...
public:
  ...
  /// @brief Method TaskScheduled, addr 0x58b21f4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Asynchronous, addr 0x58b205c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Synchronous, addr 0x58b20e4, size 0x88, virtual false, abstract: false, final false
  static inline void TaskWaitBegin_Synchronous(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID);

  /// @brief Method TaskWaitEnd, addr 0x58b216c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Enabled, addr 0x58b1ff8, size 0x64, virtual false, abstract: false, final false
