...
public:
  ...
  /// @brief Method TaskScheduled, addr 0x3c6f30c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Asynchronous, addr 0x3c6f180, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method TaskWaitBegin_Synchronous, addr 0x3c6f204, size 0x84, virtual false, abstract: false, final false
  static inline void TaskWaitBegin_Synchronous(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID);

  /// @brief Method TaskWaitEnd, addr 0x3c6f288, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Enabled, addr 0x3c6f120, size 0x60, virtual false, abstract: false, final false
