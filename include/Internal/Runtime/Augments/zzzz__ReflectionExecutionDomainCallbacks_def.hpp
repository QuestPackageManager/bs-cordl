...
public:
// Declarations
/// @brief Method CreateMissingMetadataException, addr 0x59191d8, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59191d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
