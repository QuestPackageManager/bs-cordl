...
public:
  // Declarations
  /// @brief Method CreateMissingMetadataException, addr 0x5ac5628, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac5624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
