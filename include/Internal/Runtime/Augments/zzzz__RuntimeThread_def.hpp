...
public:
  ...
  /// @brief Method Create, addr 0x5ac7988, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcessorId, addr 0x5ac7a74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Sleep, addr 0x5ac7a4c, size 0x8, virtual false, abstract: false, final false
  static inline void Sleep(int32_t millisecondsTimeout);

  /// @brief Method SpinWait, addr 0x5ac7a6c, size 0x8, virtual false, abstract: false, final false
  static inline bool SpinWait(int32_t iterations);

  /// @brief Method Start, addr 0x5ac7a34, size 0x18, virtual false, abstract: false, final false
  inline void Start(::System::Object* state);

  /// @brief Method Yield, addr 0x5ac7a54, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac7980, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsBackground, addr 0x5ac7a18, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeThread", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeThread(RuntimeThread&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeThread", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeThread(RuntimeThreadconst&) = delete;
