...
public:
  ...
  /// @brief Method Create, addr 0x598b1a4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcessorId, addr 0x598b290, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Sleep, addr 0x598b268, size 0x8, virtual false, abstract: false, final false
  static inline void Sleep(int32_t millisecondsTimeout);

  /// @brief Method SpinWait, addr 0x598b288, size 0x8, virtual false, abstract: false, final false
  static inline bool SpinWait(int32_t iterations);

  /// @brief Method Start, addr 0x598b250, size 0x18, virtual false, abstract: false, final false
  inline void Start(::System::Object* state);

  /// @brief Method Yield, addr 0x598b270, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598b19c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsBackground, addr 0x598b234, size 0x1c, virtual false, abstract: false, final false
