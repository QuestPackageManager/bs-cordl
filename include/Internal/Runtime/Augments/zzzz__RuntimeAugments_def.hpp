...
public:
  ...
  /// @brief Method ReportUnhandledException, addr 0x3c73ab0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callbacks, addr 0x3c73ad0, size 0x58, virtual false, abstract: false, final false
