...
public:
  ...
  /// @brief Method ReportUnhandledException, addr 0x58b2298, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callbacks, addr 0x58b22b4, size 0x5c, virtual false, abstract: false, final false
