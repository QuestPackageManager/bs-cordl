...
public:
  ...
  /// @brief Method ReportUnhandledException, addr 0x3c6a4b0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Callbacks, addr 0x3c6a4d0, size 0x58, virtual false, abstract: false, final false
