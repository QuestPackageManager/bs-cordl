...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeAugments", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeAugments(RuntimeAugments&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeAugments", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeAugments(RuntimeAugmentsconst&) = delete;
