...
// Write type traits
MARK_REF_T(::Internal::Cryptography::OidLookup*);
...
public:
  ...
  /// @brief Method <.cctor>b__10_0, addr 0x5fe2aac, size 0x44, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_0(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method <.cctor>b__10_1, addr 0x5fe2af0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_1(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method .ctor, addr 0x5fe2aa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Internal::Cryptography::OidLookup___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method NativeFriendlyNameToOid, addr 0x5fdff04, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method NativeOidToFriendlyName, addr 0x5fdf93c, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseCache, addr 0x5fdf934, size 0x8, virtual false, abstract: false, final false
  static inline bool ShouldUseCache(::System::Security::Cryptography::OidGroup oidGroup);

  /// @brief Method ToFriendlyName, addr 0x5fdf744, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW ToFriendlyName(::StringW oid, ::System::Security::Cryptography::OidGroup oidGroup, bool fallBackToAllGroups);

  /// @brief Method ToOid, addr 0x5fdfd34, size 0x1d0, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Internal::Cryptography::OidLookup) == 0x10, "Size mismatch!");
