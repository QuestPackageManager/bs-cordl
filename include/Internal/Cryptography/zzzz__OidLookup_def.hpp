...
public:
  ...
  /// @brief Method <.cctor>b__10_0, addr 0x40b8ef4, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_0(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method <.cctor>b__10_1, addr 0x40b8f30, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__10_1(::System::Collections::Generic::KeyValuePair_2<::StringW, ::StringW> kvp);

  /// @brief Method .ctor, addr 0x40b8eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method NativeFriendlyNameToOid, addr 0x40b6e28, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method NativeOidToFriendlyName, addr 0x40b68c8, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseCache, addr 0x40b68c0, size 0x8, virtual false, abstract: false, final false
  static inline bool ShouldUseCache(::System::Security::Cryptography::OidGroup oidGroup);

  /// @brief Method ToFriendlyName, addr 0x40b66e4, size 0x1dc, virtual false, abstract: false, final false
  static inline ::StringW ToFriendlyName(::StringW oid, ::System::Security::Cryptography::OidGroup oidGroup, bool fallBackToAllGroups);

  /// @brief Method ToOid, addr 0x40b6c78, size 0x1b0, virtual false, abstract: false, final false
