...
public:
  // Declarations
  /// @brief Method CloneByteArray addr 0x242c8ac size 0x78 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CloneByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> src);

  /// @brief Method ToHexArrayUpper addr 0x242c924 size 0xec virtual false final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> ToHexArrayUpper(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method ToHexStringUpper addr 0x242ca2c size 0x10 virtual false final false
  static inline ::StringW ToHexStringUpper(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method NibbleToHex addr 0x242ca10 size 0x1c virtual false final false
