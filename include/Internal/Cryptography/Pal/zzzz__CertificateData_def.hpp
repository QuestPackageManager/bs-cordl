...
public:
  ...
  /// @brief Method MoveNext, addr 0x411cd14, size 0x290, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Internal::Cryptography::Pal::CertificateData__ReadReverseRdns_d__21* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<System.String,System.String>>.GetEnumerator, addr 0x411d044, size 0x9c, virtual true, abstract:
  /// false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.String>>.get_Current, addr 0x411cfa4, size 0xc, virtual true, abstract: false,
  /// final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x411d0e0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x411cfb0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x411cfe8, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x411cd10, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x411ccdc, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FindAltNameMatch, addr 0x411caac, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNameInfo, addr 0x411bfe8, size 0x66c, virtual false, abstract: false, final false
  inline ::StringW GetNameInfo(::System::Security::Cryptography::X509Certificates::X509NameType nameType, bool forIssuer);

  /// @brief Method GetSimpleNameInfo, addr 0x411c654, size 0x458, virtual false, abstract: false, final false
  static inline ::StringW GetSimpleNameInfo(::System::Security::Cryptography::X509Certificates::X500DistinguishedName* name);

  /// @brief Method ReadReverseRdns, addr 0x411cc6c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x411b8c0, size 0x728, virtual false, abstract: false, final false
