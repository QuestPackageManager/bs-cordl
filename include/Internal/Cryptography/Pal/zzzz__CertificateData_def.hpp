...
// Write type traits
MARK_REF_T(::Internal::Cryptography::Pal::CertificateData__ReadReverseRdns_d__21*);
...
DEFINE_IL2CPP_CLASS(::Internal::Cryptography::Pal::CertificateData__ReadReverseRdns_d__21*, "Internal.Cryptography.Pal", "CertificateData/<ReadReverseRdns>d__21");
DEFINE_IL2CPP_CLASS(::Internal::Cryptography::Pal::CertificateData, "Internal.Cryptography.Pal", "CertificateData");
DEFINE_IL2CPP_CLASS(::Internal::Cryptography::Pal::CertificateData_AlgorithmIdentifier, "Internal.Cryptography.Pal", "CertificateData/AlgorithmIdentifier");
// Dependencies
namespace Internal::Cryptography::Pal {
// Is value type: true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5fde680, size 0x288, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Internal::Cryptography::Pal::CertificateData__ReadReverseRdns_d__21* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<System.String,System.String>>.GetEnumerator, addr 0x5fde9ac, size 0x98, virtual true, abstract:
  /// false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.String>>.get_Current, addr 0x5fde908, size 0xc, virtual true, abstract: false,
  /// final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5fdea44, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5fde914, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5fde94c, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5fde67c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5fde65c, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::Internal::Cryptography::Pal::CertificateData__ReadReverseRdns_d__21) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method FindAltNameMatch, addr 0x5fde438, size 0x1b4, virtual false, abstract: false, final false
  static inline ::StringW FindAltNameMatch(::ArrayW<uint8_t> extensionBytes, ::Internal::Cryptography::Pal::GeneralNameType matchType, ::StringW otherOid);

  /// @brief Method GetNameInfo, addr 0x5fdda50, size 0x5d8, virtual false, abstract: false, final false
  inline ::StringW GetNameInfo(::System::Security::Cryptography::X509Certificates::X509NameType nameType, bool forIssuer);

  /// @brief Method GetSimpleNameInfo, addr 0x5fde028, size 0x410, virtual false, abstract: false, final false
  static inline ::StringW GetSimpleNameInfo(::System::Security::Cryptography::X509Certificates::X500DistinguishedName* name);

  /// @brief Method ReadReverseRdns, addr 0x5fde5ec, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fdd31c, size 0x734, virtual false, abstract: false, final false
  ...
  constexpr CertificateData(::ArrayW<uint8_t> RawData, ::ArrayW<uint8_t> SubjectPublicKeyInfo, int32_t Version, ::ArrayW<uint8_t> SerialNumber,
                            ...
                            ::Internal::Cryptography::Pal::CertificateData_AlgorithmIdentifier PublicKeyAlgorithm, ::ArrayW<uint8_t> PublicKey, ::ArrayW<uint8_t> IssuerUniqueId,
                            ::ArrayW<uint8_t> SubjectUniqueId, ::System::Collections::Generic::List_1<::System::Security::Cryptography::X509Certificates::X509Extension*>* Extensions,
                            ::Internal::Cryptography::Pal::CertificateData_AlgorithmIdentifier SignatureAlgorithm, ::ArrayW<uint8_t> SignatureValue) noexcept;
...
static_assert(sizeof(::Internal::Cryptography::Pal::CertificateData) == 0x98, "Size mismatch!");
