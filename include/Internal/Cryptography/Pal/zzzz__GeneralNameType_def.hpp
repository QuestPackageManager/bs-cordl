...
DEFINE_IL2CPP_CLASS(::Internal::Cryptography::Pal::GeneralNameType, "Internal.Cryptography.Pal", "GeneralNameType");
// Dependencies
namespace Internal::Cryptography::Pal {
// Is value type: true
...
static_assert(sizeof(::Internal::Cryptography::Pal::GeneralNameType) == 0x4, "Size mismatch!");
