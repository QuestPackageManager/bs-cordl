...
DEFINE_IL2CPP_CLASS(::UnityEngine::BlendShapeBufferRange, "UnityEngine", "BlendShapeBufferRange");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Method set_endIndex, addr 0x6ab19bc, size 0x8, virtual false, abstract: false, final false
  inline void set_endIndex(uint32_t value);

  /// @brief Method set_startIndex, addr 0x6ab19ac, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::BlendShapeBufferRange) == 0x8, "Size mismatch!");
