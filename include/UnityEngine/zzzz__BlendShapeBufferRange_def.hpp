...
/// @brief Method set_endIndex, addr 0x68e7580, size 0x8, virtual false, abstract: false, final false
inline void set_endIndex(uint32_t  value) ;

/// @brief Method set_startIndex, addr 0x68e7570, size 0x8, virtual false, abstract: false, final false
