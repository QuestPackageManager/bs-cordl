...
public:
  ...
  /// @brief Method set_endIndex, addr 0x488e0e0, size 0x8, virtual false, abstract: false, final false
  inline void set_endIndex(uint32_t value);

  /// @brief Method set_startIndex, addr 0x488e0d0, size 0x8, virtual false, abstract: false, final false
