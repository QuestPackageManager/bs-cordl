...
public:
  ...
  /// @brief Method set_endIndex, addr 0x488ae7c, size 0x8, virtual false, abstract: false, final false
  inline void set_endIndex(uint32_t value);

  /// @brief Method set_startIndex, addr 0x488ae6c, size 0x8, virtual false, abstract: false, final false
