...
public:
  ...
  /// @brief Method GetResult, addr 0x31c7a3c, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> GetResult();

  static inline ::UnityEngine::AssetBundleRequest* New_ctor();

  /// @brief Method .ctor, addr 0x31c7ac0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allAssets, addr 0x31c7a84, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Object>, ::Array<::UnityW<::UnityEngine::Object>>*> get_allAssets();

  /// @brief Method get_asset, addr 0x31c7a78, size 0xc, virtual false, abstract: false, final false
