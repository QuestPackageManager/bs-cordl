...
public:
// Declarations
/// @brief Method ConvertToManaged, addr 0x687bffc, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::AssetBundleRequest* ConvertToManaged(::System::IntPtr  ptr) ;

/// @brief Method ConvertToNative, addr 0x687c080, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method GetResult, addr 0x687bda0, size 0x13c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> GetResult() ;

/// @brief Method GetResult_Injected, addr 0x687bedc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x687bfb0, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_allAssets, addr 0x687bf24, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Object>,::Array<::UnityW<::UnityEngine::Object>>*> get_allAssets() ;

/// @brief Method get_allAssets_Injected, addr 0x687bf74, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_asset, addr 0x687bf18, size 0xc, virtual false, abstract: false, final false
