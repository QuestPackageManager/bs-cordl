...
public:
  // Declarations
  /// @brief Method ConvertToManaged, addr 0x68ee008, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::AssetBundleRequest* ConvertToManaged(::System::IntPtr ptr);

  /// @brief Method ConvertToNative, addr 0x68ee08c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetResult, addr 0x68eddac, size 0x13c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> GetResult();

  /// @brief Method GetResult_Injected, addr 0x68edee8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68edfbc, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method get_allAssets, addr 0x68edf30, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Object>, ::Array<::UnityW<::UnityEngine::Object>>*> get_allAssets();

  /// @brief Method get_allAssets_Injected, addr 0x68edf80, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_asset, addr 0x68edf24, size 0xc, virtual false, abstract: false, final false
