...
::cordl_internals::setStaticField<::UnityEngine::Awaitable_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1___c<T>*>::get>(std::forward<::UnityEngine::Awaitable_1___c<T>*>(value));
}
template<typename T>
...
::cordl_internals::setStaticField<::System::Func_1<::UnityEngine::Awaitable_1<T>*>*, "<>9__15_1", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1___c<T>*>::get>(std::forward<::System::Func_1<::UnityEngine::Awaitable_1<T>*>*>(value));
}
template<typename T>
inline ::System::Func_1<::UnityEngine::Awaitable_1<T>*>* UnityEngine::Awaitable_1___c<T>::getStaticF___9__15_1()  {
return ::cordl_internals::getStaticField<::System::Func_1<::UnityEngine::Awaitable_1<T>*>*, "<>9__15_1", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1___c<T>*>::get>();
}
template<typename T>
...
::cordl_internals::setStaticField<::System::Threading::ThreadLocal_1<::UnityEngine::Pool::ObjectPool_1<::UnityEngine::Awaitable_1<T>*>*>*, "_pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1<T>*>::get>(std::forward<::System::Threading::ThreadLocal_1<::UnityEngine::Pool::ObjectPool_1<::UnityEngine::Awaitable_1<T>*>*>*>(value));
}
template<typename T>
...
return ::cordl_internals::getStaticField<::System::Threading::ThreadLocal_1<::UnityEngine::Pool::ObjectPool_1<::UnityEngine::Awaitable_1<T>*>*>*, "_pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1<T>*>::get>();
}
template<typename T>
inline void UnityEngine::Awaitable_1<T>::SetResultAndRaiseContinuation(T  result)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
...
template<typename T>
inline void UnityEngine::Awaitable_1<T>::SetExceptionAndRaiseContinuation(::System::Exception*  exception)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1<T>*>::get(),
...
template<typename T>
inline ::UnityEngine::Awaitable_1<T>* UnityEngine::Awaitable_1<T>::GetManaged()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Awaitable_1<T>*>::get(),
                        "GetManaged",
                        std::span<const Il2CppClass* const, 0>(),
