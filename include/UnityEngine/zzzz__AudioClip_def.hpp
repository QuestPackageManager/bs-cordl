...
public:
  ...
  /// @brief Method .ctor, addr 0x2c9b1a8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x2c9b27c, size 0x14, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2c9b290, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x2c9b354, size 0x14, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2c9a5f0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method GetData, addr 0x2c9a64c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetData, addr 0x2c9a6a8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUserSound, addr 0x2c9a768, size 0x74, virtual false, abstract: false, final false
  inline void CreateUserSound(::StringW name, int32_t lengthSamples, int32_t channels, int32_t frequency, bool stream);

  /// @brief Method get_length, addr 0x2c9a7dc, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_length();

  /// @brief Method get_samples, addr 0x2c9a818, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_samples();

  /// @brief Method get_channels, addr 0x2c9a854, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_channels();

  /// @brief Method get_frequency, addr 0x2c9a890, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_frequency();

  /// @brief Method LoadAudioData, addr 0x2c9a8cc, size 0x3c, virtual false, abstract: false, final false
  inline bool LoadAudioData();

  /// @brief Method UnloadAudioData, addr 0x2c9a908, size 0x3c, virtual false, abstract: false, final false
  inline bool UnloadAudioData();

  /// @brief Method get_loadState, addr 0x2c9a944, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::AudioDataLoadState get_loadState();

  /// @brief Method GetData, addr 0x2c9a980, size 0x188, virtual false, abstract: false, final false
  inline bool GetData(::ArrayW<float_t, ::Array<float_t>*> data, int32_t offsetSamples);

  /// @brief Method SetData, addr 0x2c9ab08, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_m_PCMReaderCallback, addr 0x2c9b038, size 0x9c, virtual false, abstract: false, final false
  inline void remove_m_PCMReaderCallback(::UnityEngine::__AudioClip__PCMReaderCallback* value);

  /// @brief Method add_m_PCMSetPositionCallback, addr 0x2c9af9c, size 0x9c, virtual false, abstract: false, final false
  inline void add_m_PCMSetPositionCallback(::UnityEngine::__AudioClip__PCMSetPositionCallback* value);

  /// @brief Method remove_m_PCMSetPositionCallback, addr 0x2c9b0d4, size 0x9c, virtual false, abstract: false, final false
  inline void remove_m_PCMSetPositionCallback(::UnityEngine::__AudioClip__PCMSetPositionCallback* value);

  /// @brief Method InvokePCMReaderCallback_Internal, addr 0x2c9b170, size 0x1c, virtual false, abstract: false, final false
  inline void InvokePCMReaderCallback_Internal(::ArrayW<float_t, ::Array<float_t>*> data);

  /// @brief Method InvokePCMSetPositionCallback_Internal, addr 0x2c9b18c, size 0x1c, virtual false, abstract: false, final false
