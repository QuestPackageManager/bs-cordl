...
DEFINE_IL2CPP_CLASS(::UnityEngine::LightType, "UnityEngine", "LightType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::LightType) == 0x4, "Size mismatch!");
