...
inline void UnityEngine::AssetReferenceUILabelRestriction::_ctor(/* [ParamArray] */ ::ArrayW<::StringW> allowedLabels) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::AssetReferenceUILabelRestriction*>(), { ".ctor", {}, { ::i2c::type_of<::ArrayW<::StringW>>() } })));
...
inline ::UnityEngine::AssetReferenceUILabelRestriction* UnityEngine::AssetReferenceUILabelRestriction::New_ctor(/* [ParamArray] */ ::ArrayW<::StringW> allowedLabels) {
