...
/// @brief Method FromState, addr 0x69952f8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x6995400, size 0x34, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x6995f0c, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6995f18, size 0x2c, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method get_Current, addr 0x6995318, size 0x10, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetDefaultConfiguration, addr 0x6992bd0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetAxisRaw, addr 0x6995f90, size 0x8, virtual true, abstract: false, final true
inline float_t GetAxisRaw(::StringW  axis) ;

/// @brief Method GetButtonDown, addr 0x6995f88, size 0x8, virtual true, abstract: false, final true
inline bool GetButtonDown(::StringW  button) ;

/// @brief Method GetKey, addr 0x6995f4c, size 0x3c, virtual true, abstract: false, final true
inline bool GetKey(::UnityEngine::KeyCode  key) ;

/// @brief Method GetLastPenContactEvent, addr 0x6995f98, size 0x6c, virtual true, abstract: false, final true
inline ::UnityEngine::PenData GetLastPenContactEvent() ;

/// @brief Method GetMouseButton, addr 0x69960bc, size 0x3c, virtual true, abstract: false, final true
inline bool GetMouseButton(int32_t  button) ;

/// @brief Method GetMouseButtonDown, addr 0x69960f8, size 0x3c, virtual true, abstract: false, final true
inline bool GetMouseButtonDown(int32_t  button) ;

/// @brief Method GetMouseButtonUp, addr 0x6996134, size 0x3c, virtual true, abstract: false, final true
inline bool GetMouseButtonUp(int32_t  button) ;

/// @brief Method GetTouch, addr 0x6996034, size 0x80, virtual true, abstract: false, final true
inline ::UnityEngine::Touch GetTouch(int32_t  index) ;

static inline ::UnityEngine::InputForUI::InputManagerProvider_Input* New_ctor() ;

/// @brief Method .ctor, addr 0x6992cbc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compositionString, addr 0x6995f44, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_compositionString() ;

/// @brief Method get_mousePosition, addr 0x6996170, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::Vector3 get_mousePosition() ;

/// @brief Method get_mousePresent, addr 0x69960b4, size 0x8, virtual true, abstract: false, final true
inline bool get_mousePresent() ;

/// @brief Method get_mouseScrollDelta, addr 0x6996178, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 get_mouseScrollDelta() ;

/// @brief Method get_touchCount, addr 0x699600c, size 0x28, virtual true, abstract: false, final true
inline int32_t get_touchCount() ;

/// @brief Method get_touchSupported, addr 0x6996004, size 0x8, virtual true, abstract: false, final true
inline bool get_touchSupported() ;
...
/// @brief Method .ctor, addr 0x6992cc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_timeAsRational, addr 0x6996180, size 0x8, virtual true, abstract: false, final true
inline ::Unity::IntegerTime::RationalTime get_timeAsRational() ;
...
/// @brief Method AzimuthAndAlitutudeToTilt, addr 0x69951e4, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 AzimuthAndAlitutudeToTilt(float_t  altitude, float_t  azimuth) ;

/// @brief Method CheckIfIMEChanged, addr 0x69948a4, size 0x1cc, virtual false, abstract: false, final false
inline void CheckIfIMEChanged(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method CheckMouseEvents, addr 0x6993f3c, size 0x638, virtual false, abstract: false, final false
inline void CheckMouseEvents(::Unity::IntegerTime::DiscreteTime  currentTime, bool  muted) ;

/// @brief Method CheckMouseScroll, addr 0x6994574, size 0x330, virtual false, abstract: false, final false
inline void CheckMouseScroll(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method CheckPenEvent, addr 0x6993b88, size 0x3b4, virtual false, abstract: false, final false
inline bool CheckPenEvent(::Unity::IntegerTime::DiscreteTime  currentTime, ::ByRef<::UnityEngine::PenData>  currentPenData) ;

/// @brief Method CheckTouchEvents, addr 0x6993618, size 0x570, virtual false, abstract: false, final false
inline bool CheckTouchEvents(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method DetectPen, addr 0x6993518, size 0x100, virtual false, abstract: false, final false
inline void DetectPen() ;

/// @brief Method DirectionNavigation, addr 0x6994a70, size 0x1d4, virtual false, abstract: false, final false
inline void DirectionNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method GetEventSourceFromPressedKey, addr 0x6995574, size 0x34, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::EventSource GetEventSourceFromPressedKey() ;

/// @brief Method Initialize, addr 0x6992e14, size 0x288, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method InputManagerGetAxisRawOrDefault, addr 0x6995b70, size 0x14c, virtual false, abstract: false, final false
inline float_t InputManagerGetAxisRawOrDefault(::StringW  axisName) ;

/// @brief Method InputManagerGetButtonDownOrDefault, addr 0x6995434, size 0x140, virtual false, abstract: false, final false
inline bool InputManagerGetButtonDownOrDefault(::StringW  axisName) ;

/// @brief Method InputManagerJoystickWasPressed, addr 0x6995a94, size 0xdc, virtual false, abstract: false, final false
inline bool InputManagerJoystickWasPressed() ;

/// @brief Method InputManagerKeyboardWasPressed, addr 0x69959b8, size 0xdc, virtual false, abstract: false, final false
inline bool InputManagerKeyboardWasPressed() ;

/// @brief Method MultiDisplayBottomLeftToPanelPosition, addr 0x6994f7c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method MultiDisplayToLocalScreenPosition, addr 0x6995cbc, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method NextPreviousNavigation, addr 0x6994e1c, size 0x160, virtual false, abstract: false, final false
inline void NextPreviousNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method OnFocusChanged, addr 0x699582c, size 0x18c, virtual true, abstract: false, final true
inline void OnFocusChanged(bool  focus) ;

/// @brief Method PenStatusToButton, addr 0x699525c, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputForUI::PointerEvent_Button PenStatusToButton(::UnityEngine::PenStatus  status) ;

/// @brief Method ReadCurrentNavigationMoveVector, addr 0x69955a8, size 0xe0, virtual false, abstract: false, final false
inline ::System::ValueTuple_2<::UnityEngine::Vector2,bool> ReadCurrentNavigationMoveVector() ;

/// @brief Method ScreenBottomLeftToPanelDelta, addr 0x6994ff0, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelDelta(::UnityEngine::Vector2  delta) ;

/// @brief Method ScreenBottomLeftToPanelPosition, addr 0x6995e0c, size 0x100, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2  position, int32_t  targetDisplay) ;

/// @brief Method Shutdown, addr 0x6993174, size 0x4, virtual true, abstract: false, final true
inline void Shutdown() ;

/// @brief Method SubmitCancelNavigation, addr 0x6994c44, size 0x1d8, virtual false, abstract: false, final false
inline void SubmitCancelNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method TiltToAltitude, addr 0x698f360, size 0x3c, virtual false, abstract: false, final false
static inline float_t TiltToAltitude(::UnityEngine::Vector2  tilt) ;

/// @brief Method TiltToAzimuth, addr 0x698f27c, size 0xa8, virtual false, abstract: false, final false
static inline float_t TiltToAzimuth(::UnityEngine::Vector2  tilt) ;

/// @brief Method ToIMECompositionEvent, addr 0x6995808, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x6993178, size 0x3a0, virtual true, abstract: false, final true
inline void Update() ;
...
/// @brief Method .ctor, addr 0x6991364, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get__eventModifiers, addr 0x6992bb8, size 0x18, virtual false, abstract: false, final false
