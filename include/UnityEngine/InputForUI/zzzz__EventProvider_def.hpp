...
public:
  ...
  /// @brief Method <Subscribe>b__5_0, addr 0x6a03758, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a03754, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Unsubscribe>b__0, addr 0x6a03770, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a0273c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Bootstrap, addr 0x6a02588, size 0x78, virtual false, abstract: false, final false
  static inline void Bootstrap();

  /// @brief Method Dispatch, addr 0x6a02b70, size 0x234, virtual false, abstract: false, final false
  static inline void Dispatch(::ByRef<::UnityEngine::InputForUI::Event> ev);

  /// @brief Method Initialize, addr 0x6a027e4, size 0x1d8, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method NotifyUpdate, addr 0x6a0309c, size 0x1b0, virtual false, abstract: false, final false
  static inline void NotifyUpdate();

  /// @brief Method OnFocusChanged, addr 0x6a02fb8, size 0xe4, virtual false, abstract: false, final false
  static inline void OnFocusChanged(bool focus);

  /// @brief Method SetEnabled, addr 0x6a02740, size 0xa4, virtual false, abstract: false, final false
  static inline void SetEnabled(bool enable);

  /// @brief Method SetInputSystemProvider, addr 0x6a03444, size 0x90, virtual false, abstract: false, final false
  static inline void SetInputSystemProvider(::UnityEngine::InputForUI::IEventProviderImpl* impl);

  /// @brief Method Shutdown, addr 0x6a029bc, size 0x1b4, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method Subscribe, addr 0x6a02310, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method Unsubscribe, addr 0x6a02600, size 0x13c, virtual false, abstract: false, final false
