...
/// @brief Method <Subscribe>b__5_0, addr 0x6991510, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x699150c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <Unsubscribe>b__0, addr 0x6991528, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69904f4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Bootstrap, addr 0x6990340, size 0x78, virtual false, abstract: false, final false
static inline void Bootstrap() ;

/// @brief Method Dispatch, addr 0x6990928, size 0x234, virtual false, abstract: false, final false
static inline void Dispatch(::ByRef<::UnityEngine::InputForUI::Event>  ev) ;

/// @brief Method Initialize, addr 0x699059c, size 0x1d8, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method NotifyUpdate, addr 0x6990e54, size 0x1b0, virtual false, abstract: false, final false
static inline void NotifyUpdate() ;

/// @brief Method OnFocusChanged, addr 0x6990d70, size 0xe4, virtual false, abstract: false, final false
static inline void OnFocusChanged(bool  focus) ;

/// @brief Method SetEnabled, addr 0x69904f8, size 0xa4, virtual false, abstract: false, final false
static inline void SetEnabled(bool  enable) ;

/// @brief Method SetInputSystemProvider, addr 0x69911fc, size 0x90, virtual false, abstract: false, final false
static inline void SetInputSystemProvider(::UnityEngine::InputForUI::IEventProviderImpl*  impl) ;

/// @brief Method Shutdown, addr 0x6990774, size 0x1b4, virtual false, abstract: false, final false
static inline void Shutdown() ;

/// @brief Method Subscribe, addr 0x69900c8, size 0x278, virtual false, abstract: false, final false
static inline void Subscribe(::UnityEngine::InputForUI::EventConsumer*  handler, int32_t  priority, ::System::Nullable_1<int32_t>  playerId, ::ArrayW<::UnityEngine::InputForUI::Event_Type,::Array<::UnityEngine::InputForUI::Event_Type>*>  type) ;

/// @brief Method Unsubscribe, addr 0x69903b8, size 0x13c, virtual false, abstract: false, final false
