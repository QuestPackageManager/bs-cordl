...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NavigationEventRepeatHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NavigationEventRepeatHelper(NavigationEventRepeatHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NavigationEventRepeatHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NavigationEventRepeatHelper(NavigationEventRepeatHelperconst&) = delete;
