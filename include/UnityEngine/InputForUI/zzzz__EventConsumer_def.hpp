...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6a03820, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a037a4, size 0x7c, virtual false, abstract: false, final false
