...
/// @brief Method AfterProviderUpdate, addr 0x6991100, size 0xfc, virtual false, abstract: false, final false
inline void AfterProviderUpdate() ;

/// @brief Method BeforeProviderUpdate, addr 0x6991004, size 0xfc, virtual false, abstract: false, final false
inline void BeforeProviderUpdate() ;

/// @brief Method Inspect, addr 0x6990b5c, size 0x104, virtual false, abstract: false, final false
inline void Inspect(::ByRef<::UnityEngine::InputForUI::Event>  ev) ;

/// @brief Method Reset, addr 0x6990c60, size 0x110, virtual false, abstract: false, final false
inline void Reset() ;
...
// Ctor Parameters [CppParam { name: "_sanitizers", ty: "::ArrayW<::UnityEngine::InputForUI::EventSanitizer_IEventSanitizer*,::Array<::UnityEngine::InputForUI::EventSanitizer_IEventSanitizer*>*>", modifiers: "", def_value: None }]
