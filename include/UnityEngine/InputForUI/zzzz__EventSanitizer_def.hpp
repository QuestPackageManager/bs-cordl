...
public:
  ...
  /// @brief Method AfterProviderUpdate, addr 0x6a03348, size 0xfc, virtual false, abstract: false, final false
  inline void AfterProviderUpdate();

  /// @brief Method BeforeProviderUpdate, addr 0x6a0324c, size 0xfc, virtual false, abstract: false, final false
  inline void BeforeProviderUpdate();

  /// @brief Method Inspect, addr 0x6a02da4, size 0x104, virtual false, abstract: false, final false
  inline void Inspect(::ByRef<::UnityEngine::InputForUI::Event> ev);

  /// @brief Method Reset, addr 0x6a02ea8, size 0x110, virtual false, abstract: false, final false
  inline void Reset();
