...
public:
// Declarations
/// @brief Method Get, addr 0x698ff08, size 0x10, virtual false, abstract: false, final false
inline bool Get(::UnityEngine::InputForUI::PointerEvent_Button  button) ;

/// @brief Method Reset, addr 0x698ff18, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Set, addr 0x698feec, size 0x1c, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputForUI::PointerEvent_Button  button, bool  pressed) ;

/// @brief Method ToString, addr 0x698ff20, size 0x98, virtual true, abstract: false, final false
...
// Dependencies Unity.IntegerTime.DiscreteTime, UnityEngine.InputForUI.EventModifiers, UnityEngine.InputForUI.EventSource, UnityEngine.InputForUI.PointerEvent::Button, UnityEngine.InputForUI.PointerEvent::ButtonsState, UnityEngine.InputForUI.PointerEvent::Type, UnityEngine.Vector2
namespace UnityEngine::InputForUI {
// Is value type: true
...
/// @brief Method ButtonFromButtonIndex, addr 0x698fed8, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::InputForUI::PointerEvent_Button ButtonFromButtonIndex(int32_t  index) ;

/// @brief Method ToString, addr 0x698f3d4, size 0xb04, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_altitude, addr 0x698f324, size 0x3c, virtual false, abstract: false, final false
inline float_t get_altitude() ;

/// @brief Method get_azimuth, addr 0x698f274, size 0x8, virtual false, abstract: false, final false
inline float_t get_azimuth() ;

/// @brief Method get_eventModifiers, addr 0x698f3c4, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x698f3ac, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventSource get_eventSource() ;

/// @brief Method get_isPrimaryPointer, addr 0x698f264, size 0x10, virtual false, abstract: false, final false
inline bool get_isPrimaryPointer() ;

/// @brief Method get_timestamp, addr 0x698f39c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_eventModifiers, addr 0x698f3cc, size 0x8, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x698f3b4, size 0x8, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x698f3bc, size 0x8, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x698f3a4, size 0x8, virtual false, abstract: false, final false
