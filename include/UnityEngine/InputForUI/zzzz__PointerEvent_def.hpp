...
public:
  // Declarations
  /// @brief Method Get, addr 0x6a02150, size 0x10, virtual false, abstract: false, final false
  inline bool Get(::UnityEngine::InputForUI::PointerEvent_Button button);

  /// @brief Method Reset, addr 0x6a02160, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Set, addr 0x6a02134, size 0x1c, virtual false, abstract: false, final false
  inline void Set(::UnityEngine::InputForUI::PointerEvent_Button button, bool pressed);

  /// @brief Method ToString, addr 0x6a02168, size 0x98, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method ButtonFromButtonIndex, addr 0x6a02120, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputForUI::PointerEvent_Button ButtonFromButtonIndex(int32_t index);

  /// @brief Method ToString, addr 0x6a0161c, size 0xb04, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_altitude, addr 0x6a0156c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_altitude();

  /// @brief Method get_azimuth, addr 0x6a014bc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_azimuth();

  /// @brief Method get_eventModifiers, addr 0x6a0160c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers();

  /// @brief Method get_eventSource, addr 0x6a015f4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputForUI::EventSource get_eventSource();

  /// @brief Method get_isPrimaryPointer, addr 0x6a014ac, size 0x10, virtual false, abstract: false, final false
  inline bool get_isPrimaryPointer();

  /// @brief Method get_timestamp, addr 0x6a015e4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_eventModifiers, addr 0x6a01614, size 0x8, virtual false, abstract: false, final false
  inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers value);

  /// @brief Method set_eventSource, addr 0x6a015fc, size 0x8, virtual false, abstract: false, final false
  inline void set_eventSource(::UnityEngine::InputForUI::EventSource value);

  /// @brief Method set_playerId, addr 0x6a01604, size 0x8, virtual false, abstract: false, final false
  inline void set_playerId(uint32_t value);

  /// @brief Method set_timestamp, addr 0x6a015ec, size 0x8, virtual false, abstract: false, final false
