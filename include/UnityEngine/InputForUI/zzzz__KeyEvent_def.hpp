...
/// @brief Method ClearUnchecked, addr 0x698eb30, size 0x24, virtual false, abstract: false, final false
inline void ClearUnchecked(uint32_t  index) ;

/// @brief Method GetAllPressed, addr 0x698eb80, size 0x80, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::KeyCode>* GetAllPressed() ;

/// @brief Method GetUnchecked, addr 0x698eaf0, size 0x1c, virtual false, abstract: false, final false
inline bool GetUnchecked(uint32_t  index) ;

/// @brief Method IsPressed, addr 0x698eb54, size 0x2c, virtual false, abstract: false, final false
inline bool IsPressed(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method Reset, addr 0x698ec58, size 0x16c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetPressed, addr 0x698ec20, size 0x38, virtual false, abstract: false, final false
inline void SetPressed(::UnityEngine::KeyCode  keyCode, bool  pressed) ;

/// @brief Method SetUnchecked, addr 0x698eb0c, size 0x24, virtual false, abstract: false, final false
inline void SetUnchecked(uint32_t  index) ;

/// @brief Method ShouldBeProcessed, addr 0x698eae4, size 0xc, virtual false, abstract: false, final false
static inline bool ShouldBeProcessed(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method ToString, addr 0x698edc4, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x698ee3c, size 0x74, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::InputForUI::ButtonsState_KeyEvent__GetAllPressed_d__8* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.KeyCode>.GetEnumerator, addr 0x698ef50, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.KeyCode>.get_Current, addr 0x698eeb0, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::KeyCode System_Collections_Generic_IEnumerator_UnityEngine_KeyCode__get_Current() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x698eff8, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x698eeb8, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x698eef0, size 0x60, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x698ee38, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x698ec00, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x698e8e8, size 0x1fc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_eventModifiers, addr 0x698e8d8, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::InputForUI::EventModifiers get_eventModifiers() ;

/// @brief Method get_eventSource, addr 0x698e8c0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_eventModifiers, addr 0x698e8e0, size 0x8, virtual false, abstract: false, final false
inline void set_eventModifiers(::UnityEngine::InputForUI::EventModifiers  value) ;

/// @brief Method set_eventSource, addr 0x698e8c8, size 0x8, virtual false, abstract: false, final false
inline void set_eventSource(::UnityEngine::InputForUI::EventSource  value) ;

/// @brief Method set_playerId, addr 0x698e8d0, size 0x8, virtual false, abstract: false, final false
inline void set_playerId(uint32_t  value) ;

/// @brief Method set_timestamp, addr 0x698e8b8, size 0x8, virtual false, abstract: false, final false
