...
/// @brief Method OnButtonChange, addr 0x6995328, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method OnButtonDown, addr 0x6994ff8, size 0x15c, virtual false, abstract: false, final false
inline void OnButtonDown(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::InputForUI::PointerEvent_Button  button) ;

/// @brief Method OnButtonUp, addr 0x6995154, size 0x90, virtual false, abstract: false, final false
inline void OnButtonUp(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::InputForUI::PointerEvent_Button  button) ;

/// @brief Method OnMove, addr 0x6995278, size 0x80, virtual false, abstract: false, final false
inline void OnMove(::Unity::IntegerTime::DiscreteTime  currentTime, ::UnityEngine::Vector2  position, int32_t  displayIndex) ;

/// @brief Method Reset, addr 0x699309c, size 0xd8, virtual false, abstract: false, final false
inline void Reset() ;

static inline ::Unity::IntegerTime::DiscreteTime getStaticF_kClickDelay() ;

/// @brief Method get_ButtonsState, addr 0x6996198, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::PointerEvent_ButtonsState get_ButtonsState() ;

/// @brief Method get_ClickCount, addr 0x69961b0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ClickCount() ;

/// @brief Method get_LastDisplayIndex, addr 0x69961d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LastDisplayIndex() ;

/// @brief Method get_LastPosition, addr 0x69961c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_LastPosition() ;

/// @brief Method get_LastPositionValid, addr 0x69961e0, size 0x8, virtual false, abstract: false, final false
inline bool get_LastPositionValid() ;

/// @brief Method get_LastPressedButton, addr 0x6996188, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::PointerEvent_Button get_LastPressedButton() ;

/// @brief Method get_NextPressTime, addr 0x69961a0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ClickCount, addr 0x69961b8, size 0x8, virtual false, abstract: false, final false
inline void set_ClickCount(int32_t  value) ;

/// @brief Method set_LastDisplayIndex, addr 0x69961d8, size 0x8, virtual false, abstract: false, final false
inline void set_LastDisplayIndex(int32_t  value) ;

/// @brief Method set_LastPosition, addr 0x69961c8, size 0x8, virtual false, abstract: false, final false
inline void set_LastPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_LastPositionValid, addr 0x69961e8, size 0x8, virtual false, abstract: false, final false
inline void set_LastPositionValid(bool  value) ;

/// @brief Method set_LastPressedButton, addr 0x6996190, size 0x8, virtual false, abstract: false, final false
inline void set_LastPressedButton(::UnityEngine::InputForUI::PointerEvent_Button  value) ;

/// @brief Method set_NextPressTime, addr 0x69961a8, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_LastPressedButton_k__BackingField", ty: "::UnityEngine::InputForUI::PointerEvent_Button", modifiers: "", def_value: None }, CppParam { name: "_buttonsState", ty: "::UnityEngine::InputForUI::PointerEvent_ButtonsState", modifiers: "", def_value: None }, CppParam { name: "_NextPressTime_k__BackingField", ty: "::Unity::IntegerTime::DiscreteTime", modifiers: "", def_value: None }, CppParam { name: "_ClickCount_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_LastPosition_k__BackingField", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "_LastDisplayIndex_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_LastPositionValid_k__BackingField", ty: "bool", modifiers: "", def_value: None }]
constexpr PointerState(::UnityEngine::InputForUI::PointerEvent_Button  _LastPressedButton_k__BackingField, ::UnityEngine::InputForUI::PointerEvent_ButtonsState  _buttonsState, ::Unity::IntegerTime::DiscreteTime  _NextPressTime_k__BackingField, int32_t  _ClickCount_k__BackingField, ::UnityEngine::Vector2  _LastPosition_k__BackingField, int32_t  _LastDisplayIndex_k__BackingField, bool  _LastPositionValid_k__BackingField) noexcept;
