...
/// @brief Method GetTimestamp, addr 0x6a062ec, size 0x18, virtual false, abstract: false, final false
inline ::Unity::IntegerTime::DiscreteTime GetTimestamp(::ByRef<::UnityEngine::Event*>  ev) ;

/// @brief Method Initialize, addr 0x6a053ac, size 0x1b0, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::UnityEngine::InputForUI::InputEventPartialProvider* New_ctor() ;

/// @brief Method OnFocusChanged, addr 0x6a0602c, size 0x178, virtual true, abstract: false, final true
inline void OnFocusChanged(bool  focus) ;

/// @brief Method RequestCurrentState, addr 0x6a061a4, size 0x148, virtual true, abstract: false, final true
inline bool RequestCurrentState(::UnityEngine::InputForUI::Event_Type  type) ;

/// @brief Method SendNextOrPreviousNavigationEventOnTabKeyDownEvent, addr 0x6a05ca0, size 0x168, virtual false, abstract: false, final false
inline void SendNextOrPreviousNavigationEventOnTabKeyDownEvent(::ByRef<::UnityEngine::Event*>  ev) ;

/// @brief Method Shutdown, addr 0x6a0555c, size 0x4, virtual true, abstract: false, final true
inline void Shutdown() ;

/// @brief Method ToCommandEvent, addr 0x6a05e70, size 0x1bc, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::CommandEvent ToCommandEvent(::ByRef<::UnityEngine::Event*>  ev) ;

/// @brief Method ToKeyEvent, addr 0x6a05b30, size 0x170, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::KeyEvent ToKeyEvent(::ByRef<::UnityEngine::Event*>  ev) ;

/// @brief Method ToTextInputEvent, addr 0x6a05e08, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::TextInputEvent ToTextInputEvent(::ByRef<::UnityEngine::Event*>  ev) ;

/// @brief Method Update, addr 0x6a05560, size 0x2e0, virtual true, abstract: false, final true
inline void Update() ;

/// @brief Method UpdateEventModifiers, addr 0x6a05840, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a06304, size 0x674, virtual false, abstract: false, final false
inline void _ctor() ;
