...
public:
  ...
  /// @brief Method GetDefinedRenderingLayerNames, addr 0x6980820, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetDefinedRenderingLayerNames();

  /// @brief Method GetDefinedRenderingLayersCombinedMaskValue, addr 0x69807f8, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t GetDefinedRenderingLayersCombinedMaskValue();

  /// @brief Method GetRenderingLayerCount, addr 0x6980848, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetRenderingLayerCount();

  /// @brief Method NameToRenderingLayer, addr 0x6980664, size 0x158, virtual false, abstract: false, final false
  static inline int32_t NameToRenderingLayer(::StringW layerName);

  /// @brief Method NameToRenderingLayer_Injected, addr 0x69807bc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6980660, size 0x4, virtual false, abstract: false, final false
