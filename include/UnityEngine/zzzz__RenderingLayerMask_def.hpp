...
/// @brief Method GetDefinedRenderingLayerNames, addr 0x690e604, size 0x28, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetDefinedRenderingLayerNames() ;

/// @brief Method GetDefinedRenderingLayersCombinedMaskValue, addr 0x690e5dc, size 0x28, virtual false, abstract: false, final false
static inline uint32_t GetDefinedRenderingLayersCombinedMaskValue() ;

/// @brief Method GetRenderingLayerCount, addr 0x690e62c, size 0x28, virtual false, abstract: false, final false
static inline int32_t GetRenderingLayerCount() ;

/// @brief Method NameToRenderingLayer, addr 0x690e448, size 0x158, virtual false, abstract: false, final false
static inline int32_t NameToRenderingLayer(::StringW  layerName) ;

/// @brief Method NameToRenderingLayer_Injected, addr 0x690e5a0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x690e444, size 0x4, virtual false, abstract: false, final false
