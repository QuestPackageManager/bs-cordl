...
public:
  // Declarations
  /// @brief Method Compare, addr 0x48f8dec, size 0xb4, virtual false, abstract: false, final false
  static inline bool Compare(::UnityEngine::SendMouseEvents_HitInfo lhs, ::UnityEngine::SendMouseEvents_HitInfo rhs);

  /// @brief Method SendMessage, addr 0x48f8dc8, size 0x24, virtual false, abstract: false, final false
  inline void SendMessage(::StringW name);

  /// @brief Method op_Implicit, addr 0x48f8d28, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DoSendMouseEvents, addr 0x48f7f98, size 0x968, virtual false, abstract: false, final false
  static inline void DoSendMouseEvents(int32_t skipRTCameras);

  /// @brief Method SendEvents, addr 0x48f8900, size 0x428, virtual false, abstract: false, final false
  static inline void SendEvents(int32_t i, ::UnityEngine::SendMouseEvents_HitInfo hit);

  /// @brief Method SetMouseMoved, addr 0x48f7f3c, size 0x5c, virtual false, abstract: false, final false
  static inline void SetMouseMoved();

  /// @brief Method UpdateMouse, addr 0x48f7d78, size 0x1c4, virtual false, abstract: false, final false
