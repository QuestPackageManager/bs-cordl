...
public:
// Declarations
/// @brief Method Compare, addr 0x6a0c4f4, size 0xb8, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::SendMouseEvents_HitInfo  lhs, ::UnityEngine::SendMouseEvents_HitInfo  rhs) ;

/// @brief Method SendMessage, addr 0x6a0c4d4, size 0x20, virtual false, abstract: false, final false
inline void SendMessage(::StringW  name) ;

/// @brief Method op_Implicit, addr 0x6a0c430, size 0xa4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "target", ty: "::UnityW<::UnityEngine::GameObject>", modifiers: "", def_value: None }, CppParam { name: "camera", ty: "::UnityW<::UnityEngine::Camera>", modifiers: "", def_value: None }]
...
/// @brief Field m_MouseDownHit, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_MouseDownHit, put=setStaticF_m_MouseDownHit)) ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo,::Array<::UnityEngine::SendMouseEvents_HitInfo>*>  m_MouseDownHit;
...
/// @brief Method DoSendMouseEvents, addr 0x6a0b62c, size 0x98c, virtual false, abstract: false, final false
static inline void DoSendMouseEvents(int32_t  skipRTCameras) ;

/// @brief Method SendEvents, addr 0x6a0bfb8, size 0x478, virtual false, abstract: false, final false
static inline void SendEvents(int32_t  i, ::UnityEngine::SendMouseEvents_HitInfo  hit) ;

/// @brief Method SetMouseMoved, addr 0x6a0b5cc, size 0x60, virtual false, abstract: false, final false
static inline void SetMouseMoved() ;

/// @brief Method UpdateMouse, addr 0x6a0b3f8, size 0x1d4, virtual false, abstract: false, final false
