...
DEFINE_IL2CPP_CLASS(::UnityEngine::SendMouseEvents_HitInfo, "UnityEngine", "SendMouseEvents/HitInfo");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Compare, addr 0x6b5ffd0, size 0xb8, virtual false, abstract: false, final false
  static inline bool Compare(::UnityEngine::SendMouseEvents_HitInfo lhs, ::UnityEngine::SendMouseEvents_HitInfo rhs);

  /// @brief Method SendMessage, addr 0x6b5ffb0, size 0x20, virtual false, abstract: false, final false
  inline void SendMessage(::StringW name);

  /// @brief Method op_Implicit, addr 0x6b5ff0c, size 0xa4, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::SendMouseEvents_HitInfo) == 0x10, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_m_CurrentHit, put = setStaticF_m_CurrentHit)) ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> m_CurrentHit;

  /// @brief Field m_LastHit, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_m_LastHit, put = setStaticF_m_LastHit)) ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> m_LastHit;

  /// @brief Field m_MouseDownHit, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_m_MouseDownHit, put = setStaticF_m_MouseDownHit)) ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> m_MouseDownHit;
  ...
  /// @brief Method DoSendMouseEvents, addr 0x6b5f108, size 0x98c, virtual false, abstract: false, final false
  static inline void DoSendMouseEvents(int32_t skipRTCameras);

  /// @brief Method SendEvents, addr 0x6b5fa94, size 0x478, virtual false, abstract: false, final false
  static inline void SendEvents(int32_t i, ::UnityEngine::SendMouseEvents_HitInfo hit);

  /// @brief Method SetMouseMoved, addr 0x6b5f0a8, size 0x60, virtual false, abstract: false, final false
  static inline void SetMouseMoved();

  /// @brief Method UpdateMouse, addr 0x6b5eed4, size 0x1d4, virtual false, abstract: false, final false
  static inline void UpdateMouse();

  static inline ::ArrayW<::UnityW<::UnityEngine::Camera>> getStaticF_m_Cameras();

  static inline ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> getStaticF_m_CurrentHit();

  static inline ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> getStaticF_m_LastHit();

  static inline ::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> getStaticF_m_MouseDownHit();
  ...
  static inline void setStaticF_m_CurrentHit(::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> value);

  static inline void setStaticF_m_LastHit(::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> value);

  static inline void setStaticF_m_MouseDownHit(::ArrayW<::UnityEngine::SendMouseEvents_HitInfo> value);
