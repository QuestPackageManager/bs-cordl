...
/// @brief Method InvokeOnTextureLoaded_Internal, addr 0x68b7800, size 0x70, virtual false, abstract: false, final false
static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture*  source) ;

/// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x68b7870, size 0x70, virtual false, abstract: false, final false
