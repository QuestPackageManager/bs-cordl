...
public:
  ...
  /// @brief Method InvokeOnTextureLoaded_Internal, addr 0x6929a1c, size 0x70, virtual false, abstract: false, final false
  static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture* source);

  /// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x6929a8c, size 0x70, virtual false, abstract: false, final false
