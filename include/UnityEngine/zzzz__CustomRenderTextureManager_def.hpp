...
public:
  ...
  /// @brief Method InvokeOnTextureLoaded_Internal, addr 0x4877a58, size 0x6c, virtual false, abstract: false, final false
  static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture* source);

  /// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x4877ac4, size 0x6c, virtual false, abstract: false, final false
