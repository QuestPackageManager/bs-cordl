...
// Ctor Parameters [CppParam { name: "PoseNames", ty: "::System::Collections::Generic::List_1<::StringW>*", modifiers: "", def_value: None }, CppParam { name: "Poses", ty: "::System::Collections::Generic::List_1<::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose>*", modifiers: "", def_value: None }]
constexpr TrackedPoseDriverDataDescription_PoseData(::System::Collections::Generic::List_1<::StringW>*  PoseNames, ::System::Collections::Generic::List_1<::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose>*  Poses) noexcept;
...
/// @brief Field DeviceData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_DeviceData, put=setStaticF_DeviceData)) ::System::Collections::Generic::List_1<::UnityEngine::SpatialTracking::TrackedPoseDriverDataDescription_PoseData>*  DeviceData;

static inline ::UnityEngine::SpatialTracking::TrackedPoseDriverDataDescription* New_ctor() ;

/// @brief Method .ctor, addr 0x69eb85c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
