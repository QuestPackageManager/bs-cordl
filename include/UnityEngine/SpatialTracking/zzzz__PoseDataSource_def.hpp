...
public:
  ...
  /// @brief Method GetDataFromSource, addr 0x6a5e660, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNodePoseData, addr 0x6a5e3e4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetDataFromSource, addr 0x6a5e5ec, size 0x74, virtual false, abstract: false, final false
