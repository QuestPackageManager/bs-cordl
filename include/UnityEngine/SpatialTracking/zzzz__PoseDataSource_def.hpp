...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoseDataSource", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoseDataSource(PoseDataSource&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoseDataSource", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoseDataSource(PoseDataSourceconst&) = delete;
