...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::SpatialTracking::PoseDataFlags (*)(::UnityEngine::XR::XRNode, ::ByRef<::UnityEngine::Pose>)>(&::UnityEngine::SpatialTracking::PoseDataSource::GetNodePoseData)> {
  ...
  constexpr static std::size_t addrs = 0x69ec19c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose, ::ByRef<::UnityEngine::Pose>)>(&::UnityEngine::SpatialTracking::PoseDataSource::TryGetDataFromSource)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x69ec3a4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::UnityEngine::Pose>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::SpatialTracking::PoseDataFlags (*)(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose, ::ByRef<::UnityEngine::Pose>)>(&::UnityEngine::SpatialTracking::PoseDataSource::GetDataFromSource)> {
  constexpr static std::size_t size = 0x2c4;
  constexpr static std::size_t addrs = 0x69ec418;
...
inline bool UnityEngine::SpatialTracking::PoseDataSource::TryGetDataFromSource(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose  poseSource, ::ByRef<::UnityEngine::Pose>  resultPose)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::SpatialTracking::PoseDataSource*>::get(),
                        "TryGetDataFromSource",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::UnityEngine::SpatialTracking::PoseDataFlags UnityEngine::SpatialTracking::PoseDataSource::GetDataFromSource(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose  poseSource, ::ByRef<::UnityEngine::Pose>  resultPose)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::SpatialTracking::PoseDataSource*>::get(),
                        "GetDataFromSource",
                        std::span<const Il2CppClass* const, 0>(),
