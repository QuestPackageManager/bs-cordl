...
// Is value type: true
// Dependencies: []
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16341))
...
// Is value type: true
// Dependencies: []
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16342))
...
// Is value type: true
// Dependencies: []
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16343))
...
// Is value type: true
// Dependencies: []
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16344))
...
namespace UnityEngine::SpatialTracking {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8789)), TypeDefinitionIndex(TypeDefinitionIndex(8969)), TypeDefinitionIndex(TypeDefinitionIndex(16341)),
// TypeDefinitionIndex(TypeDefinitionIndex(16342)), TypeDefinitionIndex(TypeDefinitionIndex(16343)), TypeDefinitionIndex(TypeDefinitionIndex(16344))] Self:
// TypeDefinitionIndex(TypeDefinitionIndex(16345)) CS Name: ::UnityEngine.SpatialTracking::TrackedPoseDriver*
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_PoseProviderComponent,
                      put = __cordl_internal_set_m_PoseProviderComponent))::UnityW<::UnityEngine::Experimental::XR::Interaction::BasePoseProvider> m_PoseProviderComponent;
  ...
  /// @brief Method get_deviceType, addr 0x2d3a3c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__DeviceType get_deviceType();

  /// @brief Method set_deviceType, addr 0x2d3a3d0, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceType(::UnityEngine::SpatialTracking::__TrackedPoseDriver__DeviceType value);

  /// @brief Method get_poseSource, addr 0x2d3a3d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackedPose get_poseSource();

  /// @brief Method set_poseSource, addr 0x2d3a3e0, size 0x8, virtual false, abstract: false, final false
  inline void set_poseSource(::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackedPose value);

  /// @brief Method SetPoseSource, addr 0x2d3a3e8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method get_poseProviderComponent, addr 0x2d3a52c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Experimental::XR::Interaction::BasePoseProvider> get_poseProviderComponent();

  /// @brief Method set_poseProviderComponent, addr 0x2d3a534, size 0x8, virtual false, abstract: false, final false
  inline void set_poseProviderComponent(::UnityEngine::Experimental::XR::Interaction::BasePoseProvider* value);

  /// @brief Method GetPoseData, addr 0x2d3a53c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_trackingType, addr 0x2d3a608, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackingType get_trackingType();

  /// @brief Method set_trackingType, addr 0x2d3a610, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingType(::UnityEngine::SpatialTracking::__TrackedPoseDriver__TrackingType value);

  /// @brief Method get_updateType, addr 0x2d3a618, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::__TrackedPoseDriver__UpdateType get_updateType();

  /// @brief Method set_updateType, addr 0x2d3a620, size 0x8, virtual false, abstract: false, final false
  inline void set_updateType(::UnityEngine::SpatialTracking::__TrackedPoseDriver__UpdateType value);

  /// @brief Method get_UseRelativeTransform, addr 0x2d3a628, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseRelativeTransform();

  /// @brief Method set_UseRelativeTransform, addr 0x2d3a630, size 0xc, virtual false, abstract: false, final false
  inline void set_UseRelativeTransform(bool value);

  /// @brief Method get_originPose, addr 0x2d3a63c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_originPose();

  /// @brief Method set_originPose, addr 0x2d3a650, size 0x1c, virtual false, abstract: false, final false
  inline void set_originPose(::UnityEngine::Pose value);

  /// @brief Method CacheLocalPosition, addr 0x2d3a66c, size 0x50, virtual false, abstract: false, final false
  inline void CacheLocalPosition();

  /// @brief Method ResetToCachedLocalPosition, addr 0x2d3a6bc, size 0x20, virtual false, abstract: false, final false
  inline void ResetToCachedLocalPosition();

  /// @brief Method Awake, addr 0x2d3a6dc, size 0x4, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method OnDestroy, addr 0x2d3a6e0, size 0x4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x2d3a6e4, size 0x74, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x2d3a758, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method FixedUpdate, addr 0x2d3a7d4, size 0x1c, virtual true, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Update, addr 0x2d3a7f0, size 0x1c, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method OnBeforeRender, addr 0x2d3a80c, size 0x20, virtual true, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method SetLocalTransform, addr 0x2d3a82c, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method TransformPoseByOriginIfNeeded, addr 0x2d3a910, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose TransformPoseByOriginIfNeeded(::UnityEngine::Pose pose);

  /// @brief Method HasStereoCamera, addr 0x2d3a974, size 0xb8, virtual false, abstract: false, final false
  inline bool HasStereoCamera();

  /// @brief Method PerformUpdate, addr 0x2d3aa2c, size 0xc4, virtual true, abstract: false, final false
  inline void PerformUpdate();

  static inline ::UnityEngine::SpatialTracking::TrackedPoseDriver* New_ctor();

  /// @brief Method .ctor, addr 0x2d3aaf0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_Device) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_PoseSource) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_PoseProviderComponent) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_TrackingType) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_UpdateType) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_UseRelativeTransform) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::SpatialTracking::TrackedPoseDriver, ___m_OriginPose) == 0x34, "Offset mismatch!");
