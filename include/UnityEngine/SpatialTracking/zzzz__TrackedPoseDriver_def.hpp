...
public:
  ...
  /// @brief Method Awake, addr 0x491a948, size 0x4, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method CacheLocalPosition, addr 0x491a8d8, size 0x50, virtual false, abstract: false, final false
  inline void CacheLocalPosition();

  /// @brief Method FixedUpdate, addr 0x491aa80, size 0x1c, virtual true, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetPoseData, addr 0x491a7a8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasStereoCamera, addr 0x491ac7c, size 0xb8, virtual false, abstract: false, final false
  inline bool HasStereoCamera();

  static inline ::UnityEngine::SpatialTracking::TrackedPoseDriver* New_ctor();

  /// @brief Method OnBeforeRender, addr 0x491aab8, size 0x20, virtual true, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x491a94c, size 0x4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x491a9e4, size 0x9c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x491a950, size 0x94, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PerformUpdate, addr 0x491ad34, size 0x94, virtual true, abstract: false, final false
  inline void PerformUpdate();

  /// @brief Method ResetToCachedLocalPosition, addr 0x491a928, size 0x20, virtual false, abstract: false, final false
  inline void ResetToCachedLocalPosition();

  /// @brief Method SetLocalTransform, addr 0x491aad8, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetPoseSource, addr 0x491a654, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformPoseByOriginIfNeeded, addr 0x491abbc, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose TransformPoseByOriginIfNeeded(::UnityEngine::Pose pose);

  /// @brief Method Update, addr 0x491aa9c, size 0x1c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x491adc8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseRelativeTransform, addr 0x491a894, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseRelativeTransform();

  /// @brief Method get_deviceType, addr 0x491a634, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::TrackedPoseDriver_DeviceType get_deviceType();

  /// @brief Method get_originPose, addr 0x491a8a8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_originPose();

  /// @brief Method get_poseProviderComponent, addr 0x491a798, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Experimental::XR::Interaction::BasePoseProvider> get_poseProviderComponent();

  /// @brief Method get_poseSource, addr 0x491a644, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose get_poseSource();

  /// @brief Method get_trackingType, addr 0x491a874, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackingType get_trackingType();

  /// @brief Method get_updateType, addr 0x491a884, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SpatialTracking::TrackedPoseDriver_UpdateType get_updateType();

  /// @brief Method set_UseRelativeTransform, addr 0x491a89c, size 0xc, virtual false, abstract: false, final false
  inline void set_UseRelativeTransform(bool value);

  /// @brief Method set_deviceType, addr 0x491a63c, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceType(::UnityEngine::SpatialTracking::TrackedPoseDriver_DeviceType value);

  /// @brief Method set_originPose, addr 0x491a8bc, size 0x1c, virtual false, abstract: false, final false
  inline void set_originPose(::UnityEngine::Pose value);

  /// @brief Method set_poseProviderComponent, addr 0x491a7a0, size 0x8, virtual false, abstract: false, final false
  inline void set_poseProviderComponent(::UnityEngine::Experimental::XR::Interaction::BasePoseProvider* value);

  /// @brief Method set_poseSource, addr 0x491a64c, size 0x8, virtual false, abstract: false, final false
  inline void set_poseSource(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackedPose value);

  /// @brief Method set_trackingType, addr 0x491a87c, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingType(::UnityEngine::SpatialTracking::TrackedPoseDriver_TrackingType value);

  /// @brief Method set_updateType, addr 0x491a88c, size 0x8, virtual false, abstract: false, final false
