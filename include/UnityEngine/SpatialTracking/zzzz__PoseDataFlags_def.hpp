...
DEFINE_IL2CPP_CLASS(::UnityEngine::SpatialTracking::PoseDataFlags, "UnityEngine.SpatialTracking", "PoseDataFlags");
// Dependencies
namespace UnityEngine::SpatialTracking {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23357 };
...
static_assert(sizeof(::UnityEngine::SpatialTracking::PoseDataFlags) == 0x4, "Size mismatch!");
