...
public:
  ...
  /// @brief Method GetContact, addr 0x48f5cf0, size 0x1c4, virtual false, abstract: false, final false
  inline ::UnityEngine::ContactPoint GetContact(int32_t index);

  /// @brief Method GetContacts, addr 0x48f5f60, size 0xe4, virtual false, abstract: false, final false
  inline int32_t GetContacts(::ArrayW<::UnityEngine::ContactPoint, ::Array<::UnityEngine::ContactPoint>*> contacts);

  /// @brief Method GetContacts, addr 0x48f6044, size 0x178, virtual false, abstract: false, final false
  inline int32_t GetContacts(::System::Collections::Generic::List_1<::UnityEngine::ContactPoint>* contacts);

  /// @brief Method GetEnumerator, addr 0x48f6210, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Reuse, addr 0x48f5cc0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48f5bb0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x48f5be4, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::ContactPairHeader> header, ::ByRef<::UnityEngine::ContactPair> pair, bool flipped);

  /// @brief Method get_Flipped, addr 0x48f5a9c, size 0x8, virtual false, abstract: false, final false
  inline bool get_Flipped();

  /// @brief Method get_articulationBody, addr 0x48f56d8, size 0x80, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ArticulationBody> get_articulationBody();

  /// @brief Method get_body, addr 0x48f56c4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Component> get_body();

  /// @brief Method get_collider, addr 0x48f5848, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_contactCount, addr 0x48f5ab0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_contactCount();

  /// @brief Method get_contacts, addr 0x48f5ab8, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::ContactPoint, ::Array<::UnityEngine::ContactPoint>*> get_contacts();

  /// @brief Method get_frictionForceSum, addr 0x48f6270, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_frictionForceSum();

  /// @brief Method get_gameObject, addr 0x48f5a08, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_impactForceSum, addr 0x48f622c, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_impactForceSum();

  /// @brief Method get_impulse, addr 0x48f560c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_impulse();

  /// @brief Method get_other, addr 0x48f62b4, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Component> get_other();

  /// @brief Method get_relativeVelocity, addr 0x48f5618, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_relativeVelocity();

  /// @brief Method get_rigidbody, addr 0x48f5644, size 0x80, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody();

  /// @brief Method get_transform, addr 0x48f5974, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method set_Flipped, addr 0x48f5aa4, size 0xc, virtual false, abstract: false, final false
