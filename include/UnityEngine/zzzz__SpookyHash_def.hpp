...
DEFINE_IL2CPP_CLASS(::UnityEngine::SpookyHash_U, "UnityEngine", "SpookyHash/U");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ac5564, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::SpookyHash_U) == 0x8, "Size mismatch!");
...
public:
  ...
  /// @brief Method AttemptDetectAllowUnalignedRead, addr 0x6ac5198, size 0x84, virtual false, abstract: false, final false
  static inline bool AttemptDetectAllowUnalignedRead();

  /// @brief Method End, addr 0x6ac5a4c, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method EndPartial, addr 0x6ac5ca4, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash, addr 0x6ac4e28, size 0x370, virtual false, abstract: false, final false
  static inline void Hash(void* message, uint64_t length, uint64_t* hash1, uint64_t* hash2);

  /// @brief Method Mix, addr 0x6ac556c, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method Rot64, addr 0x6ac5f34, size 0x14, virtual false, abstract: false, final false
  static inline void Rot64(::by_ref<uint64_t> x, int32_t k);

  /// @brief Method Short, addr 0x6ac521c, size 0x348, virtual false, abstract: false, final false
  static inline void Short(void* message, uint64_t length, uint64_t* hash1, uint64_t* hash2);

  /// @brief Method ShortEnd, addr 0x6ac6168, size 0x200, virtual false, abstract: false, final false
  static inline void ShortEnd(::by_ref<uint64_t> h0, ::by_ref<uint64_t> h1, ::by_ref<uint64_t> h2, ::by_ref<uint64_t> h3);

  /// @brief Method ShortMix, addr 0x6ac5f48, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method memset, addr 0x6ac59b0, size 0x9c, virtual false, abstract: false, final false
