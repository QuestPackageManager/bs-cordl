...
/// @brief Method .ctor, addr 0x6972230, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "p8", ty: "uint8_t*", modifiers: "", def_value: None }, CppParam { name: "p32", ty: "uint32_t*", modifiers: "", def_value: None }, CppParam { name: "p64", ty: "uint64_t*", modifiers: "", def_value: None }, CppParam { name: "i", ty: "uint64_t", modifiers: "", def_value: None }]
...
/// @brief Method AttemptDetectAllowUnalignedRead, addr 0x6971e64, size 0x84, virtual false, abstract: false, final false
static inline bool AttemptDetectAllowUnalignedRead() ;

/// @brief Method End, addr 0x6972718, size 0x258, virtual false, abstract: false, final false
static inline void End(uint64_t*  data, ::ByRef<uint64_t>  h0, ::ByRef<uint64_t>  h1, ::ByRef<uint64_t>  h2, ::ByRef<uint64_t>  h3, ::ByRef<uint64_t>  h4, ::ByRef<uint64_t>  h5, ::ByRef<uint64_t>  h6, ::ByRef<uint64_t>  h7, ::ByRef<uint64_t>  h8, ::ByRef<uint64_t>  h9, ::ByRef<uint64_t>  h10, ::ByRef<uint64_t>  h11) ;

/// @brief Method EndPartial, addr 0x6972970, size 0x290, virtual false, abstract: false, final false
static inline void EndPartial(::ByRef<uint64_t>  h0, ::ByRef<uint64_t>  h1, ::ByRef<uint64_t>  h2, ::ByRef<uint64_t>  h3, ::ByRef<uint64_t>  h4, ::ByRef<uint64_t>  h5, ::ByRef<uint64_t>  h6, ::ByRef<uint64_t>  h7, ::ByRef<uint64_t>  h8, ::ByRef<uint64_t>  h9, ::ByRef<uint64_t>  h10, ::ByRef<uint64_t>  h11) ;

/// @brief Method Hash, addr 0x6971af4, size 0x370, virtual false, abstract: false, final false
static inline void Hash(void*  message, uint64_t  length, uint64_t*  hash1, uint64_t*  hash2) ;

/// @brief Method Mix, addr 0x6972238, size 0x444, virtual false, abstract: false, final false
static inline void Mix(uint64_t*  data, ::ByRef<uint64_t>  s0, ::ByRef<uint64_t>  s1, ::ByRef<uint64_t>  s2, ::ByRef<uint64_t>  s3, ::ByRef<uint64_t>  s4, ::ByRef<uint64_t>  s5, ::ByRef<uint64_t>  s6, ::ByRef<uint64_t>  s7, ::ByRef<uint64_t>  s8, ::ByRef<uint64_t>  s9, ::ByRef<uint64_t>  s10, ::ByRef<uint64_t>  s11) ;

/// @brief Method Rot64, addr 0x6972c00, size 0x14, virtual false, abstract: false, final false
static inline void Rot64(::ByRef<uint64_t>  x, int32_t  k) ;

/// @brief Method Short, addr 0x6971ee8, size 0x348, virtual false, abstract: false, final false
static inline void Short(void*  message, uint64_t  length, uint64_t*  hash1, uint64_t*  hash2) ;

/// @brief Method ShortEnd, addr 0x6972e34, size 0x200, virtual false, abstract: false, final false
static inline void ShortEnd(::ByRef<uint64_t>  h0, ::ByRef<uint64_t>  h1, ::ByRef<uint64_t>  h2, ::ByRef<uint64_t>  h3) ;

/// @brief Method ShortMix, addr 0x6972c14, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method memset, addr 0x697267c, size 0x9c, virtual false, abstract: false, final false
