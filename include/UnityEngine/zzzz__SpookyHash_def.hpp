...
public:
  ...
  /// @brief Method .ctor, addr 0x48952b0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AttemptDetectAllowUnalignedRead, addr 0x4894e98, size 0x88, virtual false, abstract: false, final false
  static inline bool AttemptDetectAllowUnalignedRead();

  /// @brief Method End, addr 0x48957dc, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndPartial, addr 0x4895a48, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method Hash, addr 0x4894b50, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method Mix, addr 0x48952b8, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rot64, addr 0x4895ce0, size 0x14, virtual false, abstract: false, final false
  static inline void Rot64(::ByRef<uint64_t> x, int32_t k);

  /// @brief Method Short, addr 0x4894f20, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method ShortEnd, addr 0x4895f10, size 0x1fc, virtual false, abstract: false, final false
  static inline void ShortEnd(::ByRef<uint64_t> h0, ::ByRef<uint64_t> h1, ::ByRef<uint64_t> h2, ::ByRef<uint64_t> h3);

  /// @brief Method ShortMix, addr 0x4895cf4, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method memset, addr 0x4895704, size 0xd8, virtual false, abstract: false, final false
