...
/// @brief Method .ctor, addr 0x69eb73c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_ThrowsException, addr 0x69eb734, size 0x8, virtual true, abstract: false, final true
