...
public:
  ...
  /// @brief Method .ctor, addr 0x69821f8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_ThrowsException, addr 0x69821f0, size 0x8, virtual true, abstract: false, final true
