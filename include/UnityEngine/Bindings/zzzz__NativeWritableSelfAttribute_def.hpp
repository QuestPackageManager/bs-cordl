...
public:
  ...
  /// @brief Method .ctor, addr 0x49190cc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WritableSelf, addr 0x49190c0, size 0xc, virtual true, abstract: false, final true
