...
public:
  ...
  /// @brief Method .ctor, addr 0x3264cb8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_WritableSelf, addr 0x3264cac, size 0xc, virtual true, abstract: false, final true
