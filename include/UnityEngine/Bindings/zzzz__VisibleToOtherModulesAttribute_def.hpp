...
public:
  ...
  /// @brief Method .ctor, addr 0x4918a84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4918a8c, size 0x8, virtual false, abstract: false, final false
