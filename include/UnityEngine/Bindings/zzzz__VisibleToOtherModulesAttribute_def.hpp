...
public:
  ...
  /// @brief Method .ctor, addr 0x4912e04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4912e0c, size 0x8, virtual false, abstract: false, final false
