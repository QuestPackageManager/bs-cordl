...
public:
  ...
  /// @brief Method .ctor, addr 0x69eaa88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69eaa8c, size 0x4, virtual false, abstract: false, final false
