...
public:
  ...
  /// @brief Method .ctor, addr 0x4918e64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4918e6c, size 0x8, virtual false, abstract: false, final false
