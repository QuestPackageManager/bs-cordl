...
public:
  ...
  /// @brief Method .ctor, addr 0x6981c04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6981c08, size 0x4, virtual false, abstract: false, final false
