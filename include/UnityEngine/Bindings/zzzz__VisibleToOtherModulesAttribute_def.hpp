...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5d390, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6a5d394, size 0x4, virtual false, abstract: false, final false
