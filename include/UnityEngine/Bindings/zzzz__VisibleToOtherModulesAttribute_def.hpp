...
public:
  ...
  /// @brief Method .ctor, addr 0x4925224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x492522c, size 0x8, virtual false, abstract: false, final false
