...
public:
  ...
  /// @brief Method .ctor, addr 0x4918dec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4918df4, size 0x8, virtual false, abstract: false, final false
