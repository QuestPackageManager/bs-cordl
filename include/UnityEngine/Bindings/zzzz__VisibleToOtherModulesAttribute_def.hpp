...
public:
  ...
  /// @brief Method .ctor, addr 0x491c1f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x491c1fc, size 0x8, virtual false, abstract: false, final false
