...
public:
  ...
  /// @brief Method .ctor, addr 0x491c61c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x491c624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x491c628, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFree, ::UnityEngine::Bindings::TargetType targetType);

  /// @brief Method .ctor, addr 0x491c658, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFree, ::UnityEngine::Bindings::TargetType targetType, bool isThreadSafe);

  /// @brief Method set_TargetType, addr 0x491c614, size 0x8, virtual false, abstract: false, final false
