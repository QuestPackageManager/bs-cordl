...
public:
  ...
  /// @brief Method .ctor, addr 0x4916ad8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_DoesNotContributeToSize, addr 0x4916acc, size 0xc, virtual false, abstract: false, final false
