...
public:
  ...
  /// @brief Method .ctor, addr 0x49135a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_DoesNotContributeToSize, addr 0x4913598, size 0xc, virtual false, abstract: false, final false
