...
/// @brief Method .ctor, addr 0x69eb750, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_DoesNotContributeToSize, addr 0x69eb748, size 0x8, virtual false, abstract: false, final false
