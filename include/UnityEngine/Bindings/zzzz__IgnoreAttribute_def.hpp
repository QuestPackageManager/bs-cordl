...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5d998, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_DoesNotContributeToSize, addr 0x6a5d990, size 0x8, virtual false, abstract: false, final false
