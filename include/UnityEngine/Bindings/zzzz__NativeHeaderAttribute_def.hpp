...
public:
  ...
  /// @brief Method .ctor, addr 0x4918ec0, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  /// @brief Method set_Header, addr 0x4918eb8, size 0x8, virtual true, abstract: false, final true
