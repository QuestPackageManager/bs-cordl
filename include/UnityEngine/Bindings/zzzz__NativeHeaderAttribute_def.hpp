...
public:
  ...
  /// @brief Method .ctor, addr 0x69eaad0, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::StringW header);

  /// @brief Method set_Header, addr 0x69eaac8, size 0x8, virtual true, abstract: false, final true
