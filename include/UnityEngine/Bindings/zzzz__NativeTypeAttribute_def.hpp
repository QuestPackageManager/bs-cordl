...
namespace UnityEngine::Bindings {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2547)), TypeDefinitionIndex(TypeDefinitionIndex(16115))]
...
public:
  ...
  /// @brief Method set_Header, addr 0x2d3918c, size 0x8, virtual true, abstract: false, final true
  inline void set_Header(::StringW value);

  /// @brief Method set_IntermediateScriptingStructName, addr 0x2d39194, size 0x8, virtual false, abstract: false, final false
  inline void set_IntermediateScriptingStructName(::StringW value);

  /// @brief Method set_CodegenOptions, addr 0x2d3919c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2d391a4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Bindings::NativeTypeAttribute* New_ctor(::UnityEngine::Bindings::CodegenOptions codegenOptions);

  /// @brief Method .ctor, addr 0x2d391c0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d391e8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d392f0, size 0x30, virtual false, abstract: false, final false
