...
public:
  ...
  /// @brief Method set_Header addr 0x2d186e4 size 0x8 virtual true final true
  inline void set_Header(::StringW value);

  /// @brief Method set_IntermediateScriptingStructName addr 0x2d186ec size 0x8 virtual false final false
  inline void set_IntermediateScriptingStructName(::StringW value);

  /// @brief Method set_CodegenOptions addr 0x2d186f4 size 0x8 virtual true final true
  ...
  /// @brief Method .ctor addr 0x2d186fc size 0x1c virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::Bindings::NativeTypeAttribute* New_ctor(::UnityEngine::Bindings::CodegenOptions codegenOptions);

  /// @brief Method .ctor addr 0x2d18718 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d18740 size 0x108 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d18848 size 0x30 virtual false final false
