...
// Ctor Parameters [CppParam { name: "arrayWrapper", ty: "::UnityEngine::Bindings::BlittableArrayWrapper", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "listSize", ty:
