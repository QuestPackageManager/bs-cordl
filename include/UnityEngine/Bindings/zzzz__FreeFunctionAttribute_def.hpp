...
public:
  ...
  /// @brief Method .ctor, addr 0x698216c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6982178, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6982194, size 0x2c, virtual false, abstract: false, final false
