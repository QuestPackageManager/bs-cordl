...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Bindings::BlittableArrayWrapper::*)(void*, int32_t)>(&::UnityEngine::Bindings::BlittableArrayWrapper::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x6934624;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Bindings::BlittableArrayWrapper>::get(),
                        ".ctor",
...
template<typename T>
inline void UnityEngine::Bindings::BlittableArrayWrapper::Unmarshal(::ByRef<::ArrayW<T,::Array<T>*>>  array)  {
