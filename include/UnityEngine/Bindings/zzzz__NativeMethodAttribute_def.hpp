...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5d5f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6a5d5fc, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6a5d6f4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFreeFunction);

  /// @brief Method .ctor, addr 0x6a5d718, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, bool isFreeFunction, bool isThreadSafe);

  /// @brief Method set_HasExplicitThis, addr 0x6a5d5f0, size 0x8, virtual true, abstract: false, final true
  inline void set_HasExplicitThis(bool value);

  /// @brief Method set_IsFreeFunction, addr 0x6a5d5e0, size 0x8, virtual true, abstract: false, final true
  inline void set_IsFreeFunction(bool value);

  /// @brief Method set_IsThreadSafe, addr 0x6a5d5d8, size 0x8, virtual true, abstract: false, final true
  inline void set_IsThreadSafe(bool value);

  /// @brief Method set_Name, addr 0x6a5d5d0, size 0x8, virtual true, abstract: false, final true
  inline void set_Name(::StringW value);

  /// @brief Method set_ThrowsException, addr 0x6a5d5e8, size 0x8, virtual true, abstract: false, final true
