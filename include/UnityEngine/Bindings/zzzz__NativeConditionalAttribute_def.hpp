...
/// @brief Method .ctor, addr 0x69eb168, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition) ;

/// @brief Method .ctor, addr 0x69eb178, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition, ::StringW  stubReturnStatement) ;

/// @brief Method set_Condition, addr 0x69eb150, size 0x8, virtual false, abstract: false, final false
inline void set_Condition(::StringW  value) ;

/// @brief Method set_Enabled, addr 0x69eb160, size 0x8, virtual false, abstract: false, final false
inline void set_Enabled(bool  value) ;

/// @brief Method set_StubReturnStatement, addr 0x69eb158, size 0x8, virtual false, abstract: false, final false
