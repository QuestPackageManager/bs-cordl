...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5d3b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW condition);

  /// @brief Method .ctor, addr 0x6a5d3c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::StringW condition, ::StringW stubReturnStatement);

  /// @brief Method set_Condition, addr 0x6a5d398, size 0x8, virtual false, abstract: false, final false
  inline void set_Condition(::StringW value);

  /// @brief Method set_Enabled, addr 0x6a5d3a8, size 0x8, virtual false, abstract: false, final false
  inline void set_Enabled(bool value);

  /// @brief Method set_StubReturnStatement, addr 0x6a5d3a0, size 0x8, virtual false, abstract: false, final false
