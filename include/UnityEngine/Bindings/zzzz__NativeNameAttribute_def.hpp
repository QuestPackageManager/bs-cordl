...
public:
  ...
  /// @brief Method .ctor, addr 0x6981d4c, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x6981d44, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 22698 };
