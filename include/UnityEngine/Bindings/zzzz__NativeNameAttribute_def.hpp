...
public:
  ...
  /// @brief Method .ctor, addr 0x4918be4, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x4918bdc, size 0x8, virtual true, abstract: false, final true
