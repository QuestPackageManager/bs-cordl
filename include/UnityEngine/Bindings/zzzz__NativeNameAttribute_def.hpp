...
/// @brief Method .ctor, addr 0x6a5f050, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method set_Name, addr 0x6a5f048, size 0x8, virtual true, abstract: false, final true
