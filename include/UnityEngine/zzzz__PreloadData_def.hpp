...
public:
  ...
  /// @brief Method PreloadDataDontStripMe, addr 0x6af0324, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PreloadData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PreloadData(PreloadData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PreloadData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PreloadData(PreloadDataconst&) = delete;
