...
public:
  ...
  /// @brief Method .ctor, addr 0x6987400, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CollectTerrains>b__0, addr 0x6987764, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6987404, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AutoConnect, addr 0x6987408, size 0x35c, virtual false, abstract: false, final false
  static inline void AutoConnect();

  /// @brief Method ClearConnectivity, addr 0x69870a0, size 0xa4, virtual false, abstract: false, final false
  static inline void ClearConnectivity();

  /// @brief Method CollectTerrains, addr 0x6987144, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidTerrainsExist, addr 0x6987040, size 0x60, virtual false, abstract: false, final false
