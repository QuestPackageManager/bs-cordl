...
// Write type traits
MARK_REF_T(::UnityEngine::TerrainUtils::TerrainUtility*);
MARK_REF_T(::UnityEngine::TerrainUtils::TerrainUtility___c__DisplayClass2_0*);
MARK_REF_T(::UnityEngine::TerrainUtils::TerrainUtility___c__DisplayClass2_1*);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::TerrainUtils::TerrainUtility) == 0x10, "Size mismatch!");
