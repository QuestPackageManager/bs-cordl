...
public:
  ...
  /// @brief Method .ctor, addr 0x491aaf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CollectTerrains>b__0, addr 0x491ae8c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491aafc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AutoConnect, addr 0x491ab04, size 0x388, virtual false, abstract: false, final false
  static inline void AutoConnect();

  /// @brief Method ClearConnectivity, addr 0x491a720, size 0xf8, virtual false, abstract: false, final false
  static inline void ClearConnectivity();

  /// @brief Method CollectTerrains, addr 0x491a818, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidTerrainsExist, addr 0x491a6b8, size 0x68, virtual false, abstract: false, final false
