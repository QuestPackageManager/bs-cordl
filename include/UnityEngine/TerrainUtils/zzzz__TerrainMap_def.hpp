...
/// @brief Method <CreateFromPlacement>b__0, addr 0x6a64318, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a633f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_terrainTiles, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_terrainTiles, put=__cordl_internal_set_m_terrainTiles)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::TerrainUtils::TerrainTileCoord,::UnityW<::UnityEngine::Terrain>>*  m_terrainTiles;
...
/// @brief Method AddTerrainInternal, addr 0x6a63ab8, size 0x130, virtual false, abstract: false, final false
inline void AddTerrainInternal(int32_t  x, int32_t  z, ::UnityEngine::Terrain*  terrain) ;

/// @brief Method CreateFromPlacement, addr 0x6a633f4, size 0x3dc, virtual false, abstract: false, final false
static inline ::UnityEngine::TerrainUtils::TerrainMap* CreateFromPlacement(::UnityEngine::Vector2  gridOrigin, ::UnityEngine::Vector2  gridSize, ::System::Predicate_1<::UnityW<::UnityEngine::Terrain>>*  filter, bool  fullValidation) ;

/// @brief Method CreateFromPlacement, addr 0x6a631c4, size 0x22c, virtual false, abstract: false, final false
static inline ::UnityEngine::TerrainUtils::TerrainMap* CreateFromPlacement(::UnityEngine::Terrain*  originTerrain, ::System::Predicate_1<::UnityW<::UnityEngine::Terrain>>*  filter, bool  fullValidation) ;

/// @brief Method GetTerrain, addr 0x6a63140, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method TryToAddTerrain, addr 0x6a6386c, size 0x118, virtual false, abstract: false, final false
inline bool TryToAddTerrain(int32_t  tileX, int32_t  tileZ, ::UnityEngine::Terrain*  terrain) ;

/// @brief Method Validate, addr 0x6a63984, size 0x12c, virtual false, abstract: false, final false
inline ::UnityEngine::TerrainUtils::TerrainMapStatusCode Validate() ;

/// @brief Method ValidateTerrain, addr 0x6a63be8, size 0x730, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a637d0, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_terrainTiles, addr 0x6a63ab0, size 0x8, virtual false, abstract: false, final false
