...
// Write type traits
MARK_REF_T(::UnityEngine::TerrainUtils::TerrainMap*);
...
public:
  ...
  /// @brief Method <CreateFromPlacement>b__0, addr 0x6bb81d0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bb72a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::TerrainUtils::TerrainMap___c__DisplayClass3_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddTerrainInternal, addr 0x6bb7970, size 0x130, virtual false, abstract: false, final false
  inline void AddTerrainInternal(int32_t x, int32_t z, ::UnityEngine::Terrain* terrain);

  /// @brief Method CreateFromPlacement, addr 0x6bb72ac, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFromPlacement, addr 0x6bb707c, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTerrain, addr 0x6bb6ff8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToAddTerrain, addr 0x6bb7724, size 0x118, virtual false, abstract: false, final false
  inline bool TryToAddTerrain(int32_t tileX, int32_t tileZ, ::UnityEngine::Terrain* terrain);

  /// @brief Method Validate, addr 0x6bb783c, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::TerrainUtils::TerrainMapStatusCode Validate();

  /// @brief Method ValidateTerrain, addr 0x6bb7aa0, size 0x730, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bb7688, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_terrainTiles, addr 0x6bb7968, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TerrainUtils::TerrainMap) == 0x28, "Size mismatch!");
