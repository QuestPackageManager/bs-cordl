...
public:
  ...
  /// @brief Method <CreateFromPlacement>b__0, addr 0x4920df8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491fe60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddTerrainInternal, addr 0x4920554, size 0x128, virtual false, abstract: false, final false
  inline void AddTerrainInternal(int32_t x, int32_t z, ::UnityEngine::Terrain* terrain);

  /// @brief Method CreateFromPlacement, addr 0x491fe68, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFromPlacement, addr 0x491fbb4, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTerrain, addr 0x491fb3c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToAddTerrain, addr 0x49202d4, size 0x114, virtual false, abstract: false, final false
  inline bool TryToAddTerrain(int32_t tileX, int32_t tileZ, ::UnityEngine::Terrain* terrain);

  /// @brief Method Validate, addr 0x49203e8, size 0x164, virtual false, abstract: false, final false
  inline ::UnityEngine::TerrainUtils::TerrainMapStatusCode Validate();

  /// @brief Method ValidateTerrain, addr 0x492067c, size 0x77c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4920250, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_terrainTiles, addr 0x492054c, size 0x8, virtual false, abstract: false, final false
