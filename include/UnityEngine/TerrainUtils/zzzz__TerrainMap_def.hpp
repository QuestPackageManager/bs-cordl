...
public:
  ...
  /// @brief Method <CreateFromPlacement>b__0, addr 0x491db94, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491cbfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddTerrainInternal, addr 0x491d2f0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToAddTerrain, addr 0x491d070, size 0x114, virtual false, abstract: false, final false
  inline bool TryToAddTerrain(int32_t tileX, int32_t tileZ, ::UnityEngine::Terrain* terrain);

  /// @brief Method Validate, addr 0x491d184, size 0x164, virtual false, abstract: false, final false
  inline ::UnityEngine::TerrainUtils::TerrainMapStatusCode Validate();

  /// @brief Method ValidateTerrain, addr 0x491d418, size 0x77c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491cfec, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_terrainTiles, addr 0x491d2e8, size 0x8, virtual false, abstract: false, final false
