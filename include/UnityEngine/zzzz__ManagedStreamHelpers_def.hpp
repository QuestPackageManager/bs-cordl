...
public:
  // Declarations
  /// @brief Method ValidateLoadFromStream addr 0x2cd3868 size 0x110 virtual false final false
  static inline void ValidateLoadFromStream(::System::IO::Stream* stream);

  /// @brief Method ManagedStreamRead addr 0x2cd3978 size 0x120 virtual false final false
  ...
  /// @brief Method ManagedStreamSeek addr 0x2cd3a98 size 0x118 virtual false final false
  static inline void ManagedStreamSeek(int64_t offset, uint32_t origin, ::System::IO::Stream* stream, void* returnValueAddress);

  /// @brief Method ManagedStreamLength addr 0x2cd3bb0 size 0xfc virtual false final false
