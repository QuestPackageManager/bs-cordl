...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAnimationWindowPreview", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAnimationWindowPreview(IAnimationWindowPreviewconst&) = delete;
