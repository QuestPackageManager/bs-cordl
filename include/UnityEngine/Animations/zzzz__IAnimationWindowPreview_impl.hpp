...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Animations::IAnimationWindowPreview::*)(::UnityEngine::Playables::PlayableGraph)>(&::UnityEngine::Animations::IAnimationWindowPreview::UpdatePreviewGraph)> {
