...
public:
  ...
  /// @brief Method Create, addr 0x68ea4c4, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Animations::AnimationMotionXToDeltaPlayable Create(::UnityEngine::Playables::PlayableGraph graph);

  /// @brief Method CreateHandle, addr 0x68ea558, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::PlayableHandle CreateHandle(::UnityEngine::Playables::PlayableGraph graph);

  /// @brief Method CreateHandleInternal, addr 0x68ea778, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x68ea9ec, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x68ea87c, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationMotionXToDeltaPlayable other);

  /// @brief Method GetHandle, addr 0x68ea808, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetAbsoluteMotion, addr 0x68ea920, size 0x88, virtual false, abstract: false, final false
  inline void SetAbsoluteMotion(bool value);

  /// @brief Method SetAbsoluteMotionInternal, addr 0x68ea9a8, size 0x44, virtual false, abstract: false, final false
  static inline void SetAbsoluteMotionInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x68ea664, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x68ea814, size 0x68, virtual false, abstract: false, final false
