...
public:
  ...
  /// @brief Method Create, addr 0x2ddcbf4, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Animations::AnimationMotionXToDeltaPlayable Create(::UnityEngine::Playables::PlayableGraph graph);

  /// @brief Method CreateHandle, addr 0x2ddcc84, size 0xe0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::PlayableHandle CreateHandle(::UnityEngine::Playables::PlayableGraph graph);

  /// @brief Method CreateHandleInternal, addr 0x2ddce24, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x2ddd02c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2ddceec, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationMotionXToDeltaPlayable other);

  /// @brief Method GetHandle, addr 0x2ddceb0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetAbsoluteMotion, addr 0x2ddcf64, size 0x84, virtual false, abstract: false, final false
  inline void SetAbsoluteMotion(bool value);

  /// @brief Method SetAbsoluteMotionInternal, addr 0x2ddcfe8, size 0x44, virtual false, abstract: false, final false
  static inline void SetAbsoluteMotionInternal(ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x2ddcd64, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2ddcebc, size 0x30, virtual false, abstract: false, final false
