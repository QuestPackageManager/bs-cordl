...
public:
  ...
  /// @brief Method Create, addr 0x2d7f8d4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x2d7f96c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x2d7fb10, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x2d7fc50, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2d7fbd8, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationMixerPlayable other);

  /// @brief Method GetHandle, addr 0x2d7fb9c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x2d7fa50, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2d7fba8, size 0x30, virtual false, abstract: false, final false
