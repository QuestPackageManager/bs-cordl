...
public:
  ...
  /// @brief Method Create, addr 0x4859d90, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x4859e28, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x485a004, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x485a1b8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x485a11c, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationMixerPlayable other);

  /// @brief Method GetHandle, addr 0x485a090, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x4859f14, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x485a09c, size 0x80, virtual false, abstract: false, final false
