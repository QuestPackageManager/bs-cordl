...
public:
  ...
  /// @brief Method Create addr 0x2b30cd8 size 0x98 virtual false final false
  ...
  /// @brief Method CreateHandle addr 0x2b30d70 size 0xe4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b30e54 size 0xc0 virtual false final false
  inline void _ctor(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method GetHandle addr 0x2b30fa0 size 0xc virtual true final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method op_Implicit addr 0x2b30fac size 0x30 virtual false final false
  ...
  /// @brief Method Equals addr 0x2b30fdc size 0xac virtual true final true
  inline bool Equals(::UnityEngine::Animations::AnimationRemoveScalePlayable other);

  /// @brief Method CreateHandleInternal addr 0x2b30f14 size 0x8c virtual false final false
  ...
  /// @brief Method CreateHandleInternal_Injected addr 0x2b31088 size 0x44 virtual false final false
