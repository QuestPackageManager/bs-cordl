...
public:
  ...
  /// @brief Method Create, addr 0x68eba5c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x68ebaf8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x68ebd1c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x68ebed8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x68ebe20, size 0xb8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationRemoveScalePlayable other);

  /// @brief Method GetHandle, addr 0x68ebdac, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x68ebc08, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x68ebdb8, size 0x68, virtual false, abstract: false, final false
