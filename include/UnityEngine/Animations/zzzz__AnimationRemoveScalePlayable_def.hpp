...
public:
  ...
  /// @brief Method Create, addr 0x47dfb54, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x47dfbec, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x47dfdc8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x47dff94, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x47dfee0, size 0xb4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationRemoveScalePlayable other);

  /// @brief Method GetHandle, addr 0x47dfe54, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x47dfcd8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x47dfe60, size 0x80, virtual false, abstract: false, final false
