...
public:
  ...
  /// @brief Method SetAnimatedPropertiesInternal, addr 0x68eb118, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAnimatedPropertiesInternal_Injected, addr 0x68eb1a8, size 0x44, virtual false, abstract: false, final false
