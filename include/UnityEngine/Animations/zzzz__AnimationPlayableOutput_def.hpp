...
/// @brief Method Create, addr 0x687702c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetHandle, addr 0x6879514, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method GetTarget, addr 0x68795a0, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Animator> GetTarget() ;

/// @brief Method InternalGetTarget, addr 0x68795a4, size 0x120, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Animator> InternalGetTarget(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle) ;

/// @brief Method InternalGetTarget_Injected, addr 0x6879754, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr InternalGetTarget_Injected(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle) ;

/// @brief Method InternalSetTarget, addr 0x68796c4, size 0x90, virtual false, abstract: false, final false
static inline void InternalSetTarget(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle, ::UnityEngine::Animator*  target) ;

/// @brief Method InternalSetTarget_Injected, addr 0x6879790, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetTarget, addr 0x6879510, size 0x4, virtual false, abstract: false, final false
inline void SetTarget(::UnityEngine::Animator*  value) ;

/// @brief Method .ctor, addr 0x68793fc, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x687937c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method op_Explicit, addr 0x6879520, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x687708c, size 0x4, virtual false, abstract: false, final false
