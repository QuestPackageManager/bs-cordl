...
public:
  ...
  /// @brief Method Create, addr 0x6a41ac8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHandle, addr 0x6a43fb0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle();

  /// @brief Method GetTarget, addr 0x6a4403c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> GetTarget();

  /// @brief Method InternalGetTarget, addr 0x6a44040, size 0x120, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Animator> InternalGetTarget(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> handle);

  /// @brief Method InternalGetTarget_Injected, addr 0x6a441f0, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr InternalGetTarget_Injected(::by_ref<::UnityEngine::Playables::PlayableOutputHandle> handle);

  /// @brief Method InternalSetTarget, addr 0x6a44160, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetTarget_Injected, addr 0x6a4422c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTarget, addr 0x6a43fac, size 0x4, virtual false, abstract: false, final false
  inline void SetTarget(::UnityEngine::Animator* value);

  /// @brief Method .ctor, addr 0x6a43e98, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle handle);

  /// @brief Method get_Null, addr 0x6a43e18, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x6a43fbc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6a41b28, size 0x4, virtual false, abstract: false, final false
