...
public:
  // Declarations
  /// @brief Method Create, addr 0x68e8f34, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::PlayableBinding Create(::StringW name, ::UnityEngine::Object* key);

  /// @brief Method CreateAnimationOutput, addr 0x68e9030, size 0x8, virtual false, abstract: false, final false
