...
public:
  ...
  /// @brief Method Create, addr 0x680ee58, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x680ee90, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x680f054, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x680f3a8, size 0x54, virtual false, abstract: false, final false
  static inline bool CreateHandleInternal_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph> graph, ::System::IntPtr clip, ::ByRef<::UnityEngine::Playables::PlayableHandle> handle);

  /// @brief Method Equals, addr 0x680f10c, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationClipPlayable other);

  /// @brief Method GetHandle, addr 0x680f0fc, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetApplyFootIK, addr 0x680f188, size 0x44, virtual false, abstract: false, final false
  inline void SetApplyFootIK(bool value);

  /// @brief Method SetApplyFootIKInternal, addr 0x680f1cc, size 0x44, virtual false, abstract: false, final false
  static inline void SetApplyFootIKInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetLoopTime, addr 0x680f320, size 0x44, virtual false, abstract: false, final false
  inline void SetLoopTime(bool value);

  /// @brief Method SetLoopTimeInternal, addr 0x680f364, size 0x44, virtual false, abstract: false, final false
  static inline void SetLoopTimeInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetOverrideLoopTime, addr 0x680f298, size 0x44, virtual false, abstract: false, final false
  inline void SetOverrideLoopTime(bool value);

  /// @brief Method SetOverrideLoopTimeInternal, addr 0x680f2dc, size 0x44, virtual false, abstract: false, final false
  static inline void SetOverrideLoopTimeInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetRemoveStartOffset, addr 0x680f210, size 0x44, virtual false, abstract: false, final false
  inline void SetRemoveStartOffset(bool value);

  /// @brief Method SetRemoveStartOffsetInternal, addr 0x680f254, size 0x44, virtual false, abstract: false, final false
  static inline void SetRemoveStartOffsetInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x680ef40, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x680f108, size 0x4, virtual false, abstract: false, final false
