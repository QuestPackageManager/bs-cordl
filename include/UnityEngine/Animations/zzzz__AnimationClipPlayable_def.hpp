...
public:
  ...
  /// @brief Method Create, addr 0x48563bc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x48563f4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x4856590, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x48568c0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x4856628, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationClipPlayable other);

  /// @brief Method GetHandle, addr 0x48565ec, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetApplyFootIK, addr 0x48566a0, size 0x44, virtual false, abstract: false, final false
  inline void SetApplyFootIK(bool value);

  /// @brief Method SetApplyFootIKInternal, addr 0x48566e4, size 0x44, virtual false, abstract: false, final false
  static inline void SetApplyFootIKInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetLoopTime, addr 0x4856838, size 0x44, virtual false, abstract: false, final false
  inline void SetLoopTime(bool value);

  /// @brief Method SetLoopTimeInternal, addr 0x485687c, size 0x44, virtual false, abstract: false, final false
  static inline void SetLoopTimeInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetOverrideLoopTime, addr 0x48567b0, size 0x44, virtual false, abstract: false, final false
  inline void SetOverrideLoopTime(bool value);

  /// @brief Method SetOverrideLoopTimeInternal, addr 0x48567f4, size 0x44, virtual false, abstract: false, final false
  static inline void SetOverrideLoopTimeInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method SetRemoveStartOffset, addr 0x4856728, size 0x44, virtual false, abstract: false, final false
  inline void SetRemoveStartOffset(bool value);

  /// @brief Method SetRemoveStartOffsetInternal, addr 0x485676c, size 0x44, virtual false, abstract: false, final false
  static inline void SetRemoveStartOffsetInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x48564a0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x48565f8, size 0x30, virtual false, abstract: false, final false
