...
// Ctor Parameters [CppParam { name: "m_AnimatorBindingsVersion", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "constant", ty: "::System::IntPtr", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "input", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "output", ty:
// "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "workspace", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "inputStreamAccessor", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "animationHandleBinder", ty: "::System::IntPtr", modifiers: "",
