...
public:
  ...
  /// @brief Method Equals, addr 0x47f4bac, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimatorControllerPlayable other);

  /// @brief Method GetHandle, addr 0x47f4ba0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetHandle, addr 0x47f4a5c, size 0x144, virtual false, abstract: false, final false
  inline void SetHandle(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method .ctor, addr 0x47f49c0, size 0x9c, virtual false, abstract: false, final false
