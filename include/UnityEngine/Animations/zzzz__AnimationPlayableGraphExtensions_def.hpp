...
public:
// Declarations
/// @brief Method InternalCreateAnimationOutput, addr 0x68791e0, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method InternalCreateAnimationOutput_Injected, addr 0x6879328, size 0x54, virtual false, abstract: false, final false
