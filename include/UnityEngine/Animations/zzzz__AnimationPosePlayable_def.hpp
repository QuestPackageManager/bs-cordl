...
/// @brief Method Equals, addr 0x68ed478, size 0xb8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Animations::AnimationPosePlayable  other) ;

/// @brief Method GetHandle, addr 0x68ed46c, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method .ctor, addr 0x68ed358, size 0x114, virtual false, abstract: false, final false
