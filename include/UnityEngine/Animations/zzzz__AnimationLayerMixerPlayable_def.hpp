...
public:
  ...
  /// @brief Method Create, addr 0x68e9640, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x68e96ec, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x68e9970, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x68e9e34, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x68e9ab8, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationLayerMixerPlayable other);

  /// @brief Method GetHandle, addr 0x68e9a44, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetLayerMaskFromAvatarMask, addr 0x68e9b5c, size 0x218, virtual false, abstract: false, final false
  inline void SetLayerMaskFromAvatarMask(uint32_t layerIndex, ::UnityEngine::AvatarMask* mask);

  /// @brief Method SetLayerMaskFromAvatarMaskInternal, addr 0x68e9d74, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLayerMaskFromAvatarMaskInternal_Injected, addr 0x68e9e78, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSingleLayerOptimizationInternal, addr 0x68e9a00, size 0x44, virtual false, abstract: false, final false
  static inline void SetSingleLayerOptimizationInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x68e97fc, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x68e9a50, size 0x68, virtual false, abstract: false, final false
