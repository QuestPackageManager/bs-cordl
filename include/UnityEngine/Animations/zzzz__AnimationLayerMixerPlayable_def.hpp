...
public:
  ...
  /// @brief Method Create, addr 0x33caefc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x33caf6c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x33cb014, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x33cb20c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x33cb5c4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x33cb318, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationLayerMixerPlayable other);

  /// @brief Method GetHandle, addr 0x33cb2dc, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetLayerMaskFromAvatarMask, addr 0x33cb390, size 0x1e0, virtual false, abstract: false, final false
  inline void SetLayerMaskFromAvatarMask(uint32_t layerIndex, ::UnityEngine::AvatarMask* mask);

  /// @brief Method SetLayerMaskFromAvatarMaskInternal, addr 0x33cb570, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSingleLayerOptimizationInternal, addr 0x33cb298, size 0x44, virtual false, abstract: false, final false
  static inline void SetSingleLayerOptimizationInternal(ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x33cb0f8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x33cb2e8, size 0x30, virtual false, abstract: false, final false
