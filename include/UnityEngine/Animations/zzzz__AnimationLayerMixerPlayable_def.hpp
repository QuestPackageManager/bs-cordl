...
public:
  ...
  /// @brief Method Create, addr 0x48550f0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x4855198, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x48553d0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x4855830, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x485552c, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationLayerMixerPlayable other);

  /// @brief Method GetHandle, addr 0x48554a0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method SetLayerMaskFromAvatarMask, addr 0x48555c8, size 0x214, virtual false, abstract: false, final false
  inline void SetLayerMaskFromAvatarMask(uint32_t layerIndex, ::UnityEngine::AvatarMask* mask);

  /// @brief Method SetLayerMaskFromAvatarMaskInternal, addr 0x48557dc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSingleLayerOptimizationInternal, addr 0x485545c, size 0x44, virtual false, abstract: false, final false
  static inline void SetSingleLayerOptimizationInternal(::ByRef<::UnityEngine::Playables::PlayableHandle> handle, bool value);

  /// @brief Method .ctor, addr 0x4855284, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x48554ac, size 0x80, virtual false, abstract: false, final false
