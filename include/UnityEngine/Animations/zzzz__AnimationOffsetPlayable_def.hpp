...
public:
  ...
  /// @brief Method Create addr 0x2b31408 size 0xf0 virtual false final false
  ...
  /// @brief Method CreateHandle addr 0x2b314f8 size 0x13c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b31634 size 0xc0 virtual false final false
  inline void _ctor(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method GetHandle addr 0x2b31798 size 0xc virtual true final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method op_Implicit addr 0x2b317a4 size 0x30 virtual false final false
  ...
  /// @brief Method Equals addr 0x2b317d4 size 0xac virtual true final true
  inline bool Equals(::UnityEngine::Animations::AnimationOffsetPlayable other);

  /// @brief Method CreateHandleInternal addr 0x2b316f4 size 0xa4 virtual false final false
  ...
  /// @brief Method CreateHandleInternal_Injected addr 0x2b31880 size 0x5c virtual false final false
