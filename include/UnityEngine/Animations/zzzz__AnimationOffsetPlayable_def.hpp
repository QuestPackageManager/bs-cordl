...
public:
  ...
  /// @brief Method Create, addr 0x2d7dce8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x2d7ddd8, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x2d7dfd4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x2d7e160, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2d7e0b4, size 0xac, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationOffsetPlayable other);

  /// @brief Method GetHandle, addr 0x2d7e078, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x2d7df14, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2d7e084, size 0x30, virtual false, abstract: false, final false
