...
public:
  ...
  /// @brief Method Create, addr 0x68eaad4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x68eabc8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal, addr 0x68eae44, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandleInternal_Injected, addr 0x68eb018, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x68eaf60, size 0xb8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Animations::AnimationOffsetPlayable other);

  /// @brief Method GetHandle, addr 0x68eaeec, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x68ead30, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x68eaef8, size 0x68, virtual false, abstract: false, final false
