...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x490b01c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x490b038, size 0xc, virtual false, abstract: false, final false
