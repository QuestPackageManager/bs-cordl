...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x69ca9a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x69ca9b8, size 0xc, virtual false, abstract: false, final false
