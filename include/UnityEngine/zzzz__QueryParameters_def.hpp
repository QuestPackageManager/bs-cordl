...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x48a9ec0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x48a9edc, size 0xc, virtual false, abstract: false, final false
