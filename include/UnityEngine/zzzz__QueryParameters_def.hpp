...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x491d43c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x491d458, size 0xc, virtual false, abstract: false, final false
