...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x491440c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x4914428, size 0xc, virtual false, abstract: false, final false
