...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6961b20, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x6961b34, size 0xc, virtual false, abstract: false, final false
