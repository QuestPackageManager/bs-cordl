...
/// @brief Method AcquireMainThreadSynchronizationContext, addr 0x6862c1c, size 0xac, virtual false, abstract: false, final false
static inline void AcquireMainThreadSynchronizationContext() ;

/// @brief Method DispatchConfigurationChanged, addr 0x6862ecc, size 0x74, virtual false, abstract: false, final false
static inline void DispatchConfigurationChanged(bool  notifySubscribers) ;

/// @brief Method GetCurrentConfiguration, addr 0x6862e80, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::Android::AndroidConfiguration* GetCurrentConfiguration() ;

/// @brief Method SetCurrentConfiguration, addr 0x6862e30, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentActivityRaw, addr 0x6862bf4, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr get_CurrentActivityRaw() ;

/// @brief Method get_CurrentContextRaw, addr 0x6862bcc, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr get_CurrentContextRaw() ;

/// @brief Method get_UnityPlayerRaw, addr 0x684f8d4, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr get_UnityPlayerRaw() ;

/// @brief Method get_currentActivity, addr 0x6862d7c, size 0xb4, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* get_currentActivity() ;

/// @brief Method get_currentContext, addr 0x6862cc8, size 0xb4, virtual false, abstract: false, final false
