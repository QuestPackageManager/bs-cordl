...
public:
  ...
  /// @brief Method .ctor, addr 0x68d6944, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW _country, ::StringW _language);

  /// @brief Method get_country, addr 0x68d6934, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_country();

  /// @brief Method get_language, addr 0x68d693c, size 0x8, virtual false, abstract: false, final false
