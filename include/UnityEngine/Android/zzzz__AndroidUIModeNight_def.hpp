...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidUIModeNight, "UnityEngine.Android", "AndroidUIModeNight");
// Dependencies
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Android::AndroidUIModeNight) == 0x4, "Size mismatch!");
