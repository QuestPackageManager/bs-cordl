...
/// @brief Method <.ctor>b__2_0, addr 0x6863808, size 0x8, virtual false, abstract: false, final false
inline ::StringW __ctor_b__2_0(::StringW  ap) ;

/// @brief Method <.ctor>b__2_1, addr 0x6863810, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Android::AndroidAssetPackStatus __ctor_b__2_1(::StringW  ap) ;

/// @brief Method .ctor, addr 0x6863804, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_AssetPacks, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AssetPacks, put=__cordl_internal_set_m_AssetPacks)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::Android::AndroidAssetPackStatus>*  m_AssetPacks;
...
static inline ::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerDownloadStatusCallback* New_ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackInfo*>*  callback, ::ArrayW<::StringW,::Array<::StringW>*>  assetPacks) ;
...
/// @brief Method .ctor, addr 0x6863308, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method onStatusUpdate, addr 0x6863500, size 0x274, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerMobileDataConfirmationCallback* New_ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*>*  callback) ;
...
/// @brief Method .ctor, addr 0x6863818, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*>*  callback) ;

/// @brief Method onMobileDataConfirmationResult, addr 0x68638a0, size 0x88, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerStatusQueryCallback* New_ctor(::System::Action_2<uint64_t,::ArrayW<::UnityEngine::Android::AndroidAssetPackState*,::Array<::UnityEngine::Android::AndroidAssetPackState*>*>>*  callback, ::ArrayW<::StringW,::Array<::StringW>*>  assetPacks) ;
...
constexpr ::System::Action_2<uint64_t,::ArrayW<::UnityEngine::Android::AndroidAssetPackState*,::Array<::UnityEngine::Android::AndroidAssetPackState*>*>>* const& __cordl_internal_get_m_Callback() const;
...
/// @brief Method .ctor, addr 0x6863928, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method onStatusResult, addr 0x6863a28, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method GetAssetPackManager, addr 0x6862f88, size 0x380, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Android::AndroidAssetPacks_AssetPackManagerMobileDataConfirmationCallback*, "UnityEngine.Android", "AndroidAssetPacks/AssetPackManagerMobileDataConfirmationCallback");
