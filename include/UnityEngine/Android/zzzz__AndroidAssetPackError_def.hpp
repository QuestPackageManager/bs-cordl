...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPackError, "UnityEngine.Android", "AndroidAssetPackError");
// Dependencies
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPackError) == 0x4, "Size mismatch!");
