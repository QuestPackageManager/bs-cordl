...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::PermissionCallbacks_Result, "UnityEngine.Android", "PermissionCallbacks/Result");
...
static_assert(sizeof(::UnityEngine::Android::PermissionCallbacks_Result) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Invoke, addr 0x6a2ee98, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a2ee24, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PermissionDenied, addr 0x6a2e9a4, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionDeniedAndDontAskAgain, addr 0x6a2eb24, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionGranted, addr 0x6a2e824, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionGranted(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionRequestDismissed, addr 0x6a2eca4, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionRequestDismissed(::System::Action_1<::StringW>* value);

  /// @brief Method onPermissionResult, addr 0x6a2ef28, size 0xf8, virtual false, abstract: false, final false
  inline void onPermissionResult(::System::IntPtr javaArgs);

  /// @brief Method remove_PermissionDenied, addr 0x6a2ea64, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionDeniedAndDontAskAgain, addr 0x6a2ebe4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionGranted, addr 0x6a2e8e4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionGranted(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionRequestDismissed, addr 0x6a2ed64, size 0xc0, virtual false, abstract: false, final false
