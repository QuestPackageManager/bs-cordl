...
public:
  ...
  /// @brief Method Invoke, addr 0x68d6408, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68d6394, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PermissionDenied, addr 0x68d5f14, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionDeniedAndDontAskAgain, addr 0x68d6094, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionGranted, addr 0x68d5d94, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionGranted(::System::Action_1<::StringW>* value);

  /// @brief Method add_PermissionRequestDismissed, addr 0x68d6214, size 0xc0, virtual false, abstract: false, final false
  inline void add_PermissionRequestDismissed(::System::Action_1<::StringW>* value);

  /// @brief Method onPermissionResult, addr 0x68d6498, size 0xf8, virtual false, abstract: false, final false
  inline void onPermissionResult(::System::IntPtr javaArgs);

  /// @brief Method remove_PermissionDenied, addr 0x68d5fd4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionDenied(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionDeniedAndDontAskAgain, addr 0x68d6154, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionGranted, addr 0x68d5e54, size 0xc0, virtual false, abstract: false, final false
  inline void remove_PermissionGranted(::System::Action_1<::StringW>* value);

  /// @brief Method remove_PermissionRequestDismissed, addr 0x68d62d4, size 0xc0, virtual false, abstract: false, final false
