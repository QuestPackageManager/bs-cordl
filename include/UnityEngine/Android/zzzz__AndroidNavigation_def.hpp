...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidNavigation, "UnityEngine.Android", "AndroidNavigation");
// Dependencies
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Android::AndroidNavigation) == 0x4, "Size mismatch!");
