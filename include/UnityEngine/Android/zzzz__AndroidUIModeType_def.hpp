...
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidUIModeType, "UnityEngine.Android", "AndroidUIModeType");
// Dependencies
namespace UnityEngine::Android {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Android::AndroidUIModeType) == 0x4, "Size mismatch!");
