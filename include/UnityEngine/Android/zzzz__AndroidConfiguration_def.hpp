...
public:
  ...
  /// @brief Method ToString, addr 0x68d6b44, size 0x11b0, virtual true, abstract: false, final false
  ...
  /// @brief Method get_colorMode, addr 0x68d694c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_colorMode();

  /// @brief Method get_colorModeHdr, addr 0x68d6ae4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidColorModeHdr get_colorModeHdr();

  /// @brief Method get_colorModeWideColorGamut, addr 0x68d6af0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidColorModeWideColorGamut get_colorModeWideColorGamut();

  /// @brief Method get_densityDpi, addr 0x68d6954, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_densityDpi();

  /// @brief Method get_fontScale, addr 0x68d695c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fontScale();

  /// @brief Method get_fontWeightAdjustment, addr 0x68d6964, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_fontWeightAdjustment();

  /// @brief Method get_hardKeyboardHidden, addr 0x68d6974, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidHardwareKeyboardHidden get_hardKeyboardHidden();

  /// @brief Method get_keyboard, addr 0x68d696c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidKeyboard get_keyboard();

  /// @brief Method get_keyboardHidden, addr 0x68d697c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidKeyboardHidden get_keyboardHidden();

  /// @brief Method get_locales, addr 0x68d69ec, size 0xf8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Android::AndroidLocale*, ::Array<::UnityEngine::Android::AndroidLocale*>*> get_locales();

  /// @brief Method get_mobileCountryCode, addr 0x68d6984, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_mobileCountryCode();

  /// @brief Method get_mobileNetworkCode, addr 0x68d698c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_mobileNetworkCode();

  /// @brief Method get_navigation, addr 0x68d6994, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidNavigation get_navigation();

  /// @brief Method get_navigationHidden, addr 0x68d699c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidNavigationHidden get_navigationHidden();

  /// @brief Method get_orientation, addr 0x68d69a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidOrientation get_orientation();

  /// @brief Method get_primaryLocaleCountry, addr 0x68d69dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_primaryLocaleCountry();

  /// @brief Method get_primaryLocaleLanguage, addr 0x68d69e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_primaryLocaleLanguage();

  /// @brief Method get_screenHeightDp, addr 0x68d69ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_screenHeightDp();

  /// @brief Method get_screenLayout, addr 0x68d69c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_screenLayout();

  /// @brief Method get_screenLayoutDirection, addr 0x68d6afc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidScreenLayoutDirection get_screenLayoutDirection();

  /// @brief Method get_screenLayoutLong, addr 0x68d6b08, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidScreenLayoutLong get_screenLayoutLong();

  /// @brief Method get_screenLayoutRound, addr 0x68d6b14, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidScreenLayoutRound get_screenLayoutRound();

  /// @brief Method get_screenLayoutSize, addr 0x68d6b20, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidScreenLayoutSize get_screenLayoutSize();

  /// @brief Method get_screenWidthDp, addr 0x68d69b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_screenWidthDp();

  /// @brief Method get_smallestScreenWidthDp, addr 0x68d69bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_smallestScreenWidthDp();

  /// @brief Method get_touchScreen, addr 0x68d69cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidTouchScreen get_touchScreen();

  /// @brief Method get_uiMode, addr 0x68d69d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_uiMode();

  /// @brief Method get_uiModeNight, addr 0x68d6b2c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Android::AndroidUIModeNight get_uiModeNight();

  /// @brief Method get_uiModeType, addr 0x68d6b38, size 0xc, virtual false, abstract: false, final false
