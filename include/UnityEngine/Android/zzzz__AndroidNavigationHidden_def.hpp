...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Android::AndroidNavigationHidden, 0x4>, "Size mismatch!");

} // namespace UnityEngine::Android
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Android::AndroidNavigationHidden, "UnityEngine.Android", "AndroidNavigationHidden");
