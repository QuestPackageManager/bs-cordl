...
public:
  ...
  /// @brief Method DownloadInProgress, addr 0x68d4f64, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68d4f4c, size 0x18, virtual false, abstract: false, final false
