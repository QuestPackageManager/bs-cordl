...
// Write type traits
MARK_REF_T(::UnityEngine::Android::AndroidAssetPackInfo*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Android::AndroidAssetPackInfo*, "UnityEngine.Android", "AndroidAssetPackInfo");
...
public:
  ...
  /// @brief Method DownloadInProgress, addr 0x6a2d9f4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a2d9dc, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Android::AndroidAssetPackInfo) == 0x38, "Size mismatch!");
