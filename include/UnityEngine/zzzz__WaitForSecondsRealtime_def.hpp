...
public:
  ...
  /// @brief Method Reset, addr 0x48b35ec, size 0xc, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x48b35bc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(float_t time);

  /// @brief Method get_keepWaiting, addr 0x48b34f8, size 0x9c, virtual true, abstract: false, final false
  inline bool get_keepWaiting();

  /// @brief Method get_waitTime, addr 0x48b34e8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_waitTime();

  /// @brief Method set_waitTime, addr 0x48b34f0, size 0x8, virtual false, abstract: false, final false
