...
DEFINE_IL2CPP_CLASS(::UnityEngine::BlendShape, "UnityEngine", "BlendShape");
// [UsedByNativeCode]
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Method get_firstVertex, addr 0x6ab19a4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_firstVertex();

  /// @brief Method get_vertexCount, addr 0x6ab19b4, size 0x8, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "m_FirstVertex", ty: "uint32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_VertexCount", ty: "uint32_t", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "m_HasNormals", ty: "bool", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_HasTangents", ty: "bool", modifiers: "", def_value: None,
  // comment: None }]
...
static_assert(sizeof(::UnityEngine::BlendShape) == 0xc, "Size mismatch!");
