...
/// @brief Method get_firstVertex, addr 0x68e7568, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_firstVertex() ;

/// @brief Method get_vertexCount, addr 0x68e7578, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_FirstVertex", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_VertexCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_HasNormals", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_HasTangents", ty: "bool", modifiers: "", def_value: None }]
