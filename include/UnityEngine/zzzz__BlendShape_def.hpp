...
public:
  ...
  /// @brief Method get_firstVertex, addr 0x4890d20, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_firstVertex();

  /// @brief Method get_vertexCount, addr 0x4890d30, size 0x8, virtual false, abstract: false, final false
