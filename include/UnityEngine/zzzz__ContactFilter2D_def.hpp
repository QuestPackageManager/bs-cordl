...
public:
  // Declarations
  /// @brief Method CheckConsistency, addr 0x490193c, size 0x3c, virtual false, abstract: false, final false
  inline void CheckConsistency();

  /// @brief Method CheckConsistency_Injected, addr 0x4901978, size 0x3c, virtual false, abstract: false, final false
  static inline void CheckConsistency_Injected(::ByRef<::UnityEngine::ContactFilter2D> _unity_self);

  /// @brief Method CreateLegacyFilter, addr 0x4900588, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityEngine::ContactFilter2D CreateLegacyFilter(int32_t layerMask, float_t minDepth, float_t maxDepth);

  /// @brief Method SetDepth, addr 0x49019c4, size 0x48, virtual false, abstract: false, final false
  inline void SetDepth(float_t minDepth, float_t maxDepth);

  /// @brief Method SetLayerMask, addr 0x49019b4, size 0x10, virtual false, abstract: false, final false
