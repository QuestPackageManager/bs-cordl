...
namespace UnityEngine {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8948))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16054))
// CS Name: ::UnityEngine::ContactFilter2D
struct CORDL_TYPE ContactFilter2D {
public:
  // Declarations
  /// @brief Method CheckConsistency, addr 0x2d234a0, size 0x3c, virtual false, abstract: false, final false
  inline void CheckConsistency();

  /// @brief Method SetLayerMask, addr 0x2d23518, size 0x10, virtual false, abstract: false, final false
  inline void SetLayerMask(::UnityEngine::LayerMask layerMask);

  /// @brief Method SetDepth, addr 0x2d23528, size 0x48, virtual false, abstract: false, final false
  inline void SetDepth(float_t minDepth, float_t maxDepth);

  /// @brief Method CreateLegacyFilter, addr 0x2d21eec, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityEngine::ContactFilter2D CreateLegacyFilter(int32_t layerMask, float_t minDepth, float_t maxDepth);

  /// @brief Method CheckConsistency_Injected, addr 0x2d234dc, size 0x3c, virtual false, abstract: false, final false
