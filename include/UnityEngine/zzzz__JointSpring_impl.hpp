...
// Ctor Parameters [CppParam { name: "spring", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "damper", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "targetPosition", ty: "float_t", modifiers: "", def_value: Some("{}") }]
