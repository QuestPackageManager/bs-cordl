...
public:
  ...
  /// @brief Method OnContentTextChangedHandle, addr 0x69fce64, size 0x34, virtual false, abstract: false, final false
  inline void OnContentTextChangedHandle();

  /// @brief Method OnCursorIndexChange, addr 0x69fd290, size 0x4, virtual true, abstract: false, final false
  inline void OnCursorIndexChange();

  /// @brief Method OnSelectIndexChange, addr 0x69fd294, size 0x4, virtual true, abstract: false, final false
  inline void OnSelectIndexChange();

  /// @brief Method OnTextChangedHandle, addr 0x69fce24, size 0x40, virtual false, abstract: false, final false
  inline void OnTextChangedHandle();

  /// @brief Method UpdateScrollOffset, addr 0x69fce98, size 0x3f8, virtual false, abstract: false, final false
  inline void UpdateScrollOffset();

  /// @brief Method UpdateTextHandle, addr 0x69fc7a4, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69fc948, size 0x4b4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_position, addr 0x69fc93c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_position();

  /// @brief Method get_showCursor, addr 0x69fc640, size 0x18, virtual false, abstract: false, final false
  inline bool get_showCursor();

  /// @brief Method get_text, addr 0x69fc658, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_textWithWhitespace, addr 0x69fc8cc, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_textWithWhitespace();

  /// @brief Method set_text, addr 0x69fc670, size 0xb8, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_textWithWhitespace, addr 0x69fc728, size 0x7c, virtual false, abstract: false, final false
