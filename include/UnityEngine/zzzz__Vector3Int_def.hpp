...
public:
  ...
  /// @brief Method Equals, addr 0x697b528, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x697b5c0, size 0x30, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Vector3Int other);

  /// @brief Method GetHashCode, addr 0x697b5f0, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Max, addr 0x697b45c, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int Max(::UnityEngine::Vector3Int lhs, ::UnityEngine::Vector3Int rhs);

  /// @brief Method Min, addr 0x697b434, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int Min(::UnityEngine::Vector3Int lhs, ::UnityEngine::Vector3Int rhs);

  /// @brief Method ToString, addr 0x697b610, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x697b620, size 0x1c8, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x697b428, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_one, addr 0x697b838, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int get_one();

  /// @brief Method get_x, addr 0x697b3f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_x();

  /// @brief Method get_y, addr 0x697b408, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_y();

  /// @brief Method get_z, addr 0x697b418, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_z();

  /// @brief Method get_zero, addr 0x697b7e8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x697b498, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int op_Addition(::UnityEngine::Vector3Int a, ::UnityEngine::Vector3Int b);

  /// @brief Method op_Division, addr 0x697b4e8, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int op_Division(::UnityEngine::Vector3Int a, int32_t b);

  /// @brief Method op_Equality, addr 0x697b500, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Vector3Int lhs, ::UnityEngine::Vector3Int rhs);

  /// @brief Method op_Implicit, addr 0x697b484, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::UnityEngine::Vector3Int v);

  /// @brief Method op_Multiply, addr 0x697b4d0, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3Int op_Multiply(::UnityEngine::Vector3Int a, int32_t b);

  /// @brief Method op_Subtraction, addr 0x697b4b4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_x, addr 0x697b400, size 0x8, virtual false, abstract: false, final false
  inline void set_x(int32_t value);

  /// @brief Method set_y, addr 0x697b410, size 0x8, virtual false, abstract: false, final false
  inline void set_y(int32_t value);

  /// @brief Method set_z, addr 0x697b420, size 0x8, virtual false, abstract: false, final false
