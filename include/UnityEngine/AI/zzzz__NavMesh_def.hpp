...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6a197ac, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::AI::NavMesh_OnNavMeshPreUpdate* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x6a19744, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearPreUpdateListeners, addr 0x6a196f8, size 0x4c, virtual false, abstract: false, final false
