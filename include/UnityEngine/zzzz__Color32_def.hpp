...
public:
  ...
  /// @brief Method .ctor addr 0x2b74948 size 0x14 virtual false final false
  inline void _ctor(uint8_t r, uint8_t g, uint8_t b, uint8_t a);

  /// @brief Method op_Implicit addr 0x2b7495c size 0x2c4 virtual false final false
  static inline ::UnityEngine::Color32 op_Implicit___UnityEngine__Color32(::UnityEngine::Color c);

  /// @brief Method op_Implicit addr 0x2b74c20 size 0x3c virtual false final false
  static inline ::UnityEngine::Color op_Implicit___UnityEngine__Color(::UnityEngine::Color32 c);

  /// @brief Method Lerp addr 0x2b74c5c size 0xdc virtual false final false
  static inline ::UnityEngine::Color32 Lerp(::UnityEngine::Color32 a, ::UnityEngine::Color32 b, float_t t);

  /// @brief Method ToString addr 0x2b74d38 size 0xc virtual true final false
  inline ::StringW ToString();

  /// @brief Method ToString addr 0x2b74d44 size 0x1dc virtual true final true
