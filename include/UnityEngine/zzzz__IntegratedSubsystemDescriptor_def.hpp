...
public:
  ...
  /// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x32669a8, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method get_id, addr 0x3266930, size 0x3c, virtual true, abstract: false, final true
