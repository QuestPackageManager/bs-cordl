...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILayoutSelfController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILayoutSelfController(ILayoutSelfControllerconst&) = delete;
