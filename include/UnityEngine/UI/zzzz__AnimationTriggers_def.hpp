...
/// @brief Method .ctor, addr 0x6a4da1c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledTrigger, addr 0x6a4da0c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_disabledTrigger() ;

/// @brief Method get_highlightedTrigger, addr 0x6a4d9dc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_highlightedTrigger() ;

/// @brief Method get_normalTrigger, addr 0x6a4d9cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_normalTrigger() ;

/// @brief Method get_pressedTrigger, addr 0x6a4d9ec, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_pressedTrigger() ;

/// @brief Method get_selectedTrigger, addr 0x6a4d9fc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_selectedTrigger() ;

/// @brief Method set_disabledTrigger, addr 0x6a4da14, size 0x8, virtual false, abstract: false, final false
inline void set_disabledTrigger(::StringW  value) ;

/// @brief Method set_highlightedTrigger, addr 0x6a4d9e4, size 0x8, virtual false, abstract: false, final false
inline void set_highlightedTrigger(::StringW  value) ;

/// @brief Method set_normalTrigger, addr 0x6a4d9d4, size 0x8, virtual false, abstract: false, final false
inline void set_normalTrigger(::StringW  value) ;

/// @brief Method set_pressedTrigger, addr 0x6a4d9f4, size 0x8, virtual false, abstract: false, final false
inline void set_pressedTrigger(::StringW  value) ;

/// @brief Method set_selectedTrigger, addr 0x6a4da04, size 0x8, virtual false, abstract: false, final false
