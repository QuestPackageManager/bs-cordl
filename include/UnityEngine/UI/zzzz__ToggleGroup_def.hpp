...
public:
  ...
  /// @brief Method .ctor addr 0x2c25564 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <AnyTogglesOn>b__13_0 addr 0x2c2556c size 0x18 virtual false final false
  inline bool _AnyTogglesOn_b__13_0(::UnityEngine::UI::Toggle* x);

  /// @brief Method <ActiveToggles>b__14_0 addr 0x2c25584 size 0x18 virtual false final false
...
public:
  ...
  /// @brief Method get_allowSwitchOff addr 0x2c2506c size 0x8 virtual false final false
  inline bool get_allowSwitchOff();

  /// @brief Method set_allowSwitchOff addr 0x2c25074 size 0xc virtual false final false
  inline void set_allowSwitchOff(bool value);

  static inline ::UnityEngine::UI::ToggleGroup* New_ctor();

  /// @brief Method .ctor addr 0x2c25080 size 0x7c virtual false final false
  inline void _ctor();

  /// @brief Method Start addr 0x2c250fc size 0x1c virtual true final false
  inline void Start();

  /// @brief Method OnEnable addr 0x2c25118 size 0x1c virtual true final false
  inline void OnEnable();

  /// @brief Method ValidateToggleIsInGroup addr 0x2c25134 size 0x158 virtual false final false
  inline void ValidateToggleIsInGroup(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method NotifyToggleOn addr 0x2c24d78 size 0x10c virtual false final false
  inline void NotifyToggleOn(::UnityEngine::UI::Toggle* toggle, bool sendCallback);

  /// @brief Method UnregisterToggle addr 0x2c24c14 size 0x90 virtual false final false
  inline void UnregisterToggle(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method RegisterToggle addr 0x2c24ca4 size 0xd4 virtual false final false
  inline void RegisterToggle(::UnityEngine::UI::Toggle* toggle);

  /// @brief Method EnsureValidState addr 0x2c24544 size 0x3ec virtual false final false
  inline void EnsureValidState();

  /// @brief Method AnyTogglesOn addr 0x2c24ea4 size 0x13c virtual false final false
  inline bool AnyTogglesOn();

  /// @brief Method ActiveToggles addr 0x2c2528c size 0xfc virtual false final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UI::Toggle*>* ActiveToggles();

  /// @brief Method GetFirstActiveToggle addr 0x2c25388 size 0x88 virtual false final false
  inline ::UnityEngine::UI::Toggle* GetFirstActiveToggle();

  /// @brief Method SetAllTogglesOff addr 0x2c25410 size 0xf0 virtual false final false
