...
public:
  ...
  /// @brief Method CreateGameObject addr 0x2befca8 size 0x74 virtual true final true
  inline ::UnityEngine::GameObject* CreateGameObject(::StringW name, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> components);

  static inline ::UnityEngine::UI::__DefaultControls__DefaultRuntimeFactory* New_ctor();

  /// @brief Method .ctor addr 0x2befd1c size 0x8 virtual false final false
  inline void _ctor();
...
namespace UnityEngine::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(10170)), TypeDefinitionIndex(TypeDefinitionIndex(10178))}
...
public:
  ...
  /// @brief Method get_factory addr 0x2beb3e0 size 0x58 virtual false final false
  static inline ::UnityEngine::UI::__DefaultControls__IFactoryControls* get_factory();

  /// @brief Method CreateUIElementRoot addr 0x2beb438 size 0x160 virtual false final false
  ...
  /// @brief Method CreateUIObject addr 0x2beb598 size 0x128 virtual false final false
