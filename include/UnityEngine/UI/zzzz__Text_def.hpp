...
public:
  ...
  /// @brief Method .ctor addr 0x2c22790 size 0x98 virtual false final false
  inline void _ctor();

  /// @brief Method get_cachedTextGenerator addr 0x2c22828 size 0x98 virtual false final false
  inline ::UnityEngine::TextGenerator* get_cachedTextGenerator();

  /// @brief Method get_cachedTextGeneratorForLayout addr 0x2c228c0 size 0x6c virtual false final false
  inline ::UnityEngine::TextGenerator* get_cachedTextGeneratorForLayout();

  /// @brief Method get_mainTexture addr 0x2c2292c size 0x1a8 virtual true final false
  inline ::UnityEngine::Texture* get_mainTexture();

  /// @brief Method FontTextureChanged addr 0x2c22af0 size 0x10c virtual false final false
  inline void FontTextureChanged();

  /// @brief Method get_font addr 0x2c22ad4 size 0x1c virtual false final false
  inline ::UnityEngine::Font* get_font();

  /// @brief Method set_font addr 0x2c22bfc size 0x10c virtual false final false
  inline void set_font(::UnityEngine::Font* value);

  /// @brief Method get_text addr 0x2c22d08 size 0x8 virtual true final false
  inline ::StringW get_text();

  /// @brief Method set_text addr 0x2c22d10 size 0xc8 virtual true final false
  inline void set_text(::StringW value);

  /// @brief Method get_supportRichText addr 0x2c22dd8 size 0x1c virtual false final false
  inline bool get_supportRichText();

  /// @brief Method set_supportRichText addr 0x2c22df4 size 0x60 virtual false final false
  inline void set_supportRichText(bool value);

  /// @brief Method get_resizeTextForBestFit addr 0x2c22e54 size 0x1c virtual false final false
  inline bool get_resizeTextForBestFit();

  /// @brief Method set_resizeTextForBestFit addr 0x2c22e70 size 0x60 virtual false final false
  inline void set_resizeTextForBestFit(bool value);

  /// @brief Method get_resizeTextMinSize addr 0x2c22ed0 size 0x1c virtual false final false
  inline int32_t get_resizeTextMinSize();

  /// @brief Method set_resizeTextMinSize addr 0x2c22eec size 0x54 virtual false final false
  inline void set_resizeTextMinSize(int32_t value);

  /// @brief Method get_resizeTextMaxSize addr 0x2c22f40 size 0x1c virtual false final false
  inline int32_t get_resizeTextMaxSize();

  /// @brief Method set_resizeTextMaxSize addr 0x2c22f5c size 0x54 virtual false final false
  inline void set_resizeTextMaxSize(int32_t value);

  /// @brief Method get_alignment addr 0x2c22fb0 size 0x1c virtual false final false
  inline ::UnityEngine::TextAnchor get_alignment();

  /// @brief Method set_alignment addr 0x2c22fcc size 0x54 virtual false final false
  inline void set_alignment(::UnityEngine::TextAnchor value);

  /// @brief Method get_alignByGeometry addr 0x2c23020 size 0x1c virtual false final false
  inline bool get_alignByGeometry();

  /// @brief Method set_alignByGeometry addr 0x2c2303c size 0x48 virtual false final false
  inline void set_alignByGeometry(bool value);

  /// @brief Method get_fontSize addr 0x2c23084 size 0x1c virtual false final false
  inline int32_t get_fontSize();

  /// @brief Method set_fontSize addr 0x2c230a0 size 0x54 virtual false final false
  inline void set_fontSize(int32_t value);

  /// @brief Method get_horizontalOverflow addr 0x2c230f4 size 0x1c virtual false final false
  inline ::UnityEngine::HorizontalWrapMode get_horizontalOverflow();

  /// @brief Method set_horizontalOverflow addr 0x2c23110 size 0x54 virtual false final false
  inline void set_horizontalOverflow(::UnityEngine::HorizontalWrapMode value);

  /// @brief Method get_verticalOverflow addr 0x2c23164 size 0x1c virtual false final false
  inline ::UnityEngine::VerticalWrapMode get_verticalOverflow();

  /// @brief Method set_verticalOverflow addr 0x2c23180 size 0x54 virtual false final false
  inline void set_verticalOverflow(::UnityEngine::VerticalWrapMode value);

  /// @brief Method get_lineSpacing addr 0x2c231d4 size 0x1c virtual false final false
  inline float_t get_lineSpacing();

  /// @brief Method set_lineSpacing addr 0x2c231f0 size 0x54 virtual false final false
  inline void set_lineSpacing(float_t value);

  /// @brief Method get_fontStyle addr 0x2c23244 size 0x1c virtual false final false
  inline ::UnityEngine::FontStyle get_fontStyle();

  /// @brief Method set_fontStyle addr 0x2c23260 size 0x54 virtual false final false
  inline void set_fontStyle(::UnityEngine::FontStyle value);

  /// @brief Method get_pixelsPerUnit addr 0x2c232b4 size 0x148 virtual false final false
  inline float_t get_pixelsPerUnit();

  /// @brief Method OnEnable addr 0x2c233fc size 0x7c virtual true final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2c23478 size 0x64 virtual true final false
  inline void OnDisable();

  /// @brief Method UpdateGeometry addr 0x2c234dc size 0x88 virtual true final false
  inline void UpdateGeometry();

  /// @brief Method AssignDefaultFont addr 0x2c23564 size 0x70 virtual false final false
  inline void AssignDefaultFont();

  /// @brief Method AssignDefaultFontIfNecessary addr 0x2c235d4 size 0xbc virtual false final false
  inline void AssignDefaultFontIfNecessary();

  /// @brief Method GetGenerationSettings addr 0x2c23690 size 0x1ec virtual false final false
  inline ::UnityEngine::TextGenerationSettings GetGenerationSettings(::UnityEngine::Vector2 extents);

  /// @brief Method GetTextAnchorPivot addr 0x2c2387c size 0x6c virtual false final false
  static inline ::UnityEngine::Vector2 GetTextAnchorPivot(::UnityEngine::TextAnchor anchor);

  /// @brief Method OnPopulateMesh addr 0x2c238e8 size 0x5f0 virtual true final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method CalculateLayoutInputHorizontal addr 0x2c23fe8 size 0x4 virtual true final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical addr 0x2c23fec size 0x4 virtual true final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method get_minWidth addr 0x2c23ff0 size 0x8 virtual true final false
  inline float_t get_minWidth();

  /// @brief Method get_preferredWidth addr 0x2c23ff8 size 0xdc virtual true final false
  inline float_t get_preferredWidth();

  /// @brief Method get_flexibleWidth addr 0x2c240d4 size 0x8 virtual true final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_minHeight addr 0x2c240dc size 0x8 virtual true final false
  inline float_t get_minHeight();

  /// @brief Method get_preferredHeight addr 0x2c240e4 size 0xc8 virtual true final false
  inline float_t get_preferredHeight();

  /// @brief Method get_flexibleHeight addr 0x2c241ac size 0x8 virtual true final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_layoutPriority addr 0x2c241b4 size 0x8 virtual true final false
