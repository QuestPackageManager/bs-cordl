...
public:
  ...
  /// @brief Method .ctor addr 0x2d8ab40 size 0x98 virtual false final false
  inline void _ctor();

  /// @brief Method get_cachedTextGenerator addr 0x2d8abd8 size 0x98 virtual false final false
  inline ::UnityEngine::TextGenerator* get_cachedTextGenerator();

  /// @brief Method get_cachedTextGeneratorForLayout addr 0x2d8ac70 size 0x6c virtual false final false
  inline ::UnityEngine::TextGenerator* get_cachedTextGeneratorForLayout();

  /// @brief Method get_mainTexture addr 0x2d8acdc size 0x1a8 virtual true final false
  inline ::UnityEngine::Texture* get_mainTexture();

  /// @brief Method FontTextureChanged addr 0x2d8aea0 size 0x10c virtual false final false
  inline void FontTextureChanged();

  /// @brief Method get_font addr 0x2d8ae84 size 0x1c virtual false final false
  inline ::UnityEngine::Font* get_font();

  /// @brief Method set_font addr 0x2d8afac size 0x10c virtual false final false
  inline void set_font(::UnityEngine::Font* value);

  /// @brief Method get_text addr 0x2d8b0b8 size 0x8 virtual true final false
  inline ::StringW get_text();

  /// @brief Method set_text addr 0x2d8b0c0 size 0xc8 virtual true final false
  inline void set_text(::StringW value);

  /// @brief Method get_supportRichText addr 0x2d8b188 size 0x1c virtual false final false
  inline bool get_supportRichText();

  /// @brief Method set_supportRichText addr 0x2d8b1a4 size 0x60 virtual false final false
  inline void set_supportRichText(bool value);

  /// @brief Method get_resizeTextForBestFit addr 0x2d8b204 size 0x1c virtual false final false
  inline bool get_resizeTextForBestFit();

  /// @brief Method set_resizeTextForBestFit addr 0x2d8b220 size 0x60 virtual false final false
  inline void set_resizeTextForBestFit(bool value);

  /// @brief Method get_resizeTextMinSize addr 0x2d8b280 size 0x1c virtual false final false
  inline int32_t get_resizeTextMinSize();

  /// @brief Method set_resizeTextMinSize addr 0x2d8b29c size 0x54 virtual false final false
  inline void set_resizeTextMinSize(int32_t value);

  /// @brief Method get_resizeTextMaxSize addr 0x2d8b2f0 size 0x1c virtual false final false
  inline int32_t get_resizeTextMaxSize();

  /// @brief Method set_resizeTextMaxSize addr 0x2d8b30c size 0x54 virtual false final false
  inline void set_resizeTextMaxSize(int32_t value);

  /// @brief Method get_alignment addr 0x2d8b360 size 0x1c virtual false final false
  inline ::UnityEngine::TextAnchor get_alignment();

  /// @brief Method set_alignment addr 0x2d8b37c size 0x54 virtual false final false
  inline void set_alignment(::UnityEngine::TextAnchor value);

  /// @brief Method get_alignByGeometry addr 0x2d8b3d0 size 0x1c virtual false final false
  inline bool get_alignByGeometry();

  /// @brief Method set_alignByGeometry addr 0x2d8b3ec size 0x48 virtual false final false
  inline void set_alignByGeometry(bool value);

  /// @brief Method get_fontSize addr 0x2d8b434 size 0x1c virtual false final false
  inline int32_t get_fontSize();

  /// @brief Method set_fontSize addr 0x2d8b450 size 0x54 virtual false final false
  inline void set_fontSize(int32_t value);

  /// @brief Method get_horizontalOverflow addr 0x2d8b4a4 size 0x1c virtual false final false
  inline ::UnityEngine::HorizontalWrapMode get_horizontalOverflow();

  /// @brief Method set_horizontalOverflow addr 0x2d8b4c0 size 0x54 virtual false final false
  inline void set_horizontalOverflow(::UnityEngine::HorizontalWrapMode value);

  /// @brief Method get_verticalOverflow addr 0x2d8b514 size 0x1c virtual false final false
  inline ::UnityEngine::VerticalWrapMode get_verticalOverflow();

  /// @brief Method set_verticalOverflow addr 0x2d8b530 size 0x54 virtual false final false
  inline void set_verticalOverflow(::UnityEngine::VerticalWrapMode value);

  /// @brief Method get_lineSpacing addr 0x2d8b584 size 0x1c virtual false final false
  inline float_t get_lineSpacing();

  /// @brief Method set_lineSpacing addr 0x2d8b5a0 size 0x54 virtual false final false
  inline void set_lineSpacing(float_t value);

  /// @brief Method get_fontStyle addr 0x2d8b5f4 size 0x1c virtual false final false
  inline ::UnityEngine::FontStyle get_fontStyle();

  /// @brief Method set_fontStyle addr 0x2d8b610 size 0x54 virtual false final false
  inline void set_fontStyle(::UnityEngine::FontStyle value);

  /// @brief Method get_pixelsPerUnit addr 0x2d8b664 size 0x148 virtual false final false
  inline float_t get_pixelsPerUnit();

  /// @brief Method OnEnable addr 0x2d8b7ac size 0x7c virtual true final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2d8b828 size 0x64 virtual true final false
  inline void OnDisable();

  /// @brief Method UpdateGeometry addr 0x2d8b88c size 0x88 virtual true final false
  inline void UpdateGeometry();

  /// @brief Method AssignDefaultFont addr 0x2d8b914 size 0x70 virtual false final false
  inline void AssignDefaultFont();

  /// @brief Method AssignDefaultFontIfNecessary addr 0x2d8b984 size 0xbc virtual false final false
  inline void AssignDefaultFontIfNecessary();

  /// @brief Method GetGenerationSettings addr 0x2d8ba40 size 0x1ec virtual false final false
  inline ::UnityEngine::TextGenerationSettings GetGenerationSettings(::UnityEngine::Vector2 extents);

  /// @brief Method GetTextAnchorPivot addr 0x2d8bc2c size 0x6c virtual false final false
  static inline ::UnityEngine::Vector2 GetTextAnchorPivot(::UnityEngine::TextAnchor anchor);

  /// @brief Method OnPopulateMesh addr 0x2d8bc98 size 0x5f0 virtual true final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method CalculateLayoutInputHorizontal addr 0x2d8c398 size 0x4 virtual true final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical addr 0x2d8c39c size 0x4 virtual true final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method get_minWidth addr 0x2d8c3a0 size 0x8 virtual true final false
  inline float_t get_minWidth();

  /// @brief Method get_preferredWidth addr 0x2d8c3a8 size 0xdc virtual true final false
  inline float_t get_preferredWidth();

  /// @brief Method get_flexibleWidth addr 0x2d8c484 size 0x8 virtual true final false
  inline float_t get_flexibleWidth();

  /// @brief Method get_minHeight addr 0x2d8c48c size 0x8 virtual true final false
  inline float_t get_minHeight();

  /// @brief Method get_preferredHeight addr 0x2d8c494 size 0xc8 virtual true final false
  inline float_t get_preferredHeight();

  /// @brief Method get_flexibleHeight addr 0x2d8c55c size 0x8 virtual true final false
  inline float_t get_flexibleHeight();

  /// @brief Method get_layoutPriority addr 0x2d8c564 size 0x8 virtual true final false
