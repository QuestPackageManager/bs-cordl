...
public:
  ...
  /// @brief Method AllSelectablesNoAlloc, addr 0x6cb0b58, size 0xc0, virtual false, abstract: false, final false
  static inline int32_t AllSelectablesNoAlloc(::ArrayW<::UnityEngine::UI::Selectable*, ::Array<::UnityEngine::UI::Selectable*>*> selectables);

  /// @brief Method Awake, addr 0x6cb1294, size 0x94, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method DoSpriteSwap, addr 0x6cb178c, size 0xac, virtual false, abstract: false, final false
  inline void DoSpriteSwap(::UnityEngine::Sprite* newSprite);

  /// @brief Method DoStateTransition, addr 0x6cb19b4, size 0x25c, virtual true, abstract: false, final false
  inline void DoStateTransition(::UnityEngine::UI::Selectable_SelectionState state, bool instant);

  /// @brief Method EvaluateAndTransitionToSelectionState, addr 0x6cb2368, size 0x98, virtual false, abstract: false, final false
  inline void EvaluateAndTransitionToSelectionState();

  /// @brief Method FindSelectable, addr 0x6cb1c10, size 0x4b4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectable(::UnityEngine::Vector3 dir);

  /// @brief Method FindSelectableOnDown, addr 0x6cacc54, size 0xdc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown();

  /// @brief Method FindSelectableOnLeft, addr 0x6cac954, size 0xdc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft();

  /// @brief Method FindSelectableOnRight, addr 0x6caca54, size 0xdc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight();

  /// @brief Method FindSelectableOnUp, addr 0x6cacb54, size 0xdc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnUp();

  /// @brief Method GetPointOnRectEdge, addr 0x6cb20c4, size 0x18c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetPointOnRectEdge(::UnityEngine::RectTransform* rect, ::UnityEngine::Vector2 dir);

  /// @brief Method InstantClearState, addr 0x6cb1614, size 0x60, virtual true, abstract: false, final false
  inline void InstantClearState();

  /// @brief Method IsHighlighted, addr 0x6cb230c, size 0x5c, virtual false, abstract: false, final false
  inline bool IsHighlighted();

  /// @brief Method IsInteractable, addr 0x6cb14e8, size 0x20, virtual true, abstract: false, final false
  inline bool IsInteractable();

  /// @brief Method IsPressed, addr 0x6cb15c8, size 0x4c, virtual false, abstract: false, final false
  inline bool IsPressed();

  /// @brief Method Navigate, addr 0x6cb2250, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationFocus, addr 0x6cb156c, size 0x5c, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool hasFocus);

  /// @brief Method OnCanvasGroupChanged, addr 0x6cb1328, size 0x34, virtual true, abstract: false, final false
  inline void OnCanvasGroupChanged();

  /// @brief Method OnDeselect, addr 0x6cb2420, size 0x8, virtual true, abstract: false, final false
  inline void OnDeselect(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnDidApplyAnimationProperties, addr 0x6cb1508, size 0x4, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x6cabc18, size 0x11c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6cab958, size 0x2bc, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnMove, addr 0x6cac898, size 0x98, virtual true, abstract: false, final false
  inline void OnMove(::UnityEngine::EventSystems::AxisEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x6cac414, size 0x138, virtual true, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x6cb2400, size 0xc, virtual true, abstract: false, final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x6cb240c, size 0x8, virtual true, abstract: false, final false
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x6cac624, size 0x20, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSelect, addr 0x6cb2414, size 0xc, virtual true, abstract: false, final false
  inline void OnSelect(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnSetProperty, addr 0x6cb0cc4, size 0x64, virtual false, abstract: false, final false
  inline void OnSetProperty();

  /// @brief Method OnTransformParentChanged, addr 0x6cb155c, size 0x10, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method ParentGroupAllowsInteraction, addr 0x6cb135c, size 0x18c, virtual false, abstract: false, final false
  inline bool ParentGroupAllowsInteraction();

  /// @brief Method Select, addr 0x6cb2428, size 0x118, virtual true, abstract: false, final false
  inline void Select();

  /// @brief Method StartColorTween, addr 0x6cb1674, size 0x118, virtual false, abstract: false, final false
  inline void StartColorTween(::UnityEngine::Color targetColor, bool instant);

  /// @brief Method TriggerAnimation, addr 0x6cb1838, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cab518, size 0x114, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_allSelectableCount, addr 0x6cb0a54, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_allSelectableCount();

  /// @brief Method get_allSelectables, addr 0x6cb0ab0, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Selectable>>* get_allSelectables();

  /// @brief Method get_allSelectablesArray, addr 0x6cb09b0, size 0xa4, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::UI::Selectable>, ::Array<::UnityW<::UnityEngine::UI::Selectable>>*> get_allSelectablesArray();

  /// @brief Method get_animationTriggers, addr 0x6cb0ee4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::AnimationTriggers* get_animationTriggers();

  /// @brief Method get_animator, addr 0x6cb1248, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_animator();

  /// @brief Method get_colors, addr 0x6cb0da8, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::ColorBlock get_colors();

  /// @brief Method get_currentSelectionState, addr 0x6cb150c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::Selectable_SelectionState get_currentSelectionState();

  /// @brief Method get_hasSelection, addr 0x6cb11b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasSelection();

  /// @brief Method get_image, addr 0x6cb11c0, size 0x80, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Image> get_image();

  /// @brief Method get_interactable, addr 0x6cb1004, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method get_isPointerDown, addr 0x6cb11a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPointerDown();

  /// @brief Method get_isPointerInside, addr 0x6cb1190, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPointerInside();

  /// @brief Method get_navigation, addr 0x6cb0c18, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::Navigation get_navigation();

  /// @brief Method get_spriteState, addr 0x6cb0e4c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::SpriteState get_spriteState();

  /// @brief Method get_targetGraphic, addr 0x6cb0f74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Graphic> get_targetGraphic();

  /// @brief Method get_transition, addr 0x6cb0d28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_animationTriggers, addr 0x6cb0eec, size 0x88, virtual false, abstract: false, final false
  inline void set_animationTriggers(::UnityEngine::UI::AnimationTriggers* value);

  /// @brief Method set_colors, addr 0x6cb0db8, size 0x94, virtual false, abstract: false, final false
  inline void set_colors(::UnityEngine::UI::ColorBlock value);

  /// @brief Method set_hasSelection, addr 0x6cb11b8, size 0x8, virtual false, abstract: false, final false
  inline void set_hasSelection(bool value);

  /// @brief Method set_image, addr 0x6cb1240, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::UI::Image* value);

  /// @brief Method set_interactable, addr 0x6cb100c, size 0x184, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  /// @brief Method set_isPointerDown, addr 0x6cb11a8, size 0x8, virtual false, abstract: false, final false
  inline void set_isPointerDown(bool value);

  /// @brief Method set_isPointerInside, addr 0x6cb1198, size 0x8, virtual false, abstract: false, final false
  inline void set_isPointerInside(bool value);

  /// @brief Method set_navigation, addr 0x6cb0c30, size 0x94, virtual false, abstract: false, final false
  inline void set_navigation(::UnityEngine::UI::Navigation value);

  /// @brief Method set_spriteState, addr 0x6cb0e58, size 0x8c, virtual false, abstract: false, final false
  inline void set_spriteState(::UnityEngine::UI::SpriteState value);

  /// @brief Method set_targetGraphic, addr 0x6cb0f7c, size 0x88, virtual false, abstract: false, final false
  inline void set_targetGraphic(::UnityEngine::UI::Graphic* value);

  /// @brief Method set_transition, addr 0x6cb0d30, size 0x78, virtual false, abstract: false, final false
