...
public:
  ...
  /// @brief Method .ctor, addr 0x4957810, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x49579e8, size 0xf4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::Button__OnFinishSubmit_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x4957adc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x4957ae4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4957b1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x49579e4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x49579bc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnFinishSubmit, addr 0x495795c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* OnFinishSubmit();

  /// @brief Method OnPointerClick, addr 0x49578c0, size 0x24, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x49578e4, size 0x78, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method Press, addr 0x4957828, size 0x98, virtual false, abstract: false, final false
  inline void Press();
  ...
  /// @brief Method .ctor, addr 0x4957784, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_onClick, addr 0x4957818, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_onClick, addr 0x4957820, size 0x8, virtual false, abstract: false, final false
