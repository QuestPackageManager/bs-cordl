...
public:
  ...
  /// @brief Method .ctor, addr 0x329c148, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x329c328, size 0xbc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UI::__Button___OnFinishSubmit_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x329c3e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x329c3ec, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x329c42c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x329c324, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x329c2fc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnFinishSubmit, addr 0x329c294, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* OnFinishSubmit();

  /// @brief Method OnPointerClick, addr 0x329c1f8, size 0x24, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x329c21c, size 0x78, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method Press, addr 0x329c160, size 0x98, virtual false, abstract: false, final false
  inline void Press();
  ...
  /// @brief Method .ctor, addr 0x329c0bc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_onClick, addr 0x329c150, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_onClick, addr 0x329c158, size 0x8, virtual false, abstract: false, final false
