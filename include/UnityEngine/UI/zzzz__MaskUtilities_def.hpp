...
public:
  // Declarations
  /// @brief Method Notify2DMaskStateChanged addr 0x2c13eec size 0x25c virtual false final false
  static inline void Notify2DMaskStateChanged(::UnityEngine::Component* mask);

  /// @brief Method NotifyStencilStateChanged addr 0x2c125bc size 0x258 virtual false final false
  static inline void NotifyStencilStateChanged(::UnityEngine::Component* mask);

  /// @brief Method FindRootSortOverrideCanvas addr 0x2c12d18 size 0x1a0 virtual false final false
  static inline ::UnityEngine::Transform* FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetStencilDepth addr 0x2c12eb8 size 0x288 virtual false final false
  static inline int32_t GetStencilDepth(::UnityEngine::Transform* transform, ::UnityEngine::Transform* stopAfter);

  /// @brief Method IsDescendantOrSelf addr 0x2c14148 size 0x150 virtual false final false
  static inline bool IsDescendantOrSelf(::UnityEngine::Transform* father, ::UnityEngine::Transform* child);

  /// @brief Method GetRectMaskForClippable addr 0x2c1393c size 0x41c virtual false final false
  static inline ::UnityEngine::UI::RectMask2D* GetRectMaskForClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method GetRectMasksForClip addr 0x2c14298 size 0x364 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c145fc size 0x1008 virtual false final false
  inline void _ctor();
