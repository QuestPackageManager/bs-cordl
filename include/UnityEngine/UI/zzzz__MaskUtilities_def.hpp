...
public:
  // Declarations
  /// @brief Method FindRootSortOverrideCanvas, addr 0x6c34470, size 0x1c0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetRectMaskForClippable, addr 0x6c35124, size 0x458, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::UI::RectMask2D> GetRectMaskForClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method GetRectMasksForClip, addr 0x6c35ae8, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilDepth, addr 0x6c34630, size 0x2a0, virtual false, abstract: false, final false
  static inline int32_t GetStencilDepth(::UnityEngine::Transform* transform, ::UnityEngine::Transform* stopAfter);

  /// @brief Method IsDescendantOrSelf, addr 0x6c35998, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method Notify2DMaskStateChanged, addr 0x6c35718, size 0x280, virtual false, abstract: false, final false
  static inline void Notify2DMaskStateChanged(::UnityEngine::Component* mask);

  /// @brief Method NotifyStencilStateChanged, addr 0x6c33cc4, size 0x27c, virtual false, abstract: false, final false
  static inline void NotifyStencilStateChanged(::UnityEngine::Component* mask);

  /// @brief Method .ctor, addr 0x6c35e94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
