...
public:
  // Declarations
  /// @brief Method FindRootSortOverrideCanvas, addr 0x6ca6d78, size 0x1c0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetRectMaskForClippable, addr 0x6ca7a2c, size 0x458, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::UI::RectMask2D> GetRectMaskForClippable(::UnityEngine::UI::IClippable* clippable);

  /// @brief Method GetRectMasksForClip, addr 0x6ca83f0, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilDepth, addr 0x6ca6f38, size 0x2a0, virtual false, abstract: false, final false
  static inline int32_t GetStencilDepth(::UnityEngine::Transform* transform, ::UnityEngine::Transform* stopAfter);

  /// @brief Method IsDescendantOrSelf, addr 0x6ca82a0, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method Notify2DMaskStateChanged, addr 0x6ca8020, size 0x280, virtual false, abstract: false, final false
  static inline void Notify2DMaskStateChanged(::UnityEngine::Component* mask);

  /// @brief Method NotifyStencilStateChanged, addr 0x6ca65cc, size 0x27c, virtual false, abstract: false, final false
  static inline void NotifyStencilStateChanged(::UnityEngine::Component* mask);

  /// @brief Method .ctor, addr 0x6ca879c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
