...
public:
  ...
  /// @brief Method .ctor addr 0x2d7e1c8 size 0x50 virtual false final false
  inline void _ctor();

  /// @brief Method get_mainTexture addr 0x2d7e218 size 0x158 virtual true final false
  inline ::UnityEngine::Texture* get_mainTexture();

  /// @brief Method get_texture addr 0x2d7e370 size 0x8 virtual false final false
  inline ::UnityEngine::Texture* get_texture();

  /// @brief Method set_texture addr 0x2d7e378 size 0xac virtual false final false
  inline void set_texture(::UnityEngine::Texture* value);

  /// @brief Method get_uvRect addr 0x2d7e424 size 0xc virtual false final false
  inline ::UnityEngine::Rect get_uvRect();

  /// @brief Method set_uvRect addr 0x2d7e430 size 0x80 virtual false final false
  inline void set_uvRect(::UnityEngine::Rect value);

  /// @brief Method SetNativeSize addr 0x2d7e4b0 size 0x2e0 virtual true final false
  inline void SetNativeSize();

  /// @brief Method OnPopulateMesh addr 0x2d7e790 size 0xd18 virtual true final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method OnDidApplyAnimationProperties addr 0x2d7f870 size 0x3c virtual true final false
