...
public:
  ...
  /// @brief Method get_spacing addr 0x2c0e57c size 0x8 virtual false final false
  inline float_t get_spacing();

  /// @brief Method set_spacing addr 0x2c0e584 size 0x5c virtual false final false
  inline void set_spacing(float_t value);

  /// @brief Method get_childForceExpandWidth addr 0x2c0e5e0 size 0x8 virtual false final false
  inline bool get_childForceExpandWidth();

  /// @brief Method set_childForceExpandWidth addr 0x2c0e5e8 size 0x5c virtual false final false
  inline void set_childForceExpandWidth(bool value);

  /// @brief Method get_childForceExpandHeight addr 0x2c0e644 size 0x8 virtual false final false
  inline bool get_childForceExpandHeight();

  /// @brief Method set_childForceExpandHeight addr 0x2c0e64c size 0x5c virtual false final false
  inline void set_childForceExpandHeight(bool value);

  /// @brief Method get_childControlWidth addr 0x2c0e6a8 size 0x8 virtual false final false
  inline bool get_childControlWidth();

  /// @brief Method set_childControlWidth addr 0x2c0e6b0 size 0x5c virtual false final false
  inline void set_childControlWidth(bool value);

  /// @brief Method get_childControlHeight addr 0x2c0e70c size 0x8 virtual false final false
  inline bool get_childControlHeight();

  /// @brief Method set_childControlHeight addr 0x2c0e714 size 0x5c virtual false final false
  inline void set_childControlHeight(bool value);

  /// @brief Method get_childScaleWidth addr 0x2c0e770 size 0x8 virtual false final false
  inline bool get_childScaleWidth();

  /// @brief Method set_childScaleWidth addr 0x2c0e778 size 0x5c virtual false final false
  inline void set_childScaleWidth(bool value);

  /// @brief Method get_childScaleHeight addr 0x2c0e7d4 size 0x8 virtual false final false
  inline bool get_childScaleHeight();

  /// @brief Method set_childScaleHeight addr 0x2c0e7dc size 0x5c virtual false final false
  inline void set_childScaleHeight(bool value);

  /// @brief Method get_reverseArrangement addr 0x2c0e838 size 0x8 virtual false final false
  inline bool get_reverseArrangement();

  /// @brief Method set_reverseArrangement addr 0x2c0e840 size 0x5c virtual false final false
  inline void set_reverseArrangement(bool value);

  /// @brief Method CalcAlongAxis addr 0x2c0dc48 size 0x2a4 virtual false final false
  inline void CalcAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method SetChildrenAlongAxis addr 0x2c0df04 size 0x66c virtual false final false
  inline void SetChildrenAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method GetChildSizes addr 0x2c0e89c size 0x118 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c0dc1c size 0xc virtual false final false
  inline void _ctor();
