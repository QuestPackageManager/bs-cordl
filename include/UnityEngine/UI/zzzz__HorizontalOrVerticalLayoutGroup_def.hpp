...
public:
  ...
  /// @brief Method set_spacing, addr 0x2d76934, size 0x5c, virtual false, abstract: false, final false
  inline void set_spacing(float_t value);

  /// @brief Method get_childForceExpandWidth, addr 0x2d76990, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandWidth();

  /// @brief Method set_childForceExpandWidth, addr 0x2d76998, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandWidth(bool value);

  /// @brief Method get_childForceExpandHeight, addr 0x2d769f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandHeight();

  /// @brief Method set_childForceExpandHeight, addr 0x2d769fc, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandHeight(bool value);

  /// @brief Method get_childControlWidth, addr 0x2d76a58, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlWidth();

  /// @brief Method set_childControlWidth, addr 0x2d76a60, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlWidth(bool value);

  /// @brief Method get_childControlHeight, addr 0x2d76abc, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlHeight();

  /// @brief Method set_childControlHeight, addr 0x2d76ac4, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlHeight(bool value);

  /// @brief Method get_childScaleWidth, addr 0x2d76b20, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleWidth();

  /// @brief Method set_childScaleWidth, addr 0x2d76b28, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleWidth(bool value);

  /// @brief Method get_childScaleHeight, addr 0x2d76b84, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleHeight();

  /// @brief Method set_childScaleHeight, addr 0x2d76b8c, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleHeight(bool value);

  /// @brief Method get_reverseArrangement, addr 0x2d76be8, size 0x8, virtual false, abstract: false, final false
  inline bool get_reverseArrangement();

  /// @brief Method set_reverseArrangement, addr 0x2d76bf0, size 0x5c, virtual false, abstract: false, final false
  inline void set_reverseArrangement(bool value);

  /// @brief Method CalcAlongAxis, addr 0x2d75ff8, size 0x2a4, virtual false, abstract: false, final false
  inline void CalcAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method SetChildrenAlongAxis, addr 0x2d762b4, size 0x66c, virtual false, abstract: false, final false
  inline void SetChildrenAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method GetChildSizes, addr 0x2d76c4c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d75fcc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
