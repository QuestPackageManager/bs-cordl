...
public:
  ...
  /// @brief Method get_spacing, addr 0x2d94d14, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spacing();

  /// @brief Method set_spacing, addr 0x2d94d1c, size 0x5c, virtual false, abstract: false, final false
  inline void set_spacing(float_t value);

  /// @brief Method get_childForceExpandWidth, addr 0x2d94d78, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandWidth();

  /// @brief Method set_childForceExpandWidth, addr 0x2d94d80, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandWidth(bool value);

  /// @brief Method get_childForceExpandHeight, addr 0x2d94ddc, size 0x8, virtual false, abstract: false, final false
  inline bool get_childForceExpandHeight();

  /// @brief Method set_childForceExpandHeight, addr 0x2d94de4, size 0x5c, virtual false, abstract: false, final false
  inline void set_childForceExpandHeight(bool value);

  /// @brief Method get_childControlWidth, addr 0x2d94e40, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlWidth();

  /// @brief Method set_childControlWidth, addr 0x2d94e48, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlWidth(bool value);

  /// @brief Method get_childControlHeight, addr 0x2d94ea4, size 0x8, virtual false, abstract: false, final false
  inline bool get_childControlHeight();

  /// @brief Method set_childControlHeight, addr 0x2d94eac, size 0x5c, virtual false, abstract: false, final false
  inline void set_childControlHeight(bool value);

  /// @brief Method get_childScaleWidth, addr 0x2d94f08, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleWidth();

  /// @brief Method set_childScaleWidth, addr 0x2d94f10, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleWidth(bool value);

  /// @brief Method get_childScaleHeight, addr 0x2d94f6c, size 0x8, virtual false, abstract: false, final false
  inline bool get_childScaleHeight();

  /// @brief Method set_childScaleHeight, addr 0x2d94f74, size 0x5c, virtual false, abstract: false, final false
  inline void set_childScaleHeight(bool value);

  /// @brief Method get_reverseArrangement, addr 0x2d94fd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_reverseArrangement();

  /// @brief Method set_reverseArrangement, addr 0x2d94fd8, size 0x5c, virtual false, abstract: false, final false
  inline void set_reverseArrangement(bool value);

  /// @brief Method CalcAlongAxis, addr 0x2d943e0, size 0x2a4, virtual false, abstract: false, final false
  inline void CalcAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method SetChildrenAlongAxis, addr 0x2d9469c, size 0x66c, virtual false, abstract: false, final false
  inline void SetChildrenAlongAxis(int32_t axis, bool isVertical);

  /// @brief Method GetChildSizes, addr 0x2d95034, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d943b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
