...
namespace UnityEngine::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10178)), TypeDefinitionIndex(TypeDefinitionIndex(10173)), TypeDefinitionIndex(TypeDefinitionIndex(13219))}
...
public:
  ...
  /// @brief Method get_defaultGraphicMaterial addr 0x2bf3520 size 0xdc virtual false final false
  static inline ::UnityEngine::Material* get_defaultGraphicMaterial();

  /// @brief Method get_color addr 0x2bf35fc size 0xc virtual true final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color addr 0x2bf3608 size 0x38 virtual true final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method get_raycastTarget addr 0x2bf3640 size 0x8 virtual true final false
  inline bool get_raycastTarget();

  /// @brief Method set_raycastTarget addr 0x2bf3648 size 0xd4 virtual true final false
  inline void set_raycastTarget(bool value);

  /// @brief Method get_raycastPadding addr 0x2bf3b00 size 0xc virtual false final false
  inline ::UnityEngine::Vector4 get_raycastPadding();

  /// @brief Method set_raycastPadding addr 0x2bf3b0c size 0xc virtual false final false
  inline void set_raycastPadding(::UnityEngine::Vector4 value);

  /// @brief Method get_useLegacyMeshGeneration addr 0x2bf3b18 size 0x8 virtual false final false
  inline bool get_useLegacyMeshGeneration();

  /// @brief Method set_useLegacyMeshGeneration addr 0x2bf3b20 size 0xc virtual false final false
  inline void set_useLegacyMeshGeneration(bool value);

  static inline ::UnityEngine::UI::Graphic* New_ctor();

  /// @brief Method .ctor addr 0x2bf3b2c size 0xb0 virtual false final false
  inline void _ctor();

  /// @brief Method SetAllDirty addr 0x2bf3bdc size 0x70 virtual true final false
  inline void SetAllDirty();

  /// @brief Method SetLayoutDirty addr 0x2bf3d1c size 0xa0 virtual true final false
  inline void SetLayoutDirty();

  /// @brief Method SetVerticesDirty addr 0x2bf3e14 size 0x94 virtual true final false
  inline void SetVerticesDirty();

  /// @brief Method SetMaterialDirty addr 0x2bf3ea8 size 0x94 virtual true final false
  inline void SetMaterialDirty();

  /// @brief Method SetRaycastDirty addr 0x2bf3c4c size 0xd0 virtual false final false
  inline void SetRaycastDirty();

  /// @brief Method OnRectTransformDimensionsChange addr 0x2bf3f3c size 0xac virtual true final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnBeforeTransformParentChanged addr 0x2bf3fe8 size 0xa8 virtual true final false
  inline void OnBeforeTransformParentChanged();

  /// @brief Method OnTransformParentChanged addr 0x2bf4210 size 0xb4 virtual true final false
  inline void OnTransformParentChanged();

  /// @brief Method get_depth addr 0x2bf4628 size 0x1c virtual false final false
  inline int32_t get_depth();

  /// @brief Method get_rectTransform addr 0x2bf3dbc size 0x58 virtual true final true
  inline ::UnityEngine::RectTransform* get_rectTransform();

  /// @brief Method get_canvas addr 0x2bf371c size 0x74 virtual false final false
  inline ::UnityEngine::Canvas* get_canvas();

  /// @brief Method CacheCanvas addr 0x2bf42c4 size 0x170 virtual false final false
  inline void CacheCanvas();

  /// @brief Method get_canvasRenderer addr 0x2bf4644 size 0x90 virtual false final false
  inline ::UnityEngine::CanvasRenderer* get_canvasRenderer();

  /// @brief Method get_defaultMaterial addr 0x2bf46d4 size 0x4c virtual true final false
  inline ::UnityEngine::Material* get_defaultMaterial();

  /// @brief Method get_material addr 0x2bf4720 size 0x88 virtual true final false
  inline ::UnityEngine::Material* get_material();

  /// @brief Method set_material addr 0x2bf47a8 size 0x98 virtual true final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method get_materialForRendering addr 0x2bf4840 size 0x224 virtual true final false
  inline ::UnityEngine::Material* get_materialForRendering();

  /// @brief Method get_mainTexture addr 0x2bf4a64 size 0x58 virtual true final false
  inline ::UnityEngine::Texture* get_mainTexture();

  /// @brief Method OnEnable addr 0x2bf4abc size 0x130 virtual true final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2bf4bec size 0x148 virtual true final false
  inline void OnDisable();

  /// @brief Method OnDestroy addr 0x2bf4d34 size 0x104 virtual true final false
  inline void OnDestroy();

  /// @brief Method OnCanvasHierarchyChanged addr 0x2bf4fdc size 0x138 virtual true final false
  inline void OnCanvasHierarchyChanged();

  /// @brief Method OnCullingChanged addr 0x2bf5114 size 0x8c virtual true final false
  inline void OnCullingChanged();

  /// @brief Method Rebuild addr 0x2bf51a0 size 0xe4 virtual true final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate update);

  /// @brief Method LayoutComplete addr 0x2bf5284 size 0x4 virtual true final false
  inline void LayoutComplete();

  /// @brief Method GraphicUpdateComplete addr 0x2bf5288 size 0x4 virtual true final false
  inline void GraphicUpdateComplete();

  /// @brief Method UpdateMaterial addr 0x2bf528c size 0xb8 virtual true final false
  inline void UpdateMaterial();

  /// @brief Method UpdateGeometry addr 0x2bf5344 size 0x10 virtual true final false
  inline void UpdateGeometry();

  /// @brief Method DoMeshGeneration addr 0x2bf56f4 size 0x3d4 virtual false final false
  inline void DoMeshGeneration();

  /// @brief Method DoLegacyMeshGeneration addr 0x2bf5354 size 0x3a0 virtual false final false
  inline void DoLegacyMeshGeneration();

  /// @brief Method get_workerMesh addr 0x2bf5ac8 size 0x13c virtual false final false
  static inline ::UnityEngine::Mesh* get_workerMesh();

  /// @brief Method OnFillVBO addr 0x2bf5c04 size 0x4 virtual true final false
  inline void OnFillVBO(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* vbo);

  /// @brief Method OnPopulateMesh addr 0x2bf5c08 size 0x98 virtual true final false
  inline void OnPopulateMesh(::UnityEngine::Mesh* m);

  /// @brief Method OnPopulateMesh addr 0x2bf5ca0 size 0x48c virtual true final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method OnDidApplyAnimationProperties addr 0x2bf6258 size 0x10 virtual true final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method SetNativeSize addr 0x2bf6268 size 0x4 virtual true final false
  inline void SetNativeSize();

  /// @brief Method Raycast addr 0x2bf626c size 0x48c virtual true final false
  inline bool Raycast(::UnityEngine::Vector2 sp, ::UnityEngine::Camera* eventCamera);

  /// @brief Method PixelAdjustPoint addr 0x2bf66f8 size 0x140 virtual false final false
  inline ::UnityEngine::Vector2 PixelAdjustPoint(::UnityEngine::Vector2 point);

  /// @brief Method GetPixelAdjustedRect addr 0x2bf612c size 0x12c virtual false final false
  inline ::UnityEngine::Rect GetPixelAdjustedRect();

  /// @brief Method CrossFadeColor addr 0x2bf6838 size 0x1c virtual true final false
  inline void CrossFadeColor(::UnityEngine::Color targetColor, float_t duration, bool ignoreTimeScale, bool useAlpha);

  /// @brief Method CrossFadeColor addr 0x2bf6854 size 0x294 virtual true final false
  inline void CrossFadeColor(::UnityEngine::Color targetColor, float_t duration, bool ignoreTimeScale, bool useAlpha, bool useRGB);

  /// @brief Method CreateColorFromAlpha addr 0x2bf6ae8 size 0x14 virtual false final false
  static inline ::UnityEngine::Color CreateColorFromAlpha(float_t alpha);

  /// @brief Method CrossFadeAlpha addr 0x2bf6afc size 0x9c virtual true final false
  inline void CrossFadeAlpha(float_t alpha, float_t duration, bool ignoreTimeScale);

  /// @brief Method RegisterDirtyLayoutCallback addr 0x2bf6b98 size 0x80 virtual false final false
  inline void RegisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnregisterDirtyLayoutCallback addr 0x2bf6c18 size 0x80 virtual false final false
  inline void UnregisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method RegisterDirtyVerticesCallback addr 0x2bf6c98 size 0x80 virtual false final false
  inline void RegisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnregisterDirtyVerticesCallback addr 0x2bf6d18 size 0x80 virtual false final false
  inline void UnregisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method RegisterDirtyMaterialCallback addr 0x2bf6d98 size 0x80 virtual false final false
  inline void RegisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnregisterDirtyMaterialCallback addr 0x2bf6e18 size 0x80 virtual false final false
  inline void UnregisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x2bf6f28 size 0x8 virtual true final true
