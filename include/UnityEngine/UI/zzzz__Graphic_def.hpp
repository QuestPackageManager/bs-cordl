...
public:
  ...
  /// @brief Method CacheCanvas, addr 0x6acbb20, size 0x18c, virtual false, abstract: false, final false
  inline void CacheCanvas();

  /// @brief Method CreateColorFromAlpha, addr 0x6ace078, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color CreateColorFromAlpha(float_t alpha);

  /// @brief Method CrossFadeAlpha, addr 0x6ace08c, size 0xa0, virtual true, abstract: false, final false
  inline void CrossFadeAlpha(float_t alpha, float_t duration, bool ignoreTimeScale);

  /// @brief Method CrossFadeColor, addr 0x6acdd60, size 0x14, virtual true, abstract: false, final false
  inline void CrossFadeColor(::UnityEngine::Color targetColor, float_t duration, bool ignoreTimeScale, bool useAlpha);

  /// @brief Method CrossFadeColor, addr 0x6acdd74, size 0x304, virtual true, abstract: false, final false
  inline void CrossFadeColor(::UnityEngine::Color targetColor, float_t duration, bool ignoreTimeScale, bool useAlpha, bool useRGB);

  /// @brief Method DoLegacyMeshGeneration, addr 0x6accbd4, size 0x37c, virtual false, abstract: false, final false
  inline void DoLegacyMeshGeneration();

  /// @brief Method DoMeshGeneration, addr 0x6accf50, size 0x3b0, virtual false, abstract: false, final false
  inline void DoMeshGeneration();

  /// @brief Method GetPixelAdjustedRect, addr 0x6acd628, size 0x134, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetPixelAdjustedRect();

  /// @brief Method GraphicUpdateComplete, addr 0x6accb08, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method LayoutComplete, addr 0x6accb04, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  static inline ::UnityEngine::UI::Graphic* New_ctor();

  /// @brief Method OnBeforeTransformParentChanged, addr 0x6acb800, size 0xb0, virtual true, abstract: false, final false
  inline void OnBeforeTransformParentChanged();

  /// @brief Method OnCanvasHierarchyChanged, addr 0x6acc858, size 0x134, virtual true, abstract: false, final false
  inline void OnCanvasHierarchyChanged();

  /// @brief Method OnCullingChanged, addr 0x6acc98c, size 0x90, virtual true, abstract: false, final false
  inline void OnCullingChanged();

  /// @brief Method OnDestroy, addr 0x6acc758, size 0x100, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x6acd75c, size 0x10, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x6acc474, size 0x144, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6acc34c, size 0x128, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnFillVBO, addr 0x6acd42c, size 0x4, virtual true, abstract: false, final false
  inline void OnFillVBO(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* vbo);

  /// @brief Method OnPopulateMesh, addr 0x6acd430, size 0x9c, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::Mesh* m);

  /// @brief Method OnPopulateMesh, addr 0x6acd4cc, size 0x15c, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method OnRectTransformDimensionsChange, addr 0x6acb750, size 0xb0, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnTransformParentChanged, addr 0x6acba74, size 0xac, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method PixelAdjustPoint, addr 0x6acdc18, size 0x148, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 PixelAdjustPoint(::UnityEngine::Vector2 point);

  /// @brief Method Raycast, addr 0x6acd770, size 0x4a8, virtual true, abstract: false, final false
  inline bool Raycast(::UnityEngine::Vector2 sp, ::UnityEngine::Camera* eventCamera);

  /// @brief Method Rebuild, addr 0x6acca1c, size 0xe8, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate update);

  /// @brief Method RegisterDirtyLayoutCallback, addr 0x6ace12c, size 0x8c, virtual false, abstract: false, final false
  inline void RegisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method RegisterDirtyMaterialCallback, addr 0x6ace35c, size 0x8c, virtual false, abstract: false, final false
  inline void RegisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method RegisterDirtyVerticesCallback, addr 0x6ace244, size 0x8c, virtual false, abstract: false, final false
  inline void RegisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method SetAllDirty, addr 0x6acb3d8, size 0x70, virtual true, abstract: false, final false
  inline void SetAllDirty();

  /// @brief Method SetLayoutDirty, addr 0x6acb520, size 0xa4, virtual true, abstract: false, final false
  inline void SetLayoutDirty();

  /// @brief Method SetMaterialDirty, addr 0x6acb6b8, size 0x98, virtual true, abstract: false, final false
  inline void SetMaterialDirty();

  /// @brief Method SetNativeSize, addr 0x6acd76c, size 0x4, virtual true, abstract: false, final false
  inline void SetNativeSize();

  /// @brief Method SetRaycastDirty, addr 0x6acb448, size 0xd8, virtual false, abstract: false, final false
  inline void SetRaycastDirty();

  /// @brief Method SetVerticesDirty, addr 0x6acb620, size 0x98, virtual true, abstract: false, final false
  inline void SetVerticesDirty();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x6ace4f8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method UnregisterDirtyLayoutCallback, addr 0x6ace1b8, size 0x8c, virtual false, abstract: false, final false
  inline void UnregisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnregisterDirtyMaterialCallback, addr 0x6ace3e8, size 0x8c, virtual false, abstract: false, final false
  inline void UnregisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UnregisterDirtyVerticesCallback, addr 0x6ace2d0, size 0x8c, virtual false, abstract: false, final false
  inline void UnregisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction* action);

  /// @brief Method UpdateGeometry, addr 0x6accbc4, size 0x10, virtual true, abstract: false, final false
  inline void UpdateGeometry();

  /// @brief Method UpdateMaterial, addr 0x6accb0c, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6acb32c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_canvas, addr 0x6acaeb0, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_canvasRenderer, addr 0x6acbefc, size 0x98, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::CanvasRenderer> get_canvasRenderer();

  /// @brief Method get_color, addr 0x6acad74, size 0xc, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_defaultGraphicMaterial, addr 0x6acac90, size 0xe4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_defaultGraphicMaterial();

  /// @brief Method get_defaultMaterial, addr 0x6acbf94, size 0x50, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_defaultMaterial();

  /// @brief Method get_depth, addr 0x6acbee0, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_depth();

  /// @brief Method get_mainTexture, addr 0x6acc2f0, size 0x5c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_mainTexture();

  /// @brief Method get_material, addr 0x6acbfe4, size 0x8c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_materialForRendering, addr 0x6acc10c, size 0x1e4, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_materialForRendering();

  /// @brief Method get_raycastPadding, addr 0x6acb304, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_raycastPadding();

  /// @brief Method get_raycastTarget, addr 0x6acadcc, size 0x8, virtual true, abstract: false, final false
  inline bool get_raycastTarget();

  /// @brief Method get_rectTransform, addr 0x6acb5c4, size 0x5c, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_useLegacyMeshGeneration, addr 0x6acb31c, size 0x8, virtual false, abstract: false, final false
  inline bool get_useLegacyMeshGeneration();

  /// @brief Method get_workerMesh, addr 0x6acd300, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x6acad80, size 0x4c, virtual true, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_material, addr 0x6acc070, size 0x9c, virtual true, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_raycastPadding, addr 0x6acb310, size 0xc, virtual false, abstract: false, final false
  inline void set_raycastPadding(::UnityEngine::Vector4 value);

  /// @brief Method set_raycastTarget, addr 0x6acadd4, size 0xdc, virtual true, abstract: false, final false
  inline void set_raycastTarget(bool value);

  /// @brief Method set_useLegacyMeshGeneration, addr 0x6acb324, size 0x8, virtual false, abstract: false, final false
