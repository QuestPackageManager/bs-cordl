...
public:
  ...
  /// @brief Method GetModifiedMaterial, addr 0x6ca6ac8, size 0x2b0, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetModifiedMaterial(::UnityEngine::Material* baseMaterial);

  /// @brief Method IsRaycastLocationValid, addr 0x6ca6a0c, size 0xbc, virtual true, abstract: false, final false
  inline bool IsRaycastLocationValid(::UnityEngine::Vector2 sp, ::UnityEngine::Camera* eventCamera);

  /// @brief Method MaskEnabled, addr 0x6ca63c4, size 0x94, virtual true, abstract: false, final false
  inline bool MaskEnabled();

  static inline ::UnityEngine::UI::Mask* New_ctor();

  /// @brief Method OnDisable, addr 0x6ca6848, size 0x1c4, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6ca645c, size 0x158, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSiblingGraphicEnabledDisabled, addr 0x6ca6458, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ca63b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_graphic, addr 0x6ca635c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic();

  /// @brief Method get_rectTransform, addr 0x6ca6238, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_showMaskGraphic, addr 0x6ca6294, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_showMaskGraphic, addr 0x6ca629c, size 0xc0, virtual false, abstract: false, final false
