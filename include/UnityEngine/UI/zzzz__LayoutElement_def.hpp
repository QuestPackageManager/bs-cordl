...
public:
  ...
  /// @brief Method get_ignoreLayout addr 0x2c0f02c size 0x8 virtual true final false
  inline bool get_ignoreLayout();

  /// @brief Method set_ignoreLayout addr 0x2c0f034 size 0x74 virtual true final false
  inline void set_ignoreLayout(bool value);

  /// @brief Method CalculateLayoutInputHorizontal addr 0x2c0f160 size 0x4 virtual true final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical addr 0x2c0f164 size 0x4 virtual true final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method get_minWidth addr 0x2c0f168 size 0x8 virtual true final false
  inline float_t get_minWidth();

  /// @brief Method set_minWidth addr 0x2c0f170 size 0x74 virtual true final false
  inline void set_minWidth(float_t value);

  /// @brief Method get_minHeight addr 0x2c0f1e4 size 0x8 virtual true final false
  inline float_t get_minHeight();

  /// @brief Method set_minHeight addr 0x2c0f1ec size 0x74 virtual true final false
  inline void set_minHeight(float_t value);

  /// @brief Method get_preferredWidth addr 0x2c0f260 size 0x8 virtual true final false
  inline float_t get_preferredWidth();

  /// @brief Method set_preferredWidth addr 0x2c0f268 size 0x74 virtual true final false
  inline void set_preferredWidth(float_t value);

  /// @brief Method get_preferredHeight addr 0x2c0f2dc size 0x8 virtual true final false
  inline float_t get_preferredHeight();

  /// @brief Method set_preferredHeight addr 0x2c0f2e4 size 0x74 virtual true final false
  inline void set_preferredHeight(float_t value);

  /// @brief Method get_flexibleWidth addr 0x2c0f358 size 0x8 virtual true final false
  inline float_t get_flexibleWidth();

  /// @brief Method set_flexibleWidth addr 0x2c0f360 size 0x74 virtual true final false
  inline void set_flexibleWidth(float_t value);

  /// @brief Method get_flexibleHeight addr 0x2c0f3d4 size 0x8 virtual true final false
  inline float_t get_flexibleHeight();

  /// @brief Method set_flexibleHeight addr 0x2c0f3dc size 0x74 virtual true final false
  inline void set_flexibleHeight(float_t value);

  /// @brief Method get_layoutPriority addr 0x2c0f450 size 0x8 virtual true final false
  inline int32_t get_layoutPriority();

  /// @brief Method set_layoutPriority addr 0x2c0f458 size 0x74 virtual true final false
  inline void set_layoutPriority(int32_t value);

  static inline ::UnityEngine::UI::LayoutElement* New_ctor();

  /// @brief Method .ctor addr 0x2c0f4cc size 0x24 virtual false final false
  inline void _ctor();

  /// @brief Method OnEnable addr 0x2c0f4f0 size 0x1c virtual true final false
  inline void OnEnable();

  /// @brief Method OnTransformParentChanged addr 0x2c0f50c size 0x4 virtual true final false
  inline void OnTransformParentChanged();

  /// @brief Method OnDisable addr 0x2c0f510 size 0x1c virtual true final false
  inline void OnDisable();

  /// @brief Method OnDidApplyAnimationProperties addr 0x2c0f52c size 0x4 virtual true final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnBeforeTransformParentChanged addr 0x2c0f530 size 0x4 virtual true final false
  inline void OnBeforeTransformParentChanged();

  /// @brief Method SetDirty addr 0x2c0f0a8 size 0xb8 virtual false final false
