...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VertexHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VertexHelper(VertexHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VertexHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VertexHelper(VertexHelperconst&) = delete;
