...
public:
  // Declarations
  /// @brief Method ModifyMesh, addr 0x6e10900, size 0xe0, virtual true, abstract: false, final false
  inline void ModifyMesh(::UnityEngine::UI::VertexHelper* vh);

  static inline ::UnityEngine::UI::PositionAsUV1* New_ctor();

  /// @brief Method .ctor, addr 0x6e108fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
