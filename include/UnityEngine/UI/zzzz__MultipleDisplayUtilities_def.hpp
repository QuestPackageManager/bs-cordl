...
public:
  // Declarations
  /// @brief Method GetRelativeMousePositionForDrag, addr 0x4acd508, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRelativeMousePositionForRaycast, addr 0x4acd9e0, size 0xd4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetRelativeMousePositionForRaycast(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method RelativeMouseAtScaled, addr 0x4acd574, size 0x46c, virtual false, abstract: false, final false
