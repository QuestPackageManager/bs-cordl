...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UI::IGraphicEnabledDisabled::*)()>(&::UnityEngine::UI::IGraphicEnabledDisabled::OnSiblingGraphicEnabledDisabled)> {
