...
public:
  // Declarations
  /// @brief Method Destroy, addr 0x6c35e98, size 0x148, virtual false, abstract: false, final false
  static inline void Destroy(::UnityEngine::Object* obj);

  /// @brief Method DestroyImmediate, addr 0x6c35fe0, size 0xb4, virtual false, abstract: false, final false
