...
public:
  // Declarations
  /// @brief Method Destroy, addr 0x4acd318, size 0x124, virtual false, abstract: false, final false
  static inline void Destroy(::UnityEngine::Object* obj);

  /// @brief Method DestroyImmediate, addr 0x4acd43c, size 0xcc, virtual false, abstract: false, final false
