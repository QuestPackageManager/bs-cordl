...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Misc", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Misc(Misc&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Misc", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Misc(Miscconst&) = delete;
