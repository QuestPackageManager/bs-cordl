...
public:
  ...
  /// @brief Method RebuildForFont, addr 0x6aca850, size 0x16c, virtual false, abstract: false, final false
  static inline void RebuildForFont(::UnityEngine::Font* f);

  /// @brief Method TrackText, addr 0x6aca5d4, size 0x27c, virtual false, abstract: false, final false
  static inline void TrackText(::UnityEngine::UI::Text* t);

  /// @brief Method UntrackText, addr 0x6aca9bc, size 0x220, virtual false, abstract: false, final false
