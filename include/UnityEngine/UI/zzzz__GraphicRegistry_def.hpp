...
/// @brief Field m_Graphics, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Graphics, put=__cordl_internal_set_m_Graphics)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*  m_Graphics;

/// @brief Field m_RaycastableGraphics, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RaycastableGraphics, put=__cordl_internal_set_m_RaycastableGraphics)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*  m_RaycastableGraphics;
...
/// @brief Method DisableGraphicForCanvas, addr 0x6a5a370, size 0x1a0, virtual false, abstract: false, final false
static inline void DisableGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method DisableRaycastGraphicForCanvas, addr 0x6a5dbd0, size 0x1a0, virtual false, abstract: false, final false
static inline void DisableRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method GetGraphicsForCanvas, addr 0x6a5dd70, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method GetRaycastableGraphicsForCanvas, addr 0x6a5d050, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method RegisterGraphicForCanvas, addr 0x6a59a64, size 0x234, virtual false, abstract: false, final false
static inline void RegisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method RegisterRaycastGraphicForCanvas, addr 0x6a58e80, size 0x23c, virtual false, abstract: false, final false
static inline void RegisterRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterGraphicForCanvas, addr 0x6a59668, size 0x1c4, virtual false, abstract: false, final false
static inline void UnregisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterRaycastGraphicForCanvas, addr 0x6a58ce0, size 0x1a0, virtual false, abstract: false, final false
static inline void UnregisterRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>* const& __cordl_internal_get_m_Graphics() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*& __cordl_internal_get_m_Graphics() ;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>* const& __cordl_internal_get_m_RaycastableGraphics() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*& __cordl_internal_get_m_RaycastableGraphics() ;

constexpr void __cordl_internal_set_m_Graphics(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*  value) ;

constexpr void __cordl_internal_set_m_RaycastableGraphics(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*  value) ;

/// @brief Method .ctor, addr 0x6a5d8d0, size 0x25c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x6a5db2c, size 0xa4, virtual false, abstract: false, final false
