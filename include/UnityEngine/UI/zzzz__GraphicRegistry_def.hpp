...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphicRegistry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphicRegistry(GraphicRegistry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphicRegistry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphicRegistry(GraphicRegistryconst&) = delete;
