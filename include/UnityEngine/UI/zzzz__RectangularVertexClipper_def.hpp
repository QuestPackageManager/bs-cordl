...
public:
  ...
  /// @brief Method GetCanvasRect, addr 0x495a5cc, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x495a724, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
