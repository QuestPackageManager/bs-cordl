...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ByRef<::UnityEngine::Color>, ::UnityEngine::Color)>(&::UnityEngine::UI::SetPropertyUtility::SetColor)> {
  ...
  constexpr static std::size_t addrs = 0x6c40374;
...
template<typename T>
inline bool UnityEngine::UI::SetPropertyUtility::SetStruct(::ByRef<T>  currentValue, T  newValue)  {
...
template<typename T>
inline bool UnityEngine::UI::SetPropertyUtility::SetClass(::ByRef<T>  currentValue, T  newValue)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::SetPropertyUtility*>::get(),
                    "SetClass",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
