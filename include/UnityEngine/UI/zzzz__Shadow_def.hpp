...
public:
  ...
  /// @brief Method ApplyShadow, addr 0x6bdfdf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyShadowZeroAlloc, addr 0x6bdfafc, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ModifyMesh, addr 0x6bdfdf8, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bdf824, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_effectColor, addr 0x6bdf848, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_effectColor();

  /// @brief Method get_effectDistance, addr 0x6bdf92c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_effectDistance();

  /// @brief Method get_useGraphicAlpha, addr 0x6bdfa38, size 0x8, virtual false, abstract: false, final false
  inline bool get_useGraphicAlpha();

  /// @brief Method set_effectColor, addr 0x6bdf854, size 0xd8, virtual false, abstract: false, final false
  inline void set_effectColor(::UnityEngine::Color value);

  /// @brief Method set_effectDistance, addr 0x6bdf934, size 0x104, virtual false, abstract: false, final false
  inline void set_effectDistance(::UnityEngine::Vector2 value);

  /// @brief Method set_useGraphicAlpha, addr 0x6bdfa40, size 0xbc, virtual false, abstract: false, final false
