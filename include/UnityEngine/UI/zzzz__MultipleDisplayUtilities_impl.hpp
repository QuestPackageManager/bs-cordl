...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::EventSystems::PointerEventData*, ::ByRef<::UnityEngine::Vector2>)>(
  ...
  constexpr static std::size_t addrs = 0x6c36094;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::UnityEngine::EventSystems::PointerEventData*)>(
  ...
  constexpr static std::size_t addrs = 0x6c365e4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (*)(::UnityEngine::Vector2, int32_t)>(
    &::UnityEngine::UI::MultipleDisplayUtilities::RelativeMouseAtScaled)> {
  constexpr static std::size_t size = 0x4e4;
  constexpr static std::size_t addrs = 0x6c36100;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::MultipleDisplayUtilities*>::get(),
                                                                               "RelativeMouseAtScaled", std::span<Il2CppClass const* const, 0>(),
...
inline ::UnityEngine::Vector3 UnityEngine::UI::MultipleDisplayUtilities::RelativeMouseAtScaled(::UnityEngine::Vector2 position, int32_t displayIndex) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::MultipleDisplayUtilities*>::get(),
                                                                             ...
                                                                             ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Vector2>::get(),
                                                                                                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::Vector3, false>(nullptr, ___internal_method, position, displayIndex);
}
// Ctor Parameters []
