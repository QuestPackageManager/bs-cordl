...
namespace UnityEngine::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10336)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(10335)),
// TypeDefinitionIndex(TypeDefinitionIndex(10334))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13126)) CS Name: ::StencilMaterial::MatEntry*
