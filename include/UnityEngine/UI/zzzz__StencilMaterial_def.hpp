...
public:
  ...
  /// @brief Method .ctor, addr 0x4acd8d8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x4acce34, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID);

  /// @brief Method Add, addr 0x4acce3c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x4accec8, size 0x968, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID, ::UnityEngine::Rendering::StencilOp operation,
  ...
  /// @brief Method ClearAll, addr 0x4acdaa8, size 0x120, virtual false, abstract: false, final false
  static inline void ClearAll();

  /// @brief Method LogWarningWhenNotInBatchmode, addr 0x4acd830, size 0xa8, virtual false, abstract: false, final false
  static inline void LogWarningWhenNotInBatchmode(::StringW warning, ::UnityEngine::Object* context);

  /// @brief Method Remove, addr 0x4acd8e8, size 0x1c0, virtual false, abstract: false, final false
