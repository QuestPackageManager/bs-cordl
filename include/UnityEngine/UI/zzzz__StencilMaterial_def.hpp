...
public:
  ...
  /// @brief Method .ctor, addr 0x32d8928, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x32d7f04, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID);

  /// @brief Method Add, addr 0x32d7f0c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x32d7f98, size 0x918, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> Add(::UnityEngine::Material* baseMat, int32_t stencilID, ::UnityEngine::Rendering::StencilOp operation,
  ...
  /// @brief Method ClearAll, addr 0x32d8af8, size 0x11c, virtual false, abstract: false, final false
  static inline void ClearAll();

  /// @brief Method LogWarningWhenNotInBatchmode, addr 0x32d88b0, size 0x78, virtual false, abstract: false, final false
  static inline void LogWarningWhenNotInBatchmode(::StringW warning, ::UnityEngine::Object* context);

  /// @brief Method Remove, addr 0x32d8938, size 0x1c0, virtual false, abstract: false, final false
