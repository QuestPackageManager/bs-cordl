...
public:
  // Declarations
  /// @brief Method ModifyMesh, addr 0x6cbac78, size 0x254, virtual true, abstract: false, final false
  inline void ModifyMesh(::UnityEngine::UI::VertexHelper* vh);

  static inline ::UnityEngine::UI::Outline* New_ctor();

  /// @brief Method .ctor, addr 0x6cbac54, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
