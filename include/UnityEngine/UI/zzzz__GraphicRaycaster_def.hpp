...
/// @brief Method <Raycast>b__27_0, addr 0x6a5d88c, size 0x44, virtual false, abstract: false, final false
inline int32_t _Raycast_b__27_0(::UnityEngine::UI::Graphic*  g1, ::UnityEngine::UI::Graphic*  g2) ;

/// @brief Method .ctor, addr 0x6a5d888, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Raycast, addr 0x6a5d114, size 0x5c4, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x6a5c4a0, size 0xbb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a5c418, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Graphic>>* getStaticF_s_SortedGraphics() ;

/// @brief Method get_blockingMask, addr 0x6a5c408, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method get_blockingObjects, addr 0x6a5c3f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GraphicRaycaster_BlockingObjects get_blockingObjects() ;

/// @brief Method get_canvas, addr 0x6a5c2fc, size 0x9c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_eventCamera, addr 0x6a5d6d8, size 0xcc, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_ignoreReversedGraphics, addr 0x6a5c3e8, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreReversedGraphics() ;

/// @brief Method get_renderOrderPriority, addr 0x6a5c398, size 0x50, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_sortOrderPriority, addr 0x6a5c2b8, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method set_blockingMask, addr 0x6a5c410, size 0x8, virtual false, abstract: false, final false
inline void set_blockingMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_blockingObjects, addr 0x6a5c400, size 0x8, virtual false, abstract: false, final false
inline void set_blockingObjects(::UnityEngine::UI::GraphicRaycaster_BlockingObjects  value) ;

/// @brief Method set_ignoreReversedGraphics, addr 0x6a5c3f0, size 0x8, virtual false, abstract: false, final false
