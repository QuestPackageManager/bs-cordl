...
public:
  ...
  /// @brief Method .ctor, addr 0x6cb6c34, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GraphicUpdateComplete, addr 0x6cb6c88, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method InternalToggle, addr 0x6cb7810, size 0x54, virtual false, abstract: false, final false
  inline void InternalToggle();

  /// @brief Method LayoutComplete, addr 0x6cb6c84, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  static inline ::UnityEngine::UI::Toggle* New_ctor();

  /// @brief Method OnDestroy, addr 0x6cb6c8c, size 0x84, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x6cb7134, size 0x12c, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x6cb7114, size 0x20, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6cb70e8, size 0x2c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPointerClick, addr 0x6cb7864, size 0x1c, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x6cb7880, size 0x4, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method PlayEffect, addr 0x6cb6ae0, size 0xc8, virtual false, abstract: false, final false
  inline void PlayEffect(bool instant);

  /// @brief Method Rebuild, addr 0x6cb6c80, size 0x4, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method Set, addr 0x6cb7260, size 0x180, virtual false, abstract: false, final false
  inline void Set(bool value, bool sendCallback);

  /// @brief Method SetIsOnWithoutNotify, addr 0x6cb76b4, size 0x8, virtual false, abstract: false, final false
  inline void SetIsOnWithoutNotify(bool value);

  /// @brief Method SetToggleGroup, addr 0x6cb69a0, size 0x140, virtual false, abstract: false, final false
  inline void SetToggleGroup(::UnityEngine::UI::ToggleGroup* newGroup, bool setMemberValue);

  /// @brief Method Start, addr 0x6cb7808, size 0x8, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x6cb7884, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6cb6ba8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_group, addr 0x6cb6978, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::ToggleGroup> get_group();

  /// @brief Method get_isOn, addr 0x6cb76a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_group, addr 0x6cb6980, size 0x20, virtual false, abstract: false, final false
  inline void set_group(::UnityEngine::UI::ToggleGroup* value);

  /// @brief Method set_isOn, addr 0x6cb76ac, size 0x8, virtual false, abstract: false, final false
