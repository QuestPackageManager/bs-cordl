...
/// @brief Method DoesParentExists, addr 0x6c2d8d0, size 0x8, virtual false, abstract: false, final false
inline bool DoesParentExists() ;

/// @brief Method GetParentSize, addr 0x6c2d6d4, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetParentSize() ;

/// @brief Method GetSizeDeltaToProduceSize, addr 0x6c2d7d4, size 0xf4, virtual false, abstract: false, final false
inline float_t GetSizeDeltaToProduceSize(float_t  size, int32_t  axis) ;

/// @brief Method IsAspectModeValid, addr 0x6c2cee8, size 0x28, virtual false, abstract: false, final false
inline bool IsAspectModeValid() ;

/// @brief Method IsComponentValidOnObject, addr 0x6c2ce14, size 0xd4, virtual false, abstract: false, final false
inline bool IsComponentValidOnObject() ;

static inline ::UnityEngine::UI::AspectRatioFitter* New_ctor() ;

/// @brief Method OnDisable, addr 0x6c2cf10, size 0x68, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x6c2cd44, size 0x8c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x6c2d410, size 0x4, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x6c2d370, size 0x8c, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x6c2cc18, size 0x4, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetLayoutHorizontal, addr 0x6c2d8c8, size 0x4, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x6c2d8cc, size 0x4, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method Start, addr 0x6c2cdd0, size 0x44, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x6c2d3fc, size 0x14, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRect, addr 0x6c2d414, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c2cd38, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_aspectMode, addr 0x6c2cb98, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::AspectRatioFitter_AspectMode get_aspectMode() ;

/// @brief Method get_aspectRatio, addr 0x6c2cc1c, size 0x8, virtual false, abstract: false, final false
inline float_t get_aspectRatio() ;

/// @brief Method get_rectTransform, addr 0x6c2cc9c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method set_aspectMode, addr 0x6c2cba0, size 0x78, virtual false, abstract: false, final false
inline void set_aspectMode(::UnityEngine::UI::AspectRatioFitter_AspectMode  value) ;

/// @brief Method set_aspectRatio, addr 0x6c2cc24, size 0x78, virtual false, abstract: false, final false
