...
public:
  ...
  /// @brief Method .ctor, addr 0x2d75fc0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CalculateLayoutInputHorizontal, addr 0x2d75fd8, size 0x20, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x2d7629c, size 0xc, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  /// @brief Method SetLayoutHorizontal, addr 0x2d762a8, size 0xc, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x2d76920, size 0xc, virtual true, abstract: false, final false
