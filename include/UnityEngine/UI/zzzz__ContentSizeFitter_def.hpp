...
public:
  ...
  /// @brief Method HandleSelfFittingAlongAxis, addr 0x4ac5270, size 0xe4, virtual false, abstract: false, final false
  inline void HandleSelfFittingAlongAxis(int32_t axis);

  static inline ::UnityEngine::UI::ContentSizeFitter* New_ctor();

  /// @brief Method OnDisable, addr 0x4ac51f0, size 0x7c, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4ac51d4, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnRectTransformDimensionsChange, addr 0x4ac526c, size 0x4, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method SetDirty, addr 0x4ac5038, size 0x84, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method SetLayoutHorizontal, addr 0x4ac536c, size 0x24, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x4ac5390, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4ac51cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_horizontalFit, addr 0x4ac4fbc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::ContentSizeFitter_FitMode get_horizontalFit();

  /// @brief Method get_rectTransform, addr 0x4ac5138, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_verticalFit, addr 0x4ac50bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_horizontalFit, addr 0x4ac4fc4, size 0x74, virtual false, abstract: false, final false
  inline void set_horizontalFit(::UnityEngine::UI::ContentSizeFitter_FitMode value);

  /// @brief Method set_verticalFit, addr 0x4ac50c4, size 0x74, virtual false, abstract: false, final false
