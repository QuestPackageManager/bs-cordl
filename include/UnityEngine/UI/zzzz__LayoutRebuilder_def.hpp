...
public:
  ...
  /// @brief Method <Rebuild>b__12_0, addr 0x6dfa978, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_0(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_1, addr 0x6dfaa38, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_1(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_2, addr 0x6dfaaf8, size 0xc4, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_2(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_3, addr 0x6dfabbc, size 0xc4, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_3(::UnityEngine::Component* e);

  /// @brief Method <StripDisabledBehavioursFromList>b__10_0, addr 0x6dfa8e8, size 0x90, virtual false, abstract: false, final false
  inline bool _StripDisabledBehavioursFromList_b__10_0(::UnityEngine::Component* e);

  /// @brief Method <.cctor>b__5_0, addr 0x6dfa88c, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::LayoutRebuilder* __cctor_b__5_0();

  /// @brief Method <.cctor>b__5_1, addr 0x6dfa8d0, size 0x18, virtual false, abstract: false, final false
  inline void __cctor_b__5_1(::UnityEngine::UI::LayoutRebuilder* x);

  /// @brief Method .ctor, addr 0x6dfa888, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x6df953c, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Equals, addr 0x6dfa770, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ForceRebuildLayoutImmediate, addr 0x6df98f8, size 0xe8, virtual false, abstract: false, final false
  static inline void ForceRebuildLayoutImmediate(::UnityEngine::RectTransform* layoutRoot);

  /// @brief Method GetHashCode, addr 0x6dfa768, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GraphicUpdateComplete, addr 0x6dfa764, size 0x4, virtual true, abstract: false, final true
  inline void GraphicUpdateComplete();

  /// @brief Method Initialize, addr 0x6df9508, size 0x34, virtual false, abstract: false, final false
  inline void Initialize(::UnityEngine::RectTransform* controller);

  /// @brief Method IsDestroyed, addr 0x6df978c, size 0x64, virtual true, abstract: false, final true
  inline bool IsDestroyed();

  /// @brief Method LayoutComplete, addr 0x6dfa6dc, size 0x88, virtual true, abstract: false, final true
  inline void LayoutComplete();

  /// @brief Method MarkLayoutForRebuild, addr 0x6df4bf0, size 0x3f8, virtual false, abstract: false, final false
  static inline void MarkLayoutForRebuild(::UnityEngine::RectTransform* rect);

  /// @brief Method MarkLayoutRootForRebuild, addr 0x6dfa56c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutCalculation, addr 0x6df9c98, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutControl, addr 0x6df9f90, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReapplyDrivenProperties, addr 0x6df972c, size 0x58, virtual false, abstract: false, final false
  static inline void ReapplyDrivenProperties(::UnityEngine::RectTransform* driven);

  /// @brief Method Rebuild, addr 0x6df99e0, size 0x2b8, virtual true, abstract: false, final true
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method StripDisabledBehavioursFromList, addr 0x6df97f0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x6dfa7c0, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidController, addr 0x6dfa374, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6dfa830, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Pool::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>* getStaticF_s_Rebuilders();

  /// @brief Method get_transform, addr 0x6df9784, size 0x8, virtual true, abstract: false, final true
