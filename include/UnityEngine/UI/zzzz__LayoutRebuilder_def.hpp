...
public:
  ...
  /// @brief Method <Rebuild>b__12_0, addr 0x34f76bc, size 0xbc, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_0(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_1, addr 0x34f7778, size 0xbc, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_1(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_2, addr 0x34f7834, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_2(::UnityEngine::Component* e);

  /// @brief Method <Rebuild>b__12_3, addr 0x34f78f4, size 0xc0, virtual false, abstract: false, final false
  inline void _Rebuild_b__12_3(::UnityEngine::Component* e);

  /// @brief Method <StripDisabledBehavioursFromList>b__10_0, addr 0x34f7630, size 0x8c, virtual false, abstract: false, final false
  inline bool _StripDisabledBehavioursFromList_b__10_0(::UnityEngine::Component* e);

  /// @brief Method <.cctor>b__5_0, addr 0x34f75b8, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::UI::LayoutRebuilder* __cctor_b__5_0();

  /// @brief Method <.cctor>b__5_1, addr 0x34f7614, size 0x1c, virtual false, abstract: false, final false
  inline void __cctor_b__5_1(::UnityEngine::UI::LayoutRebuilder* x);

  /// @brief Method .ctor, addr 0x34f75b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x34f62a8, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Equals, addr 0x34f7488, size 0x50, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ForceRebuildLayoutImmediate, addr 0x34f6644, size 0xdc, virtual false, abstract: false, final false
  static inline void ForceRebuildLayoutImmediate(::UnityEngine::RectTransform* layoutRoot);

  /// @brief Method GetHashCode, addr 0x34f7480, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GraphicUpdateComplete, addr 0x34f747c, size 0x4, virtual true, abstract: false, final true
  inline void GraphicUpdateComplete();

  /// @brief Method Initialize, addr 0x34f6274, size 0x34, virtual false, abstract: false, final false
  inline void Initialize(::UnityEngine::RectTransform* controller);

  /// @brief Method IsDestroyed, addr 0x34f64e8, size 0x60, virtual true, abstract: false, final true
  inline bool IsDestroyed();

  /// @brief Method LayoutComplete, addr 0x34f73fc, size 0x80, virtual true, abstract: false, final true
  inline void LayoutComplete();

  /// @brief Method MarkLayoutForRebuild, addr 0x34f19c8, size 0x3ec, virtual false, abstract: false, final false
  static inline void MarkLayoutForRebuild(::UnityEngine::RectTransform* rect);

  /// @brief Method MarkLayoutRootForRebuild, addr 0x34f7298, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutCalculation, addr 0x34f69d4, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutControl, addr 0x34f6cd4, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReapplyDrivenProperties, addr 0x34f648c, size 0x54, virtual false, abstract: false, final false
  static inline void ReapplyDrivenProperties(::UnityEngine::RectTransform* driven);

  /// @brief Method Rebuild, addr 0x34f6720, size 0x2b4, virtual true, abstract: false, final true
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method StripDisabledBehavioursFromList, addr 0x34f6548, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x34f74d8, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidController, addr 0x34f70a4, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f7544, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Pool::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>* getStaticF_s_Rebuilders();

  /// @brief Method get_transform, addr 0x34f64e0, size 0x8, virtual true, abstract: false, final true
