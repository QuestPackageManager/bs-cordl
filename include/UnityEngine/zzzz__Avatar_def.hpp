...
public:
  ...
  /// @brief Method GetAxisLength, addr 0x68e8088, size 0x4c, virtual false, abstract: false, final false
  inline float_t GetAxisLength(int32_t humanId);

  /// @brief Method GetLimitSign, addr 0x68e85f0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetLimitSign(int32_t humanId);

  /// @brief Method GetPostRotation, addr 0x68e825c, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetPostRotation(int32_t humanId);

  /// @brief Method GetPreRotation, addr 0x68e8164, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetPreRotation(int32_t humanId);

  /// @brief Method GetZYPostQ, addr 0x68e8354, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetZYPostQ(int32_t humanId, ::UnityEngine::Quaternion parentQ, ::UnityEngine::Quaternion q);

  /// @brief Method GetZYRoll, addr 0x68e84c4, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetZYRoll(int32_t humanId, ::UnityEngine::Vector3 uvw);

  /// @brief Method Internal_GetAxisLength, addr 0x68e80d4, size 0x90, virtual false, abstract: false, final false
  inline float_t Internal_GetAxisLength(int32_t humanId);

  /// @brief Method Internal_GetAxisLength_Injected, addr 0x68e86ec, size 0x44, virtual false, abstract: false, final false
  static inline float_t Internal_GetAxisLength_Injected(::System::IntPtr _unity_self, int32_t humanId);

  /// @brief Method Internal_GetLimitSign, addr 0x68e863c, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 Internal_GetLimitSign(int32_t humanId);

  /// @brief Method Internal_GetLimitSign_Injected, addr 0x68e88a0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetPostRotation, addr 0x68e82a8, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetPostRotation(int32_t humanId);

  /// @brief Method Internal_GetPostRotation_Injected, addr 0x68e8784, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetPreRotation, addr 0x68e81b0, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetPreRotation(int32_t humanId);

  /// @brief Method Internal_GetPreRotation_Injected, addr 0x68e8730, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetZYPostQ, addr 0x68e8400, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetZYPostQ_Injected, addr 0x68e87d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetZYRoll, addr 0x68e8538, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetZYRoll(int32_t humanId, ::UnityEngine::Vector3 uvw);

  /// @brief Method Internal_GetZYRoll_Injected, addr 0x68e8844, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMuscleMinMax, addr 0x68e7e90, size 0xa8, virtual false, abstract: false, final false
  inline void SetMuscleMinMax(int32_t muscleId, float_t min, float_t max);

  /// @brief Method SetMuscleMinMax_Injected, addr 0x68e7f38, size 0x5c, virtual false, abstract: false, final false
  static inline void SetMuscleMinMax_Injected(::System::IntPtr _unity_self, int32_t muscleId, float_t min, float_t max);

  /// @brief Method SetParameter, addr 0x68e7f94, size 0xa0, virtual false, abstract: false, final false
  inline void SetParameter(int32_t parameterId, float_t value);

  /// @brief Method SetParameter_Injected, addr 0x68e8034, size 0x54, virtual false, abstract: false, final false
  static inline void SetParameter_Injected(::System::IntPtr _unity_self, int32_t parameterId, float_t value);

  /// @brief Method .ctor, addr 0x68e7cc4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_humanDescription, addr 0x68e7d94, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::HumanDescription get_humanDescription();

  /// @brief Method get_humanDescription_Injected, addr 0x68e7e4c, size 0x44, virtual false, abstract: false, final false
  static inline void get_humanDescription_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::HumanDescription> ret);

  /// @brief Method get_isHuman, addr 0x68e46f4, size 0x80, virtual false, abstract: false, final false
  inline bool get_isHuman();

  /// @brief Method get_isHuman_Injected, addr 0x68e7d58, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_isHuman_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_isValid, addr 0x68e4674, size 0x80, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method get_isValid_Injected, addr 0x68e7d1c, size 0x3c, virtual false, abstract: false, final false
