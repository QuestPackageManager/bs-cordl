...
public:
  ...
  /// @brief Method GetAxisLength, addr 0x47dcc90, size 0x70, virtual false, abstract: false, final false
  inline float_t GetAxisLength(int32_t humanId);

  /// @brief Method GetLimitSign, addr 0x47dd0a0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetLimitSign(int32_t humanId);

  /// @brief Method GetPostRotation, addr 0x47dcdf0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetPostRotation(int32_t humanId);

  /// @brief Method GetPreRotation, addr 0x47dcd44, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetPreRotation(int32_t humanId);

  /// @brief Method GetZYPostQ, addr 0x47dce9c, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetZYPostQ(int32_t humanId, ::UnityEngine::Quaternion parentQ, ::UnityEngine::Quaternion q);

  /// @brief Method GetZYRoll, addr 0x47dcfc0, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetZYRoll(int32_t humanId, ::UnityEngine::Vector3 uvw);

  /// @brief Method Internal_GetAxisLength, addr 0x47dcd00, size 0x44, virtual false, abstract: false, final false
  inline float_t Internal_GetAxisLength(int32_t humanId);

  /// @brief Method Internal_GetLimitSign, addr 0x47dd0ec, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 Internal_GetLimitSign(int32_t humanId);

  /// @brief Method Internal_GetLimitSign_Injected, addr 0x47dd2c0, size 0x54, virtual false, abstract: false, final false
  inline void Internal_GetLimitSign_Injected(int32_t humanId, ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method Internal_GetPostRotation, addr 0x47dce3c, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetPostRotation(int32_t humanId);

  /// @brief Method Internal_GetPostRotation_Injected, addr 0x47dd1a4, size 0x54, virtual false, abstract: false, final false
  inline void Internal_GetPostRotation_Injected(int32_t humanId, ByRef<::UnityEngine::Quaternion> ret);

  /// @brief Method Internal_GetPreRotation, addr 0x47dcd90, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetPreRotation(int32_t humanId);

  /// @brief Method Internal_GetPreRotation_Injected, addr 0x47dd150, size 0x54, virtual false, abstract: false, final false
  inline void Internal_GetPreRotation_Injected(int32_t humanId, ByRef<::UnityEngine::Quaternion> ret);

  /// @brief Method Internal_GetZYPostQ, addr 0x47dcf48, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetZYPostQ_Injected, addr 0x47dd1f8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetZYRoll, addr 0x47dd034, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion Internal_GetZYRoll(int32_t humanId, ::UnityEngine::Vector3 uvw);

  /// @brief Method Internal_GetZYRoll_Injected, addr 0x47dd264, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMuscleMinMax, addr 0x47dcbe0, size 0x5c, virtual false, abstract: false, final false
  inline void SetMuscleMinMax(int32_t muscleId, float_t min, float_t max);

  /// @brief Method SetParameter, addr 0x47dcc3c, size 0x54, virtual false, abstract: false, final false
  inline void SetParameter(int32_t parameterId, float_t value);

  /// @brief Method .ctor, addr 0x47dcad8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_humanDescription, addr 0x47dcb30, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::HumanDescription get_humanDescription();

  /// @brief Method get_humanDescription_Injected, addr 0x47dcb9c, size 0x44, virtual false, abstract: false, final false
  inline void get_humanDescription_Injected(ByRef<::UnityEngine::HumanDescription> ret);

  /// @brief Method get_isHuman, addr 0x47db634, size 0x3c, virtual false, abstract: false, final false
  inline bool get_isHuman();

  /// @brief Method get_isValid, addr 0x47db5f8, size 0x3c, virtual false, abstract: false, final false
