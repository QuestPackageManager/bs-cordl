...
/// @brief Method ValidateAsset, addr 0x6294a84, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::UnityEngine::Object*  obj) ;

/// @brief Method ValidateAsset, addr 0x6294a8c, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::StringW  path) ;

/// @brief Method .ctor, addr 0x6294a94, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
