...
public:
  ...
  /// @brief Method DisconnectAll, addr 0x697f0c0, size 0x28, virtual false, abstract: false, final false
  static inline void DisconnectAll();

  /// @brief Method Initialize, addr 0x697f020, size 0x28, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method IsConnected, addr 0x697f070, size 0x28, virtual false, abstract: false, final false
  static inline bool IsConnected();

  static inline ::UnityEngine::PlayerConnectionInternal* New_ctor();

  /// @brief Method PollInternal, addr 0x697ecd8, size 0x28, virtual false, abstract: false, final false
  static inline void PollInternal();

  /// @brief Method RegisterInternal, addr 0x697ed58, size 0x124, virtual false, abstract: false, final false
  static inline void RegisterInternal(::StringW messageId);

  /// @brief Method RegisterInternal_Injected, addr 0x697f0e8, size 0x3c, virtual false, abstract: false, final false
  static inline void RegisterInternal_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> messageId);

  /// @brief Method SendMessage, addr 0x697e848, size 0x1ac, virtual false, abstract: false, final false
  static inline void SendMessage(::StringW messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t playerId);

  /// @brief Method SendMessage_Injected, addr 0x697f160, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TrySendMessage, addr 0x697eaf8, size 0x1b8, virtual false, abstract: false, final false
  static inline bool TrySendMessage(::StringW messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t playerId);

  /// @brief Method TrySendMessage_Injected, addr 0x697f1b4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.DisconnectAll, addr 0x697f098, size 0x28, virtual true, abstract: false, final true
  inline void UnityEngine_IPlayerEditorConnectionNative_DisconnectAll();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.Initialize, addr 0x697eff8, size 0x28, virtual true, abstract: false, final true
  inline void UnityEngine_IPlayerEditorConnectionNative_Initialize();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.IsConnected, addr 0x697f048, size 0x28, virtual true, abstract: false, final true
  inline bool UnityEngine_IPlayerEditorConnectionNative_IsConnected();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.Poll, addr 0x697ecb0, size 0x28, virtual true, abstract: false, final true
  inline void UnityEngine_IPlayerEditorConnectionNative_Poll();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.RegisterInternal, addr 0x697ed00, size 0x58, virtual true, abstract: false, final true
  inline void UnityEngine_IPlayerEditorConnectionNative_RegisterInternal(::System::Guid messageId);

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.SendMessage, addr 0x697e744, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.TrySendMessage, addr 0x697e9f4, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.UnregisterInternal, addr 0x697ee7c, size 0x58, virtual true, abstract: false, final true
  inline void UnityEngine_IPlayerEditorConnectionNative_UnregisterInternal(::System::Guid messageId);

  /// @brief Method UnregisterInternal, addr 0x697eed4, size 0x124, virtual false, abstract: false, final false
  static inline void UnregisterInternal(::StringW messageId);

  /// @brief Method UnregisterInternal_Injected, addr 0x697f124, size 0x3c, virtual false, abstract: false, final false
  static inline void UnregisterInternal_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> messageId);

  /// @brief Method .ctor, addr 0x697f208, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
