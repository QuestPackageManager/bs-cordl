...
public:
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.SendMessage addr 0x2b5f160 size 0x12c virtual true final true
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.TrySendMessage addr 0x2b5f2e0 size 0x130 virtual true final true
  ...
  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.Poll addr 0x2b5f464 size 0x28 virtual true final true
  inline void UnityEngine_IPlayerEditorConnectionNative_Poll();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.RegisterInternal addr 0x2b5f4b4 size 0x84 virtual true final true
  inline void UnityEngine_IPlayerEditorConnectionNative_RegisterInternal(::System::Guid messageId);

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.UnregisterInternal addr 0x2b5f574 size 0x84 virtual true final true
  inline void UnityEngine_IPlayerEditorConnectionNative_UnregisterInternal(::System::Guid messageId);

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.Initialize addr 0x2b5f634 size 0x28 virtual true final true
  inline void UnityEngine_IPlayerEditorConnectionNative_Initialize();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.IsConnected addr 0x2b5f684 size 0x28 virtual true final true
  inline bool UnityEngine_IPlayerEditorConnectionNative_IsConnected();

  /// @brief Method UnityEngine.IPlayerEditorConnectionNative.DisconnectAll addr 0x2b5f6d4 size 0x28 virtual true final true
  inline void UnityEngine_IPlayerEditorConnectionNative_DisconnectAll();

  /// @brief Method IsConnected addr 0x2b5f6ac size 0x28 virtual false final false
  static inline bool IsConnected();

  /// @brief Method Initialize addr 0x2b5f65c size 0x28 virtual false final false
  static inline void Initialize();

  /// @brief Method RegisterInternal addr 0x2b5f538 size 0x3c virtual false final false
  static inline void RegisterInternal(::StringW messageId);

  /// @brief Method UnregisterInternal addr 0x2b5f5f8 size 0x3c virtual false final false
  static inline void UnregisterInternal(::StringW messageId);

  /// @brief Method SendMessage addr 0x2b5f28c size 0x54 virtual false final false
  static inline void SendMessage(::StringW messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t playerId);

  /// @brief Method TrySendMessage addr 0x2b5f410 size 0x54 virtual false final false
  static inline bool TrySendMessage(::StringW messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t playerId);

  /// @brief Method PollInternal addr 0x2b5f48c size 0x28 virtual false final false
  static inline void PollInternal();

  /// @brief Method DisconnectAll addr 0x2b5f6fc size 0x28 virtual false final false
  static inline void DisconnectAll();

  static inline ::UnityEngine::PlayerConnectionInternal* New_ctor();

  /// @brief Method .ctor addr 0x2b5f724 size 0x8 virtual false final false
  inline void _ctor();
