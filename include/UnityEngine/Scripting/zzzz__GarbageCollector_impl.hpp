...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Scripting::GarbageCollector_Mode)>(&::UnityEngine::Scripting::GarbageCollector::set_GCMode)> {
  ...
  constexpr static std::size_t addrs = 0x693476c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Scripting::GarbageCollector_Mode>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Scripting::GarbageCollector_Mode)>(&::UnityEngine::Scripting::GarbageCollector::SetMode)> {
  ...
  constexpr static std::size_t addrs = 0x6934854;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Scripting::GarbageCollector_Mode (*)()>(&::UnityEngine::Scripting::GarbageCollector::GetMode)> {
  ...
  constexpr static std::size_t addrs = 0x693482c;
...
::cordl_internals::setStaticField<::System::Action_1<::UnityEngine::Scripting::GarbageCollector_Mode>*, "GCModeChanged", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Scripting::GarbageCollector*>::get>(std::forward<::System::Action_1<::UnityEngine::Scripting::GarbageCollector_Mode>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Action_1<::UnityEngine::Scripting::GarbageCollector_Mode>*, "GCModeChanged", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Scripting::GarbageCollector*>::get>();
}
