...
public:
  ...
  /// @brief Method .ctor, addr 0x32649b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32649c0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x32649e8, size 0x8, virtual false, abstract: false, final false
