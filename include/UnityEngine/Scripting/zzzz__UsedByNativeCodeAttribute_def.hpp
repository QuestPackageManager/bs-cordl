...
public:
  ...
  /// @brief Method .ctor addr 0x2bb0de4 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::Scripting::UsedByNativeCodeAttribute* New_ctor(::StringW name);

  /// @brief Method .ctor addr 0x2bb0dec size 0x28 virtual false final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name addr 0x2bb0e14 size 0x8 virtual false final false
