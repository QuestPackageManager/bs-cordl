...
/// @brief Method .ctor, addr 0x6a5f518, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6a5f51c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method set_Name, addr 0x6a5f524, size 0x8, virtual false, abstract: false, final false
