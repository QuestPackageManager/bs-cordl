...
public:
  ...
  /// @brief Method .ctor, addr 0x6bb2ff4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bb2ff8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x6bb3000, size 0x8, virtual false, abstract: false, final false
