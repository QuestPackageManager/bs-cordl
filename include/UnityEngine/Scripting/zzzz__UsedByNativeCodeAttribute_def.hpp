...
public:
  ...
  /// @brief Method .ctor, addr 0x34aaa70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34aaa78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method set_Name, addr 0x34aaaa0, size 0x8, virtual false, abstract: false, final false
