...
public:
  ...
  /// @brief Method Blit, addr 0x31e4f04, size 0x84, virtual false, abstract: false, final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest);

  /// @brief Method Blit, addr 0x31e520c, size 0x70, virtual false, abstract: false, final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest, ::UnityEngine::Material* mat);

  /// @brief Method Blit, addr 0x31e5100, size 0xa0, virtual false, abstract: false, final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest, ::UnityEngine::Material* mat, int32_t pass);

  /// @brief Method Blit, addr 0x31e4fcc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit2, addr 0x31e4f88, size 0x44, virtual false, abstract: false, final false
  static inline void Blit2(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest);

  /// @brief Method Blit4, addr 0x31e5060, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit4_Injected, addr 0x31e5488, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTexture, addr 0x31e4638, size 0x84, virtual false, abstract: false, final false
  static inline void CopyTexture(::UnityEngine::Texture* src, ::UnityEngine::Texture* dst);

  /// @brief Method CopyTexture, addr 0x31e4700, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTexture_Full, addr 0x31e46bc, size 0x44, virtual false, abstract: false, final false
  static inline void CopyTexture_Full(::UnityEngine::Texture* src, ::UnityEngine::Texture* dst);

  /// @brief Method CopyTexture_Slice, addr 0x31e47b4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMesh, addr 0x31e4b74, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMesh, addr 0x31e49d8, size 0x19c, virtual false, abstract: false, final false
  static inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material, int32_t layer, ::UnityEngine::Camera* camera, int32_t submeshIndex,
                              ::UnityEngine::MaterialPropertyBlock* properties, bool castShadows, bool receiveShadows, bool useLightProbes);

  /// @brief Method DrawMeshInstanced, addr 0x31e3cec, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMeshInstanced, addr 0x31e3dbc, size 0x4a0, virtual false, abstract: false, final false
  static inline void DrawMeshInstanced(::UnityEngine::Mesh* mesh, int32_t submeshIndex, ::UnityEngine::Material* material,
                                       ::ArrayW<::UnityEngine::Matrix4x4, ::Array<::UnityEngine::Matrix4x4>*> matrices, int32_t count, ::UnityEngine::MaterialPropertyBlock* properties,
                                       ::UnityEngine::Rendering::ShadowCastingMode castShadows, bool receiveShadows, int32_t layer, ::UnityEngine::Camera* camera,
                                       ::UnityEngine::Rendering::LightProbeUsage lightProbeUsage, ::UnityEngine::LightProbeProxyVolume* lightProbeProxyVolume);

  /// @brief Method DrawMeshNow, addr 0x31e4828, size 0x124, virtual false, abstract: false, final false
  static inline void DrawMeshNow(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, int32_t materialIndex);

  /// @brief Method ExecuteCommandBuffer, addr 0x31e54e4, size 0x3c, virtual false, abstract: false, final false
  static inline void ExecuteCommandBuffer(::UnityEngine::Rendering::CommandBuffer* buffer);

  /// @brief Method Internal_BlitMaterial5, addr 0x31e51a0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawMesh, addr 0x31e4d18, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawMeshInstanced, addr 0x31e4e44, size 0xc0, virtual false, abstract: false, final false
  static inline void Internal_DrawMeshInstanced(::UnityEngine::Mesh* mesh, int32_t submeshIndex, ::UnityEngine::Material* material,
                                                ::ArrayW<::UnityEngine::Matrix4x4, ::Array<::UnityEngine::Matrix4x4>*> matrices, int32_t count, ::UnityEngine::MaterialPropertyBlock* properties,
                                                ::UnityEngine::Rendering::ShadowCastingMode castShadows, bool receiveShadows, int32_t layer, ::UnityEngine::Camera* camera,
                                                ::UnityEngine::Rendering::LightProbeUsage lightProbeUsage, ::UnityEngine::LightProbeProxyVolume* lightProbeProxyVolume);

  /// @brief Method Internal_DrawMeshNow2, addr 0x31e494c, size 0x8c, virtual false, abstract: false, final false
  static inline void Internal_DrawMeshNow2(::UnityEngine::Mesh* mesh, int32_t subsetIndex, ::UnityEngine::Matrix4x4 matrix);

  /// @brief Method Internal_DrawMeshNow2_Injected, addr 0x31e5374, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawMesh_Injected, addr 0x31e53c8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetMaxDrawMeshInstanceCount, addr 0x31e527c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t Internal_GetMaxDrawMeshInstanceCount();

  /// @brief Method Internal_SetNullRT, addr 0x31e4610, size 0x28, virtual false, abstract: false, final false
  static inline void Internal_SetNullRT();

  /// @brief Method Internal_SetRTSimple, addr 0x31e4444, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetRTSimple_Injected, addr 0x31e5308, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRenderTarget, addr 0x31e425c, size 0x60, virtual false, abstract: false, final false
  static inline void SetRenderTarget(::UnityEngine::RenderTexture* rt);

  /// @brief Method SetRenderTarget, addr 0x31e4338, size 0x70, virtual false, abstract: false, final false
  static inline void SetRenderTarget(::UnityEngine::RenderTexture* rt, int32_t mipLevel, ::UnityEngine::CubemapFace face);

  /// @brief Method SetRenderTarget, addr 0x31e42bc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRenderTargetImpl, addr 0x31e43a8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRenderTargetImpl, addr 0x31e44ec, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeTier, addr 0x31e52a4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method set_activeTier, addr 0x31e52cc, size 0x3c, virtual false, abstract: false, final false
