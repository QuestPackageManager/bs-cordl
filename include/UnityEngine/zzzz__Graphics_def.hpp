...
public:
  ...
  /// @brief Method DrawMeshInstanced addr 0x2b4f838 size 0xd0 virtual false final false
  ...
  /// @brief Method SetRenderTarget addr 0x2b4fda8 size 0x60 virtual false final false
  static inline void SetRenderTarget(::UnityEngine::RenderTexture* rt);

  /// @brief Method SetRenderTarget addr 0x2b4fe84 size 0x70 virtual false final false
  static inline void SetRenderTarget(::UnityEngine::RenderTexture* rt, int32_t mipLevel, ::UnityEngine::CubemapFace face);

  /// @brief Method SetRenderTargetImpl addr 0x2b4fef4 size 0x9c virtual false final false
  ...
  /// @brief Method SetRenderTargetImpl addr 0x2b50038 size 0x124 virtual false final false
  ...
  /// @brief Method SetRenderTarget addr 0x2b4fe08 size 0x7c virtual false final false
  ...
  /// @brief Method CopyTexture addr 0x2b50184 size 0x84 virtual false final false
  static inline void CopyTexture(::UnityEngine::Texture* src, ::UnityEngine::Texture* dst);

  /// @brief Method CopyTexture addr 0x2b5024c size 0xb4 virtual false final false
  ...
  /// @brief Method DrawMeshNow addr 0x2b50374 size 0x124 virtual false final false
  static inline void DrawMeshNow(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, int32_t materialIndex);

  /// @brief Method DrawMesh addr 0x2b50524 size 0x19c virtual false final false
  ...
  /// @brief Method DrawMesh addr 0x2b506c0 size 0x1a4 virtual false final false
  static inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material, int32_t layer, ::UnityEngine::Camera* camera, int32_t submeshIndex,
  ...
  /// @brief Method DrawMeshInstanced addr 0x2b4f908 size 0x4a0 virtual false final false
  static inline void DrawMeshInstanced(::UnityEngine::Mesh* mesh, int32_t submeshIndex, ::UnityEngine::Material* material,
                                       ::ArrayW<::UnityEngine::Matrix4x4, ::Array<::UnityEngine::Matrix4x4>*> matrices, int32_t count, ::UnityEngine::MaterialPropertyBlock* properties,
                                       ::UnityEngine::Rendering::ShadowCastingMode castShadows, bool receiveShadows, int32_t layer, ::UnityEngine::Camera* camera,
                                       ::UnityEngine::Rendering::LightProbeUsage lightProbeUsage, ::UnityEngine::LightProbeProxyVolume* lightProbeProxyVolume);

  /// @brief Method Blit addr 0x2b50a50 size 0x84 virtual false final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest);

  /// @brief Method Blit addr 0x2b50b18 size 0x94 virtual false final false
  ...
  /// @brief Method Blit addr 0x2b50c4c size 0xa0 virtual false final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest, ::UnityEngine::Material* mat, int32_t pass);

  /// @brief Method Blit addr 0x2b50d58 size 0x70 virtual false final false
  static inline void Blit(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest, ::UnityEngine::Material* mat);

  /// @brief Method Internal_GetMaxDrawMeshInstanceCount addr 0x2b50dc8 size 0x28 virtual false final false
  static inline int32_t Internal_GetMaxDrawMeshInstanceCount();

  /// @brief Method get_activeTier addr 0x2b50df0 size 0x28 virtual false final false
  static inline ::UnityEngine::Rendering::GraphicsTier get_activeTier();

  /// @brief Method set_activeTier addr 0x2b50e18 size 0x3c virtual false final false
  static inline void set_activeTier(::UnityEngine::Rendering::GraphicsTier value);

  /// @brief Method Internal_SetNullRT addr 0x2b5015c size 0x28 virtual false final false
  static inline void Internal_SetNullRT();

  /// @brief Method Internal_SetRTSimple addr 0x2b4ff90 size 0xa8 virtual false final false
  ...
  /// @brief Method CopyTexture_Full addr 0x2b50208 size 0x44 virtual false final false
  static inline void CopyTexture_Full(::UnityEngine::Texture* src, ::UnityEngine::Texture* dst);

  /// @brief Method CopyTexture_Slice addr 0x2b50300 size 0x74 virtual false final false
  ...
  /// @brief Method Internal_DrawMeshNow2 addr 0x2b50498 size 0x8c virtual false final false
  static inline void Internal_DrawMeshNow2(::UnityEngine::Mesh* mesh, int32_t subsetIndex, ::UnityEngine::Matrix4x4 matrix);

  /// @brief Method Internal_DrawMesh addr 0x2b50864 size 0xf0 virtual false final false
  ...
  /// @brief Method Internal_DrawMeshInstanced addr 0x2b50990 size 0xc0 virtual false final false
  static inline void Internal_DrawMeshInstanced(::UnityEngine::Mesh* mesh, int32_t submeshIndex, ::UnityEngine::Material* material,
                                                ::ArrayW<::UnityEngine::Matrix4x4, ::Array<::UnityEngine::Matrix4x4>*> matrices, int32_t count, ::UnityEngine::MaterialPropertyBlock* properties,
                                                ::UnityEngine::Rendering::ShadowCastingMode castShadows, bool receiveShadows, int32_t layer, ::UnityEngine::Camera* camera,
                                                ::UnityEngine::Rendering::LightProbeUsage lightProbeUsage, ::UnityEngine::LightProbeProxyVolume* lightProbeProxyVolume);

  /// @brief Method Internal_BlitMaterial5 addr 0x2b50cec size 0x6c virtual false final false
  ...
  /// @brief Method Blit2 addr 0x2b50ad4 size 0x44 virtual false final false
  static inline void Blit2(::UnityEngine::Texture* source, ::UnityEngine::RenderTexture* dest);

  /// @brief Method Blit4 addr 0x2b50bac size 0xa0 virtual false final false
  ...
  /// @brief Method ExecuteCommandBuffer addr 0x2b51030 size 0x3c virtual false final false
  static inline void ExecuteCommandBuffer(::UnityEngine::Rendering::CommandBuffer* buffer);

  /// @brief Method Internal_SetRTSimple_Injected addr 0x2b50e54 size 0x6c virtual false final false
  ...
  /// @brief Method Internal_DrawMeshNow2_Injected addr 0x2b50ec0 size 0x54 virtual false final false
  ...
  /// @brief Method Internal_DrawMesh_Injected addr 0x2b50f14 size 0xc0 virtual false final false
  ...
  /// @brief Method Blit4_Injected addr 0x2b50fd4 size 0x5c virtual false final false
