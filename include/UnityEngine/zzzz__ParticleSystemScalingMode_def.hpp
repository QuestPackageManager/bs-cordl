...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemScalingMode, "UnityEngine", "ParticleSystemScalingMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemScalingMode) == 0x4, "Size mismatch!");
