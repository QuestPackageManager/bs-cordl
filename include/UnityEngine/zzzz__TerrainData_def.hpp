...
public:
  ...
  /// @brief Method GetAlphamapResolutionInternal, addr 0x6a612dc, size 0xa8, virtual false, abstract: false, final false
  inline float_t GetAlphamapResolutionInternal();

  /// @brief Method GetAlphamapResolutionInternal_Injected, addr 0x6a61384, size 0x3c, virtual false, abstract: false, final false
  static inline float_t GetAlphamapResolutionInternal_Injected(::System::IntPtr _unity_self);

  /// @brief Method GetBoundaryValue, addr 0x6a61194, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_size, addr 0x6a611d0, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_size();

  /// @brief Method get_size_Injected, addr 0x6a61298, size 0x44, virtual false, abstract: false, final false
  static inline void get_size_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_users, addr 0x6a60ec8, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Terrain>, ::Array<::UnityW<::UnityEngine::Terrain>>*> get_users();

  /// @brief Method get_users_Injected, addr 0x6a613c0, size 0x3c, virtual false, abstract: false, final false
