...
/// @brief Method GetAlphamapResolutionInternal, addr 0x69ef094, size 0xa8, virtual false, abstract: false, final false
inline float_t GetAlphamapResolutionInternal() ;

/// @brief Method GetAlphamapResolutionInternal_Injected, addr 0x69ef13c, size 0x3c, virtual false, abstract: false, final false
static inline float_t GetAlphamapResolutionInternal_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method GetBoundaryValue, addr 0x69eef4c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_size, addr 0x69eef88, size 0xc8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_size() ;

/// @brief Method get_size_Injected, addr 0x69ef050, size 0x44, virtual false, abstract: false, final false
static inline void get_size_Injected(::System::IntPtr  _unity_self, ::ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method get_users, addr 0x69eec80, size 0xa8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Terrain>,::Array<::UnityW<::UnityEngine::Terrain>>*> get_users() ;

/// @brief Method get_users_Injected, addr 0x69ef178, size 0x3c, virtual false, abstract: false, final false
