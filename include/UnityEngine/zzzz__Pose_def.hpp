...
public:
  ...
  /// @brief Method Equals, addr 0x699b684, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x699b74c, size 0x130, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Pose other);

  /// @brief Method GetHashCode, addr 0x699b87c, size 0xb0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTransformedBy, addr 0x699b4a0, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose GetTransformedBy(::UnityEngine::Pose lhs);

  /// @brief Method ToString, addr 0x699b394, size 0x10c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x699b380, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_forward, addr 0x699b59c, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_forward();

  /// @brief Method get_identity, addr 0x699b618, size 0x6c, virtual false, abstract: false, final false
