...
public:
  ...
  /// @brief Method .ctor, addr 0x2ca1c7c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation);

  /// @brief Method ToString, addr 0x2ca1c90, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method GetTransformedBy, addr 0x2ca1d84, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose GetTransformedBy(::UnityEngine::Pose lhs);

  /// @brief Method get_forward, addr 0x2ca1e68, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_forward();

  /// @brief Method get_identity, addr 0x2ca1ed8, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose get_identity();

  /// @brief Method Equals, addr 0x2ca1f40, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2ca1fd0, size 0x84, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Pose other);

  /// @brief Method GetHashCode, addr 0x2ca2054, size 0xac, virtual true, abstract: false, final false
