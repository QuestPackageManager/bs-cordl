...
public:
  ...
  /// @brief Method Equals, addr 0x31cf7ac, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x31cf83c, size 0x84, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Pose other);

  /// @brief Method GetHashCode, addr 0x31cf8c0, size 0xac, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTransformedBy, addr 0x31cf5f0, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose GetTransformedBy(::UnityEngine::Pose lhs);

  /// @brief Method ToString, addr 0x31cf4fc, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x31cf4e8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_forward, addr 0x31cf6d4, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_forward();

  /// @brief Method get_identity, addr 0x31cf744, size 0x68, virtual false, abstract: false, final false
