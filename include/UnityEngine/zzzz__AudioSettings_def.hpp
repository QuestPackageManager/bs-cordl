...
public:
  ...
  /// @brief Method .ctor addr 0x2b35548 size 0xc4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x2b3560c size 0x18 virtual true final false
...
public:
  ...
  /// @brief Method get_muteState addr 0x2b35624 size 0x48 virtual false final false
  static inline bool get_muteState();

  /// @brief Method set_muteState addr 0x2b3566c size 0x4c virtual false final false
  static inline void set_muteState(bool value);

  /// @brief Method get_stopAudioOutputOnMute addr 0x2b356b8 size 0x48 virtual false final false
  static inline bool get_stopAudioOutputOnMute();

  /// @brief Method InvokeOnMuteStateChanged addr 0x2b35700 size 0x17c virtual false final false
  static inline void InvokeOnMuteStateChanged(bool mute);

  /// @brief Method InvokeIsStopAudioOutputOnMuteEnabled addr 0x2b358cc size 0x48 virtual false final false
  static inline bool InvokeIsStopAudioOutputOnMuteEnabled();

  /// @brief Method StartAudioOutput addr 0x2b358a4 size 0x28 virtual false final false
  static inline void StartAudioOutput();

  /// @brief Method StopAudioOutput addr 0x2b3587c size 0x28 virtual false final false
...
public:
  ...
  /// @brief Method GetSampleRate addr 0x2b35288 size 0x28 virtual false final false
  static inline int32_t GetSampleRate();

  /// @brief Method get_dspTime addr 0x2b352b0 size 0x28 virtual false final false
  static inline double_t get_dspTime();

  /// @brief Method get_outputSampleRate addr 0x2b352d8 size 0x28 virtual false final false
  static inline int32_t get_outputSampleRate();

  /// @brief Method GetSpatializerPluginName addr 0x2b35300 size 0x28 virtual false final false
  static inline ::StringW GetSpatializerPluginName();

  /// @brief Method GetConfiguration addr 0x2b35328 size 0x60 virtual false final false
  static inline ::UnityEngine::AudioConfiguration GetConfiguration();

  /// @brief Method InvokeOnAudioConfigurationChanged addr 0x2b353c4 size 0x6c virtual false final false
  static inline void InvokeOnAudioConfigurationChanged(bool deviceWasChanged);

  /// @brief Method InvokeOnAudioSystemShuttingDown addr 0x2b35430 size 0x64 virtual false final false
  static inline void InvokeOnAudioSystemShuttingDown();

  /// @brief Method InvokeOnAudioSystemStartedUp addr 0x2b35494 size 0x64 virtual false final false
  static inline void InvokeOnAudioSystemStartedUp();

  /// @brief Method StartAudioOutput addr 0x2b354f8 size 0x28 virtual false final false
  static inline bool StartAudioOutput();

  /// @brief Method StopAudioOutput addr 0x2b35520 size 0x28 virtual false final false
  static inline bool StopAudioOutput();

  /// @brief Method GetConfiguration_Injected addr 0x2b35388 size 0x3c virtual false final false
