...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68ee7fc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68ee790, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeIsStopAudioOutputOnMuteEnabled, addr 0x68eeb0c, size 0x4c, virtual false, abstract: false, final false
  static inline bool InvokeIsStopAudioOutputOnMuteEnabled();

  /// @brief Method InvokeOnMuteStateChanged, addr 0x68ee8fc, size 0x1c0, virtual false, abstract: false, final false
  static inline void InvokeOnMuteStateChanged(bool mute);

  /// @brief Method StartAudioOutput, addr 0x68eeae4, size 0x28, virtual false, abstract: false, final false
  static inline void StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x68eeabc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_muteState, addr 0x68ee810, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_muteState();

  /// @brief Method get_stopAudioOutputOnMute, addr 0x68ee8b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_muteState, addr 0x68ee85c, size 0x54, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetConfiguration, addr 0x68ee37c, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::AudioConfiguration GetConfiguration();

  /// @brief Method GetConfiguration_Injected, addr 0x68ee3dc, size 0x3c, virtual false, abstract: false, final false
  static inline void GetConfiguration_Injected(::ByRef<::UnityEngine::AudioConfiguration> ret);

  /// @brief Method GetSampleRate, addr 0x68ee204, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetSampleRate();

  /// @brief Method GetSpatializerPluginName, addr 0x68ee27c, size 0xc4, virtual false, abstract: false, final false
  static inline ::StringW GetSpatializerPluginName();

  /// @brief Method GetSpatializerPluginName_Injected, addr 0x68ee340, size 0x3c, virtual false, abstract: false, final false
  static inline void GetSpatializerPluginName_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method InvokeOnAudioConfigurationChanged, addr 0x68ee600, size 0x70, virtual false, abstract: false, final false
  static inline void InvokeOnAudioConfigurationChanged(bool deviceWasChanged);

  /// @brief Method InvokeOnAudioSystemShuttingDown, addr 0x68ee670, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemShuttingDown();

  /// @brief Method InvokeOnAudioSystemStartedUp, addr 0x68ee6d8, size 0x68, virtual false, abstract: false, final false
  static inline void InvokeOnAudioSystemStartedUp();

  /// @brief Method Reset, addr 0x68ee418, size 0x50, virtual false, abstract: false, final false
  static inline bool Reset(::UnityEngine::AudioConfiguration config);

  /// @brief Method SetConfiguration, addr 0x68ee18c, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetConfiguration(::UnityEngine::AudioConfiguration config);

  /// @brief Method SetConfiguration_Injected, addr 0x68ee1c8, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetConfiguration_Injected(::ByRef<::UnityEngine::AudioConfiguration> config);

  /// @brief Method StartAudioOutput, addr 0x68ee740, size 0x28, virtual false, abstract: false, final false
  static inline bool StartAudioOutput();

  /// @brief Method StopAudioOutput, addr 0x68ee768, size 0x28, virtual false, abstract: false, final false
  static inline bool StopAudioOutput();

  /// @brief Method add_OnAudioConfigurationChanged, addr 0x68ee468, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dspTime, addr 0x68ee22c, size 0x28, virtual false, abstract: false, final false
  static inline double_t get_dspTime();

  /// @brief Method get_outputSampleRate, addr 0x68ee254, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_outputSampleRate();

  /// @brief Method remove_OnAudioConfigurationChanged, addr 0x68ee534, size 0xcc, virtual false, abstract: false, final false
