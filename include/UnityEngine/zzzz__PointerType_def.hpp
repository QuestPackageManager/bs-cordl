...
DEFINE_IL2CPP_CLASS(::UnityEngine::PointerType, "UnityEngine", "PointerType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::PointerType) == 0x4, "Size mismatch!");
