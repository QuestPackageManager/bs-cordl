...
/// @brief Method .ctor, addr 0x6910754, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  order) ;

/// @brief Method get_order, addr 0x691057c, size 0x8, virtual false, abstract: false, final false
