...
public:
  ...
  /// @brief Method .ctor, addr 0x6910094, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t order);

  /// @brief Method get_order, addr 0x690febc, size 0x8, virtual false, abstract: false, final false
