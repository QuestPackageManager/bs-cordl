...
public:
  ...
  /// @brief Method DontStripMeshFilter, addr 0x4886bc0, size 0x4, virtual false, abstract: false, final false
  inline void DontStripMeshFilter();

  static inline ::UnityEngine::MeshFilter* New_ctor();

  /// @brief Method .ctor, addr 0x4886cc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x4886c44, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_sharedMesh, addr 0x4886bc4, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_sharedMesh();

  /// @brief Method set_mesh, addr 0x4886c80, size 0x44, virtual false, abstract: false, final false
  inline void set_mesh(::UnityEngine::Mesh* value);

  /// @brief Method set_sharedMesh, addr 0x4886c00, size 0x44, virtual false, abstract: false, final false
