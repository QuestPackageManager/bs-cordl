...
public:
  ...
  /// @brief Method DontStripMeshFilter, addr 0x2da0e44, size 0x4, virtual false, abstract: false, final false
  inline void DontStripMeshFilter();

  static inline ::UnityEngine::MeshFilter* New_ctor();

  /// @brief Method .ctor, addr 0x2da0f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x2da0ec8, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_sharedMesh, addr 0x2da0e48, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_sharedMesh();

  /// @brief Method set_mesh, addr 0x2da0f04, size 0x44, virtual false, abstract: false, final false
  inline void set_mesh(::UnityEngine::Mesh* value);

  /// @brief Method set_sharedMesh, addr 0x2da0e84, size 0x44, virtual false, abstract: false, final false
