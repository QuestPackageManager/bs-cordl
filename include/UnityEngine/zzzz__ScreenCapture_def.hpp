...
public:
  ...
  /// @brief Method CaptureScreenshot, addr 0x6a5d0d4, size 0xc, virtual false, abstract: false, final false
  static inline void CaptureScreenshot(::StringW filename);

  /// @brief Method CaptureScreenshot, addr 0x6a5d0e0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CaptureScreenshot_Injected, addr 0x6a5d21c, size 0x54, virtual false, abstract: false, final false
