...
public:
  ...
  /// @brief Method Create, addr 0x344dcf0, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Sprite> Create(::UnityEngine::Rect rect, ::UnityEngine::Vector2 pivot, float_t pixelsToUnits);

  /// @brief Method Create, addr 0x344dcec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x344e1ec, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x344e1e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x344e1d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x344e0f4, size 0xe4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Sprite> Create(::UnityEngine::Texture2D* texture, ::UnityEngine::Rect rect, ::UnityEngine::Vector2 pivot, float_t pixelsPerUnit, uint32_t extrude,
                                                       ::UnityEngine::SpriteMeshType meshType);

  /// @brief Method Create, addr 0x344e0e4, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Sprite> Create(::UnityEngine::Texture2D* texture, ::UnityEngine::Rect rect, ::UnityEngine::Vector2 pivot, float_t pixelsPerUnit, uint32_t extrude,
                                                       ::UnityEngine::SpriteMeshType meshType, ::UnityEngine::Vector4 border);

  /// @brief Method Create, addr 0x344dcf8, size 0x3ec, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Sprite> Create(::UnityEngine::Texture2D* texture, ::UnityEngine::Rect rect, ::UnityEngine::Vector2 pivot, float_t pixelsPerUnit, uint32_t extrude,
                                                       ::UnityEngine::SpriteMeshType meshType, ::UnityEngine::Vector4 border, bool generateFallbackPhysicsShape);

  /// @brief Method CreateSprite, addr 0x344cce4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpriteWithoutTextureScripting, addr 0x344cc14, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpriteWithoutTextureScripting_Injected, addr 0x344cc80, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSprite_Injected, addr 0x344cd7c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInnerUVs, addr 0x344ca40, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetInnerUVs();

  /// @brief Method GetInnerUVs_Injected, addr 0x344ca98, size 0x44, virtual false, abstract: false, final false
  inline void GetInnerUVs_Injected(ByRef<::UnityEngine::Vector4> ret);

  /// @brief Method GetOuterUVs, addr 0x344cadc, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetOuterUVs();

  /// @brief Method GetOuterUVs_Injected, addr 0x344cb34, size 0x44, virtual false, abstract: false, final false
  inline void GetOuterUVs_Injected(ByRef<::UnityEngine::Vector4> ret);

  /// @brief Method GetPacked, addr 0x344c8d8, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetPacked();

  /// @brief Method GetPackingMode, addr 0x344c860, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetPackingMode();

  /// @brief Method GetPackingRotation, addr 0x344c89c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetPackingRotation();

  /// @brief Method GetPadding, addr 0x344cb78, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetPadding();

  /// @brief Method GetPadding_Injected, addr 0x344cbd0, size 0x44, virtual false, abstract: false, final false
  inline void GetPadding_Injected(ByRef<::UnityEngine::Vector4> ret);

  /// @brief Method GetPhysicsShape, addr 0x344d610, size 0x158, virtual false, abstract: false, final false
  inline int32_t GetPhysicsShape(int32_t shapeIdx, ::System::Collections::Generic::List_1<::UnityEngine::Vector2>* physicsShape);

  /// @brief Method GetPhysicsShapeCount, addr 0x344d470, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetPhysicsShapeCount();

  /// @brief Method GetPhysicsShapeImpl, addr 0x344d768, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPhysicsShapePointCount, addr 0x344d4ac, size 0x120, virtual false, abstract: false, final false
  inline int32_t GetPhysicsShapePointCount(int32_t shapeIdx);

  /// @brief Method GetSecondaryTexture, addr 0x344d030, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> GetSecondaryTexture(int32_t index);

  /// @brief Method GetTextureRect, addr 0x344c914, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetTextureRect();

  /// @brief Method GetTextureRectOffset, addr 0x344c9b0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetTextureRectOffset();

  /// @brief Method GetTextureRectOffset_Injected, addr 0x344c9fc, size 0x44, virtual false, abstract: false, final false
  inline void GetTextureRectOffset_Injected(ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method GetTextureRect_Injected, addr 0x344c96c, size 0x44, virtual false, abstract: false, final false
  inline void GetTextureRect_Injected(ByRef<::UnityEngine::Rect> ret);

  /// @brief Method Internal_GetPhysicsShapePointCount, addr 0x344d5cc, size 0x44, virtual false, abstract: false, final false
  inline int32_t Internal_GetPhysicsShapePointCount(int32_t shapeIdx);

  static inline ::UnityEngine::Sprite* New_ctor();

  /// @brief Method OverrideGeometry, addr 0x344dc98, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OverridePhysicsShape, addr 0x344d7bc, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method OverridePhysicsShape, addr 0x344dc44, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OverridePhysicsShapeCount, addr 0x344dc00, size 0x44, virtual false, abstract: false, final false
  static inline void OverridePhysicsShapeCount(::UnityEngine::Sprite* sprite, int32_t physicsShapeCount);

  /// @brief Method .ctor, addr 0x344c808, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_associatedAlphaSplitTexture, addr 0x344d0ec, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_associatedAlphaSplitTexture();

  /// @brief Method get_border, addr 0x344cf58, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_border();

  /// @brief Method get_border_Injected, addr 0x344cfb0, size 0x44, virtual false, abstract: false, final false
  inline void get_border_Injected(ByRef<::UnityEngine::Vector4> ret);

  /// @brief Method get_bounds, addr 0x344ce10, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_bounds();

  /// @brief Method get_bounds_Injected, addr 0x344ce78, size 0x44, virtual false, abstract: false, final false
  inline void get_bounds_Injected(ByRef<::UnityEngine::Bounds> ret);

  /// @brief Method get_packed, addr 0x344d1b8, size 0x48, virtual false, abstract: false, final false
  inline bool get_packed();

  /// @brief Method get_packingMode, addr 0x344d200, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::SpritePackingMode get_packingMode();

  /// @brief Method get_packingRotation, addr 0x344d23c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::SpritePackingRotation get_packingRotation();

  /// @brief Method get_pivot, addr 0x344d128, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_pivot();

  /// @brief Method get_pivot_Injected, addr 0x344d174, size 0x44, virtual false, abstract: false, final false
  inline void get_pivot_Injected(ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method get_pixelsPerUnit, addr 0x344d074, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_pixelsPerUnit();

  /// @brief Method get_rect, addr 0x344cebc, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_rect_Injected, addr 0x344cf14, size 0x44, virtual false, abstract: false, final false
  inline void get_rect_Injected(ByRef<::UnityEngine::Rect> ret);

  /// @brief Method get_spriteAtlasTextureScale, addr 0x344d0b0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_spriteAtlasTextureScale();

  /// @brief Method get_texture, addr 0x344cff4, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_texture();

  /// @brief Method get_textureRect, addr 0x344d278, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_textureRect();

  /// @brief Method get_textureRectOffset, addr 0x344d304, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureRectOffset();

  /// @brief Method get_triangles, addr 0x344d3f8, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<uint16_t, ::Array<uint16_t>*> get_triangles();

  /// @brief Method get_uv, addr 0x344d434, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> get_uv();

  /// @brief Method get_vertices, addr 0x344d3bc, size 0x3c, virtual false, abstract: false, final false
