...
// Ctor Parameters [CppParam { name: "speakerMode", ty: "::UnityEngine::AudioSpeakerMode", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "dspBufferSize", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sampleRate", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "numRealVoices", ty:
// "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "numVirtualVoices", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
