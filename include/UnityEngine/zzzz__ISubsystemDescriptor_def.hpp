...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISubsystemDescriptor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISubsystemDescriptor(ISubsystemDescriptorconst&) = delete;
