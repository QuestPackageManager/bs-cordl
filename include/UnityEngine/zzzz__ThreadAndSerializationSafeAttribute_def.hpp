...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ThreadAndSerializationSafeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ThreadAndSerializationSafeAttribute(ThreadAndSerializationSafeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ThreadAndSerializationSafeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ThreadAndSerializationSafeAttribute(ThreadAndSerializationSafeAttributeconst&) = delete;
