...
namespace UnityEngine::Yoga {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15393))}
...
public:
  ...
  /// @brief Method get_Unit addr 0x2d39c24 size 0x8 virtual false final false
  inline ::UnityEngine::Yoga::YogaUnit get_Unit();

  /// @brief Method get_Value addr 0x2d39c2c size 0x8 virtual false final false
  inline float_t get_Value();

  /// @brief Method Point addr 0x2d3cdd4 size 0x24 virtual false final false
  static inline ::UnityEngine::Yoga::YogaValue Point(float_t value);

  /// @brief Method Equals addr 0x2d3cdf8 size 0x60 virtual false final false
  inline bool Equals(::UnityEngine::Yoga::YogaValue other);

  /// @brief Method Equals addr 0x2d3ce58 size 0x78 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2d3ced0 size 0x3c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Auto addr 0x2d3cf0c size 0xc virtual false final false
  static inline ::UnityEngine::Yoga::YogaValue Auto();

  /// @brief Method Percent addr 0x2d3cf18 size 0x28 virtual false final false
  static inline ::UnityEngine::Yoga::YogaValue Percent(float_t value);

  /// @brief Method op_Implicit addr 0x2d3cf40 size 0x2c virtual false final false
