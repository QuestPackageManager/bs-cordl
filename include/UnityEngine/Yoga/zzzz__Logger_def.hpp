...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x300ca1c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x300c8ec, size 0x130, virtual false, abstract: false, final false
