...
public:
  ...
  /// @brief Method set_Left addr 0x2d39b70 size 0xc virtual false final false
  inline void set_Left(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_Top addr 0x2d39c00 size 0xc virtual false final false
  inline void set_Top(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_Right addr 0x2d39c0c size 0xc virtual false final false
  inline void set_Right(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_Bottom addr 0x2d39c18 size 0xc virtual false final false
  inline void set_Bottom(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method SetStylePosition addr 0x2d39b7c size 0x84 virtual false final false
  inline void SetStylePosition(::UnityEngine::Yoga::YogaEdge edge, ::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MarginLeft addr 0x2d39cdc size 0xc virtual false final false
  inline void set_MarginLeft(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MarginTop addr 0x2d39db0 size 0xc virtual false final false
  inline void set_MarginTop(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MarginRight addr 0x2d39dbc size 0xc virtual false final false
  inline void set_MarginRight(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MarginBottom addr 0x2d39dc8 size 0xc virtual false final false
  inline void set_MarginBottom(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method SetStyleMargin addr 0x2d39ce8 size 0xc8 virtual false final false
  inline void SetStyleMargin(::UnityEngine::Yoga::YogaEdge edge, ::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_PaddingLeft addr 0x2d39ec0 size 0xc virtual false final false
  inline void set_PaddingLeft(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_PaddingTop addr 0x2d39f50 size 0xc virtual false final false
  inline void set_PaddingTop(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_PaddingRight addr 0x2d39f5c size 0xc virtual false final false
  inline void set_PaddingRight(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_PaddingBottom addr 0x2d39f68 size 0xc virtual false final false
  inline void set_PaddingBottom(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method SetStylePadding addr 0x2d39ecc size 0x84 virtual false final false
  inline void SetStylePadding(::UnityEngine::Yoga::YogaEdge edge, ::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_BorderLeftWidth addr 0x2d3a01c size 0x50 virtual false final false
  inline void set_BorderLeftWidth(float_t value);

  /// @brief Method set_BorderTopWidth addr 0x2d3a0c0 size 0x50 virtual false final false
  inline void set_BorderTopWidth(float_t value);

  /// @brief Method set_BorderRightWidth addr 0x2d3a110 size 0x50 virtual false final false
  inline void set_BorderRightWidth(float_t value);

  /// @brief Method set_BorderBottomWidth addr 0x2d3a160 size 0x50 virtual false final false
  inline void set_BorderBottomWidth(float_t value);

  /// @brief Method get_LayoutMarginLeft addr 0x2d3a1b0 size 0x40 virtual false final false
  inline float_t get_LayoutMarginLeft();

  /// @brief Method get_LayoutMarginTop addr 0x2d3a234 size 0x40 virtual false final false
  inline float_t get_LayoutMarginTop();

  /// @brief Method get_LayoutMarginRight addr 0x2d3a274 size 0x40 virtual false final false
  inline float_t get_LayoutMarginRight();

  /// @brief Method get_LayoutMarginBottom addr 0x2d3a2b4 size 0x40 virtual false final false
  inline float_t get_LayoutMarginBottom();

  /// @brief Method get_LayoutPaddingLeft addr 0x2d3a2f4 size 0x40 virtual false final false
  inline float_t get_LayoutPaddingLeft();

  /// @brief Method get_LayoutPaddingTop addr 0x2d3a378 size 0x40 virtual false final false
  inline float_t get_LayoutPaddingTop();

  /// @brief Method get_LayoutPaddingRight addr 0x2d3a3b8 size 0x40 virtual false final false
  inline float_t get_LayoutPaddingRight();

  /// @brief Method get_LayoutPaddingBottom addr 0x2d3a3f8 size 0x40 virtual false final false
  inline float_t get_LayoutPaddingBottom();

  /// @brief Method get_LayoutBorderLeft addr 0x2d3a438 size 0x40 virtual false final false
  inline float_t get_LayoutBorderLeft();

  /// @brief Method get_LayoutBorderTop addr 0x2d3a4bc size 0x40 virtual false final false
  inline float_t get_LayoutBorderTop();

  /// @brief Method get_LayoutBorderRight addr 0x2d3a4fc size 0x40 virtual false final false
  inline float_t get_LayoutBorderRight();

  /// @brief Method get_LayoutBorderBottom addr 0x2d3a53c size 0x40 virtual false final false
  inline float_t get_LayoutBorderBottom();

  static inline ::UnityEngine::Yoga::YogaNode* New_ctor(::UnityEngine::Yoga::YogaConfig* config);

  /// @brief Method .ctor addr 0x2d3a57c size 0x130 virtual false final false
  inline void _ctor(::UnityEngine::Yoga::YogaConfig* config);

  /// @brief Method Finalize addr 0x2d3a6f0 size 0x98 virtual true final false
  inline void Finalize();

  /// @brief Method set_Config addr 0x2d3a814 size 0xb0 virtual false final false
  inline void set_Config(::UnityEngine::Yoga::YogaConfig* value);

  /// @brief Method get_IsDirty addr 0x2d3a908 size 0x3c virtual false final false
  inline bool get_IsDirty();

  /// @brief Method MarkDirty addr 0x2d3a980 size 0x3c virtual true final false
  inline void MarkDirty();

  /// @brief Method get_HasNewLayout addr 0x2d3a9f8 size 0x3c virtual false final false
  inline bool get_HasNewLayout();

  /// @brief Method get_IsMeasureDefined addr 0x2d3aa70 size 0x10 virtual false final false
  inline bool get_IsMeasureDefined();

  /// @brief Method get_IsBaselineDefined addr 0x2d3aa80 size 0x10 virtual false final false
  inline bool get_IsBaselineDefined();

  /// @brief Method CopyStyle addr 0x2d3aa90 size 0x4c virtual false final false
  inline void CopyStyle(::UnityEngine::Yoga::YogaNode* srcNode);

  /// @brief Method set_FlexDirection addr 0x2d3ab20 size 0x44 virtual false final false
  inline void set_FlexDirection(::UnityEngine::Yoga::YogaFlexDirection value);

  /// @brief Method set_JustifyContent addr 0x2d3aba8 size 0x44 virtual false final false
  inline void set_JustifyContent(::UnityEngine::Yoga::YogaJustify value);

  /// @brief Method set_Display addr 0x2d3ac30 size 0x44 virtual false final false
  inline void set_Display(::UnityEngine::Yoga::YogaDisplay value);

  /// @brief Method set_AlignItems addr 0x2d3acb8 size 0x44 virtual false final false
  inline void set_AlignItems(::UnityEngine::Yoga::YogaAlign value);

  /// @brief Method set_AlignSelf addr 0x2d3ad40 size 0x44 virtual false final false
  inline void set_AlignSelf(::UnityEngine::Yoga::YogaAlign value);

  /// @brief Method set_AlignContent addr 0x2d3adc8 size 0x44 virtual false final false
  inline void set_AlignContent(::UnityEngine::Yoga::YogaAlign value);

  /// @brief Method set_PositionType addr 0x2d3ae50 size 0x44 virtual false final false
  inline void set_PositionType(::UnityEngine::Yoga::YogaPositionType value);

  /// @brief Method set_Wrap addr 0x2d3aed8 size 0x44 virtual false final false
  inline void set_Wrap(::UnityEngine::Yoga::YogaWrap value);

  /// @brief Method set_Flex addr 0x2d3af60 size 0x4c virtual false final false
  inline void set_Flex(float_t value);

  /// @brief Method set_FlexGrow addr 0x2d3aff8 size 0x4c virtual false final false
  inline void set_FlexGrow(float_t value);

  /// @brief Method set_FlexShrink addr 0x2d3b090 size 0x4c virtual false final false
  inline void set_FlexShrink(float_t value);

  /// @brief Method set_FlexBasis addr 0x2d3b128 size 0xbc virtual false final false
  inline void set_FlexBasis(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_Width addr 0x2d3b2b8 size 0xbc virtual false final false
  inline void set_Width(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_Height addr 0x2d3b448 size 0xbc virtual false final false
  inline void set_Height(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MaxWidth addr 0x2d3b5d8 size 0x7c virtual false final false
  inline void set_MaxWidth(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MaxHeight addr 0x2d3b6ec size 0x7c virtual false final false
  inline void set_MaxHeight(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MinWidth addr 0x2d3b800 size 0x7c virtual false final false
  inline void set_MinWidth(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method set_MinHeight addr 0x2d3b914 size 0x7c virtual false final false
  inline void set_MinHeight(::UnityEngine::Yoga::YogaValue value);

  /// @brief Method get_LayoutX addr 0x2d3ba28 size 0x3c virtual false final false
  inline float_t get_LayoutX();

  /// @brief Method get_LayoutY addr 0x2d3baa0 size 0x3c virtual false final false
  inline float_t get_LayoutY();

  /// @brief Method get_LayoutRight addr 0x2d3bb18 size 0x3c virtual false final false
  inline float_t get_LayoutRight();

  /// @brief Method get_LayoutBottom addr 0x2d3bb90 size 0x3c virtual false final false
  inline float_t get_LayoutBottom();

  /// @brief Method get_LayoutWidth addr 0x2d3bc08 size 0x3c virtual false final false
  inline float_t get_LayoutWidth();

  /// @brief Method get_LayoutHeight addr 0x2d3bc80 size 0x3c virtual false final false
  inline float_t get_LayoutHeight();

  /// @brief Method set_Overflow addr 0x2d3bcf8 size 0x44 virtual false final false
  inline void set_Overflow(::UnityEngine::Yoga::YogaOverflow value);

  /// @brief Method get_Count addr 0x2d3bd80 size 0x4c virtual false final false
  inline int32_t get_Count();

  /// @brief Method MarkLayoutSeen addr 0x2d3bdcc size 0x40 virtual false final false
  inline void MarkLayoutSeen();

  /// @brief Method Insert addr 0x2d3be50 size 0x124 virtual false final false
  inline void Insert(int32_t index, ::UnityEngine::Yoga::YogaNode* node);

  /// @brief Method RemoveAt addr 0x2d3bfc8 size 0xc8 virtual false final false
  inline void RemoveAt(int32_t index);

  /// @brief Method Clear addr 0x2d3c0d4 size 0x64 virtual false final false
  inline void Clear();

  /// @brief Method SetMeasureFunction addr 0x2d3c138 size 0xd8 virtual false final false
  inline void SetMeasureFunction(::UnityEngine::Yoga::MeasureFunction* measureFunction);

  /// @brief Method CalculateLayout addr 0x2d3c2cc size 0x84 virtual false final false
  inline void CalculateLayout(float_t width, float_t height);

  /// @brief Method MeasureInternal addr 0x2d3c3e8 size 0x7c virtual false final false
  ...
  /// @brief Method BaselineInternal addr 0x2d3c464 size 0x74 virtual false final false
  static inline float_t BaselineInternal(::UnityEngine::Yoga::YogaNode* node, float_t width, float_t height);

  /// @brief Method GetEnumerator addr 0x2d3c4d8 size 0x12c virtual true final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::Yoga::YogaNode*>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2d3c604 size 0x12c virtual true final true
