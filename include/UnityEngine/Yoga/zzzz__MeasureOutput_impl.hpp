...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Yoga::YogaSize (*)(float_t, float_t)>(&::UnityEngine::Yoga::MeasureOutput::Make)> {
  ...
  constexpr static std::size_t addrs = 0x2d3ca64;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Yoga::MeasureOutput*>::get(), "Make", std::vector<Il2CppClass*>{},
