...
// Ctor Parameters [CppParam { name: "inverseMassScale", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "inverseInertiaScale", ty: "float_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "otherInverseMassScale", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "otherInverseInertiaScale",
