...
public:
  ...
  /// @brief Method get_damper, addr 0x693dfd8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_damper();

  /// @brief Method get_spring, addr 0x693dfc8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spring();

  /// @brief Method set_damper, addr 0x693dfe0, size 0x8, virtual false, abstract: false, final false
  inline void set_damper(float_t value);

  /// @brief Method set_spring, addr 0x693dfd0, size 0x8, virtual false, abstract: false, final false
