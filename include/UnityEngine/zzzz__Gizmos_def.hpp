...
public:
  // Declarations
  /// @brief Method DrawCube, addr 0x6928d00, size 0x50, virtual false, abstract: false, final false
  static inline void DrawCube(::UnityEngine::Vector3 center, ::UnityEngine::Vector3 size);

  /// @brief Method DrawCube_Injected, addr 0x6928d50, size 0x44, virtual false, abstract: false, final false
  static inline void DrawCube_Injected(::ByRef<::UnityEngine::Vector3> center, ::ByRef<::UnityEngine::Vector3> size);

  /// @brief Method DrawIcon, addr 0x6928d94, size 0x14c, virtual false, abstract: false, final false
  static inline void DrawIcon(::UnityEngine::Vector3 center, ::StringW name, bool allowScaling, ::UnityEngine::Color tint);

  /// @brief Method DrawIcon_Injected, addr 0x6928ee0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawLine, addr 0x6928a98, size 0x50, virtual false, abstract: false, final false
  static inline void DrawLine(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 to);

  /// @brief Method DrawLine_Injected, addr 0x6928ae8, size 0x44, virtual false, abstract: false, final false
  static inline void DrawLine_Injected(::ByRef<::UnityEngine::Vector3> from, ::ByRef<::UnityEngine::Vector3> to);

  /// @brief Method DrawRay, addr 0x6929034, size 0x10, virtual false, abstract: false, final false
  static inline void DrawRay(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 direction);

  /// @brief Method DrawSphere, addr 0x6928bcc, size 0x54, virtual false, abstract: false, final false
  static inline void DrawSphere(::UnityEngine::Vector3 center, float_t radius);

  /// @brief Method DrawSphere_Injected, addr 0x6928c20, size 0x4c, virtual false, abstract: false, final false
  static inline void DrawSphere_Injected(::ByRef<::UnityEngine::Vector3> center, float_t radius);

  /// @brief Method DrawWireCube, addr 0x6928c6c, size 0x50, virtual false, abstract: false, final false
  static inline void DrawWireCube(::UnityEngine::Vector3 center, ::UnityEngine::Vector3 size);

  /// @brief Method DrawWireCube_Injected, addr 0x6928cbc, size 0x44, virtual false, abstract: false, final false
  static inline void DrawWireCube_Injected(::ByRef<::UnityEngine::Vector3> center, ::ByRef<::UnityEngine::Vector3> size);

  /// @brief Method DrawWireSphere, addr 0x6928b2c, size 0x54, virtual false, abstract: false, final false
  static inline void DrawWireSphere(::UnityEngine::Vector3 center, float_t radius);

  /// @brief Method DrawWireSphere_Injected, addr 0x6928b80, size 0x4c, virtual false, abstract: false, final false
  static inline void DrawWireSphere_Injected(::ByRef<::UnityEngine::Vector3> center, float_t radius);

  /// @brief Method set_color, addr 0x6928f3c, size 0x44, virtual false, abstract: false, final false
  static inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_color_Injected, addr 0x6928f80, size 0x3c, virtual false, abstract: false, final false
  static inline void set_color_Injected(::ByRef<::UnityEngine::Color> value);

  /// @brief Method set_matrix, addr 0x6928fbc, size 0x3c, virtual false, abstract: false, final false
  static inline void set_matrix(::UnityEngine::Matrix4x4 value);

  /// @brief Method set_matrix_Injected, addr 0x6928ff8, size 0x3c, virtual false, abstract: false, final false
