...
public:
  // Declarations
  /// @brief Method DrawRay addr 0x2b79018 size 0x10 virtual false final false
  static inline void DrawRay(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 direction);

  /// @brief Method DrawLine addr 0x2b79028 size 0x50 virtual false final false
  static inline void DrawLine(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 to);

  /// @brief Method DrawWireSphere addr 0x2b790bc size 0x54 virtual false final false
  static inline void DrawWireSphere(::UnityEngine::Vector3 center, float_t radius);

  /// @brief Method DrawSphere addr 0x2b7915c size 0x54 virtual false final false
  static inline void DrawSphere(::UnityEngine::Vector3 center, float_t radius);

  /// @brief Method DrawWireCube addr 0x2b791fc size 0x50 virtual false final false
  static inline void DrawWireCube(::UnityEngine::Vector3 center, ::UnityEngine::Vector3 size);

  /// @brief Method DrawCube addr 0x2b79290 size 0x50 virtual false final false
  static inline void DrawCube(::UnityEngine::Vector3 center, ::UnityEngine::Vector3 size);

  /// @brief Method set_color addr 0x2b79324 size 0x44 virtual false final false
  static inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_matrix addr 0x2b793a4 size 0x3c virtual false final false
  static inline void set_matrix(::UnityEngine::Matrix4x4 value);

  /// @brief Method DrawLine_Injected addr 0x2b79078 size 0x44 virtual false final false
  static inline void DrawLine_Injected(ByRef<::UnityEngine::Vector3> from, ByRef<::UnityEngine::Vector3> to);

  /// @brief Method DrawWireSphere_Injected addr 0x2b79110 size 0x4c virtual false final false
  static inline void DrawWireSphere_Injected(ByRef<::UnityEngine::Vector3> center, float_t radius);

  /// @brief Method DrawSphere_Injected addr 0x2b791b0 size 0x4c virtual false final false
  static inline void DrawSphere_Injected(ByRef<::UnityEngine::Vector3> center, float_t radius);

  /// @brief Method DrawWireCube_Injected addr 0x2b7924c size 0x44 virtual false final false
  static inline void DrawWireCube_Injected(ByRef<::UnityEngine::Vector3> center, ByRef<::UnityEngine::Vector3> size);

  /// @brief Method DrawCube_Injected addr 0x2b792e0 size 0x44 virtual false final false
  static inline void DrawCube_Injected(ByRef<::UnityEngine::Vector3> center, ByRef<::UnityEngine::Vector3> size);

  /// @brief Method set_color_Injected addr 0x2b79368 size 0x3c virtual false final false
  static inline void set_color_Injected(ByRef<::UnityEngine::Color> value);

  /// @brief Method set_matrix_Injected addr 0x2b793e0 size 0x3c virtual false final false
