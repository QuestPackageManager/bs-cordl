...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemRenderSpace, "UnityEngine", "ParticleSystemRenderSpace");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemRenderSpace) == 0x4, "Size mismatch!");
