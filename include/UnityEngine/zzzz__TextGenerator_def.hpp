...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6c169ec, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finalize, addr 0x6c15780, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCharactersInternal_Injected, addr 0x6c16964, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLinesInternal_Injected, addr 0x6c169a8, size 0x44, virtual false, abstract: false, final false
  static inline void GetLinesInternal_Injected(::System::IntPtr _unity_self, ::System::Object* lines);

  /// @brief Method GetPreferredHeight, addr 0x6c15e80, size 0x5c, virtual false, abstract: false, final false
  inline float_t GetPreferredHeight(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetPreferredWidth, addr 0x6c15d68, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Invalidate, addr 0x6c15c4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x6c15dc8, size 0x4c, virtual false, abstract: false, final false
  inline bool Populate(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateAlways, addr 0x6c1612c, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithError, addr 0x6c160a0, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithErrors, addr 0x6c15edc, size 0x1c4, virtual false, abstract: false, final false
  inline bool PopulateWithErrors(::StringW str, ::UnityEngine::TextGenerationSettings settings, ::UnityEngine::GameObject* context);

  /// @brief Method Populate_Internal, addr 0x6c16234, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate_Internal, addr 0x6c1657c, size 0x270, virtual false, abstract: false, final false
  inline bool Populate_Internal(::StringW str, ::UnityEngine::Font* font, ::UnityEngine::Color color, int32_t fontSize, float_t scaleFactor, float_t lineSpacing, ::UnityEngine::FontStyle style,
  ...
  /// @brief Method Populate_Internal_Injected, addr 0x6c167ec, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x6c15850, size 0x4c, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ValidatedSettings, addr 0x6c1593c, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c15608, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c15610, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_characterCount, addr 0x6c158ec, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_characterCount();

  /// @brief Method get_characterCountVisible, addr 0x6c158d8, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_characterCountVisible();

  /// @brief Method get_characterCount_Injected, addr 0x6c164b4, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_characterCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_characters, addr 0x6c16410, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters();

  /// @brief Method get_lineCount, addr 0x6c164f0, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_lineCount();

  /// @brief Method get_lineCount_Injected, addr 0x6c16540, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_lineCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_lines, addr 0x6c16440, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines();

  /// @brief Method get_rectExtents, addr 0x6c15e14, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rectExtents();

  /// @brief Method get_rectExtents_Injected, addr 0x6c16470, size 0x44, virtual false, abstract: false, final false
  static inline void get_rectExtents_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Rect> ret);

  /// @brief Method get_verts, addr 0x6c163e0, size 0x30, virtual false, abstract: false, final false
