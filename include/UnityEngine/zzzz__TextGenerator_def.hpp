...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6a4b12c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finalize, addr 0x6a49ec0, size 0xd0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCharacters, addr 0x6a4a394, size 0x4, virtual false, abstract: false, final false
  inline void GetCharacters(::System::Collections::Generic::List_1<::UnityEngine::UICharInfo>* characters);

  /// @brief Method GetCharactersInternal, addr 0x6a4a398, size 0x58, virtual false, abstract: false, final false
  inline void GetCharactersInternal(::System::Object* characters);

  /// @brief Method GetCharactersInternal_Injected, addr 0x6a4b0a4, size 0x44, virtual false, abstract: false, final false
  static inline void GetCharactersInternal_Injected(::System::IntPtr _unity_self, ::System::Object* characters);

  /// @brief Method GetLines, addr 0x6a4a3f0, size 0x4, virtual false, abstract: false, final false
  inline void GetLines(::System::Collections::Generic::List_1<::UnityEngine::UILineInfo>* lines);

  /// @brief Method GetLinesInternal, addr 0x6a4a3f4, size 0x58, virtual false, abstract: false, final false
  inline void GetLinesInternal(::System::Object* lines);

  /// @brief Method GetLinesInternal_Injected, addr 0x6a4b0e8, size 0x44, virtual false, abstract: false, final false
  static inline void GetLinesInternal_Injected(::System::IntPtr _unity_self, ::System::Object* lines);

  /// @brief Method GetPreferredHeight, addr 0x6a4a5c0, size 0x5c, virtual false, abstract: false, final false
  inline float_t GetPreferredHeight(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetPreferredWidth, addr 0x6a4a4a8, size 0x60, virtual false, abstract: false, final false
  inline float_t GetPreferredWidth(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method GetVertices, addr 0x6a4a44c, size 0x4, virtual false, abstract: false, final false
  inline void GetVertices(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* vertices);

  /// @brief Method GetVerticesInternal, addr 0x6a4a450, size 0x58, virtual false, abstract: false, final false
  inline void GetVerticesInternal(::System::Object* vertices);

  /// @brief Method GetVerticesInternal_Injected, addr 0x6a4b060, size 0x44, virtual false, abstract: false, final false
  static inline void GetVerticesInternal_Injected(::System::IntPtr _unity_self, ::System::Object* vertices);

  /// @brief Method Internal_Create, addr 0x6a49e98, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x6a49fdc, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(::System::IntPtr ptr);

  /// @brief Method Invalidate, addr 0x6a4a38c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate, addr 0x6a4a508, size 0x4c, virtual false, abstract: false, final false
  inline bool Populate(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateAlways, addr 0x6a4a86c, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithError, addr 0x6a4a7e0, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW str, ::UnityEngine::TextGenerationSettings settings);

  /// @brief Method PopulateWithErrors, addr 0x6a4a61c, size 0x1c4, virtual false, abstract: false, final false
  inline bool PopulateWithErrors(::StringW str, ::UnityEngine::TextGenerationSettings settings, ::UnityEngine::GameObject* context);

  /// @brief Method Populate_Internal, addr 0x6a4a974, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Populate_Internal, addr 0x6a4acbc, size 0x270, virtual false, abstract: false, final false
  inline bool Populate_Internal(::StringW str, ::UnityEngine::Font* font, ::UnityEngine::Color color, int32_t fontSize, float_t scaleFactor, float_t lineSpacing, ::UnityEngine::FontStyle style,
  ...
  /// @brief Method Populate_Internal_Injected, addr 0x6a4af2c, size 0x134, virtual false, abstract: false, final false
  static inline bool Populate_Internal_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> str, ::System::IntPtr font, ::ByRef<::UnityEngine::Color> color,
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x6a49f90, size 0x4c, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method ValidatedSettings, addr 0x6a4a07c, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a49d48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6a49d50, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_characterCount, addr 0x6a4a02c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_characterCount();

  /// @brief Method get_characterCountVisible, addr 0x6a4a018, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_characterCountVisible();

  /// @brief Method get_characterCount_Injected, addr 0x6a4abf4, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_characterCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_characters, addr 0x6a4ab50, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters();

  /// @brief Method get_lineCount, addr 0x6a4ac30, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_lineCount();

  /// @brief Method get_lineCount_Injected, addr 0x6a4ac80, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_lineCount_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_lines, addr 0x6a4ab80, size 0x30, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines();

  /// @brief Method get_rectExtents, addr 0x6a4a554, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rectExtents();

  /// @brief Method get_rectExtents_Injected, addr 0x6a4abb0, size 0x44, virtual false, abstract: false, final false
  static inline void get_rectExtents_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Rect> ret);

  /// @brief Method get_verts, addr 0x6a4ab20, size 0x30, virtual false, abstract: false, final false
