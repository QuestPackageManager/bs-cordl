...
public:
  ...
  /// @brief Method get_enabled addr 0x2d1684c size 0x3c virtual false final false
  inline bool get_enabled();

  /// @brief Method set_enabled addr 0x2d16888 size 0x44 virtual false final false
  inline void set_enabled(bool value);

  /// @brief Method get_attachedRigidbody addr 0x2d168cc size 0x3c virtual false final false
  inline ::UnityEngine::Rigidbody* get_attachedRigidbody();

  /// @brief Method get_isTrigger addr 0x2d16908 size 0x3c virtual false final false
  inline bool get_isTrigger();

  /// @brief Method set_isTrigger addr 0x2d16944 size 0x44 virtual false final false
  inline void set_isTrigger(bool value);

  /// @brief Method get_bounds addr 0x2d16988 size 0x68 virtual false final false
  inline ::UnityEngine::Bounds get_bounds();

  /// @brief Method Raycast addr 0x2d16a34 size 0x94 virtual false final false
  inline ::UnityEngine::RaycastHit Raycast(::UnityEngine::Ray ray, float_t maxDistance, ByRef<bool> hasHit);

  /// @brief Method Raycast addr 0x2d16b34 size 0xac virtual false final false
  inline bool Raycast(::UnityEngine::Ray ray, ByRef<::UnityEngine::RaycastHit> hitInfo, float_t maxDistance);

  /// @brief Method Internal_ClosestPointOnBounds addr 0x2d16be0 size 0x6c virtual false final false
  ...
  /// @brief Method ClosestPointOnBounds addr 0x2d16ca8 size 0xa4 virtual false final false
  inline ::UnityEngine::Vector3 ClosestPointOnBounds(::UnityEngine::Vector3 position);

  static inline ::UnityEngine::Collider* New_ctor();

  /// @brief Method .ctor addr 0x2d16844 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method get_bounds_Injected addr 0x2d169f0 size 0x44 virtual false final false
  inline void get_bounds_Injected(ByRef<::UnityEngine::Bounds> ret);

  /// @brief Method Raycast_Injected addr 0x2d16ac8 size 0x6c virtual false final false
  ...
  /// @brief Method Internal_ClosestPointOnBounds_Injected addr 0x2d16c4c size 0x5c virtual false final false
