...
DEFINE_IL2CPP_CLASS(::UnityEngine::VRTextureUsage, "UnityEngine", "VRTextureUsage");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::VRTextureUsage) == 0x4, "Size mismatch!");
