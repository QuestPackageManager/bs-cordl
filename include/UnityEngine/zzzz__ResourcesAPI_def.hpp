...
public:
  ...
  /// @brief Method FindObjectsOfTypeAll, addr 0x6ad94b0, size 0x3c, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Object>> FindObjectsOfTypeAll(::System::Type* systemTypeInstance);

  /// @brief Method FindShaderByName, addr 0x6ad94ec, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> FindShaderByName(::StringW name);

  /// @brief Method Load, addr 0x6ad94f4, size 0xc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> Load(::StringW path, ::System::Type* systemTypeInstance);

  /// @brief Method LoadAll, addr 0x6ad9500, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ad94ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveAPI, addr 0x6ad939c, size 0xb4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ResourcesAPI* get_ActiveAPI();

  /// [CompilerGenerated]
  /// @brief Method get_overrideAPI, addr 0x6ad9450, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  ResourcesAPI(ResourcesAPIconst&) = delete;
