...
public:
  ...
  static inline bool CompareValue(::by_ref<TValue> firstValue, ::by_ref<TValue> secondValue);
  ...
  /// @brief Method ProcessValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void ProcessValue(::by_ref<TValue> value);
  ...
  inline ::ArrayW<::UnityEngine::InputSystem::InputProcessor_1<TValue>*> get_processors();

  /// @brief Method get_unprocessedValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline ::by_ref<TValue> get_unprocessedValue();

  /// @brief Method get_value, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline ::by_ref<TValue> get_value();
