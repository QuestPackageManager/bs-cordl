...
/// @brief Field m_ProcessorStack, offset 0xe0, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_ProcessorStack, put=__cordl_internal_set_m_ProcessorStack)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputProcessor_1<TValue>*>  m_ProcessorStack;
