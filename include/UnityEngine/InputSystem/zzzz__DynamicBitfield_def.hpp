...
public:
  // Declarations
  /// @brief Method AnyBitIsSet, addr 0x63d04f4, size 0x8c, virtual false, abstract: false, final false
  inline bool AnyBitIsSet();

  /// @brief Method BitCountToULongCount, addr 0x63d03c8, size 0x18, virtual false, abstract: false, final false
  static inline int32_t BitCountToULongCount(int32_t bitCount);

  /// @brief Method ClearBit, addr 0x63bfe60, size 0xa0, virtual false, abstract: false, final false
  inline void ClearBit(int32_t bitIndex);

  /// @brief Method SetBit, addr 0x63d03e0, size 0xa0, virtual false, abstract: false, final false
  inline void SetBit(int32_t bitIndex);

  /// @brief Method SetLength, addr 0x63bfd2c, size 0x80, virtual false, abstract: false, final false
  inline void SetLength(int32_t newLength);

  /// @brief Method TestBit, addr 0x63d0480, size 0x74, virtual false, abstract: false, final false
