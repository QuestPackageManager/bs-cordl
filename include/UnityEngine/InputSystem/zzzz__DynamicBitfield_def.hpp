...
public:
  // Declarations
  /// @brief Method BitCountToULongCount, addr 0x2ff8a60, size 0x18, virtual false, abstract: false, final false
  static inline int32_t BitCountToULongCount(int32_t bitCount);

  /// @brief Method ClearBit, addr 0x2fea864, size 0x98, virtual false, abstract: false, final false
  inline void ClearBit(int32_t bitIndex);

  /// @brief Method SetBit, addr 0x2ff8a78, size 0x98, virtual false, abstract: false, final false
  inline void SetBit(int32_t bitIndex);

  /// @brief Method SetLength, addr 0x2fea73c, size 0x74, virtual false, abstract: false, final false
  inline void SetLength(int32_t newLength);

  /// @brief Method TestBit, addr 0x2ff8b10, size 0x78, virtual false, abstract: false, final false
