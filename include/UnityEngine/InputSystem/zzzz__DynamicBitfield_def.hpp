...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::DynamicBitfield, "UnityEngine.InputSystem", "DynamicBitfield");
...
static_assert(sizeof(::UnityEngine::InputSystem::DynamicBitfield) == 0x20, "Size mismatch!");
