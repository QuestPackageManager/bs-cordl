...
public:
  // Declarations
  /// @brief Method AnyBitIsSet, addr 0x6442bc0, size 0x8c, virtual false, abstract: false, final false
  inline bool AnyBitIsSet();

  /// @brief Method BitCountToULongCount, addr 0x6442a94, size 0x18, virtual false, abstract: false, final false
  static inline int32_t BitCountToULongCount(int32_t bitCount);

  /// @brief Method ClearBit, addr 0x643252c, size 0xa0, virtual false, abstract: false, final false
  inline void ClearBit(int32_t bitIndex);

  /// @brief Method SetBit, addr 0x6442aac, size 0xa0, virtual false, abstract: false, final false
  inline void SetBit(int32_t bitIndex);

  /// @brief Method SetLength, addr 0x64323f8, size 0x80, virtual false, abstract: false, final false
  inline void SetLength(int32_t newLength);

  /// @brief Method TestBit, addr 0x6442b4c, size 0x74, virtual false, abstract: false, final false
