...
namespace UnityEngine::InputSystem {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6755)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6755), inst: 402 })}
...
public:
  // Declarations
  /// @brief Method SetLength addr 0x29380d0 size 0x74 virtual false final false
  inline void SetLength(int32_t newLength);

  /// @brief Method SetBit addr 0x294640c size 0x98 virtual false final false
  inline void SetBit(int32_t bitIndex);

  /// @brief Method TestBit addr 0x29464a4 size 0x78 virtual false final false
  inline bool TestBit(int32_t bitIndex);

  /// @brief Method ClearBit addr 0x29381f8 size 0x98 virtual false final false
  inline void ClearBit(int32_t bitIndex);

  /// @brief Method BitCountToULongCount addr 0x29463f4 size 0x18 virtual false final false
