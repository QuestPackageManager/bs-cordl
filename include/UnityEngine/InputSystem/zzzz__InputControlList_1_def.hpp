...
template <typename TControl>
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9927), inst: 402 }), TypeDefinitionIndex(TypeDefinitionIndex(9927)),
// TypeDefinitionIndex(TypeDefinitionIndex(9931))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6312)) CS Name: ::UnityEngine.InputSystem::InputControlList`1<TControl>
