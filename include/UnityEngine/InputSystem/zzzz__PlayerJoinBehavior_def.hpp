...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::PlayerJoinBehavior, "UnityEngine.InputSystem", "PlayerJoinBehavior");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::PlayerJoinBehavior) == 0x4, "Size mismatch!");
