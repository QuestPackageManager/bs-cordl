...
public:
  ...
  /// @brief Method get_magneticField, addr 0x2aaa12c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_magneticField();

  /// @brief Method set_magneticField, addr 0x2aaa134, size 0x8, virtual false, abstract: false, final false
  inline void set_magneticField(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method get_current, addr 0x2aaa13c, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::MagneticFieldSensor* get_current();

  /// @brief Method set_current, addr 0x2aaa184, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::MagneticFieldSensor* value);

  /// @brief Method MakeCurrent, addr 0x2aaa1d0, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  /// @brief Method OnRemoved, addr 0x2aaa224, size 0x84, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method FinishSetup, addr 0x2aaa2a8, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::MagneticFieldSensor* New_ctor();

  /// @brief Method .ctor, addr 0x2aaa320, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
