...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10387)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10387), inst: 421 }),
// TypeDefinitionIndex(TypeDefinitionIndex(6219))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6397)) CS Name: ::PlayerInput::ActionEvent*
...
public:
  ...
  /// @brief Method get_actionId addr 0x2944040 size 0x8 virtual false final false
  inline ::StringW get_actionId();

  /// @brief Method get_actionName addr 0x2944048 size 0x8 virtual false final false
  inline ::StringW get_actionName();

  static inline ::UnityEngine::InputSystem::__PlayerInput__ActionEvent* New_ctor();

  /// @brief Method .ctor addr 0x2944050 size 0x48 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::__PlayerInput__ActionEvent* New_ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor addr 0x2944098 size 0x1dc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2944274 size 0x74 virtual false final false
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2323)), TypeDefinitionIndex(TypeDefinitionIndex(6219)), TypeDefinitionIndex(TypeDefinitionIndex(6746)),
// TypeDefinitionIndex(TypeDefinitionIndex(6406)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6746), inst: 974 }), TypeDefinitionIndex(TypeDefinitionIndex(6450)),
// TypeDefinitionIndex(TypeDefinitionIndex(10152)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6746), inst: 975 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2323), inst: 421 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2323), inst: 374 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(6401)) CS Name:
...
public:
  ...
  /// @brief Method get_inputIsActive addr 0x293d3d0 size 0x8 virtual false final false
  inline bool get_inputIsActive();

  /// @brief Method get_active addr 0x293d3d8 size 0x8 virtual false final false
  inline bool get_active();

  /// @brief Method get_playerIndex addr 0x293d3e0 size 0x8 virtual false final false
  inline int32_t get_playerIndex();

  /// @brief Method get_splitScreenIndex addr 0x293d3e8 size 0x8 virtual false final false
  inline int32_t get_splitScreenIndex();

  /// @brief Method get_actions addr 0x293d3f0 size 0x44 virtual false final false
  inline ::UnityEngine::InputSystem::InputActionAsset* get_actions();

  /// @brief Method set_actions addr 0x293d940 size 0xf8 virtual false final false
  inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method get_currentControlScheme addr 0x293e450 size 0x80 virtual false final false
  inline ::StringW get_currentControlScheme();

  /// @brief Method get_defaultControlScheme addr 0x293e600 size 0x8 virtual false final false
  inline ::StringW get_defaultControlScheme();

  /// @brief Method set_defaultControlScheme addr 0x293e608 size 0x8 virtual false final false
  inline void set_defaultControlScheme(::StringW value);

  /// @brief Method get_neverAutoSwitchControlSchemes addr 0x293e610 size 0x8 virtual false final false
  inline bool get_neverAutoSwitchControlSchemes();

  /// @brief Method set_neverAutoSwitchControlSchemes addr 0x293e618 size 0x38 virtual false final false
  inline void set_neverAutoSwitchControlSchemes(bool value);

  /// @brief Method get_currentActionMap addr 0x293e7f8 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::InputActionMap* get_currentActionMap();

  /// @brief Method set_currentActionMap addr 0x293e800 size 0x4c virtual false final false
  inline void set_currentActionMap(::UnityEngine::InputSystem::InputActionMap* value);

  /// @brief Method get_defaultActionMap addr 0x293e84c size 0x8 virtual false final false
  inline ::StringW get_defaultActionMap();

  /// @brief Method set_defaultActionMap addr 0x293e854 size 0x8 virtual false final false
  inline void set_defaultActionMap(::StringW value);

  /// @brief Method get_notificationBehavior addr 0x293e85c size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior();

  /// @brief Method set_notificationBehavior addr 0x293e864 size 0x58 virtual false final false
  inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications value);

  /// @brief Method get_actionEvents addr 0x293e8bc size 0x48 virtual false final false
  ...
  /// @brief Method set_actionEvents addr 0x293e904 size 0x7c virtual false final false
  ...
  /// @brief Method get_deviceLostEvent addr 0x293e980 size 0x68 virtual false final false
  inline ::UnityEngine::InputSystem::__PlayerInput__DeviceLostEvent* get_deviceLostEvent();

  /// @brief Method get_deviceRegainedEvent addr 0x293ea30 size 0x68 virtual false final false
  inline ::UnityEngine::InputSystem::__PlayerInput__DeviceRegainedEvent* get_deviceRegainedEvent();

  /// @brief Method get_controlsChangedEvent addr 0x293eae0 size 0x68 virtual false final false
  inline ::UnityEngine::InputSystem::__PlayerInput__ControlsChangedEvent* get_controlsChangedEvent();

  /// @brief Method add_onActionTriggered addr 0x293eb90 size 0xa0 virtual false final false
  inline void add_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_onActionTriggered addr 0x293ec30 size 0xa0 virtual false final false
  inline void remove_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_onDeviceLost addr 0x293ecd0 size 0xa0 virtual false final false
  inline void add_onDeviceLost(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method remove_onDeviceLost addr 0x293ed70 size 0xa0 virtual false final false
  inline void remove_onDeviceLost(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method add_onDeviceRegained addr 0x293ee10 size 0xa0 virtual false final false
  inline void add_onDeviceRegained(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method remove_onDeviceRegained addr 0x293eeb0 size 0xa0 virtual false final false
  inline void remove_onDeviceRegained(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method add_onControlsChanged addr 0x293ef50 size 0xa0 virtual false final false
  inline void add_onControlsChanged(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method remove_onControlsChanged addr 0x293eff0 size 0xa0 virtual false final false
  inline void remove_onControlsChanged(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method get_camera addr 0x293f090 size 0x8 virtual false final false
  inline ::UnityEngine::Camera* get_camera();

  /// @brief Method set_camera addr 0x293f098 size 0x8 virtual false final false
  inline void set_camera(::UnityEngine::Camera* value);

  /// @brief Method get_uiInputModule addr 0x293f0a0 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::UI::InputSystemUIInputModule* get_uiInputModule();

  /// @brief Method set_uiInputModule addr 0x293f0a8 size 0x158 virtual false final false
  inline void set_uiInputModule(::UnityEngine::InputSystem::UI::InputSystemUIInputModule* value);

  /// @brief Method get_user addr 0x293f200 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Users::InputUser get_user();

  /// @brief Method get_devices addr 0x293f208 size 0x30 virtual false final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_hasMissingRequiredDevices addr 0x293f2e4 size 0x48 virtual false final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_all addr 0x293f3a8 size 0x90 virtual false final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::PlayerInput*> get_all();

  /// @brief Method get_isSinglePlayer addr 0x293f438 size 0x118 virtual false final false
  ...
  /// @brief Method ActivateInput addr 0x293e39c size 0xb4 virtual false final false
  inline void ActivateInput();

  /// @brief Method DeactivateInput addr 0x293f6bc size 0x24 virtual false final false
  inline void DeactivateInput();

  /// @brief Method PassivateInput addr 0x293f6e0 size 0x24 virtual false final false
  inline void PassivateInput();

  /// @brief Method SwitchCurrentControlScheme addr 0x293f704 size 0x1d8 virtual false final false
  ...
  /// @brief Method SwitchCurrentControlScheme addr 0x293fcd0 size 0xe0 virtual false final false
  ...
  /// @brief Method SwitchCurrentActionMap addr 0x293f550 size 0x16c virtual false final false
  inline void SwitchCurrentActionMap(::StringW mapNameOrId);

  /// @brief Method GetPlayerByIndex addr 0x293fe6c size 0xfc virtual false final false
  static inline ::UnityEngine::InputSystem::PlayerInput* GetPlayerByIndex(int32_t playerIndex);

  /// @brief Method FindFirstPairedToDevice addr 0x293ff68 size 0x16c virtual false final false
  static inline ::UnityEngine::InputSystem::PlayerInput* FindFirstPairedToDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Instantiate addr 0x29400d4 size 0x15c virtual false final false
  ...
  /// @brief Method Instantiate addr 0x2940570 size 0x194 virtual false final false
  static inline ::UnityEngine::InputSystem::PlayerInput* Instantiate(::UnityEngine::GameObject* prefab, int32_t playerIndex, ::StringW controlScheme, int32_t splitScreenIndex,
                                                                     ::ArrayW<::UnityEngine::InputSystem::InputDevice*, ::Array<::UnityEngine::InputSystem::InputDevice*>*> pairWithDevices);

  /// @brief Method DoInstantiate addr 0x2940230 size 0x340 virtual false final false
  static inline ::UnityEngine::InputSystem::PlayerInput* DoInstantiate(::UnityEngine::GameObject* prefab);

  /// @brief Method InitializeActions addr 0x293d434 size 0x50c virtual false final false
  inline void InitializeActions();

  /// @brief Method UninitializeActions addr 0x293da38 size 0x1d4 virtual false final false
  inline void UninitializeActions();

  /// @brief Method InstallOnActionTriggeredHook addr 0x2940704 size 0x1d8 virtual false final false
  inline void InstallOnActionTriggeredHook();

  /// @brief Method UninstallOnActionTriggeredHook addr 0x2940ca8 size 0x18c virtual false final false
  inline void UninstallOnActionTriggeredHook();

  /// @brief Method OnActionTriggered addr 0x2940e34 size 0x1f4 virtual false final false
  inline void OnActionTriggered(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method CacheMessageNames addr 0x29408dc size 0x3cc virtual false final false
  inline void CacheMessageNames();

  /// @brief Method ClearCaches addr 0x293dc0c size 0x4 virtual false final false
  inline void ClearCaches();

  /// @brief Method AssignUserAndDevices addr 0x293dc10 size 0x78c virtual false final false
  inline void AssignUserAndDevices();

  /// @brief Method HaveBindingForDevice addr 0x29416b8 size 0x108 virtual false final false
  inline bool HaveBindingForDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method UnassignUserAndDevices addr 0x2941af8 size 0xb8 virtual false final false
  inline void UnassignUserAndDevices();

  /// @brief Method TryToActivateControlScheme addr 0x2941464 size 0x1e0 virtual false final false
  inline bool TryToActivateControlScheme(::UnityEngine::InputSystem::InputControlScheme controlScheme);

  /// @brief Method AssignPlayerIndex addr 0x2941e8c size 0x208 virtual false final false
  inline void AssignPlayerIndex();

  /// @brief Method OnEnable addr 0x2942094 size 0x4c8 virtual false final false
  inline void OnEnable();

  /// @brief Method StartListeningForUnpairedDeviceActivity addr 0x293e650 size 0x138 virtual false final false
  inline void StartListeningForUnpairedDeviceActivity();

  /// @brief Method StopListeningForUnpairedDeviceActivity addr 0x293e788 size 0x70 virtual false final false
  inline void StopListeningForUnpairedDeviceActivity();

  /// @brief Method StartListeningForDeviceChanges addr 0x2942614 size 0xc4 virtual false final false
  inline void StartListeningForDeviceChanges();

  /// @brief Method StopListeningForDeviceChanges addr 0x2942d94 size 0x6c virtual false final false
  inline void StopListeningForDeviceChanges();

  /// @brief Method OnDisable addr 0x2942e00 size 0x2f4 virtual false final false
  inline void OnDisable();

  /// @brief Method DebugLogAction addr 0x29432d4 size 0x78 virtual false final false
  inline void DebugLogAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method HandleDeviceLost addr 0x294334c size 0x11c virtual false final false
  inline void HandleDeviceLost();

  /// @brief Method HandleDeviceRegained addr 0x2943468 size 0x11c virtual false final false
  inline void HandleDeviceRegained();

  /// @brief Method HandleControlsChanged addr 0x29426d8 size 0x11c virtual false final false
  inline void HandleControlsChanged();

  /// @brief Method OnUserChange addr 0x2943584 size 0x168 virtual false final false
  ...
  /// @brief Method OnPreFilterUnpairedDeviceUsed addr 0x29436f8 size 0xf4 virtual false final false
  ...
  /// @brief Method OnUnpairedDeviceUsed addr 0x29437ec size 0x610 virtual false final false
  ...
  /// @brief Method OnDeviceChange addr 0x2943dfc size 0x108 virtual false final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method SwitchControlSchemeInternal addr 0x293f8dc size 0x3f4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2943fe0 size 0x14 virtual false final false
  inline void _ctor();
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10387)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10387), inst: 374 }),
// TypeDefinitionIndex(TypeDefinitionIndex(6401))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6398)) CS Name: ::PlayerInput::DeviceLostEvent*
...
public:
  ...
  /// @brief Method .ctor addr 0x293e9e8 size 0x48 virtual false final false
  inline void _ctor();
...
// TypeDefinitionIndex(TypeDefinitionIndex(10387))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6399)) CS Name: ::PlayerInput::DeviceRegainedEvent*
...
public:
  ...
  /// @brief Method .ctor addr 0x293ea98 size 0x48 virtual false final false
  inline void _ctor();
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6401)), TypeDefinitionIndex(TypeDefinitionIndex(10387)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10387), inst:
// 374 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(6400)) CS Name: ::PlayerInput::ControlsChangedEvent*
...
public:
  ...
  /// @brief Method .ctor addr 0x293eb48 size 0x48 virtual false final false
  inline void _ctor();
