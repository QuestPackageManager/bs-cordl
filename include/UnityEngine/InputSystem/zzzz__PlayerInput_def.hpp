...
public:
  ...
  /// @brief Method .ctor, addr 0x6440760, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x64407ac, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor, addr 0x6440978, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Guid actionGUID, ::StringW name);

  /// @brief Method get_actionId, addr 0x6440750, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_actionId();

  /// @brief Method get_actionName, addr 0x6440758, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x643a644, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x643a6f4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x643a7a4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActivateInput, addr 0x6439f4c, size 0xbc, virtual false, abstract: false, final false
  inline void ActivateInput();

  /// @brief Method AssignPlayerIndex, addr 0x643e294, size 0x1f4, virtual false, abstract: false, final false
  inline void AssignPlayerIndex();

  /// @brief Method AssignUserAndDevices, addr 0x6439544, size 0xa08, virtual false, abstract: false, final false
  inline void AssignUserAndDevices();

  /// @brief Method CacheMessageNames, addr 0x643b82c, size 0x3e8, virtual false, abstract: false, final false
  inline void CacheMessageNames();

  /// @brief Method ClearCaches, addr 0x64394e8, size 0x5c, virtual false, abstract: false, final false
  inline void ClearCaches();

  /// @brief Method DeactivateInput, addr 0x643bc14, size 0x24, virtual false, abstract: false, final false
  inline void DeactivateInput();

  /// @brief Method DebugLogAction, addr 0x643f7d4, size 0x7c, virtual false, abstract: false, final false
  inline void DebugLogAction(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method DoInstantiate, addr 0x643c93c, size 0x300, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> DoInstantiate(::UnityEngine::GameObject* prefab);

  /// @brief Method FindFirstPairedToDevice, addr 0x643c668, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerByIndex, addr 0x643c568, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> GetPlayerByIndex(int32_t playerIndex);

  /// @brief Method HandleControlsChanged, addr 0x643eab4, size 0x134, virtual false, abstract: false, final false
  inline void HandleControlsChanged();

  /// @brief Method HandleDeviceLost, addr 0x643f850, size 0x134, virtual false, abstract: false, final false
  inline void HandleDeviceLost();

  /// @brief Method HandleDeviceRegained, addr 0x643f984, size 0x134, virtual false, abstract: false, final false
  inline void HandleDeviceRegained();

  /// @brief Method HaveBindingForDevice, addr 0x643d948, size 0x110, virtual false, abstract: false, final false
  inline bool HaveBindingForDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InitializeActions, addr 0x6438bd4, size 0x5a4, virtual false, abstract: false, final false
  inline void InitializeActions();

  /// @brief Method InstallOnActionTriggeredHook, addr 0x643b644, size 0x1e8, virtual false, abstract: false, final false
  inline void InstallOnActionTriggeredHook();

  /// @brief Method Instantiate, addr 0x643c7d8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Instantiate, addr 0x643cc3c, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::PlayerInput> Instantiate(::UnityEngine::GameObject* prefab, int32_t playerIndex, ::StringW controlScheme, int32_t splitScreenIndex,
  ...
  /// @brief Method OnActionTriggered, addr 0x643cf3c, size 0x20c, virtual false, abstract: false, final false
  inline void OnActionTriggered(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnDeviceChange, addr 0x6440488, size 0x154, virtual false, abstract: false, final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method OnDisable, addr 0x643f2c8, size 0x2e8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x643e488, size 0x498, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPreFilterUnpairedDeviceUsed, addr 0x643fc84, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUnpairedDeviceUsed, addr 0x643fe14, size 0x674, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUserChange, addr 0x643fab8, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method PassivateInput, addr 0x643bc38, size 0x24, virtual false, abstract: false, final false
  inline void PassivateInput();

  /// @brief Method StartListeningForDeviceChanges, addr 0x643e9ec, size 0xc8, virtual false, abstract: false, final false
  inline void StartListeningForDeviceChanges();

  /// @brief Method StartListeningForUnpairedDeviceActivity, addr 0x643a290, size 0x134, virtual false, abstract: false, final false
  inline void StartListeningForUnpairedDeviceActivity();

  /// @brief Method StopListeningForDeviceChanges, addr 0x643f258, size 0x70, virtual false, abstract: false, final false
  inline void StopListeningForDeviceChanges();

  /// @brief Method StopListeningForUnpairedDeviceActivity, addr 0x643a3c4, size 0x80, virtual false, abstract: false, final false
  inline void StopListeningForUnpairedDeviceActivity();

  /// @brief Method SwitchControlSchemeInternal, addr 0x643be20, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchCurrentActionMap, addr 0x643b484, size 0x1c0, virtual false, abstract: false, final false
  inline void SwitchCurrentActionMap(::StringW mapNameOrId);

  /// @brief Method SwitchCurrentControlScheme, addr 0x643bc5c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchCurrentControlScheme, addr 0x643c33c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method TryToActivateControlScheme, addr 0x643d65c, size 0x258, virtual false, abstract: false, final false
  inline bool TryToActivateControlScheme(::UnityEngine::InputSystem::InputControlScheme controlScheme);

  /// @brief Method UnassignUserAndDevices, addr 0x643ddf4, size 0xe0, virtual false, abstract: false, final false
  inline void UnassignUserAndDevices();

  /// @brief Method UninitializeActions, addr 0x643927c, size 0x26c, virtual false, abstract: false, final false
  inline void UninitializeActions();

  /// @brief Method UninstallOnActionTriggeredHook, addr 0x643cddc, size 0x160, virtual false, abstract: false, final false
  inline void UninstallOnActionTriggeredHook();

  /// @brief Method UpdateDelegates, addr 0x643b2b0, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64406f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onActionTriggered, addr 0x643a7f0, size 0xa8, virtual false, abstract: false, final false
  inline void add_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::InputAction_CallbackContext>* value);

  /// @brief Method add_onControlsChanged, addr 0x643abe0, size 0xa8, virtual false, abstract: false, final false
  inline void add_onControlsChanged(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method add_onDeviceLost, addr 0x643a940, size 0xa8, virtual false, abstract: false, final false
  inline void add_onDeviceLost(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method add_onDeviceRegained, addr 0x643aa90, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actionEvents, addr 0x643a508, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x6438b90, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_actions();

  /// @brief Method get_active, addr 0x6438b78, size 0x8, virtual false, abstract: false, final false
  inline bool get_active();

  /// @brief Method get_all, addr 0x643b10c, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>> get_all();

  /// @brief Method get_camera, addr 0x643ad30, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_camera();

  /// @brief Method get_controlsChangedEvent, addr 0x643a740, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerInput_ControlsChangedEvent* get_controlsChangedEvent();

  /// @brief Method get_currentActionMap, addr 0x643a444, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* get_currentActionMap();

  /// @brief Method get_currentControlScheme, addr 0x643a008, size 0xc4, virtual false, abstract: false, final false
  inline ::StringW get_currentControlScheme();

  /// @brief Method get_defaultActionMap, addr 0x643a498, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_defaultActionMap();

  /// @brief Method get_defaultControlScheme, addr 0x643a240, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_defaultControlScheme();

  /// @brief Method get_deviceLostEvent, addr 0x643a5e0, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerInput_DeviceLostEvent* get_deviceLostEvent();

  /// @brief Method get_deviceRegainedEvent, addr 0x643a690, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerInput_DeviceRegainedEvent* get_deviceRegainedEvent();

  /// @brief Method get_devices, addr 0x643aeac, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_hasMissingRequiredDevices, addr 0x643afdc, size 0x9c, virtual false, abstract: false, final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_inputIsActive, addr 0x6438b70, size 0x8, virtual false, abstract: false, final false
  inline bool get_inputIsActive();

  /// @brief Method get_isSinglePlayer, addr 0x643b184, size 0x12c, virtual false, abstract: false, final false
  static inline bool get_isSinglePlayer();

  /// @brief Method get_neverAutoSwitchControlSchemes, addr 0x643a250, size 0x8, virtual false, abstract: false, final false
  inline bool get_neverAutoSwitchControlSchemes();

  /// @brief Method get_notificationBehavior, addr 0x643a4a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior();

  /// @brief Method get_playerIndex, addr 0x6438b80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_playerIndex();

  /// @brief Method get_splitScreenIndex, addr 0x6438b88, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_splitScreenIndex();

  /// @brief Method get_uiInputModule, addr 0x643ad40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::UI::InputSystemUIInputModule> get_uiInputModule();

  /// @brief Method get_user, addr 0x643aea4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Users::InputUser get_user();

  /// @brief Method remove_onActionTriggered, addr 0x643a898, size 0xa8, virtual false, abstract: false, final false
  inline void remove_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::InputAction_CallbackContext>* value);

  /// @brief Method remove_onControlsChanged, addr 0x643ac88, size 0xa8, virtual false, abstract: false, final false
  inline void remove_onControlsChanged(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method remove_onDeviceLost, addr 0x643a9e8, size 0xa8, virtual false, abstract: false, final false
  inline void remove_onDeviceLost(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>* value);

  /// @brief Method remove_onDeviceRegained, addr 0x643ab38, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actionEvents, addr 0x643a554, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actions, addr 0x6439178, size 0x104, virtual false, abstract: false, final false
  inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method set_camera, addr 0x643ad38, size 0x8, virtual false, abstract: false, final false
  inline void set_camera(::UnityEngine::Camera* value);

  /// @brief Method set_currentActionMap, addr 0x643a44c, size 0x4c, virtual false, abstract: false, final false
  inline void set_currentActionMap(::UnityEngine::InputSystem::InputActionMap* value);

  /// @brief Method set_defaultActionMap, addr 0x643a4a0, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultActionMap(::StringW value);

  /// @brief Method set_defaultControlScheme, addr 0x643a248, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultControlScheme(::StringW value);

  /// @brief Method set_neverAutoSwitchControlSchemes, addr 0x643a258, size 0x38, virtual false, abstract: false, final false
  inline void set_neverAutoSwitchControlSchemes(bool value);

  /// @brief Method set_notificationBehavior, addr 0x643a4b0, size 0x58, virtual false, abstract: false, final false
  inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications value);

  /// @brief Method set_uiInputModule, addr 0x643ad48, size 0x15c, virtual false, abstract: false, final false
