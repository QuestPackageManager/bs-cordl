...
public:
  ...
  /// @brief Method .ctor, addr 0x638d6bc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::Android::AndroidGamepadWithDpadButtons, 0x208>, "Size mismatch!");
