...
public:
  // Declarations
  /// @brief Method Initialize addr 0x2965ce0 size 0x8f4 virtual false final false
  static inline void Initialize();

  /// @brief Method OnFindLayoutForDevice addr 0x29665d4 size 0x254 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29668e8 size 0x8 virtual false final false
  inline void _ctor();
