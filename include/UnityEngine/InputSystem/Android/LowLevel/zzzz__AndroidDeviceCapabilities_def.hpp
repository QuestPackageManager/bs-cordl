...
public:
  ...
  /// @brief Method <ToString>b__8_0, addr 0x6468d30, size 0x68, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__8_0(::UnityEngine::InputSystem::Android::LowLevel::AndroidAxis i);

  /// @brief Method .ctor, addr 0x6468d2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FromJson, addr 0x6468720, size 0xc4, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities FromJson(::StringW json);

  /// @brief Method ToJson, addr 0x64688fc, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToString, addr 0x6468968, size 0x370, virtual true, abstract: false, final false
