...
public:
  ...
  /// @brief Method <ToString>b__8_0, addr 0x3179d38, size 0x64, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__8_0(::UnityEngine::InputSystem::Android::LowLevel::AndroidAxis i);

  /// @brief Method .ctor, addr 0x3179d30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FromJson, addr 0x31796fc, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities FromJson(::StringW json);

  /// @brief Method ToJson, addr 0x31798f0, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToString, addr 0x317995c, size 0x370, virtual true, abstract: false, final false
