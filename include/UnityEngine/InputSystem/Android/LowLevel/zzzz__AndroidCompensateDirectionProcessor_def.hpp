...
namespace UnityEngine::InputSystem::Android::LowLevel {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5841))]
...
public:
  // Declarations
  /// @brief Method Process, addr 0x2ae8aac, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae8ac8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
