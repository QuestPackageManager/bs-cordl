...
public:
  ...
  /// @brief Method WithData, addr 0x6468f2c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x6468fec, size 0x5c, virtual true, abstract: false, final true
