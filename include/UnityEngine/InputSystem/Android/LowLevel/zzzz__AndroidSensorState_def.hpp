...
public:
  ...
  /// @brief Method WithData, addr 0x2c2e224, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x2c2e2f4, size 0x58, virtual true, abstract: false, final true
