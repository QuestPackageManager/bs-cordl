...
public:
  ...
  /// @brief Method WithData, addr 0x4608a2c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x4608b48, size 0x58, virtual true, abstract: false, final true
