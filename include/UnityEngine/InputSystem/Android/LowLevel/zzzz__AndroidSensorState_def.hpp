...
public:
  ...
  /// @brief Method WithData, addr 0x3179f38, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x317a008, size 0x58, virtual true, abstract: false, final true
