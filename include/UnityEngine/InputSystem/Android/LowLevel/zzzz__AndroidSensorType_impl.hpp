...
constexpr ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorType::AndroidSensorType(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorType::AndroidSensorType() {}
...
constexpr ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorType UnityEngine::InputSystem::Android::LowLevel::AndroidSensorType::HingeAngle{ static_cast<int32_t>(0x24) };
