...
namespace UnityEngine::InputSystem::Android::LowLevel {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5842))]
...
public:
  // Declarations
  /// @brief Method Process, addr 0x2ae8ad0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae8b04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
