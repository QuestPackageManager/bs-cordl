...
namespace UnityEngine::InputSystem::Android::LowLevel {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5713))]
...
public:
  // Declarations
  /// @brief Method ToJson, addr 0x2ae877c, size 0x64, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method FromJson, addr 0x2ae87e0, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities FromJson(::StringW json);

  /// @brief Method ToString, addr 0x2ae8880, size 0x98, virtual true, abstract: false, final false
