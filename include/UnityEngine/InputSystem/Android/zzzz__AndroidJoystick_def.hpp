...
public:
  ...
  /// @brief Method .ctor, addr 0x65aba90, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::AndroidJoystick) == 0x1a8, "Size mismatch!");
