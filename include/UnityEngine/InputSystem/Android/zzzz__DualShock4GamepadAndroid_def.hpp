...
public:
  ...
  /// @brief Method .ctor, addr 0x65abab0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Android::DualShock4GamepadAndroid) == 0x280, "Size mismatch!");
