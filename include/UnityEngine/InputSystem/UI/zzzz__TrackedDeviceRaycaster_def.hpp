...
/// @brief Method .ctor, addr 0x63e50bc, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_distance, addr 0x63e51fc, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_graphic, addr 0x63e51e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic() ;

/// @brief Method get_screenPosition, addr 0x63e51f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_worldHitPosition, addr 0x63e51e8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method <SortedRaycastGraphics>b__25_0, addr 0x63e525c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63e5258, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_RaycastResultsCache, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RaycastResultsCache, put=__cordl_internal_set_m_RaycastResultsCache)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster_RaycastHitData>*  m_RaycastResultsCache;
...
/// @brief Field s_Instances, offset 0xffffffff, size 0x18 
 __declspec(property(get=getStaticF_s_Instances, put=setStaticF_s_Instances)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityW<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster>>  s_Instances;

/// @brief Field s_SortedGraphics, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SortedGraphics, put=setStaticF_s_SortedGraphics)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster_RaycastHitData>*  s_SortedGraphics;

static inline ::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster* New_ctor() ;

/// @brief Method OnDisable, addr 0x63e4618, size 0xf8, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x63e458c, size 0x8c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PerformRaycast, addr 0x63dd610, size 0x614, virtual false, abstract: false, final false
...
/// @brief Method RayIntersectsRectTransform, addr 0x63e4cc0, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x63e4710, size 0xac, virtual true, abstract: false, final false
inline void Raycast(::UnityEngine::EventSystems::PointerEventData*  eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  resultAppendList) ;

/// @brief Method SortedRaycastGraphics, addr 0x63e47bc, size 0x504, virtual false, abstract: false, final false
inline void SortedRaycastGraphics(::UnityEngine::Canvas*  canvas, ::UnityEngine::Ray  ray, ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster_RaycastHitData>*  results) ;
...
/// @brief Method .ctor, addr 0x63e50d0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_blockingMask, addr 0x63e453c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method get_canvas, addr 0x63e44a0, size 0x9c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_checkFor2DOcclusion, addr 0x63e455c, size 0x8, virtual false, abstract: false, final false
inline bool get_checkFor2DOcclusion() ;

/// @brief Method get_checkFor3DOcclusion, addr 0x63e454c, size 0x8, virtual false, abstract: false, final false
inline bool get_checkFor3DOcclusion() ;

/// @brief Method get_eventCamera, addr 0x63e4408, size 0x98, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_ignoreReversedGraphics, addr 0x63e456c, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreReversedGraphics() ;

/// @brief Method get_maxDistance, addr 0x63e457c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_blockingMask, addr 0x63e4544, size 0x8, virtual false, abstract: false, final false
inline void set_blockingMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_checkFor2DOcclusion, addr 0x63e4564, size 0x8, virtual false, abstract: false, final false
inline void set_checkFor2DOcclusion(bool  value) ;

/// @brief Method set_checkFor3DOcclusion, addr 0x63e4554, size 0x8, virtual false, abstract: false, final false
inline void set_checkFor3DOcclusion(bool  value) ;

/// @brief Method set_ignoreReversedGraphics, addr 0x63e4574, size 0x8, virtual false, abstract: false, final false
inline void set_ignoreReversedGraphics(bool  value) ;

/// @brief Method set_maxDistance, addr 0x63e4584, size 0x8, virtual false, abstract: false, final false
