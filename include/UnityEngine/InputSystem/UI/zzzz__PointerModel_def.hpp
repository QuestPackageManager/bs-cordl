...
namespace UnityEngine::InputSystem::UI {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8987)), TypeDefinitionIndex(TypeDefinitionIndex(13065)), TypeDefinitionIndex(TypeDefinitionIndex(13111))]
...
public:
  ...
  /// @brief Method get_isPressed, addr 0x2ad73f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPressed();

  /// @brief Method set_isPressed, addr 0x2ad655c, size 0x54, virtual false, abstract: false, final false
  inline void set_isPressed(bool value);

  /// @brief Method get_ignoreNextClick, addr 0x2ad7400, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreNextClick();

  /// @brief Method set_ignoreNextClick, addr 0x2ad7408, size 0xc, virtual false, abstract: false, final false
  inline void set_ignoreNextClick(bool value);

  /// @brief Method get_pressTime, addr 0x2ad7414, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressTime();

  /// @brief Method set_pressTime, addr 0x2ad741c, size 0x8, virtual false, abstract: false, final false
  inline void set_pressTime(float_t value);

  /// @brief Method get_clickedOnSameGameObject, addr 0x2ad7424, size 0x8, virtual false, abstract: false, final false
  inline bool get_clickedOnSameGameObject();

  /// @brief Method set_clickedOnSameGameObject, addr 0x2ad742c, size 0xc, virtual false, abstract: false, final false
  inline void set_clickedOnSameGameObject(bool value);

  /// @brief Method get_wasPressedThisFrame, addr 0x2ad32e0, size 0x10, virtual false, abstract: false, final false
  inline bool get_wasPressedThisFrame();

  /// @brief Method get_wasReleasedThisFrame, addr 0x2ad2c38, size 0x14, virtual false, abstract: false, final false
  inline bool get_wasReleasedThisFrame();

  /// @brief Method CopyPressStateTo, addr 0x2ad1db0, size 0xa0, virtual false, abstract: false, final false
  inline void CopyPressStateTo(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method CopyPressStateFrom, addr 0x2ad32f0, size 0x68, virtual false, abstract: false, final false
  inline void CopyPressStateFrom(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEndFrame, addr 0x2ad73ec, size 0xc, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::UI {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5638)), TypeDefinitionIndex(TypeDefinitionIndex(8987)), TypeDefinitionIndex(TypeDefinitionIndex(8993)),
// TypeDefinitionIndex(TypeDefinitionIndex(8996))] Self: TypeDefinitionIndex(TypeDefinitionIndex(5639)) CS Name: ::UnityEngine.InputSystem.UI::PointerModel
...
public:
  ...
  /// @brief Method get_pointerType, addr 0x2ad1e9c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType();

  /// @brief Method get_screenPosition, addr 0x2ad72d4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method set_screenPosition, addr 0x2ad5f24, size 0x40, virtual false, abstract: false, final false
  inline void set_screenPosition(::UnityEngine::Vector2 value);

  /// @brief Method get_worldPosition, addr 0x2ad72e0, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_worldPosition();

  /// @brief Method set_worldPosition, addr 0x2ad6978, size 0x54, virtual false, abstract: false, final false
  inline void set_worldPosition(::UnityEngine::Vector3 value);

  /// @brief Method get_worldOrientation, addr 0x2ad72f0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_worldOrientation();

  /// @brief Method set_worldOrientation, addr 0x2ad689c, size 0x58, virtual false, abstract: false, final false
  inline void set_worldOrientation(::UnityEngine::Quaternion value);

  /// @brief Method get_scrollDelta, addr 0x2ad7304, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_scrollDelta();

  /// @brief Method set_scrollDelta, addr 0x2ad6778, size 0x40, virtual false, abstract: false, final false
  inline void set_scrollDelta(::UnityEngine::Vector2 value);

  /// @brief Method get_pressure, addr 0x2ad7310, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method set_pressure, addr 0x2ad7318, size 0x1c, virtual false, abstract: false, final false
  inline void set_pressure(float_t value);

  /// @brief Method get_azimuthAngle, addr 0x2ad7334, size 0x8, virtual false, abstract: false, final false
  inline float_t get_azimuthAngle();

  /// @brief Method set_azimuthAngle, addr 0x2ad733c, size 0x1c, virtual false, abstract: false, final false
  inline void set_azimuthAngle(float_t value);

  /// @brief Method get_altitudeAngle, addr 0x2ad7358, size 0x8, virtual false, abstract: false, final false
  inline float_t get_altitudeAngle();

  /// @brief Method set_altitudeAngle, addr 0x2ad7360, size 0x1c, virtual false, abstract: false, final false
  inline void set_altitudeAngle(float_t value);

  /// @brief Method get_twist, addr 0x2ad737c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_twist();

  /// @brief Method set_twist, addr 0x2ad7384, size 0x1c, virtual false, abstract: false, final false
  inline void set_twist(float_t value);

  /// @brief Method get_radius, addr 0x2ad73a0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method set_radius, addr 0x2ad73ac, size 0x40, virtual false, abstract: false, final false
  inline void set_radius(::UnityEngine::Vector2 value);

  /// @brief Method .ctor, addr 0x2ad5f64, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::UI::ExtendedPointerEventData* eventData);

  /// @brief Method OnFrameFinished, addr 0x2ad6b84, size 0x48, virtual false, abstract: false, final false
  inline void OnFrameFinished();

  /// @brief Method CopyTouchOrPenStateFrom, addr 0x2ad6bcc, size 0xc8, virtual false, abstract: false, final false
