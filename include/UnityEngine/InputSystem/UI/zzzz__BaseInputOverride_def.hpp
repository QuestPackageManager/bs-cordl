...
public:
  ...
  /// @brief Method .ctor, addr 0x63dbad4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compositionString, addr 0x63dbacc, size 0x8, virtual true, abstract: false, final false
