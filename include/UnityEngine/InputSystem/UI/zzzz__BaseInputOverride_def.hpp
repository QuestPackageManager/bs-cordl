...
/// @brief Method .ctor, addr 0x63dc194, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compositionString, addr 0x63dc18c, size 0x8, virtual true, abstract: false, final false
