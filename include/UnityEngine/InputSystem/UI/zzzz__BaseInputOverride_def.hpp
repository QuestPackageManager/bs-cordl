...
public:
  ...
  /// @brief Method .ctor, addr 0x6373f48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compositionString, addr 0x6373f40, size 0x8, virtual true, abstract: false, final false
