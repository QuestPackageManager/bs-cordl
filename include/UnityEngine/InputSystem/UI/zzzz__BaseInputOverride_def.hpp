...
public:
  ...
  /// @brief Method .ctor, addr 0x45fb31c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compositionString, addr 0x45fb314, size 0x8, virtual true, abstract: false, final false
