...
public:
  ...
  /// @brief Method .ctor, addr 0x45f22ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_compositionString, addr 0x45f22e4, size 0x8, virtual true, abstract: false, final false
