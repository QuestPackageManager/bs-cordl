...
/// @brief Method ToString, addr 0x63dc1a0, size 0xe0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x63dc198, size 0x8, virtual false, abstract: false, final false
