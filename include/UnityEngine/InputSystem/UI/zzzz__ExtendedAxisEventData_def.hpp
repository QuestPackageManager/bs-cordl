...
public:
  ...
  /// @brief Method ToString, addr 0x45ede80, size 0xbc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x45ede78, size 0x8, virtual false, abstract: false, final false
