...
public:
  ...
  /// @brief Method ToString, addr 0x45f22fc, size 0xbc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x45f22f4, size 0x8, virtual false, abstract: false, final false
