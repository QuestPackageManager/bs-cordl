...
public:
  ...
  /// @brief Method ToString, addr 0x63dbae0, size 0xe0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x63dbad8, size 0x8, virtual false, abstract: false, final false
