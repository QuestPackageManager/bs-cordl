...
public:
  ...
  /// @brief Method ToString, addr 0x6373f54, size 0xe0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6373f4c, size 0x8, virtual false, abstract: false, final false
