...
// Ctor Parameters [CppParam { name: "eventData", ty: "::UnityEngine::EventSystems::BaseEventData*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "device", ty:
// "::UnityEngine::InputSystem::InputDevice*", modifiers: "", def_value: Some("{}"), comment: None }]
