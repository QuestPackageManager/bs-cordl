...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ExtendedSubmitCancelEventData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ExtendedSubmitCancelEventData(ExtendedSubmitCancelEventData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ExtendedSubmitCancelEventData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ExtendedSubmitCancelEventData(ExtendedSubmitCancelEventDataconst&) = delete;
