...
MARK_REF_T(::UnityEngine::InputSystem::UI::VirtualMouseInput*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::UI::VirtualMouseInput_CursorMode, "UnityEngine.InputSystem.UI", "VirtualMouseInput/CursorMode");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::UI::VirtualMouseInput*, "UnityEngine.InputSystem.UI", "VirtualMouseInput");
// Dependencies
namespace UnityEngine::InputSystem::UI {
// Is value type: true
