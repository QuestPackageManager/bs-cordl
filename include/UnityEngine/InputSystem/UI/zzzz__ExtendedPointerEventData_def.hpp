...
namespace UnityEngine::InputSystem::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6458)), TypeDefinitionIndex(TypeDefinitionIndex(10176)), TypeDefinitionIndex(TypeDefinitionIndex(13173)),
// TypeDefinitionIndex(TypeDefinitionIndex(10179))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6457)) CS Name: ::UnityEngine.InputSystem.UI::ExtendedPointerEventData*
...
public:
  ...
  /// @brief Method .ctor addr 0x294fab4 size 0x8 virtual false final false
  inline void _ctor(::UnityEngine::EventSystems::EventSystem* eventSystem);

  /// @brief Method get_control addr 0x294fabc size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control addr 0x294fac4 size 0x8 virtual false final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method get_device addr 0x294facc size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device addr 0x294fad4 size 0x8 virtual false final false
  inline void set_device(::UnityEngine::InputSystem::InputDevice* value);

  /// @brief Method get_touchId addr 0x294fadc size 0x8 virtual false final false
  inline int32_t get_touchId();

  /// @brief Method set_touchId addr 0x294fae4 size 0x8 virtual false final false
  inline void set_touchId(int32_t value);

  /// @brief Method get_pointerType addr 0x294faec size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType();

  /// @brief Method set_pointerType addr 0x294faf4 size 0x8 virtual false final false
  inline void set_pointerType(::UnityEngine::InputSystem::UI::UIPointerType value);

  /// @brief Method get_uiToolkitPointerId addr 0x294fafc size 0x8 virtual false final false
  inline int32_t get_uiToolkitPointerId();

  /// @brief Method set_uiToolkitPointerId addr 0x294fb04 size 0x8 virtual false final false
  inline void set_uiToolkitPointerId(int32_t value);

  /// @brief Method get_trackedDevicePosition addr 0x294fb0c size 0x10 virtual false final false
  inline ::UnityEngine::Vector3 get_trackedDevicePosition();

  /// @brief Method set_trackedDevicePosition addr 0x294fb1c size 0x10 virtual false final false
  inline void set_trackedDevicePosition(::UnityEngine::Vector3 value);

  /// @brief Method get_trackedDeviceOrientation addr 0x294fb2c size 0x14 virtual false final false
  inline ::UnityEngine::Quaternion get_trackedDeviceOrientation();

  /// @brief Method set_trackedDeviceOrientation addr 0x294fb40 size 0x14 virtual false final false
  inline void set_trackedDeviceOrientation(::UnityEngine::Quaternion value);

  /// @brief Method ToString addr 0x294fb54 size 0x3bc virtual true final false
  inline ::StringW ToString();

  /// @brief Method MakePointerIdForTouch addr 0x294ff10 size 0x8 virtual false final false
  static inline int32_t MakePointerIdForTouch(int32_t deviceId, int32_t touchId);

  /// @brief Method TouchIdFromPointerId addr 0x294ff18 size 0x8 virtual false final false
  static inline int32_t TouchIdFromPointerId(int32_t pointerId);

  /// @brief Method ReadDeviceState addr 0x294ff20 size 0x254 virtual false final false
  inline void ReadDeviceState();

  /// @brief Method GetPenPointerId addr 0x2950174 size 0x254 virtual false final false
  static inline int32_t GetPenPointerId(::UnityEngine::InputSystem::Pen* pen);

  /// @brief Method GetTouchPointerId addr 0x29503c8 size 0xf8 virtual false final false
