...
public:
  ...
  /// @brief Method InitializePlayerRoot, addr 0x637be0c, size 0xcc, virtual false, abstract: false, final false
  inline void InitializePlayerRoot();

  static inline ::UnityEngine::InputSystem::UI::MultiplayerEventSystem* New_ctor();

  /// @brief Method OnDisable, addr 0x637bef4, size 0x8, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x637bed8, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x637befc, size 0xf8, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x637bff4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playerRoot, addr 0x637bdfc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_playerRoot();

  /// @brief Method set_playerRoot, addr 0x637be04, size 0x8, virtual false, abstract: false, final false
