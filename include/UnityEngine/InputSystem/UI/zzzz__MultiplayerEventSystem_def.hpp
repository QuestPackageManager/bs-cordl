...
public:
  ...
  /// @brief Method InitializePlayerRoot, addr 0x6456064, size 0xcc, virtual false, abstract: false, final false
  inline void InitializePlayerRoot();

  static inline ::UnityEngine::InputSystem::UI::MultiplayerEventSystem* New_ctor();

  /// @brief Method OnDisable, addr 0x645614c, size 0x8, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6456130, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x6456154, size 0xf8, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x645624c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playerRoot, addr 0x6456054, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_playerRoot();

  /// @brief Method set_playerRoot, addr 0x645605c, size 0x8, virtual false, abstract: false, final false
