...
public:
  ...
  /// @brief Method FinishSetup, addr 0x63afd84, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x63afca4, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::LinearAccelerationSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x63afcf4, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63afdf4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::LinearAccelerationSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_acceleration, addr 0x63afbf8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_acceleration();

  /// @brief Method get_current, addr 0x63afc08, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_acceleration, addr 0x63afc00, size 0x8, virtual false, abstract: false, final false
  inline void set_acceleration(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_current, addr 0x63afc54, size 0x50, virtual false, abstract: false, final false
