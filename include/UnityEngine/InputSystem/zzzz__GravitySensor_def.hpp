...
public:
  ...
  /// @brief Method get_gravity addr 0x2929284 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_gravity();

  /// @brief Method set_gravity addr 0x292928c size 0x8 virtual false final false
  inline void set_gravity(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method get_current addr 0x2929294 size 0x48 virtual false final false
  static inline ::UnityEngine::InputSystem::GravitySensor* get_current();

  /// @brief Method set_current addr 0x29292dc size 0x4c virtual false final false
  static inline void set_current(::UnityEngine::InputSystem::GravitySensor* value);

  /// @brief Method FinishSetup addr 0x2929328 size 0x78 virtual true final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent addr 0x29293a0 size 0x54 virtual true final false
  inline void MakeCurrent();

  /// @brief Method OnRemoved addr 0x29293f4 size 0x84 virtual true final false
  inline void OnRemoved();

  static inline ::UnityEngine::InputSystem::GravitySensor* New_ctor();

  /// @brief Method .ctor addr 0x2929478 size 0x8 virtual false final false
  inline void _ctor();
