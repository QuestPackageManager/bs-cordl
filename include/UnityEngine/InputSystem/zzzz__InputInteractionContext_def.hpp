...
public:
  ...
  /// @brief Method Canceled, addr 0x30ce37c, size 0x40, virtual false, abstract: false, final false
  inline void Canceled();

  /// @brief Method ComputeMagnitude, addr 0x30ce270, size 0x8, virtual false, abstract: false, final false
  inline float_t ComputeMagnitude();

  /// @brief Method ControlIsActuated, addr 0x30ce278, size 0xc, virtual false, abstract: false, final false
  inline bool ControlIsActuated(float_t threshold);

  /// @brief Method Performed, addr 0x30ce2bc, size 0x40, virtual false, abstract: false, final false
  inline void Performed();

  /// @brief Method PerformedAndStayPerformed, addr 0x30ce33c, size 0x40, virtual false, abstract: false, final false
  inline void PerformedAndStayPerformed();

  /// @brief Method PerformedAndStayStarted, addr 0x30ce2fc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTimeout, addr 0x30ce3fc, size 0x24, virtual false, abstract: false, final false
  inline void SetTimeout(float_t seconds);

  /// @brief Method SetTotalTimeoutCompletionTime, addr 0x30ce420, size 0x94, virtual false, abstract: false, final false
  inline void SetTotalTimeoutCompletionTime(float_t seconds);

  /// @brief Method Started, addr 0x30ce284, size 0x38, virtual false, abstract: false, final false
  inline void Started();

  /// @brief Method Waiting, addr 0x30ce3bc, size 0x40, virtual false, abstract: false, final false
  inline void Waiting();

  /// @brief Method get_action, addr 0x30ce1c8, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_bindingIndex, addr 0x30ce4c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bindingIndex();

  /// @brief Method get_control, addr 0x30ce1ec, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_controlIndex, addr 0x30ce4bc, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_controlIndex();

  /// @brief Method get_interactionIndex, addr 0x30ce4d0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_interactionIndex();

  /// @brief Method get_isStarted, addr 0x30ce260, size 0x10, virtual false, abstract: false, final false
  inline bool get_isStarted();

  /// @brief Method get_isWaiting, addr 0x30ce250, size 0x10, virtual false, abstract: false, final false
  inline bool get_isWaiting();

  /// @brief Method get_mapIndex, addr 0x30ce4b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_mapIndex();

  /// @brief Method get_phase, addr 0x30ce210, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_startTime, addr 0x30ce220, size 0x8, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_time, addr 0x30ce218, size 0x8, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_timerHasExpired, addr 0x30ce228, size 0xc, virtual false, abstract: false, final false
  inline bool get_timerHasExpired();

  /// @brief Method set_timerHasExpired, addr 0x30ce234, size 0x1c, virtual false, abstract: false, final false
