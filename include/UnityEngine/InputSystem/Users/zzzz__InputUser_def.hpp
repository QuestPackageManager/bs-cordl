...
public:
  // Declarations
  /// @brief Method AndPairRemainingDevices, addr 0x4576498, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x45764bc, size 0x3c, virtual true, abstract: false, final true
  inline int32_t Compare(::UnityEngine::InputSystem::InputDevice* x, ::UnityEngine::InputSystem::InputDevice* y);

  /// @brief Method GetUserAccountHandleForDevice, addr 0x45764f8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SaveAndResetState>b__86_0, addr 0x4576594, size 0x74, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__86_0(ByRef<::UnityEngine::InputSystem::Users::__InputUser__GlobalState> state);

  /// @brief Method <SaveAndResetState>b__86_1, addr 0x4576608, size 0x8, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__86_1();

  /// @brief Method .ctor, addr 0x457658c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActivateControlScheme, addr 0x4568250, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ActivateControlScheme, addr 0x4568408, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Users::__InputUser__ControlSchemeChangeSyntax ActivateControlScheme(::StringW schemeName);

  /// @brief Method ActivateControlSchemeInternal, addr 0x4572934, size 0x390, virtual false, abstract: false, final false
  inline void ActivateControlSchemeInternal(int32_t userIndex, ::UnityEngine::InputSystem::InputControlScheme scheme);

  /// @brief Method AddDeviceToUser, addr 0x4574adc, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method AddUser, addr 0x45748c8, size 0xf0, virtual false, abstract: false, final false
  static inline int32_t AddUser();

  /// @brief Method AssociateActionsWithUser, addr 0x4567dd0, size 0x338, virtual false, abstract: false, final false
  inline void AssociateActionsWithUser(::UnityEngine::InputSystem::IInputActionCollection* actions);

  /// @brief Method CreateUserWithoutPairedDevices, addr 0x45681e4, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Users::InputUser CreateUserWithoutPairedDevices();

  /// @brief Method DisposeAndResetGlobalState, addr 0x45763c8, size 0xb8, virtual false, abstract: false, final false
  static inline void DisposeAndResetGlobalState();

  /// @brief Method Equals, addr 0x45753f0, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x45753e0, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Users::InputUser other);

  /// @brief Method FindControlScheme, addr 0x4566400, size 0xb4, virtual false, abstract: false, final false
  inline void FindControlScheme(::StringW schemeName, ByRef<::UnityEngine::InputSystem::InputControlScheme> scheme);

  /// @brief Method FindLostDevice, addr 0x4575cb0, size 0xb8, virtual false, abstract: false, final false
  static inline int32_t FindLostDevice(::UnityEngine::InputSystem::InputDevice* device, int32_t startIndex);

  /// @brief Method FindUserByAccount, addr 0x45746ac, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method FindUserPairedToDevice, addr 0x45744c4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x4575468, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnpairedInputDevices, addr 0x4567c58, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputControlList_1<::UnityEngine::InputSystem::InputDevice*> GetUnpairedInputDevices();

  /// @brief Method GetUnpairedInputDevices, addr 0x45742b4, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method HookIntoActionChange, addr 0x4572824, size 0x110, virtual false, abstract: false, final false
  static inline void HookIntoActionChange();

  /// @brief Method HookIntoDeviceChange, addr 0x45752fc, size 0xe4, virtual false, abstract: false, final false
  static inline void HookIntoDeviceChange();

  /// @brief Method HookIntoEvents, addr 0x457240c, size 0x104, virtual false, abstract: false, final false
  static inline void HookIntoEvents();

  /// @brief Method InitiateUserAccountSelection, addr 0x45749c4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method InitiateUserAccountSelectionAtPlatformLevel, addr 0x4575240, size 0xbc, virtual false, abstract: false, final false
  static inline bool InitiateUserAccountSelectionAtPlatformLevel(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Notify, addr 0x4572f3c, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method OnActionChange, addr 0x457574c, size 0xc8, virtual false, abstract: false, final false
  static inline void OnActionChange(::System::Object* obj, ::UnityEngine::InputSystem::InputActionChange change);

  /// @brief Method OnDeviceChange, addr 0x4575814, size 0x49c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEvent, addr 0x4575d68, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformPairingWithDevice, addr 0x45678c0, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryPairedPlatformUserAccount, addr 0x45755c8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveDeviceFromUser, addr 0x4573b7c, size 0x480, virtual false, abstract: false, final false
  static inline void RemoveDeviceFromUser(int32_t userIndex, ::UnityEngine::InputSystem::InputDevice* device, bool asLostDevice);

  /// @brief Method RemoveLostDevicesForUser, addr 0x4573a50, size 0x12c, virtual false, abstract: false, final false
  static inline void RemoveLostDevicesForUser(int32_t userIndex);

  /// @brief Method RemoveUser, addr 0x4573ffc, size 0x2b8, virtual false, abstract: false, final false
  static inline void RemoveUser(int32_t userIndex);

  /// @brief Method ResetGlobals, addr 0x4576480, size 0x18, virtual false, abstract: false, final false
  static inline void ResetGlobals();

  /// @brief Method SaveAndResetState, addr 0x45761ec, size 0x1dc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ISavedState* SaveAndResetState();

  /// @brief Method ToString, addr 0x45725b8, size 0x26c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryFindControlScheme, addr 0x4572cc4, size 0x278, virtual false, abstract: false, final false
  inline bool TryFindControlScheme(::StringW schemeName, ByRef<::UnityEngine::InputSystem::InputControlScheme> scheme);

  /// @brief Method TryFindUserIndex, addr 0x45745c0, size 0xec, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method TryFindUserIndex, addr 0x45747e4, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(::UnityEngine::InputSystem::Users::InputUserAccountHandle platformHandle);

  /// @brief Method TryFindUserIndex, addr 0x4571fc0, size 0x94, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(uint32_t userId);

  /// @brief Method UnhookFromActionChange, addr 0x45754fc, size 0xcc, virtual false, abstract: false, final false
  static inline void UnhookFromActionChange();

  /// @brief Method UnhookFromDeviceChange, addr 0x4575470, size 0x8c, virtual false, abstract: false, final false
  static inline void UnhookFromDeviceChange();

  /// @brief Method UnhookFromDeviceStateChange, addr 0x4572510, size 0xa8, virtual false, abstract: false, final false
  static inline void UnhookFromDeviceStateChange();

  /// @brief Method UnpairDevice, addr 0x456a4c8, size 0xd8, virtual false, abstract: false, final false
  inline void UnpairDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method UnpairDevices, addr 0x4567650, size 0x270, virtual false, abstract: false, final false
  inline void UnpairDevices();

  /// @brief Method UnpairDevicesAndRemoveUser, addr 0x45681c0, size 0x24, virtual false, abstract: false, final false
  inline void UnpairDevicesAndRemoveUser();

  /// @brief Method UpdateControlSchemeMatch, addr 0x4573244, size 0x80c, virtual false, abstract: false, final false
  static inline void UpdateControlSchemeMatch(int32_t userIndex, bool autoPairMissing);

  /// @brief Method UpdatePlatformUserAccount, addr 0x4574eec, size 0x354, virtual false, abstract: false, final false
  static inline int64_t UpdatePlatformUserAccount(int32_t userIndex, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method add_onChange, addr 0x4568b30, size 0xb4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method add_onPrefilterUnpairedDeviceActivity, addr 0x4568fcc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onUnpairedDeviceUsed, addr 0x4568ef4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x4572288, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputActionCollection* get_actions();

  /// @brief Method get_all, addr 0x457238c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Users::InputUser> get_all();

  /// @brief Method get_controlScheme, addr 0x4564c34, size 0x8c, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme> get_controlScheme();

  /// @brief Method get_controlSchemeMatch, addr 0x4572300, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlScheme__MatchResult get_controlSchemeMatch();

  /// @brief Method get_hasMissingRequiredDevices, addr 0x45659a8, size 0x7c, virtual false, abstract: false, final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_id, addr 0x4572054, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_id();

  /// @brief Method get_index, addr 0x4571ed8, size 0xe8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_listenForUnpairedDeviceActivity, addr 0x4569080, size 0x48, virtual false, abstract: false, final false
  static inline int32_t get_listenForUnpairedDeviceActivity();

  /// @brief Method get_lostDevices, addr 0x45721dc, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_lostDevices();

  /// @brief Method get_pairedDevices, addr 0x45658b4, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_pairedDevices();

  /// @brief Method get_platformUserAccountHandle, addr 0x457205c, size 0x90, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::Users::InputUserAccountHandle> get_platformUserAccountHandle();

  /// @brief Method get_platformUserAccountId, addr 0x4572164, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_platformUserAccountId();

  /// @brief Method get_platformUserAccountName, addr 0x45720ec, size 0x78, virtual false, abstract: false, final false
  inline ::StringW get_platformUserAccountName();

  /// @brief Method get_valid, addr 0x4564b8c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4569cc8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x45749b8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onChange, addr 0x45696b4, size 0xb4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method remove_onPrefilterUnpairedDeviceActivity, addr 0x45692a4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onUnpairedDeviceUsed, addr 0x45691b4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_listenForUnpairedDeviceActivity, addr 0x45690c8, size 0xec, virtual false, abstract: false, final false
