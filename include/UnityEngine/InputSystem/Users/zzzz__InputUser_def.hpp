...
public:
  // Declarations
  /// @brief Method AndPairRemainingDevices, addr 0x63db4f4, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x63db560, size 0x54, virtual true, abstract: false, final true
  inline int32_t Compare(::UnityEngine::InputSystem::InputDevice* x, ::UnityEngine::InputSystem::InputDevice* y);

  /// @brief Method GetUserAccountHandleForDevice, addr 0x63db5b4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SaveAndResetState>b__88_0, addr 0x63db644, size 0x8c, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__88_0(::ByRef<::UnityEngine::InputSystem::Users::InputUser_GlobalState> state);

  /// @brief Method <SaveAndResetState>b__88_1, addr 0x63db6d0, size 0x54, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__88_1();

  /// @brief Method .ctor, addr 0x63db640, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActivateControlScheme, addr 0x63cb8f4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ActivateControlScheme, addr 0x63cbafc, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Users::InputUser_ControlSchemeChangeSyntax ActivateControlScheme(::StringW schemeName);

  /// @brief Method ActivateControlSchemeInternal, addr 0x63d6b14, size 0x43c, virtual false, abstract: false, final false
  inline void ActivateControlSchemeInternal(int32_t userIndex, ::UnityEngine::InputSystem::InputControlScheme scheme);

  /// @brief Method AddDeviceToUser, addr 0x63d9260, size 0x630, virtual false, abstract: false, final false
  ...
  /// @brief Method AddUser, addr 0x63d900c, size 0xf8, virtual false, abstract: false, final false
  static inline int32_t AddUser();

  /// @brief Method AssociateActionsWithUser, addr 0x63cb38c, size 0x39c, virtual false, abstract: false, final false
  inline void AssociateActionsWithUser(::UnityEngine::InputSystem::IInputActionCollection* actions);

  /// @brief Method CreateUserWithoutPairedDevices, addr 0x63cb874, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Users::InputUser CreateUserWithoutPairedDevices();

  /// @brief Method DisposeAndResetGlobalState, addr 0x63db2e8, size 0xf4, virtual false, abstract: false, final false
  static inline void DisposeAndResetGlobalState();

  /// @brief Method Equals, addr 0x63d9f3c, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x63d9f2c, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Users::InputUser other);

  /// @brief Method FindControlScheme, addr 0x63c9d84, size 0x118, virtual false, abstract: false, final false
  inline void FindControlScheme(::StringW schemeName, ::ByRef<::UnityEngine::InputSystem::InputControlScheme> scheme);

  /// @brief Method FindLostDevice, addr 0x63daa94, size 0xdc, virtual false, abstract: false, final false
  static inline int32_t FindLostDevice(::UnityEngine::InputSystem::InputDevice* device, int32_t startIndex);

  /// @brief Method FindUserByAccount, addr 0x63d8d9c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method FindUserPairedToDevice, addr 0x63d8b30, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x63d9fec, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUnpairedInputDevices, addr 0x63cb1e8, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputControlList_1<::UnityEngine::InputSystem::InputDevice*> GetUnpairedInputDevices();

  /// @brief Method GetUnpairedInputDevices, addr 0x63d8914, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method HookIntoActionChange, addr 0x63d69bc, size 0x158, virtual false, abstract: false, final false
  static inline void HookIntoActionChange();

  /// @brief Method HookIntoDeviceChange, addr 0x63d9dec, size 0x140, virtual false, abstract: false, final false
  static inline void HookIntoDeviceChange();

  /// @brief Method HookIntoEvents, addr 0x63d64f4, size 0x144, virtual false, abstract: false, final false
  static inline void HookIntoEvents();

  /// @brief Method InitiateUserAccountSelection, addr 0x63d9110, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method InitiateUserAccountSelectionAtPlatformLevel, addr 0x63d9d20, size 0xcc, virtual false, abstract: false, final false
  static inline bool InitiateUserAccountSelectionAtPlatformLevel(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Notify, addr 0x63d71f8, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method OnActionChange, addr 0x63da348, size 0xf0, virtual false, abstract: false, final false
  static inline void OnActionChange(::System::Object* obj, ::UnityEngine::InputSystem::InputActionChange change);

  /// @brief Method OnDeviceChange, addr 0x63da438, size 0x65c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEvent, addr 0x63dab70, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformPairingWithDevice, addr 0x63cad18, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryPairedPlatformUserAccount, addr 0x63da1a8, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveDeviceFromUser, addr 0x63d7fb0, size 0x5dc, virtual false, abstract: false, final false
  static inline void RemoveDeviceFromUser(int32_t userIndex, ::UnityEngine::InputSystem::InputDevice* device, bool asLostDevice);

  /// @brief Method RemoveLostDevicesForUser, addr 0x63d7df0, size 0x1c0, virtual false, abstract: false, final false
  static inline void RemoveLostDevicesForUser(int32_t userIndex);

  /// @brief Method RemoveUser, addr 0x63d858c, size 0x388, virtual false, abstract: false, final false
  static inline void RemoveUser(int32_t userIndex);

  /// @brief Method ResetGlobals, addr 0x63db3dc, size 0x5c, virtual false, abstract: false, final false
  static inline void ResetGlobals();

  /// @brief Method SaveAndResetState, addr 0x63db0d4, size 0x214, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ISavedState* SaveAndResetState();

  /// @brief Method ToString, addr 0x63d66f8, size 0x2c4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryFindControlScheme, addr 0x63d6f50, size 0x2a8, virtual false, abstract: false, final false
  inline bool TryFindControlScheme(::StringW schemeName, ::ByRef<::UnityEngine::InputSystem::InputControlScheme> scheme);

  /// @brief Method TryFindUserIndex, addr 0x63d8c44, size 0x158, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method TryFindUserIndex, addr 0x63d8ef0, size 0x11c, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(::UnityEngine::InputSystem::Users::InputUserAccountHandle platformHandle);

  /// @brief Method TryFindUserIndex, addr 0x63d6024, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t TryFindUserIndex(uint32_t userId);

  /// @brief Method UnhookFromActionChange, addr 0x63da0ac, size 0xfc, virtual false, abstract: false, final false
  static inline void UnhookFromActionChange();

  /// @brief Method UnhookFromDeviceChange, addr 0x63d9ff4, size 0xb8, virtual false, abstract: false, final false
  static inline void UnhookFromDeviceChange();

  /// @brief Method UnhookFromDeviceStateChange, addr 0x63d6638, size 0xc0, virtual false, abstract: false, final false
  static inline void UnhookFromDeviceStateChange();

  /// @brief Method UnpairDevice, addr 0x63cdf10, size 0x114, virtual false, abstract: false, final false
  inline void UnpairDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method UnpairDevices, addr 0x63caa7c, size 0x29c, virtual false, abstract: false, final false
  inline void UnpairDevices();

  /// @brief Method UnpairDevicesAndRemoveUser, addr 0x63cb808, size 0x6c, virtual false, abstract: false, final false
  inline void UnpairDevicesAndRemoveUser();

  /// @brief Method UpdateControlSchemeMatch, addr 0x63d7508, size 0x8e8, virtual false, abstract: false, final false
  static inline void UpdateControlSchemeMatch(int32_t userIndex, bool autoPairMissing);

  /// @brief Method UpdatePlatformUserAccount, addr 0x63d9890, size 0x490, virtual false, abstract: false, final false
  static inline int64_t UpdatePlatformUserAccount(int32_t userIndex, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method add_onChange, addr 0x63cc254, size 0xcc, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method add_onPrefilterUnpairedDeviceActivity, addr 0x63cc770, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onUnpairedDeviceUsed, addr 0x63cc674, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x63d6350, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputActionCollection* get_actions();

  /// @brief Method get_all, addr 0x63d647c, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Users::InputUser> get_all();

  /// @brief Method get_controlScheme, addr 0x63c7ad4, size 0xa0, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme> get_controlScheme();

  /// @brief Method get_controlSchemeMatch, addr 0x63d63dc, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlScheme_MatchResult get_controlSchemeMatch();

  /// @brief Method get_hasMissingRequiredDevices, addr 0x63c89ac, size 0x94, virtual false, abstract: false, final false
  inline bool get_hasMissingRequiredDevices();

  /// @brief Method get_id, addr 0x63d60e0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_id();

  /// @brief Method get_index, addr 0x63d5ef8, size 0x12c, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_listenForUnpairedDeviceActivity, addr 0x63cc83c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_listenForUnpairedDeviceActivity();

  /// @brief Method get_lostDevices, addr 0x63d62a4, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_lostDevices();

  /// @brief Method get_pairedDevices, addr 0x63c8864, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_pairedDevices();

  /// @brief Method get_platformUserAccountHandle, addr 0x63d60e8, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::Users::InputUserAccountHandle> get_platformUserAccountHandle();

  /// @brief Method get_platformUserAccountId, addr 0x63d6218, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW get_platformUserAccountId();

  /// @brief Method get_platformUserAccountName, addr 0x63d618c, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW get_platformUserAccountName();

  /// @brief Method get_valid, addr 0x63c7a00, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63cd5ac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63d9104, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onChange, addr 0x63ccee4, size 0xcc, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method remove_onPrefilterUnpairedDeviceActivity, addr 0x63ccac0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onUnpairedDeviceUsed, addr 0x63cc9b4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_listenForUnpairedDeviceActivity, addr 0x63cc898, size 0x11c, virtual false, abstract: false, final false
