...
public:
// Declarations
/// @brief Method GetDefaultConfiguration, addr 0x632e06c, size 0x21c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "ActionAsset", ty: "::UnityW<::UnityEngine::InputSystem::InputActionAsset>", modifiers: "", def_value: None }, CppParam { name: "PointAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "MoveAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "SubmitAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "CancelAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "LeftClickAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "MiddleClickAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "RightClickAction", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ScrollWheelAction", ty: "::StringW", modifiers: "", def_value: None }]
constexpr InputSystemProvider_Configuration(::UnityW<::UnityEngine::InputSystem::InputActionAsset>  ActionAsset, ::StringW  PointAction, ::StringW  MoveAction, ::StringW  SubmitAction, ::StringW  CancelAction, ::StringW  LeftClickAction, ::StringW  MiddleClickAction, ::StringW  RightClickAction, ::StringW  ScrollWheelAction) noexcept;
...
/// @brief Method <Update>b__33_0, addr 0x6331f70, size 0xbc, virtual false, abstract: false, final false
inline int32_t _Update_b__33_0(::UnityEngine::InputForUI::Event  a, ::UnityEngine::InputForUI::Event  b) ;

/// @brief Method .ctor, addr 0x6331f6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActionAssetIsNotNull, addr 0x632f96c, size 0x64, virtual false, abstract: false, final false
inline bool ActionAssetIsNotNull() ;

/// @brief Method Bootstrap, addr 0x632de50, size 0x4, virtual false, abstract: false, final false
static inline void Bootstrap() ;

/// @brief Method DirectionNavigation, addr 0x632f75c, size 0x204, virtual false, abstract: false, final false
inline void DirectionNavigation(::Unity::IntegerTime::DiscreteTime  currentTime) ;

/// @brief Method DispatchFromCallback, addr 0x633067c, size 0x124, virtual false, abstract: false, final false
inline void DispatchFromCallback(::ByRef<::UnityEngine::InputForUI::Event>  ev) ;

/// @brief Method FindTouchFingerIndex, addr 0x63307a0, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method GetActiveDeviceFromDirection, addr 0x632fbe4, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetEventSource, addr 0x633062c, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::EventSource GetEventSource(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method GetEventSource, addr 0x632fce4, size 0x190, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::EventSource GetEventSource(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method GetPointerStateForSource, addr 0x633065c, size 0x20, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::InputForUI::PointerState> GetPointerStateForSource(::UnityEngine::InputForUI::EventSource  eventSource) ;

/// @brief Method Initialize, addr 0x632de84, size 0x1e8, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::UnityEngine::InputSystem::Plugins::InputForUI::InputSystemProvider* New_ctor() ;

/// @brief Method OnActionsChange, addr 0x632f2b8, size 0x38, virtual false, abstract: false, final false
inline void OnActionsChange() ;

/// @brief Method OnCancelPerformed, addr 0x6331400, size 0x11c, virtual false, abstract: false, final false
inline void OnCancelPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnClickPerformed, addr 0x633151c, size 0x40c, virtual false, abstract: false, final false
...
/// @brief Method OnFocusChanged, addr 0x632ff54, size 0x18c, virtual true, abstract: false, final true
inline void OnFocusChanged(bool  focus) ;

/// @brief Method OnLeftClickPerformed, addr 0x6331928, size 0x38, virtual false, abstract: false, final false
inline void OnLeftClickPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnMiddleClickPerformed, addr 0x6331960, size 0x38, virtual false, abstract: false, final false
inline void OnMiddleClickPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnPointerPerformed, addr 0x6330ab0, size 0x834, virtual false, abstract: false, final false
inline void OnPointerPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnRightClickPerformed, addr 0x6331998, size 0x38, virtual false, abstract: false, final false
inline void OnRightClickPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnScrollWheelPerformed, addr 0x63319d0, size 0x3dc, virtual false, abstract: false, final false
inline void OnScrollWheelPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method OnSubmitPerformed, addr 0x63312e4, size 0x11c, virtual false, abstract: false, final false
inline void OnSubmitPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext  ctx) ;

/// @brief Method ReadCurrentNavigationMoveVector, addr 0x632f9d0, size 0x104, virtual false, abstract: false, final false
inline ::System::ValueTuple_2<::UnityEngine::Vector2,bool> ReadCurrentNavigationMoveVector() ;

/// @brief Method ReadNextPreviousDirection, addr 0x632fad4, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::NavigationEvent_Direction ReadNextPreviousDirection() ;

/// @brief Method RegisterActions, addr 0x632e288, size 0x890, virtual false, abstract: false, final false
inline void RegisterActions() ;

/// @brief Method RegisterNextPreviousAction, addr 0x6331dac, size 0xe8, virtual false, abstract: false, final false
inline void RegisterNextPreviousAction() ;

/// @brief Method RequestCurrentState, addr 0x63300e0, size 0x340, virtual true, abstract: false, final true
inline bool RequestCurrentState(::UnityEngine::InputForUI::Event_Type  type) ;

/// @brief Method ResetSeenEvents, addr 0x632f960, size 0xc, virtual false, abstract: false, final false
inline void ResetSeenEvents() ;

/// @brief Method ScreenBottomLeftToPanelPosition, addr 0x633052c, size 0x100, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2  position, int32_t  targetDisplay) ;

/// @brief Method SetOnRegisterActions, addr 0x6331eb8, size 0x60, virtual false, abstract: false, final false
static inline void SetOnRegisterActions(::System::Action_1<::UnityW<::UnityEngine::InputSystem::InputActionAsset>>*  callback) ;

/// @brief Method Shutdown, addr 0x632eb18, size 0xf8, virtual true, abstract: false, final true
inline void Shutdown() ;

/// @brief Method SortEvents, addr 0x632fe74, size 0xe0, virtual false, abstract: false, final false
static inline int32_t SortEvents(::UnityEngine::InputForUI::Event  a, ::UnityEngine::InputForUI::Event  b) ;

/// @brief Method ToPointerStateEvent, addr 0x6330420, size 0x104, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::PointerEvent ToPointerStateEvent(::Unity::IntegerTime::DiscreteTime  currentTime, ::ByRef<::UnityEngine::InputForUI::PointerState>  state, ::UnityEngine::InputForUI::EventSource  eventSource) ;

/// @brief Method UnregisterActions, addr 0x632ec10, size 0x6a8, virtual false, abstract: false, final false
inline void UnregisterActions() ;

/// @brief Method UnregisterFixedActions, addr 0x6331e94, size 0x24, virtual false, abstract: false, final false
inline void UnregisterFixedActions() ;

/// @brief Method Update, addr 0x632f2f0, size 0x46c, virtual true, abstract: false, final true
inline void Update() ;
...
/// @brief Method .ctor, addr 0x632ddac, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Action_1<::UnityW<::UnityEngine::InputSystem::InputActionAsset>>* getStaticF_s_OnRegisterActions() ;

/// @brief Method get_m_CurrentTime, addr 0x632de6c, size 0x18, virtual false, abstract: false, final false
inline ::Unity::IntegerTime::DiscreteTime get_m_CurrentTime() ;

/// @brief Method get_m_EventModifiers, addr 0x632de54, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::InputForUI::EventModifiers get_m_EventModifiers() ;

/// @brief Method get_playerCount, addr 0x6330524, size 0x8, virtual true, abstract: false, final true
