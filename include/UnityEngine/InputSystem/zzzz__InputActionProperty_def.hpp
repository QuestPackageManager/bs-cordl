...
public:
  ...
  /// @brief Method get_action addr 0x28c7c7c size 0x94 virtual false final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_reference addr 0x28c7dbc size 0x18 virtual false final false
  inline ::UnityEngine::InputSystem::InputActionReference* get_reference();

  /// @brief Method .ctor addr 0x28c7dd4 size 0xc virtual false final false
  inline void _ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor addr 0x28c7de0 size 0x10 virtual false final false
  inline void _ctor(::UnityEngine::InputSystem::InputActionReference* reference);

  /// @brief Method Equals addr 0x28c7df0 size 0xa4 virtual true final true
  inline bool Equals(::UnityEngine::InputSystem::InputActionProperty other);

  /// @brief Method Equals addr 0x28c7e94 size 0x1c virtual true final true
  inline bool Equals(::UnityEngine::InputSystem::InputAction* other);

  /// @brief Method Equals addr 0x28c7eb0 size 0x6c virtual true final true
  inline bool Equals(::UnityEngine::InputSystem::InputActionReference* other);

  /// @brief Method Equals addr 0x28c7f1c size 0xcc virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x28c7fe8 size 0x9c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality addr 0x28c8084 size 0x30 virtual false final false
  ...
  /// @brief Method op_Inequality addr 0x28c80b4 size 0x34 virtual false final false
