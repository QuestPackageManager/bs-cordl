...
/// @brief Method Dispose, addr 0x63af820, size 0x5c, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x63af134, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_Subscribers, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Subscribers, put=__cordl_internal_set_m_Subscribers)) ::ArrayW<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*,::Array<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*>*>  m_Subscribers;
...
/// @brief Method Bind, addr 0x63ae794, size 0x724, virtual false, abstract: false, final false
...
/// @brief Method OnChangeUsages, addr 0x63af354, size 0xc, virtual false, abstract: false, final false
inline void OnChangeUsages(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnConnected, addr 0x63aeeb8, size 0xdc, virtual false, abstract: false, final false
inline void OnConnected(int32_t  id) ;

/// @brief Method OnDisconnected, addr 0x63af248, size 0xdc, virtual false, abstract: false, final false
inline void OnDisconnected(int32_t  id) ;

/// @brief Method OnNewDevice, addr 0x63af324, size 0xc, virtual false, abstract: false, final false
inline void OnNewDevice(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnNewEvents, addr 0x63af33c, size 0xc, virtual false, abstract: false, final false
inline void OnNewEvents(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnNewLayout, addr 0x63af330, size 0xc, virtual false, abstract: false, final false
inline void OnNewLayout(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnRemoveDevice, addr 0x63af348, size 0xc, virtual false, abstract: false, final false
inline void OnRemoveDevice(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnStartSending, addr 0x63af360, size 0xc, virtual false, abstract: false, final false
inline void OnStartSending(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnStopSending, addr 0x63af36c, size 0xc, virtual false, abstract: false, final false
inline void OnStopSending(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method SendToSubscribers, addr 0x63af138, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Subscribe, addr 0x63aef94, size 0x1a0, virtual true, abstract: false, final true
inline ::System::IDisposable* Subscribe(::System::IObserver_1<::UnityEngine::InputSystem::InputRemoting_Message>*  observer) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnCompleted, addr 0x63af628, size 0x4, virtual true, abstract: false, final true
inline void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnCompleted() ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnError, addr 0x63af624, size 0x4, virtual true, abstract: false, final true
inline void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnError(::System::Exception*  error) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnNext, addr 0x63af378, size 0x2ac, virtual true, abstract: false, final true
...
constexpr ::ArrayW<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*,::Array<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*>*> const& __cordl_internal_get_m_Subscribers() const;

constexpr ::ArrayW<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*,::Array<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*>*>& __cordl_internal_get_m_Subscribers() ;
...
constexpr void __cordl_internal_set_m_Subscribers(::ArrayW<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*,::Array<::UnityEngine::InputSystem::RemoteInputPlayerConnection_Subscriber*>*>  value) ;

/// @brief Method .ctor, addr 0x63af62c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
