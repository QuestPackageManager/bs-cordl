...
public:
  ...
  /// @brief Method FinishSetup, addr 0x4589eb8, size 0x1f4, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x4589db8, size 0x80, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::Pen* New_ctor();

  /// @brief Method OnRemoved, addr 0x4589e38, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x458a0ac, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::Pen* getStaticF__current_k__BackingField();

  /// @brief Method get_Item, addr 0x4589cc4, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_Item(::UnityEngine::InputSystem::PenButton button);

  /// @brief Method get_current, addr 0x4589c30, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Pen* get_current();

  /// @brief Method get_eraser, addr 0x4589bb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_eraser();

  /// @brief Method get_firstBarrelButton, addr 0x4589bc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_firstBarrelButton();

  /// @brief Method get_fourthBarrelButton, addr 0x4589bf0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_fourthBarrelButton();

  /// @brief Method get_inRange, addr 0x4589c00, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_inRange();

  /// @brief Method get_secondBarrelButton, addr 0x4589bd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_secondBarrelButton();

  /// @brief Method get_thirdBarrelButton, addr 0x4589be0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_thirdBarrelButton();

  /// @brief Method get_tilt, addr 0x4589c10, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_tilt();

  /// @brief Method get_tip, addr 0x4589ba0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_tip();

  /// @brief Method get_twist, addr 0x4589c20, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x4589c78, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::Pen* value);

  /// @brief Method set_eraser, addr 0x4589bb8, size 0x8, virtual false, abstract: false, final false
  inline void set_eraser(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_firstBarrelButton, addr 0x4589bc8, size 0x8, virtual false, abstract: false, final false
  inline void set_firstBarrelButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_fourthBarrelButton, addr 0x4589bf8, size 0x8, virtual false, abstract: false, final false
  inline void set_fourthBarrelButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_inRange, addr 0x4589c08, size 0x8, virtual false, abstract: false, final false
  inline void set_inRange(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_secondBarrelButton, addr 0x4589bd8, size 0x8, virtual false, abstract: false, final false
  inline void set_secondBarrelButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_thirdBarrelButton, addr 0x4589be8, size 0x8, virtual false, abstract: false, final false
  inline void set_thirdBarrelButton(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_tilt, addr 0x4589c18, size 0x8, virtual false, abstract: false, final false
  inline void set_tilt(::UnityEngine::InputSystem::Controls::Vector2Control* value);

  /// @brief Method set_tip, addr 0x4589ba8, size 0x8, virtual false, abstract: false, final false
  inline void set_tip(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_twist, addr 0x4589c28, size 0x8, virtual false, abstract: false, final false
