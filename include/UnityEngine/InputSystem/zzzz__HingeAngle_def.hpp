...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6423530, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x6423450, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::HingeAngle* New_ctor();

  /// @brief Method OnRemoved, addr 0x64234a0, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64235a0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::HingeAngle* getStaticF__current_k__BackingField();

  /// @brief Method get_angle, addr 0x64233a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_angle();

  /// @brief Method get_current, addr 0x64233b4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_angle, addr 0x64233ac, size 0x8, virtual false, abstract: false, final false
  inline void set_angle(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_current, addr 0x6423400, size 0x50, virtual false, abstract: false, final false
