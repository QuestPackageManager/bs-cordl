...
public:
  ...
  /// @brief Method .ctor, addr 0x2a6bcf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_usages>b__7_0, addr 0x2a6bcfc, size 0x24, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5928)), TypeDefinitionIndex(TypeDefinitionIndex(5968)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5928), inst: 2681
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5489)) CS Name: ::InputControlPath::ParsedPathComponent
...
public:
  ...
  /// @brief Method get_layout, addr 0x2a6b910, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_usages, addr 0x2a6b918, size 0x138, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_usages();

  /// @brief Method get_name, addr 0x2a6ba50, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_displayName, addr 0x2a6ba5c, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_isWildcard, addr 0x2a6a5f8, size 0x64, virtual false, abstract: false, final false
  inline bool get_isWildcard();

  /// @brief Method get_isDoubleWildcard, addr 0x2a6ba68, size 0x64, virtual false, abstract: false, final false
  inline bool get_isDoubleWildcard();

  /// @brief Method ToHumanReadableString, addr 0x2a69bc0, size 0x744, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHumanReadableString, addr 0x2a6bacc, size 0x64, virtual false, abstract: false, final false
  static inline ::StringW ToHumanReadableString(::UnityEngine::InputSystem::Utilities::Substring substring);

  /// @brief Method Matches, addr 0x2a6b2a8, size 0x2b0, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ComparePathElementToString, addr 0x2a6bb30, size 0x160, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5489))]
...
public:
  ...
  /// @brief Method get_isAtEnd, addr 0x2a6ad44, size 0x14, virtual false, abstract: false, final false
  inline bool get_isAtEnd();

  /// @brief Method .ctor, addr 0x2a6990c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path);

  /// @brief Method MoveToNextComponent, addr 0x2a69948, size 0x278, virtual false, abstract: false, final false
  inline bool MoveToNextComponent();

  /// @brief Method ParseComponentPart, addr 0x2a6bd20, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a6be88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <TryGetDeviceUsages>b__9_0, addr 0x2a6be90, size 0x24, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(5489)), TypeDefinitionIndex(TypeDefinitionIndex(5490))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a6b8dc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2a6beb4, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2a6beb8, size 0x140, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.get_Current, addr 0x2a6bff8, size 0x10, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a6c008, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a6c048, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.GetEnumerator, addr 0x2a6c0ac, size 0xa4, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a6c150, size 0x4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CleanSlashes, addr 0x2a69394, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW CleanSlashes(::StringW pathComponent);

  /// @brief Method Combine, addr 0x2a65024, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW Combine(::UnityEngine::InputSystem::InputControl* parent, ::StringW path);

  /// @brief Method ToHumanReadableString, addr 0x2a693b0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHumanReadableString, addr 0x2a693dc, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetDeviceUsages, addr 0x2a6a304, size 0x1a8, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> TryGetDeviceUsages(::StringW path);

  /// @brief Method TryGetDeviceLayout, addr 0x2a6a4ac, size 0x14c, virtual false, abstract: false, final false
  static inline ::StringW TryGetDeviceLayout(::StringW path);

  /// @brief Method TryGetControlLayout, addr 0x2a6a65c, size 0x23c, virtual false, abstract: false, final false
  static inline ::StringW TryGetControlLayout(::StringW path);

  /// @brief Method FindControlLayoutRecursive, addr 0x2a6a898, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method FindControlLayoutRecursive, addr 0x2a6aa08, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ControlLayoutMatchesPathComponent, addr 0x2a6aba0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method StringMatches, addr 0x2a6ad58, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControl, addr 0x2a62910, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControls, addr 0x2a6af5c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControls, addr 0x2a6b0b8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindChild, addr 0x2a65438, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Matches, addr 0x2a69810, size 0xfc, virtual false, abstract: false, final false
  static inline bool Matches(::StringW expected, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method MatchesPrefix, addr 0x2a6b190, size 0x118, virtual false, abstract: false, final false
  static inline bool MatchesPrefix(::StringW expected, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method MatchesRecursive, addr 0x2a6b128, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchPathComponent, addr 0x2a6b558, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method PathComponentCanYieldMultipleMatches, addr 0x2a6b7a8, size 0xbc, virtual false, abstract: false, final false
  static inline bool PathComponentCanYieldMultipleMatches(::StringW path, int32_t indexInPath);

  /// @brief Method Parse, addr 0x2a6b864, size 0x78, virtual false, abstract: false, final false
