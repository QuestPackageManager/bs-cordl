...
public:
  ...
  /// @brief Method .ctor, addr 0x4582e18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_usages>b__7_0, addr 0x4582e20, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComparePathElementToString, addr 0x4582c5c, size 0x160, virtual false, abstract: false, final false
  static inline bool ComparePathElementToString(::UnityEngine::InputSystem::Utilities::Substring pathElement, ::StringW element);

  /// @brief Method Matches, addr 0x45823a4, size 0x2b0, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToHumanReadableString, addr 0x458084c, size 0x7a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHumanReadableString, addr 0x4582bf8, size 0x64, virtual false, abstract: false, final false
  static inline ::StringW ToHumanReadableString(::UnityEngine::InputSystem::Utilities::Substring substring);

  /// @brief Method get_displayName, addr 0x4582b88, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_isDoubleWildcard, addr 0x4582b94, size 0x64, virtual false, abstract: false, final false
  inline bool get_isDoubleWildcard();

  /// @brief Method get_isWildcard, addr 0x45812c0, size 0x64, virtual false, abstract: false, final false
  inline bool get_isWildcard();

  /// @brief Method get_layout, addr 0x4582a44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_name, addr 0x4582b7c, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_usages, addr 0x4582a4c, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveToNextComponent, addr 0x45805e0, size 0x26c, virtual false, abstract: false, final false
  inline bool MoveToNextComponent();

  /// @brief Method ParseComponentPart, addr 0x4582e44, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::Substring ParseComponentPart(char16_t terminator);

  /// @brief Method .ctor, addr 0x45805a4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW path);

  /// @brief Method get_isAtEnd, addr 0x45819e8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <TryGetDeviceUsages>b__9_0, addr 0x4582fb0, size 0x24, virtual false, abstract: false, final false
  inline ::StringW _TryGetDeviceUsages_b__9_0(::UnityEngine::InputSystem::Utilities::Substring x);

  /// @brief Method .ctor, addr 0x4582fa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4582fd8, size 0x130, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputControlPath__Parse_d__34* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.GetEnumerator, addr 0x45831b4, size 0x9c, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.get_Current, addr 0x4583108, size 0x10, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x4583250, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x4583118, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x4583150, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x4582fd4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4582a10, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CleanSlashes, addr 0x4580020, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW CleanSlashes(::StringW pathComponent);

  /// @brief Method Combine, addr 0x457b358, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW Combine(::UnityEngine::InputSystem::InputControl* parent, ::StringW path);

  /// @brief Method ControlLayoutMatchesPathComponent, addr 0x4581844, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method FindControlLayoutRecursive, addr 0x45816ac, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method FindControlLayoutRecursive, addr 0x4581540, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchControlComponent, addr 0x4581e98, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchPathComponent, addr 0x4582654, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method Matches, addr 0x45804c4, size 0xe0, virtual false, abstract: false, final false
  static inline bool Matches(::StringW expected, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method MatchesPrefix, addr 0x45822a8, size 0xfc, virtual false, abstract: false, final false
  static inline bool MatchesPrefix(::StringW expected, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method MatchesRecursive, addr 0x4581e30, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x45829a0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method PathComponentCanYieldMultipleMatches, addr 0x45828e4, size 0xbc, virtual false, abstract: false, final false
  static inline bool PathComponentCanYieldMultipleMatches(::StringW path, int32_t indexInPath);

  /// @brief Method StringMatches, addr 0x45819fc, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHumanReadableString, addr 0x4580068, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHumanReadableString, addr 0x458003c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindChild, addr 0x457b75c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControl, addr 0x4574898, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControls, addr 0x4581c64, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindControls, addr 0x4581dc0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetControlLayout, addr 0x4581324, size 0x21c, virtual false, abstract: false, final false
  static inline ::StringW TryGetControlLayout(::StringW path);

  /// @brief Method TryGetDeviceLayout, addr 0x4581188, size 0x138, virtual false, abstract: false, final false
  static inline ::StringW TryGetDeviceLayout(::StringW path);

  /// @brief Method TryGetDeviceUsages, addr 0x4580ff0, size 0x198, virtual false, abstract: false, final false
