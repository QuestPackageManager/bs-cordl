...
public:
  ...
  /// @brief Method FinishSetup, addr 0x2fd7ed8, size 0x3b4, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x2fd7e00, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  /// @brief Method MergeForward, addr 0x2fd92f4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method OnNextUpdate, addr 0x2fd828c, size 0x2d8, virtual false, abstract: false, final false
  inline void OnNextUpdate();

  /// @brief Method OnRemoved, addr 0x2fd7e54, size 0x84, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method OnStateEvent, addr 0x2fd8564, size 0x664, virtual false, abstract: false, final false
  inline void OnStateEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr);

  /// @brief Method TriggerTap, addr 0x2fd8bc8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.ICustomDeviceReset.Reset, addr 0x2fd8f04, size 0x3f0, virtual true, abstract: false, final true
  inline void UnityEngine_InputSystem_LowLevel_ICustomDeviceReset_Reset();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IEventMerger.MergeForward, addr 0x2fd9464, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.GetStateOffsetForEvent, addr 0x2fd8c9c, size 0x248, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate, addr 0x2fd8c94, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate();

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent, addr 0x2fd8c98, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2fd9470, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_current, addr 0x2fd7d6c, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Touchscreen* get_current();

  /// @brief Method get_primaryTouch, addr 0x2fd7ccc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::TouchControl* get_primaryTouch();

  /// @brief Method get_touchControlArray, addr 0x2fd7cf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_touches, addr 0x2fd7cdc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x2fd7db4, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::Touchscreen* value);

  /// @brief Method set_primaryTouch, addr 0x2fd7cd4, size 0x8, virtual false, abstract: false, final false
  inline void set_primaryTouch(::UnityEngine::InputSystem::Controls::TouchControl* value);

  /// @brief Method set_touchControlArray, addr 0x2fd7cf8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_touches, addr 0x2fd7ce8, size 0x8, virtual false, abstract: false, final false
