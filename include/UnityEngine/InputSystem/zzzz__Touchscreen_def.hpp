...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6247)), TypeDefinitionIndex(TypeDefinitionIndex(6641)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6701), inst: 4895
// }), TypeDefinitionIndex(TypeDefinitionIndex(6701))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6288)) CS Name: ::UnityEngine.InputSystem::Touchscreen*
