...
/// @brief Method AddActionMap, addr 0x63577d0, size 0x17f8, virtual false, abstract: false, final false
inline void AddActionMap(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method ApplyParameters, addr 0x63593f0, size 0x498, virtual false, abstract: false, final false
...
/// @brief Method AssignCompositePartIndex, addr 0x635922c, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x63576e0, size 0xc, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method InstantiateBindingComposite, addr 0x6358fdc, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method StartWithPreviousResolve, addr 0x63576ec, size 0xe4, virtual false, abstract: false, final false
inline void StartWithPreviousResolve(::UnityEngine::InputSystem::InputActionState*  state, bool  isFullResolve) ;

/// @brief Method get_totalActionCount, addr 0x63576c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalActionCount() ;

/// @brief Method get_totalBindingCount, addr 0x63576d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalBindingCount() ;

/// @brief Method get_totalControlCount, addr 0x63576d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalControlCount() ;

/// @brief Method get_totalMapCount, addr 0x63576c0, size 0x8, virtual false, abstract: false, final false
