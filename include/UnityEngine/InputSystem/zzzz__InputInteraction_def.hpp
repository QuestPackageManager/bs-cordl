...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(6798))}
...
public:
  ...
  /// @brief Method GetValueType addr 0x28b6780 size 0xf4 virtual false final false
  static inline ::System::Type* GetValueType(::System::Type* interactionType);

  /// @brief Method GetDisplayName addr 0x28b6874 size 0x104 virtual false final false
  static inline ::StringW GetDisplayName(::StringW interaction);

  /// @brief Method GetDisplayName addr 0x28b6978 size 0x198 virtual false final false
