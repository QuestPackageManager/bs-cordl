...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InputInteraction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InputInteraction(InputInteraction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InputInteraction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InputInteraction(InputInteractionconst&) = delete;
