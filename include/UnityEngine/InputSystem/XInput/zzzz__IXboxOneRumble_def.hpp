...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::XInput::IXboxOneRumble*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XInput::IXboxOneRumble*, "UnityEngine.InputSystem.XInput", "IXboxOneRumble");
// Dependencies
namespace UnityEngine::InputSystem::XInput {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IXboxOneRumble", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IXboxOneRumble(IXboxOneRumbleconst&) = delete;
