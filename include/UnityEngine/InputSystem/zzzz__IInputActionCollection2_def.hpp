...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::IInputActionCollection2*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::IInputActionCollection2*, "UnityEngine.InputSystem", "IInputActionCollection2");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IInputActionCollection2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInputActionCollection2(IInputActionCollection2const&) = delete;
