...
/// @brief Field <lightLevel>k__BackingField, offset 0x188, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightLevel_k__BackingField, put=__cordl_internal_set__lightLevel_k__BackingField)) ::UnityEngine::InputSystem::Controls::AxisControl*  _lightLevel_k__BackingField;

 __declspec(property(get=get_lightLevel, put=set_lightLevel)) ::UnityEngine::InputSystem::Controls::AxisControl*  lightLevel;

/// @brief Method FinishSetup, addr 0x63b087c, size 0x70, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x63b079c, size 0x50, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::LightSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x63b07ec, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63b08ec, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::LightSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x63b0700, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LightSensor* get_current() ;

/// @brief Method get_lightLevel, addr 0x63b06f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x63b074c, size 0x50, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::LightSensor*  value) ;

/// @brief Method set_lightLevel, addr 0x63b06f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::InputSystem::LightSensor, ____lightLevel_k__BackingField) == 0x188, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LightSensor, 0x190>, "Size mismatch!");
