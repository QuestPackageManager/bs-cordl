...
public:
  ...
  /// @brief Method FinishSetup, addr 0x63b01bc, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x63b00dc, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::LightSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x63b012c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63b022c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::LightSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x63b0040, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LightSensor* get_current();

  /// @brief Method get_lightLevel, addr 0x63b0030, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x63b008c, size 0x50, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::LightSensor* value);

  /// @brief Method set_lightLevel, addr 0x63b0038, size 0x8, virtual false, abstract: false, final false
