...
public:
  ...
  /// @brief Method get_lowFrequencyMotorSpeed addr 0x2ae6fa0 size 0x8 virtual false final false
  inline float_t get_lowFrequencyMotorSpeed();

  /// @brief Method set_lowFrequencyMotorSpeed addr 0x2ae6fa8 size 0x8 virtual false final false
  inline void set_lowFrequencyMotorSpeed(float_t value);

  /// @brief Method get_highFrequencyMotorSpeed addr 0x2ae6fb0 size 0x8 virtual false final false
  inline float_t get_highFrequencyMotorSpeed();

  /// @brief Method set_highFrequencyMotorSpeed addr 0x2ae6fb8 size 0x8 virtual false final false
  inline void set_highFrequencyMotorSpeed(float_t value);

  /// @brief Method get_isRumbling addr 0x2ae6fc0 size 0xb8 virtual false final false
  inline bool get_isRumbling();

  /// @brief Method PauseHaptics addr 0x2ae7078 size 0x110 virtual false final false
  inline void PauseHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResumeHaptics addr 0x2ae71d8 size 0x8c virtual false final false
  inline void ResumeHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResetHaptics addr 0x2ae73a8 size 0x90 virtual false final false
  inline void ResetHaptics(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method SetMotorSpeeds addr 0x2ae7264 size 0x144 virtual false final false
