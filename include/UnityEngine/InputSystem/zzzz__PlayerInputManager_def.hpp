...
public:
  ...
  /// @brief Method .ctor addr 0x2ac3dac size 0x48 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x2ac3e5c size 0x48 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_splitScreen addr 0x2ac3030 size 0x8 virtual false final false
  inline bool get_splitScreen();

  /// @brief Method set_splitScreen addr 0x2ac3038 size 0x260 virtual false final false
  inline void set_splitScreen(bool value);

  /// @brief Method get_maintainAspectRatioInSplitScreen addr 0x2ac38d8 size 0x8 virtual false final false
  inline bool get_maintainAspectRatioInSplitScreen();

  /// @brief Method get_fixedNumberOfSplitScreens addr 0x2ac38e0 size 0x8 virtual false final false
  inline int32_t get_fixedNumberOfSplitScreens();

  /// @brief Method get_splitScreenArea addr 0x2ac38e8 size 0xc virtual false final false
  inline ::UnityEngine::Rect get_splitScreenArea();

  /// @brief Method get_playerCount addr 0x2ac38f4 size 0x58 virtual false final false
  inline int32_t get_playerCount();

  /// @brief Method get_maxPlayerCount addr 0x2ac394c size 0x8 virtual false final false
  inline int32_t get_maxPlayerCount();

  /// @brief Method get_joiningEnabled addr 0x2ac3954 size 0x8 virtual false final false
  inline bool get_joiningEnabled();

  /// @brief Method get_joinBehavior addr 0x2ac395c size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::PlayerJoinBehavior get_joinBehavior();

  /// @brief Method set_joinBehavior addr 0x2ac3964 size 0x50 virtual false final false
  inline void set_joinBehavior(::UnityEngine::InputSystem::PlayerJoinBehavior value);

  /// @brief Method get_joinAction addr 0x2ac3c7c size 0x14 virtual false final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_joinAction();

  /// @brief Method set_joinAction addr 0x2ac3c90 size 0xa4 virtual false final false
  inline void set_joinAction(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method get_notificationBehavior addr 0x2ac3d34 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior();

  /// @brief Method set_notificationBehavior addr 0x2ac3d3c size 0x8 virtual false final false
  inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications value);

  /// @brief Method get_playerJoinedEvent addr 0x2ac3d44 size 0x68 virtual false final false
  inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerJoinedEvent* get_playerJoinedEvent();

  /// @brief Method get_playerLeftEvent addr 0x2ac3df4 size 0x68 virtual false final false
  inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerLeftEvent* get_playerLeftEvent();

  /// @brief Method add_onPlayerJoined addr 0x2ac3ea4 size 0xa0 virtual false final false
  inline void add_onPlayerJoined(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method remove_onPlayerJoined addr 0x2ac3f44 size 0xa0 virtual false final false
  inline void remove_onPlayerJoined(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method add_onPlayerLeft addr 0x2ac3fe4 size 0xa0 virtual false final false
  inline void add_onPlayerLeft(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method remove_onPlayerLeft addr 0x2ac4084 size 0xa0 virtual false final false
  inline void remove_onPlayerLeft(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>* value);

  /// @brief Method get_playerPrefab addr 0x2ac4124 size 0x8 virtual false final false
  inline ::UnityEngine::GameObject* get_playerPrefab();

  /// @brief Method set_playerPrefab addr 0x2ac412c size 0x8 virtual false final false
  inline void set_playerPrefab(::UnityEngine::GameObject* value);

  /// @brief Method get_instance addr 0x2ac4134 size 0x48 virtual false final false
  static inline ::UnityEngine::InputSystem::PlayerInputManager* get_instance();

  /// @brief Method set_instance addr 0x2ac417c size 0x4c virtual false final false
  static inline void set_instance(::UnityEngine::InputSystem::PlayerInputManager* value);

  /// @brief Method EnableJoining addr 0x2ac3a8c size 0x1f0 virtual false final false
  inline void EnableJoining();

  /// @brief Method DisableJoining addr 0x2ac39b4 size 0xd8 virtual false final false
  inline void DisableJoining();

  /// @brief Method JoinPlayerFromUI addr 0x2ac41cc size 0x54 virtual false final false
  inline void JoinPlayerFromUI();

  /// @brief Method JoinPlayerFromAction addr 0x2ac44f8 size 0x54 virtual false final false
  inline void JoinPlayerFromAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method JoinPlayerFromActionIfNotAlreadyJoined addr 0x2ac4608 size 0xe8 virtual false final false
  inline void JoinPlayerFromActionIfNotAlreadyJoined(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method JoinPlayer addr 0x2ac454c size 0xbc virtual false final false
  ...
  /// @brief Method JoinPlayer addr 0x2ac46f0 size 0xbc virtual false final false
  ...
  /// @brief Method get_messages addr 0x2ac47ac size 0xe4 virtual false final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> get_messages();

  /// @brief Method CheckIfPlayerCanJoin addr 0x2ac4220 size 0x2d8 virtual false final false
  inline bool CheckIfPlayerCanJoin(int32_t playerIndex);

  /// @brief Method OnUnpairedDeviceUsed addr 0x2ac4890 size 0xb4 virtual false final false
  ...
  /// @brief Method OnEnable addr 0x2ac4cc0 size 0x340 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2ac5000 size 0xdc virtual false final false
  inline void OnDisable();

  /// @brief Method UpdateSplitScreen addr 0x2ac3298 size 0x640 virtual false final false
  inline void UpdateSplitScreen();

  /// @brief Method IsDeviceUsableWithPlayerActions addr 0x2ac4944 size 0x37c virtual false final false
  inline bool IsDeviceUsableWithPlayerActions(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ValidateInputActionAsset addr 0x2ac41c8 size 0x4 virtual false final false
  inline void ValidateInputActionAsset();

  /// @brief Method NotifyPlayerJoined addr 0x2ac153c size 0x128 virtual false final false
  inline void NotifyPlayerJoined(::UnityEngine::InputSystem::PlayerInput* player);

  /// @brief Method NotifyPlayerLeft addr 0x2ac1ef4 size 0x128 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ac50dc size 0x60 virtual false final false
  inline void _ctor();
