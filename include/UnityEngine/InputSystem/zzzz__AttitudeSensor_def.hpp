...
/// @brief Method FinishSetup, addr 0x6423dac, size 0x70, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x6423ccc, size 0x50, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::AttitudeSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x6423d1c, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6423e1c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::AttitudeSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_attitude, addr 0x6423c20, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_attitude() ;

/// @brief Method get_current, addr 0x6423c30, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method set_attitude, addr 0x6423c28, size 0x8, virtual false, abstract: false, final false
inline void set_attitude(::UnityEngine::InputSystem::Controls::QuaternionControl*  value) ;

/// @brief Method set_current, addr 0x6423c7c, size 0x50, virtual false, abstract: false, final false
