...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::AttitudeSensor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::AttitudeSensor*, "UnityEngine.InputSystem", "AttitudeSensor");
...
public:
  ...
  /// @brief Method FinishSetup, addr 0x65609cc, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x65608ec, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::AttitudeSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x656093c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6560a3c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::AttitudeSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_attitude, addr 0x6560840, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_attitude();

  /// @brief Method get_current, addr 0x6560850, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attitude, addr 0x6560848, size 0x8, virtual false, abstract: false, final false
  inline void set_attitude(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_current, addr 0x656089c, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::AttitudeSensor) == 0x190, "Size mismatch!");
