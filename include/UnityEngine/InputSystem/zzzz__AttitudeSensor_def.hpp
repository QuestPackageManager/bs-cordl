...
// [InputControlLayout(stateType = typeof(UnityEngine.InputSystem.LowLevel.AttitudeState), displayName = "Attitude")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttitudeSensor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttitudeSensor(AttitudeSensor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttitudeSensor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttitudeSensor(AttitudeSensorconst&) = delete;
