...
public:
  ...
  /// @brief Method .ctor, addr 0x6510c8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_onAnyButtonPress>b__80_0, addr 0x6510c90, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method <get_onAnyButtonPress>b__80_1, addr 0x6510e08, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddDevice, addr 0x650d474, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x650d378, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x650d580, size 0xbc, virtual false, abstract: false, final false
  static inline void AddDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDeviceUsage, addr 0x650e368, size 0xa0, virtual false, abstract: false, final false
  static inline void AddDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method AddDeviceUsage, addr 0x650e408, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableActions, addr 0x650f9d8, size 0xc8, virtual false, abstract: false, final false
  static inline void DisableActions(bool triggerSetupChanged);

  /// @brief Method DisableAllEnabledActions, addr 0x6510380, size 0x54, virtual false, abstract: false, final false
  static inline void DisableAllEnabledActions();

  /// @brief Method DisableDevice, addr 0x650db60, size 0x84, virtual false, abstract: false, final false
  static inline void DisableDevice(::UnityEngine::InputSystem::InputDevice* device, bool keepSendingEvents);

  /// @brief Method EnableActions, addr 0x650f8a8, size 0xc4, virtual false, abstract: false, final false
  static inline void EnableActions();

  /// @brief Method EnableDevice, addr 0x650dae8, size 0x78, virtual false, abstract: false, final false
  static inline void EnableDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method EnsureInitialized, addr 0x650976c, size 0x4, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method FindControl, addr 0x650e5b8, size 0x170, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputControl* FindControl(::StringW path);

  /// @brief Method FindControls, addr 0x650e728, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushDisconnectedDevices, addr 0x650d6b0, size 0x68, virtual false, abstract: false, final false
  static inline void FlushDisconnectedDevices();

  /// @brief Method GetDevice, addr 0x650d718, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputDevice* GetDevice(::StringW nameOrLayout);

  /// @brief Method GetDevice, addr 0x650d788, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeviceById, addr 0x650d968, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputDevice* GetDeviceById(int32_t deviceId);

  /// @brief Method GetNameOfBaseLayout, addr 0x650c1f4, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW GetNameOfBaseLayout(::StringW layoutName);

  /// @brief Method GetUnsupportedDevices, addr 0x650d9d8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnsupportedDevices, addr 0x650da78, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeInPlayer, addr 0x6510990, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFirstLayoutBasedOnSecond, addr 0x650c31c, size 0x160, virtual false, abstract: false, final false
  static inline bool IsFirstLayoutBasedOnSecond(::StringW firstLayoutName, ::StringW secondLayoutName);

  /// @brief Method ListEnabledActions, addr 0x65103d4, size 0xa0, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::InputAction*>* ListEnabledActions();

  /// @brief Method ListEnabledActions, addr 0x6510474, size 0xa8, virtual false, abstract: false, final false
  static inline int32_t ListEnabledActions(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::InputAction*>* actions);

  /// @brief Method ListInteractions, addr 0x65100c8, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListInteractions();

  /// @brief Method ListLayouts, addr 0x650bfdc, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListLayouts();

  /// @brief Method ListLayoutsBasedOn, addr 0x650c048, size 0xc4, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListLayoutsBasedOn(::StringW baseLayout);

  /// @brief Method ListProcessors, addr 0x650c8e4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayout, addr 0x650c10c, size 0xe8, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* LoadLayout(::StringW name);

  /// @brief Method PauseHaptics, addr 0x650de94, size 0x140, virtual false, abstract: false, final false
  static inline void PauseHaptics();

  /// @brief Method PerformDefaultPluginInitialization, addr 0x6510bb4, size 0x30, virtual false, abstract: false, final false
  static inline void PerformDefaultPluginInitialization();

  /// @brief Method QueueConfigChangeEvent, addr 0x650eb1c, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x650ea50, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueTextEvent, addr 0x650ed68, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterBindingComposite, addr 0x6510140, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterInteraction, addr 0x650fe88, size 0x164, virtual false, abstract: false, final false
  static inline void RegisterInteraction(::System::Type* type, ::StringW name);

  /// @brief Method RegisterLayout, addr 0x650bb50, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayout, addr 0x650b9cc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutBuilder, addr 0x650bd5c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutMatcher, addr 0x650bcdc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterLayoutOverride, addr 0x650bc58, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProcessor, addr 0x650c47c, size 0x38c, virtual false, abstract: false, final false
  static inline void RegisterProcessor(::System::Type* type, ::StringW name);

  /// @brief Method RemoveDevice, addr 0x650d63c, size 0x74, virtual false, abstract: false, final false
  static inline void RemoveDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method RemoveDeviceUsage, addr 0x650e490, size 0xa0, virtual false, abstract: false, final false
  static inline void RemoveDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method RemoveDeviceUsage, addr 0x650e530, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveLayout, addr 0x650bee0, size 0x70, virtual false, abstract: false, final false
  static inline void RemoveLayout(::StringW name);

  /// @brief Method ResetDevice, addr 0x650dd34, size 0x84, virtual false, abstract: false, final false
  static inline void ResetDevice(::UnityEngine::InputSystem::InputDevice* device, bool alsoResetDontResetControls);

  /// @brief Method ResetHaptics, addr 0x650e118, size 0x144, virtual false, abstract: false, final false
  static inline void ResetHaptics();

  /// @brief Method ResumeHaptics, addr 0x650dfd4, size 0x144, virtual false, abstract: false, final false
  static inline void ResumeHaptics();

  /// @brief Method RunInitialUpdate, addr 0x6510be4, size 0x54, virtual false, abstract: false, final false
  static inline void RunInitialUpdate();

  /// @brief Method RunInitializeInPlayer, addr 0x6510b34, size 0x80, virtual false, abstract: false, final false
  static inline void RunInitializeInPlayer();

  /// @brief Method SetDeviceUsage, addr 0x650e25c, size 0x84, virtual false, abstract: false, final false
  static inline void SetDeviceUsage(::UnityEngine::InputSystem::InputDevice* device, ::StringW usage);

  /// @brief Method SetDeviceUsage, addr 0x650e2e0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindMatchingLayout, addr 0x650bf50, size 0x8c, virtual false, abstract: false, final false
  static inline ::StringW TryFindMatchingLayout(::UnityEngine::InputSystem::Layouts::InputDeviceDescription deviceDescription);

  /// @brief Method TryGetBindingComposite, addr 0x65102a4, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetBindingComposite(::StringW name);

  /// @brief Method TryGetInteraction, addr 0x650ffec, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetInteraction(::StringW name);

  /// @brief Method TryGetProcessor, addr 0x650c808, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Type* TryGetProcessor(::StringW name);

  /// @brief Method TryResetDevice, addr 0x650ddb8, size 0x54, virtual false, abstract: false, final false
  static inline bool TryResetDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method TrySyncDevice, addr 0x650dbe4, size 0xc8, virtual false, abstract: false, final false
  static inline bool TrySyncDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method Update, addr 0x650efbc, size 0x68, virtual false, abstract: false, final false
  static inline void Update();

  /// @brief Method Update, addr 0x650f024, size 0x154, virtual false, abstract: false, final false
  static inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method add_onActionChange, addr 0x650fcf0, size 0xcc, virtual false, abstract: false, final false
  static inline void add_onActionChange(::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* value);

  /// @brief Method add_onActionsChange, addr 0x650fc10, size 0x70, virtual false, abstract: false, final false
  static inline void add_onActionsChange(::System::Action* value);

  /// @brief Method add_onAfterUpdate, addr 0x650f430, size 0x128, virtual false, abstract: false, final false
  static inline void add_onAfterUpdate(::System::Action* value);

  /// @brief Method add_onBeforeUpdate, addr 0x650f1e0, size 0x128, virtual false, abstract: false, final false
  static inline void add_onBeforeUpdate(::System::Action* value);

  /// @brief Method add_onDeviceChange, addr 0x650ca78, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceCommand, addr 0x650cd60, size 0x174, virtual false, abstract: false, final false
  static inline void add_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method add_onFindLayoutForDevice, addr 0x650d048, size 0x128, virtual false, abstract: false, final false
  static inline void add_onFindLayoutForDevice(::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate* value);

  /// @brief Method add_onLayoutChange, addr 0x650b77c, size 0x128, virtual false, abstract: false, final false
  static inline void add_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method add_onSettingsChange, addr 0x650f7c8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x650f96c, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_actions();

  /// @brief Method get_devices, addr 0x650c95c, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_disconnectedDevices, addr 0x650c9f4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isProcessingEvents, addr 0x650e7c0, size 0x68, virtual false, abstract: false, final false
  static inline bool get_isProcessingEvents();

  /// @brief Method get_metrics, addr 0x6510870, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputMetrics get_metrics();

  /// @brief Method get_onAnyButtonPress, addr 0x650e834, size 0x21c, virtual false, abstract: false, final false
  static inline ::System::IObservable_1<::UnityEngine::InputSystem::InputControl*>* get_onAnyButtonPress();

  /// @brief Method get_onEvent, addr 0x650e828, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputEventListener get_onEvent();

  /// @brief Method get_pollingFrequency, addr 0x650d298, size 0x68, virtual false, abstract: false, final false
  static inline float_t get_pollingFrequency();

  /// @brief Method get_remoting, addr 0x651051c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::InputRemoting* get_remoting();

  /// @brief Method get_runInBackground, addr 0x65105ec, size 0xdc, virtual false, abstract: false, final false
  static inline bool get_runInBackground();

  /// @brief Method get_scrollWheelDeltaPerTick, addr 0x65107ac, size 0xc4, virtual false, abstract: false, final false
  static inline float_t get_scrollWheelDeltaPerTick();

  /// @brief Method get_settings, addr 0x650f178, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::InputSettings> get_settings();

  /// @brief Method get_version, addr 0x6510578, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Version* get_version();

  /// @brief Method remove_onActionChange, addr 0x650fdbc, size 0xcc, virtual false, abstract: false, final false
  static inline void remove_onActionChange(::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* value);

  /// @brief Method remove_onActionsChange, addr 0x650fc80, size 0x70, virtual false, abstract: false, final false
  static inline void remove_onActionsChange(::System::Action* value);

  /// @brief Method remove_onAfterUpdate, addr 0x650f558, size 0x128, virtual false, abstract: false, final false
  static inline void remove_onAfterUpdate(::System::Action* value);

  /// @brief Method remove_onBeforeUpdate, addr 0x650f308, size 0x128, virtual false, abstract: false, final false
  static inline void remove_onBeforeUpdate(::System::Action* value);

  /// @brief Method remove_onDeviceChange, addr 0x650cbec, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceCommand, addr 0x650ced4, size 0x174, virtual false, abstract: false, final false
  static inline void remove_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method remove_onFindLayoutForDevice, addr 0x650d170, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onLayoutChange, addr 0x650b8a4, size 0x128, virtual false, abstract: false, final false
  static inline void remove_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method remove_onSettingsChange, addr 0x650f838, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actions, addr 0x650faa0, size 0x170, virtual false, abstract: false, final false
  static inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method set_onEvent, addr 0x650e830, size 0x4, virtual false, abstract: false, final false
  static inline void set_onEvent(::UnityEngine::InputSystem::LowLevel::InputEventListener value);

  /// @brief Method set_pollingFrequency, addr 0x650d300, size 0x78, virtual false, abstract: false, final false
  static inline void set_pollingFrequency(float_t value);

  /// @brief Method set_runInBackground, addr 0x65106c8, size 0xe4, virtual false, abstract: false, final false
  static inline void set_runInBackground(bool value);

  /// @brief Method set_settings, addr 0x650f680, size 0x148, virtual false, abstract: false, final false
