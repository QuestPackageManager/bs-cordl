...
public:
  ...
  /// @brief Method get_atmosphericPressure, addr 0x2aaa524, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_atmosphericPressure();

  /// @brief Method set_atmosphericPressure, addr 0x2aaa52c, size 0x8, virtual false, abstract: false, final false
  inline void set_atmosphericPressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method get_current, addr 0x2aaa534, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::PressureSensor* get_current();

  /// @brief Method set_current, addr 0x2aaa57c, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::PressureSensor* value);

  /// @brief Method MakeCurrent, addr 0x2aaa5c8, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  /// @brief Method OnRemoved, addr 0x2aaa61c, size 0x84, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method FinishSetup, addr 0x2aaa6a0, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::PressureSensor* New_ctor();

  /// @brief Method .ctor, addr 0x2aaa718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
