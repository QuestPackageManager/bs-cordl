...
public:
  ...
  __declspec(property(get = __get__atmosphericPressure_k__BackingField,
                      put = __set__atmosphericPressure_k__BackingField))::UnityEngine::InputSystem::Controls::AxisControl* _atmosphericPressure_k__BackingField;
  ...
  constexpr ::UnityEngine::InputSystem::Controls::AxisControl*& __get__atmosphericPressure_k__BackingField();

  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> const& __get__atmosphericPressure_k__BackingField() const;
