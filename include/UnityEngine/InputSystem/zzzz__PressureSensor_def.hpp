...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::PressureSensor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::PressureSensor*, "UnityEngine.InputSystem", "PressureSensor");
...
public:
  // Declarations
  /// @brief Field <atmosphericPressure>k__BackingField, offset 0x188, size 0x8
  ...
  /// @brief [InputControl(displayName = "Atmospheric Pressure", noisy = true)]
  ...
  /// @brief Method FinishSetup, addr 0x6566a54, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x6566974, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::PressureSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x65669c4, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6566ac4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::PressureSensor* getStaticF__current_k__BackingField();

  /// [CompilerGenerated]
  /// @brief Method get_atmosphericPressure, addr 0x65668c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_atmosphericPressure();

  /// [CompilerGenerated]
  /// @brief Method get_current, addr 0x65668d8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// [CompilerGenerated]
  /// @brief Method set_atmosphericPressure, addr 0x65668d0, size 0x8, virtual false, abstract: false, final false
  inline void set_atmosphericPressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// [CompilerGenerated]
  /// @brief Method set_current, addr 0x6566924, size 0x50, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PressureSensor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PressureSensor(PressureSensor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PressureSensor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PressureSensor(PressureSensorconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 8766 };

  /// [CompilerGenerated]
  /// @brief Field <atmosphericPressure>k__BackingField, offset: 0x188, size: 0x8, def value: None
  ::UnityEngine::InputSystem::Controls::AxisControl* ____atmosphericPressure_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::InputSystem::PressureSensor, ____atmosphericPressure_k__BackingField) == 0x188, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputSystem::PressureSensor) == 0x190, "Size mismatch!");
