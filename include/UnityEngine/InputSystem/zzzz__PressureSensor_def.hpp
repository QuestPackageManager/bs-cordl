...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6422aa4, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x64229c4, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::PressureSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x6422a14, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6422b14, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::PressureSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_atmosphericPressure, addr 0x6422918, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_atmosphericPressure();

  /// @brief Method get_current, addr 0x6422928, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atmosphericPressure, addr 0x6422920, size 0x8, virtual false, abstract: false, final false
  inline void set_atmosphericPressure(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_current, addr 0x6422974, size 0x50, virtual false, abstract: false, final false
