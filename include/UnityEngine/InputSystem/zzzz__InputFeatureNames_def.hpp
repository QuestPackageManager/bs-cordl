...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::InputFeatureNames*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputFeatureNames*, "UnityEngine.InputSystem", "InputFeatureNames");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InputFeatureNames", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InputFeatureNames(InputFeatureNames&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InputFeatureNames", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InputFeatureNames(InputFeatureNamesconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::InputFeatureNames) == 0x10, "Size mismatch!");
