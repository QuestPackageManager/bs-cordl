...
public:
  ...
  /// @brief Method WithButton, addr 0x3158168, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x3158138, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x315819c, size 0x30, virtual true, abstract: false, final true
