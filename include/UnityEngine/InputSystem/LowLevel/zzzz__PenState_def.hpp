...
public:
  ...
  /// @brief Method WithButton, addr 0x2bcf6f8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x2bcf6c8, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x2bcf72c, size 0x30, virtual true, abstract: false, final true
