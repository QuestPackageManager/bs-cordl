...
public:
  ...
  // Ctor Parameters [CppParam { name: "position", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None, comment: None }, CppParam { name: "delta", ty: "::UnityEngine::Vector2", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "tilt", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None, comment: None }, CppParam { name: "pressure", ty: "float_t", modifiers:
  // "", def_value: None, comment: None }, CppParam { name: "twist", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "buttons", ty: "uint16_t", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "displayIndex", ty: "uint16_t", modifiers: "", def_value: None, comment: None }]
