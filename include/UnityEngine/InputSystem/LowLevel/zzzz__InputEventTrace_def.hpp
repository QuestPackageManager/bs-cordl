...
/// @brief Method Dispose, addr 0x63fdf84, size 0xc, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x63fdf90, size 0xc4, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x63fe054, size 0x20, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63fe07c, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x63fd7bc, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputEventTrace*  trace) ;

/// @brief Method get_Current, addr 0x63fe074, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method <PlayAllEventsAccordingToTimestamps>b__38_0, addr 0x63ff79c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63ff798, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <ApplyDeviceMapping>b__0, addr 0x63ff8a4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63ff740, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyDeviceMapping, addr 0x63ff354, size 0x3ec, virtual false, abstract: false, final false
inline int32_t ApplyDeviceMapping(int32_t  originalDeviceId) ;

/// @brief Method Dispose, addr 0x63fe17c, size 0x2f4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finished, addr 0x63ff280, size 0xd4, virtual false, abstract: false, final false
inline void Finished() ;

/// @brief Method MoveNext, addr 0x63fe6f8, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method OnBeginFrame, addr 0x63ff0a8, size 0x1d8, virtual false, abstract: false, final false
inline void OnBeginFrame() ;

/// @brief Method OnEvent, addr 0x63fe66c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnFinished, addr 0x63fe664, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* OnFinished(::System::Action*  action) ;

/// @brief Method PlayAllEvents, addr 0x63fed24, size 0xa4, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* PlayAllEvents() ;

/// @brief Method PlayAllEventsAccordingToTimestamps, addr 0x63fedc8, size 0x2e0, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* PlayAllEventsAccordingToTimestamps() ;

/// @brief Method PlayAllFramesOneByOne, addr 0x63fec70, size 0xb4, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* PlayAllFramesOneByOne() ;

/// @brief Method PlayOneEvent, addr 0x63fe674, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* PlayOneEvent() ;

/// @brief Method QueueEvent, addr 0x63fea14, size 0x244, virtual false, abstract: false, final false
inline void QueueEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr) ;

/// @brief Method Rewind, addr 0x63fec58, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* Rewind() ;

/// @brief Method WithAllDevicesMappedToNewInstances, addr 0x63fe658, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* WithAllDevicesMappedToNewInstances() ;

/// @brief Method WithDeviceMappedFromTo, addr 0x63fe470, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method WithDeviceMappedFromTo, addr 0x63fe4f4, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63fd208, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputEventTrace*  trace) ;

/// @brief Method get_createdDevices, addr 0x63fe114, size 0x68, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::InputDevice*>* get_createdDevices() ;

/// @brief Method get_finished, addr 0x63fe0e4, size 0x8, virtual false, abstract: false, final false
inline bool get_finished() ;

/// @brief Method get_paused, addr 0x63fe0f4, size 0x8, virtual false, abstract: false, final false
inline bool get_paused() ;

/// @brief Method get_position, addr 0x63fe104, size 0x8, virtual false, abstract: false, final false
inline int32_t get_position() ;

/// @brief Method get_trace, addr 0x63fe0dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace* get_trace() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_finished, addr 0x63fe0ec, size 0x8, virtual false, abstract: false, final false
inline void set_finished(bool  value) ;

/// @brief Method set_paused, addr 0x63fe0fc, size 0x8, virtual false, abstract: false, final false
inline void set_paused(bool  value) ;

/// @brief Method set_position, addr 0x63fe10c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_deviceId, addr 0x63ff8b8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_deviceId() ;

/// @brief Method get_layout, addr 0x63ff8c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_layout() ;

/// @brief Method get_stateFormat, addr 0x63ff8d8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_stateFormat() ;

/// @brief Method get_stateSizeInBytes, addr 0x63ff8e8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_stateSizeInBytes() ;

/// @brief Method set_deviceId, addr 0x63ff8c0, size 0x8, virtual false, abstract: false, final false
inline void set_deviceId(int32_t  value) ;

/// @brief Method set_layout, addr 0x63ff8d0, size 0x8, virtual false, abstract: false, final false
inline void set_layout(::StringW  value) ;

/// @brief Method set_stateFormat, addr 0x63ff8e0, size 0x8, virtual false, abstract: false, final false
inline void set_stateFormat(::UnityEngine::InputSystem::Utilities::FourCC  value) ;

/// @brief Method set_stateSizeInBytes, addr 0x63ff8f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_DeviceInfos, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DeviceInfos, put=__cordl_internal_set_m_DeviceInfos)) ::ArrayW<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo,::Array<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo>*>  m_DeviceInfos;
...
/// @brief Method Allocate, addr 0x63fd764, size 0x50, virtual false, abstract: false, final false
inline void Allocate() ;

/// @brief Method Clear, addr 0x63fd570, size 0x1c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Disable, addr 0x63fd094, size 0x174, virtual false, abstract: false, final false
inline void Disable() ;

/// @brief Method Dispose, addr 0x63fd7dc, size 0x18, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Enable, addr 0x63fd58c, size 0x1d8, virtual false, abstract: false, final false
inline void Enable() ;

/// @brief Method GetEnumerator, addr 0x63fc468, size 0x60, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* GetEnumerator() ;

/// @brief Method GetNextEvent, addr 0x63fd4f8, size 0x78, virtual false, abstract: false, final false
inline bool GetNextEvent(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventPtr>  current) ;

/// @brief Method LoadFrom, addr 0x63fcd70, size 0x1b0, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace* LoadFrom(::StringW  filePath) ;

/// @brief Method LoadFrom, addr 0x63fcf20, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method OnBeforeUpdate, addr 0x63fd85c, size 0x178, virtual false, abstract: false, final false
inline void OnBeforeUpdate() ;

/// @brief Method OnInputEvent, addr 0x63fd9d4, size 0x52c, virtual false, abstract: false, final false
...
/// @brief Method ReadFrom, addr 0x63fc4c8, size 0x180, virtual false, abstract: false, final false
inline void ReadFrom(::StringW  filePath) ;

/// @brief Method ReadFrom, addr 0x63fc648, size 0x710, virtual false, abstract: false, final false
inline void ReadFrom(::System::IO::Stream*  stream) ;

/// @brief Method Release, addr 0x63fd7f4, size 0x68, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method Replay, addr 0x63fd030, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventTrace_ReplayController* Replay() ;

/// @brief Method Resize, addr 0x63fd260, size 0x290, virtual false, abstract: false, final false
inline bool Resize(int64_t  newBufferSize, int64_t  newMaxBufferSize) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63fd7d8, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method WriteTo, addr 0x63fbc00, size 0x180, virtual false, abstract: false, final false
inline void WriteTo(::StringW  filePath) ;

/// @brief Method WriteTo, addr 0x63fbd80, size 0x6dc, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo,::Array<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo>*> const& __cordl_internal_get_m_DeviceInfos() const;

constexpr ::ArrayW<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo,::Array<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo>*>& __cordl_internal_get_m_DeviceInfos() ;
...
constexpr void __cordl_internal_set_m_DeviceInfos(::ArrayW<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo,::Array<::UnityEngine::InputSystem::LowLevel::InputEventTrace_DeviceInfo>*>  value) ;
...
/// @brief Method .ctor, addr 0x63fbbc4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63fbb2c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method add_onEvent, addr 0x63fba74, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_FrameMarkerEvent, addr 0x63fb878, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_FrameMarkerEvent() ;

/// @brief Method get_allocatedSizeInBytes, addr 0x63fb9f0, size 0x18, virtual false, abstract: false, final false
inline int64_t get_allocatedSizeInBytes() ;

/// @brief Method get_deviceId, addr 0x63fb884, size 0x8, virtual false, abstract: false, final false
inline int32_t get_deviceId() ;

/// @brief Method get_deviceInfos, addr 0x63fba18, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_enabled, addr 0x63fb894, size 0x8, virtual false, abstract: false, final false
inline bool get_enabled() ;

/// @brief Method get_eventCount, addr 0x63fb9e0, size 0x8, virtual false, abstract: false, final false
inline int64_t get_eventCount() ;

/// @brief Method get_kFileFormat, addr 0x63fc45c, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_kFileFormat() ;

/// @brief Method get_m_EventBuffer, addr 0x63fba08, size 0x8, virtual false, abstract: false, final false
inline uint8_t* get_m_EventBuffer() ;

/// @brief Method get_m_EventBufferHead, addr 0x63fd4f0, size 0x8, virtual false, abstract: false, final false
inline uint8_t* get_m_EventBufferHead() ;

/// @brief Method get_m_EventBufferTail, addr 0x63fd7b4, size 0x8, virtual false, abstract: false, final false
inline uint8_t* get_m_EventBufferTail() ;

/// @brief Method get_maxSizeInBytes, addr 0x63fba10, size 0x8, virtual false, abstract: false, final false
inline int64_t get_maxSizeInBytes() ;

/// @brief Method get_onFilterEvent, addr 0x63fba64, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_recordFrameMarkers, addr 0x63fb89c, size 0x8, virtual false, abstract: false, final false
inline bool get_recordFrameMarkers() ;

/// @brief Method get_totalEventSizeInBytes, addr 0x63fb9e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_onEvent, addr 0x63fbad0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method set_deviceId, addr 0x63fb88c, size 0x8, virtual false, abstract: false, final false
inline void set_deviceId(int32_t  value) ;

/// @brief Method set_m_EventBuffer, addr 0x63fcd58, size 0x8, virtual false, abstract: false, final false
inline void set_m_EventBuffer(uint8_t*  value) ;

/// @brief Method set_m_EventBufferHead, addr 0x63fcd60, size 0x8, virtual false, abstract: false, final false
inline void set_m_EventBufferHead(uint8_t*  value) ;

/// @brief Method set_m_EventBufferTail, addr 0x63fcd68, size 0x8, virtual false, abstract: false, final false
inline void set_m_EventBufferTail(uint8_t*  value) ;

/// @brief Method set_onFilterEvent, addr 0x63fba6c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_recordFrameMarkers, addr 0x63fb8a4, size 0x13c, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::ReplayController_InputEventTrace___c__DisplayClass43_0*, "UnityEngine.InputSystem.LowLevel", "InputEventTrace/ReplayController/<>c__DisplayClass43_0");
