...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand, "UnityEngine.InputSystem.LowLevel", "InputDeviceCommand");
...
public:
  // Declarations
  __declspec(property(get = get_payloadPtr)) void* payloadPtr;
  ...
  /// @brief Method AllocateNative, addr 0x65adab4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65ad714, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes);

  /// @brief Method get_payloadPtr, addr 0x65adaac, size 0x8, virtual false, abstract: false, final false
  inline void* get_payloadPtr();

  /// @brief Method get_payloadSizeInBytes, addr 0x65adaa0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_payloadSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x65adb50, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand) == 0x8, "Size mismatch!");
