...
public:
  ...
  /// @brief Method AllocateNative, addr 0x6469958, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64695b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes);

  /// @brief Method get_payloadPtr, addr 0x6469950, size 0x8, virtual false, abstract: false, final false
  inline void* get_payloadPtr();

  /// @brief Method get_payloadSizeInBytes, addr 0x6469944, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_payloadSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x64699f4, size 0x8, virtual true, abstract: false, final true
