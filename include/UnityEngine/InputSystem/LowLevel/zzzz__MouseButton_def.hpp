...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::MouseButton, "UnityEngine.InputSystem.LowLevel", "MouseButton");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
public:
  ...
  /// @brief Field Forward value: I32(3)
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::MouseButton) == 0x4, "Size mismatch!");
