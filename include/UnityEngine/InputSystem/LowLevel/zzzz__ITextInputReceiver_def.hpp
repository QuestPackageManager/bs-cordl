...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::ITextInputReceiver*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::ITextInputReceiver*, "UnityEngine.InputSystem.LowLevel", "ITextInputReceiver");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ITextInputReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ITextInputReceiver(ITextInputReceiverconst&) = delete;
