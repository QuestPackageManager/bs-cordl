...
public:
  ...
  /// @brief Method get_format, addr 0x646a090, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x646a084, size 0xc, virtual false, abstract: false, final false
