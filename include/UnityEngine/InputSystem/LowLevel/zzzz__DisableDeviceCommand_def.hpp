...
public:
  ...
  /// @brief Method Create, addr 0x4605ef0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x4605e90, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x4605ec0, size 0x30, virtual true, abstract: false, final true
