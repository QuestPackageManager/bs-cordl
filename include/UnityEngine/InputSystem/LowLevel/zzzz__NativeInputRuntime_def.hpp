...
/// @brief Method .ctor, addr 0x640081c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onBeforeUpdate>b__0, addr 0x64012bc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6400960, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onShouldRunUpdate>b__0, addr 0x64012dc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x64006d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onUpdate>b__0, addr 0x64012fc, size 0x208, virtual false, abstract: false, final false
...
/// @brief Field m_OnBeforeUpdate, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnBeforeUpdate, put=__cordl_internal_set_m_OnBeforeUpdate)) ::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>*  m_OnBeforeUpdate;

/// @brief Field m_OnShouldRunUpdate, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnShouldRunUpdate, put=__cordl_internal_set_m_OnShouldRunUpdate)) ::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType,bool>*  m_OnShouldRunUpdate;
...
/// @brief Method AllocateDeviceId, addr 0x640035c, size 0x6c, virtual true, abstract: false, final true
inline int32_t AllocateDeviceId() ;

/// @brief Method DeviceCommand, addr 0x64004b8, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method OnFocusChanged, addr 0x6400fe8, size 0x24, virtual false, abstract: false, final false
inline void OnFocusChanged(bool  focus) ;

/// @brief Method OnShutdown, addr 0x6400f88, size 0x20, virtual false, abstract: false, final false
inline void OnShutdown() ;

/// @brief Method OnWantsToShutdown, addr 0x6400fa8, size 0x40, virtual false, abstract: false, final false
inline bool OnWantsToShutdown() ;

/// @brief Method QueueEvent, addr 0x6400440, size 0x78, virtual true, abstract: false, final true
inline void QueueEvent(::UnityEngine::InputSystem::LowLevel::InputEvent*  ptr) ;

/// @brief Method Update, addr 0x64003c8, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6401254, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::LowLevel::NativeInputRuntime* getStaticF_instance() ;

/// @brief Method get_currentTime, addr 0x6400db0, size 0x6c, virtual true, abstract: false, final true
inline double_t get_currentTime() ;

/// @brief Method get_currentTimeForFixedUpdate, addr 0x6400e1c, size 0x44, virtual true, abstract: false, final true
inline double_t get_currentTimeForFixedUpdate() ;

/// @brief Method get_currentTimeOffsetToRealtimeSinceStartup, addr 0x6400e60, size 0x6c, virtual true, abstract: false, final true
inline double_t get_currentTimeOffsetToRealtimeSinceStartup() ;

/// @brief Method get_isInBatchMode, addr 0x64011e8, size 0x6c, virtual true, abstract: false, final true
inline bool get_isInBatchMode() ;

/// @brief Method get_isPlayerFocused, addr 0x6400cb8, size 0x6c, virtual true, abstract: false, final true
inline bool get_isPlayerFocused() ;

/// @brief Method get_normalizeScrollWheelDelta, addr 0x6401098, size 0x6c, virtual true, abstract: false, final true
inline bool get_normalizeScrollWheelDelta() ;

/// @brief Method get_onBeforeUpdate, addr 0x64006dc, size 0x8, virtual true, abstract: false, final true
inline ::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* get_onBeforeUpdate() ;

/// @brief Method get_onDeviceDiscovered, addr 0x6400964, size 0x54, virtual true, abstract: false, final true
inline ::System::Action_2<int32_t,::StringW>* get_onDeviceDiscovered() ;

/// @brief Method get_onPlayerFocusChanged, addr 0x6400b64, size 0x8, virtual true, abstract: false, final true
inline ::System::Action_1<bool>* get_onPlayerFocusChanged() ;

/// @brief Method get_onShouldRunUpdate, addr 0x6400820, size 0x8, virtual true, abstract: false, final true
inline ::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType,bool>* get_onShouldRunUpdate() ;

/// @brief Method get_onShutdown, addr 0x6400a14, size 0x8, virtual true, abstract: false, final true
inline ::System::Action* get_onShutdown() ;

/// @brief Method get_onUpdate, addr 0x6400598, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* get_onUpdate() ;

/// @brief Method get_pollingFrequency, addr 0x6400d24, size 0x8, virtual true, abstract: false, final true
inline float_t get_pollingFrequency() ;

/// @brief Method get_runInBackground, addr 0x6400ef4, size 0x8c, virtual true, abstract: false, final true
inline bool get_runInBackground() ;

/// @brief Method get_screenOrientation, addr 0x6401070, size 0x28, virtual true, abstract: false, final true
inline ::UnityEngine::ScreenOrientation get_screenOrientation() ;

/// @brief Method get_screenSize, addr 0x640100c, size 0x64, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 get_screenSize() ;

/// @brief Method get_scrollWheelDeltaPerTick, addr 0x640117c, size 0x6c, virtual true, abstract: false, final true
inline float_t get_scrollWheelDeltaPerTick() ;

/// @brief Method get_unscaledGameTime, addr 0x6400ecc, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method set_normalizeScrollWheelDelta, addr 0x6401104, size 0x78, virtual true, abstract: false, final true
inline void set_normalizeScrollWheelDelta(bool  value) ;

/// @brief Method set_onBeforeUpdate, addr 0x64006e4, size 0x138, virtual true, abstract: false, final true
inline void set_onBeforeUpdate(::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>*  value) ;

/// @brief Method set_onDeviceDiscovered, addr 0x64009b8, size 0x5c, virtual true, abstract: false, final true
inline void set_onDeviceDiscovered(::System::Action_2<int32_t,::StringW>*  value) ;

/// @brief Method set_onPlayerFocusChanged, addr 0x6400b6c, size 0x14c, virtual true, abstract: false, final true
inline void set_onPlayerFocusChanged(::System::Action_1<bool>*  value) ;

/// @brief Method set_onShouldRunUpdate, addr 0x6400828, size 0x138, virtual true, abstract: false, final true
inline void set_onShouldRunUpdate(::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType,bool>*  value) ;

/// @brief Method set_onShutdown, addr 0x6400a1c, size 0x148, virtual true, abstract: false, final true
inline void set_onShutdown(::System::Action*  value) ;

/// @brief Method set_onUpdate, addr 0x64005a0, size 0x138, virtual true, abstract: false, final true
inline void set_onUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate*  value) ;

/// @brief Method set_pollingFrequency, addr 0x6400d2c, size 0x84, virtual true, abstract: false, final true
inline void set_pollingFrequency(float_t  value) ;

/// @brief Method set_runInBackground, addr 0x6400f80, size 0x8, virtual true, abstract: false, final true
