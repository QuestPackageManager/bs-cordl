...
public:
  ...
  /// @brief Method .ctor addr 0x2af122c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <set_onUpdate>b__0 addr 0x2af1968 size 0x1e8 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2af134c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <set_onBeforeUpdate>b__0 addr 0x2af1b50 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2af146c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <set_onShouldRunUpdate>b__0 addr 0x2af1b74 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method AllocateDeviceId addr 0x2af0f34 size 0x50 virtual true final true
  inline int32_t AllocateDeviceId();

  /// @brief Method Update addr 0x2af0f84 size 0x58 virtual true final true
  inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method QueueEvent addr 0x2af0fdc size 0x6c virtual true final true
  inline void QueueEvent(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> ptr);

  /// @brief Method DeviceCommand addr 0x2af1048 size 0xcc virtual true final true
  ...
  /// @brief Method get_onUpdate addr 0x2af1114 size 0x8 virtual true final true
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* get_onUpdate();

  /// @brief Method set_onUpdate addr 0x2af111c size 0x110 virtual true final true
  inline void set_onUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* value);

  /// @brief Method get_onBeforeUpdate addr 0x2af1234 size 0x8 virtual true final true
  inline ::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* get_onBeforeUpdate();

  /// @brief Method set_onBeforeUpdate addr 0x2af123c size 0x110 virtual true final true
  inline void set_onBeforeUpdate(::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* value);

  /// @brief Method get_onShouldRunUpdate addr 0x2af1354 size 0x8 virtual true final true
  inline ::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType, bool>* get_onShouldRunUpdate();

  /// @brief Method set_onShouldRunUpdate addr 0x2af135c size 0x110 virtual true final true
  inline void set_onShouldRunUpdate(::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType, bool>* value);

  /// @brief Method get_onDeviceDiscovered addr 0x2af1474 size 0x50 virtual true final true
  inline ::System::Action_2<int32_t, ::StringW>* get_onDeviceDiscovered();

  /// @brief Method set_onDeviceDiscovered addr 0x2af14c4 size 0x58 virtual true final true
  inline void set_onDeviceDiscovered(::System::Action_2<int32_t, ::StringW>* value);

  /// @brief Method get_onShutdown addr 0x2af151c size 0x8 virtual true final true
  inline ::System::Action* get_onShutdown();

  /// @brief Method set_onShutdown addr 0x2af1524 size 0xd0 virtual true final true
  inline void set_onShutdown(::System::Action* value);

  /// @brief Method get_onPlayerFocusChanged addr 0x2af15f4 size 0x8 virtual true final true
  inline ::System::Action_1<bool>* get_onPlayerFocusChanged();

  /// @brief Method set_onPlayerFocusChanged addr 0x2af15fc size 0xd0 virtual true final true
  inline void set_onPlayerFocusChanged(::System::Action_1<bool>* value);

  /// @brief Method get_isPlayerFocused addr 0x2af16cc size 0x8 virtual true final true
  inline bool get_isPlayerFocused();

  /// @brief Method get_pollingFrequency addr 0x2af16d4 size 0x8 virtual true final true
  inline float_t get_pollingFrequency();

  /// @brief Method set_pollingFrequency addr 0x2af16dc size 0x68 virtual true final true
  inline void set_pollingFrequency(float_t value);

  /// @brief Method get_currentTime addr 0x2af1744 size 0x50 virtual true final true
  inline double_t get_currentTime();

  /// @brief Method get_currentTimeForFixedUpdate addr 0x2af1794 size 0x2c virtual true final true
  inline double_t get_currentTimeForFixedUpdate();

  /// @brief Method get_currentTimeOffsetToRealtimeSinceStartup addr 0x2af17c0 size 0x50 virtual true final true
  inline double_t get_currentTimeOffsetToRealtimeSinceStartup();

  /// @brief Method get_unscaledGameTime addr 0x2af1810 size 0x8 virtual true final true
  inline float_t get_unscaledGameTime();

  /// @brief Method get_runInBackground addr 0x2af1818 size 0x8 virtual true final true
  inline bool get_runInBackground();

  /// @brief Method OnShutdown addr 0x2af1820 size 0x24 virtual false final false
  inline void OnShutdown();

  /// @brief Method OnWantsToShutdown addr 0x2af1844 size 0x40 virtual false final false
  inline bool OnWantsToShutdown();

  /// @brief Method OnFocusChanged addr 0x2af1884 size 0x28 virtual false final false
  inline void OnFocusChanged(bool focus);

  /// @brief Method get_screenSize addr 0x2af18ac size 0x28 virtual true final true
  inline ::UnityEngine::Vector2 get_screenSize();

  /// @brief Method get_screenOrientation addr 0x2af18d4 size 0x8 virtual true final true
  inline ::UnityEngine::ScreenOrientation get_screenOrientation();

  /// @brief Method get_isInBatchMode addr 0x2af18dc size 0x8 virtual true final true
  inline bool get_isInBatchMode();

  /// @brief Method RegisterAnalyticsEvent addr 0x2af18e4 size 0x4 virtual false final false
  inline void RegisterAnalyticsEvent(::StringW name, int32_t maxPerHour, int32_t maxPropertiesPerEvent);

  /// @brief Method SendAnalyticsEvent addr 0x2af18e8 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2af18ec size 0x10 virtual false final false
  inline void _ctor();
