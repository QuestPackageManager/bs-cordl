...
public:
  ...
  /// @brief Method WithButton, addr 0x2c2fc34, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c2fb80, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x2c2fb20, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x2c2fb50, size 0x30, virtual true, abstract: false, final true
