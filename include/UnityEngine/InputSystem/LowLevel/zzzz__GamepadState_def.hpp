...
public:
  ...
  /// @brief Method WithButton, addr 0x646a038, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6469f88, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x6469f70, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x6469f7c, size 0xc, virtual true, abstract: false, final true
