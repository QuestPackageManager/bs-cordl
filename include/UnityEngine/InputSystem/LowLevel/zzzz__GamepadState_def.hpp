...
public:
  ...
  /// @brief Method WithButton, addr 0x63f796c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63f78bc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x63f78a4, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x63f78b0, size 0xc, virtual true, abstract: false, final true
