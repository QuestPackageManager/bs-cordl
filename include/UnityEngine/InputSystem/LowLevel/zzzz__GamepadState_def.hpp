...
public:
  ...
  /// @brief Method WithButton, addr 0x317b948, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x317b894, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Format, addr 0x317b834, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x317b864, size 0x30, virtual true, abstract: false, final true
