...
public:
  ...
  /// @brief Method Create, addr 0x460a088, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460a07c, size 0xc, virtual true, abstract: false, final true
