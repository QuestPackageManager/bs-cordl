...
public:
  ...
  /// @brief Method Create, addr 0x2c31108, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x2c310e8, size 0x20, virtual true, abstract: false, final true
