...
public:
  ...
  /// @brief Method Create, addr 0x646b184, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x646b178, size 0xc, virtual true, abstract: false, final true
