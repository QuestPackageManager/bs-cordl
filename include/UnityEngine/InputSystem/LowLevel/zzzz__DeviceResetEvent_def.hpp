...
public:
  ...
  /// @brief Method Create, addr 0x63f8ab8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x63f8aac, size 0xc, virtual true, abstract: false, final true
