...
public:
  ...
  /// @brief Method Create, addr 0x460b8ac, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460b8a0, size 0xc, virtual true, abstract: false, final true
