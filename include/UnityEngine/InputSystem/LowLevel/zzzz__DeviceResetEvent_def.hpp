...
public:
  ...
  /// @brief Method Create, addr 0x4608648, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460863c, size 0xc, virtual true, abstract: false, final true
