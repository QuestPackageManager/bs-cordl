...
public:
  ...
  /// @brief Method Create, addr 0x65af2e0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65af2d4, size 0xc, virtual true, abstract: false, final true
