...
public:
  ...
  /// @brief Method Create, addr 0x65a9ac8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a9abc, size 0xc, virtual true, abstract: false, final true
