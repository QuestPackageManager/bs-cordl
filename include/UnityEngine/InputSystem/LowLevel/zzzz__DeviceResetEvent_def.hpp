...
/// @brief Method Create, addr 0x63f9178, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x63f916c, size 0xc, virtual true, abstract: false, final true
