...
public:
  ...
  /// @brief Method Create, addr 0x460e504, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460e4f8, size 0xc, virtual true, abstract: false, final true
