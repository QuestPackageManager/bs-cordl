...
/// @brief Method From, addr 0x63ff910, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x63ff918, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x63fafa4, size 0x130, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::StateEvent* From(::UnityEngine::InputSystem::LowLevel::InputEventPtr  ptr) ;

/// @brief Method FromDefaultStateFor, addr 0x63ffc68, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method FromUnchecked, addr 0x63fadc4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ToEventPtr, addr 0x63ff900, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_state, addr 0x63ff8f8, size 0x8, virtual false, abstract: false, final false
inline void* get_state() ;

/// @brief Method get_stateSizeInBytes, addr 0x63fb0d4, size 0xc, virtual false, abstract: false, final false
inline uint32_t get_stateSizeInBytes() ;

/// @brief Method get_typeStatic, addr 0x63ff904, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "baseEvent", ty: "::UnityEngine::InputSystem::LowLevel::InputEvent", modifiers: "", def_value: None }, CppParam { name: "stateFormat", ty: "::UnityEngine::InputSystem::Utilities::FourCC", modifiers: "", def_value: None }, CppParam { name: "stateData", ty: "::UnityEngine::InputSystem::LowLevel::StateEvent__stateData_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr StateEvent(::UnityEngine::InputSystem::LowLevel::InputEvent  baseEvent, ::UnityEngine::InputSystem::Utilities::FourCC  stateFormat, ::UnityEngine::InputSystem::LowLevel::StateEvent__stateData_e__FixedBuffer  stateData) noexcept;
