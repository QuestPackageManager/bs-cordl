...
public:
  ...
  /// @brief Method From, addr 0x461da18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method From, addr 0x461da20, size 0x330, virtual false, abstract: false, final false
  static inline ::Unity::Collections::NativeArray_1<uint8_t> From(::UnityEngine::InputSystem::InputDevice* device, ::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventPtr> eventPtr,
                                                                  ::Unity::Collections::Allocator allocator, bool useDefaultState);

  /// @brief Method From, addr 0x46192ac, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method FromDefaultStateFor, addr 0x461dd50, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method FromUnchecked, addr 0x4619108, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToEventPtr, addr 0x461da08, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_state, addr 0x461da00, size 0x8, virtual false, abstract: false, final false
  inline ::cordl_internals::Ptr<void> get_state();

  /// @brief Method get_stateSizeInBytes, addr 0x46193d0, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_stateSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x461da0c, size 0xc, virtual true, abstract: false, final true
