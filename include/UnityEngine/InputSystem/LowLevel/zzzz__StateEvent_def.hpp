...
public:
  ...
  /// @brief Method From, addr 0x647191c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method From, addr 0x6471924, size 0x350, virtual false, abstract: false, final false
  static inline ::Unity::Collections::NativeArray_1<uint8_t> From(::UnityEngine::InputSystem::InputDevice* device, ::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventPtr> eventPtr,
                                                                  ::Unity::Collections::Allocator allocator, bool useDefaultState);

  /// @brief Method From, addr 0x646cfb0, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::StateEvent* From(::UnityEngine::InputSystem::LowLevel::InputEventPtr ptr);

  /// @brief Method FromDefaultStateFor, addr 0x6471c74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method FromUnchecked, addr 0x646cdd0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToEventPtr, addr 0x647190c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_state, addr 0x6471904, size 0x8, virtual false, abstract: false, final false
  inline void* get_state();

  /// @brief Method get_stateSizeInBytes, addr 0x646d0e0, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_stateSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x6471910, size 0xc, virtual true, abstract: false, final true
