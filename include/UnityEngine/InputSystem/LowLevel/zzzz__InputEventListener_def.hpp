...
public:
  ...
  /// @brief Method .ctor, addr 0x65b0968, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x65b0ae8, size 0x148, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x65b09e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Subscribe, addr 0x65b080c, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Addition, addr 0x65ab164, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Subtraction, addr 0x65ab438, size 0x178, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::InputEventListener
