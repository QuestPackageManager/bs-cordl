...
public:
  ...
  /// @brief Method Create, addr 0x4608608, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand Create();

  /// @brief Method ReadId, addr 0x46085c8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x4608598, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x46085d8, size 0x30, virtual true, abstract: false, final true
