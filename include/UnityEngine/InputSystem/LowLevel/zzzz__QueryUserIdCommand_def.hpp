...
public:
  ...
  /// @brief Method Create, addr 0x460370c, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand Create();

  /// @brief Method ReadId, addr 0x46036cc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x460369c, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x46036dc, size 0x30, virtual true, abstract: false, final true
