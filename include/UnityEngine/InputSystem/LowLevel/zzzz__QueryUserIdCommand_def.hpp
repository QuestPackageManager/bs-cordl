...
/// @brief Method Create, addr 0x63f7e58, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand Create() ;

/// @brief Method ReadId, addr 0x63f7e2c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x63f7e20, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x63f7e4c, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "baseCommand", ty: "::UnityEngine::InputSystem::LowLevel::InputDeviceCommand", modifiers: "", def_value: None }, CppParam { name: "idBuffer", ty: "::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand__idBuffer_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr QueryUserIdCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, ::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand__idBuffer_e__FixedBuffer  idBuffer) noexcept;
