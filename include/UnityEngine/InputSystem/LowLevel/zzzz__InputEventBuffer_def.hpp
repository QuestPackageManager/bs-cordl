...
public:
  ...
  /// @brief Method MoveNext, addr 0x2aeb14c, size 0x6c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2aeb1b8, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Dispose, addr 0x2aeb1c4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method get_Current, addr 0x2aeb1c8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::LowLevel::InputEventPtr get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2aeb1d0, size 0x5c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_sizeInBytes, addr 0x2aea700, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_sizeInBytes();

  /// @brief Method get_capacityInBytes, addr 0x2aea708, size 0x5c, virtual false, abstract: false, final false
  inline int64_t get_capacityInBytes();

  /// @brief Method get_data, addr 0x2aea764, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> get_data();

  /// @brief Method get_bufferPtr, addr 0x2aea770, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x2aeae10, size 0x18, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method AdvanceToNextEvent, addr 0x2aeae28, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnumerator, addr 0x2aeaee8, size 0x74, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2aeaf94, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method Dispose, addr 0x2aeaf98, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Clone, addr 0x2aeaff8, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventBuffer Clone();

  /// @brief Method System.ICloneable.Clone, addr 0x2aeb0e0, size 0x68, virtual true, abstract: false, final true
