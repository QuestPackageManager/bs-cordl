...
/// @brief Method OnBeforeUpdate, addr 0x6400328, size 0x18, virtual false, abstract: false, final false
inline void OnBeforeUpdate() ;

/// @brief Method OnUpdate, addr 0x6400340, size 0x1c, virtual false, abstract: false, final false
inline void OnUpdate() ;

/// @brief Method get_value, addr 0x6400318, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_value() ;

/// @brief Method set_value, addr 0x6400320, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "lastUpdateType", ty: "::UnityEngine::InputSystem::LowLevel::InputUpdateType", modifiers: "", def_value: None }, CppParam { name: "playerUpdateStepCount", ty: "::UnityEngine::InputSystem::LowLevel::InputUpdate_UpdateStepCount", modifiers: "", def_value: None }]
constexpr InputUpdate_SerializedState(::UnityEngine::InputSystem::LowLevel::InputUpdateType  lastUpdateType, ::UnityEngine::InputSystem::LowLevel::InputUpdate_UpdateStepCount  playerUpdateStepCount) noexcept;
...
/// @brief Method GetUpdateTypeForPlayer, addr 0x64002f0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method IsPlayerUpdate, addr 0x640030c, size 0xc, virtual false, abstract: false, final false
static inline bool IsPlayerUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateType) ;

/// @brief Method OnBeforeUpdate, addr 0x64000e0, size 0x84, virtual false, abstract: false, final false
static inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  type) ;

/// @brief Method OnUpdate, addr 0x6400164, size 0x8c, virtual false, abstract: false, final false
static inline void OnUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  type) ;

/// @brief Method Restore, addr 0x6400258, size 0x98, virtual false, abstract: false, final false
static inline void Restore(::UnityEngine::InputSystem::LowLevel::InputUpdate_SerializedState  state) ;

/// @brief Method Save, addr 0x64001f0, size 0x68, virtual false, abstract: false, final false
