...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputUpdate_SerializedState, "UnityEngine.InputSystem.LowLevel", "InputUpdate/SerializedState");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputUpdate_UpdateStepCount, "UnityEngine.InputSystem.LowLevel", "InputUpdate/UpdateStepCount");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputUpdate_UpdateStepCount) == 0x8, "Size mismatch!");
