...
public:
  ...
  /// @brief Method get_Format, addr 0x2aea568, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method WithButton, addr 0x2aea598, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x2aea5c4, size 0x30, virtual true, abstract: false, final true
