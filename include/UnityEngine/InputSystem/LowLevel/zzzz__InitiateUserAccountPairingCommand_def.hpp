...
// Write type traits
MARK_VAL_T(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result);
MARK_VAL_T(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result, "UnityEngine.InputSystem.LowLevel", "InitiateUserAccountPairingCommand/Result");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand, "UnityEngine.InputSystem.LowLevel", "InitiateUserAccountPairingCommand");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
public:
  ...
  static ::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result const ErrorAlreadyInProgress;

  /// @brief Field ErrorNotSupported value: I32(-1)
  static ::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result const ErrorNotSupported;

  /// @brief Field SuccessfullyInitiated value: I32(1)
  static ::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result const SuccessfullyInitiated;
...
static_assert(offsetof(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result, value__) == 0x0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result) == 0x4, "Size mismatch!");
...
public:
  // Declarations
  using Result = ::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand_Result;
  ...
  /// @brief Method Create, addr 0x65ad7a0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65ad788, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65ad794, size 0xc, virtual true, abstract: false, final true
  ...
  // Ctor Parameters [CppParam { name: "baseCommand", ty: "::UnityEngine::InputSystem::LowLevel::InputDeviceCommand", modifiers: "", def_value: None, comment: None }]
...
#pragma pack(pop)
// Non member Declarations
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand) == 0x8, "Size mismatch!");
