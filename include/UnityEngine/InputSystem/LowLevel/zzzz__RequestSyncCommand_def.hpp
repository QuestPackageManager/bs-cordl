...
public:
  ...
  /// @brief Method Create, addr 0x65a8808, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65a87f0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65a87fc, size 0xc, virtual true, abstract: false, final true
