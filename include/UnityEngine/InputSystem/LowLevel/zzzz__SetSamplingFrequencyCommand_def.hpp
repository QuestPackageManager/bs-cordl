...
public:
  ...
  /// @brief Method Create, addr 0x460a13c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x460a0dc, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x460a10c, size 0x30, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand, 0xc>, "Size mismatch!");
