...
public:
  ...
  /// @brief Method Create, addr 0x460cd94, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x460cd34, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x460cd64, size 0x30, virtual true, abstract: false, final true
