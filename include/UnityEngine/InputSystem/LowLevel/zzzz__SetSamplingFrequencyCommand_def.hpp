...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(SetSamplingFrequencyCommand)
...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand, "UnityEngine.InputSystem.LowLevel", "SetSamplingFrequencyCommand");
...
#pragma pack(push, 0)
struct CORDL_TYPE SetSamplingFrequencyCommand {
public:
  // Declarations
  ...
  /// @brief Method Create, addr 0x65a886c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65a8854, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65a8860, size 0xc, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr SetSamplingFrequencyCommand();
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand) == 0xc, "Size mismatch!");
