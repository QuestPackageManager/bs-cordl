...
/// @brief Method Press, addr 0x63f81b8, size 0x24, virtual false, abstract: false, final false
inline void Press(::UnityEngine::InputSystem::Key  key) ;

/// @brief Method Release, addr 0x63f81dc, size 0x24, virtual false, abstract: false, final false
inline void Release(::UnityEngine::InputSystem::Key  key) ;

/// @brief Method Set, addr 0x63f8188, size 0x30, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::Key  key, bool  state) ;

/// @brief Method .ctor, addr 0x63f809c, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::InputSystem::Key,::Array<::UnityEngine::InputSystem::Key>*>  pressedKeys) ;

/// @brief Method get_Format, addr 0x63f8090, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x63f8200, size 0xc, virtual true, abstract: false, final true
