...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::PointerState, "UnityEngine.InputSystem.LowLevel", "PointerState");
...
public:
  ...
  /// @brief Method get_format, addr 0x65a8c00, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x65a8bf4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::PointerState) == 0x24, "Size mismatch!");
