...
public:
  ...
  /// @brief Method Create, addr 0x460a120, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460a114, size 0xc, virtual true, abstract: false, final true
