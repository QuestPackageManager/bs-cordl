...
public:
  ...
  /// @brief Method Create, addr 0x646b218, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x646b20c, size 0xc, virtual true, abstract: false, final true
