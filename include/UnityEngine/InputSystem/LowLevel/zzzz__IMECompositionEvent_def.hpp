...
public:
  ...
  /// @brief Method Create, addr 0x46086e0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x46086d4, size 0xc, virtual true, abstract: false, final true
