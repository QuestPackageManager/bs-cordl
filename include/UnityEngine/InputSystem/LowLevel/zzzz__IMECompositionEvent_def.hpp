...
/// @brief Method Create, addr 0x63f920c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x63f9200, size 0xc, virtual true, abstract: false, final true
