...
public:
  ...
  /// @brief Method Create, addr 0x460a0a8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x460a09c, size 0xc, virtual true, abstract: false, final true
