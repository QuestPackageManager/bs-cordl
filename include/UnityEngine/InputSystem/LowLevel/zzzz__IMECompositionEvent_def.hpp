...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::IMECompositionEvent, "UnityEngine.InputSystem.LowLevel", "IMECompositionEvent");
...
public:
  ...
  /// @brief Method Create, addr 0x65a9b5c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a9b50, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::IMECompositionEvent) == 0x98, "Size mismatch!");
