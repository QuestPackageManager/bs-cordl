...
/// @brief Method Create, addr 0x646cd90, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x646cd84, size 0xc, virtual true, abstract: false, final true
