...
public:
  ...
  /// @brief Method Create, addr 0x45a73cc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x45a73c0, size 0xc, virtual true, abstract: false, final true
