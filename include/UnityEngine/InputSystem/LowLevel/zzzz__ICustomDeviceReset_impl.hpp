...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset::*)()>(&::UnityEngine::InputSystem::LowLevel::ICustomDeviceReset::Reset)> {
