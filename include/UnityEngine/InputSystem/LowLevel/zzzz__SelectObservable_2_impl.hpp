...
inline void UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>::_ctor(::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>* observable,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>*>(),
                          { ".ctor", {}, { ::i2c::type_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>*>(), ::i2c::type_of<::System::IObserver_1<TResult>*>() } })));
...
template <typename TSource, typename TResult> inline void UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>::OnCompleted() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>*>(), { "OnCompleted", {}, {} })));
...
template <typename TSource, typename TResult> inline void UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>::OnError(::System::Exception* error) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>*>(),
...
template <typename TSource, typename TResult> inline void UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>::OnNext(TSource evt) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>*>(), { "OnNext", {}, { ::i2c::type_of<TSource>() } })));
...
UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>::New_ctor(::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>* observable,
                                                                                          ::System::IObserver_1<TResult>* observer) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::InputSystem::LowLevel::SelectObservable_2_Select<TSource, TResult>*>(observable, observer));
}
...
inline void UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>::_ctor(::System::IObservable_1<TSource>* source, ::System::Func_2<TSource, TResult>* filter) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>*>(),
                                                           { ".ctor", {}, { ::i2c::type_of<::System::IObservable_1<TSource>*>(), ::i2c::type_of<::System::Func_2<TSource, TResult>*>() } })));
...
inline ::System::IDisposable* UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>::Subscribe(::System::IObserver_1<TResult>* observer) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>*>(),
...
UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>::New_ctor(::System::IObservable_1<TSource>* source, ::System::Func_2<TSource, TResult>* filter) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::InputSystem::LowLevel::SelectObservable_2<TSource, TResult>*>(source, filter));
}
