...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6469890, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6469920, size 0x24, virtual true, abstract: false, final false
  inline int64_t EndInvoke(::ByRef<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand> command, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x646987c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6469800, size 0x7c, virtual false, abstract: false, final false
