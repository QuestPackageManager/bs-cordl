...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x301b268, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x301b2f4, size 0x2c, virtual true, abstract: false, final false
  inline int64_t EndInvoke(ByRef<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand> command, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x301b254, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x301b180, size 0xd4, virtual false, abstract: false, final false
