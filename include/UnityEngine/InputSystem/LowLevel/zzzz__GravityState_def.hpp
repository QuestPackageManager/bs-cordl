...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::GravityState, "UnityEngine.InputSystem.LowLevel", "GravityState");
...
public:
  ...
  /// @brief Method get_format, addr 0x65ae460, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x65ae454, size 0xc, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "gravity", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::GravityState) == 0xc, "Size mismatch!");
