...
public:
  ...
  /// @brief Method Create, addr 0x65adc44, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand Create();

  /// @brief Method ReadLayoutName, addr 0x65adbe8, size 0x20, virtual false, abstract: false, final false
  inline ::StringW ReadLayoutName();

  /// @brief Method WriteLayoutName, addr 0x65adc08, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65adbdc, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65adc38, size 0xc, virtual true, abstract: false, final true
