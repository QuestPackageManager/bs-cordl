...
public:
  ...
  /// @brief Method Create, addr 0x6469ae8, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand Create();

  /// @brief Method ReadLayoutName, addr 0x6469a8c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW ReadLayoutName();

  /// @brief Method WriteLayoutName, addr 0x6469aac, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x6469a80, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x6469adc, size 0xc, virtual true, abstract: false, final true
