...
public:
  ...
  /// @brief Method From, addr 0x63f8504, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method From, addr 0x63f83d0, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::DeltaStateEvent* From(::UnityEngine::InputSystem::LowLevel::InputEventPtr ptr);

  /// @brief Method FromUnchecked, addr 0x63f8500, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToEventPtr, addr 0x63f83cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_deltaState, addr 0x63f83b8, size 0x8, virtual false, abstract: false, final false
  inline void* get_deltaState();

  /// @brief Method get_deltaStateSizeInBytes, addr 0x63f83ac, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_deltaStateSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x63f83c0, size 0xc, virtual true, abstract: false, final true
