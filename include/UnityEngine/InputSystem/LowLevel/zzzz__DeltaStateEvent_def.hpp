...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DeltaStateEvent__stateData_e__FixedBuffer) == 0x1, "Size mismatch!");
...
#pragma pack(pop)
// Non member Declarations
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DeltaStateEvent) == 0x1d, "Size mismatch!");
