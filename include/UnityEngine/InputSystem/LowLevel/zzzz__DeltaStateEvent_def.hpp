...
public:
  ...
  /// @brief Method From, addr 0x646abd0, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method From, addr 0x646aa9c, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::DeltaStateEvent* From(::UnityEngine::InputSystem::LowLevel::InputEventPtr ptr);

  /// @brief Method FromUnchecked, addr 0x646abcc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToEventPtr, addr 0x646aa98, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_deltaState, addr 0x646aa84, size 0x8, virtual false, abstract: false, final false
  inline void* get_deltaState();

  /// @brief Method get_deltaStateSizeInBytes, addr 0x646aa78, size 0xc, virtual false, abstract: false, final false
  inline uint32_t get_deltaStateSizeInBytes();

  /// @brief Method get_typeStatic, addr 0x646aa8c, size 0xc, virtual true, abstract: false, final true
