...
// Dependencies UnityEngine.InputSystem.LowLevel.DeltaStateEvent::<stateData>e__FixedBuffer, UnityEngine.InputSystem.LowLevel.InputEvent, UnityEngine.InputSystem.Utilities.FourCC
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Field baseEvent, offset 0x0, size 0x14 
 ...
 __declspec(property(get=get_deltaState)) void*  deltaState;
...
/// @brief Method From, addr 0x63f8bc4, size 0x394, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x63f8a90, size 0x130, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::DeltaStateEvent* From(::UnityEngine::InputSystem::LowLevel::InputEventPtr  ptr) ;

/// @brief Method FromUnchecked, addr 0x63f8bc0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ToEventPtr, addr 0x63f8a8c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_deltaState, addr 0x63f8a78, size 0x8, virtual false, abstract: false, final false
inline void* get_deltaState() ;

/// @brief Method get_deltaStateSizeInBytes, addr 0x63f8a6c, size 0xc, virtual false, abstract: false, final false
inline uint32_t get_deltaStateSizeInBytes() ;

/// @brief Method get_typeStatic, addr 0x63f8a80, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "baseEvent", ty: "::UnityEngine::InputSystem::LowLevel::InputEvent", modifiers: "", def_value: None }, CppParam { name: "stateFormat", ty: "::UnityEngine::InputSystem::Utilities::FourCC", modifiers: "", def_value: None }, CppParam { name: "stateOffset", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "stateData", ty: "::UnityEngine::InputSystem::LowLevel::DeltaStateEvent__stateData_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr DeltaStateEvent(::UnityEngine::InputSystem::LowLevel::InputEvent  baseEvent, ::UnityEngine::InputSystem::Utilities::FourCC  stateFormat, uint32_t  stateOffset, ::UnityEngine::InputSystem::LowLevel::DeltaStateEvent__stateData_e__FixedBuffer  stateData) noexcept;
