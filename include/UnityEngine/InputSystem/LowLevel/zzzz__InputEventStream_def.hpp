...
public:
  ...
  /// @brief Method Advance, addr 0x646d784, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEvent* Advance(bool leaveEventInBuffer);

  /// @brief Method CleanUpAfterException, addr 0x646d520, size 0x70, virtual false, abstract: false, final false
  inline void CleanUpAfterException();

  /// @brief Method Close, addr 0x646d400, size 0x120, virtual false, abstract: false, final false
  inline void Close(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer);

  /// @brief Method Peek, addr 0x646d824, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEvent* Peek();

  /// @brief Method Write, addr 0x646d590, size 0x1f4, virtual false, abstract: false, final false
  inline void Write(::UnityEngine::InputSystem::LowLevel::InputEvent* eventPtr);

  /// @brief Method .ctor, addr 0x646d37c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer, int32_t maxAppendedEvents);

  /// @brief Method get_currentEventPtr, addr 0x646d2fc, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEvent* get_currentEventPtr();

  /// @brief Method get_isOpen, addr 0x646d2dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_isOpen();

  /// @brief Method get_numBytesRetainedInBuffer, addr 0x646d330, size 0x4c, virtual false, abstract: false, final false
  inline uint32_t get_numBytesRetainedInBuffer();

  /// @brief Method get_numEventsRetainedInBuffer, addr 0x646d2f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_numEventsRetainedInBuffer();

  /// @brief Method get_remainingEventCount, addr 0x646d2e4, size 0x10, virtual false, abstract: false, final false
