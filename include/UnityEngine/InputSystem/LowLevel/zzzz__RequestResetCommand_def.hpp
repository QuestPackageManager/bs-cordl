...
public:
  ...
  /// @brief Method Create, addr 0x65a87e0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65a87c8, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65a87d4, size 0xc, virtual true, abstract: false, final true
