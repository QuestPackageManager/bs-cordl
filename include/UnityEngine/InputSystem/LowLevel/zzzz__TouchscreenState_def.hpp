...
/// @brief Field primaryTouchData, offset 0x0, size 0x38 
 __declspec(property(get=__cordl_internal_get_primaryTouchData, put=__cordl_internal_set_primaryTouchData)) ::UnityEngine::InputSystem::LowLevel::TouchscreenState__primaryTouchData_e__FixedBuffer  primaryTouchData;
...
/// @brief Method get_Format, addr 0x63f870c, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x63f8724, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method get_primaryTouch, addr 0x63f8718, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::TouchState* get_primaryTouch() ;

/// @brief Method get_touches, addr 0x63f871c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "primaryTouchData", ty: "::UnityEngine::InputSystem::LowLevel::TouchscreenState__primaryTouchData_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "touchData", ty: "::UnityEngine::InputSystem::LowLevel::TouchscreenState__touchData_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr TouchscreenState(::UnityEngine::InputSystem::LowLevel::TouchscreenState__primaryTouchData_e__FixedBuffer  primaryTouchData, ::UnityEngine::InputSystem::LowLevel::TouchscreenState__touchData_e__FixedBuffer  touchData) noexcept;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::TouchscreenState__primaryTouchData_e__FixedBuffer, "UnityEngine.InputSystem.LowLevel", "TouchscreenState/<primaryTouchData>e__FixedBuffer");
