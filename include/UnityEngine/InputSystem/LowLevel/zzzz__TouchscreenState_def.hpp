...
public:
  ...
  /// @brief Method get_Format, addr 0x646a718, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format();

  /// @brief Method get_format, addr 0x646a730, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_primaryTouch, addr 0x646a724, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::TouchState* get_primaryTouch();

  /// @brief Method get_touches, addr 0x646a728, size 0x8, virtual false, abstract: false, final false
