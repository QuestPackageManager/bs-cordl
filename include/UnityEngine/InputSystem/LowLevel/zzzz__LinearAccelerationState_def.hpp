...
public:
  ...
  /// @brief Method get_kFormat, addr 0x2aea868, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_kFormat();

  /// @brief Method get_format, addr 0x2aea898, size 0x30, virtual true, abstract: false, final true
