...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::LinearAccelerationState, "UnityEngine.InputSystem.LowLevel", "LinearAccelerationState");
...
public:
  ...
  /// @brief Method get_format, addr 0x65a8c78, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x65a8c6c, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::LinearAccelerationState) == 0xc, "Size mismatch!");
