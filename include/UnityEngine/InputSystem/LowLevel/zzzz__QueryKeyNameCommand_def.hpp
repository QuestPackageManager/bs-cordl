...
public:
  ...
  /// @brief Method Create, addr 0x6469b40, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyNameCommand Create(::UnityEngine::InputSystem::Key key);

  /// @brief Method ReadKeyName, addr 0x6469b14, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x6469b08, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x6469b34, size 0xc, virtual true, abstract: false, final true
