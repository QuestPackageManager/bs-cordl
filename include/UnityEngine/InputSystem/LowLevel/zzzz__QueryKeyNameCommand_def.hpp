...
public:
  ...
  /// @brief Method Create, addr 0x65adc9c, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyNameCommand Create(::UnityEngine::InputSystem::Key key);

  /// @brief Method ReadKeyName, addr 0x65adc70, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65adc64, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65adc90, size 0xc, virtual true, abstract: false, final true
