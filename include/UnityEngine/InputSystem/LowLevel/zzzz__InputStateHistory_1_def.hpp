...
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Enumerator, "UnityEngine.InputSystem.LowLevel", "InputStateHistory`1/Enumerator");
DEFINE_IL2CPP_GEN_CLASS(::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record, "UnityEngine.InputSystem.LowLevel", "InputStateHistory`1/Record");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// cpp template
