...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InputRuntime", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InputRuntime(InputRuntime&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InputRuntime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InputRuntime(InputRuntimeconst&) = delete;
