...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::IInputRuntime*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::IInputRuntime*, "UnityEngine.InputSystem.LowLevel", "IInputRuntime");
// Dependencies
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: false
...
public:
  ...
  /// @brief Method get_normalizeScrollWheelDelta, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method get_scrollWheelDeltaPerTick, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method set_normalizeScrollWheelDelta, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IInputRuntime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInputRuntime(IInputRuntimeconst&) = delete;
