...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent, "UnityEngine.InputSystem.LowLevel", "DeviceRemoveEvent");
...
public:
  ...
  /// @brief Method Create, addr 0x65a9a4c, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent Create(int32_t deviceId, double_t time);

  /// @brief Method ToEventPtr, addr 0x65a9a48, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_typeStatic, addr 0x65a9a3c, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent) == 0x14, "Size mismatch!");
