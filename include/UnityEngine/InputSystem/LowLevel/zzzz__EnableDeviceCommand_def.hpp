...
public:
  ...
  /// @brief Method Create, addr 0x64695d8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x64695c0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x64695cc, size 0xc, virtual true, abstract: false, final true
