...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::EnableDeviceCommand, "UnityEngine.InputSystem.LowLevel", "EnableDeviceCommand");
...
public:
  ...
  /// @brief Method Create, addr 0x65ad734, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65ad71c, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65ad728, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::EnableDeviceCommand) == 0x8, "Size mismatch!");
