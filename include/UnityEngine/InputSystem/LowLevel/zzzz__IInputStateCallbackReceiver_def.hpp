...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IInputStateCallbackReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInputStateCallbackReceiver(IInputStateCallbackReceiverconst&) = delete;
