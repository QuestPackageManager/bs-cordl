...
public:
  ...
  /// @brief Method CopyToFrom, addr 0x6476acc, size 0x11c, virtual false, abstract: false, final false
  inline void CopyToFrom(void* toStatePtr, void* fromStatePtr);

  /// @brief Method FloatToPrimitiveValue, addr 0x64758a8, size 0x564, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t value);

  /// @brief Method GetPrimitiveFormatFromType, addr 0x6474380, size 0x4c0, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(::System::Type* type);

  /// @brief Method GetSizeOfPrimitiveFormatInBits, addr 0x6474094, size 0x2ec, virtual false, abstract: false, final false
  static inline int32_t GetSizeOfPrimitiveFormatInBits(::UnityEngine::InputSystem::Utilities::FourCC type);

  /// @brief Method ReadDouble, addr 0x6475e0c, size 0x420, virtual false, abstract: false, final false
  inline double_t ReadDouble(void* statePtr);

  /// @brief Method ReadFloat, addr 0x6474f54, size 0x424, virtual false, abstract: false, final false
  inline float_t ReadFloat(void* statePtr);

  /// @brief Method ReadInt, addr 0x6474998, size 0x2d4, virtual false, abstract: false, final false
  inline int32_t ReadInt(void* statePtr);

  /// @brief Method Write, addr 0x6476770, size 0x35c, virtual false, abstract: false, final false
  inline void Write(void* statePtr, ::UnityEngine::InputSystem::Utilities::PrimitiveValue value);

  /// @brief Method WriteDouble, addr 0x647622c, size 0x544, virtual false, abstract: false, final false
  inline void WriteDouble(void* statePtr, double_t value);

  /// @brief Method WriteFloat, addr 0x6475378, size 0x530, virtual false, abstract: false, final false
  inline void WriteFloat(void* statePtr, float_t value);

  /// @brief Method WriteInt, addr 0x6474c6c, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_alignedSizeInBytes, addr 0x6474880, size 0x60, virtual false, abstract: false, final false
  inline uint32_t get_alignedSizeInBytes();

  /// @brief Method get_bitOffset, addr 0x6474860, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bitOffset();

  /// @brief Method get_byteOffset, addr 0x6474850, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_byteOffset();

  /// @brief Method get_effectiveBitOffset, addr 0x647493c, size 0x5c, virtual false, abstract: false, final false
  inline uint32_t get_effectiveBitOffset();

  /// @brief Method get_effectiveByteOffset, addr 0x64748e0, size 0x5c, virtual false, abstract: false, final false
  inline uint32_t get_effectiveByteOffset();

  /// @brief Method get_format, addr 0x6474840, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_sizeInBits, addr 0x6474870, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bitOffset, addr 0x6474868, size 0x8, virtual false, abstract: false, final false
  inline void set_bitOffset(uint32_t value);

  /// @brief Method set_byteOffset, addr 0x6474858, size 0x8, virtual false, abstract: false, final false
  inline void set_byteOffset(uint32_t value);

  /// @brief Method set_format, addr 0x6474848, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::UnityEngine::InputSystem::Utilities::FourCC value);

  /// @brief Method set_sizeInBits, addr 0x6474878, size 0x8, virtual false, abstract: false, final false
