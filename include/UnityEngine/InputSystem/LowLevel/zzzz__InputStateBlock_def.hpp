...
public:
  ...
  /// @brief Method GetSizeOfPrimitiveFormatInBits addr 0x2972944 size 0x3d0 virtual false final false
  static inline int32_t GetSizeOfPrimitiveFormatInBits(::UnityEngine::InputSystem::Utilities::FourCC type);

  /// @brief Method GetPrimitiveFormatFromType addr 0x2972d14 size 0x4dc virtual false final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(::System::Type* type);

  /// @brief Method get_format addr 0x29731f0 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method set_format addr 0x29731f8 size 0x8 virtual false final false
  inline void set_format(::UnityEngine::InputSystem::Utilities::FourCC value);

  /// @brief Method get_byteOffset addr 0x2973200 size 0x8 virtual false final false
  inline uint32_t get_byteOffset();

  /// @brief Method set_byteOffset addr 0x2973208 size 0x8 virtual false final false
  inline void set_byteOffset(uint32_t value);

  /// @brief Method get_bitOffset addr 0x2973210 size 0x8 virtual false final false
  inline uint32_t get_bitOffset();

  /// @brief Method set_bitOffset addr 0x2973218 size 0x8 virtual false final false
  inline void set_bitOffset(uint32_t value);

  /// @brief Method get_sizeInBits addr 0x2973220 size 0x8 virtual false final false
  inline uint32_t get_sizeInBits();

  /// @brief Method set_sizeInBits addr 0x2973228 size 0x8 virtual false final false
  inline void set_sizeInBits(uint32_t value);

  /// @brief Method get_alignedSizeInBytes addr 0x2969cac size 0x10 virtual false final false
  inline uint32_t get_alignedSizeInBytes();

  /// @brief Method get_effectiveByteOffset addr 0x2973230 size 0xc virtual false final false
  inline uint32_t get_effectiveByteOffset();

  /// @brief Method get_effectiveBitOffset addr 0x297323c size 0xc virtual false final false
  inline uint32_t get_effectiveBitOffset();

  /// @brief Method ReadInt addr 0x2973248 size 0x1d0 virtual false final false
  inline int32_t ReadInt(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteInt addr 0x2973418 size 0x1bc virtual false final false
  inline void WriteInt(::cordl_internals::Ptr<void> statePtr, int32_t value);

  /// @brief Method ReadFloat addr 0x29735d4 size 0x2fc virtual false final false
  inline float_t ReadFloat(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteFloat addr 0x29738d0 size 0x400 virtual false final false
  inline void WriteFloat(::cordl_internals::Ptr<void> statePtr, float_t value);

  /// @brief Method FloatToPrimitiveValue addr 0x2973cd0 size 0x4a0 virtual false final false
  inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t value);

  /// @brief Method ReadDouble addr 0x2974170 size 0x2fc virtual false final false
  inline double_t ReadDouble(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteDouble addr 0x297446c size 0x424 virtual false final false
  inline void WriteDouble(::cordl_internals::Ptr<void> statePtr, double_t value);

  /// @brief Method Write addr 0x2974890 size 0x2c0 virtual false final false
  inline void Write(::cordl_internals::Ptr<void> statePtr, ::UnityEngine::InputSystem::Utilities::PrimitiveValue value);

  /// @brief Method CopyToFrom addr 0x2974b50 size 0x8c virtual false final false
