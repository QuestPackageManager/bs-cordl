...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor::*)(::UnityEngine::InputSystem::InputControl*, double_t,
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor::*)(::UnityEngine::InputSystem::InputControl*, double_t, int64_t, int32_t)>(
...
inline void UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor::NotifyControlStateChanged(::UnityEngine::InputSystem::InputControl* control, double_t time,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*>(), 0 })));
...
inline void UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor::NotifyTimerExpired(::UnityEngine::InputSystem::InputControl* control, double_t time, int64_t monitorIndex,
                                                                                             int32_t timerIndex) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*>(), 1 })));
