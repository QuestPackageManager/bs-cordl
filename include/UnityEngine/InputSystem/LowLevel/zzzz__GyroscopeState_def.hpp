...
public:
  ...
  /// @brief Method get_format, addr 0x65ae448, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::FourCC get_format();

  /// @brief Method get_kFormat, addr 0x65ae43c, size 0xc, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "angularVelocity", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None, comment: None }]
