...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate*, "UnityEngine.InputSystem.LowLevel", "InputUpdateDelegate");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x65b6080, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x65b6140, size 0x18, virtual true, abstract: false, final false
  inline void EndInvoke(::by_ref<::UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x65b606c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65b6000, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InputUpdateDelegate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InputUpdateDelegate(InputUpdateDelegate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InputUpdateDelegate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InputUpdateDelegate(InputUpdateDelegateconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate) == 0x80, "Size mismatch!");
