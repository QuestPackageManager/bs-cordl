...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4614fe4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x46150a0, size 0x1c, virtual true, abstract: false, final false
  inline void EndInvoke(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4614fd0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4614f44, size 0x8c, virtual false, abstract: false, final false
