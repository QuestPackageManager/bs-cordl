...
public:
  ...
  /// @brief Method Create, addr 0x318dbd4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x318db74, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x318dba4, size 0x30, virtual true, abstract: false, final true
