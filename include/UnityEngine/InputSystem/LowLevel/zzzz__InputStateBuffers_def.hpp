...
public:
  ...
  /// @brief Method GetBackBuffer, addr 0x6404770, size 0x28, virtual false, abstract: false, final false
  inline void* GetBackBuffer(int32_t deviceIndex);

  /// @brief Method GetFrontBuffer, addr 0x64046dc, size 0x24, virtual false, abstract: false, final false
  inline void* GetFrontBuffer(int32_t deviceIndex);

  /// @brief Method SetBackBuffer, addr 0x64049e8, size 0x20, virtual false, abstract: false, final false
  inline void SetBackBuffer(int32_t deviceIndex, void* ptr);

  /// @brief Method SetFrontBuffer, addr 0x64049cc, size 0x1c, virtual false, abstract: false, final false
  inline void SetFrontBuffer(int32_t deviceIndex, void* ptr);

  /// @brief Method SwapBuffers, addr 0x64050a4, size 0x34, virtual false, abstract: false, final false
  inline void SwapBuffers(int32_t deviceIndex);

  /// @brief Method get_valid, addr 0x6405094, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AllocateAll, addr 0x6404800, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeSizeOfSingleStateBuffer, addr 0x6404900, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeAll, addr 0x6404a08, size 0xe4, virtual false, abstract: false, final false
  inline void FreeAll();

  /// @brief Method GetBackBufferForDevice, addr 0x6404700, size 0x70, virtual false, abstract: false, final false
  static inline void* GetBackBufferForDevice(int32_t deviceIndex);

  /// @brief Method GetDoubleBuffersFor, addr 0x64045a4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFrontBufferForDevice, addr 0x6404670, size 0x6c, virtual false, abstract: false, final false
  static inline void* GetFrontBufferForDevice(int32_t deviceIndex);

  /// @brief Method MigrateAll, addr 0x6404aec, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method MigrateDoubleBuffer, addr 0x6404c4c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method MigrateSingleBuffer, addr 0x6404e70, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NextDeviceOffset, addr 0x6404fa4, size 0xf0, virtual false, abstract: false, final false
  static inline uint32_t NextDeviceOffset(uint32_t currentOffset, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method SetUpDeviceToBufferMappings, addr 0x640496c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SwitchTo, addr 0x6404798, size 0x68, virtual false, abstract: false, final false
