...
/// @brief Method GetBackBuffer, addr 0x6404e30, size 0x28, virtual false, abstract: false, final false
inline void* GetBackBuffer(int32_t  deviceIndex) ;

/// @brief Method GetFrontBuffer, addr 0x6404d9c, size 0x24, virtual false, abstract: false, final false
inline void* GetFrontBuffer(int32_t  deviceIndex) ;

/// @brief Method SetBackBuffer, addr 0x64050a8, size 0x20, virtual false, abstract: false, final false
inline void SetBackBuffer(int32_t  deviceIndex, void*  ptr) ;

/// @brief Method SetFrontBuffer, addr 0x640508c, size 0x1c, virtual false, abstract: false, final false
inline void SetFrontBuffer(int32_t  deviceIndex, void*  ptr) ;

/// @brief Method SwapBuffers, addr 0x6405764, size 0x34, virtual false, abstract: false, final false
inline void SwapBuffers(int32_t  deviceIndex) ;

/// @brief Method get_valid, addr 0x6405754, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AllocateAll, addr 0x6404ec0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method ComputeSizeOfSingleStateBuffer, addr 0x6404fc0, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method FreeAll, addr 0x64050c8, size 0xe4, virtual false, abstract: false, final false
inline void FreeAll() ;

/// @brief Method GetBackBufferForDevice, addr 0x6404dc0, size 0x70, virtual false, abstract: false, final false
static inline void* GetBackBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method GetDoubleBuffersFor, addr 0x6404c64, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method GetFrontBufferForDevice, addr 0x6404d30, size 0x6c, virtual false, abstract: false, final false
static inline void* GetFrontBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method MigrateAll, addr 0x64051ac, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method MigrateDoubleBuffer, addr 0x640530c, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method MigrateSingleBuffer, addr 0x6405530, size 0x134, virtual false, abstract: false, final false
static inline void MigrateSingleBuffer(void*  newBuffer, ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  devices, int32_t  deviceCount, void*  oldBuffer) ;

/// @brief Method NextDeviceOffset, addr 0x6405664, size 0xf0, virtual false, abstract: false, final false
static inline uint32_t NextDeviceOffset(uint32_t  currentOffset, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method SetUpDeviceToBufferMappings, addr 0x640502c, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers SetUpDeviceToBufferMappings(int32_t  deviceCount, ::ByRef<uint8_t*>  bufferPtr, uint32_t  sizePerBuffer, uint32_t  mappingTableSizePerBuffer) ;

/// @brief Method SwitchTo, addr 0x6404e58, size 0x68, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "sizePerBuffer", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "totalSize", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "defaultStateBuffer", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "noiseMaskBuffer", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "resetMaskBuffer", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "m_AllBuffers", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "m_PlayerStateBuffers", ty: "::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers", modifiers: "", def_value: None }]
constexpr InputStateBuffers(uint32_t  sizePerBuffer, uint32_t  totalSize, void*  defaultStateBuffer, void*  noiseMaskBuffer, void*  resetMaskBuffer, void*  m_AllBuffers, ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers  m_PlayerStateBuffers) noexcept;
