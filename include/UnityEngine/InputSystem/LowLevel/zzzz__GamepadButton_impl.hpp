...
constexpr ::UnityEngine::InputSystem::LowLevel::GamepadButton::GamepadButton(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::InputSystem::LowLevel::GamepadButton::GamepadButton() {}
