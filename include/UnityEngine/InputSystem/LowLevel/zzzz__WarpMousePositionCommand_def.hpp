...
public:
  ...
  /// @brief Method Create, addr 0x4603af8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x4603a98, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x4603ac8, size 0x30, virtual true, abstract: false, final true
