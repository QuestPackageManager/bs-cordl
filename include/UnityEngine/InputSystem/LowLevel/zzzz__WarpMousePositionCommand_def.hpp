...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::LowLevel::WarpMousePositionCommand, "UnityEngine.InputSystem.LowLevel", "WarpMousePositionCommand");
// Dependencies UnityEngine.InputSystem.LowLevel.InputDeviceCommand, UnityEngine.Vector2
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_warpPositionInPlayerDisplaySpace,
                      put = __cordl_internal_set_warpPositionInPlayerDisplaySpace)) ::UnityEngine::Vector2 warpPositionInPlayerDisplaySpace;

  /// @brief Convert operator to "::UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo"
  constexpr operator ::UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo*();

  /// @brief Method Create, addr 0x65ae0b0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x65ae098, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x65ae0a4, size 0xc, virtual true, abstract: false, final true
  ...
  // "warpPositionInPlayerDisplaySpace", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::InputSystem::LowLevel::WarpMousePositionCommand) == 0x10, "Size mismatch!");
