...
public:
  ...
  /// @brief Method FinishSetup, addr 0x45c8d58, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x45c8c80, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::StepCounter* New_ctor();

  /// @brief Method OnRemoved, addr 0x45c8cd4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45c8dd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::StepCounter* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x45c8bec, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::StepCounter* get_current();

  /// @brief Method get_stepCounter, addr 0x45c8bdc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x45c8c34, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::StepCounter* value);

  /// @brief Method set_stepCounter, addr 0x45c8be4, size 0x8, virtual false, abstract: false, final false
