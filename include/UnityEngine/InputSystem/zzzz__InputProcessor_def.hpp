...
/// @brief Method GetValueTypeFromType, addr 0x6368f98, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6369074, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::Utilities::TypeTable getStaticF_s_Processors() ;

/// @brief Method get_cachingPolicy, addr 0x636906c, size 0x8, virtual true, abstract: false, final false
