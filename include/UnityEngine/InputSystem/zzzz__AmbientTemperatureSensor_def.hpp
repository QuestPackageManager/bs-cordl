...
public:
  ...
  /// @brief Method FinishSetup, addr 0x6348ea0, size 0x70, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x6348dc0, size 0x50, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::AmbientTemperatureSensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x6348e10, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6348f10, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::AmbientTemperatureSensor* getStaticF__current_k__BackingField();

  /// @brief Method get_ambientTemperature, addr 0x6348d14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_ambientTemperature();

  /// @brief Method get_current, addr 0x6348d24, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ambientTemperature, addr 0x6348d1c, size 0x8, virtual false, abstract: false, final false
  inline void set_ambientTemperature(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_current, addr 0x6348d70, size 0x50, virtual false, abstract: false, final false
