...
namespace UnityEngine::InputSystem {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5580))]
...
public:
  ...
  /// @brief Method get_count, addr 0x2ab7868, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method Add, addr 0x2ab7870, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x2ab79f8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x2ab7bf0, size 0x64, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CompactArrays, addr 0x2ab7c54, size 0x68, virtual false, abstract: false, final false
  inline void CompactArrays();

  /// @brief Method RemoveAt, addr 0x2ab7b44, size 0xac, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method SortMonitorsByIndex, addr 0x2ab7cbc, size 0x13c, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2331)), TypeDefinitionIndex(TypeDefinitionIndex(2494)), TypeDefinitionIndex(TypeDefinitionIndex(2613)),
// TypeDefinitionIndex(TypeDefinitionIndex(3818)), TypeDefinitionIndex(TypeDefinitionIndex(5874)), TypeDefinitionIndex(TypeDefinitionIndex(5930)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2331), inst: 1992 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3818), inst: 1326 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3818), inst: 1330 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3818), inst: 1331 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5557)) CS Name:
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ab7df8, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2ab7e2c, size 0x44, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2ab7e70, size 0x6a4, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method <>m__Finally1, addr 0x2ab8514, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x2ab8564, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method <>m__Finally3, addr 0x2ab85b4, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally3();

  /// @brief Method <>m__Finally4, addr 0x2ab8604, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally4();

  /// @brief Method <>m__Finally5, addr 0x2ab8654, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally5();

  /// @brief Method <>m__Finally6, addr 0x2ab86a4, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally6();

  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x2ab86f4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2ab86fc, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2ab873c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x2ab8744, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2ab87f0, size 0x4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ab8858, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <MakeDeviceNameUnique>b__144_0, addr 0x2ab8860, size 0x64, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2322)), TypeDefinitionIndex(TypeDefinitionIndex(2324)), TypeDefinitionIndex(TypeDefinitionIndex(2613)),
// TypeDefinitionIndex(TypeDefinitionIndex(5483)), TypeDefinitionIndex(TypeDefinitionIndex(5498)), TypeDefinitionIndex(TypeDefinitionIndex(5499)), TypeDefinitionIndex(TypeDefinitionIndex(5553)),
// TypeDefinitionIndex(TypeDefinitionIndex(5728)), TypeDefinitionIndex(TypeDefinitionIndex(5795)), TypeDefinitionIndex(TypeDefinitionIndex(5796)), TypeDefinitionIndex(TypeDefinitionIndex(5811)),
// TypeDefinitionIndex(TypeDefinitionIndex(5812)), TypeDefinitionIndex(TypeDefinitionIndex(5827)), TypeDefinitionIndex(TypeDefinitionIndex(5854)), TypeDefinitionIndex(TypeDefinitionIndex(5869)),
// TypeDefinitionIndex(TypeDefinitionIndex(5919)), TypeDefinitionIndex(TypeDefinitionIndex(5928)), TypeDefinitionIndex(TypeDefinitionIndex(5971)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2324), inst: 524 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2324), inst: 525 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2324), inst: 526 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2324), inst: 592 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5919), inst: 991 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5919), inst: 992 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5919), inst: 993 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5919), inst: 995 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5919), inst: 999 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5919), inst: 1000 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5919), inst: 1001 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5928), inst: 3852 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5559)) CS Name:
...
public:
  ...
  /// @brief Method get_devices, addr 0x2aa6a30, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_processors, addr 0x2aac8a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_processors();

  /// @brief Method get_interactions, addr 0x2aac8b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_interactions();

  /// @brief Method get_composites, addr 0x2aac8b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_composites();

  /// @brief Method get_metrics, addr 0x2aac8c0, size 0x19c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputMetrics get_metrics();

  /// @brief Method get_settings, addr 0x2aaca5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputSettings> get_settings();

  /// @brief Method set_settings, addr 0x2aaca64, size 0xfc, virtual false, abstract: false, final false
  inline void set_settings(::UnityEngine::InputSystem::InputSettings* value);

  /// @brief Method get_updateMask, addr 0x2aaceec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_updateMask();

  /// @brief Method set_updateMask, addr 0x2aacef4, size 0x24, virtual false, abstract: false, final false
  inline void set_updateMask(::UnityEngine::InputSystem::LowLevel::InputUpdateType value);

  /// @brief Method get_defaultUpdateType, addr 0x2aad0ac, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_defaultUpdateType();

  /// @brief Method get_pollingFrequency, addr 0x2aad0c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pollingFrequency();

  /// @brief Method set_pollingFrequency, addr 0x2aad0d0, size 0x12c, virtual false, abstract: false, final false
  inline void set_pollingFrequency(float_t value);

  /// @brief Method add_onDeviceChange, addr 0x2aa5310, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceChange, addr 0x2aa5590, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceStateChange, addr 0x2aad1fc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceStateChange, addr 0x2aad254, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceCommand, addr 0x2aad2ac, size 0x58, virtual false, abstract: false, final false
  inline void add_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method remove_onDeviceCommand, addr 0x2aad304, size 0x58, virtual false, abstract: false, final false
  inline void remove_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method add_onFindControlLayoutForDevice, addr 0x2aad35c, size 0x60, virtual false, abstract: false, final false
  inline void add_onFindControlLayoutForDevice(::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate* value);

  /// @brief Method remove_onFindControlLayoutForDevice, addr 0x2aad664, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onLayoutChange, addr 0x2aa5368, size 0x58, virtual false, abstract: false, final false
  inline void add_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method remove_onLayoutChange, addr 0x2aa55e8, size 0x58, virtual false, abstract: false, final false
  inline void remove_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method add_onEvent, addr 0x2aa52b8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onEvent, addr 0x2aa5538, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onBeforeUpdate, addr 0x2aad6bc, size 0x60, virtual false, abstract: false, final false
  inline void add_onBeforeUpdate(::System::Action* value);

  /// @brief Method remove_onBeforeUpdate, addr 0x2aad828, size 0x58, virtual false, abstract: false, final false
  inline void remove_onBeforeUpdate(::System::Action* value);

  /// @brief Method add_onAfterUpdate, addr 0x2aad880, size 0x58, virtual false, abstract: false, final false
  inline void add_onAfterUpdate(::System::Action* value);

  /// @brief Method remove_onAfterUpdate, addr 0x2aad8d8, size 0x58, virtual false, abstract: false, final false
  inline void remove_onAfterUpdate(::System::Action* value);

  /// @brief Method add_onSettingsChange, addr 0x2aad930, size 0x58, virtual false, abstract: false, final false
  inline void add_onSettingsChange(::System::Action* value);

  /// @brief Method remove_onSettingsChange, addr 0x2aad988, size 0x58, virtual false, abstract: false, final false
  inline void remove_onSettingsChange(::System::Action* value);

  /// @brief Method get_isProcessingEvents, addr 0x2aad9e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isProcessingEvents();

  /// @brief Method get_gameIsPlaying, addr 0x2aad9e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_gameIsPlaying();

  /// @brief Method get_gameHasFocus, addr 0x2aad9f0, size 0x34, virtual false, abstract: false, final false
  inline bool get_gameHasFocus();

  /// @brief Method get_gameShouldGetInputRegardlessOfFocus, addr 0x2aada24, size 0x24, virtual false, abstract: false, final false
  inline bool get_gameShouldGetInputRegardlessOfFocus();

  /// @brief Method RegisterControlLayout, addr 0x2aada48, size 0x618, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW name, ::System::Type* type);

  /// @brief Method RegisterControlLayout, addr 0x2aa7bcc, size 0x4bc, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW json, ::StringW name, bool isOverride);

  /// @brief Method RegisterControlLayoutBuilder, addr 0x2aae5d8, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutPostRegistration, addr 0x2aae060, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method RecreateDevicesUsingLayout, addr 0x2aae76c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method IsControlOrChildUsingLayoutRecursive, addr 0x2aaeab0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsControlUsingLayout, addr 0x2aae9e0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterControlLayoutMatcher, addr 0x2aae4b8, size 0x120, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::StringW layoutName, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RegisterControlLayoutMatcher, addr 0x2aaf270, size 0x204, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::System::Type* type, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RecreateDevicesUsingLayoutWithInferiorMatch, addr 0x2aaecfc, size 0x1ec, virtual false, abstract: false, final false
  inline void RecreateDevicesUsingLayoutWithInferiorMatch(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher deviceMatcher);

  /// @brief Method RecreateDevice, addr 0x2aaeba0, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAvailableDevicesMatchingDescription, addr 0x2aaeee8, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveControlLayout, addr 0x2aaff64, size 0x214, virtual false, abstract: false, final false
  inline void RemoveControlLayout(::StringW name);

  /// @brief Method TryLoadControlLayout, addr 0x2ab0178, size 0x230, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* TryLoadControlLayout(::System::Type* type);

  /// @brief Method TryLoadControlLayout, addr 0x2aa7bbc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindMatchingControlLayout, addr 0x2aaf474, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOrRegisterDeviceLayoutForType, addr 0x2ab03a8, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindOrRegisterDeviceLayoutForType(::System::Type* type);

  /// @brief Method IsDeviceLayoutMarkedAsSupportedInSettings, addr 0x2ab0448, size 0x10c, virtual false, abstract: false, final false
  inline bool IsDeviceLayoutMarkedAsSupportedInSettings(::UnityEngine::InputSystem::Utilities::InternedString layoutName);

  /// @brief Method ListControlLayouts, addr 0x2ab0554, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDeviceUsage, addr 0x2ab05c8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDeviceUsage, addr 0x2aa81cc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveDeviceUsage, addr 0x2aa8394, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyUsageChanged, addr 0x2ab0724, size 0xa4, virtual false, abstract: false, final false
  inline void NotifyUsageChanged(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDevice, addr 0x2ab07c8, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::System::Type* type, ::StringW name);

  /// @brief Method AddDevice, addr 0x2aa8088, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x2aafdb4, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x2aaf8a4, size 0x510, virtual false, abstract: false, final false
  inline void AddDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDevice, addr 0x2ab1250, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::UnityEngine::InputSystem::Layouts::InputDeviceDescription description);

  /// @brief Method AddDevice, addr 0x2ab1294, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x2ab146c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveDevice, addr 0x2aa7700, size 0x464, virtual false, abstract: false, final false
  inline void RemoveDevice(::UnityEngine::InputSystem::InputDevice* device, bool keepOnListOfAvailableDevices);

  /// @brief Method FlushDisconnectedDevices, addr 0x2ab166c, size 0x54, virtual false, abstract: false, final false
  inline void FlushDisconnectedDevices();

  /// @brief Method ResetDevice, addr 0x2ab16c0, size 0x57c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetDevice, addr 0x2ab1e04, size 0x128, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::StringW nameOrLayout);

  /// @brief Method GetDevice, addr 0x2ab1f2c, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* GetDevice(::StringW nameOrLayout);

  /// @brief Method TryGetDevice, addr 0x2ab1fd0, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::System::Type* layoutType);

  /// @brief Method TryGetDeviceById, addr 0x2aa7584, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDeviceById(int32_t id);

  /// @brief Method GetUnsupportedDevices, addr 0x2ab2028, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableOrDisableDevice, addr 0x2ab0e24, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x2ab2214, size 0xcc, virtual false, abstract: false, final false
  inline void QueueEvent(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> eventPtr);

  /// @brief Method QueueEvent, addr 0x2aa8390, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2ab22e0, size 0x2c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method Update, addr 0x2ab230c, size 0xac, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method Initialize, addr 0x2ab23b8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x2ab4150, size 0x10c, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method InitializeData, addr 0x2ab23f4, size 0x146c, virtual false, abstract: false, final false
  inline void InitializeData();

  /// @brief Method InstallRuntime, addr 0x2ab3860, size 0x6e0, virtual false, abstract: false, final false
  inline void InstallRuntime(::UnityEngine::InputSystem::LowLevel::IInputRuntime* runtime);

  /// @brief Method InstallGlobals, addr 0x2ab3f40, size 0x210, virtual false, abstract: false, final false
  inline void InstallGlobals();

  /// @brief Method UninstallGlobals, addr 0x2ab425c, size 0x38c, virtual false, abstract: false, final false
  inline void UninstallGlobals();

  /// @brief Method MakeDeviceNameUnique, addr 0x2ab08b0, size 0x184, virtual false, abstract: false, final false
  inline void MakeDeviceNameUnique(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResetControlPathsRecursive, addr 0x2ab45e8, size 0xa4, virtual false, abstract: false, final false
  static inline void ResetControlPathsRecursive(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method AssignUniqueDeviceId, addr 0x2ab0a34, size 0x18c, virtual false, abstract: false, final false
  inline void AssignUniqueDeviceId(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ReallocateStateBuffers, addr 0x2aacf18, size 0x194, virtual false, abstract: false, final false
  inline void ReallocateStateBuffers();

  /// @brief Method InitializeDefaultState, addr 0x2ab468c, size 0x158, virtual false, abstract: false, final false
  inline void InitializeDefaultState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InitializeDeviceState, addr 0x2ab0bc0, size 0x228, virtual false, abstract: false, final false
  inline void InitializeDeviceState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnNativeDeviceDiscovered, addr 0x2ab47e4, size 0x3e8, virtual false, abstract: false, final false
  inline void OnNativeDeviceDiscovered(int32_t deviceId, ::StringW deviceDescriptor);

  /// @brief Method TryMatchDisconnectedDevice, addr 0x2ab4bd0, size 0x1e4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryMatchDisconnectedDevice(::StringW deviceDescriptor);

  /// @brief Method InstallBeforeUpdateHookIfNecessary, addr 0x2aad71c, size 0x10c, virtual false, abstract: false, final false
  inline void InstallBeforeUpdateHookIfNecessary();

  /// @brief Method RestoreDevicesAfterDomainReloadIfNecessary, addr 0x2ab4bcc, size 0x4, virtual false, abstract: false, final false
  inline void RestoreDevicesAfterDomainReloadIfNecessary();

  /// @brief Method WarnAboutDevicesFailingToRecreateAfterDomainReload, addr 0x2ab4db4, size 0x4, virtual false, abstract: false, final false
  inline void WarnAboutDevicesFailingToRecreateAfterDomainReload();

  /// @brief Method OnBeforeUpdate, addr 0x2ab4db8, size 0x1c0, virtual false, abstract: false, final false
  inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method ApplySettings, addr 0x2aacb60, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAvailableDevicesThatAreNowRecognized, addr 0x2aad3bc, size 0x2a8, virtual false, abstract: false, final false
  inline void AddAvailableDevicesThatAreNowRecognized();

  /// @brief Method ShouldRunDeviceInBackground, addr 0x2ab0de8, size 0x3c, virtual false, abstract: false, final false
  inline bool ShouldRunDeviceInBackground(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnFocusChanged, addr 0x2ab4f78, size 0x240, virtual false, abstract: false, final false
  inline void OnFocusChanged(bool focus);

  /// @brief Method ShouldRunUpdate, addr 0x2ab51b8, size 0x1c, virtual false, abstract: false, final false
  inline bool ShouldRunUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method OnUpdate, addr 0x2ab51d4, size 0x12e0, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeAfterUpdateCallback, addr 0x2ab6768, size 0x68, virtual false, abstract: false, final false
  inline void InvokeAfterUpdateCallback(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method UpdateState, addr 0x2ab67d0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateState, addr 0x2ab1c3c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteStateChange, addr 0x2ab6ca4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipBuffersForDeviceIfNecessary, addr 0x2ab6c00, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitor, addr 0x2ab7170, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitors, addr 0x2ab1540, size 0x12c, virtual false, abstract: false, final false
  inline void RemoveStateChangeMonitors(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method RemoveStateChangeMonitor, addr 0x2ab72ac, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitorTimeout, addr 0x2ab7404, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitorTimeout, addr 0x2ab7498, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method SortStateChangeMonitorsIfNecessary, addr 0x2ab6924, size 0x54, virtual false, abstract: false, final false
  inline void SortStateChangeMonitorsIfNecessary(int32_t deviceIndex);

  /// @brief Method SignalStateChangeMonitor, addr 0x2ab75bc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method FireStateChangeNotifications, addr 0x2ab76ac, size 0x14c, virtual false, abstract: false, final false
  inline void FireStateChangeNotifications();

  /// @brief Method ProcessStateChangeMonitors, addr 0x2ab6978, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method FireStateChangeNotifications, addr 0x2ab6d58, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessStateChangeMonitorTimeouts, addr 0x2ab64b4, size 0x2b4, virtual false, abstract: false, final false
  inline void ProcessStateChangeMonitorTimeouts();

  static inline ::UnityEngine::InputSystem::InputManager* New_ctor();

  /// @brief Method .ctor, addr 0x2ab77f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <TryFindMatchingControlLayout>b__72_0, addr 0x2ab7800, size 0x68, virtual false, abstract: false, final false
