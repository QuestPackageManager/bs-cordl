...
public:
  ...
  /// @brief Method Add, addr 0x63bfbf8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x63bffa4, size 0x68, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CompactArrays, addr 0x63c000c, size 0x68, virtual false, abstract: false, final false
  inline void CompactArrays();

  /// @brief Method Remove, addr 0x63bfdac, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveAt, addr 0x63bff00, size 0xa4, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method SortMonitorsByIndex, addr 0x63c0074, size 0x168, virtual false, abstract: false, final false
  inline void SortMonitorsByIndex();

  /// @brief Method get_count, addr 0x63bfbf0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <MakeDeviceNameUnique>b__184_0, addr 0x63c0234, size 0x24, virtual false, abstract: false, final false
  inline ::StringW _MakeDeviceNameUnique_b__184_0(::UnityEngine::InputSystem::InputDevice* x);

  /// @brief Method .ctor, addr 0x63c0230, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63c03a4, size 0x960, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputManager__ListControlLayouts_d__97* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x63c0efc, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x63c0eb4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63c0f9c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63c0ebc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63c0ef4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63c0278, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x63c0d04, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x63c0d4c, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method <>m__Finally3, addr 0x63c0d94, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally3();

  /// @brief Method <>m__Finally4, addr 0x63c0ddc, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally4();

  /// @brief Method <>m__Finally5, addr 0x63c0e24, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally5();

  /// @brief Method <>m__Finally6, addr 0x63c0e6c, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally6();

  /// @brief Method .ctor, addr 0x63c0258, size 0x20, virtual false, abstract: false, final false
...
// Dependencies System.Object, Unity.Profiling.ProfilerMarker, UnityEngine.InputSystem.InputManager::StateChangeMonitorTimeout, UnityEngine.InputSystem.InputSettings::ScrollDeltaBehavior,
...
public:
  ...
  /// @brief Method AddAvailableDevicesMatchingDescription, addr 0x63b579c, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAvailableDevicesThatAreNowRecognized, addr 0x63b3b28, size 0x244, virtual false, abstract: false, final false
  inline void AddAvailableDevicesThatAreNowRecognized();

  /// @brief Method AddDevice, addr 0x63b7c18, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::UnityEngine::InputSystem::Layouts::InputDeviceDescription description);

  /// @brief Method AddDevice, addr 0x63b7e08, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x63b7c5c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x63adc14, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x63b67cc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x63b7234, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::System::Type* type, ::StringW name);

  /// @brief Method AddDevice, addr 0x63b61c0, size 0x60c, virtual false, abstract: false, final false
  inline void AddDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDeviceUsage, addr 0x63add50, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitor, addr 0x63bf154, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitorTimeout, addr 0x63bf410, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyActions, addr 0x63b34c8, size 0x88, virtual false, abstract: false, final false
  inline void ApplyActions();

  /// @brief Method ApplySettings, addr 0x63b2eec, size 0x5cc, virtual false, abstract: false, final false
  inline void ApplySettings();

  /// @brief Method AreMaximumEventBytesPerUpdateExceeded, addr 0x63be160, size 0x140, virtual false, abstract: false, final false
  inline bool AreMaximumEventBytesPerUpdateExceeded(uint32_t totalEventBytesProcessed);

  /// @brief Method AssignUniqueDeviceId, addr 0x63b74ac, size 0x178, virtual false, abstract: false, final false
  inline void AssignUniqueDeviceId(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method CheckAllDevicesOptimizedControlsHaveValidState, addr 0x63be50c, size 0x18c, virtual false, abstract: false, final false
  inline void CheckAllDevicesOptimizedControlsHaveValidState();

  /// @brief Method Destroy, addr 0x63bb194, size 0x118, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method DontMakeCurrentlyUpdatingDeviceCurrent, addr 0x63be698, size 0x8, virtual false, abstract: false, final false
  inline void DontMakeCurrentlyUpdatingDeviceCurrent();

  /// @brief Method EnableOrDisableDevice, addr 0x63b78ec, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOrRegisterDeviceLayoutForType, addr 0x63b6db4, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindOrRegisterDeviceLayoutForType(::System::Type* type);

  /// @brief Method FireStateChangeNotifications, addr 0x63bf6b8, size 0x140, virtual false, abstract: false, final false
  inline void FireStateChangeNotifications();

  /// @brief Method FireStateChangeNotifications, addr 0x63bec78, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipBuffersForDeviceIfNecessary, addr 0x63be930, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushDisconnectedDevices, addr 0x63b7fc4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDevice, addr 0x63b8c2c, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* GetDevice(::StringW nameOrLayout);

  /// @brief Method GetUnsupportedDevices, addr 0x63b8d18, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x63b90a4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeActions, addr 0x63b90f0, size 0x94, virtual false, abstract: false, final false
  inline void InitializeActions();

  /// @brief Method InitializeData, addr 0x63b9184, size 0x16c0, virtual false, abstract: false, final false
  inline void InitializeData();

  /// @brief Method InitializeDefaultState, addr 0x63bbc24, size 0x1ac, virtual false, abstract: false, final false
  inline void InitializeDefaultState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InitializeDeviceState, addr 0x63b7624, size 0x290, virtual false, abstract: false, final false
  inline void InitializeDeviceState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InstallBeforeUpdateHookIfNecessary, addr 0x63b3e2c, size 0x144, virtual false, abstract: false, final false
  inline void InstallBeforeUpdateHookIfNecessary();

  /// @brief Method InstallGlobals, addr 0x63baf70, size 0x224, virtual false, abstract: false, final false
  inline void InstallGlobals();

  /// @brief Method InstallRuntime, addr 0x63ba844, size 0x72c, virtual false, abstract: false, final false
  inline void InstallRuntime(::UnityEngine::InputSystem::LowLevel::IInputRuntime* runtime);

  /// @brief Method InvokeAfterUpdateCallback, addr 0x63bdfb4, size 0xac, virtual false, abstract: false, final false
  inline void InvokeAfterUpdateCallback(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method IsControlOrChildUsingLayoutRecursive, addr 0x63b5330, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method IsControlUsingLayout, addr 0x63b5258, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDeviceLayoutMarkedAsSupportedInSettings, addr 0x63b6e38, size 0x108, virtual false, abstract: false, final false
  inline bool IsDeviceLayoutMarkedAsSupportedInSettings(::UnityEngine::InputSystem::Utilities::InternedString layoutName);

  /// @brief Method ListControlLayouts, addr 0x63b6f40, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListControlLayouts(::StringW basedOn);

  /// @brief Method MakeDeviceNameUnique, addr 0x63b72ec, size 0x1c0, virtual false, abstract: false, final false
  inline void MakeDeviceNameUnique(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method MakeEscapedJsonString, addr 0x63bc4ec, size 0x18c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::JsonParser_JsonString MakeEscapedJsonString(::StringW theString);

  /// @brief Method MakeStringWithEventsProcessedByDevice, addr 0x63be364, size 0x1a8, virtual false, abstract: false, final false
  inline ::StringW MakeStringWithEventsProcessedByDevice();

  static inline ::UnityEngine::InputSystem::InputManager* New_ctor();

  /// @brief Method NotifyUsageChanged, addr 0x63b712c, size 0x108, virtual false, abstract: false, final false
  inline void NotifyUsageChanged(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnBeforeUpdate, addr 0x63bc67c, size 0x210, virtual false, abstract: false, final false
  inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method OnFocusChanged, addr 0x63bc88c, size 0x24c, virtual false, abstract: false, final false
  inline void OnFocusChanged(bool focus);

  /// @brief Method OnNativeDeviceDiscovered, addr 0x63bbdd0, size 0x464, virtual false, abstract: false, final false
  inline void OnNativeDeviceDiscovered(int32_t deviceId, ::StringW deviceDescriptor);

  /// @brief Method OnUpdate, addr 0x63bcaf4, size 0x11ec, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutPostRegistration, addr 0x63b4818, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessStateChangeMonitorTimeouts, addr 0x63bdce0, size 0x2d4, virtual false, abstract: false, final false
  inline void ProcessStateChangeMonitorTimeouts();

  /// @brief Method ProcessStateChangeMonitors, addr 0x63be6ec, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x63b8ee4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x63adf10, size 0x4, virtual false, abstract: false, final false
  inline void QueueEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr ptr);

  /// @brief Method ReallocateStateBuffers, addr 0x63b357c, size 0x170, virtual false, abstract: false, final false
  inline void ReallocateStateBuffers();

  /// @brief Method RecreateDevice, addr 0x63b5434, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method RecreateDevicesUsingLayout, addr 0x63b4fe0, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method RecreateDevicesUsingLayoutWithInferiorMatch, addr 0x63b5584, size 0x218, virtual false, abstract: false, final false
  inline void RecreateDevicesUsingLayoutWithInferiorMatch(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher deviceMatcher);

  /// @brief Method RegisterControlLayout, addr 0x63ad6ec, size 0x528, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW json, ::StringW name, bool isOverride);

  /// @brief Method RegisterControlLayout, addr 0x63b4254, size 0x5c4, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW name, ::System::Type* type);

  /// @brief Method RegisterControlLayoutBuilder, addr 0x63b4e3c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterControlLayoutMatcher, addr 0x63b4ce4, size 0x158, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::StringW layoutName, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RegisterControlLayoutMatcher, addr 0x63b5b04, size 0x1e4, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::System::Type* type, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RegisterCustomTypes, addr 0x63bb650, size 0x250, virtual false, abstract: false, final false
  inline void RegisterCustomTypes();

  /// @brief Method RegisterCustomTypes, addr 0x63bb8a0, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveControlLayout, addr 0x63b6950, size 0x278, virtual false, abstract: false, final false
  inline void RemoveControlLayout(::StringW name);

  /// @brief Method RemoveDevice, addr 0x63ad130, size 0x550, virtual false, abstract: false, final false
  inline void RemoveDevice(::UnityEngine::InputSystem::InputDevice* device, bool keepOnListOfAvailableDevices);

  /// @brief Method RemoveDeviceUsage, addr 0x63adf14, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitor, addr 0x63bf2b0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitorTimeout, addr 0x63bf4a8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitors, addr 0x63b7ea8, size 0x11c, virtual false, abstract: false, final false
  inline void RemoveStateChangeMonitors(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResetControlPathsRecursive, addr 0x63bbb3c, size 0xe8, virtual false, abstract: false, final false
  static inline void ResetControlPathsRecursive(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ResetCurrentProcessedEventBytesForDevices, addr 0x63be2a0, size 0xc4, virtual false, abstract: false, final false
  inline void ResetCurrentProcessedEventBytesForDevices();

  /// @brief Method ResetDevice, addr 0x63b8020, size 0x654, virtual false, abstract: false, final false
  ...
  /// @brief Method RestoreDevicesAfterDomainReloadIfNecessary, addr 0x63bc234, size 0x4, virtual false, abstract: false, final false
  inline void RestoreDevicesAfterDomainReloadIfNecessary();

  /// @brief Method SetDeviceUsage, addr 0x63b6fb8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRunDeviceInBackground, addr 0x63b78b4, size 0x38, virtual false, abstract: false, final false
  inline bool ShouldRunDeviceInBackground(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ShouldRunUpdate, addr 0x63bcad8, size 0x1c, virtual false, abstract: false, final false
  inline bool ShouldRunUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method SignalStateChangeMonitor, addr 0x63bf5c8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SortStateChangeMonitorsIfNecessary, addr 0x63be6a0, size 0x4c, virtual false, abstract: false, final false
  inline void SortStateChangeMonitorsIfNecessary(int32_t deviceIndex);

  /// @brief Method TryFindMatchingControlLayout, addr 0x63b5ce8, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetDevice, addr 0x63b8ccc, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::System::Type* layoutType);

  /// @brief Method TryGetDevice, addr 0x63b8b1c, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::StringW nameOrLayout);

  /// @brief Method TryGetDeviceById, addr 0x63acfac, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDeviceById(int32_t id);

  /// @brief Method TryLoadControlLayout, addr 0x63ad6dc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TryLoadControlLayout, addr 0x63b6bc8, size 0x1ec, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* TryLoadControlLayout(::System::Type* type);

  /// @brief Method TryMatchDisconnectedDevice, addr 0x63bc238, size 0x2b4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryMatchDisconnectedDevice(::StringW deviceDescriptor);

  /// @brief Method UninstallGlobals, addr 0x63bb2ac, size 0x3a4, virtual false, abstract: false, final false
  inline void UninstallGlobals();

  /// @brief Method Update, addr 0x63b8fc0, size 0x2c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method Update, addr 0x63b8fec, size 0xb8, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method UpdateState, addr 0x63be060, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateState, addr 0x63b8674, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method WarnAboutDevicesFailingToRecreateAfterDomainReload, addr 0x63bc678, size 0x4, virtual false, abstract: false, final false
  inline void WarnAboutDevicesFailingToRecreateAfterDomainReload();

  /// @brief Method WriteStateChange, addr 0x63be9f0, size 0x288, virtual false, abstract: false, final false
  inline void WriteStateChange(::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers buffers, int32_t deviceIndex,
                               ::ByRef<::UnityEngine::InputSystem::LowLevel::InputStateBlock> deviceStateBlock, uint32_t stateOffsetInDevice, void* statePtr, uint32_t stateSizeInBytes,
                               bool flippedBuffers);

  /// @brief Method <TryFindMatchingControlLayout>b__94_0, addr 0x63bfb78, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63bf7f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onActionsChange, addr 0x63b413c, size 0x5c, virtual false, abstract: false, final false
  inline void add_onActionsChange(::System::Action* value);

  /// @brief Method add_onAfterUpdate, addr 0x63b3fcc, size 0x5c, virtual false, abstract: false, final false
  inline void add_onAfterUpdate(::System::Action* value);

  /// @brief Method add_onBeforeUpdate, addr 0x63b3dc8, size 0x64, virtual false, abstract: false, final false
  inline void add_onBeforeUpdate(::System::Action* value);

  /// @brief Method add_onDeviceChange, addr 0x63aad30, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceCommand, addr 0x63b3a0c, size 0x5c, virtual false, abstract: false, final false
  inline void add_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method add_onDeviceStateChange, addr 0x63b3954, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onEvent, addr 0x63aacd4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onFindControlLayoutForDevice, addr 0x63b3ac4, size 0x64, virtual false, abstract: false, final false
  inline void add_onFindControlLayoutForDevice(::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate* value);

  /// @brief Method add_onLayoutChange, addr 0x63aad8c, size 0x5c, virtual false, abstract: false, final false
  inline void add_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method add_onSettingsChange, addr 0x63b4084, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x63b34b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_actions();

  /// @brief Method get_composites, addr 0x63b2c40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_composites();

  /// @brief Method get_defaultUpdateType, addr 0x63b36ec, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_defaultUpdateType();

  /// @brief Method get_devices, addr 0x63ac45c, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_gameHasFocus, addr 0x63b4204, size 0x30, virtual false, abstract: false, final false
  inline bool get_gameHasFocus();

  /// @brief Method get_gameIsPlaying, addr 0x63b41fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_gameIsPlaying();

  /// @brief Method get_gameShouldGetInputRegardlessOfFocus, addr 0x63b4234, size 0x20, virtual false, abstract: false, final false
  inline bool get_gameShouldGetInputRegardlessOfFocus();

  /// @brief Method get_interactions, addr 0x63b2c38, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_interactions();

  /// @brief Method get_isProcessingEvents, addr 0x63b41f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isProcessingEvents();

  /// @brief Method get_metrics, addr 0x63b2c48, size 0x1a0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputMetrics get_metrics();

  /// @brief Method get_optimizedControlsFeatureEnabled, addr 0x63bbb0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_optimizedControlsFeatureEnabled();

  /// @brief Method get_paranoidReadValueCachingChecksEnabled, addr 0x63bbb2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_paranoidReadValueCachingChecksEnabled();

  /// @brief Method get_pollingFrequency, addr 0x63b3820, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pollingFrequency();

  /// @brief Method get_processors, addr 0x63b2c30, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_processors();

  /// @brief Method get_readValueCachingFeatureEnabled, addr 0x63bbb1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_readValueCachingFeatureEnabled();

  /// @brief Method get_scrollDeltaBehavior, addr 0x63b371c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputSettings_ScrollDeltaBehavior get_scrollDeltaBehavior();

  /// @brief Method get_settings, addr 0x63b2de8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputSettings> get_settings();

  /// @brief Method get_updateMask, addr 0x63b3550, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_updateMask();

  /// @brief Method remove_onActionsChange, addr 0x63b4198, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onActionsChange(::System::Action* value);

  /// @brief Method remove_onAfterUpdate, addr 0x63b4028, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onAfterUpdate(::System::Action* value);

  /// @brief Method remove_onBeforeUpdate, addr 0x63b3f70, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onBeforeUpdate(::System::Action* value);

  /// @brief Method remove_onDeviceChange, addr 0x63aaff8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceCommand, addr 0x63b3a68, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method remove_onDeviceStateChange, addr 0x63b39b0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onEvent, addr 0x63aaf9c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onFindControlLayoutForDevice, addr 0x63b3d6c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onLayoutChange, addr 0x63ab054, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method remove_onSettingsChange, addr 0x63b40e0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actions, addr 0x63b34c0, size 0x8, virtual false, abstract: false, final false
  inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method set_optimizedControlsFeatureEnabled, addr 0x63bbb14, size 0x8, virtual false, abstract: false, final false
  inline void set_optimizedControlsFeatureEnabled(bool value);

  /// @brief Method set_paranoidReadValueCachingChecksEnabled, addr 0x63bbb34, size 0x8, virtual false, abstract: false, final false
  inline void set_paranoidReadValueCachingChecksEnabled(bool value);

  /// @brief Method set_pollingFrequency, addr 0x63b3828, size 0x12c, virtual false, abstract: false, final false
  inline void set_pollingFrequency(float_t value);

  /// @brief Method set_readValueCachingFeatureEnabled, addr 0x63bbb24, size 0x8, virtual false, abstract: false, final false
  inline void set_readValueCachingFeatureEnabled(bool value);

  /// @brief Method set_scrollDeltaBehavior, addr 0x63b3724, size 0xfc, virtual false, abstract: false, final false
  inline void set_scrollDeltaBehavior(::UnityEngine::InputSystem::InputSettings_ScrollDeltaBehavior value);

  /// @brief Method set_settings, addr 0x63b2df0, size 0xfc, virtual false, abstract: false, final false
  inline void set_settings(::UnityEngine::InputSystem::InputSettings* value);

  /// @brief Method set_updateMask, addr 0x63b3558, size 0x24, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::InputManager, 0x540>, "Size mismatch!");
