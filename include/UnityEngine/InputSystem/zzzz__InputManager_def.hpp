...
public:
  ...
  /// @brief Method Add, addr 0x64322c4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x6432670, size 0x68, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CompactArrays, addr 0x64326d8, size 0x68, virtual false, abstract: false, final false
  inline void CompactArrays();

  /// @brief Method Remove, addr 0x6432478, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveAt, addr 0x64325cc, size 0xa4, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t i);

  /// @brief Method SortMonitorsByIndex, addr 0x6432740, size 0x168, virtual false, abstract: false, final false
  inline void SortMonitorsByIndex();

  /// @brief Method get_count, addr 0x64322bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <MakeDeviceNameUnique>b__184_0, addr 0x6432900, size 0x24, virtual false, abstract: false, final false
  inline ::StringW _MakeDeviceNameUnique_b__184_0(::UnityEngine::InputSystem::InputDevice* x);

  /// @brief Method .ctor, addr 0x64328fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x6432a70, size 0x960, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputManager__ListControlLayouts_d__97* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x64335c8, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x6433580, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6433668, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6433588, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x64335c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6432944, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x64333d0, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x6433418, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method <>m__Finally3, addr 0x6433460, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally3();

  /// @brief Method <>m__Finally4, addr 0x64334a8, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally4();

  /// @brief Method <>m__Finally5, addr 0x64334f0, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally5();

  /// @brief Method <>m__Finally6, addr 0x6433538, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally6();

  /// @brief Method .ctor, addr 0x6432924, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAvailableDevicesMatchingDescription, addr 0x6427e68, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAvailableDevicesThatAreNowRecognized, addr 0x64261f4, size 0x244, virtual false, abstract: false, final false
  inline void AddAvailableDevicesThatAreNowRecognized();

  /// @brief Method AddDevice, addr 0x642a2e4, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::UnityEngine::InputSystem::Layouts::InputDeviceDescription description);

  /// @brief Method AddDevice, addr 0x642a4d4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x642a328, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x64202e0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x6428e98, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDevice, addr 0x6429900, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* AddDevice(::System::Type* type, ::StringW name);

  /// @brief Method AddDevice, addr 0x642888c, size 0x60c, virtual false, abstract: false, final false
  inline void AddDevice(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method AddDeviceUsage, addr 0x642041c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitor, addr 0x6431820, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddStateChangeMonitorTimeout, addr 0x6431adc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyActions, addr 0x6425b94, size 0x88, virtual false, abstract: false, final false
  inline void ApplyActions();

  /// @brief Method ApplySettings, addr 0x64255b8, size 0x5cc, virtual false, abstract: false, final false
  inline void ApplySettings();

  /// @brief Method AreMaximumEventBytesPerUpdateExceeded, addr 0x643082c, size 0x140, virtual false, abstract: false, final false
  inline bool AreMaximumEventBytesPerUpdateExceeded(uint32_t totalEventBytesProcessed);

  /// @brief Method AssignUniqueDeviceId, addr 0x6429b78, size 0x178, virtual false, abstract: false, final false
  inline void AssignUniqueDeviceId(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method CheckAllDevicesOptimizedControlsHaveValidState, addr 0x6430bd8, size 0x18c, virtual false, abstract: false, final false
  inline void CheckAllDevicesOptimizedControlsHaveValidState();

  /// @brief Method Destroy, addr 0x642d860, size 0x118, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method DontMakeCurrentlyUpdatingDeviceCurrent, addr 0x6430d64, size 0x8, virtual false, abstract: false, final false
  inline void DontMakeCurrentlyUpdatingDeviceCurrent();

  /// @brief Method EnableOrDisableDevice, addr 0x6429fb8, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOrRegisterDeviceLayoutForType, addr 0x6429480, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindOrRegisterDeviceLayoutForType(::System::Type* type);

  /// @brief Method FireStateChangeNotifications, addr 0x6431d84, size 0x140, virtual false, abstract: false, final false
  inline void FireStateChangeNotifications();

  /// @brief Method FireStateChangeNotifications, addr 0x6431344, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipBuffersForDeviceIfNecessary, addr 0x6430ffc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushDisconnectedDevices, addr 0x642a690, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDevice, addr 0x642b2f8, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* GetDevice(::StringW nameOrLayout);

  /// @brief Method GetUnsupportedDevices, addr 0x642b3e4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x642b770, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeActions, addr 0x642b7bc, size 0x94, virtual false, abstract: false, final false
  inline void InitializeActions();

  /// @brief Method InitializeData, addr 0x642b850, size 0x16c0, virtual false, abstract: false, final false
  inline void InitializeData();

  /// @brief Method InitializeDefaultState, addr 0x642e2f0, size 0x1ac, virtual false, abstract: false, final false
  inline void InitializeDefaultState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InitializeDeviceState, addr 0x6429cf0, size 0x290, virtual false, abstract: false, final false
  inline void InitializeDeviceState(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method InstallBeforeUpdateHookIfNecessary, addr 0x64264f8, size 0x144, virtual false, abstract: false, final false
  inline void InstallBeforeUpdateHookIfNecessary();

  /// @brief Method InstallGlobals, addr 0x642d63c, size 0x224, virtual false, abstract: false, final false
  inline void InstallGlobals();

  /// @brief Method InstallRuntime, addr 0x642cf10, size 0x72c, virtual false, abstract: false, final false
  inline void InstallRuntime(::UnityEngine::InputSystem::LowLevel::IInputRuntime* runtime);

  /// @brief Method InvokeAfterUpdateCallback, addr 0x6430680, size 0xac, virtual false, abstract: false, final false
  inline void InvokeAfterUpdateCallback(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method IsControlOrChildUsingLayoutRecursive, addr 0x64279fc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method IsControlUsingLayout, addr 0x6427924, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDeviceLayoutMarkedAsSupportedInSettings, addr 0x6429504, size 0x108, virtual false, abstract: false, final false
  inline bool IsDeviceLayoutMarkedAsSupportedInSettings(::UnityEngine::InputSystem::Utilities::InternedString layoutName);

  /// @brief Method ListControlLayouts, addr 0x642960c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* ListControlLayouts(::StringW basedOn);

  /// @brief Method MakeDeviceNameUnique, addr 0x64299b8, size 0x1c0, virtual false, abstract: false, final false
  inline void MakeDeviceNameUnique(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method MakeEscapedJsonString, addr 0x642ebb8, size 0x18c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::JsonParser_JsonString MakeEscapedJsonString(::StringW theString);

  /// @brief Method MakeStringWithEventsProcessedByDevice, addr 0x6430a30, size 0x1a8, virtual false, abstract: false, final false
  inline ::StringW MakeStringWithEventsProcessedByDevice();

  static inline ::UnityEngine::InputSystem::InputManager* New_ctor();

  /// @brief Method NotifyUsageChanged, addr 0x64297f8, size 0x108, virtual false, abstract: false, final false
  inline void NotifyUsageChanged(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnBeforeUpdate, addr 0x642ed48, size 0x210, virtual false, abstract: false, final false
  inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method OnFocusChanged, addr 0x642ef58, size 0x24c, virtual false, abstract: false, final false
  inline void OnFocusChanged(bool focus);

  /// @brief Method OnNativeDeviceDiscovered, addr 0x642e49c, size 0x464, virtual false, abstract: false, final false
  inline void OnNativeDeviceDiscovered(int32_t deviceId, ::StringW deviceDescriptor);

  /// @brief Method OnUpdate, addr 0x642f1c0, size 0x11ec, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformLayoutPostRegistration, addr 0x6426ee4, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessStateChangeMonitorTimeouts, addr 0x64303ac, size 0x2d4, virtual false, abstract: false, final false
  inline void ProcessStateChangeMonitorTimeouts();

  /// @brief Method ProcessStateChangeMonitors, addr 0x6430db8, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x642b5b0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method QueueEvent, addr 0x64205dc, size 0x4, virtual false, abstract: false, final false
  inline void QueueEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr ptr);

  /// @brief Method ReallocateStateBuffers, addr 0x6425c48, size 0x170, virtual false, abstract: false, final false
  inline void ReallocateStateBuffers();

  /// @brief Method RecreateDevice, addr 0x6427b00, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method RecreateDevicesUsingLayout, addr 0x64276ac, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method RecreateDevicesUsingLayoutWithInferiorMatch, addr 0x6427c50, size 0x218, virtual false, abstract: false, final false
  inline void RecreateDevicesUsingLayoutWithInferiorMatch(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher deviceMatcher);

  /// @brief Method RegisterControlLayout, addr 0x641fdb8, size 0x528, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW json, ::StringW name, bool isOverride);

  /// @brief Method RegisterControlLayout, addr 0x6426920, size 0x5c4, virtual false, abstract: false, final false
  inline void RegisterControlLayout(::StringW name, ::System::Type* type);

  /// @brief Method RegisterControlLayoutBuilder, addr 0x6427508, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterControlLayoutMatcher, addr 0x64273b0, size 0x158, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::StringW layoutName, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RegisterControlLayoutMatcher, addr 0x64281d0, size 0x1e4, virtual false, abstract: false, final false
  inline void RegisterControlLayoutMatcher(::System::Type* type, ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher);

  /// @brief Method RegisterCustomTypes, addr 0x642dd1c, size 0x250, virtual false, abstract: false, final false
  inline void RegisterCustomTypes();

  /// @brief Method RegisterCustomTypes, addr 0x642df6c, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveControlLayout, addr 0x642901c, size 0x278, virtual false, abstract: false, final false
  inline void RemoveControlLayout(::StringW name);

  /// @brief Method RemoveDevice, addr 0x641f7fc, size 0x550, virtual false, abstract: false, final false
  inline void RemoveDevice(::UnityEngine::InputSystem::InputDevice* device, bool keepOnListOfAvailableDevices);

  /// @brief Method RemoveDeviceUsage, addr 0x64205e0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitor, addr 0x643197c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitorTimeout, addr 0x6431b74, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStateChangeMonitors, addr 0x642a574, size 0x11c, virtual false, abstract: false, final false
  inline void RemoveStateChangeMonitors(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ResetControlPathsRecursive, addr 0x642e208, size 0xe8, virtual false, abstract: false, final false
  static inline void ResetControlPathsRecursive(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ResetCurrentProcessedEventBytesForDevices, addr 0x643096c, size 0xc4, virtual false, abstract: false, final false
  inline void ResetCurrentProcessedEventBytesForDevices();

  /// @brief Method ResetDevice, addr 0x642a6ec, size 0x654, virtual false, abstract: false, final false
  ...
  /// @brief Method RestoreDevicesAfterDomainReloadIfNecessary, addr 0x642e900, size 0x4, virtual false, abstract: false, final false
  inline void RestoreDevicesAfterDomainReloadIfNecessary();

  /// @brief Method SetDeviceUsage, addr 0x6429684, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRunDeviceInBackground, addr 0x6429f80, size 0x38, virtual false, abstract: false, final false
  inline bool ShouldRunDeviceInBackground(::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method ShouldRunUpdate, addr 0x642f1a4, size 0x1c, virtual false, abstract: false, final false
  inline bool ShouldRunUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method SignalStateChangeMonitor, addr 0x6431c94, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SortStateChangeMonitorsIfNecessary, addr 0x6430d6c, size 0x4c, virtual false, abstract: false, final false
  inline void SortStateChangeMonitorsIfNecessary(int32_t deviceIndex);

  /// @brief Method TryFindMatchingControlLayout, addr 0x64283b4, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetDevice, addr 0x642b398, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::System::Type* layoutType);

  /// @brief Method TryGetDevice, addr 0x642b1e8, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDevice(::StringW nameOrLayout);

  /// @brief Method TryGetDeviceById, addr 0x641f678, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryGetDeviceById(int32_t id);

  /// @brief Method TryLoadControlLayout, addr 0x641fda8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method TryLoadControlLayout, addr 0x6429294, size 0x1ec, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* TryLoadControlLayout(::System::Type* type);

  /// @brief Method TryMatchDisconnectedDevice, addr 0x642e904, size 0x2b4, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* TryMatchDisconnectedDevice(::StringW deviceDescriptor);

  /// @brief Method UninstallGlobals, addr 0x642d978, size 0x3a4, virtual false, abstract: false, final false
  inline void UninstallGlobals();

  /// @brief Method Update, addr 0x642b68c, size 0x2c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method Update, addr 0x642b6b8, size 0xb8, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateType);

  /// @brief Method UpdateState, addr 0x643072c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateState, addr 0x642ad40, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method WarnAboutDevicesFailingToRecreateAfterDomainReload, addr 0x642ed44, size 0x4, virtual false, abstract: false, final false
  inline void WarnAboutDevicesFailingToRecreateAfterDomainReload();

  /// @brief Method WriteStateChange, addr 0x64310bc, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method <TryFindMatchingControlLayout>b__94_0, addr 0x6432244, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6431ec4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onActionsChange, addr 0x6426808, size 0x5c, virtual false, abstract: false, final false
  inline void add_onActionsChange(::System::Action* value);

  /// @brief Method add_onAfterUpdate, addr 0x6426698, size 0x5c, virtual false, abstract: false, final false
  inline void add_onAfterUpdate(::System::Action* value);

  /// @brief Method add_onBeforeUpdate, addr 0x6426494, size 0x64, virtual false, abstract: false, final false
  inline void add_onBeforeUpdate(::System::Action* value);

  /// @brief Method add_onDeviceChange, addr 0x641d3fc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onDeviceCommand, addr 0x64260d8, size 0x5c, virtual false, abstract: false, final false
  inline void add_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method add_onDeviceStateChange, addr 0x6426020, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onEvent, addr 0x641d3a0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onFindControlLayoutForDevice, addr 0x6426190, size 0x64, virtual false, abstract: false, final false
  inline void add_onFindControlLayoutForDevice(::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate* value);

  /// @brief Method add_onLayoutChange, addr 0x641d458, size 0x5c, virtual false, abstract: false, final false
  inline void add_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method add_onSettingsChange, addr 0x6426750, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_actions, addr 0x6425b84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_actions();

  /// @brief Method get_composites, addr 0x642530c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_composites();

  /// @brief Method get_defaultUpdateType, addr 0x6425db8, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_defaultUpdateType();

  /// @brief Method get_devices, addr 0x641eb28, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices();

  /// @brief Method get_gameHasFocus, addr 0x64268d0, size 0x30, virtual false, abstract: false, final false
  inline bool get_gameHasFocus();

  /// @brief Method get_gameIsPlaying, addr 0x64268c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_gameIsPlaying();

  /// @brief Method get_gameShouldGetInputRegardlessOfFocus, addr 0x6426900, size 0x20, virtual false, abstract: false, final false
  inline bool get_gameShouldGetInputRegardlessOfFocus();

  /// @brief Method get_interactions, addr 0x6425304, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_interactions();

  /// @brief Method get_isProcessingEvents, addr 0x64268c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isProcessingEvents();

  /// @brief Method get_metrics, addr 0x6425314, size 0x1a0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputMetrics get_metrics();

  /// @brief Method get_optimizedControlsFeatureEnabled, addr 0x642e1d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_optimizedControlsFeatureEnabled();

  /// @brief Method get_paranoidReadValueCachingChecksEnabled, addr 0x642e1f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_paranoidReadValueCachingChecksEnabled();

  /// @brief Method get_pollingFrequency, addr 0x6425eec, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pollingFrequency();

  /// @brief Method get_processors, addr 0x64252fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::TypeTable get_processors();

  /// @brief Method get_readValueCachingFeatureEnabled, addr 0x642e1e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_readValueCachingFeatureEnabled();

  /// @brief Method get_scrollDeltaBehavior, addr 0x6425de8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputSettings_ScrollDeltaBehavior get_scrollDeltaBehavior();

  /// @brief Method get_settings, addr 0x64254b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputSettings> get_settings();

  /// @brief Method get_updateMask, addr 0x6425c1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_updateMask();

  /// @brief Method remove_onActionsChange, addr 0x6426864, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onActionsChange(::System::Action* value);

  /// @brief Method remove_onAfterUpdate, addr 0x64266f4, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onAfterUpdate(::System::Action* value);

  /// @brief Method remove_onBeforeUpdate, addr 0x642663c, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onBeforeUpdate(::System::Action* value);

  /// @brief Method remove_onDeviceChange, addr 0x641d6c4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDeviceCommand, addr 0x6426134, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate* value);

  /// @brief Method remove_onDeviceStateChange, addr 0x642607c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onEvent, addr 0x641d668, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onFindControlLayoutForDevice, addr 0x6426438, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onLayoutChange, addr 0x641d720, size 0x5c, virtual false, abstract: false, final false
  inline void remove_onLayoutChange(::System::Action_2<::StringW, ::UnityEngine::InputSystem::InputControlLayoutChange>* value);

  /// @brief Method remove_onSettingsChange, addr 0x64267ac, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_actions, addr 0x6425b8c, size 0x8, virtual false, abstract: false, final false
  inline void set_actions(::UnityEngine::InputSystem::InputActionAsset* value);

  /// @brief Method set_optimizedControlsFeatureEnabled, addr 0x642e1e0, size 0x8, virtual false, abstract: false, final false
  inline void set_optimizedControlsFeatureEnabled(bool value);

  /// @brief Method set_paranoidReadValueCachingChecksEnabled, addr 0x642e200, size 0x8, virtual false, abstract: false, final false
  inline void set_paranoidReadValueCachingChecksEnabled(bool value);

  /// @brief Method set_pollingFrequency, addr 0x6425ef4, size 0x12c, virtual false, abstract: false, final false
  inline void set_pollingFrequency(float_t value);

  /// @brief Method set_readValueCachingFeatureEnabled, addr 0x642e1f0, size 0x8, virtual false, abstract: false, final false
  inline void set_readValueCachingFeatureEnabled(bool value);

  /// @brief Method set_scrollDeltaBehavior, addr 0x6425df0, size 0xfc, virtual false, abstract: false, final false
  inline void set_scrollDeltaBehavior(::UnityEngine::InputSystem::InputSettings_ScrollDeltaBehavior value);

  /// @brief Method set_settings, addr 0x64254bc, size 0xfc, virtual false, abstract: false, final false
  inline void set_settings(::UnityEngine::InputSystem::InputSettings* value);

  /// @brief Method set_updateMask, addr 0x6425c24, size 0x24, virtual false, abstract: false, final false
