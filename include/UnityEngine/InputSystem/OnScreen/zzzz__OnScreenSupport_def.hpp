...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x659f888, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OnScreenSupport", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OnScreenSupport(OnScreenSupport&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OnScreenSupport", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OnScreenSupport(OnScreenSupportconst&) = delete;
