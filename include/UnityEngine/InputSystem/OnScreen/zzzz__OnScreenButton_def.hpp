...
public:
  ...
  /// @brief Method OnPointerDown, addr 0x45f9154, size 0x4c, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x45f9108, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x45f91b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_controlPathInternal, addr 0x45f91a0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_controlPathInternal, addr 0x45f91a8, size 0x8, virtual true, abstract: false, final false
