...
public:
  ...
  /// @brief Method OnPointerDown, addr 0x6597238, size 0x50, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerUp, addr 0x65971e8, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6597298, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_controlPathInternal, addr 0x6597288, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_controlPathInternal, addr 0x6597290, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::InputSystem::OnScreen::OnScreenButton) == 0x40, "Size mismatch!");
