...
/// @brief Method OnPointerDown, addr 0x645a46c, size 0x50, virtual true, abstract: false, final true
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerUp, addr 0x645a41c, size 0x50, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x645a4cc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_controlPathInternal, addr 0x645a4bc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_controlPathInternal, addr 0x645a4c4, size 0x8, virtual true, abstract: false, final false
