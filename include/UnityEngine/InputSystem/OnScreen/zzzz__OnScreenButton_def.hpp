...
namespace UnityEngine::InputSystem::OnScreen {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5647))]
...
public:
  ...
  /// @brief Method OnPointerUp, addr 0x2ad9634, size 0x4c, virtual true, abstract: false, final true
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x2ad9680, size 0x4c, virtual true, abstract: false, final true
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method get_controlPathInternal, addr 0x2ad96cc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_controlPathInternal();

  /// @brief Method set_controlPathInternal, addr 0x2ad96d4, size 0x8, virtual true, abstract: false, final false
  inline void set_controlPathInternal(::StringW value);

  static inline ::UnityEngine::InputSystem::OnScreen::OnScreenButton* New_ctor();

  /// @brief Method .ctor, addr 0x2ad96dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
