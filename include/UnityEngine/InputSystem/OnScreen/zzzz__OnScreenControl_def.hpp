...
public:
  // Declarations
  /// @brief Method AddControl, addr 0x45f812c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x45f8088, size 0xa4, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method RemoveControl, addr 0x45f848c, size 0x110, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnDisable, addr 0x45f8290, size 0x1fc, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x45f828c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method SentDefaultValueToControl, addr 0x45f8158, size 0x134, virtual false, abstract: false, final false
  inline void SentDefaultValueToControl();

  /// @brief Method SetupInputControl, addr 0x45f7968, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45f791c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_control, addr 0x45f8080, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_controlPath, addr 0x45f7924, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_controlPath, addr 0x45f7930, size 0x38, virtual false, abstract: false, final false
