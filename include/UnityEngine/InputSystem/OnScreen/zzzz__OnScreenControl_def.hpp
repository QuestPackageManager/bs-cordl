...
namespace UnityEngine::InputSystem::OnScreen {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6536)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9999), inst: 741 }),
...
namespace UnityEngine::InputSystem::OnScreen {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6536)), TypeDefinitionIndex(TypeDefinitionIndex(10225)), TypeDefinitionIndex(TypeDefinitionIndex(6669)),
