...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6236)), TypeDefinitionIndex(TypeDefinitionIndex(10252)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6236), inst:
// 3342 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6583)) CS Name: ::UnityEngine.InputSystem.Processors::CompensateRotationProcessor*
class CORDL_TYPE CompensateRotationProcessor : public ::UnityEngine::InputSystem::InputProcessor_1<::UnityEngine::Quaternion> {
public:
  // Declarations
  /// @brief Method Process, addr 0x2af90bc, size 0x210, virtual true, abstract: false, final false
  inline ::UnityEngine::Quaternion Process(::UnityEngine::Quaternion value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x2af92cc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::UnityEngine::InputSystem::Processors::CompensateRotationProcessor* New_ctor();

  /// @brief Method .ctor, addr 0x2af930c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
