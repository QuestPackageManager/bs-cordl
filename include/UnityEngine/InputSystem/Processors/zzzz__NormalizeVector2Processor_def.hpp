...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::NormalizeVector2Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::NormalizeVector2Processor*, "UnityEngine.InputSystem.Processors", "NormalizeVector2Processor");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NormalizeVector2Processor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NormalizeVector2Processor(NormalizeVector2Processor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NormalizeVector2Processor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NormalizeVector2Processor(NormalizeVector2Processorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::NormalizeVector2Processor) == 0x10, "Size mismatch!");
