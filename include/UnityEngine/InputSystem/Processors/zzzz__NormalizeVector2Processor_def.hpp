...
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5847)) CS Name: ::UnityEngine.InputSystem.Processors::NormalizeVector2Processor*
class CORDL_TYPE NormalizeVector2Processor : public ::UnityEngine::InputSystem::InputProcessor_1<::UnityEngine::Vector2> {
public:
  // Declarations
  /// @brief Method Process, addr 0x2afa3e4, size 0xb4, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x2afa498, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::UnityEngine::InputSystem::Processors::NormalizeVector2Processor* New_ctor();

  /// @brief Method .ctor, addr 0x2afa4d8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
