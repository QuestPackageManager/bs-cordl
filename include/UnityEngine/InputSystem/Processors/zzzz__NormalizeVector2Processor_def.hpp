...
public:
  ...
  /// @brief Method Process, addr 0x318c6f0, size 0xb4, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x318c7a4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x318c7e4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
