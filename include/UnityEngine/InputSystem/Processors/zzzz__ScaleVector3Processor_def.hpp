...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::ScaleVector3Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::ScaleVector3Processor*, "UnityEngine.InputSystem.Processors", "ScaleVector3Processor");
...
public:
  ...
  /// @brief Method Process, addr 0x65bf2c0, size 0x18, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65bf2d8, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65bf3b0, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScaleVector3Processor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScaleVector3Processor(ScaleVector3Processor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScaleVector3Processor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScaleVector3Processor(ScaleVector3Processorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::ScaleVector3Processor) == 0x20, "Size mismatch!");
