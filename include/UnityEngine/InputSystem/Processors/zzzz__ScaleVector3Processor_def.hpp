...
public:
  ...
  /// @brief Method Process, addr 0x647b164, size 0x18, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647b17c, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647b254, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
