...
public:
  ...
  /// @brief Method Process, addr 0x461928c, size 0x10, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x461929c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x461933c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
