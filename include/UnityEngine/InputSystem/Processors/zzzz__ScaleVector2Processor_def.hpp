...
// TypeDefinitionIndex(TypeDefinitionIndex(6236))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6591)) CS Name: ::UnityEngine.InputSystem.Processors::ScaleVector2Processor*
