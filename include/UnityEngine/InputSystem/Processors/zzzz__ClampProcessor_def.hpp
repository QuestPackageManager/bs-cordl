...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::ClampProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::ClampProcessor*, "UnityEngine.InputSystem.Processors", "ClampProcessor");
...
public:
  ...
  /// @brief Method Process, addr 0x65be29c, size 0x18, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65be2b4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65be368, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClampProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClampProcessor(ClampProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClampProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClampProcessor(ClampProcessorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::ClampProcessor) == 0x18, "Size mismatch!");
