...
public:
  ...
  /// @brief Method Process, addr 0x647a140, size 0x18, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647a158, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647a20c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
