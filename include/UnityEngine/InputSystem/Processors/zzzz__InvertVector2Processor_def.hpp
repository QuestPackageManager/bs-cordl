...
// TypeDefinitionIndex(TypeDefinitionIndex(6236))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6585)) CS Name: ::UnityEngine.InputSystem.Processors::InvertVector2Processor*
