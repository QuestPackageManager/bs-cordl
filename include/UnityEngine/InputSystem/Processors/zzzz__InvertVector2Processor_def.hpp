...
public:
  ...
  /// @brief Method Process, addr 0x647a808, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647a82c, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647a8e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
