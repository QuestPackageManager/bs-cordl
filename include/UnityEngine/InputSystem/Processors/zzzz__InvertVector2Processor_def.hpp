...
public:
  ...
  /// @brief Method Process, addr 0x640813c, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x6408160, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6408214, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
