...
public:
  ...
  /// @brief Method Process, addr 0x3167a94, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x3167ab8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3167b58, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
