...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::NormalizeVector3Processor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::NormalizeVector3Processor*, "UnityEngine.InputSystem.Processors", "NormalizeVector3Processor");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NormalizeVector3Processor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NormalizeVector3Processor(NormalizeVector3Processor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NormalizeVector3Processor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NormalizeVector3Processor(NormalizeVector3Processorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::NormalizeVector3Processor) == 0x10, "Size mismatch!");
