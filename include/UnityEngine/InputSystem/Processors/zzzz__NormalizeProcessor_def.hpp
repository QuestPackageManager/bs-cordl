...
public:
  ...
  /// @brief Method Process, addr 0x2afa1b4, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method Normalize, addr 0x2afa1c0, size 0xd0, virtual false, abstract: false, final false
  static inline float_t Normalize(float_t value, float_t min, float_t max, float_t zero);

  /// @brief Method Denormalize, addr 0x2afa290, size 0x48, virtual false, abstract: false, final false
  static inline float_t Denormalize(float_t value, float_t min, float_t max, float_t zero);

  /// @brief Method ToString, addr 0x2afa2d8, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  static inline ::UnityEngine::InputSystem::Processors::NormalizeProcessor* New_ctor();

  /// @brief Method .ctor, addr 0x2afa39c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
