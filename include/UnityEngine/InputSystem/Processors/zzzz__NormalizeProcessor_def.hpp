...
public:
  ...
  /// @brief Method Denormalize, addr 0x302704c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x3026f7c, size 0xd0, virtual false, abstract: false, final false
  static inline float_t Normalize(float_t value, float_t min, float_t max, float_t zero);

  /// @brief Method Process, addr 0x3026f70, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x3027094, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3027158, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
