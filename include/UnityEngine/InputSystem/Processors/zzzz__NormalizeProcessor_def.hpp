...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::NormalizeProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::NormalizeProcessor*, "UnityEngine.InputSystem.Processors", "NormalizeProcessor");
...
public:
  ...
  /// @brief Method Denormalize, addr 0x65becc8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x65bebec, size 0xdc, virtual false, abstract: false, final false
  static inline float_t Normalize(float_t value, float_t min, float_t max, float_t zero);

  /// @brief Method Process, addr 0x65bebe0, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65bed10, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65bede8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NormalizeProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NormalizeProcessor(NormalizeProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NormalizeProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NormalizeProcessor(NormalizeProcessorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::NormalizeProcessor) == 0x20, "Size mismatch!");
