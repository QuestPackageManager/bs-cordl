...
public:
  ...
  /// @brief Method Denormalize, addr 0x647ab6c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x647aa90, size 0xdc, virtual false, abstract: false, final false
  static inline float_t Normalize(float_t value, float_t min, float_t max, float_t zero);

  /// @brief Method Process, addr 0x647aa84, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647abb4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647ac8c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
