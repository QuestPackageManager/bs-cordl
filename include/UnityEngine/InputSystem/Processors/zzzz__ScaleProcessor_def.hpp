...
/// @brief Method Process, addr 0x6408f60, size 0xc, virtual true, abstract: false, final false
inline float_t Process(float_t  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x6408f6c, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6409004, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
