...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::ScaleProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::ScaleProcessor*, "UnityEngine.InputSystem.Processors", "ScaleProcessor");
...
public:
  ...
  /// @brief Method Process, addr 0x65b98b0, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65b98bc, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65b9954, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::ScaleProcessor) == 0x18, "Size mismatch!");
