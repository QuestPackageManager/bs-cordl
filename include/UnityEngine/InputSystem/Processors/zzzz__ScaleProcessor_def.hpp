...
public:
  ...
  /// @brief Method Process, addr 0x647af6c, size 0xc, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x647af78, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x647b010, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
