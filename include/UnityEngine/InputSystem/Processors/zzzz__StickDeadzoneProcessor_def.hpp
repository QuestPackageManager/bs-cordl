...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StickDeadzoneProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StickDeadzoneProcessor(StickDeadzoneProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StickDeadzoneProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StickDeadzoneProcessor(StickDeadzoneProcessorconst&) = delete;
