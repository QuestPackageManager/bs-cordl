...
public:
  ...
  /// @brief Method GetDeadZoneAdjustedValue, addr 0x319eccc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x319ebfc, size 0xd0, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2 value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x319ed34, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x319eddc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x319eb8c, size 0x70, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x319eb1c, size 0x70, virtual false, abstract: false, final false
