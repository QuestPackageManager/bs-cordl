...
public:
  ...
  /// @brief Method Process, addr 0x461cad8, size 0x68, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x461cb40, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x461cbe8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x461ca68, size 0x70, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x461c9f8, size 0x70, virtual false, abstract: false, final false
