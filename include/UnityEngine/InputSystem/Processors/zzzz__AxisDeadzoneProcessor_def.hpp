...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Processors::AxisDeadzoneProcessor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Processors::AxisDeadzoneProcessor*, "UnityEngine.InputSystem.Processors", "AxisDeadzoneProcessor");
...
public:
  ...
  /// @brief Method Process, addr 0x65be134, size 0x70, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x65be1a4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65be260, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x65be0c0, size 0x74, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x65be04c, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AxisDeadzoneProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AxisDeadzoneProcessor(AxisDeadzoneProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AxisDeadzoneProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AxisDeadzoneProcessor(AxisDeadzoneProcessorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::InputSystem::Processors::AxisDeadzoneProcessor) == 0x18, "Size mismatch!");
