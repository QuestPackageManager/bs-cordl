...
public:
  ...
  /// @brief Method Process, addr 0x4616c1c, size 0x68, virtual true, abstract: false, final false
  inline float_t Process(float_t value, ::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ToString, addr 0x4616c84, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4616d2c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxOrDefault, addr 0x4616bac, size 0x70, virtual false, abstract: false, final false
  inline float_t get_maxOrDefault();

  /// @brief Method get_minOrDefault, addr 0x4616b3c, size 0x70, virtual false, abstract: false, final false
