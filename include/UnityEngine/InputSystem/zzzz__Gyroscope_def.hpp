...
public:
  ...
  /// @brief Method get_angularVelocity addr 0x2929088 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_angularVelocity();

  /// @brief Method set_angularVelocity addr 0x2929090 size 0x8 virtual false final false
  inline void set_angularVelocity(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method get_current addr 0x2929098 size 0x48 virtual false final false
  static inline ::UnityEngine::InputSystem::Gyroscope* get_current();

  /// @brief Method set_current addr 0x29290e0 size 0x4c virtual false final false
  static inline void set_current(::UnityEngine::InputSystem::Gyroscope* value);

  /// @brief Method MakeCurrent addr 0x292912c size 0x54 virtual true final false
  inline void MakeCurrent();

  /// @brief Method OnRemoved addr 0x2929180 size 0x84 virtual true final false
  inline void OnRemoved();

  /// @brief Method FinishSetup addr 0x2929204 size 0x78 virtual true final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Gyroscope* New_ctor();

  /// @brief Method .ctor addr 0x292927c size 0x8 virtual false final false
  inline void _ctor();
