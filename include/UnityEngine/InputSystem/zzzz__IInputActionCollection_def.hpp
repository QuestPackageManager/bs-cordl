...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::IInputActionCollection*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::IInputActionCollection*, "UnityEngine.InputSystem", "IInputActionCollection");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IInputActionCollection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInputActionCollection(IInputActionCollectionconst&) = delete;
