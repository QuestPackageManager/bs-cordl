...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6301)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
...
public:
  ...
  /// @brief Method get_enabled addr 0x2ae0184 size 0x50 virtual false final false
  static inline bool get_enabled();

  /// @brief Method Enable addr 0x2ae01d4 size 0x174 virtual false final false
  static inline void Enable();

  /// @brief Method Disable addr 0x2ae0528 size 0x198 virtual false final false
  static inline void Disable();

  /// @brief Method Reset addr 0x2ae0884 size 0xa4 virtual false final false
  static inline void Reset();

  /// @brief Method SetUpState addr 0x2ae0348 size 0x1e0 virtual false final false
  static inline void SetUpState();

  /// @brief Method TearDownState addr 0x2ae06c0 size 0x1c4 virtual false final false
  static inline void TearDownState();

  /// @brief Method OnDeviceChange addr 0x2ae0928 size 0x114 virtual false final false
  ...
  /// @brief Method OnSettingsChange addr 0x2ae0a3c size 0x98 virtual false final false
  static inline void OnSettingsChange();

  /// @brief Method CheckEnabled addr 0x2ae0ad4 size 0x9c virtual false final false
