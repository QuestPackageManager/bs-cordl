...
public:
  ...
  /// @brief Method CheckValid, addr 0x64659c8, size 0x94, virtual false, abstract: false, final false
  inline void CheckValid();

  /// @brief Method GetEnumerator, addr 0x6465804, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::EnhancedTouch::Touch>* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6465884, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x64628e4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x6465888, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x6465890, size 0x138, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x6465b40, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x6465a5c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x6465a84, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6465ad0, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6465870, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::EnhancedTouch::TouchHistory owner);

  /// @brief Method get_Current, addr 0x6465a90, size 0x40, virtual true, abstract: false, final true
