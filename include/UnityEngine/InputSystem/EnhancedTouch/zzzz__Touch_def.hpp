...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5812))]
...
public:
  // Declarations
  /// @brief Method AddFingers, addr 0x2ae4bac, size 0x118, virtual false, abstract: false, final false
  inline void AddFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveFingers, addr 0x2ae4da8, size 0x144, virtual false, abstract: false, final false
  inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method Destroy, addr 0x2ae5208, size 0x84, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method UpdateActiveFingers, addr 0x2ae40bc, size 0xf4, virtual false, abstract: false, final false
  inline void UpdateActiveFingers();

  /// @brief Method UpdateActiveTouches, addr 0x2ae39cc, size 0x5c0, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2323)), TypeDefinitionIndex(TypeDefinitionIndex(5547)), TypeDefinitionIndex(TypeDefinitionIndex(5673)),
// TypeDefinitionIndex(TypeDefinitionIndex(5675)), TypeDefinitionIndex(TypeDefinitionIndex(5919)), TypeDefinitionIndex(TypeDefinitionIndex(5928)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2323), inst: 308 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5919), inst: 984 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5928), inst: 3103 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5674)) CS Name: ::Touch::GlobalState
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ae52f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SaveAndResetState>b__78_0, addr 0x2ae5300, size 0x84, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__78_0(ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState> state);

  /// @brief Method <SaveAndResetState>b__78_1, addr 0x2ae5384, size 0x4, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5674)), TypeDefinitionIndex(TypeDefinitionIndex(5773)), TypeDefinitionIndex(TypeDefinitionIndex(5835)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5835), inst: 3878 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5678)) CS Name:
...
public:
  ...
  /// @brief Method get_valid, addr 0x2ae27e0, size 0x48, virtual false, abstract: false, final false
  inline bool get_valid();

  /// @brief Method get_finger, addr 0x2ae3634, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger();

  /// @brief Method get_phase, addr 0x2ae3620, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::TouchPhase get_phase();

  /// @brief Method get_began, addr 0x2ae3684, size 0x1c, virtual false, abstract: false, final false
  inline bool get_began();

  /// @brief Method get_inProgress, addr 0x2ae36a0, size 0x50, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_ended, addr 0x2ae36f0, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ended();

  /// @brief Method get_touchId, addr 0x2ae360c, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_touchId();

  /// @brief Method get_pressure, addr 0x2ae372c, size 0x14, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x2ae3740, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_startTime, addr 0x2ae3754, size 0x14, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_time, addr 0x2ae3768, size 0x48, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_screen, addr 0x2ae37b0, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x2ae28e0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_startScreenPosition, addr 0x2ae37cc, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_startScreenPosition();

  /// @brief Method get_delta, addr 0x2ae37e0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_tapCount, addr 0x2ae37f4, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_tapCount();

  /// @brief Method get_isTap, addr 0x2ae3808, size 0x18, virtual false, abstract: false, final false
  inline bool get_isTap();

  /// @brief Method get_isInProgress, addr 0x2ae2900, size 0x34, virtual false, abstract: false, final false
  inline bool get_isInProgress();

  /// @brief Method get_updateStepCount, addr 0x2ae2934, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_updateStepCount();

  /// @brief Method get_uniqueId, addr 0x2ae35f8, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_uniqueId();

  /// @brief Method get_state, addr 0x2ae363c, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::LowLevel::TouchState> get_state();

  /// @brief Method get_extraData, addr 0x2ae382c, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__ExtraDataPerTouchState> get_extraData();

  /// @brief Method get_history, addr 0x2ae3874, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history();

  /// @brief Method get_activeTouches, addr 0x2ae392c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_fingers, addr 0x2ae3f8c, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers();

  /// @brief Method get_activeFingers, addr 0x2ae401c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_screens, addr 0x2ae41b0, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Touchscreen*>* get_screens();

  /// @brief Method add_onFingerDown, addr 0x2ae423c, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerDown, addr 0x2ae4304, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerUp, addr 0x2ae43cc, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerUp(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerUp, addr 0x2ae4494, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerUp(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerMove, addr 0x2ae455c, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerMove, addr 0x2ae4624, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method get_maxHistoryLengthPerFinger, addr 0x2ae2cd4, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_maxHistoryLengthPerFinger();

  /// @brief Method .ctor, addr 0x2ae28f4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2ae46ec, size 0x2bc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Equals, addr 0x2ae49a8, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch other);

  /// @brief Method Equals, addr 0x2ae4a1c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2ae4aac, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method AddTouchscreen, addr 0x2ae4b20, size 0x8c, virtual false, abstract: false, final false
  static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveTouchscreen, addr 0x2ae4cc4, size 0xe4, virtual false, abstract: false, final false
  static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method BeginUpdate, addr 0x2ae4eec, size 0x74, virtual false, abstract: false, final false
  static inline void BeginUpdate();

  /// @brief Method CreateGlobalState, addr 0x2ae4f60, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState CreateGlobalState();

  /// @brief Method SaveAndResetState, addr 0x2ae4f8c, size 0x218, virtual false, abstract: false, final false
