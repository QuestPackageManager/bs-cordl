...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::EnhancedTouch::Touch_ExtraDataPerTouchState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/ExtraDataPerTouchState");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::EnhancedTouch::Touch_FingerAndTouchState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/FingerAndTouchState");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::EnhancedTouch::Touch_GlobalState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/GlobalState");
...
public:
  ...
  /// @brief Method AddTouchscreen, addr 0x65a6324, size 0x94, virtual false, abstract: false, final false
  static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method BeginUpdate, addr 0x65a9554, size 0x78, virtual false, abstract: false, final false
  static inline void BeginUpdate();

  /// @brief Method CreateGlobalState, addr 0x65a95cc, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::EnhancedTouch::Touch_GlobalState CreateGlobalState();

  /// @brief Method Equals, addr 0x65a919c, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x65a90e8, size 0xb4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch other);

  /// @brief Method GetHashCode, addr 0x65a923c, size 0xa0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method RemoveTouchscreen, addr 0x65a63b8, size 0xe8, virtual false, abstract: false, final false
  static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method SaveAndResetState, addr 0x65a95ec, size 0x224, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ISavedState* SaveAndResetState();

  /// @brief Method ToString, addr 0x65a8df8, size 0x2f0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x65a6938, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onFingerDown, addr 0x65a8930, size 0xcc, virtual false, abstract: false, final false
  static inline void add_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerMove, addr 0x65a8c60, size 0xcc, virtual false, abstract: false, final false
  static inline void add_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerUp, addr 0x65a8ac8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeFingers, addr 0x65a8708, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeTouches, addr 0x65a7f98, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_began, addr 0x65a78f4, size 0x64, virtual false, abstract: false, final false
  inline bool get_began();

  /// @brief Method get_delta, addr 0x65a7cc0, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_displayIndex, addr 0x65a7df0, size 0x60, virtual false, abstract: false, final false
  inline int32_t get_displayIndex();

  /// @brief Method get_ended, addr 0x65a7a04, size 0x8c, virtual false, abstract: false, final false
  inline bool get_ended();

  /// @brief Method get_extraData, addr 0x65a7e50, size 0x4c, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::InputSystem::EnhancedTouch::Touch_ExtraDataPerTouchState> get_extraData();

  /// @brief Method get_finger, addr 0x65a78a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger();

  /// @brief Method get_fingers, addr 0x65a8690, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers();

  /// @brief Method get_history, addr 0x65a7e9c, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history();

  /// @brief Method get_inProgress, addr 0x65a7958, size 0xac, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_isInProgress, addr 0x65a6944, size 0x6c, virtual false, abstract: false, final false
  inline bool get_isInProgress();

  /// @brief Method get_isTap, addr 0x65a7d80, size 0x64, virtual false, abstract: false, final false
  inline bool get_isTap();

  /// @brief Method get_maxHistoryLengthPerFinger, addr 0x65a6dc8, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_maxHistoryLengthPerFinger();

  /// @brief Method get_phase, addr 0x65a7840, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::TouchPhase get_phase();

  /// @brief Method get_pressure, addr 0x65a7a90, size 0x60, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x65a7af0, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_screen, addr 0x65a7bfc, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x65a68d8, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_screens, addr 0x65a889c, size 0x94, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Touchscreen*>* get_screens();

  /// @brief Method get_startScreenPosition, addr 0x65a7c60, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_startScreenPosition();

  /// @brief Method get_startTime, addr 0x65a7b50, size 0x60, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_state, addr 0x65a78a8, size 0x4c, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::InputSystem::LowLevel::TouchState> get_state();

  /// @brief Method get_tapCount, addr 0x65a7d20, size 0x60, virtual false, abstract: false, final false
  inline int32_t get_tapCount();

  /// @brief Method get_time, addr 0x65a7bb0, size 0x4c, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_touchId, addr 0x65a77e0, size 0x60, virtual false, abstract: false, final false
  inline int32_t get_touchId();

  /// @brief Method get_uniqueId, addr 0x65a7780, size 0x60, virtual false, abstract: false, final false
  inline uint32_t get_uniqueId();

  /// @brief Method get_updateStepCount, addr 0x65a69b0, size 0x60, virtual false, abstract: false, final false
  inline uint32_t get_updateStepCount();

  /// @brief Method get_valid, addr 0x65a676c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onFingerDown, addr 0x65a89fc, size 0xcc, virtual false, abstract: false, final false
  static inline void remove_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerMove, addr 0x65a8d2c, size 0xcc, virtual false, abstract: false, final false
  static inline void remove_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerUp, addr 0x65a8b94, size 0xcc, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "m_Finger", ty: "::UnityEngine::InputSystem::EnhancedTouch::Finger*", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_TouchRecord", ty:
  // "::UnityEngine::InputSystem::LowLevel::InputStateHistory_1_Record<::UnityEngine::InputSystem::LowLevel::TouchState>", modifiers: "", def_value: None, comment: None }]
...
public:
  // Declarations
  /// @brief Method AddFingers, addr 0x65a92dc, size 0x128, virtual false, abstract: false, final false
  inline void AddFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method Destroy, addr 0x65a617c, size 0x84, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method RemoveFingers, addr 0x65a9404, size 0x150, virtual false, abstract: false, final false
  inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method UpdateActiveFingers, addr 0x65a8790, size 0x10c, virtual false, abstract: false, final false
  inline void UpdateActiveFingers();

  /// @brief Method UpdateActiveTouches, addr 0x65a8020, size 0x670, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "updateMask", ty: "::UnityEngine::InputSystem::LowLevel::InputUpdateType", modifiers: "", def_value: None, comment: None }, CppParam { name: "fingers", ty:
  // "::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Finger*>", modifiers: "", def_value: None, comment: None }, CppParam { name: "activeFingers", ty:
  // "::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Finger*>", modifiers: "", def_value: None, comment: None }, CppParam { name: "activeTouches", ty:
  // "::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Touch>", modifiers: "", def_value: None, comment: None }, CppParam { name: "activeFingerCount", ty: "int32_t", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "activeTouchCount", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "totalFingerCount", ty: "int32_t", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "lastId", ty: "uint32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "haveBuiltActiveTouches", ty: "bool", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "haveActiveTouchesNeedingRefreshNextUpdate", ty: "bool", modifiers: "", def_value: None, comment: None }, CppParam { name: "activeTouchState", ty:
  // "::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>*", modifiers: "", def_value: None, comment: None }]
  constexpr Touch_FingerAndTouchState(::UnityEngine::InputSystem::LowLevel::InputUpdateType updateMask, ::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Finger*> fingers,
                                      ::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Finger*> activeFingers, ::ArrayW<::UnityEngine::InputSystem::EnhancedTouch::Touch> activeTouches,
...
static_assert(sizeof(::UnityEngine::InputSystem::EnhancedTouch::Touch_FingerAndTouchState) == 0x40, "Size mismatch!");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "touchscreens", ty: "::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Touchscreen*>", modifiers: "", def_value: None, comment:
  // None }, CppParam { name: "historyLengthPerFinger", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "onFingerDown", ty:
  // "::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*>", modifiers: "", def_value: None, comment: None }, CppParam {
  // name: "onFingerMove", ty: "::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*>", modifiers: "", def_value: None,
  ...
  // "", def_value: None, comment: None }, CppParam { name: "playerState", ty: "::UnityEngine::InputSystem::EnhancedTouch::Touch_FingerAndTouchState", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::InputSystem::EnhancedTouch::Touch_GlobalState) == 0x150, "Size mismatch!");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "accumulatedDelta", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None, comment: None }, CppParam { name: "uniqueId", ty: "uint32_t", modifiers: "",
...
static_assert(sizeof(::UnityEngine::InputSystem::EnhancedTouch::Touch_ExtraDataPerTouchState) == 0xc, "Size mismatch!");
...
public:
  ...
  /// @brief Method <SaveAndResetState>b__80_0, addr 0x65a98d4, size 0x88, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__80_0(::by_ref<::UnityEngine::InputSystem::EnhancedTouch::Touch_GlobalState> state);

  /// @brief Method <SaveAndResetState>b__80_1, addr 0x65a995c, size 0x4, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__80_1();

  /// @brief Method .ctor, addr 0x65a98d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  Touch___c(Touch___cconst&) = delete;
