...
public:
  // Declarations
  /// @brief Method AddFingers, addr 0x2ae3040, size 0x118, virtual false, abstract: false, final false
  inline void AddFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveFingers, addr 0x2ae323c, size 0x144, virtual false, abstract: false, final false
  inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method Destroy, addr 0x2ae369c, size 0x84, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method UpdateActiveFingers, addr 0x2ae2550, size 0xf4, virtual false, abstract: false, final false
  inline void UpdateActiveFingers();

  /// @brief Method UpdateActiveTouches, addr 0x2ae1e60, size 0x5c0, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6669)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6669), inst: 3129 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(2323), inst: 306 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6660), inst: 985 }), TypeDefinitionIndex(TypeDefinitionIndex(2323)),
// TypeDefinitionIndex(TypeDefinitionIndex(6288)), TypeDefinitionIndex(TypeDefinitionIndex(6660)), TypeDefinitionIndex(TypeDefinitionIndex(6414)), TypeDefinitionIndex(TypeDefinitionIndex(6416))} Self:
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ae378c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SaveAndResetState>b__78_0, addr 0x2ae3794, size 0x84, virtual false, abstract: false, final false
  inline void _SaveAndResetState_b__78_0(ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState> state);

  /// @brief Method <SaveAndResetState>b__78_1, addr 0x2ae3818, size 0x4, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6415)), TypeDefinitionIndex(TypeDefinitionIndex(6576)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6576), inst: 3896
// }), TypeDefinitionIndex(TypeDefinitionIndex(6514))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6419)) CS Name: ::UnityEngine.InputSystem.EnhancedTouch::Touch
...
public:
  ...
  /// @brief Method get_valid, addr 0x2ae0c74, size 0x48, virtual false, abstract: false, final false
  inline bool get_valid();

  /// @brief Method get_finger, addr 0x2ae1ac8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger();

  /// @brief Method get_phase, addr 0x2ae1ab4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::TouchPhase get_phase();

  /// @brief Method get_began, addr 0x2ae1b18, size 0x1c, virtual false, abstract: false, final false
  inline bool get_began();

  /// @brief Method get_inProgress, addr 0x2ae1b34, size 0x50, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_ended, addr 0x2ae1b84, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ended();

  /// @brief Method get_touchId, addr 0x2ae1aa0, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_touchId();

  /// @brief Method get_pressure, addr 0x2ae1bc0, size 0x14, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x2ae1bd4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_startTime, addr 0x2ae1be8, size 0x14, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_time, addr 0x2ae1bfc, size 0x48, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_screen, addr 0x2ae1c44, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x2ae0d74, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_startScreenPosition, addr 0x2ae1c60, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_startScreenPosition();

  /// @brief Method get_delta, addr 0x2ae1c74, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_tapCount, addr 0x2ae1c88, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_tapCount();

  /// @brief Method get_isTap, addr 0x2ae1c9c, size 0x18, virtual false, abstract: false, final false
  inline bool get_isTap();

  /// @brief Method get_isInProgress, addr 0x2ae0d94, size 0x34, virtual false, abstract: false, final false
  inline bool get_isInProgress();

  /// @brief Method get_updateStepCount, addr 0x2ae0dc8, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_updateStepCount();

  /// @brief Method get_uniqueId, addr 0x2ae1a8c, size 0x14, virtual false, abstract: false, final false
  inline uint32_t get_uniqueId();

  /// @brief Method get_state, addr 0x2ae1ad0, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::LowLevel::TouchState> get_state();

  /// @brief Method get_extraData, addr 0x2ae1cc0, size 0x48, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__ExtraDataPerTouchState> get_extraData();

  /// @brief Method get_history, addr 0x2ae1d08, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history();

  /// @brief Method get_activeTouches, addr 0x2ae1dc0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_fingers, addr 0x2ae2420, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers();

  /// @brief Method get_activeFingers, addr 0x2ae24b0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_screens, addr 0x2ae2644, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Touchscreen*>* get_screens();

  /// @brief Method add_onFingerDown, addr 0x2ae26d0, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerDown, addr 0x2ae2798, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerUp, addr 0x2ae2860, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerUp(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerUp, addr 0x2ae2928, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerUp(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method add_onFingerMove, addr 0x2ae29f0, size 0xc8, virtual false, abstract: false, final false
  static inline void add_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method remove_onFingerMove, addr 0x2ae2ab8, size 0xc8, virtual false, abstract: false, final false
  static inline void remove_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>* value);

  /// @brief Method get_maxHistoryLengthPerFinger, addr 0x2ae1168, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_maxHistoryLengthPerFinger();

  /// @brief Method .ctor, addr 0x2ae0d88, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2ae2b80, size 0x2bc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Equals, addr 0x2ae2e3c, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch other);

  /// @brief Method Equals, addr 0x2ae2eb0, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2ae2f40, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method AddTouchscreen, addr 0x2ae2fb4, size 0x8c, virtual false, abstract: false, final false
  static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveTouchscreen, addr 0x2ae3158, size 0xe4, virtual false, abstract: false, final false
  static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method BeginUpdate, addr 0x2ae3380, size 0x74, virtual false, abstract: false, final false
  static inline void BeginUpdate();

  /// @brief Method CreateGlobalState, addr 0x2ae33f4, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState CreateGlobalState();

  /// @brief Method SaveAndResetState, addr 0x2ae3420, size 0x218, virtual false, abstract: false, final false
