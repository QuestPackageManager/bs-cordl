...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6639))}
...
public:
  // Declarations
  /// @brief Method AddFingers addr 0x29632f8 size 0x118 virtual false final false
  inline void AddFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveFingers addr 0x29634f4 size 0x144 virtual false final false
  inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method Destroy addr 0x2963954 size 0x84 virtual false final false
  inline void Destroy();

  /// @brief Method UpdateActiveFingers addr 0x2962808 size 0xf4 virtual false final false
  inline void UpdateActiveFingers();

  /// @brief Method UpdateActiveTouches addr 0x2962118 size 0x5c0 virtual false final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6502)), TypeDefinitionIndex(TypeDefinitionIndex(6746)), TypeDefinitionIndex(TypeDefinitionIndex(2323)),
// TypeDefinitionIndex(TypeDefinitionIndex(6755)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6755), inst: 3065 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2323), inst: 307 }), TypeDefinitionIndex(TypeDefinitionIndex(6374)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6746), inst: 971 }),
// TypeDefinitionIndex(TypeDefinitionIndex(6500))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6501)) CS Name: ::Touch::GlobalState
...
public:
  ...
  /// @brief Method .ctor addr 0x2963a44 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SaveAndResetState>b__78_0 addr 0x2963a4c size 0x84 virtual false final false
  inline void _SaveAndResetState_b__78_0(ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState> state);

  /// @brief Method <SaveAndResetState>b__78_1 addr 0x2963ad0 size 0x4 virtual false final false
...
namespace UnityEngine::InputSystem::EnhancedTouch {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6600)), TypeDefinitionIndex(TypeDefinitionIndex(6662)), TypeDefinitionIndex(TypeDefinitionIndex(6501)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6662), inst: 3805 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(6505)) CS Name:
...
public:
  ...
  /// @brief Method get_valid addr 0x2960f2c size 0x48 virtual false final false
  inline bool get_valid();

  /// @brief Method get_finger addr 0x2961d80 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger();

  /// @brief Method get_phase addr 0x2961d6c size 0x14 virtual false final false
  inline ::UnityEngine::InputSystem::TouchPhase get_phase();

  /// @brief Method get_began addr 0x2961dd0 size 0x1c virtual false final false
  inline bool get_began();

  /// @brief Method get_inProgress addr 0x2961dec size 0x50 virtual false final false
  inline bool get_inProgress();

  /// @brief Method get_ended addr 0x2961e3c size 0x3c virtual false final false
  inline bool get_ended();

  /// @brief Method get_touchId addr 0x2961d58 size 0x14 virtual false final false
  inline int32_t get_touchId();

  /// @brief Method get_pressure addr 0x2961e78 size 0x14 virtual false final false
  inline float_t get_pressure();

  /// @brief Method get_radius addr 0x2961e8c size 0x14 virtual false final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_startTime addr 0x2961ea0 size 0x14 virtual false final false
  inline double_t get_startTime();

  /// @brief Method get_time addr 0x2961eb4 size 0x48 virtual false final false
  inline double_t get_time();

  /// @brief Method get_screen addr 0x2961efc size 0x1c virtual false final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition addr 0x296102c size 0x14 virtual false final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_startScreenPosition addr 0x2961f18 size 0x14 virtual false final false
  inline ::UnityEngine::Vector2 get_startScreenPosition();

  /// @brief Method get_delta addr 0x2961f2c size 0x14 virtual false final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_tapCount addr 0x2961f40 size 0x14 virtual false final false
  inline int32_t get_tapCount();

  /// @brief Method get_isTap addr 0x2961f54 size 0x18 virtual false final false
  inline bool get_isTap();

  /// @brief Method get_isInProgress addr 0x296104c size 0x34 virtual false final false
  inline bool get_isInProgress();

  /// @brief Method get_updateStepCount addr 0x2961080 size 0x14 virtual false final false
  inline uint32_t get_updateStepCount();

  /// @brief Method get_uniqueId addr 0x2961d44 size 0x14 virtual false final false
  inline uint32_t get_uniqueId();

  /// @brief Method get_state addr 0x2961d88 size 0x48 virtual false final false
  inline ByRef<::UnityEngine::InputSystem::LowLevel::TouchState> get_state();

  /// @brief Method get_extraData addr 0x2961f78 size 0x48 virtual false final false
  inline ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__ExtraDataPerTouchState> get_extraData();

  /// @brief Method get_history addr 0x2961fc0 size 0xb8 virtual false final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history();

  /// @brief Method get_activeTouches addr 0x2962078 size 0xa0 virtual false final false
  ...
  /// @brief Method get_fingers addr 0x29626d8 size 0x90 virtual false final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers();

  /// @brief Method get_activeFingers addr 0x2962768 size 0xa0 virtual false final false
  ...
  /// @brief Method ToString addr 0x2962e38 size 0x2bc virtual true final false
  inline ::StringW ToString();

  /// @brief Method Equals addr 0x29630f4 size 0x74 virtual true final true
  inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch other);

  /// @brief Method Equals addr 0x2963168 size 0x90 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x29631f8 size 0x74 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method AddTouchscreen addr 0x296326c size 0x8c virtual false final false
  static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method RemoveTouchscreen addr 0x2963410 size 0xe4 virtual false final false
  static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen* screen);

  /// @brief Method BeginUpdate addr 0x2963638 size 0x74 virtual false final false
  static inline void BeginUpdate();

  /// @brief Method CreateGlobalState addr 0x29636ac size 0x2c virtual false final false
  static inline ::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState CreateGlobalState();

  /// @brief Method SaveAndResetState addr 0x29636d8 size 0x218 virtual false final false
