...
public:
  ...
  /// @brief Method FindTouch, addr 0x64630c0, size 0x324, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t uniqueId);

  /// @brief Method GetTouchHistory, addr 0x64633e4, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method OnTouchRecorded, addr 0x6462dc0, size 0x2d8, virtual false, abstract: false, final false
  inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::InputStateHistory_Record record);

  /// @brief Method ShouldRecordTouch, addr 0x6462cc8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x646291c, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentTouch, addr 0x646250c, size 0x104, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch();

  /// @brief Method get_index, addr 0x6462488, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_isActive, addr 0x6462490, size 0x7c, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_lastTouch, addr 0x64626f8, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch();

  /// @brief Method get_screen, addr 0x6462480, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_screenPosition, addr 0x646265c, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_touchHistory, addr 0x64628b4, size 0x30, virtual false, abstract: false, final false
