...
public:
  ...
  /// @brief Method get_screen addr 0x2960e28 size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Touchscreen* get_screen();

  /// @brief Method get_index addr 0x2960e30 size 0x8 virtual false final false
  inline int32_t get_index();

  /// @brief Method get_isActive addr 0x2960e38 size 0x2c virtual false final false
  inline bool get_isActive();

  /// @brief Method get_screenPosition addr 0x2960f74 size 0x40 virtual false final false
  inline ::UnityEngine::Vector2 get_screenPosition();

  /// @brief Method get_lastTouch addr 0x2960fb4 size 0x78 virtual false final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch();

  /// @brief Method get_currentTouch addr 0x2960e64 size 0xc8 virtual false final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch();

  /// @brief Method get_touchHistory addr 0x2961094 size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2961104 size 0x31c virtual false final false
  ...
  /// @brief Method ShouldRecordTouch addr 0x2961478 size 0x98 virtual false final false
  ...
  /// @brief Method OnTouchRecorded addr 0x2961544 size 0x2ac virtual false final false
  inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record record);

  /// @brief Method FindTouch addr 0x296181c size 0x338 virtual false final false
  inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t uniqueId);

  /// @brief Method GetTouchHistory addr 0x2961b54 size 0x1f0 virtual false final false
