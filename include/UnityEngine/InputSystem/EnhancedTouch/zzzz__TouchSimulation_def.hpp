...
public:
  ...
  /// @brief Method AddPointer, addr 0x45ff37c, size 0x170, virtual false, abstract: false, final false
  inline void AddPointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method Destroy, addr 0x45ff2ac, size 0xd0, virtual false, abstract: false, final false
  static inline void Destroy();

  /// @brief Method Disable, addr 0x45ff1d4, size 0xd8, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method Enable, addr 0x45ff040, size 0x194, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method InstallStateChangeMonitors, addr 0x4600b48, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeviceChange, addr 0x4600090, size 0x14c, virtual false, abstract: false, final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method OnDisable, addr 0x46006e8, size 0x164, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x46001dc, size 0x394, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEvent, addr 0x45ffad8, size 0x544, virtual false, abstract: false, final false
  inline void OnEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnSourceControlChangedValue, addr 0x4600b4c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePointer, addr 0x45ff4ec, size 0x1f4, virtual false, abstract: false, final false
  inline void RemovePointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method UninstallStateChangeMonitors, addr 0x4600b50, size 0x4, virtual false, abstract: false, final false
  inline void UninstallStateChangeMonitors(int32_t startIndex);

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged, addr 0x4600b40, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired, addr 0x4600b44, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateTouch, addr 0x45ff6e0, size 0x3f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4600b54, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x45feff8, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> get_instance();

  /// @brief Method get_simulatedTouchscreen, addr 0x45fefe8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_simulatedTouchscreen, addr 0x45feff0, size 0x8, virtual false, abstract: false, final false
