...
public:
  ...
  /// @brief Method AddPointer, addr 0x2bcab88, size 0x160, virtual false, abstract: false, final false
  inline void AddPointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method Destroy, addr 0x2bcaab8, size 0xd0, virtual false, abstract: false, final false
  static inline void Destroy();

  /// @brief Method Disable, addr 0x2bca9e0, size 0xd8, virtual false, abstract: false, final false
  static inline void Disable();

  /// @brief Method Enable, addr 0x2bca844, size 0x19c, virtual false, abstract: false, final false
  static inline void Enable();

  /// @brief Method InstallStateChangeMonitors, addr 0x2bcc2ac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDeviceChange, addr 0x2bcb7cc, size 0x144, virtual false, abstract: false, final false
  inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice* device, ::UnityEngine::InputSystem::InputDeviceChange change);

  /// @brief Method OnDisable, addr 0x2bcbe4c, size 0x164, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2bcb910, size 0x3bc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEvent, addr 0x2bcb240, size 0x514, virtual false, abstract: false, final false
  inline void OnEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr, ::UnityEngine::InputSystem::InputDevice* device);

  /// @brief Method OnSourceControlChangedValue, addr 0x2bcc2b0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePointer, addr 0x2bcace8, size 0x1d0, virtual false, abstract: false, final false
  inline void RemovePointer(::UnityEngine::InputSystem::Pointer* pointer);

  /// @brief Method UninstallStateChangeMonitors, addr 0x2bcc2b4, size 0x4, virtual false, abstract: false, final false
  inline void UninstallStateChangeMonitors(int32_t startIndex);

  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged, addr 0x2bcc2a4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired, addr 0x2bcc2a8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateTouch, addr 0x2bcaeb8, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bcc2b8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x2bca7fc, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> get_instance();

  /// @brief Method get_simulatedTouchscreen, addr 0x2bca7ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_simulatedTouchscreen, addr 0x2bca7f4, size 0x8, virtual false, abstract: false, final false
