...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(2448)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2448), inst: 424
// }), TypeDefinitionIndex(TypeDefinitionIndex(6133))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6310)) CS Name: ::UnityEngine.InputSystem::InputValue*
