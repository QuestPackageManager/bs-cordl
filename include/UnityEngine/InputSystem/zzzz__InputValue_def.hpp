...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2446)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2446), inst: 421 }),
// TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(6219))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6396)) CS Name: ::UnityEngine.InputSystem::InputValue*
...
public:
  ...
  /// @brief Method Get addr 0x293d2e8 size 0x64 virtual false final false
  ...
  /// @brief Method get_isPressed addr 0x293d34c size 0x7c virtual false final false
  inline bool get_isPressed();

  static inline ::UnityEngine::InputSystem::InputValue* New_ctor();

  /// @brief Method .ctor addr 0x293d3c8 size 0x8 virtual false final false
  inline void _ctor();
