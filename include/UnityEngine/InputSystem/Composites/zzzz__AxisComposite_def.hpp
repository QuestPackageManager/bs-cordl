...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x62eda30, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x62ed91c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62eda78, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_midPoint, addr 0x62ed908, size 0x14, virtual false, abstract: false, final false
