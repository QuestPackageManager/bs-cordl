...
public:
  ...
  /// @brief Method get_valueType, addr 0x2a5e2ec, size 0x8, virtual true, abstract: false, final false
  inline ::System::Type* get_valueType();

  /// @brief Method get_valueSizeInBytes, addr 0x2a5e2f4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method EvaluateMagnitude, addr 0x2a5e2fc, size 0x40, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ReadValue, addr 0x2a5e3f8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method ModifiersArePressed, addr 0x2a5e33c, size 0xbc, virtual false, abstract: false, final false
  inline bool ModifiersArePressed(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method FinishSetup, addr 0x2a5e45c, size 0xac, virtual true, abstract: false, final false
  inline void FinishSetup(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ReadValueAsObject, addr 0x2a5e508, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a5e56c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
