...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Composites::ButtonWithOneModifier_ModifiersOrder, "UnityEngine.InputSystem.Composites", "ButtonWithOneModifier/ModifiersOrder");
...
static_assert(sizeof(::UnityEngine::InputSystem::Composites::ButtonWithOneModifier_ModifiersOrder) == 0x4, "Size mismatch!");
...
public:
  ...
  ButtonWithOneModifier(ButtonWithOneModifierconst&) = delete;
