...
public:
  ...
  /// @brief Method ReadValue, addr 0x2a5d9d0, size 0x70, virtual true, abstract: false, final false
  inline float_t ReadValue(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method ModifiersArePressed, addr 0x2a5da40, size 0xb4, virtual false, abstract: false, final false
  inline bool ModifiersArePressed(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method EvaluateMagnitude, addr 0x2a5daf4, size 0xc, virtual true, abstract: false, final false
  inline float_t EvaluateMagnitude(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext> context);

  /// @brief Method FinishSetup, addr 0x2a5db00, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a5db90, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
