...
/// @brief Field modifiersOrder, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_modifiersOrder, put=__cordl_internal_set_modifiersOrder)) ::UnityEngine::InputSystem::Composites::ButtonWithTwoModifiers_ModifiersOrder  modifiersOrder;
...
/// @brief Method EvaluateMagnitude, addr 0x6356020, size 0xc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x635602c, size 0x90, virtual true, abstract: false, final false
inline void FinishSetup(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifiersArePressed, addr 0x6355f6c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x6355eec, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63560bc, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
