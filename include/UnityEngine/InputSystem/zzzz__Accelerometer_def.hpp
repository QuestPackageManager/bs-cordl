...
public:
  ...
  /// @brief Method get_acceleration addr 0x2928e8c size 0x8 virtual false final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_acceleration();

  /// @brief Method set_acceleration addr 0x2928e94 size 0x8 virtual false final false
  inline void set_acceleration(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method get_current addr 0x2928e9c size 0x48 virtual false final false
  static inline ::UnityEngine::InputSystem::Accelerometer* get_current();

  /// @brief Method set_current addr 0x2928ee4 size 0x4c virtual false final false
  static inline void set_current(::UnityEngine::InputSystem::Accelerometer* value);

  /// @brief Method MakeCurrent addr 0x2928f30 size 0x54 virtual true final false
  inline void MakeCurrent();

  /// @brief Method OnRemoved addr 0x2928f84 size 0x84 virtual true final false
  inline void OnRemoved();

  /// @brief Method FinishSetup addr 0x2929008 size 0x78 virtual true final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Accelerometer* New_ctor();

  /// @brief Method .ctor addr 0x2929080 size 0x8 virtual false final false
  inline void _ctor();
