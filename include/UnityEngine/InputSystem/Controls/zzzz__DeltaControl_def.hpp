...
public:
  ...
  /// @brief Method FinishSetup, addr 0x45621c4, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4562378, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_down, addr 0x4562194, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_down();

  /// @brief Method get_left, addr 0x45621a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_left();

  /// @brief Method get_right, addr 0x45621b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_right();

  /// @brief Method get_up, addr 0x4562184, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::AxisControl* get_up();

  /// @brief Method set_down, addr 0x456219c, size 0x8, virtual false, abstract: false, final false
  inline void set_down(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_left, addr 0x45621ac, size 0x8, virtual false, abstract: false, final false
  inline void set_left(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_right, addr 0x45621bc, size 0x8, virtual false, abstract: false, final false
  inline void set_right(::UnityEngine::InputSystem::Controls::AxisControl* value);

  /// @brief Method set_up, addr 0x456218c, size 0x8, virtual false, abstract: false, final false
