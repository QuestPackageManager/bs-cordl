...
/// @brief Method CalculateOptimizedControlDataType, addr 0x634780c, size 0x150, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType() ;

/// @brief Method EvaluateMagnitude, addr 0x6347750, size 0xbc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(void*  statePtr) ;

/// @brief Method FinishSetup, addr 0x6344f20, size 0xc0, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::Vector2Control* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x6347590, size 0xdc, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 ReadUnprocessedValueFromState(void*  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x634766c, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6344fe4, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_x, addr 0x6347570, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_x() ;

/// @brief Method get_y, addr 0x6347580, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_y() ;

/// @brief Method set_x, addr 0x6347578, size 0x8, virtual false, abstract: false, final false
inline void set_x(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_y, addr 0x6347588, size 0x8, virtual false, abstract: false, final false
