...
// Write type traits
MARK_REF_T(::UnityEngine::InputSystem::Controls::StickControl*);
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Controls::StickControl*, "UnityEngine.InputSystem.Controls", "StickControl");
...
static_assert(sizeof(::UnityEngine::InputSystem::Controls::StickControl) == 0x140, "Size mismatch!");
