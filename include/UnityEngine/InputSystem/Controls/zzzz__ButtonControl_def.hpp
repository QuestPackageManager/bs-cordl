...
/// @brief Field <needsToCheckFramePress>k__BackingField, offset 0x139, size 0x1 
 __declspec(property(get=__cordl_internal_get__needsToCheckFramePress_k__BackingField, put=__cordl_internal_set__needsToCheckFramePress_k__BackingField)) bool  _needsToCheckFramePress_k__BackingField;
...
/// @brief Method BeginTestingForFramePresses, addr 0x634487c, size 0xfc, virtual false, abstract: false, final false
inline void BeginTestingForFramePresses(bool  currentlyPressed, bool  pressedLastFrame) ;

/// @brief Method IsValueConsideredPressed, addr 0x634474c, size 0x70, virtual false, abstract: false, final false
inline bool IsValueConsideredPressed(float_t  value) ;

static inline ::UnityEngine::InputSystem::Controls::ButtonControl* New_ctor() ;

/// @brief Method UpdateWasPressed, addr 0x6344d00, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6343d98, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_isPressed, addr 0x63447bc, size 0xc0, virtual false, abstract: false, final false
inline bool get_isPressed() ;

/// @brief Method get_needsToCheckFramePress, addr 0x63446cc, size 0x8, virtual false, abstract: false, final false
inline bool get_needsToCheckFramePress() ;

/// @brief Method get_pressPointOrDefault, addr 0x63446dc, size 0x5c, virtual false, abstract: false, final false
inline float_t get_pressPointOrDefault() ;

/// @brief Method get_wasPressedThisFrame, addr 0x6344978, size 0x1c4, virtual false, abstract: false, final false
inline bool get_wasPressedThisFrame() ;

/// @brief Method get_wasReleasedThisFrame, addr 0x6344b3c, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method set_needsToCheckFramePress, addr 0x63446d4, size 0x8, virtual false, abstract: false, final false
