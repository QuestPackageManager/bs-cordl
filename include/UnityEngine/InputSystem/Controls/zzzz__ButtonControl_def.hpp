...
public:
  ...
  /// @brief Method BeginTestingForFramePresses, addr 0x63441bc, size 0xfc, virtual false, abstract: false, final false
  inline void BeginTestingForFramePresses(bool currentlyPressed, bool pressedLastFrame);

  /// @brief Method IsValueConsideredPressed, addr 0x634408c, size 0x70, virtual false, abstract: false, final false
  inline bool IsValueConsideredPressed(float_t value);

  static inline ::UnityEngine::InputSystem::Controls::ButtonControl* New_ctor();

  /// @brief Method UpdateWasPressed, addr 0x6344640, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63436d8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_isPressed, addr 0x63440fc, size 0xc0, virtual false, abstract: false, final false
  inline bool get_isPressed();

  /// @brief Method get_needsToCheckFramePress, addr 0x634400c, size 0x8, virtual false, abstract: false, final false
  inline bool get_needsToCheckFramePress();

  /// @brief Method get_pressPointOrDefault, addr 0x634401c, size 0x5c, virtual false, abstract: false, final false
  inline float_t get_pressPointOrDefault();

  /// @brief Method get_wasPressedThisFrame, addr 0x63442b8, size 0x1c4, virtual false, abstract: false, final false
  inline bool get_wasPressedThisFrame();

  /// @brief Method get_wasReleasedThisFrame, addr 0x634447c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_needsToCheckFramePress, addr 0x6344014, size 0x8, virtual false, abstract: false, final false
