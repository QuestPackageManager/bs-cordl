...
public:
  // Declarations
  /// @brief Method FinishSetup addr 0x298af4c size 0xac virtual true final false
  inline void FinishSetup();

  /// @brief Method ReadUnprocessedValueFromState addr 0x298aff8 size 0x48 virtual true final false
  inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState addr 0x298b1d4 size 0x40 virtual true final false
  ...
  /// @brief Method .ctor addr 0x298b214 size 0x4 virtual false final false
  inline void _ctor();
