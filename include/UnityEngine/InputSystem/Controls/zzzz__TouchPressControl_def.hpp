...
public:
  // Declarations
  /// @brief Method FinishSetup, addr 0x30395c8, size 0xac, virtual true, abstract: false, final false
  inline void FinishSetup();

  static inline ::UnityEngine::InputSystem::Controls::TouchPressControl* New_ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x3039674, size 0x48, virtual true, abstract: false, final false
  inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x3039850, size 0x40, virtual true, abstract: false, final false
  inline void WriteValueIntoState(float_t value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x3039890, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
