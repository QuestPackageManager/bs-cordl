...
/// @brief Method RefreshConfiguration, addr 0x6346078, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63461f8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_keyCode, addr 0x634602c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Key get_keyCode() ;

/// @brief Method get_scanCode, addr 0x634603c, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_scanCode() ;

/// @brief Method set_keyCode, addr 0x6346034, size 0x8, virtual false, abstract: false, final false
