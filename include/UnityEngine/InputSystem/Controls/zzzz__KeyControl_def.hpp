...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5501)), TypeDefinitionIndex(TypeDefinitionIndex(5888))]
...
public:
  ...
  /// @brief Method get_keyCode, addr 0x2b0ac20, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Key get_keyCode();

  /// @brief Method set_keyCode, addr 0x2b0ac28, size 0x8, virtual false, abstract: false, final false
  inline void set_keyCode(::UnityEngine::InputSystem::Key value);

  /// @brief Method get_scanCode, addr 0x2b0ac30, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_scanCode();

  /// @brief Method RefreshConfiguration, addr 0x2b0ac4c, size 0x170, virtual true, abstract: false, final false
  inline void RefreshConfiguration();

  static inline ::UnityEngine::InputSystem::Controls::KeyControl* New_ctor();

  /// @brief Method .ctor, addr 0x2b0adbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
