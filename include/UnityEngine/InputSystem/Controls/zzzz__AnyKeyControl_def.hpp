...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6715))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2988c40 size 0x70 virtual false final false
  inline void _ctor();

  /// @brief Method ReadUnprocessedValueFromState addr 0x2988d38 size 0x28 virtual true final false
