...
/// @brief Method ReadUnprocessedValueFromState, addr 0x63b79b0, size 0x28, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(void*  statePtr) ;

/// @brief Method .ctor, addr 0x63b78a8, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
