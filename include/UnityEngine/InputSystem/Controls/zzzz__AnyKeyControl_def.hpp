...
public:
  ...
  /// @brief Method .ctor, addr 0x2b09500, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ReadUnprocessedValueFromState, addr 0x2b095f8, size 0x28, virtual true, abstract: false, final false
