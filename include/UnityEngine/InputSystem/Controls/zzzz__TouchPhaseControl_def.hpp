...
public:
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x4564290, size 0x7c, virtual true, abstract: false, final false
  inline ::UnityEngine::InputSystem::TouchPhase ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x456430c, size 0x68, virtual true, abstract: false, final false
  inline void WriteValueIntoState(::UnityEngine::InputSystem::TouchPhase value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x4564208, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
