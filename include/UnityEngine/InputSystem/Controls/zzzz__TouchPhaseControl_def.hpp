...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6302)), TypeDefinitionIndex(TypeDefinitionIndex(6373)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6302), inst: 3804
// })} Self: TypeDefinitionIndex(TypeDefinitionIndex(6728)) CS Name: ::UnityEngine.InputSystem.Controls::TouchPhaseControl*
...
public:
  ...
  /// @brief Method .ctor addr 0x298ae90 size 0x88 virtual false final false
  inline void _ctor();

  /// @brief Method ReadUnprocessedValueFromState addr 0x298af18 size 0x28 virtual true final false
  inline ::UnityEngine::InputSystem::TouchPhase ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState addr 0x298af40 size 0xc virtual true final false
