...
public:
// Declarations
/// @brief Method CalculateOptimizedControlDataType, addr 0x63b9adc, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method ReadUnprocessedValueFromState, addr 0x63b997c, size 0xac, virtual true, abstract: false, final false
inline int32_t ReadUnprocessedValueFromState(void*  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x63b9a28, size 0xb4, virtual true, abstract: false, final false
inline void WriteValueIntoState(int32_t  value, void*  statePtr) ;

/// @brief Method .ctor, addr 0x63b98f8, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
