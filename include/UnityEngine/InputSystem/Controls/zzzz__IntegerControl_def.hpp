...
public:
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x2c51508, size 0xc, virtual true, abstract: false, final false
  inline int32_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void> statePtr);

  /// @brief Method WriteValueIntoState, addr 0x2c51514, size 0x18, virtual true, abstract: false, final false
  inline void WriteValueIntoState(int32_t value, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method .ctor, addr 0x2c51480, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
