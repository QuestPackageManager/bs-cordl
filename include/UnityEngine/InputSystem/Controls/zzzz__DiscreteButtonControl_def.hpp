...
/// @brief Method FinishSetup, addr 0x6345068, size 0x100, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::DiscreteButtonControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x6345168, size 0x18c, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(void*  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x63452f8, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x634543c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
