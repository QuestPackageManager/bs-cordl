...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer, "UnityEngine.InputSystem.Utilities", "Vector3MagnitudeComparer");
// Dependencies
namespace UnityEngine::InputSystem::Utilities {
// Is value type: true
...
public:
  ...
  /// @brief Method Compare, addr 0x64fb4e8, size 0x38, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer) == 0x1, "Size mismatch!");
