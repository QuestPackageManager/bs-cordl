...
public:
  ...
  /// @brief Method MoveNext, addr 0x63c6140, size 0x140, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::Utilities::StringHelpers__Split_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x63c62c8, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x63c6280, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63c6368, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63c6288, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63c62c0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63c613c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63c57fc, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63c6370, size 0x1fc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::Utilities::StringHelpers__Tokenize_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.Utilities.Substring>.GetEnumerator, addr 0x63c661c, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.Utilities.Substring>.get_Current, addr 0x63c6578, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63c66b4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63c6584, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63c65bc, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63c636c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x63c5760, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method CharacterSeparatedListsHaveAtLeastOneCommonElement, addr 0x63c581c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x63c512c, size 0x28, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, char16_t ch);

  /// @brief Method Contains, addr 0x63c5154, size 0x28, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, ::StringW text, ::System::StringComparison comparison);

  /// @brief Method CountOccurrences, addr 0x63c567c, size 0x74, virtual false, abstract: false, final false
  static inline int32_t CountOccurrences(::StringW str, char16_t ch);

  /// @brief Method Escape, addr 0x63c4e00, size 0x1a0, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method ExpandTemplateString, addr 0x63c5f50, size 0x1ec, virtual false, abstract: false, final false
  static inline ::StringW ExpandTemplateString(::StringW _cordl_template, ::System::Func_2<::StringW, ::StringW>* mapFunc);

  /// @brief Method FromNicifiedMemorySize, addr 0x63c54e4, size 0x198, virtual false, abstract: false, final false
  static inline bool FromNicifiedMemorySize(::StringW text, ::ByRef<int64_t> result, int64_t defaultMultiplier);

  /// @brief Method GetPlural, addr 0x63c517c, size 0x1c4, virtual false, abstract: false, final false
  static inline ::StringW GetPlural(::StringW str);

  /// @brief Method InvariantEqualsIgnoreCase, addr 0x63c5f1c, size 0x34, virtual false, abstract: false, final false
  static inline bool InvariantEqualsIgnoreCase(::StringW left, ::StringW right);

  /// @brief Method IsPrintable, addr 0x63c5dd0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method NicifyMemorySize, addr 0x63c5340, size 0x1a4, virtual false, abstract: false, final false
  static inline ::StringW NicifyMemorySize(int64_t numBytes);

  /// @brief Method ParseInt, addr 0x63c5ab0, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t ParseInt(::StringW str, int32_t pos);

  /// @brief Method ReadStringFromBuffer, addr 0x63c5cbc, size 0x18, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(::System::IntPtr buffer, int32_t bufferSize);

  /// @brief Method ReadStringFromBuffer, addr 0x63c5cd4, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(::System::IntPtr buffer, int32_t bufferSize, ::ByRef<uint32_t> offset);

  /// @brief Method Split, addr 0x63c5780, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::StringW>* Split(::StringW str, ::System::Func_2<char16_t, bool>* predicate);

  /// @brief Method Tokenize, addr 0x63c56f0, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::Substring>* Tokenize(::StringW str);

  /// @brief Method Unescape, addr 0x63c4fa0, size 0x18c, virtual false, abstract: false, final false
  static inline ::StringW Unescape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method WithAllWhitespaceStripped, addr 0x63c5e3c, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW WithAllWhitespaceStripped(::StringW str);

  /// @brief Method WriteStringToBuffer, addr 0x63c5b2c, size 0x1c, virtual false, abstract: false, final false
  static inline bool WriteStringToBuffer(::StringW text, ::System::IntPtr buffer, int32_t bufferSizeInCharacters);

  /// @brief Method WriteStringToBuffer, addr 0x63c5b48, size 0x174, virtual false, abstract: false, final false
