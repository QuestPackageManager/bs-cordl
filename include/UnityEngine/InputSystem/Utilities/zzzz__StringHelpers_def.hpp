...
namespace UnityEngine::InputSystem::Utilities {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(5968))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2b17dd8, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2b188d8, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2b188dc, size 0x290, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.Utilities.Substring>.get_Current, addr 0x2b18b6c, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2b18b78, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2b18bb8, size 0x5c, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.Utilities.Substring>.GetEnumerator, addr 0x2b18c14, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2b18cb8, size 0x4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x2b17e94, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2b18cbc, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2b18cc0, size 0x128, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current, addr 0x2b18de8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2b18df0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2b18e30, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator, addr 0x2b18e38, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2b18ee4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();
...
public:
  ...
  /// @brief Method Escape, addr 0x2b175fc, size 0x16c, virtual false, abstract: false, final false
  static inline ::StringW Escape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method Unescape, addr 0x2b17768, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW Unescape(::StringW str, ::StringW chars, ::StringW replacements);

  /// @brief Method Contains, addr 0x2b178c4, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, char16_t ch);

  /// @brief Method Contains, addr 0x2b178e4, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW str, ::StringW text, ::System::StringComparison comparison);

  /// @brief Method GetPlural, addr 0x2b17904, size 0x1a8, virtual false, abstract: false, final false
  static inline ::StringW GetPlural(::StringW str);

  /// @brief Method NicifyMemorySize, addr 0x2b17aac, size 0x130, virtual false, abstract: false, final false
  static inline ::StringW NicifyMemorySize(int64_t numBytes);

  /// @brief Method FromNicifiedMemorySize, addr 0x2b17bdc, size 0x184, virtual false, abstract: false, final false
  static inline bool FromNicifiedMemorySize(::StringW text, ByRef<int64_t> result, int64_t defaultMultiplier);

  /// @brief Method CountOccurrences, addr 0x2b149dc, size 0x70, virtual false, abstract: false, final false
  static inline int32_t CountOccurrences(::StringW str, char16_t ch);

  /// @brief Method Tokenize, addr 0x2b17d60, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::Substring>* Tokenize(::StringW str);

  /// @brief Method Split, addr 0x2b17e0c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method CharacterSeparatedListsHaveAtLeastOneCommonElement, addr 0x2b17ec8, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseInt, addr 0x2b18164, size 0x84, virtual false, abstract: false, final false
  static inline int32_t ParseInt(::StringW str, int32_t pos);

  /// @brief Method WriteStringToBuffer, addr 0x2b181e8, size 0x1c, virtual false, abstract: false, final false
  static inline bool WriteStringToBuffer(::StringW text, void* buffer, int32_t bufferSizeInCharacters);

  /// @brief Method WriteStringToBuffer, addr 0x2b18204, size 0x1f0, virtual false, abstract: false, final false
  static inline bool WriteStringToBuffer(::StringW text, void* buffer, int32_t bufferSizeInCharacters, ByRef<uint32_t> offset);

  /// @brief Method ReadStringFromBuffer, addr 0x2b183f4, size 0x18, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(void* buffer, int32_t bufferSize);

  /// @brief Method ReadStringFromBuffer, addr 0x2b1840c, size 0x13c, virtual false, abstract: false, final false
  static inline ::StringW ReadStringFromBuffer(void* buffer, int32_t bufferSize, ByRef<uint32_t> offset);

  /// @brief Method IsPrintable, addr 0x2b18548, size 0x8c, virtual false, abstract: false, final false
  static inline bool IsPrintable(char16_t ch);

  /// @brief Method WithAllWhitespaceStripped, addr 0x2b185d4, size 0xf0, virtual false, abstract: false, final false
  static inline ::StringW WithAllWhitespaceStripped(::StringW str);

  /// @brief Method InvariantEqualsIgnoreCase, addr 0x2b186c4, size 0x4c, virtual false, abstract: false, final false
  static inline bool InvariantEqualsIgnoreCase(::StringW left, ::StringW right);

  /// @brief Method ExpandTemplateString, addr 0x2b18710, size 0x1c8, virtual false, abstract: false, final false
