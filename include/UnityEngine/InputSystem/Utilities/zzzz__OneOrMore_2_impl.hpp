...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TList>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, multiple);
}
template<typename TValue,typename TList>
inline ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList> UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList>::op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue_TList_(TValue  single)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList>>::get(),
                        "op_Implicit",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TValue,typename TList>
inline ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList> UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList>::op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue_TList_(TList  multiple)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList>>::get(),
                        "op_Implicit",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TValue,typename TList>
constexpr ::System::Collections::Generic::IReadOnlyCollection_1<TValue>* UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList>::i___System__Collections__Generic__IReadOnlyCollection_1_TValue_()  {
return static_cast<::System::Collections::Generic::IReadOnlyCollection_1<TValue>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
// Ctor Parameters [CppParam { name: "m_IsSingle", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Single", ty: "TValue", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Multiple", ty: "TList", modifiers: "", def_value: Some("{}") }]
template<typename TValue,typename TList>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::OneOrMore_2_Enumerator<TValue,TList>*>::get(),
                        "MoveNext",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
...
template<typename TValue,typename TList>
constexpr ::System::Collections::Generic::IEnumerator_1<TValue>* UnityEngine::InputSystem::Utilities::OneOrMore_2_Enumerator<TValue,TList>::i___System__Collections__Generic__IEnumerator_1_TValue_() noexcept {
return static_cast<::System::Collections::Generic::IEnumerator_1<TValue>*>(static_cast<void*>(this));
}
