...
public:
  ...
  /// @brief Method get_action, addr 0x2b0e6fc, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_phase, addr 0x2b0e724, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_control, addr 0x2b0e730, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_interaction, addr 0x2b0e770, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputInteraction* get_interaction();

  /// @brief Method get_time, addr 0x2b0e7c8, size 0x1c, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_startTime, addr 0x2b0e7e4, size 0xc, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_duration, addr 0x2b0e7f0, size 0x30, virtual false, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_valueSizeInBytes, addr 0x2b0e820, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method ReadValueAsObject, addr 0x2b0e82c, size 0x244, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method ReadValue, addr 0x2b0ea70, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2b0e048, size 0x2f4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2b0e354, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::Utilities::InputActionTrace* trace);

  /// @brief Method MoveNext, addr 0x2b0eb74, size 0x64, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2b0ebd8, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Dispose, addr 0x2b0ebe4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method get_Current, addr 0x2b0ebe8, size 0x64, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::Utilities::__InputActionTrace__ActionEventPtr get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2b0ec4c, size 0x64, virtual true, abstract: false, final true
...
namespace UnityEngine::InputSystem::Utilities {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(5393)), TypeDefinitionIndex(TypeDefinitionIndex(5411)),
// TypeDefinitionIndex(TypeDefinitionIndex(5440)), TypeDefinitionIndex(TypeDefinitionIndex(5791)), TypeDefinitionIndex(TypeDefinitionIndex(5928)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5928), inst: 3070 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5928), inst: 3071 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(5928), inst: 3849 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5914)) CS Name: ::UnityEngine.InputSystem.Utilities::InputActionTrace*
...
public:
  ...
  /// @brief Method get_buffer, addr 0x2b0d060, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventBuffer get_buffer();

  /// @brief Method get_count, addr 0x2b0d070, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_count();

  static inline ::UnityEngine::InputSystem::Utilities::InputActionTrace* New_ctor();

  /// @brief Method .ctor, addr 0x2b0d078, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::Utilities::InputActionTrace* New_ctor(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method .ctor, addr 0x2b0d080, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0d230, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method SubscribeToAll, addr 0x2b0d3c0, size 0xdc, virtual false, abstract: false, final false
  inline void SubscribeToAll();

  /// @brief Method UnsubscribeFromAll, addr 0x2b0d778, size 0xd8, virtual false, abstract: false, final false
  inline void UnsubscribeFromAll();

  /// @brief Method SubscribeTo, addr 0x2b0d0fc, size 0x134, virtual false, abstract: false, final false
  inline void SubscribeTo(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method SubscribeTo, addr 0x2b0d2ac, size 0x114, virtual false, abstract: false, final false
  inline void SubscribeTo(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method UnsubscribeFrom, addr 0x2b0d560, size 0x11c, virtual false, abstract: false, final false
  inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputAction* action);

  /// @brief Method UnsubscribeFrom, addr 0x2b0d67c, size 0xfc, virtual false, abstract: false, final false
  inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputActionMap* actionMap);

  /// @brief Method RecordAction, addr 0x2b0d8bc, size 0x1d0, virtual false, abstract: false, final false
  inline void RecordAction(::UnityEngine::InputSystem::__InputAction__CallbackContext context);

  /// @brief Method Clear, addr 0x2b0da8c, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Finalize, addr 0x2b0dae0, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method ToString, addr 0x2b0dc74, size 0x35c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Dispose, addr 0x2b0e33c, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeInternal, addr 0x2b0db74, size 0x100, virtual false, abstract: false, final false
  inline void DisposeInternal();

  /// @brief Method GetEnumerator, addr 0x2b0dfd0, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2b0e39c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method HookOnActionChange, addr 0x2b0d49c, size 0xc4, virtual false, abstract: false, final false
  inline void HookOnActionChange();

  /// @brief Method UnhookOnActionChange, addr 0x2b0d850, size 0x6c, virtual false, abstract: false, final false
  inline void UnhookOnActionChange();

  /// @brief Method OnActionChange, addr 0x2b0e3a0, size 0x264, virtual false, abstract: false, final false
  inline void OnActionChange(::System::Object* actionOrMapOrAsset, ::UnityEngine::InputSystem::InputActionChange change);

  /// @brief Method CloneActionStateBeforeBindingsChange, addr 0x2b0e604, size 0xf8, virtual false, abstract: false, final false
