...
template <typename TValue> constexpr ::System::IObserver_1<TValue>*& UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::__cordl_internal_get_m_Observer() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Observer;
}
template <typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::IObserver_1<TValue>*> const& UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::__cordl_internal_get_m_Observer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Observer;
}
...
template <typename TValue> constexpr int32_t const& UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::__cordl_internal_get_m_Remaining() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Remaining;
}
template <typename TValue> constexpr void UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::__cordl_internal_set_m_Remaining(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::New_ctor(::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>* observable,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>*>(observable, observer));
}
template <typename TValue>
inline void UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::_ctor(::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>* observable,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>*>::get(),
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>::OnError(::System::Exception* error) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::__TakeNObservable_1__Take<TValue>*>::get(), "OnError",
...
template <typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::IObservable_1<TValue>*> const& UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>::__cordl_internal_get_m_Source() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Source;
}
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>::_ctor(::System::IObservable_1<TValue>* source, int32_t count) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename TValue> inline ::System::IDisposable* UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>::Subscribe(::System::IObserver_1<TValue>* observer) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue>*>::get(), "Subscribe", std::span<Il2CppClass const* const, 0>(),
