...
/// @brief Method .ctor, addr 0x634b508, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  formatString) ;

/// @brief Method get_formatString, addr 0x634b4f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_formatString() ;

/// @brief Method set_formatString, addr 0x634b500, size 0x8, virtual false, abstract: false, final false
