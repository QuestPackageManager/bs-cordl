...
public:
  ...
  /// @brief Method .ctor, addr 0x303d304, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatString);

  /// @brief Method get_formatString, addr 0x303d2f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_formatString();

  /// @brief Method set_formatString, addr 0x303d2fc, size 0x8, virtual false, abstract: false, final false
