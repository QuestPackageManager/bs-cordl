...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::TakeNObservable_1);
MARK_GEN_REF_T_PTR(::UnityEngine::InputSystem::Utilities::TakeNObservable_1_Take);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::TakeNObservable_1, "UnityEngine.InputSystem.Utilities", "TakeNObservable`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::InputSystem::Utilities::TakeNObservable_1_Take, "UnityEngine.InputSystem.Utilities", "TakeNObservable`1/Take");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TakeNObservable_1_Take", modifiers: "&&", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TakeNObservable_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
