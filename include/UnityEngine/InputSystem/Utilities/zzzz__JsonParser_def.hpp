...
/// @brief Method Equals, addr 0x634d010, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x634ce84, size 0x18c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::JsonParser_JsonString  other) ;

/// @brief Method GetHashCode, addr 0x634d0a4, size 0x54, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x634cd84, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x634d0f8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634d15c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x634d128, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method <ToString>b__11_0, addr 0x634e674, size 0x8, virtual false, abstract: false, final false
inline ::StringW _ToString_b__11_0(::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue  x) ;

/// @brief Method <ToString>b__11_1, addr 0x634e67c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x634e670, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Equals, addr 0x634e438, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x634dbf4, size 0x844, virtual false, abstract: false, final false
static inline bool Equals(::System::Object*  obj, ::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue  value) ;

/// @brief Method Equals, addr 0x634d9bc, size 0x238, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue  other) ;

/// @brief Method GetHashCode, addr 0x634e4cc, size 0x118, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToBoolean, addr 0x634d17c, size 0x144, virtual false, abstract: false, final false
inline bool ToBoolean() ;

/// @brief Method ToDouble, addr 0x634d86c, size 0xcc, virtual false, abstract: false, final false
inline double_t ToDouble() ;

/// @brief Method ToInteger, addr 0x634d798, size 0xd4, virtual false, abstract: false, final false
inline int64_t ToInteger() ;

/// @brief Method ToString, addr 0x634d2c0, size 0x4d8, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
/// @brief Method op_Equality, addr 0x634c174, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634cc44, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634d974, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634d938, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x6341e34, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634d998, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634cd4c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634cc90, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x634cc68, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x634e5e4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method CurrentPropertyHasValueEqualTo, addr 0x6341ea8, size 0x150, virtual false, abstract: false, final false
inline bool CurrentPropertyHasValueEqualTo(::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue  expectedValue) ;

/// @brief Method NavigateToProperty, addr 0x6341a4c, size 0x3e8, virtual false, abstract: false, final false
inline bool NavigateToProperty(::StringW  path) ;

/// @brief Method ParseArrayValue, addr 0x634c2c8, size 0x2a8, virtual false, abstract: false, final false
inline bool ParseArrayValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseBooleanValue, addr 0x634c6d0, size 0xf0, virtual false, abstract: false, final false
inline bool ParseBooleanValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseNullValue, addr 0x634c7c0, size 0x68, virtual false, abstract: false, final false
inline bool ParseNullValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseNumber, addr 0x634c828, size 0x41c, virtual false, abstract: false, final false
inline bool ParseNumber(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseObjectValue, addr 0x634c570, size 0x160, virtual false, abstract: false, final false
inline bool ParseObjectValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseStringValue, addr 0x634c1a8, size 0x120, virtual false, abstract: false, final false
inline bool ParseStringValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method ParseToken, addr 0x634beb8, size 0x84, virtual false, abstract: false, final false
inline bool ParseToken(char16_t  token) ;

/// @brief Method ParseValue, addr 0x634c034, size 0x20, virtual false, abstract: false, final false
inline bool ParseValue() ;

/// @brief Method ParseValue, addr 0x634c054, size 0x120, virtual false, abstract: false, final false
inline bool ParseValue(::ByRef<::UnityEngine::InputSystem::Utilities::JsonParser_JsonValue>  result) ;

/// @brief Method Reset, addr 0x634bd9c, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SkipString, addr 0x634ccb0, size 0x9c, virtual false, abstract: false, final false
inline bool SkipString(::StringW  text) ;

/// @brief Method SkipToValue, addr 0x634bfc4, size 0x70, virtual false, abstract: false, final false
inline bool SkipToValue() ;

/// @brief Method SkipWhitespace, addr 0x634bf3c, size 0x88, virtual false, abstract: false, final false
inline void SkipWhitespace() ;

/// @brief Method ToString, addr 0x634bda8, size 0x110, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x63419e4, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  json) ;

/// @brief Method get_isAtEnd, addr 0x634cd74, size 0x10, virtual false, abstract: false, final false
