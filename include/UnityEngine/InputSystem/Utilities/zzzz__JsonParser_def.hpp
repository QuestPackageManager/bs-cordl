...
public:
  ...
  /// @brief Method Equals, addr 0x2bf79e8, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2bf7840, size 0x1a8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString other);

  /// @brief Method GetHashCode, addr 0x2bf7a78, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2bf774c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2bf7ab4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf7b18, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x2bf7ae4, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ToString>b__11_0, addr 0x2bf8fdc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _ToString_b__11_0(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue x);

  /// @brief Method <ToString>b__11_1, addr 0x2bf8fe4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bf8fd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x2bf8d4c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2bf84d4, size 0x878, virtual false, abstract: false, final false
  static inline bool Equals(::System::Object* obj, ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue value);

  /// @brief Method Equals, addr 0x2bf82d0, size 0x204, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue other);

  /// @brief Method GetHashCode, addr 0x2bf8ddc, size 0x15c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToBoolean, addr 0x2bf7b38, size 0x140, virtual false, abstract: false, final false
  inline bool ToBoolean();

  /// @brief Method ToDouble, addr 0x2bf8180, size 0xcc, virtual false, abstract: false, final false
  inline double_t ToDouble();

  /// @brief Method ToInteger, addr 0x2bf80b0, size 0xd0, virtual false, abstract: false, final false
  inline int64_t ToInteger();

  /// @brief Method ToString, addr 0x2bf7c78, size 0x438, virtual true, abstract: false, final false
  inline ::StringW ToString();
  ...
  /// @brief Method op_Equality, addr 0x2bf69cc, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf75fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf8288, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf824c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf7588, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue
  ...
  /// @brief Method op_Implicit, addr 0x2bf82ac, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf7710, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf7648, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2bf7620, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x2bf8f38, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CurrentPropertyHasValueEqualTo, addr 0x2bf6770, size 0x14c, virtual false, abstract: false, final false
  inline bool CurrentPropertyHasValueEqualTo(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue expectedValue);

  /// @brief Method NavigateToProperty, addr 0x2bf6144, size 0x48c, virtual false, abstract: false, final false
  inline bool NavigateToProperty(::StringW path);

  /// @brief Method ParseArrayValue, addr 0x2bf6b84, size 0x2c8, virtual false, abstract: false, final false
  inline bool ParseArrayValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseBooleanValue, addr 0x2bf6fbc, size 0xd8, virtual false, abstract: false, final false
  inline bool ParseBooleanValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseNullValue, addr 0x2bf7094, size 0x64, virtual false, abstract: false, final false
  inline bool ParseNullValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseNumber, addr 0x2bf70f8, size 0x490, virtual false, abstract: false, final false
  inline bool ParseNumber(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseObjectValue, addr 0x2bf6e4c, size 0x170, virtual false, abstract: false, final false
  inline bool ParseObjectValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseStringValue, addr 0x2bf6a00, size 0x184, virtual false, abstract: false, final false
  inline bool ParseStringValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method ParseToken, addr 0x2bf65d0, size 0x74, virtual false, abstract: false, final false
  inline bool ParseToken(char16_t token);

  /// @brief Method ParseValue, addr 0x2bf6740, size 0x30, virtual false, abstract: false, final false
  inline bool ParseValue();

  /// @brief Method ParseValue, addr 0x2bf68bc, size 0x110, virtual false, abstract: false, final false
  inline bool ParseValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue> result);

  /// @brief Method Reset, addr 0x2bf604c, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SkipString, addr 0x2bf7668, size 0xa8, virtual false, abstract: false, final false
  inline bool SkipString(::StringW text);

  /// @brief Method SkipToValue, addr 0x2bf66e0, size 0x60, virtual false, abstract: false, final false
  inline bool SkipToValue();

  /// @brief Method SkipWhitespace, addr 0x2bf6644, size 0x9c, virtual false, abstract: false, final false
  inline void SkipWhitespace();

  /// @brief Method ToString, addr 0x2bf6058, size 0xec, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2bf5fdc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW json);

  /// @brief Method get_isAtEnd, addr 0x2bf773c, size 0x10, virtual false, abstract: false, final false
