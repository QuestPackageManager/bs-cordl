...
public:
  ...
  /// @brief Method OnCompleted, addr 0x63c2f78, size 0x4, virtual true, abstract: false, final true
  inline void OnCompleted();

  /// @brief Method OnError, addr 0x63c2f7c, size 0x5c, virtual true, abstract: false, final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext, addr 0x63c2fd8, size 0x174, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63c2f6c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Subscribe, addr 0x63c2e78, size 0xf4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63c2e6c, size 0xc, virtual false, abstract: false, final false
