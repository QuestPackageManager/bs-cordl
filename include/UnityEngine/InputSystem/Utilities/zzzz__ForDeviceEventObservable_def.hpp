...
public:
  ...
  /// @brief Method .ctor addr 0x2b15da4 size 0x3c virtual false final false
  ...
  /// @brief Method OnCompleted addr 0x2b15de0 size 0x4 virtual true final true
  inline void OnCompleted();

  /// @brief Method OnError addr 0x2b15de4 size 0x58 virtual true final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext addr 0x2b15e3c size 0x184 virtual true final true
...
public:
  ...
  /// @brief Method .ctor addr 0x2b15c78 size 0x3c virtual false final false
  ...
  /// @brief Method Subscribe addr 0x2b15cb4 size 0xf0 virtual true final true
