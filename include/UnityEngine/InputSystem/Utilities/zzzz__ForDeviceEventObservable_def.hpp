...
public:
  ...
  /// @brief Method OnCompleted, addr 0x4569424, size 0x4, virtual true, abstract: false, final true
  inline void OnCompleted();

  /// @brief Method OnError, addr 0x4569428, size 0x58, virtual true, abstract: false, final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext, addr 0x4569480, size 0x184, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x45693e8, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Subscribe, addr 0x45692fc, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x45692c0, size 0x3c, virtual false, abstract: false, final false
