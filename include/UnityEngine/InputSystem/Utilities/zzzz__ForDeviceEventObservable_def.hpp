...
public:
  ...
  /// @brief Method OnCompleted, addr 0x3183490, size 0x4, virtual true, abstract: false, final true
  inline void OnCompleted();

  /// @brief Method OnError, addr 0x3183494, size 0x58, virtual true, abstract: false, final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext, addr 0x31834ec, size 0x184, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3183454, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Subscribe, addr 0x3183364, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3183328, size 0x3c, virtual false, abstract: false, final false
