...
public:
  ...
  /// @brief Method OnCompleted, addr 0x31aa0d0, size 0x4, virtual true, abstract: false, final true
  inline void OnCompleted();

  /// @brief Method OnError, addr 0x31aa0d4, size 0x58, virtual true, abstract: false, final true
  inline void OnError(::System::Exception* error);

  /// @brief Method OnNext, addr 0x31aa12c, size 0x184, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31aa094, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Subscribe, addr 0x31a9fa4, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31a9f68, size 0x3c, virtual false, abstract: false, final false
