...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::__ReadOnlyArray_1__Enumerator<TValue>::_ctor(::ArrayW<TValue, ::Array<TValue>*> array, int32_t index, int32_t length) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::__ReadOnlyArray_1__Enumerator<TValue>>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>::_ctor(::ArrayW<TValue, ::Array<TValue>*> array) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>>::get(), ".ctor", std::vector<Il2CppClass*>{},
                                  ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<TValue, ::Array<TValue>*>>::get() })));
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>::_ctor(::ArrayW<TValue, ::Array<TValue>*> array, int32_t index, int32_t length) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>>::get(), ".ctor", std::vector<Il2CppClass*>{},
      ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<TValue, ::Array<TValue>*>>::get(),
                                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, array, index, length);
}
...
template <typename TValue> inline int32_t UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>::IndexOf(::System::Predicate_1<TValue>* predicate) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>>::get(), "IndexOf", std::vector<Il2CppClass*>{},
                                  ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Predicate_1<TValue>*>::get() })));
...
UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>::op_Implicit___UnityEngine__InputSystem__Utilities__ReadOnlyArray_1_TValue_(::ArrayW<TValue, ::Array<TValue>*> array) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<TValue>>::get(), "op_Implicit",
                                  std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<TValue, ::Array<TValue>*>>::get() })));
