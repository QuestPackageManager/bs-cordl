...
#include "UnityEngine/InputSystem/Utilities/zzzz__ReadOnlyArray_1_def.hpp"
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::_ctor(::ArrayW<TValue, ::Array<TValue>*> array, int32_t index, int32_t length) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::Dispose() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(), "Dispose",
...
template <typename TValue> inline bool UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::MoveNext() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(), "MoveNext",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
...
template <typename TValue> inline void UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::Reset() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(), "Reset",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
template <typename TValue> inline TValue UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::get_Current() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(), "get_Current",
                                               std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
...
template <typename TValue> inline ::System::Object* UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::System_Collections_IEnumerator_get_Current() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>>::get(),
...
// Ctor Parameters [CppParam { name: "m_Array", ty: "::ArrayW<TValue,::Array<TValue>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_IndexStart", ty: "int32_t", modifiers: "",
...
template <typename TValue>
constexpr ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1_Enumerator<TValue>::ReadOnlyArray_1_Enumerator(::ArrayW<TValue, ::Array<TValue>*> m_Array, int32_t m_IndexStart, int32_t m_IndexEnd,
...
// Ctor Parameters [CppParam { name: "m_Array", ty: "::ArrayW<TValue,::Array<TValue>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_StartIndex", ty: "int32_t", modifiers: "",
