...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore<T>::Invoke(::by_ref<T> state) {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline void UnityEngine::InputSystem::Utilities::SavedStructState_1_TypedRestore<T>::EndInvoke(::by_ref<T> state, ::System::IAsyncResult* result) {
  auto* ___internal_method = THROW_UNLESS(
