...
constexpr ::System::IObserver_1<TSource>* UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::i___System__IObserver_1_TSource_() noexcept {
  return static_cast<::System::IObserver_1<TSource>*>(static_cast<void*>(this));
}
template <typename TSource, typename TResult>
constexpr ::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>*&
UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::__cordl_internal_get_m_Observable() {
...
UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::__cordl_internal_get_m_Observable() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Observable;
}
template <typename TSource, typename TResult>
...
UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::__cordl_internal_get_m_Observer() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Observer;
}
template <typename TSource, typename TResult>
...
UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::New_ctor(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>* observable,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>*>(observable, observer));
}
template <typename TSource, typename TResult>
inline void UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>::_ctor(::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>* observable,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::__SelectManyObservable_2__Select<TSource, TResult>*>::get(), ".ctor",
      std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>*>::get(),
...
UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>::__cordl_internal_get_m_Source() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Source;
}
template <typename TSource, typename TResult>
...
inline void UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>::_ctor(::System::IObservable_1<TSource>* source,
                                                                                                 ::System::Func_2<TSource, ::System::Collections::Generic::IEnumerable_1<TResult>*>* filter) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>*>::get(), ".ctor",
      std::span<Il2CppClass const* const, 0>(),
...
inline ::System::IDisposable* UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>::Subscribe(::System::IObserver_1<TResult>* observer) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::InputSystem::Utilities::SelectManyObservable_2<TSource, TResult>*>::get(), "Subscribe",
      std::span<Il2CppClass const* const, 0>(), ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::IObserver_1<TResult>*>::get() })));
