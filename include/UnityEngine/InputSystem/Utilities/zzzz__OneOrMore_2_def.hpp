...
template <typename TValue, typename TList>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6697)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6697), inst: 4802
