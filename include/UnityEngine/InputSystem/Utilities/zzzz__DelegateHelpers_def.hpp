...
public:
// Declarations
/// @brief Method InvokeCallbacksSafe, addr 0x634b228, size 0x2d0, virtual false, abstract: false, final false
static inline void InvokeCallbacksSafe(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*>>  callbacks, ::Unity::Profiling::ProfilerMarker  marker, ::StringW  callbackName, ::System::Object*  context) ;

/// @brief Method InvokeCallbacksSafe, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TValue>
static inline void InvokeCallbacksSafe(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<TValue>*>>  callbacks, TValue  argument, ::StringW  callbackName, ::System::Object*  context) ;

/// @brief Method InvokeCallbacksSafe, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TValue1,typename TValue2>
static inline void InvokeCallbacksSafe(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<TValue1,TValue2>*>>  callbacks, TValue1  argument1, TValue2  argument2, ::Unity::Profiling::ProfilerMarker  marker, ::StringW  callbackName, ::System::Object*  context) ;
...
template<typename TValue>
static inline void InvokeCallbacksSafe_AndInvokeReturnedActions(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_2<TValue,::System::Action*>*>>  callbacks, TValue  argument, ::StringW  callbackName, ::System::Object*  context) ;
...
static inline bool InvokeCallbacksSafe_AnyCallbackReturnsObject(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_2<TValue,TReturn>*>>  callbacks, TValue  argument, ::StringW  callbackName, ::System::Object*  context) ;
...
template<typename TValue1,typename TValue2>
static inline bool InvokeCallbacksSafe_AnyCallbackReturnsTrue(::ByRef<::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_3<TValue1,TValue2,bool>*>>  callbacks, TValue1  argument1, TValue2  argument2, ::StringW  callbackName, ::System::Object*  context) ;
