...
public:
  ...
  /// @brief Method ApplyToObject, addr 0x3047e98, size 0x2e8, virtual false, abstract: false, final false
  inline void ApplyToObject(::System::Object* instance);

  /// @brief Method ConvertTo, addr 0x3047300, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::NamedValue ConvertTo(::System::TypeCode type);

  /// @brief Method Equals, addr 0x30475bc, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3047534, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x304764c, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Parse, addr 0x3047b58, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NamedValue Parse(::StringW str);

  /// @brief Method ParseMultiple, addr 0x3047034, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseParameter, addr 0x3047804, size 0x354, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NamedValue ParseParameter(::StringW parameterString, ByRef<int32_t> index);

  /// @brief Method ToString, addr 0x3047240, size 0x94, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_name, addr 0x30472d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_type, addr 0x30472f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::TypeCode get_type();

  /// @brief Method get_value, addr 0x30472e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3047730, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x3047760, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_name, addr 0x30472dc, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_value, addr 0x30472f0, size 0x8, virtual false, abstract: false, final false
