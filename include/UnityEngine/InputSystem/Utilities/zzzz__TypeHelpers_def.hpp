...
public:
  ...
  /// @brief Method IsInt addr 0x28d9c6c size 0x10 virtual false final false
  static inline bool IsInt(::System::TypeCode type);

  /// @brief Method GetValueType addr 0x28d9c7c size 0x1a0 virtual false final false
  static inline ::System::Type* GetValueType(::System::Reflection::MemberInfo* member);

  /// @brief Method GetNiceTypeName addr 0x28d9e1c size 0x490 virtual false final false
  static inline ::StringW GetNiceTypeName(::System::Type* type);

  /// @brief Method GetGenericTypeArgumentFromHierarchy addr 0x28da2ac size 0x3cc virtual false final false
