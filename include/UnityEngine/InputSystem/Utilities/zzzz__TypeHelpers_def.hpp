...
public:
  ...
  /// @brief Method IsInt, addr 0x2a5c520, size 0x10, virtual false, abstract: false, final false
  static inline bool IsInt(::System::TypeCode type);

  /// @brief Method GetValueType, addr 0x2a5c530, size 0x1a0, virtual false, abstract: false, final false
  static inline ::System::Type* GetValueType(::System::Reflection::MemberInfo* member);

  /// @brief Method GetNiceTypeName, addr 0x2a5c6d0, size 0x490, virtual false, abstract: false, final false
  static inline ::StringW GetNiceTypeName(::System::Type* type);

  /// @brief Method GetGenericTypeArgumentFromHierarchy, addr 0x2a5cb60, size 0x3cc, virtual false, abstract: false, final false
