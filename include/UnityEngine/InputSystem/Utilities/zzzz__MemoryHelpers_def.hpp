...
public:
  ...
  /// @brief Method get_isEmpty, addr 0x2b13870, size 0x10, virtual false, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method .ctor, addr 0x2b13880, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t bitOffset, uint32_t sizeInBits);

  /// @brief Method .ctor, addr 0x2b13888, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t byteOffset, uint32_t bitOffset, uint32_t sizeInBits);

  /// @brief Method Overlap, addr 0x2b13894, size 0xc8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x2b12fc4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeFollowingByteOffset, addr 0x2b13178, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t ComputeFollowingByteOffset(uint32_t byteOffset, uint32_t sizeInBits);

  /// @brief Method WriteSingleBit, addr 0x2b13188, size 0x30, virtual false, abstract: false, final false
  static inline void WriteSingleBit(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, bool value);

  /// @brief Method ReadSingleBit, addr 0x2b13008, size 0x24, virtual false, abstract: false, final false
  static inline bool ReadSingleBit(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset);

  /// @brief Method MemCpyBitRegion, addr 0x2b131b8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method MemCmpBitRegion, addr 0x2b1302c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method MemSet, addr 0x2b132a4, size 0x64, virtual false, abstract: false, final false
  static inline void MemSet(::cordl_internals::Ptr<void> destination, int32_t numBytes, uint8_t value);

  /// @brief Method MemCpyMasked, addr 0x2b13308, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMultipleBitsAsUInt, addr 0x2b0b900, size 0x194, virtual false, abstract: false, final false
  static inline uint32_t ReadMultipleBitsAsUInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method WriteUIntAsMultipleBits, addr 0x2b13394, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadTwosComplementMultipleBitsAsInt, addr 0x2b0a23c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteIntAsTwosComplementMultipleBits, addr 0x2b0a328, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadExcessKMultipleBitsAsInt, addr 0x2b1354c, size 0x24, virtual false, abstract: false, final false
  static inline int32_t ReadExcessKMultipleBitsAsInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method WriteIntAsExcessKMultipleBits, addr 0x2b13570, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadMultipleBitsAsNormalizedUInt, addr 0x2b13584, size 0x4c, virtual false, abstract: false, final false
  static inline float_t ReadMultipleBitsAsNormalizedUInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method WriteNormalizedUIntAsMultipleBits, addr 0x2b135d0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBitsInBuffer, addr 0x2b13620, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method AlignNatural, addr 0x2b137ec, size 0x84, virtual false, abstract: false, final false
