...
public:
  ...
  /// @brief Method Overlap, addr 0x31b8f08, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31b8ef4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t bitOffset, uint32_t sizeInBits);

  /// @brief Method .ctor, addr 0x31b8efc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint32_t byteOffset, uint32_t bitOffset, uint32_t sizeInBits);

  /// @brief Method get_isEmpty, addr 0x31b8ee4, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AlignNatural, addr 0x31b8e60, size 0x84, virtual false, abstract: false, final false
  static inline uint32_t AlignNatural(uint32_t offset, uint32_t sizeInBytes);

  /// @brief Method Compare, addr 0x31b8638, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeFollowingByteOffset, addr 0x31b87ec, size 0x10, virtual false, abstract: false, final false
  static inline uint32_t ComputeFollowingByteOffset(uint32_t byteOffset, uint32_t sizeInBits);

  /// @brief Method MemCmpBitRegion, addr 0x31b86a0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method MemCpyBitRegion, addr 0x31b882c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method MemCpyMasked, addr 0x31b897c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method MemSet, addr 0x31b8918, size 0x64, virtual false, abstract: false, final false
  static inline void MemSet(::cordl_internals::Ptr<void> destination, int32_t numBytes, uint8_t value);

  /// @brief Method ReadExcessKMultipleBitsAsInt, addr 0x31b8bc0, size 0x24, virtual false, abstract: false, final false
  static inline int32_t ReadExcessKMultipleBitsAsInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method ReadMultipleBitsAsNormalizedUInt, addr 0x31b8bf8, size 0x4c, virtual false, abstract: false, final false
  static inline float_t ReadMultipleBitsAsNormalizedUInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method ReadMultipleBitsAsUInt, addr 0x31b1300, size 0x194, virtual false, abstract: false, final false
  static inline uint32_t ReadMultipleBitsAsUInt(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, uint32_t bitCount);

  /// @brief Method ReadSingleBit, addr 0x31b867c, size 0x24, virtual false, abstract: false, final false
  static inline bool ReadSingleBit(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset);

  /// @brief Method ReadTwosComplementMultipleBitsAsInt, addr 0x31af7fc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBitsInBuffer, addr 0x31b8c94, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteIntAsExcessKMultipleBits, addr 0x31b8be4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteIntAsTwosComplementMultipleBits, addr 0x31af8e8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteNormalizedUIntAsMultipleBits, addr 0x31b8c44, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteSingleBit, addr 0x31b87fc, size 0x30, virtual false, abstract: false, final false
  static inline void WriteSingleBit(::cordl_internals::Ptr<void> ptr, uint32_t bitOffset, bool value);

  /// @brief Method WriteUIntAsMultipleBits, addr 0x31b8a08, size 0x1b8, virtual false, abstract: false, final false
