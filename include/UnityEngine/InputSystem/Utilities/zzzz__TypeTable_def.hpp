...
public:
  ...
  /// @brief Method .ctor addr 0x28dad48 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <get_names>b__2_0 addr 0x28dad50 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method get_names addr 0x28da678 size 0x128 virtual false final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_names();

  /// @brief Method get_internedNames addr 0x28da7a0 size 0x50 virtual false final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::InternedString>* get_internedNames();

  /// @brief Method Initialize addr 0x28da7f0 size 0x74 virtual false final false
  inline void Initialize();

  /// @brief Method FindNameForType addr 0x28da864 size 0x220 virtual false final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindNameForType(::System::Type* type);

  /// @brief Method AddTypeRegistration addr 0x28daa84 size 0x168 virtual false final false
  inline void AddTypeRegistration(::StringW name, ::System::Type* type);

  /// @brief Method LookupTypeRegistration addr 0x28dabec size 0xf8 virtual false final false
