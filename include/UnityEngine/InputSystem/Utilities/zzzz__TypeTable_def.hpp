...
public:
  ...
  /// @brief Method .ctor, addr 0x2f8a3b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_names>b__2_0, addr 0x2f8a3c0, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddTypeRegistration, addr 0x2f8a0f4, size 0x168, virtual false, abstract: false, final false
  inline void AddTypeRegistration(::StringW name, ::System::Type* type);

  /// @brief Method FindNameForType, addr 0x2f89ed4, size 0x220, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::InternedString FindNameForType(::System::Type* type);

  /// @brief Method Initialize, addr 0x2f89e60, size 0x74, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method LookupTypeRegistration, addr 0x2f8a25c, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Type* LookupTypeRegistration(::StringW name);

  /// @brief Method get_internedNames, addr 0x2f89e10, size 0x50, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::InternedString>* get_internedNames();

  /// @brief Method get_names, addr 0x2f89ce8, size 0x128, virtual false, abstract: false, final false
