...
public:
  ...
  /// @brief Method .ctor, addr 0x2b1490c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <ToString>b__8_0, addr 0x2b14914, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_name, addr 0x2b13df0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x2b13df8, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method get_parameters, addr 0x2b13e00, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::NamedValue> get_parameters();

  /// @brief Method set_parameters, addr 0x2b13e0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2b13e14, size 0x1e8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ParseMultiple, addr 0x2b13ffc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMultiple, addr 0x2b14098, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseName, addr 0x2b14600, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ParseName(::StringW text);

  /// @brief Method Parse, addr 0x2b14680, size 0x90, virtual false, abstract: false, final false
