...
public:
  ...
  /// @brief Method .ctor addr 0x2993bb8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToString>b__8_0 addr 0x2993bc0 size 0x8 virtual false final false
...
namespace UnityEngine::InputSystem::Utilities {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6787), inst: 3050 }), TypeDefinitionIndex(TypeDefinitionIndex(6769)),
// TypeDefinitionIndex(TypeDefinitionIndex(6787))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6768)) CS Name: ::UnityEngine.InputSystem.Utilities::NameAndParameters
...
public:
  ...
  /// @brief Method get_name addr 0x299309c size 0x8 virtual false final false
  inline ::StringW get_name();

  /// @brief Method set_name addr 0x29930a4 size 0x8 virtual false final false
  inline void set_name(::StringW value);

  /// @brief Method get_parameters addr 0x29930ac size 0xc virtual false final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::NamedValue> get_parameters();

  /// @brief Method set_parameters addr 0x29930b8 size 0x8 virtual false final false
  ...
  /// @brief Method ToString addr 0x29930c0 size 0x1e8 virtual true final false
  inline ::StringW ToString();

  /// @brief Method ParseMultiple addr 0x29932a8 size 0x9c virtual false final false
  ...
  /// @brief Method ParseMultiple addr 0x2993344 size 0x1dc virtual false final false
  ...
  /// @brief Method ParseName addr 0x29938ac size 0x80 virtual false final false
  static inline ::StringW ParseName(::StringW text);

  /// @brief Method Parse addr 0x299392c size 0x90 virtual false final false
  static inline ::UnityEngine::InputSystem::Utilities::NameAndParameters Parse(::StringW text);

  /// @brief Method ParseNameAndParameters addr 0x2993520 size 0x38c virtual false final false
