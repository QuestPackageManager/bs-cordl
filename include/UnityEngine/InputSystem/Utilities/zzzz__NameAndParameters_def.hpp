...
public:
  ...
  /// @brief Method .ctor, addr 0x2b14478, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <ToString>b__8_0, addr 0x2b14480, size 0x8, virtual false, abstract: false, final false
...
namespace UnityEngine::InputSystem::Utilities {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5942)), TypeDefinitionIndex(TypeDefinitionIndex(5960)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5960), inst: 3082
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5941)) CS Name: ::UnityEngine.InputSystem.Utilities::NameAndParameters
...
public:
  ...
  /// @brief Method get_name, addr 0x2b1395c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x2b13964, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method get_parameters, addr 0x2b1396c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::NamedValue> get_parameters();

  /// @brief Method set_parameters, addr 0x2b13978, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2b13980, size 0x1e8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ParseMultiple, addr 0x2b13b68, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseMultiple, addr 0x2b13c04, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseName, addr 0x2b1416c, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ParseName(::StringW text);

  /// @brief Method Parse, addr 0x2b141ec, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::NameAndParameters Parse(::StringW text);

  /// @brief Method ParseNameAndParameters, addr 0x2b13de0, size 0x38c, virtual false, abstract: false, final false
