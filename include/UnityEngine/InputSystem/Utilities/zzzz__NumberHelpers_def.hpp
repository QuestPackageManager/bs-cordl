...
public:
  // Declarations
  /// @brief Method AlignToMultipleOf, addr 0x6350520, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t AlignToMultipleOf(int32_t number, int32_t alignment);

  /// @brief Method AlignToMultipleOf, addr 0x635053c, size 0x1c, virtual false, abstract: false, final false
  static inline int64_t AlignToMultipleOf(int64_t number, int64_t alignment);

  /// @brief Method AlignToMultipleOf, addr 0x6350558, size 0x1c, virtual false, abstract: false, final false
  static inline uint32_t AlignToMultipleOf(uint32_t number, uint32_t alignment);

  /// @brief Method Approximately, addr 0x6350574, size 0xac, virtual false, abstract: false, final false
  static inline bool Approximately(double_t a, double_t b);

  /// @brief Method IntToNormalizedFloat, addr 0x6350620, size 0x38, virtual false, abstract: false, final false
  static inline float_t IntToNormalizedFloat(int32_t value, int32_t minValue, int32_t maxValue);

  /// @brief Method NormalizedFloatToInt, addr 0x6350658, size 0x50, virtual false, abstract: false, final false
  static inline int32_t NormalizedFloatToInt(float_t value, int32_t intMinValue, int32_t intMaxValue);

  /// @brief Method NormalizedFloatToUInt, addr 0x63506e0, size 0x48, virtual false, abstract: false, final false
  static inline uint32_t NormalizedFloatToUInt(float_t value, uint32_t uintMinValue, uint32_t uintMaxValue);

  /// @brief Method RemapUIntBitsToNormalizeFloatToUIntBits, addr 0x6350728, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t RemapUIntBitsToNormalizeFloatToUIntBits(uint32_t value, uint32_t inBitSize, uint32_t outBitSize);

  /// @brief Method UIntToNormalizedFloat, addr 0x63506a8, size 0x38, virtual false, abstract: false, final false
