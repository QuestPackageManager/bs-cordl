...
public:
  ...
  /// @brief [InputControl(offset = 0, displayName = "parentBoneIndex")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BoneControl", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BoneControl(BoneControl&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BoneControl", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BoneControl(BoneControlconst&) = delete;
