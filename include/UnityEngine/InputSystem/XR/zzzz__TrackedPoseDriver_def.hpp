...
public:
  ...
  /// @brief Method Awake, addr 0x45e5cdc, size 0x2c, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method BindActions, addr 0x45e58fc, size 0x20, virtual false, abstract: false, final false
  inline void BindActions();

  /// @brief Method BindPosition, addr 0x45e4fec, size 0x1a0, virtual false, abstract: false, final false
  inline void BindPosition();

  /// @brief Method BindRotation, addr 0x45e53a4, size 0x1a0, virtual false, abstract: false, final false
  inline void BindRotation();

  /// @brief Method BindTrackingState, addr 0x45e575c, size 0x1a0, virtual false, abstract: false, final false
  inline void BindTrackingState();

  /// @brief Method HasStereoCamera, addr 0x45e5d08, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeRender, addr 0x45e6190, size 0x20, virtual true, abstract: false, final false
  inline void OnBeforeRender();

  /// @brief Method OnDestroy, addr 0x45e5ef0, size 0x2c, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x45e5e44, size 0xac, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x45e5d8c, size 0xb8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPositionCanceled, addr 0x45e599c, size 0x58, virtual false, abstract: false, final false
  inline void OnPositionCanceled(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnPositionPerformed, addr 0x45e593c, size 0x60, virtual false, abstract: false, final false
  inline void OnPositionPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnRotationCanceled, addr 0x45e5a54, size 0x50, virtual false, abstract: false, final false
  inline void OnRotationCanceled(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnRotationPerformed, addr 0x45e59f4, size 0x60, virtual false, abstract: false, final false
  inline void OnRotationPerformed(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnTrackingStateCanceled, addr 0x45e5b00, size 0x8, virtual false, abstract: false, final false
  inline void OnTrackingStateCanceled(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnTrackingStatePerformed, addr 0x45e5aa4, size 0x5c, virtual false, abstract: false, final false
  inline void OnTrackingStatePerformed(::UnityEngine::InputSystem::InputAction_CallbackContext context);

  /// @brief Method OnUpdate, addr 0x45e6174, size 0x1c, virtual true, abstract: false, final false
  inline void OnUpdate();

  /// @brief Method PerformUpdate, addr 0x45e61b0, size 0x1c, virtual true, abstract: false, final false
  inline void PerformUpdate();

  /// @brief Method ReadTrackingState, addr 0x45e6040, size 0x134, virtual false, abstract: false, final false
  inline void ReadTrackingState();

  /// @brief Method Reset, addr 0x45e5b08, size 0x1d4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetLocalTransform, addr 0x45e61cc, size 0x16c, virtual true, abstract: false, final false
  inline void SetLocalTransform(::UnityEngine::Vector3 newPosition, ::UnityEngine::Quaternion newRotation);

  /// @brief Method UnbindActions, addr 0x45e591c, size 0x20, virtual false, abstract: false, final false
  inline void UnbindActions();

  /// @brief Method UnbindPosition, addr 0x45e4ea8, size 0x144, virtual false, abstract: false, final false
  inline void UnbindPosition();

  /// @brief Method UnbindRotation, addr 0x45e5260, size 0x144, virtual false, abstract: false, final false
  inline void UnbindRotation();

  /// @brief Method UnbindTrackingState, addr 0x45e5618, size 0x144, virtual false, abstract: false, final false
  inline void UnbindTrackingState();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x45e63e4, size 0x90, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x45e63e0, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UpdateCallback, addr 0x45e5f1c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45e6474, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ignoreTrackingState, addr 0x45e4dc0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreTrackingState();

  /// @brief Method get_positionAction, addr 0x45e6338, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_positionAction();

  /// @brief Method get_positionInput, addr 0x45e4dd4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_positionInput();

  /// @brief Method get_rotationAction, addr 0x45e638c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_rotationAction();

  /// @brief Method get_rotationInput, addr 0x45e518c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_rotationInput();

  /// @brief Method get_trackingStateInput, addr 0x45e5544, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionProperty get_trackingStateInput();

  /// @brief Method get_trackingType, addr 0x45e4da0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::TrackedPoseDriver_TrackingType get_trackingType();

  /// @brief Method get_updateType, addr 0x45e4db0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::TrackedPoseDriver_UpdateType get_updateType();

  /// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
  constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

  /// @brief Method set_ignoreTrackingState, addr 0x45e4dc8, size 0xc, virtual false, abstract: false, final false
  inline void set_ignoreTrackingState(bool value);

  /// @brief Method set_positionAction, addr 0x45e6344, size 0x48, virtual false, abstract: false, final false
  inline void set_positionAction(::UnityEngine::InputSystem::InputAction* value);

  /// @brief Method set_positionInput, addr 0x45e4de8, size 0xc0, virtual false, abstract: false, final false
  inline void set_positionInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_rotationAction, addr 0x45e6398, size 0x48, virtual false, abstract: false, final false
  inline void set_rotationAction(::UnityEngine::InputSystem::InputAction* value);

  /// @brief Method set_rotationInput, addr 0x45e51a0, size 0xc0, virtual false, abstract: false, final false
  inline void set_rotationInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_trackingStateInput, addr 0x45e5558, size 0xc0, virtual false, abstract: false, final false
  inline void set_trackingStateInput(::UnityEngine::InputSystem::InputActionProperty value);

  /// @brief Method set_trackingType, addr 0x45e4da8, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingType(::UnityEngine::InputSystem::XR::TrackedPoseDriver_TrackingType value);

  /// @brief Method set_updateType, addr 0x45e4db8, size 0x8, virtual false, abstract: false, final false
