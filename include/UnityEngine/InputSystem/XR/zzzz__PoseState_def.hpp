...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::PoseState, "UnityEngine.InputSystem.XR", "PoseState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6581440, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x65813e4, size 0x5c, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::PoseState) == 0x3c, "Size mismatch!");
