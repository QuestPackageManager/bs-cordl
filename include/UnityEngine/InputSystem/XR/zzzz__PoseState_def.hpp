...
public:
  ...
  /// @brief Method .ctor, addr 0x6442ca8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x6442c4c, size 0x5c, virtual true, abstract: false, final true
