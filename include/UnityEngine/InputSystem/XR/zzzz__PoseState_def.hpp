...
public:
  ...
  /// @brief Method .ctor, addr 0x2ff2bbc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_format, addr 0x2ff2b8c, size 0x30, virtual true, abstract: false, final true
