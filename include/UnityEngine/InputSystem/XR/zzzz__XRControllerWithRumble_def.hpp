...
public:
  // Declarations
  /// @brief Method SendImpulse, addr 0x2ac67a4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ac68cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
