...
/// @brief Method .ctor, addr 0x63d6324, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint32_t  samplesQueued, uint32_t  samplesAvailable) ;

/// @brief Method get_samplesAvailable, addr 0x63d633c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesAvailable() ;

/// @brief Method get_samplesQueued, addr 0x63d632c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesQueued() ;

/// @brief Method set_samplesAvailable, addr 0x63d6344, size 0x8, virtual false, abstract: false, final false
inline void set_samplesAvailable(uint32_t  value) ;

/// @brief Method set_samplesQueued, addr 0x63d6334, size 0x8, virtual false, abstract: false, final false
