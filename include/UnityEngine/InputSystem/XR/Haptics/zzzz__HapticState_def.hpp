...
public:
  ...
  /// @brief Method .ctor, addr 0x2aca330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t samplesQueued, uint32_t samplesAvailable);

  /// @brief Method get_samplesQueued, addr 0x2aca338, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_samplesQueued();

  /// @brief Method set_samplesQueued, addr 0x2aca340, size 0x8, virtual false, abstract: false, final false
  inline void set_samplesQueued(uint32_t value);

  /// @brief Method get_samplesAvailable, addr 0x2aca348, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_samplesAvailable();

  /// @brief Method set_samplesAvailable, addr 0x2aca350, size 0x8, virtual false, abstract: false, final false
