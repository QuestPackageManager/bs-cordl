...
public:
  ...
  /// @brief Method Create, addr 0x45f21c8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x45f6620, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x45f6650, size 0x30, virtual true, abstract: false, final true
