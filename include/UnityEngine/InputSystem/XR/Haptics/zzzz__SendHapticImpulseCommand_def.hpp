...
public:
  ...
  /// @brief Method Create, addr 0x6443b08, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x6448418, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x6448424, size 0xc, virtual true, abstract: false, final true
