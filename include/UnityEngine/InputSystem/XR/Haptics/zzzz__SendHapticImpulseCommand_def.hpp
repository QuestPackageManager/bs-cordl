...
public:
  ...
  /// @brief Method Create, addr 0x315806c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x315c4f0, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x315c520, size 0x30, virtual true, abstract: false, final true
