...
/// @brief Method Create, addr 0x63d1afc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x63d640c, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x63d6418, size 0xc, virtual true, abstract: false, final true
