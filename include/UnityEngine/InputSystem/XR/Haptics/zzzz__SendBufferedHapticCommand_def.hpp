...
public:
  ...
  /// @brief Method Create, addr 0x63d5b3c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x63d5d34, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x63d5d40, size 0xc, virtual true, abstract: false, final true
