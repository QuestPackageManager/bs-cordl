...
public:
  ...
  /// @brief Method Create, addr 0x45ed2b0, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x45ed590, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x45ed5c0, size 0x30, virtual true, abstract: false, final true
