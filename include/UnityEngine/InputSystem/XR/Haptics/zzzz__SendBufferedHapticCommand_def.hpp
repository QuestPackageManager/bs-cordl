...
public:
  ...
  /// @brief Method Create, addr 0x2c10ad8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x2c10db8, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_typeStatic, addr 0x2c10de8, size 0x30, virtual true, abstract: false, final true
