...
public:
  ...
  /// @brief Method Create, addr 0x63d5cac, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x63d5c8c, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type();

  /// @brief Method get_currentState, addr 0x63d5ca4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::XR::Haptics::HapticState get_currentState();

  /// @brief Method get_typeStatic, addr 0x63d5c98, size 0xc, virtual true, abstract: false, final true
