...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRSupport", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRSupport(XRSupport&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRSupport", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRSupport(XRSupportconst&) = delete;
