...
public:
  ...
  /// @brief Method get_leftEyePosition, addr 0x2ac8378, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_leftEyePosition();

  /// @brief Method set_leftEyePosition, addr 0x2ac8384, size 0xc, virtual false, abstract: false, final false
  inline void set_leftEyePosition(::UnityEngine::Vector3 value);

  /// @brief Method get_leftEyeRotation, addr 0x2ac8390, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_leftEyeRotation();

  /// @brief Method set_leftEyeRotation, addr 0x2ac839c, size 0xc, virtual false, abstract: false, final false
  inline void set_leftEyeRotation(::UnityEngine::Quaternion value);

  /// @brief Method get_rightEyePosition, addr 0x2ac83a8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_rightEyePosition();

  /// @brief Method set_rightEyePosition, addr 0x2ac83b4, size 0xc, virtual false, abstract: false, final false
  inline void set_rightEyePosition(::UnityEngine::Vector3 value);

  /// @brief Method get_rightEyeRotation, addr 0x2ac83c0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rightEyeRotation();

  /// @brief Method set_rightEyeRotation, addr 0x2ac83cc, size 0xc, virtual false, abstract: false, final false
  inline void set_rightEyeRotation(::UnityEngine::Quaternion value);

  /// @brief Method get_fixationPoint, addr 0x2ac83d8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_fixationPoint();

  /// @brief Method set_fixationPoint, addr 0x2ac83e4, size 0xc, virtual false, abstract: false, final false
  inline void set_fixationPoint(::UnityEngine::Vector3 value);

  /// @brief Method get_leftEyeOpenAmount, addr 0x2ac83f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_leftEyeOpenAmount();

  /// @brief Method set_leftEyeOpenAmount, addr 0x2ac83f8, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyeOpenAmount(float_t value);

  /// @brief Method get_rightEyeOpenAmount, addr 0x2ac8400, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rightEyeOpenAmount();

  /// @brief Method set_rightEyeOpenAmount, addr 0x2ac8408, size 0x8, virtual false, abstract: false, final false
