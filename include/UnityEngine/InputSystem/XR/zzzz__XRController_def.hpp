...
public:
// Declarations
/// @brief Method FinishSetup, addr 0x63d18e8, size 0xfc, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::XR::XRController* New_ctor() ;

/// @brief Method .ctor, addr 0x63d1a30, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leftHand, addr 0x63d1790, size 0xac, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::XR::XRController* get_leftHand() ;

/// @brief Method get_rightHand, addr 0x63d183c, size 0xac, virtual false, abstract: false, final false
