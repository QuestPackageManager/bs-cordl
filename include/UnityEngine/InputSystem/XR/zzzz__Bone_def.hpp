...
public:
  ...
  /// @brief Method get_parentBoneIndex addr 0x29495f0 size 0x8 virtual false final false
  inline uint32_t get_parentBoneIndex();

  /// @brief Method set_parentBoneIndex addr 0x29495f8 size 0x8 virtual false final false
  inline void set_parentBoneIndex(uint32_t value);

  /// @brief Method get_position addr 0x2949600 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method set_position addr 0x294960c size 0xc virtual false final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method get_rotation addr 0x2949618 size 0xc virtual false final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method set_rotation addr 0x2949624 size 0xc virtual false final false
