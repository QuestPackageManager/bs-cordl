...
/// @brief Method <OnFindLayoutForDevice>b__0, addr 0x63d4b5c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63d3b6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field poseSubControlTypes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_poseSubControlTypes, put=setStaticF_poseSubControlTypes)) ::ArrayW<::UnityEngine::InputSystem::XR::FeatureType,::Array<::UnityEngine::InputSystem::XR::FeatureType>*>  poseSubControlTypes;

/// @brief Method Build, addr 0x63d3ecc, size 0xacc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build() ;

/// @brief Method ConvertPotentialAliasToName, addr 0x63d3b74, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method GetParentControlName, addr 0x63d3d28, size 0x3c, virtual false, abstract: false, final false
inline ::StringW GetParentControlName(::StringW  name) ;

/// @brief Method GetSizeOfFeature, addr 0x63d3564, size 0xb4, virtual false, abstract: false, final false
static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor  featureDescriptor) ;

/// @brief Method IsPoseControl, addr 0x63d3d64, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method IsSubControl, addr 0x63d3cf8, size 0x30, virtual false, abstract: false, final false
inline bool IsSubControl(::StringW  name) ;

static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor() ;

/// @brief Method OnFindLayoutForDevice, addr 0x63d3778, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method SanitizeString, addr 0x63d3618, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63d3b70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
