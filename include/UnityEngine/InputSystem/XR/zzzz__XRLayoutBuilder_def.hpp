...
public:
  ...
  /// @brief Method <OnFindLayoutForDevice>b__0, addr 0x45e7678, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45e66d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Build, addr 0x45e6a0c, size 0xad0, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build();

  /// @brief Method ConvertPotentialAliasToName, addr 0x45e66e8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentControlName, addr 0x45e6880, size 0x38, virtual false, abstract: false, final false
  inline ::StringW GetParentControlName(::StringW name);

  /// @brief Method GetSizeOfFeature, addr 0x45e613c, size 0x78, virtual false, abstract: false, final false
  static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor featureDescriptor);

  /// @brief Method IsPoseControl, addr 0x45e68b8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSubControl, addr 0x45e6864, size 0x1c, virtual false, abstract: false, final false
  inline bool IsSubControl(::StringW name);

  static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor();

  /// @brief Method OnFindLayoutForDevice, addr 0x45e6310, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method SanitizeString, addr 0x45e61b4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45e66e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
