...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::XR::FeatureType, "UnityEngine.InputSystem.XR", "FeatureType");
// Dependencies
namespace UnityEngine::InputSystem::XR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::XR::FeatureType) == 0x4, "Size mismatch!");
