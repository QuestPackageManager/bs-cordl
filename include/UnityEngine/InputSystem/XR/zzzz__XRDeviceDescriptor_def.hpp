...
public:
  ...
  /// @brief Method FromJson, addr 0x65879a0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToJson, addr 0x658ab2c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x658ab34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRDeviceDescriptor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRDeviceDescriptor(XRDeviceDescriptor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRDeviceDescriptor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRDeviceDescriptor(XRDeviceDescriptorconst&) = delete;
