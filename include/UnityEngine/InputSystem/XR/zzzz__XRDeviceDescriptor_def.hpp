...
public:
  ...
  /// @brief Method FromJson, addr 0x63d1324, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToJson, addr 0x63d44b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63d44b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
