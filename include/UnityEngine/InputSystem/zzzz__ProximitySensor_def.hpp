...
public:
  ...
  /// @brief Method FinishSetup, addr 0x45d5c88, size 0x78, virtual true, abstract: false, final false
  inline void FinishSetup();

  /// @brief Method MakeCurrent, addr 0x45d5bb0, size 0x54, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::ProximitySensor* New_ctor();

  /// @brief Method OnRemoved, addr 0x45d5c04, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45d5d00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::InputSystem::ProximitySensor* getStaticF__current_k__BackingField();

  /// @brief Method get_current, addr 0x45d5b1c, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::ProximitySensor* get_current();

  /// @brief Method get_distance, addr 0x45d5b0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x45d5b64, size 0x4c, virtual false, abstract: false, final false
  static inline void set_current(::UnityEngine::InputSystem::ProximitySensor* value);

  /// @brief Method set_distance, addr 0x45d5b14, size 0x8, virtual false, abstract: false, final false
