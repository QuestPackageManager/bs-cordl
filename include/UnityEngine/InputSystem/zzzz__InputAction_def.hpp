...
public:
  ...
  /// @brief Method get_actionIndex, addr 0x2a39e88, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_actionIndex();

  /// @brief Method get_bindingIndex, addr 0x2a39e90, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_bindingIndex();

  /// @brief Method get_controlIndex, addr 0x2a39ec4, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_controlIndex();

  /// @brief Method get_interactionIndex, addr 0x2a39ef8, size 0x34, virtual false, abstract: false, final false
  inline int32_t get_interactionIndex();

  /// @brief Method get_phase, addr 0x2a39f2c, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_started, addr 0x2a39f5c, size 0x38, virtual false, abstract: false, final false
  inline bool get_started();

  /// @brief Method get_performed, addr 0x2a39f94, size 0x38, virtual false, abstract: false, final false
  inline bool get_performed();

  /// @brief Method get_canceled, addr 0x2a39fcc, size 0x38, virtual false, abstract: false, final false
  inline bool get_canceled();

  /// @brief Method get_action, addr 0x2a3a004, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* get_action();

  /// @brief Method get_control, addr 0x2a3a034, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_interaction, addr 0x2a3a078, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::IInputInteraction* get_interaction();

  /// @brief Method get_time, addr 0x2a3a0d0, size 0x38, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_startTime, addr 0x2a3a108, size 0x38, virtual false, abstract: false, final false
  inline double_t get_startTime();

  /// @brief Method get_duration, addr 0x2a3a140, size 0x68, virtual false, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_valueType, addr 0x2a3a1a8, size 0x50, virtual false, abstract: false, final false
  inline ::System::Type* get_valueType();

  /// @brief Method get_valueSizeInBytes, addr 0x2a3a1f8, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method ReadValue, addr 0x2a3a248, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsButton, addr 0x2a3a410, size 0x84, virtual false, abstract: false, final false
  inline bool ReadValueAsButton();

  /// @brief Method ReadValueAsObject, addr 0x2a3a494, size 0x88, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method ToString, addr 0x2a3a51c, size 0x250, virtual true, abstract: false, final false
...
// TypeDefinitionIndex(TypeDefinitionIndex(5391)), TypeDefinitionIndex(TypeDefinitionIndex(5392)), TypeDefinitionIndex(TypeDefinitionIndex(5441)), TypeDefinitionIndex(TypeDefinitionIndex(5446)),
...
// TypeDefinitionIndex(2448), inst: 3072 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5919), inst: 988 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5393)) CS Name:
...
public:
  ...
  /// @brief Method get_name, addr 0x2a383c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_type, addr 0x2a383cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionType get_type();

  /// @brief Method get_id, addr 0x2a383d4, size 0x34, virtual false, abstract: false, final false
  inline ::System::Guid get_id();

  /// @brief Method get_idDontGenerate, addr 0x2a38454, size 0x48, virtual false, abstract: false, final false
  inline ::System::Guid get_idDontGenerate();

  /// @brief Method get_expectedControlType, addr 0x2a3849c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_expectedControlType();

  /// @brief Method set_expectedControlType, addr 0x2a384a4, size 0x8, virtual false, abstract: false, final false
  inline void set_expectedControlType(::StringW value);

  /// @brief Method get_processors, addr 0x2a384ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processors();

  /// @brief Method get_interactions, addr 0x2a384b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_interactions();

  /// @brief Method get_actionMap, addr 0x2a384bc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* get_actionMap();

  /// @brief Method get_bindingMask, addr 0x2a384fc, size 0x10, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> get_bindingMask();

  /// @brief Method set_bindingMask, addr 0x2a3850c, size 0x1f4, virtual false, abstract: false, final false
  inline void set_bindingMask(::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> value);

  /// @brief Method get_bindings, addr 0x2a387c8, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputBinding> get_bindings();

  /// @brief Method get_controls, addr 0x2a38878, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_controls();

  /// @brief Method get_phase, addr 0x2a38970, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionPhase get_phase();

  /// @brief Method get_inProgress, addr 0x2a38a0c, size 0x4c, virtual false, abstract: false, final false
  inline bool get_inProgress();

  /// @brief Method get_enabled, addr 0x2a38a58, size 0x48, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method add_started, addr 0x2a38aa0, size 0x58, virtual false, abstract: false, final false
  inline void add_started(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_started, addr 0x2a38af8, size 0x58, virtual false, abstract: false, final false
  inline void remove_started(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_canceled, addr 0x2a38b50, size 0x58, virtual false, abstract: false, final false
  inline void add_canceled(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_canceled, addr 0x2a38ba8, size 0x58, virtual false, abstract: false, final false
  inline void remove_canceled(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method add_performed, addr 0x2a38c00, size 0x58, virtual false, abstract: false, final false
  inline void add_performed(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method remove_performed, addr 0x2a38c58, size 0x58, virtual false, abstract: false, final false
  inline void remove_performed(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>* value);

  /// @brief Method get_triggered, addr 0x2a38cb0, size 0x4, virtual false, abstract: false, final false
  inline bool get_triggered();

  /// @brief Method get_activeControl, addr 0x2a38d54, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_activeControl();

  /// @brief Method get_wantsInitialStateCheck, addr 0x2a38de0, size 0x1c, virtual false, abstract: false, final false
  inline bool get_wantsInitialStateCheck();

  /// @brief Method set_wantsInitialStateCheck, addr 0x2a38dfc, size 0x1c, virtual false, abstract: false, final false
  inline void set_wantsInitialStateCheck(bool value);

  static inline ::UnityEngine::InputSystem::InputAction* New_ctor();

  /// @brief Method .ctor, addr 0x2a38e18, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x2a38e28, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2a38f48, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ToString, addr 0x2a38f64, size 0x2d0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Enable, addr 0x2a39234, size 0x88, virtual false, abstract: false, final false
  inline void Enable();

  /// @brief Method Disable, addr 0x2a392bc, size 0x70, virtual false, abstract: false, final false
  inline void Disable();

  /// @brief Method Clone, addr 0x2a3932c, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputAction* Clone();

  /// @brief Method System.ICloneable.Clone, addr 0x2a39408, size 0x4, virtual true, abstract: false, final true
  inline ::System::Object* System_ICloneable_Clone();

  /// @brief Method ReadValue, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename TValue> inline TValue ReadValue();

  /// @brief Method ReadValueAsObject, addr 0x2a3940c, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject();

  /// @brief Method Reset, addr 0x2a394a8, size 0x9c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method IsPressed, addr 0x2a39544, size 0x54, virtual false, abstract: false, final false
  inline bool IsPressed();

  /// @brief Method IsInProgress, addr 0x2a39598, size 0x58, virtual false, abstract: false, final false
  inline bool IsInProgress();

  /// @brief Method WasPressedThisFrame, addr 0x2a395f0, size 0xa0, virtual false, abstract: false, final false
  inline bool WasPressedThisFrame();

  /// @brief Method WasReleasedThisFrame, addr 0x2a39690, size 0xa0, virtual false, abstract: false, final false
  inline bool WasReleasedThisFrame();

  /// @brief Method WasPerformedThisFrame, addr 0x2a38cb4, size 0xa0, virtual false, abstract: false, final false
  inline bool WasPerformedThisFrame();

  /// @brief Method GetTimeoutCompletionPercentage, addr 0x2a39730, size 0x134, virtual false, abstract: false, final false
  inline float_t GetTimeoutCompletionPercentage();

  /// @brief Method get_isSingletonAction, addr 0x2a384dc, size 0x20, virtual false, abstract: false, final false
  inline bool get_isSingletonAction();

  /// @brief Method get_currentState, addr 0x2a389b0, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputActionState__TriggerState get_currentState();

  /// @brief Method MakeSureIdIsInPlace, addr 0x2a38408, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW MakeSureIdIsInPlace();

  /// @brief Method GenerateId, addr 0x2a39864, size 0x34, virtual false, abstract: false, final false
  inline void GenerateId();

  /// @brief Method GetOrCreateActionMap, addr 0x2a38700, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputActionMap* GetOrCreateActionMap();

  /// @brief Method CreateInternalActionMapForSingletonAction, addr 0x2a39898, size 0xd4, virtual false, abstract: false, final false
  inline void CreateInternalActionMapForSingletonAction();

  /// @brief Method RequestInitialStateCheckOnEnabledAction, addr 0x2a3997c, size 0x40, virtual false, abstract: false, final false
  inline void RequestInitialStateCheckOnEnabledAction();

  /// @brief Method ActiveControlIsValid, addr 0x2a399bc, size 0xf4, virtual false, abstract: false, final false
  inline bool ActiveControlIsValid(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method FindEffectiveBindingMask, addr 0x2a39b90, size 0x90, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::InputSystem::InputBinding> FindEffectiveBindingMask();

  /// @brief Method BindingIndexOnActionToBindingIndexOnMap, addr 0x2a39c20, size 0x1a0, virtual false, abstract: false, final false
  inline int32_t BindingIndexOnActionToBindingIndexOnMap(int32_t indexOfBindingOnAction);

  /// @brief Method BindingIndexOnMapToBindingIndexOnAction, addr 0x2a39dc0, size 0xc8, virtual false, abstract: false, final false
