...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputActionPhase, "UnityEngine.InputSystem", "InputActionPhase");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::InputActionPhase) == 0x4, "Size mismatch!");
