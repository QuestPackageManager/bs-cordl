...
public:
  ...
  /// @brief Method FromMatcher, addr 0x64f92a0, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToMatcher, addr 0x64f959c, size 0x42c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <With>b__12_0, addr 0x64f9a20, size 0x64, virtual false, abstract: false, final false
  inline bool _With_b__12_0(char16_t ch);

  /// @brief Method .ctor, addr 0x64f9a1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x64f8ed4, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x64f8dac, size 0x11c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher other);

  /// @brief Method FromDeviceDescription, addr 0x64f8a5c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x64f9048, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNumPropertiesIn, addr 0x64f8998, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t GetNumPropertiesIn(::UnityEngine::InputSystem::Layouts::InputDeviceDescription description);

  /// @brief Method MatchPercentage, addr 0x64f851c, size 0x328, virtual false, abstract: false, final false
  inline float_t MatchPercentage(::UnityEngine::InputSystem::Layouts::InputDeviceDescription deviceDescription);

  /// @brief Method MatchSingleProperty, addr 0x64f8850, size 0xd0, virtual false, abstract: false, final false
  static inline bool MatchSingleProperty(::System::Object* pattern, ::StringW value);

  /// @brief Method MatchSinglePropertyContains, addr 0x64f8920, size 0x58, virtual false, abstract: false, final false
  static inline bool MatchSinglePropertyContains(::System::Object* pattern, ::StringW value);

  /// @brief Method ToString, addr 0x64f8bc4, size 0x1e8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method With, addr 0x64f80d0, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDeviceClass, addr 0x64f82b4, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithDeviceClass(::StringW pattern, bool supportRegex);

  /// @brief Method WithInterface, addr 0x64f8054, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithInterface(::StringW pattern, bool supportRegex);

  /// @brief Method WithManufacturer, addr 0x64f8330, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithManufacturer(::StringW pattern, bool supportRegex);

  /// @brief Method WithManufacturerContains, addr 0x64f83ac, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithManufacturerContains(::StringW noRegExPattern);

  /// @brief Method WithProduct, addr 0x64f8424, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithProduct(::StringW pattern, bool supportRegex);

  /// @brief Method WithVersion, addr 0x64f84a0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x64f8f64, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x64f8fd4, size 0x74, virtual false, abstract: false, final false
