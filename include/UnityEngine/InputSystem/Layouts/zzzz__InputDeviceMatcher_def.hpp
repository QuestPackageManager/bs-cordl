...
public:
  ...
  /// @brief Method FromMatcher, addr 0x63b52f0, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToMatcher, addr 0x63b55ec, size 0x42c, virtual false, abstract: false, final false
  ...
  // "", def_value: None }, CppParam { name: "manufacturer", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "manufacturerContains", ty: "::StringW", modifiers: "", def_value: None
  // }, CppParam { name: "manufacturers", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "product", ty: "::StringW", modifiers: "", def_value: None
  // }, CppParam { name: "products", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "version", ty: "::StringW", modifiers: "", def_value: None },
  // CppParam { name: "versions", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "capabilities", ty:
...
public:
  ...
  /// @brief Method <With>b__12_0, addr 0x63b5a70, size 0x64, virtual false, abstract: false, final false
  inline bool _With_b__12_0(char16_t ch);

  /// @brief Method .ctor, addr 0x63b5a6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x63b4f24, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x63b4dfc, size 0x11c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher other);

  /// @brief Method FromDeviceDescription, addr 0x63b4aac, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x63b5098, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetNumPropertiesIn, addr 0x63b49e8, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t GetNumPropertiesIn(::UnityEngine::InputSystem::Layouts::InputDeviceDescription description);

  /// @brief Method MatchPercentage, addr 0x63b456c, size 0x328, virtual false, abstract: false, final false
  inline float_t MatchPercentage(::UnityEngine::InputSystem::Layouts::InputDeviceDescription deviceDescription);

  /// @brief Method MatchSingleProperty, addr 0x63b48a0, size 0xd0, virtual false, abstract: false, final false
  static inline bool MatchSingleProperty(::System::Object* pattern, ::StringW value);

  /// @brief Method MatchSinglePropertyContains, addr 0x63b4970, size 0x58, virtual false, abstract: false, final false
  static inline bool MatchSinglePropertyContains(::System::Object* pattern, ::StringW value);

  /// @brief Method ToString, addr 0x63b4c14, size 0x1e8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method With, addr 0x63b4120, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDeviceClass, addr 0x63b4304, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithDeviceClass(::StringW pattern, bool supportRegex);

  /// @brief Method WithInterface, addr 0x63b40a4, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithInterface(::StringW pattern, bool supportRegex);

  /// @brief Method WithManufacturer, addr 0x63b4380, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithManufacturer(::StringW pattern, bool supportRegex);

  /// @brief Method WithManufacturerContains, addr 0x63b43fc, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithManufacturerContains(::StringW noRegExPattern);

  /// @brief Method WithProduct, addr 0x63b4474, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher WithProduct(::StringW pattern, bool supportRegex);

  /// @brief Method WithVersion, addr 0x63b44f0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_empty, addr 0x63b4004, size 0x10, virtual false, abstract: false, final false
  inline bool get_empty();

  /// @brief Method get_patterns, addr 0x63b4014, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63b4fb4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63b5024, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63b5ad8, size 0x118, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::Layouts::InputDeviceMatcher__get_patterns_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<System.String,System.Object>>.GetEnumerator, addr 0x63b5c94, size 0x98, virtual true, abstract:
  /// false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.Object>>.get_Current, addr 0x63b5bf0, size 0xc, virtual true, abstract: false,
  /// final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63b5d2c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63b5bfc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63b5c34, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63b5ad4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63b4084, size 0x20, virtual false, abstract: false, final false
