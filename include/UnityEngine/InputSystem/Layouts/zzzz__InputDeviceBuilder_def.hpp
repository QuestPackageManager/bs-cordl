...
/// @brief Method Dispose, addr 0x6341100, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method AddChildControl, addr 0x64142bc, size 0x718, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* AddChildControl(::UnityEngine::InputSystem::Layouts::InputControlLayout*  layout, ::UnityEngine::InputSystem::Utilities::InternedString  variants, ::UnityEngine::InputSystem::InputControl*  parent, ::ByRef<bool>  haveChildrenUsingStateFromOtherControls, ::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem  controlItem, int32_t  childIndex, ::StringW  nameOverride) ;

/// @brief Method AddChildControlIfMissing, addr 0x64149d4, size 0xac, virtual false, abstract: false, final false
inline void AddChildControlIfMissing(::UnityEngine::InputSystem::Layouts::InputControlLayout*  layout, ::UnityEngine::InputSystem::Utilities::InternedString  variants, ::UnityEngine::InputSystem::InputControl*  parent, ::ByRef<bool>  haveChildrenUsingStateFromOtherControls, ::ByRef<::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem>  controlItem) ;

/// @brief Method AddChildControls, addr 0x6413144, size 0x5e8, virtual false, abstract: false, final false
...
/// @brief Method AddChildren, addr 0x6415fa8, size 0x110, virtual false, abstract: false, final false
inline void AddChildren(::ByRef<::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode>  parent, ::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode  left, ::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode  right) ;

/// @brief Method AddControlToNode, addr 0x64160b8, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method AddParentDisplayNameRecursive, addr 0x641536c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method AddProcessors, addr 0x6414bc8, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method ApplyUseStateFrom, addr 0x6413f40, size 0x1c0, virtual false, abstract: false, final false
static inline void ApplyUseStateFrom(::UnityEngine::InputSystem::InputControl*  parent, ::ByRef<::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem>  controlItem, ::UnityEngine::InputSystem::Layouts::InputControlLayout*  layout) ;

/// @brief Method ChildControlOverridePath, addr 0x6414a80, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method ComputeStateLayout, addr 0x641372c, size 0x814, virtual false, abstract: false, final false
static inline void ComputeStateLayout(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method Dispose, addr 0x6412ab8, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FinalizeControlHierarchy, addr 0x64125c8, size 0x240, virtual false, abstract: false, final false
inline void FinalizeControlHierarchy() ;

/// @brief Method FinalizeControlHierarchyRecursive, addr 0x6415438, size 0x3e8, virtual false, abstract: false, final false
inline void FinalizeControlHierarchyRecursive(::UnityEngine::InputSystem::InputControl*  control, int32_t  controlIndex, ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>  allControls, bool  noisy, bool  dontReset, ::ByRef<int32_t>  controlIndiciesNextFreeIndex) ;

/// @brief Method FindOrLoadLayout, addr 0x6412ac0, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* FindOrLoadLayout(::StringW  name) ;

/// @brief Method Finish, addr 0x6412808, size 0x230, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* Finish() ;

/// @brief Method GetBestMidPoint, addr 0x6415af0, size 0x4b8, virtual false, abstract: false, final false
inline uint16_t GetBestMidPoint(::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode  parent, uint16_t  startOffset) ;

/// @brief Method GetControlIndex, addr 0x64161ec, size 0xb8, virtual false, abstract: false, final false
inline uint16_t GetControlIndex(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method InsertChildControl, addr 0x6414df0, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method InsertChildControlOverride, addr 0x6414100, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method InsertControlBitRangeNode, addr 0x6415820, size 0x2d0, virtual false, abstract: false, final false
inline void InsertControlBitRangeNode(::ByRef<::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode>  parent, ::UnityEngine::InputSystem::InputControl*  control, ::ByRef<int32_t>  controlIndiciesNextFreeIndex, uint16_t  startOffset) ;

/// @brief Method InstantiateLayout, addr 0x6412b20, size 0x624, virtual false, abstract: false, final false
...
/// @brief Method InstantiateLayout, addr 0x6412554, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method Ref, addr 0x64162ec, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance Ref() ;

/// @brief Method Reset, addr 0x6412a38, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetDisplayName, addr 0x641516c, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method SetFormat, addr 0x6414b14, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x64123ec, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method ShiftChildIndicesInHierarchyOneUp, addr 0x641510c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_instance, addr 0x64162a4, size 0x48, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Device", ty: "::UnityEngine::InputSystem::InputDevice*", modifiers: "", def_value: None }, CppParam { name: "m_LayoutCacheRef", ty: "::UnityEngine::InputSystem::Layouts::InputControlLayout_CacheRefInstance", modifiers: "", def_value: None }, CppParam { name: "m_ChildControlOverrides", ty: "::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem>*", modifiers: "", def_value: None }, CppParam { name: "m_StateOffsetToControlMap", ty: "::System::Collections::Generic::List_1<uint32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_StringBuilder", ty: "::System::Text::StringBuilder*", modifiers: "", def_value: None }]
constexpr InputDeviceBuilder(::UnityEngine::InputSystem::InputDevice*  m_Device, ::UnityEngine::InputSystem::Layouts::InputControlLayout_CacheRefInstance  m_LayoutCacheRef, ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem>*  m_ChildControlOverrides, ::System::Collections::Generic::List_1<uint32_t>*  m_StateOffsetToControlMap, ::System::Text::StringBuilder*  m_StringBuilder) noexcept;
