...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance, "UnityEngine.InputSystem.Layouts", "InputDeviceBuilder/RefInstance");
// Dependencies
namespace UnityEngine::InputSystem::Layouts {
// Is value type: true
...
public:
  ...
  /// @brief Method Dispose, addr 0x64f18a4, size 0x90, virtual true, abstract: false, final true
  inline void Dispose();
...
static_assert(sizeof(::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance) == 0x1, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddChildControl, addr 0x65c4c0c, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildControlIfMissing, addr 0x65c5324, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildControls, addr 0x65c3a94, size 0x5e8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChildren, addr 0x65c68f8, size 0x110, virtual false, abstract: false, final false
  inline void AddChildren(::by_ref<::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode> parent, ::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode left,
                          ::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode right);

  /// @brief Method AddControlToNode, addr 0x65c6a08, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method AddParentDisplayNameRecursive, addr 0x65c5cbc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddProcessors, addr 0x65c5518, size 0x228, virtual false, abstract: false, final false
  static inline void AddProcessors(::UnityEngine::InputSystem::InputControl* control, ::by_ref<::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem> controlItem, ::StringW layoutName);

  /// @brief Method ApplyUseStateFrom, addr 0x65c4890, size 0x1c0, virtual false, abstract: false, final false
  static inline void ApplyUseStateFrom(::UnityEngine::InputSystem::InputControl* parent, ::by_ref<::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem> controlItem,
                                       ::UnityEngine::InputSystem::Layouts::InputControlLayout* layout);

  /// @brief Method ChildControlOverridePath, addr 0x65c53d0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeStateLayout, addr 0x65c407c, size 0x814, virtual false, abstract: false, final false
  static inline void ComputeStateLayout(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method Dispose, addr 0x65c3408, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FinalizeControlHierarchy, addr 0x65c2f18, size 0x240, virtual false, abstract: false, final false
  inline void FinalizeControlHierarchy();

  /// @brief Method FinalizeControlHierarchyRecursive, addr 0x65c5d88, size 0x3e8, virtual false, abstract: false, final false
  inline void FinalizeControlHierarchyRecursive(::UnityEngine::InputSystem::InputControl* control, int32_t controlIndex, ::ArrayW<::UnityEngine::InputSystem::InputControl*> allControls, bool noisy,
                                                bool dontReset, ::by_ref<int32_t> controlIndiciesNextFreeIndex);

  /// @brief Method FindOrLoadLayout, addr 0x65c3410, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* FindOrLoadLayout(::StringW name);

  /// @brief Method Finish, addr 0x65c3158, size 0x230, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* Finish();

  /// @brief Method GetBestMidPoint, addr 0x65c6440, size 0x4b8, virtual false, abstract: false, final false
  inline uint16_t GetBestMidPoint(::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode parent, uint16_t startOffset);

  /// @brief Method GetControlIndex, addr 0x65c6b3c, size 0xb8, virtual false, abstract: false, final false
  inline uint16_t GetControlIndex(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method InsertChildControl, addr 0x65c5740, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertChildControlOverride, addr 0x65c4a50, size 0x1bc, virtual false, abstract: false, final false
  inline void InsertChildControlOverride(::UnityEngine::InputSystem::InputControl* parent, ::by_ref<::UnityEngine::InputSystem::Layouts::InputControlLayout_ControlItem> controlItem);

  /// @brief Method InsertControlBitRangeNode, addr 0x65c6170, size 0x2d0, virtual false, abstract: false, final false
  inline void InsertControlBitRangeNode(::by_ref<::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode> parent, ::UnityEngine::InputSystem::InputControl* control,
                                        ::by_ref<int32_t> controlIndiciesNextFreeIndex, uint16_t startOffset);

  /// @brief Method InstantiateLayout, addr 0x65c3470, size 0x624, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateLayout, addr 0x65c2ea4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Ref, addr 0x65c6c3c, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance Ref();

  /// @brief Method Reset, addr 0x65c3388, size 0x80, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetDisplayName, addr 0x65c5abc, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFormat, addr 0x65c5464, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x65c2d3c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ShiftChildIndicesInHierarchyOneUp, addr 0x65c5a5c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_instance, addr 0x65c6bf4, size 0x48, virtual false, abstract: false, final false
