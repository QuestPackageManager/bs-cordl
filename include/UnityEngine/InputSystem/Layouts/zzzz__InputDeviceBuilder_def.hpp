...
/// @brief Method Dispose, addr 0x63b4c84, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method AddChildControl, addr 0x6487e40, size 0x718, virtual false, abstract: false, final false
...
/// @brief Method AddChildControlIfMissing, addr 0x6488558, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method AddChildControls, addr 0x6486cc8, size 0x5e8, virtual false, abstract: false, final false
...
/// @brief Method AddChildren, addr 0x6489b2c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method AddControlToNode, addr 0x6489c3c, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method AddParentDisplayNameRecursive, addr 0x6488ef0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method AddProcessors, addr 0x648874c, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method ApplyUseStateFrom, addr 0x6487ac4, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method ChildControlOverridePath, addr 0x6488604, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method ComputeStateLayout, addr 0x64872b0, size 0x814, virtual false, abstract: false, final false
static inline void ComputeStateLayout(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method Dispose, addr 0x648663c, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FinalizeControlHierarchy, addr 0x648614c, size 0x240, virtual false, abstract: false, final false
inline void FinalizeControlHierarchy() ;

/// @brief Method FinalizeControlHierarchyRecursive, addr 0x6488fbc, size 0x3e8, virtual false, abstract: false, final false
...
/// @brief Method FindOrLoadLayout, addr 0x6486644, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* FindOrLoadLayout(::StringW  name) ;

/// @brief Method Finish, addr 0x648638c, size 0x230, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* Finish() ;

/// @brief Method GetBestMidPoint, addr 0x6489674, size 0x4b8, virtual false, abstract: false, final false
inline uint16_t GetBestMidPoint(::UnityEngine::InputSystem::InputDevice_ControlBitRangeNode  parent, uint16_t  startOffset) ;

/// @brief Method GetControlIndex, addr 0x6489d70, size 0xb8, virtual false, abstract: false, final false
inline uint16_t GetControlIndex(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method InsertChildControl, addr 0x6488974, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method InsertChildControlOverride, addr 0x6487c84, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method InsertControlBitRangeNode, addr 0x64893a4, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method InstantiateLayout, addr 0x64866a4, size 0x624, virtual false, abstract: false, final false
...
/// @brief Method InstantiateLayout, addr 0x64860d8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method Ref, addr 0x6489e70, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder_RefInstance Ref() ;

/// @brief Method Reset, addr 0x64865bc, size 0x80, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetDisplayName, addr 0x6488cf0, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method SetFormat, addr 0x6488698, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x6485f70, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method ShiftChildIndicesInHierarchyOneUp, addr 0x6488c90, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_instance, addr 0x6489e28, size 0x48, virtual false, abstract: false, final false
