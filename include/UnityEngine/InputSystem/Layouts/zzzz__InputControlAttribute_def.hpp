...
public:
  ...
  /// @brief Method .ctor, addr 0x647b73c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alias, addr 0x647b64c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_alias();

  /// @brief Method get_aliases, addr 0x647b65c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_aliases();

  /// @brief Method get_arraySize, addr 0x647b6ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_arraySize();

  /// @brief Method get_bit, addr 0x647b67c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bit();

  /// @brief Method get_defaultState, addr 0x647b70c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_defaultState();

  /// @brief Method get_displayName, addr 0x647b6bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_dontReset, addr 0x647b6fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_dontReset();

  /// @brief Method get_format, addr 0x647b5fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_format();

  /// @brief Method get_layout, addr 0x647b5cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_layout();

  /// @brief Method get_maxValue, addr 0x647b72c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_maxValue();

  /// @brief Method get_minValue, addr 0x647b71c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_minValue();

  /// @brief Method get_name, addr 0x647b5ec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_noisy, addr 0x647b6dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_noisy();

  /// @brief Method get_offset, addr 0x647b68c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_offset();

  /// @brief Method get_parameters, addr 0x647b62c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_parameters();

  /// @brief Method get_processors, addr 0x647b63c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processors();

  /// @brief Method get_shortDisplayName, addr 0x647b6cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shortDisplayName();

  /// @brief Method get_sizeInBits, addr 0x647b69c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_sizeInBits();

  /// @brief Method get_synthetic, addr 0x647b6ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_synthetic();

  /// @brief Method get_usage, addr 0x647b60c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_usage();

  /// @brief Method get_usages, addr 0x647b61c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_usages();

  /// @brief Method get_useStateFrom, addr 0x647b66c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_useStateFrom();

  /// @brief Method get_variants, addr 0x647b5dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_variants();

  /// @brief Method set_alias, addr 0x647b654, size 0x8, virtual false, abstract: false, final false
  inline void set_alias(::StringW value);

  /// @brief Method set_aliases, addr 0x647b664, size 0x8, virtual false, abstract: false, final false
  inline void set_aliases(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_arraySize, addr 0x647b6b4, size 0x8, virtual false, abstract: false, final false
  inline void set_arraySize(int32_t value);

  /// @brief Method set_bit, addr 0x647b684, size 0x8, virtual false, abstract: false, final false
  inline void set_bit(uint32_t value);

  /// @brief Method set_defaultState, addr 0x647b714, size 0x8, virtual false, abstract: false, final false
  inline void set_defaultState(::System::Object* value);

  /// @brief Method set_displayName, addr 0x647b6c4, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_dontReset, addr 0x647b704, size 0x8, virtual false, abstract: false, final false
  inline void set_dontReset(bool value);

  /// @brief Method set_format, addr 0x647b604, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::StringW value);

  /// @brief Method set_layout, addr 0x647b5d4, size 0x8, virtual false, abstract: false, final false
  inline void set_layout(::StringW value);

  /// @brief Method set_maxValue, addr 0x647b734, size 0x8, virtual false, abstract: false, final false
  inline void set_maxValue(::System::Object* value);

  /// @brief Method set_minValue, addr 0x647b724, size 0x8, virtual false, abstract: false, final false
  inline void set_minValue(::System::Object* value);

  /// @brief Method set_name, addr 0x647b5f4, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_noisy, addr 0x647b6e4, size 0x8, virtual false, abstract: false, final false
  inline void set_noisy(bool value);

  /// @brief Method set_offset, addr 0x647b694, size 0x8, virtual false, abstract: false, final false
  inline void set_offset(uint32_t value);

  /// @brief Method set_parameters, addr 0x647b634, size 0x8, virtual false, abstract: false, final false
  inline void set_parameters(::StringW value);

  /// @brief Method set_processors, addr 0x647b644, size 0x8, virtual false, abstract: false, final false
  inline void set_processors(::StringW value);

  /// @brief Method set_shortDisplayName, addr 0x647b6d4, size 0x8, virtual false, abstract: false, final false
  inline void set_shortDisplayName(::StringW value);

  /// @brief Method set_sizeInBits, addr 0x647b6a4, size 0x8, virtual false, abstract: false, final false
  inline void set_sizeInBits(uint32_t value);

  /// @brief Method set_synthetic, addr 0x647b6f4, size 0x8, virtual false, abstract: false, final false
  inline void set_synthetic(bool value);

  /// @brief Method set_usage, addr 0x647b614, size 0x8, virtual false, abstract: false, final false
  inline void set_usage(::StringW value);

  /// @brief Method set_usages, addr 0x647b624, size 0x8, virtual false, abstract: false, final false
  inline void set_usages(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_useStateFrom, addr 0x647b674, size 0x8, virtual false, abstract: false, final false
  inline void set_useStateFrom(::StringW value);

  /// @brief Method set_variants, addr 0x647b5e4, size 0x8, virtual false, abstract: false, final false
