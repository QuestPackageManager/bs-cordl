...
public:
  ...
  /// @brief Method ComparePropertyToDeviceDescriptor, addr 0x63b3928, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x63b359c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x63b34ec, size 0xb0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::InputSystem::Layouts::InputDeviceDescription other);

  /// @brief Method FromJson, addr 0x63b3858, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Layouts::InputDeviceDescription FromJson(::StringW json);

  /// @brief Method GetHashCode, addr 0x63b3638, size 0x130, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToJson, addr 0x63b37dc, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW ToJson();

  /// @brief Method ToString, addr 0x63b328c, size 0x260, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_capabilities, addr 0x63b31fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_capabilities();

  /// @brief Method get_deviceClass, addr 0x63b31ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_deviceClass();

  /// @brief Method get_empty, addr 0x63b320c, size 0x80, virtual false, abstract: false, final false
  inline bool get_empty();

  /// @brief Method get_interfaceName, addr 0x63b319c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_interfaceName();

  /// @brief Method get_manufacturer, addr 0x63b31bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_manufacturer();

  /// @brief Method get_product, addr 0x63b31cc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_product();

  /// @brief Method get_serial, addr 0x63b31dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_serial();

  /// @brief Method get_version, addr 0x63b31ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x63b3768, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x63b37a0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_capabilities, addr 0x63b3204, size 0x8, virtual false, abstract: false, final false
  inline void set_capabilities(::StringW value);

  /// @brief Method set_deviceClass, addr 0x63b31b4, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceClass(::StringW value);

  /// @brief Method set_interfaceName, addr 0x63b31a4, size 0x8, virtual false, abstract: false, final false
  inline void set_interfaceName(::StringW value);

  /// @brief Method set_manufacturer, addr 0x63b31c4, size 0x8, virtual false, abstract: false, final false
  inline void set_manufacturer(::StringW value);

  /// @brief Method set_product, addr 0x63b31d4, size 0x8, virtual false, abstract: false, final false
  inline void set_product(::StringW value);

  /// @brief Method set_serial, addr 0x63b31e4, size 0x8, virtual false, abstract: false, final false
  inline void set_serial(::StringW value);

  /// @brief Method set_version, addr 0x63b31f4, size 0x8, virtual false, abstract: false, final false
