...
/// @brief Field <commonUsages>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__commonUsages_k__BackingField, put=__cordl_internal_set__commonUsages_k__BackingField)) ::ArrayW<::StringW,::Array<::StringW>*>  _commonUsages_k__BackingField;
...
/// @brief Method .ctor, addr 0x64123e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canRunInBackground, addr 0x6412248, size 0x54, virtual false, abstract: false, final false
inline bool get_canRunInBackground() ;

/// @brief Method get_commonUsages, addr 0x6412218, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_commonUsages() ;

/// @brief Method get_description, addr 0x64123c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_description() ;

/// @brief Method get_displayName, addr 0x64123b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method get_hideInUI, addr 0x64123d8, size 0x8, virtual false, abstract: false, final false
inline bool get_hideInUI() ;

/// @brief Method get_isGenericTypeOfDevice, addr 0x64123a8, size 0x8, virtual false, abstract: false, final false
inline bool get_isGenericTypeOfDevice() ;

/// @brief Method get_isNoisy, addr 0x6412238, size 0x8, virtual false, abstract: false, final false
inline bool get_isNoisy() ;

/// @brief Method get_stateFormat, addr 0x6412208, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_stateFormat() ;

/// @brief Method get_stateType, addr 0x64121f8, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_stateType() ;

/// @brief Method get_updateBeforeRender, addr 0x64122f8, size 0x54, virtual false, abstract: false, final false
inline bool get_updateBeforeRender() ;

/// @brief Method get_variants, addr 0x6412228, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_variants() ;

/// @brief Method set_canRunInBackground, addr 0x641229c, size 0x5c, virtual false, abstract: false, final false
inline void set_canRunInBackground(bool  value) ;

/// @brief Method set_commonUsages, addr 0x6412220, size 0x8, virtual false, abstract: false, final false
inline void set_commonUsages(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method set_description, addr 0x64123d0, size 0x8, virtual false, abstract: false, final false
inline void set_description(::StringW  value) ;

/// @brief Method set_displayName, addr 0x64123c0, size 0x8, virtual false, abstract: false, final false
inline void set_displayName(::StringW  value) ;

/// @brief Method set_hideInUI, addr 0x64123e0, size 0x8, virtual false, abstract: false, final false
inline void set_hideInUI(bool  value) ;

/// @brief Method set_isGenericTypeOfDevice, addr 0x64123b0, size 0x8, virtual false, abstract: false, final false
inline void set_isGenericTypeOfDevice(bool  value) ;

/// @brief Method set_isNoisy, addr 0x6412240, size 0x8, virtual false, abstract: false, final false
inline void set_isNoisy(bool  value) ;

/// @brief Method set_stateFormat, addr 0x6412210, size 0x8, virtual false, abstract: false, final false
inline void set_stateFormat(::StringW  value) ;

/// @brief Method set_stateType, addr 0x6412200, size 0x8, virtual false, abstract: false, final false
inline void set_stateType(::System::Type*  value) ;

/// @brief Method set_updateBeforeRender, addr 0x641234c, size 0x5c, virtual false, abstract: false, final false
inline void set_updateBeforeRender(bool  value) ;

/// @brief Method set_variants, addr 0x6412230, size 0x8, virtual false, abstract: false, final false
