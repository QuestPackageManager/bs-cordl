...
public:
  ...
  /// @brief Method get_stateType addr 0x2b035e4 size 0x8 virtual false final false
  inline ::System::Type* get_stateType();

  /// @brief Method set_stateType addr 0x2b035ec size 0x8 virtual false final false
  inline void set_stateType(::System::Type* value);

  /// @brief Method get_stateFormat addr 0x2b035f4 size 0x8 virtual false final false
  inline ::StringW get_stateFormat();

  /// @brief Method set_stateFormat addr 0x2b035fc size 0x8 virtual false final false
  inline void set_stateFormat(::StringW value);

  /// @brief Method get_commonUsages addr 0x2b03604 size 0x8 virtual false final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_commonUsages();

  /// @brief Method set_commonUsages addr 0x2b0360c size 0x8 virtual false final false
  inline void set_commonUsages(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method get_variants addr 0x2b03614 size 0x8 virtual false final false
  inline ::StringW get_variants();

  /// @brief Method set_variants addr 0x2b0361c size 0x8 virtual false final false
  inline void set_variants(::StringW value);

  /// @brief Method get_isNoisy addr 0x2b03624 size 0x8 virtual false final false
  inline bool get_isNoisy();

  /// @brief Method set_isNoisy addr 0x2b0362c size 0xc virtual false final false
  inline void set_isNoisy(bool value);

  /// @brief Method get_canRunInBackground addr 0x2b03638 size 0x48 virtual false final false
  inline bool get_canRunInBackground();

  /// @brief Method set_canRunInBackground addr 0x2b03680 size 0x68 virtual false final false
  inline void set_canRunInBackground(bool value);

  /// @brief Method get_updateBeforeRender addr 0x2b036e8 size 0x48 virtual false final false
  inline bool get_updateBeforeRender();

  /// @brief Method set_updateBeforeRender addr 0x2b03730 size 0x68 virtual false final false
  inline void set_updateBeforeRender(bool value);

  /// @brief Method get_isGenericTypeOfDevice addr 0x2b03798 size 0x8 virtual false final false
  inline bool get_isGenericTypeOfDevice();

  /// @brief Method set_isGenericTypeOfDevice addr 0x2b037a0 size 0xc virtual false final false
  inline void set_isGenericTypeOfDevice(bool value);

  /// @brief Method get_displayName addr 0x2b037ac size 0x8 virtual false final false
  inline ::StringW get_displayName();

  /// @brief Method set_displayName addr 0x2b037b4 size 0x8 virtual false final false
  inline void set_displayName(::StringW value);

  /// @brief Method get_description addr 0x2b037bc size 0x8 virtual false final false
  inline ::StringW get_description();

  /// @brief Method set_description addr 0x2b037c4 size 0x8 virtual false final false
  inline void set_description(::StringW value);

  /// @brief Method get_hideInUI addr 0x2b037cc size 0x8 virtual false final false
  inline bool get_hideInUI();

  /// @brief Method set_hideInUI addr 0x2b037d4 size 0xc virtual false final false
  inline void set_hideInUI(bool value);

  static inline ::UnityEngine::InputSystem::Layouts::InputControlLayoutAttribute* New_ctor();

  /// @brief Method .ctor addr 0x2b037e0 size 0x8 virtual false final false
  inline void _ctor();
