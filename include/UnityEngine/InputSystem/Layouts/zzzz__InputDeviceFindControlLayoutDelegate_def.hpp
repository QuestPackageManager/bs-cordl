...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2bdffe0, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2be0080, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Invoke, addr 0x2bdffcc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bdfef4, size 0xd8, virtual false, abstract: false, final false
