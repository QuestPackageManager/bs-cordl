...
public:
  ...
  /// @brief Method .ctor, addr 0x45c7298, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_samplingFrequency, addr 0x45c710c, size 0xec, virtual false, abstract: false, final false
  inline float_t get_samplingFrequency();

  /// @brief Method set_samplingFrequency, addr 0x45c71f8, size 0xa0, virtual false, abstract: false, final false
