...
public:
  ...
  /// @brief Method .ctor, addr 0x45c8e9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_samplingFrequency, addr 0x45c8d10, size 0xec, virtual false, abstract: false, final false
  inline float_t get_samplingFrequency();

  /// @brief Method set_samplingFrequency, addr 0x45c8dfc, size 0xa0, virtual false, abstract: false, final false
