...
public:
  ...
  /// @brief Method .ctor, addr 0x6421a34, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_samplingFrequency, addr 0x6421888, size 0x108, virtual false, abstract: false, final false
  inline float_t get_samplingFrequency();

  /// @brief Method set_samplingFrequency, addr 0x6421990, size 0xa4, virtual false, abstract: false, final false
