...
/// @brief Method .ctor, addr 0x63afa28, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_samplingFrequency, addr 0x63af87c, size 0x108, virtual false, abstract: false, final false
inline float_t get_samplingFrequency() ;

/// @brief Method set_samplingFrequency, addr 0x63af984, size 0xa4, virtual false, abstract: false, final false
