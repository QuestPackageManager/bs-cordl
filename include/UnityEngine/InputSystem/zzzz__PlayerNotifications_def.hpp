...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::PlayerNotifications, "UnityEngine.InputSystem", "PlayerNotifications");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::InputSystem::PlayerNotifications, value__) == 0x0, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::InputSystem::PlayerNotifications) == 0x4, "Size mismatch!");
