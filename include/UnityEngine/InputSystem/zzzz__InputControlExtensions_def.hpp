...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x63d6270, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_InputEventControlEnumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x63d6b58, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63d6bd8, size 0x80, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method get_eventPtr, addr 0x63d6990, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckCurrent, addr 0x63d707c, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckCurrent(uint32_t numBits);

  /// @brief Method CheckDefault, addr 0x63d705c, size 0x20, virtual false, abstract: false, final false
  inline bool CheckDefault(uint32_t numBits);

  /// @brief Method Dispose, addr 0x63d70b4, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x63d6298, size 0x388, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x63d6c58, size 0x404, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63d70c4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x63d6998, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x63d70bc, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method At, addr 0x63d70dc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DontReset, addr 0x63d73f0, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder DontReset(bool value);

  /// @brief Method Finish, addr 0x63d7494, size 0x20, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsButton, addr 0x63d7460, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsButton(bool value);

  /// @brief Method IsNoisy, addr 0x63d7394, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsNoisy(bool value);

  /// @brief Method IsSynthetic, addr 0x63d73bc, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsSynthetic(bool value);

  /// @brief Method WithAliases, addr 0x63d72b8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithAliases(int32_t startIndex, int32_t count);

  /// @brief Method WithChildren, addr 0x63d72d4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithDefaultState, addr 0x63d730c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x63d71c8, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x63d7280, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithMinAndMax, addr 0x63d7368, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x63d7180, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithName(::StringW name);

  /// @brief Method WithParent, addr 0x63d7164, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithShortDisplayName, addr 0x63d7224, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x63d72f0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUsages, addr 0x63d729c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithUsages(int32_t startIndex, int32_t count);

  /// @brief Method get_control, addr 0x63d70cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control, addr 0x63d70d4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finish, addr 0x63d787c, size 0x274, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsNoisy, addr 0x63d7618, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder IsNoisy(bool value);

  /// @brief Method WithChildren, addr 0x63d75e0, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithControlAlias, addr 0x63d76e4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlTree, addr 0x63d773c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlUsage, addr 0x63d7640, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x63d750c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x63d75c4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x63d74c4, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithName(::StringW name);

  /// @brief Method WithShortDisplayName, addr 0x63d7568, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x63d75fc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithStateOffsetToControlIndexMap, addr 0x63d7720, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_device, addr 0x63d74b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device, addr 0x63d74bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63d7b6c, size 0x234, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputControlExtensions__GetAllButtonPresses_d__43* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x63d7df8, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputControl*>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControl__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControl>.get_Current, addr 0x63d7db0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63d7ea0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63d7db8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63d7df0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63d7b48, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x63d7da0, size 0x10, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x63d66b0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x63d5c4c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x63d5b30, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildPath, addr 0x63d5d6c, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefault, addr 0x63d4934, size 0x74, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefault, addr 0x63d5018, size 0xdc, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control, void* statePtr, void* maskPtr);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x63d5268, size 0x70, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x63d52d8, size 0xd4, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method CompareState, addr 0x63d50f4, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x63d5494, size 0xac, virtual false, abstract: false, final false
  static inline bool CompareState(::UnityEngine::InputSystem::InputControl* control, void* statePtr, void* maskPtr);

  /// @brief Method CompareStateIgnoringNoise, addr 0x63d53ac, size 0xe8, virtual false, abstract: false, final false
  static inline bool CompareStateIgnoringNoise(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method CopyState, addr 0x63d4e74, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateChangedControls, addr 0x63d6220, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateControls, addr 0x63d604c, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllButtonPresses, addr 0x63d6620, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstButtonPressOrNull, addr 0x63d2508, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEvent, addr 0x63d4b84, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEventUnchecked, addr 0x63d56b0, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasButtonPress, addr 0x63d6258, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInEvent, addr 0x63d55ec, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInState, addr 0x63d5540, size 0xac, virtual false, abstract: false, final false
  static inline bool HasValueChangeInState(::UnityEngine::InputSystem::InputControl* control, void* statePtr);

  /// @brief Method IsActuated, addr 0x63d47fc, size 0x138, virtual false, abstract: false, final false
  static inline bool IsActuated(::UnityEngine::InputSystem::InputControl* control, float_t threshold);

  /// @brief Method IsPressed, addr 0x63d46b0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDefaultValueAsObject, addr 0x63d4a5c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x63d34c0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueFromEventAsObject, addr 0x63d4b04, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueIntoBuffer, addr 0x63d49a8, size 0xb4, virtual false, abstract: false, final false
  static inline void ReadValueIntoBuffer(::UnityEngine::InputSystem::InputControl* control, void* buffer, int32_t bufferSize);

  /// @brief Method ResetToDefaultStateInEvent, addr 0x63d5988, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x63d66d0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x63d6794, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoEvent, addr 0x63d4c04, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueIntoState, addr 0x63d4c94, size 0x1e0, virtual false, abstract: false, final false
