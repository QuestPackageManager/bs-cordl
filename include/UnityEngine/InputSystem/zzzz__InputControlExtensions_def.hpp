...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x457e5fc, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_InputEventControlEnumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x457eef0, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x457ef94, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method get_eventPtr, addr 0x457ed28, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckCurrent, addr 0x457f4a4, size 0x20, virtual false, abstract: false, final false
  inline bool CheckCurrent(uint32_t numBits);

  /// @brief Method CheckDefault, addr 0x457f480, size 0x24, virtual false, abstract: false, final false
  inline bool CheckDefault(uint32_t numBits);

  /// @brief Method Dispose, addr 0x457f4e0, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x457e624, size 0x384, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x457f038, size 0x448, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x457f4f0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x457ed30, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Current, addr 0x457f4e8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method At, addr 0x457f508, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DontReset, addr 0x457f820, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder DontReset(bool value);

  /// @brief Method Finish, addr 0x457f8c8, size 0x24, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsButton, addr 0x457f890, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsButton(bool value);

  /// @brief Method IsNoisy, addr 0x457f7c0, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsNoisy(bool value);

  /// @brief Method IsSynthetic, addr 0x457f7e8, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder IsSynthetic(bool value);

  /// @brief Method WithAliases, addr 0x457f6d8, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithAliases(int32_t startIndex, int32_t count);

  /// @brief Method WithChildren, addr 0x457f6f8, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithDefaultState, addr 0x457f738, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x457f5f8, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x457f698, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithMinAndMax, addr 0x457f794, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x457f5b0, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithName(::StringW name);

  /// @brief Method WithParent, addr 0x457f590, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithShortDisplayName, addr 0x457f648, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x457f718, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUsages, addr 0x457f6b8, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_ControlBuilder WithUsages(int32_t startIndex, int32_t count);

  /// @brief Method get_control, addr 0x457f4f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control, addr 0x457f500, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finish, addr 0x457fc94, size 0x24, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method IsNoisy, addr 0x457fa44, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder IsNoisy(bool value);

  /// @brief Method WithChildren, addr 0x457fa04, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithControlAlias, addr 0x457fb10, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlTree, addr 0x457fb70, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlUsage, addr 0x457fa6c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDisplayName, addr 0x457f944, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithLayout, addr 0x457f9e4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x457f8fc, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithName(::StringW name);

  /// @brief Method WithShortDisplayName, addr 0x457f994, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControlExtensions_DeviceBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithStateBlock, addr 0x457fa24, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithStateOffsetToControlIndexMap, addr 0x457fb50, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_device, addr 0x457f8ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device, addr 0x457f8f4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x457fcdc, size 0x23c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputControlExtensions__GetAllButtonPresses_d__43* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x457ff70, size 0xac, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputControl*>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControl__GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControl>.get_Current, addr 0x457ff28, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x458001c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x457ff30, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x457ff68, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x457fcb8, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x457ff18, size 0x10, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x457ea3c, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x457dfe4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x457dee8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildPath, addr 0x457e0e4, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefault, addr 0x457ccfc, size 0x74, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefault, addr 0x457d3a4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x457d5e4, size 0x70, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x457d654, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x457d47c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x457d800, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareStateIgnoringNoise, addr 0x457d71c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyState, addr 0x457d224, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateChangedControls, addr 0x457e5a8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateControls, addr 0x457e3b4, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllButtonPresses, addr 0x457e9a8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstButtonPressOrNull, addr 0x457aa3c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEvent, addr 0x457cf48, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEventUnchecked, addr 0x457da30, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasButtonPress, addr 0x457e5e0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInEvent, addr 0x457d958, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInState, addr 0x457d8ac, size 0xac, virtual false, abstract: false, final false
  static inline bool HasValueChangeInState(::UnityEngine::InputSystem::InputControl* control, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method IsActuated, addr 0x457cc30, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsActuated(::UnityEngine::InputSystem::InputControl* control, float_t threshold);

  /// @brief Method IsPressed, addr 0x457caec, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDefaultValueAsObject, addr 0x457ce24, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueAsObject, addr 0x457b978, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueFromEventAsObject, addr 0x457cec8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueIntoBuffer, addr 0x457cd70, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetToDefaultStateInEvent, addr 0x457dd34, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x457ea70, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x457eb34, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoEvent, addr 0x457d000, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueIntoState, addr 0x457d090, size 0x194, virtual false, abstract: false, final false
