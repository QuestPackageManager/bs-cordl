...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x2a65f2c, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__InputEventControlEnumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x2a667a4, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a66848, size 0xa4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CheckCurrent, addr 0x2a66d88, size 0x20, virtual false, abstract: false, final false
  inline bool CheckCurrent(uint32_t numBits);

  /// @brief Method MoveNext, addr 0x2a65f54, size 0x340, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2a668ec, size 0x478, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Dispose, addr 0x2a66dc4, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method get_Current, addr 0x2a66dcc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::InputControl* get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a66dd4, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_control, addr 0x2a66ddc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control, addr 0x2a66de4, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method At, addr 0x2a66dec, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method WithParent, addr 0x2a66e74, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x2a66e94, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithName(::StringW name);

  /// @brief Method WithDisplayName, addr 0x2a66edc, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithShortDisplayName, addr 0x2a66f2c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithLayout, addr 0x2a66f7c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUsages, addr 0x2a66f9c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithUsages(int32_t startIndex, int32_t count);

  /// @brief Method WithAliases, addr 0x2a66fbc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithAliases(int32_t startIndex, int32_t count);

  /// @brief Method WithChildren, addr 0x2a66fdc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithStateBlock, addr 0x2a66ffc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDefaultState, addr 0x2a6701c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithMinAndMax, addr 0x2a67074, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoisy, addr 0x2a670a0, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsNoisy(bool value);

  /// @brief Method IsSynthetic, addr 0x2a670c8, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsSynthetic(bool value);

  /// @brief Method DontReset, addr 0x2a670fc, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder DontReset(bool value);

  /// @brief Method IsButton, addr 0x2a67164, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsButton(bool value);

  /// @brief Method Finish, addr 0x2a67198, size 0x24, virtual false, abstract: false, final false
  inline void Finish();
...
public:
  ...
  /// @brief Method get_device, addr 0x2a671bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device, addr 0x2a671c4, size 0x8, virtual false, abstract: false, final false
  inline void set_device(::UnityEngine::InputSystem::InputDevice* value);

  /// @brief Method WithName, addr 0x2a671cc, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithName(::StringW name);

  /// @brief Method WithDisplayName, addr 0x2a67214, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithShortDisplayName, addr 0x2a67264, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithLayout, addr 0x2a672b4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithChildren, addr 0x2a672d4, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithStateBlock, addr 0x2a672f4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoisy, addr 0x2a67314, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder IsNoisy(bool value);

  /// @brief Method WithControlUsage, addr 0x2a6733c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlAlias, addr 0x2a673e0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method WithStateOffsetToControlIndexMap, addr 0x2a67420, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x2a67440, size 0x24, virtual false, abstract: false, final false
  inline void Finish();
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6536)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6219))}
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a66330, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2a67464, size 0x24, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2a67488, size 0x288, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method <>m__Finally1, addr 0x2a67710, size 0x10, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControl>.get_Current, addr 0x2a67720, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a67728, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a67768, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x2a67770, size 0xb4, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputControl*>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControl__GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a67824, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();
...
public:
  ...
  /// @brief Method ReadValueIntoBuffer, addr 0x2a646d4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDefaultValueAsObject, addr 0x2a64790, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueFromEventAsObject, addr 0x2a64838, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoEvent, addr 0x2a6497c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueIntoState, addr 0x2a64a10, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyState, addr 0x2a64bac, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefault, addr 0x2a6465c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x2a64f1c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareStateIgnoringNoise, addr 0x2a64fec, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInEvent, addr 0x2a65240, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEvent, addr 0x2a648bc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEventUnchecked, addr 0x2a65320, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetToDefaultStateInEvent, addr 0x2a65618, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x2a658cc, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x2a66434, size 0x20c, virtual false, abstract: false, final false
