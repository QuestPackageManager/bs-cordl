...
namespace UnityEngine::InputSystem {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5476)), TypeDefinitionIndex(TypeDefinitionIndex(5795))]
...
public:
  ...
  /// @brief Method get_eventPtr, addr 0x2a681ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::LowLevel::InputEventPtr get_eventPtr();

  /// @brief Method GetEnumerator, addr 0x2a67a98, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__InputEventControlEnumerator GetEnumerator();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x2a68310, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a683b4, size 0xa4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a681b4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckDefault, addr 0x2a688d0, size 0x24, virtual false, abstract: false, final false
  inline bool CheckDefault(uint32_t numBits);

  /// @brief Method CheckCurrent, addr 0x2a688f4, size 0x20, virtual false, abstract: false, final false
  inline bool CheckCurrent(uint32_t numBits);

  /// @brief Method MoveNext, addr 0x2a67ac0, size 0x340, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x2a68458, size 0x478, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method Dispose, addr 0x2a68930, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method get_Current, addr 0x2a68938, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::InputSystem::InputControl* get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a68940, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_control, addr 0x2a68948, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method set_control, addr 0x2a68950, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method At, addr 0x2a68958, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method WithParent, addr 0x2a689e0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithName, addr 0x2a68a00, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithName(::StringW name);

  /// @brief Method WithDisplayName, addr 0x2a68a48, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithShortDisplayName, addr 0x2a68a98, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithLayout, addr 0x2a68ae8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithUsages, addr 0x2a68b08, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithUsages(int32_t startIndex, int32_t count);

  /// @brief Method WithAliases, addr 0x2a68b28, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithAliases(int32_t startIndex, int32_t count);

  /// @brief Method WithChildren, addr 0x2a68b48, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithStateBlock, addr 0x2a68b68, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithDefaultState, addr 0x2a68b88, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method WithMinAndMax, addr 0x2a68be0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoisy, addr 0x2a68c0c, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsNoisy(bool value);

  /// @brief Method IsSynthetic, addr 0x2a68c34, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsSynthetic(bool value);

  /// @brief Method DontReset, addr 0x2a68c68, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder DontReset(bool value);

  /// @brief Method IsButton, addr 0x2a68cd0, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__ControlBuilder IsButton(bool value);

  /// @brief Method Finish, addr 0x2a68d04, size 0x24, virtual false, abstract: false, final false
  inline void Finish();
...
public:
  ...
  /// @brief Method get_device, addr 0x2a68d28, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputDevice* get_device();

  /// @brief Method set_device, addr 0x2a68d30, size 0x8, virtual false, abstract: false, final false
  inline void set_device(::UnityEngine::InputSystem::InputDevice* value);

  /// @brief Method WithName, addr 0x2a68d38, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithName(::StringW name);

  /// @brief Method WithDisplayName, addr 0x2a68d80, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithDisplayName(::StringW displayName);

  /// @brief Method WithShortDisplayName, addr 0x2a68dd0, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithShortDisplayName(::StringW shortDisplayName);

  /// @brief Method WithLayout, addr 0x2a68e20, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method WithChildren, addr 0x2a68e40, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder WithChildren(int32_t startIndex, int32_t count);

  /// @brief Method WithStateBlock, addr 0x2a68e60, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNoisy, addr 0x2a68e80, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::__InputControlExtensions__DeviceBuilder IsNoisy(bool value);

  /// @brief Method WithControlUsage, addr 0x2a68ea8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method WithControlAlias, addr 0x2a68f4c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method WithStateOffsetToControlIndexMap, addr 0x2a68f8c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x2a68fac, size 0x24, virtual false, abstract: false, final false
  inline void Finish();
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(5478)), TypeDefinitionIndex(TypeDefinitionIndex(5795))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a67e9c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2a68fd0, size 0x24, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2a68ff4, size 0x288, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method <>m__Finally1, addr 0x2a6927c, size 0x10, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControl>.get_Current, addr 0x2a6928c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a69294, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a692d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControl>.GetEnumerator, addr 0x2a692dc, size 0xb4, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::InputControl*>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControl__GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2a69390, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();
...
public:
  ...
  /// @brief Method IsPressed, addr 0x2a65fb4, size 0x148, virtual false, abstract: false, final false
  static inline bool IsPressed(::UnityEngine::InputSystem::InputControl* control, float_t buttonPressPoint);

  /// @brief Method IsActuated, addr 0x2a660fc, size 0xcc, virtual false, abstract: false, final false
  static inline bool IsActuated(::UnityEngine::InputSystem::InputControl* control, float_t threshold);

  /// @brief Method ReadValueAsObject, addr 0x2a65624, size 0x7c, virtual false, abstract: false, final false
  static inline ::System::Object* ReadValueAsObject(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method ReadValueIntoBuffer, addr 0x2a66240, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadDefaultValueAsObject, addr 0x2a662fc, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValueFromEventAsObject, addr 0x2a663a4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueFromObjectIntoEvent, addr 0x2a664e8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteValueIntoState, addr 0x2a6657c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyState, addr 0x2a66718, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefault, addr 0x2a661c8, size 0x78, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefault(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefault, addr 0x2a66880, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x2a66a14, size 0x74, virtual false, abstract: false, final false
  static inline bool CheckStateIsAtDefaultIgnoringNoise(::UnityEngine::InputSystem::InputControl* control);

  /// @brief Method CheckStateIsAtDefaultIgnoringNoise, addr 0x2a66a88, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareStateIgnoringNoise, addr 0x2a66b58, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x2a66960, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareState, addr 0x2a66c44, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValueChangeInState, addr 0x2a66cf8, size 0xb4, virtual false, abstract: false, final false
  static inline bool HasValueChangeInState(::UnityEngine::InputSystem::InputControl* control, ::cordl_internals::Ptr<void> statePtr);

  /// @brief Method HasValueChangeInEvent, addr 0x2a66dac, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEvent, addr 0x2a66428, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStatePtrFromStateEventUnchecked, addr 0x2a66e8c, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetToDefaultStateInEvent, addr 0x2a67184, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x2a67338, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method AccumulateValueInEvent, addr 0x2a67438, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildPath, addr 0x2a6753c, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateControls, addr 0x2a67818, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumerateChangedControls, addr 0x2a67a44, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method HasButtonPress, addr 0x2a67a7c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstButtonPressOrNull, addr 0x2a646c4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllButtonPresses, addr 0x2a67e00, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x2a67ed0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x2a67fa0, size 0x20c, virtual false, abstract: false, final false
