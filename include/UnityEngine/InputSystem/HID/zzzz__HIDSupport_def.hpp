...
public:
// Declarations
/// @brief Method .ctor, addr 0x63ef718, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::HID::HID_UsagePage  page, int32_t  usage) ;

/// @brief Method .ctor, addr 0x63ef880, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "page", ty: "::UnityEngine::InputSystem::HID::HID_UsagePage", modifiers: "", def_value: None }, CppParam { name: "usage", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field s_SupportedHIDUsages, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SupportedHIDUsages, put=setStaticF_s_SupportedHIDUsages)) ::ArrayW<::UnityEngine::InputSystem::HID::HIDSupport_HIDPageUsage,::Array<::UnityEngine::InputSystem::HID::HIDSupport_HIDPageUsage>*>  s_SupportedHIDUsages;

/// @brief Method Initialize, addr 0x63ef720, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_supportedHIDUsages, addr 0x63ef464, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method set_supportedHIDUsages, addr 0x63ef4cc, size 0x24c, virtual false, abstract: false, final false
