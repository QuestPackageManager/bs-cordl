...
public:
// Declarations
/// @brief Method FindOrAddReport, addr 0x63ef1ac, size 0x180, virtual false, abstract: false, final false
static inline int32_t FindOrAddReport(::System::Nullable_1<int32_t>  reportId, ::UnityEngine::InputSystem::HID::HID_HIDReportType  reportType, ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::HIDParser_HIDReportData>*  reports) ;

// Ctor Parameters []
// @brief default ctor
constexpr HIDParser_HIDReportData() ;

// Ctor Parameters [CppParam { name: "reportId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "reportType", ty: "::UnityEngine::InputSystem::HID::HID_HIDReportType", modifiers: "", def_value: None }, CppParam { name: "currentBitOffset", ty: "int32_t", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method GetUsage, addr 0x63ef030, size 0x114, virtual false, abstract: false, final false
inline int32_t GetUsage(int32_t  index) ;

/// @brief Method Reset, addr 0x63ef144, size 0x68, virtual false, abstract: false, final false
static inline void Reset(::ByRef<::UnityEngine::InputSystem::HID::HIDParser_HIDItemStateLocal>  state) ;

/// @brief Method SetUsage, addr 0x63eee50, size 0x15c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetPhysicalMax, addr 0x63ef3c8, size 0x9c, virtual false, abstract: false, final false
inline int32_t GetPhysicalMax() ;

/// @brief Method GetPhysicalMin, addr 0x63ef32c, size 0x9c, virtual false, abstract: false, final false
inline int32_t GetPhysicalMin() ;

/// @brief Method GetUsagePage, addr 0x63eefac, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method ParseReportDescriptor, addr 0x63ee2ac, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method ParseReportDescriptor, addr 0x63ee314, size 0xad4, virtual false, abstract: false, final false
static inline bool ParseReportDescriptor(uint8_t*  bufferPtr, int32_t  bufferLength, ::ByRef<::UnityEngine::InputSystem::HID::HID_HIDDeviceDescriptor>  deviceDescriptor) ;

/// @brief Method ReadData, addr 0x63eede8, size 0x68, virtual false, abstract: false, final false
