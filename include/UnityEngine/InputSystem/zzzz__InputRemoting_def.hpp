...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputRemoting_Flags, "UnityEngine.InputSystem", "InputRemoting/Flags");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputRemoting_MessageType, "UnityEngine.InputSystem", "InputRemoting/MessageType");
...
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::ChangeUsageMsg_InputRemoting_Data, "UnityEngine.InputSystem", "InputRemoting/ChangeUsageMsg/Data");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputRemoting_Message, "UnityEngine.InputSystem", "InputRemoting/Message");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputRemoting_RemoteInputDevice, "UnityEngine.InputSystem", "InputRemoting/RemoteInputDevice");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::InputRemoting_RemoteSender, "UnityEngine.InputSystem", "InputRemoting/RemoteSender");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::NewDeviceMsg_InputRemoting_Data, "UnityEngine.InputSystem", "InputRemoting/NewDeviceMsg/Data");
DEFINE_IL2CPP_CLASS(::UnityEngine::InputSystem::NewLayoutMsg_InputRemoting_Data, "UnityEngine.InputSystem", "InputRemoting/NewLayoutMsg/Data");
// Dependencies
namespace UnityEngine::InputSystem {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::InputSystem::InputRemoting_MessageType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::InputSystem::InputRemoting_Flags) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::InputSystem::InputRemoting_RemoteInputDevice) == 0x40, "Size mismatch!");
...
public:
  ...
  ::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteInputDevice> devices;
...
static_assert(sizeof(::UnityEngine::InputSystem::InputRemoting_RemoteSender) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::InputSystem::NewLayoutMsg_InputRemoting_Data) == 0x18, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_Senders, put = __cordl_internal_set_m_Senders)) ::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteSender> m_Senders;
  ...
  constexpr ::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteSender> const& __cordl_internal_get_m_Senders() const;

  constexpr ::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteSender>& __cordl_internal_get_m_Senders();
  ...
  constexpr void __cordl_internal_set_m_Senders(::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteSender> value);
...
public:
  ...
  ::ArrayW<::UnityEngine::InputSystem::InputRemoting_RemoteSender> ___m_Senders;
