...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x63ddc04, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddDeviceUsage, addr 0x63dc400, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearDeviceUsages, addr 0x63dc59c, size 0x60, virtual false, abstract: false, final false
  inline void ClearDeviceUsages();

  /// @brief Method CompareValue, addr 0x63dc060, size 0x120, virtual true, abstract: false, final false
  inline bool CompareValue(void* firstStatePtr, void* secondStatePtr);

  /// @brief Method DecodeStateOffsetToControlMapEntry, addr 0x63d7098, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method DumpControlBitRangeNode, addr 0x63dcf60, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method DumpControlTree, addr 0x63dd4ac, size 0xd0, virtual false, abstract: false, final false
  inline ::StringW DumpControlTree();

  /// @brief Method DumpControlTree, addr 0x63dd388, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeStateOffsetToControlMapEntry, addr 0x63dc364, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCommand, addr 0x63dc200, size 0xe0, virtual true, abstract: false, final false
  inline int64_t ExecuteCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand* commandPtr);

  /// @brief Method ExecuteDisableCommand, addr 0x63dc684, size 0x7c, virtual false, abstract: false, final false
  inline bool ExecuteDisableCommand();

  /// @brief Method ExecuteEnableCommand, addr 0x63dc5fc, size 0x88, virtual false, abstract: false, final false
  inline bool ExecuteEnableCommand();

  /// @brief Method HasDataChangedInRange, addr 0x63dd57c, size 0x688, virtual false, abstract: false, final false
  static inline bool HasDataChangedInRange(uint8_t* deviceStatePtr, void* statePtr, uint32_t startOffset, uint32_t sizeInBits);

  /// @brief Method MakeCurrent, addr 0x63db770, size 0x4, virtual true, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::InputSystem::InputDevice* New_ctor();

  /// @brief Method NotifyAdded, addr 0x63dc700, size 0x10, virtual false, abstract: false, final false
  inline void NotifyAdded();

  /// @brief Method NotifyConfigurationChanged, addr 0x63dc180, size 0x74, virtual false, abstract: false, final false
  inline void NotifyConfigurationChanged();

  /// @brief Method NotifyRemoved, addr 0x63dc710, size 0x10, virtual false, abstract: false, final false
  inline void NotifyRemoved();

  /// @brief Method OnAdded, addr 0x63dc1f4, size 0x4, virtual true, abstract: false, final false
  inline void OnAdded();

  /// @brief Method OnConfigurationChanged, addr 0x63dc1fc, size 0x4, virtual true, abstract: false, final false
  inline void OnConfigurationChanged();

  /// @brief Method OnRemoved, addr 0x63dc1f8, size 0x4, virtual true, abstract: false, final false
  inline void OnRemoved();

  /// @brief Method QueryEnabledStateFromRuntime, addr 0x63db9e0, size 0xa8, virtual false, abstract: false, final false
  inline bool QueryEnabledStateFromRuntime();

  /// @brief Method ReadValueFromBufferAsObject, addr 0x63dbd2c, size 0x38, virtual true, abstract: false, final false
  inline ::System::Object* ReadValueFromBufferAsObject(void* buffer, int32_t bufferSize);

  /// @brief Method ReadValueFromStateAsObject, addr 0x63dbd64, size 0x12c, virtual true, abstract: false, final false
  inline ::System::Object* ReadValueFromStateAsObject(void* statePtr);

  /// @brief Method ReadValueFromStateIntoBuffer, addr 0x63dbe90, size 0x1d0, virtual true, abstract: false, final false
  inline void ReadValueFromStateIntoBuffer(void* statePtr, void* bufferPtr, int32_t bufferSize);

  /// @brief Method RemoveDeviceUsage, addr 0x63dc4b8, size 0xe4, virtual false, abstract: false, final false
  inline void RemoveDeviceUsage(::UnityEngine::InputSystem::Utilities::InternedString usage);

  /// @brief Method RequestReset, addr 0x63cf674, size 0x88, virtual false, abstract: false, final false
  inline bool RequestReset();

  /// @brief Method RequestSync, addr 0x63cf514, size 0x88, virtual false, abstract: false, final false
  inline bool RequestSync();

  /// @brief Method WriteChangedControlStates, addr 0x63dc720, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteChangedControlStatesInternal, addr 0x63dcbcc, size 0x394, virtual false, abstract: false, final false
  ...
  /// @brief Method WritePartialChangedControlStatesInternal, addr 0x63dc884, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63db988, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_added, addr 0x63cafd8, size 0x10, virtual false, abstract: false, final false
  inline bool get_added();

  /// @brief Method get_all, addr 0x63dbcdc, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_all();

  /// @brief Method get_allControls, addr 0x63d7af0, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_allControls();

  /// @brief Method get_canDeviceRunInBackground, addr 0x63dba8c, size 0xb4, virtual false, abstract: false, final false
  inline bool get_canDeviceRunInBackground();

  /// @brief Method get_canRunInBackground, addr 0x63dba88, size 0x4, virtual false, abstract: false, final false
  inline bool get_canRunInBackground();

  /// @brief Method get_description, addr 0x63db9a8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Layouts::InputDeviceDescription get_description();

  /// @brief Method get_deviceId, addr 0x63dbb64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_deviceId();

  /// @brief Method get_disabledInFrontend, addr 0x63dc2e0, size 0xc, virtual false, abstract: false, final false
  inline bool get_disabledInFrontend();

  /// @brief Method get_disabledInRuntime, addr 0x63dc30c, size 0xc, virtual false, abstract: false, final false
  inline bool get_disabledInRuntime();

  /// @brief Method get_disabledWhileInBackground, addr 0x63dc338, size 0xc, virtual false, abstract: false, final false
  inline bool get_disabledWhileInBackground();

  /// @brief Method get_enabled, addr 0x63db9c4, size 0x1c, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_hasControlsWithDefaultState, addr 0x63dc370, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasControlsWithDefaultState();

  /// @brief Method get_hasDontResetControls, addr 0x63dc37c, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasDontResetControls();

  /// @brief Method get_hasEventMerger, addr 0x63dc3a8, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasEventMerger();

  /// @brief Method get_hasEventPreProcessor, addr 0x63dc3d4, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasEventPreProcessor();

  /// @brief Method get_hasStateCallbacks, addr 0x63d597c, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasStateCallbacks();

  /// @brief Method get_lastUpdateTime, addr 0x63dbb6c, size 0x58, virtual false, abstract: false, final false
  inline double_t get_lastUpdateTime();

  /// @brief Method get_native, addr 0x63dbb4c, size 0xc, virtual false, abstract: false, final false
  inline bool get_native();

  /// @brief Method get_remote, addr 0x63dbb40, size 0xc, virtual false, abstract: false, final false
  inline bool get_remote();

  /// @brief Method get_updateBeforeRender, addr 0x63dbb58, size 0xc, virtual false, abstract: false, final false
  inline bool get_updateBeforeRender();

  /// @brief Method get_valueSizeInBytes, addr 0x63dbc80, size 0x5c, virtual true, abstract: false, final false
  inline int32_t get_valueSizeInBytes();

  /// @brief Method get_valueType, addr 0x63dbc20, size 0x60, virtual true, abstract: false, final false
  inline ::System::Type* get_valueType();

  /// @brief Method get_wasUpdatedThisFrame, addr 0x63dbbc4, size 0x5c, virtual false, abstract: false, final false
  inline bool get_wasUpdatedThisFrame();

  /// @brief Method set_disabledInFrontend, addr 0x63dc2ec, size 0x20, virtual false, abstract: false, final false
  inline void set_disabledInFrontend(bool value);

  /// @brief Method set_disabledInRuntime, addr 0x63dc318, size 0x20, virtual false, abstract: false, final false
  inline void set_disabledInRuntime(bool value);

  /// @brief Method set_disabledWhileInBackground, addr 0x63dc344, size 0x20, virtual false, abstract: false, final false
  inline void set_disabledWhileInBackground(bool value);

  /// @brief Method set_hasControlsWithDefaultState, addr 0x63d7348, size 0x20, virtual false, abstract: false, final false
  inline void set_hasControlsWithDefaultState(bool value);

  /// @brief Method set_hasDontResetControls, addr 0x63d7440, size 0x20, virtual false, abstract: false, final false
  inline void set_hasDontResetControls(bool value);

  /// @brief Method set_hasEventMerger, addr 0x63dc3b4, size 0x20, virtual false, abstract: false, final false
  inline void set_hasEventMerger(bool value);

  /// @brief Method set_hasEventPreProcessor, addr 0x63dc3e0, size 0x20, virtual false, abstract: false, final false
  inline void set_hasEventPreProcessor(bool value);

  /// @brief Method set_hasStateCallbacks, addr 0x63dc388, size 0x20, virtual false, abstract: false, final false
