...
public:
  ...
  /// @brief Method get_control, addr 0x63c9478, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::InputControl* get_control();

  /// @brief Method get_part, addr 0x63c9468, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_part();

  /// @brief Method set_control, addr 0x63c9480, size 0x8, virtual false, abstract: false, final false
  inline void set_control(::UnityEngine::InputSystem::InputControl* value);

  /// @brief Method set_part, addr 0x63c9470, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EvaluateMagnitude, addr 0x63c9348, size 0x24, virtual false, abstract: false, final false
  inline float_t EvaluateMagnitude(int32_t partNumber);

  /// @brief Method GetPressTime, addr 0x63c9444, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadValue, addr 0x63c93f4, size 0x2c, virtual false, abstract: false, final false
  inline void ReadValue(int32_t partNumber, void* buffer, int32_t bufferSize);

  /// @brief Method ReadValueAsButton, addr 0x63c936c, size 0x88, virtual false, abstract: false, final false
  inline bool ReadValueAsButton(int32_t partNumber);

  /// @brief Method ReadValueAsObject, addr 0x63c9420, size 0x24, virtual false, abstract: false, final false
  inline ::System::Object* ReadValueAsObject(int32_t partNumber);

  /// @brief Method get_controls, addr 0x63c92b8, size 0x70, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x63c948c, size 0x100, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::InputSystem::InputBindingCompositeContext__get_controls_d__2* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.GetEnumerator, addr 0x63c9630, size 0x98, virtual true, abstract: false,
  /// final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.get_Current, addr 0x63c958c, size 0xc, virtual true, abstract: false, final
  /// true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x63c96c8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x63c9598, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x63c95d0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x63c9488, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x63c9328, size 0x20, virtual false, abstract: false, final false
