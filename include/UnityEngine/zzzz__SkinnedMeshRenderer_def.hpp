...
public:
  ...
  /// @brief Method get_quality addr 0x2ca3af8 size 0x3c virtual false final false
  inline ::UnityEngine::SkinQuality get_quality();

  /// @brief Method set_quality addr 0x2ca3b34 size 0x44 virtual false final false
  inline void set_quality(::UnityEngine::SkinQuality value);

  /// @brief Method get_updateWhenOffscreen addr 0x2ca3b78 size 0x3c virtual false final false
  inline bool get_updateWhenOffscreen();

  /// @brief Method set_updateWhenOffscreen addr 0x2ca3bb4 size 0x44 virtual false final false
  inline void set_updateWhenOffscreen(bool value);

  /// @brief Method get_forceMatrixRecalculationPerRender addr 0x2ca3bf8 size 0x3c virtual false final false
  inline bool get_forceMatrixRecalculationPerRender();

  /// @brief Method set_forceMatrixRecalculationPerRender addr 0x2ca3c34 size 0x44 virtual false final false
  inline void set_forceMatrixRecalculationPerRender(bool value);

  /// @brief Method get_rootBone addr 0x2ca3c78 size 0x3c virtual false final false
  inline ::UnityEngine::Transform* get_rootBone();

  /// @brief Method set_rootBone addr 0x2ca3cb4 size 0x44 virtual false final false
  inline void set_rootBone(::UnityEngine::Transform* value);

  /// @brief Method get_bones addr 0x2ca3cf8 size 0x3c virtual false final false
  inline ::ArrayW<::UnityEngine::Transform*, ::Array<::UnityEngine::Transform*>*> get_bones();

  /// @brief Method set_bones addr 0x2ca3d34 size 0x44 virtual false final false
  inline void set_bones(::ArrayW<::UnityEngine::Transform*, ::Array<::UnityEngine::Transform*>*> value);

  /// @brief Method get_sharedMesh addr 0x2ca3d78 size 0x3c virtual false final false
  inline ::UnityEngine::Mesh* get_sharedMesh();

  /// @brief Method set_sharedMesh addr 0x2ca3db4 size 0x44 virtual false final false
  inline void set_sharedMesh(::UnityEngine::Mesh* value);

  /// @brief Method get_skinnedMotionVectors addr 0x2ca3df8 size 0x3c virtual false final false
  inline bool get_skinnedMotionVectors();

  /// @brief Method set_skinnedMotionVectors addr 0x2ca3e34 size 0x44 virtual false final false
  inline void set_skinnedMotionVectors(bool value);

  /// @brief Method GetBlendShapeWeight addr 0x2ca3e78 size 0x44 virtual false final false
  inline float_t GetBlendShapeWeight(int32_t index);

  /// @brief Method SetBlendShapeWeight addr 0x2ca3ebc size 0x54 virtual false final false
  inline void SetBlendShapeWeight(int32_t index, float_t value);

  /// @brief Method BakeMesh addr 0x2ca3f10 size 0x48 virtual false final false
  inline void BakeMesh(::UnityEngine::Mesh* mesh);

  /// @brief Method BakeMesh addr 0x2ca3f58 size 0x54 virtual false final false
  inline void BakeMesh(::UnityEngine::Mesh* mesh, bool useScale);

  /// @brief Method GetVertexBuffer addr 0x2ca3fac size 0xc4 virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetVertexBuffer();

  /// @brief Method GetPreviousVertexBuffer addr 0x2ca40ac size 0xc4 virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetPreviousVertexBuffer();

  /// @brief Method GetVertexBufferImpl addr 0x2ca4070 size 0x3c virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetVertexBufferImpl();

  /// @brief Method GetPreviousVertexBufferImpl addr 0x2ca4170 size 0x3c virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetPreviousVertexBufferImpl();

  /// @brief Method get_vertexBufferTarget addr 0x2ca41ac size 0x3c virtual false final false
  inline ::UnityEngine::__GraphicsBuffer__Target get_vertexBufferTarget();

  /// @brief Method set_vertexBufferTarget addr 0x2ca41e8 size 0x44 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ca422c size 0x8 virtual false final false
  inline void _ctor();
