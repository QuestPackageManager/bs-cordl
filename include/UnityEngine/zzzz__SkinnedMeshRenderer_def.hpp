...
public:
  ...
  /// @brief Method get_quality addr 0x2b3ec24 size 0x3c virtual false final false
  inline ::UnityEngine::SkinQuality get_quality();

  /// @brief Method set_quality addr 0x2b3ec60 size 0x44 virtual false final false
  inline void set_quality(::UnityEngine::SkinQuality value);

  /// @brief Method get_updateWhenOffscreen addr 0x2b3eca4 size 0x3c virtual false final false
  inline bool get_updateWhenOffscreen();

  /// @brief Method set_updateWhenOffscreen addr 0x2b3ece0 size 0x44 virtual false final false
  inline void set_updateWhenOffscreen(bool value);

  /// @brief Method get_forceMatrixRecalculationPerRender addr 0x2b3ed24 size 0x3c virtual false final false
  inline bool get_forceMatrixRecalculationPerRender();

  /// @brief Method set_forceMatrixRecalculationPerRender addr 0x2b3ed60 size 0x44 virtual false final false
  inline void set_forceMatrixRecalculationPerRender(bool value);

  /// @brief Method get_rootBone addr 0x2b3eda4 size 0x3c virtual false final false
  inline ::UnityEngine::Transform* get_rootBone();

  /// @brief Method set_rootBone addr 0x2b3ede0 size 0x44 virtual false final false
  inline void set_rootBone(::UnityEngine::Transform* value);

  /// @brief Method get_bones addr 0x2b3ee24 size 0x3c virtual false final false
  inline ::ArrayW<::UnityEngine::Transform*, ::Array<::UnityEngine::Transform*>*> get_bones();

  /// @brief Method set_bones addr 0x2b3ee60 size 0x44 virtual false final false
  inline void set_bones(::ArrayW<::UnityEngine::Transform*, ::Array<::UnityEngine::Transform*>*> value);

  /// @brief Method get_sharedMesh addr 0x2b3eea4 size 0x3c virtual false final false
  inline ::UnityEngine::Mesh* get_sharedMesh();

  /// @brief Method set_sharedMesh addr 0x2b3eee0 size 0x44 virtual false final false
  inline void set_sharedMesh(::UnityEngine::Mesh* value);

  /// @brief Method get_skinnedMotionVectors addr 0x2b3ef24 size 0x3c virtual false final false
  inline bool get_skinnedMotionVectors();

  /// @brief Method set_skinnedMotionVectors addr 0x2b3ef60 size 0x44 virtual false final false
  inline void set_skinnedMotionVectors(bool value);

  /// @brief Method GetBlendShapeWeight addr 0x2b3efa4 size 0x44 virtual false final false
  inline float_t GetBlendShapeWeight(int32_t index);

  /// @brief Method SetBlendShapeWeight addr 0x2b3efe8 size 0x54 virtual false final false
  inline void SetBlendShapeWeight(int32_t index, float_t value);

  /// @brief Method BakeMesh addr 0x2b3f03c size 0x48 virtual false final false
  inline void BakeMesh(::UnityEngine::Mesh* mesh);

  /// @brief Method BakeMesh addr 0x2b3f084 size 0x54 virtual false final false
  inline void BakeMesh(::UnityEngine::Mesh* mesh, bool useScale);

  /// @brief Method GetVertexBuffer addr 0x2b3f0d8 size 0xc4 virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetVertexBuffer();

  /// @brief Method GetPreviousVertexBuffer addr 0x2b3f1d8 size 0xc4 virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetPreviousVertexBuffer();

  /// @brief Method GetVertexBufferImpl addr 0x2b3f19c size 0x3c virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetVertexBufferImpl();

  /// @brief Method GetPreviousVertexBufferImpl addr 0x2b3f29c size 0x3c virtual false final false
  inline ::UnityEngine::GraphicsBuffer* GetPreviousVertexBufferImpl();

  /// @brief Method get_vertexBufferTarget addr 0x2b3f2d8 size 0x3c virtual false final false
  inline ::UnityEngine::__GraphicsBuffer__Target get_vertexBufferTarget();

  /// @brief Method set_vertexBufferTarget addr 0x2b3f314 size 0x44 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b3f358 size 0x8 virtual false final false
  inline void _ctor();
