...
template <typename T> constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AsyncInstantiateOperation*> const& UnityEngine::AsyncInstantiateOperation_1<T>::__cordl_internal_get_m_op() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_op;
}
