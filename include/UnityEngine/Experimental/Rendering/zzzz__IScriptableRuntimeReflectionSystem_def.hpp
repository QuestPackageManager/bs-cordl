...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IScriptableRuntimeReflectionSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IScriptableRuntimeReflectionSystem(IScriptableRuntimeReflectionSystemconst&) = delete;
