...
public:
  ...
  /// @brief Method BuiltinUpdate, addr 0x6965584, size 0x28, virtual false, abstract: false, final false
  static inline bool BuiltinUpdate();

  /// @brief Method Dispose, addr 0x69655ac, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x69655b0, size 0x4, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Internal_BuiltinRuntimeReflectionSystem_New, addr 0x69655b4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method TickRealtimeProbes, addr 0x696555c, size 0x28, virtual true, abstract: false, final true
  inline bool TickRealtimeProbes();

  /// @brief Method .ctor, addr 0x69655f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
