...
public:
  ...
  /// @brief Method GetGraphicsFormat addr 0x2b8b7d4 size 0x84 virtual false final false
  ...
  /// @brief Method GetGraphicsFormat_Native_TextureFormat addr 0x2b8b858 size 0x44 virtual false final false
  ...
  /// @brief Method GetGraphicsFormat addr 0x2b8b89c size 0x84 virtual false final false
  ...
  /// @brief Method GetGraphicsFormat_Native_RenderTextureFormat addr 0x2b8b920 size 0x44 virtual false final false
  ...
  /// @brief Method GetGraphicsFormat addr 0x2b8b964 size 0x88 virtual false final false
  ...
  /// @brief Method GetDepthStencilFormatFromBitsLegacy_Native addr 0x2b8b9ec size 0x3c virtual false final false
  ...
  /// @brief Method GetDepthStencilFormat addr 0x2b8ba28 size 0x74 virtual false final false
  static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetDepthStencilFormat(int32_t minimumDepthBits);

  /// @brief Method GetDepthBits addr 0x2b8ba9c size 0x3c virtual false final false
  static inline int32_t GetDepthBits(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method GetDepthStencilFormat addr 0x2b8bad8 size 0x1f4 virtual false final false
  ...
  /// @brief Method IsSRGBFormat addr 0x2b8bccc size 0x3c virtual false final false
  static inline bool IsSRGBFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method GetRenderTextureFormat addr 0x2b8bd08 size 0x3c virtual false final false
  ...
  /// @brief Method IsCompressedTextureFormat addr 0x2b8bd44 size 0x3c virtual false final false
  static inline bool IsCompressedTextureFormat(::UnityEngine::TextureFormat format);

  /// @brief Method CanDecompressFormat addr 0x2b8bd80 size 0x44 virtual false final false
  static inline bool CanDecompressFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format, bool wholeImage);

  /// @brief Method CanDecompressFormat addr 0x2b8bdc4 size 0x78 virtual false final false
  static inline bool CanDecompressFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method IsDepthFormat addr 0x2b8be3c size 0x3c virtual false final false
  static inline bool IsDepthFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method IsStencilFormat addr 0x2b8be78 size 0x3c virtual false final false
  static inline bool IsStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method IsPVRTCFormat addr 0x2b8beb4 size 0x3c virtual false final false
  static inline bool IsPVRTCFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method IsCrunchFormat addr 0x2b8bef0 size 0x24 virtual false final false
