...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Rendering::CommandBuffer*, ::UnityEngine::Camera*, ::UnityEngine::Material*, Il2CppObject*)>(&::UnityEngine::Experimental::Rendering::XRMirrorView::RenderMirrorView)> {
  constexpr static std::size_t size = 0xe9c;
  constexpr static std::size_t addrs = 0x6590dac;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Rendering::CommandBuffer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Camera*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Material*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Il2CppObject*>::get()}
                    )));
...
::cordl_internals::setStaticField<::UnityEngine::MaterialPropertyBlock*, "s_MirrorViewMaterialProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<::UnityEngine::MaterialPropertyBlock*>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::MaterialPropertyBlock*, "s_MirrorViewMaterialProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>();
}
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::ProfilingSampler*, "k_MirrorViewProfilingSampler", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<::UnityEngine::Rendering::ProfilingSampler*>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::ProfilingSampler*, "k_MirrorViewProfilingSampler", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>();
}
inline void UnityEngine::Experimental::Rendering::XRMirrorView::setStaticF_k_SourceTex(int32_t  value)  {
::cordl_internals::setStaticField<int32_t, "k_SourceTex", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_SourceTexArraySlice", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_ScaleBias", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_ScaleBiasRt", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_SRGBRead", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_SRGBWrite", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_MaxNits", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_SourceMaxNits", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_SourceHDREncoding", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "k_ColorTransform", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Experimental::Rendering::XRMirrorView*>::get>(std::forward<int32_t>(value));
}
