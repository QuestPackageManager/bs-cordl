...
public:
  ...
  /// @brief Method BuildPass, addr 0x660782c, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildView, addr 0x6607bc0, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method CanUseSinglePass, addr 0x66076bc, size 0x170, virtual false, abstract: false, final false
  static inline bool CanUseSinglePass(::UnityEngine::Camera* camera, ::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass renderPass);

  /// @brief Method CreateDefaultLayout, addr 0x6601a40, size 0x4cc, virtual false, abstract: false, final false
  static inline void CreateDefaultLayout(::UnityEngine::Camera* camera, ::UnityEngine::Experimental::Rendering::XRLayout* layout);

  /// @brief Method Dispose, addr 0x66073fc, size 0x190, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method EndLayout, addr 0x660726c, size 0xe4, virtual false, abstract: false, final false
  static inline void EndLayout();

  /// @brief Method GetActiveDisplay, addr 0x6606138, size 0x5c, virtual false, abstract: false, final false
  static inline Il2CppObject* GetActiveDisplay();

  /// @brief Method GetDisplayMSAASamples, addr 0x6606da8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::MSAASamples GetDisplayMSAASamples();

  /// @brief Method GetMirrorViewMode, addr 0x6606f64, size 0x98, virtual false, abstract: false, final false
  static inline int32_t GetMirrorViewMode();

  /// @brief Method GetOcclusionMeshScale, addr 0x6606e6c, size 0x5c, virtual false, abstract: false, final false
  static inline float_t GetOcclusionMeshScale();

  /// @brief Method GetRenderViewportScale, addr 0x660719c, size 0x68, virtual false, abstract: false, final false
  static inline float_t GetRenderViewportScale();

  /// @brief Method Initialize, addr 0x6606478, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method NewLayout, addr 0x6607204, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::Rendering::XRLayout* NewLayout();

  /// @brief Method ReconfigurePass, addr 0x6602088, size 0x2a4, virtual false, abstract: false, final false
  static inline void ReconfigurePass(::UnityEngine::Experimental::Rendering::XRPass* xrPass, ::UnityEngine::Camera* camera);

  /// @brief Method RefreshDeviceInfo, addr 0x66068b8, size 0x318, virtual false, abstract: false, final false
  static inline void RefreshDeviceInfo();

  /// @brief Method RenderMirrorView, addr 0x6607350, size 0xac, virtual false, abstract: false, final false
  static inline void RenderMirrorView(::UnityEngine::Rendering::CommandBuffer* cmd, ::UnityEngine::Camera* camera);

  /// @brief Method SetDisplayMSAASamples, addr 0x6606bd0, size 0x1d8, virtual false, abstract: false, final false
  static inline void SetDisplayMSAASamples(::UnityEngine::Rendering::MSAASamples msaaSamples);

  /// @brief Method SetDisplayZRange, addr 0x6601978, size 0xc8, virtual false, abstract: false, final false
  static inline void SetDisplayZRange(float_t zNear, float_t zFar);

  /// @brief Method SetLayoutOverride, addr 0x660758c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMirrorViewMode, addr 0x6606ec8, size 0x9c, virtual false, abstract: false, final false
  static inline void SetMirrorViewMode(int32_t mirrorBlitMode);

  /// @brief Method SetOcclusionMeshScale, addr 0x6606e04, size 0x68, virtual false, abstract: false, final false
  static inline void SetOcclusionMeshScale(float_t occlusionMeshScale);

  /// @brief Method SetRenderScale, addr 0x6606ffc, size 0x1a0, virtual false, abstract: false, final false
  static inline void SetRenderScale(float_t renderScale);

  /// @brief Method XRSystemInit, addr 0x66075ec, size 0xd0, virtual false, abstract: false, final false
  static inline void XRSystemInit();

  /// @brief Method XrRenderTextureDescToUnityRenderTextureDesc, addr 0x6607d88, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateDefaultLayout>g__AddViewToPass|44_0, addr 0x6607acc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_displayActive, addr 0x66018dc, size 0x9c, virtual false, abstract: false, final false
  static inline bool get_displayActive();

  /// @brief Method get_dumpDebugInfo, addr 0x66063b8, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_dumpDebugInfo();

  /// @brief Method get_foveatedRenderingCaps, addr 0x66062fc, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::FoveatedRenderingCaps get_foveatedRenderingCaps();

  /// @brief Method get_isHDRDisplayOutputActive, addr 0x6606194, size 0xa8, virtual false, abstract: false, final false
  static inline bool get_isHDRDisplayOutputActive();

  /// @brief Method get_singlePassAllowed, addr 0x660623c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_dumpDebugInfo, addr 0x6606414, size 0x64, virtual false, abstract: false, final false
  static inline void set_dumpDebugInfo(bool value);

  /// @brief Method set_foveatedRenderingCaps, addr 0x6606358, size 0x60, virtual false, abstract: false, final false
  static inline void set_foveatedRenderingCaps(::UnityEngine::Rendering::FoveatedRenderingCaps value);

  /// @brief Method set_singlePassAllowed, addr 0x6606298, size 0x64, virtual false, abstract: false, final false
