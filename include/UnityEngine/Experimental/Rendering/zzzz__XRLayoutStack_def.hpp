...
public:
  ...
  /// @brief Method Dispose, addr 0x65905dc, size 0x9c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method New, addr 0x65903c4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x65904d0, size 0x10c, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x6590678, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_top, addr 0x659047c, size 0x54, virtual false, abstract: false, final false
