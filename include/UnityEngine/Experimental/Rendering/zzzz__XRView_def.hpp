...
public:
// Declarations
/// @brief Method ComputeEyeCenterUV, addr 0x6595f5c, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ComputeEyeCenterUV(::UnityEngine::Matrix4x4  proj) ;

/// @brief Method .ctor, addr 0x6595d04, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Matrix4x4  projMatrix, ::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  prevViewMatrix, bool  isPrevViewMatrixValid, ::UnityEngine::Rect  viewport, ::UnityEngine::Mesh*  occlusionMesh, int32_t  textureArraySlice) ;

// Ctor Parameters []
// @brief default ctor
constexpr XRView() ;

// Ctor Parameters [CppParam { name: "projMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "viewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "prevViewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "viewport", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "occlusionMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: None }, CppParam { name: "textureArraySlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "eyeCenterUV", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "isPrevViewMatrixValid", ty: "bool", modifiers: "", def_value: None }]
constexpr XRView(::UnityEngine::Matrix4x4  projMatrix, ::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  prevViewMatrix, ::UnityEngine::Rect  viewport, ::UnityW<::UnityEngine::Mesh>  occlusionMesh, int32_t  textureArraySlice, ::UnityEngine::Vector2  eyeCenterUV, bool  isPrevViewMatrixValid) noexcept;
