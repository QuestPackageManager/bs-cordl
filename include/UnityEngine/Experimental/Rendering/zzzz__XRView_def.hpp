...
public:
  // Declarations
  /// @brief Method ComputeEyeCenterUV, addr 0x67471ec, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 ComputeEyeCenterUV(::UnityEngine::Matrix4x4 proj);

  /// @brief Method .ctor, addr 0x6746f94, size 0x78, virtual false, abstract: false, final false
