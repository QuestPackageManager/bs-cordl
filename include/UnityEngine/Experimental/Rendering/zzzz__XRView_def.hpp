...
public:
  // Declarations
  /// @brief Method ComputeEyeCenterUV, addr 0x6607f68, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 ComputeEyeCenterUV(::UnityEngine::Matrix4x4 proj);

  /// @brief Method .ctor, addr 0x6607d10, size 0x78, virtual false, abstract: false, final false
