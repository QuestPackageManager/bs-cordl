...
// Dependencies System.IntPtr, UnityEngine.RenderTextureDescriptor, UnityEngine.Rendering.RenderTargetIdentifier, UnityEngine.Rendering.ScriptableCullingParameters, UnityEngine.XR.XRDisplaySubsystem::XRRenderPass
namespace UnityEngine::Experimental::Rendering {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "renderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: None }, CppParam { name: "renderTargetDesc", ty: "::UnityEngine::RenderTextureDescriptor", modifiers: "", def_value: None }, CppParam { name: "motionVectorRenderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: None }, CppParam { name: "motionVectorRenderTargetDesc", ty: "::UnityEngine::RenderTextureDescriptor", modifiers: "", def_value: None }, CppParam { name: "cullingParameters", ty: "::UnityEngine::Rendering::ScriptableCullingParameters", modifiers: "", def_value: None }, CppParam { name: "occlusionMeshMaterial", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "occlusionMeshScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "foveatedRenderingInfo", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "multipassId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cullingPassId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "copyDepth", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "hasMotionVectorPass", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "xrSdkRenderPass", ty: "::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass", modifiers: "", def_value: None }]
constexpr XRPassCreateInfo(::UnityEngine::Rendering::RenderTargetIdentifier  renderTarget, ::UnityEngine::RenderTextureDescriptor  renderTargetDesc, ::UnityEngine::Rendering::RenderTargetIdentifier  motionVectorRenderTarget, ::UnityEngine::RenderTextureDescriptor  motionVectorRenderTargetDesc, ::UnityEngine::Rendering::ScriptableCullingParameters  cullingParameters, ::UnityW<::UnityEngine::Material>  occlusionMeshMaterial, float_t  occlusionMeshScale, ::System::IntPtr  foveatedRenderingInfo, int32_t  multipassId, int32_t  cullingPassId, bool  copyDepth, bool  hasMotionVectorPass, ::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass  xrSdkRenderPass) noexcept;
