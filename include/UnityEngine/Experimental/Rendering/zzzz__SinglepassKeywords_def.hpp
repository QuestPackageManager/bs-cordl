...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SinglepassKeywords", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SinglepassKeywords(SinglepassKeywords&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SinglepassKeywords", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SinglepassKeywords(SinglepassKeywordsconst&) = delete;
