...
/// @brief Method CreateOcclusionMeshCombined, addr 0x659299c, size 0x350, virtual false, abstract: false, final false
inline void CreateOcclusionMeshCombined() ;

/// @brief Method IsOcclusionMeshSupported, addr 0x6592004, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method RenderOcclusionMesh, addr 0x6592108, size 0x3bc, virtual false, abstract: false, final false
inline void RenderOcclusionMesh(::UnityEngine::Rendering::CommandBuffer*  cmd, float_t  occlusionMeshScale, bool  yFlip) ;

/// @brief Method SetMaterial, addr 0x6591f44, size 0x8, virtual false, abstract: false, final false
inline void SetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method TryGetOcclusionMeshCombinedHashCode, addr 0x65928a4, size 0xf8, virtual false, abstract: false, final false
inline bool TryGetOcclusionMeshCombinedHashCode(::ByRef<int32_t>  hashCode) ;

/// @brief Method UpdateCombinedMesh, addr 0x65927d0, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6591f3c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_hasValidOcclusionMesh, addr 0x6591f4c, size 0xb8, virtual false, abstract: false, final false
