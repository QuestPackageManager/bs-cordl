...
/// @brief Method AddView, addr 0x6593f1c, size 0x210, virtual false, abstract: false, final false
inline void AddView(::UnityEngine::Experimental::Rendering::XRView  xrView) ;

/// @brief Method ApplyXRViewCenterOffset, addr 0x6593c48, size 0x154, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 ApplyXRViewCenterOffset(::UnityEngine::Vector2  center) ;

/// @brief Method AssignCullingParams, addr 0x6593e9c, size 0x80, virtual false, abstract: false, final false
inline void AssignCullingParams(int32_t  cullingPassId, ::UnityEngine::Rendering::ScriptableCullingParameters  cullingParams) ;

/// @brief Method AssignView, addr 0x6593d9c, size 0x100, virtual false, abstract: false, final false
inline void AssignView(int32_t  viewId, ::UnityEngine::Experimental::Rendering::XRView  xrView) ;

/// @brief Method CreateDefault, addr 0x6592e20, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetOcclusionMesh, addr 0x6592090, size 0x78, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> GetOcclusionMesh(int32_t  viewIndex) ;

/// @brief Method GetPrevViewMatrix, addr 0x6593820, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetPrevViewMatrix(int32_t  viewIndex) ;

/// @brief Method GetPrevViewValid, addr 0x65937a4, size 0x7c, virtual false, abstract: false, final false
inline bool GetPrevViewValid(int32_t  viewIndex) ;

/// @brief Method GetProjMatrix, addr 0x658f32c, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetProjMatrix(int32_t  viewIndex) ;

/// @brief Method GetTextureArraySlice, addr 0x6590948, size 0x78, virtual false, abstract: false, final false
inline int32_t GetTextureArraySlice(int32_t  viewIndex) ;

/// @brief Method GetViewMatrix, addr 0x658f294, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetViewMatrix(int32_t  viewIndex) ;

/// @brief Method GetViewport, addr 0x65908cc, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetViewport(int32_t  viewIndex) ;

/// @brief Method InitBase, addr 0x6592f00, size 0x204, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x6593104, size 0x74, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method RenderDebugXRViewsFrustum, addr 0x65939cc, size 0x27c, virtual false, abstract: false, final false
inline void RenderDebugXRViewsFrustum() ;

/// @brief Method RenderOcclusionMesh, addr 0x659396c, size 0x28, virtual false, abstract: false, final false
inline void RenderOcclusionMesh(::UnityEngine::Rendering::CommandBuffer*  cmd, bool  renderIntoTexture) ;

/// @brief Method RenderOcclusionMesh, addr 0x6593994, size 0x38, virtual false, abstract: false, final false
inline void RenderOcclusionMesh(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, bool  renderIntoTexture) ;

/// @brief Method StartSinglePass, addr 0x65925b8, size 0x218, virtual false, abstract: false, final false
inline void StartSinglePass(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method StartSinglePass, addr 0x65938b8, size 0x8c, virtual false, abstract: false, final false
inline void StartSinglePass(::UnityEngine::Rendering::IRasterCommandBuffer*  cmd) ;

/// @brief Method StopSinglePass, addr 0x6593944, size 0x14, virtual false, abstract: false, final false
inline void StopSinglePass(::UnityEngine::Rendering::BaseCommandBuffer*  cmd) ;

/// @brief Method StopSinglePass, addr 0x65924c4, size 0xf4, virtual false, abstract: false, final false
inline void StopSinglePass(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method UpdateCombinedOcclusionMesh, addr 0x6590320, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6592d80, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_copyDepth, addr 0x6593238, size 0x8, virtual false, abstract: false, final false
inline bool get_copyDepth() ;

/// @brief Method get_cullingParams, addr 0x65933c4, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ScriptableCullingParameters get_cullingParams() ;

/// @brief Method get_cullingPassId, addr 0x65932e4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cullingPassId() ;

/// @brief Method get_enabled, addr 0x658f27c, size 0x18, virtual false, abstract: false, final false
inline bool get_enabled() ;

/// @brief Method get_foveatedRenderingInfo, addr 0x65933e0, size 0x8, virtual false, abstract: false, final false
inline ::System::IntPtr get_foveatedRenderingInfo() ;

/// @brief Method get_hasMotionVectorPass, addr 0x6593248, size 0x8, virtual false, abstract: false, final false
inline bool get_hasMotionVectorPass() ;

/// @brief Method get_hasValidOcclusionMesh, addr 0x6593958, size 0x14, virtual false, abstract: false, final false
inline bool get_hasValidOcclusionMesh() ;

/// @brief Method get_hdrDisplayOutputColorGamut, addr 0x65934a8, size 0xb8, virtual false, abstract: false, final false
inline ::UnityEngine::ColorGamut get_hdrDisplayOutputColorGamut() ;

/// @brief Method get_hdrDisplayOutputInformation, addr 0x6593560, size 0x234, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::HDROutputUtils_HDRDisplayInformation get_hdrDisplayOutputInformation() ;

/// @brief Method get_isFirstCameraPass, addr 0x6593258, size 0x10, virtual false, abstract: false, final false
inline bool get_isFirstCameraPass() ;

/// @brief Method get_isHDRDisplayOutputActive, addr 0x65933f0, size 0xb8, virtual false, abstract: false, final false
inline bool get_isHDRDisplayOutputActive() ;

/// @brief Method get_isLastCameraPass, addr 0x6593268, size 0x6c, virtual false, abstract: false, final false
inline bool get_isLastCameraPass() ;

/// @brief Method get_motionVectorRenderTarget, addr 0x659335c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderTargetIdentifier get_motionVectorRenderTarget() ;

/// @brief Method get_motionVectorRenderTargetDesc, addr 0x6593384, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::RenderTextureDescriptor get_motionVectorRenderTargetDesc() ;

/// @brief Method get_multipassId, addr 0x65932d4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_multipassId() ;

/// @brief Method get_occlusionMeshScale, addr 0x6593794, size 0x8, virtual false, abstract: false, final false
inline float_t get_occlusionMeshScale() ;

/// @brief Method get_renderTarget, addr 0x65932f4, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderTargetIdentifier get_renderTarget() ;

/// @brief Method get_renderTargetDesc, addr 0x659331c, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::RenderTextureDescriptor get_renderTargetDesc() ;

/// @brief Method get_singlePassEnabled, addr 0x658f3c4, size 0x18, virtual false, abstract: false, final false
inline bool get_singlePassEnabled() ;

/// @brief Method get_supportsFoveatedRendering, addr 0x6593178, size 0xc0, virtual false, abstract: false, final false
inline bool get_supportsFoveatedRendering() ;

/// @brief Method get_viewCount, addr 0x65909c0, size 0x50, virtual false, abstract: false, final false
inline int32_t get_viewCount() ;

/// @brief Method set_copyDepth, addr 0x6593240, size 0x8, virtual false, abstract: false, final false
inline void set_copyDepth(bool  value) ;

/// @brief Method set_cullingParams, addr 0x65933d4, size 0xc, virtual false, abstract: false, final false
inline void set_cullingParams(::UnityEngine::Rendering::ScriptableCullingParameters  value) ;

/// @brief Method set_cullingPassId, addr 0x65932ec, size 0x8, virtual false, abstract: false, final false
inline void set_cullingPassId(int32_t  value) ;

/// @brief Method set_foveatedRenderingInfo, addr 0x65933e8, size 0x8, virtual false, abstract: false, final false
inline void set_foveatedRenderingInfo(::System::IntPtr  value) ;

/// @brief Method set_hasMotionVectorPass, addr 0x6593250, size 0x8, virtual false, abstract: false, final false
inline void set_hasMotionVectorPass(bool  value) ;

/// @brief Method set_motionVectorRenderTarget, addr 0x6593370, size 0x14, virtual false, abstract: false, final false
inline void set_motionVectorRenderTarget(::UnityEngine::Rendering::RenderTargetIdentifier  value) ;

/// @brief Method set_motionVectorRenderTargetDesc, addr 0x65933a4, size 0x20, virtual false, abstract: false, final false
inline void set_motionVectorRenderTargetDesc(::UnityEngine::RenderTextureDescriptor  value) ;

/// @brief Method set_multipassId, addr 0x65932dc, size 0x8, virtual false, abstract: false, final false
inline void set_multipassId(int32_t  value) ;

/// @brief Method set_occlusionMeshScale, addr 0x659379c, size 0x8, virtual false, abstract: false, final false
inline void set_occlusionMeshScale(float_t  value) ;

/// @brief Method set_renderTarget, addr 0x6593308, size 0x14, virtual false, abstract: false, final false
inline void set_renderTarget(::UnityEngine::Rendering::RenderTargetIdentifier  value) ;

/// @brief Method set_renderTargetDesc, addr 0x659333c, size 0x20, virtual false, abstract: false, final false
