...
// Ctor Parameters [CppParam { name: "renderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "renderTargetDesc",
// ty: "::UnityEngine::RenderTextureDescriptor", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "motionVectorRenderTarget", ty:
