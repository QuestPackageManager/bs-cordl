...
public:
  ...
  /// @brief Method AddCamera, addr 0x6601724, size 0x1b8, virtual false, abstract: false, final false
  inline void AddCamera(::UnityEngine::Camera* camera, bool enableXR);

  /// @brief Method AddPass, addr 0x6601f0c, size 0xe0, virtual false, abstract: false, final false
  inline void AddPass(::UnityEngine::Camera* camera, ::UnityEngine::Experimental::Rendering::XRPass* xrPass);

  /// @brief Method Clear, addr 0x6602348, size 0x144, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetActivePasses, addr 0x6602340, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method LogDebugInfo, addr 0x660248c, size 0x44c, virtual false, abstract: false, final false
  inline void LogDebugInfo();

  static inline ::UnityEngine::Experimental::Rendering::XRLayout* New_ctor();

  /// @brief Method ReconfigurePass, addr 0x6601fec, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6602a1c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
