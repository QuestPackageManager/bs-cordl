...
/// @brief Method SetBuiltinShaderConstants, addr 0x658e9c0, size 0x154, virtual false, abstract: false, final false
static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method SetBuiltinShaderConstants, addr 0x658eb14, size 0x64, virtual false, abstract: false, final false
static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

/// @brief Method Update, addr 0x658eb78, size 0x704, virtual false, abstract: false, final false
...
/// @brief Method UpdateBuiltinShaderConstants, addr 0x658e5b8, size 0x408, virtual false, abstract: false, final false
