...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRBuiltinShaderConstants", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRBuiltinShaderConstants(XRBuiltinShaderConstants&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRBuiltinShaderConstants", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRBuiltinShaderConstants(XRBuiltinShaderConstantsconst&) = delete;
