...
public:
  ...
  /// @brief Method SetBuiltinShaderConstants, addr 0x66009cc, size 0x154, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetBuiltinShaderConstants, addr 0x6600b20, size 0x64, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method Update, addr 0x6600b84, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBuiltinShaderConstants, addr 0x66005c4, size 0x408, virtual false, abstract: false, final false
