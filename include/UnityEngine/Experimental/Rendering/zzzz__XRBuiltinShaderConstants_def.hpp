...
// Write type traits
MARK_REF_T(::UnityEngine::Experimental::Rendering::XRBuiltinShaderConstants*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::Rendering::XRBuiltinShaderConstants*, "UnityEngine.Experimental.Rendering", "XRBuiltinShaderConstants");
...
public:
  ...
  __declspec(property(get = getStaticF_s_cameraProjMatrix, put = setStaticF_s_cameraProjMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_cameraProjMatrix;

  /// @brief Field s_invCameraProjMatrix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_invCameraProjMatrix, put = setStaticF_s_invCameraProjMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_invCameraProjMatrix;

  /// @brief Field s_invProjMatrix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_invProjMatrix, put = setStaticF_s_invProjMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_invProjMatrix;

  /// @brief Field s_invViewMatrix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_invViewMatrix, put = setStaticF_s_invViewMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_invViewMatrix;

  /// @brief Field s_invViewProjMatrix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_invViewProjMatrix, put = setStaticF_s_invViewProjMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_invViewProjMatrix;
  ...
  __declspec(property(get = getStaticF_s_viewMatrix, put = setStaticF_s_viewMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_viewMatrix;

  /// @brief Field s_viewProjMatrix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_viewProjMatrix, put = setStaticF_s_viewProjMatrix)) ::ArrayW<::UnityEngine::Matrix4x4> s_viewProjMatrix;

  /// @brief Field s_worldSpaceCameraPos, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_worldSpaceCameraPos, put = setStaticF_s_worldSpaceCameraPos)) ::ArrayW<::UnityEngine::Vector4> s_worldSpaceCameraPos;
  ...
  /// @brief Method SetBuiltinShaderConstants, addr 0x673fc50, size 0x154, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetBuiltinShaderConstants, addr 0x673fda4, size 0x64, virtual false, abstract: false, final false
  static inline void SetBuiltinShaderConstants(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method Update, addr 0x673fe08, size 0x704, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBuiltinShaderConstants, addr 0x673f848, size 0x408, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_invCameraProjMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_invProjMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_invViewMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_invViewProjMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_projMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_viewMatrix();

  static inline ::ArrayW<::UnityEngine::Matrix4x4> getStaticF_s_viewProjMatrix();

  static inline ::ArrayW<::UnityEngine::Vector4> getStaticF_s_worldSpaceCameraPos();
  ...
  static inline void setStaticF_s_cameraProjMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_invCameraProjMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_invProjMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_invViewMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_invViewProjMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_projMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_viewMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_viewProjMatrix(::ArrayW<::UnityEngine::Matrix4x4> value);

  static inline void setStaticF_s_worldSpaceCameraPos(::ArrayW<::UnityEngine::Vector4> value);
...
static_assert(sizeof(::UnityEngine::Experimental::Rendering::XRBuiltinShaderConstants) == 0x10, "Size mismatch!");
