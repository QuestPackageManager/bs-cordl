...
public:
  ...
  /// @brief Method Equals, addr 0x6e2c4a4, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Video::VideoClipPlayable other);

  /// @brief Method GetHandle, addr 0x6e2c498, size 0xc, virtual true, abstract: false, final true
