...
// "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "SceneCullingMask", ty: "uint64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "IndexData", ty: "::System::IntPtr",
// modifiers: "", def_value: Some("{}") }, CppParam { name: "VertexData", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "IndexCount", ty: "int32_t", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "VertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ShaderChannelMask", ty: "int32_t", modifiers: "", def_value:
// Some("{}") }]
