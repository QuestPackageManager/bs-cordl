...
// TypeDefinitionIndex(TypeDefinitionIndex(10249))} Self: TypeDefinitionIndex(TypeDefinitionIndex(10391)) CS Name: ::UnityEngine.Experimental.GlobalIllumination::DirectionalLight
