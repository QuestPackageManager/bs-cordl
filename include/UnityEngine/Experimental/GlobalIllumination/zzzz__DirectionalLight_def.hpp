...
// TypeDefinitionIndex(TypeDefinitionIndex(10387))} Self: TypeDefinitionIndex(TypeDefinitionIndex(10391)) CS Name: ::UnityEngine.Experimental.GlobalIllumination::DirectionalLight
