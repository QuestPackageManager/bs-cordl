...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::LinearColor, "UnityEngine.Experimental.GlobalIllumination", "LinearColor");
// Dependencies
namespace UnityEngine::Experimental::GlobalIllumination {
// Is value type: true
...
public:
  ...
  /// @brief Method Black, addr 0x6b2bbf0, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Black();

  /// @brief Method Convert, addr 0x6b2b8b8, size 0x338, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Convert(::UnityEngine::Color color, float_t intensity);

  /// @brief Method get_blue, addr 0x6b2b804, size 0x8, virtual false, abstract: false, final false
  inline float_t get_blue();

  /// @brief Method get_green, addr 0x6b2b750, size 0x8, virtual false, abstract: false, final false
  inline float_t get_green();

  /// @brief Method get_red, addr 0x6b2b69c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_red();

  /// @brief Method set_blue, addr 0x6b2b80c, size 0xac, virtual false, abstract: false, final false
  inline void set_blue(float_t value);

  /// @brief Method set_green, addr 0x6b2b758, size 0xac, virtual false, abstract: false, final false
  inline void set_green(float_t value);

  /// @brief Method set_red, addr 0x6b2b6a4, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::LinearColor) == 0x10, "Size mismatch!");
