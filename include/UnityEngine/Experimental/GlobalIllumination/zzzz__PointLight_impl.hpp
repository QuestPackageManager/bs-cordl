...
// "::UnityEngine::Experimental::GlobalIllumination::LinearColor", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "range", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "sphereRadius", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "falloff", ty:
// "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value: Some("{}"), comment: None }]
