#pragma once
// IWYU pragma private; include "UnityEngine/Experimental/GlobalIllumination/RectangleLight.hpp"
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::RectangleLight, "UnityEngine.Experimental.GlobalIllumination", "RectangleLight");
...
public:
  ...
  // None }, CppParam { name: "width", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "height", ty: "float_t", modifiers: "", def_value: None, comment: None },
  // CppParam { name: "falloff", ty: "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::RectangleLight) == 0x54, "Size mismatch!");
