...
DEFINE_IL2CPP_CLASS(::UnityEngine::Experimental::GlobalIllumination::PointLight, "UnityEngine.Experimental.GlobalIllumination", "PointLight");
...
public:
  ...
  // None }, CppParam { name: "sphereRadius", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "falloff", ty:
  // "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::PointLight) == 0x50, "Size mismatch!");
