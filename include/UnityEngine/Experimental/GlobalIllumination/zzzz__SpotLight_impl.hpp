...
// comment: None }, CppParam { name: "sphereRadius", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "coneAngle", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "innerConeAngle", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "falloff", ty:
// "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "angularFalloff", ty:
// "::UnityEngine::Experimental::GlobalIllumination::AngularFalloffType", modifiers: "", def_value: Some("{}"), comment: None }]
