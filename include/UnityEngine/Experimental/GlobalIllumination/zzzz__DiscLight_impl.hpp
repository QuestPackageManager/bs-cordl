...
// name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "falloff", ty: "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value:
// Some("{}") }]
constexpr ::UnityEngine::Experimental::GlobalIllumination::DiscLight::DiscLight(int32_t instanceID, bool shadow, ::UnityEngine::Experimental::GlobalIllumination::LightMode mode,
                                                                                ...
                                                                                ::UnityEngine::Experimental::GlobalIllumination::LinearColor indirectColor, float_t range, float_t radius,
