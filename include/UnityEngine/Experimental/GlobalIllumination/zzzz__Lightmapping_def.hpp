...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2e45210, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e45138, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x2e45290, size 0x4c0, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::ArrayW<::UnityEngine::Light*, ::Array<::UnityEngine::Light*>*> requests,
                             ::Unity::Collections::NativeArray_1<::UnityEngine::Experimental::GlobalIllumination::LightDataGI> lightsOutput);

  /// @brief Method .ctor, addr 0x2e45288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetDelegate, addr 0x2e44ee8, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::__Lightmapping__RequestLightsDelegate* GetDelegate();

  /// @brief Method RequestLights, addr 0x2e44f9c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetDelegate, addr 0x2e44f40, size 0x5c, virtual false, abstract: false, final false
  static inline void ResetDelegate();

  /// @brief Method SetDelegate, addr 0x2e44e70, size 0x78, virtual false, abstract: false, final false
