...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x48cab94, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48caaf4, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__7_0, addr 0x48cac0c, size 0x4bc, virtual false, abstract: false, final false
  inline void __cctor_b__7_0(::ArrayW<::UnityEngine::Light*, ::Array<::UnityEngine::Light*>*> requests,
                             ::Unity::Collections::NativeArray_1<::UnityEngine::Experimental::GlobalIllumination::LightDataGI> lightsOutput);

  /// @brief Method .ctor, addr 0x48cac04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetDelegate, addr 0x48ca8a4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate* GetDelegate();

  /// @brief Method RequestLights, addr 0x48ca958, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetDelegate, addr 0x48ca8fc, size 0x5c, virtual false, abstract: false, final false
  static inline void ResetDelegate();

  /// @brief Method SetDelegate, addr 0x48ca82c, size 0x78, virtual false, abstract: false, final false
