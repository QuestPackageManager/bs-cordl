...
// comment: None }, CppParam { name: "width", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "height", ty: "float_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "falloff", ty: "::UnityEngine::Experimental::GlobalIllumination::FalloffType", modifiers: "", def_value: Some("{}"), comment: None }]
