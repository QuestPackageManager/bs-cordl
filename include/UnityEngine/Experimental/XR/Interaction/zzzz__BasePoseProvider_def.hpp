...
public:
  // Declarations
  /// @brief Method GetPoseFromProvider, addr 0x6983a70, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetPoseFromProvider, addr 0x6983a94, size 0x7c, virtual true, abstract: false, final false
  inline bool TryGetPoseFromProvider(::ByRef<::UnityEngine::Pose> output);

  /// @brief Method .ctor, addr 0x6983b10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
