...
public:
  // Declarations
  /// @brief Method GetPoseFromProvider, addr 0x69ec8f4, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetPoseFromProvider, addr 0x69ec918, size 0x7c, virtual true, abstract: false, final false
  inline bool TryGetPoseFromProvider(::ByRef<::UnityEngine::Pose> output);

  /// @brief Method .ctor, addr 0x69ec994, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23001 };
