...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68f76d8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f7590, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeSampleFramesAvailable, addr 0x68f7540, size 0x28, virtual false, abstract: false, final false
  inline void InvokeSampleFramesAvailable(int32_t sampleFrameCount);

  /// @brief Method InvokeSampleFramesOverflow, addr 0x68f7568, size 0x28, virtual false, abstract: false, final false
