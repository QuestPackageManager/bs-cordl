...
public:
// Declarations
/// @brief Method Invoke, addr 0x68f9250, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x68f9108, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method InvokeSampleFramesAvailable, addr 0x68f90b8, size 0x28, virtual false, abstract: false, final false
inline void InvokeSampleFramesAvailable(int32_t  sampleFrameCount) ;

/// @brief Method InvokeSampleFramesOverflow, addr 0x68f90e0, size 0x28, virtual false, abstract: false, final false
