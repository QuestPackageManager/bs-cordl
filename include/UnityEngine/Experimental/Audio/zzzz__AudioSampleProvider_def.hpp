...
public:
// Declarations
/// @brief Method Invoke, addr 0x68856cc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6885584, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method InvokeSampleFramesAvailable, addr 0x6885534, size 0x28, virtual false, abstract: false, final false
inline void InvokeSampleFramesAvailable(int32_t  sampleFrameCount) ;

/// @brief Method InvokeSampleFramesOverflow, addr 0x688555c, size 0x28, virtual false, abstract: false, final false
