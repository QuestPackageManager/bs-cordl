...
public:
  ...
  /// @brief Method GetHandle, addr 0x6b2d4ac, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Experimental::Playables::TexturePlayableOutput) == 0x10, "Size mismatch!");
