...
public:
  ...
  /// @brief Method Equals, addr 0x6b2d3a8, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Playables::MaterialEffectPlayable other);

  /// @brief Method GetHandle, addr 0x6b2d39c, size 0xc, virtual true, abstract: false, final true
