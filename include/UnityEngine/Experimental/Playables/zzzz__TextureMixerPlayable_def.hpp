...
public:
  ...
  /// @brief Method Equals, addr 0x6b2d430, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Experimental::Playables::TextureMixerPlayable other);

  /// @brief Method GetHandle, addr 0x6b2d424, size 0xc, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Experimental::Playables::TextureMixerPlayable) == 0x10, "Size mismatch!");
