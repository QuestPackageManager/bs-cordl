...
/// @brief Method Equals, addr 0x69d9954, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::TextureMixerPlayable  other) ;

/// @brief Method GetHandle, addr 0x69d9948, size 0xc, virtual true, abstract: false, final true
