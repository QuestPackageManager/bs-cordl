...
/// @brief Method Equals, addr 0x6965a84, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::CameraPlayable  other) ;

/// @brief Method GetHandle, addr 0x6965a78, size 0xc, virtual true, abstract: false, final true
