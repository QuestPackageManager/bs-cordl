...
public:
  // Declarations
  /// @brief Method get_debug, addr 0x2c8ba64, size 0x28, virtual false, abstract: false, final false
  static inline bool get_debug();

  /// @brief Method set_debug, addr 0x2c8ba8c, size 0x3c, virtual false, abstract: false, final false
  static inline void set_debug(bool value);

  /// @brief Method GetConstructorID, addr 0x2c8bac8, size 0x48, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass);

  /// @brief Method GetConstructorID, addr 0x2c8a34c, size 0x4, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2c8bb10, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName);

  /// @brief Method GetMethodID, addr 0x2c8bb6c, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2c86604, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetFieldID, addr 0x2c8bb74, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName);

  /// @brief Method GetFieldID, addr 0x2c8bbd8, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature);

  /// @brief Method GetFieldID, addr 0x2c8bbd0, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method CreateJavaRunnable, addr 0x2c89994, size 0x4, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method CreateJavaProxy, addr 0x2c86418, size 0xbc, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method ConvertToJNIArray, addr 0x2c8bbe0, size 0x4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x2c8750c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteJNIArgArray, addr 0x2c8bbe4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2c87510, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetMethodID, addr 0x2c87724, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2c8bbe8, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method GetSignature, addr 0x2c8bbec, size 0x4, virtual false, abstract: false, final false
