...
public:
  // Declarations
  /// @brief Method get_debug, addr 0x2c885d0, size 0x28, virtual false, abstract: false, final false
  static inline bool get_debug();

  /// @brief Method set_debug, addr 0x2c885f8, size 0x3c, virtual false, abstract: false, final false
  static inline void set_debug(bool value);

  /// @brief Method GetConstructorID, addr 0x2c88634, size 0x48, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass);

  /// @brief Method GetConstructorID, addr 0x2c86eb8, size 0x4, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2c8867c, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName);

  /// @brief Method GetMethodID, addr 0x2c886d8, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2c83170, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetFieldID, addr 0x2c886e0, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName);

  /// @brief Method GetFieldID, addr 0x2c88744, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature);

  /// @brief Method GetFieldID, addr 0x2c8873c, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method CreateJavaRunnable, addr 0x2c86500, size 0x4, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method CreateJavaProxy, addr 0x2c82f84, size 0xbc, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method ConvertToJNIArray, addr 0x2c8874c, size 0x4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x2c84078, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteJNIArgArray, addr 0x2c88750, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2c8407c, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetMethodID, addr 0x2c84290, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2c88754, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method GetSignature, addr 0x2c88758, size 0x4, virtual false, abstract: false, final false
