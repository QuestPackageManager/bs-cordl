...
public:
  ...
  /// @brief Method ConvertToJNIArray, addr 0x31b6e5c, size 0x4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x31b2788, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaProxy, addr 0x31b1694, size 0xbc, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x31b4c10, size 0x4, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x31b6e60, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x31b6d44, size 0x48, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass);

  /// @brief Method GetConstructorID, addr 0x31b55c8, size 0x4, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass, ::StringW signature);

  /// @brief Method GetConstructorID, addr 0x31b278c, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetFieldID, addr 0x31b6df0, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName);

  /// @brief Method GetFieldID, addr 0x31b6e54, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature);

  /// @brief Method GetFieldID, addr 0x31b6e4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x31b6d8c, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName);

  /// @brief Method GetMethodID, addr 0x31b6de8, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x31b1880, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x31b29a0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x31b6e68, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x31b6e64, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method get_debug, addr 0x31b6ce0, size 0x28, virtual false, abstract: false, final false
  static inline bool get_debug();

  /// @brief Method set_debug, addr 0x31b6d08, size 0x3c, virtual false, abstract: false, final false
