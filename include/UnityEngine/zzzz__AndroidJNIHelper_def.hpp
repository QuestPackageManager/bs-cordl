...
public:
  ...
  /// @brief Method ConvertToJNIArray, addr 0x31b9e58, size 0x4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x31b5784, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaProxy, addr 0x31b4690, size 0xbc, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x31b7c0c, size 0x4, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x31b9e5c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x31b9d40, size 0x48, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass);

  /// @brief Method GetConstructorID, addr 0x31b85c4, size 0x4, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* javaClass, ::StringW signature);

  /// @brief Method GetConstructorID, addr 0x31b5788, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetFieldID, addr 0x31b9dec, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName);

  /// @brief Method GetFieldID, addr 0x31b9e50, size 0x8, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* javaClass, ::StringW fieldName, ::StringW signature);

  /// @brief Method GetFieldID, addr 0x31b9e48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x31b9d88, size 0x5c, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName);

  /// @brief Method GetMethodID, addr 0x31b9de4, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x31b487c, size 0x8, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* javaClass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x31b599c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x31b9e64, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x31b9e60, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method get_debug, addr 0x31b9cdc, size 0x28, virtual false, abstract: false, final false
  static inline bool get_debug();

  /// @brief Method set_debug, addr 0x31b9d04, size 0x3c, virtual false, abstract: false, final false
