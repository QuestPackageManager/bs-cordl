...
/// @brief Method Destroy, addr 0x6a61428, size 0x78, virtual true, abstract: false, final true
inline void Destroy() ;
...
/// @brief Method .ctor, addr 0x6a61528, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
