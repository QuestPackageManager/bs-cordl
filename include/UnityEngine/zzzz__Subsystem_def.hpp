...
public:
  ...
  /// @brief Method Destroy, addr 0x6bb4f04, size 0x78, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method .ctor, addr 0x6bb5004, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
