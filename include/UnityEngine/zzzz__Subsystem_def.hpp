...
public:
  ...
  /// @brief Method Destroy, addr 0x34ad8d8, size 0x74, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method .ctor, addr 0x34ad94c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
