...
namespace UnityEngine::TextCore::LowLevel {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15726))]
...
public:
  ...
  /// @brief Method get_glyphIndex, addr 0x2d43528, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method get_glyphValueRecord, addr 0x2d43530, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphValueRecord get_glyphValueRecord();

  /// @brief Method GetHashCode, addr 0x2d4353c, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x2d435a8, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2d43628, size 0xa4, virtual true, abstract: false, final true
