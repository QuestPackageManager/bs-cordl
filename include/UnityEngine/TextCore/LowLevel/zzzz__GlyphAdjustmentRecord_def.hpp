...
public:
  ...
  /// @brief Method Equals, addr 0x6a678ec, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6a67964, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord other);

  /// @brief Method GetHashCode, addr 0x6a67880, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6a67870, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint32_t glyphIndex, ::UnityEngine::TextCore::LowLevel::GlyphValueRecord glyphValueRecord);

  /// @brief Method get_glyphIndex, addr 0x6a6785c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method get_glyphValueRecord, addr 0x6a67864, size 0xc, virtual false, abstract: false, final false
