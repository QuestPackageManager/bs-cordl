...
// Ctor Parameters [CppParam { name: "index", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "metrics", ty: "::UnityEngine::TextCore::GlyphMetrics", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "glyphRect", ty: "::UnityEngine::TextCore::GlyphRect", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "scale",
// ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "atlasIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "classDefinitionType", ty: "::UnityEngine::TextCore::GlyphClassDefinitionType", modifiers: "", def_value: Some("{}"), comment: None }]
