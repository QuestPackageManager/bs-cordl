...
namespace UnityEngine::TextCore::LowLevel {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15527)), TypeDefinitionIndex(TypeDefinitionIndex(15528)), TypeDefinitionIndex(TypeDefinitionIndex(15529))]
