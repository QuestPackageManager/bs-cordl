...
public:
  ...
  /// @brief Method InitializeFontEngine, addr 0x2d415f4, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::LowLevel::FontEngineError InitializeFontEngine();

  /// @brief Method InitializeFontEngine_Internal, addr 0x2d4165c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t InitializeFontEngine_Internal();

  /// @brief Method LoadFontFace, addr 0x2d41684, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_And_FaceIndex_Internal, addr 0x2d41710, size 0x54, virtual false, abstract: false, final false
  static inline int32_t LoadFontFace_With_Size_And_FaceIndex_Internal(::StringW filePath, int32_t pointSize, int32_t faceIndex);

  /// @brief Method LoadFontFace, addr 0x2d41764, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::LowLevel::FontEngineError LoadFontFace(::UnityEngine::Font* font, int32_t pointSize);

  /// @brief Method LoadFontFace_With_Size_FromFont_Internal, addr 0x2d417e8, size 0x44, virtual false, abstract: false, final false
  static inline int32_t LoadFontFace_With_Size_FromFont_Internal(::UnityEngine::Font* font, int32_t pointSize);

  /// @brief Method LoadFontFace, addr 0x2d4182c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_and_FaceIndex_FromFont_Internal, addr 0x2d418b8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x2d4190c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_by_FamilyName_and_StyleName_Internal, addr 0x2d41998, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference, addr 0x2d419ec, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference_Internal, addr 0x2d41a78, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFaceInfo, addr 0x2d41acc, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::FaceInfo GetFaceInfo();

  /// @brief Method GetFaceInfo_Internal, addr 0x2d41b6c, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetFaceInfo_Internal(ByRef<::UnityEngine::TextCore::FaceInfo> faceInfo);

  /// @brief Method GetGlyphIndex, addr 0x2d41ba8, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t GetGlyphIndex(uint32_t unicode);

  /// @brief Method TryGetGlyphWithUnicodeValue, addr 0x2d41be4, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithUnicodeValue_Internal, addr 0x2d41d38, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithIndexValue, addr 0x2d41d8c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithIndexValue_Internal, addr 0x2d41ee0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTextureUploadMode, addr 0x2d41f34, size 0x3c, virtual false, abstract: false, final false
  static inline void SetTextureUploadMode(bool shouldUploadImmediately);

  /// @brief Method TryAddGlyphToTexture, addr 0x2d41f70, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphToTexture_Internal, addr 0x2d424a0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture, addr 0x2d4253c, size 0x888, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture_Internal, addr 0x2d42de4, size 0xa8, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method GetGlyphPairAdjustmentTable, addr 0x2d42e8c, size 0x150, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord, ::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>
  GetGlyphPairAdjustmentTable(::ArrayW<uint32_t, ::Array<uint32_t>*> glyphIndexes);

  /// @brief Method GetGlyphPairAdjustmentRecords, addr 0x2d4305c, size 0x188, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord, ::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>
  GetGlyphPairAdjustmentRecords(::System::Collections::Generic::List_1<uint32_t>* glyphIndexes, ByRef<int32_t> recordCount);

  /// @brief Method PopulatePairAdjustmentRecordMarshallingArray_from_KernTable, addr 0x2d42fdc, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPairAdjustmentRecordsFromMarshallingArray, addr 0x2d43020, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAtlasTexture, addr 0x2d431e4, size 0x3c, virtual false, abstract: false, final false
