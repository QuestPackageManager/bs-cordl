...
public:
  ...
  /// @brief Method GetFaceInfo, addr 0x4921ba8, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::FaceInfo GetFaceInfo();

  /// @brief Method GetFaceInfo_Internal, addr 0x4921c48, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetFaceInfo_Internal(::ByRef<::UnityEngine::TextCore::FaceInfo> faceInfo);

  /// @brief Method GetGlyphIndex, addr 0x4921c84, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t GetGlyphIndex(uint32_t unicode);

  /// @brief Method GetGlyphPairAdjustmentRecords, addr 0x4923104, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGlyphPairAdjustmentTable, addr 0x4922f34, size 0x150, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord, ::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>
  GetGlyphPairAdjustmentTable(::ArrayW<uint32_t, ::Array<uint32_t>*> glyphIndexes);

  /// @brief Method GetPairAdjustmentRecordsFromMarshallingArray, addr 0x49230c8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeFontEngine, addr 0x49216d0, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::LowLevel::FontEngineError InitializeFontEngine();

  /// @brief Method InitializeFontEngine_Internal, addr 0x4921738, size 0x28, virtual false, abstract: false, final false
  static inline int32_t InitializeFontEngine_Internal();

  /// @brief Method LoadFontFace, addr 0x49219e8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x4921760, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace, addr 0x4921840, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::LowLevel::FontEngineError LoadFontFace(::UnityEngine::Font* font, int32_t pointSize);

  /// @brief Method LoadFontFace, addr 0x4921908, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_And_FaceIndex_Internal, addr 0x49217ec, size 0x54, virtual false, abstract: false, final false
  static inline int32_t LoadFontFace_With_Size_And_FaceIndex_Internal(::StringW filePath, int32_t pointSize, int32_t faceIndex);

  /// @brief Method LoadFontFace_With_Size_FromFont_Internal, addr 0x49218c4, size 0x44, virtual false, abstract: false, final false
  static inline int32_t LoadFontFace_With_Size_FromFont_Internal(::UnityEngine::Font* font, int32_t pointSize);

  /// @brief Method LoadFontFace_With_Size_and_FaceIndex_FromFont_Internal, addr 0x4921994, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFontFace_With_Size_by_FamilyName_and_StyleName_Internal, addr 0x4921a74, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulatePairAdjustmentRecordMarshallingArray_from_KernTable, addr 0x4923084, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAtlasTexture, addr 0x492328c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTextureUploadMode, addr 0x4921ff0, size 0x3c, virtual false, abstract: false, final false
  static inline void SetTextureUploadMode(bool shouldUploadImmediately);

  /// @brief Method TryAddGlyphToTexture, addr 0x492202c, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphToTexture_Internal, addr 0x4922540, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture, addr 0x49225dc, size 0x890, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphsToTexture_Internal, addr 0x4922e8c, size 0xa8, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method TryGetGlyphWithIndexValue, addr 0x4921e58, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithIndexValue_Internal, addr 0x4921f9c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithUnicodeValue, addr 0x4921cc0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetGlyphWithUnicodeValue_Internal, addr 0x4921e04, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference, addr 0x4921ac8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference_Internal, addr 0x4921b54, size 0x54, virtual false, abstract: false, final false
