...
public:
  ...
  /// @brief Method get_xCoordinate, addr 0x4926ccc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_xCoordinate();

  /// @brief Method get_yCoordinate, addr 0x4926cd4, size 0x8, virtual false, abstract: false, final false
