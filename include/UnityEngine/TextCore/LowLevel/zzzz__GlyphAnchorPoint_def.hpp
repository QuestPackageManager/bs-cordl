...
public:
  ...
  /// @brief Method get_xCoordinate, addr 0x492fcfc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_xCoordinate();

  /// @brief Method get_yCoordinate, addr 0x492fd04, size 0x8, virtual false, abstract: false, final false
