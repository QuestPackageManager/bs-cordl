...
public:
  ...
  /// @brief Method Equals, addr 0x6a67ad4, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6a67b4c, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord other);

  /// @brief Method GetHashCode, addr 0x6a67a68, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6a67a44, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_featureLookupFlags, addr 0x6a67a3c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::LowLevel::FontFeatureLookupFlags get_featureLookupFlags();

  /// @brief Method get_firstAdjustmentRecord, addr 0x6a67a00, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_firstAdjustmentRecord();

  /// @brief Method get_secondAdjustmentRecord, addr 0x6a67a28, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_firstAdjustmentRecord, addr 0x6a67a14, size 0x14, virtual false, abstract: false, final false
