...
namespace UnityEngine::TextCore::LowLevel {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15525)), TypeDefinitionIndex(TypeDefinitionIndex(15523))}
...
public:
  ...
  /// @brief Method get_firstAdjustmentRecord addr 0x2bbb874 size 0x14 virtual false final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_firstAdjustmentRecord();

  /// @brief Method get_secondAdjustmentRecord addr 0x2bbb888 size 0x14 virtual false final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_secondAdjustmentRecord();

  /// @brief Method GetHashCode addr 0x2bbb89c size 0x6c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x2bbb908 size 0x80 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2bbb988 size 0xa4 virtual true final true
