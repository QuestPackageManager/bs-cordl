...
public:
  ...
  /// @brief Method Equals, addr 0x6a67d40, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6a67cc8, size 0x18, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::LowLevel::LigatureSubstitutionRecord other);

  /// @brief Method GetHashCode, addr 0x6a67dc0, size 0x738, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_componentGlyphIDs, addr 0x6a67ca8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t, ::Array<uint32_t>*> get_componentGlyphIDs();

  /// @brief Method get_ligatureGlyphID, addr 0x6a67cb8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6a67ce0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_componentGlyphIDs, addr 0x6a67cb0, size 0x8, virtual false, abstract: false, final false
  inline void set_componentGlyphIDs(::ArrayW<uint32_t, ::Array<uint32_t>*> value);

  /// @brief Method set_ligatureGlyphID, addr 0x6a67cc0, size 0x8, virtual false, abstract: false, final false
