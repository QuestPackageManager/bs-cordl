...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::WhiteSpace, "UnityEngine.TextCore", "WhiteSpace");
// Dependencies
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::WhiteSpace) == 0x4, "Size mismatch!");
