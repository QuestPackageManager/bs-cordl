...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::HorizontalAlignment, "UnityEngine.TextCore", "HorizontalAlignment");
// Dependencies
namespace UnityEngine::TextCore {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::HorizontalAlignment) == 0x4, "Size mismatch!");
