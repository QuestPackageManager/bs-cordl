...
public:
  ...
  /// @brief Method .ctor, addr 0x6a6971c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_hasLink>b__20_0, addr 0x6a69720, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateTextSpan, addr 0x6a686a0, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::TextSpan CreateTextSpan();

  /// @brief Method ToString, addr 0x6a68710, size 0xb18, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Default, addr 0x6a686c4, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::NativeTextGenerationSettings get_Default();

  /// @brief Method get_hasLink, addr 0x6a68584, size 0x11c, virtual false, abstract: false, final false
