...
/// @brief Method .ctor, addr 0x69f74d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_hasLink>b__20_0, addr 0x69f74d8, size 0x10, virtual false, abstract: false, final false
...
// Dependencies System.IntPtr, UnityEngine.Color32, UnityEngine.TextCore.HorizontalAlignment, UnityEngine.TextCore.LanguageDirection, UnityEngine.TextCore.Text.FontStyles, UnityEngine.TextCore.Text.TextFontWeight, UnityEngine.TextCore.TextOverflow, UnityEngine.TextCore.VerticalAlignment, UnityEngine.TextCore.WhiteSpace
namespace UnityEngine::TextCore {
// Is value type: true
...
/// @brief Method CreateTextSpan, addr 0x69f6458, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::TextSpan CreateTextSpan() ;

/// @brief Method ToString, addr 0x69f64c8, size 0xb18, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_Default, addr 0x69f647c, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::NativeTextGenerationSettings get_Default() ;

/// @brief Method get_hasLink, addr 0x69f633c, size 0x11c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "fontAsset", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "globalFontAssetFallbacks", ty: "::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>", modifiers: "", def_value: None }, CppParam { name: "text", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "screenWidth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "screenHeight", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "wordWrap", ty: "::UnityEngine::TextCore::WhiteSpace", modifiers: "", def_value: None }, CppParam { name: "overflow", ty: "::UnityEngine::TextCore::TextOverflow", modifiers: "", def_value: None }, CppParam { name: "languageDirection", ty: "::UnityEngine::TextCore::LanguageDirection", modifiers: "", def_value: None }, CppParam { name: "vertexPadding", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "horizontalAlignment", ty: "::UnityEngine::TextCore::HorizontalAlignment", modifiers: "", def_value: None }, CppParam { name: "verticalAlignment", ty: "::UnityEngine::TextCore::VerticalAlignment", modifiers: "", def_value: None }, CppParam { name: "fontSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fontStyle", ty: "::UnityEngine::TextCore::Text::FontStyles", modifiers: "", def_value: None }, CppParam { name: "fontWeight", ty: "::UnityEngine::TextCore::Text::TextFontWeight", modifiers: "", def_value: None }, CppParam { name: "textSpans", ty: "::ArrayW<::UnityEngine::TextCore::TextSpan,::Array<::UnityEngine::TextCore::TextSpan>*>", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "characterSpacing", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "wordSpacing", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "paragraphSpacing", ty: "int32_t", modifiers: "", def_value: None }]
constexpr NativeTextGenerationSettings(::System::IntPtr  fontAsset, ::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>  globalFontAssetFallbacks, ::StringW  text, int32_t  screenWidth, int32_t  screenHeight, ::UnityEngine::TextCore::WhiteSpace  wordWrap, ::UnityEngine::TextCore::TextOverflow  overflow, ::UnityEngine::TextCore::LanguageDirection  languageDirection, int32_t  vertexPadding, ::UnityEngine::TextCore::HorizontalAlignment  horizontalAlignment, ::UnityEngine::TextCore::VerticalAlignment  verticalAlignment, int32_t  fontSize, ::UnityEngine::TextCore::Text::FontStyles  fontStyle, ::UnityEngine::TextCore::Text::TextFontWeight  fontWeight, ::ArrayW<::UnityEngine::TextCore::TextSpan,::Array<::UnityEngine::TextCore::TextSpan>*>  textSpans, ::UnityEngine::Color32  color, int32_t  characterSpacing, int32_t  wordSpacing, int32_t  paragraphSpacing) noexcept;
