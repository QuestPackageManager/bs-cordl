...
public:
  ...
  /// @brief Method .ctor, addr 0x4926d3c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4926d74, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(uint32_t unicode, ::UnityEngine::TextCore::Text::FontAsset* fontAsset, ::UnityEngine::TextCore::Glyph* glyph);

  /// @brief Method .ctor, addr 0x4926df4, size 0x40, virtual false, abstract: false, final false
