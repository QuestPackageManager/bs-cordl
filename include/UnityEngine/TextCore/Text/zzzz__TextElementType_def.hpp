...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextElementType, "UnityEngine.TextCore.Text", "TextElementType");
// Dependencies
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextElementType) == 0x1, "Size mismatch!");
