...
public:
  // Declarations
  /// @brief Method Create, addr 0x6ab40a0, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create();

  /// @brief Method Destroy, addr 0x6ab40c8, size 0x3c, virtual false, abstract: false, final false
