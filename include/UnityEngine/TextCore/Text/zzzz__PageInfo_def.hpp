...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::PageInfo, "UnityEngine.TextCore.Text", "PageInfo");
// Dependencies
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::PageInfo) == 0x14, "Size mismatch!");
