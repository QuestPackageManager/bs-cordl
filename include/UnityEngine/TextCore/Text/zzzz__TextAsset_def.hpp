...
public:
  ...
  /// @brief Method get_version, addr 0x2d691d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_version();

  /// @brief Method set_version, addr 0x2d691d8, size 0x8, virtual false, abstract: false, final false
  inline void set_version(::StringW value);

  /// @brief Method get_instanceID, addr 0x2d68dc8, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_instanceID();

  /// @brief Method get_hashCode, addr 0x2d68df0, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method set_hashCode, addr 0x2d691e0, size 0x8, virtual false, abstract: false, final false
  inline void set_hashCode(int32_t value);

  /// @brief Method get_material, addr 0x2d691e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method set_material, addr 0x2d691f0, size 0x8, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method get_materialHashCode, addr 0x2d691f8, size 0x98, virtual false, abstract: false, final false
  inline int32_t get_materialHashCode();

  /// @brief Method set_materialHashCode, addr 0x2d69290, size 0x8, virtual false, abstract: false, final false
  inline void set_materialHashCode(int32_t value);

  static inline ::UnityEngine::TextCore::Text::TextAsset* New_ctor();

  /// @brief Method .ctor, addr 0x2d69298, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
