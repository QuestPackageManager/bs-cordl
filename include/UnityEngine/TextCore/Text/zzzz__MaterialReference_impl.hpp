...
// Ctor Parameters [CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "fontAsset", ty: "::UnityEngine::TextCore::Text::FontAsset*", modifiers: "",
// def_value: Some("nullptr") }, CppParam { name: "spriteAsset", ty: "::UnityEngine::TextCore::Text::SpriteAsset*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "material", ty:
// "::UnityEngine::Material*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "isDefaultMaterial", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "isFallbackMaterial", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "fallbackMaterial", ty: "::UnityEngine::Material*", modifiers: "", def_value: Some("nullptr") }, CppParam
// { name: "padding", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "referenceCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::TextCore::Text::MaterialReference::MaterialReference(int32_t index, ::UnityEngine::TextCore::Text::FontAsset* fontAsset,
                                                                              ::UnityEngine::TextCore::Text::SpriteAsset* spriteAsset, ::UnityEngine::Material* material, bool isDefaultMaterial,
