...
/// @brief Method <InitThreadArrays>b__4_0, addr 0x6a45470, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextGenerationSettings* _InitThreadArrays_b__4_0() ;

/// @brief Method <InitThreadArrays>b__4_1, addr 0x6a454c8, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextGenerator* _InitThreadArrays_b__4_1() ;

/// @brief Method <InitThreadArrays>b__4_2, addr 0x6a45520, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextInfo* _InitThreadArrays_b__4_2() ;

/// @brief Method .ctor, addr 0x6a4546c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_generators>b__10_0, addr 0x6a457a8, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextGenerator* _get_generators_b__10_0() ;

/// @brief Method <get_settingsArray>b__7_0, addr 0x6a45750, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextGenerationSettings* _get_settingsArray_b__7_0() ;

/// @brief Method <get_textInfosCommon>b__13_0, addr 0x6a45800, size 0x58, virtual false, abstract: false, final false
...
/// @brief Field m_ActiveFontFeatures, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_ActiveFontFeatures, put=setStaticF_m_ActiveFontFeatures)) ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::OTL_FeatureTag>*  m_ActiveFontFeatures;
...
/// @brief Field s_Generators, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_Generators, put=setStaticF_s_Generators)) ::ArrayW<::UnityEngine::TextCore::Text::TextGenerator*,::Array<::UnityEngine::TextCore::Text::TextGenerator*>*>  s_Generators;
...
/// @brief Field s_Settings, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_Settings, put=setStaticF_s_Settings)) ::ArrayW<::UnityEngine::TextCore::Text::TextGenerationSettings*,::Array<::UnityEngine::TextCore::Text::TextGenerationSettings*>*>  s_Settings;
...
/// @brief Field s_TextInfosCommon, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_TextInfosCommon, put=setStaticF_s_TextInfosCommon)) ::ArrayW<::UnityEngine::TextCore::Text::TextInfo*,::Array<::UnityEngine::TextCore::Text::TextInfo*>*>  s_TextInfosCommon;
...
/// @brief Method AddTextInfoToPermanentCache, addr 0x6a433d0, size 0xd0, virtual true, abstract: false, final false
inline void AddTextInfoToPermanentCache() ;

/// @brief Method AddTextInfoToTemporaryCache, addr 0x6a434a0, size 0xa4, virtual false, abstract: false, final false
inline void AddTextInfoToTemporaryCache(int32_t  hashCode) ;

/// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x6a43e60, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method Finalize, addr 0x6a427b4, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FindIntersectingLink, addr 0x6a44230, size 0xfc, virtual false, abstract: false, final false
inline int32_t FindIntersectingLink(::UnityEngine::Vector3  position, bool  inverseYAxis) ;

/// @brief Method GetCharacterHeightFromIndex, addr 0x6a445fc, size 0x80, virtual false, abstract: false, final false
inline float_t GetCharacterHeightFromIndex(int32_t  index) ;

/// @brief Method GetCorrespondingStringIndex, addr 0x6a4432c, size 0x58, virtual false, abstract: false, final false
inline int32_t GetCorrespondingStringIndex(int32_t  index) ;

/// @brief Method GetCursorIndexFromPosition, addr 0x6a4407c, size 0xb4, virtual false, abstract: false, final false
inline int32_t GetCursorIndexFromPosition(::UnityEngine::Vector2  position, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingCharacterHeight, addr 0x6a43e8c, size 0x84, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 GetCursorPositionFromStringIndexUsingCharacterHeight(int32_t  index, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingLineHeight, addr 0x6a43f10, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method GetEndOfPreviousWord, addr 0x6a4496c, size 0xd8, virtual false, abstract: false, final false
inline int32_t GetEndOfPreviousWord(int32_t  currentIndex) ;

/// @brief Method GetFirstCharacterIndexOnLine, addr 0x6a44a44, size 0xd8, virtual false, abstract: false, final false
inline int32_t GetFirstCharacterIndexOnLine(int32_t  currentIndex) ;

/// @brief Method GetHighlightRectangles, addr 0x6a43fa4, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Rect,::Array<::UnityEngine::Rect>*> GetHighlightRectangles(int32_t  cursorIndex, int32_t  selectIndex) ;

/// @brief Method GetLastCharacterIndexOnLine, addr 0x6a44b1c, size 0xd8, virtual false, abstract: false, final false
inline int32_t GetLastCharacterIndexOnLine(int32_t  currentIndex) ;

/// @brief Method GetLineHeight, addr 0x6a444fc, size 0x80, virtual false, abstract: false, final false
inline float_t GetLineHeight(int32_t  lineNumber) ;

/// @brief Method GetLineHeightDefault, addr 0x6a43958, size 0xa0, virtual false, abstract: false, final false
static inline float_t GetLineHeightDefault(::UnityEngine::TextCore::Text::TextGenerationSettings*  settings) ;

/// @brief Method GetLineHeightFromCharacterIndex, addr 0x6a4457c, size 0x80, virtual false, abstract: false, final false
inline float_t GetLineHeightFromCharacterIndex(int32_t  index) ;

/// @brief Method GetLineInfoFromCharacterIndex, addr 0x6a44384, size 0xf8, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::LineInfo GetLineInfoFromCharacterIndex(int32_t  index) ;

/// @brief Method GetLineNumber, addr 0x6a4447c, size 0x80, virtual false, abstract: false, final false
inline int32_t GetLineNumber(int32_t  index) ;

/// @brief Method GetStartOfNextWord, addr 0x6a44894, size 0xd8, virtual false, abstract: false, final false
inline int32_t GetStartOfNextWord(int32_t  currentIndex) ;

/// @brief Method IndexOf, addr 0x6a44bf4, size 0xcc, virtual false, abstract: false, final false
...
template<typename T>
static inline void InitArray(::ByRef<::ArrayW<T,::Array<T>*>>  array, ::System::Func_1<T>*  createInstance) ;

/// @brief Method InitThreadArrays, addr 0x6a42928, size 0x34c, virtual false, abstract: false, final false
static inline void InitThreadArrays() ;

/// @brief Method IsAdvancedTextEnabledForElement, addr 0x6a45290, size 0x8, virtual true, abstract: false, final false
inline bool IsAdvancedTextEnabledForElement() ;

/// @brief Method IsDirty, addr 0x6a435d8, size 0x3c, virtual false, abstract: false, final false
inline bool IsDirty(int32_t  hashCode) ;

/// @brief Method IsElided, addr 0x6a4361c, size 0x44, virtual false, abstract: false, final false
inline bool IsElided() ;

/// @brief Method LastIndexOf, addr 0x6a44cc0, size 0xcc, virtual false, abstract: false, final false
inline int32_t LastIndexOf(char16_t  value, int32_t  startIndex) ;

/// @brief Method LineDownCharacterPosition, addr 0x6a44130, size 0x80, virtual false, abstract: false, final false
inline int32_t LineDownCharacterPosition(int32_t  originalLogicalPos) ;

/// @brief Method LineUpCharacterPosition, addr 0x6a441b0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method NextCodePointIndex, addr 0x6a447bc, size 0xd8, virtual false, abstract: false, final false
inline int32_t NextCodePointIndex(int32_t  currentIndex) ;

/// @brief Method PrepareFontAsset, addr 0x6a439f8, size 0x130, virtual false, abstract: false, final false
inline bool PrepareFontAsset() ;

/// @brief Method PreviousCodePointIndex, addr 0x6a446e4, size 0xd8, virtual false, abstract: false, final false
inline int32_t PreviousCodePointIndex(int32_t  currentIndex) ;

/// @brief Method RemoveTextInfoFromPermanentCache, addr 0x6a42878, size 0xb0, virtual false, abstract: false, final false
inline void RemoveTextInfoFromPermanentCache() ;

/// @brief Method RemoveTextInfoFromTemporaryCache, addr 0x6a42804, size 0x74, virtual false, abstract: false, final false
inline void RemoveTextInfoFromTemporaryCache() ;

/// @brief Method SelectCurrentParagraph, addr 0x6a44e78, size 0xd8, virtual false, abstract: false, final false
inline void SelectCurrentParagraph(::ByRef<int32_t>  cursorIndex, ::ByRef<int32_t>  selectIndex) ;

/// @brief Method SelectCurrentWord, addr 0x6a44d8c, size 0xec, virtual false, abstract: false, final false
inline void SelectCurrentWord(int32_t  index, ::ByRef<int32_t>  cursorIndex, ::ByRef<int32_t>  selectIndex) ;

/// @brief Method SelectToEndOfParagraph, addr 0x6a451c0, size 0xd0, virtual false, abstract: false, final false
inline void SelectToEndOfParagraph(::ByRef<int32_t>  cursorIndex) ;

/// @brief Method SelectToNextParagraph, addr 0x6a45020, size 0xd0, virtual false, abstract: false, final false
inline void SelectToNextParagraph(::ByRef<int32_t>  cursorIndex) ;

/// @brief Method SelectToPreviousParagraph, addr 0x6a44f50, size 0xd0, virtual false, abstract: false, final false
inline void SelectToPreviousParagraph(::ByRef<int32_t>  cursorIndex) ;

/// @brief Method SelectToStartOfParagraph, addr 0x6a450f0, size 0xd0, virtual false, abstract: false, final false
inline void SelectToStartOfParagraph(::ByRef<int32_t>  cursorIndex) ;

/// @brief Method SetDirty, addr 0x6a435cc, size 0xc, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method Substring, addr 0x6a4467c, size 0x68, virtual false, abstract: false, final false
inline ::StringW Substring(int32_t  startIndex, int32_t  length) ;

/// @brief Method Update, addr 0x6a436ec, size 0x74, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextInfo* Update() ;

/// @brief Method UpdateCurrentFrame, addr 0x6a43544, size 0x88, virtual false, abstract: false, final false
static inline void UpdateCurrentFrame() ;

/// @brief Method UpdatePreferredSize, addr 0x6a43b28, size 0x338, virtual false, abstract: false, final false
inline void UpdatePreferredSize() ;

/// @brief Method UpdatePreferredValues, addr 0x6a43660, size 0x8c, virtual false, abstract: false, final false
inline void UpdatePreferredValues(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method UpdateWithHash, addr 0x6a43760, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a42764, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_IsCachedPermanent, addr 0x6a432dc, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCachedPermanent() ;

/// @brief Method get_IsCachedTemporary, addr 0x6a432ec, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCachedTemporary() ;

/// @brief Method get_IsPlaceholder, addr 0x6a43614, size 0x8, virtual true, abstract: false, final false
inline bool get_IsPlaceholder() ;

/// @brief Method get_TextInfoNode, addr 0x6a432cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::LinkedListNode_1<::UnityEngine::TextCore::Text::TextInfo*>* get_TextInfoNode() ;

/// @brief Method get_characterCount, addr 0x6a43308, size 0x48, virtual false, abstract: false, final false
inline int32_t get_characterCount() ;

/// @brief Method get_generator, addr 0x6a43184, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::Text::TextGenerator* get_generator() ;

/// @brief Method get_generators, addr 0x6a42df0, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method get_preferredSize, addr 0x6a432bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_preferredSize() ;

/// @brief Method get_settings, addr 0x6a43220, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::Text::TextGenerationSettings* get_settings() ;

/// @brief Method get_settingsArray, addr 0x6a42c74, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method get_textInfo, addr 0x6a43350, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfo() ;

/// @brief Method get_textInfoCommon, addr 0x6a430e8, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfoCommon() ;

/// @brief Method get_textInfosCommon, addr 0x6a42f6c, size 0x17c, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::TextCore::Text::TextInfo*,::Array<::UnityEngine::TextCore::Text::TextInfo*>*> get_textInfosCommon() ;

/// @brief Method get_useAdvancedText, addr 0x6a432fc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_IsCachedPermanent, addr 0x6a432e4, size 0x8, virtual false, abstract: false, final false
inline void set_IsCachedPermanent(bool  value) ;

/// @brief Method set_IsCachedTemporary, addr 0x6a432f4, size 0x8, virtual false, abstract: false, final false
inline void set_IsCachedTemporary(bool  value) ;

/// @brief Method set_TextInfoNode, addr 0x6a432d4, size 0x8, virtual false, abstract: false, final false
inline void set_TextInfoNode(::System::Collections::Generic::LinkedListNode_1<::UnityEngine::TextCore::Text::TextInfo*>*  value) ;

/// @brief Method set_preferredSize, addr 0x6a432c4, size 0x8, virtual false, abstract: false, final false
