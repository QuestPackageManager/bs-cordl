...
public:
  ...
  /// @brief Method <InitThreadArrays>b__4_0, addr 0x6c0d0e8, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextGenerationSettings* _InitThreadArrays_b__4_0();

  /// @brief Method <InitThreadArrays>b__4_1, addr 0x6c0d140, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextGenerator* _InitThreadArrays_b__4_1();

  /// @brief Method <InitThreadArrays>b__4_2, addr 0x6c0d198, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextInfo* _InitThreadArrays_b__4_2();

  /// @brief Method .ctor, addr 0x6c0d0e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_generators>b__10_0, addr 0x6c0d420, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextGenerator* _get_generators_b__10_0();

  /// @brief Method <get_settingsArray>b__7_0, addr 0x6c0d3c8, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextGenerationSettings* _get_settingsArray_b__7_0();

  /// @brief Method <get_textInfosCommon>b__13_0, addr 0x6c0d478, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddTextInfoToPermanentCache, addr 0x6c0b048, size 0xd0, virtual true, abstract: false, final false
  inline void AddTextInfoToPermanentCache();

  /// @brief Method AddTextInfoToTemporaryCache, addr 0x6c0b118, size 0xa4, virtual false, abstract: false, final false
  inline void AddTextInfoToTemporaryCache(int32_t hashCode);

  /// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x6c0bad8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x6c0a42c, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method FindIntersectingLink, addr 0x6c0bea8, size 0xfc, virtual false, abstract: false, final false
  inline int32_t FindIntersectingLink(::UnityEngine::Vector3 position, bool inverseYAxis);

  /// @brief Method GetCharacterHeightFromIndex, addr 0x6c0c274, size 0x80, virtual false, abstract: false, final false
  inline float_t GetCharacterHeightFromIndex(int32_t index);

  /// @brief Method GetCorrespondingStringIndex, addr 0x6c0bfa4, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetCorrespondingStringIndex(int32_t index);

  /// @brief Method GetCursorIndexFromPosition, addr 0x6c0bcf4, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetCursorIndexFromPosition(::UnityEngine::Vector2 position, bool inverseYAxis);

  /// @brief Method GetCursorPositionFromStringIndexUsingCharacterHeight, addr 0x6c0bb04, size 0x84, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 GetCursorPositionFromStringIndexUsingCharacterHeight(int32_t index, bool inverseYAxis);

  /// @brief Method GetCursorPositionFromStringIndexUsingLineHeight, addr 0x6c0bb88, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEndOfPreviousWord, addr 0x6c0c5e4, size 0xd8, virtual false, abstract: false, final false
  inline int32_t GetEndOfPreviousWord(int32_t currentIndex);

  /// @brief Method GetFirstCharacterIndexOnLine, addr 0x6c0c6bc, size 0xd8, virtual false, abstract: false, final false
  inline int32_t GetFirstCharacterIndexOnLine(int32_t currentIndex);

  /// @brief Method GetHighlightRectangles, addr 0x6c0bc1c, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Rect> GetHighlightRectangles(int32_t cursorIndex, int32_t selectIndex);

  /// @brief Method GetLastCharacterIndexOnLine, addr 0x6c0c794, size 0xd8, virtual false, abstract: false, final false
  inline int32_t GetLastCharacterIndexOnLine(int32_t currentIndex);

  /// @brief Method GetLineHeight, addr 0x6c0c174, size 0x80, virtual false, abstract: false, final false
  inline float_t GetLineHeight(int32_t lineNumber);

  /// @brief Method GetLineHeightDefault, addr 0x6c0b5d0, size 0xa0, virtual false, abstract: false, final false
  static inline float_t GetLineHeightDefault(::UnityEngine::TextCore::Text::TextGenerationSettings* settings);

  /// @brief Method GetLineHeightFromCharacterIndex, addr 0x6c0c1f4, size 0x80, virtual false, abstract: false, final false
  inline float_t GetLineHeightFromCharacterIndex(int32_t index);

  /// @brief Method GetLineInfoFromCharacterIndex, addr 0x6c0bffc, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::LineInfo GetLineInfoFromCharacterIndex(int32_t index);

  /// @brief Method GetLineNumber, addr 0x6c0c0f4, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetLineNumber(int32_t index);

  /// @brief Method GetStartOfNextWord, addr 0x6c0c50c, size 0xd8, virtual false, abstract: false, final false
  inline int32_t GetStartOfNextWord(int32_t currentIndex);

  /// @brief Method IndexOf, addr 0x6c0c86c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method InitThreadArrays, addr 0x6c0a5a0, size 0x34c, virtual false, abstract: false, final false
  static inline void InitThreadArrays();

  /// @brief Method IsAdvancedTextEnabledForElement, addr 0x6c0cf08, size 0x8, virtual true, abstract: false, final false
  inline bool IsAdvancedTextEnabledForElement();

  /// @brief Method IsDirty, addr 0x6c0b250, size 0x3c, virtual false, abstract: false, final false
  inline bool IsDirty(int32_t hashCode);

  /// @brief Method IsElided, addr 0x6c0b294, size 0x44, virtual false, abstract: false, final false
  inline bool IsElided();

  /// @brief Method LastIndexOf, addr 0x6c0c938, size 0xcc, virtual false, abstract: false, final false
  inline int32_t LastIndexOf(char16_t value, int32_t startIndex);

  /// @brief Method LineDownCharacterPosition, addr 0x6c0bda8, size 0x80, virtual false, abstract: false, final false
  inline int32_t LineDownCharacterPosition(int32_t originalLogicalPos);

  /// @brief Method LineUpCharacterPosition, addr 0x6c0be28, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method NextCodePointIndex, addr 0x6c0c434, size 0xd8, virtual false, abstract: false, final false
  inline int32_t NextCodePointIndex(int32_t currentIndex);

  /// @brief Method PrepareFontAsset, addr 0x6c0b670, size 0x130, virtual false, abstract: false, final false
  inline bool PrepareFontAsset();

  /// @brief Method PreviousCodePointIndex, addr 0x6c0c35c, size 0xd8, virtual false, abstract: false, final false
  inline int32_t PreviousCodePointIndex(int32_t currentIndex);

  /// @brief Method RemoveTextInfoFromPermanentCache, addr 0x6c0a4f0, size 0xb0, virtual false, abstract: false, final false
  inline void RemoveTextInfoFromPermanentCache();

  /// @brief Method RemoveTextInfoFromTemporaryCache, addr 0x6c0a47c, size 0x74, virtual false, abstract: false, final false
  inline void RemoveTextInfoFromTemporaryCache();

  /// @brief Method SelectCurrentParagraph, addr 0x6c0caf0, size 0xd8, virtual false, abstract: false, final false
  inline void SelectCurrentParagraph(::by_ref<int32_t> cursorIndex, ::by_ref<int32_t> selectIndex);

  /// @brief Method SelectCurrentWord, addr 0x6c0ca04, size 0xec, virtual false, abstract: false, final false
  inline void SelectCurrentWord(int32_t index, ::by_ref<int32_t> cursorIndex, ::by_ref<int32_t> selectIndex);

  /// @brief Method SelectToEndOfParagraph, addr 0x6c0ce38, size 0xd0, virtual false, abstract: false, final false
  inline void SelectToEndOfParagraph(::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToNextParagraph, addr 0x6c0cc98, size 0xd0, virtual false, abstract: false, final false
  inline void SelectToNextParagraph(::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToPreviousParagraph, addr 0x6c0cbc8, size 0xd0, virtual false, abstract: false, final false
  inline void SelectToPreviousParagraph(::by_ref<int32_t> cursorIndex);

  /// @brief Method SelectToStartOfParagraph, addr 0x6c0cd68, size 0xd0, virtual false, abstract: false, final false
  inline void SelectToStartOfParagraph(::by_ref<int32_t> cursorIndex);

  /// @brief Method SetDirty, addr 0x6c0b244, size 0xc, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method Substring, addr 0x6c0c2f4, size 0x68, virtual false, abstract: false, final false
  inline ::StringW Substring(int32_t startIndex, int32_t length);

  /// @brief Method Update, addr 0x6c0b364, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextInfo* Update();

  /// @brief Method UpdateCurrentFrame, addr 0x6c0b1bc, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateCurrentFrame();

  /// @brief Method UpdatePreferredSize, addr 0x6c0b7a0, size 0x338, virtual false, abstract: false, final false
  inline void UpdatePreferredSize();

  /// @brief Method UpdatePreferredValues, addr 0x6c0b2d8, size 0x8c, virtual false, abstract: false, final false
  inline void UpdatePreferredValues(::UnityEngine::TextCore::Text::TextGenerationSettings* tgs);

  /// @brief Method UpdateWithHash, addr 0x6c0b3d8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0a3dc, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsCachedPermanent, addr 0x6c0af54, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCachedPermanent();

  /// @brief Method get_IsCachedTemporary, addr 0x6c0af64, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCachedTemporary();

  /// @brief Method get_IsPlaceholder, addr 0x6c0b28c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsPlaceholder();

  /// @brief Method get_TextInfoNode, addr 0x6c0af44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::LinkedListNode_1<::UnityEngine::TextCore::Text::TextInfo*>* get_TextInfoNode();

  /// @brief Method get_characterCount, addr 0x6c0af80, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_characterCount();

  /// @brief Method get_generator, addr 0x6c0adfc, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextGenerator* get_generator();

  /// @brief Method get_generators, addr 0x6c0aa68, size 0x17c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::Text::TextGenerator*> get_generators();

  /// @brief Method get_preferredSize, addr 0x6c0af34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_preferredSize();

  /// @brief Method get_settings, addr 0x6c0ae98, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextGenerationSettings* get_settings();

  /// @brief Method get_settingsArray, addr 0x6c0a8ec, size 0x17c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::Text::TextGenerationSettings*> get_settingsArray();

  /// @brief Method get_textInfo, addr 0x6c0afc8, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfo();

  /// @brief Method get_textInfoCommon, addr 0x6c0ad60, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfoCommon();

  /// @brief Method get_textInfosCommon, addr 0x6c0abe4, size 0x17c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::TextCore::Text::TextInfo*> get_textInfosCommon();

  /// @brief Method get_useAdvancedText, addr 0x6c0af74, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsCachedPermanent, addr 0x6c0af5c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsCachedPermanent(bool value);

  /// @brief Method set_IsCachedTemporary, addr 0x6c0af6c, size 0x8, virtual false, abstract: false, final false
  inline void set_IsCachedTemporary(bool value);

  /// @brief Method set_TextInfoNode, addr 0x6c0af4c, size 0x8, virtual false, abstract: false, final false
  inline void set_TextInfoNode(::System::Collections::Generic::LinkedListNode_1<::UnityEngine::TextCore::Text::TextInfo*>* value);

  /// @brief Method set_preferredSize, addr 0x6c0af3c, size 0x8, virtual false, abstract: false, final false
