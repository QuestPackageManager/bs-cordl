...
public:
  ...
  /// @brief Method AdjustLineOffset, addr 0x6ab2cfc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Approximately, addr 0x6aaedd8, size 0x28, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method ConvertToFloat, addr 0x6aaf248, size 0x80, virtual false, abstract: false, final false
  static inline float_t ConvertToFloat(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startIndex, int32_t length);

  /// @brief Method ConvertToFloat, addr 0x6aaf2c8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToUTF32, addr 0x6ab30b0, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t ConvertToUTF32(uint32_t highSurrogate, uint32_t lowSurrogate);

  /// @brief Method FillCharacterVertexBuffers, addr 0x6ab0900, size 0x1228, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSpriteVertexBuffers, addr 0x6ab1bc0, size 0x113c, virtual false, abstract: false, final false
  ...
  /// @brief Method GammaToLinear, addr 0x6ab1b28, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 GammaToLinear(::UnityEngine::Color32 c);

  /// @brief Method GammaToLinear, addr 0x6ab3560, size 0xa0, virtual false, abstract: false, final false
  static inline uint8_t GammaToLinear(uint8_t value);

  /// @brief Method GetAttributeParameters, addr 0x6ab32b8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHorizontalAlignment, addr 0x6ab3068, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::HorizontalAlignment GetHorizontalAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method GetMarkupTagHashCode, addr 0x6ab05ac, size 0x104, virtual false, abstract: false, final false
  static inline int32_t GetMarkupTagHashCode(::ArrayW<uint32_t, ::Array<uint32_t>*> styleDefinition, int32_t readIndex);

  /// @brief Method GetMarkupTagHashCode, addr 0x6ab30c4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyle, addr 0x6aafd18, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleHashCode, addr 0x6aaff60, size 0xd4, virtual false, abstract: false, final false
  static inline int32_t GetStyleHashCode(::ByRef<::ArrayW<uint32_t, ::Array<uint32_t>*>> text, int32_t index, ::ByRef<int32_t> closeIndex);

  /// @brief Method GetStyleHashCode, addr 0x6aafc28, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUTF16, addr 0x6ab033c, size 0xec, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF16, addr 0x6ab0730, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method GetUTF32, addr 0x6ab0428, size 0x184, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF32, addr 0x6ab07f0, size 0x110, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method GetVerticalAlignment, addr 0x6ab308c, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::VerticalAlignment GetVerticalAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method HexCharsToColor, addr 0x6aaee00, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method HexToInt, addr 0x6aaf21c, size 0x2c, virtual false, abstract: false, final false
  static inline uint32_t HexToInt(char16_t hex);

  /// @brief Method InsertClosingStyleTag, addr 0x6ab0250, size 0xec, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertClosingTextStyle, addr 0x6aaf9c0, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningStyleTag, addr 0x6ab0168, size 0xe8, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningTextStyle, addr 0x6aaf424, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertTextStyleInTextProcessingArray, addr 0x6aaf52c, size 0x494, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBaseGlyph, addr 0x6ab33d4, size 0x180, virtual false, abstract: false, final false
  static inline bool IsBaseGlyph(uint32_t c);

  /// @brief Method IsBitmapRendering, addr 0x6ab33a0, size 0x34, virtual false, abstract: false, final false
  static inline bool IsBitmapRendering(::UnityEngine::TextCore::LowLevel::GlyphRenderMode glyphRenderMode);

  /// @brief Method IsCJK, addr 0x6ab38dc, size 0x154, virtual false, abstract: false, final false
  static inline bool IsCJK(uint32_t c);

  /// @brief Method IsEmoji, addr 0x6ab3738, size 0x88, virtual false, abstract: false, final false
  static inline bool IsEmoji(uint32_t c);

  /// @brief Method IsEmojiPresentationForm, addr 0x6ab37c0, size 0x88, virtual false, abstract: false, final false
  static inline bool IsEmojiPresentationForm(uint32_t c);

  /// @brief Method IsHangul, addr 0x6ab3848, size 0x94, virtual false, abstract: false, final false
  static inline bool IsHangul(uint32_t c);

  /// @brief Method IsValidUTF16, addr 0x6ab3600, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method IsValidUTF32, addr 0x6ab369c, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method LegacyAlignmentToNewAlignment, addr 0x6ab3044, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextAlignment LegacyAlignmentToNewAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method LegacyStyleToNewStyle, addr 0x6ab3034, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::FontStyles LegacyStyleToNewStyle(::UnityEngine::FontStyle fontStyle);

  /// @brief Method MinAlpha, addr 0x6ab3554, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color MinAlpha(::UnityEngine::Color c1, ::UnityEngine::Color c2);

  /// @brief Method ReplaceClosingStyleTag, addr 0x6ab0034, size 0x134, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x6aafe00, size 0x160, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x6aafac8, size 0x160, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ResizeLineExtents, addr 0x6ab2e80, size 0x1b4, virtual false, abstract: false, final false
  static inline void ResizeLineExtents(int32_t size, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method ToUpperASCIIFast, addr 0x6ab06b0, size 0x80, virtual false, abstract: false, final false
  static inline char16_t ToUpperASCIIFast(char16_t c);

  /// @brief Method ToUpperASCIIFast, addr 0x6ab31b8, size 0x80, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x6ab3238, size 0x80, virtual false, abstract: false, final false
