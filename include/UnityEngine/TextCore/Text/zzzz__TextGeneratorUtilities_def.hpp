...
public:
  ...
  /// @brief Method AdjustLineOffset, addr 0x69d7570, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Approximately, addr 0x69d364c, size 0x28, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method ConvertToFloat, addr 0x69d3abc, size 0x80, virtual false, abstract: false, final false
  static inline float_t ConvertToFloat(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startIndex, int32_t length);

  /// @brief Method ConvertToFloat, addr 0x69d3b3c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToUTF32, addr 0x69d7924, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t ConvertToUTF32(uint32_t highSurrogate, uint32_t lowSurrogate);

  /// @brief Method FillCharacterVertexBuffers, addr 0x69d5174, size 0x1228, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSpriteVertexBuffers, addr 0x69d6434, size 0x113c, virtual false, abstract: false, final false
  ...
  /// @brief Method GammaToLinear, addr 0x69d639c, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 GammaToLinear(::UnityEngine::Color32 c);

  /// @brief Method GammaToLinear, addr 0x69d7dd4, size 0xa0, virtual false, abstract: false, final false
  static inline uint8_t GammaToLinear(uint8_t value);

  /// @brief Method GetAttributeParameters, addr 0x69d7b2c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHorizontalAlignment, addr 0x69d78dc, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::HorizontalAlignment GetHorizontalAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method GetMarkupTagHashCode, addr 0x69d4e20, size 0x104, virtual false, abstract: false, final false
  static inline int32_t GetMarkupTagHashCode(::ArrayW<uint32_t, ::Array<uint32_t>*> styleDefinition, int32_t readIndex);

  /// @brief Method GetMarkupTagHashCode, addr 0x69d7938, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyle, addr 0x69d458c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleHashCode, addr 0x69d47d4, size 0xd4, virtual false, abstract: false, final false
  static inline int32_t GetStyleHashCode(::ByRef<::ArrayW<uint32_t, ::Array<uint32_t>*>> text, int32_t index, ::ByRef<int32_t> closeIndex);

  /// @brief Method GetStyleHashCode, addr 0x69d449c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUTF16, addr 0x69d4bb0, size 0xec, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF16, addr 0x69d4fa4, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method GetUTF32, addr 0x69d4c9c, size 0x184, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF32, addr 0x69d5064, size 0x110, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method GetVerticalAlignment, addr 0x69d7900, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::VerticalAlignment GetVerticalAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method HexCharsToColor, addr 0x69d3674, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method HexToInt, addr 0x69d3a90, size 0x2c, virtual false, abstract: false, final false
  static inline uint32_t HexToInt(char16_t hex);

  /// @brief Method InsertClosingStyleTag, addr 0x69d4ac4, size 0xec, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertClosingTextStyle, addr 0x69d4234, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningStyleTag, addr 0x69d49dc, size 0xe8, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningTextStyle, addr 0x69d3c98, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertTextStyleInTextProcessingArray, addr 0x69d3da0, size 0x494, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBaseGlyph, addr 0x69d7c48, size 0x180, virtual false, abstract: false, final false
  static inline bool IsBaseGlyph(uint32_t c);

  /// @brief Method IsBitmapRendering, addr 0x69d7c14, size 0x34, virtual false, abstract: false, final false
  static inline bool IsBitmapRendering(::UnityEngine::TextCore::LowLevel::GlyphRenderMode glyphRenderMode);

  /// @brief Method IsCJK, addr 0x69d8150, size 0x154, virtual false, abstract: false, final false
  static inline bool IsCJK(uint32_t c);

  /// @brief Method IsEmoji, addr 0x69d7fac, size 0x88, virtual false, abstract: false, final false
  static inline bool IsEmoji(uint32_t c);

  /// @brief Method IsEmojiPresentationForm, addr 0x69d8034, size 0x88, virtual false, abstract: false, final false
  static inline bool IsEmojiPresentationForm(uint32_t c);

  /// @brief Method IsHangul, addr 0x69d80bc, size 0x94, virtual false, abstract: false, final false
  static inline bool IsHangul(uint32_t c);

  /// @brief Method IsValidUTF16, addr 0x69d7e74, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method IsValidUTF32, addr 0x69d7f10, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method LegacyAlignmentToNewAlignment, addr 0x69d78b8, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextAlignment LegacyAlignmentToNewAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method LegacyStyleToNewStyle, addr 0x69d78a8, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::FontStyles LegacyStyleToNewStyle(::UnityEngine::FontStyle fontStyle);

  /// @brief Method MinAlpha, addr 0x69d7dc8, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color MinAlpha(::UnityEngine::Color c1, ::UnityEngine::Color c2);

  /// @brief Method ReplaceClosingStyleTag, addr 0x69d48a8, size 0x134, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x69d4674, size 0x160, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x69d433c, size 0x160, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ResizeLineExtents, addr 0x69d76f4, size 0x1b4, virtual false, abstract: false, final false
  static inline void ResizeLineExtents(int32_t size, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method ToUpperASCIIFast, addr 0x69d4f24, size 0x80, virtual false, abstract: false, final false
  static inline char16_t ToUpperASCIIFast(char16_t c);

  /// @brief Method ToUpperASCIIFast, addr 0x69d7a2c, size 0x80, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x69d7aac, size 0x80, virtual false, abstract: false, final false
