...
public:
  ...
  /// @brief Method AdjustLineOffset, addr 0x494e424, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Approximately, addr 0x494b0fc, size 0x30, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method ConvertToFloat, addr 0x494b9ec, size 0x80, virtual false, abstract: false, final false
  static inline float_t ConvertToFloat(::ArrayW<char16_t, ::Array<char16_t>*> chars, int32_t startIndex, int32_t length);

  /// @brief Method ConvertToFloat, addr 0x494ba6c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToUTF32, addr 0x494e784, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t ConvertToUTF32(uint32_t highSurrogate, uint32_t lowSurrogate);

  /// @brief Method FillCharacterVertexBuffers, addr 0x494d14c, size 0x99c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSpriteVertexBuffers, addr 0x494db84, size 0x8a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GammaToLinear, addr 0x494dae8, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 GammaToLinear(::UnityEngine::Color32 c);

  /// @brief Method GammaToLinear, addr 0x494ebdc, size 0xb0, virtual false, abstract: false, final false
  static inline uint8_t GammaToLinear(uint8_t value);

  /// @brief Method GetAttributeParameters, addr 0x494e984, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMarkupTagHashCode, addr 0x494cd70, size 0x118, virtual false, abstract: false, final false
  static inline int32_t GetMarkupTagHashCode(::ArrayW<uint32_t, ::Array<uint32_t>*> styleDefinition, int32_t readIndex);

  /// @brief Method GetMarkupTagHashCode, addr 0x494e798, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyle, addr 0x494c50c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleHashCode, addr 0x494c748, size 0xd8, virtual false, abstract: false, final false
  static inline int32_t GetStyleHashCode(::ByRef<::ArrayW<uint32_t, ::Array<uint32_t>*>> text, int32_t index, ::ByRef<int32_t> closeIndex);

  /// @brief Method GetStyleHashCode, addr 0x494c420, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUTF16, addr 0x494cb08, size 0xe8, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF16, addr 0x494cf84, size 0xbc, virtual false, abstract: false, final false
  static inline uint32_t GetUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method GetUTF32, addr 0x494cbf0, size 0x180, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::ArrayW<uint32_t, ::Array<uint32_t>*> text, int32_t i);

  /// @brief Method GetUTF32, addr 0x494d040, size 0x10c, virtual false, abstract: false, final false
  static inline uint32_t GetUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t i);

  /// @brief Method HexCharsToColor, addr 0x494b760, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method HexCharsToColor, addr 0x494b12c, size 0x608, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 HexCharsToColor(::ArrayW<char16_t, ::Array<char16_t>*> hexChars, int32_t tagCount);

  /// @brief Method HexToInt, addr 0x494b734, size 0x2c, virtual false, abstract: false, final false
  static inline uint32_t HexToInt(char16_t hex);

  /// @brief Method InsertClosingStyleTag, addr 0x494ca24, size 0xe4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertClosingTextStyle, addr 0x494c1c8, size 0xf8, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningStyleTag, addr 0x494c94c, size 0xd8, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertOpeningTextStyle, addr 0x494bc2c, size 0xf8, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method InsertTextStyleInTextProcessingArray, addr 0x494bd34, size 0x494, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBaseGlyph, addr 0x494eaa8, size 0x128, virtual false, abstract: false, final false
  static inline bool IsBaseGlyph(uint32_t c);

  /// @brief Method IsBitmapRendering, addr 0x494ea68, size 0x40, virtual false, abstract: false, final false
  static inline bool IsBitmapRendering(::UnityEngine::TextCore::LowLevel::GlyphRenderMode glyphRenderMode);

  /// @brief Method IsCJK, addr 0x494ee34, size 0x1b8, virtual false, abstract: false, final false
  static inline bool IsCJK(uint32_t c);

  /// @brief Method IsHangul, addr 0x494edc4, size 0x70, virtual false, abstract: false, final false
  static inline bool IsHangul(uint32_t c);

  /// @brief Method IsValidUTF16, addr 0x494ec8c, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF16(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method IsValidUTF32, addr 0x494ed28, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsValidUTF32(::UnityEngine::TextCore::Text::TextBackingContainer text, int32_t index);

  /// @brief Method LegacyAlignmentToNewAlignment, addr 0x494e760, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextAlignment LegacyAlignmentToNewAlignment(::UnityEngine::TextAnchor anchor);

  /// @brief Method LegacyStyleToNewStyle, addr 0x494e750, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::FontStyles LegacyStyleToNewStyle(::UnityEngine::FontStyle fontStyle);

  /// @brief Method MinAlpha, addr 0x494ebd0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color MinAlpha(::UnityEngine::Color c1, ::UnityEngine::Color c2);

  /// @brief Method PackUV, addr 0x494bbcc, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 PackUV(float_t x, float_t y, float_t scale);

  /// @brief Method ReplaceClosingStyleTag, addr 0x494c820, size 0x12c, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x494c5f0, size 0x158, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ReplaceOpeningStyleTag, addr 0x494c2c8, size 0x158, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method ResizeLineExtents, addr 0x494e5a4, size 0x1ac, virtual false, abstract: false, final false
  static inline void ResizeLineExtents(int32_t size, ::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method ToUpperASCIIFast, addr 0x494cf10, size 0x74, virtual false, abstract: false, final false
  static inline char16_t ToUpperASCIIFast(char16_t c);

  /// @brief Method ToUpperASCIIFast, addr 0x494e89c, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x494e910, size 0x74, virtual false, abstract: false, final false
