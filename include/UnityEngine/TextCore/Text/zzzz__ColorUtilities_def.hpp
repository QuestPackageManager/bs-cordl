...
public:
  // Declarations
  /// @brief Method CompareColors, addr 0x6992048, size 0x10, virtual false, abstract: false, final false
  static inline bool CompareColors(::UnityEngine::Color32 a, ::UnityEngine::Color32 b);

  /// @brief Method MultiplyColors, addr 0x6992058, size 0xe4, virtual false, abstract: false, final false
