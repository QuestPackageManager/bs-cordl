...
static_assert(::cordl_internals::size_check_v<::UnityEngine::TextCore::Text::OTL_FeatureTag, 0x4>, "Size mismatch!");

} // namespace UnityEngine::TextCore::Text
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::TextCore::Text::OTL_FeatureTag, "UnityEngine.TextCore.Text", "OTL_FeatureTag");
