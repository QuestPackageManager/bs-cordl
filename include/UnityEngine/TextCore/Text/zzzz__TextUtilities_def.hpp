...
// Write type traits
MARK_REF_T(::UnityEngine::TextCore::Text::TextUtilities*);
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextUtilities*, "UnityEngine.TextCore.Text", "TextUtilities");
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextUtilities) == 0x10, "Size mismatch!");
