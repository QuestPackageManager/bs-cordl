...
public:
  // Declarations
  /// @brief Method GetHashCodeCaseInSensitive, addr 0x6aba85c, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetHashCodeCaseInSensitive(::StringW s);

  /// @brief Method GetTextFontWeightIndex, addr 0x6abbe34, size 0x94, virtual false, abstract: false, final false
  static inline int32_t GetTextFontWeightIndex(::UnityEngine::TextCore::Text::TextFontWeight fontWeight);

  /// @brief Method ToUpperFast, addr 0x6abbdb4, size 0x80, virtual false, abstract: false, final false
