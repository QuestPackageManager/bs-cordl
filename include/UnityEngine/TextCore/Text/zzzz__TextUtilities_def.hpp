...
public:
  // Declarations
  /// @brief Method ToUpperFast addr 0x2bdb170 size 0x74 virtual false final false
  static inline char16_t ToUpperFast(char16_t c);

  /// @brief Method ToUpperASCIIFast addr 0x2bdb1e4 size 0x74 virtual false final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method GetHashCodeCaseInSensitive addr 0x2bcf684 size 0x70 virtual false final false
  static inline int32_t GetHashCodeCaseInSensitive(::StringW s);

  /// @brief Method UintToString addr 0x2bd5b10 size 0xd8 virtual false final false
