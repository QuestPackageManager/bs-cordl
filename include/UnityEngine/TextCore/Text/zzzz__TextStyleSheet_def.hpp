...
public:
  ...
  /// @brief Method GetStyle, addr 0x2d4c1d0, size 0x88, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(int32_t hashCode);

  /// @brief Method GetStyle, addr 0x2d4c41c, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(::StringW name);

  /// @brief Method RefreshStyles, addr 0x2d4c4b4, size 0x4, virtual false, abstract: false, final false
  inline void RefreshStyles();

  /// @brief Method LoadStyleDictionaryInternal, addr 0x2d4c258, size 0x1c4, virtual false, abstract: false, final false
  inline void LoadStyleDictionaryInternal();

  static inline ::UnityEngine::TextCore::Text::TextStyleSheet* New_ctor();

  /// @brief Method .ctor, addr 0x2d4c4b8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
