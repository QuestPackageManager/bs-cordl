...
public:
  ...
  /// @brief Method GetShaderPropertyIDs, addr 0x6abb10c, size 0xca8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShaderRef_MobileBitmap, addr 0x6ababb4, size 0x1dc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap();

  /// @brief Method get_ShaderRef_MobileSDF, addr 0x6aba8cc, size 0x17c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileSDF();

  /// @brief Method get_ShaderRef_MobileSDF_IMGUI, addr 0x6abaa48, size 0x16c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileSDF_IMGUI();

  /// @brief Method get_ShaderRef_Sprite, addr 0x6abad90, size 0x1fc, virtual false, abstract: false, final false
