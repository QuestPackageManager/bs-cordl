...
public:
  ...
  /// @brief Method RefreshStyle, addr 0x494c998, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x494c94c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hashCode, addr 0x494558c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_styleClosingTagArray, addr 0x4945b28, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t, ::Array<uint32_t>*> get_styleClosingTagArray();

  /// @brief Method get_styleOpeningTagArray, addr 0x4945594, size 0x8, virtual false, abstract: false, final false
