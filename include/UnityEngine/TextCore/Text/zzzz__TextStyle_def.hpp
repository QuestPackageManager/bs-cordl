...
public:
  ...
  /// @brief Method RefreshStyle, addr 0x6a36a7c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a36a40, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hashCode, addr 0x6a36a28, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_styleClosingTagArray, addr 0x6a36a38, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t, ::Array<uint32_t>*> get_styleClosingTagArray();

  /// @brief Method get_styleOpeningTagArray, addr 0x6a36a30, size 0x8, virtual false, abstract: false, final false
