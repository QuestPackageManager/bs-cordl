...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::TextCore::Text::SpriteCharacter::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2be2448;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::SpriteCharacter::*)()>(&::UnityEngine::TextCore::Text::SpriteCharacter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2be2450;
...
constexpr ::StringW& UnityEngine::TextCore::Text::SpriteCharacter::__get_m_Name() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Name;
}
constexpr ::StringW const& UnityEngine::TextCore::Text::SpriteCharacter::__get_m_Name() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_Name;
}
...
constexpr int32_t& UnityEngine::TextCore::Text::SpriteCharacter::__get_m_HashCode() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_HashCode;
}
constexpr int32_t const& UnityEngine::TextCore::Text::SpriteCharacter::__get_m_HashCode() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_HashCode;
}
...
inline ::UnityEngine::TextCore::Text::SpriteCharacter* UnityEngine::TextCore::Text::SpriteCharacter::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::TextCore::Text::SpriteCharacter*>());
}
