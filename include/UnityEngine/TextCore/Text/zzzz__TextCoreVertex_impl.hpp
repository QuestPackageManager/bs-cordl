...
// Ctor Parameters [CppParam { name: "position", ty: "::UnityEngine::Vector3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "color", ty: "::UnityEngine::Color32", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "uv0", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "uv2", ty:
// "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}"), comment: None }]
