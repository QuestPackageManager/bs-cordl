...
public:
  ...
  /// @brief Method GetFallbackMaterial, addr 0x2eaa824, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x2eaa4c4, size 0x360, virtual false, abstract: false, final false
