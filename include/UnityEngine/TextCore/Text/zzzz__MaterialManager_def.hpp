...
public:
  ...
  /// @brief Method CopyMaterialPresetProperties, addr 0x6bc4534, size 0x254, virtual false, abstract: false, final false
  static inline void CopyMaterialPresetProperties(::UnityEngine::Material* source, ::UnityEngine::Material* destination);

  /// @brief Method GetFallbackMaterial, addr 0x6bc4788, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x6bc4128, size 0x40c, virtual false, abstract: false, final false
