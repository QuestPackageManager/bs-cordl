...
public:
  ...
  /// @brief Method GetFallbackMaterial, addr 0x329063c, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x32902dc, size 0x360, virtual false, abstract: false, final false
