...
public:
  ...
  /// @brief Method GetFallbackMaterial, addr 0x328e640, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x328e2e0, size 0x360, virtual false, abstract: false, final false
