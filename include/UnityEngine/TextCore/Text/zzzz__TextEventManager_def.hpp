...
public:
  ...
  /// @brief Method ON_FONT_PROPERTY_CHANGED, addr 0x6c04254, size 0x98, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextEventManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextEventManager(TextEventManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextEventManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextEventManager(TextEventManagerconst&) = delete;
