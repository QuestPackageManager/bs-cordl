...
public:
  ...
  /// @brief Method <SortCharacterTable>b__190_0, addr 0x6aa508c, size 0x14, virtual false, abstract: false, final false
  inline uint32_t _SortCharacterTable_b__190_0(::UnityEngine::TextCore::Text::Character* c);

  /// @brief Method <SortGlyphTable>b__191_0, addr 0x6aa50a8, size 0x14, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphTable_b__191_0(::UnityEngine::TextCore::Glyph* c);

  /// @brief Method .ctor, addr 0x6aa5088, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCharacterToLookupCache, addr 0x6a75004, size 0xc, virtual false, abstract: false, final false
  inline void AddCharacterToLookupCache(uint32_t unicode, ::UnityEngine::TextCore::Text::Character* character);

  /// @brief Method AddCharacterToLookupCache, addr 0x6a75010, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddLigatureSubstitutionRecords, addr 0x6a7ae1c, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMarkToBaseAdjustmentRecords, addr 0x6a7a9ec, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMarkToMarkAdjustmentRecords, addr 0x6a7ac04, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method AddPairAdjustmentRecords, addr 0x6a7a76c, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method AddSynthesizedCharacter, addr 0x6a74730, size 0x878, virtual false, abstract: false, final false
  inline void AddSynthesizedCharacter(uint32_t unicode, bool isFontFaceLoaded, bool addImmediately);

  /// @brief Method AddSynthesizedCharactersAndFaceMetrics, addr 0x6a73200, size 0x1d8, virtual false, abstract: false, final false
  inline void AddSynthesizedCharactersAndFaceMetrics();

  /// @brief Method ClearAtlasTextures, addr 0x6a76f70, size 0x1e8, virtual false, abstract: false, final false
  inline void ClearAtlasTextures(bool setAtlasSizeToZero);

  /// @brief Method ClearCharacterAndGlyphTables, addr 0x6a76cc0, size 0x1bc, virtual false, abstract: false, final false
  inline void ClearCharacterAndGlyphTables();

  /// @brief Method ClearCharacterAndGlyphTablesInternal, addr 0x6a77454, size 0x24, virtual false, abstract: false, final false
  inline void ClearCharacterAndGlyphTablesInternal();

  /// @brief Method ClearFallbackCharacterTable, addr 0x6a74250, size 0x3c8, virtual false, abstract: false, final false
  inline void ClearFallbackCharacterTable();

  /// @brief Method ClearFontAssetData, addr 0x6a77174, size 0x2e0, virtual false, abstract: false, final false
  inline void ClearFontAssetData(bool setAtlasSizeToZero);

  /// @brief Method ClearFontFeaturesTables, addr 0x6a76e7c, size 0xf4, virtual false, abstract: false, final false
  inline void ClearFontFeaturesTables();

  /// @brief Method ContainsCharacterInLookupCache, addr 0x6a75234, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x6a7ba0c, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCharacterAndAddToCache, addr 0x6a79d24, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCompositeKey, addr 0x6a74fa8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a715f0, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a71a24, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a725d4, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> CreateFontAsset(::UnityEngine::Font* font);

  /// @brief Method CreateFontAsset, addr 0x6a727e8, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a72654, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a7271c, size 0xcc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> CreateFontAsset(::UnityEngine::Font* font, int32_t samplingPointSize, int32_t atlasPadding,
                                                                                   ::UnityEngine::TextCore::LowLevel::GlyphRenderMode renderMode, int32_t atlasWidth, int32_t atlasHeight,
                                                                                   ::UnityEngine::Shader* shader, ::UnityEngine::TextCore::Text::AtlasPopulationMode atlasPopulationMode,
                                                                                   bool enableMultiAtlasSupport);

  /// @brief Method CreateFontAsset, addr 0x6a7208c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAsset, addr 0x6a718a4, size 0x180, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> CreateFontAsset(::StringW fontFilePath, int32_t faceIndex, int32_t samplingPointSize, int32_t atlasPadding,
                                                                                   ::UnityEngine::TextCore::LowLevel::GlyphRenderMode renderMode, int32_t atlasWidth, int32_t atlasHeight,
                                                                                   ::UnityEngine::TextCore::Text::AtlasPopulationMode atlasPopulationMode, bool enableMultiAtlasSupport);

  /// @brief Method CreateFontAssetFromFamilyName, addr 0x6a71cec, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAssetInstance, addr 0x6a72144, size 0x490, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAssetInternal, addr 0x6a717b4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAssetOSFallbackList, addr 0x6a71b24, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFontAssetWithOSFallbackList, addr 0x6a71e80, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create_Injected, addr 0x6a7c578, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x6a7316c, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr ptr);

  /// @brief Method DestroyAtlasTextures, addr 0x6a73088, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x6a7c648, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetCharacterInLookupCache, addr 0x6a750d4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCharacters, addr 0x6a76784, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW GetCharacters(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method GetCharactersArray, addr 0x6a7687c, size 0xf4, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GetCharactersArray(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method GetFallbacks, addr 0x6a7b37c, size 0x3a0, virtual false, abstract: false, final false
  inline ::ArrayW<::System::IntPtr, ::Array<::System::IntPtr>*> GetFallbacks();

  /// @brief Method GetFontAssetByID, addr 0x6a72b40, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAssetByID(int32_t id);

  /// @brief Method GetGlyphIndex, addr 0x6a76970, size 0x14, virtual false, abstract: false, final false
  inline uint32_t GetGlyphIndex(uint32_t unicode);

  /// @brief Method GetGlyphIndex, addr 0x6a76984, size 0x160, virtual false, abstract: false, final false
  inline uint32_t GetGlyphIndex(uint32_t unicode, ::ByRef<bool> success);

  /// @brief Method GetGlyphVariantIndex, addr 0x6a76ae4, size 0xac, virtual false, abstract: false, final false
  inline uint32_t GetGlyphVariantIndex(uint32_t unicode, uint32_t variantSelectorUnicode);

  /// @brief Method GetWeightFallbacks, addr 0x6a7b71c, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCharacter, addr 0x6a75674, size 0x8, virtual false, abstract: false, final false
  inline bool HasCharacter(char16_t character, bool searchFallbacks, bool tryAddCharacter);

  /// @brief Method HasCharacter, addr 0x6a755ec, size 0x88, virtual false, abstract: false, final false
  inline bool HasCharacter(int32_t character);

  /// @brief Method HasCharacter, addr 0x6a7567c, size 0x370, virtual false, abstract: false, final false
  inline bool HasCharacter(uint32_t character, bool searchFallbacks, bool tryAddCharacter);

  /// @brief Method HasCharacterWithStyle_Internal, addr 0x6a76030, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCharacter_Internal, addr 0x6a75ddc, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCharacters, addr 0x6a766b0, size 0xd4, virtual false, abstract: false, final false
  inline bool HasCharacters(::StringW text);

  /// @brief Method HasCharacters, addr 0x6a761fc, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasCharacters, addr 0x6a76034, size 0x1c8, virtual false, abstract: false, final false
  inline bool HasCharacters(::StringW text, ::ByRef<::System::Collections::Generic::List_1<char16_t>*> missingCharacters);

  /// @brief Method HasRecursion, addr 0x6a7c114, size 0x9c, virtual false, abstract: false, final false
  inline bool HasRecursion(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method HasRecursionInternal, addr 0x6a7c1b0, size 0x330, virtual false, abstract: false, final false
  inline bool HasRecursionInternal(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method ImportFontFeatures, addr 0x6a73874, size 0x10c, virtual false, abstract: false, final false
  inline void ImportFontFeatures();

  /// @brief Method InitializeCharacterLookupDictionary, addr 0x6a73640, size 0x234, virtual false, abstract: false, final false
  inline void InitializeCharacterLookupDictionary();

  /// @brief Method InitializeDictionaryLookupTables, addr 0x6a731a8, size 0x58, virtual false, abstract: false, final false
  inline void InitializeDictionaryLookupTables();

  /// @brief Method InitializeGlyphLookupDictionary, addr 0x6a733d8, size 0x268, virtual false, abstract: false, final false
  inline void InitializeGlyphLookupDictionary();

  /// @brief Method InitializeGlyphPairAdjustmentRecordsLookupDictionary, addr 0x6a73cdc, size 0x1e4, virtual false, abstract: false, final false
  inline void InitializeGlyphPairAdjustmentRecordsLookupDictionary();

  /// @brief Method InitializeLigatureSubstitutionLookupDictionary, addr 0x6a73980, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeMarkToBaseAdjustmentRecordsLookupDictionary, addr 0x6a73ec0, size 0x1c8, virtual false, abstract: false, final false
  inline void InitializeMarkToBaseAdjustmentRecordsLookupDictionary();

  /// @brief Method InitializeMarkToMarkAdjustmentRecordsLookupDictionary, addr 0x6a74088, size 0x1c8, virtual false, abstract: false, final false
  inline void InitializeMarkToMarkAdjustmentRecordsLookupDictionary();

  /// @brief Method LoadFontFace, addr 0x6a74618, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x6a72f24, size 0x164, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ReadFontAssetDefinition, addr 0x6a70e98, size 0x554, virtual false, abstract: false, final false
  inline void ReadFontAssetDefinition();

  /// @brief Method RegisterAtlasTextureForApply, addr 0x6a77a18, size 0x140, virtual false, abstract: false, final false
  static inline void RegisterAtlasTextureForApply(::UnityEngine::Texture2D* texture);

  /// @brief Method RegisterCallbackInstance, addr 0x6a72bc8, size 0x35c, virtual false, abstract: false, final false
  inline void RegisterCallbackInstance(::UnityEngine::TextCore::Text::FontAsset* instance);

  /// @brief Method RegisterFontAssetForFontFeatureUpdate, addr 0x6a77478, size 0x148, virtual false, abstract: false, final false
  static inline void RegisterFontAssetForFontFeatureUpdate(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method RegisterFontAssetForKerningUpdate, addr 0x6a775c0, size 0x148, virtual false, abstract: false, final false
  static inline void RegisterFontAssetForKerningUpdate(::UnityEngine::TextCore::Text::FontAsset* fontAsset);

  /// @brief Method RemoveCharacterInLookupCache, addr 0x6a75188, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupNewAtlasTexture, addr 0x6a7a1fc, size 0x240, virtual false, abstract: false, final false
  inline void SetupNewAtlasTexture();

  /// @brief Method SortAllTables, addr 0x6a755cc, size 0x20, virtual false, abstract: false, final false
  inline void SortAllTables();

  /// @brief Method SortCharacterTable, addr 0x6a752f8, size 0x150, virtual false, abstract: false, final false
  inline void SortCharacterTable();

  /// @brief Method SortFontFeatureTable, addr 0x6a75598, size 0x34, virtual false, abstract: false, final false
  inline void SortFontFeatureTable();

  /// @brief Method SortGlyphTable, addr 0x6a75448, size 0x150, virtual false, abstract: false, final false
  inline void SortGlyphTable();

  /// @brief Method TryAddCharacterInternal, addr 0x6a79d10, size 0x14, virtual false, abstract: false, final false
  inline bool TryAddCharacterInternal(uint32_t unicode, ::ByRef<::UnityEngine::TextCore::Text::Character*> character);

  /// @brief Method TryAddCharacterInternal, addr 0x6a759ec, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddCharacters, addr 0x6a79498, size 0x1c, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::StringW characters, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x6a794b4, size 0x198, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::StringW characters, ::ByRef<::StringW> missingCharacters, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x6a77158, size 0x1c, virtual false, abstract: false, final false
  inline bool TryAddCharacters(::ArrayW<uint32_t, ::Array<uint32_t>*> unicodes, bool includeFontFeatures);

  /// @brief Method TryAddCharacters, addr 0x6a77d34, size 0x1240, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAddGlyphInternal, addr 0x6a7977c, size 0x1d4, virtual false, abstract: false, final false
  inline bool TryAddGlyphInternal(uint32_t glyphIndex, ::ByRef<::UnityEngine::TextCore::Glyph*> glyph);

  /// @brief Method TryAddGlyphToAtlas, addr 0x6a79950, size 0x3c0, virtual false, abstract: false, final false
  inline bool TryAddGlyphToAtlas(uint32_t glyphIndex, ::ByRef<::UnityEngine::TextCore::Glyph*> glyph, bool populateLigatures);

  /// @brief Method TryAddGlyphToTexture, addr 0x6a79eb4, size 0x348, virtual false, abstract: false, final false
  inline bool TryAddGlyphToTexture(uint32_t glyphIndex, ::ByRef<::UnityEngine::TextCore::Glyph*> glyph, bool populateLigatures);

  /// @brief Method TryAddGlyphVariantIndexInternal, addr 0x6a7964c, size 0xa0, virtual false, abstract: false, final false
  inline bool TryAddGlyphVariantIndexInternal(uint32_t unicode, uint32_t nextCharacter, uint32_t variantGlyphIndex);

  /// @brief Method TryAddGlyphsToNewAtlasTexture, addr 0x6a78f74, size 0x4b4, virtual false, abstract: false, final false
  inline bool TryAddGlyphsToNewAtlasTexture();

  /// @brief Method TryGetGlyphVariantIndexInternal, addr 0x6a796ec, size 0x90, virtual false, abstract: false, final false
  inline bool TryGetGlyphVariantIndexInternal(uint32_t unicode, uint32_t nextCharacter, ::ByRef<uint32_t> variantGlyphIndex);

  /// @brief Method UpdateAtlasTexturesInQueue, addr 0x6a77b58, size 0x188, virtual false, abstract: false, final false
  static inline void UpdateAtlasTexturesInQueue();

  /// @brief Method UpdateDiacriticalMarkAdjustmentRecords, addr 0x6a7a5bc, size 0x1b0, virtual false, abstract: false, final false
  inline void UpdateDiacriticalMarkAdjustmentRecords();

  /// @brief Method UpdateFaceInfo, addr 0x6a7bff8, size 0x94, virtual false, abstract: false, final false
  inline void UpdateFaceInfo();

  /// @brief Method UpdateFaceInfo, addr 0x6a7c08c, size 0x88, virtual false, abstract: false, final false
  static inline void UpdateFaceInfo(::System::IntPtr ptr, ::UnityEngine::TextCore::FaceInfo faceInfo);

  /// @brief Method UpdateFaceInfo_Injected, addr 0x6a7c604, size 0x44, virtual false, abstract: false, final false
  static inline void UpdateFaceInfo_Injected(::System::IntPtr ptr, ::ByRef<::UnityEngine::TextCore::FaceInfo> faceInfo);

  /// @brief Method UpdateFallbacks, addr 0x6a7bcd4, size 0x78, virtual false, abstract: false, final false
  inline void UpdateFallbacks();

  /// @brief Method UpdateFallbacks, addr 0x6a7bd4c, size 0xfc, virtual false, abstract: false, final false
  static inline void UpdateFallbacks(::System::IntPtr ptr, ::ArrayW<::System::IntPtr, ::Array<::System::IntPtr>*> fallbacks);

  /// @brief Method UpdateFallbacks_Injected, addr 0x6a7c4e0, size 0x44, virtual false, abstract: false, final false
  static inline void UpdateFallbacks_Injected(::System::IntPtr ptr, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> fallbacks);

  /// @brief Method UpdateFontAssetData, addr 0x6a76b90, size 0x130, virtual false, abstract: false, final false
  inline void UpdateFontAssetData();

  /// @brief Method UpdateFontAssetsInUpdateQueue, addr 0x6a77ce0, size 0x54, virtual false, abstract: false, final false
  static inline void UpdateFontAssetsInUpdateQueue();

  /// @brief Method UpdateFontFeaturesForFontAssetsInQueue, addr 0x6a77708, size 0x248, virtual false, abstract: false, final false
  static inline void UpdateFontFeaturesForFontAssetsInQueue();

  /// @brief Method UpdateFontFeaturesForNewlyAddedGlyphs, addr 0x6a79428, size 0x70, virtual false, abstract: false, final false
  inline void UpdateFontFeaturesForNewlyAddedGlyphs();

  /// @brief Method UpdateGPOSFontFeaturesForNewlyAddedGlyphs, addr 0x6a77950, size 0x68, virtual false, abstract: false, final false
  inline void UpdateGPOSFontFeaturesForNewlyAddedGlyphs();

  /// @brief Method UpdateGSUBFontFeaturesForNewGlyphIndex, addr 0x6a7a43c, size 0x88, virtual false, abstract: false, final false
  inline void UpdateGSUBFontFeaturesForNewGlyphIndex(uint32_t glyphIndex);

  /// @brief Method UpdateGlyphAdjustmentRecords, addr 0x6a7a540, size 0x7c, virtual false, abstract: false, final false
  inline void UpdateGlyphAdjustmentRecords();

  /// @brief Method UpdateGlyphAdjustmentRecordsForNewGlyphs, addr 0x6a779b8, size 0x60, virtual false, abstract: false, final false
  inline void UpdateGlyphAdjustmentRecordsForNewGlyphs();

  /// @brief Method UpdateLigatureSubstitutionRecords, addr 0x6a7a4c4, size 0x7c, virtual false, abstract: false, final false
  inline void UpdateLigatureSubstitutionRecords();

  /// @brief Method UpdateWeightFallbacks, addr 0x6a7be48, size 0x80, virtual false, abstract: false, final false
  inline void UpdateWeightFallbacks();

  /// @brief Method UpdateWeightFallbacks, addr 0x6a7bec8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateWeightFallbacks_Injected, addr 0x6a7c524, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a7c6dc, size 0x310, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_atlasHeight, addr 0x6a71510, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasHeight();

  /// @brief Method get_atlasPadding, addr 0x6a71520, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasPadding();

  /// @brief Method get_atlasPopulationMode, addr 0x6a70dd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::AtlasPopulationMode get_atlasPopulationMode();

  /// @brief Method get_atlasRenderMode, addr 0x6a71530, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::LowLevel::GlyphRenderMode get_atlasRenderMode();

  /// @brief Method get_atlasTexture, addr 0x6a71420, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlasTexture();

  /// @brief Method get_atlasTextureCount, addr 0x6a714c4, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_atlasTextureCount();

  /// @brief Method get_atlasTextures, addr 0x6a714b4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Texture2D>, ::Array<::UnityW<::UnityEngine::Texture2D>>*> get_atlasTextures();

  /// @brief Method get_atlasWidth, addr 0x6a71500, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_atlasWidth();

  /// @brief Method get_boldStyleSpacing, addr 0x6a715c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_boldStyleSpacing();

  /// @brief Method get_boldStyleWeight, addr 0x6a715b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_boldStyleWeight();

  /// @brief Method get_characterLookupTable, addr 0x6a713fc, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::UnityEngine::TextCore::Text::Character*>* get_characterLookupTable();

  /// @brief Method get_characterTable, addr 0x6a713ec, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>* get_characterTable();

  /// @brief Method get_clearDynamicDataOnBuild, addr 0x6a714f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_clearDynamicDataOnBuild();

  /// @brief Method get_faceInfo, addr 0x6a70de8, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::FaceInfo get_faceInfo();

  /// @brief Method get_fallbackFontAssetTable, addr 0x6a71570, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>* get_fallbackFontAssetTable();

  /// @brief Method get_familyNameHashCode, addr 0x6a70e04, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_familyNameHashCode();

  /// @brief Method get_fontAssetCreationEditorSettings, addr 0x6a70dac, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::FontAssetCreationEditorSettings get_fontAssetCreationEditorSettings();

  /// @brief Method get_fontFeatureTable, addr 0x6a71560, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::FontFeatureTable* get_fontFeatureTable();

  /// @brief Method get_fontWeightTable, addr 0x6a71580, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_freeGlyphRects, addr 0x6a71550, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::GlyphRect>* get_freeGlyphRects();

  /// @brief Method get_getFontFeatures, addr 0x6a714e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_getFontFeatures();

  /// @brief Method get_glyphLookupTable, addr 0x6a70e74, size 0x24, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::UnityEngine::TextCore::Glyph*>* get_glyphLookupTable();

  /// @brief Method get_glyphTable, addr 0x6a70e64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Glyph*>* get_glyphTable();

  /// @brief Method get_isMultiAtlasTexturesEnabled, addr 0x6a714d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isMultiAtlasTexturesEnabled();

  /// @brief Method get_italicStyleSlant, addr 0x6a715d0, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_italicStyleSlant();

  /// @brief Method get_nativeFontAsset, addr 0x6a7b230, size 0x14c, virtual false, abstract: false, final false
  inline ::System::IntPtr get_nativeFontAsset();

  /// @brief Method get_regularStyleSpacing, addr 0x6a715a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_regularStyleSpacing();

  /// @brief Method get_regularStyleWeight, addr 0x6a71590, size 0x8, virtual false, abstract: false, final false
  inline float_t get_regularStyleWeight();

  /// @brief Method get_sourceFontFile, addr 0x6a70dc8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_sourceFontFile();

  /// @brief Method get_styleNameHashCode, addr 0x6a70e34, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_styleNameHashCode();

  /// @brief Method get_tabMultiple, addr 0x6a715e0, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_tabMultiple();

  /// @brief Method get_usedGlyphRects, addr 0x6a71540, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atlasHeight, addr 0x6a71518, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasHeight(int32_t value);

  /// @brief Method set_atlasPadding, addr 0x6a71528, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasPadding(int32_t value);

  /// @brief Method set_atlasPopulationMode, addr 0x6a70de0, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasPopulationMode(::UnityEngine::TextCore::Text::AtlasPopulationMode value);

  /// @brief Method set_atlasRenderMode, addr 0x6a71538, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasRenderMode(::UnityEngine::TextCore::LowLevel::GlyphRenderMode value);

  /// @brief Method set_atlasTextures, addr 0x6a714bc, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasTextures(::ArrayW<::UnityEngine::Texture2D*, ::Array<::UnityEngine::Texture2D*>*> value);

  /// @brief Method set_atlasWidth, addr 0x6a71508, size 0x8, virtual false, abstract: false, final false
  inline void set_atlasWidth(int32_t value);

  /// @brief Method set_boldStyleSpacing, addr 0x6a715c8, size 0x8, virtual false, abstract: false, final false
  inline void set_boldStyleSpacing(float_t value);

  /// @brief Method set_boldStyleWeight, addr 0x6a715b8, size 0x8, virtual false, abstract: false, final false
  inline void set_boldStyleWeight(float_t value);

  /// @brief Method set_characterTable, addr 0x6a713f4, size 0x8, virtual false, abstract: false, final false
  inline void set_characterTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>* value);

  /// @brief Method set_clearDynamicDataOnBuild, addr 0x6a714f8, size 0x8, virtual false, abstract: false, final false
  inline void set_clearDynamicDataOnBuild(bool value);

  /// @brief Method set_faceInfo, addr 0x6a70df8, size 0xc, virtual false, abstract: false, final false
  inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo value);

  /// @brief Method set_fallbackFontAssetTable, addr 0x6a71578, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_familyNameHashCode, addr 0x6a70e2c, size 0x8, virtual false, abstract: false, final false
  inline void set_familyNameHashCode(int32_t value);

  /// @brief Method set_fontAssetCreationEditorSettings, addr 0x6a70dbc, size 0xc, virtual false, abstract: false, final false
  inline void set_fontAssetCreationEditorSettings(::UnityEngine::TextCore::Text::FontAssetCreationEditorSettings value);

  /// @brief Method set_fontFeatureTable, addr 0x6a71568, size 0x8, virtual false, abstract: false, final false
  inline void set_fontFeatureTable(::UnityEngine::TextCore::Text::FontFeatureTable* value);

  /// @brief Method set_fontWeightTable, addr 0x6a71588, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_freeGlyphRects, addr 0x6a71558, size 0x8, virtual false, abstract: false, final false
  inline void set_freeGlyphRects(::System::Collections::Generic::List_1<::UnityEngine::TextCore::GlyphRect>* value);

  /// @brief Method set_getFontFeatures, addr 0x6a714e8, size 0x8, virtual false, abstract: false, final false
  inline void set_getFontFeatures(bool value);

  /// @brief Method set_glyphTable, addr 0x6a70e6c, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Glyph*>* value);

  /// @brief Method set_isMultiAtlasTexturesEnabled, addr 0x6a714d8, size 0x8, virtual false, abstract: false, final false
  inline void set_isMultiAtlasTexturesEnabled(bool value);

  /// @brief Method set_italicStyleSlant, addr 0x6a715d8, size 0x8, virtual false, abstract: false, final false
  inline void set_italicStyleSlant(uint8_t value);

  /// @brief Method set_regularStyleSpacing, addr 0x6a715a8, size 0x8, virtual false, abstract: false, final false
  inline void set_regularStyleSpacing(float_t value);

  /// @brief Method set_regularStyleWeight, addr 0x6a71598, size 0x8, virtual false, abstract: false, final false
  inline void set_regularStyleWeight(float_t value);

  /// @brief Method set_sourceFontFile, addr 0x6a70dd0, size 0x8, virtual false, abstract: false, final false
  inline void set_sourceFontFile(::UnityEngine::Font* value);

  /// @brief Method set_styleNameHashCode, addr 0x6a70e5c, size 0x8, virtual false, abstract: false, final false
  inline void set_styleNameHashCode(int32_t value);

  /// @brief Method set_tabMultiple, addr 0x6a715e8, size 0x8, virtual false, abstract: false, final false
  inline void set_tabMultiple(uint8_t value);

  /// @brief Method set_usedGlyphRects, addr 0x6a71548, size 0x8, virtual false, abstract: false, final false
