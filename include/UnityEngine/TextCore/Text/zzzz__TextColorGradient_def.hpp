...
public:
  ...
  /// @brief Method .ctor, addr 0x6aa847c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6aa851c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x6aa8588, size 0xa4, virtual false, abstract: false, final false
