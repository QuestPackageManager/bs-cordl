...
public:
  ...
  /// @brief Method .ctor, addr 0x6bfdeac, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bfdf4c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x6bfdfb8, size 0xa4, virtual false, abstract: false, final false
