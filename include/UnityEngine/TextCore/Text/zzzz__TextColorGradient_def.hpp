...
/// @brief Method .ctor, addr 0x6a36234, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6a362d4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color  color) ;

/// @brief Method .ctor, addr 0x6a36340, size 0xa4, virtual false, abstract: false, final false
