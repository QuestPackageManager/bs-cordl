...
public:
  ...
  /// @brief Method .ctor, addr 0x34c8f88, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c9024, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x34c9090, size 0xa4, virtual false, abstract: false, final false
