...
public:
  ...
  /// @brief Method .ctor, addr 0x3295d54, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3295df0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x3295e5c, size 0xa4, virtual false, abstract: false, final false
