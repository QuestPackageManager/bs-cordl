...
public:
  ...
  /// @brief Method .ctor, addr 0x34dbe0c, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34dbea8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x34dbf14, size 0xa4, virtual false, abstract: false, final false
