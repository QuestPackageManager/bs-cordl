...
// Ctor Parameters [CppParam { name: "textElementInfos", ty: "::ArrayW<::UnityEngine::TextCore::Text::NativeTextElementInfo,::Array<::UnityEngine::TextCore::Text::NativeTextElementInfo>*>", modifiers: "", def_value: None }, CppParam { name: "fontAssetId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "textElementCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fontAsset", ty: "::UnityW<::UnityEngine::TextCore::Text::FontAsset>", modifiers: "", def_value: None }]
constexpr ATGMeshInfo(::ArrayW<::UnityEngine::TextCore::Text::NativeTextElementInfo,::Array<::UnityEngine::TextCore::Text::NativeTextElementInfo>*>  textElementInfos, int32_t  fontAssetId, int32_t  textElementCount, ::UnityW<::UnityEngine::TextCore::Text::FontAsset>  fontAsset) noexcept;
