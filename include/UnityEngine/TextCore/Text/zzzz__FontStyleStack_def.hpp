...
public:
  // Declarations
  /// @brief Method Add, addr 0x6a474b8, size 0x104, virtual false, abstract: false, final false
  inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles style);

  /// @brief Method Clear, addr 0x6a474ac, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Remove, addr 0x6a475bc, size 0x128, virtual false, abstract: false, final false
