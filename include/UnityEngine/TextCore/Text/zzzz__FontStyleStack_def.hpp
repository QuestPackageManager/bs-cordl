...
public:
// Declarations
/// @brief Method Add, addr 0x6a47b78, size 0x104, virtual false, abstract: false, final false
inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles  style) ;

/// @brief Method Clear, addr 0x6a47b6c, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x6a47c7c, size 0x128, virtual false, abstract: false, final false
