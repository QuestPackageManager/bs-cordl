...
public:
  // Declarations
  /// @brief Method Clear, addr 0x2d692c8, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Add, addr 0x2d692d4, size 0xfc, virtual false, abstract: false, final false
  inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles style);

  /// @brief Method Remove, addr 0x2d693d0, size 0x120, virtual false, abstract: false, final false
