...
// Some("{}"), comment: None }, CppParam { name: "valueType", ty: "::UnityEngine::TextCore::Text::TagValueType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "valueStartIndex", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "valueLength", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "unitType", ty: "::UnityEngine::TextCore::Text::TagUnitType", modifiers: "", def_value: Some("{}"), comment: None }]
