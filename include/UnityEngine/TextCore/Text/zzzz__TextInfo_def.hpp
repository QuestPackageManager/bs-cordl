...
public:
  ...
  /// @brief Method Clear, addr 0x349d638, size 0x5c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearLineInfo, addr 0x349d740, size 0x16c, virtual false, abstract: false, final false
  inline void ClearLineInfo();

  /// @brief Method ClearMeshInfo, addr 0x349d694, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349d504, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();
