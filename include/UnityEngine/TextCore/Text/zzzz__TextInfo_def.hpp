...
public:
  ...
  /// @brief Method Clear, addr 0x2e532ac, size 0x5c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearLineInfo, addr 0x2e533b4, size 0x16c, virtual false, abstract: false, final false
  inline void ClearLineInfo();

  /// @brief Method ClearMeshInfo, addr 0x2e53308, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e53178, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();
