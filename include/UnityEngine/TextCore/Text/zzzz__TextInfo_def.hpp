...
public:
  ...
  /// @brief Method Clear, addr 0x6ab8a40, size 0x58, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearLineInfo, addr 0x6ab8b58, size 0x17c, virtual false, abstract: false, final false
  inline void ClearLineInfo();

  /// @brief Method ClearMeshInfo, addr 0x6ab8a98, size 0xc0, virtual false, abstract: false, final false
  inline void ClearMeshInfo(bool updateMesh);

  /// @brief Method ClearPageInfo, addr 0x6ab8cd4, size 0x9c, virtual false, abstract: false, final false
  inline void ClearPageInfo();

  /// @brief Method DistanceToLine, addr 0x6ab9584, size 0xc8, virtual false, abstract: false, final false
  static inline float_t DistanceToLine(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ::UnityEngine::Vector3 point);

  /// @brief Method FindIntersectingLink, addr 0x6ab964c, size 0x278, virtual false, abstract: false, final false
  inline int32_t FindIntersectingLink(::UnityEngine::Vector3 position, ::UnityEngine::Rect screenRect, bool inverseYAxis);

  /// @brief Method FindNearestCharacterOnLine, addr 0x6ab8ff0, size 0x270, virtual false, abstract: false, final false
  inline int32_t FindNearestCharacterOnLine(::UnityEngine::Vector2 position, int32_t line, bool visibleOnly);

  /// @brief Method FindNearestLine, addr 0x6ab8f54, size 0x9c, virtual false, abstract: false, final false
  inline int32_t FindNearestLine(::UnityEngine::Vector2 position);

  /// @brief Method GetCharacterHeightFromIndex, addr 0x6ab9a40, size 0x54, virtual false, abstract: false, final false
  inline float_t GetCharacterHeightFromIndex(int32_t index);

  /// @brief Method GetCorrespondingStringIndex, addr 0x6ab98c4, size 0x4c, virtual false, abstract: false, final false
  inline int32_t GetCorrespondingStringIndex(int32_t index);

  /// @brief Method GetCursorIndexFromPosition, addr 0x6ab8ea0, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetCursorIndexFromPosition(::UnityEngine::Vector2 position, ::UnityEngine::Rect screenRect, bool inverseYAxis);

  /// @brief Method GetCursorPositionFromStringIndexUsingCharacterHeight, addr 0x6ab8d70, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCursorPositionFromStringIndexUsingLineHeight, addr 0x6ab8df4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLineHeight, addr 0x6ab99a8, size 0x4c, virtual false, abstract: false, final false
  inline float_t GetLineHeight(int32_t lineNumber);

  /// @brief Method GetLineHeightFromCharacterIndex, addr 0x6ab99f4, size 0x4c, virtual false, abstract: false, final false
  inline float_t GetLineHeightFromCharacterIndex(int32_t index);

  /// @brief Method GetLineInfoFromCharacterIndex, addr 0x6ab9910, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::LineInfo GetLineInfoFromCharacterIndex(int32_t index);

  /// @brief Method GetLineNumber, addr 0x6ab995c, size 0x4c, virtual false, abstract: false, final false
  inline int32_t GetLineNumber(int32_t index);

  /// @brief Method IndexOf, addr 0x6ab9c00, size 0xa8, virtual false, abstract: false, final false
  inline int32_t IndexOf(char16_t value, int32_t startIndex);

  /// @brief Method LastIndexOf, addr 0x6ab9ca8, size 0x9c, virtual false, abstract: false, final false
  inline int32_t LastIndexOf(char16_t value, int32_t startIndex);

  /// @brief Method LineDownCharacterPosition, addr 0x6ab9260, size 0x12c, virtual false, abstract: false, final false
  inline int32_t LineDownCharacterPosition(int32_t originalPos);

  /// @brief Method LineUpCharacterPosition, addr 0x6ab938c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method PointIntersectRectangle, addr 0x6ab94c4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveFromCache, addr 0x6ab7f64, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Substring, addr 0x6ab9a94, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ab77c0, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_vertexDataLayout, addr 0x6ab8a30, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_vertexDataLayout, addr 0x6ab8a38, size 0x8, virtual false, abstract: false, final false
