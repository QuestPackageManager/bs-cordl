...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextVertex, "UnityEngine.TextCore.Text", "TextVertex");
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextVertex) == 0x28, "Size mismatch!");
