...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x492e9f8, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x492ec04, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x492e97c, size 0x7c, virtual false, abstract: false, final false
