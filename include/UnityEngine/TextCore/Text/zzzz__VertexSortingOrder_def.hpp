...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::VertexSortingOrder, "UnityEngine.TextCore.Text", "VertexSortingOrder");
// Dependencies
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::VertexSortingOrder) == 0x4, "Size mismatch!");
