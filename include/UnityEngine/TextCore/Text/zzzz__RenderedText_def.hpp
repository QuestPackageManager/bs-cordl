...
/// @brief Method CreateString, addr 0x6a3959c, size 0xdc, virtual false, abstract: false, final false
inline ::StringW CreateString() ;

/// @brief Method Equals, addr 0x6a3c470, size 0xb8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6a3c3a4, size 0xcc, virtual true, abstract: false, final true
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x6a39f50, size 0x84, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::TextCore::Text::RenderedText  other) ;

/// @brief Method GetEnumerator, addr 0x6a3c260, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::RenderedText_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x6a3c528, size 0xac, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x6a3c228, size 0x18, virtual false, abstract: false, final false
inline void _ctor(char16_t  repeat, int32_t  repeatCount, ::StringW  suffix) ;

/// @brief Method .ctor, addr 0x6a396b8, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method .ctor, addr 0x6a3c180, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, int32_t  start, int32_t  length, ::StringW  suffix) ;

/// @brief Method .ctor, addr 0x6a3c1e4, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  suffix) ;

/// @brief Method get_CharacterCount, addr 0x6a3c240, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "value", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "valueStart", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "valueLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "suffix", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "repeat", ty: "char16_t", modifiers: "", def_value: None }, CppParam { name: "repeatCount", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x6a3c290, size 0x114, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x6a3c27c, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::UnityEngine::TextCore::Text::RenderedText>  source) ;

/// @brief Method get_Current, addr 0x6a3c5d4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Source", ty: "::UnityEngine::TextCore::Text::RenderedText", modifiers: "", def_value: None }, CppParam { name: "m_Stage", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_StageIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Current", ty: "char16_t", modifiers: "", def_value: None }]
