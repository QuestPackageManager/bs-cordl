...
// Ctor Parameters [CppParam { name: "color", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "padding", ty:
// "::UnityEngine::TextCore::Text::Offset", modifiers: "", def_value: Some("{}"), comment: None }]
