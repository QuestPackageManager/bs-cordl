...
template <typename A, typename B> inline void UnityEngine::TextCore::Text::FastAction_2<A, B>::Call(A a, B b) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::FastAction_2<A, B>*>::get(), "Call", std::span<Il2CppClass const* const, 0>(),
...
template <typename A, typename B> inline void UnityEngine::TextCore::Text::FastAction_2<A, B>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::FastAction_2<A, B>*>::get(), ".ctor",
...
template <typename A, typename B> inline ::UnityEngine::TextCore::Text::FastAction_2<A, B>* UnityEngine::TextCore::Text::FastAction_2<A, B>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::TextCore::Text::FastAction_2<A, B>*>());
}
// Ctor Parameters []
