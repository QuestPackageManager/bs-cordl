...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x69dee94, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x69de860, size 0x634, virtual false, abstract: false, final false
