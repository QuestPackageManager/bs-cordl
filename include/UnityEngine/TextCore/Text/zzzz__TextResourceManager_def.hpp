...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x34c8dd0, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x34c8884, size 0x4f4, virtual false, abstract: false, final false
