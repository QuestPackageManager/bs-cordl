...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x495d134, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x495cc24, size 0x510, virtual false, abstract: false, final false
