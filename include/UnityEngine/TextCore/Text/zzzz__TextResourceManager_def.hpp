...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6c135d8, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x6c12fa4, size 0x634, virtual false, abstract: false, final false
