...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x494ad14, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x494a804, size 0x510, virtual false, abstract: false, final false
