...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6c10050, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x6c0fa1c, size 0x634, virtual false, abstract: false, final false
