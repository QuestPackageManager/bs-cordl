...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x4954104, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x4953bf4, size 0x510, virtual false, abstract: false, final false
