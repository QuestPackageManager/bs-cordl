...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3295b9c, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x3295650, size 0x4f4, virtual false, abstract: false, final false
