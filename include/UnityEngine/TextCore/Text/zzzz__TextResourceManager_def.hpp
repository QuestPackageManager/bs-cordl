...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6aba620, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFontAsset, addr 0x6ab9fec, size 0x634, virtual false, abstract: false, final false
