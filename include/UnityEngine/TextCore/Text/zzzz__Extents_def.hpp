...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::Extents, "UnityEngine.TextCore.Text", "Extents");
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x6bc3d74, size 0x1b8, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextCore::Text::Extents) == 0x10, "Size mismatch!");
