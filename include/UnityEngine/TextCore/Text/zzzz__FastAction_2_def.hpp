...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::TextCore::Text::FastAction_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::TextCore::Text::FastAction_2, "UnityEngine.TextCore.Text", "FastAction`2");
