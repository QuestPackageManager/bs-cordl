...
public:
  ...
  /// @brief Method AddTextInfoToCache, addr 0x6ab7aa0, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveTextInfoFromCache, addr 0x6ab7cd4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ab7e00, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
