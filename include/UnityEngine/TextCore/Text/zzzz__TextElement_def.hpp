...
public:
  ...
  /// @brief Method .ctor, addr 0x6bfdd78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_elementType, addr 0x6bff528, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::TextElementType get_elementType();

  /// @brief Method get_glyph, addr 0x6bff538, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Glyph* get_glyph();

  /// @brief Method get_glyphIndex, addr 0x6bfce50, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method get_scale, addr 0x6bff548, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method get_textAsset, addr 0x6bfbbe8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextCore::Text::TextAsset> get_textAsset();

  /// @brief Method get_unicode, addr 0x6bfaad0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_unicode();

  /// @brief Method set_glyph, addr 0x6bfce58, size 0x8, virtual false, abstract: false, final false
  inline void set_glyph(::UnityEngine::TextCore::Glyph* value);

  /// @brief Method set_glyphIndex, addr 0x6bff540, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphIndex(uint32_t value);

  /// @brief Method set_scale, addr 0x6bff550, size 0x8, virtual false, abstract: false, final false
  inline void set_scale(float_t value);

  /// @brief Method set_textAsset, addr 0x6bfce60, size 0x8, virtual false, abstract: false, final false
  inline void set_textAsset(::UnityEngine::TextCore::Text::TextAsset* value);

  /// @brief Method set_unicode, addr 0x6bff530, size 0x8, virtual false, abstract: false, final false
