...
public:
  // Declarations
  /// @brief Method GetLinkId, addr 0x49313cc, size 0x44, virtual false, abstract: false, final false
  inline ::StringW GetLinkId();

  /// @brief Method GetLinkText, addr 0x49312d4, size 0xf8, virtual false, abstract: false, final false
  inline ::StringW GetLinkText(::UnityEngine::TextCore::Text::TextInfo* textInfo);

  /// @brief Method SetLinkId, addr 0x49311f8, size 0xdc, virtual false, abstract: false, final false
