...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)(int32_t, ::UnityEngine::TextCore::Text::VertexDataLayout, bool)>(&::UnityEngine::TextCore::Text::MeshInfo::_ctor)> {
  constexpr static std::size_t size = 0x4ac;
  constexpr static std::size_t addrs = 0x6a718e8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::MeshInfo>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::TextCore::Text::VertexDataLayout>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)(int32_t, bool)>(&::UnityEngine::TextCore::Text::MeshInfo::ResizeMeshInfo)> {
  constexpr static std::size_t size = 0x244;
  constexpr static std::size_t addrs = 0x6a71d94;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)(bool)>(&::UnityEngine::TextCore::Text::MeshInfo::Clear)> {
  ...
  constexpr static std::size_t addrs = 0x6a71fd8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)()>(&::UnityEngine::TextCore::Text::MeshInfo::ClearUnusedVertices)> {
  ...
  constexpr static std::size_t addrs = 0x6a72044;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)(::UnityEngine::TextCore::Text::VertexSortingOrder)>(&::UnityEngine::TextCore::Text::MeshInfo::SortGeometry)> {
  constexpr static std::size_t size = 0xb8;
  constexpr static std::size_t addrs = 0x6a720c8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "SortGeometry",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::TextCore::Text::VertexSortingOrder>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::MeshInfo::*)(int32_t, int32_t)>(&::UnityEngine::TextCore::Text::MeshInfo::SwapVertexData)> {
  constexpr static std::size_t size = 0x72c;
  constexpr static std::size_t addrs = 0x6a72180;
...
::cordl_internals::setStaticField<::UnityEngine::Color32, "k_DefaultColor", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::MeshInfo>::get>(std::forward<::UnityEngine::Color32>(value));
}
...
::cordl_internals::setStaticField<::UnityEngine::Vector3, "k_DefaultNormal", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::MeshInfo>::get>(std::forward<::UnityEngine::Vector3>(value));
}
...
::cordl_internals::setStaticField<::UnityEngine::Vector4, "k_DefaultTangent", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::MeshInfo>::get>(std::forward<::UnityEngine::Vector4>(value));
}
...
// Ctor Parameters [CppParam { name: "vertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "vertexData", ty: "::ArrayW<::UnityEngine::TextCore::Text::TextCoreVertex,::Array<::UnityEngine::TextCore::Text::TextCoreVertex>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: Some("{}") }, CppParam { name: "vertices", ty: "::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "normals", ty: "::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "tangents", ty: "::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "vertexBufferSize", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "uvs0", ty: "::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "uvs2", ty: "::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "colors32", ty: "::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "triangles", ty: "::ArrayW<int32_t,::Array<int32_t>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "vertexDataLayout", ty: "::UnityEngine::TextCore::Text::VertexDataLayout", modifiers: "", def_value: Some("{}") }, CppParam { name: "applySDF", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "glyphRenderMode", ty: "::UnityEngine::TextCore::LowLevel::GlyphRenderMode", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::TextCore::Text::MeshInfo::MeshInfo(int32_t  vertexCount, ::ArrayW<::UnityEngine::TextCore::Text::TextCoreVertex,::Array<::UnityEngine::TextCore::Text::TextCoreVertex>*>  vertexData, ::UnityW<::UnityEngine::Material>  material, ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  vertices, ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  normals, ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  tangents, int32_t  vertexBufferSize, ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  uvs0, ::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  uvs2, ::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  colors32, ::ArrayW<int32_t,::Array<int32_t>*>  triangles, ::UnityEngine::TextCore::Text::VertexDataLayout  vertexDataLayout, bool  applySDF, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  glyphRenderMode) noexcept  {
