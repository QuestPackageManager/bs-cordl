...
public:
  ...
  /// @brief Method Equals, addr 0x492d548, size 0x10c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x492d0a0, size 0x4a8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::Text::TextGenerationSettings* other);

  /// @brief Method GetHashCode, addr 0x492d654, size 0x4d0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::TextCore::Text::TextGenerationSettings* New_ctor();

  /// @brief Method ToString, addr 0x492db2c, size 0x1aa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x492f5d4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method op_Equality, addr 0x492db24, size 0x8, virtual false, abstract: false, final false
