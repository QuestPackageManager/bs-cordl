...
public:
  ...
  /// @brief Method .ctor, addr 0x6c01304, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpriteGlyph", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpriteGlyph(SpriteGlyph&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpriteGlyph", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpriteGlyph(SpriteGlyphconst&) = delete;
