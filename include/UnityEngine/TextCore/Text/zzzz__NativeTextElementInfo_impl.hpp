...
// Ctor Parameters [CppParam { name: "glyphID", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bottomLeft", ty:
// "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "topLeft", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "topRight", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "bottomRight", ty: "::UnityEngine::TextCore::Text::TextCoreVertex", modifiers: "", def_value: Some("{}"), comment: None }]
