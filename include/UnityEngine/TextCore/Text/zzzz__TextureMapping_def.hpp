...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextCore::Text::TextureMapping, "UnityEngine.TextCore.Text", "TextureMapping");
// Dependencies
namespace UnityEngine::TextCore::Text {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TextCore::Text::TextureMapping) == 0x4, "Size mismatch!");
