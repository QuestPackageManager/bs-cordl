...
// CppParam { name: "padding", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "paddingMode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "packingMode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "atlasWidth", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "atlasHeight", ty:
// "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "characterSetSelectionMode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "characterSequence", ty:
// "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "referencedFontAssetGUID", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name:
// "referencedTextAssetGUID", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "fontStyle", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "fontStyleModifier", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "renderMode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "includeFontFeatures", ty: "bool", modifiers: "", def_value: Some("{}") }]
