...
public:
  ...
  /// @brief Method .ctor, addr 0x4931728, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x4930848, size 0x8, virtual false, abstract: false, final false
