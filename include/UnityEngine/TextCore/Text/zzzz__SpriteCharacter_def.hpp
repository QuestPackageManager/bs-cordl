...
public:
  ...
  /// @brief Method .ctor, addr 0x69ccbb0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x69cbcac, size 0x8, virtual false, abstract: false, final false
