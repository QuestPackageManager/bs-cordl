...
namespace UnityEngine::TextCore::Text {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13659))]
...
public:
  ...
  /// @brief Method get_name, addr 0x2d692a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  static inline ::UnityEngine::TextCore::Text::SpriteCharacter* New_ctor();

  /// @brief Method .ctor, addr 0x2d692a8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
