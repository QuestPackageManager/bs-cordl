...
public:
  ...
  /// @brief Method .ctor, addr 0x49313c0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x49304e0, size 0x8, virtual false, abstract: false, final false
