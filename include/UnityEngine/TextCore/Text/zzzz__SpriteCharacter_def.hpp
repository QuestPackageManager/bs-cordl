...
public:
  ...
  /// @brief Method .ctor, addr 0x6aa833c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x6aa7438, size 0x8, virtual false, abstract: false, final false
