...
namespace UnityEngine::TextCore {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15527)), TypeDefinitionIndex(TypeDefinitionIndex(15529)), TypeDefinitionIndex(TypeDefinitionIndex(2613)),
// TypeDefinitionIndex(TypeDefinitionIndex(15528))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15530)) CS Name: ::UnityEngine.TextCore::Glyph*
...
public:
  ...
  /// @brief Method get_index addr 0x2d209bc size 0x8 virtual false final false
  inline uint32_t get_index();

  /// @brief Method set_index addr 0x2d209c4 size 0x8 virtual false final false
  inline void set_index(uint32_t value);

  /// @brief Method get_metrics addr 0x2d209cc size 0x14 virtual false final false
  inline ::UnityEngine::TextCore::GlyphMetrics get_metrics();

  /// @brief Method set_metrics addr 0x2d209e0 size 0x14 virtual false final false
  inline void set_metrics(::UnityEngine::TextCore::GlyphMetrics value);

  /// @brief Method get_glyphRect addr 0x2d209f4 size 0xc virtual false final false
  inline ::UnityEngine::TextCore::GlyphRect get_glyphRect();

  /// @brief Method set_glyphRect addr 0x2d20a00 size 0x8 virtual false final false
  inline void set_glyphRect(::UnityEngine::TextCore::GlyphRect value);

  /// @brief Method get_scale addr 0x2d20a08 size 0x8 virtual false final false
  inline float_t get_scale();

  /// @brief Method set_scale addr 0x2d20a10 size 0x8 virtual false final false
  inline void set_scale(float_t value);

  /// @brief Method get_atlasIndex addr 0x2d20a18 size 0x8 virtual false final false
  inline int32_t get_atlasIndex();

  /// @brief Method set_atlasIndex addr 0x2d20a20 size 0x8 virtual false final false
  inline void set_atlasIndex(int32_t value);

  static inline ::UnityEngine::TextCore::Glyph* New_ctor();

  /// @brief Method .ctor addr 0x2d20a28 size 0x28 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::TextCore::Glyph* New_ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct glyphStruct);

  /// @brief Method .ctor addr 0x2d20a50 size 0x8c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d20adc size 0x70 virtual false final false
