...
namespace UnityEngine::TextCore {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15512)), TypeDefinitionIndex(TypeDefinitionIndex(15513)), TypeDefinitionIndex(TypeDefinitionIndex(15511)),
// TypeDefinitionIndex(TypeDefinitionIndex(2611))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15514)) CS Name: ::UnityEngine.TextCore::Glyph*
...
public:
  ...
  /// @brief Method get_index addr 0x2bb960c size 0x8 virtual false final false
  inline uint32_t get_index();

  /// @brief Method set_index addr 0x2bb9614 size 0x8 virtual false final false
  inline void set_index(uint32_t value);

  /// @brief Method get_metrics addr 0x2bb961c size 0x14 virtual false final false
  inline ::UnityEngine::TextCore::GlyphMetrics get_metrics();

  /// @brief Method set_metrics addr 0x2bb9630 size 0x14 virtual false final false
  inline void set_metrics(::UnityEngine::TextCore::GlyphMetrics value);

  /// @brief Method get_glyphRect addr 0x2bb9644 size 0xc virtual false final false
  inline ::UnityEngine::TextCore::GlyphRect get_glyphRect();

  /// @brief Method set_glyphRect addr 0x2bb9650 size 0x8 virtual false final false
  inline void set_glyphRect(::UnityEngine::TextCore::GlyphRect value);

  /// @brief Method get_scale addr 0x2bb9658 size 0x8 virtual false final false
  inline float_t get_scale();

  /// @brief Method set_scale addr 0x2bb9660 size 0x8 virtual false final false
  inline void set_scale(float_t value);

  /// @brief Method get_atlasIndex addr 0x2bb9668 size 0x8 virtual false final false
  inline int32_t get_atlasIndex();

  /// @brief Method set_atlasIndex addr 0x2bb9670 size 0x8 virtual false final false
  inline void set_atlasIndex(int32_t value);

  static inline ::UnityEngine::TextCore::Glyph* New_ctor();

  /// @brief Method .ctor addr 0x2bb9678 size 0x28 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::TextCore::Glyph* New_ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct glyphStruct);

  /// @brief Method .ctor addr 0x2bb96a0 size 0x8c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2bb972c size 0x70 virtual false final false
