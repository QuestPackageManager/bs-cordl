...
public:
// Declarations
/// @brief Method ToString, addr 0x69f6fe0, size 0x4a0, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "startIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fontAsset", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "fontSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "fontStyle", ty: "::UnityEngine::TextCore::Text::FontStyles", modifiers: "", def_value: None }, CppParam { name: "fontWeight", ty: "::UnityEngine::TextCore::Text::TextFontWeight", modifiers: "", def_value: None }, CppParam { name: "linkID", ty: "int32_t", modifiers: "", def_value: None }]
constexpr TextSpan(int32_t  startIndex, int32_t  length, ::System::IntPtr  fontAsset, int32_t  fontSize, ::UnityEngine::Color32  color, ::UnityEngine::TextCore::Text::FontStyles  fontStyle, ::UnityEngine::TextCore::Text::TextFontWeight  fontWeight, int32_t  linkID) noexcept;
