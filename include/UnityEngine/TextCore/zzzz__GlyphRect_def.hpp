...
public:
  ...
  /// @brief Method Equals, addr 0x49245b4, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x492462c, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::TextCore::GlyphRect other);

  /// @brief Method GetHashCode, addr 0x4924550, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x4924544, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_height, addr 0x49244e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_width, addr 0x49244dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method get_x, addr 0x49244cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_x();

  /// @brief Method get_y, addr 0x49244d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_y();

  /// @brief Method get_zero, addr 0x49244ec, size 0x58, virtual false, abstract: false, final false
