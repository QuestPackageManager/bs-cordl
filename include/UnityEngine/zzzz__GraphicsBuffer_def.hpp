...
public:
  // Declarations
  /// @brief Method ConvertToManaged, addr 0x694b2c4, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::GraphicsBuffer* ConvertToManaged(::System::IntPtr ptr);

  /// @brief Method ConvertToNative, addr 0x694b314, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginBufferWrite, addr 0x694afd0, size 0x68, virtual false, abstract: false, final false
  inline void* BeginBufferWrite(int32_t offset, int32_t size);

  /// @brief Method BeginBufferWrite_Injected, addr 0x694b038, size 0x54, virtual false, abstract: false, final false
  static inline void* BeginBufferWrite_Injected(::System::IntPtr _unity_self, int32_t offset, int32_t size);

  /// @brief Method DestroyBuffer, addr 0x694a444, size 0x48, virtual false, abstract: false, final false
  static inline void DestroyBuffer(::UnityEngine::GraphicsBuffer* buf);

  /// @brief Method DestroyBuffer_Injected, addr 0x694a500, size 0x3c, virtual false, abstract: false, final false
  static inline void DestroyBuffer_Injected(::System::IntPtr buf);

  /// @brief Method Dispose, addr 0x694a3dc, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x694a30c, size 0xd0, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndBufferWrite, addr 0x694b08c, size 0x58, virtual false, abstract: false, final false
  inline void EndBufferWrite(int32_t bytesWritten);

  /// @brief Method EndBufferWrite_Injected, addr 0x694b0e4, size 0x44, virtual false, abstract: false, final false
  static inline void EndBufferWrite_Injected(::System::IntPtr _unity_self, int32_t bytesWritten);

  /// @brief Method Finalize, addr 0x694a2c4, size 0x48, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetUsageFlags, addr 0x694aa70, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer_UsageFlags GetUsageFlags();

  /// @brief Method GetUsageFlags_Injected, addr 0x694aac0, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::GraphicsBuffer_UsageFlags GetUsageFlags_Injected(::System::IntPtr _unity_self);

  /// @brief Method InitBuffer, addr 0x694a4a4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalInitialization, addr 0x694a558, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetData, addr 0x694add8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetData_Injected, addr 0x694af5c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetNativeData, addr 0x694ae60, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetNativeData_Injected, addr 0x694aee8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x694a908, size 0x50, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method IsValidBuffer, addr 0x694a884, size 0x48, virtual false, abstract: false, final false
  static inline bool IsValidBuffer(::UnityEngine::GraphicsBuffer* buf);

  /// @brief Method IsValidBuffer_Injected, addr 0x694a8cc, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValidBuffer_Injected(::System::IntPtr buf);

  /// @brief Method IsVertexIndexOrCopyOnly, addr 0x694a498, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x694a880, size 0x4, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method RequiresCompute, addr 0x694a48c, size 0xc, virtual false, abstract: false, final false
  static inline bool RequiresCompute(::UnityEngine::GraphicsBuffer_Target target);

  /// @brief Method SetData, addr 0x694aba4, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method SetName, addr 0x694b12c, size 0x154, virtual false, abstract: false, final false
  inline void SetName(::StringW name);

  /// @brief Method SetName_Injected, addr 0x694b280, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x694a53c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method .ctor, addr 0x694a544, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GraphicsBuffer_Target target, int32_t count, int32_t stride);

  /// @brief Method .ctor, addr 0x694a87c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bufferHandle, addr 0x694ab00, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBufferHandle get_bufferHandle();

  /// @brief Method get_bufferHandle_Injected, addr 0x694ab60, size 0x44, virtual false, abstract: false, final false
  static inline void get_bufferHandle_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::GraphicsBufferHandle> ret);

  /// @brief Method get_count, addr 0x694a958, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method get_count_Injected, addr 0x694a9a8, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_count_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_stride, addr 0x694a9e4, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_stride();

  /// @brief Method get_stride_Injected, addr 0x694aa34, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_stride_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_usageFlags, addr 0x694aafc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer_UsageFlags get_usageFlags();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_name, addr 0x694b128, size 0x4, virtual false, abstract: false, final false
