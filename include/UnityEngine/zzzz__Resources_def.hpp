...
public:
  ...
  /// @brief Method FindObjectsOfTypeAll, addr 0x48a5264, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBuiltinResource, addr 0x48a54c4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Load, addr 0x48a52cc, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Object> Load(::StringW path);

  /// @brief Method Load, addr 0x48a4d5c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAll, addr 0x48a5440, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Object>, ::Array<::UnityW<::UnityEngine::Object>>*> LoadAll(::StringW path);

  /// @brief Method LoadAll, addr 0x48a53c8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAsync, addr 0x48a5350, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::ResourceRequest* LoadAsync(::StringW path, ::System::Type* type);

  /// @brief Method UnloadAsset, addr 0x48a5508, size 0x68, virtual false, abstract: false, final false
  static inline void UnloadAsset(::UnityEngine::Object* assetToUnload);

  /// @brief Method UnloadUnusedAssets, addr 0x48a5570, size 0x28, virtual false, abstract: false, final false
