...
public:
  ...
  /// @brief Method FindObjectsOfTypeAll, addr 0x690ea5c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBuiltinResource, addr 0x690ec24, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBuiltinResource_Injected, addr 0x690eeb0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Load, addr 0x690eac8, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Object> Load(::StringW path);

  /// @brief Method Load, addr 0x690dff0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAll, addr 0x690ebb4, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Object>, ::Array<::UnityW<::UnityEngine::Object>>*> LoadAll(::StringW path);

  /// @brief Method LoadAll, addr 0x690eb38, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadUnusedAssets, addr 0x690eef4, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadUnusedAssets();

  /// @brief Method UnloadUnusedAssets_Injected, addr 0x690ef2c, size 0x28, virtual false, abstract: false, final false
