...
public:
  ...
  /// @brief Method FindObjectsOfTypeAll, addr 0x6ad6250, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBuiltinResource, addr 0x6ad6418, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBuiltinResource_Injected, addr 0x6ad66a4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Load, addr 0x6ad62bc, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Object> Load(::StringW path);

  /// @brief Method Load, addr 0x6ad57e4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAll, addr 0x6ad63a8, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Object>> LoadAll(::StringW path);

  /// @brief Method LoadAll, addr 0x6ad632c, size 0x7c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Object>> LoadAll(::StringW path, ::System::Type* systemTypeInstance);

  /// @brief Method UnloadUnusedAssets, addr 0x6ad66e8, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadUnusedAssets();

  /// @brief Method UnloadUnusedAssets_Injected, addr 0x6ad6720, size 0x28, virtual false, abstract: false, final false
