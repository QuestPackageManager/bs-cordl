...
/// @brief Method GetContactPair, addr 0x69c4904, size 0x4, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::ContactPair> GetContactPair(int32_t  index) ;

/// @brief Method GetContactPair_Internal, addr 0x69c80cc, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::ContactPair* GetContactPair_Internal(int32_t  index) ;

/// @brief Method get_Body, addr 0x69c814c, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_Body() ;

/// @brief Method get_BodyInstanceID, addr 0x69c813c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_BodyInstanceID() ;

/// @brief Method get_OtherBody, addr 0x69c8150, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_OtherBody() ;

/// @brief Method get_OtherBodyInstanceID, addr 0x69c8144, size 0x8, virtual false, abstract: false, final false
inline int32_t get_OtherBodyInstanceID() ;

/// @brief Method get_PairCount, addr 0x69c8154, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PairCount() ;

/// @brief Method get_body, addr 0x69a685c, size 0x5c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_body() ;

/// @brief Method get_bodyInstanceID, addr 0x69c80b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bodyInstanceID() ;

/// @brief Method get_hasRemovedBody, addr 0x69c48f4, size 0x10, virtual false, abstract: false, final false
inline bool get_hasRemovedBody() ;

/// @brief Method get_otherBody, addr 0x69a6800, size 0x5c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_otherBody() ;

/// @brief Method get_otherBodyInstanceID, addr 0x69c80bc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_otherBodyInstanceID() ;

/// @brief Method get_pairCount, addr 0x69c80c4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_pairCount() ;
