...
// Write type traits
MARK_REF_T(::UnityEngine::WaitWhile*);
DEFINE_IL2CPP_CLASS(::UnityEngine::WaitWhile*, "UnityEngine", "WaitWhile");
...
public:
  ...
  /// @brief Method GetTime, addr 0x6aec1cc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6aec1bc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Func_1<bool>* predicate);

  /// @brief Method get_keepWaiting, addr 0x6aec0fc, size 0xc0, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaitWhile", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaitWhile(WaitWhile&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaitWhile", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaitWhile(WaitWhileconst&) = delete;
...
static_assert(sizeof(::UnityEngine::WaitWhile) == 0x30, "Size mismatch!");
