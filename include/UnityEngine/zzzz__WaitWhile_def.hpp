...
public:
  ...
  /// @brief Method GetTime, addr 0x68b8b38, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68b8b28, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Func_1<bool>* predicate);

  /// @brief Method get_keepWaiting, addr 0x68b8a68, size 0xc0, virtual true, abstract: false, final false
