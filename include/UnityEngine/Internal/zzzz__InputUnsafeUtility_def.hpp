...
public:
// Declarations
/// @brief Method GetAxis, addr 0x6996770, size 0x128, virtual false, abstract: false, final false
static inline float_t GetAxis(::StringW  axisName) ;

/// @brief Method GetAxisRaw, addr 0x699689c, size 0x128, virtual false, abstract: false, final false
static inline float_t GetAxisRaw(::StringW  axisName) ;

/// @brief Method GetAxisRaw_Injected, addr 0x69989ec, size 0x3c, virtual false, abstract: false, final false
static inline float_t GetAxisRaw_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  axisName) ;

/// @brief Method GetAxisRaw__Unmanaged, addr 0x6998a28, size 0x44, virtual false, abstract: false, final false
static inline float_t GetAxisRaw__Unmanaged(uint8_t*  axisName, int32_t  axisNameLen) ;

/// @brief Method GetAxis_Injected, addr 0x699896c, size 0x3c, virtual false, abstract: false, final false
static inline float_t GetAxis_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  axisName) ;

/// @brief Method GetAxis__Unmanaged, addr 0x69989a8, size 0x44, virtual false, abstract: false, final false
static inline float_t GetAxis__Unmanaged(uint8_t*  axisName, int32_t  axisNameLen) ;

/// @brief Method GetButton, addr 0x69969c8, size 0x130, virtual false, abstract: false, final false
static inline bool GetButton(::StringW  buttonName) ;

/// @brief Method GetButtonDown, addr 0x6996afc, size 0x130, virtual false, abstract: false, final false
static inline bool GetButtonDown(::StringW  buttonName) ;

/// @brief Method GetButtonDown_Injected, addr 0x6998aec, size 0x3c, virtual false, abstract: false, final false
static inline bool GetButtonDown_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  buttonName) ;

/// @brief Method GetButtonDown__Unmanaged, addr 0x6998b28, size 0x44, virtual false, abstract: false, final false
static inline uint8_t GetButtonDown__Unmanaged(uint8_t*  buttonName, int32_t  buttonNameLen) ;

/// @brief Method GetButtonUp__Unmanaged, addr 0x6998b6c, size 0x44, virtual false, abstract: false, final false
static inline bool GetButtonUp__Unmanaged(uint8_t*  buttonName, int32_t  buttonNameLen) ;

/// @brief Method GetButton_Injected, addr 0x6998a6c, size 0x3c, virtual false, abstract: false, final false
static inline bool GetButton_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  buttonName) ;

/// @brief Method GetButton__Unmanaged, addr 0x6998aa8, size 0x44, virtual false, abstract: false, final false
static inline bool GetButton__Unmanaged(uint8_t*  buttonName, int32_t  buttonNameLen) ;

/// @brief Method GetKeyDownString__Unmanaged, addr 0x6998928, size 0x44, virtual false, abstract: false, final false
static inline bool GetKeyDownString__Unmanaged(uint8_t*  name, int32_t  nameLen) ;

/// @brief Method GetKeyString__Unmanaged, addr 0x69988a0, size 0x44, virtual false, abstract: false, final false
static inline bool GetKeyString__Unmanaged(uint8_t*  name, int32_t  nameLen) ;

/// @brief Method GetKeyUpString__Unmanaged, addr 0x69988e4, size 0x44, virtual false, abstract: false, final false
