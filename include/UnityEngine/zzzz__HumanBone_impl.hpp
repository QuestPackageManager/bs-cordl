...
// Ctor Parameters [CppParam { name: "m_BoneName", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_HumanName", ty: "::StringW", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "limit", ty: "::UnityEngine::HumanLimit", modifiers: "", def_value: Some("{}"), comment: None }]
