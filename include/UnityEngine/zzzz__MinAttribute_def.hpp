...
public:
  ...
  /// @brief Method .ctor, addr 0x690d550, size 0xc, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::MinAttribute, 0x20>, "Size mismatch!");
