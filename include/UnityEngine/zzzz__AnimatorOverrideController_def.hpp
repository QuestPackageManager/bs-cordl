...
public:
// Declarations
/// @brief Method Invoke, addr 0x6875ca4, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;
...
/// @brief Method .ctor, addr 0x6875c3c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method ApplyOverrides, addr 0x68759f0, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method Internal_Create, addr 0x6875714, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Internal_Create_Injected, addr 0x68757a4, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method OnInvalidateOverrideController, addr 0x6875c14, size 0x28, virtual false, abstract: false, final false
static inline void OnInvalidateOverrideController(::UnityEngine::AnimatorOverrideController*  controller) ;

/// @brief Method SendNotification, addr 0x6875934, size 0x80, virtual false, abstract: false, final false
inline void SendNotification() ;

/// @brief Method SendNotification_Injected, addr 0x68759b4, size 0x3c, virtual false, abstract: false, final false
static inline void SendNotification_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method SetClip, addr 0x68757e8, size 0xf0, virtual false, abstract: false, final false
inline void SetClip(::UnityEngine::AnimationClip*  originalClip, ::UnityEngine::AnimationClip*  overrideClip, bool  notify) ;

/// @brief Method SetClip_Injected, addr 0x68758d8, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x687568c, size 0x30, virtual false, abstract: false, final false
