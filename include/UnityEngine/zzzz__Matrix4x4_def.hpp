...
public:
  ...
  /// @brief Method DecomposeProjection, addr 0x6974d98, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::FrustumPlanes DecomposeProjection();

  /// @brief Method DecomposeProjection_Injected, addr 0x6974e00, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x6975bcc, size 0xfc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x6975cc8, size 0x9c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Matrix4x4 other);

  /// @brief Method Frustum, addr 0x69756dc, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Frustum(::UnityEngine::FrustumPlanes fp);

  /// @brief Method Frustum, addr 0x69755ac, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Frustum_Injected, addr 0x6975658, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColumn, addr 0x6975afc, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetColumn(int32_t index);

  /// @brief Method GetHashCode, addr 0x6975988, size 0x174, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetLossyScale, addr 0x6974cf8, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetLossyScale();

  /// @brief Method GetLossyScale_Injected, addr 0x6974d54, size 0x44, virtual false, abstract: false, final false
  static inline void GetLossyScale_Injected(::ByRef<::UnityEngine::Matrix4x4> _unity_self, ::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method GetPosition, addr 0x6975f0c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPosition();

  /// @brief Method GetRotation, addr 0x6974c5c, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetRotation();

  /// @brief Method GetRotation_Injected, addr 0x6974cb4, size 0x44, virtual false, abstract: false, final false
  static inline void GetRotation_Injected(::ByRef<::UnityEngine::Matrix4x4> _unity_self, ::ByRef<::UnityEngine::Quaternion> ret);

  /// @brief Method GetRow, addr 0x6975e3c, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetRow(int32_t index);

  /// @brief Method Inverse, addr 0x6975030, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Inverse(::UnityEngine::Matrix4x4 m);

  /// @brief Method Inverse3DAffine, addr 0x6974fa8, size 0x44, virtual false, abstract: false, final false
  static inline bool Inverse3DAffine(::UnityEngine::Matrix4x4 input, ::ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method Inverse3DAffine_Injected, addr 0x6974fec, size 0x44, virtual false, abstract: false, final false
  static inline bool Inverse3DAffine_Injected(::ByRef<::UnityEngine::Matrix4x4> input, ::ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method Inverse_Injected, addr 0x697509c, size 0x44, virtual false, abstract: false, final false
  static inline void Inverse_Injected(::ByRef<::UnityEngine::Matrix4x4> m, ::ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method LookAt, addr 0x69754c0, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 LookAt(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 to, ::UnityEngine::Vector3 up);

  /// @brief Method LookAt_Injected, addr 0x6975550, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyPoint, addr 0x6975f90, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyPoint(::UnityEngine::Vector3 point);

  /// @brief Method MultiplyPoint3x4, addr 0x697601c, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyPoint3x4(::UnityEngine::Vector3 point);

  /// @brief Method MultiplyVector, addr 0x6976074, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 MultiplyVector(::UnityEngine::Vector3 vector);

  /// @brief Method Ortho, addr 0x6975290, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Ortho_Injected, addr 0x697533c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Perspective, addr 0x69753c0, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Perspective(float_t fov, float_t aspect, float_t zNear, float_t zFar);

  /// @brief Method Perspective_Injected, addr 0x6975454, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rotate, addr 0x697611c, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Rotate(::UnityEngine::Quaternion q);

  /// @brief Method Scale, addr 0x69760bc, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Scale(::UnityEngine::Vector3 vector);

  /// @brief Method SetColumn, addr 0x6975f18, size 0x78, virtual false, abstract: false, final false
  inline void SetColumn(int32_t index, ::UnityEngine::Vector4 column);

  /// @brief Method TRS, addr 0x6974ebc, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 TRS(::UnityEngine::Vector3 pos, ::UnityEngine::Quaternion q, ::UnityEngine::Vector3 s);

  /// @brief Method TRS_Injected, addr 0x6974f4c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x697626c, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x697627c, size 0x518, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method Translate, addr 0x69760e8, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Translate(::UnityEngine::Vector3 vector);

  /// @brief Method Transpose, addr 0x6975160, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 Transpose(::UnityEngine::Matrix4x4 m);

  /// @brief Method Transpose_Injected, addr 0x69751cc, size 0x44, virtual false, abstract: false, final false
  static inline void Transpose_Injected(::ByRef<::UnityEngine::Matrix4x4> m, ::ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method .ctor, addr 0x6975784, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x69757a8, size 0xec, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x69757a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t row, int32_t column);

  /// @brief Method get_decomposeProjection, addr 0x6974e4c, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::FrustumPlanes get_decomposeProjection();

  /// @brief Method get_identity, addr 0x6976210, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 get_identity();

  /// @brief Method get_inverse, addr 0x69750e0, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_inverse();

  /// @brief Method get_lossyScale, addr 0x6974e48, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_lossyScale();

  /// @brief Method get_rotation, addr 0x6974e44, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_transpose, addr 0x6975210, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_transpose();

  /// @brief Method get_zero, addr 0x69761b4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Multiply, addr 0x6975d64, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 op_Multiply(::UnityEngine::Matrix4x4 lhs, ::UnityEngine::Matrix4x4 rhs);

  /// @brief Method op_Multiply, addr 0x6975e08, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x697589c, size 0xec, virtual false, abstract: false, final false
  inline void set_Item(int32_t index, float_t value);

  /// @brief Method set_Item, addr 0x6975894, size 0x8, virtual false, abstract: false, final false
