...
public:
// Declarations
/// @brief Method GetMovedFromAttributeDataForType, addr 0x69306fc, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method GetObsoleteTypeRedirection, addr 0x6930830, size 0x2c4, virtual false, abstract: false, final false
