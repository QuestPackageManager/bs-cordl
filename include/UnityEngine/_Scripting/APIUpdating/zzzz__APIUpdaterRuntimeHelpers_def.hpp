...
public:
  // Declarations
  /// @brief Method GetMovedFromAttributeDataForType addr 0x2b7f018 size 0x140 virtual false final false
  ...
  /// @brief Method GetObsoleteTypeRedirection addr 0x2b7f158 size 0x2bc virtual false final false
