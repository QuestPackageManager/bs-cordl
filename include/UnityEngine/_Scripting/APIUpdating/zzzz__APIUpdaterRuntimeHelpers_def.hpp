...
public:
  // Declarations
  /// @brief Method GetMovedFromAttributeDataForType, addr 0x48b72a0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObsoleteTypeRedirection, addr 0x48b73dc, size 0x2b8, virtual false, abstract: false, final false
