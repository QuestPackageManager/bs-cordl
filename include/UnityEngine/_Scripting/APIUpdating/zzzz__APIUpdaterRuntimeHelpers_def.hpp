...
public:
  // Declarations
  /// @brief Method GetMovedFromAttributeDataForType addr 0x2ce60f8 size 0x140 virtual false final false
  ...
  /// @brief Method GetObsoleteTypeRedirection addr 0x2ce6238 size 0x2bc virtual false final false
