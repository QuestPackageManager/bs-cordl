...
public:
  ...
  /// @brief Method ExtractFormattedStackTrace, addr 0x48af060, size 0x70c, virtual false, abstract: false, final false
  static inline ::StringW ExtractFormattedStackTrace(::System::Diagnostics::StackTrace* stackTrace);

  /// @brief Method ExtractStackTrace, addr 0x48aef04, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW ExtractStackTrace();

  /// @brief Method ExtractStringFromExceptionInternal, addr 0x48af76c, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProjectFolder, addr 0x48aee28, size 0xdc, virtual false, abstract: false, final false
