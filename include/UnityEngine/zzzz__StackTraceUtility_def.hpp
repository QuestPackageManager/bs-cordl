...
public:
  ...
  /// @brief Method SetProjectFolder addr 0x2b6b234 size 0xdc virtual false final false
  static inline void SetProjectFolder(::StringW folder);

  /// @brief Method ExtractStackTrace addr 0x2b6b310 size 0x164 virtual false final false
  static inline ::StringW ExtractStackTrace();

  /// @brief Method ExtractStringFromExceptionInternal addr 0x2b6bb1c size 0x368 virtual false final false
  ...
  /// @brief Method ExtractFormattedStackTrace addr 0x2b6b474 size 0x6a8 virtual false final false
