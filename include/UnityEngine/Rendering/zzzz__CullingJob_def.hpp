...
public:
  ...
  /// @brief Method CalculateLODVisibility, addr 0x66d2298, size 0x4b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateVisibilityMask, addr 0x66d2750, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x66d294c, size 0x1cc, virtual true, abstract: false, final true
  inline void Execute(int32_t instanceIndex);

  /// @brief Method PackFloatToUint8, addr 0x66d2238, size 0x60, virtual false, abstract: false, final false
