...
// Ctor Parameters [CppParam { name: "_Offset_LayerCount", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_MinLoadedCellInEntries_IndirectionEntryDim", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_MaxLoadedCellInEntries_RcpIndirectionEntryDim", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_PoolDim_MinBrickSize", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_RcpPoolDim_XY", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_MinEntryPos_Noise", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_EntryCount_X_XY_LeakReduction", ty: "::Unity::Mathematics::uint4", modifiers: "", def_value: None }, CppParam { name: "_Biases_NormalizationClamp", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_FrameIndex_Weights", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "_ProbeVolumeLayerMask", ty: "::Unity::Mathematics::uint4", modifiers: "", def_value: None }]
constexpr ShaderVariablesProbeVolumes(::UnityEngine::Vector4  _Offset_LayerCount, ::UnityEngine::Vector4  _MinLoadedCellInEntries_IndirectionEntryDim, ::UnityEngine::Vector4  _MaxLoadedCellInEntries_RcpIndirectionEntryDim, ::UnityEngine::Vector4  _PoolDim_MinBrickSize, ::UnityEngine::Vector4  _RcpPoolDim_XY, ::UnityEngine::Vector4  _MinEntryPos_Noise, ::Unity::Mathematics::uint4  _EntryCount_X_XY_LeakReduction, ::UnityEngine::Vector4  _Biases_NormalizationClamp, ::UnityEngine::Vector4  _FrameIndex_Weights, ::Unity::Mathematics::uint4  _ProbeVolumeLayerMask) noexcept;
