...
/// @brief Method ConvertToParameters, addr 0x6963640, size 0x750, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x696351c, size 0x124, virtual false, abstract: false, final false
inline bool IsValid() ;

static inline ::UnityEngine::Rendering::ShaderTagId getStaticF_s_EmptyName() ;

/// @brief Method get_batchLayerMask, addr 0x69634f0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_batchLayerMask() ;

/// @brief Method get_camera, addr 0x6963504, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_camera() ;

/// @brief Method get_cullingResult, addr 0x69634f8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CullingResults get_cullingResult() ;

/// @brief Method get_passName, addr 0x696350c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ShaderTagId get_passName() ;

/// @brief Method get_passNames, addr 0x6963514, size 0x8, virtual false, abstract: false, final false
