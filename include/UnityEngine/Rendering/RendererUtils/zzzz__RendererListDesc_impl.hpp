...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint32_t (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::get_batchLayerMask)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x69634f0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::CullingResults (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::get_cullingResult)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x69634f8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Camera> (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::get_camera)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6963504;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::ShaderTagId (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::get_passName)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x696350c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Rendering::ShaderTagId,::Array<::UnityEngine::Rendering::ShaderTagId>*> (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::get_passNames)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6963514;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::RendererUtils::RendererListDesc::*)()>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::IsValid)> {
  constexpr static std::size_t size = 0x124;
  constexpr static std::size_t addrs = 0x696351c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::RendererListParams (*)(::ByRef<::UnityEngine::Rendering::RendererUtils::RendererListDesc>)>(&::UnityEngine::Rendering::RendererUtils::RendererListDesc::ConvertToParameters)> {
  constexpr static std::size_t size = 0x750;
  constexpr static std::size_t addrs = 0x6963640;
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::ShaderTagId, "s_EmptyName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RendererUtils::RendererListDesc>::get>(std::forward<::UnityEngine::Rendering::ShaderTagId>(value));
}
inline ::UnityEngine::Rendering::ShaderTagId UnityEngine::Rendering::RendererUtils::RendererListDesc::getStaticF_s_EmptyName()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::ShaderTagId, "s_EmptyName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RendererUtils::RendererListDesc>::get>();
}
...
inline ::UnityEngine::Rendering::RendererListParams UnityEngine::Rendering::RendererUtils::RendererListDesc::ConvertToParameters(::ByRef<::UnityEngine::Rendering::RendererUtils::RendererListDesc>  desc)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RendererUtils::RendererListDesc>::get(),
                        "ConvertToParameters",
                        std::span<const Il2CppClass* const, 0>(),
