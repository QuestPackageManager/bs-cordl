...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TProfilingSampler_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TProfilingSampler_1(TProfilingSampler_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TProfilingSampler_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TProfilingSampler_1(TProfilingSampler_1const&) = delete;
