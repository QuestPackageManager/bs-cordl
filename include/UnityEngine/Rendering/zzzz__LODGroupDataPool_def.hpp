...
public:
  ...
  /// @brief Method Dispose, addr 0x66ecfb0, size 0xb8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FreeLODGroupData, addr 0x66ed48c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateLODGroupData, addr 0x66ed1e4, size 0x2a8, virtual false, abstract: false, final false
  inline void UpdateLODGroupData(::ByRef<::UnityEngine::Rendering::GPUDrivenLODGroupData> inputData);

  /// @brief Method UpdateLODGroupTransformData, addr 0x66ed068, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ece94, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeLodGroupCount, addr 0x66ece30, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_activeLodGroupCount();

  /// @brief Method get_crossfadedRendererCount, addr 0x66ece28, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_crossfadedRendererCount();

  /// @brief Method get_lodGroupCullingData, addr 0x66ece20, size 0x8, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData> get_lodGroupCullingData();

  /// @brief Method get_lodGroupDataHash, addr 0x66ece14, size 0xc, virtual false, abstract: false, final false
