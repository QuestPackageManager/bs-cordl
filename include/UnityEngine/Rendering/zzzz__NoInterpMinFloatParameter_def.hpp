...
public:
  ...
  /// @brief Method .ctor, addr 0x67ccd50, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t min, bool overrideState);

  /// @brief Method get_value, addr 0x67ccd34, size 0x8, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_value, addr 0x67ccd3c, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMinFloatParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInterpMinFloatParameter(NoInterpMinFloatParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMinFloatParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInterpMinFloatParameter(NoInterpMinFloatParameterconst&) = delete;
