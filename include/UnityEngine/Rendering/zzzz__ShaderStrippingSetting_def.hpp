...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x665e620, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x665e790, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_exportShaderVariants, addr 0x665e628, size 0x8, virtual false, abstract: false, final false
  inline bool get_exportShaderVariants();

  /// @brief Method get_shaderVariantLogLevel, addr 0x665e6a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ShaderVariantLogLevel get_shaderVariantLogLevel();

  /// @brief Method get_stripRuntimeDebugShaders, addr 0x665e718, size 0x8, virtual false, abstract: false, final false
  inline bool get_stripRuntimeDebugShaders();

  /// @brief Method get_version, addr 0x665e618, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_version();

  /// @brief Convert to "::UnityEngine::Rendering::IRenderPipelineGraphicsSettings"
  constexpr ::UnityEngine::Rendering::IRenderPipelineGraphicsSettings* i___UnityEngine__Rendering__IRenderPipelineGraphicsSettings() noexcept;

  /// @brief Method set_exportShaderVariants, addr 0x665e630, size 0x70, virtual false, abstract: false, final false
  inline void set_exportShaderVariants(bool value);

  /// @brief Method set_shaderVariantLogLevel, addr 0x665e6a8, size 0x70, virtual false, abstract: false, final false
  inline void set_shaderVariantLogLevel(::UnityEngine::Rendering::ShaderVariantLogLevel value);

  /// @brief Method set_stripRuntimeDebugShaders, addr 0x665e720, size 0x70, virtual false, abstract: false, final false
