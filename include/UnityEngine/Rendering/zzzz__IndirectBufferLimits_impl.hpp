...
// Ctor Parameters [CppParam { name: "maxInstanceCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "maxDrawCount", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
