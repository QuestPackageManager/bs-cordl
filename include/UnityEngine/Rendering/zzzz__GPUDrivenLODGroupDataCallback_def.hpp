...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x696049c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6960420, size 0x7c, virtual false, abstract: false, final false
