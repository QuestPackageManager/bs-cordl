...
public:
// Declarations
/// @brief Method Invoke, addr 0x6960b5c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6960ae0, size 0x7c, virtual false, abstract: false, final false
