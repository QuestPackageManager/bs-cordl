...
/// @brief Method <RelayoutEntries>b__23_0, addr 0x65f436c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65f4368, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_RequestedTextures, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RequestedTextures, put=__cordl_internal_set_m_RequestedTextures)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::Vector2Int>*  m_RequestedTextures;

 __declspec(property(get=get_mipPadding)) int32_t  mipPadding;

/// @brief Method AllocateTexture, addr 0x65f3874, size 0x1ec, virtual true, abstract: false, final false
inline bool AllocateTexture(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Texture*  texture, int32_t  width, int32_t  height, int32_t  overrideInstanceID) ;

/// @brief Method Blit2DTexture, addr 0x65f3070, size 0x388, virtual false, abstract: false, final false
inline void Blit2DTexture(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Vector4  scaleOffset, ::UnityEngine::Texture*  texture, ::UnityEngine::Vector4  sourceScaleOffset, bool  blitMips, ::UnityEngine::Rendering::PowerOfTwoTextureAtlas_BlitType  blitType) ;

/// @brief Method BlitOctahedralTexture, addr 0x65f3610, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method BlitOctahedralTextureMultiply, addr 0x65f371c, size 0x10c, virtual false, abstract: false, final false
inline void BlitOctahedralTextureMultiply(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Vector4  scaleOffset, ::UnityEngine::Texture*  texture, ::UnityEngine::Vector4  sourceScaleOffset, bool  blitMips, int32_t  overrideInstanceID) ;

/// @brief Method BlitTexture, addr 0x65f33f8, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method BlitTextureMultiply, addr 0x65f3504, size 0x10c, virtual false, abstract: false, final false
inline void BlitTextureMultiply(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Vector4  scaleOffset, ::UnityEngine::Texture*  texture, ::UnityEngine::Vector4  sourceScaleOffset, bool  blitMips, int32_t  overrideInstanceID) ;

/// @brief Method GetApproxCacheSizeInByte, addr 0x65f4108, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method GetMaxCacheSizeForWeightInByte, addr 0x65f41f0, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method GetPayloadScaleOffset, addr 0x65f2edc, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetPayloadScaleOffset(::UnityEngine::Texture*  texture, ::ByRef<::UnityEngine::Vector4>  scaleOffset) ;

/// @brief Method GetPayloadScaleOffset, addr 0x65f3038, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method GetPowerOfTwoTextureSize, addr 0x65f2fac, size 0x8c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetPowerOfTwoTextureSize(::UnityEngine::Texture*  texture) ;

/// @brief Method GetTexturePadding, addr 0x65f2eac, size 0x30, virtual false, abstract: false, final false
inline int32_t GetTexturePadding() ;

static inline ::UnityEngine::Rendering::PowerOfTwoTextureAtlas* New_ctor(int32_t  size, int32_t  mipPadding, ::UnityEngine::Experimental::Rendering::GraphicsFormat  format, ::UnityEngine::FilterMode  filterMode, ::StringW  name, bool  useMipMap) ;

/// @brief Method RelayoutEntries, addr 0x65f3cec, size 0x41c, virtual false, abstract: false, final false
inline bool RelayoutEntries() ;

/// @brief Method ReserveSpace, addr 0x65f3b68, size 0x14c, virtual false, abstract: false, final false
inline bool ReserveSpace(int32_t  id, int32_t  width, int32_t  height) ;

/// @brief Method ReserveSpace, addr 0x65f3ab4, size 0x70, virtual false, abstract: false, final false
inline bool ReserveSpace(::UnityEngine::Texture*  texture) ;

/// @brief Method ReserveSpace, addr 0x65f3b24, size 0x44, virtual false, abstract: false, final false
inline bool ReserveSpace(::UnityEngine::Texture*  texture, int32_t  width, int32_t  height) ;

/// @brief Method ReserveSpace, addr 0x65f3cb4, size 0x38, virtual false, abstract: false, final false
inline bool ReserveSpace(::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB, int32_t  width, int32_t  height) ;

/// @brief Method ResetRequestedTexture, addr 0x65f3a60, size 0x54, virtual false, abstract: false, final false
inline void ResetRequestedTexture() ;

/// @brief Method TextureSizeToPowerOfTwo, addr 0x65f3828, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65f2d80, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method get_mipPadding, addr 0x65f2ea4, size 0x8, virtual false, abstract: false, final false
