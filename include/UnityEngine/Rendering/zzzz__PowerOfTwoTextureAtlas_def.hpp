...
public:
  ...
  /// @brief Method <RelayoutEntries>b__23_0, addr 0x6666378, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6666374, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllocateTexture, addr 0x6665880, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Blit2DTexture, addr 0x666507c, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method BlitOctahedralTexture, addr 0x666561c, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method BlitOctahedralTextureMultiply, addr 0x6665728, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method BlitTexture, addr 0x6665404, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method BlitTextureMultiply, addr 0x6665510, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetApproxCacheSizeInByte, addr 0x6666114, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaxCacheSizeForWeightInByte, addr 0x66661fc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPayloadScaleOffset, addr 0x6664ee8, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetPayloadScaleOffset(::UnityEngine::Texture* texture, ::ByRef<::UnityEngine::Vector4> scaleOffset);

  /// @brief Method GetPayloadScaleOffset, addr 0x6665044, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPowerOfTwoTextureSize, addr 0x6664fb8, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetPowerOfTwoTextureSize(::UnityEngine::Texture* texture);

  /// @brief Method GetTexturePadding, addr 0x6664eb8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method RelayoutEntries, addr 0x6665cf8, size 0x41c, virtual false, abstract: false, final false
  inline bool RelayoutEntries();

  /// @brief Method ReserveSpace, addr 0x6665b74, size 0x14c, virtual false, abstract: false, final false
  inline bool ReserveSpace(int32_t id, int32_t width, int32_t height);

  /// @brief Method ReserveSpace, addr 0x6665ac0, size 0x70, virtual false, abstract: false, final false
  inline bool ReserveSpace(::UnityEngine::Texture* texture);

  /// @brief Method ReserveSpace, addr 0x6665b30, size 0x44, virtual false, abstract: false, final false
  inline bool ReserveSpace(::UnityEngine::Texture* texture, int32_t width, int32_t height);

  /// @brief Method ReserveSpace, addr 0x6665cc0, size 0x38, virtual false, abstract: false, final false
  inline bool ReserveSpace(::UnityEngine::Texture* textureA, ::UnityEngine::Texture* textureB, int32_t width, int32_t height);

  /// @brief Method ResetRequestedTexture, addr 0x6665a6c, size 0x54, virtual false, abstract: false, final false
  inline void ResetRequestedTexture();

  /// @brief Method TextureSizeToPowerOfTwo, addr 0x6665834, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6664d8c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_mipPadding, addr 0x6664eb0, size 0x8, virtual false, abstract: false, final false
