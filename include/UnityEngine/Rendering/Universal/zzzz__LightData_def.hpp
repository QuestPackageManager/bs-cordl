...
public:
  ...
  /// @brief Method .ctor, addr 0x66c3890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method get_additionalLightsCount, addr 0x66c394c, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_additionalLightsCount();

  /// @brief Method get_mainLightIndex, addr 0x66c38ec, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightIndex();

  /// @brief Method get_maxPerObjectAdditionalLightsCount, addr 0x66c39ac, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_maxPerObjectAdditionalLightsCount();

  /// @brief Method get_reflectionProbeBlending, addr 0x66c3b8c, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_reflectionProbeBlending();

  /// @brief Method get_reflectionProbeBoxProjection, addr 0x66c3b2c, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_reflectionProbeBoxProjection();

  /// @brief Method get_shadeAdditionalLightsPerVertex, addr 0x66c3a6c, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_shadeAdditionalLightsPerVertex();

  /// @brief Method get_supportsAdditionalLights, addr 0x66c3c4c, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsAdditionalLights();

  /// @brief Method get_supportsLightLayers, addr 0x66c3bec, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsLightLayers();

  /// @brief Method get_supportsMixedLighting, addr 0x66c3acc, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsMixedLighting();

  /// @brief Method get_universalLightData, addr 0x66c3898, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalLightData* get_universalLightData();

  /// @brief Method get_visibleLights, addr 0x66c3a0c, size 0x60, virtual false, abstract: false, final false
