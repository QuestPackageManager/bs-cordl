...
/// @brief Method .ctor, addr 0x672badc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ContextContainer*  frameData) ;

/// @brief Method get_additionalLightsCount, addr 0x672bb98, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<int32_t> get_additionalLightsCount() ;

/// @brief Method get_mainLightIndex, addr 0x672bb38, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<int32_t> get_mainLightIndex() ;

/// @brief Method get_maxPerObjectAdditionalLightsCount, addr 0x672bbf8, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<int32_t> get_maxPerObjectAdditionalLightsCount() ;

/// @brief Method get_reflectionProbeBlending, addr 0x672bdd8, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_reflectionProbeBlending() ;

/// @brief Method get_reflectionProbeBoxProjection, addr 0x672bd78, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_reflectionProbeBoxProjection() ;

/// @brief Method get_shadeAdditionalLightsPerVertex, addr 0x672bcb8, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_shadeAdditionalLightsPerVertex() ;

/// @brief Method get_supportsAdditionalLights, addr 0x672be98, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_supportsAdditionalLights() ;

/// @brief Method get_supportsLightLayers, addr 0x672be38, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_supportsLightLayers() ;

/// @brief Method get_supportsMixedLighting, addr 0x672bd18, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<bool> get_supportsMixedLighting() ;

/// @brief Method get_universalLightData, addr 0x672bae4, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::UniversalLightData* get_universalLightData() ;

/// @brief Method get_visibleLights, addr 0x672bc58, size 0x60, virtual false, abstract: false, final false
