...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::LightMinMaxZJob::*)(int32_t)>(&::UnityEngine::Rendering::Universal::LightMinMaxZJob::Execute)> {
  constexpr static std::size_t size = 0x440;
  constexpr static std::size_t addrs = 0x6709d58;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::LightMinMaxZJob>::get(),
                        "Execute",
