...
public:
  ...
  /// @brief Method CreateDebugRenderSetups, addr 0x6851388, size 0x148, virtual false, abstract: false, final false
  inline void CreateDebugRenderSetups(::UnityEngine::Rendering::FilteringSettings filteringSettings);

  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x68502b4, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x6850718, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method DisposeDebugRenderLists, addr 0x68514e8, size 0x188, virtual false, abstract: false, final false
  inline void DisposeDebugRenderLists();

  /// @brief Method DrawWithRendererList, addr 0x6851b88, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareRendererListForRasterPass, addr 0x68519ec, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6850184, size 0x130, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugRendererLists", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugRendererLists(DebugRendererLists&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugRendererLists", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugRendererLists(DebugRendererListsconst&) = delete;
