...
public:
  ...
  /// @brief Method CreateDebugRenderSetups, addr 0x670b440, size 0x148, virtual false, abstract: false, final false
  inline void CreateDebugRenderSetups(::UnityEngine::Rendering::FilteringSettings filteringSettings);

  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x670a36c, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x670a7d0, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method DisposeDebugRenderLists, addr 0x670b5a0, size 0x188, virtual false, abstract: false, final false
  inline void DisposeDebugRenderLists();

  /// @brief Method DrawWithRendererList, addr 0x670bc40, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareRendererListForRasterPass, addr 0x670baa4, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670a23c, size 0x130, virtual false, abstract: false, final false
