...
/// @brief Method CreateDebugRenderSetups, addr 0x6699434, size 0x148, virtual false, abstract: false, final false
inline void CreateDebugRenderSetups(::UnityEngine::Rendering::FilteringSettings  filteringSettings) ;

/// @brief Method CreateRendererListsWithDebugRenderState, addr 0x6698360, size 0x3a4, virtual false, abstract: false, final false
...
/// @brief Method CreateRendererListsWithDebugRenderState, addr 0x66987c4, size 0x38c, virtual false, abstract: false, final false
inline void CreateRendererListsWithDebugRenderState(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::ByRef<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::ByRef<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::ByRef<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock) ;

/// @brief Method DisposeDebugRenderLists, addr 0x6699594, size 0x188, virtual false, abstract: false, final false
inline void DisposeDebugRenderLists() ;

/// @brief Method DrawWithRendererList, addr 0x6699c34, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method PrepareRendererListForRasterPass, addr 0x6699a98, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6698230, size 0x130, virtual false, abstract: false, final false
