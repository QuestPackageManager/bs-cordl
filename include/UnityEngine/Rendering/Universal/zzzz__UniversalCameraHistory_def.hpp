...
public:
// Declarations
/// @brief Method Reset, addr 0x6711f98, size 0x2c, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Field m_Items, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Items, put=__cordl_internal_set_m_Items)) ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item,::Array<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>*>  m_Items;
...
/// @brief Method Dispose, addr 0x6711fc4, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GatherHistoryRequests, addr 0x6712054, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x67120b4, size 0x40, virtual false, abstract: false, final false
inline bool IsValid(int32_t  i) ;

/// @brief Method IsValidRequest, addr 0x6712074, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method ReleaseUnusedHistory, addr 0x67120f4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method SwapAndSetReferenceSize, addr 0x67121b0, size 0x18, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item,::Array<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>*> const& __cordl_internal_get_m_Items() const;
...
constexpr void __cordl_internal_set_m_Items(::ArrayW<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item,::Array<::UnityEngine::Rendering::Universal::UniversalCameraHistory_Item>*>  value) ;

constexpr void __cordl_internal_set_m_Version(int32_t  value) ;

/// @brief Method .ctor, addr 0x6711ea4, size 0xf4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnGatherHistoryRequests, addr 0x6711d4c, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method remove_OnGatherHistoryRequests, addr 0x6711df8, size 0xac, virtual true, abstract: false, final true
