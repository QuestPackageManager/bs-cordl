...
public:
  // Declarations
  /// @brief Method Reset, addr 0x68c4498, size 0x2c, virtual false, abstract: false, final false
  inline void Reset();
...
public:
  ...
  /// @brief Method Dispose, addr 0x68c44c4, size 0x90, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GatherHistoryRequests, addr 0x68c4554, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x68c45b4, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid(int32_t i);

  /// @brief Method IsValidRequest, addr 0x68c4574, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseUnusedHistory, addr 0x68c45f4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SwapAndSetReferenceSize, addr 0x68c46b0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68c43a4, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnGatherHistoryRequests, addr 0x68c424c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_OnGatherHistoryRequests, addr 0x68c42f8, size 0xac, virtual true, abstract: false, final true
