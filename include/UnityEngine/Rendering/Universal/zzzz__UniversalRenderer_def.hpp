...
public:
  ...
  /// @brief Method .ctor, addr 0x6792518, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BlitEmptyTexture>b__139_0, addr 0x67925c0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method <OnAfterRendering>b__194_0, addr 0x6792690, size 0x1c, virtual false, abstract: false, final false
  inline bool _OnAfterRendering_b__194_0(::UnityEngine::Rendering::Universal::ScriptableRenderPass* x);

  /// @brief Method <Setup>b__110_0, addr 0x6792574, size 0x1c, virtual false, abstract: false, final false
  inline bool _Setup_b__110_0(::UnityEngine::Rendering::Universal::ScriptableRenderPass* x);

  /// @brief Method <Setup>b__110_1, addr 0x6792590, size 0x30, virtual false, abstract: false, final false
  inline bool _Setup_b__110_1(::UnityEngine::Rendering::Universal::ScriptableRenderPass* x);

  /// @brief Method .ctor, addr 0x6792570, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllowPartialDepthNormalsPrepass, addr 0x6791718, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method BlitEmptyTexture, addr 0x678b840, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method BlitToDebugTexture, addr 0x678b2e8, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDepthCopySchedule, addr 0x679172c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTextureCopySchedules, addr 0x6791784, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateUVRect, addr 0x678ab28, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateUVRect, addr 0x678aaf4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method CameraHasPostProcessingWithDepth, addr 0x678bfe4, size 0x44, virtual false, abstract: false, final false
  inline bool CameraHasPostProcessingWithDepth(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method CanCopyDepth, addr 0x6785fac, size 0x124, virtual false, abstract: false, final false
  inline bool CanCopyDepth(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method CleanupRenderGraphResources, addr 0x678575c, size 0x19c, virtual false, abstract: false, final false
  inline void CleanupRenderGraphResources();

  /// @brief Method CopyDepthToDepthTexture, addr 0x67918d8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method CorrectForTextureAspectRatio, addr 0x6785d80, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAfterPostProcessTexture, addr 0x678dd8c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCameraDepthCopyTexture, addr 0x678d5dc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCameraNormalsTexture, addr 0x678d748, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCameraRenderTarget, addr 0x678942c, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDebugTexture, addr 0x678aa04, size 0xf0, virtual false, abstract: false, final false
  inline void CreateDebugTexture(::UnityEngine::RenderTextureDescriptor descriptor);

  /// @brief Method CreateMotionVectorTextures, addr 0x678d948, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRenderGraphCameraRenderTargets, addr 0x678c2c4, size 0x1318, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRenderGraphTexture, addr 0x678bea0, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRenderGraphTexture, addr 0x678bd84, size 0x11c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle CreateRenderGraphTexture(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph,
                                                                                                    ::UnityEngine::RenderTextureDescriptor desc, ::StringW name, bool clear,
                                                                                                    ::UnityEngine::FilterMode filterMode, ::UnityEngine::TextureWrapMode wrapMode);

  /// @brief Method CreateRenderingLayersTexture, addr 0x678db30, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method DebugHandlerRequireDepthPass, addr 0x678a990, size 0x74, virtual false, abstract: false, final false
  inline bool DebugHandlerRequireDepthPass(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method DepthNormalPrepassRender, addr 0x6791a4c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6785570, size 0x1ec, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnableSwapBufferMSAA, addr 0x678a96c, size 0x1c, virtual true, abstract: false, final false
  inline void EnableSwapBufferMSAA(bool enable);

  /// @brief Method EnqueueDeferred, addr 0x6789a00, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteScheduledDepthCopyWithMotion, addr 0x67916c8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishRendering, addr 0x678a694, size 0x2c, virtual true, abstract: false, final false
  inline void FinishRendering(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method GetCameraColorBackBuffer, addr 0x678a948, size 0x24, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetCameraColorBackBuffer(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method GetCameraColorFrontBuffer, addr 0x678a930, size 0x18, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetCameraColorFrontBuffer(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method GetRenderPassInputs, addr 0x6788f88, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method HasActiveRenderFeatures, addr 0x678616c, size 0x128, virtual false, abstract: false, final false
  inline bool HasActiveRenderFeatures();

  /// @brief Method HasPassesRequiringIntermediateTexture, addr 0x6786294, size 0x128, virtual false, abstract: false, final false
  inline bool HasPassesRequiringIntermediateTexture();

  /// @brief Method InstanceOcclusionTest, addr 0x6791434, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDepthPrimingEnabled, addr 0x6785ec0, size 0xec, virtual false, abstract: false, final false
  inline bool IsDepthPrimingEnabled(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method IsGLDevice, addr 0x678610c, size 0x60, virtual false, abstract: false, final false
  inline bool IsGLDevice();

  /// @brief Method IsGLESDevice, addr 0x67860d8, size 0x34, virtual false, abstract: false, final false
  inline bool IsGLESDevice();

  /// @brief Method IsOffscreenDepthTexture, addr 0x6785dc0, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsOffscreenDepthTexture(::ByRef<::UnityEngine::Rendering::Universal::CameraData> cameraData);

  /// @brief Method IsOffscreenDepthTexture, addr 0x6785e2c, size 0x94, virtual false, abstract: false, final false
  static inline bool IsOffscreenDepthTexture(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method IsWebGL, addr 0x67860d0, size 0x8, virtual false, abstract: false, final false
  inline bool IsWebGL();
  ...
  /// @brief Method OnAfterRendering, addr 0x678fd5c, size 0xab8, virtual false, abstract: false, final false
  inline void OnAfterRendering(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph);

  /// @brief Method OnBeforeRendering, addr 0x678ebdc, size 0x2d0, virtual false, abstract: false, final false
  inline void OnBeforeRendering(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph);

  /// @brief Method OnBeginRenderGraphFrame, addr 0x678e4dc, size 0x64, virtual true, abstract: false, final false
  inline void OnBeginRenderGraphFrame();

  /// @brief Method OnEndRenderGraphFrame, addr 0x6790814, size 0x60, virtual true, abstract: false, final false
  inline void OnEndRenderGraphFrame();

  /// @brief Method OnFinishRenderGraphRendering, addr 0x6790874, size 0x70, virtual true, abstract: false, final false
  inline void OnFinishRenderGraphRendering(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method OnMainRendering, addr 0x678eeac, size 0xeb0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnOffscreenDepthTextureRendering, addr 0x678e7f4, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnRecordRenderGraph, addr 0x678e540, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method PlatformRequiresExplicitMsaaResolve, addr 0x678a6c0, size 0xb0, virtual false, abstract: false, final false
  inline bool PlatformRequiresExplicitMsaaResolve();

  /// @brief Method RecordCustomPassesWithDepthCopyAndMotion, addr 0x6791628, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseRenderTargets, addr 0x67858f8, size 0x104, virtual true, abstract: false, final false
  inline void ReleaseRenderTargets();

  /// @brief Method RenderMotionVectors, addr 0x679199c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderRawColorDepthHistory, addr 0x678dfec, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method RequireDepthPrepass, addr 0x678c130, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method RequireDepthTexture, addr 0x678c1d0, size 0xf4, virtual false, abstract: false, final false
  inline bool RequireDepthTexture(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData, bool requiresDepthPrepass,
                                  ::ByRef<::UnityEngine::Rendering::Universal::UniversalRenderer_RenderPassInputSummary> renderPassInputs);

  /// @brief Method RequiresIntermediateAttachments, addr 0x678c028, size 0x108, virtual false, abstract: false, final false
  inline bool RequiresIntermediateAttachments(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData,
                                              ::ByRef<::UnityEngine::Rendering::Universal::UniversalRenderer_RenderPassInputSummary> renderPassInputs);

  /// @brief Method RequiresIntermediateColorTexture, addr 0x6789260, size 0x1cc, virtual false, abstract: false, final false
  inline bool RequiresIntermediateColorTexture(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData,
                                               ::ByRef<::UnityEngine::Rendering::Universal::UniversalRenderer_RenderPassInputSummary> renderPassInputs);

  /// @brief Method SetRenderingLayersGlobalTextures, addr 0x6791c0c, size 0x218, virtual false, abstract: false, final false
  inline void SetRenderingLayersGlobalTextures(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph);

  /// @brief Method Setup, addr 0x67863bc, size 0x2b14, virtual true, abstract: false, final false
  ...
  /// @brief Method SetupAfterPostRenderGraphFinalPassDebug, addr 0x678b5dc, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupCullingParameters, addr 0x678a284, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetupFinalPassDebug, addr 0x67859fc, size 0x384, virtual false, abstract: false, final false
  inline void SetupFinalPassDebug(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method SetupLights, addr 0x678a0f0, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method SetupRawColorDepthHistory, addr 0x6789b58, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupRenderGraphFinalPassDebug, addr 0x678ab80, size 0x768, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupRenderGraphLights, addr 0x678df68, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupRenderingLayers, addr 0x678dee8, size 0x80, virtual false, abstract: false, final false
  inline void SetupRenderingLayers(int32_t msaaSamples);

  /// @brief Method SetupVFXCameraBuffer, addr 0x6789e84, size 0x26c, virtual false, abstract: false, final false
  inline void SetupVFXCameraBuffer(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method ShouldApplyPostProcessing, addr 0x678bfcc, size 0x18, virtual false, abstract: false, final false
  inline bool ShouldApplyPostProcessing(bool postProcessEnabled);

  /// @brief Method SupportedCameraStackingTypes, addr 0x67841d4, size 0x24, virtual true, abstract: false, final false
  inline int32_t SupportedCameraStackingTypes();

  /// @brief Method SupportsMotionVectors, addr 0x67841f8, size 0x8, virtual true, abstract: false, final false
  inline bool SupportsMotionVectors();

  /// @brief Method SwapColorBuffer, addr 0x678a770, size 0x1c0, virtual true, abstract: false, final false
  inline void SwapColorBuffer(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method UpdateCameraHistory, addr 0x6788ed0, size 0xb8, virtual false, abstract: false, final false
  inline void UpdateCameraHistory(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method UpdateInstanceOccluders, addr 0x679106c, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6784338, size 0x10c8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_accurateGbufferNormals, addr 0x6784298, size 0x20, virtual false, abstract: false, final false
  inline bool get_accurateGbufferNormals();

  /// @brief Method get_cameraDepthAttachmentFormat, addr 0x6784324, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_cameraDepthAttachmentFormat();

  /// @brief Method get_cameraDepthTextureFormat, addr 0x6784310, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_cameraDepthTextureFormat();

  /// @brief Method get_colorGradingLut, addr 0x67842e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_colorGradingLut();

  /// @brief Method get_colorGradingLutPass, addr 0x67842c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::Internal::ColorGradingLutPass* get_colorGradingLutPass();

  /// @brief Method get_currentRenderGraphCameraColorHandle, addr 0x678bc50, size 0xc4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_currentRenderGraphCameraColorHandle();

  /// @brief Method get_deferredLights, addr 0x67842e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::Internal::DeferredLights* get_deferredLights();

  /// @brief Method get_depthPrimingMode, addr 0x67842b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DepthPrimingMode get_depthPrimingMode();

  /// @brief Method get_finalPostProcessPass, addr 0x67842d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::PostProcessPass* get_finalPostProcessPass();

  /// @brief Method get_nextRenderGraphCameraColorHandle, addr 0x678bd14, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_nextRenderGraphCameraColorHandle();

  /// @brief Method get_opaqueLayerMask, addr 0x67842f0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_opaqueLayerMask();

  /// @brief Method get_postProcessPass, addr 0x67842d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::PostProcessPass* get_postProcessPass();

  /// @brief Method get_renderingModeActual, addr 0x6784208, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::RenderingMode get_renderingModeActual();

  /// @brief Method get_renderingModeRequested, addr 0x6784200, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::RenderingMode get_renderingModeRequested();

  /// @brief Method get_supportsGPUOcclusion, addr 0x67908e4, size 0xc8, virtual true, abstract: false, final false
  inline bool get_supportsGPUOcclusion();

  /// @brief Method get_supportsNativeRenderPassRendergraphCompiler, addr 0x678a988, size 0x8, virtual true, abstract: false, final false
  inline bool get_supportsNativeRenderPassRendergraphCompiler();

  /// @brief Method get_transparentLayerMask, addr 0x6784300, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_depthPrimingMode, addr 0x67842c0, size 0x8, virtual false, abstract: false, final false
  inline void set_depthPrimingMode(::UnityEngine::Rendering::Universal::DepthPrimingMode value);

  /// @brief Method set_opaqueLayerMask, addr 0x67842f8, size 0x8, virtual false, abstract: false, final false
  inline void set_opaqueLayerMask(::UnityEngine::LayerMask value);

  /// @brief Method set_transparentLayerMask, addr 0x6784308, size 0x8, virtual false, abstract: false, final false
