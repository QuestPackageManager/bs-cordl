...
public:
  ...
  /// @brief Method ConfigureDithering, addr 0x67656fc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureDithering, addr 0x6765760, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureFilmGrain, addr 0x6765984, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureFilmGrain, addr 0x67659e8, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSourceSize, addr 0x6758ef0, size 0x70, virtual false, abstract: false, final false
  static inline void SetSourceSize(::UnityEngine::Rendering::CommandBuffer* cmd, ::UnityEngine::Rendering::RTHandle* source);

  /// @brief Method SetSourceSize, addr 0x6759a40, size 0x144, virtual false, abstract: false, final false
