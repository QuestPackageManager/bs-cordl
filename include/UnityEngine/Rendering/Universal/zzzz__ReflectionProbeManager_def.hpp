...
public:
  ...
  /// @brief Method Create, addr 0x6765ec0, size 0x40, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::ReflectionProbeManager Create();

  /// @brief Method Dispose, addr 0x6767bb8, size 0xc4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetScaleOffset, addr 0x6767ac4, size 0xf4, virtual false, abstract: false, final false
  inline ::Unity::Mathematics::float4 GetScaleOffset(int32_t level, int32_t dataIndex, bool includePadding, bool yflip);

  /// @brief Method Init, addr 0x6765f00, size 0x48c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method UpdateGpuData, addr 0x676638c, size 0x1738, virtual false, abstract: false, final false
  inline void UpdateGpuData(::UnityEngine::Rendering::CommandBuffer* cmd, ::ByRef<::UnityEngine::Rendering::CullingResults> cullResults);

  /// @brief Method get_atlasRT, addr 0x6765eb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_atlasRT();

  /// @brief Method get_atlasRTHandle, addr 0x6765eb8, size 0x8, virtual false, abstract: false, final false
