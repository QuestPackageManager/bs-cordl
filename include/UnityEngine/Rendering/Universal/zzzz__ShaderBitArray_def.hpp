...
public:
  ...
  /// @brief Method Clear, addr 0x67748d8, size 0x48, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetElementIndexAndBitOffset, addr 0x6774920, size 0x14, virtual false, abstract: false, final false
  inline void GetElementIndexAndBitOffset(int32_t index, ::ByRef<int32_t> elemIndex, ::ByRef<int32_t> bitOffset);

  /// @brief Method Resize, addr 0x67747a8, size 0x130, virtual false, abstract: false, final false
  inline void Resize(int32_t bitCount);

  /// @brief Method ToString, addr 0x67749a0, size 0x168, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Item, addr 0x6774934, size 0x2c, virtual false, abstract: false, final false
  inline bool get_Item(int32_t index);

  /// @brief Method get_bitCapacity, addr 0x6774784, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_bitCapacity();

  /// @brief Method get_data, addr 0x67747a0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_data();

  /// @brief Method get_elemLength, addr 0x677476c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_elemLength();

  /// @brief Method set_Item, addr 0x6774960, size 0x40, virtual false, abstract: false, final false
