...
public:
  ...
  /// @brief Method <Update>b__26_0, addr 0x6718b0c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6718b08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateChunkIndex, addr 0x6716c0c, size 0x594, virtual false, abstract: false, final false
  inline int32_t CreateChunkIndex(::UnityEngine::Material* material);

  /// @brief Method CreateDecalEntity, addr 0x671674c, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyDecalEntity, addr 0x671772c, size 0x1e8, virtual false, abstract: false, final false
  inline void DestroyDecalEntity(::UnityEngine::Rendering::Universal::DecalEntity decalEntity);

  /// @brief Method Dispose, addr 0x671831c, size 0x798, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method IsValid, addr 0x6716738, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6717914, size 0xa08, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateAllDecalEntitiesData, addr 0x6717554, size 0x1d8, virtual false, abstract: false, final false
  inline void UpdateAllDecalEntitiesData();

  /// @brief Method UpdateDecalEntityData, addr 0x67171a0, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6716410, size 0x328, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_decalProjectorMesh, addr 0x6715200, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_decalProjectorMesh();

  /// @brief Method get_errorMaterial, addr 0x6711fa8, size 0xd8, virtual false, abstract: false, final false
