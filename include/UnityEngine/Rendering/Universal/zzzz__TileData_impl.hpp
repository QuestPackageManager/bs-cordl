...
// Ctor Parameters [CppParam { name: "tileID", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "listBitMask", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "relLightOffset", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "unused", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
