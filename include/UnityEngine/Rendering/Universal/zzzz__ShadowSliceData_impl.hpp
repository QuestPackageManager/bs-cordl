...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::Universal::ShadowSliceData::*)()>(&::UnityEngine::Rendering::Universal::ShadowSliceData::Clear)> {
  ...
  constexpr static std::size_t addrs = 0x68bbf14;
...
// Ctor Parameters [CppParam { name: "viewMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "projectionMatrix", ty:
// "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "shadowTransform", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "offsetX", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "offsetY", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "resolution", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "splitData", ty: "::UnityEngine::Rendering::ShadowSplitData",
