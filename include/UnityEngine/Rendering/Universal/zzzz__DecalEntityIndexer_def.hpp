...
public:
  ...
  /// @brief Method Clear, addr 0x67160dc, size 0x90, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CreateDecalEntity, addr 0x6715c3c, size 0x1a4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalEntity CreateDecalEntity(int32_t arrayIndex, int32_t chunkIndex);

  /// @brief Method DestroyDecalEntity, addr 0x6715de0, size 0xc4, virtual false, abstract: false, final false
  inline void DestroyDecalEntity(::UnityEngine::Rendering::Universal::DecalEntity decalEntity);

  /// @brief Method GetItem, addr 0x6715ea4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x6715ba0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemapChunkIndices, addr 0x6715fb4, size 0x128, virtual false, abstract: false, final false
  inline void RemapChunkIndices(::System::Collections::Generic::List_1<int32_t>* remaper);

  /// @brief Method UpdateIndex, addr 0x6715f10, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x671616c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
