...
// Ctor Parameters [CppParam { name: "chunkIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "arrayIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "version", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field m_Entities, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Entities, put=__cordl_internal_set_m_Entities)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::DecalEntityIndexer_DecalEntityItem>*  m_Entities;
...
/// @brief Method Clear, addr 0x66a40d0, size 0x90, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateDecalEntity, addr 0x66a3c30, size 0x1a4, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DecalEntity CreateDecalEntity(int32_t  arrayIndex, int32_t  chunkIndex) ;

/// @brief Method DestroyDecalEntity, addr 0x66a3dd4, size 0xc4, virtual false, abstract: false, final false
inline void DestroyDecalEntity(::UnityEngine::Rendering::Universal::DecalEntity  decalEntity) ;

/// @brief Method GetItem, addr 0x66a3e98, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x66a3b94, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method RemapChunkIndices, addr 0x66a3fa8, size 0x128, virtual false, abstract: false, final false
inline void RemapChunkIndices(::System::Collections::Generic::List_1<int32_t>*  remaper) ;

/// @brief Method UpdateIndex, addr 0x66a3f04, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a4160, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;
