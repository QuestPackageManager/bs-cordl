...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalEntityIndexer_DecalEntityItem, "UnityEngine.Rendering.Universal", "DecalEntityIndexer/DecalEntityItem");
// Dependencies
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalEntityIndexer_DecalEntityItem) == 0xc, "Size mismatch!");
...
public:
  ...
  /// @brief Method Clear, addr 0x6856810, size 0x90, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CreateDecalEntity, addr 0x6856370, size 0x1a4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalEntity CreateDecalEntity(int32_t arrayIndex, int32_t chunkIndex);

  /// @brief Method DestroyDecalEntity, addr 0x6856514, size 0xc4, virtual false, abstract: false, final false
  inline void DestroyDecalEntity(::UnityEngine::Rendering::Universal::DecalEntity decalEntity);

  /// @brief Method GetItem, addr 0x68565d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x68562d4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RemapChunkIndices, addr 0x68566e8, size 0x128, virtual false, abstract: false, final false
  inline void RemapChunkIndices(::System::Collections::Generic::List_1<int32_t>* remaper);

  /// @brief Method UpdateIndex, addr 0x6856644, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68568a0, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
