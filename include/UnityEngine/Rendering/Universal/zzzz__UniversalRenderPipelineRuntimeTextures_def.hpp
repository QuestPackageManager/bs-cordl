...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x6771884, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67719f4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bayerMatrixTex, addr 0x6771904, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_bayerMatrixTex();

  /// @brief Method get_blueNoise64LTex, addr 0x677188c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_blueNoise64LTex();

  /// @brief Method get_debugFontTexture, addr 0x677197c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_debugFontTexture();

  /// @brief Method get_version, addr 0x677187c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_bayerMatrixTex, addr 0x677190c, size 0x70, virtual false, abstract: false, final false
  inline void set_bayerMatrixTex(::UnityEngine::Texture2D* value);

  /// @brief Method set_blueNoise64LTex, addr 0x6771894, size 0x70, virtual false, abstract: false, final false
  inline void set_blueNoise64LTex(::UnityEngine::Texture2D* value);

  /// @brief Method set_debugFontTexture, addr 0x6771984, size 0x70, virtual false, abstract: false, final false
