...
public:
  ...
  /// @brief Method IsActive, addr 0x6878f34, size 0xb8, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6878fec, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6878ff4, size 0x250, virtual false, abstract: false, final false
  inline void _ctor();
