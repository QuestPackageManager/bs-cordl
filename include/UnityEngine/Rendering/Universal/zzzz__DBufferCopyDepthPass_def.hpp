...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DBufferCopyDepthPass*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DBufferCopyDepthPass*, "UnityEngine.Rendering.Universal", "DBufferCopyDepthPass");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DBufferCopyDepthPass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DBufferCopyDepthPass(DBufferCopyDepthPass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DBufferCopyDepthPass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DBufferCopyDepthPass(DBufferCopyDepthPassconst&) = delete;
