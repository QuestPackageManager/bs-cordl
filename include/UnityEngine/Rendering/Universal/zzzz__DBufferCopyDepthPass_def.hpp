...
public:
  ...
  /// @brief Method RecordRenderGraph, addr 0x670d704, size 0x244, virtual true, abstract: false, final false
  inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, ::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method .ctor, addr 0x670d6f8, size 0xc, virtual false, abstract: false, final false
