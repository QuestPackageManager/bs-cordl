...
public:
// Declarations
static inline ::UnityEngine::Rendering::Universal::DBufferCopyDepthPass* New_ctor(::UnityEngine::Rendering::Universal::RenderPassEvent  evt, ::UnityEngine::Shader*  copyDepthShader, bool  shouldClear, bool  copyToDepth, bool  copyResolvedDepth) ;

/// @brief Method RecordRenderGraph, addr 0x670f27c, size 0x244, virtual true, abstract: false, final false
inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::ContextContainer*  frameData) ;

/// @brief Method .ctor, addr 0x670f270, size 0xc, virtual false, abstract: false, final false
