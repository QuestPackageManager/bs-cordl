...
public:
  ...
  /// @brief Method IsActive, addr 0x6739a0c, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsStreaksActive, addr 0x6739a3c, size 0x30, virtual false, abstract: false, final false
  inline bool IsStreaksActive();

  /// @brief Method IsTileCompatible, addr 0x6739a6c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x673961c, size 0x38c, virtual false, abstract: false, final false
  inline void _ctor();
