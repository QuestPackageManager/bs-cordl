...
/// @brief Method .ctor, addr 0x66bc514, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x66bc50c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
