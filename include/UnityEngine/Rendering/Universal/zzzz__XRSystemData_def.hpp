...
public:
  ...
  /// @brief Method .ctor, addr 0x66bbe54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66bbe4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
