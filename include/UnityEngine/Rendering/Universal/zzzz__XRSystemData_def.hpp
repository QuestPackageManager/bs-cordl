...
public:
  ...
  /// @brief Method .ctor, addr 0x672e520, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x672e518, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
