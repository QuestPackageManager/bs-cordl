...
/// @brief Method IsActive, addr 0x673a92c, size 0xdc, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsTileCompatible, addr 0x673aa08, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x673aa10, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
