...
public:
  ...
  /// @brief Method IsActive, addr 0x68792a8, size 0xdc, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6879384, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x687938c, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();
