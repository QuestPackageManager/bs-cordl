...
/// @brief Method get_pointLightShadow, addr 0x66c93cc, size 0xc, virtual false, abstract: false, final false
inline bool get_pointLightShadow() ;

/// @brief Method get_softShadow, addr 0x66c93c0, size 0xc, virtual false, abstract: false, final false
inline bool get_softShadow() ;

/// @brief Method set_pointLightShadow, addr 0x66c9340, size 0x20, virtual false, abstract: false, final false
inline void set_pointLightShadow(bool  value) ;

/// @brief Method set_softShadow, addr 0x66c9330, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method <CreateCompareShadowResolutionRequesPredicate>b__24_0, addr 0x66c951c, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c9518, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field s_VisibleLightIndexToCameraSquareDistance, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_VisibleLightIndexToCameraSquareDistance, put=setStaticF_s_VisibleLightIndexToCameraSquareDistance)) ::ArrayW<float_t,::Array<float_t>*>  s_VisibleLightIndexToCameraSquareDistance;

/// @brief Method ClearStaticCaches, addr 0x66c9464, size 0x60, virtual false, abstract: false, final false
static inline void ClearStaticCaches() ;

/// @brief Method CreateCompareShadowResolutionRequesPredicate, addr 0x66c925c, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method EstimateScaleFactorNeededToFitAllShadowsInAtlas, addr 0x66c9360, size 0x60, virtual false, abstract: false, final false
static inline int32_t EstimateScaleFactorNeededToFitAllShadowsInAtlas(::ByRef<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>>  shadowResolutionRequests, int32_t  endIndex, int32_t  atlasSize) ;

/// @brief Method GetAtlasSize, addr 0x66c93f8, size 0x8, virtual false, abstract: false, final false
inline int32_t GetAtlasSize() ;

/// @brief Method GetShadowSlicesScaleFactor, addr 0x66c93f0, size 0x8, virtual false, abstract: false, final false
inline int32_t GetShadowSlicesScaleFactor() ;

/// @brief Method GetSliceShadowResolutionRequest, addr 0x66c9438, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetSortedShadowResolutionRequest, addr 0x66c9414, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetTotalShadowResolutionRequestCount, addr 0x66c93e0, size 0x8, virtual false, abstract: false, final false
inline int32_t GetTotalShadowResolutionRequestCount() ;

/// @brief Method GetTotalShadowSlicesCount, addr 0x66c93d8, size 0x8, virtual false, abstract: false, final false
inline int32_t GetTotalShadowSlicesCount() ;

/// @brief Method HasSpaceForLight, addr 0x66c9400, size 0x14, virtual false, abstract: false, final false
inline bool HasSpaceForLight(int32_t  originalVisibleLightIndex) ;

/// @brief Method HasTooManyShadowMaps, addr 0x66c93e8, size 0x8, virtual false, abstract: false, final false
inline bool HasTooManyShadowMaps() ;

/// @brief Method .ctor, addr 0x66c8410, size 0xe4c, virtual false, abstract: false, final false
...
static inline ::ArrayW<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::Array<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>*> getStaticF_s_SortedShadowResolutionRequests() ;
...
static inline void setStaticF_s_SortedShadowResolutionRequests(::ArrayW<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest,::Array<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest>*>  value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::ShadowResolutionRequest_AdditionalLightsShadowAtlasLayout_SettingsOptions, "UnityEngine.Rendering.Universal", "AdditionalLightsShadowAtlasLayout/ShadowResolutionRequest/SettingsOptions");
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout_ShadowResolutionRequest, "UnityEngine.Rendering.Universal", "AdditionalLightsShadowAtlasLayout/ShadowResolutionRequest");
