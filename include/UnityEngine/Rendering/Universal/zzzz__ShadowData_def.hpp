...
public:
  ...
  /// @brief Method .ctor, addr 0x66c5a54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method get_additionalLightShadowsEnabled, addr 0x66c5db0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_additionalLightShadowsEnabled();

  /// @brief Method get_additionalLightsShadowmapHeight, addr 0x66c5e70, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_additionalLightsShadowmapHeight();

  /// @brief Method get_additionalLightsShadowmapWidth, addr 0x66c5e10, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_additionalLightsShadowmapWidth();

  /// @brief Method get_bias, addr 0x66c5f90, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> get_bias();

  /// @brief Method get_isKeywordAdditionalLightShadowsEnabled, addr 0x66c6050, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_isKeywordAdditionalLightShadowsEnabled();

  /// @brief Method get_isKeywordSoftShadowsEnabled, addr 0x66c60b0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_isKeywordSoftShadowsEnabled();

  /// @brief Method get_mainLightRenderTargetHeight, addr 0x66c61d0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightRenderTargetHeight();

  /// @brief Method get_mainLightRenderTargetWidth, addr 0x66c6170, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightRenderTargetWidth();

  /// @brief Method get_mainLightShadowCascadeBorder, addr 0x66c5cf0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<float_t> get_mainLightShadowCascadeBorder();

  /// @brief Method get_mainLightShadowCascadesCount, addr 0x66c5c30, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightShadowCascadesCount();

  /// @brief Method get_mainLightShadowCascadesSplit, addr 0x66c5c90, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Vector3> get_mainLightShadowCascadesSplit();

  /// @brief Method get_mainLightShadowResolution, addr 0x66c6110, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightShadowResolution();

  /// @brief Method get_mainLightShadowmapHeight, addr 0x66c5bd0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightShadowmapHeight();

  /// @brief Method get_mainLightShadowmapWidth, addr 0x66c5b70, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_mainLightShadowmapWidth();

  /// @brief Method get_mainLightShadowsEnabled, addr 0x66c5b10, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_mainLightShadowsEnabled();

  /// @brief Method get_resolution, addr 0x66c5ff0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<::System::Collections::Generic::List_1<int32_t>*> get_resolution();

  /// @brief Method get_shadowAtlasLayout, addr 0x66c6290, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout> get_shadowAtlasLayout();

  /// @brief Method get_shadowmapDepthBufferBits, addr 0x66c5f30, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<int32_t> get_shadowmapDepthBufferBits();

  /// @brief Method get_supportsAdditionalLightShadows, addr 0x66c5d50, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsAdditionalLightShadows();

  /// @brief Method get_supportsMainLightShadows, addr 0x66c5ab0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsMainLightShadows();

  /// @brief Method get_supportsSoftShadows, addr 0x66c5ed0, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<bool> get_supportsSoftShadows();

  /// @brief Method get_universalShadowData, addr 0x66c5a5c, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalShadowData* get_universalShadowData();

  /// @brief Method get_visibleLightsShadowCullingInfos, addr 0x66c6230, size 0x60, virtual false, abstract: false, final false
