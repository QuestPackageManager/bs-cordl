...
public:
  ...
  /// @brief Method .ctor, addr 0x68e5b0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method get_additionalLightShadowsEnabled, addr 0x68e5e68, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_additionalLightShadowsEnabled();

  /// @brief Method get_additionalLightsShadowmapHeight, addr 0x68e5f28, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_additionalLightsShadowmapHeight();

  /// @brief Method get_additionalLightsShadowmapWidth, addr 0x68e5ec8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_additionalLightsShadowmapWidth();

  /// @brief Method get_bias, addr 0x68e6048, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> get_bias();

  /// @brief Method get_isKeywordAdditionalLightShadowsEnabled, addr 0x68e6108, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_isKeywordAdditionalLightShadowsEnabled();

  /// @brief Method get_isKeywordSoftShadowsEnabled, addr 0x68e6168, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_isKeywordSoftShadowsEnabled();

  /// @brief Method get_mainLightRenderTargetHeight, addr 0x68e6288, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightRenderTargetHeight();

  /// @brief Method get_mainLightRenderTargetWidth, addr 0x68e6228, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightRenderTargetWidth();

  /// @brief Method get_mainLightShadowCascadeBorder, addr 0x68e5da8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<float_t> get_mainLightShadowCascadeBorder();

  /// @brief Method get_mainLightShadowCascadesCount, addr 0x68e5ce8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightShadowCascadesCount();

  /// @brief Method get_mainLightShadowCascadesSplit, addr 0x68e5d48, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::Vector3> get_mainLightShadowCascadesSplit();

  /// @brief Method get_mainLightShadowResolution, addr 0x68e61c8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightShadowResolution();

  /// @brief Method get_mainLightShadowmapHeight, addr 0x68e5c88, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightShadowmapHeight();

  /// @brief Method get_mainLightShadowmapWidth, addr 0x68e5c28, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_mainLightShadowmapWidth();

  /// @brief Method get_mainLightShadowsEnabled, addr 0x68e5bc8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_mainLightShadowsEnabled();

  /// @brief Method get_resolution, addr 0x68e60a8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<::System::Collections::Generic::List_1<int32_t>*> get_resolution();

  /// @brief Method get_shadowAtlasLayout, addr 0x68e6348, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::Rendering::Universal::AdditionalLightsShadowAtlasLayout> get_shadowAtlasLayout();

  /// @brief Method get_shadowmapDepthBufferBits, addr 0x68e5fe8, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<int32_t> get_shadowmapDepthBufferBits();

  /// @brief Method get_supportsAdditionalLightShadows, addr 0x68e5e08, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_supportsAdditionalLightShadows();

  /// @brief Method get_supportsMainLightShadows, addr 0x68e5b68, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_supportsMainLightShadows();

  /// @brief Method get_supportsSoftShadows, addr 0x68e5f88, size 0x60, virtual false, abstract: false, final false
  inline ::by_ref<bool> get_supportsSoftShadows();

  /// @brief Method get_universalShadowData, addr 0x68e5b14, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalShadowData* get_universalShadowData();

  /// @brief Method get_visibleLightsShadowCullingInfos, addr 0x68e62e8, size 0x60, virtual false, abstract: false, final false
