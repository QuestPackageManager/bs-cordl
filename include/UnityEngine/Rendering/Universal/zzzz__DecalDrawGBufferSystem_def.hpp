...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalDrawGBufferSystem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalDrawGBufferSystem*, "UnityEngine.Rendering.Universal", "DecalDrawGBufferSystem");
...
public:
  // Declarations
  /// @brief Method GetPassIndex, addr 0x6860aa8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6860a24, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawGBufferSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawGBufferSystem(DecalDrawGBufferSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawGBufferSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawGBufferSystem(DecalDrawGBufferSystemconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalDrawGBufferSystem) == 0x40, "Size mismatch!");
