...
/// @brief Method BeginLateLatching, addr 0x6730ee4, size 0xdc, virtual false, abstract: false, final false
static inline void BeginLateLatching(::UnityEngine::Camera*  camera, ::UnityEngine::Rendering::Universal::XRPassUniversal*  xrPass) ;

/// @brief Method EndLateLatching, addr 0x6730fc0, size 0xc8, virtual false, abstract: false, final false
static inline void EndLateLatching(::UnityEngine::Camera*  camera, ::UnityEngine::Rendering::Universal::XRPassUniversal*  xrPass) ;

/// @brief Method MarkShaderProperties, addr 0x6731114, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method UnmarkShaderProperties, addr 0x6731088, size 0x8c, virtual false, abstract: false, final false
