...
// Ctor Parameters [CppParam { name: "managedArray", ty: "::ArrayW<T,::Array<T>*>", modifiers: "", def_value: None }, CppParam { name: "handle", ty: "::System::Runtime::InteropServices::GCHandle", modifiers: "", def_value: None }, CppParam { name: "nativeArray", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: None }]
