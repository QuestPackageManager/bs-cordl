...
public:
  ...
  /// @brief Method Reset, addr 0x670c5e4, size 0x388, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method UpdateDisplayStats, addr 0x670cacc, size 0x68, virtual false, abstract: false, final false
  inline void UpdateDisplayStats();

  /// @brief Method UpdateMaterials, addr 0x670cb34, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670c560, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsPostProcessingAllowed, addr 0x670c328, size 0x238, virtual true, abstract: false, final false
  inline bool get_IsPostProcessingAllowed();

  /// @brief Method get_commonSettings, addr 0x670c2b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon* get_commonSettings();

  /// @brief Method get_displayStats, addr 0x670c308, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugDisplaySettingsStats_1<::UnityEngine::Rendering::Universal::URPProfileId>* get_displayStats();

  /// @brief Method get_gpuResidentDrawerSettings, addr 0x670c318, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer* get_gpuResidentDrawerSettings();

  /// @brief Method get_lightingSettings, addr 0x670c2e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_lightingSettings();

  /// @brief Method get_materialSettings, addr 0x670c2c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_materialSettings();

  /// @brief Method get_renderingSettings, addr 0x670c2d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* get_renderingSettings();

  /// @brief Method get_volumeSettings, addr 0x670c2f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugDisplaySettingsVolume* get_volumeSettings();

  /// @brief Method set_commonSettings, addr 0x670c2c0, size 0x8, virtual false, abstract: false, final false
  inline void set_commonSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon* value);

  /// @brief Method set_displayStats, addr 0x670c310, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_gpuResidentDrawerSettings, addr 0x670c320, size 0x8, virtual false, abstract: false, final false
  inline void set_gpuResidentDrawerSettings(::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer* value);

  /// @brief Method set_lightingSettings, addr 0x670c2f0, size 0x8, virtual false, abstract: false, final false
  inline void set_lightingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* value);

  /// @brief Method set_materialSettings, addr 0x670c2d0, size 0x8, virtual false, abstract: false, final false
  inline void set_materialSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* value);

  /// @brief Method set_renderingSettings, addr 0x670c2e0, size 0x8, virtual false, abstract: false, final false
  inline void set_renderingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* value);

  /// @brief Method set_volumeSettings, addr 0x670c300, size 0x8, virtual false, abstract: false, final false
