...
/// @brief Method Reset, addr 0x669a5d8, size 0x388, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method UpdateDisplayStats, addr 0x669aac0, size 0x68, virtual false, abstract: false, final false
inline void UpdateDisplayStats() ;

/// @brief Method UpdateMaterials, addr 0x669ab28, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x669a554, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsPostProcessingAllowed, addr 0x669a31c, size 0x238, virtual true, abstract: false, final false
inline bool get_IsPostProcessingAllowed() ;

/// @brief Method get_commonSettings, addr 0x669a2ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon* get_commonSettings() ;

/// @brief Method get_displayStats, addr 0x669a2fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplaySettingsStats_1<::UnityEngine::Rendering::Universal::URPProfileId>* get_displayStats() ;

/// @brief Method get_gpuResidentDrawerSettings, addr 0x669a30c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer* get_gpuResidentDrawerSettings() ;

/// @brief Method get_lightingSettings, addr 0x669a2dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_lightingSettings() ;

/// @brief Method get_materialSettings, addr 0x669a2bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_materialSettings() ;

/// @brief Method get_renderingSettings, addr 0x669a2cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* get_renderingSettings() ;

/// @brief Method get_volumeSettings, addr 0x669a2ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugDisplaySettingsVolume* get_volumeSettings() ;

/// @brief Method set_commonSettings, addr 0x669a2b4, size 0x8, virtual false, abstract: false, final false
inline void set_commonSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon*  value) ;

/// @brief Method set_displayStats, addr 0x669a304, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_gpuResidentDrawerSettings, addr 0x669a314, size 0x8, virtual false, abstract: false, final false
inline void set_gpuResidentDrawerSettings(::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  value) ;

/// @brief Method set_lightingSettings, addr 0x669a2e4, size 0x8, virtual false, abstract: false, final false
inline void set_lightingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting*  value) ;

/// @brief Method set_materialSettings, addr 0x669a2c4, size 0x8, virtual false, abstract: false, final false
inline void set_materialSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial*  value) ;

/// @brief Method set_renderingSettings, addr 0x669a2d4, size 0x8, virtual false, abstract: false, final false
inline void set_renderingSettings(::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering*  value) ;

/// @brief Method set_volumeSettings, addr 0x669a2f4, size 0x8, virtual false, abstract: false, final false
