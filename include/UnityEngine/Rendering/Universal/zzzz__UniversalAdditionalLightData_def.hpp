...
public:
  ...
  /// @brief Method OnAfterDeserialize, addr 0x6783b04, size 0xe8, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x6783b00, size 0x4, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method SyncLightAndShadowLayers, addr 0x67839d0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6783bec, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_additionalLightsShadowResolutionTier, addr 0x6783998, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_additionalLightsShadowResolutionTier();

  /// @brief Method get_customShadowLayers, addr 0x6783a7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_customShadowLayers();

  /// @brief Method get_light, addr 0x6783900, size 0x98, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Light> get_light();

  /// @brief Method get_lightCookieOffset, addr 0x6783ae0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_lightCookieOffset();

  /// @brief Method get_lightCookieSize, addr 0x6783ad0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_lightCookieSize();

  /// @brief Method get_lightLayerMask, addr 0x67839a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::LightLayerEnum get_lightLayerMask();

  /// @brief Method get_renderingLayers, addr 0x67839b0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_renderingLayers();

  /// @brief Method get_shadowLayerMask, addr 0x6783aa0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::LightLayerEnum get_shadowLayerMask();

  /// @brief Method get_shadowRenderingLayers, addr 0x6783ab0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_shadowRenderingLayers();

  /// @brief Method get_softShadowQuality, addr 0x6783af0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::SoftShadowQuality get_softShadowQuality();

  /// @brief Method get_usePipelineSettings, addr 0x67838f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_usePipelineSettings();

  /// @brief Method get_version, addr 0x67838e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_customShadowLayers, addr 0x6783a84, size 0x1c, virtual false, abstract: false, final false
  inline void set_customShadowLayers(bool value);

  /// @brief Method set_lightCookieOffset, addr 0x6783ae8, size 0x8, virtual false, abstract: false, final false
  inline void set_lightCookieOffset(::UnityEngine::Vector2 value);

  /// @brief Method set_lightCookieSize, addr 0x6783ad8, size 0x8, virtual false, abstract: false, final false
  inline void set_lightCookieSize(::UnityEngine::Vector2 value);

  /// @brief Method set_lightLayerMask, addr 0x67839a8, size 0x8, virtual false, abstract: false, final false
  inline void set_lightLayerMask(::UnityEngine::Rendering::Universal::LightLayerEnum value);

  /// @brief Method set_renderingLayers, addr 0x67839b8, size 0x18, virtual false, abstract: false, final false
  inline void set_renderingLayers(uint32_t value);

  /// @brief Method set_shadowLayerMask, addr 0x6783aa8, size 0x8, virtual false, abstract: false, final false
  inline void set_shadowLayerMask(::UnityEngine::Rendering::Universal::LightLayerEnum value);

  /// @brief Method set_shadowRenderingLayers, addr 0x6783ab8, size 0x18, virtual false, abstract: false, final false
  inline void set_shadowRenderingLayers(uint32_t value);

  /// @brief Method set_softShadowQuality, addr 0x6783af8, size 0x8, virtual false, abstract: false, final false
  inline void set_softShadowQuality(::UnityEngine::Rendering::Universal::SoftShadowQuality value);

  /// @brief Method set_usePipelineSettings, addr 0x67838f8, size 0x8, virtual false, abstract: false, final false
