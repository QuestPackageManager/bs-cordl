...
/// @brief Method OnAfterDeserialize, addr 0x6711af8, size 0xe8, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x6711af4, size 0x4, virtual true, abstract: false, final true
inline void OnBeforeSerialize() ;

/// @brief Method SyncLightAndShadowLayers, addr 0x67119c4, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6711be0, size 0x104, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_additionalLightsShadowResolutionTier, addr 0x671198c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_additionalLightsShadowResolutionTier() ;

/// @brief Method get_customShadowLayers, addr 0x6711a70, size 0x8, virtual false, abstract: false, final false
inline bool get_customShadowLayers() ;

/// @brief Method get_light, addr 0x67118f4, size 0x98, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Light> get_light() ;

/// @brief Method get_lightCookieOffset, addr 0x6711ad4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_lightCookieOffset() ;

/// @brief Method get_lightCookieSize, addr 0x6711ac4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_lightCookieSize() ;

/// @brief Method get_lightLayerMask, addr 0x6711994, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::LightLayerEnum get_lightLayerMask() ;

/// @brief Method get_renderingLayers, addr 0x67119a4, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_renderingLayers() ;

/// @brief Method get_shadowLayerMask, addr 0x6711a94, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::LightLayerEnum get_shadowLayerMask() ;

/// @brief Method get_shadowRenderingLayers, addr 0x6711aa4, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_shadowRenderingLayers() ;

/// @brief Method get_softShadowQuality, addr 0x6711ae4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::SoftShadowQuality get_softShadowQuality() ;

/// @brief Method get_usePipelineSettings, addr 0x67118e4, size 0x8, virtual false, abstract: false, final false
inline bool get_usePipelineSettings() ;

/// @brief Method get_version, addr 0x67118dc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_customShadowLayers, addr 0x6711a78, size 0x1c, virtual false, abstract: false, final false
inline void set_customShadowLayers(bool  value) ;

/// @brief Method set_lightCookieOffset, addr 0x6711adc, size 0x8, virtual false, abstract: false, final false
inline void set_lightCookieOffset(::UnityEngine::Vector2  value) ;

/// @brief Method set_lightCookieSize, addr 0x6711acc, size 0x8, virtual false, abstract: false, final false
inline void set_lightCookieSize(::UnityEngine::Vector2  value) ;

/// @brief Method set_lightLayerMask, addr 0x671199c, size 0x8, virtual false, abstract: false, final false
inline void set_lightLayerMask(::UnityEngine::Rendering::Universal::LightLayerEnum  value) ;

/// @brief Method set_renderingLayers, addr 0x67119ac, size 0x18, virtual false, abstract: false, final false
inline void set_renderingLayers(uint32_t  value) ;

/// @brief Method set_shadowLayerMask, addr 0x6711a9c, size 0x8, virtual false, abstract: false, final false
inline void set_shadowLayerMask(::UnityEngine::Rendering::Universal::LightLayerEnum  value) ;

/// @brief Method set_shadowRenderingLayers, addr 0x6711aac, size 0x18, virtual false, abstract: false, final false
inline void set_shadowRenderingLayers(uint32_t  value) ;

/// @brief Method set_softShadowQuality, addr 0x6711aec, size 0x8, virtual false, abstract: false, final false
inline void set_softShadowQuality(::UnityEngine::Rendering::Universal::SoftShadowQuality  value) ;

/// @brief Method set_usePipelineSettings, addr 0x67118ec, size 0x8, virtual false, abstract: false, final false
