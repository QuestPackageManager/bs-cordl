...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ShaderData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShaderData*, "UnityEngine.Rendering.Universal", "ShaderData");
...
public:
  ...
  /// @brief Method Dispose, addr 0x68b5070, size 0x60, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeBuffer, addr 0x68b50d0, size 0x24, virtual false, abstract: false, final false
  inline void DisposeBuffer(::by_ref<::UnityEngine::ComputeBuffer*> buffer);

  /// @brief Method GetAdditionalLightShadowParamsStructuredBuffer, addr 0x68b51b4, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowParamsStructuredBuffer(int32_t size);

  /// @brief Method GetAdditionalLightShadowSliceMatricesStructuredBuffer, addr 0x68b5214, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowSliceMatricesStructuredBuffer(int32_t size);

  /// @brief Method GetLightDataBuffer, addr 0x68b50f4, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::ComputeBuffer* GetLightDataBuffer(int32_t size);

  /// @brief Method GetLightIndicesBuffer, addr 0x68b5154, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68b4ffc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::Universal::ShaderData* getStaticF_m_Instance();

  /// @brief Method get_instance, addr 0x68b5000, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ShaderData) == 0x30, "Size mismatch!");
