...
/// @brief Field m_AdditionalLightShadowParamsStructuredBuffer, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightShadowParamsStructuredBuffer, put=__cordl_internal_set_m_AdditionalLightShadowParamsStructuredBuffer)) ::UnityEngine::ComputeBuffer*  m_AdditionalLightShadowParamsStructuredBuffer;

/// @brief Field m_AdditionalLightShadowSliceMatricesStructuredBuffer, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightShadowSliceMatricesStructuredBuffer, put=__cordl_internal_set_m_AdditionalLightShadowSliceMatricesStructuredBuffer)) ::UnityEngine::ComputeBuffer*  m_AdditionalLightShadowSliceMatricesStructuredBuffer;
...
/// @brief Method Dispose, addr 0x6702b70, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeBuffer, addr 0x6702bd0, size 0x24, virtual false, abstract: false, final false
inline void DisposeBuffer(::ByRef<::UnityEngine::ComputeBuffer*>  buffer) ;

/// @brief Method GetAdditionalLightShadowParamsStructuredBuffer, addr 0x6702cb4, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowParamsStructuredBuffer(int32_t  size) ;

/// @brief Method GetAdditionalLightShadowSliceMatricesStructuredBuffer, addr 0x6702d14, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowSliceMatricesStructuredBuffer(int32_t  size) ;

/// @brief Method GetLightDataBuffer, addr 0x6702bf4, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetLightDataBuffer(int32_t  size) ;

/// @brief Method GetLightIndicesBuffer, addr 0x6702c54, size 0x60, virtual false, abstract: false, final false
...
template<typename T>
inline ::UnityEngine::ComputeBuffer* GetOrUpdateBuffer(::ByRef<::UnityEngine::ComputeBuffer*>  buffer, int32_t  size) ;
...
/// @brief Method .ctor, addr 0x6702afc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::Universal::ShaderData* getStaticF_m_Instance() ;

/// @brief Method get_instance, addr 0x6702b00, size 0x70, virtual false, abstract: false, final false
