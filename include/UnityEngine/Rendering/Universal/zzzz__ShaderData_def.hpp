...
/// @brief Method Dispose, addr 0x67766f4, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeBuffer, addr 0x6776754, size 0x24, virtual false, abstract: false, final false
inline void DisposeBuffer(::ByRef<::UnityEngine::ComputeBuffer*>  buffer) ;

/// @brief Method GetAdditionalLightShadowParamsStructuredBuffer, addr 0x6776838, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowParamsStructuredBuffer(int32_t  size) ;

/// @brief Method GetAdditionalLightShadowSliceMatricesStructuredBuffer, addr 0x6776898, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetAdditionalLightShadowSliceMatricesStructuredBuffer(int32_t  size) ;

/// @brief Method GetLightDataBuffer, addr 0x6776778, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetLightDataBuffer(int32_t  size) ;

/// @brief Method GetLightIndicesBuffer, addr 0x67767d8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6776680, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::Universal::ShaderData* getStaticF_m_Instance() ;

/// @brief Method get_instance, addr 0x6776684, size 0x70, virtual false, abstract: false, final false
