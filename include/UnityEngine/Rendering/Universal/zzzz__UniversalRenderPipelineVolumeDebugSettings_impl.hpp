...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::VolumeStack* (::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::*)()>(&::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::get_selectedCameraVolumeStack)> {
  constexpr static std::size_t size = 0x150;
  constexpr static std::size_t addrs = 0x669b34c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings*>::get(),
                                  19
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::LayerMask (::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::*)()>(&::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::get_selectedCameraLayerMask)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x669b49c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::*)()>(&::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::get_selectedCameraPosition)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0x669b58c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::*)()>(&::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::get_targetRenderPipeline)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x669b68c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::*)()>(&::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings::_ctor)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x669aa4c;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::Universal::UniversalRenderPipelineVolumeDebugSettings*>());
}
// Ctor Parameters []
