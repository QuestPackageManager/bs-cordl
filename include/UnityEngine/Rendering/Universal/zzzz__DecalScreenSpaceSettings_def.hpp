...
public:
  ...
  /// @brief Method .ctor, addr 0x68adb08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalScreenSpaceSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalScreenSpaceSettings(DecalScreenSpaceSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalScreenSpaceSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalScreenSpaceSettings(DecalScreenSpaceSettingsconst&) = delete;
