...
// Declarations
template<typename T>
using __c__DisplayClass4_0_1 = ::UnityEngine::Rendering::Universal::Sorting___c__DisplayClass4_0_1<T>;
...
template<typename T>
static inline void InsertionSort(::ArrayW<T,::Array<T>*>  data, ::System::Func_3<T,T,int32_t>*  compare) ;

/// @brief Method InsertionSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void InsertionSort(::ArrayW<T,::Array<T>*>  data, int32_t  start, int32_t  end, ::System::Func_3<T,T,int32_t>*  compare) ;

/// @brief Method Median3Pivot, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T Median3Pivot(::ArrayW<T,::Array<T>*>  data, int32_t  start, int32_t  pivot, int32_t  end, ::System::Func_3<T,T,int32_t>*  compare) ;

/// @brief Method Partition, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t Partition(::ArrayW<T,::Array<T>*>  data, int32_t  start, int32_t  end, ::System::Func_3<T,T,int32_t>*  compare) ;

/// @brief Method QuickSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void QuickSort(::ArrayW<T,::Array<T>*>  data, ::System::Func_3<T,T,int32_t>*  compare) ;

/// @brief Method QuickSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void QuickSort(::ArrayW<T,::Array<T>*>  data, int32_t  start, int32_t  end, ::System::Func_3<T,T,int32_t>*  compare) ;
