...
public:
  ...
  template <typename T> static inline void InsertionSort(::ArrayW<T> data, ::System::Func_3<T, T, int32_t>* compare);

  /// @brief Method InsertionSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void InsertionSort(::ArrayW<T> data, int32_t start, int32_t end, ::System::Func_3<T, T, int32_t>* compare);

  /// @brief Method Median3Pivot, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline T Median3Pivot(::ArrayW<T> data, int32_t start, int32_t pivot, int32_t end, ::System::Func_3<T, T, int32_t>* compare);

  /// @brief Method Partition, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline int32_t Partition(::ArrayW<T> data, int32_t start, int32_t end, ::System::Func_3<T, T, int32_t>* compare);

  /// @brief Method QuickSort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline void QuickSort(::ArrayW<T> data, ::System::Func_3<T, T, int32_t>* compare);
...
#pragma pack(pop)
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::Sorting) == 0x1, "Size mismatch!");
