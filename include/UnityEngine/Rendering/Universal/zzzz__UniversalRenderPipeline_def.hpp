...
public:
  ...
  /// @brief Method .ctor, addr 0x679c9bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCached, addr 0x679c7f4, size 0x1c8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x679cffc, size 0x94, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x679cf50, size 0xac, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x679d214, size 0x94, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x679d160, size 0xb4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x679d378, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.cctor>b__122_0, addr 0x679d444, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__47_0, addr 0x679d3dc, size 0x68, virtual false, abstract: false, final false
  inline int32_t __ctor_b__47_0(::UnityEngine::Camera* camera1, ::UnityEngine::Camera* camera2);

  /// @brief Method .ctor, addr 0x679d3d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AdjustUIOverlayOwnership, addr 0x67943c4, size 0xc8, virtual false, abstract: false, final false
  static inline void AdjustUIOverlayOwnership(int32_t cameraCount);

  /// @brief Method ApplyTaaRenderingDebugOverrides, addr 0x679b700, size 0xc0, virtual false, abstract: false, final false
  static inline void ApplyTaaRenderingDebugOverrides(::ByRef<::UnityEngine::Rendering::Universal::TemporalAA_Settings> taaSettings);

  /// @brief Method BuildAdditionalLightsShadowAtlasLayout, addr 0x679a1d4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndApplyDebugSettings, addr 0x6799ce4, size 0x230, virtual false, abstract: false, final false
  static inline void CheckAndApplyDebugSettings(::ByRef<::UnityEngine::Rendering::Universal::RenderingData> renderingData);

  /// @brief Method CheckPostProcessForDepth, addr 0x679a3e8, size 0xec, virtual false, abstract: false, final false
  static inline bool CheckPostProcessForDepth();

  /// @brief Method CheckPostProcessForDepth, addr 0x679a9b8, size 0x94, virtual false, abstract: false, final false
  static inline bool CheckPostProcessForDepth(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method CreateCameraData, addr 0x6796634, size 0x53c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateLightData, addr 0x6798a8c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePostProcessingData, addr 0x6799aa0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRenderTextureDescriptor, addr 0x679b100, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRenderingData, addr 0x6799b80, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShadowAtlasAndCullShadowCasters, addr 0x6799f14, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShadowData, addr 0x6798cd4, size 0xdcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUniversalResourceData, addr 0x6798a38, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x67938fc, size 0x300, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DisposeAdditionalCameraData, addr 0x6793bfc, size 0xbc, virtual false, abstract: false, final false
  inline void DisposeAdditionalCameraData();

  /// @brief Method GetHDROutputGradingParameters, addr 0x679bcd4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHDROutputLuminanceParameters, addr 0x679bbe4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLightAttenuationAndSpotDirection, addr 0x679bde4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMainLightCascadeSplit, addr 0x679b8b8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMainLightIndex, addr 0x679b918, size 0x21c, virtual false, abstract: false, final false
  static inline int32_t GetMainLightIndex(::UnityEngine::Rendering::Universal::UniversalRenderPipelineAsset* settings,
                                          ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleLight> visibleLights);

  /// @brief Method GetPerObjectLightFlags, addr 0x679b7c0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPunctualLightDistanceAttenuation, addr 0x679bf30, size 0x3c, virtual false, abstract: false, final false
  static inline void GetPunctualLightDistanceAttenuation(float_t lightRange, ::ByRef<::UnityEngine::Vector4> lightAttenuation);

  /// @brief Method GetRenderer, addr 0x6796544, size 0xf0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::ScriptableRenderer* GetRenderer(::UnityEngine::Camera* camera,
                                                                                     ::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* additionalCameraData);

  /// @brief Method GetSpotAngleAttenuation, addr 0x679bfa0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSpotDirection, addr 0x679bf6c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method HDROutputForAnyDisplayIsActive, addr 0x679bb34, size 0xb0, virtual false, abstract: false, final false
  static inline bool HDROutputForAnyDisplayIsActive();

  /// @brief Method HDROutputForMainDisplayIsActive, addr 0x679a2e8, size 0x100, virtual false, abstract: false, final false
  static inline bool HDROutputForMainDisplayIsActive();

  /// @brief Method InitializeAdditionalCameraData, addr 0x6796b70, size 0x7a8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeLightConstants_Common, addr 0x679c0a8, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeMainLightShadowResolution, addr 0x679a128, size 0xac, virtual false, abstract: false, final false
  static inline void InitializeMainLightShadowResolution(::UnityEngine::Rendering::Universal::UniversalShadowData* shadowData);

  /// @brief Method InitializeStackedCameraData, addr 0x679aa4c, size 0x6b4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGameCamera, addr 0x6794938, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeRenderTextureGraphicsFormat, addr 0x67854a8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeUnormRenderTextureGraphicsFormat, addr 0x679bd9c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordAndExecuteRenderGraph, addr 0x679a044, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordRenderGraph, addr 0x679c418, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6793cb8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6793d50, size 0x514, virtual true, abstract: false, final false
  ...
  /// @brief Method RenderCameraStack, addr 0x6794a18, size 0x1374, virtual false, abstract: false, final false
  static inline void RenderCameraStack(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* baseCamera);

  /// @brief Method RenderSingleCamera, addr 0x6796108, size 0x68, virtual false, abstract: false, final false
  static inline void RenderSingleCamera(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method RenderSingleCamera, addr 0x6797318, size 0x1130, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSingleCameraInternal, addr 0x679603c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSingleCameraInternal, addr 0x6796170, size 0x3d4, virtual false, abstract: false, final false
  static inline void RenderSingleCameraInternal(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera,
                                                ::ByRef<::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData*> additionalCameraData);

  /// @brief Method ResolveUpscalingFilterSelection, addr 0x679b400, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHDRState, addr 0x6794264, size 0x160, virtual false, abstract: false, final false
  inline void SetHDRState(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Camera>>* cameras);

  /// @brief Method SetSupportedRenderingFeatures, addr 0x6793878, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupPerCameraShaderConstants, addr 0x67985bc, size 0x35c, virtual false, abstract: false, final false
  static inline void SetupPerCameraShaderConstants(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetupPerFrameShaderConstants, addr 0x679459c, size 0x308, virtual false, abstract: false, final false
  inline void SetupPerFrameShaderConstants();

  /// @brief Method SetupScreenMSAASamplesState, addr 0x679448c, size 0x110, virtual false, abstract: false, final false
  static inline void SetupScreenMSAASamplesState(int32_t cameraCount);

  /// @brief Method SortCameras, addr 0x67948a4, size 0x94, virtual false, abstract: false, final false
  inline void SortCameras(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Camera>>* cameras);

  /// @brief Method ToString, addr 0x6792ef0, size 0x18, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetCullingParameters, addr 0x6798448, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateCameraData, addr 0x679a648, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateCameraStereoMatrices, addr 0x679a4d4, size 0x174, virtual false, abstract: false, final false
  static inline void UpdateCameraStereoMatrices(::UnityEngine::Camera* camera, ::UnityEngine::Experimental::Rendering::XRPass* xr);

  /// @brief Method UpdateTemporalAAData, addr 0x679b5cc, size 0x134, virtual false, abstract: false, final false
  static inline void UpdateTemporalAAData(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData,
                                          ::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* additionalCameraData);

  /// @brief Method UpdateTemporalAATargets, addr 0x6798918, size 0x120, virtual false, abstract: false, final false
  static inline void UpdateTemporalAATargets(::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData);

  /// @brief Method UpdateVolumeFramework, addr 0x6795d8c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6792f08, size 0x970, virtual false, abstract: false, final false
  ...
  /// @brief Method get_asset, addr 0x6785400, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Rendering::Universal::UniversalRenderPipelineAsset> get_asset();

  /// @brief Method get_canOptimizeScreenMSAASamples, addr 0x6792d74, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_canOptimizeScreenMSAASamples();

  /// @brief Method get_defaultSettings, addr 0x6792d6c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::RenderPipelineGlobalSettings> get_defaultSettings();

  /// @brief Method get_lightsPerTile, addr 0x6792c04, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_lightsPerTile();

  /// @brief Method get_maxNumIterationsEnclosingSphere, addr 0x6792bf4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t get_maxNumIterationsEnclosingSphere();

  /// @brief Method get_maxPerObjectLights, addr 0x6792bfc, size 0x8, virtual false, abstract: false, final false
  static inline int32_t get_maxPerObjectLights();

  /// @brief Method get_maxRenderScale, addr 0x6792bec, size 0x8, virtual false, abstract: false, final false
  static inline float_t get_maxRenderScale();

  /// @brief Method get_maxShadowBias, addr 0x6792bd8, size 0x8, virtual false, abstract: false, final false
  static inline float_t get_maxShadowBias();

  /// @brief Method get_maxTileWords, addr 0x6792c68, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_maxTileWords();

  /// @brief Method get_maxVisibleAdditionalLights, addr 0x678a538, size 0x15c, virtual false, abstract: false, final false
  static inline int32_t get_maxVisibleAdditionalLights();

  /// @brief Method get_maxVisibleReflectionProbes, addr 0x6792ccc, size 0x90, virtual false, abstract: false, final false
  static inline int32_t get_maxVisibleReflectionProbes();

  /// @brief Method get_maxZBinWords, addr 0x6792c60, size 0x8, virtual false, abstract: false, final false
  static inline int32_t get_maxZBinWords();

  /// @brief Method get_minRenderScale, addr 0x6792be0, size 0xc, virtual false, abstract: false, final false
  static inline float_t get_minRenderScale();

  /// @brief Method get_runtimeTextures, addr 0x6792d5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineRuntimeTextures* get_runtimeTextures();

  /// @brief Method get_startFrameScreenMSAASamples, addr 0x6792e34, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_canOptimizeScreenMSAASamples, addr 0x6792dd0, size 0x64, virtual false, abstract: false, final false
  static inline void set_canOptimizeScreenMSAASamples(bool value);

  /// @brief Method set_runtimeTextures, addr 0x6792d64, size 0x8, virtual false, abstract: false, final false
  inline void set_runtimeTextures(::UnityEngine::Rendering::Universal::UniversalRenderPipelineRuntimeTextures* value);

  /// @brief Method set_startFrameScreenMSAASamples, addr 0x6792e90, size 0x60, virtual false, abstract: false, final false
