...
public:
  ...
  /// @brief Method Execute, addr 0x686022c, size 0x118, virtual false, abstract: false, final false
  inline void Execute();

  /// @brief Method Execute, addr 0x6860344, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68601a4, size 0x88, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalUpdateCulledSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalUpdateCulledSystem(DecalUpdateCulledSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalUpdateCulledSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalUpdateCulledSystem(DecalUpdateCulledSystemconst&) = delete;
