...
public:
  ...
  /// @brief Method IsActive, addr 0x6878768, size 0x8, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6878770, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6878778, size 0x44c, virtual false, abstract: false, final false
  inline void _ctor();
