...
public:
  ...
  /// @brief Method IsActive, addr 0x6738274, size 0x8, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x673827c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6738284, size 0x44c, virtual false, abstract: false, final false
  inline void _ctor();
