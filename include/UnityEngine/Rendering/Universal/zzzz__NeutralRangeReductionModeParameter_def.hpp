...
public:
  ...
  /// @brief Method .ctor, addr 0x687fdc4, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NeutralRangeReductionModeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NeutralRangeReductionModeParameter(NeutralRangeReductionModeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NeutralRangeReductionModeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NeutralRangeReductionModeParameter(NeutralRangeReductionModeParameterconst&) = delete;
