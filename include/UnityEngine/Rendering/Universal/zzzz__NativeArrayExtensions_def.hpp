...
template<typename T>
static inline ::ByRef<T> UnsafeElementAt(::Unity::Collections::NativeArray_1<T>  array, int32_t  index) ;

/// @brief Method UnsafeElementAtMutable, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ByRef<T> UnsafeElementAtMutable(::Unity::Collections::NativeArray_1<T>  array, int32_t  index) ;
