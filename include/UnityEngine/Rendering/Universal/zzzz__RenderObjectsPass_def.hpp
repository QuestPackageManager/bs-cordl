...
public:
  ...
  /// @brief Method .ctor, addr 0x675cdf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RecordRenderGraph>b__33_0, addr 0x675f004, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675f000, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Execute, addr 0x675cdfc, size 0x1f0, virtual true, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext context, ::ByRef<::UnityEngine::Rendering::Universal::RenderingData> renderingData);

  /// @brief Method ExecutePass, addr 0x675d36c, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x675c93c, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method InitPassData, addr 0x675cfec, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method InitRendererLists, addr 0x675d020, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecordRenderGraph, addr 0x675e1e4, size 0xdc8, virtual true, abstract: false, final false
  inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, ::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method SetDepthState, addr 0x675c72c, size 0x3c, virtual false, abstract: false, final false
  inline void SetDepthState(bool writeEnabled, ::UnityEngine::Rendering::CompareFunction function);

  /// @brief Method SetDetphState, addr 0x675c6f0, size 0x3c, virtual false, abstract: false, final false
  inline void SetDetphState(bool writeEnabled, ::UnityEngine::Rendering::CompareFunction function);

  /// @brief Method SetStencilState, addr 0x675c768, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675cce8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675c80c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method get_overrideMaterial, addr 0x675c6b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_overrideMaterial();

  /// @brief Method get_overrideMaterialPassIndex, addr 0x675c6c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_overrideMaterialPassIndex();

  /// @brief Method get_overrideShader, addr 0x675c6d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_overrideShader();

  /// @brief Method get_overrideShaderPassIndex, addr 0x675c6e0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_overrideShaderPassIndex();

  /// @brief Method set_overrideMaterial, addr 0x675c6b8, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideMaterial(::UnityEngine::Material* value);

  /// @brief Method set_overrideMaterialPassIndex, addr 0x675c6c8, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideMaterialPassIndex(int32_t value);

  /// @brief Method set_overrideShader, addr 0x675c6d8, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideShader(::UnityEngine::Shader* value);

  /// @brief Method set_overrideShaderPassIndex, addr 0x675c6e8, size 0x8, virtual false, abstract: false, final false
