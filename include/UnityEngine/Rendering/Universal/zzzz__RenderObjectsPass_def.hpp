...
/// @brief Method .ctor, addr 0x66eadec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RecordRenderGraph>b__33_0, addr 0x66ecff8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66ecff4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Execute, addr 0x66eadf0, size 0x1f0, virtual true, abstract: false, final false
inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext  context, ::ByRef<::UnityEngine::Rendering::Universal::RenderingData>  renderingData) ;

/// @brief Method ExecutePass, addr 0x66eb360, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x66ea930, size 0x3ac, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW,::Array<::StringW>*>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method InitPassData, addr 0x66eafe0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method InitRendererLists, addr 0x66eb014, size 0x34c, virtual false, abstract: false, final false
inline void InitRendererLists(::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::ByRef<::UnityEngine::Rendering::Universal::RenderObjectsPass_PassData*>  passData, ::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, bool  useRenderGraph) ;

static inline ::UnityEngine::Rendering::Universal::RenderObjectsPass* New_ctor(::UnityEngine::Rendering::Universal::URPProfileId  profileId, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW,::Array<::StringW>*>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

static inline ::UnityEngine::Rendering::Universal::RenderObjectsPass* New_ctor(::StringW  profilerTag, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW,::Array<::StringW>*>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method RecordRenderGraph, addr 0x66ec1d8, size 0xdc8, virtual true, abstract: false, final false
inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::ContextContainer*  frameData) ;

/// @brief Method SetDepthState, addr 0x66ea720, size 0x3c, virtual false, abstract: false, final false
inline void SetDepthState(bool  writeEnabled, ::UnityEngine::Rendering::CompareFunction  function) ;

/// @brief Method SetDetphState, addr 0x66ea6e4, size 0x3c, virtual false, abstract: false, final false
inline void SetDetphState(bool  writeEnabled, ::UnityEngine::Rendering::CompareFunction  function) ;

/// @brief Method SetStencilState, addr 0x66ea75c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66eacdc, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::Universal::URPProfileId  profileId, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW,::Array<::StringW>*>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method .ctor, addr 0x66ea800, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::StringW  profilerTag, ::UnityEngine::Rendering::Universal::RenderPassEvent  renderPassEvent, ::ArrayW<::StringW,::Array<::StringW>*>  shaderTags, ::UnityEngine::Rendering::Universal::RenderQueueType  renderQueueType, int32_t  layerMask, ::UnityEngine::Rendering::Universal::RenderObjects_CustomCameraSettings*  cameraSettings) ;

/// @brief Method get_overrideMaterial, addr 0x66ea6a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_overrideMaterial() ;

/// @brief Method get_overrideMaterialPassIndex, addr 0x66ea6b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_overrideMaterialPassIndex() ;

/// @brief Method get_overrideShader, addr 0x66ea6c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_overrideShader() ;

/// @brief Method get_overrideShaderPassIndex, addr 0x66ea6d4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_overrideShaderPassIndex() ;

/// @brief Method set_overrideMaterial, addr 0x66ea6ac, size 0x8, virtual false, abstract: false, final false
inline void set_overrideMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_overrideMaterialPassIndex, addr 0x66ea6bc, size 0x8, virtual false, abstract: false, final false
inline void set_overrideMaterialPassIndex(int32_t  value) ;

/// @brief Method set_overrideShader, addr 0x66ea6cc, size 0x8, virtual false, abstract: false, final false
inline void set_overrideShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_overrideShaderPassIndex, addr 0x66ea6dc, size 0x8, virtual false, abstract: false, final false
