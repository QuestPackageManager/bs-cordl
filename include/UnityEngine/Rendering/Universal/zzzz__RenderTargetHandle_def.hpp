...
public:
  ...
  /// @brief Method Equals, addr 0x6772378, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6772234, size 0x144, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::Rendering::Universal::RenderTargetHandle other);

  /// @brief Method GetCameraTarget, addr 0x6771ef8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x6772440, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasInternalRenderTargetId, addr 0x67721d4, size 0x60, virtual false, abstract: false, final false
  inline bool HasInternalRenderTargetId();

  /// @brief Method Identifier, addr 0x67720c8, size 0x10c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderTargetIdentifier Identifier();

  /// @brief Method Init, addr 0x677204c, size 0x7c, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Rendering::RenderTargetIdentifier renderTargetIdentifier);

  /// @brief Method Init, addr 0x6771fd4, size 0x78, virtual false, abstract: false, final false
  inline void Init(::StringW shaderProperty);

  /// @brief Method .ctor, addr 0x6771c84, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::RenderTargetIdentifier renderTargetIdentifier);

  /// @brief Method .ctor, addr 0x6771d00, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_id, addr 0x6771c4c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_rtid, addr 0x6771c6c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderTargetIdentifier get_rtid();

  /// @brief Method op_Equality, addr 0x6772498, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x6772520, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_id, addr 0x6771c44, size 0x8, virtual false, abstract: false, final false
  inline void set_id(int32_t value);

  /// @brief Method set_rtid, addr 0x6771c54, size 0x18, virtual false, abstract: false, final false
