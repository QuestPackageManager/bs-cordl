...
public:
  // Declarations
  /// @brief Method GetPassIndex, addr 0x68626bc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6862638, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawScreenSpaceSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawScreenSpaceSystem(DecalDrawScreenSpaceSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawScreenSpaceSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawScreenSpaceSystem(DecalDrawScreenSpaceSystemconst&) = delete;
