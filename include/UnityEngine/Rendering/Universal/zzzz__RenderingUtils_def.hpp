...
public:
  ...
  /// @brief Method AddStaleResourceToPoolOrRelease, addr 0x68b4df4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x68b2e80, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x68b3054, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearSystemInfoCache, addr 0x68b3d38, size 0x80, virtual false, abstract: false, final false
  static inline void ClearSystemInfoCache();

  /// @brief Method Contains, addr 0x68b4430, size 0xc, virtual false, abstract: false, final false
  static inline bool Contains(::UnityEngine::Rendering::ClearFlag a, ::UnityEngine::Rendering::ClearFlag b);

  /// @brief Method Contains, addr 0x68b40b4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CountDistinct, addr 0x68b42bc, size 0xe4, virtual false, abstract: false, final false
  static inline uint32_t CountDistinct(::ArrayW<::UnityEngine::Rendering::RTHandle*> source, ::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method CreateDrawingSettings, addr 0x68b61c8, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x68b6058, size 0x170, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::ShaderTagId shaderTagId,
                                                                                ::by_ref<::UnityEngine::Rendering::Universal::RenderingData> renderingData,
                                                                                ::UnityEngine::Rendering::SortingCriteria sortingCriteria);

  /// @brief Method CreateDrawingSettings, addr 0x68a3738, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x68b6364, size 0x170, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* shaderTagIdList,
                                                                                ::by_ref<::UnityEngine::Rendering::Universal::RenderingData> renderingData,
                                                                                ::UnityEngine::Rendering::SortingCriteria sortingCriteria);
  ...
  /// @brief Method CreateRendererListObjectsWithError, addr 0x68b3a4c, size 0x180, virtual false, abstract: false, final false
  ...
  /// [Conditional("DEVELOPMENT_BUILD")]
  /// [Conditional("UNITY_EDITOR")]
  /// @brief Method CreateRendererListObjectsWithError, addr 0x68b3bcc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x68a3c94, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x68a3998, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// [Conditional("DEVELOPMENT_BUILD")]
  /// [Conditional("UNITY_EDITOR")]
  /// @brief Method CreateRendererParamsObjectsWithError, addr 0x68b371c, size 0x330, virtual false, abstract: false, final false
  ...
  /// [Conditional("DEVELOPMENT_BUILD")]
  /// [Conditional("UNITY_EDITOR")]
  /// @brief Method DrawRendererListObjectsWithError, addr 0x68b3d00, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalBlit, addr 0x68b3268, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraTargetIdentifier, addr 0x68b48ec, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFinalBlitScaleBias, addr 0x68b64d4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastValidColorBufferIndex, addr 0x68b3f20, size 0xa0, virtual false, abstract: false, final false
  static inline int32_t GetLastValidColorBufferIndex(::ArrayW<::UnityEngine::Rendering::RenderTargetIdentifier> colorBuffers);

  /// @brief Method GetValidColorBufferCount, addr 0x68b3fc0, size 0x90, virtual false, abstract: false, final false
  static inline uint32_t GetValidColorBufferCount(::ArrayW<::UnityEngine::Rendering::RTHandle*> colorBuffers);

  /// @brief Method IndexOf, addr 0x68b422c, size 0x90, virtual false, abstract: false, final false
  static inline int32_t IndexOf(::ArrayW<::UnityEngine::Rendering::RTHandle*> source, ::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method IndexOf, addr 0x68b416c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRT, addr 0x68b4050, size 0x64, virtual false, abstract: false, final false
  static inline bool IsMRT(::ArrayW<::UnityEngine::Rendering::RTHandle*> colorBuffers);

  /// @brief Method LastValid, addr 0x68b43a0, size 0x90, virtual false, abstract: false, final false
  static inline int32_t LastValid(::ArrayW<::UnityEngine::Rendering::RTHandle*> source);

  /// @brief Method MultisampleDepthResolveSupported, addr 0x68b4520, size 0xf8, virtual false, abstract: false, final false
  static inline bool MultisampleDepthResolveSupported();

  /// @brief Method RTHandleNeedsReAlloc, addr 0x68b4618, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x68a6e48, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x68b56cc, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x68b5b18, size 0x4a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x68b4a98, size 0x35c, virtual false, abstract: false, final false
  ...
  /// [Obsolete("This method will be removed in a future release. Please use ReAllocateHandleIfNeeded instead. #from(2023.3)")]
  /// @brief Method ReAllocateIfNeeded, addr 0x68b4ee4, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// [Obsolete("This method will be removed in a future release. Please use ReAllocateHandleIfNeeded instead. #from(2023.3)")]
  /// @brief Method ReAllocateIfNeeded, addr 0x68b52c8, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x68b443c, size 0xe4, virtual false, abstract: false, final false
  static inline bool SequenceEqual(::ArrayW<::UnityEngine::Rendering::RTHandle*> left, ::ArrayW<::UnityEngine::Rendering::RTHandle*> right);

  /// @brief Method SetMaxRTHandlePoolCapacity, addr 0x68b5fb8, size 0xa0, virtual false, abstract: false, final false
  static inline bool SetMaxRTHandlePoolCapacity(int32_t capacity);

  /// @brief Method SetScaleBiasRt, addr 0x68b2b84, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScaleBiasRt, addr 0x68b2ce0, size 0x1a0, virtual false, abstract: false, final false
  static inline void SetScaleBiasRt(::UnityEngine::Rendering::RasterCommandBuffer* cmd, /* [IsReadOnly] */ ::by_ref<::UnityEngine::Rendering::Universal::RenderingData> renderingData);

  /// @brief Method SetViewAndProjectionMatrices, addr 0x68b2aa0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewAndProjectionMatrices, addr 0x68a346c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsGraphicsFormat, addr 0x68b3ed8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsLightLayers, addr 0x68b28fc, size 0x8, virtual false, abstract: false, final false
  static inline bool SupportsLightLayers(::UnityEngine::Rendering::GraphicsDeviceType type);

  /// @brief Method SupportsRenderTextureFormat, addr 0x68b3db8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_emptyAttachment, addr 0x68b22a4, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::AttachmentDescriptor get_emptyAttachment();

  /// @brief Method get_errorMaterial, addr 0x68b2904, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_errorMaterial();

  /// @brief Method get_fullscreenMesh, addr 0x68b230c, size 0x5e8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> get_fullscreenMesh();

  /// @brief Method get_useStructuredBuffer, addr 0x68b28f4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  RenderingUtils(RenderingUtilsconst&) = delete;
