...
public:
  ...
  /// @brief Method AddStaleResourceToPoolOrRelease, addr 0x66fca1c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x66faaa8, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x66fac7c, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearSystemInfoCache, addr 0x66fb960, size 0x80, virtual false, abstract: false, final false
  static inline void ClearSystemInfoCache();

  /// @brief Method Contains, addr 0x66fc058, size 0xc, virtual false, abstract: false, final false
  static inline bool Contains(::UnityEngine::Rendering::ClearFlag a, ::UnityEngine::Rendering::ClearFlag b);

  /// @brief Method Contains, addr 0x66fbcdc, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CountDistinct, addr 0x66fbee4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x66fdc80, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x66fddf0, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::ShaderTagId shaderTagId,
  ...
  /// @brief Method CreateDrawingSettings, addr 0x66fdf8c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x66eb360, size 0x260, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* shaderTagIdList,
                                                                                ::UnityEngine::Rendering::Universal::UniversalRenderingData* renderingData,
                                                                                ::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData,
                                                                                ::UnityEngine::Rendering::Universal::UniversalLightData* lightData,
  ...
  /// @brief Method CreateRendererListObjectsWithError, addr 0x66fb674, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListObjectsWithError, addr 0x66fb7f4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x66eb8bc, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x66eb5c0, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererParamsObjectsWithError, addr 0x66fb344, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawRendererListObjectsWithError, addr 0x66fb928, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalBlit, addr 0x66fae90, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraTargetIdentifier, addr 0x66fc514, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFinalBlitScaleBias, addr 0x66fe0fc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastValidColorBufferIndex, addr 0x66fbb48, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetValidColorBufferCount, addr 0x66fbbe8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x66fbe54, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x66fbd94, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRT, addr 0x66fbc78, size 0x64, virtual false, abstract: false, final false
  static inline bool IsMRT(::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> colorBuffers);

  /// @brief Method LastValid, addr 0x66fbfc8, size 0x90, virtual false, abstract: false, final false
  static inline int32_t LastValid(::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> source);

  /// @brief Method MultisampleDepthResolveSupported, addr 0x66fc148, size 0xf8, virtual false, abstract: false, final false
  static inline bool MultisampleDepthResolveSupported();

  /// @brief Method RTHandleNeedsReAlloc, addr 0x66fc240, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x66eea70, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x66fd2f4, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x66fd740, size 0x4a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x66fc6c0, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x66fcb0c, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x66fcef0, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x66fc064, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMaxRTHandlePoolCapacity, addr 0x66fdbe0, size 0xa0, virtual false, abstract: false, final false
  static inline bool SetMaxRTHandlePoolCapacity(int32_t capacity);

  /// @brief Method SetScaleBiasRt, addr 0x66fa7ac, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScaleBiasRt, addr 0x66fa908, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewAndProjectionMatrices, addr 0x66fa6c8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewAndProjectionMatrices, addr 0x66eb094, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsGraphicsFormat, addr 0x66fbb00, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsLightLayers, addr 0x66fa524, size 0x8, virtual false, abstract: false, final false
  static inline bool SupportsLightLayers(::UnityEngine::Rendering::GraphicsDeviceType type);

  /// @brief Method SupportsRenderTextureFormat, addr 0x66fb9e0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_emptyAttachment, addr 0x66f9ecc, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::AttachmentDescriptor get_emptyAttachment();

  /// @brief Method get_errorMaterial, addr 0x66fa52c, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_errorMaterial();

  /// @brief Method get_fullscreenMesh, addr 0x66f9f34, size 0x5e8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> get_fullscreenMesh();

  /// @brief Method get_useStructuredBuffer, addr 0x66fa51c, size 0x8, virtual false, abstract: false, final false
