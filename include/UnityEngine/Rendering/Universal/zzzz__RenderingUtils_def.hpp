...
public:
  ...
  /// @brief Method AddStaleResourceToPoolOrRelease, addr 0x676f0e8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x676d174, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x676d348, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearSystemInfoCache, addr 0x676e02c, size 0x80, virtual false, abstract: false, final false
  static inline void ClearSystemInfoCache();

  /// @brief Method Contains, addr 0x676e724, size 0xc, virtual false, abstract: false, final false
  static inline bool Contains(::UnityEngine::Rendering::ClearFlag a, ::UnityEngine::Rendering::ClearFlag b);

  /// @brief Method Contains, addr 0x676e3a8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CountDistinct, addr 0x676e5b0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x677034c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x67704bc, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::ShaderTagId shaderTagId,
  ...
  /// @brief Method CreateDrawingSettings, addr 0x6770658, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDrawingSettings, addr 0x675da2c, size 0x260, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* shaderTagIdList,
                                                                                ::UnityEngine::Rendering::Universal::UniversalRenderingData* renderingData,
                                                                                ::UnityEngine::Rendering::Universal::UniversalCameraData* cameraData,
                                                                                ::UnityEngine::Rendering::Universal::UniversalLightData* lightData,
  ...
  /// @brief Method CreateRendererListObjectsWithError, addr 0x676dd40, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListObjectsWithError, addr 0x676dec0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x675df88, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListWithRenderStateBlock, addr 0x675dc8c, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererParamsObjectsWithError, addr 0x676da10, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawRendererListObjectsWithError, addr 0x676dff4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalBlit, addr 0x676d55c, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameraTargetIdentifier, addr 0x676ebe0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFinalBlitScaleBias, addr 0x67707c8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastValidColorBufferIndex, addr 0x676e214, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetValidColorBufferCount, addr 0x676e2b4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x676e520, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOf, addr 0x676e460, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRT, addr 0x676e344, size 0x64, virtual false, abstract: false, final false
  static inline bool IsMRT(::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> colorBuffers);

  /// @brief Method LastValid, addr 0x676e694, size 0x90, virtual false, abstract: false, final false
  static inline int32_t LastValid(::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> source);

  /// @brief Method MultisampleDepthResolveSupported, addr 0x676e814, size 0xf8, virtual false, abstract: false, final false
  static inline bool MultisampleDepthResolveSupported();

  /// @brief Method RTHandleNeedsReAlloc, addr 0x676e90c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x676113c, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x676f9c0, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateHandleIfNeeded, addr 0x676fe0c, size 0x4a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x676ed8c, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x676f1d8, size 0x3e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateIfNeeded, addr 0x676f5bc, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceEqual, addr 0x676e730, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMaxRTHandlePoolCapacity, addr 0x67702ac, size 0xa0, virtual false, abstract: false, final false
  static inline bool SetMaxRTHandlePoolCapacity(int32_t capacity);

  /// @brief Method SetScaleBiasRt, addr 0x676ce78, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScaleBiasRt, addr 0x676cfd4, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewAndProjectionMatrices, addr 0x676cd94, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewAndProjectionMatrices, addr 0x675d760, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsGraphicsFormat, addr 0x676e1cc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method SupportsLightLayers, addr 0x676cbf0, size 0x8, virtual false, abstract: false, final false
  static inline bool SupportsLightLayers(::UnityEngine::Rendering::GraphicsDeviceType type);

  /// @brief Method SupportsRenderTextureFormat, addr 0x676e0ac, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_emptyAttachment, addr 0x676c598, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::AttachmentDescriptor get_emptyAttachment();

  /// @brief Method get_errorMaterial, addr 0x676cbf8, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_errorMaterial();

  /// @brief Method get_fullscreenMesh, addr 0x676c600, size 0x5e8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> get_fullscreenMesh();

  /// @brief Method get_useStructuredBuffer, addr 0x676cbe8, size 0x8, virtual false, abstract: false, final false
