...
public:
  ...
  /// @brief Method .ctor, addr 0x67791a4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* renderer);

  /// @brief Method .ctor, addr 0x6779248, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Type*, ::Array<::System::Type*>*> renderers);

  /// @brief Method get_rendererTypes, addr 0x677919c, size 0x8, virtual false, abstract: false, final false
