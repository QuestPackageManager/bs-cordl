...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalSkipCulledSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalSkipCulledSystem(DecalSkipCulledSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalSkipCulledSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalSkipCulledSystem(DecalSkipCulledSystemconst&) = delete;
