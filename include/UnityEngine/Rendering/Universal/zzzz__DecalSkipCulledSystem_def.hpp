...
public:
  ...
  /// @brief Method Execute, addr 0x68592bc, size 0x124, virtual false, abstract: false, final false
  inline void Execute(::UnityEngine::Camera* camera);

  /// @brief Method Execute, addr 0x68593e0, size 0xd4, virtual false, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::Universal::DecalCulledChunk* culledChunk, int32_t count);

  /// @brief Method GetSceneCullingMaskFromCamera, addr 0x68594b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6859234, size 0x88, virtual false, abstract: false, final false
