...
/// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x66ff134, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x66ff31c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cameraMotionVector, addr 0x66ff1b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_cameraMotionVector() ;

/// @brief Method get_copyDepthPS, addr 0x66ff13c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_copyDepthPS() ;

/// @brief Method get_decalDBufferClear, addr 0x66ff2a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_decalDBufferClear() ;

/// @brief Method get_stencilDeferredPS, addr 0x66ff22c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_stencilDeferredPS() ;

/// @brief Method get_version, addr 0x66ff12c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_cameraMotionVector, addr 0x66ff1bc, size 0x70, virtual false, abstract: false, final false
inline void set_cameraMotionVector(::UnityEngine::Shader*  value) ;

/// @brief Method set_copyDepthPS, addr 0x66ff144, size 0x70, virtual false, abstract: false, final false
inline void set_copyDepthPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_decalDBufferClear, addr 0x66ff2ac, size 0x70, virtual false, abstract: false, final false
inline void set_decalDBufferClear(::UnityEngine::Shader*  value) ;

/// @brief Method set_stencilDeferredPS, addr 0x66ff234, size 0x70, virtual false, abstract: false, final false
