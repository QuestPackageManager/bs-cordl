...
public:
  ...
  /// @brief Method .ctor, addr 0x68adafc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DBufferSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DBufferSettings(DBufferSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DBufferSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DBufferSettings(DBufferSettingsconst&) = delete;
