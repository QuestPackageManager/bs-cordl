...
/// @brief Method .ctor, addr 0x66bc1ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x66bc1f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method InternalCreateRenderer, addr 0x66bc0e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x66bc0fc, size 0xc, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x66bc0f0, size 0xc, virtual true, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetDirty, addr 0x66bc0d4, size 0xc, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method TryGetRendererFeature, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline bool TryGetRendererFeature(::ByRef<T>  rendererFeature) ;
...
/// @brief Method .ctor, addr 0x66bc120, size 0xcc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isInvalidated, addr 0x66bc0bc, size 0x8, virtual false, abstract: false, final false
inline bool get_isInvalidated() ;

/// @brief Method get_rendererFeatures, addr 0x66bc0cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_useNativeRenderPass, addr 0x66bc108, size 0x8, virtual false, abstract: false, final false
inline bool get_useNativeRenderPass() ;

/// @brief Method set_isInvalidated, addr 0x66bc0c4, size 0x8, virtual false, abstract: false, final false
inline void set_isInvalidated(bool  value) ;

/// @brief Method set_useNativeRenderPass, addr 0x66bc110, size 0x10, virtual false, abstract: false, final false
