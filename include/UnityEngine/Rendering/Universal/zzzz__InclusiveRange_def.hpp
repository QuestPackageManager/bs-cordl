...
public:
  ...
  /// @brief Method Clamp, addr 0x6709490, size 0x90, virtual false, abstract: false, final false
  inline void Clamp(int16_t min, int16_t max);

  /// @brief Method Contains, addr 0x6709534, size 0x24, virtual false, abstract: false, final false
  inline bool Contains(int16_t index);

  /// @brief Method Expand, addr 0x6709408, size 0x88, virtual false, abstract: false, final false
  inline void Expand(int16_t index);

  /// @brief Method Merge, addr 0x6709558, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x67095e4, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x67093fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int16_t start, int16_t end);

  /// @brief Method .ctor, addr 0x67093f0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int16_t startEnd);

  /// @brief Method get_empty, addr 0x67095dc, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::InclusiveRange get_empty();

  /// @brief Method get_isEmpty, addr 0x6709520, size 0x14, virtual false, abstract: false, final false
