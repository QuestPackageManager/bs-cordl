...
public:
  // Declarations
  /// @brief Method GetPassIndex, addr 0x6853a38, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6853894, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawDBufferSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawDBufferSystem(DecalDrawDBufferSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawDBufferSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawDBufferSystem(DecalDrawDBufferSystemconst&) = delete;
