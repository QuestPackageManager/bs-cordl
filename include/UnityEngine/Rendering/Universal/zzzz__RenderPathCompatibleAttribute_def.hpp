...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RenderPathCompatibleAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RenderPathCompatibleAttribute(RenderPathCompatibleAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RenderPathCompatibleAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RenderPathCompatibleAttribute(RenderPathCompatibleAttributeconst&) = delete;
