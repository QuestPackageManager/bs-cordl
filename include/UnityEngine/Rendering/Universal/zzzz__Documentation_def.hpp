...
public:
// Declarations
/// @brief Method GetPageLink, addr 0x66bce20, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetPageLink(::StringW  pageName) ;

static inline ::UnityEngine::Rendering::Universal::Documentation* New_ctor() ;

/// @brief Method .ctor, addr 0x66bce70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
