...
public:
  // Declarations
  /// @brief Method GetPageLink, addr 0x6874b38, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW GetPageLink(::StringW pageName);

  static inline ::UnityEngine::Rendering::Universal::Documentation* New_ctor();

  /// @brief Method .ctor, addr 0x6874b88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  Documentation(Documentationconst&) = delete;
