...
public:
  ...
  /// @brief Method IsActive, addr 0x672e200, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x672e230, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x672e238, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor();
