...
public:
  ...
  /// @brief Method IsActive, addr 0x687a18c, size 0x8c, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x687a218, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x687a220, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();
