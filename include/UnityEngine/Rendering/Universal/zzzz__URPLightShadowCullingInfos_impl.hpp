...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos::*)(int32_t)>(&::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos::IsSliceValid)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x67033cc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::URPLightShadowCullingInfos>::get(),
                        "IsSliceValid",
