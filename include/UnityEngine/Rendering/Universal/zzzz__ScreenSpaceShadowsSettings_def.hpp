...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScreenSpaceShadowsSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScreenSpaceShadowsSettings(ScreenSpaceShadowsSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScreenSpaceShadowsSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScreenSpaceShadowsSettings(ScreenSpaceShadowsSettingsconst&) = delete;
