...
/// @brief Method .ctor, addr 0x66f7b88, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x66f7c78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x66f7c80, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddRenderPasses, addr 0x66f7a68, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method Create, addr 0x66f78c8, size 0x1a0, virtual true, abstract: false, final false
inline void Create() ;

static inline ::UnityEngine::Rendering::Universal::RenderObjects* New_ctor() ;

/// @brief Method SupportsNativeRenderPass, addr 0x66f7b18, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66f7b20, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::RenderObjectsSettings_RenderObjects_OverrideMaterialMode, "UnityEngine.Rendering.Universal", "RenderObjects/RenderObjectsSettings/OverrideMaterialMode");
