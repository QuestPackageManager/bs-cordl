...
public:
  ...
  /// @brief Method .ctor, addr 0x6769b94, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6769c84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6769c8c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddRenderPasses, addr 0x6769a74, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x67698d4, size 0x1a0, virtual true, abstract: false, final false
  inline void Create();

  static inline ::UnityEngine::Rendering::Universal::RenderObjects* New_ctor();

  /// @brief Method SupportsNativeRenderPass, addr 0x6769b24, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6769b2c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
