...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ShaderPropertyId*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ShaderPropertyId*, "UnityEngine.Rendering.Universal", "ShaderPropertyId");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ShaderPropertyId) == 0x10, "Size mismatch!");
