...
public:
  ...
  /// @brief Method Reset, addr 0x6876d54, size 0x1c, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6876d70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
