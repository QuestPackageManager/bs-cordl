...
public:
  ...
  /// @brief Method GetOrCreateAPVSceneData, addr 0x672ebf4, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ProbeVolumeSceneData* GetOrCreateAPVSceneData();

  /// @brief Method GetOrCreateDefaultVolumeProfile, addr 0x672ead8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAtLastVersion, addr 0x672ea88, size 0x10, virtual false, abstract: false, final false
  inline bool IsAtLastVersion();

  static inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineGlobalSettings* New_ctor();

  /// @brief Method Reset, addr 0x672ea98, size 0x40, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetRenderingLayerNames, addr 0x672eb6c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x672ec54, size 0x170, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightLayerNames, addr 0x672eb24, size 0x48, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_lightLayerNames();

  /// @brief Method get_prefixedLightLayerNames, addr 0x672eadc, size 0x48, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_prefixedLightLayerNames();

  /// @brief Method get_settingsList, addr 0x672ea64, size 0x24, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>* get_settingsList();

  /// @brief Method get_stripUnusedLODCrossFadeVariants, addr 0x672ea58, size 0x8, virtual false, abstract: false, final false
  inline bool get_stripUnusedLODCrossFadeVariants();

  /// @brief Method set_stripUnusedLODCrossFadeVariants, addr 0x672ea60, size 0x4, virtual false, abstract: false, final false
