...
/// @brief Method GetOrCreateAPVSceneData, addr 0x66bcbe8, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeVolumeSceneData* GetOrCreateAPVSceneData() ;

/// @brief Method GetOrCreateDefaultVolumeProfile, addr 0x66bcacc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method IsAtLastVersion, addr 0x66bca7c, size 0x10, virtual false, abstract: false, final false
inline bool IsAtLastVersion() ;

static inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineGlobalSettings* New_ctor() ;

/// @brief Method Reset, addr 0x66bca8c, size 0x40, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ResetRenderingLayerNames, addr 0x66bcb60, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66bcc48, size 0x170, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lightLayerNames, addr 0x66bcb18, size 0x48, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_lightLayerNames() ;

/// @brief Method get_prefixedLightLayerNames, addr 0x66bcad0, size 0x48, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_prefixedLightLayerNames() ;

/// @brief Method get_settingsList, addr 0x66bca58, size 0x24, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>* get_settingsList() ;

/// @brief Method get_stripUnusedLODCrossFadeVariants, addr 0x66bca4c, size 0x8, virtual false, abstract: false, final false
inline bool get_stripUnusedLODCrossFadeVariants() ;

/// @brief Method set_stripUnusedLODCrossFadeVariants, addr 0x66bca54, size 0x4, virtual false, abstract: false, final false
