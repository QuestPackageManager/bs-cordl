...
public:
  ...
  /// @brief Method Create, addr 0x66c8af0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x66c8bdc, size 0x74, virtual true, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x66c8c90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canFoveateIntermediatePasses, addr 0x66c8c80, size 0x8, virtual false, abstract: false, final false
  inline bool get_canFoveateIntermediatePasses();

  /// @brief Method get_canMarkLateLatch, addr 0x66c8c60, size 0x8, virtual false, abstract: false, final false
  inline bool get_canMarkLateLatch();

  /// @brief Method get_hasMarkedLateLatch, addr 0x66c8c70, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasMarkedLateLatch();

  /// @brief Method get_isLateLatchEnabled, addr 0x66c8c50, size 0x8, virtual false, abstract: false, final false
  inline bool get_isLateLatchEnabled();

  /// @brief Method set_canFoveateIntermediatePasses, addr 0x66c8c88, size 0x8, virtual false, abstract: false, final false
  inline void set_canFoveateIntermediatePasses(bool value);

  /// @brief Method set_canMarkLateLatch, addr 0x66c8c68, size 0x8, virtual false, abstract: false, final false
  inline void set_canMarkLateLatch(bool value);

  /// @brief Method set_hasMarkedLateLatch, addr 0x66c8c78, size 0x8, virtual false, abstract: false, final false
  inline void set_hasMarkedLateLatch(bool value);

  /// @brief Method set_isLateLatchEnabled, addr 0x66c8c58, size 0x8, virtual false, abstract: false, final false
