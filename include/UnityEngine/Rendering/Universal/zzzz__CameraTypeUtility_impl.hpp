...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::UnityEngine::Rendering::Universal::CameraRenderType)>(&::UnityEngine::Rendering::Universal::CameraTypeUtility::GetName)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x67842d8;
...
::cordl_internals::setStaticField<::ArrayW<::StringW,::Array<::StringW>*>, "s_CameraTypeNames", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::CameraTypeUtility*>::get>(std::forward<::ArrayW<::StringW,::Array<::StringW>*>>(value));
}
inline ::ArrayW<::StringW,::Array<::StringW>*> UnityEngine::Rendering::Universal::CameraTypeUtility::getStaticF_s_CameraTypeNames()  {
return ::cordl_internals::getStaticField<::ArrayW<::StringW,::Array<::StringW>*>, "s_CameraTypeNames", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::CameraTypeUtility*>::get>();
}
