...
/// @brief Method CalculateJitter, addr 0x670673c, size 0x80, virtual false, abstract: false, final false
static inline void CalculateJitter(int32_t  frameIndex, ::ByRef<::UnityEngine::Vector2>  jitter, ::ByRef<bool>  allowScaling) ;

/// @brief Method Execute, addr 0x6706d94, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method PopulateStpConfig, addr 0x67067bc, size 0x598, virtual false, abstract: false, final false
