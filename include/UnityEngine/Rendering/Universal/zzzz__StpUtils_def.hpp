...
public:
  ...
  /// @brief Method CalculateJitter, addr 0x6778748, size 0x80, virtual false, abstract: false, final false
  static inline void CalculateJitter(int32_t frameIndex, ::ByRef<::UnityEngine::Vector2> jitter, ::ByRef<bool> allowScaling);

  /// @brief Method Execute, addr 0x6778da0, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateStpConfig, addr 0x67787c8, size 0x598, virtual false, abstract: false, final false
