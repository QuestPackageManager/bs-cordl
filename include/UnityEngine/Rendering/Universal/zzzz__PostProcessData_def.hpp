...
public:
  ...
  /// @brief Method .ctor, addr 0x66f7084, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66f7088, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66f707c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
