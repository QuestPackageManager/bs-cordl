...
public:
  ...
  /// @brief Method <GetEnumFromPath>b__0, addr 0x67753c8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67750ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetEnumFromPath, addr 0x6774fac, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::ShaderPathID GetEnumFromPath(::StringW path);

  /// @brief Method GetShaderPath, addr 0x6774d80, size 0x22c, virtual false, abstract: false, final false
  static inline ::StringW GetShaderPath(::UnityEngine::Rendering::Universal::ShaderPathID id);

  /// @brief Method IsLWShader, addr 0x67750b0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PersistentDeltaTime, addr 0x6775144, size 0x28, virtual false, abstract: false, final false
