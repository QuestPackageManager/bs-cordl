...
public:
  ...
  /// @brief Method Create, addr 0x677b514, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::TemporalAA_Settings Create();

  /// @brief Method get_baseBlendFactor, addr 0x677b43c, size 0x10, virtual false, abstract: false, final false
  inline float_t get_baseBlendFactor();

  /// @brief Method get_contrastAdaptiveSharpening, addr 0x677b4ec, size 0x8, virtual false, abstract: false, final false
  inline float_t get_contrastAdaptiveSharpening();

  /// @brief Method get_jitterScale, addr 0x677b470, size 0x8, virtual false, abstract: false, final false
  inline float_t get_jitterScale();

  /// @brief Method get_mipBias, addr 0x677b498, size 0x8, virtual false, abstract: false, final false
  inline float_t get_mipBias();

  /// @brief Method get_quality, addr 0x677b41c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::TemporalAAQuality get_quality();

  /// @brief Method get_varianceClampScale, addr 0x677b4c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_varianceClampScale();

  /// @brief Method set_baseBlendFactor, addr 0x677b44c, size 0x24, virtual false, abstract: false, final false
  inline void set_baseBlendFactor(float_t value);

  /// @brief Method set_contrastAdaptiveSharpening, addr 0x677b4f4, size 0x20, virtual false, abstract: false, final false
  inline void set_contrastAdaptiveSharpening(float_t value);

  /// @brief Method set_jitterScale, addr 0x677b478, size 0x20, virtual false, abstract: false, final false
  inline void set_jitterScale(float_t value);

  /// @brief Method set_mipBias, addr 0x677b4a0, size 0x20, virtual false, abstract: false, final false
  inline void set_mipBias(float_t value);

  /// @brief Method set_quality, addr 0x677b424, size 0x18, virtual false, abstract: false, final false
  inline void set_quality(::UnityEngine::Rendering::Universal::TemporalAAQuality value);

  /// @brief Method set_varianceClampScale, addr 0x677b4c8, size 0x24, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x677b548, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x677b610, size 0x24, virtual true, abstract: false, final false
  inline void EndInvoke(::ByRef<::UnityEngine::Vector2> jitter, ::ByRef<bool> allowScaling, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x677b534, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6779130, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x677b634, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__17_0, addr 0x677b690, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method <Render>b__17_1, addr 0x677b9a8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x677b68c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateFilterWeights, addr 0x6779634, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateJitter, addr 0x677959c, size 0x98, virtual false, abstract: false, final false
  static inline void CalculateJitter(int32_t frameIndex, ::ByRef<::UnityEngine::Vector2> jitter, ::ByRef<bool> allowScaling);

  /// @brief Method CalculateJitterMatrix, addr 0x67793d4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTaaFrameIndex, addr 0x6778d60, size 0x40, virtual false, abstract: false, final false
  static inline int32_t CalculateTaaFrameIndex(::ByRef<::UnityEngine::Rendering::Universal::TemporalAA_Settings> settings);

  /// @brief Method ExecutePass, addr 0x6779f4c, size 0x538, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x677a484, size 0xbb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TemporalAADescFromCameraDesc, addr 0x6779870, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAndWarn, addr 0x6779a78, size 0x31c, virtual false, abstract: false, final false
