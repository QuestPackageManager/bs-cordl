...
public:
  ...
  /// @brief Method Create, addr 0x68c1220, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::Universal::TemporalAA_Settings Create();

  /// @brief Method get_baseBlendFactor, addr 0x68c1148, size 0x10, virtual false, abstract: false, final false
  inline float_t get_baseBlendFactor();

  /// @brief Method get_contrastAdaptiveSharpening, addr 0x68c11f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_contrastAdaptiveSharpening();

  /// @brief Method get_jitterScale, addr 0x68c117c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_jitterScale();

  /// @brief Method get_mipBias, addr 0x68c11a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_mipBias();

  /// @brief Method get_quality, addr 0x68c1128, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::TemporalAAQuality get_quality();

  /// @brief Method get_varianceClampScale, addr 0x68c11cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_varianceClampScale();

  /// @brief Method set_baseBlendFactor, addr 0x68c1158, size 0x24, virtual false, abstract: false, final false
  inline void set_baseBlendFactor(float_t value);

  /// @brief Method set_contrastAdaptiveSharpening, addr 0x68c1200, size 0x20, virtual false, abstract: false, final false
  inline void set_contrastAdaptiveSharpening(float_t value);

  /// @brief Method set_jitterScale, addr 0x68c1184, size 0x20, virtual false, abstract: false, final false
  inline void set_jitterScale(float_t value);

  /// @brief Method set_mipBias, addr 0x68c11ac, size 0x20, virtual false, abstract: false, final false
  inline void set_mipBias(float_t value);

  /// @brief Method set_quality, addr 0x68c1130, size 0x18, virtual false, abstract: false, final false
  inline void set_quality(::UnityEngine::Rendering::Universal::TemporalAAQuality value);

  /// @brief Method set_varianceClampScale, addr 0x68c11d4, size 0x24, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x68c1254, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x68c131c, size 0x24, virtual true, abstract: false, final false
  inline void EndInvoke(::by_ref<::UnityEngine::Vector2> jitter, ::by_ref<bool> allowScaling, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x68c1240, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68bee3c, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x68c1340, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__17_0, addr 0x68c139c, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method <Render>b__17_1, addr 0x68c16b4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68c1398, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateFilterWeights, addr 0x68bf340, size 0x23c, virtual false, abstract: false, final false
  static inline ::ArrayW<float_t> CalculateFilterWeights(::by_ref<::UnityEngine::Rendering::Universal::TemporalAA_Settings> settings);

  /// @brief Method CalculateJitter, addr 0x68bf2a8, size 0x98, virtual false, abstract: false, final false
  static inline void CalculateJitter(int32_t frameIndex, ::by_ref<::UnityEngine::Vector2> jitter, ::by_ref<bool> allowScaling);

  /// @brief Method CalculateJitterMatrix, addr 0x68bf0e0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateTaaFrameIndex, addr 0x68bea6c, size 0x40, virtual false, abstract: false, final false
  static inline int32_t CalculateTaaFrameIndex(::by_ref<::UnityEngine::Rendering::Universal::TemporalAA_Settings> settings);

  /// @brief Method ExecutePass, addr 0x68bfc58, size 0x538, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x68c0190, size 0xbb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TemporalAADescFromCameraDesc, addr 0x68bf57c, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateAndWarn, addr 0x68bf784, size 0x31c, virtual false, abstract: false, final false
