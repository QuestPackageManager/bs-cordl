...
public:
  ...
  /// @brief Method .ctor, addr 0x687f1f0, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MotionBlurQualityParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MotionBlurQualityParameter(MotionBlurQualityParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MotionBlurQualityParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MotionBlurQualityParameter(MotionBlurQualityParameterconst&) = delete;
