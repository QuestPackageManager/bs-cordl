...
public:
  ...
  /// @brief Method .ctor, addr 0x683cfd4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StencilStateData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StencilStateData(StencilStateData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StencilStateData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StencilStateData(StencilStateDataconst&) = delete;
