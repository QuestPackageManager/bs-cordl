...
public:
  ...
  /// @brief Method Begin, addr 0x670be78, size 0x70, virtual false, abstract: false, final false
  inline void Begin(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method CreateDrawingSettings, addr 0x670b72c, size 0x160, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::DrawingSettings drawingSettings);

  /// @brief Method CreateRendererList, addr 0x670c080, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x670c18c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x670b728, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DrawWithRendererList, addr 0x670bee8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method End, addr 0x670bfa4, size 0x70, virtual false, abstract: false, final false
  inline void End(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method GetIndex, addr 0x670c2b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetIndex();

  /// @brief Method GetRenderStateBlock, addr 0x670b88c, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670b588, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LightingSettings, addr 0x670c05c, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings();

  /// @brief Method get_MaterialSettings, addr 0x670c014, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings();

  /// @brief Method get_RenderingSettings, addr 0x670c038, size 0x24, virtual false, abstract: false, final false
