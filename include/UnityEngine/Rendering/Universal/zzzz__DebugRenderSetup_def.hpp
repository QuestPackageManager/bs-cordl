...
public:
  ...
  /// @brief Method Begin, addr 0x6631c20, size 0x70, virtual false, abstract: false, final false
  inline void Begin(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method CreateDrawingSettings, addr 0x66314d4, size 0x160, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::DrawingSettings drawingSettings);

  /// @brief Method CreateRendererList, addr 0x6631e28, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x6631f34, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66314d0, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DrawWithRendererList, addr 0x6631c90, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method End, addr 0x6631d4c, size 0x70, virtual false, abstract: false, final false
  inline void End(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method GetIndex, addr 0x6632058, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetIndex();

  /// @brief Method GetRenderStateBlock, addr 0x6631634, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6631330, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LightingSettings, addr 0x6631e04, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings();

  /// @brief Method get_MaterialSettings, addr 0x6631dbc, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings();

  /// @brief Method get_RenderingSettings, addr 0x6631de0, size 0x24, virtual false, abstract: false, final false
