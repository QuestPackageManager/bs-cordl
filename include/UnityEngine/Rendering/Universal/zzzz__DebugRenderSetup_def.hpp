...
/// @brief Method Begin, addr 0x6699e6c, size 0x70, virtual false, abstract: false, final false
inline void Begin(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

/// @brief Method CreateDrawingSettings, addr 0x6699720, size 0x160, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DrawingSettings CreateDrawingSettings(::UnityEngine::Rendering::DrawingSettings  drawingSettings) ;

/// @brief Method CreateRendererList, addr 0x669a074, size 0x10c, virtual false, abstract: false, final false
inline void CreateRendererList(::UnityEngine::Rendering::ScriptableRenderContext  context, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::ByRef<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::ByRef<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::ByRef<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock, ::ByRef<::UnityEngine::Rendering::RendererList>  rendererList) ;

/// @brief Method CreateRendererList, addr 0x669a180, size 0x124, virtual false, abstract: false, final false
inline void CreateRendererList(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::ByRef<::UnityEngine::Rendering::DrawingSettings>  drawingSettings, ::ByRef<::UnityEngine::Rendering::FilteringSettings>  filteringSettings, ::ByRef<::UnityEngine::Rendering::RenderStateBlock>  renderStateBlock, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>  rendererListHdl) ;

/// @brief Method Dispose, addr 0x669971c, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DrawWithRendererList, addr 0x6699edc, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method End, addr 0x6699f98, size 0x70, virtual false, abstract: false, final false
inline void End(::UnityEngine::Rendering::RasterCommandBuffer*  cmd) ;

/// @brief Method GetIndex, addr 0x669a2a4, size 0x8, virtual false, abstract: false, final false
inline int32_t GetIndex() ;

/// @brief Method GetRenderStateBlock, addr 0x6699880, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x669957c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_LightingSettings, addr 0x669a050, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings() ;

/// @brief Method get_MaterialSettings, addr 0x669a008, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings() ;

/// @brief Method get_RenderingSettings, addr 0x669a02c, size 0x24, virtual false, abstract: false, final false
