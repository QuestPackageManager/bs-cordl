...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::*)(::StringW)>(&::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::set_customTitle)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x66f78b0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature*>::get(),
                        "set_customTitle",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::*)()>(&::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::get_customTitle)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x66f78b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::*)(::StringW)>(&::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x66f78c0;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____customTitle_k__BackingField)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, customTitle);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::Universal::DisallowMultipleRendererFeature*>(customTitle));
}
// Ctor Parameters []
