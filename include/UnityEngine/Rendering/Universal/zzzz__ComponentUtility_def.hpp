...
public:
  // Declarations
  /// @brief Method IsUniversalCamera, addr 0x66f6f54, size 0x94, virtual false, abstract: false, final false
  static inline bool IsUniversalCamera(::UnityEngine::Camera* camera);

  /// @brief Method IsUniversalLight, addr 0x66f6fe8, size 0x94, virtual false, abstract: false, final false
