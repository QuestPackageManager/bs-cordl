...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ComponentUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ComponentUtility(ComponentUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ComponentUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ComponentUtility(ComponentUtilityconst&) = delete;
