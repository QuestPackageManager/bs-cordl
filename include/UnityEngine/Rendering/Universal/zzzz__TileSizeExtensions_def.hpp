...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TileSizeExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TileSizeExtensions(TileSizeExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TileSizeExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TileSizeExtensions(TileSizeExtensionsconst&) = delete;
