...
public:
  ...
  /// @brief Method Execute, addr 0x6714808, size 0x30c, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x671448c, size 0x1cc, virtual false, abstract: false, final false
  inline void Execute();

  /// @brief Method Execute, addr 0x6714658, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67143f4, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::Universal::DecalEntityManager* entityManager, float_t maxDrawDistance);

  /// @brief Method get_maxDrawDistance, addr 0x67143e4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxDrawDistance();

  /// @brief Method set_maxDrawDistance, addr 0x67143ec, size 0x8, virtual false, abstract: false, final false
