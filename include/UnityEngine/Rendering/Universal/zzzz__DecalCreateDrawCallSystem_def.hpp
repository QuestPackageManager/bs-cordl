...
/// @brief Method Execute, addr 0x6716380, size 0x30c, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "decalToWorlds", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "normalToWorlds", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "sizeOffsets", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "drawDistances", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>", modifiers: "", def_value: None }, CppParam { name: "angleFades", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float2>", modifiers: "", def_value: None }, CppParam { name: "uvScaleBiases", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4>", modifiers: "", def_value: None }, CppParam { name: "layerMasks", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "sceneLayerMasks", ty: "::Unity::Collections::NativeArray_1<uint64_t>", modifiers: "", def_value: None }, CppParam { name: "fadeFactors", ty: "::Unity::Collections::NativeArray_1<float_t>", modifiers: "", def_value: None }, CppParam { name: "boundingSpheres", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::BoundingSphere>", modifiers: "", def_value: None }, CppParam { name: "renderingLayerMasks", ty: "::Unity::Collections::NativeArray_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "cameraPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "sceneCullingMask", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cullingMask", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "visibleDecalIndices", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "visibleDecalCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxDrawDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "decalToWorldsDraw", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "normalToDecalsDraw", ty: "::Unity::Collections::NativeArray_1<::Unity::Mathematics::float4x4>", modifiers: "", def_value: None }, CppParam { name: "renderingLayerMasksDraw", ty: "::Unity::Collections::NativeArray_1<float_t>", modifiers: "", def_value: None }, CppParam { name: "subCalls", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::DecalSubDrawCall>", modifiers: "", def_value: None }, CppParam { name: "subCallCount", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x6716004, size 0x1cc, virtual false, abstract: false, final false
inline void Execute() ;

/// @brief Method Execute, addr 0x67161d0, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6715f6c, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::Universal::DecalEntityManager*  entityManager, float_t  maxDrawDistance) ;

/// @brief Method get_maxDrawDistance, addr 0x6715f5c, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxDrawDistance() ;

/// @brief Method set_maxDrawDistance, addr 0x6715f64, size 0x8, virtual false, abstract: false, final false
