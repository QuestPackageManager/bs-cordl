...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::URPProfileId, "UnityEngine.Rendering.Universal", "URPProfileId");
// Dependencies
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::URPProfileId) == 0x4, "Size mismatch!");
