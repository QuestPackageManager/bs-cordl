...
public:
  ...
  /// @brief Method Dispose, addr 0x68addf4, size 0x1e4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Get, addr 0x68adb18, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAllDecalPropertyChange, addr 0x68ae0b4, size 0x18, virtual false, abstract: false, final false
  inline void OnAllDecalPropertyChange();

  /// @brief Method OnDecalAdd, addr 0x68adfd8, size 0x58, virtual false, abstract: false, final false
  inline void OnDecalAdd(::UnityEngine::Rendering::Universal::DecalProjector* decalProjector);

  /// @brief Method OnDecalMaterialChange, addr 0x68ae0cc, size 0x28, virtual false, abstract: false, final false
  inline void OnDecalMaterialChange(::UnityEngine::Rendering::Universal::DecalProjector* decalProjector);

  /// @brief Method OnDecalPropertyChange, addr 0x68ae054, size 0x60, virtual false, abstract: false, final false
  inline void OnDecalPropertyChange(::UnityEngine::Rendering::Universal::DecalProjector* decalProjector);

  /// @brief Method OnDecalRemove, addr 0x68ae030, size 0x24, virtual false, abstract: false, final false
  inline void OnDecalRemove(::UnityEngine::Rendering::Universal::DecalProjector* decalProjector);

  /// @brief Method Release, addr 0x68addd8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68ae0f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SharedDecalEntityManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SharedDecalEntityManager(SharedDecalEntityManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SharedDecalEntityManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SharedDecalEntityManager(SharedDecalEntityManagerconst&) = delete;
