...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpaceFillingCurves", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpaceFillingCurves(SpaceFillingCurves&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpaceFillingCurves", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpaceFillingCurves(SpaceFillingCurvesconst&) = delete;
