...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon_SettingsPanel*);
MARK_REF_T(::UnityEngine::Rendering::Universal::SettingsPanel_DebugDisplaySettingsCommon___c__DisplayClass3_0*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon*, "UnityEngine.Rendering.Universal", "DebugDisplaySettingsCommon");
...
public:
  ...
  /// @brief Method <.ctor>b__0, addr 0x683a498, size 0xf8, virtual false, abstract: false, final false
  inline void __ctor_b__0();

  /// @brief Method .ctor, addr 0x683a494, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x683a170, size 0x318, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Flags, addr 0x683a48c, size 0x8, virtual true, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon_SettingsPanel) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreatePanel, addr 0x683a11c, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x683a488, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AreAnySettingsActive, addr 0x683a114, size 0x8, virtual true, abstract: false, final true
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugDisplaySettingsCommon) == 0x10, "Size mismatch!");
