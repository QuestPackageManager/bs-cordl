...
public:
  ...
  /// @brief Method .ctor, addr 0x6876980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t level, int32_t index);

  /// @brief Method get_index2D, addr 0x6876988, size 0xc, virtual false, abstract: false, final false
