...
public:
  ...
  /// @brief Method Dispose, addr 0x685a258, size 0xd4, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalDrawCallChunk* New_ctor();

  /// @brief Method RemoveAtSwapBack, addr 0x685a0a0, size 0xf4, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x685a194, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x685a32c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_subCallCount, addr 0x685a094, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_subCallCount();

  /// @brief Method set_subCallCount, addr 0x685a088, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawCallChunk", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawCallChunk(DecalDrawCallChunk&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawCallChunk", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawCallChunk(DecalDrawCallChunkconst&) = delete;
