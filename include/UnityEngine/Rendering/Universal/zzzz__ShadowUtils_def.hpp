...
public:
  ...
  /// @brief Method AllocShadowRT, addr 0x6777c98, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplySliceTransform, addr 0x6776758, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractDirectionalLightMatrix, addr 0x67764ec, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractDirectionalLightMatrix, addr 0x67763bc, size 0x130, virtual false, abstract: false, final false
  static inline bool ExtractDirectionalLightMatrix(::ByRef<::UnityEngine::Rendering::CullingResults> cullResults, ::ByRef<::UnityEngine::Rendering::Universal::ShadowData> shadowData,
                                                   int32_t shadowLightIndex, int32_t cascadeIndex, int32_t shadowmapWidth, int32_t shadowmapHeight, int32_t shadowResolution, float_t shadowNearPlane,
                                                   ::ByRef<::UnityEngine::Vector4> cascadeSplitDistance, ::ByRef<::UnityEngine::Rendering::Universal::ShadowSliceData> shadowSliceData,
                                                   ::ByRef<::UnityEngine::Matrix4x4> viewMatrix, ::ByRef<::UnityEngine::Matrix4x4> projMatrix);

  /// @brief Method ExtractDirectionalLightMatrix, addr 0x6775d18, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractPointLightMatrix, addr 0x6776930, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractPointLightMatrix, addr 0x6775eec, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractSpotLightMatrix, addr 0x6776888, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractSpotLightMatrix, addr 0x6776048, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method FastApproximately, addr 0x677851c, size 0x100, virtual false, abstract: false, final false
  static inline bool FastApproximately(::UnityEngine::Vector4 a, ::UnityEngine::Vector4 b);

  /// @brief Method FastApproximately, addr 0x6778504, size 0x18, virtual false, abstract: false, final false
  static inline bool FastApproximately(float_t a, float_t b);

  /// @brief Method GetMaxTileResolutionInAtlas, addr 0x6776d6c, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t GetMaxTileResolutionInAtlas(int32_t atlasWidth, int32_t atlasHeight, int32_t tileCount);

  /// @brief Method GetPunctualLightShadowSlicesCount, addr 0x6775ed0, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetPunctualLightShadowSlicesCount(::ByRef<::UnityEngine::LightType> lightType);

  /// @brief Method GetScaleAndBiasForLinearDistanceFade, addr 0x67772b4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetShadowBias, addr 0x6776e70, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method GetShadowBias, addr 0x6776d98, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetShadowBias(::ByRef<::UnityEngine::Rendering::VisibleLight> shadowLight, int32_t shadowLightIndex,
  ...
  /// @brief Method GetShadowBias, addr 0x67771f0, size 0xc4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetShadowBias(::ByRef<::UnityEngine::Rendering::VisibleLight> shadowLight, int32_t shadowLightIndex,
  ...
  /// @brief Method GetShadowTransform, addr 0x67765c8, size 0x190, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 GetShadowTransform(::UnityEngine::Matrix4x4 proj, ::UnityEngine::Matrix4x4 view);

  /// @brief Method GetTemporaryShadowTexture, addr 0x6777974, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporaryShadowTexture(int32_t width, int32_t height, int32_t bits);

  /// @brief Method GetTemporaryShadowTextureDescriptor, addr 0x6777864, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidShadowCastingLight, addr 0x6778394, size 0x144, virtual false, abstract: false, final false
  static inline bool IsValidShadowCastingLight(::UnityEngine::Rendering::Universal::UniversalLightData* lightData, int32_t i);

  /// @brief Method IsValidShadowCastingLight, addr 0x67784d8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method MinimalPunctualLightShadowResolution, addr 0x677861c, size 0x14, virtual false, abstract: false, final false
  static inline int32_t MinimalPunctualLightShadowResolution(bool softShadow);

  /// @brief Method RenderShadowSlice, addr 0x6776cb8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderShadowSlice, addr 0x67769f8, size 0x158, virtual false, abstract: false, final false
  static inline void RenderShadowSlice(::UnityEngine::Rendering::CommandBuffer* cmd, ::ByRef<::UnityEngine::Rendering::ScriptableRenderContext> context,
                                       ::ByRef<::UnityEngine::Rendering::Universal::ShadowSliceData> shadowSliceData, ::ByRef<::UnityEngine::Rendering::ShadowDrawingSettings> settings,
                                       ::UnityEngine::Matrix4x4 proj, ::UnityEngine::Matrix4x4 view);

  /// @brief Method RenderShadowSlice, addr 0x6776b50, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCameraPosition, addr 0x6777680, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLightDirection, addr 0x6777540, size 0xa0, virtual false, abstract: false, final false
  static inline void SetLightDirection(::UnityEngine::Rendering::RasterCommandBuffer* cmd, ::UnityEngine::Vector3 lightDirection);

  /// @brief Method SetLightPosition, addr 0x67775e0, size 0xa0, virtual false, abstract: false, final false
  static inline void SetLightPosition(::UnityEngine::Rendering::RasterCommandBuffer* cmd, ::UnityEngine::Vector3 lightPosition);

  /// @brief Method SetPerLightSoftShadowKeyword, addr 0x677805c, size 0xb0, virtual false, abstract: false, final false
  static inline void SetPerLightSoftShadowKeyword(::UnityEngine::Rendering::RasterCommandBuffer* cmd, bool hasSoftShadows);

  /// @brief Method SetShadowBias, addr 0x677749c, size 0xa4, virtual false, abstract: false, final false
  static inline void SetShadowBias(::UnityEngine::Rendering::RasterCommandBuffer* cmd, ::UnityEngine::Vector4 shadowBias);

  /// @brief Method SetSoftShadowQualityShaderKeywords, addr 0x677810c, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method SetWorldToCameraAndCameraToWorldMatrices, addr 0x6777720, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupShadowCasterConstantBuffer, addr 0x6777308, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupShadowCasterConstantBuffer, addr 0x67773dc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShadowRTNeedsReAlloc, addr 0x6777a60, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method ShadowRTReAllocateIfNeeded, addr 0x6777d8c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method SoftShadowQualityToShaderProperty, addr 0x6777e80, size 0x140, virtual false, abstract: false, final false
  static inline float_t SoftShadowQualityToShaderProperty(::UnityEngine::Light* light, bool softShadowsEnabled);

  /// @brief Method SupportsPerLightSoftShadowQuality, addr 0x6777fc0, size 0x9c, virtual false, abstract: false, final false
