...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ShaderGlobalKeywords", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ShaderGlobalKeywords(ShaderGlobalKeywords&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ShaderGlobalKeywords", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ShaderGlobalKeywords(ShaderGlobalKeywordsconst&) = delete;
