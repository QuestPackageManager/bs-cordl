...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalSettings*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalSettings*, "UnityEngine.Rendering.Universal", "DecalSettings");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalSettings(DecalSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalSettings(DecalSettingsconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalSettings) == 0x30, "Size mismatch!");
