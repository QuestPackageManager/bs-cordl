...
public:
  ...
  /// @brief Method Alloc, addr 0x6878a14, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTexture, addr 0x6878918, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetTexture(int32_t frameIndex);

  /// @brief Method IsAllocated, addr 0x687898c, size 0x1c, virtual false, abstract: false, final false
  inline bool IsAllocated();

  /// @brief Method IsDirty, addr 0x68789a8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreate, addr 0x6878908, size 0x10, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method Reset, addr 0x6878ad0, size 0x20, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x6878af0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6878ba4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
