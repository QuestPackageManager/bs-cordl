...
/// @brief Method Alloc, addr 0x66c0cfc, size 0xbc, virtual false, abstract: false, final false
inline void Alloc(::ByRef<::UnityEngine::RenderTextureDescriptor>  desc) ;

/// @brief Method GetCurrentTexture, addr 0x66c0c60, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method GetPreviousTexture, addr 0x66c0c6c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetPreviousTexture() ;

/// @brief Method GetTexture, addr 0x66c0c00, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetTexture(int32_t  frameIndex) ;

/// @brief Method IsAllocated, addr 0x66c0c74, size 0x1c, virtual false, abstract: false, final false
inline bool IsAllocated() ;

/// @brief Method IsDirty, addr 0x66c0c90, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method OnCreate, addr 0x66c0bf0, size 0x10, virtual true, abstract: false, final false
inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem*  owner, uint32_t  typeId) ;

/// @brief Method Reset, addr 0x66c0db8, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x66c0dd8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c0e8c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
