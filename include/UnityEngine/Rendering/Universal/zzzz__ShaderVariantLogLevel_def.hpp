...
namespace UnityEngine::Rendering::Universal {
// Is value type: true
// CS Name: UnityEngine.Rendering.Universal.ShaderVariantLogLevel
...
public:
  ...
  enum struct __ShaderVariantLogLevel_Unwrapped : int32_t {
    ...
    __E_OnlyUniversalRPShaders = static_cast<int32_t>(0x1),
  ...
  static ::UnityEngine::Rendering::Universal::ShaderVariantLogLevel const AllShaders;

  /// @brief Field Disabled value: I32(0)
  static ::UnityEngine::Rendering::Universal::ShaderVariantLogLevel const Disabled;

  /// @brief Field OnlyUniversalRPShaders value: I32(1)
  static ::UnityEngine::Rendering::Universal::ShaderVariantLogLevel const OnlyUniversalRPShaders;
...
static_assert(offsetof(::UnityEngine::Rendering::Universal::ShaderVariantLogLevel, value__) == 0x0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::Universal::ShaderVariantLogLevel, 0x4>, "Size mismatch!");
