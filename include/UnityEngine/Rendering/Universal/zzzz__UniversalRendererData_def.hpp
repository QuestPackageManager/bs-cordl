...
public:
  ...
  /// @brief Method Create, addr 0x672e524, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x672e998, size 0xc, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ReloadAllNullProperties, addr 0x672e5cc, size 0x4, virtual false, abstract: false, final false
  inline void ReloadAllNullProperties();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x672e9b0, size 0x1c, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x672e9a4, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x672e9cc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_accurateGbufferNormals, addr 0x672e968, size 0x8, virtual false, abstract: false, final false
  inline bool get_accurateGbufferNormals();

  /// @brief Method get_copyDepthMode, addr 0x672e660, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::CopyDepthMode get_copyDepthMode();

  /// @brief Method get_defaultStencilState, addr 0x672e600, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::StencilStateData* get_defaultStencilState();

  /// @brief Method get_depthAttachmentFormat, addr 0x672e678, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DepthFormat get_depthAttachmentFormat();

  /// @brief Method get_depthPrimingMode, addr 0x672e648, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DepthPrimingMode get_depthPrimingMode();

  /// @brief Method get_depthTextureFormat, addr 0x672e828, size 0x130, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DepthFormat get_depthTextureFormat();

  /// @brief Method get_intermediateTextureMode, addr 0x672e980, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::IntermediateTextureMode get_intermediateTextureMode();

  /// @brief Method get_opaqueLayerMask, addr 0x672e5d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_opaqueLayerMask();

  /// @brief Method get_renderingMode, addr 0x672e630, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::RenderingMode get_renderingMode();

  /// @brief Method get_shadowTransparentReceive, addr 0x672e618, size 0x8, virtual false, abstract: false, final false
  inline bool get_shadowTransparentReceive();

  /// @brief Method get_transparentLayerMask, addr 0x672e5e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_transparentLayerMask();

  /// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
  constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

  /// @brief Method set_accurateGbufferNormals, addr 0x672e970, size 0x10, virtual false, abstract: false, final false
  inline void set_accurateGbufferNormals(bool value);

  /// @brief Method set_copyDepthMode, addr 0x672e668, size 0x10, virtual false, abstract: false, final false
  inline void set_copyDepthMode(::UnityEngine::Rendering::Universal::CopyDepthMode value);

  /// @brief Method set_defaultStencilState, addr 0x672e608, size 0x10, virtual false, abstract: false, final false
  inline void set_defaultStencilState(::UnityEngine::Rendering::Universal::StencilStateData* value);

  /// @brief Method set_depthAttachmentFormat, addr 0x672e734, size 0xf4, virtual false, abstract: false, final false
  inline void set_depthAttachmentFormat(::UnityEngine::Rendering::Universal::DepthFormat value);

  /// @brief Method set_depthPrimingMode, addr 0x672e650, size 0x10, virtual false, abstract: false, final false
  inline void set_depthPrimingMode(::UnityEngine::Rendering::Universal::DepthPrimingMode value);

  /// @brief Method set_depthTextureFormat, addr 0x672e958, size 0x10, virtual false, abstract: false, final false
  inline void set_depthTextureFormat(::UnityEngine::Rendering::Universal::DepthFormat value);

  /// @brief Method set_intermediateTextureMode, addr 0x672e988, size 0x10, virtual false, abstract: false, final false
  inline void set_intermediateTextureMode(::UnityEngine::Rendering::Universal::IntermediateTextureMode value);

  /// @brief Method set_opaqueLayerMask, addr 0x672e5d8, size 0x10, virtual false, abstract: false, final false
  inline void set_opaqueLayerMask(::UnityEngine::LayerMask value);

  /// @brief Method set_renderingMode, addr 0x672e638, size 0x10, virtual false, abstract: false, final false
  inline void set_renderingMode(::UnityEngine::Rendering::Universal::RenderingMode value);

  /// @brief Method set_shadowTransparentReceive, addr 0x672e620, size 0x10, virtual false, abstract: false, final false
  inline void set_shadowTransparentReceive(bool value);

  /// @brief Method set_transparentLayerMask, addr 0x672e5f0, size 0x10, virtual false, abstract: false, final false
