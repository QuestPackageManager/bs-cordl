...
public:
  ...
  /// @brief Method .ctor, addr 0x687f6b4, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScreenSpaceLensFlareResolutionParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScreenSpaceLensFlareResolutionParameter(ScreenSpaceLensFlareResolutionParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScreenSpaceLensFlareResolutionParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScreenSpaceLensFlareResolutionParameter(ScreenSpaceLensFlareResolutionParameterconst&) = delete;
