...
public:
  ...
  /// @brief Method .ctor, addr 0x687ea5c, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DepthOfFieldModeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DepthOfFieldModeParameter(DepthOfFieldModeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DepthOfFieldModeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DepthOfFieldModeParameter(DepthOfFieldModeParameterconst&) = delete;
