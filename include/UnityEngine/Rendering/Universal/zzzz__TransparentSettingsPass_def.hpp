...
public:
  ...
  /// @brief Method ExecutePass, addr 0x68a9058, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x68a8f7c, size 0x10, virtual false, abstract: false, final false
  inline bool Setup();
  ...
  /// @brief Method .ctor, addr 0x68a8ea8, size 0xd4, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::TransparentSettingsPass) == 0xc0, "Size mismatch!");
