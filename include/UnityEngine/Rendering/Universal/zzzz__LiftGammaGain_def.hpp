...
/// @brief Method IsActive, addr 0x673ad34, size 0xac, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsTileCompatible, addr 0x673ade0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x673ade8, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
