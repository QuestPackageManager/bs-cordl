...
public:
  ...
  /// @brief Method Initialize, addr 0x67a244c, size 0x1c8, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method IsRunningXRMobile, addr 0x67a2614, size 0x1a4, virtual false, abstract: false, final false
  static inline bool IsRunningXRMobile();

  /// @brief Method ShAutoDetect, addr 0x67a29f8, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isShaderAPIMobileDefined, addr 0x67a2878, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_isShaderAPIMobileDefined();

  /// @brief Method get_isSwitch, addr 0x67a2938, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_isSwitch();

  /// @brief Method get_isXRMobile, addr 0x67a27b8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isShaderAPIMobileDefined, addr 0x67a28d4, size 0x64, virtual false, abstract: false, final false
  static inline void set_isShaderAPIMobileDefined(bool value);

  /// @brief Method set_isSwitch, addr 0x67a2994, size 0x64, virtual false, abstract: false, final false
  static inline void set_isSwitch(bool value);

  /// @brief Method set_isXRMobile, addr 0x67a2814, size 0x64, virtual false, abstract: false, final false
