...
/// @brief Method <UpdateCameraStack>b__53_0, addr 0x67117cc, size 0x60, virtual false, abstract: false, final false
inline bool _UpdateCameraStack_b__53_0(::UnityEngine::Camera*  cam) ;

/// @brief Method .ctor, addr 0x67117c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetOrCreateVolumeStack, addr 0x671024c, size 0x148, virtual false, abstract: false, final false
inline void GetOrCreateVolumeStack() ;

/// @brief Method GetRawRenderer, addr 0x6711654, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method OnAfterDeserialize, addr 0x6711408, size 0x28, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x6711404, size 0x4, virtual true, abstract: false, final true
inline void OnBeforeSerialize() ;

/// @brief Method OnDestroy, addr 0x67115f0, size 0x64, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDrawGizmos, addr 0x67114c8, size 0x128, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method OnValidate, addr 0x6711430, size 0x98, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetRenderer, addr 0x6711280, size 0x8, virtual false, abstract: false, final false
inline void SetRenderer(int32_t  index) ;

/// @brief Method Start, addr 0x6710b68, size 0x34, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateCameraStack, addr 0x6710e70, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6710990, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_allowHDROutput, addr 0x67113f4, size 0x8, virtual false, abstract: false, final false
inline bool get_allowHDROutput() ;

/// @brief Method get_allowXRRendering, addr 0x67113a4, size 0x8, virtual false, abstract: false, final false
inline bool get_allowXRRendering() ;

/// @brief Method get_antialiasing, addr 0x67112d0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::AntialiasingMode get_antialiasing() ;

/// @brief Method get_antialiasingQuality, addr 0x67112e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::AntialiasingQuality get_antialiasingQuality() ;

/// @brief Method get_camera, addr 0x6710ac0, size 0xa8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_camera() ;

/// @brief Method get_cameraStack, addr 0x6707d88, size 0x1b8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Camera>>* get_cameraStack() ;

/// @brief Method get_clearDepth, addr 0x6711138, size 0x8, virtual false, abstract: false, final false
inline bool get_clearDepth() ;

/// @brief Method get_defaultAdditionalCameraData, addr 0x67108e0, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData> get_defaultAdditionalCameraData() ;

/// @brief Method get_dithering, addr 0x6711394, size 0x8, virtual false, abstract: false, final false
inline bool get_dithering() ;

/// @brief Method get_history, addr 0x67112f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ICameraHistoryReadAccess* get_history() ;

/// @brief Method get_historyManager, addr 0x6711300, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::UniversalCameraHistory* get_historyManager() ;

/// @brief Method get_motionVectorsPersistentData, addr 0x6711308, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::MotionVectorsPersistentData* get_motionVectorsPersistentData() ;

/// @brief Method get_renderPostProcessing, addr 0x67112c0, size 0x8, virtual false, abstract: false, final false
inline bool get_renderPostProcessing() ;

/// @brief Method get_renderShadows, addr 0x6710b9c, size 0x8, virtual false, abstract: false, final false
inline bool get_renderShadows() ;

/// @brief Method get_renderType, addr 0x6710bcc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraRenderType get_renderType() ;

/// @brief Method get_requiresColorOption, addr 0x6710bbc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraOverrideOption get_requiresColorOption() ;

/// @brief Method get_requiresColorTexture, addr 0x67111e0, size 0x88, virtual false, abstract: false, final false
inline bool get_requiresColorTexture() ;

/// @brief Method get_requiresDepthOption, addr 0x6710bac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::CameraOverrideOption get_requiresDepthOption() ;

/// @brief Method get_requiresDepthTexture, addr 0x6711140, size 0x88, virtual false, abstract: false, final false
inline bool get_requiresDepthTexture() ;

/// @brief Method get_requiresVolumeFrameworkUpdate, addr 0x6710054, size 0x88, virtual false, abstract: false, final false
inline bool get_requiresVolumeFrameworkUpdate() ;

/// @brief Method get_resetHistory, addr 0x6711310, size 0x10, virtual false, abstract: false, final false
inline bool get_resetHistory() ;

/// @brief Method get_screenCoordScaleBias, addr 0x67113dc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_screenCoordScaleBias() ;

/// @brief Method get_screenSizeOverride, addr 0x67113c4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_screenSizeOverride() ;

/// @brief Method get_scriptableRenderer, addr 0x6710bdc, size 0x294, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::ScriptableRenderer* get_scriptableRenderer() ;

/// @brief Method get_stopNaN, addr 0x6711384, size 0x8, virtual false, abstract: false, final false
inline bool get_stopNaN() ;

/// @brief Method get_taaSettings, addr 0x67112f0, size 0x8, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::Rendering::Universal::TemporalAA_Settings> get_taaSettings() ;

/// @brief Method get_useScreenCoordOverride, addr 0x67113b4, size 0x8, virtual false, abstract: false, final false
inline bool get_useScreenCoordOverride() ;

/// @brief Method get_version, addr 0x67108d8, size 0x8, virtual false, abstract: false, final false
inline float_t get_version() ;

/// @brief Method get_volumeFrameworkUpdateMode, addr 0x67112a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::VolumeFrameworkUpdateMode get_volumeFrameworkUpdateMode() ;

/// @brief Method get_volumeLayerMask, addr 0x6711288, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_volumeLayerMask() ;

/// @brief Method get_volumeStack, addr 0x67112b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VolumeStack* get_volumeStack() ;

/// @brief Method get_volumeTrigger, addr 0x6711298, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_allowHDROutput, addr 0x67113fc, size 0x8, virtual false, abstract: false, final false
inline void set_allowHDROutput(bool  value) ;

/// @brief Method set_allowXRRendering, addr 0x67113ac, size 0x8, virtual false, abstract: false, final false
inline void set_allowXRRendering(bool  value) ;

/// @brief Method set_antialiasing, addr 0x67112d8, size 0x8, virtual false, abstract: false, final false
inline void set_antialiasing(::UnityEngine::Rendering::Universal::AntialiasingMode  value) ;

/// @brief Method set_antialiasingQuality, addr 0x67112e8, size 0x8, virtual false, abstract: false, final false
inline void set_antialiasingQuality(::UnityEngine::Rendering::Universal::AntialiasingQuality  value) ;

/// @brief Method set_dithering, addr 0x671139c, size 0x8, virtual false, abstract: false, final false
inline void set_dithering(bool  value) ;

/// @brief Method set_renderPostProcessing, addr 0x67112c8, size 0x8, virtual false, abstract: false, final false
inline void set_renderPostProcessing(bool  value) ;

/// @brief Method set_renderShadows, addr 0x6710ba4, size 0x8, virtual false, abstract: false, final false
inline void set_renderShadows(bool  value) ;

/// @brief Method set_renderType, addr 0x6710bd4, size 0x8, virtual false, abstract: false, final false
inline void set_renderType(::UnityEngine::Rendering::Universal::CameraRenderType  value) ;

/// @brief Method set_requiresColorOption, addr 0x6710bc4, size 0x8, virtual false, abstract: false, final false
inline void set_requiresColorOption(::UnityEngine::Rendering::Universal::CameraOverrideOption  value) ;

/// @brief Method set_requiresColorTexture, addr 0x6711268, size 0x18, virtual false, abstract: false, final false
inline void set_requiresColorTexture(bool  value) ;

/// @brief Method set_requiresDepthOption, addr 0x6710bb4, size 0x8, virtual false, abstract: false, final false
inline void set_requiresDepthOption(::UnityEngine::Rendering::Universal::CameraOverrideOption  value) ;

/// @brief Method set_requiresDepthTexture, addr 0x67111c8, size 0x18, virtual false, abstract: false, final false
inline void set_requiresDepthTexture(bool  value) ;

/// @brief Method set_resetHistory, addr 0x6711320, size 0x64, virtual false, abstract: false, final false
inline void set_resetHistory(bool  value) ;

/// @brief Method set_screenCoordScaleBias, addr 0x67113e8, size 0xc, virtual false, abstract: false, final false
inline void set_screenCoordScaleBias(::UnityEngine::Vector4  value) ;

/// @brief Method set_screenSizeOverride, addr 0x67113d0, size 0xc, virtual false, abstract: false, final false
inline void set_screenSizeOverride(::UnityEngine::Vector4  value) ;

/// @brief Method set_stopNaN, addr 0x671138c, size 0x8, virtual false, abstract: false, final false
inline void set_stopNaN(bool  value) ;

/// @brief Method set_useScreenCoordOverride, addr 0x67113bc, size 0x8, virtual false, abstract: false, final false
inline void set_useScreenCoordOverride(bool  value) ;

/// @brief Method set_volumeFrameworkUpdateMode, addr 0x67112b0, size 0x8, virtual false, abstract: false, final false
inline void set_volumeFrameworkUpdateMode(::UnityEngine::Rendering::Universal::VolumeFrameworkUpdateMode  value) ;

/// @brief Method set_volumeLayerMask, addr 0x6711290, size 0x8, virtual false, abstract: false, final false
inline void set_volumeLayerMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_volumeStack, addr 0x6710610, size 0x144, virtual false, abstract: false, final false
inline void set_volumeStack(::UnityEngine::Rendering::VolumeStack*  value) ;

/// @brief Method set_volumeTrigger, addr 0x67112a0, size 0x8, virtual false, abstract: false, final false
