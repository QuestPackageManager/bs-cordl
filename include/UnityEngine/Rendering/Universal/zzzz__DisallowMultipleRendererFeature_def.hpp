...
/// @brief Method .ctor, addr 0x66f78c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  customTitle) ;

/// @brief Method get_customTitle, addr 0x66f78b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_customTitle() ;

/// @brief Method set_customTitle, addr 0x66f78b0, size 0x8, virtual false, abstract: false, final false
