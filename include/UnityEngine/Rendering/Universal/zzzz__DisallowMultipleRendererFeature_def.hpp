...
public:
  ...
  /// @brief Method .ctor, addr 0x67698cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW customTitle);

  /// @brief Method get_customTitle, addr 0x67698c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_customTitle();

  /// @brief Method set_customTitle, addr 0x67698bc, size 0x8, virtual false, abstract: false, final false
