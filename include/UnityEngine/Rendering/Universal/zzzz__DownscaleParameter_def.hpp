...
public:
  ...
  /// @brief Method .ctor, addr 0x68741c0, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DownscaleParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DownscaleParameter(DownscaleParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DownscaleParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DownscaleParameter(DownscaleParameterconst&) = delete;
