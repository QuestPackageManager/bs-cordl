...
public:
  ...
  /// @brief Method Alloc, addr 0x6872d0c, size 0x15c, virtual false, abstract: false, final false
  inline void Alloc(::by_ref<::UnityEngine::RenderTextureDescriptor> desc, bool xrMultipassEnabled);

  /// @brief Method GetCurrentTexture, addr 0x6872bec, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetCurrentTexture(int32_t eyeIndex);

  /// @brief Method GetHistoryDescriptor, addr 0x6872ecc, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureDescriptor GetHistoryDescriptor(::by_ref<::UnityEngine::RenderTextureDescriptor> cameraDesc);

  /// @brief Method GetPreviousTexture, addr 0x6872c38, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetPreviousTexture(int32_t eyeIndex);

  /// @brief Method IsAllocated, addr 0x6872c84, size 0x1c, virtual false, abstract: false, final false
  inline bool IsAllocated();

  /// @brief Method IsDirty, addr 0x6872ca0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreate, addr 0x6872ba0, size 0x4c, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method Reset, addr 0x6872e68, size 0x64, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x6872ef8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6872fc8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
