...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RawDepthHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RawDepthHistory(RawDepthHistory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RawDepthHistory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RawDepthHistory(RawDepthHistoryconst&) = delete;
