...
public:
  ...
  __declspec(property(get = __cordl_internal_get_previousViewProjectionStereo, put = __cordl_internal_set_previousViewProjectionStereo)) ::ArrayW<::UnityEngine::Matrix4x4>
