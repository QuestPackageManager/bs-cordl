...
/// @brief Field previousViewProjectionStereo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_previousViewProjectionStereo, put=__cordl_internal_set_previousViewProjectionStereo)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  previousViewProjectionStereo;

/// @brief Field viewProjectionStereo, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_viewProjectionStereo, put=__cordl_internal_set_viewProjectionStereo)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  viewProjectionStereo;
...
/// @brief Method .ctor, addr 0x66f1620, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <Render>b__0, addr 0x66f2938, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66f24c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dispose, addr 0x66f2848, size 0x80, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetObjectMotionDrawingSettings, addr 0x66f1778, size 0x178, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::DrawingSettings GetObjectMotionDrawingSettings(::UnityEngine::Camera*  camera) ;

/// @brief Method ImportXRMotionColorAndDepth, addr 0x66f1b24, size 0x2a4, virtual false, abstract: false, final false
...
/// @brief Method InitObjectMotionRendererLists, addr 0x66f18f0, size 0x1f4, virtual false, abstract: false, final false
inline void InitObjectMotionRendererLists(::ByRef<::UnityEngine::Rendering::Universal::XRDepthMotionPass_PassData*>  passData, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Camera*  camera) ;

/// @brief Method InitPassData, addr 0x66f1ae4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Render, addr 0x66f1dc8, size 0x6f8, virtual false, abstract: false, final false
...
/// @brief Method ResetMotionData, addr 0x66f1688, size 0xf0, virtual false, abstract: false, final false
inline void ResetMotionData() ;

/// @brief Method Update, addr 0x66f24c4, size 0x384, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66f13d0, size 0x250, virtual false, abstract: false, final false
