...
public:
  ...
  /// @brief Method .ctor, addr 0x676362c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__0, addr 0x6764944, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67644cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x6764854, size 0x80, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetObjectMotionDrawingSettings, addr 0x6763784, size 0x178, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DrawingSettings GetObjectMotionDrawingSettings(::UnityEngine::Camera* camera);

  /// @brief Method ImportXRMotionColorAndDepth, addr 0x6763b30, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitObjectMotionRendererLists, addr 0x67638fc, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitPassData, addr 0x6763af0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6763dd4, size 0x6f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetMotionData, addr 0x6763694, size 0xf0, virtual false, abstract: false, final false
  inline void ResetMotionData();

  /// @brief Method Update, addr 0x67644d0, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67633dc, size 0x250, virtual false, abstract: false, final false
