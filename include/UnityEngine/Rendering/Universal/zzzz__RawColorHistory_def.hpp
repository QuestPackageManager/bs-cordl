...
public:
  ...
  /// @brief Method Alloc, addr 0x6877fd0, size 0x15c, virtual false, abstract: false, final false
  inline void Alloc(::by_ref<::UnityEngine::RenderTextureDescriptor> desc, bool xrMultipassEnabled);

  /// @brief Method GetCurrentTexture, addr 0x6877eb0, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetCurrentTexture(int32_t eyeIndex);

  /// @brief Method GetHistoryDescriptor, addr 0x6878190, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureDescriptor GetHistoryDescriptor(::by_ref<::UnityEngine::RenderTextureDescriptor> cameraDesc);

  /// @brief Method GetPreviousTexture, addr 0x6877efc, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetPreviousTexture(int32_t eyeIndex);

  /// @brief Method IsAllocated, addr 0x6877f48, size 0x1c, virtual false, abstract: false, final false
  inline bool IsAllocated();

  /// @brief Method IsDirty, addr 0x6877f64, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreate, addr 0x6877e64, size 0x4c, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method Reset, addr 0x687812c, size 0x64, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x68781c8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6878290, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RawColorHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RawColorHistory(RawColorHistory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RawColorHistory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RawColorHistory(RawColorHistoryconst&) = delete;
