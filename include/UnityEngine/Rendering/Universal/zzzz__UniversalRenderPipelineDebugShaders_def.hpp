...
/// @brief Field m_ProbeVolumeSamplingDebugComputeShader, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ProbeVolumeSamplingDebugComputeShader, put=__cordl_internal_set_m_ProbeVolumeSamplingDebugComputeShader)) ::UnityW<::UnityEngine::ComputeShader>  m_ProbeVolumeSamplingDebugComputeShader;
...
/// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x6772eac, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x677301c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_debugReplacementPS, addr 0x6772eb4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_debugReplacementPS() ;

/// @brief Method get_hdrDebugViewPS, addr 0x6772f2c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_hdrDebugViewPS() ;

/// @brief Method get_probeVolumeSamplingDebugComputeShader, addr 0x6772fa4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ComputeShader> get_probeVolumeSamplingDebugComputeShader() ;

/// @brief Method get_version, addr 0x6772ea4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_debugReplacementPS, addr 0x6772ebc, size 0x70, virtual false, abstract: false, final false
inline void set_debugReplacementPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_hdrDebugViewPS, addr 0x6772f34, size 0x70, virtual false, abstract: false, final false
inline void set_hdrDebugViewPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_probeVolumeSamplingDebugComputeShader, addr 0x6772fac, size 0x70, virtual false, abstract: false, final false
