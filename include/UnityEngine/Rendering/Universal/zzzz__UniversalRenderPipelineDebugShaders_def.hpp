...
/// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x66ff328, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x66ff498, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_debugReplacementPS, addr 0x66ff330, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_debugReplacementPS() ;

/// @brief Method get_hdrDebugViewPS, addr 0x66ff3a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_hdrDebugViewPS() ;

/// @brief Method get_probeVolumeSamplingDebugComputeShader, addr 0x66ff420, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ComputeShader> get_probeVolumeSamplingDebugComputeShader() ;

/// @brief Method get_version, addr 0x66ff320, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_debugReplacementPS, addr 0x66ff338, size 0x70, virtual false, abstract: false, final false
inline void set_debugReplacementPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_hdrDebugViewPS, addr 0x66ff3b0, size 0x70, virtual false, abstract: false, final false
inline void set_hdrDebugViewPS(::UnityEngine::Shader*  value) ;

/// @brief Method set_probeVolumeSamplingDebugComputeShader, addr 0x66ff428, size 0x70, virtual false, abstract: false, final false
