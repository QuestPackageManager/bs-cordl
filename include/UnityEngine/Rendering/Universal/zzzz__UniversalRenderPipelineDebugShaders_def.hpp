...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x6771334, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67714a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_debugReplacementPS, addr 0x677133c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_debugReplacementPS();

  /// @brief Method get_hdrDebugViewPS, addr 0x67713b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_hdrDebugViewPS();

  /// @brief Method get_probeVolumeSamplingDebugComputeShader, addr 0x677142c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_probeVolumeSamplingDebugComputeShader();

  /// @brief Method get_version, addr 0x677132c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_debugReplacementPS, addr 0x6771344, size 0x70, virtual false, abstract: false, final false
  inline void set_debugReplacementPS(::UnityEngine::Shader* value);

  /// @brief Method set_hdrDebugViewPS, addr 0x67713bc, size 0x70, virtual false, abstract: false, final false
  inline void set_hdrDebugViewPS(::UnityEngine::Shader* value);

  /// @brief Method set_probeVolumeSamplingDebugComputeShader, addr 0x6771434, size 0x70, virtual false, abstract: false, final false
