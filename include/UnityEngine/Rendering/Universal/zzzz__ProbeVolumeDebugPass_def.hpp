...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass*);
MARK_REF_T(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass_WriteApvData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass*, "UnityEngine.Rendering.Universal", "ProbeVolumeDebugPass");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass_WriteApvData*, "UnityEngine.Rendering.Universal", "ProbeVolumeDebugPass/WriteApvData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass___c*, "UnityEngine.Rendering.Universal", "ProbeVolumeDebugPass/<>c");
...
public:
  ...
  /// @brief Method .ctor, addr 0x689c978, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__7_0, addr 0x689c9d4, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x689c9d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::ProbeVolumeDebugPass___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Execute, addr 0x689c02c, size 0x348, virtual true, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x689c374, size 0x604, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x689c024, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x689bf54, size 0xd0, virtual false, abstract: false, final false
