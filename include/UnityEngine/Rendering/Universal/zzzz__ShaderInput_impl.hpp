...
#include "UnityEngine/Rendering/Universal/zzzz__ShaderInput_def.hpp"
// Ctor Parameters [CppParam { name: "worldToShadowMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "shadowParams", ty:
...
// Ctor Parameters [CppParam { name: "position", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "color", ty: "::UnityEngine::Vector4", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "attenuation", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "spotDirection",
// ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "occlusionProbeChannels", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "layerMask", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }]
