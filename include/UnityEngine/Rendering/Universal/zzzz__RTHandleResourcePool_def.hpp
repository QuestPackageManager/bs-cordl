...
/// @brief Method AddResourceToPool, addr 0x6700bb8, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x67006fc, size 0x4bc, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateTextureDesc, addr 0x6701f28, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method GetHashCodeWithNameHash, addr 0x6700dcc, size 0x58, virtual false, abstract: false, final false
inline int32_t GetHashCodeWithNameHash(::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureDesc>  texDesc) ;

/// @brief Method LogDebugInfo, addr 0x670168c, size 0x89c, virtual false, abstract: false, final false
inline void LogDebugInfo() ;

static inline ::UnityEngine::Rendering::Universal::RTHandleResourcePool* New_ctor() ;

/// @brief Method PurgeUnusedResources, addr 0x6701084, size 0x608, virtual false, abstract: false, final false
inline void PurgeUnusedResources(int32_t  currentFrameIndex) ;

/// @brief Method ShouldReleaseResource, addr 0x670100c, size 0x78, virtual false, abstract: false, final false
static inline bool ShouldReleaseResource(int32_t  lastUsedFrameIndex, int32_t  currentFrameIndex) ;

/// @brief Method TryGetResource, addr 0x6700e24, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6702068, size 0xe4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_staleResourceCapacity, addr 0x6700600, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method set_staleResourceCapacity, addr 0x670065c, size 0xa0, virtual false, abstract: false, final false
