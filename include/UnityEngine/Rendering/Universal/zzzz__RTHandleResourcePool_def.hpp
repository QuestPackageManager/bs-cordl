...
public:
  ...
  /// @brief Method AddResourceToPool, addr 0x6772bc4, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x6772708, size 0x4bc, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateTextureDesc, addr 0x6773f34, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCodeWithNameHash, addr 0x6772dd8, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetHashCodeWithNameHash(::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureDesc> texDesc);

  /// @brief Method LogDebugInfo, addr 0x6773698, size 0x89c, virtual false, abstract: false, final false
  inline void LogDebugInfo();

  static inline ::UnityEngine::Rendering::Universal::RTHandleResourcePool* New_ctor();

  /// @brief Method PurgeUnusedResources, addr 0x6773090, size 0x608, virtual false, abstract: false, final false
  inline void PurgeUnusedResources(int32_t currentFrameIndex);

  /// @brief Method ShouldReleaseResource, addr 0x6773018, size 0x78, virtual false, abstract: false, final false
  static inline bool ShouldReleaseResource(int32_t lastUsedFrameIndex, int32_t currentFrameIndex);

  /// @brief Method TryGetResource, addr 0x6772e30, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6774074, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_staleResourceCapacity, addr 0x677260c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_staleResourceCapacity, addr 0x6772668, size 0xa0, virtual false, abstract: false, final false
