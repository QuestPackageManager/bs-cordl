...
public:
  ...
  /// @brief Method .ctor, addr 0x687f18c, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MotionBlurModeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MotionBlurModeParameter(MotionBlurModeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MotionBlurModeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MotionBlurModeParameter(MotionBlurModeParameterconst&) = delete;
