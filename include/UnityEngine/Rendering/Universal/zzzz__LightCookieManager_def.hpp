...
/// @brief Method get_isPow2, addr 0x66c3964, size 0x2c, virtual false, abstract: false, final false
inline bool get_isPow2() ;

/// @brief Method get_isSquare, addr 0x66c41f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x66c414c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method <.cctor>b__6_0, addr 0x66c4378, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method <.cctor>b__6_1, addr 0x66c4444, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c4374, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "m_Data", ty: "::ArrayW<T,::Array<T>*>", modifiers: "", def_value: None }, CppParam { name: "m_Start", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field lightMappings, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightMappings, put=__cordl_internal_set_lightMappings)) ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::Array<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>*>  lightMappings;
...
/// @brief Method Resize, addr 0x66c22c8, size 0x120, virtual false, abstract: false, final false
inline void Resize(int32_t  size) ;

constexpr ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::Array<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>*> const& __cordl_internal_get_lightMappings() const;

constexpr ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::Array<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>*>& __cordl_internal_get_lightMappings() ;
...
constexpr void __cordl_internal_set_lightMappings(::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::Array<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>*>  value) ;

constexpr void __cordl_internal_set_uvRects(::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  value) ;

/// @brief Method .ctor, addr 0x66c1760, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_AtlasUVRectCpuData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AtlasUVRectCpuData, put=__cordl_internal_set_m_AtlasUVRectCpuData)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AtlasUVRectCpuData;
...
/// @brief Field m_WorldToLightCpuData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_WorldToLightCpuData, put=__cordl_internal_set_m_WorldToLightCpuData)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  m_WorldToLightCpuData;
...
/// @brief Method Clear, addr 0x66c2090, size 0x9c, virtual false, abstract: false, final false
inline void Clear(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method Dispose, addr 0x66c18e0, size 0x48, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method Resize, addr 0x66c3a40, size 0x218, virtual false, abstract: false, final false
inline void Resize(int32_t  size) ;

/// @brief Method Upload, addr 0x66c3c58, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c1888, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  size, bool  useStructuredBuffer) ;

/// @brief Method get_atlasUVRects, addr 0x66c4460, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*> get_atlasUVRects() ;

/// @brief Method get_cookieEnableBits, addr 0x66c4458, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::ShaderBitArray get_cookieEnableBits() ;

/// @brief Method get_isUploaded, addr 0x66c4470, size 0x8, virtual false, abstract: false, final false
inline bool get_isUploaded() ;

/// @brief Method get_lightTypes, addr 0x66c4468, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_lightTypes() ;

/// @brief Method get_worldToLights, addr 0x66c4450, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*> get_worldToLights() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_isUploaded, addr 0x66c4478, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_VisibleLightIndexToShaderDataIndex, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_VisibleLightIndexToShaderDataIndex, put=__cordl_internal_set_m_VisibleLightIndexToShaderDataIndex)) ::ArrayW<int32_t,::Array<int32_t>*>  m_VisibleLightIndexToShaderDataIndex;
...
/// @brief Method AdjustUVRect, addr 0x66c3784, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method ApproximateCookieSizeDivisor, addr 0x66c31e8, size 0x2c, virtual false, abstract: false, final false
inline int32_t ApproximateCookieSizeDivisor(float_t  requestAtlasRatio) ;

/// @brief Method ComputeCookieRequestPixelCount, addr 0x66c30e0, size 0x108, virtual false, abstract: false, final false
inline uint32_t ComputeCookieRequestPixelCount(::ByRef<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings) ;

/// @brief Method ComputeOctahedralCookieSize, addr 0x66c3840, size 0x124, virtual false, abstract: false, final false
inline int32_t ComputeOctahedralCookieSize(::UnityEngine::Texture*  cookie) ;

/// @brief Method Dispose, addr 0x66c18b0, size 0x30, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Fetch2D, addr 0x66c361c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method FetchCube, addr 0x66c34ac, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method FetchUVRects, addr 0x66c3214, size 0x298, virtual false, abstract: false, final false
inline int32_t FetchUVRects(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  textureAtlasUVRects, int32_t  cookieSizeDivisor) ;

/// @brief Method FilterAndValidateAdditionalLights, addr 0x66c23e8, size 0x468, virtual false, abstract: false, final false
inline int32_t FilterAndValidateAdditionalLights(::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::ArrayW<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping,::Array<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>*>  validLightMappings) ;

/// @brief Method GetLightCookieShaderDataIndex, addr 0x66c1928, size 0x48, virtual false, abstract: false, final false
inline int32_t GetLightCookieShaderDataIndex(int32_t  visibleLightIndex) ;

/// @brief Method GetLightCookieShaderFormat, addr 0x66c212c, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetLightUVScaleOffset, addr 0x66c220c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method InitAdditionalLights, addr 0x66c1764, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x66c1970, size 0x198, virtual false, abstract: false, final false
inline void Setup(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method SetupAdditionalLights, addr 0x66c1ef4, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method SetupMainLight, addr 0x66c1b08, size 0x3ec, virtual false, abstract: false, final false
...
/// @brief Method ShrinkUVRect, addr 0x66c3990, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method UpdateAdditionalLightsAtlas, addr 0x66c2850, size 0x184, virtual false, abstract: false, final false
inline int32_t UpdateAdditionalLightsAtlas(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  textureAtlasUVRects) ;

/// @brief Method UploadAdditionalLights, addr 0x66c29d4, size 0x70c, virtual false, abstract: false, final false
inline void UploadAdditionalLights(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::ByRef<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Rendering::Universal::LightCookieManager_LightCookieMapping>>  validLightMappings, ::ByRef<::UnityEngine::Rendering::Universal::LightCookieManager_WorkSlice_1<::UnityEngine::Vector4>>  validUvRects) ;
...
/// @brief Method .ctor, addr 0x66c16e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_AdditionalLightsCookieAtlasTexture, addr 0x66c16c8, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_AdditionalLightsCookieAtlasTexture() ;

/// @brief Method get_IsKeywordLightCookieEnabled, addr 0x66c16b8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsKeywordLightCookieEnabled() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method isInitialized, addr 0x66c1890, size 0x20, virtual false, abstract: false, final false
inline bool isInitialized() ;

static inline void setStaticF_s_DirLightProj(::UnityEngine::Matrix4x4  value) ;

/// @brief Method set_IsKeywordLightCookieEnabled, addr 0x66c16c0, size 0x8, virtual false, abstract: false, final false
