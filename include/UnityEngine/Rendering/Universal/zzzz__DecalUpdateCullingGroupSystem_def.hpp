...
/// @brief Method Execute, addr 0x66a8d58, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x66a8bdc, size 0x17c, virtual false, abstract: false, final false
inline void Execute(::UnityEngine::Camera*  camera) ;

/// @brief Method GetSceneCullingMaskFromCamera, addr 0x66a8eb8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a8b04, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::Universal::DecalEntityManager*  entityManager, float_t  drawDistance) ;

/// @brief Method get_boundingDistance, addr 0x66a8ab4, size 0x28, virtual false, abstract: false, final false
inline float_t get_boundingDistance() ;

/// @brief Method set_boundingDistance, addr 0x66a8adc, size 0x28, virtual false, abstract: false, final false
