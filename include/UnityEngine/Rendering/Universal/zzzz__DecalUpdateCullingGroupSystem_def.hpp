...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalUpdateCullingGroupSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalUpdateCullingGroupSystem(DecalUpdateCullingGroupSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalUpdateCullingGroupSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalUpdateCullingGroupSystem(DecalUpdateCullingGroupSystemconst&) = delete;
