...
/// @brief Field autodeskInteractiveTransparentPS, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_autodeskInteractiveTransparentPS, put=__cordl_internal_set_autodeskInteractiveTransparentPS)) ::UnityW<::UnityEngine::Shader>  autodeskInteractiveTransparentPS;
...
/// @brief Method .ctor, addr 0x67305c4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x67305c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field materials, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_materials, put=__cordl_internal_set_materials)) ::UnityEngine::Rendering::Universal::UniversalRenderPipelineEditorResources_MaterialResources*  materials;
...
/// @brief Method .ctor, addr 0x67305bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::UniversalRenderPipelineEditorResources_MaterialResources*, "UnityEngine.Rendering.Universal", "UniversalRenderPipelineEditorResources/MaterialResources");
NEED_NO_BOX(::UnityEngine::Rendering::Universal::UniversalRenderPipelineEditorResources_ShaderResources);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::UniversalRenderPipelineEditorResources_ShaderResources*, "UnityEngine.Rendering.Universal", "UniversalRenderPipelineEditorResources/ShaderResources");
