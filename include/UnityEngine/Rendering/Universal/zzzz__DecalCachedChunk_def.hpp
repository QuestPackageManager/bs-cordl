...
/// @brief Field boundingSphereArray, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get_boundingSphereArray, put=__cordl_internal_set_boundingSphereArray)) ::ArrayW<::UnityEngine::BoundingSphere,::Array<::UnityEngine::BoundingSphere>*>  boundingSphereArray;
...
/// @brief Method Dispose, addr 0x66a73b0, size 0x218, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalCachedChunk* New_ctor() ;

/// @brief Method RemoveAtSwapBack, addr 0x66a6e30, size 0x2fc, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x66a712c, size 0x284, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a5540, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
