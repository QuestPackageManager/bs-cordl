...
public:
  ...
  /// @brief Method Dispose, addr 0x67193bc, size 0x218, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalCachedChunk* New_ctor();

  /// @brief Method RemoveAtSwapBack, addr 0x6718e3c, size 0x2fc, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x6719138, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x671754c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
