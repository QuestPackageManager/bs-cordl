...
public:
  ...
  /// @brief Method IsActive, addr 0x66600c4, size 0x5c, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6660120, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6660128, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
