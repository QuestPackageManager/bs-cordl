...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalSubDrawCall, "UnityEngine.Rendering.Universal", "DecalSubDrawCall");
// Dependencies
namespace UnityEngine::Rendering::Universal {
// Is value type: true
...
public:
  ...
  /// @brief Method get_count, addr 0x6854864, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalSubDrawCall) == 0x8, "Size mismatch!");
