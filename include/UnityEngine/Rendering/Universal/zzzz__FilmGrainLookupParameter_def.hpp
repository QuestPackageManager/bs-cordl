...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::FilmGrainLookupParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::FilmGrainLookupParameter*, "UnityEngine.Rendering.Universal", "FilmGrainLookupParameter");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FilmGrainLookupParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FilmGrainLookupParameter(FilmGrainLookupParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FilmGrainLookupParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FilmGrainLookupParameter(FilmGrainLookupParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::FilmGrainLookupParameter) == 0x18, "Size mismatch!");
