...
/// @brief Method DistanceBetweenQuaternions, addr 0x66a7a8c, size 0x30, virtual false, abstract: false, final false
inline float_t DistanceBetweenQuaternions(::Unity::Mathematics::quaternion  a, ::Unity::Mathematics::quaternion  b) ;

/// @brief Method Execute, addr 0x66a7abc, size 0x664, virtual true, abstract: false, final true
inline void Execute(int32_t  index, ::UnityEngine::Jobs::TransformAccess  transform) ;

/// @brief Method GetDecalProjectBoundingSphere, addr 0x66a8120, size 0x388, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x66a7684, size 0x170, virtual false, abstract: false, final false
inline void Execute() ;

/// @brief Method Execute, addr 0x66a77f4, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a75c8, size 0xbc, virtual false, abstract: false, final false
