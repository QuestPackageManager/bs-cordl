...
public:
  ...
  /// @brief Method DistanceBetweenQuaternions, addr 0x685a118, size 0x30, virtual false, abstract: false, final false
  inline float_t DistanceBetweenQuaternions(::Unity::Mathematics::quaternion a, ::Unity::Mathematics::quaternion b);

  /// @brief Method Execute, addr 0x685a148, size 0x590, virtual true, abstract: false, final true
  inline void Execute(int32_t index, ::UnityEngine::Jobs::TransformAccess transform);

  /// @brief Method GetDecalProjectBoundingSphere, addr 0x685a6d8, size 0x11c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x6859d10, size 0x170, virtual false, abstract: false, final false
  inline void Execute();

  /// @brief Method Execute, addr 0x6859e80, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6859c54, size 0xbc, virtual false, abstract: false, final false
