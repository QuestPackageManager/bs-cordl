...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::UniversalPostProcessingData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalPostProcessingData*, "UnityEngine.Rendering.Universal", "UniversalPostProcessingData");
...
public:
  ...
  /// @brief Method Reset, addr 0x6876c8c, size 0x10, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6876c9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UniversalPostProcessingData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UniversalPostProcessingData(UniversalPostProcessingData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UniversalPostProcessingData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UniversalPostProcessingData(UniversalPostProcessingDataconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalPostProcessingData) == 0x20, "Size mismatch!");
