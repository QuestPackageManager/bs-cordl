...
/// @brief Method Reset, addr 0x66bef74, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x66bef84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
