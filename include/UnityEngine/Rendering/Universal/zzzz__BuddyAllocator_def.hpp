...
public:
  ...
  /// @brief Method AlignForward, addr 0x6736e78, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6736ddc, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Free, addr 0x6736c70, size 0x16c, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::Rendering::Universal::BuddyAllocation allocation);

  /// @brief Method FreeMaskIndices, addr 0x6736768, size 0xe4, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<int32_t> FreeMaskIndices(int32_t level);

  /// @brief Method FreeMasks, addr 0x67365bc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method LevelLength, addr 0x6736e58, size 0x10, virtual false, abstract: false, final false
  static inline int32_t LevelLength(int32_t level, int32_t branchingOrder);

  /// @brief Method LevelLength64, addr 0x67366d8, size 0x24, virtual false, abstract: false, final false
  static inline int32_t LevelLength64(int32_t level, int32_t branchingOrder);

  /// @brief Method LevelOffset, addr 0x6736e38, size 0x20, virtual false, abstract: false, final false
  static inline int32_t LevelOffset(int32_t level, int32_t branchingOrder);

  /// @brief Method LevelOffset64, addr 0x67366a0, size 0x38, virtual false, abstract: false, final false
  static inline int32_t LevelOffset64(int32_t level, int32_t branchingOrder);

  /// @brief Method Pow2, addr 0x6736c64, size 0xc, virtual false, abstract: false, final false
  static inline int32_t Pow2(int32_t n);

  /// @brief Method Pow2N, addr 0x6736e68, size 0x10, virtual false, abstract: false, final false
  static inline int32_t Pow2N(int32_t x, int32_t n);

  /// @brief Method PtrAdd, addr 0x6736e94, size 0x8, virtual false, abstract: false, final false
  static inline void* PtrAdd(void* ptr, int32_t bytes);

  /// @brief Method TryAllocate, addr 0x6736a50, size 0x214, virtual false, abstract: false, final false
  inline bool TryAllocate(int32_t requestedLevel, ::ByRef<::UnityEngine::Rendering::Universal::BuddyAllocation> allocation);

  /// @brief Method .ctor, addr 0x6736894, size 0x1bc, virtual false, abstract: false, final false
  inline void _ctor(int32_t levelCount, int32_t branchingOrder, ::Unity::Collections::Allocator allocator);

  /// @brief Method get_freeMaskCounts, addr 0x67364e4, size 0x6c, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<int32_t> get_freeMaskCounts();

  /// @brief Method get_freeMaskIndicesStorage, addr 0x67366fc, size 0x6c, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<int32_t> get_freeMaskIndicesStorage();

  /// @brief Method get_freeMasksStorage, addr 0x6736550, size 0x6c, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint64_t> get_freeMasksStorage();

  /// @brief Method get_header, addr 0x67364a0, size 0x44, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::Universal::BuddyAllocator_Header> get_header();

  /// @brief Method get_levelCount, addr 0x673684c, size 0x48, virtual false, abstract: false, final false
