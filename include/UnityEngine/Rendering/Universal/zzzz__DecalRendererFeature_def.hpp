...
public:
  ...
  /// @brief Method AddRenderPasses, addr 0x6769344, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method ChangeAdaptivePerformanceDrawDistances, addr 0x67697e4, size 0x4, virtual false, abstract: false, final false
  inline void ChangeAdaptivePerformanceDrawDistances();

  /// @brief Method Create, addr 0x67684d8, size 0x64, virtual true, abstract: false, final false
  inline void Create();

  /// @brief Method Dispose, addr 0x67696c0, size 0x124, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetDBufferSettings, addr 0x67687ec, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DBufferSettings* GetDBufferSettings();

  /// @brief Method GetScreenSpaceSettings, addr 0x676885c, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalScreenSpaceSettings* GetScreenSpaceSettings();

  /// @brief Method GetTechnique, addr 0x6768604, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTechnique, addr 0x6768a10, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTechnique, addr 0x67688cc, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAutomaticDBuffer, addr 0x6768b0c, size 0xf4, virtual false, abstract: false, final false
  inline bool IsAutomaticDBuffer();

  static inline ::UnityEngine::Rendering::Universal::DecalRendererFeature* New_ctor();

  /// @brief Method OnCameraPreCull, addr 0x6769200, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method RecreateSystemsIfNeeded, addr 0x6768c00, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method RequireRenderingLayers, addr 0x676853c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetupRenderPasses, addr 0x6769504, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsNativeRenderPass, addr 0x67694f0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67697e8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_intermediateRendering, addr 0x6768450, size 0x10, virtual false, abstract: false, final false
  inline bool get_intermediateRendering();

  /// @brief Method get_isGLDevice, addr 0x6768478, size 0x60, virtual false, abstract: false, final false
  static inline bool get_isGLDevice();

  /// @brief Method get_requiresDecalLayers, addr 0x6768460, size 0x18, virtual false, abstract: false, final false
  inline bool get_requiresDecalLayers();

  /// @brief Method get_settings, addr 0x6768448, size 0x8, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::Universal::DecalSettings*> get_settings();

  /// @brief Method get_sharedDecalEntityManager, addr 0x67683ec, size 0x5c, virtual false, abstract: false, final false
