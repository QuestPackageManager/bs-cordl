...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::PinnedArray_1<T>>::get(),
                        "get_length",
...
// Ctor Parameters [CppParam { name: "managedArray", ty: "::ArrayW<T,::Array<T>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "handle", ty: "::System::Runtime::InteropServices::GCHandle", modifiers: "", def_value: Some("{}") }, CppParam { name: "nativeArray", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: Some("{}") }]
template<typename T>
constexpr ::UnityEngine::Rendering::Universal::PinnedArray_1<T>::PinnedArray_1(::ArrayW<T,::Array<T>*>  managedArray, ::System::Runtime::InteropServices::GCHandle  handle, ::Unity::Collections::NativeArray_1<T>  nativeArray) noexcept  {
