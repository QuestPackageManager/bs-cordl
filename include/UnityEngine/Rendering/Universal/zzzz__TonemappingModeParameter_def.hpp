...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::TonemappingModeParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::TonemappingModeParameter*, "UnityEngine.Rendering.Universal", "TonemappingModeParameter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x687fd60, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TonemappingModeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TonemappingModeParameter(TonemappingModeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TonemappingModeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TonemappingModeParameter(TonemappingModeParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::TonemappingModeParameter) == 0x18, "Size mismatch!");
