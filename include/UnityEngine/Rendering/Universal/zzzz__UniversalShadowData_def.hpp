...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::UniversalShadowData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::UniversalShadowData*, "UnityEngine.Rendering.Universal", "UniversalShadowData");
...
public:
  ...
  /// @brief Method Reset, addr 0x6872548, size 0x100, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6872648, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::UniversalShadowData) == 0xb0, "Size mismatch!");
