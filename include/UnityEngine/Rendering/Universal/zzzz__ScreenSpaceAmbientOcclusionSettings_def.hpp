...
/// @brief Method .ctor, addr 0x66ed300, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOMethodOptions, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/AOMethodOptions");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_AOSampleOption, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/AOSampleOption");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::ScreenSpaceAmbientOcclusionSettings_BlurQualityOptions, "UnityEngine.Rendering.Universal", "ScreenSpaceAmbientOcclusionSettings/BlurQualityOptions");
