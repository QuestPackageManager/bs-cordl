...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawErrorSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawErrorSystem(DecalDrawErrorSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawErrorSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawErrorSystem(DecalDrawErrorSystemconst&) = delete;
