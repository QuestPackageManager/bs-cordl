...
public:
  ...
  /// @brief Method GetMaterial, addr 0x6711f94, size 0x14, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Rendering::Universal::DecalEntityChunk* decalEntityChunk);

  /// @brief Method GetPassIndex, addr 0x6711f24, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6711e94, size 0x90, virtual false, abstract: false, final false
