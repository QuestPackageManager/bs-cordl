...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x6770d6c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6771134, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_copyDepthPS, addr 0x67710bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_copyDepthPS();

  /// @brief Method get_fallOffLookup, addr 0x6771044, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_fallOffLookup();

  /// @brief Method get_geometryShadowShader, addr 0x6770f54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_geometryShadowShader();

  /// @brief Method get_geometryUnshadowShader, addr 0x6770fcc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_geometryUnshadowShader();

  /// @brief Method get_lightShader, addr 0x6770d74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_lightShader();

  /// @brief Method get_projectedShadowShader, addr 0x6770dec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_projectedShadowShader();

  /// @brief Method get_spriteShadowShader, addr 0x6770e64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_spriteShadowShader();

  /// @brief Method get_spriteUnshadowShader, addr 0x6770edc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_spriteUnshadowShader();

  /// @brief Method get_version, addr 0x6770d64, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_copyDepthPS, addr 0x67710c4, size 0x70, virtual false, abstract: false, final false
  inline void set_copyDepthPS(::UnityEngine::Shader* value);

  /// @brief Method set_fallOffLookup, addr 0x677104c, size 0x70, virtual false, abstract: false, final false
  inline void set_fallOffLookup(::UnityEngine::Texture2D* value);

  /// @brief Method set_geometryShadowShader, addr 0x6770f5c, size 0x70, virtual false, abstract: false, final false
  inline void set_geometryShadowShader(::UnityEngine::Shader* value);

  /// @brief Method set_geometryUnshadowShader, addr 0x6770fd4, size 0x70, virtual false, abstract: false, final false
  inline void set_geometryUnshadowShader(::UnityEngine::Shader* value);

  /// @brief Method set_lightShader, addr 0x6770d7c, size 0x70, virtual false, abstract: false, final false
  inline void set_lightShader(::UnityEngine::Shader* value);

  /// @brief Method set_projectedShadowShader, addr 0x6770df4, size 0x70, virtual false, abstract: false, final false
  inline void set_projectedShadowShader(::UnityEngine::Shader* value);

  /// @brief Method set_spriteShadowShader, addr 0x6770e6c, size 0x70, virtual false, abstract: false, final false
  inline void set_spriteShadowShader(::UnityEngine::Shader* value);

  /// @brief Method set_spriteUnshadowShader, addr 0x6770ee4, size 0x70, virtual false, abstract: false, final false
