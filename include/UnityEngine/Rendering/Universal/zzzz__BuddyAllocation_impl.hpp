...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::Universal::BuddyAllocation::*)(int32_t, int32_t)>(&::UnityEngine::Rendering::Universal::BuddyAllocation::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6738004;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::Universal::BuddyAllocation>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::Mathematics::uint2 (::UnityEngine::Rendering::Universal::BuddyAllocation::*)()>(&::UnityEngine::Rendering::Universal::BuddyAllocation::get_index2D)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x673800c;
