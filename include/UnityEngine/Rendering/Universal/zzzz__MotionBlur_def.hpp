...
public:
  ...
  /// @brief Method IsActive, addr 0x6879834, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6879864, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x687986c, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();
