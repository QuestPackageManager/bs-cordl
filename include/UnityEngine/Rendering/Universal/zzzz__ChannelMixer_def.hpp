...
public:
  ...
  /// @brief Method IsActive, addr 0x6737ca4, size 0x154, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6737df8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6737e00, size 0x184, virtual false, abstract: false, final false
  inline void _ctor();
