...
public:
  ...
  /// @brief Method .ctor, addr 0x6774760, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_stripScreenCoordOverrideVariants, addr 0x67746e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_stripScreenCoordOverrideVariants();

  /// @brief Method get_stripUnusedPostProcessingVariants, addr 0x67745f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_stripUnusedPostProcessingVariants();

  /// @brief Method get_stripUnusedVariants, addr 0x6774670, size 0x8, virtual false, abstract: false, final false
  inline bool get_stripUnusedVariants();

  /// @brief Method get_version, addr 0x67745f0, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_version();

  /// @brief Convert to "::UnityEngine::Rendering::IRenderPipelineGraphicsSettings"
  constexpr ::UnityEngine::Rendering::IRenderPipelineGraphicsSettings* i___UnityEngine__Rendering__IRenderPipelineGraphicsSettings() noexcept;

  /// @brief Method set_stripScreenCoordOverrideVariants, addr 0x67746f0, size 0x70, virtual false, abstract: false, final false
  inline void set_stripScreenCoordOverrideVariants(bool value);

  /// @brief Method set_stripUnusedPostProcessingVariants, addr 0x6774600, size 0x70, virtual false, abstract: false, final false
  inline void set_stripUnusedPostProcessingVariants(bool value);

  /// @brief Method set_stripUnusedVariants, addr 0x6774678, size 0x70, virtual false, abstract: false, final false
