...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TaaHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TaaHistory(TaaHistory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TaaHistory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TaaHistory(TaaHistoryconst&) = delete;
