...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_isAvailableInPlayerBuild, addr 0x67714b0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6771878, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_blitHDROverlay, addr 0x6771530, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_blitHDROverlay();

  /// @brief Method get_coreBlitColorAndDepthPS, addr 0x6771620, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_coreBlitColorAndDepthPS();

  /// @brief Method get_coreBlitPS, addr 0x67715a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_coreBlitPS();

  /// @brief Method get_fallbackErrorShader, addr 0x67714b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_fallbackErrorShader();

  /// @brief Method get_samplingPS, addr 0x6771698, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_samplingPS();

  /// @brief Method get_terrainDetailGrassBillboardShader, addr 0x6771788, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_terrainDetailGrassBillboardShader();

  /// @brief Method get_terrainDetailGrassShader, addr 0x6771800, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_terrainDetailGrassShader();

  /// @brief Method get_terrainDetailLitShader, addr 0x6771710, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_terrainDetailLitShader();

  /// @brief Method get_version, addr 0x67714a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_blitHDROverlay, addr 0x6771538, size 0x70, virtual false, abstract: false, final false
  inline void set_blitHDROverlay(::UnityEngine::Shader* value);

  /// @brief Method set_coreBlitColorAndDepthPS, addr 0x6771628, size 0x70, virtual false, abstract: false, final false
  inline void set_coreBlitColorAndDepthPS(::UnityEngine::Shader* value);

  /// @brief Method set_coreBlitPS, addr 0x67715b0, size 0x70, virtual false, abstract: false, final false
  inline void set_coreBlitPS(::UnityEngine::Shader* value);

  /// @brief Method set_fallbackErrorShader, addr 0x67714c0, size 0x70, virtual false, abstract: false, final false
  inline void set_fallbackErrorShader(::UnityEngine::Shader* value);

  /// @brief Method set_samplingPS, addr 0x67716a0, size 0x70, virtual false, abstract: false, final false
  inline void set_samplingPS(::UnityEngine::Shader* value);

  /// @brief Method set_terrainDetailGrassBillboardShader, addr 0x6771790, size 0x70, virtual false, abstract: false, final false
  inline void set_terrainDetailGrassBillboardShader(::UnityEngine::Shader* value);

  /// @brief Method set_terrainDetailGrassShader, addr 0x6771808, size 0x70, virtual false, abstract: false, final false
  inline void set_terrainDetailGrassShader(::UnityEngine::Shader* value);

  /// @brief Method set_terrainDetailLitShader, addr 0x6771718, size 0x70, virtual false, abstract: false, final false
