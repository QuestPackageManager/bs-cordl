...
public:
  ...
  /// @brief Method Reset, addr 0x6730f64, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6730f7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
