...
public:
  ...
  /// @brief Method Reset, addr 0x66be898, size 0x18, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x66be8b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
