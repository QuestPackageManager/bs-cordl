...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UniversalLightData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UniversalLightData(UniversalLightData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UniversalLightData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UniversalLightData(UniversalLightDataconst&) = delete;
