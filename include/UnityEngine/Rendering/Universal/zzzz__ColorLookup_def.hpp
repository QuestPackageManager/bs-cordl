...
public:
  ...
  /// @brief Method IsActive, addr 0x665e478, size 0x44, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x665e734, size 0x8, virtual true, abstract: false, final true
  inline bool IsTileCompatible();

  static inline ::UnityEngine::Rendering::Universal::ColorLookup* New_ctor();

  /// @brief Method ValidateLUT, addr 0x665e4bc, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x665e73c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
