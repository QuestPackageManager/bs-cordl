...
public:
  ...
  /// @brief Method IsActive, addr 0x6878bc4, size 0x44, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6878e80, size 0x8, virtual true, abstract: false, final true
  inline bool IsTileCompatible();

  static inline ::UnityEngine::Rendering::Universal::ColorLookup* New_ctor();

  /// @brief Method ValidateLUT, addr 0x6878c08, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6878e88, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::ColorLookup) == 0x48, "Size mismatch!");
