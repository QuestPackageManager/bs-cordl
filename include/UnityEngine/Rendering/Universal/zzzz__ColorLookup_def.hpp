...
public:
  ...
  /// @brief Method ValidateLUT, addr 0x687e420, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x687e6a0, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
