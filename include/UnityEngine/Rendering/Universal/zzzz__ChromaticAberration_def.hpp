...
public:
  ...
  /// @brief Method IsActive, addr 0x6878478, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x68784a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x68784b0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
