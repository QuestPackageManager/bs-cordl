...
public:
  ...
  /// @brief Method IsActive, addr 0x6737f84, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x6737fb4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6737fbc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
