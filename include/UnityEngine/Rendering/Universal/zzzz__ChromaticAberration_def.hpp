...
/// @brief Method IsActive, addr 0x66c5f78, size 0x30, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsTileCompatible, addr 0x66c5fa8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x66c5fb0, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
