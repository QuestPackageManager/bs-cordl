...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChromaticAberration", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChromaticAberration(ChromaticAberration&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChromaticAberration", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChromaticAberration(ChromaticAberrationconst&) = delete;
