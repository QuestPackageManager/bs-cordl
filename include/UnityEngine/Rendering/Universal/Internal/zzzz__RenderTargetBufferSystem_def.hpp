...
public:
  ...
  /// @brief Method Clear, addr 0x67c4dbc, size 0x80, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dispose, addr 0x67c49b0, size 0x54, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method EnableMSAA, addr 0x67c4f20, size 0x80, virtual false, abstract: false, final false
  inline void EnableMSAA(bool enable);

  /// @brief Method GetBackBuffer, addr 0x67c4a4c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetBackBuffer(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method GetBufferA, addr 0x67c4fa0, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetBufferA();

  /// @brief Method GetFrontBuffer, addr 0x67c4ccc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PeekBackBuffer, addr 0x67c4a04, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* PeekBackBuffer();

  /// @brief Method ReAllocate, addr 0x67c4a64, size 0x268, virtual false, abstract: false, final false
  inline void ReAllocate(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetCameraSettings, addr 0x67c4e3c, size 0xe4, virtual false, abstract: false, final false
  inline void SetCameraSettings(::UnityEngine::RenderTextureDescriptor desc, ::UnityEngine::FilterMode filterMode);

  /// @brief Method Swap, addr 0x67c4d58, size 0x64, virtual false, abstract: false, final false
  inline void Swap();
  ...
  /// @brief Method .ctor, addr 0x67c4918, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_backBuffer, addr 0x67c4838, size 0x70, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::Universal::Internal::RenderTargetBufferSystem_SwapBuffer> get_backBuffer();

  /// @brief Method get_frontBuffer, addr 0x67c48a8, size 0x70, virtual false, abstract: false, final false
