...
public:
  ...
  /// @brief Method .ctor, addr 0x68fa3f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__20_0, addr 0x68fb270, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68fb26c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Execute, addr 0x68fa57c, size 0x1fc, virtual true, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext context, ::by_ref<::UnityEngine::Rendering::Universal::RenderingData> renderingData);

  /// @brief Method ExecutePass, addr 0x68fa4cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method InitRendererListParams, addr 0x68fa778, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCameraSetup, addr 0x68fa408, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x68fa8ec, size 0x888, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x68fa3f8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68fa250, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_destination, addr 0x68fa230, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_destination();

  /// @brief Method get_shaderTagId, addr 0x68fa240, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_destination, addr 0x68fa238, size 0x8, virtual false, abstract: false, final false
  inline void set_destination(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_shaderTagId, addr 0x68fa248, size 0x8, virtual false, abstract: false, final false
