...
public:
  ...
  /// @brief Method .ctor, addr 0x67a9d7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SetupRenderGraphLights>b__139_0, addr 0x67a9dd8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67a9dd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClearStencilPartial, addr 0x67a5a54, size 0x180, virtual false, abstract: false, final false
  inline void ClearStencilPartial(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method CreateFullscreenMesh, addr 0x67a5bd4, size 0x158, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> CreateFullscreenMesh();

  /// @brief Method CreateGbufferResources, addr 0x67a4bc8, size 0x2c4, virtual false, abstract: false, final false
  inline void CreateGbufferResources();

  /// @brief Method CreateHemisphereMesh, addr 0x67a89a8, size 0x538, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> CreateHemisphereMesh();

  /// @brief Method CreateSphereMesh, addr 0x67a83d4, size 0x5d4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> CreateSphereMesh();

  /// @brief Method DisableFramebufferFetchInput, addr 0x67a4e8c, size 0x8, virtual false, abstract: false, final false
  inline void DisableFramebufferFetchInput();

  /// @brief Method ExecuteDeferredPass, addr 0x67a5d2c, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGBufferFormat, addr 0x67a3650, size 0x15c, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetGBufferFormat(int32_t index);

  /// @brief Method HasStencilLightsOfType, addr 0x67a646c, size 0x7c, virtual false, abstract: false, final false
  inline bool HasStencilLightsOfType(::UnityEngine::LightType type);

  /// @brief Method InitStencilDeferredMaterial, addr 0x67a3c08, size 0x380, virtual false, abstract: false, final false
  inline void InitStencilDeferredMaterial();

  /// @brief Method IsRuntimeSupportedThisFrame, addr 0x67a53cc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCameraCleanup, addr 0x67a56d4, size 0xd4, virtual false, abstract: false, final false
  inline void OnCameraCleanup(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method OverwriteStencil, addr 0x67a58e8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method OverwriteStencil, addr 0x67a57a8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method PrecomputeLights, addr 0x67a4744, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method ReAllocateGBufferIfNeeded, addr 0x67a4f20, size 0x1d8, virtual false, abstract: false, final false
  inline void ReAllocateGBufferIfNeeded(::UnityEngine::RenderTextureDescriptor gbufferSlice, int32_t gbufferIndex);

  /// @brief Method ReleaseGbufferResources, addr 0x67a4e94, size 0x8c, virtual false, abstract: false, final false
  inline void ReleaseGbufferResources();

  /// @brief Method RenderFog, addr 0x67a6920, size 0x22c, virtual false, abstract: false, final false
  inline void RenderFog(::UnityEngine::Rendering::RasterCommandBuffer* cmd, bool isOrthographic);

  /// @brief Method RenderSSAOBeforeShading, addr 0x67a64e8, size 0x140, virtual false, abstract: false, final false
  inline void RenderSSAOBeforeShading(::UnityEngine::Rendering::RasterCommandBuffer* cmd);

  /// @brief Method RenderStencilDirectionalLights, addr 0x67a6d6c, size 0x614, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderStencilLights, addr 0x67a6628, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderStencilPointLights, addr 0x67a7380, size 0x618, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderStencilSpotLights, addr 0x67a7998, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveMixedLightingMode, addr 0x67a4a5c, size 0x16c, virtual false, abstract: false, final false
  inline void ResolveMixedLightingMode(::UnityEngine::Rendering::Universal::UniversalLightData* lightData);

  /// @brief Method SetAdditionalLightsShadowsKeyword, addr 0x67a8220, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLightCookiesKeyword, addr 0x67a80d8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRenderingLayersMask, addr 0x67a6d18, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSoftShadowsKeyword, addr 0x67a82e4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x67a56cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x67a5498, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLights, addr 0x67a4340, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupMainLightConstants, addr 0x67a6b4c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupMatrixConstants, addr 0x67a6090, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupRenderGraphLights, addr 0x67a3f88, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupShaderLightConstants, addr 0x67a4a58, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDeferredInputAttachments, addr 0x67a50f8, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67a3950, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AccurateGbufferNormals, addr 0x67a3880, size 0x8, virtual false, abstract: false, final false
  inline bool get_AccurateGbufferNormals();

  /// @brief Method get_DeferredInputAttachments, addr 0x67a38f0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> get_DeferredInputAttachments();

  /// @brief Method get_DeferredInputIsTransient, addr 0x67a3900, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<bool, ::Array<bool>*> get_DeferredInputIsTransient();

  /// @brief Method get_DepthAttachment, addr 0x67a3910, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_DepthAttachment();

  /// @brief Method get_DepthAttachmentHandle, addr 0x67a3940, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_DepthAttachmentHandle();

  /// @brief Method get_DepthCopyTexture, addr 0x67a3920, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_DepthCopyTexture();

  /// @brief Method get_GBufferAlbedoIndex, addr 0x67a3510, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GBufferAlbedoIndex();

  /// @brief Method get_GBufferInputAttachmentCount, addr 0x67a363c, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_GBufferInputAttachmentCount();

  /// @brief Method get_GBufferLightingIndex, addr 0x67a3528, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GBufferLightingIndex();

  /// @brief Method get_GBufferNormalSmoothnessIndex, addr 0x67a3520, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GBufferNormalSmoothnessIndex();

  /// @brief Method get_GBufferRenderingLayers, addr 0x67a3544, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_GBufferRenderingLayers();

  /// @brief Method get_GBufferShadowMask, addr 0x67a35a0, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_GBufferShadowMask();

  /// @brief Method get_GBufferSliceCount, addr 0x67a35f8, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_GBufferSliceCount();

  /// @brief Method get_GBufferSpecularMetallicIndex, addr 0x67a3518, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GBufferSpecularMetallicIndex();

  /// @brief Method get_GbufferAttachments, addr 0x67a38d0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> get_GbufferAttachments();

  /// @brief Method get_GbufferDepthIndex, addr 0x67a3530, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_GbufferDepthIndex();

  /// @brief Method get_GbufferFormats, addr 0x67a3930, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_GbufferTextureHandles, addr 0x67a38e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HasDepthPrepass, addr 0x67a3840, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasDepthPrepass();

  /// @brief Method get_HasNormalPrepass, addr 0x67a3850, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasNormalPrepass();

  /// @brief Method get_HasRenderingLayerPrepass, addr 0x67a3860, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasRenderingLayerPrepass();

  /// @brief Method get_IsOverlay, addr 0x67a3870, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsOverlay();

  /// @brief Method get_MixedLightingSetup, addr 0x67a3890, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::MixedLightingSetup get_MixedLightingSetup();

  /// @brief Method get_RenderHeight, addr 0x67a38c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RenderHeight();

  /// @brief Method get_RenderWidth, addr 0x67a38b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RenderWidth();

  /// @brief Method get_RenderingLayerMaskSize, addr 0x67a3810, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::RenderingLayerUtils_MaskSize get_RenderingLayerMaskSize();

  /// @brief Method get_UseDecalLayers, addr 0x67a3820, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseDecalLayers();

  /// @brief Method get_UseFramebufferFetch, addr 0x67a3830, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseFramebufferFetch();

  /// @brief Method get_UseJobSystem, addr 0x67a38a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseJobSystem();

  /// @brief Method get_UseLightLayers, addr 0x67a37ac, size 0x64, virtual false, abstract: false, final false
  inline bool get_UseLightLayers();

  /// @brief Method get_UseRenderingLayers, addr 0x67a3574, size 0x2c, virtual false, abstract: false, final false
  inline bool get_UseRenderingLayers();

  /// @brief Method get_UseShadowMask, addr 0x67a35e8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AccurateGbufferNormals, addr 0x67a3888, size 0x8, virtual false, abstract: false, final false
  inline void set_AccurateGbufferNormals(bool value);

  /// @brief Method set_DeferredInputAttachments, addr 0x67a38f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DeferredInputIsTransient, addr 0x67a3908, size 0x8, virtual false, abstract: false, final false
  inline void set_DeferredInputIsTransient(::ArrayW<bool, ::Array<bool>*> value);

  /// @brief Method set_DepthAttachment, addr 0x67a3918, size 0x8, virtual false, abstract: false, final false
  inline void set_DepthAttachment(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_DepthAttachmentHandle, addr 0x67a3948, size 0x8, virtual false, abstract: false, final false
  inline void set_DepthAttachmentHandle(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_DepthCopyTexture, addr 0x67a3928, size 0x8, virtual false, abstract: false, final false
  inline void set_DepthCopyTexture(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_GbufferAttachments, addr 0x67a38d8, size 0x8, virtual false, abstract: false, final false
  inline void set_GbufferAttachments(::ArrayW<::UnityEngine::Rendering::RTHandle*, ::Array<::UnityEngine::Rendering::RTHandle*>*> value);

  /// @brief Method set_GbufferFormats, addr 0x67a3938, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_GbufferTextureHandles, addr 0x67a38e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_HasDepthPrepass, addr 0x67a3848, size 0x8, virtual false, abstract: false, final false
  inline void set_HasDepthPrepass(bool value);

  /// @brief Method set_HasNormalPrepass, addr 0x67a3858, size 0x8, virtual false, abstract: false, final false
  inline void set_HasNormalPrepass(bool value);

  /// @brief Method set_HasRenderingLayerPrepass, addr 0x67a3868, size 0x8, virtual false, abstract: false, final false
  inline void set_HasRenderingLayerPrepass(bool value);

  /// @brief Method set_IsOverlay, addr 0x67a3878, size 0x8, virtual false, abstract: false, final false
  inline void set_IsOverlay(bool value);

  /// @brief Method set_MixedLightingSetup, addr 0x67a3898, size 0x8, virtual false, abstract: false, final false
  inline void set_MixedLightingSetup(::UnityEngine::Rendering::Universal::MixedLightingSetup value);

  /// @brief Method set_RenderHeight, addr 0x67a38c8, size 0x8, virtual false, abstract: false, final false
  inline void set_RenderHeight(int32_t value);

  /// @brief Method set_RenderWidth, addr 0x67a38b8, size 0x8, virtual false, abstract: false, final false
  inline void set_RenderWidth(int32_t value);

  /// @brief Method set_RenderingLayerMaskSize, addr 0x67a3818, size 0x8, virtual false, abstract: false, final false
  inline void set_RenderingLayerMaskSize(::UnityEngine::Rendering::Universal::RenderingLayerUtils_MaskSize value);

  /// @brief Method set_UseDecalLayers, addr 0x67a3828, size 0x8, virtual false, abstract: false, final false
  inline void set_UseDecalLayers(bool value);

  /// @brief Method set_UseFramebufferFetch, addr 0x67a3838, size 0x8, virtual false, abstract: false, final false
  inline void set_UseFramebufferFetch(bool value);

  /// @brief Method set_UseJobSystem, addr 0x67a38a8, size 0x8, virtual false, abstract: false, final false
