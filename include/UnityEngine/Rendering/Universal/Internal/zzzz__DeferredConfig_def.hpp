...
public:
  ...
  /// @brief Method get_IsDX10, addr 0x67a3470, size 0x4c, virtual false, abstract: false, final false
  static inline bool get_IsDX10();

  /// @brief Method get_IsOpenGL, addr 0x67a33d0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDX10, addr 0x67a34bc, size 0x54, virtual false, abstract: false, final false
  static inline void set_IsDX10(bool value);

  /// @brief Method set_IsOpenGL, addr 0x67a341c, size 0x54, virtual false, abstract: false, final false
