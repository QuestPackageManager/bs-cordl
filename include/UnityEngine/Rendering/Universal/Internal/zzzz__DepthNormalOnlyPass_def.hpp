...
public:
  ...
  /// @brief Method .ctor, addr 0x67b844c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Render>b__42_0, addr 0x67b9b44, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67b9b40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Execute, addr 0x67b87dc, size 0x280, virtual true, abstract: false, final false
  inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext context, ::ByRef<::UnityEngine::Rendering::Universal::RenderingData> renderingData);

  /// @brief Method ExecutePass, addr 0x67b86d4, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGraphicsFormat, addr 0x67b8450, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetGraphicsFormat();

  /// @brief Method InitRendererListParams, addr 0x67b8a5c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCameraCleanup, addr 0x67b8bd0, size 0xc4, virtual true, abstract: false, final false
  inline void OnCameraCleanup(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method OnCameraSetup, addr 0x67b84f4, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x67b8c94, size 0xbd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x67b84d4, size 0xc, virtual false, abstract: false, final false
  inline void Setup(::UnityEngine::Rendering::RTHandle* depthHandle, ::UnityEngine::Rendering::RTHandle* normalHandle);

  /// @brief Method Setup, addr 0x67b84e0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67b82ec, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method get_depthHandle, addr 0x67b829c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_depthHandle();

  /// @brief Method get_enableRenderingLayers, addr 0x67b82cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_enableRenderingLayers();

  /// @brief Method get_normalHandle, addr 0x67b82ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_normalHandle();

  /// @brief Method get_renderingLayersHandle, addr 0x67b82bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* get_renderingLayersHandle();

  /// @brief Method get_renderingLayersMaskSize, addr 0x67b82dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::RenderingLayerUtils_MaskSize get_renderingLayersMaskSize();

  /// @brief Method get_shaderTagIds, addr 0x67b828c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_depthHandle, addr 0x67b82a4, size 0x8, virtual false, abstract: false, final false
  inline void set_depthHandle(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_enableRenderingLayers, addr 0x67b82d4, size 0x8, virtual false, abstract: false, final false
  inline void set_enableRenderingLayers(bool value);

  /// @brief Method set_normalHandle, addr 0x67b82b4, size 0x8, virtual false, abstract: false, final false
  inline void set_normalHandle(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_renderingLayersHandle, addr 0x67b82c4, size 0x8, virtual false, abstract: false, final false
  inline void set_renderingLayersHandle(::UnityEngine::Rendering::RTHandle* value);

  /// @brief Method set_renderingLayersMaskSize, addr 0x67b82e4, size 0x8, virtual false, abstract: false, final false
  inline void set_renderingLayersMaskSize(::UnityEngine::Rendering::Universal::RenderingLayerUtils_MaskSize value);

  /// @brief Method set_shaderTagIds, addr 0x67b8294, size 0x8, virtual false, abstract: false, final false
