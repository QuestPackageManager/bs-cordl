...
public:
// Declarations
/// @brief Method Create, addr 0x6740430, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6740538, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__44_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__44_0, put=setStaticF___9__44_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>*  __9__44_0;

static inline ::UnityEngine::Rendering::Universal::Internal::ForwardLights___c* New_ctor() ;

/// @brief Method <SetupRenderGraphLights>b__44_0, addr 0x6740594, size 0x38, virtual false, abstract: false, final false
inline void _SetupRenderGraphLights_b__44_0(::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*  data, ::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*  rgContext) ;

/// @brief Method .ctor, addr 0x6740590, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::Universal::Internal::ForwardLights___c* getStaticF___9() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>* getStaticF___9__44_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::Internal::ForwardLights___c*  value) ;

static inline void setStaticF___9__44_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::ForwardLights_SetupLightPassData*,::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>*  value) ;
...
// Dependencies System.Object, Unity.Collections.NativeArray`1<T>, Unity.Jobs.JobHandle, Unity.Mathematics.int2, UnityEngine.Rendering.Universal.MixedLightingSetup, UnityEngine.Rendering.Universal.ReflectionProbeManager
namespace UnityEngine::Rendering::Universal::Internal {
// Is value type: false
...
/// @brief Field m_AdditionalLightAttenuations, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightAttenuations, put=__cordl_internal_set_m_AdditionalLightAttenuations)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightAttenuations;

/// @brief Field m_AdditionalLightColors, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightColors, put=__cordl_internal_set_m_AdditionalLightColors)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightColors;

/// @brief Field m_AdditionalLightOcclusionProbeChannels, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightOcclusionProbeChannels, put=__cordl_internal_set_m_AdditionalLightOcclusionProbeChannels)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightOcclusionProbeChannels;

/// @brief Field m_AdditionalLightPositions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightPositions, put=__cordl_internal_set_m_AdditionalLightPositions)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightPositions;

/// @brief Field m_AdditionalLightSpotDirections, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightSpotDirections, put=__cordl_internal_set_m_AdditionalLightSpotDirections)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightSpotDirections;
...
/// @brief Field m_AdditionalLightsLayerMasks, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightsLayerMasks, put=__cordl_internal_set_m_AdditionalLightsLayerMasks)) ::ArrayW<float_t,::Array<float_t>*>  m_AdditionalLightsLayerMasks;
...
/// @brief Method AlignByteCount, addr 0x673d378, size 0x14, virtual false, abstract: false, final false
static inline int32_t AlignByteCount(int32_t  count, int32_t  align) ;

/// @brief Method Cleanup, addr 0x673f6e0, size 0xe4, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateForwardPlusBuffers, addr 0x673d1bc, size 0x1ac, virtual false, abstract: false, final false
inline void CreateForwardPlusBuffers() ;

/// @brief Method GetViewParams, addr 0x673d38c, size 0xb8, virtual false, abstract: false, final false
inline void GetViewParams(::UnityEngine::Camera*  camera, ::Unity::Mathematics::float4x4  viewToClip, ::ByRef<float_t>  viewPlaneBot, ::ByRef<float_t>  viewPlaneTop, ::ByRef<::Unity::Mathematics::float4>  viewToViewportScaleBias) ;

/// @brief Method InitializeLightConstants, addr 0x673f7c4, size 0x1fc, virtual false, abstract: false, final false
inline void InitializeLightConstants(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::VisibleLight>  lights, int32_t  lightIndex, bool  supportsLightLayers, ::ByRef<::UnityEngine::Vector4>  lightPos, ::ByRef<::UnityEngine::Vector4>  lightColor, ::ByRef<::UnityEngine::Vector4>  lightAttenuation, ::ByRef<::UnityEngine::Vector4>  lightSpotDir, ::ByRef<::UnityEngine::Vector4>  lightOcclusionProbeChannel, ::ByRef<uint32_t>  lightLayerMask, ::ByRef<bool>  isSubtractive) ;
...
/// @brief Method PreSetup, addr 0x673d444, size 0x12d8, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x673e784, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method SetupAdditionalLightConstants, addr 0x673fb28, size 0x578, virtual false, abstract: false, final false
inline void SetupAdditionalLightConstants(::UnityEngine::Rendering::UnsafeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method SetupLights, addr 0x673e898, size 0xa5c, virtual false, abstract: false, final false
...
/// @brief Method SetupMainLightConstants, addr 0x673f9c0, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method SetupPerObjectLightIndices, addr 0x67400a0, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method SetupRenderGraphLights, addr 0x673f2f4, size 0x3a4, virtual false, abstract: false, final false
...
/// @brief Method SetupShaderLightConstants, addr 0x673f698, size 0x48, virtual false, abstract: false, final false
inline void SetupShaderLightConstants(::UnityEngine::Rendering::UnsafeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::CullingResults>  cullResults, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData) ;

/// @brief Method <PreSetup>g__IsProbeGreater|40_0, addr 0x673e71c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x673cd50, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x673cd7c, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method get_reflectionProbeManager, addr 0x673d368, size 0x10, virtual false, abstract: false, final false
