...
/// @brief Field shadowRendererLists, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_shadowRendererLists, put=__cordl_internal_set_shadowRendererLists)) ::ArrayW<::UnityEngine::Rendering::RendererList,::Array<::UnityEngine::Rendering::RendererList>*>  shadowRendererLists;

/// @brief Field shadowRendererListsHandle, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_shadowRendererListsHandle, put=__cordl_internal_set_shadowRendererListsHandle)) ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>  shadowRendererListsHandle;
...
constexpr ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*> const& __cordl_internal_get_shadowRendererListsHandle() const;

constexpr ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>& __cordl_internal_get_shadowRendererListsHandle() ;
...
constexpr void __cordl_internal_set_shadowRendererListsHandle(::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>  value) ;

constexpr void __cordl_internal_set_shadowmapTexture(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  value) ;

/// @brief Method .ctor, addr 0x674fe28, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__38_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__38_0, put=setStaticF___9__38_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__38_0;

static inline ::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass___c* New_ctor() ;

/// @brief Method <Render>b__38_0, addr 0x675275c, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6752758, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass___c* getStaticF___9() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__38_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass___c*  value) ;

static inline void setStaticF___9__38_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
/// @brief Field m_CascadeSlices, offset 0x138, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CascadeSlices, put=__cordl_internal_set_m_CascadeSlices)) ::ArrayW<::UnityEngine::Rendering::Universal::ShadowSliceData,::Array<::UnityEngine::Rendering::Universal::ShadowSliceData>*>  m_CascadeSlices;

/// @brief Field m_CascadeSplitDistances, offset 0x120, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CascadeSplitDistances, put=__cordl_internal_set_m_CascadeSplitDistances)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_CascadeSplitDistances;
...
/// @brief Field m_EmptyMainLightShadowmapTexture, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_EmptyMainLightShadowmapTexture, put=__cordl_internal_set_m_EmptyMainLightShadowmapTexture)) ::UnityEngine::Rendering::RTHandle*  m_EmptyMainLightShadowmapTexture;
...
/// @brief Field m_MainLightShadowMatrices, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_MainLightShadowMatrices, put=__cordl_internal_set_m_MainLightShadowMatrices)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  m_MainLightShadowMatrices;
...
/// @brief Method Clear, addr 0x67505e4, size 0x148, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Configure, addr 0x67507d8, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x674fea8, size 0x34, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Execute, addr 0x6750918, size 0x2d0, virtual true, abstract: false, final false
inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext  context, ::ByRef<::UnityEngine::Rendering::Universal::RenderingData>  renderingData) ;

/// @brief Method InitPassData, addr 0x6750cd0, size 0x54, virtual false, abstract: false, final false
inline void InitPassData(::ByRef<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*>  passData, ::UnityEngine::Rendering::Universal::UniversalRenderingData*  renderingData, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::UnityEngine::Rendering::Universal::UniversalShadowData*  shadowData) ;

/// @brief Method InitRendererLists, addr 0x6750d24, size 0x220, virtual false, abstract: false, final false
inline void InitRendererLists(::ByRef<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*>  passData, ::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, bool  useRenderGraph) ;
...
/// @brief Method Render, addr 0x6751adc, size 0x94c, virtual false, abstract: false, final false
...
/// @brief Method RenderMainLightCascadeShadowmap, addr 0x6750f44, size 0x614, virtual false, abstract: false, final false
inline void RenderMainLightCascadeShadowmap(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_PassData*>  data, bool  isRenderGraph) ;

/// @brief Method SetShadowParamsForEmptyShadowmap, addr 0x6750be8, size 0xe8, virtual false, abstract: false, final false
static inline void SetShadowParamsForEmptyShadowmap(::UnityEngine::Rendering::RasterCommandBuffer*  rasterCommandBuffer) ;

/// @brief Method Setup, addr 0x674fedc, size 0xf4, virtual false, abstract: false, final false
inline bool Setup(::ByRef<::UnityEngine::Rendering::Universal::RenderingData>  renderingData) ;

/// @brief Method Setup, addr 0x674ffd0, size 0x430, virtual false, abstract: false, final false
...
/// @brief Method SetupForEmptyRendering, addr 0x6750400, size 0x1e4, virtual false, abstract: false, final false
inline bool SetupForEmptyRendering(bool  stripShadowsOffVariants, ::UnityEngine::Light*  light, ::UnityEngine::Rendering::Universal::UniversalCameraData*  cameraData, ::UnityEngine::Rendering::Universal::UniversalShadowData*  shadowData) ;

/// @brief Method SetupMainLightShadowReceiverConstants, addr 0x6751558, size 0x584, virtual false, abstract: false, final false
inline void SetupMainLightShadowReceiverConstants(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::VisibleLight>  shadowLight, ::UnityEngine::Rendering::Universal::UniversalShadowData*  shadowData) ;

/// @brief Method UpdateTextureDescriptorIfNeeded, addr 0x675072c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x674fc78, size 0x1b0, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::Internal::MainLightShadowCasterPass_MainLightShadowConstantBuffer*, "UnityEngine.Rendering.Universal.Internal", "MainLightShadowCasterPass/MainLightShadowConstantBuffer");
