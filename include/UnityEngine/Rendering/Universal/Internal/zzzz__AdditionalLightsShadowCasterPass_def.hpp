...
/// @brief Field shadowRendererListsHdl, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_shadowRendererListsHdl, put=__cordl_internal_set_shadowRendererListsHdl)) ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>  shadowRendererListsHdl;
...
constexpr ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*> const& __cordl_internal_get_shadowRendererListsHdl() const;

constexpr ::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>& __cordl_internal_get_shadowRendererListsHdl() ;
...
constexpr void __cordl_internal_set_shadowRendererListsHdl(::ArrayW<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle,::Array<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>*>  value) ;
...
/// @brief Method .ctor, addr 0x67382b8, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__61_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__61_0, put=setStaticF___9__61_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__61_0;

static inline ::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass___c* New_ctor() ;

/// @brief Method <Render>b__61_0, addr 0x673cc7c, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x673cc78, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass___c* getStaticF___9() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__61_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass___c*  value) ;

static inline void setStaticF___9__61_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;
...
/// @brief Field m_AdditionalLightIndexToShadowParams, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightIndexToShadowParams, put=__cordl_internal_set_m_AdditionalLightIndexToShadowParams)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  m_AdditionalLightIndexToShadowParams;

/// @brief Field m_AdditionalLightIndexToVisibleLightIndex, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightIndexToVisibleLightIndex, put=__cordl_internal_set_m_AdditionalLightIndexToVisibleLightIndex)) ::ArrayW<int16_t,::Array<int16_t>*>  m_AdditionalLightIndexToVisibleLightIndex;
...
/// @brief Field m_AdditionalLightShadowSliceIndexTo_WorldShadowMatrix, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightShadowSliceIndexTo_WorldShadowMatrix, put=__cordl_internal_set_m_AdditionalLightShadowSliceIndexTo_WorldShadowMatrix)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  m_AdditionalLightShadowSliceIndexTo_WorldShadowMatrix;

/// @brief Field m_AdditionalLightsShadowSlices, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AdditionalLightsShadowSlices, put=__cordl_internal_set_m_AdditionalLightsShadowSlices)) ::ArrayW<::UnityEngine::Rendering::Universal::ShadowSliceData,::Array<::UnityEngine::Rendering::Universal::ShadowSliceData>*>  m_AdditionalLightsShadowSlices;
...
/// @brief Field m_EmptyAdditionalLightShadowmapTexture, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_EmptyAdditionalLightShadowmapTexture, put=__cordl_internal_set_m_EmptyAdditionalLightShadowmapTexture)) ::UnityEngine::Rendering::RTHandle*  m_EmptyAdditionalLightShadowmapTexture;
...
/// @brief Field m_PassData, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PassData, put=__cordl_internal_set_m_PassData)) ::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*  m_PassData;
...
/// @brief Field m_VisibleLightIndexToAdditionalLightIndex, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_VisibleLightIndexToAdditionalLightIndex, put=__cordl_internal_set_m_VisibleLightIndexToAdditionalLightIndex)) ::ArrayW<int16_t,::Array<int16_t>*>  m_VisibleLightIndexToAdditionalLightIndex;

/// @brief Field m_VisibleLightIndexToIsCastingShadows, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_VisibleLightIndexToIsCastingShadows, put=__cordl_internal_set_m_VisibleLightIndexToIsCastingShadows)) ::ArrayW<bool,::Array<bool>*>  m_VisibleLightIndexToIsCastingShadows;
...
/// @brief Field s_EmptyAdditionalLightIndexToShadowParams, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_EmptyAdditionalLightIndexToShadowParams, put=setStaticF_s_EmptyAdditionalLightIndexToShadowParams)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  s_EmptyAdditionalLightIndexToShadowParams;
...
/// @brief Method CalcGuardAngle, addr 0x673836c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x673a7c0, size 0x80, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeShadowRequestHash, addr 0x67386e8, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method Configure, addr 0x673a8ec, size 0x140, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x6738338, size 0x34, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Execute, addr 0x673aa2c, size 0x314, virtual true, abstract: false, final false
inline void Execute(::UnityEngine::Rendering::ScriptableRenderContext  context, ::ByRef<::UnityEngine::Rendering::Universal::RenderingData>  renderingData) ;

/// @brief Method GetLightTypeIdentifierForShadowParams, addr 0x67389e0, size 0x20, virtual false, abstract: false, final false
inline float_t GetLightTypeIdentifierForShadowParams(::UnityEngine::LightType  lightType) ;

/// @brief Method GetPointLightShadowFrustumFovBiasInDegrees, addr 0x67383dc, size 0x2c0, virtual false, abstract: false, final false
static inline float_t GetPointLightShadowFrustumFovBiasInDegrees(int32_t  shadowSliceResolution, bool  shadowFiltering) ;

/// @brief Method GetShadowLightIndexFromLightIndex, addr 0x673606c, size 0x60, virtual false, abstract: false, final false
inline int32_t GetShadowLightIndexFromLightIndex(int32_t  visibleLightIndex) ;

/// @brief Method InitPassData, addr 0x673ae78, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Render, addr 0x673c018, size 0x9a8, virtual false, abstract: false, final false
...
/// @brief Method RenderAdditionalShadowmapAtlas, addr 0x673b1a8, size 0xb0c, virtual false, abstract: false, final false
inline void RenderAdditionalShadowmapAtlas(::UnityEngine::Rendering::RasterCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*>  data, bool  useRenderGraph) ;

/// @brief Method ResolutionLog2ForHash, addr 0x673869c, size 0x4c, virtual false, abstract: false, final false
inline uint64_t ResolutionLog2ForHash(int32_t  resolution) ;

/// @brief Method SetShadowParamsForEmptyShadowmap, addr 0x673ad40, size 0x138, virtual false, abstract: false, final false
static inline void SetShadowParamsForEmptyShadowmap(::UnityEngine::Rendering::RasterCommandBuffer*  rasterCommandBuffer) ;

/// @brief Method Setup, addr 0x6738a38, size 0xf4, virtual false, abstract: false, final false
inline bool Setup(::ByRef<::UnityEngine::Rendering::Universal::RenderingData>  renderingData) ;

/// @brief Method Setup, addr 0x6738b2c, size 0x184c, virtual false, abstract: false, final false
...
/// @brief Method SetupAdditionalLightsShadowReceiverConstants, addr 0x673bcb4, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method SetupForEmptyRendering, addr 0x673a378, size 0x448, virtual false, abstract: false, final false
inline bool SetupForEmptyRendering(bool  stripShadowsOffVariants, ::UnityEngine::Rendering::Universal::UniversalLightData*  lightData, ::UnityEngine::Rendering::Universal::UniversalShadowData*  shadowData) ;

/// @brief Method UpdateTextureDescriptorIfNeeded, addr 0x673a840, size 0xac, virtual false, abstract: false, final false
inline void UpdateTextureDescriptorIfNeeded() ;

/// @brief Method UsesBakedShadows, addr 0x6738a00, size 0x38, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::Rendering::Universal::ShadowSliceData,::Array<::UnityEngine::Rendering::Universal::ShadowSliceData>*> const& __cordl_internal_get_m_AdditionalLightsShadowSlices() const;
...
constexpr void __cordl_internal_set_m_AdditionalLightsShadowSlices(::ArrayW<::UnityEngine::Rendering::Universal::ShadowSliceData,::Array<::UnityEngine::Rendering::Universal::ShadowSliceData>*>  value) ;
...
/// @brief Method .ctor, addr 0x6737e5c, size 0x45c, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_AdditionalShadowsConstantBuffer*, "UnityEngine.Rendering.Universal.Internal", "AdditionalLightsShadowCasterPass/AdditionalShadowsConstantBuffer");
NEED_NO_BOX(::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::Universal::Internal::AdditionalLightsShadowCasterPass_PassData*, "UnityEngine.Rendering.Universal.Internal", "AdditionalLightsShadowCasterPass/PassData");
