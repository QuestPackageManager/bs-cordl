...
/// @brief Field s_NormalReconstructionMatrix, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_NormalReconstructionMatrix, put=setStaticF_s_NormalReconstructionMatrix)) ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>  s_NormalReconstructionMatrix;
...
/// @brief Method SetupProperties, addr 0x67405cc, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method SetupProperties, addr 0x6740978, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetupProperties, addr 0x6740670, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetupProperties, addr 0x6740700, size 0x278, virtual false, abstract: false, final false
