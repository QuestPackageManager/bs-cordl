...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6713fd8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6713ff8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6713fc4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6713e80, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitMaterial, addr 0x6713b38, size 0x64, virtual false, abstract: false, final false
  inline void InitMaterial();

  /// @brief Method IsValid, addr 0x6713c8c, size 0x150, virtual false, abstract: false, final false
  inline bool IsValid();

  static inline ::UnityEngine::Rendering::Universal::DecalProjector* New_ctor();

  /// @brief Method OnDisable, addr 0x6713c1c, size 0x70, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6713b9c, size 0x80, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x6713874, size 0xec, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method UpdateAllDecalProperties, addr 0x6713ddc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6713e44, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onAllDecalPropertyChange, addr 0x6713424, size 0xd0, virtual false, abstract: false, final false
  static inline void add_onAllDecalPropertyChange(::System::Action* value);

  /// @brief Method add_onDecalAdd, addr 0x6712f4c, size 0xcc, virtual false, abstract: false, final false
  static inline void add_onDecalAdd(::UnityEngine::Rendering::Universal::DecalProjector_DecalProjectorAction* value);

  /// @brief Method add_onDecalMaterialChange, addr 0x67135c4, size 0xd0, virtual false, abstract: false, final false
  static inline void add_onDecalMaterialChange(::UnityEngine::Rendering::Universal::DecalProjector_DecalProjectorAction* value);

  /// @brief Method add_onDecalPropertyChange, addr 0x6713284, size 0xd0, virtual false, abstract: false, final false
  static inline void add_onDecalPropertyChange(::UnityEngine::Rendering::Universal::DecalProjector_DecalProjectorAction* value);

  /// @brief Method add_onDecalRemove, addr 0x67130e4, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_decalEntity, addr 0x6713854, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalEntity get_decalEntity();

  /// @brief Method get_decalOffset, addr 0x6713b1c, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_decalOffset();

  /// @brief Method get_decalSize, addr 0x6713b10, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_decalSize();

  /// @brief Method get_defaultMaterial, addr 0x6713764, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_defaultMaterial();

  /// @brief Method get_drawDistance, addr 0x6713960, size 0x8, virtual false, abstract: false, final false
  inline float_t get_drawDistance();

  /// @brief Method get_effectiveScale, addr 0x6713a94, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_effectiveScale();

  /// @brief Method get_endAngleFade, addr 0x67139d0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_endAngleFade();

  /// @brief Method get_fadeFactor, addr 0x6713a6c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fadeFactor();

  /// @brief Method get_fadeScale, addr 0x671397c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fadeScale();

  /// @brief Method get_isSupported, addr 0x6713800, size 0x54, virtual false, abstract: false, final false
  static inline bool get_isSupported();

  /// @brief Method get_material, addr 0x6713864, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_pivot, addr 0x6713a3c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_pivot();

  /// @brief Method get_renderingLayerMask, addr 0x6713a1c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_renderingLayerMask();

  /// @brief Method get_scaleMode, addr 0x6713a2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalScaleMode get_scaleMode();

  /// @brief Method get_size, addr 0x6713a54, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_size();

  /// @brief Method get_startAngleFade, addr 0x67139a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startAngleFade();

  /// @brief Method get_uvBias, addr 0x6713a0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_uvBias();

  /// @brief Method get_uvScale, addr 0x67139fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_uvScale();

  /// @brief Method get_uvScaleBias, addr 0x6713b2c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_uvScaleBias();

  /// @brief Method remove_onAllDecalPropertyChange, addr 0x67134f4, size 0xd0, virtual false, abstract: false, final false
  static inline void remove_onAllDecalPropertyChange(::System::Action* value);

  /// @brief Method remove_onDecalAdd, addr 0x6713018, size 0xcc, virtual false, abstract: false, final false
  static inline void remove_onDecalAdd(::UnityEngine::Rendering::Universal::DecalProjector_DecalProjectorAction* value);

  /// @brief Method remove_onDecalMaterialChange, addr 0x6713694, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDecalPropertyChange, addr 0x6713354, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onDecalRemove, addr 0x67131b4, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_decalEntity, addr 0x671385c, size 0x8, virtual false, abstract: false, final false
  inline void set_decalEntity(::UnityEngine::Rendering::Universal::DecalEntity value);

  /// @brief Method set_defaultMaterial, addr 0x67137b0, size 0x50, virtual false, abstract: false, final false
  static inline void set_defaultMaterial(::UnityEngine::Material* value);

  /// @brief Method set_drawDistance, addr 0x6713968, size 0x14, virtual false, abstract: false, final false
  inline void set_drawDistance(float_t value);

  /// @brief Method set_endAngleFade, addr 0x67139d8, size 0x24, virtual false, abstract: false, final false
  inline void set_endAngleFade(float_t value);

  /// @brief Method set_fadeFactor, addr 0x6713a74, size 0x20, virtual false, abstract: false, final false
  inline void set_fadeFactor(float_t value);

  /// @brief Method set_fadeScale, addr 0x6713984, size 0x20, virtual false, abstract: false, final false
  inline void set_fadeScale(float_t value);

  /// @brief Method set_material, addr 0x671386c, size 0x8, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_pivot, addr 0x6713a48, size 0xc, virtual false, abstract: false, final false
  inline void set_pivot(::UnityEngine::Vector3 value);

  /// @brief Method set_renderingLayerMask, addr 0x6713a24, size 0x8, virtual false, abstract: false, final false
  inline void set_renderingLayerMask(uint32_t value);

  /// @brief Method set_scaleMode, addr 0x6713a34, size 0x8, virtual false, abstract: false, final false
  inline void set_scaleMode(::UnityEngine::Rendering::Universal::DecalScaleMode value);

  /// @brief Method set_size, addr 0x6713a60, size 0xc, virtual false, abstract: false, final false
  inline void set_size(::UnityEngine::Vector3 value);

  /// @brief Method set_startAngleFade, addr 0x67139ac, size 0x24, virtual false, abstract: false, final false
  inline void set_startAngleFade(float_t value);

  /// @brief Method set_uvBias, addr 0x6713a14, size 0x8, virtual false, abstract: false, final false
  inline void set_uvBias(::UnityEngine::Vector2 value);

  /// @brief Method set_uvScale, addr 0x6713a04, size 0x8, virtual false, abstract: false, final false
