...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6859f24, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6859f44, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6859f10, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6859dcc, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitMaterial, addr 0x6859a84, size 0x64, virtual false, abstract: false, final false
  inline void InitMaterial();

  /// @brief Method IsValid, addr 0x6859bd8, size 0x150, virtual false, abstract: false, final false
  inline bool IsValid();

  static inline ::UnityEngine::Rendering::Universal::DecalProjector* New_ctor();

  /// @brief Method OnDisable, addr 0x6859b68, size 0x70, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6859ae8, size 0x80, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x68597c0, size 0xec, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method UpdateAllDecalProperties, addr 0x6859d28, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_decalOffset, addr 0x6859a68, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_drawDistance, addr 0x68598ac, size 0x8, virtual false, abstract: false, final false
  inline float_t get_drawDistance();

  /// @brief Method get_effectiveScale, addr 0x68599e0, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_effectiveScale();

  /// @brief Method get_endAngleFade, addr 0x685991c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_endAngleFade();

  /// @brief Method get_fadeFactor, addr 0x68599b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fadeFactor();

  /// @brief Method get_fadeScale, addr 0x68598c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fadeScale();

  /// @brief Method get_isSupported, addr 0x685974c, size 0x54, virtual false, abstract: false, final false
  static inline bool get_isSupported();

  /// @brief Method get_material, addr 0x68597b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_pivot, addr 0x6859988, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_pivot();

  /// @brief Method get_renderingLayerMask, addr 0x6859968, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_renderingLayerMask();

  /// @brief Method get_scaleMode, addr 0x6859978, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DecalScaleMode get_scaleMode();

  /// @brief Method get_size, addr 0x68599a0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_size();

  /// @brief Method get_startAngleFade, addr 0x68598f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startAngleFade();

  /// @brief Method get_uvBias, addr 0x6859958, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_uvBias();

  /// @brief Method get_uvScale, addr 0x6859948, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_drawDistance, addr 0x68598b4, size 0x14, virtual false, abstract: false, final false
  inline void set_drawDistance(float_t value);

  /// @brief Method set_endAngleFade, addr 0x6859924, size 0x24, virtual false, abstract: false, final false
  inline void set_endAngleFade(float_t value);

  /// @brief Method set_fadeFactor, addr 0x68599c0, size 0x20, virtual false, abstract: false, final false
  inline void set_fadeFactor(float_t value);

  /// @brief Method set_fadeScale, addr 0x68598d0, size 0x20, virtual false, abstract: false, final false
  inline void set_fadeScale(float_t value);

  /// @brief Method set_material, addr 0x68597b8, size 0x8, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_pivot, addr 0x6859994, size 0xc, virtual false, abstract: false, final false
  inline void set_pivot(::UnityEngine::Vector3 value);

  /// @brief Method set_renderingLayerMask, addr 0x6859970, size 0x8, virtual false, abstract: false, final false
  inline void set_renderingLayerMask(uint32_t value);

  /// @brief Method set_scaleMode, addr 0x6859980, size 0x8, virtual false, abstract: false, final false
  inline void set_scaleMode(::UnityEngine::Rendering::Universal::DecalScaleMode value);

  /// @brief Method set_size, addr 0x68599ac, size 0xc, virtual false, abstract: false, final false
  inline void set_size(::UnityEngine::Vector3 value);

  /// @brief Method set_startAngleFade, addr 0x68598f8, size 0x24, virtual false, abstract: false, final false
  inline void set_startAngleFade(float_t value);

  /// @brief Method set_uvBias, addr 0x6859960, size 0x8, virtual false, abstract: false, final false
  inline void set_uvBias(::UnityEngine::Vector2 value);

  /// @brief Method set_uvScale, addr 0x6859950, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalProjector) == 0x80, "Size mismatch!");
