...
public:
  ...
  /// @brief Method Dispose, addr 0x67163a0, size 0x6c, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalEntityChunk* New_ctor();

  /// @brief Method Push, addr 0x6716228, size 0x10, virtual true, abstract: false, final false
  inline void Push();

  /// @brief Method RemoveAtSwapBack, addr 0x6716238, size 0xcc, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x6716304, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x671640c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
