...
/// @brief Method Dispose, addr 0x66a4394, size 0x6c, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalEntityChunk* New_ctor() ;

/// @brief Method Push, addr 0x66a421c, size 0x10, virtual true, abstract: false, final false
inline void Push() ;

/// @brief Method RemoveAtSwapBack, addr 0x66a422c, size 0xcc, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x66a42f8, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a4400, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
