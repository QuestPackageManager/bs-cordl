...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DecalEntityChunk*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DecalEntityChunk*, "UnityEngine.Rendering.Universal", "DecalEntityChunk");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_decalProjectors, put = __cordl_internal_set_decalProjectors)) ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>> decalProjectors;
  ...
  /// @brief Method Dispose, addr 0x685c2ec, size 0x6c, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::Rendering::Universal::DecalEntityChunk* New_ctor();

  /// @brief Method Push, addr 0x685c174, size 0x10, virtual true, abstract: false, final false
  inline void Push();

  /// @brief Method RemoveAtSwapBack, addr 0x685c184, size 0xcc, virtual true, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t entityIndex);

  /// @brief Method SetCapacity, addr 0x685c250, size 0x9c, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>> const& __cordl_internal_get_decalProjectors() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>>& __cordl_internal_get_decalProjectors();
  ...
  constexpr void __cordl_internal_set_decalProjectors(::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>> value);
  ...
  /// @brief Method .ctor, addr 0x685c358, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalEntityChunk", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalEntityChunk(DecalEntityChunk&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalEntityChunk", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalEntityChunk(DecalEntityChunkconst&) = delete;
  ...
  ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>> ___decalProjectors;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DecalEntityChunk) == 0x50, "Size mismatch!");
