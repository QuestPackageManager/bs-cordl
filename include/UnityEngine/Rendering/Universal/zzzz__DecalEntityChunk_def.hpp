...
/// @brief Field decalEntities, offset 0x30, size 0x10 
 __declspec(property(get=__cordl_internal_get_decalEntities, put=__cordl_internal_set_decalEntities)) ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::Universal::DecalEntity>  decalEntities;

/// @brief Field decalProjectors, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_decalProjectors, put=__cordl_internal_set_decalProjectors)) ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>,::Array<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>>*>  decalProjectors;
...
/// @brief Method Dispose, addr 0x6717f18, size 0x6c, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalEntityChunk* New_ctor() ;

/// @brief Method Push, addr 0x6717da0, size 0x10, virtual true, abstract: false, final false
inline void Push() ;

/// @brief Method RemoveAtSwapBack, addr 0x6717db0, size 0xcc, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x6717e7c, size 0x9c, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>,::Array<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>>*> const& __cordl_internal_get_decalProjectors() const;
...
constexpr void __cordl_internal_set_decalProjectors(::ArrayW<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>,::Array<::UnityW<::UnityEngine::Rendering::Universal::DecalProjector>>*>  value) ;
...
/// @brief Method .ctor, addr 0x6717f84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
