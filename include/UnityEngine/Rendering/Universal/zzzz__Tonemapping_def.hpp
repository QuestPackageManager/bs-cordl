...
public:
  ...
  /// @brief Method IsActive, addr 0x687a31c, size 0x30, virtual true, abstract: false, final true
  inline bool IsActive();

  /// @brief Method IsTileCompatible, addr 0x687a34c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x687a354, size 0x1f4, virtual false, abstract: false, final false
  inline void _ctor();
