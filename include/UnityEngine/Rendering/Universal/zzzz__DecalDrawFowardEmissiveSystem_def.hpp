...
public:
  // Declarations
  /// @brief Method GetPassIndex, addr 0x6856f30, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6856eac, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawFowardEmissiveSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalDrawFowardEmissiveSystem(DecalDrawFowardEmissiveSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalDrawFowardEmissiveSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalDrawFowardEmissiveSystem(DecalDrawFowardEmissiveSystemconst&) = delete;
