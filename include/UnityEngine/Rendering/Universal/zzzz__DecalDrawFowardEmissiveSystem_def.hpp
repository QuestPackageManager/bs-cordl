...
public:
// Declarations
/// @brief Method GetPassIndex, addr 0x669efd8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x669ef54, size 0x84, virtual false, abstract: false, final false
