...
public:
  // Declarations
  /// @brief Method GetPassIndex, addr 0x6636d8c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6636d08, size 0x84, virtual false, abstract: false, final false
