...
public:
  ...
  /// @brief Method .ctor, addr 0x67081a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x67081a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Setup>b__106_0, addr 0x670b43c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method <UpdateShaderGlobalPropertiesForFinalValidationPass>b__101_0, addr 0x670b3d4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670b3d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConfigureColorDescriptorForDebugScreen, addr 0x67082e4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureDepthDescriptorForDebugScreen, addr 0x6708300, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x670a17c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x670a710, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x67081a8, size 0xc0, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method HDRDebugViewIsActive, addr 0x6707d60, size 0x30, virtual false, abstract: false, final false
  inline bool HDRDebugViewIsActive(bool resolveFinalTarget);

  /// @brief Method InitDebugFinalValidationPassData, addr 0x67088f0, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method InitDebugSetupPassData, addr 0x6709834, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method IsActiveForCamera, addr 0x6708268, size 0x28, virtual false, abstract: false, final false
  inline bool IsActiveForCamera(bool isPreviewCamera);

  static inline ::UnityEngine::Rendering::Universal::DebugHandler* New_ctor();

  /// @brief Method Render, addr 0x670a0b0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetDebugRenderTarget, addr 0x67088e8, size 0x8, virtual false, abstract: false, final false
  inline void ResetDebugRenderTarget();

  /// @brief Method SetDebugRenderTarget, addr 0x67088c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x6709cac, size 0x4, virtual false, abstract: false, final false
  inline void Setup(::UnityEngine::Rendering::CommandBuffer* cmd, bool isPreviewCamera);

  /// @brief Method Setup, addr 0x670989c, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x6709cb0, size 0x400, virtual false, abstract: false, final false
  inline void Setup(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, bool isPreviewCamera);

  /// @brief Method SetupShaderProperties, addr 0x670831c, size 0x5a8, virtual false, abstract: false, final false
  inline void SetupShaderProperties(::UnityEngine::Rendering::RasterCommandBuffer* cmd, int32_t passIndex);

  /// @brief Method TryGetFullscreenDebugMode, addr 0x6708290, size 0x18, virtual false, abstract: false, final false
  inline bool TryGetFullscreenDebugMode(::ByRef<::UnityEngine::Rendering::Universal::DebugFullScreenMode> debugFullScreenMode);

  /// @brief Method TryGetFullscreenDebugMode, addr 0x67082a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetScreenClearColor, addr 0x6707d1c, size 0x1c, virtual true, abstract: false, final true
  inline bool TryGetScreenClearColor(::ByRef<::UnityEngine::Color> color);

  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x6708e08, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x6708adc, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x6708fb8, size 0x87c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToDebugScreenTexture, addr 0x6707d90, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6707e1c, size 0x384, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AreAnySettingsActive, addr 0x6707c54, size 0x1c, virtual true, abstract: false, final true
  inline bool get_AreAnySettingsActive();

  /// @brief Method get_DebugDisplaySettings, addr 0x6707d40, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplaySettings* get_DebugDisplaySettings();

  /// @brief Method get_DebugScreenColorHandle, addr 0x6707d48, size 0x8, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::RTHandle*> get_DebugScreenColorHandle();

  /// @brief Method get_DebugScreenDepthHandle, addr 0x6707d50, size 0x8, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::RTHandle*> get_DebugScreenDepthHandle();

  /// @brief Method get_IsActiveModeUnsupportedForDeferred, addr 0x6707ca8, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsActiveModeUnsupportedForDeferred();

  /// @brief Method get_IsLightingActive, addr 0x6707c8c, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsLightingActive();

  /// @brief Method get_IsPostProcessingAllowed, addr 0x6707c70, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsPostProcessingAllowed();

  /// @brief Method get_IsRenderPassSupported, addr 0x6707dcc, size 0x2c, virtual false, abstract: false, final false
  inline bool get_IsRenderPassSupported();

  /// @brief Method get_IsScreenClearNeeded, addr 0x6707d94, size 0x38, virtual false, abstract: false, final false
  inline bool get_IsScreenClearNeeded();

  /// @brief Method get_LightingSettings, addr 0x6707c0c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings();

  /// @brief Method get_MaterialSettings, addr 0x6707c24, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings();

  /// @brief Method get_RenderingSettings, addr 0x6707c3c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* get_RenderingSettings();

  /// @brief Method get_ReplacementMaterial, addr 0x6707d38, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_ReplacementMaterial();

  /// @brief Method get_hdrDebugViewPass, addr 0x6707d58, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::HDRDebugViewPass* get_hdrDebugViewPass();

  /// @brief Method get_stpDebugViewIndex, addr 0x6707df8, size 0x24, virtual false, abstract: false, final false
