...
public:
  ...
  /// @brief Method .ctor, addr 0x68488d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x68488d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Setup>b__106_0, addr 0x684bb6c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method <UpdateShaderGlobalPropertiesForFinalValidationPass>b__101_0, addr 0x684bb04, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x684bb00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConfigureColorDescriptorForDebugScreen, addr 0x6848a14, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureDepthDescriptorForDebugScreen, addr 0x6848a30, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x684a8ac, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererListsWithDebugRenderState, addr 0x684ae40, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x68488d8, size 0xc0, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method HDRDebugViewIsActive, addr 0x6848490, size 0x30, virtual false, abstract: false, final false
  inline bool HDRDebugViewIsActive(bool resolveFinalTarget);

  /// @brief Method InitDebugFinalValidationPassData, addr 0x6849020, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method InitDebugSetupPassData, addr 0x6849f64, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method IsActiveForCamera, addr 0x6848998, size 0x28, virtual false, abstract: false, final false
  inline bool IsActiveForCamera(bool isPreviewCamera);

  static inline ::UnityEngine::Rendering::Universal::DebugHandler* New_ctor();

  /// @brief Method Render, addr 0x684a7e0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetDebugRenderTarget, addr 0x6849018, size 0x8, virtual false, abstract: false, final false
  inline void ResetDebugRenderTarget();

  /// @brief Method SetDebugRenderTarget, addr 0x6848ff4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x684a3dc, size 0x4, virtual false, abstract: false, final false
  inline void Setup(::UnityEngine::Rendering::CommandBuffer* cmd, bool isPreviewCamera);

  /// @brief Method Setup, addr 0x6849fcc, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x684a3e0, size 0x400, virtual false, abstract: false, final false
  inline void Setup(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, bool isPreviewCamera);

  /// @brief Method SetupShaderProperties, addr 0x6848a4c, size 0x5a8, virtual false, abstract: false, final false
  inline void SetupShaderProperties(::UnityEngine::Rendering::RasterCommandBuffer* cmd, int32_t passIndex);

  /// @brief Method TryGetFullscreenDebugMode, addr 0x68489c0, size 0x18, virtual false, abstract: false, final false
  inline bool TryGetFullscreenDebugMode(::by_ref<::UnityEngine::Rendering::Universal::DebugFullScreenMode> debugFullScreenMode);

  /// @brief Method TryGetFullscreenDebugMode, addr 0x68489d8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetScreenClearColor, addr 0x684844c, size 0x1c, virtual true, abstract: false, final true
  inline bool TryGetScreenClearColor(::by_ref<::UnityEngine::Color> color);

  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x6849538, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x684920c, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateShaderGlobalPropertiesForFinalValidationPass, addr 0x68496e8, size 0x87c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteToDebugScreenTexture, addr 0x68484c0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x684854c, size 0x384, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AreAnySettingsActive, addr 0x6848384, size 0x1c, virtual true, abstract: false, final true
  inline bool get_AreAnySettingsActive();

  /// @brief Method get_DebugDisplaySettings, addr 0x6848470, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::UniversalRenderPipelineDebugDisplaySettings* get_DebugDisplaySettings();

  /// @brief Method get_DebugScreenColorHandle, addr 0x6848478, size 0x8, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::Rendering::RTHandle*> get_DebugScreenColorHandle();

  /// @brief Method get_DebugScreenDepthHandle, addr 0x6848480, size 0x8, virtual false, abstract: false, final false
  inline ::by_ref<::UnityEngine::Rendering::RTHandle*> get_DebugScreenDepthHandle();

  /// @brief Method get_IsActiveModeUnsupportedForDeferred, addr 0x68483d8, size 0x74, virtual false, abstract: false, final false
  inline bool get_IsActiveModeUnsupportedForDeferred();

  /// @brief Method get_IsLightingActive, addr 0x68483bc, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsLightingActive();

  /// @brief Method get_IsPostProcessingAllowed, addr 0x68483a0, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsPostProcessingAllowed();

  /// @brief Method get_IsRenderPassSupported, addr 0x68484fc, size 0x2c, virtual false, abstract: false, final false
  inline bool get_IsRenderPassSupported();

  /// @brief Method get_IsScreenClearNeeded, addr 0x68484c4, size 0x38, virtual false, abstract: false, final false
  inline bool get_IsScreenClearNeeded();

  /// @brief Method get_LightingSettings, addr 0x684833c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting* get_LightingSettings();

  /// @brief Method get_MaterialSettings, addr 0x6848354, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsMaterial* get_MaterialSettings();

  /// @brief Method get_RenderingSettings, addr 0x684836c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::DebugDisplaySettingsRendering* get_RenderingSettings();

  /// @brief Method get_ReplacementMaterial, addr 0x6848468, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_ReplacementMaterial();

  /// @brief Method get_hdrDebugViewPass, addr 0x6848488, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::Universal::HDRDebugViewPass* get_hdrDebugViewPass();

  /// @brief Method get_stpDebugViewIndex, addr 0x6848528, size 0x24, virtual false, abstract: false, final false
