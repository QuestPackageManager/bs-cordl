...
/// @brief Method DisableProfilingRecorders, addr 0x669ac18, size 0x12c, virtual true, abstract: false, final false
inline void DisableProfilingRecorders() ;

/// @brief Method EnableProfilingRecorders, addr 0x669abc4, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method RegisterDebugUI, addr 0x669ad44, size 0x584, virtual true, abstract: false, final false
inline void RegisterDebugUI(::System::Collections::Generic::List_1<::UnityEngine::Rendering::DebugUI_Widget*>*  list) ;

/// @brief Method Update, addr 0x669b2c8, size 0x64, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method <RegisterDebugUI>b__4_0, addr 0x669b32c, size 0x8, virtual false, abstract: false, final false
inline bool _RegisterDebugUI_b__4_0() ;

/// @brief Method <RegisterDebugUI>b__4_1, addr 0x669b334, size 0x8, virtual false, abstract: false, final false
inline void _RegisterDebugUI_b__4_1(bool  value) ;

/// @brief Method <RegisterDebugUI>b__4_2, addr 0x669b33c, size 0x8, virtual false, abstract: false, final false
inline bool _RegisterDebugUI_b__4_2() ;

/// @brief Method <RegisterDebugUI>b__4_3, addr 0x669b344, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x669a960, size 0xec, virtual false, abstract: false, final false
inline void _ctor() ;
