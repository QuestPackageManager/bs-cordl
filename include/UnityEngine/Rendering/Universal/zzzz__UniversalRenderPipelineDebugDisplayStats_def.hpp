...
public:
  ...
  /// @brief Method DisableProfilingRecorders, addr 0x670cc24, size 0x12c, virtual true, abstract: false, final false
  inline void DisableProfilingRecorders();

  /// @brief Method EnableProfilingRecorders, addr 0x670cbd0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method RegisterDebugUI, addr 0x670cd50, size 0x584, virtual true, abstract: false, final false
  inline void RegisterDebugUI(::System::Collections::Generic::List_1<::UnityEngine::Rendering::DebugUI_Widget*>* list);

  /// @brief Method Update, addr 0x670d2d4, size 0x64, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method <RegisterDebugUI>b__4_0, addr 0x670d338, size 0x8, virtual false, abstract: false, final false
  inline bool _RegisterDebugUI_b__4_0();

  /// @brief Method <RegisterDebugUI>b__4_1, addr 0x670d340, size 0x8, virtual false, abstract: false, final false
  inline void _RegisterDebugUI_b__4_1(bool value);

  /// @brief Method <RegisterDebugUI>b__4_2, addr 0x670d348, size 0x8, virtual false, abstract: false, final false
  inline bool _RegisterDebugUI_b__4_2();

  /// @brief Method <RegisterDebugUI>b__4_3, addr 0x670d350, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670c96c, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
