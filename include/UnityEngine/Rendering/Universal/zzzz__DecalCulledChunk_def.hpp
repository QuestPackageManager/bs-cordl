...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecalCulledChunk", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecalCulledChunk(DecalCulledChunk&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecalCulledChunk", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecalCulledChunk(DecalCulledChunkconst&) = delete;
