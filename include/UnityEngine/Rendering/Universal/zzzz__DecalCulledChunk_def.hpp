...
/// @brief Method Dispose, addr 0x66a8a38, size 0x7c, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::Rendering::Universal::DecalCulledChunk* New_ctor() ;

/// @brief Method RemoveAtSwapBack, addr 0x66a88b0, size 0x9c, virtual true, abstract: false, final false
inline void RemoveAtSwapBack(int32_t  entityIndex) ;

/// @brief Method SetCapacity, addr 0x66a894c, size 0xec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66a5544, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
