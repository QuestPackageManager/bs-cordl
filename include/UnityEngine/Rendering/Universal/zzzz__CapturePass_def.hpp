...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::CapturePass*);
MARK_REF_T(::UnityEngine::Rendering::Universal::CapturePass_UnsafePassData*);
MARK_REF_T(::UnityEngine::Rendering::Universal::CapturePass___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CapturePass*, "UnityEngine.Rendering.Universal", "CapturePass");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CapturePass_UnsafePassData*, "UnityEngine.Rendering.Universal", "CapturePass/UnsafePassData");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::CapturePass___c*, "UnityEngine.Rendering.Universal", "CapturePass/<>c");
...
public:
  ...
  /// @brief Method .ctor, addr 0x687c334, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RecordRenderGraph>b__4_0, addr 0x687c390, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x687c38c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::CapturePass___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Execute, addr 0x687bc0c, size 0x2a0, virtual true, abstract: false, final false
  ...
  /// @brief Method RecordRenderGraph, addr 0x687beac, size 0x488, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x687bb44, size 0xc8, virtual false, abstract: false, final false
