...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::HDRACESPresetParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::HDRACESPresetParameter*, "UnityEngine.Rendering.Universal", "HDRACESPresetParameter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x687fe28, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HDRACESPresetParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HDRACESPresetParameter(HDRACESPresetParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HDRACESPresetParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HDRACESPresetParameter(HDRACESPresetParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::HDRACESPresetParameter) == 0x18, "Size mismatch!");
