...
public:
  ...
  /// @brief Method Dispose, addr 0x67743b4, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6774424, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::Rendering::Universal::ScriptableRendererFeature* New_ctor();

  /// @brief Method OnCameraPreCull, addr 0x67741bc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x67741c4, size 0xe8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x67742ac, size 0xe8, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RequireRenderingLayers, addr 0x677439c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method SetActive, addr 0x67743ac, size 0x8, virtual false, abstract: false, final false
  inline void SetActive(bool active);

  /// @brief Method SetupRenderPasses, addr 0x67741c0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsNativeRenderPass, addr 0x6774394, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6774428, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isActive, addr 0x67741b4, size 0x8, virtual false, abstract: false, final false
