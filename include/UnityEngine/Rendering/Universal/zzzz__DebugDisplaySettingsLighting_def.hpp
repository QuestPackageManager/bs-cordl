...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_SettingsPanel*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_Strings*);
MARK_REF_T(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_WidgetFactory*);
MARK_REF_T(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass0_0*);
MARK_REF_T(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass1_0*);
MARK_REF_T(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass2_0*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting*, "UnityEngine.Rendering.Universal", "DebugDisplaySettingsLighting");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_SettingsPanel*, "UnityEngine.Rendering.Universal", "DebugDisplaySettingsLighting/SettingsPanel");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_Strings*, "UnityEngine.Rendering.Universal", "DebugDisplaySettingsLighting/Strings");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_WidgetFactory*, "UnityEngine.Rendering.Universal", "DebugDisplaySettingsLighting/WidgetFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass0_0*, "UnityEngine.Rendering.Universal",
                    "DebugDisplaySettingsLighting/WidgetFactory/<>c__DisplayClass0_0");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass1_0*, "UnityEngine.Rendering.Universal",
                    "DebugDisplaySettingsLighting/WidgetFactory/<>c__DisplayClass1_0");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass2_0*, "UnityEngine.Rendering.Universal",
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::WidgetFactory_DebugDisplaySettingsLighting___c__DisplayClass2_0) == 0x18, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting_SettingsPanel) == 0x28, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::Universal::DebugDisplaySettingsLighting) == 0x20, "Size mismatch!");
