...
/// @brief Field m_historyContexts, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_historyContexts, put=__cordl_internal_set_m_historyContexts)) ::ArrayW<::UnityEngine::Rendering::STP_HistoryContext*,::Array<::UnityEngine::Rendering::STP_HistoryContext*>*>  m_historyContexts;

/// @brief Method GetHistoryContext, addr 0x66c0fac, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method OnCreate, addr 0x66c0e98, size 0xb4, virtual true, abstract: false, final false
inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem*  owner, uint32_t  typeId) ;

/// @brief Method Reset, addr 0x66c0f4c, size 0x60, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x66c0fdc, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c10a8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
