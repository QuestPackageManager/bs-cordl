...
public:
  ...
  /// @brief Method GetHistoryContext, addr 0x6732fb8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCreate, addr 0x6732ea4, size 0xb4, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method Reset, addr 0x6732f58, size 0x60, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x6732fe8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67330b4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
