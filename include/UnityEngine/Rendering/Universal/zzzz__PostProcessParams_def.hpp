...
public:
// Declarations
/// @brief Method Create, addr 0x66f33c0, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "blitMaterial", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "requestColorFormat", ty: "::UnityEngine::Experimental::Rendering::GraphicsFormat", modifiers: "", def_value: None }]
