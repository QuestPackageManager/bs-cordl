...
/// @brief Method Dispose, addr 0x66f3638, size 0x64, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Recreate, addr 0x66f3470, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method ReleaseRenderTargets, addr 0x66f369c, size 0x54, virtual false, abstract: false, final false
inline void ReleaseRenderTargets() ;

/// @brief Method .ctor, addr 0x66f3458, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_afterPostProcessColor, addr 0x66f33e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_afterPostProcessColor() ;

/// @brief Method get_colorGradingLut, addr 0x66f33ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_colorGradingLut() ;

/// @brief Method get_colorGradingLutPass, addr 0x66f33cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::Internal::ColorGradingLutPass* get_colorGradingLutPass() ;

/// @brief Method get_finalPostProcessPass, addr 0x66f33dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::Universal::PostProcessPass* get_finalPostProcessPass() ;

/// @brief Method get_isCreated, addr 0x66f33f4, size 0x64, virtual false, abstract: false, final false
inline bool get_isCreated() ;

/// @brief Method get_postProcessPass, addr 0x66f33d4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_ColorGradingLutPass", ty: "::UnityEngine::Rendering::Universal::Internal::ColorGradingLutPass*", modifiers: "", def_value: None }, CppParam { name: "m_PostProcessPass", ty: "::UnityEngine::Rendering::Universal::PostProcessPass*", modifiers: "", def_value: None }, CppParam { name: "m_FinalPostProcessPass", ty: "::UnityEngine::Rendering::Universal::PostProcessPass*", modifiers: "", def_value: None }, CppParam { name: "m_AfterPostProcessColor", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: None }, CppParam { name: "m_ColorGradingLut", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: None }, CppParam { name: "m_RendererPostProcessData", ty: "::UnityW<::UnityEngine::Rendering::Universal::PostProcessData>", modifiers: "", def_value: None }, CppParam { name: "m_CurrentPostProcessData", ty: "::UnityW<::UnityEngine::Rendering::Universal::PostProcessData>", modifiers: "", def_value: None }, CppParam { name: "m_BlitMaterial", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }]
constexpr PostProcessPasses(::UnityEngine::Rendering::Universal::Internal::ColorGradingLutPass*  m_ColorGradingLutPass, ::UnityEngine::Rendering::Universal::PostProcessPass*  m_PostProcessPass, ::UnityEngine::Rendering::Universal::PostProcessPass*  m_FinalPostProcessPass, ::UnityEngine::Rendering::RTHandle*  m_AfterPostProcessColor, ::UnityEngine::Rendering::RTHandle*  m_ColorGradingLut, ::UnityW<::UnityEngine::Rendering::Universal::PostProcessData>  m_RendererPostProcessData, ::UnityW<::UnityEngine::Rendering::Universal::PostProcessData>  m_CurrentPostProcessData, ::UnityW<::UnityEngine::Material>  m_BlitMaterial) noexcept;
