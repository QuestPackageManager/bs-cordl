...
public:
  ...
  /// @brief Method .ctor, addr 0x67c8140, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SceneRenderPipeline", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SceneRenderPipeline(SceneRenderPipeline&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SceneRenderPipeline", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SceneRenderPipeline(SceneRenderPipelineconst&) = delete;
