...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x69d3e84, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__34_0, addr 0x69d3ef0, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method <.cctor>b__34_1, addr 0x69d4150, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69d3eec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClassifyMaterials, addr 0x69d3c10, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ClassifyMaterialsImpl, addr 0x69d3a30, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ClassifyMaterialsImpl_Injected, addr 0x69d3bb4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearMaterialFilters, addr 0x69d3960, size 0x94, virtual false, abstract: false, final false
  inline void ClearMaterialFilters();

  /// @brief Method ClearMaterialFilters_Injected, addr 0x69d39f4, size 0x3c, virtual false, abstract: false, final false
  static inline void ClearMaterialFilters_Injected(::System::IntPtr _unity_self);

  /// @brief Method Destroy, addr 0x69d314c, size 0x88, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method DisableGPUDrivenRendering, addr 0x69d3554, size 0xf0, virtual false, abstract: false, final false
  inline void DisableGPUDrivenRendering(::System::ReadOnlySpan_1<int32_t> renderersID);

  /// @brief Method DisableGPUDrivenRendering_Injected, addr 0x69d3644, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData, addr 0x69d37ec, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData, addr 0x69d3688, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData_Injected, addr 0x69d3790, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x69d31d4, size 0x68, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData, addr 0x69d342c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData, addr 0x69d3278, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData_Injected, addr 0x69d33a8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x69d3108, size 0x44, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x69d30e0, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x69d323c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69d2fd4, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_scratchMaterials, addr 0x69d2fc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>* get_scratchMaterials();

  /// @brief Method get_scratchMeshes, addr 0x69d2fb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enablePartialRendering, addr 0x69d3878, size 0xa4, virtual false, abstract: false, final false
  inline void set_enablePartialRendering(bool value);

  /// @brief Method set_enablePartialRendering_Injected, addr 0x69d391c, size 0x44, virtual false, abstract: false, final false
  static inline void set_enablePartialRendering_Injected(::System::IntPtr _unity_self, bool value);

  /// @brief Method set_scratchMaterials, addr 0x69d2fcc, size 0x8, virtual false, abstract: false, final false
  inline void set_scratchMaterials(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>* value);

  /// @brief Method set_scratchMeshes, addr 0x69d2fbc, size 0x8, virtual false, abstract: false, final false
