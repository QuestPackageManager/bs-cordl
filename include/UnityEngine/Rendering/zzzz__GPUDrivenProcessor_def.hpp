...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x68f86f8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__34_0, addr 0x68f8764, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method <.cctor>b__34_1, addr 0x68f89c4, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f8760, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClassifyMaterials, addr 0x68f8484, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ClassifyMaterialsImpl, addr 0x68f82a4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ClassifyMaterialsImpl_Injected, addr 0x68f8428, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearMaterialFilters, addr 0x68f81d4, size 0x94, virtual false, abstract: false, final false
  inline void ClearMaterialFilters();

  /// @brief Method ClearMaterialFilters_Injected, addr 0x68f8268, size 0x3c, virtual false, abstract: false, final false
  static inline void ClearMaterialFilters_Injected(::System::IntPtr _unity_self);

  /// @brief Method Destroy, addr 0x68f79c0, size 0x88, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method DisableGPUDrivenRendering, addr 0x68f7dc8, size 0xf0, virtual false, abstract: false, final false
  inline void DisableGPUDrivenRendering(::System::ReadOnlySpan_1<int32_t> renderersID);

  /// @brief Method DisableGPUDrivenRendering_Injected, addr 0x68f7eb8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData, addr 0x68f8060, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData, addr 0x68f7efc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchLODGroupData_Injected, addr 0x68f8004, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x68f7a48, size 0x68, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData, addr 0x68f7ca0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData, addr 0x68f7aec, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method EnableGPUDrivenRenderingAndDispatchRendererData_Injected, addr 0x68f7c1c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x68f797c, size 0x44, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x68f7954, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create();

  /// @brief Method Internal_Destroy, addr 0x68f7ab0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f7848, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_scratchMaterials, addr 0x68f7838, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>* get_scratchMaterials();

  /// @brief Method get_scratchMeshes, addr 0x68f7828, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enablePartialRendering, addr 0x68f80ec, size 0xa4, virtual false, abstract: false, final false
  inline void set_enablePartialRendering(bool value);

  /// @brief Method set_enablePartialRendering_Injected, addr 0x68f8190, size 0x44, virtual false, abstract: false, final false
  static inline void set_enablePartialRendering_Injected(::System::IntPtr _unity_self, bool value);

  /// @brief Method set_scratchMaterials, addr 0x68f7840, size 0x8, virtual false, abstract: false, final false
  inline void set_scratchMaterials(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>* value);

  /// @brief Method set_scratchMeshes, addr 0x68f7830, size 0x8, virtual false, abstract: false, final false
