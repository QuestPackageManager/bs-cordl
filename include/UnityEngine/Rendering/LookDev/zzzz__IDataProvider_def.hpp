...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::LookDev::IDataProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LookDev::IDataProvider*, "UnityEngine.Rendering.LookDev", "IDataProvider");
// Dependencies
namespace UnityEngine::Rendering::LookDev {
// Is value type: false
