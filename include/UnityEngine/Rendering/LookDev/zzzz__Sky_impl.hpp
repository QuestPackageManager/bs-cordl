...
// Ctor Parameters [CppParam { name: "cubemap", ty: "::UnityW<::UnityEngine::Cubemap>", modifiers: "", def_value: Some("{}") }, CppParam { name: "longitudeOffset", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "exposure", ty: "float_t", modifiers: "", def_value: Some("{}") }]
