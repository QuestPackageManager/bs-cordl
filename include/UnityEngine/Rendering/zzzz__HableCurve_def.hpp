...
/// @brief Method Eval, addr 0x660e214, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x660e158, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "x0", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "y0", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "x1", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "y1", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "W", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "overshootX", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "overshootY", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "gamma", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Method .ctor, addr 0x660e15c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::HableCurve*  parent) ;

/// @brief Method get_curve, addr 0x660e724, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_curve() ;

/// @brief Method get_midSegmentA, addr 0x660e7c0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_midSegmentA() ;

/// @brief Method get_midSegmentB, addr 0x660e800, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_midSegmentB() ;

/// @brief Method get_shoSegmentA, addr 0x660e844, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_shoSegmentA() ;

/// @brief Method get_shoSegmentB, addr 0x660e884, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_shoSegmentB() ;

/// @brief Method get_toeSegmentA, addr 0x660e744, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_toeSegmentA() ;

/// @brief Method get_toeSegmentB, addr 0x660e780, size 0x40, virtual false, abstract: false, final false
...
/// @brief Field segments, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_segments, put=__cordl_internal_set_segments)) ::ArrayW<::UnityEngine::Rendering::HableCurve_Segment*,::Array<::UnityEngine::Rendering::HableCurve_Segment*>*>  segments;
...
/// @brief Method AsSlopeIntercept, addr 0x660e66c, size 0x2c, virtual false, abstract: false, final false
inline void AsSlopeIntercept(::ByRef<float_t>  m, ::ByRef<float_t>  b, float_t  x0, float_t  x1, float_t  y0, float_t  y1) ;

/// @brief Method Eval, addr 0x660e164, size 0xb0, virtual false, abstract: false, final false
inline float_t Eval(float_t  x) ;

/// @brief Method EvalDerivativeLinearGamma, addr 0x660e698, size 0x3c, virtual false, abstract: false, final false
inline float_t EvalDerivativeLinearGamma(float_t  m, float_t  b, float_t  g, float_t  x) ;

/// @brief Method Init, addr 0x660e274, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method InitSegments, addr 0x660e3b0, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method SolveAB, addr 0x660e6d4, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x660e044, size 0x114, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_inverseWhitePoint, addr 0x660e014, size 0x8, virtual false, abstract: false, final false
inline float_t get_inverseWhitePoint() ;

/// @brief Method get_whitePoint, addr 0x660e004, size 0x8, virtual false, abstract: false, final false
inline float_t get_whitePoint() ;

/// @brief Method get_x0, addr 0x660e024, size 0x8, virtual false, abstract: false, final false
inline float_t get_x0() ;

/// @brief Method get_x1, addr 0x660e034, size 0x8, virtual false, abstract: false, final false
inline float_t get_x1() ;

/// @brief Method set_inverseWhitePoint, addr 0x660e01c, size 0x8, virtual false, abstract: false, final false
inline void set_inverseWhitePoint(float_t  value) ;

/// @brief Method set_whitePoint, addr 0x660e00c, size 0x8, virtual false, abstract: false, final false
inline void set_whitePoint(float_t  value) ;

/// @brief Method set_x0, addr 0x660e02c, size 0x8, virtual false, abstract: false, final false
inline void set_x0(float_t  value) ;

/// @brief Method set_x1, addr 0x660e03c, size 0x8, virtual false, abstract: false, final false
