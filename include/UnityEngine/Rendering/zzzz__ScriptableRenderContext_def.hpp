...
public:
  ...
  /// @brief Method BeginRenderPass, addr 0x68f2a90, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginRenderPass_Internal, addr 0x68f1678, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginSubPass, addr 0x68f2b6c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginSubPass, addr 0x68f2c40, size 0xc4, virtual false, abstract: false, final false
  inline void BeginSubPass(::Unity::Collections::NativeArray_1<int32_t> colors, bool isDepthStencilReadOnly);

  /// @brief Method BeginSubPass_Internal, addr 0x68f1704, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGizmoRendererList, addr 0x68f3b24, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGizmoRendererList_Internal, addr 0x68f2544, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGizmoRendererList_Internal_Injected, addr 0x68f2658, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x68f3524, size 0x128, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateRendererList(::ByRef<::UnityEngine::Rendering::RendererListParams> param);

  /// @brief Method CreateRendererList_Internal, addr 0x68f20c4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList_Internal_Injected, addr 0x68f21c8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShadowRendererList, addr 0x68f364c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShadowRendererList_Internal, addr 0x68f226c, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateShadowRendererList_Internal(::System::IntPtr shadowDrawinSettings);

  /// @brief Method CreateShadowRendererList_Internal_Injected, addr 0x68f2320, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x68f39b4, size 0x170, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateSkyboxRendererList(::UnityEngine::Camera* camera);

  /// @brief Method CreateSkyboxRendererList, addr 0x68f3838, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x68f36e0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList_Internal, addr 0x68f2374, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList_Internal_Injected, addr 0x68f24b8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList, addr 0x68f3bc4, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateUIOverlayRendererList(::UnityEngine::Camera* camera);

  /// @brief Method CreateUIOverlayRendererList, addr 0x68f3c5c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList_Internal, addr 0x68f26b4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList_Internal_Injected, addr 0x68f27c8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWireOverlayRendererList, addr 0x68f3cfc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateWireOverlayRendererList(::UnityEngine::Camera* camera);

  /// @brief Method CreateWireOverlayRendererList_Internal, addr 0x68f2824, size 0x108, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererList CreateWireOverlayRendererList_Internal(::UnityEngine::Camera* camera);

  /// @brief Method CreateWireOverlayRendererList_Internal_Injected, addr 0x68f292c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Cull, addr 0x68f329c, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CullingResults Cull(::ByRef<::UnityEngine::Rendering::ScriptableCullingParameters> parameters);

  /// @brief Method CullShadowCasters, addr 0x68f3320, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawWireOverlay, addr 0x68f3234, size 0x68, virtual false, abstract: false, final false
  inline void DrawWireOverlay(::UnityEngine::Camera* camera);

  /// @brief Method DrawWireOverlay_Impl, addr 0x68f1f9c, size 0xdc, virtual false, abstract: false, final false
  inline void DrawWireOverlay_Impl(::UnityEngine::Camera* camera);

  /// @brief Method DrawWireOverlay_Impl_Injected, addr 0x68f2078, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method EmitGeometryForCamera, addr 0x68f1ba8, size 0xa8, virtual false, abstract: false, final false
  static inline void EmitGeometryForCamera(::UnityEngine::Camera* camera);

  /// @brief Method EmitGeometryForCamera_Injected, addr 0x68f1c50, size 0x3c, virtual false, abstract: false, final false
  static inline void EmitGeometryForCamera_Injected(::System::IntPtr camera);

  /// @brief Method EndRenderPass, addr 0x68f2d80, size 0x7c, virtual false, abstract: false, final false
  inline void EndRenderPass();

  /// @brief Method EndRenderPass_Internal, addr 0x68f17c4, size 0x3c, virtual false, abstract: false, final false
  static inline void EndRenderPass_Internal(::System::IntPtr self);

  /// @brief Method EndSubPass, addr 0x68f2d04, size 0x7c, virtual false, abstract: false, final false
  inline void EndSubPass();

  /// @brief Method EndSubPass_Internal, addr 0x68f1788, size 0x3c, virtual false, abstract: false, final false
  static inline void EndSubPass_Internal(::System::IntPtr self);

  /// @brief Method Equals, addr 0x68f3440, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x68f33e8, size 0x58, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ScriptableRenderContext other);

  /// @brief Method ExecuteCommandBuffer, addr 0x68f2f58, size 0xf0, virtual false, abstract: false, final false
  inline void ExecuteCommandBuffer(::UnityEngine::Rendering::CommandBuffer* commandBuffer);

  /// @brief Method ExecuteCommandBufferAsync, addr 0x68f3048, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCommandBufferAsync_Internal, addr 0x68f1d60, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCommandBufferAsync_Internal_Injected, addr 0x68f1df8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCommandBuffer_Internal, addr 0x68f1c8c, size 0x90, virtual false, abstract: false, final false
  inline void ExecuteCommandBuffer_Internal(::UnityEngine::Rendering::CommandBuffer* commandBuffer);

  /// @brief Method ExecuteCommandBuffer_Internal_Injected, addr 0x68f1d1c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCameras, addr 0x68f00a8, size 0xd0, virtual false, abstract: false, final false
  inline void GetCameras(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Camera>>* results);

  /// @brief Method GetCameras_Internal, addr 0x68f1b54, size 0x54, virtual false, abstract: false, final false
  inline void GetCameras_Internal(::System::Type* listType, ::System::Object* resultList);

  /// @brief Method GetHashCode, addr 0x68f351c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasInvokeOnRenderObjectCallbacks, addr 0x68f2eec, size 0x6c, virtual false, abstract: false, final false
  inline bool HasInvokeOnRenderObjectCallbacks();

  /// @brief Method HasInvokeOnRenderObjectCallbacks_Internal, addr 0x68f1800, size 0x28, virtual false, abstract: false, final false
  static inline bool HasInvokeOnRenderObjectCallbacks_Internal();

  /// @brief Method InitializeSortSettings, addr 0x68f19e0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeSortSettings_Injected, addr 0x68f1a98, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Cull, addr 0x68f1828, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CullShadowCasters, addr 0x68f1910, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CullShadowCasters_Injected, addr 0x68f199c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Cull_Injected, addr 0x68f18bc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetPtr, addr 0x68f20bc, size 0x8, virtual false, abstract: false, final false
  inline ::System::IntPtr Internal_GetPtr();

  /// @brief Method PrepareRendererListsAsync, addr 0x68f3d90, size 0x88, virtual false, abstract: false, final false
  inline void PrepareRendererListsAsync(::System::Collections::Generic::List_1<::UnityEngine::Rendering::RendererList>* rendererLists);

  /// @brief Method PrepareRendererListsAsync_Internal, addr 0x68f2980, size 0x44, virtual false, abstract: false, final false
  inline void PrepareRendererListsAsync_Internal(::System::Object* rendererLists);

  /// @brief Method QueryRendererListStatus, addr 0x68f3e18, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RendererListStatus QueryRendererListStatus(::UnityEngine::Rendering::RendererList rendererList);

  /// @brief Method QueryRendererListStatus_Internal, addr 0x68f29c4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryRendererListStatus_Internal_Injected, addr 0x68f2a4c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupCameraProperties, addr 0x68f3140, size 0x74, virtual false, abstract: false, final false
  inline void SetupCameraProperties(::UnityEngine::Camera* camera, bool stereoSetup);

  /// @brief Method SetupCameraProperties, addr 0x68f31b4, size 0x80, virtual false, abstract: false, final false
  inline void SetupCameraProperties(::UnityEngine::Camera* camera, bool stereoSetup, int32_t eye);

  /// @brief Method SetupCameraProperties_Internal, addr 0x68f1e4c, size 0xf4, virtual false, abstract: false, final false
  inline void SetupCameraProperties_Internal(::UnityEngine::Camera* camera, bool stereoSetup, int32_t eye);

  /// @brief Method SetupCameraProperties_Internal_Injected, addr 0x68f1f40, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Submit, addr 0x68f2dfc, size 0x78, virtual false, abstract: false, final false
  inline void Submit();

  /// @brief Method SubmitForRenderPassValidation, addr 0x68f2e74, size 0x78, virtual false, abstract: false, final false
  inline bool SubmitForRenderPassValidation();

  /// @brief Method SubmitForRenderPassValidation_Internal, addr 0x68f1b18, size 0x3c, virtual false, abstract: false, final false
  inline bool SubmitForRenderPassValidation_Internal();

  /// @brief Method Submit_Internal, addr 0x68f1adc, size 0x3c, virtual false, abstract: false, final false
  inline void Submit_Internal();

  /// @brief Method .ctor, addr 0x68f00a0, size 0x8, virtual false, abstract: false, final false
