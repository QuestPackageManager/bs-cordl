...
/// @brief Method .ctor, addr 0x65dfe74, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_version, addr 0x65dfe6c, size 0x8, virtual true, abstract: false, final true
