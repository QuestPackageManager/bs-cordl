...
public:
  ...
  /// @brief Method .ctor, addr 0x679691c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_version, addr 0x6796914, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeDebugResources) == 0x48, "Size mismatch!");
