...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SplashScreen", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SplashScreen(SplashScreen&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SplashScreen", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SplashScreen(SplashScreenconst&) = delete;
