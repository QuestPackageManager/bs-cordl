...
public:
  ...
  /// @brief Method GetHashCode, addr 0x67cd7f4, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cd77c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture* value, ::UnityEngine::Rendering::TextureDimension dimension, bool overrideState);

  /// @brief Method .ctor, addr 0x67cd770, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextureParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextureParameter(TextureParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextureParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextureParameter(TextureParameterconst&) = delete;
