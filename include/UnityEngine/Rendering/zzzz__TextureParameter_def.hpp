...
/// @brief Method GetHashCode, addr 0x6616d4c, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6616cd4, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  value, ::UnityEngine::Rendering::TextureDimension  dimension, bool  overrideState) ;

/// @brief Method .ctor, addr 0x6616cc8, size 0xc, virtual false, abstract: false, final false
