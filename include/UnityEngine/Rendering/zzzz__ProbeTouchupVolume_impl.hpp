...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::ProbeTouchupVolume::*)()>(&::UnityEngine::Rendering::ProbeTouchupVolume::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x65b8cd4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ProbeTouchupVolume*>::get(), ".ctor",
...
inline ::UnityEngine::Rendering::ProbeTouchupVolume* UnityEngine::Rendering::ProbeTouchupVolume::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::ProbeTouchupVolume*>());
}
// Ctor Parameters []
