...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IProbeVolumeEnabledRenderPipeline*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IProbeVolumeEnabledRenderPipeline*, "UnityEngine.Rendering", "IProbeVolumeEnabledRenderPipeline");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
  ...
  /// @brief Method get_maxSHBands, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::UnityEngine::Rendering::ProbeVolumeSHBands get_maxSHBands();

  /// @brief Method get_probeVolumeSceneData, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::UnityEngine::Rendering::ProbeVolumeSceneData* get_probeVolumeSceneData();

  /// @brief Method get_supportProbeVolume, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool get_supportProbeVolume();

  // Ctor Parameters [CppParam { name: "", ty: "IProbeVolumeEnabledRenderPipeline", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IProbeVolumeEnabledRenderPipeline(IProbeVolumeEnabledRenderPipelineconst&) = delete;
