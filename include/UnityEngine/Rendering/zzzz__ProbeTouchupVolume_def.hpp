...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProbeTouchupVolume", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProbeTouchupVolume(ProbeTouchupVolume&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProbeTouchupVolume", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProbeTouchupVolume(ProbeTouchupVolumeconst&) = delete;
