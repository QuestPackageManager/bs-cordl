...
public:
  ...
  /// @brief Method ToString, addr 0x6b05ae8, size 0x298, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b05a48, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t indexStart, int32_t indexCount, ::UnityEngine::MeshTopology topology);

  /// @brief Method get_baseVertex, addr 0x6b05ab8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_baseVertex();

  /// @brief Method get_bounds, addr 0x6b05a60, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_bounds();

  /// @brief Method get_firstVertex, addr 0x6b05ac8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_firstVertex();

  /// @brief Method get_indexCount, addr 0x6b05aa8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_indexCount();

  /// @brief Method get_indexStart, addr 0x6b05a98, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_indexStart();

  /// @brief Method get_topology, addr 0x6b05a88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::MeshTopology get_topology();

  /// @brief Method get_vertexCount, addr 0x6b05ad8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_vertexCount();

  /// @brief Method set_baseVertex, addr 0x6b05ac0, size 0x8, virtual false, abstract: false, final false
  inline void set_baseVertex(int32_t value);

  /// @brief Method set_bounds, addr 0x6b05a74, size 0x14, virtual false, abstract: false, final false
  inline void set_bounds(::UnityEngine::Bounds value);

  /// @brief Method set_firstVertex, addr 0x6b05ad0, size 0x8, virtual false, abstract: false, final false
  inline void set_firstVertex(int32_t value);

  /// @brief Method set_indexCount, addr 0x6b05ab0, size 0x8, virtual false, abstract: false, final false
  inline void set_indexCount(int32_t value);

  /// @brief Method set_indexStart, addr 0x6b05aa0, size 0x8, virtual false, abstract: false, final false
  inline void set_indexStart(int32_t value);

  /// @brief Method set_topology, addr 0x6b05a90, size 0x8, virtual false, abstract: false, final false
  inline void set_topology(::UnityEngine::MeshTopology value);

  /// @brief Method set_vertexCount, addr 0x6b05ae0, size 0x8, virtual false, abstract: false, final false
