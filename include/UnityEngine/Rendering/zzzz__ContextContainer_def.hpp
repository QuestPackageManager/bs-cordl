...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ContextContainer*);
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::ContextContainer_TypeId_1);
MARK_VAL_T(::UnityEngine::Rendering::ContextContainer_Item);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ContextContainer*, "UnityEngine.Rendering", "ContextContainer");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ContextContainer_TypeId_1, "UnityEngine.Rendering", "ContextContainer/TypeId`1");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ContextContainer_Item, "UnityEngine.Rendering", "ContextContainer/Item");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_Items, put = __cordl_internal_set_m_Items)) ::ArrayW<::UnityEngine::Rendering::ContextContainer_Item> m_Items;
  ...
  /// @brief Method Contains, addr 0x6750bf8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6750c44, size 0x17c, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  constexpr ::ArrayW<::UnityEngine::Rendering::ContextContainer_Item> const& __cordl_internal_get_m_Items() const;

  constexpr ::ArrayW<::UnityEngine::Rendering::ContextContainer_Item>& __cordl_internal_get_m_Items();
  ...
  /// @brief Method .ctor, addr 0x6750dc0, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::ContextContainer) == 0x20, "Size mismatch!");
