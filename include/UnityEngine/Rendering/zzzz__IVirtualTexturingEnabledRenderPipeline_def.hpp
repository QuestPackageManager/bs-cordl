...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IVirtualTexturingEnabledRenderPipeline*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IVirtualTexturingEnabledRenderPipeline*, "UnityEngine.Rendering", "IVirtualTexturingEnabledRenderPipeline");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IVirtualTexturingEnabledRenderPipeline", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVirtualTexturingEnabledRenderPipeline(IVirtualTexturingEnabledRenderPipelineconst&) = delete;
