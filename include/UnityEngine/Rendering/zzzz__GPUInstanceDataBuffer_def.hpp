...
public:
// Declarations
/// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x666a2c0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method CPUInstanceToGPUInstance, addr 0x666a2b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method .ctor, addr 0x666a29c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x666a388, size 0x30, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "instancesNumPrefixSum", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "gpuInstanceIndices", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>", modifiers: "", def_value: None }]
...
/// @brief Method AsReadOnly, addr 0x666a284, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly AsReadOnly() ;

/// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x666a008, size 0xc8, virtual false, abstract: false, final false
inline void CPUInstanceArrayToGPUInstanceArray(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>  gpuInstanceIndices) ;

/// @brief Method CPUInstanceToGPUInstance, addr 0x6669eac, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method CPUInstanceToGPUInstance, addr 0x6669bb4, size 0x108, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::ByRef<::Unity::Collections::NativeArray_1<int32_t>>  instancesNumPrefixSum, ::UnityEngine::Rendering::InstanceHandle  instance) ;

/// @brief Method Dispose, addr 0x666a0d0, size 0x1b4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GPUInstanceToCPUInstance, addr 0x6669eb8, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetGpuAddress, addr 0x6669e84, size 0x28, virtual false, abstract: false, final false
inline int32_t GetGpuAddress(int32_t  propertyID, bool  assertOnFail) ;

/// @brief Method GetGpuAddress, addr 0x6669e48, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetGpuAddress(::StringW  strName, bool  assertOnFail) ;

/// @brief Method GetPropertyIndex, addr 0x6669dd4, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method NextVersion, addr 0x6669b14, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x666a2b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF_s_NextLayoutVersion() ;

/// @brief Method get_valid, addr 0x6669b68, size 0x4c, virtual false, abstract: false, final false
