...
public:
  // Declarations
  /// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x66dc2cc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method CPUInstanceToGPUInstance, addr 0x66dc2c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method .ctor, addr 0x66dc2a8, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x66dc394, size 0x30, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AsReadOnly, addr 0x66dc290, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly AsReadOnly();

  /// @brief Method CPUInstanceArrayToGPUInstanceArray, addr 0x66dc014, size 0xc8, virtual false, abstract: false, final false
  inline void CPUInstanceArrayToGPUInstanceArray(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle> instances,
                                                 ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex> gpuInstanceIndices);

  /// @brief Method CPUInstanceToGPUInstance, addr 0x66dbeb8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::GPUInstanceIndex CPUInstanceToGPUInstance(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method CPUInstanceToGPUInstance, addr 0x66dbbc0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66dc0dc, size 0x1b4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GPUInstanceToCPUInstance, addr 0x66dbec4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGpuAddress, addr 0x66dbe90, size 0x28, virtual false, abstract: false, final false
  inline int32_t GetGpuAddress(int32_t propertyID, bool assertOnFail);

  /// @brief Method GetGpuAddress, addr 0x66dbe54, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetGpuAddress(::StringW strName, bool assertOnFail);

  /// @brief Method GetPropertyIndex, addr 0x66dbde0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method NextVersion, addr 0x66dbb20, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66dc2c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF_s_NextLayoutVersion();

  /// @brief Method get_valid, addr 0x66dbb74, size 0x4c, virtual false, abstract: false, final false
