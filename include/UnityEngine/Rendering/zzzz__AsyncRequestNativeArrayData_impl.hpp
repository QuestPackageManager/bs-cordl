...
// Ctor Parameters [CppParam { name: "nativeArrayBuffer", ty: "void*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lengthInBytes", ty: "int64_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
