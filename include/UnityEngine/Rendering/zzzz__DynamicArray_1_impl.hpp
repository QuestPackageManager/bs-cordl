...
// Ctor Parameters [CppParam { name: "owner", ty: "::UnityEngine::Rendering::DynamicArray_1<T>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "index", ty: "int32_t",
...
// Ctor Parameters [CppParam { name: "owner", ty: "::UnityEngine::Rendering::DynamicArray_1<T>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "index", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "first", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "last", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::default_constructor_constraint<T>)
...
// Ctor Parameters [CppParam { name: "iterator", ty: "::UnityEngine::Rendering::RangeEnumerable_DynamicArray_1_RangeIterator<T>", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::default_constructor_constraint<T>)
...
template <typename T>
  requires(::cordl_internals::default_constructor_constraint<T>)
inline int32_t UnityEngine::Rendering::DynamicArray_1<T>::Add(/* [IsReadOnly] */ ::by_ref<T> value) {
  static auto* ___internal_method =
