...
public:
  ...
  /// @brief Method .ctor, addr 0x668b64c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enabled, addr 0x668b0a8, size 0x28, virtual false, abstract: false, final false
  static inline bool get_enabled();

  /// @brief Method get_eyeTextureDesc, addr 0x668b234, size 0xd4, virtual false, abstract: false, final false
  static inline ::UnityEngine::RenderTextureDescriptor get_eyeTextureDesc();

  /// @brief Method get_eyeTextureHeight, addr 0x668b360, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_eyeTextureHeight();

  /// @brief Method get_eyeTextureWidth, addr 0x668b308, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_eyeTextureWidth();

  /// @brief Method get_isDeviceActive, addr 0x668b0d0, size 0x58, virtual false, abstract: false, final false
  static inline bool get_isDeviceActive();

  /// @brief Method get_loadedDeviceName, addr 0x668b128, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW get_loadedDeviceName();

  /// @brief Method get_mirrorViewMode, addr 0x668b538, size 0x88, virtual false, abstract: false, final false
  static inline int32_t get_mirrorViewMode();

  /// @brief Method get_occlusionMeshScale, addr 0x668b3b8, size 0xbc, virtual false, abstract: false, final false
  static inline float_t get_occlusionMeshScale();

  /// @brief Method get_supportedDevices, addr 0x668b1a0, size 0x94, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> get_supportedDevices();

  /// @brief Method set_mirrorViewMode, addr 0x668b5c0, size 0x8c, virtual false, abstract: false, final false
  static inline void set_mirrorViewMode(int32_t value);

  /// @brief Method set_occlusionMeshScale, addr 0x668b474, size 0xc4, virtual false, abstract: false, final false
