...
public:
  ...
  /// @brief Method Equals, addr 0x6b2169c, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b1aa88, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetBlendState other);

  /// @brief Method GetHashCode, addr 0x6b1ae4c, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6b21678, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultValue, addr 0x6b1a9b4, size 0xc, virtual false, abstract: false, final false
