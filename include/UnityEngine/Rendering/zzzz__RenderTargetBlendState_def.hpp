...
public:
  ...
  /// @brief Method Equals, addr 0x6b24c24, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b1dea4, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetBlendState other);

  /// @brief Method GetHashCode, addr 0x6b1e268, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x6b24c00, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultValue, addr 0x6b1ddd0, size 0xc, virtual false, abstract: false, final false
