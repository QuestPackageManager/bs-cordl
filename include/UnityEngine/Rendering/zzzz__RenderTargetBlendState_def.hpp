...
public:
  ...
  /// @brief Method Equals, addr 0x69cc1e8, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c55d4, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetBlendState other);

  /// @brief Method GetHashCode, addr 0x69c5998, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69cc1c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultValue, addr 0x69c5500, size 0xc, virtual false, abstract: false, final false
