...
// Ctor Parameters [CppParam { name: "drawCommands", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::BatchCullingOutputDrawCommands>", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "customCullingResult", ty: "::Unity::Collections::NativeArray_1<::System::IntPtr>", modifiers: "", def_value: Some("{}"), comment: None }]
