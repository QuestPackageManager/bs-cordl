...
public:
  ...
  /// @brief Method Equals, addr 0x69c8f74, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c8e74, size 0xd8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::FilteringSettings other);

  /// @brief Method GetHashCode, addr 0x69c9000, size 0x98, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69c8d4c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderQueueRange, addr 0x69c8e4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69c90ac, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method set_batchLayerMask, addr 0x69c8e54, size 0x8, virtual false, abstract: false, final false
  inline void set_batchLayerMask(uint32_t value);

  /// @brief Method set_excludeMotionVectorObjects, addr 0x69c8e5c, size 0xc, virtual false, abstract: false, final false
  inline void set_excludeMotionVectorObjects(bool value);

  /// @brief Method set_forceAllMotionVectorObjects, addr 0x69c8e68, size 0xc, virtual false, abstract: false, final false
