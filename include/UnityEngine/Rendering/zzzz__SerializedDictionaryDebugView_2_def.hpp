...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializedDictionaryDebugView_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializedDictionaryDebugView_2(SerializedDictionaryDebugView_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializedDictionaryDebugView_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializedDictionaryDebugView_2(SerializedDictionaryDebugView_2const&) = delete;
