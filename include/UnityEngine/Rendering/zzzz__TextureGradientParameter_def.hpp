...
public:
  ...
  /// @brief Method Release, addr 0x67c92c8, size 0x14, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method .ctor, addr 0x67c9264, size 0x64, virtual false, abstract: false, final false
