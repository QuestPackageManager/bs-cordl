...
/// @brief Method Release, addr 0x66863a4, size 0x14, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method .ctor, addr 0x6686340, size 0x64, virtual false, abstract: false, final false
