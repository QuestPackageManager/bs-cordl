...
/// @brief Method Equals, addr 0x6955fbc, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6955f94, size 0x28, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::DepthState  other) ;

/// @brief Method GetHashCode, addr 0x6956048, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x6955f1c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(bool  writeEnabled, ::UnityEngine::Rendering::CompareFunction  compareFunction) ;

/// @brief Method get_compareFunction, addr 0x6955f8c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CompareFunction get_compareFunction() ;

/// @brief Method get_defaultValue, addr 0x6955ef8, size 0x24, virtual false, abstract: false, final false
