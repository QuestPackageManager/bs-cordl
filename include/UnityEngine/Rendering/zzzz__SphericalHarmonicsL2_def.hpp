...
public:
  ...
  /// @brief Method Equals, addr 0x3229724, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x32297dc, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SphericalHarmonicsL2 other);

  /// @brief Method GetHashCode, addr 0x3229550, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3229824, size 0x1bc, virtual false, abstract: false, final false
