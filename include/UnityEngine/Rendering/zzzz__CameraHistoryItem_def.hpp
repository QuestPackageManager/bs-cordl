...
public:
  ...
  /// @brief Method AllocHistoryFrameRT, addr 0x66081b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentFrameRT, addr 0x66081fc, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetCurrentFrameRT(int32_t id);

  /// @brief Method GetPreviousFrameRT, addr 0x6608230, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetPreviousFrameRT(int32_t id);

  /// @brief Method MakeId, addr 0x66081a0, size 0x10, virtual false, abstract: false, final false
  inline int32_t MakeId(uint32_t index);

  static inline ::UnityEngine::Rendering::CameraHistoryItem* New_ctor();

  /// @brief Method OnCreate, addr 0x660818c, size 0xc, virtual true, abstract: false, final false
  inline void OnCreate(::UnityEngine::Rendering::BufferedRTHandleSystem* owner, uint32_t typeId);

  /// @brief Method ReleaseHistoryFrameRT, addr 0x6608218, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x660824c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_storage, addr 0x6608198, size 0x8, virtual false, abstract: false, final false
