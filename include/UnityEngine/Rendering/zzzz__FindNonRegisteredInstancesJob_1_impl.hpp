...
// Ctor Parameters [CppParam { name: "instanceIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "hashMap", ty:
// "::Unity::Collections::NativeParallelHashMap_2<int32_t,T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "outInstancesWriter", ty:
