...
public:
// Declarations
/// @brief Method IsValid, addr 0x6677b40, size 0x120, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method UseForOccluderUpdate, addr 0x6677dc0, size 0x160, virtual false, abstract: false, final false
inline void UseForOccluderUpdate(::UnityEngine::Rendering::RenderGraphModule::IBaseRenderGraphBuilder*  builder) ;

/// @brief Method UseForOcclusionTest, addr 0x6677c60, size 0x160, virtual false, abstract: false, final false
