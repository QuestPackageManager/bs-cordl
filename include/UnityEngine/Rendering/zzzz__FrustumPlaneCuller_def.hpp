...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x66cbcc8, size 0xc8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComputeSplitVisibilityMask, addr 0x66cbd90, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x66cb81c, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66cb78c, size 0x90, virtual false, abstract: false, final false
