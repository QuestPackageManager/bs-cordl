...
public:
// Declarations
/// @brief Method .ctor, addr 0x6659cbc, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ComputeSplitVisibilityMask, addr 0x6659d84, size 0x17c, virtual false, abstract: false, final false
static inline uint32_t ComputeSplitVisibilityMask(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::FrustumPlaneCuller_PlanePacket4>  planePackets, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::FrustumPlaneCuller_SplitInfo>  splitInfos, ::ByRef<::UnityEngine::Rendering::AABB>  bounds) ;

/// @brief Method Create, addr 0x6659810, size 0x440, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::FrustumPlaneCuller Create(::ByRef<::UnityEngine::Rendering::BatchCullingContext>  cc, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  receiverPlanes, ::ByRef<::UnityEngine::Rendering::ReceiverSphereCuller>  receiverSphereCuller, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method Dispose, addr 0x6659780, size 0x90, virtual false, abstract: false, final false
