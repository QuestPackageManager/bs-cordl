...
public:
  ...
  /// @brief Method Execute, addr 0x66d2bb8, size 0x53c, virtual true, abstract: false, final true
  inline void Execute(int32_t batchIndex);

  /// @brief Method IsInstanceFlipped, addr 0x66d2b18, size 0xa0, virtual false, abstract: false, final false
