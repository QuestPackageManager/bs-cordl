...
public:
  ...
  /// @brief Method Execute, addr 0x6811e3c, size 0x53c, virtual true, abstract: false, final true
  inline void Execute(int32_t batchIndex);

  /// @brief Method IsInstanceFlipped, addr 0x6811d9c, size 0xa0, virtual false, abstract: false, final false
