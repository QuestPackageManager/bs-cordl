...
public:
  ...
  /// @brief Method <BuildVolumeComponentDisplayList>b__16_0, addr 0x6642d00, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _BuildVolumeComponentDisplayList_b__16_0(::System::ValueTuple_2<::StringW, ::System::Type*> i);

  /// @brief Method <GetVolumes>b__71_0, addr 0x6642d68, size 0x60, virtual false, abstract: false, final false
  inline bool _GetVolumes_b__71_0(::UnityEngine::Rendering::Volume* v);

  /// @brief Method <SetCustomDefaultProfiles>b__49_0, addr 0x6642d08, size 0x60, virtual false, abstract: false, final false
  inline bool _SetCustomDefaultProfiles_b__49_0(::UnityEngine::Rendering::VolumeProfile* x);

  /// @brief Method <.cctor>b__74_0, addr 0x6642dc8, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::VolumeManager* __cctor_b__74_0();

  /// @brief Method .ctor, addr 0x6642cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <EvaluateVolumeDefaultState>b__1, addr 0x6642e24, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6642e20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildVolumeComponentDisplayList, addr 0x662be28, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckDefaultVolumeState, addr 0x662dcf4, size 0x94, virtual false, abstract: false, final false
  inline void CheckDefaultVolumeState();

  /// @brief Method CheckStack, addr 0x662dd88, size 0x1d4, virtual false, abstract: false, final false
  inline void CheckStack(::UnityEngine::Rendering::VolumeStack* stack);

  /// @brief Method CheckUpdateRequired, addr 0x662df5c, size 0x54, virtual false, abstract: false, final false
  inline bool CheckUpdateRequired(::UnityEngine::Rendering::VolumeStack* stack);

  /// @brief Method CreateStack, addr 0x662cd90, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::VolumeStack* CreateStack();

  /// @brief Method Deinitialize, addr 0x662ce74, size 0x16c, virtual false, abstract: false, final false
  inline void Deinitialize();

  /// @brief Method DestroyStack, addr 0x662cfe0, size 0x78, virtual false, abstract: false, final false
  inline void DestroyStack(::UnityEngine::Rendering::VolumeStack* stack);

  /// @brief Method EvaluateVolumeDefaultState, addr 0x662c598, size 0x7f8, virtual false, abstract: false, final false
  inline void EvaluateVolumeDefaultState();

  /// @brief Method GetVolumeComponentDefaultState, addr 0x662c21c, size 0x110, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::VolumeComponent> GetVolumeComponentDefaultState(::System::Type* volumeComponentType);

  /// @brief Method GetVolumeComponentsForDisplay, addr 0x6618b60, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVolumes, addr 0x662e5cc, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method GrabVolumes, addr 0x662e5b0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>* GrabVolumes(::UnityEngine::LayerMask mask);

  /// @brief Method Initialize, addr 0x662c42c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeVolumeComponents, addr 0x662c4d0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSupportedByObsoleteVolumeComponentMenuForRenderPipeline, addr 0x662d580, size 0x1ec, virtual false, abstract: false, final false
  inline bool IsSupportedByObsoleteVolumeComponentMenuForRenderPipeline(::System::Type* t, ::System::Type* pipelineAssetType);

  /// @brief Method IsVolumeRenderedByCamera, addr 0x662e714, size 0x8, virtual false, abstract: false, final false
  static inline bool IsVolumeRenderedByCamera(::UnityEngine::Rendering::Volume* volume, ::UnityEngine::Camera* camera);

  /// @brief Method LoadBaseTypes, addr 0x662b908, size 0x520, virtual false, abstract: false, final false
  inline void LoadBaseTypes(::System::Type* pipelineAssetType);

  static inline ::UnityEngine::Rendering::VolumeManager* New_ctor();

  /// @brief Method OnVolumeComponentChanged, addr 0x662d2f0, size 0x284, virtual false, abstract: false, final false
  inline void OnVolumeComponentChanged(::UnityEngine::Rendering::VolumeComponent* component);

  /// @brief Method OnVolumeProfileChanged, addr 0x662d204, size 0xec, virtual false, abstract: false, final false
  inline void OnVolumeProfileChanged(::UnityEngine::Rendering::VolumeProfile* profile);

  /// @brief Method OverrideData, addr 0x662d994, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x662b5fc, size 0x50, virtual false, abstract: false, final false
  inline void Register(::UnityEngine::Rendering::Volume* volume);

  /// @brief Method Register, addr 0x662b3a8, size 0x254, virtual false, abstract: false, final false
  inline void Register(::UnityEngine::Rendering::Volume* volume, int32_t layer);

  /// @brief Method ReplaceData, addr 0x662dad4, size 0x220, virtual false, abstract: false, final false
  inline void ReplaceData(::UnityEngine::Rendering::VolumeStack* stack);

  /// @brief Method ResetMainStack, addr 0x662d574, size 0xc, virtual false, abstract: false, final false
  inline void ResetMainStack();

  /// @brief Method SetCustomDefaultProfiles, addr 0x662d068, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGlobalDefaultProfile, addr 0x662d058, size 0x8, virtual false, abstract: false, final false
  inline void SetGlobalDefaultProfile(::UnityEngine::Rendering::VolumeProfile* profile);

  /// @brief Method SetLayerDirty, addr 0x662d964, size 0x18, virtual false, abstract: false, final false
  inline void SetLayerDirty(int32_t layer);

  /// @brief Method SetQualityDefaultProfile, addr 0x662d060, size 0x8, virtual false, abstract: false, final false
  inline void SetQualityDefaultProfile(::UnityEngine::Rendering::VolumeProfile* profile);

  /// @brief Method Unregister, addr 0x662b8a0, size 0x50, virtual false, abstract: false, final false
  inline void Unregister(::UnityEngine::Rendering::Volume* volume);

  /// @brief Method Unregister, addr 0x662b64c, size 0x254, virtual false, abstract: false, final false
  inline void Unregister(::UnityEngine::Rendering::Volume* volume, int32_t layer);

  /// @brief Method Update, addr 0x662dfc4, size 0x5ec, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::Rendering::VolumeStack* stack, ::UnityEngine::Transform* trigger, ::UnityEngine::LayerMask layerMask);

  /// @brief Method Update, addr 0x662dfb0, size 0x14, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::Transform* trigger, ::UnityEngine::LayerMask layerMask);

  /// @brief Method UpdateVolumeLayer, addr 0x662d97c, size 0x18, virtual false, abstract: false, final false
  inline void UpdateVolumeLayer(::UnityEngine::Rendering::Volume* volume, int32_t prevLayer, int32_t newLayer);

  /// @brief Method <EvaluateVolumeDefaultState>g__ApplyDefaultProfile|58_0, addr 0x662d76c, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x662c32c, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_baseComponentTypeArray, addr 0x662c1dc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> get_baseComponentTypeArray();

  /// @brief Method get_baseComponentTypes, addr 0x662b900, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Type*>* get_baseComponentTypes();

  /// @brief Method get_customDefaultProfiles, addr 0x662c20c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_globalDefaultProfile, addr 0x662c1ec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::VolumeProfile> get_globalDefaultProfile();

  /// @brief Method get_instance, addr 0x6618ab8, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::VolumeManager* get_instance();

  /// @brief Method get_isInitialized, addr 0x662c41c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_qualityDefaultProfile, addr 0x662c1fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::VolumeProfile> get_qualityDefaultProfile();

  /// @brief Method get_stack, addr 0x662b8f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_baseComponentTypeArray, addr 0x662c1e4, size 0x8, virtual false, abstract: false, final false
  inline void set_baseComponentTypeArray(::ArrayW<::System::Type*, ::Array<::System::Type*>*> value);

  /// @brief Method set_customDefaultProfiles, addr 0x662c214, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_globalDefaultProfile, addr 0x662c1f4, size 0x8, virtual false, abstract: false, final false
  inline void set_globalDefaultProfile(::UnityEngine::Rendering::VolumeProfile* value);

  /// @brief Method set_isInitialized, addr 0x662c424, size 0x8, virtual false, abstract: false, final false
  inline void set_isInitialized(bool value);

  /// @brief Method set_qualityDefaultProfile, addr 0x662c204, size 0x8, virtual false, abstract: false, final false
  inline void set_qualityDefaultProfile(::UnityEngine::Rendering::VolumeProfile* value);

  /// @brief Method set_stack, addr 0x662b8f8, size 0x8, virtual false, abstract: false, final false
