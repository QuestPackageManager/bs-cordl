...
public:
  // Declarations
  /// @brief Method HasVersion, addr 0x66d4c4c, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x66d44fc, size 0x164, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Init, addr 0x66d4410, size 0xec, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MoveToDebugStatsAndClear, addr 0x66d4788, size 0x4c4, virtual false, abstract: false, final false
  inline void MoveToDebugStatsAndClear(::UnityEngine::Rendering::DebugRendererBatcherStats* debugStats);

  /// @brief Method TryAdd, addr 0x66d4660, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CounterBuffer, addr 0x66d4408, size 0x8, virtual false, abstract: false, final false
