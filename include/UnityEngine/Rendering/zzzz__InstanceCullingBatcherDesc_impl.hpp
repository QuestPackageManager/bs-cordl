...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::InstanceCullingBatcherDesc (*)()>(&::UnityEngine::Rendering::InstanceCullingBatcherDesc::NewDefault)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x666532c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::InstanceCullingBatcherDesc>::get(),
                        "NewDefault",
