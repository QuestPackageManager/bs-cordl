...
public:
// Declarations
/// @brief Method AlignUpGroup, addr 0x660cbb4, size 0x18, virtual false, abstract: false, final false
static inline int32_t AlignUpGroup(int32_t  value) ;

/// @brief Method CalculateTotalBufferSize, addr 0x660cbcc, size 0x58, virtual false, abstract: false, final false
static inline void CalculateTotalBufferSize(int32_t  maxElementCount, ::ByRef<int32_t>  totalSize, ::ByRef<int32_t>  levelCounts) ;

/// @brief Method DivUpGroup, addr 0x660cb9c, size 0x18, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "count", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "offset", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "parentOffset", ty: "uint32_t", modifiers: "", def_value: None }]
...
/// @brief Method Create, addr 0x660cc34, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources Create(int32_t  newMaxElementCount, ::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphBuilder  builder, bool  outputIsTemp) ;

/// @brief Method Initialize, addr 0x660cc90, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method get_output, addr 0x660cc24, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "alignedElementCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxBufferCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxLevelCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixBuffer0", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }, CppParam { name: "prefixBuffer1", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }, CppParam { name: "totalLevelCountBuffer", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }, CppParam { name: "levelOffsetBuffer", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }, CppParam { name: "indirectDispatchArgsBuffer", ty: "::UnityEngine::Rendering::RenderGraphModule::BufferHandle", modifiers: "", def_value: None }]
...
/// @brief Method Create, addr 0x660cfa0, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUPrefixSum_SupportResources Create(int32_t  maxElementCount) ;

/// @brief Method Dispose, addr 0x660d378, size 0x78, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Load, addr 0x660d238, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method LoadFromShaderGraph, addr 0x660d294, size 0xe4, virtual false, abstract: false, final false
inline void LoadFromShaderGraph(::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources  shaderGraphResources) ;

/// @brief Method Resize, addr 0x660cffc, size 0x23c, virtual false, abstract: false, final false
inline void Resize(int32_t  newMaxElementCount) ;

/// @brief Method <Dispose>g__TryFreeBuffer|15_0, addr 0x660d3f0, size 0x10, virtual false, abstract: false, final false
static inline void _Dispose_g__TryFreeBuffer_15_0(::UnityEngine::GraphicsBuffer*  resource) ;

/// @brief Method get_output, addr 0x660cf98, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "ownsResources", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "alignedElementCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxBufferCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxLevelCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixBuffer0", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "prefixBuffer1", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "totalLevelCountBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "levelOffsetBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "indirectDispatchArgsBuffer", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "exclusive", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "inputCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "input", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "supportResources", ty: "::UnityEngine::Rendering::GPUPrefixSum_SupportResources", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "exclusive", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "inputCountBufferByteOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "inputCountBuffer", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "input", ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: None }, CppParam { name: "supportResources", ty: "::UnityEngine::Rendering::GPUPrefixSum_SupportResources", modifiers: "", def_value: None }]
constexpr GPUPrefixSum_IndirectDirectArgs(bool  exclusive, int32_t  inputCountBufferByteOffset, ::UnityEngine::ComputeBuffer*  inputCountBuffer, ::UnityEngine::GraphicsBuffer*  input, ::UnityEngine::Rendering::GPUPrefixSum_SupportResources  supportResources) noexcept;
...
public:
// Declarations
/// @brief Method LoadKernels, addr 0x660c260, size 0x1d8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "computeAsset", ty: "::UnityW<::UnityEngine::ComputeShader>", modifiers: "", def_value: None }, CppParam { name: "kernelCalculateLevelDispatchArgsFromConst", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelCalculateLevelDispatchArgsFromBuffer", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelPrefixSumOnGroup", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelPrefixSumOnGroupExclusive", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelPrefixSumNextInput", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelPrefixSumResolveParent", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kernelPrefixSumResolveParentExclusive", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method DispatchDirect, addr 0x660c7c8, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method DispatchIndirect, addr 0x660c9b8, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method ExecuteCommonIndirect, addr 0x660c44c, size 0x37c, virtual false, abstract: false, final false
inline void ExecuteCommonIndirect(::UnityEngine::Rendering::CommandBuffer*  cmdBuffer, ::UnityEngine::GraphicsBuffer*  inputBuffer, ::ByRef<::UnityEngine::Rendering::GPUPrefixSum_SupportResources>  supportResources, bool  isExclusive) ;

/// @brief Method PackPrefixSumArgs, addr 0x660c438, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 PackPrefixSumArgs(int32_t  a, int32_t  b, int32_t  c, int32_t  d) ;

/// @brief Method .ctor, addr 0x660c24c, size 0x14, virtual false, abstract: false, final false
