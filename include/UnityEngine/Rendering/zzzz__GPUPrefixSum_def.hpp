...
public:
  // Declarations
  /// @brief Method AlignUpGroup, addr 0x667ebc0, size 0x18, virtual false, abstract: false, final false
  static inline int32_t AlignUpGroup(int32_t value);

  /// @brief Method CalculateTotalBufferSize, addr 0x667ebd8, size 0x58, virtual false, abstract: false, final false
  static inline void CalculateTotalBufferSize(int32_t maxElementCount, ::ByRef<int32_t> totalSize, ::ByRef<int32_t> levelCounts);

  /// @brief Method DivUpGroup, addr 0x667eba8, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x667ec40, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x667ec9c, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_output, addr 0x667ec30, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x667efac, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::GPUPrefixSum_SupportResources Create(int32_t maxElementCount);

  /// @brief Method Dispose, addr 0x667f384, size 0x78, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Load, addr 0x667f244, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFromShaderGraph, addr 0x667f2a0, size 0xe4, virtual false, abstract: false, final false
  inline void LoadFromShaderGraph(::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources shaderGraphResources);

  /// @brief Method Resize, addr 0x667f008, size 0x23c, virtual false, abstract: false, final false
  inline void Resize(int32_t newMaxElementCount);

  /// @brief Method <Dispose>g__TryFreeBuffer|15_0, addr 0x667f3fc, size 0x10, virtual false, abstract: false, final false
  static inline void _Dispose_g__TryFreeBuffer_15_0(::UnityEngine::GraphicsBuffer* resource);

  /// @brief Method get_output, addr 0x667efa4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method LoadKernels, addr 0x667e26c, size 0x1d8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DispatchDirect, addr 0x667e7d4, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchIndirect, addr 0x667e9c4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCommonIndirect, addr 0x667e458, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method PackPrefixSumArgs, addr 0x667e444, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 PackPrefixSumArgs(int32_t a, int32_t b, int32_t c, int32_t d);

  /// @brief Method .ctor, addr 0x667e258, size 0x14, virtual false, abstract: false, final false
