...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUPrefixSum_DirectArgs, "UnityEngine.Rendering", "GPUPrefixSum/DirectArgs");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUPrefixSum_IndirectDirectArgs, "UnityEngine.Rendering", "GPUPrefixSum/IndirectDirectArgs");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUPrefixSum_LevelOffsets, "UnityEngine.Rendering", "GPUPrefixSum/LevelOffsets");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_LevelOffsets) == 0xc, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_RenderGraphResources) == 0x48, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_SupportResources) == 0x38, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_DirectArgs) == 0x48, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_IndirectDirectArgs) == 0x50, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUPrefixSum_SystemResources) == 0x28, "Size mismatch!");
