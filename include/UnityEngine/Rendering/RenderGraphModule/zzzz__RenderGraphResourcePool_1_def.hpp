...
/// @brief Field m_ResourcePool, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ResourcePool, put=__cordl_internal_set_m_ResourcePool)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<Type,int32_t>>*>*  m_ResourcePool;
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<Type,int32_t>>*>* const& __cordl_internal_get_m_ResourcePool() const;

constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<Type,int32_t>>*>*& __cordl_internal_get_m_ResourcePool() ;
...
constexpr void __cordl_internal_set_m_ResourcePool(::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::SortedList_2<int32_t,::System::ValueTuple_2<Type,int32_t>>*>*  value) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1_ResourceLogInfo, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphResourcePool`1/ResourceLogInfo");
