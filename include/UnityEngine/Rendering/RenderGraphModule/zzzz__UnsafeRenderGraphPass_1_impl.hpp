...
::cordl_internals::setStaticField<::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::UnsafeRenderGraphPass_1<PassData>*>::get>(std::forward<::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*>(value));
}
template<typename PassData>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::RenderGraphModule::UnsafeGraphContext*, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::UnsafeRenderGraphPass_1<PassData>*>::get>();
}
template<typename PassData>
