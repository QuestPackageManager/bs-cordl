...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x66a501c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x66a5044, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x66a5008, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a104c, size 0x148, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x66a507c, size 0x28, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext* rgContext, ::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource* res,
                                             ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x66a50a4, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x66a5068, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a1194, size 0x148, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method Cleanup, addr 0x66a4e50, size 0xc8, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Clear, addr 0x66a4c80, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method PurgeUnusedGraphicsResources, addr 0x66a4d9c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a0f90, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BeginExecute, addr 0x66a14c8, size 0xb0, virtual false, abstract: false, final false
  inline void BeginExecute(int32_t currentFrameIndex);

  /// @brief Method BeginRenderGraph, addr 0x66a1350, size 0xb4, virtual false, abstract: false, final false
  inline void BeginRenderGraph(int32_t executionCount);

  /// @brief Method CheckBufferResource, addr 0x66a06b4, size 0xa8, virtual false, abstract: false, final false
  inline void CheckBufferResource(::UnityEngine::Rendering::RenderGraphModule::BufferResource* bufferResource);

  /// @brief Method CheckHandleValidity, addr 0x66a176c, size 0x4, virtual false, abstract: false, final false
  inline void CheckHandleValidity(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method CheckHandleValidity, addr 0x66a1770, size 0x1d4, virtual false, abstract: false, final false
  inline void CheckHandleValidity(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType type, int32_t index);

  /// @brief Method CheckTextureResource, addr 0x66a026c, size 0xb0, virtual false, abstract: false, final false
  inline void CheckTextureResource(::UnityEngine::Rendering::RenderGraphModule::TextureResource* texResource);

  /// @brief Method Cleanup, addr 0x66a4db4, size 0x9c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Clear, addr 0x66a49d8, size 0xec, virtual false, abstract: false, final false
  inline void Clear(bool onException);

  /// @brief Method CreateBuffer, addr 0x6698330, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGizmoRendererList, addr 0x66a3264, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePooledResource, addr 0x66a3bf8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePooledResource, addr 0x66a3a8c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x66a30d8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererList, addr 0x66a2f90, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRendererLists, addr 0x66a46f4, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShadowRendererList, addr 0x66a31a4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSharedTexture, addr 0x66a27b4, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x66a34d0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSkyboxRendererList, addr 0x66a3594, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateSkyboxRendererList(::UnityEngine::Rendering::ScriptableRenderContext context, ::ByRef<::UnityEngine::Camera*> camera,
                                                                                                  ::UnityEngine::Matrix4x4 projectionMatrix, ::UnityEngine::Matrix4x4 viewMatrix);

  /// @brief Method CreateSkyboxRendererList, addr 0x66a3690, size 0x138, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RendererListHandle CreateSkyboxRendererList(::UnityEngine::Rendering::ScriptableRenderContext context, ::ByRef<::UnityEngine::Camera*> camera,
  ...
  /// @brief Method CreateTexture, addr 0x6697e34, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTextureCallback, addr 0x66a3cb0, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUIOverlayRendererList, addr 0x66a3338, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWireOverlayRendererList, addr 0x66a340c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method EndExecute, addr 0x66a16d8, size 0x94, virtual false, abstract: false, final false
  inline void EndExecute();

  /// @brief Method FlushLogs, addr 0x66a4f18, size 0x74, virtual false, abstract: false, final false
  inline void FlushLogs();

  /// @brief Method GetBuffer, addr 0x669fb78, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* GetBuffer(::ByRef<::UnityEngine::Rendering::RenderGraphModule::BufferHandle> handle);

  /// @brief Method GetBuffer, addr 0x66a086c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* GetBuffer(int32_t index);

  /// @brief Method GetBufferResource, addr 0x66a075c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBufferResource, addr 0x66a0888, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::BufferResource* GetBufferResource(int32_t index);

  /// @brief Method GetBufferResourceCount, addr 0x6696ab8, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetBufferResourceCount();

  /// @brief Method GetBufferResourceDesc, addr 0x6698488, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFormat, addr 0x66a2d08, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLatestVersionHandle, addr 0x6699768, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLatestVersionNumber, addr 0x66a1b38, size 0x12c, virtual false, abstract: false, final false
  inline int32_t GetLatestVersionNumber(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method GetNewVersionedHandle, addr 0x6699a4c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayTracingAccelerationStructure, addr 0x669f804, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayTracingAccelerationStructureResource, addr 0x66a096c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayTracingAccelerationStructureResourceCount, addr 0x6696ac0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetRayTracingAccelerationStructureResourceCount();

  /// @brief Method GetRenderGraphResourceName, addr 0x6699654, size 0x114, virtual false, abstract: false, final false
  inline ::StringW GetRenderGraphResourceName(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method GetRenderGraphResourceName, addr 0x66a1d6c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRenderGraphResourceTransientIndex, addr 0x6698a9c, size 0x110, virtual false, abstract: false, final false
  inline int32_t GetRenderGraphResourceTransientIndex(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method GetRenderTargetInfo, addr 0x669a9e8, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRendererList, addr 0x66a0554, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResourceCount, addr 0x66a2f10, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetResourceCount(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType type);

  /// @brief Method GetResourceLowLevel, addr 0x66a1c64, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSharedResourceCount, addr 0x66a0a7c, size 0x38, virtual false, abstract: false, final false
  inline int32_t GetSharedResourceCount(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceType type);

  /// @brief Method GetTexture, addr 0x66a031c, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetTexture(::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureHandle> handle);

  /// @brief Method GetTexture, addr 0x66a0458, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetTexture(int32_t index);

  /// @brief Method GetTextureResource, addr 0x6697c7c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextureResource, addr 0x66a0474, size 0xe0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureResource* GetTextureResource(int32_t index);

  /// @brief Method GetTextureResourceCount, addr 0x6696ab0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetTextureResourceCount();

  /// @brief Method GetTextureResourceDesc, addr 0x6697f98, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetZeroVersionedHandle, addr 0x6699a1c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportBackbuffer, addr 0x66a2a80, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportBuffer, addr 0x66a37c8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportRayTracingAccelerationStructure, addr 0x66a38a0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportTexture, addr 0x66a2240, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportTexture, addr 0x66a25b4, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportTexture, addr 0x66a221c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method IncrementReadCount, addr 0x6699908, size 0x114, virtual false, abstract: false, final false
  inline void IncrementReadCount(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method IncrementWriteCount, addr 0x6697738, size 0x114, virtual false, abstract: false, final false
  inline void IncrementWriteCount(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method IsGraphicsResourceCreated, addr 0x66a1ef8, size 0x114, virtual false, abstract: false, final false
  inline bool IsGraphicsResourceCreated(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method IsRenderGraphResourceForceReleased, addr 0x66a1e14, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsRenderGraphResourceImported, addr 0x6697900, size 0x110, virtual false, abstract: false, final false
  inline bool IsRenderGraphResourceImported(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method IsRenderGraphResourceImported, addr 0x66a2178, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsRenderGraphResourceShared, addr 0x66a1a58, size 0x6c, virtual false, abstract: false, final false
  inline bool IsRenderGraphResourceShared(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method IsRenderGraphResourceShared, addr 0x66a1eb8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method IsRendererListCreated, addr 0x66a200c, size 0x16c, virtual false, abstract: false, final false
  inline bool IsRendererListCreated(::ByRef<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle> res);

  /// @brief Method LogResources, addr 0x66a4ac4, size 0x1bc, virtual false, abstract: false, final false
  inline void LogResources();

  /// @brief Method ManageSharedRenderGraphResources, addr 0x66a1578, size 0x160, virtual false, abstract: false, final false
  inline void ManageSharedRenderGraphResources();

  /// @brief Method NewVersion, addr 0x66a1944, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method PurgeUnusedGraphicsResources, addr 0x66a4d34, size 0x68, virtual false, abstract: false, final false
  inline void PurgeUnusedGraphicsResources();

  /// @brief Method RefreshSharedTextureDesc, addr 0x66a2970, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleasePooledResource, addr 0x66a3fd4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleasePooledResource, addr 0x66a3ea8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseSharedTexture, addr 0x66a29b4, size 0xcc, virtual false, abstract: false, final false
  inline void ReleaseSharedTexture(::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureHandle> texture);

  /// @brief Method ReleaseTextureCallback, addr 0x66a408c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TextureNeedsFallback, addr 0x6697a10, size 0x150, virtual false, abstract: false, final false
  inline bool TextureNeedsFallback(::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureHandle> handle);

  /// @brief Method UpdateSharedResourceLastFrameIndex, addr 0x66a3a20, size 0x6c, virtual false, abstract: false, final false
  inline void UpdateSharedResourceLastFrameIndex(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> handle);

  /// @brief Method UpdateSharedResourceLastFrameIndex, addr 0x66a3978, size 0xa8, virtual false, abstract: false, final false
  inline void UpdateSharedResourceLastFrameIndex(int32_t type, int32_t index);

  /// @brief Method ValidateBufferDesc, addr 0x66a45d4, size 0x120, virtual false, abstract: false, final false
  inline void ValidateBufferDesc(::ByRef<::UnityEngine::Rendering::RenderGraphModule::BufferDesc> desc);

  /// @brief Method ValidateFormat, addr 0x66a2e10, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateRenderTarget, addr 0x66a2c40, size 0xc8, virtual false, abstract: false, final false
  inline void ValidateRenderTarget(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res);

  /// @brief Method ValidateRendererListDesc, addr 0x66a4414, size 0x1c0, virtual false, abstract: false, final false
  inline void ValidateRendererListDesc(::ByRef<::UnityEngine::Rendering::RendererUtils::RendererListDesc> desc);

  /// @brief Method ValidateTextureDesc, addr 0x66a4200, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a0ab4, size 0x168, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x66a0c1c, size 0x374, virtual false, abstract: false, final false
  ...
  /// @brief Method get_current, addr 0x66a01b0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_current, addr 0x66a020c, size 0x60, virtual false, abstract: false, final false
