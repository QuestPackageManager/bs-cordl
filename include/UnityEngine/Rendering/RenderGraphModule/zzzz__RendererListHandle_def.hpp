...
public:
  ...
  /// @brief Method IsValid, addr 0x66a51dc, size 0x8, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x66a30c4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t handle, ::UnityEngine::Rendering::RenderGraphModule::RendererListHandleType type);

  /// @brief Method get_handle, addr 0x66a50b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_handle();

  /// @brief Method op_Implicit, addr 0x66a50c0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x66a06ac, size 0x8, virtual false, abstract: false, final false
  static inline int32_t op_Implicit_int32_t(::UnityEngine::Rendering::RenderGraphModule::RendererListHandle handle);

  /// @brief Method set_handle, addr 0x66a50b8, size 0x8, virtual false, abstract: false, final false
