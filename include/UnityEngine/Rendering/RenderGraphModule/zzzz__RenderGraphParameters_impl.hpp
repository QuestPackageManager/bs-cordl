...
// Ctor Parameters [CppParam { name: "executionName", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "currentFrameIndex", ty: "int32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "rendererListCulling", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "scriptableRenderContext", ty:
// "::UnityEngine::Rendering::ScriptableRenderContext", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "commandBuffer", ty: "::UnityEngine::Rendering::CommandBuffer*",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "invalidContextForTesting", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
