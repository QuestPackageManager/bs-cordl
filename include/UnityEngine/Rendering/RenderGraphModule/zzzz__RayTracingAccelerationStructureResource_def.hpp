...
public:
// Declarations
/// @brief Method GetName, addr 0x662d8a0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x662d8a8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
