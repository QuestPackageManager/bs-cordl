...
public:
  // Declarations
  /// @brief Method GetName, addr 0x669f8ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x669f8b4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
