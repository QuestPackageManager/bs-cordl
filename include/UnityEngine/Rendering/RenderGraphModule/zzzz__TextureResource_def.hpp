...
public:
  ...
  /// @brief Method CreateGraphicsResource, addr 0x66a64d8, size 0x410, virtual true, abstract: false, final false
  inline void CreateGraphicsResource();

  /// @brief Method GetDescHashCode, addr 0x66a64d0, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDescHashCode();

  /// @brief Method GetName, addr 0x66a645c, size 0x74, virtual true, abstract: false, final false
  inline ::StringW GetName();

  /// @brief Method LogCreation, addr 0x66a6960, size 0x134, virtual true, abstract: false, final false
  inline void LogCreation(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger* logger);

  /// @brief Method LogRelease, addr 0x66a6a94, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method ReleaseGraphicsResource, addr 0x66a690c, size 0x54, virtual true, abstract: false, final false
  inline void ReleaseGraphicsResource();

  /// @brief Method UpdateGraphicsResource, addr 0x66a68e8, size 0x24, virtual true, abstract: false, final false
  inline void UpdateGraphicsResource();

  /// @brief Method .ctor, addr 0x66a6b78, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
