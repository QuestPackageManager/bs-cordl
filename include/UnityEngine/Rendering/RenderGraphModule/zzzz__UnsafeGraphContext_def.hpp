...
public:
  ...
  /// @brief Method FromInternalContext, addr 0x669754c, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66975f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::UnsafeCommandBuffer* getStaticF_unsCmd();

  /// @brief Method get_defaultResources, addr 0x669751c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources();

  /// @brief Method get_renderGraphPool, addr 0x6697534, size 0x18, virtual false, abstract: false, final false
