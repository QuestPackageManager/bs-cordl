...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IComputeRenderGraphBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IComputeRenderGraphBuilder(IComputeRenderGraphBuilderconst&) = delete;
