...
public:
  ...
  /// @brief Method BuildGraph, addr 0x66aae74, size 0xe34, virtual false, abstract: false, final false
  inline void BuildGraph();

  /// @brief Method Cleanup, addr 0x66aabc4, size 0x60, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Clear, addr 0x66aad20, size 0x74, virtual false, abstract: false, final false
  inline void Clear(bool clearContextData);

  /// @brief Method Compile, addr 0x66aad94, size 0x40, virtual false, abstract: false, final false
  inline void Compile(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry* resources);

  /// @brief Method CullUnusedRenderPasses, addr 0x66abca8, size 0x3d8, virtual false, abstract: false, final false
  inline void CullUnusedRenderPasses();

  /// @brief Method DetectMemoryLessResources, addr 0x66accdc, size 0x494, virtual false, abstract: false, final false
  inline void DetectMemoryLessResources();

  /// @brief Method DetermineLoadStoreActions, addr 0x66ad26c, size 0x5cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66aac24, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ExecuteBeginRenderPass, addr 0x66ae234, size 0x5b8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteCreateRessource, addr 0x66adb00, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteDestroyResource, addr 0x66ae7ec, size 0x434, virtual false, abstract: false, final false
  inline void ExecuteDestroyResource(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext* rgContext,
                                     ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry* resources,
                                     ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData> pass);

  /// @brief Method ExecuteGraph, addr 0x66af0b8, size 0x6b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteGraphNode, addr 0x66aee3c, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x66aab80, size 0x44, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method FindResourceUsageRanges, addr 0x66ac394, size 0x948, virtual false, abstract: false, final false
  inline void FindResourceUsageRanges();

  /// @brief Method GenerateNativeCompilerDebugData, addr 0x66b05d8, size 0x4334, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x66aac88, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method InjectSpaces, addr 0x66b0464, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW InjectSpaces(::StringW camelCaseString);

  /// @brief Method IsGlobalTextureInPass, addr 0x66ad838, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSameNativeSubPass, addr 0x66ad988, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeAttachmentInfo, addr 0x66af76c, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakePassBreakInfoMessage, addr 0x66afbf8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method MakePassMergeMessage, addr 0x66afd38, size 0x72c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNativeRenderPasses, addr 0x66ad170, size 0xf0, virtual false, abstract: false, final false
  inline void PrepareNativeRenderPasses();

  /// @brief Method SetPassStatesForNativePass, addr 0x66ad260, size 0xc, virtual false, abstract: false, final false
  inline void SetPassStatesForNativePass(int32_t nativePassId);

  /// @brief Method SetRandomWriteTarget, addr 0x66aec20, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupContextData, addr 0x66aadd4, size 0xa0, virtual false, abstract: false, final false
  inline void SetupContextData(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry* resources);

  /// @brief Method TryMergeNativePasses, addr 0x66ac080, size 0x314, virtual false, abstract: false, final false
  inline void TryMergeNativePasses();

  /// @brief Method ValidateAttachmentRenderTarget, addr 0x66ae110, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateNativePass, addr 0x66adf80, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66aaa44, size 0x13c, virtual false, abstract: false, final false
