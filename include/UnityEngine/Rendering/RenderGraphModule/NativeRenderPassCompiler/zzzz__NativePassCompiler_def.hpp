...
// Ctor Parameters [CppParam { name: "m_ResourcesForDebugOnly", ty: "::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*", modifiers: "", def_value: None }, CppParam { name: "m_RenderPasses", ty: "::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass*>*", modifiers: "", def_value: None }, CppParam { name: "debugName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "disableCulling", ty: "bool", modifiers: "", def_value: None }]
constexpr NativePassCompiler_RenderGraphInputInfo(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  m_ResourcesForDebugOnly, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass*>*  m_RenderPasses, ::StringW  debugName, bool  disableCulling) noexcept;
...
/// @brief Method BuildGraph, addr 0x6638e68, size 0xe34, virtual false, abstract: false, final false
inline void BuildGraph() ;

/// @brief Method Cleanup, addr 0x6638bb8, size 0x60, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x6638d14, size 0x74, virtual false, abstract: false, final false
inline void Clear(bool  clearContextData) ;

/// @brief Method Compile, addr 0x6638d88, size 0x40, virtual false, abstract: false, final false
inline void Compile(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources) ;

/// @brief Method CullUnusedRenderPasses, addr 0x6639c9c, size 0x3d8, virtual false, abstract: false, final false
inline void CullUnusedRenderPasses() ;

/// @brief Method DetectMemoryLessResources, addr 0x663acd0, size 0x494, virtual false, abstract: false, final false
inline void DetectMemoryLessResources() ;

/// @brief Method DetermineLoadStoreActions, addr 0x663b260, size 0x5cc, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x6638c18, size 0x64, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ExecuteBeginRenderPass, addr 0x663c228, size 0x5b8, virtual false, abstract: false, final false
inline void ExecuteBeginRenderPass(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  rgContext, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassData>  nativePass) ;

/// @brief Method ExecuteCreateRessource, addr 0x663baf4, size 0x480, virtual false, abstract: false, final false
inline void ExecuteCreateRessource(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  rgContext, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData>  pass) ;

/// @brief Method ExecuteDestroyResource, addr 0x663c7e0, size 0x434, virtual false, abstract: false, final false
inline void ExecuteDestroyResource(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  rgContext, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData>  pass) ;

/// @brief Method ExecuteGraph, addr 0x663d0ac, size 0x6b4, virtual false, abstract: false, final false
inline void ExecuteGraph(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*  rgContext, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::ByRef<::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass*>*>  passes) ;

/// @brief Method ExecuteGraphNode, addr 0x663ce30, size 0x27c, virtual false, abstract: false, final false
inline void ExecuteGraphNode(::ByRef<::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*>  rgContext, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass*  pass) ;

/// @brief Method Finalize, addr 0x6638b74, size 0x44, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FindResourceUsageRanges, addr 0x663a388, size 0x948, virtual false, abstract: false, final false
inline void FindResourceUsageRanges() ;

/// @brief Method GenerateNativeCompilerDebugData, addr 0x663e5cc, size 0x4334, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x6638c7c, size 0x98, virtual false, abstract: false, final false
inline bool Initialize(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraphPass*>*  renderPasses, bool  disableCulling, ::StringW  debugName, bool  useCompilationCaching, int32_t  graphHash, int32_t  frameIndex) ;

/// @brief Method InjectSpaces, addr 0x663e458, size 0x174, virtual false, abstract: false, final false
static inline ::StringW InjectSpaces(::StringW  camelCaseString) ;

/// @brief Method IsGlobalTextureInPass, addr 0x663b82c, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method IsSameNativeSubPass, addr 0x663b97c, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method MakeAttachmentInfo, addr 0x663d760, size 0x48c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassInfo_NRPInfo_PassData_DebugData_RenderGraph_AttachmentInfo* MakeAttachmentInfo(Il2CppObject*  ctx, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassData>  nativePass, int32_t  attachmentIndex) ;

/// @brief Method MakePassBreakInfoMessage, addr 0x663dbec, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method MakePassMergeMessage, addr 0x663dd2c, size 0x72c, virtual false, abstract: false, final false
static inline ::StringW MakePassMergeMessage(Il2CppObject*  ctx, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData>  pass, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData>  prevPass, ::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassBreakAudit  mergeResult) ;
...
/// @brief Method PrepareNativeRenderPasses, addr 0x663b164, size 0xf0, virtual false, abstract: false, final false
inline void PrepareNativeRenderPasses() ;

/// @brief Method SetPassStatesForNativePass, addr 0x663b254, size 0xc, virtual false, abstract: false, final false
inline void SetPassStatesForNativePass(int32_t  nativePassId) ;

/// @brief Method SetRandomWriteTarget, addr 0x663cc14, size 0x21c, virtual false, abstract: false, final false
inline void SetRandomWriteTarget(::ByRef<::UnityEngine::Rendering::CommandBuffer*>  cmd, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, int32_t  index, ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle  resource, bool  preserveCounterValue) ;

/// @brief Method SetupContextData, addr 0x6638dc8, size 0xa0, virtual false, abstract: false, final false
inline void SetupContextData(::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources) ;

/// @brief Method TryMergeNativePasses, addr 0x663a074, size 0x314, virtual false, abstract: false, final false
inline void TryMergeNativePasses() ;

/// @brief Method ValidateAttachmentRenderTarget, addr 0x663c104, size 0x124, virtual false, abstract: false, final false
inline void ValidateAttachmentRenderTarget(::ByRef<::UnityEngine::Rendering::RenderGraphModule::RenderTargetInfo>  attRenderTargetInfo, ::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourceRegistry*  resources, int32_t  nativePassWidth, int32_t  nativePassHeight, int32_t  nativePassMSAASamples) ;

/// @brief Method ValidateNativePass, addr 0x663bf74, size 0x190, virtual false, abstract: false, final false
inline void ValidateNativePass(::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassData>  nativePass, int32_t  width, int32_t  height, int32_t  depth, int32_t  samples, int32_t  attachmentCount) ;
...
/// @brief Method .ctor, addr 0x6638a38, size 0x13c, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassCompiler_NativeCompilerProfileId, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "NativePassCompiler/NativeCompilerProfileId");
NEED_NO_BOX(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassCompiler);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassCompiler*, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "NativePassCompiler");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassCompiler_RenderGraphInputInfo, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "NativePassCompiler/RenderGraphInputInfo");
