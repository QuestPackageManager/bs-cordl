...
// Ctor Parameters [CppParam { name: "a0", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a1", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a2", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a3", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a4", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a5", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a6", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "a7", ty: "DataType", modifiers: "", def_value: None }, CppParam { name: "activeAttachments", ty: "int32_t", modifiers: "", def_value: None }]
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::FixedAttachmentArray_1, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "FixedAttachmentArray`1");
