...
public:
  // Declarations
  /// @brief Method RegisterReadingPass, addr 0x66b851c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveReadingPass, addr 0x66b86b0, size 0x31c, virtual false, abstract: false, final false
  inline void RemoveReadingPass(Il2CppObject* ctx, ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle h, int32_t passId);

  /// @brief Method SetWritingPass, addr 0x66b850c, size 0x10, virtual false, abstract: false, final false
