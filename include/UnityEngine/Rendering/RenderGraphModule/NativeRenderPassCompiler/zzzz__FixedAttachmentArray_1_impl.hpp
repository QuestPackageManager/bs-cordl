...
template <typename DataType>
  requires(::cordl_internals::value_type_constraint<DataType> && ::cordl_internals::default_constructor_constraint<DataType>)
inline int32_t UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::FixedAttachmentArray_1<DataType>::Add(/* [IsReadOnly] */ ::by_ref<DataType> data) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::FixedAttachmentArray_1<DataType>>(),
...
// Ctor Parameters [CppParam { name: "a0", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "a1", ty: "DataType", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "a2", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "a3", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "a4", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "a5", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam
// { name: "a6", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "a7", ty: "DataType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
