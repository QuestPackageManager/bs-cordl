...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::Name::*)(::StringW, bool)>(
  ...
  constexpr static std::size_t addrs = 0x67edcc0;
...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "utf8ByteCount", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
