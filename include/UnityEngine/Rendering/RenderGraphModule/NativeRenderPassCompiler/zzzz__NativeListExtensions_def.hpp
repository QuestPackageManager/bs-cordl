...
template<typename T>
static inline int32_t LastIndex(::ByRef<::Unity::Collections::NativeList_1<T>>  list) ;

/// @brief Method MakeReadOnlySpan, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::ReadOnlySpan_1<T> MakeReadOnlySpan(::ByRef<::Unity::Collections::NativeList_1<T>>  list, int32_t  first, int32_t  numElements) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativeListExtensions*, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "NativeListExtensions");
