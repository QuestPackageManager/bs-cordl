...
public:
// Declarations
/// @brief Method GetName, addr 0x66b9f64, size 0x24, virtual false, abstract: false, final false
inline ::StringW GetName(Il2CppObject*  ctx, ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle  h) ;

/// @brief Method InitializeNullResource, addr 0x66ba070, size 0x14, virtual false, abstract: false, final false
inline void InitializeNullResource() ;

/// @brief Method .ctor, addr 0x66b9fe0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66ba028, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*  rll, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureDesc>  _, bool  isResourceShared) ;

/// @brief Method .ctor, addr 0x66b9f88, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*  rll, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::RenderTargetInfo>  info, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::TextureDesc>  desc, bool  isResourceShared) ;

// Ctor Parameters []
// @brief default ctor
constexpr ResourceUnversionedData() ;

// Ctor Parameters [CppParam { name: "isImported", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isShared", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "tag", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lastUsePassID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lastWritePassID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "firstUsePassID", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "memoryLess", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "width", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "height", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "volumeDepth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "msaaSamples", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "latestVersionNumber", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "clear", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "discard", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "bindMS", ty: "bool", modifiers: "", def_value: None }]
constexpr ResourceUnversionedData(bool  isImported, bool  isShared, int32_t  tag, int32_t  lastUsePassID, int32_t  lastWritePassID, int32_t  firstUsePassID, bool  memoryLess, int32_t  width, int32_t  height, int32_t  volumeDepth, int32_t  msaaSamples, int32_t  latestVersionNumber, bool  clear, bool  discard, bool  bindMS) noexcept;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::ResourceUnversionedData, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "ResourceUnversionedData");
