...
public:
  // Declarations
  /// @brief Method GetName, addr 0x66b83ec, size 0x24, virtual false, abstract: false, final false
  inline ::StringW GetName(Il2CppObject* ctx, ::UnityEngine::Rendering::RenderGraphModule::ResourceHandle h);

  /// @brief Method InitializeNullResource, addr 0x66b84f8, size 0x14, virtual false, abstract: false, final false
  inline void InitializeNullResource();

  /// @brief Method .ctor, addr 0x66b8468, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b84b0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b8410, size 0x58, virtual false, abstract: false, final false
