...
/// @brief Method GetEnumerator, addr 0x6638688, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x6638714, size 0x100, virtual false, abstract: false, final false
inline bool MoveNext() ;

/// @brief Method .ctor, addr 0x6638524, size 0x10, virtual false, abstract: false, final false
inline void _ctor(Il2CppObject*  ctx) ;

/// @brief Method get_Current, addr 0x6638694, size 0x80, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::CompilerContextData_NativePassIterator, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "CompilerContextData/NativePassIterator");
