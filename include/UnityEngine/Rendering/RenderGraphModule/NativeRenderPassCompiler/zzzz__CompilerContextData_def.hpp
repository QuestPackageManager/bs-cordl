...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::CompilerContextData_NativePassIterator, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler",
