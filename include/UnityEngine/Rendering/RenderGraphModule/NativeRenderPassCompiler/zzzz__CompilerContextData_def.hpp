...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x66aa694, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveNext, addr 0x66aa720, size 0x100, virtual false, abstract: false, final false
  inline bool MoveNext();

  /// @brief Method .ctor, addr 0x66aa530, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(Il2CppObject* ctx);

  /// @brief Method get_Current, addr 0x66aa6a0, size 0x80, virtual false, abstract: false, final false
