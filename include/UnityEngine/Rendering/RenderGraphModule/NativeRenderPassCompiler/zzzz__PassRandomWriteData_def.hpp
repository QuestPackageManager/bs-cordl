...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x6642a28, size 0x80, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "resource", ty: "::UnityEngine::Rendering::RenderGraphModule::ResourceHandle", modifiers: "", def_value: None }, CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "preserveCounterValue", ty: "bool", modifiers: "", def_value: None }]
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassRandomWriteData, "UnityEngine.Rendering.RenderGraphModule.NativeRenderPassCompiler", "PassRandomWriteData");
