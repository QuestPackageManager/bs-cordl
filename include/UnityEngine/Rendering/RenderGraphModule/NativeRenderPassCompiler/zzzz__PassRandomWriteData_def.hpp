...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67f3cb8, size 0x80, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassRandomWriteData) == 0x14, "Size mismatch!");
