...
public:
  // Declarations
  /// @brief Method CanMerge, addr 0x66b6930, size 0x7a8, virtual false, abstract: false, final false
  ...
  /// @brief Method CanMergeNativeSubPass, addr 0x66b7228, size 0x5a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x66b64e0, size 0x134, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetGraphPassNames, addr 0x66b680c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GraphPasses, addr 0x66b6624, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x66b6614, size 0x10, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method SetPassStatesForNativePass, addr 0x66b8218, size 0x1d4, virtual false, abstract: false, final false
  static inline void SetPassStatesForNativePass(Il2CppObject* contextData, int32_t nativePassId);

  /// @brief Method TryMerge, addr 0x66b7b80, size 0x698, virtual false, abstract: false, final false
  ...
  /// @brief Method TryMergeNativeSubPass, addr 0x66b5e78, size 0x668, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateNativeSubPassesAttachments, addr 0x66b77c8, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b5c20, size 0x258, virtual false, abstract: false, final false
