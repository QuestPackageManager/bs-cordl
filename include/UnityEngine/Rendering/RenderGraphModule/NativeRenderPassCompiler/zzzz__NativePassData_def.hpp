...
public:
// Declarations
/// @brief Method CanMerge, addr 0x6644924, size 0x7a8, virtual false, abstract: false, final false
...
/// @brief Method CanMergeNativeSubPass, addr 0x664521c, size 0x5a0, virtual false, abstract: false, final false
static inline bool CanMergeNativeSubPass(Il2CppObject*  contextData, ::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassData  nativePass, ::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData  passToMerge) ;

/// @brief Method Clear, addr 0x66444d4, size 0x134, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetGraphPassNames, addr 0x6644800, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method GraphPasses, addr 0x6644618, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x6644608, size 0x10, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method SetPassStatesForNativePass, addr 0x664620c, size 0x1d4, virtual false, abstract: false, final false
static inline void SetPassStatesForNativePass(Il2CppObject*  contextData, int32_t  nativePassId) ;

/// @brief Method TryMerge, addr 0x6645b74, size 0x698, virtual false, abstract: false, final false
...
/// @brief Method TryMergeNativeSubPass, addr 0x6643e6c, size 0x668, virtual false, abstract: false, final false
static inline void TryMergeNativeSubPass(Il2CppObject*  contextData, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::NativePassData>  nativePass, ::ByRef<::UnityEngine::Rendering::RenderGraphModule::NativeRenderPassCompiler::PassData>  passToMerge) ;

/// @brief Method UpdateNativeSubPassesAttachments, addr 0x66457bc, size 0x3b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6643c14, size 0x258, virtual false, abstract: false, final false
