...
public:
  // Declarations
  /// @brief Method GetResourceName, addr 0x66a6bcc, size 0x20, virtual true, abstract: false, final false
  inline ::StringW GetResourceName(::ByRef<::UnityEngine::Rendering::RTHandle*> res);

  /// @brief Method GetResourceSize, addr 0x66a6bec, size 0x1c, virtual true, abstract: false, final false
  inline int64_t GetResourceSize(::ByRef<::UnityEngine::Rendering::RTHandle*> res);

  /// @brief Method GetResourceTypeName, addr 0x66a6c08, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetResourceTypeName();

  /// @brief Method GetSortIndex, addr 0x66a6c4c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method ReleaseInternalResource, addr 0x66a6bb4, size 0x18, virtual true, abstract: false, final false
  inline void ReleaseInternalResource(::UnityEngine::Rendering::RTHandle* res);

  /// @brief Method .ctor, addr 0x66a12dc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
