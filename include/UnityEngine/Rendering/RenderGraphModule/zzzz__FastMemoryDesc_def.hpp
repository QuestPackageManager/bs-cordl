...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::FastMemoryDesc, "UnityEngine.Rendering.RenderGraphModule", "FastMemoryDesc");
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::FastMemoryDesc) == 0xc, "Size mismatch!");
