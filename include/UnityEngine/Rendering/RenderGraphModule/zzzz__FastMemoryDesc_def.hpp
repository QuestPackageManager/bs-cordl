...
// Ctor Parameters [CppParam { name: "inFastMemory", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::FastMemoryFlags", modifiers: "", def_value: None }, CppParam { name: "residencyFraction", ty: "float_t", modifiers: "", def_value: None }]
