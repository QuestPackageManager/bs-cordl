...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::*)(int32_t)>(&::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::PurgeUnusedResources)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool*>::get(),
                                  4
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::*)()>(&::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::Cleanup)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::*)(bool, int32_t)>(&::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::CheckFrameAllocation)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::*)(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger*)>(&::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::LogResources)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::*)()>(&::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool::_ctor)> {
