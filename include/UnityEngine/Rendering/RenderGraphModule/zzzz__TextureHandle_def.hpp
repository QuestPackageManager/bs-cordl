...
public:
  ...
  /// @brief Method GetDescriptor, addr 0x65cbb34, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBuiltin, addr 0x65cbb2c, size 0x8, virtual false, abstract: false, final false
  inline bool IsBuiltin();

  /// @brief Method IsValid, addr 0x65cba48, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x65cb370, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> h);

  /// @brief Method .ctor, addr 0x65c830c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x65cb314, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x65cb8ac, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x65cb388, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x65cb708, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x65cb568, size 0x1a0, virtual false, abstract: false, final false
