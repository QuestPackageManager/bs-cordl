...
public:
  ...
  /// @brief Method GetDescriptor, addr 0x67ea828, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBuiltin, addr 0x67ea820, size 0x8, virtual false, abstract: false, final false
  inline bool IsBuiltin();

  /// @brief Method IsValid, addr 0x67ea73c, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();
  ...
  /// @brief Method get_nullHandle, addr 0x67ea008, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x67ea5a0, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67ea07c, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67ea3fc, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67ea25c, size 0x1a0, virtual false, abstract: false, final false
