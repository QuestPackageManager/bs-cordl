...
public:
  ...
  /// @brief Method GetDescriptor, addr 0x67e5010, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method IsBuiltin, addr 0x67e5008, size 0x8, virtual false, abstract: false, final false
  inline bool IsBuiltin();

  /// @brief Method IsValid, addr 0x67e4f24, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x67e484c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> h);

  /// @brief Method .ctor, addr 0x67e17e8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x67e47f0, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x67e4d88, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67e4864, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67e4be4, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67e4a44, size 0x1a0, virtual false, abstract: false, final false
