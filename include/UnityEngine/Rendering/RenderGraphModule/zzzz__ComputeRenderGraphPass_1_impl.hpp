...
::cordl_internals::setStaticField<::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::ComputeRenderGraphPass_1<PassData>*>::get>(std::forward<::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>(value));
}
template<typename PassData>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::ComputeRenderGraphPass_1<PassData>*>::get>();
}
template<typename PassData>
