...
public:
  ...
  /// @brief Method IsValid, addr 0x669f720, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x669f538, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x669f4d8, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::RayTracingAccelerationStructureHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x669f630, size 0xf0, virtual false, abstract: false, final false
