...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_version, addr 0x66a91a0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66a9220, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_coreCopyPS, addr 0x66a91a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_coreCopyPS, addr 0x66a91b0, size 0x70, virtual false, abstract: false, final false
