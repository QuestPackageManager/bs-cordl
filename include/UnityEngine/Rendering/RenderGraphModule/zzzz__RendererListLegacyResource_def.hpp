...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RendererListLegacyResource, "UnityEngine.Rendering.RenderGraphModule", "RendererListLegacyResource");
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RendererListLegacyResource) == 0x20, "Size mismatch!");
