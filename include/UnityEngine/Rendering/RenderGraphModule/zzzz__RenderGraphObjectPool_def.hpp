...
public:
// Declarations
/// @brief Method Clear, addr 0x662a6e4, size 0x4, virtual true, abstract: false, final false
inline void Clear() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase* New_ctor() ;

/// @brief Method .ctor, addr 0x662a6e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cleanup, addr 0x662a4ac, size 0x1a4, virtual false, abstract: false, final false
inline void Cleanup() ;
...
template<typename T>
inline ::ArrayW<T,::Array<T>*> GetTempArray(int32_t  size) ;

/// @brief Method GetTempMaterialPropertyBlock, addr 0x662a0b4, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method ReleaseAllTempAlloc, addr 0x662a1b0, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6629f8c, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase*, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPoolBase");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPool_1, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPool`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::Rendering::RenderGraphModule::SharedObjectPool_1_RenderGraphObjectPool___c, "UnityEngine.Rendering.RenderGraphModule", "RenderGraphObjectPool/SharedObjectPool`1/<>c");
