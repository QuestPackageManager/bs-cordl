...
public:
  // Declarations
  /// @brief Method Clear, addr 0x669c6f0, size 0x4, virtual true, abstract: false, final false
  inline void Clear();

  static inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphObjectPool_SharedObjectPoolBase* New_ctor();

  /// @brief Method .ctor, addr 0x669c6ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x669c4b8, size 0x1a4, virtual false, abstract: false, final false
  inline void Cleanup();
  ...
  /// @brief Method GetTempMaterialPropertyBlock, addr 0x669c0c0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseAllTempAlloc, addr 0x669c1bc, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x669bf98, size 0x128, virtual false, abstract: false, final false
  inline void _ctor();
