...
public:
  // Declarations
  /// @brief Method CreateGraphicsResource, addr 0x669fd24, size 0x90, virtual true, abstract: false, final false
  inline void CreateGraphicsResource();

  /// @brief Method GetDescHashCode, addr 0x669fce8, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetDescHashCode();

  /// @brief Method GetName, addr 0x669fc84, size 0x64, virtual true, abstract: false, final false
  inline ::StringW GetName();

  /// @brief Method LogCreation, addr 0x669fe34, size 0xe4, virtual true, abstract: false, final false
  inline void LogCreation(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger* logger);

  /// @brief Method LogRelease, addr 0x669ff18, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method ReleaseGraphicsResource, addr 0x669fde4, size 0x50, virtual true, abstract: false, final false
  inline void ReleaseGraphicsResource();

  /// @brief Method UpdateGraphicsResource, addr 0x669fdb4, size 0x30, virtual true, abstract: false, final false
  inline void UpdateGraphicsResource();

  /// @brief Method .ctor, addr 0x669fffc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
