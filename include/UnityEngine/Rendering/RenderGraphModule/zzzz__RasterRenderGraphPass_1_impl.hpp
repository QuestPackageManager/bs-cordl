...
::cordl_internals::setStaticField<::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::RasterRenderGraphPass_1<PassData>*>::get>(std::forward<::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>(value));
}
template<typename PassData>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext, "c", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RenderGraphModule::RasterRenderGraphPass_1<PassData>*>::get>();
}
template<typename PassData>
