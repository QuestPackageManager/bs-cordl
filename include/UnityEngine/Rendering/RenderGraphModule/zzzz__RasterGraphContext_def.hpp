...
/// @brief Method FromInternalContext, addr 0x66252b4, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method get_defaultResources, addr 0x6625284, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources() ;

/// @brief Method get_renderGraphPool, addr 0x662529c, size 0x18, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "wrappedContext", ty: "::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext*", modifiers: "", def_value: None }, CppParam { name: "cmd", ty: "::UnityEngine::Rendering::RasterCommandBuffer*", modifiers: "", def_value: None }]
