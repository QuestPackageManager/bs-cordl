...
public:
  ...
  /// @brief Method FromInternalContext, addr 0x66972c0, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_defaultResources, addr 0x6697290, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources();

  /// @brief Method get_renderGraphPool, addr 0x66972a8, size 0x18, virtual false, abstract: false, final false
