...
public:
  ...
  /// @brief Method AllowGlobalStateModification, addr 0x66265f4, size 0x24, virtual true, abstract: false, final true
  inline void AllowGlobalStateModification(bool value);

  /// @brief Method AllowPassCulling, addr 0x66265c0, size 0x34, virtual true, abstract: false, final true
  inline void AllowPassCulling(bool value);

  /// @brief Method CheckNotUseFragment, addr 0x66274fc, size 0x42c, virtual false, abstract: false, final false
  inline void CheckNotUseFragment(::UnityEngine::Rendering::RenderGraphModule::TextureHandle tex);

  /// @brief Method CheckResource, addr 0x6628b14, size 0x334, virtual false, abstract: false, final false
  inline void CheckResource(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> res, bool checkTransientReadWrite);

  /// @brief Method CheckUseFragment, addr 0x6627c08, size 0x714, virtual false, abstract: false, final false
  inline void CheckUseFragment(::UnityEngine::Rendering::RenderGraphModule::TextureHandle tex, bool isDepth);

  /// @brief Method CreateTransientBuffer, addr 0x66268f0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransientBuffer, addr 0x6626634, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransientTexture, addr 0x6626938, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransientTexture, addr 0x662699c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66269ec, size 0x14, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6626a00, size 0x348, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnableAsyncCompute, addr 0x66265a4, size 0x1c, virtual true, abstract: false, final true
  inline void EnableAsyncCompute(bool value);

  /// @brief Method EnableFoveatedRasterization, addr 0x6626618, size 0x1c, virtual true, abstract: false, final true
  inline void EnableFoveatedRasterization(bool value);

  /// @brief Method GetLatestVersionHandle, addr 0x66271ec, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGlobalTextureAfterPass, addr 0x6627b08, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInputAttachment, addr 0x66287bc, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method SetRandomAccessAttachment, addr 0x66288b4, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method SetRenderAttachment, addr 0x662873c, size 0x80, virtual true, abstract: false, final true
  ...
  /// @brief Method SetRenderAttachmentDepth, addr 0x662883c, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method Setup, addr 0x6626510, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientBuffer, addr 0x6628e90, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientBuffer, addr 0x6628e7c, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::RenderGraphModule::BufferHandle
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientTexture, addr 0x6628e74, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientTexture, addr 0x6628e78, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::RenderGraphModule::TextureHandle
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.SetGlobalTextureAfterPass, addr 0x6628e50, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseBuffer, addr 0x6628e54, size 0x20, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::RenderGraphModule::BufferHandle
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseRendererList, addr 0x6628ea4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseTexture, addr 0x6628e48, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method UseAllGlobalTextures, addr 0x6627aec, size 0x1c, virtual true, abstract: false, final true
  inline void UseAllGlobalTextures(bool enable);

  /// @brief Method UseBuffer, addr 0x66274dc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method UseBufferRandomAccess, addr 0x6628938, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method UseBufferRandomAccess, addr 0x66289bc, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method UseGlobalTexture, addr 0x6627928, size 0x1c4, virtual true, abstract: false, final true
  inline void UseGlobalTexture(int32_t propertyId, ::UnityEngine::Rendering::RenderGraphModule::AccessFlags flags);

  /// @brief Method UseRendererList, addr 0x6628a4c, size 0xc8, virtual false, abstract: false, final false
  inline void UseRendererList(::ByRef<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle> input);

  /// @brief Method UseResource, addr 0x662669c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method UseTexture, addr 0x6626d48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateWriteTo, addr 0x6626d50, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66264fc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
