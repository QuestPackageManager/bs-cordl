...
/// @brief Method AllowGlobalStateModification, addr 0x6626cb4, size 0x24, virtual true, abstract: false, final true
inline void AllowGlobalStateModification(bool  value) ;

/// @brief Method AllowPassCulling, addr 0x6626c80, size 0x34, virtual true, abstract: false, final true
inline void AllowPassCulling(bool  value) ;

/// @brief Method CheckNotUseFragment, addr 0x6627bbc, size 0x42c, virtual false, abstract: false, final false
inline void CheckNotUseFragment(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  tex) ;

/// @brief Method CheckResource, addr 0x66291d4, size 0x334, virtual false, abstract: false, final false
inline void CheckResource(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle>  res, bool  checkTransientReadWrite) ;

/// @brief Method CheckUseFragment, addr 0x66282c8, size 0x714, virtual false, abstract: false, final false
inline void CheckUseFragment(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  tex, bool  isDepth) ;

/// @brief Method CreateTransientBuffer, addr 0x6626fb0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method CreateTransientBuffer, addr 0x6626cf4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method CreateTransientTexture, addr 0x6626ff8, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method CreateTransientTexture, addr 0x662705c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x66270ac, size 0x14, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x66270c0, size 0x348, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnableAsyncCompute, addr 0x6626c64, size 0x1c, virtual true, abstract: false, final true
inline void EnableAsyncCompute(bool  value) ;

/// @brief Method EnableFoveatedRasterization, addr 0x6626cd8, size 0x1c, virtual true, abstract: false, final true
inline void EnableFoveatedRasterization(bool  value) ;

/// @brief Method GetLatestVersionHandle, addr 0x66278ac, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method SetGlobalTextureAfterPass, addr 0x66281c8, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method SetInputAttachment, addr 0x6628e7c, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method SetRandomAccessAttachment, addr 0x6628f74, size 0x84, virtual true, abstract: false, final true
...
/// @brief Method SetRenderAttachment, addr 0x6628dfc, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method SetRenderAttachmentDepth, addr 0x6628efc, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method Setup, addr 0x6626bd0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientBuffer, addr 0x6629550, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientBuffer, addr 0x662953c, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientTexture, addr 0x6629534, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.CreateTransientTexture, addr 0x6629538, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.SetGlobalTextureAfterPass, addr 0x6629510, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseBuffer, addr 0x6629514, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseRendererList, addr 0x6629564, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.Rendering.RenderGraphModule.IBaseRenderGraphBuilder.UseTexture, addr 0x6629508, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method UseAllGlobalTextures, addr 0x66281ac, size 0x1c, virtual true, abstract: false, final true
inline void UseAllGlobalTextures(bool  enable) ;

/// @brief Method UseBuffer, addr 0x6627b9c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method UseBufferRandomAccess, addr 0x6628ff8, size 0x84, virtual true, abstract: false, final true
...
/// @brief Method UseBufferRandomAccess, addr 0x662907c, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method UseGlobalTexture, addr 0x6627fe8, size 0x1c4, virtual true, abstract: false, final true
inline void UseGlobalTexture(int32_t  propertyId, ::UnityEngine::Rendering::RenderGraphModule::AccessFlags  flags) ;

/// @brief Method UseRendererList, addr 0x662910c, size 0xc8, virtual false, abstract: false, final false
inline void UseRendererList(::ByRef<::UnityEngine::Rendering::RenderGraphModule::RendererListHandle>  input) ;

/// @brief Method UseResource, addr 0x6626d5c, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method UseTexture, addr 0x6627408, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ValidateWriteTo, addr 0x6627410, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6626bbc, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
