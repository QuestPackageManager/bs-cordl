...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67e46e4, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x67e46bc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t count, int32_t stride);

  /// @brief Method .ctor, addr 0x67e46d4, size 0x10, virtual false, abstract: false, final false
