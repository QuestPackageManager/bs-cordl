...
public:
  ...
  /// @brief Method FromInternalContext, addr 0x6697240, size 0x8, virtual true, abstract: false, final true
  inline void FromInternalContext(::UnityEngine::Rendering::RenderGraphModule::InternalRenderGraphContext* context);

  /// @brief Method get_cmd, addr 0x66971fc, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CommandBuffer* get_cmd();

  /// @brief Method get_defaultResources, addr 0x6697278, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources();

  /// @brief Method get_renderContext, addr 0x6697248, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ScriptableRenderContext get_renderContext();

  /// @brief Method get_renderGraphPool, addr 0x6697260, size 0x18, virtual false, abstract: false, final false
