...
public:
  ...
  /// @brief Method GetWidgetList, addr 0x668b65c, size 0x774, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::DebugUI_Widget*>* GetWidgetList(::StringW name);

  /// @brief Method IsImmediateModeSupported, addr 0x668bdd0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterDebug, addr 0x668beb0, size 0x124, virtual false, abstract: false, final false
  inline void RegisterDebug(::StringW name, ::UnityEngine::Rendering::DebugUI_Panel* debugPanel);

  /// @brief Method Reset, addr 0x668b650, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method UnRegisterDebug, addr 0x668bfd4, size 0x68, virtual false, abstract: false, final false
  inline void UnRegisterDebug(::StringW name);

  /// @brief Method <GetWidgetList>b__11_0, addr 0x668c078, size 0x8, virtual false, abstract: false, final false
  inline bool _GetWidgetList_b__11_0();

  /// @brief Method <GetWidgetList>b__11_1, addr 0x668c080, size 0x8, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_1(bool value);

  /// @brief Method <GetWidgetList>b__11_10, addr 0x668c0d8, size 0x8, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_10(bool value);

  /// @brief Method <GetWidgetList>b__11_11, addr 0x668c0e0, size 0x88, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_11();

  /// @brief Method <GetWidgetList>b__11_12, addr 0x668c168, size 0x88, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_12();

  /// @brief Method <GetWidgetList>b__11_2, addr 0x668c088, size 0x8, virtual false, abstract: false, final false
  inline bool _GetWidgetList_b__11_2();

  /// @brief Method <GetWidgetList>b__11_3, addr 0x668c090, size 0x8, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_3(bool value);

  /// @brief Method <GetWidgetList>b__11_4, addr 0x668c098, size 0x8, virtual false, abstract: false, final false
  inline bool _GetWidgetList_b__11_4();

  /// @brief Method <GetWidgetList>b__11_5, addr 0x668c0a0, size 0x8, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_5(bool value);

  /// @brief Method <GetWidgetList>b__11_6, addr 0x668c0a8, size 0x8, virtual false, abstract: false, final false
  inline bool _GetWidgetList_b__11_6();

  /// @brief Method <GetWidgetList>b__11_7, addr 0x668c0b0, size 0x8, virtual false, abstract: false, final false
  inline void _GetWidgetList_b__11_7(bool value);

  /// @brief Method <GetWidgetList>b__11_8, addr 0x668c0b8, size 0x18, virtual false, abstract: false, final false
  inline bool _GetWidgetList_b__11_8();

  /// @brief Method <GetWidgetList>b__11_9, addr 0x668c0d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x668c074, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AreAnySettingsActive, addr 0x668c03c, size 0x38, virtual true, abstract: false, final true
