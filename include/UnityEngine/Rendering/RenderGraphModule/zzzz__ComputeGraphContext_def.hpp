...
public:
  ...
  /// @brief Method FromInternalContext, addr 0x6697404, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66974a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::ComputeCommandBuffer* getStaticF_computecmd();

  /// @brief Method get_defaultResources, addr 0x66973d4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources();

  /// @brief Method get_renderGraphPool, addr 0x66973ec, size 0x18, virtual false, abstract: false, final false
