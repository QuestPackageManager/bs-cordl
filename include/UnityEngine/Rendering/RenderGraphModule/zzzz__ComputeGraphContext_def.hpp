...
/// @brief Method FromInternalContext, addr 0x66253f8, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x662549c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::ComputeCommandBuffer* getStaticF_computecmd() ;

/// @brief Method get_defaultResources, addr 0x66253c8, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderGraphModule::RenderGraphDefaultResources* get_defaultResources() ;

/// @brief Method get_renderGraphPool, addr 0x66253e0, size 0x18, virtual false, abstract: false, final false
