...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(RendererListHandleType)
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::RendererListHandleType, "UnityEngine.Rendering.RenderGraphModule", "RendererListHandleType");
// Dependencies
namespace UnityEngine::Rendering::RenderGraphModule {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::RendererListHandleType) == 0x4, "Size mismatch!");
