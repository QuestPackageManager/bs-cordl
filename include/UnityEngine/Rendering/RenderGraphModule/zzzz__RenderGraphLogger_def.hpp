...
public:
  ...
  /// @brief Method DecrementIndentation, addr 0x669ba94, size 0x78, virtual false, abstract: false, final false
  inline void DecrementIndentation(int32_t value);

  /// @brief Method GetAllLogs, addr 0x669bd4c, size 0x1b4, virtual false, abstract: false, final false
  inline ::StringW GetAllLogs();

  /// @brief Method GetLog, addr 0x669bc9c, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW GetLog(::StringW logName);

  /// @brief Method IncrementIndentation, addr 0x669b9b4, size 0x74, virtual false, abstract: false, final false
  inline void IncrementIndentation(int32_t value);

  /// @brief Method Initialize, addr 0x669bb0c, size 0x100, virtual false, abstract: false, final false
  inline void Initialize(::StringW logName);

  /// @brief Method LogLine, addr 0x669bc0c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x669bf00, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
