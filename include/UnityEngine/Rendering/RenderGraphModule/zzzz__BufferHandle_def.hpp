...
public:
  ...
  /// @brief Method IsValid, addr 0x669fa94, size 0xe4, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x669f950, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::Rendering::RenderGraphModule::ResourceHandle> h);

  /// @brief Method .ctor, addr 0x669f964, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nullHandle, addr 0x669f8f0, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderGraphModule::BufferHandle get_nullHandle();

  /// @brief Method op_Implicit, addr 0x669f9a4, size 0xf0, virtual false, abstract: false, final false
