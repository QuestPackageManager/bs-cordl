...
public:
  ...
  /// @brief Method CreateGraphicsResource, addr 0x66a5540, size 0x4, virtual true, abstract: false, final false
  inline void CreateGraphicsResource();

  /// @brief Method CreatePooledGraphicsResource, addr 0x66a553c, size 0x4, virtual true, abstract: false, final false
  inline void CreatePooledGraphicsResource();

  /// @brief Method GetDescHashCode, addr 0x66a5560, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetDescHashCode();

  /// @brief Method GetName, addr 0x66a549c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetName();

  /// @brief Method GetSortIndex, addr 0x66a5558, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetSortIndex();

  /// @brief Method IncrementReadCount, addr 0x66a54f8, size 0x10, virtual true, abstract: false, final false
  inline void IncrementReadCount();

  /// @brief Method IncrementWriteCount, addr 0x66a54e8, size 0x10, virtual true, abstract: false, final false
  inline void IncrementWriteCount();

  /// @brief Method IsCreated, addr 0x66a54e0, size 0x8, virtual true, abstract: false, final false
  inline bool IsCreated();

  /// @brief Method LogCreation, addr 0x66a5550, size 0x4, virtual true, abstract: false, final false
  inline void LogCreation(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger* logger);

  /// @brief Method LogRelease, addr 0x66a5554, size 0x4, virtual true, abstract: false, final false
  inline void LogRelease(::UnityEngine::Rendering::RenderGraphModule::RenderGraphLogger* logger);

  /// @brief Method NeedsFallBack, addr 0x66a551c, size 0x20, virtual true, abstract: false, final false
  inline bool NeedsFallBack();

  /// @brief Method NewVersion, addr 0x66a5508, size 0x14, virtual true, abstract: false, final false
  inline int32_t NewVersion();

  static inline ::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource* New_ctor();

  /// @brief Method ReleaseGraphicsResource, addr 0x66a554c, size 0x4, virtual true, abstract: false, final false
  inline void ReleaseGraphicsResource();

  /// @brief Method ReleasePooledGraphicsResource, addr 0x66a5548, size 0x4, virtual true, abstract: false, final false
  inline void ReleasePooledGraphicsResource(int32_t frameIndex);

  /// @brief Method Reset, addr 0x66a547c, size 0x20, virtual true, abstract: false, final false
  inline void Reset(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResourcePool* _);

  /// @brief Method UpdateGraphicsResource, addr 0x66a5544, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66a5568, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
