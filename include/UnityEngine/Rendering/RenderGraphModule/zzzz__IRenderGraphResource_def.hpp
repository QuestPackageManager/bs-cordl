...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource*, "UnityEngine.Rendering.RenderGraphModule", "IRenderGraphResource");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IRenderGraphResource", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IRenderGraphResource(IRenderGraphResource&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IRenderGraphResource", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRenderGraphResource(IRenderGraphResourceconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::RenderGraphModule::IRenderGraphResource) == 0x30, "Size mismatch!");
