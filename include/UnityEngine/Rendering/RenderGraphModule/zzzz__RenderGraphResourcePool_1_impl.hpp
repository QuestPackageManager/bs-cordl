...
template <typename Type>
  requires(::cordl_internals::reference_type_constraint<Type>)
inline ::StringW UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1<Type>::GetResourceName(/* [IsReadOnly] */ ::by_ref<Type> res) {
  auto* ___internal_method = THROW_UNLESS(
...
template <typename Type>
  requires(::cordl_internals::reference_type_constraint<Type>)
inline int64_t UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1<Type>::GetResourceSize(/* [IsReadOnly] */ ::by_ref<Type> res) {
  auto* ___internal_method = THROW_UNLESS(
...
template <typename Type>
  requires(::cordl_internals::reference_type_constraint<Type>)
inline bool UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1<Type>::TryGetResource(int32_t hashCode, ::by_ref<Type> resource) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::RenderGraphModule::RenderGraphResourcePool_1<Type>*>(),
