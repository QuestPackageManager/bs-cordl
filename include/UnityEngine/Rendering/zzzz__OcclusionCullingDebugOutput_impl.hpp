...
// Ctor Parameters [CppParam { name: "occluderDepthPyramid", ty: "::UnityEngine::Rendering::RTHandle*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "occlusionDebugOverlay",
// ty: "::UnityEngine::GraphicsBuffer*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "cb", ty: "::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables", modifiers:
