...
public:
  ...
  /// @brief Method GetGlobalKeywordIndex_Injected, addr 0x6b2ceb4, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t GetGlobalKeywordIndex_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> keyword);

  /// @brief Method ToString, addr 0x6b2d1b8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b2d080, size 0x138, virtual false, abstract: false, final false
