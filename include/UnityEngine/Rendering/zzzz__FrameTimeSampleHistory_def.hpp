...
/// @brief Method <.cctor>b__15_0, addr 0x65b6d1c, size 0x8, virtual false, abstract: false, final false
inline float_t __cctor_b__15_0(float_t  value, float_t  other) ;

/// @brief Method <.cctor>b__15_1, addr 0x65b6d24, size 0x14, virtual false, abstract: false, final false
inline float_t __cctor_b__15_1(float_t  value, float_t  other) ;

/// @brief Method <.cctor>b__15_2, addr 0x65b6d38, size 0xc, virtual false, abstract: false, final false
inline float_t __cctor_b__15_2(float_t  value, float_t  other) ;

/// @brief Method <.cctor>b__15_3, addr 0x65b6d44, size 0x14, virtual false, abstract: false, final false
inline float_t __cctor_b__15_3(float_t  value, float_t  other) ;

/// @brief Method <.cctor>b__15_4, addr 0x65b6d58, size 0x10, virtual false, abstract: false, final false
inline float_t __cctor_b__15_4(float_t  value, float_t  other) ;

/// @brief Method <.cctor>b__15_5, addr 0x65b6d68, size 0x14, virtual false, abstract: false, final false
inline float_t __cctor_b__15_5(float_t  value, float_t  other) ;

/// @brief Method .ctor, addr 0x65b6d18, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x65aa41c, size 0xe8, virtual false, abstract: false, final false
inline void Add(::UnityEngine::Rendering::FrameTimeSample  sample) ;

/// @brief Method Clear, addr 0x65ac060, size 0x58, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeAggregateValues, addr 0x65aa504, size 0x258, virtual false, abstract: false, final false
inline void ComputeAggregateValues() ;

/// @brief Method DiscardOldSamples, addr 0x65aa36c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method <ComputeAggregateValues>g__ForEachSampleMember|12_0, addr 0x65b6990, size 0xe4, virtual false, abstract: false, final false
static inline void _ComputeAggregateValues_g__ForEachSampleMember_12_0(::ByRef<::UnityEngine::Rendering::FrameTimeSample>  aggregate, ::UnityEngine::Rendering::FrameTimeSample  sample, ::System::Func_3<float_t,float_t,float_t>*  func) ;
...
/// @brief Method .ctor, addr 0x65aa030, size 0xac, virtual false, abstract: false, final false
