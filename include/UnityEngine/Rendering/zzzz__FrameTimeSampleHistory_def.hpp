...
public:
  ...
  /// @brief Method <.cctor>b__15_0, addr 0x6628d28, size 0x8, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_0(float_t value, float_t other);

  /// @brief Method <.cctor>b__15_1, addr 0x6628d30, size 0x14, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_1(float_t value, float_t other);

  /// @brief Method <.cctor>b__15_2, addr 0x6628d44, size 0xc, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_2(float_t value, float_t other);

  /// @brief Method <.cctor>b__15_3, addr 0x6628d50, size 0x14, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_3(float_t value, float_t other);

  /// @brief Method <.cctor>b__15_4, addr 0x6628d64, size 0x10, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_4(float_t value, float_t other);

  /// @brief Method <.cctor>b__15_5, addr 0x6628d74, size 0x14, virtual false, abstract: false, final false
  inline float_t __cctor_b__15_5(float_t value, float_t other);

  /// @brief Method .ctor, addr 0x6628d24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x661c428, size 0xe8, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::Rendering::FrameTimeSample sample);

  /// @brief Method Clear, addr 0x661e06c, size 0x58, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeAggregateValues, addr 0x661c510, size 0x258, virtual false, abstract: false, final false
  inline void ComputeAggregateValues();

  /// @brief Method DiscardOldSamples, addr 0x661c378, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method <ComputeAggregateValues>g__ForEachSampleMember|12_0, addr 0x662899c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x661c03c, size 0xac, virtual false, abstract: false, final false
