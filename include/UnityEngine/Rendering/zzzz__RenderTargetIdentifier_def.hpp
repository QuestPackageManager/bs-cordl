...
/// @brief Method Equals, addr 0x69b2e0c, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x69b2d90, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RenderTargetIdentifier  rhs) ;

/// @brief Method GetHashCode, addr 0x69b2d78, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x69b2ae4, size 0x294, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x69b2a10, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::RenderBuffer  buf, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x69b2710, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x69b2748, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  nameID) ;

/// @brief Method .ctor, addr 0x69b2768, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(int32_t  nameID, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x69b2784, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69b27b0, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  tex) ;

/// @brief Method .ctor, addr 0x69b28d8, size 0x138, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  tex, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x69b26f0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x69b2ea0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x69b2a50, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x69b2a84, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x69b2aa4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x69b2a30, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x69b2ed0, size 0x34, virtual false, abstract: false, final false
