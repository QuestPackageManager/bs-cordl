...
/// @brief Method Equals, addr 0x693f04c, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x693efd0, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RenderTargetIdentifier  rhs) ;

/// @brief Method GetHashCode, addr 0x693efb8, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x693ed24, size 0x294, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x693ec50, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::RenderBuffer  buf, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x693e950, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x693e988, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  nameID) ;

/// @brief Method .ctor, addr 0x693e9a8, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(int32_t  nameID, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x693e9c4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x693e9f0, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  tex) ;

/// @brief Method .ctor, addr 0x693eb18, size 0x138, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  tex, int32_t  mipLevel, ::UnityEngine::CubemapFace  cubeFace, int32_t  depthSlice) ;

/// @brief Method .ctor, addr 0x693e930, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x693f0e0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x693ec90, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x693ecc4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x693ece4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x693ec70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x693f110, size 0x34, virtual false, abstract: false, final false
