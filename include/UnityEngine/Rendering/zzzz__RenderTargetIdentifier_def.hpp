...
public:
  ...
  /// @brief Method Equals, addr 0x69b1294, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69b1218, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderTargetIdentifier rhs);

  /// @brief Method GetHashCode, addr 0x69b1200, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x69b0f6c, size 0x294, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x69b0e98, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::RenderBuffer buf, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x69b0b98, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x69b0bd0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t nameID);

  /// @brief Method .ctor, addr 0x69b0bf0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(int32_t nameID, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x69b0c0c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69b0c38, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture* tex);

  /// @brief Method .ctor, addr 0x69b0d60, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture* tex, int32_t mipLevel, ::UnityEngine::CubemapFace cubeFace, int32_t depthSlice);

  /// @brief Method .ctor, addr 0x69b0b78, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69b1328, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x69b0ed8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x69b0f0c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x69b0f2c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x69b0eb8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x69b1358, size 0x34, virtual false, abstract: false, final false
