...
public:
  ...
  /// @brief Method CloseFile, addr 0x6793a88, size 0xa4, virtual false, abstract: false, final false
  inline void CloseFile();

  /// @brief Method Dispose, addr 0x678dfe0, size 0x94, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FileExists, addr 0x678cb8c, size 0xf0, virtual false, abstract: false, final false
  inline bool FileExists();

  /// @brief Method GetAssetPath, addr 0x679391c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetAssetPath();

  /// @brief Method GetFileSize, addr 0x6793948, size 0x90, virtual false, abstract: false, final false
  inline int64_t GetFileSize();

  /// @brief Method IsOpen, addr 0x67939d8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsOpen();

  /// @brief Method IsValid, addr 0x678cd10, size 0x20, virtual false, abstract: false, final false
  inline bool IsValid();
  ...
  /// @brief Method OpenFile, addr 0x6793a14, size 0x74, virtual false, abstract: false, final false
  inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFile();

  /// @brief Method RefreshAssetPath, addr 0x6793878, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679372c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_asset, addr 0x6793714, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextAsset> get_asset();

  /// @brief Method get_assetGUID, addr 0x679370c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_assetGUID();

  /// @brief Method get_elementSize, addr 0x679371c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_elementSize();

  /// @brief Method get_streamableCellDescs, addr 0x6793724, size 0x8, virtual false, abstract: false, final false
