...
/// @brief Method CloseFile, addr 0x65e27f8, size 0xa4, virtual false, abstract: false, final false
inline void CloseFile() ;

/// @brief Method Dispose, addr 0x65dcd50, size 0x94, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FileExists, addr 0x65db8fc, size 0xf0, virtual false, abstract: false, final false
inline bool FileExists() ;

/// @brief Method GetAssetPath, addr 0x65e268c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW GetAssetPath() ;

/// @brief Method GetFileSize, addr 0x65e26b8, size 0x90, virtual false, abstract: false, final false
inline int64_t GetFileSize() ;

/// @brief Method IsOpen, addr 0x65e2748, size 0x3c, virtual false, abstract: false, final false
inline bool IsOpen() ;

/// @brief Method IsValid, addr 0x65dba80, size 0x20, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method OpenFile, addr 0x65e2784, size 0x74, virtual false, abstract: false, final false
inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFile() ;

/// @brief Method RefreshAssetPath, addr 0x65e25e8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65e249c, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method get_asset, addr 0x65e2484, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::TextAsset> get_asset() ;

/// @brief Method get_assetGUID, addr 0x65e247c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_assetGUID() ;

/// @brief Method get_elementSize, addr 0x65e248c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_elementSize() ;

/// @brief Method get_streamableCellDescs, addr 0x65e2494, size 0x8, virtual false, abstract: false, final false
