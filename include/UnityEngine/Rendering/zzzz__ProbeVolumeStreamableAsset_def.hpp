...
public:
  ...
  /// @brief Method CloseFile, addr 0x6654804, size 0xa4, virtual false, abstract: false, final false
  inline void CloseFile();

  /// @brief Method Dispose, addr 0x664ed5c, size 0x94, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FileExists, addr 0x664d908, size 0xf0, virtual false, abstract: false, final false
  inline bool FileExists();

  /// @brief Method GetAssetPath, addr 0x6654698, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetAssetPath();

  /// @brief Method GetFileSize, addr 0x66546c4, size 0x90, virtual false, abstract: false, final false
  inline int64_t GetFileSize();

  /// @brief Method IsOpen, addr 0x6654754, size 0x3c, virtual false, abstract: false, final false
  inline bool IsOpen();

  /// @brief Method IsValid, addr 0x664da8c, size 0x20, virtual false, abstract: false, final false
  inline bool IsValid();
  ...
  /// @brief Method OpenFile, addr 0x6654790, size 0x74, virtual false, abstract: false, final false
  inline ::Unity::IO::LowLevel::Unsafe::FileHandle OpenFile();

  /// @brief Method RefreshAssetPath, addr 0x66545f4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66544a8, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_asset, addr 0x6654490, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextAsset> get_asset();

  /// @brief Method get_assetGUID, addr 0x6654488, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_assetGUID();

  /// @brief Method get_elementSize, addr 0x6654498, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_elementSize();

  /// @brief Method get_streamableCellDescs, addr 0x66544a0, size 0x8, virtual false, abstract: false, final false
