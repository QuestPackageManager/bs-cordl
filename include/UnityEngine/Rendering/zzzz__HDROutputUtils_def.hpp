...
public:
// Declarations
/// @brief Method .ctor, addr 0x660f834, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "maxFullFrameToneMapLuminance", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxToneMapLuminance", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minToneMapLuminance", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "paperWhiteNits", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Method ConfigureHDROutput, addr 0x660f47c, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method ConfigureHDROutput, addr 0x660efe8, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method ConfigureHDROutput, addr 0x660f2f8, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method ConfigureHDROutput, addr 0x660f230, size 0xc8, virtual false, abstract: false, final false
static inline void ConfigureHDROutput(::UnityEngine::MaterialPropertyBlock*  properties, ::UnityEngine::ColorGamut  gamut) ;

/// @brief Method GetColorEncodingForGamut, addr 0x660ee3c, size 0x1ac, virtual false, abstract: false, final false
static inline bool GetColorEncodingForGamut(::UnityEngine::ColorGamut  gamut, ::ByRef<int32_t>  encoding) ;

/// @brief Method GetColorSpaceForGamut, addr 0x660ebe8, size 0x254, virtual false, abstract: false, final false
static inline bool GetColorSpaceForGamut(::UnityEngine::ColorGamut  gamut, ::ByRef<int32_t>  colorspace) ;

/// @brief Method IsShaderVariantValid, addr 0x660f6cc, size 0x168, virtual false, abstract: false, final false
