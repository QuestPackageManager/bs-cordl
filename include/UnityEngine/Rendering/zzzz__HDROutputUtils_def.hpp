...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6681840, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ConfigureHDROutput, addr 0x6681488, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureHDROutput, addr 0x6680ff4, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureHDROutput, addr 0x6681304, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureHDROutput, addr 0x668123c, size 0xc8, virtual false, abstract: false, final false
  static inline void ConfigureHDROutput(::UnityEngine::MaterialPropertyBlock* properties, ::UnityEngine::ColorGamut gamut);

  /// @brief Method GetColorEncodingForGamut, addr 0x6680e48, size 0x1ac, virtual false, abstract: false, final false
  static inline bool GetColorEncodingForGamut(::UnityEngine::ColorGamut gamut, ::ByRef<int32_t> encoding);

  /// @brief Method GetColorSpaceForGamut, addr 0x6680bf4, size 0x254, virtual false, abstract: false, final false
  static inline bool GetColorSpaceForGamut(::UnityEngine::ColorGamut gamut, ::ByRef<int32_t> colorspace);

  /// @brief Method IsShaderVariantValid, addr 0x66816d8, size 0x168, virtual false, abstract: false, final false
