...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer, "UnityEngine.Rendering", "SpeedTreeWindParamsBufferIterator/<uintParamOffsets>e__FixedBuffer");
