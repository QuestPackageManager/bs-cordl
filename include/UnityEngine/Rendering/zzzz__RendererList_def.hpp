...
public:
  ...
  /// @brief Method .ctor, addr 0x69cc2a4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isValid, addr 0x69cc268, size 0x3c, virtual false, abstract: false, final false
