...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CoreMatrixUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CoreMatrixUtils(CoreMatrixUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CoreMatrixUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CoreMatrixUtils(CoreMatrixUtilsconst&) = delete;
