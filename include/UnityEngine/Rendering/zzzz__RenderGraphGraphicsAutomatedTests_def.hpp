...
/// @brief Method .ctor, addr 0x6684ef8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_activatedFromCommandLine>b__1_0, addr 0x6684efc, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_activatedFromCommandLine, addr 0x6684ce8, size 0x10c, virtual false, abstract: false, final false
static inline bool get_activatedFromCommandLine() ;

/// @brief Method get_enabled, addr 0x6684df4, size 0x5c, virtual false, abstract: false, final false
