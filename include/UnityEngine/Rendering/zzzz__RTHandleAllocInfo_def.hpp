...
public:
  ...
  /// @brief Method .ctor, addr 0x666a13c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_anisoLevel, addr 0x666a0bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_anisoLevel();

  /// @brief Method get_autoGenerateMips, addr 0x666a0ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoGenerateMips();

  /// @brief Method get_bindTextureMS, addr 0x666a0ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_bindTextureMS();

  /// @brief Method get_dimension, addr 0x666a07c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::TextureDimension get_dimension();

  /// @brief Method get_enableRandomWrite, addr 0x666a08c, size 0x8, virtual false, abstract: false, final false
  inline bool get_enableRandomWrite();

  /// @brief Method get_filterMode, addr 0x666a03c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::FilterMode get_filterMode();

  /// @brief Method get_format, addr 0x666a02c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_format();

  /// @brief Method get_memoryless, addr 0x666a10c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureMemoryless get_memoryless();

  /// @brief Method get_mipMapBias, addr 0x666a0cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_mipMapBias();

  /// @brief Method get_msaaSamples, addr 0x666a0dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::MSAASamples get_msaaSamples();

  /// @brief Method get_name, addr 0x666a12c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_slices, addr 0x666a01c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_slices();

  /// @brief Method get_useDynamicScale, addr 0x666a0fc, size 0x8, virtual false, abstract: false, final false
  inline bool get_useDynamicScale();

  /// @brief Method get_useMipMap, addr 0x666a09c, size 0x8, virtual false, abstract: false, final false
  inline bool get_useMipMap();

  /// @brief Method get_vrUsage, addr 0x666a11c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::VRTextureUsage get_vrUsage();

  /// @brief Method get_wrapModeU, addr 0x666a04c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextureWrapMode get_wrapModeU();

  /// @brief Method get_wrapModeV, addr 0x666a05c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextureWrapMode get_wrapModeV();

  /// @brief Method get_wrapModeW, addr 0x666a06c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextureWrapMode get_wrapModeW();

  /// @brief Method set_anisoLevel, addr 0x666a0c4, size 0x8, virtual false, abstract: false, final false
  inline void set_anisoLevel(int32_t value);

  /// @brief Method set_autoGenerateMips, addr 0x666a0b4, size 0x8, virtual false, abstract: false, final false
  inline void set_autoGenerateMips(bool value);

  /// @brief Method set_bindTextureMS, addr 0x666a0f4, size 0x8, virtual false, abstract: false, final false
  inline void set_bindTextureMS(bool value);

  /// @brief Method set_dimension, addr 0x666a084, size 0x8, virtual false, abstract: false, final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method set_enableRandomWrite, addr 0x666a094, size 0x8, virtual false, abstract: false, final false
  inline void set_enableRandomWrite(bool value);

  /// @brief Method set_filterMode, addr 0x666a044, size 0x8, virtual false, abstract: false, final false
  inline void set_filterMode(::UnityEngine::FilterMode value);

  /// @brief Method set_format, addr 0x666a034, size 0x8, virtual false, abstract: false, final false
  inline void set_format(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_memoryless, addr 0x666a114, size 0x8, virtual false, abstract: false, final false
  inline void set_memoryless(::UnityEngine::RenderTextureMemoryless value);

  /// @brief Method set_mipMapBias, addr 0x666a0d4, size 0x8, virtual false, abstract: false, final false
  inline void set_mipMapBias(float_t value);

  /// @brief Method set_msaaSamples, addr 0x666a0e4, size 0x8, virtual false, abstract: false, final false
  inline void set_msaaSamples(::UnityEngine::Rendering::MSAASamples value);

  /// @brief Method set_name, addr 0x666a134, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_slices, addr 0x666a024, size 0x8, virtual false, abstract: false, final false
  inline void set_slices(int32_t value);

  /// @brief Method set_useDynamicScale, addr 0x666a104, size 0x8, virtual false, abstract: false, final false
  inline void set_useDynamicScale(bool value);

  /// @brief Method set_useMipMap, addr 0x666a0a4, size 0x8, virtual false, abstract: false, final false
  inline void set_useMipMap(bool value);

  /// @brief Method set_vrUsage, addr 0x666a124, size 0x8, virtual false, abstract: false, final false
  inline void set_vrUsage(::UnityEngine::VRTextureUsage value);

  /// @brief Method set_wrapModeU, addr 0x666a054, size 0x8, virtual false, abstract: false, final false
  inline void set_wrapModeU(::UnityEngine::TextureWrapMode value);

  /// @brief Method set_wrapModeV, addr 0x666a064, size 0x8, virtual false, abstract: false, final false
  inline void set_wrapModeV(::UnityEngine::TextureWrapMode value);

  /// @brief Method set_wrapModeW, addr 0x666a074, size 0x8, virtual false, abstract: false, final false
