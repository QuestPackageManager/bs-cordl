...
// Ctor Parameters [CppParam { name: "inputs", ty: "::UnityEngine::Rendering::AttachmentIndexArray", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "colorOutputs", ty:
// "::UnityEngine::Rendering::AttachmentIndexArray", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::SubPassFlags", modifiers: "",
