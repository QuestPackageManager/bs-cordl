...
#include "UnityEngine/Rendering/zzzz__LODGroupCullingData_def.hpp"
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
...
// Ctor Parameters [CppParam { name: "worldSpaceReferencePoint", ty: "::Unity::Mathematics::float3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lodCount", ty: "int32_t",
