...
static inline void Push(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data, ::UnityEngine::ComputeShader*  cs, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data, ::UnityEngine::Material*  mat, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::ByRef<CBType>  data, ::UnityEngine::ComputeShader*  cs, int32_t  shaderId) ;

/// @brief Method Push, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void Push(::ByRef<CBType>  data, ::UnityEngine::Material*  mat, int32_t  shaderId) ;

/// @brief Method PushGlobal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void PushGlobal(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data, int32_t  shaderId) ;

/// @brief Method PushGlobal, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void PushGlobal(::ByRef<CBType>  data, int32_t  shaderId) ;

/// @brief Method Register, addr 0x659f7fc, size 0xd4, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::Rendering::ConstantBufferBase*  cb) ;

/// @brief Method ReleaseAll, addr 0x659f660, size 0x19c, virtual false, abstract: false, final false
...
template<typename CBType>
static inline void UpdateData(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data) ;

/// @brief Method UpdateData, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename CBType>
static inline void UpdateData(::ByRef<CBType>  data) ;

/// @brief Method .ctor, addr 0x659f8d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
