...
public:
  ...
  /// @brief Method AllocateTexturesIfNecessary, addr 0x66ea2f4, size 0x250, virtual false, abstract: false, final false
  inline void AllocateTexturesIfNecessary(bool debugOverlayEnabled);

  /// @brief Method CreateFarDepthPyramid, addr 0x66ea970, size 0x4f8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66ea000, size 0x128, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetDebugOutput, addr 0x66eb01c, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::OcclusionCullingDebugOutput GetDebugOutput();

  /// @brief Method Import, addr 0x66eae68, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::OccluderHandles Import(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph);

  /// @brief Method IsSubviewValid, addr 0x66e9fc4, size 0x24, virtual false, abstract: false, final false
  inline bool IsSubviewValid(int32_t subviewIndex);

  /// @brief Method PrepareOccluders, addr 0x66eaf10, size 0x10c, virtual false, abstract: false, final false
  inline void PrepareOccluders(::ByRef<::UnityEngine::Rendering::OccluderParameters> occluderParams);

  /// @brief Method SetKeyword, addr 0x66ea544, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupFarDepthPyramidConstants, addr 0x66ea570, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateMipBounds, addr 0x66ea128, size 0x1cc, virtual false, abstract: false, final false
  inline void UpdateMipBounds();

  /// @brief Method get_depthBufferSizeInOccluderPixels, addr 0x66e9fe8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_depthBufferSizeInOccluderPixels();

  /// @brief Method get_subviewCount, addr 0x66e9fbc, size 0x8, virtual false, abstract: false, final false
