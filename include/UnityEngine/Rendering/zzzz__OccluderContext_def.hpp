...
/// @brief Method AllocateTexturesIfNecessary, addr 0x66782e8, size 0x250, virtual false, abstract: false, final false
inline void AllocateTexturesIfNecessary(bool  debugOverlayEnabled) ;

/// @brief Method CreateFarDepthPyramid, addr 0x6678964, size 0x4f8, virtual false, abstract: false, final false
inline void CreateFarDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates, ::ByRef<::UnityEngine::Rendering::OccluderHandles>  occluderHandles, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  silhouettePlanes, ::UnityEngine::ComputeShader*  occluderDepthPyramidCS, int32_t  occluderDepthDownscaleKernel) ;

/// @brief Method Dispose, addr 0x6677ff4, size 0x128, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetDebugOutput, addr 0x6679010, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OcclusionCullingDebugOutput GetDebugOutput() ;

/// @brief Method Import, addr 0x6678e5c, size 0xa8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OccluderHandles Import(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph) ;

/// @brief Method IsSubviewValid, addr 0x6677fb8, size 0x24, virtual false, abstract: false, final false
inline bool IsSubviewValid(int32_t  subviewIndex) ;

/// @brief Method PrepareOccluders, addr 0x6678f04, size 0x10c, virtual false, abstract: false, final false
inline void PrepareOccluders(::ByRef<::UnityEngine::Rendering::OccluderParameters>  occluderParams) ;

/// @brief Method SetKeyword, addr 0x6678538, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method SetupFarDepthPyramidConstants, addr 0x6678564, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method UpdateMipBounds, addr 0x667811c, size 0x1cc, virtual false, abstract: false, final false
inline void UpdateMipBounds() ;

/// @brief Method get_depthBufferSizeInOccluderPixels, addr 0x6677fdc, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_depthBufferSizeInOccluderPixels() ;

/// @brief Method get_subviewCount, addr 0x6677fb0, size 0x8, virtual false, abstract: false, final false
