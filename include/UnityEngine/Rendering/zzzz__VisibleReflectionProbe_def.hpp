...
public:
  ...
  /// @brief Method Equals, addr 0x68f6024, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x68f5d34, size 0x2f0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::VisibleReflectionProbe other);

  /// @brief Method GetHashCode, addr 0x68f60b8, size 0x1bc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_blendDistance, addr 0x68f5cc4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_blendDistance();

  /// @brief Method get_bounds, addr 0x68f5c88, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_bounds();

  /// @brief Method get_hdrData, addr 0x68f5cb8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_hdrData();

  /// @brief Method get_importance, addr 0x68f5ccc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_importance();

  /// @brief Method get_isBoxProjection, addr 0x68f5cd4, size 0x60, virtual false, abstract: false, final false
  inline bool get_isBoxProjection();

  /// @brief Method get_localToWorldMatrix, addr 0x68f5c9c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix();

  /// @brief Method get_reflectionProbe, addr 0x68f5bf4, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ReflectionProbe> get_reflectionProbe();

  /// @brief Method get_texture, addr 0x68f5b44, size 0xb0, virtual false, abstract: false, final false
