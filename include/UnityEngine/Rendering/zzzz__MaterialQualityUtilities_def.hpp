...
/// @brief Method FromIndex, addr 0x6610800, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::MaterialQuality FromIndex(int32_t  index) ;

/// @brief Method GetClosestQuality, addr 0x6610638, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetHighestQuality, addr 0x66105a8, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::MaterialQuality GetHighestQuality(::UnityEngine::Rendering::MaterialQuality  levels) ;

/// @brief Method SetGlobalShaderKeywords, addr 0x661080c, size 0xfc, virtual false, abstract: false, final false
static inline void SetGlobalShaderKeywords(::UnityEngine::Rendering::MaterialQuality  level) ;

/// @brief Method SetGlobalShaderKeywords, addr 0x6610908, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method ToFirstIndex, addr 0x6610770, size 0x90, virtual false, abstract: false, final false
