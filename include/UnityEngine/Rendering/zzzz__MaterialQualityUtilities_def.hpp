...
public:
  ...
  /// @brief Method FromIndex, addr 0x67c1a90, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::MaterialQuality FromIndex(int32_t index);

  /// @brief Method GetClosestQuality, addr 0x67c18c8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHighestQuality, addr 0x67c1838, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::MaterialQuality GetHighestQuality(::UnityEngine::Rendering::MaterialQuality levels);

  /// @brief Method SetGlobalShaderKeywords, addr 0x67c1a9c, size 0xfc, virtual false, abstract: false, final false
  static inline void SetGlobalShaderKeywords(::UnityEngine::Rendering::MaterialQuality level);

  /// @brief Method SetGlobalShaderKeywords, addr 0x67c1b98, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method ToFirstIndex, addr 0x67c1a00, size 0x90, virtual false, abstract: false, final false
