...
/// @brief Method Execute, addr 0x6664fb4, size 0xfc, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "lodBias", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "context", ty: "::UnityEngine::Rendering::BatchCullingContext*", modifiers: "", def_value: None }, CppParam { name: "receiverPlanes", ty: "::UnityEngine::Rendering::ReceiverPlanes*", modifiers: "", def_value: None }, CppParam { name: "receiverSphereCuller", ty: "::UnityEngine::Rendering::ReceiverSphereCuller*", modifiers: "", def_value: None }, CppParam { name: "frustumPlaneCuller", ty: "::UnityEngine::Rendering::FrustumPlaneCuller*", modifiers: "", def_value: None }, CppParam { name: "screenRelativeMetric", ty: "float_t*", modifiers: "", def_value: None }]
constexpr InstanceCuller_SetupCullingJobInput(float_t  lodBias, ::UnityEngine::Rendering::BatchCullingContext*  context, ::UnityEngine::Rendering::ReceiverPlanes*  receiverPlanes, ::UnityEngine::Rendering::ReceiverSphereCuller*  receiverSphereCuller, ::UnityEngine::Rendering::FrustumPlaneCuller*  frustumPlaneCuller, float_t*  screenRelativeMetric) noexcept;
...
// Dependencies System.Object, UnityEngine.Rendering.IndirectBufferContextHandles, UnityEngine.Rendering.InstanceOcclusionTestSubviewSettings, UnityEngine.Rendering.OccluderHandles, UnityEngine.Rendering.OcclusionCullingSettings
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Method .ctor, addr 0x66650b0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__26_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__26_0, put=setStaticF___9__26_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  __9__26_0;

static inline ::UnityEngine::Rendering::InstanceCuller___c* New_ctor() ;

/// @brief Method <InstanceOcclusionTest>b__26_0, addr 0x666510c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6665108, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::InstanceCuller___c* getStaticF___9() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>* getStaticF___9__26_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::InstanceCuller___c*  value) ;

static inline void setStaticF___9__26_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::InstanceCuller_InstanceOcclusionTestPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  value) ;
...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Jobs.JobHandle, UnityEngine.Rendering.IndirectBufferContextStorage, UnityEngine.Rendering.InstanceCullerSplitDebugArray, UnityEngine.Rendering.InstanceOcclusionCullerShaderVariables, UnityEngine.Rendering.InstanceOcclusionEventDebugArray, UnityEngine.Rendering.OcclusionTestComputeShader, UnityEngine.Rendering.ParallelBitArray
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method AddOcclusionCullingDispatch, addr 0x66641b4, size 0xa2c, virtual false, abstract: false, final false
inline void AddOcclusionCullingDispatch(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::ByRef<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, ::ByRef<::UnityEngine::Rendering::IndirectBufferContextHandles>  bufferHandles, ::ByRef<::UnityEngine::Rendering::OccluderHandles>  occluderHandles, ::UnityEngine::Rendering::RenderersBatchersContext*  batchersContext) ;

/// @brief Method ComputeWorstCaseDrawCommandCount, addr 0x6663338, size 0xfc, virtual false, abstract: false, final false
inline int32_t ComputeWorstCaseDrawCommandCount(::ByRef<::UnityEngine::Rendering::BatchCullingContext>  cc, ::UnityEngine::Rendering::BinningConfig  binningConfig, ::UnityEngine::Rendering::CPUDrawInstanceData*  drawInstanceData, int32_t  crossFadedRendererCount) ;

/// @brief Method CreateCompactedVisibilityMaskJob, addr 0x6663c60, size 0x154, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateCompactedVisibilityMaskJob(::ByRef<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::Unity::Collections::NativeArray_1<uint8_t>  rendererVisibilityMasks, ::Unity::Jobs::JobHandle  cullingJobHandle) ;

/// @brief Method CreateCullJobTree, addr 0x6663434, size 0x82c, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateCullJobTree(::ByRef<::UnityEngine::Rendering::BatchCullingContext>  cc, ::UnityEngine::Rendering::BatchCullingOutput  cullingOutput, ::ByRef<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::ByRef<::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly>  sharedInstanceData, ::ByRef<::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly>  instanceDataBuffer, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>  lodGroupCullingData, ::UnityEngine::Rendering::CPUDrawInstanceData*  drawInstanceData, ::Unity::Collections::NativeParallelHashMap_2<uint32_t,::UnityEngine::Rendering::BatchID>  batchIDs, int32_t  crossFadedRendererCount, float_t  smallMeshScreenPercentage, ::UnityEngine::Rendering::OcclusionCullingCommon*  occlusionCullingCommon) ;

/// @brief Method CreateFrustumCullingJob, addr 0x6662ee8, size 0x450, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle CreateFrustumCullingJob(::ByRef<::UnityEngine::Rendering::BatchCullingContext>  cc, ::ByRef<::UnityEngine::Rendering::CPUInstanceData_ReadOnly>  instanceData, ::ByRef<::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly>  sharedInstanceData, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData>  lodGroupCullingData, ::ByRef<::UnityEngine::Rendering::BinningConfig>  binningConfig, float_t  smallMeshScreenPercentage, ::UnityEngine::Rendering::OcclusionCullingCommon*  occlusionCullingCommon, ::Unity::Collections::NativeArray_1<uint8_t>  rendererVisibilityMasks, ::Unity::Collections::NativeArray_1<uint8_t>  rendererCrossFadeValues) ;

/// @brief Method Dispose, addr 0x6664cb0, size 0x128, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeCompactVisibilityMasks, addr 0x6663e48, size 0x5c, virtual false, abstract: false, final false
inline void DisposeCompactVisibilityMasks() ;

/// @brief Method DisposeSceneViewHiddenBits, addr 0x6663ea4, size 0x4, virtual false, abstract: false, final false
inline void DisposeSceneViewHiddenBits() ;

/// @brief Method EnsureValidOcclusionTestResults, addr 0x6663f0c, size 0x2a8, virtual false, abstract: false, final false
inline void EnsureValidOcclusionTestResults(int32_t  viewInstanceID) ;

/// @brief Method FlushDebugCounters, addr 0x6664be0, size 0x34, virtual false, abstract: false, final false
inline void FlushDebugCounters() ;

/// @brief Method GetCompactedVisibilityMasks, addr 0x6663ea8, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ParallelBitArray GetCompactedVisibilityMasks(bool  syncCullingJobs) ;

/// @brief Method Init, addr 0x6662c64, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method InstanceOccludersUpdated, addr 0x6663db4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method InstanceOcclusionTest, addr 0x665aab8, size 0x4d4, virtual false, abstract: false, final false
inline void InstanceOcclusionTest(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::ByRef<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::SubviewOcclusionTest>  subviewOcclusionTests, ::UnityEngine::Rendering::RenderersBatchersContext*  batchersContext) ;

/// @brief Method OnBeginCameraRendering, addr 0x6664c80, size 0x18, virtual false, abstract: false, final false
inline void OnBeginCameraRendering(::UnityEngine::Camera*  camera) ;

/// @brief Method OnBeginSceneViewCameraRendering, addr 0x6664c14, size 0x4, virtual false, abstract: false, final false
inline void OnBeginSceneViewCameraRendering() ;

/// @brief Method OnEndCameraRendering, addr 0x6664c98, size 0x18, virtual false, abstract: false, final false
inline void OnEndCameraRendering(::UnityEngine::Camera*  camera) ;

/// @brief Method OnEndSceneViewCameraRendering, addr 0x6664c18, size 0x4, virtual false, abstract: false, final false
inline void OnEndSceneViewCameraRendering() ;

/// @brief Method UpdateFrame, addr 0x6664c1c, size 0x64, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_CompactedVisibilityMasks", ty: "::UnityEngine::Rendering::ParallelBitArray", modifiers: "", def_value: None }, CppParam { name: "m_CompactedVisibilityMasksJobsHandle", ty: "::Unity::Jobs::JobHandle", modifiers: "", def_value: None }, CppParam { name: "m_IndirectStorage", ty: "::UnityEngine::Rendering::IndirectBufferContextStorage", modifiers: "", def_value: None }, CppParam { name: "m_OcclusionTestShader", ty: "::UnityEngine::Rendering::OcclusionTestComputeShader", modifiers: "", def_value: None }, CppParam { name: "m_ResetDrawArgsKernel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CopyInstancesKernel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CullInstancesKernel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_DebugStats", ty: "::UnityEngine::Rendering::DebugRendererBatcherStats*", modifiers: "", def_value: None }, CppParam { name: "m_SplitDebugArray", ty: "::UnityEngine::Rendering::InstanceCullerSplitDebugArray", modifiers: "", def_value: None }, CppParam { name: "m_OcclusionEventDebugArray", ty: "::UnityEngine::Rendering::InstanceOcclusionEventDebugArray", modifiers: "", def_value: None }, CppParam { name: "m_ProfilingSampleInstanceOcclusionTest", ty: "::UnityEngine::Rendering::ProfilingSampler*", modifiers: "", def_value: None }, CppParam { name: "m_ShaderVariables", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceOcclusionCullerShaderVariables>", modifiers: "", def_value: None }, CppParam { name: "m_ConstantBuffer", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "m_CommandBuffer", ty: "::UnityEngine::Rendering::CommandBuffer*", modifiers: "", def_value: None }]
constexpr InstanceCuller(::UnityEngine::Rendering::ParallelBitArray  m_CompactedVisibilityMasks, ::Unity::Jobs::JobHandle  m_CompactedVisibilityMasksJobsHandle, ::UnityEngine::Rendering::IndirectBufferContextStorage  m_IndirectStorage, ::UnityEngine::Rendering::OcclusionTestComputeShader  m_OcclusionTestShader, int32_t  m_ResetDrawArgsKernel, int32_t  m_CopyInstancesKernel, int32_t  m_CullInstancesKernel, ::UnityEngine::Rendering::DebugRendererBatcherStats*  m_DebugStats, ::UnityEngine::Rendering::InstanceCullerSplitDebugArray  m_SplitDebugArray, ::UnityEngine::Rendering::InstanceOcclusionEventDebugArray  m_OcclusionEventDebugArray, ::UnityEngine::Rendering::ProfilingSampler*  m_ProfilingSampleInstanceOcclusionTest, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceOcclusionCullerShaderVariables>  m_ShaderVariables, ::UnityEngine::ComputeBuffer*  m_ConstantBuffer, ::UnityEngine::Rendering::CommandBuffer*  m_CommandBuffer) noexcept;
