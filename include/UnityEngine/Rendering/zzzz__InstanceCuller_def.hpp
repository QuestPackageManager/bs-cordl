...
public:
  ...
  /// @brief Method Execute, addr 0x66d6fc0, size 0xfc, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66d70bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InstanceOcclusionTest>b__26_0, addr 0x66d7118, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66d7114, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddOcclusionCullingDispatch, addr 0x66d61c0, size 0xa2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeWorstCaseDrawCommandCount, addr 0x66d5344, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCompactedVisibilityMaskJob, addr 0x66d5c6c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateCullJobTree, addr 0x66d5440, size 0x82c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateFrustumCullingJob, addr 0x66d4ef4, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66d6cbc, size 0x128, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeCompactVisibilityMasks, addr 0x66d5e54, size 0x5c, virtual false, abstract: false, final false
  inline void DisposeCompactVisibilityMasks();

  /// @brief Method DisposeSceneViewHiddenBits, addr 0x66d5eb0, size 0x4, virtual false, abstract: false, final false
  inline void DisposeSceneViewHiddenBits();

  /// @brief Method EnsureValidOcclusionTestResults, addr 0x66d5f18, size 0x2a8, virtual false, abstract: false, final false
  inline void EnsureValidOcclusionTestResults(int32_t viewInstanceID);

  /// @brief Method FlushDebugCounters, addr 0x66d6bec, size 0x34, virtual false, abstract: false, final false
  inline void FlushDebugCounters();

  /// @brief Method GetCompactedVisibilityMasks, addr 0x66d5eb4, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ParallelBitArray GetCompactedVisibilityMasks(bool syncCullingJobs);

  /// @brief Method Init, addr 0x66d4c70, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method InstanceOccludersUpdated, addr 0x66d5dc0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method InstanceOcclusionTest, addr 0x66ccac4, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeginCameraRendering, addr 0x66d6c8c, size 0x18, virtual false, abstract: false, final false
  inline void OnBeginCameraRendering(::UnityEngine::Camera* camera);

  /// @brief Method OnBeginSceneViewCameraRendering, addr 0x66d6c20, size 0x4, virtual false, abstract: false, final false
  inline void OnBeginSceneViewCameraRendering();

  /// @brief Method OnEndCameraRendering, addr 0x66d6ca4, size 0x18, virtual false, abstract: false, final false
  inline void OnEndCameraRendering(::UnityEngine::Camera* camera);

  /// @brief Method OnEndSceneViewCameraRendering, addr 0x66d6c24, size 0x4, virtual false, abstract: false, final false
  inline void OnEndSceneViewCameraRendering();

  /// @brief Method UpdateFrame, addr 0x66d6c28, size 0x64, virtual false, abstract: false, final false
