...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DelegateUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DelegateUtility(DelegateUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DelegateUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DelegateUtility(DelegateUtilityconst&) = delete;
