...
public:
  ...
  /// @brief Method Cleanup, addr 0x6651cc0, size 0xc0, virtual false, abstract: false, final false
  static inline void Cleanup();

  /// @brief Method GenerateSkyDirections, addr 0x6651a48, size 0x21c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GenerateSkyDirections();

  /// @brief Method GetRuntimeResources, addr 0x6651878, size 0x64, virtual false, abstract: false, final false
  static inline void GetRuntimeResources(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources> rr);

  /// @brief Method GetSkySamplingDirections, addr 0x6651c64, size 0x5c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetSkySamplingDirections();

  /// @brief Method Initialize, addr 0x66518dc, size 0x16c, virtual false, abstract: false, final false
