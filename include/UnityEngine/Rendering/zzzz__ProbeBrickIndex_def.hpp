...
/// @brief Method Equals, addr 0x65d2e38, size 0x48, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ProbeBrickIndex_Brick  other) ;

/// @brief Method IntersectArea, addr 0x65d2e80, size 0x1a0, virtual false, abstract: false, final false
inline bool IntersectArea(::UnityEngine::Bounds  boundInBricksToCheck) ;

/// @brief Method .ctor, addr 0x65d2e2c, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetNumberOfChunks, addr 0x65d3020, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method AddBricks, addr 0x65d297c, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method BrickOverlapEntry, addr 0x65d25ec, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x65d1f90, size 0x9c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x65d1be8, size 0xb8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeFragmentationRate, addr 0x65d202c, size 0x64, virtual false, abstract: false, final false
inline void ComputeFragmentationRate() ;

/// @brief Method FindSlotsForEntries, addr 0x65d211c, size 0x384, virtual false, abstract: false, final false
...
/// @brief Method GetDebugFragmentationBuffer, addr 0x65d1990, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetDebugFragmentationBuffer() ;

/// @brief Method GetNumberOfChunks, addr 0x65d209c, size 0x80, virtual false, abstract: false, final false
inline int32_t GetNumberOfChunks(int32_t  brickCount) ;

/// @brief Method GetRemainingChunkCount, addr 0x65d1ca0, size 0x8, virtual false, abstract: false, final false
inline int32_t GetRemainingChunkCount() ;

/// @brief Method GetRuntimeResources, addr 0x65d1e9c, size 0xf4, virtual false, abstract: false, final false
inline void GetRuntimeResources(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method LocationToIndex, addr 0x65d2638, size 0x10, virtual false, abstract: false, final false
static inline int32_t LocationToIndex(int32_t  x, int32_t  y, int32_t  z, ::UnityEngine::Vector3Int  sizeOfValid) ;

/// @brief Method MarkBrickInPhysicalBuffer, addr 0x65d2648, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method MergeIndex, addr 0x65d2090, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method RemoveBricks, addr 0x65d2d64, size 0xc8, virtual false, abstract: false, final false
inline void RemoveBricks(::UnityEngine::Rendering::ProbeReferenceVolume_CellIndexInfo*  cellInfo) ;

/// @brief Method ReserveChunks, addr 0x65d24a0, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method SizeOfPhysicalIndexFromBudget, addr 0x65d19a8, size 0x48, virtual false, abstract: false, final false
inline int32_t SizeOfPhysicalIndexFromBudget(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method UpdateDebugData, addr 0x65d1d24, size 0x178, virtual false, abstract: false, final false
inline void UpdateDebugData() ;

/// @brief Method UploadIndexData, addr 0x65d1ca8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65d19f0, size 0x1f8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method get_estimatedVMemCost, addr 0x65d1980, size 0x8, virtual false, abstract: false, final false
inline int32_t get_estimatedVMemCost() ;

/// @brief Method get_fragmentationRate, addr 0x65d1998, size 0x8, virtual false, abstract: false, final false
inline float_t get_fragmentationRate() ;

/// @brief Method set_estimatedVMemCost, addr 0x65d1988, size 0x8, virtual false, abstract: false, final false
inline void set_estimatedVMemCost(int32_t  value) ;

/// @brief Method set_fragmentationRate, addr 0x65d19a0, size 0x8, virtual false, abstract: false, final false
