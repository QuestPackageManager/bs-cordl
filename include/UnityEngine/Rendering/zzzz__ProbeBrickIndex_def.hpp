...
public:
  ...
  /// @brief Method Equals, addr 0x67840c8, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ProbeBrickIndex_Brick other);

  /// @brief Method IntersectArea, addr 0x6784110, size 0x1a0, virtual false, abstract: false, final false
  inline bool IntersectArea(::UnityEngine::Bounds boundInBricksToCheck);

  /// @brief Method .ctor, addr 0x67840bc, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetNumberOfChunks, addr 0x67842b0, size 0x5c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBricks, addr 0x6783c0c, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method BrickOverlapEntry, addr 0x678387c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x6783220, size 0x9c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Clear, addr 0x6782e78, size 0xb8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeFragmentationRate, addr 0x67832bc, size 0x64, virtual false, abstract: false, final false
  inline void ComputeFragmentationRate();

  /// @brief Method FindSlotsForEntries, addr 0x67833ac, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDebugFragmentationBuffer, addr 0x6782c20, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ComputeBuffer* GetDebugFragmentationBuffer();

  /// @brief Method GetNumberOfChunks, addr 0x678332c, size 0x80, virtual false, abstract: false, final false
  inline int32_t GetNumberOfChunks(int32_t brickCount);

  /// @brief Method GetRemainingChunkCount, addr 0x6782f30, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetRemainingChunkCount();

  /// @brief Method GetRuntimeResources, addr 0x678312c, size 0xf4, virtual false, abstract: false, final false
  inline void GetRuntimeResources(::by_ref<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources> rr);

  /// @brief Method LocationToIndex, addr 0x67838c8, size 0x10, virtual false, abstract: false, final false
  static inline int32_t LocationToIndex(int32_t x, int32_t y, int32_t z, ::UnityEngine::Vector3Int sizeOfValid);

  /// @brief Method MarkBrickInPhysicalBuffer, addr 0x67838d8, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeIndex, addr 0x6783320, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBricks, addr 0x6783ff4, size 0xc8, virtual false, abstract: false, final false
  inline void RemoveBricks(::UnityEngine::Rendering::ProbeReferenceVolume_CellIndexInfo* cellInfo);

  /// @brief Method ReserveChunks, addr 0x6783730, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method SizeOfPhysicalIndexFromBudget, addr 0x6782c38, size 0x48, virtual false, abstract: false, final false
  inline int32_t SizeOfPhysicalIndexFromBudget(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget memoryBudget);

  /// @brief Method UpdateDebugData, addr 0x6782fb4, size 0x178, virtual false, abstract: false, final false
  inline void UpdateDebugData();

  /// @brief Method UploadIndexData, addr 0x6782f38, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6782c80, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget memoryBudget);

  /// @brief Method get_estimatedVMemCost, addr 0x6782c10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_estimatedVMemCost();

  /// @brief Method get_fragmentationRate, addr 0x6782c28, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fragmentationRate();

  /// @brief Method set_estimatedVMemCost, addr 0x6782c18, size 0x8, virtual false, abstract: false, final false
  inline void set_estimatedVMemCost(int32_t value);

  /// @brief Method set_fragmentationRate, addr 0x6782c30, size 0x8, virtual false, abstract: false, final false
