...
/// @brief Method Equals, addr 0x66469bc, size 0x48, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ProbeBrickIndex_Brick  other) ;

/// @brief Method IntersectArea, addr 0x6646a04, size 0x1a0, virtual false, abstract: false, final false
inline bool IntersectArea(::UnityEngine::Bounds  boundInBricksToCheck) ;

/// @brief Method .ctor, addr 0x66469b0, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetNumberOfChunks, addr 0x6646ba4, size 0x5c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "entriesInfo", ty: "::ArrayW<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo,::Array<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>*>", modifiers: "", def_value: None }]
constexpr ProbeBrickIndex_CellIndexUpdateInfo(::ArrayW<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo,::Array<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>*>  entriesInfo) noexcept;
...
/// @brief Method AddBricks, addr 0x6646500, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method BrickOverlapEntry, addr 0x6646170, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x6645b14, size 0x9c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x664576c, size 0xb8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeFragmentationRate, addr 0x6645bb0, size 0x64, virtual false, abstract: false, final false
inline void ComputeFragmentationRate() ;

/// @brief Method FindSlotsForEntries, addr 0x6645ca0, size 0x384, virtual false, abstract: false, final false
inline bool FindSlotsForEntries(::ByRef<::ArrayW<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo,::Array<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>*>>  entriesInfo) ;

/// @brief Method GetDebugFragmentationBuffer, addr 0x6645514, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ComputeBuffer* GetDebugFragmentationBuffer() ;

/// @brief Method GetNumberOfChunks, addr 0x6645c20, size 0x80, virtual false, abstract: false, final false
inline int32_t GetNumberOfChunks(int32_t  brickCount) ;

/// @brief Method GetRemainingChunkCount, addr 0x6645824, size 0x8, virtual false, abstract: false, final false
inline int32_t GetRemainingChunkCount() ;

/// @brief Method GetRuntimeResources, addr 0x6645a20, size 0xf4, virtual false, abstract: false, final false
inline void GetRuntimeResources(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method LocationToIndex, addr 0x66461bc, size 0x10, virtual false, abstract: false, final false
static inline int32_t LocationToIndex(int32_t  x, int32_t  y, int32_t  z, ::UnityEngine::Vector3Int  sizeOfValid) ;

/// @brief Method MarkBrickInPhysicalBuffer, addr 0x66461cc, size 0x334, virtual false, abstract: false, final false
inline void MarkBrickInPhysicalBuffer(::ByRef<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>  entry, ::UnityEngine::Vector3Int  brickMin, ::UnityEngine::Vector3Int  brickMax, int32_t  brickSubdivLevel, int32_t  entrySubdivLevel, int32_t  idx) ;

/// @brief Method MergeIndex, addr 0x6645c14, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method RemoveBricks, addr 0x66468e8, size 0xc8, virtual false, abstract: false, final false
inline void RemoveBricks(::UnityEngine::Rendering::ProbeReferenceVolume_CellIndexInfo*  cellInfo) ;

/// @brief Method ReserveChunks, addr 0x6646024, size 0x14c, virtual false, abstract: false, final false
inline bool ReserveChunks(::ArrayW<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo,::Array<::UnityEngine::Rendering::ProbeBrickIndex_IndirectionEntryUpdateInfo>*>  entriesInfo, bool  ignoreErrorLog) ;

/// @brief Method SizeOfPhysicalIndexFromBudget, addr 0x664552c, size 0x48, virtual false, abstract: false, final false
inline int32_t SizeOfPhysicalIndexFromBudget(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method UpdateDebugData, addr 0x66458a8, size 0x178, virtual false, abstract: false, final false
inline void UpdateDebugData() ;

/// @brief Method UploadIndexData, addr 0x664582c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6645574, size 0x1f8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::ProbeVolumeTextureMemoryBudget  memoryBudget) ;

/// @brief Method get_estimatedVMemCost, addr 0x6645504, size 0x8, virtual false, abstract: false, final false
inline int32_t get_estimatedVMemCost() ;

/// @brief Method get_fragmentationRate, addr 0x664551c, size 0x8, virtual false, abstract: false, final false
inline float_t get_fragmentationRate() ;

/// @brief Method set_estimatedVMemCost, addr 0x664550c, size 0x8, virtual false, abstract: false, final false
inline void set_estimatedVMemCost(int32_t  value) ;

/// @brief Method set_fragmentationRate, addr 0x6645524, size 0x8, virtual false, abstract: false, final false
