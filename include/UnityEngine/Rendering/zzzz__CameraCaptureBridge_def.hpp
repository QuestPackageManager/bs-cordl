...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CameraCaptureBridge_CameraEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CameraCaptureBridge_CameraEntry(CameraCaptureBridge_CameraEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CameraCaptureBridge_CameraEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CameraCaptureBridge_CameraEntry(CameraCaptureBridge_CameraEntryconst&) = delete;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CameraCaptureBridge", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CameraCaptureBridge(CameraCaptureBridge&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CameraCaptureBridge", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CameraCaptureBridge(CameraCaptureBridgeconst&) = delete;
