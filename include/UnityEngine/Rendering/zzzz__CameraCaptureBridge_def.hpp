...
public:
  ...
  /// @brief Method .ctor, addr 0x66780dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCaptureAction, addr 0x6677ed4, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCachedCaptureActionsEnumerator, addr 0x6677d80, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCaptureActions, addr 0x6677c64, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier, ::UnityEngine::Rendering::CommandBuffer*>*>*
  GetCaptureActions(::UnityEngine::Camera* camera);

  /// @brief Method RemoveCaptureAction, addr 0x66780e0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method get_enabled, addr 0x6677ba4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enabled, addr 0x6677c00, size 0x64, virtual false, abstract: false, final false
