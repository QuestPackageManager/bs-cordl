...
/// @brief Field actions, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_actions, put=__cordl_internal_set_actions)) ::System::Collections::Generic::HashSet_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>*  actions;

/// @brief Field cachedEnumerator, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_cachedEnumerator, put=__cordl_internal_set_cachedEnumerator)) ::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>*  cachedEnumerator;

static inline ::UnityEngine::Rendering::CameraCaptureBridge_CameraEntry* New_ctor() ;

constexpr ::System::Collections::Generic::HashSet_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>* const& __cordl_internal_get_actions() const;
...
constexpr ::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>* const& __cordl_internal_get_cachedEnumerator() const;

constexpr ::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>*& __cordl_internal_get_cachedEnumerator() ;

constexpr void __cordl_internal_set_actions(::System::Collections::Generic::HashSet_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>*  value) ;

constexpr void __cordl_internal_set_cachedEnumerator(::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>*  value) ;

/// @brief Method .ctor, addr 0x66060d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field actionDict, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_actionDict, put=setStaticF_actionDict)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Camera>,::UnityEngine::Rendering::CameraCaptureBridge_CameraEntry*>*  actionDict;

/// @brief Method AddCaptureAction, addr 0x6605ec8, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method GetCachedCaptureActionsEnumerator, addr 0x6605d74, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method GetCaptureActions, addr 0x6605c58, size 0x11c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IEnumerator_1<::System::Action_2<::UnityEngine::Rendering::RenderTargetIdentifier,::UnityEngine::Rendering::CommandBuffer*>*>* GetCaptureActions(::UnityEngine::Camera*  camera) ;

/// @brief Method RemoveCaptureAction, addr 0x66060d4, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method get_enabled, addr 0x6605b98, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method set_enabled, addr 0x6605bf4, size 0x64, virtual false, abstract: false, final false
