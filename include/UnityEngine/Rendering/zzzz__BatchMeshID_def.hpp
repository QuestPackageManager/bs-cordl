...
public:
  ...
  /// @brief Method Equals, addr 0x69d1c98, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69d1d48, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::BatchMeshID other);

  /// @brief Method GetHashCode, addr 0x69d1c90, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69d1d58, size 0x68, virtual false, abstract: false, final false
