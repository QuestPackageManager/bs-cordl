...
public:
  ...
  /// @brief Method .ctor, addr 0x664315c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW pageName, ::StringW pageHash);

  /// @brief Method get_URL, addr 0x66431c4, size 0x14, virtual true, abstract: false, final false
  inline ::StringW get_URL();

  /// @brief Method get_pageHash, addr 0x6643154, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_pageHash();

  /// @brief Method get_pageName, addr 0x664314c, size 0x8, virtual false, abstract: false, final false
