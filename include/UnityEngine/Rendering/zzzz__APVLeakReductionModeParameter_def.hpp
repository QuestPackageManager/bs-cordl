...
public:
  ...
  /// @brief Method .ctor, addr 0x6798c24, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "APVLeakReductionModeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  APVLeakReductionModeParameter(APVLeakReductionModeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "APVLeakReductionModeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  APVLeakReductionModeParameter(APVLeakReductionModeParameterconst&) = delete;
