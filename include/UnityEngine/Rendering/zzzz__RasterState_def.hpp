...
/// @brief Method Equals, addr 0x69cae74, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x69cadf8, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RasterState  other) ;

/// @brief Method GetHashCode, addr 0x69caf28, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x69cad64, size 0x94, virtual false, abstract: false, final false
