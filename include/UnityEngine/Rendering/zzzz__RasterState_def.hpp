...
public:
  ...
  /// @brief Method Equals, addr 0x69c92fc, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c9280, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RasterState other);

  /// @brief Method GetHashCode, addr 0x69c93b0, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69c91ec, size 0x94, virtual false, abstract: false, final false
