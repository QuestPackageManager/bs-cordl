...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::Rendering::DynamicResScalePolicyType", modifiers: "", def_value: Some("{}") }, CppParam { name: "method", ty: "::UnityEngine::Rendering::PerformDynamicRes*", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::DynamicResolutionHandler_ScalerContainer::DynamicResolutionHandler_ScalerContainer(::UnityEngine::Rendering::DynamicResScalePolicyType  type, ::UnityEngine::Rendering::PerformDynamicRes*  method) noexcept  {
this->type = type;
this->method = method;
}
// Ctor Parameters []
...
constexpr ::UnityEngine::Rendering::DynamicResolutionHandler_UpsamplerScheduleType  UnityEngine::Rendering::DynamicResolutionHandler_UpsamplerScheduleType::AfterDepthOfField{static_cast<int32_t>(0x1)};
