...
// modifiers: "", def_value: Some("{}") }, CppParam { name: "cullingPlanes", ty: "::cordl_internals::Ptr<::UnityEngine::Plane>", modifiers: "", def_value: Some("{}") }, CppParam { name:
...
// def_value: Some("{}") }, CppParam { name: "cullingSplitCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "viewType", ty:
...
// "", def_value: Some("{}") }, CppParam { name: "drawCommands", ty: "::cordl_internals::Ptr<::UnityEngine::Rendering::BatchCullingOutputDrawCommands>", modifiers: "", def_value: Some("{}") }]
