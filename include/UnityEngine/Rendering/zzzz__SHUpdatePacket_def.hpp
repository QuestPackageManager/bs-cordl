...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::SHUpdatePacket, 0x6c>, "Size mismatch!");

} // namespace UnityEngine::Rendering
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::SHUpdatePacket, "UnityEngine.Rendering", "SHUpdatePacket");
