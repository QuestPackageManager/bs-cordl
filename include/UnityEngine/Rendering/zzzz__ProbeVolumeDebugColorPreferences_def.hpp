...
public:
  ...
  /// @brief Method .ctor, addr 0x6791c68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProbeVolumeDebugColorPreferences", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProbeVolumeDebugColorPreferences(ProbeVolumeDebugColorPreferences&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProbeVolumeDebugColorPreferences", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProbeVolumeDebugColorPreferences(ProbeVolumeDebugColorPreferencesconst&) = delete;
