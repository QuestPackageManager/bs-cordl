...
template <typename T> inline void UnityEngine::Rendering::HashSetPool_1___c<T>::setStaticF___9(::UnityEngine::Rendering::HashSetPool_1___c<T>* value) {
  ::cordl_internals::setStaticField<::UnityEngine::Rendering::HashSetPool_1___c<T>*, "<>9",
...
template <typename T> inline ::UnityEngine::Rendering::HashSetPool_1___c<T>* UnityEngine::Rendering::HashSetPool_1___c<T>::getStaticF___9() {
  return ::cordl_internals::getStaticField<::UnityEngine::Rendering::HashSetPool_1___c<T>*, "<>9",
                                           ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get>();
}
template <typename T> inline void UnityEngine::Rendering::HashSetPool_1___c<T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get(), ".ctor",
...
template <typename T> inline void UnityEngine::Rendering::HashSetPool_1___c<T>::__cctor_b__4_0(::System::Collections::Generic::HashSet_1<T>* l) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get(), "<.cctor>b__4_0", std::span<Il2CppClass const* const, 0>(),
