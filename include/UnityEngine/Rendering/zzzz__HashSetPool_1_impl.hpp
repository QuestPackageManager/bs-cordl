...
::cordl_internals::setStaticField<::UnityEngine::Rendering::HashSetPool_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get>(std::forward<::UnityEngine::Rendering::HashSetPool_1___c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::Rendering::HashSetPool_1___c<T>* UnityEngine::Rendering::HashSetPool_1___c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::HashSetPool_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get>();
}
template<typename T>
inline void UnityEngine::Rendering::HashSetPool_1___c<T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1___c<T>*>::get(),
                        ".ctor",
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::HashSetPool_1___c<T>*>());
}
// Ctor Parameters []
template<typename T>
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::HashSet_1<T>*>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1<T>*>::get>(std::forward<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::HashSet_1<T>*>*>(value));
}
template<typename T>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::HashSet_1<T>*>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1<T>*>::get>();
}
template<typename T>
...
template<typename T>
inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::HashSet_1<T>*> UnityEngine::Rendering::HashSetPool_1<T>::Get(::ByRef<::System::Collections::Generic::HashSet_1<T>*>  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::HashSetPool_1<T>*>::get(),
                        "Get",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::HashSet_1<T>*>, false>(nullptr, ___internal_method, value);
}
template<typename T>
