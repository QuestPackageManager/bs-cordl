...
public:
  ...
  /// @brief Method .ctor, addr 0x6688274, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t min, bool overrideState);

  /// @brief Method get_value, addr 0x6688258, size 0x8, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_value, addr 0x6688260, size 0x14, virtual true, abstract: false, final false
