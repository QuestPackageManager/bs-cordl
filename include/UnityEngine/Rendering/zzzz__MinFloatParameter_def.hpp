...
public:
  ...
  /// @brief Method .ctor, addr 0x67ccd10, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t min, bool overrideState);

  /// @brief Method get_value, addr 0x67cccf4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_value, addr 0x67cccfc, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MinFloatParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MinFloatParameter(MinFloatParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MinFloatParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MinFloatParameter(MinFloatParameterconst&) = delete;
