...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::Rendering::OcclusionTestMethods);
...
public:
  // Declarations
  /// @brief Method GetBatchLayerMask, addr 0x66d1b5c, size 0x10, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::OcclusionTestMethods, 0x10>, "Size mismatch!");

} // namespace UnityEngine::Rendering
NEED_NO_BOX(::UnityEngine::Rendering::OcclusionTestMethods);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionTestMethods*, "UnityEngine.Rendering", "OcclusionTestMethods");
