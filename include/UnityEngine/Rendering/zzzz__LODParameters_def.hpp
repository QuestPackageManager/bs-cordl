...
/// @brief Method Equals, addr 0x69cacc8, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x69c8ca4, size 0xd0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::LODParameters  other) ;

/// @brief Method GetHashCode, addr 0x69c90e0, size 0x9c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_cameraPosition, addr 0x69cacac, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_cameraPosition() ;

/// @brief Method get_fieldOfView, addr 0x69cacb8, size 0x8, virtual false, abstract: false, final false
inline float_t get_fieldOfView() ;

/// @brief Method get_isOrthographic, addr 0x69cac4c, size 0x60, virtual false, abstract: false, final false
inline bool get_isOrthographic() ;

/// @brief Method get_orthoSize, addr 0x69cacc0, size 0x8, virtual false, abstract: false, final false
