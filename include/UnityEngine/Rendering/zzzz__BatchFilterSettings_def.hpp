...
public:
  ...
  /// @brief Method set_allDepthSorted, addr 0x69d1ed4, size 0x8, virtual false, abstract: false, final false
  inline void set_allDepthSorted(bool value);

  /// @brief Method set_batchLayer, addr 0x69d1eac, size 0x8, virtual false, abstract: false, final false
  inline void set_batchLayer(uint8_t value);

  /// @brief Method set_motionMode, addr 0x69d1eb4, size 0x8, virtual false, abstract: false, final false
  inline void set_motionMode(::UnityEngine::MotionVectorGenerationMode value);

  /// @brief Method set_receiveShadows, addr 0x69d1ec4, size 0x8, virtual false, abstract: false, final false
  inline void set_receiveShadows(bool value);

  /// @brief Method set_shadowCastingMode, addr 0x69d1ebc, size 0x8, virtual false, abstract: false, final false
  inline void set_shadowCastingMode(::UnityEngine::Rendering::ShadowCastingMode value);

  /// @brief Method set_staticShadowCaster, addr 0x69d1ecc, size 0x8, virtual false, abstract: false, final false
