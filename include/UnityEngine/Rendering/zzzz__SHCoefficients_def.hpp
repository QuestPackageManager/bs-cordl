...
public:
  ...
  /// @brief Method Equals, addr 0x67afd50, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x67afb44, size 0x20c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SHCoefficients other);

  /// @brief Method GetHashCode, addr 0x67afde4, size 0x17c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSHA, addr 0x67af99c, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetSHA(::UnityEngine::Rendering::SphericalHarmonicsL2 sh, int32_t i);

  /// @brief Method GetSHB, addr 0x67afa44, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetSHB(::UnityEngine::Rendering::SphericalHarmonicsL2 sh, int32_t i);

  /// @brief Method GetSHC, addr 0x67afad8, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetSHC(::UnityEngine::Rendering::SphericalHarmonicsL2 sh);

  /// @brief Method .ctor, addr 0x67af844, size 0x158, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::SphericalHarmonicsL2 sh);

  /// @brief Method .ctor, addr 0x67afaec, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x67aff60, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Rendering::SHCoefficients left, ::UnityEngine::Rendering::SHCoefficients right);

  /// @brief Method op_Inequality, addr 0x67aff94, size 0x38, virtual false, abstract: false, final false
