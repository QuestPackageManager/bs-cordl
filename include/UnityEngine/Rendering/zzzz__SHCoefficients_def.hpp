...
/// @brief Method Equals, addr 0x65feac0, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x65fe8b4, size 0x20c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::SHCoefficients  other) ;

/// @brief Method GetHashCode, addr 0x65feb54, size 0x17c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSHA, addr 0x65fe70c, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetSHA(::UnityEngine::Rendering::SphericalHarmonicsL2  sh, int32_t  i) ;

/// @brief Method GetSHB, addr 0x65fe7b4, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetSHB(::UnityEngine::Rendering::SphericalHarmonicsL2  sh, int32_t  i) ;

/// @brief Method GetSHC, addr 0x65fe848, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetSHC(::UnityEngine::Rendering::SphericalHarmonicsL2  sh) ;

/// @brief Method .ctor, addr 0x65fe5b4, size 0x158, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::SphericalHarmonicsL2  sh) ;

/// @brief Method .ctor, addr 0x65fe85c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x65fecd0, size 0x34, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::Rendering::SHCoefficients  left, ::UnityEngine::Rendering::SHCoefficients  right) ;

/// @brief Method op_Inequality, addr 0x65fed04, size 0x38, virtual false, abstract: false, final false
