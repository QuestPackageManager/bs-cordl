...
// Ctor Parameters [CppParam { name: "lodGroupID", ty: "int32_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lodOffset", ty: "int32_t*", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "lodCount", ty: "int32_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fadeMode", ty: "::UnityEngine::LODFadeMode*",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "worldSpaceReferencePoint", ty: "::UnityEngine::Vector3*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "worldSpaceSize", ty: "float_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "renderersCount", ty: "int16_t*", modifiers: "", def_value: Some("{}"), comment: None
// }, CppParam { name: "lastLODIsBillboard", ty: "bool*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lodGroupCount", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "invalidLODGroupID", ty: "int32_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "invalidLODGroupCount", ty: "int32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "lodRenderersCount", ty: "int16_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "lodScreenRelativeTransitionHeight", ty: "float_t*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lodFadeTransitionWidth", ty: "float_t*", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "lodDataCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
