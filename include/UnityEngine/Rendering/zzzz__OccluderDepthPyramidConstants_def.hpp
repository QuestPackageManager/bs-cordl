...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer, "UnityEngine.Rendering", "OccluderDepthPyramidConstants/<_InvViewProjMatrix>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer, "UnityEngine.Rendering", "OccluderDepthPyramidConstants/<_MipOffsetAndSize>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer, "UnityEngine.Rendering", "OccluderDepthPyramidConstants/<_SilhouettePlanes>e__FixedBuffer");
