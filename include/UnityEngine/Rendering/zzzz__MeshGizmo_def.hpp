...
/// @brief Method AddWireCube, addr 0x6684a30, size 0x220, virtual false, abstract: false, final false
inline void AddWireCube(::UnityEngine::Vector3  center, ::UnityEngine::Vector3  size, ::UnityEngine::Color  color) ;

/// @brief Method Clear, addr 0x6684988, size 0xa8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x668516c, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DrawMesh, addr 0x6684f74, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method RenderWireframe, addr 0x6685130, size 0x3c, virtual false, abstract: false, final false
inline void RenderWireframe(::UnityEngine::Matrix4x4  trs, ::UnityEngine::Rendering::CompareFunction  depthTest, ::StringW  gizmoName) ;

/// @brief Method <AddWireCube>g__AddEdge|10_0, addr 0x6684c50, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6684814, size 0x174, virtual false, abstract: false, final false
