...
public:
  // Declarations
  /// @brief Method Clone, addr 0x67ce400, size 0xe8, virtual true, abstract: false, final false
  inline ::System::Object* Clone();

  /// @brief Method GetHashCode, addr 0x67ce4e8, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Interp, addr 0x67ce354, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x67ce360, size 0xa0, virtual true, abstract: false, final false
  inline void SetValue(::UnityEngine::Rendering::VolumeParameter* parameter);

  /// @brief Method .ctor, addr 0x67ce2f0, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  AnimationCurveParameter(AnimationCurveParameterconst&) = delete;
