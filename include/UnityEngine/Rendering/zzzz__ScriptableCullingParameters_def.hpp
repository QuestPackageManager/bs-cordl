...
public:
  ...
  /// @brief Method Equals, addr 0x2e40bec, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2e404ac, size 0x740, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ScriptableCullingParameters other);

  /// @brief Method GetCullingPlane, addr 0x2e403bc, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::Plane GetCullingPlane(int32_t index);

  /// @brief Method GetHashCode, addr 0x2e40ca4, size 0x6a8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetLayerCullingDistance, addr 0x2e402dc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cullingPlaneCount, addr 0x2e402d4, size 0x8, virtual false, abstract: false, final false
