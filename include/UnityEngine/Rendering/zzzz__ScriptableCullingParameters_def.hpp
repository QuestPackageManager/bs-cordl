...
public:
  ...
  /// @brief Method Equals, addr 0x69c71fc, size 0x100, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c6ca4, size 0x488, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ScriptableCullingParameters other);

  /// @brief Method GetCullingPlane, addr 0x69c6b78, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::Plane GetCullingPlane(int32_t index);

  /// @brief Method GetHashCode, addr 0x69c72fc, size 0x26c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetLayerCullingDistance, addr 0x69c6ab8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cullingOptions, addr 0x69c6a50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CullingOptions get_cullingOptions();

  /// @brief Method get_cullingPlaneCount, addr 0x69c6a40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cullingPlaneCount();

  /// @brief Method get_stereoProjectionMatrix, addr 0x69c6a80, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_conservativeEnclosingSphere, addr 0x69c6a30, size 0x8, virtual false, abstract: false, final false
  inline void set_conservativeEnclosingSphere(bool value);

  /// @brief Method set_cullingOptions, addr 0x69c6a58, size 0x8, virtual false, abstract: false, final false
  inline void set_cullingOptions(::UnityEngine::Rendering::CullingOptions value);

  /// @brief Method set_maximumVisibleLights, addr 0x69c6a28, size 0x8, virtual false, abstract: false, final false
  inline void set_maximumVisibleLights(int32_t value);

  /// @brief Method set_numIterationsEnclosingSphere, addr 0x69c6a38, size 0x8, virtual false, abstract: false, final false
  inline void set_numIterationsEnclosingSphere(int32_t value);

  /// @brief Method set_reflectionProbeSortingCriteria, addr 0x69c6a60, size 0x8, virtual false, abstract: false, final false
  inline void set_reflectionProbeSortingCriteria(::UnityEngine::Rendering::ReflectionProbeSortingCriteria value);

  /// @brief Method set_shadowDistance, addr 0x69c6a48, size 0x8, virtual false, abstract: false, final false
  inline void set_shadowDistance(float_t value);

  /// @brief Method set_stereoProjectionMatrix, addr 0x69c6a98, size 0x18, virtual false, abstract: false, final false
  inline void set_stereoProjectionMatrix(::UnityEngine::Matrix4x4 value);

  /// @brief Method set_stereoSeparationDistance, addr 0x69c6ab0, size 0x8, virtual false, abstract: false, final false
  inline void set_stereoSeparationDistance(float_t value);

  /// @brief Method set_stereoViewMatrix, addr 0x69c6a68, size 0x18, virtual false, abstract: false, final false
