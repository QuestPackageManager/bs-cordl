...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::CameraEvent, "UnityEngine.Rendering", "CameraEvent");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::CameraEvent) == 0x4, "Size mismatch!");
