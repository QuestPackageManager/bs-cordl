...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x6617740, size 0x108, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::UnityEngine::Rendering::NoInterpCubemapParameter* New_ctor(::UnityEngine::Cubemap*  value, bool  overrideState) ;

/// @brief Method .ctor, addr 0x66176dc, size 0x64, virtual false, abstract: false, final false
