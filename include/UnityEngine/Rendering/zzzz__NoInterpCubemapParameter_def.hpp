...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInterpCubemapParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInterpCubemapParameter(NoInterpCubemapParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInterpCubemapParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInterpCubemapParameter(NoInterpCubemapParameterconst&) = delete;
