...
public:
  ...
  /// @brief Method Equals, addr 0x6654b78, size 0xd8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method GetHashCode, addr 0x6654c50, size 0x114, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::SphericalHarmonicsL1 getStaticF_zero();

  /// @brief Method op_Addition, addr 0x6654998, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Division, addr 0x6654a08, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6654a2c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x6654adc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Multiply, addr 0x66549e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Subtraction, addr 0x66549c0, size 0x28, virtual false, abstract: false, final false
