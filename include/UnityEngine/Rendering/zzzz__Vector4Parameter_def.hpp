...
public:
  // Declarations
  /// @brief Method Interp, addr 0x67c7ea4, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c7e20, size 0x84, virtual false, abstract: false, final false
