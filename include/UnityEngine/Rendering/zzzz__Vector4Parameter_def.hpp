...
public:
// Declarations
/// @brief Method Interp, addr 0x668a798, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x668a714, size 0x84, virtual false, abstract: false, final false
