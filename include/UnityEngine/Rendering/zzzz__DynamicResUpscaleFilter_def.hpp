...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DynamicResUpscaleFilter, "UnityEngine.Rendering", "DynamicResUpscaleFilter");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::DynamicResUpscaleFilter) == 0x1, "Size mismatch!");
