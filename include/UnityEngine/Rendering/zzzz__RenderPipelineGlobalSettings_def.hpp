...
/// @brief Method Contains, addr 0x6958378, size 0x90, virtual false, abstract: false, final false
...
inline bool GetSettingsImplementingInterface(::ByRef<::System::Collections::Generic::List_1<TSettingsInterfaceType>*>  settings) ;

static inline ::UnityEngine::Rendering::RenderPipelineGlobalSettings* New_ctor() ;

/// @brief Method OnAfterDeserialize, addr 0x695840c, size 0x4, virtual true, abstract: false, final false
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x6958408, size 0x4, virtual true, abstract: false, final false
inline void OnBeforeSerialize() ;

/// @brief Method RecreateSettingsMap, addr 0x6958144, size 0x150, virtual false, abstract: false, final false
inline void RecreateSettingsMap() ;

/// @brief Method TryGet, addr 0x6958294, size 0xe4, virtual false, abstract: false, final false
...
template<typename TSettingsInterfaceType>
inline bool TryGetFirstSettingsImplementingInterface(::ByRef<TSettingsInterfaceType>  settings) ;
...
/// @brief Method .ctor, addr 0x6958410, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_settingsList, addr 0x6957ef0, size 0x24c, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>* get_settingsList() ;

/// @brief Method get_settingsMap, addr 0x695813c, size 0x8, virtual false, abstract: false, final false
