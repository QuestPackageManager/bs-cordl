...
public:
  ...
  /// @brief Method Contains, addr 0x6b1fa74, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterDeserialize, addr 0x6b1fb08, size 0x4, virtual true, abstract: false, final false
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x6b1fb04, size 0x4, virtual true, abstract: false, final false
  inline void OnBeforeSerialize();

  /// @brief Method RecreateSettingsMap, addr 0x6b1f840, size 0x150, virtual false, abstract: false, final false
  inline void RecreateSettingsMap();

  /// @brief Method TryGet, addr 0x6b1f990, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b1fb0c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsList, addr 0x6b1f5ec, size 0x24c, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::IRenderPipelineGraphicsSettings*>* get_settingsList();

  /// @brief Method get_settingsMap, addr 0x6b1f838, size 0x8, virtual false, abstract: false, final false
