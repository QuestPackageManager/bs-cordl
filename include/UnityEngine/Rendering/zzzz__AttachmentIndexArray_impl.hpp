...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::AttachmentIndexArray::*)(int32_t)>(&::UnityEngine::Rendering::AttachmentIndexArray::_ctor)> {
  constexpr static std::size_t size = 0x90;
  constexpr static std::size_t addrs = 0x69c6d58;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::AttachmentIndexArray::*)(int32_t)>(&::UnityEngine::Rendering::AttachmentIndexArray::get_Item)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x69c6de8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::AttachmentIndexArray::*)(int32_t, int32_t)>(&::UnityEngine::Rendering::AttachmentIndexArray::set_Item)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x69c6e98;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::AttachmentIndexArray::*)()>(&::UnityEngine::Rendering::AttachmentIndexArray::get_Length)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x69c6f48;
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::AttachmentIndexArray, "Emtpy", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::AttachmentIndexArray>::get>(std::forward<::UnityEngine::Rendering::AttachmentIndexArray>(value));
}
inline ::UnityEngine::Rendering::AttachmentIndexArray UnityEngine::Rendering::AttachmentIndexArray::getStaticF_Emtpy()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::AttachmentIndexArray, "Emtpy", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::AttachmentIndexArray>::get>();
}
