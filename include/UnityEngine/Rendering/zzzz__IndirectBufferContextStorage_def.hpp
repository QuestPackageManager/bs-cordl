...
public:
  ...
  /// @brief Method AllocateDrawBuffers, addr 0x66eb854, size 0x134, virtual false, abstract: false, final false
  inline void AllocateDrawBuffers(int32_t maxDrawCount);

  /// @brief Method AllocateInstanceBuffers, addr 0x66eb724, size 0x130, virtual false, abstract: false, final false
  inline void AllocateInstanceBuffers(int32_t maxInstanceCount);

  /// @brief Method ClearContextsAndGrowBuffers, addr 0x66ebee4, size 0x20, virtual false, abstract: false, final false
  inline void ClearContextsAndGrowBuffers();

  /// @brief Method CopyFromStaging, addr 0x66ec1b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66ebb30, size 0xd0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FreeDrawBuffers, addr 0x66ebac0, size 0x70, virtual false, abstract: false, final false
  inline void FreeDrawBuffers();

  /// @brief Method FreeInstanceBuffers, addr 0x66eba50, size 0x70, virtual false, abstract: false, final false
  inline void FreeInstanceBuffers();

  /// @brief Method GetAllocInfo, addr 0x66ec120, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::IndirectBufferAllocInfo GetAllocInfo(int32_t contextIndex);

  /// @brief Method GetAllocInfoSubArray, addr 0x66ec0c0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBufferContext, addr 0x66ec288, size 0xe0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::IndirectBufferContext GetBufferContext(int32_t contextIndex);

  /// @brief Method GetLimits, addr 0x66ec274, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::IndirectBufferLimits GetLimits(int32_t contextIndex);

  /// @brief Method GrowBuffers, addr 0x66ebd20, size 0x1c4, virtual false, abstract: false, final false
  inline void GrowBuffers();

  /// @brief Method ImportBuffers, addr 0x66eb4f0, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x66eb5e8, size 0x13c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method ResetAllocators, addr 0x66eb988, size 0xc8, virtual false, abstract: false, final false
  inline void ResetAllocators();

  /// @brief Method SetBufferContext, addr 0x66ec368, size 0xd4, virtual false, abstract: false, final false
  inline void SetBufferContext(int32_t contextIndex, ::UnityEngine::Rendering::IndirectBufferContext ctx);

  /// @brief Method SyncContexts, addr 0x66ebc00, size 0x120, virtual false, abstract: false, final false
  inline void SyncContexts();

  /// @brief Method TryAllocateContext, addr 0x66ebf04, size 0x148, virtual false, abstract: false, final false
  inline int32_t TryAllocateContext(int32_t viewID);

  /// @brief Method TryGetContextIndex, addr 0x66ec04c, size 0x74, virtual false, abstract: false, final false
  inline int32_t TryGetContextIndex(int32_t viewID);

  /// @brief Method get_allocationCounters, addr 0x66eb5dc, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<int32_t> get_allocationCounters();

  /// @brief Method get_argsBuffer, addr 0x66eb4b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* get_argsBuffer();

  /// @brief Method get_drawInfoBuffer, addr 0x66eb4b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* get_drawInfoBuffer();

  /// @brief Method get_drawInfoGlobalArray, addr 0x66eb5d0, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectDrawInfo> get_drawInfoGlobalArray();

  /// @brief Method get_indirectArgsBufferHandle, addr 0x66eb4d8, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBufferHandle get_indirectArgsBufferHandle();

  /// @brief Method get_instanceBuffer, addr 0x66eb4a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* get_instanceBuffer();

  /// @brief Method get_instanceInfoBuffer, addr 0x66eb4a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GraphicsBuffer* get_instanceInfoBuffer();

  /// @brief Method get_instanceInfoGlobalArray, addr 0x66eb5c4, size 0xc, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::IndirectInstanceInfo> get_instanceInfoGlobalArray();

  /// @brief Method get_visibleInstanceBufferHandle, addr 0x66eb4c0, size 0x18, virtual false, abstract: false, final false
