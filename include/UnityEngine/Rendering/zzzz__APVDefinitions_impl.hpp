...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::APVDefinitions::*)()>(&::UnityEngine::Rendering::APVDefinitions::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6656420;
...
::cordl_internals::setStaticField<int32_t, "probeIndexChunkSize", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::APVDefinitions*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<int32_t, "probeMaxRegionCount", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::APVDefinitions*>::get>(std::forward<int32_t>(value));
}
...
::cordl_internals::setStaticField<::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>, "layerMaskColors", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::APVDefinitions*>::get>(std::forward<::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>, "layerMaskColors", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::APVDefinitions*>::get>();
}
inline void UnityEngine::Rendering::APVDefinitions::setStaticF_debugEmptyColor(::UnityEngine::Color  value)  {
::cordl_internals::setStaticField<::UnityEngine::Color, "debugEmptyColor", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::APVDefinitions*>::get>(std::forward<::UnityEngine::Color>(value));
}
