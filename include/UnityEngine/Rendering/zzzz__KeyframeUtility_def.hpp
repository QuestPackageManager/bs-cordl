...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyframeUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyframeUtility(KeyframeUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyframeUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyframeUtility(KeyframeUtilityconst&) = delete;
