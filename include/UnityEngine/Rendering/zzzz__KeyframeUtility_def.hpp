...
public:
  // Declarations
  /// @brief Method EvalCurveSegmentAndDeriv, addr 0x6684b78, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method EvalKeyAtTime, addr 0x6684c44, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchKeyFromIndexClampEdge, addr 0x6684ae8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyframeAndClampEdge, addr 0x66849f8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method InterpAnimationCurve, addr 0x6684ce8, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method LerpSingleKeyframe, addr 0x66849a0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAnimationCurve, addr 0x668498c, size 0x14, virtual false, abstract: false, final false
  static inline void ResetAnimationCurve(::UnityEngine::AnimationCurve* curve);

  /// @brief Method .ctor, addr 0x6685260, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
