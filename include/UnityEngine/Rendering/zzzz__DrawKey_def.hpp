...
/// @brief Method Equals, addr 0x6660040, size 0x158, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::DrawKey  other) ;

/// @brief Method GetHashCode, addr 0x6660198, size 0x70, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "meshID", ty: "::UnityEngine::Rendering::BatchMeshID", modifiers: "", def_value: None }, CppParam { name: "submeshIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "materialID", ty: "::UnityEngine::Rendering::BatchMaterialID", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::BatchDrawCommandFlags", modifiers: "", def_value: None }, CppParam { name: "transparentInstanceId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "overridenComponents", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "range", ty: "::UnityEngine::Rendering::RangeKey", modifiers: "", def_value: None }, CppParam { name: "lightmapIndex", ty: "int32_t", modifiers: "", def_value: None }]
constexpr DrawKey(::UnityEngine::Rendering::BatchMeshID  meshID, int32_t  submeshIndex, ::UnityEngine::Rendering::BatchMaterialID  materialID, ::UnityEngine::Rendering::BatchDrawCommandFlags  flags, int32_t  transparentInstanceId, uint32_t  overridenComponents, ::UnityEngine::Rendering::RangeKey  range, int32_t  lightmapIndex) noexcept;
