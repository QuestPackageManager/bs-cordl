...
public:
  ...
  /// @brief Method Equals, addr 0x65f7df4, size 0x158, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::DrawKey other);

  /// @brief Method GetHashCode, addr 0x65f7f4c, size 0x70, virtual true, abstract: false, final false
