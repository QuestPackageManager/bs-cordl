...
public:
  // Declarations
  /// @brief Method FromFloat4x4, addr 0x66e3210, size 0x40, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::PackedMatrix FromFloat4x4(::ByRef<::Unity::Mathematics::float4x4> m);

  /// @brief Method FromMatrix4x4, addr 0x66e31d0, size 0x40, virtual false, abstract: false, final false
