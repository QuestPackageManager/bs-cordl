...
/// @brief Method BeginCameraRendering, addr 0x6957384, size 0x68, virtual false, abstract: false, final false
static inline void BeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method BeginContextRendering, addr 0x6957224, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x69577e4, size 0x7c, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Dispose, addr 0x6957860, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndCameraRendering, addr 0x69575e4, size 0x68, virtual false, abstract: false, final false
static inline void EndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method EndContextRendering, addr 0x6957480, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method InternalRender, addr 0x695775c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Render, addr 0x69576e0, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x695786c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultSettings, addr 0x6957864, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::RenderPipelineGlobalSettings> get_defaultSettings() ;

/// @brief Method get_disposed, addr 0x69577d4, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method set_disposed, addr 0x69577dc, size 0x8, virtual false, abstract: false, final false
