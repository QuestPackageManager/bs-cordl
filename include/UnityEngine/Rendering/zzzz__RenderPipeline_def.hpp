...
public:
  ...
  /// @brief Method BeginCameraRendering, addr 0x69c95cc, size 0x68, virtual false, abstract: false, final false
  static inline void BeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method BeginContextRendering, addr 0x69c946c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x69c9a2c, size 0x7c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Dispose, addr 0x69c9aa8, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EndCameraRendering, addr 0x69c982c, size 0x68, virtual false, abstract: false, final false
  static inline void EndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method EndContextRendering, addr 0x69c96c8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRender, addr 0x69c99a4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x69c9928, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69c9ab4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_defaultSettings, addr 0x69c9aac, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::RenderPipelineGlobalSettings> get_defaultSettings();

  /// @brief Method get_disposed, addr 0x69c9a1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method set_disposed, addr 0x69c9a24, size 0x8, virtual false, abstract: false, final false
