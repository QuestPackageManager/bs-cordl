...
/// @brief Method CreateBlackTexture3D, addr 0x65fe3f0, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture3D> CreateBlackTexture3D(::StringW  name) ;

/// @brief Method CreateBlackUIntTextureArray, addr 0x65fddb4, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method CreateBlackUintTexture, addr 0x65fe028, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method CreateTexture2DArrayFromTexture2D, addr 0x65fe1f0, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method GetBlackTexture, addr 0x65fd668, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture() ;

/// @brief Method GetBlackTexture3D, addr 0x65fd758, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture3D() ;

/// @brief Method GetBlackTextureArray, addr 0x65fd6fc, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackTextureArray() ;

/// @brief Method GetBlackUIntTexture, addr 0x65fd4ac, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetBlackUIntTexture() ;

/// @brief Method GetClearTexture, addr 0x65fd540, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetClearTexture() ;

/// @brief Method GetMagentaTexture, addr 0x65fd5d4, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetMagentaTexture() ;

/// @brief Method GetWhiteTexture, addr 0x65fd7b4, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RTHandle* GetWhiteTexture() ;

/// @brief Method Initialize, addr 0x65fd848, size 0x56c, virtual false, abstract: false, final false
...
/// @brief Method get_dimension, addr 0x65fd448, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::TextureDimension get_dimension() ;

/// @brief Method get_slices, addr 0x65fd36c, size 0x5c, virtual false, abstract: false, final false
static inline int32_t get_slices() ;

/// @brief Method get_useTexArray, addr 0x65fd3c8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method set_maxViews, addr 0x65fd30c, size 0x60, virtual false, abstract: false, final false
