...
public:
  ...
  /// @brief Method CreateBlackTexture3D, addr 0x66703fc, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture3D> CreateBlackTexture3D(::StringW name);

  /// @brief Method CreateBlackUIntTextureArray, addr 0x666fdc0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBlackUintTexture, addr 0x6670034, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTexture2DArrayFromTexture2D, addr 0x66701fc, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlackTexture, addr 0x666f674, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture();

  /// @brief Method GetBlackTexture3D, addr 0x666f764, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetBlackTexture3D();

  /// @brief Method GetBlackTextureArray, addr 0x666f708, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetBlackTextureArray();

  /// @brief Method GetBlackUIntTexture, addr 0x666f4b8, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetBlackUIntTexture();

  /// @brief Method GetClearTexture, addr 0x666f54c, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetClearTexture();

  /// @brief Method GetMagentaTexture, addr 0x666f5e0, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetMagentaTexture();

  /// @brief Method GetWhiteTexture, addr 0x666f7c0, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* GetWhiteTexture();

  /// @brief Method Initialize, addr 0x666f854, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dimension, addr 0x666f454, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::TextureDimension get_dimension();

  /// @brief Method get_slices, addr 0x666f378, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t get_slices();

  /// @brief Method get_useTexArray, addr 0x666f3d4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method set_maxViews, addr 0x666f318, size 0x60, virtual false, abstract: false, final false
