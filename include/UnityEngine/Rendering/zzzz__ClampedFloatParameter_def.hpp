...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ClampedFloatParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ClampedFloatParameter(ClampedFloatParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ClampedFloatParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ClampedFloatParameter(ClampedFloatParameterconst&) = delete;
