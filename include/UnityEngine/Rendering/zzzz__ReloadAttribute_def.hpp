...
/// @brief Method .ctor, addr 0x65a27d8, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::UnityEngine::Rendering::ReloadAttribute_Package  package) ;

/// @brief Method .ctor, addr 0x65a2840, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65a27d4, size 0x4, virtual false, abstract: false, final false
