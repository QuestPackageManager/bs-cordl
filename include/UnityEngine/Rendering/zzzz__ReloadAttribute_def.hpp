...
public:
  ...
  /// @brief Method .ctor, addr 0x66147e4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::UnityEngine::Rendering::ReloadAttribute_Package package);

  /// @brief Method .ctor, addr 0x661484c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66147e0, size 0x4, virtual false, abstract: false, final false
