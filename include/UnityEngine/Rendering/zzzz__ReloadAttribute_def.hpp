...
public:
  ...
  /// @brief Method .ctor, addr 0x6753a68, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, ::UnityEngine::Rendering::ReloadAttribute_Package package);

  /// @brief Method .ctor, addr 0x6753ad0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6753a64, size 0x4, virtual false, abstract: false, final false
