...
public:
  ...
  /// @brief Method Equals, addr 0x69d0190, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c8800, size 0x218, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SortingSettings other);

  /// @brief Method GetHashCode, addr 0x69c8b70, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69d0118, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Camera* camera);

  /// @brief Method get_criteria, addr 0x69d0180, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_criteria, addr 0x69d0188, size 0x8, virtual false, abstract: false, final false
