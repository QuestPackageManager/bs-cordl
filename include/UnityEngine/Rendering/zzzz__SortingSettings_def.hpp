...
public:
  ...
  /// @brief Method Equals, addr 0x68f4a04, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x68ed074, size 0x218, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SortingSettings other);

  /// @brief Method GetHashCode, addr 0x68ed3e4, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x68f498c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Camera* camera);

  /// @brief Method get_criteria, addr 0x68f49f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_criteria, addr 0x68f49fc, size 0x8, virtual false, abstract: false, final false
