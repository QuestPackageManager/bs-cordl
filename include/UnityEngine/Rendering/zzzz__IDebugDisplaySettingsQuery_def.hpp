...
/// @brief Method TryGetScreenClearColor, addr 0x65b6d94, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_IsLightingActive, addr 0x65b6d8c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsLightingActive() ;

/// @brief Method get_IsPostProcessingAllowed, addr 0x65b6d84, size 0x8, virtual true, abstract: false, final false
