...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ComputeQueueType, "UnityEngine.Rendering", "ComputeQueueType");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::ComputeQueueType) == 0x4, "Size mismatch!");
