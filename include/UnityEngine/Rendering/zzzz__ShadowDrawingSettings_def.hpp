...
public:
  ...
  /// @brief Method Equals, addr 0x69cfbc0, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69cf8d8, size 0x170, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ShadowDrawingSettings other);

  /// @brief Method GetHashCode, addr 0x69cfc7c, size 0xc0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69cf75c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_useRenderingLayerMaskTest, addr 0x69cf750, size 0xc, virtual false, abstract: false, final false
