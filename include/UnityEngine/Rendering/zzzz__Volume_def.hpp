...
public:
  ...
  /// @brief Method HasInstantiatedProfile, addr 0x6685584, size 0x64, virtual false, abstract: false, final false
  inline bool HasInstantiatedProfile();

  static inline ::UnityEngine::Rendering::Volume* New_ctor();

  /// @brief Method OnDisable, addr 0x668569c, size 0x6c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x66855e8, size 0xb4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x66858c8, size 0x14, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Update, addr 0x6685708, size 0x18, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateLayer, addr 0x6685720, size 0xa8, virtual false, abstract: false, final false
  inline void UpdateLayer();

  /// @brief Method UpdatePriority, addr 0x66857c8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66858dc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colliders, addr 0x6685500, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Collider>>* get_colliders();

  /// @brief Method get_isGlobal, addr 0x6685264, size 0x8, virtual true, abstract: false, final true
  inline bool get_isGlobal();

  /// @brief Method get_profile, addr 0x6685274, size 0x284, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::VolumeProfile> get_profile();

  /// @brief Method get_profileRef, addr 0x6685508, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isGlobal, addr 0x668526c, size 0x8, virtual true, abstract: false, final true
  inline void set_isGlobal(bool value);

  /// @brief Method set_profile, addr 0x66854f8, size 0x8, virtual false, abstract: false, final false
