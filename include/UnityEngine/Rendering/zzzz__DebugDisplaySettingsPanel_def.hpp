...
/// @brief Method AddWidget, addr 0x661867c, size 0x100, virtual false, abstract: false, final false
inline void AddWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Clear, addr 0x661877c, size 0x78, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x66187f4, size 0x4, virtual true, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x66187f8, size 0x16c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Flags, addr 0x6618674, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Flags get_Flags() ;

/// @brief Method get_Order, addr 0x6618608, size 0x18, virtual true, abstract: false, final false
inline int32_t get_Order() ;

/// @brief Method get_PanelName, addr 0x66185e0, size 0x28, virtual true, abstract: false, final false
inline ::StringW get_PanelName() ;

/// @brief Method get_Widgets, addr 0x6618620, size 0x54, virtual true, abstract: false, final true
