...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugDisplaySettingsPanel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugDisplaySettingsPanel(DebugDisplaySettingsPanel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugDisplaySettingsPanel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugDisplaySettingsPanel(DebugDisplaySettingsPanelconst&) = delete;
