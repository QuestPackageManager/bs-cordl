...
// Ctor Parameters [CppParam { name: "localToWorld0", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "localToWorld1", ty:
// "::Unity::Mathematics::float4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "localToWorld2", ty: "::Unity::Mathematics::float4", modifiers: "", def_value: Some("{}"),
// comment: None }]
