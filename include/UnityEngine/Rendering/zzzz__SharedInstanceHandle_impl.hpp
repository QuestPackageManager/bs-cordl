...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::SharedInstanceHandle::*)()>(&::UnityEngine::Rendering::SharedInstanceHandle::get_index)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x666c6ec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::SharedInstanceHandle::*)(int32_t)>(&::UnityEngine::Rendering::SharedInstanceHandle::set_index)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x666c6f4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::SharedInstanceHandle::*)()>(&::UnityEngine::Rendering::SharedInstanceHandle::get_valid)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x666c6fc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::SharedInstanceHandle::*)(::UnityEngine::Rendering::SharedInstanceHandle)>(&::UnityEngine::Rendering::SharedInstanceHandle::Equals)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x666c75c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::SharedInstanceHandle::*)(::UnityEngine::Rendering::SharedInstanceHandle)>(&::UnityEngine::Rendering::SharedInstanceHandle::CompareTo)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x666c7c8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::SharedInstanceHandle::*)()>(&::UnityEngine::Rendering::SharedInstanceHandle::GetHashCode)> {
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::SharedInstanceHandle, "Invalid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::SharedInstanceHandle>::get>(std::forward<::UnityEngine::Rendering::SharedInstanceHandle>(value));
}
inline ::UnityEngine::Rendering::SharedInstanceHandle UnityEngine::Rendering::SharedInstanceHandle::getStaticF_Invalid()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::SharedInstanceHandle, "Invalid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::SharedInstanceHandle>::get>();
}
