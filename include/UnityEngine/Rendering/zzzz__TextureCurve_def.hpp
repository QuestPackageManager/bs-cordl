...
/// @brief Method AddKey, addr 0x6611d54, size 0x38, virtual false, abstract: false, final false
inline int32_t AddKey(float_t  time, float_t  value) ;

/// @brief Method Dispose, addr 0x6611838, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Evaluate, addr 0x6611b64, size 0x1f0, virtual false, abstract: false, final false
inline float_t Evaluate(float_t  time) ;

/// @brief Method GetTexture, addr 0x6611974, size 0x1f0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> GetTexture() ;

/// @brief Method GetTextureFormat, addr 0x66118f0, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetTextureFormat() ;

/// @brief Method MoveKey, addr 0x6611d8c, size 0x48, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::TextureCurve* New_ctor(::ArrayW<::UnityEngine::Keyframe,::Array<::UnityEngine::Keyframe>*>  keys, float_t  zeroValue, bool  loop, ::ByRef<::UnityEngine::Vector2>  bounds) ;

/// @brief Method Release, addr 0x661183c, size 0xa8, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method RemoveKey, addr 0x6611dd4, size 0x2c, virtual false, abstract: false, final false
inline void RemoveKey(int32_t  index) ;

/// @brief Method SetDirty, addr 0x66118e4, size 0xc, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SmoothTangents, addr 0x6611e00, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66116e8, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AnimationCurve*  baseCurve, float_t  zeroValue, bool  loop, ::ByRef<::UnityEngine::Vector2>  bounds) ;

/// @brief Method .ctor, addr 0x6611738, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x66116ac, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Keyframe get_Item(int32_t  index) ;

/// @brief Method get_length, addr 0x661169c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_length() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_length, addr 0x66116a4, size 0x8, virtual false, abstract: false, final false
