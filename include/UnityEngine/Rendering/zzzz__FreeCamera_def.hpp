...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FreeCamera", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FreeCamera(FreeCamera&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FreeCamera", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FreeCamera(FreeCameraconst&) = delete;
