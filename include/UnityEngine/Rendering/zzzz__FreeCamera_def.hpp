...
public:
  ...
  /// @brief Method OnEnable, addr 0x6608c48, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterInputs, addr 0x6608c4c, size 0x7f8, virtual false, abstract: false, final false
  inline void RegisterInputs();

  /// @brief Method Update, addr 0x6609658, size 0x3b8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateInputs, addr 0x6609444, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6609a10, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
