...
// Ctor Parameters [CppParam { name: "instanceIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "hashMap", ty: "::Unity::Collections::NativeParallelHashMap_2<int32_t,T>", modifiers: "", def_value: None }, CppParam { name: "outInstancesWriter", ty: "::Unity::Collections::NativeList_1_ParallelWriter<int32_t>", modifiers: "", def_value: None }]
constexpr FindNonRegisteredInstancesJob_1(::Unity::Collections::NativeArray_1<int32_t>  instanceIDs, ::Unity::Collections::NativeParallelHashMap_2<int32_t,T>  hashMap, ::Unity::Collections::NativeList_1_ParallelWriter<int32_t>  outInstancesWriter) noexcept;
