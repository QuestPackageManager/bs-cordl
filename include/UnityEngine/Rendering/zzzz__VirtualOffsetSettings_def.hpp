...
public:
// Declarations
/// @brief Method SetDefaults, addr 0x65db250, size 0x20, virtual false, abstract: false, final false
inline void SetDefaults() ;

/// @brief Method UpgradeFromTo, addr 0x65db270, size 0x24, virtual false, abstract: false, final false
