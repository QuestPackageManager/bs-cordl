...
public:
  // Declarations
  /// @brief Method SetDefaults, addr 0x664d25c, size 0x20, virtual false, abstract: false, final false
  inline void SetDefaults();

  /// @brief Method UpgradeFromTo, addr 0x664d27c, size 0x24, virtual false, abstract: false, final false
