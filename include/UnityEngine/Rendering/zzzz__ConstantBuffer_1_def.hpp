...
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ConstantBuffer_1, "UnityEngine.Rendering", "ConstantBuffer`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_Data, put = __cordl_internal_set_m_Data)) ::ArrayW<CBType> m_Data;
  ...
  constexpr ::ArrayW<CBType>& __cordl_internal_get_m_Data();
  ...
  constexpr void __cordl_internal_set_m_Data(::ArrayW<CBType> value);
