...
public:
  ...
  /// @brief Method get_colorLoadActions, addr 0x69b13ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorRenderTargets, addr 0x69b138c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorStoreActions, addr 0x69b13b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_depthLoadAction, addr 0x69b13bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderBufferLoadAction get_depthLoadAction();

  /// @brief Method get_depthRenderTarget, addr 0x69b1394, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderTargetIdentifier get_depthRenderTarget();

  /// @brief Method get_depthStoreAction, addr 0x69b13c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderBufferStoreAction get_depthStoreAction();

  /// @brief Method get_flags, addr 0x69b13cc, size 0x8, virtual false, abstract: false, final false
