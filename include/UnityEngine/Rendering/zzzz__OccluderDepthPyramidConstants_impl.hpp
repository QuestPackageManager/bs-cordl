...
constexpr ::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer(float_t  FixedElementField) noexcept  {
...
constexpr ::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer(uint32_t  FixedElementField) noexcept  {
this->FixedElementField = FixedElementField;
}
// Ctor Parameters []
...
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer(float_t  FixedElementField) noexcept  {
this->FixedElementField = FixedElementField;
}
// Ctor Parameters []
...
// Ctor Parameters [CppParam { name: "_InvViewProjMatrix", ty: "::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "_SilhouettePlanes", ty: "::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "_SrcOffset", ty: "::UnityEngine::Rendering::OccluderDepthPyramidConstants___SrcOffset_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "_MipOffsetAndSize", ty: "::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "_OccluderMipLayoutSizeX", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_OccluderMipLayoutSizeY", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_OccluderDepthPyramidPad0", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_OccluderDepthPyramidPad1", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_SrcSliceIndices", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_DstSubviewIndices", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_MipCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_SilhouettePlaneCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::OccluderDepthPyramidConstants::OccluderDepthPyramidConstants(::UnityEngine::Rendering::OccluderDepthPyramidConstants___InvViewProjMatrix_e__FixedBuffer  _InvViewProjMatrix, ::UnityEngine::Rendering::OccluderDepthPyramidConstants___SilhouettePlanes_e__FixedBuffer  _SilhouettePlanes, ::UnityEngine::Rendering::OccluderDepthPyramidConstants___SrcOffset_e__FixedBuffer  _SrcOffset, ::UnityEngine::Rendering::OccluderDepthPyramidConstants___MipOffsetAndSize_e__FixedBuffer  _MipOffsetAndSize, uint32_t  _OccluderMipLayoutSizeX, uint32_t  _OccluderMipLayoutSizeY, uint32_t  _OccluderDepthPyramidPad0, uint32_t  _OccluderDepthPyramidPad1, uint32_t  _SrcSliceIndices, uint32_t  _DstSubviewIndices, uint32_t  _MipCount, uint32_t  _SilhouettePlaneCount) noexcept  {
