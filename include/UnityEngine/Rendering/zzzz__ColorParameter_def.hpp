...
public:
  ...
  /// @brief Method Interp, addr 0x66887e4, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6688718, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color value, bool hdr, bool showAlpha, bool showEyeDropper, bool overrideState);

  /// @brief Method .ctor, addr 0x668868c, size 0x8c, virtual false, abstract: false, final false
