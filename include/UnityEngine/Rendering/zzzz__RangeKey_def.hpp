...
/// @brief Method Equals, addr 0x66d3afc, size 0x84, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RangeKey  other) ;

/// @brief Method GetHashCode, addr 0x66d3b80, size 0x44, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "layer", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "renderingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "motionMode", ty: "::UnityEngine::MotionVectorGenerationMode", modifiers: "", def_value: None }, CppParam { name: "shadowCastingMode", ty: "::UnityEngine::Rendering::ShadowCastingMode", modifiers: "", def_value: None }, CppParam { name: "staticShadowCaster", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "rendererPriority", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "supportsIndirect", ty: "bool", modifiers: "", def_value: None }]
constexpr RangeKey(uint8_t  layer, uint32_t  renderingLayerMask, ::UnityEngine::MotionVectorGenerationMode  motionMode, ::UnityEngine::Rendering::ShadowCastingMode  shadowCastingMode, bool  staticShadowCaster, int32_t  rendererPriority, bool  supportsIndirect) noexcept;
