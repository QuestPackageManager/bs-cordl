...
/// @brief Method Equals, addr 0x665ff78, size 0x84, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RangeKey  other) ;

/// @brief Method GetHashCode, addr 0x665fffc, size 0x44, virtual true, abstract: false, final false
