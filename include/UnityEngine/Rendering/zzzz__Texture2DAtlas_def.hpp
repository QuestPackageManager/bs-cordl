...
/// @brief Method AddTexture, addr 0x65fce70, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method AllocateTexture, addr 0x65fc094, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method AllocateTextureWithoutBlit, addr 0x65fc2dc, size 0x188, virtual true, abstract: false, final false
...
/// @brief Method AllocateTextureWithoutBlit, addr 0x65fc280, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Blit2DTexture, addr 0x65fb140, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method BlitCubeTexture2D, addr 0x65fbf00, size 0x194, virtual true, abstract: false, final false
...
/// @brief Method BlitOctahedralTexture, addr 0x65fbef4, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method BlitTexture, addr 0x65fbc5c, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method ClearTarget, addr 0x65fa858, size 0x1c0, virtual false, abstract: false, final false
inline void ClearTarget(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method EnsureTextureSlot, addr 0x65fd144, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method GetCachedTextureSize, addr 0x65fc624, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int GetCachedTextureSize(int32_t  id) ;

/// @brief Method GetTextureHash, addr 0x65fc464, size 0x7c, virtual false, abstract: false, final false
inline int32_t GetTextureHash(::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method GetTextureID, addr 0x65fbe0c, size 0x18, virtual false, abstract: false, final false
inline int32_t GetTextureID(::UnityEngine::Texture*  texture) ;

/// @brief Method GetTextureID, addr 0x65fc4e0, size 0x48, virtual false, abstract: false, final false
inline int32_t GetTextureID(::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method GetTextureMipmapCount, addr 0x65fa6cc, size 0x8c, virtual false, abstract: false, final false
inline int32_t GetTextureMipmapCount(int32_t  width, int32_t  height) ;

/// @brief Method Is2D, addr 0x65facd8, size 0xd0, virtual false, abstract: false, final false
inline bool Is2D(::UnityEngine::Texture*  texture) ;

/// @brief Method IsCached, addr 0x65fc55c, size 0x8c, virtual false, abstract: false, final false
inline bool IsCached(::ByRef<::UnityEngine::Vector4>  scaleOffset, int32_t  id) ;

/// @brief Method IsCached, addr 0x65fc5e8, size 0x3c, virtual false, abstract: false, final false
inline bool IsCached(::ByRef<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Texture*  texture) ;

/// @brief Method IsCached, addr 0x65fc528, size 0x34, virtual false, abstract: false, final false
inline bool IsCached(::ByRef<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Texture*  textureA, ::UnityEngine::Texture*  textureB) ;

/// @brief Method IsSingleChannelBlit, addr 0x65fada8, size 0x398, virtual false, abstract: false, final false
inline bool IsSingleChannelBlit(::UnityEngine::Texture*  source, ::UnityEngine::Texture*  destination) ;

/// @brief Method MarkGPUTextureInvalid, addr 0x65fbbe4, size 0x78, virtual false, abstract: false, final false
inline void MarkGPUTextureInvalid(int32_t  instanceId) ;

/// @brief Method MarkGPUTextureValid, addr 0x65fbb60, size 0x84, virtual false, abstract: false, final false
inline void MarkGPUTextureValid(int32_t  instanceId, bool  mipAreValid) ;

/// @brief Method NeedsUpdate, addr 0x65fc940, size 0xdc, virtual true, abstract: false, final false
inline bool NeedsUpdate(int32_t  id, int32_t  updateCount, bool  needMips) ;

/// @brief Method NeedsUpdate, addr 0x65fc6a0, size 0x2a0, virtual true, abstract: false, final false
inline bool NeedsUpdate(::UnityEngine::Texture*  texture, bool  needMips) ;

/// @brief Method NeedsUpdate, addr 0x65fca1c, size 0x454, virtual true, abstract: false, final false
...
/// @brief Method Release, addr 0x65fa758, size 0x78, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method ResetAllocator, addr 0x65fa7d0, size 0x88, virtual false, abstract: false, final false
inline void ResetAllocator() ;

/// @brief Method UpdateTexture, addr 0x65fcf10, size 0x17c, virtual true, abstract: false, final false
inline bool UpdateTexture(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Texture*  oldTexture, ::UnityEngine::Texture*  newTexture, ::ByRef<::UnityEngine::Vector4>  scaleOffset, ::UnityEngine::Vector4  sourceScaleOffset, bool  updateIfNeeded, bool  blitMips) ;

/// @brief Method UpdateTexture, addr 0x65fd08c, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65fa3d8, size 0x2f4, virtual false, abstract: false, final false
...
/// @brief Method get_AtlasTexture, addr 0x65fa3d0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* get_AtlasTexture() ;

/// @brief Method get_maxMipLevelPadding, addr 0x65fa374, size 0x5c, virtual false, abstract: false, final false
