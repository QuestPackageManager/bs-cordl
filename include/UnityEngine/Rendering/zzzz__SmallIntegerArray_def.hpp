...
/// @brief Method Dispose, addr 0x666f3f8, size 0x5c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x6670ee0, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor(int32_t  length, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method get_Item, addr 0x667109c, size 0x90, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  index) ;

/// @brief Method get_Valid, addr 0x6670ed0, size 0x8, virtual false, abstract: false, final false
inline bool get_Valid() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() ;

/// @brief Method set_Item, addr 0x667112c, size 0x98, virtual false, abstract: false, final false
inline void set_Item(int32_t  index, int32_t  value) ;

/// @brief Method set_Valid, addr 0x6670ed8, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_FixedArray", ty: "::Unity::Collections::FixedList32Bytes_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_List", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "m_IsEmbedded", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_Valid_k__BackingField", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "Length", ty: "int32_t", modifiers: "", def_value: None }]
constexpr SmallIntegerArray(::Unity::Collections::FixedList32Bytes_1<int32_t>  m_FixedArray, ::Unity::Collections::LowLevel::Unsafe::UnsafeList_1<int32_t>  m_List, bool  m_IsEmbedded, bool  _Valid_k__BackingField, int32_t  Length) noexcept;
