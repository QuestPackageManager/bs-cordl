...
constexpr ::UnityEngine::Rendering::VertexAttribute::VertexAttribute(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::VertexAttribute::VertexAttribute() {}
