...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::VirtualOffsetSettings::*)()>(&::UnityEngine::Rendering::VirtualOffsetSettings::SetDefaults)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x65db250;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::VirtualOffsetSettings>::get(),
                        "SetDefaults",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::VirtualOffsetSettings::*)(::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion, ::UnityEngine::Rendering::ProbeVolumeBakingProcessSettings_SettingsVersion)>(&::UnityEngine::Rendering::VirtualOffsetSettings::UpgradeFromTo)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x65db270;
