...
// Ctor Parameters [CppParam { name: "valid", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "lastUsedFrameIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "viewInstanceID", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method .ctor, addr 0x66f36e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x66f36ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "passIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "viewport", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "valid", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method .ctor, addr 0x66f36f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field occluderSubviewUpdates, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_occluderSubviewUpdates, put=__cordl_internal_set_occluderSubviewUpdates)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::OccluderSubviewUpdate>*  occluderSubviewUpdates;
...
/// @brief Method .ctor, addr 0x66f36f4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <>9__29_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__29_0, put=setStaticF___9__29_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OcclusionTestOverlaySetupPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  __9__29_0;

/// @brief Field <>9__32_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__32_0, put=setStaticF___9__32_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OccluderOverlayPassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  __9__32_0;

/// @brief Field <>9__37_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__37_0, put=setStaticF___9__37_0)) ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_UpdateOccludersPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  __9__37_0;

static inline ::UnityEngine::Rendering::OcclusionCullingCommon___c* New_ctor() ;

/// @brief Method <RenderDebugOccluderOverlay>b__32_0, addr 0x66f388c, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method <RenderDebugOcclusionTestOverlay>b__29_0, addr 0x66f3750, size 0x13c, virtual false, abstract: false, final false
inline void _RenderDebugOcclusionTestOverlay_b__29_0(::UnityEngine::Rendering::OcclusionCullingCommon_OcclusionTestOverlaySetupPassData*  data, ::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*  ctx) ;

/// @brief Method <UpdateInstanceOccluders>b__37_0, addr 0x66f3a2c, size 0x2cc, virtual false, abstract: false, final false
inline void _UpdateInstanceOccluders_b__37_0(::UnityEngine::Rendering::OcclusionCullingCommon_UpdateOccludersPassData*  data, ::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*  context) ;

/// @brief Method .ctor, addr 0x66f374c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::OcclusionCullingCommon___c* getStaticF___9() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OcclusionTestOverlaySetupPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>* getStaticF___9__29_0() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OccluderOverlayPassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>* getStaticF___9__32_0() ;

static inline ::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_UpdateOccludersPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>* getStaticF___9__37_0() ;

static inline void setStaticF___9(::UnityEngine::Rendering::OcclusionCullingCommon___c*  value) ;

static inline void setStaticF___9__29_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OcclusionTestOverlaySetupPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  value) ;

static inline void setStaticF___9__32_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_OccluderOverlayPassData*,::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext>*  value) ;

static inline void setStaticF___9__37_0(::UnityEngine::Rendering::RenderGraphModule::BaseRenderFunc_2<::UnityEngine::Rendering::OcclusionCullingCommon_UpdateOccludersPassData*,::UnityEngine::Rendering::RenderGraphModule::ComputeGraphContext*>*  value) ;
...
// Dependencies System.Object, Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1<T>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.Rendering.OcclusionCullingCommon::OccluderContextSlot, UnityEngine.Rendering.OcclusionCullingCommonShaderVariables, UnityEngine.Rendering.OcclusionCullingDebugShaderVariables, UnityEngine.Rendering.SilhouettePlaneCache
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field m_CommonShaderVariables, offset 0x90, size 0x10 
 __declspec(property(get=__cordl_internal_get_m_CommonShaderVariables, put=__cordl_internal_set_m_CommonShaderVariables)) ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables>  m_CommonShaderVariables;
...
/// @brief Field m_DebugShaderVariables, offset 0xa8, size 0x10 
 __declspec(property(get=__cordl_internal_get_m_DebugShaderVariables, put=__cordl_internal_set_m_DebugShaderVariables)) ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables>  m_DebugShaderVariables;
...
/// @brief Field m_OccluderContextData, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OccluderContextData, put=__cordl_internal_set_m_OccluderContextData)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::OccluderContext>*  m_OccluderContextData;

/// @brief Field m_OccluderContextSlots, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OccluderContextSlots, put=__cordl_internal_set_m_OccluderContextSlots)) ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::OcclusionCullingCommon_OccluderContextSlot>  m_OccluderContextSlots;
...
/// @brief Field m_ProfilingSamplerOccluderOverlay, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ProfilingSamplerOccluderOverlay, put=__cordl_internal_set_m_ProfilingSamplerOccluderOverlay)) ::UnityEngine::Rendering::ProfilingSampler*  m_ProfilingSamplerOccluderOverlay;

/// @brief Field m_ProfilingSamplerOcclusionTestOverlay, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ProfilingSamplerOcclusionTestOverlay, put=__cordl_internal_set_m_ProfilingSamplerOcclusionTestOverlay)) ::UnityEngine::Rendering::ProfilingSampler*  m_ProfilingSamplerOcclusionTestOverlay;

/// @brief Field m_ProfilingSamplerUpdateOccluders, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ProfilingSamplerUpdateOccluders, put=__cordl_internal_set_m_ProfilingSamplerUpdateOccluders)) ::UnityEngine::Rendering::ProfilingSampler*  m_ProfilingSamplerUpdateOccluders;
...
/// @brief Method CreateFarDepthPyramid, addr 0x66f20ac, size 0x224, virtual false, abstract: false, final false
inline void CreateFarDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates, ::ByRef<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method DeleteContext, addr 0x66f1f00, size 0x1ac, virtual false, abstract: false, final false
inline void DeleteContext(int32_t  viewInstanceID) ;

/// @brief Method DispatchDebugClear, addr 0x66f05ec, size 0x2ec, virtual false, abstract: false, final false
inline void DispatchDebugClear(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, int32_t  viewInstanceID) ;

/// @brief Method Dispose, addr 0x66f31f8, size 0x27c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetOccluderContext, addr 0x66f2e54, size 0x128, virtual false, abstract: false, final false
inline bool GetOccluderContext(int32_t  viewInstanceID, ::ByRef<::UnityEngine::Rendering::OccluderContext>  occluderContext) ;

/// @brief Method GetOcclusionTestDebugOutput, addr 0x66f12d8, size 0x174, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OcclusionCullingDebugOutput GetOcclusionTestDebugOutput(int32_t  viewInstanceID) ;

/// @brief Method HasOccluderContext, addr 0x66f2df8, size 0x5c, virtual false, abstract: false, final false
inline bool HasOccluderContext(int32_t  viewInstanceID) ;

/// @brief Method Init, addr 0x66efd38, size 0x3b0, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Rendering::GPUResidentDrawerResources*  resources) ;

/// @brief Method NewContext, addr 0x66f1c10, size 0x2f0, virtual false, abstract: false, final false
inline int32_t NewContext(int32_t  viewInstanceID) ;

static inline ::UnityEngine::Rendering::OcclusionCullingCommon* New_ctor() ;

/// @brief Method PrepareCulling, addr 0x66f00f8, size 0x1cc, virtual false, abstract: false, final false
inline void PrepareCulling(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OccluderContext>  occluderCtx, ::ByRef<::UnityEngine::Rendering::OcclusionCullingSettings>  settings, ::ByRef<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, ::ByRef<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, bool  useOcclusionDebug) ;

/// @brief Method PrepareOccluders, addr 0x66f19c0, size 0x250, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OccluderHandles PrepareOccluders(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::ByRef<::UnityEngine::Rendering::OccluderParameters>  occluderParams) ;

/// @brief Method RenderDebugOccluderOverlay, addr 0x66f144c, size 0x574, virtual false, abstract: false, final false
inline void RenderDebugOccluderOverlay(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  debugSettings, ::UnityEngine::Vector2  screenPos, float_t  maxHeight, ::UnityEngine::Rendering::RenderGraphModule::TextureHandle  colorBuffer) ;

/// @brief Method RenderDebugOcclusionTestOverlay, addr 0x66f0a58, size 0x880, virtual false, abstract: false, final false
inline void RenderDebugOcclusionTestOverlay(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::UnityEngine::Rendering::DebugDisplayGPUResidentDrawer*  debugSettings, int32_t  viewInstanceID, ::UnityEngine::Rendering::RenderGraphModule::TextureHandle  colorBuffer) ;

/// @brief Method SetDebugPyramid, addr 0x66f0974, size 0xe4, virtual false, abstract: false, final false
static inline void SetDebugPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, int32_t  kernel, ::ByRef<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method SetDepthPyramid, addr 0x66f08d8, size 0x9c, virtual false, abstract: false, final false
static inline void SetDepthPyramid(::UnityEngine::Rendering::ComputeCommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::OcclusionTestComputeShader>  shader, int32_t  kernel, ::ByRef<::UnityEngine::Rendering::OccluderHandles>  occluderHandles) ;

/// @brief Method UpdateFrame, addr 0x66f2f7c, size 0x27c, virtual false, abstract: false, final false
inline void UpdateFrame() ;

/// @brief Method UpdateInstanceOccluders, addr 0x66f22d0, size 0x79c, virtual false, abstract: false, final false
inline bool UpdateInstanceOccluders(::UnityEngine::Rendering::RenderGraphModule::RenderGraph*  renderGraph, ::ByRef<::UnityEngine::Rendering::OccluderParameters>  occluderParams, ::System::ReadOnlySpan_1<::UnityEngine::Rendering::OccluderSubviewUpdate>  occluderSubviewUpdates) ;

/// @brief Method UpdateOccluderStats, addr 0x66f2a78, size 0x380, virtual false, abstract: false, final false
inline void UpdateOccluderStats(::UnityEngine::Rendering::DebugRendererBatcherStats*  debugStats) ;

/// @brief Method UpdateSilhouettePlanes, addr 0x66f2a6c, size 0xc, virtual false, abstract: false, final false
inline void UpdateSilhouettePlanes(int32_t  viewInstanceID, ::Unity::Collections::NativeArray_1<::UnityEngine::Plane>  planes) ;

/// @brief Method UseOcclusionDebug, addr 0x66f00e8, size 0x10, virtual false, abstract: false, final false
static inline bool UseOcclusionDebug(::ByRef<::UnityEngine::Rendering::OccluderContext>  occluderCtx) ;

/// @brief Method <RenderDebugOcclusionTestOverlay>b__29_1, addr 0x66f34c8, size 0x114, virtual false, abstract: false, final false
inline void _RenderDebugOcclusionTestOverlay_b__29_1(::UnityEngine::Rendering::OcclusionCullingCommon_OcclusionTestOverlayPassData*  data, ::UnityEngine::Rendering::RenderGraphModule::RasterGraphContext  ctx) ;
...
/// @brief Method .ctor, addr 0x66f3474, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
