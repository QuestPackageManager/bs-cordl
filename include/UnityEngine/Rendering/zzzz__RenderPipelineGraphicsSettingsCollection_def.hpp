...
public:
  ...
  /// @brief Method .ctor, addr 0x6b0b5f8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsList, addr 0x6b0b5f0, size 0x8, virtual false, abstract: false, final false
