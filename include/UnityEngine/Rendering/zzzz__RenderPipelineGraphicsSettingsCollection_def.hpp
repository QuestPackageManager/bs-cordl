...
public:
  ...
  /// @brief Method .ctor, addr 0x69b2ca4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsList, addr 0x69b2c9c, size 0x8, virtual false, abstract: false, final false
