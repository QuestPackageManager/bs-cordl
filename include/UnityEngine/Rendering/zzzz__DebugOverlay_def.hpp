...
/// @brief Method Next, addr 0x65b0fd4, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::Rect Next(float_t  aspect) ;

/// @brief Method SetViewport, addr 0x65b1044, size 0x30, virtual false, abstract: false, final false
inline void SetViewport(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method StartOverlay, addr 0x65b0fc4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65b1074, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_overlaySize, addr 0x65b0fb4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_overlaySize() ;

/// @brief Method get_x, addr 0x65b0f94, size 0x8, virtual false, abstract: false, final false
inline int32_t get_x() ;

/// @brief Method get_y, addr 0x65b0fa4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_y() ;

/// @brief Method set_overlaySize, addr 0x65b0fbc, size 0x8, virtual false, abstract: false, final false
inline void set_overlaySize(int32_t  value) ;

/// @brief Method set_x, addr 0x65b0f9c, size 0x8, virtual false, abstract: false, final false
inline void set_x(int32_t  value) ;

/// @brief Method set_y, addr 0x65b0fac, size 0x8, virtual false, abstract: false, final false
