...
public:
  ...
  /// @brief Method Next, addr 0x6548d88, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect Next(float_t aspect);

  /// @brief Method SetViewport, addr 0x6548df8, size 0x30, virtual false, abstract: false, final false
  inline void SetViewport(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method StartOverlay, addr 0x6548d78, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6548e28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_overlaySize, addr 0x6548d68, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_overlaySize();

  /// @brief Method get_x, addr 0x6548d48, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_x();

  /// @brief Method get_y, addr 0x6548d58, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_y();

  /// @brief Method set_overlaySize, addr 0x6548d70, size 0x8, virtual false, abstract: false, final false
  inline void set_overlaySize(int32_t value);

  /// @brief Method set_x, addr 0x6548d50, size 0x8, virtual false, abstract: false, final false
  inline void set_x(int32_t value);

  /// @brief Method set_y, addr 0x6548d60, size 0x8, virtual false, abstract: false, final false
