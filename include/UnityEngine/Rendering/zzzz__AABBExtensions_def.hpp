...
public:
  // Declarations
  /// @brief Method ToAABB, addr 0x66c5804, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::AABB ToAABB(::UnityEngine::Bounds bounds);

  /// @brief Method ToBounds, addr 0x66c5818, size 0x68, virtual false, abstract: false, final false
