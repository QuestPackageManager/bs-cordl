...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchDrawRange, "UnityEngine.Rendering", "BatchDrawRange");
// Dependencies UnityEngine.Rendering.BatchDrawCommandType, UnityEngine.Rendering.BatchFilterSettings
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(offsetof(::UnityEngine::Rendering::BatchDrawRange, drawCommandsBegin) == 0x4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::BatchDrawRange, drawCommandsCount) == 0x8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Rendering::BatchDrawRange, filterSettings) == 0x10, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::BatchDrawRange) == 0x28, "Size mismatch!");
