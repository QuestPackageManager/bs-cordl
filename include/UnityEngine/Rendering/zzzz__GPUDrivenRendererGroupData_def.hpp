...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::GPUDrivenRendererGroupData, "UnityEngine.Rendering", "GPUDrivenRendererGroupData");
...
static_assert(sizeof(::UnityEngine::Rendering::GPUDrivenRendererGroupData) == 0x1c0, "Size mismatch!");
