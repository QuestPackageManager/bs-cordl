...
// Ctor Parameters [CppParam { name: "__4__this", ty: "::UnityEngine::Rendering::BufferedRTHandleSystem*", modifiers: "", def_value: None }, CppParam { name: "format", ty: "::UnityEngine::Experimental::Rendering::GraphicsFormat", modifiers: "", def_value: None }]
...
/// @brief Field m_RTHandles, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RTHandles, put=__cordl_internal_set_m_RTHandles)) ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::Rendering::RTHandle*,::Array<::UnityEngine::Rendering::RTHandle*>*>>*  m_RTHandles;
...
/// @brief Method AllocBuffer, addr 0x65f1fd8, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method AllocBuffer, addr 0x65f216c, size 0x228, virtual false, abstract: false, final false
inline void AllocBuffer(int32_t  bufferId, int32_t  bufferCount, ::ByRef<::UnityEngine::RenderTextureDescriptor>  descriptor, ::UnityEngine::FilterMode  filterMode, ::UnityEngine::TextureWrapMode  wrapMode, bool  isShadowMap, int32_t  anisoLevel, float_t  mipMapBias, ::StringW  name) ;

/// @brief Method CalculateRatioAgainstMaxSize, addr 0x65f2a04, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 CalculateRatioAgainstMaxSize(int32_t  width, int32_t  height) ;

/// @brief Method ClearBuffers, addr 0x65f1e0c, size 0x1cc, virtual false, abstract: false, final false
inline void ClearBuffers(::UnityEngine::Rendering::CommandBuffer*  cmd) ;

/// @brief Method Dispose, addr 0x65f2cb0, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x65f2a30, size 0x44, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetFrameRT, addr 0x65f1d40, size 0xcc, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* GetFrameRT(int32_t  bufferId, int32_t  frameIndex) ;

/// @brief Method GetNumFramesAllocated, addr 0x65f2950, size 0xb4, virtual false, abstract: false, final false
inline int32_t GetNumFramesAllocated(int32_t  bufferId) ;

static inline ::UnityEngine::Rendering::BufferedRTHandleSystem* New_ctor() ;

/// @brief Method ReleaseAll, addr 0x65f2a74, size 0x23c, virtual false, abstract: false, final false
inline void ReleaseAll() ;

/// @brief Method ReleaseBuffer, addr 0x65f2448, size 0xf4, virtual false, abstract: false, final false
inline void ReleaseBuffer(int32_t  bufferId) ;

/// @brief Method ResetReferenceSize, addr 0x65f2934, size 0x1c, virtual false, abstract: false, final false
inline void ResetReferenceSize(int32_t  width, int32_t  height) ;

/// @brief Method Swap, addr 0x65f2578, size 0x3bc, virtual false, abstract: false, final false
inline void Swap() ;

/// @brief Method SwapAndSetReferenceSize, addr 0x65f253c, size 0x3c, virtual false, abstract: false, final false
inline void SwapAndSetReferenceSize(int32_t  width, int32_t  height) ;

/// @brief Method <AllocBuffer>g__Alloc|12_0, addr 0x65f2394, size 0xb4, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandle* _AllocBuffer_g__Alloc_12_0(::ByRef<::UnityEngine::RenderTextureDescriptor>  d, ::UnityEngine::FilterMode  fMode, ::UnityEngine::TextureWrapMode  wMode, bool  isShadow, int32_t  aniso, float_t  mipBias, ::StringW  n, ::ByRef<::UnityEngine::Rendering::BufferedRTHandleSystem___c__DisplayClass12_0>  _cordl_fixed_empty_name_whitespace) ;
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::Rendering::RTHandle*,::Array<::UnityEngine::Rendering::RTHandle*>*>>* const& __cordl_internal_get_m_RTHandles() const;
...
constexpr void __cordl_internal_set_m_RTHandles(::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::Rendering::RTHandle*,::Array<::UnityEngine::Rendering::RTHandle*>*>>*  value) ;

/// @brief Method .ctor, addr 0x65f2cb8, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxHeight, addr 0x65f1d04, size 0x18, virtual false, abstract: false, final false
inline int32_t get_maxHeight() ;

/// @brief Method get_maxWidth, addr 0x65f1cec, size 0x18, virtual false, abstract: false, final false
inline int32_t get_maxWidth() ;

/// @brief Method get_rtHandleProperties, addr 0x65f1d1c, size 0x24, virtual false, abstract: false, final false
