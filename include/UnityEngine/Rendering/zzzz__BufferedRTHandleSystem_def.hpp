...
public:
  ...
  /// @brief Method AllocBuffer, addr 0x6663fe4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocBuffer, addr 0x6664178, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateRatioAgainstMaxSize, addr 0x6664a10, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalculateRatioAgainstMaxSize(int32_t width, int32_t height);

  /// @brief Method ClearBuffers, addr 0x6663e18, size 0x1cc, virtual false, abstract: false, final false
  inline void ClearBuffers(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method Dispose, addr 0x6664cbc, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6664a3c, size 0x44, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetFrameRT, addr 0x6663d4c, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* GetFrameRT(int32_t bufferId, int32_t frameIndex);

  /// @brief Method GetNumFramesAllocated, addr 0x666495c, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetNumFramesAllocated(int32_t bufferId);

  static inline ::UnityEngine::Rendering::BufferedRTHandleSystem* New_ctor();

  /// @brief Method ReleaseAll, addr 0x6664a80, size 0x23c, virtual false, abstract: false, final false
  inline void ReleaseAll();

  /// @brief Method ReleaseBuffer, addr 0x6664454, size 0xf4, virtual false, abstract: false, final false
  inline void ReleaseBuffer(int32_t bufferId);

  /// @brief Method ResetReferenceSize, addr 0x6664940, size 0x1c, virtual false, abstract: false, final false
  inline void ResetReferenceSize(int32_t width, int32_t height);

  /// @brief Method Swap, addr 0x6664584, size 0x3bc, virtual false, abstract: false, final false
  inline void Swap();

  /// @brief Method SwapAndSetReferenceSize, addr 0x6664548, size 0x3c, virtual false, abstract: false, final false
  inline void SwapAndSetReferenceSize(int32_t width, int32_t height);

  /// @brief Method <AllocBuffer>g__Alloc|12_0, addr 0x66643a0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6664cc4, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxHeight, addr 0x6663d10, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_maxHeight();

  /// @brief Method get_maxWidth, addr 0x6663cf8, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_maxWidth();

  /// @brief Method get_rtHandleProperties, addr 0x6663d28, size 0x24, virtual false, abstract: false, final false
