...
template <typename T> inline void UnityEngine::Rendering::ListChangedEventHandler_1<T>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>(),
...
inline void UnityEngine::Rendering::ListChangedEventHandler_1<T>::Invoke(::UnityEngine::Rendering::ObservableList_1<T>* sender, ::UnityEngine::Rendering::ListChangedEventArgs_1<T>* e) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>(), 13 })));
...
inline ::System::IAsyncResult* UnityEngine::Rendering::ListChangedEventHandler_1<T>::BeginInvoke(::UnityEngine::Rendering::ObservableList_1<T>* sender,
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>(), 14 })));
...
template <typename T> inline void UnityEngine::Rendering::ListChangedEventHandler_1<T>::EndInvoke(::System::IAsyncResult* result) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ListChangedEventHandler_1<T>*>(), 15 })));
