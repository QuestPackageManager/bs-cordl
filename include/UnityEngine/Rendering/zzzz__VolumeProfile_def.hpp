...
/// @brief Method <OnEnable>b__2_0, addr 0x66185b0, size 0x60, virtual false, abstract: false, final false
inline bool _OnEnable_b__2_0(::UnityEngine::Rendering::VolumeComponent*  x) ;

/// @brief Method .ctor, addr 0x66185ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x6617d28, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method GetComponentListHashCode, addr 0x6618300, size 0xc4, virtual false, abstract: false, final false
inline int32_t GetComponentListHashCode() ;

/// @brief Method GetHashCode, addr 0x661824c, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method Has, addr 0x6617eac, size 0x148, virtual false, abstract: false, final false
inline bool Has(::System::Type*  type) ;

/// @brief Method HasSubclassOf, addr 0x6618100, size 0x14c, virtual false, abstract: false, final false
inline bool HasSubclassOf(::System::Type*  type) ;

static inline ::UnityEngine::Rendering::VolumeProfile* New_ctor() ;

/// @brief Method OnDisable, addr 0x6617c28, size 0xf4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x6617b1c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x6617ff4, size 0x10c, virtual false, abstract: false, final false
inline void Remove(::System::Type*  type) ;

/// @brief Method Reset, addr 0x6617d1c, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Sanitize, addr 0x66183c4, size 0x110, virtual false, abstract: false, final false
inline void Sanitize() ;

/// @brief Method TryGet, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline bool TryGet(::ByRef<T>  component) ;

/// @brief Method TryGet, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline bool TryGet(::System::Type*  type, ::ByRef<T>  component) ;
...
template<typename T>
inline bool TryGetSubclassOf(::System::Type*  type, ::ByRef<T>  component) ;
...
/// @brief Method .ctor, addr 0x66184d4, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
