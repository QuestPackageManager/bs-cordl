...
public:
  ...
  /// @brief Method .ctor, addr 0x665de60, size 0x2d8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::DebugDisplaySettingsRenderGraph* _);

  /// @brief Method get_PanelName, addr 0x665e2b4, size 0x44, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IDebugDisplaySettingsData.CreatePanel, addr 0x665de0c, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x665dc8c, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AreAnySettingsActive, addr 0x665e138, size 0x17c, virtual true, abstract: false, final true
