...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DocumentationInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DocumentationInfo(DocumentationInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DocumentationInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DocumentationInfo(DocumentationInfoconst&) = delete;
