...
public:
// Declarations
/// @brief Method GetDefaultPackageLink, addr 0x65d1710, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW GetDefaultPackageLink(::StringW  packageName) ;

/// @brief Method GetDefaultPackageLink, addr 0x65d1680, size 0x90, virtual false, abstract: false, final false
static inline ::StringW GetDefaultPackageLink(::StringW  packageName, ::StringW  packageVersion) ;

/// @brief Method GetPackageLink, addr 0x65d1210, size 0x158, virtual false, abstract: false, final false
static inline ::StringW GetPackageLink(::StringW  packageName, ::StringW  packageVersion, ::StringW  pageName) ;

/// @brief Method GetPackageLink, addr 0x65d1368, size 0x194, virtual false, abstract: false, final false
static inline ::StringW GetPackageLink(::StringW  packageName, ::StringW  packageVersion, ::StringW  pageName, ::StringW  pageHash) ;

/// @brief Method GetPageLink, addr 0x65d14fc, size 0x184, virtual false, abstract: false, final false
static inline ::StringW GetPageLink(::StringW  packageName, ::StringW  pageName) ;

/// @brief Method GetPageLink, addr 0x65d0f20, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65d17c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_version, addr 0x65d11cc, size 0x44, virtual false, abstract: false, final false
