...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::FreeLODGroupDataJob::*)()>(&::UnityEngine::Rendering::FreeLODGroupDataJob::Execute)> {
  ...
  constexpr static std::size_t addrs = 0x667abac;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::FreeLODGroupDataJob>::get(),
                        "Execute",
...
// Ctor Parameters [CppParam { name: "destroyedLODGroupsID", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "lodGroupsData", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupData>", modifiers: "", def_value: Some("{}") }, CppParam { name: "lodGroupDataHash", ty: "::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>", modifiers: "", def_value: Some("{}") }, CppParam { name: "freeLODGroupDataHandles", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::GPUInstanceIndex>", modifiers: "", def_value: Some("{}") }, CppParam { name: "removedRendererCount", ty: "int32_t*", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::FreeLODGroupDataJob::FreeLODGroupDataJob(::Unity::Collections::NativeArray_1<int32_t>  destroyedLODGroupsID, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupData>  lodGroupsData, ::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>  lodGroupDataHash, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::GPUInstanceIndex>  freeLODGroupDataHandles, int32_t*  removedRendererCount) noexcept  {
