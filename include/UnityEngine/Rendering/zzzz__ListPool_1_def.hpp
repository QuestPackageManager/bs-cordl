...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ListPool_1___c", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListPool_1___c(ListPool_1___c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListPool_1___c", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListPool_1___c(ListPool_1___cconst&) = delete;
