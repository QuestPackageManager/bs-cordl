...
/// @brief Method AllowSmallMeshCulling, addr 0x66540b0, size 0xc4, virtual false, abstract: false, final false
static inline void AllowSmallMeshCulling(::UnityEngine::Transform*  transform, bool  allow) ;

/// @brief Method AllowSmallMeshCullingRecursively, addr 0x6653d7c, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x6653d28, size 0x28, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x6653d50, size 0x2c, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x6654174, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x665418c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_applyToChildrenRecursively, addr 0x6653d04, size 0x8, virtual false, abstract: false, final false
inline bool get_applyToChildrenRecursively() ;

/// @brief Method set_applyToChildrenRecursively, addr 0x6653d0c, size 0x1c, virtual false, abstract: false, final false
