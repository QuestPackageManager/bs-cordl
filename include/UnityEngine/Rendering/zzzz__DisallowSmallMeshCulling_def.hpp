...
public:
  ...
  /// @brief Method AllowSmallMeshCulling, addr 0x66c60bc, size 0xc4, virtual false, abstract: false, final false
  static inline void AllowSmallMeshCulling(::UnityEngine::Transform* transform, bool allow);

  /// @brief Method AllowSmallMeshCullingRecursively, addr 0x66c5d88, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x66c5d34, size 0x28, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x66c5d5c, size 0x2c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x66c6180, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c6198, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_applyToChildrenRecursively, addr 0x66c5d10, size 0x8, virtual false, abstract: false, final false
  inline bool get_applyToChildrenRecursively();

  /// @brief Method set_applyToChildrenRecursively, addr 0x66c5d18, size 0x1c, virtual false, abstract: false, final false
