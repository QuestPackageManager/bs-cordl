...
// Ctor Parameters [CppParam { name: "drawCommandsType", ty: "::UnityEngine::Rendering::BatchDrawCommandType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "drawCommandsBegin", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "drawCommandsCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None
// }, CppParam { name: "filterSettings", ty: "::UnityEngine::Rendering::BatchFilterSettings", modifiers: "", def_value: Some("{}"), comment: None }]
