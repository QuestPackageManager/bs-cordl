...
public:
  ...
  /// @brief Method Execute, addr 0x681748c, size 0x6c, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method ProcessMaterial, addr 0x68173a8, size 0xe4, virtual false, abstract: false, final false
