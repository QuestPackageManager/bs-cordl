...
public:
  ...
  /// @brief Method Execute, addr 0x66d8208, size 0x6c, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method ProcessMaterial, addr 0x66d8124, size 0xe4, virtual false, abstract: false, final false
