...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::SerializableEnum*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SerializableEnum*, "UnityEngine.Rendering", "SerializableEnum");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6759438, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* enumType);

  /// @brief Method get_value, addr 0x67592f0, size 0x118, virtual false, abstract: false, final false
  inline ::System::Enum* get_value();

  /// @brief Method set_value, addr 0x6759408, size 0x30, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializableEnum", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializableEnum(SerializableEnum&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializableEnum", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializableEnum(SerializableEnumconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::SerializableEnum) == 0x20, "Size mismatch!");
