...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::SurfaceDataAttributes::*)(::StringW, bool, bool, ::UnityEngine::Rendering::FieldPrecision, bool, ::StringW)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::SurfaceDataAttributes*>(),
                                                             { ".ctor",
                                                               {},
                                                               { ::i2c::type_of<::StringW>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(),
                                                                 ::i2c::type_of<::UnityEngine::Rendering::FieldPrecision>(), ::i2c::type_of<bool>(), ::i2c::type_of<::StringW>() } })));
...
inline void UnityEngine::Rendering::SurfaceDataAttributes::_ctor(::StringW displayName, bool isDirection, bool sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision precision, bool checkIsNormalized,
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::SurfaceDataAttributes*>(),
                                                           { ".ctor",
                                                             {},
                                                             { ::i2c::type_of<::StringW>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>(), ::i2c::type_of<::UnityEngine::Rendering::FieldPrecision>(),
...
inline void UnityEngine::Rendering::SurfaceDataAttributes::_ctor(::ArrayW<::StringW> displayNames, bool isDirection, bool sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision precision,
...
inline ::UnityEngine::Rendering::SurfaceDataAttributes* UnityEngine::Rendering::SurfaceDataAttributes::New_ctor(::ArrayW<::StringW> displayNames, bool isDirection, bool sRGBDisplay,
                                                                                                                ::UnityEngine::Rendering::FieldPrecision precision, bool checkIsNormalized,
                                                                                                                ::StringW preprocessor) {
