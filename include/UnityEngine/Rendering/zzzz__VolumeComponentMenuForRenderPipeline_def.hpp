...
public:
  ...
  static inline ::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline* New_ctor(::StringW menu, /* [ParamArray] */ ::ArrayW<::System::Type*> pipelineTypes);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VolumeComponentMenuForRenderPipeline", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VolumeComponentMenuForRenderPipeline(VolumeComponentMenuForRenderPipeline&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VolumeComponentMenuForRenderPipeline", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VolumeComponentMenuForRenderPipeline(VolumeComponentMenuForRenderPipelineconst&) = delete;
