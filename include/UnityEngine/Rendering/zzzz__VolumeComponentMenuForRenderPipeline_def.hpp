...
public:
  ...
  /// @brief Method .ctor, addr 0x6686700, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(::StringW menu, ::ArrayW<::System::Type*, ::Array<::System::Type*>*> pipelineTypes);

  /// @brief Method get_pipelineTypes, addr 0x66866f8, size 0x8, virtual false, abstract: false, final false
