...
// Ctor Parameters [CppParam { name: "lodGroupID", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "lodOffset", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "lodCount", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "fadeMode", ty: "::UnityEngine::LODFadeMode*", modifiers: "", def_value: None }, CppParam { name: "worldSpaceReferencePoint", ty: "::UnityEngine::Vector3*", modifiers: "", def_value: None }, CppParam { name: "worldSpaceSize", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "renderersCount", ty: "int16_t*", modifiers: "", def_value: None }, CppParam { name: "lastLODIsBillboard", ty: "bool*", modifiers: "", def_value: None }, CppParam { name: "lodGroupCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "invalidLODGroupID", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "invalidLODGroupCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lodRenderersCount", ty: "int16_t*", modifiers: "", def_value: None }, CppParam { name: "lodScreenRelativeTransitionHeight", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "lodFadeTransitionWidth", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "lodDataCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GPUDrivenLODGroupDataNative(int32_t*  lodGroupID, int32_t*  lodOffset, int32_t*  lodCount, ::UnityEngine::LODFadeMode*  fadeMode, ::UnityEngine::Vector3*  worldSpaceReferencePoint, float_t*  worldSpaceSize, int16_t*  renderersCount, bool*  lastLODIsBillboard, int32_t  lodGroupCount, int32_t*  invalidLODGroupID, int32_t  invalidLODGroupCount, int16_t*  lodRenderersCount, float_t*  lodScreenRelativeTransitionHeight, float_t*  lodFadeTransitionWidth, int32_t  lodDataCount) noexcept;
