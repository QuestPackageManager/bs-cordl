...
// Ctor Parameters [CppParam { name: "drawCommands", ty: "::UnityEngine::Rendering::BatchDrawCommand*", modifiers: "", def_value: None }, CppParam { name: "indirectDrawCommands", ty: "::UnityEngine::Rendering::BatchDrawCommandIndirect*", modifiers: "", def_value: None }, CppParam { name: "proceduralDrawCommands", ty: "::UnityEngine::Rendering::BatchDrawCommandProcedural*", modifiers: "", def_value: None }, CppParam { name: "proceduralIndirectDrawCommands", ty: "::UnityEngine::Rendering::BatchDrawCommandProceduralIndirect*", modifiers: "", def_value: None }, CppParam { name: "visibleInstances", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "drawRanges", ty: "::UnityEngine::Rendering::BatchDrawRange*", modifiers: "", def_value: None }, CppParam { name: "instanceSortingPositions", ty: "float_t*", modifiers: "", def_value: None }, CppParam { name: "drawCommandPickingInstanceIDs", ty: "int32_t*", modifiers: "", def_value: None }, CppParam { name: "drawCommandCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "indirectDrawCommandCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "proceduralDrawCommandCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "proceduralIndirectDrawCommandCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "visibleInstanceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "drawRangeCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "instanceSortingPositionFloatCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr BatchCullingOutputDrawCommands(::UnityEngine::Rendering::BatchDrawCommand*  drawCommands, ::UnityEngine::Rendering::BatchDrawCommandIndirect*  indirectDrawCommands, ::UnityEngine::Rendering::BatchDrawCommandProcedural*  proceduralDrawCommands, ::UnityEngine::Rendering::BatchDrawCommandProceduralIndirect*  proceduralIndirectDrawCommands, int32_t*  visibleInstances, ::UnityEngine::Rendering::BatchDrawRange*  drawRanges, float_t*  instanceSortingPositions, int32_t*  drawCommandPickingInstanceIDs, int32_t  drawCommandCount, int32_t  indirectDrawCommandCount, int32_t  proceduralDrawCommandCount, int32_t  proceduralIndirectDrawCommandCount, int32_t  visibleInstanceCount, int32_t  drawRangeCount, int32_t  instanceSortingPositionFloatCount) noexcept;
