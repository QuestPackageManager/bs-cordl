...
/// @brief Method ComputeHasValidData, addr 0x65df7f0, size 0x58, virtual false, abstract: false, final false
inline bool ComputeHasValidData(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method HasValidData, addr 0x65df848, size 0x8, virtual false, abstract: false, final false
inline bool HasValidData(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method Initialize, addr 0x65dc658, size 0x1c, virtual false, abstract: false, final false
inline void Initialize(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method IsValid, addr 0x65dcde4, size 0x28, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method .ctor, addr 0x65df850, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method Add, addr 0x65df854, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method AlignUp16, addr 0x65dd240, size 0x28, virtual false, abstract: false, final false
static inline int32_t AlignUp16(int32_t  count) ;

/// @brief Method BlendLightingScenario, addr 0x65dc6a4, size 0x344, virtual false, abstract: false, final false
inline void BlendLightingScenario(::StringW  otherScenario, float_t  blendingFactor) ;

/// @brief Method CheckCompatibleCellLayout, addr 0x65db9f4, size 0x8c, virtual false, abstract: false, final false
inline bool CheckCompatibleCellLayout() ;

/// @brief Method Cleanup, addr 0x65dc9e8, size 0x368, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method ComputeHasSupportData, addr 0x65db8a0, size 0x24, virtual false, abstract: false, final false
inline bool ComputeHasSupportData() ;

/// @brief Method ComputeHasValidSharedData, addr 0x65db8c4, size 0x38, virtual false, abstract: false, final false
inline bool ComputeHasValidSharedData() ;

/// @brief Method ComputeRegionMasks, addr 0x65db528, size 0xe0, virtual false, abstract: false, final false
inline ::Unity::Mathematics::uint4 ComputeRegionMasks() ;

/// @brief Method GetBakingHashCode, addr 0x65dd0fc, size 0x144, virtual false, abstract: false, final false
inline int32_t GetBakingHashCode() ;

/// @brief Method GetCellData, addr 0x65df2c8, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeReferenceVolume_CellData* GetCellData(int32_t  cellIndex) ;

/// @brief Method GetCellDesc, addr 0x65df24c, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ProbeReferenceVolume_CellDesc* GetCellDesc(int32_t  cellIndex) ;

/// @brief Method GetCellSizeInBricks, addr 0x65db444, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetCellSizeInBricks(int32_t  simplificationLevels) ;

/// @brief Method GetChunkGPUMemory, addr 0x65df344, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetChunkGPUMemory(::UnityEngine::Rendering::ProbeVolumeSHBands  shBands) ;

/// @brief Method GetMaxSubdivision, addr 0x65db480, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetMaxSubdivision(int32_t  simplificationLevels) ;

/// @brief Method GetMinBrickSize, addr 0x65db4a8, size 0x1c, virtual false, abstract: false, final false
static inline float_t GetMinBrickSize(float_t  minDistanceBetweenProbes) ;

/// @brief Method GetSceneCellIndexList, addr 0x65dd750, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method HasBakedData, addr 0x65dbaa8, size 0x15c, virtual false, abstract: false, final false
inline bool HasBakedData(::StringW  scenario) ;

/// @brief Method HasSupportData, addr 0x65dbaa0, size 0x8, virtual false, abstract: false, final false
inline bool HasSupportData() ;

/// @brief Method HasValidSharedData, addr 0x65db9ec, size 0x8, virtual false, abstract: false, final false
inline bool HasValidSharedData() ;

/// @brief Method Initialize, addr 0x65dc1d0, size 0x488, virtual false, abstract: false, final false
...
/// @brief Method Migrate, addr 0x65db7e0, size 0xc0, virtual false, abstract: false, final false
inline void Migrate() ;

static inline ::UnityEngine::Rendering::ProbeVolumeBakingSet* New_ctor() ;

/// @brief Method OnEnable, addr 0x65db790, size 0x50, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x65db608, size 0x188, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method PruneCellIndexList, addr 0x65dd364, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method PruneCellIndexListForScenario, addr 0x65dd54c, size 0x204, virtual false, abstract: false, final false
...
/// @brief Method ReleaseCell, addr 0x65df1b0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method RequestScratchBuffer, addr 0x65dd268, size 0xfc, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> RequestScratchBuffer(int32_t  size) ;

/// @brief Method ResolveAllCellData, addr 0x65dc674, size 0x30, virtual false, abstract: false, final false
inline bool ResolveAllCellData() ;

/// @brief Method ResolveCellData, addr 0x65de080, size 0x4a0, virtual false, abstract: false, final false
inline bool ResolveCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolvePerScenarioCellData, addr 0x65dec28, size 0x588, virtual false, abstract: false, final false
...
/// @brief Method ResolvePerScenarioCellData, addr 0x65dda00, size 0x680, virtual false, abstract: false, final false
inline bool ResolvePerScenarioCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolveSharedCellData, addr 0x65dd7cc, size 0x234, virtual false, abstract: false, final false
inline bool ResolveSharedCellData(::System::Collections::Generic::List_1<int32_t>*  cellIndices) ;

/// @brief Method ResolveSharedCellData, addr 0x65de520, size 0x708, virtual false, abstract: false, final false
...
/// @brief Method SetActiveScenario, addr 0x65dce0c, size 0x2f0, virtual false, abstract: false, final false
inline void SetActiveScenario(::StringW  scenario, bool  verbose) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x65dbc04, size 0x3e4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x65dbfe8, size 0x1e8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x65df380, size 0x470, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakedSkyOcclusion, addr 0x65db3b0, size 0x10, virtual false, abstract: false, final false
inline bool get_bakedSkyOcclusion() ;

/// @brief Method get_bakedSkyShadingDirection, addr 0x65db3d8, size 0x10, virtual false, abstract: false, final false
inline bool get_bakedSkyShadingDirection() ;

/// @brief Method get_cellSizeInBricks, addr 0x65db410, size 0x34, virtual false, abstract: false, final false
inline int32_t get_cellSizeInBricks() ;

/// @brief Method get_cellSizeInMeters, addr 0x65db4c4, size 0x64, virtual false, abstract: false, final false
inline float_t get_cellSizeInMeters() ;

/// @brief Method get_hasDilation, addr 0x65db380, size 0x20, virtual false, abstract: false, final false
inline bool get_hasDilation() ;

/// @brief Method get_lightingScenarios, addr 0x65db3a8, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_lightingScenarios() ;

/// @brief Method get_maxSubdivision, addr 0x65db474, size 0xc, virtual false, abstract: false, final false
inline int32_t get_maxSubdivision() ;

/// @brief Method get_minBrickSize, addr 0x65db488, size 0x20, virtual false, abstract: false, final false
inline float_t get_minBrickSize() ;

/// @brief Method get_otherScenario, addr 0x65db400, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_otherScenario() ;

/// @brief Method get_scenarioBlendingFactor, addr 0x65db408, size 0x8, virtual false, abstract: false, final false
inline float_t get_scenarioBlendingFactor() ;

/// @brief Method get_sceneGUIDs, addr 0x65db3a0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_sceneGUIDs() ;

/// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

/// @brief Method set_bakedSkyOcclusion, addr 0x65db3c0, size 0x18, virtual false, abstract: false, final false
inline void set_bakedSkyOcclusion(bool  value) ;

/// @brief Method set_bakedSkyShadingDirection, addr 0x65db3e8, size 0x18, virtual false, abstract: false, final false
