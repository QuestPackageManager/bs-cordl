...
public:
  ...
  /// @brief Method get_targetRenderPipeline, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::System::Type* get_targetRenderPipeline();

  /// @brief Method get_volumeComponentsPathAndType, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IVolumeDebugSettings2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVolumeDebugSettings2(IVolumeDebugSettings2const&) = delete;
