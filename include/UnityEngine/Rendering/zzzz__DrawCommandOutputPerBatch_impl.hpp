...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::DrawCommandOutputPerBatch::*)(int32_t, bool)>(&::UnityEngine::Rendering::DrawCommandOutputPerBatch::EncodeGPUInstanceIndexAndCrossFade)> {
  constexpr static std::size_t size = 0xcc;
  constexpr static std::size_t addrs = 0x6661594;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DrawCommandOutputPerBatch>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::DrawCommandOutputPerBatch::*)(int32_t)>(&::UnityEngine::Rendering::DrawCommandOutputPerBatch::IsInstanceFlipped)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::DrawCommandOutputPerBatch::*)(int32_t)>(&::UnityEngine::Rendering::DrawCommandOutputPerBatch::Execute)> {
  constexpr static std::size_t size = 0x744;
  constexpr static std::size_t addrs = 0x6661700;
