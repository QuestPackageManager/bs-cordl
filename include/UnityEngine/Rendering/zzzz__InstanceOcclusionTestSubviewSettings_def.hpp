...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings, "UnityEngine.Rendering", "InstanceOcclusionTestSubviewSettings");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method FromSpan, addr 0x682fc84, size 0xb0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings) == 0x14, "Size mismatch!");
