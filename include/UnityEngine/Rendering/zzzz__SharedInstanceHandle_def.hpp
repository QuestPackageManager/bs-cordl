...
/// @brief Method CompareTo, addr 0x666c7c8, size 0x70, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::Rendering::SharedInstanceHandle  other) ;

/// @brief Method Equals, addr 0x666c75c, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::SharedInstanceHandle  other) ;

/// @brief Method GetHashCode, addr 0x666c838, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::UnityEngine::Rendering::SharedInstanceHandle getStaticF_Invalid() ;

/// @brief Method get_index, addr 0x666c6ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_valid, addr 0x666c6fc, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_index, addr 0x666c6f4, size 0x8, virtual false, abstract: false, final false
