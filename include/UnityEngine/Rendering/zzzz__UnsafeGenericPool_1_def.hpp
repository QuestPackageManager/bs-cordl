...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnsafeGenericPool_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnsafeGenericPool_1(UnsafeGenericPool_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnsafeGenericPool_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnsafeGenericPool_1(UnsafeGenericPool_1const&) = delete;
