...
public:
// Declarations
/// @brief Method Dispose, addr 0x660dfcc, size 0x38, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Load, addr 0x660df40, size 0x8c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Create, addr 0x660de58, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method CopyBuffer, addr 0x660da88, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x660dc80, size 0x1d8, virtual false, abstract: false, final false
inline void Dispatch(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::GPUSort_Args  args) ;

/// @brief Method DispatchStage, addr 0x660d7c8, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method DivRoundUp, addr 0x660dc70, size 0x10, virtual false, abstract: false, final false
static inline int32_t DivRoundUp(int32_t  x, int32_t  y) ;

/// @brief Method .ctor, addr 0x660d610, size 0x1b8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Keywords", ty: "::ArrayW<::UnityEngine::Rendering::LocalKeyword,::Array<::UnityEngine::Rendering::LocalKeyword>*>", modifiers: "", def_value: None }, CppParam { name: "resources", ty: "::UnityEngine::Rendering::GPUSort_SystemResources", modifiers: "", def_value: None }]
constexpr GPUSort(::ArrayW<::UnityEngine::Rendering::LocalKeyword,::Array<::UnityEngine::Rendering::LocalKeyword>*>  m_Keywords, ::UnityEngine::Rendering::GPUSort_SystemResources  resources) noexcept;
