...
public:
  // Declarations
  /// @brief Method Dispose, addr 0x667ffd8, size 0x38, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Load, addr 0x667ff4c, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Create, addr 0x667fe64, size 0xe8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CopyBuffer, addr 0x667fa94, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0x667fc8c, size 0x1d8, virtual false, abstract: false, final false
  inline void Dispatch(::UnityEngine::Rendering::CommandBuffer* cmd, ::UnityEngine::Rendering::GPUSort_Args args);

  /// @brief Method DispatchStage, addr 0x667f7d4, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method DivRoundUp, addr 0x667fc7c, size 0x10, virtual false, abstract: false, final false
  static inline int32_t DivRoundUp(int32_t x, int32_t y);

  /// @brief Method .ctor, addr 0x667f61c, size 0x1b8, virtual false, abstract: false, final false
