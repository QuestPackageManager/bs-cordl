...
public:
  ...
  /// @brief Method GetReset, addr 0x664d040, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Action* GetReset();

  /// @brief Method Init, addr 0x664cfd4, size 0x6c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::UnityEngine::Rendering::ProbeVolumeDebug* New_ctor();

  /// @brief Method <GetReset>b__32_0, addr 0x664d0bc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x664cf68, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
