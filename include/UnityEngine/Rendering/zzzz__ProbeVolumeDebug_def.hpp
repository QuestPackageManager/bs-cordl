...
/// @brief Method GetReset, addr 0x65db034, size 0x7c, virtual true, abstract: false, final true
inline ::System::Action* GetReset() ;

/// @brief Method Init, addr 0x65dafc8, size 0x6c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::Rendering::ProbeVolumeDebug* New_ctor() ;

/// @brief Method <GetReset>b__32_0, addr 0x65db0b0, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65daf5c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
