...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b2b658, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b2b510, size 0x148, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b2b73c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b2b6d0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b2b750, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBatch, addr 0x6b2abf0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch, addr 0x6b2aad8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch_Injected, addr 0x6b2ab6c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6b2aa54, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method OcclusionTestAABB_Injected, addr 0x6b2b4cc, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB_Injected(::System::IntPtr occlusionBuffer, ::by_ref<::UnityEngine::Bounds> aabb);

  /// @brief Method RegisterMaterials, addr 0x6b2ad0c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMaterials_Injected, addr 0x6b2ae24, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes, addr 0x6b2af18, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes_Injected, addr 0x6b2b030, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBatch, addr 0x6b2ad04, size 0x8, virtual false, abstract: false, final false
  inline void RemoveBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch, addr 0x6b2ac64, size 0x5c, virtual false, abstract: false, final false
  inline void RemoveDrawCommandBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch_Injected, addr 0x6b2acc0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMaterial, addr 0x6b2ae78, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMaterial(::UnityEngine::Rendering::BatchMaterialID material);

  /// @brief Method UnregisterMaterial_Injected, addr 0x6b2aed4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMesh, addr 0x6b2b084, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMesh(::UnityEngine::Rendering::BatchMeshID mesh);

  /// @brief Method UnregisterMesh_Injected, addr 0x6b2b0e0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b2a9a4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::BatchRendererGroupCreateInfo info);

  /// @brief Method get_BufferTarget, addr 0x6b2b14c, size 0x28, virtual false, abstract: false, final false
