...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x48ce6f4, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48ce5f0, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeOnPerformCulling, addr 0x48ce3ac, size 0x244, virtual false, abstract: false, final false
