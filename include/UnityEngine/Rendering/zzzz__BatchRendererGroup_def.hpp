...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68f7490, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f7348, size 0x148, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68f7574, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f7508, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x68f7588, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBatch, addr 0x68f6a28, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch, addr 0x68f6910, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch_Injected, addr 0x68f69a4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x68f6848, size 0x44, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(::UnityEngine::Rendering::BatchRendererGroup* group, void* userContext);

  /// @brief Method Destroy, addr 0x68f68d4, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr groupHandle);

  /// @brief Method Dispose, addr 0x68f688c, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetBufferTarget, addr 0x68f6f5c, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::BatchBufferTarget GetBufferTarget();

  /// @brief Method InvokeOnFinishedCulling, addr 0x68f71f0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeOnPerformCulling, addr 0x68f6fac, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method OcclusionTestAABB, addr 0x68f72c0, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB(::System::IntPtr occlusionBuffer, ::UnityEngine::Bounds aabb);

  /// @brief Method OcclusionTestAABB_Injected, addr 0x68f7304, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB_Injected(::System::IntPtr occlusionBuffer, ::ByRef<::UnityEngine::Bounds> aabb);

  /// @brief Method RegisterMaterials, addr 0x68f6b44, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMaterials_Injected, addr 0x68f6c5c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes, addr 0x68f6d50, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes_Injected, addr 0x68f6e68, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBatch, addr 0x68f6b3c, size 0x8, virtual false, abstract: false, final false
  inline void RemoveBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch, addr 0x68f6a9c, size 0x5c, virtual false, abstract: false, final false
  inline void RemoveDrawCommandBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch_Injected, addr 0x68f6af8, size 0x44, virtual false, abstract: false, final false
  static inline void RemoveDrawCommandBatch_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Rendering::BatchID> batchID);

  /// @brief Method UnregisterMaterial, addr 0x68f6cb0, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMaterial(::UnityEngine::Rendering::BatchMaterialID material);

  /// @brief Method UnregisterMaterial_Injected, addr 0x68f6d0c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMesh, addr 0x68f6ebc, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMesh(::UnityEngine::Rendering::BatchMeshID mesh);

  /// @brief Method UnregisterMesh_Injected, addr 0x68f6f18, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f67dc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::BatchRendererGroupCreateInfo info);

  /// @brief Method get_BufferTarget, addr 0x68f6f84, size 0x28, virtual false, abstract: false, final false
