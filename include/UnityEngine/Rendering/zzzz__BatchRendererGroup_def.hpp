...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x48caf84, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48cae80, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeOnPerformCulling, addr 0x48cac3c, size 0x244, virtual false, abstract: false, final false
