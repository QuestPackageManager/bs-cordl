...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b280d0, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b27f88, size 0x148, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b281b4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b28148, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b281c8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddBatch, addr 0x6b27668, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch, addr 0x6b27550, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AddDrawCommandBatch_Injected, addr 0x6b275e4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x6b27488, size 0x44, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(::UnityEngine::Rendering::BatchRendererGroup* group, void* userContext);

  /// @brief Method Destroy, addr 0x6b27514, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr groupHandle);

  /// @brief Method Dispose, addr 0x6b274cc, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetBufferTarget, addr 0x6b27b9c, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::BatchBufferTarget GetBufferTarget();

  /// @brief Method InvokeOnFinishedCulling, addr 0x6b27e30, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeOnPerformCulling, addr 0x6b27bec, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method OcclusionTestAABB, addr 0x6b27f00, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB(::System::IntPtr occlusionBuffer, ::UnityEngine::Bounds aabb);

  /// @brief Method OcclusionTestAABB_Injected, addr 0x6b27f44, size 0x44, virtual false, abstract: false, final false
  static inline bool OcclusionTestAABB_Injected(::System::IntPtr occlusionBuffer, ::by_ref<::UnityEngine::Bounds> aabb);

  /// @brief Method RegisterMaterials, addr 0x6b27784, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMaterials_Injected, addr 0x6b2789c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes, addr 0x6b27990, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterMeshes_Injected, addr 0x6b27aa8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBatch, addr 0x6b2777c, size 0x8, virtual false, abstract: false, final false
  inline void RemoveBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch, addr 0x6b276dc, size 0x5c, virtual false, abstract: false, final false
  inline void RemoveDrawCommandBatch(::UnityEngine::Rendering::BatchID batchID);

  /// @brief Method RemoveDrawCommandBatch_Injected, addr 0x6b27738, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMaterial, addr 0x6b278f0, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMaterial(::UnityEngine::Rendering::BatchMaterialID material);

  /// @brief Method UnregisterMaterial_Injected, addr 0x6b2794c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterMesh, addr 0x6b27afc, size 0x5c, virtual false, abstract: false, final false
  inline void UnregisterMesh(::UnityEngine::Rendering::BatchMeshID mesh);

  /// @brief Method UnregisterMesh_Injected, addr 0x6b27b58, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b2741c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::BatchRendererGroupCreateInfo info);

  /// @brief Method get_BufferTarget, addr 0x6b27bc4, size 0x28, virtual false, abstract: false, final false
