...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::Type*,::Array<::System::Type*>*> (::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline::*)()>(&::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline::get_pipelineTypes)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x66146ec;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline*>::get(),
                        "get_pipelineTypes",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline::*)(::StringW, ::ArrayW<::System::Type*,::Array<::System::Type*>*>)>(&::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline::_ctor)> {
  constexpr static std::size_t size = 0x1b8;
  constexpr static std::size_t addrs = 0x66146f4;
...
inline ::UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline* UnityEngine::Rendering::VolumeComponentMenuForRenderPipeline::New_ctor(::StringW  menu, ::ArrayW<::System::Type*,::Array<::System::Type*>*>  pipelineTypes)  {
