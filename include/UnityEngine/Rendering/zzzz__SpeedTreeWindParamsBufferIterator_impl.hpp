...
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer() {}
// Ctor Parameters [CppParam { name: "bufferPtr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "uintParamOffsets", ty:
// "::UnityEngine::Rendering::SpeedTreeWindParamsBufferIterator__uintParamOffsets_e__FixedBuffer", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "uintStride", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "elementOffset", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "elementsCount", ty:
