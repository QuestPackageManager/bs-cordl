...
public:
  ...
  /// @brief Method .ctor, addr 0x6791118, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_version, addr 0x6791110, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeBakingResources) == 0x60, "Size mismatch!");
