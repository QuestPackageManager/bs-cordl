...
public:
  ...
  /// @brief Method .ctor, addr 0x6651e94, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_version, addr 0x6651e8c, size 0x8, virtual true, abstract: false, final true
