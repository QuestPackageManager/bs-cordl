...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::ByRef<::UnityEngine::Jobs::TransformAccessArray>, int32_t)>(
  ...
  constexpr static std::size_t addrs = 0x667050c;
...
template <typename T> inline void UnityEngine::Rendering::ArrayExtensions::FillArray(::ByRef<::Unity::Collections::NativeArray_1<T>> array, ::ByRef<T> value, int32_t startIndex, int32_t length) {
  static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ArrayExtensions*>::get(), "FillArray",
      std::array<Il2CppClass const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
