...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::PackingRules, "UnityEngine.Rendering", "PackingRules");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::PackingRules) == 0x4, "Size mismatch!");
