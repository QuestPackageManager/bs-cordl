...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::OpenGLESVersion, "UnityEngine.Rendering", "OpenGLESVersion");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::OpenGLESVersion) == 0x4, "Size mismatch!");
