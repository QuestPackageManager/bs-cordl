...
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables___OccluderMipBounds_e__FixedBuffer::OcclusionCullingDebugShaderVariables___OccluderMipBounds_e__FixedBuffer() {}
// Ctor Parameters [CppParam { name: "_DepthSizeInOccluderPixels", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_OccluderMipBounds", ty:
// "::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables___OccluderMipBounds_e__FixedBuffer", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "_OccluderMipLayoutSizeX", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_OccluderMipLayoutSizeY", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "_OcclusionCullingDebugPad0", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_OcclusionCullingDebugPad1", ty: "uint32_t",
