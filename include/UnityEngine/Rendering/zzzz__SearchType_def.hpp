...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(SearchType)
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SearchType, "UnityEngine.Rendering", "SearchType");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::SearchType) == 0x4, "Size mismatch!");
