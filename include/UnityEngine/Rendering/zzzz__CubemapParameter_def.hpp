...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x66895e0, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::CubemapParameter* New_ctor(::UnityEngine::Texture* value, bool overrideState);

  /// @brief Method .ctor, addr 0x668957c, size 0x64, virtual false, abstract: false, final false
