...
// Ctor Parameters [CppParam { name: "topology", ty: "::UnityEngine::MeshTopology", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "baseVertex", ty: "uint32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "firstIndex", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexCount", ty: "uint32_t",
