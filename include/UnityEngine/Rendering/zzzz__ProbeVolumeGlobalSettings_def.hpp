...
#include <cstdint>
CORDL_MODULE_EXPORT(ProbeVolumeGlobalSettings)
namespace UnityEngine::Rendering {
class IRenderPipelineGraphicsSettings;
}
// Forward declare root types
namespace UnityEngine::Rendering {
class ProbeVolumeGlobalSettings;
}
// Write type traits
...
public:
  ...
  /// @brief Method .ctor, addr 0x67911a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_probeVolumeDisableStreamingAssets, addr 0x679112c, size 0x8, virtual false, abstract: false, final false
  inline bool get_probeVolumeDisableStreamingAssets();

  /// @brief Method get_version, addr 0x6791124, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_version();

  /// @brief Convert to "::UnityEngine::Rendering::IRenderPipelineGraphicsSettings"
  constexpr ::UnityEngine::Rendering::IRenderPipelineGraphicsSettings* i___UnityEngine__Rendering__IRenderPipelineGraphicsSettings() noexcept;

  /// @brief Method set_probeVolumeDisableStreamingAssets, addr 0x6791134, size 0x70, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::Rendering::ProbeVolumeGlobalSettings, ___m_ProbeVolumeDisableStreamingAssets) == 0x14, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Rendering::ProbeVolumeGlobalSettings) == 0x18, "Size mismatch!");
