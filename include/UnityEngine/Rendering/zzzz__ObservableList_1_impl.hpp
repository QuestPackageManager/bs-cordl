...
template <typename T> inline void UnityEngine::Rendering::ObservableList_1<T>::Add(/* [ParamArray] */ ::ArrayW<T> items) {
  static auto* ___internal_method =
...
template <typename T> inline int32_t UnityEngine::Rendering::ObservableList_1<T>::Remove(/* [ParamArray] */ ::ArrayW<T> items) {
  static auto* ___internal_method =
