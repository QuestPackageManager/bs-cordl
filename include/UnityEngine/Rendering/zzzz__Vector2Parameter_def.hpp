...
public:
  // Declarations
  /// @brief Method Interp, addr 0x6616310, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66162a0, size 0x70, virtual false, abstract: false, final false
