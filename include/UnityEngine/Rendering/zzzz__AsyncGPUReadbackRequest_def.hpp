...
/// @brief Method GetDataRaw, addr 0x693df80, size 0x44, virtual false, abstract: false, final false
inline ::System::IntPtr GetDataRaw(int32_t  layer) ;

/// @brief Method GetLayerCount, addr 0x693de88, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetLayerCount() ;

/// @brief Method GetLayerDataSize, addr 0x693df00, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetLayerDataSize() ;

/// @brief Method HasError, addr 0x693de10, size 0x3c, virtual false, abstract: false, final false
inline bool HasError() ;

/// @brief Method InvokeCallback, addr 0x693dfc4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IsDone, addr 0x693dd98, size 0x3c, virtual false, abstract: false, final false
inline bool IsDone() ;

/// @brief Method SetScriptingCallback, addr 0x693df3c, size 0x44, virtual false, abstract: false, final false
inline void SetScriptingCallback(::System::Action_1<::UnityEngine::Rendering::AsyncGPUReadbackRequest>*  callback) ;

/// @brief Method WaitForCompletion, addr 0x693dd20, size 0x3c, virtual false, abstract: false, final false
inline void WaitForCompletion() ;

/// @brief Method get_done, addr 0x693dd5c, size 0x3c, virtual false, abstract: false, final false
inline bool get_done() ;

/// @brief Method get_hasError, addr 0x693ddd4, size 0x3c, virtual false, abstract: false, final false
inline bool get_hasError() ;

/// @brief Method get_layerCount, addr 0x693de4c, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_layerCount() ;

/// @brief Method get_layerDataSize, addr 0x693dec4, size 0x3c, virtual false, abstract: false, final false
