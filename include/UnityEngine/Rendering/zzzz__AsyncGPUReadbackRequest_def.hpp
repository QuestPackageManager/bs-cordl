...
public:
  ...
  /// @brief Method GetDataRaw, addr 0x69b01c8, size 0x44, virtual false, abstract: false, final false
  inline ::System::IntPtr GetDataRaw(int32_t layer);

  /// @brief Method GetLayerCount, addr 0x69b00d0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetLayerCount();

  /// @brief Method GetLayerDataSize, addr 0x69b0148, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetLayerDataSize();

  /// @brief Method HasError, addr 0x69b0058, size 0x3c, virtual false, abstract: false, final false
  inline bool HasError();

  /// @brief Method InvokeCallback, addr 0x69b020c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDone, addr 0x69affe0, size 0x3c, virtual false, abstract: false, final false
  inline bool IsDone();

  /// @brief Method SetScriptingCallback, addr 0x69b0184, size 0x44, virtual false, abstract: false, final false
  inline void SetScriptingCallback(::System::Action_1<::UnityEngine::Rendering::AsyncGPUReadbackRequest>* callback);

  /// @brief Method WaitForCompletion, addr 0x69aff68, size 0x3c, virtual false, abstract: false, final false
  inline void WaitForCompletion();

  /// @brief Method get_done, addr 0x69affa4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_done();

  /// @brief Method get_hasError, addr 0x69b001c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_hasError();

  /// @brief Method get_layerCount, addr 0x69b0094, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_layerCount();

  /// @brief Method get_layerDataSize, addr 0x69b010c, size 0x3c, virtual false, abstract: false, final false
