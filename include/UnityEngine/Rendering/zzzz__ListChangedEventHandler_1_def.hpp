...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ListChangedEventHandler_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListChangedEventHandler_1(ListChangedEventHandler_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListChangedEventHandler_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListChangedEventHandler_1(ListChangedEventHandler_1const&) = delete;
