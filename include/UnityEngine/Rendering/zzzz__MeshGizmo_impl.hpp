...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)(int32_t)>(&::UnityEngine::Rendering::MeshGizmo::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x67c1f20;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)()>(&::UnityEngine::Rendering::MeshGizmo::Clear)> {
  ...
  constexpr static std::size_t addrs = 0x67c2094;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Color)>(
  ...
  constexpr static std::size_t addrs = 0x67c213c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::MeshGizmo*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)(
  ...
  constexpr static std::size_t addrs = 0x67c2680;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::MeshGizmo*>(),
                                                             { "DrawMesh",
                                                               {},
                                                               { ::i2c::type_of<::UnityEngine::Matrix4x4>(), ::i2c::type_of<::UnityEngine::Material*>(), ::i2c::type_of<::UnityEngine::MeshTopology>(),
                                                                 ::i2c::type_of<::UnityEngine::Rendering::CompareFunction>(), ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)(::UnityEngine::Matrix4x4, ::UnityEngine::Rendering::CompareFunction, ::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x67c283c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)()>(&::UnityEngine::Rendering::MeshGizmo::Dispose)> {
  ...
  constexpr static std::size_t addrs = 0x67c2878;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::MeshGizmo::*)(
  ...
  constexpr static std::size_t addrs = 0x67c235c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::MeshGizmo*>(), { "<AddWireCube>g__AddEdge|10_0",
                                                                                                    {},
                                                                                                    { ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Vector3>(),
                                                                                                      ::i2c::type_of<::by_ref<::UnityEngine::Rendering::MeshGizmo___c__DisplayClass10_0>>() } })));
    return ___internal_method;
  }
};
...
inline void UnityEngine::Rendering::MeshGizmo::AddWireCube(::UnityEngine::Vector3 center, ::UnityEngine::Vector3 size, ::UnityEngine::Color color) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::MeshGizmo*>(),
                                              { "AddWireCube", {}, { ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Color>() } })));
...
inline void UnityEngine::Rendering::MeshGizmo::_AddWireCube_g__AddEdge_10_0(::UnityEngine::Vector3 p1, ::UnityEngine::Vector3 p2,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::MeshGizmo*>(), { "<AddWireCube>g__AddEdge|10_0",
                                                                                                         {},
                                                                                                         { ::i2c::type_of<::UnityEngine::Vector3>(), ::i2c::type_of<::UnityEngine::Vector3>(),
                                                                                                           ::i2c::type_of<::by_ref<::UnityEngine::Rendering::MeshGizmo___c__DisplayClass10_0>>() } })));
