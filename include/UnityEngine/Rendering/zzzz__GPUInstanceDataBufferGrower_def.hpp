...
public:
  ...
  /// @brief Method CreateResources, addr 0x66de228, size 0x4, virtual false, abstract: false, final false
  inline void CreateResources();

  /// @brief Method Dispose, addr 0x66de55c, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LoadShaders, addr 0x66de4a8, size 0xb4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x66de22c, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method SubmitToGpu, addr 0x66ddf5c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66dddd0, size 0x18c, virtual false, abstract: false, final false
