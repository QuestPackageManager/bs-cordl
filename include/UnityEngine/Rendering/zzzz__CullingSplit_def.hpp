...
// Ctor Parameters [CppParam { name: "sphereCenter", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "sphereRadius", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cullingPlaneOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cullingPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cascadeBlendCullingFactor", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "nearPlane", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cullingMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }]
constexpr CullingSplit(::UnityEngine::Vector3  sphereCenter, float_t  sphereRadius, int32_t  cullingPlaneOffset, int32_t  cullingPlaneCount, float_t  cascadeBlendCullingFactor, float_t  nearPlane, ::UnityEngine::Matrix4x4  cullingMatrix) noexcept;
