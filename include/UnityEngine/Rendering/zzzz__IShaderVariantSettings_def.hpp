...
public:
  ...
  /// @brief Method get_stripDebugVariants, addr 0x662b394, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_stripDebugVariants, addr 0x662b39c, size 0x4, virtual true, abstract: false, final false
