...
/// @brief Method CIExyToLMS, addr 0x66064a0, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 CIExyToLMS(float_t  x, float_t  y) ;

/// @brief Method ColorBalanceToLMSCoeffs, addr 0x6606530, size 0x160, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 ColorBalanceToLMSCoeffs(float_t  temperature, float_t  tint) ;

/// @brief Method ComputeEV100, addr 0x6606d74, size 0x98, virtual false, abstract: false, final false
static inline float_t ComputeEV100(float_t  aperture, float_t  shutterSpeed, float_t  ISO) ;

/// @brief Method ComputeEV100FromAvgLuminance, addr 0x6606f44, size 0xc8, virtual false, abstract: false, final false
static inline float_t ComputeEV100FromAvgLuminance(float_t  avgLuminance) ;

/// @brief Method ComputeISO, addr 0x660700c, size 0x3c, virtual false, abstract: false, final false
static inline float_t ComputeISO(float_t  aperture, float_t  shutterSpeed, float_t  targetEV100) ;

/// @brief Method ConvertEV100ToExposure, addr 0x6606e0c, size 0x78, virtual false, abstract: false, final false
static inline float_t ConvertEV100ToExposure(float_t  EV100) ;

/// @brief Method ConvertExposureToEV100, addr 0x6606e84, size 0xc0, virtual false, abstract: false, final false
static inline float_t ConvertExposureToEV100(float_t  exposure) ;

/// @brief Method Luminance, addr 0x6606cb8, size 0x30, virtual false, abstract: false, final false
static inline float_t Luminance(::ByRef<::UnityEngine::Color>  color) ;

/// @brief Method PrepareLiftGammaGain, addr 0x6606928, size 0x390, virtual false, abstract: false, final false
static inline ::System::ValueTuple_3<::UnityEngine::Vector4,::UnityEngine::Vector4,::UnityEngine::Vector4> PrepareLiftGammaGain(::ByRef<::UnityEngine::Vector4>  inLift, ::ByRef<::UnityEngine::Vector4>  inGamma, ::ByRef<::UnityEngine::Vector4>  inGain) ;

/// @brief Method PrepareShadowsMidtonesHighlights, addr 0x6606690, size 0x298, virtual false, abstract: false, final false
static inline ::System::ValueTuple_3<::UnityEngine::Vector4,::UnityEngine::Vector4,::UnityEngine::Vector4> PrepareShadowsMidtonesHighlights(::ByRef<::UnityEngine::Vector4>  inShadows, ::ByRef<::UnityEngine::Vector4>  inMidtones, ::ByRef<::UnityEngine::Vector4>  inHighlights) ;

/// @brief Method PrepareSplitToning, addr 0x6606ce8, size 0x8c, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<::UnityEngine::Vector4,::UnityEngine::Vector4> PrepareSplitToning(::ByRef<::UnityEngine::Vector4>  inShadows, ::ByRef<::UnityEngine::Vector4>  inHighlights, float_t  balance) ;

/// @brief Method StandardIlluminantY, addr 0x6606474, size 0x2c, virtual false, abstract: false, final false
static inline float_t StandardIlluminantY(float_t  x) ;

/// @brief Method ToHex, addr 0x6607048, size 0x70, virtual false, abstract: false, final false
static inline uint32_t ToHex(::UnityEngine::Color  c) ;

/// @brief Method ToRGBA, addr 0x66070b8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_lensImperfectionExposureScale, addr 0x6606400, size 0x74, virtual false, abstract: false, final false
