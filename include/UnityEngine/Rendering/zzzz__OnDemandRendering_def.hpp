...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x68d7268, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x68d720c, size 0x5c, virtual false, abstract: false, final false
