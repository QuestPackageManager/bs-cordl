...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x48c8330, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x48c82d8, size 0x58, virtual false, abstract: false, final false
