...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x69400ec, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x6940090, size 0x5c, virtual false, abstract: false, final false
