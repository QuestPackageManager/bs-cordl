...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x48c4bc0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x48c4b68, size 0x58, virtual false, abstract: false, final false
