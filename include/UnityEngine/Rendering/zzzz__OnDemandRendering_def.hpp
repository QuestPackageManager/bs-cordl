...
public:
  ...
  /// @brief Method GetRenderFrameInterval, addr 0x48d1360, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x48d1308, size 0x58, virtual false, abstract: false, final false
