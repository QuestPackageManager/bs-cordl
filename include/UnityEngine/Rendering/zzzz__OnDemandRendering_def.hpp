...
public:
  ...
  /// [RequiredByNativeCode]
  /// @brief Method GetRenderFrameInterval, addr 0x6b0b348, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_renderFrameInterval, addr 0x6b0b2ec, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OnDemandRendering", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OnDemandRendering(OnDemandRendering&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OnDemandRendering", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OnDemandRendering(OnDemandRenderingconst&) = delete;
