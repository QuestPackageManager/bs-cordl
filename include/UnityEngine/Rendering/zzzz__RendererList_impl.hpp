...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::RendererList::*)()>(&::UnityEngine::Rendering::RendererList::get_isValid)> {
  ...
  constexpr static std::size_t addrs = 0x695a020;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::RendererList::*)(::System::UIntPtr, uint32_t)>(&::UnityEngine::Rendering::RendererList::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x695a05c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::UIntPtr>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<uint32_t>::get()}
                    )));
    return ___internal_method;
  }
};
inline void UnityEngine::Rendering::RendererList::setStaticF_nullRendererList(::UnityEngine::Rendering::RendererList  value)  {
::cordl_internals::setStaticField<::UnityEngine::Rendering::RendererList, "nullRendererList", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RendererList>::get>(std::forward<::UnityEngine::Rendering::RendererList>(value));
}
inline ::UnityEngine::Rendering::RendererList UnityEngine::Rendering::RendererList::getStaticF_nullRendererList()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::RendererList, "nullRendererList", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::RendererList>::get>();
}
