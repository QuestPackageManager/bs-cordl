...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::IntParameter::*)(int32_t, bool)>(&::UnityEngine::Rendering::IntParameter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6615dc4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::IntParameter*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::IntParameter::*)(int32_t, int32_t, float_t)>(&::UnityEngine::Rendering::IntParameter::Interp)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x6615e28;
