...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1<T>, Unity.Collections.NativeParallelHashMap`2::ReadOnly<TKey, TValue>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.Rendering.BatchMaterialID, UnityEngine.Rendering.BatchMeshID, UnityEngine.Rendering.DrawBatch, UnityEngine.Rendering.DrawInstance, UnityEngine.Rendering.DrawKey, UnityEngine.Rendering.DrawRange, UnityEngine.Rendering.GPUDrivenPackedMaterialData, UnityEngine.Rendering.GPUDrivenRendererGroupData, UnityEngine.Rendering.InstanceHandle, UnityEngine.Rendering.RangeKey
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method EditDrawBatch, addr 0x66663e0, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method EditDrawRange, addr 0x6666268, size 0x178, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::Rendering::DrawRange> EditDrawRange(::ByRef<::UnityEngine::Rendering::RangeKey>  key) ;

/// @brief Method Execute, addr 0x6666c28, size 0x44, virtual true, abstract: false, final true
inline void Execute() ;

/// @brief Method ProcessRenderer, addr 0x666658c, size 0x69c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "implicitInstanceIndices", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "rendererData", ty: "::UnityEngine::Rendering::GPUDrivenRendererGroupData", modifiers: "", def_value: None }, CppParam { name: "batchMeshHash", ty: "::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::BatchMeshID>", modifiers: "", def_value: None }, CppParam { name: "batchMaterialHash", ty: "::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::BatchMaterialID>", modifiers: "", def_value: None }, CppParam { name: "packedMaterialDataHash", ty: "::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::GPUDrivenPackedMaterialData>", modifiers: "", def_value: None }, CppParam { name: "rangeHash", ty: "::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::RangeKey,int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawRanges", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawRange>", modifiers: "", def_value: None }, CppParam { name: "batchHash", ty: "::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawBatches", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>", modifiers: "", def_value: None }, CppParam { name: "drawInstances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>", modifiers: "", def_value: None }]
constexpr CreateDrawBatchesJob(bool  implicitInstanceIndices, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::UnityEngine::Rendering::GPUDrivenRendererGroupData  rendererData, ::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::BatchMeshID>  batchMeshHash, ::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::BatchMaterialID>  batchMaterialHash, ::Unity::Collections::NativeParallelHashMap_2_ReadOnly<int32_t,::UnityEngine::Rendering::GPUDrivenPackedMaterialData>  packedMaterialDataHash, ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::RangeKey,int32_t>  rangeHash, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawRange>  drawRanges, ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>  batchHash, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>  drawBatches, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>  drawInstances) noexcept;
