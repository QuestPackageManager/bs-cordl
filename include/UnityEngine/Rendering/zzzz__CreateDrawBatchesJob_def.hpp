...
public:
  ...
  /// @brief Method EditDrawBatch, addr 0x66d83ec, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method EditDrawRange, addr 0x66d8274, size 0x178, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::DrawRange> EditDrawRange(::ByRef<::UnityEngine::Rendering::RangeKey> key);

  /// @brief Method Execute, addr 0x66d8c34, size 0x44, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method ProcessRenderer, addr 0x66d8598, size 0x69c, virtual false, abstract: false, final false
