...
/// @brief Method .ctor, addr 0x65ae720, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_open, addr 0x65b0d58, size 0x8, virtual false, abstract: false, final false
inline bool get_open() ;

/// @brief Method set_open, addr 0x65b0750, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method <TogglePersistent>b__60_0, addr 0x65b0dc0, size 0x80, virtual false, abstract: false, final false
inline int32_t _TogglePersistent_b__60_0(::UnityEngine::Rendering::DebugUI_Widget*  w) ;

/// @brief Method <.cctor>b__95_0, addr 0x65b0e40, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugManager* __cctor_b__95_0() ;

/// @brief Method <.ctor>b__49_0, addr 0x65b0db8, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__49_0(bool  _p0_) ;

/// @brief Method <.ctor>b__49_1, addr 0x65b0dbc, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__49_1() ;

/// @brief Method .ctor, addr 0x65b0db4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <FindPanelIndex>b__0, addr 0x65b0e94, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65af7a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_DebugActionStates, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DebugActionStates, put=__cordl_internal_set_m_DebugActionStates)) ::ArrayW<::UnityEngine::Rendering::DebugActionState*,::Array<::UnityEngine::Rendering::DebugActionState*>*>  m_DebugActionStates;

/// @brief Field m_DebugActions, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DebugActions, put=__cordl_internal_set_m_DebugActions)) ::ArrayW<::UnityEngine::Rendering::DebugActionDesc*,::Array<::UnityEngine::Rendering::DebugActionDesc*>*>  m_DebugActions;
...
/// @brief Method AddAction, addr 0x65ac8c8, size 0xe0, virtual false, abstract: false, final false
inline void AddAction(::UnityEngine::Rendering::DebugAction  action, ::UnityEngine::Rendering::DebugActionDesc*  desc) ;

/// @brief Method ChangeSelection, addr 0x65ae8b8, size 0x1c, virtual false, abstract: false, final false
inline void ChangeSelection(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget, bool  fromNext) ;

/// @brief Method EnableInputActions, addr 0x65ac9a8, size 0x240, virtual false, abstract: false, final false
inline void EnableInputActions() ;

/// @brief Method EnsurePersistentCanvas, addr 0x65ae970, size 0x20c, virtual false, abstract: false, final false
inline void EnsurePersistentCanvas() ;

/// @brief Method FindPanelIndex, addr 0x65af6c0, size 0xe0, virtual false, abstract: false, final false
inline int32_t FindPanelIndex(::StringW  displayName) ;

/// @brief Method GetAction, addr 0x65ad044, size 0x38, virtual false, abstract: false, final false
inline float_t GetAction(::UnityEngine::Rendering::DebugAction  action) ;

/// @brief Method GetActionReleaseScrollTarget, addr 0x65ad2b0, size 0x180, virtual false, abstract: false, final false
inline bool GetActionReleaseScrollTarget() ;

/// @brief Method GetActionToggleDebugMenuWithTouch, addr 0x65ad07c, size 0x234, virtual false, abstract: false, final false
inline bool GetActionToggleDebugMenuWithTouch() ;

/// @brief Method GetItem, addr 0x65b00c0, size 0x114, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Widget* GetItem(::StringW  queryPath) ;

/// @brief Method GetItem, addr 0x65b01d4, size 0x33c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Widget* GetItem(::StringW  queryPath, ::UnityEngine::Rendering::DebugUI_IContainer*  container) ;

/// @brief Method GetItems, addr 0x65af928, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method GetItemsFromContainer, addr 0x65afb98, size 0x528, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Rendering::DebugUI_Widget*,::Array<::UnityEngine::Rendering::DebugUI_Widget*>*> GetItemsFromContainer(::UnityEngine::Rendering::DebugUI_Flags  flags, ::UnityEngine::Rendering::DebugUI_IContainer*  container) ;

/// @brief Method GetPanel, addr 0x65a575c, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method GetRequestedEditorWindowPanelIndex, addr 0x65af2c0, size 0x10, virtual false, abstract: false, final false
inline ::System::Nullable_1<int32_t> GetRequestedEditorWindowPanelIndex() ;

/// @brief Method GetState, addr 0x65ae768, size 0x11c, virtual false, abstract: false, final false
inline int32_t GetState() ;

static inline ::UnityEngine::Rendering::DebugManager* New_ctor() ;

/// @brief Method OnPanelDirty, addr 0x65af0c8, size 0x20, virtual false, abstract: false, final false
inline void OnPanelDirty(::UnityEngine::Rendering::DebugUI_Panel*  panel) ;

/// @brief Method PanelDiplayName, addr 0x65af1bc, size 0xac, virtual false, abstract: false, final false
inline ::StringW PanelDiplayName(int32_t  panelIndex) ;

/// @brief Method PanelIndex, addr 0x65af0e8, size 0xd4, virtual false, abstract: false, final false
inline int32_t PanelIndex(::StringW  displayName) ;

/// @brief Method ReDrawOnScreenDebug, addr 0x65a9abc, size 0x28, virtual false, abstract: false, final false
inline void ReDrawOnScreenDebug() ;

/// @brief Method RefreshEditor, addr 0x65a5694, size 0xc, virtual false, abstract: false, final false
inline void RefreshEditor() ;

/// @brief Method RegisterActions, addr 0x65ac4d8, size 0x3ec, virtual false, abstract: false, final false
inline void RegisterActions() ;

/// @brief Method RegisterData, addr 0x65a56a4, size 0xb8, virtual false, abstract: false, final false
inline void RegisterData(::UnityEngine::Rendering::IDebugData*  data) ;

/// @brief Method RegisterInputs, addr 0x65ad430, size 0xa70, virtual false, abstract: false, final false
inline void RegisterInputs() ;

/// @brief Method RegisterRootCanvas, addr 0x65ae884, size 0x34, virtual false, abstract: false, final false
inline void RegisterRootCanvas(::UnityEngine::Rendering::UI::DebugUIHandlerCanvas*  root) ;

/// @brief Method RemovePanel, addr 0x65af7a4, size 0x184, virtual false, abstract: false, final false
inline void RemovePanel(::StringW  displayName) ;

/// @brief Method RemovePanel, addr 0x65af390, size 0x80, virtual false, abstract: false, final false
inline void RemovePanel(::UnityEngine::Rendering::DebugUI_Panel*  panel) ;

/// @brief Method RequestEditorWindowPanelIndex, addr 0x65af268, size 0x58, virtual false, abstract: false, final false
inline void RequestEditorWindowPanelIndex(int32_t  index) ;

/// @brief Method Reset, addr 0x65ae724, size 0x44, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SampleAction, addr 0x65acbec, size 0x14c, virtual false, abstract: false, final false
inline void SampleAction(int32_t  actionIndex) ;

/// @brief Method SetScrollTarget, addr 0x65ae8d4, size 0x9c, virtual false, abstract: false, final false
inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget) ;

/// @brief Method ToggleEditorUI, addr 0x65b0c18, size 0x18, virtual false, abstract: false, final false
inline void ToggleEditorUI(bool  open) ;

/// @brief Method TogglePersistent, addr 0x65aeb7c, size 0x54c, virtual false, abstract: false, final false
inline void TogglePersistent(::UnityEngine::Rendering::DebugUI_Widget*  widget, ::System::Nullable_1<int32_t>  forceTupleIndex) ;

/// @brief Method UnregisterData, addr 0x65a5944, size 0xb8, virtual false, abstract: false, final false
inline void UnregisterData(::UnityEngine::Rendering::IDebugData*  data) ;

/// @brief Method UpdateAction, addr 0x65acdb4, size 0x64, virtual false, abstract: false, final false
inline void UpdateAction(int32_t  actionIndex) ;

/// @brief Method UpdateActions, addr 0x65acfec, size 0x58, virtual false, abstract: false, final false
inline void UpdateActions() ;

/// @brief Method UpdateReadOnlyCollection, addr 0x65adea0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65ae4d0, size 0x250, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onDisplayRuntimeUIChanged, addr 0x65adf60, size 0xc0, virtual false, abstract: false, final false
inline void add_onDisplayRuntimeUIChanged(::System::Action_1<bool>*  value) ;

/// @brief Method add_onSetDirty, addr 0x65ae0e0, size 0xac, virtual false, abstract: false, final false
inline void add_onSetDirty(::System::Action*  value) ;

/// @brief Method add_resetData, addr 0x65ae238, size 0xac, virtual false, abstract: false, final false
inline void add_resetData(::System::Action*  value) ;

/// @brief Method add_windowStateChanged, addr 0x65b0510, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method get_displayEditorUI, addr 0x65b0720, size 0x18, virtual false, abstract: false, final false
inline bool get_displayEditorUI() ;

/// @brief Method get_displayPersistentRuntimeUI, addr 0x65ae444, size 0x8c, virtual false, abstract: false, final false
inline bool get_displayPersistentRuntimeUI() ;

/// @brief Method get_displayRuntimeUI, addr 0x65ae3b8, size 0x8c, virtual false, abstract: false, final false
inline bool get_displayRuntimeUI() ;

/// @brief Method get_enableRuntimeUI, addr 0x65b07f4, size 0x8, virtual false, abstract: false, final false
inline bool get_enableRuntimeUI() ;

/// @brief Method get_instance, addr 0x65a55ec, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::DebugManager* get_instance() ;

/// @brief Method get_isAnyDebugUIActive, addr 0x65ae390, size 0x28, virtual false, abstract: false, final false
inline bool get_isAnyDebugUIActive() ;

/// @brief Method get_panels, addr 0x65adf3c, size 0x24, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Rendering::DebugUI_Panel*>* get_panels() ;

/// @brief Method remove_onDisplayRuntimeUIChanged, addr 0x65ae020, size 0xc0, virtual false, abstract: false, final false
inline void remove_onDisplayRuntimeUIChanged(::System::Action_1<bool>*  value) ;

/// @brief Method remove_onSetDirty, addr 0x65ae18c, size 0xac, virtual false, abstract: false, final false
inline void remove_onSetDirty(::System::Action*  value) ;

/// @brief Method remove_resetData, addr 0x65ae2e4, size 0xac, virtual false, abstract: false, final false
inline void remove_resetData(::System::Action*  value) ;

/// @brief Method remove_windowStateChanged, addr 0x65b0618, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method set_displayEditorUI, addr 0x65b0738, size 0x18, virtual false, abstract: false, final false
inline void set_displayEditorUI(bool  value) ;

/// @brief Method set_displayPersistentRuntimeUI, addr 0x65b0b8c, size 0x8c, virtual false, abstract: false, final false
inline void set_displayPersistentRuntimeUI(bool  value) ;

/// @brief Method set_displayRuntimeUI, addr 0x65b082c, size 0x2a0, virtual false, abstract: false, final false
inline void set_displayRuntimeUI(bool  value) ;

/// @brief Method set_enableRuntimeUI, addr 0x65b07fc, size 0x24, virtual false, abstract: false, final false
