...
// Ctor Parameters [CppParam { name: "instanceIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "batchIDs", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: None }, CppParam { name: "hashMap", ty: "::Unity::Collections::NativeParallelHashMap_2_ParallelWriter<int32_t,T>", modifiers: "", def_value: None }]
constexpr RegisterNewInstancesJob_1(::Unity::Collections::NativeArray_1<int32_t>  instanceIDs, ::Unity::Collections::NativeArray_1<T>  batchIDs, ::Unity::Collections::NativeParallelHashMap_2_ParallelWriter<int32_t,T>  hashMap) noexcept;
