...
/// @brief Method BuildBox, addr 0x65b180c, size 0x7b4, virtual false, abstract: false, final false
inline void BuildBox(::ByRef<::UnityEngine::Mesh*>  outputMesh, float_t  length, float_t  width, float_t  height) ;

/// @brief Method BuildCone, addr 0x65b1fc0, size 0x928, virtual false, abstract: false, final false
...
/// @brief Method BuildCustomSphereMesh, addr 0x65b2de8, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> BuildCustomSphereMesh(float_t  radius, uint32_t  longSubdiv, uint32_t  latSubdiv) ;

/// @brief Method BuildPyramid, addr 0x65b28e8, size 0x300, virtual false, abstract: false, final false
inline void BuildPyramid(::ByRef<::UnityEngine::Mesh*>  outputMesh, float_t  width, float_t  height, float_t  depth) ;

/// @brief Method BuildShapes, addr 0x65b2be8, size 0xf4, virtual false, abstract: false, final false
inline void BuildShapes() ;

/// @brief Method BuildSphere, addr 0x65b10ec, size 0x720, virtual false, abstract: false, final false
...
/// @brief Method RebuildResources, addr 0x65b2cdc, size 0xf4, virtual false, abstract: false, final false
inline void RebuildResources() ;

/// @brief Method RequestBoxMesh, addr 0x65b2e7c, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestBoxMesh() ;

/// @brief Method RequestConeMesh, addr 0x65b2e94, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestConeMesh() ;

/// @brief Method RequestPyramidMesh, addr 0x65b2eac, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> RequestPyramidMesh() ;

/// @brief Method RequestSphereMesh, addr 0x65b2dd0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65b10e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::DebugShapes* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x65b1078, size 0x70, virtual false, abstract: false, final false
