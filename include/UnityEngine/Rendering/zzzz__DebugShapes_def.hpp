...
public:
  ...
  /// @brief Method BuildBox, addr 0x67682b4, size 0x7b4, virtual false, abstract: false, final false
  inline void BuildBox(::by_ref<::UnityEngine::Mesh*> outputMesh, float_t length, float_t width, float_t height);

  /// @brief Method BuildCone, addr 0x6768a68, size 0x928, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildCustomSphereMesh, addr 0x6769890, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> BuildCustomSphereMesh(float_t radius, uint32_t longSubdiv, uint32_t latSubdiv);

  /// @brief Method BuildPyramid, addr 0x6769390, size 0x300, virtual false, abstract: false, final false
  inline void BuildPyramid(::by_ref<::UnityEngine::Mesh*> outputMesh, float_t width, float_t height, float_t depth);

  /// @brief Method BuildShapes, addr 0x6769690, size 0xf4, virtual false, abstract: false, final false
  inline void BuildShapes();

  /// @brief Method BuildSphere, addr 0x6767b94, size 0x720, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildResources, addr 0x6769784, size 0xf4, virtual false, abstract: false, final false
  inline void RebuildResources();

  /// @brief Method RequestBoxMesh, addr 0x6769924, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> RequestBoxMesh();

  /// @brief Method RequestConeMesh, addr 0x676993c, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> RequestConeMesh();

  /// @brief Method RequestPyramidMesh, addr 0x6769954, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> RequestPyramidMesh();

  /// @brief Method RequestSphereMesh, addr 0x6769878, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6767b90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::DebugShapes* getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x6767b20, size 0x70, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugShapes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugShapes(DebugShapes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugShapes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugShapes(DebugShapesconst&) = delete;
