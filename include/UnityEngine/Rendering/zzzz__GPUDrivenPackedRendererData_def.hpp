...
/// @brief Method .ctor, addr 0x6962094, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasTree, addr 0x696207c, size 0xc, virtual false, abstract: false, final false
inline bool get_hasTree() ;

/// @brief Method get_isPartOfStaticBatch, addr 0x6962070, size 0xc, virtual false, abstract: false, final false
inline bool get_isPartOfStaticBatch() ;

/// @brief Method get_lightProbeUsage, addr 0x6962058, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::LightProbeUsage get_lightProbeUsage() ;

/// @brief Method get_lodMask, addr 0x6962040, size 0xc, virtual false, abstract: false, final false
inline uint8_t get_lodMask() ;

/// @brief Method get_motionVecGenMode, addr 0x6962064, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::MotionVectorGenerationMode get_motionVecGenMode() ;

/// @brief Method get_shadowCastingMode, addr 0x696204c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ShadowCastingMode get_shadowCastingMode() ;

/// @brief Method get_smallMeshCulling, addr 0x6962088, size 0xc, virtual false, abstract: false, final false
inline bool get_smallMeshCulling() ;

/// @brief Method get_staticShadowCaster, addr 0x6962034, size 0xc, virtual false, abstract: false, final false
