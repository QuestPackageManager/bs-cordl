...
public:
  ...
  /// @brief Method CompareTo, addr 0x6798ae0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6798a64, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6798698, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AllocateScratchBuffer>b__26_0, addr 0x6798b5c, size 0x64, virtual false, abstract: false, final false
  inline bool _AllocateScratchBuffer_b__26_0(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool* o);

  /// @brief Method <ReleaseScratchBuffer>b__27_0, addr 0x6798bc0, size 0x64, virtual false, abstract: false, final false
  inline bool _ReleaseScratchBuffer_b__27_0(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool* o);

  /// @brief Method .ctor, addr 0x6798b58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllocateScratchBuffer, addr 0x67982f0, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x67988b4, size 0x1b0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateScratchBuffer, addr 0x679826c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrCreateScratchBufferLayout, addr 0x6797ff8, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseScratchBuffer, addr 0x6798724, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6797e90, size 0x168, virtual false, abstract: false, final false
