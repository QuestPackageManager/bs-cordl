...
public:
  ...
  /// @brief Method CompareTo, addr 0x6654044, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6653fc8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6653bfc, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AllocateScratchBuffer>b__26_0, addr 0x66540c0, size 0x64, virtual false, abstract: false, final false
  inline bool _AllocateScratchBuffer_b__26_0(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool* o);

  /// @brief Method <ReleaseScratchBuffer>b__27_0, addr 0x6654124, size 0x64, virtual false, abstract: false, final false
  inline bool _ReleaseScratchBuffer_b__27_0(::UnityEngine::Rendering::ProbeVolumeScratchBufferPool_ScratchBufferPool* o);

  /// @brief Method .ctor, addr 0x66540bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AllocateScratchBuffer, addr 0x6653854, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Cleanup, addr 0x6653e18, size 0x1b0, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateScratchBuffer, addr 0x66537d0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrCreateScratchBufferLayout, addr 0x665355c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseScratchBuffer, addr 0x6653c88, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66533f4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allocatedMemory, addr 0x66533e4, size 0x10, virtual false, abstract: false, final false
  inline int32_t get_allocatedMemory();

  /// @brief Method get_chunkSize, addr 0x66533c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_chunkSize();

  /// @brief Method get_maxChunkCount, addr 0x66533d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxChunkCount();

  static inline void setStaticF_s_ChunkCount(int32_t value);

  /// @brief Method set_chunkSize, addr 0x66533cc, size 0x8, virtual false, abstract: false, final false
  inline void set_chunkSize(int32_t value);

  /// @brief Method set_maxChunkCount, addr 0x66533dc, size 0x8, virtual false, abstract: false, final false
