...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::DrawKey::*)(::UnityEngine::Rendering::DrawKey)>(&::UnityEngine::Rendering::DrawKey::Equals)> {
  constexpr static std::size_t size = 0x158;
  constexpr static std::size_t addrs = 0x6660040;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DrawKey>::get(),
                        "Equals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Rendering::DrawKey>::get()}
                    )));
...
// Ctor Parameters [CppParam { name: "meshID", ty: "::UnityEngine::Rendering::BatchMeshID", modifiers: "", def_value: Some("{}") }, CppParam { name: "submeshIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "materialID", ty: "::UnityEngine::Rendering::BatchMaterialID", modifiers: "", def_value: Some("{}") }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::BatchDrawCommandFlags", modifiers: "", def_value: Some("{}") }, CppParam { name: "transparentInstanceId", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "overridenComponents", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "range", ty: "::UnityEngine::Rendering::RangeKey", modifiers: "", def_value: Some("{}") }, CppParam { name: "lightmapIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::DrawKey::DrawKey(::UnityEngine::Rendering::BatchMeshID  meshID, int32_t  submeshIndex, ::UnityEngine::Rendering::BatchMaterialID  materialID, ::UnityEngine::Rendering::BatchDrawCommandFlags  flags, int32_t  transparentInstanceId, uint32_t  overridenComponents, ::UnityEngine::Rendering::RangeKey  range, int32_t  lightmapIndex) noexcept  {
this->meshID = meshID;
