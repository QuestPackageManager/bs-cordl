...
public:
  ...
  /// @brief Method CreateGlobalKeyword, addr 0x69d52bc, size 0x124, virtual false, abstract: false, final false
  static inline void CreateGlobalKeyword(::StringW keyword);

  /// @brief Method CreateGlobalKeyword_Injected, addr 0x69d53e0, size 0x3c, virtual false, abstract: false, final false
  static inline void CreateGlobalKeyword_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> keyword);

  /// @brief Method GetGlobalKeywordCount, addr 0x69d512c, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t GetGlobalKeywordCount();

  /// @brief Method GetGlobalKeywordIndex, addr 0x69d5154, size 0x12c, virtual false, abstract: false, final false
  static inline uint32_t GetGlobalKeywordIndex(::StringW keyword);

  /// @brief Method GetGlobalKeywordIndex_Injected, addr 0x69d5280, size 0x3c, virtual false, abstract: false, final false
  static inline uint32_t GetGlobalKeywordIndex_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> keyword);

  /// @brief Method ToString, addr 0x69d54a8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x69d5424, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW keywordName);

  /// @brief Method get_name, addr 0x69d541c, size 0x8, virtual false, abstract: false, final false
