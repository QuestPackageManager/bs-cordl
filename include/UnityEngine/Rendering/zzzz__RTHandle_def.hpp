...
/// @brief Method ClearCustomHandleProperties, addr 0x65f45ac, size 0x8, virtual false, abstract: false, final false
inline void ClearCustomHandleProperties() ;

/// @brief Method CopyToFastMemory, addr 0x65f4ea4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetInstanceID, addr 0x65f47bc, size 0xcc, virtual false, abstract: false, final false
inline int32_t GetInstanceID() ;

/// @brief Method GetScaledSize, addr 0x65f4c1c, size 0x200, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int GetScaledSize() ;

/// @brief Method GetScaledSize, addr 0x65f4a1c, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x65f4888, size 0xa4, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method SetCustomHandleProperties, addr 0x65f458c, size 0x20, virtual false, abstract: false, final false
inline void SetCustomHandleProperties(::ByRef<::UnityEngine::Rendering::RTHandleProperties>  properties) ;

/// @brief Method SetRenderTexture, addr 0x65f4728, size 0x4c, virtual false, abstract: false, final false
inline void SetRenderTexture(::UnityEngine::RenderTexture*  rt, bool  transferOwnership) ;

/// @brief Method SetTexture, addr 0x65f4540, size 0x1c, virtual false, abstract: false, final false
inline void SetTexture(::UnityEngine::Rendering::RenderTargetIdentifier  tex) ;

/// @brief Method SetTexture, addr 0x65f4774, size 0x48, virtual false, abstract: false, final false
inline void SetTexture(::UnityEngine::Texture*  tex) ;

/// @brief Method SwitchOutFastMemory, addr 0x65f4eac, size 0x5c, virtual false, abstract: false, final false
inline void SwitchOutFastMemory(::UnityEngine::Rendering::CommandBuffer*  cmd, bool  copyContents) ;

/// @brief Method SwitchToFastMemory, addr 0x65f4e1c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65f4658, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::RTHandleSystem*  owner) ;

/// @brief Method get_externalTexture, addr 0x65f4628, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_externalTexture() ;

/// @brief Method get_isMSAAEnabled, addr 0x65f4650, size 0x8, virtual false, abstract: false, final false
inline bool get_isMSAAEnabled() ;

/// @brief Method get_name, addr 0x65f4648, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_nameID, addr 0x65f4630, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderTargetIdentifier get_nameID() ;

/// @brief Method get_referenceSize, addr 0x65f45d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int get_referenceSize() ;

/// @brief Method get_rt, addr 0x65f4620, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_rt() ;

/// @brief Method get_rtHandleProperties, addr 0x65f45e4, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RTHandleProperties get_rtHandleProperties() ;

/// @brief Method get_scaleFactor, addr 0x65f45b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_scaleFactor() ;

/// @brief Method get_useScaling, addr 0x65f45c4, size 0x8, virtual false, abstract: false, final false
inline bool get_useScaling() ;

/// @brief Method op_Implicit, addr 0x65f4668, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x65f471c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x65f4694, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method set_referenceSize, addr 0x65f45dc, size 0x8, virtual false, abstract: false, final false
inline void set_referenceSize(::UnityEngine::Vector2Int  value) ;

/// @brief Method set_scaleFactor, addr 0x65f45bc, size 0x8, virtual false, abstract: false, final false
inline void set_scaleFactor(::UnityEngine::Vector2  value) ;

/// @brief Method set_useScaling, addr 0x65f45cc, size 0x8, virtual false, abstract: false, final false
