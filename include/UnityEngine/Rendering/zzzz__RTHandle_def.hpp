...
public:
  ...
  /// @brief Method ClearCustomHandleProperties, addr 0x67ab054, size 0x8, virtual false, abstract: false, final false
  inline void ClearCustomHandleProperties();

  /// @brief Method CopyToFastMemory, addr 0x67ab94c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstanceID, addr 0x67ab264, size 0xcc, virtual false, abstract: false, final false
  inline int32_t GetInstanceID();

  /// @brief Method GetScaledSize, addr 0x67ab6c4, size 0x200, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2Int GetScaledSize();

  /// @brief Method GetScaledSize, addr 0x67ab4c4, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x67ab330, size 0xa4, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method SetTexture, addr 0x67aafe8, size 0x1c, virtual false, abstract: false, final false
  inline void SetTexture(::UnityEngine::Rendering::RenderTargetIdentifier tex);

  /// @brief Method SetTexture, addr 0x67ab21c, size 0x48, virtual false, abstract: false, final false
  inline void SetTexture(::UnityEngine::Texture* tex);

  /// @brief Method SwitchOutFastMemory, addr 0x67ab954, size 0x5c, virtual false, abstract: false, final false
  inline void SwitchOutFastMemory(::UnityEngine::Rendering::CommandBuffer* cmd, bool copyContents);

  /// @brief Method SwitchToFastMemory, addr 0x67ab8c4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67ab100, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::RTHandleSystem* owner);

  /// @brief Method get_externalTexture, addr 0x67ab0d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_externalTexture();

  /// @brief Method get_isMSAAEnabled, addr 0x67ab0f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isMSAAEnabled();

  /// @brief Method get_name, addr 0x67ab0f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_rt, addr 0x67ab0c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67ab110, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x67ab1c4, size 0xc, virtual false, abstract: false, final false
