...
public:
  ...
  /// @brief Method GetInstanceNum, addr 0x66e96c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetInstanceNum(::UnityEngine::Rendering::InstanceType type);

  /// @brief Method GetInstanceNumIncludingChildren, addr 0x66e96d0, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetInstanceNumIncludingChildren(::UnityEngine::Rendering::InstanceType type);

  /// @brief Method GetTotalInstanceNum, addr 0x66e9810, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetTotalInstanceNum();

  /// @brief Method InitDefault, addr 0x66e96ac, size 0x8, virtual false, abstract: false, final false
  inline void InitDefault();

  /// @brief Method .ctor, addr 0x66e96c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t meshRendererNum, int32_t speedTreeNum);

  /// @brief Method .ctor, addr 0x66e96b4, size 0xc, virtual false, abstract: false, final false
