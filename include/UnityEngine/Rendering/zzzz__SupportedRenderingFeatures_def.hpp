...
public:
  ...
  /// @brief Method FallbackLightmapperByRef, addr 0x69d0d1c, size 0xc, virtual false, abstract: false, final false
  static inline void FallbackLightmapperByRef(::System::IntPtr lightmapperPtr);

  /// @brief Method FallbackMixedLightingModeByRef, addr 0x69d0708, size 0x124, virtual false, abstract: false, final false
  static inline void FallbackMixedLightingModeByRef(::System::IntPtr fallbackModePtr);

  /// @brief Method IsAmbientProbeBakingSupported, addr 0x69d0be4, size 0x68, virtual false, abstract: false, final false
  static inline void IsAmbientProbeBakingSupported(::System::IntPtr isSupportedPtr);

  /// @brief Method IsDefaultReflectionProbeBakingSupported, addr 0x69d0c4c, size 0x68, virtual false, abstract: false, final false
  static inline void IsDefaultReflectionProbeBakingSupported(::System::IntPtr isSupportedPtr);

  /// @brief Method IsLightmapBakeTypeSupported, addr 0x69d0994, size 0x70, virtual false, abstract: false, final false
  static inline bool IsLightmapBakeTypeSupported(::UnityEngine::LightmapBakeType bakeType);

  /// @brief Method IsLightmapBakeTypeSupportedByRef, addr 0x69d0a04, size 0xec, virtual false, abstract: false, final false
  static inline void IsLightmapBakeTypeSupportedByRef(::UnityEngine::LightmapBakeType bakeType, ::System::IntPtr isSupportedPtr);

  /// @brief Method IsLightmapperSupportedByRef, addr 0x69d0b6c, size 0x10, virtual false, abstract: false, final false
  static inline void IsLightmapperSupportedByRef(int32_t lightmapper, ::System::IntPtr isSupportedPtr);

  /// @brief Method IsLightmapsModeSupportedByRef, addr 0x69d0af0, size 0x7c, virtual false, abstract: false, final false
  static inline void IsLightmapsModeSupportedByRef(::UnityEngine::LightmapsMode mode, ::System::IntPtr isSupportedPtr);

  /// @brief Method IsMixedLightingModeSupported, addr 0x69d082c, size 0x70, virtual false, abstract: false, final false
  static inline bool IsMixedLightingModeSupported(::UnityEngine::MixedLightingMode mixedMode);

  /// @brief Method IsMixedLightingModeSupportedByRef, addr 0x69d089c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsUIOverlayRenderedBySRP, addr 0x69d0b7c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method OverridesLightProbeSystem, addr 0x69d0cb4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69d060c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* getStaticF_s_Active();

  /// @brief Method get_active, addr 0x69d0568, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::SupportedRenderingFeatures* get_active();

  /// @brief Method get_ambientProbeBaking, addr 0x69d06e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ambientProbeBaking();

  /// @brief Method get_defaultMixedLightingModes, addr 0x69d06a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes get_defaultMixedLightingModes();

  /// @brief Method get_defaultReflectionProbeBaking, addr 0x69d06e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_defaultReflectionProbeBaking();

  /// @brief Method get_enlighten, addr 0x69d06c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_enlighten();

  /// @brief Method get_lightmapBakeTypes, addr 0x69d06b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LightmapBakeType get_lightmapBakeTypes();

  /// @brief Method get_lightmapsModes, addr 0x69d06b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LightmapsMode get_lightmapsModes();

  /// @brief Method get_mixedLightingModes, addr 0x69d06a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::SupportedRenderingFeatures_LightmapMixedBakeModes get_mixedLightingModes();

  /// @brief Method get_overridesLightProbeSystem, addr 0x69d06f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_overridesLightProbeSystem();

  /// @brief Method get_rendersUIOverlay, addr 0x69d06d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_active, addr 0x69cb308, size 0x60, virtual false, abstract: false, final false
  static inline void set_active(::UnityEngine::Rendering::SupportedRenderingFeatures* value);

  /// @brief Method set_overridesLightProbeSystem, addr 0x69d06f8, size 0x8, virtual false, abstract: false, final false
  inline void set_overridesLightProbeSystem(bool value);

  /// @brief Method set_rendersUIOverlay, addr 0x69d06d8, size 0x8, virtual false, abstract: false, final false
  inline void set_rendersUIOverlay(bool value);

  /// @brief Method set_skyOcclusion, addr 0x69d06c8, size 0x8, virtual false, abstract: false, final false
  inline void set_skyOcclusion(bool value);

  /// @brief Method set_supportsHDR, addr 0x69d0700, size 0x8, virtual false, abstract: false, final false
