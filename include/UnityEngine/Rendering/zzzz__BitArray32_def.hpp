...
public:
  ...
  /// @brief Method BitAnd, addr 0x67b1350, size 0x98, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitAnd(::UnityEngine::Rendering::IBitArray* other);

  /// @brief Method BitNot, addr 0x67b1490, size 0x64, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitNot();

  /// @brief Method BitOr, addr 0x67b13f0, size 0x98, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::IBitArray* BitOr(::UnityEngine::Rendering::IBitArray* other);

  /// @brief Method Equals, addr 0x67b1514, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x67b1590, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x67b1290, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<uint32_t>* bitIndexTrue);

  /// @brief Method .ctor, addr 0x67b1288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t initValue);

  /// @brief Method get_Item, addr 0x67b1224, size 0x10, virtual true, abstract: false, final true
  inline bool get_Item(uint32_t index);

  /// @brief Method get_allFalse, addr 0x67b0fdc, size 0x10, virtual true, abstract: false, final true
  inline bool get_allFalse();

  /// @brief Method get_allTrue, addr 0x67b0fec, size 0x10, virtual true, abstract: false, final true
  inline bool get_allTrue();

  /// @brief Method get_capacity, addr 0x67b0fd4, size 0x8, virtual true, abstract: false, final true
  inline uint32_t get_capacity();

  /// @brief Method get_humanizedData, addr 0x67b106c, size 0x1b8, virtual true, abstract: false, final true
  inline ::StringW get_humanizedData();

  /// @brief Method get_humanizedVersion, addr 0x67b0ffc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x67b13e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x67b1488, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x67b14fc, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Rendering::BitArray32 a, ::UnityEngine::Rendering::BitArray32 b);

  /// @brief Method op_Inequality, addr 0x67b1508, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::Rendering::BitArray32 a, ::UnityEngine::Rendering::BitArray32 b);

  /// @brief Method op_OnesComplement, addr 0x67b14f4, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::BitArray32 op_OnesComplement(::UnityEngine::Rendering::BitArray32 a);

  /// @brief Method set_Item, addr 0x67b1240, size 0x24, virtual true, abstract: false, final true
