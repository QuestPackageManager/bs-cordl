...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDebugDisplaySettingsPanelDisposable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDebugDisplaySettingsPanelDisposable(IDebugDisplaySettingsPanelDisposableconst&) = delete;
