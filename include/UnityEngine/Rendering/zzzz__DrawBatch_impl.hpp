...
// Ctor Parameters [CppParam { name: "key", ty: "::UnityEngine::Rendering::DrawKey", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "instanceCount", ty: "int32_t", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "instanceOffset", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "procInfo", ty:
// "::UnityEngine::Rendering::MeshProceduralInfo", modifiers: "", def_value: Some("{}"), comment: None }]
