...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ICameraHistoryReadAccess*);
MARK_REF_T(::UnityEngine::Rendering::ICameraHistoryReadAccess_HistoryRequestDelegate*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ICameraHistoryReadAccess*, "UnityEngine.Rendering", "ICameraHistoryReadAccess");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ICameraHistoryReadAccess_HistoryRequestDelegate*, "UnityEngine.Rendering", "ICameraHistoryReadAccess/HistoryRequestDelegate");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x67473e4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6747404, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x67473d0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x674728c, size 0x144, virtual false, abstract: false, final false
