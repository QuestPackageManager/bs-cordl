...
public:
  ...
  /// @brief Method IndexToSharedInstance, addr 0x66e2b68, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::SharedInstanceHandle IndexToSharedInstance(int32_t index);

  /// @brief Method InstanceToIndex, addr 0x66e2e50, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidIndex, addr 0x66e2d4c, size 0x104, virtual false, abstract: false, final false
  inline bool IsValidIndex(int32_t index);

  /// @brief Method IsValidSharedInstance, addr 0x66e2bd8, size 0x174, virtual false, abstract: false, final false
  inline bool IsValidSharedInstance(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method SharedInstanceToIndex, addr 0x66e2acc, size 0x9c, virtual false, abstract: false, final false
  inline int32_t SharedInstanceToIndex(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method .ctor, addr 0x66e25ec, size 0x458, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::Rendering::CPUSharedInstanceData> instanceData);

  /// @brief Method get_handlesLength, addr 0x66e2a44, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_handlesLength();

  /// @brief Method get_instancesLength, addr 0x66e2a88, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x66e1e40, size 0xbc, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method AddNoGrow, addr 0x66e1d34, size 0x94, virtual false, abstract: false, final false
  inline void AddNoGrow(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method AddUnsafe, addr 0x66e16c4, size 0x1f0, virtual false, abstract: false, final false
  inline void AddUnsafe(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method AsReadOnly, addr 0x66e25b8, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly AsReadOnly();

  /// @brief Method Dispose, addr 0x66e1130, size 0x2d4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method EnsureFreeInstances, addr 0x66e1d0c, size 0x28, virtual false, abstract: false, final false
  inline void EnsureFreeInstances(int32_t instancesCount);

  /// @brief Method GetFreeInstancesCount, addr 0x66e1cfc, size 0x10, virtual false, abstract: false, final false
  inline int32_t GetFreeInstancesCount();

  /// @brief Method Get_Flags, addr 0x66e21bc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CPUSharedInstanceFlags Get_Flags(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_GameObjectLayer, addr 0x66e21fc, size 0x20, virtual false, abstract: false, final false
  inline int32_t Get_GameObjectLayer(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_LODGroupAndMask, addr 0x66e21dc, size 0x20, virtual false, abstract: false, final false
  inline uint32_t Get_LODGroupAndMask(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_LocalAABB, addr 0x66e2140, size 0x7c, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::AABB> Get_LocalAABB(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_MaterialIDs, addr 0x66e223c, size 0x78, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::SmallIntegerArray> Get_MaterialIDs(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_MeshID, addr 0x66e2120, size 0x20, virtual false, abstract: false, final false
  inline int32_t Get_MeshID(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_RefCount, addr 0x66e221c, size 0x20, virtual false, abstract: false, final false
  inline int32_t Get_RefCount(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Get_RendererGroupID, addr 0x66e2100, size 0x20, virtual false, abstract: false, final false
  inline int32_t Get_RendererGroupID(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Grow, addr 0x66e1460, size 0x264, virtual false, abstract: false, final false
  inline void Grow(int32_t newCapacity);

  /// @brief Method IndexToSharedInstance, addr 0x66e1954, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::SharedInstanceHandle IndexToSharedInstance(int32_t index);

  /// @brief Method Initialize, addr 0x66e0e00, size 0x330, virtual false, abstract: false, final false
  inline void Initialize(int32_t initCapacity);

  /// @brief Method InstanceToIndex, addr 0x66e1960, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFreeInstanceHandle, addr 0x66e1b0c, size 0x128, virtual false, abstract: false, final false
  inline bool IsFreeInstanceHandle(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method IsValidIndex, addr 0x66e1c34, size 0xc8, virtual false, abstract: false, final false
  inline bool IsValidIndex(int32_t index);

  /// @brief Method IsValidInstance, addr 0x66e19b4, size 0x158, virtual false, abstract: false, final false
  inline bool IsValidInstance(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Remove, addr 0x66e1efc, size 0x204, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Set, addr 0x66e2490, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefault, addr 0x66e1dc8, size 0x78, virtual false, abstract: false, final false
  inline void SetDefault(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method Set_Flags, addr 0x66e2350, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Set_GameObjectLayer, addr 0x66e23a8, size 0x2c, virtual false, abstract: false, final false
  inline void Set_GameObjectLayer(::UnityEngine::Rendering::SharedInstanceHandle instance, int32_t gameObjectLayer);

  /// @brief Method Set_LODGroupAndMask, addr 0x66e237c, size 0x2c, virtual false, abstract: false, final false
  inline void Set_LODGroupAndMask(::UnityEngine::Rendering::SharedInstanceHandle instance, uint32_t lodGroupAndMask);

  /// @brief Method Set_LocalAABB, addr 0x66e230c, size 0x44, virtual false, abstract: false, final false
  inline void Set_LocalAABB(::UnityEngine::Rendering::SharedInstanceHandle instance, ::ByRef<::UnityEngine::Rendering::AABB> localAABB);

  /// @brief Method Set_MaterialIDs, addr 0x66e2400, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Set_MeshID, addr 0x66e22e0, size 0x2c, virtual false, abstract: false, final false
  inline void Set_MeshID(::UnityEngine::Rendering::SharedInstanceHandle instance, int32_t meshID);

  /// @brief Method Set_RefCount, addr 0x66e23d4, size 0x2c, virtual false, abstract: false, final false
  inline void Set_RefCount(::UnityEngine::Rendering::SharedInstanceHandle instance, int32_t refCount);

  /// @brief Method Set_RendererGroupID, addr 0x66e22b4, size 0x2c, virtual false, abstract: false, final false
  inline void Set_RendererGroupID(::UnityEngine::Rendering::SharedInstanceHandle instance, int32_t rendererGroupID);

  /// @brief Method SharedInstanceToIndex, addr 0x66e18b4, size 0xa0, virtual false, abstract: false, final false
  inline int32_t SharedInstanceToIndex(::UnityEngine::Rendering::SharedInstanceHandle instance);

  /// @brief Method get_handlesLength, addr 0x66e0d9c, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_handlesLength();

  /// @brief Method get_instancesCapacity, addr 0x66e0d84, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_instancesCapacity();

  /// @brief Method get_instancesLength, addr 0x66e0d6c, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_instancesLength();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable();

  /// @brief Method set_instancesCapacity, addr 0x66e0d90, size 0xc, virtual false, abstract: false, final false
  inline void set_instancesCapacity(int32_t value);

  /// @brief Method set_instancesLength, addr 0x66e0d78, size 0xc, virtual false, abstract: false, final false
