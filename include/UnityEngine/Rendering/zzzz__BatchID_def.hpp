...
public:
  ...
  /// @brief Method Equals, addr 0x48ca828, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x48ca8d0, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::BatchID other);

  /// @brief Method GetHashCode, addr 0x48ca820, size 0x8, virtual true, abstract: false, final false
