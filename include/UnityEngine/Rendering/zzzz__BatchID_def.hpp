...
public:
  ...
  /// @brief Method Equals, addr 0x6b26ebc, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b26f6c, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::BatchID other);

  /// @brief Method GetHashCode, addr 0x6b26eb4, size 0x8, virtual true, abstract: false, final false
