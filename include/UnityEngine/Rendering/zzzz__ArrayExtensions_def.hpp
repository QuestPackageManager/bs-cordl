...
template<typename T>
static inline void FillArray(::ByRef<::Unity::Collections::NativeArray_1<T>>  array, ::ByRef<T>  value, int32_t  startIndex, int32_t  length) ;

/// @brief Method ResizeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void ResizeArray(::ByRef<::ArrayW<T,::Array<T>*>>  array, int32_t  capacity) ;

/// @brief Method ResizeArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void ResizeArray(::ByRef<::Unity::Collections::NativeArray_1<T>>  array, int32_t  capacity) ;

/// @brief Method ResizeArray, addr 0x6672084, size 0xb4, virtual false, abstract: false, final false
