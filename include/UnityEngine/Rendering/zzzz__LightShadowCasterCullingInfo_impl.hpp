...
// Ctor Parameters [CppParam { name: "splitRange", ty: "::UnityEngine::RangeInt", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "projectionType", ty:
// "::UnityEngine::Rendering::BatchCullingProjectionType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "splitExclusionMask", ty: "uint16_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
