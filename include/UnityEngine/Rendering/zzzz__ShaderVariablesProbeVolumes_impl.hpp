...
// Ctor Parameters [CppParam { name: "_Offset_LayerCount", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "_MinLoadedCellInEntries_IndirectionEntryDim", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "_MaxLoadedCellInEntries_RcpIndirectionEntryDim", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_PoolDim_MinBrickSize", ty:
// "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_RcpPoolDim_XY", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None
// }, CppParam { name: "_MinEntryPos_Noise", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_EntryCount_X_XY_LeakReduction", ty:
// "::Unity::Mathematics::uint4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_Biases_NormalizationClamp", ty: "::UnityEngine::Vector4", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "_FrameIndex_Weights", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_ProbeVolumeLayerMask",
// ty: "::Unity::Mathematics::uint4", modifiers: "", def_value: Some("{}"), comment: None }]
