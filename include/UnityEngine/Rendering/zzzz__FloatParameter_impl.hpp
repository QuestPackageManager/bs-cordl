...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::FloatParameter::*)(float_t, bool)>(&::UnityEngine::Rendering::FloatParameter::_ctor)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x6616160;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::FloatParameter*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::FloatParameter::*)(float_t, float_t, float_t)>(&::UnityEngine::Rendering::FloatParameter::Interp)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x66161cc;
