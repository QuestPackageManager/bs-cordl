...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HaltonSequence", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HaltonSequence(HaltonSequence&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HaltonSequence", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HaltonSequence(HaltonSequenceconst&) = delete;
