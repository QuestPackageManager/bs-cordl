...
public:
  ...
  /// @brief Method .ctor, addr 0x67ccb8c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t min, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67ccb68, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x67ccb70, size 0x1c, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInterpClampedIntParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInterpClampedIntParameter(NoInterpClampedIntParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInterpClampedIntParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInterpClampedIntParameter(NoInterpClampedIntParameterconst&) = delete;
