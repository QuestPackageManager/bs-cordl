...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingDebugShaderVariables___OccluderMipBounds_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingDebugShaderVariables/<_OccluderMipBounds>e__FixedBuffer");
