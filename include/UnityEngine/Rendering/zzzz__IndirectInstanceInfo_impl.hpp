...
// Ctor Parameters [CppParam { name: "drawOffsetAndSplitMask", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "instanceIndexAndCrossFade", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
