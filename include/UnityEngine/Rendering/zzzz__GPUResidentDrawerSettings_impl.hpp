...
// Ctor Parameters [CppParam { name: "mode", ty: "::UnityEngine::Rendering::GPUResidentDrawerMode", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "supportDitheringCrossFade",
// ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "enableOcclusionCulling", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "allowInEditMode", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "smallMeshScreenPercentage", ty: "float_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "errorShader", ty: "::UnityW<::UnityEngine::Shader>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "loadingShader", ty:
// "::UnityW<::UnityEngine::Shader>", modifiers: "", def_value: Some("{}"), comment: None }]
