...
public:
  ...
  /// @brief Method OverrideLayout, addr 0x668ab40, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activatedFromCommandLine, addr 0x668aadc, size 0x8, virtual false, abstract: false, final false
  static inline bool get_activatedFromCommandLine();

  /// @brief Method get_enabled, addr 0x668aae4, size 0x5c, virtual false, abstract: false, final false
