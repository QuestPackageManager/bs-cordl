...
/// @brief Method Dispose, addr 0x66123a8, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Evaluate, addr 0x66126fc, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Color Evaluate(float_t  time) ;

/// @brief Method GetTexture, addr 0x6612468, size 0x294, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> GetTexture() ;

/// @brief Method GetTextureFormat, addr 0x6612460, size 0x8, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::TextureGradient* New_ctor(::ArrayW<::UnityEngine::GradientColorKey,::Array<::UnityEngine::GradientColorKey>*>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method Rebuild, addr 0x6611fcc, size 0x3dc, virtual false, abstract: false, final false
inline void Rebuild(::ArrayW<::UnityEngine::GradientColorKey,::Array<::UnityEngine::GradientColorKey>*>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method Release, addr 0x66123ac, size 0xa8, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method SetDirty, addr 0x6612454, size 0xc, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetKeys, addr 0x6612734, size 0x88, virtual false, abstract: false, final false
inline void SetKeys(::ArrayW<::UnityEngine::GradientColorKey,::Array<::UnityEngine::GradientColorKey>*>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace) ;
...
/// @brief Method .ctor, addr 0x6611edc, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Gradient*  baseCurve) ;

/// @brief Method .ctor, addr 0x6611fb4, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::GradientColorKey,::Array<::UnityEngine::GradientColorKey>*>  colorKeys, ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*>  alphaKeys, ::UnityEngine::GradientMode  mode, ::UnityEngine::ColorSpace  colorSpace, int32_t  requestedTextureSize, bool  precise) ;

/// @brief Method get_alphaKeys, addr 0x6611ec8, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*> get_alphaKeys() ;

/// @brief Method get_colorKeys, addr 0x6611eb4, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientColorKey,::Array<::UnityEngine::GradientColorKey>*> get_colorKeys() ;

/// @brief Method get_textureSize, addr 0x6611ea4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_textureSize() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_textureSize, addr 0x6611eac, size 0x8, virtual false, abstract: false, final false
