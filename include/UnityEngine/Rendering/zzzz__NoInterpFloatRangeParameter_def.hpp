...
public:
  ...
  /// @brief Method .ctor, addr 0x6688604, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 value, float_t min, float_t max, bool overrideState);

  /// @brief Method get_value, addr 0x66885d0, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector2 get_value();

  /// @brief Method set_value, addr 0x66885d8, size 0x2c, virtual true, abstract: false, final false
