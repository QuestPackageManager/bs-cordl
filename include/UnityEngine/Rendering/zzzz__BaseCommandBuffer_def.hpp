...
/// @brief Method ThrowIfGlobalStateNotAllowed, addr 0x6597a74, size 0x78, virtual false, abstract: false, final false
inline void ThrowIfGlobalStateNotAllowed() ;

/// @brief Method ThrowIfRasterNotAllowed, addr 0x6597aec, size 0x94, virtual false, abstract: false, final false
inline void ThrowIfRasterNotAllowed() ;

/// @brief Method ValidateTextureHandle, addr 0x6597b80, size 0x1e0, virtual false, abstract: false, final false
inline void ValidateTextureHandle(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  h) ;

/// @brief Method ValidateTextureHandleRead, addr 0x6597d60, size 0x18c, virtual false, abstract: false, final false
inline void ValidateTextureHandleRead(::UnityEngine::Rendering::RenderGraphModule::TextureHandle  h) ;

/// @brief Method ValidateTextureHandleWrite, addr 0x6597eec, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6597a1c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_name, addr 0x6597a44, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_sizeInBytes, addr 0x6597a5c, size 0x18, virtual false, abstract: false, final false
