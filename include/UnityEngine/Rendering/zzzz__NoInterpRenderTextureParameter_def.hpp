...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67c86f8, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c8694, size 0x64, virtual false, abstract: false, final false
