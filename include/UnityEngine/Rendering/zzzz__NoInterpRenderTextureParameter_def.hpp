...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67cdf10, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cdeac, size 0x64, virtual false, abstract: false, final false
