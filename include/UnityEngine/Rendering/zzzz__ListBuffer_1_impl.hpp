...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline ::by_ref<T> UnityEngine::Rendering::ListBuffer_1<T>::get_Item(/* [IsReadOnly] */ ::by_ref<int32_t> index) {
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline ::by_ref<T> UnityEngine::Rendering::ListBuffer_1<T>::GetUnchecked(/* [IsReadOnly] */ ::by_ref<int32_t> index) {
  static auto* ___internal_method =
...
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
inline bool UnityEngine::Rendering::ListBuffer_1<T>::TryAdd(/* [IsReadOnly] */ ::by_ref<T> value) {
  static auto* ___internal_method =
...
// Ctor Parameters [CppParam { name: "m_BufferPtr", ty: "T*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Capacity", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "m_CountPtr", ty: "int32_t*", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
  requires(::cordl_internals::value_type_constraint<T> && ::cordl_internals::default_constructor_constraint<T>)
