...
/// @brief Field m_CamerasArray, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CamerasArray, put=__cordl_internal_set_m_CamerasArray)) ::ArrayW<::UnityW<::UnityEngine::Camera>,::Array<::UnityW<::UnityEngine::Camera>>*>  m_CamerasArray;
