...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::UnityEngine::Rendering::ClampedFloatParameter::*)()>(&::UnityEngine::Rendering::ClampedFloatParameter::get_value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x67cce9c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), { ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 14 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::ClampedFloatParameter::*)(float_t)>(&::UnityEngine::Rendering::ClampedFloatParameter::set_value)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x67ccea4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), { ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 15 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::Rendering::ClampedFloatParameter::*)(float_t, float_t, float_t, bool)>(
    &::UnityEngine::Rendering::ClampedFloatParameter::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x67ccec0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(),
...
inline float_t UnityEngine::Rendering::ClampedFloatParameter::get_value() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 14 })));
  return ::cordl_internals::RunMethodRethrow<float_t>(this, ___internal_method);
}
inline void UnityEngine::Rendering::ClampedFloatParameter::set_value(float_t value) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ClampedFloatParameter*>(), 15 })));
...
inline ::UnityEngine::Rendering::ClampedFloatParameter* UnityEngine::Rendering::ClampedFloatParameter::New_ctor(float_t value, float_t min, float_t max, bool overrideState) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Rendering::ClampedFloatParameter*>(value, min, max, overrideState));
}
// Ctor Parameters []
