...
public:
  ...
  /// @brief Method .ctor, addr 0x67c6f10, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool value, ::UnityEngine::Rendering::BoolParameter_DisplayType displayType, bool overrideState);

  /// @brief Method .ctor, addr 0x67c6ea8, size 0x68, virtual false, abstract: false, final false
