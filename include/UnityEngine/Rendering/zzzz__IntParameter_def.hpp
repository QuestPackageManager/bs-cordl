...
public:
// Declarations
/// @brief Method Interp, addr 0x6615e28, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6615dc4, size 0x64, virtual false, abstract: false, final false
