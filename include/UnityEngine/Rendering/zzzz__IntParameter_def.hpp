...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntParameter(IntParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntParameter(IntParameterconst&) = delete;
