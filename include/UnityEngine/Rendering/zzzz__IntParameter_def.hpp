...
public:
  // Declarations
  /// @brief Method Interp, addr 0x67c70b8, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67c7054, size 0x64, virtual false, abstract: false, final false
