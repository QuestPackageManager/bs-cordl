...
public:
  // Declarations
  /// @brief Method Interp, addr 0x65adbdc, size 0x34, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x65adb78, size 0x64, virtual false, abstract: false, final false
