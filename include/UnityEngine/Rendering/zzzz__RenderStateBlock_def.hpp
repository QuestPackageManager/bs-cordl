...
public:
  ...
  /// @brief Method Equals, addr 0x69cbfbc, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69cbe0c, size 0x100, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderStateBlock other);

  /// @brief Method GetHashCode, addr 0x69cc050, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69cbc78, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::RenderStateMask mask);

  /// @brief Method get_depthState, addr 0x69cbdc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DepthState get_depthState();

  /// @brief Method get_mask, addr 0x69cbdfc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RenderStateMask get_mask();

  /// @brief Method get_stencilReference, addr 0x69cbdec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_stencilReference();

  /// @brief Method get_stencilState, addr 0x69cbdd0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_blendState, addr 0x69cbdac, size 0x8, virtual false, abstract: false, final false
  inline void set_blendState(::UnityEngine::Rendering::BlendState value);

  /// @brief Method set_depthState, addr 0x69cbdc8, size 0x8, virtual false, abstract: false, final false
  inline void set_depthState(::UnityEngine::Rendering::DepthState value);

  /// @brief Method set_mask, addr 0x69cbe04, size 0x8, virtual false, abstract: false, final false
  inline void set_mask(::UnityEngine::Rendering::RenderStateMask value);

  /// @brief Method set_rasterState, addr 0x69cbdb4, size 0xc, virtual false, abstract: false, final false
  inline void set_rasterState(::UnityEngine::Rendering::RasterState value);

  /// @brief Method set_stencilReference, addr 0x69cbdf4, size 0x8, virtual false, abstract: false, final false
  inline void set_stencilReference(int32_t value);

  /// @brief Method set_stencilState, addr 0x69cbde0, size 0xc, virtual false, abstract: false, final false
