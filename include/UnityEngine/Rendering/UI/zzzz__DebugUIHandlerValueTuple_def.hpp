...
/// @brief Field valueElements, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_valueElements, put=__cordl_internal_set_valueElements)) ::ArrayW<::UnityW<::UnityEngine::UI::Text>,::Array<::UnityW<::UnityEngine::UI::Text>>*>  valueElements;
...
/// @brief Method OnDeselection, addr 0x6650a34, size 0x2c, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnEnable, addr 0x66509f4, size 0x8, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSelection, addr 0x66509fc, size 0x38, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x6650a60, size 0x368, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method Update, addr 0x6651008, size 0x9c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateValueLabels, addr 0x6650dc8, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66510a4, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
