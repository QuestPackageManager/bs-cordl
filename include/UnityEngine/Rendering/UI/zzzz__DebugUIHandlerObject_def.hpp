...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerObject(DebugUIHandlerObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerObject(DebugUIHandlerObjectconst&) = delete;
