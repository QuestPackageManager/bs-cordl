...
public:
  ...
  /// @brief Method <Toggle>b__0, addr 0x66c0fac, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c0970, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Toggle>b__0, addr 0x66c0fcc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c0cf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Clear, addr 0x66c0d54, size 0x198, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method IsEmpty, addr 0x66c0cfc, size 0x58, virtual false, abstract: false, final false
  inline bool IsEmpty();

  static inline ::UnityEngine::Rendering::UI::DebugUIHandlerPersistentCanvas* New_ctor();

  /// @brief Method Toggle, addr 0x66c0688, size 0x2e8, virtual false, abstract: false, final false
  inline void Toggle(::UnityEngine::Rendering::DebugUI_Value* widget, ::StringW displayName);

  /// @brief Method Toggle, addr 0x66c0974, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c0eec, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
