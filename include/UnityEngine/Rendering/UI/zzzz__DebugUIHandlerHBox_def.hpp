...
public:
  ...
  /// @brief Method Next, addr 0x6803d18, size 0xbc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnSelection, addr 0x6803c58, size 0xc0, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x6803bf4, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6803dd4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerHBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerHBox(DebugUIHandlerHBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerHBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerHBox(DebugUIHandlerHBoxconst&) = delete;
