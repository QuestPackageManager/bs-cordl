...
/// @brief Method GetChild, addr 0x664f244, size 0x134, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> GetChild(int32_t  index) ;

/// @brief Method IsActive, addr 0x664f3fc, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x664f23c, size 0x8, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method TryGetChild, addr 0x664f378, size 0x84, virtual false, abstract: false, final false
inline bool TryGetChild(int32_t  index, ::ByRef<::UnityEngine::GameObject*>  child) ;

/// @brief Method Update, addr 0x664f53c, size 0x3fc, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x664f938, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
