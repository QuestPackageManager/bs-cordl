...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerRow", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerRow(DebugUIHandlerRow&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerRow", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerRow(DebugUIHandlerRowconst&) = delete;
