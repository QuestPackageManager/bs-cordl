...
public:
  ...
  /// @brief Method GetWidget, addr 0x66c500c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Next, addr 0x66ba438, size 0x108, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnAction, addr 0x66c5020, size 0x4, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDecrement, addr 0x66c5028, size 0x4, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnDeselection, addr 0x66c501c, size 0x4, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnEnable, addr 0x66c5000, size 0x4, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnIncrement, addr 0x66c5024, size 0x4, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method OnSelection, addr 0x66c5014, size 0x8, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method Previous, addr 0x66c502c, size 0xb0, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Previous();

  /// @brief Method SetWidget, addr 0x66c5004, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ba5f4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_nextUIHandler, addr 0x66c4ff0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_nextUIHandler();

  /// @brief Method get_parentUIHandler, addr 0x66c4fd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_parentUIHandler();

  /// @brief Method get_previousUIHandler, addr 0x66c4fe0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> get_previousUIHandler();

  /// @brief Method set_nextUIHandler, addr 0x66c4ff8, size 0x8, virtual false, abstract: false, final false
  inline void set_nextUIHandler(::UnityEngine::Rendering::UI::DebugUIHandlerWidget* value);

  /// @brief Method set_parentUIHandler, addr 0x66c4fd8, size 0x8, virtual false, abstract: false, final false
  inline void set_parentUIHandler(::UnityEngine::Rendering::UI::DebugUIHandlerWidget* value);

  /// @brief Method set_previousUIHandler, addr 0x66c4fe8, size 0x8, virtual false, abstract: false, final false
