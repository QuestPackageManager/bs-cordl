...
public:
  ...
  /// @brief Method MoveNext, addr 0x6801534, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x68015e8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x68015f0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6801628, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6801530, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6801510, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method RefreshAfterSanitization, addr 0x68014bc, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* RefreshAfterSanitization();

  /// @brief Method SetWidget, addr 0x6800f78, size 0x3a8, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method UpdateValueLabel, addr 0x6801320, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6801518, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
