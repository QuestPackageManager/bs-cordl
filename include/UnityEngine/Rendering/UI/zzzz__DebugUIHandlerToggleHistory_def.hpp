...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerToggleHistory__RefreshAfterSanitization_d__4", modifiers: "&&", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerToggleHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
