...
/// @brief Method ChangeSelectedObject, addr 0x664e150, size 0x108, virtual false, abstract: false, final false
inline void ChangeSelectedObject() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerObjectPopupField* New_ctor() ;

/// @brief Method OnDecrement, addr 0x664e268, size 0x10, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnIncrement, addr 0x664e258, size 0x10, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method SetWidget, addr 0x664e0ec, size 0x64, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x664e278, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x664e370, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
