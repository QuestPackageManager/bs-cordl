...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerGroup*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerGroup*, "UnityEngine.Rendering.UI", "DebugUIHandlerGroup");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerGroup(DebugUIHandlerGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerGroup(DebugUIHandlerGroupconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerGroup) == 0x80, "Size mismatch!");
