...
public:
  ...
  /// @brief Method OnAction, addr 0x66c1b80, size 0x98, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDeselection, addr 0x66c1b30, size 0x50, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnSelection, addr 0x66c1ad8, size 0x58, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method OnToggleValueChanged, addr 0x66c1ab4, size 0x24, virtual false, abstract: false, final false
  inline void OnToggleValueChanged(bool value);

  /// @brief Method SetWidget, addr 0x66c195c, size 0x158, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method UpdateValueLabel, addr 0x66c1c18, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c1cdc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
