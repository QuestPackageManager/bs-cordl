...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerVBox*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerVBox*, "UnityEngine.Rendering.UI", "DebugUIHandlerVBox");
...
public:
  ...
  /// @brief Method Next, addr 0x6807cdc, size 0xbc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnSelection, addr 0x6807c1c, size 0xc0, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x6807bb8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6807d98, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerVBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerVBox(DebugUIHandlerVBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerVBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerVBox(DebugUIHandlerVBoxconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerVBox) == 0x68, "Size mismatch!");
