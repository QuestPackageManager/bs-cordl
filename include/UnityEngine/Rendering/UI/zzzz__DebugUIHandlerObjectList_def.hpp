...
public:
  ...
  /// @brief Method OnDecrement, addr 0x66bfef8, size 0x1c, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnIncrement, addr 0x66bfedc, size 0x1c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method SetWidget, addr 0x66bfe78, size 0x64, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method UpdateValueLabel, addr 0x66bff14, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c00a0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
