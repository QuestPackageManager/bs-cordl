...
public:
  ...
  /// @brief Method OnAction, addr 0x66ba6f8, size 0x2c, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDeselection, addr 0x66ba6cc, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnSelection, addr 0x66ba694, size 0x38, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x66ba60c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ba724, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
