...
public:
  ...
  /// @brief Method OnAction, addr 0x67f997c, size 0x2c, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDeselection, addr 0x67f9950, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnSelection, addr 0x67f9918, size 0x38, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x67f9890, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f99a8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
