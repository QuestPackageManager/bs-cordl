...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerButton", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerButton(DebugUIHandlerButton&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerButton", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerButton(DebugUIHandlerButtonconst&) = delete;
