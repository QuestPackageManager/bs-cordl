...
/// @brief Method ChangeValue, addr 0x664d97c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method OnDecrement, addr 0x664da2c, size 0x8, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnDeselection, addr 0x664d924, size 0x50, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnIncrement, addr 0x664d974, size 0x8, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method OnSelection, addr 0x664d8cc, size 0x58, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetWidget, addr 0x664d738, size 0x90, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method UpdateValueLabel, addr 0x664d7c8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x664da34, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
