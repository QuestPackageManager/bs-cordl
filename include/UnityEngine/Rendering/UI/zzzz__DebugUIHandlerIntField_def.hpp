...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerIntField", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerIntField(DebugUIHandlerIntField&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerIntField", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerIntField(DebugUIHandlerIntFieldconst&) = delete;
