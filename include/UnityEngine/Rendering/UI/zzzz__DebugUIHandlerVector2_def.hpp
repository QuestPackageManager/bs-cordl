...
public:
  ...
  /// @brief Method Next, addr 0x66c391c, size 0xcc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnAction, addr 0x66c38f8, size 0x24, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDecrement, addr 0x66c38dc, size 0x1c, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnDeselection, addr 0x66c3894, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnIncrement, addr 0x66c38c0, size 0x1c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method OnSelection, addr 0x66c37a8, size 0xec, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetValue, addr 0x66c3704, size 0xa4, virtual false, abstract: false, final false
  inline void SetValue(float_t v, bool x, bool y);

  /// @brief Method SetWidget, addr 0x66c3314, size 0x2e8, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method SetupSettings, addr 0x66c35fc, size 0x108, virtual false, abstract: false, final false
  inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField* field);

  /// @brief Method <SetWidget>b__6_0, addr 0x66c3a00, size 0x60, virtual false, abstract: false, final false
  inline float_t _SetWidget_b__6_0();

  /// @brief Method <SetWidget>b__6_1, addr 0x66c3a60, size 0xc, virtual false, abstract: false, final false
  inline void _SetWidget_b__6_1(float_t x);

  /// @brief Method <SetWidget>b__6_2, addr 0x66c3a6c, size 0x68, virtual false, abstract: false, final false
  inline float_t _SetWidget_b__6_2();

  /// @brief Method <SetWidget>b__6_3, addr 0x66c3ad4, size 0xc, virtual false, abstract: false, final false
  inline void _SetWidget_b__6_3(float_t x);

  /// @brief Method <SetupSettings>b__8_0, addr 0x66c3ae0, size 0x18, virtual false, abstract: false, final false
  inline float_t _SetupSettings_b__8_0();

  /// @brief Method <SetupSettings>b__8_1, addr 0x66c3af8, size 0x18, virtual false, abstract: false, final false
  inline float_t _SetupSettings_b__8_1();

  /// @brief Method <SetupSettings>b__8_2, addr 0x66c3b10, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c39e8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
