...
/// @brief Method Next, addr 0x6652cdc, size 0xcc, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next() ;

/// @brief Method OnAction, addr 0x6652cb8, size 0x24, virtual true, abstract: false, final false
inline void OnAction() ;

/// @brief Method OnDecrement, addr 0x6652c9c, size 0x1c, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnDeselection, addr 0x6652c54, size 0x2c, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnIncrement, addr 0x6652c80, size 0x1c, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method OnSelection, addr 0x6652b68, size 0xec, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method SetValue, addr 0x6652ab0, size 0xb8, virtual false, abstract: false, final false
inline void SetValue(float_t  v, bool  x, bool  y, bool  z, bool  w) ;

/// @brief Method SetWidget, addr 0x66524c8, size 0x4e0, virtual true, abstract: false, final false
inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget*  widget) ;

/// @brief Method SetupSettings, addr 0x66529a8, size 0x108, virtual false, abstract: false, final false
inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField*  field) ;

/// @brief Method <SetWidget>b__8_0, addr 0x6652dc0, size 0x54, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_0() ;

/// @brief Method <SetWidget>b__8_1, addr 0x6652e14, size 0x14, virtual false, abstract: false, final false
inline void _SetWidget_b__8_1(float_t  x) ;

/// @brief Method <SetWidget>b__8_2, addr 0x6652e28, size 0x5c, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_2() ;

/// @brief Method <SetWidget>b__8_3, addr 0x6652e84, size 0x14, virtual false, abstract: false, final false
inline void _SetWidget_b__8_3(float_t  x) ;

/// @brief Method <SetWidget>b__8_4, addr 0x6652e98, size 0x5c, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_4() ;

/// @brief Method <SetWidget>b__8_5, addr 0x6652ef4, size 0x14, virtual false, abstract: false, final false
inline void _SetWidget_b__8_5(float_t  x) ;

/// @brief Method <SetWidget>b__8_6, addr 0x6652f08, size 0x5c, virtual false, abstract: false, final false
inline float_t _SetWidget_b__8_6() ;

/// @brief Method <SetWidget>b__8_7, addr 0x6652f64, size 0x14, virtual false, abstract: false, final false
inline void _SetWidget_b__8_7(float_t  x) ;

/// @brief Method <SetupSettings>b__10_0, addr 0x6652f78, size 0x18, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__10_0() ;

/// @brief Method <SetupSettings>b__10_1, addr 0x6652f90, size 0x18, virtual false, abstract: false, final false
inline float_t _SetupSettings_b__10_1() ;

/// @brief Method <SetupSettings>b__10_2, addr 0x6652fa8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6652da8, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
