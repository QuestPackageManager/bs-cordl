...
public:
  ...
  /// @brief Method OnDeselection, addr 0x66c1180, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnEnable, addr 0x66c0fdc, size 0x8, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSelection, addr 0x66c1148, size 0x38, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x66c0fe4, size 0x90, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method Update, addr 0x66c11ac, size 0x84, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateValue, addr 0x66c1074, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c1230, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
