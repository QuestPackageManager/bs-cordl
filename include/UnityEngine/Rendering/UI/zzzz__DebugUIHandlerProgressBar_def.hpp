...
public:
  ...
  /// @brief Method OnDeselection, addr 0x6805c1c, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnEnable, addr 0x6805a78, size 0x8, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSelection, addr 0x6805be4, size 0x38, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x6805a80, size 0x90, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method Update, addr 0x6805c48, size 0x84, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateValue, addr 0x6805b10, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6805ccc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerProgressBar", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerProgressBar(DebugUIHandlerProgressBar&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerProgressBar", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerProgressBar(DebugUIHandlerProgressBarconst&) = delete;
