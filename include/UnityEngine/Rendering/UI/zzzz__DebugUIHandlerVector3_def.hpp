...
public:
  ...
  /// @brief Method Next, addr 0x66c4244, size 0xcc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnAction, addr 0x66c4220, size 0x24, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDecrement, addr 0x66c4204, size 0x1c, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnDeselection, addr 0x66c41bc, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnIncrement, addr 0x66c41e8, size 0x1c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method OnSelection, addr 0x66c40d0, size 0xec, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetValue, addr 0x66c4018, size 0xb8, virtual false, abstract: false, final false
  inline void SetValue(float_t v, bool x, bool y, bool z);

  /// @brief Method SetWidget, addr 0x66c3b2c, size 0x3e4, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method SetupSettings, addr 0x66c3f10, size 0x108, virtual false, abstract: false, final false
  inline void SetupSettings(::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField* field);

  /// @brief Method <SetWidget>b__7_0, addr 0x66c4328, size 0x60, virtual false, abstract: false, final false
  inline float_t _SetWidget_b__7_0();

  /// @brief Method <SetWidget>b__7_1, addr 0x66c4388, size 0x10, virtual false, abstract: false, final false
  inline void _SetWidget_b__7_1(float_t v);

  /// @brief Method <SetWidget>b__7_2, addr 0x66c4398, size 0x68, virtual false, abstract: false, final false
  inline float_t _SetWidget_b__7_2();

  /// @brief Method <SetWidget>b__7_3, addr 0x66c4400, size 0x10, virtual false, abstract: false, final false
  inline void _SetWidget_b__7_3(float_t v);

  /// @brief Method <SetWidget>b__7_4, addr 0x66c4410, size 0x68, virtual false, abstract: false, final false
  inline float_t _SetWidget_b__7_4();

  /// @brief Method <SetWidget>b__7_5, addr 0x66c4478, size 0x10, virtual false, abstract: false, final false
  inline void _SetWidget_b__7_5(float_t v);

  /// @brief Method <SetupSettings>b__9_0, addr 0x66c4488, size 0x18, virtual false, abstract: false, final false
  inline float_t _SetupSettings_b__9_0();

  /// @brief Method <SetupSettings>b__9_1, addr 0x66c44a0, size 0x18, virtual false, abstract: false, final false
  inline float_t _SetupSettings_b__9_1();

  /// @brief Method <SetupSettings>b__9_2, addr 0x66c44b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c4310, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
