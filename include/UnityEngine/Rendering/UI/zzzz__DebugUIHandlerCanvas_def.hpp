...
/// @brief Method <ActivatePanel>b__15_0, addr 0x664aa08, size 0x2c, virtual false, abstract: false, final false
inline void _ActivatePanel_b__15_0(::UnityEngine::Rendering::UI::DebugUIHandlerPanel*  p) ;

/// @brief Method <Rebuild>b__12_0, addr 0x664a9bc, size 0x4c, virtual false, abstract: false, final false
inline bool _Rebuild_b__12_0(::UnityEngine::Rendering::DebugUI_Widget*  x) ;

/// @brief Method .ctor, addr 0x664a9b8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetWidgetFromPath>b__0, addr 0x664aa34, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x664a284, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_PrefabsMap, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PrefabsMap, put=__cordl_internal_set_m_PrefabsMap)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::UnityW<::UnityEngine::Transform>>*  m_PrefabsMap;
...
/// @brief Field m_UIPanels, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_UIPanels, put=__cordl_internal_set_m_UIPanels)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerPanel>>*  m_UIPanels;
...
/// @brief Method ActivatePanel, addr 0x6649f24, size 0x210, virtual false, abstract: false, final false
inline void ActivatePanel(int32_t  index, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  selectedWidget) ;

/// @brief Method ActivateSelection, addr 0x664a8d4, size 0x8c, virtual false, abstract: false, final false
inline void ActivateSelection() ;

/// @brief Method ChangeSelection, addr 0x664a2e0, size 0x168, virtual false, abstract: false, final false
inline void ChangeSelection(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget, bool  fromNext) ;

/// @brief Method ChangeSelectionValue, addr 0x664a7c8, size 0x10c, virtual false, abstract: false, final false
inline void ChangeSelectionValue(float_t  multiplier) ;

/// @brief Method GetWidgetFromPath, addr 0x664a134, size 0x150, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetWidgetFromPath(::StringW  queryPath) ;

/// @brief Method HandleInput, addr 0x6648ce4, size 0x21c, virtual false, abstract: false, final false
inline void HandleInput() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerCanvas* New_ctor() ;

/// @brief Method OnEnable, addr 0x6648734, size 0x18c, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Rebuild, addr 0x66490b8, size 0x9cc, virtual false, abstract: false, final false
inline void Rebuild() ;

/// @brief Method RequestHierarchyReset, addr 0x66490ac, size 0xc, virtual false, abstract: false, final false
inline void RequestHierarchyReset() ;

/// @brief Method ResetAllHierarchy, addr 0x66489fc, size 0x2e8, virtual false, abstract: false, final false
inline void ResetAllHierarchy() ;

/// @brief Method SelectNextItem, addr 0x664a530, size 0xc8, virtual false, abstract: false, final false
inline void SelectNextItem() ;

/// @brief Method SelectNextPanel, addr 0x664a6c0, size 0x7c, virtual false, abstract: false, final false
inline void SelectNextPanel() ;

/// @brief Method SelectPreviousItem, addr 0x664a5f8, size 0xc8, virtual false, abstract: false, final false
inline void SelectPreviousItem() ;

/// @brief Method SelectPreviousPanel, addr 0x664a73c, size 0x8c, virtual false, abstract: false, final false
inline void SelectPreviousPanel() ;

/// @brief Method SetScrollTarget, addr 0x664a448, size 0xe8, virtual false, abstract: false, final false
inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  widget) ;

/// @brief Method Traverse, addr 0x6649ab4, size 0x470, virtual false, abstract: false, final false
inline void Traverse(::UnityEngine::Rendering::DebugUI_IContainer*  container, ::UnityEngine::Transform*  parentTransform, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  parentUIHandler, ::ByRef<::UnityEngine::Rendering::UI::DebugUIHandlerWidget*>  selectedHandler) ;

/// @brief Method Update, addr 0x66488c0, size 0x13c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x664a960, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
