...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::UI::DebugUIHandlerBitField*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UI::DebugUIHandlerBitField*, "UnityEngine.Rendering.UI", "DebugUIHandlerBitField");
...
public:
  ...
  /// @brief Method GetValue, addr 0x67fe6e4, size 0xc4, virtual false, abstract: false, final false
  inline bool GetValue(int32_t index);

  static inline ::UnityEngine::Rendering::UI::DebugUIHandlerBitField* New_ctor();

  /// @brief Method Next, addr 0x67fee08, size 0xcc, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> Next();

  /// @brief Method OnAction, addr 0x67fede4, size 0x24, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDecrement, addr 0x67fedc8, size 0x1c, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnDeselection, addr 0x67fed80, size 0x2c, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnIncrement, addr 0x67fedac, size 0x1c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method OnSelection, addr 0x67feaf0, size 0xec, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetValue, addr 0x67fe7a8, size 0x29c, virtual false, abstract: false, final false
  inline void SetValue(int32_t index, bool value);

  /// @brief Method SetWidget, addr 0x67fe224, size 0x3d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67ff078, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerBitField", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerBitField(DebugUIHandlerBitField&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerBitField", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerBitField(DebugUIHandlerBitFieldconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::UI::DebugUIHandlerBitField) == 0x88, "Size mismatch!");
