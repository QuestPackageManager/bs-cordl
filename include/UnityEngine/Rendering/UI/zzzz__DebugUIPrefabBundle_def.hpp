...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIPrefabBundle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIPrefabBundle(DebugUIPrefabBundle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIPrefabBundle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIPrefabBundle(DebugUIPrefabBundleconst&) = delete;
