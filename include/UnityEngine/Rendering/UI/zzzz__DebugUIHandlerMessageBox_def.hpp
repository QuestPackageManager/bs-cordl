...
public:
  ...
  /// @brief Method OnSelection, addr 0x66bfc34, size 0x8, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method SetWidget, addr 0x66bfa58, size 0x188, virtual true, abstract: false, final false
  inline void SetWidget(::UnityEngine::Rendering::DebugUI_Widget* widget);

  /// @brief Method Update, addr 0x66bfbe0, size 0x54, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x66bfc3c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
