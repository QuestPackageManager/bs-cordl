...
public:
  ...
  /// @brief Method <IsDirectChild>b__0, addr 0x66bdad4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66bdacc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetActiveChildren, addr 0x66bd6c0, size 0x40c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget>>* GetActiveChildren();

  /// @brief Method GetFirstItem, addr 0x66ba540, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetFirstItem();

  /// @brief Method GetLastItem, addr 0x66ba248, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetLastItem();

  /// @brief Method IsDirectChild, addr 0x66ba140, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66bdad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
