...
/// @brief Method ChangeValue, addr 0x66c109c, size 0xb8, virtual false, abstract: false, final false
inline void ChangeValue(bool  fast, float_t  multiplier) ;

/// @brief Method Init, addr 0x66beda8, size 0x4, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::Rendering::UI::DebugUIHandlerIndirectFloatField* New_ctor() ;

/// @brief Method OnDecrement, addr 0x66c1154, size 0x8, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnDeselection, addr 0x66c1044, size 0x50, virtual true, abstract: false, final false
inline void OnDeselection() ;

/// @brief Method OnIncrement, addr 0x66c1094, size 0x8, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method OnSelection, addr 0x66c0fec, size 0x58, virtual true, abstract: false, final false
inline bool OnSelection(bool  fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  previous) ;

/// @brief Method UpdateValueLabel, addr 0x66c0ec8, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66c115c, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
