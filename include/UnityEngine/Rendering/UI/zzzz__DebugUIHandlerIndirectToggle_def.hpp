...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerIndirectToggle", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerIndirectToggle(DebugUIHandlerIndirectToggle&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerIndirectToggle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerIndirectToggle(DebugUIHandlerIndirectToggleconst&) = delete;
