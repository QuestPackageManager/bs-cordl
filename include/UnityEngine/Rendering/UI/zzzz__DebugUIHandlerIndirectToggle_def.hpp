...
public:
  ...
  /// @brief Method Init, addr 0x67f8ddc, size 0xf0, virtual false, abstract: false, final false
  inline void Init();

  static inline ::UnityEngine::Rendering::UI::DebugUIHandlerIndirectToggle* New_ctor();

  /// @brief Method OnAction, addr 0x67fe954, size 0x5c, virtual true, abstract: false, final false
  inline void OnAction();

  /// @brief Method OnDeselection, addr 0x67fe904, size 0x50, virtual true, abstract: false, final false
  inline void OnDeselection();

  /// @brief Method OnSelection, addr 0x67fe8ac, size 0x58, virtual true, abstract: false, final false
  inline bool OnSelection(bool fromNext, ::UnityEngine::Rendering::UI::DebugUIHandlerWidget* previous);

  /// @brief Method OnToggleValueChanged, addr 0x67fe880, size 0x2c, virtual false, abstract: false, final false
  inline void OnToggleValueChanged(bool value);

  /// @brief Method UpdateValueLabel, addr 0x67f922c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67fe9b0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
