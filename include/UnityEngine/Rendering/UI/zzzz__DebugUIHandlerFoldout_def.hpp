...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerFoldout", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerFoldout(DebugUIHandlerFoldout&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerFoldout", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerFoldout(DebugUIHandlerFoldoutconst&) = delete;
