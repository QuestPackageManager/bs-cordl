...
public:
  ...
  /// @brief Method OnDecrement, addr 0x66bdce0, size 0x1d8, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnIncrement, addr 0x66bdb44, size 0x19c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method UpdateValueLabel, addr 0x66bdeb8, size 0xa4, virtual true, abstract: false, final false
  inline void UpdateValueLabel();

  /// @brief Method .ctor, addr 0x66bdf5c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
