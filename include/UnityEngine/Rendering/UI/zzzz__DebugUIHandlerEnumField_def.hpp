...
public:
  ...
  /// @brief Method OnDecrement, addr 0x67fcf64, size 0x1d8, virtual true, abstract: false, final false
  inline void OnDecrement(bool fast);

  /// @brief Method OnIncrement, addr 0x67fcdc8, size 0x19c, virtual true, abstract: false, final false
  inline void OnIncrement(bool fast);

  /// @brief Method UpdateValueLabel, addr 0x67fd13c, size 0xa4, virtual true, abstract: false, final false
  inline void UpdateValueLabel();

  /// @brief Method .ctor, addr 0x67fd1e0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
