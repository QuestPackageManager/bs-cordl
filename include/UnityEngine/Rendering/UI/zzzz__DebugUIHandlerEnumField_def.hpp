...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerEnumField", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugUIHandlerEnumField(DebugUIHandlerEnumField&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugUIHandlerEnumField", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugUIHandlerEnumField(DebugUIHandlerEnumFieldconst&) = delete;
