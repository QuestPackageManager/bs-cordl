...
/// @brief Method OnDecrement, addr 0x664bcd4, size 0x1d8, virtual true, abstract: false, final false
inline void OnDecrement(bool  fast) ;

/// @brief Method OnIncrement, addr 0x664bb38, size 0x19c, virtual true, abstract: false, final false
inline void OnIncrement(bool  fast) ;

/// @brief Method UpdateValueLabel, addr 0x664beac, size 0xa4, virtual true, abstract: false, final false
inline void UpdateValueLabel() ;

/// @brief Method .ctor, addr 0x664bf50, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
