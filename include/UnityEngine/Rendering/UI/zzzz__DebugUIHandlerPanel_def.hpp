...
/// @brief Method GetFirstItem, addr 0x664a288, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetFirstItem() ;

/// @brief Method GetPanel, addr 0x664e48c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugUI_Panel* GetPanel() ;

/// @brief Method GetYPosInScroll, addr 0x664e52c, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x664e3c8, size 0xc4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnScrollbarClicked, addr 0x664e4bc, size 0x68, virtual false, abstract: false, final false
inline void OnScrollbarClicked() ;

/// @brief Method ResetDebugManager, addr 0x664e614, size 0x64, virtual false, abstract: false, final false
inline void ResetDebugManager() ;

/// @brief Method SelectNextItem, addr 0x664e494, size 0x14, virtual false, abstract: false, final false
inline void SelectNextItem() ;

/// @brief Method SelectPreviousItem, addr 0x664e4a8, size 0x14, virtual false, abstract: false, final false
inline void SelectPreviousItem() ;

/// @brief Method SetPanel, addr 0x6649a84, size 0x30, virtual false, abstract: false, final false
inline void SetPanel(::UnityEngine::Rendering::DebugUI_Panel*  panel) ;

/// @brief Method SetScrollTarget, addr 0x664e524, size 0x8, virtual false, abstract: false, final false
inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget*  target) ;

/// @brief Method UpdateScroll, addr 0x6648f00, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x664e678, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
