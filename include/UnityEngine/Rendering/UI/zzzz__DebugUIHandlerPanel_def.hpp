...
public:
  ...
  /// @brief Method GetFirstItem, addr 0x66bc294, size 0x58, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rendering::UI::DebugUIHandlerWidget> GetFirstItem();

  /// @brief Method GetPanel, addr 0x66c0498, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_Panel* GetPanel();

  /// @brief Method GetYPosInScroll, addr 0x66c0538, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x66c03d4, size 0xc4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnScrollbarClicked, addr 0x66c04c8, size 0x68, virtual false, abstract: false, final false
  inline void OnScrollbarClicked();

  /// @brief Method ResetDebugManager, addr 0x66c0620, size 0x64, virtual false, abstract: false, final false
  inline void ResetDebugManager();

  /// @brief Method SelectNextItem, addr 0x66c04a0, size 0x14, virtual false, abstract: false, final false
  inline void SelectNextItem();

  /// @brief Method SelectPreviousItem, addr 0x66c04b4, size 0x14, virtual false, abstract: false, final false
  inline void SelectPreviousItem();

  /// @brief Method SetPanel, addr 0x66bba90, size 0x30, virtual false, abstract: false, final false
  inline void SetPanel(::UnityEngine::Rendering::DebugUI_Panel* panel);

  /// @brief Method SetScrollTarget, addr 0x66c0530, size 0x8, virtual false, abstract: false, final false
  inline void SetScrollTarget(::UnityEngine::Rendering::UI::DebugUIHandlerWidget* target);

  /// @brief Method UpdateScroll, addr 0x66baf0c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66c0684, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
