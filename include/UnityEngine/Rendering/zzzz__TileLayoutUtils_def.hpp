...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TileLayoutUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TileLayoutUtils(TileLayoutUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TileLayoutUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TileLayoutUtils(TileLayoutUtilsconst&) = delete;
