...
public:
  ...
  /// @brief Method Alloc, addr 0x65f5ba4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f5e7c, size 0x21c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Vector2 scaleFactor, ::UnityEngine::Rendering::RTHandleAllocInfo info);

  /// @brief Method Alloc, addr 0x65f58ec, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f647c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f6740, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f61ec, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f9328, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RTHandle* tex);

  /// @brief Method Alloc, addr 0x65f6988, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::RenderTexture* texture, bool transferOwnership);

  /// @brief Method Alloc, addr 0x65f6a58, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RenderTargetIdentifier texture);

  /// @brief Method Alloc, addr 0x65f6b68, size 0xa0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RenderTargetIdentifier texture, ::StringW name);

  /// @brief Method Alloc, addr 0x65f6840, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Texture* texture);

  /// @brief Method Alloc, addr 0x65f50b0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f864c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f54d4, size 0x178, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::RTHandle* Alloc(int32_t width, int32_t height, ::UnityEngine::Rendering::RTHandleAllocInfo info);

  /// @brief Method Alloc, addr 0x65f4de4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x65f52b8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocAutoSizedRenderTexture, addr 0x65f9180, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocAutoSizedRenderTexture, addr 0x65f8f60, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDimensions, addr 0x65f4a0c, size 0x1cc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2Int CalculateDimensions(::UnityEngine::Vector2 scaleFactor);

  /// @brief Method CalculateDimensions, addr 0x65f4c44, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2Int CalculateDimensions(::UnityEngine::Rendering::ScaleFunc* scaleFunc);

  /// @brief Method CalculateRatioAgainstMaxSize, addr 0x65f74cc, size 0x248, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalculateRatioAgainstMaxSize(::ByRef<::UnityEngine::Vector2Int> viewportSize);

  /// @brief Method CreateRenderTexture, addr 0x65f8868, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method DemandResize, addr 0x65f8298, size 0x28c, virtual false, abstract: false, final false
  inline void DemandResize(::UnityEngine::Rendering::RTHandle* rth);

  /// @brief Method Dispose, addr 0x65f7abc, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x65f7ac4, size 0x1dc, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DumpRTInfo, addr 0x65f93a0, size 0x31c, virtual false, abstract: false, final false
  inline ::StringW DumpRTInfo();

  /// @brief Method GetMaxHeight, addr 0x65f8644, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetMaxHeight();

  /// @brief Method GetMaxWidth, addr 0x65f863c, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetMaxWidth();

  /// @brief Method GetStencilFormat, addr 0x65f8ea0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x65f6cfc, size 0x2dc, virtual false, abstract: false, final false
  inline void Initialize(int32_t width, int32_t height);

  /// @brief Method Initialize, addr 0x65f706c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x65f7114, size 0x10, virtual false, abstract: false, final false
  inline void Release(::UnityEngine::Rendering::RTHandle* rth);

  /// @brief Method Remove, addr 0x65f426c, size 0x64, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::Rendering::RTHandle* rth);

  /// @brief Method ResetReferenceSize, addr 0x65f7438, size 0xc, virtual false, abstract: false, final false
  inline void ResetReferenceSize(int32_t width, int32_t height);

  /// @brief Method Resize, addr 0x65f7e4c, size 0x324, virtual false, abstract: false, final false
  inline void Resize(int32_t width, int32_t height, bool sizeChanged);

  /// @brief Method SetHardwareDynamicResolutionState, addr 0x65f7190, size 0x19c, virtual false, abstract: false, final false
  inline void SetHardwareDynamicResolutionState(bool enableHWDynamicRes);

  /// @brief Method SetReferenceSize, addr 0x65f73ac, size 0x8, virtual false, abstract: false, final false
  inline void SetReferenceSize(int32_t width, int32_t height);

  /// @brief Method SetReferenceSize, addr 0x65f7ca0, size 0x1ac, virtual false, abstract: false, final false
  inline void SetReferenceSize(int32_t width, int32_t height, bool reset);

  /// @brief Method SwitchResizeMode, addr 0x65f8170, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65f7788, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rtHandleProperties, addr 0x65f7aa8, size 0x14, virtual false, abstract: false, final false
