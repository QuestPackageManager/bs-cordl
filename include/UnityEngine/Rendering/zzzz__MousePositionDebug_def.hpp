...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MousePositionDebug", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MousePositionDebug(MousePositionDebug&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MousePositionDebug", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MousePositionDebug(MousePositionDebugconst&) = delete;
