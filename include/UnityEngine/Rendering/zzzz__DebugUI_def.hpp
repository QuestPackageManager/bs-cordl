...
public:
  ...
  /// @brief Method GenerateQueryPath, addr 0x6625434, size 0xec, virtual true, abstract: false, final false
  inline void GenerateQueryPath();

  /// @brief Method GetHashCode, addr 0x6626104, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6625370, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_displayName, addr 0x6626030, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_displayName();

  /// @brief Method get_flags, addr 0x6626020, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_Flags get_flags();

  /// @brief Method get_isEditorOnly, addr 0x6626060, size 0xc, virtual false, abstract: false, final false
  inline bool get_isEditorOnly();

  /// @brief Method get_isHidden, addr 0x66257e8, size 0x20, virtual false, abstract: false, final false
  inline bool get_isHidden();

  /// @brief Method get_isInactiveInEditor, addr 0x6626078, size 0x8c, virtual false, abstract: false, final false
  inline bool get_isInactiveInEditor();

  /// @brief Method get_isRuntimeOnly, addr 0x662606c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isRuntimeOnly();

  /// @brief Method get_panel, addr 0x6626000, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_Panel* get_panel();

  /// @brief Method get_parent, addr 0x6626010, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_IContainer* get_parent();

  /// @brief Method get_queryPath, addr 0x6626050, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_queryPath();

  /// @brief Method get_tooltip, addr 0x6626040, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method set_displayName, addr 0x6626038, size 0x8, virtual true, abstract: false, final true
  inline void set_displayName(::StringW value);

  /// @brief Method set_flags, addr 0x6626028, size 0x8, virtual false, abstract: false, final false
  inline void set_flags(::UnityEngine::Rendering::DebugUI_Flags value);

  /// @brief Method set_nameAndTooltip, addr 0x661af4c, size 0x8, virtual false, abstract: false, final false
  inline void set_nameAndTooltip(::UnityEngine::Rendering::Widget_DebugUI_NameAndTooltip value);

  /// @brief Method set_panel, addr 0x6626008, size 0x8, virtual true, abstract: false, final false
  inline void set_panel(::UnityEngine::Rendering::DebugUI_Panel* value);

  /// @brief Method set_parent, addr 0x6626018, size 0x8, virtual true, abstract: false, final false
  inline void set_parent(::UnityEngine::Rendering::DebugUI_IContainer* value);

  /// @brief Method set_queryPath, addr 0x6626058, size 0x8, virtual false, abstract: false, final false
  inline void set_queryPath(::StringW value);

  /// @brief Method set_tooltip, addr 0x6626048, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GenerateQueryPath, addr 0x6625374, size 0xc0, virtual true, abstract: false, final false
  inline void GenerateQueryPath();

  /// @brief Method GetHashCode, addr 0x66256c0, size 0x128, virtual true, abstract: false, final false
  inline int32_t GetHashCode();
  ...
  /// @brief Method OnItemAdded, addr 0x6625520, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method OnItemRemoved, addr 0x6625658, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6625028, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x66250c4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66252a8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::StringW id);

  /// @brief Method get_children, addr 0x6624f40, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* get_children();

  /// @brief Method get_hideDisplayName, addr 0x6624ed4, size 0x6c, virtual false, abstract: false, final false
  inline bool get_hideDisplayName();

  /// @brief Method get_panel, addr 0x6624f50, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_Panel* get_panel();
  ...
  /// @brief Method set_children, addr 0x6624f48, size 0x8, virtual false, abstract: false, final false
  inline void set_children(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* value);

  /// @brief Method set_panel, addr 0x6624f58, size 0xd0, virtual true, abstract: false, final false
  inline void set_panel(::UnityEngine::Rendering::DebugUI_Panel* value);
...
public:
  ...
  /// @brief Method GetValue, addr 0x6625b88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6625bb4, size 0x44, virtual true, abstract: false, final true
  inline void SetValue(::System::Object* value);

  /// @brief Method SetValue, addr 0x6625c00, size 0x8, virtual false, abstract: false, final false
  inline void SetValue(bool value);

  /// @brief Method UnityEngine.Rendering.DebugUI.IValueField.GetValue, addr 0x6625b90, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* UnityEngine_Rendering_DebugUI_IValueField_GetValue();

  /// @brief Method ValidateValue, addr 0x6625bf8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x661def4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6625ad8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_columnLabels, addr 0x6625810, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_columnLabels();

  /// @brief Method get_columnTooltips, addr 0x6625818, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_columnTooltips();

  /// @brief Method get_isReadOnly, addr 0x6625808, size 0x8, virtual false, abstract: false, final false
  inline bool get_isReadOnly();

  /// @brief Method get_rowContents, addr 0x6625830, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_columnLabels, addr 0x661df6c, size 0x10, virtual false, abstract: false, final false
  inline void set_columnLabels(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_columnTooltips, addr 0x6625820, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6625c08, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6625c5c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x661afd4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetColumnVisibility, addr 0x6625ef4, size 0x4c, virtual false, abstract: false, final false
  inline bool GetColumnVisibility(int32_t index);

  static inline ::UnityEngine::Rendering::DebugUI_Table* New_ctor();

  /// @brief Method OnItemAdded, addr 0x6625f40, size 0x18, virtual true, abstract: false, final false
  inline void OnItemAdded(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* sender,
                          ::UnityEngine::Rendering::ListChangedEventArgs_1<::UnityEngine::Rendering::DebugUI_Widget*>* e);

  /// @brief Method OnItemRemoved, addr 0x6625f58, size 0x18, virtual true, abstract: false, final false
  inline void OnItemRemoved(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* sender,
                            ::UnityEngine::Rendering::ListChangedEventArgs_1<::UnityEngine::Rendering::DebugUI_Widget*>* e);

  /// @brief Method SetColumnVisibility, addr 0x661aef8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x661a00c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::GUIStyle* getStaticF_columnHeaderStyle();

  /// @brief Method get_VisibleColumns, addr 0x6625cb0, size 0x244, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6626184, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_action, addr 0x6626174, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action* get_action();

  /// @brief Method set_action, addr 0x662617c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatString, addr 0x66261b8, size 0x9c, virtual true, abstract: false, final false
  inline ::StringW FormatString(::System::Object* value);

  /// @brief Method GetValue, addr 0x6626198, size 0x20, virtual true, abstract: false, final false
  inline ::System::Object* GetValue();
  ...
  /// @brief Method .ctor, addr 0x6619138, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_getter, addr 0x6626188, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<::System::Object*>* get_getter();

  /// @brief Method set_getter, addr 0x6626190, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FormatString, addr 0x6626254, size 0xf0, virtual true, abstract: false, final false
  inline ::StringW FormatString(::System::Object* value);

  static inline ::UnityEngine::Rendering::DebugUI_ProgressBarValue* New_ctor();

  /// @brief Method <FormatString>g__Remap01|2_0, addr 0x6626344, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x661df88, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_numElements, addr 0x6626354, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_numElements();

  /// @brief Method get_refreshRate, addr 0x662636c, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x66263d0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetHistoryValue, addr 0x6626434, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6626474, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_historyDepth, addr 0x662641c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_historyDepth();

  /// @brief Method get_historyGetter, addr 0x662640c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Func_1<bool>*, ::Array<::System::Func_1<bool>*>*> get_historyGetter();

  /// @brief Method set_historyGetter, addr 0x6626414, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ValidateValue, addr 0x66264b0, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6626514, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ValidateValue, addr 0x6626560, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66265c4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ValidateValue, addr 0x6626610, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6626670, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InitQuickSeparators>b__17_0, addr 0x6626bd8, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW _InitQuickSeparators_b__17_0(::UnityEngine::GUIContent* x);

  /// @brief Method .ctor, addr 0x6626bd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitQuickSeparators, addr 0x6626800, size 0x214, virtual false, abstract: false, final false
  inline void InitQuickSeparators();

  static inline ::UnityEngine::Rendering::DebugUI_EnumField* New_ctor();

  /// @brief Method SetValue, addr 0x6626a14, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6618d8c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentIndex, addr 0x662675c, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_currentIndex();

  /// @brief Method get_getIndex, addr 0x662673c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<int32_t>* get_getIndex();

  /// @brief Method get_indexes, addr 0x66266c4, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_indexes();

  /// @brief Method get_setIndex, addr 0x662674c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<int32_t>* get_setIndex();

  /// @brief Method set_autoEnum, addr 0x662679c, size 0x64, virtual false, abstract: false, final false
  inline void set_autoEnum(::System::Type* value);

  /// @brief Method set_currentIndex, addr 0x662677c, size 0x20, virtual false, abstract: false, final false
  inline void set_currentIndex(int32_t value);

  /// @brief Method set_getIndex, addr 0x6626744, size 0x8, virtual false, abstract: false, final false
  inline void set_getIndex(::System::Func_1<int32_t>* value);

  /// @brief Method set_setIndex, addr 0x6626754, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x661906c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_getObjects, addr 0x6626c64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Object>>*>* get_getObjects();

  /// @brief Method set_getObjects, addr 0x6626c6c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetHistoryValue, addr 0x6626c9c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6626cdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_historyDepth, addr 0x6626c84, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_historyDepth();

  /// @brief Method get_historyIndexGetter, addr 0x6626c74, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Func_1<int32_t>*, ::Array<::System::Func_1<int32_t>*>*> get_historyIndexGetter();

  /// @brief Method set_historyIndexGetter, addr 0x6626c7c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6626d48, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enumType, addr 0x6626ce0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_enumType();

  /// @brief Method set_enumType, addr 0x6626ce8, size 0x60, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Fill, addr 0x6626db4, size 0x434, virtual false, abstract: false, final false
  inline void Fill(::ArrayW<::StringW, ::Array<::StringW>*> names);

  static inline ::UnityEngine::Rendering::DebugUI_MaskField* New_ctor();

  /// @brief Method SetValue, addr 0x66271e8, size 0xe8, virtual true, abstract: false, final false
  inline void SetValue(uint32_t value);

  /// @brief Method .ctor, addr 0x66272d0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ValidateValue, addr 0x662733c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6627394, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66273f0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6627444, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6627498, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x661af54, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x66274ec, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x662758c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_message, addr 0x662756c, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__0_0, addr 0x66276f0, size 0x9c, virtual false, abstract: false, final false
  inline bool __ctor_b__0_0();

  /// @brief Method .ctor, addr 0x66276ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6627590, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.ctor>b__29_0, addr 0x6627a98, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__29_0(::UnityEngine::Rendering::DebugUI_Panel* _p0_);

  /// @brief Method .ctor, addr 0x6627a94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetHashCode, addr 0x6627934, size 0xe8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::DebugUI_Panel* New_ctor();

  /// @brief Method OnItemAdded, addr 0x6627884, size 0x58, virtual true, abstract: false, final false
  inline void OnItemAdded(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* sender,
                          ::UnityEngine::Rendering::ListChangedEventArgs_1<::UnityEngine::Rendering::DebugUI_Widget*>* e);

  /// @brief Method OnItemRemoved, addr 0x66278dc, size 0x58, virtual true, abstract: false, final false
  inline void OnItemRemoved(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* sender,
                            ::UnityEngine::Rendering::ListChangedEventArgs_1<::UnityEngine::Rendering::DebugUI_Widget*>* e);

  /// @brief Method SetDirty, addr 0x6625588, size 0xd0, virtual false, abstract: false, final false
  inline void SetDirty();

  /// @brief Method System.IComparable<UnityEngine.Rendering.DebugUI.Panel>.CompareTo, addr 0x6627a1c, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x662141c, size 0x1f0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onSetDirty, addr 0x662160c, size 0xc0, virtual false, abstract: false, final false
  inline void add_onSetDirty(::System::Action_1<::UnityEngine::Rendering::DebugUI_Panel*>* value);

  /// @brief Method get_children, addr 0x6627874, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* get_children();

  /// @brief Method get_displayName, addr 0x662779c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_displayName();

  /// @brief Method get_editorForceUpdate, addr 0x6627868, size 0xc, virtual false, abstract: false, final false
  inline bool get_editorForceUpdate();

  /// @brief Method get_flags, addr 0x662778c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::DebugUI_Flags get_flags();

  /// @brief Method get_groupIndex, addr 0x66277ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_groupIndex();

  /// @brief Method get_isEditorOnly, addr 0x66277c4, size 0xc, virtual false, abstract: false, final false
  inline bool get_isEditorOnly();

  /// @brief Method get_isInactiveInEditor, addr 0x66277dc, size 0x8c, virtual false, abstract: false, final false
  inline bool get_isInactiveInEditor();

  /// @brief Method get_isRuntimeOnly, addr 0x66277d0, size 0xc, virtual false, abstract: false, final false
  inline bool get_isRuntimeOnly();

  /// @brief Method get_queryPath, addr 0x66277bc, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_queryPath();
  ...
  /// @brief Method remove_onSetDirty, addr 0x66212dc, size 0xc0, virtual false, abstract: false, final false
  inline void remove_onSetDirty(::System::Action_1<::UnityEngine::Rendering::DebugUI_Panel*>* value);

  /// @brief Method set_children, addr 0x662787c, size 0x8, virtual false, abstract: false, final false
  inline void set_children(::UnityEngine::Rendering::ObservableList_1<::UnityEngine::Rendering::DebugUI_Widget*>* value);

  /// @brief Method set_displayName, addr 0x66277a4, size 0x8, virtual true, abstract: false, final true
  inline void set_displayName(::StringW value);

  /// @brief Method set_flags, addr 0x6627794, size 0x8, virtual false, abstract: false, final false
  inline void set_flags(::UnityEngine::Rendering::DebugUI_Flags value);

  /// @brief Method set_groupIndex, addr 0x66277b4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6624ed0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
