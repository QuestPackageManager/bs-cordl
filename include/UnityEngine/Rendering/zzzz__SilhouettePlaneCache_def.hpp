...
public:
// Declarations
/// @brief Method .ctor, addr 0x667bee4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x667b9e0, size 0xb8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FreeUnusedSlots, addr 0x667bef8, size 0x1a0, virtual false, abstract: false, final false
inline void FreeUnusedSlots(int32_t  frameIndex, int32_t  maximumAge) ;

/// @brief Method GetSubArray, addr 0x667c098, size 0x11c, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Plane> GetSubArray(int32_t  viewInstanceID) ;

/// @brief Method Init, addr 0x667b8cc, size 0x114, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method Update, addr 0x667ba98, size 0x44c, virtual false, abstract: false, final false
