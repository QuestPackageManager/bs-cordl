...
public:
  ...
  /// @brief Method Clear, addr 0x67cf158, size 0x180, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Dispose, addr 0x67cf550, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetComponent, addr 0x67cf4dc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Reload, addr 0x67cf2d8, size 0x204, virtual false, abstract: false, final false
