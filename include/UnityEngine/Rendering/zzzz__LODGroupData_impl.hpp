...
// Ctor Parameters [CppParam { name: "valid", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lodCount", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "rendererCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "screenRelativeTransitionHeights", ty:
// "::UnityEngine::Rendering::LODGroupData__screenRelativeTransitionHeights_e__FixedBuffer", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fadeTransitionWidth", ty:
// "::UnityEngine::Rendering::LODGroupData__fadeTransitionWidth_e__FixedBuffer", modifiers: "", def_value: Some("{}"), comment: None }]
