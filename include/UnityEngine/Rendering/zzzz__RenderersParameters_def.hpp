...
/// @brief Method get_valid, addr 0x6681d30, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method CreateInstanceDataBuffer, addr 0x6680744, size 0x3c8, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::GPUInstanceDataBuffer* CreateInstanceDataBuffer(::UnityEngine::Rendering::RenderersParameters_Flags  flags, ::ByRef<::UnityEngine::Rendering::InstanceNumInfo>  instanceNumInfo) ;

/// @brief Method <.ctor>g__GetParamInfo|14_0, addr 0x6681860, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderersParameters_ParamInfo __ctor_g__GetParamInfo_14_0(::ByRef<::UnityEngine::Rendering::GPUInstanceDataBuffer*>  instanceDataBuffer, int32_t  paramNameIdx, bool  assertOnFail) ;

/// @brief Method .ctor, addr 0x6680b0c, size 0x29c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "lightmapScale", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "localToWorld", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "worldToLocal", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "matrixPreviousM", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "matrixPreviousMI", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "shCoefficients", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "boundingSphere", ty: "::UnityEngine::Rendering::RenderersParameters_ParamInfo", modifiers: "", def_value: None }, CppParam { name: "windParams", ty: "::ArrayW<::UnityEngine::Rendering::RenderersParameters_ParamInfo,::Array<::UnityEngine::Rendering::RenderersParameters_ParamInfo>*>", modifiers: "", def_value: None }, CppParam { name: "windHistoryParams", ty: "::ArrayW<::UnityEngine::Rendering::RenderersParameters_ParamInfo,::Array<::UnityEngine::Rendering::RenderersParameters_ParamInfo>*>", modifiers: "", def_value: None }]
