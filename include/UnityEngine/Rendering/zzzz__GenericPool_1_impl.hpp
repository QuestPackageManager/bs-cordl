...
template <typename T> inline T UnityEngine::Rendering::GenericPool_1<T>::Get() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::GenericPool_1<T>*>(), { "Get", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<T>(nullptr, ___internal_method);
}
template <typename T> inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> UnityEngine::Rendering::GenericPool_1<T>::Get(::by_ref<T> value) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::GenericPool_1<T>*>(), { "Get", {}, { ::i2c::type_of<::by_ref<T>>() } })));
...
template <typename T> inline void UnityEngine::Rendering::GenericPool_1<T>::Release(T toRelease) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::GenericPool_1<T>*>(), { "Release", {}, { ::i2c::type_of<T>() } })));
