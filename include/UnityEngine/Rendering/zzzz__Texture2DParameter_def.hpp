...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67cdacc, size 0x108, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::Texture2DParameter* New_ctor(::UnityEngine::Texture* value, bool overrideState);

  /// @brief Method .ctor, addr 0x67cda68, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Texture2DParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Texture2DParameter(Texture2DParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Texture2DParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Texture2DParameter(Texture2DParameterconst&) = delete;
