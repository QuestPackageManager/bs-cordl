...
/// @brief Method Equals, addr 0x69567d0, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6956468, size 0x140, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::DrawingSettings  other) ;

/// @brief Method GetHashCode, addr 0x69568d0, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetShaderPassName, addr 0x69561dc, size 0x13c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::ShaderTagId GetShaderPassName(int32_t  index) ;

/// @brief Method SetShaderPassName, addr 0x6956320, size 0x148, virtual false, abstract: false, final false
inline void SetShaderPassName(int32_t  index, ::UnityEngine::Rendering::ShaderTagId  shaderPassName) ;

/// @brief Method .ctor, addr 0x6956064, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x69569f4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_enableDynamicBatching, addr 0x695613c, size 0x10, virtual false, abstract: false, final false
inline void set_enableDynamicBatching(bool  value) ;

/// @brief Method set_enableInstancing, addr 0x695614c, size 0x20, virtual false, abstract: false, final false
inline void set_enableInstancing(bool  value) ;

/// @brief Method set_mainLightIndex, addr 0x69561d4, size 0x8, virtual false, abstract: false, final false
inline void set_mainLightIndex(int32_t  value) ;

/// @brief Method set_overrideMaterial, addr 0x695616c, size 0x2c, virtual false, abstract: false, final false
inline void set_overrideMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_overrideMaterialPassIndex, addr 0x69561c4, size 0x8, virtual false, abstract: false, final false
inline void set_overrideMaterialPassIndex(int32_t  value) ;

/// @brief Method set_overrideShader, addr 0x6956198, size 0x2c, virtual false, abstract: false, final false
inline void set_overrideShader(::UnityEngine::Shader*  value) ;

/// @brief Method set_overrideShaderPassIndex, addr 0x69561cc, size 0x8, virtual false, abstract: false, final false
inline void set_overrideShaderPassIndex(int32_t  value) ;

/// @brief Method set_perObjectData, addr 0x6956134, size 0x8, virtual false, abstract: false, final false
