...
constexpr ::UnityEngine::Rendering::VertexAttributeFormat::VertexAttributeFormat(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::Rendering::VertexAttributeFormat::VertexAttributeFormat() {}
