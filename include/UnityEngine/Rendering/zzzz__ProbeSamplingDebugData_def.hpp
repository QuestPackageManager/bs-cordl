...
public:
  ...
  /// @brief Method .ctor, addr 0x67919f8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProbeSamplingDebugData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProbeSamplingDebugData(ProbeSamplingDebugData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProbeSamplingDebugData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProbeSamplingDebugData(ProbeSamplingDebugDataconst&) = delete;
