...
public:
  ...
  /// @brief Method .ctor, addr 0x67cce24, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(float_t value, float_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67cce08, size 0x8, virtual true, abstract: false, final false
  inline float_t get_value();

  /// @brief Method set_value, addr 0x67cce10, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMaxFloatParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInterpMaxFloatParameter(NoInterpMaxFloatParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMaxFloatParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInterpMaxFloatParameter(NoInterpMaxFloatParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpMaxFloatParameter) == 0x20, "Size mismatch!");
