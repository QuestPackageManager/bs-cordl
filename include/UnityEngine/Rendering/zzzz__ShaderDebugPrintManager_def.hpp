...
public:
  ...
  /// @brief Method BufferReadComplete, addr 0x6629ba8, size 0x10c0, virtual false, abstract: false, final false
  inline void BufferReadComplete(::UnityEngine::Rendering::AsyncGPUReadbackRequest request);

  /// @brief Method ClearShaderDebugPrintBuffer, addr 0x6629ab0, size 0xf8, virtual false, abstract: false, final false
  inline void ClearShaderDebugPrintBuffer();

  /// @brief Method DebugValueTypeToElemSize, addr 0x66294f8, size 0x24, virtual false, abstract: false, final false
  inline int32_t DebugValueTypeToElemSize(::UnityEngine::Rendering::ShaderDebugPrintManager_DebugValueType type);

  /// @brief Method DefaultOutput, addr 0x662ae14, size 0x5c, virtual false, abstract: false, final false
  inline void DefaultOutput(::StringW line);

  /// @brief Method EndFrame, addr 0x662ac68, size 0xc4, virtual false, abstract: false, final false
  inline void EndFrame();

  static inline ::UnityEngine::Rendering::ShaderDebugPrintManager* New_ctor();

  /// @brief Method PrintImmediate, addr 0x662ad2c, size 0xd8, virtual false, abstract: false, final false
  inline void PrintImmediate();

  /// @brief Method SetShaderDebugPrintBindings, addr 0x662993c, size 0x174, virtual false, abstract: false, final false
  inline void SetShaderDebugPrintBindings(::UnityEngine::Rendering::CommandBuffer* cmd);

  /// @brief Method SetShaderDebugPrintInputConstants, addr 0x6629870, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x662951c, size 0x2f8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x6629814, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::ShaderDebugPrintManager* get_instance();

  /// @brief Method get_outputLine, addr 0x662ae04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_outputAction, addr 0x662ae0c, size 0x8, virtual false, abstract: false, final false
