...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ClearFlag, "UnityEngine.Rendering", "ClearFlag");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::ClearFlag) == 0x4, "Size mismatch!");
