...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Rendering::SRPLensFlareColorType, 0x4>, "Size mismatch!");

} // namespace UnityEngine::Rendering
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::SRPLensFlareColorType, "UnityEngine.Rendering", "SRPLensFlareColorType");
