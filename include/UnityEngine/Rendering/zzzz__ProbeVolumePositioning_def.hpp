...
public:
  ...
  /// @brief Method OBBAABBIntersect, addr 0x6652d48, size 0x544, virtual false, abstract: false, final false
  ...
  /// @brief Method OBBContains, addr 0x6652c70, size 0xd8, virtual false, abstract: false, final false
  static inline bool OBBContains(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_Volume> obb, ::UnityEngine::Vector3 point);

  /// @brief Method OBBIntersect, addr 0x66524ac, size 0x6dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectAABB, addr 0x665328c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectOBB, addr 0x6652b88, size 0xe8, virtual false, abstract: false, final false
