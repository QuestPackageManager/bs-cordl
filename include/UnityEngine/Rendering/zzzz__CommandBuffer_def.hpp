...
public:
  ...
  /// @brief Method InitBuffer addr 0x2ce9f98 size 0x28 virtual false final false
  static inline void* InitBuffer();

  /// @brief Method ReleaseBuffer addr 0x2ce9fc0 size 0x3c virtual false final false
  inline void ReleaseBuffer();

  /// @brief Method set_name addr 0x2ce9ffc size 0x44 virtual false final false
  inline void set_name(::StringW value);

  /// @brief Method Clear addr 0x2cea040 size 0x3c virtual false final false
  inline void Clear();

  /// @brief Method Internal_DrawMesh addr 0x2cea07c size 0x84 virtual false final false
  ...
  /// @brief Method Internal_DrawRenderer addr 0x2cea184 size 0x6c virtual false final false
  ...
  /// @brief Method Internal_DrawMeshInstanced addr 0x2cea1f0 size 0x8c virtual false final false
  ...
  /// @brief Method CopyTexture_Internal addr 0x2cea27c size 0xc8 virtual false final false
  ...
  /// @brief Method Blit_Identifier addr 0x2cea344 size 0xa0 virtual false final false
  ...
  /// @brief Method GetTemporaryRT addr 0x2cea480 size 0xbc virtual false final false
  ...
  /// @brief Method GetTemporaryRT addr 0x2cea53c size 0xac virtual false final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format,
                             int32_t antiAliasing, bool enableRandomWrite, ::UnityEngine::RenderTextureMemoryless memorylessMode);

  /// @brief Method GetTemporaryRT addr 0x2cea5e8 size 0xa4 virtual false final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format,
                             int32_t antiAliasing);

  /// @brief Method GetTemporaryRT addr 0x2cea68c size 0xa0 virtual false final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format);

  /// @brief Method GetTemporaryRT addr 0x2cea72c size 0xec virtual false final false
  ...
  /// @brief Method ReleaseTemporaryRT addr 0x2cea818 size 0x44 virtual false final false
  inline void ReleaseTemporaryRT(int32_t nameID);

  /// @brief Method SetGlobalFloat addr 0x2cea85c size 0x54 virtual false final false
  inline void SetGlobalFloat(int32_t nameID, float_t value);

  /// @brief Method SetGlobalVector addr 0x2cea8b0 size 0x5c virtual false final false
  inline void SetGlobalVector(int32_t nameID, ::UnityEngine::Vector4 value);

  /// @brief Method SetViewProjectionMatrices addr 0x2cea960 size 0x54 virtual false final false
  inline void SetViewProjectionMatrices(::UnityEngine::Matrix4x4 view, ::UnityEngine::Matrix4x4 proj);

  /// @brief Method ValidateAgainstExecutionFlags addr 0x2ceaa08 size 0x54 virtual false final false
  ...
  /// @brief Method SetGlobalTexture_Impl addr 0x2ceaa5c size 0x5c virtual false final false
  ...
  /// @brief Method SetRenderTarget addr 0x2ceaab8 size 0xa0 virtual false final false
  inline void SetRenderTarget(::UnityEngine::Rendering::RenderTargetIdentifier rt);

  /// @brief Method SetRenderTargetSingle_Internal addr 0x2ceab58 size 0x74 virtual false final false
  ...
  /// @brief Method Finalize addr 0x2ceac40 size 0x98 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x2cead50 size 0x64 virtual true final true
  inline void Dispose();

  /// @brief Method Dispose addr 0x2ceacd8 size 0x78 virtual false final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::Rendering::CommandBuffer* New_ctor();

  /// @brief Method .ctor addr 0x2ceadb4 size 0x48 virtual false final false
  inline void _ctor();

  /// @brief Method DrawMesh addr 0x2ceadfc size 0x284 virtual false final false
  ...
  /// @brief Method DrawMesh addr 0x2ceb080 size 0x30 virtual false final false
  inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material, int32_t submeshIndex, int32_t shaderPass);

  /// @brief Method DrawMesh addr 0x2ceb0b0 size 0x34 virtual false final false
  ...
  /// @brief Method DrawMesh addr 0x2ceb0e4 size 0x38 virtual false final false
  inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material);

  /// @brief Method DrawRenderer addr 0x2ceb11c size 0x214 virtual false final false
  ...
  /// @brief Method DrawMeshInstanced addr 0x2ceb330 size 0x3a8 virtual false final false
  ...
  /// @brief Method CopyTexture addr 0x2ceb6d8 size 0x94 virtual false final false
  ...
  /// @brief Method Blit addr 0x2ceb76c size 0x8c virtual false final false
  inline void Blit(::UnityEngine::Rendering::RenderTargetIdentifier source, ::UnityEngine::Rendering::RenderTargetIdentifier dest);

  /// @brief Method Blit addr 0x2ceb7f8 size 0x90 virtual false final false
  ...
  /// @brief Method Blit addr 0x2ceb888 size 0x9c virtual false final false
  ...
  /// @brief Method SetGlobalTexture addr 0x2ceb924 size 0x78 virtual false final false
  inline void SetGlobalTexture(::StringW name, ::UnityEngine::Rendering::RenderTargetIdentifier value);

  /// @brief Method SetGlobalTexture addr 0x2ceb99c size 0x5c virtual false final false
  ...
  /// @brief Method Internal_DrawMesh_Injected addr 0x2cea100 size 0x84 virtual false final false
  ...
  /// @brief Method Blit_Identifier_Injected addr 0x2cea3e4 size 0x9c virtual false final false
  ...
  /// @brief Method SetGlobalVector_Injected addr 0x2cea90c size 0x54 virtual false final false
  inline void SetGlobalVector_Injected(int32_t nameID, ByRef<::UnityEngine::Vector4> value);

  /// @brief Method SetViewProjectionMatrices_Injected addr 0x2cea9b4 size 0x54 virtual false final false
  inline void SetViewProjectionMatrices_Injected(ByRef<::UnityEngine::Matrix4x4> view, ByRef<::UnityEngine::Matrix4x4> proj);

  /// @brief Method SetRenderTargetSingle_Internal_Injected addr 0x2ceabcc size 0x74 virtual false final false
