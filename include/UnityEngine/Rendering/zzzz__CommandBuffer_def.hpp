...
public:
  ...
  /// @brief Method Blit, addr 0x48c3ce0, size 0x8c, virtual false, abstract: false, final false
  inline void Blit(::UnityEngine::Rendering::RenderTargetIdentifier source, ::UnityEngine::Rendering::RenderTargetIdentifier dest);

  /// @brief Method Blit, addr 0x48c3d6c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit, addr 0x48c3dfc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit_Identifier, addr 0x48c28c4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Blit_Identifier_Injected, addr 0x48c2964, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x48c25c0, size 0x3c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CopyTexture, addr 0x48c3c4c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTexture_Internal, addr 0x48c27fc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x48c32c0, size 0x84, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x48c327c, size 0x44, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawMesh, addr 0x48c366c, size 0x38, virtual false, abstract: false, final false
  inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material);

  /// @brief Method DrawMesh, addr 0x48c3638, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMesh, addr 0x48c3608, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMesh, addr 0x48c338c, size 0x27c, virtual false, abstract: false, final false
  inline void DrawMesh(::UnityEngine::Mesh* mesh, ::UnityEngine::Matrix4x4 matrix, ::UnityEngine::Material* material, int32_t submeshIndex, int32_t shaderPass,
                       ::UnityEngine::MaterialPropertyBlock* properties);

  /// @brief Method DrawMeshInstanced, addr 0x48c38a8, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawRenderer, addr 0x48c36a4, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x48c31c0, size 0xbc, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetTemporaryRT, addr 0x48c2c0c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTemporaryRT, addr 0x48c2b68, size 0xa4, virtual false, abstract: false, final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format,
                             int32_t antiAliasing);

  /// @brief Method GetTemporaryRT, addr 0x48c2abc, size 0xac, virtual false, abstract: false, final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format,
                             int32_t antiAliasing, bool enableRandomWrite, ::UnityEngine::RenderTextureMemoryless memorylessMode);

  /// @brief Method GetTemporaryRT, addr 0x48c2a00, size 0xbc, virtual false, abstract: false, final false
  inline void GetTemporaryRT(int32_t nameID, int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::FilterMode filter, ::UnityEngine::Experimental::Rendering::GraphicsFormat format,
                             int32_t antiAliasing, bool enableRandomWrite, ::UnityEngine::RenderTextureMemoryless memorylessMode, bool useDynamicScale);

  /// @brief Method GetTemporaryRT, addr 0x48c2cac, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method InitBuffer, addr 0x48c2518, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr InitBuffer();

  /// @brief Method Internal_DrawMesh, addr 0x48c25fc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawMeshInstanced, addr 0x48c2770, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawMesh_Injected, addr 0x48c2680, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_DrawRenderer, addr 0x48c2704, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseBuffer, addr 0x48c2540, size 0x3c, virtual false, abstract: false, final false
  inline void ReleaseBuffer();

  /// @brief Method ReleaseTemporaryRT, addr 0x48c2d98, size 0x44, virtual false, abstract: false, final false
  inline void ReleaseTemporaryRT(int32_t nameID);

  /// @brief Method SetGlobalFloat, addr 0x48c2ddc, size 0x54, virtual false, abstract: false, final false
  inline void SetGlobalFloat(int32_t nameID, float_t value);

  /// @brief Method SetGlobalTexture, addr 0x48c3e98, size 0x78, virtual false, abstract: false, final false
  inline void SetGlobalTexture(::StringW name, ::UnityEngine::Rendering::RenderTargetIdentifier value);

  /// @brief Method SetGlobalTexture, addr 0x48c3f10, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGlobalTexture_Impl, addr 0x48c2fdc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGlobalVector, addr 0x48c2e30, size 0x5c, virtual false, abstract: false, final false
  inline void SetGlobalVector(int32_t nameID, ::UnityEngine::Vector4 value);

  /// @brief Method SetGlobalVector_Injected, addr 0x48c2e8c, size 0x54, virtual false, abstract: false, final false
  inline void SetGlobalVector_Injected(int32_t nameID, ::ByRef<::UnityEngine::Vector4> value);

  /// @brief Method SetRenderTarget, addr 0x48c3038, size 0xa0, virtual false, abstract: false, final false
  inline void SetRenderTarget(::UnityEngine::Rendering::RenderTargetIdentifier rt);

  /// @brief Method SetRenderTargetSingle_Internal, addr 0x48c30d8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRenderTargetSingle_Internal_Injected, addr 0x48c314c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewProjectionMatrices, addr 0x48c2ee0, size 0x54, virtual false, abstract: false, final false
  inline void SetViewProjectionMatrices(::UnityEngine::Matrix4x4 view, ::UnityEngine::Matrix4x4 proj);

  /// @brief Method SetViewProjectionMatrices_Injected, addr 0x48c2f34, size 0x54, virtual false, abstract: false, final false
  inline void SetViewProjectionMatrices_Injected(::ByRef<::UnityEngine::Matrix4x4> view, ::ByRef<::UnityEngine::Matrix4x4> proj);

  /// @brief Method ValidateAgainstExecutionFlags, addr 0x48c2f88, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48c3344, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_name, addr 0x48c257c, size 0x44, virtual false, abstract: false, final false
