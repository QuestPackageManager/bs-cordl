...
public:
  ...
  /// @brief Method Pack, addr 0x6649d58, size 0x12c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x6649f68, size 0x68, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method GetFlatIdxForEntry, addr 0x6649950, size 0x30, virtual false, abstract: false, final false
  inline int32_t GetFlatIdxForEntry(::UnityEngine::Vector3Int entryPosition);

  /// @brief Method GetFlatIndex, addr 0x6649768, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetFlatIndex(::UnityEngine::Vector3Int normalizedPos);

  /// @brief Method GetFlatIndicesForCell, addr 0x6649980, size 0x140, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetFlatIndicesForCell(::UnityEngine::Vector3Int cellPosition);

  /// @brief Method GetGlobalIndirectionDimension, addr 0x6649714, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3Int GetGlobalIndirectionDimension();

  /// @brief Method GetGlobalIndirectionMinEntry, addr 0x6649724, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3Int GetGlobalIndirectionMinEntry();

  /// @brief Method GetMinMaxEntry, addr 0x66496f0, size 0x24, virtual false, abstract: false, final false
  inline void GetMinMaxEntry(::ByRef<::UnityEngine::Vector3Int> minEntry, ::ByRef<::UnityEngine::Vector3Int> maxEntry);

  /// @brief Method GetRuntimeResources, addr 0x6649f34, size 0x34, virtual false, abstract: false, final false
  inline void GetRuntimeResources(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources> rr);

  /// @brief Method MarkEntriesAsUnloaded, addr 0x6649e84, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method PushComputeData, addr 0x6649f08, size 0x2c, virtual false, abstract: false, final false
  inline void PushComputeData();

  /// @brief Method UpdateCell, addr 0x6649ac0, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6649780, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3Int cellMin, ::UnityEngine::Vector3Int cellMax, int32_t cellSizeInMinBricks);

  /// @brief Method get_entriesPerCellDimension, addr 0x6649748, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_entriesPerCellDimension();

  /// @brief Method get_entrySizeInBricks, addr 0x6649734, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_entrySizeInBricks();

  /// @brief Method get_estimatedVMemCost, addr 0x66496e0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_estimatedVMemCost();

  /// @brief Method set_estimatedVMemCost, addr 0x66496e8, size 0x8, virtual false, abstract: false, final false
