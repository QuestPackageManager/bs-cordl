...
// Ctor Parameters [CppParam { name: "transformUpdateFlags", ty: "::UnityEngine::Rendering::TransformUpdateFlags", modifiers: "", def_value: Some("{}") }, CppParam { name: "instanceFlags", ty: "::UnityEngine::Rendering::InstanceFlags", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::CPUSharedInstanceFlags::CPUSharedInstanceFlags(::UnityEngine::Rendering::TransformUpdateFlags  transformUpdateFlags, ::UnityEngine::Rendering::InstanceFlags  instanceFlags) noexcept  {
