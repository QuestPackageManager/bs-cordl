...
// Ctor Parameters [CppParam { name: "transformUpdateFlags", ty: "::UnityEngine::Rendering::TransformUpdateFlags", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "instanceFlags", ty: "::UnityEngine::Rendering::InstanceFlags", modifiers: "", def_value: Some("{}"), comment: None }]
