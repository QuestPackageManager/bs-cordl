...
public:
  ...
  /// @brief Method Dispose, addr 0x66d1624, size 0xf4, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x66d1554, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
