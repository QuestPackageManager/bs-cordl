...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DebugRendererBatcherStats", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DebugRendererBatcherStats(DebugRendererBatcherStats&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DebugRendererBatcherStats", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DebugRendererBatcherStats(DebugRendererBatcherStatsconst&) = delete;
