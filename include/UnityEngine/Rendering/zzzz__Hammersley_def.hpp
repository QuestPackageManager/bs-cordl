...
public:
  ...
  /// @brief Method BindConstants, addr 0x665ee40, size 0x15c, virtual false, abstract: false, final false
  static inline void BindConstants(::UnityEngine::Rendering::CommandBuffer* cmd, ::UnityEngine::ComputeShader* cs);

  /// @brief Method Initialize, addr 0x665ead0, size 0x370, virtual false, abstract: false, final false
