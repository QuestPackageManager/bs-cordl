...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x6689308, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66892a4, size 0x64, virtual false, abstract: false, final false
