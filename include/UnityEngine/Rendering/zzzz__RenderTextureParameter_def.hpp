...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x67c858c, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c8528, size 0x64, virtual false, abstract: false, final false
