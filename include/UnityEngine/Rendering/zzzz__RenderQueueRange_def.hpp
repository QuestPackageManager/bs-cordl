...
public:
  ...
  /// @brief Method Equals, addr 0x69cbafc, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c8f4c, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RenderQueueRange other);

  /// @brief Method GetHashCode, addr 0x69c9098, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method get_all, addr 0x69c8e3c, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderQueueRange get_all();

  /// @brief Method get_lowerBound, addr 0x69cbaec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lowerBound();

  /// @brief Method get_opaque, addr 0x69cbad8, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderQueueRange get_opaque();

  /// @brief Method get_transparent, addr 0x69cbae0, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderQueueRange get_transparent();

  /// @brief Method get_upperBound, addr 0x69cbaf4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x69cbbbc, size 0x68, virtual false, abstract: false, final false
