...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x65f7f64, size 0x88, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::UnityEngine::Vector2Int  size, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x65f7fec, size 0x24, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2Int EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x65f7f50, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65f7ee4, size 0x6c, virtual false, abstract: false, final false
