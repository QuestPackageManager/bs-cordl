...
public:
  ...
  /// @brief Method Equals, addr 0x69d1144, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69d0e58, size 0x2ec, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::VisibleLight other);

  /// @brief Method GetHashCode, addr 0x69d11d8, size 0xf8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_finalColor, addr 0x69d0e20, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_finalColor();

  /// @brief Method get_light, addr 0x69d0d84, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Light> get_light();

  /// @brief Method get_lightType, addr 0x69d0e18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LightType get_lightType();

  /// @brief Method get_localToWorldMatrix, addr 0x69d0e2c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix();

  /// @brief Method get_range, addr 0x69d0e48, size 0x8, virtual false, abstract: false, final false
  inline float_t get_range();

  /// @brief Method get_spotAngle, addr 0x69d0e50, size 0x8, virtual false, abstract: false, final false
