...
/// @brief Method Equals, addr 0x695eefc, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x695ec10, size 0x2ec, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::VisibleLight  other) ;

/// @brief Method GetHashCode, addr 0x695ef90, size 0xf8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_finalColor, addr 0x695ebd8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_finalColor() ;

/// @brief Method get_light, addr 0x695eb3c, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Light> get_light() ;

/// @brief Method get_lightType, addr 0x695ebd0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LightType get_lightType() ;

/// @brief Method get_localToWorldMatrix, addr 0x695ebe4, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_range, addr 0x695ec00, size 0x8, virtual false, abstract: false, final false
inline float_t get_range() ;

/// @brief Method get_spotAngle, addr 0x695ec08, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_LightType", ty: "::UnityEngine::LightType", modifiers: "", def_value: None }, CppParam { name: "m_FinalColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "m_ScreenRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "m_LocalToWorldMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "m_Range", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_SpotAngle", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_InstanceId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::Rendering::VisibleLightFlags", modifiers: "", def_value: None }]
constexpr VisibleLight(::UnityEngine::LightType  m_LightType, ::UnityEngine::Color  m_FinalColor, ::UnityEngine::Rect  m_ScreenRect, ::UnityEngine::Matrix4x4  m_LocalToWorldMatrix, float_t  m_Range, float_t  m_SpotAngle, int32_t  m_InstanceId, ::UnityEngine::Rendering::VisibleLightFlags  m_Flags) noexcept;
