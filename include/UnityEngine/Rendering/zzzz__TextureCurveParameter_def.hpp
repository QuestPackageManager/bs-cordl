...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextureCurveParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextureCurveParameter(TextureCurveParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextureCurveParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextureCurveParameter(TextureCurveParameterconst&) = delete;
