...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DynamicString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DynamicString(DynamicString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DynamicString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DynamicString(DynamicStringconst&) = delete;
