...
public:
  ...
  /// @brief Method .ctor, addr 0x67cca5c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67cca40, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x67cca48, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MaxIntParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MaxIntParameter(MaxIntParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MaxIntParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MaxIntParameter(MaxIntParameterconst&) = delete;
