...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x681fc68, size 0x4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x681e938, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Grow, addr 0x681eb64, size 0x4, virtual true, abstract: false, final true
  inline void Grow(int32_t newCapacity);

  /// @brief Method Initialize, addr 0x681e81c, size 0x4, virtual true, abstract: false, final true
  inline void Initialize(int32_t initCapacity);

  /// @brief Method Remove, addr 0x681f494, size 0x4, virtual true, abstract: false, final true
  inline void Remove(int32_t index, int32_t lastIndex);

  /// @brief Method SetDefault, addr 0x681f56c, size 0x4, virtual true, abstract: false, final true
