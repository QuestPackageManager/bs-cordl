...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SubviewOcclusionTest, "UnityEngine.Rendering", "SubviewOcclusionTest");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::SubviewOcclusionTest) == 0x8, "Size mismatch!");
