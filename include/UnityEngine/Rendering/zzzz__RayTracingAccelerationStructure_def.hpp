...
public:
  ...
  /// @brief Method .ctor, addr 0x6940320, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_buildFlags, addr 0x694030c, size 0x8, virtual false, abstract: false, final false
  inline void set_buildFlags(::UnityEngine::Rendering::RayTracingAccelerationStructureBuildFlags value);

  /// @brief Method set_relativeOrigin, addr 0x6940314, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6940380, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Destroy, addr 0x6940288, size 0x48, virtual false, abstract: false, final false
  static inline void Destroy(::UnityEngine::Rendering::RayTracingAccelerationStructure* accelStruct);

  /// @brief Method Destroy_Injected, addr 0x69402d0, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy_Injected(::System::IntPtr accelStruct);

  /// @brief Method Dispose, addr 0x6940198, size 0x98, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6940230, size 0x58, virtual false, abstract: false, final false
