...
public:
// Declarations
/// @brief Method Internal_SwitchIntoFastMemory, addr 0x69517b0, size 0xc8, virtual false, abstract: false, final false
static inline void Internal_SwitchIntoFastMemory(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<::UnityEngine::Rendering::RenderTargetIdentifier>  rt, ::UnityEngine::Rendering::FastMemoryFlags  fastMemoryFlags, float_t  residency, bool  copyContents) ;

/// @brief Method Internal_SwitchIntoFastMemory_Injected, addr 0x6951878, size 0x6c, virtual false, abstract: false, final false
static inline void Internal_SwitchIntoFastMemory_Injected(::System::IntPtr  cmd, ::ByRef<::UnityEngine::Rendering::RenderTargetIdentifier>  rt, ::UnityEngine::Rendering::FastMemoryFlags  fastMemoryFlags, float_t  residency, bool  copyContents) ;

/// @brief Method Internal_SwitchOutOfFastMemory, addr 0x69518e4, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method Internal_SwitchOutOfFastMemory_Injected, addr 0x695198c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SwitchIntoFastMemory, addr 0x69519e0, size 0x4, virtual false, abstract: false, final false
static inline void SwitchIntoFastMemory(::UnityEngine::Rendering::CommandBuffer*  cmd, ::UnityEngine::Rendering::RenderTargetIdentifier  rid, ::UnityEngine::Rendering::FastMemoryFlags  fastMemoryFlags, float_t  residency, bool  copyContents) ;

/// @brief Method SwitchOutOfFastMemory, addr 0x69519e4, size 0x4, virtual false, abstract: false, final false
