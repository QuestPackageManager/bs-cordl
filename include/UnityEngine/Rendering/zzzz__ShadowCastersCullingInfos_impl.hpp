...
// Ctor Parameters [CppParam { name: "splitBuffer", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::ShadowSplitData>", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "perLightInfos", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::LightShadowCasterCullingInfo>", modifiers: "", def_value: Some("{}"), comment: None }]
