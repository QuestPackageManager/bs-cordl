...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ShaderDebugPrintInputProducer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ShaderDebugPrintInputProducer(ShaderDebugPrintInputProducer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ShaderDebugPrintInputProducer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ShaderDebugPrintInputProducer(ShaderDebugPrintInputProducerconst&) = delete;
