...
public:
  ...
  /// @brief Method Equals, addr 0x69cff14, size 0x100, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69cfa48, size 0x178, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::ShadowSplitData other);

  /// @brief Method GetCullingPlane, addr 0x69cfdcc, size 0x148, virtual false, abstract: false, final false
  inline ::UnityEngine::Plane GetCullingPlane(int32_t index);

  /// @brief Method GetHashCode, addr 0x69cfd3c, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline int32_t getStaticF_maximumCullingPlaneCount();

  /// @brief Method get_cullingPlaneCount, addr 0x69cfdb8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cullingPlaneCount();

  /// @brief Method get_cullingSphere, addr 0x69cfdc0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_shadowCascadeBlendCullingFactor, addr 0x69cf804, size 0xd4, virtual false, abstract: false, final false
