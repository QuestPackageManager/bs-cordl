...
/// @brief Method Equals, addr 0x695dccc, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x695d800, size 0x178, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ShadowSplitData  other) ;

/// @brief Method GetCullingPlane, addr 0x695db84, size 0x148, virtual false, abstract: false, final false
inline ::UnityEngine::Plane GetCullingPlane(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x695daf4, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline int32_t getStaticF_maximumCullingPlaneCount() ;

/// @brief Method get_cullingPlaneCount, addr 0x695db70, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cullingPlaneCount() ;

/// @brief Method get_cullingSphere, addr 0x695db78, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_shadowCascadeBlendCullingFactor, addr 0x695d5bc, size 0xd4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_CullingPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingPlanes", ty: "::UnityEngine::Rendering::ShadowSplitData__m_CullingPlanes_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_CullingSphere", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "m_ShadowCascadeBlendCullingFactor", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingNearPlane", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_CullingMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }]
constexpr ShadowSplitData(int32_t  m_CullingPlaneCount, ::UnityEngine::Rendering::ShadowSplitData__m_CullingPlanes_e__FixedBuffer  m_CullingPlanes, ::UnityEngine::Vector4  m_CullingSphere, float_t  m_ShadowCascadeBlendCullingFactor, float_t  m_CullingNearPlane, ::UnityEngine::Matrix4x4  m_CullingMatrix) noexcept;
