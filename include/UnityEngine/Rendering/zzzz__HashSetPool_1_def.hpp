...
MARK_GEN_REF_PTR_T(::UnityEngine::Rendering::HashSetPool_1___c);
...
public:
  ...
  /// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::HashSet_1<T>*> Get(::ByRef<::System::Collections::Generic::HashSet_1<T>*> value);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::Rendering::HashSetPool_1___c, "UnityEngine.Rendering", "HashSetPool`1/<>c");
