...
public:
  ...
  /// @brief Method UnityEngine.Rendering.IRenderPipelineGraphicsSettings.get_version, addr 0x66d1718, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66d1b58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_debugOccluderPS, addr 0x66d1ae0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_debugOccluderPS();

  /// @brief Method get_debugOcclusionTestPS, addr 0x66d1a68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_debugOcclusionTestPS();

  /// @brief Method get_instanceDataBufferCopyKernels, addr 0x66d1720, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_instanceDataBufferCopyKernels();

  /// @brief Method get_instanceDataBufferUploadKernels, addr 0x66d1798, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_instanceDataBufferUploadKernels();

  /// @brief Method get_instanceOcclusionCullingKernels, addr 0x66d1978, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_instanceOcclusionCullingKernels();

  /// @brief Method get_occluderDepthPyramidKernels, addr 0x66d1900, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_occluderDepthPyramidKernels();

  /// @brief Method get_occlusionCullingDebugKernels, addr 0x66d19f0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_occlusionCullingDebugKernels();

  /// @brief Method get_transformUpdaterKernels, addr 0x66d1810, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ComputeShader> get_transformUpdaterKernels();

  /// @brief Method get_windDataUpdaterKernels, addr 0x66d1888, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_debugOccluderPS, addr 0x66d1ae8, size 0x70, virtual false, abstract: false, final false
  inline void set_debugOccluderPS(::UnityEngine::Shader* value);

  /// @brief Method set_debugOcclusionTestPS, addr 0x66d1a70, size 0x70, virtual false, abstract: false, final false
  inline void set_debugOcclusionTestPS(::UnityEngine::Shader* value);

  /// @brief Method set_instanceDataBufferCopyKernels, addr 0x66d1728, size 0x70, virtual false, abstract: false, final false
  inline void set_instanceDataBufferCopyKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_instanceDataBufferUploadKernels, addr 0x66d17a0, size 0x70, virtual false, abstract: false, final false
  inline void set_instanceDataBufferUploadKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_instanceOcclusionCullingKernels, addr 0x66d1980, size 0x70, virtual false, abstract: false, final false
  inline void set_instanceOcclusionCullingKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_occluderDepthPyramidKernels, addr 0x66d1908, size 0x70, virtual false, abstract: false, final false
  inline void set_occluderDepthPyramidKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_occlusionCullingDebugKernels, addr 0x66d19f8, size 0x70, virtual false, abstract: false, final false
  inline void set_occlusionCullingDebugKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_transformUpdaterKernels, addr 0x66d1818, size 0x70, virtual false, abstract: false, final false
  inline void set_transformUpdaterKernels(::UnityEngine::ComputeShader* value);

  /// @brief Method set_windDataUpdaterKernels, addr 0x66d1890, size 0x70, virtual false, abstract: false, final false
