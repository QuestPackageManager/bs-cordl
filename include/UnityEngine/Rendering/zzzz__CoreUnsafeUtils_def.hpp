...
/// @brief Method Clear, addr 0x65a08e4, size 0x50, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method TryPop, addr 0x65a09b0, size 0x60, virtual false, abstract: false, final false
inline bool TryPop(::ByRef<::StringW>  v) ;

/// @brief Method TryPush, addr 0x65a0934, size 0x7c, virtual false, abstract: false, final false
inline bool TryPush(::StringW  v) ;

/// @brief Method .ctor, addr 0x65a088c, size 0x58, virtual false, abstract: false, final false
inline void _ctor(uint8_t*  ptr, int32_t  length) ;

/// @brief Method get_Count, addr 0x65a087c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method set_Count, addr 0x65a0884, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x65a0a10, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Get, addr 0x65a0a18, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method CalculateRadixParams, addr 0x659fbdc, size 0x10, virtual false, abstract: false, final false
static inline void CalculateRadixParams(int32_t  radixBits, ::ByRef<int32_t>  bitStates) ;

/// @brief Method CalculateRadixSortSupportArrays, addr 0x659fbf8, size 0x20, virtual false, abstract: false, final false
static inline void CalculateRadixSortSupportArrays(int32_t  bitStates, int32_t  arrayLength, uint32_t*  supportArray, ::ByRef<uint32_t*>  bucketIndices, ::ByRef<uint32_t*>  bucketSizes, ::ByRef<uint32_t*>  bucketPrefix, ::ByRef<uint32_t*>  arrayOutput) ;

/// @brief Method CalculateRadixSupportSize, addr 0x659fbec, size 0xc, virtual false, abstract: false, final false
static inline int32_t CalculateRadixSupportSize(int32_t  bitStates, int32_t  arrayLength) ;

/// @brief Method CombineHashes, addr 0x65a06c0, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method CompareHashes, addr 0x65a0618, size 0xa8, virtual false, abstract: false, final false
static inline int32_t CompareHashes(int32_t  oldHashCount, ::UnityEngine::Hash128*  oldHashes, int32_t  newHashCount, ::UnityEngine::Hash128*  newHashes, int32_t*  addIndices, int32_t*  removeIndices, ::ByRef<int32_t>  addCount, ::ByRef<int32_t>  remCount) ;
...
static inline int32_t CompareHashes(int32_t  oldHashCount, void*  oldHashes, int32_t  newHashCount, void*  newHashes, int32_t*  addIndices, int32_t*  removeIndices, ::ByRef<int32_t>  addCount, ::ByRef<int32_t>  remCount) ;

/// @brief Method CopyTo, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyTo(::ArrayW<T,::Array<T>*>  list, void*  dest, int32_t  count) ;

/// @brief Method CopyTo, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CopyTo(::System::Collections::Generic::List_1<T>*  list, void*  dest, int32_t  count) ;

/// @brief Method HaveDuplicates, addr 0x65a0724, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method InsertionSort, addr 0x659ffc0, size 0x94, virtual false, abstract: false, final false
static inline void InsertionSort(::ArrayW<uint32_t,::Array<uint32_t>*>  arr, int32_t  sortSize) ;

/// @brief Method InsertionSort, addr 0x65a0054, size 0xb0, virtual false, abstract: false, final false
static inline void InsertionSort(::Unity::Collections::NativeArray_1<uint32_t>  arr, int32_t  sortSize) ;

/// @brief Method InsertionSort, addr 0x659ff60, size 0x60, virtual false, abstract: false, final false
static inline void InsertionSort(uint32_t*  arr, int32_t  length) ;

/// @brief Method MergeSort, addr 0x659fd4c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method MergeSort, addr 0x659fe5c, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method MergeSort, addr 0x659fc18, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method QuickSort, addr 0x65a0520, size 0x7c, virtual false, abstract: false, final false
static inline void QuickSort(::ArrayW<uint32_t,::Array<uint32_t>*>  arr, int32_t  left, int32_t  right) ;

/// @brief Method QuickSort, addr 0x65a059c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method RadixSort, addr 0x65a02bc, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method RadixSort, addr 0x65a03f8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method RadixSort, addr 0x65a0104, size 0x1b8, virtual false, abstract: false, final false
