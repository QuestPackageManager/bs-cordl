...
public:
  ...
  /// @brief Method Clear, addr 0x66128f0, size 0x50, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method TryPop, addr 0x66129bc, size 0x60, virtual false, abstract: false, final false
  inline bool TryPop(::ByRef<::StringW> v);

  /// @brief Method TryPush, addr 0x6612940, size 0x7c, virtual false, abstract: false, final false
  inline bool TryPush(::StringW v);

  /// @brief Method .ctor, addr 0x6612898, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(uint8_t* ptr, int32_t length);

  /// @brief Method get_Count, addr 0x6612888, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method set_Count, addr 0x6612890, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Get, addr 0x6612a1c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Get, addr 0x6612a24, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CalculateRadixParams, addr 0x6611be8, size 0x10, virtual false, abstract: false, final false
  static inline void CalculateRadixParams(int32_t radixBits, ::ByRef<int32_t> bitStates);

  /// @brief Method CalculateRadixSortSupportArrays, addr 0x6611c04, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateRadixSupportSize, addr 0x6611bf8, size 0xc, virtual false, abstract: false, final false
  static inline int32_t CalculateRadixSupportSize(int32_t bitStates, int32_t arrayLength);

  /// @brief Method CombineHashes, addr 0x66126cc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareHashes, addr 0x6612624, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method HaveDuplicates, addr 0x6612730, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertionSort, addr 0x6611fcc, size 0x94, virtual false, abstract: false, final false
  static inline void InsertionSort(::ArrayW<uint32_t, ::Array<uint32_t>*> arr, int32_t sortSize);

  /// @brief Method InsertionSort, addr 0x6612060, size 0xb0, virtual false, abstract: false, final false
  static inline void InsertionSort(::Unity::Collections::NativeArray_1<uint32_t> arr, int32_t sortSize);

  /// @brief Method InsertionSort, addr 0x6611f6c, size 0x60, virtual false, abstract: false, final false
  static inline void InsertionSort(uint32_t* arr, int32_t length);

  /// @brief Method MergeSort, addr 0x6611d58, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeSort, addr 0x6611e68, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeSort, addr 0x6611c24, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method QuickSort, addr 0x661252c, size 0x7c, virtual false, abstract: false, final false
  static inline void QuickSort(::ArrayW<uint32_t, ::Array<uint32_t>*> arr, int32_t left, int32_t right);

  /// @brief Method QuickSort, addr 0x66125a8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RadixSort, addr 0x66122c8, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method RadixSort, addr 0x6612404, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method RadixSort, addr 0x6612110, size 0x1b8, virtual false, abstract: false, final false
