...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::MaterialParameter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::MaterialParameter*, "UnityEngine.Rendering", "MaterialParameter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x67ce560, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MaterialParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MaterialParameter(MaterialParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MaterialParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MaterialParameter(MaterialParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::MaterialParameter) == 0x20, "Size mismatch!");
