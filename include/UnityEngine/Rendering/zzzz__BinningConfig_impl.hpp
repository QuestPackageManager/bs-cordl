...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Rendering::BinningConfig::*)()>(&::UnityEngine::Rendering::BinningConfig::get_visibilityConfigCount)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x6660208;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::BinningConfig>::get(),
