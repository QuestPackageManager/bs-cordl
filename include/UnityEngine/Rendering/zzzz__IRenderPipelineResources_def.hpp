...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IRenderPipelineResources*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IRenderPipelineResources*, "UnityEngine.Rendering", "IRenderPipelineResources");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRenderPipelineResources", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRenderPipelineResources(IRenderPipelineResourcesconst&) = delete;
