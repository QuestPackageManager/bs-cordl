...
public:
  ...
  /// @brief Method .ctor, addr 0x67ccaa0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t max, bool overrideState);

  /// @brief Method get_value, addr 0x67cca84, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x67cca8c, size 0x14, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMaxIntParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInterpMaxIntParameter(NoInterpMaxIntParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInterpMaxIntParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInterpMaxIntParameter(NoInterpMaxIntParameterconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::NoInterpMaxIntParameter) == 0x20, "Size mismatch!");
