...
// Ctor Parameters [CppParam { name: "sphereCenter", ty: "::UnityEngine::Vector3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sphereRadius", ty: "float_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "cullingPlaneOffset", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "cullingPlaneCount", ty:
// "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "cascadeBlendCullingFactor", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "nearPlane", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "cullingMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"),
// comment: None }]
