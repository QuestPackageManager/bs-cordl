...
public:
  ...
  /// @brief Method Equals, addr 0x6b2553c, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b25518, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SortingLayerRange other);

  /// @brief Method GetHashCode, addr 0x6b255c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_all, addr 0x6b1e2f8, size 0x8, virtual false, abstract: false, final false
