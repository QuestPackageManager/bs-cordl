...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::SortingLayerRange, "UnityEngine.Rendering", "SortingLayerRange");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
public:
  ...
  /// @brief Method Equals, addr 0x6b28ac4, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b28aa0, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::SortingLayerRange other);

  /// @brief Method GetHashCode, addr 0x6b28b4c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_all, addr 0x6b21880, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::SortingLayerRange) == 0x4, "Size mismatch!");
