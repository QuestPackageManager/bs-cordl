...
public:
  ...
  /// @brief Method BeginCameraRendering, addr 0x69c9634, size 0x94, virtual false, abstract: false, final false
  static inline void BeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method BeginContextRendering, addr 0x69c94d4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupRenderPipeline, addr 0x69c9ee4, size 0x1c4, virtual false, abstract: false, final false
  static inline void CleanupRenderPipeline();

  /// @brief Method DoRenderLoop_Internal, addr 0x69cb3c4, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method EndCameraRendering, addr 0x69c9894, size 0x94, virtual false, abstract: false, final false
  static inline void EndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method EndContextRendering, addr 0x69c9730, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentPipelineAssetType, addr 0x69cb368, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetCurrentPipelineAssetType();

  /// @brief Method HandleRenderPipelineChange, addr 0x69cb1cc, size 0x90, virtual false, abstract: false, final false
  static inline void HandleRenderPipelineChange(::UnityEngine::Rendering::RenderPipelineAsset* pipelineAsset);

  /// @brief Method IsPipelineRequireCreation, addr 0x69cb904, size 0x164, virtual false, abstract: false, final false
  static inline bool IsPipelineRequireCreation();

  /// @brief Method OnActiveRenderPipelineAssetChanged, addr 0x69cb0b8, size 0x114, virtual false, abstract: false, final false
  static inline void OnActiveRenderPipelineAssetChanged(::UnityEngine::ScriptableObject* from, ::UnityEngine::ScriptableObject* to);

  /// @brief Method OnActiveRenderPipelineTypeChanged, addr 0x69cb040, size 0x78, virtual false, abstract: false, final false
  static inline void OnActiveRenderPipelineTypeChanged();

  /// @brief Method RecreateCurrentPipeline, addr 0x69c9dd4, size 0xc0, virtual false, abstract: false, final false
  static inline void RecreateCurrentPipeline(::UnityEngine::Rendering::RenderPipelineAsset* pipelineAsset);

  /// @brief Method TryPrepareRenderPipeline, addr 0x69cb6ec, size 0x140, virtual false, abstract: false, final false
  static inline bool TryPrepareRenderPipeline(::UnityEngine::Rendering::RenderPipelineAsset* pipelineAsset);

  /// @brief Method add_beginCameraRendering, addr 0x69cac20, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_beginContextRendering, addr 0x69ca800, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_endCameraRendering, addr 0x69cae30, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_endContextRendering, addr 0x69caa10, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentPipeline, addr 0x69ca6f8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderPipeline* get_currentPipeline();

  /// @brief Method get_isCurrentPipelineValid, addr 0x69cb25c, size 0xac, virtual false, abstract: false, final false
  static inline bool get_isCurrentPipelineValid();

  /// @brief Method remove_beginCameraRendering, addr 0x69cad28, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_beginContextRendering, addr 0x69ca908, size 0x108, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method remove_endCameraRendering, addr 0x69caf38, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_endContextRendering, addr 0x69cab18, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPipeline, addr 0x69ca754, size 0xac, virtual false, abstract: false, final false
