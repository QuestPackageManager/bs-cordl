...
/// @brief Method BeginCameraRendering, addr 0x69573ec, size 0x94, virtual false, abstract: false, final false
static inline void BeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method BeginContextRendering, addr 0x695728c, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method CleanupRenderPipeline, addr 0x6957c9c, size 0x1c4, virtual false, abstract: false, final false
static inline void CleanupRenderPipeline() ;

/// @brief Method DoRenderLoop_Internal, addr 0x695917c, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method EndCameraRendering, addr 0x695764c, size 0x94, virtual false, abstract: false, final false
static inline void EndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method EndContextRendering, addr 0x69574e8, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentPipelineAssetType, addr 0x6959120, size 0x5c, virtual false, abstract: false, final false
static inline ::StringW GetCurrentPipelineAssetType() ;

/// @brief Method HandleRenderPipelineChange, addr 0x6958f84, size 0x90, virtual false, abstract: false, final false
static inline void HandleRenderPipelineChange(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method IsPipelineRequireCreation, addr 0x69596bc, size 0x164, virtual false, abstract: false, final false
static inline bool IsPipelineRequireCreation() ;

/// @brief Method OnActiveRenderPipelineAssetChanged, addr 0x6958e70, size 0x114, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineAssetChanged(::UnityEngine::ScriptableObject*  from, ::UnityEngine::ScriptableObject*  to) ;

/// @brief Method OnActiveRenderPipelineTypeChanged, addr 0x6958df8, size 0x78, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineTypeChanged() ;

/// @brief Method RecreateCurrentPipeline, addr 0x6957b8c, size 0xc0, virtual false, abstract: false, final false
static inline void RecreateCurrentPipeline(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method TryPrepareRenderPipeline, addr 0x69594a4, size 0x140, virtual false, abstract: false, final false
static inline bool TryPrepareRenderPipeline(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method add_beginCameraRendering, addr 0x69589d8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method add_beginContextRendering, addr 0x69585b8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method add_endCameraRendering, addr 0x6958be8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method add_endContextRendering, addr 0x69587c8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method get_currentPipeline, addr 0x69584b0, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderPipeline* get_currentPipeline() ;

/// @brief Method get_isCurrentPipelineValid, addr 0x6959014, size 0xac, virtual false, abstract: false, final false
static inline bool get_isCurrentPipelineValid() ;

/// @brief Method remove_beginCameraRendering, addr 0x6958ae0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method remove_beginContextRendering, addr 0x69586c0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method remove_endCameraRendering, addr 0x6958cf0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method remove_endContextRendering, addr 0x69588d0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method set_currentPipeline, addr 0x695850c, size 0xac, virtual false, abstract: false, final false
