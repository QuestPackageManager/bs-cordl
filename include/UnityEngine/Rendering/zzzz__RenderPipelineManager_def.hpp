...
public:
  ...
  /// @brief Method CleanupRenderPipeline, addr 0x48d5348, size 0x1b4, virtual false, abstract: false, final false
  static inline void CleanupRenderPipeline();

  /// @brief Method DoRenderLoop_Internal, addr 0x48d5c1c, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentPipelineAssetType, addr 0x48d5bc4, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW GetCurrentPipelineAssetType();

  /// @brief Method HandleRenderPipelineChange, addr 0x48d5a64, size 0x80, virtual false, abstract: false, final false
  static inline void HandleRenderPipelineChange(::UnityEngine::Rendering::RenderPipelineAsset* pipelineAsset);

  /// @brief Method IsPipelineRequireCreation, addr 0x48d5f60, size 0x148, virtual false, abstract: false, final false
  static inline bool IsPipelineRequireCreation();

  /// @brief Method OnActiveRenderPipelineAssetChanged, addr 0x48d5958, size 0x10c, virtual false, abstract: false, final false
  static inline void OnActiveRenderPipelineAssetChanged(::UnityEngine::ScriptableObject* from, ::UnityEngine::ScriptableObject* to);

  /// @brief Method OnActiveRenderPipelineTypeChanged, addr 0x48d58e4, size 0x74, virtual false, abstract: false, final false
  static inline void OnActiveRenderPipelineTypeChanged();

  /// @brief Method PrepareRenderPipeline, addr 0x48d54fc, size 0xb4, virtual false, abstract: false, final false
  static inline void PrepareRenderPipeline(::UnityEngine::Rendering::RenderPipelineAsset* pipelineAsset);

  /// @brief Method add_beginCameraRendering, addr 0x48d56fc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentPipeline, addr 0x48d5604, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RenderPipeline* get_currentPipeline();

  /// @brief Method remove_beginCameraRendering, addr 0x48d57f0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPipeline, addr 0x48d565c, size 0xa0, virtual false, abstract: false, final false
