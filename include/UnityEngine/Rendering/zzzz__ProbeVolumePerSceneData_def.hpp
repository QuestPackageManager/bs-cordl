...
public:
  ...
  /// @brief Method Clear, addr 0x6651f34, size 0x18, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Initialize, addr 0x66522b8, size 0xc0, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::UnityEngine::Rendering::ProbeVolumePerSceneData* New_ctor();

  /// @brief Method OnDisable, addr 0x66521fc, size 0xb8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x665214c, size 0xb0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x66522b4, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method QueueSceneLoading, addr 0x665204c, size 0x100, virtual false, abstract: false, final false
  inline void QueueSceneLoading();

  /// @brief Method QueueSceneRemoval, addr 0x6651f4c, size 0x100, virtual false, abstract: false, final false
  inline void QueueSceneRemoval();

  /// @brief Method ResolveCellData, addr 0x6652378, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6652414, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakingSet, addr 0x6651f2c, size 0x8, virtual false, abstract: false, final false
