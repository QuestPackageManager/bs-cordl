...
/// @brief Method Clear, addr 0x65dff28, size 0x18, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Initialize, addr 0x65e02ac, size 0xc0, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::UnityEngine::Rendering::ProbeVolumePerSceneData* New_ctor() ;

/// @brief Method OnDisable, addr 0x65e01f0, size 0xb8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x65e0140, size 0xb0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x65e02a8, size 0x4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method QueueSceneLoading, addr 0x65e0040, size 0x100, virtual false, abstract: false, final false
inline void QueueSceneLoading() ;

/// @brief Method QueueSceneRemoval, addr 0x65dff40, size 0x100, virtual false, abstract: false, final false
inline void QueueSceneRemoval() ;

/// @brief Method ResolveCellData, addr 0x65e036c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65e0408, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakingSet, addr 0x65dff20, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::ProbeVolumePerSceneData_ObsoleteSerializablePerScenarioDataItem, "UnityEngine.Rendering", "ProbeVolumePerSceneData/ObsoleteSerializablePerScenarioDataItem");
