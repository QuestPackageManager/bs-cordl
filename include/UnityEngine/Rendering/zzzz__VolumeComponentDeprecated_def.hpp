...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VolumeComponentDeprecated", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VolumeComponentDeprecated(VolumeComponentDeprecated&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VolumeComponentDeprecated", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VolumeComponentDeprecated(VolumeComponentDeprecatedconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::VolumeComponentDeprecated) == 0x10, "Size mismatch!");
