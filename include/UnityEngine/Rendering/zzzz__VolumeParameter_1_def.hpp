...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VolumeParameter_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VolumeParameter_1(VolumeParameter_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VolumeParameter_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VolumeParameter_1(VolumeParameter_1const&) = delete;
