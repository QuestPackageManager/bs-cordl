...
public:
  // Declarations
  /// @brief Method Interp, addr 0x6688aec, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6688a6c, size 0x80, virtual false, abstract: false, final false
