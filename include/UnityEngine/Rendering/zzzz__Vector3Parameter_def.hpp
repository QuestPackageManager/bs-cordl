...
public:
  // Declarations
  /// @brief Method Interp, addr 0x67cd588, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cd508, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Vector3Parameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Vector3Parameter(Vector3Parameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Vector3Parameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Vector3Parameter(Vector3Parameterconst&) = delete;
