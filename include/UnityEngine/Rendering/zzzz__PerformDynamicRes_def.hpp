...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6612aa8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x6612ac4, size 0x24, virtual true, abstract: false, final false
  inline float_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6612a94, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6612a2c, size 0x68, virtual false, abstract: false, final false
