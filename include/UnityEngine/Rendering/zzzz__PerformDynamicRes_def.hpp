...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PerformDynamicRes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PerformDynamicRes(PerformDynamicRes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PerformDynamicRes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PerformDynamicRes(PerformDynamicResconst&) = delete;
