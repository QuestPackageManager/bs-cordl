...
// Ctor Parameters [CppParam { name: "flags", ty: "::UnityEngine::Rendering::BatchDrawCommandFlags", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "batchID", ty:
// "::UnityEngine::Rendering::BatchID", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "materialID", ty: "::UnityEngine::Rendering::BatchMaterialID", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "splitVisibilityMask", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "lightmapIndex", ty: "uint16_t",
...
// ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "topology", ty: "::UnityEngine::MeshTopology", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "indexBufferHandle", ty: "::UnityEngine::GraphicsBufferHandle", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "visibleInstancesBufferHandle", ty:
// "::UnityEngine::GraphicsBufferHandle", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "visibleInstancesBufferWindowOffset", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "visibleInstancesBufferWindowSizeBytes", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "indirectArgsBufferHandle", ty: "::UnityEngine::GraphicsBufferHandle", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indirectArgsBufferOffset", ty: "uint32_t", modifiers:
