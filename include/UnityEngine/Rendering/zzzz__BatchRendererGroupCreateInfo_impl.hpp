...
// Ctor Parameters [CppParam { name: "cullingCallback", ty: "::UnityEngine::Rendering::BatchRendererGroup_OnPerformCulling*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "finishedCullingCallback", ty: "::UnityEngine::Rendering::BatchRendererGroup_OnFinishedCulling*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "userContext", ty:
