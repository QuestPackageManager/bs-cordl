...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::IRasterCommandBuffer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::IRasterCommandBuffer*, "UnityEngine.Rendering", "IRasterCommandBuffer");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: false
...
public:
  ...
  /// @brief Method ClearRenderTarget, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method ConfigureFoveatedRendering, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void ConfigureFoveatedRendering(::System::IntPtr platformData);

  /// @brief Method DrawMesh, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawMeshInstanced, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawMeshInstancedIndirect, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawMeshInstancedProcedural, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawMultipleMeshes, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawOcclusionMesh, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void DrawOcclusionMesh(::UnityEngine::RectInt normalizedCamViewport);

  /// @brief Method DrawProcedural, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawProceduralIndirect, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawRenderer, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method DrawRendererList, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void DrawRendererList(::UnityEngine::Rendering::RendererList rendererList);

  /// @brief Method SetFoveatedRenderingMode, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRasterCommandBuffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRasterCommandBuffer(IRasterCommandBufferconst&) = delete;
