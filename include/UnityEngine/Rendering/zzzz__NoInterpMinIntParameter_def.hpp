...
public:
  ...
  /// @brief Method .ctor, addr 0x6687f2c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t value, int32_t min, bool overrideState);

  /// @brief Method get_value, addr 0x6687f10, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_value, addr 0x6687f18, size 0x14, virtual true, abstract: false, final false
