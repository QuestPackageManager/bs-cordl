...
#include "UnityEngine/Rendering/zzzz__IDebugDisplaySettings_impl.hpp"
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::UnityEngine::Rendering::IDebugDisplaySettings*> && ::cordl_internals::default_constructor_constraint<T>)
inline bool UnityEngine::Rendering::DebugDisplaySettings_1<T>::TryGetScreenClearColor(::by_ref<::UnityEngine::Color> color) {
  auto* ___internal_method =
