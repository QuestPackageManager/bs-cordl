...
public:
  ...
  __declspec(property(get = __cordl_internal_get_displayNames, put = __cordl_internal_set_displayNames)) ::ArrayW<::StringW> displayNames;
  ...
  static inline ::UnityEngine::Rendering::SurfaceDataAttributes* New_ctor(::ArrayW<::StringW> displayNames, bool isDirection, bool sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision precision,
                                                                          bool checkIsNormalized, ::StringW preprocessor);
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_displayNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_displayNames();
  ...
  constexpr void __cordl_internal_set_displayNames(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x679da5c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679db18, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::SurfaceDataAttributes) == 0x30, "Size mismatch!");
