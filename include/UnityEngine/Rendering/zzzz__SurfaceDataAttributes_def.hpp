...
public:
  ...
  /// @brief Method .ctor, addr 0x65ec10c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65ec1c8, size 0x1c, virtual false, abstract: false, final false
