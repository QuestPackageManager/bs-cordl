...
static inline ::UnityEngine::Rendering::SurfaceDataAttributes* New_ctor(::StringW  displayName, bool  isDirection, bool  sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision  precision, bool  checkIsNormalized, ::StringW  preprocessor) ;

static inline ::UnityEngine::Rendering::SurfaceDataAttributes* New_ctor(::ArrayW<::StringW,::Array<::StringW>*>  displayNames, bool  isDirection, bool  sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision  precision, bool  checkIsNormalized, ::StringW  preprocessor) ;
...
/// @brief Method .ctor, addr 0x65ec7cc, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65ec888, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::StringW,::Array<::StringW>*>  displayNames, bool  isDirection, bool  sRGBDisplay, ::UnityEngine::Rendering::FieldPrecision  precision, bool  checkIsNormalized, ::StringW  preprocessor) ;
