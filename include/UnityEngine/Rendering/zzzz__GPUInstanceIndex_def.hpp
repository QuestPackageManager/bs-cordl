...
public:
  ...
  /// @brief Method CompareTo, addr 0x681dc4c, size 0x70, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::Rendering::GPUInstanceIndex other);

  /// @brief Method Equals, addr 0x681dbe0, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::GPUInstanceIndex other);

  /// @brief Method GetHashCode, addr 0x681dcbc, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::GPUInstanceIndex getStaticF_Invalid();

  /// @brief Method get_index, addr 0x681db70, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_valid, addr 0x681db80, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_index, addr 0x681db78, size 0x8, virtual false, abstract: false, final false
