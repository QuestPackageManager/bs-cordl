...
public:
  ...
  /// @brief Method CompareTo, addr 0x6604770, size 0x70, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::Rendering::GPUInstanceIndex other);

  /// @brief Method Equals, addr 0x6604704, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::GPUInstanceIndex other);

  /// @brief Method GetHashCode, addr 0x66047e0, size 0x58, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::GPUInstanceIndex getStaticF_Invalid();

  /// @brief Method get_index, addr 0x6604694, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_index();

  /// @brief Method get_valid, addr 0x66046a4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_index, addr 0x660469c, size 0x8, virtual false, abstract: false, final false
