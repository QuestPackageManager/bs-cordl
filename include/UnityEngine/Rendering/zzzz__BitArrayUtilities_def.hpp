...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BitArrayUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BitArrayUtilities(BitArrayUtilities&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BitArrayUtilities", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BitArrayUtilities(BitArrayUtilitiesconst&) = delete;
