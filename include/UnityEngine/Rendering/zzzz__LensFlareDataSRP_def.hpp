...
public:
  ...
  /// @brief Method HasAModulateByLightColorElement, addr 0x665dc2c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x665dc10, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
