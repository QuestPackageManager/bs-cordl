...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Rendering::ListChangedEventArgs_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Rendering::ListChangedEventArgs_1, "UnityEngine.Rendering", "ListChangedEventArgs`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ListChangedEventArgs_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ListChangedEventArgs_1(ListChangedEventArgs_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ListChangedEventArgs_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ListChangedEventArgs_1(ListChangedEventArgs_1const&) = delete;
