...
public:
  // Declarations
  /// @brief Method get_lightsUseLinearIntensity addr 0x2b846c0 size 0x28 virtual false final false
  static inline bool get_lightsUseLinearIntensity();

  /// @brief Method get_renderPipelineAsset addr 0x2b846e8 size 0x4 virtual false final false
  static inline ::UnityEngine::Rendering::RenderPipelineAsset* get_renderPipelineAsset();

  /// @brief Method set_renderPipelineAsset addr 0x2b8477c size 0x3c virtual false final false
  static inline void set_renderPipelineAsset(::UnityEngine::Rendering::RenderPipelineAsset* value);

  /// @brief Method get_INTERNAL_defaultRenderPipeline addr 0x2b847f4 size 0x28 virtual false final false
  static inline ::UnityEngine::ScriptableObject* get_INTERNAL_defaultRenderPipeline();

  /// @brief Method set_INTERNAL_defaultRenderPipeline addr 0x2b8481c size 0x3c virtual false final false
  static inline void set_INTERNAL_defaultRenderPipeline(::UnityEngine::ScriptableObject* value);

  /// @brief Method get_defaultRenderPipeline addr 0x2b846ec size 0x90 virtual false final false
  static inline ::UnityEngine::Rendering::RenderPipelineAsset* get_defaultRenderPipeline();

  /// @brief Method set_defaultRenderPipeline addr 0x2b847b8 size 0x3c virtual false final false
