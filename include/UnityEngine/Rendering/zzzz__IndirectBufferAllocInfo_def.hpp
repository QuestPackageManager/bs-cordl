...
public:
  // Declarations
  /// @brief Method GetExtraDrawInfoSlotIndex, addr 0x66e9f70, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetExtraDrawInfoSlotIndex();

  /// @brief Method IsEmpty, addr 0x66e9f2c, size 0x10, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsWithinLimits, addr 0x66e9f3c, size 0x34, virtual false, abstract: false, final false
