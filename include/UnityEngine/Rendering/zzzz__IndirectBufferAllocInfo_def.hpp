...
public:
// Declarations
/// @brief Method GetExtraDrawInfoSlotIndex, addr 0x6677f64, size 0xc, virtual false, abstract: false, final false
inline int32_t GetExtraDrawInfoSlotIndex() ;

/// @brief Method IsEmpty, addr 0x6677f20, size 0x10, virtual false, abstract: false, final false
inline bool IsEmpty() ;

/// @brief Method IsWithinLimits, addr 0x6677f30, size 0x34, virtual false, abstract: false, final false
