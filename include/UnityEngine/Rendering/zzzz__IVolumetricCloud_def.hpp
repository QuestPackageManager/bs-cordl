...
public:
  // Declarations
  /// @brief Method IsVolumetricCloudUsable, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool IsVolumetricCloudUsable();

  // Ctor Parameters [CppParam { name: "", ty: "IVolumetricCloud", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVolumetricCloud(IVolumetricCloudconst&) = delete;
