...
/// @brief Method CompareTo, addr 0x66e0158, size 0x70, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::Rendering::InstanceHandle  other) ;

/// @brief Method Create, addr 0x66ddb28, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x66e00ec, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::InstanceHandle  other) ;

/// @brief Method FromInt, addr 0x66d94f0, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::InstanceHandle FromInt(int32_t  value) ;

/// @brief Method GetHashCode, addr 0x66e01c8, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::UnityEngine::Rendering::InstanceHandle getStaticF_Invalid() ;

/// @brief Method get_index, addr 0x66e00dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_instanceIndex, addr 0x66dd8fc, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_instanceIndex() ;

/// @brief Method get_type, addr 0x66dd8a0, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::InstanceType get_type() ;

/// @brief Method get_valid, addr 0x66dd840, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_index, addr 0x66e00e4, size 0x8, virtual false, abstract: false, final false
