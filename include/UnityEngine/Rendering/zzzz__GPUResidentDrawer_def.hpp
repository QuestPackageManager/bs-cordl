...
public:
  ...
  /// @brief Method Execute, addr 0x66d0954, size 0x460, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x66d0db4, size 0x1d4, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method Execute, addr 0x66d0f88, size 0x2cc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Execute, addr 0x66d1254, size 0x164, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method AppendNewInstance, addr 0x66d07e8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method ClassifyMaterials, addr 0x66cf780, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanUp, addr 0x66ce7b0, size 0x60, virtual false, abstract: false, final false
  static inline void CleanUp();

  /// @brief Method Dispose, addr 0x66ce810, size 0x29c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method FindRenderersFromMaterials, addr 0x66d0470, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FindUnsupportedRenderers, addr 0x66cf944, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeInstances, addr 0x66d0790, size 0x58, virtual false, abstract: false, final false
  inline void FreeInstances(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle> instances);

  /// @brief Method FreeRendererGroupInstances, addr 0x66d0690, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDebugStats, addr 0x66c61bc, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::DebugRendererBatcherStats* GetDebugStats();

  /// @brief Method GetGlobalSettingsFromRPAsset, addr 0x66c9de0, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::GPUResidentDrawerSettings GetGlobalSettingsFromRPAsset();

  /// @brief Method GetMaterialsWithChangedPackedMaterial, addr 0x66d02ec, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertIntoPlayerLoop, addr 0x66cdfb8, size 0x424, virtual false, abstract: false, final false
  inline void InsertIntoPlayerLoop();

  /// @brief Method InstanceOcclusionTest, addr 0x66cdcd4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEnabled, addr 0x66ca134, size 0x54, virtual false, abstract: false, final false
  static inline bool IsEnabled();

  /// @brief Method IsForcedOnViaCommandLine, addr 0x66ce6b8, size 0x8, virtual false, abstract: false, final false
  static inline bool IsForcedOnViaCommandLine();

  /// @brief Method IsGPUResidentDrawerSupportedBySRP, addr 0x66c9f3c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsInstanceOcclusionCullingEnabled, addr 0x66cdb9c, size 0x6c, virtual false, abstract: false, final false
  static inline bool IsInstanceOcclusionCullingEnabled();

  /// @brief Method IsOcclusionForcedOnViaCommandLine, addr 0x66ce6c0, size 0x8, virtual false, abstract: false, final false
  static inline bool IsOcclusionForcedOnViaCommandLine();

  /// @brief Method IsProjectSupported, addr 0x66d0868, size 0x24, virtual false, abstract: false, final false
  static inline bool IsProjectSupported();

  /// @brief Method IsProjectSupported, addr 0x66d088c, size 0xc8, virtual false, abstract: false, final false
  static inline bool IsProjectSupported(::ByRef<::StringW> message, ::ByRef<::UnityEngine::LogType> severity);

  /// @brief Method LogMessage, addr 0x66cf084, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeginCameraRendering, addr 0x66cf718, size 0x34, virtual false, abstract: false, final false
  inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method OnBeginContextRendering, addr 0x66cf570, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEndCameraRendering, addr 0x66cf74c, size 0x34, virtual false, abstract: false, final false
  inline void OnEndCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method OnEndContextRendering, addr 0x66cf658, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSceneLoaded, addr 0x66cf158, size 0x28, virtual false, abstract: false, final false
  inline void OnSceneLoaded(::UnityEngine::SceneManagement::Scene scene, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method OnSetupAmbientProbe, addr 0x66cdc6c, size 0x68, virtual false, abstract: false, final false
  static inline void OnSetupAmbientProbe();

  /// @brief Method PostCullBeginCameraRendering, addr 0x66cdc08, size 0x64, virtual false, abstract: false, final false
  static inline void PostCullBeginCameraRendering(::UnityEngine::Rendering::RenderRequestBatcherContext context);

  /// @brief Method PostPostLateUpdate, addr 0x66cf1dc, size 0x394, virtual false, abstract: false, final false
  inline void PostPostLateUpdate();

  /// @brief Method PostPostLateUpdateStatic, addr 0x66cf180, size 0x5c, virtual false, abstract: false, final false
  static inline void PostPostLateUpdateStatic();

  /// @brief Method ProcessLODGroups, addr 0x66cfc38, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMaterials, addr 0x66cfa68, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMeshes, addr 0x66cfadc, size 0x15c, virtual false, abstract: false, final false
  inline void ProcessMeshes(::Unity::Collections::NativeArray_1<int32_t> destroyedID);

  /// @brief Method ProcessRendererMaterialChanges, addr 0x66cfeec, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessRenderers, addr 0x66cfcb0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Recreate, addr 0x66ce6ec, size 0xc4, virtual false, abstract: false, final false
  static inline void Recreate(::UnityEngine::Rendering::GPUResidentDrawerSettings settings);

  /// @brief Method Reinitialize, addr 0x66ce6c8, size 0x24, virtual false, abstract: false, final false
  static inline void Reinitialize();

  /// @brief Method ReinitializeIfNeeded, addr 0x66cde14, size 0x4, virtual false, abstract: false, final false
  static inline void ReinitializeIfNeeded();

  /// @brief Method RemoveFromPlayerLoop, addr 0x66ce3dc, size 0x2dc, virtual false, abstract: false, final false
  inline void RemoveFromPlayerLoop();

  /// @brief Method RenderDebugOccluderOverlay, addr 0x66cded4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderDebugOcclusionTestOverlay, addr 0x66cde18, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleQueryMeshInstancesJob, addr 0x66d02c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x66d066c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x66d0820, size 0x24, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle ScheduleQueryRendererGroupInstancesJob(::Unity::Collections::NativeArray_1<int32_t> rendererGroupIDs,
                                                                         ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::InstanceHandle> instances);

  /// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x66d0844, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformInstances, addr 0x66d0778, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateInstanceOccluders, addr 0x66cdd74, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ceaac, size 0x5d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_batcher, addr 0x66cf13c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::GPUResidentBatcher* get_batcher();

  /// @brief Method get_instance, addr 0x66cdb50, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::GPUResidentDrawer* get_instance();

  /// @brief Method get_settings, addr 0x66cf144, size 0x14, virtual false, abstract: false, final false
