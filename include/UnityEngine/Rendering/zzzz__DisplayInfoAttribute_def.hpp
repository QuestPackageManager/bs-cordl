...
// [AttributeUsage((System.AttributeTargets)260, AllowMultiple = false)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x6756678, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DisplayInfoAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DisplayInfoAttribute(DisplayInfoAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DisplayInfoAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DisplayInfoAttribute(DisplayInfoAttributeconst&) = delete;
