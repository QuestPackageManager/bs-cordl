...
public:
// Declarations
/// @brief Method CandelaToEv100, addr 0x660ff3c, size 0x4, virtual false, abstract: false, final false
static inline float_t CandelaToEv100(float_t  candela) ;

/// @brief Method CandelaToLumen, addr 0x660fe54, size 0x8, virtual false, abstract: false, final false
static inline float_t CandelaToLumen(float_t  candela, float_t  solidAngle) ;

/// @brief Method CandelaToLux, addr 0x660fe78, size 0xc, virtual false, abstract: false, final false
static inline float_t CandelaToLux(float_t  candela, float_t  distance) ;

/// @brief Method ConvertIntensity, addr 0x661044c, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method ConvertIntensityInternal, addr 0x660ff40, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method Ev100ToCandela, addr 0x660ff1c, size 0x20, virtual false, abstract: false, final false
static inline float_t Ev100ToCandela(float_t  ev100) ;

/// @brief Method Ev100ToNits, addr 0x660fe84, size 0x20, virtual false, abstract: false, final false
static inline float_t Ev100ToNits(float_t  ev100) ;

/// @brief Method GetAreaFromDiscLight, addr 0x660fe18, size 0x18, virtual false, abstract: false, final false
static inline float_t GetAreaFromDiscLight(float_t  discRadius) ;

/// @brief Method GetAreaFromRectangleLight, addr 0x660fe00, size 0x18, virtual false, abstract: false, final false
static inline float_t GetAreaFromRectangleLight(::UnityEngine::Vector2  rectSize) ;

/// @brief Method GetAreaFromRectangleLight, addr 0x660fde8, size 0x18, virtual false, abstract: false, final false
static inline float_t GetAreaFromRectangleLight(float_t  rectSizeX, float_t  rectSizeY) ;

/// @brief Method GetAreaFromTubeLight, addr 0x660fe30, size 0x1c, virtual false, abstract: false, final false
static inline float_t GetAreaFromTubeLight(float_t  tubeLength) ;

/// @brief Method GetNativeLightUnit, addr 0x660faf4, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::LightUnit GetNativeLightUnit(::UnityEngine::LightType  lightType) ;

/// @brief Method GetSolidAngle, addr 0x660fd28, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetSolidAngleFromPointLight, addr 0x660fba0, size 0xc, virtual false, abstract: false, final false
static inline float_t GetSolidAngleFromPointLight() ;

/// @brief Method GetSolidAngleFromPyramidLight, addr 0x660fc48, size 0xe0, virtual false, abstract: false, final false
static inline float_t GetSolidAngleFromPyramidLight(float_t  spotAngle, float_t  aspectRatio) ;

/// @brief Method GetSolidAngleFromSpotLight, addr 0x660fbac, size 0x9c, virtual false, abstract: false, final false
static inline float_t GetSolidAngleFromSpotLight(float_t  spotAngle) ;

/// @brief Method IsLightUnitSupported, addr 0x660fb44, size 0x5c, virtual false, abstract: false, final false
static inline bool IsLightUnitSupported(::UnityEngine::LightType  lightType, ::UnityEngine::Rendering::LightUnit  lightUnit) ;

/// @brief Method LumenToCandela, addr 0x660fe4c, size 0x8, virtual false, abstract: false, final false
static inline float_t LumenToCandela(float_t  lumen, float_t  solidAngle) ;

/// @brief Method LumenToNits, addr 0x660fe5c, size 0x8, virtual false, abstract: false, final false
static inline float_t LumenToNits(float_t  lumen, float_t  area) ;

/// @brief Method LuxToCandela, addr 0x660fe6c, size 0xc, virtual false, abstract: false, final false
static inline float_t LuxToCandela(float_t  lux, float_t  distance) ;

/// @brief Method NitsToEv100, addr 0x660fea4, size 0x78, virtual false, abstract: false, final false
static inline float_t NitsToEv100(float_t  nits) ;

/// @brief Method NitsToLumen, addr 0x660fe64, size 0x8, virtual false, abstract: false, final false
static inline float_t NitsToLumen(float_t  nits, float_t  area) ;

/// @brief Method get_k_EvToLuminanceFactor, addr 0x660fae0, size 0x14, virtual false, abstract: false, final false
static inline float_t get_k_EvToLuminanceFactor() ;

/// @brief Method get_k_LuminanceToEvFactor, addr 0x660fa20, size 0xc0, virtual false, abstract: false, final false
