...
::cordl_internals::setStaticField<::UnityEngine::Rendering::ObjectPool_1<T>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get>(std::forward<::UnityEngine::Rendering::ObjectPool_1<T>*>(value));
}
template<typename T>
inline ::UnityEngine::Rendering::ObjectPool_1<T>* UnityEngine::Rendering::UnsafeGenericPool_1<T>::getStaticF_s_Pool()  {
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::ObjectPool_1<T>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get>();
}
template<typename T>
...
template<typename T>
inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> UnityEngine::Rendering::UnsafeGenericPool_1<T>::Get(::ByRef<T>  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get(),
                        "Get",
                        std::span<const Il2CppClass* const, 0>(),
