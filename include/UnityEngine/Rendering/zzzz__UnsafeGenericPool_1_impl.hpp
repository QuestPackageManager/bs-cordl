...
template <typename T> inline void UnityEngine::Rendering::UnsafeGenericPool_1<T>::setStaticF_s_Pool(::UnityEngine::Rendering::ObjectPool_1<T>* value) {
  ::cordl_internals::setStaticField<::UnityEngine::Rendering::ObjectPool_1<T>*, "s_Pool",
                                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get>(
...
template <typename T> inline T UnityEngine::Rendering::UnsafeGenericPool_1<T>::Get() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get(), "Get",
                                                                             std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method);
}
template <typename T> inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<T> UnityEngine::Rendering::UnsafeGenericPool_1<T>::Get(::ByRef<T> value) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get(), "Get", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline void UnityEngine::Rendering::UnsafeGenericPool_1<T>::Release(T toRelease) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::UnsafeGenericPool_1<T>*>::get(), "Release",
