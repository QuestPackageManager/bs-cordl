...
public:
  ...
  /// @brief Method CreateResources, addr 0x66dd58c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x66ddcac, size 0x48, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LoadShaders, addr 0x66ddbf8, size 0xb4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x66ddcf4, size 0xdc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AllocateUploadHandles, addr 0x66dd0c4, size 0x8, virtual false, abstract: false, final false
  inline void AllocateUploadHandles(int32_t handlesLength);

  /// @brief Method Dispose, addr 0x66dd824, size 0x15c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetParamUIntOffset, addr 0x66dd0b8, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetParamUIntOffset(int32_t parameterIndex);

  /// @brief Method GetUIntPerInstance, addr 0x66dd0b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetUIntPerInstance();

  /// @brief Method GetUploadBufferPtr, addr 0x66dd06c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SubmitToGpu, addr 0x66dd0cc, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method SubmitToGpu, addr 0x66dd724, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66dce0c, size 0x260, virtual false, abstract: false, final false
