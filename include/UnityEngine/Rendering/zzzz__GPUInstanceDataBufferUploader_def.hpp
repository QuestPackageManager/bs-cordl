...
/// @brief Method CreateResources, addr 0x666b580, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x666bca0, size 0x48, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method LoadShaders, addr 0x666bbec, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x666bce8, size 0xdc, virtual true, abstract: false, final true
...
/// @brief Method AllocateUploadHandles, addr 0x666b0b8, size 0x8, virtual false, abstract: false, final false
inline void AllocateUploadHandles(int32_t  handlesLength) ;

/// @brief Method Dispose, addr 0x666b818, size 0x15c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetParamUIntOffset, addr 0x666b0ac, size 0xc, virtual false, abstract: false, final false
inline int32_t GetParamUIntOffset(int32_t  parameterIndex) ;

/// @brief Method GetUIntPerInstance, addr 0x666b0a4, size 0x8, virtual false, abstract: false, final false
inline int32_t GetUIntPerInstance() ;

/// @brief Method GetUploadBufferPtr, addr 0x666b060, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SubmitToGpu, addr 0x666b0c0, size 0x4c0, virtual false, abstract: false, final false
inline void SubmitToGpu(::UnityEngine::Rendering::GPUInstanceDataBuffer*  instanceDataBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>  gpuInstanceIndices, ::ByRef<::UnityEngine::Rendering::GPUInstanceDataBufferUploader_GPUResources>  gpuResources, bool  submitOnlyWrittenParams) ;

/// @brief Method SubmitToGpu, addr 0x666b718, size 0x100, virtual false, abstract: false, final false
inline void SubmitToGpu(::UnityEngine::Rendering::GPUInstanceDataBuffer*  instanceDataBuffer, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::ByRef<::UnityEngine::Rendering::GPUInstanceDataBufferUploader_GPUResources>  gpuResources, bool  submitOnlyWrittenParams) ;
...
/// @brief Method .ctor, addr 0x666ae00, size 0x260, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceComponentDesc>>  descriptions, int32_t  capacity, ::UnityEngine::Rendering::InstanceType  instanceType) ;
