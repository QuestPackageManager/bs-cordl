...
/// @brief Method Execute, addr 0x66827fc, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method AtomicIncrement, addr 0x6682864, size 0x68, virtual false, abstract: false, final false
static inline int32_t AtomicIncrement(::Unity::Collections::NativeArray_1<int32_t>  counter) ;

/// @brief Method Execute, addr 0x6682914, size 0xec, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;

/// @brief Method JobIndexPrefixSum, addr 0x66828cc, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x6682a00, size 0x78, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method Execute, addr 0x6682a78, size 0x70, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method ParallelSort, addr 0x6682300, size 0x4e0, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ParallelSort(::Unity::Collections::NativeArray_1<int32_t>  array) ;

/// @brief Method <ParallelSort>g__Swap|2_0, addr 0x66827e0, size 0x1c, virtual false, abstract: false, final false
