...
public:
  ...
  /// @brief Method Execute, addr 0x66f4808, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AtomicIncrement, addr 0x66f4870, size 0x68, virtual false, abstract: false, final false
  static inline int32_t AtomicIncrement(::Unity::Collections::NativeArray_1<int32_t> counter);

  /// @brief Method Execute, addr 0x66f4920, size 0xec, virtual true, abstract: false, final true
  inline void Execute(int32_t index);

  /// @brief Method JobIndexPrefixSum, addr 0x66f48d8, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Execute, addr 0x66f4a0c, size 0x78, virtual true, abstract: false, final true
  inline void Execute(int32_t index);
...
public:
  ...
  /// @brief Method Execute, addr 0x66f4a84, size 0x70, virtual true, abstract: false, final true
  inline void Execute(int32_t index);
...
public:
  ...
  /// @brief Method ParallelSort, addr 0x66f430c, size 0x4e0, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle ParallelSort(::Unity::Collections::NativeArray_1<int32_t> array);

  /// @brief Method <ParallelSort>g__Swap|2_0, addr 0x66f47ec, size 0x1c, virtual false, abstract: false, final false
