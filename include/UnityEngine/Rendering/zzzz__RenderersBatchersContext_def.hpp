...
/// @brief Method ChangeInstanceBufferVersion, addr 0x6681270, size 0x20, virtual false, abstract: false, final false
inline void ChangeInstanceBufferVersion() ;

/// @brief Method CreateDataBufferUploader, addr 0x6681290, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method DestroyLODGroups, addr 0x66810c8, size 0x1c, virtual false, abstract: false, final false
inline void DestroyLODGroups(::Unity::Collections::NativeArray_1<int32_t>  destroyed) ;

/// @brief Method Dispose, addr 0x6680da8, size 0x13c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method EnsureInstanceBufferCapacity, addr 0x6681028, size 0x78, virtual false, abstract: false, final false
inline void EnsureInstanceBufferCapacity() ;

/// @brief Method FreeInstances, addr 0x66811f4, size 0x18, virtual false, abstract: false, final false
inline void FreeInstances(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances) ;

/// @brief Method FreeRendererGroupInstances, addr 0x66811dc, size 0x18, virtual false, abstract: false, final false
inline void FreeRendererGroupInstances(::Unity::Collections::NativeArray_1<int32_t>  rendererGroupsID) ;

/// @brief Method GetAliveInstancesOfType, addr 0x6680f18, size 0x34, virtual false, abstract: false, final false
inline int32_t GetAliveInstancesOfType(::UnityEngine::Rendering::InstanceType  instanceType) ;

/// @brief Method GetInstanceDataBuffer, addr 0x6681820, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceDataBuffer* GetInstanceDataBuffer() ;

/// @brief Method GetMaxInstancesOfType, addr 0x6680ee4, size 0x34, virtual false, abstract: false, final false
inline int32_t GetMaxInstancesOfType(::UnityEngine::Rendering::InstanceType  instanceType) ;

/// @brief Method GetRendererInstanceHandle, addr 0x66816b4, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::InstanceHandle GetRendererInstanceHandle(int32_t  rendererID) ;

/// @brief Method GetVisibleTreeInstances, addr 0x6681804, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method GrowInstanceBuffer, addr 0x6680f4c, size 0xdc, virtual false, abstract: false, final false
inline void GrowInstanceBuffer(::ByRef<::UnityEngine::Rendering::InstanceNumInfo>  instanceNumInfo) ;

/// @brief Method InitializeInstanceTransforms, addr 0x668131c, size 0x6c, virtual false, abstract: false, final false
...
static inline ::UnityEngine::Rendering::RenderersBatchersContext* New_ctor(::ByRef<::UnityEngine::Rendering::RenderersBatchersContextDesc>  desc, ::UnityEngine::Rendering::GPUDrivenProcessor*  gpuDrivenProcessor, ::UnityEngine::Rendering::GPUResidentDrawerResources*  resources) ;

/// @brief Method ReallocateAndGetInstances, addr 0x668118c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method ScheduleCollectInstancesLODGroupAndMasksJob, addr 0x668169c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryMeshInstancesJob, addr 0x6681258, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x668120c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x6681224, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x668123c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ScheduleUpdateInstanceDataJob, addr 0x66811b4, size 0x28, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle ScheduleUpdateInstanceDataJob(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::ByRef<::UnityEngine::Rendering::GPUDrivenRendererGroupData>  rendererData) ;

/// @brief Method SubmitToGpu, addr 0x66812f4, size 0x28, virtual false, abstract: false, final false
inline void SubmitToGpu(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUInstanceIndex>  gpuInstanceIndices, ::ByRef<::UnityEngine::Rendering::GPUInstanceDataBufferUploader>  uploader, bool  submitOnlyWrittenParams) ;

/// @brief Method SubmitToGpu, addr 0x66812cc, size 0x28, virtual false, abstract: false, final false
inline void SubmitToGpu(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::ByRef<::UnityEngine::Rendering::GPUInstanceDataBufferUploader>  uploader, bool  submitOnlyWrittenParams) ;

/// @brief Method TransformLODGroupData, addr 0x66810b4, size 0x14, virtual false, abstract: false, final false
inline void TransformLODGroupData(::ByRef<::UnityEngine::Rendering::GPUDrivenLODGroupData>  lodGroupData) ;

/// @brief Method TransformLODGroups, addr 0x66815dc, size 0xa8, virtual false, abstract: false, final false
inline void TransformLODGroups(::Unity::Collections::NativeArray_1<int32_t>  lodGroupsID) ;

/// @brief Method UpdateAmbientProbeAndGpuBuffer, addr 0x66813f0, size 0x124, virtual false, abstract: false, final false
inline void UpdateAmbientProbeAndGpuBuffer(bool  forceUpdate) ;

/// @brief Method UpdateFrame, addr 0x6681828, size 0x38, virtual false, abstract: false, final false
inline void UpdateFrame() ;

/// @brief Method UpdateInstanceMotions, addr 0x6681594, size 0x48, virtual false, abstract: false, final false
inline void UpdateInstanceMotions() ;

/// @brief Method UpdateInstanceTransforms, addr 0x6681388, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method UpdateInstanceWindDataHistory, addr 0x6681514, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UpdateLODGroupData, addr 0x66810a0, size 0x14, virtual false, abstract: false, final false
inline void UpdateLODGroupData(::ByRef<::UnityEngine::Rendering::GPUDrivenLODGroupData>  lodGroupData) ;

/// @brief Method UpdateLODGroups, addr 0x66810e4, size 0xa8, virtual false, abstract: false, final false
inline void UpdateLODGroups(::Unity::Collections::NativeArray_1<int32_t>  changedID) ;

/// @brief Method UpdatePerFrameInstanceVisibility, addr 0x6681684, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x66803e4, size 0x360, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::UnityEngine::Rendering::RenderersBatchersContextDesc>  desc, ::UnityEngine::Rendering::GPUDrivenProcessor*  gpuDrivenProcessor, ::UnityEngine::Rendering::GPUResidentDrawerResources*  resources) ;

/// @brief Method get_activeLodGroupCount, addr 0x66801b8, size 0x14, virtual false, abstract: false, final false
inline int32_t get_activeLodGroupCount() ;

/// @brief Method get_aliveInstances, addr 0x66803ac, size 0x18, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle> get_aliveInstances() ;

/// @brief Method get_cachedAmbientProbe, addr 0x66802bc, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::SphericalHarmonicsL2 get_cachedAmbientProbe() ;

/// @brief Method get_crossfadedRendererCount, addr 0x66802a4, size 0x18, virtual false, abstract: false, final false
inline int32_t get_crossfadedRendererCount() ;

/// @brief Method get_debugStats, addr 0x66803dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::DebugRendererBatcherStats* get_debugStats() ;

/// @brief Method get_defaultDescriptions, addr 0x66801cc, size 0x78, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1_ReadOnly<::UnityEngine::Rendering::GPUInstanceComponentDesc> get_defaultDescriptions() ;

/// @brief Method get_defaultMetadata, addr 0x6680244, size 0x18, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::MetadataValue> get_defaultMetadata() ;

/// @brief Method get_gpuInstanceDataBuffer, addr 0x66801a0, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::GraphicsBuffer* get_gpuInstanceDataBuffer() ;

/// @brief Method get_hasBoundingSpheres, addr 0x66802cc, size 0x18, virtual false, abstract: false, final false
inline bool get_hasBoundingSpheres() ;

/// @brief Method get_instanceData, addr 0x66802e4, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CPUInstanceData_ReadOnly get_instanceData() ;

/// @brief Method get_instanceDataBuffer, addr 0x6680394, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUInstanceDataBuffer_ReadOnly get_instanceDataBuffer() ;

/// @brief Method get_instanceDataBufferLayoutVersion, addr 0x668028c, size 0x18, virtual false, abstract: false, final false
inline int32_t get_instanceDataBufferLayoutVersion() ;

/// @brief Method get_instanceDataBufferVersion, addr 0x6680274, size 0x18, virtual false, abstract: false, final false
inline int32_t get_instanceDataBufferVersion() ;

/// @brief Method get_lodGroupCullingData, addr 0x668025c, size 0x18, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::LODGroupCullingData> get_lodGroupCullingData() ;

/// @brief Method get_occlusionCullingCommon, addr 0x66803d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::OcclusionCullingCommon* get_occlusionCullingCommon() ;

/// @brief Method get_renderersParameters, addr 0x6680190, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::RenderersParameters get_renderersParameters() ;

/// @brief Method get_resources, addr 0x66803cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::GPUResidentDrawerResources* get_resources() ;

/// @brief Method get_sharedInstanceData, addr 0x668033c, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CPUSharedInstanceData_ReadOnly get_sharedInstanceData() ;

/// @brief Method get_smallMeshScreenPercentage, addr 0x66803c4, size 0x8, virtual false, abstract: false, final false
