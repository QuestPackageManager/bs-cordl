...
public:
// Declarations
/// @brief Method flattenIndex, addr 0x65d2d50, size 0x14, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Cleanup, addr 0x65d3e3c, size 0xf0, virtual false, abstract: false, final false
inline void Cleanup() ;
...
/// @brief Method Allocate, addr 0x65d4350, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method AllocatePool, addr 0x65d3688, size 0x12c, virtual false, abstract: false, final false
inline void AllocatePool(int32_t  width, int32_t  height, int32_t  depth) ;

/// @brief Method Cleanup, addr 0x65d5b20, size 0x8, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Clear, addr 0x65d42d8, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateDataLocation, addr 0x65d37b4, size 0x5f0, virtual false, abstract: false, final false
...
/// @brief Method CreateDataTexture, addr 0x65d58f0, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method Deallocate, addr 0x65d45d4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method DerivePoolSizeFromBudget, addr 0x65d3674, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method DivRoundUp, addr 0x65d307c, size 0x10, virtual false, abstract: false, final false
static inline int32_t DivRoundUp(int32_t  x, int32_t  y) ;

/// @brief Method EnsureTextureValidity, addr 0x65d3f2c, size 0x94, virtual false, abstract: false, final false
inline bool EnsureTextureValidity(bool  renderingLayers, bool  skyOcclusion, bool  skyDirection, bool  probeOcclusion) ;

/// @brief Method EnsureTextureValidity, addr 0x65d3dac, size 0x90, virtual false, abstract: false, final false
inline void EnsureTextureValidity() ;

/// @brief Method EstimateMemoryCost, addr 0x65d5788, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method EstimateMemoryCostForBlending, addr 0x65d57b0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method GetChunkCount, addr 0x65d4338, size 0x18, virtual false, abstract: false, final false
static inline int32_t GetChunkCount(int32_t  brickCount) ;

/// @brief Method GetChunkSizeInBrickCount, addr 0x65d3fc0, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetChunkSizeInBrickCount() ;

/// @brief Method GetChunkSizeInProbeCount, addr 0x65d3fc8, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetChunkSizeInProbeCount() ;

/// @brief Method GetPoolDimensions, addr 0x65d3fe0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int GetPoolDimensions() ;

/// @brief Method GetPoolHeight, addr 0x65d3fd8, size 0x8, virtual false, abstract: false, final false
inline int32_t GetPoolHeight() ;

/// @brief Method GetPoolWidth, addr 0x65d3fd0, size 0x8, virtual false, abstract: false, final false
inline int32_t GetPoolWidth() ;

/// @brief Method GetProbeOcclusionTexture, addr 0x65d3504, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetProbeOcclusionTexture() ;

/// @brief Method GetRemainingChunkCount, addr 0x65d3da4, size 0x8, virtual false, abstract: false, final false
inline int32_t GetRemainingChunkCount() ;

/// @brief Method GetRuntimeResources, addr 0x65d3ff0, size 0x2e8, virtual false, abstract: false, final false
inline void GetRuntimeResources(::ByRef<::UnityEngine::Rendering::ProbeReferenceVolume_RuntimeResources>  rr) ;

/// @brief Method GetSkyOcclusionTexture, addr 0x65d34f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetSkyOcclusionTexture() ;

/// @brief Method GetSkyShadingDirectionIndicesTexture, addr 0x65d34fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetSkyShadingDirectionIndicesTexture() ;

/// @brief Method GetValidityTexture, addr 0x65d34ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> GetValidityTexture() ;

/// @brief Method Initialize, addr 0x65d309c, size 0x450, virtual false, abstract: false, final false
...
/// @brief Method ProbeCountToDataLocSize, addr 0x65d571c, size 0x6c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3Int ProbeCountToDataLocSize(int32_t  numProbes) ;

/// @brief Method Update, addr 0x65d4bd8, size 0x970, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x65d4728, size 0x4b0, virtual false, abstract: false, final false
...
/// @brief Method UpdateValidity, addr 0x65d557c, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65d350c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method get_estimatedVMemCost, addr 0x65d308c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_estimatedVMemCost, addr 0x65d3094, size 0x8, virtual false, abstract: false, final false
