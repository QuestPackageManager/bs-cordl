...
public:
// Declarations
/// @brief Method GetCoefficient, addr 0x65e2f50, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetCoefficient(::UnityEngine::Rendering::SphericalHarmonicsL2  sh, int32_t  index) ;

/// @brief Method GetL1, addr 0x65e2df4, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetL2, addr 0x65e2e28, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method SetCoefficient, addr 0x65e2ee8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method SetL0, addr 0x65e2e90, size 0x10, virtual false, abstract: false, final false
static inline void SetL0(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L0) ;

/// @brief Method SetL1, addr 0x65e2ec4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method SetL1B, addr 0x65e2eb8, size 0xc, virtual false, abstract: false, final false
static inline void SetL1B(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_B) ;

/// @brief Method SetL1G, addr 0x65e2eac, size 0xc, virtual false, abstract: false, final false
static inline void SetL1G(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_G) ;

/// @brief Method SetL1R, addr 0x65e2ea0, size 0xc, virtual false, abstract: false, final false
static inline void SetL1R(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_R) ;

/// @brief Method .ctor, addr 0x65e2fc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
