...
public:
// Declarations
/// @brief Method GetCoefficient, addr 0x6656ad4, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetCoefficient(::UnityEngine::Rendering::SphericalHarmonicsL2  sh, int32_t  index) ;

/// @brief Method GetL1, addr 0x6656978, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetL2, addr 0x66569ac, size 0x68, virtual false, abstract: false, final false
static inline void GetL2(::UnityEngine::Rendering::SphericalHarmonicsL2  sh, ::ByRef<::UnityEngine::Vector3>  L2_0, ::ByRef<::UnityEngine::Vector3>  L2_1, ::ByRef<::UnityEngine::Vector3>  L2_2, ::ByRef<::UnityEngine::Vector3>  L2_3, ::ByRef<::UnityEngine::Vector3>  L2_4) ;

static inline ::UnityEngine::Rendering::SphericalHarmonicsL2Utils* New_ctor() ;

/// @brief Method SetCoefficient, addr 0x6656a6c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method SetL0, addr 0x6656a14, size 0x10, virtual false, abstract: false, final false
static inline void SetL0(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L0) ;

/// @brief Method SetL1, addr 0x6656a48, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method SetL1B, addr 0x6656a3c, size 0xc, virtual false, abstract: false, final false
static inline void SetL1B(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_B) ;

/// @brief Method SetL1G, addr 0x6656a30, size 0xc, virtual false, abstract: false, final false
static inline void SetL1G(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_G) ;

/// @brief Method SetL1R, addr 0x6656a24, size 0xc, virtual false, abstract: false, final false
static inline void SetL1R(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2>  sh, ::UnityEngine::Vector3  L1_R) ;

/// @brief Method .ctor, addr 0x6656b44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
