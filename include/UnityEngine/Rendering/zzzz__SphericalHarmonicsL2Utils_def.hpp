...
public:
  // Declarations
  /// @brief Method GetCoefficient, addr 0x6654f5c, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetCoefficient(::UnityEngine::Rendering::SphericalHarmonicsL2 sh, int32_t index);

  /// @brief Method GetL1, addr 0x6654e00, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetL2, addr 0x6654e34, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCoefficient, addr 0x6654ef4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SetL0, addr 0x6654e9c, size 0x10, virtual false, abstract: false, final false
  static inline void SetL0(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2> sh, ::UnityEngine::Vector3 L0);

  /// @brief Method SetL1, addr 0x6654ed0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetL1B, addr 0x6654ec4, size 0xc, virtual false, abstract: false, final false
  static inline void SetL1B(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2> sh, ::UnityEngine::Vector3 L1_B);

  /// @brief Method SetL1G, addr 0x6654eb8, size 0xc, virtual false, abstract: false, final false
  static inline void SetL1G(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2> sh, ::UnityEngine::Vector3 L1_G);

  /// @brief Method SetL1R, addr 0x6654eac, size 0xc, virtual false, abstract: false, final false
  static inline void SetL1R(::ByRef<::UnityEngine::Rendering::SphericalHarmonicsL2> sh, ::UnityEngine::Vector3 L1_R);

  /// @brief Method .ctor, addr 0x6654fcc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
