...
/// @brief Method Awake, addr 0x65d1854, size 0x38, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::UnityEngine::Rendering::ProbeAdjustmentVolume* New_ctor() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x65d18a4, size 0x14, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x65d188c, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x65d18b8, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;
