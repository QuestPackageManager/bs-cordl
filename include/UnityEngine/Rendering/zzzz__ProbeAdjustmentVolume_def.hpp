...
public:
  ...
  /// @brief Method Awake, addr 0x6643860, size 0x38, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::UnityEngine::Rendering::ProbeAdjustmentVolume* New_ctor();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x66438b0, size 0x14, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x6643898, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66438c4, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
