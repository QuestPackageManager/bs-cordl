...
// "topology", ty: "::UnityEngine::MeshTopology", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexBufferHandle", ty: "::UnityEngine::GraphicsBufferHandle", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "baseVertex", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexOffsetBytes", ty: "uint32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "elementCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }]
