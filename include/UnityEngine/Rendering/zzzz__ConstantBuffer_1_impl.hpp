...
template<typename CBType>
constexpr ::ArrayW<CBType,::Array<CBType>*>& UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_get_m_Data()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Data;
}
template<typename CBType>
constexpr ::ArrayW<CBType,::Array<CBType>*> const& UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_get_m_Data() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Data;
}
template<typename CBType>
constexpr void UnityEngine::Rendering::ConstantBuffer_1<CBType>::__cordl_internal_set_m_Data(::ArrayW<CBType,::Array<CBType>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>::get(),
                        ".ctor",
...
template<typename CBType>
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::UpdateData(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>::get(),
                        "UpdateData",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename CBType>
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::UpdateData(::ByRef<CBType>  data)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>::get(),
                        "UpdateData",
                        std::span<const Il2CppClass* const, 0>(),
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Set",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::MaterialPropertyBlock*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, mpb, shaderId);
}
template<typename CBType>
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::PushGlobal(::UnityEngine::Rendering::CommandBuffer*  cmd, ::ByRef<CBType>  data, int32_t  shaderId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>::get(),
                        "PushGlobal",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename CBType>
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::PushGlobal(::ByRef<CBType>  data, int32_t  shaderId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>::get(),
                        "PushGlobal",
                        std::span<const Il2CppClass* const, 0>(),
