...
template <typename CBType>
  requires(::cordl_internals::value_type_constraint<CBType> && ::cordl_internals::default_constructor_constraint<CBType>)
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::UpdateData(::UnityEngine::Rendering::CommandBuffer* cmd, /* [IsReadOnly] */ ::by_ref<CBType> data) {
...
template <typename CBType>
  requires(::cordl_internals::value_type_constraint<CBType> && ::cordl_internals::default_constructor_constraint<CBType>)
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::UpdateData(/* [IsReadOnly] */ ::by_ref<CBType> data) {
  static auto* ___internal_method =
...
template <typename CBType>
  requires(::cordl_internals::value_type_constraint<CBType> && ::cordl_internals::default_constructor_constraint<CBType>)
inline void UnityEngine::Rendering::ConstantBuffer_1<CBType>::PushGlobal(/* [IsReadOnly] */ ::by_ref<CBType> data, int32_t shaderId) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ConstantBuffer_1<CBType>*>(),
