...
public:
  ...
  /// @brief Method .ctor, addr 0x67a2f30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_packagePath, addr 0x67a2f1c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_packagePath();

  /// @brief Method get_packagePath_Internal, addr 0x67a2f24, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RenderPipelineResources", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RenderPipelineResources(RenderPipelineResources&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RenderPipelineResources", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RenderPipelineResources(RenderPipelineResourcesconst&) = delete;
