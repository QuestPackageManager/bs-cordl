...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConstantBufferBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConstantBufferBase(ConstantBufferBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConstantBufferBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConstantBufferBase(ConstantBufferBaseconst&) = delete;
