...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProbeBrickBlendingPool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProbeBrickBlendingPool(ProbeBrickBlendingPool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProbeBrickBlendingPool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProbeBrickBlendingPool(ProbeBrickBlendingPoolconst&) = delete;
