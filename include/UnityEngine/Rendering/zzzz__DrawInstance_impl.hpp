...
// Ctor Parameters [CppParam { name: "key", ty: "::UnityEngine::Rendering::DrawKey", modifiers: "", def_value: Some("{}") }, CppParam { name: "instanceIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
