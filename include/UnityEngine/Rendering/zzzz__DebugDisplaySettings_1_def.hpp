...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::Rendering::DebugDisplaySettings_1_IDebugDisplaySettingsDataComparer, "UnityEngine.Rendering", "DebugDisplaySettings`1/IDebugDisplaySettingsDataComparer");
