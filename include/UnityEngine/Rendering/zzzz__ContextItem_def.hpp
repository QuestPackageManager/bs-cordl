...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::ContextItem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ContextItem*, "UnityEngine.Rendering", "ContextItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x67474dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::ContextItem) == 0x10, "Size mismatch!");
