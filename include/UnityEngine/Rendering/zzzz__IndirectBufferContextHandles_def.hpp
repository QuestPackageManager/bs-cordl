...
public:
  // Declarations
  /// @brief Method UseForOcclusionTest, addr 0x682fd34, size 0x208, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::IndirectBufferContextHandles) == 0x30, "Size mismatch!");
