...
public:
  ...
  /// @brief Method Equals, addr 0x3225c60, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3225c2c, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::CoreCameraValues other);

  /// @brief Method GetHashCode, addr 0x3225cf8, size 0x20, virtual true, abstract: false, final false
