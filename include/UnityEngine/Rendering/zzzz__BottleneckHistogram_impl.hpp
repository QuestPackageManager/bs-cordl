...
// Ctor Parameters [CppParam { name: "PresentLimited", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "CPU", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "GPU", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Balanced", ty: "float_t", modifiers: "", def_value: Some("{}") }]
