...
public:
  // Declarations
  /// @brief Method UpdateWindAndWriteBufferWindParams, addr 0x6a62f64, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateWindAndWriteBufferWindParams_Injected, addr 0x6a6301c, size 0x54, virtual false, abstract: false, final false
