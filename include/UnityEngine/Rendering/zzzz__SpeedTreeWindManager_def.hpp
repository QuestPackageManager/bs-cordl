...
public:
// Declarations
/// @brief Method UpdateWindAndWriteBufferWindParams, addr 0x69f0d1c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method UpdateWindAndWriteBufferWindParams_Injected, addr 0x69f0dd4, size 0x54, virtual false, abstract: false, final false
