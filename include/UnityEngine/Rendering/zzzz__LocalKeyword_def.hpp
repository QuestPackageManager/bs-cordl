...
public:
  ...
  /// @brief Method Equals, addr 0x32279ec, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x3227a78, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::LocalKeyword rhs);

  /// @brief Method GetHashCode, addr 0x3227ac8, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x32279e4, size 0x8, virtual true, abstract: false, final false
