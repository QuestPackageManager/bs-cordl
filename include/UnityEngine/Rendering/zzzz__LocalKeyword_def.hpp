...
/// @brief Method Equals, addr 0x6962d7c, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x6962e08, size 0x2c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::LocalKeyword  rhs) ;

/// @brief Method GetComputeShaderKeywordCount, addr 0x69627b0, size 0x80, virtual false, abstract: false, final false
static inline uint32_t GetComputeShaderKeywordCount(::UnityEngine::ComputeShader*  shader) ;

/// @brief Method GetComputeShaderKeywordCount_Injected, addr 0x6962830, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t GetComputeShaderKeywordCount_Injected(::System::IntPtr  shader) ;

/// @brief Method GetComputeShaderKeywordIndex, addr 0x696286c, size 0x174, virtual false, abstract: false, final false
static inline uint32_t GetComputeShaderKeywordIndex(::UnityEngine::ComputeShader*  shader, ::StringW  keyword) ;

/// @brief Method GetComputeShaderKeywordIndex_Injected, addr 0x69629e0, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x6962e40, size 0x10, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetShaderKeywordCount, addr 0x696253c, size 0x80, virtual false, abstract: false, final false
static inline uint32_t GetShaderKeywordCount(::UnityEngine::Shader*  shader) ;

/// @brief Method GetShaderKeywordCount_Injected, addr 0x69625bc, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t GetShaderKeywordCount_Injected(::System::IntPtr  shader) ;

/// @brief Method GetShaderKeywordIndex, addr 0x69625f8, size 0x174, virtual false, abstract: false, final false
static inline uint32_t GetShaderKeywordIndex(::UnityEngine::Shader*  shader, ::StringW  keyword) ;

/// @brief Method GetShaderKeywordIndex_Injected, addr 0x696276c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x6962d74, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6962bcc, size 0x1a8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ComputeShader*  shader, ::StringW  name) ;

/// @brief Method .ctor, addr 0x6962a24, size 0x1a8, virtual false, abstract: false, final false
