...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::OccluderDerivedData (*)(::ByRef<::UnityEngine::Rendering::OccluderSubviewUpdate>)>(&::UnityEngine::Rendering::OccluderDerivedData::FromParameters)> {
  constexpr static std::size_t size = 0x330;
  constexpr static std::size_t addrs = 0x6677810;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::OccluderDerivedData>::get(),
                        "FromParameters",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::UnityEngine::Rendering::OccluderSubviewUpdate>>::get()}
                    )));
