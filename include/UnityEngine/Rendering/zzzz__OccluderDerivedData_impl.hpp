...
// "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "radialDirWorldSpace", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "facingDirWorldSpace", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }]
