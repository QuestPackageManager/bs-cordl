...
public:
  ...
  /// @brief Method ChangeLayer, addr 0x66860a0, size 0xfc, virtual false, abstract: false, final false
  inline bool ChangeLayer(::UnityEngine::Rendering::Volume* volume, int32_t previousLayerIndex, int32_t currentLayerIndex);

  /// @brief Method GrabVolumes, addr 0x66862d4, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x66859b4, size 0x330, virtual false, abstract: false, final false
  inline bool Register(::UnityEngine::Rendering::Volume* volume, int32_t layer);

  /// @brief Method SetLayerIndexDirty, addr 0x6685ce4, size 0x178, virtual false, abstract: false, final false
  inline void SetLayerIndexDirty(int32_t layerIndex);

  /// @brief Method SortByPriority, addr 0x668619c, size 0x138, virtual false, abstract: false, final false
  static inline void SortByPriority(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>* volumes);

  /// @brief Method Unregister, addr 0x6685e5c, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66865a4, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_count, addr 0x6685964, size 0x50, virtual false, abstract: false, final false
