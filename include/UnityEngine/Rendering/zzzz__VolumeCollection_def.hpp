...
public:
  ...
  /// @brief Method ChangeLayer, addr 0x67c5324, size 0xfc, virtual false, abstract: false, final false
  inline bool ChangeLayer(::UnityEngine::Rendering::Volume* volume, int32_t previousLayerIndex, int32_t currentLayerIndex);

  /// @brief Method GrabVolumes, addr 0x67c5558, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x67c4c38, size 0x330, virtual false, abstract: false, final false
  inline bool Register(::UnityEngine::Rendering::Volume* volume, int32_t layer);

  /// @brief Method SetLayerIndexDirty, addr 0x67c4f68, size 0x178, virtual false, abstract: false, final false
  inline void SetLayerIndexDirty(int32_t layerIndex);

  /// @brief Method SortByPriority, addr 0x67c5420, size 0x138, virtual false, abstract: false, final false
  static inline void SortByPriority(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>* volumes);

  /// @brief Method Unregister, addr 0x67c50e0, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67c5828, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_count, addr 0x67c4be8, size 0x50, virtual false, abstract: false, final false
