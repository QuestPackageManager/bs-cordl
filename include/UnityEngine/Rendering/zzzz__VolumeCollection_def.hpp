...
/// @brief Method ChangeLayer, addr 0x6614094, size 0xfc, virtual false, abstract: false, final false
inline bool ChangeLayer(::UnityEngine::Rendering::Volume*  volume, int32_t  previousLayerIndex, int32_t  currentLayerIndex) ;

/// @brief Method GrabVolumes, addr 0x66142c8, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method Register, addr 0x66139a8, size 0x330, virtual false, abstract: false, final false
inline bool Register(::UnityEngine::Rendering::Volume*  volume, int32_t  layer) ;

/// @brief Method SetLayerIndexDirty, addr 0x6613cd8, size 0x178, virtual false, abstract: false, final false
inline void SetLayerIndexDirty(int32_t  layerIndex) ;

/// @brief Method SortByPriority, addr 0x6614190, size 0x138, virtual false, abstract: false, final false
static inline void SortByPriority(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Rendering::Volume>>*  volumes) ;

/// @brief Method Unregister, addr 0x6613e50, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6614598, size 0x14c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_count, addr 0x6613958, size 0x50, virtual false, abstract: false, final false
