...
public:
  ...
  /// @brief Method SetParentObject, addr 0x65e0cf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65e0ce8, size 0x8, virtual false, abstract: false, final false
