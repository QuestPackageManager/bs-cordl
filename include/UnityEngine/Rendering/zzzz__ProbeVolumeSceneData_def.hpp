...
public:
  ...
  /// @brief Method SetParentObject, addr 0x66533bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66533b4, size 0x8, virtual false, abstract: false, final false
