...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::UISubset, "UnityEngine.Rendering", "UISubset");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::UISubset) == 0x4, "Size mismatch!");
