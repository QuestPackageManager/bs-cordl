...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BlendState, "UnityEngine.Rendering", "BlendState");
...
static_assert(sizeof(::UnityEngine::Rendering::BlendState) == 0x44, "Size mismatch!");
