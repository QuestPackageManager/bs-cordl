...
public:
  ...
  /// @brief Method Equals, addr 0x69c564c, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c5514, size 0xc0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::BlendState other);

  /// @brief Method GetHashCode, addr 0x69c56e0, size 0x2b8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x69c5474, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool separateMRTBlend, bool alphaToMask);

  /// @brief Method get_defaultValue, addr 0x69c542c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_blendState0, addr 0x69c550c, size 0x8, virtual false, abstract: false, final false
