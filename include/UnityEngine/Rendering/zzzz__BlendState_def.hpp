...
/// @brief Method Equals, addr 0x6953404, size 0x94, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x69532cc, size 0xc0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::BlendState  other) ;

/// @brief Method GetHashCode, addr 0x6953498, size 0x2b8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x695322c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(bool  separateMRTBlend, bool  alphaToMask) ;

/// @brief Method get_defaultValue, addr 0x69531e4, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_blendState0, addr 0x69532c4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_BlendState0", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState1", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState2", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState3", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState4", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState5", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState6", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_BlendState7", ty: "::UnityEngine::Rendering::RenderTargetBlendState", modifiers: "", def_value: None }, CppParam { name: "m_SeparateMRTBlendStates", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_AlphaToMask", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "m_Padding", ty: "int16_t", modifiers: "", def_value: None }]
