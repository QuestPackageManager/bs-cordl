...
/// @brief Method Execute, addr 0x6674a58, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method Execute, addr 0x6674b28, size 0x8c, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x6674bb4, size 0x134, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
// Ctor Parameters [CppParam { name: "rendererGroupInstanceMultiHash", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "rendererGroupIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "atomicNonFoundInstancesCount", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeAtomicCounter32", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x6674ce8, size 0x20c, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
// Ctor Parameters [CppParam { name: "rendererGroupInstanceMultiHash", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "rendererGroupIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instancesOffsets", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instancesCounts", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "atomicNonFoundSharedInstancesCount", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeAtomicCounter32", modifiers: "", def_value: None }, CppParam { name: "atomicNonFoundInstancesCount", ty: "::Unity::Collections::LowLevel::Unsafe::UnsafeAtomicCounter32", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x6674ef4, size 0x1f8, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
// Ctor Parameters [CppParam { name: "instanceData", ty: "::UnityEngine::Rendering::CPUInstanceData", modifiers: "", def_value: None }, CppParam { name: "sharedInstanceData", ty: "::UnityEngine::Rendering::CPUSharedInstanceData", modifiers: "", def_value: None }, CppParam { name: "sortedMeshID", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }]
...
/// @brief Method Execute, addr 0x66750ec, size 0x168, virtual true, abstract: false, final true
...
/// @brief Method Execute, addr 0x6675254, size 0x3c, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method Execute, addr 0x6675290, size 0x5a0, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
/// @brief Method Execute, addr 0x6675830, size 0x298, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
/// @brief Method Execute, addr 0x6675ac8, size 0x184, virtual true, abstract: false, final true
...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeParallelMultiHashMap`2<TKey, TValue>, UnityEngine.Rendering.CPUInstanceData, UnityEngine.Rendering.CPUSharedInstanceData, UnityEngine.Rendering.GPUDrivenPackedRendererData, UnityEngine.Rendering.InstanceAllocators, UnityEngine.Rendering.InstanceHandle
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x6675c4c, size 0x38c, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "implicitInstanceIndices", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "rendererGroupIDs", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "packedRendererData", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUDrivenPackedRendererData>", modifiers: "", def_value: None }, CppParam { name: "instanceOffsets", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instanceCounts", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instanceAllocators", ty: "::UnityEngine::Rendering::InstanceAllocators", modifiers: "", def_value: None }, CppParam { name: "instanceData", ty: "::UnityEngine::Rendering::CPUInstanceData", modifiers: "", def_value: None }, CppParam { name: "sharedInstanceData", ty: "::UnityEngine::Rendering::CPUSharedInstanceData", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "rendererGroupInstanceMultiHash", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }]
constexpr InstanceDataSystem_ReallocateInstancesJob(bool  implicitInstanceIndices, ::Unity::Collections::NativeArray_1<int32_t>  rendererGroupIDs, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::GPUDrivenPackedRendererData>  packedRendererData, ::Unity::Collections::NativeArray_1<int32_t>  instanceOffsets, ::Unity::Collections::NativeArray_1<int32_t>  instanceCounts, ::UnityEngine::Rendering::InstanceAllocators  instanceAllocators, ::UnityEngine::Rendering::CPUInstanceData  instanceData, ::UnityEngine::Rendering::CPUSharedInstanceData  sharedInstanceData, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>  rendererGroupInstanceMultiHash) noexcept;
...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeParallelMultiHashMap`2<TKey, TValue>, UnityEngine.Rendering.CPUInstanceData, UnityEngine.Rendering.CPUSharedInstanceData, UnityEngine.Rendering.InstanceAllocators, UnityEngine.Rendering.InstanceHandle
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x6675fd8, size 0x2f0, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "instanceAllocators", ty: "::UnityEngine::Rendering::InstanceAllocators", modifiers: "", def_value: None }, CppParam { name: "instanceData", ty: "::UnityEngine::Rendering::CPUInstanceData", modifiers: "", def_value: None }, CppParam { name: "sharedInstanceData", ty: "::UnityEngine::Rendering::CPUSharedInstanceData", modifiers: "", def_value: None }, CppParam { name: "rendererGroupInstanceMultiHash", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }]
constexpr InstanceDataSystem_FreeInstancesJob(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::UnityEngine::Rendering::InstanceAllocators  instanceAllocators, ::UnityEngine::Rendering::CPUInstanceData  instanceData, ::UnityEngine::Rendering::CPUSharedInstanceData  sharedInstanceData, ::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>  rendererGroupInstanceMultiHash) noexcept;
...
/// @brief Method Execute, addr 0x66762c8, size 0x268, virtual true, abstract: false, final true
inline void Execute() ;
...
// Ctor Parameters [CppParam { name: "rendererGroupsID", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "instanceAllocators", ty: "::UnityEngine::Rendering::InstanceAllocators", modifiers: "", def_value: None }, CppParam { name: "instanceData", ty: "::UnityEngine::Rendering::CPUInstanceData", modifiers: "", def_value: None }, CppParam { name: "sharedInstanceData", ty: "::UnityEngine::Rendering::CPUSharedInstanceData", modifiers: "", def_value: None }, CppParam { name: "rendererGroupInstanceMultiHash", ty: "::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }]
constexpr InstanceDataSystem_FreeRendererGroupInstancesJob(::Unity::Collections::NativeArray_1<int32_t>  rendererGroupsID, ::UnityEngine::Rendering::InstanceAllocators  instanceAllocators, ::UnityEngine::Rendering::CPUInstanceData  instanceData, ::UnityEngine::Rendering::CPUSharedInstanceData  sharedInstanceData, ::Unity::Collections::NativeParallelMultiHashMap_2<int32_t,::UnityEngine::Rendering::InstanceHandle>  rendererGroupInstanceMultiHash) noexcept;
...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.Rendering.CPUInstanceData, UnityEngine.Rendering.CPUSharedInstanceData, UnityEngine.Rendering.GPUDrivenRendererGroupData, UnityEngine.Rendering.GPUInstanceIndex, UnityEngine.Rendering.InstanceHandle
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x6676530, size 0x3f0, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
// Ctor Parameters [CppParam { name: "implicitInstanceIndices", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "rendererData", ty: "::UnityEngine::Rendering::GPUDrivenRendererGroupData", modifiers: "", def_value: None }, CppParam { name: "instances", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>", modifiers: "", def_value: None }, CppParam { name: "lodGroupDataMap", ty: "::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>", modifiers: "", def_value: None }, CppParam { name: "instanceData", ty: "::UnityEngine::Rendering::CPUInstanceData", modifiers: "", def_value: None }, CppParam { name: "sharedInstanceData", ty: "::UnityEngine::Rendering::CPUSharedInstanceData", modifiers: "", def_value: None }]
constexpr InstanceDataSystem_UpdateRendererInstancesJob(bool  implicitInstanceIndices, ::UnityEngine::Rendering::GPUDrivenRendererGroupData  rendererData, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>  lodGroupDataMap, ::UnityEngine::Rendering::CPUInstanceData  instanceData, ::UnityEngine::Rendering::CPUSharedInstanceData  sharedInstanceData) noexcept;
...
/// @brief Method Execute, addr 0x66769c4, size 0x98, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method Execute, addr 0x6676a5c, size 0x288, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
/// @brief Method Execute, addr 0x6676d5c, size 0xe4, virtual true, abstract: false, final true
inline void Execute(int32_t  startIndex, int32_t  count) ;
...
// Dependencies System.Object, Unity.Collections.NativeParallelMultiHashMap`2<TKey, TValue>, UnityEngine.Rendering.CPUInstanceData, UnityEngine.Rendering.CPUSharedInstanceData, UnityEngine.Rendering.InstanceAllocators, UnityEngine.Rendering.InstanceHandle
namespace UnityEngine::Rendering {
// Is value type: false
...
/// @brief Field m_ScratchWindParamAddressArray, offset 0x260, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScratchWindParamAddressArray, put=__cordl_internal_set_m_ScratchWindParamAddressArray)) ::ArrayW<int32_t,::Array<int32_t>*>  m_ScratchWindParamAddressArray;
...
template<typename T>
static inline int32_t AtomicAddLengthNoResize(::ByRef<::Unity::Collections::NativeList_1<T>>  list, int32_t  count) ;

/// @brief Method DispatchMotionUpdateCommand, addr 0x6671e7c, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method DispatchProbeUpdateCommand, addr 0x6671b84, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method DispatchTransformUpdateCommand, addr 0x6672104, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method DispatchWindDataCopyHistoryCommand, addr 0x66724c4, size 0x264, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x667158c, size 0xc0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method EnsureIndexQueueBufferCapacity, addr 0x667169c, size 0x9c, virtual false, abstract: false, final false
inline void EnsureIndexQueueBufferCapacity(int32_t  capacity) ;

/// @brief Method EnsureProbeBuffersCapacity, addr 0x6671738, size 0x154, virtual false, abstract: false, final false
inline void EnsureProbeBuffersCapacity(int32_t  capacity) ;

/// @brief Method EnsureTransformBuffersCapacity, addr 0x667188c, size 0x178, virtual false, abstract: false, final false
inline void EnsureTransformBuffersCapacity(int32_t  capacity) ;

/// @brief Method FreeInstances, addr 0x66735bc, size 0xb8, virtual false, abstract: false, final false
inline void FreeInstances(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances) ;

/// @brief Method FreeRendererGroupInstances, addr 0x6673504, size 0xb8, virtual false, abstract: false, final false
inline void FreeRendererGroupInstances(::Unity::Collections::NativeArray_1<int32_t>  rendererGroupsID) ;

/// @brief Method GetAliveInstancesOfType, addr 0x6671674, size 0x28, virtual false, abstract: false, final false
inline int32_t GetAliveInstancesOfType(::UnityEngine::Rendering::InstanceType  instanceType) ;

/// @brief Method GetMaxInstancesOfType, addr 0x667164c, size 0x28, virtual false, abstract: false, final false
inline int32_t GetMaxInstancesOfType(::UnityEngine::Rendering::InstanceType  instanceType) ;

/// @brief Method GetVisibleTreeInstances, addr 0x6674100, size 0x3d8, virtual false, abstract: false, final false
inline void GetVisibleTreeInstances(::ByRef<::UnityEngine::Rendering::ParallelBitArray>  compactedVisibilityMasks, ::ByRef<::UnityEngine::Rendering::ParallelBitArray>  processedBits, ::Unity::Collections::NativeList_1<int32_t>  visibeTreeRendererIDs, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::InstanceHandle>  visibeTreeInstances, bool  becomeVisibleOnly, ::ByRef<int32_t>  becomeVisibeTreeInstancesCount) ;

/// @brief Method InitializeInstanceTransforms, addr 0x6673834, size 0x48, virtual false, abstract: false, final false
inline void InitializeInstanceTransforms(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4>  localToWorldMatrices, ::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4>  prevLocalToWorldMatrices, ::ByRef<::UnityEngine::Rendering::RenderersParameters>  renderersParameters, ::UnityEngine::Rendering::GPUInstanceDataBuffer*  outputBuffer) ;

/// @brief Method InternalSanityCheckStates, addr 0x6673e88, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method ReallocateAndGetInstances, addr 0x6673230, size 0x2d4, virtual false, abstract: false, final false
inline void ReallocateAndGetInstances(::ByRef<::UnityEngine::Rendering::GPUDrivenRendererGroupData>  rendererData, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances) ;

/// @brief Method ScheduleCollectInstancesLODGroupAndMasksJob, addr 0x6673d8c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method ScheduleInterpolateProbesAndUpdateTetrahedronCache, addr 0x6671a04, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x66738d4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x6673984, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQueryRendererGroupInstancesJob, addr 0x6673aa0, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method ScheduleQuerySortedMeshInstancesJob, addr 0x6673c7c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method ScheduleUpdateInstanceDataJob, addr 0x6673674, size 0x12c, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle ScheduleUpdateInstanceDataJob(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::ByRef<::UnityEngine::Rendering::GPUDrivenRendererGroupData>  rendererData, ::Unity::Collections::NativeParallelHashMap_2<int32_t,::UnityEngine::Rendering::GPUInstanceIndex>  lodGroupDataMap) ;

/// @brief Method UpdateAllInstanceProbes, addr 0x66737a0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method UpdateInstanceMotions, addr 0x66738c0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method UpdateInstanceMotionsData, addr 0x6672728, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method UpdateInstanceProbesData, addr 0x6672e68, size 0x368, virtual false, abstract: false, final false
inline void UpdateInstanceProbesData(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::ByRef<::UnityEngine::Rendering::RenderersParameters>  renderersParameters, ::UnityEngine::Rendering::GPUInstanceDataBuffer*  outputBuffer) ;

/// @brief Method UpdateInstanceTransforms, addr 0x667387c, size 0x44, virtual false, abstract: false, final false
inline void UpdateInstanceTransforms(::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4>  localToWorldMatrices, ::ByRef<::UnityEngine::Rendering::RenderersParameters>  renderersParameters, ::UnityEngine::Rendering::GPUInstanceDataBuffer*  outputBuffer) ;

/// @brief Method UpdateInstanceTransformsData, addr 0x66728f8, size 0x570, virtual false, abstract: false, final false
inline void UpdateInstanceTransformsData(bool  initialize, ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle>  instances, ::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4>  localToWorldMatrices, ::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4>  prevLocalToWorldMatrices, ::ByRef<::UnityEngine::Rendering::RenderersParameters>  renderersParameters, ::UnityEngine::Rendering::GPUInstanceDataBuffer*  outputBuffer) ;

/// @brief Method UpdateInstanceWindDataHistory, addr 0x66731d0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method UpdatePerFrameInstanceVisibility, addr 0x66744d8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6671344, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method get_aliveInstances, addr 0x66712ec, size 0x58, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::InstanceHandle> get_aliveInstances() ;

/// @brief Method get_hasBoundingSpheres, addr 0x6671244, size 0x8, virtual false, abstract: false, final false
inline bool get_hasBoundingSpheres() ;

/// @brief Method get_instanceData, addr 0x667124c, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::CPUInstanceData_ReadOnly get_instanceData() ;

/// @brief Method get_sharedInstanceData, addr 0x667129c, size 0x50, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::InstanceDataSystem_CalculateInterpolatedLightAndOcclusionProbesBatchJob, "UnityEngine.Rendering", "InstanceDataSystem/CalculateInterpolatedLightAndOcclusionProbesBatchJob");
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::InstanceDataSystem_ComputeInstancesOffsetAndResizeInstancesArrayJob, "UnityEngine.Rendering", "InstanceDataSystem/ComputeInstancesOffsetAndResizeInstancesArrayJob");
