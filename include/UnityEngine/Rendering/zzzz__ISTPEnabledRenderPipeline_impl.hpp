...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::Rendering::ISTPEnabledRenderPipeline::*)()>(&::UnityEngine::Rendering::ISTPEnabledRenderPipeline::get_isStpUsed)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::Rendering::ISTPEnabledRenderPipeline*>(),
...
inline bool UnityEngine::Rendering::ISTPEnabledRenderPipeline::get_isStpUsed() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Rendering::ISTPEnabledRenderPipeline*>(), 0 })));
