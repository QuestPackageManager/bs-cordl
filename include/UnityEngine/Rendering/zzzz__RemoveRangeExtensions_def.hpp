...
public:
  ...
  static inline bool TryRemoveElementsInRange(/* [DisallowNull] */ ::System::Collections::Generic::IList_1<TValue>* list, int32_t index, int32_t count,
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemoveRangeExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemoveRangeExtensions(RemoveRangeExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemoveRangeExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemoveRangeExtensions(RemoveRangeExtensionsconst&) = delete;
