...
// Ctor Parameters [CppParam { name: "key", ty: "::UnityEngine::Rendering::RangeKey", modifiers: "", def_value: None }, CppParam { name: "drawCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "drawOffset", ty: "int32_t", modifiers: "", def_value: None }]
