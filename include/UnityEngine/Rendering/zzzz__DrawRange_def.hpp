...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::DrawRange, "UnityEngine.Rendering", "DrawRange");
...
static_assert(sizeof(::UnityEngine::Rendering::DrawRange) == 0x24, "Size mismatch!");
