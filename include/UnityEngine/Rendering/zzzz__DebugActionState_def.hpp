...
/// @brief Method Reset, addr 0x6624b08, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Trigger, addr 0x6624a54, size 0xb4, virtual false, abstract: false, final false
inline void Trigger(int32_t  triggerCount, float_t  state) ;

/// @brief Method TriggerWithButton, addr 0x66208bc, size 0x7c, virtual false, abstract: false, final false
inline void TriggerWithButton(::UnityEngine::InputSystem::InputAction*  action, float_t  state) ;

/// @brief Method Update, addr 0x662099c, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x662076c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_actionState, addr 0x6624a44, size 0x8, virtual false, abstract: false, final false
inline float_t get_actionState() ;

/// @brief Method get_runningAction, addr 0x6624a34, size 0x8, virtual false, abstract: false, final false
inline bool get_runningAction() ;

/// @brief Method set_actionState, addr 0x6624a4c, size 0x8, virtual false, abstract: false, final false
inline void set_actionState(float_t  value) ;

/// @brief Method set_runningAction, addr 0x6624a3c, size 0x8, virtual false, abstract: false, final false
