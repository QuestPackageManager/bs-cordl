...
public:
  ...
  /// @brief Method .ctor, addr 0x6b0b66c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  RecreatePipelineOnChangeAttribute(RecreatePipelineOnChangeAttributeconst&) = delete;
