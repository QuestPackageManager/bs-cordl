...
public:
  ...
  /// @brief Method Equals, addr 0x3227b40, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x3227bbc, size 0xc, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::LocalKeywordSpace rhs);

  /// @brief Method GetHashCode, addr 0x3227b18, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x3227ac0, size 0x8, virtual false, abstract: false, final false
