...
public:
  ...
  /// @brief Method Equals, addr 0x6b2a69c, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x6b2a718, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::LocalKeywordSpace rhs);

  /// @brief Method GetHashCode, addr 0x6b2a61c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetKeywords, addr 0x6b2a624, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Rendering::LocalKeyword> GetKeywords();

  /// @brief Method get_keywords, addr 0x6b2a660, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b2a600, size 0xc, virtual false, abstract: false, final false
