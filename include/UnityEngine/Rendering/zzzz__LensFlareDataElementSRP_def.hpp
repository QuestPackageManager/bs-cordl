...
public:
  ...
  /// @brief Method Clone, addr 0x665d6bc, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x665d0c4, size 0x54c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_count, addr 0x665dbe0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method get_edgeOffset, addr 0x665dbf8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_edgeOffset();

  /// @brief Method get_fallOff, addr 0x665dbf0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fallOff();

  /// @brief Method get_intensityVariation, addr 0x665dbe8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensityVariation();

  /// @brief Method get_localIntensity, addr 0x665dbd8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_localIntensity();

  /// @brief Method get_sdfRoundness, addr 0x665dc08, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sdfRoundness();

  /// @brief Method get_sideCount, addr 0x665dc00, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sideCount();

  /// @brief Method set_count, addr 0x665d624, size 0x10, virtual false, abstract: false, final false
  inline void set_count(int32_t value);

  /// @brief Method set_edgeOffset, addr 0x665d668, size 0x20, virtual false, abstract: false, final false
  inline void set_edgeOffset(float_t value);

  /// @brief Method set_fallOff, addr 0x665d648, size 0x20, virtual false, abstract: false, final false
  inline void set_fallOff(float_t value);

  /// @brief Method set_intensityVariation, addr 0x665d634, size 0x14, virtual false, abstract: false, final false
  inline void set_intensityVariation(float_t value);

  /// @brief Method set_localIntensity, addr 0x665d610, size 0x14, virtual false, abstract: false, final false
  inline void set_localIntensity(float_t value);

  /// @brief Method set_sdfRoundness, addr 0x665d688, size 0x20, virtual false, abstract: false, final false
  inline void set_sdfRoundness(float_t value);

  /// @brief Method set_sideCount, addr 0x665d6a8, size 0x14, virtual false, abstract: false, final false
