...
/// @brief Method Clone, addr 0x65eb6b0, size 0x51c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65eb0b8, size 0x54c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_count, addr 0x65ebbd4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_count() ;

/// @brief Method get_edgeOffset, addr 0x65ebbec, size 0x8, virtual false, abstract: false, final false
inline float_t get_edgeOffset() ;

/// @brief Method get_fallOff, addr 0x65ebbe4, size 0x8, virtual false, abstract: false, final false
inline float_t get_fallOff() ;

/// @brief Method get_intensityVariation, addr 0x65ebbdc, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensityVariation() ;

/// @brief Method get_localIntensity, addr 0x65ebbcc, size 0x8, virtual false, abstract: false, final false
inline float_t get_localIntensity() ;

/// @brief Method get_sdfRoundness, addr 0x65ebbfc, size 0x8, virtual false, abstract: false, final false
inline float_t get_sdfRoundness() ;

/// @brief Method get_sideCount, addr 0x65ebbf4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_sideCount() ;

/// @brief Method set_count, addr 0x65eb618, size 0x10, virtual false, abstract: false, final false
inline void set_count(int32_t  value) ;

/// @brief Method set_edgeOffset, addr 0x65eb65c, size 0x20, virtual false, abstract: false, final false
inline void set_edgeOffset(float_t  value) ;

/// @brief Method set_fallOff, addr 0x65eb63c, size 0x20, virtual false, abstract: false, final false
inline void set_fallOff(float_t  value) ;

/// @brief Method set_intensityVariation, addr 0x65eb628, size 0x14, virtual false, abstract: false, final false
inline void set_intensityVariation(float_t  value) ;

/// @brief Method set_localIntensity, addr 0x65eb604, size 0x14, virtual false, abstract: false, final false
inline void set_localIntensity(float_t  value) ;

/// @brief Method set_sdfRoundness, addr 0x65eb67c, size 0x20, virtual false, abstract: false, final false
inline void set_sdfRoundness(float_t  value) ;

/// @brief Method set_sideCount, addr 0x65eb69c, size 0x14, virtual false, abstract: false, final false
