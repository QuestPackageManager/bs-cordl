...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Rendering::MaterialParameter::*)(::UnityEngine::Material*, bool)>(
    &::UnityEngine::Rendering::MaterialParameter::_ctor)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x65af86c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::MaterialParameter*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
inline ::UnityEngine::Rendering::MaterialParameter* UnityEngine::Rendering::MaterialParameter::New_ctor(::UnityEngine::Material* value, bool overrideState) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Rendering::MaterialParameter*>(value, overrideState));
}
// Ctor Parameters []
