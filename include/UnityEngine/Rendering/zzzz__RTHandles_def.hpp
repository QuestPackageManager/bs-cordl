...
public:
  ...
  /// @brief Method Alloc, addr 0x6667d18, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668374, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x666811c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x66684a8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6667e58, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668c44, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668a00, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668d74, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668764, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6668fd8, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::RenderTexture* tex, bool transferOwnership);

  /// @brief Method Alloc, addr 0x66692d4, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RTHandle* tex);

  /// @brief Method Alloc, addr 0x66664c4, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RenderTargetIdentifier tex);

  /// @brief Method Alloc, addr 0x666919c, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Rendering::RenderTargetIdentifier tex, ::StringW name);

  /// @brief Method Alloc, addr 0x6668ea0, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::RTHandle* Alloc(::UnityEngine::Texture* tex);

  /// @brief Method Alloc, addr 0x6667620, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6667b00, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6667354, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method Alloc, addr 0x6667818, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDimensions, addr 0x666705c, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2Int CalculateDimensions(::UnityEngine::Vector2 scaleFactor);

  /// @brief Method CalculateDimensions, addr 0x66672a4, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2Int CalculateDimensions(::UnityEngine::Rendering::ScaleFunc* scaleFunc);

  /// @brief Method CalculateRatioAgainstMaxSize, addr 0x6669b10, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalculateRatioAgainstMaxSize(int32_t width, int32_t height);

  /// @brief Method GetFormat, addr 0x6667e4c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x666934c, size 0x7c, virtual false, abstract: false, final false
  static inline void Initialize(int32_t width, int32_t height);

  /// @brief Method Initialize, addr 0x66696a4, size 0x94, virtual false, abstract: false, final false
  static inline void Initialize(int32_t width, int32_t height, bool useLegacyDynamicResControl);

  /// @brief Method Release, addr 0x6669764, size 0x7c, virtual false, abstract: false, final false
  static inline void Release(::UnityEngine::Rendering::RTHandle* rth);

  /// @brief Method ResetReferenceSize, addr 0x6669a80, size 0x84, virtual false, abstract: false, final false
  static inline void ResetReferenceSize(int32_t width, int32_t height);

  /// @brief Method SetHardwareDynamicResolutionState, addr 0x66697f0, size 0x6c, virtual false, abstract: false, final false
  static inline void SetHardwareDynamicResolutionState(bool hwDynamicResRequested);

  /// @brief Method SetReferenceSize, addr 0x66699f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_maxHeight, addr 0x6666f7c, size 0x68, virtual false, abstract: false, final false
  static inline int32_t get_maxHeight();

  /// @brief Method get_maxWidth, addr 0x6666f14, size 0x68, virtual false, abstract: false, final false
  static inline int32_t get_maxWidth();

  /// @brief Method get_rtHandleProperties, addr 0x6666fe4, size 0x78, virtual false, abstract: false, final false
