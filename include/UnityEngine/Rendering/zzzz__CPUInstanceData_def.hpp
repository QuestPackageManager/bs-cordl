...
public:
  ...
  /// @brief Method IndexToInstance, addr 0x66e0a84, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::InstanceHandle IndexToInstance(int32_t index);

  /// @brief Method InstanceToIndex, addr 0x66e09e8, size 0x9c, virtual false, abstract: false, final false
  inline int32_t InstanceToIndex(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method IsValidIndex, addr 0x66e0c68, size 0x104, virtual false, abstract: false, final false
  inline bool IsValidIndex(int32_t index);

  /// @brief Method IsValidInstance, addr 0x66e0af4, size 0x174, virtual false, abstract: false, final false
  inline bool IsValidInstance(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method .ctor, addr 0x66e061c, size 0x340, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::Rendering::CPUInstanceData> instanceData);

  /// @brief Method get_handlesLength, addr 0x66e095c, size 0x44, virtual false, abstract: false, final false
  inline int32_t get_handlesLength();

  /// @brief Method get_instancesLength, addr 0x66e09a0, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x66dffcc, size 0x54, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method AddNoGrow, addr 0x66dff00, size 0x2c, virtual false, abstract: false, final false
  inline void AddNoGrow(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method AddUnsafe, addr 0x66df8e4, size 0x1f0, virtual false, abstract: false, final false
  inline void AddUnsafe(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method AsReadOnly, addr 0x66e05e8, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::CPUInstanceData_ReadOnly AsReadOnly();

  /// @brief Method Dispose, addr 0x66df59c, size 0x118, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method EnsureFreeInstances, addr 0x66dfed8, size 0x28, virtual false, abstract: false, final false
  inline void EnsureFreeInstances(int32_t instancesCount);

  /// @brief Method GetFreeInstancesCount, addr 0x66dfec8, size 0x10, virtual false, abstract: false, final false
  inline int32_t GetFreeInstancesCount();

  /// @brief Method Get_LocalToWorldIsFlipped, addr 0x66e030c, size 0x24, virtual false, abstract: false, final false
  inline bool Get_LocalToWorldIsFlipped(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_MovedInCurrentFrame, addr 0x66e0410, size 0x24, virtual false, abstract: false, final false
  inline bool Get_MovedInCurrentFrame(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_MovedInPreviousFrame, addr 0x66e0434, size 0x24, virtual false, abstract: false, final false
  inline bool Get_MovedInPreviousFrame(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_SharedInstance, addr 0x66e02ec, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::SharedInstanceHandle Get_SharedInstance(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_TetrahedronCacheIndex, addr 0x66e0374, size 0x20, virtual false, abstract: false, final false
  inline int32_t Get_TetrahedronCacheIndex(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_VisibleInPreviousFrame, addr 0x66e0458, size 0x24, virtual false, abstract: false, final false
  inline bool Get_VisibleInPreviousFrame(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_WorldAABB, addr 0x66e0330, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::AABB Get_WorldAABB(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Get_WorldBounds, addr 0x66e0394, size 0x7c, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Rendering::AABB> Get_WorldBounds(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Grow, addr 0x66df6b8, size 0x228, virtual false, abstract: false, final false
  inline void Grow(int32_t newCapacity);

  /// @brief Method IndexToInstance, addr 0x66dfb74, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::InstanceHandle IndexToInstance(int32_t index);

  /// @brief Method Initialize, addr 0x66df244, size 0x354, virtual false, abstract: false, final false
  inline void Initialize(int32_t initCapacity);

  /// @brief Method InstanceToIndex, addr 0x66dfad4, size 0xa0, virtual false, abstract: false, final false
  inline int32_t InstanceToIndex(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method IsFreeInstanceHandle, addr 0x66dfcd8, size 0x128, virtual false, abstract: false, final false
  inline bool IsFreeInstanceHandle(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method IsValidIndex, addr 0x66dfe00, size 0xc8, virtual false, abstract: false, final false
  inline bool IsValidIndex(int32_t index);

  /// @brief Method IsValidInstance, addr 0x66dfb80, size 0x158, virtual false, abstract: false, final false
  inline bool IsValidInstance(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Remove, addr 0x66e0020, size 0x1f0, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Set, addr 0x66e0214, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefault, addr 0x66dff2c, size 0xa0, virtual false, abstract: false, final false
  inline void SetDefault(::UnityEngine::Rendering::InstanceHandle instance);

  /// @brief Method Set_LocalToWorldIsFlipped, addr 0x66e04a8, size 0x34, virtual false, abstract: false, final false
  inline void Set_LocalToWorldIsFlipped(::UnityEngine::Rendering::InstanceHandle instance, bool isFlipped);

  /// @brief Method Set_MovedInCurrentFrame, addr 0x66e054c, size 0x34, virtual false, abstract: false, final false
  inline void Set_MovedInCurrentFrame(::UnityEngine::Rendering::InstanceHandle instance, bool movedInCurrentFrame);

  /// @brief Method Set_MovedInPreviousFrame, addr 0x66e0580, size 0x34, virtual false, abstract: false, final false
  inline void Set_MovedInPreviousFrame(::UnityEngine::Rendering::InstanceHandle instance, bool movedInPreviousFrame);

  /// @brief Method Set_SharedInstance, addr 0x66e047c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Set_TetrahedronCacheIndex, addr 0x66e0520, size 0x2c, virtual false, abstract: false, final false
  inline void Set_TetrahedronCacheIndex(::UnityEngine::Rendering::InstanceHandle instance, int32_t tetrahedronCacheIndex);

  /// @brief Method Set_VisibleInPreviousFrame, addr 0x66e05b4, size 0x34, virtual false, abstract: false, final false
  inline void Set_VisibleInPreviousFrame(::UnityEngine::Rendering::InstanceHandle instance, bool visibleInPreviousFrame);

  /// @brief Method Set_WorldAABB, addr 0x66e04dc, size 0x44, virtual false, abstract: false, final false
  inline void Set_WorldAABB(::UnityEngine::Rendering::InstanceHandle instance, ::ByRef<::UnityEngine::Rendering::AABB> worldBounds);

  /// @brief Method get_handlesLength, addr 0x66df1e0, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_handlesLength();

  /// @brief Method get_instancesCapacity, addr 0x66df1c8, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_instancesCapacity();

  /// @brief Method get_instancesLength, addr 0x66df1b0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_instancesLength();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable();

  /// @brief Method set_instancesCapacity, addr 0x66df1d4, size 0xc, virtual false, abstract: false, final false
  inline void set_instancesCapacity(int32_t value);

  /// @brief Method set_instancesLength, addr 0x66df1bc, size 0xc, virtual false, abstract: false, final false
