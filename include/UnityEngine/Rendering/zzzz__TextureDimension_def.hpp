...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::TextureDimension, "UnityEngine.Rendering", "TextureDimension");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::TextureDimension) == 0x4, "Size mismatch!");
