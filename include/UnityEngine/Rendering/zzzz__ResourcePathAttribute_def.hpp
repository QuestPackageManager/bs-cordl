...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResourcePathAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResourcePathAttribute(ResourcePathAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResourcePathAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResourcePathAttribute(ResourcePathAttributeconst&) = delete;
