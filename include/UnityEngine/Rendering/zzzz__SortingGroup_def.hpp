...
public:
  ...
  /// @brief Method get_invalidSortingGroupID, addr 0x2cfaeb0, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_invalidSortingGroupID();

  /// @brief Method UpdateAllSortingGroups, addr 0x2cfaed8, size 0x28, virtual false, abstract: false, final false
  static inline void UpdateAllSortingGroups();

  /// @brief Method get_sortingLayerName, addr 0x2cfaf00, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_sortingLayerName();

  /// @brief Method set_sortingLayerName, addr 0x2cfaf3c, size 0x44, virtual false, abstract: false, final false
  inline void set_sortingLayerName(::StringW value);

  /// @brief Method get_sortingLayerID, addr 0x2cfaf80, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_sortingLayerID();

  /// @brief Method set_sortingLayerID, addr 0x2cfafbc, size 0x44, virtual false, abstract: false, final false
  inline void set_sortingLayerID(int32_t value);

  /// @brief Method get_sortingOrder, addr 0x2cfb000, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_sortingOrder();

  /// @brief Method set_sortingOrder, addr 0x2cfb03c, size 0x44, virtual false, abstract: false, final false
  inline void set_sortingOrder(int32_t value);

  /// @brief Method get_sortingGroupID, addr 0x2cfb080, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_sortingGroupID();

  /// @brief Method get_sortingGroupOrder, addr 0x2cfb0bc, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_sortingGroupOrder();

  /// @brief Method get_index, addr 0x2cfb0f8, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_index();

  static inline ::UnityEngine::Rendering::SortingGroup* New_ctor();

  /// @brief Method .ctor, addr 0x2cfb134, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
