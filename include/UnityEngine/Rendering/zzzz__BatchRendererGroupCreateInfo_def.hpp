...
// Ctor Parameters [CppParam { name: "cullingCallback", ty: "::UnityEngine::Rendering::BatchRendererGroup_OnPerformCulling*", modifiers: "", def_value: None }, CppParam { name: "finishedCullingCallback", ty: "::UnityEngine::Rendering::BatchRendererGroup_OnFinishedCulling*", modifiers: "", def_value: None }, CppParam { name: "userContext", ty: "::System::IntPtr", modifiers: "", def_value: None }]
constexpr BatchRendererGroupCreateInfo(::UnityEngine::Rendering::BatchRendererGroup_OnPerformCulling*  cullingCallback, ::UnityEngine::Rendering::BatchRendererGroup_OnFinishedCulling*  finishedCullingCallback, ::System::IntPtr  userContext) noexcept;
