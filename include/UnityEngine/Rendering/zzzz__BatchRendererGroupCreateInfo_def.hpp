...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchRendererGroupCreateInfo, "UnityEngine.Rendering", "BatchRendererGroupCreateInfo");
...
static_assert(sizeof(::UnityEngine::Rendering::BatchRendererGroupCreateInfo) == 0x18, "Size mismatch!");
