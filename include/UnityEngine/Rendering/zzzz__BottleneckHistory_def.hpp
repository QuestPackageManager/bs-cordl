...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::BottleneckHistory*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BottleneckHistory*, "UnityEngine.Rendering", "BottleneckHistory");
...
public:
  ...
  /// @brief Method AddBottleneckFromAveragedSample, addr 0x675ba9c, size 0xdc, virtual false, abstract: false, final false
  inline void AddBottleneckFromAveragedSample(::UnityEngine::Rendering::FrameTimeSample frameHistorySampleAverage);

  /// @brief Method Clear, addr 0x675d294, size 0x5c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeHistogram, addr 0x675bb78, size 0x118, virtual false, abstract: false, final false
  inline void ComputeHistogram();

  /// @brief Method DetermineBottleneck, addr 0x6767b6c, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::PerformanceBottleneck DetermineBottleneck(::UnityEngine::Rendering::FrameTimeSample s);

  /// @brief Method DiscardOldSamples, addr 0x675b9ec, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675b36c, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Rendering::BottleneckHistory) == 0x28, "Size mismatch!");
