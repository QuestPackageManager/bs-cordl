...
/// @brief Field m_Bottlenecks, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Bottlenecks, put=__cordl_internal_set_m_Bottlenecks)) ::System::Collections::Generic::List_1<::UnityEngine::Rendering::PerformanceBottleneck>*  m_Bottlenecks;

/// @brief Method AddBottleneckFromAveragedSample, addr 0x65aa80c, size 0xdc, virtual false, abstract: false, final false
inline void AddBottleneckFromAveragedSample(::UnityEngine::Rendering::FrameTimeSample  frameHistorySampleAverage) ;

/// @brief Method Clear, addr 0x65ac004, size 0x5c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeHistogram, addr 0x65aa8e8, size 0x118, virtual false, abstract: false, final false
inline void ComputeHistogram() ;

/// @brief Method DetermineBottleneck, addr 0x65b68dc, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::PerformanceBottleneck DetermineBottleneck(::UnityEngine::Rendering::FrameTimeSample  s) ;

/// @brief Method DiscardOldSamples, addr 0x65aa75c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65aa0dc, size 0xac, virtual false, abstract: false, final false
