...
/// @brief Method AddBottleneckFromAveragedSample, addr 0x661e390, size 0xdc, virtual false, abstract: false, final false
inline void AddBottleneckFromAveragedSample(::UnityEngine::Rendering::FrameTimeSample  frameHistorySampleAverage) ;

/// @brief Method Clear, addr 0x661fb88, size 0x5c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeHistogram, addr 0x661e46c, size 0x118, virtual false, abstract: false, final false
inline void ComputeHistogram() ;

/// @brief Method DetermineBottleneck, addr 0x662a460, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::PerformanceBottleneck DetermineBottleneck(::UnityEngine::Rendering::FrameTimeSample  s) ;

/// @brief Method DiscardOldSamples, addr 0x661e2e0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x661dc60, size 0xac, virtual false, abstract: false, final false
