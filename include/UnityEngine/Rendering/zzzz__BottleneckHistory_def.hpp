...
public:
  ...
  /// @brief Method AddBottleneckFromAveragedSample, addr 0x661c818, size 0xdc, virtual false, abstract: false, final false
  inline void AddBottleneckFromAveragedSample(::UnityEngine::Rendering::FrameTimeSample frameHistorySampleAverage);

  /// @brief Method Clear, addr 0x661e010, size 0x5c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeHistogram, addr 0x661c8f4, size 0x118, virtual false, abstract: false, final false
  inline void ComputeHistogram();

  /// @brief Method DetermineBottleneck, addr 0x66288e8, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::PerformanceBottleneck DetermineBottleneck(::UnityEngine::Rendering::FrameTimeSample s);

  /// @brief Method DiscardOldSamples, addr 0x661c768, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x661c0e8, size 0xac, virtual false, abstract: false, final false
