...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BottleneckHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BottleneckHistory(BottleneckHistory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BottleneckHistory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BottleneckHistory(BottleneckHistoryconst&) = delete;
