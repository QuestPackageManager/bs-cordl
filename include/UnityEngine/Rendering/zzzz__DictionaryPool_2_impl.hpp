...
::cordl_internals::setStaticField<::UnityEngine::Rendering::DictionaryPool_2___c<TKey,TValue>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DictionaryPool_2___c<TKey,TValue>*>::get>(std::forward<::UnityEngine::Rendering::DictionaryPool_2___c<TKey,TValue>*>(value));
}
template<typename TKey,typename TValue>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::DictionaryPool_2___c<TKey,TValue>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DictionaryPool_2___c<TKey,TValue>*>::get>();
}
template<typename TKey,typename TValue>
...
::cordl_internals::setStaticField<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DictionaryPool_2<TKey,TValue>*>::get>(std::forward<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>*>(value));
}
template<typename TKey,typename TValue>
...
return ::cordl_internals::getStaticField<::UnityEngine::Rendering::ObjectPool_1<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DictionaryPool_2<TKey,TValue>*>::get>();
}
template<typename TKey,typename TValue>
...
template<typename TKey,typename TValue>
inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::Dictionary_2<TKey,TValue>*> UnityEngine::Rendering::DictionaryPool_2<TKey,TValue>::Get(::ByRef<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::DictionaryPool_2<TKey,TValue>*>::get(),
                        "Get",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>, false>(nullptr, ___internal_method, value);
}
template<typename TKey,typename TValue>
