...
public:
  ...
  /// @brief Method .ctor, addr 0x6687b74, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <FindParameters>b__10_0, addr 0x6687bd8, size 0x24, virtual false, abstract: false, final false
  inline int32_t _FindParameters_b__10_0(::System::Reflection::FieldInfo* t);

  /// @brief Method .ctor, addr 0x6687bd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AnyPropertiesIsOverridden, addr 0x6687968, size 0xb0, virtual false, abstract: false, final false
  inline bool AnyPropertiesIsOverridden();

  /// @brief Method FindParameters, addr 0x6686930, size 0x63c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x66878b4, size 0xb4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::Rendering::VolumeComponent* New_ctor();

  /// @brief Method OnDestroy, addr 0x6687a18, size 0x4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x6687180, size 0x104, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x6686f6c, size 0x214, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Override, addr 0x6687284, size 0x130, virtual true, abstract: false, final false
  inline void Override(::UnityEngine::Rendering::VolumeComponent* state, float_t interpFactor);

  /// @brief Method Release, addr 0x6687a1c, size 0xb4, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method SetAllOverridesTo, addr 0x66873b4, size 0x10, virtual false, abstract: false, final false
  inline void SetAllOverridesTo(bool state);

  /// @brief Method SetOverridesTo, addr 0x66873c4, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6687ad0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_displayName, addr 0x66868bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_parameters, addr 0x66868cc, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Rendering::VolumeParameter*>* get_parameters();

  /// @brief Method set_displayName, addr 0x66868c4, size 0x8, virtual false, abstract: false, final false
