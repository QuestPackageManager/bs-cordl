...
public:
  ...
  /// @brief Method Execute, addr 0x66d7690, size 0x144, virtual true, abstract: false, final true
  inline void Execute(int32_t index);

  /// @brief Method IncrementCounter, addr 0x66d7640, size 0x50, virtual false, abstract: false, final false
