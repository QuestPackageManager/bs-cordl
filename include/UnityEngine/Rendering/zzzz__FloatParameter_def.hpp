...
public:
  // Declarations
  /// @brief Method Interp, addr 0x67c745c, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67c73f0, size 0x6c, virtual false, abstract: false, final false
