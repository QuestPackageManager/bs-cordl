...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatParameter(FloatParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatParameter(FloatParameterconst&) = delete;
