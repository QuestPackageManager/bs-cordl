...
public:
  ...
  /// @brief Method .ctor, addr 0x675667c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AdditionalPropertyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AdditionalPropertyAttribute(AdditionalPropertyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AdditionalPropertyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AdditionalPropertyAttribute(AdditionalPropertyAttributeconst&) = delete;
