...
public:
  ...
  /// @brief Method Awake, addr 0x678c454, size 0x30, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x678c484, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
