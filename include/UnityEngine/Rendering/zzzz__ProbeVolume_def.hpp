...
/// @brief Method Awake, addr 0x65db1c4, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x65db1f4, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
