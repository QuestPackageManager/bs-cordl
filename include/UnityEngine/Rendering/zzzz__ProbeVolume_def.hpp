...
public:
  ...
  /// @brief Method Awake, addr 0x664d1d0, size 0x30, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x664d200, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
