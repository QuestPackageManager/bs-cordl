...
public:
  ...
  /// @brief Method SetRTHandleStaticWrapper, addr 0x66663f8, size 0xcc, virtual false, abstract: false, final false
  static inline void SetRTHandleStaticWrapper(::UnityEngine::Rendering::RenderTargetIdentifier rtId);

  /// @brief Method SetRTHandleUserManagedWrapper, addr 0x6666568, size 0x30, virtual false, abstract: false, final false
