...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::ShadowCastingMode, "UnityEngine.Rendering", "ShadowCastingMode");
// Dependencies
namespace UnityEngine::Rendering {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Rendering::ShadowCastingMode) == 0x4, "Size mismatch!");
