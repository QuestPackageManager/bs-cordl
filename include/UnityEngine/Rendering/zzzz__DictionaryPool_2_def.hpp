...
/// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::ObjectPool_1_PooledObject<::System::Collections::Generic::Dictionary_2<TKey,TValue>*> Get(::ByRef<::System::Collections::Generic::Dictionary_2<TKey,TValue>*>  value) ;
