...
public:
  ...
  /// @brief Method Equals, addr 0x69ccb94, size 0x100, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69cc8f0, size 0x298, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::RendererListParams other);

  /// @brief Method GetHashCode, addr 0x69ccc94, size 0x10c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Validate, addr 0x69cc510, size 0x3e0, virtual false, abstract: false, final false
  inline void Validate();

  /// @brief Method .ctor, addr 0x69cc30c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_numStateBlocks, addr 0x69cc3b0, size 0x68, virtual false, abstract: false, final false
  inline int32_t get_numStateBlocks();

  /// @brief Method get_stateBlocksPtr, addr 0x69cc418, size 0x7c, virtual false, abstract: false, final false
  inline ::System::IntPtr get_stateBlocksPtr();

  /// @brief Method get_tagsValuePtr, addr 0x69cc494, size 0x7c, virtual false, abstract: false, final false
