...
// Dependencies System.Nullable`1<T>, Unity.Collections.NativeArray`1<T>, UnityEngine.Rendering.CullingResults, UnityEngine.Rendering.DrawingSettings, UnityEngine.Rendering.FilteringSettings, UnityEngine.Rendering.RenderStateBlock, UnityEngine.Rendering.ShaderTagId
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Equals, addr 0x695a94c, size 0x100, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x695a6a8, size 0x298, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RendererListParams  other) ;

/// @brief Method GetHashCode, addr 0x695aa4c, size 0x10c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Validate, addr 0x695a2c8, size 0x3e0, virtual false, abstract: false, final false
inline void Validate() ;

/// @brief Method .ctor, addr 0x695a0c4, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method get_numStateBlocks, addr 0x695a168, size 0x68, virtual false, abstract: false, final false
inline int32_t get_numStateBlocks() ;

/// @brief Method get_stateBlocksPtr, addr 0x695a1d0, size 0x7c, virtual false, abstract: false, final false
inline ::System::IntPtr get_stateBlocksPtr() ;

/// @brief Method get_tagsValuePtr, addr 0x695a24c, size 0x7c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "cullingResults", ty: "::UnityEngine::Rendering::CullingResults", modifiers: "", def_value: None }, CppParam { name: "drawSettings", ty: "::UnityEngine::Rendering::DrawingSettings", modifiers: "", def_value: None }, CppParam { name: "filteringSettings", ty: "::UnityEngine::Rendering::FilteringSettings", modifiers: "", def_value: None }, CppParam { name: "tagName", ty: "::UnityEngine::Rendering::ShaderTagId", modifiers: "", def_value: None }, CppParam { name: "isPassTagName", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "tagValues", ty: "::System::Nullable_1<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::ShaderTagId>>", modifiers: "", def_value: None }, CppParam { name: "stateBlocks", ty: "::System::Nullable_1<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::RenderStateBlock>>", modifiers: "", def_value: None }]
constexpr RendererListParams(::UnityEngine::Rendering::CullingResults  cullingResults, ::UnityEngine::Rendering::DrawingSettings  drawSettings, ::UnityEngine::Rendering::FilteringSettings  filteringSettings, ::UnityEngine::Rendering::ShaderTagId  tagName, bool  isPassTagName, ::System::Nullable_1<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::ShaderTagId>>  tagValues, ::System::Nullable_1<::Unity::Collections::NativeArray_1<::UnityEngine::Rendering::RenderStateBlock>>  stateBlocks) noexcept;
