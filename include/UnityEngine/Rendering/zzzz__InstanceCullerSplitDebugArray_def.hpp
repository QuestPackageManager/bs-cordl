...
public:
  ...
  /// @brief Method AddSync, addr 0x68133a0, size 0x8c, virtual false, abstract: false, final false
  inline void AddSync(int32_t baseIndex, ::Unity::Jobs::JobHandle jobHandle);

  /// @brief Method Dispose, addr 0x6813224, size 0x94, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Init, addr 0x681314c, size 0xd8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MoveToDebugStatsAndClear, addr 0x681342c, size 0x260, virtual false, abstract: false, final false
  inline void MoveToDebugStatsAndClear(::UnityEngine::Rendering::DebugRendererBatcherStats* debugStats);

  /// @brief Method TryAddSplits, addr 0x68132b8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Counters, addr 0x6813140, size 0xc, virtual false, abstract: false, final false
