...
public:
  ...
  /// @brief Method IsSupported, addr 0x667e0e4, size 0x34, virtual false, abstract: false, final false
  static inline bool IsSupported();

  /// @brief Method SetEasuConstants, addr 0x667dfd0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEasuConstants, addr 0x667de4c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method SetRcasConstants, addr 0x667dfe4, size 0xc8, virtual false, abstract: false, final false
  static inline void SetRcasConstants(::UnityEngine::Rendering::CommandBuffer* cmd, float_t sharpnessStops);

  /// @brief Method SetRcasConstantsLinear, addr 0x667e0ac, size 0x14, virtual false, abstract: false, final false
  static inline void SetRcasConstantsLinear(::UnityEngine::Rendering::CommandBuffer* cmd, float_t sharpnessLinear);

  /// @brief Method SetRcasConstantsLinear, addr 0x667e0c0, size 0x24, virtual false, abstract: false, final false
