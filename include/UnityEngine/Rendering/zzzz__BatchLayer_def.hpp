...
// Write type traits
MARK_REF_T(::UnityEngine::Rendering::BatchLayer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::BatchLayer*, "UnityEngine.Rendering", "BatchLayer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x680a31c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BatchLayer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BatchLayer(BatchLayer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BatchLayer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BatchLayer(BatchLayerconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Rendering::BatchLayer) == 0x10, "Size mismatch!");
