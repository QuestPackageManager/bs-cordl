...
// Dependencies Unity.Collections.NativeArray`1<T>, Unity.Collections.NativeList`1<T>, Unity.Collections.NativeParallelHashMap`2<TKey, TValue>, UnityEngine.Rendering.DrawBatch, UnityEngine.Rendering.DrawInstance, UnityEngine.Rendering.DrawKey, UnityEngine.Rendering.DrawRange, UnityEngine.Rendering.RangeKey
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Execute, addr 0x6665f38, size 0x1e0, virtual true, abstract: false, final true
inline void Execute() ;

/// @brief Method RemoveDrawBatch, addr 0x6665cc8, size 0x270, virtual false, abstract: false, final false
inline void RemoveDrawBatch(::ByRef<::UnityEngine::Rendering::DrawKey>  key) ;

/// @brief Method RemoveDrawRange, addr 0x6665b24, size 0x1a4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "drawInstanceIndices", ty: "::Unity::Collections::NativeArray_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawInstances", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>", modifiers: "", def_value: None }, CppParam { name: "rangeHash", ty: "::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::RangeKey,int32_t>", modifiers: "", def_value: None }, CppParam { name: "batchHash", ty: "::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawRanges", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawRange>", modifiers: "", def_value: None }, CppParam { name: "drawBatches", ty: "::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>", modifiers: "", def_value: None }]
constexpr RemoveDrawInstanceIndicesJob(::Unity::Collections::NativeArray_1<int32_t>  drawInstanceIndices, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawInstance>  drawInstances, ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::RangeKey,int32_t>  rangeHash, ::Unity::Collections::NativeParallelHashMap_2<::UnityEngine::Rendering::DrawKey,int32_t>  batchHash, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawRange>  drawRanges, ::Unity::Collections::NativeList_1<::UnityEngine::Rendering::DrawBatch>  drawBatches) noexcept;
