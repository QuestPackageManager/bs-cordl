...
MARK_REF_T(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass50_0*);
MARK_REF_T(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass51_0*);
...
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass50_0*, "UnityEngine.Rendering", "LensFlareCommonSRP/<>c__DisplayClass50_0");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass51_0*, "UnityEngine.Rendering", "LensFlareCommonSRP/<>c__DisplayClass51_0");
DEFINE_IL2CPP_CLASS(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass74_0, "UnityEngine.Rendering", "LensFlareCommonSRP/<>c__DisplayClass74_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6794c44, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddData>b__0, addr 0x679bd80, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6794c40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveData>b__0, addr 0x679bdfc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6794e94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Rendering::LensFlareCommonSRP___c__DisplayClass74_0) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddData, addr 0x6794a5c, size 0x1e4, virtual false, abstract: false, final false
  inline void AddData(::UnityEngine::Rendering::LensFlareComponentSRP* newData);

  /// @brief Method CalcCropExtents, addr 0x679b508, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcCropExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView, float_t d);

  /// @brief Method CalcViewExtents, addr 0x679b4c4, size 0x44, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcViewExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView);

  /// @brief Method ComputeOcclusion, addr 0x6796434, size 0xfec, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeOcclusion, addr 0x67961a0, size 0x13c, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::CommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
  ...
  /// @brief Method ComputeOcclusion, addr 0x67962dc, size 0x158, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
                                      ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture);

  /// @brief Method ComputeOcclusion, addr 0x6796048, size 0x158, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
                                      ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture, int32_t _FlareOcclusionTex, int32_t _FlareCloudOpacity,
  ...
  /// @brief Method Dispose, addr 0x67945d8, size 0xd0, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x679a4c4, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x6799508, size 0xfbc, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::CommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x6799180, size 0x1b4, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x6799334, size 0x1d4, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x679b258, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x679a8c8, size 0x990, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x679a678, size 0x250, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoPaniniProjection, addr 0x6797458, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ForceSingleElement, addr 0x6797420, size 0x38, virtual false, abstract: false, final false
  static inline bool ForceSingleElement(::UnityEngine::Rendering::LensFlareDataElementSRP* element);

  /// @brief Method GetFlareData0, addr 0x67957f8, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLensFlareRayOffset, addr 0x6795a10, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAvailableIndex, addr 0x679491c, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetNextAvailableIndex();

  /// @brief Method GetOcclusionRTFormat, addr 0x6794384, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetOcclusionRTFormat();

  /// @brief Method Initialize, addr 0x67943f0, size 0x1e8, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method IsCloudLayerOpacityNeeded, addr 0x6795cd8, size 0x248, virtual false, abstract: false, final false
  static inline bool IsCloudLayerOpacityNeeded(::UnityEngine::Camera* cam);

  /// @brief Method IsEmpty, addr 0x6794884, size 0x98, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsLensFlareSRPHidden, addr 0x67956d0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOcclusionRTCompatible, addr 0x6794260, size 0x124, virtual false, abstract: false, final false
  static inline bool IsOcclusionRTCompatible();

  static inline ::UnityEngine::Rendering::LensFlareCommonSRP* New_ctor();

  /// @brief Method Panini_Generic_Inv, addr 0x679b5d0, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Panini_Generic_Inv(::UnityEngine::Vector2 projPos, float_t d);

  /// @brief Method ProcessLensFlareSRPElements, addr 0x6798db4, size 0x1d8, virtual false, abstract: false, final false
  static inline void ProcessLensFlareSRPElements(::by_ref<::ArrayW<::UnityEngine::Rendering::LensFlareDataElementSRP*>> elements, ::UnityEngine::Rendering::CommandBuffer* cmd,
  ...
  /// @brief Method ProcessLensFlareSRPElementsSingle, addr 0x6797694, size 0x1720, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveData, addr 0x6794c50, size 0x244, virtual false, abstract: false, final false
  inline void RemoveData(::UnityEngine::Rendering::LensFlareComponentSRP* data);

  /// @brief Method SetOcclusionPermutation, addr 0x6795f20, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuateForwardLight, addr 0x6795578, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuateForwardLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaDiscLight, addr 0x6795634, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaDiscLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaRectangleLight, addr 0x6795598, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaRectangleLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaTubeLight, addr 0x6795050, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationDirLight, addr 0x6794ea0, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationDirLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationPointLight, addr 0x6794e98, size 0x8, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationPointLight();

  /// @brief Method ShapeAttenuationSpotBoxLight, addr 0x6794f74, size 0x30, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotBoxLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationSpotConeLight, addr 0x6794ec0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationSpotPyramidLight, addr 0x6794fa4, size 0xac, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotPyramidLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method WorldToViewport, addr 0x6795a44, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToViewportDistance, addr 0x6795c18, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 WorldToViewportDistance(::UnityEngine::Camera* cam, ::UnityEngine::Vector3 positionWS);

  /// @brief Method WorldToViewportLocal, addr 0x6795b9c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessLensFlareSRPElementsSingle>g__ComputeLocalSize|74_0, addr 0x6798f8c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessLensFlareSRPElementsSingle>g__RandomRange|74_1, addr 0x6799140, size 0x40, virtual false, abstract: false, final false
  static inline float_t _ProcessLensFlareSRPElementsSingle_g__RandomRange_74_1(float_t min, float_t max);

  /// @brief Method <ShapeAttenuationAreaTubeLight>g__DiffLineIntegral|57_2, addr 0x6795284, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method <ShapeAttenuationAreaTubeLight>g__Fpo|57_0, addr 0x679bd28, size 0x40, virtual false, abstract: false, final false
  static inline float_t _ShapeAttenuationAreaTubeLight_g__Fpo_57_0(float_t d, float_t l);

  /// @brief Method <ShapeAttenuationAreaTubeLight>g__Fwt|57_1, addr 0x679bd68, size 0x18, virtual false, abstract: false, final false
  static inline float_t _ShapeAttenuationAreaTubeLight_g__Fwt_57_1(float_t d, float_t l);

  /// @brief Method .ctor, addr 0x679425c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Data, addr 0x6794828, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::LensFlareCommonSRP_LensFlareCompInfo*>* get_Data();

  /// @brief Method get_Instance, addr 0x67946a8, size 0x180, virtual false, abstract: false, final false
