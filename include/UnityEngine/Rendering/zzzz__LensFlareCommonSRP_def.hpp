...
public:
  ...
  /// @brief Method .ctor, addr 0x66559c0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddData>b__0, addr 0x665cafc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66559bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveData>b__0, addr 0x665cb78, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6655c10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddData, addr 0x66557d8, size 0x1e4, virtual false, abstract: false, final false
  inline void AddData(::UnityEngine::Rendering::LensFlareComponentSRP* newData);

  /// @brief Method CalcCropExtents, addr 0x665c284, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcCropExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView, float_t d);

  /// @brief Method CalcViewExtents, addr 0x665c240, size 0x44, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcViewExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView);

  /// @brief Method ComputeOcclusion, addr 0x66571b0, size 0xfec, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeOcclusion, addr 0x6656f1c, size 0x13c, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::CommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
  ...
  /// @brief Method ComputeOcclusion, addr 0x6657058, size 0x158, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
                                      ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture);

  /// @brief Method ComputeOcclusion, addr 0x6656dc4, size 0x158, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
                                      ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled, bool hasCloudLayer,
                                      ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture, int32_t _FlareOcclusionTex, int32_t _FlareCloudOpacity,
  ...
  /// @brief Method Dispose, addr 0x6655354, size 0xd0, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x665b240, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x665a284, size 0xfbc, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::CommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x6659efc, size 0x1b4, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x665a0b0, size 0x1d4, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x665bfd4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x665b644, size 0x990, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x665b3f4, size 0x250, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoPaniniProjection, addr 0x66581d4, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ForceSingleElement, addr 0x665819c, size 0x38, virtual false, abstract: false, final false
  static inline bool ForceSingleElement(::UnityEngine::Rendering::LensFlareDataElementSRP* element);

  /// @brief Method GetFlareData0, addr 0x6656574, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLensFlareRayOffset, addr 0x665678c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAvailableIndex, addr 0x6655698, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetNextAvailableIndex();

  /// @brief Method GetOcclusionRTFormat, addr 0x6655100, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetOcclusionRTFormat();

  /// @brief Method Initialize, addr 0x665516c, size 0x1e8, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method IsCloudLayerOpacityNeeded, addr 0x6656a54, size 0x248, virtual false, abstract: false, final false
  static inline bool IsCloudLayerOpacityNeeded(::UnityEngine::Camera* cam);

  /// @brief Method IsEmpty, addr 0x6655600, size 0x98, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsLensFlareSRPHidden, addr 0x665644c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOcclusionRTCompatible, addr 0x6654fdc, size 0x124, virtual false, abstract: false, final false
  static inline bool IsOcclusionRTCompatible();

  static inline ::UnityEngine::Rendering::LensFlareCommonSRP* New_ctor();

  /// @brief Method Panini_Generic_Inv, addr 0x665c34c, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Panini_Generic_Inv(::UnityEngine::Vector2 projPos, float_t d);

  /// @brief Method ProcessLensFlareSRPElements, addr 0x6659b30, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessLensFlareSRPElementsSingle, addr 0x6658410, size 0x1720, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveData, addr 0x66559cc, size 0x244, virtual false, abstract: false, final false
  inline void RemoveData(::UnityEngine::Rendering::LensFlareComponentSRP* data);

  /// @brief Method SetOcclusionPermutation, addr 0x6656c9c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuateForwardLight, addr 0x66562f4, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuateForwardLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaDiscLight, addr 0x66563b0, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaDiscLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaRectangleLight, addr 0x6656314, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaRectangleLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaTubeLight, addr 0x6655dcc, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationDirLight, addr 0x6655c1c, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationDirLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationPointLight, addr 0x6655c14, size 0x8, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationPointLight();

  /// @brief Method ShapeAttenuationSpotBoxLight, addr 0x6655cf0, size 0x30, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotBoxLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationSpotConeLight, addr 0x6655c3c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationSpotPyramidLight, addr 0x6655d20, size 0xac, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotPyramidLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method WorldToViewport, addr 0x66567c0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToViewportDistance, addr 0x6656994, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 WorldToViewportDistance(::UnityEngine::Camera* cam, ::UnityEngine::Vector3 positionWS);

  /// @brief Method WorldToViewportLocal, addr 0x6656918, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessLensFlareSRPElementsSingle>g__ComputeLocalSize|74_0, addr 0x6659d08, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessLensFlareSRPElementsSingle>g__RandomRange|74_1, addr 0x6659ebc, size 0x40, virtual false, abstract: false, final false
  static inline float_t _ProcessLensFlareSRPElementsSingle_g__RandomRange_74_1(float_t min, float_t max);

  /// @brief Method <ShapeAttenuationAreaTubeLight>g__DiffLineIntegral|57_2, addr 0x6656000, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method <ShapeAttenuationAreaTubeLight>g__Fpo|57_0, addr 0x665caa4, size 0x40, virtual false, abstract: false, final false
  static inline float_t _ShapeAttenuationAreaTubeLight_g__Fpo_57_0(float_t d, float_t l);

  /// @brief Method <ShapeAttenuationAreaTubeLight>g__Fwt|57_1, addr 0x665cae4, size 0x18, virtual false, abstract: false, final false
  static inline float_t _ShapeAttenuationAreaTubeLight_g__Fwt_57_1(float_t d, float_t l);

  /// @brief Method .ctor, addr 0x6654fd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Data, addr 0x66555a4, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::LensFlareCommonSRP_LensFlareCompInfo*>* get_Data();

  /// @brief Method get_Instance, addr 0x6655424, size 0x180, virtual false, abstract: false, final false
