...
public:
  ...
  /// @brief Method .ctor, addr 0x679a45c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddData>b__0, addr 0x67a1598, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679a458, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveData>b__0, addr 0x67a1614, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679a6ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddData, addr 0x679a274, size 0x1e4, virtual false, abstract: false, final false
  inline void AddData(::UnityEngine::Rendering::LensFlareComponentSRP* newData);

  /// @brief Method CalcCropExtents, addr 0x67a0d20, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcCropExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView, float_t d);

  /// @brief Method CalcViewExtents, addr 0x67a0cdc, size 0x44, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 CalcViewExtents(float_t actualWidth, float_t actualHeight, float_t fieldOfView);

  /// @brief Method ComputeOcclusion, addr 0x679bc4c, size 0xfec, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeOcclusion, addr 0x679baf4, size 0x158, virtual false, abstract: false, final false
  static inline void ComputeOcclusion(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Experimental::Rendering::XRPass* xr, int32_t xrIndex, float_t actualWidth,
                                      float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative, ::UnityEngine::Vector3 cameraPositionWS,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x679ed20, size 0xfbc, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::CommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareDataDrivenCommon, addr 0x679eb4c, size 0x1d4, virtual false, abstract: false, final false
  static inline void DoLensFlareDataDrivenCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, ::UnityEngine::Rect viewport, ::UnityEngine::Experimental::Rendering::XRPass* xr,
                                                 int32_t xrIndex, float_t actualWidth, float_t actualHeight, bool usePanini, float_t paniniDistance, float_t paniniCropToFit, bool isCameraRelative,
                                                 ::UnityEngine::Vector3 cameraPositionWS, ::UnityEngine::Matrix4x4 viewProjMatrix, ::UnityEngine::Rendering::UnsafeCommandBuffer* cmd, bool taaEnabled,
                                                 bool hasCloudLayer, ::UnityEngine::Texture* cloudOpacityTexture, ::UnityEngine::Texture* sunOcclusionTexture,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x67a00e0, size 0x990, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoLensFlareScreenSpaceCommon, addr 0x679fe90, size 0x250, virtual false, abstract: false, final false
  static inline void DoLensFlareScreenSpaceCommon(::UnityEngine::Material* lensFlareShader, ::UnityEngine::Camera* cam, float_t actualWidth, float_t actualHeight, ::UnityEngine::Color tintColor,
                                                  ::UnityEngine::Texture* originalBloomTexture, ::UnityEngine::Texture* bloomMipTexture, ::UnityEngine::Texture* spectralLut,
                                                  ::UnityEngine::Texture* streakTextureTmp, ::UnityEngine::Texture* streakTextureTmp2, ::UnityEngine::Vector4 parameters1,
                                                  ::UnityEngine::Vector4 parameters2, ::UnityEngine::Vector4 parameters3, ::UnityEngine::Vector4 parameters4, ::UnityEngine::Vector4 parameters5,
  ...
  /// @brief Method DoPaniniProjection, addr 0x679cc70, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ForceSingleElement, addr 0x679cc38, size 0x38, virtual false, abstract: false, final false
  static inline bool ForceSingleElement(::UnityEngine::Rendering::LensFlareDataElementSRP* element);

  /// @brief Method GetFlareData0, addr 0x679b010, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLensFlareRayOffset, addr 0x679b228, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAvailableIndex, addr 0x679a134, size 0x140, virtual false, abstract: false, final false
  inline int32_t GetNextAvailableIndex();

  /// @brief Method GetOcclusionRTFormat, addr 0x6799b9c, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetOcclusionRTFormat();

  /// @brief Method Initialize, addr 0x6799c08, size 0x1e8, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method IsCloudLayerOpacityNeeded, addr 0x679b4f0, size 0x248, virtual false, abstract: false, final false
  static inline bool IsCloudLayerOpacityNeeded(::UnityEngine::Camera* cam);

  /// @brief Method IsEmpty, addr 0x679a09c, size 0x98, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsLensFlareSRPHidden, addr 0x679aee8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOcclusionRTCompatible, addr 0x6799a78, size 0x124, virtual false, abstract: false, final false
  static inline bool IsOcclusionRTCompatible();

  static inline ::UnityEngine::Rendering::LensFlareCommonSRP* New_ctor();

  /// @brief Method Panini_Generic_Inv, addr 0x67a0de8, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Panini_Generic_Inv(::UnityEngine::Vector2 projPos, float_t d);

  /// @brief Method ProcessLensFlareSRPElements, addr 0x679e5cc, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessLensFlareSRPElementsSingle, addr 0x679ceac, size 0x1720, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveData, addr 0x679a468, size 0x244, virtual false, abstract: false, final false
  inline void RemoveData(::UnityEngine::Rendering::LensFlareComponentSRP* data);

  /// @brief Method SetOcclusionPermutation, addr 0x679b738, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuateForwardLight, addr 0x679ad90, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuateForwardLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaDiscLight, addr 0x679ae4c, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaDiscLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaRectangleLight, addr 0x679adb0, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationAreaRectangleLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationAreaTubeLight, addr 0x679a868, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationDirLight, addr 0x679a6b8, size 0x20, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationDirLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationPointLight, addr 0x679a6b0, size 0x8, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationPointLight();

  /// @brief Method ShapeAttenuationSpotBoxLight, addr 0x679a78c, size 0x30, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotBoxLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method ShapeAttenuationSpotConeLight, addr 0x679a6d8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShapeAttenuationSpotPyramidLight, addr 0x679a7bc, size 0xac, virtual false, abstract: false, final false
  static inline float_t ShapeAttenuationSpotPyramidLight(::UnityEngine::Vector3 forward, ::UnityEngine::Vector3 wo);

  /// @brief Method WorldToViewport, addr 0x679b25c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToViewportDistance, addr 0x679b430, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6799a74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Data, addr 0x679a040, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Rendering::LensFlareCommonSRP_LensFlareCompInfo*>* get_Data();

  /// @brief Method get_Instance, addr 0x6799ec0, size 0x180, virtual false, abstract: false, final false
