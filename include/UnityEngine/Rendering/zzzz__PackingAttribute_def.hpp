...
/// @brief Method .ctor, addr 0x6660524, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6660434, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::StringW,::Array<::StringW>*>  displayNames, ::UnityEngine::Rendering::FieldPacking  packingScheme, int32_t  bitSize, int32_t  offsetInSource, float_t  minValue, float_t  maxValue, bool  isDirection, bool  sRGBDisplay, bool  checkIsNormalized, ::StringW  preprocessor) ;
