...
public:
  ...
  static inline ::UnityEngine::Rendering::PackingAttribute* New_ctor(::ArrayW<::StringW> displayNames, ::UnityEngine::Rendering::FieldPacking packingScheme, int32_t bitSize, int32_t offsetInSource,
                                                                     float_t minValue, float_t maxValue, bool isDirection, bool sRGBDisplay, bool checkIsNormalized, ::StringW preprocessor);
  ...
  /// @brief Method .ctor, addr 0x679dc30, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679db40, size 0xf0, virtual false, abstract: false, final false
