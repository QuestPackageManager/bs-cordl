...
public:
  ...
  /// @brief Method Equals, addr 0x69c643c, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69c5c74, size 0x7c8, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Rendering::CameraProperties other);

  /// @brief Method GetCameraCullingPlane, addr 0x69c5ba8, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Plane GetCameraCullingPlane(int32_t index);

  /// @brief Method GetHashCode, addr 0x69c64f8, size 0x530, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetShadowCullingPlane, addr 0x69c5adc, size 0xcc, virtual false, abstract: false, final false
