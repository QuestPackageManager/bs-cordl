...
// Dependencies UnityEngine.Matrix4x4, UnityEngine.Rect, UnityEngine.Rendering.CameraProperties::<layerCullDistances>e__FixedBuffer, UnityEngine.Rendering.CameraProperties::<m_CameraCullPlanes>e__FixedBuffer, UnityEngine.Rendering.CameraProperties::<m_ShadowCullPlanes>e__FixedBuffer, UnityEngine.Rendering.CoreCameraValues, UnityEngine.Vector3
namespace UnityEngine::Rendering {
// Is value type: true
...
/// @brief Method Equals, addr 0x69c7fb4, size 0xbc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x69c77ec, size 0x7c8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::CameraProperties  other) ;

/// @brief Method GetCameraCullingPlane, addr 0x69c7720, size 0xcc, virtual false, abstract: false, final false
inline ::UnityEngine::Plane GetCameraCullingPlane(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x69c8070, size 0x530, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetShadowCullingPlane, addr 0x69c7654, size 0xcc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "screenRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "viewDir", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "projectionNear", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "projectionFar", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cameraNear", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cameraFar", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cameraAspect", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cameraToWorld", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "actualWorldToClip", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "cameraClipToWorld", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "cameraWorldToClip", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "implicitProjection", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "stereoWorldToClipLeft", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "stereoWorldToClipRight", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "worldToCamera", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "up", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "right", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "transformDirection", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "cameraEuler", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "velocity", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "farPlaneWorldSpaceLength", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "rendererCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_ShadowCullPlanes", ty: "::UnityEngine::Rendering::CameraProperties__m_ShadowCullPlanes_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_CameraCullPlanes", ty: "::UnityEngine::Rendering::CameraProperties__m_CameraCullPlanes_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "baseFarDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "shadowCullCenter", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "layerCullDistances", ty: "::UnityEngine::Rendering::CameraProperties__layerCullDistances_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "layerCullSpherical", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "coreCameraValues", ty: "::UnityEngine::Rendering::CoreCameraValues", modifiers: "", def_value: None }, CppParam { name: "cameraType", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "projectionIsOblique", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "isImplicitProjectionMatrix", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "useInteractiveLightBakingData", ty: "bool", modifiers: "", def_value: None }]
