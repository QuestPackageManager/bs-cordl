...
public:
  ...
  /// @brief Method OnAfterDeserialize, addr 0x65ebd54, size 0x4, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x65ebd50, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x65ebd58, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsList, addr 0x65ebd38, size 0x18, virtual false, abstract: false, final false
