...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RenderPipelineGraphicsSettingsContainer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RenderPipelineGraphicsSettingsContainer(RenderPipelineGraphicsSettingsContainer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RenderPipelineGraphicsSettingsContainer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RenderPipelineGraphicsSettingsContainer(RenderPipelineGraphicsSettingsContainerconst&) = delete;
