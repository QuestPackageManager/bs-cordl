...
public:
  ...
  /// @brief Method SetDefaults, addr 0x664d2e8, size 0x3c, virtual false, abstract: false, final false
  inline void SetDefaults();

  /// @brief Method Upgrade, addr 0x664d350, size 0x30, virtual false, abstract: false, final false
  inline void Upgrade();

  /// @brief Method .ctor, addr 0x664d324, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Default, addr 0x664d2a0, size 0x48, virtual false, abstract: false, final false
