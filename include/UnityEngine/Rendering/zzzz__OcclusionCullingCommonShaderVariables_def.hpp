...
/// @brief Method .ctor, addr 0x66f02c4, size 0x328, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::UnityEngine::Rendering::OccluderContext>  occluderCtx, ::ByRef<::UnityEngine::Rendering::InstanceOcclusionTestSubviewSettings>  subviewSettings, bool  occlusionOverlayCountVisible, bool  overrideOcclusionTestToAlwaysPass) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___FacingDirWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_FacingDirWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___OccluderMipBounds_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_OccluderMipBounds>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___RadialDirWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_RadialDirWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewOriginWorldSpace_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_ViewOriginWorldSpace>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::OcclusionCullingCommonShaderVariables___ViewProjMatrix_e__FixedBuffer, "UnityEngine.Rendering", "OcclusionCullingCommonShaderVariables/<_ViewProjMatrix>e__FixedBuffer");
