...
public:
  ...
  /// @brief Method CalculateRaycastTexCoord, addr 0x490680c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateRaycastTexCoord_Injected, addr 0x490688c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_articulationBody, addr 0x4906ad8, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ArticulationBody> get_articulationBody();

  /// @brief Method get_barycentricCoordinate, addr 0x49067d8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_barycentricCoordinate();

  /// @brief Method get_collider, addr 0x49066f4, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_colliderInstanceID, addr 0x49067a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_colliderInstanceID();

  /// @brief Method get_distance, addr 0x49067f4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_lightmapCoord, addr 0x4906bd0, size 0xfc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_lightmapCoord();

  /// @brief Method get_normal, addr 0x49067c0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_point, addr 0x49067a8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_rigidbody, addr 0x4906a1c, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody();

  /// @brief Method get_textureCoord, addr 0x4906900, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord();

  /// @brief Method get_textureCoord1, addr 0x4906ccc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord1();

  /// @brief Method get_textureCoord2, addr 0x4906920, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_textureCoord2();

  /// @brief Method get_transform, addr 0x4906940, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method get_triangleIndex, addr 0x4906804, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_triangleIndex();

  /// @brief Method set_barycentricCoordinate, addr 0x49067ec, size 0x8, virtual false, abstract: false, final false
  inline void set_barycentricCoordinate(::UnityEngine::Vector3 value);

  /// @brief Method set_distance, addr 0x49067fc, size 0x8, virtual false, abstract: false, final false
  inline void set_distance(float_t value);

  /// @brief Method set_normal, addr 0x49067cc, size 0xc, virtual false, abstract: false, final false
  inline void set_normal(::UnityEngine::Vector3 value);

  /// @brief Method set_point, addr 0x49067b4, size 0xc, virtual false, abstract: false, final false
