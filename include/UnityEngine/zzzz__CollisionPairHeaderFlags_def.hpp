...
DEFINE_IL2CPP_CLASS(::UnityEngine::CollisionPairHeaderFlags, "UnityEngine", "CollisionPairHeaderFlags");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::CollisionPairHeaderFlags) == 0x2, "Size mismatch!");
