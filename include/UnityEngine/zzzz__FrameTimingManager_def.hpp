...
public:
  // Declarations
  /// @brief Method CaptureFrameTimings, addr 0x48774b0, size 0x28, virtual false, abstract: false, final false
  static inline void CaptureFrameTimings();

  /// @brief Method GetLatestTimings, addr 0x48774d8, size 0x44, virtual false, abstract: false, final false
