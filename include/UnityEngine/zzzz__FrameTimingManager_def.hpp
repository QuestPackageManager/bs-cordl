...
public:
// Declarations
/// @brief Method CaptureFrameTimings, addr 0x68bcea0, size 0x28, virtual false, abstract: false, final false
static inline void CaptureFrameTimings() ;

/// @brief Method GetLatestTimings, addr 0x68bcec8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method GetLatestTimings_Injected, addr 0x68bcf9c, size 0x44, virtual false, abstract: false, final false
