...
public:
  ...
  /// @brief Method GetParentTypeDisallowingMultipleInclusion, addr 0x2cd439c, size 0x100, virtual false, abstract: false, final false
  static inline ::System::Type* GetParentTypeDisallowingMultipleInclusion(::System::Type* type);

  /// @brief Method GetRequiredComponents, addr 0x2cd449c, size 0x43c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Type*, ::Array<::System::Type*>*> GetRequiredComponents(::System::Type* klass);

  /// @brief Method GetExecuteMode, addr 0x2cd48d8, size 0x114, virtual false, abstract: false, final false
  static inline int32_t GetExecuteMode(::System::Type* klass);

  /// @brief Method CheckIsEditorScript, addr 0x2cd49ec, size 0xe0, virtual false, abstract: false, final false
  static inline int32_t CheckIsEditorScript(::System::Type* klass);

  /// @brief Method GetDefaultExecutionOrderFor, addr 0x2cd4acc, size 0x78, virtual false, abstract: false, final false
