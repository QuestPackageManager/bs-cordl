...
public:
  ...
  /// @brief Method .ctor, addr 0x490e8fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_force, addr 0x490e41c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_force();

  /// @brief Method get_force_Injected, addr 0x490e478, size 0x44, virtual false, abstract: false, final false
  inline void get_force_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_relativeForce, addr 0x490e554, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_relativeForce();

  /// @brief Method get_relativeForce_Injected, addr 0x490e5b0, size 0x44, virtual false, abstract: false, final false
  inline void get_relativeForce_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_relativeTorque, addr 0x490e7c4, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_relativeTorque();

  /// @brief Method get_relativeTorque_Injected, addr 0x490e820, size 0x44, virtual false, abstract: false, final false
  inline void get_relativeTorque_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_torque, addr 0x490e68c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_torque();

  /// @brief Method get_torque_Injected, addr 0x490e6e8, size 0x44, virtual false, abstract: false, final false
  inline void get_torque_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method set_force, addr 0x490e4bc, size 0x54, virtual false, abstract: false, final false
  inline void set_force(::UnityEngine::Vector3 value);

  /// @brief Method set_force_Injected, addr 0x490e510, size 0x44, virtual false, abstract: false, final false
  inline void set_force_Injected(::ByRef<::UnityEngine::Vector3> value);

  /// @brief Method set_relativeForce, addr 0x490e5f4, size 0x54, virtual false, abstract: false, final false
  inline void set_relativeForce(::UnityEngine::Vector3 value);

  /// @brief Method set_relativeForce_Injected, addr 0x490e648, size 0x44, virtual false, abstract: false, final false
  inline void set_relativeForce_Injected(::ByRef<::UnityEngine::Vector3> value);

  /// @brief Method set_relativeTorque, addr 0x490e864, size 0x54, virtual false, abstract: false, final false
  inline void set_relativeTorque(::UnityEngine::Vector3 value);

  /// @brief Method set_relativeTorque_Injected, addr 0x490e8b8, size 0x44, virtual false, abstract: false, final false
  inline void set_relativeTorque_Injected(::ByRef<::UnityEngine::Vector3> value);

  /// @brief Method set_torque, addr 0x490e72c, size 0x54, virtual false, abstract: false, final false
  inline void set_torque(::UnityEngine::Vector3 value);

  /// @brief Method set_torque_Injected, addr 0x490e780, size 0x44, virtual false, abstract: false, final false
