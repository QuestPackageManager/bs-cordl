...
public:
  ...
  /// @brief Method Equals, addr 0x6b02ad8, size 0xa0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x6b02acc, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6b02ac4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x6b0133c, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Playables::PlayableOutput) == 0x10, "Size mismatch!");
