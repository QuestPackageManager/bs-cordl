...
public:
  ...
  /// @brief Method Equals, addr 0x322e2f8, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x322e2ec, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x322d5fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x322d980, size 0x58, virtual false, abstract: false, final false
