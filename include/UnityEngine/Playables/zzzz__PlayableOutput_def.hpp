...
public:
  ...
  /// @brief Method Equals, addr 0x486a8b4, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x486a8a8, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x486a8a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x48686c4, size 0x58, virtual false, abstract: false, final false
