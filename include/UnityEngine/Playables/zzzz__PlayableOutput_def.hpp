...
public:
  ...
  /// @brief Method Equals, addr 0x3438030, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x3438024, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3437334, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x34376b8, size 0x58, virtual false, abstract: false, final false
