...
public:
  ...
  /// @brief Method get_Null, addr 0x2d00c68, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::PlayableOutput get_Null();

  /// @brief Method .ctor, addr 0x2d008e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle handle);

  /// @brief Method GetHandle, addr 0x2d015d4, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method Equals, addr 0x2d015e0, size 0x74, virtual true, abstract: false, final true
