...
public:
  ...
  /// @brief Method Equals, addr 0x69ad724, size 0xa0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x69ad718, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69ad710, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x69ac0e4, size 0x5c, virtual false, abstract: false, final false
