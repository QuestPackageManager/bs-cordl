...
public:
  ...
  /// @brief Method Equals, addr 0x48cbc38, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutput other);

  /// @brief Method GetHandle, addr 0x48cbc2c, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x48cbc24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x48c9a48, size 0x58, virtual false, abstract: false, final false
