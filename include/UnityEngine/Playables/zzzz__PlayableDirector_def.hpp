...
public:
  ...
  /// @brief Method get_extrapolationMode, addr 0x2cfa7e0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Play, addr 0x2cfa98c, size 0x48, virtual false, abstract: false, final false
  inline void Play(::UnityEngine::Playables::FrameRate frameRate);

  /// @brief Method SetGenericBinding, addr 0x2cfaa1c, size 0x54, virtual false, abstract: false, final false
  inline void SetGenericBinding(::UnityEngine::Object* key, ::UnityEngine::Object* value);

  /// @brief Method set_time, addr 0x2cfaac4, size 0x4c, virtual false, abstract: false, final false
  inline void set_time(double_t value);

  /// @brief Method get_time, addr 0x2cfab10, size 0x3c, virtual false, abstract: false, final false
  inline double_t get_time();

  /// @brief Method get_duration, addr 0x2cfab4c, size 0x3c, virtual false, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method Evaluate, addr 0x2cfab88, size 0x3c, virtual false, abstract: false, final false
  inline void Evaluate();

  /// @brief Method PlayOnFrame, addr 0x2cfa9d4, size 0x48, virtual false, abstract: false, final false
  inline void PlayOnFrame(::UnityEngine::Playables::FrameRate frameRate);

  /// @brief Method Play, addr 0x2cfac08, size 0x3c, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Stop, addr 0x2cfac44, size 0x3c, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Pause, addr 0x2cfac80, size 0x3c, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method SetReferenceValue, addr 0x2cfacbc, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method GetWrapMode, addr 0x2cfa81c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::DirectorWrapMode GetWrapMode();

  /// @brief Method GetGraphHandle, addr 0x2cfa938, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableGraph GetGraphHandle();

  /// @brief Method Internal_SetGenericBinding, addr 0x2cfaa70, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SendOnPlayableDirectorPause, addr 0x2cfaebc, size 0x20, virtual false, abstract: false, final false
  inline void SendOnPlayableDirectorPause();

  /// @brief Method SendOnPlayableDirectorStop, addr 0x2cfaedc, size 0x20, virtual false, abstract: false, final false
  inline void SendOnPlayableDirectorStop();

  /// @brief Method PlayOnFrame_Injected, addr 0x2cfabc4, size 0x44, virtual false, abstract: false, final false
  inline void PlayOnFrame_Injected(ByRef<::UnityEngine::Playables::FrameRate> frameRate);

  /// @brief Method SetReferenceValue_Injected, addr 0x2cfad14, size 0x54, virtual true, abstract: false, final true
