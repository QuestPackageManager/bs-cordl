...
public:
  ...
  /// @brief Method DoubleToFrameRate, addr 0x48d8124, size 0xe4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::FrameRate DoubleToFrameRate(double_t framerate);

  /// @brief Method Equals, addr 0x48d7e04, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x48d7df4, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::FrameRate other);

  /// @brief Method GetHashCode, addr 0x48d7f10, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsValid, addr 0x48d7de4, size 0x10, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method ToString, addr 0x48d7f18, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x48d7f74, size 0x1b0, virtual false, abstract: false, final false
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x48d7dd4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dropFrame, addr 0x48d7d54, size 0xc, virtual false, abstract: false, final false
  inline bool get_dropFrame();

  /// @brief Method get_rate, addr 0x48d7d60, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x48d7eac, size 0x64, virtual false, abstract: false, final false
