...
public:
  ...
  /// @brief Method get_Null, addr 0x2cff61c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x2cff674, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x2cff6a8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2cff764, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* p);

  /// @brief Method Equals, addr 0x2cff7dc, size 0x80, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutputHandle other);

  /// @brief Method CompareVersion, addr 0x2cff730, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x2cff85c, size 0x74, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method GetPlayableOutputType, addr 0x2cff90c, size 0x74, virtual false, abstract: false, final false
  inline ::System::Type* GetPlayableOutputType();

  /// @brief Method SetReferenceObject, addr 0x2cff9bc, size 0x84, virtual false, abstract: false, final false
  inline void SetReferenceObject(::UnityEngine::Object* target);

  /// @brief Method SetUserData, addr 0x2cffa84, size 0x84, virtual false, abstract: false, final false
  inline void SetUserData(::UnityEngine::Object* target);

  /// @brief Method GetSourcePlayable, addr 0x2cffb4c, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableHandle GetSourcePlayable();

  /// @brief Method SetSourcePlayable, addr 0x2cffc1c, size 0x98, virtual false, abstract: false, final false
  inline void SetSourcePlayable(::UnityEngine::Playables::PlayableHandle target, int32_t port);

  /// @brief Method GetSourceOutputPort, addr 0x2cffd08, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetSourceOutputPort();

  /// @brief Method SetWeight, addr 0x2cffdb8, size 0x84, virtual false, abstract: false, final false
  inline void SetWeight(float_t weight);

  /// @brief Method PushNotification, addr 0x2cffe88, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddNotificationReceiver, addr 0x2cfff84, size 0x84, virtual false, abstract: false, final false
  inline void AddNotificationReceiver(::UnityEngine::Playables::INotificationReceiver* receiver);

  /// @brief Method IsValid_Injected, addr 0x2cff8d0, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValid_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle> _unity_self);

  /// @brief Method GetPlayableOutputType_Injected, addr 0x2cff980, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::Type* GetPlayableOutputType_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle> _unity_self);

  /// @brief Method SetReferenceObject_Injected, addr 0x2cffa40, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUserData_Injected, addr 0x2cffb08, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSourcePlayable_Injected, addr 0x2cffbd8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSourcePlayable_Injected, addr 0x2cffcb4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSourceOutputPort_Injected, addr 0x2cffd7c, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetSourceOutputPort_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle> _unity_self);

  /// @brief Method SetWeight_Injected, addr 0x2cffe3c, size 0x4c, virtual false, abstract: false, final false
  static inline void SetWeight_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle> _unity_self, float_t weight);

  /// @brief Method PushNotification_Injected, addr 0x2cfff28, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddNotificationReceiver_Injected, addr 0x2d00008, size 0x44, virtual false, abstract: false, final false
