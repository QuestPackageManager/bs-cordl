...
public:
  ...
  /// @brief Method AddNotificationReceiver, addr 0x693b684, size 0x44, virtual false, abstract: false, final false
  inline void AddNotificationReceiver(::UnityEngine::Playables::INotificationReceiver* receiver);

  /// @brief Method CompareVersion, addr 0x693b048, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x693b10c, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableOutputHandle other);

  /// @brief Method Equals, addr 0x693b058, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* p);

  /// @brief Method GetHashCode, addr 0x693b038, size 0x10, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetPlayableOutputType, addr 0x693b1bc, size 0x3c, virtual false, abstract: false, final false
  inline ::System::Type* GetPlayableOutputType();

  /// @brief Method GetSourceOutputPort, addr 0x693b4fc, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetSourceOutputPort();

  /// @brief Method GetSourcePlayable, addr 0x693b338, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableHandle GetSourcePlayable();

  /// @brief Method GetSourcePlayable_Injected, addr 0x693b3c8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x693b180, size 0x3c, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method PushNotification, addr 0x693b584, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method PushNotification_Injected, addr 0x693b628, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetReferenceObject, addr 0x693b1f8, size 0xb8, virtual false, abstract: false, final false
  inline void SetReferenceObject(::UnityEngine::Object* target);

  /// @brief Method SetReferenceObject_Injected, addr 0x693b2b0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSourcePlayable, addr 0x693b40c, size 0x9c, virtual false, abstract: false, final false
  inline void SetSourcePlayable(::UnityEngine::Playables::PlayableHandle target, int32_t port);

  /// @brief Method SetSourcePlayable_Injected, addr 0x693b4a8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetUserData, addr 0x693b2f4, size 0x44, virtual false, abstract: false, final false
  inline void SetUserData(::UnityEngine::Object* target);

  /// @brief Method SetWeight, addr 0x693b538, size 0x4c, virtual false, abstract: false, final false
  inline void SetWeight(float_t weight);

  static inline ::UnityEngine::Playables::PlayableOutputHandle getStaticF_m_Null();

  /// @brief Method get_Null, addr 0x693afdc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x693aee8, size 0x7c, virtual false, abstract: false, final false
