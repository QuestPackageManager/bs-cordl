...
public:
  // Declarations
  /// @brief Method GetRootPlayable, addr 0x2cf6200, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Evaluate, addr 0x2cf6260, size 0x40, virtual false, abstract: false, final false
  inline void Evaluate();

  /// @brief Method IsValid, addr 0x2cf62ec, size 0x3c, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method IsPlaying, addr 0x2cf6364, size 0x3c, virtual false, abstract: false, final false
  inline bool IsPlaying();

  /// @brief Method Evaluate, addr 0x2cf62a0, size 0x4c, virtual false, abstract: false, final false
  inline void Evaluate(float_t deltaTime);

  /// @brief Method GetResolver, addr 0x2cf6428, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::IExposedPropertyTable* GetResolver();

  /// @brief Method GetPlayableCount, addr 0x2cf64a0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetPlayableCount();

  /// @brief Method GetRootPlayableCount, addr 0x2cf6518, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetRootPlayableCount();

  /// @brief Method SynchronizeEvaluation, addr 0x2cf6590, size 0x50, virtual false, abstract: false, final false
  inline void SynchronizeEvaluation(::UnityEngine::Playables::PlayableGraph playable);

  /// @brief Method CreatePlayableHandle, addr 0x2cf5cb0, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableHandle CreatePlayableHandle();

  /// @brief Method CreateScriptOutputInternal, addr 0x2cf5a70, size 0x54, virtual false, abstract: false, final false
  inline bool CreateScriptOutputInternal(::StringW name, ByRef<::UnityEngine::Playables::PlayableOutputHandle> handle);

  /// @brief Method GetRootPlayableInternal, addr 0x2cf6204, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableHandle GetRootPlayableInternal(int32_t index);

  /// @brief Method IsMatchFrameRateEnabled, addr 0x2cf6710, size 0x3c, virtual false, abstract: false, final false
  inline bool IsMatchFrameRateEnabled();

  /// @brief Method GetFrameRate, addr 0x2cf6788, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::FrameRate GetFrameRate();

  /// @brief Method ConnectInternal, addr 0x2cf6818, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValid_Injected, addr 0x2cf6328, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValid_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method IsPlaying_Injected, addr 0x2cf63a0, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsPlaying_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method Evaluate_Injected, addr 0x2cf63dc, size 0x4c, virtual false, abstract: false, final false
  static inline void Evaluate_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self, float_t deltaTime);

  /// @brief Method GetResolver_Injected, addr 0x2cf6464, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayableCount_Injected, addr 0x2cf64dc, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetPlayableCount_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method GetRootPlayableCount_Injected, addr 0x2cf6554, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetRootPlayableCount_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method SynchronizeEvaluation_Injected, addr 0x2cf65e0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayableHandle_Injected, addr 0x2cf6624, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateScriptOutputInternal_Injected, addr 0x2cf6668, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRootPlayableInternal_Injected, addr 0x2cf66bc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMatchFrameRateEnabled_Injected, addr 0x2cf674c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsMatchFrameRateEnabled_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method GetFrameRate_Injected, addr 0x2cf67d4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ConnectInternal_Injected, addr 0x2cf688c, size 0x6c, virtual false, abstract: false, final false
