...
public:
  // Declarations
  /// @brief Method GetRootPlayable addr 0x2b8dec0 size 0x4 virtual false final false
  ...
  /// @brief Method Evaluate addr 0x2b8df20 size 0x40 virtual false final false
  inline void Evaluate();

  /// @brief Method IsValid addr 0x2b8dfac size 0x3c virtual false final false
  inline bool IsValid();

  /// @brief Method IsPlaying addr 0x2b8e024 size 0x3c virtual false final false
  inline bool IsPlaying();

  /// @brief Method Evaluate addr 0x2b8df60 size 0x4c virtual false final false
  inline void Evaluate(float_t deltaTime);

  /// @brief Method GetResolver addr 0x2b8e0e8 size 0x3c virtual false final false
  inline ::UnityEngine::IExposedPropertyTable* GetResolver();

  /// @brief Method GetPlayableCount addr 0x2b8e160 size 0x3c virtual false final false
  inline int32_t GetPlayableCount();

  /// @brief Method GetRootPlayableCount addr 0x2b8e1d8 size 0x3c virtual false final false
  inline int32_t GetRootPlayableCount();

  /// @brief Method SynchronizeEvaluation addr 0x2b8e250 size 0x50 virtual false final false
  inline void SynchronizeEvaluation(::UnityEngine::Playables::PlayableGraph playable);

  /// @brief Method CreatePlayableHandle addr 0x2b8d970 size 0x54 virtual false final false
  inline ::UnityEngine::Playables::PlayableHandle CreatePlayableHandle();

  /// @brief Method CreateScriptOutputInternal addr 0x2b8d730 size 0x54 virtual false final false
  inline bool CreateScriptOutputInternal(::StringW name, ByRef<::UnityEngine::Playables::PlayableOutputHandle> handle);

  /// @brief Method GetRootPlayableInternal addr 0x2b8dec4 size 0x5c virtual false final false
  inline ::UnityEngine::Playables::PlayableHandle GetRootPlayableInternal(int32_t index);

  /// @brief Method IsMatchFrameRateEnabled addr 0x2b8e3d0 size 0x3c virtual false final false
  inline bool IsMatchFrameRateEnabled();

  /// @brief Method GetFrameRate addr 0x2b8e448 size 0x4c virtual false final false
  inline ::UnityEngine::Playables::FrameRate GetFrameRate();

  /// @brief Method ConnectInternal addr 0x2b8e4d8 size 0x74 virtual false final false
  ...
  /// @brief Method IsValid_Injected addr 0x2b8dfe8 size 0x3c virtual false final false
  static inline bool IsValid_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method IsPlaying_Injected addr 0x2b8e060 size 0x3c virtual false final false
  static inline bool IsPlaying_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method Evaluate_Injected addr 0x2b8e09c size 0x4c virtual false final false
  static inline void Evaluate_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self, float_t deltaTime);

  /// @brief Method GetResolver_Injected addr 0x2b8e124 size 0x3c virtual false final false
  ...
  /// @brief Method GetPlayableCount_Injected addr 0x2b8e19c size 0x3c virtual false final false
  static inline int32_t GetPlayableCount_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method GetRootPlayableCount_Injected addr 0x2b8e214 size 0x3c virtual false final false
  static inline int32_t GetRootPlayableCount_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method SynchronizeEvaluation_Injected addr 0x2b8e2a0 size 0x44 virtual false final false
  ...
  /// @brief Method CreatePlayableHandle_Injected addr 0x2b8e2e4 size 0x44 virtual false final false
  ...
  /// @brief Method CreateScriptOutputInternal_Injected addr 0x2b8e328 size 0x54 virtual false final false
  ...
  /// @brief Method GetRootPlayableInternal_Injected addr 0x2b8e37c size 0x54 virtual false final false
  ...
  /// @brief Method IsMatchFrameRateEnabled_Injected addr 0x2b8e40c size 0x3c virtual false final false
  static inline bool IsMatchFrameRateEnabled_Injected(ByRef<::UnityEngine::Playables::PlayableGraph> _unity_self);

  /// @brief Method GetFrameRate_Injected addr 0x2b8e494 size 0x44 virtual false final false
  ...
  /// @brief Method ConnectInternal_Injected addr 0x2b8e54c size 0x6c virtual false final false
