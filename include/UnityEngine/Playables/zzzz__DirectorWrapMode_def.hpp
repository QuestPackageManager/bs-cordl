...
DEFINE_IL2CPP_CLASS(::UnityEngine::Playables::DirectorWrapMode, "UnityEngine.Playables", "DirectorWrapMode");
// Dependencies
namespace UnityEngine::Playables {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Playables::DirectorWrapMode) == 0x4, "Size mismatch!");
