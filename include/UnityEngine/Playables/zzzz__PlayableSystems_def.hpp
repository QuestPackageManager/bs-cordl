...
public:
// Declarations
/// @brief Method Invoke, addr 0x69de600, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69de4bc, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x69de8f0, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x69de8f8, size 0x2c, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x69de924, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x69de888, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x69de794, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableSystems_DataPlayableOutputList*  list) ;

/// @brief Method get_Current, addr 0x69de7a8, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method GetEnumerator, addr 0x69de73c, size 0x58, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x69de7a4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x69de350, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle*  outputs, int32_t  count) ;

/// @brief Method get_Count, addr 0x69de734, size 0x8, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x69de614, size 0x120, virtual true, abstract: false, final true
...
/// @brief Method CombineTypeAndIndex, addr 0x69de198, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Internal_CallSystemDelegate, addr 0x69de1a4, size 0x1ac, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Playables::DataPlayableOutputList_PlayableSystems_DataPlayableOutputEnumerator*, "UnityEngine.Playables", "PlayableSystems/DataPlayableOutputList/DataPlayableOutputEnumerator");
