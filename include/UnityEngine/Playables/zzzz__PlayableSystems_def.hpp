...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69dca88, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69dc944, size 0x144, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 22434 };
...
public:
  ...
  /// @brief Method Dispose, addr 0x69dcd78, size 0x8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x69dcd80, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x69dcdac, size 0xc, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x69dcd10, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69dcc1c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableSystems_DataPlayableOutputList* list);

  /// @brief Method get_Current, addr 0x69dcc30, size 0xe0, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x69dcbc4, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x69dcc2c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69dc7d8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle* outputs, int32_t count);

  /// @brief Method get_Count, addr 0x69dcbbc, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x69dca9c, size 0x120, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CombineTypeAndIndex, addr 0x69dc620, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CallSystemDelegate, addr 0x69dc62c, size 0x1ac, virtual false, abstract: false, final false
