...
public:
  ...
  /// @brief Method Internal_CreatePlayable, addr 0x48c633c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetPlayableAssetDuration, addr 0x48c6414, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48c643c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_duration, addr 0x48c628c, size 0x58, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_outputs, addr 0x48c62e4, size 0x58, virtual true, abstract: false, final false
