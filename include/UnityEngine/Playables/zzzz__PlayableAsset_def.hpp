...
public:
  ...
  /// @brief Method get_duration, addr 0x2d004c4, size 0x58, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_outputs, addr 0x2d0051c, size 0x58, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method Internal_CreatePlayable, addr 0x2d00574, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetPlayableAssetDuration, addr 0x2d006a4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d006cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
