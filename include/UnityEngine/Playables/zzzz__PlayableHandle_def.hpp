...
/// @brief Method CheckInputBounds, addr 0x693a880, size 0x74, virtual false, abstract: false, final false
inline bool CheckInputBounds(int32_t  inputIndex) ;

/// @brief Method CheckInputBounds, addr 0x693ab78, size 0x208, virtual false, abstract: false, final false
inline bool CheckInputBounds(int32_t  inputIndex, bool  acceptAny) ;

/// @brief Method CompareVersion, addr 0x693aa30, size 0x10, virtual false, abstract: false, final false
static inline bool CompareVersion(::UnityEngine::Playables::PlayableHandle  lhs, ::UnityEngine::Playables::PlayableHandle  rhs) ;

/// @brief Method Equals, addr 0x693aaf4, size 0x74, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Playables::PlayableHandle  other) ;

/// @brief Method Equals, addr 0x693aa40, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  p) ;

/// @brief Method GetDuration, addr 0x693b044, size 0x3c, virtual false, abstract: false, final false
inline double_t GetDuration() ;

/// @brief Method GetGraph, addr 0x693b110, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableGraph GetGraph() ;

/// @brief Method GetGraph_Injected, addr 0x693b1a0, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x693ab68, size 0x10, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetInput, addr 0x693a6bc, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable GetInput(int32_t  inputPort) ;

/// @brief Method GetInputCount, addr 0x693ad80, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetInputCount() ;

/// @brief Method GetInputHandle, addr 0x693a724, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle GetInputHandle(int32_t  index) ;

/// @brief Method GetInputHandle_Injected, addr 0x693b454, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetInputWeight, addr 0x693a948, size 0xa4, virtual false, abstract: false, final false
inline float_t GetInputWeight(int32_t  inputIndex) ;

/// @brief Method GetInputWeightFromIndex, addr 0x693a9ec, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetPlayState, addr 0x693ae3c, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayState GetPlayState() ;

/// @brief Method GetPlayableType, addr 0x6939a08, size 0x3c, virtual false, abstract: false, final false
inline ::System::Type* GetPlayableType() ;

/// @brief Method GetPreviousTime, addr 0x693b318, size 0x3c, virtual false, abstract: false, final false
inline double_t GetPreviousTime() ;

/// @brief Method GetScriptInstance, addr 0x693b418, size 0x3c, virtual false, abstract: false, final false
inline ::System::Object* GetScriptInstance() ;

/// @brief Method GetTime, addr 0x693af3c, size 0x3c, virtual false, abstract: false, final false
inline double_t GetTime() ;

/// @brief Method GetTimeWrapMode, addr 0x693b398, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::DirectorWrapMode GetTimeWrapMode() ;

/// @brief Method IsDone, addr 0x693afc4, size 0x3c, virtual false, abstract: false, final false
inline bool IsDone() ;
...
/// @brief Method IsValid, addr 0x693adbc, size 0x3c, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method Pause, addr 0x693aeb4, size 0x3c, virtual false, abstract: false, final false
inline void Pause() ;

/// @brief Method Play, addr 0x693ae78, size 0x3c, virtual false, abstract: false, final false
inline void Play() ;

/// @brief Method SetDone, addr 0x693b000, size 0x44, virtual false, abstract: false, final false
inline void SetDone(bool  value) ;

/// @brief Method SetDuration, addr 0x693b080, size 0x4c, virtual false, abstract: false, final false
inline void SetDuration(double_t  value) ;

/// @brief Method SetInputCount, addr 0x693b1e4, size 0x44, virtual false, abstract: false, final false
inline void SetInputCount(int32_t  value) ;

/// @brief Method SetInputWeight, addr 0x693a7c4, size 0xbc, virtual false, abstract: false, final false
inline bool SetInputWeight(int32_t  inputIndex, float_t  weight) ;

/// @brief Method SetInputWeight, addr 0x693b228, size 0x9c, virtual false, abstract: false, final false
inline void SetInputWeight(::UnityEngine::Playables::PlayableHandle  input, float_t  weight) ;

/// @brief Method SetInputWeightFromIndex, addr 0x693a8f4, size 0x54, virtual false, abstract: false, final false
inline void SetInputWeightFromIndex(int32_t  index, float_t  weight) ;

/// @brief Method SetInputWeight_Injected, addr 0x693b2c4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SetPropagateSetTime, addr 0x693b0cc, size 0x44, virtual false, abstract: false, final false
inline void SetPropagateSetTime(bool  value) ;

/// @brief Method SetScriptInstance, addr 0x693adf8, size 0x44, virtual false, abstract: false, final false
inline void SetScriptInstance(::System::Object*  scriptInstance) ;

/// @brief Method SetSpeed, addr 0x693aef0, size 0x4c, virtual false, abstract: false, final false
inline void SetSpeed(double_t  value) ;

/// @brief Method SetTime, addr 0x693af78, size 0x4c, virtual false, abstract: false, final false
inline void SetTime(double_t  value) ;

/// @brief Method SetTimeWrapMode, addr 0x693b3d4, size 0x44, virtual false, abstract: false, final false
inline void SetTimeWrapMode(::UnityEngine::Playables::DirectorWrapMode  mode) ;

/// @brief Method SetTraversalMode, addr 0x693b354, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_Null, addr 0x6939bd8, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x6939ae4, size 0x7c, virtual false, abstract: false, final false
