...
public:
  ...
  /// @brief Method get_Null, addr 0x2d00b70, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::PlayableHandle get_Null();

  /// @brief Method GetInput, addr 0x2d016c4, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable GetInput(int32_t inputPort);

  /// @brief Method SetInputWeight, addr 0x2d01764, size 0x44, virtual false, abstract: false, final false
  inline bool SetInputWeight(int32_t inputIndex, float_t weight);

  /// @brief Method GetInputWeight, addr 0x2d01854, size 0x2c, virtual false, abstract: false, final false
  inline float_t GetInputWeight(int32_t inputIndex);

  /// @brief Method op_Equality, addr 0x2cff488, size 0x88, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Playables::PlayableHandle x, ::UnityEngine::Playables::PlayableHandle y);

  /// @brief Method Equals, addr 0x2d01938, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* p);

  /// @brief Method Equals, addr 0x2d019b0, size 0x80, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::PlayableHandle other);

  /// @brief Method GetHashCode, addr 0x2d01a30, size 0x34, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method CompareVersion, addr 0x2d01904, size 0x34, virtual false, abstract: false, final false
  static inline bool CompareVersion(::UnityEngine::Playables::PlayableHandle lhs, ::UnityEngine::Playables::PlayableHandle rhs);

  /// @brief Method CheckInputBounds, addr 0x2d017a8, size 0x18, virtual false, abstract: false, final false
  inline bool CheckInputBounds(int32_t inputIndex);

  /// @brief Method CheckInputBounds, addr 0x2d01a64, size 0x224, virtual false, abstract: false, final false
  inline bool CheckInputBounds(int32_t inputIndex, bool acceptAny);

  /// @brief Method IsValid, addr 0x2d01cfc, size 0x74, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method GetPlayableType, addr 0x2d00a18, size 0x74, virtual false, abstract: false, final false
  inline ::System::Type* GetPlayableType();

  /// @brief Method SetScriptInstance, addr 0x2d01de8, size 0x84, virtual false, abstract: false, final false
  inline void SetScriptInstance(::System::Object* scriptInstance);

  /// @brief Method GetPlayState, addr 0x2d01eb0, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayState GetPlayState();

  /// @brief Method Play, addr 0x2d01f60, size 0x74, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Pause, addr 0x2d02010, size 0x74, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method SetSpeed, addr 0x2d020c0, size 0x84, virtual false, abstract: false, final false
  inline void SetSpeed(double_t value);

  /// @brief Method GetTime, addr 0x2d02190, size 0x74, virtual false, abstract: false, final false
  inline double_t GetTime();

  /// @brief Method SetTime, addr 0x2d02240, size 0x84, virtual false, abstract: false, final false
  inline void SetTime(double_t value);

  /// @brief Method IsDone, addr 0x2d02310, size 0x74, virtual false, abstract: false, final false
  inline bool IsDone();

  /// @brief Method SetDone, addr 0x2d023c0, size 0x84, virtual false, abstract: false, final false
  inline void SetDone(bool value);

  /// @brief Method GetDuration, addr 0x2d02488, size 0x74, virtual false, abstract: false, final false
  inline double_t GetDuration();

  /// @brief Method SetDuration, addr 0x2d02538, size 0x84, virtual false, abstract: false, final false
  inline void SetDuration(double_t value);

  /// @brief Method SetPropagateSetTime, addr 0x2d02608, size 0x84, virtual false, abstract: false, final false
  inline void SetPropagateSetTime(bool value);

  /// @brief Method GetGraph, addr 0x2d026d0, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableGraph GetGraph();

  /// @brief Method GetInputCount, addr 0x2d01c88, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetInputCount();

  /// @brief Method SetInputCount, addr 0x2d027dc, size 0x84, virtual false, abstract: false, final false
  inline void SetInputCount(int32_t value);

  /// @brief Method SetInputWeight, addr 0x2d028a4, size 0x98, virtual false, abstract: false, final false
  inline void SetInputWeight(::UnityEngine::Playables::PlayableHandle input, float_t weight);

  /// @brief Method GetPreviousTime, addr 0x2d02990, size 0x74, virtual false, abstract: false, final false
  inline double_t GetPreviousTime();

  /// @brief Method SetTraversalMode, addr 0x2d02a40, size 0x84, virtual false, abstract: false, final false
  inline void SetTraversalMode(::UnityEngine::Playables::PlayableTraversalMode mode);

  /// @brief Method GetTimeWrapMode, addr 0x2d02b08, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::DirectorWrapMode GetTimeWrapMode();

  /// @brief Method SetTimeWrapMode, addr 0x2d02bb8, size 0x84, virtual false, abstract: false, final false
  inline void SetTimeWrapMode(::UnityEngine::Playables::DirectorWrapMode mode);

  /// @brief Method GetScriptInstance, addr 0x2d02c80, size 0x74, virtual false, abstract: false, final false
  inline ::System::Object* GetScriptInstance();

  /// @brief Method GetInputHandle, addr 0x2d016c8, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::PlayableHandle GetInputHandle(int32_t index);

  /// @brief Method SetInputWeightFromIndex, addr 0x2d017c0, size 0x94, virtual false, abstract: false, final false
  inline void SetInputWeightFromIndex(int32_t index, float_t weight);

  /// @brief Method GetInputWeightFromIndex, addr 0x2d01880, size 0x84, virtual false, abstract: false, final false
  inline float_t GetInputWeightFromIndex(int32_t index);

  /// @brief Method IsValid_Injected, addr 0x2d01d70, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsValid_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method GetPlayableType_Injected, addr 0x2d01dac, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::Type* GetPlayableType_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetScriptInstance_Injected, addr 0x2d01e6c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayState_Injected, addr 0x2d01f24, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Play_Injected, addr 0x2d01fd4, size 0x3c, virtual false, abstract: false, final false
  static inline void Play_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method Pause_Injected, addr 0x2d02084, size 0x3c, virtual false, abstract: false, final false
  static inline void Pause_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetSpeed_Injected, addr 0x2d02144, size 0x4c, virtual false, abstract: false, final false
  static inline void SetSpeed_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, double_t value);

  /// @brief Method GetTime_Injected, addr 0x2d02204, size 0x3c, virtual false, abstract: false, final false
  static inline double_t GetTime_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetTime_Injected, addr 0x2d022c4, size 0x4c, virtual false, abstract: false, final false
  static inline void SetTime_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, double_t value);

  /// @brief Method IsDone_Injected, addr 0x2d02384, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsDone_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetDone_Injected, addr 0x2d02444, size 0x44, virtual false, abstract: false, final false
  static inline void SetDone_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, bool value);

  /// @brief Method GetDuration_Injected, addr 0x2d024fc, size 0x3c, virtual false, abstract: false, final false
  static inline double_t GetDuration_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetDuration_Injected, addr 0x2d025bc, size 0x4c, virtual false, abstract: false, final false
  static inline void SetDuration_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, double_t value);

  /// @brief Method SetPropagateSetTime_Injected, addr 0x2d0268c, size 0x44, virtual false, abstract: false, final false
  static inline void SetPropagateSetTime_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, bool value);

  /// @brief Method GetGraph_Injected, addr 0x2d0275c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputCount_Injected, addr 0x2d027a0, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetInputCount_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetInputCount_Injected, addr 0x2d02860, size 0x44, virtual false, abstract: false, final false
  static inline void SetInputCount_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self, int32_t value);

  /// @brief Method SetInputWeight_Injected, addr 0x2d0293c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousTime_Injected, addr 0x2d02a04, size 0x3c, virtual false, abstract: false, final false
  static inline double_t GetPreviousTime_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method SetTraversalMode_Injected, addr 0x2d02ac4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTimeWrapMode_Injected, addr 0x2d02b7c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTimeWrapMode_Injected, addr 0x2d02c3c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScriptInstance_Injected, addr 0x2d02cf4, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::Object* GetScriptInstance_Injected(ByRef<::UnityEngine::Playables::PlayableHandle> _unity_self);

  /// @brief Method GetInputHandle_Injected, addr 0x2d02d30, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInputWeightFromIndex_Injected, addr 0x2d02d84, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputWeightFromIndex_Injected, addr 0x2d02dd8, size 0x44, virtual false, abstract: false, final false
