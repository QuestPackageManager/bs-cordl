...
public:
  ...
  /// @brief Method Create, addr 0x6b06a08, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::ScriptPlayableOutput Create(::UnityEngine::Playables::PlayableGraph graph, ::StringW name);

  /// @brief Method GetHandle, addr 0x6b06bec, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle();

  /// @brief Method .ctor, addr 0x6b06ad8, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle handle);

  /// @brief Method get_Null, addr 0x6b06a5c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6b06a58, size 0x4, virtual false, abstract: false, final false
