...
/// @brief Method HasFlags, addr 0x6939220, size 0x10, virtual false, abstract: false, final false
inline bool HasFlags(::UnityEngine::Playables::FrameData_Flags  flag) ;

/// @brief Method get_deltaTime, addr 0x6939230, size 0xc, virtual false, abstract: false, final false
inline float_t get_deltaTime() ;

/// @brief Method get_effectivePlayState, addr 0x6939284, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayState get_effectivePlayState() ;

/// @brief Method get_effectiveSpeed, addr 0x693923c, size 0x8, virtual false, abstract: false, final false
inline float_t get_effectiveSpeed() ;

/// @brief Method get_evaluationType, addr 0x6939244, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::FrameData_EvaluationType get_evaluationType() ;

/// @brief Method get_output, addr 0x6939278, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableOutput get_output() ;

/// @brief Method get_seekOccurred, addr 0x6939254, size 0xc, virtual false, abstract: false, final false
inline bool get_seekOccurred() ;

/// @brief Method get_timeHeld, addr 0x693926c, size 0xc, virtual false, abstract: false, final false
inline bool get_timeHeld() ;

/// @brief Method get_timeLooped, addr 0x6939260, size 0xc, virtual false, abstract: false, final false
