...
DEFINE_IL2CPP_CLASS(::UnityEngine::Playables::DirectorUpdateMode, "UnityEngine.Playables", "DirectorUpdateMode");
// Dependencies
namespace UnityEngine::Playables {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Playables::DirectorUpdateMode) == 0x4, "Size mismatch!");
