...
public:
  ...
  /// @brief Method Create, addr 0x6b040d8, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Playables::Playable Create(::UnityEngine::Playables::PlayableGraph graph, int32_t inputCount);

  /// @brief Method Equals, addr 0x6b042d4, size 0xa0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Playables::Playable other);

  /// @brief Method GetHandle, addr 0x6b041d8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method GetPlayableType, addr 0x6b041e4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Null, addr 0x6b0407c, size 0x5c, virtual false, abstract: false, final false
