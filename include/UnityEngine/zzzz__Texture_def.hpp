...
public:
  ...
  /// @brief Method .ctor, addr 0x2cad540, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mipmapCount, addr 0x2cad598, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_mipmapCount();

  /// @brief Method GetDataWidth, addr 0x2cad5d4, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetDataWidth();

  /// @brief Method GetDataHeight, addr 0x2cad610, size 0x3c, virtual false, abstract: false, final false
  inline int32_t GetDataHeight();

  /// @brief Method get_width, addr 0x2cad64c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method set_width, addr 0x2cad688, size 0x40, virtual true, abstract: false, final false
  inline void set_width(int32_t value);

  /// @brief Method get_height, addr 0x2cad6c8, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method set_height, addr 0x2cad704, size 0x40, virtual true, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_dimension, addr 0x2cad744, size 0x40, virtual true, abstract: false, final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method get_isReadable, addr 0x2cad784, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method get_wrapMode, addr 0x2cad7c0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextureWrapMode get_wrapMode();

  /// @brief Method set_wrapMode, addr 0x2cad7fc, size 0x44, virtual false, abstract: false, final false
  inline void set_wrapMode(::UnityEngine::TextureWrapMode value);

  /// @brief Method get_filterMode, addr 0x2cad840, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::FilterMode get_filterMode();

  /// @brief Method set_filterMode, addr 0x2cad87c, size 0x44, virtual false, abstract: false, final false
  inline void set_filterMode(::UnityEngine::FilterMode value);

  /// @brief Method get_anisoLevel, addr 0x2cad8c0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_anisoLevel();

  /// @brief Method set_anisoLevel, addr 0x2cad8fc, size 0x44, virtual false, abstract: false, final false
  inline void set_anisoLevel(int32_t value);

  /// @brief Method get_texelSize, addr 0x2cad940, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_texelSize();

  /// @brief Method GetNativeTexturePtr, addr 0x2cad9d0, size 0x3c, virtual false, abstract: false, final false
  inline void* GetNativeTexturePtr();

  /// @brief Method Internal_GetActiveTextureColorSpace, addr 0x2cada0c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t Internal_GetActiveTextureColorSpace();

  /// @brief Method get_activeTextureColorSpace, addr 0x2cada48, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateFormat, addr 0x2cadcf0, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNonReadableException, addr 0x2cadea0, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::UnityException* CreateNonReadableException(::UnityEngine::Texture* t);

  /// @brief Method CreateNativeArrayLengthOverflowException, addr 0x2cadf44, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UnityException* CreateNativeArrayLengthOverflowException();

  /// @brief Method get_texelSize_Injected, addr 0x2cad98c, size 0x44, virtual false, abstract: false, final false
