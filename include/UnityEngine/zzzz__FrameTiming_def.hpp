...
// Ctor Parameters [CppParam { name: "cpuFrameTime", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "cpuMainThreadFrameTime", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "cpuMainThreadPresentWaitTime", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "cpuRenderThreadFrameTime", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "gpuFrameTime", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "frameStartTimestamp", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "firstSubmitTimestamp", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cpuTimePresentCalled", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cpuTimeFrameComplete", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "heightScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "widthScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "syncInterval", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr FrameTiming(double_t  cpuFrameTime, double_t  cpuMainThreadFrameTime, double_t  cpuMainThreadPresentWaitTime, double_t  cpuRenderThreadFrameTime, double_t  gpuFrameTime, uint64_t  frameStartTimestamp, uint64_t  firstSubmitTimestamp, uint64_t  cpuTimePresentCalled, uint64_t  cpuTimeFrameComplete, float_t  heightScale, float_t  widthScale, uint32_t  syncInterval) noexcept;
