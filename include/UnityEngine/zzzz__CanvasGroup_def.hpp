...
public:
  ...
  /// @brief Method IsRaycastLocationValid, addr 0x4aaa074, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4aaa0b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x4aa9e6c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_alpha();

  /// @brief Method get_blocksRaycasts, addr 0x4aa9f74, size 0x3c, virtual false, abstract: false, final false
  inline bool get_blocksRaycasts();

  /// @brief Method get_ignoreParentGroups, addr 0x4aa9ff4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_ignoreParentGroups();

  /// @brief Method get_interactable, addr 0x4aa9ef4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alpha, addr 0x4aa9ea8, size 0x4c, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_blocksRaycasts, addr 0x4aa9fb0, size 0x44, virtual false, abstract: false, final false
  inline void set_blocksRaycasts(bool value);

  /// @brief Method set_ignoreParentGroups, addr 0x4aaa030, size 0x44, virtual false, abstract: false, final false
  inline void set_ignoreParentGroups(bool value);

  /// @brief Method set_interactable, addr 0x4aa9f30, size 0x44, virtual false, abstract: false, final false
