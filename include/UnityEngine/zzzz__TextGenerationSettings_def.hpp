...
public:
// Declarations
/// @brief Method CompareColors, addr 0x6abdd7c, size 0x144, virtual false, abstract: false, final false
inline bool CompareColors(::UnityEngine::Color  left, ::UnityEngine::Color  right) ;

/// @brief Method CompareVector2, addr 0x6abdec0, size 0xd4, virtual false, abstract: false, final false
inline bool CompareVector2(::UnityEngine::Vector2  left, ::UnityEngine::Vector2  right) ;

/// @brief Method Equals, addr 0x6abdf94, size 0x234, virtual false, abstract: false, final false
