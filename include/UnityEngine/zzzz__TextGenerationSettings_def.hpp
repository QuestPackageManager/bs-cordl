...
DEFINE_IL2CPP_CLASS(::UnityEngine::TextGenerationSettings, "UnityEngine", "TextGenerationSettings");
...
public:
  // Declarations
  /// @brief Method CompareColors, addr 0x6c11c34, size 0x144, virtual false, abstract: false, final false
  inline bool CompareColors(::UnityEngine::Color left, ::UnityEngine::Color right);

  /// @brief Method CompareVector2, addr 0x6c11d78, size 0xd4, virtual false, abstract: false, final false
  inline bool CompareVector2(::UnityEngine::Vector2 left, ::UnityEngine::Vector2 right);

  /// @brief Method Equals, addr 0x6c11e4c, size 0x234, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::TextGenerationSettings) == 0x60, "Size mismatch!");
