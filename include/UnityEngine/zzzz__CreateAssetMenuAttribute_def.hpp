...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad77d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_fileName, addr 0x6ad77c0, size 0x8, virtual false, abstract: false, final false
  inline void set_fileName(::StringW value);

  /// @brief Method set_menuName, addr 0x6ad77b8, size 0x8, virtual false, abstract: false, final false
  inline void set_menuName(::StringW value);

  /// @brief Method set_order, addr 0x6ad77c8, size 0x8, virtual false, abstract: false, final false
