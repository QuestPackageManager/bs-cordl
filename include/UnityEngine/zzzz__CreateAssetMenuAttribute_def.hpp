...
/// @brief Method .ctor, addr 0x691069c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_fileName, addr 0x691068c, size 0x8, virtual false, abstract: false, final false
inline void set_fileName(::StringW  value) ;

/// @brief Method set_menuName, addr 0x6910684, size 0x8, virtual false, abstract: false, final false
inline void set_menuName(::StringW  value) ;

/// @brief Method set_order, addr 0x6910694, size 0x8, virtual false, abstract: false, final false
