...
public:
  ...
  /// @brief Method .ctor, addr 0x697fe64, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(bool showAlpha);

  /// @brief Method .ctor, addr 0x697fe80, size 0x1c, virtual false, abstract: false, final false
