...
public:
  ...
  /// @brief Method .ctor, addr 0x48b358c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(bool showAlpha);

  /// @brief Method .ctor, addr 0x48b35c8, size 0x44, virtual false, abstract: false, final false
