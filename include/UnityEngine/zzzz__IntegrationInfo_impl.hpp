...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::IntegrationInfo::*)()>(&::UnityEngine::IntegrationInfo::get_Name)> {
  ...
  constexpr static std::size_t addrs = 0x69c8004;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::IntegrationInfo>::get(),
                        "get_Name",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::IntegrationInfo::*)()>(&::UnityEngine::IntegrationInfo::get_Description)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x69c805c;
...
// Ctor Parameters [CppParam { name: "Id", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "IntegrationVersion", ty: "::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "SdkVersion", ty: "::UnityEngine::IntegrationInfo__SdkVersion_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Features", ty: "::UnityEngine::IntegrationInfo_SupportedUnityFeatures", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Name", ty: "::UnityEngine::IntegrationInfo__m_Name_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Desc", ty: "::UnityEngine::IntegrationInfo__m_Desc_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::IntegrationInfo::IntegrationInfo(uint32_t  Id, ::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer  IntegrationVersion, ::UnityEngine::IntegrationInfo__SdkVersion_e__FixedBuffer  SdkVersion, ::UnityEngine::IntegrationInfo_SupportedUnityFeatures  m_Features, ::UnityEngine::IntegrationInfo__m_Name_e__FixedBuffer  m_Name, ::UnityEngine::IntegrationInfo__m_Desc_e__FixedBuffer  m_Desc) noexcept  {
this->Id = Id;
