...
// Write type traits
MARK_REF_T(::UnityEngine::WaitUntil*);
DEFINE_IL2CPP_CLASS(::UnityEngine::WaitUntil*, "UnityEngine", "WaitUntil");
...
public:
  ...
  /// @brief Method GetTime, addr 0x6aec058, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6aec048, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Func_1<bool>* predicate);

  /// @brief Method get_keepWaiting, addr 0x6aebf84, size 0xc4, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaitUntil", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaitUntil(WaitUntil&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaitUntil", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaitUntil(WaitUntilconst&) = delete;
...
static_assert(sizeof(::UnityEngine::WaitUntil) == 0x30, "Size mismatch!");
