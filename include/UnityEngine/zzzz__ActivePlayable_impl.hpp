...
// Ctor Parameters [CppParam { name: "_settings_k__BackingField", ty: "::UnityEngine::PlayableSettings", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "_clipPlayableHandle_k__BackingField", ty: "::UnityEngine::Playables::PlayableHandle", modifiers: "", def_value: Some("{}"), comment: None }]
