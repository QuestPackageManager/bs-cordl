...
public:
  ...
  /// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x6bb8598, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6bb85a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// [CompilerGenerated]
  /// @brief Method get_id, addr 0x6bb8590, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  SubsystemDescriptor(SubsystemDescriptorconst&) = delete;
