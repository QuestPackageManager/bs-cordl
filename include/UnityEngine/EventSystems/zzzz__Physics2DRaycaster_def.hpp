...
public:
  ...
  /// @brief Method Raycast, addr 0x6c57cac, size 0x658, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c57c94, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
