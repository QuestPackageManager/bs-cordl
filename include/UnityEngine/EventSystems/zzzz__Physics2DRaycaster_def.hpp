...
/// @brief Method Raycast, addr 0x6c5836c, size 0x658, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c58354, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
