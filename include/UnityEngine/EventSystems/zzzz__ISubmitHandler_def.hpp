...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::ISubmitHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::ISubmitHandler*, "UnityEngine.EventSystems", "ISubmitHandler");
// Dependencies
namespace UnityEngine::EventSystems {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISubmitHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISubmitHandler(ISubmitHandlerconst&) = delete;
