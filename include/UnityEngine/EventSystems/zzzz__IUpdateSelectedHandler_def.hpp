...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IUpdateSelectedHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IUpdateSelectedHandler(IUpdateSelectedHandlerconst&) = delete;
