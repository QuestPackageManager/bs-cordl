...
public:
  ...
  /// @brief Method Reset, addr 0x6cbee60, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Use, addr 0x6cbee68, size 0xc, virtual true, abstract: false, final false
  inline void Use();
  ...
  /// @brief Method .ctor, addr 0x6cbee7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_used, addr 0x6cbee74, size 0x8, virtual true, abstract: false, final false
