...
public:
  ...
  /// @brief Method Reset, addr 0x6e14890, size 0x8, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Use, addr 0x6e14898, size 0xc, virtual true, abstract: false, final false
  inline void Use();
  ...
  /// @brief Method .ctor, addr 0x6e148ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_used, addr 0x6e148a4, size 0x8, virtual true, abstract: false, final false
