...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::IDropHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::IDropHandler*, "UnityEngine.EventSystems", "IDropHandler");
// Dependencies
namespace UnityEngine::EventSystems {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDropHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDropHandler(IDropHandlerconst&) = delete;
