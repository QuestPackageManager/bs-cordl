...
public:
  ...
  /// @brief Method ToString, addr 0x2ad1a30, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2acf944, size 0x8, virtual false, abstract: false, final false
