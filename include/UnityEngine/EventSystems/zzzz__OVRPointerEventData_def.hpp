...
public:
  ...
  /// @brief Method ToString, addr 0x295044c, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x294e360, size 0x8, virtual false, abstract: false, final false
