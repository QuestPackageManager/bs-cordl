...
public:
  ...
  /// @brief Method ToString, addr 0x4077d88, size 0x590, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4075bc0, size 0x8, virtual false, abstract: false, final false
