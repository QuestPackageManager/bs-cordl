...
public:
  ...
  /// @brief Method ToString, addr 0x407c91c, size 0x590, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407a754, size 0x8, virtual false, abstract: false, final false
