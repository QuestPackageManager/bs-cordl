...
public:
  ...
  /// @brief Method ToString, addr 0x5e4cce8, size 0x414, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e4cce0, size 0x8, virtual false, abstract: false, final false
