...
public:
  ...
  /// @brief Method ToString, addr 0x2c0537c, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c03290, size 0x8, virtual false, abstract: false, final false
