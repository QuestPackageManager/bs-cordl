...
public:
  ...
  /// @brief Method ToString, addr 0x28edc14, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ebb28, size 0x8, virtual false, abstract: false, final false
