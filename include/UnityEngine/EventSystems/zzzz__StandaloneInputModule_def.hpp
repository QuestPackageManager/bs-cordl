...
public:
  ...
  /// @brief Method ActivateModule, addr 0x34f283c, size 0x100, virtual true, abstract: false, final false
  inline void ActivateModule();

  /// @brief Method DeactivateModule, addr 0x34f293c, size 0x4, virtual true, abstract: false, final false
  inline void DeactivateModule();

  /// @brief Method ForceAutoSelect, addr 0x34f3b24, size 0x8, virtual true, abstract: false, final false
  inline bool ForceAutoSelect();

  /// @brief Method GetCurrentFocusedGameObject, addr 0x34f3e80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> GetCurrentFocusedGameObject();

  /// @brief Method GetRawMoveVector, addr 0x34f376c, size 0x110, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  static inline ::UnityEngine::EventSystems::StandaloneInputModule* New_ctor();

  /// @brief Method Process, addr 0x34f2940, size 0xa4, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method ProcessMouseEvent, addr 0x34f2c90, size 0x8, virtual false, abstract: false, final false
  inline void ProcessMouseEvent();

  /// @brief Method ProcessMouseEvent, addr 0x34f387c, size 0x2a8, virtual false, abstract: false, final false
  inline void ProcessMouseEvent(int32_t id);

  /// @brief Method ProcessMousePress, addr 0x34f3b2c, size 0x354, virtual false, abstract: false, final false
  inline void ProcessMousePress(::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData* data);

  /// @brief Method ProcessTouchEvents, addr 0x34f2b2c, size 0x164, virtual false, abstract: false, final false
  inline bool ProcessTouchEvents();

  /// @brief Method ProcessTouchPress, addr 0x34f3108, size 0x664, virtual false, abstract: false, final false
  inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData* pointerEvent, bool pressed, bool released);

  /// @brief Method ReleaseMouse, addr 0x34f229c, size 0x36c, virtual false, abstract: false, final false
  inline void ReleaseMouse(::UnityEngine::EventSystems::PointerEventData* pointerEvent, ::UnityEngine::GameObject* currentOverGo);

  /// @brief Method SendMoveEventToSelectedObject, addr 0x34f2c98, size 0x264, virtual false, abstract: false, final false
  inline bool SendMoveEventToSelectedObject();

  /// @brief Method SendSubmitEventToSelectedObject, addr 0x34f2efc, size 0x20c, virtual false, abstract: false, final false
  inline bool SendSubmitEventToSelectedObject();

  /// @brief Method SendUpdateEventToSelectedObject, addr 0x34f29e4, size 0x148, virtual false, abstract: false, final false
  inline bool SendUpdateEventToSelectedObject();

  /// @brief Method ShouldActivateModule, addr 0x34f2608, size 0x234, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method ShouldIgnoreEventsOnNoFocus, addr 0x34f21c4, size 0x8, virtual false, abstract: false, final false
  inline bool ShouldIgnoreEventsOnNoFocus();

  /// @brief Method UpdateModule, addr 0x34f21cc, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f2078, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowActivationOnMobileDevice, addr 0x34f213c, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowActivationOnMobileDevice();

  /// @brief Method get_cancelButton, addr 0x34f21b4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_cancelButton();

  /// @brief Method get_forceModuleActive, addr 0x34f2150, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceModuleActive();

  /// @brief Method get_horizontalAxis, addr 0x34f2184, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_horizontalAxis();

  /// @brief Method get_inputActionsPerSecond, addr 0x34f2164, size 0x8, virtual false, abstract: false, final false
  inline float_t get_inputActionsPerSecond();

  /// @brief Method get_inputMode, addr 0x34f2134, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::__StandaloneInputModule__InputMode get_inputMode();

  /// @brief Method get_repeatDelay, addr 0x34f2174, size 0x8, virtual false, abstract: false, final false
  inline float_t get_repeatDelay();

  /// @brief Method get_submitButton, addr 0x34f21a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_submitButton();

  /// @brief Method get_verticalAxis, addr 0x34f2194, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_verticalAxis();

  /// @brief Method set_allowActivationOnMobileDevice, addr 0x34f2144, size 0xc, virtual false, abstract: false, final false
  inline void set_allowActivationOnMobileDevice(bool value);

  /// @brief Method set_cancelButton, addr 0x34f21bc, size 0x8, virtual false, abstract: false, final false
  inline void set_cancelButton(::StringW value);

  /// @brief Method set_forceModuleActive, addr 0x34f2158, size 0xc, virtual false, abstract: false, final false
  inline void set_forceModuleActive(bool value);

  /// @brief Method set_horizontalAxis, addr 0x34f218c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalAxis(::StringW value);

  /// @brief Method set_inputActionsPerSecond, addr 0x34f216c, size 0x8, virtual false, abstract: false, final false
  inline void set_inputActionsPerSecond(float_t value);

  /// @brief Method set_repeatDelay, addr 0x34f217c, size 0x8, virtual false, abstract: false, final false
  inline void set_repeatDelay(float_t value);

  /// @brief Method set_submitButton, addr 0x34f21ac, size 0x8, virtual false, abstract: false, final false
  inline void set_submitButton(::StringW value);

  /// @brief Method set_verticalAxis, addr 0x34f219c, size 0x8, virtual false, abstract: false, final false
