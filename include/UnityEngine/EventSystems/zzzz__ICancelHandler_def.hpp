...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::ICancelHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::ICancelHandler*, "UnityEngine.EventSystems", "ICancelHandler");
// Dependencies
namespace UnityEngine::EventSystems {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ICancelHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ICancelHandler(ICancelHandlerconst&) = delete;
