...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::PhysicsRaycaster*);
MARK_REF_T(::UnityEngine::EventSystems::PhysicsRaycaster_RaycastHitComparer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PhysicsRaycaster*, "UnityEngine.EventSystems", "PhysicsRaycaster");
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::PhysicsRaycaster_RaycastHitComparer*, "UnityEngine.EventSystems", "PhysicsRaycaster/RaycastHitComparer");
...
public:
  ...
  /// @brief Method Compare, addr 0x6e20f20, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e20f84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeRayAndDistance, addr 0x6e2063c, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x6e20bac, size 0x374, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e1ffd8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_depth, addr 0x6e20ac4, size 0xc8, virtual true, abstract: false, final false
  inline int32_t get_depth();

  /// @brief Method get_eventCamera, addr 0x6e209ec, size 0xd8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_eventMask, addr 0x6e20b8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_eventMask();

  /// @brief Method get_finalEventMask, addr 0x6e20934, size 0xb8, virtual false, abstract: false, final false
  inline int32_t get_finalEventMask();

  /// @brief Method get_maxRayIntersections, addr 0x6e20b9c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxRayIntersections();

  /// @brief Method set_eventMask, addr 0x6e20b94, size 0x8, virtual false, abstract: false, final false
  inline void set_eventMask(::UnityEngine::LayerMask value);

  /// @brief Method set_maxRayIntersections, addr 0x6e20ba4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::EventSystems::PhysicsRaycaster) == 0x48, "Size mismatch!");
