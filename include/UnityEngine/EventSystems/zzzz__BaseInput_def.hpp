...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseInput", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseInput(BaseInput&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseInput", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseInput(BaseInputconst&) = delete;
