...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPointerEnterHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPointerEnterHandler(IPointerEnterHandlerconst&) = delete;
