...
public:
  ...
  /// @brief Method ActivateModule, addr 0x40744c4, size 0xcc, virtual true, abstract: false, final false
  inline void ActivateModule();

  /// @brief Method AllowMoveEventProcessing, addr 0x4074a94, size 0x5c, virtual false, abstract: false, final false
  inline bool AllowMoveEventProcessing(float_t time);

  /// @brief Method ClearSelection, addr 0x40745ac, size 0x2f8, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method CopyFromTo, addr 0x4075a00, size 0x70, virtual false, abstract: false, final false
  inline void CopyFromTo(::UnityEngine::EventSystems::OVRPointerEventData* from, ::UnityEngine::EventSystems::OVRPointerEventData* to);

  /// @brief Method CopyFromTo, addr 0x4075a70, size 0x60, virtual false, abstract: false, final false
  inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData* from, ::UnityEngine::EventSystems::PointerEventData* to);

  /// @brief Method DeactivateModule, addr 0x4074590, size 0x1c, virtual true, abstract: false, final false
  inline void DeactivateModule();

  /// @brief Method GetCanvasPointerData, addr 0x40769c0, size 0x388, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetCanvasPointerData();

  /// @brief Method GetExtraScrollDelta, addr 0x4076494, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetExtraScrollDelta();

  /// @brief Method GetGazeButtonState, addr 0x40774ac, size 0x110, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_FramePressState GetGazeButtonState();

  /// @brief Method GetGazePointerData, addr 0x4075d6c, size 0x728, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetGazePointerData();

  /// @brief Method GetPointerData, addr 0x4075ad0, size 0xf0, virtual false, abstract: false, final false
  inline bool GetPointerData(int32_t id, ::ByRef<::UnityEngine::EventSystems::OVRPointerEventData*> data, bool create);

  /// @brief Method GetRawMoveVector, addr 0x4074af0, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  /// @brief Method GetRectTransformNormal, addr 0x4075bc8, size 0x1a4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetRectTransformNormal(::UnityEngine::RectTransform* rectTransform);

  /// @brief Method IsModuleSupported, addr 0x4074324, size 0x18, virtual true, abstract: false, final false
  inline bool IsModuleSupported();

  /// @brief Method IsPointerMoving, addr 0x40759cc, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Process, addr 0x4075968, size 0x64, virtual true, abstract: false, final false
  inline void Process();

  /// @brief Method ProcessDrag, addr 0x4077194, size 0x318, virtual true, abstract: false, final false
  inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method ProcessMouseEvent, addr 0x4075660, size 0x2c8, virtual false, abstract: false, final false
  inline void ProcessMouseEvent(::UnityEngine::EventSystems::PointerInputModule_MouseState* mouseData);

  /// @brief Method ProcessMousePress, addr 0x4074ef4, size 0x668, virtual false, abstract: false, final false
  inline void ProcessMousePress(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData* data);

  /// @brief Method SendMoveEventToSelectedObject, addr 0x4074ba8, size 0x204, virtual false, abstract: false, final false
  inline bool SendMoveEventToSelectedObject();

  /// @brief Method SendSubmitEventToSelectedObject, addr 0x40748a4, size 0x1f0, virtual false, abstract: false, final false
  inline bool SendSubmitEventToSelectedObject();

  /// @brief Method SendUpdateEventToSelectedObject, addr 0x4074dac, size 0x148, virtual false, abstract: false, final false
  inline bool SendUpdateEventToSelectedObject();

  /// @brief Method ShouldActivateModule, addr 0x407433c, size 0x188, virtual true, abstract: false, final false
  inline bool ShouldActivateModule();

  /// @brief Method ShouldStartDrag, addr 0x4076d48, size 0x348, virtual false, abstract: false, final false
  inline bool ShouldStartDrag(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method SwipeAdjustedPosition, addr 0x407710c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateModule, addr 0x4074300, size 0x24, virtual true, abstract: false, final false
  inline void UpdateModule();

  /// @brief Method UseMouse, addr 0x4075928, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4074134, size 0x160, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowActivationOnMobileDevice, addr 0x407429c, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowActivationOnMobileDevice();

  /// @brief Method get_cancelButton, addr 0x40742f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_cancelButton();

  /// @brief Method get_horizontalAxis, addr 0x40742c0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_horizontalAxis();

  /// @brief Method get_inputActionsPerSecond, addr 0x40742b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_inputActionsPerSecond();

  /// @brief Method get_inputMode, addr 0x4074294, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::OVRInputModule_InputMode get_inputMode();

  /// @brief Method get_submitButton, addr 0x40742e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_submitButton();

  /// @brief Method get_verticalAxis, addr 0x40742d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_verticalAxis();

  /// @brief Method set_allowActivationOnMobileDevice, addr 0x40742a4, size 0xc, virtual false, abstract: false, final false
  inline void set_allowActivationOnMobileDevice(bool value);

  /// @brief Method set_cancelButton, addr 0x40742f8, size 0x8, virtual false, abstract: false, final false
  inline void set_cancelButton(::StringW value);

  /// @brief Method set_horizontalAxis, addr 0x40742c8, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalAxis(::StringW value);

  /// @brief Method set_inputActionsPerSecond, addr 0x40742b8, size 0x8, virtual false, abstract: false, final false
  inline void set_inputActionsPerSecond(float_t value);

  /// @brief Method set_submitButton, addr 0x40742e8, size 0x8, virtual false, abstract: false, final false
  inline void set_submitButton(::StringW value);

  /// @brief Method set_verticalAxis, addr 0x40742d8, size 0x8, virtual false, abstract: false, final false
