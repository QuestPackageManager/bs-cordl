...
public:
  ...
  /// @brief Method .ctor, addr 0x6cc6de0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_button, addr 0x6cc6dd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_InputButton get_button();

  /// @brief Method get_eventData, addr 0x6cc6dc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData* get_eventData();

  /// @brief Method set_button, addr 0x6cc6dd8, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::EventSystems::PointerEventData_InputButton value);

  /// @brief Method set_eventData, addr 0x6cc6dc8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x6cc6de4, size 0xcc, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x6cc6ec0, size 0xd0, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x6cc6fa4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x6cc630c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cc6d4c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x6cc6eb0, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x6cc6f90, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cc713c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClearSelection, addr 0x6cc6794, size 0x180, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method CopyFromTo, addr 0x6cc5e9c, size 0xa8, virtual false, abstract: false, final false
  inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData* from, ::UnityEngine::EventSystems::PointerEventData* to);

  /// @brief Method DeselectIfSelectionChanged, addr 0x6cc6b8c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastPointerEventData, addr 0x6cc6340, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t id);

  /// @brief Method GetMousePointerEventData, addr 0x6cc5fc0, size 0x14, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData();

  /// @brief Method GetMousePointerEventData, addr 0x6cc5fd4, size 0x338, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData(int32_t id);

  /// @brief Method GetPointerData, addr 0x6cc5ac8, size 0x108, virtual false, abstract: false, final false
  inline bool GetPointerData(int32_t id, ::ByRef<::UnityEngine::EventSystems::PointerEventData*> data, bool create);

  /// @brief Method GetTouchPointerEventData, addr 0x6cc5c38, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPointerOverGameObject, addr 0x6cc66f0, size 0xa4, virtual true, abstract: false, final false
  inline bool IsPointerOverGameObject(int32_t pointerId);

  static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor();

  /// @brief Method ProcessDrag, addr 0x6cc63f0, size 0x300, virtual true, abstract: false, final false
  inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method ProcessMove, addr 0x6cc638c, size 0x64, virtual true, abstract: false, final false
  inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method RemovePointerData, addr 0x6cc5bd0, size 0x68, virtual false, abstract: false, final false
  inline void RemovePointerData(::UnityEngine::EventSystems::PointerEventData* data);

  /// @brief Method ShouldStartDrag, addr 0x6cc635c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method StateForMouseButton, addr 0x6cc5f44, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_FramePressState StateForMouseButton(int32_t buttonId);

  /// @brief Method ToString, addr 0x6cc6914, size 0x278, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cc6c84, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();
