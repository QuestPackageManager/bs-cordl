...
public:
  ...
  /// @brief Method .ctor, addr 0x4adc220, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_button, addr 0x4adc210, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_InputButton get_button();

  /// @brief Method get_eventData, addr 0x4adc200, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData* get_eventData();

  /// @brief Method set_button, addr 0x4adc218, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::EventSystems::PointerEventData_InputButton value);

  /// @brief Method set_eventData, addr 0x4adc208, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnyPressesThisFrame, addr 0x4adc228, size 0xbc, virtual false, abstract: false, final false
  inline bool AnyPressesThisFrame();

  /// @brief Method AnyReleasesThisFrame, addr 0x4adc2f4, size 0xc0, virtual false, abstract: false, final false
  inline bool AnyReleasesThisFrame();

  /// @brief Method GetButtonState, addr 0x4adc3c8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method SetButtonState, addr 0x4adb7a8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4adc184, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method PressedThisFrame, addr 0x4adc2e4, size 0x10, virtual false, abstract: false, final false
  inline bool PressedThisFrame();

  /// @brief Method ReleasedThisFrame, addr 0x4adc3b4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4adc558, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClearSelection, addr 0x4adbbd0, size 0x1c0, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method CopyFromTo, addr 0x4adb378, size 0x88, virtual false, abstract: false, final false
  inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData* from, ::UnityEngine::EventSystems::PointerEventData* to);

  /// @brief Method DeselectIfSelectionChanged, addr 0x4adbff8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastPointerEventData, addr 0x4adb7e0, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t id);

  /// @brief Method GetMousePointerEventData, addr 0x4adb47c, size 0x14, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData();

  /// @brief Method GetMousePointerEventData, addr 0x4adb490, size 0x318, virtual true, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData(int32_t id);

  /// @brief Method GetPointerData, addr 0x4adaeb4, size 0xec, virtual false, abstract: false, final false
  inline bool GetPointerData(int32_t id, ::ByRef<::UnityEngine::EventSystems::PointerEventData*> data, bool create);

  /// @brief Method GetTouchPointerEventData, addr 0x4adaffc, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPointerOverGameObject, addr 0x4adbb34, size 0x9c, virtual true, abstract: false, final false
  inline bool IsPointerOverGameObject(int32_t pointerId);

  static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor();

  /// @brief Method ProcessDrag, addr 0x4adb874, size 0x2c0, virtual true, abstract: false, final false
  inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method ProcessMove, addr 0x4adb830, size 0x44, virtual true, abstract: false, final false
  inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData* pointerEvent);

  /// @brief Method RemovePointerData, addr 0x4adafa0, size 0x5c, virtual false, abstract: false, final false
  inline void RemovePointerData(::UnityEngine::EventSystems::PointerEventData* data);

  /// @brief Method ShouldStartDrag, addr 0x4adb800, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method StateForMouseButton, addr 0x4adb400, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_FramePressState StateForMouseButton(int32_t buttonId);

  /// @brief Method ToString, addr 0x4adbd90, size 0x268, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4adc0e4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
