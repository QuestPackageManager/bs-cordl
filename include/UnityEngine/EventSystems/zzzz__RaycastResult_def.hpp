...
public:
  ...
  /// @brief Method Clear, addr 0x32f0604, size 0xa4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ToString, addr 0x32e5364, size 0x6d8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_gameObject, addr 0x32f055c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_isValid, addr 0x32f056c, size 0x98, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method set_gameObject, addr 0x32f0564, size 0x8, virtual false, abstract: false, final false
  ...
  // ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "depth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "sortingLayer", ty: "int32_t", modifiers: "",
  // def_value: None }, CppParam { name: "sortingOrder", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "worldPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None
  // }, CppParam { name: "worldNormal", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "screenPosition", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None
  // }, CppParam { name: "displayIndex", ty: "int32_t", modifiers: "", def_value: None }]
