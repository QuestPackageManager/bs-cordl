...
public:
  ...
  /// @brief Method Clear, addr 0x4ae67c8, size 0xa8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ToString, addr 0x4adb650, size 0x430, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_gameObject, addr 0x4ae6720, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_isValid, addr 0x4ae6730, size 0x98, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method set_gameObject, addr 0x4ae6728, size 0x8, virtual false, abstract: false, final false
