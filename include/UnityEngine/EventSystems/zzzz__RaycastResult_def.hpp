...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_GameObject", ty: "::UnityW<::UnityEngine::GameObject>", modifiers: "", def_value: None }, CppParam { name: "module", ty:
  ...
  constexpr RaycastResult(::UnityW<::UnityEngine::GameObject> m_GameObject, ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> module, float_t distance, float_t index, int32_t depth,
  ...
  ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> module;
