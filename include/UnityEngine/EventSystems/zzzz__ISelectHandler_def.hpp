...
// Write type traits
MARK_REF_T(::UnityEngine::EventSystems::ISelectHandler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::EventSystems::ISelectHandler*, "UnityEngine.EventSystems", "ISelectHandler");
// Dependencies
namespace UnityEngine::EventSystems {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISelectHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISelectHandler(ISelectHandlerconst&) = delete;
