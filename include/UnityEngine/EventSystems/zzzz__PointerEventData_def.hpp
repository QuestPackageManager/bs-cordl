...
public:
  ...
  /// @brief Method IsPointerMoving, addr 0x6cbf4b4, size 0x20, virtual false, abstract: false, final false
  inline bool IsPointerMoving();

  /// @brief Method IsScrolling, addr 0x6cbf4d4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x6cbf6a4, size 0x754, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbf388, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::EventSystems::EventSystem* eventSystem);

  /// @brief Method get_altitudeAngle, addr 0x6cbf2e0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_altitudeAngle();

  /// @brief Method get_azimuthAngle, addr 0x6cbf2f0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_azimuthAngle();

  /// @brief Method get_button, addr 0x6cbf2b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::PointerEventData_InputButton get_button();

  /// @brief Method get_clickCount, addr 0x6cbf268, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_clickCount();

  /// @brief Method get_clickTime, addr 0x6cbf258, size 0x8, virtual false, abstract: false, final false
  inline float_t get_clickTime();

  /// @brief Method get_delta, addr 0x6cbf1e8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_delta();

  /// @brief Method get_displayIndex, addr 0x6cbf1b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_displayIndex();

  /// @brief Method get_dragging, addr 0x6cbf2a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_dragging();

  /// @brief Method get_eligibleForClick, addr 0x6cbf1a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_eligibleForClick();

  /// @brief Method get_enterEventCamera, addr 0x6cbf4f4, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_enterEventCamera();

  /// @brief Method get_fullyExited, addr 0x6cbf368, size 0x8, virtual false, abstract: false, final false
  inline bool get_fullyExited();

  /// @brief Method get_lastPress, addr 0x6cbf128, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_lastPress();

  /// @brief Method get_penStatus, addr 0x6cbf328, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PenStatus get_penStatus();

  /// @brief Method get_pointerClick, addr 0x6cbf158, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_pointerClick();

  /// @brief Method get_pointerCurrentRaycast, addr 0x6cbf168, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::RaycastResult get_pointerCurrentRaycast();

  /// @brief Method get_pointerDrag, addr 0x6cbf148, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_pointerDrag();

  /// @brief Method get_pointerEnter, addr 0x6cbf118, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_pointerEnter();

  /// @brief Method get_pointerId, addr 0x6cbf1c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_pointerId();

  /// @brief Method get_pointerPress, addr 0x6cbf61c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_pointerPress();

  /// @brief Method get_pointerPressRaycast, addr 0x6cbf184, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::EventSystems::RaycastResult get_pointerPressRaycast();

  /// @brief Method get_position, addr 0x6cbf1d0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_position();

  /// @brief Method get_pressEventCamera, addr 0x6cbf588, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_pressEventCamera();

  /// @brief Method get_pressPosition, addr 0x6cbf200, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_pressPosition();

  /// @brief Method get_pressure, addr 0x6cbf2c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pressure();

  /// @brief Method get_radius, addr 0x6cbf338, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radius();

  /// @brief Method get_radiusVariance, addr 0x6cbf350, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_radiusVariance();

  /// @brief Method get_rawPointerPress, addr 0x6cbf138, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_rawPointerPress();

  /// @brief Method get_reentered, addr 0x6cbf378, size 0x8, virtual false, abstract: false, final false
  inline bool get_reentered();

  /// @brief Method get_scrollDelta, addr 0x6cbf278, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_scrollDelta();

  /// @brief Method get_tangentialPressure, addr 0x6cbf2d0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tangentialPressure();

  /// @brief Method get_tilt, addr 0x6cbf310, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_tilt();

  /// @brief Method get_twist, addr 0x6cbf300, size 0x8, virtual false, abstract: false, final false
  inline float_t get_twist();

  /// @brief Method get_useDragThreshold, addr 0x6cbf290, size 0x8, virtual false, abstract: false, final false
  inline bool get_useDragThreshold();

  /// @brief Method get_worldNormal, addr 0x6cbf238, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_worldNormal();

  /// @brief Method get_worldPosition, addr 0x6cbf218, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_worldPosition();

  /// @brief Method set_altitudeAngle, addr 0x6cbf2e8, size 0x8, virtual false, abstract: false, final false
  inline void set_altitudeAngle(float_t value);

  /// @brief Method set_azimuthAngle, addr 0x6cbf2f8, size 0x8, virtual false, abstract: false, final false
  inline void set_azimuthAngle(float_t value);

  /// @brief Method set_button, addr 0x6cbf2b8, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::EventSystems::PointerEventData_InputButton value);

  /// @brief Method set_clickCount, addr 0x6cbf270, size 0x8, virtual false, abstract: false, final false
  inline void set_clickCount(int32_t value);

  /// @brief Method set_clickTime, addr 0x6cbf260, size 0x8, virtual false, abstract: false, final false
  inline void set_clickTime(float_t value);

  /// @brief Method set_delta, addr 0x6cbf1f4, size 0xc, virtual false, abstract: false, final false
  inline void set_delta(::UnityEngine::Vector2 value);

  /// @brief Method set_displayIndex, addr 0x6cbf1b8, size 0x8, virtual false, abstract: false, final false
  inline void set_displayIndex(int32_t value);

  /// @brief Method set_dragging, addr 0x6cbf2a8, size 0x8, virtual false, abstract: false, final false
  inline void set_dragging(bool value);

  /// @brief Method set_eligibleForClick, addr 0x6cbf1a8, size 0x8, virtual false, abstract: false, final false
  inline void set_eligibleForClick(bool value);

  /// @brief Method set_fullyExited, addr 0x6cbf370, size 0x8, virtual false, abstract: false, final false
  inline void set_fullyExited(bool value);

  /// @brief Method set_lastPress, addr 0x6cbf130, size 0x8, virtual false, abstract: false, final false
  inline void set_lastPress(::UnityEngine::GameObject* value);

  /// @brief Method set_penStatus, addr 0x6cbf330, size 0x8, virtual false, abstract: false, final false
  inline void set_penStatus(::UnityEngine::PenStatus value);

  /// @brief Method set_pointerClick, addr 0x6cbf160, size 0x8, virtual false, abstract: false, final false
  inline void set_pointerClick(::UnityEngine::GameObject* value);

  /// @brief Method set_pointerCurrentRaycast, addr 0x6cbf178, size 0xc, virtual false, abstract: false, final false
  inline void set_pointerCurrentRaycast(::UnityEngine::EventSystems::RaycastResult value);

  /// @brief Method set_pointerDrag, addr 0x6cbf150, size 0x8, virtual false, abstract: false, final false
  inline void set_pointerDrag(::UnityEngine::GameObject* value);

  /// @brief Method set_pointerEnter, addr 0x6cbf120, size 0x8, virtual false, abstract: false, final false
  inline void set_pointerEnter(::UnityEngine::GameObject* value);

  /// @brief Method set_pointerId, addr 0x6cbf1c8, size 0x8, virtual false, abstract: false, final false
  inline void set_pointerId(int32_t value);

  /// @brief Method set_pointerPress, addr 0x6cbf624, size 0x80, virtual false, abstract: false, final false
  inline void set_pointerPress(::UnityEngine::GameObject* value);

  /// @brief Method set_pointerPressRaycast, addr 0x6cbf194, size 0xc, virtual false, abstract: false, final false
  inline void set_pointerPressRaycast(::UnityEngine::EventSystems::RaycastResult value);

  /// @brief Method set_position, addr 0x6cbf1dc, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector2 value);

  /// @brief Method set_pressPosition, addr 0x6cbf20c, size 0xc, virtual false, abstract: false, final false
  inline void set_pressPosition(::UnityEngine::Vector2 value);

  /// @brief Method set_pressure, addr 0x6cbf2c8, size 0x8, virtual false, abstract: false, final false
  inline void set_pressure(float_t value);

  /// @brief Method set_radius, addr 0x6cbf344, size 0xc, virtual false, abstract: false, final false
  inline void set_radius(::UnityEngine::Vector2 value);

  /// @brief Method set_radiusVariance, addr 0x6cbf35c, size 0xc, virtual false, abstract: false, final false
  inline void set_radiusVariance(::UnityEngine::Vector2 value);

  /// @brief Method set_rawPointerPress, addr 0x6cbf140, size 0x8, virtual false, abstract: false, final false
  inline void set_rawPointerPress(::UnityEngine::GameObject* value);

  /// @brief Method set_reentered, addr 0x6cbf380, size 0x8, virtual false, abstract: false, final false
  inline void set_reentered(bool value);

  /// @brief Method set_scrollDelta, addr 0x6cbf284, size 0xc, virtual false, abstract: false, final false
  inline void set_scrollDelta(::UnityEngine::Vector2 value);

  /// @brief Method set_tangentialPressure, addr 0x6cbf2d8, size 0x8, virtual false, abstract: false, final false
  inline void set_tangentialPressure(float_t value);

  /// @brief Method set_tilt, addr 0x6cbf31c, size 0xc, virtual false, abstract: false, final false
  inline void set_tilt(::UnityEngine::Vector2 value);

  /// @brief Method set_twist, addr 0x6cbf308, size 0x8, virtual false, abstract: false, final false
  inline void set_twist(float_t value);

  /// @brief Method set_useDragThreshold, addr 0x6cbf298, size 0x8, virtual false, abstract: false, final false
  inline void set_useDragThreshold(bool value);

  /// @brief Method set_worldNormal, addr 0x6cbf248, size 0x10, virtual false, abstract: false, final false
  inline void set_worldNormal(::UnityEngine::Vector3 value);

  /// @brief Method set_worldPosition, addr 0x6cbf228, size 0x10, virtual false, abstract: false, final false
