...
constexpr ::UnityEngine::EventSystems::EventTriggerType::EventTriggerType(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::EventSystems::EventTriggerType::EventTriggerType() {}
