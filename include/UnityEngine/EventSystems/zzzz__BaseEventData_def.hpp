...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseEventData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseEventData(BaseEventData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseEventData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseEventData(BaseEventDataconst&) = delete;
