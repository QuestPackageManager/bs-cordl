...
public:
  ...
  /// @brief Method .ctor, addr 0x6c4c550, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::EventSystems::EventSystem* eventSystem);

  /// @brief Method get_currentInputModule, addr 0x6c4c578, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::EventSystems::BaseInputModule> get_currentInputModule();

  /// @brief Method get_selectedObject, addr 0x6c4c590, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_selectedObject();

  /// @brief Method set_selectedObject, addr 0x6c4c5a8, size 0x18, virtual false, abstract: false, final false
