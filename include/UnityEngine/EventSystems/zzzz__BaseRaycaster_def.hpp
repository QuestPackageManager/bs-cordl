...
public:
  ...
  /// @brief Method OnCanvasHierarchyChanged, addr 0x2eacf20, size 0x8, virtual true, abstract: false, final false
  inline void OnCanvasHierarchyChanged();

  /// @brief Method OnDisable, addr 0x2eacecc, size 0x54, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2eace78, size 0x54, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTransformParentChanged, addr 0x2eacf2c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2eacbb4, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ea1e80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_priority, addr 0x2eacb9c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_priority();

  /// @brief Method get_renderOrderPriority, addr 0x2eacbac, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_renderOrderPriority();

  /// @brief Method get_rootRaycaster, addr 0x2ea3c44, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> get_rootRaycaster();

  /// @brief Method get_sortOrderPriority, addr 0x2eacba4, size 0x8, virtual true, abstract: false, final false
