...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncInstantiateOperation_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncInstantiateOperation_1(AsyncInstantiateOperation_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncInstantiateOperation_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncInstantiateOperation_1(AsyncInstantiateOperation_1const&) = delete;
