...
public:
  ...
  /// @brief Method Reset, addr 0x33f0fb8, size 0x28, virtual false, abstract: false, final false
  static inline void Reset();

  /// @brief Method .ctor, addr 0x33f0e34, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakedColorSpace, addr 0x33f0e08, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::ColorSpace get_bakedColorSpace();

  /// @brief Method get_lightProbes, addr 0x33f0f54, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::LightProbes> get_lightProbes();

  /// @brief Method get_lightmaps, addr 0x33f0e8c, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::LightmapData*, ::Array<::UnityEngine::LightmapData*>*> get_lightmaps();

  /// @brief Method get_lightmapsMode, addr 0x33f0ef0, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::LightmapsMode get_lightmapsMode();

  /// @brief Method get_lightmapsModeLegacy, addr 0x33f0dfc, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::LightmapsModeLegacy get_lightmapsModeLegacy();

  /// @brief Method set_bakedColorSpace, addr 0x33f0e30, size 0x4, virtual false, abstract: false, final false
  static inline void set_bakedColorSpace(::UnityEngine::ColorSpace value);

  /// @brief Method set_lightProbes, addr 0x33f0f7c, size 0x3c, virtual false, abstract: false, final false
  static inline void set_lightProbes(::UnityEngine::LightProbes* value);

  /// @brief Method set_lightmaps, addr 0x33f0eb4, size 0x3c, virtual false, abstract: false, final false
  static inline void set_lightmaps(::ArrayW<::UnityEngine::LightmapData*, ::Array<::UnityEngine::LightmapData*>*> value);

  /// @brief Method set_lightmapsMode, addr 0x33f0f18, size 0x3c, virtual false, abstract: false, final false
  static inline void set_lightmapsMode(::UnityEngine::LightmapsMode value);

  /// @brief Method set_lightmapsModeLegacy, addr 0x33f0e04, size 0x4, virtual false, abstract: false, final false
