...
public:
  ...
  /// @brief Method WrapBootConfigData, addr 0x485efa0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x485eff8, size 0x84, virtual false, abstract: false, final false
