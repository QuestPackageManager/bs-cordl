...
public:
  ...
  /// @brief Method WrapBootConfigData, addr 0x2e1afa4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e1b004, size 0xc4, virtual false, abstract: false, final false
