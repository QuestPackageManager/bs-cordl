...
public:
  ...
  /// @brief Method .ctor, addr 0x693d134, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_impulse, addr 0x693cf20, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_impulse();

  /// @brief Method get_normal, addr 0x693cf14, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_otherCollider, addr 0x693d0d0, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_otherCollider();

  /// @brief Method get_point, addr 0x693cf08, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_separation, addr 0x693d12c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_separation();

  /// @brief Method get_thisCollider, addr 0x693cf2c, size 0x5c, virtual false, abstract: false, final false
