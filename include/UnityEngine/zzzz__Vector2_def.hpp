...
public:
  ...
  /// @brief Method get_Item addr 0x2b6e76c size 0x6c virtual false final false
  inline float_t get_Item(int32_t index);

  /// @brief Method set_Item addr 0x2b6e7d8 size 0x6c virtual false final false
  inline void set_Item(int32_t index, float_t value);

  /// @brief Method .ctor addr 0x2b6e844 size 0x8 virtual false final false
  inline void _ctor(float_t x, float_t y);

  /// @brief Method Lerp addr 0x2b6e84c size 0x30 virtual false final false
  static inline ::UnityEngine::Vector2 Lerp(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b, float_t t);

  /// @brief Method LerpUnclamped addr 0x2b6e87c size 0x1c virtual false final false
  static inline ::UnityEngine::Vector2 LerpUnclamped(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b, float_t t);

  /// @brief Method Scale addr 0x2b6e898 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 Scale(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method Scale addr 0x2b6e8a4 size 0x14 virtual false final false
  inline void Scale(::UnityEngine::Vector2 scale);

  /// @brief Method Normalize addr 0x2b6e8b8 size 0xc8 virtual false final false
  inline void Normalize();

  /// @brief Method get_normalized addr 0x2b6e980 size 0xb0 virtual false final false
  inline ::UnityEngine::Vector2 get_normalized();

  /// @brief Method ToString addr 0x2b6ea30 size 0xc virtual true final false
  inline ::StringW ToString();

  /// @brief Method ToString addr 0x2b6ea3c size 0x8 virtual false final false
  inline ::StringW ToString(::StringW format);

  /// @brief Method ToString addr 0x2b64bc8 size 0x188 virtual true final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method GetHashCode addr 0x2b6ea44 size 0x34 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x2b6ea78 size 0x88 virtual true final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals addr 0x2b6eb00 size 0x24 virtual true final true
  inline bool Equals(::UnityEngine::Vector2 other);

  /// @brief Method Perpendicular addr 0x2b6eb24 size 0x14 virtual false final false
  static inline ::UnityEngine::Vector2 Perpendicular(::UnityEngine::Vector2 inDirection);

  /// @brief Method Dot addr 0x2b6eb38 size 0x10 virtual false final false
  static inline float_t Dot(::UnityEngine::Vector2 lhs, ::UnityEngine::Vector2 rhs);

  /// @brief Method get_magnitude addr 0x2b6eb48 size 0x6c virtual false final false
  inline float_t get_magnitude();

  /// @brief Method get_sqrMagnitude addr 0x2b6ebb4 size 0x14 virtual false final false
  inline float_t get_sqrMagnitude();

  /// @brief Method Angle addr 0x2b6ebc8 size 0xf4 virtual false final false
  static inline float_t Angle(::UnityEngine::Vector2 from, ::UnityEngine::Vector2 to);

  /// @brief Method SignedAngle addr 0x2b6ecbc size 0x10c virtual false final false
  static inline float_t SignedAngle(::UnityEngine::Vector2 from, ::UnityEngine::Vector2 to);

  /// @brief Method Distance addr 0x2b6edc8 size 0x84 virtual false final false
  static inline float_t Distance(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method ClampMagnitude addr 0x2b6ee4c size 0x94 virtual false final false
  static inline ::UnityEngine::Vector2 ClampMagnitude(::UnityEngine::Vector2 vector, float_t maxLength);

  /// @brief Method SqrMagnitude addr 0x2b6eee0 size 0x10 virtual false final false
  static inline float_t SqrMagnitude(::UnityEngine::Vector2 a);

  /// @brief Method Min addr 0x2b6eef0 size 0x14 virtual false final false
  static inline ::UnityEngine::Vector2 Min(::UnityEngine::Vector2 lhs, ::UnityEngine::Vector2 rhs);

  /// @brief Method Max addr 0x2b6ef04 size 0x14 virtual false final false
  static inline ::UnityEngine::Vector2 Max(::UnityEngine::Vector2 lhs, ::UnityEngine::Vector2 rhs);

  /// @brief Method op_Addition addr 0x2b6ef18 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Addition(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method op_Subtraction addr 0x2b6ef24 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Subtraction(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method op_Multiply addr 0x2b6ef30 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Multiply(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method op_Division addr 0x2b6ef3c size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Division(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method op_UnaryNegation addr 0x2b6ef48 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_UnaryNegation(::UnityEngine::Vector2 a);

  /// @brief Method op_Multiply addr 0x2b6ef54 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Multiply(::UnityEngine::Vector2 a, float_t d);

  /// @brief Method op_Multiply addr 0x2b6ef60 size 0x10 virtual false final false
  static inline ::UnityEngine::Vector2 op_Multiply(float_t d, ::UnityEngine::Vector2 a);

  /// @brief Method op_Division addr 0x2b6ef70 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 op_Division(::UnityEngine::Vector2 a, float_t d);

  /// @brief Method op_Equality addr 0x2b6ef7c size 0x28 virtual false final false
  static inline bool op_Equality(::UnityEngine::Vector2 lhs, ::UnityEngine::Vector2 rhs);

  /// @brief Method op_Inequality addr 0x2b6efa4 size 0x28 virtual false final false
  static inline bool op_Inequality(::UnityEngine::Vector2 lhs, ::UnityEngine::Vector2 rhs);

  /// @brief Method op_Implicit addr 0x2b6efcc size 0x4 virtual false final false
  static inline ::UnityEngine::Vector2 op_Implicit___UnityEngine__Vector2(::UnityEngine::Vector3 v);

  /// @brief Method op_Implicit addr 0x2b6efd0 size 0x8 virtual false final false
  static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::UnityEngine::Vector2 v);

  /// @brief Method get_zero addr 0x2b6efd8 size 0x48 virtual false final false
  static inline ::UnityEngine::Vector2 get_zero();

  /// @brief Method get_one addr 0x2b6f020 size 0x48 virtual false final false
  static inline ::UnityEngine::Vector2 get_one();

  /// @brief Method get_up addr 0x2b6f068 size 0x48 virtual false final false
  static inline ::UnityEngine::Vector2 get_up();

  /// @brief Method get_down addr 0x2b6f0b0 size 0x48 virtual false final false
  static inline ::UnityEngine::Vector2 get_down();

  /// @brief Method get_right addr 0x2b6f0f8 size 0x48 virtual false final false
