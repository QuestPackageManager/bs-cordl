...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad77a0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW menuName);

  /// @brief Method .ctor, addr 0x6ad77ac, size 0xc, virtual false, abstract: false, final false
