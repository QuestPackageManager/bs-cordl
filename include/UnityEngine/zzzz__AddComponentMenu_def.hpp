...
public:
  ...
  /// @brief Method .ctor, addr 0x2dc4db8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW menuName);

  /// @brief Method .ctor, addr 0x2dc4de4, size 0x30, virtual false, abstract: false, final false
