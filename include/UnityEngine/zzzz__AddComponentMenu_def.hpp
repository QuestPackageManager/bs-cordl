...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddComponentMenu", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddComponentMenu(AddComponentMenu&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddComponentMenu", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddComponentMenu(AddComponentMenuconst&) = delete;
