...
public:
  ...
  /// @brief Method .ctor, addr 0x48ac24c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW menuName);

  /// @brief Method .ctor, addr 0x48ac278, size 0x30, virtual false, abstract: false, final false
