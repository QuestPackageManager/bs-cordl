...
public:
  ...
  /// @brief Method .ctor, addr 0x690ffac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW menuName);

  /// @brief Method .ctor, addr 0x690ffb8, size 0xc, virtual false, abstract: false, final false
