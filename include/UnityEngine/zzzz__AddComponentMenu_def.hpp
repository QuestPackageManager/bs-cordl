...
/// @brief Method .ctor, addr 0x691066c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  menuName) ;

/// @brief Method .ctor, addr 0x6910678, size 0xc, virtual false, abstract: false, final false
