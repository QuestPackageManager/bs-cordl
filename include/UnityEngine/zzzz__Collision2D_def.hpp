...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Collision2D", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Collision2D(Collision2D&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Collision2D", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Collision2D(Collision2Dconst&) = delete;
