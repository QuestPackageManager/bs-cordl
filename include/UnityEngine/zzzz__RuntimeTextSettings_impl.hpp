...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::RuntimeTextSettings> (*)()>(&::UnityEngine::RuntimeTextSettings::get_defaultTextSettings)> {
  ...
  constexpr static std::size_t addrs = 0x6986bf4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Shader> (::UnityEngine::RuntimeTextSettings::*)()>(&::UnityEngine::RuntimeTextSettings::GetFontShader)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6986cb4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>* (::UnityEngine::RuntimeTextSettings::*)()>(&::UnityEngine::RuntimeTextSettings::GetStaticFallbackOSFontAsset)> {
  constexpr static std::size_t size = 0x4c;
  constexpr static std::size_t addrs = 0x6986d08;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::RuntimeTextSettings::*)(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>*)>(&::UnityEngine::RuntimeTextSettings::SetStaticFallbackOSFontAsset)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x6986d54;
...
::cordl_internals::setStaticField<::UnityW<::UnityEngine::RuntimeTextSettings>, "s_DefaultTextSettings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::RuntimeTextSettings*>::get>(std::forward<::UnityW<::UnityEngine::RuntimeTextSettings>>(value));
}
inline ::UnityW<::UnityEngine::RuntimeTextSettings> UnityEngine::RuntimeTextSettings::getStaticF_s_DefaultTextSettings()  {
return ::cordl_internals::getStaticField<::UnityW<::UnityEngine::RuntimeTextSettings>, "s_DefaultTextSettings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::RuntimeTextSettings*>::get>();
}
...
::cordl_internals::setStaticField<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>*, "s_FallbackOSFontAssetIMGUIInternal", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::RuntimeTextSettings*>::get>(std::forward<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::FontAsset>>*, "s_FallbackOSFontAssetIMGUIInternal", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::RuntimeTextSettings*>::get>();
}
