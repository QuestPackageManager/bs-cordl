...
public:
  ...
  /// @brief Method get_format addr 0x2b4b720 size 0x3c virtual false final false
  inline ::UnityEngine::TextureFormat get_format();

  /// @brief Method Internal_CreateImpl addr 0x2b4b75c size 0x74 virtual false final false
  ...
  /// @brief Method Internal_Create addr 0x2b4b7d0 size 0xc8 virtual false final false
  ...
  /// @brief Method get_isReadable addr 0x2b4b898 size 0x3c virtual true final false
  inline bool get_isReadable();

  /// @brief Method SmoothEdges addr 0x2b4b8d4 size 0x44 virtual false final false
  inline void SmoothEdges(int32_t smoothRegionWidthInPixels);

  /// @brief Method SmoothEdges addr 0x2b4b918 size 0x40 virtual false final false
  inline void SmoothEdges();

  /// @brief Method GetPixels addr 0x2b4b958 size 0x54 virtual false final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> GetPixels(::UnityEngine::CubemapFace face, int32_t miplevel);

  /// @brief Method GetPixels addr 0x2b4b9ac size 0x48 virtual false final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> GetPixels(::UnityEngine::CubemapFace face);

  /// @brief Method SetPixels addr 0x2b4b9f4 size 0x5c virtual false final false
  ...
  /// @brief Method SetPixels addr 0x2b4ba50 size 0x58 virtual false final false
  inline void SetPixels(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> colors, ::UnityEngine::CubemapFace face);

  /// @brief Method ValidateFormat addr 0x2b4baa8 size 0xd4 virtual false final false
  inline bool ValidateFormat(::UnityEngine::TextureFormat format, int32_t width);

  /// @brief Method ValidateFormat addr 0x2b4bb7c size 0x128 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4bca4 size 0x3c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4bce0 size 0xe8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4bdc8 size 0x78 virtual false final false
  inline void _ctor(int32_t width, ::UnityEngine::TextureFormat format, int32_t mipCount);

  static inline ::UnityEngine::Cubemap* New_ctor(int32_t width, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                                                 int32_t mipCount);

  /// @brief Method .ctor addr 0x2b4bf68 size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4be40 size 0x128 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4c09c size 0x10 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4c0ac size 0x80 virtual false final false
  inline void _ctor(int32_t width, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method CreateExternalTexture addr 0x2b4c12c size 0x10c virtual false final false
  ...
  /// @brief Method ValidateIsNotCrunched addr 0x2b4c044 size 0x58 virtual false final false
