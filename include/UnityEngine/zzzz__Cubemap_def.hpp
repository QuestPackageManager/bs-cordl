...
public:
  ...
  template <typename T> inline void SetPixelData(::ArrayW<T> data, int32_t mipLevel, ::UnityEngine::CubemapFace face, /* [DefaultValue("0")] */ int32_t sourceDataStartIndex);
