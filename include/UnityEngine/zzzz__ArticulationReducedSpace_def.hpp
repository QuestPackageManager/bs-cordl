...
namespace UnityEngine {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13910))]
...
public:
  ...
  /// @brief Method get_Item, addr 0x2d2a06c, size 0x5c, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t i);

  /// @brief Method set_Item, addr 0x2d2a0c8, size 0x5c, virtual false, abstract: false, final false
  inline void set_Item(int32_t i, float_t value);

  /// @brief Method .ctor, addr 0x2d2a124, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a);

  /// @brief Method .ctor, addr 0x2d2a134, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b);

  /// @brief Method .ctor, addr 0x2d2a144, size 0x14, virtual false, abstract: false, final false
