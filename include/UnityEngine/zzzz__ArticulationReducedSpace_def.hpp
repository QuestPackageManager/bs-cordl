...
public:
  ...
  /// @brief Method .ctor, addr 0x69a7040, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a);

  /// @brief Method .ctor, addr 0x69a7050, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b);

  /// @brief Method .ctor, addr 0x69a7060, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t a, float_t b, float_t c);

  /// @brief Method get_Item, addr 0x69a6fa0, size 0x50, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t i);

  /// @brief Method set_Item, addr 0x69a6ff0, size 0x50, virtual false, abstract: false, final false
