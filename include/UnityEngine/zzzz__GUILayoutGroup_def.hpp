...
public:
  ...
  /// @brief Method Add, addr 0x48e0770, size 0xa4, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::GUILayoutEntry* e);

  /// @brief Method ApplyOptions, addr 0x48e63ec, size 0x120, virtual true, abstract: false, final false
  inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*, ::Array<::UnityEngine::GUILayoutOption*>*> options);

  /// @brief Method ApplyStyleSettings, addr 0x48e650c, size 0x74, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::UnityEngine::GUIStyle* style);

  /// @brief Method CalcHeight, addr 0x48e7468, size 0x5fc, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x48e6580, size 0x6ac, virtual true, abstract: false, final false
  inline void CalcWidth();

  /// @brief Method GetNext, addr 0x48e0814, size 0x2e4, virtual false, abstract: false, final false
  inline ::UnityEngine::GUILayoutEntry* GetNext();

  static inline ::UnityEngine::GUILayoutGroup* New_ctor();

  /// @brief Method ResetCursor, addr 0x48e061c, size 0x8, virtual false, abstract: false, final false
  inline void ResetCursor();

  /// @brief Method SetHorizontal, addr 0x48e6c2c, size 0x83c, virtual true, abstract: false, final false
  inline void SetHorizontal(float_t x, float_t width);

  /// @brief Method SetVertical, addr 0x48e7a64, size 0x848, virtual true, abstract: false, final false
  inline void SetVertical(float_t y, float_t height);

  /// @brief Method ToString, addr 0x48e82ac, size 0x38c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48dfcb0, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::GUILayoutEntry* getStaticF_none();

  /// @brief Method get_marginBottom, addr 0x48e63e4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginBottom();

  /// @brief Method get_marginLeft, addr 0x48e63cc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginLeft();

  /// @brief Method get_marginRight, addr 0x48e63d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginRight();

  /// @brief Method get_marginTop, addr 0x48e63dc, size 0x8, virtual true, abstract: false, final false
