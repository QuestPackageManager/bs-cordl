...
public:
  ...
  /// @brief Method Add, addr 0x69ee034, size 0xb4, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::GUILayoutEntry* e);

  /// @brief Method ApplyOptions, addr 0x69f69dc, size 0xc8, virtual true, abstract: false, final false
  inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*, ::Array<::UnityEngine::GUILayoutOption*>*> options);

  /// @brief Method ApplyStyleSettings, addr 0x69f6aa4, size 0x74, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::UnityEngine::GUIStyle* style);

  /// @brief Method CalcHeight, addr 0x69f77e8, size 0x4c0, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x69f6b18, size 0x574, virtual true, abstract: false, final false
  inline void CalcWidth();

  /// @brief Method GetNext, addr 0x69ee0e8, size 0x29c, virtual false, abstract: false, final false
  inline ::UnityEngine::GUILayoutEntry* GetNext();

  static inline ::UnityEngine::GUILayoutGroup* New_ctor();

  /// @brief Method ResetCursor, addr 0x69edeec, size 0x8, virtual false, abstract: false, final false
  inline void ResetCursor();

  /// @brief Method SetHorizontal, addr 0x69f708c, size 0x75c, virtual true, abstract: false, final false
  inline void SetHorizontal(float_t x, float_t width);

  /// @brief Method SetVertical, addr 0x69f7ca8, size 0x76c, virtual true, abstract: false, final false
  inline void SetVertical(float_t y, float_t height);

  /// @brief Method ToString, addr 0x69f8414, size 0x344, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69ed574, size 0x114, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::GUILayoutEntry* getStaticF_none();

  /// @brief Method get_marginBottom, addr 0x69f69d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginBottom();

  /// @brief Method get_marginLeft, addr 0x69f69bc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginLeft();

  /// @brief Method get_marginRight, addr 0x69f69c4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_marginRight();

  /// @brief Method get_marginTop, addr 0x69f69cc, size 0x8, virtual true, abstract: false, final false
