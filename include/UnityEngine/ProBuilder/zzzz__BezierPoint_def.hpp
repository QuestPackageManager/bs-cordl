...
public:
  // Declarations
  /// @brief Method .ctor addr 0x29b5528 size 0x28 virtual false final false
  ...
  /// @brief Method EnforceTangentMode addr 0x29b5550 size 0x318 virtual false final false
  ...
  /// @brief Method SetPosition addr 0x29b5868 size 0x50 virtual false final false
  inline void SetPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetTangentIn addr 0x29b58b8 size 0x14 virtual false final false
  inline void SetTangentIn(::UnityEngine::Vector3 tangent, ::UnityEngine::ProBuilder::BezierTangentMode mode);

  /// @brief Method SetTangentOut addr 0x29b58cc size 0x14 virtual false final false
  inline void SetTangentOut(::UnityEngine::Vector3 tangent, ::UnityEngine::ProBuilder::BezierTangentMode mode);

  /// @brief Method QuadraticPosition addr 0x29b58e0 size 0x60 virtual false final false
  ...
  /// @brief Method CubicPosition addr 0x29b5940 size 0xa0 virtual false final false
  ...
  /// @brief Method GetLookDirection addr 0x29b59e0 size 0x9f8 virtual false final false
