...
public:
  // Declarations
  /// @brief Method CubicPosition, addr 0x46fea9c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method EnforceTangentMode, addr 0x46fe6a8, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLookDirection, addr 0x46feb3c, size 0x9ac, virtual false, abstract: false, final false
  ...
  /// @brief Method QuadraticPosition, addr 0x46fea3c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPosition, addr 0x46fe9c0, size 0x54, virtual false, abstract: false, final false
  inline void SetPosition(::UnityEngine::Vector3 position);

  /// @brief Method SetTangentIn, addr 0x46fea14, size 0x14, virtual false, abstract: false, final false
  inline void SetTangentIn(::UnityEngine::Vector3 tangent, ::UnityEngine::ProBuilder::BezierTangentMode mode);

  /// @brief Method SetTangentOut, addr 0x46fea28, size 0x14, virtual false, abstract: false, final false
  inline void SetTangentOut(::UnityEngine::Vector3 tangent, ::UnityEngine::ProBuilder::BezierTangentMode mode);

  /// @brief Method .ctor, addr 0x46fe680, size 0x28, virtual false, abstract: false, final false
