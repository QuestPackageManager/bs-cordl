...
public:
  ...
  /// @brief Method .ctor addr 0x2a3f294 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToTriangles>b__0_0 addr 0x2a3f29c size 0x18 virtual false final false
  inline ::UnityEngine::ProBuilder::Face* _ToTriangles_b__0_0(::UnityEngine::ProBuilder::FaceRebuildData* x);

  /// @brief Method <GetWindingOrder>b__3_0 addr 0x2a3f2b4 size 0x1c virtual false final false
...
public:
  ...
  /// @brief Method ToTriangles addr 0x2a3d49c size 0x5bc virtual false final false
  ...
  /// @brief Method BreakFaceIntoTris addr 0x2a3da58 size 0x61c virtual false final false
  ...
  /// @brief Method GetWindingOrder addr 0x2a3e074 size 0x38 virtual false final false
  ...
  /// @brief Method GetWindingOrder addr 0x2a3e330 size 0x1a0 virtual false final false
  ...
  /// @brief Method GetWindingOrder addr 0x2a3e0ac size 0x284 virtual false final false
  ...
  /// @brief Method FlipEdge addr 0x2a3e4d0 size 0x368 virtual false final false
  static inline bool FlipEdge(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face);

  /// @brief Method ConformNormals addr 0x2a3e838 size 0x51c virtual false final false
  ...
  /// @brief Method GetWindingFlags addr 0x2a3ed54 size 0xec virtual false final false
  ...
  /// @brief Method ConformOppositeNormal addr 0x2a3ef9c size 0x120 virtual false final false
  static inline ::UnityEngine::ProBuilder::ActionResult* ConformOppositeNormal(::UnityEngine::ProBuilder::WingedEdge* source);

  /// @brief Method GetCommonEdgeInWindingOrder addr 0x2a3ee40 size 0x15c virtual false final false
  static inline ::UnityEngine::ProBuilder::Edge GetCommonEdgeInWindingOrder(::UnityEngine::ProBuilder::WingedEdge* wing);

  /// @brief Method MatchNormal addr 0x2a3f0bc size 0x174 virtual false final false
