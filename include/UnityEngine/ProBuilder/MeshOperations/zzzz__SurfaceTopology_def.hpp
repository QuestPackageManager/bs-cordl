...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::SurfaceTopology*);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::SurfaceTopology) == 0x10, "Size mismatch!");
