...
public:
  ...
  /// @brief Method <GetWindingOrder>b__3_0, addr 0x4784568, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _GetWindingOrder_b__3_0(::UnityEngine::ProBuilder::Vertex* x);

  /// @brief Method <ToTriangles>b__0_0, addr 0x4784550, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Face* _ToTriangles_b__0_0(::UnityEngine::ProBuilder::FaceRebuildData* x);

  /// @brief Method .ctor, addr 0x4784548, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BreakFaceIntoTris, addr 0x4782d38, size 0x5ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ConformNormals, addr 0x4783ae4, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method ConformOppositeNormal, addr 0x4784240, size 0x110, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* ConformOppositeNormal(::UnityEngine::ProBuilder::WingedEdge* source);

  /// @brief Method FlipEdge, addr 0x4783774, size 0x370, virtual false, abstract: false, final false
  static inline bool FlipEdge(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face);

  /// @brief Method GetCommonEdgeInWindingOrder, addr 0x47840e4, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Edge GetCommonEdgeInWindingOrder(::UnityEngine::ProBuilder::WingedEdge* wing);

  /// @brief Method GetWindingFlags, addr 0x4783ff8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindingOrder, addr 0x4783324, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindingOrder, addr 0x478335c, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindingOrder, addr 0x47835dc, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchNormal, addr 0x4784350, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTriangles, addr 0x4782788, size 0x5b0, virtual false, abstract: false, final false
