...
/// @brief Method <Import>b__9_0, addr 0x657eb08, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 _Import_b__9_0(::UnityEngine::ProBuilder::Vertex*  x) ;

/// @brief Method .ctor, addr 0x657eb04, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_SourceMaterials, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SourceMaterials, put=__cordl_internal_set_m_SourceMaterials)) ::ArrayW<::UnityW<::UnityEngine::Material>,::Array<::UnityW<::UnityEngine::Material>>*>  m_SourceMaterials;
...
/// @brief Field m_Vertices, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Vertices, put=__cordl_internal_set_m_Vertices)) ::ArrayW<::UnityEngine::ProBuilder::Vertex*,::Array<::UnityEngine::ProBuilder::Vertex*>*>  m_Vertices;

/// @brief Method Import, addr 0x657d5e8, size 0x190, virtual false, abstract: false, final false
inline bool Import(::UnityEngine::GameObject*  go, ::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings*  importSettings) ;

/// @brief Method Import, addr 0x657d778, size 0xabc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x657d5e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh*  destination) ;

/// @brief Method .ctor, addr 0x657d35c, size 0x16c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GameObject*  gameObject) ;

/// @brief Method .ctor, addr 0x657d4c8, size 0x118, virtual false, abstract: false, final false
