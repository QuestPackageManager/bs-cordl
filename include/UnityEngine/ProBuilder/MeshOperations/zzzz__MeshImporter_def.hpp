...
public:
  ...
  /// @brief Method <Import>b__9_0, addr 0x477d0c0, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _Import_b__9_0(::UnityEngine::ProBuilder::Vertex* x);

  /// @brief Method .ctor, addr 0x477d0b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Import, addr 0x477bb0c, size 0x184, virtual false, abstract: false, final false
  inline bool Import(::UnityEngine::GameObject* go, ::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings* importSettings);

  /// @brief Method Import, addr 0x477bc90, size 0xa8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x477bae4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh* destination);

  /// @brief Method .ctor, addr 0x477b85c, size 0x168, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GameObject* gameObject);

  /// @brief Method .ctor, addr 0x477b9c4, size 0x120, virtual false, abstract: false, final false
