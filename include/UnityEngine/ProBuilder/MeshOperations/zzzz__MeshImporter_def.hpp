...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::MeshOperations::MeshImporter*);
...
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::MeshImporter___c) == 0x10, "Size mismatch!");

} // namespace UnityEngine::ProBuilder::MeshOperations
// Dependencies System.Object, UnityEngine.Material, UnityEngine.ProBuilder.Vertex
namespace UnityEngine::ProBuilder::MeshOperations {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_SourceMaterials, put = __cordl_internal_set_m_SourceMaterials)) ::ArrayW<::UnityW<::UnityEngine::Material>> m_SourceMaterials;
  ...
  static inline ::UnityEngine::ProBuilder::MeshOperations::MeshImporter* New_ctor(::UnityEngine::Mesh* sourceMesh, ::ArrayW<::UnityEngine::Material*> sourceMaterials,
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::Material>> const& __cordl_internal_get_m_SourceMaterials() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Material>>& __cordl_internal_get_m_SourceMaterials();
  ...
  constexpr ::ArrayW<::UnityEngine::ProBuilder::Vertex*> const& __cordl_internal_get_m_Vertices() const;

  constexpr ::ArrayW<::UnityEngine::ProBuilder::Vertex*>& __cordl_internal_get_m_Vertices();

  constexpr void __cordl_internal_set_m_Destination(::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> value);

  constexpr void __cordl_internal_set_m_SourceMaterials(::ArrayW<::UnityW<::UnityEngine::Material>> value);
...
public:
  ...
  ::ArrayW<::UnityW<::UnityEngine::Material>> ___m_SourceMaterials;
  ...
  ::ArrayW<::UnityEngine::ProBuilder::Vertex*> ___m_Vertices;
...
static_assert(sizeof(::UnityEngine::ProBuilder::MeshOperations::MeshImporter) == 0x30, "Size mismatch!");
