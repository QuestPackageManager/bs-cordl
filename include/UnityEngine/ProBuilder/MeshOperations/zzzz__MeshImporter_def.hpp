...
public:
  ...
  /// @brief Method <Import>b__9_0, addr 0x32f185c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _Import_b__9_0(::UnityEngine::ProBuilder::Vertex* x);

  /// @brief Method .ctor, addr 0x32f1854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Import, addr 0x32f02c8, size 0x184, virtual false, abstract: false, final false
  inline bool Import(::UnityEngine::GameObject* go, ::UnityEngine::ProBuilder::MeshOperations::MeshImportSettings* importSettings);

  /// @brief Method Import, addr 0x32f044c, size 0xab8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32f02a0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh* destination);

  /// @brief Method .ctor, addr 0x32f000c, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GameObject* gameObject);

  /// @brief Method .ctor, addr 0x32f0178, size 0x128, virtual false, abstract: false, final false
