...
/// @brief Field <>9__0_6, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__0_6, put=setStaticF___9__0_6)) ::System::Func_2<::UnityEngine::ProBuilder::SimpleTuple_2<::UnityEngine::ProBuilder::FaceRebuildData*,::System::Collections::Generic::List_1<int32_t>*>,int32_t>*  __9__0_6;

static inline ::UnityEngine::ProBuilder::MeshOperations::Bevel___c* New_ctor() ;

/// @brief Method <BevelEdges>b__0_0, addr 0x65646dc, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* _BevelEdges_b__0_0(::UnityEngine::ProBuilder::FaceRebuildData*  x) ;

/// @brief Method <BevelEdges>b__0_1, addr 0x6564750, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* _BevelEdges_b__0_1(::UnityEngine::ProBuilder::FaceRebuildData*  x) ;

/// @brief Method <BevelEdges>b__0_2, addr 0x6564764, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* _BevelEdges_b__0_2(::UnityEngine::ProBuilder::FaceRebuildData*  x) ;

/// @brief Method <BevelEdges>b__0_3, addr 0x6564778, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* _BevelEdges_b__0_3(::UnityEngine::ProBuilder::FaceRebuildData*  x) ;

/// @brief Method <BevelEdges>b__0_6, addr 0x65646f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65646d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::System::Func_2<::UnityEngine::ProBuilder::SimpleTuple_2<::UnityEngine::ProBuilder::FaceRebuildData*,::System::Collections::Generic::List_1<int32_t>*>,int32_t>* getStaticF___9__0_6() ;
...
static inline void setStaticF___9__0_6(::System::Func_2<::UnityEngine::ProBuilder::SimpleTuple_2<::UnityEngine::ProBuilder::FaceRebuildData*,::System::Collections::Generic::List_1<int32_t>*>,int32_t>*  value) ;
...
/// @brief Field ignore, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_ignore, put=__cordl_internal_set_ignore)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::ProBuilder::Face*,::System::Collections::Generic::List_1<int32_t>*>*  ignore;

/// @brief Field sharedIndexes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_sharedIndexes, put=__cordl_internal_set_sharedIndexes)) ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*,::Array<::UnityEngine::ProBuilder::SharedVertex*>*>  sharedIndexes;

static inline ::UnityEngine::ProBuilder::MeshOperations::Bevel___c__DisplayClass0_0* New_ctor() ;

/// @brief Method <BevelEdges>b__7, addr 0x656478c, size 0x3c, virtual false, abstract: false, final false
inline int32_t _BevelEdges_b__7(int32_t  x) ;

/// @brief Method <BevelEdges>b__8, addr 0x65647c8, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6563754, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <BevelEdges>b__4, addr 0x6564804, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6563758, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <BevelEdges>b__5, addr 0x656483c, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6564410, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BevelEdges, addr 0x6560ea0, size 0x28b4, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Face*>* BevelEdges(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Edge>*  edges, float_t  amount) ;

/// @brief Method GetBridgeFaces, addr 0x6563b70, size 0x8a0, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::FaceRebuildData*>* GetBridgeFaces(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Vertex*>*  vertices, ::UnityEngine::ProBuilder::WingedEdge*  left, ::UnityEngine::ProBuilder::WingedEdge*  right, ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::SimpleTuple_2<::UnityEngine::ProBuilder::FaceRebuildData*,::System::Collections::Generic::List_1<int32_t>*>>*>*  holes) ;

/// @brief Method GetLeadingEdge, addr 0x6564518, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::Edge GetLeadingEdge(::UnityEngine::ProBuilder::WingedEdge*  wing, int32_t  common) ;

/// @brief Method SlideEdge, addr 0x656375c, size 0x414, virtual false, abstract: false, final false
