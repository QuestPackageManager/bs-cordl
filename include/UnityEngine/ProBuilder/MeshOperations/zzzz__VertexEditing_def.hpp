...
public:
  // Declarations
  /// @brief Method MergeVertices, addr 0x2bc4420, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitVertices, addr 0x2bc474c, size 0x88, virtual false, abstract: false, final false
  static inline void SplitVertices(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method SplitVertices, addr 0x2bc47d4, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method WeldVertices, addr 0x2bc4bf8, size 0xce8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExplodeVertex, addr 0x2bc58e0, size 0xb90, virtual false, abstract: false, final false
  ...
  /// @brief Method AlignEdgeWithDirection, addr 0x2bc6470, size 0x1048, virtual false, abstract: false, final false
