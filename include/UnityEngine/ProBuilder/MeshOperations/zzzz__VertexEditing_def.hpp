...
public:
  // Declarations
  /// @brief Method AlignEdgeWithDirection, addr 0x478d4f4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method ExplodeVertex, addr 0x478c968, size 0xb8c, virtual false, abstract: false, final false
  ...
  /// @brief Method MergeVertices, addr 0x478b4cc, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitVertices, addr 0x478b7dc, size 0x88, virtual false, abstract: false, final false
  static inline void SplitVertices(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method SplitVertices, addr 0x478b864, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method WeldVertices, addr 0x478bc74, size 0xcf4, virtual false, abstract: false, final false
