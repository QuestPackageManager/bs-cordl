...
public:
  // Declarations
  /// @brief Method MergeVertices addr 0x2bc68b4 size 0x32c virtual false final false
  ...
  /// @brief Method SplitVertices addr 0x2bc6be0 size 0x88 virtual false final false
  static inline void SplitVertices(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method SplitVertices addr 0x2bc6c68 size 0x424 virtual false final false
  ...
  /// @brief Method WeldVertices addr 0x2bc708c size 0xce8 virtual false final false
  ...
  /// @brief Method ExplodeVertex addr 0x2bc7d74 size 0xb90 virtual false final false
  ...
  /// @brief Method AlignEdgeWithDirection addr 0x2bc8904 size 0x1048 virtual false final false
