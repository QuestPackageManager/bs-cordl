...
public:
  ...
  /// @brief Method ToString, addr 0x331a270, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331a348, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_quads, addr 0x331a238, size 0x8, virtual false, abstract: false, final false
  inline bool get_quads();

  /// @brief Method get_smoothing, addr 0x331a24c, size 0x8, virtual false, abstract: false, final false
  inline bool get_smoothing();

  /// @brief Method get_smoothingAngle, addr 0x331a260, size 0x8, virtual false, abstract: false, final false
  inline float_t get_smoothingAngle();

  /// @brief Method set_quads, addr 0x331a240, size 0xc, virtual false, abstract: false, final false
  inline void set_quads(bool value);

  /// @brief Method set_smoothing, addr 0x331a254, size 0xc, virtual false, abstract: false, final false
  inline void set_smoothing(bool value);

  /// @brief Method set_smoothingAngle, addr 0x331a268, size 0x8, virtual false, abstract: false, final false
