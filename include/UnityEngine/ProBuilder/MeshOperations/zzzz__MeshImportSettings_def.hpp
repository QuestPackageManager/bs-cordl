...
/// @brief Method ToString, addr 0x657d26c, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x657d348, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_quads, addr 0x657d23c, size 0x8, virtual false, abstract: false, final false
inline bool get_quads() ;

/// @brief Method get_smoothing, addr 0x657d24c, size 0x8, virtual false, abstract: false, final false
inline bool get_smoothing() ;

/// @brief Method get_smoothingAngle, addr 0x657d25c, size 0x8, virtual false, abstract: false, final false
inline float_t get_smoothingAngle() ;

/// @brief Method set_quads, addr 0x657d244, size 0x8, virtual false, abstract: false, final false
inline void set_quads(bool  value) ;

/// @brief Method set_smoothing, addr 0x657d254, size 0x8, virtual false, abstract: false, final false
inline void set_smoothing(bool  value) ;

/// @brief Method set_smoothingAngle, addr 0x657d264, size 0x8, virtual false, abstract: false, final false
