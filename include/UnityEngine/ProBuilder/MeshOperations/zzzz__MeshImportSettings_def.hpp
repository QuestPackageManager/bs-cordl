...
public:
  ...
  /// @brief Method ToString, addr 0x65ef278, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65ef354, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_quads, addr 0x65ef248, size 0x8, virtual false, abstract: false, final false
  inline bool get_quads();

  /// @brief Method get_smoothing, addr 0x65ef258, size 0x8, virtual false, abstract: false, final false
  inline bool get_smoothing();

  /// @brief Method get_smoothingAngle, addr 0x65ef268, size 0x8, virtual false, abstract: false, final false
  inline float_t get_smoothingAngle();

  /// @brief Method set_quads, addr 0x65ef250, size 0x8, virtual false, abstract: false, final false
  inline void set_quads(bool value);

  /// @brief Method set_smoothing, addr 0x65ef260, size 0x8, virtual false, abstract: false, final false
  inline void set_smoothing(bool value);

  /// @brief Method set_smoothingAngle, addr 0x65ef270, size 0x8, virtual false, abstract: false, final false
