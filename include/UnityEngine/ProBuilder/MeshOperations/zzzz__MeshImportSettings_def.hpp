...
public:
  ...
  /// @brief Method ToString, addr 0x478a658, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x478a730, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_quads, addr 0x478a620, size 0x8, virtual false, abstract: false, final false
  inline bool get_quads();

  /// @brief Method get_smoothing, addr 0x478a634, size 0x8, virtual false, abstract: false, final false
  inline bool get_smoothing();

  /// @brief Method get_smoothingAngle, addr 0x478a648, size 0x8, virtual false, abstract: false, final false
  inline float_t get_smoothingAngle();

  /// @brief Method set_quads, addr 0x478a628, size 0xc, virtual false, abstract: false, final false
  inline void set_quads(bool value);

  /// @brief Method set_smoothing, addr 0x478a63c, size 0xc, virtual false, abstract: false, final false
  inline void set_smoothing(bool value);

  /// @brief Method set_smoothingAngle, addr 0x478a650, size 0x8, virtual false, abstract: false, final false
