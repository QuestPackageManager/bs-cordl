...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x651a3a0, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x6519d0c, size 0x694, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x6515fe8, size 0x800, virtual false, abstract: false, final false
