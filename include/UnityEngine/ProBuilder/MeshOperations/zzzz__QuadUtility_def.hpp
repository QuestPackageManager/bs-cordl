...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x332d448, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x332cddc, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x33290dc, size 0x854, virtual false, abstract: false, final false
