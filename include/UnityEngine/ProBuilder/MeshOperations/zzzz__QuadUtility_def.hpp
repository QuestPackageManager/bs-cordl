...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x32f5270, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x32f4c04, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x32f0f04, size 0x854, virtual false, abstract: false, final false
