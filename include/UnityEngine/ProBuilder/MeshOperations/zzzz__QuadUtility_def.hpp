...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x673387c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x67331e8, size 0x694, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x672f4c4, size 0x800, virtual false, abstract: false, final false
