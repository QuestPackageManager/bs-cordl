...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x47868d0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x4786248, size 0x688, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x47825d8, size 0x8b0, virtual false, abstract: false, final false
