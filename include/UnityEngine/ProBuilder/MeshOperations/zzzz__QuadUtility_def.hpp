...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x331f5c4, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x331ef58, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x331b258, size 0x854, virtual false, abstract: false, final false
