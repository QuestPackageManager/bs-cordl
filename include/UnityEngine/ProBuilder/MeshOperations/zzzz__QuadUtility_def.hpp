...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x30ee7e8, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x30ee17c, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x30ea47c, size 0x854, virtual false, abstract: false, final false
