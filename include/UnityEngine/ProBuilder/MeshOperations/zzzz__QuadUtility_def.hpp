...
public:
  // Declarations
  /// @brief Method GetBestQuadConnection, addr 0x477d4e0, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuadScore, addr 0x477ce58, size 0x688, virtual false, abstract: false, final false
  ...
  /// @brief Method ToQuads, addr 0x47791e8, size 0x8b0, virtual false, abstract: false, final false
