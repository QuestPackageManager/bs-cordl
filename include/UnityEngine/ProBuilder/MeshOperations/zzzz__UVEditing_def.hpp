...
public:
  ...
  /// @brief Method <GetUVs>b__2_0, addr 0x65fc0d8, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 _GetUVs_b__2_0(::UnityEngine::Vector4 x);

  /// @brief Method <ProjectFacesAuto>b__8_0, addr 0x65fc120, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesAuto_b__8_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesAuto>b__8_1, addr 0x65fc140, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesAuto_b__8_1(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesBox>b__11_0, addr 0x65fc180, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesBox_b__11_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <ProjectFacesBox>b__9_0, addr 0x65fc160, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _ProjectFacesBox_b__9_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <SewUVs>b__4_1, addr 0x65fc0dc, size 0x44, virtual false, abstract: false, final false
  inline int32_t _SewUVs_b__4_1(::System::Collections::Generic::KeyValuePair_2<int32_t, int32_t> y);

  /// @brief Method .ctor, addr 0x65fc0d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AutoStitch>b__0, addr 0x65fc1a0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65f8d50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SewUVs>b__0, addr 0x65fc1e0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65fa6c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AlignEdges, addr 0x65f8d54, size 0xa04, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyUVs, addr 0x65f9d40, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoStitch, addr 0x65f8ad4, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method CollapseUVs, addr 0x65fa6c8, size 0xcc, virtual false, abstract: false, final false
  static inline void CollapseUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t, ::Array<int32_t>*> indexes);

  /// @brief Method FindMinimalUV, addr 0x65fb628, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method FitUVs, addr 0x65fbf84, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUVs, addr 0x65f9758, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectFacesAuto, addr 0x65fab98, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectFacesBox, addr 0x65faf48, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectFacesBox, addr 0x65fb6ec, size 0x71c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectFacesSphere, addr 0x65fbe08, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method SewUVs, addr 0x65fa0a0, size 0x624, virtual false, abstract: false, final false
  static inline void SewUVs(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t, ::Array<int32_t>*> indexes, float_t delta);

  /// @brief Method SplitUVs, addr 0x65fa794, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitUVs, addr 0x65f99c0, size 0x380, virtual false, abstract: false, final false
