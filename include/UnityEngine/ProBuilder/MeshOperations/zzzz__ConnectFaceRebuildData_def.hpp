...
public:
  ...
  /// @brief Method .ctor, addr 0x671e36c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConnectFaceRebuildData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConnectFaceRebuildData(ConnectFaceRebuildData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConnectFaceRebuildData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConnectFaceRebuildData(ConnectFaceRebuildDataconst&) = delete;
