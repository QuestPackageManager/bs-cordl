...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x4782708, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x4782650, size 0xb8, virtual false, abstract: false, final false
