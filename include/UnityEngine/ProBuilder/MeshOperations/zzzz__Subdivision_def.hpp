...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x32f5594, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x32f54e0, size 0xb4, virtual false, abstract: false, final false
