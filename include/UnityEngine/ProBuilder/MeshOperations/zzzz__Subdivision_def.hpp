...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x477d80c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x477d754, size 0xb8, virtual false, abstract: false, final false
