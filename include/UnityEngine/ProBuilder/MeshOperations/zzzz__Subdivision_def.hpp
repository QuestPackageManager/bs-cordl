...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x47823a0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x47822e8, size 0xb8, virtual false, abstract: false, final false
