...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x4782780, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x47826c8, size 0xb8, virtual false, abstract: false, final false
