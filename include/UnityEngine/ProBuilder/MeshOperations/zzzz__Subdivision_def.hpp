...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x4783fa4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x4783eec, size 0xb8, virtual false, abstract: false, final false
