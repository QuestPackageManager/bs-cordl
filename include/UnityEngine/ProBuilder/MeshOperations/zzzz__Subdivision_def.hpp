...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x65f48ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x65f4830, size 0xbc, virtual false, abstract: false, final false
