...
public:
  // Declarations
  /// @brief Method Subdivide, addr 0x4786bfc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Subdivide, addr 0x4786b44, size 0xb8, virtual false, abstract: false, final false
