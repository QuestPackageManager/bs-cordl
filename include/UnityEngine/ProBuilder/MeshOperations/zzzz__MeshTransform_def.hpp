...
public:
  // Declarations
  /// @brief Method CenterPivot, addr 0x2c9d8ec, size 0x2f8, virtual false, abstract: false, final false
  static inline void CenterPivot(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t, ::Array<int32_t>*> indexes);

  /// @brief Method FreezeScaleTransform, addr 0x2ca2370, size 0x164, virtual false, abstract: false, final false
  static inline void FreezeScaleTransform(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SetPivot, addr 0x2ca210c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPivot, addr 0x2ca21cc, size 0x1a4, virtual false, abstract: false, final false
