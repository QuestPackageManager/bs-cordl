...
public:
  // Declarations
  /// @brief Method CenterPivot, addr 0x47878c0, size 0x2d8, virtual false, abstract: false, final false
  static inline void CenterPivot(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t, ::Array<int32_t>*> indexes);

  /// @brief Method FreezeScaleTransform, addr 0x478c1f4, size 0x160, virtual false, abstract: false, final false
  static inline void FreezeScaleTransform(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SetPivot, addr 0x478bfc8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPivot, addr 0x478c060, size 0x194, virtual false, abstract: false, final false
