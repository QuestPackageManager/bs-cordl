...
public:
  // Declarations
  /// @brief Method CenterPivot, addr 0x477e890, size 0x2d8, virtual false, abstract: false, final false
  static inline void CenterPivot(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<int32_t, ::Array<int32_t>*> indexes);

  /// @brief Method FreezeScaleTransform, addr 0x47831c4, size 0x160, virtual false, abstract: false, final false
  static inline void FreezeScaleTransform(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SetPivot, addr 0x4782f98, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPivot, addr 0x4783030, size 0x194, virtual false, abstract: false, final false
