...
public:
  ...
  /// @brief Method <CreateShapeFromPolygon>b__8_0, addr 0x6712064, size 0x14, virtual false, abstract: false, final false
  inline int32_t _CreateShapeFromPolygon_b__8_0(::ArrayW<::UnityEngine::Vector3> arr);

  /// @brief Method <FaceWithVerticesAndHole>b__10_0, addr 0x6712078, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_0(::UnityEngine::ProBuilder::Vertex* v);

  /// @brief Method <FaceWithVerticesAndHole>b__10_1, addr 0x6712090, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_1(::UnityEngine::ProBuilder::Vertex* v);

  /// @brief Method <InsertVertexInFace>b__18_0, addr 0x67120a8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Face* _InsertVertexInFace_b__18_0(::UnityEngine::ProBuilder::FaceRebuildData* f);

  /// @brief Method .ctor, addr 0x6712060, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AppendVerticesToEdge>b__0, addr 0x67120bc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670f3dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppendFace, addr 0x6707a84, size 0x8b0, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendFaces, addr 0x6708334, size 0x65c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToEdge, addr 0x670d6e8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToEdge, addr 0x670d76c, size 0x1c70, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToFace, addr 0x670ca10, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToFace, addr 0x670ca18, size 0xc54, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Face* AppendVerticesToFace(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face, ::ArrayW<::UnityEngine::Vector3> points,
                                                                      bool insertOnEdge);

  /// @brief Method Bridge, addr 0x670b380, size 0x13c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearAndRefreshMesh, addr 0x6709cfc, size 0x3c, virtual false, abstract: false, final false
  static inline void ClearAndRefreshMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CreatePolygon, addr 0x6708990, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePolygonWithHole, addr 0x6708f70, size 0x8e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x6709cf4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x670a8dc, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                                ::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* points, float_t extrude, bool flipNormals,
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x6709d38, size 0xba4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                                ::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* points, float_t extrude, bool flipNormals,
                                                                                ::System::Collections::Generic::IList_1<::System::Collections::Generic::IList_1<::UnityEngine::Vector3>*>* holePoints);

  /// @brief Method CreateShapeFromPolygon, addr 0x6709cc4, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::PolyShape* poly);

  /// @brief Method DuplicateAndFlip, addr 0x670a8e4, size 0x6f4, virtual false, abstract: false, final false
  static inline void DuplicateAndFlip(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::ArrayW<::UnityEngine::ProBuilder::Face*> faces);

  /// @brief Method FaceWithVertices, addr 0x6708ea8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceWithVerticesAndHole, addr 0x6709858, size 0x46c, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexInFace, addr 0x670f9c8, size 0xe74, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexInMesh, addr 0x6711bfc, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexOnEdge, addr 0x671083c, size 0x13c0, virtual false, abstract: false, final false
  ...
  /// @brief Method TentCapWithVertices, addr 0x670afd8, size 0x3a8, virtual false, abstract: false, final false
