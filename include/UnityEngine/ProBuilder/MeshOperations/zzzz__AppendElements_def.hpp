...
public:
  ...
  /// @brief Method <CreateShapeFromPolygon>b__8_0, addr 0x47621a0, size 0x18, virtual false, abstract: false, final false
  inline int32_t _CreateShapeFromPolygon_b__8_0(::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> arr);

  /// @brief Method <FaceWithVerticesAndHole>b__10_0, addr 0x47621b8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_0(::UnityEngine::ProBuilder::Vertex* v);

  /// @brief Method <FaceWithVerticesAndHole>b__10_1, addr 0x47621d4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_1(::UnityEngine::ProBuilder::Vertex* v);

  /// @brief Method <InsertVertexInFace>b__18_0, addr 0x47621f0, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Face* _InsertVertexInFace_b__18_0(::UnityEngine::ProBuilder::FaceRebuildData* f);

  /// @brief Method .ctor, addr 0x4762198, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AppendVerticesToEdge>b__0, addr 0x4762208, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x475f6b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppendFace, addr 0x4757eec, size 0x878, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendFaces, addr 0x4758764, size 0x5d4, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToEdge, addr 0x475d8e4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToEdge, addr 0x475d964, size 0x1d54, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToFace, addr 0x475cca8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendVerticesToFace, addr 0x475ccb0, size 0xbbc, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Face* AppendVerticesToFace(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face,
                                                                      ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> points, bool insertOnEdge);

  /// @brief Method Bridge, addr 0x475b6bc, size 0x12f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearAndRefreshMesh, addr 0x475a134, size 0x3c, virtual false, abstract: false, final false
  static inline void ClearAndRefreshMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CreatePolygon, addr 0x4758d38, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePolygonWithHole, addr 0x4759330, size 0x96c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x475a128, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x475acc4, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                                ::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* points, float_t extrude, bool flipNormals,
  ...
  /// @brief Method CreateShapeFromPolygon, addr 0x475a170, size 0xb54, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                                ::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* points, float_t extrude, bool flipNormals,
                                                                                ::System::Collections::Generic::IList_1<::System::Collections::Generic::IList_1<::UnityEngine::Vector3>*>* holePoints);

  /// @brief Method CreateShapeFromPolygon, addr 0x475a0f8, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::PolyShape* poly);

  /// @brief Method DuplicateAndFlip, addr 0x475acd0, size 0x66c, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceWithVertices, addr 0x4759268, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceWithVerticesAndHole, addr 0x4759c9c, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexInFace, addr 0x475fb88, size 0xe58, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexInMesh, addr 0x4761dac, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertVertexOnEdge, addr 0x47609e0, size 0x13cc, virtual false, abstract: false, final false
  ...
  /// @brief Method TentCapWithVertices, addr 0x475b33c, size 0x380, virtual false, abstract: false, final false
