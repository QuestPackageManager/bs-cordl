...
/// @brief Method <CreateShapeFromPolygon>b__8_0, addr 0x65d4958, size 0x14, virtual false, abstract: false, final false
inline int32_t _CreateShapeFromPolygon_b__8_0(::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  arr) ;

/// @brief Method <FaceWithVerticesAndHole>b__10_0, addr 0x65d496c, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_0(::UnityEngine::ProBuilder::Vertex*  v) ;

/// @brief Method <FaceWithVerticesAndHole>b__10_1, addr 0x65d4984, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 _FaceWithVerticesAndHole_b__10_1(::UnityEngine::ProBuilder::Vertex*  v) ;

/// @brief Method <InsertVertexInFace>b__18_0, addr 0x65d499c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* _InsertVertexInFace_b__18_0(::UnityEngine::ProBuilder::FaceRebuildData*  f) ;

/// @brief Method .ctor, addr 0x65d4954, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <AppendVerticesToEdge>b__0, addr 0x65d49b0, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65d1cd0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AppendFace, addr 0x65ca378, size 0x8b0, virtual false, abstract: false, final false
...
/// @brief Method AppendFaces, addr 0x65cac28, size 0x65c, virtual false, abstract: false, final false
...
/// @brief Method AppendVerticesToEdge, addr 0x65cffdc, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method AppendVerticesToEdge, addr 0x65d0060, size 0x1c70, virtual false, abstract: false, final false
...
/// @brief Method AppendVerticesToFace, addr 0x65cf304, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AppendVerticesToFace, addr 0x65cf30c, size 0xc54, virtual false, abstract: false, final false
...
/// @brief Method Bridge, addr 0x65cdc74, size 0x13c0, virtual false, abstract: false, final false
...
/// @brief Method ClearAndRefreshMesh, addr 0x65cc5f0, size 0x3c, virtual false, abstract: false, final false
static inline void ClearAndRefreshMesh(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh) ;

/// @brief Method CreatePolygon, addr 0x65cb284, size 0x518, virtual false, abstract: false, final false
...
/// @brief Method CreatePolygonWithHole, addr 0x65cb864, size 0x8e8, virtual false, abstract: false, final false
...
/// @brief Method CreateShapeFromPolygon, addr 0x65cc5e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CreateShapeFromPolygon, addr 0x65cd1d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CreateShapeFromPolygon, addr 0x65cc62c, size 0xba4, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::System::Collections::Generic::IList_1<::UnityEngine::Vector3>*  points, float_t  extrude, bool  flipNormals, ::System::Collections::Generic::IList_1<::System::Collections::Generic::IList_1<::UnityEngine::Vector3>*>*  holePoints) ;

/// @brief Method CreateShapeFromPolygon, addr 0x65cc5b8, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::ActionResult* CreateShapeFromPolygon(::UnityEngine::ProBuilder::PolyShape*  poly) ;

/// @brief Method DuplicateAndFlip, addr 0x65cd1d8, size 0x6f4, virtual false, abstract: false, final false
...
/// @brief Method FaceWithVertices, addr 0x65cb79c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method FaceWithVerticesAndHole, addr 0x65cc14c, size 0x46c, virtual false, abstract: false, final false
...
/// @brief Method InsertVertexInFace, addr 0x65d22bc, size 0xe74, virtual false, abstract: false, final false
...
/// @brief Method InsertVertexInMesh, addr 0x65d44f0, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method InsertVertexOnEdge, addr 0x65d3130, size 0x13c0, virtual false, abstract: false, final false
...
/// @brief Method TentCapWithVertices, addr 0x65cd8cc, size 0x3a8, virtual false, abstract: false, final false
