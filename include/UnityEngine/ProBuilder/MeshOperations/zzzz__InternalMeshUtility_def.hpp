...
public:
  ...
  /// @brief Method <CreateMeshWithTransform>b__1_0, addr 0x30e3068, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> _CreateMeshWithTransform_b__1_0(::UnityEngine::Mesh* x);

  /// @brief Method <CreateMeshWithTransform>b__1_1, addr 0x30e3080, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> _CreateMeshWithTransform_b__1_1(::UnityEngine::Mesh* x);

  /// @brief Method <CreateMeshWithTransform>b__1_2, addr 0x30e3098, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> _CreateMeshWithTransform_b__1_2(::UnityEngine::Mesh* x);

  /// @brief Method <FilterUnusedSubmeshIndexes>b__3_0, addr 0x30e30f8, size 0xc, virtual false, abstract: false, final false
  inline bool _FilterUnusedSubmeshIndexes_b__3_0(bool x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_0, addr 0x30e30b0, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> _ResetPbObjectWithMeshFilter_b__2_0(::UnityEngine::Mesh* x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_1, addr 0x30e30c8, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> _ResetPbObjectWithMeshFilter_b__2_1(::UnityEngine::Mesh* x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_2, addr 0x30e30e0, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> _ResetPbObjectWithMeshFilter_b__2_2(::UnityEngine::Mesh* x);

  /// @brief Method .ctor, addr 0x30e3060, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AverageNormalWithIndexes, addr 0x30defa4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMeshWithTransform, addr 0x30e04d8, size 0x10fc, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterUnusedSubmeshIndexes, addr 0x30e2aa4, size 0x558, virtual false, abstract: false, final false
  static inline void FilterUnusedSubmeshIndexes(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method ResetPbObjectWithMeshFilter, addr 0x30e18cc, size 0x11d8, virtual false, abstract: false, final false
