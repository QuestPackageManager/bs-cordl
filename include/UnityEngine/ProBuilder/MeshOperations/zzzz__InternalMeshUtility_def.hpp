...
public:
  ...
  /// @brief Method <CreateMeshWithTransform>b__1_0, addr 0x65edd6c, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> _CreateMeshWithTransform_b__1_0(::UnityEngine::Mesh* x);

  /// @brief Method <CreateMeshWithTransform>b__1_1, addr 0x65edd84, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> _CreateMeshWithTransform_b__1_1(::UnityEngine::Mesh* x);

  /// @brief Method <CreateMeshWithTransform>b__1_2, addr 0x65edd9c, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> _CreateMeshWithTransform_b__1_2(::UnityEngine::Mesh* x);

  /// @brief Method <FilterUnusedSubmeshIndexes>b__3_0, addr 0x65eddfc, size 0xc, virtual false, abstract: false, final false
  inline bool _FilterUnusedSubmeshIndexes_b__3_0(bool x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_0, addr 0x65eddb4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> _ResetPbObjectWithMeshFilter_b__2_0(::UnityEngine::Mesh* x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_1, addr 0x65eddcc, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> _ResetPbObjectWithMeshFilter_b__2_1(::UnityEngine::Mesh* x);

  /// @brief Method <ResetPbObjectWithMeshFilter>b__2_2, addr 0x65edde4, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> _ResetPbObjectWithMeshFilter_b__2_2(::UnityEngine::Mesh* x);

  /// @brief Method .ctor, addr 0x65edd68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AverageNormalWithIndexes, addr 0x65e9d54, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMeshWithTransform, addr 0x65eb224, size 0x112c, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterUnusedSubmeshIndexes, addr 0x65ed7f0, size 0x524, virtual false, abstract: false, final false
  static inline void FilterUnusedSubmeshIndexes(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method ResetPbObjectWithMeshFilter, addr 0x65ec650, size 0x11a0, virtual false, abstract: false, final false
