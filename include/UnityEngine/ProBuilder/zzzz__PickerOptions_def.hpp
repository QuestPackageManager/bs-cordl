...
public:
  ...
  /// @brief Method Equals, addr 0x64c49f8, size 0xb4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x64c4aac, size 0xa4, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ProBuilder::PickerOptions other);

  /// @brief Method GetHashCode, addr 0x64c4b50, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::ProBuilder::PickerOptions getStaticF_k_Default();

  /// @brief Method get_Default, addr 0x64c499c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::PickerOptions get_Default();

  /// @brief Method get_depthTest, addr 0x64c497c, size 0x8, virtual false, abstract: false, final false
  inline bool get_depthTest();

  /// @brief Method get_rectSelectMode, addr 0x64c498c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::RectSelectMode get_rectSelectMode();

  /// @brief Method op_Equality, addr 0x64c4bcc, size 0x70, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::PickerOptions a, ::UnityEngine::ProBuilder::PickerOptions b);

  /// @brief Method op_Inequality, addr 0x64c4c3c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_depthTest, addr 0x64c4984, size 0x8, virtual false, abstract: false, final false
  inline void set_depthTest(bool value);

  /// @brief Method set_rectSelectMode, addr 0x64c4994, size 0x8, virtual false, abstract: false, final false
