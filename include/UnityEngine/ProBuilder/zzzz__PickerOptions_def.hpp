...
public:
  ...
  /// @brief Method Equals, addr 0x329f414, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x329f4ac, size 0x38, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ProBuilder::PickerOptions other);

  /// @brief Method GetHashCode, addr 0x329f4e4, size 0x3c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::ProBuilder::PickerOptions getStaticF_k_Default();

  /// @brief Method get_Default, addr 0x329f3bc, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::PickerOptions get_Default();

  /// @brief Method get_depthTest, addr 0x329f398, size 0x8, virtual false, abstract: false, final false
  inline bool get_depthTest();

  /// @brief Method get_rectSelectMode, addr 0x329f3ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::RectSelectMode get_rectSelectMode();

  /// @brief Method op_Equality, addr 0x329f520, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::PickerOptions a, ::UnityEngine::ProBuilder::PickerOptions b);

  /// @brief Method op_Inequality, addr 0x329f554, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method set_depthTest, addr 0x329f3a0, size 0xc, virtual false, abstract: false, final false
  inline void set_depthTest(bool value);

  /// @brief Method set_rectSelectMode, addr 0x329f3b4, size 0x8, virtual false, abstract: false, final false
