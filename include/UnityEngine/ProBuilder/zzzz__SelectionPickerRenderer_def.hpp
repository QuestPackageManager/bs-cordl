...
public:
  ...
  /// @brief Method RenderLookupTexture, addr 0x473e580, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Texture2D> RenderLookupTexture(::UnityEngine::Camera* camera, ::UnityEngine::Shader* shader, ::StringW tag, int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x473e588, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RenderLookupTexture, addr 0x473e590, size 0x3c0, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Texture2D> RenderLookupTexture(::UnityEngine::Camera* camera, ::UnityEngine::Shader* shader, ::StringW tag, int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x473e950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GenerateFacePickingObjects>b__24_0, addr 0x473e9bc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x473e9b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PickVerticesInRect>b__0, addr 0x473e9dc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x473e9d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildEdgeMesh, addr 0x473dfd8, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildVertexMesh, addr 0x473d838, size 0x7a0, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeRGBA, addr 0x473c488, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t DecodeRGBA(::UnityEngine::Color32 color);

  /// @brief Method EncodeRGBA, addr 0x473d824, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 EncodeRGBA(uint32_t hash);

  /// @brief Method GenerateEdgePickingObjects, addr 0x473d3f4, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFacePickingObjects, addr 0x473ca5c, size 0x568, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateVertexPickingObjects, addr 0x473cfc4, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method PickEdgesInRect, addr 0x473b43c, size 0x798, virtual false, abstract: false, final false
  ...
  /// @brief Method PickFacesInRect, addr 0x473a588, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method PickVerticesInRect, addr 0x4738cdc, size 0x968, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x473c77c, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x473c49c, size 0x2e0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> RenderSelectionPickerTexture(
      ::UnityEngine::Camera* camera, ::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh>>* selection, bool doDepthTest,
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x473c23c, size 0x24c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> RenderSelectionPickerTexture(
  ...
  /// @brief Method ShouldUseHDRP, addr 0x473c234, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pickerRenderer, addr 0x473c164, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::SelectionPickerRenderer_ISelectionPickerRenderer* get_pickerRenderer();

  /// @brief Method get_renderTextureFormat, addr 0x473c000, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::RenderTextureFormat get_renderTextureFormat();

  /// @brief Method get_textureFormat, addr 0x473c15c, size 0x8, virtual false, abstract: false, final false
