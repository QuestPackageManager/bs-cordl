...
public:
  ...
  /// @brief Method RenderLookupTexture, addr 0x309a240, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Texture2D> RenderLookupTexture(::UnityEngine::Camera* camera, ::UnityEngine::Shader* shader, ::StringW tag, int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x309a248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RenderLookupTexture, addr 0x309a250, size 0x414, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Texture2D> RenderLookupTexture(::UnityEngine::Camera* camera, ::UnityEngine::Shader* shader, ::StringW tag, int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x309a664, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PickVerticesInRect>b__0, addr 0x309a674, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x309a66c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GenerateFacePickingObjects>b__24_0, addr 0x309a828, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x309a820, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildEdgeMesh, addr 0x3099ca4, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildVertexMesh, addr 0x3099538, size 0x76c, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeRGBA, addr 0x3097fdc, size 0x84, virtual false, abstract: false, final false
  static inline uint32_t DecodeRGBA(::UnityEngine::Color32 color);

  /// @brief Method EncodeRGBA, addr 0x30994b0, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 EncodeRGBA(uint32_t hash);

  /// @brief Method GenerateEdgePickingObjects, addr 0x3099030, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFacePickingObjects, addr 0x3098620, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateVertexPickingObjects, addr 0x3098bb0, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method PickEdgesInRect, addr 0x30970d0, size 0x7a0, virtual false, abstract: false, final false
  ...
  /// @brief Method PickFacesInRect, addr 0x30962a4, size 0x5e4, virtual false, abstract: false, final false
  ...
  /// @brief Method PickVerticesInRect, addr 0x30949a8, size 0x9b8, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x3098340, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x3098060, size 0x2e0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> RenderSelectionPickerTexture(
      ::UnityEngine::Camera* camera, ::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh>>* selection, bool doDepthTest,
  ...
  /// @brief Method RenderSelectionPickerTexture, addr 0x3097d90, size 0x24c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> RenderSelectionPickerTexture(
  ...
  /// @brief Method ShouldUseHDRP, addr 0x3097d88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pickerRenderer, addr 0x3097cb0, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::__SelectionPickerRenderer__ISelectionPickerRenderer* get_pickerRenderer();

  /// @brief Method get_renderTextureFormat, addr 0x3097b4c, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::RenderTextureFormat get_renderTextureFormat();

  /// @brief Method get_textureFormat, addr 0x3097ca8, size 0x8, virtual false, abstract: false, final false
