...
public:
  ...
  /// @brief Method .ctor addr 0x2a055b0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortCommonIndexesByAdjacency>b__0 addr 0x2a05e80 size 0x84 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2a05f68 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortCommonIndexesByAdjacency>b__32_1 addr 0x2a05f70 size 0x18 virtual false final false
  inline ::UnityEngine::ProBuilder::Edge _SortCommonIndexesByAdjacency_b__32_1(::UnityEngine::ProBuilder::WingedEdge* y);

  /// @brief Method <SortCommonIndexesByAdjacency>b__32_2 addr 0x2a05f88 size 0x8 virtual false final false
...
public:
  ...
  /// @brief Method get_edge addr 0x2a043e0 size 0xc virtual false final false
  inline ::UnityEngine::ProBuilder::EdgeLookup get_edge();

  /// @brief Method set_edge addr 0x2a043ec size 0x8 virtual false final false
  inline void set_edge(::UnityEngine::ProBuilder::EdgeLookup value);

  /// @brief Method get_face addr 0x2a043f4 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::Face* get_face();

  /// @brief Method set_face addr 0x2a043fc size 0x8 virtual false final false
  inline void set_face(::UnityEngine::ProBuilder::Face* value);

  /// @brief Method get_next addr 0x2a04404 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_next();

  /// @brief Method set_next addr 0x2a0440c size 0x8 virtual false final false
  inline void set_next(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method get_previous addr 0x2a04414 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_previous();

  /// @brief Method set_previous addr 0x2a0441c size 0x8 virtual false final false
  inline void set_previous(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method get_opposite addr 0x2a04424 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_opposite();

  /// @brief Method set_opposite addr 0x2a0442c size 0x8 virtual false final false
  inline void set_opposite(::UnityEngine::ProBuilder::WingedEdge* value);

  static inline ::UnityEngine::ProBuilder::WingedEdge* New_ctor();

  /// @brief Method .ctor addr 0x2a04434 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Equals addr 0x2a0443c size 0x38 virtual true final true
  inline bool Equals(::UnityEngine::ProBuilder::WingedEdge* other);

  /// @brief Method Equals addr 0x2a04474 size 0xd4 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2a04548 size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Count addr 0x2a04568 size 0x34 virtual false final false
  inline int32_t Count();

  /// @brief Method ToString addr 0x2a0459c size 0x1cc virtual true final false
  inline ::StringW ToString();

  /// @brief Method MakeQuad addr 0x2a04768 size 0x3dc virtual false final false
  ...
  /// @brief Method GetAdjacentEdgeWithCommonIndex addr 0x2a04b44 size 0x84 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* GetAdjacentEdgeWithCommonIndex(int32_t common);

  /// @brief Method SortEdgesByAdjacency addr 0x2a04bc8 size 0x118 virtual false final false
  ...
  /// @brief Method SortEdgesByAdjacency addr 0x2a04ce0 size 0x19c virtual false final false
  static inline void SortEdgesByAdjacency(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>* edges);

  /// @brief Method GetSpokes addr 0x2a04e7c size 0x430 virtual false final false
  ...
  /// @brief Method SortCommonIndexesByAdjacency addr 0x2a052ac size 0x304 virtual false final false
  ...
  /// @brief Method GetWingedEdges addr 0x2a055b8 size 0xf8 virtual false final false
  ...
  /// @brief Method GetWingedEdges addr 0x2a056b0 size 0x744 virtual false final false
