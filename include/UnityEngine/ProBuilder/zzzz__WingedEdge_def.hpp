...
public:
  ...
  /// @brief Method <SortCommonIndexesByAdjacency>b__32_1, addr 0x65bd6ec, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge _SortCommonIndexesByAdjacency_b__32_1(::UnityEngine::ProBuilder::WingedEdge* y);

  /// @brief Method <SortCommonIndexesByAdjacency>b__32_2, addr 0x65bd700, size 0x8, virtual false, abstract: false, final false
  inline int32_t _SortCommonIndexesByAdjacency_b__32_2(::UnityEngine::ProBuilder::Edge x);

  /// @brief Method .ctor, addr 0x65bd6e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SortCommonIndexesByAdjacency>b__0, addr 0x65bd708, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65bcdfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Count, addr 0x65bbcc8, size 0x34, virtual false, abstract: false, final false
  inline int32_t Count();

  /// @brief Method Equals, addr 0x65bbb44, size 0x10c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x65bbaa4, size 0xa0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::WingedEdge* other);

  /// @brief Method GetAdjacentEdgeWithCommonIndex, addr 0x65bc2d4, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::WingedEdge* GetAdjacentEdgeWithCommonIndex(int32_t common);

  /// @brief Method GetHashCode, addr 0x65bbc50, size 0x78, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSpokes, addr 0x65bc660, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWingedEdges, addr 0x65bcefc, size 0x6e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWingedEdges, addr 0x65bce00, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeQuad, addr 0x65bbef8, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SortCommonIndexesByAdjacency, addr 0x65bcae4, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method SortEdgesByAdjacency, addr 0x65bc3a0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method SortEdgesByAdjacency, addr 0x65bc4bc, size 0x1a4, virtual false, abstract: false, final false
  static inline void SortEdgesByAdjacency(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>* edges);

  /// @brief Method ToString, addr 0x65bbcfc, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65bbaa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_edge, addr 0x65bba4c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::EdgeLookup get_edge();

  /// @brief Method get_face, addr 0x65bba60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Face* get_face();

  /// @brief Method get_next, addr 0x65bba70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_next();

  /// @brief Method get_opposite, addr 0x65bba90, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_opposite();

  /// @brief Method get_previous, addr 0x65bba80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_edge, addr 0x65bba58, size 0x8, virtual false, abstract: false, final false
  inline void set_edge(::UnityEngine::ProBuilder::EdgeLookup value);

  /// @brief Method set_face, addr 0x65bba68, size 0x8, virtual false, abstract: false, final false
  inline void set_face(::UnityEngine::ProBuilder::Face* value);

  /// @brief Method set_next, addr 0x65bba78, size 0x8, virtual false, abstract: false, final false
  inline void set_next(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method set_opposite, addr 0x65bba98, size 0x8, virtual false, abstract: false, final false
  inline void set_opposite(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method set_previous, addr 0x65bba88, size 0x8, virtual false, abstract: false, final false
