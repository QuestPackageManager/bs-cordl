...
public:
  ...
  /// @brief Method .ctor addr 0x2b86304 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortCommonIndexesByAdjacency>b__0 addr 0x2b86bd4 size 0x84 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2b86cbc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortCommonIndexesByAdjacency>b__32_1 addr 0x2b86cc4 size 0x18 virtual false final false
  inline ::UnityEngine::ProBuilder::Edge _SortCommonIndexesByAdjacency_b__32_1(::UnityEngine::ProBuilder::WingedEdge* y);

  /// @brief Method <SortCommonIndexesByAdjacency>b__32_2 addr 0x2b86cdc size 0x8 virtual false final false
...
public:
  ...
  /// @brief Method get_edge addr 0x2b85134 size 0xc virtual false final false
  inline ::UnityEngine::ProBuilder::EdgeLookup get_edge();

  /// @brief Method set_edge addr 0x2b85140 size 0x8 virtual false final false
  inline void set_edge(::UnityEngine::ProBuilder::EdgeLookup value);

  /// @brief Method get_face addr 0x2b85148 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::Face* get_face();

  /// @brief Method set_face addr 0x2b85150 size 0x8 virtual false final false
  inline void set_face(::UnityEngine::ProBuilder::Face* value);

  /// @brief Method get_next addr 0x2b85158 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_next();

  /// @brief Method set_next addr 0x2b85160 size 0x8 virtual false final false
  inline void set_next(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method get_previous addr 0x2b85168 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_previous();

  /// @brief Method set_previous addr 0x2b85170 size 0x8 virtual false final false
  inline void set_previous(::UnityEngine::ProBuilder::WingedEdge* value);

  /// @brief Method get_opposite addr 0x2b85178 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* get_opposite();

  /// @brief Method set_opposite addr 0x2b85180 size 0x8 virtual false final false
  inline void set_opposite(::UnityEngine::ProBuilder::WingedEdge* value);

  static inline ::UnityEngine::ProBuilder::WingedEdge* New_ctor();

  /// @brief Method .ctor addr 0x2b85188 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Equals addr 0x2b85190 size 0x38 virtual true final true
  inline bool Equals(::UnityEngine::ProBuilder::WingedEdge* other);

  /// @brief Method Equals addr 0x2b851c8 size 0xd4 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2b8529c size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Count addr 0x2b852bc size 0x34 virtual false final false
  inline int32_t Count();

  /// @brief Method ToString addr 0x2b852f0 size 0x1cc virtual true final false
  inline ::StringW ToString();

  /// @brief Method MakeQuad addr 0x2b854bc size 0x3dc virtual false final false
  ...
  /// @brief Method GetAdjacentEdgeWithCommonIndex addr 0x2b85898 size 0x84 virtual false final false
  inline ::UnityEngine::ProBuilder::WingedEdge* GetAdjacentEdgeWithCommonIndex(int32_t common);

  /// @brief Method SortEdgesByAdjacency addr 0x2b8591c size 0x118 virtual false final false
  ...
  /// @brief Method SortEdgesByAdjacency addr 0x2b85a34 size 0x19c virtual false final false
  static inline void SortEdgesByAdjacency(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>* edges);

  /// @brief Method GetSpokes addr 0x2b85bd0 size 0x430 virtual false final false
  ...
  /// @brief Method SortCommonIndexesByAdjacency addr 0x2b86000 size 0x304 virtual false final false
  ...
  /// @brief Method GetWingedEdges addr 0x2b8630c size 0xf8 virtual false final false
  ...
  /// @brief Method GetWingedEdges addr 0x2b86404 size 0x744 virtual false final false
