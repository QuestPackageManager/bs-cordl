...
public:
  ...
  /// @brief Method FromBool, addr 0x2c7dbe8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBool, addr 0x2c7dbd8, size 0x10, virtual false, abstract: false, final false
  inline bool ToBool();
  ...
  /// @brief Method .ctor, addr 0x2c7db94, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::__ActionResult__Status status, ::StringW notification);

  /// @brief Method get_NoSelection, addr 0x2c7dd04, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_NoSelection();

  /// @brief Method get_Success, addr 0x2c7dc88, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_Success();

  /// @brief Method get_UserCanceled, addr 0x2c7dd84, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::ActionResult* get_UserCanceled();

  /// @brief Method get_notification, addr 0x2c7db84, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_notification();

  /// @brief Method get_status, addr 0x2c7db74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::__ActionResult__Status get_status();

  /// @brief Method op_Implicit, addr 0x2c7dbc4, size 0x14, virtual false, abstract: false, final false
  static inline bool op_Implicit_bool(::UnityEngine::ProBuilder::ActionResult* res);

  /// @brief Method set_notification, addr 0x2c7db8c, size 0x8, virtual false, abstract: false, final false
  inline void set_notification(::StringW value);

  /// @brief Method set_status, addr 0x2c7db7c, size 0x8, virtual false, abstract: false, final false
