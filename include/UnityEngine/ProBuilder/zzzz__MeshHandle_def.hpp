...
public:
  ...
  /// @brief Method DrawMeshNow, addr 0x6583aec, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6583ae4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Transform* transform, ::UnityEngine::Mesh* mesh);

  /// @brief Method get_mesh, addr 0x6583adc, size 0x8, virtual false, abstract: false, final false
