...
public:
  ...
  /// @brief Method DrawMeshNow, addr 0x2c935b0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c93584, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Transform* transform, ::UnityEngine::Mesh* mesh);

  /// @brief Method get_mesh, addr 0x2c9357c, size 0x8, virtual false, abstract: false, final false
