...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::SelectPathFaces*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::SelectPathFaces*, "UnityEngine.ProBuilder", "SelectPathFaces");
...
public:
  ...
  __declspec(property(get = getStaticF_s_cachedPredecessors, put = setStaticF_s_cachedPredecessors)) ::ArrayW<int32_t> s_cachedPredecessors;
  ...
  /// @brief Method Dijkstra, addr 0x66e7e04, size 0x6dc, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t> Dijkstra(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t start);

  /// @brief Method GetMinimalPath, addr 0x66e7cd8, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPath, addr 0x66e7a2c, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWeight, addr 0x66e84e0, size 0x424, virtual false, abstract: false, final false
  ...
  static inline ::ArrayW<int32_t> getStaticF_s_cachedPredecessors();
  ...
  static inline void setStaticF_s_cachedPredecessors(::ArrayW<int32_t> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectPathFaces", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectPathFaces(SelectPathFaces&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectPathFaces", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectPathFaces(SelectPathFacesconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::SelectPathFaces) == 0x10, "Size mismatch!");
