...
public:
  ...
  /// @brief Method Dijkstra, addr 0x4737030, size 0x700, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> Dijkstra(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t start);

  /// @brief Method GetMinimalPath, addr 0x4736f14, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPath, addr 0x4736c70, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWeight, addr 0x4737730, size 0x414, virtual false, abstract: false, final false
