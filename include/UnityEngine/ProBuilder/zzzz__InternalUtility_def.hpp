...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::InternalUtility*);
...
public:
  ...
  /// @brief Method <TryParseColor>b__0, addr 0x66bd350, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66bd34c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ControlKeyString, addr 0x66bcf9c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method EmptyGameObjectWithTransform, addr 0x66bcd9c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method MeshGameObjectWithTransform, addr 0x66bce88, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseColor, addr 0x66bd0c0, size 0x28c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::InternalUtility) == 0x10, "Size mismatch!");
