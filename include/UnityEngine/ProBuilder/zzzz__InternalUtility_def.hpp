...
public:
  ...
  /// @brief Method <TryParseColor>b__0, addr 0x470ef20, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x470ef18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ControlKeyString, addr 0x470ebac, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method EmptyGameObjectWithTransform, addr 0x470e9a8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method MeshGameObjectWithTransform, addr 0x470ea90, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryParseColor, addr 0x470ecbc, size 0x25c, virtual false, abstract: false, final false
