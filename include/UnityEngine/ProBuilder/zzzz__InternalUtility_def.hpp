...
/// @brief Method <TryParseColor>b__0, addr 0x657fc44, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x657fc40, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ControlKeyString, addr 0x657f890, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method EmptyGameObjectWithTransform, addr 0x657f690, size 0xec, virtual false, abstract: false, final false
...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> GetComponents(::UnityEngine::GameObject*  go) ;

/// @brief Method GetComponents, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T,::Array<T>*> GetComponents(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Transform>>*  transforms) ;

/// @brief Method MeshGameObjectWithTransform, addr 0x657f77c, size 0x114, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> MeshGameObjectWithTransform(::StringW  name, ::UnityEngine::Transform*  t, ::UnityEngine::Mesh*  mesh, ::UnityEngine::Material*  mat, bool  inheritParent) ;
...
/// @brief Method TryParseColor, addr 0x657f9b4, size 0x28c, virtual false, abstract: false, final false
