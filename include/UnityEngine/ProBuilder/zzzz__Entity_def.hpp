...
public:
  ...
  /// @brief Method Awake, addr 0x4708980, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::UnityEngine::ProBuilder::Entity* New_ctor();

  /// @brief Method SetEntity, addr 0x4708a48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4708a50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_entityType, addr 0x4708978, size 0x8, virtual false, abstract: false, final false
