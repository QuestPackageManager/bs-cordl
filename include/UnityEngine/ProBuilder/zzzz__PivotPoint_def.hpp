...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::PivotPoint, "UnityEngine.ProBuilder", "PivotPoint");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::PivotPoint) == 0x4, "Size mismatch!");
