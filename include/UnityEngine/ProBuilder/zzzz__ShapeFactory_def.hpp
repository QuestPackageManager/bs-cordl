...
public:
  ...
  /// @brief Method Instantiate, addr 0x66e45ec, size 0x240, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> Instantiate(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method Instantiate, addr 0x66e4384, size 0x268, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::ShapeFactory) == 0x10, "Size mismatch!");
