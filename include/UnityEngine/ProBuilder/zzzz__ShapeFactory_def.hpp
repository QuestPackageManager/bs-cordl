...
public:
  ...
  /// @brief Method Instantiate, addr 0x2cb5edc, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Instantiate, addr 0x2cb5c48, size 0x294, virtual false, abstract: false, final false
