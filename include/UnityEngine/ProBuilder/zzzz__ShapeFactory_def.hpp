...
/// @brief Method Instantiate, addr 0x653335c, size 0x240, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> Instantiate(::UnityEngine::ProBuilder::Shapes::Shape*  shape) ;

/// @brief Method Instantiate, addr 0x65330f4, size 0x268, virtual false, abstract: false, final false
