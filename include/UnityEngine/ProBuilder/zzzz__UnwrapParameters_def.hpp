...
public:
  ...
  /// @brief Method Reset, addr 0x32b53d4, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x32b546c, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32adae0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32b53e4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::UnwrapParameters* other);

  /// @brief Method get_angleError, addr 0x32b53b4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_angleError();

  /// @brief Method get_areaError, addr 0x32b53c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_areaError();

  /// @brief Method get_hardAngle, addr 0x32b5394, size 0x8, virtual false, abstract: false, final false
  inline float_t get_hardAngle();

  /// @brief Method get_packMargin, addr 0x32b53a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_packMargin();

  /// @brief Method set_angleError, addr 0x32b53bc, size 0x8, virtual false, abstract: false, final false
  inline void set_angleError(float_t value);

  /// @brief Method set_areaError, addr 0x32b53cc, size 0x8, virtual false, abstract: false, final false
  inline void set_areaError(float_t value);

  /// @brief Method set_hardAngle, addr 0x32b539c, size 0x8, virtual false, abstract: false, final false
  inline void set_hardAngle(float_t value);

  /// @brief Method set_packMargin, addr 0x32b53ac, size 0x8, virtual false, abstract: false, final false
