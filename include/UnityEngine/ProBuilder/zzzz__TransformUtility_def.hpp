...
public:
  ...
  /// @brief Method UnparentChildren addr 0x29fb590 size 0x150 virtual false final false
  static inline void UnparentChildren(::UnityEngine::Transform* t);

  /// @brief Method ReparentChildren addr 0x29fb6e0 size 0x128 virtual false final false
  static inline void ReparentChildren(::UnityEngine::Transform* t);

  /// @brief Method TransformVertex addr 0x29fb808 size 0x1e4 virtual false final false
  ...
  /// @brief Method InverseTransformVertex addr 0x29fb9ec size 0x1dc virtual false final false
