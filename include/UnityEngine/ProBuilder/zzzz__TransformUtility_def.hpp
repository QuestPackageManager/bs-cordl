...
/// @brief Field s_ChildStack, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ChildStack, put=setStaticF_s_ChildStack)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Transform>,::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*>>*  s_ChildStack;

/// @brief Method InverseTransformVertex, addr 0x6541bec, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method ReparentChildren, addr 0x65418f0, size 0x140, virtual false, abstract: false, final false
static inline void ReparentChildren(::UnityEngine::Transform*  t) ;

/// @brief Method TransformVertex, addr 0x6541a30, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method UnparentChildren, addr 0x6541770, size 0x180, virtual false, abstract: false, final false
