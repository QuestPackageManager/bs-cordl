...
public:
  ...
  /// @brief Method InverseTransformVertex, addr 0x30ad064, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReparentChildren, addr 0x30acd58, size 0x128, virtual false, abstract: false, final false
  static inline void ReparentChildren(::UnityEngine::Transform* t);

  /// @brief Method TransformVertex, addr 0x30ace80, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnparentChildren, addr 0x30acc08, size 0x150, virtual false, abstract: false, final false
