...
/// @brief Method CompareTo, addr 0x6532894, size 0x70, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CompareTo, addr 0x6532904, size 0x154, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::ProBuilder::SemVer*  version) ;

/// @brief Method Equals, addr 0x653252c, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x65325ac, size 0x1a8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::SemVer*  version) ;

/// @brief Method GetBuildNumber, addr 0x6533034, size 0xc0, virtual false, abstract: false, final false
static inline int32_t GetBuildNumber(::StringW  input) ;

/// @brief Method GetHashCode, addr 0x6532754, size 0x140, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsValid, addr 0x65324fc, size 0x30, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method ToString, addr 0x6532dd0, size 0x264, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x6532b80, size 0x250, virtual false, abstract: false, final false
inline ::StringW ToString(::StringW  format) ;

/// @brief Method TryGetVersionInfo, addr 0x6532168, size 0x394, virtual false, abstract: false, final false
static inline bool TryGetVersionInfo(::StringW  input, ::ByRef<::UnityEngine::ProBuilder::SemVer*>  version) ;

/// @brief Method WrapNoValue, addr 0x6532a58, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65320b0, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x65320c8, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  formatted, ::StringW  date) ;

/// @brief Method .ctor, addr 0x653209c, size 0x14, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  patch, int32_t  build, ::StringW  type, ::StringW  date, ::StringW  metadata) ;

/// @brief Method get_MajorMinorPatch, addr 0x653202c, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::SemVer* get_MajorMinorPatch() ;

/// @brief Method get_build, addr 0x6531f28, size 0x8, virtual false, abstract: false, final false
inline int32_t get_build() ;

/// @brief Method get_date, addr 0x6531fd8, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_date() ;

/// @brief Method get_major, addr 0x6531f10, size 0x8, virtual false, abstract: false, final false
inline int32_t get_major() ;

/// @brief Method get_metadata, addr 0x6531f84, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_metadata() ;

/// @brief Method get_minor, addr 0x6531f18, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minor() ;

/// @brief Method get_patch, addr 0x6531f20, size 0x8, virtual false, abstract: false, final false
inline int32_t get_patch() ;

/// @brief Method get_type, addr 0x6531f30, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x6532a68, size 0x14, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_GreaterThan, addr 0x6532ac8, size 0x1c, virtual false, abstract: false, final false
static inline bool op_GreaterThan(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_GreaterThanOrEqual, addr 0x6532b2c, size 0x54, virtual false, abstract: false, final false
static inline bool op_GreaterThanOrEqual(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_Inequality, addr 0x6532a7c, size 0x28, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_LessThan, addr 0x6532aa4, size 0x24, virtual false, abstract: false, final false
static inline bool op_LessThan(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_LessThanOrEqual, addr 0x6532ae4, size 0x48, virtual false, abstract: false, final false
