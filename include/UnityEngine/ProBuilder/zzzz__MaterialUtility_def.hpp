...
public:
  ...
  /// @brief Method GetMaterialCount, addr 0x657f8fc, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t GetMaterialCount(::UnityEngine::Renderer* renderer);

  /// @brief Method GetSharedMaterial, addr 0x657f9e0, size 0x158, virtual false, abstract: false, final false
