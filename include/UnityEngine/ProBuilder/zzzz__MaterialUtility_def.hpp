...
public:
  ...
  /// @brief Method GetMaterialCount, addr 0x4714f4c, size 0xd0, virtual false, abstract: false, final false
  static inline int32_t GetMaterialCount(::UnityEngine::Renderer* renderer);

  /// @brief Method GetSharedMaterial, addr 0x471501c, size 0x140, virtual false, abstract: false, final false
