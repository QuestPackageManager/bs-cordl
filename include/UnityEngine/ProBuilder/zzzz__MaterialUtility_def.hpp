...
public:
  ...
  /// @brief Method GetMaterialCount, addr 0x4710a58, size 0xd0, virtual false, abstract: false, final false
  static inline int32_t GetMaterialCount(::UnityEngine::Renderer* renderer);

  /// @brief Method GetSharedMaterial, addr 0x4710b28, size 0x140, virtual false, abstract: false, final false
