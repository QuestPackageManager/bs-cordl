...
public:
  ...
  /// @brief Method GetMaterialCount, addr 0x328127c, size 0xd0, virtual false, abstract: false, final false
  static inline int32_t GetMaterialCount(::UnityEngine::Renderer* renderer);

  /// @brief Method GetSharedMaterial, addr 0x328134c, size 0x140, virtual false, abstract: false, final false
