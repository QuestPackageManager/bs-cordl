...
/// @brief Method GetMaterialCount, addr 0x650d8f0, size 0xe4, virtual false, abstract: false, final false
static inline int32_t GetMaterialCount(::UnityEngine::Renderer*  renderer) ;

/// @brief Method GetSharedMaterial, addr 0x650d9d4, size 0x158, virtual false, abstract: false, final false
