...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::BuiltinMaterials*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::BuiltinMaterials*, "UnityEngine.ProBuilder", "BuiltinMaterials");
...
static_assert(sizeof(::UnityEngine::ProBuilder::BuiltinMaterials) == 0x10, "Size mismatch!");
