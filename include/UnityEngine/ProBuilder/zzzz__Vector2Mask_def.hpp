...
public:
  ...
  /// @brief Method .ctor, addr 0x2cc7ae4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint8_t mask);

  /// @brief Method .ctor, addr 0x2cc7ac0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 v, float_t epsilon);

  static inline ::UnityEngine::ProBuilder::Vector2Mask getStaticF_XY();

  /// @brief Method get_x, addr 0x2cc7a90, size 0x18, virtual false, abstract: false, final false
  inline float_t get_x();

  /// @brief Method get_y, addr 0x2cc7aa8, size 0x18, virtual false, abstract: false, final false
  inline float_t get_y();

  /// @brief Method op_BitwiseAnd, addr 0x2cc7b3c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x2cc7b30, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_ExclusiveOr, addr 0x2cc7b48, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2cc7b08, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2cc7aec, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 op_Implicit___UnityEngine__Vector2(::UnityEngine::ProBuilder::Vector2Mask mask);

  /// @brief Method op_Multiply, addr 0x2cc7b54, size 0x28, virtual false, abstract: false, final false
