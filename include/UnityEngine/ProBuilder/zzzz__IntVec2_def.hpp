...
public:
  ...
  /// @brief Method Equals, addr 0x4710d84, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* b);

  /// @brief Method Equals, addr 0x4710c1c, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method Equals, addr 0x4710d18, size 0x6c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::Vector2 p);

  /// @brief Method GetHashCode, addr 0x4710e40, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x4710b58, size 0xa0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x4710b50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 vector);

  /// @brief Method get_x, addr 0x4710b40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_x();

  /// @brief Method get_y, addr 0x4710b48, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4710bf8, size 0x24, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method op_Implicit, addr 0x4710e50, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::IntVec2 op_Implicit___UnityEngine__ProBuilder__IntVec2(::UnityEngine::Vector2 p);

  /// @brief Method op_Implicit, addr 0x4710e4c, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 op_Implicit___UnityEngine__Vector2(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method op_Inequality, addr 0x4710c88, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method round, addr 0x4710cb0, size 0x68, virtual false, abstract: false, final false
