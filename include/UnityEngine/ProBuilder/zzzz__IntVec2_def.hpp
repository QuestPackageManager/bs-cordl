...
public:
  ...
  /// @brief Method Equals, addr 0x66c2df4, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* b);

  /// @brief Method Equals, addr 0x66c2c88, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method Equals, addr 0x66c2d88, size 0x6c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::Vector2 p);

  /// @brief Method GetHashCode, addr 0x66c2eb4, size 0x80, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x66c2bb0, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x66c2ba8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 vector);

  /// @brief Method get_x, addr 0x66c2b98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_x();

  /// @brief Method get_y, addr 0x66c2ba0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x66c2c64, size 0x24, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method op_Implicit, addr 0x66c2f38, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::IntVec2 op_Implicit___UnityEngine__ProBuilder__IntVec2(::UnityEngine::Vector2 p);

  /// @brief Method op_Implicit, addr 0x66c2f34, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 op_Implicit___UnityEngine__Vector2(::UnityEngine::ProBuilder::IntVec2 p);

  /// @brief Method op_Inequality, addr 0x66c2cf4, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::IntVec2 a, ::UnityEngine::ProBuilder::IntVec2 b);

  /// @brief Method round, addr 0x66c2d1c, size 0x6c, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "value", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None, comment: None }]
