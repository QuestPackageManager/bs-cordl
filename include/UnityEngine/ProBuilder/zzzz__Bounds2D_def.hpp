...
/// @brief Method Center, addr 0x64ff214, size 0x2a8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 Center(::System::Collections::Generic::IList_1<::UnityEngine::Vector2>*  points) ;

/// @brief Method Center, addr 0x64ff4bc, size 0x450, virtual false, abstract: false, final false
...
/// @brief Method Center, addr 0x64ffd64, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method ContainsPoint, addr 0x64fef64, size 0x48, virtual false, abstract: false, final false
inline bool ContainsPoint(::UnityEngine::Vector2  point) ;

/// @brief Method Intersects, addr 0x64ff1a0, size 0x38, virtual false, abstract: false, final false
inline bool Intersects(::UnityEngine::ProBuilder::Bounds2D*  bounds) ;

/// @brief Method Intersects, addr 0x64ff1d8, size 0x3c, virtual false, abstract: false, final false
inline bool Intersects(::UnityEngine::Rect  rect) ;

/// @brief Method IntersectsLineSegment, addr 0x64fefac, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method SetWithPoints, addr 0x64fe404, size 0x304, virtual false, abstract: false, final false
inline void SetWithPoints(::System::Collections::Generic::IList_1<::UnityEngine::Vector2>*  points) ;

/// @brief Method SetWithPoints, addr 0x64fe790, size 0x570, virtual false, abstract: false, final false
...
/// @brief Method Size, addr 0x64ff90c, size 0x458, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x6500254, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x64fe27c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x64fe2e8, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector2  center, ::UnityEngine::Vector2  size) ;

/// @brief Method .ctor, addr 0x64fee5c, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  points, int32_t  length) ;

/// @brief Method .ctor, addr 0x64fed00, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x64fe384, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IList_1<::UnityEngine::Vector2>*  points) ;

/// @brief Method .ctor, addr 0x64fe708, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_corners, addr 0x64fe1b0, size 0xcc, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*> get_corners() ;

/// @brief Method get_extents, addr 0x64fe1a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_extents() ;

/// @brief Method get_size, addr 0x64fe188, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_size() ;

/// @brief Method set_size, addr 0x64fe190, size 0x18, virtual false, abstract: false, final false
