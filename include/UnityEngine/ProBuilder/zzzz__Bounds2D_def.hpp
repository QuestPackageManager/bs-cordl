...
public:
  ...
  /// @brief Method get_size, addr 0x2b37100, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_size();

  /// @brief Method set_size, addr 0x2b37108, size 0x18, virtual false, abstract: false, final false
  inline void set_size(::UnityEngine::Vector2 value);

  /// @brief Method get_extents, addr 0x2b37120, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_extents();

  /// @brief Method get_corners, addr 0x2b37128, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b371f0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::ProBuilder::Bounds2D* New_ctor(::UnityEngine::Vector2 center, ::UnityEngine::Vector2 size);

  /// @brief Method .ctor, addr 0x2b37260, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b3730c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b3767c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b37c6c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b37e30, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> points, int32_t length);

  /// @brief Method ContainsPoint, addr 0x2b37f7c, size 0x54, virtual false, abstract: false, final false
  inline bool ContainsPoint(::UnityEngine::Vector2 point);

  /// @brief Method IntersectsLineSegment, addr 0x2b37fd0, size 0x198, virtual false, abstract: false, final false
  inline bool IntersectsLineSegment(::UnityEngine::Vector2 lineStart, ::UnityEngine::Vector2 lineEnd);

  /// @brief Method Intersects, addr 0x2b381e0, size 0x64, virtual false, abstract: false, final false
  inline bool Intersects(::UnityEngine::ProBuilder::Bounds2D* bounds);

  /// @brief Method Intersects, addr 0x2b38244, size 0x90, virtual false, abstract: false, final false
  inline bool Intersects(::UnityEngine::Rect rect);

  /// @brief Method SetWithPoints, addr 0x2b3738c, size 0x2f0, virtual false, abstract: false, final false
  inline void SetWithPoints(::System::Collections::Generic::IList_1<::UnityEngine::Vector2>* points);

  /// @brief Method SetWithPoints, addr 0x2b3770c, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method Center, addr 0x2b382d4, size 0x2b4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Center(::System::Collections::Generic::IList_1<::UnityEngine::Vector2>* points);

  /// @brief Method Center, addr 0x2b38588, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method Size, addr 0x2b389e0, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method Center, addr 0x2b38e2c, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2b3936c, size 0x1bc, virtual true, abstract: false, final false
