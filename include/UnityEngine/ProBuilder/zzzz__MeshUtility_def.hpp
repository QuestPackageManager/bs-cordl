...
public:
  ...
  /// @brief Method <CollapseSharedVertices>b__11_0, addr 0x46a4c1c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x46a4c14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CollapseSharedVertices, addr 0x46a3768, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Compile, addr 0x46a2df8, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyTo, addr 0x46a1c08, size 0x45c, virtual false, abstract: false, final false
  static inline void CopyTo(::UnityEngine::Mesh* source, ::UnityEngine::Mesh* destination);

  /// @brief Method DeepCopy, addr 0x46a1ba4, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Mesh> DeepCopy(::UnityEngine::Mesh* source);

  /// @brief Method FitToSize, addr 0x46a3c3c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangleMesh, addr 0x46a0e1c, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateTangent, addr 0x46a1670, size 0x534, virtual false, abstract: false, final false
  static inline void GenerateTangent(::UnityEngine::Mesh* mesh);

  /// @brief Method GetBounds, addr 0x46a4a34, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Bounds GetBounds(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method GetIndexCount, addr 0x46a2c24, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPrimitiveCount, addr 0x46a2ce4, size 0x114, virtual false, abstract: false, final false
  static inline uint32_t GetPrimitiveCount(::UnityEngine::Mesh* mesh);

  /// @brief Method GetVertices, addr 0x46a1120, size 0x550, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::Vertex*, ::Array<::UnityEngine::ProBuilder::Vertex*>*> GetVertices(::UnityEngine::Mesh* mesh);

  /// @brief Method IsUsedInParticleSystem, addr 0x46a4834, size 0xf4, virtual false, abstract: false, final false
  static inline bool IsUsedInParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method Print, addr 0x46a2064, size 0xbb0, virtual false, abstract: false, final false
  ...
  /// @brief Method RestoreParticleSystem, addr 0x46a499c, size 0x98, virtual false, abstract: false, final false
  static inline void RestoreParticleSystem(::UnityEngine::ProBuilder::ProBuilderMesh* pbmesh);

  /// @brief Method SanityCheck, addr 0x46a2c14, size 0x10, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::Mesh* mesh);

  /// @brief Method SanityCheck, addr 0x46a3f48, size 0x1c, virtual false, abstract: false, final false
  static inline ::StringW SanityCheck(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method SanityCheck, addr 0x46a45a4, size 0x290, virtual false, abstract: false, final false
