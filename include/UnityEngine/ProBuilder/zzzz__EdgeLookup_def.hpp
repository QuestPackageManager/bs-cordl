...
public:
  ...
  /// @brief Method .ctor addr 0x29bd564 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetEdgeLookup>b__0 addr 0x29bd908 size 0x84 virtual false final false
...
namespace UnityEngine::ProBuilder {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12045))}
...
public:
  ...
  /// @brief Method get_local addr 0x29bd064 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::Edge get_local();

  /// @brief Method set_local addr 0x29bd06c size 0x8 virtual false final false
  inline void set_local(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method get_common addr 0x29bd074 size 0x8 virtual false final false
  inline ::UnityEngine::ProBuilder::Edge get_common();

  /// @brief Method set_common addr 0x29bd07c size 0x8 virtual false final false
  inline void set_common(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method .ctor addr 0x29bd084 size 0x8 virtual false final false
  inline void _ctor(::UnityEngine::ProBuilder::Edge common, ::UnityEngine::ProBuilder::Edge local);

  /// @brief Method .ctor addr 0x29bd08c size 0x18 virtual false final false
  inline void _ctor(int32_t cx, int32_t cy, int32_t x, int32_t y);

  /// @brief Method Equals addr 0x29bd0a4 size 0x38 virtual true final true
  inline bool Equals(::UnityEngine::ProBuilder::EdgeLookup other);

  /// @brief Method Equals addr 0x29bd0dc size 0xa8 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x29bd184 size 0x24 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality addr 0x29bd1a8 size 0x9c virtual false final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method op_Inequality addr 0x29bd244 size 0xa0 virtual false final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method ToString addr 0x29bd2e4 size 0x1ac virtual true final false
  inline ::StringW ToString();

  /// @brief Method GetEdgeLookup addr 0x29bd490 size 0xd4 virtual false final false
  ...
  /// @brief Method GetEdgeLookupHashSet addr 0x29bd56c size 0x39c virtual false final false
