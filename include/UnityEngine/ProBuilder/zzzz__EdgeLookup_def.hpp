...
public:
  ...
  /// @brief Method <GetEdgeLookup>b__0, addr 0x329fd5c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329f9b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x329f530, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x329f4f8, size 0x38, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::EdgeLookup other);

  /// @brief Method GetEdgeLookup, addr 0x329f8e4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeLookupHashSet, addr 0x329f9c0, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x329f5d8, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x329f738, size 0x1ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x329f4d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Edge common, ::UnityEngine::ProBuilder::Edge local);

  /// @brief Method .ctor, addr 0x329f4e0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t cx, int32_t cy, int32_t x, int32_t y);

  /// @brief Method get_common, addr 0x329f4c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge get_common();

  /// @brief Method get_local, addr 0x329f4b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x329f5fc, size 0x9c, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method op_Inequality, addr 0x329f698, size 0xa0, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method set_common, addr 0x329f4d0, size 0x8, virtual false, abstract: false, final false
  inline void set_common(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method set_local, addr 0x329f4c0, size 0x8, virtual false, abstract: false, final false
