...
public:
  ...
  /// @brief Method .ctor, addr 0x2b3de24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <GetEdgeLookup>b__0, addr 0x2b3e1c8, size 0x84, virtual false, abstract: false, final false
...
namespace UnityEngine::ProBuilder {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(12015))]
...
public:
  ...
  /// @brief Method get_local, addr 0x2b3d924, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge get_local();

  /// @brief Method set_local, addr 0x2b3d92c, size 0x8, virtual false, abstract: false, final false
  inline void set_local(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method get_common, addr 0x2b3d934, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Edge get_common();

  /// @brief Method set_common, addr 0x2b3d93c, size 0x8, virtual false, abstract: false, final false
  inline void set_common(::UnityEngine::ProBuilder::Edge value);

  /// @brief Method .ctor, addr 0x2b3d944, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Edge common, ::UnityEngine::ProBuilder::Edge local);

  /// @brief Method .ctor, addr 0x2b3d94c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(int32_t cx, int32_t cy, int32_t x, int32_t y);

  /// @brief Method Equals, addr 0x2b3d964, size 0x38, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::EdgeLookup other);

  /// @brief Method Equals, addr 0x2b3d99c, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2b3da44, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x2b3da68, size 0x9c, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method op_Inequality, addr 0x2b3db04, size 0xa0, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::EdgeLookup a, ::UnityEngine::ProBuilder::EdgeLookup b);

  /// @brief Method ToString, addr 0x2b3dba4, size 0x1ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method GetEdgeLookup, addr 0x2b3dd50, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeLookupHashSet, addr 0x2b3de2c, size 0x39c, virtual false, abstract: false, final false
