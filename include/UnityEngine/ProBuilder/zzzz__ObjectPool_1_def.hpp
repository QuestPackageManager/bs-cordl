...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::ObjectPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::ObjectPool_1, "UnityEngine.ProBuilder", "ObjectPool`1");
