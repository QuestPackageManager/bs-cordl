...
public:
  ...
  /// @brief Method Clear, addr 0x3087d28, size 0xe0, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method DeleteKey, addr 0x30872ac, size 0x234, virtual false, abstract: false, final false
  inline void DeleteKey(::StringW key);

  /// @brief Method Get, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline T Get(::StringW key, T fallback);

  /// @brief Method GetBool, addr 0x30874e0, size 0x88, virtual false, abstract: false, final false
  inline bool GetBool(::StringW key, bool fallback);

  /// @brief Method GetBoolDictionary, addr 0x3087cf8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, bool>* GetBoolDictionary();

  /// @brief Method GetColor, addr 0x30876dc, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetColor(::StringW key, ::UnityEngine::Color fallback);

  /// @brief Method GetColorDictionary, addr 0x3087d18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::Color>* GetColorDictionary();

  /// @brief Method GetFloat, addr 0x30875e4, size 0x7c, virtual false, abstract: false, final false
  inline float_t GetFloat(::StringW key, float_t fallback);

  /// @brief Method GetFloatDictionary, addr 0x3087d08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, float_t>* GetFloatDictionary();

  /// @brief Method GetInt, addr 0x3087568, size 0x7c, virtual false, abstract: false, final false
  inline int32_t GetInt(::StringW key, int32_t fallback);

  /// @brief Method GetIntDictionary, addr 0x3087d00, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, int32_t>* GetIntDictionary();

  /// @brief Method GetMaterial, addr 0x3087784, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetMaterial(::StringW key, ::UnityEngine::Material* fallback);

  /// @brief Method GetMaterialDictionary, addr 0x3087d20, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityW<::UnityEngine::Material>>* GetMaterialDictionary();

  /// @brief Method GetString, addr 0x3087660, size 0x7c, virtual false, abstract: false, final false
  inline ::StringW GetString(::StringW key, ::StringW fallback);

  /// @brief Method GetStringDictionary, addr 0x3087d10, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetStringDictionary();

  /// @brief Method HasKey, addr 0x3087168, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterDeserialize, addr 0x3086c9c, size 0x3c8, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x3086988, size 0x314, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method Set, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> inline void Set(::StringW key, T value);

  /// @brief Method SetBool, addr 0x3087800, size 0xcc, virtual false, abstract: false, final false
  inline void SetBool(::StringW key, bool value);

  /// @brief Method SetColor, addr 0x3087b30, size 0xfc, virtual false, abstract: false, final false
  inline void SetColor(::StringW key, ::UnityEngine::Color value);

  /// @brief Method SetDefaultValues, addr 0x3087064, size 0x104, virtual true, abstract: false, final true
  inline void SetDefaultValues();

  /// @brief Method SetFloat, addr 0x3087998, size 0xcc, virtual false, abstract: false, final false
  inline void SetFloat(::StringW key, float_t value);

  /// @brief Method SetInt, addr 0x30878cc, size 0xcc, virtual false, abstract: false, final false
  inline void SetInt(::StringW key, int32_t value);

  /// @brief Method SetMaterial, addr 0x3087c2c, size 0xcc, virtual false, abstract: false, final false
  inline void SetMaterial(::StringW key, ::UnityEngine::Material* value);

  /// @brief Method SetString, addr 0x3087a64, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3087e08, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor();
