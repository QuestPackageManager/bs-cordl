...
public:
  ...
  /// @brief Method ToString, addr 0x4747338, size 0x150, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformPoint, addr 0x47472d4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4747284, size 0x50, virtual false, abstract: false, final false
