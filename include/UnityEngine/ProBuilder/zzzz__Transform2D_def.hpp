...
public:
  ...
  /// @brief Method ToString, addr 0x4750368, size 0x150, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformPoint, addr 0x4750304, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47502b4, size 0x50, virtual false, abstract: false, final false
