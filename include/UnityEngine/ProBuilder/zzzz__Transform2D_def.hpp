...
public:
  ...
  /// @brief Method ToString, addr 0x65b361c, size 0x160, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformPoint, addr 0x65b360c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65b35fc, size 0x10, virtual false, abstract: false, final false
