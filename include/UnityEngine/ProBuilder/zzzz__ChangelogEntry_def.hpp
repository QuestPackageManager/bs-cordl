...
public:
  ...
  /// @brief Method ToString, addr 0x66b283c, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b2834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::SemVer* version, ::StringW releaseNotes);

  /// @brief Method get_releaseNotes, addr 0x66b282c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_releaseNotes();

  /// @brief Method get_versionInfo, addr 0x66b2824, size 0x8, virtual false, abstract: false, final false
