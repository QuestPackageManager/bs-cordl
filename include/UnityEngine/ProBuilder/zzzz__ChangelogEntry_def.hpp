...
public:
  ...
  /// @brief Method ToString, addr 0x47061c8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x470619c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::SemVer* version, ::StringW releaseNotes);

  /// @brief Method get_releaseNotes, addr 0x4706194, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_releaseNotes();

  /// @brief Method get_versionInfo, addr 0x470618c, size 0x8, virtual false, abstract: false, final false
