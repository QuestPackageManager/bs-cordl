...
public:
  ...
  /// @brief Method SetMaterial, addr 0x470967c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47098e0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
