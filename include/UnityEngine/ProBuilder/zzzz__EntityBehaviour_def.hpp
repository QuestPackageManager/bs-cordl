...
public:
  ...
  /// @brief Method SetMaterial, addr 0x6499c00, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6499e60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
