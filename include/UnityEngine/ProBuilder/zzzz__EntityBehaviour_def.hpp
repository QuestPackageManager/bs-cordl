...
/// @brief Method SetMaterial, addr 0x65759d0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6575c30, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
