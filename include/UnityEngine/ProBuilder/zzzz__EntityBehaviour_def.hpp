...
public:
  ...
  /// @brief Method SetMaterial, addr 0x2c839f4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c83c58, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
