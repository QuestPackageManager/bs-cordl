...
public:
  ...
  /// @brief Method SetMaterial, addr 0x66b30dc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b333c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
