...
public:
  ...
  /// @brief Method SetMaterial, addr 0x46a24ac, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x46a2710, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
