...
public:
  ...
  /// @brief Method SetMaterial, addr 0x4705188, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47053ec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
