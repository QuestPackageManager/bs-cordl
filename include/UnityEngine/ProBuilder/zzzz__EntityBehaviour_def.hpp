...
public:
  ...
  /// @brief Method SetMaterial, addr 0x650178c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65019ec, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
