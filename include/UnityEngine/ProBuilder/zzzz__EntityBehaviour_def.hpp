...
public:
  ...
  /// @brief Method SetMaterial, addr 0x4706a24, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4706c88, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
