...
public:
  ...
  /// @brief Method SetMaterial, addr 0x6573e58, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65740b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
