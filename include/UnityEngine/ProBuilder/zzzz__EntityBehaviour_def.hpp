...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::EntityBehaviour*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::EntityBehaviour*, "UnityEngine.ProBuilder", "EntityBehaviour");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EntityBehaviour", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EntityBehaviour(EntityBehaviour&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EntityBehaviour", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EntityBehaviour(EntityBehaviourconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::EntityBehaviour) == 0x28, "Size mismatch!");
