...
public:
  ...
  /// @brief Method SetColors, addr 0x329cf84, size 0xa4, virtual false, abstract: false, final false
  inline void SetColors(::System::Collections::Generic::IEnumerable_1<::UnityEngine::Color>* colors);

  /// @brief Method SetDefaultValues, addr 0x329d028, size 0x7c8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x329d918, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x329d8d0, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x329d7f0, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_Item(int32_t i);

  /// @brief Method get_colors, addr 0x329cf08, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Color>* get_colors();

  /// @brief Method get_current, addr 0x329cef0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x329d848, size 0x88, virtual false, abstract: false, final false
  inline void set_Item(int32_t i, ::UnityEngine::Color value);

  /// @brief Method set_current, addr 0x329cefc, size 0xc, virtual false, abstract: false, final false
