...
public:
  ...
  /// @brief Method SetColors, addr 0x66b8bf0, size 0xac, virtual false, abstract: false, final false
  inline void SetColors(::System::Collections::Generic::IEnumerable_1<::UnityEngine::Color>* colors);

  /// @brief Method SetDefaultValues, addr 0x66b8c9c, size 0x798, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66b957c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x66b952c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x66b9434, size 0x64, virtual false, abstract: false, final false
