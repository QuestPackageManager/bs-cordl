...
public:
  // Declarations
  /// @brief Method ToString, addr 0x32b7600, size 0x1a4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method <SetAutoUV>b__0_0, addr 0x32b7810, size 0x18, virtual false, abstract: false, final false
  inline bool _SetAutoUV_b__0_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method .ctor, addr 0x32b7808, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyUVAnchor, addr 0x32b7024, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyUVSettings, addr 0x32b6384, size 0x8e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateDelta, addr 0x32b598c, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyUVs, addr 0x32adc58, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAutoUnwrapSettings, addr 0x32b5dd0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIndex, addr 0x32b5fd8, size 0xb0, virtual false, abstract: false, final false
  static inline int32_t GetIndex(::System::Collections::Generic::IList_1<int32_t>* collection, int32_t index);

  /// @brief Method GetRotatedSize, addr 0x32b6088, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUVTransform, addr 0x32b5ed0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectTextureGroup, addr 0x32b6c68, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method ScaleUVs, addr 0x32b6dfc, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAutoAndAlignUnwrapParamsToUVs, addr 0x32b57a0, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAutoUV, addr 0x32b5618, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Unwrap, addr 0x32adb18, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method UpgradeAutoUVScaleOffset, addr 0x32b73bc, size 0x124, virtual false, abstract: false, final false
