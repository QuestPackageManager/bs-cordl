...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x4743664, size 0x19c, virtual true, abstract: false, final false
  inline void Initialize();

  static inline ::UnityEngine::ProBuilder::TriggerBehaviour* New_ctor();

  /// @brief Method OnEnterPlayMode, addr 0x4743800, size 0x78, virtual true, abstract: false, final false
  inline void OnEnterPlayMode();

  /// @brief Method OnSceneLoaded, addr 0x4743878, size 0x78, virtual true, abstract: false, final false
  inline void OnSceneLoaded(::UnityEngine::SceneManagement::Scene scene, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method .ctor, addr 0x47438f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
