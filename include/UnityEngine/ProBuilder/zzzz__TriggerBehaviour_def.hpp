...
public:
  // Declarations
  /// @brief Method Initialize, addr 0x65b4138, size 0x1b0, virtual true, abstract: false, final false
  inline void Initialize();

  static inline ::UnityEngine::ProBuilder::TriggerBehaviour* New_ctor();

  /// @brief Method OnEnterPlayMode, addr 0x65b42e8, size 0x7c, virtual true, abstract: false, final false
  inline void OnEnterPlayMode();

  /// @brief Method OnSceneLoaded, addr 0x65b4364, size 0x7c, virtual true, abstract: false, final false
  inline void OnSceneLoaded(::UnityEngine::SceneManagement::Scene scene, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method .ctor, addr 0x65b43e0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
