...
public:
  ...
  /// @brief Method Dispose, addr 0x32f72e4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x32f7290, size 0x3c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::ProBuilder::WingedEdgeEnumerator* New_ctor(::UnityEngine::ProBuilder::WingedEdge* start);

  /// @brief Method Reset, addr 0x32f72cc, size 0x8, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32f72dc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32f7268, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::WingedEdge* start);

  /// @brief Method get_Current, addr 0x32f72d4, size 0x8, virtual true, abstract: false, final true
