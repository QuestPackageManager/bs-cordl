...
namespace UnityEngine::ProBuilder {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10249)), TypeDefinitionIndex(TypeDefinitionIndex(10246))}
...
public:
  ...
  /// @brief Method set_normal, addr 0x2b54aa8, size 0xc, virtual false, abstract: false, final false
  inline void set_normal(::UnityEngine::Vector3 value);

  /// @brief Method get_tangent, addr 0x2b54ab4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_tangent();

  /// @brief Method set_tangent, addr 0x2b54ac0, size 0xc, virtual false, abstract: false, final false
  inline void set_tangent(::UnityEngine::Vector4 value);

  /// @brief Method get_bitangent, addr 0x2b54acc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_bitangent();

  /// @brief Method set_bitangent, addr 0x2b54ad8, size 0xc, virtual false, abstract: false, final false
  inline void set_bitangent(::UnityEngine::Vector3 value);

  /// @brief Method Equals, addr 0x2b54ae4, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2b54c0c, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x2b54b74, size 0x98, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::Normal other);

  /// @brief Method op_Equality, addr 0x2b54c70, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::Normal a, ::UnityEngine::ProBuilder::Normal b);

  /// @brief Method op_Inequality, addr 0x2b54ca0, size 0x48, virtual false, abstract: false, final false
