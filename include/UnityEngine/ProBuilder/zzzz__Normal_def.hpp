...
namespace UnityEngine::ProBuilder {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10173)), TypeDefinitionIndex(TypeDefinitionIndex(10176))}
...
public:
  ...
  /// @brief Method get_normal addr 0x29d2d48 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method set_normal addr 0x29d2d54 size 0xc virtual false final false
  inline void set_normal(::UnityEngine::Vector3 value);

  /// @brief Method get_tangent addr 0x29d2d60 size 0xc virtual false final false
  inline ::UnityEngine::Vector4 get_tangent();

  /// @brief Method set_tangent addr 0x29d2d6c size 0xc virtual false final false
  inline void set_tangent(::UnityEngine::Vector4 value);

  /// @brief Method get_bitangent addr 0x29d2d78 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_bitangent();

  /// @brief Method set_bitangent addr 0x29d2d84 size 0xc virtual false final false
  inline void set_bitangent(::UnityEngine::Vector3 value);

  /// @brief Method Equals addr 0x29d2d90 size 0x90 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x29d2eb8 size 0x64 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x29d2e20 size 0x98 virtual true final true
  inline bool Equals(::UnityEngine::ProBuilder::Normal other);

  /// @brief Method op_Equality addr 0x29d2f1c size 0x30 virtual false final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::Normal a, ::UnityEngine::ProBuilder::Normal b);

  /// @brief Method op_Inequality addr 0x29d2f4c size 0x48 virtual false final false
