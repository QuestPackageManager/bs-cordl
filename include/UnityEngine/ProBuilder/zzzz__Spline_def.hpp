...
public:
  // Declarations
  /// @brief Method Extrude addr 0x29f8a38 size 0x24 virtual false final false
  ...
  /// @brief Method Extrude addr 0x29f8a5c size 0xd8 virtual false final false
  ...
  /// @brief Method GetControlPoints addr 0x29f8b34 size 0x520 virtual false final false
  ...
  /// @brief Method Extrude addr 0x29f9054 size 0x95c virtual false final false
  ...
  /// @brief Method GetRingRotation addr 0x29f99b0 size 0x890 virtual false final false
  ...
  /// @brief Method VertexRing addr 0x29fa240 size 0x1f0 virtual false final false
