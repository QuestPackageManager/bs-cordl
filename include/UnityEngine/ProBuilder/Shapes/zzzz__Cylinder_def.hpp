...
public:
  ...
  /// @brief Method CopyShape, addr 0x474ea5c, size 0xd4, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Cylinder* New_ctor();

  /// @brief Method RebuildMesh, addr 0x474eb5c, size 0xb78, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x474eb30, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x474f6d4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
