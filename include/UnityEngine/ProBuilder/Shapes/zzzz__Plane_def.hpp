...
/// @brief Method CopyShape, addr 0x65c44dc, size 0xbc, virtual true, abstract: false, final false
inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape*  shape) ;

static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor() ;

/// @brief Method RebuildMesh, addr 0x65c4598, size 0x25c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65c47f4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
