...
public:
  ...
  /// @brief Method CopyShape, addr 0x4753464, size 0xac, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4753510, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4753768, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
