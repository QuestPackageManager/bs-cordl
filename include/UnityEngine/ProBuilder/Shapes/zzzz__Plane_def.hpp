...
public:
  ...
  /// @brief Method CopyShape, addr 0x6701be8, size 0xbc, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor();

  /// @brief Method RebuildMesh, addr 0x6701ca4, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6701f00, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Shapes::Plane) == 0x18, "Size mismatch!");
