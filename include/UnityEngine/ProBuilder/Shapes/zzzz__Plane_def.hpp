...
public:
  ...
  /// @brief Method CopyShape, addr 0x47560bc, size 0xac, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4756168, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47563c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
