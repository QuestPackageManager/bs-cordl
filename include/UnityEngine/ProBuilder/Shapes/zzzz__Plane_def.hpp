...
public:
  ...
  /// @brief Method CopyShape, addr 0x6550298, size 0xbc, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor();

  /// @brief Method RebuildMesh, addr 0x6550354, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65505b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
