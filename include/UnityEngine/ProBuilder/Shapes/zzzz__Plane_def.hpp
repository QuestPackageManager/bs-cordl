...
public:
  ...
  /// @brief Method CopyShape, addr 0x32c3448, size 0xac, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Plane* New_ctor();

  /// @brief Method RebuildMesh, addr 0x32c34f4, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32c3740, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
