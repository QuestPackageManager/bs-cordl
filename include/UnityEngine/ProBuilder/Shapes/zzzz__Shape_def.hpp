...
/// @brief Method UpdateBounds, addr 0x6552104, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x654c5a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
