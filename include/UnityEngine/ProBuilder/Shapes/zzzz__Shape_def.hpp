...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Shapes::Shape*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Shapes::Shape*, "UnityEngine.ProBuilder.Shapes", "Shape");
...
public:
  ...
  /// @brief Method UpdateBounds, addr 0x6708bac, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6703048, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Shape", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Shape(Shape&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Shape", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Shape(Shapeconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Shapes::Shape) == 0x10, "Size mismatch!");
