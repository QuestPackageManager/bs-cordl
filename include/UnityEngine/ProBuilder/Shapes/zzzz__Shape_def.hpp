...
/// @brief Method UpdateBounds, addr 0x65c5c88, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65c0124, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
