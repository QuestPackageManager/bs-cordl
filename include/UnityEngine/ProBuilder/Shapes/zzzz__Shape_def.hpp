...
public:
  ...
  /// @brief Method UpdateBounds, addr 0x4751b98, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x474be38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
