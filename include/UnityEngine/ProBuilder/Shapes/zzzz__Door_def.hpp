...
public:
  ...
  /// @brief Method CopyShape, addr 0x4753b68, size 0xac, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Door* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4753c14, size 0x1a04, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4755618, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
