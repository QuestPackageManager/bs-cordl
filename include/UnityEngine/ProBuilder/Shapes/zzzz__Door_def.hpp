...
public:
  ...
  /// @brief Method CopyShape, addr 0x66ff6dc, size 0xbc, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Door* New_ctor();

  /// @brief Method RebuildMesh, addr 0x66ff798, size 0x18f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6701088, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
