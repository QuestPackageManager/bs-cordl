...
public:
  ...
  /// @brief Method CopyShape, addr 0x654dd8c, size 0xbc, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Door* New_ctor();

  /// @brief Method RebuildMesh, addr 0x654de48, size 0x18f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x654f738, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
