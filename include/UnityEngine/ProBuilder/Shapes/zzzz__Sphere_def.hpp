...
public:
  ...
  /// @brief Method CopyShape, addr 0x67033e8, size 0x90, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Sphere* New_ctor();

  /// @brief Method RebuildMesh, addr 0x67034d4, size 0x8e8, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method SubdivideIcosahedron, addr 0x6703dbc, size 0x50c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3> SubdivideIcosahedron(::ArrayW<::UnityEngine::Vector3> vertices, float_t radius);

  /// @brief Method UpdateBounds, addr 0x6703478, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67042c8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
