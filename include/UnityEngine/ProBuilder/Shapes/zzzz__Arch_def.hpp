...
public:
  ...
  /// @brief Method CopyShape, addr 0x30b7688, size 0x94, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x30b771c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x30b77e0, size 0xc00, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30b83e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
