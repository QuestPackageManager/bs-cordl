...
public:
  ...
  /// @brief Method CopyShape, addr 0x65bd7fc, size 0xa0, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x65bd89c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x65bd964, size 0xc24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65be588, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
