...
public:
  ...
  /// @brief Method CopyShape, addr 0x46d5740, size 0x9c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x46d57dc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x46d58a0, size 0xb44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x46d63e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
