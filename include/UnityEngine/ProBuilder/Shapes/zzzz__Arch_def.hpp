...
public:
  ...
  /// @brief Method CopyShape, addr 0x4751028, size 0x9c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x47510c4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x4751188, size 0xb44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4751ccc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
