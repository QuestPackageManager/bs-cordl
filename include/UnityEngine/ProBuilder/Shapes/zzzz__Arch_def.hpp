...
public:
  ...
  /// @brief Method CopyShape, addr 0x474e3d0, size 0x9c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetFace, addr 0x474e46c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x474e530, size 0xb44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x474f074, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
