...
public:
  ...
  /// @brief Method CopyShape, addr 0x2b9005c, size 0x8c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method UpdateBounds, addr 0x2b900e8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method RebuildMesh, addr 0x2b90170, size 0x984, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method GetCirclePoints, addr 0x2b90af4, size 0x34c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCirclePoints, addr 0x2b90e40, size 0x298, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetCirclePoints(int32_t segments, float_t radius, float_t circumference, ::UnityEngine::Quaternion rotation,
                                                                                                   ::UnityEngine::Vector3 offset);

  static inline ::UnityEngine::ProBuilder::Shapes::Torus* New_ctor();

  /// @brief Method .ctor, addr 0x2b910d8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
