...
public:
  ...
  /// @brief Method CopyShape, addr 0x6555040, size 0x9c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetCirclePoints, addr 0x6555e78, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCirclePoints, addr 0x6555b5c, size 0x31c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetCirclePoints(int32_t segments, float_t radius, float_t circumference, ::UnityEngine::Quaternion rotation,
                                                                                                   float_t offset);

  static inline ::UnityEngine::ProBuilder::Shapes::Torus* New_ctor();

  /// @brief Method RebuildMesh, addr 0x655515c, size 0xa00, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x65550dc, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x655610c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
