...
public:
  ...
  /// @brief Method CopyShape, addr 0x4756870, size 0x94, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetCirclePoints, addr 0x475763c, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCirclePoints, addr 0x47572ec, size 0x350, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetCirclePoints(int32_t segments, float_t radius, float_t circumference, ::UnityEngine::Quaternion rotation,
                                                                                                   float_t offset);

  static inline ::UnityEngine::ProBuilder::Shapes::Torus* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4756984, size 0x968, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x4756904, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47578d8, size 0x234, virtual false, abstract: false, final false
  inline void _ctor();
