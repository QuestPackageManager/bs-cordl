...
public:
  ...
  /// @brief Method CopyShape, addr 0x2cd8968, size 0x8c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method GetCirclePoints, addr 0x2cd974c, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCirclePoints, addr 0x2cd9400, size 0x34c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetCirclePoints(int32_t segments, float_t radius, float_t circumference, ::UnityEngine::Quaternion rotation,
                                                                                                   float_t offset);

  static inline ::UnityEngine::ProBuilder::Shapes::Torus* New_ctor();

  /// @brief Method RebuildMesh, addr 0x2cd8a7c, size 0x984, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x2cd89f4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd99e4, size 0x102c, virtual false, abstract: false, final false
  inline void _ctor();
