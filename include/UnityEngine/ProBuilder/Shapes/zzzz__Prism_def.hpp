...
public:
  // Declarations
  /// @brief Method CopyShape addr 0x2a0b650 size 0x4 virtual true final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method RebuildMesh addr 0x2a0b654 size 0x814 virtual true final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  static inline ::UnityEngine::ProBuilder::Shapes::Prism* New_ctor();

  /// @brief Method .ctor addr 0x2a0be68 size 0x8 virtual false final false
  inline void _ctor();
