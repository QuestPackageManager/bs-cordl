...
public:
  ...
  /// @brief Method CopyShape, addr 0x474f0a4, size 0x8c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Cone* New_ctor();

  /// @brief Method RebuildMesh, addr 0x474f294, size 0xc4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x474f130, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x474fee0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
