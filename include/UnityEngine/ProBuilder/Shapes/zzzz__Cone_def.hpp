...
public:
  ...
  /// @brief Method CopyShape, addr 0x66fd834, size 0x98, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Cone* New_ctor();

  /// @brief Method RebuildMesh, addr 0x66fda4c, size 0xc68, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x66fd8cc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66fe6b4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
