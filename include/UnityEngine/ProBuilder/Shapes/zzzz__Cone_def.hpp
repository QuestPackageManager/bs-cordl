...
public:
  ...
  /// @brief Method CopyShape, addr 0x2c6e72c, size 0x84, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Cone* New_ctor();

  /// @brief Method RebuildMesh, addr 0x2c6e924, size 0xc4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x2c6e7b0, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c6f570, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
