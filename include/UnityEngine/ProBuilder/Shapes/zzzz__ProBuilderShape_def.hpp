...
public:
  ...
  /// @brief Method OnValidate, addr 0x65c378c, size 0xa8, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Rebuild, addr 0x65c3b94, size 0x154, virtual false, abstract: false, final false
  inline void Rebuild();

  /// @brief Method Rebuild, addr 0x65c3ce8, size 0xb4, virtual false, abstract: false, final false
  inline void Rebuild(::UnityEngine::Bounds bounds, ::UnityEngine::Quaternion rotation);

  /// @brief Method Rebuild, addr 0x65c39b0, size 0x11c, virtual false, abstract: false, final false
  inline void Rebuild(::UnityEngine::Vector3 pivotPosition, ::UnityEngine::Quaternion rotation, ::UnityEngine::Bounds bounds);

  /// @brief Method RotateInsideBounds, addr 0x65c3eac, size 0x190, virtual false, abstract: false, final false
  inline void RotateInsideBounds(::UnityEngine::Quaternion deltaRotation);

  /// @brief Method SetShape, addr 0x65c3d9c, size 0x110, virtual false, abstract: false, final false
  inline void SetShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  /// @brief Method UpdateBounds, addr 0x65c3acc, size 0xc8, virtual false, abstract: false, final false
  inline void UpdateBounds(::UnityEngine::Bounds bounds);

  /// @brief Method UpdateShape, addr 0x65c3834, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65c403c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_editionBounds, addr 0x65c352c, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_editionBounds();

  /// @brief Method get_isEditable, addr 0x65c3660, size 0x28, virtual false, abstract: false, final false
  inline bool get_isEditable();

  /// @brief Method get_mesh, addr 0x65c3688, size 0x104, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh();

  /// @brief Method get_shape, addr 0x65c3414, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Shapes::Shape* get_shape();

  /// @brief Method get_shapeLocalBounds, addr 0x65c35e4, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_shapeLocalBounds();

  /// @brief Method get_shapeRotation, addr 0x65c34e8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_shapeRotation();

  /// @brief Method get_shapeWorldBounds, addr 0x65c3618, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Bounds get_shapeWorldBounds();

  /// @brief Method get_shapeWorldCenter, addr 0x65c3500, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_shapeWorldCenter();

  /// @brief Method get_size, addr 0x65c341c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_size();

  /// @brief Method set_shapeRotation, addr 0x65c34f4, size 0xc, virtual false, abstract: false, final false
  inline void set_shapeRotation(::UnityEngine::Quaternion value);

  /// @brief Method set_size, addr 0x65c3428, size 0xc0, virtual false, abstract: false, final false
