...
public:
  ...
  /// @brief Method BuildCurvedStairs, addr 0x2cd673c, size 0x1174, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildStairs, addr 0x2cd78b0, size 0xf28, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyShape, addr 0x2cd6640, size 0x9c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Stairs* New_ctor();

  /// @brief Method RebuildMesh, addr 0x2cd66dc, size 0x60, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x2cd87d8, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cd893c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sides, addr 0x2cd662c, size 0x8, virtual false, abstract: false, final false
  inline bool get_sides();

  /// @brief Method set_sides, addr 0x2cd6634, size 0xc, virtual false, abstract: false, final false
