...
public:
  ...
  /// @brief Method BuildCurvedStairs, addr 0x65c5658, size 0x1090, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildStairs, addr 0x65c66e8, size 0xec0, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyShape, addr 0x65c5554, size 0xb8, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Stairs* New_ctor();

  /// @brief Method RebuildMesh, addr 0x65c560c, size 0x4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x65c75a8, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65c76e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sides, addr 0x65c5544, size 0x8, virtual false, abstract: false, final false
  inline bool get_sides();

  /// @brief Method set_sides, addr 0x65c554c, size 0x8, virtual false, abstract: false, final false
