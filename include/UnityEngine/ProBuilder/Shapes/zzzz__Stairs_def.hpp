...
public:
  ...
  /// @brief Method BuildCurvedStairs, addr 0x476203c, size 0x1094, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildStairs, addr 0x47630d0, size 0xeb0, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyShape, addr 0x4761f44, size 0xac, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Stairs* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4761ff0, size 0x4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x4763f80, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47640d0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sides, addr 0x4761f30, size 0x8, virtual false, abstract: false, final false
  inline bool get_sides();

  /// @brief Method set_sides, addr 0x4761f38, size 0xc, virtual false, abstract: false, final false
