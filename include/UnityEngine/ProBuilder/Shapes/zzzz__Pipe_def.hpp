...
public:
  ...
  /// @brief Method CopyShape, addr 0x47511b0, size 0x8c, virtual true, abstract: false, final false
  inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape* shape);

  static inline ::UnityEngine::ProBuilder::Shapes::Pipe* New_ctor();

  /// @brief Method RebuildMesh, addr 0x4751268, size 0x9bc, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Vector3 size, ::UnityEngine::Quaternion rotation);

  /// @brief Method UpdateBounds, addr 0x475123c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4751c24, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
