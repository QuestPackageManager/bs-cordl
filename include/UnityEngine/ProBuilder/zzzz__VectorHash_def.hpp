...
public:
  // Declarations
  /// @brief Method HashFloat addr 0x29fe728 size 0x40 virtual false final false
  static inline int32_t HashFloat(float_t f);

  /// @brief Method GetHashCode addr 0x29fe768 size 0x7c virtual false final false
  static inline int32_t GetHashCode(::UnityEngine::Vector2 v);

  /// @brief Method GetHashCode addr 0x29e9094 size 0xb0 virtual false final false
  static inline int32_t GetHashCode(::UnityEngine::Vector3 v);

  /// @brief Method GetHashCode addr 0x29fe7e4 size 0xe0 virtual false final false
