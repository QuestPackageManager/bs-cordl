...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x6544908, size 0x7c, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::UnityEngine::Vector2  v) ;

/// @brief Method GetHashCode, addr 0x652fbd0, size 0xac, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::UnityEngine::Vector3  v) ;

/// @brief Method GetHashCode, addr 0x6544984, size 0xe0, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::UnityEngine::Vector4  v) ;

/// @brief Method HashFloat, addr 0x65448c8, size 0x40, virtual false, abstract: false, final false
