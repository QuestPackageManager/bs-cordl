...
public:
  ...
  /// @brief Method GetSubmeshCount, addr 0x473d3bc, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t GetSubmeshCount(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method GetSubmeshes, addr 0x473d428, size 0x940, virtual false, abstract: false, final false
  ...
  /// @brief Method MapFaceMaterialsToSubmeshIndex, addr 0x473dd68, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x473d2b4, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x473d1bc, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Mesh* mesh, int32_t subMeshIndex);

  /// @brief Method .ctor, addr 0x473d0fc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_indexes, addr 0x473d004, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_indexes();

  /// @brief Method get_submeshIndex, addr 0x473d0ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_submeshIndex();

  /// @brief Method get_topology, addr 0x473d0dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::MeshTopology get_topology();

  /// @brief Method set_indexes, addr 0x473d080, size 0x5c, virtual false, abstract: false, final false
  inline void set_indexes(::System::Collections::Generic::IEnumerable_1<int32_t>* value);

  /// @brief Method set_submeshIndex, addr 0x473d0f4, size 0x8, virtual false, abstract: false, final false
  inline void set_submeshIndex(int32_t value);

  /// @brief Method set_topology, addr 0x473d0e4, size 0x8, virtual false, abstract: false, final false
