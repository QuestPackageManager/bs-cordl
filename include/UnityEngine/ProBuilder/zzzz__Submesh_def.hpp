...
/// @brief Method GetSubmeshCount, addr 0x65b46cc, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetSubmeshCount(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh) ;

/// @brief Method GetSubmeshes, addr 0x65b4730, size 0x914, virtual false, abstract: false, final false
...
/// @brief Method MapFaceMaterialsToSubmeshIndex, addr 0x65b5044, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x65b45b0, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x65b44c0, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Mesh*  mesh, int32_t  subMeshIndex) ;

/// @brief Method .ctor, addr 0x65b4400, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_indexes, addr 0x65b4308, size 0x78, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_indexes() ;

/// @brief Method get_submeshIndex, addr 0x65b43f0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_submeshIndex() ;

/// @brief Method get_topology, addr 0x65b43e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::MeshTopology get_topology() ;

/// @brief Method set_indexes, addr 0x65b4380, size 0x60, virtual false, abstract: false, final false
inline void set_indexes(::System::Collections::Generic::IEnumerable_1<int32_t>*  value) ;

/// @brief Method set_submeshIndex, addr 0x65b43f8, size 0x8, virtual false, abstract: false, final false
inline void set_submeshIndex(int32_t  value) ;

/// @brief Method set_topology, addr 0x65b43e8, size 0x8, virtual false, abstract: false, final false
