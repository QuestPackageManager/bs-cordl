...
/// @brief Method GetSubmeshCount, addr 0x6540b48, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetSubmeshCount(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh) ;

/// @brief Method GetSubmeshes, addr 0x6540bac, size 0x914, virtual false, abstract: false, final false
...
/// @brief Method MapFaceMaterialsToSubmeshIndex, addr 0x65414c0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x6540a2c, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x654093c, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Mesh*  mesh, int32_t  subMeshIndex) ;

/// @brief Method .ctor, addr 0x654087c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_indexes, addr 0x6540784, size 0x78, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_indexes() ;

/// @brief Method get_submeshIndex, addr 0x654086c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_submeshIndex() ;

/// @brief Method get_topology, addr 0x654085c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::MeshTopology get_topology() ;

/// @brief Method set_indexes, addr 0x65407fc, size 0x60, virtual false, abstract: false, final false
inline void set_indexes(::System::Collections::Generic::IEnumerable_1<int32_t>*  value) ;

/// @brief Method set_submeshIndex, addr 0x6540874, size 0x8, virtual false, abstract: false, final false
inline void set_submeshIndex(int32_t  value) ;

/// @brief Method set_topology, addr 0x6540864, size 0x8, virtual false, abstract: false, final false
