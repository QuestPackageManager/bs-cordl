...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::RectSelectMode, "UnityEngine.ProBuilder", "RectSelectMode");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::RectSelectMode) == 0x4, "Size mismatch!");
