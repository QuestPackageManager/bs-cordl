...
public:
  ...
  /// @brief Method FromRGB, addr 0x649ad1c, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::XYZColor* FromRGB(float_t R, float_t G, float_t B);

  /// @brief Method FromRGB, addr 0x649ac24, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x649af3c, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x649ac18, size 0xc, virtual false, abstract: false, final false
