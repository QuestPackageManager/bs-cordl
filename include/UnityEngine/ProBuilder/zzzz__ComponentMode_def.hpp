...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::ComponentMode, "UnityEngine.ProBuilder", "ComponentMode");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::ComponentMode) == 0x4, "Size mismatch!");
