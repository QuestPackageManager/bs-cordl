...
public:
  ...
  /// @brief Method FromRGB, addr 0x6574b08, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SqrDistance, addr 0x6574e2c, size 0x44, virtual false, abstract: false, final false
  inline float_t SqrDistance(::UnityEngine::ProBuilder::HSVColor* InColor);

  /// @brief Method ToString, addr 0x6574d54, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6574ae8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t h, float_t s, float_t v);

  /// @brief Method .ctor, addr 0x6574af4, size 0x14, virtual false, abstract: false, final false
