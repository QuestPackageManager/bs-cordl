...
public:
  ...
  /// @brief Method FromRGB, addr 0x2c22ee4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SqrDistance, addr 0x2c23244, size 0x48, virtual false, abstract: false, final false
  inline float_t SqrDistance(::UnityEngine::ProBuilder::HSVColor* InColor);

  /// @brief Method ToString, addr 0x2c23180, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c22e60, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(float_t h, float_t s, float_t v);

  /// @brief Method .ctor, addr 0x2c22e9c, size 0x48, virtual false, abstract: false, final false
