...
public:
  ...
  /// @brief Method FromRGB, addr 0x650243c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SqrDistance, addr 0x6502760, size 0x44, virtual false, abstract: false, final false
  inline float_t SqrDistance(::UnityEngine::ProBuilder::HSVColor* InColor);

  /// @brief Method ToString, addr 0x6502688, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x650241c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t h, float_t s, float_t v);

  /// @brief Method .ctor, addr 0x6502428, size 0x14, virtual false, abstract: false, final false
