...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HSVColor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HSVColor(HSVColor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HSVColor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HSVColor(HSVColorconst&) = delete;
