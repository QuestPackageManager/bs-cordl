...
public:
  ...
  /// @brief Method FromRGB, addr 0x3276650, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method SqrDistance, addr 0x32769b0, size 0x48, virtual false, abstract: false, final false
  inline float_t SqrDistance(::UnityEngine::ProBuilder::HSVColor* InColor);

  /// @brief Method ToString, addr 0x32768ec, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32765cc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(float_t h, float_t s, float_t v);

  /// @brief Method .ctor, addr 0x3276608, size 0x48, virtual false, abstract: false, final false
