...
public:
  ...
  /// @brief Method ContainsEdge, addr 0x32b4f80, size 0x100, virtual false, abstract: false, final false
  inline bool ContainsEdge(::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method Equals, addr 0x32b4e34, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x32b4e00, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::Triangle other);

  /// @brief Method GetHashCode, addr 0x32b4ecc, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAdjacent, addr 0x32b4eec, size 0x94, virtual false, abstract: false, final false
  inline bool IsAdjacent(::UnityEngine::ProBuilder::Triangle other);

  /// @brief Method .ctor, addr 0x32b4df4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t a, int32_t b, int32_t c);

  /// @brief Method get_a, addr 0x32b4d54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_a();

  /// @brief Method get_b, addr 0x32b4d5c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_b();

  /// @brief Method get_c, addr 0x32b4d64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_c();

  /// @brief Method get_indices, addr 0x32b4d6c, size 0x88, virtual false, abstract: false, final false
