...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Triangle, "UnityEngine.ProBuilder", "Triangle");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
public:
  ...
  /// @brief Method ContainsEdge, addr 0x66f32e4, size 0xd8, virtual false, abstract: false, final false
  inline bool ContainsEdge(::UnityEngine::ProBuilder::Edge edge);

  /// @brief Method Equals, addr 0x66f31c8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x66f3194, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::Triangle other);

  /// @brief Method GetHashCode, addr 0x66f3264, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsAdjacent, addr 0x66f3284, size 0x60, virtual false, abstract: false, final false
  inline bool IsAdjacent(::UnityEngine::ProBuilder::Triangle other);

  /// @brief Method .ctor, addr 0x66f3188, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t a, int32_t b, int32_t c);

  /// @brief Method get_a, addr 0x66f30e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_a();

  /// @brief Method get_b, addr 0x66f30ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_b();

  /// @brief Method get_c, addr 0x66f30f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_c();

  /// @brief Method get_indices, addr 0x66f30fc, size 0x8c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ProBuilder::Triangle) == 0xc, "Size mismatch!");
