...
public:
  ...
  /// @brief Method Abs, addr 0x3078490, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 Abs(::UnityEngine::Vector3 v);

  /// @brief Method Approx, addr 0x307847c, size 0x14, virtual false, abstract: false, final false
  static inline bool Approx(float_t a, float_t b, float_t delta);

  /// @brief Method Approx2, addr 0x30783a8, size 0x24, virtual false, abstract: false, final false
  static inline bool Approx2(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b, float_t delta);

  /// @brief Method Approx3, addr 0x30783cc, size 0x30, virtual false, abstract: false, final false
  static inline bool Approx3(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, float_t delta);

  /// @brief Method Approx4, addr 0x30783fc, size 0x40, virtual false, abstract: false, final false
  static inline bool Approx4(::UnityEngine::Vector4 a, ::UnityEngine::Vector4 b, float_t delta);

  /// @brief Method ApproxC, addr 0x307843c, size 0x40, virtual false, abstract: false, final false
  static inline bool ApproxC(::UnityEngine::Color a, ::UnityEngine::Color b, float_t delta);

  /// @brief Method Average, addr 0x30774b8, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method Average, addr 0x3077800, size 0x5a0, virtual false, abstract: false, final false
  ...
  /// @brief Method Average, addr 0x3077da0, size 0x5a8, virtual false, abstract: false, final false
  ...
  /// @brief Method Clamp, addr 0x3074a08, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t Clamp(int32_t value, int32_t lowerBound, int32_t upperBound);

  /// @brief Method Cross, addr 0x3075f88, size 0x30, virtual false, abstract: false, final false
  static inline void Cross(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ByRef<::UnityEngine::Vector3> res);

  /// @brief Method DistancePointLineSegment, addr 0x30753d0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method DistancePointLineSegment, addr 0x307553c, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method DivideBy, addr 0x3076d54, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 DivideBy(::UnityEngine::Vector2 v, ::UnityEngine::Vector2 o);

  /// @brief Method DivideBy, addr 0x3076d60, size 0x10, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 DivideBy(::UnityEngine::Vector3 v, ::UnityEngine::Vector3 o);

  /// @brief Method EnsureUnitVector, addr 0x30787b8, size 0x108, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 EnsureUnitVector(::UnityEngine::Vector2 value);

  /// @brief Method EnsureUnitVector, addr 0x30788c0, size 0x120, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 EnsureUnitVector(::UnityEngine::Vector3 value);

  /// @brief Method EnsureUnitVector, addr 0x30789e0, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 EnsureUnitVector(::UnityEngine::Vector4 value);

  /// @brief Method FixNaN, addr 0x3078738, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 FixNaN(::UnityEngine::Vector4 value);

  /// @brief Method GetBounds, addr 0x3072090, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLineSegmentIntersect, addr 0x3065f24, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLineSegmentIntersect, addr 0x3075990, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNearestPointRayRay, addr 0x307576c, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetNearestPointRayRay(::UnityEngine::Ray a, ::UnityEngine::Ray b);

  /// @brief Method GetNearestPointRayRay, addr 0x307582c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method InvertScaleVector, addr 0x3078348, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 InvertScaleVector(::UnityEngine::Vector3 scaleVector);

  /// @brief Method IsCardinalAxis, addr 0x3076b0c, size 0x248, virtual false, abstract: false, final false
  static inline bool IsCardinalAxis(::UnityEngine::Vector3 v, float_t epsilon);

  /// @brief Method IsNumber, addr 0x3078590, size 0x34, virtual false, abstract: false, final false
  static inline bool IsNumber(::UnityEngine::Vector2 value);

  /// @brief Method IsNumber, addr 0x30785c4, size 0x44, virtual false, abstract: false, final false
  static inline bool IsNumber(::UnityEngine::Vector3 value);

  /// @brief Method IsNumber, addr 0x3078608, size 0x60, virtual false, abstract: false, final false
  static inline bool IsNumber(::UnityEngine::Vector4 value);

  /// @brief Method IsNumber, addr 0x30784dc, size 0xb4, virtual false, abstract: false, final false
  static inline bool IsNumber(float_t value);

  /// @brief Method LargestValue, addr 0x3076d94, size 0xc, virtual false, abstract: false, final false
  static inline float_t LargestValue(::UnityEngine::Vector2 v);

  /// @brief Method LargestValue, addr 0x3076d70, size 0x24, virtual false, abstract: false, final false
  static inline float_t LargestValue(::UnityEngine::Vector3 v);

  /// @brief Method LargestVector2, addr 0x307712c, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 LargestVector2(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> v);

  /// @brief Method LargestVector2, addr 0x3077180, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeNonZero, addr 0x3078668, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Normal, addr 0x3076900, size 0x20c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 Normal(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face);

  /// @brief Method Normal, addr 0x3075fd0, size 0x1b4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 Normal(::UnityEngine::Vector3 p0, ::UnityEngine::Vector3 p1, ::UnityEngine::Vector3 p2);

  /// @brief Method Normal, addr 0x3076184, size 0x77c, virtual false, abstract: false, final false
  ...
  /// @brief Method NormalTangentBitangent, addr 0x30717e4, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method Perpendicular, addr 0x3075198, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Perpendicular(::UnityEngine::Vector2 value);

  /// @brief Method PointInCircumference, addr 0x3074ab0, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 PointInCircumference(float_t radius, float_t angleInDegrees, ::UnityEngine::Vector2 origin);

  /// @brief Method PointInEllipseCircumference, addr 0x3074b0c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInEllipseCircumferenceWithConstantAngle, addr 0x3074c38, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInPolygon, addr 0x3075aa4, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInPolygon, addr 0x3075d1c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInPolygon, addr 0x3075e40, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method PointInSphere, addr 0x3074da8, size 0x78, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 PointInSphere(float_t radius, float_t latitudeAngle, float_t longitudeAngle);

  /// @brief Method PolygonArea, addr 0x3074ffc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method RayIntersectsTriangle, addr 0x306f724, size 0x2dc, virtual false, abstract: false, final false
  ...
  /// @brief Method RayIntersectsTriangle2, addr 0x307096c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method RectIntersectsLineSegment, addr 0x3075f64, size 0x4, virtual false, abstract: false, final false
  static inline bool RectIntersectsLineSegment(::UnityEngine::Rect rect, ::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method RectIntersectsLineSegment, addr 0x3075f68, size 0x8, virtual false, abstract: false, final false
  static inline bool RectIntersectsLineSegment(::UnityEngine::Rect rect, ::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b);

  /// @brief Method ReflectPoint, addr 0x30751ac, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateAroundPoint, addr 0x307510c, size 0x70, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 RotateAroundPoint(::UnityEngine::Vector2 v, ::UnityEngine::Vector2 origin, float_t theta);

  /// @brief Method ScaleAroundPoint, addr 0x307517c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method Secant, addr 0x3075fb8, size 0x18, virtual false, abstract: false, final false
  static inline float_t Secant(float_t x);

  /// @brief Method Sign, addr 0x30784a0, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 Sign(::UnityEngine::Vector3 v);

  /// @brief Method SignedAngle, addr 0x3074e20, size 0x104, virtual false, abstract: false, final false
  static inline float_t SignedAngle(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method SmallestVector2, addr 0x3076da0, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 SmallestVector2(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> v);

  /// @brief Method SmallestVector2, addr 0x3076df4, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method SqrDistance, addr 0x3074f24, size 0x24, virtual false, abstract: false, final false
  static inline float_t SqrDistance(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b);

  /// @brief Method SqrDistanceRayPoint, addr 0x3075338, size 0x98, virtual false, abstract: false, final false
  static inline float_t SqrDistanceRayPoint(::UnityEngine::Ray ray, ::UnityEngine::Vector3 point);

  /// @brief Method Subtract, addr 0x3075f70, size 0x18, virtual false, abstract: false, final false
  static inline void Subtract(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ByRef<::UnityEngine::Vector3> res);

  /// @brief Method Sum, addr 0x30784c4, size 0x18, virtual false, abstract: false, final false
  static inline float_t Sum(::UnityEngine::Vector3 v);

  /// @brief Method TriangleArea, addr 0x3074f48, size 0xb4, virtual false, abstract: false, final false
