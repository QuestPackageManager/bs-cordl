...
public:
  ...
  /// @brief Method PointInCircumference addr 0x29c6434 size 0x5c virtual false final false
  static inline ::UnityEngine::Vector2 PointInCircumference(float_t radius, float_t angleInDegrees, ::UnityEngine::Vector2 origin);

  /// @brief Method PointInEllipseCircumference addr 0x29c6490 size 0x12c virtual false final false
  ...
  /// @brief Method PointInEllipseCircumferenceWithConstantAngle addr 0x29c65bc size 0x170 virtual false final false
  ...
  /// @brief Method PointInSphere addr 0x29c672c size 0x78 virtual false final false
  static inline ::UnityEngine::Vector3 PointInSphere(float_t radius, float_t latitudeAngle, float_t longitudeAngle);

  /// @brief Method SignedAngle addr 0x29c67a4 size 0x104 virtual false final false
  static inline float_t SignedAngle(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method SqrDistance addr 0x29c68a8 size 0x24 virtual false final false
  static inline float_t SqrDistance(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b);

  /// @brief Method TriangleArea addr 0x29c68cc size 0xb4 virtual false final false
  static inline float_t TriangleArea(::UnityEngine::Vector3 x, ::UnityEngine::Vector3 y, ::UnityEngine::Vector3 z);

  /// @brief Method PolygonArea addr 0x29c6980 size 0x110 virtual false final false
  ...
  /// @brief Method RotateAroundPoint addr 0x29c6a90 size 0x70 virtual false final false
  static inline ::UnityEngine::Vector2 RotateAroundPoint(::UnityEngine::Vector2 v, ::UnityEngine::Vector2 origin, float_t theta);

  /// @brief Method ScaleAroundPoint addr 0x29c6b00 size 0x1c virtual false final false
  ...
  /// @brief Method Perpendicular addr 0x29c6b1c size 0x14 virtual false final false
  static inline ::UnityEngine::Vector2 Perpendicular(::UnityEngine::Vector2 value);

  /// @brief Method ReflectPoint addr 0x29c6b30 size 0x18c virtual false final false
  ...
  /// @brief Method SqrDistanceRayPoint addr 0x29c6cbc size 0x98 virtual false final false
  static inline float_t SqrDistanceRayPoint(::UnityEngine::Ray ray, ::UnityEngine::Vector3 point);

  /// @brief Method DistancePointLineSegment addr 0x29c6d54 size 0x16c virtual false final false
  ...
  /// @brief Method DistancePointLineSegment addr 0x29c6ec0 size 0x230 virtual false final false
  ...
  /// @brief Method GetNearestPointRayRay addr 0x29c70f0 size 0xc0 virtual false final false
  static inline ::UnityEngine::Vector3 GetNearestPointRayRay(::UnityEngine::Ray a, ::UnityEngine::Ray b);

  /// @brief Method GetNearestPointRayRay addr 0x29c71b0 size 0x164 virtual false final false
  ...
  /// @brief Method GetLineSegmentIntersect addr 0x29c7314 size 0x114 virtual false final false
  ...
  /// @brief Method GetLineSegmentIntersect addr 0x29b78a8 size 0x78 virtual false final false
  ...
  /// @brief Method PointInPolygon addr 0x29c7428 size 0x278 virtual false final false
  ...
  /// @brief Method PointInPolygon addr 0x29c76a0 size 0x124 virtual false final false
  ...
  /// @brief Method PointInPolygon addr 0x29c77c4 size 0x124 virtual false final false
  ...
  /// @brief Method RectIntersectsLineSegment addr 0x29c78e8 size 0x4 virtual false final false
  static inline bool RectIntersectsLineSegment(::UnityEngine::Rect rect, ::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b);

  /// @brief Method RectIntersectsLineSegment addr 0x29c78ec size 0x8 virtual false final false
  static inline bool RectIntersectsLineSegment(::UnityEngine::Rect rect, ::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b);

  /// @brief Method RayIntersectsTriangle addr 0x29c10a8 size 0x2dc virtual false final false
  ...
  /// @brief Method RayIntersectsTriangle2 addr 0x29c22f0 size 0x238 virtual false final false
  ...
  /// @brief Method Secant addr 0x29c793c size 0x18 virtual false final false
  static inline float_t Secant(float_t x);

  /// @brief Method Normal addr 0x29c7954 size 0x1b4 virtual false final false
  static inline ::UnityEngine::Vector3 Normal(::UnityEngine::Vector3 p0, ::UnityEngine::Vector3 p1, ::UnityEngine::Vector3 p2);

  /// @brief Method Normal addr 0x29c7b08 size 0x77c virtual false final false
  ...
  /// @brief Method Normal addr 0x29c8284 size 0x20c virtual false final false
  static inline ::UnityEngine::Vector3 Normal(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::ProBuilder::Face* face);

  /// @brief Method NormalTangentBitangent addr 0x29c3168 size 0x3ec virtual false final false
  ...
  /// @brief Method IsCardinalAxis addr 0x29c8490 size 0x248 virtual false final false
  static inline bool IsCardinalAxis(::UnityEngine::Vector3 v, float_t epsilon);

  /// @brief Method DivideBy addr 0x29c86d8 size 0xc virtual false final false
  static inline ::UnityEngine::Vector2 DivideBy(::UnityEngine::Vector2 v, ::UnityEngine::Vector2 o);

  /// @brief Method DivideBy addr 0x29c86e4 size 0x10 virtual false final false
  ...
  /// @brief Method LargestValue addr 0x29c86f4 size 0x24 virtual false final false
  static inline float_t LargestValue(::UnityEngine::Vector3 v);

  /// @brief Method LargestValue addr 0x29c8718 size 0xc virtual false final false
  static inline float_t LargestValue(::UnityEngine::Vector2 v);

  /// @brief Method SmallestVector2 addr 0x29c8724 size 0x54 virtual false final false
  static inline ::UnityEngine::Vector2 SmallestVector2(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> v);

  /// @brief Method SmallestVector2 addr 0x29c8778 size 0x338 virtual false final false
  ...
  /// @brief Method LargestVector2 addr 0x29c8ab0 size 0x54 virtual false final false
  static inline ::UnityEngine::Vector2 LargestVector2(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> v);

  /// @brief Method LargestVector2 addr 0x29c8b04 size 0x338 virtual false final false
  ...
  /// @brief Method GetBounds addr 0x29c3a14 size 0x5d0 virtual false final false
  ...
  /// @brief Method Average addr 0x29c8e3c size 0x348 virtual false final false
  ...
  /// @brief Method Average addr 0x29c9184 size 0x5a0 virtual false final false
  ...
  /// @brief Method Average addr 0x29c9724 size 0x5a8 virtual false final false
  ...
  /// @brief Method InvertScaleVector addr 0x29c9ccc size 0x60 virtual false final false
  static inline ::UnityEngine::Vector3 InvertScaleVector(::UnityEngine::Vector3 scaleVector);

  /// @brief Method Approx2 addr 0x29c9d2c size 0x24 virtual false final false
  static inline bool Approx2(::UnityEngine::Vector2 a, ::UnityEngine::Vector2 b, float_t delta);

  /// @brief Method Approx3 addr 0x29c9d50 size 0x30 virtual false final false
  static inline bool Approx3(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, float_t delta);

  /// @brief Method Approx4 addr 0x29c9d80 size 0x40 virtual false final false
  static inline bool Approx4(::UnityEngine::Vector4 a, ::UnityEngine::Vector4 b, float_t delta);

  /// @brief Method ApproxC addr 0x29c9dc0 size 0x40 virtual false final false
  static inline bool ApproxC(::UnityEngine::Color a, ::UnityEngine::Color b, float_t delta);

  /// @brief Method Approx addr 0x29c9e00 size 0x14 virtual false final false
  static inline bool Approx(float_t a, float_t b, float_t delta);

  /// @brief Method Clamp addr 0x29c638c size 0x1c virtual false final false
  static inline int32_t Clamp(int32_t value, int32_t lowerBound, int32_t upperBound);

  /// @brief Method Abs addr 0x29c9e14 size 0x10 virtual false final false
  static inline ::UnityEngine::Vector3 Abs(::UnityEngine::Vector3 v);

  /// @brief Method Sign addr 0x29c9e24 size 0x24 virtual false final false
  static inline ::UnityEngine::Vector3 Sign(::UnityEngine::Vector3 v);

  /// @brief Method Sum addr 0x29c9e48 size 0x18 virtual false final false
  static inline float_t Sum(::UnityEngine::Vector3 v);

  /// @brief Method Cross addr 0x29c790c size 0x30 virtual false final false
  static inline void Cross(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ByRef<::UnityEngine::Vector3> res);

  /// @brief Method Subtract addr 0x29c78f4 size 0x18 virtual false final false
  static inline void Subtract(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ByRef<::UnityEngine::Vector3> res);

  /// @brief Method IsNumber addr 0x29c9e60 size 0xb4 virtual false final false
  static inline bool IsNumber(float_t value);

  /// @brief Method IsNumber addr 0x29c9f14 size 0x34 virtual false final false
  static inline bool IsNumber(::UnityEngine::Vector2 value);

  /// @brief Method IsNumber addr 0x29c9f48 size 0x44 virtual false final false
  static inline bool IsNumber(::UnityEngine::Vector3 value);

  /// @brief Method IsNumber addr 0x29c9f8c size 0x60 virtual false final false
  static inline bool IsNumber(::UnityEngine::Vector4 value);

  /// @brief Method MakeNonZero addr 0x29c9fec size 0xd0 virtual false final false
  static inline float_t MakeNonZero(float_t value, float_t min);

  /// @brief Method FixNaN addr 0x29ca0bc size 0x80 virtual false final false
  static inline ::UnityEngine::Vector4 FixNaN(::UnityEngine::Vector4 value);

  /// @brief Method EnsureUnitVector addr 0x29ca13c size 0x108 virtual false final false
  static inline ::UnityEngine::Vector2 EnsureUnitVector(::UnityEngine::Vector2 value);

  /// @brief Method EnsureUnitVector addr 0x29ca244 size 0x120 virtual false final false
  static inline ::UnityEngine::Vector3 EnsureUnitVector(::UnityEngine::Vector3 value);

  /// @brief Method EnsureUnitVector addr 0x29ca364 size 0x4c virtual false final false
