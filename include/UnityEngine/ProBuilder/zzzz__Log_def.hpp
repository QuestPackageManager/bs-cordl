...
namespace UnityEngine::ProBuilder {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12063)), TypeDefinitionIndex(TypeDefinitionIndex(12064)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method PushLogLevel addr 0x29c55c4 size 0x90 virtual false final false
  static inline void PushLogLevel(::UnityEngine::ProBuilder::LogLevel level);

  /// @brief Method PopLogLevel addr 0x29c5654 size 0x88 virtual false final false
  static inline void PopLogLevel();

  /// @brief Method SetLogLevel addr 0x29c56dc size 0x5c virtual false final false
  static inline void SetLogLevel(::UnityEngine::ProBuilder::LogLevel level);

  /// @brief Method SetOutput addr 0x29c5738 size 0x5c virtual false final false
  static inline void SetOutput(::UnityEngine::ProBuilder::LogOutput output);

  /// @brief Method SetLogFile addr 0x29c5794 size 0x5c virtual false final false
  ...
  /// @brief Method Debug addr 0x29c57f0 size 0x58 virtual false final false
  static inline void Debug(::StringW message);

  /// @brief Method Debug addr 0x29c5918 size 0x4 virtual false final false
  static inline void Debug(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Info addr 0x29c591c size 0x78 virtual false final false
  static inline void Info(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Info addr 0x29c5994 size 0x80 virtual false final false
  static inline void Info(::StringW message);

  /// @brief Method Warning addr 0x29c5a14 size 0x78 virtual false final false
  static inline void Warning(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Warning addr 0x29c5a8c size 0x80 virtual false final false
  static inline void Warning(::StringW message);

  /// @brief Method Error addr 0x29c5b0c size 0x78 virtual false final false
  static inline void Error(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Error addr 0x29b94f8 size 0x80 virtual false final false
  ...
  /// @brief Method DoPrint addr 0x29c5848 size 0xd0 virtual false final false
  static inline void DoPrint(::StringW message, ::UnityEngine::LogType type);

  /// @brief Method PrintToFile addr 0x29c5c58 size 0x3d8 virtual false final false
  static inline void PrintToFile(::StringW message, ::StringW path);

  /// @brief Method ClearLogFile addr 0x29c6030 size 0x90 virtual false final false
  static inline void ClearLogFile();

  /// @brief Method PrintToConsole addr 0x29c5b84 size 0xd4 virtual false final false
