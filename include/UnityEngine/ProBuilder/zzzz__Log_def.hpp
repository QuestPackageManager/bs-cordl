...
public:
  ...
  /// @brief Method ClearLogFile, addr 0x4714e00, size 0x90, virtual false, abstract: false, final false
  static inline void ClearLogFile();

  /// @brief Method Debug, addr 0x47146b8, size 0x4, virtual false, abstract: false, final false
  static inline void Debug(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Debug, addr 0x4714590, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method DoPrint, addr 0x47145e8, size 0xd0, virtual false, abstract: false, final false
  static inline void DoPrint(::StringW message, ::UnityEngine::LogType type);

  /// @brief Method Error, addr 0x47148ac, size 0x78, virtual false, abstract: false, final false
  static inline void Error(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Error, addr 0x47083c0, size 0x80, virtual false, abstract: false, final false
  static inline void Error(::StringW message);

  /// @brief Method Info, addr 0x47146bc, size 0x78, virtual false, abstract: false, final false
  static inline void Info(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Info, addr 0x4714734, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method PopLogLevel, addr 0x47143f4, size 0x88, virtual false, abstract: false, final false
  static inline void PopLogLevel();

  /// @brief Method PrintToConsole, addr 0x4714924, size 0xe4, virtual false, abstract: false, final false
  static inline void PrintToConsole(::StringW message, ::UnityEngine::LogType type);

  /// @brief Method PrintToFile, addr 0x4714a08, size 0x3f8, virtual false, abstract: false, final false
  static inline void PrintToFile(::StringW message, ::StringW path);

  /// @brief Method PushLogLevel, addr 0x4714364, size 0x90, virtual false, abstract: false, final false
  static inline void PushLogLevel(::UnityEngine::ProBuilder::LogLevel level);

  /// @brief Method SetLogFile, addr 0x4714534, size 0x5c, virtual false, abstract: false, final false
  static inline void SetLogFile(::StringW path);

  /// @brief Method SetLogLevel, addr 0x471447c, size 0x5c, virtual false, abstract: false, final false
  static inline void SetLogLevel(::UnityEngine::ProBuilder::LogLevel level);

  /// @brief Method SetOutput, addr 0x47144d8, size 0x5c, virtual false, abstract: false, final false
  static inline void SetOutput(::UnityEngine::ProBuilder::LogOutput output);

  /// @brief Method Warning, addr 0x47147b4, size 0x78, virtual false, abstract: false, final false
  static inline void Warning(::StringW format, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> values);

  /// @brief Method Warning, addr 0x471482c, size 0x80, virtual false, abstract: false, final false
