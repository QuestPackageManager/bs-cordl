...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Point, put = __cordl_internal_set_Point)) ::ArrayW<TKey> Point;
  ...
  static inline ::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* New_ctor(::ArrayW<TKey> point, TValue value);
  ...
  constexpr ::ArrayW<TKey> const& __cordl_internal_get_Point() const;

  constexpr ::ArrayW<TKey>& __cordl_internal_get_Point();
  ...
  constexpr void __cordl_internal_set_Point(::ArrayW<TKey> value);
  ...
  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<TKey> point, TValue value);
