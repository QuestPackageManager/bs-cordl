...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DuplicateNodeError", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DuplicateNodeError(DuplicateNodeError&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DuplicateNodeError", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DuplicateNodeError(DuplicateNodeErrorconst&) = delete;
