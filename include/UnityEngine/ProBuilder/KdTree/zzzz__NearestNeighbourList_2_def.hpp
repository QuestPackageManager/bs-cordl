...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NearestNeighbourList_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NearestNeighbourList_2(NearestNeighbourList_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NearestNeighbourList_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NearestNeighbourList_2(NearestNeighbourList_2const&) = delete;
