...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::PriorityQueue_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::KdTree::PriorityQueue_2, "UnityEngine.ProBuilder.KdTree", "PriorityQueue`2");
// Dependencies System.Object, UnityEngine.ProBuilder.KdTree.ItemPriority`2<TItem, TPriority>
namespace UnityEngine::ProBuilder::KdTree {
// cpp template
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_queue, put = __cordl_internal_set_queue)) ::ArrayW<::UnityEngine::ProBuilder::KdTree::ItemPriority_2<TItem, TPriority>> queue;
  ...
  constexpr ::ArrayW<::UnityEngine::ProBuilder::KdTree::ItemPriority_2<TItem, TPriority>> const& __cordl_internal_get_queue() const;

  constexpr ::ArrayW<::UnityEngine::ProBuilder::KdTree::ItemPriority_2<TItem, TPriority>>& __cordl_internal_get_queue();
  ...
  constexpr void __cordl_internal_set_queue(::ArrayW<::UnityEngine::ProBuilder::KdTree::ItemPriority_2<TItem, TPriority>> value);
...
public:
  ...
  PriorityQueue_2(PriorityQueue_2const&) = delete;
  ...
  ::ArrayW<::UnityEngine::ProBuilder::KdTree::ItemPriority_2<TItem, TPriority>> ___queue;
