...
namespace UnityEngine::ProBuilder::KdTree::Math {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15819)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15819), inst: 2643 })}
...
public:
  ...
  /// @brief Method Compare addr 0x29ab750 size 0x20 virtual true final false
  inline int32_t Compare(double_t a, double_t b);

  /// @brief Method AreEqual addr 0x29ab770 size 0xc virtual true final false
  inline bool AreEqual(double_t a, double_t b);

  /// @brief Method get_MinValue addr 0x29ab77c size 0xc virtual true final false
  inline double_t get_MinValue();

  /// @brief Method get_MaxValue addr 0x29ab788 size 0xc virtual true final false
  inline double_t get_MaxValue();

  /// @brief Method get_Zero addr 0x29ab794 size 0x8 virtual true final false
  inline double_t get_Zero();

  /// @brief Method get_NegativeInfinity addr 0x29ab79c size 0xc virtual true final false
  inline double_t get_NegativeInfinity();

  /// @brief Method get_PositiveInfinity addr 0x29ab7a8 size 0xc virtual true final false
  inline double_t get_PositiveInfinity();

  /// @brief Method Add addr 0x29ab7b4 size 0x8 virtual true final false
  inline double_t Add(double_t a, double_t b);

  /// @brief Method Subtract addr 0x29ab7bc size 0x8 virtual true final false
  inline double_t Subtract(double_t a, double_t b);

  /// @brief Method Multiply addr 0x29ab7c4 size 0x8 virtual true final false
  inline double_t Multiply(double_t a, double_t b);

  /// @brief Method DistanceSquaredBetweenPoints addr 0x29ab7cc size 0x100 virtual true final false
  ...
  /// @brief Method .ctor addr 0x29ab8cc size 0x48 virtual false final false
  inline void _ctor();
