...
public:
  ...
  /// @brief Method Compare, addr 0x2b2d4a4, size 0x20, virtual true, abstract: false, final false
  inline int32_t Compare(double_t a, double_t b);

  /// @brief Method AreEqual, addr 0x2b2d4c4, size 0xc, virtual true, abstract: false, final false
  inline bool AreEqual(double_t a, double_t b);

  /// @brief Method get_MinValue, addr 0x2b2d4d0, size 0xc, virtual true, abstract: false, final false
  inline double_t get_MinValue();

  /// @brief Method get_MaxValue, addr 0x2b2d4dc, size 0xc, virtual true, abstract: false, final false
  inline double_t get_MaxValue();

  /// @brief Method get_Zero, addr 0x2b2d4e8, size 0x8, virtual true, abstract: false, final false
  inline double_t get_Zero();

  /// @brief Method get_NegativeInfinity, addr 0x2b2d4f0, size 0xc, virtual true, abstract: false, final false
  inline double_t get_NegativeInfinity();

  /// @brief Method get_PositiveInfinity, addr 0x2b2d4fc, size 0xc, virtual true, abstract: false, final false
  inline double_t get_PositiveInfinity();

  /// @brief Method Add, addr 0x2b2d508, size 0x8, virtual true, abstract: false, final false
  inline double_t Add(double_t a, double_t b);

  /// @brief Method Subtract, addr 0x2b2d510, size 0x8, virtual true, abstract: false, final false
  inline double_t Subtract(double_t a, double_t b);

  /// @brief Method Multiply, addr 0x2b2d518, size 0x8, virtual true, abstract: false, final false
  inline double_t Multiply(double_t a, double_t b);

  /// @brief Method DistanceSquaredBetweenPoints, addr 0x2b2d520, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b2d620, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
