...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::KdTree::IPriorityQueue_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::KdTree::IPriorityQueue_2, "UnityEngine.ProBuilder.KdTree", "IPriorityQueue`2");
// Dependencies
namespace UnityEngine::ProBuilder::KdTree {
// cpp template
