...
public:
  ...
  /// @brief Method Equals, addr 0x66b929c, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x66b9288, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Inverse, addr 0x66b9164, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::HandleConstraint2D* Inverse();

  /// @brief Method InverseMask, addr 0x66b91e4, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 InverseMask(::UnityEngine::Vector2 v);

  /// @brief Method Mask, addr 0x66b91cc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x66b9328, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b915c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t x, int32_t y);

  static inline ::UnityEngine::ProBuilder::HandleConstraint2D* getStaticF_None();

  /// @brief Method op_Equality, addr 0x66b9208, size 0x40, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::HandleConstraint2D* a, ::UnityEngine::ProBuilder::HandleConstraint2D* b);

  /// @brief Method op_Inequality, addr 0x66b9248, size 0x40, virtual false, abstract: false, final false
