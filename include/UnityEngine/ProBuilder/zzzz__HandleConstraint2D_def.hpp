...
public:
  ...
  /// @brief Method Equals, addr 0x66beab4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x66beaa0, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Inverse, addr 0x66be97c, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::HandleConstraint2D* Inverse();

  /// @brief Method InverseMask, addr 0x66be9fc, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 InverseMask(::UnityEngine::Vector2 v);

  /// @brief Method Mask, addr 0x66be9e4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x66beb40, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66be974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t x, int32_t y);

  static inline ::UnityEngine::ProBuilder::HandleConstraint2D* getStaticF_None();

  /// @brief Method op_Equality, addr 0x66bea20, size 0x40, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::HandleConstraint2D* a, ::UnityEngine::ProBuilder::HandleConstraint2D* b);

  /// @brief Method op_Inequality, addr 0x66bea60, size 0x40, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HandleConstraint2D", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HandleConstraint2D(HandleConstraint2D&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HandleConstraint2D", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HandleConstraint2D(HandleConstraint2Dconst&) = delete;
