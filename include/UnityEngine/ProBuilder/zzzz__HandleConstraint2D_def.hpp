...
public:
  ...
  /// @brief Method Equals, addr 0x470b338, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x470b330, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Inverse, addr 0x470b1fc, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::HandleConstraint2D* Inverse();

  /// @brief Method InverseMask, addr 0x470b288, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 InverseMask(::UnityEngine::Vector2 v);

  /// @brief Method Mask, addr 0x470b270, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x470b3b8, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x470b1d0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(int32_t x, int32_t y);

  static inline ::UnityEngine::ProBuilder::HandleConstraint2D* getStaticF_None();

  /// @brief Method op_Equality, addr 0x470b2b0, size 0x40, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::HandleConstraint2D* a, ::UnityEngine::ProBuilder::HandleConstraint2D* b);

  /// @brief Method op_Inequality, addr 0x470b2f0, size 0x40, virtual false, abstract: false, final false
