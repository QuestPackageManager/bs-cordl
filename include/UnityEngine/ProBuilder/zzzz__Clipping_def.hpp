...
public:
  ...
  /// @brief Method ComputeOutCode, addr 0x2c8368c, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::__Clipping__OutCode ComputeOutCode(::UnityEngine::Rect rect, float_t x, float_t y);

  /// @brief Method RectContainsLineSegment, addr 0x2c83728, size 0x1c0, virtual false, abstract: false, final false
