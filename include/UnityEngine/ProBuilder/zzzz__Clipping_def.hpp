...
static_assert(sizeof(::UnityEngine::ProBuilder::Clipping_OutCode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method ComputeOutCode, addr 0x66b2d74, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Clipping_OutCode ComputeOutCode(::UnityEngine::Rect rect, float_t x, float_t y);

  /// @brief Method RectContainsLineSegment, addr 0x66b2db0, size 0x210, virtual false, abstract: false, final false
