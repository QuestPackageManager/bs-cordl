...
public:
  ...
  /// @brief Method ComputeOutCode, addr 0x4704ee8, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Clipping_OutCode ComputeOutCode(::UnityEngine::Rect rect, float_t x, float_t y);

  /// @brief Method RectContainsLineSegment, addr 0x4704f34, size 0x1c0, virtual false, abstract: false, final false
