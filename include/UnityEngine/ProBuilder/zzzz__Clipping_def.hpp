...
/// @brief Method ComputeOutCode, addr 0x6575668, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::Clipping_OutCode ComputeOutCode(::UnityEngine::Rect  rect, float_t  x, float_t  y) ;

/// @brief Method RectContainsLineSegment, addr 0x65756a4, size 0x210, virtual false, abstract: false, final false
