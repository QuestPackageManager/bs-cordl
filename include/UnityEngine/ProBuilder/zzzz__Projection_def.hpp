...
/// @brief Method <Sort>b__6_0, addr 0x6528fc4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method <Sort>b__6_1, addr 0x652901c, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 _Sort_b__6_1(::UnityEngine::ProBuilder::SimpleTuple_2<float_t,::UnityEngine::Vector2>  x) ;

/// @brief Method .ctor, addr 0x6528fc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method FindBestPlane, addr 0x6528a9c, size 0x4d0, virtual false, abstract: false, final false
static inline ::UnityEngine::Plane FindBestPlane(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, int32_t  textureGroup) ;

/// @brief Method FindBestPlane, addr 0x65261e0, size 0x990, virtual false, abstract: false, final false
...
/// @brief Method GetTangentToAxis, addr 0x65275f4, size 0xcc, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetTangentToAxis(::UnityEngine::ProBuilder::ProjectionAxis  axis) ;

/// @brief Method PlanarProject, addr 0x65261b8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method PlanarProject, addr 0x6526b70, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method PlanarProject, addr 0x6527b78, size 0x460, virtual false, abstract: false, final false
...
/// @brief Method PlanarProject, addr 0x65276c0, size 0x4b8, virtual false, abstract: false, final false
...
/// @brief Method PlanarProject, addr 0x6526d44, size 0x7c4, virtual false, abstract: false, final false
...
/// @brief Method ProjectionAxisToVector, addr 0x65288cc, size 0x1d0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 ProjectionAxisToVector(::UnityEngine::ProBuilder::ProjectionAxis  axis) ;

/// @brief Method Sort, addr 0x65283c0, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method SphericalProject, addr 0x6527fd8, size 0x3e8, virtual false, abstract: false, final false
...
/// @brief Method VectorToProjectionAxis, addr 0x6527508, size 0xec, virtual false, abstract: false, final false
