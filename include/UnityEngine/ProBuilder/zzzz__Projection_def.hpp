...
public:
  ...
  /// @brief Method <Sort>b__6_0, addr 0x472b0c0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method <Sort>b__6_1, addr 0x472b108, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 _Sort_b__6_1(::UnityEngine::ProBuilder::SimpleTuple_2<float_t, ::UnityEngine::Vector2> x);

  /// @brief Method .ctor, addr 0x472b0b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindBestPlane, addr 0x472ab98, size 0x4c4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Plane FindBestPlane(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t textureGroup);

  /// @brief Method FindBestPlane, addr 0x47284b8, size 0x97c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTangentToAxis, addr 0x472989c, size 0xbc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetTangentToAxis(::UnityEngine::ProBuilder::ProjectionAxis axis);

  /// @brief Method PlanarProject, addr 0x4728490, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method PlanarProject, addr 0x4728e34, size 0x1b8, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> PlanarProject(::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* positions,
                                                                                                 ::System::Collections::Generic::IList_1<int32_t>* indexes, ::UnityEngine::Vector3 direction);

  /// @brief Method PlanarProject, addr 0x4729d94, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method PlanarProject, addr 0x4729958, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method PlanarProject, addr 0x4728fec, size 0x790, virtual false, abstract: false, final false
  ...
  /// @brief Method ProjectionAxisToVector, addr 0x472a9f8, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 ProjectionAxisToVector(::UnityEngine::ProBuilder::ProjectionAxis axis);

  /// @brief Method Sort, addr 0x472a520, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method SphericalProject, addr 0x472a164, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method VectorToProjectionAxis, addr 0x472977c, size 0x120, virtual false, abstract: false, final false
