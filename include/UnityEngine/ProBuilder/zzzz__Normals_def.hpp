...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Normals", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Normals(Normals&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Normals", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Normals(Normalsconst&) = delete;
