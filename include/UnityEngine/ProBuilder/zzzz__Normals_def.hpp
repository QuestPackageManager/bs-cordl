...
public:
  ...
  /// @brief Method CalculateHardNormals, addr 0x3080c08, size 0x4c8, virtual false, abstract: false, final false
  static inline void CalculateHardNormals(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CalculateNormals, addr 0x30810d0, size 0x5a8, virtual false, abstract: false, final false
  static inline void CalculateNormals(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CalculateTangents, addr 0x308070c, size 0x4fc, virtual false, abstract: false, final false
  static inline void CalculateTangents(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method ClearIntArray, addr 0x3080610, size 0xfc, virtual false, abstract: false, final false
