...
public:
  ...
  /// @brief Method CalculateHardNormals, addr 0x32b59e0, size 0x4c8, virtual false, abstract: false, final false
  static inline void CalculateHardNormals(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CalculateNormals, addr 0x32b5ea8, size 0x5a8, virtual false, abstract: false, final false
  static inline void CalculateNormals(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method CalculateTangents, addr 0x32b54e4, size 0x4fc, virtual false, abstract: false, final false
  static inline void CalculateTangents(::UnityEngine::ProBuilder::ProBuilderMesh* mesh);

  /// @brief Method ClearIntArray, addr 0x32b53e8, size 0xfc, virtual false, abstract: false, final false
