...
/// @brief Method <SortedRemoveAndShift>b__26_0, addr 0x653da7c, size 0x48, virtual false, abstract: false, final false
inline bool _SortedRemoveAndShift_b__26_0(::System::Collections::Generic::KeyValuePair_2<int32_t,int32_t>  x) ;

/// @brief Method .ctor, addr 0x653da78, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x653c450, size 0x64, virtual true, abstract: false, final true
inline void Add(int32_t  item) ;

/// @brief Method Clear, addr 0x653c4b4, size 0x54, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x653c508, size 0x68, virtual true, abstract: false, final true
inline bool Contains(int32_t  item) ;

/// @brief Method CopyTo, addr 0x653c570, size 0x18, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<int32_t,::Array<int32_t>*>  array, int32_t  arrayIndex) ;

/// @brief Method GetEnumerator, addr 0x653c340, size 0xa4, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<int32_t>* GetEnumerator() ;

/// @brief Method GetSharedVertexLookup, addr 0x653c63c, size 0x41c, virtual false, abstract: false, final false
...
/// @brief Method GetSharedVerticesWithPositions, addr 0x653b5c8, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x653c588, size 0x9c, virtual true, abstract: false, final true
inline bool Remove(int32_t  item) ;

/// @brief Method RemoveAndShift, addr 0x653d32c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method SetCoincident, addr 0x653d70c, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method ShiftIndexes, addr 0x653ca58, size 0x40, virtual false, abstract: false, final false
inline void ShiftIndexes(int32_t  offset) ;

/// @brief Method SortedRemoveAndShift, addr 0x653d3f8, size 0x314, virtual false, abstract: false, final false
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x653c44c, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method ToSharedVertices, addr 0x653d1c4, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method ToSharedVertices, addr 0x653ca98, size 0x72c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x653c3e4, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x653b51c, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<int32_t>*  indexes) ;

/// @brief Method .ctor, addr 0x653c22c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::SharedVertex*  sharedVertex) ;

/// @brief Method get_Count, addr 0x653c2f8, size 0x18, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x653c624, size 0x18, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Item, addr 0x652fba0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  i) ;

/// @brief Method get_arrayInternal, addr 0x653c224, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x653c310, size 0x30, virtual false, abstract: false, final false
