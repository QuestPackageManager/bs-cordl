...
public:
  ...
  /// @brief Method .ctor addr 0x29f7798 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortedRemoveAndShift>b__26_0 addr 0x29f77a0 size 0x40 virtual false final false
...
public:
  ...
  /// @brief Method get_arrayInternal addr 0x29f5f48 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29f5240 size 0xb0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29f5f50 size 0xd0 virtual false final false
  inline void _ctor(::UnityEngine::ProBuilder::SharedVertex* sharedVertex);

  /// @brief Method get_Item addr 0x29e9064 size 0x30 virtual false final false
  inline int32_t get_Item(int32_t i);

  /// @brief Method set_Item addr 0x29f603c size 0x30 virtual false final false
  inline void set_Item(int32_t i, int32_t value);

  /// @brief Method GetEnumerator addr 0x29f606c size 0xa0 virtual true final true
  inline ::System::Collections::Generic::IEnumerator_1<int32_t>* GetEnumerator();

  /// @brief Method ToString addr 0x29f610c size 0x68 virtual true final false
  inline ::StringW ToString();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29f6174 size 0x4 virtual true final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method Add addr 0x29f6178 size 0x60 virtual true final true
  inline void Add(int32_t item);

  /// @brief Method Clear addr 0x29f61d8 size 0x50 virtual true final true
  inline void Clear();

  /// @brief Method Contains addr 0x29f6228 size 0x64 virtual true final true
  inline bool Contains(int32_t item);

  /// @brief Method CopyTo addr 0x29f628c size 0x1c virtual true final true
  inline void CopyTo(::ArrayW<int32_t, ::Array<int32_t>*> array, int32_t arrayIndex);

  /// @brief Method Remove addr 0x29f62a8 size 0x94 virtual true final true
  inline bool Remove(int32_t item);

  /// @brief Method get_Count addr 0x29f6020 size 0x1c virtual true final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly addr 0x29f633c size 0x1c virtual true final true
  inline bool get_IsReadOnly();

  /// @brief Method GetSharedVertexLookup addr 0x29f6358 size 0x414 virtual false final false
  ...
  /// @brief Method ShiftIndexes addr 0x29f676c size 0x40 virtual false final false
  inline void ShiftIndexes(int32_t offset);

  /// @brief Method ToSharedVertices addr 0x29f67ac size 0x6e8 virtual false final false
  ...
  /// @brief Method ToSharedVertices addr 0x29f6e94 size 0x17c virtual false final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ToSharedVertices(::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<int32_t>*>* list);

  /// @brief Method GetSharedVerticesWithPositions addr 0x29f52f0 size 0x5d8 virtual false final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  GetSharedVerticesWithPositions(::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* positions);

  /// @brief Method RemoveAndShift addr 0x29f7010 size 0xa8 virtual false final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ...
  /// @brief Method SortedRemoveAndShift addr 0x29f70b8 size 0x350 virtual false final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ...
  /// @brief Method SetCoincident addr 0x29f7408 size 0x32c virtual false final false
