...
public:
  ...
  /// @brief Method .ctor, addr 0x2b77058, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SortedRemoveAndShift>b__26_0, addr 0x2b77060, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_arrayInternal, addr 0x2b75808, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b74b00, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b75810, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::SharedVertex* sharedVertex);

  /// @brief Method get_Item, addr 0x2b68924, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_Item(int32_t i);

  /// @brief Method set_Item, addr 0x2b758fc, size 0x30, virtual false, abstract: false, final false
  inline void set_Item(int32_t i, int32_t value);

  /// @brief Method GetEnumerator, addr 0x2b7592c, size 0xa0, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<int32_t>* GetEnumerator();

  /// @brief Method ToString, addr 0x2b759cc, size 0x68, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2b75a34, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method Add, addr 0x2b75a38, size 0x60, virtual true, abstract: false, final true
  inline void Add(int32_t item);

  /// @brief Method Clear, addr 0x2b75a98, size 0x50, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x2b75ae8, size 0x64, virtual true, abstract: false, final true
  inline bool Contains(int32_t item);

  /// @brief Method CopyTo, addr 0x2b75b4c, size 0x1c, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<int32_t, ::Array<int32_t>*> array, int32_t arrayIndex);

  /// @brief Method Remove, addr 0x2b75b68, size 0x94, virtual true, abstract: false, final true
  inline bool Remove(int32_t item);

  /// @brief Method get_Count, addr 0x2b758e0, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x2b75bfc, size 0x1c, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method GetSharedVertexLookup, addr 0x2b75c18, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method ShiftIndexes, addr 0x2b7602c, size 0x40, virtual false, abstract: false, final false
  inline void ShiftIndexes(int32_t offset);

  /// @brief Method ToSharedVertices, addr 0x2b7606c, size 0x6e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToSharedVertices, addr 0x2b76754, size 0x17c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ToSharedVertices(::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<int32_t>*>* list);

  /// @brief Method GetSharedVerticesWithPositions, addr 0x2b74bb0, size 0x5d8, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  GetSharedVerticesWithPositions(::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* positions);

  /// @brief Method RemoveAndShift, addr 0x2b768d0, size 0xa8, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ...
  /// @brief Method SortedRemoveAndShift, addr 0x2b76978, size 0x350, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::ProBuilder::SharedVertex*, ::Array<::UnityEngine::ProBuilder::SharedVertex*>*>
  ...
  /// @brief Method SetCoincident, addr 0x2b76cc8, size 0x32c, virtual false, abstract: false, final false
