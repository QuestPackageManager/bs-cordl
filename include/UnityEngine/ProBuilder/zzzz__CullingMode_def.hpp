...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::CullingMode, "UnityEngine.ProBuilder", "CullingMode");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::CullingMode) == 0x4, "Size mismatch!");
