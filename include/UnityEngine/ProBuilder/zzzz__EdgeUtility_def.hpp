...
public:
  ...
  /// @brief Method <GetSharedVertexHandleEdges>b__0, addr 0x66bc478, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66bbba4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ValidateEdge, addr 0x66bbcd4, size 0x22c, virtual false, abstract: false, final false
