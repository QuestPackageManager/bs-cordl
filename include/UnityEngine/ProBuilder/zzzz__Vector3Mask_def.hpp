...
public:
  ...
  /// @brief Method Equals, addr 0x2cc80d0, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2cc80c0, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::Vector3Mask other);

  /// @brief Method GetHashCode, addr 0x2cc8148, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2cc7c4c, size 0xec, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2cc7c44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint8_t mask);

  /// @brief Method .ctor, addr 0x2cc7c10, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 v, float_t epsilon);

  static inline ::UnityEngine::ProBuilder::Vector3Mask getStaticF_XYZ();

  /// @brief Method get_Item, addr 0x2cc7fec, size 0x60, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t i);

  /// @brief Method get_active, addr 0x2cc7d38, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_active();

  /// @brief Method get_x, addr 0x2cc7bc8, size 0x18, virtual false, abstract: false, final false
  inline float_t get_x();

  /// @brief Method get_y, addr 0x2cc7be0, size 0x18, virtual false, abstract: false, final false
  inline float_t get_y();

  /// @brief Method get_z, addr 0x2cc7bf8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseAnd, addr 0x2cc7dbc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_BitwiseOr, addr 0x2cc7db0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2cc7f74, size 0x10, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::Vector3Mask left, ::UnityEngine::ProBuilder::Vector3Mask right);

  /// @brief Method op_ExclusiveOr, addr 0x2cc7dc8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x2cc7d78, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x2cc7d54, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::UnityEngine::ProBuilder::Vector3Mask mask);

  /// @brief Method op_Inequality, addr 0x2cc7f84, size 0x68, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::Vector3Mask left, ::UnityEngine::ProBuilder::Vector3Mask right);

  /// @brief Method op_Multiply, addr 0x2cc7e08, size 0x30, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Multiply(::UnityEngine::ProBuilder::Vector3Mask mask, ::UnityEngine::Vector3 value);

  /// @brief Method op_Multiply, addr 0x2cc7dd4, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 op_Multiply(::UnityEngine::ProBuilder::Vector3Mask mask, float_t value);

  /// @brief Method op_Multiply, addr 0x2cc7e38, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x2cc804c, size 0x74, virtual false, abstract: false, final false
