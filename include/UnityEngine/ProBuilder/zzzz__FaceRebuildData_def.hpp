...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::FaceRebuildData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::FaceRebuildData*, "UnityEngine.ProBuilder", "FaceRebuildData");
...
public:
  ...
  /// @brief Method Apply, addr 0x66be264, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method Apply, addr 0x66be3f0, size 0x580, virtual false, abstract: false, final false
  ...
  /// @brief Method Offset, addr 0x66be168, size 0x8, virtual false, abstract: false, final false
  inline int32_t Offset();

  /// @brief Method ToString, addr 0x66be170, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66be970, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FaceRebuildData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FaceRebuildData(FaceRebuildData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FaceRebuildData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FaceRebuildData(FaceRebuildDataconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::FaceRebuildData) == 0x38, "Size mismatch!");
