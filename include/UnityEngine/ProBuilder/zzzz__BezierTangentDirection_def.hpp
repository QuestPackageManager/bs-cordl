...
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::BezierTangentDirection, "UnityEngine.ProBuilder", "BezierTangentDirection");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ProBuilder::BezierTangentDirection) == 0x4, "Size mismatch!");
