...
// Ctor Parameters [CppParam { name: "mesh", ty: "::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vertex", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "screenDistance", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "worldPosition", ty:
