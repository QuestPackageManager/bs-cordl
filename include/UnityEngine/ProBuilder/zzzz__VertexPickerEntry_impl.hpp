...
// Ctor Parameters [CppParam { name: "mesh", ty: "::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "vertex", ty: "int32_t",
// modifiers: "", def_value: Some("{}") }, CppParam { name: "screenDistance", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "worldPosition", ty: "::UnityEngine::Vector3",
