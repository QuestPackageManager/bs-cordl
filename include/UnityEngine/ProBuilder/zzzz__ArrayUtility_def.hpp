...
public:
// Declarations
/// @brief Method Center, addr 0x64fc7b4, size 0x18, virtual false, abstract: false, final false
inline int32_t Center() ;

/// @brief Method ToString, addr 0x64fc7cc, size 0x158, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Valid, addr 0x64fc7a0, size 0x14, virtual false, abstract: false, final false
inline bool Valid() ;

/// @brief Method .ctor, addr 0x64fc798, size 0x8, virtual false, abstract: false, final false
