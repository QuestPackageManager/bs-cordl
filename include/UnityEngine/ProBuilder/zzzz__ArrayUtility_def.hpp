...
public:
  // Declarations
  /// @brief Method Center, addr 0x656e7c0, size 0x18, virtual false, abstract: false, final false
  inline int32_t Center();

  /// @brief Method ToString, addr 0x656e7d8, size 0x158, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Valid, addr 0x656e7ac, size 0x14, virtual false, abstract: false, final false
  inline bool Valid();

  /// @brief Method .ctor, addr 0x656e7a4, size 0x8, virtual false, abstract: false, final false
