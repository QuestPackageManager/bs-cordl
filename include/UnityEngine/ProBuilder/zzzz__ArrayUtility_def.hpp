...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::ArrayUtility*);
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::ArrayUtility___c__23_1);
MARK_GEN_REF_T_PTR(::UnityEngine::ProBuilder::ArrayUtility___c__DisplayClass21_0_2);
MARK_VAL_T(::UnityEngine::ProBuilder::ArrayUtility_SearchRange);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::ArrayUtility*, "UnityEngine.ProBuilder", "ArrayUtility");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::ArrayUtility___c__23_1, "UnityEngine.ProBuilder", "ArrayUtility/<>c__23`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::ProBuilder::ArrayUtility___c__DisplayClass21_0_2, "UnityEngine.ProBuilder", "ArrayUtility/<>c__DisplayClass21_0`2");
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::ArrayUtility_SearchRange, "UnityEngine.ProBuilder", "ArrayUtility/SearchRange");
// Dependencies
namespace UnityEngine::ProBuilder {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Center, addr 0x66b325c, size 0x18, virtual false, abstract: false, final false
  inline int32_t Center();

  /// @brief Method ToString, addr 0x66b3274, size 0x158, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Valid, addr 0x66b3248, size 0x14, virtual false, abstract: false, final false
  inline bool Valid();

  /// @brief Method .ctor, addr 0x66b3240, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  template <typename T> static inline ::ArrayW<T> Fill(int32_t count, ::System::Func_2<int32_t, T>* ctor);

  /// @brief Method Fill, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  template <typename T> static inline ::ArrayW<T> Fill(T val, int32_t length);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::ProBuilder::ArrayUtility) == 0x10, "Size mismatch!");
