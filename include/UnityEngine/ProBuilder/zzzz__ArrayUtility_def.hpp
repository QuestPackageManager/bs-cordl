...
public:
  // Declarations
  /// @brief Method Center, addr 0x32a7f2c, size 0x18, virtual false, abstract: false, final false
  inline int32_t Center();

  /// @brief Method ToString, addr 0x32a7f44, size 0x1fc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Valid, addr 0x32a7f18, size 0x14, virtual false, abstract: false, final false
  inline bool Valid();

  /// @brief Method .ctor, addr 0x32a7f10, size 0x8, virtual false, abstract: false, final false
