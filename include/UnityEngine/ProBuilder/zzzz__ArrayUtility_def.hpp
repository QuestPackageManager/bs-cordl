...
namespace UnityEngine::ProBuilder {
template<typename T>
class ArrayUtility___c__23_1;
}
namespace UnityEngine::ProBuilder {
template<typename TSource,typename TKey>
class ArrayUtility___c__DisplayClass21_0_2;
}
...
public:
// Declarations
/// @brief Method Center, addr 0x6570338, size 0x18, virtual false, abstract: false, final false
inline int32_t Center() ;

/// @brief Method ToString, addr 0x6570350, size 0x158, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Valid, addr 0x6570324, size 0x14, virtual false, abstract: false, final false
inline bool Valid() ;

/// @brief Method .ctor, addr 0x657031c, size 0x8, virtual false, abstract: false, final false
...
template<typename T>
using __c__23_1 = ::UnityEngine::ProBuilder::ArrayUtility___c__23_1<T>;

template<typename TSource,typename TKey>
using __c__DisplayClass21_0_2 = ::UnityEngine::ProBuilder::ArrayUtility___c__DisplayClass21_0_2<TSource, TKey>;
