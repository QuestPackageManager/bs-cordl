...
public:
  ...
  /// @brief Method CreateEntry, addr 0x65012bc, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6500fcc, size 0x2f0, virtual false, abstract: false, final false
  inline void _ctor(::StringW log);

  /// @brief Method get_entries, addr 0x6500f54, size 0x78, virtual false, abstract: false, final false
