...
public:
  ...
  /// @brief Method CreateEntry, addr 0x47091fc, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4708f00, size 0x2fc, virtual false, abstract: false, final false
  inline void _ctor(::StringW log);

  /// @brief Method get_entries, addr 0x4708e84, size 0x7c, virtual false, abstract: false, final false
