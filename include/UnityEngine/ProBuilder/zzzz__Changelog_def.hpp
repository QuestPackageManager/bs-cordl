...
public:
  ...
  /// @brief Method CreateEntry, addr 0x6499730, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6499440, size 0x2f0, virtual false, abstract: false, final false
  inline void _ctor(::StringW log);

  /// @brief Method get_entries, addr 0x64993c8, size 0x78, virtual false, abstract: false, final false
