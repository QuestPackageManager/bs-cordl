...
public:
  ...
  /// @brief Method CreateEntry, addr 0x32ad628, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32ad31c, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::StringW log);

  /// @brief Method get_entries, addr 0x32ad2a0, size 0x7c, virtual false, abstract: false, final false
