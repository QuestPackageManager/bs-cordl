...
public:
  // Declarations
  /// @brief Method PickEdgesInRect, addr 0x66e2408, size 0x980, virtual false, abstract: false, final false
  ...
  /// @brief Method PickFace, addr 0x66e35e0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method PickFacesInRect, addr 0x66e0d8c, size 0x1034, virtual false, abstract: false, final false
  ...
  /// @brief Method PickVerticesInRect, addr 0x66dfb30, size 0x694, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectionPicker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectionPicker(SelectionPicker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectionPicker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectionPicker(SelectionPickerconst&) = delete;
