...
public:
  ...
  /// @brief Method IsSnapEnabled, addr 0x651a604, size 0x8, virtual false, abstract: false, final false
  inline bool IsSnapEnabled();

  static inline ::UnityEngine::ProBuilder::PolyShape* New_ctor();

  /// @brief Method SetControlPoints, addr 0x651a4d0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x651a60c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_controlPoints, addr 0x651a458, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Vector3>* get_controlPoints();

  /// @brief Method get_extrude, addr 0x651a530, size 0x8, virtual false, abstract: false, final false
  inline float_t get_extrude();

  /// @brief Method get_flipNormals, addr 0x651a550, size 0x8, virtual false, abstract: false, final false
  inline bool get_flipNormals();

  /// @brief Method get_mesh, addr 0x651a560, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh();

  /// @brief Method get_polyEditMode, addr 0x651a540, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::PolyShape_PolyEditMode get_polyEditMode();

  /// @brief Method set_extrude, addr 0x651a538, size 0x8, virtual false, abstract: false, final false
  inline void set_extrude(float_t value);

  /// @brief Method set_flipNormals, addr 0x651a558, size 0x8, virtual false, abstract: false, final false
  inline void set_flipNormals(bool value);

  /// @brief Method set_mesh, addr 0x651a5fc, size 0x8, virtual false, abstract: false, final false
  inline void set_mesh(::UnityEngine::ProBuilder::ProBuilderMesh* value);

  /// @brief Method set_polyEditMode, addr 0x651a548, size 0x8, virtual false, abstract: false, final false
