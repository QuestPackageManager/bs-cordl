...
public:
  ...
  /// @brief Method IsSnapEnabled, addr 0x328e384, size 0x8, virtual false, abstract: false, final false
  inline bool IsSnapEnabled();

  static inline ::UnityEngine::ProBuilder::PolyShape* New_ctor();

  /// @brief Method SetControlPoints, addr 0x328e258, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328e38c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_controlPoints, addr 0x328e1dc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Vector3>* get_controlPoints();

  /// @brief Method get_extrude, addr 0x328e2b4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_extrude();

  /// @brief Method get_flipNormals, addr 0x328e2d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_flipNormals();

  /// @brief Method get_mesh, addr 0x328e2e8, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh();

  /// @brief Method get_polyEditMode, addr 0x328e2c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::__PolyShape__PolyEditMode get_polyEditMode();

  /// @brief Method set_extrude, addr 0x328e2bc, size 0x8, virtual false, abstract: false, final false
  inline void set_extrude(float_t value);

  /// @brief Method set_flipNormals, addr 0x328e2dc, size 0xc, virtual false, abstract: false, final false
  inline void set_flipNormals(bool value);

  /// @brief Method set_mesh, addr 0x328e37c, size 0x8, virtual false, abstract: false, final false
  inline void set_mesh(::UnityEngine::ProBuilder::ProBuilderMesh* value);

  /// @brief Method set_polyEditMode, addr 0x328e2cc, size 0x8, virtual false, abstract: false, final false
