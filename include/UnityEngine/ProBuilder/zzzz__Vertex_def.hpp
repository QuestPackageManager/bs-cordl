...
public:
  ...
  /// @brief Method Add, addr 0x65b7de8, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* Add(::UnityEngine::ProBuilder::Vertex* a, ::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method Add, addr 0x65b7e64, size 0xf0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method Average, addr 0x65b97c4, size 0xbc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Divide, addr 0x65b818c, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* Divide(::UnityEngine::ProBuilder::Vertex* a, float_t value);

  /// @brief Method Divide, addr 0x65b8208, size 0x44, virtual false, abstract: false, final false
  inline void Divide(float_t value);

  /// @brief Method Equals, addr 0x65b7670, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x65b76f0, size 0x21c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ProBuilder::Vertex* other);

  /// @brief Method Equals, addr 0x65b790c, size 0x28c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ProBuilder::Vertex* other, ::UnityEngine::ProBuilder::MeshArrays mask);

  /// @brief Method GetArrays, addr 0x65b8b3c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArrays, addr 0x65b8b64, size 0x994, virtual false, abstract: false, final false
  static inline void GetArrays(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Vertex*>* vertices,
                               ::ByRef<::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*>> position, ::ByRef<::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*>> color,
                               ::ByRef<::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*>> uv0, ::ByRef<::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*>> normal,
                               ::ByRef<::ArrayW<::UnityEngine::Vector4, ::Array<::UnityEngine::Vector4>*>> tangent, ::ByRef<::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*>> uv2,
  ...
  /// @brief Method GetHashCode, addr 0x65b7b98, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasArrays, addr 0x65b75fc, size 0x10, virtual false, abstract: false, final false
  inline bool HasArrays(::UnityEngine::ProBuilder::MeshArrays attribute);

  /// @brief Method Mix, addr 0x65ba38c, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Multiply, addr 0x65b80c8, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* Multiply(::UnityEngine::ProBuilder::Vertex* a, float_t value);

  /// @brief Method Multiply, addr 0x65b8144, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x65b824c, size 0x594, virtual false, abstract: false, final false
  inline void Normalize();

  /// @brief Method SetMesh, addr 0x65b94f8, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Subtract, addr 0x65b7f58, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* Subtract(::UnityEngine::ProBuilder::Vertex* a, ::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method Subtract, addr 0x65b7fd4, size 0xf0, virtual false, abstract: false, final false
  inline void Subtract(::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method ToString, addr 0x65b87e0, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65b766c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x65b7c64, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Vertex* vertex);

  /// @brief Method get_attributes, addr 0x65b75f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::MeshArrays get_attributes();

  /// @brief Method get_color, addr 0x65b7428, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_hasColor, addr 0x65b7618, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasColor();

  /// @brief Method get_hasNormal, addr 0x65b7624, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasNormal();

  /// @brief Method get_hasPosition, addr 0x65b760c, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasPosition();

  /// @brief Method get_hasTangent, addr 0x65b7630, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasTangent();

  /// @brief Method get_hasUV0, addr 0x65b763c, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasUV0();

  /// @brief Method get_hasUV2, addr 0x65b7648, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasUV2();

  /// @brief Method get_hasUV3, addr 0x65b7654, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasUV3();

  /// @brief Method get_hasUV4, addr 0x65b7660, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasUV4();

  /// @brief Method get_normal, addr 0x65b746c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_position, addr 0x65b73f4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_tangent, addr 0x65b74b0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_tangent();

  /// @brief Method get_uv0, addr 0x65b74f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_uv0();

  /// @brief Method get_uv2, addr 0x65b7530, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_uv2();

  /// @brief Method get_uv3, addr 0x65b756c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 get_uv3();

  /// @brief Method get_uv4, addr 0x65b75b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x65b7de4, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* op_Addition(::UnityEngine::ProBuilder::Vertex* a, ::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method op_Division, addr 0x65b8188, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* op_Division(::UnityEngine::ProBuilder::Vertex* a, float_t value);

  /// @brief Method op_Equality, addr 0x65b7d88, size 0x28, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::ProBuilder::Vertex* a, ::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method op_Inequality, addr 0x65b7db0, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::ProBuilder::Vertex* a, ::UnityEngine::ProBuilder::Vertex* b);

  /// @brief Method op_Multiply, addr 0x65b80c4, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::Vertex* op_Multiply(::UnityEngine::ProBuilder::Vertex* a, float_t value);

  /// @brief Method op_Subtraction, addr 0x65b7f54, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x65b7434, size 0x18, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_hasColor, addr 0x65b744c, size 0x20, virtual false, abstract: false, final false
  inline void set_hasColor(bool value);

  /// @brief Method set_hasNormal, addr 0x65b7490, size 0x20, virtual false, abstract: false, final false
  inline void set_hasNormal(bool value);

  /// @brief Method set_hasPosition, addr 0x65b7418, size 0x10, virtual false, abstract: false, final false
  inline void set_hasPosition(bool value);

  /// @brief Method set_hasTangent, addr 0x65b74d4, size 0x20, virtual false, abstract: false, final false
  inline void set_hasTangent(bool value);

  /// @brief Method set_hasUV0, addr 0x65b7510, size 0x20, virtual false, abstract: false, final false
  inline void set_hasUV0(bool value);

  /// @brief Method set_hasUV2, addr 0x65b754c, size 0x20, virtual false, abstract: false, final false
  inline void set_hasUV2(bool value);

  /// @brief Method set_hasUV3, addr 0x65b7590, size 0x20, virtual false, abstract: false, final false
  inline void set_hasUV3(bool value);

  /// @brief Method set_hasUV4, addr 0x65b75d4, size 0x20, virtual false, abstract: false, final false
  inline void set_hasUV4(bool value);

  /// @brief Method set_normal, addr 0x65b7478, size 0x18, virtual false, abstract: false, final false
  inline void set_normal(::UnityEngine::Vector3 value);

  /// @brief Method set_position, addr 0x65b7400, size 0x18, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_tangent, addr 0x65b74bc, size 0x18, virtual false, abstract: false, final false
  inline void set_tangent(::UnityEngine::Vector4 value);

  /// @brief Method set_uv0, addr 0x65b74fc, size 0x14, virtual false, abstract: false, final false
  inline void set_uv0(::UnityEngine::Vector2 value);

  /// @brief Method set_uv2, addr 0x65b7538, size 0x14, virtual false, abstract: false, final false
  inline void set_uv2(::UnityEngine::Vector2 value);

  /// @brief Method set_uv3, addr 0x65b7578, size 0x18, virtual false, abstract: false, final false
  inline void set_uv3(::UnityEngine::Vector4 value);

  /// @brief Method set_uv4, addr 0x65b75bc, size 0x18, virtual false, abstract: false, final false
