...
public:
  ...
  /// @brief Method <CreateFaceMeshFromFaces>b__10_0, addr 0x471c6ec, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _CreateFaceMeshFromFaces_b__10_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method <CreateFaceMesh>b__9_0, addr 0x471c6d4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<int32_t>* _CreateFaceMesh_b__9_0(::UnityEngine::ProBuilder::Face* x);

  /// @brief Method .ctor, addr 0x471c6cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateEdgeBillboardMesh, addr 0x471b050, size 0x880, virtual false, abstract: false, final false
  static inline void CreateEdgeBillboardMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target);

  /// @brief Method CreateEdgeBillboardMesh, addr 0x471b8d0, size 0xc00, virtual false, abstract: false, final false
  static inline void CreateEdgeBillboardMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target,
                                             ::System::Collections::Generic::ICollection_1<::UnityEngine::ProBuilder::Edge>* edges);

  /// @brief Method CreateEdgeMesh, addr 0x471932c, size 0x3f0, virtual false, abstract: false, final false
  static inline void CreateEdgeMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target);

  /// @brief Method CreateEdgeMesh, addr 0x471971c, size 0x2c8, virtual false, abstract: false, final false
  static inline void CreateEdgeMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target,
                                    ::ArrayW<::UnityEngine::ProBuilder::Edge, ::Array<::UnityEngine::ProBuilder::Edge>*> edges);

  /// @brief Method CreateFaceMesh, addr 0x4719070, size 0x168, virtual false, abstract: false, final false
  static inline void CreateFaceMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target);

  /// @brief Method CreateFaceMeshFromFaces, addr 0x47191d8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePointBillboardMesh, addr 0x4719df0, size 0x97c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePointBillboardMesh, addr 0x471a76c, size 0x8e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePointMesh, addr 0x4719c38, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateVertexMesh, addr 0x47199e4, size 0x19c, virtual false, abstract: false, final false
  static inline void CreateVertexMesh(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, ::UnityEngine::Mesh* target);

  /// @brief Method CreateVertexMesh, addr 0x4719b80, size 0xb8, virtual false, abstract: false, final false
