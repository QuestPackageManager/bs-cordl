...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProBuilderSnapping", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProBuilderSnapping(ProBuilderSnapping&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProBuilderSnapping", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProBuilderSnapping(ProBuilderSnappingconst&) = delete;
