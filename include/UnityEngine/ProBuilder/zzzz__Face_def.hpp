...
/// @brief Method CacheDistinctIndexes, addr 0x6505d24, size 0x94, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> CacheDistinctIndexes() ;

/// @brief Method CacheEdges, addr 0x6505e54, size 0x3a0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ProBuilder::Edge,::Array<::UnityEngine::ProBuilder::Edge>*> CacheEdges() ;

/// @brief Method Contains, addr 0x65065fc, size 0x94, virtual false, abstract: false, final false
inline bool Contains(int32_t  a, int32_t  b, int32_t  c) ;

/// @brief Method CopyFrom, addr 0x65064cc, size 0x130, virtual false, abstract: false, final false
inline void CopyFrom(::UnityEngine::ProBuilder::Face*  other) ;

/// @brief Method GetDistinctIndices, addr 0x6507178, size 0x3cc, virtual false, abstract: false, final false
...
/// @brief Method GetIndices, addr 0x6506dcc, size 0x3ac, virtual false, abstract: false, final false
...
/// @brief Method InvalidateCache, addr 0x6505b94, size 0x8, virtual false, abstract: false, final false
inline void InvalidateCache() ;

/// @brief Method IsQuad, addr 0x6506690, size 0x48, virtual false, abstract: false, final false
inline bool IsQuad() ;
...
/// @brief Method Reverse, addr 0x6506d78, size 0x54, virtual false, abstract: false, final false
inline void Reverse() ;

/// @brief Method SetIndexes, addr 0x6505c14, size 0x110, virtual false, abstract: false, final false
inline void SetIndexes(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method ShiftIndexes, addr 0x6506c88, size 0x44, virtual false, abstract: false, final false
inline void ShiftIndexes(int32_t  offset) ;

/// @brief Method ShiftIndexesToZero, addr 0x6506d1c, size 0x5c, virtual false, abstract: false, final false
inline void ShiftIndexesToZero() ;

/// @brief Method SmallestIndexValue, addr 0x6506ccc, size 0x50, virtual false, abstract: false, final false
inline int32_t SmallestIndexValue() ;

/// @brief Method ToQuad, addr 0x65066d8, size 0x3cc, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> ToQuad() ;

/// @brief Method ToString, addr 0x6506aa4, size 0x1e4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetNextEdge, addr 0x6507544, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6506310, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6506318, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method .ctor, addr 0x65064c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::Face*  other) ;

/// @brief Method .ctor, addr 0x65063b4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6506440, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x65062e0, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  i) ;

/// @brief Method get_distinctIndexes, addr 0x6505db8, size 0x9c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_distinctIndexes() ;

/// @brief Method get_distinctIndexesInternal, addr 0x6505458, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_distinctIndexesInternal() ;

/// @brief Method get_edges, addr 0x65061f4, size 0x9c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::ProBuilder::Edge>* get_edges() ;

/// @brief Method get_edgesInternal, addr 0x65059bc, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ProBuilder::Edge,::Array<::UnityEngine::ProBuilder::Edge>*> get_edgesInternal() ;

/// @brief Method get_indexes, addr 0x6505b9c, size 0x78, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_indexes() ;

/// @brief Method get_indexesInternal, addr 0x6505ad0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_indexesInternal() ;

/// @brief Method get_manualUV, addr 0x6505ab0, size 0x8, virtual false, abstract: false, final false
inline bool get_manualUV() ;

/// @brief Method get_material, addr 0x65062a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_smoothingGroup, addr 0x6506290, size 0x8, virtual false, abstract: false, final false
inline int32_t get_smoothingGroup() ;

/// @brief Method get_submeshIndex, addr 0x65062b0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_submeshIndex() ;

/// @brief Method get_textureGroup, addr 0x6505ac0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_textureGroup() ;

/// @brief Method get_uv, addr 0x65062c0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::AutoUnwrapSettings get_uv() ;

/// @brief Method set_indexesInternal, addr 0x6505ad8, size 0xbc, virtual false, abstract: false, final false
inline void set_indexesInternal(::ArrayW<int32_t,::Array<int32_t>*>  value) ;

/// @brief Method set_manualUV, addr 0x6505ab8, size 0x8, virtual false, abstract: false, final false
inline void set_manualUV(bool  value) ;

/// @brief Method set_material, addr 0x65062a8, size 0x8, virtual false, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_smoothingGroup, addr 0x6506298, size 0x8, virtual false, abstract: false, final false
inline void set_smoothingGroup(int32_t  value) ;

/// @brief Method set_submeshIndex, addr 0x65062b8, size 0x8, virtual false, abstract: false, final false
inline void set_submeshIndex(int32_t  value) ;

/// @brief Method set_textureGroup, addr 0x6505ac8, size 0x8, virtual false, abstract: false, final false
inline void set_textureGroup(int32_t  value) ;

/// @brief Method set_uv, addr 0x65062d0, size 0x10, virtual false, abstract: false, final false
