...
namespace UnityEngine::ProBuilder {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12028)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method get_manualUV addr 0x29be344 size 0x8 virtual false final false
  inline bool get_manualUV();

  /// @brief Method set_manualUV addr 0x29be34c size 0xc virtual false final false
  inline void set_manualUV(bool value);

  /// @brief Method get_textureGroup addr 0x29be358 size 0x8 virtual false final false
  inline int32_t get_textureGroup();

  /// @brief Method set_textureGroup addr 0x29be360 size 0x8 virtual false final false
  inline void set_textureGroup(int32_t value);

  /// @brief Method get_indexesInternal addr 0x29be368 size 0x8 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_indexesInternal();

  /// @brief Method set_indexesInternal addr 0x29be370 size 0xc8 virtual false final false
  inline void set_indexesInternal(::ArrayW<int32_t, ::Array<int32_t>*> value);

  /// @brief Method get_indexes addr 0x29be440 size 0x7c virtual false final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_indexes();

  /// @brief Method SetIndexes addr 0x29be4bc size 0x110 virtual false final false
  inline void SetIndexes(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method get_distinctIndexesInternal addr 0x29bddec size 0x14 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_distinctIndexesInternal();

  /// @brief Method get_distinctIndexes addr 0x29be640 size 0x8c virtual false final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_distinctIndexes();

  /// @brief Method get_edgesInternal addr 0x29be248 size 0x14 virtual false final false
  inline ::ArrayW<::UnityEngine::ProBuilder::Edge, ::Array<::UnityEngine::ProBuilder::Edge>*> get_edgesInternal();

  /// @brief Method get_edges addr 0x29be9cc size 0x8c virtual false final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::ProBuilder::Edge>* get_edges();

  /// @brief Method get_smoothingGroup addr 0x29bea58 size 0x8 virtual false final false
  inline int32_t get_smoothingGroup();

  /// @brief Method set_smoothingGroup addr 0x29bea60 size 0x8 virtual false final false
  inline void set_smoothingGroup(int32_t value);

  /// @brief Method get_material addr 0x29bea68 size 0x8 virtual false final false
  inline ::UnityEngine::Material* get_material();

  /// @brief Method set_material addr 0x29bea70 size 0x8 virtual false final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method get_submeshIndex addr 0x29bea78 size 0x8 virtual false final false
  inline int32_t get_submeshIndex();

  /// @brief Method set_submeshIndex addr 0x29bea80 size 0x8 virtual false final false
  inline void set_submeshIndex(int32_t value);

  /// @brief Method get_uv addr 0x29bea88 size 0x10 virtual false final false
  inline ::UnityEngine::ProBuilder::AutoUnwrapSettings get_uv();

  /// @brief Method set_uv addr 0x29bea98 size 0x10 virtual false final false
  inline void set_uv(::UnityEngine::ProBuilder::AutoUnwrapSettings value);

  /// @brief Method get_Item addr 0x29beaa8 size 0x30 virtual false final false
  inline int32_t get_Item(int32_t i);

  static inline ::UnityEngine::ProBuilder::Face* New_ctor();

  /// @brief Method .ctor addr 0x29bead8 size 0x1c virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::ProBuilder::Face* New_ctor(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method .ctor addr 0x29beaf4 size 0xa4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29beb98 size 0xc0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29bec58 size 0xbc virtual false final false
  ...
  /// @brief Method .ctor addr 0x29bed14 size 0x2c virtual false final false
  inline void _ctor(::UnityEngine::ProBuilder::Face* other);

  /// @brief Method CopyFrom addr 0x29bed40 size 0x13c virtual false final false
  inline void CopyFrom(::UnityEngine::ProBuilder::Face* other);

  /// @brief Method InvalidateCache addr 0x29be438 size 0x8 virtual false final false
  inline void InvalidateCache();

  /// @brief Method CacheEdges addr 0x29be6cc size 0x300 virtual false final false
  inline ::ArrayW<::UnityEngine::ProBuilder::Edge, ::Array<::UnityEngine::ProBuilder::Edge>*> CacheEdges();

  /// @brief Method CacheDistinctIndexes addr 0x29be5cc size 0x74 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> CacheDistinctIndexes();

  /// @brief Method Contains addr 0x29bee7c size 0x94 virtual false final false
  inline bool Contains(int32_t a, int32_t b, int32_t c);

  /// @brief Method IsQuad addr 0x29bef10 size 0x48 virtual false final false
  inline bool IsQuad();

  /// @brief Method ToQuad addr 0x29bef58 size 0x384 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> ToQuad();

  /// @brief Method ToString addr 0x29bf2dc size 0x1cc virtual true final false
  inline ::StringW ToString();

  /// @brief Method ShiftIndexes addr 0x29bf4a8 size 0x44 virtual false final false
  inline void ShiftIndexes(int32_t offset);

  /// @brief Method SmallestIndexValue addr 0x29bf4ec size 0x50 virtual false final false
  inline int32_t SmallestIndexValue();

  /// @brief Method ShiftIndexesToZero addr 0x29bf53c size 0x64 virtual false final false
  inline void ShiftIndexesToZero();

  /// @brief Method Reverse addr 0x29bf5a0 size 0x50 virtual false final false
  inline void Reverse();

  /// @brief Method GetIndices addr 0x29bf5f0 size 0x3c4 virtual false final false
  ...
  /// @brief Method GetDistinctIndices addr 0x29bf9b4 size 0x3ec virtual false final false
  ...
  /// @brief Method TryGetNextEdge addr 0x29bfda0 size 0x16c virtual false final false
