...
public:
  ...
  /// @brief Method CacheDistinctIndexes, addr 0x6577d30, size 0x94, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> CacheDistinctIndexes();

  /// @brief Method CacheEdges, addr 0x6577e60, size 0x3a0, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::ProBuilder::Edge, ::Array<::UnityEngine::ProBuilder::Edge>*> CacheEdges();

  /// @brief Method Contains, addr 0x6578608, size 0x94, virtual false, abstract: false, final false
  inline bool Contains(int32_t a, int32_t b, int32_t c);

  /// @brief Method CopyFrom, addr 0x65784d8, size 0x130, virtual false, abstract: false, final false
  inline void CopyFrom(::UnityEngine::ProBuilder::Face* other);

  /// @brief Method GetDistinctIndices, addr 0x6579184, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIndices, addr 0x6578dd8, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method InvalidateCache, addr 0x6577ba0, size 0x8, virtual false, abstract: false, final false
  inline void InvalidateCache();

  /// @brief Method IsQuad, addr 0x657869c, size 0x48, virtual false, abstract: false, final false
  inline bool IsQuad();
  ...
  /// @brief Method Reverse, addr 0x6578d84, size 0x54, virtual false, abstract: false, final false
  inline void Reverse();

  /// @brief Method SetIndexes, addr 0x6577c20, size 0x110, virtual false, abstract: false, final false
  inline void SetIndexes(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method ShiftIndexes, addr 0x6578c94, size 0x44, virtual false, abstract: false, final false
  inline void ShiftIndexes(int32_t offset);

  /// @brief Method ShiftIndexesToZero, addr 0x6578d28, size 0x5c, virtual false, abstract: false, final false
  inline void ShiftIndexesToZero();

  /// @brief Method SmallestIndexValue, addr 0x6578cd8, size 0x50, virtual false, abstract: false, final false
  inline int32_t SmallestIndexValue();

  /// @brief Method ToQuad, addr 0x65786e4, size 0x3cc, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> ToQuad();

  /// @brief Method ToString, addr 0x6578ab0, size 0x1e4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetNextEdge, addr 0x6579550, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x657831c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6578324, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method .ctor, addr 0x65784d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Face* other);

  /// @brief Method .ctor, addr 0x65783c0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x657844c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Item, addr 0x65782ec, size 0x30, virtual false, abstract: false, final false
  inline int32_t get_Item(int32_t i);

  /// @brief Method get_distinctIndexes, addr 0x6577dc4, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_distinctIndexes();

  /// @brief Method get_distinctIndexesInternal, addr 0x6577464, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_distinctIndexesInternal();

  /// @brief Method get_edges, addr 0x6578200, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::ProBuilder::Edge>* get_edges();

  /// @brief Method get_edgesInternal, addr 0x65779c8, size 0x14, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::ProBuilder::Edge, ::Array<::UnityEngine::ProBuilder::Edge>*> get_edgesInternal();

  /// @brief Method get_indexes, addr 0x6577ba8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_indexes();

  /// @brief Method get_indexesInternal, addr 0x6577adc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_indexesInternal();

  /// @brief Method get_manualUV, addr 0x6577abc, size 0x8, virtual false, abstract: false, final false
  inline bool get_manualUV();

  /// @brief Method get_material, addr 0x65782ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_smoothingGroup, addr 0x657829c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_smoothingGroup();

  /// @brief Method get_submeshIndex, addr 0x65782bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_submeshIndex();

  /// @brief Method get_textureGroup, addr 0x6577acc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_textureGroup();

  /// @brief Method get_uv, addr 0x65782cc, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::AutoUnwrapSettings get_uv();

  /// @brief Method set_indexesInternal, addr 0x6577ae4, size 0xbc, virtual false, abstract: false, final false
  inline void set_indexesInternal(::ArrayW<int32_t, ::Array<int32_t>*> value);

  /// @brief Method set_manualUV, addr 0x6577ac4, size 0x8, virtual false, abstract: false, final false
  inline void set_manualUV(bool value);

  /// @brief Method set_material, addr 0x65782b4, size 0x8, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_smoothingGroup, addr 0x65782a4, size 0x8, virtual false, abstract: false, final false
  inline void set_smoothingGroup(int32_t value);

  /// @brief Method set_submeshIndex, addr 0x65782c4, size 0x8, virtual false, abstract: false, final false
  inline void set_submeshIndex(int32_t value);

  /// @brief Method set_textureGroup, addr 0x6577ad4, size 0x8, virtual false, abstract: false, final false
  inline void set_textureGroup(int32_t value);

  /// @brief Method set_uv, addr 0x65782dc, size 0x10, virtual false, abstract: false, final false
