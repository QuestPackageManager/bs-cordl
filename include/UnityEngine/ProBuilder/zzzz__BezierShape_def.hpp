...
public:
  ...
  /// @brief Method Init, addr 0x47027fc, size 0x254, virtual false, abstract: false, final false
  inline void Init();

  static inline ::UnityEngine::ProBuilder::BezierShape* New_ctor();

  /// @brief Method Refresh, addr 0x4702a50, size 0xbc, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x4702b0c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isEditing, addr 0x470274c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEditing();

  /// @brief Method get_mesh, addr 0x4702760, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh();

  /// @brief Method set_isEditing, addr 0x4702754, size 0xc, virtual false, abstract: false, final false
  inline void set_isEditing(bool value);

  /// @brief Method set_mesh, addr 0x47027f4, size 0x8, virtual false, abstract: false, final false
