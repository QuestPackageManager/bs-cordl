...
public:
  // Declarations
  /// @brief Method ScreenToGuiPoint, addr 0x2b413bc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycast, addr 0x2b4140c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycast, addr 0x2b4144c, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycastBothCullModes, addr 0x2b41c44, size 0x4ac, virtual false, abstract: false, final false
  ...
  /// @brief Method FaceRaycast, addr 0x2b420f0, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method InverseTransformRay, addr 0x2b42638, size 0x138, virtual false, abstract: false, final false
  static inline ::UnityEngine::Ray InverseTransformRay(::UnityEngine::Transform* transform, ::UnityEngine::Ray InWorldRay);

  /// @brief Method MeshRaycast, addr 0x2b42770, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method MeshRaycast, addr 0x2b428f8, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method PointIsOccluded, addr 0x2b42de8, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRotation, addr 0x2b42ff8, size 0x6b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFaceRotation, addr 0x2b436b0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFaceRotation, addr 0x2b437c0, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeRotation, addr 0x2b43e14, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEdgeRotation, addr 0x2b43f24, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertexRotation, addr 0x2b43fe8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertexRotation, addr 0x2b440f0, size 0x114, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion GetVertexRotation(::UnityEngine::ProBuilder::ProBuilderMesh* mesh, int32_t vertex);

  /// @brief Method GetActiveElementPosition, addr 0x2b44204, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetActiveElementPosition(::UnityEngine::ProBuilder::ProBuilderMesh* mesh,
                                                                ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Face*>* faces);

  /// @brief Method GetActiveElementPosition, addr 0x2b448a4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetActiveElementPosition, addr 0x2b449b0, size 0xa8, virtual false, abstract: false, final false
