...
public:
  ...
  /// @brief Method UniformDistribution, addr 0x46fe95c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method UniformGrid, addr 0x46feb1c, size 0x18c, virtual false, abstract: false, final false
