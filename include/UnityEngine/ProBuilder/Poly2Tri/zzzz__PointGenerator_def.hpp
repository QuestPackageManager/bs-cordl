...
public:
  ...
  /// @brief Method UniformDistribution, addr 0x656d71c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method UniformGrid, addr 0x656d8e8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656da74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
