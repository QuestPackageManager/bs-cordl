...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PointGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PointGenerator(PointGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PointGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PointGenerator(PointGeneratorconst&) = delete;
