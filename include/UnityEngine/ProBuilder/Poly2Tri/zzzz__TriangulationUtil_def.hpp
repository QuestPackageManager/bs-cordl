...
public:
  ...
  /// @brief Method InScanArea, addr 0x46fcab0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Orient2d, addr 0x46fb1d8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method SmartIncircle, addr 0x46fd388, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x46fe8fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
