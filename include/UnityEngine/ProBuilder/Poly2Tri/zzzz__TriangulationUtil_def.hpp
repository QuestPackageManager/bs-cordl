...
public:
  ...
  /// @brief Method InScanArea, addr 0x64f91c4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Orient2d, addr 0x64f77d8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SmartIncircle, addr 0x64f9ab0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64faff0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
