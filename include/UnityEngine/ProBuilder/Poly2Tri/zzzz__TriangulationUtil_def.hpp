...
/// @brief Method InScanArea, addr 0x656d408, size 0x78, virtual false, abstract: false, final false
static inline bool InScanArea(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pa, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pb, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pc, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pd) ;

static inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationUtil* New_ctor() ;

/// @brief Method Orient2d, addr 0x656ba1c, size 0xec, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::Poly2Tri::Orientation Orient2d(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pa, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pb, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pc) ;

/// @brief Method SmartIncircle, addr 0x656dcf4, size 0xc4, virtual false, abstract: false, final false
static inline bool SmartIncircle(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pa, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pb, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pc, ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  pd) ;

/// @brief Method .ctor, addr 0x656f234, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
