...
public:
  ...
  /// @brief Method InScanArea, addr 0x656b890, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Orient2d, addr 0x6569ea4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SmartIncircle, addr 0x656c17c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656d6bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
