...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::TriangulationUtil*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::TriangulationUtil*, "UnityEngine.ProBuilder.Poly2Tri", "TriangulationUtil");
...
public:
  ...
  /// @brief Method InScanArea, addr 0x66aab14, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Orient2d, addr 0x66a9128, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SmartIncircle, addr 0x66ab400, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ac940, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::TriangulationUtil) == 0x10, "Size mismatch!");
