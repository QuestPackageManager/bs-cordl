...
public:
  ...
  /// @brief Method InScanArea, addr 0x46fe2d4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Orient2d, addr 0x46fc9fc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method SmartIncircle, addr 0x46febac, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4700120, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
