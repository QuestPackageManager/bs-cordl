...
public:
  ...
  /// @brief Method Clear, addr 0x4702268, size 0x44, virtual true, abstract: false, final false
  inline void Clear();
  ...
  /// @brief Method .ctor, addr 0x4701b6c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method get_ActiveConstraint, addr 0x4702230, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* get_ActiveConstraint();

  /// @brief Method get_ActiveNode, addr 0x4702228, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* get_ActiveNode();

  /// @brief Method get_ActivePoint, addr 0x47021d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* get_ActivePoint();

  /// @brief Method get_IsDebugContext, addr 0x4702260, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDebugContext();

  /// @brief Method get_PrimaryTriangle, addr 0x47021c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* get_PrimaryTriangle();

  /// @brief Method get_SecondaryTriangle, addr 0x47021cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* get_SecondaryTriangle();

  /// @brief Method set_ActiveConstraint, addr 0x46febec, size 0x4c, virtual false, abstract: false, final false
  inline void set_ActiveConstraint(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* value);

  /// @brief Method set_ActiveNode, addr 0x46ff608, size 0x4c, virtual false, abstract: false, final false
  inline void set_ActiveNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* value);

  /// @brief Method set_ActivePoint, addr 0x47021dc, size 0x4c, virtual false, abstract: false, final false
  inline void set_ActivePoint(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* value);

  /// @brief Method set_PrimaryTriangle, addr 0x46ffdf4, size 0x4c, virtual false, abstract: false, final false
  inline void set_PrimaryTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* value);

  /// @brief Method set_SecondaryTriangle, addr 0x4700ee0, size 0x4c, virtual false, abstract: false, final false
