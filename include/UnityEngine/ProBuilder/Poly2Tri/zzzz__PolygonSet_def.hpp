...
public:
  ...
  /// @brief Method Add, addr 0x326872c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32685ac, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3268628, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::Polygon* poly);

  /// @brief Method get_Polygons, addr 0x32687d4, size 0x8, virtual false, abstract: false, final false
