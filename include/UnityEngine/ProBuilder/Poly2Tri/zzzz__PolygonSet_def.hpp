...
public:
  ...
  /// @brief Method Add, addr 0x64f4e08, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64f4c98, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x64f4d0c, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::Polygon* poly);

  /// @brief Method get_Polygons, addr 0x64f4ebc, size 0x8, virtual false, abstract: false, final false
