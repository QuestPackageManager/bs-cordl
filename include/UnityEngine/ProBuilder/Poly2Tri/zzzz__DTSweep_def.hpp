...
public:
  ...
  /// @brief Method .ctor addr 0x29b1b9c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SplitEdge>b__0 addr 0x29b25f8 size 0x38 virtual false final false
...
public:
  ...
  /// @brief Method Triangulate addr 0x29ac0b4 size 0x4c virtual false final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method Sweep addr 0x29af220 size 0x218 virtual false final false
  static inline void Sweep(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method FinalizationConvexHull addr 0x29af4e0 size 0x280 virtual false final false
  static inline void FinalizationConvexHull(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method TurnAdvancingFrontConvex addr 0x29afadc size 0x16c virtual false final false
  ...
  /// @brief Method FinalizationPolygon addr 0x29af438 size 0xa8 virtual false final false
  static inline void FinalizationPolygon(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method PointEvent addr 0x29af770 size 0x10c virtual false final false
  ...
  /// @brief Method NewFrontTriangle addr 0x29b05f8 size 0x1a4 virtual false final false
  ...
  /// @brief Method EdgeEvent addr 0x29af954 size 0x184 virtual false final false
  ...
  /// @brief Method FillEdgeEvent addr 0x29b0c28 size 0x2c virtual false final false
  ...
  /// @brief Method FillRightConcaveEdgeEvent addr 0x29b1048 size 0xfc virtual false final false
  ...
  /// @brief Method FillRightConvexEdgeEvent addr 0x29b1144 size 0x120 virtual false final false
  ...
  /// @brief Method FillRightBelowEdgeEvent addr 0x29b1264 size 0x12c virtual false final false
  ...
  /// @brief Method FillRightAboveEdgeEvent addr 0x29b0e34 size 0x10c virtual false final false
  ...
  /// @brief Method FillLeftConvexEdgeEvent addr 0x29b1390 size 0x118 virtual false final false
  ...
  /// @brief Method FillLeftConcaveEdgeEvent addr 0x29b14a8 size 0xf4 virtual false final false
  ...
  /// @brief Method FillLeftBelowEdgeEvent addr 0x29b159c size 0x128 virtual false final false
  ...
  /// @brief Method FillLeftAboveEdgeEvent addr 0x29b0f40 size 0x108 virtual false final false
  ...
  /// @brief Method IsEdgeSideOfTriangle addr 0x29b0b68 size 0xc0 virtual false final false
  ...
  /// @brief Method EdgeEvent addr 0x29b0c54 size 0x1e0 virtual false final false
  ...
  /// @brief Method SplitEdge addr 0x29b1a84 size 0x118 virtual false final false
  ...
  /// @brief Method FlipEdgeEvent addr 0x29b1700 size 0x384 virtual false final false
  ...
  /// @brief Method NextFlipPoint addr 0x29b1d4c size 0x160 virtual false final false
  ...
  /// @brief Method NextFlipTriangle addr 0x29b1cd8 size 0x74 virtual false final false
  ...
  /// @brief Method FlipScanEdgeEvent addr 0x29b1eac size 0x1a0 virtual false final false
  ...
  /// @brief Method FillAdvancingFront addr 0x29b07b4 size 0xf8 virtual false final false
  ...
  /// @brief Method FillBasin addr 0x29b21b8 size 0x190 virtual false final false
  ...
  /// @brief Method FillBasinReq addr 0x29b2348 size 0x170 virtual false final false
  ...
  /// @brief Method IsShallow addr 0x29b24b8 size 0x64 virtual false final false
  ...
  /// @brief Method HoleAngle addr 0x29b2058 size 0xc4 virtual false final false
  static inline double_t HoleAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method BasinAngle addr 0x29b211c size 0x9c virtual false final false
  static inline double_t BasinAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method Fill addr 0x29b0458 size 0x17c virtual false final false
  ...
  /// @brief Method Legalize addr 0x29b08ac size 0x270 virtual false final false
  ...
  /// @brief Method RotateTrianglePair addr 0x29afc48 size 0x4b8 virtual false final false
