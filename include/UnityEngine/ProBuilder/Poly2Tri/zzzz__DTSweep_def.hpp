...
public:
  ...
  /// @brief Method .ctor, addr 0x2b3245c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SplitEdge>b__0, addr 0x2b32eb8, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Triangulate, addr 0x2b2c974, size 0x4c, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method Sweep, addr 0x2b2fae0, size 0x218, virtual false, abstract: false, final false
  static inline void Sweep(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method FinalizationConvexHull, addr 0x2b2fda0, size 0x280, virtual false, abstract: false, final false
  static inline void FinalizationConvexHull(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method TurnAdvancingFrontConvex, addr 0x2b3039c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalizationPolygon, addr 0x2b2fcf8, size 0xa8, virtual false, abstract: false, final false
  static inline void FinalizationPolygon(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext* tcx);

  /// @brief Method PointEvent, addr 0x2b30030, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method NewFrontTriangle, addr 0x2b30eb8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method EdgeEvent, addr 0x2b30214, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method FillEdgeEvent, addr 0x2b314e8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightConcaveEdgeEvent, addr 0x2b31908, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightConvexEdgeEvent, addr 0x2b31a04, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightBelowEdgeEvent, addr 0x2b31b24, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillRightAboveEdgeEvent, addr 0x2b316f4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftConvexEdgeEvent, addr 0x2b31c50, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftConcaveEdgeEvent, addr 0x2b31d68, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftBelowEdgeEvent, addr 0x2b31e5c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method FillLeftAboveEdgeEvent, addr 0x2b31800, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEdgeSideOfTriangle, addr 0x2b31428, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method EdgeEvent, addr 0x2b31514, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitEdge, addr 0x2b32344, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipEdgeEvent, addr 0x2b31fc0, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method NextFlipPoint, addr 0x2b3260c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method NextFlipTriangle, addr 0x2b32598, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipScanEdgeEvent, addr 0x2b3276c, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method FillAdvancingFront, addr 0x2b31074, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method FillBasin, addr 0x2b32a78, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method FillBasinReq, addr 0x2b32c08, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method IsShallow, addr 0x2b32d78, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method HoleAngle, addr 0x2b32918, size 0xc4, virtual false, abstract: false, final false
  static inline double_t HoleAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method BasinAngle, addr 0x2b329dc, size 0x9c, virtual false, abstract: false, final false
  static inline double_t BasinAngle(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method Fill, addr 0x2b30d18, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Legalize, addr 0x2b3116c, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateTrianglePair, addr 0x2b30508, size 0x4b8, virtual false, abstract: false, final false
