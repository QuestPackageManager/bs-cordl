...
public:
  ...
  /// @brief Method AddTriangle, addr 0x66ac304, size 0xb8, virtual true, abstract: false, final true
  inline void AddTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method AddTriangles, addr 0x66ac3bc, size 0x334, virtual true, abstract: false, final true
  inline void AddTriangles(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* list);

  /// @brief Method ClearTriangles, addr 0x66ac6f0, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method Prepare, addr 0x66ac114, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66abee0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* points);

  /// @brief Method get_Points, addr 0x66ac2dc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* get_Points();

  /// @brief Method get_Triangles, addr 0x66ac2ec, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* get_Triangles();

  /// @brief Method get_TriangulationMode, addr 0x66ac2fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Points, addr 0x66ac2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_Points(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* value);

  /// @brief Method set_Triangles, addr 0x66ac2f4, size 0x8, virtual false, abstract: false, final false
