...
public:
  ...
  /// @brief Method Clear, addr 0x656c68c, size 0x88, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method Done, addr 0x656928c, size 0x10, virtual false, abstract: false, final false
  inline void Done();
  ...
  /// @brief Method PrepareTriangulation, addr 0x656c974, size 0x114, virtual true, abstract: false, final false
  inline void PrepareTriangulation(::UnityEngine::ProBuilder::Poly2Tri::Triangulatable* t);

  /// @brief Method Update, addr 0x6569618, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x656c3a8, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_DTDebugContext, addr 0x65693bc, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::DTSweepDebugContext* get_DTDebugContext();

  /// @brief Method get_DebugContext, addr 0x656d514, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext* get_DebugContext();

  /// @brief Method get_IsDebugEnabled, addr 0x656d554, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsDebugEnabled();

  /// @brief Method get_StepCount, addr 0x656d544, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_StepCount();

  /// @brief Method get_Triangulatable, addr 0x656d534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::Triangulatable* get_Triangulatable();

  /// @brief Method get_TriangulationMode, addr 0x656d524, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationMode get_TriangulationMode();

  /// @brief Method set_DebugContext, addr 0x656d51c, size 0x8, virtual false, abstract: false, final false
  inline void set_DebugContext(::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext* value);

  /// @brief Method set_IsDebugEnabled, addr 0x656d55c, size 0x8, virtual true, abstract: false, final false
  inline void set_IsDebugEnabled(bool value);

  /// @brief Method set_StepCount, addr 0x656d54c, size 0x8, virtual false, abstract: false, final false
  inline void set_StepCount(int32_t value);

  /// @brief Method set_Triangulatable, addr 0x656d53c, size 0x8, virtual false, abstract: false, final false
  inline void set_Triangulatable(::UnityEngine::ProBuilder::Poly2Tri::Triangulatable* value);

  /// @brief Method set_TriangulationMode, addr 0x656d52c, size 0x8, virtual false, abstract: false, final false
