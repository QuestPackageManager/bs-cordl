...
/// @brief Method AddNode, addr 0x64f831c, size 0x14, virtual false, abstract: false, final false
inline void AddNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode*  node) ;

/// @brief Method Clear, addr 0x64fa600, size 0x80, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateAdvancingFront, addr 0x64f6b6c, size 0x21c, virtual false, abstract: false, final false
inline void CreateAdvancingFront() ;

/// @brief Method FinalizeTriangulation, addr 0x64f7d40, size 0xfc, virtual false, abstract: false, final false
inline void FinalizeTriangulation() ;

/// @brief Method LocateNode, addr 0x64f812c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method MapTriangleToNodes, addr 0x64f7c08, size 0xd4, virtual false, abstract: false, final false
inline void MapTriangleToNodes(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  t) ;

/// @brief Method MeshClean, addr 0x64f8128, size 0x4, virtual false, abstract: false, final false
inline void MeshClean(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  triangle) ;

/// @brief Method MeshCleanReq, addr 0x64fa4dc, size 0x124, virtual false, abstract: false, final false
inline void MeshCleanReq(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  triangle) ;

/// @brief Method NewConstraint, addr 0x64faa7c, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method PrepareTriangulation, addr 0x64fa708, size 0x260, virtual true, abstract: false, final false
inline void PrepareTriangulation(::UnityEngine::ProBuilder::Poly2Tri::Triangulatable*  t) ;

/// @brief Method RemoveFromList, addr 0x64f7cdc, size 0x64, virtual false, abstract: false, final false
inline void RemoveFromList(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  triangle) ;

/// @brief Method RemoveNode, addr 0x64fa15c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x64f3e34, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Algorithm, addr 0x64faae8, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationAlgorithm get_Algorithm() ;

/// @brief Method get_Head, addr 0x64fa374, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* get_Head() ;

/// @brief Method get_IsDebugEnabled, addr 0x64fa458, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDebugEnabled() ;

/// @brief Method get_Tail, addr 0x64fa384, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* get_Tail() ;

/// @brief Method set_Head, addr 0x64fa37c, size 0x8, virtual false, abstract: false, final false
inline void set_Head(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  value) ;

/// @brief Method set_IsDebugEnabled, addr 0x64fa460, size 0x74, virtual true, abstract: false, final false
inline void set_IsDebugEnabled(bool  value) ;

/// @brief Method set_Tail, addr 0x64fa38c, size 0x8, virtual false, abstract: false, final false
