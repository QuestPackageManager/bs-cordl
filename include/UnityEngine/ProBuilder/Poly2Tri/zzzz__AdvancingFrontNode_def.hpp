...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode*, "UnityEngine.ProBuilder.Poly2Tri", "AdvancingFrontNode");
...
public:
  ...
  AdvancingFrontNode(AdvancingFrontNodeconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode) == 0x38, "Size mismatch!");
