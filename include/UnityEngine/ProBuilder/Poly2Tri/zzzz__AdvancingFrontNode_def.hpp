...
public:
  ...
  /// @brief Method .ctor, addr 0x648e8e4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* point);

  /// @brief Method get_HasNext, addr 0x648e900, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasNext();

  /// @brief Method get_HasPrev, addr 0x648e910, size 0x10, virtual false, abstract: false, final false
