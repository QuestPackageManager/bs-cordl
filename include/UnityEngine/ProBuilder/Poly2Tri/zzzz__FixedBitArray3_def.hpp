...
public:
  ...
  /// @brief Method Clear, addr 0x64f95b0, size 0xc, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Clear, addr 0x64fbac4, size 0x50, virtual false, abstract: false, final false
  inline void Clear(bool value);

  /// @brief Method Contains, addr 0x64fba04, size 0x74, virtual false, abstract: false, final false
  inline bool Contains(bool value);

  /// @brief Method Enumerate, addr 0x64fbb14, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<bool>* Enumerate();

  /// @brief Method GetEnumerator, addr 0x64fbbb0, size 0xac, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<bool>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x64fba78, size 0x4c, virtual false, abstract: false, final false
  inline int32_t IndexOf(bool value);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x64fbc5c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method get_Item, addr 0x64f5a24, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x64f5d54, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x64fbc64, size 0x74, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::ProBuilder::Poly2Tri::FixedBitArray3__Enumerate_d__10* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<System.Boolean>.GetEnumerator, addr 0x64fbd3c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Boolean>.get_Current, addr 0x64fbcd8, size 0x8, virtual true, abstract: false, final true
  inline bool System_Collections_Generic_IEnumerator_System_Boolean__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x64fbddc, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x64fbce0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x64fbd18, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x64fbc60, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x64fbb90, size 0x20, virtual false, abstract: false, final false
