...
public:
  ...
  /// @brief Method CreateContext, addr 0x6565c50, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Triangulate, addr 0x6565d7c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Triangulate, addr 0x6565db8, size 0x44, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::ConstrainedPointSet* cps);

  /// @brief Method Triangulate, addr 0x6565d38, size 0x44, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::Polygon* p);

  /// @brief Method Triangulate, addr 0x6565dfc, size 0x44, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::PointSet* ps);

  /// @brief Method Triangulate, addr 0x656594c, size 0x304, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::PolygonSet* ps);

  /// @brief Method Triangulate, addr 0x6565ca4, size 0x94, virtual false, abstract: false, final false
  static inline void Triangulate(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext* tcx);

  /// @brief Method Warmup, addr 0x6565f4c, size 0x4, virtual false, abstract: false, final false
