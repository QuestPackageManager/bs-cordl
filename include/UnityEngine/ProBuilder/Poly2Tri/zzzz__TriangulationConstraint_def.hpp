...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::TriangulationConstraint*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::TriangulationConstraint*, "UnityEngine.ProBuilder.Poly2Tri", "TriangulationConstraint");
...
public:
  ...
  /// @brief Method .ctor, addr 0x66b0d14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  TriangulationConstraint(TriangulationConstraintconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::TriangulationConstraint) == 0x20, "Size mismatch!");
