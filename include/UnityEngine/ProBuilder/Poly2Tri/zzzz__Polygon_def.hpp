...
public:
  ...
  /// @brief Method AddHole, addr 0x305fdc4, size 0xf0, virtual false, abstract: false, final false
  inline void AddHole(::UnityEngine::ProBuilder::Poly2Tri::Polygon* poly);

  /// @brief Method AddPoint, addr 0x30603e4, size 0xc4, virtual false, abstract: false, final false
  inline void AddPoint(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* p);

  /// @brief Method AddPoints, addr 0x305ffd0, size 0x414, virtual false, abstract: false, final false
  inline void AddPoints(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* list);

  /// @brief Method AddSteinerPoint, addr 0x305fbc8, size 0xf0, virtual false, abstract: false, final false
  inline void AddSteinerPoint(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* point);

  /// @brief Method AddSteinerPoints, addr 0x305fcb8, size 0xa0, virtual false, abstract: false, final false
  inline void AddSteinerPoints(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* points);

  /// @brief Method AddTriangle, addr 0x3060534, size 0xa8, virtual true, abstract: false, final true
  inline void AddTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method AddTriangles, addr 0x30605dc, size 0x58, virtual true, abstract: false, final true
  inline void AddTriangles(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* list);

  /// @brief Method ClearSteinerPoints, addr 0x305fd58, size 0x6c, virtual false, abstract: false, final false
  inline void ClearSteinerPoints();

  /// @brief Method ClearTriangles, addr 0x3060634, size 0x6c, virtual true, abstract: false, final true
  inline void ClearTriangles();

  /// @brief Method InsertPointAfter, addr 0x305feb4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Prepare, addr 0x30606a0, size 0x3ec, virtual true, abstract: false, final true
  inline void Prepare(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext* tcx);

  /// @brief Method RemovePoint, addr 0x30604a8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x305fbbc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x305fb34, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* points);

  /// @brief Method .ctor, addr 0x305f77c, size 0x3b8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* points);

  /// @brief Method get_Holes, addr 0x306052c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::Polygon*>* get_Holes();

  /// @brief Method get_Points, addr 0x306051c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* get_Points();

  /// @brief Method get_Triangles, addr 0x3060524, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* get_Triangles();

  /// @brief Method get_TriangulationMode, addr 0x305fbc0, size 0x8, virtual true, abstract: false, final true
