...
public:
  ...
  /// @brief Method AddHole, addr 0x64f3f28, size 0x104, virtual false, abstract: false, final false
  inline void AddHole(::UnityEngine::ProBuilder::Poly2Tri::Polygon* poly);

  /// @brief Method AddPoint, addr 0x64f4554, size 0xd0, virtual false, abstract: false, final false
  inline void AddPoint(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* p);

  /// @brief Method AddPoints, addr 0x64f4160, size 0x3f4, virtual false, abstract: false, final false
  inline void AddPoints(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* list);

  /// @brief Method AddSteinerPoint, addr 0x64f3cec, size 0x104, virtual false, abstract: false, final false
  inline void AddSteinerPoint(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* point);

  /// @brief Method AddSteinerPoints, addr 0x64f3df0, size 0xc4, virtual false, abstract: false, final false
  inline void AddSteinerPoints(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* points);

  /// @brief Method AddTriangle, addr 0x64f46bc, size 0xb4, virtual true, abstract: false, final true
  inline void AddTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method AddTriangles, addr 0x64f4770, size 0x74, virtual true, abstract: false, final true
  inline void AddTriangles(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* list);

  /// @brief Method ClearSteinerPoints, addr 0x64f3eb4, size 0x74, virtual false, abstract: false, final false
  inline void ClearSteinerPoints();

  /// @brief Method ClearTriangles, addr 0x64f47e4, size 0x74, virtual true, abstract: false, final true
  inline void ClearTriangles();

  /// @brief Method InsertPointAfter, addr 0x64f402c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Prepare, addr 0x64f4858, size 0x408, virtual true, abstract: false, final true
  inline void Prepare(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext* tcx);

  /// @brief Method RemovePoint, addr 0x64f4624, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64f3ce0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64f3c50, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* points);

  /// @brief Method .ctor, addr 0x64f3884, size 0x3cc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>* points);

  /// @brief Method get_Holes, addr 0x64f46b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::Polygon*>* get_Holes();

  /// @brief Method get_Points, addr 0x64f46a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* get_Points();

  /// @brief Method get_Triangles, addr 0x64f46ac, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* get_Triangles();

  /// @brief Method get_TriangulationMode, addr 0x64f3ce4, size 0x8, virtual true, abstract: false, final true
