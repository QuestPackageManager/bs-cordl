...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::DTSweepBasin*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::DTSweepBasin*, "UnityEngine.ProBuilder.Poly2Tri", "DTSweepBasin");
...
public:
  ...
  DTSweepBasin(DTSweepBasinconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::DTSweepBasin) == 0x38, "Size mismatch!");
