...
public:
  ...
  /// @brief Method Area, addr 0x32a1af8, size 0xf8, virtual false, abstract: false, final false
  inline double_t Area();

  /// @brief Method Centroid, addr 0x32a1bf0, size 0x148, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* Centroid();

  /// @brief Method Contains, addr 0x32a0b84, size 0x58, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method EdgeIndex, addr 0x32a0ca4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstrainedEdgeAcross, addr 0x32a1db0, size 0x1c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetConstrainedEdgeCCW, addr 0x32a1d38, size 0x3c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetConstrainedEdgeCW, addr 0x32a1d74, size 0x3c, virtual false, abstract: false, final false
  inline bool GetConstrainedEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeAcross, addr 0x32a1f08, size 0x1c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeCCW, addr 0x32a1e90, size 0x3c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method GetDelaunayEdgeCW, addr 0x32a1ecc, size 0x3c, virtual false, abstract: false, final false
  inline bool GetDelaunayEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexCCWFrom, addr 0x32a0b50, size 0x34, virtual false, abstract: false, final false
  inline int32_t IndexCCWFrom(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexCWFrom, addr 0x32a0b1c, size 0x34, virtual false, abstract: false, final false
  inline int32_t IndexCWFrom(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method IndexOf, addr 0x32a0a6c, size 0xb0, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p);

  /// @brief Method Legalize, addr 0x32a1300, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkConstrainedEdge, addr 0x32a1adc, size 0x1c, virtual false, abstract: false, final false
  inline void MarkConstrainedEdge(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* edge);

  /// @brief Method MarkConstrainedEdge, addr 0x32a1a60, size 0xc, virtual false, abstract: false, final false
  inline void MarkConstrainedEdge(int32_t index);

  /// @brief Method MarkConstrainedEdge, addr 0x32a1720, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkEdge, addr 0x32a1844, size 0x21c, virtual false, abstract: false, final false
  inline void MarkEdge(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* tList);

  /// @brief Method MarkEdge, addr 0x32a1750, size 0xf4, virtual false, abstract: false, final false
  inline void MarkEdge(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* triangle);

  /// @brief Method MarkNeighbor, addr 0x32a0bdc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkNeighbor, addr 0x32a0d8c, size 0x1ac, virtual false, abstract: false, final false
  inline void MarkNeighbor(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* t);

  /// @brief Method MarkNeighborEdges, addr 0x32a1588, size 0x12c, virtual false, abstract: false, final false
  inline void MarkNeighborEdges();

  /// @brief Method NeighborAcrossFrom, addr 0x32a112c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method NeighborCCWFrom, addr 0x32a108c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method NeighborCWFrom, addr 0x32a0fec, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method OppositePoint, addr 0x32a0f38, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method PointCCWFrom, addr 0x32a11ac, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method PointCWFrom, addr 0x32a0f64, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method RotateCW, addr 0x32a1234, size 0xcc, virtual false, abstract: false, final false
  inline void RotateCW();

  /// @brief Method SetConstrainedEdgeAcross, addr 0x32a1e64, size 0x2c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetConstrainedEdgeCCW, addr 0x32a1dcc, size 0x4c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetConstrainedEdgeCW, addr 0x32a1e18, size 0x4c, virtual false, abstract: false, final false
  inline void SetConstrainedEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeAcross, addr 0x32a1fbc, size 0x2c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeAcross(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeCCW, addr 0x32a1f24, size 0x4c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeCCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method SetDelaunayEdgeCW, addr 0x32a1f70, size 0x4c, virtual false, abstract: false, final false
  inline void SetDelaunayEdgeCW(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* p, bool ce);

  /// @brief Method ToString, addr 0x32a1398, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a09c8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsInterior, addr 0x32a09b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInterior();

  /// @brief Method set_IsInterior, addr 0x32a09bc, size 0xc, virtual false, abstract: false, final false
