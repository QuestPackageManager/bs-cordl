...
public:
  ...
  /// @brief Method RandomCircleSweep addr 0x2b35cf0 size 0x2f0 virtual false final false
  static inline ::UnityEngine::ProBuilder::Poly2Tri::Polygon* RandomCircleSweep(double_t scale, int32_t vertexCount);

  /// @brief Method RandomCircleSweep2 addr 0x2b35fe0 size 0x25c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b3623c size 0x8 virtual false final false
  inline void _ctor();
