...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::PolygonGenerator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::PolygonGenerator*, "UnityEngine.ProBuilder.Poly2Tri", "PolygonGenerator");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PolygonGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PolygonGenerator(PolygonGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PolygonGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PolygonGenerator(PolygonGeneratorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::PolygonGenerator) == 0x10, "Size mismatch!");
