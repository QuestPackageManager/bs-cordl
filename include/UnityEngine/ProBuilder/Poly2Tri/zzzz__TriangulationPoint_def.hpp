...
public:
  ...
  /// @brief Method AddEdge, addr 0x66b0d18, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x66b2010, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method get_HasEdges, addr 0x66ade48, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasEdges();

  /// @brief Method get_Xf, addr 0x66b2128, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Xf, addr 0x66b2134, size 0xc, virtual false, abstract: false, final false
  inline void set_Xf(float_t value);

  /// @brief Method set_Yf, addr 0x66b214c, size 0xc, virtual false, abstract: false, final false
