...
public:
  ...
  /// @brief Method get_Edges addr 0x29b3984 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>* get_Edges();

  /// @brief Method set_Edges addr 0x29b398c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x29ad450 size 0x3c virtual false final false
  inline void _ctor(double_t x, double_t y, int32_t index);

  /// @brief Method ToString addr 0x29b3994 size 0x1a4 virtual true final false
  inline ::StringW ToString();

  /// @brief Method get_Xf addr 0x29b3b38 size 0xc virtual false final false
  inline float_t get_Xf();

  /// @brief Method set_Xf addr 0x29b3b44 size 0xc virtual false final false
  inline void set_Xf(float_t value);

  /// @brief Method get_Yf addr 0x29b3b50 size 0xc virtual false final false
  inline float_t get_Yf();

  /// @brief Method set_Yf addr 0x29b3b5c size 0xc virtual false final false
  inline void set_Yf(float_t value);

  /// @brief Method AddEdge addr 0x29b2640 size 0xf0 virtual false final false
  inline void AddEdge(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* e);

  /// @brief Method get_HasEdges addr 0x29af87c size 0x10 virtual false final false
