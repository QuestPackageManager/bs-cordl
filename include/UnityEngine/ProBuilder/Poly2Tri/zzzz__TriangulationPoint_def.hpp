...
public:
  ...
  /// @brief Method AddEdge, addr 0x2c19fd4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2c1b328, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c14de4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(double_t x, double_t y, int32_t index);

  /// @brief Method get_Edges, addr 0x2c1b318, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>* get_Edges();

  /// @brief Method get_HasEdges, addr 0x2c17210, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasEdges();

  /// @brief Method get_Xf, addr 0x2c1b4cc, size 0xc, virtual false, abstract: false, final false
  inline float_t get_Xf();

  /// @brief Method get_Yf, addr 0x2c1b4e4, size 0xc, virtual false, abstract: false, final false
  inline float_t get_Yf();

  /// @brief Method set_Edges, addr 0x2c1b320, size 0x8, virtual false, abstract: false, final false
  inline void set_Edges(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>* value);

  /// @brief Method set_Xf, addr 0x2c1b4d8, size 0xc, virtual false, abstract: false, final false
  inline void set_Xf(float_t value);

  /// @brief Method set_Yf, addr 0x2c1b4f0, size 0xc, virtual false, abstract: false, final false
