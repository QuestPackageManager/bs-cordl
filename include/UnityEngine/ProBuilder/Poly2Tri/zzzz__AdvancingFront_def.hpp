...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFront*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFront*, "UnityEngine.ProBuilder.Poly2Tri", "AdvancingFront");
...
public:
  ...
  /// @brief Method AddNode, addr 0x66ad374, size 0x4, virtual false, abstract: false, final false
  inline void AddNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method FindSearchNode, addr 0x66ad470, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* FindSearchNode(double_t x);

  /// @brief Method LocateNode, addr 0x66ad478, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method LocateNode, addr 0x66ad48c, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* LocateNode(double_t x);

  /// @brief Method LocatePoint, addr 0x66ad4e8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveNode, addr 0x66ad378, size 0x4, virtual false, abstract: false, final false
  inline void RemoveNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method ToString, addr 0x66ad37c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66ad368, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  AdvancingFront(AdvancingFrontconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFront) == 0x28, "Size mismatch!");
