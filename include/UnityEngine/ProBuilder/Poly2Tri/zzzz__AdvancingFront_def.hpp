...
public:
  ...
  /// @brief Method AddNode, addr 0x65688d8, size 0x4, virtual false, abstract: false, final false
  inline void AddNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method FindSearchNode, addr 0x65689d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* FindSearchNode(double_t x);

  /// @brief Method LocateNode, addr 0x65689dc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method LocateNode, addr 0x65689f0, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* LocateNode(double_t x);

  /// @brief Method LocatePoint, addr 0x6568a4c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveNode, addr 0x65688dc, size 0x4, virtual false, abstract: false, final false
  inline void RemoveNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* node);

  /// @brief Method ToString, addr 0x65688e0, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65688cc, size 0xc, virtual false, abstract: false, final false
