...
public:
  ...
  /// @brief Method Compare, addr 0x2c7b1c0, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2c7a924, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
