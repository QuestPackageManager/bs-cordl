...
public:
  ...
  /// @brief Method Compare, addr 0x2c1a988, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2c1a0ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
