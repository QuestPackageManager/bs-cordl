...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::Poly2Tri::DTSweepPointComparator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::Poly2Tri::DTSweepPointComparator*, "UnityEngine.ProBuilder.Poly2Tri", "DTSweepPointComparator");
...
public:
  ...
  /// @brief Method Compare, addr 0x66b1670, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66b0e40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  DTSweepPointComparator(DTSweepPointComparatorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::Poly2Tri::DTSweepPointComparator) == 0x10, "Size mismatch!");
