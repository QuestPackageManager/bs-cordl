...
/// @brief Method Compare, addr 0x64fabc8, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x64fa398, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
