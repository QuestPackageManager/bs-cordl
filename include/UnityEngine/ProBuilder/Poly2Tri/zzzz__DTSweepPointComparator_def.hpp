...
public:
  ...
  /// @brief Method Compare, addr 0x3061670, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3060dd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
