...
public:
  ...
  /// @brief Method Compare, addr 0x470b2dc, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x470aa54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
