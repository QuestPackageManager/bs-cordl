...
public:
  ...
  /// @brief Method Compare, addr 0x46fddb8, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x46fd530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
