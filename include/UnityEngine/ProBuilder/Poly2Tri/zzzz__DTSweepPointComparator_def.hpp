...
public:
  ...
  /// @brief Method Compare, addr 0x469b0dc, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x469a854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
