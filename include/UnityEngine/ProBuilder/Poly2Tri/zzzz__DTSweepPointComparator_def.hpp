...
public:
  ...
  /// @brief Method Compare, addr 0x32a62cc, size 0x50, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32a5a30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
