...
public:
  ...
  /// @brief Method Compare, addr 0x46fc3f0, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x46fbb68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
