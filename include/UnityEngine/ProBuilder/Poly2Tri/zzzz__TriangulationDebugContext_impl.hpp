...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::*)(
  ...
  constexpr static std::size_t addrs = 0x2b34cd4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((
        ::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
constexpr ::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext*& UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::__get__tcx() {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____tcx;
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext*> const& UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::__get__tcx() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____tcx;
}
...
UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::New_ctor(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext* tcx) {
  return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*>(tcx));
}
...
inline void UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::Clear() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*>::get(), "Clear",
