...
public:
  ...
  /// @brief Method FromRGB, addr 0x66b46b8, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::CIELabColor* FromRGB(::UnityEngine::Color col);

  /// @brief Method FromXYZ, addr 0x66b44fc, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x66b4748, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b44f0, size 0xc, virtual false, abstract: false, final false
