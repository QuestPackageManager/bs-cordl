...
// Write type traits
MARK_REF_T(::UnityEngine::ProBuilder::CIELabColor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ProBuilder::CIELabColor*, "UnityEngine.ProBuilder", "CIELabColor");
...
public:
  ...
  /// @brief Method FromRGB, addr 0x66b9ed0, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::CIELabColor* FromRGB(::UnityEngine::Color col);

  /// @brief Method FromXYZ, addr 0x66b9d14, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x66b9f60, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66b9d08, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CIELabColor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CIELabColor(CIELabColor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CIELabColor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CIELabColor(CIELabColorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ProBuilder::CIELabColor) == 0x20, "Size mismatch!");
