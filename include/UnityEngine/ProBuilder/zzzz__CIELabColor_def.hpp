...
public:
  ...
  /// @brief Method FromRGB, addr 0x47018fc, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ProBuilder::CIELabColor* FromRGB(::UnityEngine::Color col);

  /// @brief Method FromXYZ, addr 0x4701720, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x4701988, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47016e4, size 0x3c, virtual false, abstract: false, final false
