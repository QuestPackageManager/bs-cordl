...
public:
  ...
  /// @brief Method .ctor, addr 0x33c1e60, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClips, addr 0x33c2e94, size 0x3c, virtual false, abstract: false, final false
