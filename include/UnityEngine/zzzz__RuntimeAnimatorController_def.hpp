...
public:
  ...
  /// @brief Method .ctor, addr 0x2c8accc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClips, addr 0x2c8bd00, size 0x3c, virtual false, abstract: false, final false
