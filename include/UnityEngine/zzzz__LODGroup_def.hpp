...
public:
  ...
  /// @brief Method GetLODs, addr 0x48939c4, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::LOD, ::Array<::UnityEngine::LOD>*> GetLODs();

  /// @brief Method RecalculateBounds, addr 0x4893988, size 0x3c, virtual false, abstract: false, final false
  inline void RecalculateBounds();

  /// @brief Method SetLODs, addr 0x4893a00, size 0x44, virtual false, abstract: false, final false
  inline void SetLODs(::ArrayW<::UnityEngine::LOD, ::Array<::UnityEngine::LOD>*> lods);

  /// @brief Method get_lodCount, addr 0x489394c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_lodCount();

  /// @brief Method get_size, addr 0x4893910, size 0x3c, virtual false, abstract: false, final false
