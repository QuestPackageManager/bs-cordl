...
public:
  ...
  /// @brief Method get_size addr 0x2b51cec size 0x3c virtual false final false
  inline float_t get_size();

  /// @brief Method get_lodCount addr 0x2b51d28 size 0x3c virtual false final false
  inline int32_t get_lodCount();

  /// @brief Method RecalculateBounds addr 0x2b51d64 size 0x3c virtual false final false
  inline void RecalculateBounds();

  /// @brief Method GetLODs addr 0x2b51da0 size 0x3c virtual false final false
  inline ::ArrayW<::UnityEngine::LOD, ::Array<::UnityEngine::LOD>*> GetLODs();

  /// @brief Method SetLODs addr 0x2b51ddc size 0x44 virtual false final false
