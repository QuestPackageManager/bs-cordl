...
/// @brief Method get_localReferencePoint, addr 0x68dc62c, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_localReferencePoint() ;

/// @brief Method get_localReferencePoint_Injected, addr 0x68dc6cc, size 0x44, virtual false, abstract: false, final false
static inline void get_localReferencePoint_Injected(::System::IntPtr  _unity_self, ::ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method get_size, addr 0x68dc710, size 0x80, virtual false, abstract: false, final false
inline float_t get_size() ;

/// @brief Method get_size_Injected, addr 0x68dc790, size 0x3c, virtual false, abstract: false, final false
