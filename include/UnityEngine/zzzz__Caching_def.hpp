...
public:
  // Declarations
  /// @brief Method set_compressionEnabled addr 0x2b5f72c size 0x3c virtual false final false
  static inline void set_compressionEnabled(bool value);

  /// @brief Method get_ready addr 0x2b5f768 size 0x28 virtual false final false
  static inline bool get_ready();

  /// @brief Method ClearCachedVersion addr 0x2b5f790 size 0x84 virtual false final false
  static inline bool ClearCachedVersion(::StringW assetBundleName, ::UnityEngine::Hash128 hash);

  /// @brief Method ClearCachedVersionInternal addr 0x2b5f814 size 0x54 virtual false final false
  static inline bool ClearCachedVersionInternal(::StringW assetBundleName, ::UnityEngine::Hash128 hash);

  /// @brief Method ClearOtherCachedVersions addr 0x2b5f8ac size 0x88 virtual false final false
  static inline bool ClearOtherCachedVersions(::StringW assetBundleName, ::UnityEngine::Hash128 hash);

  /// @brief Method ClearAllCachedVersions addr 0x2b5f990 size 0x78 virtual false final false
  static inline bool ClearAllCachedVersions(::StringW assetBundleName);

  /// @brief Method ClearCachedVersions addr 0x2b5f934 size 0x5c virtual false final false
  static inline bool ClearCachedVersions(::StringW assetBundleName, ::UnityEngine::Hash128 hash, bool keepInputVersion);

  /// @brief Method IsVersionCached addr 0x2b5fa5c size 0xa8 virtual false final false
  static inline bool IsVersionCached(::UnityEngine::CachedAssetBundle cachedBundle);

  /// @brief Method IsVersionCached addr 0x2b5fb18 size 0x5c virtual false final false
  static inline bool IsVersionCached(::StringW url, ::StringW assetBundleName, ::UnityEngine::Hash128 hash);

  /// @brief Method AddCache addr 0x2b5fbc8 size 0x254 virtual false final false
  static inline ::UnityEngine::Cache AddCache(::StringW cachePath);

  /// @brief Method AddCache addr 0x2b5fea4 size 0x5c virtual false final false
  static inline ::UnityEngine::Cache AddCache(::StringW cachePath, bool isReadonly);

  /// @brief Method GetCacheByPath addr 0x2b5fe1c size 0x4c virtual false final false
  static inline ::UnityEngine::Cache GetCacheByPath(::StringW cachePath);

  /// @brief Method get_defaultCache addr 0x2b5ff98 size 0x44 virtual false final false
  static inline ::UnityEngine::Cache get_defaultCache();

  /// @brief Method get_currentCacheForWriting addr 0x2b60018 size 0x44 virtual false final false
  static inline ::UnityEngine::Cache get_currentCacheForWriting();

  /// @brief Method set_currentCacheForWriting addr 0x2b60098 size 0x40 virtual false final false
  static inline void set_currentCacheForWriting(::UnityEngine::Cache value);

  /// @brief Method ClearCachedVersionInternal_Injected addr 0x2b5f868 size 0x44 virtual false final false
  static inline bool ClearCachedVersionInternal_Injected(::StringW assetBundleName, ByRef<::UnityEngine::Hash128> hash);

  /// @brief Method ClearCachedVersions_Injected addr 0x2b5fa08 size 0x54 virtual false final false
  ...
  /// @brief Method IsVersionCached_Injected addr 0x2b5fb74 size 0x54 virtual false final false
  static inline bool IsVersionCached_Injected(::StringW url, ::StringW assetBundleName, ByRef<::UnityEngine::Hash128> hash);

  /// @brief Method AddCache_Injected addr 0x2b5ff00 size 0x54 virtual false final false
  static inline void AddCache_Injected(::StringW cachePath, bool isReadonly, ByRef<::UnityEngine::Cache> ret);

  /// @brief Method GetCacheByPath_Injected addr 0x2b5ff54 size 0x44 virtual false final false
  static inline void GetCacheByPath_Injected(::StringW cachePath, ByRef<::UnityEngine::Cache> ret);

  /// @brief Method get_defaultCache_Injected addr 0x2b5ffdc size 0x3c virtual false final false
  static inline void get_defaultCache_Injected(ByRef<::UnityEngine::Cache> ret);

  /// @brief Method get_currentCacheForWriting_Injected addr 0x2b6005c size 0x3c virtual false final false
  static inline void get_currentCacheForWriting_Injected(ByRef<::UnityEngine::Cache> ret);

  /// @brief Method set_currentCacheForWriting_Injected addr 0x2b600d8 size 0x3c virtual false final false
