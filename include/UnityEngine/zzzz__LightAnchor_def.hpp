...
/// @brief Method GetWorldSpaceAxes, addr 0x658d81c, size 0x88c, virtual false, abstract: false, final false
...
/// @brief Method NormalizeAngleDegree, addr 0x658d0f4, size 0x34, virtual false, abstract: false, final false
static inline float_t NormalizeAngleDegree(float_t  angle) ;

/// @brief Method OnDrawGizmosSelected, addr 0x658e4d8, size 0xdc, virtual false, abstract: false, final false
inline void OnDrawGizmosSelected() ;

/// @brief Method SynchronizeOnTransform, addr 0x658d31c, size 0x500, virtual false, abstract: false, final false
inline void SynchronizeOnTransform(::UnityEngine::Camera*  camera) ;

/// @brief Method Update, addr 0x658e3d4, size 0x104, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTransform, addr 0x658e0a8, size 0x68, virtual false, abstract: false, final false
inline void UpdateTransform(::UnityEngine::Camera*  camera, ::UnityEngine::Vector3  anchor) ;

/// @brief Method UpdateTransform, addr 0x658e110, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x658e5b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_anchorPosition, addr 0x658d1e4, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_anchorPosition() ;

/// @brief Method get_anchorPositionOffset, addr 0x658d304, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_anchorPositionOffset() ;

/// @brief Method get_anchorPositionOverride, addr 0x658d2f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_anchorPositionOverride() ;

/// @brief Method get_distance, addr 0x658d1a8, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_frameSpace, addr 0x658d1d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LightAnchor_UpDirection get_frameSpace() ;

/// @brief Method get_pitch, addr 0x658d128, size 0x8, virtual false, abstract: false, final false
inline float_t get_pitch() ;

/// @brief Method get_roll, addr 0x658d168, size 0x8, virtual false, abstract: false, final false
inline float_t get_roll() ;

/// @brief Method get_yaw, addr 0x658d0b4, size 0x8, virtual false, abstract: false, final false
inline float_t get_yaw() ;

/// @brief Method set_anchorPositionOffset, addr 0x658d310, size 0xc, virtual false, abstract: false, final false
inline void set_anchorPositionOffset(::UnityEngine::Vector3  value) ;

/// @brief Method set_anchorPositionOverride, addr 0x658d2fc, size 0x8, virtual false, abstract: false, final false
inline void set_anchorPositionOverride(::UnityEngine::Transform*  value) ;

/// @brief Method set_distance, addr 0x658d1b0, size 0x24, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_frameSpace, addr 0x658d1dc, size 0x8, virtual false, abstract: false, final false
inline void set_frameSpace(::UnityEngine::LightAnchor_UpDirection  value) ;

/// @brief Method set_pitch, addr 0x658d130, size 0x38, virtual false, abstract: false, final false
inline void set_pitch(float_t  value) ;

/// @brief Method set_roll, addr 0x658d170, size 0x38, virtual false, abstract: false, final false
inline void set_roll(float_t  value) ;

/// @brief Method set_yaw, addr 0x658d0bc, size 0x38, virtual false, abstract: false, final false
