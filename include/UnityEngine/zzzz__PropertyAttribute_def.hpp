...
public:
  ...
  /// @brief Method .ctor, addr 0x697fdd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x697fdd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool applyToCollection);

  /// @brief Method set_order, addr 0x697fdc8, size 0x8, virtual false, abstract: false, final false
