...
public:
  ...
  /// @brief Method .ctor, addr 0x690d4f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x690d4fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool applyToCollection);

  /// @brief Method set_order, addr 0x690d4ec, size 0x8, virtual false, abstract: false, final false
