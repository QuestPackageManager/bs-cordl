...
/// @brief Method .ctor, addr 0x690dbb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x690dbbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(bool  applyToCollection) ;

/// @brief Method set_order, addr 0x690dbac, size 0x8, virtual false, abstract: false, final false
