...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CachedInvokableCall_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CachedInvokableCall_1(CachedInvokableCall_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CachedInvokableCall_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CachedInvokableCall_1(CachedInvokableCall_1const&) = delete;
