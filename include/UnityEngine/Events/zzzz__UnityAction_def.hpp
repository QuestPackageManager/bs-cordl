...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69a63d8, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Events::UnityAction* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x69a6370, size 0x68, virtual false, abstract: false, final false
