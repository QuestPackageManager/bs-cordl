...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2df0730, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Events::UnityAction* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x2df0674, size 0xbc, virtual false, abstract: false, final false
