...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnityAction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnityAction(UnityAction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnityAction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnityAction(UnityActionconst&) = delete;
