...
template <typename T0> inline void UnityEngine::Events::UnityAction_1<T0>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::UnityAction_1<T0>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
