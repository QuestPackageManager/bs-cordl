...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Events::UnityAction_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Events::UnityAction_4, "UnityEngine.Events", "UnityAction`4");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnityAction_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnityAction_4(UnityAction_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnityAction_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnityAction_4(UnityAction_4const&) = delete;
