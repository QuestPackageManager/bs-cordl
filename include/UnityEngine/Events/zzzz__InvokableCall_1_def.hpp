...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::Events::InvokableCall_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::Events::InvokableCall_1, "UnityEngine.Events", "InvokableCall`1");
...
public:
  ...
  constexpr ::UnityEngine::Events::UnityAction_1<T1>* const& __cordl_internal_get_Delegate() const;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvokableCall_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvokableCall_1(InvokableCall_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvokableCall_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvokableCall_1(InvokableCall_1const&) = delete;
