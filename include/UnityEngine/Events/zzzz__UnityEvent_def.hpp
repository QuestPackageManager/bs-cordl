...
public:
  ...
  /// @brief Method AddListener, addr 0x68cac94, size 0x2c, virtual false, abstract: false, final false
  inline void AddListener(::UnityEngine::Events::UnityAction* call);

  /// @brief Method FindMethod_Impl, addr 0x68cad68, size 0x68, virtual true, abstract: false, final false
  inline ::System::Reflection::MethodInfo* FindMethod_Impl(::StringW name, ::System::Type* targetObjType);

  /// @brief Method GetDelegate, addr 0x68cacc0, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Events::BaseInvokableCall* GetDelegate(::UnityEngine::Events::UnityAction* action);

  /// @brief Method GetDelegate, addr 0x68cadd0, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityEngine::Events::BaseInvokableCall* GetDelegate(::System::Object* target, ::System::Reflection::MethodInfo* theFunction);

  /// @brief Method Invoke, addr 0x68cae3c, size 0x194, virtual false, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Events::UnityEvent* New_ctor();

  /// @brief Method RemoveListener, addr 0x68cad1c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68cac8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
