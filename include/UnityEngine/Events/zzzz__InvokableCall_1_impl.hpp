...
template <typename T1> inline void UnityEngine::Events::InvokableCall_1<T1>::add_Delegate(::UnityEngine::Events::UnityAction_1<T1>* value) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::InvokableCall_1<T1>*>::get(), "add_Delegate", std::span<Il2CppClass const* const, 0>(),
...
template <typename T1> inline void UnityEngine::Events::InvokableCall_1<T1>::remove_Delegate(::UnityEngine::Events::UnityAction_1<T1>* value) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::InvokableCall_1<T1>*>::get(), "remove_Delegate", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Events::UnityAction_1<T1>*>::get() })));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, value);
}
