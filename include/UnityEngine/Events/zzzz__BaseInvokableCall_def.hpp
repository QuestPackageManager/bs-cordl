...
public:
  // Declarations
  /// @brief Method AllowInvoke, addr 0x3231f00, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3231e10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3231e18, size 0xe8, virtual false, abstract: false, final false
