...
public:
  // Declarations
  /// @brief Method AllowInvoke, addr 0x48be25c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48be160, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x48be168, size 0xf4, virtual false, abstract: false, final false
