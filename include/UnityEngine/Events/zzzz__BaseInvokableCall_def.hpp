...
public:
  // Declarations
  /// @brief Method AllowInvoke, addr 0x2dee914, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dee824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2dee82c, size 0xe8, virtual false, abstract: false, final false
