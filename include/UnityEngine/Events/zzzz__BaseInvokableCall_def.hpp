...
public:
  // Declarations
  /// @brief Method AllowInvoke, addr 0x322ff04, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322fe14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x322fe1c, size 0xe8, virtual false, abstract: false, final false
