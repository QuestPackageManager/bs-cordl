...
public:
  // Declarations
  /// @brief Method AllowInvoke, addr 0x2e4a14c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e4a05c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2e4a064, size 0xe8, virtual false, abstract: false, final false
