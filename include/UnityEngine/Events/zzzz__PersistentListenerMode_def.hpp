...
DEFINE_IL2CPP_CLASS(::UnityEngine::Events::PersistentListenerMode, "UnityEngine.Events", "PersistentListenerMode");
// Dependencies
namespace UnityEngine::Events {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Events::PersistentListenerMode) == 0x4, "Size mismatch!");
