...
public:
  ...
  /// @brief Method Initialize, addr 0x6afa6fc, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6afa688, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
