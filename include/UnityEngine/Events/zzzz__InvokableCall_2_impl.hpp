...
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::add_Delegate(::UnityEngine::Events::UnityAction_2<T1, T2>* value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(),
                                                                                         { "add_Delegate", {}, { ::i2c::type_of<::UnityEngine::Events::UnityAction_2<T1, T2>*>() } })));
...
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::remove_Delegate(::UnityEngine::Events::UnityAction_2<T1, T2>* value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(),
                                                                                         { "remove_Delegate", {}, { ::i2c::type_of<::UnityEngine::Events::UnityAction_2<T1, T2>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, value);
}
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::_ctor(::System::Object* target, ::System::Reflection::MethodInfo* theFunction) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(),
...
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::_ctor(::UnityEngine::Events::UnityAction_2<T1, T2>* action) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(), { ".ctor", {}, { ::i2c::type_of<::UnityEngine::Events::UnityAction_2<T1, T2>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, action);
}
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::Invoke(::ArrayW<::System::Object*> args) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(), 4 })));
...
template <typename T1, typename T2> inline void UnityEngine::Events::InvokableCall_2<T1, T2>::Invoke(T1 args0, T2 args1) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(), { "Invoke", {}, { ::i2c::type_of<T1>(), ::i2c::type_of<T2>() } })));
...
template <typename T1, typename T2> inline bool UnityEngine::Events::InvokableCall_2<T1, T2>::Find(::System::Object* targetObj, ::System::Reflection::MethodInfo* method) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(), 5 })));
...
inline ::UnityEngine::Events::InvokableCall_2<T1, T2>* UnityEngine::Events::InvokableCall_2<T1, T2>::New_ctor(::UnityEngine::Events::UnityAction_2<T1, T2>* action) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::UnityEngine::Events::InvokableCall_2<T1, T2>*>(action));
}
// Ctor Parameters []
