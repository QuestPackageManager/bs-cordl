...
template<typename T1,typename T2>
inline void UnityEngine::Events::InvokableCall_2<T1,T2>::add_Delegate(::UnityEngine::Events::UnityAction_2<T1,T2>*  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::InvokableCall_2<T1,T2>*>::get(),
                        "add_Delegate",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Events::UnityAction_2<T1,T2>*>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, value);
}
template<typename T1,typename T2>
inline void UnityEngine::Events::InvokableCall_2<T1,T2>::remove_Delegate(::UnityEngine::Events::UnityAction_2<T1,T2>*  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::InvokableCall_2<T1,T2>*>::get(),
                        "remove_Delegate",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T1,typename T2>
inline void UnityEngine::Events::InvokableCall_2<T1,T2>::_ctor(::UnityEngine::Events::UnityAction_2<T1,T2>*  action)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::InvokableCall_2<T1,T2>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
