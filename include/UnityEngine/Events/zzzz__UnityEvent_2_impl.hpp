...
constexpr ::ArrayW<::System::Object*,::Array<::System::Object*>*>& UnityEngine::Events::UnityEvent_2<T0,T1>::__cordl_internal_get_m_InvokeArray()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_InvokeArray;
}
template<typename T0,typename T1>
constexpr ::ArrayW<::System::Object*,::Array<::System::Object*>*> const& UnityEngine::Events::UnityEvent_2<T0,T1>::__cordl_internal_get_m_InvokeArray() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_InvokeArray;
}
template<typename T0,typename T1>
constexpr void UnityEngine::Events::UnityEvent_2<T0,T1>::__cordl_internal_set_m_InvokeArray(::ArrayW<::System::Object*,::Array<::System::Object*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
inline void UnityEngine::Events::UnityEvent_2<T0,T1>::AddListener(::UnityEngine::Events::UnityAction_2<T0,T1>*  call)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::UnityEvent_2<T0,T1>*>::get(),
                        "AddListener",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Events::UnityAction_2<T0,T1>*>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, call);
}
template<typename T0,typename T1>
inline void UnityEngine::Events::UnityEvent_2<T0,T1>::RemoveListener(::UnityEngine::Events::UnityAction_2<T0,T1>*  call)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::UnityEvent_2<T0,T1>*>::get(),
                        "RemoveListener",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T0,typename T1>
inline ::UnityEngine::Events::BaseInvokableCall* UnityEngine::Events::UnityEvent_2<T0,T1>::GetDelegate(::UnityEngine::Events::UnityAction_2<T0,T1>*  action)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Events::UnityEvent_2<T0,T1>*>::get(),
                        "GetDelegate",
                        std::span<const Il2CppClass* const, 0>(),
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Invoke",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T0>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T1>::get()}
                    )));
