...
public:
  ...
  /// @brief Field LineStrip value: static_cast<int32_t>(0x4)
  static ::UnityEngine::MeshTopology const LineStrip;

  /// @brief Field Lines value: static_cast<int32_t>(0x3)
  static ::UnityEngine::MeshTopology const Lines;

  /// @brief Field Points value: static_cast<int32_t>(0x5)
  static ::UnityEngine::MeshTopology const Points;

  /// @brief Field Quads value: static_cast<int32_t>(0x2)
  static ::UnityEngine::MeshTopology const Quads;

  /// @brief Field Triangles value: static_cast<int32_t>(0x0)
