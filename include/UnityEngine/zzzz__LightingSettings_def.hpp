...
public:
  ...
  /// @brief Method Internal_Create, addr 0x34067f8, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Create(::UnityEngine::LightingSettings* self);

  /// @brief Method LightingSettingsDontStripMe, addr 0x340676c, size 0x4, virtual false, abstract: false, final false
  inline void LightingSettingsDontStripMe();

  static inline ::UnityEngine::LightingSettings* New_ctor();

  /// @brief Method .ctor, addr 0x3406770, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bakedGI, addr 0x3406834, size 0x3c, virtual false, abstract: false, final false
  inline bool get_bakedGI();

  /// @brief Method get_realtimeEnvironmentLighting, addr 0x3406934, size 0x3c, virtual false, abstract: false, final false
  inline bool get_realtimeEnvironmentLighting();

  /// @brief Method get_realtimeGI, addr 0x34068b4, size 0x3c, virtual false, abstract: false, final false
  inline bool get_realtimeGI();

  /// @brief Method set_bakedGI, addr 0x3406870, size 0x44, virtual false, abstract: false, final false
  inline void set_bakedGI(bool value);

  /// @brief Method set_realtimeEnvironmentLighting, addr 0x3406970, size 0x44, virtual false, abstract: false, final false
  inline void set_realtimeEnvironmentLighting(bool value);

  /// @brief Method set_realtimeGI, addr 0x34068f0, size 0x44, virtual false, abstract: false, final false
