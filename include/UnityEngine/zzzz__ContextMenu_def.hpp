...
public:
  ...
  /// @brief Method .ctor, addr 0x48ac2c0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW itemName);

  /// @brief Method .ctor, addr 0x48ac2f8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW itemName, bool isValidateFunction);

  /// @brief Method .ctor, addr 0x48ac334, size 0x40, virtual false, abstract: false, final false
