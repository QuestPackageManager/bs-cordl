...
public:
  ...
  /// @brief Method Equals, addr 0x4857dc8, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x4857ea4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4857ec4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x4857dc0, size 0x8, virtual false, abstract: false, final false
