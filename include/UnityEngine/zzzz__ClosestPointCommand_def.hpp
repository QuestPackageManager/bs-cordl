...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x48ab7a8, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleClosestPointCommandBatch, addr 0x48ab8f8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleClosestPointCommandBatch_Injected, addr 0x48ab984, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48ab6ac, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48ab67c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colliderInstanceID, addr 0x48ab750, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_colliderInstanceID();

  /// @brief Method get_point, addr 0x48ab738, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_position, addr 0x48ab760, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_rotation, addr 0x48ab778, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_scale, addr 0x48ab790, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_scale();

  /// @brief Method set_colliderInstanceID, addr 0x48ab758, size 0x8, virtual false, abstract: false, final false
  inline void set_colliderInstanceID(int32_t value);

  /// @brief Method set_point, addr 0x48ab744, size 0xc, virtual false, abstract: false, final false
  inline void set_point(::UnityEngine::Vector3 value);

  /// @brief Method set_position, addr 0x48ab76c, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_rotation, addr 0x48ab784, size 0xc, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method set_scale, addr 0x48ab79c, size 0xc, virtual false, abstract: false, final false
