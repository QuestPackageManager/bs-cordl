...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x69cc6e8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleClosestPointCommandBatch, addr 0x69cc7e4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleClosestPointCommandBatch_Injected, addr 0x69cc870, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69cc5f0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69cc5c0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colliderInstanceID, addr 0x69cc690, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_colliderInstanceID();

  /// @brief Method get_point, addr 0x69cc678, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_position, addr 0x69cc6a0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_rotation, addr 0x69cc6b8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_scale, addr 0x69cc6d0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_scale();

  /// @brief Method set_colliderInstanceID, addr 0x69cc698, size 0x8, virtual false, abstract: false, final false
  inline void set_colliderInstanceID(int32_t value);

  /// @brief Method set_point, addr 0x69cc684, size 0xc, virtual false, abstract: false, final false
  inline void set_point(::UnityEngine::Vector3 value);

  /// @brief Method set_position, addr 0x69cc6ac, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_rotation, addr 0x69cc6c4, size 0xc, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method set_scale, addr 0x69cc6dc, size 0xc, virtual false, abstract: false, final false
