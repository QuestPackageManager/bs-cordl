...
public:
  // Declarations
  /// @brief Method InitState addr 0x2b5ed18 size 0x3c virtual false final false
  static inline void InitState(int32_t seed);

  /// @brief Method Range addr 0x2b5ed54 size 0x40 virtual false final false
  static inline float_t Range(float_t minInclusive, float_t maxInclusive);

  /// @brief Method Range addr 0x2b5ed94 size 0x44 virtual false final false
  static inline int32_t Range(int32_t minInclusive, int32_t maxExclusive);

  /// @brief Method RandomRangeInt addr 0x2b5edd8 size 0x44 virtual false final false
  static inline int32_t RandomRangeInt(int32_t minInclusive, int32_t maxExclusive);

  /// @brief Method get_value addr 0x2b5ee1c size 0x28 virtual false final false
  static inline float_t get_value();

  /// @brief Method get_insideUnitSphere addr 0x2b5ee44 size 0x4c virtual false final false
  static inline ::UnityEngine::Vector3 get_insideUnitSphere();

  /// @brief Method get_onUnitSphere addr 0x2b5eecc size 0x4c virtual false final false
  static inline ::UnityEngine::Vector3 get_onUnitSphere();

  /// @brief Method get_rotation addr 0x2b5ef54 size 0x48 virtual false final false
  static inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method ColorHSV addr 0x2b5efd8 size 0x24 virtual false final false
  static inline ::UnityEngine::Color ColorHSV();

  /// @brief Method ColorHSV addr 0x2b5effc size 0x164 virtual false final false
  ...
  /// @brief Method get_insideUnitSphere_Injected addr 0x2b5ee90 size 0x3c virtual false final false
  static inline void get_insideUnitSphere_Injected(ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_onUnitSphere_Injected addr 0x2b5ef18 size 0x3c virtual false final false
  static inline void get_onUnitSphere_Injected(ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_rotation_Injected addr 0x2b5ef9c size 0x3c virtual false final false
