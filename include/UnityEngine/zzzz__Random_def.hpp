...
/// @brief Method ColorHSV, addr 0x690e2a0, size 0x24, virtual false, abstract: false, final false
static inline ::UnityEngine::Color ColorHSV() ;

/// @brief Method ColorHSV, addr 0x690e2c4, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method InitState, addr 0x690df6c, size 0x3c, virtual false, abstract: false, final false
static inline void InitState(int32_t  seed) ;

/// @brief Method RandomRangeInt, addr 0x690e128, size 0x44, virtual false, abstract: false, final false
static inline int32_t RandomRangeInt(int32_t  minInclusive, int32_t  maxExclusive) ;

/// @brief Method Range, addr 0x690e0a4, size 0x40, virtual false, abstract: false, final false
static inline float_t Range(float_t  minInclusive, float_t  maxInclusive) ;

/// @brief Method Range, addr 0x690e0e4, size 0x44, virtual false, abstract: false, final false
static inline int32_t Range(int32_t  minInclusive, int32_t  maxExclusive) ;

/// @brief Method get_onUnitSphere, addr 0x690e194, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 get_onUnitSphere() ;

/// @brief Method get_onUnitSphere_Injected, addr 0x690e1e0, size 0x3c, virtual false, abstract: false, final false
static inline void get_onUnitSphere_Injected(::ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method get_rotation, addr 0x690e21c, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_rotation_Injected, addr 0x690e264, size 0x3c, virtual false, abstract: false, final false
static inline void get_rotation_Injected(::ByRef<::UnityEngine::Quaternion>  ret) ;

/// @brief Method get_state, addr 0x690dfa8, size 0x44, virtual false, abstract: false, final false
static inline ::UnityEngine::Random_State get_state() ;

/// @brief Method get_state_Injected, addr 0x690dfec, size 0x3c, virtual false, abstract: false, final false
static inline void get_state_Injected(::ByRef<::UnityEngine::Random_State>  ret) ;

/// @brief Method get_value, addr 0x690e16c, size 0x28, virtual false, abstract: false, final false
static inline float_t get_value() ;

/// @brief Method set_state, addr 0x690e028, size 0x40, virtual false, abstract: false, final false
static inline void set_state(::UnityEngine::Random_State  value) ;

/// @brief Method set_state_Injected, addr 0x690e068, size 0x3c, virtual false, abstract: false, final false
