...
DEFINE_IL2CPP_CLASS(::UnityEngine::RigidbodyInterpolation, "UnityEngine", "RigidbodyInterpolation");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::RigidbodyInterpolation) == 0x4, "Size mismatch!");
