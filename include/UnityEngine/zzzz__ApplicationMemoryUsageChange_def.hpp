...
public:
  ...
  /// @brief Method .ctor, addr 0x68337cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ApplicationMemoryUsage usage);

  /// @brief Method set_memoryUsage, addr 0x6834aac, size 0x8, virtual false, abstract: false, final false
