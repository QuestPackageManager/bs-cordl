...
public:
  ...
  /// @brief Method .ctor, addr 0x690da10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ApplicationMemoryUsage usage);

  /// @brief Method set_memoryUsage, addr 0x690ef00, size 0x8, virtual false, abstract: false, final false
