...
public:
  // Declarations
  /// @brief Method ConvertToManaged, addr 0x68994a8, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Gradient* ConvertToManaged(::System::IntPtr ptr);

  /// @brief Method ConvertToNative, addr 0x6899494, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x68986e4, size 0x50, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Cleanup_Injected, addr 0x6898734, size 0x3c, virtual false, abstract: false, final false
  static inline void Cleanup_Injected(::System::IntPtr _unity_self);

  /// @brief Method Equals, addr 0x6899308, size 0xf4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method Equals, addr 0x68993fc, size 0x90, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Gradient* other);

  /// @brief Method Evaluate, addr 0x68988ac, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color Evaluate(float_t time);

  /// @brief Method Evaluate_Injected, addr 0x6898928, size 0x54, virtual false, abstract: false, final false
  static inline void Evaluate_Injected(::System::IntPtr _unity_self, float_t time, ::ByRef<::UnityEngine::Color> ret);

  /// @brief Method Finalize, addr 0x6898860, size 0x4c, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetHashCode, addr 0x689948c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Init, addr 0x68986bc, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Init();

  /// @brief Method Internal_Equals, addr 0x6898770, size 0x58, virtual false, abstract: false, final false
  inline bool Internal_Equals(::System::IntPtr other);

  /// @brief Method Internal_Equals_Injected, addr 0x68987c8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetKeys, addr 0x6899154, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method SetKeys_Injected, addr 0x68992b4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x689880c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6898854, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method get_alphaKeys, addr 0x6898c40, size 0x14c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::GradientAlphaKey, ::Array<::UnityEngine::GradientAlphaKey>*> get_alphaKeys();

  /// @brief Method get_alphaKeys_Injected, addr 0x6898d8c, size 0x44, virtual false, abstract: false, final false
  static inline void get_alphaKeys_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method get_colorKeys, addr 0x689897c, size 0x14c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::GradientColorKey, ::Array<::UnityEngine::GradientColorKey>*> get_colorKeys();

  /// @brief Method get_colorKeys_Injected, addr 0x6898ac8, size 0x44, virtual false, abstract: false, final false
  static inline void get_colorKeys_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method get_colorSpace, addr 0x689902c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::ColorSpace get_colorSpace();

  /// @brief Method get_colorSpace_Injected, addr 0x689907c, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ColorSpace get_colorSpace_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_mode, addr 0x6898f04, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::GradientMode get_mode();

  /// @brief Method get_mode_Injected, addr 0x6898f54, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alphaKeys, addr 0x6898dd0, size 0xf0, virtual false, abstract: false, final false
  inline void set_alphaKeys(::ArrayW<::UnityEngine::GradientAlphaKey, ::Array<::UnityEngine::GradientAlphaKey>*> value);

  /// @brief Method set_alphaKeys_Injected, addr 0x6898ec0, size 0x44, virtual false, abstract: false, final false
  static inline void set_alphaKeys_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> value);

  /// @brief Method set_colorKeys, addr 0x6898b0c, size 0xf0, virtual false, abstract: false, final false
  inline void set_colorKeys(::ArrayW<::UnityEngine::GradientColorKey, ::Array<::UnityEngine::GradientColorKey>*> value);

  /// @brief Method set_colorKeys_Injected, addr 0x6898bfc, size 0x44, virtual false, abstract: false, final false
  static inline void set_colorKeys_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> value);

  /// @brief Method set_colorSpace, addr 0x68990b8, size 0x58, virtual false, abstract: false, final false
  inline void set_colorSpace(::UnityEngine::ColorSpace value);

  /// @brief Method set_colorSpace_Injected, addr 0x6899110, size 0x44, virtual false, abstract: false, final false
  static inline void set_colorSpace_Injected(::System::IntPtr _unity_self, ::UnityEngine::ColorSpace value);

  /// @brief Method set_mode, addr 0x6898f90, size 0x58, virtual false, abstract: false, final false
  inline void set_mode(::UnityEngine::GradientMode value);

  /// @brief Method set_mode_Injected, addr 0x6898fe8, size 0x44, virtual false, abstract: false, final false
