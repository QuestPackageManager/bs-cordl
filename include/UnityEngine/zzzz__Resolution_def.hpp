...
/// @brief Method ToString, addr 0x68bf9c8, size 0x178, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_height, addr 0x68bf9b8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_height() ;

/// @brief Method get_refreshRateRatio, addr 0x68bf9c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RefreshRate get_refreshRateRatio() ;

/// @brief Method get_width, addr 0x68bf9b0, size 0x8, virtual false, abstract: false, final false
