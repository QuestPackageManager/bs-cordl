...
DEFINE_IL2CPP_CLASS(::UnityEngine::ModifiableContactPatch_Flags, "UnityEngine", "ModifiableContactPatch/Flags");
...
static_assert(sizeof(::UnityEngine::ModifiableContactPatch_Flags) == 0x4, "Size mismatch!");
