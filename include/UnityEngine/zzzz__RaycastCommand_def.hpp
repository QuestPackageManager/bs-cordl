...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x69cadf0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleBatch, addr 0x69caba8, size 0x1ac, virtual false, abstract: false, final false
  static inline ::Unity::Jobs::JobHandle ScheduleBatch(::Unity::Collections::NativeArray_1<::UnityEngine::RaycastCommand> commands,
                                                       ::Unity::Collections::NativeArray_1<::UnityEngine::RaycastHit> results, int32_t minCommandsPerJob, int32_t maxHits,
                                                       ::Unity::Jobs::JobHandle dependsOn);

  /// @brief Method ScheduleRaycastBatch, addr 0x69cad54, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleRaycastBatch_Injected, addr 0x69cae14, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69caea0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69caa80, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69caf6c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69cab3c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_direction, addr 0x69cab70, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_direction();

  /// @brief Method get_distance, addr 0x69cab98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_from, addr 0x69cab58, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_from();

  /// @brief Method get_layerMask, addr 0x69cafa0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerMask();

  /// @brief Method get_maxHits, addr 0x69caf94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxHits();

  /// @brief Method get_physicsScene, addr 0x69cab88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method set_direction, addr 0x69cab7c, size 0xc, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::Vector3 value);

  /// @brief Method set_distance, addr 0x69caba0, size 0x8, virtual false, abstract: false, final false
  inline void set_distance(float_t value);

  /// @brief Method set_from, addr 0x69cab64, size 0xc, virtual false, abstract: false, final false
  inline void set_from(::UnityEngine::Vector3 value);

  /// @brief Method set_layerMask, addr 0x69caf64, size 0x8, virtual false, abstract: false, final false
  inline void set_layerMask(int32_t value);

  /// @brief Method set_maxHits, addr 0x69caf9c, size 0x4, virtual false, abstract: false, final false
  inline void set_maxHits(int32_t value);

  /// @brief Method set_physicsScene, addr 0x69cab90, size 0x8, virtual false, abstract: false, final false
