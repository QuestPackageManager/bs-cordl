...
public:
  // Declarations
  /// @brief Method PropertyNameFromString addr 0x2cc86c4 size 0x4c virtual false final false
  static inline ::UnityEngine::PropertyName PropertyNameFromString(::StringW name);

  /// @brief Method PropertyNameFromString_Injected addr 0x2cc8890 size 0x44 virtual false final false
