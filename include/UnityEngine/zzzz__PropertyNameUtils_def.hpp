...
public:
  // Declarations
  /// @brief Method PropertyNameFromString, addr 0x697fea4, size 0x134, virtual false, abstract: false, final false
  static inline ::UnityEngine::PropertyName PropertyNameFromString(::StringW name);

  /// @brief Method PropertyNameFromString_Injected, addr 0x697ffd8, size 0x44, virtual false, abstract: false, final false
