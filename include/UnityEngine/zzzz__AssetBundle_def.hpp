...
public:
  ...
  /// @brief Method .ctor addr 0x2b34930 size 0x58 virtual false final false
  inline void _ctor();

  /// @brief Method LoadFromFileAsync_Internal addr 0x2b34988 size 0x54 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync_Internal(::StringW path, uint32_t crc, uint64_t offset);

  /// @brief Method LoadFromFileAsync addr 0x2b349dc size 0x44 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync(::StringW path);

  /// @brief Method LoadFromFileAsync addr 0x2b34a20 size 0x48 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync(::StringW path, uint32_t crc);

  /// @brief Method LoadFromFile_Internal addr 0x2b34a68 size 0x54 virtual false final false
  static inline ::UnityEngine::AssetBundle* LoadFromFile_Internal(::StringW path, uint32_t crc, uint64_t offset);

  /// @brief Method LoadFromFile addr 0x2b34abc size 0x44 virtual false final false
  static inline ::UnityEngine::AssetBundle* LoadFromFile(::StringW path);

  /// @brief Method LoadAsset addr 0x2b34b00 size 0x8c virtual false final false
  ...
  /// @brief Method LoadAsset addr 0x2b34b8c size 0x10c virtual false final false
  inline ::UnityEngine::Object* LoadAsset(::StringW name, ::System::Type* type);

  /// @brief Method LoadAsset_Internal addr 0x2b34c98 size 0x54 virtual false final false
  ...
  /// @brief Method LoadAssetAsync addr 0x2b34cec size 0x10c virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetAsync(::StringW name, ::System::Type* type);

  /// @brief Method LoadAssetWithSubAssetsAsync addr 0x2b34e4c size 0x10c virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetWithSubAssetsAsync(::StringW name, ::System::Type* type);

  /// @brief Method LoadAllAssetsAsync addr 0x2b34fac size 0x84 virtual false final false
  ...
  /// @brief Method LoadAllAssetsAsync addr 0x2b35030 size 0xcc virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAllAssetsAsync(::System::Type* type);

  /// @brief Method LoadAssetAsync_Internal addr 0x2b34df8 size 0x54 virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetAsync_Internal(::StringW name, ::System::Type* type);

  /// @brief Method Unload addr 0x2b350fc size 0x44 virtual false final false
  inline void Unload(bool unloadAllLoadedObjects);

  /// @brief Method GetAllAssetNames addr 0x2b35140 size 0x3c virtual false final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllAssetNames();

  /// @brief Method GetAllScenePaths addr 0x2b3517c size 0x3c virtual false final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllScenePaths();

  /// @brief Method LoadAssetWithSubAssetsAsync_Internal addr 0x2b34f58 size 0x54 virtual false final false
