...
public:
  ...
  /// @brief Method .ctor addr 0x2c995d0 size 0x58 virtual false final false
  inline void _ctor();

  /// @brief Method UnloadAllAssetBundles addr 0x2c99628 size 0x3c virtual false final false
  static inline void UnloadAllAssetBundles(bool unloadAllObjects);

  /// @brief Method LoadFromFileAsync_Internal addr 0x2c99664 size 0x54 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync_Internal(::StringW path, uint32_t crc, uint64_t offset);

  /// @brief Method LoadFromFileAsync addr 0x2c996b8 size 0x44 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync(::StringW path);

  /// @brief Method LoadFromFileAsync addr 0x2c996fc size 0x48 virtual false final false
  static inline ::UnityEngine::AssetBundleCreateRequest* LoadFromFileAsync(::StringW path, uint32_t crc);

  /// @brief Method LoadFromFile_Internal addr 0x2c99744 size 0x54 virtual false final false
  static inline ::UnityEngine::AssetBundle* LoadFromFile_Internal(::StringW path, uint32_t crc, uint64_t offset);

  /// @brief Method LoadFromFile addr 0x2c99798 size 0x44 virtual false final false
  static inline ::UnityEngine::AssetBundle* LoadFromFile(::StringW path);

  /// @brief Method LoadAsset addr 0x2c997dc size 0x8c virtual false final false
  ...
  /// @brief Method LoadAsset addr 0x2c99868 size 0x10c virtual false final false
  inline ::UnityEngine::Object* LoadAsset(::StringW name, ::System::Type* type);

  /// @brief Method LoadAsset_Internal addr 0x2c99974 size 0x54 virtual false final false
  ...
  /// @brief Method LoadAssetAsync addr 0x2c999c8 size 0x10c virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetAsync(::StringW name, ::System::Type* type);

  /// @brief Method LoadAssetWithSubAssetsAsync addr 0x2c99b28 size 0x10c virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetWithSubAssetsAsync(::StringW name, ::System::Type* type);

  /// @brief Method LoadAllAssetsAsync addr 0x2c99c88 size 0x84 virtual false final false
  ...
  /// @brief Method LoadAllAssetsAsync addr 0x2c99d0c size 0xcc virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAllAssetsAsync(::System::Type* type);

  /// @brief Method LoadAssetAsync_Internal addr 0x2c99ad4 size 0x54 virtual false final false
  inline ::UnityEngine::AssetBundleRequest* LoadAssetAsync_Internal(::StringW name, ::System::Type* type);

  /// @brief Method Unload addr 0x2c99dd8 size 0x44 virtual false final false
  inline void Unload(bool unloadAllLoadedObjects);

  /// @brief Method GetAllAssetNames addr 0x2c99e1c size 0x3c virtual false final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllAssetNames();

  /// @brief Method GetAllScenePaths addr 0x2c99e58 size 0x3c virtual false final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetAllScenePaths();

  /// @brief Method LoadAssetWithSubAssetsAsync_Internal addr 0x2c99c34 size 0x54 virtual false final false
