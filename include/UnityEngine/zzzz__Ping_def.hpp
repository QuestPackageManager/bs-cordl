...
public:
  ...
  /// @brief Method DestroyPing, addr 0x2de96fc, size 0xa0, virtual false, abstract: false, final false
  inline void DestroyPing();

  /// @brief Method Finalize, addr 0x2de9668, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x2de962c, size 0x3c, virtual false, abstract: false, final false
  static inline void* Internal_Create(::StringW address);

  /// @brief Method Internal_Destroy, addr 0x2de979c, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(void* ptr);

  /// @brief Method Internal_IsDone, addr 0x2de9868, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2de95dc, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method get_isDone, addr 0x2de97d8, size 0x90, virtual false, abstract: false, final false
  inline bool get_isDone();

  /// @brief Method get_time, addr 0x2de98a4, size 0x3c, virtual false, abstract: false, final false
