...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6ad321c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DestroyPing, addr 0x6ad302c, size 0x4c, virtual false, abstract: false, final false
  inline void DestroyPing();

  /// @brief Method Finalize, addr 0x6ad2fac, size 0x80, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x6ad2e80, size 0x12c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create(::StringW address);

  /// @brief Method Internal_Create_Injected, addr 0x6ad30b4, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create_Injected(::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> address);

  /// @brief Method Internal_Destroy, addr 0x6ad3078, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(::System::IntPtr ptr);

  /// @brief Method Internal_IsDone, addr 0x6ad3104, size 0x50, virtual false, abstract: false, final false
  inline bool Internal_IsDone();

  /// @brief Method Internal_IsDone_Injected, addr 0x6ad3154, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ad2e64, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method get_isDone, addr 0x6ad30f0, size 0x14, virtual false, abstract: false, final false
  inline bool get_isDone();

  /// @brief Method get_time, addr 0x6ad3190, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_time();

  /// @brief Method get_time_Injected, addr 0x6ad31e0, size 0x3c, virtual false, abstract: false, final false
