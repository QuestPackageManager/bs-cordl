...
public:
  ...
  /// @brief Method DestroyPing, addr 0x482e254, size 0x5c, virtual false, abstract: false, final false
  inline void DestroyPing();

  /// @brief Method Finalize, addr 0x482e1c0, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Create, addr 0x482e184, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Internal_Create(::StringW address);

  /// @brief Method Internal_Destroy, addr 0x482e2b0, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(::System::IntPtr ptr);

  /// @brief Method Internal_IsDone, addr 0x482e34c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x482e134, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW address);

  /// @brief Method get_isDone, addr 0x482e2ec, size 0x60, virtual false, abstract: false, final false
  inline bool get_isDone();

  /// @brief Method get_time, addr 0x482e388, size 0x3c, virtual false, abstract: false, final false
