...
DEFINE_IL2CPP_CLASS(::UnityEngine::CollisionPairEventFlags, "UnityEngine", "CollisionPairEventFlags");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::CollisionPairEventFlags) == 0x2, "Size mismatch!");
