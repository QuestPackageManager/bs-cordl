...
public:
  ...
  /// @brief Method .ctor, addr 0x48a8a88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* requiredComponent);

  /// @brief Method .ctor, addr 0x48a8ab0, size 0x2c, virtual false, abstract: false, final false
