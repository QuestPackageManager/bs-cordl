...
public:
  ...
  /// @brief Method .ctor, addr 0x6982878, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* requiredComponent);

  /// @brief Method .ctor, addr 0x6982880, size 0x8, virtual false, abstract: false, final false
