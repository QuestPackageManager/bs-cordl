...
public:
  ...
  /// @brief Method .ctor, addr 0x48ac1f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* requiredComponent);

  /// @brief Method .ctor, addr 0x48ac220, size 0x2c, virtual false, abstract: false, final false
