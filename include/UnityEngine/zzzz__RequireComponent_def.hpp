...
public:
  ...
  /// @brief Method .ctor, addr 0x2e2059c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* requiredComponent);

  /// @brief Method .ctor, addr 0x2e205c4, size 0x2c, virtual false, abstract: false, final false
