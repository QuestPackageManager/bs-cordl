...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x49133e4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapSphereBatch, addr 0x49135c8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapSphereBatch_Injected, addr 0x4913664, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4913394, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49132fc, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 point, float_t radius, ::UnityEngine::QueryParameters queryParameters);

  /// @brief Method get_physicsScene, addr 0x49133d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method get_point, addr 0x49133ac, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point();

  /// @brief Method get_radius, addr 0x49133c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_physicsScene, addr 0x49133dc, size 0x8, virtual false, abstract: false, final false
  inline void set_physicsScene(::UnityEngine::PhysicsScene value);

  /// @brief Method set_point, addr 0x49133b8, size 0xc, virtual false, abstract: false, final false
  inline void set_point(::UnityEngine::Vector3 value);

  /// @brief Method set_radius, addr 0x49133cc, size 0x8, virtual false, abstract: false, final false
