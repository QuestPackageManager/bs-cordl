...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IntegratedSubsystem_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IntegratedSubsystem_1(IntegratedSubsystem_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IntegratedSubsystem_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IntegratedSubsystem_1(IntegratedSubsystem_1const&) = delete;
