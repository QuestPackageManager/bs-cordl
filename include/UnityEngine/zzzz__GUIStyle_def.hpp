...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6b4c120, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalcMinMaxWidth, addr 0x6b4bab8, size 0x28, virtual false, abstract: false, final false
  inline void CalcMinMaxWidth(::UnityEngine::GUIContent* content, ::by_ref<float_t> minWidth, ::by_ref<float_t> maxWidth);

  /// @brief Method CalcSizeWithConstraints, addr 0x6b4748c, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalcSizeWithConstraints(::UnityEngine::GUIContent* content, ::UnityEngine::Vector2 constraints);

  /// @brief Method Draw, addr 0x6b42dac, size 0x14, virtual false, abstract: false, final false
  inline void Draw(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID);

  /// @brief Method Draw, addr 0x6b425a4, size 0xd4, virtual false, abstract: false, final false
  inline void Draw(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID, bool on, bool hover);

  /// @brief Method Draw, addr 0x6b4b57c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x6b4b21c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method Internal_CalcSizeWithConstraints_Injected, addr 0x6b4ac18, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw2_Injected, addr 0x6b4aae8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw_Injected, addr 0x6b4a990, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetTextRectOffset_Injected, addr 0x6b4af54, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTooltipActive_Injected, addr 0x6b4b004, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMouseTooltip_Injected, addr 0x6b4afc0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x6b4bae0, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b47730, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_alignment, addr 0x6b49bdc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::TextAnchor get_alignment();

  /// @brief Method get_alignment_Injected, addr 0x6b49c70, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextAnchor get_alignment_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_clipping, addr 0x6b49e64, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::TextClipping get_clipping();

  /// @brief Method get_clipping_Injected, addr 0x6b49ef8, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextClipping get_clipping_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_contentOffset, addr 0x6b49f34, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_contentOffset();

  /// @brief Method get_contentOffset_Injected, addr 0x6b49fe0, size 0x44, virtual false, abstract: false, final false
  static inline void get_contentOffset_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Vector2> ret);

  /// @brief Method get_fixedHeight, addr 0x6b4a0f4, size 0x94, virtual false, abstract: false, final false
  inline float_t get_fixedHeight();

  /// @brief Method get_fixedHeight_Injected, addr 0x6b4a188, size 0x3c, virtual false, abstract: false, final false
  static inline float_t get_fixedHeight_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_fixedWidth, addr 0x6b4a024, size 0x94, virtual false, abstract: false, final false
  inline float_t get_fixedWidth();

  /// @brief Method get_fixedWidth_Injected, addr 0x6b4a0b8, size 0x3c, virtual false, abstract: false, final false
  static inline float_t get_fixedWidth_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_font, addr 0x6b4996c, size 0x164, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_font();

  /// @brief Method get_fontSize, addr 0x6b4a3ec, size 0x94, virtual false, abstract: false, final false
  inline int32_t get_fontSize();

  /// @brief Method get_fontSize_Injected, addr 0x6b4a480, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_fontSize_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_fontStyle, addr 0x6b4a4bc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::FontStyle get_fontStyle();

  /// @brief Method get_fontStyle_Injected, addr 0x6b4a550, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::FontStyle get_fontStyle_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_font_Injected, addr 0x6b49ad0, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_font_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_imagePosition, addr 0x6b49b0c, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::ImagePosition get_imagePosition();

  /// @brief Method get_imagePosition_Injected, addr 0x6b49ba0, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::ImagePosition get_imagePosition_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_isHeightDependantOnWidth, addr 0x6b47370, size 0x40, virtual false, abstract: false, final false
  inline bool get_isHeightDependantOnWidth();

  /// @brief Method get_lineHeight, addr 0x6b4b3b8, size 0xdc, virtual false, abstract: false, final false
  inline float_t get_lineHeight();

  /// @brief Method get_margin, addr 0x6b4b2d8, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_margin();

  /// @brief Method get_name, addr 0x6b48edc, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_none, addr 0x6b42d20, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIStyle* get_none();

  /// @brief Method get_normal, addr 0x6b48fa4, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyleState* get_normal();

  /// @brief Method get_padding, addr 0x6b4b348, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_padding();

  /// @brief Method get_rawName, addr 0x6b49620, size 0x148, virtual false, abstract: false, final false
  inline ::StringW get_rawName();

  /// @brief Method get_rawName_Injected, addr 0x6b49768, size 0x44, virtual false, abstract: false, final false
  static inline void get_rawName_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method get_richText, addr 0x6b4a58c, size 0x94, virtual false, abstract: false, final false
  inline bool get_richText();

  /// @brief Method get_richText_Injected, addr 0x6b4a620, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_richText_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_stretchHeight, addr 0x6b4a2d8, size 0x94, virtual false, abstract: false, final false
  inline bool get_stretchHeight();

  /// @brief Method get_stretchHeight_Injected, addr 0x6b4a36c, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_stretchHeight_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_stretchWidth, addr 0x6b4a1c4, size 0x94, virtual false, abstract: false, final false
  inline bool get_stretchWidth();

  /// @brief Method get_stretchWidth_Injected, addr 0x6b4a258, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_stretchWidth_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_wordWrap, addr 0x6b49d94, size 0x94, virtual false, abstract: false, final false
  inline bool get_wordWrap();

  /// @brief Method get_wordWrap_Injected, addr 0x6b49e28, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_alignment, addr 0x6b49cac, size 0xa4, virtual false, abstract: false, final false
  inline void set_alignment(::UnityEngine::TextAnchor value);

  /// @brief Method set_alignment_Injected, addr 0x6b49d50, size 0x44, virtual false, abstract: false, final false
  static inline void set_alignment_Injected(::System::IntPtr _unity_self, ::UnityEngine::TextAnchor value);

  /// @brief Method set_name, addr 0x6b481cc, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_rawName, addr 0x6b497ac, size 0x17c, virtual false, abstract: false, final false
  inline void set_rawName(::StringW value);

  /// @brief Method set_rawName_Injected, addr 0x6b49928, size 0x44, virtual false, abstract: false, final false
  static inline void set_rawName_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> value);

  /// @brief Method set_stretchHeight, addr 0x6b48f00, size 0xa4, virtual false, abstract: false, final false
  inline void set_stretchHeight(bool value);

  /// @brief Method set_stretchHeight_Injected, addr 0x6b4a3a8, size 0x44, virtual false, abstract: false, final false
  static inline void set_stretchHeight_Injected(::System::IntPtr _unity_self, bool value);

  /// @brief Method set_stretchWidth, addr 0x6b477b0, size 0xa4, virtual false, abstract: false, final false
  inline void set_stretchWidth(bool value);

  /// @brief Method set_stretchWidth_Injected, addr 0x6b4a294, size 0x44, virtual false, abstract: false, final false
