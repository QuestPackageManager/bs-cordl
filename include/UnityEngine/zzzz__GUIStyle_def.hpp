...
public:
  ...
  /// @brief Method get_rawName, addr 0x2d18248, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_rawName();

  /// @brief Method set_rawName, addr 0x2d18284, size 0x44, virtual false, abstract: false, final false
  inline void set_rawName(::StringW value);

  /// @brief Method get_font, addr 0x2d182c8, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_font();

  /// @brief Method set_font, addr 0x2d18304, size 0x44, virtual false, abstract: false, final false
  inline void set_font(::UnityEngine::Font* value);

  /// @brief Method get_imagePosition, addr 0x2d18348, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::ImagePosition get_imagePosition();

  /// @brief Method set_alignment, addr 0x2d18384, size 0x44, virtual false, abstract: false, final false
  inline void set_alignment(::UnityEngine::TextAnchor value);

  /// @brief Method get_wordWrap, addr 0x2d183c8, size 0x3c, virtual false, abstract: false, final false
  inline bool get_wordWrap();

  /// @brief Method set_wordWrap, addr 0x2d18404, size 0x44, virtual false, abstract: false, final false
  inline void set_wordWrap(bool value);

  /// @brief Method set_clipping, addr 0x2d18448, size 0x44, virtual false, abstract: false, final false
  inline void set_clipping(::UnityEngine::TextClipping value);

  /// @brief Method get_fixedWidth, addr 0x2d17b38, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_fixedWidth();

  /// @brief Method get_fixedHeight, addr 0x2d17d1c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_fixedHeight();

  /// @brief Method get_stretchWidth, addr 0x2d1848c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_stretchWidth();

  /// @brief Method get_stretchHeight, addr 0x2d184c8, size 0x3c, virtual false, abstract: false, final false
  inline bool get_stretchHeight();

  /// @brief Method set_stretchHeight, addr 0x2d18504, size 0x44, virtual false, abstract: false, final false
  inline void set_stretchHeight(bool value);

  /// @brief Method set_fontSize, addr 0x2d18548, size 0x44, virtual false, abstract: false, final false
  inline void set_fontSize(int32_t value);

  /// @brief Method set_fontStyle, addr 0x2d1858c, size 0x44, virtual false, abstract: false, final false
  inline void set_fontStyle(::UnityEngine::FontStyle value);

  /// @brief Method set_richText, addr 0x2d185d0, size 0x44, virtual false, abstract: false, final false
  inline void set_richText(bool value);

  /// @brief Method Internal_Create, addr 0x2d18614, size 0x3c, virtual false, abstract: false, final false
  static inline void* Internal_Create(::UnityEngine::GUIStyle* self);

  /// @brief Method Internal_Copy, addr 0x2d18650, size 0x44, virtual false, abstract: false, final false
  static inline void* Internal_Copy(::UnityEngine::GUIStyle* self, ::UnityEngine::GUIStyle* other);

  /// @brief Method Internal_Destroy, addr 0x2d18694, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(void* self);

  /// @brief Method GetStyleStatePtr, addr 0x2d186d0, size 0x44, virtual false, abstract: false, final false
  inline void* GetStyleStatePtr(int32_t idx);

  /// @brief Method GetRectOffsetPtr, addr 0x2d18714, size 0x44, virtual false, abstract: false, final false
  inline void* GetRectOffsetPtr(int32_t idx);

  /// @brief Method Internal_GetLineHeight, addr 0x2d18758, size 0x3c, virtual false, abstract: false, final false
  static inline float_t Internal_GetLineHeight(void* target);

  /// @brief Method Internal_Draw, addr 0x2d18794, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw2, addr 0x2d188a4, size 0x74, virtual false, abstract: false, final false
  inline void Internal_Draw2(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID, bool on);

  /// @brief Method Internal_GetCursorPixelPosition, addr 0x2d18984, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorStringIndex, addr 0x2d18a64, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetSelectedRenderedText, addr 0x2d18b24, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CalcSize, addr 0x2d18c04, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcSize(::UnityEngine::GUIContent* content);

  /// @brief Method Internal_CalcSizeWithConstraints, addr 0x2d18cb4, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcSizeWithConstraints(::UnityEngine::GUIContent* content, ::UnityEngine::Vector2 maxSize);

  /// @brief Method Internal_CalcHeight, addr 0x2d18d74, size 0x54, virtual false, abstract: false, final false
  inline float_t Internal_CalcHeight(::UnityEngine::GUIContent* content, float_t width);

  /// @brief Method Internal_CalcMinMaxWidth, addr 0x2d18dc8, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 Internal_CalcMinMaxWidth(::UnityEngine::GUIContent* content);

  /// @brief Method SetMouseTooltip, addr 0x2d18e78, size 0x8c, virtual false, abstract: false, final false
  static inline void SetMouseTooltip(::StringW tooltip, ::UnityEngine::Rect screenRect);

  /// @brief Method IsTooltipActive, addr 0x2d18f48, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsTooltipActive(::StringW tooltip);

  /// @brief Method SetDefaultFont, addr 0x2d18f84, size 0x3c, virtual false, abstract: false, final false
  static inline void SetDefaultFont(::UnityEngine::Font* font);

  static inline ::UnityEngine::GUIStyle* New_ctor();

  /// @brief Method .ctor, addr 0x2d18fc0, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::GUIStyle* New_ctor(::UnityEngine::GUIStyle* other);

  /// @brief Method .ctor, addr 0x2d19048, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GUIStyle* other);

  /// @brief Method Finalize, addr 0x2d1912c, size 0x144, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method get_name, addr 0x2d19270, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x2d192bc, size 0x48, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method get_normal, addr 0x2d19304, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyleState* get_normal();

  /// @brief Method get_border, addr 0x2d19360, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_border();

  /// @brief Method get_margin, addr 0x2d17b74, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_margin();

  /// @brief Method get_padding, addr 0x2d19408, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::RectOffset* get_padding();

  /// @brief Method get_lineHeight, addr 0x2d194b0, size 0xfc, virtual false, abstract: false, final false
  inline float_t get_lineHeight();

  /// @brief Method Draw, addr 0x2d195ac, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Draw, addr 0x2d195e4, size 0xa0, virtual false, abstract: false, final false
  inline void Draw(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, int32_t controlID, bool on, bool hover);

  /// @brief Method Draw, addr 0x2d195c0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_none, addr 0x2d19684, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIStyle* get_none();

  /// @brief Method GetCursorPixelPosition, addr 0x2d19714, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorStringIndex, addr 0x2d19718, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CalcSize, addr 0x2d1971c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalcSize(::UnityEngine::GUIContent* content);

  /// @brief Method CalcSizeWithConstraints, addr 0x2d19720, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 CalcSizeWithConstraints(::UnityEngine::GUIContent* content, ::UnityEngine::Vector2 constraints);

  /// @brief Method CalcHeight, addr 0x2d19724, size 0x54, virtual false, abstract: false, final false
  inline float_t CalcHeight(::UnityEngine::GUIContent* content, float_t width);

  /// @brief Method get_isHeightDependantOnWidth, addr 0x2d19778, size 0xac, virtual false, abstract: false, final false
  inline bool get_isHeightDependantOnWidth();

  /// @brief Method CalcMinMaxWidth, addr 0x2d19824, size 0x28, virtual false, abstract: false, final false
  inline void CalcMinMaxWidth(::UnityEngine::GUIContent* content, ByRef<float_t> minWidth, ByRef<float_t> maxWidth);

  /// @brief Method ToString, addr 0x2d1984c, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Internal_Draw_Injected, addr 0x2d18820, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Draw2_Injected, addr 0x2d18918, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorPixelPosition_Injected, addr 0x2d189f8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetCursorStringIndex_Injected, addr 0x2d18ac8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetSelectedRenderedText_Injected, addr 0x2d18b98, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CalcSize_Injected, addr 0x2d18c60, size 0x54, virtual false, abstract: false, final false
  inline void Internal_CalcSize_Injected(::UnityEngine::GUIContent* content, ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method Internal_CalcSizeWithConstraints_Injected, addr 0x2d18d18, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CalcMinMaxWidth_Injected, addr 0x2d18e24, size 0x54, virtual false, abstract: false, final false
  inline void Internal_CalcMinMaxWidth_Injected(::UnityEngine::GUIContent* content, ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method SetMouseTooltip_Injected, addr 0x2d18f04, size 0x44, virtual false, abstract: false, final false
