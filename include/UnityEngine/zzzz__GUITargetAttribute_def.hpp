...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GUITargetAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GUITargetAttribute(GUITargetAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GUITargetAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GUITargetAttribute(GUITargetAttributeconst&) = delete;
