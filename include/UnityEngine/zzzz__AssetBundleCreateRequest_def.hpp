...
public:
  ...
  /// @brief Method .ctor, addr 0x4865920, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetBundle, addr 0x48658e4, size 0x3c, virtual false, abstract: false, final false
