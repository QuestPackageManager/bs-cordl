...
public:
  ...
  /// @brief Method .ctor, addr 0x31c7b04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetBundle, addr 0x31c7ac8, size 0x3c, virtual false, abstract: false, final false
