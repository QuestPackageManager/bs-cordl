...
public:
  ...
  /// @brief Method GetHumanoidBodyPartActive, addr 0x2c8ba50, size 0x44, virtual false, abstract: false, final false
  inline bool GetHumanoidBodyPartActive(::UnityEngine::AvatarMaskBodyPart index);

  /// @brief Method get_transformCount, addr 0x2c8ba94, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_transformCount();

  /// @brief Method GetTransformPath, addr 0x2c8bad0, size 0x44, virtual false, abstract: false, final false
  inline ::StringW GetTransformPath(int32_t index);

  /// @brief Method GetTransformWeight, addr 0x2c8bb14, size 0x44, virtual false, abstract: false, final false
  inline float_t GetTransformWeight(int32_t index);

  /// @brief Method GetTransformActive, addr 0x2c8bb58, size 0x54, virtual false, abstract: false, final false
