...
/// @brief Method GetCustomLowpassLevelCurveCopy, addr 0x6885024, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::AnimationCurve* GetCustomLowpassLevelCurveCopy() ;

/// @brief Method GetCustomLowpassLevelCurveCopy_Injected, addr 0x68850bc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetCustomLowpassLevelCurveHelper, addr 0x68850f8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method SetCustomLowpassLevelCurveHelper_Injected, addr 0x68851b4, size 0x44, virtual false, abstract: false, final false
static inline void SetCustomLowpassLevelCurveHelper_Injected(::System::IntPtr  source, ::System::IntPtr  curve) ;

/// @brief Method .ctor, addr 0x6885530, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_customCutoffCurve, addr 0x68851f8, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::AnimationCurve* get_customCutoffCurve() ;

/// @brief Method get_cutoffFrequency, addr 0x6885200, size 0x80, virtual false, abstract: false, final false
inline float_t get_cutoffFrequency() ;

/// @brief Method get_cutoffFrequency_Injected, addr 0x6885280, size 0x3c, virtual false, abstract: false, final false
static inline float_t get_cutoffFrequency_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_lowpassResonanceQ, addr 0x6885398, size 0x80, virtual false, abstract: false, final false
inline float_t get_lowpassResonanceQ() ;

/// @brief Method get_lowpassResonanceQ_Injected, addr 0x6885418, size 0x3c, virtual false, abstract: false, final false
static inline float_t get_lowpassResonanceQ_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method set_customCutoffCurve, addr 0x68851fc, size 0x4, virtual false, abstract: false, final false
inline void set_customCutoffCurve(::UnityEngine::AnimationCurve*  value) ;

/// @brief Method set_cutoffFrequency, addr 0x68852bc, size 0x90, virtual false, abstract: false, final false
inline void set_cutoffFrequency(float_t  value) ;

/// @brief Method set_cutoffFrequency_Injected, addr 0x688534c, size 0x4c, virtual false, abstract: false, final false
static inline void set_cutoffFrequency_Injected(::System::IntPtr  _unity_self, float_t  value) ;

/// @brief Method set_lowpassResonanceQ, addr 0x6885454, size 0x90, virtual false, abstract: false, final false
inline void set_lowpassResonanceQ(float_t  value) ;

/// @brief Method set_lowpassResonanceQ_Injected, addr 0x68854e4, size 0x4c, virtual false, abstract: false, final false
