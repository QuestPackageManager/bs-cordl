...
public:
  ...
  /// @brief Method GetCustomLowpassLevelCurveCopy, addr 0x6a4f9f8, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* GetCustomLowpassLevelCurveCopy();

  /// @brief Method GetCustomLowpassLevelCurveCopy_Injected, addr 0x6a4fa90, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCustomLowpassLevelCurveHelper, addr 0x6a4facc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCustomLowpassLevelCurveHelper_Injected, addr 0x6a4fb88, size 0x44, virtual false, abstract: false, final false
  static inline void SetCustomLowpassLevelCurveHelper_Injected(::System::IntPtr source, ::System::IntPtr curve);

  /// @brief Method .ctor, addr 0x6a4ff04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customCutoffCurve, addr 0x6a4fbcc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* get_customCutoffCurve();

  /// @brief Method get_cutoffFrequency, addr 0x6a4fbd4, size 0x80, virtual false, abstract: false, final false
  inline float_t get_cutoffFrequency();

  /// @brief Method get_cutoffFrequency_Injected, addr 0x6a4fc54, size 0x3c, virtual false, abstract: false, final false
  static inline float_t get_cutoffFrequency_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_lowpassResonanceQ, addr 0x6a4fd6c, size 0x80, virtual false, abstract: false, final false
  inline float_t get_lowpassResonanceQ();

  /// @brief Method get_lowpassResonanceQ_Injected, addr 0x6a4fdec, size 0x3c, virtual false, abstract: false, final false
  static inline float_t get_lowpassResonanceQ_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_customCutoffCurve, addr 0x6a4fbd0, size 0x4, virtual false, abstract: false, final false
  inline void set_customCutoffCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method set_cutoffFrequency, addr 0x6a4fc90, size 0x90, virtual false, abstract: false, final false
  inline void set_cutoffFrequency(float_t value);

  /// @brief Method set_cutoffFrequency_Injected, addr 0x6a4fd20, size 0x4c, virtual false, abstract: false, final false
  static inline void set_cutoffFrequency_Injected(::System::IntPtr _unity_self, float_t value);

  /// @brief Method set_lowpassResonanceQ, addr 0x6a4fe28, size 0x90, virtual false, abstract: false, final false
  inline void set_lowpassResonanceQ(float_t value);

  /// @brief Method set_lowpassResonanceQ_Injected, addr 0x6a4feb8, size 0x4c, virtual false, abstract: false, final false
