...
public:
  ...
  /// @brief Method Dispose, addr 0x6a2d638, size 0x5c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x6a2d5f4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a2d59c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr jobject);

  /// @brief Method op_Implicit, addr 0x6a2d694, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GlobalJavaObjectRef", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlobalJavaObjectRef(GlobalJavaObjectRef&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlobalJavaObjectRef", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlobalJavaObjectRef(GlobalJavaObjectRefconst&) = delete;
