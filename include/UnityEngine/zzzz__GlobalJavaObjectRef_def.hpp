...
public:
  ...
  /// @brief Method Dispose, addr 0x67f514c, size 0x5c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x67f5108, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f50b0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr jobject);

  /// @brief Method op_Implicit, addr 0x67f51a8, size 0x14, virtual false, abstract: false, final false
