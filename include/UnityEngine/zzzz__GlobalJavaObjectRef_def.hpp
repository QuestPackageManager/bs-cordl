...
public:
  ...
  /// @brief Method Dispose, addr 0x31af298, size 0x7c, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x31af204, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31af114, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(void* jobject);

  /// @brief Method op_Implicit, addr 0x31af314, size 0x18, virtual false, abstract: false, final false
