...
public:
  ...
  /// @brief Method Dispose, addr 0x4849e30, size 0x40, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x4849d9c, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4849d2c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr jobject);

  /// @brief Method op_Implicit, addr 0x4849e70, size 0x18, virtual false, abstract: false, final false
