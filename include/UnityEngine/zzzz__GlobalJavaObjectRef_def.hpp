...
public:
  ...
  /// @brief Method Dispose, addr 0x48471d8, size 0x40, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x4847144, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48470d4, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr jobject);

  /// @brief Method op_Implicit, addr 0x4847218, size 0x18, virtual false, abstract: false, final false
