...
DEFINE_IL2CPP_CLASS(::UnityEngine::TransparencySortMode, "UnityEngine", "TransparencySortMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::TransparencySortMode) == 0x4, "Size mismatch!");
