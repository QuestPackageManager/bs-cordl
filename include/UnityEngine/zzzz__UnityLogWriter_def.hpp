...
public:
  ...
  /// @brief Method WriteStringToUnityLog addr 0x2b3c45c size 0x44 virtual false final false
  static inline void WriteStringToUnityLog(::StringW s);

  /// @brief Method WriteStringToUnityLogImpl addr 0x2b3c4a0 size 0x3c virtual false final false
  static inline void WriteStringToUnityLogImpl(::StringW s);

  /// @brief Method Init addr 0x2b3c4dc size 0x80 virtual false final false
  static inline void Init();

  /// @brief Method get_Encoding addr 0x2b3c5b4 size 0x8 virtual true final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method Write addr 0x2b3c5bc size 0x54 virtual true final false
  inline void Write(char16_t value);

  /// @brief Method Write addr 0x2b3c610 size 0x44 virtual true final false
  inline void Write(::StringW s);

  /// @brief Method Write addr 0x2b3c654 size 0x48 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2b3c55c size 0x58 virtual false final false
  inline void _ctor();
