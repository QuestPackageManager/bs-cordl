...
public:
  ...
  /// @brief Method WriteStringToUnityLog, addr 0x2ca115c, size 0x44, virtual false, abstract: false, final false
  static inline void WriteStringToUnityLog(::StringW s);

  /// @brief Method WriteStringToUnityLogImpl, addr 0x2ca11a0, size 0x3c, virtual false, abstract: false, final false
  static inline void WriteStringToUnityLogImpl(::StringW s);

  /// @brief Method Init, addr 0x2ca11dc, size 0x80, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method get_Encoding, addr 0x2ca12b4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Text::Encoding* get_Encoding();

  /// @brief Method Write, addr 0x2ca12bc, size 0x54, virtual true, abstract: false, final false
  inline void Write(char16_t value);

  /// @brief Method Write, addr 0x2ca1310, size 0x44, virtual true, abstract: false, final false
  inline void Write(::StringW s);

  /// @brief Method Write, addr 0x2ca1354, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ca125c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
