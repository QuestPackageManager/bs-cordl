...
DEFINE_IL2CPP_CLASS(::UnityEngine::FindObjectsInactive, "UnityEngine", "FindObjectsInactive");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::FindObjectsInactive) == 0x4, "Size mismatch!");
