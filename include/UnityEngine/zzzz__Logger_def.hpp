...
public:
  ...
  /// @brief Method GetString, addr 0x33d89a8, size 0x120, virtual false, abstract: false, final false
  static inline ::StringW GetString(::System::Object* message);

  /// @brief Method IsLogTypeAllowed, addr 0x33d896c, size 0x3c, virtual true, abstract: false, final true
  inline bool IsLogTypeAllowed(::UnityEngine::LogType logType);

  /// @brief Method Log, addr 0x33d8ac8, size 0x174, virtual true, abstract: false, final true
  inline void Log(::UnityEngine::LogType logType, ::System::Object* message);

  /// @brief Method Log, addr 0x33d8c3c, size 0x178, virtual true, abstract: false, final true
  inline void Log(::UnityEngine::LogType logType, ::System::Object* message, ::UnityEngine::Object* context);

  /// @brief Method LogError, addr 0x33d8db4, size 0x190, virtual true, abstract: false, final true
  inline void LogError(::StringW tag, ::System::Object* message);

  /// @brief Method LogException, addr 0x33d8f44, size 0xd4, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception, ::UnityEngine::Object* context);

  /// @brief Method LogFormat, addr 0x33d9110, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method LogFormat, addr 0x33d9018, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33d86b0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ILogHandler* logHandler);

  /// @brief Method get_filterLogType, addr 0x33d895c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::LogType get_filterLogType();

  /// @brief Method get_logEnabled, addr 0x33d8948, size 0x8, virtual true, abstract: false, final true
  inline bool get_logEnabled();

  /// @brief Method get_logHandler, addr 0x33d8938, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_filterLogType, addr 0x33d8964, size 0x8, virtual true, abstract: false, final true
  inline void set_filterLogType(::UnityEngine::LogType value);

  /// @brief Method set_logEnabled, addr 0x33d8950, size 0xc, virtual true, abstract: false, final true
  inline void set_logEnabled(bool value);

  /// @brief Method set_logHandler, addr 0x33d8940, size 0x8, virtual true, abstract: false, final true
