...
public:
  ...
  /// @brief Method Apply, addr 0x489729c, size 0xc, virtual false, abstract: false, final false
  inline void Apply();

  /// @brief Method Apply, addr 0x4897210, size 0x8c, virtual false, abstract: false, final false
  inline void Apply(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method ApplyImpl, addr 0x4896aa8, size 0x54, virtual false, abstract: false, final false
  inline void ApplyImpl(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method Internal_Create, addr 0x48969b4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CreateImpl, addr 0x4896918, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPixels32, addr 0x4896b50, size 0x48, virtual false, abstract: false, final false
  inline void SetPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors);

  /// @brief Method SetPixels32, addr 0x4896afc, size 0x54, virtual false, abstract: false, final false
  inline void SetPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors, int32_t miplevel);

  /// @brief Method ValidateIsNotCrunched, addr 0x4896ddc, size 0x54, virtual false, abstract: false, final false
  static inline void ValidateIsNotCrunched(::UnityEngine::Experimental::Rendering::TextureCreationFlags flags);

  /// @brief Method .ctor, addr 0x4896b98, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4896c8c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::Experimental::Rendering::DefaultFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);

  /// @brief Method .ctor, addr 0x4896bec, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4896cf0, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);

  /// @brief Method .ctor, addr 0x4896fd0, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method .ctor, addr 0x4897088, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x489714c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4896e30, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::TextureFormat textureFormat, int32_t mipCount);

  /// @brief Method .ctor, addr 0x4896e50, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4896e6c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isReadable, addr 0x48968dc, size 0x3c, virtual true, abstract: false, final false
