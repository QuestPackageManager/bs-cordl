...
public:
  ...
  /// @brief Method get_isReadable, addr 0x2cb1648, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl, addr 0x2cb1684, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create, addr 0x2cb1710, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyImpl, addr 0x2cb17f0, size 0x54, virtual false, abstract: false, final false
  inline void ApplyImpl(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method SetPixels32, addr 0x2cb1844, size 0x54, virtual false, abstract: false, final false
  inline void SetPixels32(::ArrayW<::UnityEngine::Color32, ::Array<::UnityEngine::Color32>*> colors, int32_t miplevel);

  /// @brief Method SetPixels32, addr 0x2cb1898, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb18e0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb1934, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb19d4, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor, addr 0x2cb1b18, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb1c64, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb1d98, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb1da8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Apply, addr 0x2cb1db8, size 0x8c, virtual false, abstract: false, final false
  inline void Apply(bool updateMipmaps, bool makeNoLongerReadable);

  /// @brief Method Apply, addr 0x2cb1e44, size 0xc, virtual false, abstract: false, final false
  inline void Apply();

  /// @brief Method ValidateIsNotCrunched, addr 0x2cb1ac0, size 0x58, virtual false, abstract: false, final false
