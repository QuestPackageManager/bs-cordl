...
#include "UnityEngine/zzzz__NoAllocHelpers_def.hpp"
template<typename T>
constexpr ::ArrayW<T,::Array<T>*>& UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1<T>::__cordl_internal_get__items()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*> const& UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1<T>::__cordl_internal_get__items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr void UnityEngine::NoAllocHelpers_ListPrivateFieldAccess_1<T>::__cordl_internal_set__items(::ArrayW<T,::Array<T>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)(::System::Array*)>(&::UnityEngine::NoAllocHelpers::SafeLength)> {
  ...
  constexpr static std::size_t addrs = 0x691bb40;
...
template<typename T>
inline ::ArrayW<T,::Array<T>*> UnityEngine::NoAllocHelpers::ExtractArrayFromList(::System::Collections::Generic::List_1<T>*  list)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::NoAllocHelpers*>::get(),
...
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ...
                    "ResetListContents",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
                    ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<T>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::ReadOnlySpan_1<T>>::get()}
                )));
static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(
                    ___internal_method_base,
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}
