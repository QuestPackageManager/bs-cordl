...
public:
  // Declarations
  /// @brief Method InvokeMoveNext addr 0x2b6a56c size 0x154 virtual false final false
  static inline void InvokeMoveNext(::System::Collections::IEnumerator* enumerator, void* returnValueAddress);

  /// @brief Method InvokeMember addr 0x2b6a6c0 size 0xf4 virtual false final false
