...
public:
  // Declarations
  /// @brief Method InvokeMember, addr 0x48b6cbc, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Object* InvokeMember(::System::Object* behaviour, ::StringW name, ::System::Object* variable);

  /// @brief Method InvokeMoveNext, addr 0x48b6b90, size 0x12c, virtual false, abstract: false, final false
