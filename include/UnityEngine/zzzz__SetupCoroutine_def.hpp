...
public:
  // Declarations
  /// @brief Method InvokeMember, addr 0x2e1e9f4, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Object* InvokeMember(::System::Object* behaviour, ::StringW name, ::System::Object* variable);

  /// @brief Method InvokeMoveNext, addr 0x2e1e8a0, size 0x154, virtual false, abstract: false, final false
