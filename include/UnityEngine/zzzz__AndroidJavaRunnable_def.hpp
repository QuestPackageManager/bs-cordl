...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x31af0dc, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::AndroidJavaRunnable* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x31af020, size 0xbc, virtual false, abstract: false, final false
