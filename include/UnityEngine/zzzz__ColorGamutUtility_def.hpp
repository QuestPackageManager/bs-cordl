...
public:
// Declarations
/// @brief Method GetColorPrimaries, addr 0x68bf8fc, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityEngine::ColorPrimaries GetColorPrimaries(::UnityEngine::ColorGamut  gamut) ;

/// @brief Method GetTransferFunction, addr 0x68bf974, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityEngine::TransferFunction GetTransferFunction(::UnityEngine::ColorGamut  gamut) ;

/// @brief Method GetWhitePoint, addr 0x68bf938, size 0x3c, virtual false, abstract: false, final false
