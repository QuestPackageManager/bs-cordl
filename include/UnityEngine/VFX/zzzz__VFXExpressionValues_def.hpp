...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6e2959c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateExpressionValuesWrapper, addr 0x6e29208, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::VFX::VFXExpressionValues* CreateExpressionValuesWrapper(::System::IntPtr ptr);

  /// @brief Method GetBool, addr 0x6e29260, size 0x58, virtual false, abstract: false, final false
  inline bool GetBool(int32_t nameID);

  /// @brief Method GetBool_Injected, addr 0x6e292b8, size 0x44, virtual false, abstract: false, final false
  static inline bool GetBool_Injected(::System::IntPtr _unity_self, int32_t nameID);

  /// @brief Method GetFloat, addr 0x6e29434, size 0x58, virtual false, abstract: false, final false
  inline float_t GetFloat(int32_t nameID);

  /// @brief Method GetFloat_Injected, addr 0x6e2948c, size 0x44, virtual false, abstract: false, final false
  static inline float_t GetFloat_Injected(::System::IntPtr _unity_self, int32_t nameID);

  /// @brief Method GetInt, addr 0x6e292fc, size 0x58, virtual false, abstract: false, final false
  inline int32_t GetInt(int32_t nameID);

  /// @brief Method GetInt_Injected, addr 0x6e29354, size 0x44, virtual false, abstract: false, final false
  static inline int32_t GetInt_Injected(::System::IntPtr _unity_self, int32_t nameID);

  /// @brief Method GetUInt, addr 0x6e29398, size 0x58, virtual false, abstract: false, final false
  inline uint32_t GetUInt(int32_t nameID);

  /// @brief Method GetUInt_Injected, addr 0x6e293f0, size 0x44, virtual false, abstract: false, final false
  static inline uint32_t GetUInt_Injected(::System::IntPtr _unity_self, int32_t nameID);

  /// @brief Method GetVector3, addr 0x6e294d0, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetVector3(int32_t nameID);

  /// @brief Method GetVector3_Injected, addr 0x6e29548, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e29204, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
