...
public:
  ...
  /// @brief Method IsValid, addr 0x69de674, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x69de6e8, size 0x60, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ToString, addr 0x69de858, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69de748, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69de918, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_KeyProperty, addr 0x69de60c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_KeyProperty();

  /// @brief Method get_KeySmoothProperty, addr 0x69de640, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_KeySmoothProperty();

  /// @brief Method set_KeyProperty, addr 0x69de624, size 0x1c, virtual false, abstract: false, final false
  inline void set_KeyProperty(::StringW value);

  /// @brief Method set_KeySmoothProperty, addr 0x69de658, size 0x1c, virtual false, abstract: false, final false
