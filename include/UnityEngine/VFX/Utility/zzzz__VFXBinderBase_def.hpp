...
public:
  ...
  /// @brief Method Awake, addr 0x69e39bc, size 0x54, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method OnDisable, addr 0x69e3a10, size 0xa4, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x69e0024, size 0xec, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Reset, addr 0x69e39b8, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x69e3ab4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e0008, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
