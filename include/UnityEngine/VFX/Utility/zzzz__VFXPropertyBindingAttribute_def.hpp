...
public:
  ...
  static inline ::UnityEngine::VFX::Utility::VFXPropertyBindingAttribute* New_ctor(/* [ParamArray] */ ::ArrayW<::StringW> editorTypes);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VFXPropertyBindingAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VFXPropertyBindingAttribute(VFXPropertyBindingAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VFXPropertyBindingAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VFXPropertyBindingAttribute(VFXPropertyBindingAttributeconst&) = delete;
