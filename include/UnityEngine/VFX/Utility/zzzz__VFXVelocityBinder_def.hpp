...
public:
  ...
  /// @brief Method IsValid, addr 0x69e34ac, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x69e3558, size 0x64, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x69e3788, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69e35bc, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e3884, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline float_t getStaticF_invalidPreviousTime();

  /// @brief Method get_Property, addr 0x69e3474, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  static inline void setStaticF_invalidPreviousTime(float_t value);

  /// @brief Method set_Property, addr 0x69e348c, size 0x20, virtual false, abstract: false, final false
