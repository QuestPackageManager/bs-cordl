...
public:
  ...
  /// @brief Method IsValid, addr 0x69e3228, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69e331c, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69e32d4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e3418, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Property, addr 0x69e31f0, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  /// @brief Method set_Property, addr 0x69e3208, size 0x20, virtual false, abstract: false, final false
