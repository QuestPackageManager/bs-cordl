...
public:
  ...
  /// @brief Method IsValid, addr 0x69e24e0, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x69e24c4, size 0x18, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x69e24dc, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method ToString, addr 0x69e2734, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69e25ec, size 0x148, virtual true, abstract: false, final false
  inline void UpdateBinding(::UnityEngine::VFX::VisualEffect* component);

  /// @brief Method UpdateSubProperties, addr 0x69e239c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e2830, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Property, addr 0x69e235c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  /// @brief Method set_Property, addr 0x69e2374, size 0x28, virtual false, abstract: false, final false
