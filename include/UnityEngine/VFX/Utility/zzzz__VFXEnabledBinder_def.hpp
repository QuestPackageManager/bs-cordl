...
public:
  ...
  /// @brief Method IsValid, addr 0x69dd098, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69dd1b4, size 0x138, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69dd140, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69dd2ec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Property, addr 0x69dd064, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  /// @brief Method set_Property, addr 0x69dd07c, size 0x1c, virtual false, abstract: false, final false
