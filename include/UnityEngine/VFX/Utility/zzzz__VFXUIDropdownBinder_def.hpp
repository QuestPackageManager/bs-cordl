...
CORDL_MODULE_EXPORT(VFXUIDropdownBinder)
...
namespace UnityEngine::VFX::Utility {
// Is value type: false
// CS Name: UnityEngine.VFX.Utility.VFXUIDropdownBinder
class CORDL_TYPE VFXUIDropdownBinder : public ::UnityEngine::VFX::Utility::VFXBinderBase {
public:
  // Declarations
  __declspec(property(get = get_Property, put = set_Property)) ::StringW Property;

  /// @brief Field Target, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get_Target, put = __cordl_internal_set_Target)) ::UnityW<::UnityEngine::UI::Dropdown> Target;
  ...
  /// @brief Method IsValid, addr 0x69e2d0c, size 0xac, virtual true, abstract: false, final false
  inline bool IsValid(::UnityEngine::VFX::VisualEffect* component);

  static inline ::UnityEngine::VFX::Utility::VFXUIDropdownBinder* New_ctor();

  /// @brief Method ToString, addr 0x69e2e00, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69e2db8, size 0x48, virtual true, abstract: false, final false
  inline void UpdateBinding(::UnityEngine::VFX::VisualEffect* component);

  constexpr ::UnityW<::UnityEngine::UI::Dropdown> const& __cordl_internal_get_Target() const;

  constexpr ::UnityW<::UnityEngine::UI::Dropdown>& __cordl_internal_get_Target();
  ...
  constexpr void __cordl_internal_set_Target(::UnityW<::UnityEngine::UI::Dropdown> value);

  constexpr void __cordl_internal_set_m_Property(::UnityEngine::VFX::Utility::ExposedProperty* value);

  /// @brief Method .ctor, addr 0x69e2efc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Property, addr 0x69e2cd4, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  /// @brief Method set_Property, addr 0x69e2cec, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  ::UnityW<::UnityEngine::UI::Dropdown> ___Target;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::UnityEngine::VFX::Utility::VFXUIDropdownBinder, ___m_Property) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::VFX::Utility::VFXUIDropdownBinder, ___Target) == 0x30, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::VFX::Utility::VFXUIDropdownBinder) == 0x38, "Size mismatch!");
