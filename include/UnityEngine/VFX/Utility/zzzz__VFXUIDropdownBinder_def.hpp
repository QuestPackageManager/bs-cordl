...
public:
  ...
  /// @brief Method IsValid, addr 0x69e8524, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69e8618, size 0xfc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdateBinding, addr 0x69e85d0, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69e8714, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Property, addr 0x69e84ec, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_Property();

  /// @brief Method set_Property, addr 0x69e8504, size 0x20, virtual false, abstract: false, final false
