...
// Ctor Parameters [CppParam { name: "vfxAsset", ty: "::UnityW<::UnityEngine::VFX::VisualEffectAsset>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "activeBatchCount", ty:
// "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "inactiveBatchCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "activeInstanceCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "unbatchedInstanceCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "totalInstanceCapacity", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "maxInstancePerBatchCapacity", ty: "uint32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "totalGPUSizeInBytes", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "totalCPUSizeInBytes", ty: "uint64_t", modifiers: "", def_value: Some("{}"), comment: None }]
