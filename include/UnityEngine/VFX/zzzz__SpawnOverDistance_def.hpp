...
public:
  ...
  /// @brief Method .ctor, addr 0x69cc9b4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnPlay, addr 0x69cc520, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method OnStop, addr 0x69cc834, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method OnUpdate, addr 0x69cc5a8, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69cc838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
