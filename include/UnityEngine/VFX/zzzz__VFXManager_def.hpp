...
public:
  ...
  /// @brief Method Internal_ProcessCameraCommand, addr 0x6cd2ecc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_ProcessCameraCommand_Injected, addr 0x6cd2fd8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsCameraBufferNeeded, addr 0x6cd3034, size 0xcc, virtual false, abstract: false, final false
  static inline ::UnityEngine::VFX::VFXCameraBufferTypes IsCameraBufferNeeded(::UnityEngine::Camera* cam);

  /// @brief Method IsCameraBufferNeeded_Injected, addr 0x6cd3100, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::VFX::VFXCameraBufferTypes IsCameraBufferNeeded_Injected(::System::IntPtr cam);

  /// @brief Method ProcessCameraCommand, addr 0x6cd2e44, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCameraBuffer, addr 0x6cd313c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCameraBuffer_Injected, addr 0x6cd3280, size 0x84, virtual false, abstract: false, final false
