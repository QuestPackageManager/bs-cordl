...
public:
  ...
  /// @brief Method .ctor, addr 0x69cf09c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipEnd, addr 0x69ceffc, size 0x8, virtual false, abstract: false, final false
  inline double_t get_clipEnd();

  /// @brief Method get_clipEventsCount, addr 0x69cf05c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_clipEventsCount();

  /// @brief Method get_clipStart, addr 0x69cefec, size 0x8, virtual false, abstract: false, final false
  inline double_t get_clipStart();

  /// @brief Method get_events, addr 0x69cf04c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::VFX::VisualEffectPlayableSerializedEvent> get_events();

  /// @brief Method get_prewarmDeltaTime, addr 0x69cf07c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_prewarmDeltaTime();

  /// @brief Method get_prewarmEvent, addr 0x69cf08c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::VFX::Utility::ExposedProperty* get_prewarmEvent();

  /// @brief Method get_prewarmStepCount, addr 0x69cf06c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_prewarmStepCount();

  /// @brief Method get_reinitEnter, addr 0x69cf01c, size 0x8, virtual false, abstract: false, final false
  inline bool get_reinitEnter();

  /// @brief Method get_reinitExit, addr 0x69cf02c, size 0x8, virtual false, abstract: false, final false
  inline bool get_reinitExit();

  /// @brief Method get_scrubbing, addr 0x69cf00c, size 0x8, virtual false, abstract: false, final false
  inline bool get_scrubbing();

  /// @brief Method get_startSeed, addr 0x69cf03c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_startSeed();

  /// @brief Method set_clipEnd, addr 0x69cf004, size 0x8, virtual false, abstract: false, final false
  inline void set_clipEnd(double_t value);

  /// @brief Method set_clipEventsCount, addr 0x69cf064, size 0x8, virtual false, abstract: false, final false
  inline void set_clipEventsCount(uint32_t value);

  /// @brief Method set_clipStart, addr 0x69ceff4, size 0x8, virtual false, abstract: false, final false
  inline void set_clipStart(double_t value);

  /// @brief Method set_events, addr 0x69cf054, size 0x8, virtual false, abstract: false, final false
  inline void set_events(::ArrayW<::UnityEngine::VFX::VisualEffectPlayableSerializedEvent> value);

  /// @brief Method set_prewarmDeltaTime, addr 0x69cf084, size 0x8, virtual false, abstract: false, final false
  inline void set_prewarmDeltaTime(float_t value);

  /// @brief Method set_prewarmEvent, addr 0x69cf094, size 0x8, virtual false, abstract: false, final false
  inline void set_prewarmEvent(::UnityEngine::VFX::Utility::ExposedProperty* value);

  /// @brief Method set_prewarmStepCount, addr 0x69cf074, size 0x8, virtual false, abstract: false, final false
  inline void set_prewarmStepCount(uint32_t value);

  /// @brief Method set_reinitEnter, addr 0x69cf024, size 0x8, virtual false, abstract: false, final false
  inline void set_reinitEnter(bool value);

  /// @brief Method set_reinitExit, addr 0x69cf034, size 0x8, virtual false, abstract: false, final false
  inline void set_reinitExit(bool value);

  /// @brief Method set_scrubbing, addr 0x69cf014, size 0x8, virtual false, abstract: false, final false
  inline void set_scrubbing(bool value);

  /// @brief Method set_startSeed, addr 0x69cf044, size 0x8, virtual false, abstract: false, final false
