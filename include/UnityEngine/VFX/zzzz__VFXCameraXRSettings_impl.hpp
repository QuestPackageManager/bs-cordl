...
// Ctor Parameters [CppParam { name: "viewTotal", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "viewCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "viewOffset", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
