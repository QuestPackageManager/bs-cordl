...
public:
  ...
  /// @brief Method CreateSpawnerStateWrapper, addr 0x6cd336c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::VFX::VFXSpawnerState* CreateSpawnerStateWrapper();

  /// @brief Method Dispose, addr 0x6cd35c4, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Finalize, addr 0x6cd3580, size 0x44, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Internal_Destroy, addr 0x6cd3544, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Destroy(::System::IntPtr ptr);

  static inline ::UnityEngine::VFX::VFXSpawnerState* New_ctor(::System::IntPtr ptr, bool owner);

  /// @brief Method PrepareWrapper, addr 0x6cd33c8, size 0x90, virtual false, abstract: false, final false
  inline void PrepareWrapper();

  /// @brief Method Release, addr 0x6cd34ec, size 0x58, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method SetWrapValue, addr 0x6cd3458, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd3360, size 0xc, virtual false, abstract: false, final false
