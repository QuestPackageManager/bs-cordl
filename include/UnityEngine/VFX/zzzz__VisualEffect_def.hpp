...
public:
  ...
  /// @brief Method CreateVFXEventAttribute, addr 0x6cd3864, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::VFX::VFXEventAttribute* CreateVFXEventAttribute();

  /// @brief Method InvokeGetCachedEventAttributeForOutputEvent_Internal, addr 0x6cd38f4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeOutputEventReceived_Internal, addr 0x6cd3930, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_visualEffectAsset, addr 0x6cd36d8, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::VFX::VisualEffectAsset> get_visualEffectAsset();

  /// @brief Method get_visualEffectAsset_Injected, addr 0x6cd3828, size 0x3c, virtual false, abstract: false, final false
