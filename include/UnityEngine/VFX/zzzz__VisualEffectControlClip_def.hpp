...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x69cca70, size 0x604, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69cd094, size 0x31c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x69cca48, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method get_clipEnd, addr 0x69cca60, size 0x8, virtual false, abstract: false, final false
  inline double_t get_clipEnd();

  /// @brief Method get_clipStart, addr 0x69cca50, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_clipEnd, addr 0x69cca68, size 0x8, virtual false, abstract: false, final false
  inline void set_clipEnd(double_t value);

  /// @brief Method set_clipStart, addr 0x69cca58, size 0x8, virtual false, abstract: false, final false
