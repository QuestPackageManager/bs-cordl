...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VFXRuntimeResources", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VFXRuntimeResources(VFXRuntimeResources&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VFXRuntimeResources", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VFXRuntimeResources(VFXRuntimeResourcesconst&) = delete;
