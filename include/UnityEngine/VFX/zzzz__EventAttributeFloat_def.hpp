...
public:
  ...
  /// @brief Method <.ctor>b__0_0, addr 0x69cd5e0, size 0x1c, virtual false, abstract: false, final false
  inline bool __ctor_b__0_0(::UnityEngine::VFX::VFXEventAttribute* e, int32_t id);

  /// @brief Method <.ctor>b__0_1, addr 0x69cd5fc, size 0x1c, virtual false, abstract: false, final false
  inline void __ctor_b__0_1(::UnityEngine::VFX::VFXEventAttribute* e, int32_t id, float_t value);

  /// @brief Method .ctor, addr 0x69cd5dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x69cd408, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
