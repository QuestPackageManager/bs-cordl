...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventAttributeValue_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventAttributeValue_1(EventAttributeValue_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventAttributeValue_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventAttributeValue_1(EventAttributeValue_1const&) = delete;
