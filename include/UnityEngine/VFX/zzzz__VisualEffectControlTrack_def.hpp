...
public:
  ...
  /// @brief Method <OnBeforeTrackSerialize>b__5_0, addr 0x69cf78c, size 0x88, virtual false, abstract: false, final false
  inline bool _OnBeforeTrackSerialize_b__5_0(::UnityEngine::Timeline::TimelineClip* x);

  /// @brief Method .ctor, addr 0x69cf788, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateTrackMixer, addr 0x69cf1d4, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method GatherProperties, addr 0x69cf614, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method IsUpToDate, addr 0x69cf0a0, size 0x10, virtual false, abstract: false, final false
  inline bool IsUpToDate();

  static inline ::UnityEngine::VFX::VisualEffectControlTrack* New_ctor();

  /// @brief Method OnBeforeTrackSerialize, addr 0x69cf0b0, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69cf6d0, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
