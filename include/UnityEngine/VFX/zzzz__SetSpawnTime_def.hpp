...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SetSpawnTime", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SetSpawnTime(SetSpawnTime&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SetSpawnTime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SetSpawnTime(SetSpawnTimeconst&) = delete;
