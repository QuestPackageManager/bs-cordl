...
public:
  ...
  /// @brief Method .ctor, addr 0x69cc3e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnPlay, addr 0x69cc0d4, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method OnStop, addr 0x69cc2f8, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method OnUpdate, addr 0x69cc1a0, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x69cc304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
