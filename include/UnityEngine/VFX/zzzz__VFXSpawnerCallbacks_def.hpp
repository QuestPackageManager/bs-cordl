...
public:
  ...
  /// @brief Method .ctor, addr 0x6e29e30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::VFX::VFXSpawnerCallbacks) == 0x18, "Size mismatch!");
