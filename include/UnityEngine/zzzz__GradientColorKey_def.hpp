...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6ac8cb0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::GradientColorKey) == 0x14, "Size mismatch!");
