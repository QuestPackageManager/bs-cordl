...
public:
// Declarations
/// @brief Method CreateAsyncInstantiateOperationResultArray, addr 0x698355c, size 0x18, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityW<::UnityEngine::Object>,::Array<::UnityW<::UnityEngine::Object>>*> CreateAsyncInstantiateOperationResultArray(::UnityEngine::AsyncInstantiateOperation*  op, int32_t  size) ;
