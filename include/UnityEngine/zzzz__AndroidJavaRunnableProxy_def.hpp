...
public:
  ...
  /// @brief Method Invoke, addr 0x6a27fa0, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a27e90, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaRunnable* runnable);

  /// @brief Method run, addr 0x6a27f80, size 0x20, virtual false, abstract: false, final false
  inline void run();
