...
public:
  ...
  /// @brief Method Invoke, addr 0x685ce44, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x685cd34, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaRunnable* runnable);

  /// @brief Method run, addr 0x685ce24, size 0x20, virtual false, abstract: false, final false
  inline void run();
