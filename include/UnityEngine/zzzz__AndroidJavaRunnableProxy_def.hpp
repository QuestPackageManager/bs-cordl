...
// Write type traits
MARK_REF_T(::UnityEngine::AndroidJavaRunnableProxy*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AndroidJavaRunnableProxy*, "UnityEngine", "AndroidJavaRunnableProxy");
...
public:
  ...
  /// @brief Method Invoke, addr 0x6a2d7b8, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a2d6a8, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaRunnable* runnable);

  /// @brief Method run, addr 0x6a2d798, size 0x20, virtual false, abstract: false, final false
  inline void run();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AndroidJavaRunnableProxy", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AndroidJavaRunnableProxy(AndroidJavaRunnableProxy&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AndroidJavaRunnableProxy", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AndroidJavaRunnableProxy(AndroidJavaRunnableProxyconst&) = delete;
...
static_assert(sizeof(::UnityEngine::AndroidJavaRunnableProxy) == 0x28, "Size mismatch!");
