...
/// @brief Method Invoke, addr 0x685d504, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x685d3f4, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AndroidJavaRunnable*  runnable) ;

/// @brief Method run, addr 0x685d4e4, size 0x20, virtual false, abstract: false, final false
inline void run() ;
