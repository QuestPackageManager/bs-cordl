...
public:
  ...
  /// @brief Method Invoke, addr 0x67f52cc, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f51bc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaRunnable* runnable);

  /// @brief Method run, addr 0x67f52ac, size 0x20, virtual false, abstract: false, final false
  inline void run();
