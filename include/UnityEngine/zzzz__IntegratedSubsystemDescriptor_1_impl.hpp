...
inline ::UnityEngine::ISubsystem* UnityEngine::IntegratedSubsystemDescriptor_1<TSubsystem>::CreateImpl()  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::IntegratedSubsystemDescriptor_1<TSubsystem>*>::get(),
                            6
                        )));
return ::cordl_internals::RunMethodRethrow<::UnityEngine::ISubsystem*, false>(this, ___internal_method);
}
template<typename TSubsystem>
inline TSubsystem UnityEngine::IntegratedSubsystemDescriptor_1<TSubsystem>::Create()  {
