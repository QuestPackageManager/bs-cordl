...
// Ctor Parameters [CppParam { name: "startCharIdx", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "height", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "topY", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "leading", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
