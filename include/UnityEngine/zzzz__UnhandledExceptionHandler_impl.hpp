...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UnhandledExceptionHandler___c::*)()>(&::UnityEngine::UnhandledExceptionHandler___c::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x691de0c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UnhandledExceptionHandler___c*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UnhandledExceptionHandler___c::*)(::System::Object*, ::System::UnhandledExceptionEventArgs*)>(&::UnityEngine::UnhandledExceptionHandler___c::_RegisterUECatcher_b__0_0)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x691de10;
...
::cordl_internals::setStaticField<::UnityEngine::UnhandledExceptionHandler___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UnhandledExceptionHandler___c*>::get>(std::forward<::UnityEngine::UnhandledExceptionHandler___c*>(value));
}
inline ::UnityEngine::UnhandledExceptionHandler___c* UnityEngine::UnhandledExceptionHandler___c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UnhandledExceptionHandler___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UnhandledExceptionHandler___c*>::get>();
}
inline void UnityEngine::UnhandledExceptionHandler___c::setStaticF___9__0_0(::System::UnhandledExceptionEventHandler*  value)  {
::cordl_internals::setStaticField<::System::UnhandledExceptionEventHandler*, "<>9__0_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UnhandledExceptionHandler___c*>::get>(std::forward<::System::UnhandledExceptionEventHandler*>(value));
}
inline ::System::UnhandledExceptionEventHandler* UnityEngine::UnhandledExceptionHandler___c::getStaticF___9__0_0()  {
return ::cordl_internals::getStaticField<::System::UnhandledExceptionEventHandler*, "<>9__0_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UnhandledExceptionHandler___c*>::get>();
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UnhandledExceptionHandler___c*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::UnhandledExceptionHandler::RegisterUECatcher)> {
  ...
  constexpr static std::size_t addrs = 0x691dcbc;
