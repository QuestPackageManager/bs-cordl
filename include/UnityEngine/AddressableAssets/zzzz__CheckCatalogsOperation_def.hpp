...
public:
  ...
  /// @brief Method .ctor addr 0x28a7410 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Start>b__5_0 addr 0x28a7418 size 0x9c virtual false final false
...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3831)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14304), inst: 781 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3823)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3831), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(14304)),
// TypeDefinitionIndex(TypeDefinitionIndex(14303)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14303), inst: 784 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3823), inst: 279 }), TypeDefinitionIndex(TypeDefinitionIndex(14305))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14363)) CS Name:
...
public:
  ...
  /// @brief Method .ctor addr 0x28a318c size 0x5c virtual false final false
  inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl* aa);

  /// @brief Method Start addr 0x28a31e8 size 0x5f4 virtual false final false
  ...
  /// @brief Method InvokeWaitForCompletion addr 0x28a6a28 size 0x134 virtual true final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method Destroy addr 0x28a6b5c size 0x70 virtual true final false
  inline void Destroy();

  /// @brief Method GetDependencies addr 0x28a6bcc size 0x124 virtual true final false
  ...
  /// @brief Method ProcessDependentOpResults addr 0x28a6cf0 size 0x624 virtual false final false
  ...
  /// @brief Method Execute addr 0x28a7314 size 0x98 virtual true final false
  inline void Execute();
