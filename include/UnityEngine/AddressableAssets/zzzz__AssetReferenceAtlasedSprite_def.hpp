...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite*, "UnityEngine.AddressableAssets", "AssetReferenceAtlasedSprite");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceAtlasedSprite", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetReferenceAtlasedSprite(AssetReferenceAtlasedSprite&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceAtlasedSprite", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetReferenceAtlasedSprite(AssetReferenceAtlasedSpriteconst&) = delete;
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReferenceAtlasedSprite) == 0x40, "Size mismatch!");
