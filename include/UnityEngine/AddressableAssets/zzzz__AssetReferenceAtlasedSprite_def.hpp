...
/// @brief Method ValidateAsset, addr 0x62aa46c, size 0x7c, virtual true, abstract: false, final false
inline bool ValidateAsset(::UnityEngine::Object*  obj) ;

/// @brief Method ValidateAsset, addr 0x62aa4e8, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::StringW  path) ;

/// @brief Method .ctor, addr 0x62aa3f4, size 0x78, virtual false, abstract: false, final false
