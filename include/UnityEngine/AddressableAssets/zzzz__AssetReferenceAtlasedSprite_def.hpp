...
public:
  ...
  /// @brief Method ValidateAsset, addr 0x6242220, size 0x7c, virtual true, abstract: false, final false
  inline bool ValidateAsset(::UnityEngine::Object* obj);

  /// @brief Method ValidateAsset, addr 0x624229c, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::StringW path);

  /// @brief Method .ctor, addr 0x62421a8, size 0x78, virtual false, abstract: false, final false
