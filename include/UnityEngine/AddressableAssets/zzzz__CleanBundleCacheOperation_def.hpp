...
public:
  ...
  /// @brief Method CompleteInternal, addr 0x631d78c, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteInternal(bool result, bool success, ::StringW errorMsg);

  /// @brief Method Destroy, addr 0x631da64, size 0x80, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method DetermineCacheDirsNotInUse, addr 0x631e6f8, size 0x3f0, virtual false, abstract: false, final false
  inline void DetermineCacheDirsNotInUse(::System::Collections::Generic::HashSet_1<::StringW>* cacheDirsInUse);

  /// @brief Method DetermineCacheDirsNotInUse, addr 0x631eb28, size 0x90, virtual false, abstract: false, final false
  inline void DetermineCacheDirsNotInUse(::System::Object* data);

  /// @brief Method Execute, addr 0x631dbc8, size 0x210, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetCacheDirsInUse, addr 0x631ddd8, size 0x920, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDependencies, addr 0x631dae4, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x631d834, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method RemoveCacheEntries, addr 0x631d914, size 0x150, virtual false, abstract: false, final false
  inline void RemoveCacheEntries();

  /// @brief Method Start, addr 0x631af34, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update, addr 0x631eae8, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x631ae70, size 0xc4, virtual false, abstract: false, final false
