...
/// @brief Method CompleteInternal, addr 0x62ab780, size 0xa8, virtual false, abstract: false, final false
inline void CompleteInternal(bool  result, bool  success, ::StringW  errorMsg) ;

/// @brief Method Destroy, addr 0x62aba58, size 0x80, virtual true, abstract: false, final false
inline void Destroy() ;

/// @brief Method DetermineCacheDirsNotInUse, addr 0x62ac6ec, size 0x3f0, virtual false, abstract: false, final false
inline void DetermineCacheDirsNotInUse(::System::Collections::Generic::HashSet_1<::StringW>*  cacheDirsInUse) ;

/// @brief Method DetermineCacheDirsNotInUse, addr 0x62acb1c, size 0x90, virtual false, abstract: false, final false
inline void DetermineCacheDirsNotInUse(::System::Object*  data) ;

/// @brief Method Execute, addr 0x62abbbc, size 0x210, virtual true, abstract: false, final false
inline void Execute() ;

/// @brief Method GetCacheDirsInUse, addr 0x62abdcc, size 0x920, virtual false, abstract: false, final false
...
/// @brief Method GetDependencies, addr 0x62abad8, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method InvokeWaitForCompletion, addr 0x62ab828, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method RemoveCacheEntries, addr 0x62ab908, size 0x150, virtual false, abstract: false, final false
inline void RemoveCacheEntries() ;

/// @brief Method Start, addr 0x62a8f28, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update, addr 0x62acadc, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x62a8e64, size 0xc4, virtual false, abstract: false, final false
