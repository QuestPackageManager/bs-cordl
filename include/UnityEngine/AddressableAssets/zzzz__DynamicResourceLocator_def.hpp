...
public:
  ...
  /// @brief Method CreateDynamicLocations, addr 0x2b128fc, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method Locate, addr 0x2b123b0, size 0x54c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2b12388, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl* addr);

  /// @brief Method get_AtlasSpriteProviderId, addr 0x2b11f30, size 0x458, virtual false, abstract: false, final false
  inline ::StringW get_AtlasSpriteProviderId();

  /// @brief Method get_Keys, addr 0x2b11eec, size 0x44, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_Keys();

  /// @brief Method get_LocatorId, addr 0x2b11eac, size 0x40, virtual true, abstract: false, final true
