...
public:
  ...
  /// @brief Method get_LocatorId, addr 0x2a29dd8, size 0x40, virtual true, abstract: false, final true
  inline ::StringW get_LocatorId();

  /// @brief Method get_Keys, addr 0x2a29e18, size 0x44, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_Keys();

  /// @brief Method get_AtlasSpriteProviderId, addr 0x2a29e5c, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a2a2b4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl* addr);

  /// @brief Method Locate, addr 0x2a2a2dc, size 0x54c, virtual true, abstract: false, final true
  ...
  /// @brief Method CreateDynamicLocations, addr 0x2a2a828, size 0x68c, virtual false, abstract: false, final false
