...
public:
  ...
  /// @brief Method CreateDynamicLocations, addr 0x44f168c, size 0x690, virtual false, abstract: false, final false
  ...
  /// @brief Method Locate, addr 0x44f1140, size 0x54c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x44f1118, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl* addr);

  /// @brief Method get_AllLocations, addr 0x44f10d4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AtlasSpriteProviderId, addr 0x44f0c84, size 0x450, virtual false, abstract: false, final false
  inline ::StringW get_AtlasSpriteProviderId();

  /// @brief Method get_Keys, addr 0x44f0c40, size 0x44, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_Keys();

  /// @brief Method get_LocatorId, addr 0x44f0c00, size 0x40, virtual true, abstract: false, final true
