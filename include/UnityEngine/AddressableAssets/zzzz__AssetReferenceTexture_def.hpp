...
public:
  ...
  /// @brief Method .ctor, addr 0x64601c8, size 0x78, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceTexture", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetReferenceTexture(AssetReferenceTexture&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceTexture", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetReferenceTexture(AssetReferenceTextureconst&) = delete;
