...
public:
  ...
  /// @brief Method CreateEvent, addr 0x44f7064, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44f70a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
