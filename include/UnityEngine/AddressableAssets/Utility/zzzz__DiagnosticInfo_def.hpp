...
public:
  ...
  /// @brief Method CreateEvent, addr 0x4504588, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent CreateEvent(::StringW category, ::UnityEngine::ResourceManagement::ResourceManager_DiagnosticEventType eventType,
  ...
  /// @brief Method .ctor, addr 0x45045cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
