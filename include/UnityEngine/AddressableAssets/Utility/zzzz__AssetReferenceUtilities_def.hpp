...
public:
  // Declarations
  /// @brief Method FormatName, addr 0x6321014, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x63210b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
