...
public:
  // Declarations
  /// @brief Method FormatName, addr 0x645f7ac, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x645f848, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
