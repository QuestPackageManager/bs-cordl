...
public:
  ...
  /// @brief Method .ctor addr 0x28aaa74 size 0xec virtual false final false
  inline void _ctor(::UnityEngine::ResourceManagement::ResourceManager* resourceManager);

  /// @brief Method SumDependencyNameHashCodes addr 0x28aab60 size 0x218 virtual false final false
  inline int32_t SumDependencyNameHashCodes(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method CalculateHashCode addr 0x28aad78 size 0x144 virtual false final false
  inline int32_t CalculateHashCode(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method CalculateCompletedOperationHashcode addr 0x28aaebc size 0x8c virtual false final false
  ...
  /// @brief Method GenerateCompletedOperationDisplayName addr 0x28aaf48 size 0x430 virtual false final false
  ...
  /// @brief Method OnResourceManagerDiagnosticEvent addr 0x28ab378 size 0x3c8 virtual false final false
  ...
  /// @brief Method Dispose addr 0x28ab740 size 0xd4 virtual true final true
  inline void Dispose();
