...
public:
  ...
  /// @brief Method CalculateCompletedOperationHashcode, addr 0x44f750c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateHashCode, addr 0x44f73c8, size 0x144, virtual false, abstract: false, final false
  inline int32_t CalculateHashCode(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method Dispose, addr 0x44f7db4, size 0xd8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GenerateCompletedOperationDisplayName, addr 0x44f7598, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnResourceManagerDiagnosticEvent, addr 0x44f79e4, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method SumDependencyNameHashCodes, addr 0x44f719c, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44f70b0, size 0xec, virtual false, abstract: false, final false
