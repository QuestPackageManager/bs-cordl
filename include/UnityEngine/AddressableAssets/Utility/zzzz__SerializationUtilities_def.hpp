...
/// @brief Method ReadInt32FromByteArray, addr 0x62af0a8, size 0x70, virtual false, abstract: false, final false
static inline int32_t ReadInt32FromByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method ReadObjectFromByteArray, addr 0x62af19c, size 0x510, virtual false, abstract: false, final false
static inline ::System::Object* ReadObjectFromByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  keyData, int32_t  dataIndex) ;

/// @brief Method WriteInt32ToByteArray, addr 0x62af118, size 0x84, virtual false, abstract: false, final false
static inline int32_t WriteInt32ToByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  val, int32_t  offset) ;

/// @brief Method WriteObjectToByteList, addr 0x62af6ac, size 0x98c, virtual false, abstract: false, final false
