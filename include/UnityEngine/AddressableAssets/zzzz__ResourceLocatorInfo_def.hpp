...
public:
  ...
  /// @brief Method UpdateContent, addr 0x44e2ad8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44e2a9c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* loc, ::StringW localHash,
                    ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* remoteCatalogLocation);

  /// @brief Method get_CanUpdateContent, addr 0x44e1670, size 0x1a4, virtual false, abstract: false, final false
  inline bool get_CanUpdateContent();

  /// @brief Method get_CatalogLocation, addr 0x44e2a78, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_CatalogLocation();

  /// @brief Method get_ContentUpdateAvailable, addr 0x44e2a88, size 0x8, virtual false, abstract: false, final false
  inline bool get_ContentUpdateAvailable();

  /// @brief Method get_HashLocation, addr 0x44e1910, size 0x11c, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_HashLocation();

  /// @brief Method get_LocalHash, addr 0x44e2a68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalHash();

  /// @brief Method get_Locator, addr 0x44e2a58, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* get_Locator();

  /// @brief Method set_CatalogLocation, addr 0x44e2a80, size 0x8, virtual false, abstract: false, final false
  inline void set_CatalogLocation(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* value);

  /// @brief Method set_ContentUpdateAvailable, addr 0x44e2a90, size 0xc, virtual false, abstract: false, final false
  inline void set_ContentUpdateAvailable(bool value);

  /// @brief Method set_LocalHash, addr 0x44e2a70, size 0x8, virtual false, abstract: false, final false
  inline void set_LocalHash(::StringW value);

  /// @brief Method set_Locator, addr 0x44e2a60, size 0x8, virtual false, abstract: false, final false
