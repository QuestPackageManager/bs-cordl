...
public:
  ...
  /// @brief Method Add, addr 0x450c394, size 0x160, virtual false, abstract: false, final false
  inline void Add(::System::Object* key, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method Add, addr 0x4509b70, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Locate, addr 0x450a994, size 0x878, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x45098dc, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW id, int32_t capacity);

  /// @brief Method .ctor, addr 0x450ba00, size 0x994, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Keys, addr 0x450a944, size 0x50, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_Keys();

  /// @brief Method get_Locations, addr 0x450c4f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocatorId, addr 0x450b9f0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_LocatorId, addr 0x450b9f8, size 0x8, virtual false, abstract: false, final false
