...
/// @brief Method Hash, addr 0x62b5034, size 0x4c, virtual true, abstract: false, final true
inline int32_t Hash(::System::Type*  t) ;

static inline ::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData_CompactLocation* New_ctor(::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationMap*  locator, ::StringW  internalId, ::StringW  providerId, ::System::Object*  dependencyKey, ::System::Object*  data, int32_t  depHash, ::StringW  primaryKey, ::System::Type*  type) ;

/// @brief Method ToString, addr 0x62b502c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62b36e0, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method get_Data, addr 0x62b500c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x62b4f74, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method get_DependencyHashCode, addr 0x62b5004, size 0x8, virtual true, abstract: false, final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies, addr 0x62b4ff4, size 0x10, virtual true, abstract: false, final true
inline bool get_HasDependencies() ;

/// @brief Method get_InternalId, addr 0x62b4f64, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_InternalId() ;

/// @brief Method get_PrimaryKey, addr 0x62b5014, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ProviderId, addr 0x62b4f6c, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_ResourceType, addr 0x62b5024, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_PrimaryKey, addr 0x62b501c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <GetData>b__48_0, addr 0x62b50d8, size 0xa4, virtual false, abstract: false, final false
inline ::StringW _GetData_b__48_0(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  d) ;

/// @brief Method .ctor, addr 0x62b50d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CleanData, addr 0x62b1404, size 0x60, virtual false, abstract: false, final false
inline void CleanData() ;

/// @brief Method CreateCustomLocator, addr 0x62acbac, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method CreateLocator, addr 0x62b2e0c, size 0x760, virtual false, abstract: false, final false
inline ::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationMap* CreateLocator(::StringW  providerSuffix) ;

/// @brief Method ExpandInternalId, addr 0x62b3614, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW ExpandInternalId(::ArrayW<::StringW,::Array<::StringW>*>  internalIdPrefixes, ::StringW  v) ;

/// @brief Method GetData, addr 0x62b3830, size 0xe9c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogDataEntry*>* GetData() ;

/// @brief Method LoadFromFile, addr 0x62b2d94, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SaveToFile, addr 0x62b2de8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62b2d10, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x62b2c8c, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::StringW  id) ;

static inline int32_t getStaticF_kMagic() ;

/// @brief Method get_BuildResultHash, addr 0x62b2c0c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BuildResultHash() ;

/// @brief Method get_InstanceProviderData, addr 0x62b2c2c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::Util::ObjectInitializationData get_InstanceProviderData() ;

/// @brief Method get_InternalIds, addr 0x62b2d8c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_InternalIds() ;

/// @brief Method get_ProviderId, addr 0x62b2c1c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ProviderId() ;

/// @brief Method get_ProviderIds, addr 0x62b2d84, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ProviderIds() ;

/// @brief Method get_ResourceProviderData, addr 0x62b2c7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_SceneProviderData, addr 0x62b2c54, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_BuildResultHash, addr 0x62b2c14, size 0x8, virtual false, abstract: false, final false
inline void set_BuildResultHash(::StringW  value) ;

/// @brief Method set_InstanceProviderData, addr 0x62b2c40, size 0x14, virtual false, abstract: false, final false
inline void set_InstanceProviderData(::UnityEngine::ResourceManagement::Util::ObjectInitializationData  value) ;

/// @brief Method set_ProviderId, addr 0x62b2c24, size 0x8, virtual false, abstract: false, final false
inline void set_ProviderId(::StringW  value) ;

/// @brief Method set_ResourceProviderData, addr 0x62b2c84, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_SceneProviderData, addr 0x62b2c68, size 0x14, virtual false, abstract: false, final false
