...
public:
  ...
  /// @brief Method Locate, addr 0x45024ac, size 0x274, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4502768, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Keys, addr 0x4502720, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::System::Object*>* get_Keys();

  /// @brief Method get_LocatorId, addr 0x4502728, size 0x40, virtual true, abstract: false, final true
