...
static ::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_DependencyHashIndex const Local;
...
/// @brief Field m_WebRequestQueueOperation, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_WebRequestQueueOperation, put=__cordl_internal_set_m_WebRequestQueueOperation)) ::UnityEngine::ResourceManagement::WebRequestQueueOperation*  m_WebRequestQueueOperation;
...
/// @brief Method Finalize, addr 0x6325f48, size 0x5c, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method LoadCatalogFromBundleAsync, addr 0x6325284, size 0x2b4, virtual false, abstract: false, final false
inline void LoadCatalogFromBundleAsync() ;

/// @brief Method LoadTextAssetRequestComplete, addr 0x63261e8, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method Unload, addr 0x6325fa4, size 0x28, virtual false, abstract: false, final false
inline void Unload() ;

/// @brief Method WaitForCompletion, addr 0x6324e9c, size 0xec, virtual false, abstract: false, final false
inline bool WaitForCompletion() ;

/// @brief Method WebRequestOperationCompleted, addr 0x6325fcc, size 0x21c, virtual false, abstract: false, final false
inline void WebRequestOperationCompleted(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method <LoadCatalogFromBundleAsync>b__19_0, addr 0x6326438, size 0x1fc, virtual false, abstract: false, final false
inline void _LoadCatalogFromBundleAsync_b__19_0(::UnityEngine::AsyncOperation*  loadOp) ;

/// @brief Method <LoadCatalogFromBundleAsync>b__19_1, addr 0x632639c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x63250b4, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::StringW  bundlePath, int32_t  webRequestTimeout) ;

/// @brief Method add_OnLoaded, addr 0x63251c4, size 0xc0, virtual false, abstract: false, final false
inline void add_OnLoaded(::System::Action_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*>*  value) ;

/// @brief Method get_OpInProgress, addr 0x6325f20, size 0x8, virtual false, abstract: false, final false
inline bool get_OpInProgress() ;

/// @brief Method get_OpIsSuccess, addr 0x6325f28, size 0x20, virtual false, abstract: false, final false
inline bool get_OpIsSuccess() ;

/// @brief Method remove_OnLoaded, addr 0x6325e60, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Field m_BundledCatalog, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_BundledCatalog, put=__cordl_internal_set_m_BundledCatalog)) ::UnityEngine::AddressableAssets::ResourceProviders::InternalOp_ContentCatalogProvider_BundledCatalog*  m_BundledCatalog;

/// @brief Field m_ContentCatalogData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ContentCatalogData, put=__cordl_internal_set_m_ContentCatalogData)) ::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*  m_ContentCatalogData;

/// @brief Field m_ContentCatalogDataLoadOp, offset 0x48, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_ContentCatalogDataLoadOp, put=__cordl_internal_set_m_ContentCatalogDataLoadOp)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*>  m_ContentCatalogDataLoadOp;

/// @brief Field m_DisableCatalogUpdateOnStart, offset 0x69, size 0x1 
...
/// @brief Field m_IsLocalCatalogInBundle, offset 0x6a, size 0x1 
...
/// @brief Field m_ProviderInterface, offset 0x28, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_ProviderInterface, put=__cordl_internal_set_m_ProviderInterface)) ::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle  m_ProviderInterface;
...
/// @brief Method CanLoadCatalogFromBundle, addr 0x63246fc, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method CatalogLoadOpCompleteCallback, addr 0x6325538, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method DetermineIdToLoad, addr 0x6324034, size 0x6c8, virtual false, abstract: false, final false
...
/// @brief Method GetTransformedInternalId, addr 0x6324fe8, size 0xcc, virtual false, abstract: false, final false
inline ::StringW GetTransformedInternalId(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  loc) ;

/// @brief Method LoadCatalog, addr 0x63247c4, size 0x5f4, virtual false, abstract: false, final false
...
/// @brief Method OnCatalogLoaded, addr 0x63255c4, size 0x894, virtual false, abstract: false, final false
inline void OnCatalogLoaded(::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*  ccd) ;

/// @brief Method Release, addr 0x6323d48, size 0x10, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method Start, addr 0x6323ec4, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method WaitForCompletionCallback, addr 0x6324db8, size 0xe4, virtual false, abstract: false, final false
inline bool WaitForCompletionCallback() ;

/// @brief Method <LoadCatalog>b__14_0, addr 0x6325e58, size 0x8, virtual false, abstract: false, final false
...
constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*> const& __cordl_internal_get_m_ContentCatalogDataLoadOp() const;

constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*>& __cordl_internal_get_m_ContentCatalogDataLoadOp() ;
...
constexpr void __cordl_internal_set_m_ContentCatalogDataLoadOp(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData*>  value) ;
...
/// @brief Method .ctor, addr 0x6323ec0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_ContentCatalogDataLoadOp, offset: 0x48, size: 0x18, def value: None
...
/// @brief Field m_BundledCatalog, offset: 0x60, size: 0x8, def value: None
 ::UnityEngine::AddressableAssets::ResourceProviders::InternalOp_ContentCatalogProvider_BundledCatalog*  ___m_BundledCatalog;

/// @brief Field m_Retried, offset: 0x68, size: 0x1, def value: None
 bool  ___m_Retried;

/// @brief Field m_DisableCatalogUpdateOnStart, offset: 0x69, size: 0x1, def value: None
 bool  ___m_DisableCatalogUpdateOnStart;

/// @brief Field m_IsLocalCatalogInBundle, offset: 0x6a, size: 0x1, def value: None
...
static_assert(offsetof(::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp, ___m_BundledCatalog) == 0x60, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp, ___m_Retried) == 0x68, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp, ___m_DisableCatalogUpdateOnStart) == 0x69, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp, ___m_IsLocalCatalogInBundle) == 0x6a, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp, 0x70>, "Size mismatch!");
...
/// @brief Field m_LocationToCatalogLoadOpMap, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_LocationToCatalogLoadOpMap, put=__cordl_internal_set_m_LocationToCatalogLoadOpMap)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp*>*  m_LocationToCatalogLoadOpMap;
...
/// @brief Method Provide, addr 0x6323d58, size 0x168, virtual true, abstract: false, final false
inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle  providerInterface) ;

/// @brief Method Release, addr 0x6323c5c, size 0xec, virtual true, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp*>* const& __cordl_internal_get_m_LocationToCatalogLoadOpMap() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp*>*& __cordl_internal_get_m_LocationToCatalogLoadOpMap() ;
...
constexpr void __cordl_internal_set_m_LocationToCatalogLoadOpMap(::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp*>*  value) ;

/// @brief Method .ctor, addr 0x6323bbc, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Field m_LocationToCatalogLoadOpMap, offset: 0x20, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_InternalOp*>*  ___m_LocationToCatalogLoadOpMap;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider, 0x28>, "Size mismatch!");

} // namespace end def UnityEngine::AddressableAssets::ResourceProviders
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::AddressableAssets::ResourceProviders::ContentCatalogProvider_DependencyHashIndex, "UnityEngine.AddressableAssets.ResourceProviders", "ContentCatalogProvider/DependencyHashIndex");
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::AddressableAssets::ResourceProviders::InternalOp_ContentCatalogProvider_BundledCatalog*, "UnityEngine.AddressableAssets.ResourceProviders", "ContentCatalogProvider/InternalOp/BundledCatalog");
