...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::AssetReference*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::AssetReference*, "UnityEngine.AddressableAssets", "AssetReference");
...
public:
  ...
  /// @brief Method InstantiateAsync, addr 0x645b2d0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAsync, addr 0x645b1d0, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method IsValid, addr 0x645ae28, size 0xc, virtual false, abstract: false, final false
  inline bool IsValid();
  ...
  /// @brief Method LoadSceneAsync, addr 0x645afe8, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method ReleaseAsset, addr 0x645b408, size 0xa4, virtual true, abstract: false, final false
  inline void ReleaseAsset();

  /// @brief Method ReleaseInstance, addr 0x645b4ac, size 0x58, virtual true, abstract: false, final false
  inline void ReleaseInstance(::UnityEngine::GameObject* obj);

  /// @brief Method RuntimeKeyIsValid, addr 0x645b384, size 0x84, virtual true, abstract: false, final false
  inline bool RuntimeKeyIsValid();

  /// @brief Method ToString, addr 0x645af7c, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnLoadScene, addr 0x645b138, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidateAsset, addr 0x645b504, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::UnityEngine::Object* obj);

  /// @brief Method ValidateAsset, addr 0x645b50c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x645ae40, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x645ae8c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::StringW guid);

  /// @brief Method get_Asset, addr 0x645aedc, size 0xa0, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> get_Asset();

  /// @brief Method get_AssetGUID, addr 0x645ad6c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_AssetGUID();

  /// @brief Method get_IsDone, addr 0x645ae34, size 0xc, virtual false, abstract: false, final false
  inline bool get_IsDone();

  /// @brief Method get_OperationHandle, addr 0x645ac94, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle get_OperationHandle();

  /// @brief Method get_RuntimeKey, addr 0x645acbc, size 0xb0, virtual true, abstract: false, final false
  inline ::System::Object* get_RuntimeKey();

  /// @brief Method get_SubObjectName, addr 0x645ad74, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_SubObjectName();

  /// @brief Method get_SubObjectType, addr 0x645ad84, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method set_OperationHandle, addr 0x645aca8, size 0x14, virtual false, abstract: false, final false
  inline void set_OperationHandle(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle value);

  /// @brief Method set_SubObjectName, addr 0x645ad7c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::AddressableAssets::AssetReference) == 0x40, "Size mismatch!");
