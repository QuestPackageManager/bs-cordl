...
public:
  ...
  /// @brief Method get_CompressionEnabled addr 0x28b2bb8 size 0x8 virtual false final false
  inline bool get_CompressionEnabled();

  /// @brief Method set_CompressionEnabled addr 0x28b2bc0 size 0xc virtual false final false
  inline void set_CompressionEnabled(bool value);

  /// @brief Method get_CacheDirectoryOverride addr 0x28b2bcc size 0x8 virtual false final false
  inline ::StringW get_CacheDirectoryOverride();

  /// @brief Method set_CacheDirectoryOverride addr 0x28b2bd4 size 0x8 virtual false final false
  inline void set_CacheDirectoryOverride(::StringW value);

  /// @brief Method get_ExpirationDelay addr 0x28b2bdc size 0x8 virtual false final false
  inline int32_t get_ExpirationDelay();

  /// @brief Method set_ExpirationDelay addr 0x28b2be4 size 0x8 virtual false final false
  inline void set_ExpirationDelay(int32_t value);

  /// @brief Method get_LimitCacheSize addr 0x28b2bec size 0x8 virtual false final false
  inline bool get_LimitCacheSize();

  /// @brief Method set_LimitCacheSize addr 0x28b2bf4 size 0xc virtual false final false
  inline void set_LimitCacheSize(bool value);

  /// @brief Method get_MaximumCacheSize addr 0x28b2c00 size 0x8 virtual false final false
  inline int64_t get_MaximumCacheSize();

  /// @brief Method set_MaximumCacheSize addr 0x28b2c08 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x28b2c10 size 0x6c virtual false final false
  inline void _ctor();
