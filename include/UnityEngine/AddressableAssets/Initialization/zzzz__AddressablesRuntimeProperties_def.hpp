...
/// @brief Method ClearCachedPropertyValues, addr 0x62b6194, size 0x80, virtual false, abstract: false, final false
static inline void ClearCachedPropertyValues() ;

/// @brief Method EvaluateProperty, addr 0x62b6214, size 0x3dc, virtual false, abstract: false, final false
static inline ::StringW EvaluateProperty(::StringW  name) ;

/// @brief Method EvaluateString, addr 0x62a1f08, size 0xf4, virtual false, abstract: false, final false
static inline ::StringW EvaluateString(::StringW  inputString) ;

/// @brief Method EvaluateString, addr 0x62b6bb0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method EvaluateStringInternal, addr 0x62b65f0, size 0x5c0, virtual false, abstract: false, final false
...
/// @brief Method GetAssemblies, addr 0x62b604c, size 0x1c, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*> GetAssemblies() ;

/// @brief Method GetCachedValueCount, addr 0x62b6068, size 0x84, virtual false, abstract: false, final false
static inline int32_t GetCachedValueCount() ;

/// @brief Method SetPropertyValue, addr 0x62b60ec, size 0xa8, virtual false, abstract: false, final false
