...
public:
  ...
  /// @brief Method ClearCachedPropertyValues, addr 0x63281a0, size 0x80, virtual false, abstract: false, final false
  static inline void ClearCachedPropertyValues();

  /// @brief Method EvaluateProperty, addr 0x6328220, size 0x3dc, virtual false, abstract: false, final false
  static inline ::StringW EvaluateProperty(::StringW name);

  /// @brief Method EvaluateString, addr 0x6313f14, size 0xf4, virtual false, abstract: false, final false
  static inline ::StringW EvaluateString(::StringW inputString);

  /// @brief Method EvaluateString, addr 0x6328bbc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateStringInternal, addr 0x63285fc, size 0x5c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAssemblies, addr 0x6328058, size 0x1c, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Reflection::Assembly*, ::Array<::System::Reflection::Assembly*>*> GetAssemblies();

  /// @brief Method GetCachedValueCount, addr 0x6328074, size 0x84, virtual false, abstract: false, final false
  static inline int32_t GetCachedValueCount();

  /// @brief Method SetPropertyValue, addr 0x63280f8, size 0xa8, virtual false, abstract: false, final false
