...
public:
  ...
  /// @brief Method Execute, addr 0x4504638, size 0x98, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x45044e0, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::Func_1<bool>* callback);

  /// @brief Method InvokeWaitForCompletion, addr 0x45044e8, size 0x94, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  static inline ::UnityEngine::AddressableAssets::Initialization::CacheInitialization_CacheInitOp* New_ctor();

  /// @brief Method Update, addr 0x450457c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4504410, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InitializeAsync>b__0, addr 0x45046d0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4504408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Initialize, addr 0x4504170, size 0x148, virtual true, abstract: false, final true
  inline bool Initialize(::StringW id, ::StringW dataStr);

  /// @brief Method InitializeAsync, addr 0x45042b8, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x45044d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_RootPath, addr 0x4504460, size 0x78, virtual false, abstract: false, final false
