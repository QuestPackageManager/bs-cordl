...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::Initialization::CacheInitialization*);
MARK_REF_T(::UnityEngine::AddressableAssets::Initialization::CacheInitialization_CacheInitOp*);
MARK_REF_T(::UnityEngine::AddressableAssets::Initialization::CacheInitialization___c__DisplayClass1_0*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::Initialization::CacheInitialization*, "UnityEngine.AddressableAssets.Initialization", "CacheInitialization");
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::Initialization::CacheInitialization_CacheInitOp*, "UnityEngine.AddressableAssets.Initialization", "CacheInitialization/CacheInitOp");
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::Initialization::CacheInitialization___c__DisplayClass1_0*, "UnityEngine.AddressableAssets.Initialization",
...
public:
  ...
  /// @brief Method Execute, addr 0x6467ba4, size 0x9c, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x6467a00, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::Func_1<bool>* callback);

  /// @brief Method InvokeWaitForCompletion, addr 0x6467a08, size 0xc0, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  static inline ::UnityEngine::AddressableAssets::Initialization::CacheInitialization_CacheInitOp* New_ctor();

  /// @brief Method Update, addr 0x6467ac8, size 0xdc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6467910, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InitializeAsync>b__0, addr 0x6467c40, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x646790c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::AddressableAssets::Initialization::CacheInitialization___c__DisplayClass1_0) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method Initialize, addr 0x6467580, size 0x208, virtual true, abstract: false, final true
  inline bool Initialize(::StringW id, ::StringW dataStr);

  /// @brief Method InitializeAsync, addr 0x6467788, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x64679fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_RootPath, addr 0x6467964, size 0x98, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::AddressableAssets::Initialization::CacheInitialization) == 0x10, "Size mismatch!");
