...
constexpr ::UnityEngine::AddressableAssets::AddressablesPlatform::AddressablesPlatform(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::AddressableAssets::AddressablesPlatform::AddressablesPlatform() {}
