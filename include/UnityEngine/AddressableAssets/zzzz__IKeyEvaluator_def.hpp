...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::IKeyEvaluator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::IKeyEvaluator*, "UnityEngine.AddressableAssets", "IKeyEvaluator");
// Dependencies
namespace UnityEngine::AddressableAssets {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IKeyEvaluator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IKeyEvaluator(IKeyEvaluatorconst&) = delete;
