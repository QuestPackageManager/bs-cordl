...
public:
  ...
  /// @brief Method ValidateAsset, addr 0x44ed5ac, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::StringW path);

  /// @brief Method .ctor, addr 0x44ed554, size 0x58, virtual false, abstract: false, final false
