...
public:
  ...
  /// @brief Method ValidateAsset, addr 0x62421a0, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::StringW path);

  /// @brief Method .ctor, addr 0x6242128, size 0x78, virtual false, abstract: false, final false
