...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8805)), TypeDefinitionIndex(TypeDefinitionIndex(14095)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14095), inst:
// 404 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(14098)) CS Name: ::UnityEngine.AddressableAssets::AssetReferenceTexture2D*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2a266e0, size 0x58, virtual false, abstract: false, final false
