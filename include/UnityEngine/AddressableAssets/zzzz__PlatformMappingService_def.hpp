...
/// @brief Field s_RuntimeTargetMapping, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_RuntimeTargetMapping, put=setStaticF_s_RuntimeTargetMapping)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::RuntimePlatform,::UnityEngine::AddressableAssets::AddressablesPlatform>*  s_RuntimeTargetMapping;

/// @brief Method GetAddressablesPlatformInternal, addr 0x62aeae0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetAddressablesPlatformPathInternal, addr 0x62aebcc, size 0x144, virtual false, abstract: false, final false
static inline ::StringW GetAddressablesPlatformPathInternal(::UnityEngine::RuntimePlatform  platform) ;

/// @brief Method GetPlatformPathSubFolder, addr 0x62a1e64, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62aed10, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
