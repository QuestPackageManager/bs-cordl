...
public:
  ...
  /// @brief Method GetAddressablesPlatformInternal, addr 0x44fb10c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAddressablesPlatformPathInternal, addr 0x44fb1e0, size 0x120, virtual false, abstract: false, final false
  static inline ::StringW GetAddressablesPlatformPathInternal(::UnityEngine::RuntimePlatform platform);

  /// @brief Method GetPlatform, addr 0x44fb300, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::AddressableAssets::AddressablesPlatform GetPlatform();

  /// @brief Method GetPlatformPathSubFolder, addr 0x44ef284, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44fb384, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
