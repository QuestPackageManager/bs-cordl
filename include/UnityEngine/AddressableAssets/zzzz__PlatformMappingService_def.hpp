...
// Write type traits
MARK_REF_T(::UnityEngine::AddressableAssets::PlatformMappingService*);
DEFINE_IL2CPP_CLASS(::UnityEngine::AddressableAssets::PlatformMappingService*, "UnityEngine.AddressableAssets", "PlatformMappingService");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformMappingService", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformMappingService(PlatformMappingService&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformMappingService", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformMappingService(PlatformMappingServiceconst&) = delete;
...
static_assert(sizeof(::UnityEngine::AddressableAssets::PlatformMappingService) == 0x10, "Size mismatch!");
