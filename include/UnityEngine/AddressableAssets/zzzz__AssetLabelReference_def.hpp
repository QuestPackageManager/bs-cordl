...
public:
  ...
  /// @brief Method GetHashCode, addr 0x62a9ab4, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::UnityEngine::AddressableAssets::AssetLabelReference* New_ctor();

  /// @brief Method RuntimeKeyIsValid, addr 0x62a9a5c, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x62a9ad0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_RuntimeKey, addr 0x62a9a38, size 0x24, virtual true, abstract: false, final true
  inline ::System::Object* get_RuntimeKey();

  /// @brief Method get_labelString, addr 0x62a9a28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_labelString, addr 0x62a9a30, size 0x8, virtual false, abstract: false, final false
