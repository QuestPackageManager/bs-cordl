...
public:
  ...
  /// @brief Method .ctor, addr 0x6460150, size 0x78, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceGameObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetReferenceGameObject(AssetReferenceGameObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetReferenceGameObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetReferenceGameObject(AssetReferenceGameObjectconst&) = delete;
