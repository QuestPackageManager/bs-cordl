...
/// @brief Field <MergeMode>k__BackingField, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__MergeMode_k__BackingField, put=__cordl_internal_set__MergeMode_k__BackingField)) ::System::Nullable_1<::UnityEngine::AddressableAssets::Addressables_MergeMode>  _MergeMode_k__BackingField;
...
/// @brief Method FormatMergeModeMessage, addr 0x6296708, size 0x48c, virtual false, abstract: false, final false
...
/// @brief Method FormatMessage, addr 0x6295f34, size 0x7d4, virtual false, abstract: false, final false
inline ::StringW FormatMessage(::UnityEngine::AddressableAssets::InvalidKeyException_Format  format, ::StringW  foundWithTypeString) ;

/// @brief Method FormatMultipleAssignableTypesMessage, addr 0x6298be4, size 0x1fc, virtual false, abstract: false, final false
...
/// @brief Method FormatNotFoundMessage, addr 0x6298a94, size 0xc, virtual false, abstract: false, final false
inline ::StringW FormatNotFoundMessage(::StringW  keyString) ;

/// @brief Method FormatTypeNotAssignableMessage, addr 0x6298aa0, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method GetCSVString, addr 0x62973b8, size 0x414, virtual false, abstract: false, final false
static inline ::StringW GetCSVString(::System::Collections::IEnumerable*  enumerator, ::StringW  prefixSingle, ::StringW  prefixPlural) ;

/// @brief Method GetKeyString, addr 0x6296b94, size 0xec, virtual false, abstract: false, final false
inline ::StringW GetKeyString() ;

/// @brief Method GetMessageForSingleKey, addr 0x6297318, size 0xa0, virtual false, abstract: false, final false
inline ::StringW GetMessageForSingleKey(::StringW  keyString) ;

/// @brief Method GetMessageforMergeKeys, addr 0x62977cc, size 0xbf8, virtual false, abstract: false, final false
inline ::StringW GetMessageforMergeKeys(::System::Collections::Generic::List_1<::StringW>*  keys) ;

/// @brief Method GetTypeToKeys, addr 0x6298de0, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method GetTypesForKey, addr 0x62983c4, size 0x6d0, virtual false, abstract: false, final false
...
static inline ::UnityEngine::AddressableAssets::InvalidKeyException* New_ctor(::System::Object*  key, ::System::Type*  type, ::UnityEngine::AddressableAssets::Addressables_MergeMode  mergeMode, ::UnityEngine::AddressableAssets::AddressablesImpl*  addr) ;
...
/// @brief Method .ctor, addr 0x6295d78, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6295af8, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  key) ;

/// @brief Method .ctor, addr 0x6295b4c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  key, ::System::Type*  type) ;

/// @brief Method .ctor, addr 0x6295bbc, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  key, ::System::Type*  type, ::UnityEngine::AddressableAssets::AddressablesImpl*  addr) ;

/// @brief Method .ctor, addr 0x6295c3c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  key, ::System::Type*  type, ::UnityEngine::AddressableAssets::Addressables_MergeMode  mergeMode) ;

/// @brief Method .ctor, addr 0x6295cd8, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6295dd0, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x6295e3c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  innerException) ;

/// @brief Method .ctor, addr 0x6295eb0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_Key, addr 0x6295ad0, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_Key() ;

/// @brief Method get_MergeMode, addr 0x6295af0, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::UnityEngine::AddressableAssets::Addressables_MergeMode> get_MergeMode() ;

/// @brief Method get_Message, addr 0x6296c80, size 0x698, virtual true, abstract: false, final false
inline ::StringW get_Message() ;

/// @brief Method get_Type, addr 0x6295ae0, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_Type() ;

/// @brief Method set_Key, addr 0x6295ad8, size 0x8, virtual false, abstract: false, final false
inline void set_Key(::System::Object*  value) ;

/// @brief Method set_Type, addr 0x6295ae8, size 0x8, virtual false, abstract: false, final false
