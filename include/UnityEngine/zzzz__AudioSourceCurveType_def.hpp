...
DEFINE_IL2CPP_CLASS(::UnityEngine::AudioSourceCurveType, "UnityEngine", "AudioSourceCurveType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::AudioSourceCurveType) == 0x4, "Size mismatch!");
