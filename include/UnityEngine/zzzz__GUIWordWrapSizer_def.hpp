...
// Write type traits
MARK_REF_T(::UnityEngine::GUIWordWrapSizer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::GUIWordWrapSizer*, "UnityEngine", "GUIWordWrapSizer");
...
public:
  ...
  /// @brief Method CalcHeight, addr 0x6b4f540, size 0x58, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x6b4f4d8, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b473b0, size 0xdc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GUIWordWrapSizer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GUIWordWrapSizer(GUIWordWrapSizer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GUIWordWrapSizer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GUIWordWrapSizer(GUIWordWrapSizerconst&) = delete;
...
static_assert(sizeof(::UnityEngine::GUIWordWrapSizer) == 0x58, "Size mismatch!");
