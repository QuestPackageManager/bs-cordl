...
public:
  ...
  /// @brief Method CalcHeight, addr 0x48ef35c, size 0xa0, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x48ef2f4, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48ea010, size 0xd4, virtual false, abstract: false, final false
