...
public:
  ...
  /// @brief Method CalcHeight, addr 0x69f6964, size 0x58, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x69f68fc, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69ee7d4, size 0xdc, virtual false, abstract: false, final false
