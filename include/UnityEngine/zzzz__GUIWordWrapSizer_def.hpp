...
public:
  ...
  /// @brief Method CalcHeight, addr 0x48e2bbc, size 0xa0, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x48e2b54, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48dd870, size 0xd4, virtual false, abstract: false, final false
