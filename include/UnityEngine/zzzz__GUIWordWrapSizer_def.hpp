...
/// @brief Method CalcHeight, addr 0x698471c, size 0x58, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x69846b4, size 0x68, virtual true, abstract: false, final false
inline void CalcWidth() ;

static inline ::UnityEngine::GUIWordWrapSizer* New_ctor(::UnityEngine::GUIStyle*  style, ::UnityEngine::GUIContent*  content, ::ArrayW<::UnityEngine::GUILayoutOption*,::Array<::UnityEngine::GUILayoutOption*>*>  options) ;
...
/// @brief Method .ctor, addr 0x697c58c, size 0xdc, virtual false, abstract: false, final false
