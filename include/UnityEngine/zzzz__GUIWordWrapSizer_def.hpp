...
public:
  ...
  /// @brief Method CalcHeight, addr 0x698405c, size 0x58, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x6983ff4, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x697becc, size 0xdc, virtual false, abstract: false, final false
