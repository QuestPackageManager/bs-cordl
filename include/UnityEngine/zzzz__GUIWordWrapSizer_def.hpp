...
public:
  ...
  /// @brief Method CalcHeight, addr 0x691b1d8, size 0x58, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x691b170, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6913048, size 0xdc, virtual false, abstract: false, final false
