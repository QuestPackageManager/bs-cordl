...
/// @brief Method ScheduleBatch, addr 0x69cb9fc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ScheduleBatch, addr 0x69cb7b4, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method ScheduleSpherecastBatch, addr 0x69cb960, size 0x9c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleSpherecastBatch(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, void*  commands, int32_t  commandLen, void*  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits) ;

/// @brief Method ScheduleSpherecastBatch_Injected, addr 0x69cba20, size 0x8c, virtual false, abstract: false, final false
static inline void ScheduleSpherecastBatch_Injected(::ByRef<::Unity::Jobs::LowLevel::Unsafe::JobsUtility_JobScheduleParameters>  parameters, void*  commands, int32_t  commandLen, void*  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method .ctor, addr 0x69cbaac, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69cb668, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69cbb80, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69cb734, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_direction, addr 0x69cb77c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_direction() ;

/// @brief Method get_distance, addr 0x69cb794, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_layerMask, addr 0x69cbba4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layerMask() ;

/// @brief Method get_origin, addr 0x69cb754, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_origin() ;

/// @brief Method get_physicsScene, addr 0x69cb7a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::PhysicsScene get_physicsScene() ;

/// @brief Method get_radius, addr 0x69cb76c, size 0x8, virtual false, abstract: false, final false
inline float_t get_radius() ;

/// @brief Method set_direction, addr 0x69cb788, size 0xc, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::Vector3  value) ;

/// @brief Method set_distance, addr 0x69cb79c, size 0x8, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_layerMask, addr 0x69cbb78, size 0x8, virtual false, abstract: false, final false
inline void set_layerMask(int32_t  value) ;

/// @brief Method set_origin, addr 0x69cb760, size 0xc, virtual false, abstract: false, final false
inline void set_origin(::UnityEngine::Vector3  value) ;

/// @brief Method set_physicsScene, addr 0x69cb7ac, size 0x8, virtual false, abstract: false, final false
inline void set_physicsScene(::UnityEngine::PhysicsScene  value) ;

/// @brief Method set_radius, addr 0x69cb774, size 0x8, virtual false, abstract: false, final false
