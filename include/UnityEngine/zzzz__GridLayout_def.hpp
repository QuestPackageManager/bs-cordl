...
public:
  // Declarations
  /// @brief Method CellToLocal addr 0x2cfaefc size 0x68 virtual false final false
  inline ::UnityEngine::Vector3 CellToLocal(::UnityEngine::Vector3Int cellPosition);

  /// @brief Method DoNothing addr 0x2cfafb8 size 0x4 virtual false final false
  inline void DoNothing();

  static inline ::UnityEngine::GridLayout* New_ctor();

  /// @brief Method .ctor addr 0x2cfafbc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CellToLocal_Injected addr 0x2cfaf64 size 0x54 virtual false final false
