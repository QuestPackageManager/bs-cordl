...
public:
  ...
  /// @brief Method .ctor, addr 0x69a7074, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(int32_t rows, int32_t cols);

  /// @brief Method get_Item, addr 0x69a7194, size 0xbc, virtual false, abstract: false, final false
  inline float_t get_Item(int32_t row, int32_t col);

  /// @brief Method get_columns, addr 0x69a732c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_columns();

  /// @brief Method get_elements, addr 0x69a733c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<float_t>* get_elements();

  /// @brief Method get_rows, addr 0x69a731c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_rows();

  /// @brief Method set_Item, addr 0x69a7250, size 0xcc, virtual false, abstract: false, final false
  inline void set_Item(int32_t row, int32_t col, float_t value);

  /// @brief Method set_columns, addr 0x69a7334, size 0x8, virtual false, abstract: false, final false
  inline void set_columns(int32_t value);

  /// @brief Method set_elements, addr 0x69a7344, size 0x8, virtual false, abstract: false, final false
  inline void set_elements(::System::Collections::Generic::List_1<float_t>* value);

  /// @brief Method set_rows, addr 0x69a7324, size 0x8, virtual false, abstract: false, final false
