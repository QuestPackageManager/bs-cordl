...
public:
// Declarations
/// @brief Method CreateInstance, addr 0x691bc30, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CreateScriptableObject, addr 0x691bbf4, size 0x3c, virtual false, abstract: false, final false
static inline void CreateScriptableObject(::UnityEngine::ScriptableObject*  self) ;

/// @brief Method CreateScriptableObjectInstanceFromType, addr 0x691bc38, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method CreateScriptableObjectInstanceFromType_Injected, addr 0x691bd60, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x691bb7c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
