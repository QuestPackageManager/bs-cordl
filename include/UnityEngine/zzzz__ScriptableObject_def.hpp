...
public:
  // Declarations
  /// @brief Method CreateInstance, addr 0x698de4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateScriptableObject, addr 0x698de10, size 0x3c, virtual false, abstract: false, final false
  static inline void CreateScriptableObject(::UnityEngine::ScriptableObject* self);

  /// @brief Method CreateScriptableObjectInstanceFromType, addr 0x698de54, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateScriptableObjectInstanceFromType_Injected, addr 0x698df7c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x698dd98, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
