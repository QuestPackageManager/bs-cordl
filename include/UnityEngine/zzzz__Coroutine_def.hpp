...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x6914410, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Finalize, addr 0x6914360, size 0x74, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::UnityEngine::Coroutine* New_ctor() ;

/// @brief Method ReleaseCoroutine, addr 0x69143d4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x691435c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
