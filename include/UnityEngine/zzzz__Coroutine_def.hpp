...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x698662c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finalize, addr 0x698657c, size 0x74, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::UnityEngine::Coroutine* New_ctor();

  /// @brief Method ReleaseCoroutine, addr 0x69865f0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6986578, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
