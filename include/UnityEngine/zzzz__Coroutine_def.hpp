...
public:
  ...
  /// @brief Method Finalize, addr 0x48a4678, size 0xbc, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::UnityEngine::Coroutine* New_ctor();

  /// @brief Method ReleaseCoroutine, addr 0x48a4734, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48a4670, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
