...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6ade42c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Finalize, addr 0x6ade37c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ade378, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
