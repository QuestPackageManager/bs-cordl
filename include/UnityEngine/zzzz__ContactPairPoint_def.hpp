...
public:
  ...
  /// @brief Method get_Impulse, addr 0x6a3a5b8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Impulse();

  /// @brief Method get_Normal, addr 0x6a3a5ac, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Normal();

  /// @brief Method get_Position, addr 0x6a3a598, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Position();

  /// @brief Method get_Separation, addr 0x6a3a5a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Separation();

  /// @brief Method get_impulse, addr 0x6a3a58c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_impulse();

  /// @brief Method get_normal, addr 0x6a3a580, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_normal();

  /// @brief Method get_position, addr 0x6a3a56c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_separation, addr 0x6a3a578, size 0x8, virtual false, abstract: false, final false
  inline float_t get_separation();
