...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x699d93c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x699d8c0, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ForceUpdateRectTransforms, addr 0x699d04c, size 0x78, virtual false, abstract: false, final false
  inline void ForceUpdateRectTransforms();

  /// @brief Method ForceUpdateRectTransforms_Injected, addr 0x699d0c4, size 0x3c, virtual false, abstract: false, final false
  static inline void ForceUpdateRectTransforms_Injected(::System::IntPtr _unity_self);

  /// @brief Method GetLocalCorners, addr 0x699d100, size 0xf4, virtual false, abstract: false, final false
  inline void GetLocalCorners(::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> fourCornersArray);

  /// @brief Method GetParentSize, addr 0x699d5c0, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetParentSize();

  /// @brief Method GetRectInParentSpace, addr 0x699d724, size 0x188, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetRectInParentSpace();

  /// @brief Method GetWorldCorners, addr 0x699d1f4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method SendReapplyDrivenProperties, addr 0x699d6b4, size 0x70, virtual false, abstract: false, final false
  static inline void SendReapplyDrivenProperties(::UnityEngine::RectTransform* driven);

  /// @brief Method SetInsetAndSizeFromParentEdge, addr 0x699d3c4, size 0x104, virtual false, abstract: false, final false
  inline void SetInsetAndSizeFromParentEdge(::UnityEngine::RectTransform_Edge edge, float_t inset, float_t size);

  /// @brief Method SetSizeWithCurrentAnchors, addr 0x699d4c8, size 0xf8, virtual false, abstract: false, final false
  inline void SetSizeWithCurrentAnchors(::UnityEngine::RectTransform_Axis axis, float_t size);

  /// @brief Method .ctor, addr 0x699d8b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_reapplyDrivenProperties, addr 0x699bce8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_anchorMax, addr 0x699c140, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_anchorMax();

  /// @brief Method get_anchorMax_Injected, addr 0x699c1d0, size 0x44, virtual false, abstract: false, final false
  static inline void get_anchorMax_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method get_anchorMin, addr 0x699bf9c, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_anchorMin();

  /// @brief Method get_anchorMin_Injected, addr 0x699c02c, size 0x44, virtual false, abstract: false, final false
  static inline void get_anchorMin_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method get_anchoredPosition, addr 0x699c2e4, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_anchoredPosition();

  /// @brief Method get_anchoredPosition3D, addr 0x699c7d0, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_anchoredPosition3D();

  /// @brief Method get_anchoredPosition_Injected, addr 0x699c374, size 0x44, virtual false, abstract: false, final false
  static inline void get_anchoredPosition_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method get_drivenByObject, addr 0x699cc4c, size 0x148, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Object> get_drivenByObject();

  /// @brief Method get_drivenByObject_Injected, addr 0x699cd94, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_drivenByObject_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_drivenProperties, addr 0x699cecc, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::DrivenTransformProperties get_drivenProperties();

  /// @brief Method get_drivenProperties_Injected, addr 0x699cf44, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::DrivenTransformProperties get_drivenProperties_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_offsetMax, addr 0x699caa8, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_offsetMax();

  /// @brief Method get_offsetMin, addr 0x699c95c, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_offsetMin();

  /// @brief Method get_pivot, addr 0x699c62c, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_pivot();

  /// @brief Method get_pivot_Injected, addr 0x699c6bc, size 0x44, virtual false, abstract: false, final false
  static inline void get_pivot_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method get_rect, addr 0x699be80, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_rect_Injected, addr 0x699bf58, size 0x44, virtual false, abstract: false, final false
  static inline void get_rect_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Rect> ret);

  /// @brief Method get_sizeDelta, addr 0x699c488, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_sizeDelta();

  /// @brief Method get_sizeDelta_Injected, addr 0x699c518, size 0x44, virtual false, abstract: false, final false
  static inline void get_sizeDelta_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> ret);

  /// @brief Method remove_reapplyDrivenProperties, addr 0x699bdb4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_anchorMax, addr 0x699c214, size 0x8c, virtual false, abstract: false, final false
  inline void set_anchorMax(::UnityEngine::Vector2 value);

  /// @brief Method set_anchorMax_Injected, addr 0x699c2a0, size 0x44, virtual false, abstract: false, final false
  static inline void set_anchorMax_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> value);

  /// @brief Method set_anchorMin, addr 0x699c070, size 0x8c, virtual false, abstract: false, final false
  inline void set_anchorMin(::UnityEngine::Vector2 value);

  /// @brief Method set_anchorMin_Injected, addr 0x699c0fc, size 0x44, virtual false, abstract: false, final false
  static inline void set_anchorMin_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> value);

  /// @brief Method set_anchoredPosition, addr 0x699c3b8, size 0x8c, virtual false, abstract: false, final false
  inline void set_anchoredPosition(::UnityEngine::Vector2 value);

  /// @brief Method set_anchoredPosition3D, addr 0x699c89c, size 0x30, virtual false, abstract: false, final false
  inline void set_anchoredPosition3D(::UnityEngine::Vector3 value);

  /// @brief Method set_anchoredPosition_Injected, addr 0x699c444, size 0x44, virtual false, abstract: false, final false
  static inline void set_anchoredPosition_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> value);

  /// @brief Method set_drivenByObject, addr 0x699cdd0, size 0xb8, virtual false, abstract: false, final false
  inline void set_drivenByObject(::UnityEngine::Object* value);

  /// @brief Method set_drivenByObject_Injected, addr 0x699ce88, size 0x44, virtual false, abstract: false, final false
  static inline void set_drivenByObject_Injected(::System::IntPtr _unity_self, ::System::IntPtr value);

  /// @brief Method set_drivenProperties, addr 0x699cf80, size 0x88, virtual false, abstract: false, final false
  inline void set_drivenProperties(::UnityEngine::DrivenTransformProperties value);

  /// @brief Method set_drivenProperties_Injected, addr 0x699d008, size 0x44, virtual false, abstract: false, final false
  static inline void set_drivenProperties_Injected(::System::IntPtr _unity_self, ::UnityEngine::DrivenTransformProperties value);

  /// @brief Method set_offsetMax, addr 0x699cb4c, size 0x100, virtual false, abstract: false, final false
  inline void set_offsetMax(::UnityEngine::Vector2 value);

  /// @brief Method set_offsetMin, addr 0x699c9b0, size 0xf8, virtual false, abstract: false, final false
  inline void set_offsetMin(::UnityEngine::Vector2 value);

  /// @brief Method set_pivot, addr 0x699c700, size 0x8c, virtual false, abstract: false, final false
  inline void set_pivot(::UnityEngine::Vector2 value);

  /// @brief Method set_pivot_Injected, addr 0x699c78c, size 0x44, virtual false, abstract: false, final false
  static inline void set_pivot_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Vector2> value);

  /// @brief Method set_sizeDelta, addr 0x699c55c, size 0x8c, virtual false, abstract: false, final false
  inline void set_sizeDelta(::UnityEngine::Vector2 value);

  /// @brief Method set_sizeDelta_Injected, addr 0x699c5e8, size 0x44, virtual false, abstract: false, final false
