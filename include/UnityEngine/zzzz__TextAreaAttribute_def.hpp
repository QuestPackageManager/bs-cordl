...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad8070, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ad8080, size 0xc, virtual false, abstract: false, final false
