...
public:
  ...
  /// @brief Method .ctor, addr 0x690d56c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x690d57c, size 0xc, virtual false, abstract: false, final false
