...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad4d60, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ad4d70, size 0xc, virtual false, abstract: false, final false
