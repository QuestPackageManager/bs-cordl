...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x69150a0, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::GUISkin_SkinChangedDelegate* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x6915038, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Apply, addr 0x69139cc, size 0x84, virtual false, abstract: false, final false
  inline void Apply();

  /// @brief Method BuildStyleCache, addr 0x6913e6c, size 0xd08, virtual false, abstract: false, final false
  inline void BuildStyleCache();

  /// @brief Method CleanupRoots, addr 0x6913a50, size 0x50, virtual false, abstract: false, final false
  static inline void CleanupRoots();

  /// @brief Method FindStyle, addr 0x6914ee8, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* FindStyle(::StringW styleName);

  /// @brief Method GetEnumerator, addr 0x6914f74, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetStyle, addr 0x6914cd8, size 0x210, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* GetStyle(::StringW styleName);

  /// @brief Method MakeCurrent, addr 0x690d85c, size 0xac, virtual false, abstract: false, final false
  inline void MakeCurrent();

  static inline ::UnityEngine::GUISkin* New_ctor();

  /// @brief Method OnEnable, addr 0x69139c8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6913920, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_box, addr 0x690e008, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_box();

  /// @brief Method get_button, addr 0x6913c54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_button();

  /// @brief Method get_customStyles, addr 0x6913d84, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::GUIStyle*, ::Array<::UnityEngine::GUIStyle*>*> get_customStyles();

  /// @brief Method get_error, addr 0x6913d9c, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIStyle* get_error();

  /// @brief Method get_font, addr 0x6913aa0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Font> get_font();

  /// @brief Method get_horizontalScrollbar, addr 0x6913cf4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalScrollbar();

  /// @brief Method get_horizontalScrollbarLeftButton, addr 0x6913d14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalScrollbarLeftButton();

  /// @brief Method get_horizontalScrollbarRightButton, addr 0x6913d24, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalScrollbarRightButton();

  /// @brief Method get_horizontalScrollbarThumb, addr 0x6913d04, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalScrollbarThumb();

  /// @brief Method get_horizontalSlider, addr 0x6913c84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalSlider();

  /// @brief Method get_horizontalSliderThumb, addr 0x6913c94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalSliderThumb();

  /// @brief Method get_horizontalSliderThumbExtent, addr 0x6913ca4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_horizontalSliderThumbExtent();

  /// @brief Method get_label, addr 0x690dbd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_label();

  /// @brief Method get_scrollView, addr 0x6913d74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_scrollView();

  /// @brief Method get_settings, addr 0x6913d94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUISettings* get_settings();

  /// @brief Method get_sliderMixed, addr 0x6913cb4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_sliderMixed();

  /// @brief Method get_textArea, addr 0x6913c44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_textArea();

  /// @brief Method get_textField, addr 0x6913c34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_textField();

  /// @brief Method get_toggle, addr 0x6913c64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_toggle();

  /// @brief Method get_verticalScrollbar, addr 0x6913d34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalScrollbar();

  /// @brief Method get_verticalScrollbarDownButton, addr 0x6913d64, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalScrollbarDownButton();

  /// @brief Method get_verticalScrollbarThumb, addr 0x6913d44, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalScrollbarThumb();

  /// @brief Method get_verticalScrollbarUpButton, addr 0x6913d54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalScrollbarUpButton();

  /// @brief Method get_verticalSlider, addr 0x6913cc4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalSlider();

  /// @brief Method get_verticalSliderThumb, addr 0x6913cd4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalSliderThumb();

  /// @brief Method get_verticalSliderThumbExtent, addr 0x6913ce4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::GUIStyle* get_verticalSliderThumbExtent();

  /// @brief Method get_window, addr 0x6913c74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_box, addr 0x6913c24, size 0x8, virtual false, abstract: false, final false
  inline void set_box(::UnityEngine::GUIStyle* value);

  /// @brief Method set_button, addr 0x6913c5c, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::GUIStyle* value);

  /// @brief Method set_customStyles, addr 0x6913d8c, size 0x8, virtual false, abstract: false, final false
  inline void set_customStyles(::ArrayW<::UnityEngine::GUIStyle*, ::Array<::UnityEngine::GUIStyle*>*> value);

  /// @brief Method set_font, addr 0x6913aa8, size 0xd4, virtual false, abstract: false, final false
  inline void set_font(::UnityEngine::Font* value);

  /// @brief Method set_horizontalScrollbar, addr 0x6913cfc, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbar(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalScrollbarLeftButton, addr 0x6913d1c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbarLeftButton(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalScrollbarRightButton, addr 0x6913d2c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbarRightButton(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalScrollbarThumb, addr 0x6913d0c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalScrollbarThumb(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalSlider, addr 0x6913c8c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalSlider(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalSliderThumb, addr 0x6913c9c, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalSliderThumb(::UnityEngine::GUIStyle* value);

  /// @brief Method set_horizontalSliderThumbExtent, addr 0x6913cac, size 0x8, virtual false, abstract: false, final false
  inline void set_horizontalSliderThumbExtent(::UnityEngine::GUIStyle* value);

  /// @brief Method set_label, addr 0x6913c2c, size 0x8, virtual false, abstract: false, final false
  inline void set_label(::UnityEngine::GUIStyle* value);

  /// @brief Method set_scrollView, addr 0x6913d7c, size 0x8, virtual false, abstract: false, final false
  inline void set_scrollView(::UnityEngine::GUIStyle* value);

  /// @brief Method set_sliderMixed, addr 0x6913cbc, size 0x8, virtual false, abstract: false, final false
  inline void set_sliderMixed(::UnityEngine::GUIStyle* value);

  /// @brief Method set_textArea, addr 0x6913c4c, size 0x8, virtual false, abstract: false, final false
  inline void set_textArea(::UnityEngine::GUIStyle* value);

  /// @brief Method set_textField, addr 0x6913c3c, size 0x8, virtual false, abstract: false, final false
  inline void set_textField(::UnityEngine::GUIStyle* value);

  /// @brief Method set_toggle, addr 0x6913c6c, size 0x8, virtual false, abstract: false, final false
  inline void set_toggle(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalScrollbar, addr 0x6913d3c, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbar(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalScrollbarDownButton, addr 0x6913d6c, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbarDownButton(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalScrollbarThumb, addr 0x6913d4c, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbarThumb(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalScrollbarUpButton, addr 0x6913d5c, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalScrollbarUpButton(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalSlider, addr 0x6913ccc, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalSlider(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalSliderThumb, addr 0x6913cdc, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalSliderThumb(::UnityEngine::GUIStyle* value);

  /// @brief Method set_verticalSliderThumbExtent, addr 0x6913cec, size 0x8, virtual false, abstract: false, final false
  inline void set_verticalSliderThumbExtent(::UnityEngine::GUIStyle* value);

  /// @brief Method set_window, addr 0x6913c7c, size 0x8, virtual false, abstract: false, final false
