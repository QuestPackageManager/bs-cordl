...
public:
  ...
  /// @brief Method .ctor, addr 0x68b2618, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t start, int32_t length);

  /// @brief Method get_end, addr 0x68b260c, size 0xc, virtual false, abstract: false, final false
