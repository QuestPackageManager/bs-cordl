...
public:
  ...
  /// @brief Method Execute, addr 0x44eb19c, size 0x650, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x44eabc4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x44eaffc, size 0x1a0, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method LogRuntimeWarnings, addr 0x44eacc8, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method <Execute>b__8_0, addr 0x44eb8dc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44eb894, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x44eac88, size 0x40, virtual true, abstract: false, final false
