...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation*, "UnityEngine.ResourceManagement.AsyncOperations", "InitalizationObjectsOperation");
...
public:
  ...
  /// @brief Method Execute, addr 0x64458c0, size 0x680, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x644535c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x64456e0, size 0x1e0, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method LogRuntimeWarnings, addr 0x64453d0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method <Execute>b__8_0, addr 0x6446040, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6445ff4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x644538c, size 0x44, virtual true, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation, ___m_Addressables) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation, ___m_DepOp) == 0xb8, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation) == 0xd0, "Size mismatch!");
