...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __get_value() const;
...
template <typename TObject>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(14306))}
...
public:
  ...
  __declspec(property(get = __get_m_DestroyedAction,
                      put = __set_m_DestroyedAction))::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>* m_DestroyedAction;

  /// @brief Field m_CompletedActionT, offset 0x40, size 0x8
  __declspec(property(get = __get_m_CompletedActionT,
                      put = __set_m_CompletedActionT))::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>* m_CompletedActionT;
  ...
  __declspec(property(get = __get_m_dependencyCompleteAction,
                      put = __set_m_dependencyCompleteAction))::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>* m_dependencyCompleteAction;
  ...
  __declspec(property(get = __get_m_taskCompletionSourceTypeless,
                      put = __set_m_taskCompletionSourceTypeless))::System::Threading::Tasks::TaskCompletionSource_1<::System::Object*>* m_taskCompletionSourceTypeless;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Exception*> const& __get_m_Error() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __get_m_DestroyedAction() const;
  ...
  __get_m_CompletedActionT() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*> const& __get_m_OnDestroyAction() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __get_m_dependencyCompleteAction() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskCompletionSource_1<TObject>*> const& __get_m_taskCompletionSource() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskCompletionSource_1<::System::Object*>*> const& __get_m_taskCompletionSourceTypeless() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_1<float_t>*> const& __get_m_UpdateCallback() const;
