...
public:
  ...
  /// @brief Method Equals addr 0x2a59db4 size 0x2c virtual false final false
  inline bool Equals(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle other);

  /// @brief Method get_DebugName addr 0x2a59de0 size 0xdc virtual false final false
  inline ::StringW get_DebugName();

  /// @brief Method add_Destroyed addr 0x2a59f74 size 0xb4 virtual false final false
  inline void add_Destroyed(::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>* value);

  /// @brief Method remove_Destroyed addr 0x2a5a028 size 0xb4 virtual false final false
  inline void remove_Destroyed(::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>* value);

  /// @brief Method GetDependencies addr 0x2a5a0dc size 0xb4 virtual false final false
  ...
  /// @brief Method GetHashCode addr 0x2a5a190 size 0x30 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method get_InternalOp addr 0x2a59c00 size 0x100 virtual false final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* get_InternalOp();

  /// @brief Method get_IsDone addr 0x2a5a1c0 size 0xc8 virtual false final false
  inline bool get_IsDone();

  /// @brief Method IsValid addr 0x2a59ebc size 0xb8 virtual false final false
  inline bool IsValid();

  /// @brief Method get_OperationException addr 0x2a5a288 size 0xac virtual false final false
  inline ::System::Exception* get_OperationException();

  /// @brief Method get_PercentComplete addr 0x2a5a334 size 0xac virtual false final false
  inline float_t get_PercentComplete();

  /// @brief Method GetDownloadStatus addr 0x2a5a3e0 size 0xa0 virtual false final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus GetDownloadStatus();

  /// @brief Method InternalGetDownloadStatus addr 0x2a5a480 size 0x174 virtual false final false
  ...
  /// @brief Method get_ReferenceCount addr 0x2a5a5f4 size 0xac virtual false final false
  inline int32_t get_ReferenceCount();

  /// @brief Method Release addr 0x2a49f00 size 0xb4 virtual false final false
  inline void Release();

  /// @brief Method get_Result addr 0x2a56a08 size 0xa8 virtual false final false
  inline ::System::Object* get_Result();

  /// @brief Method get_Status addr 0x2a5a6a0 size 0xac virtual false final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationStatus get_Status();

  /// @brief Method get_Task addr 0x2a5a74c size 0xac virtual false final false
  inline ::System::Threading::Tasks::Task_1<::System::Object*>* get_Task();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2a5a7f8 size 0x4 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.IEnumerator.MoveNext addr 0x2a5a7fc size 0x18 virtual true final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2a5a814 size 0x4 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method WaitForCompletion addr 0x2a5a818 size 0x14c virtual false final false
