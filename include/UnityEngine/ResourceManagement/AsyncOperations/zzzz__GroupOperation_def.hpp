...
/// @brief Field m_Settings, offset 0xa4, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_Settings, put=__cordl_internal_set_m_Settings)) ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation_GroupOperationSettings  m_Settings;
...
/// @brief Method CompleteIfDependenciesComplete, addr 0x6770464, size 0x318, virtual false, abstract: false, final false
inline void CompleteIfDependenciesComplete() ;

/// @brief Method DependenciesAreUnchanged, addr 0x676fd70, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method Destroy, addr 0x677077c, size 0x24, virtual true, abstract: false, final false
inline void Destroy() ;

/// @brief Method Execute, addr 0x677023c, size 0x228, virtual true, abstract: false, final false
inline void Execute() ;

/// @brief Method GetDependencies, addr 0x676f810, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method GetDependentOps, addr 0x676f7cc, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetDownloadStatus, addr 0x676fb00, size 0x270, virtual true, abstract: false, final false
...
/// @brief Method Init, addr 0x67709a8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x6770a68, size 0xa0, virtual false, abstract: false, final false
inline void Init(::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  operations, ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation_GroupOperationSettings  settings) ;

/// @brief Method InvokeWaitForCompletion, addr 0x676f3e4, size 0x3d8, virtual true, abstract: false, final false
inline bool InvokeWaitForCompletion() ;

static inline ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation* New_ctor() ;

/// @brief Method OnOperationCompleted, addr 0x6770b08, size 0x10, virtual false, abstract: false, final false
inline void OnOperationCompleted(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle  op) ;

/// @brief Method ReleaseDependencies, addr 0x676f898, size 0x268, virtual true, abstract: false, final false
inline void ReleaseDependencies() ;

/// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.get_Key, addr 0x676f7bc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.set_Key, addr 0x676f7c4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x676f2a0, size 0x144, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DebugName, addr 0x676fefc, size 0x340, virtual true, abstract: false, final false
inline ::StringW get_DebugName() ;

/// @brief Method get_Progress, addr 0x67707a0, size 0x208, virtual true, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation_GroupOperationSettings, "UnityEngine.ResourceManagement.AsyncOperations", "GroupOperation/GroupOperationSettings");
