...
public:
  ...
  /// @brief Method CompleteIfDependenciesComplete, addr 0x310e104, size 0x308, virtual false, abstract: false, final false
  inline void CompleteIfDependenciesComplete();

  /// @brief Method DependenciesAreUnchanged, addr 0x310da4c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x310e40c, size 0x10, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x310deec, size 0x218, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x310d534, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDependentOps, addr 0x30fcb64, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDownloadStatus, addr 0x310d7ec, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x30fca78, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x310e614, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x310d14c, size 0x3d8, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  static inline ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation* New_ctor();

  /// @brief Method OnOperationCompleted, addr 0x310e6ac, size 0x10, virtual false, abstract: false, final false
  inline void OnOperationCompleted(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle op);

  /// @brief Method ReleaseDependencies, addr 0x310d598, size 0x254, virtual true, abstract: false, final false
  inline void ReleaseDependencies();

  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.get_Key, addr 0x310d524, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.set_Key, addr 0x310d52c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x310d014, size 0x138, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x310dc18, size 0x2d4, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x310e41c, size 0x1f8, virtual true, abstract: false, final false
