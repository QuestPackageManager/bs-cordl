...
public:
  ...
  /// @brief Method CompleteIfDependenciesComplete, addr 0x6922acc, size 0x318, virtual false, abstract: false, final false
  inline void CompleteIfDependenciesComplete();

  /// @brief Method DependenciesAreUnchanged, addr 0x69223d8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x6922de4, size 0x24, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x69228a4, size 0x228, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x6921e78, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDependentOps, addr 0x6921e34, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDownloadStatus, addr 0x6922168, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x6923010, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x69230d0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x6921a4c, size 0x3d8, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  static inline ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation* New_ctor();

  /// @brief Method OnOperationCompleted, addr 0x6923170, size 0x10, virtual false, abstract: false, final false
  inline void OnOperationCompleted(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle op);

  /// @brief Method ReleaseDependencies, addr 0x6921f00, size 0x268, virtual true, abstract: false, final false
  inline void ReleaseDependencies();

  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.get_Key, addr 0x6921e24, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.set_Key, addr 0x6921e2c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6921908, size 0x144, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x6922564, size 0x340, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x6922e08, size 0x208, virtual true, abstract: false, final false
