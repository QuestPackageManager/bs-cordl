...
public:
  ...
  /// @brief Method CompleteIfDependenciesComplete, addr 0x3314b8c, size 0x308, virtual false, abstract: false, final false
  inline void CompleteIfDependenciesComplete();

  /// @brief Method DependenciesAreUnchanged, addr 0x33144d4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Destroy, addr 0x3314e94, size 0x10, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x3314974, size 0x218, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x3313fbc, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDependentOps, addr 0x33035ec, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDownloadStatus, addr 0x3314274, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3303500, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x331509c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeWaitForCompletion, addr 0x3313bd4, size 0x3d8, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();

  static inline ::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation* New_ctor();

  /// @brief Method OnOperationCompleted, addr 0x3315134, size 0x10, virtual false, abstract: false, final false
  inline void OnOperationCompleted(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle op);

  /// @brief Method ReleaseDependencies, addr 0x3314020, size 0x254, virtual true, abstract: false, final false
  inline void ReleaseDependencies();

  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.get_Key, addr 0x3313fac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.set_Key, addr 0x3313fb4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3313a9c, size 0x138, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x33146a0, size 0x2d4, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x3314ea4, size 0x1f8, virtual true, abstract: false, final false
