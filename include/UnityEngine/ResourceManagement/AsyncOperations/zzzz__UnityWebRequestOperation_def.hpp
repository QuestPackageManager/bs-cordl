...
public:
  ...
  /// @brief Method Execute, addr 0x47a7e38, size 0x9c, virtual true, abstract: false, final false
  inline void Execute();
  ...
  /// @brief Method <Execute>b__2_0, addr 0x47a7ed4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47a7ddc, size 0x5c, virtual false, abstract: false, final false
