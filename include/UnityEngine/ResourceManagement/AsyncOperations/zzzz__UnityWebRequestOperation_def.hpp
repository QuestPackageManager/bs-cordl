...
public:
  ...
  /// @brief Method Execute, addr 0x47b3ac0, size 0x9c, virtual true, abstract: false, final false
  inline void Execute();
  ...
  /// @brief Method <Execute>b__2_0, addr 0x47b3b5c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47b3a64, size 0x5c, virtual false, abstract: false, final false
