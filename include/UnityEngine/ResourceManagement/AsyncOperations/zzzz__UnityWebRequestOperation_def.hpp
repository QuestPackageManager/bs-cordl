...
public:
  ...
  /// @brief Method Execute, addr 0x47aaa90, size 0x9c, virtual true, abstract: false, final false
  inline void Execute();
  ...
  /// @brief Method <Execute>b__2_0, addr 0x47aab2c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47aaa34, size 0x5c, virtual false, abstract: false, final false
