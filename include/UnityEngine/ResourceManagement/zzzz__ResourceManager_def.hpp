...
public:
  ...
  /// @brief Method .ctor, addr 0x2cb529c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Context, addr 0x2cb528c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Context();

  /// @brief Method get_Error, addr 0x2cb5294, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Error();

  /// @brief Method get_EventValue, addr 0x2cb527c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_EventValue();

  /// @brief Method get_Location, addr 0x2cb5284, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_Location();

  /// @brief Method get_OperationHandle, addr 0x2cb5260, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle get_OperationHandle();

  /// @brief Method get_Type, addr 0x2cb5274, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Destroy, addr 0x2cb56bc, size 0xb4, virtual true, abstract: false, final false
  inline void Destroy();

  /// @brief Method Execute, addr 0x2cb58e8, size 0x240, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method GetDependencies, addr 0x2cb547c, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDownloadStatus, addr 0x2cb53a0, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x2cb4494, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method InstanceScene, addr 0x2cb56b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene InstanceScene();

  /// @brief Method InvokeWaitForCompletion, addr 0x2cb57b8, size 0x130, virtual true, abstract: false, final false
  inline bool InvokeWaitForCompletion();
  ...
  /// @brief Method .ctor, addr 0x2cb5b28, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_DebugName, addr 0x2cb55a4, size 0x110, virtual true, abstract: false, final false
  inline ::StringW get_DebugName();

  /// @brief Method get_Progress, addr 0x2cb5770, size 0x48, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Acquire, addr 0x2cb3948, size 0x20, virtual false, abstract: false, final false
  inline void Acquire(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method AcquireGroupOpFromCache, addr 0x2cb3a2c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOperationToCache, addr 0x2cb375c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method AddUpdateReceiver, addr 0x2cb09c4, size 0x68, virtual false, abstract: false, final false
  inline void AddUpdateReceiver(::UnityEngine::ResourceManagement::IUpdateReceiver* receiver);

  /// @brief Method CachedOperationCount, addr 0x2cb383c, size 0x50, virtual false, abstract: false, final false
  inline int32_t CachedOperationCount();

  /// @brief Method CalculateLocationsHash, addr 0x2cb1bfc, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupSceneInstances, addr 0x2cb44c4, size 0x408, virtual false, abstract: false, final false
  inline void CleanupSceneInstances(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method ClearDiagnosticCallbacks, addr 0x2cb13a0, size 0x8, virtual false, abstract: false, final false
  inline void ClearDiagnosticCallbacks();

  /// @brief Method ClearDiagnosticsCallback, addr 0x2cb1398, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateGenericGroupOperation, addr 0x2cb3b68, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x2cb50a4, size 0xd8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method ExecuteDeferredCallbacks, addr 0x2cb48cc, size 0x1b4, virtual false, abstract: false, final false
  inline void ExecuteDeferredCallbacks();

  /// @brief Method GetDefaultTypeForLocation, addr 0x2cb1ab4, size 0x148, virtual false, abstract: false, final false
  inline ::System::Type* GetDefaultTypeForLocation(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* loc);

  /// @brief Method GetResourceProvider, addr 0x2cb166c, size 0x448, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOperationCached, addr 0x2cb37e4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInstanceOperationDestroy, addr 0x2cb32f8, size 0x144, virtual false, abstract: false, final false
  inline void OnInstanceOperationDestroy(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method OnObjectAdded, addr 0x2cb11e4, size 0x74, virtual false, abstract: false, final false
  inline void OnObjectAdded(::System::Object* obj);

  /// @brief Method OnObjectRemoved, addr 0x2cb1258, size 0x74, virtual false, abstract: false, final false
  inline void OnObjectRemoved(::System::Object* obj);

  /// @brief Method OnOperationDestroyCached, addr 0x2cb3510, size 0x1d4, virtual false, abstract: false, final false
  inline void OnOperationDestroyCached(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method OnOperationDestroyNonCached, addr 0x2cb343c, size 0xd4, virtual false, abstract: false, final false
  inline void OnOperationDestroyNonCached(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation* o);

  /// @brief Method PostDiagnosticEvent, addr 0x2cb1554, size 0x118, virtual false, abstract: false, final false
  inline void PostDiagnosticEvent(::UnityEngine::ResourceManagement::__ResourceManager__DiagnosticEventContext context);

  /// @brief Method ProvideInstance, addr 0x2cb41e0, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvideResource, addr 0x2cb204c, size 0x7d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvideResourceGroupCached, addr 0x2cb2a08, size 0x77c, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>
  ...
  /// @brief Method ProvideScene, addr 0x2cb3f70, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterDiagnosticCallback, addr 0x2cb14ac, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterDiagnosticCallback, addr 0x2cb14a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterForCallbacks, addr 0x2cb12cc, size 0xcc, virtual false, abstract: false, final false
  inline void RegisterForCallbacks();

  /// @brief Method RegisterForDeferredCallback, addr 0x2cb4a80, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x2cb388c, size 0x8, virtual false, abstract: false, final false
  inline void Release(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle);

  /// @brief Method ReleaseScene, addr 0x2cb40b0, size 0x130, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ...
  /// @brief Method RemoveOperationFromCache, addr 0x2cb36e4, size 0x78, virtual false, abstract: false, final false
  inline bool RemoveOperationFromCache(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* key);

  /// @brief Method RemoveUpdateReciever, addr 0x2cb0a2c, size 0x12c, virtual false, abstract: false, final false
  inline void RemoveUpdateReciever(::UnityEngine::ResourceManagement::IUpdateReceiver* receiver);

  /// @brief Method StartOperation, addr 0x2cb3184, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformInternalId, addr 0x2cb0858, size 0xc4, virtual false, abstract: false, final false
  inline ::StringW TransformInternalId(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method UnregisterDiagnosticCallback, addr 0x2cb13a8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2cb4c90, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__53_0, addr 0x2cb525c, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__53_0(::UnityEngine::ResourceManagement::IUpdateReceiver* x);

  /// @brief Method .ctor, addr 0x2cb0b80, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Allocator, addr 0x2cb0b58, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::Util::IAllocationStrategy* get_Allocator();

  /// @brief Method get_CertificateHandlerInstance, addr 0x2cb0b70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::CertificateHandler* get_CertificateHandlerInstance();

  /// @brief Method get_ExceptionHandler, addr 0x2cb0794, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InstanceOperationCount, addr 0x2cb097c, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_InstanceOperationCount();

  /// @brief Method get_InternalIdTransformFunc, addr 0x2cb0848, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_OperationCacheCount, addr 0x2cb092c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_OperationCacheCount();

  /// @brief Method get_ResourceProviders, addr 0x2cb0b68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_WebRequestOverride, addr 0x2cb091c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Allocator, addr 0x2cb0b60, size 0x8, virtual false, abstract: false, final false
  inline void set_Allocator(::UnityEngine::ResourceManagement::Util::IAllocationStrategy* value);

  /// @brief Method set_CertificateHandlerInstance, addr 0x2cb0b78, size 0x8, virtual false, abstract: false, final false
  inline void set_CertificateHandlerInstance(::UnityEngine::Networking::CertificateHandler* value);

  /// @brief Method set_ExceptionHandler, addr 0x2cb07ec, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_InternalIdTransformFunc, addr 0x2cb0850, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_WebRequestOverride, addr 0x2cb0924, size 0x8, virtual false, abstract: false, final false
