...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WebRequestQueue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WebRequestQueue(WebRequestQueue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WebRequestQueue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WebRequestQueue(WebRequestQueueconst&) = delete;
