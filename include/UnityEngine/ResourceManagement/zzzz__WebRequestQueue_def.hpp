...
/// @brief Field s_ActiveRequests, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ActiveRequests, put=setStaticF_s_ActiveRequests)) ::System::Collections::Generic::List_1<::UnityEngine::Networking::UnityWebRequestAsyncOperation*>*  s_ActiveRequests;
...
/// @brief Field s_QueuedOperations, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_QueuedOperations, put=setStaticF_s_QueuedOperations)) ::System::Collections::Generic::Queue_1<::UnityEngine::ResourceManagement::WebRequestQueueOperation*>*  s_QueuedOperations;

/// @brief Method BeginWebRequest, addr 0x6758e60, size 0x2b8, virtual false, abstract: false, final false
static inline void BeginWebRequest(::UnityEngine::ResourceManagement::WebRequestQueueOperation*  queueOperation) ;

/// @brief Method DequeueRequest, addr 0x67596a4, size 0xbc, virtual false, abstract: false, final false
static inline void DequeueRequest(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  operation) ;

/// @brief Method OnWebAsyncOpComplete, addr 0x6759760, size 0xac, virtual false, abstract: false, final false
static inline void OnWebAsyncOpComplete(::UnityEngine::AsyncOperation*  operation) ;

/// @brief Method OnWebAsyncOpComplete, addr 0x6759588, size 0x11c, virtual false, abstract: false, final false
static inline void OnWebAsyncOpComplete(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  operation) ;

/// @brief Method QueueRequest, addr 0x6758d48, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method SetMaxConcurrentRequests, addr 0x6758c84, size 0xc4, virtual false, abstract: false, final false
static inline void SetMaxConcurrentRequests(int32_t  maxRequests) ;

/// @brief Method WaitForRequestToBeActive, addr 0x6759118, size 0x3d0, virtual false, abstract: false, final false
