...
public:
  ...
  /// @brief Method BeginWebRequest, addr 0x67cae6c, size 0x2b8, virtual false, abstract: false, final false
  static inline void BeginWebRequest(::UnityEngine::ResourceManagement::WebRequestQueueOperation* queueOperation);

  /// @brief Method DequeueRequest, addr 0x67cb6b0, size 0xbc, virtual false, abstract: false, final false
  static inline void DequeueRequest(::UnityEngine::Networking::UnityWebRequestAsyncOperation* operation);

  /// @brief Method OnWebAsyncOpComplete, addr 0x67cb76c, size 0xac, virtual false, abstract: false, final false
  static inline void OnWebAsyncOpComplete(::UnityEngine::AsyncOperation* operation);

  /// @brief Method OnWebAsyncOpComplete, addr 0x67cb594, size 0x11c, virtual false, abstract: false, final false
  static inline void OnWebAsyncOpComplete(::UnityEngine::Networking::UnityWebRequestAsyncOperation* operation);

  /// @brief Method QueueRequest, addr 0x67cad54, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMaxConcurrentRequests, addr 0x67cac90, size 0xc4, virtual false, abstract: false, final false
  static inline void SetMaxConcurrentRequests(int32_t maxRequests);

  /// @brief Method WaitForRequestToBeActive, addr 0x67cb124, size 0x3d0, virtual false, abstract: false, final false
