...
public:
  ...
  /// @brief Method Complete, addr 0x2d153f0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d153c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Networking::UnityWebRequest* request);

  /// @brief Method get_IsDone, addr 0x2d153a8, size 0x20, virtual false, abstract: false, final false
