...
public:
  ...
  /// @brief Method Complete, addr 0x2cb5bb8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5b90, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Networking::UnityWebRequest* request);

  /// @brief Method get_IsDone, addr 0x2cb5b70, size 0x20, virtual false, abstract: false, final false
