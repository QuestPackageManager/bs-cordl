...
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 789 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 789 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14032)), TypeDefinitionIndex(TypeDefinitionIndex(14033)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 832 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14036))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13949)) CS Name: ::UnityEngine.ResourceManagement::ChainOperation`2<TObject,TObjectDependency>*
