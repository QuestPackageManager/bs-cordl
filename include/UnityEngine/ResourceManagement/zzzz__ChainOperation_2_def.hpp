...
// SizeInfo { instance_size: 288, native_size: 281, calculated_instance_size: 288, calculated_native_size: 281, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::ResourceManagement {
// cpp template
...
public:
  ...
  /// @brief Field m_CachedOnWrappedCompleted, offset 0x110, size 0x8
  __declspec(property(
  ...
  /// @brief Field m_Callback, offset 0x108, size 0x8
  ...
  /// @brief Field m_ReleaseDependenciesOnFailure, offset 0x118, size 0x1
  ...
  /// @brief Field m_WrappedOp, offset 0xb8, size 0x20
  ...
  /// @brief Field m_depStatus, offset 0xd8, size 0x18
  ...
  /// @brief Field m_wrapStatus, offset 0xf0, size 0x18
...
public:
  ...
  /// @brief Field m_CachedOnWrappedCompleted, offset: 0x110, size: 0x8, def value: None
  ...
  /// @brief Field m_ReleaseDependenciesOnFailure, offset: 0x118, size: 0x1, def value: None
