...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EngineEmitter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EngineEmitter(EngineEmitter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EngineEmitter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EngineEmitter(EngineEmitterconst&) = delete;
