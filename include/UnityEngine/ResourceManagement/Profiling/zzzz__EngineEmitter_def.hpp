...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Profiling::EngineEmitter*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Profiling::EngineEmitter*, "UnityEngine.ResourceManagement.Profiling", "EngineEmitter");
...
public:
  ...
  /// @brief Method EmitFrameMetaData, addr 0x691ed44, size 0x4, virtual true, abstract: false, final true
  inline void EmitFrameMetaData(::System::Guid id, int32_t tag, ::System::Array* data);

  /// @brief Method InitialiseCallbacks, addr 0x691ed48, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x691eda0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEnabled, addr 0x691ed1c, size 0x28, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Profiling::EngineEmitter) == 0x10, "Size mismatch!");
