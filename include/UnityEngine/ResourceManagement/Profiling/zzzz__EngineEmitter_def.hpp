...
public:
  ...
  /// @brief Method EmitFrameMetaData, addr 0x67de6e8, size 0x4, virtual true, abstract: false, final true
  inline void EmitFrameMetaData(::System::Guid id, int32_t tag, ::System::Array* data);

  /// @brief Method InitialiseCallbacks, addr 0x67de6ec, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67de744, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEnabled, addr 0x67de6c0, size 0x28, virtual true, abstract: false, final true
