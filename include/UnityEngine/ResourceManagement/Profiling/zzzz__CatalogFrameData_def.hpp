...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Profiling::CatalogFrameData, "UnityEngine.ResourceManagement.Profiling", "CatalogFrameData");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "BuildResultHash", ty: "::UnityEngine::Hash128", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Profiling::CatalogFrameData) == 0x10, "Size mismatch!");
