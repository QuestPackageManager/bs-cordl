...
// Ctor Parameters [CppParam { name: "BundleCode", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ReferenceCount", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "PercentComplete", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Status", ty:
// "::UnityEngine::ResourceManagement::Profiling::ContentStatus", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Source", ty:
// "::UnityEngine::ResourceManagement::Util::BundleSource", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "LoadingOptions", ty:
// "::UnityEngine::ResourceManagement::Profiling::BundleOptions", modifiers: "", def_value: Some("{}"), comment: None }]
