...
public:
  // Declarations
  /// @brief Method Equals, addr 0x67de748, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x67de7d4, size 0xa4, virtual true, abstract: false, final false
