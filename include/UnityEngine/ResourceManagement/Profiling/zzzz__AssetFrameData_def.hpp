...
public:
// Declarations
/// @brief Method Equals, addr 0x676c73c, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x676c7c8, size 0xa4, virtual true, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "AssetCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "BundleCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ReferenceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "PercentComplete", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "Status", ty: "::UnityEngine::ResourceManagement::Profiling::ContentStatus", modifiers: "", def_value: None }]
