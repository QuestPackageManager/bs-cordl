...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Profiling::AssetFrameData, "UnityEngine.ResourceManagement.Profiling", "AssetFrameData");
...
public:
  // Declarations
  /// @brief Method Equals, addr 0x691eda4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x691ee30, size 0xa4, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Profiling::AssetFrameData) == 0x14, "Size mismatch!");
