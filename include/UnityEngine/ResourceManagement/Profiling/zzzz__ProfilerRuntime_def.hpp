...
public:
  ...
  /// @brief Method AddAssetOperation, addr 0x67d8ed8, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBundleOperation, addr 0x67d403c, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCatalog, addr 0x67decb8, size 0xe0, virtual false, abstract: false, final false
  static inline void AddCatalog(::UnityEngine::Hash128 buildHash);

  /// @brief Method AddSceneOperation, addr 0x67dbfe4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method BundleReleased, addr 0x67d3d58, size 0x2e4, virtual false, abstract: false, final false
  static inline void BundleReleased(::StringW bundleName);

  /// @brief Method GetContainingBundleNameForLocation, addr 0x67ded98, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSceneLoadCounterValue, addr 0x67df114, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetSceneLoadCounterValue();

  /// @brief Method Initialise, addr 0x67c60b0, size 0x23c, virtual false, abstract: false, final false
  static inline void Initialise();

  /// @brief Method InstanceOnOnLateUpdateDelegate, addr 0x67de878, size 0x50, virtual false, abstract: false, final false
  static inline void InstanceOnOnLateUpdateDelegate(float_t deltaTime);

  /// @brief Method PushToProfilerStream, addr 0x67de8c8, size 0x3f0, virtual false, abstract: false, final false
  static inline void PushToProfilerStream();

  /// @brief Method RefreshChangedReferenceCounts, addr 0x67df17c, size 0xa48, virtual false, abstract: false, final false
  static inline void RefreshChangedReferenceCounts();

  /// @brief Method SceneReleased, addr 0x67dca38, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUpdateFrameDataWithOperationData, addr 0x67dfbc4, size 0x2f4, virtual false, abstract: false, final false
