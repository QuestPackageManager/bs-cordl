...
/// @brief Field m_AssetData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_AssetData, put=setStaticF_m_AssetData)) ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>*  m_AssetData;

/// @brief Field m_BundleData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_BundleData, put=setStaticF_m_BundleData)) ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::BundleFrameData>*  m_BundleData;

/// @brief Field m_BundleNameToAssetOperations, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_BundleNameToAssetOperations, put=setStaticF_m_BundleNameToAssetOperations)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*>*  m_BundleNameToAssetOperations;

/// @brief Field m_BundleNameToOperation, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_BundleNameToOperation, put=setStaticF_m_BundleNameToOperation)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*  m_BundleNameToOperation;

/// @brief Field m_CatalogData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_CatalogData, put=setStaticF_m_CatalogData)) ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::Hash128,::UnityEngine::ResourceManagement::Profiling::CatalogFrameData>*  m_CatalogData;

/// @brief Field m_DataChange, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_DataChange, put=setStaticF_m_DataChange)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::System::ValueTuple_2<int32_t,float_t>>*  m_DataChange;

/// @brief Field m_SceneData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_SceneData, put=setStaticF_m_SceneData)) ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>*  m_SceneData;
...
/// @brief Method AddAssetOperation, addr 0x6766ecc, size 0x6e0, virtual false, abstract: false, final false
...
/// @brief Method AddBundleOperation, addr 0x6762030, size 0x32c, virtual false, abstract: false, final false
...
/// @brief Method AddCatalog, addr 0x676ccac, size 0xe0, virtual false, abstract: false, final false
static inline void AddCatalog(::UnityEngine::Hash128  buildHash) ;

/// @brief Method AddSceneOperation, addr 0x6769fd8, size 0x260, virtual false, abstract: false, final false
static inline void AddSceneOperation(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  handle, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location, ::UnityEngine::ResourceManagement::Profiling::ContentStatus  status) ;

/// @brief Method BundleReleased, addr 0x6761d4c, size 0x2e4, virtual false, abstract: false, final false
static inline void BundleReleased(::StringW  bundleName) ;

/// @brief Method GetContainingBundleNameForLocation, addr 0x676cd8c, size 0x37c, virtual false, abstract: false, final false
...
/// @brief Method GetSceneLoadCounterValue, addr 0x676d108, size 0x68, virtual false, abstract: false, final false
static inline int32_t GetSceneLoadCounterValue() ;

/// @brief Method Initialise, addr 0x67540a4, size 0x23c, virtual false, abstract: false, final false
static inline void Initialise() ;

/// @brief Method InstanceOnOnLateUpdateDelegate, addr 0x676c86c, size 0x50, virtual false, abstract: false, final false
static inline void InstanceOnOnLateUpdateDelegate(float_t  deltaTime) ;

/// @brief Method PushToProfilerStream, addr 0x676c8bc, size 0x3f0, virtual false, abstract: false, final false
static inline void PushToProfilerStream() ;

/// @brief Method RefreshChangedReferenceCounts, addr 0x676d170, size 0xa48, virtual false, abstract: false, final false
static inline void RefreshChangedReferenceCounts() ;

/// @brief Method SceneReleased, addr 0x676aa2c, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ShouldUpdateFrameDataWithOperationData, addr 0x676dbb8, size 0x2f4, virtual false, abstract: false, final false
static inline bool ShouldUpdateFrameDataWithOperationData(::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*  activeOperation, int32_t  frameReferenceCount, float_t  framePercentComplete, ::ByRef<::System::ValueTuple_2<int32_t,float_t>>  newDataOut) ;
...
static inline ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>* getStaticF_m_AssetData() ;

static inline ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::BundleFrameData>* getStaticF_m_BundleData() ;

static inline ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*>* getStaticF_m_BundleNameToAssetOperations() ;
...
static inline ::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>* getStaticF_m_SceneData() ;
...
static inline void setStaticF_m_AssetData(::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>*  value) ;

static inline void setStaticF_m_BundleData(::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::BundleFrameData>*  value) ;

static inline void setStaticF_m_BundleNameToAssetOperations(::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*>*  value) ;
...
static inline void setStaticF_m_CatalogData(::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::Hash128,::UnityEngine::ResourceManagement::Profiling::CatalogFrameData>*  value) ;

static inline void setStaticF_m_DataChange(::System::Collections::Generic::Dictionary_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::System::ValueTuple_2<int32_t,float_t>>*  value) ;

static inline void setStaticF_m_SceneData(::UnityEngine::ResourceManagement::Profiling::ProfilerFrameData_2<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*,::UnityEngine::ResourceManagement::Profiling::AssetFrameData>*  value) ;
