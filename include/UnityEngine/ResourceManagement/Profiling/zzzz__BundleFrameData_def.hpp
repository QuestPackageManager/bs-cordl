...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Profiling::BundleFrameData, "UnityEngine.ResourceManagement.Profiling", "BundleFrameData");
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Profiling::BundleFrameData) == 0x18, "Size mismatch!");
