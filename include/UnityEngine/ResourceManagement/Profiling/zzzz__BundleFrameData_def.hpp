...
// Ctor Parameters [CppParam { name: "BundleCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ReferenceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "PercentComplete", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "Status", ty: "::UnityEngine::ResourceManagement::Profiling::ContentStatus", modifiers: "", def_value: None }, CppParam { name: "Source", ty: "::UnityEngine::ResourceManagement::Util::BundleSource", modifiers: "", def_value: None }, CppParam { name: "LoadingOptions", ty: "::UnityEngine::ResourceManagement::Profiling::BundleOptions", modifiers: "", def_value: None }]
constexpr BundleFrameData(int32_t  BundleCode, int32_t  ReferenceCount, float_t  PercentComplete, ::UnityEngine::ResourceManagement::Profiling::ContentStatus  Status, ::UnityEngine::ResourceManagement::Util::BundleSource  Source, ::UnityEngine::ResourceManagement::Profiling::BundleOptions  LoadingOptions) noexcept;
...
} // namespace end def UnityEngine::ResourceManagement::Profiling
