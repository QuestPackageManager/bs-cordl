...
public:
  ...
  /// @brief Method Start addr 0x2a531bc size 0x3c8 virtual false final false
  inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method BeginAssetLoad addr 0x2a53640 size 0x368 virtual false final false
  inline void BeginAssetLoad();

  /// @brief Method WaitForCompletionHandler addr 0x2a53be8 size 0xf8 virtual false final false
  inline bool WaitForCompletionHandler();

  /// @brief Method ActionComplete addr 0x2a53a54 size 0x194 virtual false final false
  inline void ActionComplete(::UnityEngine::AsyncOperation* obj);

  /// @brief Method GetArrayResult addr 0x2a53ce0 size 0x30 virtual false final false
  inline void GetArrayResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method GetListResult addr 0x2a53d10 size 0x30 virtual false final false
  inline void GetListResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method GetAssetResult addr 0x2a53d40 size 0xc0 virtual false final false
  inline void GetAssetResult(::UnityEngine::Object* asset);

  /// @brief Method GetAssetSubObjectResult addr 0x2a53e00 size 0xcc virtual false final false
  inline void GetAssetSubObjectResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method CompleteOperation addr 0x2a53ecc size 0xf0 virtual false final false
  inline void CompleteOperation();

  /// @brief Method ProgressCallback addr 0x2a53fbc size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a531b4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Start>b__7_0 addr 0x2a53fd4 size 0x4 virtual false final false
...
public:
  ...
  /// @brief Method Provide addr 0x2a53134 size 0x80 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2a53584 size 0x8 virtual false final false
  inline void _ctor();
