...
public:
  ...
  /// @brief Method ActionComplete, addr 0x67d8d54, size 0x184, virtual false, abstract: false, final false
  inline void ActionComplete(::UnityEngine::AsyncOperation* obj);

  /// @brief Method BeginAssetLoad, addr 0x67d8974, size 0x3e0, virtual false, abstract: false, final false
  inline void BeginAssetLoad();

  /// @brief Method CompleteOperation, addr 0x67d98a4, size 0x188, virtual false, abstract: false, final false
  inline void CompleteOperation();

  /// @brief Method GetArrayResult, addr 0x67d96c0, size 0x30, virtual false, abstract: false, final false
  inline void GetArrayResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method GetAssetResult, addr 0x67d9720, size 0xc4, virtual false, abstract: false, final false
  inline void GetAssetResult(::UnityEngine::Object* asset);

  /// @brief Method GetAssetSubObjectResult, addr 0x67d97e4, size 0xc0, virtual false, abstract: false, final false
  inline void GetAssetSubObjectResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method GetListResult, addr 0x67d96f0, size 0x30, virtual false, abstract: false, final false
  inline void GetListResult(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> allAssets);

  /// @brief Method IsDownloadOnly, addr 0x67d85b0, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method ProgressCallback, addr 0x67d9a2c, size 0x18, virtual false, abstract: false, final false
  inline float_t ProgressCallback();

  /// @brief Method Start, addr 0x67d81e0, size 0x3cc, virtual false, abstract: false, final false
  inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method WaitForCompletionHandler, addr 0x67d95b8, size 0x108, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <Start>b__8_0, addr 0x67d9a44, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67d81dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Provide, addr 0x67d8168, size 0x74, virtual true, abstract: false, final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method .ctor, addr 0x67d85ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
