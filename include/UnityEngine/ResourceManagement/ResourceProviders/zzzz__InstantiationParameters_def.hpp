...
public:
  ...
  /// @brief Method .ctor, addr 0x691a0c0, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Transform* parent, bool instantiateInWorldSpace);

  /// @brief Method .ctor, addr 0x691a178, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 position, ::UnityEngine::Quaternion rotation, ::UnityEngine::Transform* parent);

  /// @brief Method get_InstantiateInWorldPosition, addr 0x691a0b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_InstantiateInWorldPosition();

  /// @brief Method get_Parent, addr 0x691a0a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Parent();

  /// @brief Method get_Position, addr 0x691a090, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Position();

  /// @brief Method get_Rotation, addr 0x691a09c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_Rotation();

  /// @brief Method get_SetPositionRotation, addr 0x691a0b8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::InstantiationParameters) == 0x30, "Size mismatch!");
