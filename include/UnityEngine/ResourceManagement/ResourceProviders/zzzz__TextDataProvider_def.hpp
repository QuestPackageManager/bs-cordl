...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x47af408, size 0xac, virtual false, abstract: false, final false
  inline void CompleteOperation(::StringW text, ::System::Exception* exception);

  /// @brief Method ConvertText, addr 0x47af0e0, size 0xf8, virtual false, abstract: false, final false
  inline ::System::Object* ConvertText(::StringW text);

  /// @brief Method GetPercentComplete, addr 0x47af0c8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x47af24c, size 0x1bc, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x47af4b4, size 0x2a8, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x47aecd4, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCompletionHandler, addr 0x47af1d8, size 0x74, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <SendWebRequest>b__13_0, addr 0x47af75c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47aeccc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x47aec24, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x47aec2c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47ac254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x47aec10, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method set_IgnoreFailures, addr 0x47aec18, size 0xc, virtual false, abstract: false, final false
