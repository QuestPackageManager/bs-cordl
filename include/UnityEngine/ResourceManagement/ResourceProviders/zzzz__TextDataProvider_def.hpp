...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x69233c8, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteOperation(::StringW text, ::System::Exception* exception);

  /// @brief Method ConvertText, addr 0x6923080, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* ConvertText(::StringW text);

  /// @brief Method GetPercentComplete, addr 0x6923068, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x69231f4, size 0x1d4, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x6923470, size 0x414, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x6922c28, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6922c24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x6922b98, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x6922ba0, size 0x84, virtual true, abstract: false, final false
