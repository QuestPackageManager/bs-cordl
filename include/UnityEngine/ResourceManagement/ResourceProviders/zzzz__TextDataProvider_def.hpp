...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x676ae88, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteOperation(::StringW text, ::System::Exception* exception);

  /// @brief Method ConvertText, addr 0x676ab40, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* ConvertText(::StringW text);

  /// @brief Method GetPercentComplete, addr 0x676ab28, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x676acb4, size 0x1d4, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x676af30, size 0x414, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x676a6e8, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCompletionHandler, addr 0x676ac40, size 0x74, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <SendWebRequest>b__13_0, addr 0x676b344, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x676a6e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x676a658, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x676a660, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6767e0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x676a648, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method set_IgnoreFailures, addr 0x676a650, size 0x8, virtual false, abstract: false, final false
