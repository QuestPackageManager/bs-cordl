...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x6703310, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteOperation(::StringW text, ::System::Exception* exception);

  /// @brief Method ConvertText, addr 0x6702fc8, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* ConvertText(::StringW text);

  /// @brief Method GetPercentComplete, addr 0x6702fb0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x670313c, size 0x1d4, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x67033b8, size 0x414, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x6702b70, size 0x440, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCompletionHandler, addr 0x67030c8, size 0x74, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <SendWebRequest>b__13_0, addr 0x67037cc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6702b6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x6702ae0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x6702ae8, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6700280, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x6702ad0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method set_IgnoreFailures, addr 0x6702ad8, size 0x8, virtual false, abstract: false, final false
