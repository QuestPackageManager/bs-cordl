...
/// @brief Method CompleteOperation, addr 0x676b548, size 0xa8, virtual false, abstract: false, final false
inline void CompleteOperation(::StringW  text, ::System::Exception*  exception) ;

/// @brief Method ConvertText, addr 0x676b200, size 0x100, virtual false, abstract: false, final false
inline ::System::Object* ConvertText(::StringW  text) ;

/// @brief Method GetPercentComplete, addr 0x676b1e8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method RequestOperation_completed, addr 0x676b374, size 0x1d4, virtual false, abstract: false, final false
inline void RequestOperation_completed(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method SendWebRequest, addr 0x676b5f0, size 0x414, virtual true, abstract: false, final false
inline void SendWebRequest(::StringW  path) ;

/// @brief Method Start, addr 0x676ada8, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method WaitForCompletionHandler, addr 0x676b300, size 0x74, virtual false, abstract: false, final false
inline bool WaitForCompletionHandler() ;

/// @brief Method <SendWebRequest>b__13_0, addr 0x676ba04, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x676ada4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Convert, addr 0x676ad18, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Provide, addr 0x676ad20, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x67684cc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IgnoreFailures, addr 0x676ad08, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreFailures() ;

/// @brief Method set_IgnoreFailures, addr 0x676ad10, size 0x8, virtual false, abstract: false, final false
