...
public:
  ...
  /// @brief Method CompleteOperation, addr 0x67d7d68, size 0xa8, virtual false, abstract: false, final false
  inline void CompleteOperation(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::System::Exception* exception);

  /// @brief Method ConvertBytes, addr 0x67d7970, size 0x100, virtual false, abstract: false, final false
  inline ::System::Object* ConvertBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetPercentComplete, addr 0x67d7958, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestOperation_completed, addr 0x67d7b94, size 0x1d4, virtual false, abstract: false, final false
  inline void RequestOperation_completed(::UnityEngine::AsyncOperation* op);

  /// @brief Method SendWebRequest, addr 0x67d7e10, size 0x2bc, virtual true, abstract: false, final false
  inline void SendWebRequest(::StringW path);

  /// @brief Method Start, addr 0x67d7478, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCompletionHandler, addr 0x67d7b20, size 0x74, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method <SendWebRequest>b__13_0, addr 0x67d80cc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67d7474, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Convert, addr 0x67d73e8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x67d73f0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67d7954, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x67d73d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method set_IgnoreFailures, addr 0x67d73e0, size 0x8, virtual false, abstract: false, final false
