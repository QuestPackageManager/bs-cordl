...
public:
  ...
  /// @brief Method .ctor, addr 0x6919144, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DownloadOnlyLocation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DownloadOnlyLocation(DownloadOnlyLocation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DownloadOnlyLocation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DownloadOnlyLocation(DownloadOnlyLocationconst&) = delete;
