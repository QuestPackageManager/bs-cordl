...
public:
  // Declarations
  /// @brief Method Provide, addr 0x2bd36a0, size 0x34c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bd39ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
