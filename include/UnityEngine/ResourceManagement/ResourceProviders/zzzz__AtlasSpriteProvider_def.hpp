...
public:
  ...
  /// @brief Method Provide, addr 0x479dd10, size 0x380, virtual true, abstract: false, final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle providerInterface);

  /// @brief Method .ctor, addr 0x479e090, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
