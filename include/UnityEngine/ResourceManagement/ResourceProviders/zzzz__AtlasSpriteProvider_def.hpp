...
public:
  ...
  /// @brief Method Provide, addr 0x67d6fc4, size 0x37c, virtual true, abstract: false, final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle providerInterface);

  /// @brief Method Release, addr 0x67d7340, size 0x94, virtual true, abstract: false, final false
  inline void Release(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location, ::System::Object* obj);

  /// @brief Method .ctor, addr 0x67d73d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
