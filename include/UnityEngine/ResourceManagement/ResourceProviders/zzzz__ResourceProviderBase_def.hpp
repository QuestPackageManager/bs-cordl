...
public:
  ...
  /// @brief Method Execute, addr 0x3107c2c, size 0x88, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x3107bb4, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::Func_1<bool>* callback);

  /// @brief Method InvokeWaitForCompletion, addr 0x3107bbc, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3107b64, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InitializeAsync>b__0, addr 0x3107cb4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3107b5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanProvide, addr 0x310794c, size 0x40, virtual true, abstract: false, final false
  inline bool CanProvide(::System::Type* t, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method GetDefaultType, addr 0x310799c, size 0x6c, virtual true, abstract: false, final false
  inline ::System::Type* GetDefaultType(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method Initialize, addr 0x3107928, size 0x24, virtual true, abstract: false, final false
  inline bool Initialize(::StringW id, ::StringW data);

  /// @brief Method InitializeAsync, addr 0x3107a08, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x3107998, size 0x4, virtual true, abstract: false, final false
  inline void Release(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location, ::System::Object* obj);

  /// @brief Method ToString, addr 0x310798c, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ResourceManagement.ResourceProviders.IResourceProvider.get_BehaviourFlags, addr 0x3107bac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3105450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ProviderId, addr 0x31078d8, size 0x50, virtual true, abstract: false, final false
