...
public:
  ...
  /// @brief Method Execute, addr 0x6920694, size 0xa0, virtual true, abstract: false, final false
  inline void Execute();

  /// @brief Method Init, addr 0x6920600, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::Func_1<bool>* callback);

  /// @brief Method InvokeWaitForCompletion, addr 0x6920608, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69205ac, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <InitializeAsync>b__0, addr 0x6920734, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69205a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanProvide, addr 0x69203a4, size 0x40, virtual true, abstract: false, final false
  inline bool CanProvide(::System::Type* t, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method GetDefaultType, addr 0x69203f4, size 0x30, virtual true, abstract: false, final false
  inline ::System::Type* GetDefaultType(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method Initialize, addr 0x6920384, size 0x20, virtual true, abstract: false, final false
  inline bool Initialize(::StringW id, ::StringW data);

  /// @brief Method InitializeAsync, addr 0x6920424, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x69203e4, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ResourceManagement.ResourceProviders.IResourceProvider.get_BehaviourFlags, addr 0x69205f8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x691cc68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ProviderId, addr 0x692033c, size 0x48, virtual true, abstract: false, final false
