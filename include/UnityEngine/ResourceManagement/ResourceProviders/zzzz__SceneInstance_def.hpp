...
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance, "UnityEngine.ResourceManagement.ResourceProviders", "SceneInstance");
...
public:
  ...
  /// @brief Method ActivateAsync, addr 0x691a81c, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::AsyncOperation* ActivateAsync();

  /// @brief Method Equals, addr 0x691a850, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x691a848, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_ReleaseSceneOnSceneUnloaded, addr 0x691a80c, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReleaseSceneOnSceneUnloaded();

  /// @brief Method get_Scene, addr 0x691a7fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene get_Scene();

  /// @brief Method set_ReleaseSceneOnSceneUnloaded, addr 0x691a814, size 0x8, virtual false, abstract: false, final false
  inline void set_ReleaseSceneOnSceneUnloaded(bool value);

  /// @brief Method set_Scene, addr 0x691a804, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance) == 0x10, "Size mismatch!");
