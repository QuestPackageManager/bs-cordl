...
public:
  ...
  /// @brief Method ActivateAsync, addr 0x67da1d4, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::AsyncOperation* ActivateAsync();

  /// @brief Method Equals, addr 0x67da208, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x67da200, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_ReleaseSceneOnSceneUnloaded, addr 0x67da1c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_ReleaseSceneOnSceneUnloaded();

  /// @brief Method get_Scene, addr 0x67da1b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene get_Scene();

  /// @brief Method set_ReleaseSceneOnSceneUnloaded, addr 0x67da1cc, size 0x8, virtual false, abstract: false, final false
  inline void set_ReleaseSceneOnSceneUnloaded(bool value);

  /// @brief Method set_Scene, addr 0x67da1bc, size 0x8, virtual false, abstract: false, final false
