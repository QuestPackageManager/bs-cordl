...
public:
  ...
  /// @brief Method get_Scene, addr 0x2bd7408, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SceneManagement::Scene get_Scene();

  /// @brief Method set_Scene, addr 0x2bd7410, size 0x8, virtual false, abstract: false, final false
  inline void set_Scene(::UnityEngine::SceneManagement::Scene value);

  /// @brief Method Activate, addr 0x2bd7418, size 0x20, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method ActivateAsync, addr 0x2bd7438, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::AsyncOperation* ActivateAsync();

  /// @brief Method GetHashCode, addr 0x2bd7464, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x2bd7484, size 0xb8, virtual true, abstract: false, final false
