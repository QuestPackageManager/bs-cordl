...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10302))}
...
public:
  ...
  /// @brief Method get_Scene addr 0x2a546b4 size 0x8 virtual false final false
  inline ::UnityEngine::SceneManagement::Scene get_Scene();

  /// @brief Method set_Scene addr 0x2a546bc size 0x8 virtual false final false
  inline void set_Scene(::UnityEngine::SceneManagement::Scene value);

  /// @brief Method Activate addr 0x2a546c4 size 0x20 virtual false final false
  inline void Activate();

  /// @brief Method ActivateAsync addr 0x2a546e4 size 0x2c virtual false final false
  inline ::UnityEngine::AsyncOperation* ActivateAsync();

  /// @brief Method GetHashCode addr 0x2a54710 size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x2a54730 size 0xb8 virtual true final false
