...
constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneReleaseMode  UnityEngine::ResourceManagement::ResourceProviders::SceneReleaseMode::ReleaseSceneWhenSceneUnloaded{static_cast<int32_t>(0x0)};
constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneReleaseMode  UnityEngine::ResourceManagement::ResourceProviders::SceneReleaseMode::OnlyReleaseSceneOnHandleRelease{static_cast<int32_t>(0x1)};
