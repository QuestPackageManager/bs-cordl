...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceProviders::IInstanceProvider*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceProviders::IInstanceProvider*, "UnityEngine.ResourceManagement.ResourceProviders", "IInstanceProvider");
// Dependencies
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IInstanceProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInstanceProvider(IInstanceProviderconst&) = delete;
