...
public:
  ...
  /// @brief Method GetDependencies, addr 0x330c68c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDownloadProgressCallbacks, addr 0x330a83c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetProgressCallback, addr 0x330a788, size 0xb4, virtual false, abstract: false, final false
  inline void SetProgressCallback(::System::Func_1<float_t>* callback);

  /// @brief Method SetWaitForCompletionCallback, addr 0x330a8f0, size 0xb4, virtual false, abstract: false, final false
  inline void SetWaitForCompletionCallback(::System::Func_1<bool>* callback);

  /// @brief Method .ctor, addr 0x330d540, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DependencyCount, addr 0x330d708, size 0xac, virtual false, abstract: false, final false
  inline int32_t get_DependencyCount();

  /// @brief Method get_InternalOp, addr 0x330d5fc, size 0x104, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::IGenericProviderOperation* get_InternalOp();

  /// @brief Method get_Location, addr 0x3309f3c, size 0xac, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_Location();

  /// @brief Method get_ResourceManager, addr 0x330d700, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceManager* get_ResourceManager();

  /// @brief Method get_Type, addr 0x330caa8, size 0xac, virtual false, abstract: false, final false
