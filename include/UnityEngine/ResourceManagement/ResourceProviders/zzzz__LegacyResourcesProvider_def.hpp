...
public:
  ...
  /// @brief Method Start addr 0x2bd7b44 size 0x190 virtual false final false
  inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method WaitForCompletionHandler addr 0x2bd7e04 size 0x14 virtual false final false
  inline bool WaitForCompletionHandler();

  /// @brief Method AsyncOperationCompleted addr 0x2bd7e18 size 0x184 virtual false final false
  inline void AsyncOperationCompleted(::UnityEngine::AsyncOperation* op);

  /// @brief Method PercentComplete addr 0x2bd7f9c size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2bd7b3c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Provide addr 0x2bd7750 size 0x3ec virtual true final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle pi);

  /// @brief Method Release addr 0x2bd7cd4 size 0x128 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2bd7dfc size 0x8 virtual false final false
  inline void _ctor();
