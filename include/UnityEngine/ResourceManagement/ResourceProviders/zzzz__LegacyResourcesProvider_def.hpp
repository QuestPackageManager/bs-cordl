...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14273)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method Start addr 0x2a54df0 size 0x190 virtual false final false
  inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method WaitForCompletionHandler addr 0x2a550b0 size 0x14 virtual false final false
  inline bool WaitForCompletionHandler();

  /// @brief Method AsyncOperationCompleted addr 0x2a550c4 size 0x184 virtual false final false
  inline void AsyncOperationCompleted(::UnityEngine::AsyncOperation* op);

  /// @brief Method PercentComplete addr 0x2a55248 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a54de8 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Provide addr 0x2a549fc size 0x3ec virtual true final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle pi);

  /// @brief Method Release addr 0x2a54f80 size 0x128 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2a550a8 size 0x8 virtual false final false
  inline void _ctor();
