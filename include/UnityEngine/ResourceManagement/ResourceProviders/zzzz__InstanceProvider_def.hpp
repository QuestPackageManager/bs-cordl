...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x67d9b50, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x67d9c40, size 0x260, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x67d9ea0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
