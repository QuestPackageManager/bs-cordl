...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x479e474, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x479e54c, size 0x23c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x479e788, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
