...
/// @brief Method ProvideInstance, addr 0x6767b44, size 0xf0, virtual true, abstract: false, final true
...
/// @brief Method ReleaseInstance, addr 0x6767c34, size 0x260, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>* const& __cordl_internal_get_m_InstanceObjectToPrefabHandle() const;
...
/// @brief Method .ctor, addr 0x6767e94, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
