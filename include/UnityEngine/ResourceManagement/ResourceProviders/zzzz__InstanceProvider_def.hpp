...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x310674c, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x3106824, size 0x218, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3106a3c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
