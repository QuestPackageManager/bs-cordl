...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x66ff8f8, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x66ff9e8, size 0x260, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x66ffc48, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
