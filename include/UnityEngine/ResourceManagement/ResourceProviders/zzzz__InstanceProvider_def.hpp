...
public:
  ...
  /// @brief Method ProvideInstance, addr 0x47ab920, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method ReleaseInstance, addr 0x47ab9f8, size 0x23c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x47abc34, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
