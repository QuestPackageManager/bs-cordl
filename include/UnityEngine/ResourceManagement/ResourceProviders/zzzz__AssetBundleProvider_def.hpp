...
public:
  // Declarations
  /// @brief Method GetDefaultType, addr 0x30ff25c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method Provide, addr 0x30ff1dc, size 0x80, virtual true, abstract: false, final false
  inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle providerInterface);

  /// @brief Method Release, addr 0x30ff2c8, size 0x184, virtual true, abstract: false, final false
  inline void Release(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location, ::System::Object* asset);

  /// @brief Method WaitForAllUnloadingBundlesToComplete, addr 0x30ff1d8, size 0x4, virtual false, abstract: false, final false
  static inline void WaitForAllUnloadingBundlesToComplete();

  /// @brief Method .ctor, addr 0x30ff44c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
