...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14033)), TypeDefinitionIndex(TypeDefinitionIndex(14034)), TypeDefinitionIndex(TypeDefinitionIndex(3835)),
// TypeDefinitionIndex(TypeDefinitionIndex(14032)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 792 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(14032), inst: 797 }), TypeDefinitionIndex(TypeDefinitionIndex(14004)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3835), inst: 275 }),
// TypeDefinitionIndex(TypeDefinitionIndex(10375))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14015)) CS Name: ::SceneProvider::SceneOp*
...
public:
  ...
  __declspec(property(get = __get_m_ActivateOnLoad, put = __set_m_ActivateOnLoad)) bool m_ActivateOnLoad;

  /// @brief Field m_Inst, offset 0x98, size 0x10
  __declspec(property(get = __get_m_Inst, put = __set_m_Inst))::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance m_Inst;
  ...
  __declspec(property(get = __get_m_LoadMode, put = __set_m_LoadMode))::UnityEngine::SceneManagement::LoadSceneMode m_LoadMode;

  /// @brief Field m_Priority, offset 0xb4, size 0x4
  __declspec(property(get = __get_m_Priority, put = __set_m_Priority)) int32_t m_Priority;
  ...
  constexpr bool const& __get_m_ActivateOnLoad() const;

  constexpr void __set_m_ActivateOnLoad(bool value);

  constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance& __get_m_Inst();

  constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance const& __get_m_Inst() const;
  ...
  constexpr ::UnityEngine::SceneManagement::LoadSceneMode& __get_m_LoadMode();

  constexpr ::UnityEngine::SceneManagement::LoadSceneMode const& __get_m_LoadMode() const;

  constexpr void __set_m_LoadMode(::UnityEngine::SceneManagement::LoadSceneMode value);

  constexpr int32_t& __get_m_Priority();

  constexpr int32_t const& __get_m_Priority() const;
  ...
  /// @brief Method .ctor addr 0x2bd87c4 size 0x5c virtual false final false
  inline void _ctor(::UnityEngine::ResourceManagement::ResourceManager* rm);

  /// @brief Method GetDownloadStatus addr 0x2bd8bd0 size 0xdc virtual true final false
  ...
  /// @brief Method Init addr 0x2bd8820 size 0xc4 virtual false final false
  inline void
  ...
  /// @brief Method InvokeWaitForCompletion addr 0x2bd8cac size 0x338 virtual true final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method GetDependencies addr 0x2bd8fe4 size 0x14c virtual true final false
  ...
  /// @brief Method get_DebugName addr 0x2bd9130 size 0xa4 virtual true final false
  inline ::StringW get_DebugName();

  /// @brief Method Execute addr 0x2bd91d4 size 0x588 virtual true final false
  inline void Execute();

  /// @brief Method InternalLoadScene addr 0x2bd9804 size 0xd4 virtual false final false
  ...
  /// @brief Method InternalLoad addr 0x2bd98d8 size 0x84 virtual false final false
  ...
  /// @brief Method Destroy addr 0x2bd995c size 0x90 virtual true final false
  inline void Destroy();

  /// @brief Method get_Progress addr 0x2bd99ec size 0xc0 virtual true final false
  inline float_t get_Progress();

  /// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update addr 0x2bd9aac size 0x128 virtual true final true
...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14004)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 797 }), GenericInstantiation(GenericInstantiation
// { tdi: TypeDefinitionIndex(14032), inst: 797 }), TypeDefinitionIndex(TypeDefinitionIndex(14033)), TypeDefinitionIndex(TypeDefinitionIndex(10378)), TypeDefinitionIndex(TypeDefinitionIndex(14032))}
...
public:
  ...
  __declspec(property(get = __get_m_Instance, put = __set_m_Instance))::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance m_Instance;

  /// @brief Field m_sceneLoadHandle, offset 0xa0, size 0x20
  __declspec(property(
      get = __get_m_sceneLoadHandle,
      put = __set_m_sceneLoadHandle))::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance> m_sceneLoadHandle;

  /// @brief Field m_UnloadOptions, offset 0xc0, size 0x4
  __declspec(property(get = __get_m_UnloadOptions, put = __set_m_UnloadOptions))::UnityEngine::SceneManagement::UnloadSceneOptions m_UnloadOptions;

  __declspec(property(get = get_Progress)) float_t Progress;

  constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance& __get_m_Instance();

  constexpr ::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance const& __get_m_Instance() const;

  constexpr void __set_m_Instance(::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance value);

  constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>& __get_m_sceneLoadHandle();

  constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance> const& __get_m_sceneLoadHandle() const;
  ...
  constexpr ::UnityEngine::SceneManagement::UnloadSceneOptions& __get_m_UnloadOptions();

  constexpr ::UnityEngine::SceneManagement::UnloadSceneOptions const& __get_m_UnloadOptions() const;

  constexpr void __set_m_UnloadOptions(::UnityEngine::SceneManagement::UnloadSceneOptions value);

  /// @brief Method Init addr 0x2bd8b34 size 0x94 virtual false final false
  ...
  /// @brief Method Execute addr 0x2bd9bd4 size 0x134 virtual true final false
  inline void Execute();

  /// @brief Method InvokeWaitForCompletion addr 0x2bd9e40 size 0xb4 virtual true final false
  inline bool InvokeWaitForCompletion();

  /// @brief Method UnloadSceneCompleted addr 0x2bd9d78 size 0xc8 virtual false final false
  inline void UnloadSceneCompleted(::UnityEngine::AsyncOperation* obj);

  /// @brief Method UnloadSceneCompletedNoRelease addr 0x2bd9d08 size 0x70 virtual false final false
  inline void UnloadSceneCompletedNoRelease(::UnityEngine::AsyncOperation* obj);

  /// @brief Method get_Progress addr 0x2bd9ef4 size 0x48 virtual true final false
  inline float_t get_Progress();

  static inline ::UnityEngine::ResourceManagement::ResourceProviders::__SceneProvider__UnloadSceneOp* New_ctor();

  /// @brief Method .ctor addr 0x2bd8aec size 0x48 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ProvideScene addr 0x2bd8468 size 0x35c virtual true final true
  ...
  /// @brief Method ReleaseScene addr 0x2bd88e4 size 0xe8 virtual true final true
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ...
  /// @brief Method UnityEngine.ResourceManagement.ResourceProviders.ISceneProvider2.ReleaseScene addr 0x2bd89cc size 0x120 virtual true final true
  inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>
  ...
  /// @brief Method .ctor addr 0x2bd8bc8 size 0x8 virtual false final false
  inline void _ctor();
