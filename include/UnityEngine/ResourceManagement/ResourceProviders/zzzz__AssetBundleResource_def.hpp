...
/// @brief Method <.ctor>b__52_0, addr 0x67643e8, size 0x14, virtual false, abstract: false, final false
inline bool __ctor_b__52_0(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*  x) ;

/// @brief Method .ctor, addr 0x67643e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_RequestRetryCallback, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RequestRetryCallback, put=__cordl_internal_set_m_RequestRetryCallback)) ::System::Func_2<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*,bool>*  m_RequestRetryCallback;
...
/// @brief Method AddBeginWebRequestHandler, addr 0x6763c74, size 0x114, virtual false, abstract: false, final false
inline void AddBeginWebRequestHandler(::UnityEngine::ResourceManagement::WebRequestQueueOperation*  webRequestQueueOperation) ;

/// @brief Method AddBundleToProfiler, addr 0x676189c, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method AddCallbackInvokeIfDone, addr 0x6763780, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method BeginOperation, addr 0x67623d4, size 0x21c, virtual false, abstract: false, final false
inline void BeginOperation() ;

/// @brief Method BeginWebRequestOperation, addr 0x6763d88, size 0x118, virtual false, abstract: false, final false
inline void BeginWebRequestOperation(::UnityEngine::AsyncOperation*  asyncOp) ;

/// @brief Method CompleteBundleLoad, addr 0x6764068, size 0x17c, virtual false, abstract: false, final false
inline void CompleteBundleLoad(::UnityEngine::AssetBundle*  bundle) ;

/// @brief Method CreateWebRequest, addr 0x6761668, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method CreateWebRequest, addr 0x6761690, size 0x20c, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* CreateWebRequest(::StringW  url) ;

/// @brief Method EnqueueWebRequest, addr 0x6763b58, size 0x11c, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::WebRequestQueueOperation* EnqueueWebRequest(::StringW  internalId) ;

/// @brief Method GetAssetBundle, addr 0x6761b08, size 0x1c, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::AssetBundle> GetAssetBundle() ;

/// @brief Method GetAssetPreloadRequest, addr 0x67619e0, size 0x128, virtual false, abstract: false, final false
inline ::UnityEngine::AssetBundleRequest* GetAssetPreloadRequest() ;

/// @brief Method GetDownloadStatus, addr 0x6761b3c, size 0x154, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus GetDownloadStatus() ;

/// @brief Method GetLoadInfo, addr 0x67637e0, size 0x30, virtual false, abstract: false, final false
static inline void GetLoadInfo(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle  handle, ::ByRef<::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleResource_LoadType>  loadType, ::ByRef<::StringW>  path) ;

/// @brief Method GetLoadInfo, addr 0x6763810, size 0x288, virtual false, abstract: false, final false
static inline void GetLoadInfo(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location, ::UnityEngine::ResourceManagement::ResourceManager*  resourceManager, ::ByRef<::UnityEngine::ResourceManagement::ResourceProviders::AssetBundleResource_LoadType>  loadType, ::ByRef<::StringW>  path) ;

/// @brief Method LoadLocalBundle, addr 0x6763a98, size 0xc0, virtual false, abstract: false, final false
inline void LoadLocalBundle() ;

/// @brief Method LocalRequestOperationCompleted, addr 0x67636c0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method OnUnloadOperationComplete, addr 0x67623cc, size 0x8, virtual false, abstract: false, final false
inline void OnUnloadOperationComplete(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method PercentComplete, addr 0x6761b24, size 0x18, virtual false, abstract: false, final false
inline float_t PercentComplete() ;

/// @brief Method RemoveBundleFromProfiler, addr 0x676235c, size 0x70, virtual false, abstract: false, final false
inline void RemoveBundleFromProfiler() ;

/// @brief Method Start, addr 0x67625f0, size 0x3dc, virtual false, abstract: false, final false
inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle  provideHandle, ::UnityEngine::AssetBundleUnloadOperation*  unloadOp, ::System::Func_2<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*,bool>*  requestRetryCallback) ;

/// @brief Method Unload, addr 0x67641e4, size 0xb4, virtual false, abstract: false, final false
inline bool Unload(::ByRef<::UnityEngine::AssetBundleUnloadOperation*>  unloadOp) ;

/// @brief Method Update, addr 0x6763ea0, size 0x1c8, virtual true, abstract: false, final true
inline void Update(float_t  unscaledDeltaTime) ;

/// @brief Method WaitForCompletionHandler, addr 0x6762c0c, size 0x38c, virtual false, abstract: false, final false
inline bool WaitForCompletionHandler() ;

/// @brief Method WebRequestOperationCompleted, addr 0x6762f98, size 0x728, virtual false, abstract: false, final false
inline void WebRequestOperationCompleted(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method <AddBeginWebRequestHandler>b__45_0, addr 0x676438c, size 0x4, virtual false, abstract: false, final false
inline void _AddBeginWebRequestHandler_b__45_0(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  asyncOp) ;

/// @brief Method <GetAssetPreloadRequest>b__30_0, addr 0x6764380, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6764298, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BytesToDownload, addr 0x6761560, size 0x58, virtual false, abstract: false, final false
inline int64_t get_BytesToDownload() ;

/// @brief Method get_HasTimedOut, addr 0x6761524, size 0x3c, virtual false, abstract: false, final false
