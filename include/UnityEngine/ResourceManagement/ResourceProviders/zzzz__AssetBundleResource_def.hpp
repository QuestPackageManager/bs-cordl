...
public:
  ...
  /// @brief Method <.ctor>b__52_0, addr 0x66fc19c, size 0x14, virtual false, abstract: false, final false
  inline bool __ctor_b__52_0(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult* x);

  /// @brief Method .ctor, addr 0x66fc198, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddBeginWebRequestHandler, addr 0x66fba28, size 0x114, virtual false, abstract: false, final false
  inline void AddBeginWebRequestHandler(::UnityEngine::ResourceManagement::WebRequestQueueOperation* webRequestQueueOperation);

  /// @brief Method AddBundleToProfiler, addr 0x66f9650, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCallbackInvokeIfDone, addr 0x66fb534, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginOperation, addr 0x66fa188, size 0x21c, virtual false, abstract: false, final false
  inline void BeginOperation();

  /// @brief Method BeginWebRequestOperation, addr 0x66fbb3c, size 0x118, virtual false, abstract: false, final false
  inline void BeginWebRequestOperation(::UnityEngine::AsyncOperation* asyncOp);

  /// @brief Method CompleteBundleLoad, addr 0x66fbe1c, size 0x17c, virtual false, abstract: false, final false
  inline void CompleteBundleLoad(::UnityEngine::AssetBundle* bundle);

  /// @brief Method CreateWebRequest, addr 0x66f941c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWebRequest, addr 0x66f9444, size 0x20c, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest* CreateWebRequest(::StringW url);

  /// @brief Method EnqueueWebRequest, addr 0x66fb90c, size 0x11c, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::WebRequestQueueOperation* EnqueueWebRequest(::StringW internalId);

  /// @brief Method GetAssetBundle, addr 0x66f98bc, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AssetBundle> GetAssetBundle();

  /// @brief Method GetAssetPreloadRequest, addr 0x66f9794, size 0x128, virtual false, abstract: false, final false
  inline ::UnityEngine::AssetBundleRequest* GetAssetPreloadRequest();

  /// @brief Method GetDownloadStatus, addr 0x66f98f0, size 0x154, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus GetDownloadStatus();

  /// @brief Method GetLoadInfo, addr 0x66fb594, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLoadInfo, addr 0x66fb5c4, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLocalBundle, addr 0x66fb84c, size 0xc0, virtual false, abstract: false, final false
  inline void LoadLocalBundle();

  /// @brief Method LocalRequestOperationCompleted, addr 0x66fb474, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnUnloadOperationComplete, addr 0x66fa180, size 0x8, virtual false, abstract: false, final false
  inline void OnUnloadOperationComplete(::UnityEngine::AsyncOperation* op);

  /// @brief Method PercentComplete, addr 0x66f98d8, size 0x18, virtual false, abstract: false, final false
  inline float_t PercentComplete();

  /// @brief Method RemoveBundleFromProfiler, addr 0x66fa110, size 0x70, virtual false, abstract: false, final false
  inline void RemoveBundleFromProfiler();

  /// @brief Method Start, addr 0x66fa3a4, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Unload, addr 0x66fbf98, size 0xb4, virtual false, abstract: false, final false
  inline bool Unload(::ByRef<::UnityEngine::AssetBundleUnloadOperation*> unloadOp);

  /// @brief Method Update, addr 0x66fbc54, size 0x1c8, virtual true, abstract: false, final true
  inline void Update(float_t unscaledDeltaTime);

  /// @brief Method WaitForCompletionHandler, addr 0x66fa9c0, size 0x38c, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method WebRequestOperationCompleted, addr 0x66fad4c, size 0x728, virtual false, abstract: false, final false
  inline void WebRequestOperationCompleted(::UnityEngine::AsyncOperation* op);

  /// @brief Method <AddBeginWebRequestHandler>b__45_0, addr 0x66fc140, size 0x4, virtual false, abstract: false, final false
  inline void _AddBeginWebRequestHandler_b__45_0(::UnityEngine::Networking::UnityWebRequestAsyncOperation* asyncOp);

  /// @brief Method <GetAssetPreloadRequest>b__30_0, addr 0x66fc134, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66fc04c, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BytesToDownload, addr 0x66f9314, size 0x58, virtual false, abstract: false, final false
  inline int64_t get_BytesToDownload();

  /// @brief Method get_HasTimedOut, addr 0x66f92d8, size 0x3c, virtual false, abstract: false, final false
