...
public:
  ...
  /// @brief Method AddCallbackInvokeIfDone, addr 0x2cbbde0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method BeginOperation, addr 0x2cbb238, size 0x378, virtual false, abstract: false, final false
  inline void BeginOperation();

  /// @brief Method BeginWebRequestOperation, addr 0x2cbc064, size 0xec, virtual false, abstract: false, final false
  inline void BeginWebRequestOperation(::UnityEngine::AsyncOperation* asyncOp);

  /// @brief Method CompleteBundleLoad, addr 0x2cbc2fc, size 0x13c, virtual false, abstract: false, final false
  inline void CompleteBundleLoad(::UnityEngine::AssetBundle* bundle);

  /// @brief Method CreateWebRequest, addr 0x2cba87c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateWebRequest, addr 0x2cba8a4, size 0x1bc, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest* CreateWebRequest(::StringW url);

  /// @brief Method GetAssetBundle, addr 0x2cbab84, size 0xf8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AssetBundle> GetAssetBundle();

  /// @brief Method GetAssetPreloadRequest, addr 0x2cbaa60, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::AssetBundleRequest* GetAssetPreloadRequest();

  /// @brief Method GetDownloadStatus, addr 0x2cbac94, size 0x150, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus GetDownloadStatus();

  /// @brief Method GetLoadInfo, addr 0x2cbbe40, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLoadInfo, addr 0x2cbbe70, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalRequestOperationCompleted, addr 0x2cbc270, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PercentComplete, addr 0x2cbac7c, size 0x18, virtual false, abstract: false, final false
  inline float_t PercentComplete();

  /// @brief Method Start, addr 0x2cbade4, size 0x238, virtual false, abstract: false, final false
  inline void Start(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle);

  /// @brief Method Unload, addr 0x2cbc438, size 0xa0, virtual false, abstract: false, final false
  inline void Unload();

  /// @brief Method Update, addr 0x2cbc150, size 0x120, virtual true, abstract: false, final true
  inline void Update(float_t unscaledDeltaTime);

  /// @brief Method WaitForCompletionHandler, addr 0x2cbb5b0, size 0x240, virtual false, abstract: false, final false
  inline bool WaitForCompletionHandler();

  /// @brief Method WebRequestOperationCompleted, addr 0x2cbb7f0, size 0x5f0, virtual false, abstract: false, final false
  inline void WebRequestOperationCompleted(::UnityEngine::AsyncOperation* op);

  /// @brief Method <BeginOperation>b__34_0, addr 0x2cbc4ec, size 0x4, virtual false, abstract: false, final false
  inline void _BeginOperation_b__34_0(::UnityEngine::Networking::UnityWebRequestAsyncOperation* asyncOp);

  /// @brief Method <GetAssetPreloadRequest>b__25_0, addr 0x2cbc4e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cbc4d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BytesToDownload, addr 0x2cba778, size 0x58, virtual false, abstract: false, final false
  inline int64_t get_BytesToDownload();

  /// @brief Method get_HasTimedOut, addr 0x2cba738, size 0x40, virtual false, abstract: false, final false
