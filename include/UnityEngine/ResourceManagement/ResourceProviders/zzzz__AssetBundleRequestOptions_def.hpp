...
public:
  ...
  /// @brief Method ComputeSize, addr 0x66f9168, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66f9284, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AssetLoadMode, addr 0x66f9118, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode get_AssetLoadMode();

  /// @brief Method get_BundleName, addr 0x66f9108, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BundleName();

  /// @brief Method get_BundleSize, addr 0x66f9128, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_BundleSize();

  /// @brief Method get_ChunkedTransfer, addr 0x66f90cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ChunkedTransfer();

  /// @brief Method get_ClearOtherCachedVersionsWhenLoaded, addr 0x66f9158, size 0x8, virtual false, abstract: false, final false
  inline bool get_ClearOtherCachedVersionsWhenLoaded();

  /// @brief Method get_Crc, addr 0x66f90ac, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Crc();

  /// @brief Method get_Hash, addr 0x66f909c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Hash();

  /// @brief Method get_RedirectLimit, addr 0x66f90dc, size 0x14, virtual false, abstract: false, final false
  inline int32_t get_RedirectLimit();

  /// @brief Method get_RetryCount, addr 0x66f90f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_RetryCount();

  /// @brief Method get_Timeout, addr 0x66f90bc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Timeout();

  /// @brief Method get_UseCrcForCachedBundle, addr 0x66f9138, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseCrcForCachedBundle();

  /// @brief Method get_UseUnityWebRequestForLocalBundles, addr 0x66f9148, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_AssetLoadMode, addr 0x66f9120, size 0x8, virtual false, abstract: false, final false
  inline void set_AssetLoadMode(::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode value);

  /// @brief Method set_BundleName, addr 0x66f9110, size 0x8, virtual false, abstract: false, final false
  inline void set_BundleName(::StringW value);

  /// @brief Method set_BundleSize, addr 0x66f9130, size 0x8, virtual false, abstract: false, final false
  inline void set_BundleSize(int64_t value);

  /// @brief Method set_ChunkedTransfer, addr 0x66f90d4, size 0x8, virtual false, abstract: false, final false
  inline void set_ChunkedTransfer(bool value);

  /// @brief Method set_ClearOtherCachedVersionsWhenLoaded, addr 0x66f9160, size 0x8, virtual false, abstract: false, final false
  inline void set_ClearOtherCachedVersionsWhenLoaded(bool value);

  /// @brief Method set_Crc, addr 0x66f90b4, size 0x8, virtual false, abstract: false, final false
  inline void set_Crc(uint32_t value);

  /// @brief Method set_Hash, addr 0x66f90a4, size 0x8, virtual false, abstract: false, final false
  inline void set_Hash(::StringW value);

  /// @brief Method set_RedirectLimit, addr 0x66f90f0, size 0x8, virtual false, abstract: false, final false
  inline void set_RedirectLimit(int32_t value);

  /// @brief Method set_RetryCount, addr 0x66f9100, size 0x8, virtual false, abstract: false, final false
  inline void set_RetryCount(int32_t value);

  /// @brief Method set_Timeout, addr 0x66f90c4, size 0x8, virtual false, abstract: false, final false
  inline void set_Timeout(int32_t value);

  /// @brief Method set_UseCrcForCachedBundle, addr 0x66f9140, size 0x8, virtual false, abstract: false, final false
  inline void set_UseCrcForCachedBundle(bool value);

  /// @brief Method set_UseUnityWebRequestForLocalBundles, addr 0x66f9150, size 0x8, virtual false, abstract: false, final false
