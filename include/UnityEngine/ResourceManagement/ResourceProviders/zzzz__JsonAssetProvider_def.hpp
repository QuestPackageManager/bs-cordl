...
public:
  // Declarations
  /// @brief Method Convert, addr 0x479ed1c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479ed28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
