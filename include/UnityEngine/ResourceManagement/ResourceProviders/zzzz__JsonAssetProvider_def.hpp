...
public:
  // Declarations
  /// @brief Method Convert, addr 0x6700270, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x670027c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
