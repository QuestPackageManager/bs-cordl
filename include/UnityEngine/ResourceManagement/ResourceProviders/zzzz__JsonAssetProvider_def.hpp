...
public:
  // Declarations
  /// @brief Method Convert, addr 0x4799e20, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4799e2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
