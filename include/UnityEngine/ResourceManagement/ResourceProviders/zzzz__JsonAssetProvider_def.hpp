...
public:
  // Declarations
  /// @brief Method Convert, addr 0x2bd7734, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bd7740, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
