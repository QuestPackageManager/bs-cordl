...
public:
  // Declarations
  /// @brief Method Convert, addr 0x47ac240, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47ac24c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
