...
public:
// Declarations
/// @brief Method Convert, addr 0x67684bc, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x67684c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
