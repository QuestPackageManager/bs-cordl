...
public:
  // Ctor Parameters [CppParam { name: "", ty: "JsonAssetProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  JsonAssetProvider(JsonAssetProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "JsonAssetProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  JsonAssetProvider(JsonAssetProviderconst&) = delete;
