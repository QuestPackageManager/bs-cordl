...
public:
  ...
  /// @brief Method Copy, addr 0x67006a4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6700744, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x6700724, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method get_WebRequestTimeout, addr 0x6700734, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_WebRequestTimeout();

  /// @brief Method set_IgnoreFailures, addr 0x670072c, size 0x8, virtual false, abstract: false, final false
  inline void set_IgnoreFailures(bool value);

  /// @brief Method set_WebRequestTimeout, addr 0x670073c, size 0x8, virtual false, abstract: false, final false
