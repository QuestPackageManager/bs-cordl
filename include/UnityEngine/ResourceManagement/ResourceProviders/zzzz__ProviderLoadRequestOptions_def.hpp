...
public:
  ...
  /// @brief Method Copy, addr 0x6768230, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67682d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IgnoreFailures, addr 0x67682b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IgnoreFailures();

  /// @brief Method get_WebRequestTimeout, addr 0x67682c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_WebRequestTimeout();

  /// @brief Method set_IgnoreFailures, addr 0x67682b8, size 0x8, virtual false, abstract: false, final false
  inline void set_IgnoreFailures(bool value);

  /// @brief Method set_WebRequestTimeout, addr 0x67682c8, size 0x8, virtual false, abstract: false, final false
