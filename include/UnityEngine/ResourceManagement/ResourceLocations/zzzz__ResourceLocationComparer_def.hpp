...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationComparer*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationComparer*, "UnityEngine.ResourceManagement.ResourceLocations", "ResourceLocationComparer");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResourceLocationComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResourceLocationComparer(ResourceLocationComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResourceLocationComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResourceLocationComparer(ResourceLocationComparerconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationComparer) == 0x10, "Size mismatch!");
