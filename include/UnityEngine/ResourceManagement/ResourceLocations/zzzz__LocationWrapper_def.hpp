...
public:
  ...
  /// @brief Method Hash, addr 0x47b027c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x47a6b84, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method get_Data, addr 0x47b0090, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Object* get_Data();

  /// @brief Method get_Dependencies, addr 0x47afea4, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_DependencyHashCode, addr 0x47aff48, size 0xa4, virtual true, abstract: false, final true
  inline int32_t get_DependencyHashCode();

  /// @brief Method get_HasDependencies, addr 0x47affec, size 0xa4, virtual true, abstract: false, final true
  inline bool get_HasDependencies();

  /// @brief Method get_InternalId, addr 0x47afd60, size 0xa0, virtual true, abstract: false, final true
  inline ::StringW get_InternalId();

  /// @brief Method get_PrimaryKey, addr 0x47b0134, size 0xa4, virtual true, abstract: false, final true
  inline ::StringW get_PrimaryKey();

  /// @brief Method get_ProviderId, addr 0x47afe00, size 0xa4, virtual true, abstract: false, final true
  inline ::StringW get_ProviderId();

  /// @brief Method get_ResourceType, addr 0x47b01d8, size 0xa4, virtual true, abstract: false, final true
