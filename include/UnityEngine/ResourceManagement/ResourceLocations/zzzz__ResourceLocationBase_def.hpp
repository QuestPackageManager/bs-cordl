...
public:
  ...
  /// @brief Method ComputeDependencyHash, addr 0x691e538, size 0x1f0, virtual false, abstract: false, final false
  inline void ComputeDependencyHash();

  /// @brief Method Hash, addr 0x691e30c, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method ToString, addr 0x691e358, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x691e360, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Data, addr 0x691e2dc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* get_Data();

  /// @brief Method get_Dependencies, addr 0x691e278, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_DependencyHashCode, addr 0x691e2fc, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_DependencyHashCode();

  /// @brief Method get_HasDependencies, addr 0x691e280, size 0x5c, virtual true, abstract: false, final true
  inline bool get_HasDependencies();

  /// @brief Method get_InternalId, addr 0x691e268, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_InternalId();

  /// @brief Method get_PrimaryKey, addr 0x691e2ec, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_PrimaryKey();

  /// @brief Method get_ProviderId, addr 0x691e270, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_ProviderId();

  /// @brief Method get_ResourceType, addr 0x691e304, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Data, addr 0x691e2e4, size 0x8, virtual false, abstract: false, final false
  inline void set_Data(::System::Object* value);

  /// @brief Method set_PrimaryKey, addr 0x691e2f4, size 0x8, virtual false, abstract: false, final false
