...
/// @brief Method ComputeDependencyHash, addr 0x676bed0, size 0x1f0, virtual false, abstract: false, final false
inline void ComputeDependencyHash() ;

/// @brief Method Hash, addr 0x676bca4, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x676bcf0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x676bcf8, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method get_Data, addr 0x676bc74, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x676bc10, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method get_DependencyHashCode, addr 0x676bc94, size 0x8, virtual true, abstract: false, final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies, addr 0x676bc18, size 0x5c, virtual true, abstract: false, final true
inline bool get_HasDependencies() ;

/// @brief Method get_InternalId, addr 0x676bc00, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_InternalId() ;

/// @brief Method get_PrimaryKey, addr 0x676bc84, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ProviderId, addr 0x676bc08, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_ResourceType, addr 0x676bc9c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_Data, addr 0x676bc7c, size 0x8, virtual false, abstract: false, final false
inline void set_Data(::System::Object*  value) ;

/// @brief Method set_PrimaryKey, addr 0x676bc8c, size 0x8, virtual false, abstract: false, final false
