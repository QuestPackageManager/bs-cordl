...
public:
  ...
  /// @brief Method GetPool, addr 0x30fb954, size 0xf0, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::System::Object*>* GetPool();

  /// @brief Method New, addr 0x30fbb04, size 0x13c, virtual true, abstract: false, final true
  ...
  /// @brief Method Release, addr 0x30fbc40, size 0x138, virtual true, abstract: false, final true
  inline void Release(int32_t typeHash, ::System::Object* obj);

  /// @brief Method ReleasePool, addr 0x30fba44, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30f3cf4, size 0x1d8, virtual false, abstract: false, final false
