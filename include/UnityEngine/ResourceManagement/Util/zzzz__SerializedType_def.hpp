...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_AssemblyName", ty: "::StringW", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_ClassName", ty: "::StringW", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "m_CachedType", ty: "::System::Type*", modifiers: "", def_value: None, comment: None }, CppParam { name: "_ValueChanged_k__BackingField", ty: "bool",
