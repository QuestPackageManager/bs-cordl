...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>::get(),
                        "Equals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<bool, false>(this, ___internal_method, other);
}
template<typename TKey,typename TValue>
inline int32_t UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>::GetHashCode()  {
...
template<typename TKey,typename TValue>
constexpr ::System::IEquatable_1<::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>* UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>::i___System__IEquatable_1___UnityEngine__ResourceManagement__Util__LRUCache_2_Entry_TKey_TValue__()  {
return static_cast<::System::IEquatable_1<::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
// Ctor Parameters [CppParam { name: "lruNode", ty: "::System::Collections::Generic::LinkedListNode_1<TKey>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "Value", ty: "TValue", modifiers: "", def_value: Some("{}") }]
template<typename TKey,typename TValue>
...
// Ctor Parameters [CppParam { name: "requestHits", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "requestCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "entryLimit", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "cache", ty: "::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "lru", ty: "::System::Collections::Generic::LinkedList_1<TKey>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "nodeCache", ty: "::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<TKey>*", modifiers: "", def_value: Some("{}") }]
template<typename TKey,typename TValue>
