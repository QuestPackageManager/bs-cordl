...
// Ctor Parameters [CppParam { name: "lruNode", ty: "::System::Collections::Generic::LinkedListNode_1<TKey>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "Value", ty:
// "TValue", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*>)
...
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*>)
inline bool UnityEngine::ResourceManagement::Util::LRUCache_2<TKey, TValue>::TryGet(TKey offset, ::by_ref<TValue> val) {
...
// "::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "lru", ty: "::System::Collections::Generic::LinkedList_1<TKey>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "nodeCache", ty:
// "::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<TKey>*", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename TKey, typename TValue>
  requires(::cordl_internals::type_constraint<TKey, ::System::IEquatable_1<TKey>*>)
