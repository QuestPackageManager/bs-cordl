...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x66f72d0, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x66f6e68, size 0x2f8, virtual false, abstract: false, final false
