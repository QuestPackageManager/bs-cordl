...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x4792af0, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x47926ac, size 0x2f4, virtual false, abstract: false, final false
