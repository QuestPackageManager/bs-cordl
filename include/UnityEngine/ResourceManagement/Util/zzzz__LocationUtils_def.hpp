...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x675ee5c, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x675e9f4, size 0x2f8, virtual false, abstract: false, final false
