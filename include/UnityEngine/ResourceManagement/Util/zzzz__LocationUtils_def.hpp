...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x6911b70, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x6911708, size 0x2f8, virtual false, abstract: false, final false
