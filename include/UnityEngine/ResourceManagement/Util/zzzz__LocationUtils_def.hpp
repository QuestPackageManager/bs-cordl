...
public:
  // Declarations
  /// @brief Method DependenciesEqual, addr 0x30fb54c, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method LocationEquals, addr 0x30fb110, size 0x2f4, virtual false, abstract: false, final false
