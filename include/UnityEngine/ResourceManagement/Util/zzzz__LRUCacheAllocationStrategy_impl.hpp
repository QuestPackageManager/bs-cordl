...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::*)(int32_t, int32_t, int32_t, int32_t)>(&::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::_ctor)> {
  constexpr static std::size_t size = 0x1e4;
  constexpr static std::size_t addrs = 0x6753ec0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::System::Object*>* (::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::*)()>(&::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::GetPool)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x675f958;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::*)(::System::Collections::Generic::List_1<::System::Object*>*)>(&::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::ReleasePool)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x675fa5c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::*)(::System::Type*, int32_t)>(&::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::New)> {
  constexpr static std::size_t size = 0x15c;
  constexpr static std::size_t addrs = 0x675fb30;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::*)(int32_t, ::System::Object*)>(&::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::Release)> {
  constexpr static std::size_t size = 0x174;
  constexpr static std::size_t addrs = 0x675fc8c;
...
constexpr ::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Object*>*>*& UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_get_m_poolCache()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_poolCache;
}
constexpr ::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Object*>*>* const& UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_get_m_poolCache() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_poolCache;
}
constexpr void UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_set_m_poolCache(::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Object*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::System::Object*>*>*& UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_get_m_cache()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_cache;
}
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::System::Object*>*>* const& UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_get_m_cache() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_cache;
}
constexpr void UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::__cordl_internal_set_m_cache(::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::System::Object*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, poolMaxSize, poolCapacity, poolCacheMaxSize, initialPoolCacheCapacity);
}
...
inline ::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy* UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::New_ctor(int32_t  poolMaxSize, int32_t  poolCapacity, int32_t  poolCacheMaxSize, int32_t  initialPoolCacheCapacity)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy*>(poolMaxSize, poolCapacity, poolCacheMaxSize, initialPoolCacheCapacity));
}
...
constexpr ::UnityEngine::ResourceManagement::Util::IAllocationStrategy* UnityEngine::ResourceManagement::Util::LRUCacheAllocationStrategy::i___UnityEngine__ResourceManagement__Util__IAllocationStrategy() noexcept {
return static_cast<::UnityEngine::ResourceManagement::Util::IAllocationStrategy*>(static_cast<void*>(this));
}
// Ctor Parameters []
