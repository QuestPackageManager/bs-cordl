...
template<typename T>
inline bool UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1<T>::get_CacheExists()  {
...
template<typename T>
inline void UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1<T>::SetCacheSize(int32_t  length)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1<T>*>::get(),
                        "SetCacheSize",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::ResourceManagement::Util::GlobalLinkedListNodeCache_1<T>::GlobalLinkedListNodeCache_1()   {
}
