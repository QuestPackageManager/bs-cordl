...
public:
  // Declarations
  /// @brief Method IsAssetBundleDownloaded, addr 0x2cb66d4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestHasErrors, addr 0x2cb9db0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb9ff0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
