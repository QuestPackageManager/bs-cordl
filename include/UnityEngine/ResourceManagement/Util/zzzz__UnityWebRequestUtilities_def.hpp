...
public:
  // Declarations
  /// @brief Method IsAssetBundleDownloaded, addr 0x30ff3b8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestHasErrors, addr 0x3102a94, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3102cd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
