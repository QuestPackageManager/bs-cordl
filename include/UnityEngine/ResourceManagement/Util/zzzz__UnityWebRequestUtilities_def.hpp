...
public:
  // Declarations
  /// @brief Method IsAssetBundleDownloaded, addr 0x4796670, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestHasErrors, addr 0x479d454, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479d67c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
