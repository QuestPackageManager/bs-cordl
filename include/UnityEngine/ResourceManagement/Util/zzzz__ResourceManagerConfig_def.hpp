...
public:
  // Declarations
  /// @brief Method CreateArrayResult, addr 0x67d2730, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateListResult, addr 0x67d28ac, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractKeyAndSubKey, addr 0x67d23d0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPathRemote, addr 0x67d2498, size 0x68, virtual false, abstract: false, final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath, addr 0x67d25e0, size 0x150, virtual false, abstract: false, final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method ShouldPathUseWebRequest, addr 0x67d2548, size 0x98, virtual false, abstract: false, final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method StripQueryParameters, addr 0x67d2500, size 0x48, virtual false, abstract: false, final false
