...
public:
  // Declarations
  /// @brief Method ExtractKeyAndSubKey addr 0x2a4fd90 size 0xe4 virtual false final false
  static inline bool ExtractKeyAndSubKey(::System::Object* keyObj, ByRef<::StringW> mainKey, ByRef<::StringW> subKey);

  /// @brief Method IsPathRemote addr 0x2a4fe74 size 0x60 virtual false final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method StripQueryParameters addr 0x2a4fed4 size 0x44 virtual false final false
  static inline ::StringW StripQueryParameters(::StringW path);

  /// @brief Method ShouldPathUseWebRequest addr 0x2a4ff18 size 0x7c virtual false final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath addr 0x2a4ff94 size 0x104 virtual false final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method CreateArrayResult addr 0x2a50098 size 0x1b8 virtual false final false
  ...
  /// @brief Method CreateListResult addr 0x2a50250 size 0x1cc virtual false final false
