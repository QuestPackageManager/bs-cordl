...
public:
  // Declarations
  /// @brief Method CreateArrayResult, addr 0x66f84d8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateListResult, addr 0x66f8654, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractKeyAndSubKey, addr 0x66f8178, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPathRemote, addr 0x66f8240, size 0x68, virtual false, abstract: false, final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath, addr 0x66f8388, size 0x150, virtual false, abstract: false, final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method ShouldPathUseWebRequest, addr 0x66f82f0, size 0x98, virtual false, abstract: false, final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method StripQueryParameters, addr 0x66f82a8, size 0x48, virtual false, abstract: false, final false
