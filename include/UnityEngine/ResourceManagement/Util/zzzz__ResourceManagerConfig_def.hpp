...
public:
  // Declarations
  /// @brief Method CreateArrayResult, addr 0x4798bdc, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateListResult, addr 0x4798d94, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractKeyAndSubKey, addr 0x47988b0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPathRemote, addr 0x4798994, size 0x64, virtual false, abstract: false, final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath, addr 0x4798ab8, size 0x124, virtual false, abstract: false, final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method ShouldPathUseWebRequest, addr 0x4798a3c, size 0x7c, virtual false, abstract: false, final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method StripQueryParameters, addr 0x47989f8, size 0x44, virtual false, abstract: false, final false
