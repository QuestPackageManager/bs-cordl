...
public:
  // Declarations
  /// @brief Method CreateArrayResult, addr 0x4793ce0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateListResult, addr 0x4793e98, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractKeyAndSubKey, addr 0x47939b4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPathRemote, addr 0x4793a98, size 0x64, virtual false, abstract: false, final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath, addr 0x4793bbc, size 0x124, virtual false, abstract: false, final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method ShouldPathUseWebRequest, addr 0x4793b40, size 0x7c, virtual false, abstract: false, final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method StripQueryParameters, addr 0x4793afc, size 0x44, virtual false, abstract: false, final false
