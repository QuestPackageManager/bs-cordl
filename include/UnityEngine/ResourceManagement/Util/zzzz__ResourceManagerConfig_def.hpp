...
public:
  // Declarations
  /// @brief Method CreateArrayResult, addr 0x2d19264, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateListResult, addr 0x2d1941c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractKeyAndSubKey, addr 0x2d18f5c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPathRemote, addr 0x2d19040, size 0x60, virtual false, abstract: false, final false
  static inline bool IsPathRemote(::StringW path);

  /// @brief Method PlatformCanLoadLocallyFromUrlPath, addr 0x2d19160, size 0x104, virtual false, abstract: false, final false
  static inline bool PlatformCanLoadLocallyFromUrlPath();

  /// @brief Method ShouldPathUseWebRequest, addr 0x2d190e4, size 0x7c, virtual false, abstract: false, final false
  static inline bool ShouldPathUseWebRequest(::StringW path);

  /// @brief Method StripQueryParameters, addr 0x2d190a0, size 0x44, virtual false, abstract: false, final false
