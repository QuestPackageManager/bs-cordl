...
public:
  ...
  /// @brief Method ShouldRetryDownloadError, addr 0x4794444, size 0x2f8, virtual false, abstract: false, final false
  inline bool ShouldRetryDownloadError();

  /// @brief Method ToString, addr 0x4794294, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479418c, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Networking::UnityWebRequest* request);

  /// @brief Method get_Error, addr 0x4794414, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Error();

  /// @brief Method get_Method, addr 0x4794434, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Method();

  /// @brief Method get_ResponseCode, addr 0x4794424, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_ResponseCode();

  /// @brief Method get_Result, addr 0x479442c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest_Result get_Result();

  /// @brief Method get_Url, addr 0x479443c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Url();

  /// @brief Method set_Error, addr 0x479441c, size 0x8, virtual false, abstract: false, final false
