...
public:
  ...
  /// @brief Method GetAsyncInitHandle, addr 0x675fb00, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x675fa48, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Data, addr 0x675fa40, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_Id, addr 0x675fa28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_ObjectType, addr 0x675fa30, size 0x10, virtual false, abstract: false, final false
