...
public:
  ...
  /// @brief Method GetAsyncInitHandle, addr 0x47a5b90, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x47a5af8, size 0x98, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_Data, addr 0x47a5af0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Data();

  /// @brief Method get_Id, addr 0x47a5ad8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method get_ObjectType, addr 0x47a5ae0, size 0x10, virtual false, abstract: false, final false
