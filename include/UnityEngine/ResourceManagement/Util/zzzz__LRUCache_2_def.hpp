...
constexpr ::System::IEquatable_1<::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>* i___System__IEquatable_1___UnityEngine__ResourceManagement__Util__LRUCache_2_Entry_TKey_TValue__() ;
...
// Ctor Parameters [CppParam { name: "requestHits", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "requestCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "entryLimit", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cache", ty: "::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>*", modifiers: "", def_value: None }, CppParam { name: "lru", ty: "::System::Collections::Generic::LinkedList_1<TKey>*", modifiers: "", def_value: None }, CppParam { name: "nodeCache", ty: "::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<TKey>*", modifiers: "", def_value: None }]
constexpr LRUCache_2(int32_t  requestHits, int32_t  requestCount, int32_t  entryLimit, ::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::LRUCache_2_Entry<TKey,TValue>>*  cache, ::System::Collections::Generic::LinkedList_1<TKey>*  lru, ::UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<TKey>*  nodeCache) noexcept;
