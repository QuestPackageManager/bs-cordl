...
public:
  ...
  /// @brief Method Equals, addr 0x30fb40c, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x30fb498, size 0x28, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::DependenciesCacheKey* other);

  /// @brief Method Equals, addr 0x30fb4c0, size 0x8c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x30fb404, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30f6b38, size 0x30, virtual false, abstract: false, final false
