...
public:
  ...
  /// @brief Method Equals, addr 0x33311e4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3331270, size 0x28, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::DependenciesCacheKey* other);

  /// @brief Method Equals, addr 0x3331298, size 0x8c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x33311dc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x332c910, size 0x30, virtual false, abstract: false, final false
