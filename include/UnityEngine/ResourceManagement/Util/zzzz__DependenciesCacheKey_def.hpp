...
public:
  ...
  /// @brief Method Equals, addr 0x47a4dc8, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x47a4e58, size 0x28, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::DependenciesCacheKey* other);

  /// @brief Method Equals, addr 0x47a4e80, size 0x90, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x47a4dc0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479cf20, size 0x30, virtual false, abstract: false, final false
