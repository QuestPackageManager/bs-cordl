...
public:
  ...
  /// @brief Method New, addr 0x67d194c, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method Release, addr 0x67d195c, size 0x4, virtual true, abstract: false, final true
  inline void Release(int32_t typeHash, ::System::Object* obj);

  /// @brief Method .ctor, addr 0x67d1960, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
