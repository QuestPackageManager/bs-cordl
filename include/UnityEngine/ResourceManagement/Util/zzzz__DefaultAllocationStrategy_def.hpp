...
public:
  ...
  /// @brief Method New, addr 0x4735114, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method Release, addr 0x4735120, size 0x4, virtual true, abstract: false, final true
  inline void Release(int32_t typeHash, ::System::Object* obj);

  /// @brief Method .ctor, addr 0x4735124, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
