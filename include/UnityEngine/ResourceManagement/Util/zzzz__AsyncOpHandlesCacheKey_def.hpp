...
public:
  ...
  /// @brief Method Equals, addr 0x4734fbc, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4735020, size 0x7c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey* other);

  /// @brief Method Equals, addr 0x473509c, size 0x64, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x4734f9c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x472cbe8, size 0x88, virtual false, abstract: false, final false
