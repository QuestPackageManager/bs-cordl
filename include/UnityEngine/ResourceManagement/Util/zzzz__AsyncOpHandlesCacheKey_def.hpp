...
public:
  ...
  /// @brief Method Equals, addr 0x6917630, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x69176a0, size 0x8c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey* other);

  /// @brief Method Equals, addr 0x691772c, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x6917614, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x690ec08, size 0xac, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncOpHandlesCacheKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncOpHandlesCacheKey(AsyncOpHandlesCacheKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncOpHandlesCacheKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncOpHandlesCacheKey(AsyncOpHandlesCacheKeyconst&) = delete;
