...
public:
  ...
  /// @brief Method Equals, addr 0x47a51bc, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x47a5220, size 0x7c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey* other);

  /// @brief Method Equals, addr 0x47a529c, size 0x64, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x47a519c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479cde8, size 0x88, virtual false, abstract: false, final false
