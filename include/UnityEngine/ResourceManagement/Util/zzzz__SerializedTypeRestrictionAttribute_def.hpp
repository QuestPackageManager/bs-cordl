...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Util::SerializedTypeRestrictionAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Util::SerializedTypeRestrictionAttribute*, "UnityEngine.ResourceManagement.Util", "SerializedTypeRestrictionAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6917c6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializedTypeRestrictionAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializedTypeRestrictionAttribute(SerializedTypeRestrictionAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializedTypeRestrictionAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializedTypeRestrictionAttribute(SerializedTypeRestrictionAttributeconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Util::SerializedTypeRestrictionAttribute) == 0x18, "Size mismatch!");
