...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinkedListNodeCache_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinkedListNodeCache_1(LinkedListNodeCache_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinkedListNodeCache_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinkedListNodeCache_1(LinkedListNodeCache_1const&) = delete;
