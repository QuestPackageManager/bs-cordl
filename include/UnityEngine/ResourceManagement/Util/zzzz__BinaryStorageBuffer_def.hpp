...
public:
  ...
  /// @brief Method <FindBestSeparator>b__0, addr 0x675ab60, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675a7c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Deserialize, addr 0x675a228, size 0x2c4, virtual true, abstract: false, final true
  ...
  /// @brief Method FindBestSeparator, addr 0x675a5c8, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x675a7c8, size 0x378, virtual true, abstract: false, final true
  inline uint32_t Serialize(::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_Writer* writer, ::System::Object* val);

  /// @brief Method .ctor, addr 0x675ab5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Dependencies, addr 0x675a220, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Deserialize, addr 0x675ab78, size 0x1a0, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x675ad18, size 0x120, virtual true, abstract: false, final true
  inline uint32_t Serialize(::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_Writer* writer, ::System::Object* val);

  /// @brief Method .ctor, addr 0x675ae38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Dependencies, addr 0x675ab70, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter*>* get_Dependencies();
...
public:
  ...
  /// @brief Method AddSerializationAdapter, addr 0x675b03c, size 0xc, virtual false, abstract: false, final false
  inline void AddSerializationAdapter(::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter* a);

  /// @brief Method ComputeStringLength, addr 0x675bb58, size 0x20, virtual false, abstract: false, final false
  inline int32_t ComputeStringLength(uint32_t id, char16_t sep);

  /// @brief Method GetAutoEncodedStringLength, addr 0x675bb78, size 0x48, virtual false, abstract: false, final false
  inline int32_t GetAutoEncodedStringLength(uint32_t id);

  /// @brief Method GetBuffer, addr 0x675b04c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBuffer();

  /// @brief Method GetCacheStats, addr 0x675ae3c, size 0x14, virtual false, abstract: false, final false
  inline void GetCacheStats(::ByRef<int32_t> reqCount, ::ByRef<int32_t> reqHits);

  /// @brief Method GetDynamicStringLength, addr 0x675bbc0, size 0xb4, virtual false, abstract: false, final false
  inline int32_t GetDynamicStringLength(uint32_t id, char16_t sep);

  /// @brief Method GetStringLengthInternal, addr 0x675bc74, size 0x1a0, virtual false, abstract: false, final false
  inline int32_t GetStringLengthInternal(uint32_t offset, ::System::Text::Encoding* enc);

  /// @brief Method Init, addr 0x675ae50, size 0x1ec, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method ReadAutoEncodedString, addr 0x675b758, size 0x54, virtual false, abstract: false, final false
  inline ::StringW ReadAutoEncodedString(uint32_t id, bool cacheValue);

  /// @brief Method ReadDynamicString, addr 0x675b7ac, size 0x17c, virtual false, abstract: false, final false
  inline ::StringW ReadDynamicString(uint32_t id, char16_t sep, bool cacheValue);

  /// @brief Method ReadObject, addr 0x675b2d0, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Object* ReadObject(uint32_t id, bool cacheValue);

  /// @brief Method ReadObject, addr 0x675b53c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadObjectArray, addr 0x675b134, size 0x19c, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Object*, ::Array<::System::Object*>*> ReadObjectArray(uint32_t id, bool cacheValues, bool cacheFullArray);

  /// @brief Method ReadObjectArray, addr 0x675b390, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadString, addr 0x675a4ec, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW ReadString(uint32_t id, char16_t sep, bool cacheValue);

  /// @brief Method ReadStringInternal, addr 0x675b928, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method <ReadDynamicString>b__29_0, addr 0x675be14, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675b048, size 0x4, virtual false, abstract: false, final false
  inline void
  _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t maxCachedObjects,
        ::ArrayW<::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter*, ::Array<::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter*>*>
            adapters);

  /// @brief Method .ctor, addr 0x675b054, size 0xe0, virtual false, abstract: false, final false
  inline void
...
public:
  ...
  /// @brief Method .ctor, addr 0x675c270, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeStringSize, addr 0x675d0b0, size 0x54, virtual false, abstract: false, final false
  static inline uint32_t ComputeStringSize(::StringW str, ::ByRef<bool> isUnicode);

  /// @brief Method FindChunkWithSpace, addr 0x675c274, size 0x198, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::Util::Writer_BinaryStorageBuffer_Chunk* FindChunkWithSpace(uint32_t length);

  /// @brief Method IsUnicode, addr 0x675d00c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecurseDynamicStringParts, addr 0x675d104, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method ReserveInternal, addr 0x675c640, size 0x50, virtual false, abstract: false, final false
  inline uint32_t ReserveInternal(uint32_t dataSize, bool prefixSize);

  /// @brief Method SerializeToByteArray, addr 0x675ccd4, size 0x1fc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> SerializeToByteArray();

  /// @brief Method SerializeToStream, addr 0x675ced0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteAutoEncodedString, addr 0x675cbc8, size 0xb0, virtual false, abstract: false, final false
  inline uint32_t WriteAutoEncodedString(::StringW str);

  /// @brief Method WriteDynamicString, addr 0x675ca4c, size 0x17c, virtual false, abstract: false, final false
  inline uint32_t WriteDynamicString(::StringW str, char16_t sep);

  /// @brief Method WriteInternal, addr 0x675c40c, size 0x234, virtual false, abstract: false, final false
  inline uint32_t WriteInternal(void* pData, uint32_t dataSize, bool prefixSize);

  /// @brief Method WriteInternal, addr 0x675c690, size 0x264, virtual false, abstract: false, final false
  inline void WriteInternal(uint32_t id, void* pData, uint32_t dataSize, bool prefixSize);

  /// @brief Method WriteObject, addr 0x675c8f4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteString, addr 0x675ab40, size 0x1c, virtual false, abstract: false, final false
  inline uint32_t WriteString(::StringW str, char16_t sep);

  /// @brief Method WriteStringInternal, addr 0x675cc78, size 0x5c, virtual false, abstract: false, final false
  inline uint32_t WriteStringInternal(::StringW val, ::System::Text::Encoding* enc);

  /// @brief Method WriteUnicodeString, addr 0x675d078, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x675bfb4, size 0x2bc, virtual false, abstract: false, final false
  inline void
  _ctor(int32_t chunkSize,
        ::ArrayW<::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter*, ::Array<::UnityEngine::ResourceManagement::Util::BinaryStorageBuffer_ISerializationAdapter*>*>
            adapters);

  /// @brief Method get_Length, addr 0x675bfac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSerializationAdapter, addr 0x6759998, size 0x658, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method ComputeHash, addr 0x6759980, size 0x18, virtual false, abstract: false, final false
  static inline void ComputeHash(void* pData, uint64_t size, ::UnityEngine::Hash128* hash);

  /// @brief Method GetSerializationAdapter, addr 0x6759ff0, size 0x22c, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method .ctor, addr 0x675a21c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
