...
public:
  ...
  /// @brief Method Equals, addr 0x69115b0, size 0x70, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6911698, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method Equals, addr 0x6911620, size 0x78, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::LocationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x6911500, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69087dc, size 0xa8, virtual false, abstract: false, final false
