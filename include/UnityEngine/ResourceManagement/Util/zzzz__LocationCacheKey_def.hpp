...
public:
  ...
  /// @brief Method Equals, addr 0x47a49a8, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x47a4a68, size 0x64, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method Equals, addr 0x47a4a0c, size 0x5c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::LocationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x47a48fc, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x479c290, size 0xf0, virtual false, abstract: false, final false
