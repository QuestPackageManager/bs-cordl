...
public:
  ...
  /// @brief Method Equals, addr 0x4792588, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4792648, size 0x64, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey* other);

  /// @brief Method Equals, addr 0x47925ec, size 0x5c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::ResourceManagement::Util::LocationCacheKey* other);

  /// @brief Method GetHashCode, addr 0x47924dc, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4789e70, size 0xf0, virtual false, abstract: false, final false
