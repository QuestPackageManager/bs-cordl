...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocationCacheKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocationCacheKey(LocationCacheKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocationCacheKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocationCacheKey(LocationCacheKeyconst&) = delete;
