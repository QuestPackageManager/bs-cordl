...
public:
  // Declarations
  /// @brief Method PlatformUsesMultiThreading addr 0x2a4f2ac size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4f2b8 size 0x8 virtual false final false
  inline void _ctor();
