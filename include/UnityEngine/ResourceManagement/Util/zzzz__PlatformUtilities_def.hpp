...
public:
  ...
  /// @brief Method PlatformUsesMultiThreading, addr 0x6911f84, size 0xc, virtual false, abstract: false, final false
  static inline bool PlatformUsesMultiThreading(::UnityEngine::RuntimePlatform platform);

  /// @brief Method .ctor, addr 0x6911f90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
