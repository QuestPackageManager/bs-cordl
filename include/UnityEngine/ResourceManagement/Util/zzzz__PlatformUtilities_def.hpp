...
public:
  ...
  /// @brief Method PlatformUsesMultiThreading, addr 0x4792ee0, size 0xc, virtual false, abstract: false, final false
  static inline bool PlatformUsesMultiThreading(::UnityEngine::RuntimePlatform platform);

  /// @brief Method .ctor, addr 0x4792eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
