...
public:
  ...
  /// @brief Method PlatformUsesMultiThreading, addr 0x2d18478, size 0xc, virtual false, abstract: false, final false
  static inline bool PlatformUsesMultiThreading(::UnityEngine::RuntimePlatform platform);

  /// @brief Method .ctor, addr 0x2d18484, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
