...
public:
  ...
  /// @brief Method Invoke, addr 0x66f6314, size 0x16c, virtual false, abstract: false, final false
  inline void Invoke();

  /// @brief Method ToString, addr 0x66f6710, size 0x360, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x66f5c54, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_InvocationTime, addr 0x66f6700, size 0x8, virtual false, abstract: false, final false
  inline float_t get_InvocationTime();

  static inline void setStaticF_s_Id(int32_t value);

  /// @brief Method set_InvocationTime, addr 0x66f6708, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAction, addr 0x66f593c, size 0x78, virtual false, abstract: false, final false
  static inline void AddAction(::System::Delegate* action, float_t delay, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> parameters);

  /// @brief Method AddActionInternal, addr 0x66f59b4, size 0x2a0, virtual false, abstract: false, final false
  inline void AddActionInternal(::System::Delegate* action, float_t delay, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> parameters);

  /// @brief Method Clear, addr 0x66f58b4, size 0x7c, virtual false, abstract: false, final false
  static inline void Clear();

  /// @brief Method DestroyWhenComplete, addr 0x66f5930, size 0xc, virtual false, abstract: false, final false
  inline void DestroyWhenComplete();

  /// @brief Method GetNode, addr 0x66f57b8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalLateUpdate, addr 0x66f5fa0, size 0x334, virtual false, abstract: false, final false
  inline void InternalLateUpdate(float_t t);

  /// @brief Method LateUpdate, addr 0x66f62d4, size 0x40, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::UnityEngine::ResourceManagement::Util::DelayedActionManager* New_ctor();

  /// @brief Method OnApplicationQuit, addr 0x66f6480, size 0xc0, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method Wait, addr 0x66f5e00, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x66f6540, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsActive, addr 0x66f5cd4, size 0x12c, virtual false, abstract: false, final false
