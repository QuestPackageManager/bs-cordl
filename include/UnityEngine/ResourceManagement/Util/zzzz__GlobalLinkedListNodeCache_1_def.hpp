...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GlobalLinkedListNodeCache_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlobalLinkedListNodeCache_1(GlobalLinkedListNodeCache_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlobalLinkedListNodeCache_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlobalLinkedListNodeCache_1(GlobalLinkedListNodeCache_1const&) = delete;
