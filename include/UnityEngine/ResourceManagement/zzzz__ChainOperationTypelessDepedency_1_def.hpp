...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14034)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 788 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14036)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 788 }), TypeDefinitionIndex(TypeDefinitionIndex(14033)),
// TypeDefinitionIndex(TypeDefinitionIndex(14032))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13950)) CS Name: ::UnityEngine.ResourceManagement::ChainOperationTypelessDepedency`1<TObject>*
...
public:
  ...
  __declspec(property(get = __get_m_Callback, put = __set_m_Callback))::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle,
  ...
  constexpr void __set_m_Callback(
