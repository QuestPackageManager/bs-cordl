...
public:
  ...
  /// @brief Method .ctor addr 0x2a4cecc size 0x58 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::ResourceManagement::Exceptions::ResourceManagerException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x2a4cf24 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4cf8c size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4cffc size 0x80 virtual false final false
  ...
  /// @brief Method ToString addr 0x2a4d07c size 0x88 virtual true final false
