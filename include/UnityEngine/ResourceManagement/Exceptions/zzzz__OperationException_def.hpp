...
public:
  ...
  /// @brief Method ToString, addr 0x67596dc, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6759668, size 0x74, virtual false, abstract: false, final false
