...
public:
  ...
  /// @brief Method ToString, addr 0x479fed8, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x479fe68, size 0x70, virtual false, abstract: false, final false
