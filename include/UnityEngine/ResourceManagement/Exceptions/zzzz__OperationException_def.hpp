...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Exceptions::OperationException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Exceptions::OperationException*, "UnityEngine.ResourceManagement.Exceptions", "OperationException");
...
public:
  ...
  /// @brief Method ToString, addr 0x690c3f0, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x690c37c, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Exceptions::OperationException) == 0x90, "Size mismatch!");
