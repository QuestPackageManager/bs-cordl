...
public:
  ...
  /// @brief Method ToString, addr 0x67cbd28, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cbb8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x67c760c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* location);

  /// @brief Method .ctor, addr 0x67cbb90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x67cbb94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x67cbb98, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Location, addr 0x67cbb7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_Location();

  /// @brief Method get_Message, addr 0x67cbb9c, size 0x18c, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method set_Location, addr 0x67cbb84, size 0x8, virtual false, abstract: false, final false
