...
public:
  ...
  /// @brief Method get_Location addr 0x2a4d104 size 0x8 virtual false final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_Location();

  /// @brief Method set_Location addr 0x2a4d10c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a48e88 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4d114 size 0x4 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::ResourceManagement::Exceptions::UnknownResourceProviderException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x2a4d118 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4d11c size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a4d120 size 0x4 virtual false final false
  ...
  /// @brief Method get_Message addr 0x2a4d124 size 0x214 virtual true final false
  inline ::StringW get_Message();

  /// @brief Method ToString addr 0x2a4d338 size 0xc virtual true final false
