...
public:
  ...
  /// @brief Method ToString, addr 0x67cbed0, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67cbe90, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Message, addr 0x67cbebc, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_WebRequestResult, addr 0x67cbec8, size 0x8, virtual false, abstract: false, final false
