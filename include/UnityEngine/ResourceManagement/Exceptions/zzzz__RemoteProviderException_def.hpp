...
public:
  ...
  /// @brief Method ToString, addr 0x47910e4, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47910a4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Message, addr 0x47910d0, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// @brief Method get_WebRequestResult, addr 0x47910dc, size 0x8, virtual false, abstract: false, final false
