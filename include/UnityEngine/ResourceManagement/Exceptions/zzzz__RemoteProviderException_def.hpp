...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException*, "UnityEngine.ResourceManagement.Exceptions", "RemoteProviderException");
...
public:
  ...
  /// @brief Method ToString, addr 0x6911d30, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6911cf0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Message, addr 0x6911d1c, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_Message();

  /// [CompilerGenerated]
  /// @brief Method get_WebRequestResult, addr 0x6911d28, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemoteProviderException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemoteProviderException(RemoteProviderException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemoteProviderException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemoteProviderException(RemoteProviderExceptionconst&) = delete;
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException) == 0xa0, "Size mismatch!");
