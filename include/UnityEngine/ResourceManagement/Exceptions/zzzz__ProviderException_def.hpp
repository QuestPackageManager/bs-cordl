...
public:
  ...
  /// @brief Method .ctor, addr 0x4796f30, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Location, addr 0x4796f58, size 0x8, virtual false, abstract: false, final false
