...
public:
  ...
  /// @brief Method .ctor, addr 0x6759794, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Location, addr 0x67597bc, size 0x8, virtual false, abstract: false, final false
