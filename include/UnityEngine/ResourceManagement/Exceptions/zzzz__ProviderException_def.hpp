...
public:
  ...
  /// @brief Method .ctor, addr 0x47942d8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Location, addr 0x4794300, size 0x8, virtual false, abstract: false, final false
