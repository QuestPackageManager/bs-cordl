...
// Write type traits
MARK_REF_T(::UnityEngine::ResourceManagement::Exceptions::ProviderException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::ResourceManagement::Exceptions::ProviderException*, "UnityEngine.ResourceManagement.Exceptions", "ProviderException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x690c4a8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Location, addr 0x690c4d0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::ResourceManagement::Exceptions::ProviderException) == 0x98, "Size mismatch!");
