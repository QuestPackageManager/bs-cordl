...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::*)(::StringW, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*, ::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*, ::System::Exception*)>(&::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::_ctor)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x6759e84;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::*)()>(&::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::get_Message)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x6759eb0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult* (::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::*)()>(&::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::get_WebRequestResult)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6759ebc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::*)()>(&::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::ToString)> {
  constexpr static std::size_t size = 0x17c;
  constexpr static std::size_t addrs = 0x6759ec4;
...
constexpr ::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*& UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::__cordl_internal_get__WebRequestResult_k__BackingField()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____WebRequestResult_k__BackingField;
}
constexpr ::UnityEngine::ResourceManagement::Util::UnityWebRequestResult* const& UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::__cordl_internal_get__WebRequestResult_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____WebRequestResult_k__BackingField;
}
constexpr void UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::__cordl_internal_set__WebRequestResult_k__BackingField(::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::_ctor(::StringW  message, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location, ::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*  uwrResult, ::System::Exception*  innerException)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ResourceManagement::Exceptions::RemoteProviderException*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
