...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3, "UnityEngine.ParticleSystemJobs", "NativeParticleData/Array3");
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemJobs::NativeParticleData_Array4, "UnityEngine.ParticleSystemJobs", "NativeParticleData/Array4");
// Dependencies
namespace UnityEngine::ParticleSystemJobs {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::UnityEngine::ParticleSystemJobs::NativeParticleData_Array4) == 0x20, "Size mismatch!");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "count", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "positions", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "velocities", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "axisOfRotations", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "rotations", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "rotationalSpeeds", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "sizes", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array3", modifiers: "", def_value: None, comment: None }, CppParam { name: "startColors", ty: "void*", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "aliveTimePercent", ty: "void*", modifiers: "", def_value: None, comment: None }, CppParam { name: "inverseStartLifetimes", ty: "void*", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "randomSeeds", ty: "void*", modifiers: "", def_value: None, comment: None }, CppParam { name: "customData1", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array4", modifiers: "", def_value: None, comment: None }, CppParam { name: "customData2", ty:
  // "::UnityEngine::ParticleSystemJobs::NativeParticleData_Array4", modifiers: "", def_value: None, comment: None }, CppParam { name: "meshIndices", ty: "void*", modifiers: "", def_value: None,
  // comment: None }]
