...
/// @brief Method GetRayIntersection, addr 0x69a5974, size 0xb4, virtual false, abstract: false, final false
static inline ::UnityEngine::RaycastHit2D GetRayIntersection(::UnityEngine::Ray  ray, float_t  distance, int32_t  layerMask) ;

/// @brief Method GetRayIntersectionAll, addr 0x69a5a28, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::RaycastHit2D,::Array<::UnityEngine::RaycastHit2D>*> GetRayIntersectionAll(::UnityEngine::Ray  ray) ;

/// @brief Method GetRayIntersectionAll, addr 0x69a5c08, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetRayIntersectionAll, addr 0x69a5c80, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method GetRayIntersectionAll_Internal, addr 0x69a5a98, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetRayIntersectionAll_Internal_Injected, addr 0x69a5d04, size 0x7c, virtual false, abstract: false, final false
static inline void GetRayIntersectionAll_Internal_Injected(::ByRef<::UnityEngine::PhysicsScene2D>  physicsScene, ::ByRef<::UnityEngine::Vector3>  origin, ::ByRef<::UnityEngine::Vector3>  direction, float_t  distance, int32_t  layerMask, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper>  ret) ;

/// @brief Method GetRayIntersectionNonAlloc, addr 0x69a5e0c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetRayIntersectionNonAlloc, addr 0x69a5e8c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetRayIntersectionNonAlloc, addr 0x69a5d80, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a5254, size 0xe4, virtual false, abstract: false, final false
static inline ::UnityEngine::RaycastHit2D Raycast(::UnityEngine::Vector2  origin, ::UnityEngine::Vector2  direction) ;

/// @brief Method Raycast, addr 0x69a5338, size 0xe4, virtual false, abstract: false, final false
static inline ::UnityEngine::RaycastHit2D Raycast(::UnityEngine::Vector2  origin, ::UnityEngine::Vector2  direction, float_t  distance) ;

/// @brief Method Raycast, addr 0x69a541c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a551c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a561c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a5724, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a57e4, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x69a58ac, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method get_defaultPhysicsScene, addr 0x69a5224, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::PhysicsScene2D get_defaultPhysicsScene() ;

/// @brief Method get_queriesHitTriggers, addr 0x69a522c, size 0x28, virtual false, abstract: false, final false
