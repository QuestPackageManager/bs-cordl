...
public:
  ...
  /// @brief Method GetRayIntersection, addr 0x3481e44, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::RaycastHit2D GetRayIntersection(::UnityEngine::Ray ray, float_t distance, int32_t layerMask);

  /// @brief Method GetRayIntersectionAll, addr 0x3481f04, size 0xac, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::RaycastHit2D, ::Array<::UnityEngine::RaycastHit2D>*> GetRayIntersectionAll(::UnityEngine::Ray ray);

  /// @brief Method GetRayIntersectionAll, addr 0x3482060, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionAll, addr 0x348210c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionAll_Internal, addr 0x3481fb0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionAll_Internal_Injected, addr 0x34821c4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionNonAlloc, addr 0x3482230, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionNonAlloc, addr 0x34822c8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionNonAlloc, addr 0x3482368, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x3481714, size 0xc4, virtual false, abstract: false, final false
  static inline ::UnityEngine::RaycastHit2D Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction);

  /// @brief Method Raycast, addr 0x34817d8, size 0xcc, virtual false, abstract: false, final false
  static inline ::UnityEngine::RaycastHit2D Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, float_t distance);

  /// @brief Method Raycast, addr 0x34818a4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x34819c0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x3481adc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x3481c00, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x3481cbc, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, ::UnityEngine::ContactFilter2D contactFilter,
                                ::ArrayW<::UnityEngine::RaycastHit2D, ::Array<::UnityEngine::RaycastHit2D>*> results, float_t distance);

  /// @brief Method Raycast, addr 0x3481d80, size 0xc4, virtual false, abstract: false, final false
  static inline int32_t Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, ::UnityEngine::ContactFilter2D contactFilter,
  ...
  /// @brief Method get_defaultPhysicsScene, addr 0x34816e4, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::PhysicsScene2D get_defaultPhysicsScene();

  /// @brief Method get_queriesHitTriggers, addr 0x34816ec, size 0x28, virtual false, abstract: false, final false
