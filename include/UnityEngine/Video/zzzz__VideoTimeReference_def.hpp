...
DEFINE_IL2CPP_CLASS(::UnityEngine::Video::VideoTimeReference, "UnityEngine.Video", "VideoTimeReference");
// Dependencies
namespace UnityEngine::Video {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Video::VideoTimeReference) == 0x4, "Size mismatch!");
