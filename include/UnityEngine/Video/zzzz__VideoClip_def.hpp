...
/// @brief Method GetAudioChannelCount, addr 0x6c62010, size 0x90, virtual false, abstract: false, final false
inline uint16_t GetAudioChannelCount(uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioChannelCount_Injected, addr 0x6c620a0, size 0x44, virtual false, abstract: false, final false
static inline uint16_t GetAudioChannelCount_Injected(::System::IntPtr  _unity_self, uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioLanguage, addr 0x6c621b8, size 0x140, virtual false, abstract: false, final false
inline ::StringW GetAudioLanguage(uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioLanguage_Injected, addr 0x6c622f8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetAudioSampleRate, addr 0x6c620e4, size 0x90, virtual false, abstract: false, final false
inline uint32_t GetAudioSampleRate(uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioSampleRate_Injected, addr 0x6c62174, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c617a4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_audioTrackCount, addr 0x6c61f54, size 0x80, virtual false, abstract: false, final false
inline uint16_t get_audioTrackCount() ;

/// @brief Method get_audioTrackCount_Injected, addr 0x6c61fd4, size 0x3c, virtual false, abstract: false, final false
static inline uint16_t get_audioTrackCount_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_frameCount, addr 0x6c61974, size 0x80, virtual false, abstract: false, final false
inline uint64_t get_frameCount() ;

/// @brief Method get_frameCount_Injected, addr 0x6c619f4, size 0x3c, virtual false, abstract: false, final false
static inline uint64_t get_frameCount_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_frameRate, addr 0x6c61a30, size 0x80, virtual false, abstract: false, final false
inline double_t get_frameRate() ;

/// @brief Method get_frameRate_Injected, addr 0x6c61ab0, size 0x3c, virtual false, abstract: false, final false
static inline double_t get_frameRate_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_height, addr 0x6c61c64, size 0x80, virtual false, abstract: false, final false
inline uint32_t get_height() ;

/// @brief Method get_height_Injected, addr 0x6c61ce4, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t get_height_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_length, addr 0x6c61aec, size 0x80, virtual false, abstract: false, final false
inline double_t get_length() ;

/// @brief Method get_length_Injected, addr 0x6c61b6c, size 0x3c, virtual false, abstract: false, final false
static inline double_t get_length_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_originalPath, addr 0x6c617fc, size 0x134, virtual false, abstract: false, final false
inline ::StringW get_originalPath() ;

/// @brief Method get_originalPath_Injected, addr 0x6c61930, size 0x44, virtual false, abstract: false, final false
static inline void get_originalPath_Injected(::System::IntPtr  _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  ret) ;

/// @brief Method get_pixelAspectRatioDenominator, addr 0x6c61ddc, size 0x80, virtual false, abstract: false, final false
inline uint32_t get_pixelAspectRatioDenominator() ;

/// @brief Method get_pixelAspectRatioDenominator_Injected, addr 0x6c61e5c, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t get_pixelAspectRatioDenominator_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_pixelAspectRatioNumerator, addr 0x6c61d20, size 0x80, virtual false, abstract: false, final false
inline uint32_t get_pixelAspectRatioNumerator() ;

/// @brief Method get_pixelAspectRatioNumerator_Injected, addr 0x6c61da0, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t get_pixelAspectRatioNumerator_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_sRGB, addr 0x6c61e98, size 0x80, virtual false, abstract: false, final false
inline bool get_sRGB() ;

/// @brief Method get_sRGB_Injected, addr 0x6c61f18, size 0x3c, virtual false, abstract: false, final false
static inline bool get_sRGB_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_width, addr 0x6c61ba8, size 0x80, virtual false, abstract: false, final false
inline uint32_t get_width() ;

/// @brief Method get_width_Injected, addr 0x6c61c28, size 0x3c, virtual false, abstract: false, final false
