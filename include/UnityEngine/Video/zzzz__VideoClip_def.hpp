...
public:
  ...
  /// @brief Method .ctor addr 0x2d482e8 size 0x58 virtual false final false
  inline void _ctor();

  /// @brief Method get_originalPath addr 0x2d48340 size 0x3c virtual false final false
  inline ::StringW get_originalPath();

  /// @brief Method get_frameCount addr 0x2d4837c size 0x3c virtual false final false
  inline uint64_t get_frameCount();

  /// @brief Method get_frameRate addr 0x2d483b8 size 0x3c virtual false final false
  inline double_t get_frameRate();

  /// @brief Method get_length addr 0x2d483f4 size 0x3c virtual false final false
  inline double_t get_length();

  /// @brief Method get_width addr 0x2d48430 size 0x3c virtual false final false
  inline uint32_t get_width();

  /// @brief Method get_height addr 0x2d4846c size 0x3c virtual false final false
  inline uint32_t get_height();

  /// @brief Method get_pixelAspectRatioNumerator addr 0x2d484a8 size 0x3c virtual false final false
  inline uint32_t get_pixelAspectRatioNumerator();

  /// @brief Method get_pixelAspectRatioDenominator addr 0x2d484e4 size 0x3c virtual false final false
  inline uint32_t get_pixelAspectRatioDenominator();

  /// @brief Method get_sRGB addr 0x2d48520 size 0x3c virtual false final false
  inline bool get_sRGB();

  /// @brief Method get_audioTrackCount addr 0x2d4855c size 0x3c virtual false final false
  inline uint16_t get_audioTrackCount();

  /// @brief Method GetAudioChannelCount addr 0x2d48598 size 0x44 virtual false final false
  inline uint16_t GetAudioChannelCount(uint16_t audioTrackIdx);

  /// @brief Method GetAudioSampleRate addr 0x2d485dc size 0x44 virtual false final false
  inline uint32_t GetAudioSampleRate(uint16_t audioTrackIdx);

  /// @brief Method GetAudioLanguage addr 0x2d48620 size 0x44 virtual false final false
