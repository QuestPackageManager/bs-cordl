...
public:
  ...
  /// @brief Method set_text, addr 0x2d4f1e4, size 0x44, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method get_alignment, addr 0x2d4f228, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::TextAlignment get_alignment();

  /// @brief Method set_alignment, addr 0x2d4f264, size 0x44, virtual false, abstract: false, final false
