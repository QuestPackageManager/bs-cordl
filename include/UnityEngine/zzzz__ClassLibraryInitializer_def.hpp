...
public:
  ...
  /// @brief Method <InitAssemblyRedirections>b__2_0, addr 0x48b57f4, size 0x108, virtual false, abstract: false, final false
  inline ::System::Reflection::Assembly* _InitAssemblyRedirections_b__2_0(::System::Object* _, ::System::ResolveEventArgs* args);

  /// @brief Method .ctor, addr 0x48b57ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x48b556c, size 0x8, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method InitAssemblyRedirections, addr 0x48b569c, size 0xf4, virtual false, abstract: false, final false
  static inline void InitAssemblyRedirections();

  /// @brief Method InitStdErrWithHandle, addr 0x48b5574, size 0x128, virtual false, abstract: false, final false
