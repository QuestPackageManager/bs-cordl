...
public:
  ...
  /// @brief Method <InitAssemblyRedirections>b__2_0, addr 0x48a9434, size 0x108, virtual false, abstract: false, final false
  inline ::System::Reflection::Assembly* _InitAssemblyRedirections_b__2_0(::System::Object* _, ::System::ResolveEventArgs* args);

  /// @brief Method .ctor, addr 0x48a942c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x48a91ac, size 0x8, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method InitAssemblyRedirections, addr 0x48a92dc, size 0xf4, virtual false, abstract: false, final false
  static inline void InitAssemblyRedirections();

  /// @brief Method InitStdErrWithHandle, addr 0x48a91b4, size 0x128, virtual false, abstract: false, final false
