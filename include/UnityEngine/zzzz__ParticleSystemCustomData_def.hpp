...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemCustomData, "UnityEngine", "ParticleSystemCustomData");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemCustomData) == 0x4, "Size mismatch!");
