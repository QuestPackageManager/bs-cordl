...
public:
// Declarations
/// @brief Method Invoke, addr 0x699579c, size 0xcc, virtual false, abstract: false, final false
inline void Invoke() ;

/// @brief Method .ctor, addr 0x6995398, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field m_AsyncWorkQueue, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AsyncWorkQueue, put=__cordl_internal_set_m_AsyncWorkQueue)) ::System::Collections::Generic::List_1<::UnityEngine::UnitySynchronizationContext_WorkRequest>*  m_AsyncWorkQueue;

/// @brief Field m_CurrentFrameWork, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CurrentFrameWork, put=__cordl_internal_set_m_CurrentFrameWork)) ::System::Collections::Generic::List_1<::UnityEngine::UnitySynchronizationContext_WorkRequest>*  m_CurrentFrameWork;
...
/// @brief Method CreateCopy, addr 0x699553c, size 0x68, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method Exec, addr 0x69955a4, size 0x1f8, virtual false, abstract: false, final false
inline void Exec() ;

/// @brief Method ExecutePendingTasks, addr 0x69959e4, size 0xe4, virtual false, abstract: false, final false
static inline bool ExecutePendingTasks(int64_t  millisecondsTimeout) ;

/// @brief Method ExecuteTasks, addr 0x699597c, size 0x68, virtual false, abstract: false, final false
static inline void ExecuteTasks() ;

/// @brief Method HasPendingTasks, addr 0x6995868, size 0x68, virtual false, abstract: false, final false
inline bool HasPendingTasks() ;

/// @brief Method InitializeSynchronizationContext, addr 0x69958d0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method OperationCompleted, addr 0x69953c0, size 0x1c, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x69953a4, size 0x1c, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x69953dc, size 0x160, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  callback, ::System::Object*  state) ;

/// @brief Method Send, addr 0x69950c4, size 0x2d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6994f90, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(int32_t  mainThreadID) ;

/// @brief Method .ctor, addr 0x6995038, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_MainThreadId, addr 0x6994f88, size 0x8, virtual false, abstract: false, final false
