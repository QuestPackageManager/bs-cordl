...
DEFINE_IL2CPP_CLASS(::UnityEngine::UnitySynchronizationContext_WorkRequest, "UnityEngine", "UnitySynchronizationContext/WorkRequest");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6ae8848, size 0xcc, virtual false, abstract: false, final false
  inline void Invoke();

  /// @brief Method .ctor, addr 0x6ae8444, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UnitySynchronizationContext_WorkRequest) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateCopy, addr 0x6ae85e8, size 0x68, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method Exec, addr 0x6ae8650, size 0x1f8, virtual false, abstract: false, final false
  inline void Exec();

  /// @brief Method ExecutePendingTasks, addr 0x6ae8a90, size 0xe4, virtual false, abstract: false, final false
  static inline bool ExecutePendingTasks(int64_t millisecondsTimeout);

  /// @brief Method ExecuteTasks, addr 0x6ae8a28, size 0x68, virtual false, abstract: false, final false
  static inline void ExecuteTasks();

  /// @brief Method HasPendingTasks, addr 0x6ae8914, size 0x68, virtual false, abstract: false, final false
  inline bool HasPendingTasks();

  /// @brief Method InitializeSynchronizationContext, addr 0x6ae897c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OperationCompleted, addr 0x6ae846c, size 0x1c, virtual true, abstract: false, final false
  inline void OperationCompleted();

  /// @brief Method OperationStarted, addr 0x6ae8450, size 0x1c, virtual true, abstract: false, final false
  inline void OperationStarted();

  /// @brief Method Post, addr 0x6ae8488, size 0x160, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* callback, ::System::Object* state);

  /// @brief Method Send, addr 0x6ae8170, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ae803c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t mainThreadID);

  /// @brief Method .ctor, addr 0x6ae80e4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MainThreadId, addr 0x6ae8034, size 0x8, virtual false, abstract: false, final false
