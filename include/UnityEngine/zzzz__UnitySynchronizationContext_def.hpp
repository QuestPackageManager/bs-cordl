...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x68b84c4, size 0xcc, virtual false, abstract: false, final false
  inline void Invoke();

  /// @brief Method .ctor, addr 0x68b80c0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateCopy, addr 0x68b8264, size 0x68, virtual true, abstract: false, final false
  inline ::System::Threading::SynchronizationContext* CreateCopy();

  /// @brief Method Exec, addr 0x68b82cc, size 0x1f8, virtual false, abstract: false, final false
  inline void Exec();

  /// @brief Method ExecutePendingTasks, addr 0x68b870c, size 0xe4, virtual false, abstract: false, final false
  static inline bool ExecutePendingTasks(int64_t millisecondsTimeout);

  /// @brief Method ExecuteTasks, addr 0x68b86a4, size 0x68, virtual false, abstract: false, final false
  static inline void ExecuteTasks();

  /// @brief Method HasPendingTasks, addr 0x68b8590, size 0x68, virtual false, abstract: false, final false
  inline bool HasPendingTasks();

  /// @brief Method InitializeSynchronizationContext, addr 0x68b85f8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OperationCompleted, addr 0x68b80e8, size 0x1c, virtual true, abstract: false, final false
  inline void OperationCompleted();

  /// @brief Method OperationStarted, addr 0x68b80cc, size 0x1c, virtual true, abstract: false, final false
  inline void OperationStarted();

  /// @brief Method Post, addr 0x68b8104, size 0x160, virtual true, abstract: false, final false
  inline void Post(::System::Threading::SendOrPostCallback* callback, ::System::Object* state);

  /// @brief Method Send, addr 0x68b7dec, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68b7cb8, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t mainThreadID);

  /// @brief Method .ctor, addr 0x68b7d60, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MainThreadId, addr 0x68b7cb0, size 0x8, virtual false, abstract: false, final false
