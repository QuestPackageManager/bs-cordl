...
public:
// Declarations
/// @brief Method Invoke, addr 0x6921a08, size 0xcc, virtual false, abstract: false, final false
inline void Invoke() ;

/// @brief Method .ctor, addr 0x6921604, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method CreateCopy, addr 0x69217a8, size 0x68, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method Exec, addr 0x6921810, size 0x1f8, virtual false, abstract: false, final false
inline void Exec() ;

/// @brief Method ExecutePendingTasks, addr 0x6921c50, size 0xe4, virtual false, abstract: false, final false
static inline bool ExecutePendingTasks(int64_t  millisecondsTimeout) ;

/// @brief Method ExecuteTasks, addr 0x6921be8, size 0x68, virtual false, abstract: false, final false
static inline void ExecuteTasks() ;

/// @brief Method HasPendingTasks, addr 0x6921ad4, size 0x68, virtual false, abstract: false, final false
inline bool HasPendingTasks() ;

/// @brief Method InitializeSynchronizationContext, addr 0x6921b3c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method OperationCompleted, addr 0x692162c, size 0x1c, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x6921610, size 0x1c, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x6921648, size 0x160, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  callback, ::System::Object*  state) ;

/// @brief Method Send, addr 0x6921330, size 0x2d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69211fc, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(int32_t  mainThreadID) ;

/// @brief Method .ctor, addr 0x69212a4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_MainThreadId, addr 0x69211f4, size 0x8, virtual false, abstract: false, final false
