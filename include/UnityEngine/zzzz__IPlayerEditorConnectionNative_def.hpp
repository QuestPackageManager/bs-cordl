...
// Write type traits
MARK_REF_T(::UnityEngine::IPlayerEditorConnectionNative*);
DEFINE_IL2CPP_CLASS(::UnityEngine::IPlayerEditorConnectionNative*, "UnityEngine", "IPlayerEditorConnectionNative");
// Dependencies
namespace UnityEngine {
// Is value type: false
