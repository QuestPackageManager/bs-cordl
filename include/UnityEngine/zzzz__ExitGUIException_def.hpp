...
public:
  ...
  /// @brief Method .ctor, addr 0x6918f00, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6912bf8, size 0xdc, virtual false, abstract: false, final false
