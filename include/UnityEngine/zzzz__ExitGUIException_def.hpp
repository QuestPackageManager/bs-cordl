...
public:
  ...
  /// @brief Method .ctor, addr 0x48e1474, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x48dd388, size 0xd0, virtual false, abstract: false, final false
