...
public:
  ...
  /// @brief Method .ctor, addr 0x6981d84, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x697ba7c, size 0xdc, virtual false, abstract: false, final false
