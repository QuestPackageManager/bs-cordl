...
public:
  ...
  /// @brief Method Finalize, addr 0x68cf948, size 0x78, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetProxyObject, addr 0x68d1dfc, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::AndroidJavaObject* GetProxyObject();

  /// @brief Method GetRawProxy, addr 0x68d1cd8, size 0xbc, virtual false, abstract: false, final false
  inline ::System::IntPtr GetRawProxy();

  /// @brief Method Invoke, addr 0x68cf5c0, size 0x37c, virtual true, abstract: false, final false
  inline ::System::IntPtr Invoke(::StringW methodName, ::System::IntPtr javaArgs);

  /// @brief Method Invoke, addr 0x68cf9c0, size 0x94c, virtual true, abstract: false, final false
  inline ::UnityEngine::AndroidJavaObject* Invoke(::StringW methodName, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method Invoke, addr 0x68d0e3c, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68cf488, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW javaInterface);

  /// @brief Method .ctor, addr 0x68cf940, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::AndroidJavaClass* javaInterface);

  /// @brief Method equals, addr 0x68d1b7c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method hashCode, addr 0x68d1bd4, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method toString, addr 0x68d1d94, size 0x68, virtual true, abstract: false, final false
