...
public:
  ...
  /// @brief Method Add, addr 0x69a3fcc, size 0x8, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::Transform* transform);

  /// @brief Method Add, addr 0x69a3fd4, size 0x90, virtual false, abstract: false, final false
  static inline void Add(::System::IntPtr transformArrayIntPtr, ::UnityEngine::Transform* transform);

  /// @brief Method Add_Injected, addr 0x69a40ec, size 0x44, virtual false, abstract: false, final false
  static inline void Add_Injected(::System::IntPtr transformArrayIntPtr, ::System::IntPtr transform);

  /// @brief Method Allocate, addr 0x69a3c8c, size 0x88, virtual false, abstract: false, final false
  static inline void Allocate(int32_t capacity, int32_t desiredJobCount, ::ByRef<::UnityEngine::Jobs::TransformAccessArray> array);

  /// @brief Method Create, addr 0x69a3d14, size 0x44, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(int32_t capacity, int32_t desiredJobCount);

  /// @brief Method DestroyTransformAccessArray, addr 0x69a3de0, size 0x3c, virtual false, abstract: false, final false
  static inline void DestroyTransformAccessArray(::System::IntPtr transformArray);

  /// @brief Method Dispose, addr 0x69a3d68, size 0x78, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetLength, addr 0x69a3f90, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GetLength(::System::IntPtr transformArrayIntPtr);

  /// @brief Method GetSortedToUserIndex, addr 0x69a416c, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetSortedToUserIndex(::System::IntPtr transformArrayIntPtr);

  /// @brief Method GetSortedTransformAccess, addr 0x69a4130, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetSortedTransformAccess(::System::IntPtr transformArrayIntPtr);

  /// @brief Method GetTransform, addr 0x69a3e2c, size 0x128, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> GetTransform(::System::IntPtr transformArrayIntPtr, int32_t index);

  /// @brief Method GetTransformAccessArrayForSchedule, addr 0x69a3e1c, size 0x8, virtual false, abstract: false, final false
  inline ::System::IntPtr GetTransformAccessArrayForSchedule();

  /// @brief Method GetTransform_Injected, addr 0x69a41a8, size 0x44, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetTransform_Injected(::System::IntPtr transformArrayIntPtr, int32_t index);

  /// @brief Method RemoveAtSwapBack, addr 0x69a4064, size 0x44, virtual false, abstract: false, final false
  inline void RemoveAtSwapBack(int32_t index);

  /// @brief Method RemoveAtSwapBack, addr 0x69a40a8, size 0x44, virtual false, abstract: false, final false
  static inline void RemoveAtSwapBack(::System::IntPtr transformArrayIntPtr, int32_t index);

  /// @brief Method .ctor, addr 0x69a3c78, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity, int32_t desiredJobCount);

  /// @brief Method get_Item, addr 0x69a3e24, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_Item(int32_t index);

  /// @brief Method get_isCreated, addr 0x69a3d58, size 0x10, virtual false, abstract: false, final false
  inline bool get_isCreated();

  /// @brief Method get_length, addr 0x69a3f54, size 0x3c, virtual false, abstract: false, final false
