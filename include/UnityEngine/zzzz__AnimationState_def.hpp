...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x6868c84, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6868c80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_clip, addr 0x686809c, size 0x13c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AnimationClip> get_clip() ;

/// @brief Method get_clip_Injected, addr 0x6868c44, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr get_clip_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method set_normalizedTime, addr 0x6868aec, size 0x60, virtual false, abstract: false, final false
inline void set_normalizedTime(float_t  value) ;

/// @brief Method set_normalizedTime_Injected, addr 0x6868b4c, size 0x4c, virtual false, abstract: false, final false
static inline void set_normalizedTime_Injected(::System::IntPtr  _unity_self, float_t  value) ;

/// @brief Method set_speed, addr 0x6868b98, size 0x60, virtual false, abstract: false, final false
inline void set_speed(float_t  value) ;

/// @brief Method set_speed_Injected, addr 0x6868bf8, size 0x4c, virtual false, abstract: false, final false
static inline void set_speed_Injected(::System::IntPtr  _unity_self, float_t  value) ;

/// @brief Method set_time, addr 0x6868a40, size 0x60, virtual false, abstract: false, final false
inline void set_time(float_t  value) ;

/// @brief Method set_time_Injected, addr 0x6868aa0, size 0x4c, virtual false, abstract: false, final false
