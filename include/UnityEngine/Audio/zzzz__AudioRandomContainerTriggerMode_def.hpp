...
DEFINE_IL2CPP_CLASS(::UnityEngine::Audio::AudioRandomContainerTriggerMode, "UnityEngine.Audio", "AudioRandomContainerTriggerMode");
// Dependencies
namespace UnityEngine::Audio {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Audio::AudioRandomContainerTriggerMode) == 0x4, "Size mismatch!");
