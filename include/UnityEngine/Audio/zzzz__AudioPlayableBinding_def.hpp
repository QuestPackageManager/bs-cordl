...
public:
// Declarations
/// @brief Method Create, addr 0x68886ec, size 0xfc, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::PlayableBinding Create(::StringW  name, ::UnityEngine::Object*  key) ;

/// @brief Method CreateAudioOutput, addr 0x68887e8, size 0x8, virtual false, abstract: false, final false
