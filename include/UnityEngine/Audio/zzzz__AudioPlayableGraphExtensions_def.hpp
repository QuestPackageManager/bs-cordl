...
public:
  // Declarations
  /// @brief Method InternalCreateAudioOutput, addr 0x68fa860, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalCreateAudioOutput_Injected, addr 0x68fa9a8, size 0x54, virtual false, abstract: false, final false
