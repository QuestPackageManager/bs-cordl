...
public:
  // Declarations
  /// @brief Method InternalCreateAudioOutput, addr 0x6a53228, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalCreateAudioOutput_Injected, addr 0x6a53370, size 0x54, virtual false, abstract: false, final false
