...
public:
  ...
  /// @brief Method Create addr 0x2b382b8 size 0x3c virtual false final false
  ...
  /// @brief Method CreateHandle addr 0x2b382f4 size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b383d0 size 0xc0 virtual false final false
  inline void _ctor(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method GetHandle addr 0x2b384e4 size 0xc virtual true final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method op_Implicit addr 0x2b384f0 size 0x30 virtual false final false
  ...
  /// @brief Method Equals addr 0x2b38520 size 0x78 virtual true final true
  inline bool Equals(::UnityEngine::Audio::AudioMixerPlayable other);

  /// @brief Method CreateAudioMixerPlayableInternal addr 0x2b38490 size 0x54 virtual false final false
