...
public:
  ...
  /// @brief Method .ctor, addr 0x2c9d0f8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Playables::PlayableHandle handle);

  /// @brief Method GetHandle, addr 0x2c9d20c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method op_Implicit, addr 0x2c9d218, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2c9d248, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Audio::AudioMixerPlayable other);

  /// @brief Method CreateAudioMixerPlayableInternal, addr 0x2c9d1b8, size 0x54, virtual false, abstract: false, final false
