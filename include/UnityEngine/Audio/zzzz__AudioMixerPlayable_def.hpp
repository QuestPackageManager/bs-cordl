...
public:
  ...
  /// @brief Method Create, addr 0x6887bb8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAudioMixerPlayableInternal, addr 0x6887e08, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x6887bf0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x6887eec, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Audio::AudioMixerPlayable other);

  /// @brief Method GetHandle, addr 0x6887e5c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x6887cf4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x6887e6c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6887e68, size 0x4, virtual false, abstract: false, final false
