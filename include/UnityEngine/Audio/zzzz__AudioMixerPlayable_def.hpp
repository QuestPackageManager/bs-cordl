...
public:
  ...
  /// @brief Method Create, addr 0x33fdbac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAudioMixerPlayableInternal, addr 0x33fdd84, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateHandle, addr 0x33fdbe8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x33fde58, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Audio::AudioMixerPlayable other);

  /// @brief Method GetHandle, addr 0x33fddd8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::PlayableHandle GetHandle();

  /// @brief Method .ctor, addr 0x33fdcc4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x33fde14, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x33fdde4, size 0x30, virtual false, abstract: false, final false
