...
// Write type traits
MARK_REF_T(::UnityEngine::Audio::AudioManagerTestProxy*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Audio::AudioManagerTestProxy*, "UnityEngine.Audio", "AudioManagerTestProxy");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AudioManagerTestProxy", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AudioManagerTestProxy(AudioManagerTestProxy&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AudioManagerTestProxy", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AudioManagerTestProxy(AudioManagerTestProxyconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Audio::AudioManagerTestProxy) == 0x10, "Size mismatch!");
