...
public:
  ...
  /// @brief Method TransitionTo, addr 0x68fa6c8, size 0x30, virtual false, abstract: false, final false
  inline void TransitionTo(float_t timeToReach);

  /// @brief Method .ctor, addr 0x68fa634, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioMixer, addr 0x68f94ac, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Audio::AudioMixer> get_audioMixer();

  /// @brief Method get_audioMixer_Injected, addr 0x68fa68c, size 0x3c, virtual false, abstract: false, final false
