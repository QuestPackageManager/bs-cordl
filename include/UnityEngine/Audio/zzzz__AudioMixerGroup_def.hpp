...
/// @brief Method .ctor, addr 0x6888094, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_audioMixer, addr 0x68880ec, size 0x150, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Audio::AudioMixer> get_audioMixer() ;

/// @brief Method get_audioMixer_Injected, addr 0x688823c, size 0x3c, virtual false, abstract: false, final false
