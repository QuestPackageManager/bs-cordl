...
DEFINE_IL2CPP_CLASS(::UnityEngine::Audio::AudioMixerUpdateMode, "UnityEngine.Audio", "AudioMixerUpdateMode");
// Dependencies
namespace UnityEngine::Audio {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Audio::AudioMixerUpdateMode) == 0x4, "Size mismatch!");
