...
DEFINE_IL2CPP_CLASS(::UnityEngine::Audio::AudioRandomContainerLoopMode, "UnityEngine.Audio", "AudioRandomContainerLoopMode");
// Dependencies
namespace UnityEngine::Audio {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Audio::AudioRandomContainerLoopMode) == 0x4, "Size mismatch!");
