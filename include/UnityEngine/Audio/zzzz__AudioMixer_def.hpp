...
public:
  ...
  /// @brief Method ClearFloat, addr 0x68f9c0c, size 0x178, virtual false, abstract: false, final false
  inline bool ClearFloat(::StringW name);

  /// @brief Method ClearFloat_Injected, addr 0x68f9d84, size 0x44, virtual false, abstract: false, final false
  static inline bool ClearFloat_Injected(::System::IntPtr _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> name);

  /// @brief Method FindMatchingGroups, addr 0x68f90f8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method FindMatchingGroups_Injected, addr 0x68f926c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method FindSnapshot, addr 0x68f8e1c, size 0x298, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Audio::AudioMixerSnapshot> FindSnapshot(::StringW name);

  /// @brief Method FindSnapshot_Injected, addr 0x68f90b4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAbsoluteAudibilityFromGroup, addr 0x68f9f9c, size 0xc0, virtual false, abstract: false, final false
  inline float_t GetAbsoluteAudibilityFromGroup(::UnityEngine::Audio::AudioMixerGroup* group);

  /// @brief Method GetAbsoluteAudibilityFromGroup_Injected, addr 0x68fa05c, size 0x44, virtual false, abstract: false, final false
  static inline float_t GetAbsoluteAudibilityFromGroup_Injected(::System::IntPtr _unity_self, ::System::IntPtr group);

  /// @brief Method GetFloat, addr 0x68f9dc8, size 0x180, virtual false, abstract: false, final false
  inline bool GetFloat(::StringW name, ::ByRef<float_t> value);

  /// @brief Method GetFloat_Injected, addr 0x68f9f48, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFloat, addr 0x68f9a30, size 0x188, virtual false, abstract: false, final false
  inline bool SetFloat(::StringW name, float_t value);

  /// @brief Method SetFloat_Injected, addr 0x68f9bb8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionToSnapshot, addr 0x68f92b0, size 0x1fc, virtual false, abstract: false, final false
  inline void TransitionToSnapshot(::UnityEngine::Audio::AudioMixerSnapshot* snapshot, float_t timeToReach);

  /// @brief Method TransitionToSnapshotInternal, addr 0x68f95fc, size 0xd0, virtual false, abstract: false, final false
  inline void TransitionToSnapshotInternal(::UnityEngine::Audio::AudioMixerSnapshot* snapshot, float_t timeToReach);

  /// @brief Method TransitionToSnapshotInternal_Injected, addr 0x68f96cc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionToSnapshots, addr 0x68f9720, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionToSnapshots_Injected, addr 0x68f983c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68f8b34, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_outputAudioMixerGroup, addr 0x68f8b8c, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Audio::AudioMixerGroup> get_outputAudioMixerGroup();

  /// @brief Method get_outputAudioMixerGroup_Injected, addr 0x68f8cdc, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_outputAudioMixerGroup_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_updateMode, addr 0x68f98a0, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::Audio::AudioMixerUpdateMode get_updateMode();

  /// @brief Method get_updateMode_Injected, addr 0x68f9920, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Audio::AudioMixerUpdateMode get_updateMode_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_outputAudioMixerGroup, addr 0x68f8d18, size 0xc0, virtual false, abstract: false, final false
  inline void set_outputAudioMixerGroup(::UnityEngine::Audio::AudioMixerGroup* value);

  /// @brief Method set_outputAudioMixerGroup_Injected, addr 0x68f8dd8, size 0x44, virtual false, abstract: false, final false
  static inline void set_outputAudioMixerGroup_Injected(::System::IntPtr _unity_self, ::System::IntPtr value);

  /// @brief Method set_updateMode, addr 0x68f995c, size 0x90, virtual false, abstract: false, final false
  inline void set_updateMode(::UnityEngine::Audio::AudioMixerUpdateMode value);

  /// @brief Method set_updateMode_Injected, addr 0x68f99ec, size 0x44, virtual false, abstract: false, final false
