...
public:
  ...
  /// @brief Method set_updateMode, addr 0x2c9c5b0, size 0x44, virtual false, abstract: false, final false
  inline void set_updateMode(::UnityEngine::Audio::AudioMixerUpdateMode value);

  /// @brief Method SetFloat, addr 0x2c9c5f4, size 0x54, virtual false, abstract: false, final false
  inline bool SetFloat(::StringW name, float_t value);

  /// @brief Method GetFloat, addr 0x2c9c648, size 0x54, virtual false, abstract: false, final false
