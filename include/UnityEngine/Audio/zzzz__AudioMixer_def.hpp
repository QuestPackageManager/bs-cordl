...
/// @brief Method ClearFloat, addr 0x6887c00, size 0x178, virtual false, abstract: false, final false
inline bool ClearFloat(::StringW  name) ;

/// @brief Method ClearFloat_Injected, addr 0x6887d78, size 0x44, virtual false, abstract: false, final false
static inline bool ClearFloat_Injected(::System::IntPtr  _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  name) ;

/// @brief Method FindMatchingGroups, addr 0x68870ec, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method FindMatchingGroups_Injected, addr 0x6887260, size 0x44, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityW<::UnityEngine::Audio::AudioMixerGroup>,::Array<::UnityW<::UnityEngine::Audio::AudioMixerGroup>>*> FindMatchingGroups_Injected(::System::IntPtr  _unity_self, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  subPath) ;

/// @brief Method FindSnapshot, addr 0x6886e10, size 0x298, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Audio::AudioMixerSnapshot> FindSnapshot(::StringW  name) ;

/// @brief Method FindSnapshot_Injected, addr 0x68870a8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetAbsoluteAudibilityFromGroup, addr 0x6887f90, size 0xc0, virtual false, abstract: false, final false
inline float_t GetAbsoluteAudibilityFromGroup(::UnityEngine::Audio::AudioMixerGroup*  group) ;

/// @brief Method GetAbsoluteAudibilityFromGroup_Injected, addr 0x6888050, size 0x44, virtual false, abstract: false, final false
static inline float_t GetAbsoluteAudibilityFromGroup_Injected(::System::IntPtr  _unity_self, ::System::IntPtr  group) ;

/// @brief Method GetFloat, addr 0x6887dbc, size 0x180, virtual false, abstract: false, final false
inline bool GetFloat(::StringW  name, ::ByRef<float_t>  value) ;

/// @brief Method GetFloat_Injected, addr 0x6887f3c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SetFloat, addr 0x6887a24, size 0x188, virtual false, abstract: false, final false
inline bool SetFloat(::StringW  name, float_t  value) ;

/// @brief Method SetFloat_Injected, addr 0x6887bac, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method TransitionToSnapshot, addr 0x68872a4, size 0x1fc, virtual false, abstract: false, final false
inline void TransitionToSnapshot(::UnityEngine::Audio::AudioMixerSnapshot*  snapshot, float_t  timeToReach) ;

/// @brief Method TransitionToSnapshotInternal, addr 0x68875f0, size 0xd0, virtual false, abstract: false, final false
inline void TransitionToSnapshotInternal(::UnityEngine::Audio::AudioMixerSnapshot*  snapshot, float_t  timeToReach) ;

/// @brief Method TransitionToSnapshotInternal_Injected, addr 0x68876c0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method TransitionToSnapshots, addr 0x6887714, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method TransitionToSnapshots_Injected, addr 0x6887830, size 0x64, virtual false, abstract: false, final false
static inline void TransitionToSnapshots_Injected(::System::IntPtr  _unity_self, ::ArrayW<::UnityEngine::Audio::AudioMixerSnapshot*,::Array<::UnityEngine::Audio::AudioMixerSnapshot*>*>  snapshots, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  weights, float_t  timeToReach) ;

/// @brief Method .ctor, addr 0x6886b28, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_outputAudioMixerGroup, addr 0x6886b80, size 0x150, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Audio::AudioMixerGroup> get_outputAudioMixerGroup() ;

/// @brief Method get_outputAudioMixerGroup_Injected, addr 0x6886cd0, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr get_outputAudioMixerGroup_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_updateMode, addr 0x6887894, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Audio::AudioMixerUpdateMode get_updateMode() ;

/// @brief Method get_updateMode_Injected, addr 0x6887914, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityEngine::Audio::AudioMixerUpdateMode get_updateMode_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method set_outputAudioMixerGroup, addr 0x6886d0c, size 0xc0, virtual false, abstract: false, final false
inline void set_outputAudioMixerGroup(::UnityEngine::Audio::AudioMixerGroup*  value) ;

/// @brief Method set_outputAudioMixerGroup_Injected, addr 0x6886dcc, size 0x44, virtual false, abstract: false, final false
static inline void set_outputAudioMixerGroup_Injected(::System::IntPtr  _unity_self, ::System::IntPtr  value) ;

/// @brief Method set_updateMode, addr 0x6887950, size 0x90, virtual false, abstract: false, final false
inline void set_updateMode(::UnityEngine::Audio::AudioMixerUpdateMode  value) ;

/// @brief Method set_updateMode_Injected, addr 0x68879e0, size 0x44, virtual false, abstract: false, final false
