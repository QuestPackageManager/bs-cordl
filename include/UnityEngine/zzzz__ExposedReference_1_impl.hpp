...
// Ctor Parameters [CppParam { name: "exposedName", ty: "::UnityEngine::PropertyName", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "defaultValue", ty:
// "::UnityW<::UnityEngine::Object>", modifiers: "", def_value: Some("{}"), comment: None }]
