...
public:
  ...
  /// @brief Method MoveNext, addr 0x48add88, size 0xc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::CustomYieldInstruction* New_ctor();

  /// @brief Method Reset, addr 0x48add94, size 0x4, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method .ctor, addr 0x48add98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Current, addr 0x48add80, size 0x8, virtual true, abstract: false, final true
