...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "signature", ty: "::StringW", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "fnPtr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }]
