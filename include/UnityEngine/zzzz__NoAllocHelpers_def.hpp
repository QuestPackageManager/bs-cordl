...
public:
  ...
  /// @brief Method ExtractArrayFromList, addr 0x343b128, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_ResizeList, addr 0x343b0e4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeLength, addr 0x343b0d4, size 0x10, virtual false, abstract: false, final false
