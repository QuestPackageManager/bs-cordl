...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> ExtractArrayFromList(::System::Collections::Generic::List_1<T>*  list) ;
...
/// @brief Method SafeLength, addr 0x691bb40, size 0x10, virtual false, abstract: false, final false
