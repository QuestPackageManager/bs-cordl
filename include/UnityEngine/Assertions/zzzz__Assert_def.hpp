...
public:
  ...
  /// @brief Method AreEqual, addr 0x48d2a40, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method AreEqual, addr 0x48d2fdc, size 0x8c, virtual false, abstract: false, final false
  static inline void AreEqual(int32_t expected, int32_t actual);

  /// @brief Method Fail, addr 0x48d268c, size 0x120, virtual false, abstract: false, final false
  static inline void Fail(::StringW message, ::StringW userMessage);

  /// @brief Method IsFalse, addr 0x48d29c0, size 0x80, virtual false, abstract: false, final false
  static inline void IsFalse(bool condition, ::StringW message);

  /// @brief Method IsNotNull, addr 0x48d2f20, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x48d2cfc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTrue, addr 0x48d2820, size 0x6c, virtual false, abstract: false, final false
  static inline void IsTrue(bool condition);

  /// @brief Method IsTrue, addr 0x48d288c, size 0x80, virtual false, abstract: false, final false
