...
public:
  ...
  /// @brief Method AreEqual, addr 0x3451664, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method AreEqual, addr 0x34519e8, size 0x8c, virtual false, abstract: false, final false
  static inline void AreEqual(int32_t expected, int32_t actual);

  /// @brief Method AreNotEqual, addr 0x3451920, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Fail, addr 0x3451168, size 0x128, virtual false, abstract: false, final false
  static inline void Fail(::StringW message, ::StringW userMessage);

  /// @brief Method IsFalse, addr 0x3451290, size 0x80, virtual false, abstract: false, final false
  static inline void IsFalse(bool condition, ::StringW message);

  /// @brief Method IsNotNull, addr 0x3451534, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNull, addr 0x3451310, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsTrue, addr 0x3450fec, size 0x6c, virtual false, abstract: false, final false
  static inline void IsTrue(bool condition);

  /// @brief Method IsTrue, addr 0x3451058, size 0x80, virtual false, abstract: false, final false
