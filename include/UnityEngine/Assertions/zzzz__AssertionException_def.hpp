...
/// @brief Method .ctor, addr 0x693c1b8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  userMessage) ;

/// @brief Method get_Message, addr 0x693cba8, size 0x78, virtual true, abstract: false, final false
