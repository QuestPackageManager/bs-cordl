...
// Write type traits
MARK_REF_T(::UnityEngine::Assertions::AssertionException*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Assertions::AssertionException*, "UnityEngine.Assertions", "AssertionException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b06d54, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW userMessage);

  /// @brief Method get_Message, addr 0x6b07744, size 0x78, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssertionException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssertionException(AssertionException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssertionException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssertionException(AssertionExceptionconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Assertions::AssertionException) == 0x98, "Size mismatch!");
