...
public:
  ...
  /// @brief Method .ctor, addr 0x48d1c94, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, ::StringW userMessage);

  /// @brief Method get_Message, addr 0x48d259c, size 0x74, virtual true, abstract: false, final false
