...
public:
  // Declarations
  /// @brief Method EncodeToEXR, addr 0x69e47b4, size 0x160, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeToEXR(::UnityEngine::Texture2D* tex, ::UnityEngine::Texture2D_EXRFlags flags);

  /// @brief Method EncodeToEXR_Injected, addr 0x69e4914, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeToJPG, addr 0x69e47ac, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeToJPG(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToJPG, addr 0x69e45f8, size 0x160, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeToJPG(::UnityEngine::Texture2D* tex, int32_t quality);

  /// @brief Method EncodeToJPG_Injected, addr 0x69e4758, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeToPNG, addr 0x69e4468, size 0x14c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeToPNG(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToPNG_Injected, addr 0x69e45b4, size 0x44, virtual false, abstract: false, final false
  static inline void EncodeToPNG_Injected(::System::IntPtr tex, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method EncodeToTGA, addr 0x69e42d8, size 0x14c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncodeToTGA(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToTGA_Injected, addr 0x69e4424, size 0x44, virtual false, abstract: false, final false
  static inline void EncodeToTGA_Injected(::System::IntPtr tex, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method LoadImage, addr 0x69e4af0, size 0x8, virtual false, abstract: false, final false
  static inline bool LoadImage(::UnityEngine::Texture2D* tex, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method LoadImage, addr 0x69e4968, size 0x134, virtual false, abstract: false, final false
  static inline bool LoadImage(::UnityEngine::Texture2D* tex, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, bool markNonReadable);

  /// @brief Method LoadImage_Injected, addr 0x69e4a9c, size 0x54, virtual false, abstract: false, final false
