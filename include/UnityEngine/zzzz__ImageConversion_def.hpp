...
public:
  // Declarations
  /// @brief Method EncodeToEXR, addr 0x6b39e08, size 0x160, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeToEXR(::UnityEngine::Texture2D* tex, ::UnityEngine::Texture2D_EXRFlags flags);

  /// @brief Method EncodeToEXR_Injected, addr 0x6b39f68, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeToJPG, addr 0x6b39e00, size 0x8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeToJPG(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToJPG, addr 0x6b39c4c, size 0x160, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeToJPG(::UnityEngine::Texture2D* tex, int32_t quality);

  /// @brief Method EncodeToJPG_Injected, addr 0x6b39dac, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method EncodeToPNG, addr 0x6b39abc, size 0x14c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeToPNG(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToPNG_Injected, addr 0x6b39c08, size 0x44, virtual false, abstract: false, final false
  static inline void EncodeToPNG_Injected(::System::IntPtr tex, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method EncodeToTGA, addr 0x6b3992c, size 0x14c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> EncodeToTGA(::UnityEngine::Texture2D* tex);

  /// @brief Method EncodeToTGA_Injected, addr 0x6b39a78, size 0x44, virtual false, abstract: false, final false
  static inline void EncodeToTGA_Injected(::System::IntPtr tex, ::by_ref<::UnityEngine::Bindings::BlittableArrayWrapper> ret);

  /// @brief Method LoadImage, addr 0x6b3a144, size 0x8, virtual false, abstract: false, final false
  static inline bool LoadImage(::UnityEngine::Texture2D* tex, ::ArrayW<uint8_t> data);

  /// @brief Method LoadImage, addr 0x6b39fbc, size 0x134, virtual false, abstract: false, final false
  static inline bool LoadImage(::UnityEngine::Texture2D* tex, ::ArrayW<uint8_t> data, bool markNonReadable);

  /// @brief Method LoadImage_Injected, addr 0x6b3a0f0, size 0x54, virtual false, abstract: false, final false
