...
public:
// Declarations
/// @brief Method EncodeToEXR, addr 0x697256c, size 0x160, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeToEXR(::UnityEngine::Texture2D*  tex, ::UnityEngine::Texture2D_EXRFlags  flags) ;

/// @brief Method EncodeToEXR_Injected, addr 0x69726cc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method EncodeToJPG, addr 0x6972564, size 0x8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeToJPG(::UnityEngine::Texture2D*  tex) ;

/// @brief Method EncodeToJPG, addr 0x69723b0, size 0x160, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeToJPG(::UnityEngine::Texture2D*  tex, int32_t  quality) ;

/// @brief Method EncodeToJPG_Injected, addr 0x6972510, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method EncodeToPNG, addr 0x6972220, size 0x14c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeToPNG(::UnityEngine::Texture2D*  tex) ;

/// @brief Method EncodeToPNG_Injected, addr 0x697236c, size 0x44, virtual false, abstract: false, final false
static inline void EncodeToPNG_Injected(::System::IntPtr  tex, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper>  ret) ;

/// @brief Method EncodeToTGA, addr 0x6972090, size 0x14c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeToTGA(::UnityEngine::Texture2D*  tex) ;

/// @brief Method EncodeToTGA_Injected, addr 0x69721dc, size 0x44, virtual false, abstract: false, final false
static inline void EncodeToTGA_Injected(::System::IntPtr  tex, ::ByRef<::UnityEngine::Bindings::BlittableArrayWrapper>  ret) ;

/// @brief Method LoadImage, addr 0x69728a8, size 0x8, virtual false, abstract: false, final false
static inline bool LoadImage(::UnityEngine::Texture2D*  tex, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method LoadImage, addr 0x6972720, size 0x134, virtual false, abstract: false, final false
static inline bool LoadImage(::UnityEngine::Texture2D*  tex, ::ArrayW<uint8_t,::Array<uint8_t>*>  data, bool  markNonReadable) ;

/// @brief Method LoadImage_Injected, addr 0x6972854, size 0x54, virtual false, abstract: false, final false
