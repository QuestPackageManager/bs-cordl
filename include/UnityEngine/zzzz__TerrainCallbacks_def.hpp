...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3475cd0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3475bf8, size 0xd8, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3475dc0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3475ce8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method InvokeHeightmapChangedCallback, addr 0x34759d0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeTextureChangedCallback, addr 0x3475adc, size 0x11c, virtual false, abstract: false, final false
