...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x491d098, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491cff8, size 0xa0, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x491d150, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x491d0b0, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method InvokeHeightmapChangedCallback, addr 0x491cd94, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeTextureChangedCallback, addr 0x491cedc, size 0x11c, virtual false, abstract: false, final false
