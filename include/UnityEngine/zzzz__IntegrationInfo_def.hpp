...
// Dependencies UnityEngine.IntegrationInfo::<IntegrationVersion>e__FixedBuffer, UnityEngine.IntegrationInfo::<SdkVersion>e__FixedBuffer, UnityEngine.IntegrationInfo::<m_Desc>e__FixedBuffer, UnityEngine.IntegrationInfo::<m_Name>e__FixedBuffer, UnityEngine.IntegrationInfo::SupportedUnityFeatures
namespace UnityEngine {
// Is value type: true
...
/// @brief Field IntegrationVersion, offset 0x4, size 0x6 
 __declspec(property(get=__cordl_internal_get_IntegrationVersion, put=__cordl_internal_set_IntegrationVersion)) ::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer  IntegrationVersion;
...
/// @brief Method get_Description, addr 0x69c805c, size 0x58, virtual false, abstract: false, final false
inline ::StringW get_Description() ;

/// @brief Method get_Name, addr 0x69c8004, size 0x58, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Id", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "IntegrationVersion", ty: "::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "SdkVersion", ty: "::UnityEngine::IntegrationInfo__SdkVersion_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_Features", ty: "::UnityEngine::IntegrationInfo_SupportedUnityFeatures", modifiers: "", def_value: None }, CppParam { name: "m_Name", ty: "::UnityEngine::IntegrationInfo__m_Name_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "m_Desc", ty: "::UnityEngine::IntegrationInfo__m_Desc_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr IntegrationInfo(uint32_t  Id, ::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer  IntegrationVersion, ::UnityEngine::IntegrationInfo__SdkVersion_e__FixedBuffer  SdkVersion, ::UnityEngine::IntegrationInfo_SupportedUnityFeatures  m_Features, ::UnityEngine::IntegrationInfo__m_Name_e__FixedBuffer  m_Name, ::UnityEngine::IntegrationInfo__m_Desc_e__FixedBuffer  m_Desc) noexcept;
