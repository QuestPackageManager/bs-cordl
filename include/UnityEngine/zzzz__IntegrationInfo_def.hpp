...
DEFINE_IL2CPP_CLASS(::UnityEngine::IntegrationInfo__IntegrationVersion_e__FixedBuffer, "UnityEngine", "IntegrationInfo/<IntegrationVersion>e__FixedBuffer");
...
public:
  ...
  /// @brief Method get_Description, addr 0x6b92e80, size 0x58, virtual false, abstract: false, final false
  inline ::StringW get_Description();

  /// @brief Method get_Name, addr 0x6b92e28, size 0x58, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::IntegrationInfo) == 0x100, "Size mismatch!");
