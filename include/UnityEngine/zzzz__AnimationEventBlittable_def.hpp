...
public:
  ...
  /// @brief Method Dispose, addr 0x68db4dc, size 0x18c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeEvents, addr 0x68db47c, size 0x60, virtual false, abstract: false, final false
  static inline void DisposeEvents(::System::IntPtr animationEventBlittableArray, int32_t size);

  /// @brief Method FreeEventsInternal, addr 0x68db668, size 0x3c, virtual false, abstract: false, final false
  static inline void FreeEventsInternal(::System::IntPtr value);

  /// @brief Method FromAnimationEvent, addr 0x68daca4, size 0x1f4, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationEventBlittable FromAnimationEvent(::UnityEngine::AnimationEvent* animationEvent);

  /// @brief Method FromAnimationEvents, addr 0x68daeec, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method PointerToAnimationEvent, addr 0x68db100, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationEvent* PointerToAnimationEvent(::System::IntPtr animationEventBlittable);

  /// @brief Method PointerToAnimationEvents, addr 0x68db3b8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAnimationEvent, addr 0x68db12c, size 0x28c, virtual false, abstract: false, final false
