...
public:
  ...
  /// @brief Method get_collider, addr 0x6a182a0, size 0x3f4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider2D> get_collider();

  /// @brief Method get_distance, addr 0x6a18290, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_fraction, addr 0x6a18298, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fraction();

  /// @brief Method get_normal, addr 0x6a18288, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_normal();

  /// @brief Method get_point, addr 0x6a18280, size 0x8, virtual false, abstract: false, final false
