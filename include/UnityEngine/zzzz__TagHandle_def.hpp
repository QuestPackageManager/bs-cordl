...
public:
  // Declarations
  /// @brief Method TagToString, addr 0x698ef24, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW TagToString(uint32_t tagIndex);

  /// @brief Method TagToString_Injected, addr 0x698eff0, size 0x44, virtual false, abstract: false, final false
  static inline void TagToString_Injected(uint32_t tagIndex, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method ToString, addr 0x698ef1c, size 0x8, virtual true, abstract: false, final false
