...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HumanTrait", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HumanTrait(HumanTrait&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HumanTrait", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HumanTrait(HumanTraitconst&) = delete;
