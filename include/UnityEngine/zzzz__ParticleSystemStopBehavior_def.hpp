...
DEFINE_IL2CPP_CLASS(::UnityEngine::ParticleSystemStopBehavior, "UnityEngine", "ParticleSystemStopBehavior");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ParticleSystemStopBehavior) == 0x4, "Size mismatch!");
