...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16332))
...
public:
  ...
  /// @brief Method get_cellSize, addr 0x2d068b0, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_cellSize();

  static inline ::UnityEngine::Grid* New_ctor();

  /// @brief Method .ctor, addr 0x2d06950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellSize_Injected, addr 0x2d0690c, size 0x44, virtual false, abstract: false, final false
