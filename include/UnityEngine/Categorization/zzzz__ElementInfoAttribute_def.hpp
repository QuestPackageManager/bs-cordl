...
public:
  ...
  /// @brief Method .ctor, addr 0x69a6740, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Order, addr 0x69a6738, size 0x8, virtual false, abstract: false, final false
