...
public:
  ...
  /// @brief Method AngleAxis_Injected, addr 0x6ad0360, size 0x54, virtual false, abstract: false, final false
  static inline void AngleAxis_Injected(float_t angle, ::by_ref<::UnityEngine::Vector3> axis, ::by_ref<::UnityEngine::Quaternion> ret);

  /// @brief Method Dot, addr 0x6ad06c8, size 0x20, virtual false, abstract: false, final false
  static inline float_t Dot(::UnityEngine::Quaternion a, ::UnityEngine::Quaternion b);

  /// @brief Method Equals, addr 0x6ad0c5c, size 0x160, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x6ad0dbc, size 0xf4, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::Quaternion other);

  /// @brief Method Euler, addr 0x6ad08e8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method FromToRotation_Injected, addr 0x6acfda4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_FromEulerRad_Injected, addr 0x6ad016c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Inverse_Injected, addr 0x6acfe4c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x6ad0b1c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SlerpUnclamped_Injected, addr 0x6acffdc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Slerp_Injected, addr 0x6acff04, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAngleAxis, addr 0x6ad0900, size 0x34, virtual false, abstract: false, final false
  inline void ToAngleAxis(::by_ref<float_t> angle, ::by_ref<::UnityEngine::Vector3> axis);

  /// @brief Method ToString, addr 0x6ad0eb0, size 0x10, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x6ad0ec0, size 0x218, virtual true, abstract: false, final true
  inline ::StringW ToString(::StringW format, ::System::IFormatProvider* formatProvider);

  /// @brief Method .ctor, addr 0x6ad04e0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_eulerAngles, addr 0x6ad0874, size 0x2c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_eulerAngles();

  /// @brief Method get_identity, addr 0x6ad04ec, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6ad0668, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::Quaternion lhs, ::UnityEngine::Quaternion rhs);

  /// @brief Method op_Inequality, addr 0x6ad0698, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::Quaternion lhs, ::UnityEngine::Quaternion rhs);

  /// @brief Method op_Multiply, addr 0x6ad053c, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion op_Multiply(::UnityEngine::Quaternion lhs, ::UnityEngine::Quaternion rhs);

  /// @brief Method op_Multiply, addr 0x6ad05b0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_eulerAngles, addr 0x6ad08a0, size 0x30, virtual false, abstract: false, final false
