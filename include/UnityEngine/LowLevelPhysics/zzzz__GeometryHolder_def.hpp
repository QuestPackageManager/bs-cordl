...
} // namespace end def UnityEngine::LowLevelPhysics
...
// Ctor Parameters [CppParam { name: "m_Type", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_DataStart", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_FakePointer0", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "m_FakePointer1", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "m_Blob", ty: "::UnityEngine::LowLevelPhysics::GeometryHolder__m_Blob_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr GeometryHolder(int32_t  m_Type, uint32_t  m_DataStart, ::System::IntPtr  m_FakePointer0, ::System::IntPtr  m_FakePointer1, ::UnityEngine::LowLevelPhysics::GeometryHolder__m_Blob_e__FixedBuffer  m_Blob) noexcept;
