...
DEFINE_IL2CPP_CLASS(::UnityEngine::LowLevelPhysics::GeometryType, "UnityEngine.LowLevelPhysics", "GeometryType");
// Dependencies
namespace UnityEngine::LowLevelPhysics {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::LowLevelPhysics::GeometryType) == 0x4, "Size mismatch!");
