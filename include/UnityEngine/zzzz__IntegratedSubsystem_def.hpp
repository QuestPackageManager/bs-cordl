...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x69ed4f0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Destroy, addr 0x69ed20c, size 0x8c, virtual true, abstract: false, final true
inline void Destroy() ;

/// @brief Method IsRunning, addr 0x69ed460, size 0x50, virtual false, abstract: false, final false
inline bool IsRunning() ;

/// @brief Method IsRunning_Injected, addr 0x69ed4b0, size 0x3c, virtual false, abstract: false, final false
static inline bool IsRunning_Injected(::System::IntPtr  _unity_self) ;

static inline ::UnityEngine::IntegratedSubsystem* New_ctor() ;

/// @brief Method SetHandle, addr 0x69ed058, size 0x58, virtual false, abstract: false, final false
inline void SetHandle(::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method SetHandle_Injected, addr 0x69ed0b0, size 0x44, virtual false, abstract: false, final false
static inline void SetHandle_Injected(::System::IntPtr  _unity_self, ::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method Start, addr 0x69ed0f4, size 0x50, virtual true, abstract: false, final true
inline void Start() ;

/// @brief Method Start_Injected, addr 0x69ed144, size 0x3c, virtual false, abstract: false, final false
static inline void Start_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method Stop, addr 0x69ed180, size 0x50, virtual true, abstract: false, final true
inline void Stop() ;

/// @brief Method Stop_Injected, addr 0x69ed1d0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69ed4ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_running, addr 0x69ed43c, size 0x14, virtual true, abstract: false, final true
inline bool get_running() ;

/// @brief Method get_valid, addr 0x69ed450, size 0x10, virtual false, abstract: false, final false
