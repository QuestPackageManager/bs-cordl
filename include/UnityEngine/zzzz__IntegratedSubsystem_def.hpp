...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6bb4d8c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Destroy, addr 0x6bb4aa8, size 0x8c, virtual true, abstract: false, final true
  inline void Destroy();

  /// @brief Method IsRunning, addr 0x6bb4cfc, size 0x50, virtual false, abstract: false, final false
  inline bool IsRunning();

  /// @brief Method IsRunning_Injected, addr 0x6bb4d4c, size 0x3c, virtual false, abstract: false, final false
  static inline bool IsRunning_Injected(::System::IntPtr _unity_self);

  static inline ::UnityEngine::IntegratedSubsystem* New_ctor();

  /// @brief Method SetHandle, addr 0x6bb48f4, size 0x58, virtual false, abstract: false, final false
  inline void SetHandle(::UnityEngine::IntegratedSubsystem* subsystem);

  /// @brief Method SetHandle_Injected, addr 0x6bb494c, size 0x44, virtual false, abstract: false, final false
  static inline void SetHandle_Injected(::System::IntPtr _unity_self, ::UnityEngine::IntegratedSubsystem* subsystem);

  /// @brief Method Start, addr 0x6bb4990, size 0x50, virtual true, abstract: false, final true
  inline void Start();

  /// @brief Method Start_Injected, addr 0x6bb49e0, size 0x3c, virtual false, abstract: false, final false
  static inline void Start_Injected(::System::IntPtr _unity_self);

  /// @brief Method Stop, addr 0x6bb4a1c, size 0x50, virtual true, abstract: false, final true
  inline void Stop();

  /// @brief Method Stop_Injected, addr 0x6bb4a6c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bb4d88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_running, addr 0x6bb4cd8, size 0x14, virtual true, abstract: false, final true
  inline bool get_running();

  /// @brief Method get_valid, addr 0x6bb4cec, size 0x10, virtual false, abstract: false, final false
