...
public:
  ...
  /// @brief Method Equals, addr 0x4921afc, size 0x64, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4921b60, size 0x25c, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::DetailPrototype* other);

  /// @brief Method GetHashCode, addr 0x4921dbc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4921a54, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_dryColor, addr 0x4921a10, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_dryColor();

  /// @brief Method get_healthyColor, addr 0x49219f8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_healthyColor();

  /// @brief Method get_maxHeight, addr 0x49219d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxHeight();

  /// @brief Method get_maxWidth, addr 0x49219b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxWidth();

  /// @brief Method get_minHeight, addr 0x49219c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_minHeight();

  /// @brief Method get_minWidth, addr 0x49219a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_minWidth();

  /// @brief Method get_noiseSpread, addr 0x49219e8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noiseSpread();

  /// @brief Method get_renderMode, addr 0x4921a28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_dryColor, addr 0x4921a1c, size 0xc, virtual false, abstract: false, final false
  inline void set_dryColor(::UnityEngine::Color value);

  /// @brief Method set_healthyColor, addr 0x4921a04, size 0xc, virtual false, abstract: false, final false
  inline void set_healthyColor(::UnityEngine::Color value);

  /// @brief Method set_maxHeight, addr 0x49219e0, size 0x8, virtual false, abstract: false, final false
  inline void set_maxHeight(float_t value);

  /// @brief Method set_maxWidth, addr 0x49219c0, size 0x8, virtual false, abstract: false, final false
  inline void set_maxWidth(float_t value);

  /// @brief Method set_minHeight, addr 0x49219d0, size 0x8, virtual false, abstract: false, final false
  inline void set_minHeight(float_t value);

  /// @brief Method set_minWidth, addr 0x49219b0, size 0x8, virtual false, abstract: false, final false
  inline void set_minWidth(float_t value);

  /// @brief Method set_noiseSpread, addr 0x49219f0, size 0x8, virtual false, abstract: false, final false
  inline void set_noiseSpread(float_t value);

  /// @brief Method set_prototype, addr 0x4921998, size 0x8, virtual false, abstract: false, final false
  inline void set_prototype(::UnityEngine::GameObject* value);

  /// @brief Method set_prototypeTexture, addr 0x49219a0, size 0x8, virtual false, abstract: false, final false
  inline void set_prototypeTexture(::UnityEngine::Texture2D* value);

  /// @brief Method set_renderMode, addr 0x4921a30, size 0x8, virtual false, abstract: false, final false
  inline void set_renderMode(::UnityEngine::DetailRenderMode value);

  /// @brief Method set_usePrototypeMesh, addr 0x4921a38, size 0x1c, virtual false, abstract: false, final false
