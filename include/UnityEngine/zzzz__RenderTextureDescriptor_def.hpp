...
namespace UnityEngine {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10121)), TypeDefinitionIndex(TypeDefinitionIndex(10406)), TypeDefinitionIndex(TypeDefinitionIndex(10118)),
// TypeDefinitionIndex(TypeDefinitionIndex(10350)), TypeDefinitionIndex(TypeDefinitionIndex(10348)), TypeDefinitionIndex(TypeDefinitionIndex(10119))} Self:
