...
public:
  ...
  /// @brief Method SetOrClearRenderTextureCreationFlag, addr 0x696edfc, size 0x1c, virtual false, abstract: false, final false
  inline void SetOrClearRenderTextureCreationFlag(bool value, ::UnityEngine::RenderTextureCreationFlags flag);

  /// @brief Method .ctor, addr 0x696f214, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height);

  /// @brief Method .ctor, addr 0x696f2c8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x696f35c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x696f500, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x696f4a4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, ::UnityEngine::Experimental::Rendering::GraphicsFormat depthStencilFormat,
                    int32_t mipCount);

  /// @brief Method .ctor, addr 0x696f220, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::RenderTextureFormat colorFormat);

  /// @brief Method .ctor, addr 0x696f228, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::RenderTextureFormat colorFormat, int32_t depthBufferBits);

  /// @brief Method .ctor, addr 0x696f2c0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x696f3c4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_autoGenerateMips, addr 0x696f5dc, size 0xc, virtual false, abstract: false, final false
  inline bool get_autoGenerateMips();

  /// @brief Method get_bindMS, addr 0x696f634, size 0xc, virtual false, abstract: false, final false
  inline bool get_bindMS();

  /// @brief Method get_colorFormat, addr 0x696ee30, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_colorFormat();

  /// @brief Method get_depthBufferBits, addr 0x696f030, size 0x7c, virtual false, abstract: false, final false
  inline int32_t get_depthBufferBits();

  /// @brief Method get_depthStencilFormat, addr 0x696ee20, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_depthStencilFormat();

  /// @brief Method get_dimension, addr 0x696f1d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::TextureDimension get_dimension();

  /// @brief Method get_enableRandomWrite, addr 0x696f608, size 0xc, virtual false, abstract: false, final false
  inline bool get_enableRandomWrite();

  /// @brief Method get_graphicsFormat, addr 0x696ed4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat();

  /// @brief Method get_height, addr 0x696ed0c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_memoryless, addr 0x696f204, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureMemoryless get_memoryless();

  /// @brief Method get_mipCount, addr 0x696ed3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_mipCount();

  /// @brief Method get_msaaSamples, addr 0x696ed1c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_msaaSamples();

  /// @brief Method get_sRGB, addr 0x696efb4, size 0x7c, virtual false, abstract: false, final false
  inline bool get_sRGB();

  /// @brief Method get_shadowSamplingMode, addr 0x696f1e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rendering::ShadowSamplingMode get_shadowSamplingMode();

  /// @brief Method get_useDynamicScale, addr 0x696f680, size 0xc, virtual false, abstract: false, final false
  inline bool get_useDynamicScale();

  /// @brief Method get_useDynamicScaleExplicit, addr 0x696f6ac, size 0xc, virtual false, abstract: false, final false
  inline bool get_useDynamicScaleExplicit();

  /// @brief Method get_useMipMap, addr 0x696f5c0, size 0xc, virtual false, abstract: false, final false
  inline bool get_useMipMap();

  /// @brief Method get_volumeDepth, addr 0x696ed2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_volumeDepth();

  /// @brief Method get_vrUsage, addr 0x696f1f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::VRTextureUsage get_vrUsage();

  /// @brief Method get_width, addr 0x696ecfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method set_autoGenerateMips, addr 0x696f5e8, size 0x20, virtual false, abstract: false, final false
  inline void set_autoGenerateMips(bool value);

  /// @brief Method set_bindMS, addr 0x696f640, size 0x20, virtual false, abstract: false, final false
  inline void set_bindMS(bool value);

  /// @brief Method set_colorFormat, addr 0x696eecc, size 0xe8, virtual false, abstract: false, final false
  inline void set_colorFormat(::UnityEngine::RenderTextureFormat value);

  /// @brief Method set_createdFromScript, addr 0x696f660, size 0x20, virtual false, abstract: false, final false
  inline void set_createdFromScript(bool value);

  /// @brief Method set_depthBufferBits, addr 0x696f1a8, size 0x2c, virtual false, abstract: false, final false
  inline void set_depthBufferBits(int32_t value);

  /// @brief Method set_depthStencilFormat, addr 0x696ee28, size 0x8, virtual false, abstract: false, final false
  inline void set_depthStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_dimension, addr 0x696f1dc, size 0x8, virtual false, abstract: false, final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method set_enableRandomWrite, addr 0x696f614, size 0x20, virtual false, abstract: false, final false
  inline void set_enableRandomWrite(bool value);

  /// @brief Method set_graphicsFormat, addr 0x696ed54, size 0xa8, virtual false, abstract: false, final false
  inline void set_graphicsFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_height, addr 0x696ed14, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_memoryless, addr 0x696f20c, size 0x8, virtual false, abstract: false, final false
  inline void set_memoryless(::UnityEngine::RenderTextureMemoryless value);

  /// @brief Method set_mipCount, addr 0x696ed44, size 0x8, virtual false, abstract: false, final false
  inline void set_mipCount(int32_t value);

  /// @brief Method set_msaaSamples, addr 0x696ed24, size 0x8, virtual false, abstract: false, final false
  inline void set_msaaSamples(int32_t value);

  /// @brief Method set_sRGB, addr 0x696f0ac, size 0xfc, virtual false, abstract: false, final false
  inline void set_sRGB(bool value);

  /// @brief Method set_shadowSamplingMode, addr 0x696f1ec, size 0x8, virtual false, abstract: false, final false
  inline void set_shadowSamplingMode(::UnityEngine::Rendering::ShadowSamplingMode value);

  /// @brief Method set_stencilFormat, addr 0x696ee18, size 0x8, virtual false, abstract: false, final false
  inline void set_stencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_useDynamicScale, addr 0x696f68c, size 0x20, virtual false, abstract: false, final false
  inline void set_useDynamicScale(bool value);

  /// @brief Method set_useDynamicScaleExplicit, addr 0x696f6b8, size 0x20, virtual false, abstract: false, final false
  inline void set_useDynamicScaleExplicit(bool value);

  /// @brief Method set_useMipMap, addr 0x696f5cc, size 0x10, virtual false, abstract: false, final false
  inline void set_useMipMap(bool value);

  /// @brief Method set_volumeDepth, addr 0x696ed34, size 0x8, virtual false, abstract: false, final false
  inline void set_volumeDepth(int32_t value);

  /// @brief Method set_vrUsage, addr 0x696f1fc, size 0x8, virtual false, abstract: false, final false
  inline void set_vrUsage(::UnityEngine::VRTextureUsage value);

  /// @brief Method set_width, addr 0x696ed04, size 0x8, virtual false, abstract: false, final false
