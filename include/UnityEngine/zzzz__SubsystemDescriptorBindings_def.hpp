...
public:
  // Declarations
  /// @brief Method Create, addr 0x69ecf28, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(::System::IntPtr descriptorPtr);

  /// @brief Method GetId, addr 0x69ece4c, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW GetId(::System::IntPtr descriptorPtr);

  /// @brief Method GetId_Injected, addr 0x69ecf64, size 0x44, virtual false, abstract: false, final false
