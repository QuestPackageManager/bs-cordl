...
public:
  // Declarations
  /// @brief Method Create, addr 0x489fa48, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(::System::IntPtr descriptorPtr);

  /// @brief Method GetId, addr 0x489f9f8, size 0x3c, virtual false, abstract: false, final false
