...
DEFINE_IL2CPP_CLASS(::UnityEngine::RigidbodyConstraints, "UnityEngine", "RigidbodyConstraints");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::RigidbodyConstraints) == 0x4, "Size mismatch!");
