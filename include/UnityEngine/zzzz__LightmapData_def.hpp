...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightmapData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightmapData(LightmapData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightmapData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightmapData(LightmapDataconst&) = delete;
