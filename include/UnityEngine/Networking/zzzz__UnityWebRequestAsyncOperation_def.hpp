...
public:
// Declarations
/// @brief Method ConvertToManaged, addr 0x6cd1d24, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd1cc8, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_webRequest, addr 0x6cd1d14, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* get_webRequest() ;

/// @brief Method set_webRequest, addr 0x6cd1d1c, size 0x8, virtual false, abstract: false, final false
