...
public:
  // Declarations
  /// @brief Method ConvertToManaged, addr 0x6e25bdc, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e25b80, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method get_webRequest, addr 0x6e25bcc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Networking::UnityWebRequest* get_webRequest();

  /// @brief Method set_webRequest, addr 0x6e25bd4, size 0x8, virtual false, abstract: false, final false
