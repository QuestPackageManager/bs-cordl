...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x6c5d350, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x6c5d1bc, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(::UnityEngine::Networking::CertificateHandler*  obj) ;

/// @brief Method Dispose, addr 0x6c5d31c, size 0x20, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x6c5d2c8, size 0x54, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::UnityEngine::Networking::CertificateHandler* New_ctor() ;

/// @brief Method ReleaseFromScripting, addr 0x6c5d1f8, size 0x50, virtual false, abstract: false, final false
inline void ReleaseFromScripting() ;

/// @brief Method ReleaseFromScripting_Injected, addr 0x6c5d248, size 0x3c, virtual false, abstract: false, final false
static inline void ReleaseFromScripting_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method ValidateCertificate, addr 0x6c5d33c, size 0x8, virtual true, abstract: false, final false
inline bool ValidateCertificate(::ArrayW<uint8_t,::Array<uint8_t>*>  certificateData) ;

/// @brief Method ValidateCertificateNative, addr 0x6c5d344, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c5d284, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;
