...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Networking::DownloadedTextureParams (*)()>(&::UnityEngine::Networking::DownloadedTextureParams::get_Default)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6c60320;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Networking::DownloadedTextureParams>::get(),
                        "get_Default",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Networking::DownloadedTextureParams::*)(bool)>(&::UnityEngine::Networking::DownloadedTextureParams::set_readable)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x6c60328;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Networking::DownloadedTextureParams::*)(::UnityEngine::Networking::DownloadedTextureFlags, bool)>(&::UnityEngine::Networking::DownloadedTextureParams::SetFlags)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x6c60338;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "SetFlags",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Networking::DownloadedTextureFlags>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                    )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "flags", ty: "::UnityEngine::Networking::DownloadedTextureFlags", modifiers: "", def_value: Some("{}") }, CppParam { name: "mipmapCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
