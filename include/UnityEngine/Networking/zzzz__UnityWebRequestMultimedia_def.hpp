...
public:
  // Declarations
  /// @brief Method GetAudioClip, addr 0x6e26fcc, size 0xc8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnityWebRequestMultimedia", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnityWebRequestMultimedia(UnityWebRequestMultimedia&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnityWebRequestMultimedia", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnityWebRequestMultimedia(UnityWebRequestMultimediaconst&) = delete;
