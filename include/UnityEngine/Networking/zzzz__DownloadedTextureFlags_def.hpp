...
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::DownloadedTextureFlags, "UnityEngine.Networking", "DownloadedTextureFlags");
// Dependencies
namespace UnityEngine::Networking {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Networking::DownloadedTextureFlags) == 0x4, "Size mismatch!");
