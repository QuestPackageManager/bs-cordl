...
public:
  ...
  /// @brief Method Create addr 0x2eabc08 size 0x54 virtual false final false
  static inline void* Create(::UnityEngine::Networking::DownloadHandlerAssetBundle* obj, ::StringW url, uint32_t crc);

  /// @brief Method CreateCached addr 0x2eabc5c size 0x70 virtual false final false
  ...
  /// @brief Method InternalCreateAssetBundle addr 0x2eabd38 size 0x5c virtual false final false
  inline void InternalCreateAssetBundle(::StringW url, uint32_t crc);

  /// @brief Method InternalCreateAssetBundleCached addr 0x2eabd94 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2eaba44 size 0x64 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2eabb98 size 0x70 virtual false final false
  inline void _ctor(::StringW url, ::UnityEngine::CachedAssetBundle cachedBundle, uint32_t crc);

  /// @brief Method GetData addr 0x2eabdac size 0x50 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method GetText addr 0x2eabdfc size 0x50 virtual true final false
  inline ::StringW GetText();

  /// @brief Method get_assetBundle addr 0x2eabe4c size 0x3c virtual false final false
  inline ::UnityEngine::AssetBundle* get_assetBundle();

  /// @brief Method get_autoLoadAssetBundle addr 0x2eabe88 size 0x3c virtual false final false
  inline bool get_autoLoadAssetBundle();

  /// @brief Method set_autoLoadAssetBundle addr 0x2eabec4 size 0x44 virtual false final false
  inline void set_autoLoadAssetBundle(bool value);

  /// @brief Method get_isDownloadComplete addr 0x2eabf08 size 0x3c virtual false final false
  inline bool get_isDownloadComplete();

  /// @brief Method CreateCached_Injected addr 0x2eabccc size 0x6c virtual false final false
