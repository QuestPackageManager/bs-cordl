...
namespace UnityEngine::Networking {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15564))}
...
public:
  ...
  /// @brief Method Create addr 0x2d42e1c size 0x54 virtual false final false
  static inline void* Create(::UnityEngine::Networking::DownloadHandlerAssetBundle* obj, ::StringW url, uint32_t crc);

  /// @brief Method CreateCached addr 0x2d42e70 size 0x70 virtual false final false
  ...
  /// @brief Method InternalCreateAssetBundle addr 0x2d42f4c size 0x5c virtual false final false
  inline void InternalCreateAssetBundle(::StringW url, uint32_t crc);

  /// @brief Method InternalCreateAssetBundleCached addr 0x2d42fa8 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d42c58 size 0x64 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d42dac size 0x70 virtual false final false
  inline void _ctor(::StringW url, ::UnityEngine::CachedAssetBundle cachedBundle, uint32_t crc);

  /// @brief Method GetData addr 0x2d42fc0 size 0x50 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method GetText addr 0x2d43010 size 0x50 virtual true final false
  inline ::StringW GetText();

  /// @brief Method get_assetBundle addr 0x2d43060 size 0x3c virtual false final false
  inline ::UnityEngine::AssetBundle* get_assetBundle();

  /// @brief Method get_autoLoadAssetBundle addr 0x2d4309c size 0x3c virtual false final false
  inline bool get_autoLoadAssetBundle();

  /// @brief Method set_autoLoadAssetBundle addr 0x2d430d8 size 0x44 virtual false final false
  inline void set_autoLoadAssetBundle(bool value);

  /// @brief Method get_isDownloadComplete addr 0x2d4311c size 0x3c virtual false final false
  inline bool get_isDownloadComplete();

  /// @brief Method CreateCached_Injected addr 0x2d42ee0 size 0x6c virtual false final false
