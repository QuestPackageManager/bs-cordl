...
public:
  ...
  /// @brief Method Release addr 0x2d4658c size 0x3c virtual false final false
  inline void Release();

  static inline ::UnityEngine::Networking::DownloadHandler* New_ctor();

  /// @brief Method .ctor addr 0x2d465c8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Finalize addr 0x2d465d0 size 0x9c virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x2d4666c size 0x94 virtual true final false
  inline void Dispose();

  /// @brief Method get_error addr 0x2d46700 size 0x3c virtual false final false
  inline ::StringW get_error();

  /// @brief Method GetErrorMsg addr 0x2d4673c size 0x3c virtual false final false
  inline ::StringW GetErrorMsg();

  /// @brief Method get_text addr 0x2d46778 size 0xc virtual false final false
  inline ::StringW get_text();

  /// @brief Method GetNativeData addr 0x2d46784 size 0xc virtual true final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method GetData addr 0x2d46790 size 0x4 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetData();

  /// @brief Method GetText addr 0x2d46838 size 0xe8 virtual true final false
  inline ::StringW GetText();

  /// @brief Method GetTextEncoder addr 0x2d46920 size 0x270 virtual false final false
  inline ::System::Text::Encoding* GetTextEncoder();

  /// @brief Method GetContentType addr 0x2d46b90 size 0x3c virtual false final false
  inline ::StringW GetContentType();

  /// @brief Method ReceiveContentLengthHeader addr 0x2d46bcc size 0xc virtual true final false
  inline void ReceiveContentLengthHeader(uint64_t contentLength);

  /// @brief Method ReceiveContentLength addr 0x2d46bd8 size 0x4 virtual true final false
  ...
  /// @brief Method InternalGetByteArray addr 0x2d46bdc size 0x44 virtual false final false
  ...
  /// @brief Method InternalGetByteArray addr 0x2d46794 size 0xa4 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> InternalGetByteArray(::UnityEngine::Networking::DownloadHandler* dh);

  /// @brief Method InternalGetNativeArray addr 0x2d46c20 size 0xbc virtual false final false
  ...
  /// @brief Method DisposeNativeArray addr 0x2d46cdc size 0x54 virtual false final false
  static inline void DisposeNativeArray(ByRef<::Unity::Collections::NativeArray_1<uint8_t>> data);

  /// @brief Method CreateNativeArrayForNativeData addr 0x2d46d30 size 0x68 virtual false final false
