...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6e28fc8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateNativeArrayForNativeData, addr 0x6e28f6c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x6e285f4, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetContentType, addr 0x6e28c04, size 0x100, virtual false, abstract: false, final false
  inline ::StringW GetContentType();

  /// @brief Method GetContentType_Injected, addr 0x6e28d04, size 0x44, virtual false, abstract: false, final false
  static inline void GetContentType_Injected(::System::IntPtr _unity_self, ::by_ref<::UnityEngine::Bindings::ManagedSpanWrapper> ret);

  /// @brief Method GetData, addr 0x6e28848, size 0x4, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> GetData();

  /// @brief Method GetErrorMsg, addr 0x6e28664, size 0x100, virtual false, abstract: false, final false
  inline ::StringW GetErrorMsg();

  /// @brief Method GetErrorMsg_Injected, addr 0x6e28764, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetText, addr 0x6e288d8, size 0xb8, virtual true, abstract: false, final false
  inline ::StringW GetText();

  /// @brief Method GetTextEncoder, addr 0x6e28990, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseFromScripting_Injected, addr 0x6e285b4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_data, addr 0x6e28824, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> get_data();

  /// @brief Method get_error, addr 0x6e28660, size 0x4, virtual false, abstract: false, final false
  inline ::StringW get_error();

  /// @brief Method get_nativeData, addr 0x6e287a8, size 0x7c, virtual false, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1_ReadOnly<uint8_t> get_nativeData();

  /// @brief Method get_text, addr 0x6e28830, size 0xc, virtual false, abstract: false, final false
