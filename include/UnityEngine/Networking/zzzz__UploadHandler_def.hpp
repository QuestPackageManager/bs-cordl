...
public:
  ...
  /// @brief Method Dispose, addr 0x4ae79e4, size 0x58, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method Release, addr 0x4ae79a8, size 0x3c, virtual false, abstract: false, final false
  inline void Release();
