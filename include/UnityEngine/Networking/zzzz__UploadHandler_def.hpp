...
public:
  ...
  /// @brief Method Dispose, addr 0x3016e90, size 0x94, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method Release, addr 0x3016e54, size 0x3c, virtual false, abstract: false, final false
  inline void Release();
