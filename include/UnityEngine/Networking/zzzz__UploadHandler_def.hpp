...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6cd2554, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x6cd2534, size 0x20, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x6cd24e8, size 0x4c, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::UnityEngine::Networking::UploadHandler* New_ctor();

  /// @brief Method ReleaseFromScripting, addr 0x6cd2458, size 0x50, virtual false, abstract: false, final false
  inline void ReleaseFromScripting();

  /// @brief Method ReleaseFromScripting_Injected, addr 0x6cd24a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd24e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
