...
public:
// Declarations
/// @brief Method GetAssetBundle, addr 0x6c5adec, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Networking::UnityWebRequest* GetAssetBundle(::StringW  uri) ;

/// @brief Method GetAssetBundle, addr 0x6c5adf4, size 0xc8, virtual false, abstract: false, final false
static inline ::UnityEngine::Networking::UnityWebRequest* GetAssetBundle(::StringW  uri, uint32_t  crc) ;

/// @brief Method GetAssetBundle, addr 0x6c5aebc, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Networking::UnityWebRequest* GetAssetBundle(::System::Uri*  uri) ;

/// @brief Method GetAssetBundle, addr 0x6c5afc0, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetAssetBundle, addr 0x6c5aec4, size 0xe4, virtual false, abstract: false, final false
