...
// Write type traits
MARK_REF_T(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents*);
MARK_REF_T(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_ConnectionChangeEvent*);
MARK_REF_T(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageEvent*);
MARK_REF_T(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageTypeSubscribers*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents*, "UnityEngine.Networking.PlayerConnection", "PlayerEditorConnectionEvents");
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_ConnectionChangeEvent*, "UnityEngine.Networking.PlayerConnection",
                    "PlayerEditorConnectionEvents/ConnectionChangeEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageEvent*, "UnityEngine.Networking.PlayerConnection", "PlayerEditorConnectionEvents/MessageEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageTypeSubscribers*, "UnityEngine.Networking.PlayerConnection",
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b03934, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageEvent) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b0397c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_ConnectionChangeEvent) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b038ac, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_MessageTypeId, addr 0x6b03470, size 0x2c, virtual false, abstract: false, final false
  inline ::System::Guid get_MessageTypeId();

  /// @brief Method set_MessageTypeId, addr 0x6b03908, size 0x2c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents_MessageTypeSubscribers) == 0x28, "Size mismatch!");
...
public:
  ...
  /// @brief Method AddAndCreate, addr 0x6b02158, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildLookup, addr 0x6b03518, size 0x394, virtual false, abstract: false, final false
  inline void BuildLookup();

  /// @brief Method InvokeMessageIdSubscribers, addr 0x6b02fac, size 0x184, virtual false, abstract: false, final false
  inline void InvokeMessageIdSubscribers(::System::Guid messageId, ::ArrayW<uint8_t> data, int32_t playerId);

  static inline ::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents* New_ctor();

  /// @brief Method UnregisterManagedCallback, addr 0x6b024d8, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b03354, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_messageTypeSubscribers, addr 0x6b03510, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents, ___m_SubscriberLookup) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents, ___connectionEvent) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents, ___disconnectionEvent) == 0x28, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents) == 0x30, "Size mismatch!");
