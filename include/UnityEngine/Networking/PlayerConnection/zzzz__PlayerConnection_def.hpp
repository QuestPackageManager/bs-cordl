...
public:
  ...
  /// @brief Method .ctor addr 0x2b80d10 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Register>b__0 addr 0x2b81a14 size 0x48 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2b80ec0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Unregister>b__0 addr 0x2b81a5c size 0x48 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2b81640 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <BlockUntilRecvMsg>b__0 addr 0x2b81aa4 size 0xc virtual false final false
...
public:
  ...
  /// @brief Method get_instance addr 0x2b807d4 size 0x98 virtual false final false
  static inline ::UnityEngine::Networking::PlayerConnection::PlayerConnection* get_instance();

  /// @brief Method get_isConnected addr 0x2b808f0 size 0x9c virtual false final false
  inline bool get_isConnected();

  /// @brief Method CreateInstance addr 0x2b8086c size 0x84 virtual false final false
  static inline ::UnityEngine::Networking::PlayerConnection::PlayerConnection* CreateInstance();

  /// @brief Method OnEnable addr 0x2b80a0c size 0xc0 virtual false final false
  inline void OnEnable();

  /// @brief Method GetConnectionNativeApi addr 0x2b8098c size 0x80 virtual false final false
  inline ::UnityEngine::IPlayerEditorConnectionNative* GetConnectionNativeApi();

  /// @brief Method Register addr 0x2b80acc size 0x244 virtual true final true
  ...
  /// @brief Method Unregister addr 0x2b80d18 size 0x1a8 virtual true final true
  ...
  /// @brief Method RegisterConnection addr 0x2b80ec8 size 0x1a0 virtual true final true
  inline void RegisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method RegisterDisconnection addr 0x2b81068 size 0x60 virtual true final true
  inline void RegisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method UnregisterConnection addr 0x2b810c8 size 0x60 virtual true final true
  inline void UnregisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method UnregisterDisconnection addr 0x2b81128 size 0x60 virtual true final true
  inline void UnregisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method Send addr 0x2b81188 size 0x15c virtual true final true
  inline void Send(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method TrySend addr 0x2b812e4 size 0x15c virtual true final true
  inline bool TrySend(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method BlockUntilRecvMsg addr 0x2b81440 size 0x200 virtual false final false
  inline bool BlockUntilRecvMsg(::System::Guid messageId, int32_t timeout);

  /// @brief Method DisconnectAll addr 0x2b81648 size 0x9c virtual true final true
  inline void DisconnectAll();

  /// @brief Method MessageCallbackInternal addr 0x2b816e4 size 0x118 virtual false final false
  static inline void MessageCallbackInternal(void* data, uint64_t size, uint64_t guid, ::StringW messageId);

  /// @brief Method ConnectedCallbackInternal addr 0x2b817fc size 0xdc virtual false final false
  static inline void ConnectedCallbackInternal(int32_t playerId);

  /// @brief Method DisconnectedCallback addr 0x2b818d8 size 0x94 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b8196c size 0xa8 virtual false final false
  inline void _ctor();
