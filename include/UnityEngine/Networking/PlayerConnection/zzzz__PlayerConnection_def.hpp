...
public:
  ...
  /// @brief Method <Register>b__0, addr 0x321fd20, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321f01c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Unregister>b__0, addr 0x321fd68, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321f1cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BlockUntilRecvMsg>b__0, addr 0x321fdb0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321f94c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUntilRecvMsg, addr 0x321f74c, size 0x200, virtual false, abstract: false, final false
  inline bool BlockUntilRecvMsg(::System::Guid messageId, int32_t timeout);

  /// @brief Method ConnectedCallbackInternal, addr 0x321fb08, size 0xdc, virtual false, abstract: false, final false
  static inline void ConnectedCallbackInternal(int32_t playerId);

  /// @brief Method CreateInstance, addr 0x321eb78, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> CreateInstance();

  /// @brief Method DisconnectAll, addr 0x321f954, size 0x9c, virtual true, abstract: false, final true
  inline void DisconnectAll();

  /// @brief Method DisconnectedCallback, addr 0x321fbe4, size 0x94, virtual false, abstract: false, final false
  static inline void DisconnectedCallback(int32_t playerId);

  /// @brief Method GetConnectionNativeApi, addr 0x321ec98, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::IPlayerEditorConnectionNative* GetConnectionNativeApi();

  /// @brief Method MessageCallbackInternal, addr 0x321f9f0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x321ed18, size 0xc0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Register, addr 0x321edd8, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterConnection, addr 0x321f1d4, size 0x1a0, virtual true, abstract: false, final true
  inline void RegisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method RegisterDisconnection, addr 0x321f374, size 0x60, virtual true, abstract: false, final true
  inline void RegisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method Send, addr 0x321f494, size 0x15c, virtual true, abstract: false, final true
  inline void Send(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method TrySend, addr 0x321f5f0, size 0x15c, virtual true, abstract: false, final true
  inline bool TrySend(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Unregister, addr 0x321f024, size 0x1a8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterConnection, addr 0x321f3d4, size 0x60, virtual true, abstract: false, final true
  inline void UnregisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method UnregisterDisconnection, addr 0x321f434, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x321fc78, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x321eae0, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> get_instance();

  /// @brief Method get_isConnected, addr 0x321ebfc, size 0x9c, virtual false, abstract: false, final false
