...
public:
  ...
  /// @brief Method <Register>b__0, addr 0x2ddb704, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ddaa00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Unregister>b__0, addr 0x2ddb74c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ddabb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BlockUntilRecvMsg>b__0, addr 0x2ddb794, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ddb330, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BlockUntilRecvMsg, addr 0x2ddb130, size 0x200, virtual false, abstract: false, final false
  inline bool BlockUntilRecvMsg(::System::Guid messageId, int32_t timeout);

  /// @brief Method ConnectedCallbackInternal, addr 0x2ddb4ec, size 0xdc, virtual false, abstract: false, final false
  static inline void ConnectedCallbackInternal(int32_t playerId);

  /// @brief Method CreateInstance, addr 0x2dda55c, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> CreateInstance();

  /// @brief Method DisconnectAll, addr 0x2ddb338, size 0x9c, virtual true, abstract: false, final true
  inline void DisconnectAll();

  /// @brief Method DisconnectedCallback, addr 0x2ddb5c8, size 0x94, virtual false, abstract: false, final false
  static inline void DisconnectedCallback(int32_t playerId);

  /// @brief Method GetConnectionNativeApi, addr 0x2dda67c, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::IPlayerEditorConnectionNative* GetConnectionNativeApi();

  /// @brief Method MessageCallbackInternal, addr 0x2ddb3d4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x2dda6fc, size 0xc0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Register, addr 0x2dda7bc, size 0x244, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterConnection, addr 0x2ddabb8, size 0x1a0, virtual true, abstract: false, final true
  inline void RegisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method RegisterDisconnection, addr 0x2ddad58, size 0x60, virtual true, abstract: false, final true
  inline void RegisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method Send, addr 0x2ddae78, size 0x15c, virtual true, abstract: false, final true
  inline void Send(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method TrySend, addr 0x2ddafd4, size 0x15c, virtual true, abstract: false, final true
  inline bool TrySend(::System::Guid messageId, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Unregister, addr 0x2ddaa08, size 0x1a8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterConnection, addr 0x2ddadb8, size 0x60, virtual true, abstract: false, final true
  inline void UnregisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>* callback);

  /// @brief Method UnregisterDisconnection, addr 0x2ddae18, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2ddb65c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x2dda4c4, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> get_instance();

  /// @brief Method get_isConnected, addr 0x2dda5e0, size 0x9c, virtual false, abstract: false, final false
