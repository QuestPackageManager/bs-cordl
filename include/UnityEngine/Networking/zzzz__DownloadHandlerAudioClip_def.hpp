...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6c5b6f8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6c5b20c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Create_Injected, addr 0x6c5b350, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6c5b3e0, size 0x60, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetContent, addr 0x6c5b6a0, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::AudioClip> GetContent(::UnityEngine::Networking::UnityWebRequest* www);

  /// @brief Method GetNativeData, addr 0x6c5b3d4, size 0xc, virtual true, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method GetText, addr 0x6c5b440, size 0x4c, virtual true, abstract: false, final false
  inline ::StringW GetText();

  /// @brief Method InternalCreateAudioClip, addr 0x6c5b3a4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c5b3bc, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::StringW url, ::UnityEngine::AudioType audioType);

  /// @brief Method get_audioClip, addr 0x6c5b48c, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioClip> get_audioClip();

  /// @brief Method get_audioClip_Injected, addr 0x6c5b5c8, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_audioClip_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_streamAudio, addr 0x6c5b604, size 0x58, virtual false, abstract: false, final false
  inline void set_streamAudio(bool value);

  /// @brief Method set_streamAudio_Injected, addr 0x6c5b65c, size 0x44, virtual false, abstract: false, final false
