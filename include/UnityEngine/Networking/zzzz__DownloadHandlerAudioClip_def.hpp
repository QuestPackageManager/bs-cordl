...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x6c5bdb8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x6c5b8cc, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method Create_Injected, addr 0x6c5ba10, size 0x54, virtual false, abstract: false, final false
static inline ::System::IntPtr Create_Injected(::UnityEngine::Networking::DownloadHandlerAudioClip*  obj, ::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  url, ::UnityEngine::AudioType  audioType) ;

/// @brief Method Dispose, addr 0x6c5baa0, size 0x60, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetContent, addr 0x6c5bd60, size 0x58, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::AudioClip> GetContent(::UnityEngine::Networking::UnityWebRequest*  www) ;

/// @brief Method GetNativeData, addr 0x6c5ba94, size 0xc, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method GetText, addr 0x6c5bb00, size 0x4c, virtual true, abstract: false, final false
inline ::StringW GetText() ;

/// @brief Method InternalCreateAudioClip, addr 0x6c5ba64, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c5ba7c, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::StringW  url, ::UnityEngine::AudioType  audioType) ;

/// @brief Method get_audioClip, addr 0x6c5bb4c, size 0x13c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioClip> get_audioClip() ;

/// @brief Method get_audioClip_Injected, addr 0x6c5bc88, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr get_audioClip_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method set_streamAudio, addr 0x6c5bcc4, size 0x58, virtual false, abstract: false, final false
inline void set_streamAudio(bool  value) ;

/// @brief Method set_streamAudio_Injected, addr 0x6c5bd1c, size 0x44, virtual false, abstract: false, final false
