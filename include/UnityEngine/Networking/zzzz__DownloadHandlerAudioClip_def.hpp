...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6cce000, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6ccdb14, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Create_Injected, addr 0x6ccdc58, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6ccdce8, size 0x60, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetContent, addr 0x6ccdfa8, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::AudioClip> GetContent(::UnityEngine::Networking::UnityWebRequest* www);

  /// @brief Method GetNativeData, addr 0x6ccdcdc, size 0xc, virtual true, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method GetText, addr 0x6ccdd48, size 0x4c, virtual true, abstract: false, final false
  inline ::StringW GetText();

  /// @brief Method InternalCreateAudioClip, addr 0x6ccdcac, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccdcc4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::StringW url, ::UnityEngine::AudioType audioType);

  /// @brief Method get_audioClip, addr 0x6ccdd94, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioClip> get_audioClip();

  /// @brief Method get_audioClip_Injected, addr 0x6ccded0, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_audioClip_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_streamAudio, addr 0x6ccdf0c, size 0x58, virtual false, abstract: false, final false
  inline void set_streamAudio(bool value);

  /// @brief Method set_streamAudio_Injected, addr 0x6ccdf64, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23076 };
