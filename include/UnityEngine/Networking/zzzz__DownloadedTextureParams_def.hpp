...
public:
  ...
  /// @brief Method SetFlags, addr 0x6e27fb0, size 0x1c, virtual false, abstract: false, final false
  inline void SetFlags(::UnityEngine::Networking::DownloadedTextureFlags flgs, bool add);

  /// @brief Method get_Default, addr 0x6e27f98, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Networking::DownloadedTextureParams get_Default();

  /// @brief Method set_readable, addr 0x6e27fa0, size 0x10, virtual false, abstract: false, final false
