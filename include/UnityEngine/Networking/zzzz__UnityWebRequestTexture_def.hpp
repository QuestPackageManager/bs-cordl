...
public:
  // Declarations
  /// @brief Method GetTexture, addr 0x6c6001c, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Networking::UnityWebRequest* GetTexture(::StringW uri);

  /// @brief Method GetTexture, addr 0x6c60024, size 0x100, virtual false, abstract: false, final false
