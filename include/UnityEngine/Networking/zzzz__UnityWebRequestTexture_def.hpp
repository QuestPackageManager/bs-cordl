...
public:
  // Declarations
  /// @brief Method GetTexture, addr 0x6cd2924, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Networking::UnityWebRequest* GetTexture(::StringW uri);

  /// @brief Method GetTexture, addr 0x6cd292c, size 0x100, virtual false, abstract: false, final false
