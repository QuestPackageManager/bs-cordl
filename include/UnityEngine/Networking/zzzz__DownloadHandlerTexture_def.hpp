...
public:
  ...
  /// @brief Method Create, addr 0x301709c, size 0x44, virtual false, abstract: false, final false
  static inline void* Create(::UnityEngine::Networking::DownloadHandlerTexture* obj, bool readable);

  /// @brief Method Dispose, addr 0x3017138, size 0x24, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetContent, addr 0x30172ac, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> GetContent(::UnityEngine::Networking::UnityWebRequest* www);

  /// @brief Method GetNativeData, addr 0x301712c, size 0xc, virtual true, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method InternalCreateTexture, addr 0x30170e0, size 0x4c, virtual false, abstract: false, final false
  inline void InternalCreateTexture(bool readable);

  /// @brief Method InternalGetTexture, addr 0x3017160, size 0x110, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> InternalGetTexture();

  /// @brief Method InternalGetTextureNative, addr 0x3017270, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x301703c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(bool readable);

  /// @brief Method get_texture, addr 0x301715c, size 0x4, virtual false, abstract: false, final false
