...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6cd2910, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Create, addr 0x6cd259c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Create_Injected, addr 0x6cd25e4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6cd26dc, size 0x60, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetContent, addr 0x6cd28b8, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> GetContent(::UnityEngine::Networking::UnityWebRequest* www);

  /// @brief Method GetNativeData, addr 0x6cd26d0, size 0xc, virtual true, abstract: false, final false
  inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData();

  /// @brief Method InternalCreateTexture, addr 0x6cd2628, size 0x4c, virtual false, abstract: false, final false
  inline void InternalCreateTexture(::UnityEngine::Networking::DownloadedTextureParams parameters);

  /// @brief Method InternalGetTextureNative, addr 0x6cd2740, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> InternalGetTextureNative();

  /// @brief Method InternalGetTextureNative_Injected, addr 0x6cd287c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd2674, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor(bool readable);

  /// @brief Method get_texture, addr 0x6cd273c, size 0x4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23082 };
