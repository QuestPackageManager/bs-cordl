...
public:
  ...
  /// @brief Method BroadcastMessage, addr 0x6986394, size 0x184, virtual false, abstract: false, final false
  inline void BroadcastMessage(::StringW methodName, ::System::Object* parameter, ::UnityEngine::SendMessageOptions options);

  /// @brief Method BroadcastMessage_Injected, addr 0x6986518, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTag, addr 0x6986190, size 0x20, virtual false, abstract: false, final false
  inline bool CompareTag(::StringW tag);

  /// @brief Method GetComponent, addr 0x698558c, size 0x298, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Component> GetComponent(::StringW type);

  /// @brief Method GetComponent, addr 0x6985278, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentFastPath, addr 0x69853f0, size 0x98, virtual false, abstract: false, final false
  inline void GetComponentFastPath(::System::Type* type, ::System::IntPtr oneFurtherThanResultValue);

  /// @brief Method GetComponentFastPath_Injected, addr 0x6985488, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentInChildren, addr 0x6985868, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentInParent, addr 0x6985ac0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponent_Injected, addr 0x6985824, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x6985d18, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x6985eb8, size 0x4, virtual false, abstract: false, final false
  inline void GetComponents(::System::Type* type, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Component>>* results);

  /// @brief Method GetComponentsForListInternal, addr 0x6985dcc, size 0x98, virtual false, abstract: false, final false
  inline void GetComponentsForListInternal(::System::Type* searchType, ::System::Object* resultList);

  /// @brief Method GetComponentsForListInternal_Injected, addr 0x6985e64, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentsInChildren, addr 0x69859f8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentsInParent, addr 0x6985c50, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method SendMessage, addr 0x69861b4, size 0x184, virtual false, abstract: false, final false
  inline void SendMessage(::StringW methodName, ::System::Object* value, ::UnityEngine::SendMessageOptions options);

  /// @brief Method SendMessage_Injected, addr 0x6986338, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetComponent, addr 0x69854dc, size 0x30, virtual false, abstract: false, final false
  inline bool TryGetComponent(::System::Type* type, ::ByRef<::UnityEngine::Component*> component);

  /// @brief Method .ctor, addr 0x6984928, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameObject, addr 0x69850ec, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_gameObject_Injected, addr 0x698523c, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_gameObject_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_tag, addr 0x6985ebc, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_tag();

  /// @brief Method get_transform, addr 0x6984f60, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method get_transform_Injected, addr 0x69850b0, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr get_transform_Injected(::System::IntPtr _unity_self);

  /// @brief Method set_tag, addr 0x6986008, size 0x20, virtual false, abstract: false, final false
