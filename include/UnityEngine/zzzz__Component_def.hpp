...
public:
  ...
  /// @brief Method BroadcastMessage, addr 0x48b6a34, size 0x5c, virtual false, abstract: false, final false
  inline void BroadcastMessage(::StringW methodName, ::System::Object* parameter, ::UnityEngine::SendMessageOptions options);

  /// @brief Method CompareTag, addr 0x48b68c4, size 0x78, virtual false, abstract: false, final false
  inline bool CompareTag(::StringW tag);

  /// @brief Method GetComponent, addr 0x48b6198, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Component> GetComponent(::StringW type);

  /// @brief Method GetComponent, addr 0x48b5f88, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentFastPath, addr 0x48b6044, size 0x54, virtual false, abstract: false, final false
  inline void GetComponentFastPath(::System::Type* type, ::System::IntPtr oneFurtherThanResultValue);

  /// @brief Method GetComponentInChildren, addr 0x48b61dc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentInParent, addr 0x48b63cc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x48b65bc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponents, addr 0x48b6708, size 0x54, virtual false, abstract: false, final false
  inline void GetComponents(::System::Type* type, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Component>>* results);

  /// @brief Method GetComponentsForListInternal, addr 0x48b66b4, size 0x54, virtual false, abstract: false, final false
  inline void GetComponentsForListInternal(::System::Type* searchType, ::System::Object* resultList);

  /// @brief Method GetComponentsInChildren, addr 0x48b62b8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComponentsInParent, addr 0x48b64a8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SendMessage, addr 0x48b69dc, size 0x58, virtual false, abstract: false, final false
  inline void SendMessage(::StringW methodName, ::UnityEngine::SendMessageOptions options);

  /// @brief Method SendMessage, addr 0x48b6980, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetComponent, addr 0x48b6098, size 0x60, virtual false, abstract: false, final false
  inline bool TryGetComponent(::System::Type* type, ::ByRef<::UnityEngine::Component*> component);

  /// @brief Method .ctor, addr 0x48b5514, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameObject, addr 0x48b5f4c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_gameObject();

  /// @brief Method get_tag, addr 0x48b675c, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_tag();

  /// @brief Method get_transform, addr 0x48b5f10, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Method set_tag, addr 0x48b6808, size 0x78, virtual false, abstract: false, final false
