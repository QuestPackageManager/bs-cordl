...
public:
  ...
  /// @brief Method ClearTransformMotion, addr 0x485f9a4, size 0x3c, virtual false, abstract: false, final false
  inline void ClearTransformMotion();

  /// @brief Method GetSelfAndInterCollisionIndices, addr 0x485f9e0, size 0x44, virtual false, abstract: false, final false
  inline void GetSelfAndInterCollisionIndices(::System::Collections::Generic::List_1<uint32_t>* indices);

  /// @brief Method GetVirtualParticleIndices, addr 0x485fa68, size 0x44, virtual false, abstract: false, final false
  inline void GetVirtualParticleIndices(::System::Collections::Generic::List_1<uint32_t>* indicesOutList);

  /// @brief Method GetVirtualParticleWeights, addr 0x485faf0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x485fc2c, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::RaycastHit Raycast(::UnityEngine::Ray ray, float_t maxDistance, ::ByRef<bool> hasHit);

  /// @brief Method Raycast_Injected, addr 0x485fcc0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEnabledFading, addr 0x485fbe4, size 0x48, virtual false, abstract: false, final false
  inline void SetEnabledFading(bool enabled);

  /// @brief Method SetEnabledFading, addr 0x485fb90, size 0x54, virtual false, abstract: false, final false
  inline void SetEnabledFading(bool enabled, float_t interpolationTime);

  /// @brief Method SetSelfAndInterCollisionIndices, addr 0x485fa24, size 0x44, virtual false, abstract: false, final false
  inline void SetSelfAndInterCollisionIndices(::System::Collections::Generic::List_1<uint32_t>* indices);

  /// @brief Method SetVirtualParticleIndices, addr 0x485faac, size 0x44, virtual false, abstract: false, final false
  inline void SetVirtualParticleIndices(::System::Collections::Generic::List_1<uint32_t>* indicesIn);

  /// @brief Method SetVirtualParticleWeights, addr 0x485fb34, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x485fd2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bendingStiffness, addr 0x485ee30, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_bendingStiffness();

  /// @brief Method get_capsuleColliders, addr 0x485eca8, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::CapsuleCollider>, ::Array<::UnityW<::UnityEngine::CapsuleCollider>>*> get_capsuleColliders();

  /// @brief Method get_clothSolverFrequency, addr 0x485f660, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_clothSolverFrequency();

  /// @brief Method get_coefficients, addr 0x485ec28, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::ClothSkinningCoefficient, ::Array<::UnityEngine::ClothSkinningCoefficient>*> get_coefficients();

  /// @brief Method get_collisionMassScale, addr 0x485f3c0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_collisionMassScale();

  /// @brief Method get_damping, addr 0x485ef40, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_damping();

  /// @brief Method get_enableContinuousCollision, addr 0x485f448, size 0x3c, virtual false, abstract: false, final false
  inline bool get_enableContinuousCollision();

  /// @brief Method get_enabled, addr 0x485f2b8, size 0x3c, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_externalAcceleration, addr 0x485efc8, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_externalAcceleration();

  /// @brief Method get_externalAcceleration_Injected, addr 0x485f024, size 0x44, virtual false, abstract: false, final false
  inline void get_externalAcceleration_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_friction, addr 0x485f338, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_friction();

  /// @brief Method get_normals, addr 0x485ebec, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> get_normals();

  /// @brief Method get_randomAcceleration, addr 0x485f100, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_randomAcceleration();

  /// @brief Method get_randomAcceleration_Injected, addr 0x485f15c, size 0x44, virtual false, abstract: false, final false
  inline void get_randomAcceleration_Injected(::ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_selfCollision, addr 0x485fb88, size 0x8, virtual false, abstract: false, final false
  inline bool get_selfCollision();

  /// @brief Method get_selfCollisionDistance, addr 0x485f894, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_selfCollisionDistance();

  /// @brief Method get_selfCollisionStiffness, addr 0x485f91c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_selfCollisionStiffness();

  /// @brief Method get_sleepThreshold, addr 0x485eda8, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_sleepThreshold();

  /// @brief Method get_solverFrequency, addr 0x485f6e8, size 0x48, virtual false, abstract: false, final false
  inline bool get_solverFrequency();

  /// @brief Method get_sphereColliders, addr 0x485ed28, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::ClothSphereColliderPair, ::Array<::UnityEngine::ClothSphereColliderPair>*> get_sphereColliders();

  /// @brief Method get_stiffnessFrequency, addr 0x485f80c, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_stiffnessFrequency();

  /// @brief Method get_stretchingStiffness, addr 0x485eeb8, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_stretchingStiffness();

  /// @brief Method get_useContinuousCollision, addr 0x485fb78, size 0x8, virtual false, abstract: false, final false
  inline float_t get_useContinuousCollision();

  /// @brief Method get_useGravity, addr 0x485f238, size 0x3c, virtual false, abstract: false, final false
  inline bool get_useGravity();

  /// @brief Method get_useTethers, addr 0x485f78c, size 0x3c, virtual false, abstract: false, final false
  inline bool get_useTethers();

  /// @brief Method get_useVirtualParticles, addr 0x485f4c8, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_useVirtualParticles();

  /// @brief Method get_vertices, addr 0x485ebb0, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> get_vertices();

  /// @brief Method get_worldAccelerationScale, addr 0x485f5d8, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_worldAccelerationScale();

  /// @brief Method get_worldVelocityScale, addr 0x485f550, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_worldVelocityScale();

  /// @brief Method set_bendingStiffness, addr 0x485ee6c, size 0x4c, virtual false, abstract: false, final false
  inline void set_bendingStiffness(float_t value);

  /// @brief Method set_capsuleColliders, addr 0x485ece4, size 0x44, virtual false, abstract: false, final false
  inline void set_capsuleColliders(::ArrayW<::UnityEngine::CapsuleCollider*, ::Array<::UnityEngine::CapsuleCollider*>*> value);

  /// @brief Method set_clothSolverFrequency, addr 0x485f69c, size 0x4c, virtual false, abstract: false, final false
  inline void set_clothSolverFrequency(float_t value);

  /// @brief Method set_coefficients, addr 0x485ec64, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_collisionMassScale, addr 0x485f3fc, size 0x4c, virtual false, abstract: false, final false
  inline void set_collisionMassScale(float_t value);

  /// @brief Method set_damping, addr 0x485ef7c, size 0x4c, virtual false, abstract: false, final false
  inline void set_damping(float_t value);

  /// @brief Method set_enableContinuousCollision, addr 0x485f484, size 0x44, virtual false, abstract: false, final false
  inline void set_enableContinuousCollision(bool value);

  /// @brief Method set_enabled, addr 0x485f2f4, size 0x44, virtual false, abstract: false, final false
  inline void set_enabled(bool value);

  /// @brief Method set_externalAcceleration, addr 0x485f068, size 0x54, virtual false, abstract: false, final false
  inline void set_externalAcceleration(::UnityEngine::Vector3 value);

  /// @brief Method set_externalAcceleration_Injected, addr 0x485f0bc, size 0x44, virtual false, abstract: false, final false
  inline void set_externalAcceleration_Injected(::ByRef<::UnityEngine::Vector3> value);

  /// @brief Method set_friction, addr 0x485f374, size 0x4c, virtual false, abstract: false, final false
  inline void set_friction(float_t value);

  /// @brief Method set_randomAcceleration, addr 0x485f1a0, size 0x54, virtual false, abstract: false, final false
  inline void set_randomAcceleration(::UnityEngine::Vector3 value);

  /// @brief Method set_randomAcceleration_Injected, addr 0x485f1f4, size 0x44, virtual false, abstract: false, final false
  inline void set_randomAcceleration_Injected(::ByRef<::UnityEngine::Vector3> value);

  /// @brief Method set_selfCollisionDistance, addr 0x485f8d0, size 0x4c, virtual false, abstract: false, final false
  inline void set_selfCollisionDistance(float_t value);

  /// @brief Method set_selfCollisionStiffness, addr 0x485f958, size 0x4c, virtual false, abstract: false, final false
  inline void set_selfCollisionStiffness(float_t value);

  /// @brief Method set_sleepThreshold, addr 0x485ede4, size 0x4c, virtual false, abstract: false, final false
  inline void set_sleepThreshold(float_t value);

  /// @brief Method set_solverFrequency, addr 0x485f730, size 0x5c, virtual false, abstract: false, final false
  inline void set_solverFrequency(bool value);

  /// @brief Method set_sphereColliders, addr 0x485ed64, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_stiffnessFrequency, addr 0x485f848, size 0x4c, virtual false, abstract: false, final false
  inline void set_stiffnessFrequency(float_t value);

  /// @brief Method set_stretchingStiffness, addr 0x485eef4, size 0x4c, virtual false, abstract: false, final false
  inline void set_stretchingStiffness(float_t value);

  /// @brief Method set_useContinuousCollision, addr 0x485fb80, size 0x8, virtual false, abstract: false, final false
  inline void set_useContinuousCollision(float_t value);

  /// @brief Method set_useGravity, addr 0x485f274, size 0x44, virtual false, abstract: false, final false
  inline void set_useGravity(bool value);

  /// @brief Method set_useTethers, addr 0x485f7c8, size 0x44, virtual false, abstract: false, final false
  inline void set_useTethers(bool value);

  /// @brief Method set_useVirtualParticles, addr 0x485f504, size 0x4c, virtual false, abstract: false, final false
  inline void set_useVirtualParticles(float_t value);

  /// @brief Method set_worldAccelerationScale, addr 0x485f614, size 0x4c, virtual false, abstract: false, final false
  inline void set_worldAccelerationScale(float_t value);

  /// @brief Method set_worldVelocityScale, addr 0x485f58c, size 0x4c, virtual false, abstract: false, final false
