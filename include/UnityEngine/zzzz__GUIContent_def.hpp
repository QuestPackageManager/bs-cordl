...
public:
  ...
  /// @brief Method get_text addr 0x2b9c380 size 0x8 virtual false final false
  inline ::StringW get_text();

  /// @brief Method set_text addr 0x2b9c388 size 0x8 virtual false final false
  inline void set_text(::StringW value);

  /// @brief Method set_image addr 0x2b9c390 size 0x8 virtual false final false
  inline void set_image(::UnityEngine::Texture* value);

  /// @brief Method get_tooltip addr 0x2b94d84 size 0x8 virtual false final false
  inline ::StringW get_tooltip();

  /// @brief Method set_tooltip addr 0x2b9c398 size 0x8 virtual false final false
  inline void set_tooltip(::StringW value);

  static inline ::UnityEngine::GUIContent* New_ctor();

  /// @brief Method .ctor addr 0x2b9c3a0 size 0x5c virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::GUIContent* New_ctor(::StringW text);

  /// @brief Method .ctor addr 0x2b9c3fc size 0x64 virtual false final false
  inline void _ctor(::StringW text);

  static inline ::UnityEngine::GUIContent* New_ctor(::StringW text, ::UnityEngine::Texture* image, ::StringW tooltip);

  /// @brief Method .ctor addr 0x2b9c460 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b93cd8 size 0x84 virtual false final false
  inline void _ctor(::UnityEngine::GUIContent* src);

  /// @brief Method Temp addr 0x2b94698 size 0x8c virtual false final false
  static inline ::UnityEngine::GUIContent* Temp(::StringW t);

  /// @brief Method ClearStaticCache addr 0x2b9be50 size 0xa0 virtual false final false
  static inline void ClearStaticCache();

  /// @brief Method ToString addr 0x2b9c4e4 size 0x20 virtual true final false
