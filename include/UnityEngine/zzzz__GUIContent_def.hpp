...
/// @brief Method ClearStaticCache, addr 0x697921c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method SetTextWithoutNotify, addr 0x69790e8, size 0x8, virtual false, abstract: false, final false
inline void SetTextWithoutNotify(::StringW  value) ;

/// @brief Method Temp, addr 0x697707c, size 0x98, virtual false, abstract: false, final false
static inline ::UnityEngine::GUIContent* Temp(::StringW  t) ;

/// @brief Method ToString, addr 0x69792b8, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6979100, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x69791d0, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GUIContent*  src) ;

/// @brief Method .ctor, addr 0x697911c, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  text) ;

/// @brief Method .ctor, addr 0x6979154, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, ::UnityEngine::Texture*  image, ::StringW  tooltip) ;

/// @brief Method .ctor, addr 0x6979194, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, ::StringW  tooltip) ;

/// @brief Method add_OnTextChanged, addr 0x6978e44, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method get_text, addr 0x6978f9c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method get_textWithWhitespace, addr 0x6979078, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_textWithWhitespace() ;

/// @brief Method get_tooltip, addr 0x6977858, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_tooltip() ;

/// @brief Method remove_OnTextChanged, addr 0x6978ef0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method set_image, addr 0x69790f0, size 0x8, virtual false, abstract: false, final false
inline void set_image(::UnityEngine::Texture*  value) ;

/// @brief Method set_text, addr 0x6978fa4, size 0x58, virtual false, abstract: false, final false
inline void set_text(::StringW  value) ;

/// @brief Method set_textWithWhitespace, addr 0x6978ffc, size 0x7c, virtual false, abstract: false, final false
inline void set_textWithWhitespace(::StringW  value) ;

/// @brief Method set_tooltip, addr 0x69790f8, size 0x8, virtual false, abstract: false, final false
