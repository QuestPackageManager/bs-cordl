...
public:
  ...
  /// @brief Method ClearStaticCache, addr 0x48ddc74, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Temp, addr 0x48dbda4, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIContent* Temp(::StringW t);

  /// @brief Method ToString, addr 0x48ddd14, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48dda98, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x48ddbe4, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GUIContent* src);

  /// @brief Method .ctor, addr 0x48ddaf4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x48ddb58, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x48dda28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_tooltip, addr 0x48dc5e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_image, addr 0x48dda88, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::Texture* value);

  /// @brief Method set_text, addr 0x48dda30, size 0x58, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_tooltip, addr 0x48dda90, size 0x8, virtual false, abstract: false, final false
