...
public:
  ...
  /// @brief Method ClearStaticCache, addr 0x6978b5c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTextWithoutNotify, addr 0x6978a28, size 0x8, virtual false, abstract: false, final false
  inline void SetTextWithoutNotify(::StringW value);

  /// @brief Method Temp, addr 0x69769bc, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::GUIContent* Temp(::StringW t);

  /// @brief Method ToString, addr 0x6978bf8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6978a40, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6978b10, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::GUIContent* src);

  /// @brief Method .ctor, addr 0x6978a5c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x6978a94, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::StringW text, ::UnityEngine::Texture* image, ::StringW tooltip);

  /// @brief Method .ctor, addr 0x6978ad4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::StringW text, ::StringW tooltip);

  /// @brief Method add_OnTextChanged, addr 0x6978784, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x69788dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_textWithWhitespace, addr 0x69789b8, size 0x70, virtual false, abstract: false, final false
  inline ::StringW get_textWithWhitespace();

  /// @brief Method get_tooltip, addr 0x6977198, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method remove_OnTextChanged, addr 0x6978830, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method set_image, addr 0x6978a30, size 0x8, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::Texture* value);

  /// @brief Method set_text, addr 0x69788e4, size 0x58, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_textWithWhitespace, addr 0x697893c, size 0x7c, virtual false, abstract: false, final false
  inline void set_textWithWhitespace(::StringW value);

  /// @brief Method set_tooltip, addr 0x6978a38, size 0x8, virtual false, abstract: false, final false
