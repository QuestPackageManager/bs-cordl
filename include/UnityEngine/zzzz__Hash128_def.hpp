...
template<typename T>
inline void Append(::ByRef<T>  val) ;

/// @brief Method Append, addr 0x68fd900, size 0x4, virtual false, abstract: false, final false
inline void Append(int32_t  val) ;

/// @brief Method CompareTo, addr 0x68fda28, size 0xb8, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CompareTo, addr 0x68fd518, size 0x4c, virtual true, abstract: false, final true
...
template<typename T>
static inline ::UnityEngine::Hash128 Compute(::ByRef<T>  val) ;

/// @brief Method Compute, addr 0x68fd8a8, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Compute(int32_t  val) ;

/// @brief Method ComputeFromPtr, addr 0x68fd83c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x68fd96c, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x68fd9fc, size 0x14, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Hash128  obj) ;

/// @brief Method GetHashCode, addr 0x68fda10, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Hash128ToStringImpl, addr 0x68fd5b0, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW Hash128ToStringImpl(::UnityEngine::Hash128  hash) ;

/// @brief Method Hash128ToStringImpl_Injected, addr 0x68fd7f8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x68fd680, size 0x134, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Parse(::StringW  hashString) ;

/// @brief Method Parse_Injected, addr 0x68fd7b4, size 0x44, virtual false, abstract: false, final false
static inline void Parse_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  hashString, ::ByRef<::UnityEngine::Hash128>  ret) ;

/// @brief Method Rot64, addr 0x68fdc84, size 0x14, virtual false, abstract: false, final false
static inline void Rot64(::ByRef<uint64_t>  x, int32_t  k) ;

/// @brief Method ShortEnd, addr 0x68fdaf0, size 0x194, virtual false, abstract: false, final false
static inline void ShortEnd(::ByRef<uint64_t>  h0, ::ByRef<uint64_t>  h1, ::ByRef<uint64_t>  h2, ::ByRef<uint64_t>  h3) ;

/// @brief Method ShortHash4, addr 0x68fd904, size 0x68, virtual false, abstract: false, final false
inline void ShortHash4(uint32_t  data) ;

/// @brief Method ToString, addr 0x68fd5a4, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x68fd4d8, size 0x18, virtual false, abstract: false, final false
inline void _ctor(uint32_t  u32_0, uint32_t  u32_1, uint32_t  u32_2, uint32_t  u32_3) ;

/// @brief Method .ctor, addr 0x68fd4f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint64_t  u64_0, uint64_t  u64_1) ;

/// @brief Method get_isValid, addr 0x68fd4f8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x68fd9ec, size 0x10, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::Hash128  hash1, ::UnityEngine::Hash128  hash2) ;

/// @brief Method op_GreaterThan, addr 0x68fd57c, size 0x28, virtual false, abstract: false, final false
static inline bool op_GreaterThan(::UnityEngine::Hash128  x, ::UnityEngine::Hash128  y) ;

/// @brief Method op_Inequality, addr 0x68fdae0, size 0x10, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::Hash128  hash1, ::UnityEngine::Hash128  hash2) ;

/// @brief Method op_LessThan, addr 0x68fd564, size 0x18, virtual false, abstract: false, final false
