...
public:
// Declarations
/// @brief Method Dispose, addr 0x68b86c4, size 0x70, virtual false, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method Execute, addr 0x68b8734, size 0x4, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method CalculateInterpolatedLightAndOcclusionProbes, addr 0x68b8650, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method CalculateInterpolatedLightAndOcclusionProbes, addr 0x68b8488, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method Create, addr 0x68b821c, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr Create() ;

/// @brief Method Destroy, addr 0x68b8350, size 0x3c, virtual false, abstract: false, final false
static inline void Destroy(::System::IntPtr  lightProbeContextWrapper) ;

/// @brief Method Dispose, addr 0x68b838c, size 0xfc, virtual false, abstract: false, final false
inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle  inputDeps) ;

/// @brief Method Dispose, addr 0x68b8244, size 0x10c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x68b819c, size 0x80, virtual false, abstract: false, final false
