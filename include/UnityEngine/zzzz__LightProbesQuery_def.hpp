...
public:
  // Declarations
  /// @brief Method Dispose, addr 0x692a8e0, size 0x70, virtual false, abstract: false, final false
  inline void Dispose();
...
public:
  ...
  /// @brief Method Execute, addr 0x692a950, size 0x4, virtual true, abstract: false, final true
  inline void Execute();
...
public:
  ...
  /// @brief Method CalculateInterpolatedLightAndOcclusionProbes, addr 0x692a86c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateInterpolatedLightAndOcclusionProbes, addr 0x692a6a4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x692a438, size 0x28, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create();

  /// @brief Method Destroy, addr 0x692a56c, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr lightProbeContextWrapper);

  /// @brief Method Dispose, addr 0x692a5a8, size 0xfc, virtual false, abstract: false, final false
  inline ::Unity::Jobs::JobHandle Dispose(::Unity::Jobs::JobHandle inputDeps);

  /// @brief Method Dispose, addr 0x692a460, size 0x10c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x692a3b8, size 0x80, virtual false, abstract: false, final false
