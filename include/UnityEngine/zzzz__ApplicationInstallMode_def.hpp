...
DEFINE_IL2CPP_CLASS(::UnityEngine::ApplicationInstallMode, "UnityEngine", "ApplicationInstallMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::ApplicationInstallMode) == 0x4, "Size mismatch!");
