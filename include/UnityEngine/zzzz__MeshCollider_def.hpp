...
public:
  ...
  __declspec(property(put = set_convex)) bool convex;

  /// @brief Method get_sharedMesh addr 0x2baf258 size 0x3c virtual false final false
  inline ::UnityEngine::Mesh* get_sharedMesh();

  /// @brief Method set_sharedMesh addr 0x2baf294 size 0x44 virtual false final false
  inline void set_sharedMesh(::UnityEngine::Mesh* value);

  /// @brief Method set_convex addr 0x2baf2d8 size 0x44 virtual false final false
