...
public:
  ...
  /// @brief Method .ctor, addr 0x484da48, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isLooping, addr 0x48548dc, size 0x3c, virtual false, abstract: false, final false
