...
public:
  // Declarations
  /// @brief Method FindObjectsOfTypeAll, addr 0x69809ec, size 0x3c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Object>, ::Array<::UnityW<::UnityEngine::Object>>*> FindObjectsOfTypeAll(::System::Type* type);

  /// @brief Method FindShaderByName, addr 0x6980a28, size 0x274, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> FindShaderByName(::StringW name);

  /// @brief Method FindShaderByName_Injected, addr 0x6980c9c, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr FindShaderByName_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> name);

  /// @brief Method Load, addr 0x6980cd8, size 0x28c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Object> Load(::StringW path, ::System::Type* systemTypeInstance);

  /// @brief Method LoadAll, addr 0x6980fa8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadAll_Injected, addr 0x6981130, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Load_Injected, addr 0x6980f64, size 0x44, virtual false, abstract: false, final false
