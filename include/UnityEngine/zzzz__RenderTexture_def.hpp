...
public:
  ...
  /// @brief Method get_width, addr 0x2cb483c, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method set_width, addr 0x2cb4878, size 0x44, virtual true, abstract: false, final false
  inline void set_width(int32_t value);

  /// @brief Method get_height, addr 0x2cb48bc, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method set_height, addr 0x2cb48f8, size 0x44, virtual true, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_dimension, addr 0x2cb493c, size 0x44, virtual true, abstract: false, final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method get_graphicsFormat, addr 0x2cb4980, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat();

  /// @brief Method set_graphicsFormat, addr 0x2cb49bc, size 0x44, virtual false, abstract: false, final false
  inline void set_graphicsFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_useMipMap, addr 0x2cb4a00, size 0x44, virtual false, abstract: false, final false
  inline void set_useMipMap(bool value);

  /// @brief Method get_sRGB, addr 0x2cb4a44, size 0x3c, virtual false, abstract: false, final false
  inline bool get_sRGB();

  /// @brief Method get_vrUsage, addr 0x2cb4a80, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::VRTextureUsage get_vrUsage();

  /// @brief Method get_format, addr 0x2cb4abc, size 0x114, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method set_depthStencilFormat, addr 0x2cb4c48, size 0x44, virtual false, abstract: false, final false
  inline void set_depthStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method get_antiAliasing, addr 0x2cb4c8c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_antiAliasing();

  /// @brief Method set_antiAliasing, addr 0x2cb4cc8, size 0x44, virtual false, abstract: false, final false
  inline void set_antiAliasing(int32_t value);

  /// @brief Method GetActive, addr 0x2cb4d0c, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetActive();

  /// @brief Method SetActive, addr 0x2cb4d34, size 0x3c, virtual false, abstract: false, final false
  static inline void SetActive(::UnityEngine::RenderTexture* rt);

  /// @brief Method get_active, addr 0x2cb4d70, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> get_active();

  /// @brief Method set_active, addr 0x2cb4d98, size 0x3c, virtual false, abstract: false, final false
  static inline void set_active(::UnityEngine::RenderTexture* value);

  /// @brief Method GetColorBuffer, addr 0x2cb4dd4, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer GetColorBuffer();

  /// @brief Method GetDepthBuffer, addr 0x2cb4e6c, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer GetDepthBuffer();

  /// @brief Method SetMipMapCount, addr 0x2cb4f04, size 0x44, virtual false, abstract: false, final false
  inline void SetMipMapCount(int32_t count);

  /// @brief Method get_colorBuffer, addr 0x2cb4f48, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer get_colorBuffer();

  /// @brief Method get_depthBuffer, addr 0x2cb4f4c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer get_depthBuffer();

  /// @brief Method DiscardContents, addr 0x2cb4f50, size 0x54, virtual false, abstract: false, final false
  inline void DiscardContents(bool discardColor, bool discardDepth);

  /// @brief Method DiscardContents, addr 0x2cb4fa4, size 0x44, virtual false, abstract: false, final false
  inline void DiscardContents();

  /// @brief Method Create, addr 0x2cb4fe8, size 0x3c, virtual false, abstract: false, final false
  inline bool Create();

  /// @brief Method Release, addr 0x2cb5024, size 0x3c, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method IsCreated, addr 0x2cb5060, size 0x3c, virtual false, abstract: false, final false
  inline bool IsCreated();

  /// @brief Method SetSRGBReadWrite, addr 0x2cb509c, size 0x44, virtual false, abstract: false, final false
  inline void SetSRGBReadWrite(bool srgb);

  /// @brief Method Internal_Create, addr 0x2cb50e0, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Create(::UnityEngine::RenderTexture* rt);

  /// @brief Method SetRenderTextureDescriptor, addr 0x2cb511c, size 0x44, virtual false, abstract: false, final false
  inline void SetRenderTextureDescriptor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetDescriptor, addr 0x2cb4bd0, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureDescriptor GetDescriptor();

  /// @brief Method GetTemporary_Internal, addr 0x2cb51e8, size 0x3c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporary_Internal(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method ReleaseTemporary, addr 0x2cb5260, size 0x3c, virtual false, abstract: false, final false
  static inline void ReleaseTemporary(::UnityEngine::RenderTexture* temp);

  static inline ::UnityEngine::RenderTexture* New_ctor();

  /// @brief Method .ctor, addr 0x2cb529c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::RenderTexture* New_ctor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method .ctor, addr 0x2cb52f0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5838, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5a34, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5a80, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5b10, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5d94, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb5f98, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, ::UnityEngine::Experimental::Rendering::GraphicsFormat depthStencilFormat);
  ...
  /// @brief Method .ctor, addr 0x2cb6028, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb62ac, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb63dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb633c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::RenderTextureFormat format, int32_t mipCount);

  /// @brief Method Initialize, addr 0x2cb60d0, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDepthStencilFormatLegacy, addr 0x2cb5d10, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_descriptor, addr 0x2cb59a4, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureDescriptor get_descriptor();

  /// @brief Method ValidateRenderTextureDesc, addr 0x2cb53e8, size 0x450, virtual false, abstract: false, final false
  static inline void ValidateRenderTextureDesc(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetCompatibleFormat, addr 0x2cb63e4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTemporary, addr 0x2cb654c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporary(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetTemporaryImpl, addr 0x2cb65e8, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTemporary, addr 0x2cb6778, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTemporary, addr 0x2cb67dc, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporary(int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::RenderTextureFormat format,
                                                                    ::UnityEngine::RenderTextureReadWrite readWrite);

  /// @brief Method GetTemporary, addr 0x2cb6834, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporary(int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::RenderTextureFormat format);

  /// @brief Method GetTemporary, addr 0x2cb688c, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::RenderTexture> GetTemporary(int32_t width, int32_t height);

  /// @brief Method GetColorBuffer_Injected, addr 0x2cb4e28, size 0x44, virtual false, abstract: false, final false
  inline void GetColorBuffer_Injected(ByRef<::UnityEngine::RenderBuffer> ret);

  /// @brief Method GetDepthBuffer_Injected, addr 0x2cb4ec0, size 0x44, virtual false, abstract: false, final false
  inline void GetDepthBuffer_Injected(ByRef<::UnityEngine::RenderBuffer> ret);

  /// @brief Method SetRenderTextureDescriptor_Injected, addr 0x2cb5160, size 0x44, virtual false, abstract: false, final false
  inline void SetRenderTextureDescriptor_Injected(ByRef<::UnityEngine::RenderTextureDescriptor> desc);

  /// @brief Method GetDescriptor_Injected, addr 0x2cb51a4, size 0x44, virtual false, abstract: false, final false
  inline void GetDescriptor_Injected(ByRef<::UnityEngine::RenderTextureDescriptor> ret);

  /// @brief Method GetTemporary_Internal_Injected, addr 0x2cb5224, size 0x3c, virtual false, abstract: false, final false
