...
public:
  ...
  /// @brief Method get_width addr 0x2b4d690 size 0x3c virtual true final false
  inline int32_t get_width();

  /// @brief Method set_width addr 0x2b4d6cc size 0x44 virtual true final false
  inline void set_width(int32_t value);

  /// @brief Method get_height addr 0x2b4d710 size 0x3c virtual true final false
  inline int32_t get_height();

  /// @brief Method set_height addr 0x2b4d74c size 0x44 virtual true final false
  inline void set_height(int32_t value);

  /// @brief Method set_dimension addr 0x2b4d790 size 0x44 virtual true final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method get_graphicsFormat addr 0x2b4d7d4 size 0x3c virtual false final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat();

  /// @brief Method set_graphicsFormat addr 0x2b4d810 size 0x44 virtual false final false
  inline void set_graphicsFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_useMipMap addr 0x2b4d854 size 0x44 virtual false final false
  inline void set_useMipMap(bool value);

  /// @brief Method get_sRGB addr 0x2b4d898 size 0x3c virtual false final false
  inline bool get_sRGB();

  /// @brief Method get_vrUsage addr 0x2b4d8d4 size 0x3c virtual false final false
  inline ::UnityEngine::VRTextureUsage get_vrUsage();

  /// @brief Method get_format addr 0x2b4d910 size 0x114 virtual false final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method set_depthStencilFormat addr 0x2b4da9c size 0x44 virtual false final false
  inline void set_depthStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method get_antiAliasing addr 0x2b4dae0 size 0x3c virtual false final false
  inline int32_t get_antiAliasing();

  /// @brief Method set_antiAliasing addr 0x2b4db1c size 0x44 virtual false final false
  inline void set_antiAliasing(int32_t value);

  /// @brief Method GetActive addr 0x2b4db60 size 0x28 virtual false final false
  static inline ::UnityEngine::RenderTexture* GetActive();

  /// @brief Method SetActive addr 0x2b4db88 size 0x3c virtual false final false
  static inline void SetActive(::UnityEngine::RenderTexture* rt);

  /// @brief Method get_active addr 0x2b4dbc4 size 0x28 virtual false final false
  static inline ::UnityEngine::RenderTexture* get_active();

  /// @brief Method set_active addr 0x2b4dbec size 0x3c virtual false final false
  static inline void set_active(::UnityEngine::RenderTexture* value);

  /// @brief Method GetColorBuffer addr 0x2b4dc28 size 0x54 virtual false final false
  inline ::UnityEngine::RenderBuffer GetColorBuffer();

  /// @brief Method GetDepthBuffer addr 0x2b4dcc0 size 0x54 virtual false final false
  inline ::UnityEngine::RenderBuffer GetDepthBuffer();

  /// @brief Method SetMipMapCount addr 0x2b4dd58 size 0x44 virtual false final false
  inline void SetMipMapCount(int32_t count);

  /// @brief Method get_colorBuffer addr 0x2b4dd9c size 0x4 virtual false final false
  inline ::UnityEngine::RenderBuffer get_colorBuffer();

  /// @brief Method get_depthBuffer addr 0x2b4dda0 size 0x4 virtual false final false
  inline ::UnityEngine::RenderBuffer get_depthBuffer();

  /// @brief Method DiscardContents addr 0x2b4dda4 size 0x54 virtual false final false
  inline void DiscardContents(bool discardColor, bool discardDepth);

  /// @brief Method DiscardContents addr 0x2b4ddf8 size 0x44 virtual false final false
  inline void DiscardContents();

  /// @brief Method Create addr 0x2b4de3c size 0x3c virtual false final false
  inline bool Create();

  /// @brief Method Release addr 0x2b4de78 size 0x3c virtual false final false
  inline void Release();

  /// @brief Method IsCreated addr 0x2b4deb4 size 0x3c virtual false final false
  inline bool IsCreated();

  /// @brief Method SetSRGBReadWrite addr 0x2b4def0 size 0x44 virtual false final false
  inline void SetSRGBReadWrite(bool srgb);

  /// @brief Method Internal_Create addr 0x2b4df34 size 0x3c virtual false final false
  static inline void Internal_Create(::UnityEngine::RenderTexture* rt);

  /// @brief Method SetRenderTextureDescriptor addr 0x2b4df70 size 0x44 virtual false final false
  inline void SetRenderTextureDescriptor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetDescriptor addr 0x2b4da24 size 0x78 virtual false final false
  inline ::UnityEngine::RenderTextureDescriptor GetDescriptor();

  /// @brief Method GetTemporary_Internal addr 0x2b4e03c size 0x3c virtual false final false
  static inline ::UnityEngine::RenderTexture* GetTemporary_Internal(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method ReleaseTemporary addr 0x2b4e0b4 size 0x3c virtual false final false
  static inline void ReleaseTemporary(::UnityEngine::RenderTexture* temp);

  static inline ::UnityEngine::RenderTexture* New_ctor();

  /// @brief Method .ctor addr 0x2b4e0f0 size 0x54 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::RenderTexture* New_ctor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method .ctor addr 0x2b4e144 size 0xf8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4e68c size 0x16c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4e888 size 0x4c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4e8d4 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4e964 size 0x200 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4ebe8 size 0x204 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4edec size 0x90 virtual false final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, ::UnityEngine::Experimental::Rendering::GraphicsFormat depthStencilFormat);
  ...
  /// @brief Method .ctor addr 0x2b4ee7c size 0xa8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4f100 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4f230 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4f190 size 0xa0 virtual false final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::RenderTextureFormat format, int32_t mipCount);

  /// @brief Method Initialize addr 0x2b4ef24 size 0x1dc virtual false final false
  ...
  /// @brief Method GetDepthStencilFormatLegacy addr 0x2b4eb64 size 0x84 virtual false final false
  ...
  /// @brief Method get_descriptor addr 0x2b4e7f8 size 0x90 virtual false final false
  inline ::UnityEngine::RenderTextureDescriptor get_descriptor();

  /// @brief Method ValidateRenderTextureDesc addr 0x2b4e23c size 0x450 virtual false final false
  static inline void ValidateRenderTextureDesc(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetCompatibleFormat addr 0x2b4f238 size 0x160 virtual false final false
  ...
  /// @brief Method GetTemporary addr 0x2b4f3a0 size 0x80 virtual false final false
  static inline ::UnityEngine::RenderTexture* GetTemporary(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetTemporaryImpl addr 0x2b4f43c size 0xb8 virtual false final false
  ...
  /// @brief Method GetTemporary addr 0x2b4f5cc size 0x64 virtual false final false
  ...
  /// @brief Method GetTemporary addr 0x2b4f630 size 0x58 virtual false final false
  static inline ::UnityEngine::RenderTexture* GetTemporary(int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::RenderTextureFormat format,
                                                           ::UnityEngine::RenderTextureReadWrite readWrite);

  /// @brief Method GetTemporary addr 0x2b4f688 size 0x58 virtual false final false
  static inline ::UnityEngine::RenderTexture* GetTemporary(int32_t width, int32_t height, int32_t depthBuffer, ::UnityEngine::RenderTextureFormat format);

  /// @brief Method GetTemporary addr 0x2b4f6e0 size 0x54 virtual false final false
  static inline ::UnityEngine::RenderTexture* GetTemporary(int32_t width, int32_t height);

  /// @brief Method GetColorBuffer_Injected addr 0x2b4dc7c size 0x44 virtual false final false
  inline void GetColorBuffer_Injected(ByRef<::UnityEngine::RenderBuffer> ret);

  /// @brief Method GetDepthBuffer_Injected addr 0x2b4dd14 size 0x44 virtual false final false
  inline void GetDepthBuffer_Injected(ByRef<::UnityEngine::RenderBuffer> ret);

  /// @brief Method SetRenderTextureDescriptor_Injected addr 0x2b4dfb4 size 0x44 virtual false final false
  inline void SetRenderTextureDescriptor_Injected(ByRef<::UnityEngine::RenderTextureDescriptor> desc);

  /// @brief Method GetDescriptor_Injected addr 0x2b4dff8 size 0x44 virtual false final false
  inline void GetDescriptor_Injected(ByRef<::UnityEngine::RenderTextureDescriptor> ret);

  /// @brief Method GetTemporary_Internal_Injected addr 0x2b4e078 size 0x3c virtual false final false
