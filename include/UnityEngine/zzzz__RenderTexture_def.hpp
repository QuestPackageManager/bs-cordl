...
public:
  ...
  /// @brief Method get_width, addr 0x2cb2aa0, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method set_width, addr 0x2cb2adc, size 0x44, virtual true, abstract: false, final false
  inline void set_width(int32_t value);

  /// @brief Method get_height, addr 0x2cb2b20, size 0x3c, virtual true, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method set_height, addr 0x2cb2b5c, size 0x44, virtual true, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_dimension, addr 0x2cb2ba0, size 0x44, virtual true, abstract: false, final false
  inline void set_dimension(::UnityEngine::Rendering::TextureDimension value);

  /// @brief Method get_graphicsFormat, addr 0x2cb2be4, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat();

  /// @brief Method set_graphicsFormat, addr 0x2cb2c20, size 0x44, virtual false, abstract: false, final false
  inline void set_graphicsFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method set_useMipMap, addr 0x2cb2c64, size 0x44, virtual false, abstract: false, final false
  inline void set_useMipMap(bool value);

  /// @brief Method get_sRGB, addr 0x2cb2ca8, size 0x3c, virtual false, abstract: false, final false
  inline bool get_sRGB();

  /// @brief Method get_vrUsage, addr 0x2cb2ce4, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::VRTextureUsage get_vrUsage();

  /// @brief Method get_format, addr 0x2cb2d20, size 0x114, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method set_depthStencilFormat, addr 0x2cb2eac, size 0x44, virtual false, abstract: false, final false
  inline void set_depthStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat value);

  /// @brief Method get_antiAliasing, addr 0x2cb2ef0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_antiAliasing();

  /// @brief Method set_antiAliasing, addr 0x2cb2f2c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColorBuffer, addr 0x2cb3038, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer GetColorBuffer();

  /// @brief Method GetDepthBuffer, addr 0x2cb30d0, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer GetDepthBuffer();

  /// @brief Method SetMipMapCount, addr 0x2cb3168, size 0x44, virtual false, abstract: false, final false
  inline void SetMipMapCount(int32_t count);

  /// @brief Method get_colorBuffer, addr 0x2cb31ac, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer get_colorBuffer();

  /// @brief Method get_depthBuffer, addr 0x2cb31b0, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderBuffer get_depthBuffer();

  /// @brief Method DiscardContents, addr 0x2cb31b4, size 0x54, virtual false, abstract: false, final false
  inline void DiscardContents(bool discardColor, bool discardDepth);

  /// @brief Method DiscardContents, addr 0x2cb3208, size 0x44, virtual false, abstract: false, final false
  inline void DiscardContents();

  /// @brief Method Create, addr 0x2cb324c, size 0x3c, virtual false, abstract: false, final false
  inline bool Create();

  /// @brief Method Release, addr 0x2cb3288, size 0x3c, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method IsCreated, addr 0x2cb32c4, size 0x3c, virtual false, abstract: false, final false
  inline bool IsCreated();

  /// @brief Method SetSRGBReadWrite, addr 0x2cb3300, size 0x44, virtual false, abstract: false, final false
  inline void SetSRGBReadWrite(bool srgb);

  /// @brief Method Internal_Create, addr 0x2cb3344, size 0x3c, virtual false, abstract: false, final false
  static inline void Internal_Create(::UnityEngine::RenderTexture* rt);

  /// @brief Method SetRenderTextureDescriptor, addr 0x2cb3380, size 0x44, virtual false, abstract: false, final false
  inline void SetRenderTextureDescriptor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetDescriptor, addr 0x2cb2e34, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3500, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::RenderTexture* New_ctor(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method .ctor, addr 0x2cb3554, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3a9c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3c98, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3ce4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3d74, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3ff8, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb41fc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, ::UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, ::UnityEngine::Experimental::Rendering::GraphicsFormat depthStencilFormat);
  ...
  /// @brief Method .ctor, addr 0x2cb428c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4510, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4640, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb45a0, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::RenderTextureFormat format, int32_t mipCount);

  /// @brief Method Initialize, addr 0x2cb4334, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDepthStencilFormatLegacy, addr 0x2cb3f74, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_descriptor, addr 0x2cb3c08, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureDescriptor get_descriptor();

  /// @brief Method ValidateRenderTextureDesc, addr 0x2cb364c, size 0x450, virtual false, abstract: false, final false
  static inline void ValidateRenderTextureDesc(::UnityEngine::RenderTextureDescriptor desc);

  /// @brief Method GetCompatibleFormat, addr 0x2cb4648, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDepthBuffer_Injected, addr 0x2cb3124, size 0x44, virtual false, abstract: false, final false
  inline void GetDepthBuffer_Injected(ByRef<::UnityEngine::RenderBuffer> ret);

  /// @brief Method SetRenderTextureDescriptor_Injected, addr 0x2cb33c4, size 0x44, virtual false, abstract: false, final false
  inline void SetRenderTextureDescriptor_Injected(ByRef<::UnityEngine::RenderTextureDescriptor> desc);

  /// @brief Method GetDescriptor_Injected, addr 0x2cb3408, size 0x44, virtual false, abstract: false, final false
