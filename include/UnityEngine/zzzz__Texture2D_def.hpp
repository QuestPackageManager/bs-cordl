...
public:
  ...
  static inline ::UnityEngine::Texture2D* New_ctor(int32_t width, int32_t height, /* [DefaultValue("TextureFormat.RGBA32")] */ ::UnityEngine::TextureFormat textureFormat,
...
public:
  ...
  Texture2D(Texture2Dconst&) = delete;
