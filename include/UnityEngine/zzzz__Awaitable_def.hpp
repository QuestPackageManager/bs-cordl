...
public:
  ...
  /// @brief Method get_Awaitable, addr 0x698445c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Awaitable* get_Awaitable();

  /// @brief Method get_FrameIndex, addr 0x6984464, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x6982cdc, size 0x78, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::UnityEngine::Awaitable_DoubleBufferedAwaitableList* New_ctor();

  /// @brief Method SwapAndComplete, addr 0x6982db8, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69843c8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6984494, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsManaged, addr 0x6983b5c, size 0x6c, virtual false, abstract: false, final false
  inline bool get_IsManaged();

  /// @brief Method get_IsNull, addr 0x6983bc8, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsNull();

  /// @brief Method op_Implicit, addr 0x698449c, size 0x4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__76_0, addr 0x698454c, size 0x140, virtual false, abstract: false, final false
  inline ::UnityEngine::Pool::ObjectPool_1<::UnityEngine::Awaitable*>* __cctor_b__76_0();

  /// @brief Method <.cctor>b__76_1, addr 0x698468c, size 0x4c, virtual false, abstract: false, final false
  inline ::UnityEngine::Awaitable* __cctor_b__76_1();

  /// @brief Method .ctor, addr 0x6984548, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckPointerValidity, addr 0x6984168, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::Awaitable_AwaitableHandle CheckPointerValidity();

  /// @brief Method DoRunContinuationOnSynchonizationContext, addr 0x69835fc, size 0x70, virtual false, abstract: false, final false
  static inline void DoRunContinuationOnSynchonizationContext(::System::Object* continuation);

  /// @brief Method IsNativeAwaitableCompleted, addr 0x6982c24, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t IsNativeAwaitableCompleted(::System::IntPtr nativeAwaitable);

  /// @brief Method MatchCompletionThreadAffinity, addr 0x698321c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method NewManagedAwaitable, addr 0x698312c, size 0xf0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Awaitable* NewManagedAwaitable();

  static inline ::UnityEngine::Awaitable* New_ctor();

  /// @brief Method OnDelayedCallManagerCleared, addr 0x6982c60, size 0x7c, virtual false, abstract: false, final false
  static inline void OnDelayedCallManagerCleared();

  /// @brief Method OnEndOfFrame, addr 0x6983050, size 0x64, virtual false, abstract: false, final false
  static inline void OnEndOfFrame();

  /// @brief Method OnUpdate, addr 0x6982d54, size 0x64, virtual false, abstract: false, final false
  static inline void OnUpdate();

  /// @brief Method PropagateExceptionAndRelease, addr 0x69837b8, size 0x3a4, virtual false, abstract: false, final false
  inline void PropagateExceptionAndRelease();

  /// @brief Method RaiseManagedCompletion, addr 0x698366c, size 0x14c, virtual false, abstract: false, final false
  inline void RaiseManagedCompletion();

  /// @brief Method RaiseManagedCompletion, addr 0x6983304, size 0x184, virtual false, abstract: false, final false
  inline void RaiseManagedCompletion(::System::Exception* exception);

  /// @brief Method ReleaseNativeAwaitable, addr 0x6982be8, size 0x3c, virtual false, abstract: false, final false
  static inline void ReleaseNativeAwaitable(::System::IntPtr nativeAwaitable);

  /// @brief Method RunContinuation, addr 0x6982ab0, size 0x138, virtual false, abstract: false, final false
  inline void RunContinuation();

  /// @brief Method RunOrScheduleContinuation, addr 0x6983488, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExceptionFromNative, addr 0x698297c, size 0x134, virtual false, abstract: false, final false
  inline void SetExceptionFromNative(::System::Exception* ex);

  /// @brief Method SetSynchronizationContext, addr 0x69830b4, size 0x70, virtual false, abstract: false, final false
  static inline void SetSynchronizationContext(::UnityEngine::UnitySynchronizationContext* synchronizationContext);

  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x6984210, size 0x34, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6984244, size 0x4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6984248, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6983124, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsCompleted, addr 0x6983d78, size 0x12c, virtual false, abstract: false, final false
  inline bool get_IsCompleted();

  /// @brief Method get_IsCompletedNoLock, addr 0x6983bd8, size 0x1a0, virtual false, abstract: false, final false
  inline bool get_IsCompletedNoLock();

  /// @brief Method get_IsDettachedOrCompleted, addr 0x6983ea4, size 0x2c4, virtual false, abstract: false, final false
