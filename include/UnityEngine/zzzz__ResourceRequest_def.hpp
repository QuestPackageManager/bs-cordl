...
public:
  ...
  /// @brief Method GetResult, addr 0x48b3c3c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48b3ccc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_asset, addr 0x48b3cc0, size 0xc, virtual false, abstract: false, final false
