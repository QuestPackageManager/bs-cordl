...
public:
  ...
  /// @brief Method GetResult, addr 0x690dfe4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x690e078, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method get_asset, addr 0x690e06c, size 0xc, virtual false, abstract: false, final false
