...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x31f7700, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f763c, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SendEvents, addr 0x31f75e0, size 0x5c, virtual false, abstract: false, final false
