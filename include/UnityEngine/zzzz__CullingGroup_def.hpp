...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2db497c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2db48b8, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SendEvents, addr 0x2db485c, size 0x5c, virtual false, abstract: false, final false
