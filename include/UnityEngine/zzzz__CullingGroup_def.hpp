...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x486ae68, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x486addc, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SendEvents, addr 0x486ad80, size 0x5c, virtual false, abstract: false, final false
