...
public:
  ...
  /// @brief Method get_deviceEyeTextureDimension, addr 0x4aedbc8, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rendering::TextureDimension get_deviceEyeTextureDimension();

  /// @brief Method get_enabled, addr 0x4aeda64, size 0x28, virtual false, abstract: false, final false
  static inline bool get_enabled();

  /// @brief Method get_eyeTextureHeight, addr 0x4aedba0, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_eyeTextureHeight();

  /// @brief Method get_eyeTextureResolutionScale, addr 0x4aedb18, size 0x28, virtual false, abstract: false, final false
  static inline float_t get_eyeTextureResolutionScale();

  /// @brief Method get_eyeTextureWidth, addr 0x4aedb78, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_eyeTextureWidth();

  /// @brief Method get_isDeviceActive, addr 0x4aeda8c, size 0x28, virtual false, abstract: false, final false
  static inline bool get_isDeviceActive();

  /// @brief Method get_loadedDeviceName, addr 0x4aedd78, size 0x28, virtual false, abstract: false, final false
  static inline ::StringW get_loadedDeviceName();

  /// @brief Method get_occlusionMaskScale, addr 0x4aedd28, size 0x28, virtual false, abstract: false, final false
  static inline float_t get_occlusionMaskScale();

  /// @brief Method get_renderViewportScale, addr 0x4aedbf0, size 0x28, virtual false, abstract: false, final false
  static inline float_t get_renderViewportScale();

  /// @brief Method get_renderViewportScaleInternal, addr 0x4aedc18, size 0x28, virtual false, abstract: false, final false
  static inline float_t get_renderViewportScaleInternal();

  /// @brief Method get_showDeviceView, addr 0x4aedab4, size 0x28, virtual false, abstract: false, final false
  static inline bool get_showDeviceView();

  /// @brief Method get_stereoRenderingMode, addr 0x4aedda0, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::XRSettings_StereoRenderingMode get_stereoRenderingMode();

  /// @brief Method get_useOcclusionMesh, addr 0x4aedd50, size 0x28, virtual false, abstract: false, final false
  static inline bool get_useOcclusionMesh();

  /// @brief Method set_eyeTextureResolutionScale, addr 0x4aedb40, size 0x38, virtual false, abstract: false, final false
  static inline void set_eyeTextureResolutionScale(float_t value);

  /// @brief Method set_renderViewportScale, addr 0x4aedc40, size 0xb0, virtual false, abstract: false, final false
  static inline void set_renderViewportScale(float_t value);

  /// @brief Method set_renderViewportScaleInternal, addr 0x4aedcf0, size 0x38, virtual false, abstract: false, final false
  static inline void set_renderViewportScaleInternal(float_t value);

  /// @brief Method set_showDeviceView, addr 0x4aedadc, size 0x3c, virtual false, abstract: false, final false
