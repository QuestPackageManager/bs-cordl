...
public:
  ...
  /// @brief Method FinishSetup, addr 0x2f6477c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f647f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_userPresence, addr 0x2f6476c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_userPresence();

  /// @brief Method set_userPresence, addr 0x2f64774, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::XR::WindowsMR::Input::WMRHMD, ____userPresence_k__BackingField) == 0x1a8, "Offset mismatch!");
