...
public:
  ...
  /// @brief Method Equals, addr 0x6cdb938, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6cdb9c4, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::Hand other);

  /// @brief Method GetHashCode, addr 0x6cdb9e8, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_deviceId, addr 0x6cdb928, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_deviceId();

  /// @brief Method get_featureIndex, addr 0x6cdb930, size 0x8, virtual false, abstract: false, final false
