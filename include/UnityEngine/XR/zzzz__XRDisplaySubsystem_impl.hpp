...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass::*)(
  ...
  constexpr static std::size_t addrs = 0x6e3594c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass>(),
                            { "GetRenderParameter",
                              {},
                              { ::i2c::type_of<::UnityEngine::Camera*>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRRenderParameter>>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass::*)()>(
  ...
  constexpr static std::size_t addrs = 0x6e35a50;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass>(), { "GetRenderParameterCount", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<
  ...
  constexpr static std::size_t addrs = 0x6e359f4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass>(),
                                                             { "GetRenderParameter_Injected",
                                                               {},
                                                               { ::i2c::type_of<::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass>>(), ::i2c::type_of<::System::IntPtr>(),
...
inline void UnityEngine::XR::XRDisplaySubsystem_XRRenderPass::GetRenderParameter_Injected(::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass> _unity_self, ::System::IntPtr camera,
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::XR::XRDisplaySubsystem_XRMirrorViewBlitDesc::*)(int32_t, ::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRBlitParams>)>(
  ...
  constexpr static std::size_t addrs = 0x6e35a8c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_XRMirrorViewBlitDesc>(),
...
inline void UnityEngine::XR::XRDisplaySubsystem_XRMirrorViewBlitDesc::GetBlitParameter(int32_t blitParameterIndex, ::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRBlitParams> blitParameter) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_XRMirrorViewBlitDesc>(),
                                                           { "GetBlitParameter", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::UnityEngine::XR::XRDisplaySubsystem_XRBlitParams>>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::IntPtr (*)(Il2CppObject*)>(&::UnityEngine::XR::XRDisplaySubsystem_BindingsMarshaller::ConvertToNative)> {
  ...
  constexpr static std::size_t addrs = 0x6e35ae0;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::XR::XRDisplaySubsystem_BindingsMarshaller*>(), { "ConvertToNative", {}, { ::i2c::type_of<Il2CppObject*>() } })));
    return ___internal_method;
  }
};
