...
template<typename T>
inline ::StringW UnityEngine::XR::InputFeatureUsage_1<T>::get_name()  {
...
template<typename T>
inline void UnityEngine::XR::InputFeatureUsage_1<T>::set_name(::StringW  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::InputFeatureUsage_1<T>>::get(),
                        "set_name",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void UnityEngine::XR::InputFeatureUsage_1<T>::_ctor(::StringW  usageName)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::InputFeatureUsage_1<T>>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline bool UnityEngine::XR::InputFeatureUsage_1<T>::Equals(::System::Object*  obj)  {
...
template<typename T>
inline bool UnityEngine::XR::InputFeatureUsage_1<T>::Equals(::UnityEngine::XR::InputFeatureUsage_1<T>  other)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::InputFeatureUsage_1<T>>::get(),
                        "Equals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::XR::InputFeatureUsage_1<T>>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<bool, false>(this, ___internal_method, other);
}
template<typename T>
inline int32_t UnityEngine::XR::InputFeatureUsage_1<T>::GetHashCode()  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::InputFeatureUsage_1<T>>::get(),
                            2
...
template<typename T>
constexpr  UnityEngine::XR::InputFeatureUsage_1<T>::operator ::System::IEquatable_1<::UnityEngine::XR::InputFeatureUsage_1<T>>*()  {
...
template<typename T>
constexpr ::UnityEngine::XR::InputFeatureUsage_1<T>::InputFeatureUsage_1(::StringW  _name_k__BackingField) noexcept  {
this->_name_k__BackingField = _name_k__BackingField;
}
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::XR::InputFeatureUsage_1<T>::InputFeatureUsage_1()   {
}
