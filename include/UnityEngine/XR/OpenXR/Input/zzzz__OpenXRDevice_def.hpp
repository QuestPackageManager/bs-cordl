...
public:
// Declarations
/// @brief Method FinishSetup, addr 0x6826cb0, size 0xf4, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::XR::OpenXR::Input::OpenXRDevice* New_ctor() ;

/// @brief Method .ctor, addr 0x6826da4, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
