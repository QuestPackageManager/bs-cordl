...
/// @brief Method ReadUnprocessedValueFromState, addr 0x6826ca8, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::Input::Haptic ReadUnprocessedValueFromState(void*  statePtr) ;

/// @brief Method .ctor, addr 0x6826c28, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
