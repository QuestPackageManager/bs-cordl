...
public:
  ...
  /// @brief Method ReadUnprocessedValueFromState, addr 0x6898cb4, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::Haptic ReadUnprocessedValueFromState(void* statePtr);

  /// @brief Method .ctor, addr 0x6898c34, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
