...
/// @brief Method get_angularVelocity, addr 0x682abfc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularVelocity() ;

/// @brief Method get_isTracked, addr 0x682ab94, size 0x8, virtual false, abstract: false, final false
inline bool get_isTracked() ;

/// @brief Method get_position, addr 0x682abb4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_position() ;

/// @brief Method get_rotation, addr 0x682abcc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_trackingState, addr 0x682aba4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::InputTrackingState get_trackingState() ;

/// @brief Method get_velocity, addr 0x682abe4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_velocity() ;

/// @brief Method set_angularVelocity, addr 0x682ac08, size 0xc, virtual false, abstract: false, final false
inline void set_angularVelocity(::UnityEngine::Vector3  value) ;

/// @brief Method set_isTracked, addr 0x682ab9c, size 0x8, virtual false, abstract: false, final false
inline void set_isTracked(bool  value) ;

/// @brief Method set_position, addr 0x682abc0, size 0xc, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::Vector3  value) ;

/// @brief Method set_rotation, addr 0x682abd8, size 0xc, virtual false, abstract: false, final false
inline void set_rotation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_trackingState, addr 0x682abac, size 0x8, virtual false, abstract: false, final false
inline void set_trackingState(::UnityEngine::XR::InputTrackingState  value) ;

/// @brief Method set_velocity, addr 0x682abf0, size 0xc, virtual false, abstract: false, final false
