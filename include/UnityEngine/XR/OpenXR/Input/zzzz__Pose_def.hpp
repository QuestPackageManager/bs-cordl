...
public:
  ...
  /// @brief Method get_angularVelocity, addr 0x689cc08, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_angularVelocity();

  /// @brief Method get_isTracked, addr 0x689cba0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isTracked();

  /// @brief Method get_position, addr 0x689cbc0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method get_rotation, addr 0x689cbd8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method get_trackingState, addr 0x689cbb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::InputTrackingState get_trackingState();

  /// @brief Method get_velocity, addr 0x689cbf0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_velocity();

  /// @brief Method set_angularVelocity, addr 0x689cc14, size 0xc, virtual false, abstract: false, final false
  inline void set_angularVelocity(::UnityEngine::Vector3 value);

  /// @brief Method set_isTracked, addr 0x689cba8, size 0x8, virtual false, abstract: false, final false
  inline void set_isTracked(bool value);

  /// @brief Method set_position, addr 0x689cbcc, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method set_rotation, addr 0x689cbe4, size 0xc, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method set_trackingState, addr 0x689cbb8, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingState(::UnityEngine::XR::InputTrackingState value);

  /// @brief Method set_velocity, addr 0x689cbfc, size 0xc, virtual false, abstract: false, final false
