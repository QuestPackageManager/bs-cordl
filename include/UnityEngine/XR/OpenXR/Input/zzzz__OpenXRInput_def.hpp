...
/// @brief Method Create, addr 0x682a320, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x682aa58, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x682aa64, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method <AttachActionSets>b__9_0, addr 0x682aac8, size 0x48, virtual false, abstract: false, final false
inline bool _AttachActionSets_b__9_0(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature*  f) ;

/// @brief Method <AttachActionSets>b__9_1, addr 0x682ab10, size 0x40, virtual false, abstract: false, final false
inline bool _AttachActionSets_b__9_1(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature*  f) ;

/// @brief Method <CreateActions>b__11_0, addr 0x682ab50, size 0x14, virtual false, abstract: false, final false
inline ::StringW _CreateActions_b__11_0(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_DeviceConfig*  d) ;

/// @brief Method <CreateActions>b__11_1, addr 0x682ab64, size 0x1c, virtual false, abstract: false, final false
inline bool _CreateActions_b__11_1(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionBinding*  b) ;

/// @brief Method <CreateActions>b__11_2, addr 0x682ab80, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x682aac4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field ExpectedControlTypeToActionType, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ExpectedControlTypeToActionType, put=setStaticF_ExpectedControlTypeToActionType)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionType>*  ExpectedControlTypeToActionType;
...
/// @brief Method AttachActionSets, addr 0x6821800, size 0xc18, virtual false, abstract: false, final false
static inline void AttachActionSets() ;

/// @brief Method CreateActions, addr 0x6827464, size 0xa28, virtual false, abstract: false, final false
static inline bool CreateActions(::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionMapConfig*>*  actionMaps, ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::Input::OpenXRInput_SerializedBinding>*>*  interactionProfiles) ;

/// @brief Method GetActionHandle, addr 0x682a170, size 0x70, virtual false, abstract: false, final false
static inline uint64_t GetActionHandle(::UnityEngine::XR::InputDevice  device, ::UnityEngine::XR::InputFeatureUsage  usage) ;

/// @brief Method GetActionHandle, addr 0x682a0cc, size 0xa4, virtual false, abstract: false, final false
static inline uint64_t GetActionHandle(::UnityEngine::XR::InputDevice  device, ::StringW  usageName) ;

/// @brief Method GetActionHandle, addr 0x6828eb4, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method GetActionHandleName, addr 0x6828b28, size 0xe8, virtual false, abstract: false, final false
static inline ::StringW GetActionHandleName(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method GetActionIsActive, addr 0x6829bf4, size 0x70, virtual false, abstract: false, final false
static inline bool GetActionIsActive(::UnityEngine::XR::InputDevice  device, ::UnityEngine::XR::InputFeatureUsage  usage) ;

/// @brief Method GetActionIsActive, addr 0x6829c64, size 0xa0, virtual false, abstract: false, final false
static inline bool GetActionIsActive(::UnityEngine::XR::InputDevice  device, ::StringW  usageName) ;

/// @brief Method GetActionIsActive, addr 0x6829994, size 0x1b8, virtual false, abstract: false, final false
static inline bool GetActionIsActive(::UnityEngine::InputSystem::InputAction*  inputAction) ;

/// @brief Method GetDeviceId, addr 0x68290dc, size 0xb0, virtual false, abstract: false, final false
static inline uint32_t GetDeviceId(::UnityEngine::InputSystem::InputDevice*  inputDevice) ;

/// @brief Method GetDeviceId, addr 0x6829494, size 0xb8, virtual false, abstract: false, final false
static inline uint32_t GetDeviceId(::UnityEngine::XR::InputDevice  inputDevice) ;

/// @brief Method Internal_AttachActionSets, addr 0x6828110, size 0x60, virtual false, abstract: false, final false
static inline bool Internal_AttachActionSets() ;

/// @brief Method Internal_CreateAction, addr 0x682873c, size 0x260, virtual false, abstract: false, final false
static inline uint64_t Internal_CreateAction(uint64_t  actionSetId, ::StringW  name, ::StringW  localizedName, uint32_t  actionType, ::UnityEngine::XR::OpenXR::Input::OpenXRInput_SerializedGuid  guid, ::ArrayW<::StringW,::Array<::StringW>*>  userPaths, uint32_t  userPathCount, bool  isAdditive, ::ArrayW<::StringW,::Array<::StringW>*>  usages, uint32_t  usageCount) ;

/// @brief Method Internal_CreateActionSet, addr 0x6828670, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method Internal_GetActionId, addr 0x682a27c, size 0xa4, virtual false, abstract: false, final false
static inline uint64_t Internal_GetActionId(uint32_t  deviceId, ::StringW  name) ;

/// @brief Method Internal_GetActionIdNoISX, addr 0x682a1e0, size 0x9c, virtual false, abstract: false, final false
static inline uint64_t Internal_GetActionIdNoISX(uint32_t  deviceId, ::StringW  usageName) ;

/// @brief Method Internal_GetActionIsActive, addr 0x6829b4c, size 0xa8, virtual false, abstract: false, final false
static inline bool Internal_GetActionIsActive(uint32_t  deviceId, ::StringW  name) ;

/// @brief Method Internal_GetActionIsActiveNoISX, addr 0x6829d04, size 0xa0, virtual false, abstract: false, final false
static inline bool Internal_GetActionIsActiveNoISX(uint32_t  deviceId, ::StringW  name) ;

/// @brief Method Internal_GetDeviceId, addr 0x682a334, size 0x9c, virtual false, abstract: false, final false
static inline uint32_t Internal_GetDeviceId(::UnityEngine::XR::InputDeviceCharacteristics  characteristics, ::StringW  name) ;

/// @brief Method Internal_RegisterDeviceDefinition, addr 0x6828378, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method Internal_SendHapticImpulse, addr 0x682918c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Internal_SendHapticImpulseNoISX, addr 0x682954c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Internal_SetDpadBindingCustomValues, addr 0x682899c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Internal_StopHaptics, addr 0x6829724, size 0x84, virtual false, abstract: false, final false
static inline void Internal_StopHaptics(uint32_t  deviceId, uint64_t  actionId) ;

/// @brief Method Internal_StopHapticsNoISX, addr 0x68296a8, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_StopHapticsNoISX(uint32_t  deviceId) ;

/// @brief Method Internal_SuggestBindings, addr 0x6827fc0, size 0x150, virtual false, abstract: false, final false
static inline bool Internal_SuggestBindings(::StringW  interactionProfile, ::ArrayW<::UnityEngine::XR::OpenXR::Input::OpenXRInput_SerializedBinding,::Array<::UnityEngine::XR::OpenXR::Input::OpenXRInput_SerializedBinding>*>  serializedBindings, uint32_t  serializedBindingCount) ;

/// @brief Method Internal_TryGetInputSourceName, addr 0x6829894, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Internal_TryGetInputSourceNamePtr, addr 0x682a3d0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Internal_TrySetControllerLateLatchAction, addr 0x6829f04, size 0x8c, virtual false, abstract: false, final false
static inline bool Internal_TrySetControllerLateLatchAction(uint32_t  deviceId, uint64_t  actionId) ;

/// @brief Method RegisterDevices, addr 0x68271bc, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method RegisterLayouts, addr 0x6820470, size 0x224, virtual false, abstract: false, final false
static inline void RegisterLayouts() ;

/// @brief Method SanitizeCharForOpenXRPath, addr 0x6828a50, size 0xd8, virtual false, abstract: false, final false
static inline char16_t SanitizeCharForOpenXRPath(char16_t  c) ;

/// @brief Method SanitizeStringForOpenXRPath, addr 0x68284b4, size 0x1bc, virtual false, abstract: false, final false
static inline ::StringW SanitizeStringForOpenXRPath(::StringW  input) ;

/// @brief Method SendHapticImpulse, addr 0x6828e30, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method SendHapticImpulse, addr 0x6828d40, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method SendHapticImpulse, addr 0x6828c10, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method SendHapticImpulse, addr 0x6828c94, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method SendHapticImpulse, addr 0x68293ac, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method SetDpadBindingCustomValues, addr 0x6827e8c, size 0x134, virtual false, abstract: false, final false
static inline void SetDpadBindingCustomValues() ;

/// @brief Method StopHapticImpulse, addr 0x68295f0, size 0xb8, virtual false, abstract: false, final false
static inline void StopHapticImpulse(::UnityEngine::XR::InputDevice  device) ;

/// @brief Method StopHaptics, addr 0x6829238, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method StopHaptics, addr 0x6829308, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method TryGetInputSourceName, addr 0x68297a8, size 0xec, virtual false, abstract: false, final false
static inline bool TryGetInputSourceName(::UnityEngine::InputSystem::InputAction*  inputAction, int32_t  index, ::ByRef<::StringW>  name, ::UnityEngine::XR::OpenXR::Input::OpenXRInput_InputSourceNameFlags  flags, ::UnityEngine::InputSystem::InputDevice*  inputDevice) ;

/// @brief Method TrySetControllerLateLatchAction, addr 0x6829f90, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method TrySetControllerLateLatchAction, addr 0x682a000, size 0xcc, virtual false, abstract: false, final false
static inline bool TrySetControllerLateLatchAction(::UnityEngine::XR::InputDevice  device, ::StringW  usageName) ;

/// @brief Method TrySetControllerLateLatchAction, addr 0x6829da4, size 0x160, virtual false, abstract: false, final false
static inline bool TrySetControllerLateLatchAction(::UnityEngine::InputSystem::InputAction*  inputAction) ;

/// @brief Method UserPathToDeviceName, addr 0x6828170, size 0x208, virtual false, abstract: false, final false
static inline ::StringW UserPathToDeviceName(::StringW  userPath) ;

/// @brief Method ValidateActionMapConfig, addr 0x6826f78, size 0x1b8, virtual false, abstract: false, final false
...
static inline void setStaticF_ExpectedControlTypeToActionType(::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionType>*  value) ;
