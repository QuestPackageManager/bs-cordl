...
/// @brief Field m_List, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_List, put=__cordl_internal_set_m_List)) ::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*>  m_List;

static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeList* New_ctor() ;

constexpr ::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*> const& __cordl_internal_get_m_List() const;
...
constexpr void __cordl_internal_set_m_List(::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*>  value) ;

/// @brief Method .ctor, addr 0x681d8fc, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <ApplyRenderSettings>b__44_0, addr 0x681d9b8, size 0x8, virtual false, abstract: false, final false
inline int32_t _ApplyRenderSettings_b__44_0(::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup  e) ;

/// @brief Method .ctor, addr 0x681d9a4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_colorSubmissionModes>b__25_0, addr 0x681d9a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup _get_colorSubmissionModes_b__25_0(int32_t  i) ;

/// @brief Method <set_colorSubmissionModes>b__26_0, addr 0x681d9b0, size 0x8, virtual false, abstract: false, final false
...
// Dependencies UnityEngine.ScriptableObject, UnityEngine.XR.OpenXR.OpenXRSettings::BackendFovationApi, UnityEngine.XR.OpenXR.OpenXRSettings::ColorSubmissionModeGroup, UnityEngine.XR.OpenXR.OpenXRSettings::DepthSubmissionMode, UnityEngine.XR.OpenXR.OpenXRSettings::RenderMode, UnityEngine.XR.OpenXR.OpenXRSettings::SpaceWarpMotionVectorTextureFormat
namespace UnityEngine::XR::OpenXR {
// Is value type: false
...
using __c = ::UnityEngine::XR::OpenXR::OpenXRSettings___c;
 ...
 __declspec(property(get=get_colorSubmissionModes, put=set_colorSubmissionModes)) ::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*>  colorSubmissionModes;
...
/// @brief Field features, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_features, put=__cordl_internal_set_features)) ::ArrayW<::UnityW<::UnityEngine::XR::OpenXR::Features::OpenXRFeature>,::Array<::UnityW<::UnityEngine::XR::OpenXR::Features::OpenXRFeature>>*>  features;
...
/// @brief Field m_depthSubmissionMode, offset 0x38, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_depthSubmissionMode, put=__cordl_internal_set_m_depthSubmissionMode)) ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode  m_depthSubmissionMode;

/// @brief Field m_eyeTrackingPermissionsToRequest, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_eyeTrackingPermissionsToRequest, put=__cordl_internal_set_m_eyeTrackingPermissionsToRequest)) ::ArrayW<::StringW,::Array<::StringW>*>  m_eyeTrackingPermissionsToRequest;

/// @brief Field m_foveatedRenderingApi, offset 0x42, size 0x1 
 __declspec(property(get=__cordl_internal_get_m_foveatedRenderingApi, put=__cordl_internal_set_m_foveatedRenderingApi)) ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi  m_foveatedRenderingApi;
...
/// @brief Field m_spacewarpMotionVectorTextureFormat, offset 0x3c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_spacewarpMotionVectorTextureFormat, put=__cordl_internal_set_m_spacewarpMotionVectorTextureFormat)) ::UnityEngine::XR::OpenXR::OpenXRSettings_SpaceWarpMotionVectorTextureFormat  m_spacewarpMotionVectorTextureFormat;
...
/// @brief Field s_RuntimeInstance, offset 0xffffffff, size 0x8 
 ...
 __declspec(property(get=get_spacewarpMotionVectorTextureFormat, put=set_spacewarpMotionVectorTextureFormat)) ::UnityEngine::XR::OpenXR::OpenXRSettings_SpaceWarpMotionVectorTextureFormat  spacewarpMotionVectorTextureFormat;

 __declspec(property(get=get_symmetricProjection, put=set_symmetricProjection)) bool  symmetricProjection;

/// @brief Method ApplyRenderSettings, addr 0x681cb38, size 0x2b0, virtual false, abstract: false, final false
inline void ApplyRenderSettings() ;

/// @brief Method ApplySettings, addr 0x681d5d4, size 0x4, virtual false, abstract: false, final false
inline void ApplySettings() ;

/// @brief Method Awake, addr 0x681d584, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetFeature, addr 0x681b4ac, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetFeatures, addr 0x681b81c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method GetFeatures, addr 0x681b538, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method GetFeatures, addr 0x681b6b4, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method GetFeatures, addr 0x681b8ac, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x681c2e4, size 0xb4, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> GetInstance(bool  useActiveBuildTarget) ;

/// @brief Method Internal_GetAllowRecentering, addr 0x681d6e4, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_GetAllowRecentering() ;

/// @brief Method Internal_GetColorSubmissionModes, addr 0x681bef0, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Internal_GetDepthSubmissionMode, addr 0x681c508, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode Internal_GetDepthSubmissionMode() ;

/// @brief Method Internal_GetFloorOffset, addr 0x681d754, size 0x64, virtual false, abstract: false, final false
static inline float_t Internal_GetFloorOffset() ;

/// @brief Method Internal_GetHasEyeTrackingPermissions, addr 0x681d428, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_GetHasEyeTrackingPermissions() ;

/// @brief Method Internal_GetIsUsingLegacyXRDisplay, addr 0x681d518, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_GetIsUsingLegacyXRDisplay() ;

/// @brief Method Internal_GetRenderMode, addr 0x681ba70, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode Internal_GetRenderMode() ;

/// @brief Method Internal_GetSpaceWarpMotionVectorTextureFormat, addr 0x681c7d8, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method Internal_GetUsedFoveatedRenderingApi, addr 0x681d24c, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi Internal_GetUsedFoveatedRenderingApi() ;

/// @brief Method Internal_HasRequestedEyeTrackingPermissions, addr 0x681cee0, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_HasRequestedEyeTrackingPermissions() ;

/// @brief Method Internal_RegenerateTrackingOrigin, addr 0x681d67c, size 0x64, virtual false, abstract: false, final false
static inline void Internal_RegenerateTrackingOrigin() ;

/// @brief Method Internal_SetAllowRecentering, addr 0x681d5ec, size 0x8c, virtual false, abstract: false, final false
static inline void Internal_SetAllowRecentering(bool  active, float_t  height) ;

/// @brief Method Internal_SetColorSubmissionMode, addr 0x681d494, size 0x84, virtual false, abstract: false, final false
static inline void Internal_SetColorSubmissionMode(::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*>  colorSubmissionMode) ;

/// @brief Method Internal_SetColorSubmissionModes, addr 0x681c1d4, size 0x8c, virtual false, abstract: false, final false
static inline void Internal_SetColorSubmissionModes(::ArrayW<int32_t,::Array<int32_t>*>  colorSubmissionMode, int32_t  arraySize) ;

/// @brief Method Internal_SetDepthSubmissionMode, addr 0x681c668, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Internal_SetHasEyeTrackingPermissions, addr 0x681c398, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetHasEyeTrackingPermissions(bool  value) ;

/// @brief Method Internal_SetOptimizeBufferDiscards, addr 0x681cabc, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetOptimizeBufferDiscards(bool  enabled) ;

/// @brief Method Internal_SetOptimizeMultiviewRenderRegions, addr 0x681d3ac, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetOptimizeMultiviewRenderRegions(bool  enabled) ;

/// @brief Method Internal_SetRenderMode, addr 0x681bbd0, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetRenderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode  renderMode) ;

/// @brief Method Internal_SetSpaceWarpMotionVectorTextureFormat, addr 0x681c938, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Internal_SetSymmetricProjection, addr 0x681cde8, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetSymmetricProjection(bool  enabled) ;

/// @brief Method Internal_SetUsedFoveatedRenderingApi, addr 0x681ce64, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method PermissionGrantedCallback, addr 0x681c260, size 0x84, virtual false, abstract: false, final false
static inline void PermissionGrantedCallback(::StringW  permissionName) ;

/// @brief Method RefreshRecenterSpace, addr 0x681d678, size 0x4, virtual false, abstract: false, final false
static inline void RefreshRecenterSpace() ;

/// @brief Method SetAllowRecentering, addr 0x681d5e8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x681d7b8, size 0x144, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ActiveBuildTargetInstance, addr 0x681d5d8, size 0x8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_ActiveBuildTargetInstance() ;

/// @brief Method get_AllowRecentering, addr 0x681d6e0, size 0x4, virtual false, abstract: false, final false
static inline bool get_AllowRecentering() ;

/// @brief Method get_FloorOffset, addr 0x681d750, size 0x4, virtual false, abstract: false, final false
static inline float_t get_FloorOffset() ;

/// @brief Method get_Instance, addr 0x681d5e0, size 0x8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_Instance() ;

/// @brief Method get_autoColorSubmissionMode, addr 0x681bc4c, size 0x8, virtual false, abstract: false, final false
inline bool get_autoColorSubmissionMode() ;

/// @brief Method get_colorSubmissionModes, addr 0x681bc5c, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method get_depthSubmissionMode, addr 0x681c414, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode get_depthSubmissionMode() ;

/// @brief Method get_featureCount, addr 0x681b494, size 0x18, virtual false, abstract: false, final false
inline int32_t get_featureCount() ;

/// @brief Method get_foveatedRenderingApi, addr 0x681d158, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi get_foveatedRenderingApi() ;

/// @brief Method get_optimizeBufferDiscards, addr 0x681c9b4, size 0x8, virtual false, abstract: false, final false
inline bool get_optimizeBufferDiscards() ;

/// @brief Method get_renderMode, addr 0x681b97c, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode get_renderMode() ;

/// @brief Method get_spacewarpMotionVectorTextureFormat, addr 0x681c6e4, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRSettings_SpaceWarpMotionVectorTextureFormat get_spacewarpMotionVectorTextureFormat() ;

/// @brief Method get_symmetricProjection, addr 0x681d050, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_autoColorSubmissionMode, addr 0x681bc54, size 0x8, virtual false, abstract: false, final false
inline void set_autoColorSubmissionMode(bool  value) ;

/// @brief Method set_colorSubmissionModes, addr 0x681bfd8, size 0x1fc, virtual false, abstract: false, final false
inline void set_colorSubmissionModes(::ArrayW<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup,::Array<::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup>*>  value) ;

/// @brief Method set_depthSubmissionMode, addr 0x681c56c, size 0xfc, virtual false, abstract: false, final false
inline void set_depthSubmissionMode(::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode  value) ;

/// @brief Method set_foveatedRenderingApi, addr 0x681d2b0, size 0xfc, virtual false, abstract: false, final false
inline void set_foveatedRenderingApi(::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi  value) ;

/// @brief Method set_optimizeBufferDiscards, addr 0x681c9bc, size 0x100, virtual false, abstract: false, final false
inline void set_optimizeBufferDiscards(bool  value) ;

/// @brief Method set_renderMode, addr 0x681bad4, size 0xfc, virtual false, abstract: false, final false
inline void set_renderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode  value) ;

/// @brief Method set_spacewarpMotionVectorTextureFormat, addr 0x681c83c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method set_symmetricProjection, addr 0x681d058, size 0x100, virtual false, abstract: false, final false
