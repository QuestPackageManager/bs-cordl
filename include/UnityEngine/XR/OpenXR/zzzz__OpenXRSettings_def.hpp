...
public:
  ...
  /// @brief Method .ctor, addr 0x688f908, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ApplyRenderSettings>b__44_0, addr 0x688f9c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t _ApplyRenderSettings_b__44_0(::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup e);

  /// @brief Method .ctor, addr 0x688f9b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_colorSubmissionModes>b__25_0, addr 0x688f9b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_ColorSubmissionModeGroup _get_colorSubmissionModes_b__25_0(int32_t i);

  /// @brief Method <set_colorSubmissionModes>b__26_0, addr 0x688f9bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyRenderSettings, addr 0x688eb44, size 0x2b0, virtual false, abstract: false, final false
  inline void ApplyRenderSettings();

  /// @brief Method ApplySettings, addr 0x688f5e0, size 0x4, virtual false, abstract: false, final false
  inline void ApplySettings();

  /// @brief Method Awake, addr 0x688f590, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetFeature, addr 0x688d4b8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688d828, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688d544, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688d6c0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFeatures, addr 0x688d8b8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x688e2f0, size 0xb4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> GetInstance(bool useActiveBuildTarget);

  /// @brief Method Internal_GetAllowRecentering, addr 0x688f6f0, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetAllowRecentering();

  /// @brief Method Internal_GetColorSubmissionModes, addr 0x688defc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetDepthSubmissionMode, addr 0x688e514, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode Internal_GetDepthSubmissionMode();

  /// @brief Method Internal_GetFloorOffset, addr 0x688f760, size 0x64, virtual false, abstract: false, final false
  static inline float_t Internal_GetFloorOffset();

  /// @brief Method Internal_GetHasEyeTrackingPermissions, addr 0x688f434, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetHasEyeTrackingPermissions();

  /// @brief Method Internal_GetIsUsingLegacyXRDisplay, addr 0x688f524, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_GetIsUsingLegacyXRDisplay();

  /// @brief Method Internal_GetRenderMode, addr 0x688da7c, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode Internal_GetRenderMode();

  /// @brief Method Internal_GetSpaceWarpMotionVectorTextureFormat, addr 0x688e7e4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_GetUsedFoveatedRenderingApi, addr 0x688f258, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi Internal_GetUsedFoveatedRenderingApi();

  /// @brief Method Internal_HasRequestedEyeTrackingPermissions, addr 0x688eeec, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_HasRequestedEyeTrackingPermissions();

  /// @brief Method Internal_RegenerateTrackingOrigin, addr 0x688f688, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_RegenerateTrackingOrigin();

  /// @brief Method Internal_SetAllowRecentering, addr 0x688f5f8, size 0x8c, virtual false, abstract: false, final false
  static inline void Internal_SetAllowRecentering(bool active, float_t height);

  /// @brief Method Internal_SetColorSubmissionMode, addr 0x688f4a0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetColorSubmissionModes, addr 0x688e1e0, size 0x8c, virtual false, abstract: false, final false
  static inline void Internal_SetColorSubmissionModes(::ArrayW<int32_t, ::Array<int32_t>*> colorSubmissionMode, int32_t arraySize);

  /// @brief Method Internal_SetDepthSubmissionMode, addr 0x688e674, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetHasEyeTrackingPermissions, addr 0x688e3a4, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetHasEyeTrackingPermissions(bool value);

  /// @brief Method Internal_SetOptimizeBufferDiscards, addr 0x688eac8, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetOptimizeBufferDiscards(bool enabled);

  /// @brief Method Internal_SetOptimizeMultiviewRenderRegions, addr 0x688f3b8, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetOptimizeMultiviewRenderRegions(bool enabled);

  /// @brief Method Internal_SetRenderMode, addr 0x688dbdc, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetRenderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode renderMode);

  /// @brief Method Internal_SetSpaceWarpMotionVectorTextureFormat, addr 0x688e944, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetSymmetricProjection, addr 0x688edf4, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetSymmetricProjection(bool enabled);

  /// @brief Method Internal_SetUsedFoveatedRenderingApi, addr 0x688ee70, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method PermissionGrantedCallback, addr 0x688e26c, size 0x84, virtual false, abstract: false, final false
  static inline void PermissionGrantedCallback(::StringW permissionName);

  /// @brief Method RefreshRecenterSpace, addr 0x688f684, size 0x4, virtual false, abstract: false, final false
  static inline void RefreshRecenterSpace();

  /// @brief Method SetAllowRecentering, addr 0x688f5f4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x688f7c4, size 0x144, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveBuildTargetInstance, addr 0x688f5e4, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_ActiveBuildTargetInstance();

  /// @brief Method get_AllowRecentering, addr 0x688f6ec, size 0x4, virtual false, abstract: false, final false
  static inline bool get_AllowRecentering();

  /// @brief Method get_FloorOffset, addr 0x688f75c, size 0x4, virtual false, abstract: false, final false
  static inline float_t get_FloorOffset();

  /// @brief Method get_Instance, addr 0x688f5ec, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRSettings> get_Instance();

  /// @brief Method get_autoColorSubmissionMode, addr 0x688dc58, size 0x8, virtual false, abstract: false, final false
  inline bool get_autoColorSubmissionMode();

  /// @brief Method get_colorSubmissionModes, addr 0x688dc68, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method get_depthSubmissionMode, addr 0x688e420, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode get_depthSubmissionMode();

  /// @brief Method get_featureCount, addr 0x688d4a0, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_featureCount();

  /// @brief Method get_foveatedRenderingApi, addr 0x688f164, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi get_foveatedRenderingApi();

  /// @brief Method get_optimizeBufferDiscards, addr 0x688e9c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_optimizeBufferDiscards();

  /// @brief Method get_renderMode, addr 0x688d988, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode get_renderMode();

  /// @brief Method get_spacewarpMotionVectorTextureFormat, addr 0x688e6f0, size 0xf4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRSettings_SpaceWarpMotionVectorTextureFormat get_spacewarpMotionVectorTextureFormat();

  /// @brief Method get_symmetricProjection, addr 0x688f05c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_autoColorSubmissionMode, addr 0x688dc60, size 0x8, virtual false, abstract: false, final false
  inline void set_autoColorSubmissionMode(bool value);

  /// @brief Method set_colorSubmissionModes, addr 0x688dfe4, size 0x1fc, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method set_depthSubmissionMode, addr 0x688e578, size 0xfc, virtual false, abstract: false, final false
  inline void set_depthSubmissionMode(::UnityEngine::XR::OpenXR::OpenXRSettings_DepthSubmissionMode value);

  /// @brief Method set_foveatedRenderingApi, addr 0x688f2bc, size 0xfc, virtual false, abstract: false, final false
  inline void set_foveatedRenderingApi(::UnityEngine::XR::OpenXR::OpenXRSettings_BackendFovationApi value);

  /// @brief Method set_optimizeBufferDiscards, addr 0x688e9c8, size 0x100, virtual false, abstract: false, final false
  inline void set_optimizeBufferDiscards(bool value);

  /// @brief Method set_renderMode, addr 0x688dae0, size 0xfc, virtual false, abstract: false, final false
  inline void set_renderMode(::UnityEngine::XR::OpenXR::OpenXRSettings_RenderMode value);

  /// @brief Method set_spacewarpMotionVectorTextureFormat, addr 0x688e848, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_symmetricProjection, addr 0x688f064, size 0x100, virtual false, abstract: false, final false
