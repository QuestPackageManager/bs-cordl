...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaitForRestartFinish", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaitForRestartFinish(WaitForRestartFinish&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaitForRestartFinish", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaitForRestartFinish(WaitForRestartFinishconst&) = delete;
