...
public:
  ...
  /// @brief Method .ctor, addr 0x6896d9c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(float_t timeout);

  /// @brief Method get_keepWaiting, addr 0x6898a0c, size 0xec, virtual true, abstract: false, final false
