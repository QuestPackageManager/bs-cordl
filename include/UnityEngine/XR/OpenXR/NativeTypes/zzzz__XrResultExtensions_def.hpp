...
public:
  // Declarations
  /// @brief Method IsError, addr 0x6898bb4, size 0x8, virtual false, abstract: false, final false
  static inline bool IsError(::UnityEngine::XR::OpenXR::NativeTypes::XrResult xrResult);

  /// @brief Method IsSuccess, addr 0x6898b9c, size 0xc, virtual false, abstract: false, final false
  static inline bool IsSuccess(::UnityEngine::XR::OpenXR::NativeTypes::XrResult xrResult);

  /// @brief Method IsUnqualifiedSuccess, addr 0x6898ba8, size 0xc, virtual false, abstract: false, final false
