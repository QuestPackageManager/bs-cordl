...
// Ctor Parameters [CppParam { name: "Type", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "Next", ty: "void*", modifiers: "", def_value: None }, CppParam { name: "CreateFlags", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "UsageFlags", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "Format", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "SampleCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "Width", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "Height", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "FaceCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "ArraySize", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "MipCount", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr XrSwapchainCreateInfo(uint32_t  Type, void*  Next, uint64_t  CreateFlags, uint64_t  UsageFlags, int64_t  Format, uint32_t  SampleCount, uint32_t  Width, uint32_t  Height, uint32_t  FaceCount, uint32_t  ArraySize, uint32_t  MipCount) noexcept;
