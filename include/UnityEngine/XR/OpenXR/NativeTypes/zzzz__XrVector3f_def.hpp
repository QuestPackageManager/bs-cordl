...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x69f166c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 value);

  /// @brief Method .ctor, addr 0x69f165c, size 0x10, virtual false, abstract: false, final false
