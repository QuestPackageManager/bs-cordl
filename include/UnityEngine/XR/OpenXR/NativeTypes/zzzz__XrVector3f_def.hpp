...
public:
// Declarations
/// @brief Method .ctor, addr 0x6826bd0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  value) ;

/// @brief Method .ctor, addr 0x6826bc0, size 0x10, virtual false, abstract: false, final false
