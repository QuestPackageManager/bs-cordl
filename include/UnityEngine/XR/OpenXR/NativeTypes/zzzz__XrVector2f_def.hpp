...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::NativeTypes::XrVector2f, "UnityEngine.XR.OpenXR.NativeTypes", "XrVector2f");
// Dependencies
namespace UnityEngine::XR::OpenXR::NativeTypes {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x69f1654, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector2 value);

  /// @brief Method .ctor, addr 0x69f164c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::NativeTypes::XrVector2f) == 0x8, "Size mismatch!");
