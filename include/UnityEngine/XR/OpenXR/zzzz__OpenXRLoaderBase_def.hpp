...
public:
  ...
  /// @brief Method .ctor, addr 0x6894c3c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6896178, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x689621c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6896164, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6895f98, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <InitializeInternal>b__33_0, addr 0x6896280, size 0x60, virtual false, abstract: false, final false
  inline bool _InitializeInternal_b__33_0(::UnityEngine::XR::OpenXR::Features::OpenXRFeature* f);

  /// @brief Method <InitializeInternal>b__33_1, addr 0x68962e0, size 0x14, virtual false, abstract: false, final false
  inline int32_t _InitializeInternal_b__33_1(::UnityEngine::XR::OpenXR::Features::OpenXRFeature* f);

  /// @brief Method <InitializeInternal>b__33_2, addr 0x68962f4, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _InitializeInternal_b__33_2(::UnityEngine::XR::OpenXR::Features::OpenXRFeature* f);

  /// @brief Method .ctor, addr 0x689627c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateSubsystems, addr 0x6892d1c, size 0x12c, virtual false, abstract: false, final false
  inline bool CreateSubsystems();

  /// @brief Method DebugLogEnabledSpecExtensions, addr 0x6893184, size 0x22c, virtual false, abstract: false, final false
  static inline void DebugLogEnabledSpecExtensions();

  /// @brief Method Deinitialize, addr 0x6894618, size 0x2f0, virtual true, abstract: false, final false
  ...
  /// @brief Method ExceptionHandler, addr 0x689196c, size 0x258, virtual false, abstract: false, final false
  static inline void ExceptionHandler(::System::Object* sender, ::System::UnhandledExceptionEventArgs* args);

  /// @brief Method Initialize, addr 0x6891bc4, size 0x294, virtual true, abstract: false, final false
  inline bool Initialize();

  /// @brief Method InitializeInternal, addr 0x6891e58, size 0x5a8, virtual false, abstract: false, final false
  inline bool InitializeInternal();

  /// @brief Method Internal_BeginSession, addr 0x68937a8, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_BeginSession();

  /// @brief Method Internal_CreateSessionIfNeeded, addr 0x689373c, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_CreateSessionIfNeeded();

  /// @brief Method Internal_DestroySession, addr 0x689496c, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_DestroySession();

  /// @brief Method Internal_EndSession, addr 0x68945b4, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_EndSession();

  /// @brief Method Internal_InitializeSession, addr 0x6892958, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_InitializeSession();

  /// @brief Method Internal_IsExtensionEnabled, addr 0x6895454, size 0x9c, virtual false, abstract: false, final false
  static inline bool Internal_IsExtensionEnabled(::StringW extensionName);

  /// @brief Method Internal_LoadOpenXRLibrary, addr 0x6894bb0, size 0x8c, virtual false, abstract: false, final false
  static inline bool Internal_LoadOpenXRLibrary(::ArrayW<uint8_t, ::Array<uint8_t>*> loaderPath);

  /// @brief Method Internal_PumpMessageLoop, addr 0x6893468, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_PumpMessageLoop();

  /// @brief Method Internal_RequestEnableExtensionString, addr 0x6894c48, size 0x94, virtual false, abstract: false, final false
  static inline bool Internal_RequestEnableExtensionString(::StringW extensionString);

  /// @brief Method Internal_RequestExitSession, addr 0x6894908, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_RequestExitSession();

  /// @brief Method Internal_SetApplicationInfo, addr 0x6894a34, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SetCallbacks, addr 0x6896004, size 0x80, virtual false, abstract: false, final false
  static inline void Internal_SetCallbacks(::UnityEngine::XR::OpenXR::OpenXRLoaderBase_ReceiveNativeEventDelegate* callback);

  /// @brief Method Internal_SetSuccessfullyInitialized, addr 0x6892400, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_SetSuccessfullyInitialized(bool value);

  /// @brief Method Internal_UnloadOpenXRLibrary, addr 0x68949d0, size 0x64, virtual false, abstract: false, final false
  static inline void Internal_UnloadOpenXRLibrary();

  /// @brief Method LoadOpenXRSymbols, addr 0x68927c8, size 0x70, virtual false, abstract: false, final false
  inline bool LoadOpenXRSymbols();

  /// @brief Method LogRequestedOpenXRFeatures, addr 0x6894cdc, size 0x778, virtual false, abstract: false, final false
  inline void LogRequestedOpenXRFeatures();

  static inline ::UnityEngine::XR::OpenXR::OpenXRLoaderBase* New_ctor();

  /// @brief Method ProcessOpenXRMessageLoop, addr 0x68933b0, size 0xb8, virtual false, abstract: false, final false
  inline void ProcessOpenXRMessageLoop();

  /// @brief Method ReceiveNativeEvent, addr 0x68913e4, size 0x304, virtual false, abstract: false, final false
  static inline void ReceiveNativeEvent(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_NativeEvent e, uint64_t payload);

  /// @brief Method RegisterOpenXRCallbacks, addr 0x6892c80, size 0x9c, virtual false, abstract: false, final false
  static inline void RegisterOpenXRCallbacks();

  /// @brief Method RequestOpenXRFeatures, addr 0x68929c4, size 0x2bc, virtual false, abstract: false, final false
  inline void RequestOpenXRFeatures();

  /// @brief Method SetApplicationInfo, addr 0x6892e48, size 0x158, virtual false, abstract: false, final false
  inline void SetApplicationInfo();

  /// @brief Method Start, addr 0x68934cc, size 0xa4, virtual true, abstract: false, final false
  inline bool Start();

  /// @brief Method StartInternal, addr 0x6893570, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Stop, addr 0x6894424, size 0x134, virtual true, abstract: false, final false
  inline bool Stop();

  /// @brief Method StopInternal, addr 0x6894558, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method StringToWCHAR_T, addr 0x6894b10, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6890d34, size 0x6b0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Instance, addr 0x68916e8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRLoaderBase> get_Instance();

  /// @brief Method get_currentLoaderState, addr 0x68917a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState get_currentLoaderState();

  /// @brief Method get_displaySubsystem, addr 0x68917b4, size 0x68, virtual false, abstract: false, final false
  inline Il2CppObject* get_displaySubsystem();

  /// @brief Method get_inputSubsystem, addr 0x689181c, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::XRInputSubsystem* get_inputSubsystem();

  /// @brief Method get_isInitialized, addr 0x6891900, size 0x14, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_isStarted, addr 0x6891914, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Instance, addr 0x6891744, size 0x60, virtual false, abstract: false, final false
  static inline void set_Instance(::UnityEngine::XR::OpenXR::OpenXRLoaderBase* value);

  /// @brief Method set_currentLoaderState, addr 0x68917ac, size 0x8, virtual false, abstract: false, final false
