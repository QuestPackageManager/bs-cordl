...
/// @brief Method .ctor, addr 0x6822c30, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x682416c, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x6824210, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x6824158, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6823f8c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method <InitializeInternal>b__33_0, addr 0x6824274, size 0x60, virtual false, abstract: false, final false
inline bool _InitializeInternal_b__33_0(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method <InitializeInternal>b__33_1, addr 0x68242d4, size 0x14, virtual false, abstract: false, final false
inline int32_t _InitializeInternal_b__33_1(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method <InitializeInternal>b__33_2, addr 0x68242e8, size 0x14, virtual false, abstract: false, final false
inline ::StringW _InitializeInternal_b__33_2(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method .ctor, addr 0x6824270, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <currentLoaderState>k__BackingField, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get__currentLoaderState_k__BackingField, put=__cordl_internal_set__currentLoaderState_k__BackingField)) ::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState  _currentLoaderState_k__BackingField;
...
/// @brief Field runningStates, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_runningStates, put=__cordl_internal_set_runningStates)) ::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState>*  runningStates;
...
/// @brief Field validLoaderDeinitStates, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_validLoaderDeinitStates, put=__cordl_internal_set_validLoaderDeinitStates)) ::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState>*  validLoaderDeinitStates;

/// @brief Field validLoaderInitStates, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_validLoaderInitStates, put=__cordl_internal_set_validLoaderInitStates)) ::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState>*  validLoaderInitStates;

/// @brief Field validLoaderStartStates, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_validLoaderStartStates, put=__cordl_internal_set_validLoaderStartStates)) ::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState>*  validLoaderStartStates;

/// @brief Field validLoaderStopStates, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_validLoaderStopStates, put=__cordl_internal_set_validLoaderStopStates)) ::System::Collections::Generic::List_1<::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState>*  validLoaderStopStates;
...
/// @brief Method CreateSubsystems, addr 0x6820d10, size 0x12c, virtual false, abstract: false, final false
inline bool CreateSubsystems() ;

/// @brief Method DebugLogEnabledSpecExtensions, addr 0x6821178, size 0x22c, virtual false, abstract: false, final false
static inline void DebugLogEnabledSpecExtensions() ;

/// @brief Method Deinitialize, addr 0x682260c, size 0x2f0, virtual true, abstract: false, final false
...
/// @brief Method ExceptionHandler, addr 0x681f960, size 0x258, virtual false, abstract: false, final false
static inline void ExceptionHandler(::System::Object*  sender, ::System::UnhandledExceptionEventArgs*  args) ;

/// @brief Method Initialize, addr 0x681fbb8, size 0x294, virtual true, abstract: false, final false
inline bool Initialize() ;

/// @brief Method InitializeInternal, addr 0x681fe4c, size 0x5a8, virtual false, abstract: false, final false
inline bool InitializeInternal() ;

/// @brief Method Internal_BeginSession, addr 0x682179c, size 0x64, virtual false, abstract: false, final false
static inline void Internal_BeginSession() ;

/// @brief Method Internal_CreateSessionIfNeeded, addr 0x6821730, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_CreateSessionIfNeeded() ;

/// @brief Method Internal_DestroySession, addr 0x6822960, size 0x64, virtual false, abstract: false, final false
static inline void Internal_DestroySession() ;

/// @brief Method Internal_EndSession, addr 0x68225a8, size 0x64, virtual false, abstract: false, final false
static inline void Internal_EndSession() ;

/// @brief Method Internal_InitializeSession, addr 0x682094c, size 0x6c, virtual false, abstract: false, final false
static inline bool Internal_InitializeSession() ;

/// @brief Method Internal_IsExtensionEnabled, addr 0x6823448, size 0x9c, virtual false, abstract: false, final false
static inline bool Internal_IsExtensionEnabled(::StringW  extensionName) ;

/// @brief Method Internal_LoadOpenXRLibrary, addr 0x6822ba4, size 0x8c, virtual false, abstract: false, final false
static inline bool Internal_LoadOpenXRLibrary(::ArrayW<uint8_t,::Array<uint8_t>*>  loaderPath) ;

/// @brief Method Internal_PumpMessageLoop, addr 0x682145c, size 0x64, virtual false, abstract: false, final false
static inline void Internal_PumpMessageLoop() ;

/// @brief Method Internal_RequestEnableExtensionString, addr 0x6822c3c, size 0x94, virtual false, abstract: false, final false
static inline bool Internal_RequestEnableExtensionString(::StringW  extensionString) ;

/// @brief Method Internal_RequestExitSession, addr 0x68228fc, size 0x64, virtual false, abstract: false, final false
static inline void Internal_RequestExitSession() ;

/// @brief Method Internal_SetApplicationInfo, addr 0x6822a28, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method Internal_SetCallbacks, addr 0x6823ff8, size 0x80, virtual false, abstract: false, final false
static inline void Internal_SetCallbacks(::UnityEngine::XR::OpenXR::OpenXRLoaderBase_ReceiveNativeEventDelegate*  callback) ;

/// @brief Method Internal_SetSuccessfullyInitialized, addr 0x68203f4, size 0x7c, virtual false, abstract: false, final false
static inline void Internal_SetSuccessfullyInitialized(bool  value) ;

/// @brief Method Internal_UnloadOpenXRLibrary, addr 0x68229c4, size 0x64, virtual false, abstract: false, final false
static inline void Internal_UnloadOpenXRLibrary() ;

/// @brief Method LoadOpenXRSymbols, addr 0x68207bc, size 0x70, virtual false, abstract: false, final false
inline bool LoadOpenXRSymbols() ;

/// @brief Method LogRequestedOpenXRFeatures, addr 0x6822cd0, size 0x778, virtual false, abstract: false, final false
inline void LogRequestedOpenXRFeatures() ;

static inline ::UnityEngine::XR::OpenXR::OpenXRLoaderBase* New_ctor() ;

/// @brief Method ProcessOpenXRMessageLoop, addr 0x68213a4, size 0xb8, virtual false, abstract: false, final false
inline void ProcessOpenXRMessageLoop() ;

/// @brief Method ReceiveNativeEvent, addr 0x681f3d8, size 0x304, virtual false, abstract: false, final false
static inline void ReceiveNativeEvent(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_NativeEvent  e, uint64_t  payload) ;

/// @brief Method RegisterOpenXRCallbacks, addr 0x6820c74, size 0x9c, virtual false, abstract: false, final false
static inline void RegisterOpenXRCallbacks() ;

/// @brief Method RequestOpenXRFeatures, addr 0x68209b8, size 0x2bc, virtual false, abstract: false, final false
inline void RequestOpenXRFeatures() ;

/// @brief Method SetApplicationInfo, addr 0x6820e3c, size 0x158, virtual false, abstract: false, final false
inline void SetApplicationInfo() ;

/// @brief Method Start, addr 0x68214c0, size 0xa4, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method StartInternal, addr 0x6821564, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method Stop, addr 0x6822418, size 0x134, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method StopInternal, addr 0x682254c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method StringToWCHAR_T, addr 0x6822b04, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x681ed28, size 0x6b0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Instance, addr 0x681f6dc, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::XR::OpenXR::OpenXRLoaderBase> get_Instance() ;

/// @brief Method get_currentLoaderState, addr 0x681f798, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::OpenXRLoaderBase_LoaderState get_currentLoaderState() ;

/// @brief Method get_displaySubsystem, addr 0x681f7a8, size 0x68, virtual false, abstract: false, final false
inline Il2CppObject* get_displaySubsystem() ;

/// @brief Method get_inputSubsystem, addr 0x681f810, size 0xe4, virtual false, abstract: false, final false
inline ::UnityEngine::XR::XRInputSubsystem* get_inputSubsystem() ;

/// @brief Method get_isInitialized, addr 0x681f8f4, size 0x14, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_isStarted, addr 0x681f908, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_Instance, addr 0x681f738, size 0x60, virtual false, abstract: false, final false
static inline void set_Instance(::UnityEngine::XR::OpenXR::OpenXRLoaderBase*  value) ;

/// @brief Method set_currentLoaderState, addr 0x681f7a0, size 0x8, virtual false, abstract: false, final false
