...
// Ctor Parameters [CppParam { name: "colorFormat", ty: "::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFormat", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "color",
// ty: "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "depthFormat", ty:
// "::UnityEngine::XR::OpenXR::API::UnityXRDepthTextureFormat", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "depth", ty:
// "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "shadingRateFormat", ty:
// "::UnityEngine::XR::OpenXR::API::UnityXRShadingRateFormat", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "shadingRate", ty:
// "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "width", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "height", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "textureArrayLength", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }]
