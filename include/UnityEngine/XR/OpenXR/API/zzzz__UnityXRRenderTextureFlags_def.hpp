...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFlags, "UnityEngine.XR.OpenXR.API", "UnityXRRenderTextureFlags");
// Dependencies
namespace UnityEngine::XR::OpenXR::API {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFlags) == 0x4, "Size mismatch!");
