...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFormat, "UnityEngine.XR.OpenXR.API", "UnityXRRenderTextureFormat");
// Dependencies
namespace UnityEngine::XR::OpenXR::API {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFormat) == 0x4, "Size mismatch!");
