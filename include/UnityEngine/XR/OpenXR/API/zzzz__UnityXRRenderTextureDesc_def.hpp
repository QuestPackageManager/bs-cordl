...
// Dependencies UnityEngine.XR.OpenXR.API.UnityXRDepthTextureFormat, UnityEngine.XR.OpenXR.API.UnityXRRenderTextureFormat, UnityEngine.XR.OpenXR.API.UnityXRShadingRateFormat, UnityEngine.XR.OpenXR.API.UnityXRTextureData
namespace UnityEngine::XR::OpenXR::API {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "colorFormat", ty: "::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFormat", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: None }, CppParam { name: "depthFormat", ty: "::UnityEngine::XR::OpenXR::API::UnityXRDepthTextureFormat", modifiers: "", def_value: None }, CppParam { name: "depth", ty: "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: None }, CppParam { name: "shadingRateFormat", ty: "::UnityEngine::XR::OpenXR::API::UnityXRShadingRateFormat", modifiers: "", def_value: None }, CppParam { name: "shadingRate", ty: "::UnityEngine::XR::OpenXR::API::UnityXRTextureData", modifiers: "", def_value: None }, CppParam { name: "width", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "height", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "textureArrayLength", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr UnityXRRenderTextureDesc(::UnityEngine::XR::OpenXR::API::UnityXRRenderTextureFormat  colorFormat, ::UnityEngine::XR::OpenXR::API::UnityXRTextureData  color, ::UnityEngine::XR::OpenXR::API::UnityXRDepthTextureFormat  depthFormat, ::UnityEngine::XR::OpenXR::API::UnityXRTextureData  depth, ::UnityEngine::XR::OpenXR::API::UnityXRShadingRateFormat  shadingRateFormat, ::UnityEngine::XR::OpenXR::API::UnityXRTextureData  shadingRate, uint32_t  width, uint32_t  height, uint32_t  textureArrayLength, uint32_t  flags) noexcept;
