...
// Ctor Parameters [CppParam { name: "nativePtr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "referenceTextureId", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
