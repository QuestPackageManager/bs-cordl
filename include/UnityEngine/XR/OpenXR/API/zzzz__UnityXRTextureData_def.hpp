...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRTextureData, "UnityEngine.XR.OpenXR.API", "UnityXRTextureData");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRTextureData) == 0x10, "Size mismatch!");
