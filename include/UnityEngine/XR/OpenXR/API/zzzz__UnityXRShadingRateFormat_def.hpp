...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::API::UnityXRShadingRateFormat, "UnityEngine.XR.OpenXR.API", "UnityXRShadingRateFormat");
// Dependencies
namespace UnityEngine::XR::OpenXR::API {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::API::UnityXRShadingRateFormat) == 0x4, "Size mismatch!");
