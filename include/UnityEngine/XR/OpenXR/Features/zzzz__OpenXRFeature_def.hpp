...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_LoaderEvent, "UnityEngine.XR.OpenXR.Features", "OpenXRFeature/LoaderEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_NativeEvent, "UnityEngine.XR.OpenXR.Features", "OpenXRFeature/NativeEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_StatFlags, "UnityEngine.XR.OpenXR.Features", "OpenXRFeature/StatFlags");
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::OpenXRFeature_LoaderEvent) == 0x4, "Size mismatch!");
