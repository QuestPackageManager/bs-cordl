...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Interactions::PalmPoseInteraction*);
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Interactions::PalmPoseInteraction_PalmPose*);
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Interactions::PalmPoseInteraction___c*);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Interactions::PalmPoseInteraction___c) == 0x10, "Size mismatch!");
