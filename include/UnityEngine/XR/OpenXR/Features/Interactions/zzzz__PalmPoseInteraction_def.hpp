...
public:
  ...
  /// @brief Method FinishSetup, addr 0x68bd0cc, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68bd148, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_devicePosition, addr 0x68bd08c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_devicePosition();

  /// @brief Method get_deviceRotation, addr 0x68bd09c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_deviceRotation();

  /// @brief Method get_isTracked, addr 0x68bd06c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_isTracked();

  /// @brief Method get_palmPose, addr 0x68bd05c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_palmPose();

  /// @brief Method get_palmPosition, addr 0x68bd0ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_palmPosition();

  /// @brief Method get_palmRotation, addr 0x68bd0bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_palmRotation();

  /// @brief Method get_trackingState, addr 0x68bd07c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_trackingState();

  /// @brief Method set_devicePosition, addr 0x68bd094, size 0x8, virtual false, abstract: false, final false
  inline void set_devicePosition(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_deviceRotation, addr 0x68bd0a4, size 0x8, virtual false, abstract: false, final false
  inline void set_deviceRotation(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_isTracked, addr 0x68bd074, size 0x8, virtual false, abstract: false, final false
  inline void set_isTracked(::UnityEngine::InputSystem::Controls::ButtonControl* value);

  /// @brief Method set_palmPose, addr 0x68bd064, size 0x8, virtual false, abstract: false, final false
  inline void set_palmPose(::UnityEngine::XR::OpenXR::Input::PoseControl* value);

  /// @brief Method set_palmPosition, addr 0x68bd0b4, size 0x8, virtual false, abstract: false, final false
  inline void set_palmPosition(::UnityEngine::InputSystem::Controls::Vector3Control* value);

  /// @brief Method set_palmRotation, addr 0x68bd0c4, size 0x8, virtual false, abstract: false, final false
  inline void set_palmRotation(::UnityEngine::InputSystem::Controls::QuaternionControl* value);

  /// @brief Method set_trackingState, addr 0x68bd084, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddAdditiveActions>b__15_0, addr 0x68bd1c0, size 0xb8, virtual false, abstract: false, final false
  inline bool _AddAdditiveActions_b__15_0(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_DeviceConfig* d);

  /// @brief Method <AddAdditiveActions>b__15_1, addr 0x68bd278, size 0x14, virtual false, abstract: false, final false
  inline bool _AddAdditiveActions_b__15_1(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionConfig* a);

  /// @brief Method .ctor, addr 0x68bd1bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddAdditiveActions, addr 0x68bc9ec, size 0x614, virtual true, abstract: false, final false
  ...
  /// @brief Method AddBindingBasedOnRuntimeAPIVersion, addr 0x68bc86c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeviceLayoutName, addr 0x68bc47c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetDeviceLayoutName();

  static inline ::UnityEngine::XR::OpenXR::Features::Interactions::PalmPoseInteraction* New_ctor();

  /// @brief Method OnInstanceCreate, addr 0x68bc258, size 0x6c, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method RegisterActionMapsWithRuntime, addr 0x68bc4c0, size 0x3ac, virtual true, abstract: false, final false
  inline void RegisterActionMapsWithRuntime();

  /// @brief Method RegisterDeviceLayout, addr 0x68bc2c4, size 0x148, virtual true, abstract: false, final false
  inline void RegisterDeviceLayout();

  /// @brief Method UnregisterDeviceLayout, addr 0x68bc40c, size 0x70, virtual true, abstract: false, final false
  inline void UnregisterDeviceLayout();

  /// @brief Method .ctor, addr 0x68bd000, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsAdditive, addr 0x68bc250, size 0x8, virtual true, abstract: false, final false
