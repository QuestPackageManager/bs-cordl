...
/// @brief Method FinishSetup, addr 0x682ece8, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x682ed60, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pose, addr 0x682ecd8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_pose() ;

/// @brief Method set_pose, addr 0x682ece0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetDeviceLayoutName, addr 0x682e6f0, size 0x44, virtual true, abstract: false, final false
inline ::StringW GetDeviceLayoutName() ;

/// @brief Method GetInteractionProfileType, addr 0x682e63c, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method OnInstanceCreate, addr 0x682e400, size 0x6c, virtual true, abstract: false, final false
inline bool OnInstanceCreate(uint64_t  instance) ;

/// @brief Method RegisterActionMapsWithRuntime, addr 0x682e734, size 0x548, virtual true, abstract: false, final false
inline void RegisterActionMapsWithRuntime() ;

/// @brief Method RegisterDeviceLayout, addr 0x682e46c, size 0x160, virtual true, abstract: false, final false
inline void RegisterDeviceLayout() ;

/// @brief Method UnregisterDeviceLayout, addr 0x682e5cc, size 0x70, virtual true, abstract: false, final false
inline void UnregisterDeviceLayout() ;

/// @brief Method .ctor, addr 0x682ec7c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
