...
public:
  ...
  /// @brief Method FinishSetup, addr 0x68a2574, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68a2670, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_devicePose, addr 0x68a2534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_devicePose();

  /// @brief Method get_pinchPose, addr 0x68a2564, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_pinchPose();

  /// @brief Method get_pointer, addr 0x68a2544, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_pointer();

  /// @brief Method get_pokePose, addr 0x68a2554, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::OpenXR::Input::PoseControl* get_pokePose();

  /// @brief Method set_devicePose, addr 0x68a253c, size 0x8, virtual false, abstract: false, final false
  inline void set_devicePose(::UnityEngine::XR::OpenXR::Input::PoseControl* value);

  /// @brief Method set_pinchPose, addr 0x68a256c, size 0x8, virtual false, abstract: false, final false
  inline void set_pinchPose(::UnityEngine::XR::OpenXR::Input::PoseControl* value);

  /// @brief Method set_pointer, addr 0x68a254c, size 0x8, virtual false, abstract: false, final false
  inline void set_pointer(::UnityEngine::XR::OpenXR::Input::PoseControl* value);

  /// @brief Method set_pokePose, addr 0x68a255c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddAdditiveActions>b__17_0, addr 0x68a26e8, size 0xb8, virtual false, abstract: false, final false
  inline bool _AddAdditiveActions_b__17_0(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_DeviceConfig* d);

  /// @brief Method <AddAdditiveActions>b__17_1, addr 0x68a27a0, size 0x14, virtual false, abstract: false, final false
  inline bool _AddAdditiveActions_b__17_1(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionConfig* a);

  /// @brief Method <AddAdditiveActions>b__17_2, addr 0x68a27b4, size 0x1c, virtual false, abstract: false, final false
  inline bool _AddAdditiveActions_b__17_2(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionConfig* m);

  /// @brief Method .ctor, addr 0x68a26e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddAdditiveActions>b__3, addr 0x68a27d0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68a24d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddAdditiveActions, addr 0x68a1bc0, size 0x914, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDeviceLayoutName, addr 0x68a115c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetDeviceLayoutName();

  /// @brief Method GetInteractionProfileType, addr 0x68a10a8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnInstanceCreate, addr 0x68a0e84, size 0x6c, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method RegisterActionMapsWithRuntime, addr 0x68a11a0, size 0xa20, virtual true, abstract: false, final false
  inline void RegisterActionMapsWithRuntime();

  /// @brief Method RegisterDeviceLayout, addr 0x68a0ef0, size 0x148, virtual true, abstract: false, final false
  inline void RegisterDeviceLayout();

  /// @brief Method UnregisterDeviceLayout, addr 0x68a1038, size 0x70, virtual true, abstract: false, final false
  inline void UnregisterDeviceLayout();

  /// @brief Method .ctor, addr 0x68a24d8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsAdditive, addr 0x68a0e7c, size 0x8, virtual true, abstract: false, final false
