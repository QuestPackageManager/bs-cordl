...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EyeTrackingUsages", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EyeTrackingUsages(EyeTrackingUsages&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EyeTrackingUsages", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EyeTrackingUsages(EyeTrackingUsagesconst&) = delete;
