...
// [Preserve]
// [InputControlLayout(displayName = "Oculus Touch Controller (OpenXR)", commonUsages = new[] { "LeftHand", "RightHand" })]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OculusTouchControllerProfile_OculusTouchController", modifiers: "&&", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OculusTouchControllerProfile", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
