...
// [Preserve]
// [InputControlLayout(displayName = "Meta Quest Touch Plus Controller(OpenXR)", commonUsages = new[] { "LeftHand", "RightHand" })]
...
public:
  ...
  /// [Preserve]
  /// @brief [InputControl(offset = 36, noisy = true, alias = "gripPosition")]
  ...
  /// [Preserve]
  /// @brief [InputControl(offset = 48, noisy = true, alias = "gripOrientation")]
  ...
  /// [Preserve]
  /// @brief [InputControl(aliases = new[] { "Primary", "menuButton", "systemButton" }, usage = "MenuButton")]
  ...
  /// [Preserve]
  /// @brief [InputControl(aliases = new[] { "ATouched", "XTouched", "ATouch", "XTouch", "buttonATouched", "buttonXTouched" }, usage = "PrimaryTouch")]
  ...
  /// [Preserve]
  /// @brief [InputControl(aliases = new[] { "BTouched", "YTouched", "BTouch", "YTouch", "buttonBTouched", "buttonYTouched" }, usage = "SecondaryTouch")]
  ...
  /// [Preserve]
  /// @brief [InputControl(usage = "ThumbProximity")]
  ...
  /// [Preserve]
  /// @brief [InputControl(usage = "ThumbrestTouch")]
  ...
  /// [Preserve]
  /// @brief [InputControl(usage = "TriggerProximity")]
  ...
  /// [Preserve]
  /// @brief [InputControl(usage = "TriggerSlide")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaQuestTouchPlusControllerProfile_QuestTouchPlusController", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "MetaQuestTouchPlusControllerProfile_QuestTouchPlusController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaQuestTouchPlusControllerProfile_QuestTouchPlusController(MetaQuestTouchPlusControllerProfile_QuestTouchPlusControllerconst&) = delete;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaQuestTouchPlusControllerProfile", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaQuestTouchPlusControllerProfile(MetaQuestTouchPlusControllerProfile&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaQuestTouchPlusControllerProfile", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaQuestTouchPlusControllerProfile(MetaQuestTouchPlusControllerProfileconst&) = delete;
