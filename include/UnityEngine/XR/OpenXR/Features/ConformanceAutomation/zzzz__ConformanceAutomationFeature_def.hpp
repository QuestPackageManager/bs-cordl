...
/// @brief Method ConformanceAutomationSetActive, addr 0x683bfb4, size 0xac, virtual false, abstract: false, final false
static inline bool ConformanceAutomationSetActive(::StringW  interactionProfile, ::StringW  topLevelPath, bool  isActive) ;

/// @brief Method ConformanceAutomationSetBool, addr 0x683c104, size 0xac, virtual false, abstract: false, final false
static inline bool ConformanceAutomationSetBool(::StringW  topLevelPath, ::StringW  inputSourcePath, bool  state) ;

/// @brief Method ConformanceAutomationSetFloat, addr 0x683c254, size 0xb4, virtual false, abstract: false, final false
static inline bool ConformanceAutomationSetFloat(::StringW  topLevelPath, ::StringW  inputSourcePath, float_t  state) ;

/// @brief Method ConformanceAutomationSetPose, addr 0x683c524, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method ConformanceAutomationSetVec2, addr 0x683c3b4, size 0xbc, virtual false, abstract: false, final false
static inline bool ConformanceAutomationSetVec2(::StringW  topLevelPath, ::StringW  inputSourcePath, ::UnityEngine::Vector2  state) ;

/// @brief Method ConformanceAutomationSetVelocity, addr 0x683c70c, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method OnInstanceCreate, addr 0x683bd64, size 0xe4, virtual true, abstract: false, final false
inline bool OnInstanceCreate(uint64_t  instance) ;

/// @brief Method OnInstanceDestroy, addr 0x683becc, size 0x4c, virtual true, abstract: false, final false
inline void OnInstanceDestroy(uint64_t  xrInstance) ;

/// @brief Method OnSessionCreate, addr 0x683bf18, size 0x50, virtual true, abstract: false, final false
inline void OnSessionCreate(uint64_t  xrSessionId) ;

/// @brief Method OnSessionDestroy, addr 0x683bf68, size 0x4c, virtual true, abstract: false, final false
inline void OnSessionDestroy(uint64_t  xrSessionId) ;

/// @brief Method .ctor, addr 0x683c90c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method initialize, addr 0x683be48, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceActiveEXT, addr 0x683c060, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceLocationEXT, addr 0x683c648, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceStateBoolEXT, addr 0x683c1b0, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceStateFloatEXT, addr 0x683c308, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceStateVector2fEXT, addr 0x683c470, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method xrSetInputDeviceVelocityUNITY, addr 0x683c810, size 0xfc, virtual false, abstract: false, final false
