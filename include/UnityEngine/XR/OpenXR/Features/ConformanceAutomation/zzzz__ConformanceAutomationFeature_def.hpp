...
public:
  ...
  /// @brief Method ConformanceAutomationSetActive, addr 0x67d3d7c, size 0xac, virtual false, abstract: false, final false
  static inline bool ConformanceAutomationSetActive(::StringW interactionProfile, ::StringW topLevelPath, bool isActive);

  /// @brief Method ConformanceAutomationSetBool, addr 0x67d3ecc, size 0xac, virtual false, abstract: false, final false
  static inline bool ConformanceAutomationSetBool(::StringW topLevelPath, ::StringW inputSourcePath, bool state);

  /// @brief Method ConformanceAutomationSetFloat, addr 0x67d401c, size 0xb4, virtual false, abstract: false, final false
  static inline bool ConformanceAutomationSetFloat(::StringW topLevelPath, ::StringW inputSourcePath, float_t state);

  /// @brief Method ConformanceAutomationSetPose, addr 0x67d42ec, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ConformanceAutomationSetVec2, addr 0x67d417c, size 0xbc, virtual false, abstract: false, final false
  static inline bool ConformanceAutomationSetVec2(::StringW topLevelPath, ::StringW inputSourcePath, ::UnityEngine::Vector2 state);

  /// @brief Method ConformanceAutomationSetVelocity, addr 0x67d44d4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInstanceCreate, addr 0x67d3b2c, size 0xe4, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method OnInstanceDestroy, addr 0x67d3c94, size 0x4c, virtual true, abstract: false, final false
  inline void OnInstanceDestroy(uint64_t xrInstance);

  /// @brief Method OnSessionCreate, addr 0x67d3ce0, size 0x50, virtual true, abstract: false, final false
  inline void OnSessionCreate(uint64_t xrSessionId);

  /// @brief Method OnSessionDestroy, addr 0x67d3d30, size 0x4c, virtual true, abstract: false, final false
  inline void OnSessionDestroy(uint64_t xrSessionId);

  /// @brief Method .ctor, addr 0x67d46d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method initialize, addr 0x67d3c10, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceActiveEXT, addr 0x67d3e28, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceLocationEXT, addr 0x67d4410, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceStateBoolEXT, addr 0x67d3f78, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceStateFloatEXT, addr 0x67d40d0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceStateVector2fEXT, addr 0x67d4238, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method xrSetInputDeviceVelocityUNITY, addr 0x67d45d8, size 0xfc, virtual false, abstract: false, final false
