...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings",
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel) == 0x4, "Size mismatch!");
