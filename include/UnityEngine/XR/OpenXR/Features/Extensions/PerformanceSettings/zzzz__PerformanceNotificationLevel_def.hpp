...
} // namespace end def UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings", "PerformanceNotificationLevel");
