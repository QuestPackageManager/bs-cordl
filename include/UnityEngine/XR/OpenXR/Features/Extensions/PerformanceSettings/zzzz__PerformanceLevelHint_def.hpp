...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceLevelHint, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings", "PerformanceLevelHint");
