...
constexpr ::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain  UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain::Cpu{static_cast<int32_t>(0x1)};
constexpr ::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain  UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain::Gpu{static_cast<int32_t>(0x2)};
