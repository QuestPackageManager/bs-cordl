...
// Dependencies UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings.PerformanceDomain, UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings.PerformanceNotificationLevel, UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings.PerformanceSubDomain
namespace UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings {
// Is value type: true
...
// Ctor Parameters [CppParam { name: "domain", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain", modifiers: "", def_value: None }, CppParam { name: "subDomain", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceSubDomain", modifiers: "", def_value: None }, CppParam { name: "fromLevel", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel", modifiers: "", def_value: None }, CppParam { name: "toLevel", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel", modifiers: "", def_value: None }]
constexpr PerformanceChangeNotification(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain  domain, ::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceSubDomain  subDomain, ::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel  fromLevel, ::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel  toLevel) noexcept;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceChangeNotification, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings", "PerformanceChangeNotification");
