...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceSubDomain, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings",
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceSubDomain) == 0x4, "Size mismatch!");
