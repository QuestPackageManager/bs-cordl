...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::NativeApi_XrPerformanceSettingsFeature_XrPerformanceNotificationDelegate*);
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature*);
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature_NativeApi*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::NativeApi_XrPerformanceSettingsFeature_XrPerformanceNotificationDelegate*,
...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature*, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings",
                    "XrPerformanceSettingsFeature");
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature_NativeApi*, "UnityEngine.XR.OpenXR.Features.Extensions.PerformanceSettings",
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6a19664, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6a196ec, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6a19650, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a19554, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::NativeApi_XrPerformanceSettingsFeature_XrPerformanceNotificationDelegate) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method xr_performance_settings_setEventCallback, addr 0x6a195c0, size 0x88, virtual false, abstract: false, final false
  static inline bool
  ...
  /// @brief Method xr_performance_settings_setPerformanceLevel, addr 0x6a19420, size 0x8c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature_NativeApi) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnInstanceCreate, addr 0x6a194ac, size 0xa8, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t xrInstance);

  /// @brief Method OnXrPerformanceNotificationCallback, addr 0x6a19164, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPerformanceLevelHint, addr 0x6a193a8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a19648, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnXrPerformanceChangeNotification, addr 0x6a191e8, size 0xe0, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method remove_OnXrPerformanceChangeNotification, addr 0x6a192c8, size 0xe0, virtual false, abstract: false, final false
  static inline void
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::XrPerformanceSettingsFeature) == 0x50, "Size mismatch!");
