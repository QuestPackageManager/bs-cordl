...
// Ctor Parameters [CppParam { name: "domain", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceDomain", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "subDomain", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceSubDomain", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "fromLevel", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "toLevel", ty: "::UnityEngine::XR::OpenXR::Features::Extensions::PerformanceSettings::PerformanceNotificationLevel", modifiers: "", def_value: Some("{}"), comment: None }]
