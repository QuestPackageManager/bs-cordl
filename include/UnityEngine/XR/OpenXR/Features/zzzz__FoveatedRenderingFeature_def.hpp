...
public:
  // Declarations
  /// @brief Method HookGetInstanceProcAddr, addr 0x69f5cc4, size 0x8, virtual true, abstract: false, final false
  inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr func);

  /// @brief Method Internal_Unity_GetUseFoveatedRenderingLegacyMode, addr 0x69f5d48, size 0x6c, virtual false, abstract: false, final false
  static inline bool Internal_Unity_GetUseFoveatedRenderingLegacyMode();

  /// @brief Method Internal_Unity_SetUseFoveatedRenderingLegacyMode, addr 0x69f5c40, size 0x7c, virtual false, abstract: false, final false
  static inline void Internal_Unity_SetUseFoveatedRenderingLegacyMode(bool value);

  /// @brief Method Internal_Unity_intercept_xrGetInstanceProcAddr, addr 0x69f5ccc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInstanceCreate, addr 0x69f5b9c, size 0xa4, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t instance);

  /// @brief Method .ctor, addr 0x69f5db4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
