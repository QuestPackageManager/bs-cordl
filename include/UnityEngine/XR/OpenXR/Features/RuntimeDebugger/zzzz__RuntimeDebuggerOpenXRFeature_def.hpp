...
public:
  ...
  /// @brief Method HookGetInstanceProcAddr, addr 0x68b03c8, size 0x104, virtual true, abstract: false, final false
  inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr func);

  /// @brief Method Native_EndDataAccess, addr 0x68b0530, size 0x64, virtual false, abstract: false, final false
  static inline void Native_EndDataAccess();

  /// @brief Method Native_GetDataForRead, addr 0x68b08d8, size 0x8c, virtual false, abstract: false, final false
  static inline bool Native_GetDataForRead(::ByRef<::System::IntPtr> ptr, ::ByRef<uint32_t> size);

  /// @brief Method Native_GetLUTData, addr 0x68b0844, size 0x94, virtual false, abstract: false, final false
  static inline void Native_GetLUTData(::ByRef<::System::IntPtr> ptr, ::ByRef<uint32_t> size, uint32_t offset);

  /// @brief Method Native_HookGetInstanceProcAddr, addr 0x68b0594, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Native_StartDataAccess, addr 0x68b04cc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method RecvMsg, addr 0x68b0628, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68b0964, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
