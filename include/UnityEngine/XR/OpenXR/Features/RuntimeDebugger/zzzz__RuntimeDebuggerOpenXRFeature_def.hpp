...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::Features::RuntimeDebugger::RuntimeDebuggerOpenXRFeature*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::Features::RuntimeDebugger::RuntimeDebuggerOpenXRFeature*, "UnityEngine.XR.OpenXR.Features.RuntimeDebugger", "RuntimeDebuggerOpenXRFeature");
...
public:
  ...
  /// @brief Method HookGetInstanceProcAddr, addr 0x6a08e58, size 0x104, virtual true, abstract: false, final false
  inline ::System::IntPtr HookGetInstanceProcAddr(::System::IntPtr func);

  /// @brief Method Native_EndDataAccess, addr 0x6a08fc0, size 0x64, virtual false, abstract: false, final false
  static inline void Native_EndDataAccess();

  /// @brief Method Native_GetDataForRead, addr 0x6a09368, size 0x8c, virtual false, abstract: false, final false
  static inline bool Native_GetDataForRead(::by_ref<::System::IntPtr> ptr, ::by_ref<uint32_t> size);

  /// @brief Method Native_GetLUTData, addr 0x6a092d4, size 0x94, virtual false, abstract: false, final false
  static inline void Native_GetLUTData(::by_ref<::System::IntPtr> ptr, ::by_ref<uint32_t> size, uint32_t offset);

  /// @brief Method Native_HookGetInstanceProcAddr, addr 0x6a09024, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Native_StartDataAccess, addr 0x6a08f5c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method RecvMsg, addr 0x6a090b8, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a093f4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::Features::RuntimeDebugger::RuntimeDebuggerOpenXRFeature) == 0x60, "Size mismatch!");
