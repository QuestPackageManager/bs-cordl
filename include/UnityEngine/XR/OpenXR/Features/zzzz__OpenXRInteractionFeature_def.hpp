...
/// @brief Method .ctor, addr 0x682c310, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x682c314, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x682c318, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x682c31c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_InteractionProfileEnabledMaps, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_InteractionProfileEnabledMaps, put=setStaticF_m_InteractionProfileEnabledMaps)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_InteractionProfileType,::System::Collections::Generic::Dictionary_2<::StringW,bool>*>*  m_InteractionProfileEnabledMaps;

/// @brief Method AddActionMap, addr 0x682c0c8, size 0x178, virtual false, abstract: false, final false
inline void AddActionMap(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionMapConfig*  map) ;

/// @brief Method AddAdditiveActions, addr 0x682c240, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method CreateActionMaps, addr 0x6827130, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetDeviceLayoutName, addr 0x682c084, size 0x44, virtual true, abstract: false, final false
inline ::StringW GetDeviceLayoutName() ;

/// @brief Method GetInteractionProfileType, addr 0x682c07c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method OnEnabledChange, addr 0x682c244, size 0x4, virtual true, abstract: false, final false
inline void OnEnabledChange() ;

/// @brief Method OnInstanceCreate, addr 0x682c05c, size 0x20, virtual true, abstract: false, final false
inline bool OnInstanceCreate(uint64_t  xrSession) ;

/// @brief Method RegisterActionMapsWithRuntime, addr 0x682c058, size 0x4, virtual true, abstract: false, final false
inline void RegisterActionMapsWithRuntime() ;

/// @brief Method RegisterDeviceLayout, addr 0x682c050, size 0x4, virtual true, abstract: false, final false
inline void RegisterDeviceLayout() ;

/// @brief Method RegisterLayouts, addr 0x6826e70, size 0x108, virtual false, abstract: false, final false
static inline void RegisterLayouts() ;

/// @brief Method UnregisterDeviceLayout, addr 0x682c054, size 0x4, virtual true, abstract: false, final false
inline void UnregisterDeviceLayout() ;

/// @brief Method .ctor, addr 0x682c248, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_InteractionProfileType,::System::Collections::Generic::Dictionary_2<::StringW,bool>*>* getStaticF_m_InteractionProfileEnabledMaps() ;

/// @brief Method get_IsAdditive, addr 0x682c048, size 0x8, virtual true, abstract: false, final false
...
static inline void setStaticF_m_InteractionProfileEnabledMaps(::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_InteractionProfileType,::System::Collections::Generic::Dictionary_2<::StringW,bool>*>*  value) ;
