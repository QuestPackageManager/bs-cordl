...
public:
  ...
  /// @brief Method .ctor, addr 0x689e31c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x689e320, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x689e324, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x689e328, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddActionMap, addr 0x689e0d4, size 0x178, virtual false, abstract: false, final false
  inline void AddActionMap(::UnityEngine::XR::OpenXR::Features::OpenXRInteractionFeature_ActionMapConfig* map);

  /// @brief Method AddAdditiveActions, addr 0x689e24c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateActionMaps, addr 0x689913c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDeviceLayoutName, addr 0x689e090, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetDeviceLayoutName();

  /// @brief Method GetInteractionProfileType, addr 0x689e088, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnabledChange, addr 0x689e250, size 0x4, virtual true, abstract: false, final false
  inline void OnEnabledChange();

  /// @brief Method OnInstanceCreate, addr 0x689e068, size 0x20, virtual true, abstract: false, final false
  inline bool OnInstanceCreate(uint64_t xrSession);

  /// @brief Method RegisterActionMapsWithRuntime, addr 0x689e064, size 0x4, virtual true, abstract: false, final false
  inline void RegisterActionMapsWithRuntime();

  /// @brief Method RegisterDeviceLayout, addr 0x689e05c, size 0x4, virtual true, abstract: false, final false
  inline void RegisterDeviceLayout();

  /// @brief Method RegisterLayouts, addr 0x6898e7c, size 0x108, virtual false, abstract: false, final false
  static inline void RegisterLayouts();

  /// @brief Method UnregisterDeviceLayout, addr 0x689e060, size 0x4, virtual true, abstract: false, final false
  inline void UnregisterDeviceLayout();

  /// @brief Method .ctor, addr 0x689e254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IsAdditive, addr 0x689e054, size 0x8, virtual true, abstract: false, final false
