...
// Ctor Parameters [CppParam { name: "success", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "runtime", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "runtime_version", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "plugin_version", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "api_version", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "available_extensions", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "enabled_extensions", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "enabled_features", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "failed_features", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }]
constexpr OpenXRAnalytics_InitializeEvent(bool  success, ::StringW  runtime, ::StringW  runtime_version, ::StringW  plugin_version, ::StringW  api_version, ::ArrayW<::StringW,::Array<::StringW>*>  available_extensions, ::ArrayW<::StringW,::Array<::StringW>*>  enabled_extensions, ::ArrayW<::StringW,::Array<::StringW>*>  enabled_features, ::ArrayW<::StringW,::Array<::StringW>*>  failed_features) noexcept;
...
/// @brief Method <CreateInitializeEvent>b__7_0, addr 0x681e450, size 0xa4, virtual false, abstract: false, final false
inline ::StringW _CreateInitializeEvent_b__7_0(::StringW  ext) ;

/// @brief Method <CreateInitializeEvent>b__7_1, addr 0x681e4f8, size 0xa4, virtual false, abstract: false, final false
inline ::StringW _CreateInitializeEvent_b__7_1(::StringW  ext) ;

/// @brief Method <CreateInitializeEvent>b__7_2, addr 0x681e59c, size 0x84, virtual false, abstract: false, final false
inline bool _CreateInitializeEvent_b__7_2(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method <CreateInitializeEvent>b__7_3, addr 0x681e620, size 0x78, virtual false, abstract: false, final false
inline ::StringW _CreateInitializeEvent_b__7_3(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method <CreateInitializeEvent>b__7_4, addr 0x681e698, size 0x84, virtual false, abstract: false, final false
inline bool _CreateInitializeEvent_b__7_4(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method <CreateInitializeEvent>b__7_5, addr 0x681e71c, size 0x78, virtual false, abstract: false, final false
inline ::StringW _CreateInitializeEvent_b__7_5(::UnityEngine::XR::OpenXR::Features::OpenXRFeature*  f) ;

/// @brief Method .ctor, addr 0x681e44c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateInitializeEvent, addr 0x681d9cc, size 0x544, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::OpenXR::OpenXRAnalytics_InitializeEvent CreateInitializeEvent(bool  success) ;

/// @brief Method Initialize, addr 0x681d9c0, size 0x8, virtual false, abstract: false, final false
static inline bool Initialize() ;

/// @brief Method SendInitializeEvent, addr 0x681d9c8, size 0x4, virtual false, abstract: false, final false
