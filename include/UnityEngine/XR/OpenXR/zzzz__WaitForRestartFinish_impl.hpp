...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::XR::OpenXR::WaitForRestartFinish::*)(float_t)>(&::UnityEngine::XR::OpenXR::WaitForRestartFinish::_ctor)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x6824d90;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::XR::OpenXR::WaitForRestartFinish::*)()>(&::UnityEngine::XR::OpenXR::WaitForRestartFinish::get_keepWaiting)> {
  constexpr static std::size_t size = 0xec;
  constexpr static std::size_t addrs = 0x6826a00;
