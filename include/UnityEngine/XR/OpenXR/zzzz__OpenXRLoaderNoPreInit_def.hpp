...
// Write type traits
MARK_REF_T(::UnityEngine::XR::OpenXR::OpenXRLoaderNoPreInit*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::OpenXR::OpenXRLoaderNoPreInit*, "UnityEngine.XR.OpenXR", "OpenXRLoaderNoPreInit");
...
public:
  ...
  /// @brief Method .ctor, addr 0x69f45b0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpenXRLoaderNoPreInit", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpenXRLoaderNoPreInit(OpenXRLoaderNoPreInit&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpenXRLoaderNoPreInit", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpenXRLoaderNoPreInit(OpenXRLoaderNoPreInitconst&) = delete;
...
static_assert(sizeof(::UnityEngine::XR::OpenXR::OpenXRLoaderNoPreInit) == 0x78, "Size mismatch!");
