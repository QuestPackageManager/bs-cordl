...
// Ctor Parameters [CppParam { name: "view", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "projection", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "viewport", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "occlusionMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: None }, CppParam { name: "textureArraySlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "previousView", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "isPreviousViewValid", ty: "bool", modifiers: "", def_value: None }]
constexpr XRDisplaySubsystem_XRRenderParameter(::UnityEngine::Matrix4x4  view, ::UnityEngine::Matrix4x4  projection, ::UnityEngine::Rect  viewport, ::UnityW<::UnityEngine::Mesh>  occlusionMesh, int32_t  textureArraySlice, ::UnityEngine::Matrix4x4  previousView, bool  isPreviousViewValid) noexcept;
...
public:
// Declarations
/// @brief Method GetRenderParameter, addr 0x6cde990, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method GetRenderParameterCount, addr 0x6cdea94, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetRenderParameterCount() ;

/// @brief Method GetRenderParameter_Injected, addr 0x6cdea38, size 0x5c, virtual false, abstract: false, final false
static inline void GetRenderParameter_Injected(::ByRef<::UnityEngine::XR::XRDisplaySubsystem_XRRenderPass>  _unity_self, ::System::IntPtr  camera, int32_t  renderParameterIndex, ::ByRef<::UnityEngine::XR::XRDisplaySubsystem_XRRenderParameter>  renderParameter) ;

// Ctor Parameters []
// @brief default ctor
constexpr XRDisplaySubsystem_XRRenderPass() ;

// Ctor Parameters [CppParam { name: "displaySubsystemInstance", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "renderPassIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "renderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: None }, CppParam { name: "renderTargetDesc", ty: "::UnityEngine::RenderTextureDescriptor", modifiers: "", def_value: None }, CppParam { name: "hasMotionVectorPass", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "motionVectorRenderTarget", ty: "::UnityEngine::Rendering::RenderTargetIdentifier", modifiers: "", def_value: None }, CppParam { name: "motionVectorRenderTargetDesc", ty: "::UnityEngine::RenderTextureDescriptor", modifiers: "", def_value: None }, CppParam { name: "shouldFillOutDepth", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "cullingPassIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "foveatedRenderingInfo", ty: "::System::IntPtr", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method GetBlitParameter, addr 0x6cdead0, size 0x54, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method ConvertToNative, addr 0x6cdeb24, size 0x14, virtual false, abstract: false, final false
