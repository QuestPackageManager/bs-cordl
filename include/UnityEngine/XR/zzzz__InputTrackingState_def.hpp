...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::InputTrackingState, "UnityEngine.XR", "InputTrackingState");
// Dependencies
namespace UnityEngine::XR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::InputTrackingState) == 0x4, "Size mismatch!");
