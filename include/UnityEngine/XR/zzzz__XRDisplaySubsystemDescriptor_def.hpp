...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3907c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRDisplaySubsystemDescriptor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRDisplaySubsystemDescriptor(XRDisplaySubsystemDescriptor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRDisplaySubsystemDescriptor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRDisplaySubsystemDescriptor(XRDisplaySubsystemDescriptorconst&) = delete;
