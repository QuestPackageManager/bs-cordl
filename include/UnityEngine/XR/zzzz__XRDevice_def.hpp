...
public:
  ...
  /// @brief Method DisableAutoXRCameraTracking, addr 0x36320d4, size 0x44, virtual false, abstract: false, final false
  static inline void DisableAutoXRCameraTracking(::UnityEngine::Camera* camera, bool disabled);

  /// @brief Method InvokeDeviceLoaded, addr 0x3632118, size 0x6c, virtual false, abstract: false, final false
  static inline void InvokeDeviceLoaded(::StringW loadedDeviceName);

  /// @brief Method SetTrackingSpaceType, addr 0x3632098, size 0x3c, virtual false, abstract: false, final false
