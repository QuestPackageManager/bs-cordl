...
public:
  ...
  /// @brief Method DisableAutoXRCameraTracking, addr 0x6e3325c, size 0xb4, virtual false, abstract: false, final false
  static inline void DisableAutoXRCameraTracking(::UnityEngine::Camera* camera, bool disabled);

  /// @brief Method DisableAutoXRCameraTracking_Injected, addr 0x6e33310, size 0x44, virtual false, abstract: false, final false
  static inline void DisableAutoXRCameraTracking_Injected(::System::IntPtr camera, bool disabled);

  /// @brief Method InvokeDeviceLoaded, addr 0x6e33354, size 0x70, virtual false, abstract: false, final false
  static inline void InvokeDeviceLoaded(::StringW loadedDeviceName);

  /// @brief Method SetTrackingSpaceType, addr 0x6e33220, size 0x3c, virtual false, abstract: false, final false
