...
public:
  ...
  /// @brief Method TryGet, addr 0x6cdb140, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGet, addr 0x6cdb0b0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetAcceleration, addr 0x6cdb1e4, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetAcceleration(::ByRef<::UnityEngine::Vector3> acceleration);

  /// @brief Method TryGetAngularAcceleration, addr 0x6cdb1f8, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetAngularAcceleration(::ByRef<::UnityEngine::Vector3> angularAcceleration);

  /// @brief Method TryGetAngularVelocity, addr 0x6cdb1d0, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetAngularVelocity(::ByRef<::UnityEngine::Vector3> angularVelocity);

  /// @brief Method TryGetPosition, addr 0x6cdb09c, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetPosition(::ByRef<::UnityEngine::Vector3> position);

  /// @brief Method TryGetRotation, addr 0x6cdb12c, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetRotation(::ByRef<::UnityEngine::Quaternion> rotation);

  /// @brief Method TryGetVelocity, addr 0x6cdb1bc, size 0x14, virtual false, abstract: false, final false
  inline bool TryGetVelocity(::ByRef<::UnityEngine::Vector3> velocity);

  /// @brief Method get_nodeType, addr 0x6cdb094, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::XRNode get_nodeType();

  /// @brief Method set_nodeType, addr 0x6cdadb8, size 0x8, virtual false, abstract: false, final false
  inline void set_nodeType(::UnityEngine::XR::XRNode value);

  /// @brief Method set_tracked, addr 0x6cdadc0, size 0xc, virtual false, abstract: false, final false
  inline void set_tracked(bool value);

  /// @brief Method set_uniqueID, addr 0x6cdadb0, size 0x8, virtual false, abstract: false, final false
