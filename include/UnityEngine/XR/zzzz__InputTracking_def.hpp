...
public:
  ...
  /// @brief Method GetDeviceIdAtXRNode, addr 0x6cdb058, size 0x3c, virtual false, abstract: false, final false
  static inline uint64_t GetDeviceIdAtXRNode(::UnityEngine::XR::XRNode node);

  /// @brief Method GetNodeStates, addr 0x6cdadcc, size 0x9c, virtual false, abstract: false, final false
  static inline void GetNodeStates(::System::Collections::Generic::List_1<::UnityEngine::XR::XRNodeState>* nodeStates);

  /// @brief Method GetNodeStates_Internal, addr 0x6cdae68, size 0x1b4, virtual false, abstract: false, final false
  static inline void GetNodeStates_Internal(::System::Collections::Generic::List_1<::UnityEngine::XR::XRNodeState>* nodeStates);

  /// @brief Method GetNodeStates_Internal_Injected, addr 0x6cdb01c, size 0x3c, virtual false, abstract: false, final false
  static inline void GetNodeStates_Internal_Injected(::ByRef<::UnityEngine::Bindings::BlittableListWrapper> nodeStates);

  /// @brief Method InvokeTrackingEvent, addr 0x6cdac20, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method add_nodeAdded, addr 0x6cda890, size 0xe4, virtual false, abstract: false, final false
  static inline void add_nodeAdded(::System::Action_1<::UnityEngine::XR::XRNodeState>* value);

  /// @brief Method add_nodeRemoved, addr 0x6cdaa58, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_nodeAdded, addr 0x6cda974, size 0xe4, virtual false, abstract: false, final false
  static inline void remove_nodeAdded(::System::Action_1<::UnityEngine::XR::XRNodeState>* value);

  /// @brief Method remove_nodeRemoved, addr 0x6cdab3c, size 0xe4, virtual false, abstract: false, final false
