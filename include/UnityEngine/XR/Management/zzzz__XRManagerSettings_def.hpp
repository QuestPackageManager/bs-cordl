...
public:
  ...
  /// @brief Method MoveNext, addr 0x688d040, size 0x30c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::XR::Management::XRManagerSettings__InitializeLoader_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x688d394, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x688d39c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x688d3d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x688cfe4, size 0x5c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x688d34c, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x688c948, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x688cd50, size 0x178, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckGraphicsAPICompatibility, addr 0x688c75c, size 0x198, virtual false, abstract: false, final false
  inline bool CheckGraphicsAPICompatibility(::UnityEngine::XR::Management::XRLoader* loader);

  /// @brief Method DeinitializeLoader, addr 0x688c404, size 0xf0, virtual false, abstract: false, final false
  inline void DeinitializeLoader();

  /// @brief Method InitializeLoader, addr 0x688c8f4, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* InitializeLoader();

  /// @brief Method InitializeLoaderSync, addr 0x688bf80, size 0x204, virtual false, abstract: false, final false
  inline void InitializeLoaderSync();

  static inline ::UnityEngine::XR::Management::XRManagerSettings* New_ctor();

  /// @brief Method OnDestroy, addr 0x688cef8, size 0x10, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x688cee0, size 0x18, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x688cec8, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSubsystems, addr 0x688c184, size 0xe8, virtual false, abstract: false, final false
  inline void StartSubsystems();

  /// @brief Method StopSubsystems, addr 0x688c31c, size 0xe8, virtual false, abstract: false, final false
  inline void StopSubsystems();

  /// @brief Method TryAddLoader, addr 0x688c950, size 0x1ac, virtual false, abstract: false, final false
  inline bool TryAddLoader(::UnityEngine::XR::Management::XRLoader* loader, int32_t index);

  /// @brief Method TryRemoveLoader, addr 0x688cafc, size 0xa8, virtual false, abstract: false, final false
  inline bool TryRemoveLoader(::UnityEngine::XR::Management::XRLoader* loader);

  /// @brief Method TrySetLoaders, addr 0x688cba4, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x688cf20, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeLoader, addr 0x688c74c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Management::XRLoader> get_activeLoader();

  /// @brief Method get_activeLoaders, addr 0x688c73c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_activeLoaders();

  /// @brief Method get_automaticLoading, addr 0x688c714, size 0x8, virtual false, abstract: false, final false
  inline bool get_automaticLoading();

  /// @brief Method get_automaticRunning, addr 0x688c724, size 0x8, virtual false, abstract: false, final false
  inline bool get_automaticRunning();

  /// @brief Method get_currentLoaders, addr 0x688cf08, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_currentLoaders();

  /// @brief Method get_isInitializationComplete, addr 0x688c744, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitializationComplete();

  /// @brief Method get_loaders, addr 0x688c734, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_loaders();

  /// @brief Method get_registeredLoaders, addr 0x688cf18, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::XR::Management::XRLoader>>* get_registeredLoaders();

  /// @brief Method set_activeLoader, addr 0x688c754, size 0x8, virtual false, abstract: false, final false
  inline void set_activeLoader(::UnityEngine::XR::Management::XRLoader* value);

  /// @brief Method set_automaticLoading, addr 0x688c71c, size 0x8, virtual false, abstract: false, final false
  inline void set_automaticLoading(bool value);

  /// @brief Method set_automaticRunning, addr 0x688c72c, size 0x8, virtual false, abstract: false, final false
  inline void set_automaticRunning(bool value);

  /// @brief Method set_currentLoaders, addr 0x688cf10, size 0x8, virtual false, abstract: false, final false
