...
public:
  // Declarations
  /// @brief Method Initialize addr 0x2af2728 size 0x8 virtual true final false
  inline bool Initialize();

  /// @brief Method Start addr 0x2af2730 size 0x8 virtual true final false
  inline bool Start();

  /// @brief Method Stop addr 0x2af2738 size 0x8 virtual true final false
  inline bool Stop();

  /// @brief Method Deinitialize addr 0x2af2740 size 0x8 virtual true final false
  ...
  /// @brief Method GetSupportedGraphicsDeviceTypes addr 0x2af2748 size 0x70 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2af27b8 size 0x8 virtual false final false
  inline void _ctor();
