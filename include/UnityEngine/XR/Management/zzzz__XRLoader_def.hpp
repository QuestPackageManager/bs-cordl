...
public:
// Declarations
/// @brief Method Deinitialize, addr 0x681a584, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method GetSupportedGraphicsDeviceTypes, addr 0x681a58c, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method Initialize, addr 0x681a56c, size 0x8, virtual true, abstract: false, final false
inline bool Initialize() ;

static inline ::UnityEngine::XR::Management::XRLoader* New_ctor() ;

/// @brief Method Start, addr 0x681a574, size 0x8, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x681a57c, size 0x8, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x681a5fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
