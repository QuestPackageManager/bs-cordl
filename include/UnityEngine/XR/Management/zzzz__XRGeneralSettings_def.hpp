...
public:
  ...
  /// @brief Method AttemptInitializeXRSDKOnLoad, addr 0x688baf0, size 0xf4, virtual false, abstract: false, final false
  static inline void AttemptInitializeXRSDKOnLoad();

  /// @brief Method AttemptStartXRSDKOnBeforeSplashScreen, addr 0x688be8c, size 0xf4, virtual false, abstract: false, final false
  static inline void AttemptStartXRSDKOnBeforeSplashScreen();

  /// @brief Method Awake, addr 0x688b72c, size 0x168, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DeInitXRSDK, addr 0x688b980, size 0xb4, virtual false, abstract: false, final false
  inline void DeInitXRSDK();

  /// @brief Method InitXRSDK, addr 0x688bbe4, size 0x2a8, virtual false, abstract: false, final false
  inline void InitXRSDK();

  static inline ::UnityEngine::XR::Management::XRGeneralSettings* New_ctor();

  /// @brief Method OnDestroy, addr 0x688baec, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Quit, addr 0x688b894, size 0xec, virtual false, abstract: false, final false
  static inline void Quit();

  /// @brief Method Start, addr 0x688ba34, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartXRSDK, addr 0x688ba38, size 0xb4, virtual false, abstract: false, final false
  inline void StartXRSDK();

  /// @brief Method StopXRSDK, addr 0x688c26c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x688c4f4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AssignedSettings, addr 0x688b71c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::XR::Management::XRManagerSettings> get_AssignedSettings();

  /// @brief Method get_InitManagerOnStart, addr 0x688b724, size 0x8, virtual false, abstract: false, final false
  inline bool get_InitManagerOnStart();

  /// @brief Method get_Instance, addr 0x688b6c0, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::XR::Management::XRGeneralSettings> get_Instance();

  /// @brief Method get_Manager, addr 0x688b6b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Manager, addr 0x688b6b8, size 0x8, virtual false, abstract: false, final false
