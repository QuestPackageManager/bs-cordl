...
/// @brief Method AttemptInitializeXRSDKOnLoad, addr 0x6819ae4, size 0xf4, virtual false, abstract: false, final false
static inline void AttemptInitializeXRSDKOnLoad() ;

/// @brief Method AttemptStartXRSDKOnBeforeSplashScreen, addr 0x6819e80, size 0xf4, virtual false, abstract: false, final false
static inline void AttemptStartXRSDKOnBeforeSplashScreen() ;

/// @brief Method Awake, addr 0x6819720, size 0x168, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DeInitXRSDK, addr 0x6819974, size 0xb4, virtual false, abstract: false, final false
inline void DeInitXRSDK() ;

/// @brief Method InitXRSDK, addr 0x6819bd8, size 0x2a8, virtual false, abstract: false, final false
inline void InitXRSDK() ;

static inline ::UnityEngine::XR::Management::XRGeneralSettings* New_ctor() ;

/// @brief Method OnDestroy, addr 0x6819ae0, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Quit, addr 0x6819888, size 0xec, virtual false, abstract: false, final false
static inline void Quit() ;

/// @brief Method Start, addr 0x6819a28, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartXRSDK, addr 0x6819a2c, size 0xb4, virtual false, abstract: false, final false
inline void StartXRSDK() ;

/// @brief Method StopXRSDK, addr 0x681a260, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x681a4e8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AssignedSettings, addr 0x6819710, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::XR::Management::XRManagerSettings> get_AssignedSettings() ;

/// @brief Method get_InitManagerOnStart, addr 0x6819718, size 0x8, virtual false, abstract: false, final false
inline bool get_InitManagerOnStart() ;

/// @brief Method get_Instance, addr 0x68196b4, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::XR::Management::XRGeneralSettings> get_Instance() ;

/// @brief Method get_Manager, addr 0x68196a4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Manager, addr 0x68196ac, size 0x8, virtual false, abstract: false, final false
