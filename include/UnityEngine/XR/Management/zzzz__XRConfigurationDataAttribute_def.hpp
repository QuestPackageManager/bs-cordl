...
public:
  ...
  /// @brief Method .ctor, addr 0x688b6a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x688b6a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW displayName, ::StringW buildSettingsKey);

  /// @brief Method get_buildSettingsKey, addr 0x688b694, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_buildSettingsKey();

  /// @brief Method get_displayName, addr 0x688b684, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method set_buildSettingsKey, addr 0x688b69c, size 0x8, virtual false, abstract: false, final false
  inline void set_buildSettingsKey(::StringW value);

  /// @brief Method set_displayName, addr 0x688b68c, size 0x8, virtual false, abstract: false, final false
