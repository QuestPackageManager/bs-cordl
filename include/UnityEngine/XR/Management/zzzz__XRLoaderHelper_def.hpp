...
/// @brief Method Deinitialize, addr 0x681a604, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x681a660, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
