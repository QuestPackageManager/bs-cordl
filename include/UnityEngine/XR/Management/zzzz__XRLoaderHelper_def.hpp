...
public:
  ...
  /// @brief Method Deinitialize, addr 0x67b23cc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67b2428, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
