...
public:
  ...
  /// @brief Method Deinitialize, addr 0x6819f44, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6819fa0, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
