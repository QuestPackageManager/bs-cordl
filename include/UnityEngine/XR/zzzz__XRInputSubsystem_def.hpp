...
MARK_REF_T(::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller*);
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::XRInputSubsystem*, "UnityEngine.XR", "XRInputSubsystem");
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::XRInputSubsystem_BindingsMarshaller*, "UnityEngine.XR", "XRInputSubsystem/BindingsMarshaller");
...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6e3612c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeBoundaryChangedEvent, addr 0x6e36024, size 0xcc, virtual false, abstract: false, final false
  static inline void InvokeBoundaryChangedEvent(::System::IntPtr internalPtr);

  /// @brief Method InvokeTrackingOriginUpdatedEvent, addr 0x6e35f58, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryRecenter, addr 0x6e35b30, size 0x50, virtual false, abstract: false, final false
  inline bool TryRecenter();

  /// @brief Method TryRecenter_Injected, addr 0x6e35b80, size 0x3c, virtual false, abstract: false, final false
  static inline bool TryRecenter_Injected(::System::IntPtr _unity_self);

  /// @brief Method TrySetTrackingOriginMode, addr 0x6e35bbc, size 0x58, virtual false, abstract: false, final false
  inline bool TrySetTrackingOriginMode(::UnityEngine::XR::TrackingOriginModeFlags origin);

  /// @brief Method TrySetTrackingOriginMode_Injected, addr 0x6e35c14, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e360f0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_boundaryChanged, addr 0x6e35dd8, size 0xc0, virtual false, abstract: false, final false
  inline void add_boundaryChanged(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method add_trackingOriginUpdated, addr 0x6e35c58, size 0xc0, virtual false, abstract: false, final false
  inline void add_trackingOriginUpdated(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method remove_boundaryChanged, addr 0x6e35e98, size 0xc0, virtual false, abstract: false, final false
  inline void remove_boundaryChanged(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method remove_trackingOriginUpdated, addr 0x6e35d18, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::XR::XRInputSubsystem) == 0x38, "Size mismatch!");
