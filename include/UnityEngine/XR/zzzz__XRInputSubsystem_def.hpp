...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6cdd5f8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeBoundaryChangedEvent, addr 0x6cdd4f0, size 0xcc, virtual false, abstract: false, final false
  static inline void InvokeBoundaryChangedEvent(::System::IntPtr internalPtr);

  /// @brief Method InvokeTrackingOriginUpdatedEvent, addr 0x6cdd424, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryRecenter, addr 0x6cdcffc, size 0x50, virtual false, abstract: false, final false
  inline bool TryRecenter();

  /// @brief Method TryRecenter_Injected, addr 0x6cdd04c, size 0x3c, virtual false, abstract: false, final false
  static inline bool TryRecenter_Injected(::System::IntPtr _unity_self);

  /// @brief Method TrySetTrackingOriginMode, addr 0x6cdd088, size 0x58, virtual false, abstract: false, final false
  inline bool TrySetTrackingOriginMode(::UnityEngine::XR::TrackingOriginModeFlags origin);

  /// @brief Method TrySetTrackingOriginMode_Injected, addr 0x6cdd0e0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cdd5bc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_boundaryChanged, addr 0x6cdd2a4, size 0xc0, virtual false, abstract: false, final false
  inline void add_boundaryChanged(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method add_trackingOriginUpdated, addr 0x6cdd124, size 0xc0, virtual false, abstract: false, final false
  inline void add_trackingOriginUpdated(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method remove_boundaryChanged, addr 0x6cdd364, size 0xc0, virtual false, abstract: false, final false
  inline void remove_boundaryChanged(::System::Action_1<::UnityEngine::XR::XRInputSubsystem*>* value);

  /// @brief Method remove_trackingOriginUpdated, addr 0x6cdd1e4, size 0xc0, virtual false, abstract: false, final false
