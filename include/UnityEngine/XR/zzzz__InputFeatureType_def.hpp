...
DEFINE_IL2CPP_CLASS(::UnityEngine::XR::InputFeatureType, "UnityEngine.XR", "InputFeatureType");
// Dependencies
namespace UnityEngine::XR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::XR::InputFeatureType) == 0x4, "Size mismatch!");
