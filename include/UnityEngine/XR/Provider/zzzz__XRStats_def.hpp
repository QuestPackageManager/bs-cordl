...
public:
  // Declarations
  /// @brief Method TryGetStat addr 0x2d4b318 size 0x5c virtual false final false
  static inline bool TryGetStat(::UnityEngine::IntegratedSubsystem* xrSubsystem, ::StringW tag, ByRef<float_t> value);

  /// @brief Method TryGetStat_Internal addr 0x2d4b374 size 0x54 virtual false final false
