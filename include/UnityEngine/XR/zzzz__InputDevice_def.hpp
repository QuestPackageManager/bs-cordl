...
public:
  ...
  /// @brief Method Equals, addr 0x4aeb6c0, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4aeb750, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::InputDevice other);

  /// @brief Method GetHashCode, addr 0x4aeb778, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IsValidId, addr 0x4aeb3e4, size 0x20, virtual false, abstract: false, final false
  inline bool IsValidId();

  /// @brief Method SendHapticImpulse, addr 0x4aeb4d8, size 0xf8, virtual false, abstract: false, final false
  inline bool SendHapticImpulse(uint32_t channel, float_t amplitude, float_t duration);

  /// @brief Method StopHaptics, addr 0x4aeb62c, size 0x58, virtual false, abstract: false, final false
  inline void StopHaptics();

  /// @brief Method .ctor, addr 0x4aeb360, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint64_t deviceId);

  /// @brief Method get_deviceId, addr 0x4aeb370, size 0x18, virtual false, abstract: false, final false
  inline uint64_t get_deviceId();

  /// @brief Method get_isValid, addr 0x4aeb388, size 0x5c, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method get_manufacturer, addr 0x4aeb440, size 0x5c, virtual false, abstract: false, final false
