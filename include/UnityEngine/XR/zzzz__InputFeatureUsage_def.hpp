...
public:
  ...
  /// @brief Method Equals, addr 0x36321a4, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x363222c, size 0x40, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::InputFeatureUsage other);

  /// @brief Method GetHashCode, addr 0x363226c, size 0x50, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_internalType, addr 0x363219c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::InputFeatureType get_internalType();

  /// @brief Method get_name, addr 0x3632194, size 0x8, virtual false, abstract: false, final false
