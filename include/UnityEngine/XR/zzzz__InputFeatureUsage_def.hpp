...
namespace UnityEngine::XR {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15572))}
...
public:
  ...
  /// @brief Method get_name addr 0x2d49244 size 0x8 virtual false final false
  inline ::StringW get_name();

  /// @brief Method get_internalType addr 0x2d4924c size 0x8 virtual false final false
  inline ::UnityEngine::XR::InputFeatureType get_internalType();

  /// @brief Method Equals addr 0x2d49254 size 0x88 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2d492dc size 0x40 virtual true final true
  inline bool Equals(::UnityEngine::XR::InputFeatureUsage other);

  /// @brief Method GetHashCode addr 0x2d4931c size 0x50 virtual true final false
