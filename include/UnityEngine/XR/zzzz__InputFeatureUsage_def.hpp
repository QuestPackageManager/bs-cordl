...
public:
  ...
  /// @brief Method Equals, addr 0x6cdb21c, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6cdb2a4, size 0x3c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::InputFeatureUsage other);

  /// @brief Method GetHashCode, addr 0x6cdb2e0, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_internalType, addr 0x6cdb214, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::XR::InputFeatureType get_internalType();

  /// @brief Method get_name, addr 0x6cdb20c, size 0x8, virtual false, abstract: false, final false
