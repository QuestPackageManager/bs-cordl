...
public:
  ...
  /// @brief Method Equals, addr 0x6e34614, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6e346a0, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::XR::Bone other);

  /// @brief Method GetHashCode, addr 0x6e346c4, size 0x14, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_deviceId, addr 0x6e34604, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_deviceId();

  /// @brief Method get_featureIndex, addr 0x6e3460c, size 0x8, virtual false, abstract: false, final false
