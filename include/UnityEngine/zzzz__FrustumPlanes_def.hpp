...
// Ctor Parameters [CppParam { name: "left", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "right", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "bottom", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "top", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "zNear", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "zFar", ty: "float_t", modifiers: "", def_value: None }]
