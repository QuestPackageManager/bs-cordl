...
::cordl_internals::setStaticField<::UnityEngine::Pool::GenericPool_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::GenericPool_1___c<T>*>::get>(std::forward<::UnityEngine::Pool::GenericPool_1___c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::Pool::GenericPool_1___c<T>* UnityEngine::Pool::GenericPool_1___c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::Pool::GenericPool_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::GenericPool_1___c<T>*>::get>();
}
template<typename T>
...
::cordl_internals::setStaticField<::UnityEngine::Pool::ObjectPool_1<T>*, "s_Pool", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::GenericPool_1<T>*>::get>(std::forward<::UnityEngine::Pool::ObjectPool_1<T>*>(value));
}
template<typename T>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::GenericPool_1<T>*>::get(),
                        "Get",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
...
template<typename T>
inline ::UnityEngine::Pool::PooledObject_1<T> UnityEngine::Pool::GenericPool_1<T>::Get(::ByRef<T>  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::GenericPool_1<T>*>::get(),
                        "Get",
                        std::span<const Il2CppClass* const, 0>(),
