...
template <typename TCollection, typename TItem> inline void UnityEngine::Pool::__CollectionPool_2____c<TCollection, TItem>::__cctor_b__5_1(TCollection l) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Pool::__CollectionPool_2____c<TCollection, TItem>*>::get(), "<.cctor>b__5_1",
