...
DEFINE_IL2CPP_CLASS(::UnityEngine::RenderTextureReadWrite, "UnityEngine", "RenderTextureReadWrite");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::RenderTextureReadWrite) == 0x4, "Size mismatch!");
