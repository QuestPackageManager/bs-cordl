...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Analytics::SubsystemsAnalyticStart::*)()>(&::UnityEngine::Analytics::SubsystemsAnalyticStart::_ctor)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x6c595bc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::SubsystemsAnalyticStart*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Analytics::SubsystemsAnalyticStart* (*)()>(&::UnityEngine::Analytics::SubsystemsAnalyticStart::CreateSubsystemsAnalyticStart)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6c59650;
