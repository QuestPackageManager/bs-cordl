...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VRDeviceAnalyticBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VRDeviceAnalyticBase(VRDeviceAnalyticBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VRDeviceAnalyticBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VRDeviceAnalyticBase(VRDeviceAnalyticBaseconst&) = delete;
