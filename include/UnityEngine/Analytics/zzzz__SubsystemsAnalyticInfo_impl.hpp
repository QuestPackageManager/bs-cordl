...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Analytics::SubsystemsAnalyticInfo::*)()>(
    &::UnityEngine::Analytics::SubsystemsAnalyticInfo::_ctor)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x6c590cc;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::SubsystemsAnalyticInfo*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Analytics::SubsystemsAnalyticInfo* (*)()>(
    &::UnityEngine::Analytics::SubsystemsAnalyticInfo::CreateSubsystemsAnalyticInfo)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6c59160;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::SubsystemsAnalyticInfo*>::get(),
                                                                               "CreateSubsystemsAnalyticInfo", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
constexpr void UnityEngine::Analytics::SubsystemsAnalyticInfo::__cordl_internal_set_plugin_name(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___plugin_name)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr void UnityEngine::Analytics::SubsystemsAnalyticInfo::__cordl_internal_set_library_name(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___library_name)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
inline void UnityEngine::Analytics::SubsystemsAnalyticInfo::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::SubsystemsAnalyticInfo*>::get(), ".ctor",
...
inline ::UnityEngine::Analytics::SubsystemsAnalyticInfo* UnityEngine::Analytics::SubsystemsAnalyticInfo::CreateSubsystemsAnalyticInfo() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::SubsystemsAnalyticInfo*>::get(),
                                                                             "CreateSubsystemsAnalyticInfo", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::Analytics::SubsystemsAnalyticInfo*, false>(nullptr, ___internal_method);
}
inline ::UnityEngine::Analytics::SubsystemsAnalyticInfo* UnityEngine::Analytics::SubsystemsAnalyticInfo::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Analytics::SubsystemsAnalyticInfo*>());
}
// Ctor Parameters []
