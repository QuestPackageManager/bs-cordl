...
public:
  ...
  /// @brief Method .ctor, addr 0x6b045fc, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Analytics::AnalyticsEventBase) == 0x30, "Size mismatch!");
