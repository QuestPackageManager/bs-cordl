...
public:
  ...
  /// @brief Method CreateVRDeviceUserAnalytic, addr 0x6bf0458, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf04ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
