...
public:
  ...
  /// @brief Method CreateVRDeviceUserAnalytic, addr 0x6ccbbe4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbc38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
