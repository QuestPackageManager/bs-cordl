...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Analytics::VRDeviceUserAnalytic* (*)()>(&::UnityEngine::Analytics::VRDeviceUserAnalytic::CreateVRDeviceUserAnalytic)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6c5999c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Analytics::VRDeviceUserAnalytic*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Analytics::VRDeviceUserAnalytic::*)()>(&::UnityEngine::Analytics::VRDeviceUserAnalytic::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6c599f0;
