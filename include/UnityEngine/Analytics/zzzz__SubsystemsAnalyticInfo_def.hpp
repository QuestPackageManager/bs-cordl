...
public:
  ...
  /// @brief Method CreateSubsystemsAnalyticInfo, addr 0x6ccba68, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccb9d4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
