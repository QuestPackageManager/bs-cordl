...
public:
  ...
  /// @brief Method CreateBatchRenderGroupUsageAnalytic, addr 0x6b04688, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b04610, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
