...
public:
  ...
  /// @brief Method CreateVRDeviceMirrorAnalytic, addr 0x6ccbb8c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbbe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
