...
public:
  ...
  /// @brief Field kSessionStopped value: static_cast<int32_t>(0x0)
  static ::UnityEngine::Analytics::AnalyticsSessionState const kSessionStopped;

  /// @brief Field kSessionStarted value: static_cast<int32_t>(0x1)
  static ::UnityEngine::Analytics::AnalyticsSessionState const kSessionStarted;

  /// @brief Field kSessionPaused value: static_cast<int32_t>(0x2)
  static ::UnityEngine::Analytics::AnalyticsSessionState const kSessionPaused;

  /// @brief Field kSessionResumed value: static_cast<int32_t>(0x3)
