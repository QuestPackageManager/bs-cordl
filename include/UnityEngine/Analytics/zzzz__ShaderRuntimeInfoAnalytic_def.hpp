...
/// @brief Method CreateShaderRuntimeInfoAnalytic, addr 0x693d0bc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x693d028, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
