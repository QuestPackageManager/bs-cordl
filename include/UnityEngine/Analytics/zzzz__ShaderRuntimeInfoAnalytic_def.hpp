...
/// @brief Method CreateShaderRuntimeInfoAnalytic, addr 0x69b0e7c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x69b0de8, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
