...
public:
  // Declarations
  /// @brief Method CreateSubsystemsAnalyticStart, addr 0x6e212c8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21234, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
