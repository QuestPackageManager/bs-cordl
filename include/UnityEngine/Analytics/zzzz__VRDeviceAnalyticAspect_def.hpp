...
/// @brief Method CreateVRDeviceAnalyticAspect, addr 0x6c598ec, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c59940, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
