...
public:
  ...
  /// @brief Method CreateVRDeviceAnalyticAspect, addr 0x6ccbb34, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbb88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 22688 };
