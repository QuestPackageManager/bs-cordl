...
public:
  // Declarations
  /// @brief Method CreateSubsystemsAnalyticStop, addr 0x6e213b0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e2131c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
