...
/// @brief Method CreateUaaLApplicationLaunchAnalytic, addr 0x693cfd4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x693cf5c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
