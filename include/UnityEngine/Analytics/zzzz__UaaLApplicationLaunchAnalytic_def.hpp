...
public:
  ...
  /// @brief Method CreateUaaLApplicationLaunchAnalytic, addr 0x6b04754, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b046dc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
