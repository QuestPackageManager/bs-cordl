...
public:
  ...
  template <typename T> inline bool Evaluate(::by_ref<T> value, int32_t index, int32_t count);
  ...
  /// @brief Method .ctor, addr 0x6a7e948, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetUInt, addr 0x6a7e2d4, size 0x38, virtual false, abstract: false, final false
  inline uint32_t GetUInt();

  /// @brief Method RotateRight, addr 0x6a7e9fc, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t RotateRight(uint32_t v, int32_t rot);

  /// @brief Method Step, addr 0x6a7e9c4, size 0x20, virtual false, abstract: false, final false
  inline void Step();

  /// @brief Method XshRr, addr 0x6a7e9e4, size 0x18, virtual false, abstract: false, final false
  static inline uint32_t XshRr(uint64_t s);

  /// @brief Method .ctor, addr 0x6a7e914, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6a7e93c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ExpressionToTokens>b__14_0, addr 0x6a7ea5c, size 0x84, virtual false, abstract: false, final false
  inline bool _ExpressionToTokens_b__14_0(::StringW f);

  /// @brief Method .ctor, addr 0x6a7ea58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method EvaluateDouble, addr 0x6a7cb14, size 0x530, virtual false, abstract: false, final false
  static inline bool EvaluateDouble(::ArrayW<::StringW> tokens, ::by_ref<double_t> value, int32_t index, int32_t count);

  /// @brief Method EvaluateOp, addr 0x6a7d228, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpressionToTokens, addr 0x6a7db54, size 0x44c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> ExpressionToTokens(::StringW expression, ::by_ref<bool> hasVariables);

  /// @brief Method FixUnaryOperators, addr 0x6a7e168, size 0x16c, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> FixUnaryOperators(::ArrayW<::StringW> tokens);

  /// @brief Method InfixToRPN, addr 0x6a7d5ac, size 0x434, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> InfixToRPN(::ArrayW<::StringW> tokens);

  /// @brief Method IsCommand, addr 0x6a7d18c, size 0x9c, virtual false, abstract: false, final false
  static inline bool IsCommand(::StringW token);

  /// @brief Method IsDelayedFunction, addr 0x6a7d9e0, size 0x70, virtual false, abstract: false, final false
  static inline bool IsDelayedFunction(::StringW token);

  /// @brief Method IsOperator, addr 0x6a7d044, size 0xa0, virtual false, abstract: false, final false
  static inline bool IsOperator(::StringW token);

  /// @brief Method IsVariable, addr 0x6a7d560, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsVariable(::StringW token);

  /// @brief Method NeedToPop, addr 0x6a7da50, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method PreFormatExpression, addr 0x6a7dfa0, size 0x1c8, virtual false, abstract: false, final false
  static inline ::StringW PreFormatExpression(::StringW expression);

  /// @brief Method TokenToOperator, addr 0x6a7d0e4, size 0xa8, virtual false, abstract: false, final false
  ...
  template <typename T> static inline bool TryParse(::StringW expression, ::by_ref<T> result);
