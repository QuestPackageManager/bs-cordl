...
public:
  // Declarations
  /// @brief Method SetCursor addr 0x2b3d4c4 size 0x58 virtual false final false
  static inline void SetCursor(::UnityEngine::Texture2D* texture, ::UnityEngine::Vector2 hotspot, ::UnityEngine::CursorMode cursorMode);

  /// @brief Method set_visible addr 0x2b3d570 size 0x3c virtual false final false
  static inline void set_visible(bool value);

  /// @brief Method get_lockState addr 0x2b3d5ac size 0x28 virtual false final false
  static inline ::UnityEngine::CursorLockMode get_lockState();

  /// @brief Method set_lockState addr 0x2b3d5d4 size 0x3c virtual false final false
  static inline void set_lockState(::UnityEngine::CursorLockMode value);

  /// @brief Method SetCursor_Injected addr 0x2b3d51c size 0x54 virtual false final false
