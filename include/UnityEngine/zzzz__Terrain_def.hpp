...
public:
  ...
  /// @brief Method SetNeighbors, addr 0x6a60c1c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNeighbors_Injected, addr 0x6a60d44, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a60dd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeTerrains, addr 0x6a60db0, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Terrain>, ::Array<::UnityW<::UnityEngine::Terrain>>*> get_activeTerrains();

  /// @brief Method get_allowAutoConnect, addr 0x6a60aa4, size 0x80, virtual false, abstract: false, final false
  inline bool get_allowAutoConnect();

  /// @brief Method get_allowAutoConnect_Injected, addr 0x6a60b24, size 0x3c, virtual false, abstract: false, final false
  static inline bool get_allowAutoConnect_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_groupingID, addr 0x6a60b60, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_groupingID();

  /// @brief Method get_groupingID_Injected, addr 0x6a60be0, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_groupingID_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_terrainData, addr 0x6a60918, size 0x150, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TerrainData> get_terrainData();

  /// @brief Method get_terrainData_Injected, addr 0x6a60a68, size 0x3c, virtual false, abstract: false, final false
