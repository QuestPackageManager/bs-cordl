...
DEFINE_IL2CPP_CLASS(::UnityEngine::SpriteTileMode, "UnityEngine", "SpriteTileMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Field Adaptive value: I32(1)
  static ::UnityEngine::SpriteTileMode const Adaptive;

  /// @brief Field Continuous value: I32(0)
...
static_assert(sizeof(::UnityEngine::SpriteTileMode) == 0x4, "Size mismatch!");
