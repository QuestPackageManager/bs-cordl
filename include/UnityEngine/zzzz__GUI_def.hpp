...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b43924, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b438b8, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BeginGroup, addr 0x6b42980, size 0xe0, virtual false, abstract: false, final false
  static inline void BeginGroup(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, ::UnityEngine::GUIStyle* style);

  /// @brief Method BeginGroup, addr 0x6b42a60, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Box, addr 0x6b42378, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method DoLabel, addr 0x6b42004, size 0x294, virtual false, abstract: false, final false
  static inline void DoLabel(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, ::UnityEngine::GUIStyle* style);

  /// @brief Method DoSetSkin, addr 0x6b419b8, size 0xd4, virtual false, abstract: false, final false
  static inline void DoSetSkin(::UnityEngine::GUISkin* newSkin);

  /// @brief Method EndGroup, addr 0x6b42e00, size 0x70, virtual false, abstract: false, final false
  static inline void EndGroup();

  /// @brief Method Label, addr 0x6b41f40, size 0xc4, virtual false, abstract: false, final false
  static inline void Label(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, ::UnityEngine::GUIStyle* style);

  /// @brief Method Label, addr 0x6b41dc8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_backgroundColor, addr 0x6b41148, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color get_backgroundColor();

  /// @brief Method get_backgroundColor_Injected, addr 0x6b411d4, size 0x3c, virtual false, abstract: false, final false
  static inline void get_backgroundColor_Injected(::by_ref<::UnityEngine::Color> ret);

  /// @brief Method get_changed, addr 0x6b41460, size 0x28, virtual false, abstract: false, final false
  static inline bool get_changed();

  /// @brief Method get_color, addr 0x6b40fbc, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color get_color();

  /// @brief Method get_color_Injected, addr 0x6b41048, size 0x3c, virtual false, abstract: false, final false
  static inline void get_color_Injected(::by_ref<::UnityEngine::Color> ret);

  /// @brief Method get_contentColor, addr 0x6b412d4, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color get_contentColor();

  /// @brief Method get_contentColor_Injected, addr 0x6b41360, size 0x3c, virtual false, abstract: false, final false
  static inline void get_contentColor_Injected(::by_ref<::UnityEngine::Color> ret);

  /// @brief Method get_enabled, addr 0x6b414c4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_skin, addr 0x6b41a8c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method set_backgroundColor, addr 0x6b41210, size 0x88, virtual false, abstract: false, final false
  static inline void set_backgroundColor(::UnityEngine::Color value);

  /// @brief Method set_backgroundColor_Injected, addr 0x6b41298, size 0x3c, virtual false, abstract: false, final false
  static inline void set_backgroundColor_Injected(::by_ref<::UnityEngine::Color> value);

  /// @brief Method set_changed, addr 0x6b41488, size 0x3c, virtual false, abstract: false, final false
  static inline void set_changed(bool value);

  /// @brief Method set_color, addr 0x6b41084, size 0x88, virtual false, abstract: false, final false
  static inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_color_Injected, addr 0x6b4110c, size 0x3c, virtual false, abstract: false, final false
  static inline void set_color_Injected(::by_ref<::UnityEngine::Color> value);

  /// @brief Method set_contentColor, addr 0x6b4139c, size 0x88, virtual false, abstract: false, final false
  static inline void set_contentColor(::UnityEngine::Color value);

  /// @brief Method set_contentColor_Injected, addr 0x6b41424, size 0x3c, virtual false, abstract: false, final false
  static inline void set_contentColor_Injected(::by_ref<::UnityEngine::Color> value);

  /// @brief Method set_enabled, addr 0x6b414ec, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_skin, addr 0x6b41874, size 0x84, virtual false, abstract: false, final false
