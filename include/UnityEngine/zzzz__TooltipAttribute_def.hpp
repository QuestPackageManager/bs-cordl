...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad8014, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TooltipAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TooltipAttribute(TooltipAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TooltipAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TooltipAttribute(TooltipAttributeconst&) = delete;
