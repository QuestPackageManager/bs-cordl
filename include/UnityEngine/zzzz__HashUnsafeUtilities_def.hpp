...
public:
  // Declarations
  /// @brief Method ComputeHash128, addr 0x489e248, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeHash128, addr 0x489dec4, size 0x7c, virtual false, abstract: false, final false
