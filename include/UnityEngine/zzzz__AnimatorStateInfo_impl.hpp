...
// Ctor Parameters [CppParam { name: "m_Name", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Path", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "m_FullPath", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_NormalizedTime", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "m_Length", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Speed", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "m_SpeedMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Tag", ty: "int32_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "m_Loop", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
