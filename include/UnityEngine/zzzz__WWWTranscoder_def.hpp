...
public:
  ...
  /// @brief Method ByteSubArrayEquals, addr 0x6e280e0, size 0x90, virtual false, abstract: false, final false
  static inline bool ByteSubArrayEquals(::ArrayW<uint8_t> array, int32_t index, ::ArrayW<uint8_t> comperand);

  /// @brief Method Decode, addr 0x6e27e04, size 0x2dc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> Decode(::ArrayW<uint8_t> input, uint8_t escapeChar, ::ArrayW<uint8_t> space);

  /// @brief Method Hex2Byte, addr 0x6e27d48, size 0xbc, virtual false, abstract: false, final false
  static inline uint8_t Hex2Byte(::ArrayW<uint8_t> b, int32_t offset);

  /// @brief Method URLDecode, addr 0x6e279e0, size 0x68, virtual false, abstract: false, final false
