...
public:
  // Declarations
  /// @brief Method OnCreateClip, addr 0x2c6b0c0, size 0x94, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  static inline ::UnityEngine::Timeline::PlayableTrack* New_ctor();

  /// @brief Method .ctor, addr 0x2c6b154, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
