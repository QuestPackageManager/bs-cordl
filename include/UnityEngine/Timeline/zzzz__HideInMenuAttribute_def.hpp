...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HideInMenuAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HideInMenuAttribute(HideInMenuAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HideInMenuAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HideInMenuAttribute(HideInMenuAttributeconst&) = delete;
