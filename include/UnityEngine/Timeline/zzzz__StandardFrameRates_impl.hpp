...
constexpr ::UnityEngine::Timeline::StandardFrameRates::StandardFrameRates(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::Timeline::StandardFrameRates::StandardFrameRates() {}
