...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10353)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2ade120 size 0x34 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x2ade2f8 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x2ade2fc size 0x90 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current addr 0x2ade38c size 0x10 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2ade39c size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2ade3dc size 0x60 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator addr 0x2ade43c size 0xa4 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2ade4e0 size 0x4 virtual true final true
...
public:
  ...
  /// @brief Method get_bufferingTime addr 0x2addfc0 size 0x8 virtual false final false
  inline float_t get_bufferingTime();

  /// @brief Method set_bufferingTime addr 0x2addfc8 size 0x8 virtual false final false
  inline void set_bufferingTime(float_t value);

  /// @brief Method get_clip addr 0x2addfd0 size 0x8 virtual false final false
  inline ::UnityEngine::AudioClip* get_clip();

  /// @brief Method set_clip addr 0x2addfd8 size 0x8 virtual false final false
  inline void set_clip(::UnityEngine::AudioClip* value);

  /// @brief Method get_loop addr 0x2addfe0 size 0x8 virtual false final false
  inline bool get_loop();

  /// @brief Method set_loop addr 0x2addfe8 size 0xc virtual false final false
  inline void set_loop(bool value);

  /// @brief Method get_duration addr 0x2addff4 size 0xb4 virtual true final false
  inline double_t get_duration();

  /// @brief Method get_outputs addr 0x2ade0a8 size 0x78 virtual true final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method CreatePlayable addr 0x2ade154 size 0x11c virtual true final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method get_clipCaps addr 0x2ade270 size 0xc virtual true final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  static inline ::UnityEngine::Timeline::AudioPlayableAsset* New_ctor();

  /// @brief Method .ctor addr 0x2ade27c size 0x7c virtual false final false
  inline void _ctor();
