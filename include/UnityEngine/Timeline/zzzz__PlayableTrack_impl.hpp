...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::PlayableTrack::*)(::UnityEngine::Timeline::TimelineClip*)>(&::UnityEngine::Timeline::PlayableTrack::OnCreateClip)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x6813470;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::PlayableTrack::*)()>(&::UnityEngine::Timeline::PlayableTrack::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x681350c;
