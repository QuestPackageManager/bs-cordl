...
public:
  ...
  /// @brief Method Create, addr 0x687fdfc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableAt, addr 0x6880248, size 0x10, virtual true, abstract: false, final false
  inline void DisableAt(double_t localTime, double_t rootDuration, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAt, addr 0x687ffb8, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method SetTime, addr 0x687fd80, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x687a5c8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clip, addr 0x687fddc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* get_clip();

  /// @brief Method get_duration, addr 0x687fd34, size 0x4c, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_mixer, addr 0x687fde4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_mixer();

  /// @brief Method get_playable, addr 0x687fdf0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_playable();

  /// @brief Method get_start, addr 0x687fcb4, size 0x80, virtual true, abstract: false, final false
  inline double_t get_start();

  /// @brief Method set_enable, addr 0x687fe98, size 0x120, virtual true, abstract: false, final false
