...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::ScheduleRuntimeClip*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::ScheduleRuntimeClip*, "UnityEngine.Timeline", "ScheduleRuntimeClip");
...
public:
  ...
  /// @brief Method Create, addr 0x69c0458, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableAt, addr 0x69c08a4, size 0x10, virtual true, abstract: false, final false
  inline void DisableAt(double_t localTime, double_t rootDuration, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAt, addr 0x69c0614, size 0x290, virtual true, abstract: false, final false
  ...
  /// @brief Method SetTime, addr 0x69c03dc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69bac24, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clip, addr 0x69c0438, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* get_clip();

  /// @brief Method get_duration, addr 0x69c0390, size 0x4c, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_mixer, addr 0x69c0440, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_mixer();

  /// @brief Method get_playable, addr 0x69c044c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_playable();

  /// @brief Method get_start, addr 0x69c0310, size 0x80, virtual true, abstract: false, final false
  inline double_t get_start();

  /// @brief Method set_enable, addr 0x69c04f4, size 0x120, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::Timeline::ScheduleRuntimeClip) == 0x58, "Size mismatch!");
