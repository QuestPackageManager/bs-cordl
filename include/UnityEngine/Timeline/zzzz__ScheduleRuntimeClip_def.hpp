...
public:
  ...
  __declspec(property(get = __get_m_StartDelay, put = __set_m_StartDelay)) double_t m_StartDelay;

  /// @brief Field m_FinishTail, offset 0x48, size 0x8
  __declspec(property(get = __get_m_FinishTail, put = __set_m_FinishTail)) double_t m_FinishTail;
  ...
  constexpr double_t& __get_m_StartDelay();

  constexpr double_t const& __get_m_StartDelay() const;

  constexpr void __set_m_StartDelay(double_t value);

  constexpr double_t& __get_m_FinishTail();

  constexpr double_t const& __get_m_FinishTail() const;
  ...
  /// @brief Method get_start, addr 0x2c680b4, size 0x78, virtual true, abstract: false, final false
  inline double_t get_start();

  /// @brief Method get_duration, addr 0x2c6812c, size 0x4c, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method SetTime, addr 0x2c68178, size 0x58, virtual false, abstract: false, final false
  inline void SetTime(double_t time);

  /// @brief Method get_clip, addr 0x2c681d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* get_clip();

  /// @brief Method get_mixer, addr 0x2c681d8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_mixer();

  /// @brief Method get_playable, addr 0x2c681e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enable, addr 0x2c68288, size 0x104, virtual true, abstract: false, final false
  inline void set_enable(bool value);

  /// @brief Method EvaluateAt, addr 0x2c6838c, size 0x268, virtual true, abstract: false, final false
  inline void EvaluateAt(double_t localTime, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method DisableAt, addr 0x2c685f4, size 0x10, virtual true, abstract: false, final false
