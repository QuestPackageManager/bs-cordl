...
public:
  // Declarations
  /// @brief Method UpgradeClipInFromGlobalToLocal, addr 0x4812af4, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculateEasingRatio, addr 0x48148ec, size 0xc4, virtual false, abstract: false, final false
  static inline double_t CalculateEasingRatio(double_t easeIn, double_t easeOut);

  /// @brief Method ConformEaseValues, addr 0x481485c, size 0x90, virtual false, abstract: false, final false
  inline void ConformEaseValues();

  /// @brief Method CreateCurves, addr 0x481456c, size 0xcc, virtual true, abstract: false, final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method EvaluateMixIn, addr 0x4813ee0, size 0xd4, virtual false, abstract: false, final false
  inline float_t EvaluateMixIn(double_t time);

  /// @brief Method EvaluateMixOut, addr 0x4813dec, size 0xf4, virtual false, abstract: false, final false
  inline float_t EvaluateMixOut(double_t time);

  /// @brief Method FromLocalTimeUnbound, addr 0x48142b8, size 0x44, virtual false, abstract: false, final false
  inline double_t FromLocalTimeUnbound(double_t time);

  /// @brief Method GetDefaultMixInCurve, addr 0x4813ac4, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixInCurve();

  /// @brief Method GetDefaultMixOutCurve, addr 0x4813bd4, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixOutCurve();

  /// @brief Method GetExtrapolatedTime, addr 0x48140f4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentTrack, addr 0x4813378, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetParentTrack();

  /// @brief Method Hash, addr 0x4813d10, size 0xdc, virtual false, abstract: false, final false
  inline int32_t Hash();

  /// @brief Method IsExtrapolatedTime, addr 0x481444c, size 0x3c, virtual false, abstract: false, final false
  inline bool IsExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPostExtrapolatedTime, addr 0x4814210, size 0x58, virtual false, abstract: false, final false
  inline bool IsPostExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPreExtrapolatedTime, addr 0x48140a4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SanitizeTimeValue, addr 0x4812f48, size 0x11c, virtual false, abstract: false, final false
  static inline double_t SanitizeTimeValue(double_t value, double_t defaultValue);

  /// @brief Method SetParentTrack_Internal, addr 0x4812b6c, size 0xf4, virtual false, abstract: false, final false
  inline void SetParentTrack_Internal(::UnityEngine::Timeline::TrackAsset* newParentTrack);

  /// @brief Method SetPostExtrapolationTime, addr 0x481443c, size 0x8, virtual false, abstract: false, final false
  inline void SetPostExtrapolationTime(double_t time);

  /// @brief Method SetPreExtrapolationTime, addr 0x4814444, size 0x8, virtual false, abstract: false, final false
  inline void SetPreExtrapolationTime(double_t time);

  /// @brief Method ToLocalTime, addr 0x4813fb4, size 0xf0, virtual false, abstract: false, final false
  inline double_t ToLocalTime(double_t time);

  /// @brief Method ToLocalTimeUnbound, addr 0x4814268, size 0x50, virtual false, abstract: false, final false
  inline double_t ToLocalTimeUnbound(double_t time);

  /// @brief Method ToString, addr 0x4814680, size 0x1dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x4814644, size 0x3c, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x4814638, size 0xc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_assetOwner, addr 0x4813350, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_assetOwner();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName, addr 0x481325c, size 0x58, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_targetTrack, addr 0x4813358, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> UnityEngine_Timeline_ICurvesOwner_get_targetTrack();

  /// @brief Method UpdateDirty, addr 0x4812f3c, size 0x4, virtual false, abstract: false, final false
  inline void UpdateDirty(double_t oldValue, double_t newValue);

  /// @brief Method UpgradeToLatestVersion, addr 0x4812ab8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4812b30, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_animationClip, addr 0x48142fc, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AnimationClip> get_animationClip();

  /// @brief Method get_asset, addr 0x4813340, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> get_asset();

  /// @brief Method get_blendInCurveMode, addr 0x4813a18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_BlendCurveMode get_blendInCurveMode();

  /// @brief Method get_blendInDuration, addr 0x48138c8, size 0x20, virtual false, abstract: false, final false
  inline double_t get_blendInDuration();

  /// @brief Method get_blendOutCurveMode, addr 0x4813a28, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_BlendCurveMode get_blendOutCurveMode();

  /// @brief Method get_blendOutDuration, addr 0x4813970, size 0x20, virtual false, abstract: false, final false
  inline double_t get_blendOutDuration();

  /// @brief Method get_clipAssetDuration, addr 0x481318c, size 0xc0, virtual false, abstract: false, final false
  inline double_t get_clipAssetDuration();

  /// @brief Method get_clipCaps, addr 0x4812d78, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method get_clipIn, addr 0x4813084, size 0x20, virtual false, abstract: false, final false
  inline double_t get_clipIn();

  /// @brief Method get_curves, addr 0x481324c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AnimationClip> get_curves();

  /// @brief Method get_displayName, addr 0x481317c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_duration, addr 0x481306c, size 0x8, virtual true, abstract: false, final true
  inline double_t get_duration();

  /// @brief Method get_easeInDuration, addr 0x48134b0, size 0xbc, virtual false, abstract: false, final false
  inline double_t get_easeInDuration();

  /// @brief Method get_easeOutDuration, addr 0x4813690, size 0xbc, virtual false, abstract: false, final false
  inline double_t get_easeOutDuration();

  /// @brief Method get_easeOutTime, addr 0x481389c, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_easeOutTime();

  /// @brief Method get_eastOutTime, addr 0x4813870, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_eastOutTime();

  /// @brief Method get_end, addr 0x4813074, size 0x10, virtual false, abstract: false, final false
  inline double_t get_end();

  /// @brief Method get_exposedParameters, addr 0x4813c98, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_exposedParameters();

  /// @brief Method get_extrapolatedDuration, addr 0x48144a0, size 0xcc, virtual false, abstract: false, final false
  inline double_t get_extrapolatedDuration();

  /// @brief Method get_extrapolatedStart, addr 0x4814488, size 0x18, virtual false, abstract: false, final false
  inline double_t get_extrapolatedStart();

  /// @brief Method get_hasBlendIn, addr 0x481374c, size 0x2c, virtual false, abstract: false, final false
  inline bool get_hasBlendIn();

  /// @brief Method get_hasBlendOut, addr 0x481356c, size 0x2c, virtual false, abstract: false, final false
  inline bool get_hasBlendOut();

  /// @brief Method get_hasCurves, addr 0x48132b4, size 0x8c, virtual true, abstract: false, final true
  inline bool get_hasCurves();

  /// @brief Method get_hasPostExtrapolation, addr 0x4812c80, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasPostExtrapolation();

  /// @brief Method get_hasPreExtrapolation, addr 0x4812c60, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasPreExtrapolation();

  /// @brief Method get_mixInCurve, addr 0x4813a38, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* get_mixInCurve();

  /// @brief Method get_mixInDuration, addr 0x4813b04, size 0x44, virtual false, abstract: false, final false
  inline double_t get_mixInDuration();

  /// @brief Method get_mixInPercentage, addr 0x4813ae4, size 0x20, virtual false, abstract: false, final false
  inline float_t get_mixInPercentage();

  /// @brief Method get_mixOutCurve, addr 0x4813b48, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* get_mixOutCurve();

  /// @brief Method get_mixOutDuration, addr 0x4813c20, size 0x44, virtual false, abstract: false, final false
  inline double_t get_mixOutDuration();

  /// @brief Method get_mixOutPercentage, addr 0x4813c64, size 0x20, virtual false, abstract: false, final false
  inline float_t get_mixOutPercentage();

  /// @brief Method get_mixOutTime, addr 0x4813bf4, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_mixOutTime();

  /// @brief Method get_parentTrack, addr 0x481336c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> get_parentTrack();

  /// @brief Method get_postExtrapolationMode, addr 0x48143f4, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_postExtrapolationMode();

  /// @brief Method get_preExtrapolationMode, addr 0x4814418, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_preExtrapolationMode();

  /// @brief Method get_recordable, addr 0x4813c84, size 0x8, virtual false, abstract: false, final false
  inline bool get_recordable();

  /// @brief Method get_start, addr 0x4812f40, size 0x8, virtual false, abstract: false, final false
  inline double_t get_start();

  /// @brief Method get_timeScale, addr 0x4812ca0, size 0xd8, virtual false, abstract: false, final false
  inline double_t get_timeScale();

  /// @brief Method get_underlyingAsset, addr 0x4813360, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_asset, addr 0x4813348, size 0x8, virtual false, abstract: false, final false
  inline void set_asset(::UnityEngine::Object* value);

  /// @brief Method set_blendInCurveMode, addr 0x4813a20, size 0x8, virtual false, abstract: false, final false
  inline void set_blendInCurveMode(::UnityEngine::Timeline::TimelineClip_BlendCurveMode value);

  /// @brief Method set_blendInDuration, addr 0x48138e8, size 0x88, virtual false, abstract: false, final false
  inline void set_blendInDuration(double_t value);

  /// @brief Method set_blendOutCurveMode, addr 0x4813a30, size 0x8, virtual false, abstract: false, final false
  inline void set_blendOutCurveMode(::UnityEngine::Timeline::TimelineClip_BlendCurveMode value);

  /// @brief Method set_blendOutDuration, addr 0x4813990, size 0x88, virtual false, abstract: false, final false
  inline void set_blendOutDuration(double_t value);

  /// @brief Method set_clipIn, addr 0x48130a4, size 0xd8, virtual false, abstract: false, final false
  inline void set_clipIn(double_t value);

  /// @brief Method set_curves, addr 0x4813254, size 0x8, virtual false, abstract: false, final false
  inline void set_curves(::UnityEngine::AnimationClip* value);

  /// @brief Method set_displayName, addr 0x4813184, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_duration, addr 0x480f15c, size 0xac, virtual false, abstract: false, final false
  inline void set_duration(double_t value);

  /// @brief Method set_easeInDuration, addr 0x4813598, size 0xf8, virtual false, abstract: false, final false
  inline void set_easeInDuration(double_t value);

  /// @brief Method set_easeOutDuration, addr 0x4813778, size 0xf8, virtual false, abstract: false, final false
  inline void set_easeOutDuration(double_t value);

  /// @brief Method set_mixInCurve, addr 0x4813adc, size 0x8, virtual false, abstract: false, final false
  inline void set_mixInCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method set_mixOutCurve, addr 0x4813bec, size 0x8, virtual false, abstract: false, final false
  inline void set_mixOutCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method set_parentTrack, addr 0x4813374, size 0x4, virtual false, abstract: false, final false
  inline void set_parentTrack(::UnityEngine::Timeline::TrackAsset* value);

  /// @brief Method set_postExtrapolationMode, addr 0x480f39c, size 0x34, virtual false, abstract: false, final false
  inline void set_postExtrapolationMode(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_preExtrapolationMode, addr 0x480f368, size 0x34, virtual false, abstract: false, final false
  inline void set_preExtrapolationMode(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_recordable, addr 0x4813c8c, size 0xc, virtual false, abstract: false, final false
  inline void set_recordable(bool value);

  /// @brief Method set_start, addr 0x480f058, size 0x104, virtual false, abstract: false, final false
  inline void set_start(double_t value);

  /// @brief Method set_timeScale, addr 0x4812e68, size 0xd4, virtual false, abstract: false, final false
  inline void set_timeScale(double_t value);

  /// @brief Method set_underlyingAsset, addr 0x4813368, size 0x4, virtual false, abstract: false, final false
