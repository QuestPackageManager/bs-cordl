...
public:
  // Declarations
  /// @brief Method UpgradeClipInFromGlobalToLocal, addr 0x4814390, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculateEasingRatio, addr 0x4816188, size 0xc4, virtual false, abstract: false, final false
  static inline double_t CalculateEasingRatio(double_t easeIn, double_t easeOut);

  /// @brief Method ConformEaseValues, addr 0x48160f8, size 0x90, virtual false, abstract: false, final false
  inline void ConformEaseValues();

  /// @brief Method CreateCurves, addr 0x4815e08, size 0xcc, virtual true, abstract: false, final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method EvaluateMixIn, addr 0x481577c, size 0xd4, virtual false, abstract: false, final false
  inline float_t EvaluateMixIn(double_t time);

  /// @brief Method EvaluateMixOut, addr 0x4815688, size 0xf4, virtual false, abstract: false, final false
  inline float_t EvaluateMixOut(double_t time);

  /// @brief Method FromLocalTimeUnbound, addr 0x4815b54, size 0x44, virtual false, abstract: false, final false
  inline double_t FromLocalTimeUnbound(double_t time);

  /// @brief Method GetDefaultMixInCurve, addr 0x4815360, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixInCurve();

  /// @brief Method GetDefaultMixOutCurve, addr 0x4815470, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixOutCurve();

  /// @brief Method GetExtrapolatedTime, addr 0x4815990, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentTrack, addr 0x4814c14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetParentTrack();

  /// @brief Method Hash, addr 0x48155ac, size 0xdc, virtual false, abstract: false, final false
  inline int32_t Hash();

  /// @brief Method IsExtrapolatedTime, addr 0x4815ce8, size 0x3c, virtual false, abstract: false, final false
  inline bool IsExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPostExtrapolatedTime, addr 0x4815aac, size 0x58, virtual false, abstract: false, final false
  inline bool IsPostExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPreExtrapolatedTime, addr 0x4815940, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SanitizeTimeValue, addr 0x48147e4, size 0x11c, virtual false, abstract: false, final false
  static inline double_t SanitizeTimeValue(double_t value, double_t defaultValue);

  /// @brief Method SetParentTrack_Internal, addr 0x4814408, size 0xf4, virtual false, abstract: false, final false
  inline void SetParentTrack_Internal(::UnityEngine::Timeline::TrackAsset* newParentTrack);

  /// @brief Method SetPostExtrapolationTime, addr 0x4815cd8, size 0x8, virtual false, abstract: false, final false
  inline void SetPostExtrapolationTime(double_t time);

  /// @brief Method SetPreExtrapolationTime, addr 0x4815ce0, size 0x8, virtual false, abstract: false, final false
  inline void SetPreExtrapolationTime(double_t time);

  /// @brief Method ToLocalTime, addr 0x4815850, size 0xf0, virtual false, abstract: false, final false
  inline double_t ToLocalTime(double_t time);

  /// @brief Method ToLocalTimeUnbound, addr 0x4815b04, size 0x50, virtual false, abstract: false, final false
  inline double_t ToLocalTimeUnbound(double_t time);

  /// @brief Method ToString, addr 0x4815f1c, size 0x1dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x4815ee0, size 0x3c, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x4815ed4, size 0xc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_assetOwner, addr 0x4814bec, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_assetOwner();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName, addr 0x4814af8, size 0x58, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_targetTrack, addr 0x4814bf4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> UnityEngine_Timeline_ICurvesOwner_get_targetTrack();

  /// @brief Method UpdateDirty, addr 0x48147d8, size 0x4, virtual false, abstract: false, final false
  inline void UpdateDirty(double_t oldValue, double_t newValue);

  /// @brief Method UpgradeToLatestVersion, addr 0x4814354, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48143cc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_animationClip, addr 0x4815b98, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AnimationClip> get_animationClip();

  /// @brief Method get_asset, addr 0x4814bdc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> get_asset();

  /// @brief Method get_blendInCurveMode, addr 0x48152b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_BlendCurveMode get_blendInCurveMode();

  /// @brief Method get_blendInDuration, addr 0x4815164, size 0x20, virtual false, abstract: false, final false
  inline double_t get_blendInDuration();

  /// @brief Method get_blendOutCurveMode, addr 0x48152c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_BlendCurveMode get_blendOutCurveMode();

  /// @brief Method get_blendOutDuration, addr 0x481520c, size 0x20, virtual false, abstract: false, final false
  inline double_t get_blendOutDuration();

  /// @brief Method get_clipAssetDuration, addr 0x4814a28, size 0xc0, virtual false, abstract: false, final false
  inline double_t get_clipAssetDuration();

  /// @brief Method get_clipCaps, addr 0x4814614, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method get_clipIn, addr 0x4814920, size 0x20, virtual false, abstract: false, final false
  inline double_t get_clipIn();

  /// @brief Method get_curves, addr 0x4814ae8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AnimationClip> get_curves();

  /// @brief Method get_displayName, addr 0x4814a18, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_displayName();

  /// @brief Method get_duration, addr 0x4814908, size 0x8, virtual true, abstract: false, final true
  inline double_t get_duration();

  /// @brief Method get_easeInDuration, addr 0x4814d4c, size 0xbc, virtual false, abstract: false, final false
  inline double_t get_easeInDuration();

  /// @brief Method get_easeOutDuration, addr 0x4814f2c, size 0xbc, virtual false, abstract: false, final false
  inline double_t get_easeOutDuration();

  /// @brief Method get_easeOutTime, addr 0x4815138, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_easeOutTime();

  /// @brief Method get_eastOutTime, addr 0x481510c, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_eastOutTime();

  /// @brief Method get_end, addr 0x4814910, size 0x10, virtual false, abstract: false, final false
  inline double_t get_end();

  /// @brief Method get_exposedParameters, addr 0x4815534, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_exposedParameters();

  /// @brief Method get_extrapolatedDuration, addr 0x4815d3c, size 0xcc, virtual false, abstract: false, final false
  inline double_t get_extrapolatedDuration();

  /// @brief Method get_extrapolatedStart, addr 0x4815d24, size 0x18, virtual false, abstract: false, final false
  inline double_t get_extrapolatedStart();

  /// @brief Method get_hasBlendIn, addr 0x4814fe8, size 0x2c, virtual false, abstract: false, final false
  inline bool get_hasBlendIn();

  /// @brief Method get_hasBlendOut, addr 0x4814e08, size 0x2c, virtual false, abstract: false, final false
  inline bool get_hasBlendOut();

  /// @brief Method get_hasCurves, addr 0x4814b50, size 0x8c, virtual true, abstract: false, final true
  inline bool get_hasCurves();

  /// @brief Method get_hasPostExtrapolation, addr 0x481451c, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasPostExtrapolation();

  /// @brief Method get_hasPreExtrapolation, addr 0x48144fc, size 0x20, virtual false, abstract: false, final false
  inline bool get_hasPreExtrapolation();

  /// @brief Method get_mixInCurve, addr 0x48152d4, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* get_mixInCurve();

  /// @brief Method get_mixInDuration, addr 0x48153a0, size 0x44, virtual false, abstract: false, final false
  inline double_t get_mixInDuration();

  /// @brief Method get_mixInPercentage, addr 0x4815380, size 0x20, virtual false, abstract: false, final false
  inline float_t get_mixInPercentage();

  /// @brief Method get_mixOutCurve, addr 0x48153e4, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::AnimationCurve* get_mixOutCurve();

  /// @brief Method get_mixOutDuration, addr 0x48154bc, size 0x44, virtual false, abstract: false, final false
  inline double_t get_mixOutDuration();

  /// @brief Method get_mixOutPercentage, addr 0x4815500, size 0x20, virtual false, abstract: false, final false
  inline float_t get_mixOutPercentage();

  /// @brief Method get_mixOutTime, addr 0x4815490, size 0x2c, virtual false, abstract: false, final false
  inline double_t get_mixOutTime();

  /// @brief Method get_parentTrack, addr 0x4814c08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> get_parentTrack();

  /// @brief Method get_postExtrapolationMode, addr 0x4815c90, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_postExtrapolationMode();

  /// @brief Method get_preExtrapolationMode, addr 0x4815cb4, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip_ClipExtrapolation get_preExtrapolationMode();

  /// @brief Method get_recordable, addr 0x4815520, size 0x8, virtual false, abstract: false, final false
  inline bool get_recordable();

  /// @brief Method get_start, addr 0x48147dc, size 0x8, virtual false, abstract: false, final false
  inline double_t get_start();

  /// @brief Method get_timeScale, addr 0x481453c, size 0xd8, virtual false, abstract: false, final false
  inline double_t get_timeScale();

  /// @brief Method get_underlyingAsset, addr 0x4814bfc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_asset, addr 0x4814be4, size 0x8, virtual false, abstract: false, final false
  inline void set_asset(::UnityEngine::Object* value);

  /// @brief Method set_blendInCurveMode, addr 0x48152bc, size 0x8, virtual false, abstract: false, final false
  inline void set_blendInCurveMode(::UnityEngine::Timeline::TimelineClip_BlendCurveMode value);

  /// @brief Method set_blendInDuration, addr 0x4815184, size 0x88, virtual false, abstract: false, final false
  inline void set_blendInDuration(double_t value);

  /// @brief Method set_blendOutCurveMode, addr 0x48152cc, size 0x8, virtual false, abstract: false, final false
  inline void set_blendOutCurveMode(::UnityEngine::Timeline::TimelineClip_BlendCurveMode value);

  /// @brief Method set_blendOutDuration, addr 0x481522c, size 0x88, virtual false, abstract: false, final false
  inline void set_blendOutDuration(double_t value);

  /// @brief Method set_clipIn, addr 0x4814940, size 0xd8, virtual false, abstract: false, final false
  inline void set_clipIn(double_t value);

  /// @brief Method set_curves, addr 0x4814af0, size 0x8, virtual false, abstract: false, final false
  inline void set_curves(::UnityEngine::AnimationClip* value);

  /// @brief Method set_displayName, addr 0x4814a20, size 0x8, virtual false, abstract: false, final false
  inline void set_displayName(::StringW value);

  /// @brief Method set_duration, addr 0x48109f8, size 0xac, virtual false, abstract: false, final false
  inline void set_duration(double_t value);

  /// @brief Method set_easeInDuration, addr 0x4814e34, size 0xf8, virtual false, abstract: false, final false
  inline void set_easeInDuration(double_t value);

  /// @brief Method set_easeOutDuration, addr 0x4815014, size 0xf8, virtual false, abstract: false, final false
  inline void set_easeOutDuration(double_t value);

  /// @brief Method set_mixInCurve, addr 0x4815378, size 0x8, virtual false, abstract: false, final false
  inline void set_mixInCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method set_mixOutCurve, addr 0x4815488, size 0x8, virtual false, abstract: false, final false
  inline void set_mixOutCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method set_parentTrack, addr 0x4814c10, size 0x4, virtual false, abstract: false, final false
  inline void set_parentTrack(::UnityEngine::Timeline::TrackAsset* value);

  /// @brief Method set_postExtrapolationMode, addr 0x4810c38, size 0x34, virtual false, abstract: false, final false
  inline void set_postExtrapolationMode(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_preExtrapolationMode, addr 0x4810c04, size 0x34, virtual false, abstract: false, final false
  inline void set_preExtrapolationMode(::UnityEngine::Timeline::TimelineClip_ClipExtrapolation value);

  /// @brief Method set_recordable, addr 0x4815528, size 0xc, virtual false, abstract: false, final false
  inline void set_recordable(bool value);

  /// @brief Method set_start, addr 0x48108f4, size 0x104, virtual false, abstract: false, final false
  inline void set_start(double_t value);

  /// @brief Method set_timeScale, addr 0x4814704, size 0xd4, virtual false, abstract: false, final false
  inline void set_timeScale(double_t value);

  /// @brief Method set_underlyingAsset, addr 0x4814c04, size 0x4, virtual false, abstract: false, final false
