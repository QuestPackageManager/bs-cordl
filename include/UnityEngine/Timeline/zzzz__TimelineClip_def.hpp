...
public:
  // Declarations
  /// @brief Method UpgradeClipInFromGlobalToLocal addr 0x2ad1574 size 0x3c virtual false final false
...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14119)), TypeDefinitionIndex(TypeDefinitionIndex(14142)), TypeDefinitionIndex(TypeDefinitionIndex(2611)),
// TypeDefinitionIndex(TypeDefinitionIndex(14118))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14120)) CS Name: ::UnityEngine.Timeline::TimelineClip*
...
public:
  ...
  /// @brief Method UpgradeToLatestVersion addr 0x2ad153c size 0x38 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ad15b0 size 0x3c virtual false final false
  inline void _ctor(::UnityEngine::Timeline::TrackAsset* parent);

  /// @brief Method get_hasPreExtrapolation addr 0x2ad16e0 size 0x20 virtual false final false
  inline bool get_hasPreExtrapolation();

  /// @brief Method get_hasPostExtrapolation addr 0x2ad1700 size 0x20 virtual false final false
  inline bool get_hasPostExtrapolation();

  /// @brief Method get_timeScale addr 0x2ad1720 size 0xd8 virtual false final false
  inline double_t get_timeScale();

  /// @brief Method set_timeScale addr 0x2ad18e8 size 0xdc virtual false final false
  inline void set_timeScale(double_t value);

  /// @brief Method get_start addr 0x2ad19c8 size 0x8 virtual false final false
  inline double_t get_start();

  /// @brief Method set_start addr 0x2acda9c size 0x104 virtual false final false
  inline void set_start(double_t value);

  /// @brief Method get_duration addr 0x2ad1b70 size 0x8 virtual true final true
  inline double_t get_duration();

  /// @brief Method set_duration addr 0x2acdba0 size 0xac virtual false final false
  inline void set_duration(double_t value);

  /// @brief Method get_end addr 0x2ad1b78 size 0x10 virtual false final false
  inline double_t get_end();

  /// @brief Method get_clipIn addr 0x2ad1b88 size 0x20 virtual false final false
  inline double_t get_clipIn();

  /// @brief Method set_clipIn addr 0x2ad1ba8 size 0xd8 virtual false final false
  inline void set_clipIn(double_t value);

  /// @brief Method get_displayName addr 0x2ad1c80 size 0x8 virtual false final false
  inline ::StringW get_displayName();

  /// @brief Method set_displayName addr 0x2ad1c88 size 0x8 virtual false final false
  inline void set_displayName(::StringW value);

  /// @brief Method get_clipAssetDuration addr 0x2ad1c90 size 0xc0 virtual false final false
  inline double_t get_clipAssetDuration();

  /// @brief Method get_curves addr 0x2ad1d50 size 0x8 virtual true final true
  inline ::UnityEngine::AnimationClip* get_curves();

  /// @brief Method set_curves addr 0x2ad1d58 size 0x8 virtual false final false
  inline void set_curves(::UnityEngine::AnimationClip* value);

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName addr 0x2ad1d60 size 0x58 virtual true final true
  inline ::StringW UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName();

  /// @brief Method get_hasCurves addr 0x2ad1db8 size 0x8c virtual true final true
  inline bool get_hasCurves();

  /// @brief Method get_asset addr 0x2ad1e44 size 0x8 virtual true final true
  inline ::UnityEngine::Object* get_asset();

  /// @brief Method set_asset addr 0x2ad1e4c size 0x8 virtual false final false
  inline void set_asset(::UnityEngine::Object* value);

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_assetOwner addr 0x2ad1e54 size 0x8 virtual true final true
  inline ::UnityEngine::Object* UnityEngine_Timeline_ICurvesOwner_get_assetOwner();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_targetTrack addr 0x2ad1e5c size 0x8 virtual true final true
  inline ::UnityEngine::Timeline::TrackAsset* UnityEngine_Timeline_ICurvesOwner_get_targetTrack();

  /// @brief Method get_underlyingAsset addr 0x2ad1e64 size 0x8 virtual false final false
  inline ::UnityEngine::Object* get_underlyingAsset();

  /// @brief Method set_underlyingAsset addr 0x2ad1e6c size 0x4 virtual false final false
  inline void set_underlyingAsset(::UnityEngine::Object* value);

  /// @brief Method get_parentTrack addr 0x2ad1e70 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::TrackAsset* get_parentTrack();

  /// @brief Method set_parentTrack addr 0x2ad1e78 size 0x4 virtual false final false
  inline void set_parentTrack(::UnityEngine::Timeline::TrackAsset* value);

  /// @brief Method GetParentTrack addr 0x2ad1e7c size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::TrackAsset* GetParentTrack();

  /// @brief Method SetParentTrack_Internal addr 0x2ad15ec size 0xf4 virtual false final false
  inline void SetParentTrack_Internal(::UnityEngine::Timeline::TrackAsset* newParentTrack);

  /// @brief Method get_easeInDuration addr 0x2ad1fb8 size 0xbc virtual false final false
  inline double_t get_easeInDuration();

  /// @brief Method set_easeInDuration addr 0x2ad20a0 size 0xf8 virtual false final false
  inline void set_easeInDuration(double_t value);

  /// @brief Method get_easeOutDuration addr 0x2ad2198 size 0xbc virtual false final false
  inline double_t get_easeOutDuration();

  /// @brief Method set_easeOutDuration addr 0x2ad2280 size 0xf8 virtual false final false
  inline void set_easeOutDuration(double_t value);

  /// @brief Method get_eastOutTime addr 0x2ad2378 size 0x2c virtual false final false
  inline double_t get_eastOutTime();

  /// @brief Method get_easeOutTime addr 0x2ad23a4 size 0x2c virtual false final false
  inline double_t get_easeOutTime();

  /// @brief Method get_blendInDuration addr 0x2ad23d0 size 0x20 virtual false final false
  inline double_t get_blendInDuration();

  /// @brief Method set_blendInDuration addr 0x2ad23f0 size 0x88 virtual false final false
  inline void set_blendInDuration(double_t value);

  /// @brief Method get_blendOutDuration addr 0x2ad2478 size 0x20 virtual false final false
  inline double_t get_blendOutDuration();

  /// @brief Method set_blendOutDuration addr 0x2ad2498 size 0x88 virtual false final false
  inline void set_blendOutDuration(double_t value);

  /// @brief Method get_blendInCurveMode addr 0x2ad2520 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__BlendCurveMode get_blendInCurveMode();

  /// @brief Method set_blendInCurveMode addr 0x2ad2528 size 0x8 virtual false final false
  inline void set_blendInCurveMode(::UnityEngine::Timeline::__TimelineClip__BlendCurveMode value);

  /// @brief Method get_blendOutCurveMode addr 0x2ad2530 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__BlendCurveMode get_blendOutCurveMode();

  /// @brief Method set_blendOutCurveMode addr 0x2ad2538 size 0x8 virtual false final false
  inline void set_blendOutCurveMode(::UnityEngine::Timeline::__TimelineClip__BlendCurveMode value);

  /// @brief Method get_hasBlendIn addr 0x2ad2254 size 0x2c virtual false final false
  inline bool get_hasBlendIn();

  /// @brief Method get_hasBlendOut addr 0x2ad2074 size 0x2c virtual false final false
  inline bool get_hasBlendOut();

  /// @brief Method get_mixInCurve addr 0x2ad2540 size 0x8c virtual false final false
  inline ::UnityEngine::AnimationCurve* get_mixInCurve();

  /// @brief Method set_mixInCurve addr 0x2ad25e4 size 0x8 virtual false final false
  inline void set_mixInCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method get_mixInPercentage addr 0x2ad25ec size 0x20 virtual false final false
  inline float_t get_mixInPercentage();

  /// @brief Method get_mixInDuration addr 0x2ad260c size 0x44 virtual false final false
  inline double_t get_mixInDuration();

  /// @brief Method get_mixOutCurve addr 0x2ad2650 size 0x8c virtual false final false
  inline ::UnityEngine::AnimationCurve* get_mixOutCurve();

  /// @brief Method set_mixOutCurve addr 0x2ad26f4 size 0x8 virtual false final false
  inline void set_mixOutCurve(::UnityEngine::AnimationCurve* value);

  /// @brief Method get_mixOutTime addr 0x2ad26fc size 0x2c virtual false final false
  inline double_t get_mixOutTime();

  /// @brief Method get_mixOutDuration addr 0x2ad2728 size 0x44 virtual false final false
  inline double_t get_mixOutDuration();

  /// @brief Method get_mixOutPercentage addr 0x2ad276c size 0x20 virtual false final false
  inline float_t get_mixOutPercentage();

  /// @brief Method get_recordable addr 0x2ad278c size 0x8 virtual false final false
  inline bool get_recordable();

  /// @brief Method set_recordable addr 0x2ad2794 size 0xc virtual false final false
  inline void set_recordable(bool value);

  /// @brief Method get_exposedParameters addr 0x2ad27a0 size 0x80 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_exposedParameters();

  /// @brief Method get_clipCaps addr 0x2ad17f8 size 0xe4 virtual false final false
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method Hash addr 0x2ad2820 size 0x1ec virtual false final false
  inline int32_t Hash();

  /// @brief Method EvaluateMixOut addr 0x2ad2a0c size 0xf4 virtual false final false
  inline float_t EvaluateMixOut(double_t time);

  /// @brief Method EvaluateMixIn addr 0x2ad2b00 size 0xd4 virtual false final false
  inline float_t EvaluateMixIn(double_t time);

  /// @brief Method GetDefaultMixInCurve addr 0x2ad25cc size 0x18 virtual false final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixInCurve();

  /// @brief Method GetDefaultMixOutCurve addr 0x2ad26dc size 0x18 virtual false final false
  static inline ::UnityEngine::AnimationCurve* GetDefaultMixOutCurve();

  /// @brief Method ToLocalTime addr 0x2ad2bd4 size 0xec virtual false final false
  inline double_t ToLocalTime(double_t time);

  /// @brief Method ToLocalTimeUnbound addr 0x2ad2e80 size 0x50 virtual false final false
  inline double_t ToLocalTimeUnbound(double_t time);

  /// @brief Method FromLocalTimeUnbound addr 0x2ad2ed0 size 0x44 virtual false final false
  inline double_t FromLocalTimeUnbound(double_t time);

  /// @brief Method get_animationClip addr 0x2ad2f14 size 0xf8 virtual false final false
  inline ::UnityEngine::AnimationClip* get_animationClip();

  /// @brief Method SanitizeTimeValue addr 0x2ad19d0 size 0x198 virtual false final false
  static inline double_t SanitizeTimeValue(double_t value, double_t defaultValue);

  /// @brief Method get_postExtrapolationMode addr 0x2ad300c size 0x24 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_postExtrapolationMode();

  /// @brief Method set_postExtrapolationMode addr 0x2acdde0 size 0x34 virtual false final false
  inline void set_postExtrapolationMode(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method get_preExtrapolationMode addr 0x2ad3030 size 0x24 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_preExtrapolationMode();

  /// @brief Method set_preExtrapolationMode addr 0x2acddac size 0x34 virtual false final false
  inline void set_preExtrapolationMode(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method SetPostExtrapolationTime addr 0x2ad3054 size 0x8 virtual false final false
  inline void SetPostExtrapolationTime(double_t time);

  /// @brief Method SetPreExtrapolationTime addr 0x2ad305c size 0x8 virtual false final false
  inline void SetPreExtrapolationTime(double_t time);

  /// @brief Method IsExtrapolatedTime addr 0x2ad3064 size 0x3c virtual false final false
  inline bool IsExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPreExtrapolatedTime addr 0x2ad2cc0 size 0x50 virtual false final false
  inline bool IsPreExtrapolatedTime(double_t sequenceTime);

  /// @brief Method IsPostExtrapolatedTime addr 0x2ad2e28 size 0x58 virtual false final false
  inline bool IsPostExtrapolatedTime(double_t sequenceTime);

  /// @brief Method get_extrapolatedStart addr 0x2ad30a0 size 0x18 virtual false final false
  inline double_t get_extrapolatedStart();

  /// @brief Method get_extrapolatedDuration addr 0x2ad30b8 size 0xcc virtual false final false
  inline double_t get_extrapolatedDuration();

  /// @brief Method GetExtrapolatedTime addr 0x2ad2d10 size 0x118 virtual false final false
  ...
  /// @brief Method CreateCurves addr 0x2ad3184 size 0xcc virtual true final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize addr 0x2ad3250 size 0xc virtual true final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize addr 0x2ad325c size 0x38 virtual true final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method ToString addr 0x2ad3294 size 0x1dc virtual true final false
  inline ::StringW ToString();

  /// @brief Method ConformEaseValues addr 0x2ad3470 size 0x90 virtual false final false
  inline void ConformEaseValues();

  /// @brief Method CalculateEasingRatio addr 0x2ad3500 size 0xcc virtual false final false
  static inline double_t CalculateEasingRatio(double_t easeIn, double_t easeOut);

  /// @brief Method UpdateDirty addr 0x2ad19c4 size 0x4 virtual false final false
