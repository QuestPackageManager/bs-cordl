...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Timeline::NotificationFlags (::UnityEngine::Timeline::INotificationOptionProvider::*)()>(&::UnityEngine::Timeline::INotificationOptionProvider::get_flags)> {
