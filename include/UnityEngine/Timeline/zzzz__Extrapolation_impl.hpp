...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::Extrapolation___c::*)()>(&::UnityEngine::Timeline::Extrapolation___c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x68158f8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Timeline::Extrapolation___c::*)(::UnityEngine::Timeline::TimelineClip*, ::UnityEngine::Timeline::TimelineClip*)>(&::UnityEngine::Timeline::Extrapolation___c::_SortClipsByStartTime_b__2_0)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x68158fc;
...
::cordl_internals::setStaticField<::UnityEngine::Timeline::Extrapolation___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::Extrapolation___c*>::get>(std::forward<::UnityEngine::Timeline::Extrapolation___c*>(value));
}
inline ::UnityEngine::Timeline::Extrapolation___c* UnityEngine::Timeline::Extrapolation___c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::Timeline::Extrapolation___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::Extrapolation___c*>::get>();
}
...
::cordl_internals::setStaticField<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*, "<>9__2_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::Extrapolation___c*>::get>(std::forward<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*>(value));
}
inline ::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>* UnityEngine::Timeline::Extrapolation___c::getStaticF___9__2_0()  {
return ::cordl_internals::getStaticField<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*, "<>9__2_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::Extrapolation___c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Timeline::TrackAsset*)>(&::UnityEngine::Timeline::Extrapolation::CalculateExtrapolationTimes)> {
  ...
  constexpr static std::size_t addrs = 0x6815320;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*> (*)(::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*>)>(&::UnityEngine::Timeline::Extrapolation::SortClipsByStartTime)> {
  ...
  constexpr static std::size_t addrs = 0x68156cc;
