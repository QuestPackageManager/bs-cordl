...
public:
  ...
  /// @brief Method Create, addr 0x687f5a4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableAt, addr 0x687fa48, size 0x160, virtual true, abstract: false, final false
  inline void DisableAt(double_t localTime, double_t rootDuration, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAt, addr 0x687f84c, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetDuration, addr 0x687f7f0, size 0x5c, virtual false, abstract: false, final false
  inline void SetDuration(double_t duration);

  /// @brief Method SetTime, addr 0x687f794, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6869cac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clip, addr 0x687f62c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* get_clip();

  /// @brief Method get_duration, addr 0x687f58c, size 0x14, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_mixer, addr 0x687f634, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_mixer();

  /// @brief Method get_playable, addr 0x687f640, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Playables::Playable get_playable();

  /// @brief Method get_start, addr 0x687f564, size 0x28, virtual true, abstract: false, final false
  inline double_t get_start();

  /// @brief Method set_enable, addr 0x687f64c, size 0x148, virtual true, abstract: false, final false
