...
public:
  ...
  /// @brief Method MoveToTrack, addr 0x69c8b3c, size 0x31c, virtual false, abstract: false, final false
  static inline void MoveToTrack(::UnityEngine::Timeline::TimelineClip* clip, ::UnityEngine::Timeline::TrackAsset* destinationTrack);

  /// @brief Method MoveToTrack_Impl, addr 0x69c8e58, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method TryMoveToTrack, addr 0x69c8f7c, size 0x1a4, virtual false, abstract: false, final false
