...
public:
  ...
  /// @brief Method MoveToTrack, addr 0x2db5a94, size 0x3c0, virtual false, abstract: false, final false
  static inline void MoveToTrack(::UnityEngine::Timeline::TimelineClip* clip, ::UnityEngine::Timeline::TrackAsset* destinationTrack);

  /// @brief Method MoveToTrack_Impl, addr 0x2db5e54, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method TryMoveToTrack, addr 0x2db5f74, size 0x1a4, virtual false, abstract: false, final false
