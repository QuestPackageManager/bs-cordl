...
/// @brief Method Append, addr 0x680f000, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x680f708, size 0xa8, virtual false, abstract: false, final false
inline void Remove(int32_t  idx) ;

/// @brief Method Remove, addr 0x680f26c, size 0xf0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method TryGetValue, addr 0x680edec, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x680fa70, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_events, addr 0x680fb34, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::UnityEvent*>* get_events() ;

/// @brief Method get_signals, addr 0x680fb2c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddEmptyReaction, addr 0x680f128, size 0x7c, virtual false, abstract: false, final false
inline int32_t AddEmptyReaction(::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method AddReaction, addr 0x680eec0, size 0x140, virtual false, abstract: false, final false
inline void AddReaction(::UnityEngine::Timeline::SignalAsset*  asset, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeReactionAtIndex, addr 0x680f7b0, size 0xd0, virtual false, abstract: false, final false
inline void ChangeReactionAtIndex(int32_t  idx, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeSignalAtIndex, addr 0x680f3f8, size 0x264, virtual false, abstract: false, final false
inline void ChangeSignalAtIndex(int32_t  idx, ::UnityEngine::Timeline::SignalAsset*  newKey) ;

/// @brief Method Count, addr 0x680f3a0, size 0x58, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method GetReaction, addr 0x680f374, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReaction(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method GetReactionAtIndex, addr 0x680f880, size 0xc8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReactionAtIndex(int32_t  idx) ;

/// @brief Method GetRegisteredSignals, addr 0x680f35c, size 0x18, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>* GetRegisteredSignals() ;

/// @brief Method GetSignalAssetAtIndex, addr 0x680f948, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x680fa10, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnNotify, addr 0x680ecc0, size 0x12c, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x680f1a4, size 0xc8, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  asset) ;

/// @brief Method RemoveAtIndex, addr 0x680f65c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x680fa14, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
