...
public:
  ...
  /// @brief Method SetStandardFrameRate, addr 0x481c504, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x481c3f8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_fps, addr 0x481c468, size 0xc, virtual false, abstract: false, final false
  inline float_t get_fps();

  /// @brief Method get_frameRate, addr 0x481c4fc, size 0x8, virtual false, abstract: false, final false
  inline double_t get_frameRate();

  /// @brief Method get_scenePreview, addr 0x481c64c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_fps, addr 0x481c474, size 0x88, virtual false, abstract: false, final false
  inline void set_fps(float_t value);

  /// @brief Method set_frameRate, addr 0x4819e18, size 0x18, virtual false, abstract: false, final false
  inline void set_frameRate(double_t value);

  /// @brief Method set_scenePreview, addr 0x481c654, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x481c794, size 0x45c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::Timeline::TimelineAsset__get_outputs_d__27* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x481cdf8, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x481cd50, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x481ce94, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x481cd60, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x481cd98, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x481c6e4, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x481cca0, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x481cbf0, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x4819390, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddSubTracksRecursive, addr 0x481a034, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTrackInternal, addr 0x481a394, size 0xb0, virtual false, abstract: false, final false
  inline void AddTrackInternal(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method AllocateTrack, addr 0x481b498, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateItemsDuration, addr 0x4818fe4, size 0x154, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::DiscreteTime CalculateItemsDuration();

  /// @brief Method CreateMarkerTrack, addr 0x481adcc, size 0xcc, virtual false, abstract: false, final false
  inline void CreateMarkerTrack();

  /// @brief Method CreatePlayable, addr 0x481a5d0, size 0x1c4, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreateTrack, addr 0x481b034, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteClip, addr 0x481b708, size 0x1cc, virtual false, abstract: false, final false
  inline bool DeleteClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteRecordedAnimation, addr 0x481b8d4, size 0x158, virtual false, abstract: false, final false
  inline void DeleteRecordedAnimation(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteRecordedAnimation, addr 0x481bf78, size 0x14c, virtual false, abstract: false, final false
  inline void DeleteRecordedAnimation(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method DeleteTrack, addr 0x481ba2c, size 0x54c, virtual false, abstract: false, final false
  inline bool DeleteTrack(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method GatherProperties, addr 0x481a910, size 0x318, virtual true, abstract: false, final true
  ...
  /// @brief Method GetOutputTrack, addr 0x4819e90, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetOutputTrack(int32_t index);

  /// @brief Method GetOutputTracks, addr 0x4819ed4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetOutputTracks();

  /// @brief Method GetRootTrack, addr 0x4819e30, size 0x60, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetRootTrack(int32_t index);

  /// @brief Method GetRootTracks, addr 0x4819710, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetRootTracks();

  /// @brief Method GetValidFrameRate, addr 0x4819d6c, size 0xac, virtual false, abstract: false, final false
  static inline double_t GetValidFrameRate(double_t frameRate);

  /// @brief Method Invalidate, addr 0x481a444, size 0xc, virtual false, abstract: false, final false
  inline void Invalidate();

  /// @brief Method MoveLastTrackBefore, addr 0x481c0c4, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x4819d44, size 0x28, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RemoveTrack, addr 0x481a450, size 0x108, virtual false, abstract: false, final false
  inline void RemoveTrack(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x481a79c, size 0xc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x481a794, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UpdateFixedDurationWithItemsDuration, addr 0x481ae98, size 0x6c, virtual false, abstract: false, final false
  inline void UpdateFixedDurationWithItemsDuration();

  /// @brief Method UpdateOutputTrackCache, addr 0x481974c, size 0x228, virtual false, abstract: false, final false
  inline void UpdateOutputTrackCache();

  /// @brief Method UpdateRootTrackCache, addr 0x48199c4, size 0x380, virtual false, abstract: false, final false
  inline void UpdateRootTrackCache();

  /// @brief Method UpgradeToLatestVersion, addr 0x4818f28, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method __internalAwake, addr 0x481a7a8, size 0x168, virtual false, abstract: false, final false
  inline void __internalAwake();

  /// @brief Method .ctor, addr 0x481c39c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x48193c4, size 0x34c, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method get_duration, addr 0x4818f34, size 0xb0, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_durationMode, addr 0x4819310, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineAsset_DurationMode get_durationMode();

  /// @brief Method get_editorSettings, addr 0x4818f2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineAsset_EditorSettings* get_editorSettings();

  /// @brief Method get_fixedDuration, addr 0x48191d0, size 0xb4, virtual false, abstract: false, final false
  inline double_t get_fixedDuration();

  /// @brief Method get_flattenedTracks, addr 0x4819eec, size 0x148, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Timeline::TrackAsset>, ::Array<::UnityW<::UnityEngine::Timeline::TrackAsset>>*> get_flattenedTracks();

  /// @brief Method get_markerTrack, addr 0x481a384, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::MarkerTrack> get_markerTrack();

  /// @brief Method get_outputTrackCount, addr 0x4819728, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_outputTrackCount();

  /// @brief Method get_outputs, addr 0x4819320, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_rootTrackCount, addr 0x4819974, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_rootTrackCount();

  /// @brief Method get_trackObjects, addr 0x481a38c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_durationMode, addr 0x4819318, size 0x8, virtual false, abstract: false, final false
  inline void set_durationMode(::UnityEngine::Timeline::TimelineAsset_DurationMode value);

  /// @brief Method set_fixedDuration, addr 0x48192a0, size 0x70, virtual false, abstract: false, final false
