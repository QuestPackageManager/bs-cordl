...
public:
  ...
  /// @brief Method SetStandardFrameRate, addr 0x6798280, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6798174, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_fps, addr 0x67981e0, size 0xc, virtual false, abstract: false, final false
  inline float_t get_fps();

  /// @brief Method get_frameRate, addr 0x6798278, size 0x8, virtual false, abstract: false, final false
  inline double_t get_frameRate();

  /// @brief Method get_scenePreview, addr 0x67983c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_fps, addr 0x67981ec, size 0x8c, virtual false, abstract: false, final false
  inline void set_fps(float_t value);

  /// @brief Method set_frameRate, addr 0x6795a78, size 0x18, virtual false, abstract: false, final false
  inline void set_frameRate(double_t value);

  /// @brief Method set_scenePreview, addr 0x67983d0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x6798510, size 0x474, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::Timeline::TimelineAsset__get_outputs_d__27* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x6798b98, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x6798aec, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6798c30, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6798afc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6798b34, size 0x64, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6798464, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x6798a38, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x6798984, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x679504c, size 0x20, virtual false, abstract: false, final false
...
// Dependencies UnityEngine.Playables.PlayableAsset, UnityEngine.Timeline.TimelineAsset::DurationMode
namespace UnityEngine::Timeline {
// Is value type: false
...
public:
  ...
  /// @brief Method AddSubTracksRecursive, addr 0x6795cd4, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTrackInternal, addr 0x6796020, size 0xbc, virtual false, abstract: false, final false
  inline void AddTrackInternal(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method AllocateTrack, addr 0x6797228, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateItemsDuration, addr 0x6794ca4, size 0x150, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::DiscreteTime CalculateItemsDuration();

  /// @brief Method CreateMarkerTrack, addr 0x6796ac8, size 0xd4, virtual false, abstract: false, final false
  inline void CreateMarkerTrack();

  /// @brief Method CreatePlayable, addr 0x679628c, size 0x1f4, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreateTrack, addr 0x6796dcc, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteClip, addr 0x6797490, size 0x1dc, virtual false, abstract: false, final false
  inline bool DeleteClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteRecordedAnimation, addr 0x679766c, size 0x160, virtual false, abstract: false, final false
  inline void DeleteRecordedAnimation(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteRecordedAnimation, addr 0x6797cc4, size 0x154, virtual false, abstract: false, final false
  inline void DeleteRecordedAnimation(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method DeleteTrack, addr 0x67977cc, size 0x4f8, virtual false, abstract: false, final false
  inline bool DeleteTrack(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method GatherProperties, addr 0x6796614, size 0x2f4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetOutputTrack, addr 0x6795afc, size 0x44, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetOutputTrack(int32_t index);

  /// @brief Method GetOutputTracks, addr 0x6795b40, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetOutputTracks();

  /// @brief Method GetRootTrack, addr 0x6795a90, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> GetRootTrack(int32_t index);

  /// @brief Method GetRootTracks, addr 0x6795394, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetRootTracks();

  /// @brief Method GetValidFrameRate, addr 0x67959ac, size 0xcc, virtual false, abstract: false, final false
  static inline double_t GetValidFrameRate(double_t frameRate);

  /// @brief Method Invalidate, addr 0x67960dc, size 0xc, virtual false, abstract: false, final false
  inline void Invalidate();

  /// @brief Method MoveLastTrackBefore, addr 0x6797e18, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x6795984, size 0x28, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RemoveMarkerTrack, addr 0x6796b9c, size 0x88, virtual false, abstract: false, final false
  inline void RemoveMarkerTrack();

  /// @brief Method RemoveTrack, addr 0x67960e8, size 0x120, virtual false, abstract: false, final false
  inline void RemoveTrack(::UnityEngine::Timeline::TrackAsset* track);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x6796488, size 0xc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x6796480, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UpdateFixedDurationWithItemsDuration, addr 0x6796c24, size 0x70, virtual false, abstract: false, final false
  inline void UpdateFixedDurationWithItemsDuration();

  /// @brief Method UpdateOutputTrackCache, addr 0x67953d0, size 0x224, virtual false, abstract: false, final false
  inline void UpdateOutputTrackCache();

  /// @brief Method UpdateRootTrackCache, addr 0x679564c, size 0x338, virtual false, abstract: false, final false
  inline void UpdateRootTrackCache();

  /// @brief Method UpgradeToLatestVersion, addr 0x6794bd8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method __internalAwake, addr 0x6796494, size 0x180, virtual false, abstract: false, final false
  inline void __internalAwake();

  /// @brief Method .ctor, addr 0x6798114, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x679506c, size 0x328, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method get_duration, addr 0x6794be4, size 0xc0, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_durationMode, addr 0x6794fcc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineAsset_DurationMode get_durationMode();

  /// @brief Method get_editorSettings, addr 0x6794bdc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineAsset_EditorSettings* get_editorSettings();

  /// @brief Method get_fixedDuration, addr 0x6794e8c, size 0xb8, virtual false, abstract: false, final false
  inline double_t get_fixedDuration();

  /// @brief Method get_flattenedTracks, addr 0x6795b58, size 0x17c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Timeline::TrackAsset>, ::Array<::UnityW<::UnityEngine::Timeline::TrackAsset>>*> get_flattenedTracks();

  /// @brief Method get_markerTrack, addr 0x6796010, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Timeline::MarkerTrack> get_markerTrack();

  /// @brief Method get_outputTrackCount, addr 0x67953ac, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_outputTrackCount();

  /// @brief Method get_outputs, addr 0x6794fdc, size 0x70, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_rootTrackCount, addr 0x67955f4, size 0x58, virtual false, abstract: false, final false
  inline int32_t get_rootTrackCount();

  /// @brief Method get_trackObjects, addr 0x6796018, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_durationMode, addr 0x6794fd4, size 0x8, virtual false, abstract: false, final false
  inline void set_durationMode(::UnityEngine::Timeline::TimelineAsset_DurationMode value);

  /// @brief Method set_fixedDuration, addr 0x6794f5c, size 0x70, virtual false, abstract: false, final false
