...
public:
  // Declarations
  /// @brief Method ConvertRotationsToEuler addr 0x2ad0ff0 size 0x9c virtual false final false
  static inline void ConvertRotationsToEuler(::UnityEngine::Timeline::AnimationTrack* track);

  /// @brief Method ConvertRootMotion addr 0x2ad108c size 0x84 virtual false final false
  static inline void ConvertRootMotion(::UnityEngine::Timeline::AnimationTrack* track);

  /// @brief Method ConvertInfiniteTrack addr 0x2ad1110 size 0x20 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2acd2f0 size 0x34 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x2ad1350 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x2ad1354 size 0x90 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current addr 0x2ad13e4 size 0x10 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2ad13f4 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2ad1434 size 0x60 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator addr 0x2ad1494 size 0xa4 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2ad1538 size 0x4 virtual true final true
...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10176)), TypeDefinitionIndex(TypeDefinitionIndex(10179)), TypeDefinitionIndex(TypeDefinitionIndex(14109)),
// TypeDefinitionIndex(TypeDefinitionIndex(14118)), TypeDefinitionIndex(TypeDefinitionIndex(14102)), TypeDefinitionIndex(TypeDefinitionIndex(14133)), TypeDefinitionIndex(TypeDefinitionIndex(14108))}
...
public:
  ...
  /// @brief Method get_position addr 0x2acd050 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method set_position addr 0x2acd05c size 0xc virtual false final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method get_rotation addr 0x2acd068 size 0x24 virtual false final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method set_rotation addr 0x2acd08c size 0x3c virtual false final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method get_eulerAngles addr 0x2acd0c8 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_eulerAngles();

  /// @brief Method set_eulerAngles addr 0x2acd0d4 size 0xc virtual false final false
  inline void set_eulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method get_applyOffsets addr 0x2acd0e0 size 0x8 virtual false final false
  inline bool get_applyOffsets();

  /// @brief Method set_applyOffsets addr 0x2acd0e8 size 0x4 virtual false final false
  inline void set_applyOffsets(bool value);

  /// @brief Method get_trackOffset addr 0x2acd0ec size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::TrackOffset get_trackOffset();

  /// @brief Method set_trackOffset addr 0x2acd0f4 size 0x8 virtual false final false
  inline void set_trackOffset(::UnityEngine::Timeline::TrackOffset value);

  /// @brief Method get_matchTargetFields addr 0x2acd0fc size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::MatchTargetFields get_matchTargetFields();

  /// @brief Method set_matchTargetFields addr 0x2acd104 size 0x70 virtual false final false
  inline void set_matchTargetFields(::UnityEngine::Timeline::MatchTargetFields value);

  /// @brief Method get_infiniteClip addr 0x2acd174 size 0x8 virtual false final false
  inline ::UnityEngine::AnimationClip* get_infiniteClip();

  /// @brief Method set_infiniteClip addr 0x2acd17c size 0x8 virtual false final false
  inline void set_infiniteClip(::UnityEngine::AnimationClip* value);

  /// @brief Method get_infiniteClipRemoveOffset addr 0x2acd184 size 0x8 virtual false final false
  inline bool get_infiniteClipRemoveOffset();

  /// @brief Method set_infiniteClipRemoveOffset addr 0x2acd18c size 0xc virtual false final false
  inline void set_infiniteClipRemoveOffset(bool value);

  /// @brief Method get_avatarMask addr 0x2acd198 size 0x8 virtual false final false
  inline ::UnityEngine::AvatarMask* get_avatarMask();

  /// @brief Method set_avatarMask addr 0x2acd1a0 size 0x8 virtual false final false
  inline void set_avatarMask(::UnityEngine::AvatarMask* value);

  /// @brief Method get_applyAvatarMask addr 0x2acd1a8 size 0x8 virtual false final false
  inline bool get_applyAvatarMask();

  /// @brief Method set_applyAvatarMask addr 0x2acd1b0 size 0xc virtual false final false
  inline void set_applyAvatarMask(bool value);

  /// @brief Method CanCompileClips addr 0x2acd1bc size 0xbc virtual true final false
  inline bool CanCompileClips();

  /// @brief Method get_outputs addr 0x2acd278 size 0x78 virtual true final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_inClipMode addr 0x2acd324 size 0x34 virtual false final false
  inline bool get_inClipMode();

  /// @brief Method get_infiniteClipOffsetPosition addr 0x2acd408 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_infiniteClipOffsetPosition();

  /// @brief Method set_infiniteClipOffsetPosition addr 0x2acd414 size 0xc virtual false final false
  inline void set_infiniteClipOffsetPosition(::UnityEngine::Vector3 value);

  /// @brief Method get_infiniteClipOffsetRotation addr 0x2acd420 size 0x24 virtual false final false
  inline ::UnityEngine::Quaternion get_infiniteClipOffsetRotation();

  /// @brief Method set_infiniteClipOffsetRotation addr 0x2acd444 size 0x3c virtual false final false
  inline void set_infiniteClipOffsetRotation(::UnityEngine::Quaternion value);

  /// @brief Method get_infiniteClipOffsetEulerAngles addr 0x2acd480 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_infiniteClipOffsetEulerAngles();

  /// @brief Method set_infiniteClipOffsetEulerAngles addr 0x2acd48c size 0xc virtual false final false
  inline void set_infiniteClipOffsetEulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method get_infiniteClipApplyFootIK addr 0x2acd498 size 0x8 virtual false final false
  inline bool get_infiniteClipApplyFootIK();

  /// @brief Method set_infiniteClipApplyFootIK addr 0x2acd4a0 size 0xc virtual false final false
  inline void set_infiniteClipApplyFootIK(bool value);

  /// @brief Method get_infiniteClipTimeOffset addr 0x2acd4ac size 0x8 virtual false final false
  inline double_t get_infiniteClipTimeOffset();

  /// @brief Method set_infiniteClipTimeOffset addr 0x2acd4b4 size 0x8 virtual false final false
  inline void set_infiniteClipTimeOffset(double_t value);

  /// @brief Method get_infiniteClipPreExtrapolation addr 0x2acd4bc size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_infiniteClipPreExtrapolation();

  /// @brief Method set_infiniteClipPreExtrapolation addr 0x2acd4c4 size 0x8 virtual false final false
  inline void set_infiniteClipPreExtrapolation(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method get_infiniteClipPostExtrapolation addr 0x2acd4cc size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_infiniteClipPostExtrapolation();

  /// @brief Method set_infiniteClipPostExtrapolation addr 0x2acd4d4 size 0x8 virtual false final false
  inline void set_infiniteClipPostExtrapolation(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method get_infiniteClipLoop addr 0x2acd4dc size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__AnimationPlayableAsset__LoopMode get_infiniteClipLoop();

  /// @brief Method set_infiniteClipLoop addr 0x2acd4e4 size 0x8 virtual false final false
  inline void set_infiniteClipLoop(::UnityEngine::Timeline::__AnimationPlayableAsset__LoopMode value);

  /// @brief Method ResetOffsets addr 0x2acd4ec size 0x6c virtual false final false
  inline void ResetOffsets();

  /// @brief Method CreateClip addr 0x2acd55c size 0xa8 virtual false final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClip(::UnityEngine::AnimationClip* clip);

  /// @brief Method CreateInfiniteClip addr 0x2acd858 size 0x104 virtual false final false
  inline void CreateInfiniteClip(::StringW infiniteClipName);

  /// @brief Method CreateRecordableClip addr 0x2acd95c size 0x140 virtual false final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateRecordableClip(::StringW animClipName);

  /// @brief Method OnCreateClip addr 0x2acdc4c size 0x40 virtual true final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method CalculateItemsHash addr 0x2acde14 size 0x74 virtual true final false
  inline int32_t CalculateItemsHash();

  /// @brief Method UpdateClipOffsets addr 0x2acd558 size 0x4 virtual false final false
  inline void UpdateClipOffsets();

  /// @brief Method CompileTrackPlayable addr 0x2acdffc size 0x424 virtual false final false
  ...
  /// @brief Method UnityEngine.Timeline.ILayerable.CreateLayerMixer addr 0x2acea18 size 0x50 virtual true final true
  ...
  /// @brief Method CreateMixerPlayableGraph addr 0x2acea68 size 0x99c virtual true final false
  ...
  /// @brief Method GetDefaultBlendCount addr 0x2acf8d8 size 0x8 virtual false final false
  inline int32_t GetDefaultBlendCount();

  /// @brief Method AttachDefaultBlend addr 0x2acfddc size 0x4 virtual false final false
  ...
  /// @brief Method AttachOffsetPlayable addr 0x2acfdf8 size 0x158 virtual false final false
  ...
  /// @brief Method RequiresMotionXPlayable addr 0x2acfccc size 0x110 virtual false final false
  inline bool RequiresMotionXPlayable(::UnityEngine::Timeline::AppliedOffsetMode mode, ::UnityEngine::GameObject* gameObject);

  /// @brief Method UsesAbsoluteMotion addr 0x2acfde0 size 0x18 virtual false final false
  static inline bool UsesAbsoluteMotion(::UnityEngine::Timeline::AppliedOffsetMode mode);

  /// @brief Method HasController addr 0x2ad0134 size 0x120 virtual false final false
  inline bool HasController(::UnityEngine::GameObject* gameObject);

  /// @brief Method GetBinding addr 0x2acff50 size 0x1e4 virtual false final false
  inline ::UnityEngine::Animator* GetBinding(::UnityEngine::Playables::PlayableDirector* director);

  /// @brief Method CreateGroupMixer addr 0x2acf8e0 size 0x70 virtual false final false
  ...
  /// @brief Method CreateInfiniteTrackPlayable addr 0x2acf950 size 0x37c virtual false final false
  ...
  /// @brief Method ApplyTrackOffset addr 0x2ace860 size 0x1b8 virtual false final false
  ...
  /// @brief Method GetEvaluationTime addr 0x2ad0280 size 0x9c virtual true final false
  inline void GetEvaluationTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method GetSequenceTime addr 0x2ad0578 size 0xfc virtual true final false
  inline void GetSequenceTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method AssignAnimationClip addr 0x2acd604 size 0x254 virtual false final false
  inline void AssignAnimationClip(::UnityEngine::Timeline::TimelineClip* clip, ::UnityEngine::AnimationClip* animClip);

  /// @brief Method GatherProperties addr 0x2ad07e8 size 0x4 virtual true final false
  ...
  /// @brief Method GetAnimationClips addr 0x2ad07ec size 0x564 virtual false final false
  inline void GetAnimationClips(::System::Collections::Generic::List_1<::UnityEngine::AnimationClip*>* animClips);

  /// @brief Method GetOffsetMode addr 0x2acf868 size 0x70 virtual false final false
  inline ::UnityEngine::Timeline::AppliedOffsetMode GetOffsetMode(::UnityEngine::GameObject* go, bool animatesRootTransform);

  /// @brief Method IsRootTransformDisabledByMask addr 0x2acf5ec size 0x264 virtual false final false
  inline bool IsRootTransformDisabledByMask(::UnityEngine::GameObject* gameObject, ::UnityEngine::Transform* genericRootNode);

  /// @brief Method GetGenericRootNode addr 0x2acf404 size 0x1e8 virtual false final false
  inline ::UnityEngine::Transform* GetGenericRootNode(::UnityEngine::GameObject* gameObject);

  /// @brief Method AnimatesRootTransform addr 0x2ace47c size 0x3e4 virtual false final false
  inline bool AnimatesRootTransform();

  /// @brief Method FindInHierarchyBreadthFirst addr 0x2ad0d50 size 0x1d4 virtual false final false
  static inline ::UnityEngine::Transform* FindInHierarchyBreadthFirst(::UnityEngine::Transform* t, ::StringW name);

  /// @brief Method get_openClipOffsetPosition addr 0x2ad0f28 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_openClipOffsetPosition();

  /// @brief Method set_openClipOffsetPosition addr 0x2ad0f34 size 0xc virtual false final false
  inline void set_openClipOffsetPosition(::UnityEngine::Vector3 value);

  /// @brief Method get_openClipOffsetRotation addr 0x2ad0f40 size 0x24 virtual false final false
  inline ::UnityEngine::Quaternion get_openClipOffsetRotation();

  /// @brief Method set_openClipOffsetRotation addr 0x2ad0f64 size 0x4 virtual false final false
  inline void set_openClipOffsetRotation(::UnityEngine::Quaternion value);

  /// @brief Method get_openClipOffsetEulerAngles addr 0x2ad0f68 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_openClipOffsetEulerAngles();

  /// @brief Method set_openClipOffsetEulerAngles addr 0x2ad0f74 size 0xc virtual false final false
  inline void set_openClipOffsetEulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method get_openClipPreExtrapolation addr 0x2ad0f80 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_openClipPreExtrapolation();

  /// @brief Method set_openClipPreExtrapolation addr 0x2ad0f88 size 0x8 virtual false final false
  inline void set_openClipPreExtrapolation(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method get_openClipPostExtrapolation addr 0x2ad0f90 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation get_openClipPostExtrapolation();

  /// @brief Method set_openClipPostExtrapolation addr 0x2ad0f98 size 0x8 virtual false final false
  inline void set_openClipPostExtrapolation(::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation value);

  /// @brief Method OnUpgradeFromVersion addr 0x2ad0fa0 size 0x50 virtual true final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  static inline ::UnityEngine::Timeline::AnimationTrack* New_ctor();

  /// @brief Method .ctor addr 0x2ad1130 size 0x190 virtual false final false
  inline void _ctor();
