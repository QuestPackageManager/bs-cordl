...
public:
  ...
  /// @brief Method Evaluate, addr 0x6867194, size 0x1ac, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FindMixers, addr 0x6866db4, size 0xfc, virtual false, abstract: false, final false
  inline void FindMixers();

  /// @brief Method FindMixers, addr 0x6866eb0, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6866cfc, size 0xb8, virtual false, abstract: false, final false
