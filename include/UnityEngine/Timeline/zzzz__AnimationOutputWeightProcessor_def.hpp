...
public:
  ...
  /// @brief Method Evaluate, addr 0x69a77f0, size 0x1ac, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FindMixers, addr 0x69a7410, size 0xfc, virtual false, abstract: false, final false
  inline void FindMixers();

  /// @brief Method FindMixers, addr 0x69a750c, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a7358, size 0xb8, virtual false, abstract: false, final false
