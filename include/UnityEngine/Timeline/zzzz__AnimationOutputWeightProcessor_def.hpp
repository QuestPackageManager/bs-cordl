...
public:
  ...
  /// @brief Method Evaluate, addr 0x480b688, size 0x160, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FindMixers, addr 0x480b2ac, size 0xe8, virtual false, abstract: false, final false
  inline void FindMixers();

  /// @brief Method FindMixers, addr 0x480b394, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x480b1ec, size 0xc0, virtual false, abstract: false, final false
