...
public:
  ...
  /// @brief Method Create addr 0x2ae8ce0 size 0x144 virtual false final false
  ...
  /// @brief Method get_prefabInstance addr 0x2ae90ac size 0x8 virtual false final false
  inline ::UnityEngine::GameObject* get_prefabInstance();

  /// @brief Method Initialize addr 0x2ae8e24 size 0x288 virtual false final false
  inline ::UnityEngine::GameObject* Initialize(::UnityEngine::GameObject* prefabGameObject, ::UnityEngine::Transform* parentTransform);

  /// @brief Method OnPlayableDestroy addr 0x2ae93fc size 0xac virtual true final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnBehaviourPlay addr 0x2ae94a8 size 0x88 virtual true final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPause addr 0x2ae9530 size 0xa8 virtual true final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method SetHideFlagsRecursive addr 0x2ae90b4 size 0x348 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ae95d8 size 0x8 virtual false final false
  inline void _ctor();
