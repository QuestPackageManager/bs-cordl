...
public:
  ...
  /// @brief Method Create, addr 0x4824048, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x4824188, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x48248dc, size 0xa8, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x4824854, size 0x88, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnPlayableDestroy, addr 0x4824784, size 0xd0, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method SetHideFlagsRecursive, addr 0x4824414, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4824984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_prefabInstance, addr 0x482440c, size 0x8, virtual false, abstract: false, final false
