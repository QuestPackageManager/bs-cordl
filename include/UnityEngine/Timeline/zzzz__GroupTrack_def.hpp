...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x2c67dd4, size 0x8, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method get_outputs, addr 0x2c67ddc, size 0x58, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  static inline ::UnityEngine::Timeline::GroupTrack* New_ctor();

  /// @brief Method .ctor, addr 0x2c67e34, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
