...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x6881f44, size 0x8, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  static inline ::UnityEngine::Timeline::GroupTrack* New_ctor();

  /// @brief Method .ctor, addr 0x6881fa8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_outputs, addr 0x6881f4c, size 0x5c, virtual true, abstract: false, final false
