...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x48273c0, size 0x8, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  static inline ::UnityEngine::Timeline::GroupTrack* New_ctor();

  /// @brief Method .ctor, addr 0x4827420, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_outputs, addr 0x48273c8, size 0x58, virtual true, abstract: false, final false
