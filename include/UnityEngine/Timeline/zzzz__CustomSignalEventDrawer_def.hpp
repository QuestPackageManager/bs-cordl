...
public:
  ...
  /// @brief Method .ctor, addr 0x680e2dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Timeline::CustomSignalEventDrawer, 0x18>, "Size mismatch!");
