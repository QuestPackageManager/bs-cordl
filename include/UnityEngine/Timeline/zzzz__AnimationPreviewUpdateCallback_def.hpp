...
public:
  ...
  /// @brief Method Evaluate, addr 0x480937c, size 0x1e4, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FetchPreviewComponents, addr 0x4809560, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48092b4, size 0xc8, virtual false, abstract: false, final false
