...
public:
  ...
  /// @brief Method Evaluate, addr 0x68684bc, size 0x1c0, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FetchPreviewComponents, addr 0x686867c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x68683fc, size 0xc0, virtual false, abstract: false, final false
