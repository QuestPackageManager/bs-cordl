...
public:
  ...
  /// @brief Method Evaluate, addr 0x480c8b0, size 0x1e4, virtual true, abstract: false, final true
  inline void Evaluate();

  /// @brief Method FetchPreviewComponents, addr 0x480ca94, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x480c7e8, size 0xc8, virtual false, abstract: false, final false
