...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AnimationPreviewUpdateCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AnimationPreviewUpdateCallback(AnimationPreviewUpdateCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AnimationPreviewUpdateCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AnimationPreviewUpdateCallback(AnimationPreviewUpdateCallbackconst&) = delete;
