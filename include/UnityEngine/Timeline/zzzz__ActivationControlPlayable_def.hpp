...
public:
  ...
  /// @brief Method Create, addr 0x4826c28, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x482bd58, size 0xa8, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x482bcd0, size 0x88, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnGraphStart, addr 0x482be88, size 0x94, virtual true, abstract: false, final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnPlayableDestroy, addr 0x482bf1c, size 0xcc, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x482be00, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x482bfe8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
