...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9193)), TypeDefinitionIndex(TypeDefinitionIndex(13853)), TypeDefinitionIndex(TypeDefinitionIndex(13854))]
...
public:
  ...
  /// @brief Method Create, addr 0x2c62d90, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPlay, addr 0x2c67e88, size 0x88, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPause, addr 0x2c67f10, size 0xa8, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method ProcessFrame, addr 0x2c67fb8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method OnGraphStart, addr 0x2c68040, size 0x94, virtual true, abstract: false, final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnPlayableDestroy, addr 0x2c680d4, size 0xcc, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  static inline ::UnityEngine::Timeline::ActivationControlPlayable* New_ctor();

  /// @brief Method .ctor, addr 0x2c681a0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
