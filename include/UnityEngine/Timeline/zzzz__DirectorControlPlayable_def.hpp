...
/// @brief Method Create, addr 0x680af44, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method DetectDiscontinuity, addr 0x681072c, size 0x11c, virtual false, abstract: false, final false
inline bool DetectDiscontinuity(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method DetectOutOfSync, addr 0x6810efc, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method OnBehaviourPause, addr 0x6810b90, size 0x11c, virtual true, abstract: false, final false
inline void OnBehaviourPause(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method OnBehaviourPlay, addr 0x6810ab8, size 0xd8, virtual true, abstract: false, final false
inline void OnBehaviourPlay(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method OnPlayableDestroy, addr 0x68104b8, size 0xc4, virtual true, abstract: false, final false
inline void OnPlayableDestroy(::UnityEngine::Playables::Playable  playable) ;

/// @brief Method PrepareFrame, addr 0x681057c, size 0x1b0, virtual true, abstract: false, final false
inline void PrepareFrame(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method ProcessFrame, addr 0x6810cac, size 0x250, virtual true, abstract: false, final false
inline void ProcessFrame(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info, ::System::Object*  playerData) ;

/// @brief Method SyncSpeed, addr 0x6810848, size 0x158, virtual false, abstract: false, final false
inline void SyncSpeed(double_t  speed) ;

/// @brief Method SyncStart, addr 0x68109a0, size 0x118, virtual false, abstract: false, final false
inline void SyncStart(::UnityEngine::Playables::PlayableGraph  graph, double_t  time) ;

/// @brief Method SyncStop, addr 0x68111e4, size 0xf8, virtual false, abstract: false, final false
inline void SyncStop(::UnityEngine::Playables::PlayableGraph  graph, double_t  time) ;

/// @brief Method UpdateTime, addr 0x6811050, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x68112dc, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
