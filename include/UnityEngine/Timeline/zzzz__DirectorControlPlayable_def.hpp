...
public:
  ...
  /// @brief Method Create, addr 0x3190c8c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method DetectDiscontinuity, addr 0x319635c, size 0x114, virtual false, abstract: false, final false
  inline bool DetectDiscontinuity(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method DetectOutOfSync, addr 0x3196a30, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x3196730, size 0x100, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x319665c, size 0xd4, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnPlayableDestroy, addr 0x31960e8, size 0xc0, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method PrepareFrame, addr 0x31961a8, size 0x1b4, virtual true, abstract: false, final false
  inline void PrepareFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method ProcessFrame, addr 0x3196830, size 0x200, virtual true, abstract: false, final false
  inline void ProcessFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info, ::System::Object* playerData);

  /// @brief Method SyncSpeed, addr 0x3196470, size 0x12c, virtual false, abstract: false, final false
  inline void SyncSpeed(double_t speed);

  /// @brief Method SyncStart, addr 0x319659c, size 0xc0, virtual false, abstract: false, final false
  inline void SyncStart(::UnityEngine::Playables::PlayableGraph graph, double_t time);

  /// @brief Method SyncStop, addr 0x3196d0c, size 0x84, virtual false, abstract: false, final false
  inline void SyncStop(::UnityEngine::Playables::PlayableGraph graph, double_t time);

  /// @brief Method UpdateTime, addr 0x3196b7c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3196d90, size 0x1010, virtual false, abstract: false, final false
  inline void _ctor();
