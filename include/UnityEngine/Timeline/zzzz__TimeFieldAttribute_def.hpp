...
/// @brief Field <useEditMode>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__useEditMode_k__BackingField, put=__cordl_internal_set__useEditMode_k__BackingField)) ::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode  _useEditMode_k__BackingField;
...
/// @brief Method .ctor, addr 0x6887144, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode  useEditMode) ;

/// @brief Method get_useEditMode, addr 0x688713c, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::Timeline::TimeFieldAttribute, 0x20>, "Size mismatch!");
