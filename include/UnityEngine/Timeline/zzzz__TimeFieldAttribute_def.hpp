...
public:
  ...
  /// @brief Method .ctor, addr 0x319a090, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Timeline::__TimeFieldAttribute__UseEditMode useEditMode);

  /// @brief Method get_useEditMode, addr 0x319a088, size 0x8, virtual false, abstract: false, final false
