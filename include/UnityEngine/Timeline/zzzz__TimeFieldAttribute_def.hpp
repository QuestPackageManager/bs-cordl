...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8914)), TypeDefinitionIndex(TypeDefinitionIndex(13874))]
...
public:
  ...
  /// @brief Method get_useEditMode, addr 0x2c6b2cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c6b2d4, size 0x28, virtual false, abstract: false, final false
