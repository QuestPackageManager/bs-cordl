...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode, "UnityEngine.Timeline", "TimeFieldAttribute/UseEditMode");
...
static_assert(sizeof(::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x69c5c28, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode useEditMode);

  /// @brief Method get_useEditMode, addr 0x69c5c20, size 0x8, virtual false, abstract: false, final false
