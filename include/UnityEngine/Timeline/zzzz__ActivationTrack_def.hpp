...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x6866690, size 0x64, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CreateTrackMixer, addr 0x68667e4, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method GatherProperties, addr 0x68668cc, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCreateClip, addr 0x6866b88, size 0x54, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method UpdateTrackMode, addr 0x68667d0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6866be0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x68667b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x68667bc, size 0x14, virtual false, abstract: false, final false
