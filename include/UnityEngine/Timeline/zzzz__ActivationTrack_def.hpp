...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x4819aa0, size 0x5c, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CreateTrackMixer, addr 0x4819bdc, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method GatherProperties, addr 0x4819cb8, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCreateClip, addr 0x4819f5c, size 0x50, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method UpdateTrackMode, addr 0x4819bc8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4819fb0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x4819bac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x4819bb4, size 0x14, virtual false, abstract: false, final false
