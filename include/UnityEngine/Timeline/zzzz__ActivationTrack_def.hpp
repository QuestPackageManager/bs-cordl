...
public:
  ...
  /// @brief Method CanCompileClips, addr 0x4810a70, size 0x5c, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CreateTrackMixer, addr 0x4810bac, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method GatherProperties, addr 0x4810c88, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCreateClip, addr 0x4810f2c, size 0x50, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method UpdateTrackMode, addr 0x4810b98, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4810f80, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x4810b7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x4810b84, size 0x14, virtual false, abstract: false, final false
