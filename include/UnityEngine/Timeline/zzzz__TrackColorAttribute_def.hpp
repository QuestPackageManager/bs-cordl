...
public:
  ...
  /// @brief Method .ctor, addr 0x68795b0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t r, float_t g, float_t b);

  /// @brief Method get_color, addr 0x68795a4, size 0xc, virtual false, abstract: false, final false
