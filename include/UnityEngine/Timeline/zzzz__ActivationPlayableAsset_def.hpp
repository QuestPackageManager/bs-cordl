...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x67f3f4c, size 0x70, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  static inline ::UnityEngine::Timeline::ActivationPlayableAsset* New_ctor();

  /// @brief Method .ctor, addr 0x67f3fbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x67f3f44, size 0x8, virtual true, abstract: false, final true
