...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*)>(&::UnityEngine::Timeline::SignalAsset::add_OnEnableCallback)> {
  constexpr static std::size_t size = 0xe0;
  constexpr static std::size_t addrs = 0x6882528;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*)>(&::UnityEngine::Timeline::SignalAsset::remove_OnEnableCallback)> {
  constexpr static std::size_t size = 0xe0;
  constexpr static std::size_t addrs = 0x6882608;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::SignalAsset::*)()>(&::UnityEngine::Timeline::SignalAsset::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x68826e8;
...
::cordl_internals::setStaticField<::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*, "OnEnableCallback", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::SignalAsset*>::get>(std::forward<::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Action_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>*, "OnEnableCallback", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::SignalAsset*>::get>();
}
