...
public:
  ...
  /// @brief Method PrepareFrame, addr 0x2da6f48, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2da717c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
