...
public:
  ...
  /// @brief Method PrepareFrame, addr 0x318d3f8, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x318d62c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
