...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::AudioMixerProperties*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::AudioMixerProperties*, "UnityEngine.Timeline", "AudioMixerProperties");
...
public:
  ...
  /// @brief Method PrepareFrame, addr 0x69b9c2c, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69b9ef8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::Timeline::AudioMixerProperties) == 0x20, "Size mismatch!");
