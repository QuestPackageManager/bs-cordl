...
public:
  ...
  /// @brief Method PrepareFrame, addr 0x482c458, size 0x2a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x482c700, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
