...
public:
  ...
  /// @brief Method PrepareFrame, addr 0x679f38c, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x679f658, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
