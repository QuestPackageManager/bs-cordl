...
/// @brief Method PrepareFrame, addr 0x687b148, size 0x2cc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x687b414, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
