...
public:
  ...
  /// @brief Method .ctor, addr 0x4838130, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x4838160, size 0x30, virtual false, abstract: false, final false
