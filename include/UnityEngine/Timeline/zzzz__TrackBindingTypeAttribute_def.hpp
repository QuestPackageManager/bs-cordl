...
public:
  ...
  /// @brief Method .ctor, addr 0x67ab354, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x67ab364, size 0xc, virtual false, abstract: false, final false
