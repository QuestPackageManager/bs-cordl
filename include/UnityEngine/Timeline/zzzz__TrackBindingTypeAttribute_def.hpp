...
public:
  ...
  /// @brief Method .ctor, addr 0x6812ecc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x6812edc, size 0xc, virtual false, abstract: false, final false
