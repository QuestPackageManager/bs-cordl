...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::TrackBindingTypeAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::TrackBindingTypeAttribute*, "UnityEngine.Timeline", "TrackBindingTypeAttribute");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrackBindingTypeAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrackBindingTypeAttribute(TrackBindingTypeAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrackBindingTypeAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrackBindingTypeAttribute(TrackBindingTypeAttributeconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Timeline::TrackBindingTypeAttribute) == 0x20, "Size mismatch!");
