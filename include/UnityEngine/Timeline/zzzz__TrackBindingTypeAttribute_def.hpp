...
public:
  ...
  /// @brief Method .ctor, addr 0x482ac84, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method .ctor, addr 0x482acb4, size 0x30, virtual false, abstract: false, final false
