...
namespace UnityEngine::Timeline {
class ControlPlayableAsset__GetControlableScripts_d__40;
}
namespace UnityEngine::Timeline {
...
MARK_REF_PTR_T(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40);
// Dependencies System.Object
namespace UnityEngine::Timeline {
// Is value type: false
// CS Name: UnityEngine.Timeline.ControlPlayableAsset/<GetControlableScripts>d__40
class CORDL_TYPE ControlPlayableAsset__GetControlableScripts_d__40 : public ::System::Object {
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_UnityEngine_MonoBehaviour__get_Current)) ::UnityW<::UnityEngine::MonoBehaviour>  System_Collections_Generic_IEnumerator_UnityEngine_MonoBehaviour__Current;
...
/// @brief Field <>7__wrap1, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get___7__wrap1, put=__cordl_internal_set___7__wrap1)) ::ArrayW<::UnityW<::UnityEngine::MonoBehaviour>,::Array<::UnityW<::UnityEngine::MonoBehaviour>>*>  __7__wrap1;
...
/// @brief Method MoveNext, addr 0x68803fc, size 0x144, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.MonoBehaviour>.GetEnumerator, addr 0x6880588, size 0x98, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.MonoBehaviour>.get_Current, addr 0x6880540, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::MonoBehaviour> System_Collections_Generic_IEnumerator_UnityEngine_MonoBehaviour__get_Current() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6880620, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x6880548, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6880580, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x68803f8, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x687ec0c, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr ControlPlayableAsset__GetControlableScripts_d__40() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "ControlPlayableAsset__GetControlableScripts_d__40", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
ControlPlayableAsset__GetControlableScripts_d__40(ControlPlayableAsset__GetControlableScripts_d__40 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "ControlPlayableAsset__GetControlableScripts_d__40", modifiers: "const&", def_value: None }]
...
static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, ___root) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____3__root) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____7__wrap1) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, _____7__wrap2) == 0x40, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40, 0x48>, "Size mismatch!");

} // namespace end def UnityEngine::Timeline
// Dependencies UnityEngine.ExposedReference`1<T>, UnityEngine.Playables.PlayableAsset, UnityEngine.Timeline.ActivationControlPlayable::PostPlaybackState, UnityEngine.Timeline.DirectorControlPlayable::PauseAction
namespace UnityEngine::Timeline {
// Is value type: false
...
public:
// Declarations
using _GetControlableScripts_d__40 = ::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40;

/// @brief Field <controllingDirectors>k__BackingField, offset 0x59, size 0x1 
...
/// @brief Field <controllingParticles>k__BackingField, offset 0x5a, size 0x1 
...
/// @brief Field directorOnClipEnd, offset 0x40, size 0x4 
 __declspec(property(get=__cordl_internal_get_directorOnClipEnd, put=__cordl_internal_set_directorOnClipEnd)) ::UnityEngine::Timeline::DirectorControlPlayable_PauseAction  directorOnClipEnd;

 __declspec(property(get=get_duration)) double_t  duration;

/// @brief Field k_EmptyDirectorsList, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_EmptyDirectorsList, put=setStaticF_k_EmptyDirectorsList)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Playables::PlayableDirector>>*  k_EmptyDirectorsList;

/// @brief Field k_EmptyParticlesList, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_k_EmptyParticlesList, put=setStaticF_k_EmptyParticlesList)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::ParticleSystem>>*  k_EmptyParticlesList;

/// @brief Field m_ControlDirectorAsset, offset 0x48, size 0x8 
...
/// @brief Field s_ProcessedDirectors, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ProcessedDirectors, put=setStaticF_s_ProcessedDirectors)) ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::Playables::PlayableDirector>>*  s_ProcessedDirectors;

/// @brief Field s_SubEmitterCollector, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_SubEmitterCollector, put=setStaticF_s_SubEmitterCollector)) ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::ParticleSystem>>*  s_SubEmitterCollector;
...
/// @brief Method CacheSubEmitters, addr 0x687ee38, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method ConnectMixerAndPlayable, addr 0x687e8ac, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ConnectPlayablesToMixer, addr 0x687e72c, size 0x180, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::Playable ConnectPlayablesToMixer(::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::List_1<::UnityEngine::Playables::Playable>*  playables) ;

/// @brief Method CreateActivationPlayable, addr 0x687d874, size 0x164, virtual false, abstract: false, final false
inline void CreateActivationPlayable(::UnityEngine::GameObject*  root, ::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::List_1<::UnityEngine::Playables::Playable>*  outplayables) ;

/// @brief Method CreatePlayable, addr 0x687c58c, size 0x8a0, virtual true, abstract: false, final false
inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::GameObject*  go) ;

/// @brief Method GatherProperties, addr 0x687ef4c, size 0x318, virtual true, abstract: false, final true
...
template<typename T>
inline ::System::Collections::Generic::IList_1<T>* GetComponent(::UnityEngine::GameObject*  gameObject) ;

/// @brief Method GetControlableScripts, addr 0x687e2b0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method GetControllableParticleSystems, addr 0x687ce2c, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method GetControllableParticleSystems, addr 0x687ec38, size 0x200, virtual false, abstract: false, final false
static inline void GetControllableParticleSystems(::UnityEngine::Transform*  t, ::System::Collections::Generic::ICollection_1<::UnityW<::UnityEngine::ParticleSystem>>*  roots, ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::ParticleSystem>>*  subEmitters) ;

static inline ::UnityEngine::Timeline::ControlPlayableAsset* New_ctor() ;

/// @brief Method OnEnable, addr 0x687c524, size 0x54, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PreviewActivation, addr 0x687f6a0, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method PreviewDirectors, addr 0x687fdec, size 0x3ac, virtual false, abstract: false, final false
static inline void PreviewDirectors(::UnityEngine::Timeline::IPropertyCollector*  driver, ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Playables::PlayableDirector>>*  directors) ;

/// @brief Method PreviewParticles, addr 0x687f264, size 0x43c, virtual false, abstract: false, final false
...
/// @brief Method PreviewTimeControl, addr 0x687f9f0, size 0x3fc, virtual false, abstract: false, final false
static inline void PreviewTimeControl(::UnityEngine::Timeline::IPropertyCollector*  driver, ::UnityEngine::Playables::PlayableDirector*  director, ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::MonoBehaviour>>*  scripts) ;

/// @brief Method SearchHierarchyAndConnectControlableScripts, addr 0x687e320, size 0x40c, virtual false, abstract: false, final false
static inline void SearchHierarchyAndConnectControlableScripts(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::MonoBehaviour>>*  controlableScripts, ::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::List_1<::UnityEngine::Playables::Playable>*  outplayables) ;

/// @brief Method SearchHierarchyAndConnectDirector, addr 0x687d9d8, size 0x4c0, virtual false, abstract: false, final false
inline void SearchHierarchyAndConnectDirector(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Playables::PlayableDirector>>*  directors, ::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::List_1<::UnityEngine::Playables::Playable>*  outplayables, bool  disableSelfReferences) ;

/// @brief Method SearchHierarchyAndConnectParticleSystem, addr 0x687de98, size 0x418, virtual false, abstract: false, final false
inline void SearchHierarchyAndConnectParticleSystem(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::ParticleSystem>>*  particleSystems, ::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::List_1<::UnityEngine::Playables::Playable>*  outplayables) ;

/// @brief Method UpdateDurationAndLoopFlag, addr 0x687cfb0, size 0x8c4, virtual false, abstract: false, final false
inline void UpdateDurationAndLoopFlag(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::Playables::PlayableDirector>>*  directors, ::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::ParticleSystem>>*  particleSystems) ;
...
constexpr ::UnityEngine::Timeline::DirectorControlPlayable_PauseAction const& __cordl_internal_get_directorOnClipEnd() const;

constexpr ::UnityEngine::Timeline::DirectorControlPlayable_PauseAction& __cordl_internal_get_directorOnClipEnd() ;
...
constexpr void __cordl_internal_set_directorOnClipEnd(::UnityEngine::Timeline::DirectorControlPlayable_PauseAction  value) ;
...
/// @brief Method .ctor, addr 0x6880198, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_clipCaps, addr 0x687c580, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method get_controllingDirectors, addr 0x687c504, size 0x8, virtual false, abstract: false, final false
inline bool get_controllingDirectors() ;

/// @brief Method get_controllingParticles, addr 0x687c514, size 0x8, virtual false, abstract: false, final false
inline bool get_controllingParticles() ;

/// @brief Method get_duration, addr 0x687c578, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_controllingDirectors, addr 0x687c50c, size 0x8, virtual false, abstract: false, final false
inline void set_controllingDirectors(bool  value) ;

/// @brief Method set_controllingParticles, addr 0x687c51c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field directorOnClipEnd, offset: 0x40, size: 0x4, def value: None
 ::UnityEngine::Timeline::DirectorControlPlayable_PauseAction  ___directorOnClipEnd;

/// @brief Field m_ControlDirectorAsset, offset: 0x48, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Playables::PlayableAsset>  ___m_ControlDirectorAsset;

/// @brief Field m_Duration, offset: 0x50, size: 0x8, def value: None
 double_t  ___m_Duration;

/// @brief Field m_SupportLoop, offset: 0x58, size: 0x1, def value: None
 bool  ___m_SupportLoop;

/// @brief Field <controllingDirectors>k__BackingField, offset: 0x59, size: 0x1, def value: None
 bool  ____controllingDirectors_k__BackingField;

/// @brief Field <controllingParticles>k__BackingField, offset: 0x5a, size: 0x1, def value: None
...
static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ___directorOnClipEnd) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ___m_ControlDirectorAsset) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ___m_Duration) == 0x50, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ___m_SupportLoop) == 0x58, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ____controllingDirectors_k__BackingField) == 0x59, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::Timeline::ControlPlayableAsset, ____controllingParticles_k__BackingField) == 0x5a, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::Timeline::ControlPlayableAsset, 0x60>, "Size mismatch!");
...
NEED_NO_BOX(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::ControlPlayableAsset__GetControlableScripts_d__40*, "UnityEngine.Timeline", "ControlPlayableAsset/<GetControlableScripts>d__40");
