...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Timeline::ClipCaps (::UnityEngine::Timeline::ITimelineClipAsset::*)()>(&::UnityEngine::Timeline::ITimelineClipAsset::get_clipCaps)> {
