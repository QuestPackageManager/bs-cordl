...
public:
  ...
  /// @brief Method HasAny, addr 0x480fe24, size 0x74, virtual false, abstract: false, final false
  static inline bool HasAny(::UnityEngine::Timeline::MatchTargetFields me, ::UnityEngine::Timeline::MatchTargetFields fields);

  /// @brief Method Toggle, addr 0x480fe98, size 0x8, virtual false, abstract: false, final false
