...
public:
  ...
  /// @brief Method HasAny, addr 0x68687bc, size 0x78, virtual false, abstract: false, final false
  static inline bool HasAny(::UnityEngine::Timeline::MatchTargetFields me, ::UnityEngine::Timeline::MatchTargetFields fields);

  /// @brief Method Toggle, addr 0x6868834, size 0x8, virtual false, abstract: false, final false
