...
// Write type traits
MARK_REF_T(::UnityEngine::Timeline::TimeControlPlayable*);
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::TimeControlPlayable*, "UnityEngine.Timeline", "TimeControlPlayable");
...
public:
  ...
  /// @brief Method Create, addr 0x69ca0c0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x69ca1c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x69ca384, size 0xb4, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x69ca2cc, size 0xb8, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method PrepareFrame, addr 0x69ca1d0, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69ca438, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeControlPlayable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeControlPlayable(TimeControlPlayable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeControlPlayable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeControlPlayable(TimeControlPlayableconst&) = delete;
...
static_assert(sizeof(::UnityEngine::Timeline::TimeControlPlayable) == 0x20, "Size mismatch!");
