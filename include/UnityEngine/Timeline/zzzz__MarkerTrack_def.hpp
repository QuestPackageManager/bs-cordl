...
public:
  ...
  /// @brief Method .ctor, addr 0x33c7428, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_outputs, addr 0x33c7244, size 0x1e4, virtual true, abstract: false, final false
