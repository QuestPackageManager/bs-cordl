...
public:
  ...
  /// @brief Method .ctor, addr 0x680e284, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_outputs, addr 0x680e0bc, size 0x1c8, virtual true, abstract: false, final false
