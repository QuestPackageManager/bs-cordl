...
/// @brief Method .ctor, addr 0x680d594, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_duration, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline double_t get_duration() ;

/// @brief Method get_intervalEnd, addr 0x680dc10, size 0x88, virtual true, abstract: false, final false
inline int64_t get_intervalEnd() ;

/// @brief Method get_intervalStart, addr 0x680db9c, size 0x74, virtual true, abstract: false, final false
