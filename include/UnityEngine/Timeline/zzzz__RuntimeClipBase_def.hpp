...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14155))}
...
public:
  ...
  /// @brief Method get_intervalStart addr 0x2ae425c size 0x70 virtual true final false
  inline int64_t get_intervalStart();

  /// @brief Method get_intervalEnd addr 0x2ae42cc size 0x84 virtual true final false
  inline int64_t get_intervalEnd();

  static inline ::UnityEngine::Timeline::RuntimeClipBase* New_ctor();

  /// @brief Method .ctor addr 0x2ae3c7c size 0x8 virtual false final false
  inline void _ctor();
