...
public:
  ...
  /// @brief Method get_intervalStart, addr 0x2c67fb0, size 0x70, virtual true, abstract: false, final false
  inline int64_t get_intervalStart();

  /// @brief Method get_intervalEnd, addr 0x2c68020, size 0x84, virtual true, abstract: false, final false
  inline int64_t get_intervalEnd();

  static inline ::UnityEngine::Timeline::RuntimeClipBase* New_ctor();

  /// @brief Method .ctor, addr 0x2c679d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
