...
public:
  ...
  /// @brief Method get_markers addr 0x2ae4a90 size 0x18 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::Timeline::IMarker*>* get_markers();

  /// @brief Method .ctor addr 0x2add60c size 0xd4 virtual false final false
  inline void _ctor(int32_t capacity);

  /// @brief Method Add addr 0x2ada190 size 0xec virtual false final false
  inline void Add(::UnityEngine::ScriptableObject* item);

  /// @brief Method Remove addr 0x2ad9144 size 0x1e4 virtual false final false
  inline bool Remove(::UnityEngine::Timeline::IMarker* item);

  /// @brief Method Remove addr 0x2ada2b0 size 0xc0 virtual false final false
  ...
  /// @brief Method Clear addr 0x2ada118 size 0x70 virtual false final false
  inline void Clear();

  /// @brief Method Contains addr 0x2ae4d80 size 0x58 virtual false final false
  inline bool Contains(::UnityEngine::ScriptableObject* item);

  /// @brief Method GetMarkers addr 0x2ad9328 size 0x18 virtual false final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::IMarker*>* GetMarkers();

  /// @brief Method get_Count addr 0x2ad9340 size 0x50 virtual false final false
  inline int32_t get_Count();

  /// @brief Method get_Item addr 0x2ad9398 size 0x60 virtual false final false
  inline ::UnityEngine::Timeline::IMarker* get_Item(int32_t idx);

  /// @brief Method GetRawMarkerList addr 0x2ae4dd8 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::ScriptableObject*>* GetRawMarkerList();

  /// @brief Method CreateMarker addr 0x2ad8e3c size 0x300 virtual false final false
  inline ::UnityEngine::Timeline::IMarker* CreateMarker(::System::Type* type, double_t time, ::UnityEngine::Timeline::TrackAsset* owner);

  /// @brief Method HasNotifications addr 0x2add5f4 size 0x18 virtual false final false
  inline bool HasNotifications();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize addr 0x2ae4de0 size 0x4 virtual true final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize addr 0x2ae4de4 size 0xc virtual true final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method BuildCache addr 0x2ae4aa8 size 0x2d8 virtual false final false
