...
namespace UnityEngine::Timeline {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14177))}
...
public:
  ...
  /// @brief Method get_triggerInEditor addr 0x2aea6fc size 0xc virtual false final false
  inline bool get_triggerInEditor();

  /// @brief Method get_prewarm addr 0x2aea6f0 size 0xc virtual false final false
  inline bool get_prewarm();

  /// @brief Method get_triggerOnce addr 0x2ae9e2c size 0xc virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2aea7e8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortNotifications>b__12_0 addr 0x2aea7f0 size 0x10 virtual false final false
...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10347)), TypeDefinitionIndex(TypeDefinitionIndex(10350))}
...
public:
  ...
  /// @brief Method set_timeSource addr 0x2ae993c size 0x8 virtual false final false
  inline void set_timeSource(::UnityEngine::Playables::Playable value);

  /// @brief Method Create addr 0x2ae9944 size 0x11c virtual false final false
  ...
  /// @brief Method AddNotification addr 0x2ae9a60 size 0xf8 virtual false final false
  ...
  /// @brief Method OnGraphStart addr 0x2ae9b58 size 0x1c4 virtual true final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnBehaviourPause addr 0x2ae9e38 size 0x1ac virtual true final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method PrepareFrame addr 0x2aea06c size 0x35c virtual true final false
  inline void PrepareFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method SortNotifications addr 0x2ae9d1c size 0x110 virtual false final false
  inline void SortNotifications();

  /// @brief Method CanRestoreNotification addr 0x2aea68c size 0x5c virtual false final false
  ...
  /// @brief Method TriggerNotificationsInRange addr 0x2aea4cc size 0x1c0 virtual false final false
  ...
  /// @brief Method SyncDurationWithExternalSource addr 0x2aea3c8 size 0x104 virtual false final false
  inline void SyncDurationWithExternalSource(::UnityEngine::Playables::Playable playable);

  /// @brief Method Trigger_internal addr 0x2ae9fe4 size 0x88 virtual false final false
  ...
  /// @brief Method Restore_internal addr 0x2aea6e8 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2aea708 size 0x7c virtual false final false
  inline void _ctor();
