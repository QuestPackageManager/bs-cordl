...
public:
  ...
  /// @brief Method Create, addr 0x482898c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x4828acc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x4828f1c, size 0xc, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x4828f10, size 0xc, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method PrepareFrame, addr 0x4828c98, size 0x1b4, virtual true, abstract: false, final false
  inline void PrepareFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData data);

  /// @brief Method SetRandomSeed, addr 0x4828b5c, size 0x13c, virtual false, abstract: false, final false
  static inline void SetRandomSeed(::UnityEngine::ParticleSystem* particleSystem, uint32_t randomSeed);

  /// @brief Method Simulate, addr 0x4828e4c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4828f28, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_particleSystem, addr 0x4828b4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ParticleSystem> get_particleSystem();

  /// @brief Method set_particleSystem, addr 0x4828b54, size 0x8, virtual false, abstract: false, final false
