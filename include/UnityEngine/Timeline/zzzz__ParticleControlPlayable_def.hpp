...
public:
  ...
  /// @brief Method Create, addr 0x482ce80, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x482cfc0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBehaviourPause, addr 0x482d410, size 0xc, virtual true, abstract: false, final false
  inline void OnBehaviourPause(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnBehaviourPlay, addr 0x482d404, size 0xc, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method PrepareFrame, addr 0x482d18c, size 0x1b4, virtual true, abstract: false, final false
  inline void PrepareFrame(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData data);

  /// @brief Method SetRandomSeed, addr 0x482d050, size 0x13c, virtual false, abstract: false, final false
  static inline void SetRandomSeed(::UnityEngine::ParticleSystem* particleSystem, uint32_t randomSeed);

  /// @brief Method Simulate, addr 0x482d340, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x482d41c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_particleSystem, addr 0x482d040, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::ParticleSystem> get_particleSystem();

  /// @brief Method set_particleSystem, addr 0x482d048, size 0x8, virtual false, abstract: false, final false
