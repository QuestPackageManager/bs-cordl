...
public:
  ...
  /// @brief Method OnInitialize, addr 0x6880448, size 0x4, virtual true, abstract: false, final false
  inline void OnInitialize(::UnityEngine::Timeline::TrackAsset* aPent);

  /// @brief Method UnityEngine.Timeline.IMarker.Initialize, addr 0x68802f0, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x688044c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_parent, addr 0x6880258, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> get_parent();

  /// @brief Method get_time, addr 0x6880268, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_parent, addr 0x6880260, size 0x8, virtual false, abstract: false, final false
  inline void set_parent(::UnityEngine::Timeline::TrackAsset* value);

  /// @brief Method set_time, addr 0x6880270, size 0x80, virtual true, abstract: false, final true
