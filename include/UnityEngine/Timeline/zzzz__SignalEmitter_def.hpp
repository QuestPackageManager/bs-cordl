...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14159))}
...
public:
  ...
  /// @brief Method get_retroactive addr 0x2ae523c size 0x8 virtual false final false
  inline bool get_retroactive();

  /// @brief Method set_retroactive addr 0x2ae5244 size 0xc virtual false final false
  inline void set_retroactive(bool value);

  /// @brief Method get_emitOnce addr 0x2ae5250 size 0x8 virtual false final false
  inline bool get_emitOnce();

  /// @brief Method set_emitOnce addr 0x2ae5258 size 0xc virtual false final false
  inline void set_emitOnce(bool value);

  /// @brief Method get_asset addr 0x2ae5264 size 0x8 virtual false final false
  inline ::UnityEngine::Timeline::SignalAsset* get_asset();

  /// @brief Method set_asset addr 0x2ae526c size 0x8 virtual false final false
  inline void set_asset(::UnityEngine::Timeline::SignalAsset* value);

  /// @brief Method UnityEngine.Playables.INotification.get_id addr 0x2ae5274 size 0xc0 virtual true final true
  inline ::UnityEngine::PropertyName UnityEngine_Playables_INotification_get_id();

  /// @brief Method UnityEngine.Timeline.INotificationOptionProvider.get_flags addr 0x2ae5334 size 0x1c virtual true final true
  ...
  /// @brief Method .ctor addr 0x2ae5350 size 0x8 virtual false final false
  inline void _ctor();
