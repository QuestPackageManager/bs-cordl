...
/// @brief Method UnityEngine.Playables.INotification.get_id, addr 0x6882790, size 0x90, virtual true, abstract: false, final true
inline ::UnityEngine::PropertyName UnityEngine_Playables_INotification_get_id() ;

/// @brief Method UnityEngine.Timeline.INotificationOptionProvider.get_flags, addr 0x6882820, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x688283c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_asset, addr 0x6882780, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Timeline::SignalAsset> get_asset() ;

/// @brief Method get_emitOnce, addr 0x6882770, size 0x8, virtual false, abstract: false, final false
inline bool get_emitOnce() ;

/// @brief Method get_retroactive, addr 0x6882760, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_asset, addr 0x6882788, size 0x8, virtual false, abstract: false, final false
inline void set_asset(::UnityEngine::Timeline::SignalAsset*  value) ;

/// @brief Method set_emitOnce, addr 0x6882778, size 0x8, virtual false, abstract: false, final false
inline void set_emitOnce(bool  value) ;

/// @brief Method set_retroactive, addr 0x6882768, size 0x8, virtual false, abstract: false, final false
