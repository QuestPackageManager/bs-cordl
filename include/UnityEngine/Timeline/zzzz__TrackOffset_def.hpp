...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::TrackOffset, "UnityEngine.Timeline", "TrackOffset");
// Dependencies
namespace UnityEngine::Timeline {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Timeline::TrackOffset) == 0x4, "Size mismatch!");
