...
public:
  ...
  /// @brief Method <SortClipsByStartTime>b__2_0, addr 0x6887908, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6887904, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateExtrapolationTimes, addr 0x688732c, size 0x3ac, virtual false, abstract: false, final false
  static inline void CalculateExtrapolationTimes(::UnityEngine::Timeline::TrackAsset* asset);

  /// @brief Method SortClipsByStartTime, addr 0x68876d8, size 0x14c, virtual false, abstract: false, final false
