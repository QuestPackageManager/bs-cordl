...
public:
  ...
  /// @brief Method <SortClipsByStartTime>b__2_0, addr 0x33ce2b8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33ce2b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateExtrapolationTimes, addr 0x33cdc80, size 0x40c, virtual false, abstract: false, final false
  static inline void CalculateExtrapolationTimes(::UnityEngine::Timeline::TrackAsset* asset);

  /// @brief Method SortClipsByStartTime, addr 0x33ce08c, size 0x13c, virtual false, abstract: false, final false
