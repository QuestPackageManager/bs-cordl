...
public:
  ...
  /// @brief Method <SortClipsByStartTime>b__2_0, addr 0x681523c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6815238, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateExtrapolationTimes, addr 0x6814c60, size 0x3ac, virtual false, abstract: false, final false
  static inline void CalculateExtrapolationTimes(::UnityEngine::Timeline::TrackAsset* asset);

  /// @brief Method SortClipsByStartTime, addr 0x681500c, size 0x14c, virtual false, abstract: false, final false
