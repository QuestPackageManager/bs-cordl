...
public:
  ...
  /// @brief Method .ctor, addr 0x4832144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intervalBit, addr 0x4832aac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_intervalBit, addr 0x4832ab4, size 0x8, virtual false, abstract: false, final false
