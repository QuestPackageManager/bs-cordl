...
public:
  ...
  /// @brief Method .ctor, addr 0x3193064, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intervalBit, addr 0x31939cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_intervalBit, addr 0x31939d4, size 0x8, virtual false, abstract: false, final false
