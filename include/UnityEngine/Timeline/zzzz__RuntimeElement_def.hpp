...
public:
  ...
  /// @brief Method .ctor, addr 0x2dacbb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intervalBit, addr 0x2dad51c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_intervalBit, addr 0x2dad524, size 0x8, virtual false, abstract: false, final false
