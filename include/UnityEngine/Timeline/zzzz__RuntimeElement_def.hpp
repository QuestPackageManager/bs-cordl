...
public:
  ...
  /// @brief Method .ctor, addr 0x687f2ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intervalBit, addr 0x687fca4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_intervalBit, addr 0x687fcac, size 0x8, virtual false, abstract: false, final false
