...
public:
  ...
  /// @brief Method OnEnable, addr 0x33d64a0, size 0x6c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x33d650c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnEnableCallback, addr 0x33d6308, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnEnableCallback, addr 0x33d63d4, size 0xcc, virtual false, abstract: false, final false
