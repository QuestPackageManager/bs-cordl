...
public:
  // Declarations
  /// @brief Method CreateNotificationsPlayable, addr 0x33ce4b0, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TrackTypeSupportsNotifications, addr 0x33ceb90, size 0x18c, virtual false, abstract: false, final false
