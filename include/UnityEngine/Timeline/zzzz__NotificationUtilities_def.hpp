...
public:
  // Declarations
  /// @brief Method CreateNotificationsPlayable, addr 0x319c6d8, size 0x6e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TrackTypeSupportsNotifications, addr 0x319cdb8, size 0x18c, virtual false, abstract: false, final false
