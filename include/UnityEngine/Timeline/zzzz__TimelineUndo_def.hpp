...
public:
  // Declarations
  /// @brief Method PushDestroyUndo, addr 0x68894d4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method PushUndo, addr 0x6889564, size 0x4, virtual false, abstract: false, final false
  static inline void PushUndo(::UnityEngine::Object* thingToDirty, ::StringW operation);

  /// @brief Method PushUndo, addr 0x6889560, size 0x4, virtual false, abstract: false, final false
  static inline void PushUndo(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> thingsToDirty, ::StringW operation);

  /// @brief Method RegisterCreatedObjectUndo, addr 0x6889568, size 0x4, virtual false, abstract: false, final false
  static inline void RegisterCreatedObjectUndo(::UnityEngine::Object* thingCreated, ::StringW operation);

  /// @brief Method UndoName, addr 0x688956c, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW UndoName(::StringW name);

  /// @brief Method get_undoEnabled, addr 0x68894cc, size 0x8, virtual false, abstract: false, final false
