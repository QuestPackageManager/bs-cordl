...
DEFINE_IL2CPP_CLASS(::UnityEngine::Timeline::StandardFrameRates, "UnityEngine.Timeline", "StandardFrameRates");
// Dependencies
namespace UnityEngine::Timeline {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::Timeline::StandardFrameRates) == 0x4, "Size mismatch!");
