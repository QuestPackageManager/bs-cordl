...
public:
  // Declarations
  /// @brief Method ConvertRotationToEuler, addr 0x2c50590, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2c4fd34, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2c5072c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2c50730, size 0x90, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x2c507c0, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2c507d0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2c50810, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x2c50870, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2c50914, size 0x4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_position, addr 0x2c4f904, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_position();

  /// @brief Method set_position, addr 0x2c4f910, size 0xc, virtual false, abstract: false, final false
  inline void set_position(::UnityEngine::Vector3 value);

  /// @brief Method get_rotation, addr 0x2c4f91c, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_rotation();

  /// @brief Method set_rotation, addr 0x2c4f940, size 0x3c, virtual false, abstract: false, final false
  inline void set_rotation(::UnityEngine::Quaternion value);

  /// @brief Method get_eulerAngles, addr 0x2c4f97c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_eulerAngles();

  /// @brief Method set_eulerAngles, addr 0x2c4f988, size 0xc, virtual false, abstract: false, final false
  inline void set_eulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method get_useTrackMatchFields, addr 0x2c4f994, size 0x8, virtual false, abstract: false, final false
  inline bool get_useTrackMatchFields();

  /// @brief Method set_useTrackMatchFields, addr 0x2c4f99c, size 0xc, virtual false, abstract: false, final false
  inline void set_useTrackMatchFields(bool value);

  /// @brief Method get_matchTargetFields, addr 0x2c4f9a8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::MatchTargetFields get_matchTargetFields();

  /// @brief Method set_matchTargetFields, addr 0x2c4f9b0, size 0x8, virtual false, abstract: false, final false
  inline void set_matchTargetFields(::UnityEngine::Timeline::MatchTargetFields value);

  /// @brief Method get_removeStartOffset, addr 0x2c4f9b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_removeStartOffset();

  /// @brief Method set_removeStartOffset, addr 0x2c4f9c0, size 0xc, virtual false, abstract: false, final false
  inline void set_removeStartOffset(bool value);

  /// @brief Method get_applyFootIK, addr 0x2c4f9cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_applyFootIK();

  /// @brief Method set_applyFootIK, addr 0x2c4f9d4, size 0xc, virtual false, abstract: false, final false
  inline void set_applyFootIK(bool value);

  /// @brief Method get_loop, addr 0x2c4f9e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::__AnimationPlayableAsset__LoopMode get_loop();

  /// @brief Method set_loop, addr 0x2c4f9e8, size 0x8, virtual false, abstract: false, final false
  inline void set_loop(::UnityEngine::Timeline::__AnimationPlayableAsset__LoopMode value);

  /// @brief Method get_hasRootTransforms, addr 0x2c4f9f0, size 0xa4, virtual false, abstract: false, final false
  inline bool get_hasRootTransforms();

  /// @brief Method get_appliedOffsetMode, addr 0x2c4fb60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::AppliedOffsetMode get_appliedOffsetMode();

  /// @brief Method set_appliedOffsetMode, addr 0x2c4fb68, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_duration, addr 0x2c4fc38, size 0x84, virtual true, abstract: false, final false
  inline double_t get_duration();

  /// @brief Method get_outputs, addr 0x2c4fcbc, size 0x78, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method CreatePlayable, addr 0x2c4fd68, size 0xd8, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreatePlayable, addr 0x2c4fe40, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldApplyOffset, addr 0x2c50228, size 0x74, virtual false, abstract: false, final false
  static inline bool ShouldApplyOffset(::UnityEngine::Timeline::AppliedOffsetMode mode, ::UnityEngine::AnimationClip* clip);

  /// @brief Method ShouldApplyScaleRemove, addr 0x2c50208, size 0x20, virtual false, abstract: false, final false
  static inline bool ShouldApplyScaleRemove(::UnityEngine::Timeline::AppliedOffsetMode mode);

  /// @brief Method get_clipCaps, addr 0x2c5029c, size 0xe8, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method ResetOffsets, addr 0x2c50384, size 0x6c, virtual false, abstract: false, final false
  inline void ResetOffsets();

  /// @brief Method GatherProperties, addr 0x2c503f0, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method HasRootTransforms, addr 0x2c4fa94, size 0xcc, virtual false, abstract: false, final false
  static inline bool HasRootTransforms(::UnityEngine::AnimationClip* clip);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x2c5049c, size 0x60, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x2c504fc, size 0x84, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method OnUpgradeFromVersion, addr 0x2c50580, size 0x10, virtual false, abstract: false, final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  static inline ::UnityEngine::Timeline::AnimationPlayableAsset* New_ctor();

  /// @brief Method .ctor, addr 0x2c505dc, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
