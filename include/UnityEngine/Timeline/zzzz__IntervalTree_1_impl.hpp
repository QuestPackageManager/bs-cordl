...
#include "UnityEngine/Timeline/zzzz__IntervalTree_1_def.hpp"
// Ctor Parameters [CppParam { name: "intervalStart", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "intervalEnd", ty: "int64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "item", ty: "T", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
