...
public:
  // Declarations
  /// @brief Method Create, addr 0x2c6151c, size 0x10c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2c5c02c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2c61628, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2c6162c, size 0x244, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x2c61870, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2c61880, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2c618c0, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x2c61920, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2c619c4, size 0x4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method .ctor, addr 0x2c61a2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SortClips>b__121_0, addr 0x2c61a34, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnBeforeTrackSerialize, addr 0x2c5b320, size 0x4, virtual true, abstract: false, final false
  inline void OnBeforeTrackSerialize();

  /// @brief Method OnAfterTrackDeserialize, addr 0x2c5b324, size 0x4, virtual true, abstract: false, final false
  inline void OnAfterTrackDeserialize();

  /// @brief Method OnUpgradeFromVersion, addr 0x2c5b328, size 0x4, virtual true, abstract: false, final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x2c5b32c, size 0x15c, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x2c5b488, size 0x3bc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UpgradeToLatestVersion, addr 0x2c5b8cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_end, addr 0x2c593e0, size 0x60, virtual false, abstract: false, final false
  inline double_t get_end();

  /// @brief Method get_duration, addr 0x2c5be28, size 0x60, virtual true, abstract: false, final true
  inline double_t get_duration();

  /// @brief Method get_muted, addr 0x2c5be90, size 0x8, virtual false, abstract: false, final false
  inline bool get_muted();

  /// @brief Method set_muted, addr 0x2c5be98, size 0xc, virtual false, abstract: false, final false
  inline void set_muted(bool value);

  /// @brief Method get_mutedInHierarchy, addr 0x2c590b4, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetClips, addr 0x2c54c78, size 0x4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::TimelineClip*>* GetClips();

  /// @brief Method get_clips, addr 0x2c510ac, size 0xb0, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Timeline::TimelineClip*, ::Array<::UnityEngine::Timeline::TimelineClip*>*> get_clips();

  /// @brief Method get_isEmpty, addr 0x2c5beb4, size 0x6c, virtual true, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method get_hasClips, addr 0x2c4ed70, size 0x54, virtual false, abstract: false, final false
  inline bool get_hasClips();

  /// @brief Method get_hasCurves, addr 0x2c5bf20, size 0x8c, virtual true, abstract: false, final true
  inline bool get_hasCurves();

  /// @brief Method get_isSubTrack, addr 0x2c519e0, size 0x120, virtual false, abstract: false, final false
  inline bool get_isSubTrack();

  /// @brief Method get_outputs, addr 0x2c5bfb4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method set_customPlayableTypename, addr 0x2c5c274, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName, addr 0x2c5c28c, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method set_locked, addr 0x2c5c2e8, size 0xc, virtual false, abstract: false, final false
  inline void set_locked(bool value);

  /// @brief Method get_lockedInHierarchy, addr 0x2c5c2f4, size 0x18c, virtual false, abstract: false, final false
  inline bool get_lockedInHierarchy();

  /// @brief Method get_supportsNotifications, addr 0x2c5c480, size 0xb4, virtual false, abstract: false, final false
  inline bool get_supportsNotifications();

  /// @brief Method __internalAwake, addr 0x2c5c534, size 0xcc, virtual false, abstract: false, final false
  inline void __internalAwake();

  /// @brief Method CreateCurves, addr 0x2c5c600, size 0xb4, virtual true, abstract: false, final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method CreateTrackMixer, addr 0x2c5c6b4, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePlayable, addr 0x2c5c724, size 0x50, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreateDefaultClip, addr 0x2c5c774, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteClip, addr 0x2c5ca70, size 0x114, virtual false, abstract: false, final false
  inline bool DeleteClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method CreateMarker, addr 0x2c5cb84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteMarker, addr 0x2c5ce90, size 0x8, virtual false, abstract: false, final false
  inline bool DeleteMarker(::UnityEngine::Timeline::IMarker* marker);

  /// @brief Method GetMarkers, addr 0x2c5b8d0, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::IMarker*>* GetMarkers();

  /// @brief Method GetMarkerCount, addr 0x2c5bfac, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetMarkerCount();

  /// @brief Method GetMarker, addr 0x2c5d0e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::IMarker* GetMarker(int32_t idx);

  /// @brief Method CreateClip, addr 0x2c5d14c, size 0x130, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClip(::System::Type* requestedType);

  /// @brief Method CreateAndAddNewClipOfType, addr 0x2c5ca40, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateAndAddNewClipOfType(::System::Type* requestedType);

  /// @brief Method CreateClipOfType, addr 0x2c5d4fc, size 0x1e0, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipOfType(::System::Type* requestedType);

  /// @brief Method CreateClipFromPlayableAsset, addr 0x2c5d97c, size 0x284, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipFromPlayableAsset(::UnityEngine::Playables::IPlayableAsset* asset);

  /// @brief Method CreateClipFromAsset, addr 0x2c5d6dc, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMarker, addr 0x2c5dedc, size 0x8, virtual false, abstract: false, final false
  inline void AddMarker(::UnityEngine::ScriptableObject* e);

  /// @brief Method DeleteMarkerRaw, addr 0x2c5dfd0, size 0x34, virtual false, abstract: false, final false
  inline bool DeleteMarkerRaw(::UnityEngine::ScriptableObject* marker);

  /// @brief Method GetTimeRangeHash, addr 0x2c5e0c4, size 0x314, virtual false, abstract: false, final false
  inline int32_t GetTimeRangeHash();

  /// @brief Method AddClip, addr 0x2c55c38, size 0xd4, virtual false, abstract: false, final false
  inline void AddClip(::UnityEngine::Timeline::TimelineClip* newClip);

  /// @brief Method CreateNotificationsPlayable, addr 0x2c5e3d8, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayableGraph, addr 0x2c5ea28, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileClips, addr 0x2c5f0fc, size 0x428, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateMixerPlayableGraph, addr 0x2c5fa88, size 0x5a8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConfigureTrackAnimation, addr 0x2c5f524, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method SortClips, addr 0x2c60030, size 0x128, virtual false, abstract: false, final false
  inline void SortClips();

  /// @brief Method ClearClipsInternal, addr 0x2c60158, size 0x78, virtual false, abstract: false, final false
  inline void ClearClipsInternal();

  /// @brief Method ClearSubTracksInternal, addr 0x2c601d0, size 0x78, virtual false, abstract: false, final false
  inline void ClearSubTracksInternal();

  /// @brief Method OnClipMove, addr 0x2c558bc, size 0x8, virtual false, abstract: false, final false
  inline void OnClipMove();

  /// @brief Method CreateNewClipContainerInternal, addr 0x2c5dc00, size 0x25c, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateNewClipContainerInternal();

  /// @brief Method AddChild, addr 0x2c5a720, size 0x104, virtual false, abstract: false, final false
  inline void AddChild(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method MoveLastTrackBefore, addr 0x2c60248, size 0x1f0, virtual false, abstract: false, final false
  inline void MoveLastTrackBefore(::UnityEngine::Timeline::TrackAsset* asset);

  /// @brief Method RemoveSubTrack, addr 0x2c589dc, size 0x7c, virtual false, abstract: false, final false
  inline bool RemoveSubTrack(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method RemoveClip, addr 0x2c55bd8, size 0x60, virtual false, abstract: false, final false
  inline void RemoveClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method GetEvaluationTime, addr 0x2c54070, size 0x25c, virtual true, abstract: false, final false
  inline void GetEvaluationTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method GetSequenceTime, addr 0x2c543c8, size 0x10, virtual true, abstract: false, final false
  inline void GetSequenceTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method GatherProperties, addr 0x2c60454, size 0x6d4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnCreateClip, addr 0x2c4f228, size 0x4, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method UpdateDuration, addr 0x2c5bd1c, size 0x10c, virtual false, abstract: false, final false
  inline void UpdateDuration();

  /// @brief Method CalculateItemsHash, addr 0x2c51cc8, size 0x88, virtual true, abstract: false, final false
  inline int32_t CalculateItemsHash();

  /// @brief Method CreatePlayable, addr 0x2c60c90, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method Invalidate, addr 0x2c5b844, size 0x88, virtual false, abstract: false, final false
  inline void Invalidate();

  /// @brief Method GetNotificationDuration, addr 0x2c543d8, size 0x164, virtual false, abstract: false, final false
  inline double_t GetNotificationDuration();

  /// @brief Method CanCompileClips, addr 0x2c4edc4, size 0x5c, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CanCreateTrackMixer, addr 0x2c60f34, size 0x10, virtual true, abstract: false, final false
  inline bool CanCreateTrackMixer();

  /// @brief Method IsCompilable, addr 0x2c60f44, size 0x3cc, virtual false, abstract: false, final false
  inline bool IsCompilable();

  /// @brief Method UpdateChildTrackCache, addr 0x2c5c060, size 0x20c, virtual false, abstract: false, final false
  inline void UpdateChildTrackCache();

  /// @brief Method Hash, addr 0x2c61310, size 0x38, virtual true, abstract: false, final false
  inline int32_t Hash();

  /// @brief Method GetClipsHash, addr 0x2c60b28, size 0x168, virtual false, abstract: false, final false
  inline int32_t GetClipsHash();

  /// @brief Method GetAnimationClipHash, addr 0x2c51bdc, size 0xec, virtual false, abstract: false, final false
  static inline int32_t GetAnimationClipHash(::UnityEngine::AnimationClip* clip);

  /// @brief Method HasNotifications, addr 0x2c60438, size 0x1c, virtual false, abstract: false, final false
  inline bool HasNotifications();

  /// @brief Method CanCompileNotifications, addr 0x2c5fa54, size 0x34, virtual false, abstract: false, final false
  inline bool CanCompileNotifications();

  /// @brief Method CanCreateMixerRecursive, addr 0x2c5ece8, size 0x334, virtual false, abstract: false, final false
  inline bool CanCreateMixerRecursive();

  static inline ::UnityEngine::Timeline::TrackAsset* New_ctor();

  /// @brief Method .ctor, addr 0x2c4f288, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
