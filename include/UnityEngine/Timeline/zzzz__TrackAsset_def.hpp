...
public:
  // Declarations
  /// @brief Method Clear, addr 0x318d940, size 0xe0, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Create, addr 0x318fe40, size 0x10c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x318ff50, size 0x244, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::Timeline::__TrackAsset___get_outputs_d__65* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.Playables.PlayableBinding>.GetEnumerator, addr 0x3190244, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Playables.PlayableBinding>.get_Current, addr 0x3190194, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x31902e8, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x31901a4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x31901e4, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x318ff4c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x318a950, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SortClips>b__121_0, addr 0x3190358, size 0x34, virtual false, abstract: false, final false
  inline int32_t _SortClips_b__121_0(::UnityEngine::Timeline::TimelineClip* clip1, ::UnityEngine::Timeline::TimelineClip* clip2);

  /// @brief Method .ctor, addr 0x3190350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddChild, addr 0x3189044, size 0x104, virtual false, abstract: false, final false
  inline void AddChild(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method AddClip, addr 0x318455c, size 0xd4, virtual false, abstract: false, final false
  inline void AddClip(::UnityEngine::Timeline::TimelineClip* newClip);

  /// @brief Method AddMarker, addr 0x318c800, size 0x8, virtual false, abstract: false, final false
  inline void AddMarker(::UnityEngine::ScriptableObject* e);

  /// @brief Method CalculateItemsHash, addr 0x31805ec, size 0x88, virtual true, abstract: false, final false
  inline int32_t CalculateItemsHash();

  /// @brief Method CanCompileClips, addr 0x317d6e8, size 0x5c, virtual true, abstract: false, final false
  inline bool CanCompileClips();

  /// @brief Method CanCompileNotifications, addr 0x318e378, size 0x34, virtual false, abstract: false, final false
  inline bool CanCompileNotifications();

  /// @brief Method CanCreateMixerRecursive, addr 0x318d60c, size 0x334, virtual false, abstract: false, final false
  inline bool CanCreateMixerRecursive();

  /// @brief Method CanCreateTrackMixer, addr 0x318f858, size 0x10, virtual true, abstract: false, final false
  inline bool CanCreateTrackMixer();

  /// @brief Method ClearClipsInternal, addr 0x318ea7c, size 0x78, virtual false, abstract: false, final false
  inline void ClearClipsInternal();

  /// @brief Method ClearMarkers, addr 0x318c788, size 0x8, virtual false, abstract: false, final false
  inline void ClearMarkers();

  /// @brief Method ClearSubTracksInternal, addr 0x318eaf4, size 0x78, virtual false, abstract: false, final false
  inline void ClearSubTracksInternal();

  /// @brief Method CompileClips, addr 0x318da20, size 0x428, virtual true, abstract: false, final false
  ...
  /// @brief Method ConfigureTrackAnimation, addr 0x318de48, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndAddNewClipOfType, addr 0x318b364, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClip, addr 0x318ba70, size 0x130, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClip(::System::Type* requestedType);

  /// @brief Method CreateClipFromAsset, addr 0x318c000, size 0x2a0, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipFromAsset(::UnityEngine::ScriptableObject* playableAsset);

  /// @brief Method CreateClipFromPlayableAsset, addr 0x318c2a0, size 0x284, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipFromPlayableAsset(::UnityEngine::Playables::IPlayableAsset* asset);

  /// @brief Method CreateClipOfType, addr 0x318be20, size 0x1e0, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateClipOfType(::System::Type* requestedType);

  /// @brief Method CreateCurves, addr 0x318af24, size 0xb4, virtual true, abstract: false, final true
  inline void CreateCurves(::StringW curvesClipName);

  /// @brief Method CreateDefaultClip, addr 0x318b098, size 0x2cc, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateDefaultClip();

  /// @brief Method CreateMarker, addr 0x318b4a8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMixerPlayableGraph, addr 0x318e3ac, size 0x5a8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateNewClipContainerInternal, addr 0x318c524, size 0x25c, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::TimelineClip* CreateNewClipContainerInternal();

  /// @brief Method CreateNotificationsPlayable, addr 0x318ccfc, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayable, addr 0x318f5b4, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePlayable, addr 0x318b048, size 0x50, virtual true, abstract: false, final true
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  /// @brief Method CreatePlayableGraph, addr 0x318d34c, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackMixer, addr 0x318afd8, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method DeleteClip, addr 0x318b394, size 0x114, virtual false, abstract: false, final false
  inline bool DeleteClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method DeleteMarker, addr 0x318b7b4, size 0x8, virtual false, abstract: false, final false
  inline bool DeleteMarker(::UnityEngine::Timeline::IMarker* marker);

  /// @brief Method DeleteMarkerRaw, addr 0x318c8f4, size 0x34, virtual false, abstract: false, final false
  inline bool DeleteMarkerRaw(::UnityEngine::ScriptableObject* marker);

  /// @brief Method GatherCompilableTracks, addr 0x318dfa4, size 0x3d4, virtual false, abstract: false, final false
  inline void GatherCompilableTracks(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* tracks);

  /// @brief Method GatherNotifications, addr 0x318cfcc, size 0x380, virtual false, abstract: false, final false
  inline void GatherNotifications(::System::Collections::Generic::List_1<::UnityEngine::Timeline::IMarker*>* markers);

  /// @brief Method GatherProperties, addr 0x318ed78, size 0x6d4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAnimationClipHash, addr 0x3180500, size 0xec, virtual false, abstract: false, final false
  static inline int32_t GetAnimationClipHash(::UnityEngine::AnimationClip* clip);

  /// @brief Method GetChildTracks, addr 0x3181ec8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>* GetChildTracks();

  /// @brief Method GetClips, addr 0x318359c, size 0x4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::TimelineClip*>* GetClips();

  /// @brief Method GetClipsHash, addr 0x318f44c, size 0x168, virtual false, abstract: false, final false
  inline int32_t GetClipsHash();

  /// @brief Method GetEvaluationTime, addr 0x3182994, size 0x25c, virtual true, abstract: false, final false
  inline void GetEvaluationTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method GetGameObjectBinding, addr 0x317d984, size 0x178, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> GetGameObjectBinding(::UnityEngine::Playables::PlayableDirector* director);

  /// @brief Method GetMarker, addr 0x318ba08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::IMarker* GetMarker(int32_t idx);

  /// @brief Method GetMarkerCount, addr 0x318a8d0, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetMarkerCount();

  /// @brief Method GetMarkers, addr 0x318a1f4, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::IMarker*>* GetMarkers();

  /// @brief Method GetMarkersRaw, addr 0x318c780, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::ScriptableObject>>* GetMarkersRaw();

  /// @brief Method GetNotificationDuration, addr 0x3182cfc, size 0x164, virtual false, abstract: false, final false
  inline double_t GetNotificationDuration();

  /// @brief Method GetSequenceTime, addr 0x3182cec, size 0x10, virtual true, abstract: false, final false
  inline void GetSequenceTime(ByRef<double_t> outStart, ByRef<double_t> outDuration);

  /// @brief Method GetTimeRangeHash, addr 0x318c9e8, size 0x314, virtual false, abstract: false, final false
  inline int32_t GetTimeRangeHash();

  /// @brief Method HasNotifications, addr 0x318ed5c, size 0x1c, virtual false, abstract: false, final false
  inline bool HasNotifications();

  /// @brief Method Hash, addr 0x318fc34, size 0x38, virtual true, abstract: false, final false
  inline int32_t Hash();

  /// @brief Method Invalidate, addr 0x318a168, size 0x88, virtual false, abstract: false, final false
  inline void Invalidate();

  /// @brief Method IsCompilable, addr 0x318f868, size 0x3cc, virtual false, abstract: false, final false
  inline bool IsCompilable();

  /// @brief Method MoveLastTrackBefore, addr 0x318eb6c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAfterTrackDeserialize, addr 0x3189c48, size 0x4, virtual true, abstract: false, final false
  inline void OnAfterTrackDeserialize();

  /// @brief Method OnBeforeTrackSerialize, addr 0x3189c44, size 0x4, virtual true, abstract: false, final false
  inline void OnBeforeTrackSerialize();

  /// @brief Method OnClipMove, addr 0x31841e0, size 0x8, virtual false, abstract: false, final false
  inline void OnClipMove();

  /// @brief Method OnCreateClip, addr 0x317db4c, size 0x4, virtual true, abstract: false, final false
  inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method OnUpgradeFromVersion, addr 0x3189c4c, size 0x4, virtual true, abstract: false, final false
  inline void OnUpgradeFromVersion(int32_t oldVersion);

  /// @brief Method RemoveClip, addr 0x31844fc, size 0x60, virtual false, abstract: false, final false
  inline void RemoveClip(::UnityEngine::Timeline::TimelineClip* clip);

  /// @brief Method RemoveSubTrack, addr 0x3187300, size 0x7c, virtual false, abstract: false, final false
  inline bool RemoveSubTrack(::UnityEngine::Timeline::TrackAsset* child);

  /// @brief Method SortClips, addr 0x318e954, size 0x128, virtual false, abstract: false, final false
  inline void SortClips();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x3189dac, size 0x3bc, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize();

  /// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x3189c50, size 0x15c, virtual true, abstract: false, final true
  inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_asset, addr 0x318abf0, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_asset();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_assetOwner, addr 0x318abf4, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> UnityEngine_Timeline_ICurvesOwner_get_assetOwner();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName, addr 0x318abb0, size 0x40, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName();

  /// @brief Method UnityEngine.Timeline.ICurvesOwner.get_targetTrack, addr 0x318abf8, size 0x4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Timeline::TrackAsset> UnityEngine_Timeline_ICurvesOwner_get_targetTrack();

  /// @brief Method UpdateChildTrackCache, addr 0x318a984, size 0x20c, virtual false, abstract: false, final false
  inline void UpdateChildTrackCache();

  /// @brief Method UpdateDuration, addr 0x318a640, size 0x10c, virtual false, abstract: false, final false
  inline void UpdateDuration();

  /// @brief Method UpgradeToLatestVersion, addr 0x318a1f0, size 0x4, virtual false, abstract: false, final false
  inline void UpgradeToLatestVersion();

  /// @brief Method ValidateClipType, addr 0x318bba0, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method __internalAwake, addr 0x318ae58, size 0xcc, virtual false, abstract: false, final false
  inline void __internalAwake();

  /// @brief Method .ctor, addr 0x317dbac, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnClipPlayableCreate, addr 0x318a210, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method add_OnTrackAnimationPlayableCreate, addr 0x318a3f8, size 0xf4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method get_clips, addr 0x317f9d0, size 0xb0, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Timeline::TimelineClip*, ::Array<::UnityEngine::Timeline::TimelineClip*>*> get_clips();

  /// @brief Method get_curves, addr 0x318aba0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AnimationClip> get_curves();

  /// @brief Method get_customPlayableTypename, addr 0x318ab90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_customPlayableTypename();

  /// @brief Method get_duration, addr 0x318a74c, size 0x60, virtual true, abstract: false, final true
  inline double_t get_duration();

  /// @brief Method get_end, addr 0x3187d04, size 0x60, virtual false, abstract: false, final false
  inline double_t get_end();

  /// @brief Method get_hasClips, addr 0x317d694, size 0x54, virtual false, abstract: false, final false
  inline bool get_hasClips();

  /// @brief Method get_hasCurves, addr 0x318a844, size 0x8c, virtual true, abstract: false, final true
  inline bool get_hasCurves();

  /// @brief Method get_isEmpty, addr 0x318a7d8, size 0x6c, virtual true, abstract: false, final false
  inline bool get_isEmpty();

  /// @brief Method get_isSubTrack, addr 0x3180304, size 0x120, virtual false, abstract: false, final false
  inline bool get_isSubTrack();

  /// @brief Method get_locked, addr 0x318ac04, size 0x8, virtual false, abstract: false, final false
  inline bool get_locked();

  /// @brief Method get_lockedInHierarchy, addr 0x318ac18, size 0x18c, virtual false, abstract: false, final false
  inline bool get_lockedInHierarchy();

  /// @brief Method get_muted, addr 0x318a7b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_muted();

  /// @brief Method get_mutedInHierarchy, addr 0x31879d8, size 0x18c, virtual false, abstract: false, final false
  inline bool get_mutedInHierarchy();

  /// @brief Method get_outputs, addr 0x318a8d8, size 0x78, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Playables::PlayableBinding>* get_outputs();

  /// @brief Method get_parent, addr 0x318a7c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Playables::PlayableAsset> get_parent();

  /// @brief Method get_start, addr 0x318a5e0, size 0x60, virtual false, abstract: false, final false
  inline double_t get_start();

  /// @brief Method get_subTracksObjects, addr 0x318abfc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::ScriptableObject>>* get_subTracksObjects();

  /// @brief Method get_supportsNotifications, addr 0x318ada4, size 0xb4, virtual false, abstract: false, final false
  inline bool get_supportsNotifications();

  /// @brief Method get_timelineAsset, addr 0x31880d4, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnClipPlayableCreate, addr 0x318a304, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_OnTrackAnimationPlayableCreate, addr 0x318a4ec, size 0xf4, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method set_curves, addr 0x318aba8, size 0x8, virtual false, abstract: false, final false
  inline void set_curves(::UnityEngine::AnimationClip* value);

  /// @brief Method set_customPlayableTypename, addr 0x318ab98, size 0x8, virtual false, abstract: false, final false
  inline void set_customPlayableTypename(::StringW value);

  /// @brief Method set_locked, addr 0x318ac0c, size 0xc, virtual false, abstract: false, final false
  inline void set_locked(bool value);

  /// @brief Method set_muted, addr 0x318a7bc, size 0xc, virtual false, abstract: false, final false
  inline void set_muted(bool value);

  /// @brief Method set_parent, addr 0x318a7d0, size 0x8, virtual false, abstract: false, final false
