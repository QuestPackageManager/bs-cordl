...
public:
  ...
  /// @brief Method CacheTrack, addr 0x319b628, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Compile, addr 0x319a37c, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileTrackList, addr 0x319a60c, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x319a15c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackOutput, addr 0x319adc8, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackPlayable, addr 0x319a9a8, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method Evaluate, addr 0x319b6c4, size 0x5ec, virtual false, abstract: false, final false
  inline void Evaluate(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAnimationPreviewUpdateCallback, addr 0x319b538, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateWeightsForAnimationPlayableOutput, addr 0x319b448, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAOTCompilationOnly, addr 0x319bcb0, size 0x64, virtual false, abstract: false, final false
  static inline void ForAOTCompilationOnly();

  static inline ::UnityEngine::Timeline::TimelinePlayable* New_ctor();

  /// @brief Method PrepareFrame, addr 0x319b698, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x319bd14, size 0x148, virtual false, abstract: false, final false
  inline void _ctor();
