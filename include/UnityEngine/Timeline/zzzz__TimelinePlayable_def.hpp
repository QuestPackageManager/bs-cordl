...
public:
  ...
  /// @brief Method CacheTrack, addr 0x33cd400, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Compile, addr 0x33cc154, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method CompileTrackList, addr 0x33cc3e4, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x33cbf34, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackOutput, addr 0x33ccba0, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTrackPlayable, addr 0x33cc780, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method Evaluate, addr 0x33cd49c, size 0x5ec, virtual false, abstract: false, final false
  inline void Evaluate(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData frameData);

  /// @brief Method EvaluateAnimationPreviewUpdateCallback, addr 0x33cd310, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateWeightsForAnimationPlayableOutput, addr 0x33cd220, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ForAOTCompilationOnly, addr 0x33cda88, size 0x64, virtual false, abstract: false, final false
  static inline void ForAOTCompilationOnly();

  static inline ::UnityEngine::Timeline::TimelinePlayable* New_ctor();

  /// @brief Method PrepareFrame, addr 0x33cd470, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33cdaec, size 0x148, virtual false, abstract: false, final false
  inline void _ctor();
