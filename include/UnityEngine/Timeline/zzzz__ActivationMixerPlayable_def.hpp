...
public:
  ...
  /// @brief Method Create, addr 0x67f3be8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPlayableDestroy, addr 0x67f3c84, size 0xc4, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x67f3d48, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f3f40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x67f3c74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x67f3c7c, size 0x8, virtual false, abstract: false, final false
