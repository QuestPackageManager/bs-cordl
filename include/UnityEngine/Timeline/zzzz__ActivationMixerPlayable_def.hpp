...
public:
  ...
  /// @brief Method Create, addr 0x68662b4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPlayableDestroy, addr 0x6866350, size 0xc4, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x6866414, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x686660c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x6866340, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x6866348, size 0x8, virtual false, abstract: false, final false
