...
public:
  ...
  /// @brief Method Create, addr 0x48106a8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPlayableDestroy, addr 0x481073c, size 0xc0, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x48107fc, size 0x1f0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48109ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_postPlaybackState, addr 0x481072c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState();

  /// @brief Method set_postPlaybackState, addr 0x4810734, size 0x8, virtual false, abstract: false, final false
