...
public:
  ...
  /// @brief Method CompareTo, addr 0x692a9a4, size 0x44, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::RefreshRate other);

  /// @brief Method Equals, addr 0x692a968, size 0x3c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::RefreshRate other);

  /// @brief Method ToString, addr 0x692a9e8, size 0xa0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_value, addr 0x692a954, size 0x14, virtual false, abstract: false, final false
