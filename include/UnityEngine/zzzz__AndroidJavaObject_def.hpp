...
public:
  ...
  /// @brief Method AndroidJavaClassDeleteLocalRef, addr 0x2d6d39c, size 0xc8, virtual false, abstract: false, final false
  static inline ::UnityEngine::AndroidJavaClass* AndroidJavaClassDeleteLocalRef(void* jclass);

  /// @brief Method AndroidJavaObjectDeleteLocalRef, addr 0x2d6bf54, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Call, addr 0x2d6c808, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CallStatic, addr 0x2d6c948, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneReference, addr 0x2d6cb1c, size 0x15c, virtual false, abstract: false, final false
  inline ::UnityEngine::AndroidJavaObject* CloneReference();

  /// @brief Method DebugPrint, addr 0x2d6cdf4, size 0x358, virtual false, abstract: false, final false
  inline void DebugPrint(::StringW call, ::StringW methodName, ::StringW signature, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method DebugPrint, addr 0x2d6cd6c, size 0x88, virtual false, abstract: false, final false
  inline void DebugPrint(::StringW msg);

  /// @brief Method Dispose, addr 0x2d6bc6c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2d6d334, size 0x30, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x2d6d294, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRawClass, addr 0x2d6cae4, size 0x1c, virtual false, abstract: false, final false
  inline void* GetRawClass();

  /// @brief Method GetRawObject, addr 0x2d6bd90, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method _AndroidJavaObject, addr 0x2d6c308, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method _Call, addr 0x2d6c80c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method _CallStatic, addr 0x2d6c94c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method _GetRawClass, addr 0x2d6cb00, size 0x1c, virtual false, abstract: false, final false
  inline void* _GetRawClass();

  /// @brief Method _GetRawObject, addr 0x2d6ca88, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d6c300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2d6c24c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::StringW, ::Array<::StringW>*> args);

  /// @brief Method .ctor, addr 0x2d6c7d4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method .ctor, addr 0x2d6c5b8, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::UnityEngine::AndroidJavaClass*, ::Array<::UnityEngine::AndroidJavaClass*>*> args);

  /// @brief Method .ctor, addr 0x2d6c504, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::UnityEngine::AndroidJavaObject*, ::Array<::UnityEngine::AndroidJavaObject*>*> args);

  /// @brief Method .ctor, addr 0x2d6c66c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::UnityEngine::AndroidJavaProxy*, ::Array<::UnityEngine::AndroidJavaProxy*>*> args);

  /// @brief Method .ctor, addr 0x2d6c720, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className, ::ArrayW<::UnityEngine::AndroidJavaRunnable*, ::Array<::UnityEngine::AndroidJavaRunnable*>*> args);

  /// @brief Method .ctor, addr 0x2d6d170, size 0x124, virtual false, abstract: false, final false
