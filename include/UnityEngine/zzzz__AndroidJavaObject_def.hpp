...
public:
  ...
  /// @brief Method .ctor addr 0x2c8660c size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c868c4 size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c86978 size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c86a2c size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c86ae0 size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c86b94 size 0x34 virtual false final false
  inline void _ctor(::StringW className, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method Dispose addr 0x2c8602c size 0x6c virtual true final true
  inline void Dispose();
  ...
  /// @brief Method Call addr 0x2c86bc8 size 0x4 virtual false final false
  ...
  /// @brief Method CallStatic addr 0x2c86d08 size 0x4 virtual false final false
  ...
  /// @brief Method GetRawObject addr 0x2c86150 size 0x5c virtual false final false
  inline void* GetRawObject();

  /// @brief Method GetRawClass addr 0x2c86ea4 size 0x1c virtual false final false
  inline void* GetRawClass();

  /// @brief Method CloneReference addr 0x2c86edc size 0x15c virtual false final false
  ...
  /// @brief Method DebugPrint addr 0x2c8712c size 0x88 virtual false final false
  inline void DebugPrint(::StringW msg);

  /// @brief Method DebugPrint addr 0x2c871b4 size 0x358 virtual false final false
  inline void DebugPrint(::StringW call, ::StringW methodName, ::StringW signature, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method _AndroidJavaObject addr 0x2c866c8 size 0x1fc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c87530 size 0x124 virtual false final false
  inline void _ctor(void* jobject);

  static inline ::UnityEngine::AndroidJavaObject* New_ctor();

  /// @brief Method .ctor addr 0x2c866c0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Finalize addr 0x2c87654 size 0xa0 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x2c876f4 size 0x30 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method _Call addr 0x2c86bcc size 0x13c virtual false final false
  ...
  /// @brief Method _CallStatic addr 0x2c86d0c size 0x13c virtual false final false
  ...
  /// @brief Method AndroidJavaObjectDeleteLocalRef addr 0x2c86314 size 0xc8 virtual false final false
  static inline ::UnityEngine::AndroidJavaObject* AndroidJavaObjectDeleteLocalRef(void* jobject);

  /// @brief Method AndroidJavaClassDeleteLocalRef addr 0x2c8775c size 0xc8 virtual false final false
  ...
  /// @brief Method _GetRawObject addr 0x2c86e48 size 0x5c virtual false final false
  inline void* _GetRawObject();

  /// @brief Method _GetRawClass addr 0x2c86ec0 size 0x1c virtual false final false
