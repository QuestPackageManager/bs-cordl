...
public:
  ...
  /// @brief Method .ctor, addr 0x696f6e8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool useMipmapLimit, ::StringW groupName);

  /// @brief Method get_groupName, addr 0x696f6e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_groupName();

  /// @brief Method get_useMipmapLimit, addr 0x696f6d8, size 0x8, virtual false, abstract: false, final false
