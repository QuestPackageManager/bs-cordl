...
/// @brief Method .ctor, addr 0x68fd4cc, size 0xc, virtual false, abstract: false, final false
inline void _ctor(bool  useMipmapLimit, ::StringW  groupName) ;

/// @brief Method get_groupName, addr 0x68fd4c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_groupName() ;

/// @brief Method get_useMipmapLimit, addr 0x68fd4bc, size 0x8, virtual false, abstract: false, final false
