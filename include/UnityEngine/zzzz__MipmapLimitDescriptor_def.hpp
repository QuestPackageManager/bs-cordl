...
public:
  ...
  /// @brief Method .ctor, addr 0x6ac4594, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool useMipmapLimit, ::StringW groupName);

  /// @brief Method get_groupName, addr 0x6ac458c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_groupName();

  /// @brief Method get_useMipmapLimit, addr 0x6ac4584, size 0x8, virtual false, abstract: false, final false
