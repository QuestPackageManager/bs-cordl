...
public:
  ...
  /// @brief Method get_minDistance, addr 0x2c9b0e0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_minDistance();

  /// @brief Method set_minDistance, addr 0x2c9b11c, size 0x4c, virtual false, abstract: false, final false
  inline void set_minDistance(float_t value);

  /// @brief Method get_maxDistance, addr 0x2c9b168, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_maxDistance();

  /// @brief Method set_maxDistance, addr 0x2c9b1a4, size 0x4c, virtual false, abstract: false, final false
  inline void set_maxDistance(float_t value);

  /// @brief Method get_reverbPreset, addr 0x2c9b1f0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::AudioReverbPreset get_reverbPreset();

  /// @brief Method set_reverbPreset, addr 0x2c9b22c, size 0x44, virtual false, abstract: false, final false
  inline void set_reverbPreset(::UnityEngine::AudioReverbPreset value);

  /// @brief Method get_room, addr 0x2c9b270, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_room();

  /// @brief Method set_room, addr 0x2c9b2ac, size 0x44, virtual false, abstract: false, final false
  inline void set_room(int32_t value);

  /// @brief Method get_roomHF, addr 0x2c9b2f0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_roomHF();

  /// @brief Method set_roomHF, addr 0x2c9b32c, size 0x44, virtual false, abstract: false, final false
  inline void set_roomHF(int32_t value);

  /// @brief Method get_roomLF, addr 0x2c9b370, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_roomLF();

  /// @brief Method set_roomLF, addr 0x2c9b3ac, size 0x44, virtual false, abstract: false, final false
  inline void set_roomLF(int32_t value);

  /// @brief Method get_decayTime, addr 0x2c9b3f0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_decayTime();

  /// @brief Method set_decayTime, addr 0x2c9b42c, size 0x4c, virtual false, abstract: false, final false
  inline void set_decayTime(float_t value);

  /// @brief Method get_decayHFRatio, addr 0x2c9b478, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_decayHFRatio();

  /// @brief Method set_decayHFRatio, addr 0x2c9b4b4, size 0x4c, virtual false, abstract: false, final false
  inline void set_decayHFRatio(float_t value);

  /// @brief Method get_reflections, addr 0x2c9b500, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_reflections();

  /// @brief Method set_reflections, addr 0x2c9b53c, size 0x44, virtual false, abstract: false, final false
  inline void set_reflections(int32_t value);

  /// @brief Method get_reflectionsDelay, addr 0x2c9b580, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_reflectionsDelay();

  /// @brief Method set_reflectionsDelay, addr 0x2c9b5bc, size 0x4c, virtual false, abstract: false, final false
  inline void set_reflectionsDelay(float_t value);

  /// @brief Method get_reverb, addr 0x2c9b608, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_reverb();

  /// @brief Method set_reverb, addr 0x2c9b644, size 0x44, virtual false, abstract: false, final false
  inline void set_reverb(int32_t value);

  /// @brief Method get_reverbDelay, addr 0x2c9b688, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_reverbDelay();

  /// @brief Method set_reverbDelay, addr 0x2c9b6c4, size 0x4c, virtual false, abstract: false, final false
  inline void set_reverbDelay(float_t value);

  /// @brief Method get_HFReference, addr 0x2c9b710, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_HFReference();

  /// @brief Method set_HFReference, addr 0x2c9b74c, size 0x4c, virtual false, abstract: false, final false
  inline void set_HFReference(float_t value);

  /// @brief Method get_LFReference, addr 0x2c9b798, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_LFReference();

  /// @brief Method set_LFReference, addr 0x2c9b7d4, size 0x4c, virtual false, abstract: false, final false
  inline void set_LFReference(float_t value);

  /// @brief Method get_roomRolloffFactor, addr 0x2c9b820, size 0x70, virtual false, abstract: false, final false
  inline float_t get_roomRolloffFactor();

  /// @brief Method set_roomRolloffFactor, addr 0x2c9b890, size 0x68, virtual false, abstract: false, final false
  inline void set_roomRolloffFactor(float_t value);

  /// @brief Method get_diffusion, addr 0x2c9b8f8, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_diffusion();

  /// @brief Method set_diffusion, addr 0x2c9b934, size 0x4c, virtual false, abstract: false, final false
  inline void set_diffusion(float_t value);

  /// @brief Method get_density, addr 0x2c9b980, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_density();

  /// @brief Method set_density, addr 0x2c9b9bc, size 0x4c, virtual false, abstract: false, final false
  inline void set_density(float_t value);

  static inline ::UnityEngine::AudioReverbZone* New_ctor();

  /// @brief Method .ctor, addr 0x2c9ba08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
