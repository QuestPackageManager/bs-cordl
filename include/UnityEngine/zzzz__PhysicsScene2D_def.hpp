...
public:
  ...
  /// @brief Method Equals, addr 0x488cebc, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x488cf34, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::PhysicsScene2D other);

  /// @brief Method GetHashCode, addr 0x488ceb4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRayIntersection, addr 0x488d4b8, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::RaycastHit2D GetRayIntersection(::UnityEngine::Ray ray, float_t distance, int32_t layerMask);

  /// @brief Method GetRayIntersection, addr 0x488d624, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal, addr 0x488d648, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal_Injected, addr 0x488d6c8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal, addr 0x488d50c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal_Injected, addr 0x488d5a8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x488d1a0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x488cf44, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x488d270, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x488d394, size 0x30, virtual false, abstract: false, final false
  inline int32_t Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, float_t distance, ::UnityEngine::ContactFilter2D contactFilter,
                         ::System::Collections::Generic::List_1<::UnityEngine::RaycastHit2D>* results);

  /// @brief Method RaycastArray_Internal, addr 0x488d2a0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastArray_Internal_Injected, addr 0x488d318, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal, addr 0x488d3c4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal_Injected, addr 0x488d43c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal, addr 0x488d10c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal_Injected, addr 0x488d1f4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x488cdd0, size 0xe4, virtual true, abstract: false, final false
