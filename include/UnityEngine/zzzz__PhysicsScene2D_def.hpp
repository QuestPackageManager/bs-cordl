...
public:
  ...
  /// @brief Method Equals, addr 0x324fb5c, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x324fbd4, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::PhysicsScene2D other);

  /// @brief Method GetHashCode, addr 0x324fb54, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetRayIntersection, addr 0x3250158, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::RaycastHit2D GetRayIntersection(::UnityEngine::Ray ray, float_t distance, int32_t layerMask);

  /// @brief Method GetRayIntersection, addr 0x3250324, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal, addr 0x32503b0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersectionArray_Internal_Injected, addr 0x3250430, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal, addr 0x325020c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRayIntersection_Internal_Injected, addr 0x32502a8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x324fe40, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x324fbe4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x324ff10, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x3250034, size 0x30, virtual false, abstract: false, final false
  inline int32_t Raycast(::UnityEngine::Vector2 origin, ::UnityEngine::Vector2 direction, float_t distance, ::UnityEngine::ContactFilter2D contactFilter,
                         ::System::Collections::Generic::List_1<::UnityEngine::RaycastHit2D>* results);

  /// @brief Method RaycastArray_Internal, addr 0x324ff40, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastArray_Internal_Injected, addr 0x324ffb8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal, addr 0x3250064, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastList_Internal_Injected, addr 0x32500dc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal, addr 0x324fdac, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast_Internal_Injected, addr 0x324fe94, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x324fa70, size 0xe4, virtual true, abstract: false, final false
