...
public:
  ...
  /// @brief Method ToString, addr 0x2f3e97c, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateAsset, addr 0x2f3e96c, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::UnityEngine::Object* obj);

  /// @brief Method ValidateAsset, addr 0x2f3e974, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f3e944, size 0x28, virtual false, abstract: false, final false
