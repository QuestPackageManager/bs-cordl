...
public:
  ...
  /// @brief Method ToString, addr 0x44dee3c, size 0x100, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateAsset, addr 0x44dee2c, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::UnityEngine::Object* obj);

  /// @brief Method ValidateAsset, addr 0x44dee34, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44dee04, size 0x28, virtual false, abstract: false, final false
