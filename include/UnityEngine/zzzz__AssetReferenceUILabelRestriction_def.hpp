...
public:
  ...
  /// @brief Method ToString, addr 0x2b594cc, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ValidateAsset, addr 0x2b594bc, size 0x8, virtual true, abstract: false, final false
  inline bool ValidateAsset(::UnityEngine::Object* obj);

  /// @brief Method ValidateAsset, addr 0x2b594c4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b59494, size 0x28, virtual false, abstract: false, final false
