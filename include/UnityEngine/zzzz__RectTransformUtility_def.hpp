...
public:
  ...
  /// @brief Method PixelAdjustPoint addr 0x2d3f4f8 size 0xa4 virtual false final false
  ...
  /// @brief Method PixelAdjustRect addr 0x2d3f5f8 size 0xa0 virtual false final false
  static inline ::UnityEngine::Rect PixelAdjustRect(::UnityEngine::RectTransform* rectTransform, ::UnityEngine::Canvas* canvas);

  /// @brief Method PointInRectangle addr 0x2d3f6ec size 0xa8 virtual false final false
  ...
  /// @brief Method RectangleContainsScreenPoint addr 0x2d3f7f0 size 0xd4 virtual false final false
  ...
  /// @brief Method RectangleContainsScreenPoint addr 0x2d3f8c4 size 0xac virtual false final false
  ...
  /// @brief Method ScreenPointToWorldPointInRectangle addr 0x2d3f970 size 0x2ec virtual false final false
  ...
  /// @brief Method ScreenPointToLocalPointInRectangle addr 0x2d3fd8c size 0x100 virtual false final false
  ...
  /// @brief Method PixelAdjustRect_Injected addr 0x2d3f698 size 0x54 virtual false final false
  ...
  /// @brief Method PointInRectangle_Injected addr 0x2d3f794 size 0x5c virtual false final false
