...
public:
  ...
  /// @brief Method get_collider, addr 0x49110ac, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_instanceID, addr 0x49110a4, size 0x8, virtual false, abstract: false, final false
