...
public:
  ...
  /// @brief Method get_collider, addr 0x6b92928, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_instanceID, addr 0x6b92920, size 0x8, virtual false, abstract: false, final false
