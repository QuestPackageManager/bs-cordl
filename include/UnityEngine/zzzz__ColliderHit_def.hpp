...
public:
  ...
  /// @brief Method get_collider, addr 0x491443c, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_instanceID, addr 0x4914434, size 0x8, virtual false, abstract: false, final false
