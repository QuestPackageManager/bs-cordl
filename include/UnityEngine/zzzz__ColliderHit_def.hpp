...
public:
  ...
  /// @brief Method get_collider, addr 0x69ca9cc, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_collider();

  /// @brief Method get_instanceID, addr 0x69ca9c4, size 0x8, virtual false, abstract: false, final false
