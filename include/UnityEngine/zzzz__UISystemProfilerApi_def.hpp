...
public:
  ...
  /// @brief Method BeginSample addr 0x2eab674 size 0x3c virtual false final false
  static inline void BeginSample(::UnityEngine::__UISystemProfilerApi__SampleType type);

  /// @brief Method EndSample addr 0x2eab6b0 size 0x3c virtual false final false
  static inline void EndSample(::UnityEngine::__UISystemProfilerApi__SampleType type);

  /// @brief Method AddMarker addr 0x2eab6ec size 0x44 virtual false final false
