...
public:
  ...
  /// @brief Method AddMarker, addr 0x33f6850, size 0x44, virtual false, abstract: false, final false
  static inline void AddMarker(::StringW name, ::UnityEngine::Object* obj);

  /// @brief Method BeginSample, addr 0x33f67d8, size 0x3c, virtual false, abstract: false, final false
  static inline void BeginSample(::UnityEngine::__UISystemProfilerApi__SampleType type);

  /// @brief Method EndSample, addr 0x33f6814, size 0x3c, virtual false, abstract: false, final false
