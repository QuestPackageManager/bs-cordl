...
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimationCullingType, "UnityEngine", "AnimationCullingType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::AnimationCullingType) == 0x4, "Size mismatch!");
