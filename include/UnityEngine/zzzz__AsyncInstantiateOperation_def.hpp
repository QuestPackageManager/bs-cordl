...
public:
  ...
  /// @brief Method CreateResultArray, addr 0x6ad689c, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Object>> CreateResultArray(int32_t size);

  /// @brief Method IsCancellationRequested, addr 0x6ad6828, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ad67cc, size 0x5c, virtual false, abstract: false, final false
