...
public:
  ...
  /// @brief Method get_allSlices, addr 0x2cb1e50, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_allSlices();

  /// @brief Method get_isReadable, addr 0x2cb1e78, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl, addr 0x2cb1eb4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create, addr 0x2cb1f38, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateFormat, addr 0x2cb2010, size 0xe8, virtual false, abstract: false, final false
  inline bool ValidateFormat(::UnityEngine::TextureFormat format, int32_t width, int32_t height);

  /// @brief Method ValidateFormat, addr 0x2cb20f8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb222c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2280, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2320, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor, addr 0x2cb2454, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb259c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb25b0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method ValidateIsNotCrunched, addr 0x2cb23fc, size 0x58, virtual false, abstract: false, final false
