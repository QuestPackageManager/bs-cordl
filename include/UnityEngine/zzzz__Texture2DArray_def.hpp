...
public:
  ...
  /// @brief Method get_allSlices, addr 0x2cb3bec, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_allSlices();

  /// @brief Method get_isReadable, addr 0x2cb3c14, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl, addr 0x2cb3c50, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create, addr 0x2cb3cd4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateFormat, addr 0x2cb3dac, size 0xe8, virtual false, abstract: false, final false
  inline bool ValidateFormat(::UnityEngine::TextureFormat format, int32_t width, int32_t height);

  /// @brief Method ValidateFormat, addr 0x2cb3e94, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb3fc8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb401c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb40bc, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor, addr 0x2cb41f0, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4338, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb434c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t height, int32_t depth, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method ValidateIsNotCrunched, addr 0x2cb4198, size 0x58, virtual false, abstract: false, final false
