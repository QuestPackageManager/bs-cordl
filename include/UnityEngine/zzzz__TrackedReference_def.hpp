...
public:
  ...
  /// @brief Method Equals, addr 0x32089cc, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* o);

  /// @brief Method GetHashCode, addr 0x3208a4c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3208918, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Equality, addr 0x3208920, size 0x94, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::TrackedReference* x, ::UnityEngine::TrackedReference* y);

  /// @brief Method op_Implicit, addr 0x3208a58, size 0x1c, virtual false, abstract: false, final false
  static inline bool op_Implicit_bool(::UnityEngine::TrackedReference* exists);

  /// @brief Method op_Inequality, addr 0x32089b4, size 0x18, virtual false, abstract: false, final false
