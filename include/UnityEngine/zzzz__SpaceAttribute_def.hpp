...
public:
  ...
  /// @brief Method .ctor, addr 0x2e1a05c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2e1a07c, size 0x28, virtual false, abstract: false, final false
