...
public:
  ...
  /// @brief Method .ctor, addr 0x3433690, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34336b0, size 0x28, virtual false, abstract: false, final false
