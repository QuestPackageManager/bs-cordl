...
public:
  ...
  /// @brief Method .ctor, addr 0x320146c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x320148c, size 0x28, virtual false, abstract: false, final false
