...
public:
  ...
  /// @brief Method PostRegisteredAtlas, addr 0x6b2ea58, size 0x70, virtual false, abstract: false, final false
  static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method Register, addr 0x6b2eac8, size 0x80, virtual false, abstract: false, final false
  static inline void Register(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method Register_Injected, addr 0x6b2eb48, size 0x3c, virtual false, abstract: false, final false
  static inline void Register_Injected(::System::IntPtr spriteAtlas);

  /// @brief Method RequestAtlas, addr 0x6b2e7d0, size 0xc0, virtual false, abstract: false, final false
  static inline bool RequestAtlas(::StringW tag);

  /// @brief Method add_atlasRegistered, addr 0x6b2e890, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_atlasRegistered, addr 0x6b2e974, size 0xe4, virtual false, abstract: false, final false
