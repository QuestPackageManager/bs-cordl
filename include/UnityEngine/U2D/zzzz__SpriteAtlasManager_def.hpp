...
public:
  ...
  /// @brief Method PostRegisteredAtlas, addr 0x48bd9c8, size 0x6c, virtual false, abstract: false, final false
  static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method Register, addr 0x48bda34, size 0x3c, virtual false, abstract: false, final false
  static inline void Register(::UnityEngine::U2D::SpriteAtlas* spriteAtlas);

  /// @brief Method RequestAtlas, addr 0x48bd774, size 0xb4, virtual false, abstract: false, final false
  static inline bool RequestAtlas(::StringW tag);

  /// @brief Method add_atlasRegistered, addr 0x48bd828, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_atlasRegistered, addr 0x48bd8f8, size 0xd0, virtual false, abstract: false, final false
