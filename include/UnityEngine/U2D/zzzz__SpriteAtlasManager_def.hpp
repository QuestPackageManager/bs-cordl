...
/// @brief Method PostRegisteredAtlas, addr 0x69671bc, size 0x70, virtual false, abstract: false, final false
static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register, addr 0x696722c, size 0x80, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register_Injected, addr 0x69672ac, size 0x3c, virtual false, abstract: false, final false
static inline void Register_Injected(::System::IntPtr  spriteAtlas) ;

/// @brief Method RequestAtlas, addr 0x6966f34, size 0xc0, virtual false, abstract: false, final false
static inline bool RequestAtlas(::StringW  tag) ;

/// @brief Method add_atlasRegistered, addr 0x6966ff4, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasRegistered, addr 0x69670d8, size 0xe4, virtual false, abstract: false, final false
