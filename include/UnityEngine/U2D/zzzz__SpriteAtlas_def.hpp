...
public:
  ...
  /// @brief Method get_isVariant addr 0x2ce687c size 0x3c virtual false final false
  inline bool get_isVariant();

  /// @brief Method get_tag addr 0x2ce68b8 size 0x3c virtual false final false
  inline ::StringW get_tag();

  /// @brief Method get_spriteCount addr 0x2ce68f4 size 0x3c virtual false final false
  inline int32_t get_spriteCount();

  /// @brief Method CanBindTo addr 0x2ce6930 size 0x44 virtual false final false
  inline bool CanBindTo(::UnityEngine::Sprite* sprite);

  /// @brief Method GetSprite addr 0x2ce6974 size 0x44 virtual false final false
  inline ::UnityEngine::Sprite* GetSprite(::StringW name);

  /// @brief Method GetSprites addr 0x2ce69b8 size 0x44 virtual false final false
  inline int32_t GetSprites(::ArrayW<::UnityEngine::Sprite*, ::Array<::UnityEngine::Sprite*>*> sprites);

  /// @brief Method GetSprites addr 0x2ce6a40 size 0x54 virtual false final false
  inline int32_t GetSprites(::ArrayW<::UnityEngine::Sprite*, ::Array<::UnityEngine::Sprite*>*> sprites, ::StringW name);

  /// @brief Method GetSpritesScripting addr 0x2ce69fc size 0x44 virtual false final false
  inline int32_t GetSpritesScripting(::ArrayW<::UnityEngine::Sprite*, ::Array<::UnityEngine::Sprite*>*> sprites);

  /// @brief Method GetSpritesWithNameScripting addr 0x2ce6a94 size 0x54 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ce6ae8 size 0x58 virtual false final false
  inline void _ctor();
