...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpriteShapeRenderer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpriteShapeRenderer(SpriteShapeRenderer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpriteShapeRenderer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpriteShapeRenderer(SpriteShapeRendererconst&) = delete;
