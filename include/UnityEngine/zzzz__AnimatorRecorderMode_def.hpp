...
DEFINE_IL2CPP_CLASS(::UnityEngine::AnimatorRecorderMode, "UnityEngine", "AnimatorRecorderMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::AnimatorRecorderMode) == 0x4, "Size mismatch!");
