...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6a8e574, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x6a8e000, size 0x90, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method Finalize, addr 0x6a8dfbc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method GetColorImpl_Injected, addr 0x6a8cef0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFloatImpl_Injected, addr 0x6a8cd70, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrixImpl_Injected, addr 0x6a8cfd4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVectorImpl_Injected, addr 0x6a8ce28, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetBufferImpl_Injected, addr 0x6a8d6c8, size 0x54, virtual false, abstract: false, final false
  static inline void SetBufferImpl_Injected(::System::IntPtr _unity_self, int32_t name, ::System::IntPtr value);

  /// @brief Method SetColor, addr 0x6a8e280, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorImpl_Injected, addr 0x6a8d2d4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetConstantBufferImpl_Injected, addr 0x6a8d7a8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFloat, addr 0x6a8e1f4, size 0x30, virtual false, abstract: false, final false
  inline void SetFloat(::StringW name, float_t value);

  /// @brief Method SetFloat, addr 0x6a8e224, size 0x4, virtual false, abstract: false, final false
  inline void SetFloat(int32_t nameID, float_t value);

  /// @brief Method SetFloatArray, addr 0x6a8e448, size 0x3c, virtual false, abstract: false, final false
  inline void SetFloatArray(::StringW name, ::ArrayW<float_t> values);

  /// @brief Method SetFloatArray, addr 0x6a8dd48, size 0xbc, virtual false, abstract: false, final false
  inline void SetFloatArray(int32_t name, ::ArrayW<float_t> values, int32_t count);

  /// @brief Method SetFloatArray, addr 0x6a8e484, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFloatImpl_Injected, addr 0x6a8d14c, size 0x54, virtual false, abstract: false, final false
  static inline void SetFloatImpl_Injected(::System::IntPtr _unity_self, int32_t name, float_t value);

  /// @brief Method SetInt, addr 0x6a8e090, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIntImpl_Injected, addr 0x6a8d090, size 0x54, virtual false, abstract: false, final false
  static inline void SetIntImpl_Injected(::System::IntPtr _unity_self, int32_t name, int32_t value);

  /// @brief Method SetInteger, addr 0x6a8e228, size 0x4, virtual false, abstract: false, final false
  inline void SetInteger(int32_t nameID, int32_t value);

  /// @brief Method SetMatrix, addr 0x6a8e2d4, size 0x4c, virtual false, abstract: false, final false
  inline void SetMatrix(::StringW name, ::UnityEngine::Matrix4x4 value);

  /// @brief Method SetMatrix, addr 0x6a8e320, size 0x2c, virtual false, abstract: false, final false
  inline void SetMatrix(int32_t nameID, ::UnityEngine::Matrix4x4 value);

  /// @brief Method SetMatrixArray, addr 0x6a8e4e8, size 0x3c, virtual false, abstract: false, final false
  inline void SetMatrixArray(::StringW name, ::ArrayW<::UnityEngine::Matrix4x4> values);

  /// @brief Method SetMatrixArray, addr 0x6a8dec0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTexture, addr 0x6a8e37c, size 0x30, virtual false, abstract: false, final false
  inline void SetTexture(::StringW name, ::UnityEngine::Texture* value);

  /// @brief Method SetTexture, addr 0x6a8e3b0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetVector, addr 0x6a8e22c, size 0x50, virtual false, abstract: false, final false
  inline void SetVector(::StringW name, ::UnityEngine::Vector4 value);

  /// @brief Method SetVector, addr 0x6a8e27c, size 0x4, virtual false, abstract: false, final false
  inline void SetVector(int32_t nameID, ::UnityEngine::Vector4 value);

  /// @brief Method SetVectorArray, addr 0x6a8e498, size 0x3c, virtual false, abstract: false, final false
  inline void SetVectorArray(::StringW name, ::ArrayW<::UnityEngine::Vector4> values);

  /// @brief Method SetVectorArray, addr 0x6a8de04, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetVectorImpl_Injected, addr 0x6a8d210, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a8df7c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor();
