...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x4955a94, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::UnityEngine::Font_FontTextureRebuildCallback* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x4955a0c, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateDynamicFontFromOSFont, addr 0x495552c, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> CreateDynamicFontFromOSFont(::StringW fontname, int32_t size);

  /// @brief Method CreateDynamicFontFromOSFont, addr 0x49555d0, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> CreateDynamicFontFromOSFont(::ArrayW<::StringW, ::Array<::StringW>*> fontnames, int32_t size);

  /// @brief Method GetCharacterInfo, addr 0x49558b0, size 0x5c, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::ByRef<::UnityEngine::CharacterInfo> info);

  /// @brief Method GetCharacterInfo, addr 0x4955850, size 0x60, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::ByRef<::UnityEngine::CharacterInfo> info, int32_t size);

  /// @brief Method GetCharacterInfo, addr 0x49557e4, size 0x6c, virtual false, abstract: false, final false
  inline bool GetCharacterInfo(char16_t ch, ::ByRef<::UnityEngine::CharacterInfo> info, int32_t size, ::UnityEngine::FontStyle style);

  /// @brief Method GetDefault, addr 0x49556e4, size 0x28, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Font> GetDefault();

  /// @brief Method GetMaxVertsForString, addr 0x49556c4, size 0x20, virtual false, abstract: false, final false
  static inline int32_t GetMaxVertsForString(::StringW str);

  /// @brief Method GetOSInstalledFontNames, addr 0x4955794, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetOSInstalledFontNames();

  /// @brief Method GetPathsToOSFonts, addr 0x49557bc, size 0x28, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> GetPathsToOSFonts();

  /// @brief Method HasCharacter, addr 0x495570c, size 0x44, virtual false, abstract: false, final false
  inline bool HasCharacter(char16_t c);

  /// @brief Method HasCharacter, addr 0x4955750, size 0x44, virtual false, abstract: false, final false
  inline bool HasCharacter(int32_t c);

  /// @brief Method Internal_CreateDynamicFont, addr 0x49554d8, size 0x54, virtual false, abstract: false, final false
  static inline void Internal_CreateDynamicFont(::UnityEngine::Font* self, ::ArrayW<::StringW, ::Array<::StringW>*> _names, int32_t size);

  /// @brief Method Internal_CreateFont, addr 0x49552a8, size 0x44, virtual false, abstract: false, final false
  static inline void Internal_CreateFont(::UnityEngine::Font* self, ::StringW name);

  /// @brief Method Internal_CreateFontFromPath, addr 0x49553fc, size 0x44, virtual false, abstract: false, final false
  static inline void Internal_CreateFontFromPath(::UnityEngine::Font* self, ::StringW fontPath);

  /// @brief Method InvokeTextureRebuilt_Internal, addr 0x4955638, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestCharactersInTexture, addr 0x49559c0, size 0x4c, virtual false, abstract: false, final false
  inline void RequestCharactersInTexture(::StringW characters);

  /// @brief Method RequestCharactersInTexture, addr 0x4955968, size 0x58, virtual false, abstract: false, final false
  inline void RequestCharactersInTexture(::StringW characters, int32_t size);

  /// @brief Method RequestCharactersInTexture, addr 0x495590c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4955224, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x49552ec, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x4955440, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::StringW, ::Array<::StringW>*> names, int32_t size);

  /// @brief Method add_m_FontTextureRebuildCallback, addr 0x4954ea8, size 0x9c, virtual false, abstract: false, final false
  inline void add_m_FontTextureRebuildCallback(::UnityEngine::Font_FontTextureRebuildCallback* value);

  /// @brief Method add_textureRebuilt, addr 0x4954d10, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ascent, addr 0x49550e0, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_ascent();

  /// @brief Method get_characterInfo, addr 0x4955158, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::CharacterInfo, ::Array<::UnityEngine::CharacterInfo>*> get_characterInfo();

  /// @brief Method get_dynamic, addr 0x4953e90, size 0x3c, virtual false, abstract: false, final false
  inline bool get_dynamic();

  /// @brief Method get_fontNames, addr 0x4955060, size 0x3c, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_fontNames();

  /// @brief Method get_fontSize, addr 0x495511c, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_fontSize();

  /// @brief Method get_lineHeight, addr 0x49551d8, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_lineHeight();

  /// @brief Method get_material, addr 0x4954fe0, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_material();

  /// @brief Method get_textureRebuildCallback, addr 0x4955214, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Font_FontTextureRebuildCallback* get_textureRebuildCallback();

  /// @brief Method remove_m_FontTextureRebuildCallback, addr 0x4954f44, size 0x9c, virtual false, abstract: false, final false
  inline void remove_m_FontTextureRebuildCallback(::UnityEngine::Font_FontTextureRebuildCallback* value);

  /// @brief Method remove_textureRebuilt, addr 0x4954ddc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_characterInfo, addr 0x4955194, size 0x44, virtual false, abstract: false, final false
  inline void set_characterInfo(::ArrayW<::UnityEngine::CharacterInfo, ::Array<::UnityEngine::CharacterInfo>*> value);

  /// @brief Method set_fontNames, addr 0x495509c, size 0x44, virtual false, abstract: false, final false
  inline void set_fontNames(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_material, addr 0x495501c, size 0x44, virtual false, abstract: false, final false
  inline void set_material(::UnityEngine::Material* value);

  /// @brief Method set_textureRebuildCallback, addr 0x495521c, size 0x8, virtual false, abstract: false, final false
