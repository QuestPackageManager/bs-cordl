...
namespace UnityEngine {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(8996)), TypeDefinitionIndex(TypeDefinitionIndex(13939))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2d2dddc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d2de58, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_center, addr 0x2d2de90, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_center();

  /// @brief Method set_center, addr 0x2d2de9c, size 0xc, virtual false, abstract: false, final false
  inline void set_center(::UnityEngine::Vector3 value);

  /// @brief Method get_halfExtents, addr 0x2d2dea8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_halfExtents();

  /// @brief Method set_halfExtents, addr 0x2d2deb4, size 0xc, virtual false, abstract: false, final false
  inline void set_halfExtents(::UnityEngine::Vector3 value);

  /// @brief Method get_orientation, addr 0x2d2dec0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_orientation();

  /// @brief Method set_orientation, addr 0x2d2decc, size 0xc, virtual false, abstract: false, final false
  inline void set_orientation(::UnityEngine::Quaternion value);

  /// @brief Method get_direction, addr 0x2d2ded8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_direction();

  /// @brief Method set_direction, addr 0x2d2dee4, size 0xc, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::Vector3 value);

  /// @brief Method get_distance, addr 0x2d2def0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method set_distance, addr 0x2d2def8, size 0x8, virtual false, abstract: false, final false
  inline void set_distance(float_t value);

  /// @brief Method get_layerMask, addr 0x2d2df00, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layerMask();

  /// @brief Method set_layerMask, addr 0x2d2df08, size 0x8, virtual false, abstract: false, final false
  inline void set_layerMask(int32_t value);

  /// @brief Method get_maxHits, addr 0x2d2df10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxHits();

  /// @brief Method set_maxHits, addr 0x2d2df18, size 0x8, virtual false, abstract: false, final false
  inline void set_maxHits(int32_t value);

  /// @brief Method get_physicsScene, addr 0x2d2df20, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method set_physicsScene, addr 0x2d2df28, size 0x8, virtual false, abstract: false, final false
  inline void set_physicsScene(::UnityEngine::PhysicsScene value);

  /// @brief Method ScheduleBatch, addr 0x2d2df30, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleBoxcastBatch, addr 0x2d2e080, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleBoxcastBatch_Injected, addr 0x2d2e10c, size 0x84, virtual false, abstract: false, final false
