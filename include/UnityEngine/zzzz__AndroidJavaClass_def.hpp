...
/// @brief Method _AndroidJavaClass, addr 0x6861440, size 0x128, virtual false, abstract: false, final false
inline void _AndroidJavaClass(::StringW  className) ;

/// @brief Method .ctor, addr 0x685d930, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::StringW  className) ;

/// @brief Method .ctor, addr 0x6860e3c, size 0xe0, virtual false, abstract: false, final false
