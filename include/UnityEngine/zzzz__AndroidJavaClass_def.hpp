...
public:
  ...
  /// @brief Method _AndroidJavaClass, addr 0x68d344c, size 0x128, virtual false, abstract: false, final false
  inline void _AndroidJavaClass(::StringW className);

  /// @brief Method .ctor, addr 0x68cf93c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::StringW className);

  /// @brief Method .ctor, addr 0x68d2e48, size 0xe0, virtual false, abstract: false, final false
