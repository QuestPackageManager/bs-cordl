...
DEFINE_IL2CPP_CLASS(::UnityEngine::IMECompositionMode, "UnityEngine", "IMECompositionMode");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::IMECompositionMode) == 0x4, "Size mismatch!");
