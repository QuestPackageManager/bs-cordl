...
public:
  ...
  /// @brief Method get_isReadable addr 0x2b4d1b4 size 0x3c virtual true final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl addr 0x2b4d1f0 size 0x74 virtual false final false
  ...
  /// @brief Method Internal_Create addr 0x2b4d264 size 0xc8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4d32c size 0x4c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4d378 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4d408 size 0xd0 virtual false final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor addr 0x2b4d530 size 0x138 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4d668 size 0x14 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2b4d67c size 0x14 virtual false final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method ValidateIsNotCrunched addr 0x2b4d4d8 size 0x58 virtual false final false
