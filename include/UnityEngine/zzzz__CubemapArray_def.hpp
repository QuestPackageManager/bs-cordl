...
public:
  ...
  /// @brief Method get_isReadable, addr 0x2cb4360, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl, addr 0x2cb439c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create, addr 0x2cb4410, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb44d8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4524, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb45b4, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor, addr 0x2cb46dc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4814, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb4828, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method ValidateIsNotCrunched, addr 0x2cb4684, size 0x58, virtual false, abstract: false, final false
