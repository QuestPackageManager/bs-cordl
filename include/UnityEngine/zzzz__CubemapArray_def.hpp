...
public:
  ...
  /// @brief Method Internal_Create, addr 0x489733c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_CreateImpl, addr 0x48972b8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateIsNotCrunched, addr 0x489762c, size 0x54, virtual false, abstract: false, final false
  static inline void ValidateIsNotCrunched(::UnityEngine::Experimental::Rendering::TextureCreationFlags flags);

  /// @brief Method .ctor, addr 0x4897410, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48974ec, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::Experimental::Rendering::DefaultFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);

  /// @brief Method .ctor, addr 0x489745c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4897540, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);

  /// @brief Method .ctor, addr 0x4897954, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method .ctor, addr 0x48978ac, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::TextureFormat textureFormat, bool mipChain, bool linear);

  /// @brief Method .ctor, addr 0x48977f8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48977ec, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4897680, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isReadable, addr 0x489727c, size 0x3c, virtual true, abstract: false, final false
