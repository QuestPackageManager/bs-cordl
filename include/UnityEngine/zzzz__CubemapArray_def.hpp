...
public:
  ...
  /// @brief Method get_isReadable, addr 0x2cb25c4, size 0x3c, virtual true, abstract: false, final false
  inline bool get_isReadable();

  /// @brief Method Internal_CreateImpl, addr 0x2cb2600, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_Create, addr 0x2cb2674, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb273c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2788, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2818, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::Experimental::Rendering::GraphicsFormat format, ::UnityEngine::Experimental::Rendering::TextureCreationFlags flags,
                    int32_t mipCount);
  ...
  /// @brief Method .ctor, addr 0x2cb2940, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2a78, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2cb2a8c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t width, int32_t cubemapCount, ::UnityEngine::TextureFormat textureFormat, bool mipChain);

  /// @brief Method ValidateIsNotCrunched, addr 0x2cb28e8, size 0x58, virtual false, abstract: false, final false
