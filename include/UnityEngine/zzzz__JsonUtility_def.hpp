...
public:
  // Declarations
  /// @brief Method FromJson, addr 0x348dbd8, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromJsonInternal, addr 0x348da08, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Object* FromJsonInternal(::StringW json, ::System::Object* objectToOverwrite, ::System::Type* type);

  /// @brief Method ToJson, addr 0x348da5c, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj);

  /// @brief Method ToJson, addr 0x348da64, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj, bool prettyPrint);

  /// @brief Method ToJsonInternal, addr 0x348d9c4, size 0x44, virtual false, abstract: false, final false
