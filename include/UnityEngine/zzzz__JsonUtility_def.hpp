...
public:
  // Declarations
  /// @brief Method FromJson, addr 0x3249b1c, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromJsonInternal, addr 0x324994c, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Object* FromJsonInternal(::StringW json, ::System::Object* objectToOverwrite, ::System::Type* type);

  /// @brief Method ToJson, addr 0x32499a0, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj);

  /// @brief Method ToJson, addr 0x32499a8, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW ToJson(::System::Object* obj, bool prettyPrint);

  /// @brief Method ToJsonInternal, addr 0x3249908, size 0x44, virtual false, abstract: false, final false
