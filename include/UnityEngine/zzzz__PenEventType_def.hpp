...
DEFINE_IL2CPP_CLASS(::UnityEngine::PenEventType, "UnityEngine", "PenEventType");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
public:
  ...
  /// @brief Field NoContact value: I32(0)
  static ::UnityEngine::PenEventType const NoContact;

  /// @brief Field PenDown value: I32(1)
  static ::UnityEngine::PenEventType const PenDown;

  /// @brief Field PenUp value: I32(2)
...
static_assert(sizeof(::UnityEngine::PenEventType) == 0x4, "Size mismatch!");
