...
// TypeDefinitionIndex(TypeDefinitionIndex(10043))} Self: TypeDefinitionIndex(TypeDefinitionIndex(10222)) CS Name: ::UnityEngine.Profiling.Experimental::DebugScreenCapture
...
public:
  ...
  /// @brief Method set_rawImageDataReference addr 0x2b7fcbc size 0x8 virtual false final false
  inline void set_rawImageDataReference(::Unity::Collections::NativeArray_1<uint8_t> value);

  /// @brief Method set_imageFormat addr 0x2b7fcc4 size 0x8 virtual false final false
  inline void set_imageFormat(::UnityEngine::TextureFormat value);

  /// @brief Method set_width addr 0x2b7fccc size 0x8 virtual false final false
  inline void set_width(int32_t value);

  /// @brief Method set_height addr 0x2b7fcd4 size 0x8 virtual false final false
