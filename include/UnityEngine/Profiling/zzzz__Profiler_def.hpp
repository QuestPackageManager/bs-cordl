...
public:
// Declarations
/// @brief Method GetMonoUsedSizeLong, addr 0x6930dfc, size 0x28, virtual false, abstract: false, final false
static inline int64_t GetMonoUsedSizeLong() ;

/// @brief Method GetRuntimeMemorySizeLong, addr 0x6930d30, size 0x90, virtual false, abstract: false, final false
static inline int64_t GetRuntimeMemorySizeLong(::UnityEngine::Object*  o) ;

/// @brief Method GetRuntimeMemorySizeLong_Injected, addr 0x6930dc0, size 0x3c, virtual false, abstract: false, final false
static inline int64_t GetRuntimeMemorySizeLong_Injected(::System::IntPtr  o) ;

/// @brief Method GetTotalAllocatedMemoryLong, addr 0x6930e24, size 0x28, virtual false, abstract: false, final false
static inline int64_t GetTotalAllocatedMemoryLong() ;

/// @brief Method GetTotalReservedMemoryLong, addr 0x6930e4c, size 0x28, virtual false, abstract: false, final false
static inline int64_t GetTotalReservedMemoryLong() ;

/// @brief Method get_enabled, addr 0x6930ccc, size 0x28, virtual false, abstract: false, final false
static inline bool get_enabled() ;

/// @brief Method set_enableBinaryLog, addr 0x6930c54, size 0x3c, virtual false, abstract: false, final false
static inline void set_enableBinaryLog(bool  value) ;

/// @brief Method set_enabled, addr 0x6930cf4, size 0x3c, virtual false, abstract: false, final false
static inline void set_enabled(bool  value) ;

/// @brief Method set_logFile, addr 0x6930af4, size 0x124, virtual false, abstract: false, final false
static inline void set_logFile(::StringW  value) ;

/// @brief Method set_logFile_Injected, addr 0x6930c18, size 0x3c, virtual false, abstract: false, final false
static inline void set_logFile_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  value) ;

/// @brief Method set_maxUsedMemory, addr 0x6930c90, size 0x3c, virtual false, abstract: false, final false
