...
public:
  ...
  /// @brief Method GetRecorder, addr 0x69a3394, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a3378, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69a337c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  static inline ::UnityEngine::Profiling::Sampler* getStaticF_s_InvalidSampler();

  /// @brief Method get_isValid, addr 0x69a3384, size 0x10, virtual false, abstract: false, final false
