...
// Ctor Parameters [CppParam { name: "_element_k__BackingField", ty: "::UnityW<::UnityEngine::Audio::AudioContainerElement>", modifiers: "", def_value: None }, CppParam { name: "_scheduledTime_k__BackingField", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "_pitchOffset_k__BackingField", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_volumeOffset_k__BackingField", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_triggerTimeOffset_k__BackingField", ty: "double_t", modifiers: "", def_value: None }]
constexpr PlayableSettings(::UnityW<::UnityEngine::Audio::AudioContainerElement>  _element_k__BackingField, double_t  _scheduledTime_k__BackingField, float_t  _pitchOffset_k__BackingField, float_t  _volumeOffset_k__BackingField, double_t  _triggerTimeOffset_k__BackingField) noexcept;
