...
public:
  ...
  // Ctor Parameters [CppParam { name: "_element_k__BackingField", ty: "::UnityW<::UnityEngine::Audio::AudioContainerElement>", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "_scheduledTime_k__BackingField", ty: "double_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "_pitchOffset_k__BackingField", ty: "float_t", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "_volumeOffset_k__BackingField", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "_triggerTimeOffset_k__BackingField", ty:
  // "double_t", modifiers: "", def_value: None, comment: None }]
