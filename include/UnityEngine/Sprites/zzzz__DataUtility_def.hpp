...
public:
  // Declarations
  /// @brief Method GetInnerUV, addr 0x69d90e0, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetInnerUV(::UnityEngine::Sprite* sprite);

  /// @brief Method GetMinSize, addr 0x69d911c, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetMinSize(::UnityEngine::Sprite* sprite);

  /// @brief Method GetOuterUV, addr 0x69d90f4, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetOuterUV(::UnityEngine::Sprite* sprite);

  /// @brief Method GetPadding, addr 0x69d9108, size 0x14, virtual false, abstract: false, final false
