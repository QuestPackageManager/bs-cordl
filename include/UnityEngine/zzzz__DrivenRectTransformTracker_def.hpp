...
public:
  // Declarations
  /// @brief Method Add, addr 0x2e3088c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x2e30890, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
