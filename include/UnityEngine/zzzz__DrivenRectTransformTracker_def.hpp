...
public:
  // Declarations
  /// @brief Method Add, addr 0x68c0580, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x68c0584, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
