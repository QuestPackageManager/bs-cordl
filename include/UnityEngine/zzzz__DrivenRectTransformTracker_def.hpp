...
public:
  // Declarations
  /// @brief Method Add, addr 0x48c25e8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x48c25ec, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
