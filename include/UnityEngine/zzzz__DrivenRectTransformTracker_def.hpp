...
public:
  // Declarations
  /// @brief Method Add, addr 0x6af0e18, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x6af0e1c, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
