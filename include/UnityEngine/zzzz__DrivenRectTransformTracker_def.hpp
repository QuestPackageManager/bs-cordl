...
public:
  // Declarations
  /// @brief Method Add, addr 0x3217674, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x3217678, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
