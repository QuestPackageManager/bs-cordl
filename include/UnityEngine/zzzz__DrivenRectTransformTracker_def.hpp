...
public:
  // Declarations
  /// @brief Method Add, addr 0x6929404, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x6929408, size 0x4, virtual false, abstract: false, final false
  inline void Clear();
