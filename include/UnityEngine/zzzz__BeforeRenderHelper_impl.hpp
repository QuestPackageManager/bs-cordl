...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Events::UnityAction*)>(&::UnityEngine::BeforeRenderHelper::RegisterCallback)> {
  ...
  constexpr static std::size_t addrs = 0x68b6f54;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Events::UnityAction*)>(&::UnityEngine::BeforeRenderHelper::UnregisterCallback)> {
  ...
  constexpr static std::size_t addrs = 0x68b729c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::BeforeRenderHelper::Invoke)> {
  ...
  constexpr static std::size_t addrs = 0x68b75bc;
...
::cordl_internals::setStaticField<::System::Collections::Generic::List_1<::UnityEngine::BeforeRenderHelper_OrderBlock>*, "s_OrderBlocks", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::BeforeRenderHelper*>::get>(std::forward<::System::Collections::Generic::List_1<::UnityEngine::BeforeRenderHelper_OrderBlock>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::UnityEngine::BeforeRenderHelper_OrderBlock>*, "s_OrderBlocks", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::BeforeRenderHelper*>::get>();
}
