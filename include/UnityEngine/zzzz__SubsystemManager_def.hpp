...
/// @brief Method ClearSubsystems, addr 0x69edb1c, size 0x220, virtual false, abstract: false, final false
static inline void ClearSubsystems() ;

/// @brief Method GetIntegratedSubsystemByPtr, addr 0x69edeb0, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method InitializeIntegratedSubsystem, addr 0x69eda24, size 0xf8, virtual false, abstract: false, final false
static inline void InitializeIntegratedSubsystem(::System::IntPtr  ptr, ::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method ReloadSubsystemsCompleted, addr 0x69ed940, size 0xe4, virtual false, abstract: false, final false
static inline void ReloadSubsystemsCompleted() ;

/// @brief Method ReloadSubsystemsStarted, addr 0x69ed85c, size 0xe4, virtual false, abstract: false, final false
static inline void ReloadSubsystemsStarted() ;

/// @brief Method RemoveDeprecatedSubsystem, addr 0x69ed6e0, size 0x88, virtual false, abstract: false, final false
static inline bool RemoveDeprecatedSubsystem(::UnityEngine::Subsystem*  subsystem) ;

/// @brief Method RemoveIntegratedSubsystemByPtr, addr 0x69ed298, size 0x168, virtual false, abstract: false, final false
static inline void RemoveIntegratedSubsystemByPtr(::System::IntPtr  ptr) ;

/// @brief Method RemoveStandaloneSubsystem, addr 0x69edfec, size 0x88, virtual false, abstract: false, final false
static inline bool RemoveStandaloneSubsystem(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*  subsystem) ;

/// @brief Method StaticConstructScriptingClassMap, addr 0x69edd3c, size 0x28, virtual false, abstract: false, final false
