...
// Ctor Parameters [CppParam { name: "_first_k__BackingField", ty: "::UnityW<::UnityEngine::SphereCollider>", modifiers: "", def_value: None }, CppParam { name: "_second_k__BackingField", ty: "::UnityW<::UnityEngine::SphereCollider>", modifiers: "", def_value: None }]
