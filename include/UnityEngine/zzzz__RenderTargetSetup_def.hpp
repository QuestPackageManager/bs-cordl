...
// Ctor Parameters [CppParam { name: "color", ty: "::ArrayW<::UnityEngine::RenderBuffer,::Array<::UnityEngine::RenderBuffer>*>", modifiers: "", def_value: None }, CppParam { name: "depth", ty: "::UnityEngine::RenderBuffer", modifiers: "", def_value: None }, CppParam { name: "mipLevel", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cubemapFace", ty: "::UnityEngine::CubemapFace", modifiers: "", def_value: None }, CppParam { name: "depthSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "colorLoad", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferLoadAction,::Array<::UnityEngine::Rendering::RenderBufferLoadAction>*>", modifiers: "", def_value: None }, CppParam { name: "colorStore", ty: "::ArrayW<::UnityEngine::Rendering::RenderBufferStoreAction,::Array<::UnityEngine::Rendering::RenderBufferStoreAction>*>", modifiers: "", def_value: None }, CppParam { name: "depthLoad", ty: "::UnityEngine::Rendering::RenderBufferLoadAction", modifiers: "", def_value: None }, CppParam { name: "depthStore", ty: "::UnityEngine::Rendering::RenderBufferStoreAction", modifiers: "", def_value: None }]
