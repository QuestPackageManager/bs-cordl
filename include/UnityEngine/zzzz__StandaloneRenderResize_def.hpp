...
DEFINE_IL2CPP_CLASS(::UnityEngine::StandaloneRenderResize, "UnityEngine", "StandaloneRenderResize");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::StandaloneRenderResize) == 0x4, "Size mismatch!");
