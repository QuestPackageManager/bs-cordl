...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::ILogHandler::*)(::UnityEngine::LogType, ::UnityEngine::Object*, ::StringW, ::ArrayW<::System::Object*>)>(
    &::UnityEngine::ILogHandler::LogFormat)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::ILogHandler*>(), { ::i2c::class_of<::UnityEngine::ILogHandler*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::ILogHandler::*)(::System::Exception*, ::UnityEngine::Object*)>(&::UnityEngine::ILogHandler::LogException)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::ILogHandler*>(), { ::i2c::class_of<::UnityEngine::ILogHandler*>(), 1 }));
    return ___internal_method;
  }
};
...
inline void UnityEngine::ILogHandler::LogException(::System::Exception* exception, ::UnityEngine::Object* context) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::ILogHandler*>(), 1 })));
