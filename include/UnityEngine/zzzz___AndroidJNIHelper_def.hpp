...
public:
  // Declarations
  /// @brief Method Box, addr 0x2dc7ea0, size 0x958, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToJNIArray, addr 0x2dcc458, size 0x9b4, virtual false, abstract: false, final false
  static inline void* ConvertToJNIArray(::System::Array* array);

  /// @brief Method CreateJNIArgArray, addr 0x2dcbe4c, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateJavaProxy, addr 0x2dcb8dc, size 0x78, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(void* delegateHandle, ::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x2dcb954, size 0x60, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method DeleteJNIArgArray, addr 0x2dcd4a8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2dcd6b0, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetConstructorID, addr 0x2dcd800, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFieldID, addr 0x2dcdd0c, size 0x318, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* jclass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodID, addr 0x2dcd7c8, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMethodID, addr 0x2dcda00, size 0x210, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodIDFallback, addr 0x2dcdc10, size 0xfc, virtual false, abstract: false, final false
  static inline void* GetMethodIDFallback(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetSignature, addr 0x2dcd6d0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignature, addr 0x2dce060, size 0xe74, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method InvokeJavaProxyMethod, addr 0x2dcb9b4, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method Unbox, addr 0x2dc8bac, size 0x8f8, virtual false, abstract: false, final false
  static inline ::System::Object* Unbox(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method UnboxArray, addr 0x2dcce10, size 0x698, virtual false, abstract: false, final false
  static inline ::System::Object* UnboxArray(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method .ctor, addr 0x2dceed4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
