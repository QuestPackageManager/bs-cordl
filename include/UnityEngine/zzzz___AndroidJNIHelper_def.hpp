...
public:
  // Declarations
  /// @brief Method CreateJavaProxy, addr 0x2c84fd0, size 0x78, virtual false, abstract: false, final false
  static inline void* CreateJavaProxy(void* delegateHandle, ::UnityEngine::AndroidJavaProxy* proxy);

  /// @brief Method CreateJavaRunnable, addr 0x2c85048, size 0x60, virtual false, abstract: false, final false
  static inline void* CreateJavaRunnable(::UnityEngine::AndroidJavaRunnable* jrunnable);

  /// @brief Method InvokeJavaProxyMethod, addr 0x2c850a8, size 0x498, virtual false, abstract: false, final false
  static inline void* InvokeJavaProxyMethod(::UnityEngine::AndroidJavaProxy* proxy, void* jmethodName, void* jargs);

  /// @brief Method CreateJNIArgArray, addr 0x2c85540, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnboxArray, addr 0x2c86504, size 0x698, virtual false, abstract: false, final false
  static inline ::System::Object* UnboxArray(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method Unbox, addr 0x2c822a0, size 0x8f8, virtual false, abstract: false, final false
  static inline ::System::Object* Unbox(::UnityEngine::AndroidJavaObject* obj);

  /// @brief Method Box, addr 0x2c81594, size 0x958, virtual false, abstract: false, final false
  static inline ::UnityEngine::AndroidJavaObject* Box(::System::Object* obj);

  /// @brief Method DeleteJNIArgArray, addr 0x2c86b9c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertToJNIArray, addr 0x2c85b4c, size 0x9b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2c86da4, size 0x20, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method GetMethodID, addr 0x2c86ebc, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConstructorID, addr 0x2c86ef4, size 0x200, virtual false, abstract: false, final false
  static inline void* GetConstructorID(void* jclass, ::StringW signature);

  /// @brief Method GetMethodID, addr 0x2c870f4, size 0x210, virtual false, abstract: false, final false
  static inline void* GetMethodID(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetMethodIDFallback, addr 0x2c87304, size 0xfc, virtual false, abstract: false, final false
  static inline void* GetMethodIDFallback(void* jclass, ::StringW methodName, ::StringW signature, bool isStatic);

  /// @brief Method GetFieldID, addr 0x2c87400, size 0x318, virtual false, abstract: false, final false
  static inline void* GetFieldID(void* jclass, ::StringW fieldName, ::StringW signature, bool isStatic);

  /// @brief Method GetSignature, addr 0x2c87754, size 0xe74, virtual false, abstract: false, final false
  static inline ::StringW GetSignature(::System::Object* obj);

  /// @brief Method GetSignature, addr 0x2c86dc4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c885c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
