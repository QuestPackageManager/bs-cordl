...
public:
  ...
  /// @brief Method Equals, addr 0x68ea6e4, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x68ea7a4, size 0x5c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::BoneWeight1 other);

  /// @brief Method GetHashCode, addr 0x68ea800, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_boneIndex, addr 0x68ea6dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_boneIndex();

  /// @brief Method get_weight, addr 0x68ea6d4, size 0x8, virtual false, abstract: false, final false
