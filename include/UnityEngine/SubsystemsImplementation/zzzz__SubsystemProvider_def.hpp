...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubsystemProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubsystemProvider(SubsystemProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubsystemProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubsystemProvider(SubsystemProviderconst&) = delete;
