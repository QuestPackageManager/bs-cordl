...
public:
  ...
  /// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x6bb5e4c, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method get_id, addr 0x6bb5e44, size 0x8, virtual true, abstract: false, final true
