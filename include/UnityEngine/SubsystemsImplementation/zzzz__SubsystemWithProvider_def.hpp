...
public:
  ...
  /// @brief Method Destroy, addr 0x69850f0, size 0x80, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method Start, addr 0x698507c, size 0x3c, virtual true, abstract: false, final true
  inline void Start();

  /// @brief Method Stop, addr 0x69850b8, size 0x38, virtual true, abstract: false, final true
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x6985188, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_providerBase, addr 0x6985180, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* get_providerBase();

  /// @brief Method get_running, addr 0x6985170, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_running, addr 0x6985178, size 0x8, virtual false, abstract: false, final false
