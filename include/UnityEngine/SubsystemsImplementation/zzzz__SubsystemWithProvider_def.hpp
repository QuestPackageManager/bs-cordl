...
public:
  ...
  /// @brief Method Destroy, addr 0x491c1d4, size 0x7c, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method Start, addr 0x491c160, size 0x3c, virtual true, abstract: false, final true
  inline void Start();

  /// @brief Method Stop, addr 0x491c19c, size 0x38, virtual true, abstract: false, final true
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x491c26c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_providerBase, addr 0x491c264, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* get_providerBase();

  /// @brief Method get_running, addr 0x491c250, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_running, addr 0x491c258, size 0xc, virtual false, abstract: false, final false
