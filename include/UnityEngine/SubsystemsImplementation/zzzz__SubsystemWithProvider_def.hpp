...
public:
  ...
  /// @brief Method Destroy, addr 0x6a6087c, size 0x80, virtual true, abstract: false, final true
  inline void Destroy();
  ...
  /// @brief Method Start, addr 0x6a60808, size 0x3c, virtual true, abstract: false, final true
  inline void Start();

  /// @brief Method Stop, addr 0x6a60844, size 0x38, virtual true, abstract: false, final true
  inline void Stop();
  ...
  /// @brief Method .ctor, addr 0x6a60914, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_providerBase, addr 0x6a6090c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* get_providerBase();

  /// @brief Method get_running, addr 0x6a608fc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_running, addr 0x6a60904, size 0x8, virtual false, abstract: false, final false
