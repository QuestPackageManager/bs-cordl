...
public:
  ...
  /// @brief Field LeftKnee value: static_cast<int32_t>(0x0)
  static ::UnityEngine::AvatarIKHint const LeftKnee;

  /// @brief Field RightKnee value: static_cast<int32_t>(0x1)
  static ::UnityEngine::AvatarIKHint const RightKnee;

  /// @brief Field LeftElbow value: static_cast<int32_t>(0x2)
  static ::UnityEngine::AvatarIKHint const LeftElbow;

  /// @brief Field RightElbow value: static_cast<int32_t>(0x3)
