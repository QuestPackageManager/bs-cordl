...
/// @brief Method get_bounceMinVelocity, addr 0x69a75f0, size 0x8, virtual false, abstract: false, final false
inline float_t get_bounceMinVelocity() ;

/// @brief Method get_bounciness, addr 0x69a75e0, size 0x8, virtual false, abstract: false, final false
inline float_t get_bounciness() ;

/// @brief Method get_contactDistance, addr 0x69a7600, size 0x8, virtual false, abstract: false, final false
inline float_t get_contactDistance() ;

/// @brief Method get_max, addr 0x69a75d0, size 0x8, virtual false, abstract: false, final false
inline float_t get_max() ;

/// @brief Method get_min, addr 0x69a75c0, size 0x8, virtual false, abstract: false, final false
inline float_t get_min() ;

/// @brief Method set_bounceMinVelocity, addr 0x69a75f8, size 0x8, virtual false, abstract: false, final false
inline void set_bounceMinVelocity(float_t  value) ;

/// @brief Method set_bounciness, addr 0x69a75e8, size 0x8, virtual false, abstract: false, final false
inline void set_bounciness(float_t  value) ;

/// @brief Method set_contactDistance, addr 0x69a7608, size 0x8, virtual false, abstract: false, final false
inline void set_contactDistance(float_t  value) ;

/// @brief Method set_max, addr 0x69a75d8, size 0x8, virtual false, abstract: false, final false
inline void set_max(float_t  value) ;

/// @brief Method set_min, addr 0x69a75c8, size 0x8, virtual false, abstract: false, final false
