...
public:
  ...
  /// @brief Method Internal_CallTetrahedralizationCompletedFunction addr 0x2cb7238 size 0x64 virtual false final false
  static inline void Internal_CallTetrahedralizationCompletedFunction();

  /// @brief Method Internal_CallNeedsRetetrahedralizationFunction addr 0x2cb729c size 0x64 virtual false final false
