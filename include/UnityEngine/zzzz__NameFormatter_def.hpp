...
public:
  // Declarations
  /// @brief Method FormatVariableName, addr 0x699bae4, size 0x1ac, virtual false, abstract: false, final false
  static inline ::StringW FormatVariableName(::StringW name);

  /// @brief Method FormatVariableName_Injected, addr 0x699bc9c, size 0x44, virtual false, abstract: false, final false
