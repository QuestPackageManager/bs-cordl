...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x4910a18, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapCapsuleBatch, addr 0x4910bfc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapCapsuleBatch_Injected, addr 0x4910c98, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49109ac, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49108f4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_physicsScene, addr 0x4910a08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method get_point0, addr 0x49109c8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point0();

  /// @brief Method get_point1, addr 0x49109e0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point1();

  /// @brief Method get_radius, addr 0x49109f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_physicsScene, addr 0x4910a10, size 0x8, virtual false, abstract: false, final false
  inline void set_physicsScene(::UnityEngine::PhysicsScene value);

  /// @brief Method set_point0, addr 0x49109d4, size 0xc, virtual false, abstract: false, final false
  inline void set_point0(::UnityEngine::Vector3 value);

  /// @brief Method set_point1, addr 0x49109ec, size 0xc, virtual false, abstract: false, final false
  inline void set_point1(::UnityEngine::Vector3 value);

  /// @brief Method set_radius, addr 0x4910a00, size 0x8, virtual false, abstract: false, final false
