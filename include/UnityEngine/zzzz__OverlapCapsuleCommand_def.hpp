...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x6a3fb18, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapCapsuleBatch, addr 0x6a3fcc4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapCapsuleBatch_Injected, addr 0x6a3fd60, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a3faac, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a3f9ec, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_physicsScene, addr 0x6a3fb08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method get_point0, addr 0x6a3fac8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point0();

  /// @brief Method get_point1, addr 0x6a3fae0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_point1();

  /// @brief Method get_radius, addr 0x6a3faf8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_physicsScene, addr 0x6a3fb10, size 0x8, virtual false, abstract: false, final false
  inline void set_physicsScene(::UnityEngine::PhysicsScene value);

  /// @brief Method set_point0, addr 0x6a3fad4, size 0xc, virtual false, abstract: false, final false
  inline void set_point0(::UnityEngine::Vector3 value);

  /// @brief Method set_point1, addr 0x6a3faec, size 0xc, virtual false, abstract: false, final false
  inline void set_point1(::UnityEngine::Vector3 value);

  /// @brief Method set_radius, addr 0x6a3fb00, size 0x8, virtual false, abstract: false, final false
