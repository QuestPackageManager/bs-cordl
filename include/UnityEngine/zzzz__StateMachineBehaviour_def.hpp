...
public:
  ...
  /// @brief Method OnStateEnter, addr 0x484ddd4, size 0x4, virtual true, abstract: false, final false
  inline void OnStateEnter(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateEnter, addr 0x484ddf0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateExit, addr 0x484dddc, size 0x4, virtual true, abstract: false, final false
  inline void OnStateExit(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateExit, addr 0x484ddf8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateIK, addr 0x484dde4, size 0x4, virtual true, abstract: false, final false
  inline void OnStateIK(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateIK, addr 0x484de00, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMachineEnter, addr 0x484dde8, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMachineEnter(::UnityEngine::Animator* animator, int32_t stateMachinePathHash);

  /// @brief Method OnStateMachineEnter, addr 0x484de04, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMachineExit, addr 0x484ddec, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMachineExit(::UnityEngine::Animator* animator, int32_t stateMachinePathHash);

  /// @brief Method OnStateMachineExit, addr 0x484de08, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateMove, addr 0x484dde0, size 0x4, virtual true, abstract: false, final false
  inline void OnStateMove(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateMove, addr 0x484ddfc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnStateUpdate, addr 0x484ddd8, size 0x4, virtual true, abstract: false, final false
  inline void OnStateUpdate(::UnityEngine::Animator* animator, ::UnityEngine::AnimatorStateInfo stateInfo, int32_t layerIndex);

  /// @brief Method OnStateUpdate, addr 0x484ddf4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x484de0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
