...
public:
  ...
  // Ctor Parameters [CppParam { name: "order", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "callback", ty: "::UnityEngine::Events::UnityAction*", modifiers: "",
...
public:
  ...
  /// @brief Method GetUpdateOrder, addr 0x6a83860, size 0x114, virtual false, abstract: false, final false
  static inline int32_t GetUpdateOrder(::UnityEngine::Events::UnityAction* callback);

  /// @brief Method Invoke, addr 0x6a83fdc, size 0x1b4, virtual false, abstract: false, final false
  static inline void Invoke();

  /// @brief Method RegisterCallback, addr 0x6a83974, size 0x348, virtual false, abstract: false, final false
  static inline void RegisterCallback(::UnityEngine::Events::UnityAction* callback);

  /// @brief Method UnregisterCallback, addr 0x6a83cbc, size 0x320, virtual false, abstract: false, final false
...
public:
  ...
  BeforeRenderHelper(BeforeRenderHelperconst&) = delete;
