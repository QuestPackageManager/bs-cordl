...
public:
  ...
  /// @brief Method .ctor, addr 0x69f5df4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearUnusedTextHandles, addr 0x69f5afc, size 0x260, virtual false, abstract: false, final false
  static inline void ClearUnusedTextHandles();

  /// @brief Method ConvertGUIStyleToGenerationSettings, addr 0x69f5318, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method EmptyManagedCache, addr 0x69f3444, size 0xb0, virtual false, abstract: false, final false
  static inline void EmptyManagedCache();

  /// @brief Method GetLineHeight, addr 0x69f28b8, size 0xe8, virtual false, abstract: false, final false
  static inline float_t GetLineHeight(::UnityEngine::GUIStyle* style);

  /// @brief Method GetPreferredSize, addr 0x69f2ed4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetPreferredSize();

  /// @brief Method GetTextHandle, addr 0x69f575c, size 0x388, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextHandle, addr 0x69f2ca4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextHandle, addr 0x69f3274, size 0x130, virtual false, abstract: false, final false
  static inline ::UnityEngine::IMGUITextHandle* GetTextHandle(::UnityEngine::GUIStyle* style, ::UnityEngine::Rect position, ::StringW content, ::UnityEngine::Color32 textColor,
                                                              ::ByRef<bool> isCached);

  /// @brief Method LegacyClippingToNewOverflow, addr 0x69f5e00, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldCleanup, addr 0x69f5ae4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69f5d5c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
