...
DEFINE_IL2CPP_CLASS(::UnityEngine::NetworkReachability, "UnityEngine", "NetworkReachability");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::NetworkReachability) == 0x4, "Size mismatch!");
