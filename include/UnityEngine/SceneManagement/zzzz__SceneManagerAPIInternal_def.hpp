...
public:
// Declarations
/// @brief Method GetNumScenesInBuildSettings, addr 0x6935218, size 0x28, virtual false, abstract: false, final false
static inline int32_t GetNumScenesInBuildSettings() ;

/// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x6935240, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method LoadSceneAsyncNameIndexInternal_Injected, addr 0x6935430, size 0x5c, virtual false, abstract: false, final false
static inline ::System::IntPtr LoadSceneAsyncNameIndexInternal_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper>  sceneName, int32_t  sceneBuildIndex, ::ByRef<::UnityEngine::SceneManagement::LoadSceneParameters>  parameters, bool  mustCompleteNextFrame) ;
