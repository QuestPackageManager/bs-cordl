...
public:
  // Declarations
  /// @brief Method GetNumScenesInBuildSettings, addr 0x6afc68c, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetNumScenesInBuildSettings();

  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x6afc6b4, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal_Injected, addr 0x6afc8a4, size 0x5c, virtual false, abstract: false, final false
