...
public:
  // Declarations
  /// @brief Method GetNumScenesInBuildSettings, addr 0x69a7434, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetNumScenesInBuildSettings();

  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x69a745c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal_Injected, addr 0x69a764c, size 0x5c, virtual false, abstract: false, final false
