...
public:
  // Declarations
  /// @brief Method GetNumScenesInBuildSettings, addr 0x322b698, size 0x28, virtual false, abstract: false, final false
  static inline int32_t GetNumScenesInBuildSettings();

  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x322b6c0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal_Injected, addr 0x322b720, size 0x5c, virtual false, abstract: false, final false
