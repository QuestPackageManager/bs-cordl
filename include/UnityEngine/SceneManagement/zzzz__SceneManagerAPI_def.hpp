...
public:
  ...
  /// @brief Method GetNumScenesInBuildSettings, addr 0x48c0dc4, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetNumScenesInBuildSettings();

  /// @brief Method LoadFirstScene, addr 0x48c0e4c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::AsyncOperation* LoadFirstScene(bool mustLoadAsync);

  /// @brief Method LoadSceneAsyncByNameOrIndex, addr 0x48c0dec, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x48c0dbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ActiveAPI, addr 0x48c0cbc, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::SceneManagerAPI* get_ActiveAPI();

  /// @brief Method get_overrideAPI, addr 0x48c0d64, size 0x58, virtual false, abstract: false, final false
