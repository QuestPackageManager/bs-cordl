...
namespace UnityEngine::SceneManagement {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9143)), TypeDefinitionIndex(TypeDefinitionIndex(9144))]
...
public:
  ...
  /// @brief Method set_loadSceneMode, addr 0x2cfb13c, size 0x8, virtual false, abstract: false, final false
  inline void set_loadSceneMode(::UnityEngine::SceneManagement::LoadSceneMode value);

  /// @brief Method .ctor, addr 0x2cfb144, size 0x8, virtual false, abstract: false, final false
