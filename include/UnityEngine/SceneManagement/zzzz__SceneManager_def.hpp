...
public:
  ...
  /// @brief Method add_sceneLoaded addr 0x2b87e5c size 0xf0 virtual false final false
  ...
  /// @brief Method remove_sceneLoaded addr 0x2b87f4c size 0xf0 virtual false final false
  ...
  /// @brief Method add_sceneUnloaded addr 0x2b8803c size 0xf4 virtual false final false
  static inline void add_sceneUnloaded(::UnityEngine::Events::UnityAction_1<::UnityEngine::SceneManagement::Scene>* value);

  /// @brief Method remove_sceneUnloaded addr 0x2b88130 size 0xf4 virtual false final false
  static inline void remove_sceneUnloaded(::UnityEngine::Events::UnityAction_1<::UnityEngine::SceneManagement::Scene>* value);

  /// @brief Method LoadScene addr 0x2b88224 size 0x68 virtual false final false
  static inline void LoadScene(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene addr 0x2b8832c size 0x58 virtual false final false
  static inline void LoadScene(::StringW sceneName);

  /// @brief Method LoadScene addr 0x2b8828c size 0xa0 virtual false final false
  ...
  /// @brief Method LoadScene addr 0x2b88514 size 0x68 virtual false final false
  static inline void LoadScene(int32_t sceneBuildIndex, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene addr 0x2b8857c size 0xa0 virtual false final false
  ...
  /// @brief Method LoadSceneAsync addr 0x2b8861c size 0x68 virtual false final false
  ...
  /// @brief Method LoadSceneAsync addr 0x2b88684 size 0x6c virtual false final false
  ...
  /// @brief Method LoadSceneAsync addr 0x2b886f0 size 0x68 virtual false final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync addr 0x2b887c4 size 0x58 virtual false final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName);

  /// @brief Method LoadSceneAsync addr 0x2b88758 size 0x6c virtual false final false
  ...
  /// @brief Method UnloadSceneAsync addr 0x2b8881c size 0x74 virtual false final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::StringW sceneName);

  /// @brief Method UnloadSceneAsync addr 0x2b88978 size 0x58 virtual false final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method UnloadSceneAsync addr 0x2b88a58 size 0x64 virtual false final false
  ...
  /// @brief Method Internal_SceneLoaded addr 0x2b88abc size 0xb0 virtual false final false
  ...
  /// @brief Method Internal_SceneUnloaded addr 0x2b88b6c size 0x9c virtual false final false
  static inline void Internal_SceneUnloaded(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method Internal_ActiveSceneChanged addr 0x2b88c08 size 0xb0 virtual false final false
  ...
  /// @brief Method get_sceneCount addr 0x2b88460 size 0x28 virtual false final false
  static inline int32_t get_sceneCount();

  /// @brief Method get_sceneCountInBuildSettings addr 0x2b794f0 size 0x60 virtual false final false
  static inline int32_t get_sceneCountInBuildSettings();

  /// @brief Method GetActiveScene addr 0x2b88d60 size 0x7c virtual false final false
  static inline ::UnityEngine::SceneManagement::Scene GetActiveScene();

  /// @brief Method SetActiveScene addr 0x2b88e18 size 0x7c virtual false final false
  static inline bool SetActiveScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method GetSceneByName addr 0x2b88ed0 size 0x8c virtual false final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneByName(::StringW name);

  /// @brief Method GetSceneAt addr 0x2b88488 size 0x8c virtual false final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneAt(int32_t index);

  /// @brief Method UnloadSceneAsyncInternal addr 0x2b889d0 size 0x88 virtual false final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal addr 0x2b88384 size 0xdc virtual false final false
  ...
  /// @brief Method UnloadSceneNameIndexInternal addr 0x2b88890 size 0xe8 virtual false final false
  ...
  /// @brief Method MoveGameObjectToScene addr 0x2b89028 size 0x88 virtual false final false
  static inline void MoveGameObjectToScene(::UnityEngine::GameObject* go, ::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method LoadFirstScene_Internal addr 0x2b890f4 size 0x68 virtual false final false
  static inline ::UnityEngine::AsyncOperation* LoadFirstScene_Internal(bool async);

  /// @brief Method GetActiveScene_Injected addr 0x2b88ddc size 0x3c virtual false final false
  static inline void GetActiveScene_Injected(ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method SetActiveScene_Injected addr 0x2b88e94 size 0x3c virtual false final false
  static inline bool SetActiveScene_Injected(ByRef<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method GetSceneByName_Injected addr 0x2b88f5c size 0x44 virtual false final false
  static inline void GetSceneByName_Injected(::StringW name, ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneAt_Injected addr 0x2b88fa0 size 0x44 virtual false final false
  static inline void GetSceneAt_Injected(int32_t index, ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method UnloadSceneAsyncInternal_Injected addr 0x2b88fe4 size 0x44 virtual false final false
  ...
  /// @brief Method MoveGameObjectToScene_Injected addr 0x2b890b0 size 0x44 virtual false final false
