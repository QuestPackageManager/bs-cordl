...
public:
  ...
  /// @brief Method add_sceneLoaded, addr 0x2cef290, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sceneLoaded, addr 0x2cef380, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneUnloaded, addr 0x2cef470, size 0xf4, virtual false, abstract: false, final false
  static inline void add_sceneUnloaded(::UnityEngine::Events::UnityAction_1<::UnityEngine::SceneManagement::Scene>* value);

  /// @brief Method remove_sceneUnloaded, addr 0x2cef564, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_sceneUnloaded(::UnityEngine::Events::UnityAction_1<::UnityEngine::SceneManagement::Scene>* value);

  /// @brief Method LoadScene, addr 0x2cef658, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene, addr 0x2cef760, size 0x58, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName);

  /// @brief Method LoadScene, addr 0x2cef6c0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadScene, addr 0x2cef94c, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(int32_t sceneBuildIndex, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene, addr 0x2cef9b4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x2cefa54, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x2cefabc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x2cefb28, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync, addr 0x2cefbfc, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName);

  /// @brief Method LoadSceneAsync, addr 0x2cefb90, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneAsync, addr 0x2cefc54, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::StringW sceneName);

  /// @brief Method UnloadSceneAsync, addr 0x2cefdb4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method UnloadSceneAsync, addr 0x2cefe94, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneLoaded, addr 0x2cefef8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneUnloaded, addr 0x2ceffa8, size 0x9c, virtual false, abstract: false, final false
  static inline void Internal_SceneUnloaded(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method Internal_ActiveSceneChanged, addr 0x2cf0044, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sceneCount, addr 0x2cef898, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_sceneCount();

  /// @brief Method get_sceneCountInBuildSettings, addr 0x2cded48, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_sceneCountInBuildSettings();

  /// @brief Method GetActiveScene, addr 0x2cf00f4, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetActiveScene();

  /// @brief Method SetActiveScene, addr 0x2cf01ac, size 0x7c, virtual false, abstract: false, final false
  static inline bool SetActiveScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method GetSceneByName, addr 0x2cf0264, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneByName(::StringW name);

  /// @brief Method GetSceneAt, addr 0x2cef8c0, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneAt(int32_t index);

  /// @brief Method UnloadSceneAsyncInternal, addr 0x2cefe0c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x2cef7b8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneNameIndexInternal, addr 0x2cefcc8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveGameObjectToScene, addr 0x2cf03bc, size 0x88, virtual false, abstract: false, final false
  static inline void MoveGameObjectToScene(::UnityEngine::GameObject* go, ::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method LoadFirstScene_Internal, addr 0x2cf0488, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadFirstScene_Internal(bool async);

  /// @brief Method GetActiveScene_Injected, addr 0x2cf0170, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveScene_Injected(ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method SetActiveScene_Injected, addr 0x2cf0228, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetActiveScene_Injected(ByRef<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method GetSceneByName_Injected, addr 0x2cf02f0, size 0x44, virtual false, abstract: false, final false
  static inline void GetSceneByName_Injected(::StringW name, ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneAt_Injected, addr 0x2cf0334, size 0x44, virtual false, abstract: false, final false
  static inline void GetSceneAt_Injected(int32_t index, ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method UnloadSceneAsyncInternal_Injected, addr 0x2cf0378, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveGameObjectToScene_Injected, addr 0x2cf0444, size 0x44, virtual false, abstract: false, final false
