...
public:
  ...
  /// @brief Method GetActiveScene, addr 0x69a78e0, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetActiveScene();

  /// @brief Method GetActiveScene_Injected, addr 0x69a7960, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveScene_Injected(::ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneAt, addr 0x69a7bf8, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneAt(int32_t index);

  /// @brief Method GetSceneAt_Injected, addr 0x69a7c88, size 0x44, virtual false, abstract: false, final false
  static inline void GetSceneAt_Injected(int32_t index, ::ByRef<::UnityEngine::SceneManagement::Scene> ret);

  /// @brief Method GetSceneByName, addr 0x69a7a58, size 0x15c, virtual false, abstract: false, final false
  static inline ::UnityEngine::SceneManagement::Scene GetSceneByName(::StringW name);

  /// @brief Method GetSceneByName_Injected, addr 0x69a7bb4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_ActiveSceneChanged, addr 0x69a8cc0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneLoaded, addr 0x69a8b6c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Internal_SceneUnloaded, addr 0x69a8c20, size 0xa0, virtual false, abstract: false, final false
  static inline void Internal_SceneUnloaded(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method LoadFirstScene_Internal, addr 0x69a7f9c, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadFirstScene_Internal(bool async);

  /// @brief Method LoadScene, addr 0x69a8804, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadScene, addr 0x69a86a8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadScene, addr 0x69a879c, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(int32_t sceneBuildIndex, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadScene, addr 0x69a8740, size 0x5c, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName);

  /// @brief Method LoadScene, addr 0x69a8638, size 0x68, virtual false, abstract: false, final false
  static inline void LoadScene(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync, addr 0x69a889c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x69a8904, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsync, addr 0x69a8a4c, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName);

  /// @brief Method LoadSceneAsync, addr 0x69a8974, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* LoadSceneAsync(::StringW sceneName, ::UnityEngine::SceneManagement::LoadSceneMode mode);

  /// @brief Method LoadSceneAsync, addr 0x69a89dc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSceneAsyncNameIndexInternal, addr 0x69a7da8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveGameObjectToScene, addr 0x69a7e8c, size 0xcc, virtual false, abstract: false, final false
  static inline void MoveGameObjectToScene(::UnityEngine::GameObject* go, ::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method MoveGameObjectToScene_Injected, addr 0x69a7f58, size 0x44, virtual false, abstract: false, final false
  static inline void MoveGameObjectToScene_Injected(::System::IntPtr go, ::ByRef<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method SetActiveScene, addr 0x69a799c, size 0x80, virtual false, abstract: false, final false
  static inline bool SetActiveScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method SetActiveScene_Injected, addr 0x69a7a1c, size 0x3c, virtual false, abstract: false, final false
  static inline bool SetActiveScene_Injected(::ByRef<::UnityEngine::SceneManagement::Scene> scene);

  /// @brief Method UnloadSceneAsync, addr 0x69a8aa8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::AsyncOperation* UnloadSceneAsync(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method UnloadSceneAsync, addr 0x69a8b04, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneAsyncInternal, addr 0x69a7ccc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSceneAsyncInternal_Injected, addr 0x69a7d64, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method add_activeSceneChanged, addr 0x69a8428, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneLoaded, addr 0x69a8008, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sceneUnloaded, addr 0x69a8218, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sceneCount, addr 0x69a7854, size 0x28, virtual false, abstract: false, final false
  static inline int32_t get_sceneCount();

  /// @brief Method get_sceneCountInBuildSettings, addr 0x69a787c, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_sceneCountInBuildSettings();

  /// @brief Method remove_activeSceneChanged, addr 0x69a8530, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sceneLoaded, addr 0x69a8110, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sceneUnloaded, addr 0x69a8320, size 0x108, virtual false, abstract: false, final false
