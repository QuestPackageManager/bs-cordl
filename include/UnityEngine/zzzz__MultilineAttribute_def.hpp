...
// Write type traits
MARK_REF_T(::UnityEngine::MultilineAttribute*);
DEFINE_IL2CPP_CLASS(::UnityEngine::MultilineAttribute*, "UnityEngine", "MultilineAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad8060, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultilineAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultilineAttribute(MultilineAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultilineAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultilineAttribute(MultilineAttributeconst&) = delete;
...
static_assert(sizeof(::UnityEngine::MultilineAttribute) == 0x20, "Size mismatch!");
