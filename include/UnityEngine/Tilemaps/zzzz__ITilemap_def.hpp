...
public:
  ...
  /// @brief Method CreateInstance, addr 0x4956390, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Tilemaps::ITilemap* CreateInstance();

  /// @brief Method FindAllRefreshPositions, addr 0x49563f8, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllTileData, addr 0x4956754, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshTile, addr 0x49561e8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49561e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
