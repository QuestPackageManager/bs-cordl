...
// CppParam { name: "m_AnimationSpeed", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_AnimationStartTime", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam
// { name: "m_Flags", ty: "::UnityEngine::Tilemaps::TileAnimationFlags", modifiers: "", def_value: Some("{}") }]
