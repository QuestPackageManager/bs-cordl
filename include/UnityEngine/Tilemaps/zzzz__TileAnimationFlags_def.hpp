...
// Type: UnityEngine.Tilemaps::TileAnimationFlags
...
public:
  ...
  /// @brief Field LoopOnce value: static_cast<int32_t>(0x1)
  ...
  /// @brief Field PauseAnimation value: static_cast<int32_t>(0x2)
  static ::UnityEngine::Tilemaps::TileAnimationFlags const PauseAnimation;

  /// @brief Field UpdatePhysics value: static_cast<int32_t>(0x4)
