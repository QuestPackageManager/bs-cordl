...
public:
  // Declarations
  /// @brief Method RegisterSpriteAtlasRegistered addr 0x2d50138 size 0x80 virtual false final false
  inline void RegisterSpriteAtlasRegistered();

  /// @brief Method UnregisterSpriteAtlasRegistered addr 0x2d501b8 size 0x80 virtual false final false
  inline void UnregisterSpriteAtlasRegistered();

  /// @brief Method OnSpriteAtlasRegistered addr 0x2d50238 size 0x44 virtual false final false
