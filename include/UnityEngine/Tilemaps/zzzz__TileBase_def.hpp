...
public:
  // Declarations
  /// @brief Method GetTileAnimationData, addr 0x49598fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetTileAnimationDataNoRef, addr 0x4959904, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTileAnimationDataRef, addr 0x4959948, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTileData, addr 0x49598ac, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetTileDataNoRef, addr 0x49598b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshTile, addr 0x4959894, size 0x18, virtual true, abstract: false, final false
  inline void RefreshTile(::UnityEngine::Vector3Int position, ::UnityEngine::Tilemaps::ITilemap* tilemap);

  /// @brief Method StartUp, addr 0x4959970, size 0x8, virtual true, abstract: false, final false
  inline bool StartUp(::UnityEngine::Vector3Int position, ::UnityEngine::Tilemaps::ITilemap* tilemap, ::UnityEngine::GameObject* go);

  /// @brief Method StartUpRef, addr 0x4959978, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x495988c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
