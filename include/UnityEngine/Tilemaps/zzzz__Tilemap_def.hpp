...
public:
  ...
  /// @brief Method get_layoutGrid addr 0x2d4f8d4 size 0x3c virtual false final false
  inline ::UnityEngine::Grid* get_layoutGrid();

  /// @brief Method get_cellBounds addr 0x2d4f910 size 0x84 virtual false final false
  inline ::UnityEngine::BoundsInt get_cellBounds();

  /// @brief Method get_origin addr 0x2d4f994 size 0x5c virtual false final false
  inline ::UnityEngine::Vector3Int get_origin();

  /// @brief Method get_size addr 0x2d4f9f0 size 0x5c virtual false final false
  inline ::UnityEngine::Vector3Int get_size();

  /// @brief Method get_tileAnchor addr 0x2d4fad4 size 0x5c virtual false final false
  inline ::UnityEngine::Vector3 get_tileAnchor();

  /// @brief Method get_orientationMatrix addr 0x2d4fb74 size 0x6c virtual false final false
  inline ::UnityEngine::Matrix4x4 get_orientationMatrix();

  /// @brief Method GetTileAsset addr 0x2d4fc24 size 0x54 virtual false final false
  ...
  /// @brief Method GetTileAssetsBlock addr 0x2d4fcbc size 0x60 virtual false final false
  ...
  /// @brief Method GetTilesBlock addr 0x2d4fd70 size 0x194 virtual false final false
  ...
  /// @brief Method HasTile addr 0x2d4ff04 size 0x84 virtual false final false
  inline bool HasTile(::UnityEngine::Vector3Int position);

  /// @brief Method RefreshTile addr 0x2d4ff88 size 0x54 virtual false final false
  inline void RefreshTile(::UnityEngine::Vector3Int position);

  /// @brief Method RefreshTilesNative addr 0x2d50020 size 0x54 virtual false final false
  inline void RefreshTilesNative(::cordl_internals::Ptr<void> positions, int32_t count);

  /// @brief Method GetUsedTilesCount addr 0x2d50074 size 0x3c virtual false final false
  inline int32_t GetUsedTilesCount();

  /// @brief Method GetUsedTilesNonAlloc addr 0x2d500b0 size 0x44 virtual false final false
  inline int32_t GetUsedTilesNonAlloc(::ArrayW<::UnityEngine::Tilemaps::TileBase*, ::Array<::UnityEngine::Tilemaps::TileBase*>*> usedTiles);

  /// @brief Method Internal_GetUsedTilesNonAlloc addr 0x2d500f4 size 0x44 virtual false final false
  inline int32_t Internal_GetUsedTilesNonAlloc(::ArrayW<::UnityEngine::Object*, ::Array<::UnityEngine::Object*>*> usedTiles);

  /// @brief Method get_origin_Injected addr 0x2d4fa4c size 0x44 virtual false final false
  inline void get_origin_Injected(ByRef<::UnityEngine::Vector3Int> ret);

  /// @brief Method get_size_Injected addr 0x2d4fa90 size 0x44 virtual false final false
  inline void get_size_Injected(ByRef<::UnityEngine::Vector3Int> ret);

  /// @brief Method get_tileAnchor_Injected addr 0x2d4fb30 size 0x44 virtual false final false
  inline void get_tileAnchor_Injected(ByRef<::UnityEngine::Vector3> ret);

  /// @brief Method get_orientationMatrix_Injected addr 0x2d4fbe0 size 0x44 virtual false final false
  inline void get_orientationMatrix_Injected(ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method GetTileAsset_Injected addr 0x2d4fc78 size 0x44 virtual false final false
  inline ::UnityEngine::Object* GetTileAsset_Injected(ByRef<::UnityEngine::Vector3Int> position);

  /// @brief Method GetTileAssetsBlock_Injected addr 0x2d4fd1c size 0x54 virtual false final false
  ...
  /// @brief Method RefreshTile_Injected addr 0x2d4ffdc size 0x44 virtual false final false
