...
public:
  ...
  /// @brief Method ScheduleBatch, addr 0x491384c, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapBoxBatch, addr 0x4913a30, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ScheduleOverlapBoxBatch_Injected, addr 0x4913acc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49136f0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49137d0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_center, addr 0x49137f4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_center();

  /// @brief Method get_halfExtents, addr 0x491380c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_halfExtents();

  /// @brief Method get_orientation, addr 0x4913824, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion get_orientation();

  /// @brief Method get_physicsScene, addr 0x491383c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::PhysicsScene get_physicsScene();

  /// @brief Method set_center, addr 0x4913800, size 0xc, virtual false, abstract: false, final false
  inline void set_center(::UnityEngine::Vector3 value);

  /// @brief Method set_halfExtents, addr 0x4913818, size 0xc, virtual false, abstract: false, final false
  inline void set_halfExtents(::UnityEngine::Vector3 value);

  /// @brief Method set_orientation, addr 0x4913830, size 0xc, virtual false, abstract: false, final false
  inline void set_orientation(::UnityEngine::Quaternion value);

  /// @brief Method set_physicsScene, addr 0x4913844, size 0x8, virtual false, abstract: false, final false
