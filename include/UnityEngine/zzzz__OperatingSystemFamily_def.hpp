...
DEFINE_IL2CPP_CLASS(::UnityEngine::OperatingSystemFamily, "UnityEngine", "OperatingSystemFamily");
// Dependencies
namespace UnityEngine {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::OperatingSystemFamily) == 0x4, "Size mismatch!");
