...
/// @brief Method IsManagedCodeWorking, addr 0x691bdcc, size 0x8, virtual false, abstract: false, final false
static inline bool IsManagedCodeWorking() ;

/// @brief Method SetupCallbacks, addr 0x691bdd4, size 0x4, virtual false, abstract: false, final false
