...
public:
  ...
  /// @brief Method get_cookieSize, addr 0x2ca2650, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_spotAngle, addr 0x2ca2704, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_spotAngle();

  /// @brief Method get_color, addr 0x2ca2740, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color, addr 0x2ca27dc, size 0x54, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method get_colorTemperature, addr 0x2ca2874, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_colorTemperature();

  /// @brief Method get_useColorTemperature, addr 0x2ca28b0, size 0x3c, virtual false, abstract: false, final false
  inline bool get_useColorTemperature();

  /// @brief Method get_intensity, addr 0x2ca28ec, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x2ca2928, size 0x4c, virtual false, abstract: false, final false
  inline void set_intensity(float_t value);

  /// @brief Method get_bounceIntensity, addr 0x2ca2974, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_bounceIntensity();

  /// @brief Method get_range, addr 0x2ca29b0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_range();

  /// @brief Method get_bakingOutput, addr 0x2ca29ec, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::LightBakingOutput get_bakingOutput();

  /// @brief Method get_color_Injected, addr 0x2ca2798, size 0x44, virtual false, abstract: false, final false
  inline void get_color_Injected(ByRef<::UnityEngine::Color> ret);

  /// @brief Method set_color_Injected, addr 0x2ca2830, size 0x44, virtual false, abstract: false, final false
  inline void set_color_Injected(ByRef<::UnityEngine::Color> value);

  /// @brief Method get_bakingOutput_Injected, addr 0x2ca2a54, size 0x44, virtual false, abstract: false, final false
