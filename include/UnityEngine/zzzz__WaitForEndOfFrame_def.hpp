...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaitForEndOfFrame", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaitForEndOfFrame(WaitForEndOfFrame&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaitForEndOfFrame", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaitForEndOfFrame(WaitForEndOfFrameconst&) = delete;
