...
public:
  ...
  /// @brief Method CreateBatchRendererGroupRuntimeAnalytic, addr 0x6a650ac, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a65034, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
