...
/// @brief Method CreateBatchRendererGroupRuntimeAnalytic, addr 0x689df70, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x689def8, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
