...
public:
  ...
  /// @brief Method <GetCachedEnumData>b__2_1, addr 0x6988040, size 0x58, virtual false, abstract: false, final false
  inline ::StringW _GetCachedEnumData_b__2_1(::System::Reflection::FieldInfo* f);

  /// @brief Method <GetCachedEnumData>b__2_2, addr 0x6988098, size 0x64, virtual false, abstract: false, final false
  inline ::System::Enum* _GetCachedEnumData_b__2_2(::System::Reflection::FieldInfo* f);

  /// @brief Method <GetCachedEnumData>b__2_3, addr 0x69880fc, size 0x60, virtual false, abstract: false, final false
  inline int32_t _GetCachedEnumData_b__2_3(::System::Enum* v);

  /// @brief Method <GetCachedEnumData>b__2_4, addr 0x698815c, size 0x60, virtual false, abstract: false, final false
  inline int32_t _GetCachedEnumData_b__2_4(::System::Enum* v);

  /// @brief Method <GetCachedEnumData>b__2_5, addr 0x698801c, size 0x24, virtual false, abstract: false, final false
  inline int32_t _GetCachedEnumData_b__2_5(::System::Reflection::FieldInfo* f);

  /// @brief Method .ctor, addr 0x6988018, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetCachedEnumData>b__0, addr 0x69881bc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69875ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CheckObsoleteAddition, addr 0x69875f0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method EnumNameFromEnumField, addr 0x6987cd4, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW EnumNameFromEnumField(::System::Reflection::FieldInfo* field, ::System::Func_2<::StringW, ::StringW>* nicifyName);

  /// @brief Method EnumTooltipFromEnumField, addr 0x6987bb8, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW EnumTooltipFromEnumField(::System::Reflection::FieldInfo* field);

  /// @brief Method GetCachedEnumData, addr 0x698686c, size 0xd80, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleInspectorOrderAttribute, addr 0x698770c, size 0x4ac, virtual false, abstract: false, final false
  static inline void HandleInspectorOrderAttribute(::System::Type* enumType, ::ByRef<::UnityEngine::EnumData> enumData);

  /// @brief Method <EnumNameFromEnumField>g__NicifyName|8_0, addr 0x6987ec4, size 0x4c, virtual false, abstract: false, final false
