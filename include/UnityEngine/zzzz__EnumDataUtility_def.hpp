...
/// @brief Method <GetCachedEnumData>b__2_1, addr 0x6989bb8, size 0x58, virtual false, abstract: false, final false
inline ::StringW _GetCachedEnumData_b__2_1(::System::Reflection::FieldInfo*  f) ;

/// @brief Method <GetCachedEnumData>b__2_2, addr 0x6989c10, size 0x64, virtual false, abstract: false, final false
inline ::System::Enum* _GetCachedEnumData_b__2_2(::System::Reflection::FieldInfo*  f) ;

/// @brief Method <GetCachedEnumData>b__2_3, addr 0x6989c74, size 0x60, virtual false, abstract: false, final false
inline int32_t _GetCachedEnumData_b__2_3(::System::Enum*  v) ;

/// @brief Method <GetCachedEnumData>b__2_4, addr 0x6989cd4, size 0x60, virtual false, abstract: false, final false
inline int32_t _GetCachedEnumData_b__2_4(::System::Enum*  v) ;

/// @brief Method <GetCachedEnumData>b__2_5, addr 0x6989b94, size 0x24, virtual false, abstract: false, final false
inline int32_t _GetCachedEnumData_b__2_5(::System::Reflection::FieldInfo*  f) ;

/// @brief Method .ctor, addr 0x6989b90, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetCachedEnumData>b__0, addr 0x6989d34, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6989164, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "nicifyName", ty: "::System::Func_2<::StringW,::StringW>*", modifiers: "", def_value: None }, CppParam { name: "field", ty: "::System::Reflection::FieldInfo*", modifiers: "", def_value: None }]
...
/// @brief Field s_EnumData, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_EnumData, put=setStaticF_s_EnumData)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::EnumDataUtility_CachedType,::System::Type*>,::UnityEngine::EnumData>*  s_EnumData;

/// @brief Method CheckObsoleteAddition, addr 0x6989168, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method EnumNameFromEnumField, addr 0x698984c, size 0x1f0, virtual false, abstract: false, final false
static inline ::StringW EnumNameFromEnumField(::System::Reflection::FieldInfo*  field, ::System::Func_2<::StringW,::StringW>*  nicifyName) ;

/// @brief Method EnumTooltipFromEnumField, addr 0x6989730, size 0x11c, virtual false, abstract: false, final false
static inline ::StringW EnumTooltipFromEnumField(::System::Reflection::FieldInfo*  field) ;

/// @brief Method GetCachedEnumData, addr 0x69883e4, size 0xd80, virtual false, abstract: false, final false
...
/// @brief Method HandleInspectorOrderAttribute, addr 0x6989284, size 0x4ac, virtual false, abstract: false, final false
static inline void HandleInspectorOrderAttribute(::System::Type*  enumType, ::ByRef<::UnityEngine::EnumData>  enumData) ;

/// @brief Method <EnumNameFromEnumField>g__NicifyName|8_0, addr 0x6989a3c, size 0x4c, virtual false, abstract: false, final false
...
static inline void setStaticF_s_EnumData(::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::EnumDataUtility_CachedType,::System::Type*>,::UnityEngine::EnumData>*  value) ;
