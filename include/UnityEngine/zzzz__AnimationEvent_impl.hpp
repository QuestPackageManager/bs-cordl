...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::AnimationEvent::*)()>(&::UnityEngine::AnimationEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6a34134;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::AnimationEvent*>(), { ".ctor", {}, {} })));
