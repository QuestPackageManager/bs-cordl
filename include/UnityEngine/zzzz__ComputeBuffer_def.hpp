...
public:
  // Declarations
  /// @brief Method ConvertToNative, addr 0x6aecbd8, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DestroyBuffer_Injected, addr 0x6aec450, size 0x3c, virtual false, abstract: false, final false
  static inline void DestroyBuffer_Injected(::System::IntPtr buf);

  /// @brief Method Dispose, addr 0x6aec344, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6aec274, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalSetNativeData_Injected, addr 0x6aecaf0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidBuffer_Injected, addr 0x6aec6e0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6aec694, size 0x4, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method SetData, addr 0x6aec884, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6aec48c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t count, int32_t stride);

  /// @brief Method .ctor, addr 0x6aec664, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t count, int32_t stride, ::UnityEngine::ComputeBufferType type);

  /// @brief Method .ctor, addr 0x6aec498, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_count, addr 0x6aec76c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_count();

  /// @brief Method get_count_Injected, addr 0x6aec7bc, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t get_count_Injected(::System::IntPtr _unity_self);

  /// @brief Method get_stride, addr 0x6aec7f8, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_stride();

  /// @brief Method get_stride_Injected, addr 0x6aec848, size 0x3c, virtual false, abstract: false, final false
