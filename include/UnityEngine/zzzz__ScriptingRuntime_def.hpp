...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptingRuntime", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptingRuntime(ScriptingRuntime&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptingRuntime", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptingRuntime(ScriptingRuntimeconst&) = delete;
