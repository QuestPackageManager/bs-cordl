...
public:
// Declarations
/// @brief Method ConvertToManaged, addr 0x690f614, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::AsyncOperation* ConvertToManaged(::System::IntPtr  ptr) ;

/// @brief Method ConvertToNative, addr 0x690fd5c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Finalize, addr 0x690fb44, size 0x74, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalDestroy, addr 0x690f7e0, size 0x3c, virtual false, abstract: false, final false
static inline void InternalDestroy(::System::IntPtr  ptr) ;

/// @brief Method InternalSetManagedObject, addr 0x690f81c, size 0x44, virtual false, abstract: false, final false
static inline void InternalSetManagedObject(::System::IntPtr  ptr, ::UnityEngine::AsyncOperation*  self) ;

/// @brief Method InvokeCompletionEvent, addr 0x690fbb8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x690f860, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x690e784, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method add_completed, addr 0x690fbe8, size 0xd4, virtual false, abstract: false, final false
inline void add_completed(::System::Action_1<::UnityEngine::AsyncOperation*>*  value) ;

/// @brief Method get_allowSceneActivation, addr 0x690fa1c, size 0x50, virtual false, abstract: false, final false
inline bool get_allowSceneActivation() ;

/// @brief Method get_allowSceneActivation_Injected, addr 0x690fa6c, size 0x3c, virtual false, abstract: false, final false
static inline bool get_allowSceneActivation_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_isDone, addr 0x690f868, size 0x50, virtual false, abstract: false, final false
inline bool get_isDone() ;

/// @brief Method get_isDone_Injected, addr 0x690f8b8, size 0x3c, virtual false, abstract: false, final false
static inline bool get_isDone_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method get_progress, addr 0x690f8f4, size 0x50, virtual false, abstract: false, final false
inline float_t get_progress() ;

/// @brief Method get_progress_Injected, addr 0x690f944, size 0x3c, virtual false, abstract: false, final false
static inline float_t get_progress_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method remove_completed, addr 0x690fcbc, size 0xa0, virtual false, abstract: false, final false
inline void remove_completed(::System::Action_1<::UnityEngine::AsyncOperation*>*  value) ;

/// @brief Method set_allowSceneActivation, addr 0x690faa8, size 0x58, virtual false, abstract: false, final false
inline void set_allowSceneActivation(bool  value) ;

/// @brief Method set_allowSceneActivation_Injected, addr 0x690fb00, size 0x44, virtual false, abstract: false, final false
static inline void set_allowSceneActivation_Injected(::System::IntPtr  _unity_self, bool  value) ;

/// @brief Method set_priority, addr 0x690f980, size 0x58, virtual false, abstract: false, final false
inline void set_priority(int32_t  value) ;

/// @brief Method set_priority_Injected, addr 0x690f9d8, size 0x44, virtual false, abstract: false, final false
