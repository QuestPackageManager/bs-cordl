...
public:
  ...
  /// @brief Method ApplyOptions, addr 0x69f6188, size 0x278, virtual true, abstract: false, final false
  inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*, ::Array<::UnityEngine::GUILayoutOption*>*> options);

  /// @brief Method ApplyStyleSettings, addr 0x69f610c, size 0x7c, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::UnityEngine::GUIStyle* style);

  /// @brief Method CalcHeight, addr 0x69f60f0, size 0x4, virtual true, abstract: false, final false
  inline void CalcHeight();

  /// @brief Method CalcWidth, addr 0x69f60ec, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetHorizontal, addr 0x69f60f4, size 0xc, virtual true, abstract: false, final false
  inline void SetHorizontal(float_t x, float_t width);

  /// @brief Method SetVertical, addr 0x69f6100, size 0xc, virtual true, abstract: false, final false
  inline void SetVertical(float_t y, float_t height);

  /// @brief Method ToString, addr 0x69f6400, size 0x49c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69f6020, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(float_t _minWidth, float_t _maxWidth, float_t _minHeight, float_t _maxHeight, ::UnityEngine::GUIStyle* _style);

  /// @brief Method .ctor, addr 0x69ee8f0, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(float_t _minWidth, float_t _maxWidth, float_t _minHeight, float_t _maxHeight, ::UnityEngine::GUIStyle* _style,
                    ::ArrayW<::UnityEngine::GUILayoutOption*, ::Array<::UnityEngine::GUILayoutOption*>*> options);
  ...
  /// @brief Method get_marginBottom, addr 0x69f5f84, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_marginBottom();

  /// @brief Method get_marginHorizontal, addr 0x69f5fa8, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_marginHorizontal();

  /// @brief Method get_marginLeft, addr 0x69f5f18, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_marginLeft();

  /// @brief Method get_marginRight, addr 0x69f5f3c, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_marginRight();

  /// @brief Method get_marginTop, addr 0x69f5f60, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_marginTop();

  /// @brief Method get_marginVertical, addr 0x69f5fe4, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_marginVertical();

  /// @brief Method get_style, addr 0x69f5f10, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_style, addr 0x69ed7c4, size 0x10, virtual false, abstract: false, final false
