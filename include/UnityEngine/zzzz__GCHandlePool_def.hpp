...
/// @brief Field m_handles, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_handles, put=__cordl_internal_set_m_handles)) ::ArrayW<::System::Runtime::InteropServices::GCHandle,::Array<::System::Runtime::InteropServices::GCHandle>*>  m_handles;

/// @brief Method Alloc, addr 0x68ded74, size 0x70, virtual false, abstract: false, final false
inline ::System::Runtime::InteropServices::GCHandle Alloc(::System::Object*  o) ;

/// @brief Method AllocHandleIfNotNull, addr 0x68dede4, size 0x10, virtual false, abstract: false, final false
inline ::System::IntPtr AllocHandleIfNotNull(::System::Object*  o) ;

/// @brief Method Free, addr 0x68dd278, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x68dca10, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
