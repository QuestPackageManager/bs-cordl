...
public:
  // Declarations
  /// @brief Method ConvertToManaged, addr 0x68ed900, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::AssetBundleUnloadOperation* ConvertToManaged(::System::IntPtr ptr);

  /// @brief Method ConvertToNative, addr 0x68ee178, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method WaitForCompletion, addr 0x68ee0a0, size 0x50, virtual false, abstract: false, final false
  inline void WaitForCompletion();

  /// @brief Method WaitForCompletion_Injected, addr 0x68ee0f0, size 0x3c, virtual false, abstract: false, final false
  static inline void WaitForCompletion_Injected(::System::IntPtr _unity_self);

  /// @brief Method .ctor, addr 0x68ee12c, size 0x4c, virtual false, abstract: false, final false
