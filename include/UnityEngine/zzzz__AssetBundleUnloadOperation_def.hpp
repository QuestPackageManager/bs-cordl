...
public:
  ...
  /// @brief Method WaitForCompletion, addr 0x485c984, size 0x3c, virtual false, abstract: false, final false
  inline void WaitForCompletion();

  /// @brief Method .ctor, addr 0x485c9c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
