...
public:
  ...
  /// @brief Method WaitForCompletion, addr 0x4858128, size 0x3c, virtual false, abstract: false, final false
  inline void WaitForCompletion();

  /// @brief Method .ctor, addr 0x4858164, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
