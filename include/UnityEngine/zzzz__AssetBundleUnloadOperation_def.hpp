...
public:
  ...
  /// @brief Method WaitForCompletion, addr 0x47e109c, size 0x3c, virtual false, abstract: false, final false
  inline void WaitForCompletion();

  /// @brief Method .ctor, addr 0x47e10d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
