...
public:
// Declarations
/// @brief Method ConvertToManaged, addr 0x687b8f4, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::AssetBundleUnloadOperation* ConvertToManaged(::System::IntPtr  ptr) ;

/// @brief Method ConvertToNative, addr 0x687c16c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method WaitForCompletion, addr 0x687c094, size 0x50, virtual false, abstract: false, final false
inline void WaitForCompletion() ;

/// @brief Method WaitForCompletion_Injected, addr 0x687c0e4, size 0x3c, virtual false, abstract: false, final false
static inline void WaitForCompletion_Injected(::System::IntPtr  _unity_self) ;

/// @brief Method .ctor, addr 0x687c120, size 0x4c, virtual false, abstract: false, final false
