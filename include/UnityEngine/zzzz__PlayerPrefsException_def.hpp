...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerPrefsException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerPrefsException(PlayerPrefsException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerPrefsException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerPrefsException(PlayerPrefsExceptionconst&) = delete;
