...
public:
  ...
  /// @brief Method get_displaySubsystem addr 0x2c7d014 size 0x70 virtual false final false
  inline Il2CppObject* get_displaySubsystem();

  /// @brief Method get_inputSubsystem addr 0x2c7d084 size 0x70 virtual false final false
  inline ::UnityEngine::XR::XRInputSubsystem* get_inputSubsystem();

  /// @brief Method Initialize addr 0x2c7d0f4 size 0xd4 virtual true final false
  inline bool Initialize();

  /// @brief Method Start addr 0x2c7d1c8 size 0x78 virtual true final false
  inline bool Start();

  /// @brief Method Stop addr 0x2c7d240 size 0x78 virtual true final false
  inline bool Stop();

  /// @brief Method Deinitialize addr 0x2c7d2b8 size 0x78 virtual true final false
  inline bool Deinitialize();

  /// @brief Method DisableVRAndEnable2DReprojection addr 0x2c7d330 size 0x98 virtual false final false
  inline bool DisableVRAndEnable2DReprojection();

  /// @brief Method EnableVRAndDisable2DReprojection addr 0x2c7d3c8 size 0xc4 virtual false final false
  inline bool EnableVRAndDisable2DReprojection();

  static inline ::UnityEngine::PS4::XR::PSVRLoader* New_ctor();

  /// @brief Method .ctor addr 0x2c7d48c size 0x8 virtual false final false
  inline void _ctor();
