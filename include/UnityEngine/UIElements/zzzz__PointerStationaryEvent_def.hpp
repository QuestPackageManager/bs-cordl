...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a33014, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PointerStationaryEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a3300c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a32e0c, size 0x50, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x4a32e5c, size 0x104, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerStationaryEvent* New_ctor();

  /// @brief Method .ctor, addr 0x4a32f60, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
