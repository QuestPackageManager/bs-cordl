...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlRootElementTraits", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlRootElementTraits(UxmlRootElementTraits&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlRootElementTraits", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlRootElementTraits(UxmlRootElementTraitsconst&) = delete;
