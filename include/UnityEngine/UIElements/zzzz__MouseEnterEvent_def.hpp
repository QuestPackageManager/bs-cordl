...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7301)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7301), inst: 4548 })}
...
public:
  // Declarations
  /// @brief Method Init addr 0x2ce920c size 0x54 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2ce9260 size 0xc virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseEnterEvent* New_ctor();

  /// @brief Method .ctor addr 0x2ce926c size 0x54 virtual false final false
  inline void _ctor();
