...
public:
  // Declarations
  /// @brief Method Init addr 0x2e515bc size 0x54 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2e51610 size 0xc virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseEnterEvent* New_ctor();

  /// @brief Method .ctor addr 0x2e5161c size 0x54 virtual false final false
  inline void _ctor();
