...
public:
  ...
  /// @brief Method .ctor, addr 0x6cbc7e4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlElementAttribute) == 0x18, "Size mismatch!");
