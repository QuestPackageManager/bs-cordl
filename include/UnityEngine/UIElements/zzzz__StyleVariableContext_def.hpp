...
public:
  ...
  /// @brief Method Add, addr 0x2fd0ec4, size 0x1a0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::StyleVariable sv);

  /// @brief Method AddInitialRange, addr 0x2fd1064, size 0xf8, virtual false, abstract: false, final false
  inline void AddInitialRange(::UnityEngine::UIElements::StyleVariableContext* other);

  /// @brief Method Clear, addr 0x2fd115c, size 0x9c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetVariableHash, addr 0x2fd1498, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindVariable, addr 0x2fd13ac, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fd11f8, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2fd12c0, size 0xec, virtual false, abstract: false, final false
