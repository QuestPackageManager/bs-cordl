...
public:
  ...
  /// @brief Method Add, addr 0x6c9a0a0, size 0x354, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::StyleVariable sv);

  /// @brief Method AddInitialRange, addr 0x6c9a400, size 0x15c, virtual false, abstract: false, final false
  inline void AddInitialRange(::UnityEngine::UIElements::StyleVariableContext* other);

  /// @brief Method Clear, addr 0x6c9a55c, size 0xc8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetVariableHash, addr 0x6c9a900, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindVariable, addr 0x6c9a814, size 0xec, virtual false, abstract: false, final false
  inline bool TryFindVariable(::StringW name, ::by_ref<::UnityEngine::UIElements::StyleVariable> v);

  /// @brief Method <Add>g__ComputeOrderSensitiveHash|7_0, addr 0x6c9a3f4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c9a624, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c9a704, size 0x110, virtual false, abstract: false, final false
