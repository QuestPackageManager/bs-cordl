...
/// @brief Method Add, addr 0x6ad2428, size 0x354, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::StyleVariable  sv) ;

/// @brief Method AddInitialRange, addr 0x6ad2788, size 0x15c, virtual false, abstract: false, final false
inline void AddInitialRange(::UnityEngine::UIElements::StyleVariableContext*  other) ;

/// @brief Method Clear, addr 0x6ad28e4, size 0xc8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetVariableHash, addr 0x6ad2c88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method TryFindVariable, addr 0x6ad2b9c, size 0xec, virtual false, abstract: false, final false
inline bool TryFindVariable(::StringW  name, ::ByRef<::UnityEngine::UIElements::StyleVariable>  v) ;

/// @brief Method <Add>g__ComputeOrderSensitiveHash|7_0, addr 0x6ad277c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ad29ac, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6ad2a8c, size 0x110, virtual false, abstract: false, final false
