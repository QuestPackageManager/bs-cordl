...
public:
  ...
  /// @brief Method Add, addr 0x33b5ce0, size 0x1a0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::StyleVariable sv);

  /// @brief Method AddInitialRange, addr 0x33b5e80, size 0xf8, virtual false, abstract: false, final false
  inline void AddInitialRange(::UnityEngine::UIElements::StyleVariableContext* other);

  /// @brief Method Clear, addr 0x33b5f78, size 0x9c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetVariableHash, addr 0x33b62b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryFindVariable, addr 0x33b61c8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33b6014, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33b60dc, size 0xec, virtual false, abstract: false, final false
