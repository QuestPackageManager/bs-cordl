...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x351fc3c, size 0x20, virtual true, abstract: false, final false
  inline void ApplyStyles();

  /// @brief Method Blur, addr 0x350a1a4, size 0x2c, virtual false, abstract: false, final false
  inline void Blur();

  /// @brief Method CreateMarkers, addr 0x351ed78, size 0x24c, virtual false, abstract: false, final false
  inline void CreateMarkers();

  /// @brief Method DefaultTimeSinceStartupMs, addr 0x351f4bc, size 0x38, virtual false, abstract: false, final false
  static inline int64_t DefaultTimeSinceStartupMs();

  /// @brief Method Dispose, addr 0x351f454, size 0x68, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Focus, addr 0x350a1d0, size 0x2c, virtual false, abstract: false, final false
  inline void Focus();

  /// @brief Method GetUpdater, addr 0x35200a0, size 0x1c, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualTreeUpdater* GetUpdater(::UnityEngine::UIElements::VisualTreeUpdatePhase phase);

  /// @brief Method LoadResource, addr 0x351ec3c, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnVersionChanged, addr 0x3520054, size 0x4c, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method PerformPick, addr 0x351f570, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Pick, addr 0x351f92c, size 0x174, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* Pick(::UnityEngine::Vector2 point);

  /// @brief Method PickAll, addr 0x351f854, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method PickAll, addr 0x351f4f4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Repaint, addr 0x351fcd0, size 0x384, virtual true, abstract: false, final false
  inline void Repaint(::UnityEngine::Event* e);

  /// @brief Method TimeSinceStartupMs, addr 0x350c6e8, size 0xdc, virtual false, abstract: false, final false
  static inline int64_t TimeSinceStartupMs();

  /// @brief Method UpdateAnimations, addr 0x351fbfc, size 0x20, virtual true, abstract: false, final false
  inline void UpdateAnimations();

  /// @brief Method UpdateBindings, addr 0x351fc1c, size 0x20, virtual true, abstract: false, final false
  inline void UpdateBindings();

  /// @brief Method UpdateForRepaint, addr 0x351fc5c, size 0x74, virtual false, abstract: false, final false
  inline void UpdateForRepaint();

  /// @brief Method ValidateLayout, addr 0x351fb98, size 0x64, virtual true, abstract: false, final false
  inline void ValidateLayout();

  /// @brief Method <Pick>g__PixelOf|99_0, addr 0x351faa0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x351f0c8, size 0x38c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IMGUIContainersCount, addr 0x351f01c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_IMGUIContainersCount();

  /// @brief Method get_IMGUIEventInterests, addr 0x351ebc4, size 0x10, virtual true, abstract: false, final false
  inline ::UnityEngine::EventInterests get_IMGUIEventInterests();

  /// @brief Method get_TimeSinceStartup, addr 0x351efc4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::TimeMsFunction* get_TimeSinceStartup();

  /// @brief Method get_atlas, addr 0x351f04c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::AtlasBase* get_atlas();

  /// @brief Method get_contextType, addr 0x351eb94, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ContextType get_contextType();

  /// @brief Method get_dispatcher, addr 0x351ea48, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::EventDispatcher* get_dispatcher();

  /// @brief Method get_focusController, addr 0x351ebb4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_getViewDataDictionary, addr 0x351ebac, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::GetViewDataDictionary* get_getViewDataDictionary();

  /// @brief Method get_hierarchyVersion, addr 0x351f03c, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_hierarchyVersion();

  /// @brief Method get_loadResourceFunc, addr 0x351ebe4, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::LoadResourceFunction* get_loadResourceFunc();

  /// @brief Method get_name, addr 0x351ed68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_ownerObject, addr 0x351eb84, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::ScriptableObject> get_ownerObject();

  /// @brief Method get_rootIMGUIContainer, addr 0x351f02c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IMGUIContainer* get_rootIMGUIContainer();

  /// @brief Method get_saveViewData, addr 0x351eba4, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::SavePersistentViewData* get_saveViewData();

  /// @brief Method get_scheduler, addr 0x351eac4, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IScheduler* get_scheduler();

  /// @brief Method get_standardShader, addr 0x351f044, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_standardShader();

  /// @brief Method get_styleAnimationSystem, addr 0x351eac8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* get_styleAnimationSystem();

  /// @brief Method get_timerEventScheduler, addr 0x351ea58, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimerEventScheduler* get_timerEventScheduler();

  /// @brief Method get_version, addr 0x351f034, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_version();

  /// @brief Method get_visualTree, addr 0x351ea40, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_IMGUIContainersCount, addr 0x351f024, size 0x8, virtual true, abstract: false, final false
  inline void set_IMGUIContainersCount(int32_t value);

  /// @brief Method set_IMGUIEventInterests, addr 0x351ebd4, size 0x10, virtual true, abstract: false, final false
  inline void set_IMGUIEventInterests(::UnityEngine::EventInterests value);

  /// @brief Method set_atlas, addr 0x351f054, size 0x74, virtual true, abstract: false, final false
  inline void set_atlas(::UnityEngine::UIElements::AtlasBase* value);

  /// @brief Method set_contextType, addr 0x351eb9c, size 0x8, virtual true, abstract: false, final false
  inline void set_contextType(::UnityEngine::UIElements::ContextType value);

  /// @brief Method set_dispatcher, addr 0x351ea50, size 0x8, virtual true, abstract: false, final true
  inline void set_dispatcher(::UnityEngine::UIElements::EventDispatcher* value);

  /// @brief Method set_focusController, addr 0x351ebbc, size 0x8, virtual true, abstract: false, final true
  inline void set_focusController(::UnityEngine::UIElements::FocusController* value);

  /// @brief Method set_name, addr 0x351ed70, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_ownerObject, addr 0x351eb8c, size 0x8, virtual true, abstract: false, final false
  inline void set_ownerObject(::UnityEngine::ScriptableObject* value);

  /// @brief Method set_styleAnimationSystem, addr 0x351ead0, size 0xb4, virtual true, abstract: false, final false
