...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x6c612c4, size 0x1c, virtual true, abstract: false, final false
  inline void ApplyStyles();

  /// @brief Method Blur, addr 0x6c5fe94, size 0x2c, virtual false, abstract: false, final false
  inline void Blur();

  /// @brief Method CreateMarkers, addr 0x6c5fefc, size 0x2a0, virtual false, abstract: false, final false
  inline void CreateMarkers();

  /// @brief Method DefaultTimeSinceStartupMs, addr 0x6c60b50, size 0x50, virtual false, abstract: false, final false
  static inline int64_t DefaultTimeSinceStartupMs();

  /// @brief Method Dispose, addr 0x6c609c8, size 0x88, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Focus, addr 0x6c5fe88, size 0xc, virtual false, abstract: false, final false
  inline void Focus();

  /// @brief Method GetUpdater, addr 0x6c617a4, size 0x20, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualTreeUpdater* GetUpdater(::UnityEngine::UIElements::VisualTreeUpdatePhase phase);

  /// @brief Method LoadResource, addr 0x6c5fd48, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method OnVersionChanged, addr 0x6c615b8, size 0x1d4, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method PerformPick, addr 0x6c60c28, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Pick, addr 0x6c60fdc, size 0x180, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* Pick(::UnityEngine::Vector2 point);

  /// @brief Method PickAll, addr 0x6c60eec, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method PickAll, addr 0x6c60ba0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6c615b4, size 0x4, virtual true, abstract: false, final false
  inline void Render();

  /// @brief Method Repaint, addr 0x6c61354, size 0x260, virtual true, abstract: false, final false
  inline void Repaint(::UnityEngine::Event* e);

  /// @brief Method SetUpdater, addr 0x6c6178c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method TimeSinceStartupMs, addr 0x6c60a50, size 0x100, virtual false, abstract: false, final false
  static inline int64_t TimeSinceStartupMs();

  /// @brief Method UpdateAnimations, addr 0x6c6128c, size 0x1c, virtual true, abstract: false, final false
  inline void UpdateAnimations();

  /// @brief Method UpdateBindings, addr 0x6c612a8, size 0x1c, virtual true, abstract: false, final false
  inline void UpdateBindings();

  /// @brief Method UpdateForRepaint, addr 0x6c612e0, size 0x74, virtual false, abstract: false, final false
  inline void UpdateForRepaint();

  /// @brief Method ValidateFocus, addr 0x6c5fec0, size 0x34, virtual true, abstract: false, final false
  inline void ValidateFocus();

  /// @brief Method ValidateLayout, addr 0x6c61228, size 0x64, virtual true, abstract: false, final false
  inline void ValidateLayout();

  /// @brief Method <Pick>g__PixelOf|105_0, addr 0x6c6115c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c602ac, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HyperlinkColor, addr 0x6c617c4, size 0x14, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_HyperlinkColor();

  /// @brief Method get_IMGUIContainersCount, addr 0x6c60200, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_IMGUIContainersCount();

  /// @brief Method get_IMGUIEventInterests, addr 0x6c5fccc, size 0x10, virtual true, abstract: false, final false
  inline ::UnityEngine::EventInterests get_IMGUIEventInterests();

  /// @brief Method get_TimeSinceStartup, addr 0x6c601a4, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::TimeMsFunction* get_TimeSinceStartup();

  /// @brief Method get_atlas, addr 0x6c60228, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::AtlasBase* get_atlas();

  /// @brief Method get_contextType, addr 0x6c5fca4, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ContextType get_contextType();

  /// @brief Method get_dispatcher, addr 0x6c5fb50, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::EventDispatcher* get_dispatcher();

  /// @brief Method get_focusController, addr 0x6c5fcbc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_getViewDataDictionary, addr 0x6c5fcb4, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::GetViewDataDictionary* get_getViewDataDictionary();

  /// @brief Method get_hierarchyVersion, addr 0x6c60220, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_hierarchyVersion();

  /// @brief Method get_loadResourceFunc, addr 0x6c5fcec, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::LoadResourceFunction* get_loadResourceFunc();

  /// @brief Method get_name, addr 0x6c5fef4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_ownerObject, addr 0x6c5fc94, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::ScriptableObject> get_ownerObject();

  /// @brief Method get_panelChangeReceiver, addr 0x6c6019c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IDebugPanelChangeReceiver* get_panelChangeReceiver();

  /// @brief Method get_rootIMGUIContainer, addr 0x6c60210, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IMGUIContainer* get_rootIMGUIContainer();

  /// @brief Method get_saveViewData, addr 0x6c5fcac, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::SavePersistentViewData* get_saveViewData();

  /// @brief Method get_scheduler, addr 0x6c5fbc8, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IScheduler* get_scheduler();

  /// @brief Method get_styleAnimationSystem, addr 0x6c5fbcc, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* get_styleAnimationSystem();

  /// @brief Method get_timerEventScheduler, addr 0x6c5fb60, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimerEventScheduler* get_timerEventScheduler();

  /// @brief Method get_version, addr 0x6c60218, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_version();

  /// @brief Method get_visualTree, addr 0x6c5fb48, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_IMGUIContainersCount, addr 0x6c60208, size 0x8, virtual true, abstract: false, final false
  inline void set_IMGUIContainersCount(int32_t value);

  /// @brief Method set_IMGUIEventInterests, addr 0x6c5fcdc, size 0x10, virtual true, abstract: false, final false
  inline void set_IMGUIEventInterests(::UnityEngine::EventInterests value);

  /// @brief Method set_atlas, addr 0x6c60230, size 0x7c, virtual true, abstract: false, final false
  inline void set_atlas(::UnityEngine::UIElements::AtlasBase* value);

  /// @brief Method set_dispatcher, addr 0x6c5fb58, size 0x8, virtual true, abstract: false, final true
  inline void set_dispatcher(::UnityEngine::UIElements::EventDispatcher* value);

  /// @brief Method set_focusController, addr 0x6c5fcc4, size 0x8, virtual true, abstract: false, final true
  inline void set_focusController(::UnityEngine::UIElements::FocusController* value);

  /// @brief Method set_name, addr 0x6c550c0, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_ownerObject, addr 0x6c5fc9c, size 0x8, virtual true, abstract: false, final false
  inline void set_ownerObject(::UnityEngine::ScriptableObject* value);

  /// @brief Method set_panelChangeReceiver, addr 0x6c54af0, size 0xcc, virtual false, abstract: false, final false
  inline void set_panelChangeReceiver(::UnityEngine::UIElements::IDebugPanelChangeReceiver* value);

  /// @brief Method set_styleAnimationSystem, addr 0x6c5fbd4, size 0xc0, virtual true, abstract: false, final false
