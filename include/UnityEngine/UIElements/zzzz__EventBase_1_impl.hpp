...
::cordl_internals::setStaticField<::UnityEngine::UIElements::EventBase_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventBase_1___c<T>*>::get>(std::forward<::UnityEngine::UIElements::EventBase_1___c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::UIElements::EventBase_1___c<T>* UnityEngine::UIElements::EventBase_1___c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::EventBase_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventBase_1___c<T>*>::get>();
}
template<typename T>
