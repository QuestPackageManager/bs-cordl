...
public:
  ...
  /// @brief Method ClearDirty, addr 0x6ad7b08, size 0x8, virtual false, abstract: false, final false
  inline void ClearDirty();

  /// @brief Method MarkDirty, addr 0x6ad7afc, size 0xc, virtual false, abstract: false, final false
  inline void MarkDirty();

  static inline ::UnityEngine::UIElements::Binding* New_ctor();

  /// @brief Method OnActivated, addr 0x6ad7b10, size 0x4, virtual true, abstract: false, final false
  inline void OnActivated(::ByRef<::UnityEngine::UIElements::BindingActivationContext> context);

  /// @brief Method OnDataSourceChanged, addr 0x6ad7b18, size 0x4, virtual true, abstract: false, final false
  inline void OnDataSourceChanged(::ByRef<::UnityEngine::UIElements::DataSourceContextChanged> context);

  /// @brief Method OnDeactivated, addr 0x6ad7b14, size 0x4, virtual true, abstract: false, final false
  inline void OnDeactivated(::ByRef<::UnityEngine::UIElements::BindingActivationContext> context);

  /// @brief Method ResetPanelLogLevel, addr 0x6ad7a40, size 0x90, virtual false, abstract: false, final false
  static inline void ResetPanelLogLevel(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method SetGlobalLogLevel, addr 0x6ad78b8, size 0x60, virtual false, abstract: false, final false
  static inline void SetGlobalLogLevel(::UnityEngine::UIElements::BindingLogLevel logLevel);

  /// @brief Method SetPanelLogLevel, addr 0x6ad7918, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ad7af0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isDirty, addr 0x6ad7ad8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDirty();

  /// @brief Method get_updateTrigger, addr 0x6ad7ae0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BindingUpdateTrigger get_updateTrigger();

  /// @brief Method set_updateTrigger, addr 0x6ad7ae8, size 0x8, virtual false, abstract: false, final false
