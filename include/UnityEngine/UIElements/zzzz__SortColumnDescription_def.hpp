...
public:
  ...
  /// @brief Method .ctor, addr 0x6c09d70, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method NotifyPropertyChanged, addr 0x6c0976c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c09af0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c09afc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t columnIndex, ::UnityEngine::UIElements::SortDirection direction);

  /// @brief Method .ctor, addr 0x6c09b2c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW columnName, ::UnityEngine::UIElements::SortDirection direction);

  /// @brief Method add_changed, addr 0x6c09970, size 0xc0, virtual false, abstract: false, final false
  inline void add_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>* value);

  /// @brief Method add_propertyChanged, addr 0x6c09518, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_column, addr 0x6c0988c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Column* get_column();

  /// @brief Method get_columnIndex, addr 0x6c097b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_columnIndex();

  /// @brief Method get_columnName, addr 0x6c09698, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_columnName();

  /// @brief Method get_direction, addr 0x6c0989c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_changed, addr 0x6c09a30, size 0xc0, virtual false, abstract: false, final false
  inline void remove_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>* value);

  /// @brief Method remove_propertyChanged, addr 0x6c095d8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method set_column, addr 0x6c09894, size 0x8, virtual false, abstract: false, final false
  inline void set_column(::UnityEngine::UIElements::Column* value);

  /// @brief Method set_columnIndex, addr 0x6c097c0, size 0xcc, virtual false, abstract: false, final false
  inline void set_columnIndex(int32_t value);

  /// @brief Method set_columnName, addr 0x6c096a0, size 0xcc, virtual false, abstract: false, final false
  inline void set_columnName(::StringW value);

  /// @brief Method set_direction, addr 0x6c098a4, size 0xcc, virtual false, abstract: false, final false
