...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6da71c4, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TransitionCancelEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6da71c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TransitionCancelEvent___c", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TransitionCancelEvent___c(TransitionCancelEvent___c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TransitionCancelEvent___c", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TransitionCancelEvent___c(TransitionCancelEvent___cconst&) = delete;
...
public:
  ...
  /// @brief Method .ctor, addr 0x6da7120, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TransitionCancelEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TransitionCancelEvent(TransitionCancelEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TransitionCancelEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TransitionCancelEvent(TransitionCancelEventconst&) = delete;
