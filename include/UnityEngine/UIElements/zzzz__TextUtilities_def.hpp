...
public:
  // Declarations
  /// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x4a903cc, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFontAsset, addr 0x4a8ff7c, size 0x1bc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAsset(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetTextCoreSettingsForElement, addr 0x4a90710, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextSettingsFrom, addr 0x4a8feb8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFontAssigned, addr 0x4a9064c, size 0xc4, virtual false, abstract: false, final false
  static inline bool IsFontAssigned(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method MeasureVisualElementTextSize, addr 0x4a904d0, size 0x17c, virtual false, abstract: false, final false
