...
public:
  // Declarations
  /// @brief Method ComputeTextScaling, addr 0x2e468dc, size 0xfc, virtual false, abstract: false, final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method MeasureVisualElementTextSize, addr 0x2e469d8, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFontAssigned, addr 0x2e47388, size 0x84, virtual false, abstract: false, final false
