...
public:
  // Declarations
  /// @brief Method ComputeTextScaling addr 0x2cde52c size 0xfc virtual false final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method MeasureVisualElementTextSize addr 0x2cde628 size 0x464 virtual false final false
  ...
  /// @brief Method GetFontAsset addr 0x2cdde70 size 0x128 virtual false final false
  ...
  /// @brief Method GetTextCoreSettingsForElement addr 0x2cdf190 size 0x3b4 virtual false final false
