...
public:
  // Declarations
  /// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x4a963b4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFontAsset, addr 0x4a95f64, size 0x1bc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAsset(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetTextCoreSettingsForElement, addr 0x4a966f8, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextSettingsFrom, addr 0x4a95ea0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFontAssigned, addr 0x4a96634, size 0xc4, virtual false, abstract: false, final false
  static inline bool IsFontAssigned(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method MeasureVisualElementTextSize, addr 0x4a964b8, size 0x17c, virtual false, abstract: false, final false
