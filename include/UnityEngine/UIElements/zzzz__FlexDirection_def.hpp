...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::FlexDirection, "UnityEngine.UIElements", "FlexDirection");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::FlexDirection) == 0x4, "Size mismatch!");
