...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DropdownMenuSeparator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DropdownMenuSeparator*, "UnityEngine.UIElements", "DropdownMenuSeparator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d908c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW subMenuPath);

  /// @brief Method get_subMenuPath, addr 0x6d908c0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::DropdownMenuSeparator) == 0x18, "Size mismatch!");
