...
/// @brief Method ApplyConverterGroupToSource, addr 0x6a740d8, size 0x8c, virtual false, abstract: false, final false
inline void ApplyConverterGroupToSource(::UnityEngine::UIElements::ConverterGroup*  group) ;

/// @brief Method ApplyConverterGroupToUI, addr 0x6a74164, size 0x8c, virtual false, abstract: false, final false
inline void ApplyConverterGroupToUI(::UnityEngine::UIElements::ConverterGroup*  group) ;

/// @brief Method CacheReflectionInfo, addr 0x6a73de8, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method get_bindingMode, addr 0x6a73fb4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingMode get_bindingMode() ;

/// @brief Method get_dataSource, addr 0x6a73f78, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_dataSource() ;

/// @brief Method get_dataSourcePath, addr 0x6a73f98, size 0x10, virtual true, abstract: false, final true
inline ::Unity::Properties::PropertyPath get_dataSourcePath() ;

/// @brief Method get_dataSourceType, addr 0x6a73f88, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_dataSourceType() ;

/// @brief Method get_sourceToUiConverters, addr 0x6a73fd8, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ConverterGroup* get_sourceToUiConverters() ;

/// @brief Method get_uiToSourceConverters, addr 0x6a74058, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ConverterGroup* get_uiToSourceConverters() ;

/// @brief Method get_updateUIMethod, addr 0x6a67354, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_bindingMode, addr 0x6a73fbc, size 0x1c, virtual false, abstract: false, final false
inline void set_bindingMode(::UnityEngine::UIElements::BindingMode  value) ;

/// @brief Method set_dataSource, addr 0x6a73f80, size 0x8, virtual false, abstract: false, final false
inline void set_dataSource(::System::Object*  value) ;

/// @brief Method set_dataSourcePath, addr 0x6a73fa8, size 0xc, virtual false, abstract: false, final false
inline void set_dataSourcePath(::Unity::Properties::PropertyPath  value) ;

/// @brief Method set_dataSourceType, addr 0x6a73f90, size 0x8, virtual false, abstract: false, final false
