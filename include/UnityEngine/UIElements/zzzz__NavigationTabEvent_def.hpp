...
public:
  ...
  /// @brief Method DetermineMoveDirection, addr 0x35e9304, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::__NavigationTabEvent__Direction DetermineMoveDirection(int32_t moveValue);

  /// @brief Method GetPooled, addr 0x35e9320, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::NavigationTabEvent* GetPooled(int32_t moveValue);

  /// @brief Method Init, addr 0x35e93ac, size 0x50, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x35e93fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_direction, addr 0x35e92fc, size 0x8, virtual false, abstract: false, final false
