...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::FocusChangeDirection*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::FocusChangeDirection*, "UnityEngine.UIElements", "FocusChangeDirection");
...
public:
  ...
  __declspec(property(get = getStaticF__lastValue_k__BackingField, put = setStaticF__lastValue_k__BackingField)) ::UnityEngine::UIElements::FocusChangeDirection* _lastValue_k__BackingField;

  /// @brief Field <none>k__BackingField, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF__none_k__BackingField, put = setStaticF__none_k__BackingField)) ::UnityEngine::UIElements::FocusChangeDirection* _none_k__BackingField;
  ...
  /// @brief Method ApplyTo, addr 0x6da4af4, size 0x28, virtual true, abstract: false, final false
  inline void ApplyTo(::UnityEngine::UIElements::FocusController* focusController, ::UnityEngine::UIElements::Focusable* f);

  /// @brief Method Dispose, addr 0x6da4af0, size 0x4, virtual true, abstract: false, final false
  inline void Dispose();

  static inline ::UnityEngine::UIElements::FocusChangeDirection* New_ctor(int32_t value);

  /// @brief Method System.IDisposable.Dispose, addr 0x6da4ae4, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6da4ad0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lastValue, addr 0x6da4a74, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::FocusChangeDirection* get_lastValue();

  /// @brief Method get_none, addr 0x6da4a18, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::FocusChangeDirection* get_none();

  /// @brief Method get_unspecified, addr 0x6da49bc, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::FocusChangeDirection* get_unspecified();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method op_Implicit, addr 0x6da4ad8, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::FocusChangeDirection) == 0x18, "Size mismatch!");
