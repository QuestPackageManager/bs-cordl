...
public:
  ...
  /// @brief Method get_texture addr 0x2c57cb4 size 0x8 virtual false final false
  inline ::UnityEngine::Texture2D* get_texture();

  /// @brief Method set_texture addr 0x2c57cbc size 0x8 virtual false final false
  inline void set_texture(::UnityEngine::Texture2D* value);

  /// @brief Method get_hotspot addr 0x2c57cc4 size 0x8 virtual false final false
  inline ::UnityEngine::Vector2 get_hotspot();

  /// @brief Method set_hotspot addr 0x2c57ccc size 0x8 virtual false final false
  inline void set_hotspot(::UnityEngine::Vector2 value);

  /// @brief Method get_defaultCursorId addr 0x2c57cd4 size 0x8 virtual false final false
  inline int32_t get_defaultCursorId();

  /// @brief Method set_defaultCursorId addr 0x2c57cdc size 0x8 virtual false final false
  inline void set_defaultCursorId(int32_t value);

  /// @brief Method Equals addr 0x2c57ce4 size 0x90 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2c57d74 size 0xb0 virtual true final true
  inline bool Equals(::UnityEngine::UIElements::Cursor other);

  /// @brief Method GetHashCode addr 0x2c57e24 size 0xd8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality addr 0x2c57efc size 0x30 virtual false final false
  static inline bool op_Equality(::UnityEngine::UIElements::Cursor style1, ::UnityEngine::UIElements::Cursor style2);

  /// @brief Method ToString addr 0x2c57f2c size 0x88 virtual true final false
