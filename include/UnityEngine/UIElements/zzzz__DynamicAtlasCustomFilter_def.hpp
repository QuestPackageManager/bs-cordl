...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2ec0de8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ec0d10, size 0xd8, virtual false, abstract: false, final false
