...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6c2e4d4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c2e454, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DynamicAtlasCustomFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DynamicAtlasCustomFilter(DynamicAtlasCustomFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DynamicAtlasCustomFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DynamicAtlasCustomFilter(DynamicAtlasCustomFilterconst&) = delete;
