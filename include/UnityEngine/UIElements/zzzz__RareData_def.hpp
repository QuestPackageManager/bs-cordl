...
public:
  ...
  /// @brief Method Copy, addr 0x6b35f9c, size 0x10, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::RareData Copy();

  /// @brief Method CopyFrom, addr 0x6b35fac, size 0x8, virtual true, abstract: false, final true
  inline void CopyFrom(::ByRef<::UnityEngine::UIElements::RareData> other);

  /// @brief Method Equals, addr 0x6b36118, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b360d4, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::RareData other);

  /// @brief Method GetHashCode, addr 0x6b361bc, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b35fb4, size 0x120, virtual false, abstract: false, final false
