...
public:
  ...
  /// @brief Method Copy, addr 0x4a834e4, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::RareData Copy();

  /// @brief Method CopyFrom, addr 0x4a83500, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(::ByRef<::UnityEngine::UIElements::RareData> other);

  /// @brief Method Equals, addr 0x4a8367c, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4a83638, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::RareData other);

  /// @brief Method GetHashCode, addr 0x4a8371c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4a83514, size 0x124, virtual false, abstract: false, final false
