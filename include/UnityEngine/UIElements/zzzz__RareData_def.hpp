...
public:
  ...
  /// @brief Method Copy, addr 0x33d31ec, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::RareData Copy();

  /// @brief Method CopyFrom, addr 0x33d3208, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::RareData> other);

  /// @brief Method Equals, addr 0x33d3380, size 0xa0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x33d333c, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::RareData other);

  /// @brief Method GetHashCode, addr 0x33d3420, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x33d321c, size 0x120, virtual false, abstract: false, final false
