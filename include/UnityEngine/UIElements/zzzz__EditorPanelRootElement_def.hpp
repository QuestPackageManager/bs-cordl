...
/// @brief Method OnEventCompletedAtAnyTarget, addr 0x6bf038c, size 0x3c, virtual false, abstract: false, final false
inline void OnEventCompletedAtAnyTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method .ctor, addr 0x6bee548, size 0x238, virtual false, abstract: false, final false
inline void _ctor() ;
