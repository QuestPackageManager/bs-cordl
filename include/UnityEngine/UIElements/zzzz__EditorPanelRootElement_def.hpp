...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EditorPanelRootElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EditorPanelRootElement(EditorPanelRootElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EditorPanelRootElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EditorPanelRootElement(EditorPanelRootElementconst&) = delete;
