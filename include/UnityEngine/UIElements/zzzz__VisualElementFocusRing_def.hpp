...
public:
  ...
  /// @brief Method .ctor, addr 0x499d338, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// Dependencies System.Object, UnityEngine.UIElements.IFocusRing, UnityEngine.UIElements.VisualElementFocusRing::DefaultFocusOrder
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  /// @brief Method BuildRingForScopeRecursive, addr 0x499cd98, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoUpdate, addr 0x499ccc8, size 0xd0, virtual false, abstract: false, final false
  inline void DoUpdate();

  /// @brief Method FocusRingAutoIndexSort, addr 0x499c8c0, size 0x318, virtual false, abstract: false, final false
  ...
  /// @brief Method FocusRingSort, addr 0x499cbd8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFocusChangeDirection, addr 0x499d3e8, size 0x3b8, virtual true, abstract: false, final true
  ...
  /// @brief Method GetFocusableInternalIndex, addr 0x499d340, size 0xa8, virtual false, abstract: false, final false
  inline int32_t GetFocusableInternalIndex(::UnityEngine::UIElements::Focusable* f);

  /// @brief Method GetNextFocusable, addr 0x499d7a0, size 0x3f4, virtual true, abstract: false, final true
  ...
  /// @brief Method GetNextFocusableInTree, addr 0x499db94, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousFocusableInTree, addr 0x499dc30, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method SortAndFlattenScopeLists, addr 0x499d07c, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499c7f4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_defaultFocusOrder, addr 0x499c8b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementFocusRing_DefaultFocusOrder get_defaultFocusOrder();

  /// @brief Method get_focusController, addr 0x499c88c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method set_defaultFocusOrder, addr 0x499c8b8, size 0x8, virtual false, abstract: false, final false
