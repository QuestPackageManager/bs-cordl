...
/// @brief Field m_TriggerEvent, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TriggerEvent, put=__cordl_internal_set_m_TriggerEvent)) ::ArrayW<::UnityEngine::UIElements::IPointerOrMouseEvent*,::Array<::UnityEngine::UIElements::IPointerOrMouseEvent*>*>  m_TriggerEvent;

/// @brief Method CommitElementUnderPointers, addr 0x6bcbd58, size 0xcac, virtual false, abstract: false, final false
...
/// @brief Method GetEventPointerPosition, addr 0x6bcb9bc, size 0x1c0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetEventPointerPosition(::UnityEngine::UIElements::EventBase*  triggerEvent) ;

/// @brief Method GetTopElementUnderPointer, addr 0x6bcb828, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetTopElementUnderPointer(int32_t  pointerId) ;

/// @brief Method GetTopElementUnderPointer, addr 0x6bcb7b4, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x6bcb858, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x6bcbd50, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x6bcbb84, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method SetTemporaryElementUnderPointer, addr 0x6bcbb7c, size 0x8, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIElements::IPointerOrMouseEvent*,::Array<::UnityEngine::UIElements::IPointerOrMouseEvent*>*> const& __cordl_internal_get_m_TriggerEvent() const;

constexpr ::ArrayW<::UnityEngine::UIElements::IPointerOrMouseEvent*,::Array<::UnityEngine::UIElements::IPointerOrMouseEvent*>*>& __cordl_internal_get_m_TriggerEvent() ;
...
/// @brief Method .ctor, addr 0x6bcd000, size 0x13c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_TriggerEvent, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::UnityEngine::UIElements::IPointerOrMouseEvent*,::Array<::UnityEngine::UIElements::IPointerOrMouseEvent*>*>  ___m_TriggerEvent;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::ElementUnderPointer, 0x38>, "Size mismatch!");
