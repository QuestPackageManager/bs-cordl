...
public:
  ...
  /// @brief Method CommitElementUnderPointers, addr 0x359d3f0, size 0xc54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEventPointerPosition, addr 0x359cfdc, size 0x1b8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetEventPointerPosition(::UnityEngine::UIElements::EventBase* triggerEvent);

  /// @brief Method GetTopElementUnderPointer, addr 0x359ce4c, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetTopElementUnderPointer(int32_t pointerId);

  /// @brief Method GetTopElementUnderPointer, addr 0x359cdd8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetElementUnderPointer, addr 0x359ce7c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method SetElementUnderPointer, addr 0x359d3e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetElementUnderPointer, addr 0x359d19c, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTemporaryElementUnderPointer, addr 0x359d194, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x359e7b8, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor();
