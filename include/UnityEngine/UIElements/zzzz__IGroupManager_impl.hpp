...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::IGroupManager::*)(::UnityEngine::UIElements::IGroupBox*)>(
    &::UnityEngine::UIElements::IGroupManager::Init)> {
