...
// Write type traits
MARK_VAL_T(::UnityEngine::UIElements::Axis);
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
// CS Name: UnityEngine.UIElements.Axis
...
public:
  ...
  static ::UnityEngine::UIElements::Axis const X;

  /// @brief Field Y value: I32(1)
  static ::UnityEngine::UIElements::Axis const Y;

  /// @brief Field Z value: I32(2)
  static ::UnityEngine::UIElements::Axis const Z;
...
static_assert(offsetof(::UnityEngine::UIElements::Axis, value__) == 0x0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Axis, 0x4>, "Size mismatch!");

} // namespace UnityEngine::UIElements
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::Axis, "UnityEngine.UIElements", "Axis");
