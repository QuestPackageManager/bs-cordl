...
public:
  ...
  /// @brief Method .ctor, addr 0x6aec478, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::UnityEngine::UIElements::BindingId> propertyName);

  /// @brief Method get_propertyName, addr 0x6aec480, size 0x10, virtual false, abstract: false, final false
