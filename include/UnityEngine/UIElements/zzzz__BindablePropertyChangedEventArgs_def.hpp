...
/// @brief Method .ctor, addr 0x6a7a230, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::UnityEngine::UIElements::BindingId>  propertyName) ;

/// @brief Method get_propertyName, addr 0x6a7a238, size 0x10, virtual false, abstract: false, final false
