...
public:
  // Declarations
  /// @brief Method GetCursorPosition, addr 0x2ebec10, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeTextWidth, addr 0x2ebedbc, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method ComputeTextHeight, addr 0x2ebef00, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method GetVertices, addr 0x2ebf044, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOffset, addr 0x2ebf290, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeTextScaling, addr 0x2ebf41c, size 0xfc, virtual false, abstract: false, final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method DoComputeTextWidth, addr 0x2ebeec4, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoComputeTextHeight, addr 0x2ebf008, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoGetCursorPosition, addr 0x2ebed54, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices, addr 0x2ebf234, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetOffset, addr 0x2ebf3c0, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 DoGetOffset(::UnityEngine::UIElements::TextNativeSettings settings, ::UnityEngine::Rect rect);

  /// @brief Method DoComputeTextWidth_Injected, addr 0x2ebf518, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoComputeTextHeight_Injected, addr 0x2ebf554, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoGetCursorPosition_Injected, addr 0x2ebf590, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices_Injected, addr 0x2ebf5ec, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetOffset_Injected, addr 0x2ebf648, size 0x54, virtual false, abstract: false, final false
