...
public:
  // Declarations
  /// @brief Method GetCursorPosition, addr 0x2ea5828, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeTextWidth, addr 0x2ea59d4, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method ComputeTextHeight, addr 0x2ea5b18, size 0x108, virtual false, abstract: false, final false
  static inline float_t ComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method GetVertices, addr 0x2ea5c5c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOffset, addr 0x2ea5ea8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeTextScaling, addr 0x2ea6034, size 0xfc, virtual false, abstract: false, final false
  static inline float_t ComputeTextScaling(::UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint);

  /// @brief Method DoComputeTextWidth, addr 0x2ea5adc, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoComputeTextHeight, addr 0x2ea5c20, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight(::UnityEngine::UIElements::TextNativeSettings settings);

  /// @brief Method DoGetCursorPosition, addr 0x2ea596c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices, addr 0x2ea5e4c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetOffset, addr 0x2ea5fd8, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 DoGetOffset(::UnityEngine::UIElements::TextNativeSettings settings, ::UnityEngine::Rect rect);

  /// @brief Method DoComputeTextWidth_Injected, addr 0x2ea6130, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextWidth_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoComputeTextHeight_Injected, addr 0x2ea616c, size 0x3c, virtual false, abstract: false, final false
  static inline float_t DoComputeTextHeight_Injected(ByRef<::UnityEngine::UIElements::TextNativeSettings> settings);

  /// @brief Method DoGetCursorPosition_Injected, addr 0x2ea61a8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertices_Injected, addr 0x2ea6204, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoGetOffset_Injected, addr 0x2ea6260, size 0x54, virtual false, abstract: false, final false
