...
public:
  ...
  /// @brief Method MoveNext, addr 0x6af52b4, size 0x20, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x6af52d4, size 0x2c, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method .ctor, addr 0x6af5094, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyViewModel* hierarchyViewModel);

  /// @brief Method get_Current, addr 0x6af5248, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Add, addr 0x6af5130, size 0x38, virtual true, abstract: false, final true
  inline int32_t Add(::System::Object* value);

  /// @brief Method Clear, addr 0x6af5168, size 0x38, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x6af4d54, size 0x90, virtual true, abstract: false, final true
  inline bool Contains(::System::Object* value);

  /// @brief Method CopyTo, addr 0x6af4f5c, size 0xbc, virtual true, abstract: false, final true
  inline void CopyTo(::System::Array* array, int32_t index);

  /// @brief Method GetEnumerator, addr 0x6af5018, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method IndexOf, addr 0x6af4de4, size 0xbc, virtual true, abstract: false, final true
  inline int32_t IndexOf(::System::Object* value);

  /// @brief Method Insert, addr 0x6af51a0, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x6af51d8, size 0x38, virtual true, abstract: false, final true
  inline void Remove(::System::Object* value);

  /// @brief Method RemoveAt, addr 0x6af5210, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6af4ea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Unity::Hierarchy::HierarchyViewModel* viewModel);

  /// @brief Method get_Count, addr 0x6af4d3c, size 0x18, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsFixedSize, addr 0x6af4d2c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsFixedSize();

  /// @brief Method get_IsReadOnly, addr 0x6af4d34, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_IsSynchronized, addr 0x6af50c0, size 0x38, virtual true, abstract: false, final true
  inline bool get_IsSynchronized();

  /// @brief Method get_Item, addr 0x6af4ea8, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Object* get_Item(int32_t index);

  /// @brief Method get_SyncRoot, addr 0x6af50f8, size 0x38, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Item, addr 0x6af4f24, size 0x38, virtual true, abstract: false, final true
