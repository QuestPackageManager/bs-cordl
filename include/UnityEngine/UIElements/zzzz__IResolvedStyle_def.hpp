...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IResolvedStyle*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IResolvedStyle*, "UnityEngine.UIElements", "IResolvedStyle");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IResolvedStyle", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IResolvedStyle(IResolvedStyleconst&) = delete;
