...
/// @brief Field m_LastFocusedElementTreeChildIndexes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_LastFocusedElementTreeChildIndexes, put=__cordl_internal_set_m_LastFocusedElementTreeChildIndexes)) ::System::Collections::Generic::List_1<int32_t>*  m_LastFocusedElementTreeChildIndexes;
...
/// @brief Field m_ScheduleDeferredScrollToItem, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScheduleDeferredScrollToItem, put=__cordl_internal_set_m_ScheduleDeferredScrollToItem)) ::UnityEngine::UIElements::IVisualElementScheduledItem*  m_ScheduleDeferredScrollToItem;
