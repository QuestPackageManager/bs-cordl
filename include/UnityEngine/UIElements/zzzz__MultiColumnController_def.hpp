...
/// @brief Field m_MultiColumnHeader, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_MultiColumnHeader, put=__cordl_internal_set_m_MultiColumnHeader)) ::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader*  m_MultiColumnHeader;
...
template<typename T>
static inline void BindCellItem(::UnityEngine::UIElements::VisualElement*  ve, int32_t  rowIndex, ::UnityEngine::UIElements::Column*  column, T  item) ;

/// @brief Method BindItem, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline void BindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index, T  item) ;

/// @brief Method CombinedComparison, addr 0x6b943fc, size 0x538, virtual false, abstract: false, final false
...
template<typename T>
static inline void DefaultBindCellItem(::UnityEngine::UIElements::VisualElement*  ve, T  item) ;

/// @brief Method DefaultMakeCellItem, addr 0x6b92178, size 0xac, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::VisualElement* DefaultMakeCellItem() ;

/// @brief Method DestroyItem, addr 0x6b92b00, size 0x428, virtual false, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x6b9324c, size 0x658, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetIndexFromList, addr 0x6b94934, size 0x98, virtual false, abstract: false, final false
static inline int32_t GetIndexFromList(int32_t  index, ::System::Collections::Generic::List_1<int32_t>*  indices) ;

/// @brief Method GetSortedIndex, addr 0x6b949cc, size 0x6c, virtual false, abstract: false, final false
inline int32_t GetSortedIndex(int32_t  sourceIndex) ;

/// @brief Method GetSourceIndex, addr 0x6b92a94, size 0x6c, virtual false, abstract: false, final false
inline int32_t GetSourceIndex(int32_t  sortedIndex) ;

/// @brief Method MakeItem, addr 0x6b92224, size 0x450, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* MakeItem() ;

static inline ::UnityEngine::UIElements::MultiColumnController* New_ctor(::UnityEngine::UIElements::Columns*  columns, ::UnityEngine::UIElements::SortColumnDescriptions*  sortDescriptions, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::SortColumnDescription*>*  sortedColumns) ;

/// @brief Method OnColumnAdded, addr 0x6b94e08, size 0x18, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x6b94ea8, size 0x38, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::ColumnsDataType  type) ;

/// @brief Method OnColumnContainerGeometryChanged, addr 0x6b93d2c, size 0x8, virtual false, abstract: false, final false
inline void OnColumnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x6b94e20, size 0x18, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x6b94e38, size 0x34, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x6b94a54, size 0x3b4, virtual false, abstract: false, final false
inline void OnColumnResized(int32_t  index, float_t  width) ;

/// @brief Method OnColumnSortingChanged, addr 0x6b93d34, size 0x50, virtual false, abstract: false, final false
inline void OnColumnSortingChanged() ;

/// @brief Method OnColumnsChanged, addr 0x6b94e6c, size 0x3c, virtual false, abstract: false, final false
inline void OnColumnsChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnContextMenuPopulateEvent, addr 0x6b94a38, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnHorizontalScrollerValueChanged, addr 0x6b938a4, size 0x18, virtual false, abstract: false, final false
inline void OnHorizontalScrollerValueChanged(float_t  v) ;

/// @brief Method OnViewDataRestored, addr 0x6b94ee0, size 0x18, virtual false, abstract: false, final false
inline void OnViewDataRestored() ;

/// @brief Method OnViewportGeometryChanged, addr 0x6b938bc, size 0x2b0, virtual false, abstract: false, final false
inline void OnViewportGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method PrepareView, addr 0x6b92f28, size 0x324, virtual false, abstract: false, final false
inline void PrepareView(::UnityEngine::UIElements::BaseVerticalCollectionView*  collectionView) ;

/// @brief Method SortIfNeeded, addr 0x6b93e70, size 0x58c, virtual false, abstract: false, final false
inline void SortIfNeeded() ;

/// @brief Method UnbindCellItem, addr 0x6b92144, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method UnbindItem, addr 0x6b92674, size 0x420, virtual false, abstract: false, final false
inline void UnbindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method UpdateContentContainer, addr 0x6b93b6c, size 0x1c0, virtual false, abstract: false, final false
inline void UpdateContentContainer(::UnityEngine::UIElements::BaseVerticalCollectionView*  collectionView) ;

/// @brief Method UpdateDragger, addr 0x6b93d84, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b91c60, size 0x4e4, virtual false, abstract: false, final false
...
/// @brief Method add_columnSortingChanged, addr 0x6b91950, size 0xac, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_headerContextMenuPopulateEvent, addr 0x6b91aa8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_header, addr 0x6b91c28, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader* get_header() ;

/// @brief Method get_sortingMode, addr 0x6b91c30, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnSortingMode get_sortingMode() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnSortingChanged, addr 0x6b919fc, size 0xac, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_headerContextMenuPopulateEvent, addr 0x6b91b68, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_sortingMode, addr 0x6b91c38, size 0x28, virtual false, abstract: false, final false
