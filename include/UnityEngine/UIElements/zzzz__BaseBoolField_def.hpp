...
/// @brief Method InitLabel, addr 0x6a8ce24, size 0xfc, virtual true, abstract: false, final false
inline void InitLabel() ;

static inline ::UnityEngine::UIElements::BaseBoolField* New_ctor(::StringW  label) ;

/// @brief Method OnClickEvent, addr 0x6a8cfe4, size 0x380, virtual false, abstract: false, final false
inline void OnClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x6a8cdd0, size 0x38, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterEditingCallbacks, addr 0x6a8d5ec, size 0x118, virtual true, abstract: false, final false
inline void RegisterEditingCallbacks() ;

/// @brief Method SetValueWithoutNotify, addr 0x6a8cf20, size 0xc4, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(bool  newValue) ;

/// @brief Method ShouldIgnoreClick, addr 0x6a8d364, size 0xe4, virtual false, abstract: false, final false
inline bool ShouldIgnoreClick(::UnityEngine::Vector3  position) ;

/// @brief Method ToggleValue, addr 0x6a8d448, size 0x38, virtual true, abstract: false, final false
inline void ToggleValue() ;

/// @brief Method UnregisterEditingCallbacks, addr 0x6a8d704, size 0x118, virtual true, abstract: false, final false
inline void UnregisterEditingCallbacks() ;

/// @brief Method UpdateMixedValueContent, addr 0x6a8d480, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a8ca38, size 0x29c, virtual false, abstract: false, final false
...
/// @brief Method get_text, addr 0x6a8ce08, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method get_toggleOnLabelClick, addr 0x6a8ca18, size 0x8, virtual false, abstract: false, final false
inline bool get_toggleOnLabelClick() ;

/// @brief Method get_toggleOnTextClick, addr 0x6a8ca28, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_acceptClicksIfDisabled, addr 0x6a8ca00, size 0x18, virtual false, abstract: false, final false
inline void set_acceptClicksIfDisabled(bool  value) ;

/// @brief Method set_text, addr 0x6a8ccd4, size 0xfc, virtual false, abstract: false, final false
inline void set_text(::StringW  value) ;

/// @brief Method set_toggleOnLabelClick, addr 0x6a8ca20, size 0x8, virtual false, abstract: false, final false
inline void set_toggleOnLabelClick(bool  value) ;

/// @brief Method set_toggleOnTextClick, addr 0x6a8ca30, size 0x8, virtual false, abstract: false, final false
