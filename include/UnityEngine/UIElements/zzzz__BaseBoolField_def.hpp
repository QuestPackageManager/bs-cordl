...
public:
  ...
  /// @brief Method InitLabel, addr 0x6aff06c, size 0xfc, virtual true, abstract: false, final false
  inline void InitLabel();

  static inline ::UnityEngine::UIElements::BaseBoolField* New_ctor(::StringW label);

  /// @brief Method OnClickEvent, addr 0x6aff22c, size 0x380, virtual false, abstract: false, final false
  inline void OnClickEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method OnNavigationSubmit, addr 0x6aff018, size 0x38, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method RegisterEditingCallbacks, addr 0x6aff834, size 0x118, virtual true, abstract: false, final false
  inline void RegisterEditingCallbacks();

  /// @brief Method SetValueWithoutNotify, addr 0x6aff168, size 0xc4, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(bool newValue);

  /// @brief Method ShouldIgnoreClick, addr 0x6aff5ac, size 0xe4, virtual false, abstract: false, final false
  inline bool ShouldIgnoreClick(::UnityEngine::Vector3 position);

  /// @brief Method ToggleValue, addr 0x6aff690, size 0x38, virtual true, abstract: false, final false
  inline void ToggleValue();

  /// @brief Method UnregisterEditingCallbacks, addr 0x6aff94c, size 0x118, virtual true, abstract: false, final false
  inline void UnregisterEditingCallbacks();

  /// @brief Method UpdateMixedValueContent, addr 0x6aff6c8, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6afec80, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x6aff050, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_toggleOnLabelClick, addr 0x6afec60, size 0x8, virtual false, abstract: false, final false
  inline bool get_toggleOnLabelClick();

  /// @brief Method get_toggleOnTextClick, addr 0x6afec70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_acceptClicksIfDisabled, addr 0x6afec48, size 0x18, virtual false, abstract: false, final false
  inline void set_acceptClicksIfDisabled(bool value);

  /// @brief Method set_text, addr 0x6afef1c, size 0xfc, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_toggleOnLabelClick, addr 0x6afec68, size 0x8, virtual false, abstract: false, final false
  inline void set_toggleOnLabelClick(bool value);

  /// @brief Method set_toggleOnTextClick, addr 0x6afec78, size 0x8, virtual false, abstract: false, final false
