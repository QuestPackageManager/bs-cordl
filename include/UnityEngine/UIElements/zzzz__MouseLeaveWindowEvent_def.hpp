...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7301), inst: 4551 }), TypeDefinitionIndex(TypeDefinitionIndex(7301))}
...
public:
  // Declarations
  /// @brief Method Init addr 0x2ce9584 size 0x50 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2ce95d4 size 0xa4 virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* New_ctor();

  /// @brief Method .ctor addr 0x2ce9678 size 0x50 virtual false final false
  inline void _ctor();

  /// @brief Method GetPooled addr 0x2ce96c8 size 0xb4 virtual false final false
  static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* GetPooled(::UnityEngine::Event* systemEvent);

  /// @brief Method PostDispatch addr 0x2ce977c size 0x15c virtual true final false
