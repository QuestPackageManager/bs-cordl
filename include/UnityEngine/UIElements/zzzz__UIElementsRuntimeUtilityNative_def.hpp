...
public:
  ...
  /// @brief Method RegisterPlayerloopCallback, addr 0x300caf8, size 0x28, virtual false, abstract: false, final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method RepaintOverlayPanels, addr 0x300ca30, size 0x64, virtual false, abstract: false, final false
  static inline void RepaintOverlayPanels();

  /// @brief Method UnregisterPlayerloopCallback, addr 0x300cb20, size 0x28, virtual false, abstract: false, final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method UpdateRuntimePanels, addr 0x300ca94, size 0x64, virtual false, abstract: false, final false
  static inline void UpdateRuntimePanels();

  /// @brief Method VisualElementCreation, addr 0x300cb48, size 0x28, virtual false, abstract: false, final false
