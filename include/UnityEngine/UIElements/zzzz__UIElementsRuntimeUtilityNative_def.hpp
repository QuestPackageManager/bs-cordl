...
public:
  ...
  /// @brief Method RegisterPlayerloopCallback, addr 0x6c5e5d0, size 0x28, virtual false, abstract: false, final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method RenderOffscreenPanels, addr 0x6c5e568, size 0x68, virtual false, abstract: false, final false
  static inline void RenderOffscreenPanels();

  /// @brief Method RepaintPanels, addr 0x6c5e4f8, size 0x70, virtual false, abstract: false, final false
  static inline void RepaintPanels(bool onlyOffscreen);

  /// @brief Method UnregisterPlayerloopCallback, addr 0x6c5e5f8, size 0x28, virtual false, abstract: false, final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method UpdatePanels, addr 0x6c5e490, size 0x68, virtual false, abstract: false, final false
  static inline void UpdatePanels();

  /// @brief Method VisualElementCreation, addr 0x6c5e620, size 0x28, virtual false, abstract: false, final false
