...
/// @brief Method RegisterPlayerloopCallback, addr 0x6bec388, size 0x28, virtual false, abstract: false, final false
static inline void RegisterPlayerloopCallback() ;

/// @brief Method RenderOffscreenPanels, addr 0x6bec320, size 0x68, virtual false, abstract: false, final false
static inline void RenderOffscreenPanels() ;

/// @brief Method RepaintPanels, addr 0x6bec2b0, size 0x70, virtual false, abstract: false, final false
static inline void RepaintPanels(bool  onlyOffscreen) ;

/// @brief Method UnregisterPlayerloopCallback, addr 0x6bec3b0, size 0x28, virtual false, abstract: false, final false
static inline void UnregisterPlayerloopCallback() ;

/// @brief Method UpdatePanels, addr 0x6bec248, size 0x68, virtual false, abstract: false, final false
static inline void UpdatePanels() ;

/// @brief Method VisualElementCreation, addr 0x6bec3d8, size 0x28, virtual false, abstract: false, final false
