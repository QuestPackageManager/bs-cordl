...
public:
  ...
  /// @brief Method RegisterPlayerloopCallback, addr 0x4a460c4, size 0x28, virtual false, abstract: false, final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method RepaintOffscreenPanels, addr 0x4a46060, size 0x64, virtual false, abstract: false, final false
  static inline void RepaintOffscreenPanels();

  /// @brief Method RepaintOverlayPanels, addr 0x4a45f98, size 0x64, virtual false, abstract: false, final false
  static inline void RepaintOverlayPanels();

  /// @brief Method UnregisterPlayerloopCallback, addr 0x4a460ec, size 0x28, virtual false, abstract: false, final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method UpdateRuntimePanels, addr 0x4a45ffc, size 0x64, virtual false, abstract: false, final false
  static inline void UpdateRuntimePanels();

  /// @brief Method VisualElementCreation, addr 0x4a46114, size 0x28, virtual false, abstract: false, final false
