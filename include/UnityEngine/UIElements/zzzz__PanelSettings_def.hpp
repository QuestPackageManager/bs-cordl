...
/// @brief Method CreateRelatedRuntimePanel, addr 0x6be26a4, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* CreateRelatedRuntimePanel() ;

/// @brief Method DisposePanel, addr 0x6be12bc, size 0x20, virtual false, abstract: false, final false
inline void DisposePanel() ;

/// @brief Method DisposeRelatedPanel, addr 0x6be2974, size 0x60, virtual false, abstract: false, final false
inline void DisposeRelatedPanel() ;

/// @brief Method MarkPotentiallyEmpty, addr 0x6be2644, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SetPanelChangeReceiver, addr 0x6be1334, size 0x28, virtual false, abstract: false, final false
inline void SetPanelChangeReceiver() ;

/// @brief Method SetSortingPriority, addr 0x6be0bf0, size 0x28, virtual false, abstract: false, final false
inline void SetSortingPriority() ;

/// @brief Method SetTargetDisplay, addr 0x6be0c54, size 0x24, virtual false, abstract: false, final false
inline void SetTargetDisplay() ;

/// @brief Method SetTargetTexture, addr 0x6be0aa4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6be0f98, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::PanelSettings*  settings) ;

/// @brief Method get_isInitialized, addr 0x6be0e9c, size 0x10, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_panel, addr 0x6be0d2c, size 0x150, virtual false, abstract: false, final false
...
// Dependencies UnityEngine.Color, UnityEngine.Rect, UnityEngine.ScriptableObject, UnityEngine.UIElements.BindingLogLevel, UnityEngine.UIElements.PanelRenderMode, UnityEngine.UIElements.PanelScaleMode, UnityEngine.UIElements.PanelScreenMatchMode, UnityEngine.Vector2Int
namespace UnityEngine::UIElements {
// Is value type: false
...
/// @brief Method ApplyPanelSettings, addr 0x6be1364, size 0x7bc, virtual false, abstract: false, final false
inline void ApplyPanelSettings() ;

/// @brief Method ApplySortingOrder, addr 0x6be0bdc, size 0x14, virtual false, abstract: false, final false
inline void ApplySortingOrder() ;

/// @brief Method ApplyThemeStyleSheet, addr 0x6be0924, size 0x144, virtual false, abstract: false, final false
inline void ApplyThemeStyleSheet(::UnityEngine::UIElements::VisualElement*  root) ;

/// @brief Method AssignICUData, addr 0x6be1288, size 0x8, virtual false, abstract: false, final false
inline bool AssignICUData() ;

/// @brief Method AttachAndInsertUIDocumentToVisualTree, addr 0x6be2108, size 0x9c, virtual false, abstract: false, final false
inline void AttachAndInsertUIDocumentToVisualTree(::UnityEngine::UIElements::UIDocument*  uiDocument) ;

/// @brief Method DetachUIDocument, addr 0x6be25b4, size 0x90, virtual false, abstract: false, final false
inline void DetachUIDocument(::UnityEngine::UIElements::UIDocument*  uiDocument) ;

/// @brief Method DisposePanel, addr 0x6be12dc, size 0x2c, virtual false, abstract: false, final false
inline void DisposePanel() ;

/// @brief Method GetDisplayRect, addr 0x6be1b20, size 0xf8, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetDisplayRect() ;

/// @brief Method GetPanelChangeReceiver, addr 0x6be135c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IDebugPanelChangeReceiver* GetPanelChangeReceiver() ;

/// @brief Method InitializeShaders, addr 0x6be1110, size 0x178, virtual false, abstract: false, final false
inline void InitializeShaders() ;

static inline ::UnityEngine::UIElements::PanelSettings* New_ctor() ;

/// @brief Method OnDisable, addr 0x6be1290, size 0x2c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x6be0fa4, size 0x12c, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Reset, addr 0x6be0fa0, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ResolveScale, addr 0x6be1c18, size 0xd4, virtual false, abstract: false, final false
inline float_t ResolveScale(::UnityEngine::Rect  targetRect, float_t  screenDpi) ;

/// @brief Method SetPanelChangeReceiver, addr 0x6be1318, size 0x1c, virtual false, abstract: false, final false
inline void SetPanelChangeReceiver(::UnityEngine::UIElements::IDebugPanelChangeReceiver*  value) ;

/// @brief Method SetScreenToPanelSpaceFunction, addr 0x6be1ea0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method UpdateScreenDPI, addr 0x6be10d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6be0ee8, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ScreenDPI, addr 0x6be1308, size 0x8, virtual false, abstract: false, final false
inline float_t get_ScreenDPI() ;

/// @brief Method get_bindingLogLevel, addr 0x6be0c78, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingLogLevel get_bindingLogLevel() ;

/// @brief Method get_clearColor, addr 0x6be0cf4, size 0x8, virtual false, abstract: false, final false
inline bool get_clearColor() ;

/// @brief Method get_clearDepthStencil, addr 0x6be0cd8, size 0x8, virtual false, abstract: false, final false
inline bool get_clearDepthStencil() ;

/// @brief Method get_colorClearValue, addr 0x6be0d04, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_colorClearValue() ;

/// @brief Method get_depthClearValue, addr 0x6be0ce8, size 0xc, virtual false, abstract: false, final false
inline float_t get_depthClearValue() ;

/// @brief Method get_dynamicAtlasSettings, addr 0x6be0ed8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DynamicAtlasSettings* get_dynamicAtlasSettings() ;

/// @brief Method get_fallbackDpi, addr 0x6be0b58, size 0x8, virtual false, abstract: false, final false
inline float_t get_fallbackDpi() ;

/// @brief Method get_isInitialized, addr 0x6be0e7c, size 0x20, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_match, addr 0x6be0ba8, size 0x8, virtual false, abstract: false, final false
inline float_t get_match() ;

/// @brief Method get_panel, addr 0x6be0cc4, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* get_panel() ;

/// @brief Method get_pixelsPerUnit, addr 0x6be0b08, size 0x8, virtual false, abstract: false, final false
inline float_t get_pixelsPerUnit() ;

/// @brief Method get_referenceDpi, addr 0x6be0b28, size 0x8, virtual false, abstract: false, final false
inline float_t get_referenceDpi() ;

/// @brief Method get_referenceResolution, addr 0x6be0b88, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int get_referenceResolution() ;

/// @brief Method get_referenceSpritePixelsPerUnit, addr 0x6be0af8, size 0x8, virtual false, abstract: false, final false
inline float_t get_referenceSpritePixelsPerUnit() ;

/// @brief Method get_renderMode, addr 0x6be0ac8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PanelRenderMode get_renderMode() ;

/// @brief Method get_scale, addr 0x6be0b18, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_scaleMode, addr 0x6be0ae8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PanelScaleMode get_scaleMode() ;

/// @brief Method get_screenMatchMode, addr 0x6be0b98, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PanelScreenMatchMode get_screenMatchMode() ;

/// @brief Method get_sortingOrder, addr 0x6be0bb8, size 0x8, virtual false, abstract: false, final false
inline float_t get_sortingOrder() ;

/// @brief Method get_targetDisplay, addr 0x6be0c18, size 0x8, virtual false, abstract: false, final false
inline int32_t get_targetDisplay() ;

/// @brief Method get_targetTexture, addr 0x6be0a68, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_targetTexture() ;

/// @brief Method get_themeStyleSheet, addr 0x6be090c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::ThemeStyleSheet> get_themeStyleSheet() ;

/// @brief Method get_vertexBudget, addr 0x6be0d1c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_vertexBudget() ;

/// @brief Method get_visualTree, addr 0x6be0eac, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_visualTree() ;

/// @brief Method get_worldSpaceLayer, addr 0x6be0ad8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_worldSpaceLayer() ;

/// @brief Method set_ScreenDPI, addr 0x6be1310, size 0x8, virtual false, abstract: false, final false
inline void set_ScreenDPI(float_t  value) ;

/// @brief Method set_bindingLogLevel, addr 0x6be0c80, size 0x44, virtual false, abstract: false, final false
inline void set_bindingLogLevel(::UnityEngine::UIElements::BindingLogLevel  value) ;

/// @brief Method set_clearColor, addr 0x6be0cfc, size 0x8, virtual false, abstract: false, final false
inline void set_clearColor(bool  value) ;

/// @brief Method set_clearDepthStencil, addr 0x6be0ce0, size 0x8, virtual false, abstract: false, final false
inline void set_clearDepthStencil(bool  value) ;

/// @brief Method set_colorClearValue, addr 0x6be0d10, size 0xc, virtual false, abstract: false, final false
inline void set_colorClearValue(::UnityEngine::Color  value) ;

/// @brief Method set_dynamicAtlasSettings, addr 0x6be0ee0, size 0x8, virtual false, abstract: false, final false
inline void set_dynamicAtlasSettings(::UnityEngine::UIElements::DynamicAtlasSettings*  value) ;

/// @brief Method set_fallbackDpi, addr 0x6be0b60, size 0x28, virtual false, abstract: false, final false
inline void set_fallbackDpi(float_t  value) ;

/// @brief Method set_match, addr 0x6be0bb0, size 0x8, virtual false, abstract: false, final false
inline void set_match(float_t  value) ;

/// @brief Method set_pixelsPerUnit, addr 0x6be0b10, size 0x8, virtual false, abstract: false, final false
inline void set_pixelsPerUnit(float_t  value) ;

/// @brief Method set_referenceDpi, addr 0x6be0b30, size 0x28, virtual false, abstract: false, final false
inline void set_referenceDpi(float_t  value) ;

/// @brief Method set_referenceResolution, addr 0x6be0b90, size 0x8, virtual false, abstract: false, final false
inline void set_referenceResolution(::UnityEngine::Vector2Int  value) ;

/// @brief Method set_referenceSpritePixelsPerUnit, addr 0x6be0b00, size 0x8, virtual false, abstract: false, final false
inline void set_referenceSpritePixelsPerUnit(float_t  value) ;

/// @brief Method set_renderMode, addr 0x6be0ad0, size 0x8, virtual false, abstract: false, final false
inline void set_renderMode(::UnityEngine::UIElements::PanelRenderMode  value) ;

/// @brief Method set_scale, addr 0x6be0b20, size 0x8, virtual false, abstract: false, final false
inline void set_scale(float_t  value) ;

/// @brief Method set_scaleMode, addr 0x6be0af0, size 0x8, virtual false, abstract: false, final false
inline void set_scaleMode(::UnityEngine::UIElements::PanelScaleMode  value) ;

/// @brief Method set_screenMatchMode, addr 0x6be0ba0, size 0x8, virtual false, abstract: false, final false
inline void set_screenMatchMode(::UnityEngine::UIElements::PanelScreenMatchMode  value) ;

/// @brief Method set_sortingOrder, addr 0x6be0bc0, size 0x1c, virtual false, abstract: false, final false
inline void set_sortingOrder(float_t  value) ;

/// @brief Method set_targetDisplay, addr 0x6be0c20, size 0x34, virtual false, abstract: false, final false
inline void set_targetDisplay(int32_t  value) ;

/// @brief Method set_targetTexture, addr 0x6be0a70, size 0x34, virtual false, abstract: false, final false
inline void set_targetTexture(::UnityEngine::RenderTexture*  value) ;

/// @brief Method set_themeStyleSheet, addr 0x6be0914, size 0x10, virtual false, abstract: false, final false
inline void set_themeStyleSheet(::UnityEngine::UIElements::ThemeStyleSheet*  value) ;

/// @brief Method set_vertexBudget, addr 0x6be0d24, size 0x8, virtual false, abstract: false, final false
inline void set_vertexBudget(uint32_t  value) ;

/// @brief Method set_worldSpaceLayer, addr 0x6be0ae0, size 0x8, virtual false, abstract: false, final false
