...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7284), inst: 1665 }), TypeDefinitionIndex(TypeDefinitionIndex(7284))}
...
public:
  ...
  /// @brief Method get_isHandledByDraggable addr 0x2ce6ec4 size 0x8 virtual false final false
  inline bool get_isHandledByDraggable();

  /// @brief Method set_isHandledByDraggable addr 0x2ce6ecc size 0xc virtual false final false
  inline void set_isHandledByDraggable(bool value);

  /// @brief Method Init addr 0x2ce6ed8 size 0x50 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2ce6f28 size 0x10c virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerMoveEvent* New_ctor();

  /// @brief Method .ctor addr 0x2ce7034 size 0x50 virtual false final false
  inline void _ctor();

  /// @brief Method PostDispatch addr 0x2ce7084 size 0x608 virtual true final false
