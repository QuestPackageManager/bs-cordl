...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IFocusRing*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IFocusRing*, "UnityEngine.UIElements", "IFocusRing");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IFocusRing", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFocusRing(IFocusRingconst&) = delete;
