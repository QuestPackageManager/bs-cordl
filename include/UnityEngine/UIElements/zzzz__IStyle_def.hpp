...
// Declarations
 ...
 __declspec(property(get=get_transitionTimingFunction, put=set_transitionTimingFunction)) ::UnityEngine::UIElements::StyleList_1<::UnityEngine::UIElements::EasingFunction>  transitionTimingFunction;
 ...
 __declspec(property(get=get_unityEditorTextRenderingMode, put=set_unityEditorTextRenderingMode)) ::UnityEngine::UIElements::StyleEnum_1<::UnityEngine::UIElements::EditorTextRenderingMode>  unityEditorTextRenderingMode;
 ...
 __declspec(property(get=get_unityTextOverflowPosition, put=set_unityTextOverflowPosition)) ::UnityEngine::UIElements::StyleEnum_1<::UnityEngine::UIElements::TextOverflowPosition>  unityTextOverflowPosition;
