...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Foldout*);
MARK_REF_T(::UnityEngine::UIElements::Foldout_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Foldout_UxmlTraits*);
...
static_assert(sizeof(::UnityEngine::UIElements::Foldout_UxmlTraits) == 0xa0, "Size mismatch!");
