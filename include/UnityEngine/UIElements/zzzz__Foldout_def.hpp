...
public:
  ...
  /// @brief Method .ctor, addr 0x6be9590, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be95f8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be974c, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Apply, addr 0x6be8ab4, size 0xc4, virtual false, abstract: false, final false
  inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op);

  /// @brief Method Apply, addr 0x6be8a50, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAttachToPanel, addr 0x6be8f9c, size 0x1e0, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnViewDataReady, addr 0x6be8a1c, size 0x34, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method SetValueWithoutNotify, addr 0x6be88d8, size 0x144, virtual true, abstract: false, final true
  ...
  /// @brief Method <.ctor>b__39_0, addr 0x6be953c, size 0x54, virtual false, abstract: false, final false
  inline void __ctor_b__39_0(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method .ctor, addr 0x6be8b78, size 0x424, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_contentContainer, addr 0x6be83cc, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_focusable, addr 0x6be83d4, size 0x8, virtual true, abstract: false, final false
  inline bool get_focusable();

  /// @brief Method get_text, addr 0x6be84e0, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_toggle, addr 0x6be83c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Toggle* get_toggle();

  /// @brief Method get_toggleOnLabelClick, addr 0x6be841c, size 0x18, virtual false, abstract: false, final false
  inline bool get_toggleOnLabelClick();

  /// @brief Method get_value, addr 0x6be86d4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_focusable, addr 0x6be83dc, size 0x40, virtual true, abstract: false, final false
  inline void set_focusable(bool value);

  /// @brief Method set_text, addr 0x6be850c, size 0x1c8, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method set_toggleOnLabelClick, addr 0x6be8434, size 0xac, virtual false, abstract: false, final false
  inline void set_toggleOnLabelClick(bool value);

  /// @brief Method set_value, addr 0x6be86dc, size 0x1fc, virtual true, abstract: false, final true
