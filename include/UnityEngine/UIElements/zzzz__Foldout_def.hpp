...
public:
  ...
  /// @brief Method Init, addr 0x2e4f4d0, size 0x130, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__Foldout__UxmlTraits* New_ctor();

  /// @brief Method .ctor, addr 0x2e4f600, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_contentContainer, addr 0x2e4ed78, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method set_text, addr 0x2e48830, size 0x124, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method get_value, addr 0x2e4ed80, size 0x8, virtual true, abstract: false, final true
  inline bool get_value();

  /// @brief Method set_value, addr 0x2e4ed88, size 0x1e0, virtual true, abstract: false, final true
  inline void set_value(bool value);

  /// @brief Method SetValueWithoutNotify, addr 0x2e4ef68, size 0x120, virtual true, abstract: false, final true
  inline void SetValueWithoutNotify(bool newValue);

  /// @brief Method OnViewDataReady, addr 0x2e4f088, size 0x40, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  static inline ::UnityEngine::UIElements::Foldout* New_ctor();

  /// @brief Method .ctor, addr 0x2e48500, size 0x330, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method OnAttachToPanel, addr 0x2e4f0d0, size 0x1c0, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method <.ctor>b__23_0, addr 0x2e4f438, size 0x50, virtual false, abstract: false, final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6256)), TypeDefinitionIndex(TypeDefinitionIndex(6345)), TypeDefinitionIndex(TypeDefinitionIndex(6346)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6256), inst: 5240 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6344)) CS Name: ::Foldout::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e4f488, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
