...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DefaultGroupManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DefaultGroupManager*, "UnityEngine.UIElements", "DefaultGroupManager");
...
public:
  ...
  /// @brief Method Init, addr 0x6db17fc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OnOptionSelectionChanged, addr 0x6db1804, size 0x198, virtual true, abstract: false, final true
  inline void OnOptionSelectionChanged(::UnityEngine::UIElements::IGroupBoxOption* selectedOption);

  /// @brief Method RegisterOption, addr 0x6db199c, size 0x164, virtual true, abstract: false, final true
  inline void RegisterOption(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnregisterOption, addr 0x6db1b00, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6db102c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::DefaultGroupManager) == 0x28, "Size mismatch!");
