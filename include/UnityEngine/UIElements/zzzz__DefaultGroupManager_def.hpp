...
public:
  ...
  /// @brief Method Init, addr 0x4a3d6a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OnOptionSelectionChanged, addr 0x4a3d6b0, size 0x1d0, virtual true, abstract: false, final true
  inline void OnOptionSelectionChanged(::UnityEngine::UIElements::IGroupBoxOption* selectedOption);

  /// @brief Method RegisterOption, addr 0x4a3d880, size 0x14c, virtual true, abstract: false, final true
  inline void RegisterOption(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnregisterOption, addr 0x4a3d9cc, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4a3cf14, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
