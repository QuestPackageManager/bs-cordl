...
public:
  ...
  /// @brief Method Init, addr 0x6c58844, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method OnOptionSelectionChanged, addr 0x6c5884c, size 0x198, virtual true, abstract: false, final true
  inline void OnOptionSelectionChanged(::UnityEngine::UIElements::IGroupBoxOption* selectedOption);

  /// @brief Method RegisterOption, addr 0x6c589e4, size 0x164, virtual true, abstract: false, final true
  inline void RegisterOption(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnregisterOption, addr 0x6c58b48, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6c58074, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
