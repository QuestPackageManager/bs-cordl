...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a2c900, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::FocusInEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a2c8f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a2c7e8, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x4a2c83c, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::FocusInEvent* New_ctor();

  /// @brief Method .ctor, addr 0x4a2c848, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
