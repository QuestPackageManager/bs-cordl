...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7401), inst: 3232 }), TypeDefinitionIndex(TypeDefinitionIndex(7401)), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(7401), inst: 3269 }), TypeDefinitionIndex(TypeDefinitionIndex(7442)), TypeDefinitionIndex(TypeDefinitionIndex(7444)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(7401), inst: 3295 }), TypeDefinitionIndex(TypeDefinitionIndex(7446)), TypeDefinitionIndex(TypeDefinitionIndex(7443)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(7401), inst: 3244 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7401), inst: 3307 }), TypeDefinitionIndex(TypeDefinitionIndex(7445)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7401), inst: 3296 }), TypeDefinitionIndex(TypeDefinitionIndex(7447))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7382)) CS
...
public:
  ...
  /// @brief Method get_customPropertiesCount addr 0x2cebbe8 size 0x58 virtual false final false
  inline int32_t get_customPropertiesCount();

  /// @brief Method get_hasTransition addr 0x2cebc40 size 0x20 virtual false final false
  inline bool get_hasTransition();

  /// @brief Method FinalizeApply addr 0x2cebc60 size 0x100 virtual false final false
  inline void FinalizeApply(ByRef<::UnityEngine::UIElements::ComputedStyle> parentStyle);

  /// @brief Method SyncWithLayout addr 0x2cebdb0 size 0x3e4 virtual false final false
  inline void SyncWithLayout(::UnityEngine::Yoga::YogaNode* targetNode);

  /// @brief Method ApplyGlobalKeyword addr 0x2cecc34 size 0xa0 virtual false final false
  ...
  /// @brief Method ApplyGlobalKeyword addr 0x2cecd3c size 0x24 virtual false final false
  ...
  /// @brief Method RemoveCustomStyleProperty addr 0x2cee438 size 0xac virtual false final false
  inline void RemoveCustomStyleProperty(::UnityEngine::UIElements::StyleSheets::StylePropertyReader* reader);

  /// @brief Method ApplyCustomStyleProperty addr 0x2cee4e4 size 0xf0 virtual false final false
  inline void ApplyCustomStyleProperty(::UnityEngine::UIElements::StyleSheets::StylePropertyReader* reader);

  /// @brief Method ApplyAllPropertyInitial addr 0x2cee5d4 size 0x60 virtual false final false
  inline void ApplyAllPropertyInitial();

  /// @brief Method ResetComputedTransitions addr 0x2cee774 size 0x8 virtual false final false
  inline void ResetComputedTransitions();

  /// @brief Method CompareChanges addr 0x2cee77c size 0x2e8 virtual false final false
  ...
  /// @brief Method StartAnimationInlineTranslate addr 0x2ceed80 size 0x218 virtual false final false
  ...
  /// @brief Method get_alignContent addr 0x2cecaa4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Align get_alignContent();

  /// @brief Method get_alignItems addr 0x2cecaf4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Align get_alignItems();

  /// @brief Method get_alignSelf addr 0x2cec8c4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Align get_alignSelf();

  /// @brief Method get_backgroundColor addr 0x2ceef98 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_backgroundColor();

  /// @brief Method get_backgroundImage addr 0x2ceefec size 0x60 virtual false final false
  inline ::UnityEngine::UIElements::Background get_backgroundImage();

  /// @brief Method get_borderBottomColor addr 0x2cef04c size 0x54 virtual false final false
  inline ::UnityEngine::Color get_borderBottomColor();

  /// @brief Method get_borderBottomLeftRadius addr 0x2ceea64 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_borderBottomLeftRadius();

  /// @brief Method get_borderBottomRightRadius addr 0x2ceeab4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_borderBottomRightRadius();

  /// @brief Method get_borderBottomWidth addr 0x2cec734 size 0x50 virtual false final false
  inline float_t get_borderBottomWidth();

  /// @brief Method get_borderLeftColor addr 0x2cef0a0 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_borderLeftColor();

  /// @brief Method get_borderLeftWidth addr 0x2cec644 size 0x50 virtual false final false
  inline float_t get_borderLeftWidth();

  /// @brief Method get_borderRightColor addr 0x2cef0f4 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_borderRightColor();

  /// @brief Method get_borderRightWidth addr 0x2cec6e4 size 0x50 virtual false final false
  inline float_t get_borderRightWidth();

  /// @brief Method get_borderTopColor addr 0x2cef148 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_borderTopColor();

  /// @brief Method get_borderTopLeftRadius addr 0x2ceeb04 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_borderTopLeftRadius();

  /// @brief Method get_borderTopRightRadius addr 0x2ceeb54 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_borderTopRightRadius();

  /// @brief Method get_borderTopWidth addr 0x2cec694 size 0x50 virtual false final false
  inline float_t get_borderTopWidth();

  /// @brief Method get_bottom addr 0x2cec374 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_bottom();

  /// @brief Method get_color addr 0x2cef19c size 0x54 virtual false final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_cursor addr 0x2cef1f0 size 0x68 virtual false final false
  inline ::UnityEngine::UIElements::Cursor get_cursor();

  /// @brief Method get_display addr 0x2cecbe4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::DisplayStyle get_display();

  /// @brief Method get_flexBasis addr 0x2cec234 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_flexBasis();

  /// @brief Method get_flexDirection addr 0x2ceca54 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::FlexDirection get_flexDirection();

  /// @brief Method get_flexGrow addr 0x2cec194 size 0x50 virtual false final false
  inline float_t get_flexGrow();

  /// @brief Method get_flexShrink addr 0x2cec1e4 size 0x50 virtual false final false
  inline float_t get_flexShrink();

  /// @brief Method get_flexWrap addr 0x2cecb94 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Wrap get_flexWrap();

  /// @brief Method get_fontSize addr 0x2cebd60 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_fontSize();

  /// @brief Method get_height addr 0x2cec7d4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_height();

  /// @brief Method get_justifyContent addr 0x2cecb44 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Justify get_justifyContent();

  /// @brief Method get_left addr 0x2cec284 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_left();

  /// @brief Method get_letterSpacing addr 0x2cef258 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_letterSpacing();

  /// @brief Method get_marginBottom addr 0x2cec4b4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_marginBottom();

  /// @brief Method get_marginLeft addr 0x2cec3c4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_marginLeft();

  /// @brief Method get_marginRight addr 0x2cec464 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_marginRight();

  /// @brief Method get_marginTop addr 0x2cec414 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_marginTop();

  /// @brief Method get_maxHeight addr 0x2cec964 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_maxHeight();

  /// @brief Method get_maxWidth addr 0x2cec914 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_maxWidth();

  /// @brief Method get_minHeight addr 0x2ceca04 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_minHeight();

  /// @brief Method get_minWidth addr 0x2cec9b4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_minWidth();

  /// @brief Method get_opacity addr 0x2ceeba4 size 0x50 virtual false final false
  inline float_t get_opacity();

  /// @brief Method get_overflow addr 0x2cec874 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::OverflowInternal get_overflow();

  /// @brief Method get_paddingBottom addr 0x2cec5f4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_paddingBottom();

  /// @brief Method get_paddingLeft addr 0x2cec504 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_paddingLeft();

  /// @brief Method get_paddingRight addr 0x2cec5a4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_paddingRight();

  /// @brief Method get_paddingTop addr 0x2cec554 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_paddingTop();

  /// @brief Method get_position addr 0x2cec824 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Position get_position();

  /// @brief Method get_right addr 0x2cec324 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_right();

  /// @brief Method get_rotate addr 0x2ceed18 size 0x68 virtual false final false
  inline ::UnityEngine::UIElements::Rotate get_rotate();

  /// @brief Method get_scale addr 0x2ceecc4 size 0x54 virtual false final false
  inline ::UnityEngine::UIElements::Scale get_scale();

  /// @brief Method get_textOverflow addr 0x2cef2a8 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::TextOverflow get_textOverflow();

  /// @brief Method get_textShadow addr 0x2cef2f8 size 0x68 virtual false final false
  inline ::UnityEngine::UIElements::TextShadow get_textShadow();

  /// @brief Method get_top addr 0x2cec2d4 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_top();

  /// @brief Method get_transformOrigin addr 0x2ceebf4 size 0x68 virtual false final false
  inline ::UnityEngine::UIElements::TransformOrigin get_transformOrigin();

  /// @brief Method get_transitionDelay addr 0x2cef360 size 0x50 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>* get_transitionDelay();

  /// @brief Method get_transitionDuration addr 0x2cef3b0 size 0x50 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>* get_transitionDuration();

  /// @brief Method get_transitionProperty addr 0x2cef400 size 0x50 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StylePropertyName>* get_transitionProperty();

  /// @brief Method get_transitionTimingFunction addr 0x2cef450 size 0x50 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::EasingFunction>* get_transitionTimingFunction();

  /// @brief Method get_translate addr 0x2ceec5c size 0x68 virtual false final false
  inline ::UnityEngine::UIElements::Translate get_translate();

  /// @brief Method get_unityBackgroundImageTintColor addr 0x2cef4a0 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_unityBackgroundImageTintColor();

  /// @brief Method get_unityBackgroundScaleMode addr 0x2cef4f4 size 0x50 virtual false final false
  inline ::UnityEngine::ScaleMode get_unityBackgroundScaleMode();

  /// @brief Method get_unityFont addr 0x2cef544 size 0x50 virtual false final false
  inline ::UnityEngine::Font* get_unityFont();

  /// @brief Method get_unityFontDefinition addr 0x2cef594 size 0x54 virtual false final false
  inline ::UnityEngine::UIElements::FontDefinition get_unityFontDefinition();

  /// @brief Method get_unityFontStyleAndWeight addr 0x2cef5e8 size 0x50 virtual false final false
  inline ::UnityEngine::FontStyle get_unityFontStyleAndWeight();

  /// @brief Method get_unityOverflowClipBox addr 0x2cef638 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::OverflowClipBox get_unityOverflowClipBox();

  /// @brief Method get_unityParagraphSpacing addr 0x2cef688 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_unityParagraphSpacing();

  /// @brief Method get_unitySliceBottom addr 0x2cef6d8 size 0x50 virtual false final false
  inline int32_t get_unitySliceBottom();

  /// @brief Method get_unitySliceLeft addr 0x2cef728 size 0x50 virtual false final false
  inline int32_t get_unitySliceLeft();

  /// @brief Method get_unitySliceRight addr 0x2cef778 size 0x50 virtual false final false
  inline int32_t get_unitySliceRight();

  /// @brief Method get_unitySliceTop addr 0x2cef7c8 size 0x50 virtual false final false
  inline int32_t get_unitySliceTop();

  /// @brief Method get_unityTextAlign addr 0x2cef818 size 0x50 virtual false final false
  inline ::UnityEngine::TextAnchor get_unityTextAlign();

  /// @brief Method get_unityTextOutlineColor addr 0x2cef868 size 0x54 virtual false final false
  inline ::UnityEngine::Color get_unityTextOutlineColor();

  /// @brief Method get_unityTextOutlineWidth addr 0x2cef8bc size 0x50 virtual false final false
  inline float_t get_unityTextOutlineWidth();

  /// @brief Method get_unityTextOverflowPosition addr 0x2cef90c size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::TextOverflowPosition get_unityTextOverflowPosition();

  /// @brief Method get_visibility addr 0x2cef95c size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Visibility get_visibility();

  /// @brief Method get_whiteSpace addr 0x2cef9ac size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::WhiteSpace get_whiteSpace();

  /// @brief Method get_width addr 0x2cec784 size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_width();

  /// @brief Method get_wordSpacing addr 0x2cef9fc size 0x50 virtual false final false
  inline ::UnityEngine::UIElements::Length get_wordSpacing();

  /// @brief Method Create addr 0x2cefa4c size 0x170 virtual false final false
  static inline ::UnityEngine::UIElements::ComputedStyle Create(ByRef<::UnityEngine::UIElements::ComputedStyle> parentStyle);

  /// @brief Method CreateInitial addr 0x2cefbbc size 0x138 virtual false final false
  static inline ::UnityEngine::UIElements::ComputedStyle CreateInitial();

  /// @brief Method Acquire addr 0x2cefcf4 size 0x118 virtual false final false
  inline ::UnityEngine::UIElements::ComputedStyle Acquire();

  /// @brief Method Release addr 0x2cefe0c size 0x100 virtual false final false
  inline void Release();

  /// @brief Method CopyFrom addr 0x2cee634 size 0x140 virtual false final false
  inline void CopyFrom(ByRef<::UnityEngine::UIElements::ComputedStyle> other);

  /// @brief Method ApplyProperties addr 0x2ceff0c size 0x11e4 virtual false final false
  ...
  /// @brief Method ApplyStyleValue addr 0x2cf10f0 size 0xb84 virtual false final false
  ...
  /// @brief Method ApplyStyleValueManaged addr 0x2cf1c74 size 0x3a8 virtual false final false
  ...
  /// @brief Method ApplyStyleCursor addr 0x2cf201c size 0x68 virtual false final false
  inline void ApplyStyleCursor(::UnityEngine::UIElements::Cursor cursor);

  /// @brief Method ApplyStyleTextShadow addr 0x2cf2084 size 0x70 virtual false final false
  inline void ApplyStyleTextShadow(::UnityEngine::UIElements::TextShadow st);

  /// @brief Method ApplyFromComputedStyle addr 0x2cf20f4 size 0xec0 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf2fb4 size 0x720 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf36d4 size 0x2d0 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf39a4 size 0x514 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf3eb8 size 0x294 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf414c size 0x140 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf428c size 0x13c virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf43c8 size 0x148 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf4510 size 0x150 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf4660 size 0x148 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf47a8 size 0x148 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf48f0 size 0x140 virtual false final false
  ...
  /// @brief Method ApplyPropertyAnimation addr 0x2cf4a30 size 0x148 virtual false final false
  ...
  /// @brief Method StartAnimation addr 0x2cf4b78 size 0x4444 virtual false final false
  ...
  /// @brief Method StartAnimationAllProperty addr 0x2cf8fbc size 0x3a6c virtual false final false
  ...
  /// @brief Method StartAnimationInline addr 0x2cfca28 size 0x36f8 virtual false final false
  ...
  /// @brief Method ApplyStyleTransformOrigin addr 0x2d00120 size 0x68 virtual false final false
  inline void ApplyStyleTransformOrigin(::UnityEngine::UIElements::TransformOrigin st);

  /// @brief Method ApplyStyleTranslate addr 0x2d00188 size 0x68 virtual false final false
  inline void ApplyStyleTranslate(::UnityEngine::UIElements::Translate translateValue);

  /// @brief Method ApplyStyleRotate addr 0x2d001f0 size 0x68 virtual false final false
  inline void ApplyStyleRotate(::UnityEngine::UIElements::Rotate rotateValue);

  /// @brief Method ApplyStyleScale addr 0x2d00258 size 0x60 virtual false final false
  inline void ApplyStyleScale(::UnityEngine::UIElements::Scale scaleValue);

  /// @brief Method ApplyInitialValue addr 0x2ceccd4 size 0x3c virtual false final false
  inline void ApplyInitialValue(::UnityEngine::UIElements::StyleSheets::StylePropertyReader* reader);

  /// @brief Method ApplyInitialValue addr 0x2cecd60 size 0x16d8 virtual false final false
  inline void ApplyInitialValue(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method ApplyUnsetValue addr 0x2cecd10 size 0x2c virtual false final false
  ...
  /// @brief Method ApplyUnsetValue addr 0x2d002b8 size 0x26c virtual false final false
