...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::IVisualElementScheduledItem* (::UnityEngine::UIElements::IVisualElementScheduler::*)(::System::Action_1<::UnityEngine::UIElements::TimerState>*)>(&::UnityEngine::UIElements::IVisualElementScheduler::Execute)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::IVisualElementScheduledItem* (::UnityEngine::UIElements::IVisualElementScheduler::*)(::System::Action*)>(&::UnityEngine::UIElements::IVisualElementScheduler::Execute)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
