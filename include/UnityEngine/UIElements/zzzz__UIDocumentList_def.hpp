...
public:
  ...
  /// @brief Method RemoveFromListAndFromVisualTree addr 0x2e14f44 size 0x78 virtual false final false
  inline void RemoveFromListAndFromVisualTree(::UnityEngine::UIElements::UIDocument* uiDocument);

  /// @brief Method AddToListAndToVisualTree addr 0x2e14fc4 size 0x354 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2e15318 size 0x7c virtual false final false
  inline void _ctor();
