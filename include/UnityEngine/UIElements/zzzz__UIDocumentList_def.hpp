...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UIDocumentList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UIDocumentList(UIDocumentList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UIDocumentList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UIDocumentList(UIDocumentListconst&) = delete;
