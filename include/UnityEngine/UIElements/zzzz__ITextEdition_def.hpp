...
public:
  ...
  /// @brief Method get_GetDefaultValueType, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method set_GetDefaultValueType, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method set_placeholder, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void set_placeholder(::StringW value);

  // Ctor Parameters [CppParam { name: "", ty: "ITextEdition", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ITextEdition(ITextEditionconst&) = delete;
