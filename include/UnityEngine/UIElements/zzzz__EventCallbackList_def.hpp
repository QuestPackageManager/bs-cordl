...
/// @brief Field EmptyArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_EmptyArray, put=setStaticF_EmptyArray)) ::ArrayW<::UnityEngine::UIElements::EventCallbackFunctorBase*,::Array<::UnityEngine::UIElements::EventCallbackFunctorBase*>*>  EmptyArray;
...
/// @brief Field m_Array, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Array, put=__cordl_internal_set_m_Array)) ::ArrayW<::UnityEngine::UIElements::EventCallbackFunctorBase*,::Array<::UnityEngine::UIElements::EventCallbackFunctorBase*>*>  m_Array;
...
/// @brief Method Add, addr 0x6bcdd7c, size 0xf0, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::EventCallbackFunctorBase*  item) ;

/// @brief Method AddRange, addr 0x6bcd9e0, size 0xcc, virtual false, abstract: false, final false
inline void AddRange(::UnityEngine::UIElements::EventCallbackList*  list) ;

/// @brief Method Clear, addr 0x6bcdb2c, size 0x28, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Find, addr 0x6bcdbc8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x6bcdc78, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bcd97c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6bcd900, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_Span, addr 0x6bcde6c, size 0xec, virtual false, abstract: false, final false
