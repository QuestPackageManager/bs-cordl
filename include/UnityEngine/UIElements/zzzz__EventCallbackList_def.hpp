...
public:
  ...
  /// @brief Method Add, addr 0x6c3ffc4, size 0xf0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::EventCallbackFunctorBase* item);

  /// @brief Method AddRange, addr 0x6c3fc28, size 0xcc, virtual false, abstract: false, final false
  inline void AddRange(::UnityEngine::UIElements::EventCallbackList* list);

  /// @brief Method Clear, addr 0x6c3fd74, size 0x28, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method Find, addr 0x6c3fe10, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x6c3fec0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c3fbc4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c3fb48, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Span, addr 0x6c400b4, size 0xec, virtual false, abstract: false, final false
