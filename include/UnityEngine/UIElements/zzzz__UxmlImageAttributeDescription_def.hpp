...
public:
  ...
  /// @brief Method GetValueFromBag, addr 0x6b66e6c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b66ddc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_defaultValue, addr 0x6b66e5c, size 0x10, virtual false, abstract: false, final false
