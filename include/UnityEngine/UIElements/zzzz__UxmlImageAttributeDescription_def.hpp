...
/// @brief Field <defaultValue>k__BackingField, offset 0x48, size 0x20 
 __declspec(property(get=__cordl_internal_get__defaultValue_k__BackingField, put=__cordl_internal_set__defaultValue_k__BackingField)) ::UnityEngine::UIElements::Background  _defaultValue_k__BackingField;
...
/// @brief Method GetValueFromBag, addr 0x6af4c24, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6af4b94, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_defaultValue, addr 0x6af4c14, size 0x10, virtual false, abstract: false, final false
