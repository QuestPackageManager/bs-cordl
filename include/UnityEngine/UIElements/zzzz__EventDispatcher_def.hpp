...
public:
  ...
  /// @brief Method <.cctor>b__35_0, addr 0x6c3cce4, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>* __cctor_b__35_0();

  /// @brief Method .ctor, addr 0x6c3cce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CloseGate, addr 0x6c3ba28, size 0x14, virtual false, abstract: false, final false
  inline void CloseGate();

  /// @brief Method CreateDefault, addr 0x6c3bcdc, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::EventDispatcher* CreateDefault();

  /// @brief Method Dispatch, addr 0x6c3be94, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleRecursiveState, addr 0x6c3c33c, size 0x490, virtual false, abstract: false, final false
  ...
  /// @brief Method OpenGate, addr 0x6c3ba50, size 0x194, virtual false, abstract: false, final false
  inline void OpenGate();

  /// @brief Method ProcessEvent, addr 0x6c3c0bc, size 0x280, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::BaseVisualElementPanel* panel);

  /// @brief Method ProcessEventQueue, addr 0x6c3c7cc, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c3bd30, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_dispatchImmediately, addr 0x6c3be6c, size 0x20, virtual false, abstract: false, final false
  inline bool get_dispatchImmediately();

  /// @brief Method get_pointerState, addr 0x6c3bcd4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_processingEvents, addr 0x6c3be8c, size 0x8, virtual false, abstract: false, final false
