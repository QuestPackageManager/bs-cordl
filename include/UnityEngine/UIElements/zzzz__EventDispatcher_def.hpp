...
public:
  ...
  /// @brief Method <.cctor>b__31_0, addr 0x4a241f4, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>* __cctor_b__31_0();

  /// @brief Method .ctor, addr 0x4a241ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyDispatchingStrategies, addr 0x4a235e0, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseGate, addr 0x4a22768, size 0x10, virtual false, abstract: false, final false
  inline void CloseGate();

  /// @brief Method CreateForRuntime, addr 0x4a228c0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0x4a22af4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method OpenGate, addr 0x4a22790, size 0x88, virtual false, abstract: false, final false
  inline void OpenGate();

  /// @brief Method ProcessEvent, addr 0x4a22cf4, size 0x520, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method ProcessEventQueue, addr 0x4a23214, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a22918, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dispatchImmediately, addr 0x4a22ac8, size 0x20, virtual false, abstract: false, final false
  inline bool get_dispatchImmediately();

  /// @brief Method get_pointerState, addr 0x4a228b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_processingEvents, addr 0x4a22ae8, size 0xc, virtual false, abstract: false, final false
