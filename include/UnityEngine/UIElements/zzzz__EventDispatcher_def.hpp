...
public:
  ...
  /// @brief Method ApplyDispatchingStrategies, addr 0x35570e0, size 0x330, virtual false, abstract: false, final false
  ...
  /// @brief Method CloseGate, addr 0x3556454, size 0x10, virtual false, abstract: false, final false
  inline void CloseGate();

  /// @brief Method CreateForRuntime, addr 0x35565ac, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispatch, addr 0x35567e4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method OpenGate, addr 0x355647c, size 0x88, virtual false, abstract: false, final false
  inline void OpenGate();

  /// @brief Method ProcessEvent, addr 0x3556948, size 0x3d0, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::UIElements::EventBase* evt, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method ProcessEventQueue, addr 0x3556d18, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355660c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dispatchImmediately, addr 0x35567b8, size 0x20, virtual false, abstract: false, final false
  inline bool get_dispatchImmediately();

  /// @brief Method get_pointerState, addr 0x35565a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_processingEvents, addr 0x35567d8, size 0xc, virtual false, abstract: false, final false
