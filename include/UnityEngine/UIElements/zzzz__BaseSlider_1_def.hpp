...
/// @brief Field <clampedDragger>k__BackingField, offset 0x578, size 0x8 
 __declspec(property(get=__cordl_internal_get__clampedDragger_k__BackingField, put=__cordl_internal_set__clampedDragger_k__BackingField)) ::UnityEngine::UIElements::ClampedDragger_1<TValueType>*  _clampedDragger_k__BackingField;
...
/// @brief Field <dragBorderElement>k__BackingField, offset 0x540, size 0x8 
 __declspec(property(get=__cordl_internal_get__dragBorderElement_k__BackingField, put=__cordl_internal_set__dragBorderElement_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _dragBorderElement_k__BackingField;

/// @brief Field <dragContainer>k__BackingField, offset 0x528, size 0x8 
 __declspec(property(get=__cordl_internal_get__dragContainer_k__BackingField, put=__cordl_internal_set__dragContainer_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _dragContainer_k__BackingField;
...
/// @brief Field <fillElement>k__BackingField, offset 0x550, size 0x8 
 __declspec(property(get=__cordl_internal_get__fillElement_k__BackingField, put=__cordl_internal_set__fillElement_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _fillElement_k__BackingField;

/// @brief Field <inputTextField>k__BackingField, offset 0x548, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputTextField_k__BackingField, put=__cordl_internal_set__inputTextField_k__BackingField)) ::UnityEngine::UIElements::TextField*  _inputTextField_k__BackingField;

/// @brief Field <trackElement>k__BackingField, offset 0x538, size 0x8 
 __declspec(property(get=__cordl_internal_get__trackElement_k__BackingField, put=__cordl_internal_set__trackElement_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _trackElement_k__BackingField;
