...
public:
// Declarations
/// @brief Method NamesPathMatchesElementNamesPath, addr 0x6af2080, size 0x328, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_ElementName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_NamesPath", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "m_AttributeName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_Value", ty: "::StringW", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "m_ElementId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_ElementIdsPath", ty: "::System::Collections::Generic::List_1<int32_t>*", modifiers: "", def_value: None }, CppParam { name: "m_SerializedData", ty: "::UnityEngine::UIElements::UxmlSerializedData*", modifiers: "", def_value: None }]
...
/// @brief Field m_AttributeOverrides, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AttributeOverrides, put=__cordl_internal_set_m_AttributeOverrides)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>*  m_AttributeOverrides;

/// @brief Field m_SerializedDataOverride, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SerializedDataOverride, put=__cordl_internal_set_m_SerializedDataOverride)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_UxmlSerializedDataOverride>*  m_SerializedDataOverride;

/// @brief Field m_SlotUsages, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SlotUsages, put=__cordl_internal_set_m_SlotUsages)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualTreeAsset_SlotUsageEntry>*  m_SlotUsages;
...
/// @brief Method Instantiate, addr 0x6af0940, size 0x794, virtual true, abstract: false, final false
...
/// @brief Method get_attributeOverrides, addr 0x6af0930, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>* get_attributeOverrides() ;

/// @brief Method get_serializedDataOverrides, addr 0x6af0938, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_slotUsages, addr 0x6af2078, size 0x8, virtual false, abstract: false, final false
