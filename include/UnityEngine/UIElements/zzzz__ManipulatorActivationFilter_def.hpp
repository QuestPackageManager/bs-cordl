...
public:
  ...
  /// @brief Method Equals, addr 0x6c5d268, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c5d304, size 0x34, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::ManipulatorActivationFilter other);

  /// @brief Method GetHashCode, addr 0x6c5d338, size 0x2c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HasModifiers, addr 0x6c5d4b8, size 0x1f8, virtual false, abstract: false, final false
  inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method MatchModifiers, addr 0x6c5d6b0, size 0x54, virtual false, abstract: false, final false
  inline bool MatchModifiers(bool alt, bool ctrl, bool shift, bool command);

  /// @brief Method Matches, addr 0x6c5d364, size 0x154, virtual false, abstract: false, final false
  inline bool Matches(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method get_button, addr 0x6c5d240, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MouseButton get_button();

  /// @brief Method get_clickCount, addr 0x6c5d260, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_clickCount();

  /// @brief Method get_modifiers, addr 0x6c5d250, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_button, addr 0x6c5d248, size 0x8, virtual false, abstract: false, final false
  inline void set_button(::UnityEngine::UIElements::MouseButton value);

  /// @brief Method set_modifiers, addr 0x6c5d258, size 0x8, virtual false, abstract: false, final false
