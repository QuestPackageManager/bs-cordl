...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6439)), TypeDefinitionIndex(TypeDefinitionIndex(8909)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6439), inst: 1683
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6433)) CS Name: ::UnityEngine.UIElements::TooltipEvent*
...
public:
  ...
  /// @brief Method set_tooltip, addr 0x2e683d0, size 0x8, virtual false, abstract: false, final false
  inline void set_tooltip(::StringW value);

  /// @brief Method set_rect, addr 0x2e683d8, size 0xc, virtual false, abstract: false, final false
  inline void set_rect(::UnityEngine::Rect value);

  /// @brief Method Init, addr 0x2e683e4, size 0x90, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2e68474, size 0x5c, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::TooltipEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2e684ec, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();
