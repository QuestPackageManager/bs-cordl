...
public:
  ...
  /// @brief Method GetPointerType, addr 0x6c4a550, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW GetPointerType(int32_t pointerId);

  /// @brief Method IsDirectManipulationDevice, addr 0x6c4a648, size 0x90, virtual false, abstract: false, final false
