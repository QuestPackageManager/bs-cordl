...
public:
  ...
  /// @brief Method Equals, addr 0x360b8b0, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x360b824, size 0x8c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleTransformOrigin other);

  /// @brief Method GetHashCode, addr 0x360b940, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x360b9d8, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x360b724, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x360b730, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::TransformOrigin v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method get_keyword, addr 0x360b71c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method get_value, addr 0x3609240, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Equality, addr 0x360b748, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x360943c, size 0xc, virtual false, abstract: false, final false
