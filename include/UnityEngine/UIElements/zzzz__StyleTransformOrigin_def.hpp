...
/// @brief Method Equals, addr 0x6b3d72c, size 0xdc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6b3d6ac, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleTransformOrigin  other) ;

/// @brief Method GetHashCode, addr 0x6b3d808, size 0x24, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x6b3d82c, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6b3d600, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6b3d5c8, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TransformOrigin  v) ;

/// @brief Method .ctor, addr 0x6b3d5e8, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TransformOrigin  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x6b3d5b8, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x6b3d514, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x6b3d60c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x6b3d68c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x6b3d698, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_keyword, addr 0x6b3d5c0, size 0x8, virtual true, abstract: false, final true
inline void set_keyword(::UnityEngine::UIElements::StyleKeyword  value) ;

/// @brief Method set_value, addr 0x6b3d5a4, size 0x14, virtual true, abstract: false, final true
