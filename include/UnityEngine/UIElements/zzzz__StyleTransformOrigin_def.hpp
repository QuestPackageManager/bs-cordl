...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::StyleTransformOrigin, "UnityEngine.UIElements", "StyleTransformOrigin");
// Dependencies UnityEngine.UIElements.StyleKeyword, UnityEngine.UIElements.TransformOrigin
namespace UnityEngine::UIElements {
// Is value type: true
...
public:
  ...
  __declspec(property(get = get_value, put = set_value)) ::UnityEngine::UIElements::TransformOrigin value;
  ...
  /// @brief Method Equals, addr 0x6c915e4, size 0xdc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c91564, size 0x80, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleTransformOrigin other);

  /// @brief Method GetHashCode, addr 0x6c916c0, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6c916e4, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6c914b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6c91480, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::TransformOrigin v);

  /// @brief Method .ctor, addr 0x6c914a0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::TransformOrigin v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method get_keyword, addr 0x6c91470, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method get_value, addr 0x6c913cc, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Equality, addr 0x6c914c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6c91544, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6c91550, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_keyword, addr 0x6c91478, size 0x8, virtual true, abstract: false, final true
  inline void set_keyword(::UnityEngine::UIElements::StyleKeyword value);

  /// @brief Method set_value, addr 0x6c9145c, size 0x14, virtual true, abstract: false, final true
...
static_assert(sizeof(::UnityEngine::UIElements::StyleTransformOrigin) == 0x18, "Size mismatch!");
