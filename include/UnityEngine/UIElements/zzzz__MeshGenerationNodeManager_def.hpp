...
public:
  ...
  /// @brief Method CreateImpl, addr 0x6c7d12c, size 0x19c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MeshGenerationNodeImpl* CreateImpl(::UnityEngine::UIElements::UIR::Entry* parentEntry, bool safe);

  /// @brief Method CreateNode, addr 0x6c7c420, size 0x28, virtual false, abstract: false, final false
  inline void CreateNode(::UnityEngine::UIElements::UIR::Entry* parentEntry, ::ByRef<::UnityEngine::UIElements::MeshGenerationNode> node);

  /// @brief Method CreateUnsafeNode, addr 0x6c7c490, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6c7d360, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6c7d3c8, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetAll, addr 0x6c7d2c8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c7d0a4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::UIR::EntryRecorder* entryRecorder);

  /// @brief Method get_disposed, addr 0x6c7d350, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6c7d358, size 0x8, virtual false, abstract: false, final false
