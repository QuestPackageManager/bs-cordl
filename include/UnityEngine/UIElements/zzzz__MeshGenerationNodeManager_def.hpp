...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MeshGenerationNodeManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MeshGenerationNodeManager(MeshGenerationNodeManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MeshGenerationNodeManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MeshGenerationNodeManager(MeshGenerationNodeManagerconst&) = delete;
