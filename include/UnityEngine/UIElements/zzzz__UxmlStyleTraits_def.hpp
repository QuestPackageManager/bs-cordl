...
public:
  ...
  /// @brief Method .ctor, addr 0x6cbb650, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlStyleTraits) == 0x30, "Size mismatch!");
