...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Matrix4x4 (*)(float_t, float_t, float_t, float_t, float_t, float_t)>(&::UnityEngine::UIElements::ProjectionUtils::Ortho)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x6bf1874;
