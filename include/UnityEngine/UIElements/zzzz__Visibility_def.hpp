...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Visibility, "UnityEngine.UIElements", "Visibility");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::Visibility) == 0x4, "Size mismatch!");
