...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6491)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6491), inst: 1942 })]
...
public:
  // Declarations
  /// @brief Method PreDispatch, addr 0x2e6d408, size 0x7c, virtual true, abstract: false, final false
  inline void PreDispatch(::UnityEngine::UIElements::IPanel* panel);

  static inline ::UnityEngine::UIElements::BlurEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2e6d484, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
