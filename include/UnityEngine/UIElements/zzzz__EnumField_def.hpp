...
public:
  ...
  /// @brief Method .ctor, addr 0x4994e44, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4994e8c, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499509c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.ctor>b__22_0, addr 0x499518c, size 0x5c, virtual false, abstract: false, final false
  inline void __ctor_b__22_0(::UnityEngine::UIElements::MouseDownEvent* e);

  /// @brief Method .ctor, addr 0x4995184, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ChangeValueFromMenu, addr 0x4994b48, size 0x8c, virtual false, abstract: false, final false
  inline void ChangeValueFromMenu(::System::Object* menuItem);

  /// @brief Method ContainsPointer, addr 0x499446c, size 0x84, virtual false, abstract: false, final false
  inline bool ContainsPointer(int32_t pointerId);

  /// @brief Method Init, addr 0x4993cb8, size 0x8, virtual false, abstract: false, final false
  inline void Init(::System::Enum* defaultValue);

  /// @brief Method Init, addr 0x4994014, size 0x104, virtual false, abstract: false, final false
  inline void Init(::System::Enum* defaultValue, bool includeObsoleteValues);

  /// @brief Method Initialize, addr 0x4993b34, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method OnNavigationSubmit, addr 0x49944f0, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method OnPointerDownEvent, addr 0x4994388, size 0x58, virtual false, abstract: false, final false
  inline void OnPointerDownEvent(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMoveEvent, addr 0x49943e0, size 0x8c, virtual false, abstract: false, final false
  inline void OnPointerMoveEvent(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method PopulateDataFromType, addr 0x4994118, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x49942a8, size 0xe0, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::System::Enum* newValue);

  /// @brief Method ShowMenu, addr 0x4994514, size 0x34c, virtual false, abstract: false, final false
  inline void ShowMenu();

  /// @brief Method UpdateMixedValueContent, addr 0x4994bd4, size 0x134, virtual true, abstract: false, final false
  inline void UpdateMixedValueContent();

  /// @brief Method UpdateValueLabel, addr 0x49941bc, size 0xec, virtual false, abstract: false, final false
  inline void UpdateValueLabel(::System::Enum* value);

  /// @brief Method <ShowMenu>b__33_0, addr 0x4994e40, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4993cc0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4993ccc, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method get_includeObsoleteValues, addr 0x4993b2c, size 0x8, virtual false, abstract: false, final false
