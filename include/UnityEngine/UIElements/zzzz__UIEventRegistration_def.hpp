...
/// @brief Method <.cctor>b__1_0, addr 0x6aedb14, size 0x50, virtual false, abstract: false, final false
inline void __cctor_b__1_0() ;

/// @brief Method <.cctor>b__1_1, addr 0x6aedb64, size 0x50, virtual false, abstract: false, final false
inline void __cctor_b__1_1() ;

/// @brief Method <.cctor>b__1_2, addr 0x6aedbb4, size 0x68, virtual false, abstract: false, final false
inline bool __cctor_b__1_2(int32_t  i, ::System::IntPtr  ptr) ;

/// @brief Method <.cctor>b__1_3, addr 0x6aedc1c, size 0x50, virtual false, abstract: false, final false
inline void __cctor_b__1_3() ;

/// @brief Method <.cctor>b__1_4, addr 0x6aedc6c, size 0x58, virtual false, abstract: false, final false
inline bool __cctor_b__1_4(::System::Exception*  exception) ;

/// @brief Method <.cctor>b__1_5, addr 0x6aedcc4, size 0x50, virtual false, abstract: false, final false
inline void __cctor_b__1_5() ;

/// @brief Method .ctor, addr 0x6aedb10, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CleanupRoots, addr 0x6aed77c, size 0x1a0, virtual false, abstract: false, final false
static inline void CleanupRoots() ;

/// @brief Method EndContainerGUIFromException, addr 0x6aed3b0, size 0x1f8, virtual false, abstract: false, final false
static inline bool EndContainerGUIFromException(::System::Exception*  exception) ;

/// @brief Method MakeCurrentIMGUIContainerDirty, addr 0x6aed91c, size 0x1a0, virtual false, abstract: false, final false
static inline void MakeCurrentIMGUIContainerDirty() ;

/// @brief Method ProcessEvent, addr 0x6aed5a8, size 0x1d4, virtual false, abstract: false, final false
static inline bool ProcessEvent(int32_t  instanceID, ::System::IntPtr  nativeEventPtr) ;

/// @brief Method RegisterUIElementSystem, addr 0x6aecfe8, size 0x8c, virtual false, abstract: false, final false
static inline void RegisterUIElementSystem(::UnityEngine::UIElements::IUIElementsUtility*  utility) ;

/// @brief Method ReleaseCapture, addr 0x6aed210, size 0x1a0, virtual false, abstract: false, final false
static inline void ReleaseCapture() ;

/// @brief Method TakeCapture, addr 0x6aed074, size 0x19c, virtual false, abstract: false, final false
