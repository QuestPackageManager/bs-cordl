...
public:
  ...
  /// @brief Method .ctor, addr 0x4a10b88, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a10bd0, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a10d04, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RadioButtonValueChangedCallback, addr 0x4a1061c, size 0xf8, virtual false, abstract: false, final false
  inline void RadioButtonValueChangedCallback(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method SetValueWithoutNotify, addr 0x4a10714, size 0x60, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(int32_t newValue);

  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x4a10774, size 0x200, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x4a10974, size 0x174, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBox_OnOptionRemoved(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UpdateRadioButtons, addr 0x4a101d8, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a103d4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4a103e0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_contentContainer, addr 0x4a103c4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method set_choices, addr 0x4a0fb30, size 0x6a8, virtual false, abstract: false, final false
