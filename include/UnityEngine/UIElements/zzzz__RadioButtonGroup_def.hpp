...
// TypeDefinitionIndex(TypeDefinitionIndex(6988))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7134)) CS Name: ::RadioButtonGroup::UxmlTraits*
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7135)), TypeDefinitionIndex(TypeDefinitionIndex(7134)),
