...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WorldSpaceDataStore", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WorldSpaceDataStore(WorldSpaceDataStore&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WorldSpaceDataStore", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WorldSpaceDataStore(WorldSpaceDataStoreconst&) = delete;
