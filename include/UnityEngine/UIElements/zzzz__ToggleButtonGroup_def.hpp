...
public:
  ...
  /// @brief Method .ctor, addr 0x6c219a8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c21a10, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c21b88, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnButtonGroupContainerElementAdded, addr 0x6c209b0, size 0x340, virtual false, abstract: false, final false
  inline void OnButtonGroupContainerElementAdded(::UnityEngine::UIElements::VisualElement* ve, int32_t index);

  /// @brief Method OnButtonGroupContainerElementRemoved, addr 0x6c20e8c, size 0x37c, virtual false, abstract: false, final false
  inline void OnButtonGroupContainerElementRemoved(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method OnOptionChange, addr 0x6c21208, size 0x300, virtual false, abstract: false, final false
  inline void OnOptionChange(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method OnViewDataReady, addr 0x6c20384, size 0x78, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method SetValueWithoutNotify, addr 0x6c207cc, size 0x1e4, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::UIElements::ToggleButtonGroupState newValue);

  /// @brief Method UpdateButtonStates, addr 0x6c203fc, size 0x238, virtual false, abstract: false, final false
  inline void UpdateButtonStates(::UnityEngine::UIElements::ToggleButtonGroupState options);

  /// @brief Method UpdateButtonsStyling, addr 0x6c20cf0, size 0x19c, virtual false, abstract: false, final false
  inline void UpdateButtonsStyling();

  /// @brief Method UpdateMixedValueContent, addr 0x6c20634, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1fee8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c1fef8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW label);

  /// @brief Method .ctor, addr 0x6c20050, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allowEmptySelection, addr 0x6c1fcf8, size 0x8, virtual false, abstract: false, final false
  inline bool get_allowEmptySelection();

  /// @brief Method get_contentContainer, addr 0x6c20374, size 0x10, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_isMultipleSelection, addr 0x6c1f890, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_allowEmptySelection, addr 0x6c1fd00, size 0x1e8, virtual false, abstract: false, final false
  inline void set_allowEmptySelection(bool value);

  /// @brief Method set_isMultipleSelection, addr 0x6c1f898, size 0x1e8, virtual false, abstract: false, final false
