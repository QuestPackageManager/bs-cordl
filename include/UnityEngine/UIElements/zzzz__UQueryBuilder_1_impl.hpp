...
inline ::UnityEngine::UIElements::UQueryBuilder_1<T2> UnityEngine::UIElements::UQueryBuilder_1<T>::OfType(::StringW name, /* [ParamArray] */ ::ArrayW<::StringW> classes) {
...
template <typename T> inline void UnityEngine::UIElements::UQueryBuilder_1<T>::AddClasses(/* [ParamArray] */ ::ArrayW<::StringW> classes) {
  static auto* ___internal_method =
...
// Ctor Parameters [CppParam { name: "m_StyleSelectors", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSelector*>*", modifiers: "", def_value: Some("{}"), comment: None
// }, CppParam { name: "m_Parts", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSelectorPart>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "m_Element", ty: "::UnityEngine::UIElements::VisualElement*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Matchers", ty:
// "::System::Collections::Generic::List_1<::UnityEngine::UIElements::RuleMatcher>*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "m_Relationship", ty:
// "::UnityEngine::UIElements::StyleSelectorRelationship", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pseudoStatesMask", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "negatedPseudoStatesMask", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
template <typename T>
