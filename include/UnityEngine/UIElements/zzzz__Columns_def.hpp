...
public:
  ...
  /// @brief Method .ctor, addr 0x6c03ab8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UpdateVisibleColumns>b__87_0, addr 0x6c03b84, size 0x14, virtual false, abstract: false, final false
  inline bool _UpdateVisibleColumns_b__87_0(::UnityEngine::UIElements::Column* c);

  /// @brief Method .ctor, addr 0x6c03b80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x6c02308, size 0xc0, virtual true, abstract: false, final true
  inline void Add(::UnityEngine::UIElements::Column* item);

  /// @brief Method Clear, addr 0x6c02680, size 0x1a4, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x6c02aa0, size 0xb8, virtual true, abstract: false, final true
  inline bool Contains(::UnityEngine::UIElements::Column* item);

  /// @brief Method Contains, addr 0x6c02b58, size 0x2f4, virtual false, abstract: false, final false
  inline bool Contains(::StringW name);

  /// @brief Method CopyTo, addr 0x6c02e4c, size 0xc0, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::UnityEngine::UIElements::Column*, ::Array<::UnityEngine::UIElements::Column*>*> array, int32_t arrayIndex);

  /// @brief Method DirtyVisibleColumns, addr 0x6c031c8, size 0x7c, virtual false, abstract: false, final false
  inline void DirtyVisibleColumns();

  /// @brief Method GetEnumerator, addr 0x6bff0a8, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::Column*>* GetEnumerator();

  /// @brief Method IndexOf, addr 0x6bfb2dc, size 0xb8, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::Column* column);

  /// @brief Method InitOrderColumns, addr 0x6c01850, size 0x80, virtual false, abstract: false, final false
  inline void InitOrderColumns();

  /// @brief Method Insert, addr 0x6c023c8, size 0x2b8, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::Column* column);

  /// @brief Method IsPrimary, addr 0x6c022a0, size 0x64, virtual false, abstract: false, final false
  inline bool IsPrimary(::UnityEngine::UIElements::Column* column);

  static inline ::UnityEngine::UIElements::Columns* New_ctor();

  /// @brief Method NotifyChange, addr 0x6c0156c, size 0x1c, virtual false, abstract: false, final false
  inline void NotifyChange(::UnityEngine::UIElements::ColumnsDataType type);

  /// @brief Method NotifyPropertyChanged, addr 0x6c01588, size 0x4c, virtual false, abstract: false, final false
  inline void NotifyPropertyChanged(::ByRef<::UnityEngine::UIElements::BindingId> property);

  /// @brief Method OnColumnChanged, addr 0x6c03170, size 0x58, virtual false, abstract: false, final false
  inline void OnColumnChanged(::UnityEngine::UIElements::Column* column, ::UnityEngine::UIElements::ColumnDataType type);

  /// @brief Method OnColumnResized, addr 0x6c03244, size 0x1c, virtual false, abstract: false, final false
  inline void OnColumnResized(::UnityEngine::UIElements::Column* column);

  /// @brief Method OnColumnsPropertyChanged, addr 0x6c02f0c, size 0x264, virtual false, abstract: false, final false
  inline void OnColumnsPropertyChanged(::System::Object* sender, ::UnityEngine::UIElements::BindablePropertyChangedEventArgs args);

  /// @brief Method Remove, addr 0x6c02824, size 0x27c, virtual true, abstract: false, final true
  inline bool Remove(::UnityEngine::UIElements::Column* column);

  /// @brief Method ReorderDisplay, addr 0x6c035fc, size 0x110, virtual false, abstract: false, final false
  inline void ReorderDisplay(int32_t from, int32_t to);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6c02304, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method UpdateVisibleColumns, addr 0x6c018d0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0370c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_changed, addr 0x6c01b0c, size 0xc0, virtual false, abstract: false, final false
  inline void add_changed(::System::Action_1<::UnityEngine::UIElements::ColumnsDataType>* value);

  /// @brief Method add_columnAdded, addr 0x6bfd6b8, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnAdded(::System::Action_2<::UnityEngine::UIElements::Column*, int32_t>* value);

  /// @brief Method add_columnChanged, addr 0x6c01ee0, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnChanged(::System::Action_2<::UnityEngine::UIElements::Column*, ::UnityEngine::UIElements::ColumnDataType>* value);

  /// @brief Method add_columnRemoved, addr 0x6bfd778, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnRemoved(::System::Action_1<::UnityEngine::UIElements::Column*>* value);

  /// @brief Method add_columnReordered, addr 0x6bfd838, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnReordered(::System::Action_3<::UnityEngine::UIElements::Column*, int32_t, int32_t>* value);

  /// @brief Method add_columnResized, addr 0x6c02060, size 0xc0, virtual false, abstract: false, final false
  inline void add_columnResized(::System::Action_1<::UnityEngine::UIElements::Column*>* value);

  /// @brief Method add_propertyChanged, addr 0x6c01318, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_Count, addr 0x6bfd614, size 0xa4, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x6c03260, size 0xa8, virtual true, abstract: false, final true
  inline bool get_IsReadOnly();

  /// @brief Method get_Item, addr 0x6bfd46c, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Column* get_Item(int32_t index);

  /// @brief Method get_Item, addr 0x6c03308, size 0x2f4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Column* get_Item(::StringW name);

  /// @brief Method get_displayList, addr 0x6bfb464, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::Column*>* get_displayList();

  /// @brief Method get_primaryColumnName, addr 0x6c01498, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_primaryColumnName();

  /// @brief Method get_reorderable, addr 0x6c015d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_reorderable();

  /// @brief Method get_resizable, addr 0x6c016a8, size 0x8, virtual false, abstract: false, final false
  inline bool get_resizable();

  /// @brief Method get_resizePreview, addr 0x6c0177c, size 0x8, virtual false, abstract: false, final false
  inline bool get_resizePreview();

  /// @brief Method get_stretchMode, addr 0x6c01c8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Columns_StretchMode get_stretchMode();

  /// @brief Method get_visibleList, addr 0x6bfb54c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_changed, addr 0x6c01bcc, size 0xc0, virtual false, abstract: false, final false
  inline void remove_changed(::System::Action_1<::UnityEngine::UIElements::ColumnsDataType>* value);

  /// @brief Method remove_columnAdded, addr 0x6c01d60, size 0xc0, virtual false, abstract: false, final false
  inline void remove_columnAdded(::System::Action_2<::UnityEngine::UIElements::Column*, int32_t>* value);

  /// @brief Method remove_columnChanged, addr 0x6c01fa0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_columnRemoved, addr 0x6c01e20, size 0xc0, virtual false, abstract: false, final false
  inline void remove_columnRemoved(::System::Action_1<::UnityEngine::UIElements::Column*>* value);

  /// @brief Method remove_columnReordered, addr 0x6c021e0, size 0xc0, virtual false, abstract: false, final false
  inline void remove_columnReordered(::System::Action_3<::UnityEngine::UIElements::Column*, int32_t, int32_t>* value);

  /// @brief Method remove_columnResized, addr 0x6c02120, size 0xc0, virtual false, abstract: false, final false
  inline void remove_columnResized(::System::Action_1<::UnityEngine::UIElements::Column*>* value);

  /// @brief Method remove_propertyChanged, addr 0x6c013d8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method set_primaryColumnName, addr 0x6c014a0, size 0xcc, virtual false, abstract: false, final false
  inline void set_primaryColumnName(::StringW value);

  /// @brief Method set_reorderable, addr 0x6c015dc, size 0xcc, virtual false, abstract: false, final false
  inline void set_reorderable(bool value);

  /// @brief Method set_resizable, addr 0x6c016b0, size 0xcc, virtual false, abstract: false, final false
  inline void set_resizable(bool value);

  /// @brief Method set_resizePreview, addr 0x6c01784, size 0xcc, virtual false, abstract: false, final false
  inline void set_resizePreview(bool value);

  /// @brief Method set_stretchMode, addr 0x6c01c94, size 0xcc, virtual false, abstract: false, final false
