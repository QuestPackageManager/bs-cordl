...
public:
  ...
  /// @brief Method .ctor, addr 0x6b42a70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_properties, addr 0x6b42a68, size 0x8, virtual false, abstract: false, final false
