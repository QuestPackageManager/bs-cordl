...
public:
  ...
  /// @brief Method .ctor, addr 0x2fd287c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_properties, addr 0x2fd2874, size 0x8, virtual false, abstract: false, final false
