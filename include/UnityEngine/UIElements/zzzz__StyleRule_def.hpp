...
public:
  ...
  /// @brief Method .ctor, addr 0x35ea8cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_properties, addr 0x35ea8c4, size 0x8, virtual false, abstract: false, final false
