...
public:
  ...
  /// @brief Method .ctor, addr 0x4a90d5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_properties, addr 0x4a90d54, size 0x8, virtual false, abstract: false, final false
