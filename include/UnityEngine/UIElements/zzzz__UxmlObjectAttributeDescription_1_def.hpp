...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::UxmlObjectAttributeDescription_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UxmlObjectAttributeDescription_1, "UnityEngine.UIElements", "UxmlObjectAttributeDescription`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlObjectAttributeDescription_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlObjectAttributeDescription_1(UxmlObjectAttributeDescription_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlObjectAttributeDescription_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlObjectAttributeDescription_1(UxmlObjectAttributeDescription_1const&) = delete;
