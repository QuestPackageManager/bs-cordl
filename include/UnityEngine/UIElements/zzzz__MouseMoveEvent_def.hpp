...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7301)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7301), inst: 4552 })}
...
public:
  // Declarations
  /// @brief Method Init addr 0x2ce8f04 size 0x54 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2ce8f58 size 0xc virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseMoveEvent* New_ctor();

  /// @brief Method .ctor addr 0x2ce8f64 size 0x54 virtual false final false
  inline void _ctor();

  /// @brief Method GetPooled addr 0x2ce7694 size 0x48 virtual false final false
