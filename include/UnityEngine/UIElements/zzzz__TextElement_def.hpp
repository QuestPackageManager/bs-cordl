...
public:
  ...
  /// @brief Method .ctor, addr 0x6cb219c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6cb2204, size 0x3e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cb25e4, size 0x250, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildContextualMenu, addr 0x6cad7bc, size 0x3a0, virtual false, abstract: false, final false
  inline void BuildContextualMenu(::UnityEngine::UIElements::ContextualMenuPopulateEvent* evt);

  /// @brief Method Copy, addr 0x6cad724, size 0x4c, virtual false, abstract: false, final false
  inline void Copy(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method CopyActionStatus, addr 0x6cadc90, size 0x134, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DropdownMenuAction_Status CopyActionStatus(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method Cut, addr 0x6cad6d8, size 0x4c, virtual false, abstract: false, final false
  inline void Cut(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method CutActionStatus, addr 0x6cadb5c, size 0x134, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DropdownMenuAction_Status CutActionStatus(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method DoMeasure, addr 0x6cac6f8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method DrawCaret, addr 0x6cab298, size 0x3cc, virtual false, abstract: false, final false
  inline void DrawCaret(Il2CppObject* mgc);

  /// @brief Method DrawHighlighting, addr 0x6cab664, size 0xa84, virtual false, abstract: false, final false
  inline void DrawHighlighting(Il2CppObject* mgc);

  /// @brief Method DrawNativeHighlighting, addr 0x6caae3c, size 0x45c, virtual false, abstract: false, final false
  inline void DrawNativeHighlighting(Il2CppObject* mgc);

  /// @brief Method ElideText, addr 0x6cac194, size 0x510, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultValueType, addr 0x6caa564, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method MeasureTextSize, addr 0x6cac6a4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDetachFromPanel, addr 0x6caa6d8, size 0x30, virtual false, abstract: false, final false
  inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* detachEvent);

  /// @brief Method OnGenerateTextOver, addr 0x6ca8fa8, size 0x218, virtual false, abstract: false, final false
  inline void OnGenerateTextOver(Il2CppObject* mgc);

  /// @brief Method OnGenerateVisualContent, addr 0x6caab50, size 0x2ec, virtual false, abstract: false, final false
  inline void OnGenerateVisualContent(Il2CppObject* mgc);

  /// @brief Method OnGeometryChanged, addr 0x6caa5b8, size 0x4, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* e);

  /// @brief Method Paste, addr 0x6cad770, size 0x4c, virtual false, abstract: false, final false
  inline void Paste(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method PasteActionStatus, addr 0x6caddc4, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DropdownMenuAction_Status PasteActionStatus(::UnityEngine::UIElements::DropdownMenuAction* a);

  /// @brief Method ProcessMenuCommand, addr 0x6cad564, size 0x174, virtual false, abstract: false, final false
  inline void ProcessMenuCommand(::StringW command);

  /// @brief Method SetRenderedText, addr 0x6cacd74, size 0x8, virtual false, abstract: false, final false
  inline void SetRenderedText(::StringW value);

  /// @brief Method ShouldElide, addr 0x6cac0e8, size 0x40, virtual false, abstract: false, final false
  inline bool ShouldElide();

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.SetValueWithoutNotify, addr 0x6cacbcc, size 0x1a8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_INotifyValueChanged_System_String__SetValueWithoutNotify(::StringW newValue);

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.get_value, addr 0x6cac75c, size 0x20, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_UIElements_INotifyValueChanged_System_String__get_value();

  /// @brief Method UnityEngine.UIElements.INotifyValueChanged<System.String>.set_value, addr 0x6cac77c, size 0x30c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_INotifyValueChanged_System_String__set_value(::StringW value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.CullString, addr 0x6cae8d0, size 0xec, virtual true, abstract: false, final true
  inline ::StringW UnityEngine_UIElements_ITextEdition_CullString(::StringW s);

  /// @brief Method UnityEngine.UIElements.ITextEdition.RestoreValueAndText, addr 0x6cae5e0, size 0x14, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_RestoreValueAndText();

  /// @brief Method UnityEngine.UIElements.ITextEdition.SaveValueAndText, addr 0x6cae5bc, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.ITextEdition.get_autoCorrection, addr 0x6caef24, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextEdition_get_autoCorrection();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_hideMobileInput, addr 0x6cad060, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.ITextEdition.get_isPassword, addr 0x6caed00, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextEdition_get_isPassword();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_isReadOnly, addr 0x6cad2dc, size 0x1c, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextEdition_get_isReadOnly();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_keyboardType, addr 0x6cace6c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::TouchScreenKeyboardType UnityEngine_UIElements_ITextEdition_get_keyboardType();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_maskChar, addr 0x6cae9bc, size 0x8, virtual true, abstract: false, final true
  inline char16_t UnityEngine_UIElements_ITextEdition_get_maskChar();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_maxLength, addr 0x6cae164, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_ITextEdition_get_maxLength();

  /// @brief Method UnityEngine.UIElements.ITextEdition.get_multiline, addr 0x6cacd8c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.ITextEdition.set_autoCorrection, addr 0x6caef2c, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_autoCorrection(bool value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_hideMobileInput, addr 0x6cad0c8, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.ITextEdition.set_isPassword, addr 0x6caed08, size 0xb4, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_isPassword(bool value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_isReadOnly, addr 0x6cad2f8, size 0x114, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_isReadOnly(bool value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_keyboardType, addr 0x6cace74, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_keyboardType(::UnityEngine::TouchScreenKeyboardType value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_maskChar, addr 0x6cae9c4, size 0x12c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_maskChar(char16_t value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_maxLength, addr 0x6cae16c, size 0x13c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_maxLength(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_multiline, addr 0x6cacd94, size 0xd8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_multiline(bool value);

  /// @brief Method UnityEngine.UIElements.ITextEdition.set_placeholder, addr 0x6cae408, size 0x1a4, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextEdition_set_placeholder(::StringW value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.HasSelection, addr 0x6cafd4c, size 0xe0, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_HasSelection();

  /// @brief Method UnityEngine.UIElements.ITextSelection.SelectAll, addr 0x6cafbb4, size 0xcc, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_SelectAll();

  /// @brief Method UnityEngine.UIElements.ITextSelection.SelectNone, addr 0x6cafc80, size 0xcc, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_SelectNone();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_cursorColor, addr 0x6cb0b0c, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_ITextSelection_get_cursorColor();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_cursorIndex, addr 0x6caf364, size 0xd0, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_ITextSelection_get_cursorIndex();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_cursorPosition, addr 0x6cb05fc, size 0xfc, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 UnityEngine_UIElements_ITextSelection_get_cursorPosition();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_cursorWidth, addr 0x6cb0db0, size 0x8, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_ITextSelection_get_cursorWidth();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_doubleClickSelectsWord, addr 0x6cafe2c, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_get_doubleClickSelectsWord();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_isSelectable, addr 0x6caf120, size 0x20, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_get_isSelectable();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_lineHeightAtCursorPosition, addr 0x6cb079c, size 0xcc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_ITextSelection_get_lineHeightAtCursorPosition();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_selectAllOnFocus, addr 0x6cb0214, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_get_selectAllOnFocus();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_selectAllOnMouseUp, addr 0x6cb0408, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_get_selectAllOnMouseUp();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_selectIndex, addr 0x6caf78c, size 0xd0, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_ITextSelection_get_selectIndex();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_selectionColor, addr 0x6cb0868, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_ITextSelection_get_selectionColor();

  /// @brief Method UnityEngine.UIElements.ITextSelection.get_tripleClickSelectsLine, addr 0x6cb0020, size 0x8, virtual true, abstract: false, final true
  inline bool UnityEngine_UIElements_ITextSelection_get_tripleClickSelectsLine();

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_cursorColor, addr 0x6cb0b20, size 0x118, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_cursorColor(::UnityEngine::Color value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_cursorIndex, addr 0x6caf434, size 0x200, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_cursorIndex(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_doubleClickSelectsWord, addr 0x6cafe34, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_doubleClickSelectsWord(bool value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_isSelectable, addr 0x6caf140, size 0xd0, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_isSelectable(bool value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_selectAllOnFocus, addr 0x6cb021c, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_selectAllOnFocus(bool value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_selectAllOnMouseUp, addr 0x6cb0410, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_selectAllOnMouseUp(bool value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_selectIndex, addr 0x6caf85c, size 0x200, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_selectIndex(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_selectionColor, addr 0x6cb087c, size 0x118, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_selectionColor(::UnityEngine::Color value);

  /// @brief Method UnityEngine.UIElements.ITextSelection.set_tripleClickSelectsLine, addr 0x6cb0028, size 0x94, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITextSelection_set_tripleClickSelectsLine(bool value);

  /// @brief Method UpdateTooltip, addr 0x6cac128, size 0x6c, virtual false, abstract: false, final false
  inline void UpdateTooltip();

  /// @brief Method UpdateVisibleText, addr 0x6caa5bc, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6caa198, size 0x3cc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_autoCorrection, addr 0x6caefc0, size 0xa4, virtual false, abstract: false, final false
  inline bool get_autoCorrection();

  /// @brief Method get_cursorColor, addr 0x6cb0c38, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_cursorColor();

  /// @brief Method get_cursorIndex, addr 0x6caf634, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_cursorIndex();

  /// @brief Method get_cursorPosition, addr 0x6cb06f8, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_cursorPosition();

  /// @brief Method get_displayTooltipWhenElided, addr 0x6caaa80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_edition, addr 0x6ca43ec, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITextEdition* get_edition();

  /// @brief Method get_effectiveMaskChar, addr 0x6caec48, size 0xb8, virtual false, abstract: false, final false
  inline char16_t get_effectiveMaskChar();

  /// @brief Method get_emojiFallbackSupport, addr 0x6caa908, size 0x8, virtual false, abstract: false, final false
  inline bool get_emojiFallbackSupport();

  /// @brief Method get_enableRichText, addr 0x6caa84c, size 0x8, virtual false, abstract: false, final false
  inline bool get_enableRichText();

  /// @brief Method get_hasFocus, addr 0x6ca62e0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isPassword, addr 0x6caedbc, size 0xa4, virtual false, abstract: false, final false
  inline bool get_isPassword();

  /// @brief Method get_isReadOnly, addr 0x6cad40c, size 0xa4, virtual false, abstract: false, final false
  inline bool get_isReadOnly();

  /// @brief Method get_isSelectable, addr 0x6caf210, size 0xa0, virtual false, abstract: false, final false
  inline bool get_isSelectable();

  /// @brief Method get_keyboardType, addr 0x6cacf08, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::TouchScreenKeyboardType get_keyboardType();

  /// @brief Method get_maskChar, addr 0x6caeaf0, size 0xa4, virtual false, abstract: false, final false
  inline char16_t get_maskChar();

  /// @brief Method get_maxLength, addr 0x6cae2a8, size 0xa4, virtual false, abstract: false, final false
  inline int32_t get_maxLength();

  /// @brief Method get_originalText, addr 0x6caf118, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_originalText();

  /// @brief Method get_parseEscapeSequences, addr 0x6caa9c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_parseEscapeSequences();

  /// @brief Method get_renderedText, addr 0x6ca2268, size 0x190, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Text::RenderedText get_renderedText();

  /// @brief Method get_selectAllOnFocus, addr 0x6cb02b0, size 0xa4, virtual false, abstract: false, final false
  inline bool get_selectAllOnFocus();

  /// @brief Method get_selectAllOnMouseUp, addr 0x6cb04a4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_selection, addr 0x6ca7398, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITextSelection* get_selection();

  /// @brief Method get_selectionColor, addr 0x6cb0994, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectionColor();

  /// @brief Method get_showPlaceholderText, addr 0x6ca3a60, size 0x104, virtual false, abstract: false, final false
  inline bool get_showPlaceholderText();

  /// @brief Method get_text, addr 0x6caa708, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x6caca88, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method set_autoCorrection, addr 0x6caf064, size 0xb4, virtual false, abstract: false, final false
  inline void set_autoCorrection(bool value);

  /// @brief Method set_cursorColor, addr 0x6cb0cdc, size 0xd4, virtual false, abstract: false, final false
  inline void set_cursorColor(::UnityEngine::Color value);

  /// @brief Method set_cursorIndex, addr 0x6caf6d8, size 0xb4, virtual false, abstract: false, final false
  inline void set_cursorIndex(int32_t value);

  /// @brief Method set_displayTooltipWhenElided, addr 0x6caaa88, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_emojiFallbackSupport, addr 0x6caa910, size 0xb4, virtual false, abstract: false, final false
  inline void set_emojiFallbackSupport(bool value);

  /// @brief Method set_enableRichText, addr 0x6caa854, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isPassword, addr 0x6caee60, size 0xb4, virtual false, abstract: false, final false
  inline void set_isPassword(bool value);

  /// @brief Method set_isReadOnly, addr 0x6cad4b0, size 0xb4, virtual false, abstract: false, final false
  inline void set_isReadOnly(bool value);

  /// @brief Method set_isSelectable, addr 0x6caf2b0, size 0xb4, virtual false, abstract: false, final false
  inline void set_isSelectable(bool value);

  /// @brief Method set_keyboardType, addr 0x6cacfac, size 0xb4, virtual false, abstract: false, final false
  inline void set_keyboardType(::UnityEngine::TouchScreenKeyboardType value);

  /// @brief Method set_maskChar, addr 0x6caeb94, size 0xb4, virtual false, abstract: false, final false
  inline void set_maskChar(char16_t value);

  /// @brief Method set_maxLength, addr 0x6cae34c, size 0xb4, virtual false, abstract: false, final false
  inline void set_maxLength(int32_t value);

  /// @brief Method set_parseEscapeSequences, addr 0x6caa9cc, size 0xb4, virtual false, abstract: false, final false
  inline void set_parseEscapeSequences(bool value);

  /// @brief Method set_selectAllOnFocus, addr 0x6cb0354, size 0xb4, virtual false, abstract: false, final false
  inline void set_selectAllOnFocus(bool value);

  /// @brief Method set_selectAllOnMouseUp, addr 0x6cb0548, size 0xb4, virtual false, abstract: false, final false
  inline void set_selectAllOnMouseUp(bool value);

  /// @brief Method set_selectIndex, addr 0x6cafb00, size 0xb4, virtual false, abstract: false, final false
  inline void set_selectIndex(int32_t value);

  /// @brief Method set_selectionColor, addr 0x6cb0a38, size 0xd4, virtual false, abstract: false, final false
  inline void set_selectionColor(::UnityEngine::Color value);

  /// @brief Method set_text, addr 0x6caa7a0, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method set_value, addr 0x6cacb20, size 0xac, virtual false, abstract: false, final false
