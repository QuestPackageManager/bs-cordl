...
public:
  ...
  /// @brief Method .ctor, addr 0x6bee12c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6bee194, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AcceptCharacter, addr 0x6bee224, size 0xc8, virtual true, abstract: false, final false
  inline bool AcceptCharacter(char16_t c);

  static inline ::UnityEngine::UIElements::Hash128Field_Hash128Input* New_ctor();

  /// @brief Method Parse, addr 0x6bede34, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Hash128 Parse(::StringW str);

  /// @brief Method StringToValue, addr 0x6bee2ec, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Hash128 StringToValue(::StringW str);

  /// @brief Method .ctor, addr 0x6bed95c, size 0x184, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowedCharacters, addr 0x6bee1e0, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleEventBubbleUp, addr 0x6bede90, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x6bedd5c, size 0xc4, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::Hash128 newValue);

  /// @brief Method StringToValue, addr 0x6bede2c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Hash128 StringToValue(::StringW str);

  /// @brief Method UpdateTextFromValue, addr 0x6bedcdc, size 0x80, virtual true, abstract: false, final false
  inline void UpdateTextFromValue();

  /// @brief Method UpdateValueFromText, addr 0x6bedbec, size 0xf0, virtual true, abstract: false, final false
  inline void UpdateValueFromText();

  /// @brief Method ValueToString, addr 0x6bede20, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bed7cc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bed7d8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x6bedae0, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_value, addr 0x6bedb28, size 0xc4, virtual true, abstract: false, final false
