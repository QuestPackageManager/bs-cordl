...
/// @brief Method .ctor, addr 0x6befca4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6befd0c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AcceptCharacter, addr 0x6befd9c, size 0xc8, virtual true, abstract: false, final false
inline bool AcceptCharacter(char16_t  c) ;

static inline ::UnityEngine::UIElements::Hash128Field_Hash128Input* New_ctor() ;

/// @brief Method Parse, addr 0x6bef9ac, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Parse(::StringW  str) ;

/// @brief Method StringToValue, addr 0x6befe64, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x6bef4d4, size 0x184, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x6befd58, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method HandleEventBubbleUp, addr 0x6befa08, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method SetValueWithoutNotify, addr 0x6bef8d4, size 0xc4, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Hash128  newValue) ;

/// @brief Method StringToValue, addr 0x6bef9a4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x6bef854, size 0x80, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method UpdateValueFromText, addr 0x6bef764, size 0xf0, virtual true, abstract: false, final false
inline void UpdateValueFromText() ;

/// @brief Method ValueToString, addr 0x6bef998, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bef344, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6bef350, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x6bef658, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_value, addr 0x6bef6a0, size 0xc4, virtual true, abstract: false, final false
