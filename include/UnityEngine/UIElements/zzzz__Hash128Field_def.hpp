...
/// @brief Method .ctor, addr 0x6b7bee4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6b7bf4c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AcceptCharacter, addr 0x6b7bfdc, size 0xc8, virtual true, abstract: false, final false
inline bool AcceptCharacter(char16_t  c) ;

static inline ::UnityEngine::UIElements::Hash128Field_Hash128Input* New_ctor() ;

/// @brief Method Parse, addr 0x6b7bbec, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Parse(::StringW  str) ;

/// @brief Method StringToValue, addr 0x6b7c0a4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x6b7b714, size 0x184, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x6b7bf98, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method HandleEventBubbleUp, addr 0x6b7bc48, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method SetValueWithoutNotify, addr 0x6b7bb14, size 0xc4, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Hash128  newValue) ;

/// @brief Method StringToValue, addr 0x6b7bbe4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x6b7ba94, size 0x80, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method UpdateValueFromText, addr 0x6b7b9a4, size 0xf0, virtual true, abstract: false, final false
inline void UpdateValueFromText() ;

/// @brief Method ValueToString, addr 0x6b7bbd8, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b7b584, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6b7b590, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x6b7b898, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_value, addr 0x6b7b8e0, size 0xc4, virtual true, abstract: false, final false
