...
public:
  ...
  /// @brief Method Acquire, addr 0x6c7f700, size 0x190, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId Acquire(::UnityEngine::Texture* tex);

  /// @brief Method AllocAndAcquire, addr 0x6c7f17c, size 0x2f0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId AllocAndAcquire(::UnityEngine::Texture* texture, bool dynamic);

  /// @brief Method AllocAndAcquireDynamic, addr 0x6c7f170, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId AllocAndAcquireDynamic();

  /// @brief Method GetTexture, addr 0x6c7ef88, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6c7f890, size 0x2c4, virtual false, abstract: false, final false
  inline void Release(::UnityEngine::UIElements::TextureId id);

  /// @brief Method UpdateDynamic, addr 0x6c7f46c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c7fb54, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::TextureRegistry* getStaticF__instance_k__BackingField();

  /// @brief Method get_instance, addr 0x6c7ef2c, size 0x5c, virtual false, abstract: false, final false
