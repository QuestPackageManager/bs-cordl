...
/// @brief Method <.cctor>b__1_0, addr 0x6bd489c, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::WheelEvent* __cctor_b__1_0() ;

/// @brief Method .ctor, addr 0x6bd4898, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dispatch, addr 0x6bd47b8, size 0x8c, virtual true, abstract: false, final false
inline void Dispatch(::UnityEngine::UIElements::BaseVisualElementPanel*  panel) ;

/// @brief Method GetPooled, addr 0x6bd4550, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x6bd4630, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x6bd44d8, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::WheelEvent* GetPooled(::UnityEngine::Event*  systemEvent) ;

/// @brief Method Init, addr 0x6bd46ac, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x6bd4700, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bd4764, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_delta, addr 0x6bd44c0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_delta() ;

/// @brief Method set_delta, addr 0x6bd44cc, size 0xc, virtual false, abstract: false, final false
