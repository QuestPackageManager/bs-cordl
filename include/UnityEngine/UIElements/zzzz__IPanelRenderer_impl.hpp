...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::UnityEngine::UIElements::IPanelRenderer::*)()>(&::UnityEngine::UIElements::IPanelRenderer::get_forceGammaRendering)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::IPanelRenderer::*)(bool)>(&::UnityEngine::UIElements::IPanelRenderer::set_forceGammaRendering)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 1 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<uint32_t (::UnityEngine::UIElements::IPanelRenderer::*)()>(&::UnityEngine::UIElements::IPanelRenderer::get_vertexBudget)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 2 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::IPanelRenderer::*)(uint32_t)>(&::UnityEngine::UIElements::IPanelRenderer::set_vertexBudget)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 3 }));
    return ___internal_method;
  }
};
...
inline bool UnityEngine::UIElements::IPanelRenderer::get_forceGammaRendering() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 0 })));
  return ::cordl_internals::RunMethodRethrow<bool>(this, ___internal_method);
}
inline void UnityEngine::UIElements::IPanelRenderer::set_forceGammaRendering(bool value) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 1 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, value);
}
inline uint32_t UnityEngine::UIElements::IPanelRenderer::get_vertexBudget() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::IPanelRenderer*>(), 2 })));
