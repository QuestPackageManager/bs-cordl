...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::TrickleDown, "UnityEngine.UIElements", "TrickleDown");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::TrickleDown) == 0x4, "Size mismatch!");
