...
public:
  // Declarations
  /// @brief Method ToString, addr 0x6d0f0f8, size 0x16c, virtual true, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::StyleSheets::ScalableImage) == 0x10, "Size mismatch!");
