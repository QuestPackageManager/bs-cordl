...
public:
  // Declarations
  /// @brief Method Traverse addr 0x2de3d68 size 0x10 virtual true final false
  ...
  /// @brief Method Recurse addr 0x2de3d78 size 0xd0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2de3e48 size 0x8 virtual false final false
  inline void _ctor();
