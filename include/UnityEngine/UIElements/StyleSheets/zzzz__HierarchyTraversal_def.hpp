...
public:
  ...
  /// @brief Method Recurse, addr 0x3331edc, size 0xd0, virtual false, abstract: false, final false
  inline void Recurse(::UnityEngine::UIElements::VisualElement* element, int32_t depth);

  /// @brief Method Traverse, addr 0x3331ecc, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3331fac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
