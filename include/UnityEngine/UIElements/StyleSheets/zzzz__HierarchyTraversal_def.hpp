...
/// @brief Method Recurse, addr 0x6baccc4, size 0xc0, virtual false, abstract: false, final false
inline void Recurse(::UnityEngine::UIElements::VisualElement*  element, int32_t  depth) ;

/// @brief Method Traverse, addr 0x6baccb4, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bacd84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
