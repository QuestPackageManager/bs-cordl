...
public:
  ...
  /// @brief Method Recurse, addr 0x6bab14c, size 0xc0, virtual false, abstract: false, final false
  inline void Recurse(::UnityEngine::UIElements::VisualElement* element, int32_t depth);

  /// @brief Method Traverse, addr 0x6bab13c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bab20c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
