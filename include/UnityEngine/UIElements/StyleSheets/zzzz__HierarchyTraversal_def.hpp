...
public:
  // Declarations
  /// @brief Method Traverse, addr 0x2e02150, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Recurse, addr 0x2e02160, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e02230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
