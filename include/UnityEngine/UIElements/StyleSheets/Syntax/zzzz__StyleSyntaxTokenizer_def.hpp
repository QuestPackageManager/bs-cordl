...
public:
  ...
  /// @brief Method GlobCharacter, addr 0x35750e4, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t GlobCharacter(::StringW s, int32_t index, char16_t c);

  /// @brief Method IsNextCharacter, addr 0x3575120, size 0x44, virtual false, abstract: false, final false
  static inline bool IsNextCharacter(::StringW s, int32_t index, char16_t c);

  /// @brief Method IsNextLetterOrDash, addr 0x35751fc, size 0xc0, virtual false, abstract: false, final false
  static inline bool IsNextLetterOrDash(::StringW s, int32_t index);

  /// @brief Method IsNextNumber, addr 0x3575164, size 0x98, virtual false, abstract: false, final false
  static inline bool IsNextNumber(::StringW s, int32_t index);

  /// @brief Method MoveNext, addr 0x3574228, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method PeekNext, addr 0x357433c, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken PeekNext();

  /// @brief Method Tokenize, addr 0x35743ec, size 0xcf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35752bc, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_current, addr 0x357417c, size 0xac, virtual false, abstract: false, final false
