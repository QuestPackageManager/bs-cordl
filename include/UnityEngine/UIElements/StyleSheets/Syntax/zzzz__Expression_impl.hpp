...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::StyleSheets::Syntax::Expression::*)(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType)>(&::UnityEngine::UIElements::StyleSheets::Syntax::Expression::_ctor)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x6bc45ec;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType>::get()}
                    )));
...
constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*>& UnityEngine::UIElements::StyleSheets::Syntax::Expression::__cordl_internal_get_subExpressions()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___subExpressions;
}
constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*> const& UnityEngine::UIElements::StyleSheets::Syntax::Expression::__cordl_internal_get_subExpressions() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___subExpressions;
}
constexpr void UnityEngine::UIElements::StyleSheets::Syntax::Expression::__cordl_internal_set_subExpressions(::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
