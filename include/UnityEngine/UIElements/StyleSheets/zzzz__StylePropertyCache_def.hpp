...
/// @brief Method TryGetNonTerminalValue, addr 0x6b3f7a0, size 0x98, virtual false, abstract: false, final false
static inline bool TryGetNonTerminalValue(::StringW  name, ::ByRef<::StringW>  syntax) ;

/// @brief Method TryGetSyntax, addr 0x6b3f708, size 0x98, virtual false, abstract: false, final false
