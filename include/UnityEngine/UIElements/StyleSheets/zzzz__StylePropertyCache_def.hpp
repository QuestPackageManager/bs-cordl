...
public:
  ...
  /// @brief Method TryGetNonTerminalValue, addr 0x49d2350, size 0x90, virtual false, abstract: false, final false
  static inline bool TryGetNonTerminalValue(::StringW name, ::ByRef<::StringW> syntax);

  /// @brief Method TryGetSyntax, addr 0x49d22c0, size 0x90, virtual false, abstract: false, final false
