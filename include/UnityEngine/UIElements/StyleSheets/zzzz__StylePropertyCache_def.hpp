...
public:
  ...
  /// @brief Method TryGetNonTerminalValue, addr 0x49d56e0, size 0x90, virtual false, abstract: false, final false
  static inline bool TryGetNonTerminalValue(::StringW name, ::ByRef<::StringW> syntax);

  /// @brief Method TryGetSyntax, addr 0x49d5650, size 0x90, virtual false, abstract: false, final false
