...
public:
  ...
  /// @brief Method TryGetNonTerminalValue, addr 0x6bb19e8, size 0x98, virtual false, abstract: false, final false
  static inline bool TryGetNonTerminalValue(::StringW name, ::ByRef<::StringW> syntax);

  /// @brief Method TryGetSyntax, addr 0x6bb1950, size 0x98, virtual false, abstract: false, final false
