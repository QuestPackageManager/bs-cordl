...
public:
  ...
  /// @brief Method HexToColor32, addr 0x35687e8, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 HexToColor32(uint32_t color);

  /// @brief Method TryGetColor, addr 0x35658e0, size 0xf4, virtual false, abstract: false, final false
