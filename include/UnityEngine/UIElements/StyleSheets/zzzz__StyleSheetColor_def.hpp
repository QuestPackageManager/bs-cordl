...
public:
  ...
  /// @brief Method HexToColor32, addr 0x6d17e1c, size 0x14, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color32 HexToColor32(uint32_t color);

  /// @brief Method TryGetColor, addr 0x6d144bc, size 0xe8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StyleSheetColor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StyleSheetColor(StyleSheetColor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StyleSheetColor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StyleSheetColor(StyleSheetColorconst&) = delete;
