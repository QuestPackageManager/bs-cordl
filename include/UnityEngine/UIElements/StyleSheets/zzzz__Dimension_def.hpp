...
public:
  ...
  /// @brief Method Equals, addr 0x49d5da4, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x49d5d7c, size 0x28, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleSheets::Dimension other);

  /// @brief Method GetHashCode, addr 0x49d5e30, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToAngle, addr 0x49d5cc8, size 0x8c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Angle ToAngle();

  /// @brief Method ToLength, addr 0x49d0f4c, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length ToLength();

  /// @brief Method ToString, addr 0x49d5e78, size 0x134, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToTime, addr 0x49d5c98, size 0x30, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TimeValue ToTime();

  /// @brief Method .ctor, addr 0x49d5c8c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x49d5d54, size 0x28, virtual false, abstract: false, final false
