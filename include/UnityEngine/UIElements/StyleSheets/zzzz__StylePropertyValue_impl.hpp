...
// Ctor Parameters [CppParam { name: "sheet", ty: "::UnityW<::UnityEngine::UIElements::StyleSheet>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "handle", ty:
// "::UnityEngine::UIElements::StyleValueHandle", modifiers: "", def_value: Some("{}"), comment: None }]
