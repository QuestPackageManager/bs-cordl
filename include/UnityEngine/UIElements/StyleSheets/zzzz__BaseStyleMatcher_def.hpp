...
public:
  ...
  /// @brief Method DropContext, addr 0x6bc1654, size 0x54, virtual false, abstract: false, final false
  inline void DropContext();

  /// @brief Method Initialize, addr 0x6bc1500, size 0x5c, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method Match, addr 0x6bc16a8, size 0xbc, virtual false, abstract: false, final false
  inline bool Match(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchAndAnd, addr 0x6bc1d94, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchCombinator, addr 0x6bc19b8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchDataType, addr 0x6bc1a8c, size 0x168, virtual false, abstract: false, final false
  inline bool MatchDataType(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchExpression, addr 0x6bc176c, size 0x114, virtual false, abstract: false, final false
  inline bool MatchExpression(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchExpressionWithMultiplier, addr 0x6bc1880, size 0x138, virtual false, abstract: false, final false
  inline bool MatchExpressionWithMultiplier(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchGroup, addr 0x6bc1bf4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchJuxtaposition, addr 0x6bc1dc4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchMany, addr 0x6bc1e3c, size 0x19c, virtual false, abstract: false, final false
  inline int32_t MatchMany(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchManyByOrder, addr 0x6bc1fd8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchOr, addr 0x6bc1cb0, size 0xcc, virtual false, abstract: false, final false
  inline bool MatchOr(::UnityEngine::UIElements::StyleSheets::Syntax::Expression* exp);

  /// @brief Method MatchOrOr, addr 0x6bc1d7c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveNext, addr 0x6bc155c, size 0x44, virtual false, abstract: false, final false
  inline void MoveNext();

  static inline ::UnityEngine::UIElements::StyleSheets::BaseStyleMatcher* New_ctor();

  /// @brief Method RestoreContext, addr 0x6bc15f8, size 0x5c, virtual false, abstract: false, final false
  inline void RestoreContext();

  /// @brief Method SaveContext, addr 0x6bc15a0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bc218c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Text::RegularExpressions::Regex* getStaticF_s_CustomIdentRegex();

  /// @brief Method get_currentIndex, addr 0x6bc14e0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentIndex();

  /// @brief Method get_hasCurrent, addr 0x6bc14b8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_matchedVariableCount, addr 0x6bc14f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentIndex, addr 0x6bc14e8, size 0x8, virtual false, abstract: false, final false
  inline void set_currentIndex(int32_t value);

  /// @brief Method set_matchedVariableCount, addr 0x6bc14f8, size 0x8, virtual false, abstract: false, final false
