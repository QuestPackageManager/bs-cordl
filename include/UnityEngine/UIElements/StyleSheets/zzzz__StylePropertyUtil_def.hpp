...
public:
  ...
  /// @brief Method IsAnimatable addr 0x2c87d04 size 0x80 virtual false final false
  static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method TryGetEnumIntValue addr 0x2c87d84 size 0xd98 virtual false final false
  ...
  /// @brief Method IsMatchingShorthand addr 0x2c88b1c size 0x130 virtual false final false
