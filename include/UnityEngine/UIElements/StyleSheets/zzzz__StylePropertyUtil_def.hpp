...
public:
  ...
  /// @brief Method IsAnimatable, addr 0x6bb39f8, size 0x88, virtual false, abstract: false, final false
  static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method IsMatchingShorthand, addr 0x6bb3808, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetEnumIntValue, addr 0x6bb0598, size 0x1260, virtual false, abstract: false, final false
