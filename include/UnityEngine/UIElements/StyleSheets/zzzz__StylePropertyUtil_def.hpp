...
public:
  ...
  /// @brief Method IsAnimatable, addr 0x49dfd38, size 0x80, virtual false, abstract: false, final false
  static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method IsMatchingShorthand, addr 0x49dfbcc, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetEnumIntValue, addr 0x49dd5bc, size 0xf78, virtual false, abstract: false, final false
