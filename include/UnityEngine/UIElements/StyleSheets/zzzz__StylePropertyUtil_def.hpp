...
public:
  ...
  /// @brief Method IsAnimatable, addr 0x49d3900, size 0x80, virtual false, abstract: false, final false
  static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method IsMatchingShorthand, addr 0x49d3794, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetEnumIntValue, addr 0x49d1184, size 0xf78, virtual false, abstract: false, final false
