...
public:
  // Declarations
  /// @brief Method Compare, addr 0x49d3f18, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49d3f04, size 0x14, virtual false, abstract: false, final false
