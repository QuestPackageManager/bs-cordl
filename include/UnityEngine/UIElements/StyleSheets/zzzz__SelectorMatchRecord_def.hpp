...
public:
  // Declarations
  /// @brief Method Compare, addr 0x49da6b0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49da69c, size 0x14, virtual false, abstract: false, final false
