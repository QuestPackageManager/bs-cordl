...
public:
  // Declarations
  /// @brief Method Compare, addr 0x33379fc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33379e8, size 0x14, virtual false, abstract: false, final false
