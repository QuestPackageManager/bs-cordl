...
public:
  // Declarations
  /// @brief Method Compare, addr 0x6ae26a4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ae2690, size 0x14, virtual false, abstract: false, final false
