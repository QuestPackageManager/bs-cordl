...
public:
  // Declarations
  /// @brief Method Compare, addr 0x3567c30, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3567c1c, size 0x14, virtual false, abstract: false, final false
