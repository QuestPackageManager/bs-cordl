...
public:
  // Declarations
  /// @brief Method Compare, addr 0x2f51be0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f51bcc, size 0x14, virtual false, abstract: false, final false
