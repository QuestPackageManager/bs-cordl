...
// Ctor Parameters [CppParam { name: "errorCode", ty: "::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "errorValue", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }]
