...
public:
  ...
  /// @brief Method .ctor, addr 0x2dd7b14, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Init, addr 0x2dd7958, size 0x134, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method get_binding, addr 0x2ddb2e8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IBinding* get_binding();

  /// @brief Method set_bindingPath, addr 0x2ddb2f0, size 0x8, virtual true, abstract: false, final true
  inline void set_bindingPath(::StringW value);

  static inline ::UnityEngine::UIElements::BindableElement* New_ctor();

  /// @brief Method .ctor, addr 0x2dd7458, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6059)), TypeDefinitionIndex(TypeDefinitionIndex(6060)), TypeDefinitionIndex(TypeDefinitionIndex(6256)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6256), inst: 5236 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6058)) CS Name: ::BindableElement::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ddb2f8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
