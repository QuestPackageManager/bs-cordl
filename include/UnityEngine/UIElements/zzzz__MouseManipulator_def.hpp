...
public:
  ...
  /// @brief Method get_activators addr 0x2dbaf38 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::ManipulatorActivationFilter>* get_activators();

  /// @brief Method set_activators addr 0x2dbaf40 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2dbaf48 size 0x80 virtual false final false
  inline void _ctor();

  /// @brief Method CanStartManipulation addr 0x2dbafc8 size 0x17c virtual false final false
  inline bool CanStartManipulation(::UnityEngine::UIElements::IMouseEvent* e);

  /// @brief Method CanStopManipulation addr 0x2dbb144 size 0xb8 virtual false final false
