...
/// @brief Method .ctor, addr 0x6beb730, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activators, addr 0x6beb720, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::ManipulatorActivationFilter>* get_activators() ;

/// @brief Method set_activators, addr 0x6beb728, size 0x8, virtual false, abstract: false, final false
