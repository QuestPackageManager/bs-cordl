...
public:
  // Declarations
  /// @brief Method CaptureMouse, addr 0x4a4e410, size 0xd8, virtual false, abstract: false, final false
  static inline void CaptureMouse(::UnityEngine::UIElements::IEventHandler* handler);

  /// @brief Method HasMouseCapture, addr 0x4a4cbbc, size 0xac, virtual false, abstract: false, final false
  static inline bool HasMouseCapture(::UnityEngine::UIElements::IEventHandler* handler);

  /// @brief Method ReleaseMouse, addr 0x4a4e5e4, size 0xd8, virtual false, abstract: false, final false
