...
public:
  ...
  /// @brief Method .ctor, addr 0x2e245f8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x2e24724, size 0x14, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e2479c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <.cctor>b__9_0, addr 0x2e247a4, size 0x4, virtual false, abstract: false, final false
  inline void __cctor_b__9_0();

  /// @brief Method <.cctor>b__9_1, addr 0x2e247a8, size 0x64, virtual false, abstract: false, final false
  inline void __cctor_b__9_1(int32_t displayIndex, int32_t sortOrder);

  /// @brief Method <SortPanels>b__46_0, addr 0x2e2480c, size 0x170, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method add_onCreatePanel, addr 0x2e22704, size 0xf0, virtual false, abstract: false, final false
  static inline void add_onCreatePanel(::System::Action_1<::UnityEngine::UIElements::BaseRuntimePanel*>* value);

  /// @brief Method remove_onCreatePanel, addr 0x2e227f4, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_onCreatePanel(::System::Action_1<::UnityEngine::UIElements::BaseRuntimePanel*>* value);

  /// @brief Method CreateEvent, addr 0x2e22c18, size 0x74, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event* systemEvent);

  /// @brief Method FindOrCreateRuntimePanel, addr 0x2e22c8c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method DisposeRuntimePanel, addr 0x2e2307c, size 0xd0, virtual false, abstract: false, final false
  static inline void DisposeRuntimePanel(::UnityEngine::ScriptableObject* ownerObject);

  /// @brief Method RegisterCachedPanelInternal, addr 0x2e22f58, size 0x124, virtual false, abstract: false, final false
  static inline void RegisterCachedPanelInternal(int32_t instanceID, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method RemoveCachedPanelInternal, addr 0x2e22e28, size 0x130, virtual false, abstract: false, final false
  static inline void RemoveCachedPanelInternal(int32_t instanceID);

  /// @brief Method RepaintOverlayPanel, addr 0x2e23238, size 0x1c0, virtual false, abstract: false, final false
  static inline void RepaintOverlayPanel(::UnityEngine::UIElements::BaseRuntimePanel* panel);

  /// @brief Method BeginRenderOverlays, addr 0x2e233f8, size 0x58, virtual false, abstract: false, final false
  static inline void BeginRenderOverlays(int32_t displayIndex);

  /// @brief Method RenderOverlaysBeforePriority, addr 0x2e23450, size 0x1b0, virtual false, abstract: false, final false
  static inline void RenderOverlaysBeforePriority(int32_t displayIndex, float_t maxPriority);

  /// @brief Method EndRenderOverlays, addr 0x2e23688, size 0x70, virtual false, abstract: false, final false
  static inline void EndRenderOverlays(int32_t displayIndex);

  /// @brief Method get_activeEventSystem, addr 0x2e236f8, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Object> get_activeEventSystem();

  /// @brief Method set_activeEventSystem, addr 0x2e23750, size 0x5c, virtual false, abstract: false, final false
  static inline void set_activeEventSystem(::UnityEngine::Object* value);

  /// @brief Method get_useDefaultEventSystem, addr 0x2e237ac, size 0xbc, virtual false, abstract: false, final false
  static inline bool get_useDefaultEventSystem();

  /// @brief Method RegisterEventSystem, addr 0x2e23868, size 0x218, virtual false, abstract: false, final false
  static inline void RegisterEventSystem(::UnityEngine::Object* eventSystem);

  /// @brief Method UnregisterEventSystem, addr 0x2e23a80, size 0x114, virtual false, abstract: false, final false
  static inline void UnregisterEventSystem(::UnityEngine::Object* eventSystem);

  /// @brief Method get_defaultEventSystem, addr 0x2e23b94, size 0xac, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::DefaultEventSystem* get_defaultEventSystem();

  /// @brief Method UpdateRuntimePanels, addr 0x2e23c40, size 0x21c, virtual false, abstract: false, final false
  static inline void UpdateRuntimePanels();

  /// @brief Method MarkPotentiallyEmpty, addr 0x2e24060, size 0x114, virtual false, abstract: false, final false
  static inline void MarkPotentiallyEmpty(::UnityEngine::UIElements::PanelSettings* settings);

  /// @brief Method RemoveUnusedPanels, addr 0x2e23e5c, size 0x204, virtual false, abstract: false, final false
  static inline void RemoveUnusedPanels();

  /// @brief Method RegisterPlayerloopCallback, addr 0x2e2314c, size 0x9c, virtual false, abstract: false, final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method UnregisterPlayerloopCallback, addr 0x2e231e8, size 0x50, virtual false, abstract: false, final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method SetPanelOrderingDirty, addr 0x2e161a8, size 0x5c, virtual false, abstract: false, final false
  static inline void SetPanelOrderingDirty();

  /// @brief Method GetSortedPlayerPanels, addr 0x2e23600, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Panel*>* GetSortedPlayerPanels();

  /// @brief Method SortPanels, addr 0x2e24174, size 0x1c4, virtual false, abstract: false, final false
  static inline void SortPanels();

  /// @brief Method MultiDisplayBottomLeftToPanelPosition, addr 0x2e24338, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiDisplayToLocalScreenPosition, addr 0x2e243b8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenBottomLeftToPanelPosition, addr 0x2e2450c, size 0xe4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2 position, int32_t targetDisplay);

  /// @brief Method ScreenBottomLeftToPanelDelta, addr 0x2e245f0, size 0x8, virtual false, abstract: false, final false
