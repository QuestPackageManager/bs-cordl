...
public:
  ...
  /// @brief Method .ctor addr 0x2ca0e60 size 0x12c virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x2ca0f8c size 0x14 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2ca1004 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <.cctor>b__9_0 addr 0x2ca100c size 0x4 virtual false final false
  inline void __cctor_b__9_0();

  /// @brief Method <.cctor>b__9_1 addr 0x2ca1010 size 0x64 virtual false final false
  inline void __cctor_b__9_1(int32_t displayIndex, int32_t sortOrder);

  /// @brief Method <SortPanels>b__46_0 addr 0x2ca1074 size 0x170 virtual false final false
...
public:
  ...
  /// @brief Method add_onCreatePanel addr 0x2c9ef6c size 0xf0 virtual false final false
  static inline void add_onCreatePanel(::System::Action_1<::UnityEngine::UIElements::BaseRuntimePanel*>* value);

  /// @brief Method remove_onCreatePanel addr 0x2c9f05c size 0xf0 virtual false final false
  static inline void remove_onCreatePanel(::System::Action_1<::UnityEngine::UIElements::BaseRuntimePanel*>* value);

  /// @brief Method CreateEvent addr 0x2c9f480 size 0x74 virtual false final false
  static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event* systemEvent);

  /// @brief Method FindOrCreateRuntimePanel addr 0x2c9f4f4 size 0x19c virtual false final false
  ...
  /// @brief Method DisposeRuntimePanel addr 0x2c9f8e4 size 0xd0 virtual false final false
  static inline void DisposeRuntimePanel(::UnityEngine::ScriptableObject* ownerObject);

  /// @brief Method RegisterCachedPanelInternal addr 0x2c9f7c0 size 0x124 virtual false final false
  static inline void RegisterCachedPanelInternal(int32_t instanceID, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method RemoveCachedPanelInternal addr 0x2c9f690 size 0x130 virtual false final false
  static inline void RemoveCachedPanelInternal(int32_t instanceID);

  /// @brief Method RepaintOverlayPanel addr 0x2c9faa0 size 0x1c0 virtual false final false
  static inline void RepaintOverlayPanel(::UnityEngine::UIElements::BaseRuntimePanel* panel);

  /// @brief Method BeginRenderOverlays addr 0x2c9fc60 size 0x58 virtual false final false
  static inline void BeginRenderOverlays(int32_t displayIndex);

  /// @brief Method RenderOverlaysBeforePriority addr 0x2c9fcb8 size 0x1b0 virtual false final false
  static inline void RenderOverlaysBeforePriority(int32_t displayIndex, float_t maxPriority);

  /// @brief Method EndRenderOverlays addr 0x2c9fef0 size 0x70 virtual false final false
  static inline void EndRenderOverlays(int32_t displayIndex);

  /// @brief Method get_activeEventSystem addr 0x2c9ff60 size 0x58 virtual false final false
  static inline ::UnityEngine::Object* get_activeEventSystem();

  /// @brief Method set_activeEventSystem addr 0x2c9ffb8 size 0x5c virtual false final false
  static inline void set_activeEventSystem(::UnityEngine::Object* value);

  /// @brief Method get_useDefaultEventSystem addr 0x2ca0014 size 0xbc virtual false final false
  static inline bool get_useDefaultEventSystem();

  /// @brief Method RegisterEventSystem addr 0x2ca00d0 size 0x218 virtual false final false
  static inline void RegisterEventSystem(::UnityEngine::Object* eventSystem);

  /// @brief Method UnregisterEventSystem addr 0x2ca02e8 size 0x114 virtual false final false
  static inline void UnregisterEventSystem(::UnityEngine::Object* eventSystem);

  /// @brief Method get_defaultEventSystem addr 0x2ca03fc size 0xac virtual false final false
  static inline ::UnityEngine::UIElements::DefaultEventSystem* get_defaultEventSystem();

  /// @brief Method UpdateRuntimePanels addr 0x2ca04a8 size 0x21c virtual false final false
  static inline void UpdateRuntimePanels();

  /// @brief Method MarkPotentiallyEmpty addr 0x2ca08c8 size 0x114 virtual false final false
  static inline void MarkPotentiallyEmpty(::UnityEngine::UIElements::PanelSettings* settings);

  /// @brief Method RemoveUnusedPanels addr 0x2ca06c4 size 0x204 virtual false final false
  static inline void RemoveUnusedPanels();

  /// @brief Method RegisterPlayerloopCallback addr 0x2c9f9b4 size 0x9c virtual false final false
  static inline void RegisterPlayerloopCallback();

  /// @brief Method UnregisterPlayerloopCallback addr 0x2c9fa50 size 0x50 virtual false final false
  static inline void UnregisterPlayerloopCallback();

  /// @brief Method SetPanelOrderingDirty addr 0x2c92a10 size 0x5c virtual false final false
  static inline void SetPanelOrderingDirty();

  /// @brief Method GetSortedPlayerPanels addr 0x2c9fe68 size 0x88 virtual false final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Panel*>* GetSortedPlayerPanels();

  /// @brief Method SortPanels addr 0x2ca09dc size 0x1c4 virtual false final false
  static inline void SortPanels();

  /// @brief Method MultiDisplayBottomLeftToPanelPosition addr 0x2ca0ba0 size 0x80 virtual false final false
  ...
  /// @brief Method MultiDisplayToLocalScreenPosition addr 0x2ca0c20 size 0x154 virtual false final false
  ...
  /// @brief Method ScreenBottomLeftToPanelPosition addr 0x2ca0d74 size 0xe4 virtual false final false
  static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2 position, int32_t targetDisplay);

  /// @brief Method ScreenBottomLeftToPanelDelta addr 0x2ca0e58 size 0x8 virtual false final false
