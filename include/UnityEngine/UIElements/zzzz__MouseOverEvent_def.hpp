...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7301), inst: 4554 }), TypeDefinitionIndex(TypeDefinitionIndex(7301))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2ce98d8 size 0x48 virtual false final false
  inline void _ctor();
