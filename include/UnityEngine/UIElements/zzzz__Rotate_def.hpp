...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7391)), TypeDefinitionIndex(TypeDefinitionIndex(10176))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2d06ef4 size 0x60 virtual false final false
  inline void _ctor(::UnityEngine::UIElements::Angle angle);

  /// @brief Method Initial addr 0x2d06f54 size 0x8c virtual false final false
  static inline ::UnityEngine::UIElements::Rotate Initial();

  /// @brief Method None addr 0x2d06fe8 size 0x70 virtual false final false
  static inline ::UnityEngine::UIElements::Rotate None();

  /// @brief Method get_angle addr 0x2d07058 size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::Angle get_angle();

  /// @brief Method set_angle addr 0x2d07060 size 0x8 virtual false final false
  inline void set_angle(::UnityEngine::UIElements::Angle value);

  /// @brief Method op_Equality addr 0x2d07068 size 0x84 virtual false final false
  static inline bool op_Equality(::UnityEngine::UIElements::Rotate lhs, ::UnityEngine::UIElements::Rotate rhs);

  /// @brief Method op_Inequality addr 0x2d07114 size 0x48 virtual false final false
  static inline bool op_Inequality(::UnityEngine::UIElements::Rotate lhs, ::UnityEngine::UIElements::Rotate rhs);

  /// @brief Method Equals addr 0x2d0715c size 0x44 virtual true final true
  inline bool Equals(::UnityEngine::UIElements::Rotate other);

  /// @brief Method Equals addr 0x2d071a0 size 0xa0 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2d07240 size 0x98 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x2d07300 size 0x68 virtual true final false
  inline ::StringW ToString();

  /// @brief Method ToQuaternion addr 0x2d07540 size 0x20 virtual false final false
