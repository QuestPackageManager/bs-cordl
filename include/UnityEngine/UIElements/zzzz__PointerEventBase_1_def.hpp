...
public:
// Declarations
 __declspec(property(get=UnityEngine_UIElements_IPointerEventInternal_get_compatibilityMouseEvent, put=UnityEngine_UIElements_IPointerEventInternal_set_compatibilityMouseEvent)) ::UnityEngine::UIElements::IMouseEvent*  UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent;
...
/// @brief Field <UnityEngine.UIElements.IPointerEventInternal.compatibilityMouseEvent>k__BackingField, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField, put=__cordl_internal_set__UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField)) ::UnityEngine::UIElements::IMouseEvent*  _UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField;

/// @brief Field <UnityEngine.UIElements.IPointerEventInternal.displayIndex>k__BackingField, offset 0xf0, size 0x4 
 __declspec(property(get=__cordl_internal_get__UnityEngine_UIElements_IPointerEventInternal_displayIndex_k__BackingField, put=__cordl_internal_set__UnityEngine_UIElements_IPointerEventInternal_displayIndex_k__BackingField)) int32_t  _UnityEngine_UIElements_IPointerEventInternal_displayIndex_k__BackingField;
...
/// @brief Field <radiusVariance>k__BackingField, offset 0xd8, size 0x8 
...
/// @brief Field <twist>k__BackingField, offset 0xc8, size 0x4 
...
/// @brief Field m_AltitudeAngle, offset 0x68, size 0x4 
...
/// @brief Field m_AltitudeNeedsConversion, offset 0x64, size 0x1 
...
/// @brief Field m_AzimuthAngle, offset 0x6c, size 0x4 
...
/// @brief Field m_AzimuthNeedsConversion, offset 0x65, size 0x1 
...
static inline T GetPooled(::UnityEngine::EventType  eventType, ::UnityEngine::Vector3  mousePosition, ::UnityEngine::Vector2  delta, int32_t  button, int32_t  clickCount, ::UnityEngine::EventModifiers  modifiers, int32_t  displayIndex) ;
...
/// @brief Field m_AltitudeNeedsConversion, offset: 0x64, size: 0x1, def value: None
 bool  ___m_AltitudeNeedsConversion;

/// @brief Field m_AzimuthNeedsConversion, offset: 0x65, size: 0x1, def value: None
 bool  ___m_AzimuthNeedsConversion;

/// @brief Field m_AltitudeAngle, offset: 0x68, size: 0x4, def value: None
 float_t  ___m_AltitudeAngle;

/// @brief Field m_AzimuthAngle, offset: 0x6c, size: 0x4, def value: None
 float_t  ___m_AzimuthAngle;

/// @brief Field m_TiltNeeded, offset: 0x70, size: 0x1, def value: None
...
/// @brief Field <twist>k__BackingField, offset: 0xc8, size: 0x4, def value: None
 float_t  ____twist_k__BackingField;

/// @brief Field <penStatus>k__BackingField, offset: 0xcc, size: 0x4, def value: None
