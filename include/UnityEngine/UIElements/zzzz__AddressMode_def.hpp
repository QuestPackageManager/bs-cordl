...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::AddressMode, "UnityEngine.UIElements", "AddressMode");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::AddressMode) == 0x4, "Size mismatch!");
