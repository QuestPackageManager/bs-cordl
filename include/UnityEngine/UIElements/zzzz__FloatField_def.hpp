...
/// @brief Method .ctor, addr 0x6b75c80, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6b75ce8, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6b75e0c, size 0x274, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6b760dc, size 0xa0, virtual true, abstract: false, final false
inline float_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6b76080, size 0x5c, virtual true, abstract: false, final false
inline ::StringW ValueToString(float_t  v) ;

/// @brief Method .ctor, addr 0x6b75a88, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x6b75db0, size 0x5c, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentFloatField, addr 0x6b75d34, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6b75b48, size 0x5c, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, float_t  startValue) ;

/// @brief Method CanTryParse, addr 0x6b75b24, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6b7581c, size 0xe0, virtual true, abstract: false, final false
inline float_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6b7575c, size 0xc0, virtual true, abstract: false, final false
inline ::StringW ValueToString(float_t  v) ;

/// @brief Method .ctor, addr 0x6b758fc, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6b75908, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method get_floatInput, addr 0x6b756cc, size 0x90, virtual false, abstract: false, final false
