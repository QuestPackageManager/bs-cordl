...
public:
  ...
  /// @brief Method Copy, addr 0x6c8f908, size 0x148, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::TransitionData Copy();

  /// @brief Method CopyFrom, addr 0x6c8fa50, size 0x1d4, virtual true, abstract: false, final true
  inline void CopyFrom(::by_ref<::UnityEngine::UIElements::TransitionData> other);

  /// @brief Method Equals, addr 0x6c8fcbc, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c8fc70, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransitionData other);

  /// @brief Method GetHashCode, addr 0x6c8fd6c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6c8fc24, size 0x4c, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "transitionDelay", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>*", modifiers: "", def_value: None, comment: None }, CppParam
  // { name: "transitionDuration", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>*", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "transitionProperty", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::StylePropertyName>*", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "transitionTimingFunction", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::EasingFunction>*", modifiers: "", def_value: None, comment: None }]
