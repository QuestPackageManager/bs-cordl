...
public:
  ...
  /// @brief Method Copy, addr 0x6a5b1c4, size 0x148, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::TransitionData Copy();

  /// @brief Method CopyFrom, addr 0x6a5b30c, size 0x1d4, virtual true, abstract: false, final true
  inline void CopyFrom(::ByRef<::UnityEngine::UIElements::TransitionData> other);

  /// @brief Method Equals, addr 0x6a5b578, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6a5b52c, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransitionData other);

  /// @brief Method GetHashCode, addr 0x6a5b628, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6a5b4e0, size 0x4c, virtual false, abstract: false, final false
