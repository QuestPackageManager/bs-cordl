...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6d88530, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::SetupDragAndDropArgs) == 0x38, "Size mismatch!");
