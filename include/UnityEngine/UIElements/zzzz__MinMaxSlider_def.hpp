...
public:
  ...
  /// @brief Method .ctor, addr 0x6bfa9fc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6bfac14, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bfaa64, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ClampValues, addr 0x6bf7a54, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 ClampValues(::UnityEngine::Vector2 valueToClamp);

  /// @brief Method ComputeValueFromDraggingThumb, addr 0x6bf9ea4, size 0x1a0, virtual false, abstract: false, final false
  inline void ComputeValueFromDraggingThumb(float_t dragElementStartPos, float_t dragElementEndPos);

  /// @brief Method ComputeValueFromKey, addr 0x6bf98b0, size 0x564, virtual false, abstract: false, final false
  inline void ComputeValueFromKey(bool leftDirection, bool isShift, ::UnityEngine::UIElements::MinMaxSlider_DragState moveState);

  /// @brief Method ComputeValueFromPosition, addr 0x6bf9418, size 0x78, virtual false, abstract: false, final false
  inline float_t ComputeValueFromPosition(float_t positionToConvert);

  /// @brief Method GetNavigationState, addr 0x6bf95c0, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MinMaxSlider_DragState GetNavigationState();

  /// @brief Method HandleEventBubbleUp, addr 0x6bf9490, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method OnBlur, addr 0x6bf97b8, size 0x8, virtual false, abstract: false, final false
  inline void OnBlur(::UnityEngine::UIElements::BlurEvent* evt);

  /// @brief Method OnFocusIn, addr 0x6bf978c, size 0x2c, virtual false, abstract: false, final false
  inline void OnFocusIn(::UnityEngine::UIElements::FocusInEvent* evt);

  /// @brief Method OnNavigationMove, addr 0x6bf97e4, size 0xcc, virtual false, abstract: false, final false
  inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent* evt);

  /// @brief Method OnNavigationSubmit, addr 0x6bf97c0, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method RegisterEditingCallbacks, addr 0x6bfa2b4, size 0x140, virtual true, abstract: false, final false
  inline void RegisterEditingCallbacks();

  /// @brief Method SetNavigationState, addr 0x6bf9678, size 0x114, virtual false, abstract: false, final false
  inline void SetNavigationState(::UnityEngine::UIElements::MinMaxSlider_DragState newState);

  /// @brief Method SetSliderValueFromClick, addr 0x6bfa044, size 0x26c, virtual false, abstract: false, final false
  inline void SetSliderValueFromClick();

  /// @brief Method SetSliderValueFromDrag, addr 0x6bf9e14, size 0x90, virtual false, abstract: false, final false
  inline void SetSliderValueFromDrag();

  /// @brief Method SetValueWithoutNotify, addr 0x6bf7d18, size 0x98, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::Vector2 newValue);

  /// @brief Method SliderLerpUnclamped, addr 0x6bf9408, size 0x10, virtual false, abstract: false, final false
  inline float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x6bf93f8, size 0x10, virtual false, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method UnregisterEditingCallbacks, addr 0x6bfa3f4, size 0x140, virtual true, abstract: false, final false
  inline void UnregisterEditingCallbacks();

  /// @brief Method UpdateDragElementPosition, addr 0x6bf7db0, size 0xa24, virtual false, abstract: false, final false
  inline void UpdateDragElementPosition();

  /// @brief Method UpdateDragElementPosition, addr 0x6bf93c0, size 0x38, virtual false, abstract: false, final false
  inline void UpdateDragElementPosition(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method UpdateMixedValueContent, addr 0x6bfa2b0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf8b94, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bf8bb4, size 0x80c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clampedDragger, addr 0x6bf78a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ClampedDragger_1<float_t>* get_clampedDragger();

  /// @brief Method get_dragElement, addr 0x6bf7874, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragElement();

  /// @brief Method get_dragMaxThumb, addr 0x6bf7894, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragMaxThumb();

  /// @brief Method get_dragMinThumb, addr 0x6bf7884, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_dragMinThumb();

  /// @brief Method get_highLimit, addr 0x6bf883c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highLimit();

  /// @brief Method get_lowLimit, addr 0x6bf8844, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lowLimit();

  /// @brief Method get_maxValue, addr 0x6bf7a8c, size 0x20, virtual false, abstract: false, final false
  inline float_t get_maxValue();

  /// @brief Method get_minValue, addr 0x6bf78b4, size 0x10, virtual false, abstract: false, final false
  inline float_t get_minValue();

  /// @brief Method get_range, addr 0x6bf87d4, size 0x68, virtual false, abstract: false, final false
  inline float_t get_range();

  /// @brief Method get_value, addr 0x6bf7c40, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_clampedDragger, addr 0x6bf78ac, size 0x8, virtual false, abstract: false, final false
  inline void set_clampedDragger(::UnityEngine::UIElements::ClampedDragger_1<float_t>* value);

  /// @brief Method set_dragElement, addr 0x6bf787c, size 0x8, virtual false, abstract: false, final false
  inline void set_dragElement(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_dragMaxThumb, addr 0x6bf789c, size 0x8, virtual false, abstract: false, final false
  inline void set_dragMaxThumb(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_dragMinThumb, addr 0x6bf788c, size 0x8, virtual false, abstract: false, final false
  inline void set_dragMinThumb(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_highLimit, addr 0x6bf89f0, size 0x1a4, virtual false, abstract: false, final false
  inline void set_highLimit(float_t value);

  /// @brief Method set_lowLimit, addr 0x6bf884c, size 0x1a4, virtual false, abstract: false, final false
  inline void set_lowLimit(float_t value);

  /// @brief Method set_maxValue, addr 0x6bf7aac, size 0x194, virtual false, abstract: false, final false
  inline void set_maxValue(float_t value);

  /// @brief Method set_minValue, addr 0x6bf78c4, size 0x190, virtual false, abstract: false, final false
  inline void set_minValue(float_t value);

  /// @brief Method set_value, addr 0x6bf7c88, size 0x90, virtual true, abstract: false, final false
