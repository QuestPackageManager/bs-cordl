...
public:
  ...
  /// @brief Method <.cctor>b__4_0, addr 0x499e50c, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* __cctor_b__4_0();

  /// @brief Method .ctor, addr 0x499e504, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Copy, addr 0x499e158, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Get, addr 0x499e204, size 0xe0, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* Get(int32_t initialCapacity);

  /// @brief Method Release, addr 0x499e2e4, size 0xb4, virtual false, abstract: false, final false
