...
public:
  ...
  /// @brief Method .ctor, addr 0x6c1b948, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_preview, addr 0x6c1b940, size 0x8, virtual false, abstract: false, final false
