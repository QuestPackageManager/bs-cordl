...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIElementsBridge*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIElementsBridge*, "UnityEngine.UIElements", "UIElementsBridge");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6caff80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::UIElementsBridge) == 0x10, "Size mismatch!");
