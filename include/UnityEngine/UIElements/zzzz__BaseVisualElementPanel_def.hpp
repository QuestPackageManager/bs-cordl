...
public:
  ...
  /// @brief Method ClearCachedElementUnderPointer, addr 0x6c5f0a8, size 0x24, virtual false, abstract: false, final false
  inline void ClearCachedElementUnderPointer(int32_t pointerId, ::UnityEngine::UIElements::EventBase* triggerEvent);

  /// @brief Method CommitElementUnderPointers, addr 0x6c5f0cc, size 0x5c, virtual false, abstract: false, final false
  inline void CommitElementUnderPointers();

  /// @brief Method Dispose, addr 0x6c5e9dc, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6c5ea50, size 0x1e8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetTopElementUnderPointer, addr 0x6c5edcc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeAtlasChanged, addr 0x6c5f4e8, size 0x1c, virtual false, abstract: false, final false
  inline void InvokeAtlasChanged();

  /// @brief Method InvokeBeforeUpdate, addr 0x6c5f678, size 0x20, virtual false, abstract: false, final false
  inline void InvokeBeforeUpdate();

  /// @brief Method InvokeHierarchyChanged, addr 0x6c5f65c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecomputeTopElementUnderPointer, addr 0x6c5ede4, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6c5f898, size 0xa8, virtual true, abstract: false, final false
  inline void Render();
  ...
  /// @brief Method SendEvent, addr 0x6c5ecd8, size 0xe4, virtual false, abstract: false, final false
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method SetSpecializedHierarchyFlagsUpdater, addr 0x6c5f288, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x6c5f890, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x6c5f894, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateElementUnderPointers, addr 0x6c5f698, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c5e888, size 0x154, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_atlasChanged, addr 0x6c5f390, size 0xac, virtual false, abstract: false, final false
  inline void add_atlasChanged(::System::Action* value);

  /// @brief Method add_hierarchyChanged, addr 0x6c5f504, size 0xac, virtual false, abstract: false, final false
  inline void add_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent* value);

  /// @brief Method add_isFlatChanged, addr 0x6c5f128, size 0xac, virtual false, abstract: false, final false
  inline void add_isFlatChanged(::System::Action* value);

  /// @brief Method add_panelDisposed, addr 0x6c580e8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clearSettings, addr 0x6c5ec60, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_contextualMenuManager, addr 0x6c5ecb8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::ContextualMenuManager* get_contextualMenuManager();

  /// @brief Method get_cursorManager, addr 0x6c5eca8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ICursorManager* get_cursorManager();

  /// @brief Method get_dataBindingManager, addr 0x6c5ecc8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x6c5edbc, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_duringLayoutPhase, addr 0x6c5ec88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isFlat, addr 0x6c5f280, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_referenceSpritePixelsPerUnit, addr 0x6c5ec50, size 0x8, virtual false, abstract: false, final false
  inline float_t get_referenceSpritePixelsPerUnit();

  /// @brief Method get_repaintData, addr 0x6c5ec98, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_scale, addr 0x6c5ec38, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method get_scaledPixelsPerPoint, addr 0x6c5ec40, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method get_uiElementsBridge, addr 0x6c5e830, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_atlasChanged, addr 0x6c5f43c, size 0xac, virtual false, abstract: false, final false
  inline void remove_atlasChanged(::System::Action* value);

  /// @brief Method remove_hierarchyChanged, addr 0x6c5f5b0, size 0xac, virtual false, abstract: false, final false
  inline void remove_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent* value);

  /// @brief Method remove_isFlatChanged, addr 0x6c5f1d4, size 0xac, virtual false, abstract: false, final false
  inline void remove_isFlatChanged(::System::Action* value);

  /// @brief Method remove_panelDisposed, addr 0x6c5834c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_clearSettings, addr 0x6c5ec74, size 0x14, virtual false, abstract: false, final false
  inline void set_clearSettings(::UnityEngine::UIElements::PanelClearSettings value);

  /// @brief Method set_contextualMenuManager, addr 0x6c5ecc0, size 0x8, virtual false, abstract: false, final false
  inline void set_contextualMenuManager(::UnityEngine::UIElements::ContextualMenuManager* value);

  /// @brief Method set_cursorManager, addr 0x6c5ecb0, size 0x8, virtual true, abstract: false, final false
  inline void set_cursorManager(::UnityEngine::UIElements::ICursorManager* value);

  /// @brief Method set_dataBindingManager, addr 0x6c5ecd0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x6c5edc4, size 0x8, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_duringLayoutPhase, addr 0x6c5ec90, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isFlat, addr 0x6c540a4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_referenceSpritePixelsPerUnit, addr 0x6c5ec58, size 0x8, virtual false, abstract: false, final false
  inline void set_referenceSpritePixelsPerUnit(float_t value);

  /// @brief Method set_repaintData, addr 0x6c5eca0, size 0x8, virtual true, abstract: false, final false
  inline void set_repaintData(::UnityEngine::UIElements::RepaintData* value);

  /// @brief Method set_scale, addr 0x6c53f34, size 0x138, virtual false, abstract: false, final false
