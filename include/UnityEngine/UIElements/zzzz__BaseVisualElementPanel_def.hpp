...
public:
  ...
  /// @brief Method ClearCachedElementUnderPointer, addr 0x6db4ad8, size 0x24, virtual false, abstract: false, final false
  inline void ClearCachedElementUnderPointer(int32_t pointerId, ::UnityEngine::UIElements::EventBase* triggerEvent);

  /// @brief Method CommitElementUnderPointers, addr 0x6db4afc, size 0x5c, virtual false, abstract: false, final false
  inline void CommitElementUnderPointers();

  /// @brief Method Dispose, addr 0x6db440c, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6db4480, size 0x1e8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetTopElementUnderPointer, addr 0x6db47fc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeAtlasChanged, addr 0x6db4f18, size 0x1c, virtual false, abstract: false, final false
  inline void InvokeAtlasChanged();

  /// @brief Method InvokeBeforeUpdate, addr 0x6db50a8, size 0x20, virtual false, abstract: false, final false
  inline void InvokeBeforeUpdate();

  /// @brief Method InvokeHierarchyChanged, addr 0x6db508c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecomputeTopElementUnderPointer, addr 0x6db4814, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Render, addr 0x6db52c8, size 0xa8, virtual true, abstract: false, final false
  inline void Render();
  ...
  /// @brief Method SendEvent, addr 0x6db4708, size 0xe4, virtual false, abstract: false, final false
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method SetSpecializedHierarchyFlagsUpdater, addr 0x6db4cb8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x6db52c0, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x6db52c4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateElementUnderPointers, addr 0x6db50c8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6db42b8, size 0x154, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_atlasChanged, addr 0x6db4dc0, size 0xac, virtual false, abstract: false, final false
  inline void add_atlasChanged(::System::Action* value);

  /// @brief Method add_hierarchyChanged, addr 0x6db4f34, size 0xac, virtual false, abstract: false, final false
  inline void add_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent* value);

  /// @brief Method add_isFlatChanged, addr 0x6db4b58, size 0xac, virtual false, abstract: false, final false
  inline void add_isFlatChanged(::System::Action* value);

  /// @brief Method add_panelDisposed, addr 0x6dadb18, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clearSettings, addr 0x6db4690, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_contextualMenuManager, addr 0x6db46e8, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::ContextualMenuManager* get_contextualMenuManager();

  /// @brief Method get_cursorManager, addr 0x6db46d8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ICursorManager* get_cursorManager();

  /// @brief Method get_dataBindingManager, addr 0x6db46f8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x6db47ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_duringLayoutPhase, addr 0x6db46b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isFlat, addr 0x6db4cb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_referenceSpritePixelsPerUnit, addr 0x6db4680, size 0x8, virtual false, abstract: false, final false
  inline float_t get_referenceSpritePixelsPerUnit();

  /// @brief Method get_repaintData, addr 0x6db46c8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_scale, addr 0x6db4668, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method get_scaledPixelsPerPoint, addr 0x6db4670, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method get_uiElementsBridge, addr 0x6db4260, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_atlasChanged, addr 0x6db4e6c, size 0xac, virtual false, abstract: false, final false
  inline void remove_atlasChanged(::System::Action* value);

  /// @brief Method remove_hierarchyChanged, addr 0x6db4fe0, size 0xac, virtual false, abstract: false, final false
  inline void remove_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent* value);

  /// @brief Method remove_isFlatChanged, addr 0x6db4c04, size 0xac, virtual false, abstract: false, final false
  inline void remove_isFlatChanged(::System::Action* value);

  /// @brief Method remove_panelDisposed, addr 0x6dadd7c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_clearSettings, addr 0x6db46a4, size 0x14, virtual false, abstract: false, final false
  inline void set_clearSettings(::UnityEngine::UIElements::PanelClearSettings value);

  /// @brief Method set_contextualMenuManager, addr 0x6db46f0, size 0x8, virtual false, abstract: false, final false
  inline void set_contextualMenuManager(::UnityEngine::UIElements::ContextualMenuManager* value);

  /// @brief Method set_cursorManager, addr 0x6db46e0, size 0x8, virtual true, abstract: false, final false
  inline void set_cursorManager(::UnityEngine::UIElements::ICursorManager* value);

  /// @brief Method set_dataBindingManager, addr 0x6db4700, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x6db47f4, size 0x8, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_duringLayoutPhase, addr 0x6db46c0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isFlat, addr 0x6da9ad4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_referenceSpritePixelsPerUnit, addr 0x6db4688, size 0x8, virtual false, abstract: false, final false
  inline void set_referenceSpritePixelsPerUnit(float_t value);

  /// @brief Method set_repaintData, addr 0x6db46d0, size 0x8, virtual true, abstract: false, final false
  inline void set_repaintData(::UnityEngine::UIElements::RepaintData* value);

  /// @brief Method set_scale, addr 0x6da9964, size 0x138, virtual false, abstract: false, final false
