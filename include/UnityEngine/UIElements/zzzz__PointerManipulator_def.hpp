...
public:
  ...
  /// @brief Method CanStartManipulation, addr 0x4a482d4, size 0x1e4, virtual false, abstract: false, final false
  inline bool CanStartManipulation(::UnityEngine::UIElements::IPointerEvent* e);

  /// @brief Method CanStopManipulation, addr 0x4a484b8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a4856c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
