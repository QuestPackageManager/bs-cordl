...
public:
  ...
  __declspec(property(get = get_values)) ::ArrayW<::UnityEngine::UIElements::StyleValueHandle> values;
  ...
  /// @brief Method .ctor, addr 0x6c98494, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x6c98484, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_values, addr 0x6c9848c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::StyleProperty) == 0x30, "Size mismatch!");
