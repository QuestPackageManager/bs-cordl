...
public:
  ...
  /// @brief Method .ctor, addr 0x33b5ae4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x33b5ad4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_values, addr 0x33b5adc, size 0x8, virtual false, abstract: false, final false
