...
public:
  ...
  /// @brief Method get_profilerMarker addr 0x2dfe9d0 size 0x58 virtual true final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method OnVersionChanged addr 0x2dfea28 size 0x90 virtual true final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update addr 0x2dfeb60 size 0x144 virtual true final false
  inline void Update();

  /// @brief Method ValidateViewDataOnSubTree addr 0x2dfeca4 size 0x150 virtual false final false
  inline void ValidateViewDataOnSubTree(::UnityEngine::UIElements::VisualElement* ve, bool enablePersistence);

  /// @brief Method PropagateToParents addr 0x2dfeab8 size 0xa8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2dfedf4 size 0xa0 virtual false final false
  inline void _ctor();
