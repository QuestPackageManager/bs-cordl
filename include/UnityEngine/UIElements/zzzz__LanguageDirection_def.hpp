...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::LanguageDirection, "UnityEngine.UIElements", "LanguageDirection");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::LanguageDirection) == 0x4, "Size mismatch!");
