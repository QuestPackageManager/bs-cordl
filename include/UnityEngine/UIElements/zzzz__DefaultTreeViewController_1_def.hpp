...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTreeViewController_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTreeViewController_1(DefaultTreeViewController_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTreeViewController_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTreeViewController_1(DefaultTreeViewController_1const&) = delete;
