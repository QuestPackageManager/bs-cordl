...
public:
  ...
  /// @brief Method Build, addr 0x35ccc5c, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x35ccb7c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x35ccf54, size 0x110, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x35ccab0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
