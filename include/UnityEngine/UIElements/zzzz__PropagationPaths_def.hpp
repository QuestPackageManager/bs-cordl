...
public:
  ...
  /// @brief Method <.cctor>b__12_0, addr 0x4a34e94, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PropagationPaths* __cctor_b__12_0();

  /// @brief Method .ctor, addr 0x4a34e8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Build, addr 0x4a238e8, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x4a27bb4, size 0x110, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x4a34c64, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
