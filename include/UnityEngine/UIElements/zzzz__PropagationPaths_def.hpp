...
public:
  ...
  /// @brief Method <.cctor>b__8_0, addr 0x6c4d2d0, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PropagationPaths* __cctor_b__8_0();

  /// @brief Method .ctor, addr 0x6c4d2cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Build, addr 0x6c424ec, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6c4d06c, size 0xf4, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x6c4cfd0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
