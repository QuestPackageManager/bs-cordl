...
public:
  ...
  /// @brief Method .ctor, addr 0x6be2c0c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be2c74, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be2e3c, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x6be2fb0, size 0x4, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_0(::UnityEngine::Vector3 r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x6be2fb4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::Vector3> r, float_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x6be2fbc, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_2(::UnityEngine::Vector3 r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x6be2fc4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::Vector3> r, float_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x6be2fcc, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_4(::UnityEngine::Vector3 r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x6be2fd4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::ByRef<::UnityEngine::Vector3> r, float_t v);

  /// @brief Method .ctor, addr 0x6be2fac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x6be2698, size 0x490, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be2b28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bdda68, size 0x12c, virtual false, abstract: false, final false
