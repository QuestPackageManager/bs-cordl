...
public:
  // Declarations
  /// @brief Method AdjustSpriteUVsForScaleMode, addr 0x33c68bc, size 0x760, virtual false, abstract: false, final false
  ...
  /// @brief Method AdjustUVsForScaleMode, addr 0x33c659c, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyPackingRotation, addr 0x33c72ec, size 0x12c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ApplyPackingRotation(::UnityEngine::Rect uv, ::UnityEngine::SpritePackingRotation rotation);

  /// @brief Method ComputeGeomRect, addr 0x33c713c, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeGeomRect(::UnityEngine::Sprite* sprite);

  /// @brief Method ComputeUVRect, addr 0x33c7214, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeUVRect(::UnityEngine::Sprite* sprite);

  /// @brief Method HasRadius, addr 0x33c7d64, size 0x74, virtual false, abstract: false, final false
  inline bool HasRadius(float_t epsilon);

  /// @brief Method MakeSprite, addr 0x33c7584, size 0x6c4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeTextured, addr 0x33c7418, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeVectorTextured, addr 0x33c7c48, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method RectIntersection, addr 0x33c701c, size 0x120, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x33c7dd8, size 0x2a0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTextNativeSettings, addr 0x33c8420, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeStyleBased, addr 0x33c8078, size 0x3a8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AdjustBackgroundSizeForBorders, addr 0x33c6148, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertBorderRadiusPercentToPoints, addr 0x33c5e70, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVisualElementRadii, addr 0x33c5eac, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rectangle, addr 0x33c5c3c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Text, addr 0x33c5d3c, size 0x134, virtual false, abstract: false, final false
