...
public:
  // Declarations
  /// @brief Method AdjustSpriteUVsForScaleMode, addr 0x33c98b8, size 0x760, virtual false, abstract: false, final false
  ...
  /// @brief Method AdjustUVsForScaleMode, addr 0x33c9598, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyPackingRotation, addr 0x33ca2e8, size 0x12c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ApplyPackingRotation(::UnityEngine::Rect uv, ::UnityEngine::SpritePackingRotation rotation);

  /// @brief Method ComputeGeomRect, addr 0x33ca138, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeGeomRect(::UnityEngine::Sprite* sprite);

  /// @brief Method ComputeUVRect, addr 0x33ca210, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeUVRect(::UnityEngine::Sprite* sprite);

  /// @brief Method HasRadius, addr 0x33cad60, size 0x74, virtual false, abstract: false, final false
  inline bool HasRadius(float_t epsilon);

  /// @brief Method MakeSprite, addr 0x33ca580, size 0x6c4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeTextured, addr 0x33ca414, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeVectorTextured, addr 0x33cac44, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method RectIntersection, addr 0x33ca018, size 0x120, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetHashCode, addr 0x33cadd4, size 0x2a0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetTextNativeSettings, addr 0x33cb41c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeStyleBased, addr 0x33cb074, size 0x3a8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AdjustBackgroundSizeForBorders, addr 0x33c9144, size 0x454, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertBorderRadiusPercentToPoints, addr 0x33c8e6c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVisualElementRadii, addr 0x33c8ea8, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method Rectangle, addr 0x33c8c38, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Text, addr 0x33c8d38, size 0x134, virtual false, abstract: false, final false
