...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DoubleField*);
MARK_REF_T(::UnityEngine::UIElements::DoubleField_DoubleInput*);
MARK_REF_T(::UnityEngine::UIElements::DoubleField_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::DoubleField_UxmlTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DoubleField*, "UnityEngine.UIElements", "DoubleField");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d3adec, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d3ae54, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::DoubleField_UxmlTraits) == 0xc0, "Size mismatch!");
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6d3af78, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method StringToValue, addr 0x6d3b180, size 0xa0, virtual true, abstract: false, final false
  inline double_t StringToValue(::StringW str);

  /// @brief Method ValueToString, addr 0x6d3b124, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ValueToString(double_t v);

  /// @brief Method .ctor, addr 0x6d3abf8, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allowedCharacters, addr 0x6d3af1c, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW get_allowedCharacters();

  /// @brief Method get_parentDoubleField, addr 0x6d3aea0, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6d3acb4, size 0x5c, virtual true, abstract: false, final false
  inline void ApplyInputDeviceDelta(::UnityEngine::Vector3 delta, ::UnityEngine::UIElements::DeltaSpeed speed, double_t startValue);

  /// @brief Method CanTryParse, addr 0x6d3ac94, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method StringToValue, addr 0x6d3a98c, size 0xe0, virtual true, abstract: false, final false
  inline double_t StringToValue(::StringW str);

  /// @brief Method ValueToString, addr 0x6d3a8cc, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ValueToString(double_t v);

  /// @brief Method .ctor, addr 0x6d3aa6c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d3aa78, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method get_doubleInput, addr 0x6d3a83c, size 0x90, virtual false, abstract: false, final false
