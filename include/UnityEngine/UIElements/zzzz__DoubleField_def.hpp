...
/// @brief Method .ctor, addr 0x6be6f34, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6be6f9c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6be70c0, size 0x1ac, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6be72c8, size 0xa0, virtual true, abstract: false, final false
inline double_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6be726c, size 0x5c, virtual true, abstract: false, final false
inline ::StringW ValueToString(double_t  v) ;

/// @brief Method .ctor, addr 0x6be6d40, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x6be7064, size 0x5c, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentDoubleField, addr 0x6be6fe8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6be6dfc, size 0x5c, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, double_t  startValue) ;

/// @brief Method CanTryParse, addr 0x6be6ddc, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6be6ad4, size 0xe0, virtual true, abstract: false, final false
inline double_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6be6a14, size 0xc0, virtual true, abstract: false, final false
inline ::StringW ValueToString(double_t  v) ;

/// @brief Method .ctor, addr 0x6be6bb4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6be6bc0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method get_doubleInput, addr 0x6be6984, size 0x90, virtual false, abstract: false, final false
