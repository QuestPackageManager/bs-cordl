...
::cordl_internals::setStaticField<::UnityEngine::UIElements::ChangeEvent_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::ChangeEvent_1___c<T>*>::get>(std::forward<::UnityEngine::UIElements::ChangeEvent_1___c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::UIElements::ChangeEvent_1___c<T>* UnityEngine::UIElements::ChangeEvent_1___c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::ChangeEvent_1___c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::ChangeEvent_1___c<T>*>::get>();
}
template<typename T>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::ChangeEvent_1<T>*>::get(),
                        "get_previousValue",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
