...
public:
  ...
  /// @brief Method SetWantsMouseJumping, addr 0x6ae7c4c, size 0x4, virtual true, abstract: false, final false
  inline void SetWantsMouseJumping(int32_t value);

  /// @brief Method .ctor, addr 0x6ae7c50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
