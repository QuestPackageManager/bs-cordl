...
public:
  ...
  /// @brief Method DispatchEvent, addr 0x2e4cdd4, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2e4cfe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
