...
public:
  ...
  /// @brief Method CanDispatchEvent addr 0x2ce49ac size 0x78 virtual true final true
  inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method DispatchEvent addr 0x2ce4a24 size 0x200 virtual true final true
  ...
  /// @brief Method .ctor addr 0x2ce4c30 size 0x8 virtual false final false
  inline void _ctor();
