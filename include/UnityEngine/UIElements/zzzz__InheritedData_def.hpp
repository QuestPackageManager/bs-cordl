...
public:
  ...
  /// @brief Method Copy, addr 0x6b35090, size 0x10, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::InheritedData Copy();

  /// @brief Method CopyFrom, addr 0x6b350a0, size 0x8, virtual true, abstract: false, final true
  inline void CopyFrom(::ByRef<::UnityEngine::UIElements::InheritedData> other);

  /// @brief Method Equals, addr 0x6b3539c, size 0xa4, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b35350, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::InheritedData other);

  /// @brief Method GetHashCode, addr 0x6b35440, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b350a8, size 0x288, virtual false, abstract: false, final false
