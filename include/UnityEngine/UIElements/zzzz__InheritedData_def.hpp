...
public:
  ...
  /// @brief Method Copy, addr 0x4a81f7c, size 0x1c, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::InheritedData Copy();

  /// @brief Method CopyFrom, addr 0x4a81f98, size 0x14, virtual true, abstract: false, final true
  inline void CopyFrom(::ByRef<::UnityEngine::UIElements::InheritedData> other);

  /// @brief Method Equals, addr 0x4a82268, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4a8221c, size 0x4c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::InheritedData other);

  /// @brief Method GetHashCode, addr 0x4a82310, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4a81fac, size 0x248, virtual false, abstract: false, final false
