...
public:
  ...
  /// @brief Method AddHash, addr 0x4a140b8, size 0x94, virtual false, abstract: false, final false
  inline void AddHash(int32_t hash);

  /// @brief Method IsCandidate, addr 0x4a1414c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method PopElement, addr 0x4a143d4, size 0xf0, virtual false, abstract: false, final false
  inline void PopElement();

  /// @brief Method PushElement, addr 0x4a141a4, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a14038, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
