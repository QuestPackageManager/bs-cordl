...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::Experimental::ITransitionAnimations* (::UnityEngine::UIElements::IExperimentalFeatures::*)()>(&::UnityEngine::UIElements::IExperimentalFeatures::get_animation)> {
