...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x49a2ff0, size 0xec, virtual false, abstract: false, final false
  inline void ApplyStyles();

  /// @brief Method Dispose, addr 0x49a345c, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::VisualTreeStyleUpdater* New_ctor();

  /// @brief Method OnVersionChanged, addr 0x49a2b74, size 0xd0, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x49a2cc4, size 0x32c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x49a34bc, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_disposed, addr 0x49a3448, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_profilerMarker, addr 0x49a2b1c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x49a3450, size 0xc, virtual false, abstract: false, final false
