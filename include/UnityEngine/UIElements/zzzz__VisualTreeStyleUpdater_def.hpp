...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x3311548, size 0xe0, virtual false, abstract: false, final false
  inline void ApplyStyles();

  static inline ::UnityEngine::UIElements::VisualTreeStyleUpdater* New_ctor();

  /// @brief Method OnVersionChanged, addr 0x33110f4, size 0xc8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x331123c, size 0x30c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x33119ac, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_profilerMarker, addr 0x331109c, size 0x58, virtual true, abstract: false, final false
