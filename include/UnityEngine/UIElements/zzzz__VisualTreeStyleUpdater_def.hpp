...
public:
  ...
  /// @brief Method ApplyStyles, addr 0x3516284, size 0xe0, virtual false, abstract: false, final false
  inline void ApplyStyles();

  static inline ::UnityEngine::UIElements::VisualTreeStyleUpdater* New_ctor();

  /// @brief Method OnVersionChanged, addr 0x3515e30, size 0xc8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x3515f78, size 0x30c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x35166e8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_profilerMarker, addr 0x3515dd8, size 0x58, virtual true, abstract: false, final false
