...
public:
  // Declarations
  /// @brief Method ShouldSendNavigationMoveEvent, addr 0x6c4514c, size 0xc0, virtual false, abstract: false, final false
  static inline bool ShouldSendNavigationMoveEvent(::UnityEngine::UIElements::KeyDownEvent* e);

  /// @brief Method ShouldSendNavigationMoveEventRuntime, addr 0x6c454c0, size 0x44, virtual false, abstract: false, final false
