...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::EventCallback_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::EventCallback_2, "UnityEngine.UIElements", "EventCallback`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventCallback_2", modifiers: "&&", def_value: None, comment: None }]
