...
public:
  // Declarations
  /// @brief Method Init, addr 0x6c09638, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToNativeColorPage, addr 0x6c096d4, size 0x10, virtual false, abstract: false, final false
