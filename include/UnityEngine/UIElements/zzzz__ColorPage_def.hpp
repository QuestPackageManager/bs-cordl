...
public:
  // Declarations
  /// @brief Method Init, addr 0x4a4b754, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToNativeColorPage, addr 0x4a4b820, size 0x14, virtual false, abstract: false, final false
