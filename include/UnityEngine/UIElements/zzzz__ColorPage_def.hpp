...
public:
// Declarations
/// @brief Method Init, addr 0x6c7dab8, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method ToNativeColorPage, addr 0x6c7db54, size 0x10, virtual false, abstract: false, final false
