...
public:
  ...
  /// @brief Method .ctor, addr 0x35e6b14, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customStyle, addr 0x35db6cc, size 0x88, virtual false, abstract: false, final false
