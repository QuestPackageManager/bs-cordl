...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7266)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7266), inst: 1654 })}
...
public:
  ...
  /// @brief Method get_customStyle addr 0x2cdd100 size 0x88 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ce8548 size 0x6c virtual false final false
  inline void _ctor();
