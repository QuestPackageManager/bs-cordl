...
/// @brief Method .ctor, addr 0x6b6175c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_id, addr 0x6b61744, size 0x8, virtual false, abstract: false, final false
inline void set_id(int32_t  value) ;

/// @brief Method set_isAppliedToAllChildren, addr 0x6b61754, size 0x8, virtual false, abstract: false, final false
inline void set_isAppliedToAllChildren(bool  value) ;

/// @brief Method set_isExpanded, addr 0x6b6174c, size 0x8, virtual false, abstract: false, final false
