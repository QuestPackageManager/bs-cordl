...
public:
  ...
  /// @brief Method DetermineMoveDirection, addr 0x35e90d0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPooled, addr 0x35e913c, size 0xe0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::NavigationMoveEvent* GetPooled(::UnityEngine::Vector2 moveVector);

  /// @brief Method Init, addr 0x35e921c, size 0x88, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x35e92a4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_direction, addr 0x35e9124, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__NavigationMoveEvent__Direction get_direction();

  /// @brief Method set_direction, addr 0x35e912c, size 0x8, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UIElements::__NavigationMoveEvent__Direction value);

  /// @brief Method set_move, addr 0x35e9134, size 0x8, virtual false, abstract: false, final false
