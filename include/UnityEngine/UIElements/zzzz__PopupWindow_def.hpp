...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PopupWindow*);
MARK_REF_T(::UnityEngine::UIElements::PopupWindow_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::PopupWindow_UxmlTraits*);
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::PopupWindow_UxmlTraits) == 0xd0, "Size mismatch!");
