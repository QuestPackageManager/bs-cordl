...
public:
  ...
  /// @brief Method remove_itemsSourceChanged, addr 0x2e86d3c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_itemsSourceChanged(::System::Action* value);

  /// @brief Method add_itemIndexChanged, addr 0x2e86dd8, size 0xb0, virtual false, abstract: false, final false
  inline void add_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method remove_itemIndexChanged, addr 0x2e86e88, size 0xb0, virtual false, abstract: false, final false
  inline void remove_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method get_itemsSource, addr 0x2e86f38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* get_itemsSource();

  /// @brief Method set_itemsSource, addr 0x2e8639c, size 0x2c, virtual false, abstract: false, final false
  inline void set_itemsSource(::System::Collections::IList* value);

  /// @brief Method get_view, addr 0x2e86f5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_view();

  /// @brief Method SetView, addr 0x2e86f64, size 0x94, virtual false, abstract: false, final false
  inline void SetView(::UnityEngine::UIElements::BaseVerticalCollectionView* view);

  /// @brief Method GetItemCount, addr 0x2e86ff8, size 0xb0, virtual true, abstract: false, final false
  inline int32_t GetItemCount();

  /// @brief Method GetIdForIndex, addr 0x2e870a8, size 0x38, virtual true, abstract: false, final false
  inline int32_t GetIdForIndex(int32_t index);

  /// @brief Method GetItemForIndex, addr 0x2e870e0, size 0x13c, virtual true, abstract: false, final false
  inline ::System::Object* GetItemForIndex(int32_t index);

  /// @brief Method InvokeMakeItem, addr 0x2e8721c, size 0x38, virtual true, abstract: false, final false
  inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeBindItem, addr 0x2e85b88, size 0xc8, virtual true, abstract: false, final false
  inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method InvokeUnbindItem, addr 0x2e87254, size 0x24, virtual true, abstract: false, final false
  inline void InvokeUnbindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method InvokeDestroyItem, addr 0x2e87278, size 0x24, virtual true, abstract: false, final false
  inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method MakeItem, addr 0x2e8729c, size 0xdc, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* MakeItem();

  /// @brief Method BindItem, addr 0x2e87378, size 0x1d0, virtual true, abstract: false, final false
  inline void BindItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method UnbindItem, addr 0x2e87548, size 0x34, virtual true, abstract: false, final false
  inline void UnbindItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method DestroyItem, addr 0x2e8757c, size 0x34, virtual true, abstract: false, final false
  inline void DestroyItem(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method RaiseItemsSourceChanged, addr 0x2e86f40, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemsSourceChanged();

  /// @brief Method RaiseItemIndexChanged, addr 0x2e86694, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e86c98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
