...
public:
  ...
  /// @brief Method Dispose, addr 0x497cf80, size 0xc, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method GetIdForIndex, addr 0x497d050, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetIdForIndex(int32_t index);

  /// @brief Method GetIndexForId, addr 0x497d048, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetIndexForId(int32_t id);

  /// @brief Method GetItemForIndex, addr 0x497d058, size 0x13c, virtual true, abstract: false, final false
  inline ::System::Object* GetItemForIndex(int32_t index);

  /// @brief Method GetItemsCount, addr 0x497cf8c, size 0xb0, virtual true, abstract: false, final false
  inline int32_t GetItemsCount();

  /// @brief Method GetItemsMinCount, addr 0x497d03c, size 0xc, virtual true, abstract: false, final false
  inline int32_t GetItemsMinCount();

  /// @brief Method InvokeBindItem, addr 0x4977698, size 0xd4, virtual true, abstract: false, final false
  inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method InvokeDestroyItem, addr 0x4979e40, size 0x24, virtual true, abstract: false, final false
  inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeMakeItem, addr 0x497d194, size 0x3c, virtual true, abstract: false, final false
  inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeUnbindItem, addr 0x497d1d0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method PrepareView, addr 0x497cf7c, size 0x4, virtual true, abstract: false, final false
  inline void PrepareView();

  /// @brief Method RaiseItemIndexChanged, addr 0x4978550, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemIndexChanged(int32_t srcIndex, int32_t dstIndex);

  /// @brief Method RaiseItemsSourceChanged, addr 0x497ceb0, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseItemsSourceChanged();

  /// @brief Method SetItemsSourceWithoutNotify, addr 0x497c8d8, size 0x8, virtual false, abstract: false, final false
  inline void SetItemsSourceWithoutNotify(::System::Collections::IList* source);

  /// @brief Method SetView, addr 0x497ced4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4978f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_itemIndexChanged, addr 0x497cc98, size 0xb0, virtual false, abstract: false, final false
  inline void add_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method add_itemsSourceChanged, addr 0x497cb60, size 0x9c, virtual false, abstract: false, final false
  inline void add_itemsSourceChanged(::System::Action* value);

  /// @brief Method get_itemsSource, addr 0x497cdf8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::IList* get_itemsSource();

  /// @brief Method get_view, addr 0x497cecc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_view();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_itemIndexChanged, addr 0x497cd48, size 0xb0, virtual false, abstract: false, final false
  inline void remove_itemIndexChanged(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method remove_itemsSourceChanged, addr 0x497cbfc, size 0x9c, virtual false, abstract: false, final false
  inline void remove_itemsSourceChanged(::System::Action* value);

  /// @brief Method set_itemsSource, addr 0x497ce00, size 0xb0, virtual true, abstract: false, final false
