...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad9794, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::StringW id, ::StringW displayName, ::StringW description);

  /// @brief Method get_registry, addr 0x6ad978c, size 0x8, virtual false, abstract: false, final false
