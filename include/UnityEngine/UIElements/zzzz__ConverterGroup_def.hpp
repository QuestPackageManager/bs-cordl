...
/// @brief Field <registry>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__registry_k__BackingField, put=__cordl_internal_set__registry_k__BackingField)) ::UnityEngine::UIElements::TypeConverterRegistry  _registry_k__BackingField;
...
inline bool TryConvert(::ByRef<TSource>  source, ::ByRef<TDestination>  destination) ;
...
/// @brief Method .ctor, addr 0x6a6754c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  id, ::StringW  displayName, ::StringW  description) ;

/// @brief Method get_registry, addr 0x6a67544, size 0x8, virtual false, abstract: false, final false
