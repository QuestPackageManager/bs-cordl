...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutFlexDirection, "UnityEngine.UIElements.Layout", "LayoutFlexDirection");
// Dependencies
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutFlexDirection) == 0x4, "Size mismatch!");
