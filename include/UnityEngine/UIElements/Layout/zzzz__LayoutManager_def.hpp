...
public:
  ...
  /// @brief Method <Initialize>b__7_0, addr 0x6ba6ea4, size 0x78, virtual false, abstract: false, final false
  inline void _Initialize_b__7_0(::System::Object* _, ::System::EventArgs* __);

  /// @brief Method .ctor, addr 0x6ba6ea0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateConfig, addr 0x6ba5e54, size 0xc4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutConfig CreateConfig();

  /// @brief Method CreateNode, addr 0x6ba61a0, size 0x34, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutNode CreateNode();

  /// @brief Method CreateNodeInternal, addr 0x6ba61d4, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyConfig, addr 0x6ba6070, size 0x38, virtual false, abstract: false, final false
  inline void DestroyConfig(::ByRef<::UnityEngine::UIElements::Layout::LayoutConfig> config);

  /// @brief Method DestroyNode, addr 0x6ba67e4, size 0x1e8, virtual false, abstract: false, final false
  inline void DestroyNode(::ByRef<::UnityEngine::UIElements::Layout::LayoutNode> node);

  /// @brief Method Dispose, addr 0x6ba5938, size 0x134, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method FreeNode, addr 0x6ba66bc, size 0x128, virtual false, abstract: false, final false
  inline void FreeNode(::UnityEngine::UIElements::Layout::LayoutHandle handle);

  /// @brief Method GetAccess, addr 0x6ba6018, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutDataAccess GetAccess();

  /// @brief Method GetBaselineFunction, addr 0x6ba6da8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultConfig, addr 0x6ba6044, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutConfig GetDefaultConfig();

  /// @brief Method GetManager, addr 0x6ba5a6c, size 0xdc, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Layout::LayoutManager* GetManager(int32_t index);

  /// @brief Method GetMeasureFunction, addr 0x6ba6a1c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOwner, addr 0x6ba6b74, size 0x128, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetOwner(::UnityEngine::UIElements::Layout::LayoutHandle handle);

  /// @brief Method Initialize, addr 0x6ba52f0, size 0x1a8, virtual false, abstract: false, final false
  static inline void Initialize();

  static inline ::UnityEngine::UIElements::Layout::LayoutManager* New_ctor(::Unity::Collections::Allocator allocator);

  /// @brief Method SetMeasureFunction, addr 0x6ba6ac0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOwner, addr 0x6ba6c9c, size 0x10c, virtual false, abstract: false, final false
  inline void SetOwner(::UnityEngine::UIElements::Layout::LayoutHandle handle, ::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method Shutdown, addr 0x6ba58a8, size 0x90, virtual false, abstract: false, final false
  static inline void Shutdown();

  /// @brief Method TryFreeNodes, addr 0x6ba642c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba5498, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SharedManager, addr 0x6ba5204, size 0x5c, virtual false, abstract: false, final false
