...
public:
// Declarations
/// @brief Method Invoke, addr 0x6b32fa8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b32f28, size 0x80, virtual false, abstract: false, final false
