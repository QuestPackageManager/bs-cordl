...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LayoutBaselineFunction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LayoutBaselineFunction(LayoutBaselineFunction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LayoutBaselineFunction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LayoutBaselineFunction(LayoutBaselineFunctionconst&) = delete;
