...
/// @brief Method .ctor, addr 0x6b32c80, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_Handle, addr 0x6b32c94, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Layout::LayoutHandle get_Handle() ;

/// @brief Method get_PointScaleFactor, addr 0x6b32c9c, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<float_t> get_PointScaleFactor() ;

/// @brief Method get_Undefined, addr 0x6b32c68, size 0x10, virtual false, abstract: false, final false
