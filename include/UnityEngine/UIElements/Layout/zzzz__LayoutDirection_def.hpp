...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutDirection, "UnityEngine.UIElements.Layout", "LayoutDirection");
// Dependencies
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutDirection) == 0x4, "Size mismatch!");
