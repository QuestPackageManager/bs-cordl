...
public:
  ...
  /// @brief Method InvokeBaselineFunction, addr 0x6ba9980, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeMeasureFunction, addr 0x6ba96ec, size 0x294, virtual false, abstract: false, final false
