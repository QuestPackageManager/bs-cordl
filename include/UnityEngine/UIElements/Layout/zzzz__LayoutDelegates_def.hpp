...
/// @brief Field s_InvokeBaselineDelegate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_InvokeBaselineDelegate, put=setStaticF_s_InvokeBaselineDelegate)) ::UnityEngine::UIElements::Layout::InvokeBaselineFunctionDelegate*  s_InvokeBaselineDelegate;
...
/// @brief Method InvokeBaselineFunction, addr 0x6b37738, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method InvokeMeasureFunction, addr 0x6b374a4, size 0x294, virtual false, abstract: false, final false
static inline void InvokeMeasureFunction(::ByRef<::UnityEngine::UIElements::Layout::LayoutNode>  node, float_t  width, ::UnityEngine::UIElements::Layout::LayoutMeasureMode  widthMode, float_t  height, ::UnityEngine::UIElements::Layout::LayoutMeasureMode  heightMode, ::ByRef<::System::IntPtr>  exception, ::ByRef<::UnityEngine::UIElements::Layout::LayoutSize>  result) ;
