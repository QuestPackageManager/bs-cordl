...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Layout::LayoutDelegates*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutDelegates*, "UnityEngine.UIElements.Layout", "LayoutDelegates");
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutDelegates) == 0x10, "Size mismatch!");
