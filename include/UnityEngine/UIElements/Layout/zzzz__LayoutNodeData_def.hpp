...
/// @brief Method get_HasNewLayout, addr 0x6b367a4, size 0xc, virtual false, abstract: false, final false
inline bool get_HasNewLayout() ;

/// @brief Method get_IsDirty, addr 0x6b366a8, size 0xc, virtual false, abstract: false, final false
inline bool get_IsDirty() ;

/// @brief Method set_HasNewLayout, addr 0x6b36834, size 0x20, virtual false, abstract: false, final false
inline void set_HasNewLayout(bool  value) ;

/// @brief Method set_IsDirty, addr 0x6b36728, size 0x10, virtual false, abstract: false, final false
