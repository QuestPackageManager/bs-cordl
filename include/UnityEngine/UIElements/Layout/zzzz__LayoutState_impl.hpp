...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::Layout::LayoutState (*)()>(&::UnityEngine::UIElements::Layout::LayoutState::get_Default)> {
  ...
  constexpr static std::size_t addrs = 0x6d03f58;
...
// Ctor Parameters [CppParam { name: "measureFunctionCallback", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "baselineFunctionCallback", ty:
// "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "unusedExceptionPointer", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "depth", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "currentGenerationCount", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "error", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }]
