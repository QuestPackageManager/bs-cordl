...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutUnit, "UnityEngine.UIElements.Layout", "LayoutUnit");
// Dependencies
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutUnit) == 0x4, "Size mismatch!");
