...
/// @brief Field DimensionValuesAutoUnit, offset 0xffffffff, size 0x10 
 __declspec(property(get=getStaticF_DimensionValuesAutoUnit, put=setStaticF_DimensionValuesAutoUnit)) ::UnityEngine::UIElements::Layout::FixedBuffer2_1<::UnityEngine::UIElements::Layout::LayoutValue>  DimensionValuesAutoUnit;

/// @brief Field DimensionValuesUnit, offset 0xffffffff, size 0x10 
 __declspec(property(get=getStaticF_DimensionValuesUnit, put=setStaticF_DimensionValuesUnit)) ::UnityEngine::UIElements::Layout::FixedBuffer2_1<::UnityEngine::UIElements::Layout::LayoutValue>  DimensionValuesUnit;

/// @brief Field EdgeValuesUnit, offset 0xffffffff, size 0x48 
 __declspec(property(get=getStaticF_EdgeValuesUnit, put=setStaticF_EdgeValuesUnit)) ::UnityEngine::UIElements::Layout::FixedBuffer9_1<::UnityEngine::UIElements::Layout::LayoutValue>  EdgeValuesUnit;
