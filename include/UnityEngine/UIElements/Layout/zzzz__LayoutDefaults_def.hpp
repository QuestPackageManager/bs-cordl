...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutDefaults, "UnityEngine.UIElements.Layout", "LayoutDefaults");
...
public:
  ...
  __declspec(property(get = getStaticF_DimensionValues, put = setStaticF_DimensionValues)) ::ArrayW<float_t> DimensionValues;
  ...
  static inline ::ArrayW<float_t> getStaticF_DimensionValues();
  ...
  static inline void setStaticF_DimensionValues(::ArrayW<float_t> value);
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutDefaults) == 0x1, "Size mismatch!");
