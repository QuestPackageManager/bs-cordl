...
// Ctor Parameters [CppParam { name: "NextCachedMeasurementsIndex", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "cachedMeasurements", ty: "::UnityEngine::UIElements::Layout::FixedBuffer16_1<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement>", modifiers: "", def_value: None }, CppParam { name: "CachedLayout", ty: "::UnityEngine::UIElements::Layout::LayoutCachedMeasurement", modifiers: "", def_value: None }]
constexpr LayoutCacheData(uint32_t  NextCachedMeasurementsIndex, ::UnityEngine::UIElements::Layout::FixedBuffer16_1<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement>  cachedMeasurements, ::UnityEngine::UIElements::Layout::LayoutCachedMeasurement  CachedLayout) noexcept;
