...
public:
  ...
  /// @brief Method UnityEngine.UIElements.Layout.ILayoutProcessor.CalculateLayout, addr 0x6d03fc4, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d02548, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LayoutProcessorNative", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LayoutProcessorNative(LayoutProcessorNative&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LayoutProcessorNative", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LayoutProcessorNative(LayoutProcessorNativeconst&) = delete;
