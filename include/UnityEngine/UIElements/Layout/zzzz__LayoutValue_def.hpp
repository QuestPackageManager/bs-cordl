...
public:
  ...
  /// @brief Method Auto, addr 0x6ba87c8, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Layout::LayoutValue Auto();

  /// @brief Method Equals, addr 0x6baac08, size 0xc8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6baaba4, size 0x64, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::UIElements::Layout::LayoutValue other);

  /// @brief Method GetHashCode, addr 0x6baacd0, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Percent, addr 0x6ba8854, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Layout::LayoutValue Percent(float_t value);

  /// @brief Method Point, addr 0x6ba87d4, size 0x20, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Layout::LayoutValue Point(float_t value);

  /// @brief Method Undefined, addr 0x6ba8874, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Layout::LayoutValue Undefined();

  /// @brief Method get_Unit, addr 0x6baab94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutUnit get_Unit();

  /// @brief Method get_Value, addr 0x6baab9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Value();

  /// @brief Method op_Implicit, addr 0x6baacf4, size 0x20, virtual false, abstract: false, final false
