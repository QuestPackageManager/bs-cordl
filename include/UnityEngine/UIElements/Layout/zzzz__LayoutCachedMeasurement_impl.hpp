...
::cordl_internals::setStaticField<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement, "Default", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement>::get>(std::forward<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement, "Default", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::LayoutCachedMeasurement>::get>();
}
// Ctor Parameters [CppParam { name: "AvailableWidth", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "AvailableHeight", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ParentWidth", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ParentHeight", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "WidthMeasureMode", ty: "::UnityEngine::UIElements::Layout::LayoutMeasureMode", modifiers: "", def_value: Some("{}") }, CppParam { name: "HeightMeasureMode", ty: "::UnityEngine::UIElements::Layout::LayoutMeasureMode", modifiers: "", def_value: Some("{}") }, CppParam { name: "ComputedWidth", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ComputedHeight", ty: "float_t", modifiers: "", def_value: Some("{}") }]
