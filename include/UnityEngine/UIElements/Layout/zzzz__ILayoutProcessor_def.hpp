...
public:
  // Declarations
  /// @brief Method CalculateLayout, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILayoutProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILayoutProcessor(ILayoutProcessorconst&) = delete;
