...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::Layout::LayoutComputedData (*)()>(
  ...
  constexpr static std::size_t addrs = 0x6ba6578;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t* (::UnityEngine::UIElements::Layout::LayoutComputedData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x6ba9dec;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::LayoutComputedData>::get(),
                                                                               "get_MarginBuffer", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t* (::UnityEngine::UIElements::Layout::LayoutComputedData::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6ba9df4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::LayoutComputedData>::get(),
                                                                               "get_BorderBuffer", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t* (::UnityEngine::UIElements::Layout::LayoutComputedData::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6ba9dfc;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::LayoutComputedData>::get(),
                                                                               "get_PaddingBuffer", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
constexpr ::UnityEngine::UIElements::Layout::LayoutComputedData::LayoutComputedData(
    ...
    ::UnityEngine::UIElements::Layout::LayoutComputedData__Padding_e__FixedBuffer Padding, ::UnityEngine::UIElements::Layout::LayoutDirection Direction, uint32_t ComputedFlexBasisGeneration,
    float_t ComputedFlexBasis, bool HadOverflow, uint32_t GenerationCount, ::UnityEngine::UIElements::Layout::LayoutDirection LastParentDirection, float_t LastPointScaleFactor,
