...
public:
  ...
  /// @brief Method Dispose, addr 0x6baa37c, size 0xd8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetComponentDataPtr, addr 0x6baa4b8, size 0x34, virtual false, abstract: false, final false
  inline uint8_t* GetComponentDataPtr(int32_t index);

  /// @brief Method ResizeCapacity, addr 0x6baa884, size 0x1c8, virtual false, abstract: false, final false
  inline void ResizeCapacity(int32_t capacity);

  /// @brief Method .ctor, addr 0x6baa204, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Allocate, addr 0x6baa4ec, size 0x1e4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Layout::LayoutHandle Allocate(uint8_t* data, int32_t count);

  /// @brief Method Dispose, addr 0x6ba5f18, size 0x100, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Exists, addr 0x6baa454, size 0x40, virtual false, abstract: false, final false
  inline bool Exists(::ByRef<::UnityEngine::UIElements::Layout::LayoutHandle> handle);

  /// @brief Method Free, addr 0x6ba60a8, size 0xf8, virtual false, abstract: false, final false
  inline void Free(::ByRef<::UnityEngine::UIElements::Layout::LayoutHandle> handle);

  /// @brief Method GetComponentDataPtr, addr 0x6baa494, size 0x24, virtual false, abstract: false, final false
  inline void* GetComponentDataPtr(int32_t index, int32_t componentIndex);

  /// @brief Method GetNextFreeIndex, addr 0x6baa6d0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method IncreaseCapacity, addr 0x6baa6e4, size 0x3c, virtual false, abstract: false, final false
  inline void IncreaseCapacity();

  /// @brief Method ResizeArray, addr 0x6baa738, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizeCapacity, addr 0x6baa21c, size 0x160, virtual false, abstract: false, final false
  inline void ResizeCapacity(int32_t capacity);

  /// @brief Method SetNextFreeIndex, addr 0x6baa720, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba5b48, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValid, addr 0x6ba9e04, size 0x10, virtual false, abstract: false, final false
