...
/// @brief Method Dispose, addr 0x6b38134, size 0xd8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetComponentDataPtr, addr 0x6b38270, size 0x34, virtual false, abstract: false, final false
inline uint8_t* GetComponentDataPtr(int32_t  index) ;

/// @brief Method ResizeCapacity, addr 0x6b3863c, size 0x1c8, virtual false, abstract: false, final false
inline void ResizeCapacity(int32_t  capacity) ;

/// @brief Method .ctor, addr 0x6b37fbc, size 0x18, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Allocator", ty: "::Unity::Collections::Allocator", modifiers: "", def_value: None }, CppParam { name: "Size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ComponentCountPerChunk", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ChunkCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Chunks", ty: "::UnityEngine::UIElements::Layout::LayoutDataStore_Chunk*", modifiers: "", def_value: None }]
constexpr LayoutDataStore_ComponentDataStore(::Unity::Collections::Allocator  Allocator, int32_t  Size, int32_t  ComponentCountPerChunk, int32_t  ChunkCount, ::UnityEngine::UIElements::Layout::LayoutDataStore_Chunk*  m_Chunks) noexcept;
...
inline ::UnityEngine::UIElements::Layout::LayoutHandle Allocate(::ByRef<T0>  component0) ;
...
/// @brief Method Allocate, addr 0x6b382a4, size 0x1e4, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Layout::LayoutHandle Allocate(uint8_t*  data, int32_t  count) ;

/// @brief Method Dispose, addr 0x6b33cd0, size 0x100, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Exists, addr 0x6b3820c, size 0x40, virtual false, abstract: false, final false
inline bool Exists(::ByRef<::UnityEngine::UIElements::Layout::LayoutHandle>  handle) ;

/// @brief Method Free, addr 0x6b33e60, size 0xf8, virtual false, abstract: false, final false
inline void Free(::ByRef<::UnityEngine::UIElements::Layout::LayoutHandle>  handle) ;

/// @brief Method GetComponentDataPtr, addr 0x6b3824c, size 0x24, virtual false, abstract: false, final false
inline void* GetComponentDataPtr(int32_t  index, int32_t  componentIndex) ;

/// @brief Method GetNextFreeIndex, addr 0x6b38488, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method IncreaseCapacity, addr 0x6b3849c, size 0x3c, virtual false, abstract: false, final false
inline void IncreaseCapacity() ;

/// @brief Method ResizeArray, addr 0x6b384f0, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method ResizeCapacity, addr 0x6b37fd4, size 0x160, virtual false, abstract: false, final false
inline void ResizeCapacity(int32_t  capacity) ;

/// @brief Method SetNextFreeIndex, addr 0x6b384d8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b33900, size 0x30c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::UIElements::Layout::ComponentType,::Array<::UnityEngine::UIElements::Layout::ComponentType>*>  components, int32_t  initialCapacity, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method get_IsValid, addr 0x6b37bbc, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Allocator", ty: "::Unity::Collections::Allocator", modifiers: "", def_value: None }, CppParam { name: "m_Data", ty: "::UnityEngine::UIElements::Layout::LayoutDataStore_Data*", modifiers: "", def_value: None }]
