...
// Ctor Parameters [CppParam { name: "AvailableWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "AvailableHeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "ParentWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "ParentHeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "WidthMeasureMode", ty: "::UnityEngine::UIElements::Layout::LayoutMeasureMode", modifiers: "", def_value: None }, CppParam { name: "HeightMeasureMode", ty: "::UnityEngine::UIElements::Layout::LayoutMeasureMode", modifiers: "", def_value: None }, CppParam { name: "ComputedWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "ComputedHeight", ty: "float_t", modifiers: "", def_value: None }]
