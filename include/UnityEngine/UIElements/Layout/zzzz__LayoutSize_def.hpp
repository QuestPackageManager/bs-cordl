...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Layout::LayoutSize, "UnityEngine.UIElements.Layout", "LayoutSize");
// Dependencies
namespace UnityEngine::UIElements::Layout {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6d005bc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Layout::LayoutSize) == 0x8, "Size mismatch!");
