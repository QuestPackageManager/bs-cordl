...
public:
  ...
  /// @brief Method GetBaselineFunction, addr 0x6baa18c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetComputedData, addr 0x6ba9ed8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConfigData, addr 0x6ba9f3c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMeasureFunction, addr 0x6ba9f9c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNodeData, addr 0x6ba9e14, size 0x60, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::UIElements::Layout::LayoutNodeData> GetNodeData(::UnityEngine::UIElements::Layout::LayoutHandle handle);

  /// @brief Method GetOwner, addr 0x6baa094, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetOwner(::UnityEngine::UIElements::Layout::LayoutHandle handle);

  /// @brief Method GetStyleData, addr 0x6ba9e74, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMeasureFunction, addr 0x6baa014, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOwner, addr 0x6baa10c, size 0x80, virtual false, abstract: false, final false
  inline void SetOwner(::UnityEngine::UIElements::Layout::LayoutHandle handle, ::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method .ctor, addr 0x6ba6034, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValid, addr 0x6ba69ec, size 0x20, virtual false, abstract: false, final false
