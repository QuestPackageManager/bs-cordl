...
/// @brief Method GetBaselineFunction, addr 0x6b37f44, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetComputedData, addr 0x6b37c90, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method GetConfigData, addr 0x6b37cf4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetMeasureFunction, addr 0x6b37d54, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetNodeData, addr 0x6b37bcc, size 0x60, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::UIElements::Layout::LayoutNodeData> GetNodeData(::UnityEngine::UIElements::Layout::LayoutHandle  handle) ;

/// @brief Method GetOwner, addr 0x6b37e4c, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetOwner(::UnityEngine::UIElements::Layout::LayoutHandle  handle) ;

/// @brief Method GetStyleData, addr 0x6b37c2c, size 0x64, virtual false, abstract: false, final false
...
template<typename T>
inline ::ByRef<T> GetTypedConfigDataRef(::UnityEngine::UIElements::Layout::LayoutHandle  handle, ::UnityEngine::UIElements::Layout::LayoutConfigDataType  type) ;

/// @brief Method GetTypedNodeDataRef, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline ::ByRef<T> GetTypedNodeDataRef(::UnityEngine::UIElements::Layout::LayoutHandle  handle, ::UnityEngine::UIElements::Layout::LayoutNodeDataType  type) ;

/// @brief Method SetMeasureFunction, addr 0x6b37dcc, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method SetOwner, addr 0x6b37ec4, size 0x80, virtual false, abstract: false, final false
inline void SetOwner(::UnityEngine::UIElements::Layout::LayoutHandle  handle, ::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method .ctor, addr 0x6b33dec, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_IsValid, addr 0x6b347a4, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Manager", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Nodes", ty: "::UnityEngine::UIElements::Layout::LayoutDataStore", modifiers: "", def_value: None }, CppParam { name: "m_Configs", ty: "::UnityEngine::UIElements::Layout::LayoutDataStore", modifiers: "", def_value: None }]
