...
template<typename T>
constexpr ::System::Collections::Generic::List_1<::ArrayW<T,::Array<T>*>>*& UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>::__cordl_internal_get_m_Chunks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr void UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>::__cordl_internal_set_m_Chunks(::System::Collections::Generic::List_1<::ArrayW<T,::Array<T>*>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
inline void UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>*>::get(),
                        ".ctor",
...
template<typename T>
inline void UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>::UpdateValue(::ByRef<int32_t>  index, T  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>*>::get(),
                        "UpdateValue",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<int32_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, index, value);
}
template<typename T>
inline ::UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>* UnityEngine::UIElements::Layout::ManagedObjectStore_1<T>::New_ctor()  {
