...
public:
  ...
  /// @brief Method .ctor, addr 0x6c0c500, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c0c568, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0c6a0, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitLabel, addr 0x6c0c1ec, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method OnOptionAttachToPanel, addr 0x6c0c104, size 0x74, virtual false, abstract: false, final false
  inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnOptionDetachFromPanel, addr 0x6c0c178, size 0x74, virtual false, abstract: false, final false
  inline void OnOptionDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method SetValueWithoutNotify, addr 0x6c0c2bc, size 0x1c, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(bool newValue);

  /// @brief Method ToggleValue, addr 0x6c0c26c, size 0x40, virtual true, abstract: false, final false
  inline void ToggleValue();

  /// @brief Method UnityEngine.UIElements.IGroupBoxOption.SetSelected, addr 0x6c0c2ac, size 0x10, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBoxOption_SetSelected(bool selected);

  /// @brief Method UpdateCheckmark, addr 0x6c0bd48, size 0xfc, virtual false, abstract: false, final false
  inline void UpdateCheckmark();

  /// @brief Method UpdateMixedValueContent, addr 0x6c0c2d8, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0be44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c0be4c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x6c0bc18, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method set_value, addr 0x6c0bc5c, size 0xec, virtual true, abstract: false, final false
