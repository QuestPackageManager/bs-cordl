...
public:
  ...
  /// @brief Method .ctor, addr 0x4a00a48, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a00a90, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a00bac, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitLabel, addr 0x4a00744, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnOptionAttachToPanel, addr 0x4a0066c, size 0x6c, virtual false, abstract: false, final false
  inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnOptionDetachFromPanel, addr 0x4a006d8, size 0x6c, virtual false, abstract: false, final false
  inline void OnOptionDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method SetValueWithoutNotify, addr 0x4a00814, size 0x20, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(bool newValue);

  /// @brief Method ToggleValue, addr 0x4a007c0, size 0x40, virtual true, abstract: false, final false
  inline void ToggleValue();

  /// @brief Method UnityEngine.UIElements.IGroupBoxOption.SetSelected, addr 0x4a00800, size 0x14, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBoxOption_SetSelected(bool selected);

  /// @brief Method UpdateCheckmark, addr 0x4a002f0, size 0xf4, virtual false, abstract: false, final false
  inline void UpdateCheckmark();

  /// @brief Method UpdateMixedValueContent, addr 0x4a00834, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a003e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4a003ec, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x4a001c4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_value, addr 0x4a0020c, size 0xe4, virtual true, abstract: false, final false
