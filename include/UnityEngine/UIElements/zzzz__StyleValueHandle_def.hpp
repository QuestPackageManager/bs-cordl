...
public:
  ...
  /// @brief Method get_valueType, addr 0x4a817f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType get_valueType();

  /// @brief Method set_valueType, addr 0x4a8f058, size 0x8, virtual false, abstract: false, final false
