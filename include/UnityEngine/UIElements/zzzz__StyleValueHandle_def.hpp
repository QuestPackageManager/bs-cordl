...
public:
  ...
  /// @brief Method get_valueType, addr 0x33b6ad8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType get_valueType();

  /// @brief Method set_valueType, addr 0x33b76a0, size 0x8, virtual false, abstract: false, final false
