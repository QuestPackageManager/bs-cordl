...
public:
  ...
  /// @brief Method get_valueType, addr 0x4a8dc30, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleValueType get_valueType();

  /// @brief Method set_valueType, addr 0x4a9b490, size 0x8, virtual false, abstract: false, final false
