...
/// @brief Method <.cctor>b__0_0, addr 0x6bd7444, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::NavigationSubmitEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x6bd7440, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6bd73a0, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::NavigationSubmitEvent, 0x70>, "Size mismatch!");
