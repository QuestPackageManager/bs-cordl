...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6d9f0bc, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::NavigationSubmitEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6d9f0b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d9f018, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
