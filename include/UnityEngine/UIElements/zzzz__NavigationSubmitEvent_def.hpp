...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7334), inst: 4604 }), TypeDefinitionIndex(TypeDefinitionIndex(7334))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2ceaed0 size 0x48 virtual false final false
  inline void _ctor();
