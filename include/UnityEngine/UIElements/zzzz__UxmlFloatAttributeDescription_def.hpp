...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x6b65774, size 0x8, virtual false, abstract: false, final false
  inline float_t _GetValueFromBag_b__3_0(::StringW s, float_t f);

  /// @brief Method .ctor, addr 0x6b65770, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToFloat, addr 0x6b65684, size 0x98, virtual false, abstract: false, final false
  static inline float_t ConvertValueToFloat(::StringW v, float_t defaultValue);

  /// @brief Method GetValueFromBag, addr 0x6b654ec, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b6544c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
