...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerDownEvent*);
MARK_REF_T(::UnityEngine::UIElements::PointerDownEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerDownEvent*, "UnityEngine.UIElements", "PointerDownEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::PointerDownEvent___c*, "UnityEngine.UIElements", "PointerDownEvent/<>c");
...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6da09f0, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PointerDownEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6da09ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::PointerDownEvent___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x6da053c, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x6da0590, size 0xa8, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerDownEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x6da07b8, size 0x1e0, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method PreDispatch, addr 0x6da068c, size 0x12c, virtual true, abstract: false, final false
  inline void PreDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x6da0638, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
