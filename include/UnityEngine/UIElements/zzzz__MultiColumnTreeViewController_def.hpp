...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnTreeViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnTreeViewController(MultiColumnTreeViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnTreeViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnTreeViewController(MultiColumnTreeViewControllerconst&) = delete;
