...
/// @brief Method BindItem, addr 0x6a89ad4, size 0x8c, virtual true, abstract: false, final false
inline void BindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method DestroyItem, addr 0x6a89b78, size 0x18, virtual true, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x6a89bb0, size 0x30, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method InvokeMakeItem, addr 0x6a89628, size 0xd8, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method MakeItem, addr 0x6a89abc, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method PreRefresh, addr 0x6a895f8, size 0x30, virtual true, abstract: false, final false
inline void PreRefresh() ;

/// @brief Method PrepareView, addr 0x6a89b90, size 0x20, virtual true, abstract: false, final false
inline void PrepareView() ;

/// @brief Method UnbindItem, addr 0x6a89b60, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a89544, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method get_columnController, addr 0x6a8953c, size 0x8, virtual false, abstract: false, final false
