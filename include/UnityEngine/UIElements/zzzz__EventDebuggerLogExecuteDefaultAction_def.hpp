...
public:
  ...
  /// @brief Method Dispose, addr 0x4a286ec, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x4a286e8, size 0x4, virtual false, abstract: false, final false
