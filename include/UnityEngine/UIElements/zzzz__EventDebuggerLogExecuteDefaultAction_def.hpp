...
public:
  ...
  /// @brief Method Dispose, addr 0x35d83a8, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x35d83a4, size 0x4, virtual false, abstract: false, final false
