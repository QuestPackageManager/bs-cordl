...
public:
  ...
  /// @brief Method GetStyleBackground, addr 0x6ac50ec, size 0x268, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleBackground GetStyleBackground(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleBackgroundPosition, addr 0x6ac5424, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleBackgroundRepeat, addr 0x6ac549c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleColor, addr 0x6ac505c, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleColor GetStyleColor(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleFloat, addr 0x6ac4f6c, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat GetStyleFloat(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleFont, addr 0x6ac5514, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFont GetStyleFont(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleFontDefinition, addr 0x6ac5604, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStyleInt, addr 0x6ac4fd8, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleInt GetStyleInt(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleLength, addr 0x6ac4d38, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStyleValue, addr 0x6ac56d8, size 0x214, virtual false, abstract: false, final false
  inline void SetStyleValue(::UnityEngine::UIElements::StyleSheets::StyleValue value);

  /// @brief Method TryGetStyleValue, addr 0x6ac4da4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ac58ec, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
