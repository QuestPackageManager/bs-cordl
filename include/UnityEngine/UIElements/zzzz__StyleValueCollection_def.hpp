...
public:
  ...
  /// @brief Method GetStyleFloat, addr 0x2fd9090, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat GetStyleFloat(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleInt, addr 0x2fd90e8, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleInt GetStyleInt(::UnityEngine::UIElements::StyleSheets::StylePropertyId id);

  /// @brief Method GetStyleLength, addr 0x2fd8e5c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetStyleValue, addr 0x2fd916c, size 0x1fc, virtual false, abstract: false, final false
  inline void SetStyleValue(::UnityEngine::UIElements::StyleSheets::StyleValue value);

  /// @brief Method TryGetStyleValue, addr 0x2fd8ed0, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fd9368, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
