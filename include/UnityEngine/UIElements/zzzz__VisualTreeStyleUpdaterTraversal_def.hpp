...
public:
  ...
  /// @brief Method <ProcessMatchedRules>b__28_0, addr 0x6b77be4, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b77be0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddChangedElement, addr 0x6b75c64, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CancelAnimationsWithNoTransitionProperty, addr 0x6b760e0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x6b76030, size 0xb0, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ForceUpdateTransitions, addr 0x6b778c4, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method OnProcessMatchResult, addr 0x6b76ba4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareTraversal, addr 0x6b7639c, size 0xc, virtual false, abstract: false, final false
  inline void PrepareTraversal(::UnityEngine::UIElements::BaseVisualElementPanel* panel, float_t pixelsPerPoint);

  /// @brief Method ProcessMatchedRules, addr 0x6b77200, size 0x5f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMatchedVariables, addr 0x6b77aec, size 0xa0, virtual false, abstract: false, final false
  inline void ProcessMatchedVariables(::UnityEngine::UIElements::StyleSheet* sheet, ::UnityEngine::UIElements::StyleRule* rule);

  /// @brief Method ProcessTransitions, addr 0x6b777f0, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateToChildren, addr 0x6b76a28, size 0xe0, virtual false, abstract: false, final false
  inline void PropagateToChildren(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method PropagateToParents, addr 0x6b76b08, size 0x9c, virtual false, abstract: false, final false
  inline void PropagateToParents(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ShouldSkipElement, addr 0x6b77170, size 0x90, virtual false, abstract: false, final false
  inline bool ShouldSkipElement(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method TraverseRecursive, addr 0x6b76bd0, size 0x5a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b76470, size 0x208, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentPanel, addr 0x6b76a18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_currentPanel();

  /// @brief Method get_currentPixelsPerPoint, addr 0x6b76a08, size 0x8, virtual false, abstract: false, final false
  inline float_t get_currentPixelsPerPoint();

  /// @brief Method set_currentPanel, addr 0x6b76a20, size 0x8, virtual false, abstract: false, final false
  inline void set_currentPanel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method set_currentPixelsPerPoint, addr 0x6b76a10, size 0x8, virtual false, abstract: false, final false
