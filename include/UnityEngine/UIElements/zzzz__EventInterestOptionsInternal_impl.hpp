...
// Ctor Parameters []
constexpr ::UnityEngine::UIElements::EventInterestOptionsInternal::EventInterestOptionsInternal()   {
}
constexpr ::UnityEngine::UIElements::EventInterestOptionsInternal  UnityEngine::UIElements::EventInterestOptionsInternal::TriggeredByOS{static_cast<int32_t>(0x6806e)};
