...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DynamicAtlasFilters, "UnityEngine.UIElements", "DynamicAtlasFilters");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::DynamicAtlasFilters) == 0x4, "Size mismatch!");
