...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::EventCallbackListPool*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EventCallbackListPool*, "UnityEngine.UIElements", "EventCallbackListPool");
...
public:
  ...
  /// @brief Method Get, addr 0x6d98a28, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6d98cac, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d98d54, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventCallbackListPool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventCallbackListPool(EventCallbackListPool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventCallbackListPool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventCallbackListPool(EventCallbackListPoolconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::EventCallbackListPool) == 0x18, "Size mismatch!");
