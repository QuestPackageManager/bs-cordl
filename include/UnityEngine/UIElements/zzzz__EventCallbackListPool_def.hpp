...
public:
  ...
  /// @brief Method Get, addr 0x3396ef8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x339725c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339732c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
