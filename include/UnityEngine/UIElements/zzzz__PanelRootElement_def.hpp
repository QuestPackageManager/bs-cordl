...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PanelRootElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PanelRootElement(PanelRootElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PanelRootElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PanelRootElement(PanelRootElementconst&) = delete;
