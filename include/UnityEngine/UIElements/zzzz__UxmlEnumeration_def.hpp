...
public:
  ...
  /// @brief Method Equals, addr 0x358da98, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x358dbe4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_values, addr 0x358da34, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_values();

  /// @brief Method set_values, addr 0x358da3c, size 0x5c, virtual false, abstract: false, final false
