...
public:
  ...
  /// @brief Method Equals, addr 0x4aa5078, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aa51ac, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_values, addr 0x4aa5014, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_values();

  /// @brief Method set_values, addr 0x4aa501c, size 0x5c, virtual false, abstract: false, final false
