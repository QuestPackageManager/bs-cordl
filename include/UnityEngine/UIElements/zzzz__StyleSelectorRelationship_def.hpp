...
public:
  ...
  /// @brief Field Descendent value: static_cast<int32_t>(0x2)
  static ::UnityEngine::UIElements::StyleSelectorRelationship const Descendent;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::StyleSelectorRelationship, 0x4>, "Size mismatch!");
