...
public:
  ...
  /// @brief Method TryFindValueInAttributeOverrides, addr 0x6b646b8, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetAttributeOverrideValueFromBagAsString, addr 0x6b64cc0, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValueFromBagAsString, addr 0x6b64940, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValueFromBagAsString, addr 0x6b6497c, size 0x344, virtual false, abstract: false, final false
  inline bool TryGetValueFromBagAsString(::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc, ::ByRef<::StringW> value,
                                         ::ByRef<::UnityEngine::UIElements::VisualTreeAsset*> sourceAsset);

  /// @brief Method ValidateName, addr 0x6b64f04, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b645f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x6b64600, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x6b64608, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_obsoleteNames, addr 0x6b64610, size 0x88, virtual false, abstract: false, final false
  inline void set_obsoleteNames(::System::Collections::Generic::IEnumerable_1<::StringW>* value);

  /// @brief Method set_restriction, addr 0x6b646b0, size 0x8, virtual false, abstract: false, final false
  inline void set_restriction(::UnityEngine::UIElements::UxmlTypeRestriction* value);

  /// @brief Method set_type, addr 0x6b64698, size 0x8, virtual false, abstract: false, final false
  inline void set_type(::StringW value);

  /// @brief Method set_typeNamespace, addr 0x6b646a0, size 0x8, virtual false, abstract: false, final false
  inline void set_typeNamespace(::StringW value);

  /// @brief Method set_use, addr 0x6b646a8, size 0x8, virtual false, abstract: false, final false
