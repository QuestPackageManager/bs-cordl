...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6239))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e2bcb0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_name, addr 0x2e2bcd4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x2e2bcdc, size 0x8, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_obsoleteNames, addr 0x2e2bce4, size 0x5c, virtual false, abstract: false, final false
  inline void set_obsoleteNames(::System::Collections::Generic::IEnumerable_1<::StringW>* value);

  /// @brief Method set_type, addr 0x2e2bd40, size 0x8, virtual false, abstract: false, final false
  inline void set_type(::StringW value);

  /// @brief Method set_typeNamespace, addr 0x2e2bd48, size 0x8, virtual false, abstract: false, final false
  inline void set_typeNamespace(::StringW value);

  /// @brief Method set_use, addr 0x2e2bd50, size 0x8, virtual false, abstract: false, final false
  inline void set_use(::UnityEngine::UIElements::__UxmlAttributeDescription__Use value);

  /// @brief Method set_restriction, addr 0x2e2bd58, size 0x8, virtual false, abstract: false, final false
  inline void set_restriction(::UnityEngine::UIElements::UxmlTypeRestriction* value);

  /// @brief Method TryGetValueFromBagAsString, addr 0x2e2bd60, size 0x474, virtual false, abstract: false, final false
