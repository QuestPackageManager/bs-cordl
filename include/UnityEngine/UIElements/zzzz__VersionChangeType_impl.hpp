...
constexpr ::UnityEngine::UIElements::VersionChangeType::VersionChangeType(int32_t value__) noexcept {
  this->value__ = value__;
}
// Ctor Parameters []
constexpr ::UnityEngine::UIElements::VersionChangeType::VersionChangeType() {}
