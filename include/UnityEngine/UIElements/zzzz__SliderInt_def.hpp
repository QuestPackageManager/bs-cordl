...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6247)), TypeDefinitionIndex(TypeDefinitionIndex(6390)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6390), inst: 917
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6380)) CS Name: ::SliderInt::UxmlTraits*
...
public:
  ...
  /// @brief Method Init, addr 0x2e5576c, size 0x2c0, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__SliderInt__UxmlTraits* New_ctor();

  /// @brief Method .ctor, addr 0x2e55a2c, size 0x230, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6360)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6360), inst: 103 })]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e54c2c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x2e54c44, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pageSize, addr 0x2e54d90, size 0x48, virtual true, abstract: false, final false
  inline float_t get_pageSize();

  /// @brief Method set_pageSize, addr 0x2e54dd8, size 0x118, virtual true, abstract: false, final false
  inline void set_pageSize(float_t value);

  /// @brief Method SliderLerpUnclamped, addr 0x2e54ef0, size 0xec, virtual true, abstract: false, final false
  inline int32_t SliderLerpUnclamped(int32_t a, int32_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x2e54fdc, size 0x1c, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(int32_t currentValue, int32_t lowerValue, int32_t higherValue);

  /// @brief Method ParseStringToValue, addr 0x2e54ff8, size 0x2c, virtual true, abstract: false, final false
  inline int32_t ParseStringToValue(::StringW stringValue);

  /// @brief Method ComputeValueAndDirectionFromClick, addr 0x2e55024, size 0x360, virtual true, abstract: false, final false
  ...
  /// @brief Method ComputeValueFromKey, addr 0x2e55384, size 0x2d0, virtual true, abstract: false, final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6256)), TypeDefinitionIndex(TypeDefinitionIndex(6380)), TypeDefinitionIndex(TypeDefinitionIndex(6381)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6256), inst: 5257 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6379)) CS Name: ::SliderInt::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e55724, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
