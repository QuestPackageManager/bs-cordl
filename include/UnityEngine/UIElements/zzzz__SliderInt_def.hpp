...
public:
  ...
  /// @brief Method .ctor, addr 0x35d0558, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x35d05a0, size 0x2c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d0860, size 0x230, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ComputeValueAndDirectionFromClick, addr 0x35cfe58, size 0x360, virtual true, abstract: false, final false
  ...
  /// @brief Method ComputeValueFromKey, addr 0x35d01b8, size 0x2d0, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseStringToValue, addr 0x35cfe2c, size 0x2c, virtual true, abstract: false, final false
  inline int32_t ParseStringToValue(::StringW stringValue);

  /// @brief Method SliderLerpUnclamped, addr 0x35cfd24, size 0xec, virtual true, abstract: false, final false
  inline int32_t SliderLerpUnclamped(int32_t a, int32_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x35cfe10, size 0x1c, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(int32_t currentValue, int32_t lowerValue, int32_t higherValue);

  /// @brief Method .ctor, addr 0x35cfa60, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35cfa78, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pageSize, addr 0x35cfbc4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_pageSize, addr 0x35cfc0c, size 0x118, virtual true, abstract: false, final false
