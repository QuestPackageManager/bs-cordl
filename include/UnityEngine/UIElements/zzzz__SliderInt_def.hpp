...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::SliderInt*);
MARK_REF_T(::UnityEngine::UIElements::SliderInt_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::SliderInt_UxmlTraits*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::SliderInt*, "UnityEngine.UIElements", "SliderInt");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::SliderInt_UxmlFactory*, "UnityEngine.UIElements", "SliderInt/UxmlFactory");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::SliderInt_UxmlTraits*, "UnityEngine.UIElements", "SliderInt/UxmlTraits");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d72254, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SliderInt_UxmlFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SliderInt_UxmlFactory(SliderInt_UxmlFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SliderInt_UxmlFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SliderInt_UxmlFactory(SliderInt_UxmlFactoryconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::SliderInt_UxmlFactory) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x6d722bc, size 0x310, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d725cc, size 0x26c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SliderInt_UxmlTraits", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SliderInt_UxmlTraits(SliderInt_UxmlTraits&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SliderInt_UxmlTraits", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SliderInt_UxmlTraits(SliderInt_UxmlTraitsconst&) = delete;
...
static_assert(offsetof(::UnityEngine::UIElements::SliderInt_UxmlTraits, ___m_HighValue) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::SliderInt_UxmlTraits, ___m_PageSize) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::SliderInt_UxmlTraits, ___m_ShowInputField) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::SliderInt_UxmlTraits, ___m_Direction) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::SliderInt_UxmlTraits, ___m_Inverted) == 0xc8, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::SliderInt_UxmlTraits) == 0xd0, "Size mismatch!");
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6d717ec, size 0x1ac, virtual true, abstract: false, final false
  inline void ApplyInputDeviceDelta(::UnityEngine::Vector3 delta, ::UnityEngine::UIElements::DeltaSpeed speed, int32_t startValue);

  /// @brief Method ComputeValueAndDirectionFromClick, addr 0x6d71bc0, size 0x308, virtual true, abstract: false, final false
  ...
  /// @brief Method ComputeValueFromKey, addr 0x6d71ec8, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseStringToValue, addr 0x6d71b3c, size 0x84, virtual true, abstract: false, final false
  inline int32_t ParseStringToValue(::StringW previousValue, ::StringW newValue);

  /// @brief Method SliderLerpUnclamped, addr 0x6d71998, size 0xf0, virtual true, abstract: false, final false
  inline int32_t SliderLerpUnclamped(int32_t a, int32_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x6d71a88, size 0x28, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(int32_t currentValue, int32_t lowerValue, int32_t higherValue);

  /// @brief Method SliderRange, addr 0x6d71ab0, size 0x8c, virtual true, abstract: false, final false
  inline int32_t SliderRange();

  /// @brief Method .ctor, addr 0x6d71514, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d7152c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pageSize, addr 0x6d71684, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method set_pageSize, addr 0x6d716c8, size 0x124, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SliderInt", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SliderInt(SliderInt&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SliderInt", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SliderInt(SliderIntconst&) = delete;
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::SliderInt) == 0x590, "Size mismatch!");
