...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::UIElements::UxmlUtility);
...
public:
  // Declarations
  /// @brief Method ParseStringListAttribute, addr 0x6b68668, size 0x17c, virtual false, abstract: false, final false
