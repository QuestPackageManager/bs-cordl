...
public:
  ...
  /// @brief Method .ctor, addr 0x6b703c4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_height, addr 0x6b703bc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_height();

  /// @brief Method get_width, addr 0x6b703b4, size 0x8, virtual false, abstract: false, final false
