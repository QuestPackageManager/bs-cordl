...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VectorImage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VectorImage(VectorImage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VectorImage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VectorImage(VectorImageconst&) = delete;
