...
public:
  ...
  /// @brief Method CurrentTime, addr 0x6c425e4, size 0x54, virtual false, abstract: false, final false
  static inline int64_t CurrentTime();

  /// @brief Method Dispose, addr 0x6c432c8, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetAdditionalBinding, addr 0x6c420b8, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IBinding* GetAdditionalBinding(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetBindingObjectFromElement, addr 0x6c41f78, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method OnHierarchyChange, addr 0x6c425cc, size 0x18, virtual true, abstract: false, final false
  inline void OnHierarchyChange(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::HierarchyChangeType type);

  /// @brief Method OnVersionChanged, addr 0x6c424c0, size 0x10c, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method PerformTrackingOperations, addr 0x6c42700, size 0x204, virtual false, abstract: false, final false
  inline void PerformTrackingOperations();

  /// @brief Method ShouldProcessBindings, addr 0x6c42638, size 0xc8, virtual false, abstract: false, final false
  static inline bool ShouldProcessBindings(int64_t startTime);

  /// @brief Method StartTracking, addr 0x6c42148, size 0x9c, virtual false, abstract: false, final false
  inline void StartTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StartTrackingRecursive, addr 0x6c42288, size 0x128, virtual false, abstract: false, final false
  inline void StartTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTracking, addr 0x6c421e4, size 0x9c, virtual false, abstract: false, final false
  inline void StopTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTrackingRecursive, addr 0x6c423b0, size 0x110, virtual false, abstract: false, final false
  inline void StopTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Update, addr 0x6c42904, size 0x568, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBindings, addr 0x6c42e6c, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c432cc, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_disableBindingsThrottling, addr 0x6c41f1c, size 0x5c, virtual false, abstract: false, final false
  static inline bool get_disableBindingsThrottling();

  /// @brief Method get_profilerMarker, addr 0x6c41ec0, size 0x5c, virtual true, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_temporaryObjectCache, addr 0x6c42280, size 0x8, virtual false, abstract: false, final false
