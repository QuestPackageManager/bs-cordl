...
public:
  ...
  /// @brief Method CurrentTime, addr 0x4971e08, size 0x50, virtual false, abstract: false, final false
  static inline int64_t CurrentTime();

  /// @brief Method GetAdditionalBinding, addr 0x4971944, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IBinding* GetAdditionalBinding(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetBindingObjectFromElement, addr 0x497180c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method OnHierarchyChange, addr 0x4971df0, size 0x18, virtual true, abstract: false, final false
  inline void OnHierarchyChange(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::HierarchyChangeType type);

  /// @brief Method OnVersionChanged, addr 0x4971cf8, size 0xf8, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method PerformTrackingOperations, addr 0x4971e58, size 0x288, virtual false, abstract: false, final false
  inline void PerformTrackingOperations();

  /// @brief Method StartTracking, addr 0x49719cc, size 0x80, virtual false, abstract: false, final false
  inline void StartTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StartTrackingRecursive, addr 0x4971ad4, size 0x118, virtual false, abstract: false, final false
  inline void StartTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTracking, addr 0x4971a4c, size 0x80, virtual false, abstract: false, final false
  inline void StopTracking(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method StopTrackingRecursive, addr 0x4971bec, size 0x10c, virtual false, abstract: false, final false
  inline void StopTrackingRecursive(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Update, addr 0x49720e0, size 0x5b8, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBindings, addr 0x4972698, size 0x530, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4972bc8, size 0x154, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_disableBindingsThrottling, addr 0x49717b4, size 0x58, virtual false, abstract: false, final false
  static inline bool get_disableBindingsThrottling();

  /// @brief Method get_profilerMarker, addr 0x497175c, size 0x58, virtual true, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_temporaryObjectCache, addr 0x4971acc, size 0x8, virtual false, abstract: false, final false
