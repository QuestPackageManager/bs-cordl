...
public:
// Declarations
/// @brief Method CeilToPixelGrid, addr 0x6a62f9c, size 0x14, virtual false, abstract: false, final false
static inline float_t CeilToPixelGrid(float_t  v, float_t  pixelsPerPoint, float_t  offset) ;

/// @brief Method RoundToPanelPixelSize, addr 0x6a62fb0, size 0x48, virtual false, abstract: false, final false
static inline float_t RoundToPanelPixelSize(::UnityEngine::UIElements::VisualElement*  ve, float_t  v) ;

/// @brief Method RoundToPixelGrid, addr 0x6a62f80, size 0x1c, virtual false, abstract: false, final false
