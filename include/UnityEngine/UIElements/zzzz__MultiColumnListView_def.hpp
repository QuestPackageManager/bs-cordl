...
public:
  ...
  /// @brief Method .ctor, addr 0x6c081f0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c08258, size 0x224, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0847c, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColumnsChanged, addr 0x6c07f88, size 0x38, virtual false, abstract: false, final false
  inline void ColumnsChanged(::System::Object* sender, ::UnityEngine::UIElements::BindablePropertyChangedEventArgs args);

  /// @brief Method CreateViewController, addr 0x6c07c80, size 0x7c, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController();

  /// @brief Method CreateVirtualizationController, addr 0x6c07f3c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method RaiseColumnSortingChanged, addr 0x6c07978, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseColumnSortingChanged();

  /// @brief Method RaiseHeaderContextMenuPopulate, addr 0x6c07fc0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewController, addr 0x6c07cfc, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c07a60, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c07ac0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_columns, addr 0x6c075bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Columns* get_columns();

  /// @brief Method get_sortColumnDescriptions, addr 0x6c07744, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortColumnDescriptions();

  /// @brief Method get_sortingMode, addr 0x6c07994, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ColumnSortingMode get_sortingMode();

  /// @brief Method get_viewController, addr 0x6c07534, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method set_columns, addr 0x6c075c4, size 0x180, virtual false, abstract: false, final false
  inline void set_columns(::UnityEngine::UIElements::Columns* value);

  /// @brief Method set_sortColumnDescriptions, addr 0x6c0774c, size 0xe4, virtual false, abstract: false, final false
  inline void set_sortColumnDescriptions(::UnityEngine::UIElements::SortColumnDescriptions* value);

  /// @brief Method set_sortingMode, addr 0x6c0799c, size 0xc4, virtual false, abstract: false, final false
