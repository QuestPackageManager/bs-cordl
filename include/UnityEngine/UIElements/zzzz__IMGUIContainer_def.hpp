...
/// @brief Method .ctor, addr 0x6bea7e4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6bea84c, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::IMGUIContainer_UxmlTraits, 0x88>, "Size mismatch!");
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::IMGUIContainer_GUIGlobals, 0x7c>, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x6bea734, size 0x74, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x6bea7a8, size 0x18, virtual true, abstract: false, final false
inline void Dispose(bool  disposeManaged) ;

/// @brief Method DoIMGUIRepaint, addr 0x6be8b5c, size 0x2e0, virtual false, abstract: false, final false
inline void DoIMGUIRepaint() ;

/// @brief Method DoMeasure, addr 0x6bea470, size 0x2c4, virtual true, abstract: false, final false
...
/// @brief Method DoOnGUI, addr 0x6be7b00, size 0x1030, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentClipRect, addr 0x6be9b5c, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetCurrentClipRect() ;

/// @brief Method GetCurrentTransformAndClip, addr 0x6be9c60, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method HandleEventBubbleUp, addr 0x6be9e24, size 0x4cc, virtual true, abstract: false, final false
inline void HandleEventBubbleUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventBubbleUpDisabled, addr 0x6be9e18, size 0xc, virtual true, abstract: false, final false
inline void HandleEventBubbleUpDisabled(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleIMGUIEvent, addr 0x6be954c, size 0xc, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x6be9b94, size 0xcc, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, ::System::Action*  onGUIHandler, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x6be8e3c, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method IsContainerCapturingTheMouse, addr 0x6be9558, size 0x114, virtual false, abstract: false, final false
inline bool IsContainerCapturingTheMouse() ;

/// @brief Method IsDockAreaMouseUp, addr 0x6be9a58, size 0xd4, virtual false, abstract: false, final false
static inline bool IsDockAreaMouseUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsEventInsideLocalWindow, addr 0x6be98a0, size 0x1b8, virtual false, abstract: false, final false
inline bool IsEventInsideLocalWindow(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsLocalEvent, addr 0x6be966c, size 0x234, virtual false, abstract: false, final false
inline bool IsLocalEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method MarkDirtyLayout, addr 0x6be8b30, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method OnGenerateVisualContent, addr 0x6be75c0, size 0x1a4, virtual false, abstract: false, final false
inline void OnGenerateVisualContent(Il2CppObject*  mgc) ;

/// @brief Method RestoreGlobals, addr 0x6be7910, size 0x1f0, virtual false, abstract: false, final false
inline void RestoreGlobals() ;

/// @brief Method SaveGlobals, addr 0x6be7764, size 0x1ac, virtual false, abstract: false, final false
inline void SaveGlobals() ;

/// @brief Method SendEventToIMGUI, addr 0x6be919c, size 0x26c, virtual false, abstract: false, final false
inline bool SendEventToIMGUI(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SendEventToIMGUIRaw, addr 0x6be9408, size 0xa4, virtual false, abstract: false, final false
inline bool SendEventToIMGUIRaw(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SetFoldoutDepthClass, addr 0x6bea2f0, size 0x180, virtual false, abstract: false, final false
inline void SetFoldoutDepthClass() ;

/// @brief Method VerifyBounds, addr 0x6be94ac, size 0xa0, virtual false, abstract: false, final false
inline bool VerifyBounds(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method <DoOnGUI>b__59_0, addr 0x6bea7c0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6be7360, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6be7368, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method get_cache, addr 0x6be6c40, size 0x6c, virtual false, abstract: false, final false
inline ::UnityEngine::GUILayoutUtility_LayoutCache* get_cache() ;

/// @brief Method get_canGrabFocus, addr 0x6be6da0, size 0x20, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_contextType, addr 0x6be6cfc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method get_cullingEnabled, addr 0x6be6b88, size 0x8, virtual false, abstract: false, final false
inline bool get_cullingEnabled() ;

/// @brief Method get_focusOnlyIfHasFocusableControls, addr 0x6be6d98, size 0x8, virtual false, abstract: false, final false
inline bool get_focusOnlyIfHasFocusableControls() ;

/// @brief Method get_guiState, addr 0x6be6a80, size 0xe0, virtual false, abstract: false, final false
inline ::UnityEngine::ObjectGUIState* get_guiState() ;

/// @brief Method get_lastWorldClip, addr 0x6be6b60, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_lastWorldClip() ;

/// @brief Method get_layoutMeasuredHeight, addr 0x6be6cd4, size 0x28, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredHeight() ;

/// @brief Method get_layoutMeasuredWidth, addr 0x6be6cac, size 0x28, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredWidth() ;

/// @brief Method get_onGUIHandler, addr 0x6be69e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_contextType, addr 0x6be6d04, size 0x94, virtual false, abstract: false, final false
inline void set_contextType(::UnityEngine::UIElements::ContextType  value) ;

/// @brief Method set_cullingEnabled, addr 0x6be6b90, size 0xb0, virtual false, abstract: false, final false
inline void set_cullingEnabled(bool  value) ;

/// @brief Method set_lastWorldClip, addr 0x6be6b74, size 0x14, virtual false, abstract: false, final false
inline void set_lastWorldClip(::UnityEngine::Rect  value) ;

/// @brief Method set_onGUIHandler, addr 0x6be69ec, size 0x94, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::IMGUIContainer, 0x5c0>, "Size mismatch!");
