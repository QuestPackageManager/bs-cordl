...
inline ::ArrayW<::UnityEngine::UIElements::BaseCompositeField_3_FieldDescription<TValueType,TField,TFieldValue>,::Array<::UnityEngine::UIElements::BaseCompositeField_3_FieldDescription<TValueType,TField,TFieldValue>>*> DescribeFields() ;
