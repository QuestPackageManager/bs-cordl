...
public:
  ...
  /// @brief Method get_mode addr 0x2d03e6c size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::EasingMode get_mode();

  /// @brief Method .ctor addr 0x2d03e74 size 0x8 virtual false final false
  inline void _ctor(::UnityEngine::UIElements::EasingMode mode);

  /// @brief Method op_Implicit addr 0x2d03e7c size 0x8 virtual false final false
  ...
  /// @brief Method op_Equality addr 0x2d03e84 size 0xc virtual false final false
  static inline bool op_Equality(::UnityEngine::UIElements::EasingFunction lhs, ::UnityEngine::UIElements::EasingFunction rhs);

  /// @brief Method Equals addr 0x2d03e90 size 0x10 virtual true final true
  inline bool Equals(::UnityEngine::UIElements::EasingFunction other);

  /// @brief Method Equals addr 0x2d03ea0 size 0x78 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method ToString addr 0x2d03f18 size 0x68 virtual true final false
  inline ::StringW ToString();

  /// @brief Method GetHashCode addr 0x2d03f80 size 0x8 virtual true final false
