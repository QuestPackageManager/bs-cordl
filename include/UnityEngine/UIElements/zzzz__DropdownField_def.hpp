...
public:
  ...
  /// @brief Method Init, addr 0x2f8fc2c, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f8fda8, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddMenuItems, addr 0x2f8ee54, size 0x308, virtual false, abstract: false, final false
  inline void AddMenuItems(::UnityEngine::UIElements::IGenericMenu* menu);

  /// @brief Method ChangeValueFromMenu, addr 0x2f8f164, size 0x10, virtual false, abstract: false, final false
  inline void ChangeValueFromMenu(::StringW menuItem);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2f8f3c0, size 0x180, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method GetListItemToDisplay, addr 0x2f8e9f4, size 0xac, virtual false, abstract: false, final false
  inline ::StringW GetListItemToDisplay(::StringW value);

  /// @brief Method GetValueToDisplay, addr 0x2f8e968, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x2f8f2b0, size 0x110, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method ShowMenu, addr 0x2f8f540, size 0x180, virtual false, abstract: false, final false
  inline void ShowMenu();

  /// @brief Method UpdateMixedValueContent, addr 0x2f8f994, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f8eb3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2f8eb44, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_textElement, addr 0x2f8e960, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextElement* get_textElement();

  /// @brief Method get_value, addr 0x2f8f1e4, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_choices, addr 0x2f8f174, size 0x70, virtual true, abstract: false, final false
  inline void set_choices(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_index, addr 0x2f8eaa0, size 0x9c, virtual false, abstract: false, final false
  inline void set_index(int32_t value);

  /// @brief Method set_value, addr 0x2f8f22c, size 0x84, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2f8fbe4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method DoMeasure, addr 0x2f8fe94, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f8edfc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMenuItems>b__0, addr 0x2f8ff38, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f8f15c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
