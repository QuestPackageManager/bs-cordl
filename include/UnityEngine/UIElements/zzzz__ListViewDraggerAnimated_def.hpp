...
/// @brief Method Animate, addr 0x6bc5700, size 0x380, virtual false, abstract: false, final false
inline void Animate(::UnityEngine::UIElements::ReusableCollectionItem*  element, float_t  paddingTop) ;

/// @brief Method ClearDragAndDropUI, addr 0x6bc6860, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x6bc63d8, size 0x488, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method StartDrag, addr 0x6bc4f54, size 0x7ac, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::StartDragArgs StartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method TryGetDragPosition, addr 0x6bc6864, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x6bc5a80, size 0x958, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bc4f40, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  listView) ;

/// @brief Method get_draggedItem, addr 0x6bc4f30, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* get_draggedItem() ;

/// @brief Method get_isDragging, addr 0x6bc4f20, size 0x8, virtual false, abstract: false, final false
inline bool get_isDragging() ;

/// @brief Method get_supportsDragEvents, addr 0x6bc4f38, size 0x8, virtual true, abstract: false, final false
inline bool get_supportsDragEvents() ;

/// @brief Method set_isDragging, addr 0x6bc4f28, size 0x8, virtual false, abstract: false, final false
