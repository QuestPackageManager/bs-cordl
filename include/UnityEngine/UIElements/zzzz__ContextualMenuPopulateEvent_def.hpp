...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::ContextualMenuPopulateEvent*);
...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6d9e490, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6d9e48c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::ContextualMenuPopulateEvent___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetPooled, addr 0x6d9da80, size 0x7f8, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x6d9e278, size 0x74, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x6d9e2ec, size 0x34, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* New_ctor();

  /// @brief Method PostDispatch, addr 0x6d9e394, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d9e320, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menu, addr 0x6d9da60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DropdownMenu* get_menu();

  /// @brief Method get_triggerEvent, addr 0x6d9da70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* get_triggerEvent();

  /// @brief Method set_menu, addr 0x6d9da68, size 0x8, virtual false, abstract: false, final false
  inline void set_menu(::UnityEngine::UIElements::DropdownMenu* value);

  /// @brief Method set_triggerEvent, addr 0x6d9da78, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::ContextualMenuPopulateEvent) == 0xb0, "Size mismatch!");
