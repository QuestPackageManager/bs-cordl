...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x6a8ade8, size 0x40, virtual false, abstract: false, final false
  inline uint64_t _GetValueFromBag_b__3_0(::StringW s, uint64_t l);

  /// @brief Method .ctor, addr 0x6a8ade4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToUlong, addr 0x6a8ad54, size 0x3c, virtual false, abstract: false, final false
  static inline uint64_t ConvertValueToUlong(::StringW v, uint64_t defaultValue);

  /// @brief Method GetValueFromBag, addr 0x6a8abbc, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a8ab20, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
