...
public:
  ...
  /// @brief Method AddStyleSheet, addr 0x3540058, size 0xec, virtual false, abstract: false, final false
  inline void AddStyleSheet(::UnityEngine::UIElements::StyleSheet* sheet);

  /// @brief Method GetStyleSheetAt, addr 0x35401ac, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveStyleSheetRange, addr 0x3540144, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x353ff94, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_styleSheetCount, addr 0x353ff4c, size 0x48, virtual false, abstract: false, final false
