...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10251)), TypeDefinitionIndex(TypeDefinitionIndex(6887)), TypeDefinitionIndex(TypeDefinitionIndex(7313)),
// TypeDefinitionIndex(TypeDefinitionIndex(7293))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7361)) CS Name: ::UnityEngine.UIElements::VisualData
