...
public:
  ...
  /// @brief Method .ctor, addr 0x6be37bc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be3824, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be3a34, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x6be3be4, size 0x4, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_0(::UnityEngine::Vector4 r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x6be3be8, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::Vector4> r, float_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x6be3bf0, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_2(::UnityEngine::Vector4 r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x6be3bf8, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::Vector4> r, float_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x6be3c00, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_4(::UnityEngine::Vector4 r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x6be3c08, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::ByRef<::UnityEngine::Vector4> r, float_t v);

  /// @brief Method <DescribeFields>b__0_6, addr 0x6be3c10, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_6(::UnityEngine::Vector4 r);

  /// @brief Method <DescribeFields>b__0_7, addr 0x6be3c18, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_7(::ByRef<::UnityEngine::Vector4> r, float_t v);

  /// @brief Method .ctor, addr 0x6be3be0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x6be2fdc, size 0x5d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be35ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6be35b4, size 0x12c, virtual false, abstract: false, final false
