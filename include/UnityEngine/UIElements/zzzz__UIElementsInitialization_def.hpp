...
public:
  // Declarations
  /// @brief Method InitializeUIElementsManaged, addr 0x6b5a55c, size 0x4, virtual false, abstract: false, final false
  static inline void InitializeUIElementsManaged();

  /// @brief Method RegisterBuiltInPropertyBags, addr 0x6b5a560, size 0x15f8, virtual false, abstract: false, final false
