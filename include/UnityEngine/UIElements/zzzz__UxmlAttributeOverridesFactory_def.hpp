...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6003)), TypeDefinitionIndex(TypeDefinitionIndex(6236)), TypeDefinitionIndex(TypeDefinitionIndex(6256)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6256), inst: 5264 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6235)) CS Name:
...
public:
  ...
  /// @brief Method get_uxmlName, addr 0x2e2b8e4, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x2e2b924, size 0x74, virtual true, abstract: false, final false
  inline ::StringW get_uxmlQualifiedName();

  /// @brief Method Create, addr 0x2e2b998, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e2b9a0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
