...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(6977)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5284
// }), TypeDefinitionIndex(TypeDefinitionIndex(6744))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6976)) CS Name: ::UnityEngine.UIElements::UxmlAttributeOverridesFactory*
...
public:
  ...
  /// @brief Method get_uxmlName addr 0x2e0e4fc size 0x40 virtual true final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName addr 0x2e0e53c size 0x74 virtual true final false
  inline ::StringW get_uxmlQualifiedName();

  /// @brief Method Create addr 0x2e0e5b0 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2e0e5b8 size 0x48 virtual false final false
  inline void _ctor();
