...
public:
  ...
  /// @brief Method SetValue, addr 0x6b02fd4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b02e94, size 0xa8, virtual false, abstract: false, final false
  static inline void SetValue(int32_t hash, ::UnityEngine::UIElements::StyleVariableContext* data);

  /// @brief Method SetValue, addr 0x6b02d34, size 0xc8, virtual false, abstract: false, final false
  static inline void SetValue(int64_t hash, ::ByRef<::UnityEngine::UIElements::ComputedStyle> data);

  /// @brief Method TryGetValue, addr 0x6b02f3c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0x6b02dfc, size 0x98, virtual false, abstract: false, final false
  static inline bool TryGetValue(int32_t hash, ::ByRef<::UnityEngine::UIElements::StyleVariableContext*> data);

  /// @brief Method TryGetValue, addr 0x6b02c9c, size 0x98, virtual false, abstract: false, final false
