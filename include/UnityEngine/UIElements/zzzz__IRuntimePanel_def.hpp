...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IRuntimePanel*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IRuntimePanel*, "UnityEngine.UIElements", "IRuntimePanel");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRuntimePanel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRuntimePanel(IRuntimePanelconst&) = delete;
