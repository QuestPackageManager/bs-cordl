...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ATGTextEventHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ATGTextEventHandler(ATGTextEventHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ATGTextEventHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ATGTextEventHandler(ATGTextEventHandlerconst&) = delete;
