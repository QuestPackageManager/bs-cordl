...
/// @brief Method AllocateHyperlinkCallbacks, addr 0x6ad4678, size 0x174, virtual false, abstract: false, final false
inline void AllocateHyperlinkCallbacks() ;

/// @brief Method AllocateLinkCallbacks, addr 0x6ad44f4, size 0x174, virtual false, abstract: false, final false
inline void AllocateLinkCallbacks() ;

/// @brief Method HasAllocatedHyperlinkCallbacks, addr 0x6ad4668, size 0x10, virtual false, abstract: false, final false
inline bool HasAllocatedHyperlinkCallbacks() ;

/// @brief Method HasAllocatedLinkCallbacks, addr 0x6ad44e4, size 0x10, virtual false, abstract: false, final false
inline bool HasAllocatedLinkCallbacks() ;

/// @brief Method HyperlinkOnPointerMove, addr 0x6ad4aa8, size 0x270, virtual false, abstract: false, final false
inline void HyperlinkOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method HyperlinkOnPointerOut, addr 0x6ad4d18, size 0x8, virtual false, abstract: false, final false
inline void HyperlinkOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  evt) ;

/// @brief Method HyperlinkOnPointerOver, addr 0x6ad4aa0, size 0x8, virtual false, abstract: false, final false
inline void HyperlinkOnPointerOver(::UnityEngine::UIElements::PointerOverEvent*  _) ;

/// @brief Method HyperlinkOnPointerUp, addr 0x6ad47ec, size 0x13c, virtual false, abstract: false, final false
inline void HyperlinkOnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  pue) ;

/// @brief Method LinkTagOnPointerDown, addr 0x6ad4d20, size 0x21c, virtual false, abstract: false, final false
inline void LinkTagOnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  pde) ;

/// @brief Method LinkTagOnPointerMove, addr 0x6ad5158, size 0x468, virtual false, abstract: false, final false
inline void LinkTagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method LinkTagOnPointerOut, addr 0x6ad55c0, size 0x1b4, virtual false, abstract: false, final false
inline void LinkTagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  poe) ;

/// @brief Method LinkTagOnPointerUp, addr 0x6ad4f3c, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method RegisterHyperlinkCallbacks, addr 0x6ad5980, size 0x19c, virtual false, abstract: false, final false
inline void RegisterHyperlinkCallbacks() ;

/// @brief Method RegisterLinkTagCallbacks, addr 0x6ad5774, size 0x110, virtual false, abstract: false, final false
inline void RegisterLinkTagCallbacks() ;

/// @brief Method UnRegisterHyperlinkCallbacks, addr 0x6ad5b1c, size 0x190, virtual false, abstract: false, final false
inline void UnRegisterHyperlinkCallbacks() ;

/// @brief Method UnRegisterLinkTagCallbacks, addr 0x6ad5884, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ad4448, size 0x9c, virtual false, abstract: false, final false
