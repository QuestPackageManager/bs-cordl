...
public:
  ...
  /// @brief Method .ctor, addr 0x498dfec, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x498e034, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RefreshButtonsState, addr 0x498df14, size 0xd8, virtual false, abstract: false, final false
  inline void RefreshButtonsState();

  /// @brief Method SetValueWithoutNotify, addr 0x498de90, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x498ddd8, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
