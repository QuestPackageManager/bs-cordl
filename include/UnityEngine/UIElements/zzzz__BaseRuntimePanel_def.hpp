...
public:
  ...
  /// @brief Method <.cctor>b__52_0, addr 0x6c625d0, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 __cctor_b__52_0(::UnityEngine::Vector2 p);

  /// @brief Method .ctor, addr 0x6c625cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AssignPanelToComponents, addr 0x6c618fc, size 0x2e0, virtual false, abstract: false, final false
  inline void AssignPanelToComponents(::UnityEngine::UIElements::BaseRuntimePanel* panel);

  /// @brief Method Dispose, addr 0x6c61d3c, size 0x4c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method InvokeDrawsInCamerasChanged, addr 0x6c61ee0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method PointerEntersPanel, addr 0x6c623fc, size 0xa4, virtual false, abstract: false, final false
  inline void PointerEntersPanel(int32_t pointerId, ::UnityEngine::Vector2 position);

  /// @brief Method PointerLeavesPanel, addr 0x6c62340, size 0xbc, virtual false, abstract: false, final false
  inline void PointerLeavesPanel(int32_t pointerId, ::UnityEngine::Vector2 position);

  /// @brief Method Render, addr 0x6c61fc4, size 0x220, virtual true, abstract: false, final false
  inline void Render();

  /// @brief Method ScreenToPanel, addr 0x6c621ec, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 ScreenToPanel(::UnityEngine::Vector2 screen);

  /// @brief Method ScreenToPanel, addr 0x6c62224, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6c55148, size 0x10c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x6c54fe0, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::ScriptableObject* ownerObject, ::UnityEngine::UIElements::EventDispatcher* dispatcher);

  /// @brief Method add_destroyed, addr 0x6c61be4, size 0xac, virtual false, abstract: false, final false
  inline void add_destroyed(::System::Action* value);

  /// @brief Method add_drawsInCamerasChanged, addr 0x6c61d88, size 0xac, virtual false, abstract: false, final false
  inline void add_drawsInCamerasChanged(::System::Action* value);

  /// @brief Method getScreenRenderingHeight, addr 0x6c54274, size 0xdc, virtual false, abstract: false, final false
  static inline int32_t getScreenRenderingHeight(int32_t display);

  /// @brief Method getScreenRenderingWidth, addr 0x6c54198, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_drawsInCameras, addr 0x6c569e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawsInCameras();

  /// @brief Method get_pixelsPerUnit, addr 0x6c56e68, size 0x8, virtual false, abstract: false, final false
  inline float_t get_pixelsPerUnit();

  /// @brief Method get_screenRenderingHeight, addr 0x6c61f68, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_screenRenderingHeight();

  /// @brief Method get_screenRenderingWidth, addr 0x6c61f0c, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_screenRenderingWidth();

  /// @brief Method get_screenToPanelSpace, addr 0x6c621e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::UnityEngine::Vector2, ::UnityEngine::Vector2>* get_screenToPanelSpace();

  /// @brief Method get_selectableGameObject, addr 0x6c61854, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::GameObject> get_selectableGameObject();

  /// @brief Method get_sortingPriority, addr 0x6c61bdc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sortingPriority();

  /// @brief Method get_targetDisplay, addr 0x6c61efc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_targetDisplay();

  /// @brief Method remove_destroyed, addr 0x6c61c90, size 0xac, virtual false, abstract: false, final false
  inline void remove_destroyed(::System::Action* value);

  /// @brief Method remove_drawsInCamerasChanged, addr 0x6c61e34, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method set_drawsInCameras, addr 0x6c5406c, size 0x30, virtual false, abstract: false, final false
  inline void set_drawsInCameras(bool value);

  /// @brief Method set_pixelsPerUnit, addr 0x6c5409c, size 0x8, virtual false, abstract: false, final false
  inline void set_pixelsPerUnit(float_t value);

  /// @brief Method set_screenToPanelSpace, addr 0x6c54114, size 0x84, virtual false, abstract: false, final false
  inline void set_screenToPanelSpace(::System::Func_2<::UnityEngine::Vector2, ::UnityEngine::Vector2>* value);

  /// @brief Method set_selectableGameObject, addr 0x6c6185c, size 0xa0, virtual true, abstract: false, final true
  inline void set_selectableGameObject(::UnityEngine::GameObject* value);

  /// @brief Method set_sortingPriority, addr 0x6c549ec, size 0x104, virtual false, abstract: false, final false
  inline void set_sortingPriority(float_t value);

  /// @brief Method set_targetDisplay, addr 0x6c61f04, size 0x8, virtual false, abstract: false, final false
