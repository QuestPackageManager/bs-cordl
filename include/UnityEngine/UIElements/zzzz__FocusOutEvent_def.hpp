...
/// @brief Method <.cctor>b__0_0, addr 0x6bd1b18, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::FocusOutEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x6bd1b14, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x6bd17c4, size 0x58, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x6bd181c, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::FocusOutEvent* New_ctor() ;

/// @brief Method PostDispatch, addr 0x6bd1880, size 0x8c, virtual true, abstract: false, final false
inline void PostDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method .ctor, addr 0x6bd1828, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
