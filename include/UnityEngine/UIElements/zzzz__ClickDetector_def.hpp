...
public:
  ...
  /// @brief Method Reset, addr 0x6a7de68, size 0x68, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6a7dc3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CancelClickTracking, addr 0x6a7e32c, size 0x104, virtual false, abstract: false, final false
  inline void CancelClickTracking(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method Cleanup, addr 0x6a7e430, size 0x154, virtual false, abstract: false, final false
  inline void Cleanup(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* elements);

  /// @brief Method ContainsPointer, addr 0x6a7e178, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendClickEvent, addr 0x6a7ded0, size 0x2a8, virtual false, abstract: false, final false
  inline void SendClickEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method StartClickTracking, addr 0x6a7dc40, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a7d9c8, size 0x274, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int32_t getStaticF__s_DoubleClickTime_k__BackingField();

  /// @brief Method get_s_DoubleClickTime, addr 0x6a7d90c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_s_DoubleClickTime, addr 0x6a7d968, size 0x60, virtual false, abstract: false, final false
