...
public:
  ...
  /// @brief Method Reset, addr 0x2dd1734, size 0x64, virtual false, abstract: false, final false
  inline void Reset();

  static inline ::UnityEngine::UIElements::__ClickDetector__ButtonClickStatus* New_ctor();

  /// @brief Method .ctor, addr 0x2dd14c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_s_DoubleClickTime, addr 0x2dd11b0, size 0x58, virtual false, abstract: false, final false
  static inline int32_t get_s_DoubleClickTime();

  /// @brief Method set_s_DoubleClickTime, addr 0x2dd1208, size 0x5c, virtual false, abstract: false, final false
  static inline void set_s_DoubleClickTime(int32_t value);

  static inline ::UnityEngine::UIElements::ClickDetector* New_ctor();

  /// @brief Method .ctor, addr 0x2dd1264, size 0x260, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method StartClickTracking, addr 0x2dd14cc, size 0x268, virtual false, abstract: false, final false
  inline void StartClickTracking(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method SendClickEvent, addr 0x2dd1798, size 0x3e4, virtual false, abstract: false, final false
  inline void SendClickEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method CancelClickTracking, addr 0x2dd1c9c, size 0xfc, virtual false, abstract: false, final false
  inline void CancelClickTracking(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ProcessEvent, addr 0x2dd1d98, size 0x51c, virtual false, abstract: false, final false
  inline void ProcessEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ContainsPointer, addr 0x2dd1b7c, size 0x120, virtual false, abstract: false, final false
