...
public:
  // Declarations
  /// @brief Method Create, addr 0x4a42578, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr Create(bool computeBBox);

  /// @brief Method Destroy, addr 0x4a425b4, size 0x3c, virtual false, abstract: false, final false
  static inline void Destroy(::System::IntPtr handle);

  /// @brief Method Reset, addr 0x4a425f0, size 0x3c, virtual false, abstract: false, final false
