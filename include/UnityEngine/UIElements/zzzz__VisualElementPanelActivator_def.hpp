...
public:
  ...
  /// @brief Method OnEnter, addr 0x2f1976c, size 0x10, virtual false, abstract: false, final false
  inline void OnEnter(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnLeave, addr 0x2f1977c, size 0x74, virtual false, abstract: false, final false
  inline void OnLeave(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method SendActivation, addr 0x2f1953c, size 0x118, virtual false, abstract: false, final false
  inline void SendActivation();

  /// @brief Method SendDeactivation, addr 0x2f19654, size 0x118, virtual false, abstract: false, final false
  inline void SendDeactivation();

  /// @brief Method SetActive, addr 0x2f17848, size 0x33c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f17738, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::IVisualElementPanelActivatable* activatable);

  /// @brief Method get_isActive, addr 0x2f19514, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_isDetaching, addr 0x2f19528, size 0x8, virtual false, abstract: false, final false
  inline bool get_isDetaching();

  /// @brief Method set_isActive, addr 0x2f1951c, size 0xc, virtual false, abstract: false, final false
  inline void set_isActive(bool value);

  /// @brief Method set_isDetaching, addr 0x2f19530, size 0xc, virtual false, abstract: false, final false
