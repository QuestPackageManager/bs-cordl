...
public:
  ...
  /// @brief Method RemoveAttribute, addr 0x6b64fa0, size 0xfc, virtual false, abstract: false, final false
  inline void RemoveAttribute(::StringW attributeName);

  /// @brief Method SetAttribute, addr 0x6b6509c, size 0x4, virtual false, abstract: false, final false
  inline void SetAttribute(::StringW name, ::StringW value);

  /// @brief Method SetOrAddProperty, addr 0x6b675a4, size 0x210, virtual false, abstract: false, final false
  inline void SetOrAddProperty(::StringW propertyName, ::StringW propertyValue);

  /// @brief Method ToString, addr 0x6b677b4, size 0xa0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TryGetAttributeValue, addr 0x6b674c4, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6b67488, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW fullTypeName, ::UnityEngine::UIElements::UxmlNamespaceDefinition xmlNamespace);

  /// @brief Method get_fullTypeName, addr 0x6b67494, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_id, addr 0x6b6749c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_orderInDocument, addr 0x6b674ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_orderInDocument();

  /// @brief Method get_parentId, addr 0x6b674b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_id, addr 0x6b674a4, size 0x8, virtual false, abstract: false, final false
  inline void set_id(int32_t value);

  /// @brief Method set_parentId, addr 0x6b674bc, size 0x8, virtual false, abstract: false, final false
