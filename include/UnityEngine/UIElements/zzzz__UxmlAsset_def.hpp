...
public:
  ...
  /// @brief Method SetAttribute, addr 0x4a9e37c, size 0x4, virtual false, abstract: false, final false
  inline void SetAttribute(::StringW name, ::StringW value);

  /// @brief Method SetOrAddProperty, addr 0x4a9e380, size 0x1f8, virtual false, abstract: false, final false
  inline void SetOrAddProperty(::StringW propertyName, ::StringW propertyValue);

  /// @brief Method TryGetAttributeValue, addr 0x4a9e2ac, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_fullTypeName, addr 0x4a9e28c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_id, addr 0x4a9e294, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_orderInDocument, addr 0x4a9e29c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_orderInDocument();

  /// @brief Method get_parentId, addr 0x4a9e2a4, size 0x8, virtual false, abstract: false, final false
