...
public:
  // Declarations
  /// @brief Method GetParentMustDirtyFlags, addr 0x6b752d4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method OnVersionChanged, addr 0x6b7519c, size 0x138, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x6b75308, size 0x4, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method .ctor, addr 0x6b7530c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
