...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::BackgroundSizeType, "UnityEngine.UIElements", "BackgroundSizeType");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::BackgroundSizeType) == 0x4, "Size mismatch!");
