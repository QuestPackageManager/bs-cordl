...
// Type: UnityEngine.UIElements::BackgroundSizeType
...
public:
  ...
  /// @brief Field Contain value: static_cast<int32_t>(0x2)
  static ::UnityEngine::UIElements::BackgroundSizeType const Contain;

  /// @brief Field Cover value: static_cast<int32_t>(0x1)
  static ::UnityEngine::UIElements::BackgroundSizeType const Cover;

  /// @brief Field Length value: static_cast<int32_t>(0x0)
