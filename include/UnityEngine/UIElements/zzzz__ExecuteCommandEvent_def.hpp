...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7315)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7315), inst: 1007 })}
...
public:
  ...
  /// @brief Method .ctor addr 0x2ce9b74 size 0x48 virtual false final false
  inline void _ctor();
