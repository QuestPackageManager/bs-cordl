...
template<typename T>
constexpr ::UnityEngine::UIElements::IMouseEvent*& UnityEngine::UIElements::PointerEventBase_1<T>::__cordl_internal_get__UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField;
}
template<typename T>
constexpr ::UnityEngine::UIElements::IMouseEvent* const& UnityEngine::UIElements::PointerEventBase_1<T>::__cordl_internal_get__UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField;
}
template<typename T>
constexpr void UnityEngine::UIElements::PointerEventBase_1<T>::__cordl_internal_set__UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField(::UnityEngine::UIElements::IMouseEvent*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____UnityEngine_UIElements_IPointerEventInternal_compatibilityMouseEvent_k__BackingField, value);
}
template<typename T>
...
return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method, eventType, mousePosition, delta, button, clickCount, modifiers, displayIndex);
}
template<typename T>
...
return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method, touch, modifiers, displayIndex);
}
template<typename T>
...
return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method, pen, modifiers, displayIndex);
}
template<typename T>
inline T UnityEngine::UIElements::PointerEventBase_1<T>::GetPooled(::UnityEngine::InputForUI::PointerEvent  pointerEvent, ::UnityEngine::Vector2  position, ::UnityEngine::Vector2  deltaPosition, int32_t  pointerId, float_t  deltaTime)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PointerEventBase_1<T>*>::get(),
                        "GetPooled",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 5>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::InputForUI::PointerEvent>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Vector2>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Vector2>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method, pointerEvent, position, deltaPosition, pointerId, deltaTime);
}
template<typename T>
