...
public:
  ...
  /// @brief Method .ctor, addr 0x498f550, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x498f598, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x498f76c, size 0x140, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x498f910, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_0(::UnityEngine::RectInt r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x498f918, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::RectInt> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x498f920, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_2(::UnityEngine::RectInt r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x498f928, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::RectInt> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x498f930, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_4(::UnityEngine::RectInt r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x498f938, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::ByRef<::UnityEngine::RectInt> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_6, addr 0x498f940, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_6(::UnityEngine::RectInt r);

  /// @brief Method <DescribeFields>b__0_7, addr 0x498f948, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_7(::ByRef<::UnityEngine::RectInt> r, int32_t v);

  /// @brief Method .ctor, addr 0x498f908, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x498ece8, size 0x658, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x498f340, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x498f348, size 0x138, virtual false, abstract: false, final false
