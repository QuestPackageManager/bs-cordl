...
public:
  ...
  /// @brief Method .ctor, addr 0x6c1ee64, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c1eecc, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1efe8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Apply, addr 0x6c1e208, size 0x1ac, virtual false, abstract: false, final false
  inline void Apply(::UnityEngine::UIElements::TabView* tabView);

  static inline ::UnityEngine::UIElements::TabView_ViewState* New_ctor();

  /// @brief Method OnAfterDeserialize, addr 0x6c1f098, size 0xc, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x6c1f08c, size 0xc, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method Save, addr 0x6c1e3b4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1f0a4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <OnElementAdded>b__0, addr 0x6c1f118, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1e7c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <FindTabByKey>b__0, addr 0x6c1f14c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1ec60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FindTabByKey, addr 0x6c1eb80, size 0xe0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Tab* FindTabByKey(::StringW key);

  static inline ::UnityEngine::UIElements::TabView* New_ctor();

  /// @brief Method OnElementAdded, addr 0x6c1e59c, size 0x228, virtual false, abstract: false, final false
  inline void OnElementAdded(::UnityEngine::UIElements::VisualElement* ve, int32_t index);

  /// @brief Method OnElementRemoved, addr 0x6c1e7c8, size 0x1a4, virtual false, abstract: false, final false
  inline void OnElementRemoved(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method OnTabClosed, addr 0x6c1e970, size 0x1c, virtual false, abstract: false, final false
  inline void OnTabClosed(::UnityEngine::UIElements::Tab* tab, int32_t index);

  /// @brief Method OnTabSelected, addr 0x6c1e96c, size 0x4, virtual false, abstract: false, final false
  inline void OnTabSelected(::UnityEngine::UIElements::Tab* tab);

  /// @brief Method OnViewDataReady, addr 0x6c1e138, size 0xd0, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method ReorderTab, addr 0x6c1e98c, size 0x1f4, virtual false, abstract: false, final false
  inline void ReorderTab(int32_t from, int32_t to);

  /// @brief Method SaveViewState, addr 0x6c1dbb0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1dd98, size 0x3a0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_activeTab, addr 0x6c1da0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Tab* get_activeTab();

  /// @brief Method get_contentContainer, addr 0x6c1d9ec, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_header, addr 0x6c1d9f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_header();

  /// @brief Method get_reorderable, addr 0x6c1dbe4, size 0x8, virtual false, abstract: false, final false
  inline bool get_reorderable();

  /// @brief Method get_tabHeaders, addr 0x6c1da04, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* get_tabHeaders();

  /// @brief Method get_tabs, addr 0x6c1d9fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_activeTab, addr 0x6c1da14, size 0x19c, virtual false, abstract: false, final false
  inline void set_activeTab(::UnityEngine::UIElements::Tab* value);

  /// @brief Method set_reorderable, addr 0x6c1dbec, size 0x1ac, virtual false, abstract: false, final false
