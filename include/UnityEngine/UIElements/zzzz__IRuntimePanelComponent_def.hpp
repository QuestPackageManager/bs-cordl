...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IRuntimePanelComponent*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IRuntimePanelComponent*, "UnityEngine.UIElements", "IRuntimePanelComponent");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRuntimePanelComponent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRuntimePanelComponent(IRuntimePanelComponentconst&) = delete;
