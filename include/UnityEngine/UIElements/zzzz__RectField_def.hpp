...
public:
  ...
  /// @brief Method .ctor, addr 0x6be0d34, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be0d9c, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be0fac, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x6be115c, size 0x4, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_0(::UnityEngine::Rect r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x6be1160, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::Rect> r, float_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x6be1168, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_2(::UnityEngine::Rect r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x6be1170, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::Rect> r, float_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x6be1178, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_4(::UnityEngine::Rect r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x6be1180, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::ByRef<::UnityEngine::Rect> r, float_t v);

  /// @brief Method <DescribeFields>b__0_6, addr 0x6be1188, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_6(::UnityEngine::Rect r);

  /// @brief Method <DescribeFields>b__0_7, addr 0x6be1190, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_7(::ByRef<::UnityEngine::Rect> r, float_t v);

  /// @brief Method .ctor, addr 0x6be1158, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x6be053c, size 0x5d0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be0b0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6be0b14, size 0x144, virtual false, abstract: false, final false
