...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IReorderable*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IReorderable*, "UnityEngine.UIElements", "IReorderable");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IReorderable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IReorderable(IReorderableconst&) = delete;
