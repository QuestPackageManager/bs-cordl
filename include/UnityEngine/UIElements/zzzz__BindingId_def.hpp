...
/// @brief Method Equals, addr 0x6afefdc, size 0xc4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6afef8c, size 0x50, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BindingId  other) ;

/// @brief Method GetHashCode, addr 0x6aff0a0, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x6afef84, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6afee58, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::Unity::Properties::PropertyPath>  path) ;

/// @brief Method .ctor, addr 0x6afedcc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x6aff0a8, size 0x50, virtual false, abstract: false, final false
static inline bool op_Equality(::ByRef<::UnityEngine::UIElements::BindingId>  lhs, ::ByRef<::UnityEngine::UIElements::BindingId>  rhs) ;

/// @brief Method op_Implicit, addr 0x6afee9c, size 0x8, virtual false, abstract: false, final false
static inline ::StringW op_Implicit___StringW(::ByRef<::UnityEngine::UIElements::BindingId>  vep) ;

/// @brief Method op_Implicit, addr 0x6afeea4, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BindingId op_Implicit___UnityEngine__UIElements__BindingId(::StringW  name) ;

/// @brief Method op_Implicit, addr 0x6afef2c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x6afee8c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x6aff0f8, size 0x9c, virtual false, abstract: false, final false
