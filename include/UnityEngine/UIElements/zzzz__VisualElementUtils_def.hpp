...
public:
  ...
  /// @brief Method <AssignInspectorStyleIfNecessary>b__5_0, addr 0x49ada00, size 0x6c, virtual false, abstract: false, final false
  inline bool _AssignInspectorStyleIfNecessary_b__5_0(::UnityEngine::UIElements::VisualElement* i);

  /// @brief Method .ctor, addr 0x49ad9f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AssignInspectorStyleIfNecessary, addr 0x49ad79c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFoldoutDepth, addr 0x49ad6b8, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t GetFoldoutDepth(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method GetUniqueName, addr 0x49ad5a4, size 0x114, virtual false, abstract: false, final false
