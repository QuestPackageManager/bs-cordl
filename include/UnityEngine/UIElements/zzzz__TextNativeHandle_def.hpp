...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10170)), TypeDefinitionIndex(TypeDefinitionIndex(9927)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9927), inst: 738
// }), TypeDefinitionIndex(TypeDefinitionIndex(15407))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7232)) CS Name: ::UnityEngine.UIElements::TextNativeHandle
...
public:
  ...
  /// @brief Method get_MeasuredSizes addr 0x2cde074 size 0x8 virtual true final true
  inline ::UnityEngine::Vector2 get_MeasuredSizes();

  /// @brief Method set_MeasuredSizes addr 0x2cde07c size 0x8 virtual true final true
  inline void set_MeasuredSizes(::UnityEngine::Vector2 value);

  /// @brief Method get_RoundedSizes addr 0x2cde084 size 0x8 virtual true final true
  inline ::UnityEngine::Vector2 get_RoundedSizes();

  /// @brief Method set_RoundedSizes addr 0x2cde08c size 0x8 virtual true final true
  inline void set_RoundedSizes(::UnityEngine::Vector2 value);

  /// @brief Method New addr 0x2cde094 size 0x5c virtual false final false
  static inline ::UnityEngine::UIElements::ITextHandle* New();

  /// @brief Method IsLegacy addr 0x2cde0f0 size 0x8 virtual true final true
  inline bool IsLegacy();

  /// @brief Method GetLineHeight addr 0x2cde0f8 size 0x70 virtual true final true
  ...
  /// @brief Method Update addr 0x2cde1cc size 0x70 virtual true final true
  ...
  /// @brief Method GetVertices addr 0x2cde23c size 0x210 virtual false final false
  ...
  /// @brief Method GetCursorPosition addr 0x2cde44c size 0x58 virtual true final true
