...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10243)), TypeDefinitionIndex(TypeDefinitionIndex(15377)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9999), inst:
// 749 }), TypeDefinitionIndex(TypeDefinitionIndex(9999))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7146)) CS Name: ::UnityEngine.UIElements::TextNativeHandle
