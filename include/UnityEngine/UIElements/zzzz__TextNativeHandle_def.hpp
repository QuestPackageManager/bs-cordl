...
public:
  ...
  /// @brief Method ComputeTextHeight, addr 0x35c68b0, size 0x64, virtual true, abstract: false, final true
  inline float_t ComputeTextHeight(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method ComputeTextWidth, addr 0x35c6bec, size 0x80, virtual true, abstract: false, final true
  inline float_t ComputeTextWidth(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method GetCursorPosition, addr 0x35c6b94, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLineHeight, addr 0x35c6840, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method GetVertices, addr 0x35c6984, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method IsElided, addr 0x35c6c6c, size 0x8, virtual true, abstract: false, final true
  inline bool IsElided();

  /// @brief Method IsLegacy, addr 0x35c6838, size 0x8, virtual true, abstract: false, final true
  inline bool IsLegacy();

  /// @brief Method New, addr 0x35c67dc, size 0x5c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::ITextHandle* New();

  /// @brief Method Update, addr 0x35c6914, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method get_MeasuredSizes, addr 0x35c67bc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_MeasuredSizes();

  /// @brief Method get_RoundedSizes, addr 0x35c67cc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_MeasuredSizes, addr 0x35c67c4, size 0x8, virtual true, abstract: false, final true
  inline void set_MeasuredSizes(::UnityEngine::Vector2 value);

  /// @brief Method set_RoundedSizes, addr 0x35c67d4, size 0x8, virtual true, abstract: false, final true
