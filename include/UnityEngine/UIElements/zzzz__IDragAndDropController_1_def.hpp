...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IDragAndDropController_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDragAndDropController_1(IDragAndDropController_1const&) = delete;
