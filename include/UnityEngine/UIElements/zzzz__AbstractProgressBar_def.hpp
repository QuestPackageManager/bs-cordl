...
public:
  ...
  /// @brief Method Init, addr 0x6c0b7cc, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c0b9b4, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateProgressWidth, addr 0x6c0b378, size 0x84, virtual false, abstract: false, final false
  inline float_t CalculateProgressWidth(float_t width);

  static inline ::UnityEngine::UIElements::AbstractProgressBar* New_ctor();

  /// @brief Method OnGeometryChanged, addr 0x6c0b0b8, size 0x24, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* e);

  /// @brief Method SetProgress, addr 0x6c0abb0, size 0x12c, virtual false, abstract: false, final false
  inline void SetProgress(float_t p);

  /// @brief Method SetValueWithoutNotify, addr 0x6c0b350, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6c0adf0, size 0x2c8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_highValue, addr 0x6c0acdc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highValue();

  /// @brief Method get_lowValue, addr 0x6c0aa9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lowValue();

  /// @brief Method get_title, addr 0x6c0a990, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_title();

  /// @brief Method get_value, addr 0x6c0b0dc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_highValue, addr 0x6c0ace4, size 0x10c, virtual false, abstract: false, final false
  inline void set_highValue(float_t value);

  /// @brief Method set_lowValue, addr 0x6c0aaa4, size 0x10c, virtual false, abstract: false, final false
  inline void set_lowValue(float_t value);

  /// @brief Method set_title, addr 0x6c0a9b0, size 0xec, virtual false, abstract: false, final false
  inline void set_title(::StringW value);

  /// @brief Method set_value, addr 0x6c0b0e4, size 0x26c, virtual true, abstract: false, final false
