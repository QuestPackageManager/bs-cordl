...
public:
  ...
  /// @brief Method Init, addr 0x35b87f8, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b89dc, size 0x164, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateProgressWidth, addr 0x35b8584, size 0x104, virtual false, abstract: false, final false
  inline float_t CalculateProgressWidth(float_t width);

  static inline ::UnityEngine::UIElements::AbstractProgressBar* New_ctor();

  /// @brief Method OnGeometryChanged, addr 0x35b82d4, size 0x24, virtual false, abstract: false, final false
  inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* e);

  /// @brief Method SetProgress, addr 0x35b7ef8, size 0x124, virtual false, abstract: false, final false
  inline void SetProgress(float_t p);

  /// @brief Method SetValueWithoutNotify, addr 0x35b855c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35b8034, size 0x2a0, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_highValue, addr 0x35b801c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_highValue();

  /// @brief Method get_lowValue, addr 0x35b7ee0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lowValue();

  /// @brief Method get_value, addr 0x35b82f8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_highValue, addr 0x35b8024, size 0x10, virtual false, abstract: false, final false
  inline void set_highValue(float_t value);

  /// @brief Method set_lowValue, addr 0x35b7ee8, size 0x10, virtual false, abstract: false, final false
  inline void set_lowValue(float_t value);

  /// @brief Method set_title, addr 0x35b7ebc, size 0x24, virtual false, abstract: false, final false
  inline void set_title(::StringW value);

  /// @brief Method set_value, addr 0x35b8300, size 0x25c, virtual true, abstract: false, final false
