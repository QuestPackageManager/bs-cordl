...
public:
  ...
  /// @brief Method .ctor, addr 0x4a8a920, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x4a8a86c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x4a8a8ac, size 0x74, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x4a8a968, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a8b6d4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetContentContainer, addr 0x4a8a864, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a8a810, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4a8a830, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW templateId);

  /// @brief Method get_contentContainer, addr 0x4a8a85c, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_templateId, addr 0x4a8a7f8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_templateId();

  /// @brief Method set_templateId, addr 0x4a8a800, size 0x8, virtual false, abstract: false, final false
  inline void set_templateId(::StringW value);

  /// @brief Method set_templateSource, addr 0x4a8a808, size 0x8, virtual false, abstract: false, final false
