...
public:
  ...
  /// @brief Method .ctor, addr 0x4a90980, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x4a908cc, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x4a9090c, size 0x74, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x4a909c8, size 0x3dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a91734, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetContentContainer, addr 0x4a908c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a90870, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4a90890, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW templateId);

  /// @brief Method get_contentContainer, addr 0x4a908bc, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_templateId, addr 0x4a90858, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_templateId();

  /// @brief Method set_templateId, addr 0x4a90860, size 0x8, virtual false, abstract: false, final false
  inline void set_templateId(::StringW value);

  /// @brief Method set_templateSource, addr 0x4a90868, size 0x8, virtual false, abstract: false, final false
