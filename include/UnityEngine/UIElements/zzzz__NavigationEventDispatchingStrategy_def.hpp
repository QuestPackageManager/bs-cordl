...
public:
  ...
  /// @brief Method CanDispatchEvent, addr 0x4a2fad4, size 0x54, virtual true, abstract: false, final true
  inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method DispatchEvent, addr 0x4a2fb28, size 0x160, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4a24170, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
