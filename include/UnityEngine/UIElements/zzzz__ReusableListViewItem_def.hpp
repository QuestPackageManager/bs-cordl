...
public:
  ...
  /// @brief Method DetachElement, addr 0x6afcdc4, size 0x90, virtual true, abstract: false, final false
  inline void DetachElement();

  /// @brief Method Init, addr 0x6af2ca4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method PreAttachElement, addr 0x6afcd34, size 0x90, virtual true, abstract: false, final false
  inline void PreAttachElement();

  /// @brief Method SetDragGhost, addr 0x6afce54, size 0x90, virtual true, abstract: false, final false
  inline void SetDragGhost(bool dragGhost);

  /// @brief Method SetDragHandleEnabled, addr 0x6afb1f4, size 0xac, virtual false, abstract: false, final false
  inline void SetDragHandleEnabled(bool enabled);

  /// @brief Method UpdateDragHandle, addr 0x6af332c, size 0x144, virtual false, abstract: false, final false
  inline void UpdateDragHandle(bool needsDragHandle);

  /// @brief Method UpdateHierarchy, addr 0x6afcad0, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6afcee4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_k_SortingDisablesReorderingTooltip();

  /// @brief Method get_rootElement, addr 0x6afcab8, size 0x18, virtual true, abstract: false, final false
