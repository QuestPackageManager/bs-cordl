...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6631))]
...
public:
  ...
  /// @brief Method get_rootElement, addr 0x2ea1998, size 0x18, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_rootElement();

  /// @brief Method Init, addr 0x2e9fd38, size 0x10, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* item, bool usesAnimatedDragger);

  /// @brief Method UpdateHierarchy, addr 0x2ea19b8, size 0x274, virtual false, abstract: false, final false
  inline void UpdateHierarchy(bool usesAnimatedDragger);

  /// @brief Method UpdateDragHandle, addr 0x2e9fe34, size 0x13c, virtual false, abstract: false, final false
  inline void UpdateDragHandle(bool needsDragHandle);

  /// @brief Method PreAttachElement, addr 0x2ea1c2c, size 0x8c, virtual true, abstract: false, final false
  inline void PreAttachElement();

  /// @brief Method DetachElement, addr 0x2ea1d74, size 0x8c, virtual true, abstract: false, final false
  inline void DetachElement();

  static inline ::UnityEngine::UIElements::ReusableListViewItem* New_ctor();

  /// @brief Method .ctor, addr 0x2ea1ef8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
