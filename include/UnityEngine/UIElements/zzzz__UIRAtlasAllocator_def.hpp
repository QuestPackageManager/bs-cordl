...
public:
  ...
  /// @brief Method <.cctor>b__21_0, addr 0x6bf22f8, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_Row* __cctor_b__21_0();

  /// @brief Method .ctor, addr 0x6bf22f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x6bf1f4c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6bf13e4, size 0x98, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x6bf2184, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::UIRAtlasAllocator_Row*>* getStaticF_s_Pool();

  /// @brief Method get_offsetX, addr 0x6bf214c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetX();

  /// @brief Method get_offsetY, addr 0x6bf215c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetY();

  /// @brief Method get_width, addr 0x6bf216c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_height, addr 0x6bf217c, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_offsetX, addr 0x6bf2154, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetX(int32_t value);

  /// @brief Method set_offsetY, addr 0x6bf2164, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetY(int32_t value);

  /// @brief Method set_width, addr 0x6bf2174, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__9_0, addr 0x6bf24b0, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* __cctor_b__9_0();

  /// @brief Method .ctor, addr 0x6bf24ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x6bf1838, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* Acquire(::UnityEngine::RectInt rect);

  /// @brief Method AddAfter, addr 0x6bf201c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x6bf147c, size 0x88, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method RemoveFromChain, addr 0x6bf2000, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf233c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildAreas, addr 0x6bf18d8, size 0xec, virtual false, abstract: false, final false
  inline void BuildAreas();

  /// @brief Method Dispose, addr 0x6bf12e4, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6bf1354, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetLog2OfNextPower, addr 0x6bf1504, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocate, addr 0x6bf19c4, size 0x400, virtual false, abstract: false, final false
  inline bool TryAllocate(int32_t width, int32_t height, ::ByRef<::UnityEngine::RectInt> location);

  /// @brief Method TryPartitionArea, addr 0x6bf1dc4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf1658, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x6bf12d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_maxAtlasSize, addr 0x6bf127c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxAtlasSize();

  /// @brief Method get_maxImageHeight, addr 0x6bf128c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageHeight();

  /// @brief Method get_maxImageWidth, addr 0x6bf1284, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageWidth();

  /// @brief Method get_physicalHeight, addr 0x6bf12c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalHeight();

  /// @brief Method get_physicalWidth, addr 0x6bf12b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalWidth();

  /// @brief Method get_virtualHeight, addr 0x6bf12a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_virtualHeight();

  /// @brief Method get_virtualWidth, addr 0x6bf1294, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x6bf12dc, size 0x8, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_physicalHeight, addr 0x6bf12cc, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalHeight(int32_t value);

  /// @brief Method set_physicalWidth, addr 0x6bf12bc, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalWidth(int32_t value);

  /// @brief Method set_virtualHeight, addr 0x6bf12ac, size 0x8, virtual false, abstract: false, final false
  inline void set_virtualHeight(int32_t value);

  /// @brief Method set_virtualWidth, addr 0x6bf129c, size 0x8, virtual false, abstract: false, final false
