...
public:
  ...
  /// @brief Method <.cctor>b__21_0, addr 0x4a55298, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_Row* __cctor_b__21_0();

  /// @brief Method .ctor, addr 0x4a55290, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x4a54ef0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x4a54440, size 0x90, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x4a5511c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::UIRAtlasAllocator_Row*>* getStaticF_s_Pool();

  /// @brief Method get_offsetX, addr 0x4a550e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetX();

  /// @brief Method get_offsetY, addr 0x4a550f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetY();

  /// @brief Method get_width, addr 0x4a55104, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_height, addr 0x4a55114, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_offsetX, addr 0x4a550ec, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetX(int32_t value);

  /// @brief Method set_offsetY, addr 0x4a550fc, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetY(int32_t value);

  /// @brief Method set_width, addr 0x4a5510c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__9_0, addr 0x4a55468, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* __cctor_b__9_0();

  /// @brief Method .ctor, addr 0x4a55460, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x4a54824, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* Acquire(::UnityEngine::RectInt rect);

  /// @brief Method AddAfter, addr 0x4a54fc4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x4a544d0, size 0x80, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method RemoveFromChain, addr 0x4a54f9c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a552ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildAreas, addr 0x4a548bc, size 0xf8, virtual false, abstract: false, final false
  inline void BuildAreas();

  /// @brief Method Dispose, addr 0x4a54344, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4a543b0, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetLog2OfNextPower, addr 0x4a54550, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocate, addr 0x4a549b4, size 0x3b4, virtual false, abstract: false, final false
  inline bool TryAllocate(int32_t width, int32_t height, ::ByRef<::UnityEngine::RectInt> location);

  /// @brief Method TryPartitionArea, addr 0x4a54d68, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a54680, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x4a54330, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_maxAtlasSize, addr 0x4a542d8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxAtlasSize();

  /// @brief Method get_maxImageHeight, addr 0x4a542e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageHeight();

  /// @brief Method get_maxImageWidth, addr 0x4a542e0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageWidth();

  /// @brief Method get_physicalHeight, addr 0x4a54320, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalHeight();

  /// @brief Method get_physicalWidth, addr 0x4a54310, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalWidth();

  /// @brief Method get_virtualHeight, addr 0x4a54300, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_virtualHeight();

  /// @brief Method get_virtualWidth, addr 0x4a542f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x4a54338, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_physicalHeight, addr 0x4a54328, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalHeight(int32_t value);

  /// @brief Method set_physicalWidth, addr 0x4a54318, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalWidth(int32_t value);

  /// @brief Method set_virtualHeight, addr 0x4a54308, size 0x8, virtual false, abstract: false, final false
  inline void set_virtualHeight(int32_t value);

  /// @brief Method set_virtualWidth, addr 0x4a542f8, size 0x8, virtual false, abstract: false, final false
