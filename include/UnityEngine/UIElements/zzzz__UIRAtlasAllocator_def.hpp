...
public:
  ...
  /// @brief Method <.cctor>b__21_0, addr 0x4a463ac, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_Row* __cctor_b__21_0();

  /// @brief Method .ctor, addr 0x4a463a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x4a46004, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x4a45554, size 0x90, virtual false, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method .ctor, addr 0x4a46230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::UIRAtlasAllocator_Row*>* getStaticF_s_Pool();

  /// @brief Method get_offsetX, addr 0x4a461f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetX();

  /// @brief Method get_offsetY, addr 0x4a46208, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_offsetY();

  /// @brief Method get_width, addr 0x4a46218, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_height, addr 0x4a46228, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_offsetX, addr 0x4a46200, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetX(int32_t value);

  /// @brief Method set_offsetY, addr 0x4a46210, size 0x8, virtual false, abstract: false, final false
  inline void set_offsetY(int32_t value);

  /// @brief Method set_width, addr 0x4a46220, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__9_0, addr 0x4a4657c, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* __cctor_b__9_0();

  /// @brief Method .ctor, addr 0x4a46574, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Acquire, addr 0x4a45938, size 0x98, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::UIRAtlasAllocator_AreaNode* Acquire(::UnityEngine::RectInt rect);

  /// @brief Method AddAfter, addr 0x4a460d8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x4a455e4, size 0x80, virtual false, abstract: false, final false
  inline void Release();

  /// @brief Method RemoveFromChain, addr 0x4a460b0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a46400, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildAreas, addr 0x4a459d0, size 0xf8, virtual false, abstract: false, final false
  inline void BuildAreas();

  /// @brief Method Dispose, addr 0x4a45458, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4a454c4, size 0x90, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetLog2OfNextPower, addr 0x4a45664, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocate, addr 0x4a45ac8, size 0x3b4, virtual false, abstract: false, final false
  inline bool TryAllocate(int32_t width, int32_t height, ::ByRef<::UnityEngine::RectInt> location);

  /// @brief Method TryPartitionArea, addr 0x4a45e7c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a45794, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x4a45444, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_maxAtlasSize, addr 0x4a453ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxAtlasSize();

  /// @brief Method get_maxImageHeight, addr 0x4a453fc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageHeight();

  /// @brief Method get_maxImageWidth, addr 0x4a453f4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxImageWidth();

  /// @brief Method get_physicalHeight, addr 0x4a45434, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalHeight();

  /// @brief Method get_physicalWidth, addr 0x4a45424, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_physicalWidth();

  /// @brief Method get_virtualHeight, addr 0x4a45414, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_virtualHeight();

  /// @brief Method get_virtualWidth, addr 0x4a45404, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x4a4544c, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_physicalHeight, addr 0x4a4543c, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalHeight(int32_t value);

  /// @brief Method set_physicalWidth, addr 0x4a4542c, size 0x8, virtual false, abstract: false, final false
  inline void set_physicalWidth(int32_t value);

  /// @brief Method set_virtualHeight, addr 0x4a4541c, size 0x8, virtual false, abstract: false, final false
  inline void set_virtualHeight(int32_t value);

  /// @brief Method set_virtualWidth, addr 0x4a4540c, size 0x8, virtual false, abstract: false, final false
