...
/// @brief Method DetachElement, addr 0x6a8b5f0, size 0x1b8, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Indent, addr 0x6a84380, size 0x14, virtual false, abstract: false, final false
inline void Indent(int32_t  depth) ;

/// @brief Method Init, addr 0x6a8b364, size 0xd4, virtual true, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  item) ;

/// @brief Method InitExpandHierarchy, addr 0x6a8ad78, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method OnPointerUp, addr 0x6a8bb00, size 0x1c, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnToggleGeometryChanged, addr 0x6a8b8ec, size 0x214, virtual false, abstract: false, final false
inline void OnToggleGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnToggleValueChanged, addr 0x6a8bb1c, size 0x1c, virtual false, abstract: false, final false
inline void OnToggleValueChanged(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method PreAttachElement, addr 0x6a8b438, size 0x1b8, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetExpandedWithoutNotify, addr 0x6a843e4, size 0x20, virtual false, abstract: false, final false
inline void SetExpandedWithoutNotify(bool  expanded) ;

/// @brief Method SetToggleVisibility, addr 0x6a84458, size 0x18, virtual false, abstract: false, final false
inline void SetToggleVisibility(bool  visible) ;

/// @brief Method UpdateIndentLayout, addr 0x6a8b7a8, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6a8b228, size 0x124, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onPointerUp, addr 0x6a84758, size 0xc0, virtual false, abstract: false, final false
inline void add_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method add_onToggleValueChanged, addr 0x6a84818, size 0xc0, virtual false, abstract: false, final false
inline void add_onToggleValueChanged(::System::Action_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  value) ;

/// @brief Method get_rootElement, addr 0x6a8b34c, size 0x18, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootElement() ;

/// @brief Method remove_onPointerUp, addr 0x6a845b8, size 0xc0, virtual false, abstract: false, final false
inline void remove_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method remove_onToggleValueChanged, addr 0x6a84678, size 0xc0, virtual false, abstract: false, final false
