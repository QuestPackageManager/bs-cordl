...
public:
  ...
  /// @brief Method .ctor, addr 0x6c31718, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_paths, addr 0x6c32a90, size 0x8, virtual true, abstract: false, final false
