...
public:
  ...
  /// @brief Method SetGenericData, addr 0x6c32b68, size 0x98, virtual false, abstract: false, final false
  inline void SetGenericData(::StringW key, ::System::Object* data);

  /// @brief Method .ctor, addr 0x6c30bd4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW title, ::UnityEngine::UIElements::DragVisualMode visualMode);

  /// @brief Method get_assetPaths, addr 0x6c32b58, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_assetPaths();

  /// @brief Method get_genericData, addr 0x6c32b38, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Hashtable* get_genericData();

  /// @brief Method get_title, addr 0x6c32b28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_title();

  /// @brief Method get_unityObjectReferences, addr 0x6c32b48, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Object>>* get_unityObjectReferences();

  /// @brief Method get_visualMode, addr 0x6c32b30, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DragVisualMode get_visualMode();

  /// @brief Method set_assetPaths, addr 0x6c32b60, size 0x8, virtual false, abstract: false, final false
  inline void set_assetPaths(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_genericData, addr 0x6c32b40, size 0x8, virtual false, abstract: false, final false
  inline void set_genericData(::System::Collections::Hashtable* value);

  /// @brief Method set_unityObjectReferences, addr 0x6c32b50, size 0x8, virtual false, abstract: false, final false
