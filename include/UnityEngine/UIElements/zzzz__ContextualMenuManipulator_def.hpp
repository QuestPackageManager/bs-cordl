...
public:
  ...
  /// @brief Method DoDisplayMenu, addr 0x4981078, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnContextualMenuEvent, addr 0x4981278, size 0x1c, virtual false, abstract: false, final false
  inline void OnContextualMenuEvent(::UnityEngine::UIElements::ContextualMenuPopulateEvent* evt);

  /// @brief Method OnKeyUpEvent, addr 0x4981214, size 0x64, virtual false, abstract: false, final false
  inline void OnKeyUpEvent(::UnityEngine::UIElements::KeyUpEvent* evt);

  /// @brief Method OnMouseDownEventOSX, addr 0x4981114, size 0x88, virtual false, abstract: false, final false
  inline void OnMouseDownEventOSX(::UnityEngine::UIElements::MouseDownEvent* evt);

  /// @brief Method OnMouseUpDownEvent, addr 0x4980fd8, size 0xa0, virtual false, abstract: false, final false
  inline void OnMouseUpDownEvent(::UnityEngine::UIElements::IMouseEvent* evt);

  /// @brief Method OnMouseUpEventOSX, addr 0x498119c, size 0x78, virtual false, abstract: false, final false
  inline void OnMouseUpEventOSX(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x4980a48, size 0x2c8, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x4980d10, size 0x2c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49808cc, size 0x17c, virtual false, abstract: false, final false
