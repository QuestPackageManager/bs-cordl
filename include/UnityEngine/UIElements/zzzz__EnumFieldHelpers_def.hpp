...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::EnumFieldHelpers*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::EnumFieldHelpers*, "UnityEngine.UIElements", "EnumFieldHelpers");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnumFieldHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnumFieldHelpers(EnumFieldHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnumFieldHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnumFieldHelpers(EnumFieldHelpersconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::EnumFieldHelpers) == 0x10, "Size mismatch!");
