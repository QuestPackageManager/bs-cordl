...
/// @brief Method ExtractValue, addr 0x6b73944, size 0x368, virtual false, abstract: false, final false
static inline bool ExtractValue(::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc, ::ByRef<::System::Type*>  resEnumType, ::ByRef<::System::Enum*>  resEnumValue, ::ByRef<bool>  resIncludeObsoleteValues) ;
