...
public:
  ...
  /// @brief Method Equals, addr 0x6cbde64, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbde70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
