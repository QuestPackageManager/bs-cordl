...
public:
  ...
  /// @brief Method Equals, addr 0x6af5b2c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6af5b38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
