...
public:
  ...
  /// @brief Method Init, addr 0x2e9cf84, size 0x260, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__InternalTreeView__UxmlTraits* New_ctor();

  /// @brief Method .ctor, addr 0x2e9d1e4, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__UxmlTraits, ___m_ItemHeight) == 0x70, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__UxmlTraits, ___m_ShowBorder) == 0x78, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__UxmlTraits, ___m_SelectionType) == 0x80, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__UxmlTraits, ___m_ShowAlternatingRowBackgrounds) == 0x88, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_ItemWrappers,
                      put = __cordl_internal_set_m_ItemWrappers))::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>* m_ItemWrappers;
  ...
  constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>*& __cordl_internal_get_m_ItemWrappers();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>*> const&
  __cordl_internal_get_m_ItemWrappers() const;

  constexpr void __cordl_internal_set_m_ItemWrappers(::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>* value);
  ...
  /// @brief Method get_unbindItem, addr 0x2e99cd8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_2<::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::ITreeViewItem*>* get_unbindItem();

  /// @brief Method set_itemHeight, addr 0x2e99ce0, size 0x20, virtual false, abstract: false, final false
  inline void set_itemHeight(int32_t value);

  /// @brief Method set_showBorder, addr 0x2e99d00, size 0x20, virtual false, abstract: false, final false
  inline void set_showBorder(bool value);

  /// @brief Method set_selectionType, addr 0x2e99d20, size 0x1c, virtual false, abstract: false, final false
  inline void set_selectionType(::UnityEngine::UIElements::SelectionType value);

  /// @brief Method set_showAlternatingRowBackgrounds, addr 0x2e99d3c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e99d58, size 0x554, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method RefreshItems, addr 0x2e9a2ac, size 0x24, virtual false, abstract: false, final false
  inline void RefreshItems();

  /// @brief Method Rebuild, addr 0x2e9a374, size 0x24, virtual false, abstract: false, final false
  inline void Rebuild();

  /// @brief Method OnViewDataReady, addr 0x2e9a398, size 0x3c, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method GetAllItems, addr 0x2e9a3d4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method OnKeyDown, addr 0x2e9a47c, size 0xbc, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method ListViewRefresh, addr 0x2e9a358, size 0x1c, virtual false, abstract: false, final false
  inline void ListViewRefresh();

  /// @brief Method OnItemsChosen, addr 0x2e9ab28, size 0x420, virtual false, abstract: false, final false
  inline void OnItemsChosen(::System::Collections::Generic::IEnumerable_1<::System::Object*>* chosenItems);

  /// @brief Method OnSelectionChange, addr 0x2e9af48, size 0x454, virtual false, abstract: false, final false
  inline void OnSelectionChange(::System::Collections::Generic::IEnumerable_1<::System::Object*>* selectedListItems);

  /// @brief Method OnTreeViewMouseUp, addr 0x2e9b39c, size 0x38, virtual false, abstract: false, final false
  inline void OnTreeViewMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnItemMouseUp, addr 0x2e9b3d4, size 0x7fc, virtual false, abstract: false, final false
  inline void OnItemMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method MakeTreeItem, addr 0x2e9bbd0, size 0x4e0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* MakeTreeItem();

  /// @brief Method UnbindTreeItem, addr 0x2e9c0b0, size 0x11c, virtual false, abstract: false, final false
  inline void UnbindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method BindTreeItem, addr 0x2e9c1cc, size 0x35c, virtual false, abstract: false, final false
  inline void BindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method GetItemId, addr 0x2e9c528, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetItemId(int32_t index);

  /// @brief Method IsExpandedByIndex, addr 0x2e9a538, size 0x9c, virtual false, abstract: false, final false
  inline bool IsExpandedByIndex(int32_t index);

  /// @brief Method CollapseItemByIndex, addr 0x2e9a8dc, size 0x24c, virtual false, abstract: false, final false
  inline void CollapseItemByIndex(int32_t index);

  /// @brief Method ExpandItemByIndex, addr 0x2e9a5d4, size 0x308, virtual false, abstract: false, final false
  inline void ExpandItemByIndex(int32_t index);

  /// @brief Method ToggleExpandedState, addr 0x2e9cb5c, size 0x184, virtual false, abstract: false, final false
  inline void ToggleExpandedState(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method CreateWrappers, addr 0x2e9c63c, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method RegenerateWrappers, addr 0x2e9a2d0, size 0x88, virtual false, abstract: false, final false
  inline void RegenerateWrappers();

  /// @brief Method OnCustomStyleResolved, addr 0x2e9cce0, size 0x150, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_MakeItem) == 0x3b0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___onItemsChosen) == 0x3b8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___onSelectionChange) == 0x3c0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_SelectedItems) == 0x3c8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_BindItem) == 0x3d0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ____unbindItem_k__BackingField) == 0x3d8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_RootItems) == 0x3e0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_ExpandedItemIds) == 0x3e8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_ItemWrappers) == 0x3f0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_ListView) == 0x3f8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::InternalTreeView, ___m_ScrollView) == 0x400, "Offset mismatch!");
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6256)), TypeDefinitionIndex(TypeDefinitionIndex(6606)), TypeDefinitionIndex(TypeDefinitionIndex(6609)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6256), inst: 5245 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(6605)) CS Name: ::InternalTreeView::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e9cf3c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_id, addr 0x2e9c59c, size 0xa0, virtual false, abstract: false, final false
...
static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper, depth) == 0x0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper, item) == 0x8, "Offset mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e9a438, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2e9d3f0, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2e9d3f4, size 0x3f8, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current, addr 0x2e9d7ec, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2e9d7f4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2e9d834, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator, addr 0x2e9d83c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2e9d8dc, size 0x4, virtual true, abstract: false, final true
...
static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, _____l__initialThreadId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, ___rootItems) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, _____3__rootItems) == 0x30, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, ____iteratorStack_5__1) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, ____currentIterator_5__2) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, ____hasNext_5__3) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::__InternalTreeView___GetAllItems_d__64, ____currentItem_5__4) == 0x50, "Offset mismatch!");
