...
public:
  ...
  /// @brief Method Init, addr 0x2e82b9c, size 0x260, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__InternalTreeView__UxmlTraits* New_ctor();

  /// @brief Method .ctor, addr 0x2e82dfc, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_unbindItem, addr 0x2e7f8f0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_2<::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::ITreeViewItem*>* get_unbindItem();

  /// @brief Method set_itemHeight, addr 0x2e7f8f8, size 0x20, virtual false, abstract: false, final false
  inline void set_itemHeight(int32_t value);

  /// @brief Method set_showBorder, addr 0x2e7f918, size 0x20, virtual false, abstract: false, final false
  inline void set_showBorder(bool value);

  /// @brief Method set_selectionType, addr 0x2e7f938, size 0x1c, virtual false, abstract: false, final false
  inline void set_selectionType(::UnityEngine::UIElements::SelectionType value);

  /// @brief Method set_showAlternatingRowBackgrounds, addr 0x2e7f954, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e7f970, size 0x554, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method RefreshItems, addr 0x2e7fec4, size 0x24, virtual false, abstract: false, final false
  inline void RefreshItems();

  /// @brief Method Rebuild, addr 0x2e7ff8c, size 0x24, virtual false, abstract: false, final false
  inline void Rebuild();

  /// @brief Method OnViewDataReady, addr 0x2e7ffb0, size 0x3c, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method GetAllItems, addr 0x2e7ffec, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method OnKeyDown, addr 0x2e80094, size 0xbc, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method ListViewRefresh, addr 0x2e7ff70, size 0x1c, virtual false, abstract: false, final false
  inline void ListViewRefresh();

  /// @brief Method OnItemsChosen, addr 0x2e80740, size 0x420, virtual false, abstract: false, final false
  inline void OnItemsChosen(::System::Collections::Generic::IEnumerable_1<::System::Object*>* chosenItems);

  /// @brief Method OnSelectionChange, addr 0x2e80b60, size 0x454, virtual false, abstract: false, final false
  inline void OnSelectionChange(::System::Collections::Generic::IEnumerable_1<::System::Object*>* selectedListItems);

  /// @brief Method OnTreeViewMouseUp, addr 0x2e80fb4, size 0x38, virtual false, abstract: false, final false
  inline void OnTreeViewMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnItemMouseUp, addr 0x2e80fec, size 0x7fc, virtual false, abstract: false, final false
  inline void OnItemMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method MakeTreeItem, addr 0x2e817e8, size 0x4e0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* MakeTreeItem();

  /// @brief Method UnbindTreeItem, addr 0x2e81cc8, size 0x11c, virtual false, abstract: false, final false
  inline void UnbindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method BindTreeItem, addr 0x2e81de4, size 0x35c, virtual false, abstract: false, final false
  inline void BindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method GetItemId, addr 0x2e82140, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetItemId(int32_t index);

  /// @brief Method IsExpandedByIndex, addr 0x2e80150, size 0x9c, virtual false, abstract: false, final false
  inline bool IsExpandedByIndex(int32_t index);

  /// @brief Method CollapseItemByIndex, addr 0x2e804f4, size 0x24c, virtual false, abstract: false, final false
  inline void CollapseItemByIndex(int32_t index);

  /// @brief Method ExpandItemByIndex, addr 0x2e801ec, size 0x308, virtual false, abstract: false, final false
  inline void ExpandItemByIndex(int32_t index);

  /// @brief Method ToggleExpandedState, addr 0x2e82774, size 0x184, virtual false, abstract: false, final false
  inline void ToggleExpandedState(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method CreateWrappers, addr 0x2e82254, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method RegenerateWrappers, addr 0x2e7fee8, size 0x88, virtual false, abstract: false, final false
  inline void RegenerateWrappers();

  /// @brief Method OnCustomStyleResolved, addr 0x2e828f8, size 0x150, virtual false, abstract: false, final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7347)), TypeDefinitionIndex(TypeDefinitionIndex(7350)),
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e82b54, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_id, addr 0x2e821b4, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e80050, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x2e83008, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x2e8300c, size 0x3f8, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current, addr 0x2e83404, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2e8340c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2e8344c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator, addr 0x2e83454, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2e834f4, size 0x4, virtual true, abstract: false, final true
