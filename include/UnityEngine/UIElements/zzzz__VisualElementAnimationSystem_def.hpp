...
public:
  ...
  /// @brief Method get_profilerMarker, addr 0x2db6f78, size 0x58, virtual true, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_stylePropertyAnimationProfilerMarker, addr 0x2db6fd0, size 0x58, virtual false, abstract: false, final false
  static inline ::Unity::Profiling::ProfilerMarker get_stylePropertyAnimationProfilerMarker();

  /// @brief Method UnregisterAnimation, addr 0x2db7028, size 0x64, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterAnimations, addr 0x2db708c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAnimation, addr 0x2db7204, size 0x64, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterAnimations, addr 0x2db7268, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2db73e0, size 0x46c, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method OnVersionChanged, addr 0x2db7928, size 0x4, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  static inline ::UnityEngine::UIElements::VisualElementAnimationSystem* New_ctor();

  /// @brief Method .ctor, addr 0x2db792c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
