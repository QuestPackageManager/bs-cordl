...
public:
  ...
  /// @brief Method get_profilerMarker addr 0x2c4fbc8 size 0x58 virtual true final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_stylePropertyAnimationProfilerMarker addr 0x2c4fc20 size 0x58 virtual false final false
  static inline ::Unity::Profiling::ProfilerMarker get_stylePropertyAnimationProfilerMarker();

  /// @brief Method UnregisterAnimation addr 0x2c4fc78 size 0x64 virtual false final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterAnimations addr 0x2c4fcdc size 0x178 virtual false final false
  ...
  /// @brief Method RegisterAnimation addr 0x2c4fe54 size 0x64 virtual false final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterAnimations addr 0x2c4feb8 size 0x178 virtual false final false
  ...
  /// @brief Method Update addr 0x2c50030 size 0x46c virtual true final false
  inline void Update();

  /// @brief Method OnVersionChanged addr 0x2c50578 size 0x4 virtual true final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  static inline ::UnityEngine::UIElements::VisualElementAnimationSystem* New_ctor();

  /// @brief Method .ctor addr 0x2c5057c size 0xc4 virtual false final false
  inline void _ctor();
