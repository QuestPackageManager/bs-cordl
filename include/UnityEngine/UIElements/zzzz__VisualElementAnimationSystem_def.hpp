...
public:
  ...
  /// @brief Method get_profilerMarker, addr 0x2dd5360, size 0x58, virtual true, abstract: false, final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method get_stylePropertyAnimationProfilerMarker, addr 0x2dd53b8, size 0x58, virtual false, abstract: false, final false
  static inline ::Unity::Profiling::ProfilerMarker get_stylePropertyAnimationProfilerMarker();

  /// @brief Method UnregisterAnimation, addr 0x2dd5410, size 0x64, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterAnimations, addr 0x2dd5474, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAnimation, addr 0x2dd55ec, size 0x64, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterAnimations, addr 0x2dd5650, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2dd57c8, size 0x46c, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method OnVersionChanged, addr 0x2dd5d10, size 0x4, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  static inline ::UnityEngine::UIElements::VisualElementAnimationSystem* New_ctor();

  /// @brief Method .ctor, addr 0x2dd5d14, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
