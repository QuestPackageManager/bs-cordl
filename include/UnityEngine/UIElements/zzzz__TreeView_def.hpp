...
public:
  ...
  /// @brief Method .ctor, addr 0x35a8614, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x35b410c, size 0x260, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b436c, size 0x208, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_id, addr 0x35b376c, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x35b4578, size 0x3f8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UIElements::__TreeView___GetAllItems_d__64* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator, addr 0x35b49c0, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current, addr 0x35b4970, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x35b4a60, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x35b4978, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x35b49b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x35b4574, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35b1608, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BindTreeItem, addr 0x35b339c, size 0x35c, virtual false, abstract: false, final false
  inline void BindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method CollapseItemByIndex, addr 0x35b1aac, size 0x24c, virtual false, abstract: false, final false
  inline void CollapseItemByIndex(int32_t index);

  /// @brief Method CreateWrappers, addr 0x35b380c, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method ExpandItemByIndex, addr 0x35b17a4, size 0x308, virtual false, abstract: false, final false
  inline void ExpandItemByIndex(int32_t index);

  /// @brief Method GetAllItems, addr 0x35b15a4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method GetItemId, addr 0x35b36f8, size 0x74, virtual false, abstract: false, final false
  inline int32_t GetItemId(int32_t index);

  /// @brief Method IsExpandedByIndex, addr 0x35b1708, size 0x9c, virtual false, abstract: false, final false
  inline bool IsExpandedByIndex(int32_t index);

  /// @brief Method ListViewRefresh, addr 0x35b1528, size 0x1c, virtual false, abstract: false, final false
  inline void ListViewRefresh();

  /// @brief Method MakeTreeItem, addr 0x35b2da0, size 0x4e0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* MakeTreeItem();

  static inline ::UnityEngine::UIElements::TreeView* New_ctor();

  /// @brief Method OnCustomStyleResolved, addr 0x35b3eb0, size 0x150, virtual false, abstract: false, final false
  inline void OnCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent* e);

  /// @brief Method OnItemMouseUp, addr 0x35b25a4, size 0x7fc, virtual false, abstract: false, final false
  inline void OnItemMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnItemsChosen, addr 0x35b1cf8, size 0x420, virtual false, abstract: false, final false
  inline void OnItemsChosen(::System::Collections::Generic::IEnumerable_1<::System::Object*>* chosenItems);

  /// @brief Method OnKeyDown, addr 0x35b164c, size 0xbc, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnSelectionChange, addr 0x35b2118, size 0x454, virtual false, abstract: false, final false
  inline void OnSelectionChange(::System::Collections::Generic::IEnumerable_1<::System::Object*>* selectedListItems);

  /// @brief Method OnTreeViewMouseUp, addr 0x35b256c, size 0x38, virtual false, abstract: false, final false
  inline void OnTreeViewMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnViewDataReady, addr 0x35b1568, size 0x3c, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method Rebuild, addr 0x35b1544, size 0x24, virtual false, abstract: false, final false
  inline void Rebuild();

  /// @brief Method RefreshItems, addr 0x35b147c, size 0x24, virtual false, abstract: false, final false
  inline void RefreshItems();

  /// @brief Method RegenerateWrappers, addr 0x35b14a0, size 0x88, virtual false, abstract: false, final false
  inline void RegenerateWrappers();

  /// @brief Method ToggleExpandedState, addr 0x35b3d2c, size 0x184, virtual false, abstract: false, final false
  inline void ToggleExpandedState(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method UnbindTreeItem, addr 0x35b3280, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b0f28, size 0x554, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_unbindItem, addr 0x35b0ea8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_itemHeight, addr 0x35b0eb0, size 0x20, virtual false, abstract: false, final false
  inline void set_itemHeight(int32_t value);

  /// @brief Method set_selectionType, addr 0x35b0ef0, size 0x1c, virtual false, abstract: false, final false
  inline void set_selectionType(::UnityEngine::UIElements::SelectionType value);

  /// @brief Method set_showAlternatingRowBackgrounds, addr 0x35b0f0c, size 0x1c, virtual false, abstract: false, final false
  inline void set_showAlternatingRowBackgrounds(::UnityEngine::UIElements::AlternatingRowBackground value);

  /// @brief Method set_showBorder, addr 0x35b0ed0, size 0x20, virtual false, abstract: false, final false
