...
public:
  ...
  /// @brief Method Init addr 0x2e1cef0 size 0x260 virtual true final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__TreeView__UxmlTraits* New_ctor();

  /// @brief Method .ctor addr 0x2e1d150 size 0x208 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_unbindItem addr 0x2e19c8c size 0x8 virtual false final false
  inline ::System::Action_2<::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::ITreeViewItem*>* get_unbindItem();

  /// @brief Method set_itemHeight addr 0x2e19c94 size 0x20 virtual false final false
  inline void set_itemHeight(int32_t value);

  /// @brief Method set_showBorder addr 0x2e19cb4 size 0x20 virtual false final false
  inline void set_showBorder(bool value);

  /// @brief Method set_selectionType addr 0x2e19cd4 size 0x1c virtual false final false
  inline void set_selectionType(::UnityEngine::UIElements::SelectionType value);

  /// @brief Method set_showAlternatingRowBackgrounds addr 0x2e19cf0 size 0x1c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2e19d0c size 0x554 virtual false final false
  inline void _ctor();

  /// @brief Method RefreshItems addr 0x2e1a260 size 0x24 virtual false final false
  inline void RefreshItems();

  /// @brief Method Rebuild addr 0x2e1a328 size 0x24 virtual false final false
  inline void Rebuild();

  /// @brief Method OnViewDataReady addr 0x2e1a34c size 0x3c virtual true final false
  inline void OnViewDataReady();

  /// @brief Method GetAllItems addr 0x2e1a388 size 0x64 virtual false final false
  ...
  /// @brief Method OnKeyDown addr 0x2e1a430 size 0xbc virtual false final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method ListViewRefresh addr 0x2e1a30c size 0x1c virtual false final false
  inline void ListViewRefresh();

  /// @brief Method OnItemsChosen addr 0x2e1aadc size 0x420 virtual false final false
  inline void OnItemsChosen(::System::Collections::Generic::IEnumerable_1<::System::Object*>* chosenItems);

  /// @brief Method OnSelectionChange addr 0x2e1aefc size 0x454 virtual false final false
  inline void OnSelectionChange(::System::Collections::Generic::IEnumerable_1<::System::Object*>* selectedListItems);

  /// @brief Method OnTreeViewMouseUp addr 0x2e1b350 size 0x38 virtual false final false
  inline void OnTreeViewMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnItemMouseUp addr 0x2e1b388 size 0x7fc virtual false final false
  inline void OnItemMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method MakeTreeItem addr 0x2e1bb84 size 0x4e0 virtual false final false
  inline ::UnityEngine::UIElements::VisualElement* MakeTreeItem();

  /// @brief Method UnbindTreeItem addr 0x2e1c064 size 0x11c virtual false final false
  inline void UnbindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method BindTreeItem addr 0x2e1c180 size 0x35c virtual false final false
  inline void BindTreeItem(::UnityEngine::UIElements::VisualElement* element, int32_t index);

  /// @brief Method GetItemId addr 0x2e1c4dc size 0x74 virtual false final false
  inline int32_t GetItemId(int32_t index);

  /// @brief Method IsExpandedByIndex addr 0x2e1a4ec size 0x9c virtual false final false
  inline bool IsExpandedByIndex(int32_t index);

  /// @brief Method CollapseItemByIndex addr 0x2e1a890 size 0x24c virtual false final false
  inline void CollapseItemByIndex(int32_t index);

  /// @brief Method ExpandItemByIndex addr 0x2e1a588 size 0x308 virtual false final false
  inline void ExpandItemByIndex(int32_t index);

  /// @brief Method ToggleExpandedState addr 0x2e1cb10 size 0x184 virtual false final false
  inline void ToggleExpandedState(::UnityEngine::UIElements::ChangeEvent_1<bool>* evt);

  /// @brief Method CreateWrappers addr 0x2e1c5f0 size 0x520 virtual false final false
  ...
  /// @brief Method RegenerateWrappers addr 0x2e1a284 size 0x88 virtual false final false
  inline void RegenerateWrappers();

  /// @brief Method OnCustomStyleResolved addr 0x2e1cc94 size 0x150 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7034)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5282
// }), TypeDefinitionIndex(TypeDefinitionIndex(7031))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7030)) CS Name: ::TreeView::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor addr 0x2e113f8 size 0x48 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_id addr 0x2e1c550 size 0xa0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2e1a3ec size 0x44 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x2e1d358 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x2e1d35c size 0x3f8 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current addr 0x2e1d754 size 0x8 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2e1d75c size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2e1d79c size 0x8 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator addr 0x2e1d7a4 size 0xa0 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2e1d844 size 0x4 virtual true final true
