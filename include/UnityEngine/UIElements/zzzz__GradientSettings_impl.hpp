...
// Ctor Parameters [CppParam { name: "gradientType", ty: "::UnityEngine::UIElements::GradientType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "addressMode", ty:
// "::UnityEngine::UIElements::AddressMode", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "radialFocus", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "location", ty: "::UnityEngine::RectInt", modifiers: "", def_value: Some("{}"), comment: None }]
