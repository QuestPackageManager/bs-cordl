...
public:
  ...
  /// @brief Method Equals, addr 0x6b395e4, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b39584, size 0x60, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleBackgroundPosition other);

  /// @brief Method GetHashCode, addr 0x6b39664, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6b396ac, size 0x7c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b39520, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6b37d88, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BackgroundPosition v);

  /// @brief Method .ctor, addr 0x6b39514, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BackgroundPosition v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method get_keyword, addr 0x6b39504, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method get_value, addr 0x6b394d8, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Equality, addr 0x6b3952c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x6b37d94, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_keyword, addr 0x6b3950c, size 0x8, virtual true, abstract: false, final true
  inline void set_keyword(::UnityEngine::UIElements::StyleKeyword value);

  /// @brief Method set_value, addr 0x6b394f8, size 0xc, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::StyleBackgroundPosition, 0x10>, "Size mismatch!");

} // namespace UnityEngine::UIElements
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::StyleBackgroundPosition, "UnityEngine.UIElements", "StyleBackgroundPosition");
