...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x6ad23b0, size 0x78, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x6ad23a4, size 0xc, virtual false, abstract: false, final false
