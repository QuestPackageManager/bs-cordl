...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2e83ee0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x2e83eec, size 0x78, virtual true, abstract: false, final false
