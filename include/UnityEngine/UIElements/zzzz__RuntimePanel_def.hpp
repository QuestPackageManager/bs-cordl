...
public:
  ...
  /// @brief Method <.ctor>b__5_0, addr 0x4a479c8, size 0x14, virtual false, abstract: false, final false
  inline void __ctor_b__5_0(::UnityEngine::UIElements::FocusEvent* e, ::UnityEngine::UIElements::RuntimePanel* p);

  /// @brief Method .ctor, addr 0x4a479c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Create, addr 0x4a472c8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method OnElementFocus, addr 0x4a478a0, size 0x78, virtual false, abstract: false, final false
  inline void OnElementFocus(::UnityEngine::UIElements::FocusEvent* evt);

  /// @brief Method Update, addr 0x4a47718, size 0x80, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x4a47320, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_panelSettings, addr 0x4a472c0, size 0x8, virtual true, abstract: false, final true
