...
/// @brief Method FromBindingData, addr 0x6a79b78, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method FromRequest, addr 0x6a79ac8, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BindingInfo FromRequest(::UnityEngine::UIElements::VisualElement*  target, ::ByRef<::Unity::Properties::PropertyPath>  targetPath, ::UnityEngine::UIElements::Binding*  binding) ;

/// @brief Method .ctor, addr 0x6a79a98, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_binding, addr 0x6a79a90, size 0x8, virtual false, abstract: false, final false
