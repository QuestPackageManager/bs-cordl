...
public:
  ...
  /// @brief Method HandleDragAndDrop, addr 0x4a1f8b0, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x4a1f9f8, size 0x2bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a1f88c, size 0x24, virtual false, abstract: false, final false
