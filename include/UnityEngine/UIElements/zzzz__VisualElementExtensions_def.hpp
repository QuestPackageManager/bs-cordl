...
public:
  // Declarations
  /// @brief Method AddManipulator, addr 0x35184ec, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalToWorld, addr 0x3518314, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 LocalToWorld(::UnityEngine::UIElements::VisualElement* ele, ::UnityEngine::Vector2 p);

  /// @brief Method RemoveManipulator, addr 0x3518598, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method WorldToLocal, addr 0x3518400, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect WorldToLocal(::UnityEngine::UIElements::VisualElement* ele, ::UnityEngine::Rect r);

  /// @brief Method WorldToLocal, addr 0x3518228, size 0xec, virtual false, abstract: false, final false
