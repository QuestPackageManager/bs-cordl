...
public:
  ...
  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x49fa5c4, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method OnBlur, addr 0x49fa95c, size 0x54, virtual false, abstract: false, final false
  inline void OnBlur(::UnityEngine::UIElements::BlurEvent* _);

  /// @brief Method OnExecuteCommandEvent, addr 0x49fb58c, size 0x26c, virtual false, abstract: false, final false
  inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent* evt);

  /// @brief Method OnFocus, addr 0x49fa878, size 0xe4, virtual false, abstract: false, final false
  inline void OnFocus(::UnityEngine::UIElements::FocusEvent* _);

  /// @brief Method OnKeyDown, addr 0x49fa9b0, size 0x9c8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidateCommandEvent, addr 0x49fb378, size 0x214, virtual false, abstract: false, final false
  inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent* evt);

  /// @brief Method UpdateLabel, addr 0x49fb7f8, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49fa48c, size 0x10c, virtual false, abstract: false, final false
