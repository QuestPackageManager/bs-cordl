...
public:
  ...
  /// @brief Method HandleEventBubbleUp, addr 0x6d46b94, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method OnBlur, addr 0x6d47c28, size 0x74, virtual false, abstract: false, final false
  inline void OnBlur(::UnityEngine::UIElements::BlurEvent* _);

  /// @brief Method OnExecuteCommandEvent, addr 0x6d478e0, size 0x250, virtual false, abstract: false, final false
  inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent* evt);

  /// @brief Method OnFocus, addr 0x6d47b30, size 0xf8, virtual false, abstract: false, final false
  inline void OnFocus(::UnityEngine::UIElements::FocusEvent* _);

  /// @brief Method OnKeyDown, addr 0x6d46e9c, size 0x838, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidateCommandEvent, addr 0x6d476d4, size 0x20c, virtual false, abstract: false, final false
  inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent* evt);

  /// @brief Method UpdateLabel, addr 0x6d47c9c, size 0x280, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d46a74, size 0x118, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::KeyboardTextEditorEventHandler) == 0x30, "Size mismatch!");
