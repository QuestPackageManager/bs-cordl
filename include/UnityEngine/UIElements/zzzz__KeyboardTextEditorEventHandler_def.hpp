...
/// @brief Method HandleEventBubbleUp, addr 0x6b7ef1c, size 0x304, virtual true, abstract: false, final false
...
/// @brief Method OnBlur, addr 0x6b7ffb0, size 0x74, virtual false, abstract: false, final false
inline void OnBlur(::UnityEngine::UIElements::BlurEvent*  _) ;

/// @brief Method OnExecuteCommandEvent, addr 0x6b7fc68, size 0x250, virtual false, abstract: false, final false
inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent*  evt) ;

/// @brief Method OnFocus, addr 0x6b7feb8, size 0xf8, virtual false, abstract: false, final false
inline void OnFocus(::UnityEngine::UIElements::FocusEvent*  _) ;

/// @brief Method OnKeyDown, addr 0x6b7f224, size 0x838, virtual false, abstract: false, final false
...
/// @brief Method OnValidateCommandEvent, addr 0x6b7fa5c, size 0x20c, virtual false, abstract: false, final false
inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent*  evt) ;

/// @brief Method UpdateLabel, addr 0x6b80024, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b7edfc, size 0x118, virtual false, abstract: false, final false
