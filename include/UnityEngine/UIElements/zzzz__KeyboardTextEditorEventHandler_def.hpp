...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6353)), TypeDefinitionIndex(TypeDefinitionIndex(8987))]
...
public:
  ...
  /// @brief Method get_isClicking, addr 0x2e3b990, size 0x8, virtual false, abstract: false, final false
  inline bool get_isClicking();

  /// @brief Method set_isClicking, addr 0x2e3b998, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e3b9cc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x2e3ba4c, size 0x5bc, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method OnFocus, addr 0x2e3c008, size 0x190, virtual false, abstract: false, final false
  inline void OnFocus(::UnityEngine::UIElements::FocusEvent* _);

  /// @brief Method OnBlur, addr 0x2e3c198, size 0xc, virtual false, abstract: false, final false
  inline void OnBlur(::UnityEngine::UIElements::BlurEvent* _);

  /// @brief Method OnMouseDown, addr 0x2e3c1a4, size 0x3f4, virtual false, abstract: false, final false
  inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent* evt);

  /// @brief Method OnMouseUp, addr 0x2e3c598, size 0x168, virtual false, abstract: false, final false
  inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent* evt);

  /// @brief Method OnMouseMove, addr 0x2e3c700, size 0x148, virtual false, abstract: false, final false
  inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent* evt);

  /// @brief Method ProcessDragMove, addr 0x2e3d7d0, size 0x134, virtual false, abstract: false, final false
  inline void ProcessDragMove(::UnityEngine::UIElements::MouseMoveEvent* evt);

  /// @brief Method MoveDistanceQualifiesForDrag, addr 0x2e3d7ac, size 0x24, virtual false, abstract: false, final false
  inline bool MoveDistanceQualifiesForDrag(::UnityEngine::Vector2 start, ::UnityEngine::Vector2 current);

  /// @brief Method OnKeyDown, addr 0x2e3c848, size 0x608, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnValidateCommandEvent, addr 0x2e3ce50, size 0x364, virtual false, abstract: false, final false
  inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent* evt);

  /// @brief Method OnExecuteCommandEvent, addr 0x2e3d1b4, size 0x5f8, virtual false, abstract: false, final false
  inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent* evt);

  /// @brief Method PreDrawCursor, addr 0x2e3d904, size 0x340, virtual false, abstract: false, final false
  inline void PreDrawCursor(::StringW newText);

  /// @brief Method PostDrawCursor, addr 0x2e3dc44, size 0x24, virtual false, abstract: false, final false
