...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::UIElements::IDelayedField);
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
NEED_NO_BOX(::UnityEngine::UIElements::IDelayedField);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::IDelayedField*, "UnityEngine.UIElements", "IDelayedField");
