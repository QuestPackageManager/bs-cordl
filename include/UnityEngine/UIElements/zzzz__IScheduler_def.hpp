...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IScheduler*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IScheduler*, "UnityEngine.UIElements", "IScheduler");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IScheduler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IScheduler(ISchedulerconst&) = delete;
