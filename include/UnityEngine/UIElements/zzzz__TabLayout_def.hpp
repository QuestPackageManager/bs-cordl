...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TabLayout", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TabLayout(TabLayout&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TabLayout", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TabLayout(TabLayoutconst&) = delete;
