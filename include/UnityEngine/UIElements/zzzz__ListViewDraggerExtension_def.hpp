...
public:
  // Declarations
  /// @brief Method GetRecycledItemFromId, addr 0x4a18d34, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRecycledItemFromIndex, addr 0x4a1d360, size 0x344, virtual false, abstract: false, final false
