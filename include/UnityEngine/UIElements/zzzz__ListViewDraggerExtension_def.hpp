...
public:
  // Declarations
  /// @brief Method GetRecycledItemFromId, addr 0x4a1259c, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRecycledItemFromIndex, addr 0x4a16bc8, size 0x344, virtual false, abstract: false, final false
