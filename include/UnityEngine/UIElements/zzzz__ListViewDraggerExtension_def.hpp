...
public:
  // Declarations
  /// @brief Method GetRecycledItemFromId, addr 0x6bc4268, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRecycledItemFromIndex, addr 0x6bc4564, size 0x2fc, virtual false, abstract: false, final false
