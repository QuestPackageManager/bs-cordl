...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7451))}
...
public:
  ...
  /// @brief Method add_itemsSourceSizeChanged addr 0x2d1ccc0 size 0x9c virtual false final false
  inline void add_itemsSourceSizeChanged(::System::Action* value);

  /// @brief Method remove_itemsSourceSizeChanged addr 0x2d1cd5c size 0x9c virtual false final false
  inline void remove_itemsSourceSizeChanged(::System::Action* value);

  /// @brief Method add_itemsAdded addr 0x2d1cdf8 size 0xb0 virtual false final false
  inline void add_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method remove_itemsAdded addr 0x2d1cea8 size 0xb0 virtual false final false
  inline void remove_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method add_itemsRemoved addr 0x2d1cf58 size 0xb0 virtual false final false
  inline void add_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method remove_itemsRemoved addr 0x2d1d008 size 0xb0 virtual false final false
  inline void remove_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>* value);

  /// @brief Method get_listView addr 0x2d1d0b8 size 0x7c virtual false final false
  inline ::UnityEngine::UIElements::ListView* get_listView();

  /// @brief Method InvokeMakeItem addr 0x2d1d134 size 0x46c virtual true final false
  inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem);

  /// @brief Method InvokeBindItem addr 0x2d1d5b0 size 0xec virtual true final false
  inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem* reusableItem, int32_t index);

  /// @brief Method NeedsDragHandle addr 0x2d1d8a0 size 0x3c virtual true final false
  inline bool NeedsDragHandle(int32_t index);

  /// @brief Method AddItems addr 0x2d1d8dc size 0x520 virtual true final false
  inline void AddItems(int32_t itemCount);

  /// @brief Method Move addr 0x2d1e050 size 0x9c virtual true final false
  inline void Move(int32_t index, int32_t newIndex);

  /// @brief Method RemoveItem addr 0x2d1e300 size 0x1b0 virtual true final false
  inline void RemoveItem(int32_t index);

  /// @brief Method RemoveItems addr 0x2d1e4b0 size 0x260 virtual true final false
  inline void RemoveItems(::System::Collections::Generic::List_1<int32_t>* indices);

  /// @brief Method RaiseOnSizeChanged addr 0x2d1e034 size 0x1c virtual false final false
  inline void RaiseOnSizeChanged();

  /// @brief Method RaiseItemsAdded addr 0x2d1e018 size 0x1c virtual false final false
  inline void RaiseItemsAdded(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method RaiseItemsRemoved addr 0x2d1e8c4 size 0x1c virtual false final false
  inline void RaiseItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method AddToArray addr 0x2d1df14 size 0xd8 virtual false final false
  static inline ::System::Array* AddToArray(::System::Array* source, int32_t itemCount);

  /// @brief Method RemoveFromArray addr 0x2d1e710 size 0x1b4 virtual false final false
  static inline ::System::Array* RemoveFromArray(::System::Array* source, ::System::Collections::Generic::List_1<int32_t>* indicesToRemove);

  /// @brief Method Swap addr 0x2d1e0ec size 0x1f8 virtual false final false
  inline void Swap(int32_t lhs, int32_t rhs);

  /// @brief Method EnsureItemSourceCanBeResized addr 0x2d1ddfc size 0x118 virtual false final false
  inline void EnsureItemSourceCanBeResized();

  static inline ::UnityEngine::UIElements::ListViewController* New_ctor();

  /// @brief Method .ctor addr 0x2d1e8e0 size 0x8 virtual false final false
  inline void _ctor();
