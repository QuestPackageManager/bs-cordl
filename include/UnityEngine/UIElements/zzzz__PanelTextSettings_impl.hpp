...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::UIElements::PanelTextSettings> (*)()>(&::UnityEngine::UIElements::PanelTextSettings::get_defaultPanelTextSettings)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x6ad8b44;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::UIElements::PanelTextSettings::InitializeDefaultPanelTextSettingsIfNull)> {
  ...
  constexpr static std::size_t addrs = 0x6ad8b94;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::PanelTextSettings::*)()>(&::UnityEngine::UIElements::PanelTextSettings::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6ad8c48;
...
::cordl_internals::setStaticField<::UnityW<::UnityEngine::UIElements::PanelTextSettings>, "s_DefaultPanelTextSettings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PanelTextSettings*>::get>(std::forward<::UnityW<::UnityEngine::UIElements::PanelTextSettings>>(value));
}
...
return ::cordl_internals::getStaticField<::UnityW<::UnityEngine::UIElements::PanelTextSettings>, "s_DefaultPanelTextSettings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PanelTextSettings*>::get>();
}
