...
public:
  ...
  /// @brief Method OnEnable, addr 0x6ad3460, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x6ad347c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
