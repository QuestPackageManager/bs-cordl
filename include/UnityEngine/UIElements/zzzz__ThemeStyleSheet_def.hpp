...
public:
  ...
  /// @brief Method OnEnable, addr 0x33b73bc, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x33b753c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
