...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TreeDataController_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TreeDataController_1(TreeDataController_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TreeDataController_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TreeDataController_1(TreeDataController_1const&) = delete;
