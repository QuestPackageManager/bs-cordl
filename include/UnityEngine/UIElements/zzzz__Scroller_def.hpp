...
public:
  ...
  /// @brief Method SliderNormalizeValue, addr 0x6ba47e0, size 0x28, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method .ctor, addr 0x6ba4124, size 0x94, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Scroller_ScrollerSlider, 0x590>, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ba48b0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6ba4918, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba4b38, size 0x240, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Scroller_UxmlTraits, 0xa8>, "Size mismatch!");
...
public:
  ...
  /// @brief Field <highButton>k__BackingField, offset 0x4c0, size 0x8
  ...
  /// @brief Field <lowButton>k__BackingField, offset 0x4b8, size 0x8
  ...
  /// @brief Method Adjust, addr 0x6ba1edc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSliderValueChange, addr 0x6ba41b8, size 0xbc, virtual false, abstract: false, final false
  inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>* evt);

  /// @brief Method ScrollPageDown, addr 0x6ba433c, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageDown();

  /// @brief Method ScrollPageDown, addr 0x6ba4344, size 0xc0, virtual false, abstract: false, final false
  inline void ScrollPageDown(float_t factor);

  /// @brief Method ScrollPageUp, addr 0x6ba4274, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageUp();

  /// @brief Method ScrollPageUp, addr 0x6ba427c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba4110, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6b9ef5c, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_valueChanged, addr 0x6ba3c00, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_direction, addr 0x6ba3d98, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::SliderDirection get_direction();

  /// @brief Method get_highButton, addr 0x6ba3d90, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_highButton();

  /// @brief Method get_highValue, addr 0x6b9dcec, size 0x50, virtual false, abstract: false, final false
  inline float_t get_highValue();

  /// @brief Method get_lowButton, addr 0x6ba3d88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_lowButton();

  /// @brief Method get_lowValue, addr 0x6ba1908, size 0x50, virtual false, abstract: false, final false
  inline float_t get_lowValue();

  /// @brief Method get_slider, addr 0x6ba3d80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Slider* get_slider();

  /// @brief Method get_value, addr 0x6b9c630, size 0x20, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method remove_valueChanged, addr 0x6ba3cc0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_direction, addr 0x6ba3e58, size 0x2b8, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UIElements::SliderDirection value);

  /// @brief Method set_highValue, addr 0x6ba209c, size 0x148, virtual false, abstract: false, final false
  inline void set_highValue(float_t value);

  /// @brief Method set_lowValue, addr 0x6ba1f54, size 0x148, virtual false, abstract: false, final false
  inline void set_lowValue(float_t value);

  /// @brief Method set_value, addr 0x6b9c7c8, size 0x148, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::UnityEngine::UIElements::Scroller, ___valueChanged) == 0x4a8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Scroller, ____slider_k__BackingField) == 0x4b0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Scroller, ____lowButton_k__BackingField) == 0x4b8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::Scroller, ____highButton_k__BackingField) == 0x4c0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Scroller, 0x4c8>, "Size mismatch!");
