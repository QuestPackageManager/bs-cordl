...
/// @brief Method SliderNormalizeValue, addr 0x6ba4ea0, size 0x28, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method .ctor, addr 0x6ba47e4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ba4f70, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x6ba4fd8, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ba51f8, size 0x240, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Adjust, addr 0x6ba259c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OnSliderValueChange, addr 0x6ba4878, size 0xbc, virtual false, abstract: false, final false
inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>*  evt) ;

/// @brief Method ScrollPageDown, addr 0x6ba49fc, size 0x8, virtual false, abstract: false, final false
inline void ScrollPageDown() ;

/// @brief Method ScrollPageDown, addr 0x6ba4a04, size 0xc0, virtual false, abstract: false, final false
inline void ScrollPageDown(float_t  factor) ;

/// @brief Method ScrollPageUp, addr 0x6ba4934, size 0x8, virtual false, abstract: false, final false
inline void ScrollPageUp() ;

/// @brief Method ScrollPageUp, addr 0x6ba493c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ba47d0, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6b9f61c, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method add_valueChanged, addr 0x6ba42c0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_direction, addr 0x6ba4458, size 0xc0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SliderDirection get_direction() ;

/// @brief Method get_highButton, addr 0x6ba4450, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::RepeatButton* get_highButton() ;

/// @brief Method get_highValue, addr 0x6b9e3ac, size 0x50, virtual false, abstract: false, final false
inline float_t get_highValue() ;

/// @brief Method get_lowButton, addr 0x6ba4448, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::RepeatButton* get_lowButton() ;

/// @brief Method get_lowValue, addr 0x6ba1fc8, size 0x50, virtual false, abstract: false, final false
inline float_t get_lowValue() ;

/// @brief Method get_slider, addr 0x6ba4440, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Slider* get_slider() ;

/// @brief Method get_value, addr 0x6b9ccf0, size 0x20, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method remove_valueChanged, addr 0x6ba4380, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x6ba4518, size 0x2b8, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UIElements::SliderDirection  value) ;

/// @brief Method set_highValue, addr 0x6ba275c, size 0x148, virtual false, abstract: false, final false
inline void set_highValue(float_t  value) ;

/// @brief Method set_lowValue, addr 0x6ba2614, size 0x148, virtual false, abstract: false, final false
inline void set_lowValue(float_t  value) ;

/// @brief Method set_value, addr 0x6b9ce88, size 0x148, virtual false, abstract: false, final false
