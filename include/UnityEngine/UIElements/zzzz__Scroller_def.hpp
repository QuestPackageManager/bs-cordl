...
public:
  ...
  /// @brief Method Init addr 0x2e2ad88 size 0x1ec virtual true final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__Scroller__UxmlTraits* New_ctor();

  /// @brief Method .ctor addr 0x2e2af74 size 0x25c virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method add_valueChanged addr 0x2e29fc4 size 0xb4 virtual false final false
  inline void add_valueChanged(::System::Action_1<float_t>* value);

  /// @brief Method remove_valueChanged addr 0x2e2a078 size 0xb4 virtual false final false
  inline void remove_valueChanged(::System::Action_1<float_t>* value);

  /// @brief Method get_slider addr 0x2e2a12c size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::Slider* get_slider();

  /// @brief Method set_slider addr 0x2e2a134 size 0x8 virtual false final false
  inline void set_slider(::UnityEngine::UIElements::Slider* value);

  /// @brief Method get_lowButton addr 0x2e2a13c size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::RepeatButton* get_lowButton();

  /// @brief Method set_lowButton addr 0x2e2a144 size 0x8 virtual false final false
  inline void set_lowButton(::UnityEngine::UIElements::RepeatButton* value);

  /// @brief Method get_highButton addr 0x2e2a14c size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::RepeatButton* get_highButton();

  /// @brief Method set_highButton addr 0x2e2a154 size 0x8 virtual false final false
  inline void set_highButton(::UnityEngine::UIElements::RepeatButton* value);

  /// @brief Method get_value addr 0x2e2a15c size 0x24 virtual false final false
  inline float_t get_value();

  /// @brief Method set_value addr 0x2e2a180 size 0x24 virtual false final false
  inline void set_value(float_t value);

  /// @brief Method get_lowValue addr 0x2e2a1a4 size 0x50 virtual false final false
  inline float_t get_lowValue();

  /// @brief Method set_lowValue addr 0x2e2a1f4 size 0x60 virtual false final false
  inline void set_lowValue(float_t value);

  /// @brief Method get_highValue addr 0x2e2a254 size 0x50 virtual false final false
  inline float_t get_highValue();

  /// @brief Method set_highValue addr 0x2e2a2a4 size 0x60 virtual false final false
  inline void set_highValue(float_t value);

  /// @brief Method set_direction addr 0x2e2a304 size 0x1fc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2e2a500 size 0x14 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x2e2a514 size 0x3a8 virtual false final false
  ...
  /// @brief Method Adjust addr 0x2e2a8bc size 0x78 virtual false final false
  inline void Adjust(float_t factor);

  /// @brief Method OnSliderValueChange addr 0x2e2a934 size 0x9c virtual false final false
  inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>* evt);

  /// @brief Method ScrollPageUp addr 0x2e2a9d0 size 0x8 virtual false final false
  inline void ScrollPageUp();

  /// @brief Method ScrollPageDown addr 0x2e2aad0 size 0x8 virtual false final false
  inline void ScrollPageDown();

  /// @brief Method ScrollPageUp addr 0x2e2a9d8 size 0xf8 virtual false final false
  inline void ScrollPageUp(float_t factor);

  /// @brief Method ScrollPageDown addr 0x2e2aad8 size 0xf8 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2e2ad40 size 0x48 virtual false final false
  inline void _ctor();
