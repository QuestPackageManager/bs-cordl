...
public:
  ...
  /// @brief Method SliderNormalizeValue, addr 0x6d6cb18, size 0x28, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method .ctor, addr 0x6d6c45c, size 0x94, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d6cbe8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6d6cc50, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d6ce70, size 0x240, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Adjust, addr 0x6d6a214, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSliderValueChange, addr 0x6d6c4f0, size 0xbc, virtual false, abstract: false, final false
  inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>* evt);

  /// @brief Method ScrollPageDown, addr 0x6d6c674, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageDown();

  /// @brief Method ScrollPageDown, addr 0x6d6c67c, size 0xc0, virtual false, abstract: false, final false
  inline void ScrollPageDown(float_t factor);

  /// @brief Method ScrollPageUp, addr 0x6d6c5ac, size 0x8, virtual false, abstract: false, final false
  inline void ScrollPageUp();

  /// @brief Method ScrollPageUp, addr 0x6d6c5b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d6c448, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d67294, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_valueChanged, addr 0x6d6bf38, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_direction, addr 0x6d6c0d0, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::SliderDirection get_direction();

  /// @brief Method get_highButton, addr 0x6d6c0c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_highButton();

  /// @brief Method get_highValue, addr 0x6d66024, size 0x50, virtual false, abstract: false, final false
  inline float_t get_highValue();

  /// @brief Method get_lowButton, addr 0x6d6c0c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RepeatButton* get_lowButton();

  /// @brief Method get_lowValue, addr 0x6d69c40, size 0x50, virtual false, abstract: false, final false
  inline float_t get_lowValue();

  /// @brief Method get_slider, addr 0x6d6c0b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Slider* get_slider();

  /// @brief Method get_value, addr 0x6d64968, size 0x20, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method remove_valueChanged, addr 0x6d6bff8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_direction, addr 0x6d6c190, size 0x2b8, virtual false, abstract: false, final false
  inline void set_direction(::UnityEngine::UIElements::SliderDirection value);

  /// @brief Method set_highValue, addr 0x6d6a3d4, size 0x148, virtual false, abstract: false, final false
  inline void set_highValue(float_t value);

  /// @brief Method set_lowValue, addr 0x6d6a28c, size 0x148, virtual false, abstract: false, final false
  inline void set_lowValue(float_t value);

  /// @brief Method set_value, addr 0x6d64b00, size 0x148, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Scroller) == 0x4c8, "Size mismatch!");
