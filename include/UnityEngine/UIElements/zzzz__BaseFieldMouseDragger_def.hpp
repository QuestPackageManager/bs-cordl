...
public:
  ...
  /// @brief Method SetDragZone, addr 0x6c4e570, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c4e58c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
