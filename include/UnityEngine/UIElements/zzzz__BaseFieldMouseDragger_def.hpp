...
public:
  ...
  /// @brief Method SetDragZone, addr 0x4a336a4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a336c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
