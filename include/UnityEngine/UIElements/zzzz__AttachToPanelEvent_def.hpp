...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7329), inst: 4719 }), TypeDefinitionIndex(TypeDefinitionIndex(7329))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2cea8fc size 0x48 virtual false final false
  inline void _ctor();
