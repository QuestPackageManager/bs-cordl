...
public:
  ...
  /// @brief Method Equals, addr 0x6b41904, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x6b41980, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StylePropertyName other);

  /// @brief Method GetHashCode, addr 0x6b418fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method StylePropertyIdFromString, addr 0x6b41734, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId StylePropertyIdFromString(::StringW name);

  /// @brief Method ToString, addr 0x6b41990, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b41890, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method .ctor, addr 0x6b417dc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleSheets::StylePropertyId stylePropertyId);

  /// @brief Method get_id, addr 0x6b41724, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId get_id();

  /// @brief Method get_name, addr 0x6b4172c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b418c4, size 0xc, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::StylePropertyName lhs, ::UnityEngine::UIElements::StylePropertyName rhs);

  /// @brief Method op_Implicit, addr 0x6b418dc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x6b418d0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b41b8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b41b94, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b41aac, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b41b84, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b41b7c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b41ba8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b41bb0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b41b14, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b41ba0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b41b98, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b41998, size 0x114, virtual false, abstract: false, final false
  inline void _ctor();
