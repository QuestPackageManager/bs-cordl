...
public:
  ...
  /// @brief Method Init, addr 0x49835dc, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4983a7c, size 0x214, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddItems, addr 0x4981e90, size 0x2c, virtual false, abstract: false, final false
  inline void AddItems(int32_t itemCount);

  /// @brief Method CreateDragAndDropController, addr 0x4982968, size 0x5c, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ICollectionDragAndDropController* CreateDragAndDropController();

  /// @brief Method CreateDragger, addr 0x49828d4, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::ListViewDragger* CreateDragger();

  /// @brief Method CreateVirtualizationController, addr 0x49825a0, size 0x48, virtual true, abstract: false, final false
  inline void CreateVirtualizationController();

  /// @brief Method EnableFooter, addr 0x4981a50, size 0x358, virtual false, abstract: false, final false
  inline void EnableFooter(bool enabled);

  /// @brief Method HandleItemNavigation, addr 0x4982a94, size 0x694, virtual true, abstract: false, final false
  inline bool HandleItemNavigation(bool moveIn, bool altPressed);

  static inline ::UnityEngine::UIElements::BaseListView* New_ctor();

  /// @brief Method OnAddClicked, addr 0x4982100, size 0x280, virtual false, abstract: false, final false
  inline void OnAddClicked();

  /// @brief Method OnArraySizeFieldChanged, addr 0x4981f38, size 0x1c8, virtual false, abstract: false, final false
  inline void OnArraySizeFieldChanged(::UnityEngine::UIElements::ChangeEvent_1<::StringW>* evt);

  /// @brief Method OnItemAdded, addr 0x49827a8, size 0x1c, virtual false, abstract: false, final false
  inline void OnItemAdded(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method OnItemsRemoved, addr 0x49827c4, size 0x1c, virtual false, abstract: false, final false
  inline void OnItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>* indices);

  /// @brief Method OnItemsSourceSizeChanged, addr 0x49827e0, size 0x8c, virtual false, abstract: false, final false
  inline void OnItemsSourceSizeChanged();

  /// @brief Method OnRemoveClicked, addr 0x4982380, size 0x218, virtual false, abstract: false, final false
  inline void OnRemoveClicked();

  /// @brief Method PostRefresh, addr 0x4982a70, size 0x24, virtual true, abstract: false, final false
  inline void PostRefresh();

  /// @brief Method SetViewController, addr 0x49825e8, size 0x1c0, virtual true, abstract: false, final false
  inline void SetViewController(::UnityEngine::UIElements::CollectionViewController* controller);

  /// @brief Method SetupArraySizeField, addr 0x4981290, size 0x2f8, virtual false, abstract: false, final false
  inline void SetupArraySizeField();

  /// @brief Method UpdateArraySizeField, addr 0x4981da8, size 0xc4, virtual false, abstract: false, final false
  inline void UpdateArraySizeField();

  /// @brief Method UpdateListViewLabel, addr 0x49817ec, size 0x254, virtual false, abstract: false, final false
  inline void UpdateListViewLabel();

  /// @brief Method <OnAddClicked>b__36_0, addr 0x498350c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49829c4, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_reorderModeChanged, addr 0x497d1e0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_footer, addr 0x4982598, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_footer();

  /// @brief Method get_reorderMode, addr 0x498286c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ListViewReorderMode get_reorderMode();

  /// @brief Method get_showAddRemoveFooter, addr 0x4981a40, size 0x10, virtual false, abstract: false, final false
  inline bool get_showAddRemoveFooter();

  /// @brief Method get_showBoundCollectionSize, addr 0x498126c, size 0x8, virtual false, abstract: false, final false
  inline bool get_showBoundCollectionSize();

  /// @brief Method get_showFoldoutHeader, addr 0x4981588, size 0x8, virtual false, abstract: false, final false
  inline bool get_showFoldoutHeader();

  /// @brief Method get_viewController, addr 0x4981ebc, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseListViewController* get_viewController();

  /// @brief Method remove_reorderModeChanged, addr 0x497d338, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_headerTitle, addr 0x4981e6c, size 0x1c, virtual false, abstract: false, final false
  inline void set_headerTitle(::StringW value);

  /// @brief Method set_reorderMode, addr 0x4982874, size 0x60, virtual false, abstract: false, final false
  inline void set_reorderMode(::UnityEngine::UIElements::ListViewReorderMode value);

  /// @brief Method set_showAddRemoveFooter, addr 0x4981e88, size 0x8, virtual false, abstract: false, final false
  inline void set_showAddRemoveFooter(bool value);

  /// @brief Method set_showBoundCollectionSize, addr 0x4981274, size 0x1c, virtual false, abstract: false, final false
  inline void set_showBoundCollectionSize(bool value);

  /// @brief Method set_showFoldoutHeader, addr 0x4981590, size 0x25c, virtual false, abstract: false, final false
