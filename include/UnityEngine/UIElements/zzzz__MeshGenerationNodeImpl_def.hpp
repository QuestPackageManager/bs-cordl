...
public:
  ...
  /// @brief Method Dispose, addr 0x6c7cff8, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6c7d060, size 0x44, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawGradients, addr 0x6c7cd5c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawMesh, addr 0x6c7cbd8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNode, addr 0x6c7cfc8, size 0xc, virtual false, abstract: false, final false
  inline void GetNode(::ByRef<::UnityEngine::UIElements::MeshGenerationNode> node);

  /// @brief Method GetParentEntry, addr 0x6c7cfe0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Entry* GetParentEntry();

  /// @brief Method GetUnsafeNode, addr 0x6c7cfd4, size 0xc, virtual false, abstract: false, final false
  inline void GetUnsafeNode(::ByRef<::UnityEngine::UIElements::UnsafeMeshGenerationNode> node);

  /// @brief Method Init, addr 0x6c7cea8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x6c7cf44, size 0x84, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6c7ce88, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disposed, addr 0x6c7cfe8, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6c7cff0, size 0x8, virtual false, abstract: false, final false
