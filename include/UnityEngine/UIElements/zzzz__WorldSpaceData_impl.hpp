...
::cordl_internals::setStaticField<::UnityEngine::Bounds, "k_Empty3DBounds", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::WorldSpaceData>::get>(std::forward<::UnityEngine::Bounds>(value));
}
