...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::BindablePropertyChangedEventArgs::*)(::ByRef<::UnityEngine::UIElements::BindingId>)>(&::UnityEngine::UIElements::BindablePropertyChangedEventArgs::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6aedff0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::BindablePropertyChangedEventArgs>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::BindingId (::UnityEngine::UIElements::BindablePropertyChangedEventArgs::*)()>(&::UnityEngine::UIElements::BindablePropertyChangedEventArgs::get_propertyName)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x6aedff8;
