...
/// @brief Method Commit, addr 0x6bf34d8, size 0x44, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method CreateAtlasTexture, addr 0x6bf388c, size 0x134, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> CreateAtlasTexture() ;

/// @brief Method Dispose, addr 0x6bf2d54, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x6bf2dc4, size 0x20c, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x6bf33f8, size 0xe0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D  alloc) ;

/// @brief Method TryAdd, addr 0x6bf2fd0, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x6bf32a0, size 0x158, virtual false, abstract: false, final false
inline void Update(::UnityEngine::Texture2D*  image, ::UnityEngine::RectInt  rect) ;

/// @brief Method UpdateAtlasTexture, addr 0x6bf351c, size 0x370, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bf2be4, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_atlas, addr 0x6bf2bc4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_atlas() ;

/// @brief Method get_disposed, addr 0x6bf2d44, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_filterMode, addr 0x6bf2bdc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::FilterMode get_filterMode() ;

/// @brief Method get_format, addr 0x6bf2bd4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RenderTextureFormat get_format() ;

/// @brief Method get_textureId, addr 0x6bf2bb4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_atlas, addr 0x6bf2bcc, size 0x8, virtual false, abstract: false, final false
inline void set_atlas(::UnityEngine::RenderTexture*  value) ;

/// @brief Method set_disposed, addr 0x6bf2d4c, size 0x8, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_textureId, addr 0x6bf2bbc, size 0x8, virtual false, abstract: false, final false
