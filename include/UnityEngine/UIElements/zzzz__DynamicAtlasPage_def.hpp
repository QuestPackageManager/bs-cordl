...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6598)), TypeDefinitionIndex(TypeDefinitionIndex(8849)),
// TypeDefinitionIndex(TypeDefinitionIndex(8853)), TypeDefinitionIndex(TypeDefinitionIndex(8988))] Self: TypeDefinitionIndex(TypeDefinitionIndex(6601)) CS Name:
...
public:
  ...
  /// @brief Method get_textureId, addr 0x2e973a0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextureId get_textureId();

  /// @brief Method set_textureId, addr 0x2e973a8, size 0x8, virtual false, abstract: false, final false
  inline void set_textureId(::UnityEngine::UIElements::TextureId value);

  /// @brief Method get_atlas, addr 0x2e973b0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_atlas();

  /// @brief Method set_atlas, addr 0x2e973b8, size 0x8, virtual false, abstract: false, final false
  inline void set_atlas(::UnityEngine::RenderTexture* value);

  /// @brief Method get_format, addr 0x2e973c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method get_filterMode, addr 0x2e973c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e973d0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x2e975d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method set_disposed, addr 0x2e975e0, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method Dispose, addr 0x2e975ec, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2e97658, size 0x1d4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method TryAdd, addr 0x2e97898, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2e97a7c, size 0x19c, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::Texture2D* image, ::UnityEngine::RectInt rect);

  /// @brief Method Remove, addr 0x2e97dbc, size 0xfc, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::UIR::__Allocator2D__Alloc2D alloc);

  /// @brief Method Commit, addr 0x2e97eb8, size 0x40, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method UpdateAtlasTexture, addr 0x2e97ef8, size 0x380, virtual false, abstract: false, final false
  inline void UpdateAtlasTexture();

  /// @brief Method CreateAtlasTexture, addr 0x2e98364, size 0x138, virtual false, abstract: false, final false
