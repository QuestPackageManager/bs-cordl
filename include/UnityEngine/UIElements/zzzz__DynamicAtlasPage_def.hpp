...
public:
  ...
  /// @brief Method Commit, addr 0x4a43958, size 0x44, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method CreateAtlasTexture, addr 0x4a43d08, size 0x130, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> CreateAtlasTexture();

  /// @brief Method Dispose, addr 0x4a4322c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4a43298, size 0x1dc, virtual true, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x4a43878, size 0xe0, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D alloc);

  /// @brief Method TryAdd, addr 0x4a43474, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x4a43730, size 0x148, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::Texture2D* image, ::UnityEngine::RectInt rect);

  /// @brief Method UpdateAtlasTexture, addr 0x4a4399c, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a430cc, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x4a430ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_atlas();

  /// @brief Method get_disposed, addr 0x4a43218, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_filterMode, addr 0x4a430c4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::FilterMode get_filterMode();

  /// @brief Method get_format, addr 0x4a430bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::RenderTextureFormat get_format();

  /// @brief Method get_textureId, addr 0x4a4309c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atlas, addr 0x4a430b4, size 0x8, virtual false, abstract: false, final false
  inline void set_atlas(::UnityEngine::RenderTexture* value);

  /// @brief Method set_disposed, addr 0x4a43220, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_textureId, addr 0x4a430a4, size 0x8, virtual false, abstract: false, final false
