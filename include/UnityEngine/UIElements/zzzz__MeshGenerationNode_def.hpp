...
public:
  // Declarations
  /// @brief Method Create, addr 0x6c7ca74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentEntry, addr 0x6c7ca7c, size 0x20, virtual false, abstract: false, final false
