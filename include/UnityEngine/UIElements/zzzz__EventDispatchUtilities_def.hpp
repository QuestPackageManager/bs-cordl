...
public:
// Declarations
/// @brief Method DefaultDispatch, addr 0x6c41004, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Disabled, addr 0x6c44034, size 0x30, virtual false, abstract: false, final false
static inline bool Disabled(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method DispatchToAssignedTarget, addr 0x6c44c2c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method DispatchToCachedElementUnderPointerOrPanelRoot, addr 0x6c44b4c, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method DispatchToCapturingElement, addr 0x6c44d40, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method DispatchToCapturingElementOrElementUnderPointer, addr 0x6c44cb8, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method DispatchToElementUnderPointerOrPanelRoot, addr 0x6c44a68, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method DispatchToFocusedElementOrPanelRoot, addr 0x6c44718, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method DispatchToPanelRoot, addr 0x6c44e50, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAcrossPropagationPath, addr 0x6c433dc, size 0x7c4, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAcrossPropagationPathWithCompatibilityEvent, addr 0x6c427a8, size 0xc34, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAtTargetAndDefaultPhase, addr 0x6c43ba0, size 0x494, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpAllDefaultActions, addr 0x6c44560, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpCallbacks, addr 0x6c44484, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpHandleEvent, addr 0x6c44508, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_DefaultAction, addr 0x6c443c4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_DefaultActionAtTarget, addr 0x6c44330, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_TrickleDownCallbacks, addr 0x6c44458, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_TrickleDownHandleEvent, addr 0x6c444b0, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method PropagateEvent, addr 0x6c42658, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method PropagateToRemainingIMGUIContainerRecursive, addr 0x6c44ea4, size 0x3b4, virtual false, abstract: false, final false
...
/// @brief Method PropagateToRemainingIMGUIContainers, addr 0x6c44a00, size 0x68, virtual false, abstract: false, final false
