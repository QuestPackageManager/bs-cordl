...
public:
// Declarations
/// @brief Method DefaultDispatch, addr 0x6bcd244, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Disabled, addr 0x6bd0274, size 0x30, virtual false, abstract: false, final false
static inline bool Disabled(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method DispatchToAssignedTarget, addr 0x6bd0e6c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method DispatchToCachedElementUnderPointerOrPanelRoot, addr 0x6bd0d8c, size 0xe0, virtual false, abstract: false, final false
static inline void DispatchToCachedElementUnderPointerOrPanelRoot(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::BaseVisualElementPanel*  panel, int32_t  pointerId, ::UnityEngine::Vector2  position) ;

/// @brief Method DispatchToCapturingElement, addr 0x6bd0f80, size 0x110, virtual false, abstract: false, final false
static inline bool DispatchToCapturingElement(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::BaseVisualElementPanel*  panel, int32_t  pointerId, ::UnityEngine::Vector2  position) ;

/// @brief Method DispatchToCapturingElementOrElementUnderPointer, addr 0x6bd0ef8, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method DispatchToElementUnderPointerOrPanelRoot, addr 0x6bd0ca8, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method DispatchToFocusedElementOrPanelRoot, addr 0x6bd0958, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method DispatchToPanelRoot, addr 0x6bd1090, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAcrossPropagationPath, addr 0x6bcf61c, size 0x7c4, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAcrossPropagationPathWithCompatibilityEvent, addr 0x6bce9e8, size 0xc34, virtual false, abstract: false, final false
...
/// @brief Method HandleEventAtTargetAndDefaultPhase, addr 0x6bcfde0, size 0x494, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpAllDefaultActions, addr 0x6bd07a0, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpCallbacks, addr 0x6bd06c4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_BubbleUpHandleEvent, addr 0x6bd0748, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_DefaultAction, addr 0x6bd0604, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_DefaultActionAtTarget, addr 0x6bd0570, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_TrickleDownCallbacks, addr 0x6bd0698, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method HandleEvent_TrickleDownHandleEvent, addr 0x6bd06f0, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method PropagateEvent, addr 0x6bce898, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method PropagateToRemainingIMGUIContainerRecursive, addr 0x6bd10e4, size 0x3b4, virtual false, abstract: false, final false
...
/// @brief Method PropagateToRemainingIMGUIContainers, addr 0x6bd0c40, size 0x68, virtual false, abstract: false, final false
