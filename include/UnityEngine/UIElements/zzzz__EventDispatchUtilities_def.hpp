...
public:
  // Declarations
  /// @brief Method DefaultDispatch, addr 0x6d98444, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Disabled, addr 0x6d9b474, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToAssignedTarget, addr 0x6d9c06c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToCachedElementUnderPointerOrPanelRoot, addr 0x6d9bf8c, size 0xe0, virtual false, abstract: false, final false
  static inline void DispatchToCachedElementUnderPointerOrPanelRoot(::UnityEngine::UIElements::EventBase* evt, /* [NotNull] */ ::UnityEngine::UIElements::BaseVisualElementPanel* panel,
                                                                    int32_t pointerId, ::UnityEngine::Vector2 position);

  /// @brief Method DispatchToCapturingElement, addr 0x6d9c180, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToCapturingElementOrElementUnderPointer, addr 0x6d9c0f8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToElementUnderPointerOrPanelRoot, addr 0x6d9bea8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToFocusedElementOrPanelRoot, addr 0x6d9bb58, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method DispatchToPanelRoot, addr 0x6d9c290, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEventAcrossPropagationPath, addr 0x6d9a81c, size 0x7c4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEventAcrossPropagationPathWithCompatibilityEvent, addr 0x6d99be8, size 0xc34, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEventAtTargetAndDefaultPhase, addr 0x6d9afe0, size 0x494, virtual false, abstract: false, final false
  static inline void HandleEventAtTargetAndDefaultPhase(::UnityEngine::UIElements::EventBase* evt, /* [NotNull] */ ::UnityEngine::UIElements::BaseVisualElementPanel* panel,
                                                        /* [NotNull] */ ::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method HandleEvent_BubbleUpAllDefaultActions, addr 0x6d9b9a0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_BubbleUpCallbacks, addr 0x6d9b8c4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_BubbleUpHandleEvent, addr 0x6d9b948, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_DefaultAction, addr 0x6d9b804, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_DefaultActionAtTarget, addr 0x6d9b770, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_TrickleDownCallbacks, addr 0x6d9b898, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEvent_TrickleDownHandleEvent, addr 0x6d9b8f0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateEvent, addr 0x6d99a98, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateToRemainingIMGUIContainerRecursive, addr 0x6d9c2e4, size 0x3b4, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateToRemainingIMGUIContainers, addr 0x6d9be40, size 0x68, virtual false, abstract: false, final false
...
public:
  ...
  EventDispatchUtilities(EventDispatchUtilitiesconst&) = delete;
