...
MARK_GEN_REF_PTR_T(::UnityEngine::UIElements::ObjectPool_1___c);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::UIElements::ObjectPool_1___c, "UnityEngine.UIElements", "ObjectPool`1/<>c");
