...
public:
  ...
  /// @brief Method .ctor, addr 0x49a6ca0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x49a6ce8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49a6e3c, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetIconClass, addr 0x49a6a6c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateIcon, addr 0x49a6814, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49a68c8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x49a691c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method set_messageType, addr 0x49a67fc, size 0x18, virtual false, abstract: false, final false
  inline void set_messageType(::UnityEngine::UIElements::HelpBoxMessageType value);

  /// @brief Method set_text, addr 0x49a67d8, size 0x24, virtual false, abstract: false, final false
