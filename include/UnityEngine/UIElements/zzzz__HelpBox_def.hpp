...
/// @brief Method .ctor, addr 0x6bf05b8, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x6bf0620, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bf0780, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetIconClass, addr 0x6bf0234, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method UpdateIcon, addr 0x6bf0020, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bf00c4, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6bf00dc, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method get_messageType, addr 0x6beff78, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::HelpBoxMessageType get_messageType() ;

/// @brief Method get_text, addr 0x6befe6c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_messageType, addr 0x6beff80, size 0xa0, virtual false, abstract: false, final false
inline void set_messageType(::UnityEngine::UIElements::HelpBoxMessageType  value) ;

/// @brief Method set_text, addr 0x6befe8c, size 0xec, virtual false, abstract: false, final false
