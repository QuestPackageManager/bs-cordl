...
public:
  ...
  /// @brief Method .ctor, addr 0x499dc70, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x499dcb8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499de0c, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetIconClass, addr 0x499da3c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateIcon, addr 0x499d7e4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499d898, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x499d8ec, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method set_messageType, addr 0x499d7cc, size 0x18, virtual false, abstract: false, final false
  inline void set_messageType(::UnityEngine::UIElements::HelpBoxMessageType value);

  /// @brief Method set_text, addr 0x499d7a8, size 0x24, virtual false, abstract: false, final false
