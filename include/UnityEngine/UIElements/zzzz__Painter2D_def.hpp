...
public:
  ...
  /// @brief Method Execute, addr 0x6c7daac, size 0x27c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x6c7c950, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6c7d660, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnMeshGeneration, addr 0x6c7d9a8, size 0x48, virtual false, abstract: false, final false
  inline void OnMeshGeneration(Il2CppObject* ctx, ::System::Object* data);

  /// @brief Method Reset, addr 0x6c7c7cc, size 0x48, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ScheduleJobs, addr 0x6c7d784, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c7d4d4, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c7c0c0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isPainterActive, addr 0x6c7d720, size 0x64, virtual false, abstract: false, final false
