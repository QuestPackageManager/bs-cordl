...
public:
  ...
  /// @brief Method Dispose, addr 0x4a4d328, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4a4d38c, size 0x88, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::Painter2D* New_ctor(::UnityEngine::UIElements::MeshGenerationContext* ctx);

  /// @brief Method Reset, addr 0x4a4d2e4, size 0x44, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x4a4d1a0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isPainterActive, addr 0x4a4d414, size 0x60, virtual false, abstract: false, final false
