...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a34608, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PointerEnterEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a34600, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a344f0, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x4a34544, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::PointerEnterEvent* New_ctor();

  /// @brief Method .ctor, addr 0x4a34550, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
