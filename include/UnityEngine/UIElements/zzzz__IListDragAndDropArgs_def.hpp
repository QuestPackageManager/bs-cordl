...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IListDragAndDropArgs", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IListDragAndDropArgs(IListDragAndDropArgsconst&) = delete;
