...
public:
  ...
  /// @brief Method get_editorEngine addr 0x2ccc6f8 size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::TextEditorEngine* get_editorEngine();

  /// @brief Method set_editorEngine addr 0x2ccc700 size 0x8 virtual false final false
  inline void set_editorEngine(::UnityEngine::UIElements::TextEditorEngine* value);

  /// @brief Method get_textInputField addr 0x2ccc708 size 0x8 virtual false final false
  inline ::UnityEngine::UIElements::ITextInputField* get_textInputField();

  /// @brief Method set_textInputField addr 0x2ccc710 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2ccc718 size 0xc0 virtual false final false
  ...
  /// @brief Method ExecuteDefaultActionAtTarget addr 0x2ccc7d8 size 0x4 virtual true final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultAction addr 0x2ccc7dc size 0x158 virtual true final false
