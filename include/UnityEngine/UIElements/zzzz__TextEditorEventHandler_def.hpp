...
public:
  ...
  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x49ee4b4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49ee1d8, size 0x2c, virtual false, abstract: false, final false
