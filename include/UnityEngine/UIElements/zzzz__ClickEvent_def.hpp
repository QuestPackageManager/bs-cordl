...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7284)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7284), inst: 4735 })}
...
public:
  // Declarations
  /// @brief Method Init addr 0x2ce822c size 0x54 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2ce8280 size 0xc virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::ClickEvent* New_ctor();

  /// @brief Method .ctor addr 0x2ce828c size 0x54 virtual false final false
  inline void _ctor();

  /// @brief Method GetPooled addr 0x2ce82e0 size 0x70 virtual false final false
