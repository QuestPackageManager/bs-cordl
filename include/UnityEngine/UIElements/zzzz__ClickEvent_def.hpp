...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a2e35c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ClickEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a2e354, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPooled, addr 0x4a2e288, size 0x70, virtual false, abstract: false, final false
