...
inline void UnityEngine::UIElements::DataSourceContext::_ctor(::System::Object* dataSource, /* [IsReadOnly] */ ::by_ref<::Unity::Properties::PropertyPath> dataSourcePath) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::DataSourceContext>(),
                                                           { ".ctor", {}, { ::i2c::type_of<::System::Object*>(), ::i2c::type_of<::by_ref<::Unity::Properties::PropertyPath>>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(*this, ___internal_method, dataSource, dataSourcePath);
}
// Ctor Parameters [CppParam { name: "_dataSource_k__BackingField", ty: "::System::Object*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_dataSourcePath_k__BackingField",
// ty: "::Unity::Properties::PropertyPath", modifiers: "", def_value: Some("{}"), comment: None }]
