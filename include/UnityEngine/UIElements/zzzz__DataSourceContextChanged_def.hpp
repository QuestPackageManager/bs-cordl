...
public:
// Declarations
/// @brief Method .ctor, addr 0x6a7a1d4, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  element, ::ByRef<::UnityEngine::UIElements::BindingId>  bindingId, ::ByRef<::UnityEngine::UIElements::DataSourceContext>  previousContext, ::ByRef<::UnityEngine::UIElements::DataSourceContext>  newContext) ;
