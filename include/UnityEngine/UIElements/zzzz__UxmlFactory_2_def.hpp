...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlFactory_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlFactory_2(UxmlFactory_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlFactory_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlFactory_2(UxmlFactory_2const&) = delete;
