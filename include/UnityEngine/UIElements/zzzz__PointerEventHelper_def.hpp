...
public:
  // Declarations
  /// @brief Method GetPooled, addr 0x6da3810, size 0x1c4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PointerEventHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PointerEventHelper(PointerEventHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PointerEventHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PointerEventHelper(PointerEventHelperconst&) = delete;
