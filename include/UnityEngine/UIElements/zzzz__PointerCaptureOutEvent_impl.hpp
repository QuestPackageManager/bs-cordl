...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::PointerCaptureOutEvent___c::*)()>(&::UnityEngine::UIElements::PointerCaptureOutEvent___c::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6bcad0c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::PointerCaptureOutEvent* (::UnityEngine::UIElements::PointerCaptureOutEvent___c::*)()>(&::UnityEngine::UIElements::PointerCaptureOutEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6bcad10;
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::PointerCaptureOutEvent___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PointerCaptureOutEvent___c*>::get>(std::forward<::UnityEngine::UIElements::PointerCaptureOutEvent___c*>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::PointerCaptureOutEvent___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PointerCaptureOutEvent___c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::PointerCaptureOutEvent::*)(::UnityEngine::UIElements::IPanel*)>(&::UnityEngine::UIElements::PointerCaptureOutEvent::PreDispatch)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x6bcabfc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::PointerCaptureOutEvent::*)()>(&::UnityEngine::UIElements::PointerCaptureOutEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6bcac6c;
