...
public:
  ...
  /// @brief Method Reset, addr 0x33c5b78, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x33c5bc4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllIndices, addr 0x33c5aa0, size 0xd8, virtual false, abstract: false, final false
  inline void SetAllIndices(::ArrayW<uint16_t, ::Array<uint16_t>*> indices);

  /// @brief Method SetAllVertices, addr 0x33c59c8, size 0xd8, virtual false, abstract: false, final false
  inline void SetAllVertices(::ArrayW<::UnityEngine::UIElements::Vertex, ::Array<::UnityEngine::UIElements::Vertex>*> vertices);

  /// @brief Method SetNextIndex, addr 0x33c5964, size 0x64, virtual false, abstract: false, final false
  inline void SetNextIndex(uint16_t index);

  /// @brief Method SetNextVertex, addr 0x33c58c8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c5824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_indexCount, addr 0x33c5874, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_indexCount();

  /// @brief Method get_uvRegion, addr 0x33c58bc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_uvRegion();

  /// @brief Method get_vertexCount, addr 0x33c582c, size 0x48, virtual false, abstract: false, final false
