...
public:
  ...
  /// @brief Method ToString, addr 0x6cc0824, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cc0814, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isField, addr 0x6cc080c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlObjectAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlObjectAsset(UxmlObjectAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlObjectAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlObjectAsset(UxmlObjectAssetconst&) = delete;
