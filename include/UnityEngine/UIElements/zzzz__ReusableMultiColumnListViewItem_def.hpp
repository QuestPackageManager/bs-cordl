...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReusableMultiColumnListViewItem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReusableMultiColumnListViewItem(ReusableMultiColumnListViewItem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReusableMultiColumnListViewItem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReusableMultiColumnListViewItem(ReusableMultiColumnListViewItemconst&) = delete;
