...
public:
  ...
  /// @brief Method <TraverseRecursive>b__5_0, addr 0x4a9b0dc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a9b0d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method NoProcessResult, addr 0x4a9ae6c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnRuleMatchedElement, addr 0x4a9ae64, size 0x8, virtual true, abstract: false, final false
  inline bool OnRuleMatchedElement(::UnityEngine::UIElements::RuleMatcher matcher, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Run, addr 0x4a9b068, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Traverse, addr 0x4a9ae5c, size 0x8, virtual true, abstract: false, final false
  inline void Traverse(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method TraverseRecursive, addr 0x4a9ae70, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a9ae54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method IsInUse, addr 0x4a9b114, size 0x10, virtual false, abstract: false, final false
  inline bool IsInUse();

  static inline ::UnityEngine::UIElements::UQuery_SingleQueryMatcher* New_ctor();

  /// @brief Method Run, addr 0x4a9b0f0, size 0x24, virtual true, abstract: false, final false
  inline void Run(::UnityEngine::UIElements::VisualElement* root, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::RuleMatcher>* matchers);
  ...
  /// @brief Method .ctor, addr 0x4a9b124, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_match, addr 0x4a9b0e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_match();

  /// @brief Method set_match, addr 0x4a9b0e8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateNew, addr 0x4a9b140, size 0x54, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::UQuery_SingleQueryMatcher* CreateNew();

  static inline ::UnityEngine::UIElements::UQuery_FirstQueryMatcher* New_ctor();

  /// @brief Method OnRuleMatchedElement, addr 0x4a9b12c, size 0x14, virtual true, abstract: false, final false
  inline bool OnRuleMatchedElement(::UnityEngine::UIElements::RuleMatcher matcher, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method .ctor, addr 0x4a9b194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
