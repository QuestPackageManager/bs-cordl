...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6474)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6474), inst: 4622 })]
...
public:
  // Declarations
  /// @brief Method Init, addr 0x2e6c21c, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x2e6c270, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::MouseDownEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2e6c27c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method MakeFromPointerEvent, addr 0x2e6c2d0, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPooled, addr 0x2e6a658, size 0x4, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::MouseDownEvent* GetPooled(::UnityEngine::UIElements::PointerDownEvent* pointerEvent);

  /// @brief Method GetPooled, addr 0x2e6ae24, size 0x4, virtual false, abstract: false, final false
