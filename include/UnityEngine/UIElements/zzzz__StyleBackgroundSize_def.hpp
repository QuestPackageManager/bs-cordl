...
public:
  ...
  /// @brief Method Equals, addr 0x4a85b6c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4a85af0, size 0x7c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleBackgroundSize other);

  /// @brief Method GetHashCode, addr 0x4a85bfc, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x4a85c24, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x4a85a60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x4a85a6c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BackgroundSize v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method get_keyword, addr 0x4a85a58, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method get_value, addr 0x4a85a18, size 0x40, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Equality, addr 0x4a85a84, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x4a85ae4, size 0xc, virtual false, abstract: false, final false
