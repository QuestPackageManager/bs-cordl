...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x6dad60c, size 0x498, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x6dadbd8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x6dadc98, size 0xe4, virtual false, abstract: false, final false
