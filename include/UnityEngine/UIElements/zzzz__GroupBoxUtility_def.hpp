...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x2f1293c, size 0x3e0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x2f12ed0, size 0xb4, virtual false, abstract: false, final false
  static inline void OnGroupBoxDetachedFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnOptionAttachToPanel, addr 0x2f126f0, size 0x24c, virtual false, abstract: false, final false
  static inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnOptionDetachFromPanel, addr 0x2f12d1c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x2f12f84, size 0xdc, virtual false, abstract: false, final false
