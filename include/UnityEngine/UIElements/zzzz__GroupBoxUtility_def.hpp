...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x4a48e68, size 0x46c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x4a49400, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x4a494b4, size 0xd4, virtual false, abstract: false, final false
