...
public:
  ...
  /// @brief Method FindOrCreateGroupManager, addr 0x3557cc8, size 0x3e0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox* groupBox);

  /// @brief Method OnGroupBoxDetachedFromPanel, addr 0x355825c, size 0xb4, virtual false, abstract: false, final false
  static inline void OnGroupBoxDetachedFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnOptionAttachToPanel, addr 0x3557a7c, size 0x24c, virtual false, abstract: false, final false
  static inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnOptionDetachFromPanel, addr 0x35580a8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelDestroyed, addr 0x3558310, size 0xdc, virtual false, abstract: false, final false
