...
public:
  ...
  /// @brief Method .ctor, addr 0x6d4c514, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6d4c57c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d4c6b4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateViewController, addr 0x6d4c0e0, size 0x44, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController();

  /// @brief Method HasValidDataAndBindings, addr 0x6d4c084, size 0x5c, virtual true, abstract: false, final false
  inline bool HasValidDataAndBindings();

  static inline ::UnityEngine::UIElements::ListView* New_ctor();

  /// @brief Method TemplateMakeItem, addr 0x6d4bd64, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d4c124, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bindItem, addr 0x6d4be50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_2<::UnityEngine::UIElements::VisualElement*, int32_t>* get_bindItem();

  /// @brief Method get_destroyItem, addr 0x6d4bfcc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::VisualElement*>* get_destroyItem();

  /// @brief Method get_itemTemplate, addr 0x6d4bc54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UIElements::VisualTreeAsset> get_itemTemplate();

  /// @brief Method get_makeItem, addr 0x6d4bb90, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<::UnityEngine::UIElements::VisualElement*>* get_makeItem();

  /// @brief Method get_unbindItem, addr 0x6d4bf14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindItem, addr 0x6d4be58, size 0xbc, virtual false, abstract: false, final false
  inline void set_bindItem(::System::Action_2<::UnityEngine::UIElements::VisualElement*, int32_t>* value);

  /// @brief Method set_destroyItem, addr 0x6d4bfd4, size 0xb0, virtual false, abstract: false, final false
  inline void set_destroyItem(::System::Action_1<::UnityEngine::UIElements::VisualElement*>* value);

  /// @brief Method set_itemTemplate, addr 0x6d4bc5c, size 0x108, virtual false, abstract: false, final false
  inline void set_itemTemplate(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method set_makeItem, addr 0x6d4bb98, size 0xbc, virtual false, abstract: false, final false
  inline void set_makeItem(::System::Func_1<::UnityEngine::UIElements::VisualElement*>* value);

  /// @brief Method set_unbindItem, addr 0x6d4bf1c, size 0xb0, virtual false, abstract: false, final false
