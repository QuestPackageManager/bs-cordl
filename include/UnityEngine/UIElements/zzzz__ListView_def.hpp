...
public:
  ...
  /// @brief Method .ctor, addr 0x6bf6ae4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6bf6b4c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf6c84, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateViewController, addr 0x6bf66b0, size 0x44, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController();

  /// @brief Method HasValidDataAndBindings, addr 0x6bf6654, size 0x5c, virtual true, abstract: false, final false
  inline bool HasValidDataAndBindings();

  static inline ::UnityEngine::UIElements::ListView* New_ctor();

  /// @brief Method TemplateMakeItem, addr 0x6bf6334, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf66f4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bindItem, addr 0x6bf6420, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_2<::UnityEngine::UIElements::VisualElement*, int32_t>* get_bindItem();

  /// @brief Method get_destroyItem, addr 0x6bf659c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::VisualElement*>* get_destroyItem();

  /// @brief Method get_itemTemplate, addr 0x6bf6224, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UIElements::VisualTreeAsset> get_itemTemplate();

  /// @brief Method get_makeItem, addr 0x6bf6160, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_1<::UnityEngine::UIElements::VisualElement*>* get_makeItem();

  /// @brief Method get_unbindItem, addr 0x6bf64e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bindItem, addr 0x6bf6428, size 0xbc, virtual false, abstract: false, final false
  inline void set_bindItem(::System::Action_2<::UnityEngine::UIElements::VisualElement*, int32_t>* value);

  /// @brief Method set_destroyItem, addr 0x6bf65a4, size 0xb0, virtual false, abstract: false, final false
  inline void set_destroyItem(::System::Action_1<::UnityEngine::UIElements::VisualElement*>* value);

  /// @brief Method set_itemTemplate, addr 0x6bf622c, size 0x108, virtual false, abstract: false, final false
  inline void set_itemTemplate(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method set_makeItem, addr 0x6bf6168, size 0xbc, virtual false, abstract: false, final false
  inline void set_makeItem(::System::Func_1<::UnityEngine::UIElements::VisualElement*>* value);

  /// @brief Method set_unbindItem, addr 0x6bf64ec, size 0xb0, virtual false, abstract: false, final false
