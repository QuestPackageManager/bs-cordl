...
public:
  ...
  /// @brief Method DirtyBoundingBoxHierarchy, addr 0x49a565c, size 0xa4, virtual false, abstract: false, final false
  static inline void DirtyBoundingBoxHierarchy(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method DirtyHierarchy, addr 0x49a5574, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnVersionChanged, addr 0x49a5490, size 0xe4, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update, addr 0x49a5700, size 0x5c, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x49a575c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_profilerMarker, addr 0x49a5438, size 0x58, virtual true, abstract: false, final false
