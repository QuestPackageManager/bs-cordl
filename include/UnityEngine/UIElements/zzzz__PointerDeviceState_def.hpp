...
public:
  ...
  /// @brief Method get_Position, addr 0x2e4a6ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Position();

  /// @brief Method set_Position, addr 0x2e4a6b4, size 0x8, virtual false, abstract: false, final false
  inline void set_Position(::UnityEngine::Vector2 value);

  /// @brief Method get_Panel, addr 0x2e4a6bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_Panel();

  /// @brief Method set_Panel, addr 0x2e4a6c4, size 0x8, virtual false, abstract: false, final false
  inline void set_Panel(::UnityEngine::UIElements::IPanel* value);

  /// @brief Method get_Flags, addr 0x2e4a6cc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag get_Flags();

  /// @brief Method set_Flags, addr 0x2e4a6d4, size 0x8, virtual false, abstract: false, final false
  inline void set_Flags(::UnityEngine::UIElements::__PointerDeviceState__LocationFlag value);

  /// @brief Method SetLocation, addr 0x2e49e64, size 0x10c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method RemovePanelData, addr 0x2e49c88, size 0x1dc, virtual false, abstract: false, final false
  static inline void RemovePanelData(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method SavePointerPosition, addr 0x2e49f70, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PressButton, addr 0x2e4a018, size 0xdc, virtual false, abstract: false, final false
  static inline void PressButton(int32_t pointerId, int32_t buttonId);

  /// @brief Method ReleaseButton, addr 0x2e4a0f4, size 0xdc, virtual false, abstract: false, final false
  static inline void ReleaseButton(int32_t pointerId, int32_t buttonId);

  /// @brief Method ReleaseAllButtons, addr 0x2e4a1d0, size 0x7c, virtual false, abstract: false, final false
  static inline void ReleaseAllButtons(int32_t pointerId);

  /// @brief Method GetPointerPosition, addr 0x2e491a8, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetPointerPosition(int32_t pointerId, ::UnityEngine::UIElements::ContextType contextType);

  /// @brief Method GetPanel, addr 0x2e4a24c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IPanel* GetPanel(int32_t pointerId, ::UnityEngine::UIElements::ContextType contextType);

  /// @brief Method HasFlagFast, addr 0x2e4a2cc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasLocationFlag, addr 0x2e4a2d8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPressedButtons, addr 0x2e4a36c, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t GetPressedButtons(int32_t pointerId);

  /// @brief Method HasAdditionalPressedButtons, addr 0x2e4a3e8, size 0x98, virtual false, abstract: false, final false
  static inline bool HasAdditionalPressedButtons(int32_t pointerId, int32_t exceptButtonId);

  /// @brief Method SetPlayerPanelWithSoftPointerCapture, addr 0x2e4a480, size 0xac, virtual false, abstract: false, final false
  static inline void SetPlayerPanelWithSoftPointerCapture(int32_t pointerId, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method GetPlayerPanelWithSoftPointerCapture, addr 0x2e4a52c, size 0x7c, virtual false, abstract: false, final false
