...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6417)), TypeDefinitionIndex(TypeDefinitionIndex(8987))]
...
public:
  ...
  /// @brief Method get_Position, addr 0x2e65a94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_Position();

  /// @brief Method set_Position, addr 0x2e65a9c, size 0x8, virtual false, abstract: false, final false
  inline void set_Position(::UnityEngine::Vector2 value);

  /// @brief Method get_Panel, addr 0x2e65aa4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_Panel();

  /// @brief Method set_Panel, addr 0x2e65aac, size 0x8, virtual false, abstract: false, final false
  inline void set_Panel(::UnityEngine::UIElements::IPanel* value);

  /// @brief Method get_Flags, addr 0x2e65ab4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag get_Flags();

  /// @brief Method set_Flags, addr 0x2e65abc, size 0x8, virtual false, abstract: false, final false
  inline void set_Flags(::UnityEngine::UIElements::__PointerDeviceState__LocationFlag value);

  /// @brief Method SetLocation, addr 0x2e6524c, size 0x10c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method RemovePanelData, addr 0x2e65070, size 0x1dc, virtual false, abstract: false, final false
  static inline void RemovePanelData(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method SavePointerPosition, addr 0x2e65358, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method PressButton, addr 0x2e65400, size 0xdc, virtual false, abstract: false, final false
  static inline void PressButton(int32_t pointerId, int32_t buttonId);

  /// @brief Method ReleaseButton, addr 0x2e654dc, size 0xdc, virtual false, abstract: false, final false
  static inline void ReleaseButton(int32_t pointerId, int32_t buttonId);

  /// @brief Method ReleaseAllButtons, addr 0x2e655b8, size 0x7c, virtual false, abstract: false, final false
  static inline void ReleaseAllButtons(int32_t pointerId);

  /// @brief Method GetPointerPosition, addr 0x2e64590, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetPointerPosition(int32_t pointerId, ::UnityEngine::UIElements::ContextType contextType);

  /// @brief Method GetPanel, addr 0x2e65634, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IPanel* GetPanel(int32_t pointerId, ::UnityEngine::UIElements::ContextType contextType);

  /// @brief Method HasFlagFast, addr 0x2e656b4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasLocationFlag, addr 0x2e656c0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPressedButtons, addr 0x2e65754, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t GetPressedButtons(int32_t pointerId);

  /// @brief Method HasAdditionalPressedButtons, addr 0x2e657d0, size 0x98, virtual false, abstract: false, final false
  static inline bool HasAdditionalPressedButtons(int32_t pointerId, int32_t exceptButtonId);

  /// @brief Method SetPlayerPanelWithSoftPointerCapture, addr 0x2e65868, size 0xac, virtual false, abstract: false, final false
  static inline void SetPlayerPanelWithSoftPointerCapture(int32_t pointerId, ::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method GetPlayerPanelWithSoftPointerCapture, addr 0x2e65914, size 0x7c, virtual false, abstract: false, final false
