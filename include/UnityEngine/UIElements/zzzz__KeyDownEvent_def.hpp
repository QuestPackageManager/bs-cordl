...
public:
  // Declarations
  /// @brief Method GetEquivalentImguiEvent, addr 0x339ecc0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x339ed80, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
