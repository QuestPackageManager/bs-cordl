...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a2556c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::KeyDownEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a25564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetEquivalentImguiEvent, addr 0x4a24760, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method PostDispatch, addr 0x4a24820, size 0x100, virtual true, abstract: false, final false
  inline void PostDispatch(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method SendEquivalentNavigationEventIfAny, addr 0x4a24920, size 0x908, virtual false, abstract: false, final false
  inline void SendEquivalentNavigationEventIfAny(::UnityEngine::UIElements::IPanel* panel);

  /// @brief Method .ctor, addr 0x4a254c0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
