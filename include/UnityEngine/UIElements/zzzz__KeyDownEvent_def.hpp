...
public:
  // Declarations
  /// @brief Method GetEquivalentImguiEvent, addr 0x35a79f8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a7ab8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
