...
public:
  ...
  /// @brief Method .ctor, addr 0x6b71f64, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::Type*, ::Array<::System::Type*>*> eventTypes);

  /// @brief Method .ctor, addr 0x6b71f70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::EventInterestOptions interests);

  /// @brief Method .ctor, addr 0x6b71f78, size 0x8, virtual false, abstract: false, final false
