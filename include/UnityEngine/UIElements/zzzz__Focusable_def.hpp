...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6470))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e16e44, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_focusable, addr 0x2e16e6c, size 0x8, virtual false, abstract: false, final false
  inline bool get_focusable();

  /// @brief Method set_focusable, addr 0x2e16e74, size 0xc, virtual false, abstract: false, final false
  inline void set_focusable(bool value);

  /// @brief Method get_tabIndex, addr 0x2e16e80, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tabIndex();

  /// @brief Method set_tabIndex, addr 0x2e16e88, size 0x8, virtual false, abstract: false, final false
  inline void set_tabIndex(int32_t value);

  /// @brief Method get_delegatesFocus, addr 0x2e16e90, size 0x8, virtual false, abstract: false, final false
  inline bool get_delegatesFocus();

  /// @brief Method set_delegatesFocus, addr 0x2e16e98, size 0xe4, virtual false, abstract: false, final false
  inline void set_delegatesFocus(bool value);

  /// @brief Method get_excludeFromFocusRing, addr 0x2e16f7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_excludeFromFocusRing();

  /// @brief Method set_excludeFromFocusRing, addr 0x2e16f84, size 0xe4, virtual false, abstract: false, final false
  inline void set_excludeFromFocusRing(bool value);

  /// @brief Method get_canGrabFocus, addr 0x2e17068, size 0x8, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method Focus, addr 0x2e17070, size 0xb0, virtual true, abstract: false, final false
  inline void Focus();

  /// @brief Method Blur, addr 0x2e17268, size 0x38, virtual true, abstract: false, final false
  inline void Blur();

  /// @brief Method BlurImmediately, addr 0x2e172f8, size 0x38, virtual false, abstract: false, final false
  inline void BlurImmediately();

  /// @brief Method GetFocusDelegate, addr 0x2e17120, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Focusable* GetFocusDelegate();

  /// @brief Method GetFirstFocusableChild, addr 0x2e17330, size 0x120, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ExecuteDefaultAction, addr 0x2e17450, size 0x2c, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionDisabled, addr 0x2e174dc, size 0x2c, virtual true, abstract: false, final false
  inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ProcessEvent, addr 0x2e1747c, size 0x60, virtual false, abstract: false, final false
