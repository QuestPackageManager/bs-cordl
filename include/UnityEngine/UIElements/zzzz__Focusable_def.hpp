...
/// @brief Method Blur, addr 0x6bdc8a8, size 0x38, virtual true, abstract: false, final false
inline void Blur() ;

/// @brief Method BlurImmediately, addr 0x6bdc938, size 0x38, virtual false, abstract: false, final false
inline void BlurImmediately() ;

/// @brief Method Focus, addr 0x6bdc67c, size 0xac, virtual true, abstract: false, final false
inline void Focus() ;

/// @brief Method GetFirstFocusableChild, addr 0x6bdc970, size 0x138, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetFocusDelegate, addr 0x6bdc728, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6bdc348, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_canGrabFocus, addr 0x6bdc66c, size 0x10, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_delegatesFocus, addr 0x6bdc4d8, size 0x8, virtual false, abstract: false, final false
inline bool get_delegatesFocus() ;

/// @brief Method get_excludeFromFocusRing, addr 0x6bdc570, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_focusable, addr 0x6bdc43c, size 0x8, virtual true, abstract: false, final false
inline bool get_focusable() ;

/// @brief Method get_isEligibleToReceiveFocusFromDisabledChild, addr 0x6bdc65c, size 0x8, virtual false, abstract: false, final false
inline bool get_isEligibleToReceiveFocusFromDisabledChild() ;

/// @brief Method get_tabIndex, addr 0x6bdc4d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_delegatesFocus, addr 0x6bdc4e0, size 0x90, virtual false, abstract: false, final false
inline void set_delegatesFocus(bool  value) ;

/// @brief Method set_excludeFromFocusRing, addr 0x6bdc578, size 0xe4, virtual false, abstract: false, final false
inline void set_excludeFromFocusRing(bool  value) ;

/// @brief Method set_focusable, addr 0x6bdc444, size 0x8c, virtual true, abstract: false, final false
inline void set_focusable(bool  value) ;

/// @brief Method set_isEligibleToReceiveFocusFromDisabledChild, addr 0x6bdc664, size 0x8, virtual false, abstract: false, final false
inline void set_isEligibleToReceiveFocusFromDisabledChild(bool  value) ;

/// @brief Method set_tabIndex, addr 0x6bdc3ac, size 0x90, virtual false, abstract: false, final false
