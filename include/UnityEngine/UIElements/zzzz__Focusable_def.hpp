...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7297))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2c936ac size 0x28 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method get_focusable addr 0x2c936d4 size 0x8 virtual false final false
  inline bool get_focusable();

  /// @brief Method set_focusable addr 0x2c936dc size 0xc virtual false final false
  inline void set_focusable(bool value);

  /// @brief Method get_tabIndex addr 0x2c936e8 size 0x8 virtual false final false
  inline int32_t get_tabIndex();

  /// @brief Method set_tabIndex addr 0x2c936f0 size 0x8 virtual false final false
  inline void set_tabIndex(int32_t value);

  /// @brief Method get_delegatesFocus addr 0x2c936f8 size 0x8 virtual false final false
  inline bool get_delegatesFocus();

  /// @brief Method set_delegatesFocus addr 0x2c93700 size 0xe4 virtual false final false
  inline void set_delegatesFocus(bool value);

  /// @brief Method get_excludeFromFocusRing addr 0x2c937e4 size 0x8 virtual false final false
  inline bool get_excludeFromFocusRing();

  /// @brief Method set_excludeFromFocusRing addr 0x2c937ec size 0xe4 virtual false final false
  inline void set_excludeFromFocusRing(bool value);

  /// @brief Method get_canGrabFocus addr 0x2c938d0 size 0x8 virtual true final false
  inline bool get_canGrabFocus();

  /// @brief Method Focus addr 0x2c938d8 size 0xb0 virtual true final false
  inline void Focus();

  /// @brief Method Blur addr 0x2c93ad0 size 0x38 virtual true final false
  inline void Blur();

  /// @brief Method BlurImmediately addr 0x2c93b60 size 0x38 virtual false final false
  inline void BlurImmediately();

  /// @brief Method GetFocusDelegate addr 0x2c93988 size 0x90 virtual false final false
  inline ::UnityEngine::UIElements::Focusable* GetFocusDelegate();

  /// @brief Method GetFirstFocusableChild addr 0x2c93b98 size 0x120 virtual false final false
  static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ExecuteDefaultAction addr 0x2c93cb8 size 0x2c virtual true final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionDisabled addr 0x2c93d44 size 0x2c virtual true final false
  inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ProcessEvent addr 0x2c93ce4 size 0x60 virtual false final false
