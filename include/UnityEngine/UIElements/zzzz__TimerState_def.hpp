...
public:
  ...
  /// @brief Method get_start addr 0x2ca11e4 size 0x8 virtual false final false
  inline int64_t get_start();

  /// @brief Method set_start addr 0x2ca11ec size 0x8 virtual false final false
  inline void set_start(int64_t value);

  /// @brief Method get_now addr 0x2ca11f4 size 0x8 virtual false final false
  inline int64_t get_now();

  /// @brief Method set_now addr 0x2ca11fc size 0x8 virtual false final false
  inline void set_now(int64_t value);

  /// @brief Method get_deltaTime addr 0x2ca1204 size 0xc virtual false final false
  inline int64_t get_deltaTime();

  /// @brief Method Equals addr 0x2ca1210 size 0x88 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2ca1298 size 0x24 virtual true final true
  inline bool Equals(::UnityEngine::UIElements::TimerState other);

  /// @brief Method GetHashCode addr 0x2ca12bc size 0x7c virtual true final false
