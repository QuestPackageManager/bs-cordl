...
public:
  ...
  /// @brief Method Equals, addr 0x6dd95fc, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6dd9688, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TimerState other);

  /// @brief Method GetHashCode, addr 0x6dd96ac, size 0x44, virtual true, abstract: false, final false
