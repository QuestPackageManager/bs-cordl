...
public:
  ...
  /// @brief Method Equals, addr 0x6c80644, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6c806d0, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TimerState other);

  /// @brief Method GetHashCode, addr 0x6c806f4, size 0x44, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method get_deltaTime, addr 0x6c80638, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_deltaTime();

  /// @brief Method get_now, addr 0x6c80628, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_now();

  /// @brief Method get_start, addr 0x6c80618, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_now, addr 0x6c80630, size 0x8, virtual false, abstract: false, final false
  inline void set_now(int64_t value);

  /// @brief Method set_start, addr 0x6c80620, size 0x8, virtual false, abstract: false, final false
