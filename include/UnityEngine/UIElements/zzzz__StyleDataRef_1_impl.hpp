...
template <typename T> inline void UnityEngine::UIElements::StyleDataRef_1_RefCounted<T>::setStaticF_m_NextId(uint32_t value) {
  ::cordl_internals::setStaticField<uint32_t, "m_NextId", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::StyleDataRef_1_RefCounted<T>*>::get>(
...
template <typename T> inline int32_t UnityEngine::UIElements::StyleDataRef_1_RefCounted<T>::get_refCount() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::StyleDataRef_1_RefCounted<T>*>::get(),
