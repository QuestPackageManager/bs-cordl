...
public:
  ...
  /// @brief Method .ctor, addr 0x4995810, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UpdateItem>b__0, addr 0x4996994, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499593c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDisabledItem, addr 0x4995740, size 0x10, virtual true, abstract: false, final true
  inline void AddDisabledItem(::StringW itemName, bool isChecked);

  /// @brief Method AddItem, addr 0x49953e8, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method AddItem, addr 0x49953c0, size 0x28, virtual true, abstract: false, final true
  inline void AddItem(::StringW itemName, bool isChecked, ::System::Action* action);

  /// @brief Method AddItem, addr 0x499571c, size 0x24, virtual true, abstract: false, final true
  inline void AddItem(::StringW itemName, bool isChecked, ::System::Action_1<::System::Object*>* action, ::System::Object* data);

  /// @brief Method AddSeparator, addr 0x4995750, size 0xc0, virtual true, abstract: false, final true
  inline void AddSeparator(::StringW path);

  /// @brief Method Apply, addr 0x49948c0, size 0x194, virtual false, abstract: false, final false
  inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op);

  /// @brief Method Apply, addr 0x4994884, size 0x3c, virtual false, abstract: false, final false
  inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op, ::UnityEngine::UIElements::EventBase* sourceEvent);

  /// @brief Method ChangeSelectedIndex, addr 0x4995284, size 0x13c, virtual false, abstract: false, final false
  inline void ChangeSelectedIndex(int32_t newIndex, int32_t previousIndex);

  /// @brief Method DropDown, addr 0x4995944, size 0x928, virtual true, abstract: false, final true
  inline void DropDown(::UnityEngine::Rect position, ::UnityEngine::UIElements::VisualElement* targetElement, bool anchored);

  /// @brief Method EnsureVisibilityInParent, addr 0x499626c, size 0x57c, virtual false, abstract: false, final false
  inline void EnsureVisibilityInParent();

  /// @brief Method GetSelectedIndex, addr 0x4994a54, size 0xa0, virtual false, abstract: false, final false
  inline int32_t GetSelectedIndex();

  /// @brief Method Hide, addr 0x49947f4, size 0x90, virtual false, abstract: false, final false
  inline void Hide(bool giveFocusBack);

  static inline ::UnityEngine::UIElements::GenericDropdownMenu* New_ctor();

  /// @brief Method OnAttachToPanel, addr 0x4994044, size 0x418, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnContainerGeometryChanged, addr 0x49967f0, size 0x4, virtual false, abstract: false, final false
  inline void OnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnDetachFromPanel, addr 0x499445c, size 0x398, virtual false, abstract: false, final false
  inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnFocusOut, addr 0x4995128, size 0x148, virtual false, abstract: false, final false
  inline void OnFocusOut(::UnityEngine::UIElements::FocusOutEvent* evt);

  /// @brief Method OnParentResized, addr 0x4995270, size 0x14, virtual false, abstract: false, final false
  inline void OnParentResized(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnPointerDown, addr 0x4994c58, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMove, addr 0x4994eb4, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method OnPointerUp, addr 0x4994fe0, size 0x148, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OnTargetElementDetachFromPanel, addr 0x49967e8, size 0x8, virtual false, abstract: false, final false
  inline void OnTargetElementDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method UpdateItem, addr 0x4995818, size 0x124, virtual false, abstract: false, final false
  inline void UpdateItem(::StringW itemName, bool isChecked);

  /// @brief Method UpdateSelection, addr 0x4994d84, size 0x130, virtual false, abstract: false, final false
  inline void UpdateSelection(::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method <Apply>g__UpdateSelectionDown|39_0, addr 0x4994b9c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method <Apply>g__UpdateSelectionUp|39_1, addr 0x4994af4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4991d34, size 0x2e8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_closeOnParentResize, addr 0x499400c, size 0x8, virtual false, abstract: false, final false
  inline bool get_closeOnParentResize();

  /// @brief Method get_contentContainer, addr 0x4994020, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_isSingleSelectionDropdown, addr 0x4993ff8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_closeOnParentResize, addr 0x4994014, size 0xc, virtual false, abstract: false, final false
  inline void set_closeOnParentResize(bool value);

  /// @brief Method set_isSingleSelectionDropdown, addr 0x4994000, size 0xc, virtual false, abstract: false, final false
