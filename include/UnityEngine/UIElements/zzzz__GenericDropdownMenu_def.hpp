...
public:
  ...
  /// @brief Method .ctor, addr 0x49922dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UpdateItem>b__0, addr 0x4993460, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4992408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDisabledItem, addr 0x499220c, size 0x10, virtual true, abstract: false, final true
  inline void AddDisabledItem(::StringW itemName, bool isChecked);

  /// @brief Method AddItem, addr 0x4991eb4, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method AddItem, addr 0x4991e8c, size 0x28, virtual true, abstract: false, final true
  inline void AddItem(::StringW itemName, bool isChecked, ::System::Action* action);

  /// @brief Method AddItem, addr 0x49921e8, size 0x24, virtual true, abstract: false, final true
  inline void AddItem(::StringW itemName, bool isChecked, ::System::Action_1<::System::Object*>* action, ::System::Object* data);

  /// @brief Method AddSeparator, addr 0x499221c, size 0xc0, virtual true, abstract: false, final true
  inline void AddSeparator(::StringW path);

  /// @brief Method Apply, addr 0x499138c, size 0x194, virtual false, abstract: false, final false
  inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op);

  /// @brief Method Apply, addr 0x4991350, size 0x3c, virtual false, abstract: false, final false
  inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation op, ::UnityEngine::UIElements::EventBase* sourceEvent);

  /// @brief Method ChangeSelectedIndex, addr 0x4991d50, size 0x13c, virtual false, abstract: false, final false
  inline void ChangeSelectedIndex(int32_t newIndex, int32_t previousIndex);

  /// @brief Method DropDown, addr 0x4992410, size 0x928, virtual true, abstract: false, final true
  inline void DropDown(::UnityEngine::Rect position, ::UnityEngine::UIElements::VisualElement* targetElement, bool anchored);

  /// @brief Method EnsureVisibilityInParent, addr 0x4992d38, size 0x57c, virtual false, abstract: false, final false
  inline void EnsureVisibilityInParent();

  /// @brief Method GetSelectedIndex, addr 0x4991520, size 0xa0, virtual false, abstract: false, final false
  inline int32_t GetSelectedIndex();

  /// @brief Method Hide, addr 0x49912c0, size 0x90, virtual false, abstract: false, final false
  inline void Hide(bool giveFocusBack);

  static inline ::UnityEngine::UIElements::GenericDropdownMenu* New_ctor();

  /// @brief Method OnAttachToPanel, addr 0x4990b10, size 0x418, virtual false, abstract: false, final false
  inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent* evt);

  /// @brief Method OnContainerGeometryChanged, addr 0x49932bc, size 0x4, virtual false, abstract: false, final false
  inline void OnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnDetachFromPanel, addr 0x4990f28, size 0x398, virtual false, abstract: false, final false
  inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method OnFocusOut, addr 0x4991bf4, size 0x148, virtual false, abstract: false, final false
  inline void OnFocusOut(::UnityEngine::UIElements::FocusOutEvent* evt);

  /// @brief Method OnParentResized, addr 0x4991d3c, size 0x14, virtual false, abstract: false, final false
  inline void OnParentResized(::UnityEngine::UIElements::GeometryChangedEvent* evt);

  /// @brief Method OnPointerDown, addr 0x4991724, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnPointerMove, addr 0x4991980, size 0x12c, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* evt);

  /// @brief Method OnPointerUp, addr 0x4991aac, size 0x148, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OnTargetElementDetachFromPanel, addr 0x49932b4, size 0x8, virtual false, abstract: false, final false
  inline void OnTargetElementDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent* evt);

  /// @brief Method UpdateItem, addr 0x49922e4, size 0x124, virtual false, abstract: false, final false
  inline void UpdateItem(::StringW itemName, bool isChecked);

  /// @brief Method UpdateSelection, addr 0x4991850, size 0x130, virtual false, abstract: false, final false
  inline void UpdateSelection(::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method <Apply>g__UpdateSelectionDown|39_0, addr 0x4991668, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method <Apply>g__UpdateSelectionUp|39_1, addr 0x49915c0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x498e800, size 0x2e8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_closeOnParentResize, addr 0x4990ad8, size 0x8, virtual false, abstract: false, final false
  inline bool get_closeOnParentResize();

  /// @brief Method get_contentContainer, addr 0x4990aec, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_isSingleSelectionDropdown, addr 0x4990ac4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_closeOnParentResize, addr 0x4990ae0, size 0xc, virtual false, abstract: false, final false
  inline void set_closeOnParentResize(bool value);

  /// @brief Method set_isSingleSelectionDropdown, addr 0x4990acc, size 0xc, virtual false, abstract: false, final false
