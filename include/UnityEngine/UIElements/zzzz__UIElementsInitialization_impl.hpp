...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::UIElements::UIElementsInitialization::InitializeUIElementsManaged)> {
  ...
  constexpr static std::size_t addrs = 0x6ae8314;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIElementsInitialization*>::get(),
                        "InitializeUIElementsManaged",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::UIElements::UIElementsInitialization::RegisterBuiltInPropertyBags)> {
  ...
  constexpr static std::size_t addrs = 0x6ae8318;
