...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6d8baa8, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::CanStartDragArgs) == 0x18, "Size mismatch!");
