...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DragAndDropUtility*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DragAndDropUtility*, "UnityEngine.UIElements", "DragAndDropUtility");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DragAndDropUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DragAndDropUtility(DragAndDropUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DragAndDropUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DragAndDropUtility(DragAndDropUtilityconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::DragAndDropUtility) == 0x10, "Size mismatch!");
