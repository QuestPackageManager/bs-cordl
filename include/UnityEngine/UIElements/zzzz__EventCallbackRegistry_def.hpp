...
public:
  ...
  /// @brief Method GetCallbackList, addr 0x4a28654, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCallbackListForReading, addr 0x4a287f8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventCallbackList* GetCallbackListForReading();

  /// @brief Method GetCallbackListForWriting, addr 0x4a28740, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventCallbackList* GetCallbackListForWriting();

  /// @brief Method HasBubbleHandlers, addr 0x4a28a2c, size 0x20, virtual false, abstract: false, final false
  inline bool HasBubbleHandlers();

  /// @brief Method HasTrickleDownHandlers, addr 0x4a28a0c, size 0x20, virtual false, abstract: false, final false
  inline bool HasTrickleDownHandlers();

  /// @brief Method InvokeCallbacks, addr 0x4a28868, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReleaseCallbackList, addr 0x4a286bc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method UnregisterCallback, addr 0x4a28814, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a28724, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
