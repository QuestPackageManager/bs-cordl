...
/// @brief Method .ctor, addr 0x6b85098, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6b85100, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6b85224, size 0x268, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int64_t  startValue) ;

/// @brief Method ClampMinMaxLongValue, addr 0x6b8548c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6b8558c, size 0xa0, virtual true, abstract: false, final false
inline int64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6b85530, size 0x5c, virtual true, abstract: false, final false
inline ::StringW ValueToString(int64_t  v) ;

/// @brief Method .ctor, addr 0x6b84e9c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x6b851c8, size 0x5c, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentLongField, addr 0x6b8514c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x6b84f58, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int64_t  startValue) ;

/// @brief Method CanTryParse, addr 0x6b84f38, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x6b84c30, size 0xe0, virtual true, abstract: false, final false
inline int64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x6b84b70, size 0xc0, virtual true, abstract: false, final false
inline ::StringW ValueToString(int64_t  v) ;

/// @brief Method .ctor, addr 0x6b84d10, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6b84d1c, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method get_longInput, addr 0x6b84ae0, size 0x90, virtual false, abstract: false, final false
