...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x4a3b37c, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MouseOutEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x4a3b374, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4a3b2d0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
