...
class CORDL_TYPE __Vector2IntField__UxmlFactory
    : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::Vector2IntField*, ::UnityEngine::UIElements::__Vector2IntField__UxmlTraits*> {
public:
  // Declarations
  static inline ::UnityEngine::UIElements::__Vector2IntField__UxmlFactory* New_ctor();

  /// @brief Method .ctor, addr 0x491637c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x49163c4, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4916520, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static __declspec(property(
      ...
      put = setStaticF___9__0_1)) ::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>* __9__0_1;
  ...
  static __declspec(property(
      ...
      put = setStaticF___9__0_3)) ::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>* __9__0_3;

  static inline ::UnityEngine::UIElements::__Vector2IntField____c* New_ctor();

  /// @brief Method <DescribeFields>b__0_0, addr 0x4916654, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_0(::UnityEngine::Vector2Int r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x491665c, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(ByRef<::UnityEngine::Vector2Int> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x4916664, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_2(::UnityEngine::Vector2Int r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x491666c, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(ByRef<::UnityEngine::Vector2Int> r, int32_t v);

  /// @brief Method .ctor, addr 0x491664c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  static inline void
  setStaticF___9__0_1(::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>* value);

  static inline void setStaticF___9__0_2(::System::Func_2<::UnityEngine::Vector2Int, int32_t>* value);

  static inline void
  setStaticF___9__0_3(::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>* value);
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x4915df4, size 0x390, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityEngine::UIElements::__BaseCompositeField_3__FieldDescription<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>,
                  ::Array<::UnityEngine::UIElements::__BaseCompositeField_3__FieldDescription<::UnityEngine::Vector2Int, ::UnityEngine::UIElements::IntegerField*, int32_t>>*>
  DescribeFields();
  ...
  /// @brief Method .ctor, addr 0x4916184, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x491618c, size 0x120, virtual false, abstract: false, final false
