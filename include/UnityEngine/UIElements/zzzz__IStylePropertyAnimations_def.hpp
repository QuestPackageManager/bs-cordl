...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IStylePropertyAnimations", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IStylePropertyAnimations(IStylePropertyAnimationsconst&) = delete;
