...
public:
  ...
  /// @brief Method HandleEventBubbleUp, addr 0x6b4b1c4, size 0x270, virtual false, abstract: false, final false
  inline void HandleEventBubbleUp(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method InitTextEditorEventHandler, addr 0x6b4b0c4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnFocusInEvent, addr 0x6b4b438, size 0x2e0, virtual false, abstract: false, final false
  inline void OnFocusInEvent();

  /// @brief Method OnFocusOutEvent, addr 0x6b4b718, size 0xb8, virtual false, abstract: false, final false
  inline void OnFocusOutEvent();

  /// @brief Method Reset, addr 0x6b4b198, size 0x2c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method <OnFocusInEvent>b__14_0, addr 0x6b4b7d0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b4afa4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::TextElement* textElement);

  /// @brief Method get_editingEventHandler, addr 0x6b4ae98, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextEditorEventHandler* get_editingEventHandler();

  /// @brief Method get_touchScreenTextFieldChanged, addr 0x6b4af00, size 0xa4, virtual false, abstract: false, final false
  inline bool get_touchScreenTextFieldChanged();

  /// @brief Method set_editingEventHandler, addr 0x6b4aea0, size 0x60, virtual false, abstract: false, final false
