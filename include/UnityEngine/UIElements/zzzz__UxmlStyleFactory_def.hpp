...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5286 }), TypeDefinitionIndex(TypeDefinitionIndex(6744)),
// TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(6973))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6972)) CS Name:
