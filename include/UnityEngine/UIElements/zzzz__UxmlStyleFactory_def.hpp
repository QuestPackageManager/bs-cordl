...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UxmlStyleFactory*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UxmlStyleFactory*, "UnityEngine.UIElements", "UxmlStyleFactory");
...
public:
  ...
  /// @brief Method Create, addr 0x6cbb5e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbb5e8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x6cbb524, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x6cbb568, size 0x78, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlStyleFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlStyleFactory(UxmlStyleFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlStyleFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlStyleFactory(UxmlStyleFactoryconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::UxmlStyleFactory) == 0x18, "Size mismatch!");
