...
/// @brief Method Create, addr 0x6b641a0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b641a8, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_uxmlName, addr 0x6b640e4, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_uxmlName() ;

/// @brief Method get_uxmlQualifiedName, addr 0x6b64128, size 0x78, virtual true, abstract: false, final false
