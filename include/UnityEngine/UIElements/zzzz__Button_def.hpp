...
public:
  ...
  /// @brief Method .ctor, addr 0x6be000c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be0128, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be0074, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DoMeasure, addr 0x6bdfd6c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method OnNavigationSubmit, addr 0x6bdfd30, size 0x3c, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method ResetButtonHierarchy, addr 0x6bdf6a8, size 0xf0, virtual false, abstract: false, final false
  inline void ResetButtonHierarchy();

  /// @brief Method UpdateButtonHierarchy, addr 0x6bdf798, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bdfb24, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bdfb98, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::System::Action* clickEvent);

  /// @brief Method .ctor, addr 0x6bdfb58, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clickable, addr 0x6bdf3e8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Clickable* get_clickable();

  /// @brief Method get_iconImage, addr 0x6bdf450, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Background get_iconImage();

  /// @brief Method get_text, addr 0x6bdf9a0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method set_clickable, addr 0x6bdf3f0, size 0x60, virtual false, abstract: false, final false
  inline void set_clickable(::UnityEngine::UIElements::Clickable* value);

  /// @brief Method set_iconImage, addr 0x6bdf460, size 0x248, virtual false, abstract: false, final false
  inline void set_iconImage(::UnityEngine::UIElements::Background value);

  /// @brief Method set_text, addr 0x6bdf9c0, size 0x164, virtual true, abstract: false, final false
