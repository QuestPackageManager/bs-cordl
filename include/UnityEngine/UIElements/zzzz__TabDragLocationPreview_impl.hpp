...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::VisualElement* (::UnityEngine::UIElements::TabDragLocationPreview::*)()>(&::UnityEngine::UIElements::TabDragLocationPreview::get_preview)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6ba96f8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TabDragLocationPreview*>::get(),
                        "get_preview",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::TabDragLocationPreview::*)()>(&::UnityEngine::UIElements::TabDragLocationPreview::_ctor)> {
  constexpr static std::size_t size = 0x108;
  constexpr static std::size_t addrs = 0x6ba9700;
...
::cordl_internals::setStaticField<::StringW, "ussClassName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TabDragLocationPreview*>::get>(std::forward<::StringW>(value));
}
...
::cordl_internals::setStaticField<::StringW, "visualUssClassName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TabDragLocationPreview*>::get>(std::forward<::StringW>(value));
}
...
::cordl_internals::setStaticField<::StringW, "verticalUssClassName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TabDragLocationPreview*>::get>(std::forward<::StringW>(value));
}
...
::cordl_internals::setStaticField<::StringW, "horizontalUssClassName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TabDragLocationPreview*>::get>(std::forward<::StringW>(value));
}
