...
/// @brief Method .ctor, addr 0x6a65968, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BindingStatus  status, ::StringW  message) ;

/// @brief Method get_message, addr 0x6a65960, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_message() ;

/// @brief Method get_status, addr 0x6a65958, size 0x8, virtual false, abstract: false, final false
