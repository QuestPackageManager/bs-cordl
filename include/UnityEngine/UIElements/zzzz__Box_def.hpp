...
/// @brief Method .ctor, addr 0x6be0eec, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6be0de8, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
