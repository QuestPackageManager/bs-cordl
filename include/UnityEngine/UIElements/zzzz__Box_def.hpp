...
public:
  ...
  /// @brief Method .ctor, addr 0x6bdf374, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6bdf270, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
