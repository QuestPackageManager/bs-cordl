...
public:
  ...
  /// @brief Method .ctor, addr 0x49879bc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x49878c8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
