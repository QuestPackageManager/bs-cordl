...
public:
  ...
  /// @brief Method .ctor, addr 0x4912028, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4911f34, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
