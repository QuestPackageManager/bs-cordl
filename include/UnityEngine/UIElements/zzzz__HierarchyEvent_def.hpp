...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6db77d4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6db768c, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HierarchyEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HierarchyEvent(HierarchyEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HierarchyEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HierarchyEvent(HierarchyEventconst&) = delete;
