...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6c5e81c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c5e6d4, size 0x148, virtual false, abstract: false, final false
