...
public:
  ...
  /// @brief Method .ctor, addr 0x6c17f84, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c17fec, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c182f0, size 0x26c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyInputDeviceDelta, addr 0x6c177f0, size 0x110, virtual true, abstract: false, final false
  inline void ApplyInputDeviceDelta(::UnityEngine::Vector3 delta, ::UnityEngine::UIElements::DeltaSpeed speed, float_t startValue);

  /// @brief Method ComputeValueFromKey, addr 0x6c17cd0, size 0x1d8, virtual true, abstract: false, final false
  ...
  /// @brief Method ParseStringToValue, addr 0x6c17c48, size 0x88, virtual true, abstract: false, final false
  inline float_t ParseStringToValue(::StringW previousValue, ::StringW newValue);

  /// @brief Method SliderLerpUnclamped, addr 0x6c17900, size 0x2b8, virtual true, abstract: false, final false
  inline float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant);

  /// @brief Method SliderNormalizeValue, addr 0x6c17110, size 0xa8, virtual true, abstract: false, final false
  inline float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue);

  /// @brief Method SliderRange, addr 0x6c17bb8, size 0x90, virtual true, abstract: false, final false
  inline float_t SliderRange();

  /// @brief Method .ctor, addr 0x6c17680, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c17698, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c170dc, size 0xc, virtual false, abstract: false, final false
