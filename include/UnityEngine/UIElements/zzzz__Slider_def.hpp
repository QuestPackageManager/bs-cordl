...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Slider*);
MARK_REF_T(::UnityEngine::UIElements::Slider_UxmlFactory*);
MARK_REF_T(::UnityEngine::UIElements::Slider_UxmlTraits*);
...
static_assert(sizeof(::UnityEngine::UIElements::Slider_UxmlTraits) == 0xd0, "Size mismatch!");
