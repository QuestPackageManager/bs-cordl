...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3316c24, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3316b68, size 0xbc, virtual false, abstract: false, final false
