...
public:
  ...
  /// @brief Method .ctor, addr 0x499c310, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x499c358, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499c4bc, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x499c5f0, size 0x4, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_0(::UnityEngine::Vector2 r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x499c5f4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::Vector2> r, float_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x499c5fc, size 0x8, virtual false, abstract: false, final false
  inline float_t _DescribeFields_b__0_2(::UnityEngine::Vector2 r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x499c604, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::Vector2> r, float_t v);

  /// @brief Method .ctor, addr 0x499c5e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x499bd88, size 0x390, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499c118, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x499c120, size 0x120, virtual false, abstract: false, final false
