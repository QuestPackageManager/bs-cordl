...
public:
  ...
  /// @brief Method Dispose, addr 0x499f844, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x499f8b0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499bf70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_panelChanged, addr 0x499f6c4, size 0xb0, virtual false, abstract: false, final false
  inline void add_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method get_panel, addr 0x499be9c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_visualTree, addr 0x499d4a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_panelChanged, addr 0x499f774, size 0xb0, virtual false, abstract: false, final false
  inline void remove_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method set_panel, addr 0x499f824, size 0x20, virtual true, abstract: false, final true
