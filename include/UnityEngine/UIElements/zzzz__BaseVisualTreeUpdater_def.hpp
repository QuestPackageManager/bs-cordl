...
public:
  ...
  /// @brief Method Dispose, addr 0x6b78678, size 0x74, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b786ec, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method UnityEngine.UIElements.IVisualTreeUpdater.get_FrameCount, addr 0x6b784c8, size 0x8, virtual true, abstract: false, final true
  inline int64_t UnityEngine_UIElements_IVisualTreeUpdater_get_FrameCount();

  /// @brief Method UnityEngine.UIElements.IVisualTreeUpdater.set_FrameCount, addr 0x6b784d0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6b74ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_panelChanged, addr 0x6b784d8, size 0xc0, virtual false, abstract: false, final false
  inline void add_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method get_panel, addr 0x6b74c14, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_visualTree, addr 0x6b7637c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_panelChanged, addr 0x6b78598, size 0xc0, virtual false, abstract: false, final false
  inline void remove_panelChanged(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>* value);

  /// @brief Method set_panel, addr 0x6b78658, size 0x20, virtual true, abstract: false, final true
