...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimerEventScheduler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimerEventScheduler(TimerEventScheduler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimerEventScheduler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimerEventScheduler(TimerEventSchedulerconst&) = delete;
