...
public:
  ...
  /// @brief Method PrivateUnSchedule, addr 0x4a66344, size 0xa0, virtual false, abstract: false, final false
  inline bool PrivateUnSchedule(::UnityEngine::UIElements::ScheduledItem* sItem);

  /// @brief Method RemovedScheduledItemAt, addr 0x4a66138, size 0x7c, virtual false, abstract: false, final false
  inline bool RemovedScheduledItemAt(int32_t index);

  /// @brief Method Schedule, addr 0x4a65f80, size 0x1b8, virtual true, abstract: false, final true
  inline void Schedule(::UnityEngine::UIElements::ScheduledItem* item);

  /// @brief Method Unschedule, addr 0x4a661b4, size 0x190, virtual true, abstract: false, final true
  inline void Unschedule(::UnityEngine::UIElements::ScheduledItem* item);

  /// @brief Method UpdateScheduledEvents, addr 0x4a663e4, size 0x314, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4a666f8, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();
