...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::MouseOverEvent___c::*)()>(&::UnityEngine::UIElements::MouseOverEvent___c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6bd4fc4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::MouseOverEvent* (::UnityEngine::UIElements::MouseOverEvent___c::*)()>(&::UnityEngine::UIElements::MouseOverEvent___c::__cctor_b__0_0)> {
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::MouseOverEvent___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MouseOverEvent___c*>::get>(std::forward<::UnityEngine::UIElements::MouseOverEvent___c*>(value));
}
inline ::UnityEngine::UIElements::MouseOverEvent___c* UnityEngine::UIElements::MouseOverEvent___c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::MouseOverEvent___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MouseOverEvent___c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::MouseOverEvent::*)(::UnityEngine::UIElements::BaseVisualElementPanel*)>(&::UnityEngine::UIElements::MouseOverEvent::Dispatch)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6bd4e98;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::MouseOverEvent::*)(::UnityEngine::UIElements::IPanel*)>(&::UnityEngine::UIElements::MouseOverEvent::PreDispatch)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0x6bd4e9c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::MouseOverEvent::*)()>(&::UnityEngine::UIElements::MouseOverEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6bd4f24;
