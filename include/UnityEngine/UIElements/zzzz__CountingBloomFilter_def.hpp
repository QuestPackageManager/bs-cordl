...
/// @brief Method AdjustSlot, addr 0x6bb74b0, size 0x2c, virtual false, abstract: false, final false
inline void AdjustSlot(uint32_t  index, bool  increment) ;

/// @brief Method ContainsHash, addr 0x6bb7564, size 0x28, virtual false, abstract: false, final false
inline bool ContainsHash(uint32_t  hash) ;

/// @brief Method Hash1, addr 0x6bb74dc, size 0x8, virtual false, abstract: false, final false
inline uint32_t Hash1(uint32_t  hash) ;

/// @brief Method Hash2, addr 0x6bb74e4, size 0x8, virtual false, abstract: false, final false
inline uint32_t Hash2(uint32_t  hash) ;

/// @brief Method InsertHash, addr 0x6bb74fc, size 0x38, virtual false, abstract: false, final false
inline void InsertHash(uint32_t  hash) ;

/// @brief Method IsSlotEmpty, addr 0x6bb74ec, size 0x10, virtual false, abstract: false, final false
inline bool IsSlotEmpty(uint32_t  index) ;

/// @brief Method RemoveHash, addr 0x6bb7534, size 0x30, virtual false, abstract: false, final false
