...
// Write type traits
MARK_REF_PTR_T(::UnityEngine::UIElements::LanguageDirectionExtensions);
...
public:
// Declarations
/// @brief Method toTextCore, addr 0x6b71fa4, size 0xa4, virtual false, abstract: false, final false
