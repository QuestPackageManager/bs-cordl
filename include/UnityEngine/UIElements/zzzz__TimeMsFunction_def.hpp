...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x355ec0c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355eb50, size 0xbc, virtual false, abstract: false, final false
