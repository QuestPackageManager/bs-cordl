...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3547d88, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3547ccc, size 0xbc, virtual false, abstract: false, final false
