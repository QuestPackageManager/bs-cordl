...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x49c8530, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49c84a8, size 0x88, virtual false, abstract: false, final false
