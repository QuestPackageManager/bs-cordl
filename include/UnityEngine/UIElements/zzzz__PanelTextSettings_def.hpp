...
public:
  ...
  /// @brief Method GetCachedFontAsset, addr 0x4a91b84, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateLocalizationFontAsset, addr 0x4a915c8, size 0x5bc, virtual false, abstract: false, final false
  static inline void UpdateLocalizationFontAsset();

  /// @brief Method .ctor, addr 0x4a91b8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_defaultPanelTextSettings, addr 0x4a91494, size 0x134, virtual false, abstract: false, final false
