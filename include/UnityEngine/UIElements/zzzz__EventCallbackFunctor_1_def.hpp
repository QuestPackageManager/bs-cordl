...
static inline ::UnityEngine::UIElements::EventCallbackFunctor_1<TEventType>* GetPooled(int64_t  eventTypeId, ::UnityEngine::UIElements::EventCallback_1<TEventType>*  callback, ::UnityEngine::UIElements::InvokePolicy  invokePolicy) ;
