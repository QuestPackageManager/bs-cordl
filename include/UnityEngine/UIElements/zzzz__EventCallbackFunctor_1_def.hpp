...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventCallbackFunctor_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventCallbackFunctor_1(EventCallbackFunctor_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventCallbackFunctor_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventCallbackFunctor_1(EventCallbackFunctor_1const&) = delete;
