...
public:
  // Declarations
  /// [CompilerGenerated]
  /// @brief Method add_propertyChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void add_propertyChanged(::System::EventHandler_1<::UnityEngine::UIElements::BindablePropertyChangedEventArgs>* value);

  /// [CompilerGenerated]
  /// @brief Method remove_propertyChanged, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void remove_propertyChanged(::System::EventHandler_1<::UnityEngine::UIElements::BindablePropertyChangedEventArgs>* value);

  // Ctor Parameters [CppParam { name: "", ty: "INotifyBindablePropertyChanged", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INotifyBindablePropertyChanged(INotifyBindablePropertyChangedconst&) = delete;
