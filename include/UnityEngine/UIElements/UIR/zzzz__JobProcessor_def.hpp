...
public:
// Declarations
/// @brief Method ScheduleConvertMeshJobs, addr 0x6b078c0, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConvertMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleConvertMeshJobs_Injected, addr 0x6b0791c, size 0x54, virtual false, abstract: false, final false
static inline void ScheduleConvertMeshJobs_Injected(::System::IntPtr  buffer, int32_t  jobCount, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleCopyMeshJobs, addr 0x6b07970, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleCopyMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleCopyMeshJobs_Injected, addr 0x6b079cc, size 0x54, virtual false, abstract: false, final false
static inline void ScheduleCopyMeshJobs_Injected(::System::IntPtr  buffer, int32_t  jobCount, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleNudgeJobs, addr 0x6b07810, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleNudgeJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleNudgeJobs_Injected, addr 0x6b0786c, size 0x54, virtual false, abstract: false, final false
