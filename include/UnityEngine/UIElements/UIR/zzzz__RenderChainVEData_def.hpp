...
/// @brief Method AllocatesID, addr 0x6b950f0, size 0x70, virtual false, abstract: false, final false
static inline bool AllocatesID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method InheritsID, addr 0x6b95170, size 0x6c, virtual false, abstract: false, final false
static inline bool InheritsID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method get_hasExtraData, addr 0x6b95200, size 0xc, virtual false, abstract: false, final false
inline bool get_hasExtraData() ;

/// @brief Method get_hasExtraMeshes, addr 0x6b9520c, size 0xc, virtual false, abstract: false, final false
inline bool get_hasExtraMeshes() ;

/// @brief Method get_isGroupTransform, addr 0x6b951e8, size 0xc, virtual false, abstract: false, final false
inline bool get_isGroupTransform() ;

/// @brief Method get_isIgnoringDynamicColorHint, addr 0x6b951f4, size 0xc, virtual false, abstract: false, final false
inline bool get_isIgnoringDynamicColorHint() ;

/// @brief Method get_isInChain, addr 0x6b951dc, size 0xc, virtual false, abstract: false, final false
inline bool get_isInChain() ;

/// @brief Method get_lastTailOrHeadCommand, addr 0x6b950d8, size 0x18, virtual false, abstract: false, final false
