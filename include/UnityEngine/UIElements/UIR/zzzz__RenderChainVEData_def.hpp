...
public:
  ...
  /// @brief Method AllocatesID, addr 0x6cec530, size 0x70, virtual false, abstract: false, final false
  static inline bool AllocatesID(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method InheritsID, addr 0x6cec5b0, size 0x6c, virtual false, abstract: false, final false
  static inline bool InheritsID(::UnityEngine::UIElements::UIR::BMPAlloc alloc);

  /// @brief Method get_hasExtraData, addr 0x6cec640, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasExtraData();

  /// @brief Method get_hasExtraMeshes, addr 0x6cec64c, size 0xc, virtual false, abstract: false, final false
  inline bool get_hasExtraMeshes();

  /// @brief Method get_isGroupTransform, addr 0x6cec628, size 0xc, virtual false, abstract: false, final false
  inline bool get_isGroupTransform();

  /// @brief Method get_isIgnoringDynamicColorHint, addr 0x6cec634, size 0xc, virtual false, abstract: false, final false
  inline bool get_isIgnoringDynamicColorHint();

  /// @brief Method get_isInChain, addr 0x6cec61c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isInChain();

  /// @brief Method get_lastTailOrHeadCommand, addr 0x6cec518, size 0x18, virtual false, abstract: false, final false
