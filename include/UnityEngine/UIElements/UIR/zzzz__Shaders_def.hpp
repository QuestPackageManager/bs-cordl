...
/// @brief Method Acquire, addr 0x6b264a4, size 0x64, virtual false, abstract: false, final false
static inline void Acquire() ;

/// @brief Method GetOrCreateMaterial, addr 0x6b2625c, size 0x188, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetOrCreateMaterial(::ByRef<::UnityEngine::Material*>  material, ::StringW  shaderName) ;

/// @brief Method Release, addr 0x6b26508, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method get_editorMaterial, addr 0x6b26444, size 0x60, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_editorMaterial() ;

/// @brief Method get_runtimeMaterial, addr 0x6b261fc, size 0x60, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_runtimeMaterial() ;

/// @brief Method get_runtimeWorldMaterial, addr 0x6b263e4, size 0x60, virtual false, abstract: false, final false
