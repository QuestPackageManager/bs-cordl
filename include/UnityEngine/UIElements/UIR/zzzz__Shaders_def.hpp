...
public:
  ...
  /// @brief Method Acquire, addr 0x6b986ec, size 0x64, virtual false, abstract: false, final false
  static inline void Acquire();

  /// @brief Method GetOrCreateMaterial, addr 0x6b984a4, size 0x188, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetOrCreateMaterial(::ByRef<::UnityEngine::Material*> material, ::StringW shaderName);

  /// @brief Method Release, addr 0x6b98750, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method get_editorMaterial, addr 0x6b9868c, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_editorMaterial();

  /// @brief Method get_runtimeMaterial, addr 0x6b98444, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> get_runtimeMaterial();

  /// @brief Method get_runtimeWorldMaterial, addr 0x6b9862c, size 0x60, virtual false, abstract: false, final false
