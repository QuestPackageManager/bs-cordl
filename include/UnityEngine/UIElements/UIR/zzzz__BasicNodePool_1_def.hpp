...
// Write type traits
MARK_GEN_REF_T_PTR(::UnityEngine::UIElements::UIR::BasicNodePool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::UnityEngine::UIElements::UIR::BasicNodePool_1, "UnityEngine.UIElements.UIR", "BasicNodePool`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicNodePool_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicNodePool_1(BasicNodePool_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicNodePool_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicNodePool_1(BasicNodePool_1const&) = delete;
