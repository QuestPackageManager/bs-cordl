...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BaseShaderInfoStorage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BaseShaderInfoStorage(BaseShaderInfoStorage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BaseShaderInfoStorage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BaseShaderInfoStorage(BaseShaderInfoStorageconst&) = delete;
