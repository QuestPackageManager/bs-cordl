...
// def_value: Some("{}"), comment: None }, CppParam { name: "vertCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexSrc", ty: "::System::IntPtr",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexDst", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexCount", ty:
// "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexOffset", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
