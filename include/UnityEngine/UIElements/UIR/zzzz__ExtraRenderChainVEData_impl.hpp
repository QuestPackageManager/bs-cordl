...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::ExtraRenderChainVEData::*)()>(&::UnityEngine::UIElements::UIR::ExtraRenderChainVEData::Reset)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x6b212b4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::ExtraRenderChainVEData*>::get(),
                        "Reset",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::ExtraRenderChainVEData::*)()>(&::UnityEngine::UIElements::UIR::ExtraRenderChainVEData::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x6b21264;
...
constexpr ::UnityEngine::UIElements::UIR::BasicNode_1<::UnityEngine::UIElements::UIR::MeshHandle*>* const& UnityEngine::UIElements::UIR::ExtraRenderChainVEData::__cordl_internal_get_extraMesh() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___extraMesh;
}
