...
struct __OpacityIdAccelerator__OpacityIdUpdateJob;
}
...
MARK_VAL_T(::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob);
// Type: ::OpacityIdUpdateJob
...
namespace UnityEngine::UIElements::UIR {
// Is value type: true
// CS Name: ::OpacityIdAccelerator::OpacityIdUpdateJob
struct CORDL_TYPE __OpacityIdAccelerator__OpacityIdUpdateJob {
public:
  // Declarations
  /// @brief Convert operator to "::Unity::Jobs::IJobParallelFor"
  constexpr operator ::Unity::Jobs::IJobParallelFor*();

  /// @brief Method Execute, addr 0x49435ec, size 0x128, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __OpacityIdAccelerator__OpacityIdUpdateJob();
  ...
  // None }]
  constexpr __OpacityIdAccelerator__OpacityIdUpdateJob(::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex> oldVerts,
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob, 0x28>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob, oldVerts) == 0x0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob, newVerts) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob, opacityData) == 0x20, "Offset mismatch!");
...
public:
  // Declarations
  using OpacityIdUpdateJob = ::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob;
  ...
  /// @brief Method CompleteJobs, addr 0x49433f8, size 0x98, virtual false, abstract: false, final false
  inline void CompleteJobs();

  /// @brief Method CreateJob, addr 0x4943304, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x49434a4, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4943510, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4943574, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disposed, addr 0x4943490, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x4943498, size 0xc, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::__OpacityIdAccelerator__OpacityIdUpdateJob, "UnityEngine.UIElements.UIR", "OpacityIdAccelerator/OpacityIdUpdateJob");
