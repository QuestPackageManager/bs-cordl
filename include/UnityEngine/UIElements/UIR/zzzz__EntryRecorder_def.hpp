...
public:
  ...
  /// @brief Method Append, addr 0x6aa8820, size 0x98, virtual false, abstract: false, final false
  static inline void Append(::UnityEngine::UIElements::UIR::Entry* parentEntry, ::UnityEngine::UIElements::UIR::Entry* entry);

  /// @brief Method AppendMeshEntry, addr 0x6aa7864, size 0x270, virtual false, abstract: false, final false
  static inline void AppendMeshEntry(::UnityEngine::UIElements::UIR::Entry* parentEntry, ::UnityEngine::UIElements::UIR::Entry* entry);

  /// @brief Method BeginStencilMask, addr 0x6aa7dc4, size 0xb0, virtual false, abstract: false, final false
  inline void BeginStencilMask(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method BlitAndPopRenderTexture, addr 0x6aa84a4, size 0xb0, virtual false, abstract: false, final false
  inline void BlitAndPopRenderTexture(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method CutRenderChain, addr 0x6aa86bc, size 0xb0, virtual false, abstract: false, final false
  inline void CutRenderChain(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method DrawChildren, addr 0x6aa7d14, size 0xb0, virtual false, abstract: false, final false
  inline void DrawChildren(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method DrawGradients, addr 0x6aa7be4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawImmediate, addr 0x6aa7c50, size 0xc4, virtual false, abstract: false, final false
  inline void DrawImmediate(::UnityEngine::UIElements::UIR::Entry* parentEntry, ::System::Action* callback, bool cullingEnabled);

  /// @brief Method DrawMesh, addr 0x6aa77e4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawRasterText, addr 0x6aa7ad4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawSdfText, addr 0x6aa7b5c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method EndStencilMask, addr 0x6aa7e74, size 0xb0, virtual false, abstract: false, final false
  inline void EndStencilMask(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method InsertPlaceholder, addr 0x6aa876c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method PopClippingRect, addr 0x6aa8084, size 0xb0, virtual false, abstract: false, final false
  inline void PopClippingRect(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PopDefaultMaterial, addr 0x6aa860c, size 0xb0, virtual false, abstract: false, final false
  inline void PopDefaultMaterial(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PopGroupMatrix, addr 0x6aa8344, size 0xb0, virtual false, abstract: false, final false
  inline void PopGroupMatrix(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PopScissors, addr 0x6aa81e4, size 0xb0, virtual false, abstract: false, final false
  inline void PopScissors(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PopStencilMask, addr 0x6aa7f24, size 0xb0, virtual false, abstract: false, final false
  inline void PopStencilMask(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PushClippingRect, addr 0x6aa7fd4, size 0xb0, virtual false, abstract: false, final false
  inline void PushClippingRect(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PushDefaultMaterial, addr 0x6aa8554, size 0xb8, virtual false, abstract: false, final false
  inline void PushDefaultMaterial(::UnityEngine::UIElements::UIR::Entry* parentEntry, ::UnityEngine::Material* material);

  /// @brief Method PushGroupMatrix, addr 0x6aa8294, size 0xb0, virtual false, abstract: false, final false
  inline void PushGroupMatrix(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PushRenderTexture, addr 0x6aa83f4, size 0xb0, virtual false, abstract: false, final false
  inline void PushRenderTexture(::UnityEngine::UIElements::UIR::Entry* parentEntry);

  /// @brief Method PushScissors, addr 0x6aa8134, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6aa7770, size 0x74, virtual false, abstract: false, final false
