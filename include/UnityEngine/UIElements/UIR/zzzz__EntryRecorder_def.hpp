...
/// @brief Method Append, addr 0x6b11d64, size 0x98, virtual false, abstract: false, final false
static inline void Append(::UnityEngine::UIElements::UIR::Entry*  parentEntry, ::UnityEngine::UIElements::UIR::Entry*  entry) ;

/// @brief Method AppendMeshEntry, addr 0x6b10da8, size 0x270, virtual false, abstract: false, final false
static inline void AppendMeshEntry(::UnityEngine::UIElements::UIR::Entry*  parentEntry, ::UnityEngine::UIElements::UIR::Entry*  entry) ;

/// @brief Method BeginStencilMask, addr 0x6b11308, size 0xb0, virtual false, abstract: false, final false
inline void BeginStencilMask(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method BlitAndPopRenderTexture, addr 0x6b119e8, size 0xb0, virtual false, abstract: false, final false
inline void BlitAndPopRenderTexture(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method CutRenderChain, addr 0x6b11c00, size 0xb0, virtual false, abstract: false, final false
inline void CutRenderChain(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method DrawChildren, addr 0x6b11258, size 0xb0, virtual false, abstract: false, final false
inline void DrawChildren(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method DrawGradients, addr 0x6b11128, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method DrawImmediate, addr 0x6b11194, size 0xc4, virtual false, abstract: false, final false
inline void DrawImmediate(::UnityEngine::UIElements::UIR::Entry*  parentEntry, ::System::Action*  callback, bool  cullingEnabled) ;

/// @brief Method DrawMesh, addr 0x6b10d28, size 0x80, virtual false, abstract: false, final false
inline void DrawMesh(::UnityEngine::UIElements::UIR::Entry*  parentEntry, ::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>  vertices, ::Unity::Collections::NativeSlice_1<uint16_t>  indices, ::UnityEngine::Texture*  texture, bool  skipAtlas) ;

/// @brief Method DrawRasterText, addr 0x6b11018, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method DrawSdfText, addr 0x6b110a0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method EndStencilMask, addr 0x6b113b8, size 0xb0, virtual false, abstract: false, final false
inline void EndStencilMask(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method InsertPlaceholder, addr 0x6b11cb0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method PopClippingRect, addr 0x6b115c8, size 0xb0, virtual false, abstract: false, final false
inline void PopClippingRect(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PopDefaultMaterial, addr 0x6b11b50, size 0xb0, virtual false, abstract: false, final false
inline void PopDefaultMaterial(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PopGroupMatrix, addr 0x6b11888, size 0xb0, virtual false, abstract: false, final false
inline void PopGroupMatrix(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PopScissors, addr 0x6b11728, size 0xb0, virtual false, abstract: false, final false
inline void PopScissors(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PopStencilMask, addr 0x6b11468, size 0xb0, virtual false, abstract: false, final false
inline void PopStencilMask(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PushClippingRect, addr 0x6b11518, size 0xb0, virtual false, abstract: false, final false
inline void PushClippingRect(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PushDefaultMaterial, addr 0x6b11a98, size 0xb8, virtual false, abstract: false, final false
inline void PushDefaultMaterial(::UnityEngine::UIElements::UIR::Entry*  parentEntry, ::UnityEngine::Material*  material) ;

/// @brief Method PushGroupMatrix, addr 0x6b117d8, size 0xb0, virtual false, abstract: false, final false
inline void PushGroupMatrix(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PushRenderTexture, addr 0x6b11938, size 0xb0, virtual false, abstract: false, final false
inline void PushRenderTexture(::UnityEngine::UIElements::UIR::Entry*  parentEntry) ;

/// @brief Method PushScissors, addr 0x6b11678, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b10cb4, size 0x74, virtual false, abstract: false, final false
