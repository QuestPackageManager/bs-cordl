...
public:
  ...
  /// @brief Method Reset, addr 0x49ba268, size 0x1c8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x49b6030, size 0x164, virtual false, abstract: false, final false
  inline void _ctor();
