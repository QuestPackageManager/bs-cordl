...
/// @brief Method Reset, addr 0x6b31290, size 0x1e8, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x6b31478, size 0x15c, virtual false, abstract: false, final false
inline void _ctor() ;
