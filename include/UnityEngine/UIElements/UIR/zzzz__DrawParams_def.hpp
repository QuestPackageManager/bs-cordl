...
public:
  ...
  /// @brief Method Reset, addr 0x33219d4, size 0x1cc, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x331c6d8, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
