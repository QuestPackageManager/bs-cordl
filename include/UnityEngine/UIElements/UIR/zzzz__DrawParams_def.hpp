...
public:
  ...
  /// @brief Method Reset, addr 0x6ba34d8, size 0x1e8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6ba36c0, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor();
