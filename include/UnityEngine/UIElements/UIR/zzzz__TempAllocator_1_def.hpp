...
template <typename T> struct __TempAllocator_1__Page;
}
...
MARK_GEN_VAL_T(::UnityEngine::UIElements::UIR::__TempAllocator_1__Page);
// Type: ::Page
...
template <typename T>
// Is value type: true
// CS Name: ::TempAllocator`1::Page<T>
struct CORDL_TYPE __TempAllocator_1__Page {
public:
  // Declarations
  // Ctor Parameters []
  // @brief default ctor
  constexpr __TempAllocator_1__Page();
  ...
  // }]
  constexpr __TempAllocator_1__Page(::Unity::Collections::NativeArray_1<T> array, int32_t used) noexcept;
...
// SizeInfo { instance_size: 64, native_size: 61, calculated_instance_size: 64, calculated_native_size: 61, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::UIElements::UIR {
// cpp template
template <typename T>
// Is value type: false
...
public:
  // Declarations
  using Page = ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>;
  ...
  __declspec(property(get = __cordl_internal_get_m_Excess,
                      put = __cordl_internal_set_m_Excess)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>* m_Excess;
  ...
  __declspec(property(get = __cordl_internal_get_m_Pool, put = __cordl_internal_set_m_Pool)) ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T> m_Pool;
  ...
  constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*& __cordl_internal_get_m_Excess();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*> const& __cordl_internal_get_m_Excess() const;
  ...
  constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T> const& __cordl_internal_get_m_Pool() const;

  constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>& __cordl_internal_get_m_Pool();

  constexpr void __cordl_internal_set__disposed_k__BackingField(bool value);

  constexpr void __cordl_internal_set_m_Excess(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>* value);
  ...
  constexpr void __cordl_internal_set_m_Pool(::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T> value);
...
public:
  ...
  ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T> ___m_Pool;

  /// @brief Field m_Excess, offset: 0x30, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>* ___m_Excess;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::UIR::__TempAllocator_1__Page, "UnityEngine.UIElements.UIR", "TempAllocator`1/Page");
