...
public:
  ...
  /// @brief Method AppendCommand, addr 0x6b82b2c, size 0x40, virtual false, abstract: false, final false
  inline void AppendCommand(::UnityEngine::UIElements::UIR::RenderChainCommand* next);

  /// @brief Method ClearReferences, addr 0x6b81124, size 0x38, virtual false, abstract: false, final false
  inline void ClearReferences();

  /// @brief Method CreateBlitShader, addr 0x6b82c5c, size 0x1fc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> CreateBlitShader(float_t colorConversion);

  /// @brief Method CreateMeshDrawCommand, addr 0x6b82a4c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawReverseMask, addr 0x6b823ac, size 0x2ac, virtual false, abstract: false, final false
  inline void DrawReverseMask();

  /// @brief Method GetBlitMaterial, addr 0x6b82658, size 0x244, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBlitMaterial(::UnityEngine::UIElements::VisualElement_RenderTargetMode mode);

  /// @brief Method Init, addr 0x6b80ed4, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessFirstAlloc, addr 0x6b811bc, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessHead, addr 0x6b8115c, size 0x60, virtual false, abstract: false, final false
  inline void ProcessHead();

  /// @brief Method ProcessMeshEntry, addr 0x6b81d9c, size 0x610, virtual false, abstract: false, final false
  inline void ProcessMeshEntry(::UnityEngine::UIElements::UIR::Entry* entry, ::UnityEngine::UIElements::TextureId textureId);

  /// @brief Method ProcessNextAlloc, addr 0x6b8289c, size 0x14c, virtual false, abstract: false, final false
  inline void ProcessNextAlloc();

  /// @brief Method ProcessRange, addr 0x6b812ec, size 0x994, virtual false, abstract: false, final false
  inline void ProcessRange(int32_t first, int32_t last);

  /// @brief Method ProcessTail, addr 0x6b81c80, size 0x11c, virtual false, abstract: false, final false
  inline void ProcessTail();

  /// @brief Method UpdateOrAllocate, addr 0x6b82b6c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b82e58, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_firstHeadCommand, addr 0x6b80e94, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstHeadCommand();

  /// @brief Method get_firstTailCommand, addr 0x6b80eb4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstTailCommand();

  /// @brief Method get_lastHeadCommand, addr 0x6b80ea4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_lastHeadCommand();

  /// @brief Method get_lastTailCommand, addr 0x6b80ec4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_firstHeadCommand, addr 0x6b80e9c, size 0x8, virtual false, abstract: false, final false
  inline void set_firstHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand* value);

  /// @brief Method set_firstTailCommand, addr 0x6b80ebc, size 0x8, virtual false, abstract: false, final false
  inline void set_firstTailCommand(::UnityEngine::UIElements::UIR::RenderChainCommand* value);

  /// @brief Method set_lastHeadCommand, addr 0x6b80eac, size 0x8, virtual false, abstract: false, final false
  inline void set_lastHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand* value);

  /// @brief Method set_lastTailCommand, addr 0x6b80ecc, size 0x8, virtual false, abstract: false, final false
