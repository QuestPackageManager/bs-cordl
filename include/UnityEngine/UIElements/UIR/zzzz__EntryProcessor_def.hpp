...
// Ctor Parameters [CppParam { name: "vertices", ty: "::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>", modifiers: "", def_value: None }, CppParam { name: "indices", ty: "::Unity::Collections::NativeSlice_1<uint16_t>", modifiers: "", def_value: None }, CppParam { name: "indexOffset", ty: "int32_t", modifiers: "", def_value: None }]
...
// Dependencies System.Object, Unity.Collections.NativeSlice`1<T>, UnityEngine.Color32, UnityEngine.Matrix4x4, UnityEngine.Rect, UnityEngine.UIElements.UIR.BMPAlloc, UnityEngine.UIElements.UIR.VertexFlags, UnityEngine.UIElements.Vertex
namespace UnityEngine::UIElements::UIR {
// Is value type: false
...
/// @brief Field <firstHeadCommand>k__BackingField, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get__firstHeadCommand_k__BackingField, put=__cordl_internal_set__firstHeadCommand_k__BackingField)) ::UnityEngine::UIElements::UIR::RenderChainCommand*  _firstHeadCommand_k__BackingField;

/// @brief Field <firstTailCommand>k__BackingField, offset 0x138, size 0x8 
 __declspec(property(get=__cordl_internal_get__firstTailCommand_k__BackingField, put=__cordl_internal_set__firstTailCommand_k__BackingField)) ::UnityEngine::UIElements::UIR::RenderChainCommand*  _firstTailCommand_k__BackingField;

/// @brief Field <lastHeadCommand>k__BackingField, offset 0x130, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastHeadCommand_k__BackingField, put=__cordl_internal_set__lastHeadCommand_k__BackingField)) ::UnityEngine::UIElements::UIR::RenderChainCommand*  _lastHeadCommand_k__BackingField;

/// @brief Field <lastTailCommand>k__BackingField, offset 0x140, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastTailCommand_k__BackingField, put=__cordl_internal_set__lastTailCommand_k__BackingField)) ::UnityEngine::UIElements::UIR::RenderChainCommand*  _lastTailCommand_k__BackingField;
...
/// @brief Field m_MaskMeshes, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_MaskMeshes, put=__cordl_internal_set_m_MaskMeshes)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::UIR::EntryProcessor_MaskMesh>*  m_MaskMeshes;
...
/// @brief Method AppendCommand, addr 0x6b846a4, size 0x40, virtual false, abstract: false, final false
inline void AppendCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  next) ;

/// @brief Method ClearReferences, addr 0x6b82c9c, size 0x38, virtual false, abstract: false, final false
inline void ClearReferences() ;

/// @brief Method CreateBlitShader, addr 0x6b847d4, size 0x1fc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> CreateBlitShader(float_t  colorConversion) ;

/// @brief Method CreateMeshDrawCommand, addr 0x6b845c4, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* CreateMeshDrawCommand(::UnityEngine::UIElements::UIR::MeshHandle*  mesh, int32_t  indexCount, int32_t  indexOffset, ::UnityEngine::Material*  material, ::UnityEngine::UIElements::TextureId  texture) ;

/// @brief Method DrawReverseMask, addr 0x6b83f24, size 0x2ac, virtual false, abstract: false, final false
inline void DrawReverseMask() ;

/// @brief Method GetBlitMaterial, addr 0x6b841d0, size 0x244, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetBlitMaterial(::UnityEngine::UIElements::VisualElement_RenderTargetMode  mode) ;

/// @brief Method Init, addr 0x6b82a4c, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method ProcessFirstAlloc, addr 0x6b82d34, size 0x130, virtual false, abstract: false, final false
inline void ProcessFirstAlloc(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>*  allocList, ::ByRef<::UnityEngine::UIElements::UIR::MeshHandle*>  mesh) ;

/// @brief Method ProcessHead, addr 0x6b82cd4, size 0x60, virtual false, abstract: false, final false
inline void ProcessHead() ;

/// @brief Method ProcessMeshEntry, addr 0x6b83914, size 0x610, virtual false, abstract: false, final false
inline void ProcessMeshEntry(::UnityEngine::UIElements::UIR::Entry*  entry, ::UnityEngine::UIElements::TextureId  textureId) ;

/// @brief Method ProcessNextAlloc, addr 0x6b84414, size 0x14c, virtual false, abstract: false, final false
inline void ProcessNextAlloc() ;

/// @brief Method ProcessRange, addr 0x6b82e64, size 0x994, virtual false, abstract: false, final false
inline void ProcessRange(int32_t  first, int32_t  last) ;

/// @brief Method ProcessTail, addr 0x6b837f8, size 0x11c, virtual false, abstract: false, final false
inline void ProcessTail() ;

/// @brief Method UpdateOrAllocate, addr 0x6b846e4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b849d0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_firstHeadCommand, addr 0x6b82a0c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstHeadCommand() ;

/// @brief Method get_firstTailCommand, addr 0x6b82a2c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_firstTailCommand() ;

/// @brief Method get_lastHeadCommand, addr 0x6b82a1c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChainCommand* get_lastHeadCommand() ;

/// @brief Method get_lastTailCommand, addr 0x6b82a3c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_firstHeadCommand, addr 0x6b82a14, size 0x8, virtual false, abstract: false, final false
inline void set_firstHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_firstTailCommand, addr 0x6b82a34, size 0x8, virtual false, abstract: false, final false
inline void set_firstTailCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_lastHeadCommand, addr 0x6b82a24, size 0x8, virtual false, abstract: false, final false
inline void set_lastHeadCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  value) ;

/// @brief Method set_lastTailCommand, addr 0x6b82a44, size 0x8, virtual false, abstract: false, final false
