...
template <typename T> inline void UnityEngine::UIElements::UIR::BasicNode_1<T>::AppendTo(ByRef<::UnityEngine::UIElements::UIR::BasicNode_1<T>*> first) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::BasicNode_1<T>*>::get(), "AppendTo", std::vector<Il2CppClass*>{},
                                  ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::UnityEngine::UIElements::UIR::BasicNode_1<T>*>>::get() })));
...
template <typename T> inline ::UnityEngine::UIElements::UIR::BasicNode_1<T>* UnityEngine::UIElements::UIR::BasicNode_1<T>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::UIElements::UIR::BasicNode_1<T>*>());
}
