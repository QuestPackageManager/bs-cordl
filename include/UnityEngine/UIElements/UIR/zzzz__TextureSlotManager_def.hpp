...
public:
  ...
  /// @brief Method Bind, addr 0x6b9ac30, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOldestSlot, addr 0x6b9ab64, size 0xcc, virtual false, abstract: false, final false
  inline int32_t FindOldestSlot();

  /// @brief Method IndexOf, addr 0x6b9aa10, size 0xec, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::TextureId id);

  /// @brief Method MarkUsed, addr 0x6b9aafc, size 0x58, virtual false, abstract: false, final false
  inline void MarkUsed(int32_t slotIndex);

  static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor();

  /// @brief Method Reset, addr 0x6b9a748, size 0x128, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetGpuData, addr 0x6b9a870, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method StartNewBatch, addr 0x6b9a9a0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b9a5c8, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FreeSlots, addr 0x6b9ab54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FreeSlots, addr 0x6b9ab5c, size 0x8, virtual false, abstract: false, final false
