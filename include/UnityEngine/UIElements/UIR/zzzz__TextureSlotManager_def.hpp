...
/// @brief Method Bind, addr 0x6b289e8, size 0x28c, virtual false, abstract: false, final false
inline void Bind(::UnityEngine::UIElements::TextureId  id, float_t  sdfScale, float_t  sharpness, int32_t  slot, ::UnityEngine::MaterialPropertyBlock*  mat, ::UnityEngine::UIElements::UIR::CommandList*  commandList) ;

/// @brief Method FindOldestSlot, addr 0x6b2891c, size 0xcc, virtual false, abstract: false, final false
inline int32_t FindOldestSlot() ;

/// @brief Method IndexOf, addr 0x6b287c8, size 0xec, virtual false, abstract: false, final false
inline int32_t IndexOf(::UnityEngine::UIElements::TextureId  id) ;

/// @brief Method MarkUsed, addr 0x6b288b4, size 0x58, virtual false, abstract: false, final false
inline void MarkUsed(int32_t  slotIndex) ;

static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor() ;

/// @brief Method Reset, addr 0x6b28500, size 0x128, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetGpuData, addr 0x6b28628, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method StartNewBatch, addr 0x6b28758, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b28380, size 0x180, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FreeSlots, addr 0x6b2890c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_FreeSlots, addr 0x6b28914, size 0x8, virtual false, abstract: false, final false
