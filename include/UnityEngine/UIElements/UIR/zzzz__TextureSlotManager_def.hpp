...
public:
  ...
  /// @brief Method Bind, addr 0x6cf0660, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindOldestSlot, addr 0x6cf0594, size 0xcc, virtual false, abstract: false, final false
  inline int32_t FindOldestSlot();

  /// @brief Method IndexOf, addr 0x6cf0440, size 0xec, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::TextureId id);

  /// @brief Method MarkUsed, addr 0x6cf052c, size 0x58, virtual false, abstract: false, final false
  inline void MarkUsed(int32_t slotIndex);

  static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor();

  /// @brief Method Reset, addr 0x6cf0178, size 0x128, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetGpuData, addr 0x6cf02a0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method StartNewBatch, addr 0x6cf03d0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cefff8, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FreeSlots, addr 0x6cf0584, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_FreeSlots, addr 0x6cf058c, size 0x8, virtual false, abstract: false, final false
