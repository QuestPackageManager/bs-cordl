...
public:
  ...
  /// @brief Method DrawVisualElementBackground, addr 0x6b7da38, size 0x11ec, virtual true, abstract: false, final false
  inline void DrawVisualElementBackground(Il2CppObject* mgc);

  /// @brief Method DrawVisualElementBorder, addr 0x6b7ec24, size 0x990, virtual true, abstract: false, final false
  inline void DrawVisualElementBorder(Il2CppObject* mgc);

  /// @brief Method DrawVisualElementStencilMask, addr 0x6b7f5b4, size 0xa0, virtual true, abstract: false, final false
  inline void DrawVisualElementStencilMask(Il2CppObject* mgc);

  /// @brief Method GenerateStencilClipEntryForRoundedRectBackground, addr 0x6b7f654, size 0x728, virtual false, abstract: false, final false
  ...
  /// @brief Method RequiresStencilMask, addr 0x6b7d9ac, size 0x8c, virtual true, abstract: false, final false
  inline bool RequiresStencilMask(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method ScheduleMeshGenerationJobs, addr 0x6b7fd7c, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b7d9a4, size 0x8, virtual false, abstract: false, final false
