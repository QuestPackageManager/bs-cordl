...
public:
  ...
  static __declspec(property(get = getStaticF_k_GenerateClosingCommandsMarker, put = setStaticF_k_GenerateClosingCommandsMarker)) ::Unity::Profiling::ProfilerMarker k_GenerateClosingCommandsMarker;

  /// @brief Field k_GenerateEntries, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_k_GenerateEntries, put = setStaticF_k_GenerateEntries)) ::Unity::Profiling::ProfilerMarker k_GenerateEntries;
  ...
  static __declspec(property(get = getStaticF_k_UpdateOpacityIdMarker, put = setStaticF_k_UpdateOpacityIdMarker)) ::Unity::Profiling::ProfilerMarker k_UpdateOpacityIdMarker;
  ...
  /// @brief Method ClosePaintElement, addr 0x4957be0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeTransformMatrix, addr 0x495567c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBlitShader, addr 0x49579c0, size 0x220, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> CreateBlitShader(float_t colorConversion);

  /// @brief Method DoUpdateOpacityId, addr 0x4957ecc, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method FindClosingCommandInsertionPoint, addr 0x49573dc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method FindCommandInsertionPoint, addr 0x49570bc, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBlitMaterial, addr 0x4957628, size 0x2b8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBlitMaterial(::UnityEngine::UIElements::__VisualElement__RenderTargetMode mode);

  /// @brief Method GetVerticesTransformInfo, addr 0x4955504, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method InjectClosingCommandInBetween, addr 0x4957540, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method InjectClosingMeshDrawCommand, addr 0x49578e0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method InjectCommandInBetween, addr 0x4957344, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method InjectMeshDrawCommand, addr 0x495726c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeGenerateVisualContent, addr 0x4956ee8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsParentOrAncestorOf, addr 0x49557a0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method NudgeVerticesToNewSpace, addr 0x4957fe0, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method PaintElement, addr 0x495582c, size 0x142c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNudgeVertices, addr 0x4958364, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetCommands, addr 0x4956c58, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateOpacityId, addr 0x4957e1c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateOrAllocate, addr 0x4956fd4, size 0xe8, virtual false, abstract: false, final false
