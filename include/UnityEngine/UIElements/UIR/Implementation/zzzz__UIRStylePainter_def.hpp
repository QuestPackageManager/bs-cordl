...
public:
  ...
  /// @brief Method AddGradientsEntry, addr 0x352e6ac, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method AdjustSpriteWinding, addr 0x353373c, size 0x320, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocRawVertsIndices, addr 0x352e0fc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocThroughDrawGradients, addr 0x352e69c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method AllocThroughDrawMesh, addr 0x352e1b8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyVisualElementClipping, addr 0x3532760, size 0x24c, virtual false, abstract: false, final false
  inline void ApplyVisualElementClipping();

  /// @brief Method Begin, addr 0x352ee70, size 0x510, virtual false, abstract: false, final false
  inline void Begin(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Dispose, addr 0x352ed88, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x352edec, size 0x84, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawBorder, addr 0x3530d80, size 0xe0, virtual true, abstract: false, final true
  inline void DrawBorder(::UnityEngine::UIElements::__MeshGenerationContextUtils__BorderParams borderParams);

  /// @brief Method DrawImmediate, addr 0x3530e60, size 0x17c, virtual true, abstract: false, final true
  inline void DrawImmediate(::System::Action* callback, bool cullingEnabled);

  /// @brief Method DrawMesh, addr 0x352e1cc, size 0x4d0, virtual true, abstract: false, final true
  ...
  /// @brief Method DrawRectangle, addr 0x3530028, size 0x29c, virtual true, abstract: false, final true
  inline void DrawRectangle(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams rectParams);

  /// @brief Method DrawSprite, addr 0x3530728, size 0x658, virtual false, abstract: false, final false
  inline void DrawSprite(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams rectParams);

  /// @brief Method DrawText, addr 0x352f490, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method DrawTextCore, addr 0x352fa00, size 0x628, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawTextNative, addr 0x352f5c8, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawVectorImage, addr 0x35302c4, size 0x464, virtual false, abstract: false, final false
  inline void DrawVectorImage(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams rectParams);

  /// @brief Method DrawVisualElementBackground, addr 0x3530fe4, size 0xe08, virtual false, abstract: false, final false
  inline void DrawVisualElementBackground();

  /// @brief Method DrawVisualElementBorder, addr 0x3531dec, size 0x974, virtual false, abstract: false, final false
  inline void DrawVisualElementBorder();

  /// @brief Method GenerateStencilClipEntryForRoundedRectBackground, addr 0x3532d20, size 0xa1c, virtual false, abstract: false, final false
  inline void GenerateStencilClipEntryForRoundedRectBackground();

  /// @brief Method GenerateStencilClipEntryForSVGBackground, addr 0x35329ac, size 0x374, virtual false, abstract: false, final false
  inline void GenerateStencilClipEntryForSVGBackground();

  /// @brief Method GetPooledMeshWriteData, addr 0x352dfdc, size 0x120, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MeshWriteData* GetPooledMeshWriteData();

  /// @brief Method LandClipRegisterMesh, addr 0x352f3f4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method LandClipUnregisterMeshDrawCommand, addr 0x352f380, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x3533a5c, size 0xe4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ValidateMeshWriteData, addr 0x3533b40, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x352e9b0, size 0x368, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::UIR::RenderChain* renderChain);

  /// @brief Method get_closingInfo, addr 0x352ed38, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__ClosingInfo get_closingInfo();

  /// @brief Method get_currentElement, addr 0x352ed20, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_currentElement();

  /// @brief Method get_disposed, addr 0x352ed74, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_entries, addr 0x352ed30, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__Entry>* get_entries();

  /// @brief Method get_meshGenerationContext, addr 0x352ed18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MeshGenerationContext* get_meshGenerationContext();

  /// @brief Method get_totalIndices, addr 0x352ed64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalIndices();

  /// @brief Method get_totalVertices, addr 0x352ed54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_totalVertices();

  /// @brief Method get_visualElement, addr 0x3530fdc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_currentElement, addr 0x352ed28, size 0x8, virtual false, abstract: false, final false
  inline void set_currentElement(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_disposed, addr 0x352ed7c, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_totalIndices, addr 0x352ed6c, size 0x8, virtual false, abstract: false, final false
  inline void set_totalIndices(int32_t value);

  /// @brief Method set_totalVertices, addr 0x352ed5c, size 0x8, virtual false, abstract: false, final false
