...
// "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "xformClipPages", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "ids", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "addFlags", ty: "::UnityEngine::Color32", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "opacityPage", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "textCoreSettingsPage",
// ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "usesTextCoreSettings", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "textureId", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "gradientSettingsIndexOffset", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "indexSrc", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "indexDst", ty: "::System::IntPtr",
