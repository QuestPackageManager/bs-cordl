...
public:
  ...
  /// @brief Method Dispose, addr 0x49a5b34, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x49a5b98, size 0x90, virtual false, abstract: false, final false
