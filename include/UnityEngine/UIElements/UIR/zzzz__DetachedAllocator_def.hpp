...
public:
  ...
  /// @brief Method Dispose, addr 0x6b7cce4, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b7cd4c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b7cbc0, size 0x124, virtual false, abstract: false, final false
  inline void _ctor();
