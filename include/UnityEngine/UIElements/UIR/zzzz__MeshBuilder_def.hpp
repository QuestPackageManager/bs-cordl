...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x49adabc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49ada30, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Allocate, addr 0x49ad8d4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ConvertTextVertexToUIRVertex, addr 0x49ad1d4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method LimitTextVertices, addr 0x49ad2d4, size 0x130, virtual false, abstract: false, final false
  static inline int32_t LimitTextVertices(int32_t vertexCount, bool logTruncation);

  /// @brief Method MakeText, addr 0x49ad404, size 0x4d0, virtual false, abstract: false, final false
