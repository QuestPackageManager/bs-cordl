...
constexpr NudgeJobData(::System::IntPtr  headSrc, ::System::IntPtr  headDst, int32_t  headCount, ::System::IntPtr  tailSrc, ::System::IntPtr  tailDst, int32_t  tailCount, ::UnityEngine::Matrix4x4  transform) noexcept;
