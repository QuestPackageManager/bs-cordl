...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::MeshWriteDataPool*);
...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x6ce2c20, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MeshWriteData* __cctor_b__2_0();

  /// @brief Method .ctor, addr 0x6ce2c1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::MeshWriteDataPool___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce2a70, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UIR::MeshWriteDataPool) == 0x38, "Size mismatch!");
