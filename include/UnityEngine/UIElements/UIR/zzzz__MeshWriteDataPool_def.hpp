...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x6b8d1f0, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::MeshWriteData* __cctor_b__2_0();

  /// @brief Method .ctor, addr 0x6b8d1ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b8d040, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
