...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x6cede70, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color __cctor_b__2_0(::UnityEngine::Color c);

  /// @brief Method .ctor, addr 0x6cede6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6cedcb0, size 0x9c, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::UIR::ShaderInfoStorageRGBAFloat) == 0x48, "Size mismatch!");
