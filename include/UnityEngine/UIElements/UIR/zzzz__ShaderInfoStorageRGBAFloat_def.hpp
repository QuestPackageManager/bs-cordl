...
public:
  ...
  /// @brief Method <.cctor>b__2_0, addr 0x49acb14, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Color __cctor_b__2_0(::UnityEngine::Color c);

  /// @brief Method .ctor, addr 0x49acb0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x49ac958, size 0x94, virtual false, abstract: false, final false
