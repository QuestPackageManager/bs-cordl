...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::JobManager*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::JobManager*, "UnityEngine.UIElements.UIR", "JobManager");
...
public:
  ...
  /// @brief Method Add, addr 0x6cd8418, size 0x64, virtual false, abstract: false, final false
  inline void Add(::by_ref<::UnityEngine::UIElements::UIR::ConvertMeshJobData> job);

  /// @brief Method Add, addr 0x6cd84f8, size 0x64, virtual false, abstract: false, final false
  inline void Add(::by_ref<::UnityEngine::UIElements::UIR::CopyMeshJobData> job);

  /// @brief Method Add, addr 0x6cda47c, size 0x64, virtual false, abstract: false, final false
  inline void Add(::by_ref<::UnityEngine::UIElements::UIR::NudgeJobData> job);

  /// @brief Method CompleteConvertMeshJobs, addr 0x6cda6c0, size 0x1e0, virtual false, abstract: false, final false
  inline void CompleteConvertMeshJobs();

  /// @brief Method CompleteCopyMeshJobs, addr 0x6cda8a0, size 0x1e0, virtual false, abstract: false, final false
  inline void CompleteCopyMeshJobs();

  /// @brief Method CompleteNudgeJobs, addr 0x6cda4e0, size 0x1e0, virtual false, abstract: false, final false
  inline void CompleteNudgeJobs();

  /// @brief Method Dispose, addr 0x6cdaa90, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6cdaaf8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cdabd0, size 0x23c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disposed, addr 0x6cdaa80, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6cdaa88, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::JobManager) == 0x38, "Size mismatch!");
