...
public:
  // Declarations
  /// @brief Method ClearDirty, addr 0x49af41c, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method EnsureFits, addr 0x49b1184, size 0x114, virtual false, abstract: false, final false
  inline void EnsureFits(int32_t maxDepth);

  /// @brief Method RegisterDirty, addr 0x49b0b34, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x49ae8f0, size 0x78, virtual false, abstract: false, final false
  inline void Reset();
...
public:
  ...
  /// @brief Method AccessIndex, addr 0x49b219c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::UIR::RenderChain* AccessIndex(int32_t index);

  /// @brief Method AllocateIndex, addr 0x49b1fcc, size 0x14c, virtual false, abstract: false, final false
  static inline int32_t AllocateIndex(::UnityEngine::UIElements::UIR::RenderChain* renderChain);

  /// @brief Method FreeIndex, addr 0x49b2118, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__34_0, addr 0x49b2310, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChainCommand* __ctor_b__34_0();

  /// @brief Method <.ctor>b__34_1, addr 0x49b23a8, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__34_1(::UnityEngine::UIElements::UIR::RenderChainCommand* cmd);

  /// @brief Method .ctor, addr 0x49b2308, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AccessRenderNodeData, addr 0x49b1518, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::UIR::RenderChain_RenderNodeData AccessRenderNodeData(::System::IntPtr obj);

  /// @brief Method AllocCommand, addr 0x49b134c, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::RenderChainCommand* AllocCommand();

  /// @brief Method AppendTexture, addr 0x49b1f24, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ChildWillBeRemoved, addr 0x49b1298, size 0xb4, virtual false, abstract: false, final false
  inline void ChildWillBeRemoved(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method Constructor, addr 0x49ae4ec, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method Destructor, addr 0x49ae968, size 0x28c, virtual false, abstract: false, final false
  inline void Destructor();

  /// @brief Method Dispose, addr 0x49aed5c, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x49aedcc, size 0x2c, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawStats, addr 0x49af9c8, size 0xa84, virtual false, abstract: false, final false
  inline void DrawStats();

  /// @brief Method EnsureFitsDepth, addr 0x49b117c, size 0x8, virtual false, abstract: false, final false
  inline void EnsureFitsDepth(int32_t depth);

  /// @brief Method FreeCommand, addr 0x49b13b4, size 0xb0, virtual false, abstract: false, final false
  inline void FreeCommand(::UnityEngine::UIElements::UIR::RenderChainCommand* cmd);

  /// @brief Method GetFirstElementInPanel, addr 0x49aebf4, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetFirstElementInPanel(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetStandardMaterial, addr 0x49af8dc, size 0xec, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetStandardMaterial();

  /// @brief Method GetStandardWorldSpaceMaterial, addr 0x49b1090, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method OnRegisterIntermediateRendererMat, addr 0x49b1b10, size 0x334, virtual false, abstract: false, final false
  ...
  /// @brief Method OnRegisterIntermediateRenderers, addr 0x49b1698, size 0x478, virtual false, abstract: false, final false
  static inline void OnRegisterIntermediateRenderers(::UnityEngine::Camera* camera);

  /// @brief Method OnRenderCommandAdded, addr 0x49b1464, size 0x8c, virtual false, abstract: false, final false
  inline void OnRenderCommandAdded(::UnityEngine::UIElements::UIR::RenderChainCommand* command);

  /// @brief Method OnRenderCommandsRemoved, addr 0x49b14f0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method OnRenderNodeExecute, addr 0x49b15f0, size 0xa8, virtual false, abstract: false, final false
  static inline void OnRenderNodeExecute(::System::IntPtr obj);

  /// @brief Method ProcessChanges, addr 0x49aedf8, size 0x624, virtual false, abstract: false, final false
  inline void ProcessChanges();

  /// @brief Method Render, addr 0x49af5b4, size 0x328, virtual false, abstract: false, final false
  inline void Render();

  /// @brief Method RepaintTexturedElements, addr 0x49b1e44, size 0xe0, virtual false, abstract: false, final false
  inline void RepaintTexturedElements();

  /// @brief Method ResetTextures, addr 0x49aec3c, size 0x10c, virtual false, abstract: false, final false
  inline void ResetTextures(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnChildAdded, addr 0x49b044c, size 0x1c4, virtual false, abstract: false, final false
  inline void UIEOnChildAdded(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnChildRemoving, addr 0x49b0964, size 0xfc, virtual false, abstract: false, final false
  inline void UIEOnChildRemoving(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnChildrenReordered, addr 0x49b07b4, size 0x1b0, virtual false, abstract: false, final false
  inline void UIEOnChildrenReordered(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnClippingChanged, addr 0x49b0610, size 0x8c, virtual false, abstract: false, final false
  inline void UIEOnClippingChanged(::UnityEngine::UIElements::VisualElement* ve, bool hierarchical);

  /// @brief Method UIEOnColorChanged, addr 0x49b0cf8, size 0x80, virtual false, abstract: false, final false
  inline void UIEOnColorChanged(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnOpacityChanged, addr 0x49b069c, size 0x8c, virtual false, abstract: false, final false
  inline void UIEOnOpacityChanged(::UnityEngine::UIElements::VisualElement* ve, bool hierarchical);

  /// @brief Method UIEOnOpacityIdChanged, addr 0x49b0e08, size 0x80, virtual false, abstract: false, final false
  inline void UIEOnOpacityIdChanged(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnRenderHintsChanged, addr 0x49b0a60, size 0xd4, virtual false, abstract: false, final false
  inline void UIEOnRenderHintsChanged(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UIEOnTransformOrSizeChanged, addr 0x49b0d78, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method UIEOnVisualsChanged, addr 0x49b0728, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49ae18c, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x49b0ea8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::AtlasBase* get_atlas();

  /// @brief Method get_device, addr 0x49b0e98, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::UIRenderDevice* get_device();

  /// @brief Method get_disposed, addr 0x49aed48, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_drawInCameras, addr 0x49b0f1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawInCameras();

  /// @brief Method get_drawStats, addr 0x49b0f08, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawStats();

  /// @brief Method get_indicesPool, addr 0x49b0ed8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::TempAllocator_1<uint16_t>* get_indicesPool();

  /// @brief Method get_jobManager, addr 0x49b0ee8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::JobManager* get_jobManager();

  /// @brief Method get_opacityIdAccelerator, addr 0x49adee0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::OpacityIdAccelerator* get_opacityIdAccelerator();

  /// @brief Method get_painter, addr 0x49b0ef8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter* get_painter();

  /// @brief Method get_panel, addr 0x49b0e88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_panel();

  /// @brief Method get_vectorImageManager, addr 0x49b0eb8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::VectorImageManager* get_vectorImageManager();

  /// @brief Method get_vertsPool, addr 0x49b0ec8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_atlas, addr 0x49b0eb0, size 0x8, virtual false, abstract: false, final false
  inline void set_atlas(::UnityEngine::UIElements::AtlasBase* value);

  /// @brief Method set_defaultShader, addr 0x49b0f30, size 0xb0, virtual false, abstract: false, final false
  inline void set_defaultShader(::UnityEngine::Shader* value);

  /// @brief Method set_defaultWorldSpaceShader, addr 0x49b0fe0, size 0xb0, virtual false, abstract: false, final false
  inline void set_defaultWorldSpaceShader(::UnityEngine::Shader* value);

  /// @brief Method set_device, addr 0x49b0ea0, size 0x8, virtual false, abstract: false, final false
  inline void set_device(::UnityEngine::UIElements::UIR::UIRenderDevice* value);

  /// @brief Method set_disposed, addr 0x49aed50, size 0xc, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_drawInCameras, addr 0x49b0f24, size 0xc, virtual false, abstract: false, final false
  inline void set_drawInCameras(bool value);

  /// @brief Method set_drawStats, addr 0x49b0f10, size 0xc, virtual false, abstract: false, final false
  inline void set_drawStats(bool value);

  /// @brief Method set_indicesPool, addr 0x49b0ee0, size 0x8, virtual false, abstract: false, final false
  inline void set_indicesPool(::UnityEngine::UIElements::UIR::TempAllocator_1<uint16_t>* value);

  /// @brief Method set_jobManager, addr 0x49b0ef0, size 0x8, virtual false, abstract: false, final false
  inline void set_jobManager(::UnityEngine::UIElements::UIR::JobManager* value);

  /// @brief Method set_opacityIdAccelerator, addr 0x49adee8, size 0x8, virtual false, abstract: false, final false
  inline void set_opacityIdAccelerator(::UnityEngine::UIElements::UIR::OpacityIdAccelerator* value);

  /// @brief Method set_painter, addr 0x49b0f00, size 0x8, virtual false, abstract: false, final false
  inline void set_painter(::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter* value);

  /// @brief Method set_panel, addr 0x49b0e90, size 0x8, virtual false, abstract: false, final false
  inline void set_panel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method set_vectorImageManager, addr 0x49b0ec0, size 0x8, virtual false, abstract: false, final false
  inline void set_vectorImageManager(::UnityEngine::UIElements::UIR::VectorImageManager* value);

  /// @brief Method set_vertsPool, addr 0x49b0ed0, size 0x8, virtual false, abstract: false, final false
