...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Entry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Entry(Entry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Entry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Entry(Entryconst&) = delete;
