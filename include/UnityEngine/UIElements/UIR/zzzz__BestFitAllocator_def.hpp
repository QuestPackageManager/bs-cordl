...
public:
// Declarations
/// @brief Method CreateBlock, addr 0x6b30d14, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ResetBlock, addr 0x6b30dc8, size 0x4, virtual false, abstract: false, final false
static inline void ResetBlock(::UnityEngine::UIElements::UIR::BestFitAllocator_Block*  block) ;

/// @brief Method .ctor, addr 0x6b305e8, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6b30d8c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_size, addr 0x6b308bc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field m_FirstAvailableBlock, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FirstAvailableBlock, put=__cordl_internal_set_m_FirstAvailableBlock)) ::UnityEngine::UIElements::UIR::BestFitAllocator_Block*  m_FirstAvailableBlock;
...
/// @brief Method Allocate, addr 0x6b306e8, size 0x190, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size) ;

/// @brief Method BestFitFindAvailableBlock, addr 0x6b30878, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BestFitAllocator_Block* BestFitFindAvailableBlock(uint32_t  size) ;

/// @brief Method CoalesceBlockWithPrevious, addr 0x6b30bfc, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x6b309b8, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method SplitBlock, addr 0x6b308c8, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b30548, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(uint32_t  size) ;

/// @brief Method get_highWatermark, addr 0x6b306e0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_highWatermark() ;

/// @brief Method get_totalSize, addr 0x6b306d8, size 0x8, virtual false, abstract: false, final false
