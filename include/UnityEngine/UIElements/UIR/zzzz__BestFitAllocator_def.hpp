...
public:
  // Declarations
  /// @brief Method CreateBlock, addr 0x6ba2f5c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetBlock, addr 0x6ba3010, size 0x4, virtual false, abstract: false, final false
  static inline void ResetBlock(::UnityEngine::UIElements::UIR::BestFitAllocator_Block* block);

  /// @brief Method .ctor, addr 0x6ba2830, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6ba2fd4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_size, addr 0x6ba2b04, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Allocate, addr 0x6ba2930, size 0x190, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size);

  /// @brief Method BestFitFindAvailableBlock, addr 0x6ba2ac0, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::BestFitAllocator_Block* BestFitFindAvailableBlock(uint32_t size);

  /// @brief Method CoalesceBlockWithPrevious, addr 0x6ba2e44, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Free, addr 0x6ba2c00, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBlock, addr 0x6ba2b10, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba2790, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(uint32_t size);

  /// @brief Method get_highWatermark, addr 0x6ba2928, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_highWatermark();

  /// @brief Method get_totalSize, addr 0x6ba2920, size 0x8, virtual false, abstract: false, final false
