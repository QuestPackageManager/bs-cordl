...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::EntryPool*);
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::EntryPool___c) == 0x10, "Size mismatch!");
...
public:
  ...
  constexpr ::ArrayW<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::UIR::Entry*>*> const& __cordl_internal_get_m_ThreadEntries() const;

  constexpr ::ArrayW<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::UIR::Entry*>*>& __cordl_internal_get_m_ThreadEntries();
...
public:
  ...
  ::ArrayW<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::UIR::Entry*>*> ___m_ThreadEntries;
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::EntryPool) == 0x20, "Size mismatch!");
