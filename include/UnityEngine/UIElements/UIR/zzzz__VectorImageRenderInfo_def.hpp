...
/// @brief Method Reset, addr 0x6b2ac34, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x6b2abdc, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
