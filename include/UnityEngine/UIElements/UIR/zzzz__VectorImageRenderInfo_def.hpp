...
public:
  ...
  /// @brief Method Reset, addr 0x2f351f0, size 0x10, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2f35188, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
