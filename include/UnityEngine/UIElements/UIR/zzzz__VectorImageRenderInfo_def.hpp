...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::VectorImageRenderInfo*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::VectorImageRenderInfo*, "UnityEngine.UIElements.UIR", "VectorImageRenderInfo");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VectorImageRenderInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VectorImageRenderInfo(VectorImageRenderInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VectorImageRenderInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VectorImageRenderInfo(VectorImageRenderInfoconst&) = delete;
