...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7433)), TypeDefinitionIndex(TypeDefinitionIndex(7399)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7399), inst: 413
// })} Self: TypeDefinitionIndex(TypeDefinitionIndex(7419)) CS Name: ::UnityEngine.UIElements.UIR::VectorImageRenderInfo*
