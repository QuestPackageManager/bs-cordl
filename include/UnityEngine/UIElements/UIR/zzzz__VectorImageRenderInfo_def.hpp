...
public:
  ...
  /// @brief Method Reset, addr 0x6ac16f0, size 0x10, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6ac1698, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
