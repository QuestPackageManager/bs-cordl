...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::UIR::ExtraRenderChainVEData*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::ExtraRenderChainVEData*, "UnityEngine.UIElements.UIR", "ExtraRenderChainVEData");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::ExtraRenderChainVEData) == 0x20, "Size mismatch!");
