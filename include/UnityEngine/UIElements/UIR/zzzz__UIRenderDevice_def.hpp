...
public:
  // Declarations
  /// @brief Method Dispose, addr 0x6ba24cc, size 0x180, virtual false, abstract: false, final false
  inline void Dispose();
...
public:
  ...
  /// @brief Method <.ctor>b__58_0, addr 0x6ba2714, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::MeshHandle* __ctor_b__58_0();

  /// @brief Method <.ctor>b__58_1, addr 0x6ba278c, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__58_1(::UnityEngine::UIElements::UIR::MeshHandle* mh);

  /// @brief Method .ctor, addr 0x6ba2710, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ActiveUpdatesForMeshHandle, addr 0x6b9fe58, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method AdvanceFrame, addr 0x6ba008c, size 0x8e0, virtual false, abstract: false, final false
  inline void AdvanceFrame();

  /// @brief Method Allocate, addr 0x6b9edb0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Allocate, addr 0x6b9ee7c, size 0x660, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyBatchState, addr 0x6ba0b1c, size 0x1cc, virtual false, abstract: false, final false
  inline void ApplyBatchState(::ByRef<::UnityEngine::UIElements::UIR::UIRenderDevice_EvaluationState> st);

  /// @brief Method ApplyDrawCommandState, addr 0x6ba096c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CompleteCreation, addr 0x6b9e63c, size 0x260, virtual false, abstract: false, final false
  inline void CompleteCreation();

  /// @brief Method Dispose, addr 0x6b9e8bc, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b9e92c, size 0x184, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawRanges, addr 0x6ba1d58, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method EvaluateChain, addr 0x6ba0ce8, size 0xd44, virtual false, abstract: false, final false
  ...
  /// @brief Method FlushAllPendingDeviceDisposes, addr 0x6ba21bc, size 0x98, virtual false, abstract: false, final false
  static inline void FlushAllPendingDeviceDisposes();

  /// @brief Method Free, addr 0x6b96528, size 0x6f8, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::MeshHandle* mesh);

  /// @brief Method GatherDrawStatistics, addr 0x6ba2254, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::UIRenderDevice_DrawStatistics GatherDrawStatistics();

  /// @brief Method InitVertexDeclaration, addr 0x6b9e4dc, size 0x160, virtual false, abstract: false, final false
  inline void InitVertexDeclaration();

  /// @brief Method KickRanges, addr 0x6ba1a2c, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEngineUpdateGlobal, addr 0x6ba226c, size 0x50, virtual false, abstract: false, final false
  static inline void OnEngineUpdateGlobal();

  /// @brief Method OnFlushPendingResources, addr 0x6ba22bc, size 0x210, virtual false, abstract: false, final false
  static inline void OnFlushPendingResources();

  /// @brief Method OnFrameRenderingBegin, addr 0x6b9ffdc, size 0xb0, virtual false, abstract: false, final false
  inline void OnFrameRenderingBegin();

  /// @brief Method PrepareForGfxDeviceRecreate, addr 0x6ba20f4, size 0x64, virtual false, abstract: false, final false
  static inline void PrepareForGfxDeviceRecreate();

  /// @brief Method ProcessDeviceFreeQueue, addr 0x6b9eab0, size 0x300, virtual false, abstract: false, final false
  static inline void ProcessDeviceFreeQueue();

  /// @brief Method PruneUnusedPages, addr 0x6ba1ffc, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryAllocFromPage, addr 0x6b9fee0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6b9fb98, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x6b97c78, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateAfterGPUUsedData, addr 0x6b9f4dc, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateCopyBackIndices, addr 0x6b9fd50, size 0x108, virtual false, abstract: false, final false
  inline void UpdateCopyBackIndices(::UnityEngine::UIElements::UIR::MeshHandle* mesh, bool copyBackIndices);

  /// @brief Method UpdateFenceValue, addr 0x6ba1c6c, size 0xec, virtual false, abstract: false, final false
  inline void UpdateFenceValue();

  /// @brief Method WaitOnCpuFence, addr 0x6ba1f38, size 0xc4, virtual false, abstract: false, final false
  inline void WaitOnCpuFence(uint32_t fence);

  /// @brief Method WrapUpGfxDeviceRecreate, addr 0x6ba2158, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b9def0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(uint32_t initialVertexCapacity, uint32_t initialIndexCapacity);

  /// @brief Method .ctor, addr 0x6b9def8, size 0x5e4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_breakBatches, addr 0x6b9db80, size 0x8, virtual false, abstract: false, final false
  inline bool get_breakBatches();

  /// @brief Method get_commandLists, addr 0x6b9dbb8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::CommandList*>*,
                  ::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::CommandList*>*>*>
  get_commandLists();

  /// @brief Method get_currentFrameCommandLists, addr 0x6b9dbc0, size 0x40, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::CommandList*>* get_currentFrameCommandLists();

  /// @brief Method get_disposed, addr 0x6b9e8ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Method get_drawsInCameras, addr 0x6b9dba0, size 0x8, virtual false, abstract: false, final false
  inline bool get_drawsInCameras();

  /// @brief Method get_frameIndex, addr 0x6b9dbb0, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_frameIndex();

  /// @brief Method get_fullyCreated, addr 0x6b9e89c, size 0x10, virtual false, abstract: false, final false
  inline bool get_fullyCreated();

  /// @brief Method get_isFlat, addr 0x6b9db90, size 0x8, virtual false, abstract: false, final false
  inline bool get_isFlat();

  /// @brief Method get_maxVerticesPerPage, addr 0x6b98e3c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_breakBatches, addr 0x6b9db88, size 0x8, virtual false, abstract: false, final false
  inline void set_breakBatches(bool value);

  /// @brief Method set_disposed, addr 0x6b9e8b4, size 0x8, virtual false, abstract: false, final false
  inline void set_disposed(bool value);

  /// @brief Method set_drawsInCameras, addr 0x6b9dba8, size 0x8, virtual false, abstract: false, final false
  inline void set_drawsInCameras(bool value);

  /// @brief Method set_isFlat, addr 0x6b9db98, size 0x8, virtual false, abstract: false, final false
