...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::GfxUpdateBufferRange, "UnityEngine.UIElements.UIR", "GfxUpdateBufferRange");
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::GfxUpdateBufferRange) == 0x10, "Size mismatch!");
