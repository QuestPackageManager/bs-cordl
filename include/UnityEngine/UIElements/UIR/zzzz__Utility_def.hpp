...
public:
  ...
  /// @brief Method AllocateBuffer, addr 0x6b7917c, size 0x54, virtual false, abstract: false, final false
  static inline ::System::IntPtr AllocateBuffer(int32_t elementCount, int32_t elementStride, bool vertexBuffer);

  /// @brief Method CPUFencePassed, addr 0x6b79710, size 0x3c, virtual false, abstract: false, final false
  static inline bool CPUFencePassed(uint32_t fence);

  /// @brief Method CreateStencilState, addr 0x6b795b8, size 0x88, virtual false, abstract: false, final false
  static inline ::System::IntPtr CreateStencilState(::UnityEngine::Rendering::StencilState stencilState);

  /// @brief Method CreateStencilState_Injected, addr 0x6b79640, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CreateStencilState_Injected(::ByRef<::UnityEngine::Rendering::StencilState> stencilState);

  /// @brief Method DisableScissor, addr 0x6b79590, size 0x28, virtual false, abstract: false, final false
  static inline void DisableScissor();

  /// @brief Method DrawRanges, addr 0x6b793a0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeBuffer, addr 0x6b791d0, size 0x3c, virtual false, abstract: false, final false
  static inline void FreeBuffer(::System::IntPtr buffer);

  /// @brief Method GetActiveViewport, addr 0x6b797b0, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::RectInt GetActiveViewport();

  /// @brief Method GetActiveViewport_Injected, addr 0x6b79838, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveViewport_Injected(::ByRef<::UnityEngine::RectInt> ret);

  /// @brief Method GetUnityProjectionMatrix, addr 0x6b79900, size 0xa0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix();

  /// @brief Method GetUnityProjectionMatrix_Injected, addr 0x6b799a0, size 0x3c, virtual false, abstract: false, final false
  static inline void GetUnityProjectionMatrix_Injected(::ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method GetVertexDeclaration, addr 0x6b79278, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVertexDeclaration_Injected, addr 0x6b79364, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetVertexDeclaration_Injected(::ByRef<::UnityEngine::Bindings::ManagedSpanWrapper> vertexAttributes);

  /// @brief Method HasMappedBufferRange, addr 0x6b796c0, size 0x28, virtual false, abstract: false, final false
  static inline bool HasMappedBufferRange();

  /// @brief Method InsertCPUFence, addr 0x6b796e8, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t InsertCPUFence();

  /// @brief Method NotifyOfUIREvents, addr 0x6b798c4, size 0x3c, virtual false, abstract: false, final false
  static inline void NotifyOfUIREvents(bool subscribe);

  /// @brief Method ProfileDrawChainBegin, addr 0x6b79874, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainBegin();

  /// @brief Method ProfileDrawChainEnd, addr 0x6b7989c, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainEnd();

  /// @brief Method RaiseEngineUpdate, addr 0x6b7906c, size 0x98, virtual false, abstract: false, final false
  static inline void RaiseEngineUpdate();

  /// @brief Method RaiseFlushPendingResources, addr 0x6b79104, size 0x78, virtual false, abstract: false, final false
  static inline void RaiseFlushPendingResources();

  /// @brief Method RaiseGraphicsResourcesRecreate, addr 0x6b78fec, size 0x80, virtual false, abstract: false, final false
  static inline void RaiseGraphicsResourcesRecreate(bool recreate);

  /// @brief Method SetPropertyBlock, addr 0x6b79414, size 0x80, virtual false, abstract: false, final false
  static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock* props);

  /// @brief Method SetPropertyBlock_Injected, addr 0x6b79494, size 0x3c, virtual false, abstract: false, final false
  static inline void SetPropertyBlock_Injected(::System::IntPtr props);

  /// @brief Method SetScissorRect, addr 0x6b794d0, size 0x84, virtual false, abstract: false, final false
  static inline void SetScissorRect(::UnityEngine::RectInt scissorRect);

  /// @brief Method SetScissorRect_Injected, addr 0x6b79554, size 0x3c, virtual false, abstract: false, final false
  static inline void SetScissorRect_Injected(::ByRef<::UnityEngine::RectInt> scissorRect);

  /// @brief Method SetStencilState, addr 0x6b7967c, size 0x44, virtual false, abstract: false, final false
  static inline void SetStencilState(::System::IntPtr stencilState, int32_t stencilRef);

  /// @brief Method SyncRenderThread, addr 0x6b79788, size 0x28, virtual false, abstract: false, final false
  static inline void SyncRenderThread();

  /// @brief Method UpdateBufferRanges, addr 0x6b7920c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCPUFencePassed, addr 0x6b7974c, size 0x3c, virtual false, abstract: false, final false
  static inline void WaitForCPUFencePassed(uint32_t fence);

  /// @brief Method add_EngineUpdate, addr 0x6b78c2c, size 0xf0, virtual false, abstract: false, final false
  static inline void add_EngineUpdate(::System::Action* value);

  /// @brief Method add_FlushPendingResources, addr 0x6b78e0c, size 0xf0, virtual false, abstract: false, final false
  static inline void add_FlushPendingResources(::System::Action* value);

  /// @brief Method add_GraphicsResourcesRecreate, addr 0x6b78a24, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_EngineUpdate, addr 0x6b78d1c, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_EngineUpdate(::System::Action* value);

  /// @brief Method remove_FlushPendingResources, addr 0x6b78efc, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_FlushPendingResources(::System::Action* value);

  /// @brief Method remove_GraphicsResourcesRecreate, addr 0x6b78b28, size 0x104, virtual false, abstract: false, final false
