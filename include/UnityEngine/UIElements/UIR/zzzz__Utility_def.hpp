...
public:
  ...
  /// @brief Method add_GraphicsResourcesRecreate, addr 0x2ebf69c, size 0xf0, virtual false, abstract: false, final false
  static inline void add_GraphicsResourcesRecreate(::System::Action_1<bool>* value);

  /// @brief Method remove_GraphicsResourcesRecreate, addr 0x2ebf78c, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_GraphicsResourcesRecreate(::System::Action_1<bool>* value);

  /// @brief Method add_EngineUpdate, addr 0x2ebf87c, size 0xdc, virtual false, abstract: false, final false
  static inline void add_EngineUpdate(::System::Action* value);

  /// @brief Method remove_EngineUpdate, addr 0x2ebf958, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_EngineUpdate(::System::Action* value);

  /// @brief Method add_FlushPendingResources, addr 0x2ebfa34, size 0xdc, virtual false, abstract: false, final false
  static inline void add_FlushPendingResources(::System::Action* value);

  /// @brief Method remove_FlushPendingResources, addr 0x2ebfb10, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_FlushPendingResources(::System::Action* value);

  /// @brief Method add_RegisterIntermediateRenderers, addr 0x2ebfbec, size 0xf4, virtual false, abstract: false, final false
  static inline void add_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>* value);

  /// @brief Method remove_RegisterIntermediateRenderers, addr 0x2ebfce0, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>* value);

  /// @brief Method add_RenderNodeExecute, addr 0x2ebfdd4, size 0xf4, virtual false, abstract: false, final false
  static inline void add_RenderNodeExecute(::System::Action_1<void*>* value);

  /// @brief Method remove_RenderNodeExecute, addr 0x2ebfec8, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_RenderNodeExecute(::System::Action_1<void*>* value);

  /// @brief Method RaiseGraphicsResourcesRecreate, addr 0x2ebffbc, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseGraphicsResourcesRecreate(bool recreate);

  /// @brief Method RaiseEngineUpdate, addr 0x2ec0038, size 0x94, virtual false, abstract: false, final false
  static inline void RaiseEngineUpdate();

  /// @brief Method RaiseFlushPendingResources, addr 0x2ec00cc, size 0x74, virtual false, abstract: false, final false
  static inline void RaiseFlushPendingResources();

  /// @brief Method RaiseRegisterIntermediateRenderers, addr 0x2ec0140, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRegisterIntermediateRenderers(::UnityEngine::Camera* camera);

  /// @brief Method RaiseRenderNodeAdd, addr 0x2ec01bc, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeAdd(void* userData);

  /// @brief Method RaiseRenderNodeExecute, addr 0x2ec0238, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeExecute(void* userData);

  /// @brief Method RaiseRenderNodeCleanup, addr 0x2ec02b4, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeCleanup(void* userData);

  /// @brief Method AllocateBuffer, addr 0x2ec0330, size 0x54, virtual false, abstract: false, final false
  static inline void* AllocateBuffer(int32_t elementCount, int32_t elementStride, bool vertexBuffer);

  /// @brief Method FreeBuffer, addr 0x2ec0384, size 0x3c, virtual false, abstract: false, final false
  static inline void FreeBuffer(void* buffer);

  /// @brief Method UpdateBufferRanges, addr 0x2ec03c0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetVectorArray, addr 0x2ec042c, size 0x5c, virtual false, abstract: false, final false
  static inline void SetVectorArray(::UnityEngine::MaterialPropertyBlock* props, int32_t name, void* vector4s, int32_t count);

  /// @brief Method GetVertexDeclaration, addr 0x2ec0488, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterIntermediateRenderer, addr 0x2ec04c4, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method DrawRanges, addr 0x2ec0670, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyBlock, addr 0x2ec06e4, size 0x3c, virtual false, abstract: false, final false
  static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock* props);

  /// @brief Method SetScissorRect, addr 0x2ec0720, size 0x80, virtual false, abstract: false, final false
  static inline void SetScissorRect(::UnityEngine::RectInt scissorRect);

  /// @brief Method DisableScissor, addr 0x2ec07dc, size 0x28, virtual false, abstract: false, final false
  static inline void DisableScissor();

  /// @brief Method CreateStencilState, addr 0x2ec0804, size 0x84, virtual false, abstract: false, final false
  static inline void* CreateStencilState(::UnityEngine::Rendering::StencilState stencilState);

  /// @brief Method SetStencilState, addr 0x2ec08c4, size 0x44, virtual false, abstract: false, final false
  static inline void SetStencilState(void* stencilState, int32_t stencilRef);

  /// @brief Method HasMappedBufferRange, addr 0x2ec0908, size 0x28, virtual false, abstract: false, final false
  static inline bool HasMappedBufferRange();

  /// @brief Method InsertCPUFence, addr 0x2ec0930, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t InsertCPUFence();

  /// @brief Method CPUFencePassed, addr 0x2ec0958, size 0x3c, virtual false, abstract: false, final false
  static inline bool CPUFencePassed(uint32_t fence);

  /// @brief Method WaitForCPUFencePassed, addr 0x2ec0994, size 0x3c, virtual false, abstract: false, final false
  static inline void WaitForCPUFencePassed(uint32_t fence);

  /// @brief Method SyncRenderThread, addr 0x2ec09d0, size 0x28, virtual false, abstract: false, final false
  static inline void SyncRenderThread();

  /// @brief Method GetActiveViewport, addr 0x2ec09f8, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::RectInt GetActiveViewport();

  /// @brief Method ProfileDrawChainBegin, addr 0x2ec0ab8, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainBegin();

  /// @brief Method ProfileDrawChainEnd, addr 0x2ec0ae0, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainEnd();

  /// @brief Method NotifyOfUIREvents, addr 0x2ec0b08, size 0x3c, virtual false, abstract: false, final false
  static inline void NotifyOfUIREvents(bool subscribe);

  /// @brief Method GetUnityProjectionMatrix, addr 0x2ec0b44, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix();

  /// @brief Method RegisterIntermediateRenderer_Injected, addr 0x2ec05b0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScissorRect_Injected, addr 0x2ec07a0, size 0x3c, virtual false, abstract: false, final false
  static inline void SetScissorRect_Injected(ByRef<::UnityEngine::RectInt> scissorRect);

  /// @brief Method CreateStencilState_Injected, addr 0x2ec0888, size 0x3c, virtual false, abstract: false, final false
  static inline void* CreateStencilState_Injected(ByRef<::UnityEngine::Rendering::StencilState> stencilState);

  /// @brief Method GetActiveViewport_Injected, addr 0x2ec0a7c, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveViewport_Injected(ByRef<::UnityEngine::RectInt> ret);

  /// @brief Method GetUnityProjectionMatrix_Injected, addr 0x2ec0be0, size 0x3c, virtual false, abstract: false, final false
