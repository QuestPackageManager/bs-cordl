...
public:
  ...
  static __declspec(property(get = getStaticF_RenderNodeAdd, put = setStaticF_RenderNodeAdd)) ::System::Action_1<::System::IntPtr>* RenderNodeAdd;

  /// @brief Field RenderNodeCleanup, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_RenderNodeCleanup, put = setStaticF_RenderNodeCleanup)) ::System::Action_1<::System::IntPtr>* RenderNodeCleanup;

  /// @brief Field RenderNodeExecute, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_RenderNodeExecute, put = setStaticF_RenderNodeExecute)) ::System::Action_1<::System::IntPtr>* RenderNodeExecute;
  ...
  /// @brief Method AllocateBuffer, addr 0x492afa4, size 0x54, virtual false, abstract: false, final false
  static inline ::System::IntPtr AllocateBuffer(int32_t elementCount, int32_t elementStride, bool vertexBuffer);

  /// @brief Method CPUFencePassed, addr 0x492b5cc, size 0x3c, virtual false, abstract: false, final false
  static inline bool CPUFencePassed(uint32_t fence);

  /// @brief Method CreateStencilState, addr 0x492b478, size 0x84, virtual false, abstract: false, final false
  static inline ::System::IntPtr CreateStencilState(::UnityEngine::Rendering::StencilState stencilState);

  /// @brief Method CreateStencilState_Injected, addr 0x492b4fc, size 0x3c, virtual false, abstract: false, final false
  static inline ::System::IntPtr CreateStencilState_Injected(ByRef<::UnityEngine::Rendering::StencilState> stencilState);

  /// @brief Method DisableScissor, addr 0x492b450, size 0x28, virtual false, abstract: false, final false
  static inline void DisableScissor();

  /// @brief Method DrawRanges, addr 0x492b2e4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method FreeBuffer, addr 0x492aff8, size 0x3c, virtual false, abstract: false, final false
  static inline void FreeBuffer(::System::IntPtr buffer);

  /// @brief Method GetActiveViewport, addr 0x492b66c, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::RectInt GetActiveViewport();

  /// @brief Method GetActiveViewport_Injected, addr 0x492b6f0, size 0x3c, virtual false, abstract: false, final false
  static inline void GetActiveViewport_Injected(ByRef<::UnityEngine::RectInt> ret);

  /// @brief Method GetUnityProjectionMatrix, addr 0x492b7b8, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix();

  /// @brief Method GetUnityProjectionMatrix_Injected, addr 0x492b854, size 0x3c, virtual false, abstract: false, final false
  static inline void GetUnityProjectionMatrix_Injected(ByRef<::UnityEngine::Matrix4x4> ret);

  /// @brief Method GetVertexDeclaration, addr 0x492b0fc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasMappedBufferRange, addr 0x492b57c, size 0x28, virtual false, abstract: false, final false
  static inline bool HasMappedBufferRange();

  /// @brief Method InsertCPUFence, addr 0x492b5a4, size 0x28, virtual false, abstract: false, final false
  static inline uint32_t InsertCPUFence();

  /// @brief Method NotifyOfUIREvents, addr 0x492b77c, size 0x3c, virtual false, abstract: false, final false
  static inline void NotifyOfUIREvents(bool subscribe);

  /// @brief Method ProfileDrawChainBegin, addr 0x492b72c, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainBegin();

  /// @brief Method ProfileDrawChainEnd, addr 0x492b754, size 0x28, virtual false, abstract: false, final false
  static inline void ProfileDrawChainEnd();

  /// @brief Method RaiseEngineUpdate, addr 0x492acac, size 0x94, virtual false, abstract: false, final false
  static inline void RaiseEngineUpdate();

  /// @brief Method RaiseFlushPendingResources, addr 0x492ad40, size 0x74, virtual false, abstract: false, final false
  static inline void RaiseFlushPendingResources();

  /// @brief Method RaiseGraphicsResourcesRecreate, addr 0x492ac30, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseGraphicsResourcesRecreate(bool recreate);

  /// @brief Method RaiseRegisterIntermediateRenderers, addr 0x492adb4, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRegisterIntermediateRenderers(::UnityEngine::Camera* camera);

  /// @brief Method RaiseRenderNodeAdd, addr 0x492ae30, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeAdd(::System::IntPtr userData);

  /// @brief Method RaiseRenderNodeCleanup, addr 0x492af28, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeCleanup(::System::IntPtr userData);

  /// @brief Method RaiseRenderNodeExecute, addr 0x492aeac, size 0x7c, virtual false, abstract: false, final false
  static inline void RaiseRenderNodeExecute(::System::IntPtr userData);

  /// @brief Method RegisterIntermediateRenderer, addr 0x492b138, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterIntermediateRenderer_Injected, addr 0x492b224, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetPropertyBlock, addr 0x492b358, size 0x3c, virtual false, abstract: false, final false
  static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock* props);

  /// @brief Method SetScissorRect, addr 0x492b394, size 0x80, virtual false, abstract: false, final false
  static inline void SetScissorRect(::UnityEngine::RectInt scissorRect);

  /// @brief Method SetScissorRect_Injected, addr 0x492b414, size 0x3c, virtual false, abstract: false, final false
  static inline void SetScissorRect_Injected(ByRef<::UnityEngine::RectInt> scissorRect);

  /// @brief Method SetStencilState, addr 0x492b538, size 0x44, virtual false, abstract: false, final false
  static inline void SetStencilState(::System::IntPtr stencilState, int32_t stencilRef);

  /// @brief Method SetVectorArray, addr 0x492b0a0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncRenderThread, addr 0x492b644, size 0x28, virtual false, abstract: false, final false
  static inline void SyncRenderThread();

  /// @brief Method UpdateBufferRanges, addr 0x492b034, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitForCPUFencePassed, addr 0x492b608, size 0x3c, virtual false, abstract: false, final false
  static inline void WaitForCPUFencePassed(uint32_t fence);

  /// @brief Method add_EngineUpdate, addr 0x492a4f0, size 0xdc, virtual false, abstract: false, final false
  static inline void add_EngineUpdate(::System::Action* value);

  /// @brief Method add_FlushPendingResources, addr 0x492a6a8, size 0xdc, virtual false, abstract: false, final false
  static inline void add_FlushPendingResources(::System::Action* value);

  /// @brief Method add_GraphicsResourcesRecreate, addr 0x492a310, size 0xf0, virtual false, abstract: false, final false
  static inline void add_GraphicsResourcesRecreate(::System::Action_1<bool>* value);

  /// @brief Method add_RegisterIntermediateRenderers, addr 0x492a860, size 0xf4, virtual false, abstract: false, final false
  static inline void add_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>* value);

  /// @brief Method add_RenderNodeExecute, addr 0x492aa48, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_EngineUpdate, addr 0x492a5cc, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_EngineUpdate(::System::Action* value);

  /// @brief Method remove_FlushPendingResources, addr 0x492a784, size 0xdc, virtual false, abstract: false, final false
  static inline void remove_FlushPendingResources(::System::Action* value);

  /// @brief Method remove_GraphicsResourcesRecreate, addr 0x492a400, size 0xf0, virtual false, abstract: false, final false
  static inline void remove_GraphicsResourcesRecreate(::System::Action_1<bool>* value);

  /// @brief Method remove_RegisterIntermediateRenderers, addr 0x492a954, size 0xf4, virtual false, abstract: false, final false
  static inline void remove_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>* value);

  /// @brief Method remove_RenderNodeExecute, addr 0x492ab3c, size 0xf4, virtual false, abstract: false, final false
