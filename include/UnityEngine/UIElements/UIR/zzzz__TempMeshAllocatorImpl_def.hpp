...
public:
  ...
  /// @brief Method AllocateTempMesh, addr 0x6b98ba4, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x6b98e44, size 0x230, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method CreateNativeHandle, addr 0x6b98b98, size 0xc, virtual false, abstract: false, final false
  inline void CreateNativeHandle(::ByRef<::UnityEngine::UIElements::TempMeshAllocator> allocator);

  /// @brief Method Dispose, addr 0x6b99084, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b990ec, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b989ac, size 0x1ec, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disposed, addr 0x6b99074, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6b9907c, size 0x8, virtual false, abstract: false, final false
