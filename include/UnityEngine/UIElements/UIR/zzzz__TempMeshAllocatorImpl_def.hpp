...
/// @brief Field m_ThreadData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ThreadData, put=__cordl_internal_set_m_ThreadData)) ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData,::Array<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>*>  m_ThreadData;
...
/// @brief Method AllocateTempMesh, addr 0x6b2695c, size 0x298, virtual false, abstract: false, final false
inline void AllocateTempMesh(int32_t  vertexCount, int32_t  indexCount, ::ByRef<::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>>  vertices, ::ByRef<::Unity::Collections::NativeSlice_1<uint16_t>>  indices) ;

/// @brief Method Clear, addr 0x6b26bfc, size 0x230, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CreateNativeHandle, addr 0x6b26950, size 0xc, virtual false, abstract: false, final false
inline void CreateNativeHandle(::ByRef<::UnityEngine::UIElements::TempMeshAllocator>  allocator) ;

/// @brief Method Dispose, addr 0x6b26e3c, size 0x68, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x6b26ea4, size 0xb4, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData,::Array<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>*> const& __cordl_internal_get_m_ThreadData() const;
...
constexpr void __cordl_internal_set_m_ThreadData(::ArrayW<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData,::Array<::UnityEngine::UIElements::UIR::TempMeshAllocatorImpl_ThreadData>*>  value) ;
...
/// @brief Method .ctor, addr 0x6b26764, size 0x1ec, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disposed, addr 0x6b26e2c, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x6b26e34, size 0x8, virtual false, abstract: false, final false
