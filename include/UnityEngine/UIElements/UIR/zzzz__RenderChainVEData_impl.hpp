...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::UIR::RenderChainCommand* (::UnityEngine::UIElements::UIR::RenderChainVEData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x49334c8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::UIElements::UIR::BMPAlloc)>(
  ...
  constexpr static std::size_t addrs = 0x49334e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::UnityEngine::UIElements::UIR::BMPAlloc)>(&::UnityEngine::UIElements::UIR::RenderChainVEData::InheritsID)> {
  ...
  constexpr static std::size_t addrs = 0x493355c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::UIR::RenderChainVEData::*)()>(
  ...
  constexpr static std::size_t addrs = 0x49335c4;
...
// def_value: Some("nullptr") }, CppParam { name: "flags", ty: "::UnityEngine::UIElements::UIR::RenderDataFlags", modifiers: "", def_value: Some("{}") }, CppParam { name: "hierarchyDepth", ty:
// "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "dirtiedValues", ty: "::UnityEngine::UIElements::UIR::RenderDataDirtyTypes", modifiers: "", def_value: Some("{}") }, CppParam {
// name: "dirtyID", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "firstCommand", ty: "::UnityEngine::UIElements::UIR::RenderChainCommand*", modifiers: "", def_value:
// Some("nullptr") }, CppParam { name: "lastCommand", ty: "::UnityEngine::UIElements::UIR::RenderChainCommand*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "firstClosingCommand",
// ty: "::UnityEngine::UIElements::UIR::RenderChainCommand*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "lastClosingCommand", ty:
// "::UnityEngine::UIElements::UIR::RenderChainCommand*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "isInChain", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam {
// name: "isHierarchyHidden", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "localFlipsWinding", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "localTransformScaleZero", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "worldFlipsWinding", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "worldTransformScaleZero", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "clipMethod", ty: "::UnityEngine::UIElements::UIR::Implementation::ClipMethod", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "childrenStencilRef", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "childrenMaskDepth", ty: "int32_t", modifiers: "", def_value:
// Some("{}") }, CppParam { name: "disableNudging", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "data", ty: "::UnityEngine::UIElements::UIR::MeshHandle*", modifiers: "",
// def_value: Some("nullptr") }, CppParam { name: "closingData", ty: "::UnityEngine::UIElements::UIR::MeshHandle*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "verticesSpace", ty:
// "::UnityEngine::Matrix4x4", modifiers: "", def_value: Some("{}") }, CppParam { name: "displacementUVStart", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "displacementUVEnd", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "transformID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") },
// CppParam { name: "clipRectID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "opacityID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc",
// modifiers: "", def_value: Some("{}") }, CppParam { name: "textCoreSettingsID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "colorID",
// ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "backgroundColorID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "",
// def_value: Some("{}") }, CppParam { name: "borderLeftColorID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "borderTopColorID", ty:
// "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "borderRightColorID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value:
// Some("{}") }, CppParam { name: "borderBottomColorID", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "tintColorID", ty:
// "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: Some("{}") }, CppParam { name: "compositeOpacity", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "backgroundColor", ty: "::UnityEngine::Color", modifiers: "", def_value: Some("{}") }, CppParam { name: "textures", ty:
// "::UnityEngine::UIElements::UIR::BasicNode_1<::UnityEngine::UIElements::UIR::TextureEntry>*", modifiers: "", def_value: Some("nullptr") }]
