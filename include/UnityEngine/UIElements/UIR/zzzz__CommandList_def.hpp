...
public:
  ...
  /// @brief Method ApplyBatchProps, addr 0x6b7b9fc, size 0xf0, virtual false, abstract: false, final false
  inline void ApplyBatchProps();

  /// @brief Method Dispose, addr 0x6b7bca0, size 0x68, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b7bd08, size 0x90, virtual false, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DrawRanges, addr 0x6b7baec, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x6b7b500, size 0x388, virtual false, abstract: false, final false
  inline void Execute();
  ...
  /// @brief Method Reset, addr 0x6b7b3e0, size 0x120, virtual false, abstract: false, final false
  inline void Reset(::UnityEngine::UIElements::VisualElement* newOwner);

  /// @brief Method SetTexture, addr 0x6b7b888, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b7b204, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* owner, ::System::IntPtr vertexDecl, ::System::IntPtr stencilState);

  /// @brief Method get_disposed, addr 0x6b7bc90, size 0x8, virtual false, abstract: false, final false
  inline bool get_disposed();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposed, addr 0x6b7bc98, size 0x8, virtual false, abstract: false, final false
