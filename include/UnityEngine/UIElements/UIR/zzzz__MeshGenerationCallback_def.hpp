...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6cde770, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cde628, size 0x148, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MeshGenerationCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MeshGenerationCallback(MeshGenerationCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MeshGenerationCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MeshGenerationCallback(MeshGenerationCallbackconst&) = delete;
