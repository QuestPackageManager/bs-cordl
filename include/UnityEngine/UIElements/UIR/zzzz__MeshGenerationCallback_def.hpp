...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b857b8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b85670, size 0x148, virtual false, abstract: false, final false
