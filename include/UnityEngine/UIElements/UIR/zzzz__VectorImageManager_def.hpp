...
public:
  ...
  /// @brief Method AddUser, addr 0x2edc070, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x2edc040, size 0x30, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method Dispose, addr 0x2edbebc, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2edbf28, size 0x118, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::UIR::VectorImageManager* New_ctor(::UnityEngine::UIElements::AtlasBase* atlas);

  /// @brief Method Register, addr 0x2edc174, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2edbcec, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x2edbcd8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlas();

  /// @brief Method get_disposed, addr 0x2edbea8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x2edbeb0, size 0xc, virtual false, abstract: false, final false
