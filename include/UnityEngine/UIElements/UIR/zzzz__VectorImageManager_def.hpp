...
public:
  ...
  /// @brief Method AddUser, addr 0x331b6c4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x331b694, size 0x30, virtual false, abstract: false, final false
  inline void Commit();

  /// @brief Method Dispose, addr 0x331b510, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x331b57c, size 0x118, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  static inline ::UnityEngine::UIElements::UIR::VectorImageManager* New_ctor(::UnityEngine::UIElements::AtlasBase* atlas);

  /// @brief Method Register, addr 0x331b7c8, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331b340, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_atlas, addr 0x331b32c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture2D> get_atlas();

  /// @brief Method get_disposed, addr 0x331b4fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x331b504, size 0xc, virtual false, abstract: false, final false
