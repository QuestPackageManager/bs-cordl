...
// Ctor Parameters [CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "texture", ty:
...
constexpr ::UnityEngine::UIElements::UIR::State::State(::UnityW<::UnityEngine::Material> material, ::UnityEngine::UIElements::TextureId texture, int32_t stencilRef, float_t sdfScale) noexcept {
