...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(CopyMeshJobData)
// Forward declare root types
namespace UnityEngine::UIElements::UIR {
struct CopyMeshJobData;
}
// Write type traits
MARK_VAL_T(::UnityEngine::UIElements::UIR::CopyMeshJobData);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::CopyMeshJobData, "UnityEngine.UIElements.UIR", "CopyMeshJobData");
...
static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, vertDst) == 0x8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, vertCount) == 0x10, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, indexSrc) == 0x18, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, indexDst) == 0x20, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, indexCount) == 0x28, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::UIR::CopyMeshJobData, indexOffset) == 0x2c, "Offset mismatch!");

static_assert(sizeof(::UnityEngine::UIElements::UIR::CopyMeshJobData) == 0x30, "Size mismatch!");
