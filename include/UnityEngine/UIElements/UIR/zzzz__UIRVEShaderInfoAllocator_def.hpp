...
namespace UnityEngine::UIElements::UIR {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9999), inst: 755 }), TypeDefinitionIndex(TypeDefinitionIndex(9999)), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(9999), inst: 751 }), TypeDefinitionIndex(TypeDefinitionIndex(7424)), TypeDefinitionIndex(TypeDefinitionIndex(10246)), TypeDefinitionIndex(TypeDefinitionIndex(10244)),
// TypeDefinitionIndex(TypeDefinitionIndex(7415)), TypeDefinitionIndex(TypeDefinitionIndex(7376)), TypeDefinitionIndex(TypeDefinitionIndex(10245)), TypeDefinitionIndex(TypeDefinitionIndex(7374))}
