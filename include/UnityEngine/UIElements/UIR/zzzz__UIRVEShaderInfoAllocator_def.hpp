...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UIRVEShaderInfoAllocator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UIRVEShaderInfoAllocator(UIRVEShaderInfoAllocator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UIRVEShaderInfoAllocator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UIRVEShaderInfoAllocator(UIRVEShaderInfoAllocatorconst&) = delete;
