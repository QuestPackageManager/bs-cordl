...
public:
  ...
  /// @brief Method Add, addr 0x6b80b48, size 0x168, virtual false, abstract: false, final false
  inline void Add(int32_t vertexCount, int32_t indexCount);

  /// @brief Method ClearReferences, addr 0x6b80ad0, size 0x78, virtual false, abstract: false, final false
  inline void ClearReferences();

  /// @brief Method DoEvaluate, addr 0x6b80718, size 0x3b8, virtual false, abstract: false, final false
  inline void DoEvaluate(::UnityEngine::UIElements::UIR::Entry* entry);

  /// @brief Method Flush, addr 0x6b80cb0, size 0xb0, virtual false, abstract: false, final false
  inline void Flush();

  static inline ::UnityEngine::UIElements::UIR::EntryPreProcessor* New_ctor();

  /// @brief Method PreProcess, addr 0x6b8054c, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b80d60, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_childrenIndex, addr 0x6b8052c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_childrenIndex();

  /// @brief Method get_flattenedEntries, addr 0x6b80544, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Entry*>* get_flattenedEntries();

  /// @brief Method get_headAllocs, addr 0x6b80534, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::EntryPreProcessor_AllocSize>* get_headAllocs();

  /// @brief Method get_tailAllocs, addr 0x6b8053c, size 0x8, virtual false, abstract: false, final false
