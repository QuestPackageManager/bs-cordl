...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::VertexFlags, "UnityEngine.UIElements.UIR", "VertexFlags");
// Dependencies
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::VertexFlags) == 0x4, "Size mismatch!");
