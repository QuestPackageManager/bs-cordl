...
#include "UnityEngine/UIElements/UIR/zzzz__TempAllocator_1_def.hpp"
// Ctor Parameters [CppParam { name: "array", ty: "::Unity::Collections::NativeArray_1<T>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "used", ty: "int32_t", modifiers:
