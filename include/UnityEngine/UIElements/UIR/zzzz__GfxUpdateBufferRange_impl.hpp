...
// Ctor Parameters [CppParam { name: "offsetFromWriteStart", ty: "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "size", ty: "uint32_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "source", ty: "::System::UIntPtr", modifiers: "", def_value: Some("{}"), comment: None }]
