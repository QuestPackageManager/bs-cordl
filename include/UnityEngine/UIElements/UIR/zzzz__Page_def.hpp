...
static inline ::UnityEngine::UIElements::UIR::Page_DataSet_1<T>* New_ctor(::UnityEngine::UIElements::UIR::Utility_GPUBufferType  bufferType, uint32_t  totalCount, uint32_t  maxQueuedFrameCount, uint32_t  updateRangePoolSize, bool  mockBuffer) ;
...
/// @brief Method Dispose, addr 0x6b30404, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x6b311a8, size 0xa0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;
...
/// @brief Method .ctor, addr 0x6b31060, size 0x138, virtual false, abstract: false, final false
inline void _ctor(uint32_t  vertexMaxCount, uint32_t  indexMaxCount, uint32_t  maxQueuedFrameCount, bool  mockPage) ;

/// @brief Method get_disposed, addr 0x6b31198, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_isEmpty, addr 0x6b31248, size 0x48, virtual false, abstract: false, final false
inline bool get_isEmpty() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x6b311a0, size 0x8, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::UIElements::UIR::Page_DataSet_1, "UnityEngine.UIElements.UIR", "Page/DataSet`1");
