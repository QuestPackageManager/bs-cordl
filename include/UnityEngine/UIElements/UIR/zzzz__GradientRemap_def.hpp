...
public:
  ...
  /// @brief Method Reset, addr 0x331b2c4, size 0x68, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x331b268, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
