...
public:
  ...
  /// @brief Method Reset, addr 0x356237c, size 0x68, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3562320, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
