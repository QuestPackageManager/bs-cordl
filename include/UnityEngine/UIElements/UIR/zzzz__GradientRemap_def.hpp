...
public:
  ...
  /// @brief Method Reset, addr 0x6b2a838, size 0x6c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6b2a7e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
