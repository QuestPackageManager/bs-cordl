...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicNode_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicNode_1(BasicNode_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicNode_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicNode_1(BasicNode_1const&) = delete;
