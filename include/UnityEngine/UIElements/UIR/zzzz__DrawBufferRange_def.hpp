...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::UIR::DrawBufferRange, "UnityEngine.UIElements.UIR", "DrawBufferRange");
// Dependencies
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::UIR::DrawBufferRange) == 0x10, "Size mismatch!");
