...
public:
  ...
  /// @brief Method DepthFirstOnChildAdded, addr 0x6ab9354, size 0x528, virtual false, abstract: false, final false
  ...
  /// @brief Method DepthFirstOnChildRemoving, addr 0x6aba5f8, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method DepthFirstOnClippingChanged, addr 0x6ab7ff4, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method DepthFirstOnOpacityChanged, addr 0x6ab85e0, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method DepthFirstOnTransformOrSizeChanged, addr 0x6ab8d04, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method DetermineSelfClipMethod, addr 0x6abb494, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetClipRectIDClipInfo, addr 0x6ab91b8, size 0x19c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetClipRectIDClipInfo(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetLastDeepestChild, addr 0x6ab99a0, size 0x7c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetLastDeepestChild(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method GetTransformIDTransformInfo, addr 0x6ab906c, size 0x14c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 GetTransformIDTransformInfo(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method InitColorIDs, addr 0x6ab9a84, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method NeedsColorID, addr 0x6ab9a6c, size 0x18, virtual false, abstract: false, final false
  static inline bool NeedsColorID(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method NeedsTextCoreSettings, addr 0x6abbf9c, size 0xac, virtual false, abstract: false, final false
  static inline bool NeedsTextCoreSettings(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method NeedsTransformID, addr 0x6ab9a1c, size 0x28, virtual false, abstract: false, final false
  static inline bool NeedsTransformID(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method NudgeVerticesToNewSpace, addr 0x6abbbc0, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnColorChanged, addr 0x6ab8a14, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareNudgeVertices, addr 0x6abc410, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOnClippingChanged, addr 0x6ab7f14, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOnColorChanged, addr 0x6ab8988, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOnOpacityChanged, addr 0x6ab8518, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOnTransformOrSizeChanged, addr 0x6ab8c48, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorValues, addr 0x6ab9fe8, size 0x4a8, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateLocalFlipsWinding, addr 0x6ab987c, size 0x124, virtual false, abstract: false, final false
  static inline bool UpdateLocalFlipsWinding(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method UpdateTextCoreSettings, addr 0x6abb6d4, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateZeroScaling, addr 0x6abba3c, size 0x184, virtual false, abstract: false, final false
