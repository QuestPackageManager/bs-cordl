...
/// @brief Method DepthFirstOnChildAdded, addr 0x6b96658, size 0x528, virtual false, abstract: false, final false
...
/// @brief Method DepthFirstOnChildRemoving, addr 0x6b978fc, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method DepthFirstOnClippingChanged, addr 0x6b952f8, size 0x524, virtual false, abstract: false, final false
...
/// @brief Method DepthFirstOnOpacityChanged, addr 0x6b958e4, size 0x3a8, virtual false, abstract: false, final false
...
/// @brief Method DepthFirstOnTransformOrSizeChanged, addr 0x6b96008, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method DetermineSelfClipMethod, addr 0x6b98798, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GetClipRectIDClipInfo, addr 0x6b964bc, size 0x19c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetClipRectIDClipInfo(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetLastDeepestChild, addr 0x6b96ca4, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::VisualElement* GetLastDeepestChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetTransformIDTransformInfo, addr 0x6b96370, size 0x14c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 GetTransformIDTransformInfo(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method InitColorIDs, addr 0x6b96d88, size 0x564, virtual false, abstract: false, final false
...
/// @brief Method NeedsColorID, addr 0x6b96d70, size 0x18, virtual false, abstract: false, final false
static inline bool NeedsColorID(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method NeedsTextCoreSettings, addr 0x6b992a0, size 0xac, virtual false, abstract: false, final false
static inline bool NeedsTextCoreSettings(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method NeedsTransformID, addr 0x6b96d20, size 0x28, virtual false, abstract: false, final false
static inline bool NeedsTransformID(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method NudgeVerticesToNewSpace, addr 0x6b98ec4, size 0x3dc, virtual false, abstract: false, final false
static inline bool NudgeVerticesToNewSpace(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::UIR::RenderChain*  renderChain, ::UnityEngine::UIElements::UIR::UIRenderDevice*  device) ;

/// @brief Method OnColorChanged, addr 0x6b95d18, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method PrepareNudgeVertices, addr 0x6b99714, size 0xdc, virtual false, abstract: false, final false
static inline void PrepareNudgeVertices(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::UIR::UIRenderDevice*  device, ::UnityEngine::UIElements::UIR::MeshHandle*  mesh, ::ByRef<::System::IntPtr>  src, ::ByRef<::System::IntPtr>  dst, ::ByRef<int32_t>  count) ;

/// @brief Method ProcessOnClippingChanged, addr 0x6b95218, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method ProcessOnColorChanged, addr 0x6b95c8c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method ProcessOnOpacityChanged, addr 0x6b9581c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ProcessOnTransformOrSizeChanged, addr 0x6b95f4c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method SetColorValues, addr 0x6b972ec, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method UpdateLocalFlipsWinding, addr 0x6b96b80, size 0x124, virtual false, abstract: false, final false
static inline bool UpdateLocalFlipsWinding(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method UpdateTextCoreSettings, addr 0x6b989d8, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method UpdateZeroScaling, addr 0x6b98d40, size 0x184, virtual false, abstract: false, final false
