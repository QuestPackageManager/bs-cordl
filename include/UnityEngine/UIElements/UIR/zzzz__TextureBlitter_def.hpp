...
public:
  ...
  /// @brief Method BeginBlit, addr 0x2ff3de4, size 0x1fc, virtual false, abstract: false, final false
  inline void BeginBlit(::UnityEngine::RenderTexture* dst);

  /// @brief Method BlitOneNow, addr 0x2fe63fc, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x2fe61d8, size 0xec, virtual false, abstract: false, final false
  inline void Commit(::UnityEngine::RenderTexture* dst);

  /// @brief Method Dispose, addr 0x2fe578c, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x2ff3c3c, size 0x7c, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DoBlit, addr 0x2ff3fe0, size 0x51c, virtual false, abstract: false, final false
  ...
  /// @brief Method EndBlit, addr 0x2ff44fc, size 0xe0, virtual false, abstract: false, final false
  inline void EndBlit();

  static inline ::UnityEngine::UIElements::UIR::TextureBlitter* New_ctor(int32_t capacity);

  /// @brief Method QueueBlit, addr 0x2fe5b78, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fe5484, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x2ff3c28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x2ff3c30, size 0xc, virtual false, abstract: false, final false
