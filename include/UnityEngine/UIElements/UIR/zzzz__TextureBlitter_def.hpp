...
public:
  ...
  /// @brief Method BeginBlit, addr 0x6b99984, size 0x254, virtual false, abstract: false, final false
  inline void BeginBlit(::UnityEngine::RenderTexture* dst);

  /// @brief Method BlitOneNow, addr 0x6b9990c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Commit, addr 0x6b9a334, size 0x10c, virtual false, abstract: false, final false
  inline void Commit(::UnityEngine::RenderTexture* dst);

  /// @brief Method Dispose, addr 0x6b994cc, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x6b9953c, size 0x88, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method DoBlit, addr 0x6b99bd8, size 0x6dc, virtual false, abstract: false, final false
  ...
  /// @brief Method EndBlit, addr 0x6b9a2b4, size 0x80, virtual false, abstract: false, final false
  inline void EndBlit();

  static inline ::UnityEngine::UIElements::UIR::TextureBlitter* New_ctor(int32_t capacity);

  /// @brief Method QueueBlit, addr 0x6b997b0, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b99700, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_disposed, addr 0x6b994bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_disposed, addr 0x6b994c4, size 0x8, virtual false, abstract: false, final false
