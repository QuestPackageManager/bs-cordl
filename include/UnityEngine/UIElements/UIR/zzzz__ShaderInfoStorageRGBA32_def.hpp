...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7381), inst: 742 }), TypeDefinitionIndex(TypeDefinitionIndex(7381)),
// TypeDefinitionIndex(TypeDefinitionIndex(10250))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7383)) CS Name: ::UnityEngine.UIElements.UIR::ShaderInfoStorageRGBA32*
