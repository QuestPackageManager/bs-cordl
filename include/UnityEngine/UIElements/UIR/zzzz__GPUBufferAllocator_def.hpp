...
public:
  ...
  /// @brief Method Allocate, addr 0x3320e50, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived);

  /// @brief Method Free, addr 0x3320f8c, size 0x84, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::Alloc alloc);

  /// @brief Method HighLowCollide, addr 0x3325494, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3325400, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(uint32_t maxSize);

  /// @brief Method get_isEmpty, addr 0x33254cc, size 0x3c, virtual false, abstract: false, final false
