...
public:
  ...
  /// @brief Method Allocate, addr 0x49bb31c, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived);

  /// @brief Method Free, addr 0x49bb448, size 0x84, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::Alloc alloc);

  /// @brief Method HighLowCollide, addr 0x49bf4ac, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49bf424, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(uint32_t maxSize);

  /// @brief Method get_isEmpty, addr 0x49bf4e4, size 0x3c, virtual false, abstract: false, final false
