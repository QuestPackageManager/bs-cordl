...
public:
  ...
  /// @brief Method Allocate, addr 0x6cf8ac4, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived);

  /// @brief Method Free, addr 0x6cf8c28, size 0x74, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::Alloc alloc);

  /// @brief Method HighLowCollide, addr 0x6cf8bf0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cf8a44, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(uint32_t maxSize);

  /// @brief Method get_isEmpty, addr 0x6cf8c9c, size 0x3c, virtual false, abstract: false, final false
