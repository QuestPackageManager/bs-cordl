...
public:
  ...
  /// @brief Method Allocate, addr 0x6ba3094, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived);

  /// @brief Method Free, addr 0x6ba31f8, size 0x74, virtual false, abstract: false, final false
  inline void Free(::UnityEngine::UIElements::UIR::Alloc alloc);

  /// @brief Method HighLowCollide, addr 0x6ba31c0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ba3014, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(uint32_t maxSize);

  /// @brief Method get_isEmpty, addr 0x6ba326c, size 0x3c, virtual false, abstract: false, final false
