...
/// @brief Method Allocate, addr 0x6b30e4c, size 0x12c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size, bool  shortLived) ;

/// @brief Method Free, addr 0x6b30fb0, size 0x74, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::Alloc  alloc) ;

/// @brief Method HighLowCollide, addr 0x6b30f78, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b30dcc, size 0x80, virtual false, abstract: false, final false
inline void _ctor(uint32_t  maxSize) ;

/// @brief Method get_isEmpty, addr 0x6b31024, size 0x3c, virtual false, abstract: false, final false
