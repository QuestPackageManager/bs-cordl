...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x49df140, size 0x50, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Experimental::PointerOutLinkTagEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x49df138, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPooled, addr 0x49df040, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x49defe0, size 0x54, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x49df034, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::Experimental::PointerOutLinkTagEvent* New_ctor();

  /// @brief Method .ctor, addr 0x49df088, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
