...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6b53fe4, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Experimental::PointerUpLinkTagEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6b53fe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPooled, addr 0x6b53ec8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x6b53e64, size 0x58, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x6b53ebc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b53f34, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_linkID, addr 0x6b53e54, size 0x8, virtual false, abstract: false, final false
  inline void set_linkID(::StringW value);

  /// @brief Method set_linkText, addr 0x6b53e5c, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Experimental::PointerUpLinkTagEvent, 0x108>, "Size mismatch!");
