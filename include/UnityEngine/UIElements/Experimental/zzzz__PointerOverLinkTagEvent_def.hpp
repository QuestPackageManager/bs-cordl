...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent*);
MARK_REF_T(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent___c*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent*, "UnityEngine.UIElements.Experimental", "PointerOverLinkTagEvent");
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent___c*, "UnityEngine.UIElements.Experimental", "PointerOverLinkTagEvent/<>c");
...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6d1b7fc, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6d1b7f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetPooled, addr 0x6d1b6e0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x6d1b67c, size 0x58, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x6d1b6d4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d1b74c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_linkID, addr 0x6d1b66c, size 0x8, virtual false, abstract: false, final false
  inline void set_linkID(::StringW value);

  /// @brief Method set_linkText, addr 0x6d1b674, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Experimental::PointerOverLinkTagEvent) == 0x108, "Size mismatch!");
