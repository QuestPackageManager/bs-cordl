...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Lerp", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Lerp(Lerp&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Lerp", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Lerp(Lerpconst&) = delete;
