...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Experimental::Lerp*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Experimental::Lerp*, "UnityEngine.UIElements.Experimental", "Lerp");
...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x6d1c6e0, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color Interpolate(::UnityEngine::Color start, ::UnityEngine::Color end, float_t ratio);

  /// @brief Method Interpolate, addr 0x6d1c718, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method Interpolate, addr 0x6d1c6d0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Experimental::Lerp) == 0x10, "Size mismatch!");
