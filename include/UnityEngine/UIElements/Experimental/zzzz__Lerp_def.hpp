...
public:
// Declarations
/// @brief Method Interpolate, addr 0x6bc8828, size 0x38, virtual false, abstract: false, final false
static inline ::UnityEngine::Color Interpolate(::UnityEngine::Color  start, ::UnityEngine::Color  end, float_t  ratio) ;

/// @brief Method Interpolate, addr 0x6bc8860, size 0x434, virtual false, abstract: false, final false
...
/// @brief Method Interpolate, addr 0x6bc8818, size 0x10, virtual false, abstract: false, final false
