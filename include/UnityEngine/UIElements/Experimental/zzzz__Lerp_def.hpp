...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x49e2c80, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color Interpolate(::UnityEngine::Color start, ::UnityEngine::Color end, float_t ratio);

  /// @brief Method Interpolate, addr 0x49e2cb8, size 0x3bc, virtual false, abstract: false, final false
  ...
  /// @brief Method Interpolate, addr 0x49e2c70, size 0x10, virtual false, abstract: false, final false
