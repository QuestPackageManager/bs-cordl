...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::VisualElementFocusChangeDirection*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::VisualElementFocusChangeDirection*, "UnityEngine.UIElements", "VisualElementFocusChangeDirection");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VisualElementFocusChangeDirection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VisualElementFocusChangeDirection(VisualElementFocusChangeDirection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VisualElementFocusChangeDirection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VisualElementFocusChangeDirection(VisualElementFocusChangeDirectionconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::VisualElementFocusChangeDirection) == 0x18, "Size mismatch!");
