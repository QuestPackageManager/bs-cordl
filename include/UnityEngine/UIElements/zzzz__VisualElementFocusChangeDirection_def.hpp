...
public:
  ...
  /// @brief Method get_left, addr 0x2dbb1fc, size 0x58, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::FocusChangeDirection* get_left();

  /// @brief Method get_right, addr 0x2dbb254, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2dbb2ac, size 0x68, virtual false, abstract: false, final false
