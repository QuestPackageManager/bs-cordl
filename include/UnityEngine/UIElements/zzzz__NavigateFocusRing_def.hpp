...
public:
  ...
  /// @brief Method .ctor, addr 0x49bd4b8, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetBestOverall, addr 0x49bd12c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Order, addr 0x49bd6b4, size 0xec, virtual false, abstract: false, final false
  inline int32_t Order(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x49bda3c, size 0x84, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x49bd7a0, size 0x1bc, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method TieBreaker, addr 0x49bd95c, size 0xe0, virtual false, abstract: false, final false
  inline int32_t TieBreaker(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method ValidateElement, addr 0x49bd5ec, size 0xc8, virtual false, abstract: false, final false
  inline bool ValidateElement(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method ValidateHierarchyTraversal, addr 0x49bd524, size 0xc8, virtual false, abstract: false, final false
...
public:
  ...
  static __declspec(property(get = getStaticF_Next, put = setStaticF_Next)) ::UnityEngine::UIElements::FocusChangeDirection* Next;

  /// @brief Field Previous, offset 0xffffffff, size 0x8
  static __declspec(property(get = getStaticF_Previous, put = setStaticF_Previous)) ::UnityEngine::UIElements::FocusChangeDirection* Previous;
  ...
  /// @brief Method GetFocusChangeDirection, addr 0x49bc864, size 0x364, virtual true, abstract: false, final true
  ...
  /// @brief Method GetNextFocusable, addr 0x49bcbc8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method GetNextFocusable2D, addr 0x49bcd1c, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method IsActive, addr 0x49bd208, size 0xd8, virtual false, abstract: false, final false
  static inline bool IsActive(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method IsNavigable, addr 0x49bd2e0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49bc7e8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_focusController, addr 0x49bc7c4, size 0x24, virtual false, abstract: false, final false
