...
public:
  ...
  /// @brief Method .ctor, addr 0x2f28150, size 0x68, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetBestOverall, addr 0x2f27b74, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Order, addr 0x2f2832c, size 0xec, virtual false, abstract: false, final false
  inline int32_t Order(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x2f28740, size 0x84, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::UIElements::VisualElement* a, ::UnityEngine::UIElements::VisualElement* b);

  /// @brief Method StrictOrder, addr 0x2f28418, size 0x1f4, virtual false, abstract: false, final false
  inline int32_t StrictOrder(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method TieBreaker, addr 0x2f2860c, size 0x134, virtual false, abstract: false, final false
  inline int32_t TieBreaker(::UnityEngine::Rect ra, ::UnityEngine::Rect rb);

  /// @brief Method ValidateElement, addr 0x2f28268, size 0xc4, virtual false, abstract: false, final false
  inline bool ValidateElement(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method ValidateHierarchyTraversal, addr 0x2f281b8, size 0xb0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetFocusChangeDirection, addr 0x2f26e70, size 0x438, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLeafFocusable, addr 0x2f27cb0, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetLeafFocusable(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method GetLeafFocusableRecursive, addr 0x2f27f18, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetLeafFocusableRecursive(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method GetNextFocusable, addr 0x2f272a8, size 0x2b4, virtual true, abstract: false, final false
  ...
  /// @brief Method GetNextFocusable2D, addr 0x2f2755c, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRootFocusable, addr 0x2f27aec, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::VisualElement* GetRootFocusable(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method IsActive, addr 0x2f27d10, size 0xd8, virtual false, abstract: false, final false
  static inline bool IsActive(::UnityEngine::UIElements::VisualElement* v);

  /// @brief Method IsFocusRoot, addr 0x2f27e68, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsFocusRoot(::UnityEngine::UIElements::VisualElement* focusable);

  /// @brief Method IsFocusable, addr 0x2f27de8, size 0x40, virtual false, abstract: false, final false
  static inline bool IsFocusable(::UnityEngine::UIElements::Focusable* focusable);

  /// @brief Method IsLeaf, addr 0x2f27e28, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f26334, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_focusController, addr 0x2f26e4c, size 0x24, virtual false, abstract: false, final false
