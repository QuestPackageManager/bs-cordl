...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x6af4024, size 0x40, virtual false, abstract: false, final false
inline uint32_t _GetValueFromBag_b__3_0(::StringW  s, uint32_t  i) ;

/// @brief Method .ctor, addr 0x6af4020, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToUInt, addr 0x6af3f90, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t ConvertValueToUInt(::StringW  v, uint32_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x6af3df8, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6af3d58, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
