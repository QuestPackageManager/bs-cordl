...
template <typename TContainer, typename TValue> inline TValue UnityEngine::UIElements::StyleValuePropertyBag_2_ValueProperty<TContainer, TValue>::GetValue(::by_ref<TContainer> container) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass,
...
template <typename TContainer, typename TValue> inline void UnityEngine::UIElements::StyleValuePropertyBag_2_ValueProperty<TContainer, TValue>::SetValue(::by_ref<TContainer> container, TValue value) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass,
