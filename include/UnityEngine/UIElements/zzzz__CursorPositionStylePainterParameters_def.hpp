...
public:
  // Declarations
  /// @brief Method GetDefault, addr 0x3303f44, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextNativeSettings, addr 0x330408c, size 0x50, virtual false, abstract: false, final false
