...
public:
  // Declarations
  /// @brief Method GetDefault, addr 0x2f1e128, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextNativeSettings, addr 0x2f1e270, size 0x50, virtual false, abstract: false, final false
