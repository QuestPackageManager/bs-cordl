...
public:
  ...
  /// @brief Method .ctor, addr 0x6d615e0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d61588, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
