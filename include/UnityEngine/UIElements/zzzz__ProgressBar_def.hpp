...
public:
  ...
  /// @brief Method .ctor, addr 0x4a033e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4a0338c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
