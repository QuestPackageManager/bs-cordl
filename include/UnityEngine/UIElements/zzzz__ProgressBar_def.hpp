...
public:
  ...
  /// @brief Method .ctor, addr 0x338895c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3388908, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
