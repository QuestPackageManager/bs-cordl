...
public:
  ...
  /// @brief Method .ctor, addr 0x358d698, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x358d644, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
