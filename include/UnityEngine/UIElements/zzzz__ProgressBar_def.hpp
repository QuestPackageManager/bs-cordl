...
public:
  ...
  /// @brief Method .ctor, addr 0x2f472b8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2f4730c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
