...
public:
  ...
  /// @brief Method .ctor, addr 0x2e387a8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7119)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5270
// }), TypeDefinitionIndex(TypeDefinitionIndex(7116))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7118)) CS Name: ::ProgressBar::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2e387fc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
