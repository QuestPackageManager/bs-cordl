...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5270 }),
// TypeDefinitionIndex(TypeDefinitionIndex(7116)), TypeDefinitionIndex(TypeDefinitionIndex(7119))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7118)) CS Name: ::ProgressBar::UxmlFactory*
