...
/// @brief Method Equals, addr 0x6ac713c, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6ac70ec, size 0x50, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleBackground  other) ;

/// @brief Method GetHashCode, addr 0x6ac71e4, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x6ac720c, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6ac707c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6ac7014, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Sprite*  v) ;

/// @brief Method .ctor, addr 0x6ac5a54, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Sprite*  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6ac6fe0, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture2D*  v) ;

/// @brief Method .ctor, addr 0x6ac5a14, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture2D*  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6ac708c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Background  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6ac7048, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VectorImage*  v) ;

/// @brief Method .ctor, addr 0x6ac5a94, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VectorImage*  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x6ac6fd0, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x6ac6f90, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x6ac709c, size 0x50, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::StyleBackground  lhs, ::UnityEngine::UIElements::StyleBackground  rhs) ;

/// @brief Method op_Implicit, addr 0x6ac5ad4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_keyword, addr 0x6ac6fd8, size 0x8, virtual true, abstract: false, final true
inline void set_keyword(::UnityEngine::UIElements::StyleKeyword  value) ;

/// @brief Method set_value, addr 0x6ac6fc0, size 0x10, virtual true, abstract: false, final true
