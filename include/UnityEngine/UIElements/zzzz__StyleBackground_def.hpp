...
public:
  ...
  /// @brief Method Equals, addr 0x6b39384, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b39334, size 0x50, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::StyleBackground other);

  /// @brief Method GetHashCode, addr 0x6b3942c, size 0x28, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x6b39454, size 0x84, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b392c4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6b3925c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* v);

  /// @brief Method .ctor, addr 0x6b37c9c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6b39228, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture2D* v);

  /// @brief Method .ctor, addr 0x6b37c5c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Texture2D* v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6b392d4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Background v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor, addr 0x6b39290, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VectorImage* v);

  /// @brief Method .ctor, addr 0x6b37cdc, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VectorImage* v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method get_keyword, addr 0x6b39218, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method get_value, addr 0x6b391d8, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method op_Equality, addr 0x6b392e4, size 0x50, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::StyleBackground lhs, ::UnityEngine::UIElements::StyleBackground rhs);

  /// @brief Method op_Implicit, addr 0x6b37d1c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_keyword, addr 0x6b39220, size 0x8, virtual true, abstract: false, final true
  inline void set_keyword(::UnityEngine::UIElements::StyleKeyword value);

  /// @brief Method set_value, addr 0x6b39208, size 0x10, virtual true, abstract: false, final true
