...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::*)(::UnityEngine::UIElements::VisualElement*, ::UnityEngine::UIElements::VersionChangeType)>(&::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::OnVersionChanged)> {
  constexpr static std::size_t size = 0x138;
  constexpr static std::size_t addrs = 0x6b02f54;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater*>::get(),
                                  15
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::VisualElementFlags (::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::*)(::UnityEngine::UIElements::VisualElement*)>(&::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::GetParentMustDirtyFlags)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x6b0308c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::*)()>(&::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::Update)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6b030c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::*)()>(&::UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x6b030c4;
...
inline void UnityEngine::UIElements::VisualTreeWorldSpaceHierarchyFlagsUpdater::OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType)  {
