...
public:
  ...
  /// @brief Method .ctor, addr 0x6c1b428, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c1b490, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1b630, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.ctor>b__63_0, addr 0x6c1b7d4, size 0x1c, virtual false, abstract: false, final false
  inline void __ctor_b__63_0(::UnityEngine::UIElements::TooltipEvent* evt);

  /// @brief Method .ctor, addr 0x6c1b7d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCloseButton, addr 0x6c1adb0, size 0x20, virtual false, abstract: false, final false
  inline void AddCloseButton();

  /// @brief Method AddDragHandles, addr 0x6c1ad34, size 0x24, virtual false, abstract: false, final false
  inline void AddDragHandles();

  /// @brief Method EnableTabCloseButton, addr 0x6c1a044, size 0xc, virtual false, abstract: false, final false
  inline void EnableTabCloseButton(bool enable);

  /// @brief Method EnableTabDragHandles, addr 0x6c1ada4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCloseButtonClicked, addr 0x6c1aeb4, size 0x74, virtual false, abstract: false, final false
  inline void OnCloseButtonClicked(::UnityEngine::UIElements::PointerDownEvent* evt);

  /// @brief Method OnTabClicked, addr 0x6c1ae94, size 0x20, virtual false, abstract: false, final false
  inline void OnTabClicked(::UnityEngine::UIElements::PointerDownEvent* _);

  /// @brief Method RemoveCloseButton, addr 0x6c1add0, size 0x4c, virtual false, abstract: false, final false
  inline void RemoveCloseButton();

  /// @brief Method RemoveDragHandles, addr 0x6c1ad58, size 0x4c, virtual false, abstract: false, final false
  inline void RemoveDragHandles();

  /// @brief Method SetActive, addr 0x6c1ae1c, size 0x3c, virtual false, abstract: false, final false
  inline void SetActive();

  /// @brief Method SetInactive, addr 0x6c1ae58, size 0x3c, virtual false, abstract: false, final false
  inline void SetInactive();

  /// @brief Method UpdateTooltip, addr 0x6c1ac44, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c1a058, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c1a094, size 0xabc, virtual false, abstract: false, final false
  inline void _ctor(::StringW label, ::UnityEngine::UIElements::Background iconImage);

  /// @brief Method add_closed, addr 0x6c19a00, size 0xc0, virtual false, abstract: false, final false
  inline void add_closed(::System::Action_1<::UnityEngine::UIElements::Tab*>* value);

  /// @brief Method add_selected, addr 0x6c19880, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_closeable, addr 0x6c19f68, size 0x8, virtual false, abstract: false, final false
  inline bool get_closeable();

  /// @brief Method get_contentContainer, addr 0x6c1a050, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_iconImage, addr 0x6c19cc4, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Background get_iconImage();

  /// @brief Method get_label, addr 0x6c19b88, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_label();

  /// @brief Method get_tabHeader, addr 0x6c19b80, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_tabHeader();

  /// @brief Method remove_closed, addr 0x6c19ac0, size 0xc0, virtual false, abstract: false, final false
  inline void remove_closed(::System::Action_1<::UnityEngine::UIElements::Tab*>* value);

  /// @brief Method remove_selected, addr 0x6c19940, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_closeable, addr 0x6c19f70, size 0xd4, virtual false, abstract: false, final false
  inline void set_closeable(bool value);

  /// @brief Method set_iconImage, addr 0x6c19cd4, size 0x294, virtual false, abstract: false, final false
  inline void set_iconImage(::UnityEngine::UIElements::Background value);

  /// @brief Method set_label, addr 0x6c19b90, size 0x134, virtual false, abstract: false, final false
