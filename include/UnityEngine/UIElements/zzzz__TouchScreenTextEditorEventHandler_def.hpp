...
/// @brief Method CloseTouchScreenKeyboard, addr 0x6b821c8, size 0x134, virtual false, abstract: false, final false
inline void CloseTouchScreenKeyboard() ;

/// @brief Method DoPollTouchScreenKeyboard, addr 0x6b81948, size 0x880, virtual false, abstract: false, final false
inline void DoPollTouchScreenKeyboard() ;

/// @brief Method HandleEventBubbleUp, addr 0x6b82a68, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method OnFocusInEvent, addr 0x6b82e08, size 0x164, virtual false, abstract: false, final false
inline void OnFocusInEvent() ;

/// @brief Method OnFocusOutEvent, addr 0x6b82f6c, size 0x3f4, virtual false, abstract: false, final false
inline void OnFocusOutEvent(::UnityEngine::UIElements::FocusOutEvent*  evt) ;

/// @brief Method OnPointerDownEvent, addr 0x6b82c54, size 0x194, virtual false, abstract: false, final false
inline void OnPointerDownEvent() ;

/// @brief Method OnPointerUpEvent, addr 0x6b82de8, size 0x20, virtual false, abstract: false, final false
inline void OnPointerUpEvent(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OpenTouchScreenKeyboard, addr 0x6b82548, size 0x520, virtual false, abstract: false, final false
inline void OpenTouchScreenKeyboard() ;

/// @brief Method PollTouchScreenKeyboard, addr 0x6b816ec, size 0x25c, virtual false, abstract: false, final false
inline void PollTouchScreenKeyboard() ;

/// @brief Method UpdateStringPositionFromKeyboard, addr 0x6b822fc, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b816dc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Frame, addr 0x6b815f0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method set_Frame, addr 0x6b8163c, size 0x50, virtual false, abstract: false, final false
static inline void set_Frame(int64_t  value) ;

/// @brief Method set_activeTouchScreenKeyboard, addr 0x6b8168c, size 0x50, virtual false, abstract: false, final false
