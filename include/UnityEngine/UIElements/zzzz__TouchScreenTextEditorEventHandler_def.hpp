...
public:
  ...
  /// @brief Method DoPollTouchScreenKeyboard, addr 0x3387ee4, size 0x728, virtual false, abstract: false, final false
  inline void DoPollTouchScreenKeyboard();

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x338860c, size 0x550, virtual true, abstract: false, final false
  ...
  /// @brief Method PollTouchScreenKeyboard, addr 0x3387c88, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3387c80, size 0x8, virtual false, abstract: false, final false
