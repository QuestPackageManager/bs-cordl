...
public:
  ...
  /// @brief Method CloseTouchScreenKeyboard, addr 0x49f10c0, size 0xe4, virtual false, abstract: false, final false
  inline void CloseTouchScreenKeyboard();

  /// @brief Method DoPollTouchScreenKeyboard, addr 0x49f0880, size 0x840, virtual false, abstract: false, final false
  inline void DoPollTouchScreenKeyboard();

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x49f191c, size 0x1dc, virtual true, abstract: false, final false
  ...
  /// @brief Method OnFocusInEvent, addr 0x49f1cd8, size 0x180, virtual false, abstract: false, final false
  inline void OnFocusInEvent();

  /// @brief Method OnFocusOutEvent, addr 0x49f1e58, size 0x480, virtual false, abstract: false, final false
  inline void OnFocusOutEvent(::UnityEngine::UIElements::FocusOutEvent* evt);

  /// @brief Method OnPointerDownEvent, addr 0x49f1af8, size 0x1c0, virtual false, abstract: false, final false
  inline void OnPointerDownEvent();

  /// @brief Method OnPointerUpEvent, addr 0x49f1cb8, size 0x20, virtual false, abstract: false, final false
  inline void OnPointerUpEvent(::UnityEngine::UIElements::PointerUpEvent* evt);

  /// @brief Method OpenTouchScreenKeyboard, addr 0x49f1414, size 0x508, virtual false, abstract: false, final false
  inline void OpenTouchScreenKeyboard();

  /// @brief Method PollTouchScreenKeyboard, addr 0x49f0648, size 0x238, virtual false, abstract: false, final false
  inline void PollTouchScreenKeyboard();

  /// @brief Method UpdateStringPositionFromKeyboard, addr 0x49f11a4, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49f0614, size 0x34, virtual false, abstract: false, final false
