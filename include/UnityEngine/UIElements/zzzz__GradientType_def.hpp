...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::GradientType, "UnityEngine.UIElements", "GradientType");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
static_assert(sizeof(::UnityEngine::UIElements::GradientType) == 0x4, "Size mismatch!");
