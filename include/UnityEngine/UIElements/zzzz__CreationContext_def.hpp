...
public:
  ...
  /// @brief Method get_target, addr 0x2e31bc8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_target();

  /// @brief Method set_target, addr 0x2e31bd0, size 0x8, virtual false, abstract: false, final false
  inline void set_target(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method get_visualTreeAsset, addr 0x2e31bd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UIElements::VisualTreeAsset> get_visualTreeAsset();

  /// @brief Method set_visualTreeAsset, addr 0x2e31be0, size 0x8, virtual false, abstract: false, final false
  inline void set_visualTreeAsset(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method get_slotInsertionPoints, addr 0x2e31be8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::UIElements::VisualElement*>* get_slotInsertionPoints();

  /// @brief Method set_slotInsertionPoints, addr 0x2e31bf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attributeOverrides, addr 0x2e31bf8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attributeOverrides, addr 0x2e31c00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2e2f6b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2e31c08, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2e31c90, size 0xf0, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::CreationContext other);

  /// @brief Method GetHashCode, addr 0x2e31d80, size 0xf0, virtual true, abstract: false, final false
