...
public:
  ...
  /// @brief Method Equals, addr 0x49a09b8, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x49a0a70, size 0x158, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::CreationContext other);

  /// @brief Method GetHashCode, addr 0x49a0bc8, size 0x128, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x49a0940, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49a08c0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_attributeOverrides, addr 0x49a08b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>* get_attributeOverrides();

  /// @brief Method get_slotInsertionPoints, addr 0x49a08a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::UnityEngine::UIElements::VisualElement*>* get_slotInsertionPoints();

  /// @brief Method get_target, addr 0x49a0880, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_target();

  /// @brief Method get_visualTreeAsset, addr 0x49a0890, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_attributeOverrides, addr 0x49a08b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_slotInsertionPoints, addr 0x49a08a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_target, addr 0x49a0888, size 0x8, virtual false, abstract: false, final false
  inline void set_target(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_visualTreeAsset, addr 0x49a0898, size 0x8, virtual false, abstract: false, final false
