...
/// @brief Method Invoke, addr 0x6beaf08, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x6beadc4, size 0x54, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  evt) ;

/// @brief Method OnNavigationCancel, addr 0x6beaf24, size 0x24, virtual false, abstract: false, final false
inline void OnNavigationCancel(::UnityEngine::UIElements::NavigationCancelEvent*  evt) ;

/// @brief Method OnNavigationMove, addr 0x6beaf6c, size 0x8c, virtual false, abstract: false, final false
inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x6beaf48, size 0x24, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x6bea964, size 0x22c, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x6beab98, size 0x22c, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method <OnKeyDown>g__GetOperation|4_0, addr 0x6beae18, size 0xf0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::KeyboardNavigationOperation _OnKeyDown_g__GetOperation_4_0(::ByRef<::UnityEngine::UIElements::KeyboardNavigationManipulator___c__DisplayClass4_0>  _cordl_fixed_empty_name_whitespace) ;
...
/// @brief Method .ctor, addr 0x6bea958, size 0x8, virtual false, abstract: false, final false
