...
public:
  ...
  /// @brief Method .ctor, addr 0x2de1e5c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterCallbacksOnTarget, addr 0x2de1e84, size 0x254, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x2de20d8, size 0x254, virtual true, abstract: false, final false
  inline void UnregisterCallbacksFromTarget();

  /// @brief Method OnKeyDown, addr 0x2de232c, size 0xe8, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnRuntimeKeyDown, addr 0x2de2460, size 0x4c, virtual false, abstract: false, final false
  inline void OnRuntimeKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnEditorKeyDown, addr 0x2de2414, size 0x4c, virtual false, abstract: false, final false
  inline void OnEditorKeyDown(::UnityEngine::UIElements::KeyDownEvent* evt);

  /// @brief Method OnNavigationCancel, addr 0x2de267c, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationCancel(::UnityEngine::UIElements::NavigationCancelEvent* evt);

  /// @brief Method OnNavigationSubmit, addr 0x2de26a0, size 0x24, virtual false, abstract: false, final false
  inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent* evt);

  /// @brief Method OnNavigationMove, addr 0x2de26c4, size 0x68, virtual false, abstract: false, final false
  inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent* evt);

  /// @brief Method Invoke, addr 0x2de2568, size 0x20, virtual false, abstract: false, final false
  inline void Invoke(::UnityEngine::UIElements::KeyboardNavigationOperation operation, ::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method <OnRuntimeKeyDown>g__GetOperation|5_0, addr 0x2de24ac, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method <OnEditorKeyDown>g__GetOperation|6_0, addr 0x2de2588, size 0xf4, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::KeyboardNavigationOperation
