...
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Spacing, "UnityEngine.UIElements", "Spacing");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x6dda310, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t left, float_t top, float_t right, float_t bottom);

  /// @brief Method get_horizontal, addr 0x6dda2f0, size 0x10, virtual false, abstract: false, final false
  inline float_t get_horizontal();

  /// @brief Method get_vertical, addr 0x6dda300, size 0x10, virtual false, abstract: false, final false
  inline float_t get_vertical();

  /// @brief Method op_Subtraction, addr 0x6dda31c, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Spacing) == 0x10, "Size mismatch!");
