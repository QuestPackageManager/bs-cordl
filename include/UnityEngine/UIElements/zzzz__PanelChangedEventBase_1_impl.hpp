...
UnityEngine::UIElements::PanelChangedEventBase_1<T>::__cordl_internal_get__originPanel_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____originPanel_k__BackingField;
}
...
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> const&
UnityEngine::UIElements::PanelChangedEventBase_1<T>::__cordl_internal_get__destinationPanel_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____destinationPanel_k__BackingField;
}
...
template <typename T> inline void UnityEngine::UIElements::PanelChangedEventBase_1<T>::Init() {
  auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PanelChangedEventBase_1<T>*>::get(), 12)));
