...
public:
  ...
  /// @brief Method .ctor, addr 0x6be4a38, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6be4aa0, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be4c68, size 0x11c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DescribeFields>b__0_0, addr 0x6be4ddc, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_0(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_1, addr 0x6be4de4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_1(::ByRef<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_2, addr 0x6be4dec, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_2(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_3, addr 0x6be4df4, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_3(::ByRef<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method <DescribeFields>b__0_4, addr 0x6be4dfc, size 0x8, virtual false, abstract: false, final false
  inline int32_t _DescribeFields_b__0_4(::UnityEngine::Vector3Int r);

  /// @brief Method <DescribeFields>b__0_5, addr 0x6be4e04, size 0x8, virtual false, abstract: false, final false
  inline void _DescribeFields_b__0_5(::ByRef<::UnityEngine::Vector3Int> r, int32_t v);

  /// @brief Method .ctor, addr 0x6be4dd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DescribeFields, addr 0x6be44c4, size 0x490, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6be4954, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bde850, size 0x12c, virtual false, abstract: false, final false
