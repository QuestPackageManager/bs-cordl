...
namespace UnityEngine::UIElements {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7381)), TypeDefinitionIndex(TypeDefinitionIndex(7386))}
...
public:
  ...
  /// @brief Method get_value addr 0x2d09cb4 size 0x44 virtual true final true
  inline ::UnityEngine::UIElements::Rotate get_value();

  /// @brief Method get_keyword addr 0x2d0cc38 size 0x8 virtual true final true
  inline ::UnityEngine::UIElements::StyleKeyword get_keyword();

  /// @brief Method .ctor addr 0x2d0cc40 size 0x10 virtual false final false
  inline void _ctor(::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method .ctor addr 0x2d0cc50 size 0x18 virtual false final false
  inline void _ctor(::UnityEngine::UIElements::Rotate v, ::UnityEngine::UIElements::StyleKeyword keyword);

  /// @brief Method op_Equality addr 0x2d0cc68 size 0x5c virtual false final false
  static inline bool op_Equality(::UnityEngine::UIElements::StyleRotate lhs, ::UnityEngine::UIElements::StyleRotate rhs);

  /// @brief Method op_Implicit addr 0x2d0a10c size 0x10 virtual false final false
  ...
  /// @brief Method Equals addr 0x2d0ccc4 size 0x7c virtual true final true
  inline bool Equals(::UnityEngine::UIElements::StyleRotate other);

  /// @brief Method Equals addr 0x2d0cd40 size 0x90 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2d0cdd0 size 0x24 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x2d0cdf4 size 0x88 virtual true final false
