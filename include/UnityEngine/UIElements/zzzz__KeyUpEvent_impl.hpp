...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::KeyUpEvent___c::*)()>(&::UnityEngine::UIElements::KeyUpEvent___c::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6bd2d8c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::KeyUpEvent___c*>::get(), ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::KeyUpEvent* (::UnityEngine::UIElements::KeyUpEvent___c::*)()>(
    &::UnityEngine::UIElements::KeyUpEvent___c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6bd2d90;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::KeyUpEvent___c*>::get(),
...
inline void UnityEngine::UIElements::KeyUpEvent___c::setStaticF___9(::UnityEngine::UIElements::KeyUpEvent___c* value) {
  ::cordl_internals::setStaticField<::UnityEngine::UIElements::KeyUpEvent___c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::KeyUpEvent___c*>::get>(
      std::forward<::UnityEngine::UIElements::KeyUpEvent___c*>(value));
}
inline ::UnityEngine::UIElements::KeyUpEvent___c* UnityEngine::UIElements::KeyUpEvent___c::getStaticF___9() {
  return ::cordl_internals::getStaticField<::UnityEngine::UIElements::KeyUpEvent___c*, "<>9",
                                           ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::KeyUpEvent___c*>::get>();
}
...
inline ::UnityEngine::UIElements::KeyUpEvent___c* UnityEngine::UIElements::KeyUpEvent___c::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UIElements::KeyUpEvent___c*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::KeyUpEvent::*)()>(&::UnityEngine::UIElements::KeyUpEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6bd2cec;
