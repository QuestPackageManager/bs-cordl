...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x6b66da8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Hash128 _GetValueFromBag_b__3_0(::StringW s, ::UnityEngine::Hash128 i);

  /// @brief Method .ctor, addr 0x6b66da4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetValueFromBag, addr 0x6b66bb8, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b66b18, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
