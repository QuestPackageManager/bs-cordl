...
public:
  ...
  /// @brief Method .ctor, addr 0x498dc10, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x498dc58, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x498deb0, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x498d810, size 0xfc, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::BoundsInt newValue);

  /// @brief Method UpdateMixedValueContent, addr 0x498d90c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__10_0, addr 0x498dab8, size 0xac, virtual false, abstract: false, final false
  inline void __ctor_b__10_0(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3Int>* e);

  /// @brief Method <.ctor>b__10_1, addr 0x498db64, size 0xac, virtual false, abstract: false, final false
  inline void __ctor_b__10_1(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3Int>* e);

  /// @brief Method .ctor, addr 0x498d370, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x498d378, size 0x378, virtual false, abstract: false, final false
