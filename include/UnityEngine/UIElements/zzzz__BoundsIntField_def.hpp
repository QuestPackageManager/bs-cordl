...
public:
  ...
  /// @brief Method .ctor, addr 0x6bded90, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6bdedf8, size 0x2a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bdf0a0, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetValueWithoutNotify, addr 0x6bde97c, size 0xd0, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::UnityEngine::BoundsInt newValue);

  /// @brief Method UpdateMixedValueContent, addr 0x6bdea4c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__11_0, addr 0x6bdec18, size 0xbc, virtual false, abstract: false, final false
  inline void __ctor_b__11_0(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3Int>* e);

  /// @brief Method <.ctor>b__11_1, addr 0x6bdecd4, size 0xbc, virtual false, abstract: false, final false
  inline void __ctor_b__11_1(::UnityEngine::UIElements::ChangeEvent_1<::UnityEngine::Vector3Int>* e);

  /// @brief Method .ctor, addr 0x6bde488, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6bde490, size 0x3c0, virtual false, abstract: false, final false
