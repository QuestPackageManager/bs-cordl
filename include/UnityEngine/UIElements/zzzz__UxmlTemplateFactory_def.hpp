...
public:
  ...
  /// @brief Method Create, addr 0x6cb827c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cb8284, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_uxmlName, addr 0x6cb81c0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_uxmlName();

  /// @brief Method get_uxmlQualifiedName, addr 0x6cb8204, size 0x78, virtual true, abstract: false, final false
