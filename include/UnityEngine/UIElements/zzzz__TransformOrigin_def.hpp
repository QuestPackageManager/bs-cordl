...
public:
  ...
  /// @brief Method Equals, addr 0x6b3c93c, size 0xcc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b3c8d4, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::TransformOrigin other);

  /// @brief Method GetHashCode, addr 0x6b36868, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Initial, addr 0x6b3ba14, size 0x18, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::TransformOrigin Initial();

  /// @brief Method ToString, addr 0x6b3ca08, size 0x13c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b3c810, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 vector);

  /// @brief Method .ctor, addr 0x6b3c804, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Length x, ::UnityEngine::UIElements::Length y, float_t z);

  /// @brief Method get_x, addr 0x6b3c83c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length get_x();

  /// @brief Method get_y, addr 0x6b3c84c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length get_y();

  /// @brief Method get_z, addr 0x6b3c85c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b36520, size 0x6c, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::TransformOrigin lhs, ::UnityEngine::UIElements::TransformOrigin rhs);

  /// @brief Method op_Inequality, addr 0x6b3c86c, size 0x68, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::UIElements::TransformOrigin lhs, ::UnityEngine::UIElements::TransformOrigin rhs);

  /// @brief Method set_x, addr 0x6b3c844, size 0x8, virtual false, abstract: false, final false
  inline void set_x(::UnityEngine::UIElements::Length value);

  /// @brief Method set_y, addr 0x6b3c854, size 0x8, virtual false, abstract: false, final false
  inline void set_y(::UnityEngine::UIElements::Length value);

  /// @brief Method set_z, addr 0x6b3c864, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3cdcc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b3cdd4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b3cc90, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3cdc4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3cdbc, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3cdec, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::Length GetValue(::ByRef<::UnityEngine::UIElements::TransformOrigin> container);

  static inline ::UnityEngine::UIElements::PropertyBag_TransformOrigin_YProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6b3cdf4, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::UIElements::TransformOrigin> container, ::UnityEngine::UIElements::Length value);
  ...
  /// @brief Method .ctor, addr 0x6b3ccf4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3cde4, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3cddc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3ce0c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b3ce14, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b3cd58, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3ce04, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3cdfc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b3cb44, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
