...
public:
  ...
  /// @brief Method .ctor, addr 0x499cac4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x499cb0c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x499cc04, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x499ca1c, size 0x4, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption* option);

  /// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x499ca20, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x499c98c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x499c994, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x499c874, size 0x118, virtual false, abstract: false, final false
