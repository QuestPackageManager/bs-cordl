...
CORDL_MODULE_EXPORT(UxmlIgnoreAttribute)
...
public:
  ...
  /// @brief Method .ctor, addr 0x6cbfd74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UxmlIgnoreAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UxmlIgnoreAttribute(UxmlIgnoreAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UxmlIgnoreAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UxmlIgnoreAttribute(UxmlIgnoreAttributeconst&) = delete;
