...
public:
  // Declarations
  /// @brief Method GetViewHashCode, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline int64_t GetViewHashCode();

  // Ctor Parameters [CppParam { name: "", ty: "IDataSourceViewHashProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IDataSourceViewHashProvider(IDataSourceViewHashProviderconst&) = delete;
