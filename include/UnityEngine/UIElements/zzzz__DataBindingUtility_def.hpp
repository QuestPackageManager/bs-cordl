...
public:
  ...
  /// @brief Method <.cctor>b__23_0, addr 0x6aec318, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Internal::TypePathVisitor* __cctor_b__23_0();

  /// @brief Method <.cctor>b__23_1, addr 0x6aec35c, size 0x28, virtual false, abstract: false, final false
  inline void __cctor_b__23_1(::UnityEngine::UIElements::Internal::TypePathVisitor* v);

  /// @brief Method <.cctor>b__23_2, addr 0x6aec384, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Internal::AutoCompletePathVisitor* __cctor_b__23_2();

  /// @brief Method <.cctor>b__23_3, addr 0x6aec3dc, size 0x18, virtual false, abstract: false, final false
  inline void __cctor_b__23_3(::UnityEngine::UIElements::Internal::AutoCompletePathVisitor* v);

  /// @brief Method .ctor, addr 0x6aec314, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method TryGetBinding, addr 0x6aebe2c, size 0x184, virtual false, abstract: false, final false
