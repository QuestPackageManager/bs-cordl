...
public:
  ...
  /// @brief Method .ctor, addr 0x4a8ba2c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a8ba84, size 0x294, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a8bd18, size 0x44c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_focusIndex, addr 0x4a8ba74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UxmlIntAttributeDescription* get_focusIndex();

  /// @brief Method get_focusable, addr 0x4a8ba7c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x4a8c1a4, size 0x78, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method BringToFront, addr 0x4a8ce68, size 0xb4, virtual false, abstract: false, final false
  inline void BringToFront(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Children, addr 0x4a8d230, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::VisualElement*>* Children();

  /// @brief Method Clear, addr 0x4a8cb4c, size 0x31c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ElementAt, addr 0x4a8d22c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method Equals, addr 0x4a8d268, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4a8d24c, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::UIElements::VisualElement_Hierarchy other);

  /// @brief Method GetHashCode, addr 0x4a8d2e0, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x4a8d1cc, size 0x60, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x4a8c26c, size 0x2f0, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method MoveChildElement, addr 0x4a8cf1c, size 0xe0, virtual false, abstract: false, final false
  inline void MoveChildElement(::UnityEngine::UIElements::VisualElement* child, int32_t currentIndex, int32_t nextIndex);

  /// @brief Method PlaceBehind, addr 0x4a8d094, size 0xd8, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* child, ::UnityEngine::UIElements::VisualElement* over);

  /// @brief Method PutChildAtIndex, addr 0x4a8c55c, size 0x13c, virtual false, abstract: false, final false
  inline void PutChildAtIndex(::UnityEngine::UIElements::VisualElement* child, int32_t index);

  /// @brief Method ReleaseChildList, addr 0x4a8ca6c, size 0xe0, virtual false, abstract: false, final false
  inline void ReleaseChildList();

  /// @brief Method Remove, addr 0x4a8c6ec, size 0xec, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method RemoveAt, addr 0x4a8c7d8, size 0x218, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveChildAtIndex, addr 0x4a8c9f0, size 0x7c, virtual false, abstract: false, final false
  inline void RemoveChildAtIndex(int32_t index);

  /// @brief Method SendToBack, addr 0x4a8cffc, size 0x98, virtual false, abstract: false, final false
  inline void SendToBack(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method SetParent, addr 0x4a8c698, size 0x54, virtual false, abstract: false, final false
  inline void SetParent(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method .ctor, addr 0x4a8c19c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method get_Item, addr 0x4a8d16c, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_childCount, addr 0x4a8c21c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_children, addr 0x4a8c180, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* get_children();

  /// @brief Method get_parent, addr 0x4a8c164, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method op_Equality, addr 0x4a8d25c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CanBeActivated, addr 0x4a8d6dc, size 0x3c, virtual true, abstract: false, final true
  inline bool CanBeActivated();

  /// @brief Method Every, addr 0x4a8d3b0, size 0xa4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IVisualElementScheduledItem* Every(int64_t intervalMs);

  /// @brief Method ExecuteLater, addr 0x4a8d4d4, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnItemUnscheduled, addr 0x4a8d454, size 0x40, virtual true, abstract: false, final false
  inline void OnItemUnscheduled();

  /// @brief Method OnPanelActivate, addr 0x4a8d510, size 0xf0, virtual true, abstract: false, final true
  inline void OnPanelActivate();

  /// @brief Method OnPanelDeactivate, addr 0x4a8d600, size 0xdc, virtual true, abstract: false, final true
  inline void OnPanelDeactivate();

  /// @brief Method Pause, addr 0x4a8d4b4, size 0x20, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x4a8d494, size 0x20, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method StartingIn, addr 0x4a8d3a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4a8d308, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* handler);

  /// @brief Method get_element, addr 0x4a8d2f8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_element, addr 0x4a8d300, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x4a8d778, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x4a8d718, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x4a8d80c, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x4a8d7ac, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method LogCustomPropertyWarning, addr 0x4a8dca0, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContext, addr 0x4a8d840, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0x4a8e0a4, size 0xc4, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<::StringW> property, ::ByRef<::StringW> value);

  /// @brief Method TryGetValue, addr 0x4a8dafc, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a8de94, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a8dd8c, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a8df9c, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a8d84c, size 0x98, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<float_t> property, ::ByRef<float_t> value);

  /// @brief Method TryGetValue, addr 0x4a8da40, size 0xbc, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<int32_t> property, ::ByRef<int32_t> value);

  /// @brief Method TryGetValue, addr 0x4a8d8e4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a8e168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4a8e178, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_fullTypeName, addr 0x4a8e1e8, size 0x48, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_type, addr 0x4a8e170, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_type();

  /// @brief Method get_typeName, addr 0x4a8e230, size 0x98, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_typeNamespace, addr 0x4a8e2c8, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UnityEngine.UIElements.Experimental.ITransitionAnimations.Start>b__0, addr 0x4a8e318, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a8e310, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x4a89970, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method AddStyleSheetPath, addr 0x4a8b1bc, size 0x234, virtual false, abstract: false, final false
  inline void AddStyleSheetPath(::StringW sheetPath);

  /// @brief Method AddToClassList, addr 0x4a854f8, size 0x210, virtual false, abstract: false, final false
  inline void AddToClassList(::StringW className);

  /// @brief Method AssignMeasureFunction, addr 0x4a86200, size 0x90, virtual false, abstract: false, final false
  inline void AssignMeasureFunction();

  /// @brief Method AssignStyleValues, addr 0x4a86d98, size 0x15f4, virtual false, abstract: false, final false
  ...
  /// @brief Method BringToFront, addr 0x4a89fe0, size 0x64, virtual false, abstract: false, final false
  inline void BringToFront();

  /// @brief Method CalculateConservativeRect, addr 0x4a8ab20, size 0x22c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect CalculateConservativeRect(::ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Rect rect);

  /// @brief Method ChangeIMGUIContainerCount, addr 0x4a82dc0, size 0x40, virtual false, abstract: false, final false
  inline void ChangeIMGUIContainerCount(int32_t delta);

  /// @brief Method CheckUserKeyArgument, addr 0x4a86920, size 0x15c, virtual false, abstract: false, final false
  static inline void CheckUserKeyArgument(::UnityEngine::PropertyName key);

  /// @brief Method Children, addr 0x4a89f2c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::VisualElement*>* Children();

  /// @brief Method ClassListContains, addr 0x4a867f4, size 0xac, virtual false, abstract: false, final false
  inline bool ClassListContains(::StringW cls);

  /// @brief Method Clear, addr 0x4a89ab0, size 0x68, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearManualLayout, addr 0x4a80628, size 0x5c4, virtual false, abstract: false, final false
  inline void ClearManualLayout();

  /// @brief Method CombineClipRects, addr 0x4a826b4, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect CombineClipRects(::UnityEngine::Rect rect, ::UnityEngine::Rect parentRect);

  /// @brief Method ComputeAAAlignedBound, addr 0x4a826fc, size 0x114, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeAAAlignedBound(::UnityEngine::Rect position, ::UnityEngine::Matrix4x4 mat);

  /// @brief Method Contains, addr 0x4a82a48, size 0x70, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method ContainsPoint, addr 0x4a8612c, size 0x54, virtual true, abstract: false, final false
  inline bool ContainsPoint(::UnityEngine::Vector2 localPoint);

  /// @brief Method DirtyNextParentWithEventCallback, addr 0x4a894d8, size 0x80, virtual false, abstract: false, final false
  inline void DirtyNextParentWithEventCallback();

  /// @brief Method DoMeasure, addr 0x4a862b0, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method ElementAt, addr 0x4a89b18, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method ElementAtTreePath, addr 0x4a89c7c, size 0x1b0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAtTreePath(::System::Collections::Generic::List_1<int32_t>* childIndexes);

  /// @brief Method EnableInClassList, addr 0x4a85708, size 0xc, virtual false, abstract: false, final false
  inline void EnableInClassList(::StringW className, bool enable);

  /// @brief Method EnsureWorldTransformAndClipUpToDate, addr 0x4a820d8, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureWorldTransformAndClipUpToDate();

  /// @brief Method ExecuteDefaultAction, addr 0x4a830e0, size 0x720, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method FinalizeLayout, addr 0x4a863e8, size 0x4c, virtual false, abstract: false, final false
  inline void FinalizeLayout();

  /// @brief Method FindCommonAncestor, addr 0x4a8a2a8, size 0x184, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* FindCommonAncestor(::UnityEngine::UIElements::VisualElement* other);

  /// @brief Method FindElementInTree, addr 0x4a89e2c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Focus, addr 0x4a83db8, size 0x84, virtual true, abstract: false, final true
  inline void Focus();

  /// @brief Method GatherAllChildren, addr 0x4a84828, size 0xd8, virtual false, abstract: false, final false
  inline void GatherAllChildren(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* elements);

  /// @brief Method GetAnimationSystem, addr 0x4a86b84, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementAnimationSystem* GetAnimationSystem();

  /// @brief Method GetCachedNextParentWithEventCallback, addr 0x4a89558, size 0x28, virtual false, abstract: false, final false
  inline bool GetCachedNextParentWithEventCallback(::ByRef<::UnityEngine::UIElements::VisualElement*> nextParent);

  /// @brief Method GetClassesForIteration, addr 0x4a867ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstAncestorWhere, addr 0x4a8a234, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x4a85c70, size 0x74, virtual false, abstract: false, final false
  inline ::StringW GetFullHierarchicalViewDataKey();

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x4a85bdc, size 0x94, virtual false, abstract: false, final false
  inline void GetFullHierarchicalViewDataKey(::System::Text::StringBuilder* key);

  /// @brief Method GetNextElementDepthFirst, addr 0x4a8a530, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetNextElementDepthFirst();

  /// @brief Method GetOrCreateTypeData, addr 0x4a8b514, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentSizeForLengthConversion, addr 0x4a7eb04, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPivotedMatrixWithLayout, addr 0x4a819c4, size 0x188, virtual false, abstract: false, final false
  inline void GetPivotedMatrixWithLayout(::ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method GetPreviousElementDepthFirst, addr 0x4a8a620, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetPreviousElementDepthFirst();

  /// @brief Method GetProperty, addr 0x4a868a0, size 0x80, virtual false, abstract: false, final false
  inline ::System::Object* GetProperty(::UnityEngine::PropertyName key);

  /// @brief Method GetRoot, addr 0x4a8a42c, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRoot();

  /// @brief Method GetRootVisualContainer, addr 0x4a8a4ec, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRootVisualContainer();

  /// @brief Method GetStylePropertyAnimationSystem, addr 0x4a7d058, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* GetStylePropertyAnimationSystem();

  /// @brief Method GetTooltipRect, addr 0x4a83d20, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::Rect GetTooltipRect();

  /// @brief Method HasChangedPanel, addr 0x4a84b40, size 0x314, virtual false, abstract: false, final false
  inline void HasChangedPanel(::UnityEngine::UIElements::BaseVisualElementPanel* prevPanel);

  /// @brief Method HasDefaultAction, addr 0x4a898dc, size 0x10, virtual false, abstract: false, final false
  inline bool HasDefaultAction(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacks, addr 0x4a89854, size 0x10, virtual false, abstract: false, final false
  inline bool HasEventCallbacks(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacksOrDefaultActionAtTarget, addr 0x4a898c4, size 0x18, virtual false, abstract: false, final false
  inline bool HasEventCallbacksOrDefaultActionAtTarget(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacksOrDefaultActions, addr 0x4a84f24, size 0x20, virtual false, abstract: false, final false
  inline bool HasEventCallbacksOrDefaultActions(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasParentEventCallbacksOrDefaultActionAtTarget, addr 0x4a89898, size 0x2c, virtual false, abstract: false, final false
  inline bool HasParentEventCallbacksOrDefaultActionAtTarget(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasParentEventCallbacksOrDefaultActions, addr 0x4a89864, size 0x34, virtual false, abstract: false, final false
  inline bool HasParentEventCallbacksOrDefaultActions(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasProperty, addr 0x4a86af4, size 0x80, virtual false, abstract: false, final false
  inline bool HasProperty(::UnityEngine::PropertyName key);

  /// @brief Method IncrementVersion, addr 0x4a788d0, size 0x28, virtual false, abstract: false, final false
  inline void IncrementVersion(::UnityEngine::UIElements::VersionChangeType changeType);

  /// @brief Method IndexOf, addr 0x4a89bfc, size 0x80, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x4a89a20, size 0x90, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method InvokeGenerateVisualContent, addr 0x4a859f0, size 0x1ec, virtual false, abstract: false, final false
  inline void InvokeGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method InvokeHierarchyChanged, addr 0x4a84fdc, size 0x20, virtual false, abstract: false, final false
  inline void InvokeHierarchyChanged(::UnityEngine::UIElements::HierarchyChangeType changeType);

  /// @brief Method IsPartOfCapturedChain, addr 0x4a829a4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewDataPersitenceSupportedOnChildren, addr 0x4a86070, size 0x7c, virtual false, abstract: false, final false
  inline bool IsViewDataPersitenceSupportedOnChildren(bool existingState);

  /// @brief Method MarkDirtyRepaint, addr 0x4a859bc, size 0x24, virtual false, abstract: false, final false
  inline void MarkDirtyRepaint();

  /// @brief Method MarkRenderHintsClean, addr 0x4a7fa34, size 0x10, virtual false, abstract: false, final false
  inline void MarkRenderHintsClean();

  /// @brief Method Max, addr 0x4a8a994, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Max(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method Measure, addr 0x4a862c0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Min, addr 0x4a8a978, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Min(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method MultiplyMatrix34, addr 0x4a81b4c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyMatrix44Point2, addr 0x4a8ae24, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MultiplyMatrix44Point2(::ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector2 point);

  /// @brief Method MultiplyVector2, addr 0x4a8ae48, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnViewDataReady, addr 0x4a86128, size 0x4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method OnViewDataReady, addr 0x4a860ec, size 0x3c, virtual false, abstract: false, final false
  inline void OnViewDataReady(bool enablePersistence);

  /// @brief Method OrderMinMaxRect, addr 0x4a8ad4c, size 0x44, virtual false, abstract: false, final false
  static inline void OrderMinMaxRect(::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method OverwriteFromViewData, addr 0x4a85ce4, size 0x310, virtual false, abstract: false, final false
  inline void OverwriteFromViewData(::System::Object* obj, ::StringW key);

  /// @brief Method PlaceBehind, addr 0x4a8a0a8, size 0x128, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* sibling);

  /// @brief Method PropagateCachedNextParentWithEventCallback, addr 0x4a89648, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateEnabledToChildren, addr 0x4a85728, size 0xb0, virtual false, abstract: false, final false
  inline void PropagateEnabledToChildren(bool value);

  /// @brief Method ReadCurrentValues, addr 0x4a8838c, size 0xeec, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAnimation, addr 0x4a86c18, size 0x108, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterRunningAnimations, addr 0x4a84f44, size 0x6c, virtual false, abstract: false, final false
  inline void RegisterRunningAnimations();

  /// @brief Method RemoveFromClassList, addr 0x4a853dc, size 0x11c, virtual false, abstract: false, final false
  inline void RemoveFromClassList(::StringW className);

  /// @brief Method RemoveFromHierarchy, addr 0x4a8a1d0, size 0x64, virtual false, abstract: false, final false
  inline void RemoveFromHierarchy();

  /// @brief Method RemoveMeasureFunction, addr 0x4a86290, size 0x20, virtual false, abstract: false, final false
  inline void RemoveMeasureFunction();

  /// @brief Method ResolveLengthValue, addr 0x4a7c6e4, size 0x19c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat ResolveLengthValue(::UnityEngine::UIElements::Length length, bool isRow);

  /// @brief Method ResolveRotation, addr 0x4a8a768, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion ResolveRotation();

  /// @brief Method ResolveScale, addr 0x4a8a818, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveScale();

  /// @brief Method ResolveTransformOrigin, addr 0x4a7c96c, size 0x304, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTransformOrigin();

  /// @brief Method ResolveTranslate, addr 0x4a7cc74, size 0x1fc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTranslate();

  /// @brief Method RetargetElement, addr 0x4a8a704, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* RetargetElement(::UnityEngine::UIElements::VisualElement* retargetAgainst);

  /// @brief Method SaveViewData, addr 0x4a85ff4, size 0x7c, virtual false, abstract: false, final false
  inline void SaveViewData();

  /// @brief Method SendEvent, addr 0x4a84fb0, size 0x18, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e);

  /// @brief Method SendEvent, addr 0x4a84fc8, size 0x14, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method SendToBack, addr 0x4a8a044, size 0x64, virtual false, abstract: false, final false
  inline void SendToBack();

  /// @brief Method SetAsNextParentWithEventCallback, addr 0x4a7f120, size 0xb0, virtual false, abstract: false, final false
  inline void SetAsNextParentWithEventCallback();

  /// @brief Method SetComputedStyle, addr 0x4a864b4, size 0x1cc, virtual false, abstract: false, final false
  inline void SetComputedStyle(::ByRef<::UnityEngine::UIElements::ComputedStyle> newStyle);

  /// @brief Method SetEnabled, addr 0x4a830bc, size 0x24, virtual false, abstract: false, final false
  inline void SetEnabled(bool value);

  /// @brief Method SetEnabledFromHierarchyPrivate, addr 0x4a84ffc, size 0x380, virtual false, abstract: false, final false
  inline bool SetEnabledFromHierarchyPrivate(bool state);

  /// @brief Method SetInlineRule, addr 0x4a86434, size 0x80, virtual false, abstract: false, final false
  inline void SetInlineRule(::UnityEngine::UIElements::StyleSheet* sheet, ::UnityEngine::UIElements::StyleRule* rule);

  /// @brief Method SetPanel, addr 0x4a83e3c, size 0x9ec, virtual false, abstract: false, final false
  inline void SetPanel(::UnityEngine::UIElements::BaseVisualElementPanel* p);

  /// @brief Method SetProperty, addr 0x4a86a7c, size 0x78, virtual false, abstract: false, final false
  inline void SetProperty(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetPropertyInternal, addr 0x4a7f488, size 0x240, virtual false, abstract: false, final false
  inline void SetPropertyInternal(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetTooltip, addr 0x4a83c44, size 0xdc, virtual false, abstract: false, final false
  inline void SetTooltip(::UnityEngine::UIElements::TooltipEvent* e);

  /// @brief Method ShouldClip, addr 0x4a81448, size 0x2c, virtual false, abstract: false, final false
  inline bool ShouldClip();

  /// @brief Method Start, addr 0x4a89358, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method SubstractBorderPadding, addr 0x4a82114, size 0x5a0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect SubstractBorderPadding(::UnityEngine::Rect worldRect);

  /// @brief Method ToString, addr 0x4a86680, size 0x16c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformAlignedRect, addr 0x4a8ad90, size 0x94, virtual false, abstract: false, final false
  static inline void TransformAlignedRect(::ByRef<::UnityEngine::Matrix4x4> matrix, ::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TransformAlignedRectToParentSpace, addr 0x4a8a9b0, size 0x170, virtual false, abstract: false, final false
  inline void TransformAlignedRectToParentSpace(::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TranslateMatrix34, addr 0x4a8ae64, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateMatrix34InPlace, addr 0x4a8af50, size 0x5c, virtual false, abstract: false, final false
  static inline void TranslateMatrix34InPlace(::ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector3 rhs);

  /// @brief Method TryConvertBackgroundSizeUnits, addr 0x4a7effc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertLengthUnits, addr 0x4a7e84c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTransformOriginUnits, addr 0x4a7eecc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTranslateUnits, addr 0x4a7ef64, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetPropertyInternal, addr 0x4a7f330, size 0xe8, virtual false, abstract: false, final false
  inline bool TryGetPropertyInternal(::UnityEngine::PropertyName key, ::ByRef<::System::Object*> value);

  /// @brief Method UnityEngine.UIElements.Experimental.ITransitionAnimations.Start, addr 0x4a89278, size 0xe0, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*
  ...
  /// @brief Method UnityEngine.UIElements.IExperimentalFeatures.get_animation, addr 0x4a898f0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_backgroundColor, addr 0x4a7c4a0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_backgroundColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomColor, addr 0x4a7c4ac, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderBottomColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomLeftRadius, addr 0x4a7c4b8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomRightRadius, addr 0x4a7c4d4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomWidth, addr 0x4a7c4f0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftColor, addr 0x4a7c50c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderLeftColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftWidth, addr 0x4a7c518, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderLeftWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightColor, addr 0x4a7c534, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderRightColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightWidth, addr 0x4a7c540, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderRightWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopColor, addr 0x4a7c55c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderTopColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopLeftRadius, addr 0x4a7c568, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopRightRadius, addr 0x4a7c584, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopWidth, addr 0x4a7c5a0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_bottom, addr 0x4a7c5bc, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_bottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_color, addr 0x4a7c5d8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_color();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_display, addr 0x4a7c5e4, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DisplayStyle UnityEngine_UIElements_IResolvedStyle_get_display();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexDirection, addr 0x4a7c5f0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::FlexDirection UnityEngine_UIElements_IResolvedStyle_get_flexDirection();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexGrow, addr 0x4a7c5fc, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexGrow();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexShrink, addr 0x4a7c608, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexShrink();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_height, addr 0x4a7c614, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_height();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_left, addr 0x4a7c630, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_left();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginBottom, addr 0x4a7c64c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginLeft, addr 0x4a7c668, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginRight, addr 0x4a7c684, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginTop, addr 0x4a7c6a0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minHeight, addr 0x4a7c6bc, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minHeight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minWidth, addr 0x4a7c880, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_opacity, addr 0x4a7c8a8, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_opacity();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingBottom, addr 0x4a7c8b4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingLeft, addr 0x4a7c8d0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingRight, addr 0x4a7c8ec, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingTop, addr 0x4a7c908, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_right, addr 0x4a7c924, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_right();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_scale, addr 0x4a7c940, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Scale UnityEngine_UIElements_IResolvedStyle_get_scale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_top, addr 0x4a7c94c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_top();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_transformOrigin, addr 0x4a7c968, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_transformOrigin();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_translate, addr 0x4a7cc70, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_translate();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityBackgroundImageTintColor, addr 0x4a7ce70, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityBackgroundImageTintColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceLeft, addr 0x4a7ce7c, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceRight, addr 0x4a7ce88, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceScale, addr 0x4a7ce94, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceScale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineColor, addr 0x4a7cea0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineWidth, addr 0x4a7ceac, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_visibility, addr 0x4a7ceb8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Visibility UnityEngine_UIElements_IResolvedStyle_get_visibility();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_width, addr 0x4a7cec4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_width();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAllAnimations, addr 0x4a7e5b8, size 0xe0, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_CancelAllAnimations();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAnimation, addr 0x4a7e4e8, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.GetAllAnimations, addr 0x4a7e760, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d3b0, size 0x150, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d8a4, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d61c, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7e114, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7e244, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7e360, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d774, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d294, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7de04, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7db4c, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d9c0, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7df8c, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7dc7c, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d074, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a7d178, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.StartEnum, addr 0x4a7d500, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.UpdateAnimation, addr 0x4a7e698, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_completedAnimationCount, addr 0x4a7d048, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_completedAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_runningAnimationCount, addr 0x4a7d038, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_runningAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_completedAnimationCount, addr 0x4a7d050, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_completedAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_runningAnimationCount, addr 0x4a7d040, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_runningAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITransform.get_position, addr 0x4a7fa48, size 0xa0, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_position();

  /// @brief Method UnityEngine.UIElements.ITransform.get_scale, addr 0x4a7fc54, size 0xb4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_scale();

  /// @brief Method UnityEngine.UIElements.ITransform.set_position, addr 0x4a7fae8, size 0x16c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITransform_set_position(::UnityEngine::Vector3 value);

  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x4a8afb0, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x4a8b064, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterAnimation, addr 0x4a86d20, size 0x78, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterRunningAnimations, addr 0x4a84e54, size 0xd0, virtual false, abstract: false, final false
  inline void UnregisterRunningAnimations();

  /// @brief Method UpdateBoundingBox, addr 0x4a810c8, size 0x210, virtual false, abstract: false, final false
  inline void UpdateBoundingBox();

  /// @brief Method UpdateCallbackParentCategories, addr 0x4a8976c, size 0xb8, virtual false, abstract: false, final false
  inline void UpdateCallbackParentCategories();

  /// @brief Method UpdateCursorStyle, addr 0x4a83800, size 0x444, virtual false, abstract: false, final false
  inline void UpdateCursorStyle(int64_t eventType);

  /// @brief Method UpdateHoverPseudoState, addr 0x4a828ac, size 0xf8, virtual false, abstract: false, final false
  inline void UpdateHoverPseudoState();

  /// @brief Method UpdateWorldBoundingBox, addr 0x4a8131c, size 0xf0, virtual false, abstract: false, final false
  inline void UpdateWorldBoundingBox();

  /// @brief Method UpdateWorldClip, addr 0x4a81d9c, size 0x2d0, virtual false, abstract: false, final false
  inline void UpdateWorldClip();

  /// @brief Method UpdateWorldTransform, addr 0x4a81638, size 0x2c8, virtual false, abstract: false, final false
  inline void UpdateWorldTransform();

  /// @brief Method UpdateWorldTransformInverse, addr 0x4a81928, size 0x54, virtual false, abstract: false, final false
  inline void UpdateWorldTransformInverse();

  /// @brief Method WillChangePanel, addr 0x4a84900, size 0x240, virtual false, abstract: false, final false
  inline void WillChangePanel(::UnityEngine::UIElements::BaseVisualElementPanel* destinationPanel);

  /// @brief Method <AssignMeasureFunction>b__432_0, addr 0x4a8b8b8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a82e00, size 0x2bc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x4a89b1c, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_boundingBox, addr 0x4a8108c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBox();

  /// @brief Method get_boundingBoxInParentSpace, addr 0x4a8140c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBoxInParentSpace();

  /// @brief Method get_canGrabFocus, addr 0x4a7f6c8, size 0x118, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method get_childCount, addr 0x4a89b94, size 0x68, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_classList, addr 0x4a82b58, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_classList();

  /// @brief Method get_computedStyle, addr 0x4a747cc, size 0x8, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::UIElements::ComputedStyle> get_computedStyle();

  /// @brief Method get_containedPointerIds, addr 0x4a8289c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_containedPointerIds();

  /// @brief Method get_contentContainer, addr 0x4a89964, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_contentRect, addr 0x4a80bec, size 0x204, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_contentRect();

  /// @brief Method get_customStyle, addr 0x4a8b118, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICustomStyle* get_customStyle();

  /// @brief Method get_defaultMaterial, addr 0x4a86b7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_defaultMaterial();

  /// @brief Method get_disableClipping, addr 0x4a89918, size 0xc, virtual false, abstract: false, final false
  inline bool get_disableClipping();

  /// @brief Method get_elementPanel, addr 0x4a89954, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_elementPanel();

  /// @brief Method get_enableViewDataPersistence, addr 0x4a7f27c, size 0xc, virtual false, abstract: false, final false
  inline bool get_enableViewDataPersistence();

  /// @brief Method get_enabledInHierarchy, addr 0x4a7f894, size 0x10, virtual false, abstract: false, final false
  inline bool get_enabledInHierarchy();

  /// @brief Method get_enabledSelf, addr 0x4a85714, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabledSelf();

  /// @brief Method get_eventCallbackCategories, addr 0x4a896a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_eventCallbackCategories();

  /// @brief Method get_eventCallbackParentCategories, addr 0x4a89720, size 0x40, virtual false, abstract: false, final false
  inline int32_t get_eventCallbackParentCategories();

  /// @brief Method get_experimental, addr 0x4a898ec, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IExperimentalFeatures* get_experimental();

  /// @brief Method get_focusController, addr 0x4a7f8a4, size 0xb0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_fullTypeName, addr 0x4a82c0c, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_generateVisualContent, addr 0x4a859e0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* get_generateVisualContent();

  /// @brief Method get_hasCompletedAnimations, addr 0x4a7cf8c, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasCompletedAnimations();

  /// @brief Method get_hasDefaultRotationAndScale, addr 0x4a8a8ac, size 0xcc, virtual false, abstract: false, final false
  inline bool get_hasDefaultRotationAndScale();

  /// @brief Method get_hasInlineStyle, addr 0x4a82d80, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasInlineStyle();

  /// @brief Method get_hasRunningAnimations, addr 0x4a7cee0, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasRunningAnimations();

  /// @brief Method get_hierarchy, addr 0x4a898f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_Hierarchy get_hierarchy();

  /// @brief Method get_isBoundingBoxDirty, addr 0x4a8100c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isBoundingBoxDirty();

  /// @brief Method get_isCompositeRoot, addr 0x4a7f0d8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isCompositeRoot();

  /// @brief Method get_isEventCallbackParentCategoriesDirty, addr 0x4a89760, size 0xc, virtual false, abstract: false, final false
  inline bool get_isEventCallbackParentCategoriesDirty();

  /// @brief Method get_isHierarchyDisplayed, addr 0x4a7f1d0, size 0xc, virtual false, abstract: false, final false
  inline bool get_isHierarchyDisplayed();

  /// @brief Method get_isLayoutManual, addr 0x4a7fd08, size 0xc, virtual false, abstract: false, final false
  inline bool get_isLayoutManual();

  /// @brief Method get_isParentEnabledInHierarchy, addr 0x4a8537c, size 0x60, virtual false, abstract: false, final false
  inline bool get_isParentEnabledInHierarchy();

  /// @brief Method get_isRootVisualContainer, addr 0x4a89904, size 0x8, virtual false, abstract: false, final false
  inline bool get_isRootVisualContainer();

  /// @brief Method get_isWorldBoundingBoxOrDependenciesDirty, addr 0x4a81078, size 0x14, virtual false, abstract: false, final false
  inline bool get_isWorldBoundingBoxOrDependenciesDirty();

  /// @brief Method get_isWorldClipDirty, addr 0x4a81d24, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldClipDirty();

  /// @brief Method get_isWorldTransformDirty, addr 0x4a81590, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformDirty();

  /// @brief Method get_isWorldTransformInverseOrDependenciesDirty, addr 0x4a815ec, size 0x10, virtual false, abstract: false, final false
  inline bool get_isWorldTransformInverseOrDependenciesDirty();

  /// @brief Method get_languageDirection, addr 0x4a857d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::LanguageDirection get_languageDirection();

  /// @brief Method get_layout, addr 0x4a7fdb0, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_layout();

  /// @brief Method get_localBound, addr 0x4a81554, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_localBound();

  /// @brief Method get_localLanguageDirection, addr 0x4a857e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::LanguageDirection get_localLanguageDirection();

  /// @brief Method get_name, addr 0x4a82af8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_nextParentWithEventCallback, addr 0x4a89580, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_nextParentWithEventCallback();

  /// @brief Method get_paddingRect, addr 0x4a80df0, size 0x204, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_paddingRect();

  /// @brief Method get_panel, addr 0x4a7f954, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_panel();

  /// @brief Method get_parent, addr 0x4a7f7e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method get_pickingMode, addr 0x4a82ab8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PickingMode get_pickingMode();

  /// @brief Method get_positionWithLayout, addr 0x4a8197c, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionWithLayout();

  /// @brief Method get_pseudoStates, addr 0x4a82810, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PseudoStates get_pseudoStates();

  /// @brief Method get_rect, addr 0x4a80ff4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_renderHints, addr 0x4a7f97c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RenderHints get_renderHints();

  /// @brief Method get_requireMeasureFunction, addr 0x4a86180, size 0xc, virtual false, abstract: false, final false
  inline bool get_requireMeasureFunction();

  /// @brief Method get_resolvedStyle, addr 0x4a74740, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IResolvedStyle* get_resolvedStyle();

  /// @brief Method get_scaledPixelsPerPoint, addr 0x4a7fd44, size 0x6c, virtual false, abstract: false, final false
  inline float_t get_scaledPixelsPerPoint();

  /// @brief Method get_schedule, addr 0x4a8afac, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualElementScheduler* get_schedule();

  /// @brief Method get_style, addr 0x4a7b774, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStyle* get_style();

  /// @brief Method get_styleAnimation, addr 0x4a7c25c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimations* get_styleAnimation();

  /// @brief Method get_styleInitialized, addr 0x4a7c250, size 0xc, virtual false, abstract: false, final false
  inline bool get_styleInitialized();

  /// @brief Method get_styleSheets, addr 0x4a8b198, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementStyleSheetSet get_styleSheets();

  /// @brief Method get_subRenderTargetMode, addr 0x4a86b74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_RenderTargetMode get_subRenderTargetMode();

  /// @brief Method get_tooltip, addr 0x4a83d24, size 0x94, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method get_transform, addr 0x4a7fa44, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITransform* get_transform();

  /// @brief Method get_typeData, addr 0x4a82c28, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_TypeData* get_typeData();

  /// @brief Method get_typeName, addr 0x4a82d54, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_usageHints, addr 0x4a7f95c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UsageHints get_usageHints();

  /// @brief Method get_userData, addr 0x4a7f2b8, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_userData();

  /// @brief Method get_viewDataKey, addr 0x4a7f20c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_viewDataKey();

  /// @brief Method get_visible, addr 0x4a7f7e8, size 0xac, virtual false, abstract: false, final false
  inline bool get_visible();

  /// @brief Method get_worldBound, addr 0x4a81498, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBound();

  /// @brief Method get_worldBoundingBox, addr 0x4a812d8, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBoundingBox();

  /// @brief Method get_worldClip, addr 0x4a81d60, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClip();

  /// @brief Method get_worldClipIsInfinite, addr 0x4a820a8, size 0x30, virtual false, abstract: false, final false
  inline bool get_worldClipIsInfinite();

  /// @brief Method get_worldClipMinusGroup, addr 0x4a8206c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClipMinusGroup();

  /// @brief Method get_worldTransform, addr 0x4a815fc, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_worldTransform();

  /// @brief Method get_worldTransformInverse, addr 0x4a81900, size 0x28, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Matrix4x4> get_worldTransformInverse();

  /// @brief Method get_worldTransformRef, addr 0x4a81474, size 0x24, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Matrix4x4> get_worldTransformRef();

  /// @brief Method get_yogaNode, addr 0x4a82d70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_containedPointerIds, addr 0x4a828a4, size 0x8, virtual false, abstract: false, final false
  inline void set_containedPointerIds(int32_t value);

  /// @brief Method set_disableClipping, addr 0x4a89924, size 0x30, virtual false, abstract: false, final false
  inline void set_disableClipping(bool value);

  /// @brief Method set_elementPanel, addr 0x4a8995c, size 0x8, virtual false, abstract: false, final false
  inline void set_elementPanel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method set_enableViewDataPersistence, addr 0x4a7f288, size 0x30, virtual false, abstract: false, final false
  inline void set_enableViewDataPersistence(bool value);

  /// @brief Method set_enabledSelf, addr 0x4a8571c, size 0xc, virtual false, abstract: false, final false
  inline void set_enabledSelf(bool value);

  /// @brief Method set_eventCallbackCategories, addr 0x4a896ac, size 0x74, virtual false, abstract: false, final false
  inline void set_eventCallbackCategories(int32_t value);

  /// @brief Method set_generateVisualContent, addr 0x4a859e8, size 0x8, virtual false, abstract: false, final false
  inline void set_generateVisualContent(::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* value);

  /// @brief Method set_hierarchy, addr 0x4a898fc, size 0x8, virtual false, abstract: false, final false
  inline void set_hierarchy(::UnityEngine::UIElements::VisualElement_Hierarchy value);

  /// @brief Method set_isBoundingBoxDirty, addr 0x4a81018, size 0x30, virtual false, abstract: false, final false
  inline void set_isBoundingBoxDirty(bool value);

  /// @brief Method set_isCompositeRoot, addr 0x4a7f0e4, size 0x3c, virtual false, abstract: false, final false
  inline void set_isCompositeRoot(bool value);

  /// @brief Method set_isEventCallbackParentCategoriesDirty, addr 0x4a89824, size 0x30, virtual false, abstract: false, final false
  inline void set_isEventCallbackParentCategoriesDirty(bool value);

  /// @brief Method set_isHierarchyDisplayed, addr 0x4a7f1dc, size 0x30, virtual false, abstract: false, final false
  inline void set_isHierarchyDisplayed(bool value);

  /// @brief Method set_isLayoutManual, addr 0x4a7fd14, size 0x30, virtual false, abstract: false, final false
  inline void set_isLayoutManual(bool value);

  /// @brief Method set_isRootVisualContainer, addr 0x4a8990c, size 0xc, virtual false, abstract: false, final false
  inline void set_isRootVisualContainer(bool value);

  /// @brief Method set_isWorldBoundingBoxDirty, addr 0x4a81048, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldBoundingBoxDirty(bool value);

  /// @brief Method set_isWorldClipDirty, addr 0x4a81d30, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldClipDirty(bool value);

  /// @brief Method set_isWorldTransformDirty, addr 0x4a8159c, size 0x20, virtual false, abstract: false, final false
  inline void set_isWorldTransformDirty(bool value);

  /// @brief Method set_isWorldTransformInverseDirty, addr 0x4a815bc, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldTransformInverseDirty(bool value);

  /// @brief Method set_layout, addr 0x4a7fe48, size 0x7e0, virtual false, abstract: false, final false
  inline void set_layout(::UnityEngine::Rect value);

  /// @brief Method set_localLanguageDirection, addr 0x4a857e8, size 0xf0, virtual false, abstract: false, final false
  inline void set_localLanguageDirection(::UnityEngine::UIElements::LanguageDirection value);

  /// @brief Method set_name, addr 0x4a82b00, size 0x58, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_pickingMode, addr 0x4a82ac0, size 0x38, virtual false, abstract: false, final false
  inline void set_pickingMode(::UnityEngine::UIElements::PickingMode value);

  /// @brief Method set_pseudoStates, addr 0x4a82818, size 0x84, virtual false, abstract: false, final false
  inline void set_pseudoStates(::UnityEngine::UIElements::PseudoStates value);

  /// @brief Method set_renderHints, addr 0x4a7f9e8, size 0x4c, virtual false, abstract: false, final false
  inline void set_renderHints(::UnityEngine::UIElements::RenderHints value);

  /// @brief Method set_requireMeasureFunction, addr 0x4a8618c, size 0x74, virtual false, abstract: false, final false
  inline void set_requireMeasureFunction(bool value);

  /// @brief Method set_styleInitialized, addr 0x4a82d90, size 0x30, virtual false, abstract: false, final false
  inline void set_styleInitialized(bool value);

  /// @brief Method set_tooltip, addr 0x4a8b3f0, size 0x124, virtual false, abstract: false, final false
  inline void set_tooltip(::StringW value);

  /// @brief Method set_usageHints, addr 0x4a7f984, size 0x64, virtual false, abstract: false, final false
  inline void set_usageHints(::UnityEngine::UIElements::UsageHints value);

  /// @brief Method set_userData, addr 0x4a7f418, size 0x70, virtual false, abstract: false, final false
  inline void set_userData(::System::Object* value);

  /// @brief Method set_viewDataKey, addr 0x4a7f214, size 0x68, virtual false, abstract: false, final false
  inline void set_viewDataKey(::StringW value);

  /// @brief Method set_visible, addr 0x4a858d8, size 0xe4, virtual false, abstract: false, final false
  inline void set_visible(bool value);

  /// @brief Method set_visualTreeAssetSource, addr 0x4a89968, size 0x8, virtual false, abstract: false, final false
  inline void set_visualTreeAssetSource(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method set_yogaNode, addr 0x4a82d78, size 0x8, virtual false, abstract: false, final false
