...
public:
  ...
  /// @brief Method set_element, addr 0x2db0340, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2db0348, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* handler);

  /// @brief Method StartingIn, addr 0x2db0418, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IVisualElementScheduledItem* StartingIn(int64_t delayMs);

  /// @brief Method Every, addr 0x2db0420, size 0xa4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IVisualElementScheduledItem* Every(int64_t intervalMs);

  /// @brief Method OnItemUnscheduled, addr 0x2db04c4, size 0x3c, virtual true, abstract: false, final false
  inline void OnItemUnscheduled();

  /// @brief Method Resume, addr 0x2da1a68, size 0x1c, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method Pause, addr 0x2db083c, size 0x1c, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method ExecuteLater, addr 0x2db0858, size 0x3c, virtual true, abstract: false, final true
  inline void ExecuteLater(int64_t delayMs);

  /// @brief Method OnPanelActivate, addr 0x2db0894, size 0xf0, virtual true, abstract: false, final true
  inline void OnPanelActivate();

  /// @brief Method OnPanelDeactivate, addr 0x2db0984, size 0xdc, virtual true, abstract: false, final true
  inline void OnPanelDeactivate();

  /// @brief Method CanBeActivated, addr 0x2db0a60, size 0x3c, virtual true, abstract: false, final true
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2323), inst: 404 }), TypeDefinitionIndex(TypeDefinitionIndex(2323)),
// TypeDefinitionIndex(TypeDefinitionIndex(6733)), TypeDefinitionIndex(TypeDefinitionIndex(6939)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6733), inst: 5351 })} Self:
...
public:
  ...
  /// @brief Method .ctor, addr 0x2da1a08, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformTimerUpdate, addr 0x2db0a9c, size 0x34, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2da1b30, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* handler, ::System::Action* updateEvent);

  /// @brief Method PerformTimerUpdate, addr 0x2db0ad0, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);
...
public:
  ...
  /// @brief Method get_focusable, addr 0x2db0b54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UxmlBoolAttributeDescription* get_focusable();

  /// @brief Method Init, addr 0x2db0b5c, size 0x288, virtual true, abstract: false, final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__VisualElement__UxmlTraits* New_ctor();

  /// @brief Method .ctor, addr 0x2db0de4, size 0x4d0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_parent, addr 0x2da4dcc, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method .ctor, addr 0x2da82d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Add, addr 0x2dab984, size 0x7c, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Insert, addr 0x2daba8c, size 0x31c, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Remove, addr 0x2daca00, size 0xf4, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method RemoveAt, addr 0x2db1424, size 0x244, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method Clear, addr 0x2dabe0c, size 0x344, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method BringToFront, addr 0x2dac680, size 0xb4, virtual false, abstract: false, final false
  inline void BringToFront(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method SendToBack, addr 0x2dac76c, size 0x98, virtual false, abstract: false, final false
  inline void SendToBack(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method PlaceBehind, addr 0x2dac8f0, size 0xd8, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* child, ::UnityEngine::UIElements::VisualElement* over);

  /// @brief Method MoveChildElement, addr 0x2db17c4, size 0x114, virtual false, abstract: false, final false
  inline void MoveChildElement(::UnityEngine::UIElements::VisualElement* child, int32_t currentIndex, int32_t nextIndex);

  /// @brief Method get_childCount, addr 0x2dac28c, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_Item, addr 0x2dac1c8, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method IndexOf, addr 0x2dac358, size 0x60, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method ElementAt, addr 0x2db18d8, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method SetParent, addr 0x2db13fc, size 0x28, virtual false, abstract: false, final false
  inline void SetParent(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method PutChildAtIndex, addr 0x2db12bc, size 0x140, virtual false, abstract: false, final false
  inline void PutChildAtIndex(::UnityEngine::UIElements::VisualElement* child, int32_t index);

  /// @brief Method RemoveChildAtIndex, addr 0x2db1668, size 0x7c, virtual false, abstract: false, final false
  inline void RemoveChildAtIndex(int32_t index);

  /// @brief Method ReleaseChildList, addr 0x2db16e4, size 0xe0, virtual false, abstract: false, final false
  inline void ReleaseChildList();

  /// @brief Method Equals, addr 0x2db18dc, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::UIElements::__VisualElement__Hierarchy other);

  /// @brief Method Equals, addr 0x2db18f8, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2db1970, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x2db18ec, size 0xc, virtual false, abstract: false, final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6739)), TypeDefinitionIndex(TypeDefinitionIndex(7396)), TypeDefinitionIndex(TypeDefinitionIndex(10159)),
// TypeDefinitionIndex(TypeDefinitionIndex(6821)), TypeDefinitionIndex(TypeDefinitionIndex(6865)), TypeDefinitionIndex(TypeDefinitionIndex(7296)), TypeDefinitionIndex(TypeDefinitionIndex(6822)),
// TypeDefinitionIndex(TypeDefinitionIndex(10165)), TypeDefinitionIndex(TypeDefinitionIndex(6823)), TypeDefinitionIndex(TypeDefinitionIndex(9966)), TypeDefinitionIndex(TypeDefinitionIndex(6741)),
// TypeDefinitionIndex(TypeDefinitionIndex(10245)), TypeDefinitionIndex(TypeDefinitionIndex(6880))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6744)) CS Name:
...
public:
  ...
  /// @brief Method get_tooltip, addr 0x2da1640, size 0x94, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method set_tooltip, addr 0x2da1754, size 0x10c, virtual false, abstract: false, final false
  inline void set_tooltip(::StringW value);

  /// @brief Method get_schedule, addr 0x2da1958, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualElementScheduler* get_schedule();

  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x2da195c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x2da1a84, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method get_hasRunningAnimations, addr 0x2da1b90, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasRunningAnimations();

  /// @brief Method get_hasCompletedAnimations, addr 0x2da1c40, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasCompletedAnimations();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_runningAnimationCount, addr 0x2da1cec, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_runningAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_runningAnimationCount, addr 0x2da1cf4, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_runningAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_completedAnimationCount, addr 0x2da1cfc, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_completedAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_completedAnimationCount, addr 0x2da1d04, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_completedAnimationCount(int32_t value);

  /// @brief Method GetStylePropertyAnimationSystem, addr 0x2da1d0c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* GetStylePropertyAnimationSystem();

  /// @brief Method get_styleAnimation, addr 0x2da1c3c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimations* get_styleAnimation();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da1d28, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da1e2c, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da1f48, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2178, size 0x150, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.StartEnum, addr 0x2da22c8, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da23e4, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da253c, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da266c, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2788, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2914, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2a44, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2c20, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x2da2da8, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAnimation, addr 0x2da2f84, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAllAnimations, addr 0x2da3054, size 0xe0, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_CancelAllAnimations();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.UpdateAnimation, addr 0x2da3134, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.GetAllAnimations, addr 0x2da31fc, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method TryConvertLengthUnits, addr 0x2da2080, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTransformOriginUnits, addr 0x2da2f58, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTranslateUnits, addr 0x2da2bf4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_positionWithLayout, addr 0x2da32e8, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionWithLayout();

  /// @brief Method GetPivotedMatrixWithLayout, addr 0x2da3628, size 0x1d0, virtual false, abstract: false, final false
  inline void GetPivotedMatrixWithLayout(ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method get_hasDefaultRotationAndScale, addr 0x2da3c28, size 0xd0, virtual false, abstract: false, final false
  inline bool get_hasDefaultRotationAndScale();

  /// @brief Method Min, addr 0x2da3d00, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Min(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method Max, addr 0x2da3d1c, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Max(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method TransformAlignedRectToParentSpace, addr 0x2da3d38, size 0x184, virtual false, abstract: false, final false
  inline void TransformAlignedRectToParentSpace(ByRef<::UnityEngine::Rect> rect);

  /// @brief Method CalculateConservativeRect, addr 0x2da3ebc, size 0x3d4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect CalculateConservativeRect(ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Rect rect);

  /// @brief Method TransformAlignedRect, addr 0x2da4364, size 0x94, virtual false, abstract: false, final false
  static inline void TransformAlignedRect(ByRef<::UnityEngine::Matrix4x4> matrix, ByRef<::UnityEngine::Rect> rect);

  /// @brief Method OrderMinMaxRect, addr 0x2da4290, size 0xd4, virtual false, abstract: false, final false
  static inline void OrderMinMaxRect(ByRef<::UnityEngine::Rect> rect);

  /// @brief Method MultiplyMatrix44Point2, addr 0x2da43f8, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MultiplyMatrix44Point2(ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector2 point);

  /// @brief Method MultiplyVector2, addr 0x2da441c, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MultiplyVector2(ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector2 vector);

  /// @brief Method MultiplyMatrix34, addr 0x2da4438, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateMatrix34, addr 0x2da4610, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateMatrix34InPlace, addr 0x2da46fc, size 0x5c, virtual false, abstract: false, final false
  static inline void TranslateMatrix34InPlace(ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector3 rhs);

  /// @brief Method get_isCompositeRoot, addr 0x2da4758, size 0xc, virtual false, abstract: false, final false
  inline bool get_isCompositeRoot();

  /// @brief Method set_isCompositeRoot, addr 0x2da4764, size 0x2c, virtual false, abstract: false, final false
  inline void set_isCompositeRoot(bool value);

  /// @brief Method get_isHierarchyDisplayed, addr 0x2da4790, size 0xc, virtual false, abstract: false, final false
  inline bool get_isHierarchyDisplayed();

  /// @brief Method set_isHierarchyDisplayed, addr 0x2da479c, size 0x2c, virtual false, abstract: false, final false
  inline void set_isHierarchyDisplayed(bool value);

  /// @brief Method get_viewDataKey, addr 0x2da47c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_viewDataKey();

  /// @brief Method set_viewDataKey, addr 0x2da47d0, size 0x68, virtual false, abstract: false, final false
  inline void set_viewDataKey(::StringW value);

  /// @brief Method get_enableViewDataPersistence, addr 0x2da4860, size 0xc, virtual false, abstract: false, final false
  inline bool get_enableViewDataPersistence();

  /// @brief Method set_enableViewDataPersistence, addr 0x2da486c, size 0x2c, virtual false, abstract: false, final false
  inline void set_enableViewDataPersistence(bool value);

  /// @brief Method get_userData, addr 0x2da4898, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_userData();

  /// @brief Method set_userData, addr 0x2da49f8, size 0x70, virtual false, abstract: false, final false
  inline void set_userData(::System::Object* value);

  /// @brief Method get_canGrabFocus, addr 0x2da4cbc, size 0x110, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method get_focusController, addr 0x2da4eb0, size 0xb0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_usageHints, addr 0x2da4f68, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UsageHints get_usageHints();

  /// @brief Method set_usageHints, addr 0x2da4f94, size 0x84, virtual false, abstract: false, final false
  inline void set_usageHints(::UnityEngine::UIElements::UsageHints value);

  /// @brief Method get_renderHints, addr 0x2da4f8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RenderHints get_renderHints();

  /// @brief Method set_renderHints, addr 0x2da5018, size 0x4c, virtual false, abstract: false, final false
  inline void set_renderHints(::UnityEngine::UIElements::RenderHints value);

  /// @brief Method MarkRenderHintsClean, addr 0x2da5064, size 0x10, virtual false, abstract: false, final false
  inline void MarkRenderHintsClean();

  /// @brief Method get_transform, addr 0x2da5074, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITransform* get_transform();

  /// @brief Method UnityEngine.UIElements.ITransform.get_position, addr 0x2da5078, size 0xa0, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_position();

  /// @brief Method UnityEngine.UIElements.ITransform.set_position, addr 0x2da5118, size 0x16c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITransform_set_position(::UnityEngine::Vector3 value);

  /// @brief Method UnityEngine.UIElements.ITransform.get_scale, addr 0x2da52f4, size 0xb4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_scale();

  /// @brief Method get_isLayoutManual, addr 0x2da53a8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isLayoutManual();

  /// @brief Method set_isLayoutManual, addr 0x2da53b4, size 0x2c, virtual false, abstract: false, final false
  inline void set_isLayoutManual(bool value);

  /// @brief Method get_scaledPixelsPerPoint, addr 0x2da53e0, size 0x14, virtual false, abstract: false, final false
  inline float_t get_scaledPixelsPerPoint();

  /// @brief Method get_layout, addr 0x2da3580, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_layout();

  /// @brief Method set_layout, addr 0x2da53f4, size 0x8d0, virtual false, abstract: false, final false
  inline void set_layout(::UnityEngine::Rect value);

  /// @brief Method get_contentRect, addr 0x2da5cc4, size 0x214, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_contentRect();

  /// @brief Method get_paddingRect, addr 0x2da5ed8, size 0x214, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_paddingRect();

  /// @brief Method get_isBoundingBoxDirty, addr 0x2da6158, size 0xc, virtual false, abstract: false, final false
  inline bool get_isBoundingBoxDirty();

  /// @brief Method set_isBoundingBoxDirty, addr 0x2da6164, size 0x2c, virtual false, abstract: false, final false
  inline void set_isBoundingBoxDirty(bool value);

  /// @brief Method get_isWorldBoundingBoxDirty, addr 0x2da6190, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldBoundingBoxDirty();

  /// @brief Method set_isWorldBoundingBoxDirty, addr 0x2da619c, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldBoundingBoxDirty(bool value);

  /// @brief Method get_boundingBox, addr 0x2da61c8, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBox();

  /// @brief Method get_worldBoundingBox, addr 0x2da65b0, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBoundingBox();

  /// @brief Method get_boundingBoxInParentSpace, addr 0x2da66ec, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBoxInParentSpace();

  /// @brief Method UpdateBoundingBox, addr 0x2da6204, size 0x3ac, virtual false, abstract: false, final false
  inline void UpdateBoundingBox();

  /// @brief Method UpdateWorldBoundingBox, addr 0x2da65f0, size 0xfc, virtual false, abstract: false, final false
  inline void UpdateWorldBoundingBox();

  /// @brief Method get_worldBound, addr 0x2da68d0, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBound();

  /// @brief Method get_localBound, addr 0x2da69a0, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_localBound();

  /// @brief Method get_rect, addr 0x2da60ec, size 0x6c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_isWorldTransformDirty, addr 0x2da6b34, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformDirty();

  /// @brief Method set_isWorldTransformDirty, addr 0x2da6b40, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldTransformDirty(bool value);

  /// @brief Method get_isWorldTransformInverseDirty, addr 0x2da6b6c, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformInverseDirty();

  /// @brief Method set_isWorldTransformInverseDirty, addr 0x2da6b78, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldTransformInverseDirty(bool value);

  /// @brief Method get_worldTransform, addr 0x2da6ba4, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_worldTransform();

  /// @brief Method get_worldTransformRef, addr 0x2da68ac, size 0x24, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::Matrix4x4> get_worldTransformRef();

  /// @brief Method get_worldTransformInverse, addr 0x2da6e88, size 0x28, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::Matrix4x4> get_worldTransformInverse();

  /// @brief Method UpdateWorldTransform, addr 0x2da6be4, size 0x2a4, virtual false, abstract: false, final false
  inline void UpdateWorldTransform();

  /// @brief Method UpdateWorldTransformInverse, addr 0x2da6eb0, size 0x58, virtual false, abstract: false, final false
  inline void UpdateWorldTransformInverse();

  /// @brief Method get_isWorldClipDirty, addr 0x2da6f08, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldClipDirty();

  /// @brief Method set_isWorldClipDirty, addr 0x2da6f14, size 0x2c, virtual false, abstract: false, final false
  inline void set_isWorldClipDirty(bool value);

  /// @brief Method get_worldClip, addr 0x2da6f40, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClip();

  /// @brief Method get_worldClipMinusGroup, addr 0x2da71fc, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClipMinusGroup();

  /// @brief Method get_worldClipIsInfinite, addr 0x2da7238, size 0x30, virtual false, abstract: false, final false
  inline bool get_worldClipIsInfinite();

  /// @brief Method EnsureWorldTransformAndClipUpToDate, addr 0x2da7268, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureWorldTransformAndClipUpToDate();

  /// @brief Method UpdateWorldClip, addr 0x2da6f7c, size 0x280, virtual false, abstract: false, final false
  inline void UpdateWorldClip();

  /// @brief Method CombineClipRects, addr 0x2da78e0, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect CombineClipRects(::UnityEngine::Rect rect, ::UnityEngine::Rect parentRect);

  /// @brief Method SubstractBorderPadding, addr 0x2da72a4, size 0x63c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect SubstractBorderPadding(::UnityEngine::Rect worldRect);

  /// @brief Method ComputeAAAlignedBound, addr 0x2da79d8, size 0x1d0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeAAAlignedBound(::UnityEngine::Rect position, ::UnityEngine::Matrix4x4 mat);

  /// @brief Method get_pseudoStates, addr 0x2da7ba8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PseudoStates get_pseudoStates();

  /// @brief Method set_pseudoStates, addr 0x2da7bb0, size 0x84, virtual false, abstract: false, final false
  inline void set_pseudoStates(::UnityEngine::UIElements::PseudoStates value);

  /// @brief Method get_containedPointerIds, addr 0x2da7c34, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_containedPointerIds();

  /// @brief Method set_containedPointerIds, addr 0x2da7c3c, size 0x8, virtual false, abstract: false, final false
  inline void set_containedPointerIds(int32_t value);

  /// @brief Method UpdateHoverPseudoState, addr 0x2da7c44, size 0xcc, virtual false, abstract: false, final false
  inline void UpdateHoverPseudoState();

  /// @brief Method get_pickingMode, addr 0x2da7d10, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PickingMode get_pickingMode();

  /// @brief Method set_pickingMode, addr 0x2da7d18, size 0x8, virtual false, abstract: false, final false
  inline void set_pickingMode(::UnityEngine::UIElements::PickingMode value);

  /// @brief Method get_name, addr 0x2da7d20, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x2da7d28, size 0x58, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method get_fullTypeName, addr 0x2da7d80, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_typeName, addr 0x2da7f0c, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_yogaNode, addr 0x2da7fbc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Yoga::YogaNode* get_yogaNode();

  /// @brief Method set_yogaNode, addr 0x2da7fc4, size 0x8, virtual false, abstract: false, final false
  inline void set_yogaNode(::UnityEngine::Yoga::YogaNode* value);

  /// @brief Method get_computedStyle, addr 0x2da3cf8, size 0x8, virtual false, abstract: false, final false
  inline ByRef<::UnityEngine::UIElements::ComputedStyle> get_computedStyle();

  /// @brief Method get_hasInlineStyle, addr 0x2da7fcc, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasInlineStyle();

  /// @brief Method get_styleInitialized, addr 0x2da7fdc, size 0xc, virtual false, abstract: false, final false
  inline bool get_styleInitialized();

  /// @brief Method set_styleInitialized, addr 0x2da7fe8, size 0x2c, virtual false, abstract: false, final false
  inline void set_styleInitialized(bool value);

  /// @brief Method ChangeIMGUIContainerCount, addr 0x2da8014, size 0x30, virtual false, abstract: false, final false
  inline void ChangeIMGUIContainerCount(int32_t delta);

  static inline ::UnityEngine::UIElements::VisualElement* New_ctor();

  /// @brief Method .ctor, addr 0x2da8044, size 0x28c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ExecuteDefaultAction, addr 0x2da82fc, size 0x6a8, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method GetTooltipRect, addr 0x2da8d08, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::Rect GetTooltipRect();

  /// @brief Method SetTooltip, addr 0x2da8c2c, size 0xdc, virtual false, abstract: false, final false
  inline void SetTooltip(::UnityEngine::UIElements::TooltipEvent* e);

  /// @brief Method Focus, addr 0x2da8d0c, size 0x54, virtual true, abstract: false, final true
  inline void Focus();

  /// @brief Method SetPanel, addr 0x2da8d60, size 0x994, virtual false, abstract: false, final false
  inline void SetPanel(::UnityEngine::UIElements::BaseVisualElementPanel* p);

  /// @brief Method WillChangePanel, addr 0x2da97cc, size 0x1dc, virtual false, abstract: false, final false
  inline void WillChangePanel(::UnityEngine::UIElements::BaseVisualElementPanel* destinationPanel);

  /// @brief Method HasChangedPanel, addr 0x2da99a8, size 0x2bc, virtual false, abstract: false, final false
  inline void HasChangedPanel(::UnityEngine::UIElements::BaseVisualElementPanel* prevPanel);

  /// @brief Method SendEvent, addr 0x2da9da0, size 0x18, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e);

  /// @brief Method SendEvent, addr 0x2da9db8, size 0x14, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method IncrementVersion, addr 0x2da4838, size 0x28, virtual false, abstract: false, final false
  inline void IncrementVersion(::UnityEngine::UIElements::VersionChangeType changeType);

  /// @brief Method InvokeHierarchyChanged, addr 0x2da9dcc, size 0x20, virtual false, abstract: false, final false
  inline void InvokeHierarchyChanged(::UnityEngine::UIElements::HierarchyChangeType changeType);

  /// @brief Method SetEnabledFromHierarchyPrivate, addr 0x2da9dec, size 0x37c, virtual false, abstract: false, final false
  inline bool SetEnabledFromHierarchyPrivate(bool state);

  /// @brief Method get_isParentEnabledInHierarchy, addr 0x2daa168, size 0x34, virtual false, abstract: false, final false
  inline bool get_isParentEnabledInHierarchy();

  /// @brief Method get_enabledInHierarchy, addr 0x2da4ea0, size 0x10, virtual false, abstract: false, final false
  inline bool get_enabledInHierarchy();

  /// @brief Method get_enabledSelf, addr 0x2daa4d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabledSelf();

  /// @brief Method set_enabledSelf, addr 0x2daa4e0, size 0xc, virtual false, abstract: false, final false
  inline void set_enabledSelf(bool value);

  /// @brief Method SetEnabled, addr 0x2da82d8, size 0x24, virtual false, abstract: false, final false
  inline void SetEnabled(bool value);

  /// @brief Method PropagateEnabledToChildren, addr 0x2daa4ec, size 0xb0, virtual false, abstract: false, final false
  inline void PropagateEnabledToChildren(bool value);

  /// @brief Method get_visible, addr 0x2da4df0, size 0xac, virtual false, abstract: false, final false
  inline bool get_visible();

  /// @brief Method set_visible, addr 0x2daa59c, size 0xe4, virtual false, abstract: false, final false
  inline void set_visible(bool value);

  /// @brief Method MarkDirtyRepaint, addr 0x2daa680, size 0x24, virtual false, abstract: false, final false
  inline void MarkDirtyRepaint();

  /// @brief Method get_generateVisualContent, addr 0x2daa6a4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* get_generateVisualContent();

  /// @brief Method set_generateVisualContent, addr 0x2daa6ac, size 0x8, virtual false, abstract: false, final false
  inline void set_generateVisualContent(::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* value);

  /// @brief Method InvokeGenerateVisualContent, addr 0x2daa6b4, size 0x234, virtual false, abstract: false, final false
  inline void InvokeGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x2daa8e8, size 0x94, virtual false, abstract: false, final false
  inline void GetFullHierarchicalViewDataKey(::System::Text::StringBuilder* key);

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x2daa97c, size 0x74, virtual false, abstract: false, final false
  inline ::StringW GetFullHierarchicalViewDataKey();

  /// @brief Method OverwriteFromViewData, addr 0x2daa9f0, size 0x320, virtual false, abstract: false, final false
  inline void OverwriteFromViewData(::System::Object* obj, ::StringW key);

  /// @brief Method SaveViewData, addr 0x2daad10, size 0x7c, virtual false, abstract: false, final false
  inline void SaveViewData();

  /// @brief Method IsViewDataPersitenceSupportedOnChildren, addr 0x2daad8c, size 0x74, virtual false, abstract: false, final false
  inline bool IsViewDataPersitenceSupportedOnChildren(bool existingState);

  /// @brief Method OnViewDataReady, addr 0x2daae00, size 0x38, virtual false, abstract: false, final false
  inline void OnViewDataReady(bool enablePersistence);

  /// @brief Method OnViewDataReady, addr 0x2daae38, size 0x4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method ContainsPoint, addr 0x2daae3c, size 0x48, virtual true, abstract: false, final false
  inline bool ContainsPoint(::UnityEngine::Vector2 localPoint);

  /// @brief Method get_requireMeasureFunction, addr 0x2daae84, size 0xc, virtual false, abstract: false, final false
  inline bool get_requireMeasureFunction();

  /// @brief Method set_requireMeasureFunction, addr 0x2daae90, size 0x70, virtual false, abstract: false, final false
  inline void set_requireMeasureFunction(bool value);

  /// @brief Method AssignMeasureFunction, addr 0x2daaf00, size 0x8c, virtual false, abstract: false, final false
  inline void AssignMeasureFunction();

  /// @brief Method RemoveMeasureFunction, addr 0x2daaf8c, size 0x20, virtual false, abstract: false, final false
  inline void RemoveMeasureFunction();

  /// @brief Method DoMeasure, addr 0x2daafac, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method Measure, addr 0x2daafbc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method FinalizeLayout, addr 0x2dab0e4, size 0x4c, virtual false, abstract: false, final false
  inline void FinalizeLayout();

  /// @brief Method SetInlineRule, addr 0x2dab130, size 0x90, virtual false, abstract: false, final false
  inline void SetInlineRule(::UnityEngine::UIElements::StyleSheet* sheet, ::UnityEngine::UIElements::StyleRule* rule);

  /// @brief Method SetComputedStyle, addr 0x2dab1c0, size 0x1cc, virtual false, abstract: false, final false
  inline void SetComputedStyle(ByRef<::UnityEngine::UIElements::ComputedStyle> newStyle);

  /// @brief Method ToString, addr 0x2dab38c, size 0x234, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method GetClassesForIteration, addr 0x2dab5c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* GetClassesForIteration();

  /// @brief Method AddToClassList, addr 0x2daa2c4, size 0x208, virtual false, abstract: false, final false
  inline void AddToClassList(::StringW className);

  /// @brief Method RemoveFromClassList, addr 0x2daa19c, size 0x128, virtual false, abstract: false, final false
  inline void RemoveFromClassList(::StringW className);

  /// @brief Method EnableInClassList, addr 0x2daa4cc, size 0xc, virtual false, abstract: false, final false
  inline void EnableInClassList(::StringW className, bool enable);

  /// @brief Method ClassListContains, addr 0x2dab5c8, size 0xa8, virtual false, abstract: false, final false
  inline bool ClassListContains(::StringW cls);

  /// @brief Method GetProperty, addr 0x2da16d4, size 0x80, virtual false, abstract: false, final false
  inline ::System::Object* GetProperty(::UnityEngine::PropertyName key);

  /// @brief Method SetProperty, addr 0x2da18e0, size 0x78, virtual false, abstract: false, final false
  inline void SetProperty(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method HasProperty, addr 0x2da1860, size 0x80, virtual false, abstract: false, final false
  inline bool HasProperty(::UnityEngine::PropertyName key);

  /// @brief Method TryGetPropertyInternal, addr 0x2da4910, size 0xe8, virtual false, abstract: false, final false
  inline bool TryGetPropertyInternal(::UnityEngine::PropertyName key, ByRef<::System::Object*> value);

  /// @brief Method CheckUserKeyArgument, addr 0x2dab670, size 0x168, virtual false, abstract: false, final false
  static inline void CheckUserKeyArgument(::UnityEngine::PropertyName key);

  /// @brief Method SetPropertyInternal, addr 0x2da4a68, size 0x254, virtual false, abstract: false, final false
  inline void SetPropertyInternal(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method UpdateCursorStyle, addr 0x2da89a4, size 0x288, virtual false, abstract: false, final false
  inline void UpdateCursorStyle(int64_t eventType);

  /// @brief Method get_subRenderTargetMode, addr 0x2dab7d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_experimental, addr 0x2dab854, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IExperimentalFeatures* get_experimental();

  /// @brief Method UnityEngine.UIElements.IExperimentalFeatures.get_animation, addr 0x2dab858, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_hierarchy, addr 0x2dab85c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__VisualElement__Hierarchy get_hierarchy();

  /// @brief Method set_hierarchy, addr 0x2dab864, size 0x8, virtual false, abstract: false, final false
  inline void set_hierarchy(::UnityEngine::UIElements::__VisualElement__Hierarchy value);

  /// @brief Method get_isRootVisualContainer, addr 0x2dab86c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isRootVisualContainer();

  /// @brief Method set_isRootVisualContainer, addr 0x2dab874, size 0xc, virtual false, abstract: false, final false
  inline void set_isRootVisualContainer(bool value);

  /// @brief Method get_disableClipping, addr 0x2dab880, size 0xc, virtual false, abstract: false, final false
  inline bool get_disableClipping();

  /// @brief Method set_disableClipping, addr 0x2dab88c, size 0x2c, virtual false, abstract: false, final false
  inline void set_disableClipping(bool value);

  /// @brief Method ShouldClip, addr 0x2da6880, size 0x2c, virtual false, abstract: false, final false
  inline bool ShouldClip();

  /// @brief Method get_parent, addr 0x2da4de8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method get_elementPanel, addr 0x2dab8b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_elementPanel();

  /// @brief Method set_elementPanel, addr 0x2dab8c0, size 0x8, virtual false, abstract: false, final false
  inline void set_elementPanel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method get_panel, addr 0x2da4f60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_panel();

  /// @brief Method get_contentContainer, addr 0x2dab8c8, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method set_visualTreeAssetSource, addr 0x2dab8cc, size 0x8, virtual false, abstract: false, final false
  inline void set_visualTreeAssetSource(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method Add, addr 0x2dab8d4, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Insert, addr 0x2daba00, size 0x8c, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Clear, addr 0x2dabda8, size 0x64, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ElementAt, addr 0x2dac150, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method get_Item, addr 0x2dac154, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_childCount, addr 0x2dac228, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method IndexOf, addr 0x2dac2dc, size 0x7c, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method ElementAtTreePath, addr 0x2dac3b8, size 0x1a8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAtTreePath(::System::Collections::Generic::List_1<int32_t>* childIndexes);

  /// @brief Method FindElementInTree, addr 0x2dac560, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method BringToFront, addr 0x2dac648, size 0x38, virtual false, abstract: false, final false
  inline void BringToFront();

  /// @brief Method SendToBack, addr 0x2dac734, size 0x38, virtual false, abstract: false, final false
  inline void SendToBack();

  /// @brief Method PlaceBehind, addr 0x2dac804, size 0xec, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* sibling);

  /// @brief Method RemoveFromHierarchy, addr 0x2dac9c8, size 0x38, virtual false, abstract: false, final false
  inline void RemoveFromHierarchy();

  /// @brief Method Contains, addr 0x2dacaf4, size 0x34, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method GatherAllChildren, addr 0x2da96f4, size 0xd8, virtual false, abstract: false, final false
  inline void GatherAllChildren(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* elements);

  /// @brief Method FindCommonAncestor, addr 0x2dacb28, size 0x118, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* FindCommonAncestor(::UnityEngine::UIElements::VisualElement* other);

  /// @brief Method GetRoot, addr 0x2dacc40, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRoot();

  /// @brief Method GetRootVisualContainer, addr 0x2dacd00, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRootVisualContainer();

  /// @brief Method GetNextElementDepthFirst, addr 0x2dacd38, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetNextElementDepthFirst();

  /// @brief Method GetPreviousElementDepthFirst, addr 0x2dace28, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetPreviousElementDepthFirst();

  /// @brief Method RetargetElement, addr 0x2dacf10, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* RetargetElement(::UnityEngine::UIElements::VisualElement* retargetAgainst);

  /// @brief Method get_style, addr 0x2da5284, size 0x70, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStyle* get_style();

  /// @brief Method get_customStyle, addr 0x2dacf74, size 0x74, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICustomStyle* get_customStyle();

  /// @brief Method get_styleSheets, addr 0x2dacff4, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementStyleSheetSet get_styleSheets();

  /// @brief Method AddStyleSheetPath, addr 0x2dad018, size 0x234, virtual false, abstract: false, final false
  inline void AddStyleSheetPath(::StringW sheetPath);

  /// @brief Method ResolveLengthValue, addr 0x2dad24c, size 0x190, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat ResolveLengthValue(::UnityEngine::UIElements::Length length, bool isRow);

  /// @brief Method ResolveTranslate, addr 0x2da334c, size 0x234, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTranslate();

  /// @brief Method ResolveTransformOrigin, addr 0x2da37f8, size 0x3c0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTransformOrigin();

  /// @brief Method ResolveRotation, addr 0x2da3bb8, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion ResolveRotation();

  /// @brief Method ResolveScale, addr 0x2da3c00, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveScale();

  /// @brief Method GetAnimationSystem, addr 0x2dad3dc, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementAnimationSystem* GetAnimationSystem();

  /// @brief Method RegisterAnimation, addr 0x2dad470, size 0x10c, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterAnimation, addr 0x2dad57c, size 0x78, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterRunningAnimations, addr 0x2da9c64, size 0xd0, virtual false, abstract: false, final false
  inline void UnregisterRunningAnimations();

  /// @brief Method RegisterRunningAnimations, addr 0x2da9d34, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignStyleValues, addr 0x2dad5f4, size 0x15e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCurrentValues, addr 0x2daebd4, size 0xee4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnityEngine.UIElements.Experimental.ITransitionAnimations.Start, addr 0x2dafab8, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method Start, addr 0x2dafb88, size 0x184, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*
  ...
  /// @brief Method get_resolvedStyle, addr 0x2da4e9c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IResolvedStyle* get_resolvedStyle();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_backgroundColor, addr 0x2dafd0c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_backgroundColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomColor, addr 0x2dafd18, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderBottomColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomLeftRadius, addr 0x2dafd24, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomRightRadius, addr 0x2dafd40, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomWidth, addr 0x2dafd5c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftColor, addr 0x2dafd78, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderLeftColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftWidth, addr 0x2dafd84, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderLeftWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightColor, addr 0x2dafda0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderRightColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightWidth, addr 0x2dafdac, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderRightWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopColor, addr 0x2dafdc8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderTopColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopLeftRadius, addr 0x2dafdd4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopRightRadius, addr 0x2dafdf0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopWidth, addr 0x2dafe0c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_bottom, addr 0x2dafe28, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_bottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_color, addr 0x2dafe44, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_color();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_display, addr 0x2dafe50, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DisplayStyle UnityEngine_UIElements_IResolvedStyle_get_display();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexGrow, addr 0x2dafe5c, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexGrow();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexShrink, addr 0x2dafe68, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexShrink();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_height, addr 0x2dafe74, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_height();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_left, addr 0x2dafe90, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_left();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginBottom, addr 0x2dafeac, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginLeft, addr 0x2dafec8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginRight, addr 0x2dafee4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginTop, addr 0x2daff00, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minHeight, addr 0x2daff1c, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minHeight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minWidth, addr 0x2daff44, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_opacity, addr 0x2daff6c, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_opacity();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingBottom, addr 0x2daff78, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingLeft, addr 0x2daff94, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingRight, addr 0x2daffb0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingTop, addr 0x2daffcc, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_right, addr 0x2daffe8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_right();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_scale, addr 0x2db0004, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Scale UnityEngine_UIElements_IResolvedStyle_get_scale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_top, addr 0x2db0010, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_top();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_transformOrigin, addr 0x2db002c, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_transformOrigin();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_translate, addr 0x2db0030, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_translate();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityBackgroundImageTintColor, addr 0x2db0034, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityBackgroundImageTintColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceLeft, addr 0x2db0040, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceRight, addr 0x2db004c, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineColor, addr 0x2db0058, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineWidth, addr 0x2db0064, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_visibility, addr 0x2db0070, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Visibility UnityEngine_UIElements_IResolvedStyle_get_visibility();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_whiteSpace, addr 0x2db007c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::WhiteSpace UnityEngine_UIElements_IResolvedStyle_get_whiteSpace();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_width, addr 0x2db0088, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_width();

  /// @brief Method <AssignMeasureFunction>b__281_0, addr 0x2db0334, size 0x4, virtual false, abstract: false, final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5288 }), TypeDefinitionIndex(TypeDefinitionIndex(6997)),
// TypeDefinitionIndex(TypeDefinitionIndex(6737)), TypeDefinitionIndex(TypeDefinitionIndex(6744))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6736)) CS Name: ::VisualElement::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2db0b04, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2dab7e8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_fullTypeName, addr 0x2da7ec4, size 0x48, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_typeName, addr 0x2da7f24, size 0x98, virtual false, abstract: false, final false
  inline ::StringW get_typeName();
...
public:
  ...
  /// @brief Method TryGetValue, addr 0x2db1988, size 0x9c, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<float_t> property, ByRef<float_t> value);

  /// @brief Method TryGetValue, addr 0x2db1adc, size 0xc0, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<int32_t> property, ByRef<int32_t> value);

  /// @brief Method TryGetValue, addr 0x2db1b9c, size 0x14c, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x2db1a24, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method LogCustomPropertyWarning, addr 0x2db1ce8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2db032c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2dafb80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <UnityEngine.UIElements.Experimental.ITransitionAnimations.Start>b__0, addr 0x2db21b0, size 0x1c, virtual false, abstract: false, final false
