...
public:
  ...
  /// @brief Method .ctor, addr 0x4a7960c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x4a79664, size 0x294, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a798f8, size 0x44c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_focusIndex, addr 0x4a79654, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UxmlIntAttributeDescription* get_focusIndex();

  /// @brief Method get_focusable, addr 0x4a7965c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x4a79d84, size 0x78, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method BringToFront, addr 0x4a7aa48, size 0xb4, virtual false, abstract: false, final false
  inline void BringToFront(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method Children, addr 0x4a7ae10, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::VisualElement*>* Children();

  /// @brief Method Clear, addr 0x4a7a72c, size 0x31c, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ElementAt, addr 0x4a7ae0c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method Equals, addr 0x4a7ae48, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4a7ae2c, size 0x10, virtual false, abstract: false, final false
  inline bool Equals(::UnityEngine::UIElements::VisualElement_Hierarchy other);

  /// @brief Method GetHashCode, addr 0x4a7aec0, size 0x18, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x4a7adac, size 0x60, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x4a79e4c, size 0x2f0, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method MoveChildElement, addr 0x4a7aafc, size 0xe0, virtual false, abstract: false, final false
  inline void MoveChildElement(::UnityEngine::UIElements::VisualElement* child, int32_t currentIndex, int32_t nextIndex);

  /// @brief Method PlaceBehind, addr 0x4a7ac74, size 0xd8, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* child, ::UnityEngine::UIElements::VisualElement* over);

  /// @brief Method PutChildAtIndex, addr 0x4a7a13c, size 0x13c, virtual false, abstract: false, final false
  inline void PutChildAtIndex(::UnityEngine::UIElements::VisualElement* child, int32_t index);

  /// @brief Method ReleaseChildList, addr 0x4a7a64c, size 0xe0, virtual false, abstract: false, final false
  inline void ReleaseChildList();

  /// @brief Method Remove, addr 0x4a7a2cc, size 0xec, virtual false, abstract: false, final false
  inline void Remove(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method RemoveAt, addr 0x4a7a3b8, size 0x218, virtual false, abstract: false, final false
  inline void RemoveAt(int32_t index);

  /// @brief Method RemoveChildAtIndex, addr 0x4a7a5d0, size 0x7c, virtual false, abstract: false, final false
  inline void RemoveChildAtIndex(int32_t index);

  /// @brief Method SendToBack, addr 0x4a7abdc, size 0x98, virtual false, abstract: false, final false
  inline void SendToBack(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method SetParent, addr 0x4a7a278, size 0x54, virtual false, abstract: false, final false
  inline void SetParent(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method .ctor, addr 0x4a79d7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method get_Item, addr 0x4a7ad4c, size 0x60, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_childCount, addr 0x4a79dfc, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_children, addr 0x4a79d60, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* get_children();

  /// @brief Method get_parent, addr 0x4a79d44, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method op_Equality, addr 0x4a7ae3c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CanBeActivated, addr 0x4a7b2bc, size 0x3c, virtual true, abstract: false, final true
  inline bool CanBeActivated();

  /// @brief Method Every, addr 0x4a7af90, size 0xa4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IVisualElementScheduledItem* Every(int64_t intervalMs);

  /// @brief Method ExecuteLater, addr 0x4a7b0b4, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnItemUnscheduled, addr 0x4a7b034, size 0x40, virtual true, abstract: false, final false
  inline void OnItemUnscheduled();

  /// @brief Method OnPanelActivate, addr 0x4a7b0f0, size 0xf0, virtual true, abstract: false, final true
  inline void OnPanelActivate();

  /// @brief Method OnPanelDeactivate, addr 0x4a7b1e0, size 0xdc, virtual true, abstract: false, final true
  inline void OnPanelDeactivate();

  /// @brief Method Pause, addr 0x4a7b094, size 0x20, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x4a7b074, size 0x20, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method StartingIn, addr 0x4a7af88, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4a7aee8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::VisualElement* handler);

  /// @brief Method get_element, addr 0x4a7aed8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_element, addr 0x4a7aee0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x4a7b358, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x4a7b2f8, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method PerformTimerUpdate, addr 0x4a7b3ec, size 0x34, virtual true, abstract: false, final false
  inline void PerformTimerUpdate(::UnityEngine::UIElements::TimerState state);

  /// @brief Method .ctor, addr 0x4a7b38c, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method LogCustomPropertyWarning, addr 0x4a7b880, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContext, addr 0x4a7b420, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetValue, addr 0x4a7bc84, size 0xc4, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<::StringW> property, ::ByRef<::StringW> value);

  /// @brief Method TryGetValue, addr 0x4a7b6dc, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a7ba74, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a7b96c, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a7bb7c, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method TryGetValue, addr 0x4a7b42c, size 0x98, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<float_t> property, ::ByRef<float_t> value);

  /// @brief Method TryGetValue, addr 0x4a7b620, size 0xbc, virtual true, abstract: false, final true
  inline bool TryGetValue(::UnityEngine::UIElements::CustomStyleProperty_1<int32_t> property, ::ByRef<int32_t> value);

  /// @brief Method TryGetValue, addr 0x4a7b4c4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a7bd48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4a7bd58, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* type);

  /// @brief Method get_fullTypeName, addr 0x4a7bdc8, size 0x48, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_type, addr 0x4a7bd50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_type();

  /// @brief Method get_typeName, addr 0x4a7be10, size 0x98, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_typeNamespace, addr 0x4a7bea8, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UnityEngine.UIElements.Experimental.ITransitionAnimations.Start>b__0, addr 0x4a7bef8, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x4a77550, size 0xb0, virtual false, abstract: false, final false
  inline void Add(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method AddStyleSheetPath, addr 0x4a78d9c, size 0x234, virtual false, abstract: false, final false
  inline void AddStyleSheetPath(::StringW sheetPath);

  /// @brief Method AddToClassList, addr 0x4a730d8, size 0x210, virtual false, abstract: false, final false
  inline void AddToClassList(::StringW className);

  /// @brief Method AssignMeasureFunction, addr 0x4a73de0, size 0x90, virtual false, abstract: false, final false
  inline void AssignMeasureFunction();

  /// @brief Method AssignStyleValues, addr 0x4a74978, size 0x15f4, virtual false, abstract: false, final false
  ...
  /// @brief Method BringToFront, addr 0x4a77bc0, size 0x64, virtual false, abstract: false, final false
  inline void BringToFront();

  /// @brief Method CalculateConservativeRect, addr 0x4a78700, size 0x22c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect CalculateConservativeRect(::ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Rect rect);

  /// @brief Method ChangeIMGUIContainerCount, addr 0x4a709a0, size 0x40, virtual false, abstract: false, final false
  inline void ChangeIMGUIContainerCount(int32_t delta);

  /// @brief Method CheckUserKeyArgument, addr 0x4a74500, size 0x15c, virtual false, abstract: false, final false
  static inline void CheckUserKeyArgument(::UnityEngine::PropertyName key);

  /// @brief Method Children, addr 0x4a77b0c, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::VisualElement*>* Children();

  /// @brief Method ClassListContains, addr 0x4a743d4, size 0xac, virtual false, abstract: false, final false
  inline bool ClassListContains(::StringW cls);

  /// @brief Method Clear, addr 0x4a77690, size 0x68, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearManualLayout, addr 0x4a6e208, size 0x5c4, virtual false, abstract: false, final false
  inline void ClearManualLayout();

  /// @brief Method CombineClipRects, addr 0x4a70294, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect CombineClipRects(::UnityEngine::Rect rect, ::UnityEngine::Rect parentRect);

  /// @brief Method ComputeAAAlignedBound, addr 0x4a702dc, size 0x114, virtual false, abstract: false, final false
  static inline ::UnityEngine::Rect ComputeAAAlignedBound(::UnityEngine::Rect position, ::UnityEngine::Matrix4x4 mat);

  /// @brief Method Contains, addr 0x4a70628, size 0x70, virtual false, abstract: false, final false
  inline bool Contains(::UnityEngine::UIElements::VisualElement* child);

  /// @brief Method ContainsPoint, addr 0x4a73d0c, size 0x54, virtual true, abstract: false, final false
  inline bool ContainsPoint(::UnityEngine::Vector2 localPoint);

  /// @brief Method DirtyNextParentWithEventCallback, addr 0x4a770b8, size 0x80, virtual false, abstract: false, final false
  inline void DirtyNextParentWithEventCallback();

  /// @brief Method DoMeasure, addr 0x4a73e90, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method ElementAt, addr 0x4a776f8, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAt(int32_t index);

  /// @brief Method ElementAtTreePath, addr 0x4a7785c, size 0x1b0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* ElementAtTreePath(::System::Collections::Generic::List_1<int32_t>* childIndexes);

  /// @brief Method EnableInClassList, addr 0x4a732e8, size 0xc, virtual false, abstract: false, final false
  inline void EnableInClassList(::StringW className, bool enable);

  /// @brief Method EnsureWorldTransformAndClipUpToDate, addr 0x4a6fcb8, size 0x3c, virtual false, abstract: false, final false
  inline void EnsureWorldTransformAndClipUpToDate();

  /// @brief Method ExecuteDefaultAction, addr 0x4a70cc0, size 0x720, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method FinalizeLayout, addr 0x4a73fc8, size 0x4c, virtual false, abstract: false, final false
  inline void FinalizeLayout();

  /// @brief Method FindCommonAncestor, addr 0x4a77e88, size 0x184, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* FindCommonAncestor(::UnityEngine::UIElements::VisualElement* other);

  /// @brief Method FindElementInTree, addr 0x4a77a0c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Focus, addr 0x4a71998, size 0x84, virtual true, abstract: false, final true
  inline void Focus();

  /// @brief Method GatherAllChildren, addr 0x4a72408, size 0xd8, virtual false, abstract: false, final false
  inline void GatherAllChildren(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>* elements);

  /// @brief Method GetAnimationSystem, addr 0x4a74764, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementAnimationSystem* GetAnimationSystem();

  /// @brief Method GetCachedNextParentWithEventCallback, addr 0x4a77138, size 0x28, virtual false, abstract: false, final false
  inline bool GetCachedNextParentWithEventCallback(::ByRef<::UnityEngine::UIElements::VisualElement*> nextParent);

  /// @brief Method GetClassesForIteration, addr 0x4a743cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstAncestorWhere, addr 0x4a77e14, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x4a73850, size 0x74, virtual false, abstract: false, final false
  inline ::StringW GetFullHierarchicalViewDataKey();

  /// @brief Method GetFullHierarchicalViewDataKey, addr 0x4a737bc, size 0x94, virtual false, abstract: false, final false
  inline void GetFullHierarchicalViewDataKey(::System::Text::StringBuilder* key);

  /// @brief Method GetNextElementDepthFirst, addr 0x4a78110, size 0xf0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetNextElementDepthFirst();

  /// @brief Method GetOrCreateTypeData, addr 0x4a790f4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentSizeForLengthConversion, addr 0x4a6c6e4, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPivotedMatrixWithLayout, addr 0x4a6f5a4, size 0x188, virtual false, abstract: false, final false
  inline void GetPivotedMatrixWithLayout(::ByRef<::UnityEngine::Matrix4x4> result);

  /// @brief Method GetPreviousElementDepthFirst, addr 0x4a78200, size 0xe4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetPreviousElementDepthFirst();

  /// @brief Method GetProperty, addr 0x4a74480, size 0x80, virtual false, abstract: false, final false
  inline ::System::Object* GetProperty(::UnityEngine::PropertyName key);

  /// @brief Method GetRoot, addr 0x4a7800c, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRoot();

  /// @brief Method GetRootVisualContainer, addr 0x4a780cc, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* GetRootVisualContainer();

  /// @brief Method GetStylePropertyAnimationSystem, addr 0x4a6ac38, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* GetStylePropertyAnimationSystem();

  /// @brief Method GetTooltipRect, addr 0x4a71900, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::Rect GetTooltipRect();

  /// @brief Method HasChangedPanel, addr 0x4a72720, size 0x314, virtual false, abstract: false, final false
  inline void HasChangedPanel(::UnityEngine::UIElements::BaseVisualElementPanel* prevPanel);

  /// @brief Method HasDefaultAction, addr 0x4a774bc, size 0x10, virtual false, abstract: false, final false
  inline bool HasDefaultAction(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacks, addr 0x4a77434, size 0x10, virtual false, abstract: false, final false
  inline bool HasEventCallbacks(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacksOrDefaultActionAtTarget, addr 0x4a774a4, size 0x18, virtual false, abstract: false, final false
  inline bool HasEventCallbacksOrDefaultActionAtTarget(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasEventCallbacksOrDefaultActions, addr 0x4a72b04, size 0x20, virtual false, abstract: false, final false
  inline bool HasEventCallbacksOrDefaultActions(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasParentEventCallbacksOrDefaultActionAtTarget, addr 0x4a77478, size 0x2c, virtual false, abstract: false, final false
  inline bool HasParentEventCallbacksOrDefaultActionAtTarget(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasParentEventCallbacksOrDefaultActions, addr 0x4a77444, size 0x34, virtual false, abstract: false, final false
  inline bool HasParentEventCallbacksOrDefaultActions(::UnityEngine::UIElements::EventCategory eventCategory);

  /// @brief Method HasProperty, addr 0x4a746d4, size 0x80, virtual false, abstract: false, final false
  inline bool HasProperty(::UnityEngine::PropertyName key);

  /// @brief Method IncrementVersion, addr 0x4a664b0, size 0x28, virtual false, abstract: false, final false
  inline void IncrementVersion(::UnityEngine::UIElements::VersionChangeType changeType);

  /// @brief Method IndexOf, addr 0x4a777dc, size 0x80, virtual false, abstract: false, final false
  inline int32_t IndexOf(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method Insert, addr 0x4a77600, size 0x90, virtual false, abstract: false, final false
  inline void Insert(int32_t index, ::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method InvokeGenerateVisualContent, addr 0x4a735d0, size 0x1ec, virtual false, abstract: false, final false
  inline void InvokeGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext* mgc);

  /// @brief Method InvokeHierarchyChanged, addr 0x4a72bbc, size 0x20, virtual false, abstract: false, final false
  inline void InvokeHierarchyChanged(::UnityEngine::UIElements::HierarchyChangeType changeType);

  /// @brief Method IsPartOfCapturedChain, addr 0x4a70584, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewDataPersitenceSupportedOnChildren, addr 0x4a73c50, size 0x7c, virtual false, abstract: false, final false
  inline bool IsViewDataPersitenceSupportedOnChildren(bool existingState);

  /// @brief Method MarkDirtyRepaint, addr 0x4a7359c, size 0x24, virtual false, abstract: false, final false
  inline void MarkDirtyRepaint();

  /// @brief Method MarkRenderHintsClean, addr 0x4a6d614, size 0x10, virtual false, abstract: false, final false
  inline void MarkRenderHintsClean();

  /// @brief Method Max, addr 0x4a78574, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Max(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method Measure, addr 0x4a73ea0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Min, addr 0x4a78558, size 0x1c, virtual false, abstract: false, final false
  static inline float_t Min(float_t a, float_t b, float_t c, float_t d);

  /// @brief Method MultiplyMatrix34, addr 0x4a6f72c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyMatrix44Point2, addr 0x4a78a04, size 0x24, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 MultiplyMatrix44Point2(::ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector2 point);

  /// @brief Method MultiplyVector2, addr 0x4a78a28, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnViewDataReady, addr 0x4a73d08, size 0x4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method OnViewDataReady, addr 0x4a73ccc, size 0x3c, virtual false, abstract: false, final false
  inline void OnViewDataReady(bool enablePersistence);

  /// @brief Method OrderMinMaxRect, addr 0x4a7892c, size 0x44, virtual false, abstract: false, final false
  static inline void OrderMinMaxRect(::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method OverwriteFromViewData, addr 0x4a738c4, size 0x310, virtual false, abstract: false, final false
  inline void OverwriteFromViewData(::System::Object* obj, ::StringW key);

  /// @brief Method PlaceBehind, addr 0x4a77c88, size 0x128, virtual false, abstract: false, final false
  inline void PlaceBehind(::UnityEngine::UIElements::VisualElement* sibling);

  /// @brief Method PropagateCachedNextParentWithEventCallback, addr 0x4a77228, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method PropagateEnabledToChildren, addr 0x4a73308, size 0xb0, virtual false, abstract: false, final false
  inline void PropagateEnabledToChildren(bool value);

  /// @brief Method ReadCurrentValues, addr 0x4a75f6c, size 0xeec, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAnimation, addr 0x4a747f8, size 0x108, virtual false, abstract: false, final false
  inline void RegisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method RegisterRunningAnimations, addr 0x4a72b24, size 0x6c, virtual false, abstract: false, final false
  inline void RegisterRunningAnimations();

  /// @brief Method RemoveFromClassList, addr 0x4a72fbc, size 0x11c, virtual false, abstract: false, final false
  inline void RemoveFromClassList(::StringW className);

  /// @brief Method RemoveFromHierarchy, addr 0x4a77db0, size 0x64, virtual false, abstract: false, final false
  inline void RemoveFromHierarchy();

  /// @brief Method RemoveMeasureFunction, addr 0x4a73e70, size 0x20, virtual false, abstract: false, final false
  inline void RemoveMeasureFunction();

  /// @brief Method ResolveLengthValue, addr 0x4a6a2c4, size 0x19c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::StyleFloat ResolveLengthValue(::UnityEngine::UIElements::Length length, bool isRow);

  /// @brief Method ResolveRotation, addr 0x4a78348, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion ResolveRotation();

  /// @brief Method ResolveScale, addr 0x4a783f8, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveScale();

  /// @brief Method ResolveTransformOrigin, addr 0x4a6a54c, size 0x304, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTransformOrigin();

  /// @brief Method ResolveTranslate, addr 0x4a6a854, size 0x1fc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ResolveTranslate();

  /// @brief Method RetargetElement, addr 0x4a782e4, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* RetargetElement(::UnityEngine::UIElements::VisualElement* retargetAgainst);

  /// @brief Method SaveViewData, addr 0x4a73bd4, size 0x7c, virtual false, abstract: false, final false
  inline void SaveViewData();

  /// @brief Method SendEvent, addr 0x4a72b90, size 0x18, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e);

  /// @brief Method SendEvent, addr 0x4a72ba8, size 0x14, virtual true, abstract: false, final true
  inline void SendEvent(::UnityEngine::UIElements::EventBase* e, ::UnityEngine::UIElements::DispatchMode dispatchMode);

  /// @brief Method SendToBack, addr 0x4a77c24, size 0x64, virtual false, abstract: false, final false
  inline void SendToBack();

  /// @brief Method SetAsNextParentWithEventCallback, addr 0x4a6cd00, size 0xb0, virtual false, abstract: false, final false
  inline void SetAsNextParentWithEventCallback();

  /// @brief Method SetComputedStyle, addr 0x4a74094, size 0x1cc, virtual false, abstract: false, final false
  inline void SetComputedStyle(::ByRef<::UnityEngine::UIElements::ComputedStyle> newStyle);

  /// @brief Method SetEnabled, addr 0x4a70c9c, size 0x24, virtual false, abstract: false, final false
  inline void SetEnabled(bool value);

  /// @brief Method SetEnabledFromHierarchyPrivate, addr 0x4a72bdc, size 0x380, virtual false, abstract: false, final false
  inline bool SetEnabledFromHierarchyPrivate(bool state);

  /// @brief Method SetInlineRule, addr 0x4a74014, size 0x80, virtual false, abstract: false, final false
  inline void SetInlineRule(::UnityEngine::UIElements::StyleSheet* sheet, ::UnityEngine::UIElements::StyleRule* rule);

  /// @brief Method SetPanel, addr 0x4a71a1c, size 0x9ec, virtual false, abstract: false, final false
  inline void SetPanel(::UnityEngine::UIElements::BaseVisualElementPanel* p);

  /// @brief Method SetProperty, addr 0x4a7465c, size 0x78, virtual false, abstract: false, final false
  inline void SetProperty(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetPropertyInternal, addr 0x4a6d068, size 0x240, virtual false, abstract: false, final false
  inline void SetPropertyInternal(::UnityEngine::PropertyName key, ::System::Object* value);

  /// @brief Method SetTooltip, addr 0x4a71824, size 0xdc, virtual false, abstract: false, final false
  inline void SetTooltip(::UnityEngine::UIElements::TooltipEvent* e);

  /// @brief Method ShouldClip, addr 0x4a6f028, size 0x2c, virtual false, abstract: false, final false
  inline bool ShouldClip();

  /// @brief Method Start, addr 0x4a76f38, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method SubstractBorderPadding, addr 0x4a6fcf4, size 0x5a0, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect SubstractBorderPadding(::UnityEngine::Rect worldRect);

  /// @brief Method ToString, addr 0x4a74260, size 0x16c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TransformAlignedRect, addr 0x4a78970, size 0x94, virtual false, abstract: false, final false
  static inline void TransformAlignedRect(::ByRef<::UnityEngine::Matrix4x4> matrix, ::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TransformAlignedRectToParentSpace, addr 0x4a78590, size 0x170, virtual false, abstract: false, final false
  inline void TransformAlignedRectToParentSpace(::ByRef<::UnityEngine::Rect> rect);

  /// @brief Method TranslateMatrix34, addr 0x4a78a44, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method TranslateMatrix34InPlace, addr 0x4a78b30, size 0x5c, virtual false, abstract: false, final false
  static inline void TranslateMatrix34InPlace(::ByRef<::UnityEngine::Matrix4x4> lhs, ::UnityEngine::Vector3 rhs);

  /// @brief Method TryConvertBackgroundSizeUnits, addr 0x4a6cbdc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertLengthUnits, addr 0x4a6c42c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTransformOriginUnits, addr 0x4a6caac, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method TryConvertTranslateUnits, addr 0x4a6cb44, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetPropertyInternal, addr 0x4a6cf10, size 0xe8, virtual false, abstract: false, final false
  inline bool TryGetPropertyInternal(::UnityEngine::PropertyName key, ::ByRef<::System::Object*> value);

  /// @brief Method UnityEngine.UIElements.Experimental.ITransitionAnimations.Start, addr 0x4a76e58, size 0xe0, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*
  ...
  /// @brief Method UnityEngine.UIElements.IExperimentalFeatures.get_animation, addr 0x4a774d0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_backgroundColor, addr 0x4a6a080, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_backgroundColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomColor, addr 0x4a6a08c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderBottomColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomLeftRadius, addr 0x4a6a098, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomRightRadius, addr 0x4a6a0b4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderBottomWidth, addr 0x4a6a0d0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderBottomWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftColor, addr 0x4a6a0ec, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderLeftColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderLeftWidth, addr 0x4a6a0f8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderLeftWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightColor, addr 0x4a6a114, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderRightColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderRightWidth, addr 0x4a6a120, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderRightWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopColor, addr 0x4a6a13c, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_borderTopColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopLeftRadius, addr 0x4a6a148, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopLeftRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopRightRadius, addr 0x4a6a164, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopRightRadius();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_borderTopWidth, addr 0x4a6a180, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_borderTopWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_bottom, addr 0x4a6a19c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_bottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_color, addr 0x4a6a1b8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_color();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_display, addr 0x4a6a1c4, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DisplayStyle UnityEngine_UIElements_IResolvedStyle_get_display();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexDirection, addr 0x4a6a1d0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::FlexDirection UnityEngine_UIElements_IResolvedStyle_get_flexDirection();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexGrow, addr 0x4a6a1dc, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexGrow();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_flexShrink, addr 0x4a6a1e8, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_flexShrink();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_height, addr 0x4a6a1f4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_height();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_left, addr 0x4a6a210, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_left();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginBottom, addr 0x4a6a22c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginLeft, addr 0x4a6a248, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginRight, addr 0x4a6a264, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_marginTop, addr 0x4a6a280, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_marginTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minHeight, addr 0x4a6a29c, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minHeight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_minWidth, addr 0x4a6a460, size 0x28, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::StyleFloat UnityEngine_UIElements_IResolvedStyle_get_minWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_opacity, addr 0x4a6a488, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_opacity();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingBottom, addr 0x4a6a494, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingBottom();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingLeft, addr 0x4a6a4b0, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingRight, addr 0x4a6a4cc, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_paddingTop, addr 0x4a6a4e8, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_paddingTop();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_right, addr 0x4a6a504, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_right();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_scale, addr 0x4a6a520, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Scale UnityEngine_UIElements_IResolvedStyle_get_scale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_top, addr 0x4a6a52c, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_top();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_transformOrigin, addr 0x4a6a548, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_transformOrigin();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_translate, addr 0x4a6a850, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_IResolvedStyle_get_translate();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityBackgroundImageTintColor, addr 0x4a6aa50, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityBackgroundImageTintColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceLeft, addr 0x4a6aa5c, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceLeft();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceRight, addr 0x4a6aa68, size 0xc, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceRight();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unitySliceScale, addr 0x4a6aa74, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unitySliceScale();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineColor, addr 0x4a6aa80, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineColor();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_unityTextOutlineWidth, addr 0x4a6aa8c, size 0xc, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_unityTextOutlineWidth();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_visibility, addr 0x4a6aa98, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::Visibility UnityEngine_UIElements_IResolvedStyle_get_visibility();

  /// @brief Method UnityEngine.UIElements.IResolvedStyle.get_width, addr 0x4a6aaa4, size 0x1c, virtual true, abstract: false, final true
  inline float_t UnityEngine_UIElements_IResolvedStyle_get_width();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAllAnimations, addr 0x4a6c198, size 0xe0, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_CancelAllAnimations();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.CancelAnimation, addr 0x4a6c0c8, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.GetAllAnimations, addr 0x4a6c340, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6af90, size 0x150, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b484, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b1fc, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6bcf4, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6be24, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6bf40, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b354, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6ae74, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b9e4, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b72c, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b5a0, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6bb6c, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6b85c, size 0x188, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6ac54, size 0x104, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.Start, addr 0x4a6ad58, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.StartEnum, addr 0x4a6b0e0, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.UpdateAnimation, addr 0x4a6c278, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_completedAnimationCount, addr 0x4a6ac28, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_completedAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.get_runningAnimationCount, addr 0x4a6ac18, size 0x8, virtual true, abstract: false, final true
  inline int32_t UnityEngine_UIElements_IStylePropertyAnimations_get_runningAnimationCount();

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_completedAnimationCount, addr 0x4a6ac30, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_completedAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.IStylePropertyAnimations.set_runningAnimationCount, addr 0x4a6ac20, size 0x8, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_IStylePropertyAnimations_set_runningAnimationCount(int32_t value);

  /// @brief Method UnityEngine.UIElements.ITransform.get_position, addr 0x4a6d628, size 0xa0, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_position();

  /// @brief Method UnityEngine.UIElements.ITransform.get_scale, addr 0x4a6d834, size 0xb4, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 UnityEngine_UIElements_ITransform_get_scale();

  /// @brief Method UnityEngine.UIElements.ITransform.set_position, addr 0x4a6d6c8, size 0x16c, virtual true, abstract: false, final true
  inline void UnityEngine_UIElements_ITransform_set_position(::UnityEngine::Vector3 value);

  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x4a78b90, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnityEngine.UIElements.IVisualElementScheduler.Execute, addr 0x4a78c44, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method UnregisterAnimation, addr 0x4a74900, size 0x78, virtual false, abstract: false, final false
  inline void UnregisterAnimation(::UnityEngine::UIElements::Experimental::IValueAnimationUpdate* anim);

  /// @brief Method UnregisterRunningAnimations, addr 0x4a72a34, size 0xd0, virtual false, abstract: false, final false
  inline void UnregisterRunningAnimations();

  /// @brief Method UpdateBoundingBox, addr 0x4a6eca8, size 0x210, virtual false, abstract: false, final false
  inline void UpdateBoundingBox();

  /// @brief Method UpdateCallbackParentCategories, addr 0x4a7734c, size 0xb8, virtual false, abstract: false, final false
  inline void UpdateCallbackParentCategories();

  /// @brief Method UpdateCursorStyle, addr 0x4a713e0, size 0x444, virtual false, abstract: false, final false
  inline void UpdateCursorStyle(int64_t eventType);

  /// @brief Method UpdateHoverPseudoState, addr 0x4a7048c, size 0xf8, virtual false, abstract: false, final false
  inline void UpdateHoverPseudoState();

  /// @brief Method UpdateWorldBoundingBox, addr 0x4a6eefc, size 0xf0, virtual false, abstract: false, final false
  inline void UpdateWorldBoundingBox();

  /// @brief Method UpdateWorldClip, addr 0x4a6f97c, size 0x2d0, virtual false, abstract: false, final false
  inline void UpdateWorldClip();

  /// @brief Method UpdateWorldTransform, addr 0x4a6f218, size 0x2c8, virtual false, abstract: false, final false
  inline void UpdateWorldTransform();

  /// @brief Method UpdateWorldTransformInverse, addr 0x4a6f508, size 0x54, virtual false, abstract: false, final false
  inline void UpdateWorldTransformInverse();

  /// @brief Method WillChangePanel, addr 0x4a724e0, size 0x240, virtual false, abstract: false, final false
  inline void WillChangePanel(::UnityEngine::UIElements::BaseVisualElementPanel* destinationPanel);

  /// @brief Method <AssignMeasureFunction>b__432_0, addr 0x4a79498, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a709e0, size 0x2bc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Item, addr 0x4a776fc, size 0x78, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_Item(int32_t key);

  /// @brief Method get_boundingBox, addr 0x4a6ec6c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBox();

  /// @brief Method get_boundingBoxInParentSpace, addr 0x4a6efec, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_boundingBoxInParentSpace();

  /// @brief Method get_canGrabFocus, addr 0x4a6d2a8, size 0x118, virtual true, abstract: false, final false
  inline bool get_canGrabFocus();

  /// @brief Method get_childCount, addr 0x4a77774, size 0x68, virtual false, abstract: false, final false
  inline int32_t get_childCount();

  /// @brief Method get_classList, addr 0x4a70738, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_classList();

  /// @brief Method get_computedStyle, addr 0x4a623ac, size 0x8, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::UIElements::ComputedStyle> get_computedStyle();

  /// @brief Method get_containedPointerIds, addr 0x4a7047c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_containedPointerIds();

  /// @brief Method get_contentContainer, addr 0x4a77544, size 0x4, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_contentContainer();

  /// @brief Method get_contentRect, addr 0x4a6e7cc, size 0x204, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_contentRect();

  /// @brief Method get_customStyle, addr 0x4a78cf8, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICustomStyle* get_customStyle();

  /// @brief Method get_defaultMaterial, addr 0x4a7475c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_defaultMaterial();

  /// @brief Method get_disableClipping, addr 0x4a774f8, size 0xc, virtual false, abstract: false, final false
  inline bool get_disableClipping();

  /// @brief Method get_elementPanel, addr 0x4a77534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVisualElementPanel* get_elementPanel();

  /// @brief Method get_enableViewDataPersistence, addr 0x4a6ce5c, size 0xc, virtual false, abstract: false, final false
  inline bool get_enableViewDataPersistence();

  /// @brief Method get_enabledInHierarchy, addr 0x4a6d474, size 0x10, virtual false, abstract: false, final false
  inline bool get_enabledInHierarchy();

  /// @brief Method get_enabledSelf, addr 0x4a732f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabledSelf();

  /// @brief Method get_eventCallbackCategories, addr 0x4a77284, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_eventCallbackCategories();

  /// @brief Method get_eventCallbackParentCategories, addr 0x4a77300, size 0x40, virtual false, abstract: false, final false
  inline int32_t get_eventCallbackParentCategories();

  /// @brief Method get_experimental, addr 0x4a774cc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IExperimentalFeatures* get_experimental();

  /// @brief Method get_focusController, addr 0x4a6d484, size 0xb0, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::FocusController* get_focusController();

  /// @brief Method get_fullTypeName, addr 0x4a707ec, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_fullTypeName();

  /// @brief Method get_generateVisualContent, addr 0x4a735c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* get_generateVisualContent();

  /// @brief Method get_hasCompletedAnimations, addr 0x4a6ab6c, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasCompletedAnimations();

  /// @brief Method get_hasDefaultRotationAndScale, addr 0x4a7848c, size 0xcc, virtual false, abstract: false, final false
  inline bool get_hasDefaultRotationAndScale();

  /// @brief Method get_hasInlineStyle, addr 0x4a70960, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasInlineStyle();

  /// @brief Method get_hasRunningAnimations, addr 0x4a6aac0, size 0xac, virtual false, abstract: false, final false
  inline bool get_hasRunningAnimations();

  /// @brief Method get_hierarchy, addr 0x4a774d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_Hierarchy get_hierarchy();

  /// @brief Method get_isBoundingBoxDirty, addr 0x4a6ebec, size 0xc, virtual false, abstract: false, final false
  inline bool get_isBoundingBoxDirty();

  /// @brief Method get_isCompositeRoot, addr 0x4a6ccb8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isCompositeRoot();

  /// @brief Method get_isEventCallbackParentCategoriesDirty, addr 0x4a77340, size 0xc, virtual false, abstract: false, final false
  inline bool get_isEventCallbackParentCategoriesDirty();

  /// @brief Method get_isHierarchyDisplayed, addr 0x4a6cdb0, size 0xc, virtual false, abstract: false, final false
  inline bool get_isHierarchyDisplayed();

  /// @brief Method get_isLayoutManual, addr 0x4a6d8e8, size 0xc, virtual false, abstract: false, final false
  inline bool get_isLayoutManual();

  /// @brief Method get_isParentEnabledInHierarchy, addr 0x4a72f5c, size 0x60, virtual false, abstract: false, final false
  inline bool get_isParentEnabledInHierarchy();

  /// @brief Method get_isRootVisualContainer, addr 0x4a774e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isRootVisualContainer();

  /// @brief Method get_isWorldBoundingBoxOrDependenciesDirty, addr 0x4a6ec58, size 0x14, virtual false, abstract: false, final false
  inline bool get_isWorldBoundingBoxOrDependenciesDirty();

  /// @brief Method get_isWorldClipDirty, addr 0x4a6f904, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldClipDirty();

  /// @brief Method get_isWorldTransformDirty, addr 0x4a6f170, size 0xc, virtual false, abstract: false, final false
  inline bool get_isWorldTransformDirty();

  /// @brief Method get_isWorldTransformInverseOrDependenciesDirty, addr 0x4a6f1cc, size 0x10, virtual false, abstract: false, final false
  inline bool get_isWorldTransformInverseOrDependenciesDirty();

  /// @brief Method get_languageDirection, addr 0x4a733b8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::LanguageDirection get_languageDirection();

  /// @brief Method get_layout, addr 0x4a6d990, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_layout();

  /// @brief Method get_localBound, addr 0x4a6f134, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_localBound();

  /// @brief Method get_localLanguageDirection, addr 0x4a733c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::LanguageDirection get_localLanguageDirection();

  /// @brief Method get_name, addr 0x4a706d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_nextParentWithEventCallback, addr 0x4a77160, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_nextParentWithEventCallback();

  /// @brief Method get_paddingRect, addr 0x4a6e9d0, size 0x204, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_paddingRect();

  /// @brief Method get_panel, addr 0x4a6d534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IPanel* get_panel();

  /// @brief Method get_parent, addr 0x4a6d3c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_parent();

  /// @brief Method get_pickingMode, addr 0x4a70698, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PickingMode get_pickingMode();

  /// @brief Method get_positionWithLayout, addr 0x4a6f55c, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionWithLayout();

  /// @brief Method get_pseudoStates, addr 0x4a703f0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PseudoStates get_pseudoStates();

  /// @brief Method get_rect, addr 0x4a6ebd4, size 0x18, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_rect();

  /// @brief Method get_renderHints, addr 0x4a6d55c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::RenderHints get_renderHints();

  /// @brief Method get_requireMeasureFunction, addr 0x4a73d60, size 0xc, virtual false, abstract: false, final false
  inline bool get_requireMeasureFunction();

  /// @brief Method get_resolvedStyle, addr 0x4a62320, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IResolvedStyle* get_resolvedStyle();

  /// @brief Method get_scaledPixelsPerPoint, addr 0x4a6d924, size 0x6c, virtual false, abstract: false, final false
  inline float_t get_scaledPixelsPerPoint();

  /// @brief Method get_schedule, addr 0x4a78b8c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IVisualElementScheduler* get_schedule();

  /// @brief Method get_style, addr 0x4a69354, size 0x68, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStyle* get_style();

  /// @brief Method get_styleAnimation, addr 0x4a69e3c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IStylePropertyAnimations* get_styleAnimation();

  /// @brief Method get_styleInitialized, addr 0x4a69e30, size 0xc, virtual false, abstract: false, final false
  inline bool get_styleInitialized();

  /// @brief Method get_styleSheets, addr 0x4a78d78, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElementStyleSheetSet get_styleSheets();

  /// @brief Method get_subRenderTargetMode, addr 0x4a74754, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_RenderTargetMode get_subRenderTargetMode();

  /// @brief Method get_tooltip, addr 0x4a71904, size 0x94, virtual false, abstract: false, final false
  inline ::StringW get_tooltip();

  /// @brief Method get_transform, addr 0x4a6d624, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ITransform* get_transform();

  /// @brief Method get_typeData, addr 0x4a70808, size 0x12c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement_TypeData* get_typeData();

  /// @brief Method get_typeName, addr 0x4a70934, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_typeName();

  /// @brief Method get_usageHints, addr 0x4a6d53c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::UsageHints get_usageHints();

  /// @brief Method get_userData, addr 0x4a6ce98, size 0x78, virtual false, abstract: false, final false
  inline ::System::Object* get_userData();

  /// @brief Method get_viewDataKey, addr 0x4a6cdec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_viewDataKey();

  /// @brief Method get_visible, addr 0x4a6d3c8, size 0xac, virtual false, abstract: false, final false
  inline bool get_visible();

  /// @brief Method get_worldBound, addr 0x4a6f078, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBound();

  /// @brief Method get_worldBoundingBox, addr 0x4a6eeb8, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldBoundingBox();

  /// @brief Method get_worldClip, addr 0x4a6f940, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClip();

  /// @brief Method get_worldClipIsInfinite, addr 0x4a6fc88, size 0x30, virtual false, abstract: false, final false
  inline bool get_worldClipIsInfinite();

  /// @brief Method get_worldClipMinusGroup, addr 0x4a6fc4c, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_worldClipMinusGroup();

  /// @brief Method get_worldTransform, addr 0x4a6f1dc, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_worldTransform();

  /// @brief Method get_worldTransformInverse, addr 0x4a6f4e0, size 0x28, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Matrix4x4> get_worldTransformInverse();

  /// @brief Method get_worldTransformRef, addr 0x4a6f054, size 0x24, virtual false, abstract: false, final false
  inline ::ByRef<::UnityEngine::Matrix4x4> get_worldTransformRef();

  /// @brief Method get_yogaNode, addr 0x4a70950, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_containedPointerIds, addr 0x4a70484, size 0x8, virtual false, abstract: false, final false
  inline void set_containedPointerIds(int32_t value);

  /// @brief Method set_disableClipping, addr 0x4a77504, size 0x30, virtual false, abstract: false, final false
  inline void set_disableClipping(bool value);

  /// @brief Method set_elementPanel, addr 0x4a7753c, size 0x8, virtual false, abstract: false, final false
  inline void set_elementPanel(::UnityEngine::UIElements::BaseVisualElementPanel* value);

  /// @brief Method set_enableViewDataPersistence, addr 0x4a6ce68, size 0x30, virtual false, abstract: false, final false
  inline void set_enableViewDataPersistence(bool value);

  /// @brief Method set_enabledSelf, addr 0x4a732fc, size 0xc, virtual false, abstract: false, final false
  inline void set_enabledSelf(bool value);

  /// @brief Method set_eventCallbackCategories, addr 0x4a7728c, size 0x74, virtual false, abstract: false, final false
  inline void set_eventCallbackCategories(int32_t value);

  /// @brief Method set_generateVisualContent, addr 0x4a735c8, size 0x8, virtual false, abstract: false, final false
  inline void set_generateVisualContent(::System::Action_1<::UnityEngine::UIElements::MeshGenerationContext*>* value);

  /// @brief Method set_hierarchy, addr 0x4a774dc, size 0x8, virtual false, abstract: false, final false
  inline void set_hierarchy(::UnityEngine::UIElements::VisualElement_Hierarchy value);

  /// @brief Method set_isBoundingBoxDirty, addr 0x4a6ebf8, size 0x30, virtual false, abstract: false, final false
  inline void set_isBoundingBoxDirty(bool value);

  /// @brief Method set_isCompositeRoot, addr 0x4a6ccc4, size 0x3c, virtual false, abstract: false, final false
  inline void set_isCompositeRoot(bool value);

  /// @brief Method set_isEventCallbackParentCategoriesDirty, addr 0x4a77404, size 0x30, virtual false, abstract: false, final false
  inline void set_isEventCallbackParentCategoriesDirty(bool value);

  /// @brief Method set_isHierarchyDisplayed, addr 0x4a6cdbc, size 0x30, virtual false, abstract: false, final false
  inline void set_isHierarchyDisplayed(bool value);

  /// @brief Method set_isLayoutManual, addr 0x4a6d8f4, size 0x30, virtual false, abstract: false, final false
  inline void set_isLayoutManual(bool value);

  /// @brief Method set_isRootVisualContainer, addr 0x4a774ec, size 0xc, virtual false, abstract: false, final false
  inline void set_isRootVisualContainer(bool value);

  /// @brief Method set_isWorldBoundingBoxDirty, addr 0x4a6ec28, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldBoundingBoxDirty(bool value);

  /// @brief Method set_isWorldClipDirty, addr 0x4a6f910, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldClipDirty(bool value);

  /// @brief Method set_isWorldTransformDirty, addr 0x4a6f17c, size 0x20, virtual false, abstract: false, final false
  inline void set_isWorldTransformDirty(bool value);

  /// @brief Method set_isWorldTransformInverseDirty, addr 0x4a6f19c, size 0x30, virtual false, abstract: false, final false
  inline void set_isWorldTransformInverseDirty(bool value);

  /// @brief Method set_layout, addr 0x4a6da28, size 0x7e0, virtual false, abstract: false, final false
  inline void set_layout(::UnityEngine::Rect value);

  /// @brief Method set_localLanguageDirection, addr 0x4a733c8, size 0xf0, virtual false, abstract: false, final false
  inline void set_localLanguageDirection(::UnityEngine::UIElements::LanguageDirection value);

  /// @brief Method set_name, addr 0x4a706e0, size 0x58, virtual false, abstract: false, final false
  inline void set_name(::StringW value);

  /// @brief Method set_pickingMode, addr 0x4a706a0, size 0x38, virtual false, abstract: false, final false
  inline void set_pickingMode(::UnityEngine::UIElements::PickingMode value);

  /// @brief Method set_pseudoStates, addr 0x4a703f8, size 0x84, virtual false, abstract: false, final false
  inline void set_pseudoStates(::UnityEngine::UIElements::PseudoStates value);

  /// @brief Method set_renderHints, addr 0x4a6d5c8, size 0x4c, virtual false, abstract: false, final false
  inline void set_renderHints(::UnityEngine::UIElements::RenderHints value);

  /// @brief Method set_requireMeasureFunction, addr 0x4a73d6c, size 0x74, virtual false, abstract: false, final false
  inline void set_requireMeasureFunction(bool value);

  /// @brief Method set_styleInitialized, addr 0x4a70970, size 0x30, virtual false, abstract: false, final false
  inline void set_styleInitialized(bool value);

  /// @brief Method set_tooltip, addr 0x4a78fd0, size 0x124, virtual false, abstract: false, final false
  inline void set_tooltip(::StringW value);

  /// @brief Method set_usageHints, addr 0x4a6d564, size 0x64, virtual false, abstract: false, final false
  inline void set_usageHints(::UnityEngine::UIElements::UsageHints value);

  /// @brief Method set_userData, addr 0x4a6cff8, size 0x70, virtual false, abstract: false, final false
  inline void set_userData(::System::Object* value);

  /// @brief Method set_viewDataKey, addr 0x4a6cdf4, size 0x68, virtual false, abstract: false, final false
  inline void set_viewDataKey(::StringW value);

  /// @brief Method set_visible, addr 0x4a734b8, size 0xe4, virtual false, abstract: false, final false
  inline void set_visible(bool value);

  /// @brief Method set_visualTreeAssetSource, addr 0x4a77548, size 0x8, virtual false, abstract: false, final false
  inline void set_visualTreeAssetSource(::UnityEngine::UIElements::VisualTreeAsset* value);

  /// @brief Method set_yogaNode, addr 0x4a70958, size 0x8, virtual false, abstract: false, final false
