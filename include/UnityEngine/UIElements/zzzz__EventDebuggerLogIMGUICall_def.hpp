...
public:
  ...
  /// @brief Method Dispose, addr 0x4a291fc, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x4a291f8, size 0x4, virtual false, abstract: false, final false
