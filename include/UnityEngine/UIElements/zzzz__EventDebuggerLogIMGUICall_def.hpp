...
public:
  ...
  /// @brief Method Dispose, addr 0x4a28ac4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x4a28ac0, size 0x4, virtual false, abstract: false, final false
