...
public:
  ...
  __declspec(property(get = getStaticF__EditorResourcesBasePath_k__BackingField, put = setStaticF__EditorResourcesBasePath_k__BackingField)) ::StringW _EditorResourcesBasePath_k__BackingField;
  ...
  /// @brief Method Refresh, addr 0x4a9baec, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_EditorResourcesBasePath, addr 0x4a9ba34, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW get_EditorResourcesBasePath();

  /// @brief Method get_IsUIEPackageLoaded, addr 0x4a9b97c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method set_EditorResourcesBasePath, addr 0x4a9ba8c, size 0x5c, virtual false, abstract: false, final false
  static inline void set_EditorResourcesBasePath(::StringW value);

  /// @brief Method set_IsUIEPackageLoaded, addr 0x4a9b9d4, size 0x60, virtual false, abstract: false, final false
