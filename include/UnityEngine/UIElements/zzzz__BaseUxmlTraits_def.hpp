...
/// @brief Method .ctor, addr 0x6af4b7c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_canHaveAnyAttribute, addr 0x6af4b88, size 0x8, virtual false, abstract: false, final false
