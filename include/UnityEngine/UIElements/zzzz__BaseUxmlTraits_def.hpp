...
public:
  ...
  /// @brief Method .ctor, addr 0x4ab067c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_canHaveAnyAttribute, addr 0x4ab069c, size 0xc, virtual false, abstract: false, final false
