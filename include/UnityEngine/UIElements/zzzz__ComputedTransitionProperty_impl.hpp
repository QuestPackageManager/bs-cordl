...
// Ctor Parameters [CppParam { name: "id", ty: "::UnityEngine::UIElements::StyleSheets::StylePropertyId", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "durationMs", ty:
// "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "delayMs", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "easingCurve",
// ty: "::System::Func_2<float_t,float_t>*", modifiers: "", def_value: Some("{}"), comment: None }]
