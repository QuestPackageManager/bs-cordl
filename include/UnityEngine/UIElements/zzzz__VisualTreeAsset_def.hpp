...
public:
  ...
  /// @brief Method .ctor, addr 0x33615ac, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x3361a34, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3361a2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3361a70, size 0x4e0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UIElements::__VisualTreeAsset___get_templateDependencies_d__17* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.VisualTreeAsset>.GetEnumerator, addr 0x3361ff0, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.VisualTreeAsset>.get_Current, addr 0x3361fa0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3362090, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3361fa8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3361fe8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3361a44, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x3361f50, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x335f690, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3362180, size 0x5bc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::UnityEngine::UIElements::__VisualTreeAsset___get_stylesheets_d__21* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.StyleSheet>.GetEnumerator, addr 0x336287c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.StyleSheet>.get_Current, addr 0x336282c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x336291c, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3362834, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3362874, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3362094, size 0xec, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method <>m__Finally1, addr 0x33627dc, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x336273c, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method <>m__Finally3, addr 0x336278c, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally3();

  /// @brief Method .ctor, addr 0x335f738, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method <CloneSetupRecursively>b__0, addr 0x3362920, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33612f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AssignClassListFromAssetToElement, addr 0x3360200, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignStyleSheetFromAssetToElement, addr 0x336026c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneSetupRecursively, addr 0x3360438, size 0x848, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneTree, addr 0x335ffdc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TemplateContainer* CloneTree();

  /// @brief Method CloneTree, addr 0x335ffe0, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TemplateContainer* CloneTree(::StringW bindingPath);

  /// @brief Method CloneTree, addr 0x3360000, size 0x1c, virtual false, abstract: false, final false
  inline void CloneTree(::UnityEngine::UIElements::VisualElement* target);

  /// @brief Method CloneTree, addr 0x336001c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneTree, addr 0x335f93c, size 0x680, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareForOrder, addr 0x3361300, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x3360c80, size 0x5c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChildSerialNumber, addr 0x335f5cc, size 0x60, virtual false, abstract: false, final false
  inline int32_t GetNextChildSerialNumber();

  /// @brief Method Instantiate, addr 0x335f7bc, size 0x180, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TemplateContainer* Instantiate();

  /// @brief Method Instantiate, addr 0x335ffbc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveTemplate, addr 0x336133c, size 0x270, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UIElements::VisualTreeAsset> ResolveTemplate(::StringW templateName);

  /// @brief Method TryGetSlotInsertionPoint, addr 0x3361240, size 0xb0, virtual false, abstract: false, final false
  inline bool TryGetSlotInsertionPoint(int32_t insertionPointId, ByRef<::StringW> slotName);

  /// @brief Method <Create>g__CreateError|49_0, addr 0x33615c0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33618f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_contentContainerId, addr 0x335f7ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_contentContainerId();

  /// @brief Method get_contentHash, addr 0x33618e4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_contentHash();

  /// @brief Method get_importedWithErrors, addr 0x335f5a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_importedWithErrors();

  /// @brief Method get_importedWithWarnings, addr 0x335f5b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_importedWithWarnings();

  /// @brief Method get_slots, addr 0x335f79c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotDefinition>* get_slots();

  /// @brief Method get_stylesheets, addr 0x335f6d4, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UIElements::StyleSheet>>* get_stylesheets();

  /// @brief Method get_templateAssets, addr 0x335f78c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset*>* get_templateAssets();

  /// @brief Method get_templateDependencies, addr 0x335f62c, size 0x64, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UIElements::VisualTreeAsset>>* get_templateDependencies();

  /// @brief Method get_visualElementAssets, addr 0x335f77c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_contentContainerId, addr 0x335f7b4, size 0x8, virtual false, abstract: false, final false
  inline void set_contentContainerId(int32_t value);

  /// @brief Method set_contentHash, addr 0x33618ec, size 0x8, virtual false, abstract: false, final false
  inline void set_contentHash(int32_t value);

  /// @brief Method set_importedWithErrors, addr 0x335f5ac, size 0xc, virtual false, abstract: false, final false
  inline void set_importedWithErrors(bool value);

  /// @brief Method set_importedWithWarnings, addr 0x335f5c0, size 0xc, virtual false, abstract: false, final false
  inline void set_importedWithWarnings(bool value);

  /// @brief Method set_slots, addr 0x335f7a4, size 0x8, virtual false, abstract: false, final false
  inline void set_slots(::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotDefinition>* value);

  /// @brief Method set_templateAssets, addr 0x335f794, size 0x8, virtual false, abstract: false, final false
  inline void set_templateAssets(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset*>* value);

  /// @brief Method set_visualElementAssets, addr 0x335f784, size 0x8, virtual false, abstract: false, final false
