...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::UnityEngine::UIElements::DropdownMenuSeparator::*)()>(&::UnityEngine::UIElements::DropdownMenuSeparator::get_subMenuPath)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6bc8c48;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::DropdownMenuSeparator::*)(::StringW)>(&::UnityEngine::UIElements::DropdownMenuSeparator::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6bc8c50;
