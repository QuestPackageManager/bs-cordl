...
public:
  // Declarations
  /// @brief Method AllocateTempMesh, addr 0x6c7dd28, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x6c7ed34, size 0x8, virtual false, abstract: false, final false
