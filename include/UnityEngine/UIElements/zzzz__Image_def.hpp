...
public:
  ...
  /// @brief Method .ctor, addr 0x6bf0fd4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6bf103c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateUV, addr 0x6bef3c8, size 0x1a8, virtual false, abstract: false, final false
  inline void CalculateUV(::UnityEngine::Rect srcRect);

  /// @brief Method ClearProperty, addr 0x6bf0950, size 0x38, virtual false, abstract: false, final false
  inline void ClearProperty();

  /// @brief Method DoMeasure, addr 0x6befcc4, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method GetSourceRect, addr 0x6bef0c8, size 0x188, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetSourceRect();

  /// @brief Method GetTextureDisplaySize, addr 0x6befb88, size 0x13c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetTextureDisplaySize(::UnityEngine::Sprite* sprite);

  /// @brief Method GetTextureDisplaySize, addr 0x6befaa4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCustomStyleResolved, addr 0x6bf0414, size 0x38, virtual false, abstract: false, final false
  inline void OnCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent* e);

  /// @brief Method OnGenerateVisualContent, addr 0x6befec8, size 0x54c, virtual false, abstract: false, final false
  inline void OnGenerateVisualContent(Il2CppObject* mgc);

  /// @brief Method ReadCustomProperties, addr 0x6bf044c, size 0x504, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScaleMode, addr 0x6bef68c, size 0xb4, virtual false, abstract: false, final false
  inline void SetScaleMode(::UnityEngine::ScaleMode mode);

  /// @brief Method SetTintColor, addr 0x6bef7b8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bef8d0, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_image, addr 0x6beed18, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Texture> get_image();

  /// @brief Method get_scaleMode, addr 0x6bef660, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ScaleMode get_scaleMode();

  /// @brief Method get_sourceRect, addr 0x6bef0c4, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_sourceRect();

  /// @brief Method get_sprite, addr 0x6beee5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_sprite();

  /// @brief Method get_tintColor, addr 0x6bef740, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_tintColor();

  /// @brief Method get_uv, addr 0x6bef570, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect get_uv();

  /// @brief Method get_vectorImage, addr 0x6beef90, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_image, addr 0x6beed20, size 0x13c, virtual false, abstract: false, final false
  inline void set_image(::UnityEngine::Texture* value);

  /// @brief Method set_scaleMode, addr 0x6bef668, size 0x24, virtual false, abstract: false, final false
  inline void set_scaleMode(::UnityEngine::ScaleMode value);

  /// @brief Method set_sourceRect, addr 0x6bef250, size 0x178, virtual false, abstract: false, final false
  inline void set_sourceRect(::UnityEngine::Rect value);

  /// @brief Method set_sprite, addr 0x6beee64, size 0x12c, virtual false, abstract: false, final false
  inline void set_sprite(::UnityEngine::Sprite* value);

  /// @brief Method set_tintColor, addr 0x6bef754, size 0x64, virtual false, abstract: false, final false
  inline void set_tintColor(::UnityEngine::Color value);

  /// @brief Method set_uv, addr 0x6bef584, size 0xdc, virtual false, abstract: false, final false
  inline void set_uv(::UnityEngine::Rect value);

  /// @brief Method set_vectorImage, addr 0x6beef98, size 0x12c, virtual false, abstract: false, final false
