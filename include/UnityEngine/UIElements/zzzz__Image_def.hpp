...
/// @brief Method .ctor, addr 0x6b7ed8c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x6b7edf4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CalculateUV, addr 0x6b7d180, size 0x1a8, virtual false, abstract: false, final false
inline void CalculateUV(::UnityEngine::Rect  srcRect) ;

/// @brief Method ClearProperty, addr 0x6b7e708, size 0x38, virtual false, abstract: false, final false
inline void ClearProperty() ;

/// @brief Method DoMeasure, addr 0x6b7da7c, size 0x204, virtual true, abstract: false, final false
...
/// @brief Method GetSourceRect, addr 0x6b7ce80, size 0x188, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetSourceRect() ;

/// @brief Method GetTextureDisplaySize, addr 0x6b7d940, size 0x13c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetTextureDisplaySize(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetTextureDisplaySize, addr 0x6b7d85c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method OnCustomStyleResolved, addr 0x6b7e1cc, size 0x38, virtual false, abstract: false, final false
inline void OnCustomStyleResolved(::UnityEngine::UIElements::CustomStyleResolvedEvent*  e) ;

/// @brief Method OnGenerateVisualContent, addr 0x6b7dc80, size 0x54c, virtual false, abstract: false, final false
inline void OnGenerateVisualContent(Il2CppObject*  mgc) ;

/// @brief Method ReadCustomProperties, addr 0x6b7e204, size 0x504, virtual false, abstract: false, final false
...
inline void SetProperty(T0  src, ::ByRef<T0>  dst, ::ByRef<T1>  alt0, ::ByRef<T2>  alt1, ::UnityEngine::UIElements::BindingId  binding) ;

/// @brief Method SetScaleMode, addr 0x6b7d444, size 0xb4, virtual false, abstract: false, final false
inline void SetScaleMode(::UnityEngine::ScaleMode  mode) ;

/// @brief Method SetTintColor, addr 0x6b7d570, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b7d688, size 0x1d4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_image, addr 0x6b7cad0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_image() ;

/// @brief Method get_scaleMode, addr 0x6b7d418, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ScaleMode get_scaleMode() ;

/// @brief Method get_sourceRect, addr 0x6b7ce7c, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_sourceRect() ;

/// @brief Method get_sprite, addr 0x6b7cc14, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_sprite() ;

/// @brief Method get_tintColor, addr 0x6b7d4f8, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_tintColor() ;

/// @brief Method get_uv, addr 0x6b7d328, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_uv() ;

/// @brief Method get_vectorImage, addr 0x6b7cd48, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_image, addr 0x6b7cad8, size 0x13c, virtual false, abstract: false, final false
inline void set_image(::UnityEngine::Texture*  value) ;

/// @brief Method set_scaleMode, addr 0x6b7d420, size 0x24, virtual false, abstract: false, final false
inline void set_scaleMode(::UnityEngine::ScaleMode  value) ;

/// @brief Method set_sourceRect, addr 0x6b7d008, size 0x178, virtual false, abstract: false, final false
inline void set_sourceRect(::UnityEngine::Rect  value) ;

/// @brief Method set_sprite, addr 0x6b7cc1c, size 0x12c, virtual false, abstract: false, final false
inline void set_sprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_tintColor, addr 0x6b7d50c, size 0x64, virtual false, abstract: false, final false
inline void set_tintColor(::UnityEngine::Color  value) ;

/// @brief Method set_uv, addr 0x6b7d33c, size 0xdc, virtual false, abstract: false, final false
inline void set_uv(::UnityEngine::Rect  value) ;

/// @brief Method set_vectorImage, addr 0x6b7cd50, size 0x12c, virtual false, abstract: false, final false
