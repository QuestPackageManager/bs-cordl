...
public:
  ...
  /// @brief Method ReleasePointer addr 0x2db7f58 size 0xc4 virtual false final false
  static inline void ReleasePointer(::UnityEngine::UIElements::IPanel* panel, int32_t pointerId);

  /// @brief Method ActivateCompatibilityMouseEvents addr 0x2db804c size 0xc4 virtual false final false
  static inline void ActivateCompatibilityMouseEvents(::UnityEngine::UIElements::IPanel* panel, int32_t pointerId);

  /// @brief Method PreventCompatibilityMouseEvents addr 0x2db8144 size 0xc4 virtual false final false
  static inline void PreventCompatibilityMouseEvents(::UnityEngine::UIElements::IPanel* panel, int32_t pointerId);

  /// @brief Method ShouldSendCompatibilityMouseEvents addr 0x2db8238 size 0x124 virtual false final false
  ...
  /// @brief Method ProcessPointerCapture addr 0x2db8490 size 0xc4 virtual false final false
