...
public:
  ...
  /// @brief Method .ctor, addr 0x6ad7b5c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_bindingId, addr 0x6ad7b34, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BindingId get_bindingId();

  /// @brief Method get_dataSource, addr 0x6ad7b54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_dataSource();

  /// @brief Method get_dataSourcePath, addr 0x6ad7b44, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_dataSourcePath();

  /// @brief Method get_targetElement, addr 0x6ad7b2c, size 0x8, virtual false, abstract: false, final false
