...
/// @brief Method .ctor, addr 0x6a65914, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  targetElement, ::ByRef<::UnityEngine::UIElements::BindingId>  bindingId, ::ByRef<::Unity::Properties::PropertyPath>  resolvedDataSourcePath, ::System::Object*  resolvedDataSource) ;

/// @brief Method get_bindingId, addr 0x6a658ec, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BindingId get_bindingId() ;

/// @brief Method get_dataSource, addr 0x6a6590c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_dataSource() ;

/// @brief Method get_dataSourcePath, addr 0x6a658fc, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyPath get_dataSourcePath() ;

/// @brief Method get_targetElement, addr 0x6a658e4, size 0x8, virtual false, abstract: false, final false
