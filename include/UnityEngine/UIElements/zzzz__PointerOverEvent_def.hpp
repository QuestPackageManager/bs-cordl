...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7284), inst: 4741 }), TypeDefinitionIndex(TypeDefinitionIndex(7284))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2ce84b8 size 0x48 virtual false final false
  inline void _ctor();
