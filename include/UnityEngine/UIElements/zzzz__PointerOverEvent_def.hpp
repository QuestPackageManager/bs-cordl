...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6c4cd90, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::PointerOverEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6c4cd8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispatch, addr 0x6c4cce8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c4ccec, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::PointerOverEvent, 0xf8>, "Size mismatch!");
