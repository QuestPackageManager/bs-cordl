...
public:
  ...
  /// @brief Method get_profilerMarker addr 0x2d0f6e0 size 0x58 virtual true final false
  inline ::Unity::Profiling::ProfilerMarker get_profilerMarker();

  /// @brief Method OnVersionChanged addr 0x2d0f738 size 0x48 virtual true final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method Update addr 0x2d0f780 size 0x2ec virtual true final false
  inline void Update();

  /// @brief Method UpdateSubTree addr 0x2d0fa6c size 0x810 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d1027c size 0x8 virtual false final false
  inline void _ctor();
