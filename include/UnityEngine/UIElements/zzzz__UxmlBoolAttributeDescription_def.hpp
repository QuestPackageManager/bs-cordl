...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x4ab0418, size 0x10, virtual false, abstract: false, final false
  inline bool _GetValueFromBag_b__3_0(::StringW s, bool b);

  /// @brief Method .ctor, addr 0x4ab0410, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToBool, addr 0x4ab032c, size 0x88, virtual false, abstract: false, final false
  static inline bool ConvertValueToBool(::StringW v, bool defaultValue);

  /// @brief Method GetValueFromBag, addr 0x4ab01dc, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4aa745c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
