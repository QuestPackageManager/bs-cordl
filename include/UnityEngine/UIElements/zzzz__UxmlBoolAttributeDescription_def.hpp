...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x6b66b0c, size 0xc, virtual false, abstract: false, final false
  inline bool _GetValueFromBag_b__3_0(::StringW s, bool b);

  /// @brief Method .ctor, addr 0x6b66b08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToBool, addr 0x6b66a58, size 0x5c, virtual false, abstract: false, final false
  static inline bool ConvertValueToBool(::StringW v, bool defaultValue);

  /// @brief Method GetValueFromBag, addr 0x6b668bc, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b59934, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
