...
public:
  ...
  /// @brief Method <GetValueFromBag>b__3_0, addr 0x335e030, size 0x10, virtual false, abstract: false, final false
  inline bool _GetValueFromBag_b__3_0(::StringW s, bool b);

  /// @brief Method <TryGetValueFromBag>b__4_0, addr 0x335e040, size 0x10, virtual false, abstract: false, final false
  inline bool _TryGetValueFromBag_b__4_0(::StringW s, bool b);

  /// @brief Method .ctor, addr 0x335e028, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertValueToBool, addr 0x335df3c, size 0x88, virtual false, abstract: false, final false
  static inline bool ConvertValueToBool(::StringW v, bool defaultValue);

  /// @brief Method GetValueFromBag, addr 0x335dc5c, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method TryGetValueFromBag, addr 0x335ddc4, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335dbc0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
