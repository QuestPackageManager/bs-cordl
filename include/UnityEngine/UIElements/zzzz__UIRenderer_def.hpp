...
public:
  ...
  __declspec(property(get = __cordl_internal_get_commandLists, put = __cordl_internal_set_commandLists)) ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::CommandList*>*>
      commandLists;
