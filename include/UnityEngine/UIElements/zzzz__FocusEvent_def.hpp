...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6491)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6491), inst: 1943 })]
...
public:
  // Declarations
  /// @brief Method PreDispatch, addr 0x2e6d580, size 0xa8, virtual true, abstract: false, final false
  inline void PreDispatch(::UnityEngine::UIElements::IPanel* panel);

  static inline ::UnityEngine::UIElements::FocusEvent* New_ctor();

  /// @brief Method .ctor, addr 0x2e6d628, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
