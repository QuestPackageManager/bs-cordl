...
public:
  // Declarations
  /// @brief Method GetPooled addr 0x2e49a78 size 0x84 virtual false final false
  static inline ::UnityEngine::UIElements::IMGUIEvent* GetPooled(::UnityEngine::Event* systemEvent);

  /// @brief Method Init addr 0x2e49bb0 size 0x54 virtual true final false
  inline void Init();

  /// @brief Method LocalInit addr 0x2e49c04 size 0xc virtual false final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::IMGUIEvent* New_ctor();

  /// @brief Method .ctor addr 0x2e49c10 size 0x78 virtual false final false
  inline void _ctor();
