...
public:
  ...
  /// @brief Method <.cctor>b__0_0, addr 0x6c4e51c, size 0x54, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::IMGUIEvent* __cctor_b__0_0();

  /// @brief Method .ctor, addr 0x6c4e518, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispatch, addr 0x6c4e4c0, size 0x4, virtual true, abstract: false, final false
  inline void Dispatch(::UnityEngine::UIElements::BaseVisualElementPanel* panel);

  /// @brief Method GetPooled, addr 0x6c4e350, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::IMGUIEvent* GetPooled(::UnityEngine::Event* systemEvent);

  /// @brief Method Init, addr 0x6c4e3dc, size 0x58, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method LocalInit, addr 0x6c4e434, size 0xc, virtual false, abstract: false, final false
  inline void LocalInit();

  static inline ::UnityEngine::UIElements::IMGUIEvent* New_ctor();

  /// @brief Method .ctor, addr 0x6c4e440, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
