...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RuntimeEventDispatcher", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RuntimeEventDispatcher(RuntimeEventDispatcher&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RuntimeEventDispatcher", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RuntimeEventDispatcher(RuntimeEventDispatcherconst&) = delete;
