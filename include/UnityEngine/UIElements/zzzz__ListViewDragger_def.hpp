...
public:
  ...
  /// @brief Method Equals, addr 0x3358d54, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3358184, size 0x58, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::__ListViewDragger__DragPosition other);

  /// @brief Method GetHashCode, addr 0x3358df0, size 0x48, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyDragAndDropUI, addr 0x3357638, size 0x5e0, virtual false, abstract: false, final false
  inline void ApplyDragAndDropUI(::UnityEngine::UIElements::__ListViewDragger__DragPosition dragPosition);

  /// @brief Method CanStartDrag, addr 0x3356cd8, size 0x23c, virtual true, abstract: false, final false
  inline bool CanStartDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method ClearDragAndDropUI, addr 0x335883c, size 0x410, virtual true, abstract: false, final false
  inline void ClearDragAndDropUI();

  /// @brief Method GetRecycledItem, addr 0x3356f14, size 0x398, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ReusableCollectionItem* GetRecycledItem(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method GetVisualMode, addr 0x33574d4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleDragAndScroll, addr 0x3357c18, size 0x23c, virtual false, abstract: false, final false
  inline void HandleDragAndScroll(::UnityEngine::Vector2 pointerPosition);

  /// @brief Method MakeDragAndDropArgs, addr 0x3357e54, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x3357fa4, size 0x1e0, virtual true, abstract: false, final false
  inline void OnDrop(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method PlaceHoverBarAt, addr 0x33581dc, size 0x184, virtual false, abstract: false, final false
  inline void PlaceHoverBarAt(float_t top);

  /// @brief Method PlaceHoverBarAtElement, addr 0x3358360, size 0xbc, virtual false, abstract: false, final false
  inline void PlaceHoverBarAtElement(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method StartDrag, addr 0x33572ac, size 0x1bc, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::StartDragArgs* StartDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method TryGetDragPosition, addr 0x335841c, size 0x340, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateDrag, addr 0x3357468, size 0x6c, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::DragVisualMode UpdateDrag(::UnityEngine::Vector3 pointerPosition);

  /// @brief Method <ApplyDragAndDropUI>b__22_0, addr 0x3358c4c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3356b98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView* listView);

  /// @brief Method get_dragAndDropController, addr 0x3356b88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ICollectionDragAndDropController* get_dragAndDropController();

  /// @brief Method get_targetListView, addr 0x3356af0, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_targetListView();

  /// @brief Method get_targetScrollView, addr 0x3356b6c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ScrollView* get_targetScrollView();

  /// @brief Method set_dragAndDropController, addr 0x3356b90, size 0x8, virtual false, abstract: false, final false
