...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::PointerCaptureEvent*);
...
static_assert(sizeof(::UnityEngine::UIElements::PointerCaptureEvent___c) == 0x10, "Size mismatch!");
...
// Non member Declarations
static_assert(sizeof(::UnityEngine::UIElements::PointerCaptureEvent) == 0x78, "Size mismatch!");
