...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::IMouseEvent*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::IMouseEvent*, "UnityEngine.UIElements", "IMouseEvent");
// Dependencies
namespace UnityEngine::UIElements {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMouseEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMouseEvent(IMouseEventconst&) = delete;
