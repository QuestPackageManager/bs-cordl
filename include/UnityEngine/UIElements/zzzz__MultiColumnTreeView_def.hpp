...
public:
  ...
  /// @brief Method .ctor, addr 0x6c0910c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x6c09174, size 0x224, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c09398, size 0x180, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColumnsChanged, addr 0x6c08ea4, size 0x38, virtual false, abstract: false, final false
  inline void ColumnsChanged(::System::Object* sender, ::UnityEngine::UIElements::BindablePropertyChangedEventArgs args);

  /// @brief Method CreateViewController, addr 0x6c08b88, size 0x90, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController();

  /// @brief Method CreateVirtualizationController, addr 0x6c08e58, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method RaiseColumnSortingChanged, addr 0x6c088f8, size 0x1c, virtual false, abstract: false, final false
  inline void RaiseColumnSortingChanged();

  /// @brief Method RaiseHeaderContextMenuPopulate, addr 0x6c08edc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetViewController, addr 0x6c08c18, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c089e0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6c08a40, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method get_columns, addr 0x6c08684, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Columns* get_columns();

  /// @brief Method get_sortColumnDescriptions, addr 0x6c0880c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortColumnDescriptions();

  /// @brief Method get_sortingMode, addr 0x6c08914, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ColumnSortingMode get_sortingMode();

  /// @brief Method get_viewController, addr 0x6c085fc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method set_columns, addr 0x6c0868c, size 0x180, virtual false, abstract: false, final false
  inline void set_columns(::UnityEngine::UIElements::Columns* value);

  /// @brief Method set_sortColumnDescriptions, addr 0x6c08814, size 0xe4, virtual false, abstract: false, final false
  inline void set_sortColumnDescriptions(::UnityEngine::UIElements::SortColumnDescriptions* value);

  /// @brief Method set_sortingMode, addr 0x6c0891c, size 0xc4, virtual false, abstract: false, final false
