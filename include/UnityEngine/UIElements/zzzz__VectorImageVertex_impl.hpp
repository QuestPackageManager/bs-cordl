...
// "", def_value: Some("{}"), comment: None }, CppParam { name: "uv", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "settingIndex", ty:
// "uint32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "flags", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "circle", ty: "::UnityEngine::Vector4", modifiers: "", def_value: Some("{}"), comment: None }]
