...
public:
  ...
  /// @brief Method GetMovedUIControlTypeName, addr 0x4aa88e4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterEngineFactories, addr 0x4aa8b24, size 0x10c4, virtual false, abstract: false, final false
  static inline void RegisterEngineFactories();

  /// @brief Method RegisterFactory, addr 0x4aa9eb8, size 0x5d0, virtual false, abstract: false, final false
  static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory* factory);

  /// @brief Method RegisterUserFactories, addr 0x4aa9be8, size 0x2d0, virtual false, abstract: false, final false
  static inline void RegisterUserFactories();

  /// @brief Method TryGetValue, addr 0x4aaa488, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_factories, addr 0x4aa8a44, size 0xe0, virtual false, abstract: false, final false
