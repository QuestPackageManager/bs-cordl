...
public:
  ...
  /// @brief Method GetMovedUIControlTypeName, addr 0x6b68d70, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterEngineFactories, addr 0x6b68f84, size 0x1294, virtual false, abstract: false, final false
  static inline void RegisterEngineFactories();

  /// @brief Method RegisterFactory, addr 0x6b6a538, size 0x5dc, virtual false, abstract: false, final false
  static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory* factory);

  /// @brief Method RegisterUserFactories, addr 0x6b6a218, size 0x320, virtual false, abstract: false, final false
  static inline void RegisterUserFactories();

  /// @brief Method TryGetValue, addr 0x6b6ab14, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_factories, addr 0x6b68e60, size 0x124, virtual false, abstract: false, final false
