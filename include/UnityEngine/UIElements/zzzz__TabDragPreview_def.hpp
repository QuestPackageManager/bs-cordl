...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TabDragPreview", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TabDragPreview(TabDragPreview&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TabDragPreview", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TabDragPreview(TabDragPreviewconst&) = delete;
