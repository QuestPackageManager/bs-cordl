...
/// @brief Method Equals, addr 0x6ac756c, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6ac7548, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleBackgroundRepeat  other) ;

/// @brief Method GetHashCode, addr 0x6ac75f8, size 0x2c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x6ac7624, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6ac752c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x6ac5bb8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundRepeat  v) ;

/// @brief Method .ctor, addr 0x6ac7520, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundRepeat  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x6ac7510, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x6ac74e0, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x6ac7538, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x6ac5bc4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_keyword, addr 0x6ac7518, size 0x8, virtual true, abstract: false, final true
inline void set_keyword(::UnityEngine::UIElements::StyleKeyword  value) ;

/// @brief Method set_value, addr 0x6ac7504, size 0xc, virtual true, abstract: false, final true
