...
template<typename TEventType,typename TCallbackArgs>
inline ::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>* UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::GetPooled(int64_t  eventTypeId, ::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*  callback, TCallbackArgs  userArgs, ::UnityEngine::UIElements::InvokePolicy  invokePolicy)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>*>::get(),
                        "GetPooled",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int64_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TCallbackArgs>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::InvokePolicy>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>*, false>(nullptr, ___internal_method, eventTypeId, callback, userArgs, invokePolicy);
}
template<typename TEventType,typename TCallbackArgs>
