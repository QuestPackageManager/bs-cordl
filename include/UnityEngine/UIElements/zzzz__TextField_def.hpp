...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7182)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7182), inst: 393 })}
...
public:
  ...
  /// @brief Method Init addr 0x2cc1f88 size 0x114 virtual true final false
  inline void Init(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::IUxmlAttributes* bag, ::UnityEngine::UIElements::CreationContext cc);

  static inline ::UnityEngine::UIElements::__TextField__UxmlTraits* New_ctor();

  /// @brief Method .ctor addr 0x2cc209c size 0xa0 virtual false final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7184), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(7184))}
...
public:
  ...
  /// @brief Method get_textInput addr 0x2cc186c size 0x84 virtual false final false
  inline ::UnityEngine::UIElements::__TextField__TextInput* get_textInput();

  /// @brief Method set_multiline addr 0x2cc18f0 size 0x20 virtual false final false
  inline void set_multiline(bool value);

  static inline ::UnityEngine::UIElements::TextField* New_ctor();

  /// @brief Method .ctor addr 0x2cc19dc size 0x18 virtual false final false
  inline void _ctor();

  static inline ::UnityEngine::UIElements::TextField* New_ctor(::StringW label);

  /// @brief Method .ctor addr 0x2cc19f4 size 0x14 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2cc1a08 size 0x1dc virtual false final false
  inline void _ctor(::StringW label, int32_t maxLength, bool multiline, bool isPasswordField, char16_t maskChar);

  /// @brief Method get_value addr 0x2cc1c2c size 0x48 virtual true final false
  inline ::StringW get_value();

  /// @brief Method set_value addr 0x2cc1c74 size 0xa4 virtual true final false
  inline void set_value(::StringW value);

  /// @brief Method SetValueWithoutNotify addr 0x2cc1d18 size 0xa4 virtual true final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method OnViewDataReady addr 0x2cc1dbc size 0xb4 virtual true final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7147)), TypeDefinitionIndex(TypeDefinitionIndex(7083)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7083), inst: 5164
// }), TypeDefinitionIndex(TypeDefinitionIndex(7145))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7144)) CS Name: ::TextField::UxmlFactory*
...
public:
  ...
  /// @brief Method .ctor addr 0x2cc1f40 size 0x48 virtual false final false
  inline void _ctor();
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7183)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7183), inst: 393 })}
...
public:
  ...
  /// @brief Method get_parentTextField addr 0x2cc213c size 0x80 virtual false final false
  inline ::UnityEngine::UIElements::TextField* get_parentTextField();

  /// @brief Method get_multiline addr 0x2cc21bc size 0x8 virtual false final false
  inline bool get_multiline();

  /// @brief Method set_multiline addr 0x2cc1910 size 0xcc virtual false final false
  inline void set_multiline(bool value);

  /// @brief Method SetTextAlign addr 0x2cc21c4 size 0xa0 virtual false final false
  inline void SetTextAlign();

  /// @brief Method set_isPasswordField addr 0x2cc2264 size 0x5c virtual true final false
  inline void set_isPasswordField(bool value);

  /// @brief Method StringToValue addr 0x2cc22c0 size 0x8 virtual true final false
  inline ::StringW StringToValue(::StringW str);

  /// @brief Method SyncTextEngine addr 0x2cc22c8 size 0x90 virtual true final false
  inline void SyncTextEngine();

  /// @brief Method ExecuteDefaultActionAtTarget addr 0x2cc2358 size 0x730 virtual true final false
  inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultAction addr 0x2cc2a88 size 0x18c virtual true final false
  ...
  /// @brief Method .ctor addr 0x2cc1be4 size 0x48 virtual false final false
  inline void _ctor();
