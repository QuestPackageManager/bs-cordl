...
public:
  ...
  /// @brief Method .ctor, addr 0x357e18c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x357e1d4, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357e2e8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ExecuteDefaultAction, addr 0x357ecd4, size 0x18c, virtual true, abstract: false, final false
  inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase* evt);

  /// @brief Method ExecuteDefaultActionAtTarget, addr 0x357e5a4, size 0x730, virtual true, abstract: false, final false
  ...
  /// @brief Method SetTextAlign, addr 0x357e410, size 0xa0, virtual false, abstract: false, final false
  inline void SetTextAlign();

  /// @brief Method StringToValue, addr 0x357e50c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW StringToValue(::StringW str);

  /// @brief Method SyncTextEngine, addr 0x357e514, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357de30, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_multiline, addr 0x357e408, size 0x8, virtual false, abstract: false, final false
  inline bool get_multiline();

  /// @brief Method get_parentTextField, addr 0x357e388, size 0x80, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::TextField* get_parentTextField();

  /// @brief Method set_isPasswordField, addr 0x357e4b0, size 0x5c, virtual true, abstract: false, final false
  inline void set_isPasswordField(bool value);

  /// @brief Method set_multiline, addr 0x357db5c, size 0xcc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnViewDataReady, addr 0x357e008, size 0xb4, virtual true, abstract: false, final false
  inline void OnViewDataReady();

  /// @brief Method SetValueWithoutNotify, addr 0x357df64, size 0xa4, virtual true, abstract: false, final false
  inline void SetValueWithoutNotify(::StringW newValue);

  /// @brief Method .ctor, addr 0x357dc28, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x357dc40, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::StringW label);

  /// @brief Method .ctor, addr 0x357dc54, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_textInput, addr 0x357dab8, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__TextField__TextInput* get_textInput();

  /// @brief Method get_value, addr 0x357de78, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method set_multiline, addr 0x357db3c, size 0x20, virtual false, abstract: false, final false
  inline void set_multiline(bool value);

  /// @brief Method set_value, addr 0x357dec0, size 0xa4, virtual true, abstract: false, final false
