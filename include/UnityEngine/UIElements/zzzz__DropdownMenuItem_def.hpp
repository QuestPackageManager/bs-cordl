...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::DropdownMenuItem*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::DropdownMenuItem*, "UnityEngine.UIElements", "DropdownMenuItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6d908bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEngine::UIElements::DropdownMenuItem) == 0x10, "Size mismatch!");
