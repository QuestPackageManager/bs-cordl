...
public:
  ...
  /// @brief Method get_MeasuredSizes addr 0x2e457f8 size 0x8 virtual true final true
  inline ::UnityEngine::Vector2 get_MeasuredSizes();

  /// @brief Method set_MeasuredSizes addr 0x2e45800 size 0x8 virtual true final true
  inline void set_MeasuredSizes(::UnityEngine::Vector2 value);

  /// @brief Method get_RoundedSizes addr 0x2e45808 size 0x8 virtual true final true
  inline ::UnityEngine::Vector2 get_RoundedSizes();

  /// @brief Method set_RoundedSizes addr 0x2e45810 size 0x8 virtual true final true
  inline void set_RoundedSizes(::UnityEngine::Vector2 value);

  /// @brief Method New addr 0x2e45818 size 0xc0 virtual false final false
  static inline ::UnityEngine::UIElements::ITextHandle* New();

  /// @brief Method get_textInfoMesh addr 0x2e458d8 size 0x6c virtual false final false
  inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfoMesh();

  /// @brief Method get_textInfoLayout addr 0x2e45944 size 0xc0 virtual false final false
  static inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfoLayout();

  /// @brief Method IsLegacy addr 0x2e45a04 size 0x8 virtual true final true
  inline bool IsLegacy();

  /// @brief Method IsDirty addr 0x2e45a0c size 0x44 virtual false final false
  inline bool IsDirty(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms);

  /// @brief Method GetCursorPosition addr 0x2e45a50 size 0x28 virtual true final true
  ...
  /// @brief Method Update addr 0x2e45c78 size 0x208 virtual true final true
  ...
  /// @brief Method UpdatePreferredValues addr 0x2e45aac size 0x130 virtual false final false
  inline void UpdatePreferredValues(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms);

  /// @brief Method GetTextOverflowMode addr 0x2e4612c size 0x3c virtual false final false
  ...
  /// @brief Method UpdateGenerationSettingsCommon addr 0x2e45e80 size 0x2ac virtual false final false
  ...
  /// @brief Method IsElided addr 0x2e46348 size 0x64 virtual true final true
