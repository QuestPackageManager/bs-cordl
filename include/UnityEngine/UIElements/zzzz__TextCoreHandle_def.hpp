...
public:
  ...
  /// @brief Method ComputeTextHeight, addr 0x35dbdf8, size 0x34, virtual true, abstract: false, final true
  inline float_t ComputeTextHeight(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method ComputeTextWidth, addr 0x35dbc94, size 0x34, virtual true, abstract: false, final true
  inline float_t ComputeTextWidth(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms, float_t scaling);

  /// @brief Method GetCursorPosition, addr 0x35dbc6c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLineHeight, addr 0x35dbe2c, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method GetTextOverflowMode, addr 0x35dc348, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDirty, addr 0x35dbc28, size 0x44, virtual false, abstract: false, final false
  inline bool IsDirty(::UnityEngine::UIElements::__MeshGenerationContextUtils__TextParams parms);

  /// @brief Method IsElided, addr 0x35dc564, size 0x64, virtual true, abstract: false, final true
  inline bool IsElided();

  /// @brief Method IsLegacy, addr 0x35dbc20, size 0x8, virtual true, abstract: false, final true
  inline bool IsLegacy();

  /// @brief Method New, addr 0x35dba34, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::ITextHandle* New();

  /// @brief Method Update, addr 0x35dbe94, size 0x208, virtual true, abstract: false, final true
  ...
  /// @brief Method UpdateGenerationSettingsCommon, addr 0x35dc09c, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdatePreferredValues, addr 0x35dbcc8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MeasuredSizes, addr 0x35dba14, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_MeasuredSizes();

  /// @brief Method get_RoundedSizes, addr 0x35dba24, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector2 get_RoundedSizes();

  /// @brief Method get_textInfoLayout, addr 0x35dbb60, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityEngine::TextCore::Text::TextInfo* get_textInfoLayout();

  /// @brief Method get_textInfoMesh, addr 0x35dbaf4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_MeasuredSizes, addr 0x35dba1c, size 0x8, virtual true, abstract: false, final true
  inline void set_MeasuredSizes(::UnityEngine::Vector2 value);

  /// @brief Method set_RoundedSizes, addr 0x35dba2c, size 0x8, virtual true, abstract: false, final true
