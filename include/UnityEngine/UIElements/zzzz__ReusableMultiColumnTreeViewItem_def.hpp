...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReusableMultiColumnTreeViewItem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReusableMultiColumnTreeViewItem(ReusableMultiColumnTreeViewItem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReusableMultiColumnTreeViewItem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReusableMultiColumnTreeViewItem(ReusableMultiColumnTreeViewItemconst&) = delete;
