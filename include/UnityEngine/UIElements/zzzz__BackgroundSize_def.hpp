...
public:
  ...
  /// @brief Method Equals, addr 0x4970e84, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4970f14, size 0x5c, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::BackgroundSize other);

  /// @brief Method GetHashCode, addr 0x4970f70, size 0x5c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Initial, addr 0x4970e34, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::BackgroundSize Initial();

  /// @brief Method ToString, addr 0x4971014, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x497079c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::BackgroundSizeType sizeType);

  /// @brief Method .ctor, addr 0x49707f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Length sizeX, ::UnityEngine::UIElements::Length sizeY);

  /// @brief Method get_sizeType, addr 0x4970db0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BackgroundSizeType get_sizeType();

  /// @brief Method get_x, addr 0x4970e0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length get_x();

  /// @brief Method get_y, addr 0x4970e20, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4970bc0, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::BackgroundSize style1, ::UnityEngine::UIElements::BackgroundSize style2);

  /// @brief Method op_Inequality, addr 0x4970fcc, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_sizeType, addr 0x4970db8, size 0x54, virtual false, abstract: false, final false
  inline void set_sizeType(::UnityEngine::UIElements::BackgroundSizeType value);

  /// @brief Method set_x, addr 0x4970e14, size 0xc, virtual false, abstract: false, final false
  inline void set_x(::UnityEngine::UIElements::Length value);

  /// @brief Method set_y, addr 0x4970e28, size 0xc, virtual false, abstract: false, final false
