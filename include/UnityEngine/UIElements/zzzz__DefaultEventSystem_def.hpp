...
public:
  ...
  /// @brief Method GetAxisRaw, addr 0x3534d24, size 0xc, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x3534d18, size 0xc, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetTouch, addr 0x3534d38, size 0x38, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::__DefaultEventSystem__Input* New_ctor();

  /// @brief Method .ctor, addr 0x35335f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mousePresent, addr 0x3534d70, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x3534d30, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();
...
public:
  ...
  /// @brief Method GetAxisRaw, addr 0x3534d80, size 0x8, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x3534d78, size 0x8, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetTouch, addr 0x3534d90, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::__DefaultEventSystem__NoInput* New_ctor();

  /// @brief Method .ctor, addr 0x35335f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mousePresent, addr 0x3534da4, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x3534d88, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();
...
public:
  ...
  /// @brief Method <ProcessTouchEvents>b__30_0, addr 0x35350a4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__23_0, addr 0x3534e18, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendIMGUIEvents_b__23_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendIMGUIEvents>b__23_1, addr 0x3534e7c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__23_2, addr 0x3534f08, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendInputEvents>b__24_0, addr 0x3534fbc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__24_1, addr 0x3534fdc, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_1(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__24_2, addr 0x3535040, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__24_2(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <.cctor>b__41_0, addr 0x3535170, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__41_0();

  /// @brief Method .ctor, addr 0x3534e10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetDefaultInput, addr 0x353345c, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__DefaultEventSystem__IInput* GetDefaultInput();

  /// @brief Method GetLocalScreenPosition, addr 0x35343d0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRawMoveVector, addr 0x35348a8, size 0x2b8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  /// @brief Method MakeTouchEvent, addr 0x3534718, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessTouchEvents, addr 0x3533764, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method SendIMGUIEvents, addr 0x3533bb4, size 0x4c0, virtual false, abstract: false, final false
  inline void SendIMGUIEvents();

  /// @brief Method SendInputEvents, addr 0x3534074, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldIgnoreEventsOnAppNotFocused, addr 0x3533600, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldIgnoreEventsOnAppNotFocused();

  /// @brief Method ShouldSendMoveFromInput, addr 0x35343ec, size 0x2b8, virtual false, abstract: false, final false
  inline bool ShouldSendMoveFromInput();

  /// @brief Method Update, addr 0x35336f8, size 0x6c, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::UIElements::__DefaultEventSystem__UpdateMode updateMode);

  /// @brief Method UpdateFocusedPanel, addr 0x35346a4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3534b60, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Func_1<bool>* getStaticF_IsEditorRemoteConnected();

  /// @brief Method get_focusedPanel, addr 0x3533620, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseRuntimePanel* get_focusedPanel();

  /// @brief Method get_input, addr 0x3533438, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::__DefaultEventSystem__IInput* get_input();

  /// @brief Method get_isAppFocused, addr 0x3533430, size 0x8, virtual false, abstract: false, final false
  inline bool get_isAppFocused();

  static inline void setStaticF_IsEditorRemoteConnected(::System::Func_1<bool>* value);

  /// @brief Method set_focusedPanel, addr 0x3533628, size 0x78, virtual false, abstract: false, final false
