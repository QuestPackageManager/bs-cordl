...
public:
  ...
  /// @brief Method Dispose, addr 0x4a11520, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x4a10828, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearLastPenContactEvent, addr 0x4a11554, size 0x8, virtual true, abstract: false, final true
  inline void ClearLastPenContactEvent();

  /// @brief Method GetAxisRaw, addr 0x4a11548, size 0xc, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x4a1153c, size 0xc, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetLastPenContactEvent, addr 0x4a1155c, size 0x38, virtual true, abstract: false, final true
  inline ::UnityEngine::PenData GetLastPenContactEvent();

  /// @brief Method GetMouseButtonDown, addr 0x4a115dc, size 0xc, virtual true, abstract: false, final true
  inline bool GetMouseButtonDown(int32_t button);

  /// @brief Method GetMouseButtonUp, addr 0x4a115e8, size 0xc, virtual true, abstract: false, final true
  inline bool GetMouseButtonUp(int32_t button);

  /// @brief Method GetTouch, addr 0x4a1159c, size 0x38, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::DefaultEventSystem_Input* New_ctor();

  /// @brief Method .ctor, addr 0x4a0eb58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_anyKey, addr 0x4a11604, size 0x8, virtual true, abstract: false, final true
  inline bool get_anyKey();

  /// @brief Method get_doubleClickTime, addr 0x4a11614, size 0x24, virtual true, abstract: false, final true
  inline float_t get_doubleClickTime();

  /// @brief Method get_mouseButtonCount, addr 0x4a115fc, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_mouseButtonCount();

  /// @brief Method get_mousePosition, addr 0x4a115f4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 get_mousePosition();

  /// @brief Method get_mousePresent, addr 0x4a115d4, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x4a11594, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();

  /// @brief Method get_unscaledTime, addr 0x4a1160c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_unscaledTime();
...
public:
  ...
  /// @brief Method ClearLastPenContactEvent, addr 0x4a11664, size 0x4, virtual true, abstract: false, final true
  inline void ClearLastPenContactEvent();

  /// @brief Method GetAxisRaw, addr 0x4a11640, size 0x8, virtual true, abstract: false, final true
  inline float_t GetAxisRaw(::StringW axis);

  /// @brief Method GetButtonDown, addr 0x4a11638, size 0x8, virtual true, abstract: false, final true
  inline bool GetButtonDown(::StringW button);

  /// @brief Method GetLastPenContactEvent, addr 0x4a11668, size 0x10, virtual true, abstract: false, final true
  inline ::UnityEngine::PenData GetLastPenContactEvent();

  /// @brief Method GetMouseButtonDown, addr 0x4a11680, size 0x8, virtual true, abstract: false, final true
  inline bool GetMouseButtonDown(int32_t button);

  /// @brief Method GetMouseButtonUp, addr 0x4a11688, size 0x8, virtual true, abstract: false, final true
  inline bool GetMouseButtonUp(int32_t button);

  /// @brief Method GetTouch, addr 0x4a11650, size 0x14, virtual true, abstract: false, final true
  inline ::UnityEngine::Touch GetTouch(int32_t index);

  static inline ::UnityEngine::UIElements::DefaultEventSystem_NoInput* New_ctor();

  /// @brief Method .ctor, addr 0x4a0eb60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_anyKey, addr 0x4a116a8, size 0x8, virtual true, abstract: false, final true
  inline bool get_anyKey();

  /// @brief Method get_doubleClickTime, addr 0x4a116b8, size 0xc, virtual true, abstract: false, final true
  inline float_t get_doubleClickTime();

  /// @brief Method get_mouseButtonCount, addr 0x4a116a0, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_mouseButtonCount();

  /// @brief Method get_mousePosition, addr 0x4a11690, size 0x10, virtual true, abstract: false, final true
  inline ::UnityEngine::Vector3 get_mousePosition();

  /// @brief Method get_mousePresent, addr 0x4a11678, size 0x8, virtual true, abstract: false, final true
  inline bool get_mousePresent();

  /// @brief Method get_touchCount, addr 0x4a11648, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_touchCount();

  /// @brief Method get_unscaledTime, addr 0x4a116b0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_unscaledTime();
...
public:
  ...
  /// @brief Method <ProcessMouseEvents>b__36_0, addr 0x4a118d0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessMouseEvents>b__36_1, addr 0x4a1196c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessMouseEvents>b__36_2, addr 0x4a11980, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessPenEvents>b__46_0, addr 0x4a11cc4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessTabEvent>b__53_0, addr 0x4a11d70, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method <ProcessTouchEvents>b__45_0, addr 0x4a11bf8, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__30_0, addr 0x4a11728, size 0x64, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendIMGUIEvents_b__30_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendIMGUIEvents>b__30_1, addr 0x4a1178c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendIMGUIEvents>b__30_2, addr 0x4a11828, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method <SendInputEvents>b__37_0, addr 0x4a11994, size 0x94, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__37_0(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__37_1, addr 0x4a11a28, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__37_1(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <SendInputEvents>b__37_2, addr 0x4a11b10, size 0xe8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::EventBase* _SendInputEvents_b__37_2(::UnityEngine::UIElements::DefaultEventSystem* self);

  /// @brief Method <.cctor>b__58_0, addr 0x4a11e5c, size 0x8, virtual false, abstract: false, final false
  inline bool __cctor_b__58_0();

  /// @brief Method .ctor, addr 0x4a11720, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FocusBasedEventSequence, addr 0x4a0fd4c, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DefaultEventSystem_FocusBasedEventSequenceContext FocusBasedEventSequence();

  /// @brief Method GetDefaultInput, addr 0x4a0e9c4, size 0x194, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DefaultEventSystem_IInput* GetDefaultInput();

  /// @brief Method GetRawMoveVector, addr 0x4a11080, size 0x2b4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetRawMoveVector();

  /// @brief Method MakePenEvent, addr 0x4a10fc8, size 0xb8, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::EventBase* MakePenEvent(::UnityEngine::PenData pen, ::UnityEngine::EventModifiers modifiers);

  /// @brief Method MakeTouchEvent, addr 0x4a10e48, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method OnFocusEvent, addr 0x4a10dcc, size 0x4, virtual false, abstract: false, final false
  inline void OnFocusEvent(::UnityEngine::UIElements::RuntimePanel* panel, ::UnityEngine::UIElements::FocusEvent* evt);

  /// @brief Method ProcessMouseEvents, addr 0x4a0f400, size 0x94c, virtual false, abstract: false, final false
  inline void ProcessMouseEvents();

  /// @brief Method ProcessPenEvents, addr 0x4a0ece8, size 0x2cc, virtual false, abstract: false, final false
  inline bool ProcessPenEvents();

  /// @brief Method ProcessTabEvent, addr 0x4a10870, size 0x188, virtual false, abstract: false, final false
  inline void ProcessTabEvent(::UnityEngine::Event* e, ::UnityEngine::EventModifiers modifiers);

  /// @brief Method ProcessTouchEvents, addr 0x4a0efb4, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendIMGUIEvents, addr 0x4a0fd6c, size 0x758, virtual false, abstract: false, final false
  inline void SendIMGUIEvents();

  /// @brief Method SendInputEvents, addr 0x4a104c4, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldIgnoreEventsOnAppNotFocused, addr 0x4a0eb68, size 0x20, virtual false, abstract: false, final false
  inline bool ShouldIgnoreEventsOnAppNotFocused();

  /// @brief Method ShouldSendMoveFromInput, addr 0x4a109f8, size 0x3d4, virtual false, abstract: false, final false
  inline bool ShouldSendMoveFromInput();

  /// @brief Method Update, addr 0x4a0ebe0, size 0x108, virtual false, abstract: false, final false
  inline void Update(::UnityEngine::UIElements::DefaultEventSystem_UpdateMode updateMode);

  /// @brief Method UpdateFocusedPanel, addr 0x4a10dd0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a11334, size 0x128, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Func_1<bool>* getStaticF_IsEditorRemoteConnected();

  /// @brief Method get_focusedPanel, addr 0x4a0eb88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::BaseRuntimePanel* get_focusedPanel();

  /// @brief Method get_input, addr 0x4a0e9a0, size 0x24, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DefaultEventSystem_IInput* get_input();

  /// @brief Method get_isAppFocused, addr 0x4a0e950, size 0x50, virtual false, abstract: false, final false
  inline bool get_isAppFocused();

  static inline void setStaticF_IsEditorRemoteConnected(::System::Func_1<bool>* value);

  /// @brief Method set_focusedPanel, addr 0x4a0eb90, size 0x50, virtual false, abstract: false, final false
