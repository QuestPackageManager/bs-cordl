...
public:
  ...
  /// @brief Method .ctor, addr 0x4a24df0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CompareId, addr 0x4a234e8, size 0x644, virtual true, abstract: false, final false
  inline int32_t CompareId(int32_t id1, int32_t id2);

  /// @brief Method DelayExpandDropItem, addr 0x4a24a34, size 0x218, virtual false, abstract: false, final false
  inline void DelayExpandDropItem();

  /// @brief Method DragCleanup, addr 0x4a24464, size 0x140, virtual true, abstract: false, final false
  inline void DragCleanup();

  /// @brief Method ExpandDropItem, addr 0x4a24c4c, size 0x1a4, virtual false, abstract: false, final false
  inline void ExpandDropItem();

  /// @brief Method HandleAutoExpand, addr 0x4a24900, size 0x134, virtual true, abstract: false, final false
  inline void HandleAutoExpand(::UnityEngine::UIElements::ReusableCollectionItem* item, ::UnityEngine::Vector2 pointerPosition);

  /// @brief Method HandleDragAndDrop, addr 0x4a23bd0, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDrop, addr 0x4a23cb8, size 0x7ac, virtual true, abstract: false, final false
  inline void OnDrop(::UnityEngine::UIElements::IListDragAndDropArgs* args);

  /// @brief Method RestoreExpanded, addr 0x4a245a4, size 0x35c, virtual false, abstract: false, final false
  inline void RestoreExpanded(::System::Collections::Generic::List_1<int32_t>* ids);

  /// @brief Method SetupDragAndDrop, addr 0x4a23b2c, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a23424, size 0xc4, virtual false, abstract: false, final false
