...
inline float_t _GetContentHeightForIndex_g__GetContentHeightFromCachedHeight_69_0(int32_t  index, ::ByRef<::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo<T>>  heightInfo, ::ByRef<::UnityEngine::UIElements::DynamicHeightVirtualizationController_1___c__DisplayClass69_0<T>>  _cordl_fixed_empty_name_whitespace) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ScrollDirection, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ScrollDirection");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_VirtualizationChange, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/VirtualizationChange");
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1_ContentHeightCacheInfo, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ContentHeightCacheInfo");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::DynamicHeightVirtualizationController_1___c__DisplayClass69_0, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/<>c__DisplayClass69_0");
