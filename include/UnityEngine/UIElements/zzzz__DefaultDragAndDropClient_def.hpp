...
public:
  ...
  /// @brief Method AcceptDrag, addr 0x6c316b4, size 0x4, virtual true, abstract: false, final true
  inline void AcceptDrag();

  /// @brief Method DragCleanup, addr 0x6c316c0, size 0x54, virtual true, abstract: false, final true
  inline void DragCleanup();

  /// @brief Method GetGenericData, addr 0x6c30e0c, size 0x64, virtual true, abstract: false, final false
  inline ::System::Object* GetGenericData(::StringW key);

  static inline ::UnityEngine::UIElements::DefaultDragAndDropClient* New_ctor();

  /// @brief Method SetVisualMode, addr 0x6c316b8, size 0x8, virtual true, abstract: false, final true
  inline void SetVisualMode(::UnityEngine::UIElements::DragVisualMode mode);

  /// @brief Method StartDrag, addr 0x6c30e70, size 0x6a4, virtual true, abstract: false, final true
  inline void StartDrag(::UnityEngine::UIElements::StartDragArgs args, ::UnityEngine::Vector3 pointerPosition);

  /// @brief Method UpdateDrag, addr 0x6c31514, size 0x1a0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6c30d58, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x6c31714, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::DragAndDropData* get_data();

  /// @brief Method get_source, addr 0x6c30db8, size 0x54, virtual true, abstract: false, final false
