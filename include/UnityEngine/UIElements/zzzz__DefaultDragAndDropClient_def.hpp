...
public:
  ...
  /// @brief Method StartDrag, addr 0x358c688, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x358c668, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x358a9c0, size 0x4, virtual true, abstract: false, final true
  inline ::UnityEngine::UIElements::IDragAndDropData* get_data();

  /// @brief Method get_userData, addr 0x358c670, size 0x18, virtual true, abstract: false, final true
