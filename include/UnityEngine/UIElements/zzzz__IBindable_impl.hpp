...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEngine::UIElements::IBinding* (::UnityEngine::UIElements::IBindable::*)()>(&::UnityEngine::UIElements::IBindable::get_binding)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), { ::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEngine::UIElements::IBindable::*)(::StringW)>(&::UnityEngine::UIElements::IBindable::set_bindingPath)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), { ::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), 1 }));
    return ___internal_method;
  }
};
inline ::UnityEngine::UIElements::IBinding* UnityEngine::UIElements::IBindable::get_binding() {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), 0 })));
...
inline void UnityEngine::UIElements::IBindable::set_bindingPath(::StringW value) {
  auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::UnityEngine::UIElements::IBindable*>(), 1 })));
