...
public:
// Declarations
/// @brief Method .ctor, addr 0x6a7db00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <ProcessDataSourceChangedRequests>b__29_0, addr 0x6a7dfb0, size 0x1c, virtual false, abstract: false, final false
inline bool _ProcessDataSourceChangedRequests_b__29_0(::UnityEngine::UIElements::VisualElement*  e) ;

/// @brief Method .ctor, addr 0x6a7dfac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_BindingRegistrationRequests, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_BindingRegistrationRequests, put=__cordl_internal_set_m_BindingRegistrationRequests)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*  m_BindingRegistrationRequests;

/// @brief Field m_BoundsElement, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_BoundsElement, put=__cordl_internal_set_m_BoundsElement)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*  m_BoundsElement;

/// @brief Field m_DataSourceChangedRequests, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DataSourceChangedRequests, put=__cordl_internal_set_m_DataSourceChangedRequests)) ::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::VisualElement*>*  m_DataSourceChangedRequests;

/// @brief Field m_DirtyBindings, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DirtyBindings, put=__cordl_internal_set_m_DirtyBindings)) ::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::Binding*>*  m_DirtyBindings;
...
/// @brief Field m_RemovedElements, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RemovedElements, put=__cordl_internal_set_m_RemovedElements)) ::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::VisualElement*>*  m_RemovedElements;
...
/// @brief Field m_VersionChanges, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_VersionChanges, put=__cordl_internal_set_m_VersionChanges)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualTreeDataBindingsUpdater_VersionInfo>*  m_VersionChanges;
...
/// @brief Field s_ProcessBindingRequestsProfilerMarker, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ProcessBindingRequestsProfilerMarker, put=setStaticF_s_ProcessBindingRequestsProfilerMarker)) ::Unity::Profiling::ProfilerMarker  s_ProcessBindingRequestsProfilerMarker;
...
/// @brief Field s_ShouldUpdateBindingProfilerMarker, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ShouldUpdateBindingProfilerMarker, put=setStaticF_s_ShouldUpdateBindingProfilerMarker)) ::Unity::Profiling::ProfilerMarker  s_ShouldUpdateBindingProfilerMarker;
...
/// @brief Method CacheAndLogBindingResult, addr 0x6a7c150, size 0x130, virtual false, abstract: false, final false
inline void CacheAndLogBindingResult(bool  appliedOnUiCache, ::ByRef<::UnityEngine::UIElements::DataBindingManager_BindingData*>  bindingData, ::ByRef<::UnityEngine::UIElements::BindingResult>  result) ;

/// @brief Method Dispose, addr 0x6a7dd64, size 0x40, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetDataSourceVersion, addr 0x6a7d954, size 0x1ac, virtual false, abstract: false, final false
inline ::System::ValueTuple_2<bool,int64_t> GetDataSourceVersion(::System::Object*  source) ;

/// @brief Method IsPrefix, addr 0x6a7db08, size 0x16c, virtual false, abstract: false, final false
inline bool IsPrefix(::ByRef<::Unity::Properties::PropertyPath>  prefix, ::ByRef<::Unity::Properties::PropertyPath>  path) ;

/// @brief Method LogResult, addr 0x6a7c280, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method OnHierarchyChange, addr 0x6a7bc74, size 0x3e0, virtual false, abstract: false, final false
...
/// @brief Method OnPanelChanged, addr 0x6a7dc74, size 0xf0, virtual false, abstract: false, final false
inline void OnPanelChanged(::UnityEngine::UIElements::BaseVisualElementPanel*  p) ;

/// @brief Method OnVersionChanged, addr 0x6a7c054, size 0xfc, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method ProcessAllBindingRequests, addr 0x6a7d16c, size 0x1f0, virtual false, abstract: false, final false
inline void ProcessAllBindingRequests() ;

/// @brief Method ProcessBindingRequests, addr 0x6a7dda4, size 0x38, virtual false, abstract: false, final false
inline void ProcessBindingRequests(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method ProcessDataSourceChangedRequests, addr 0x6a7d35c, size 0x2d0, virtual false, abstract: false, final false
inline void ProcessDataSourceChangedRequests() ;

/// @brief Method ProcessPropertyChangedEvents, addr 0x6a7d62c, size 0x328, virtual false, abstract: false, final false
inline void ProcessPropertyChangedEvents(::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::Binding*>*  ranUpdate) ;

/// @brief Method Update, addr 0x6a7c3c4, size 0xda8, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x6a7b9f0, size 0x284, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_bindingManager, addr 0x6a7b974, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DataBindingManager* get_bindingManager() ;

/// @brief Method get_profilerMarker, addr 0x6a7b994, size 0x5c, virtual true, abstract: false, final false
