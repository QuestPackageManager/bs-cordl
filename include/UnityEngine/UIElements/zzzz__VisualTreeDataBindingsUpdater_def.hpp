...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6aefd48, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ProcessDataSourceChangedRequests>b__29_0, addr 0x6af01f8, size 0x1c, virtual false, abstract: false, final false
  inline bool _ProcessDataSourceChangedRequests_b__29_0(::UnityEngine::UIElements::VisualElement* e);

  /// @brief Method .ctor, addr 0x6af01f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CacheAndLogBindingResult, addr 0x6aee398, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6aeffac, size 0x40, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method GetDataSourceVersion, addr 0x6aefb9c, size 0x1ac, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<bool, int64_t> GetDataSourceVersion(::System::Object* source);

  /// @brief Method IsPrefix, addr 0x6aefd50, size 0x16c, virtual false, abstract: false, final false
  inline bool IsPrefix(::ByRef<::Unity::Properties::PropertyPath> prefix, ::ByRef<::Unity::Properties::PropertyPath> path);

  /// @brief Method LogResult, addr 0x6aee4c8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method OnHierarchyChange, addr 0x6aedebc, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnPanelChanged, addr 0x6aefebc, size 0xf0, virtual false, abstract: false, final false
  inline void OnPanelChanged(::UnityEngine::UIElements::BaseVisualElementPanel* p);

  /// @brief Method OnVersionChanged, addr 0x6aee29c, size 0xfc, virtual true, abstract: false, final false
  inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement* ve, ::UnityEngine::UIElements::VersionChangeType versionChangeType);

  /// @brief Method ProcessAllBindingRequests, addr 0x6aef3b4, size 0x1f0, virtual false, abstract: false, final false
  inline void ProcessAllBindingRequests();

  /// @brief Method ProcessBindingRequests, addr 0x6aeffec, size 0x38, virtual false, abstract: false, final false
  inline void ProcessBindingRequests(::UnityEngine::UIElements::VisualElement* element);

  /// @brief Method ProcessDataSourceChangedRequests, addr 0x6aef5a4, size 0x2d0, virtual false, abstract: false, final false
  inline void ProcessDataSourceChangedRequests();

  /// @brief Method ProcessPropertyChangedEvents, addr 0x6aef874, size 0x328, virtual false, abstract: false, final false
  inline void ProcessPropertyChangedEvents(::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::Binding*>* ranUpdate);

  /// @brief Method Update, addr 0x6aee60c, size 0xda8, virtual true, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x6aedc38, size 0x284, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bindingManager, addr 0x6aedbbc, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::DataBindingManager* get_bindingManager();

  /// @brief Method get_profilerMarker, addr 0x6aedbdc, size 0x5c, virtual true, abstract: false, final false
