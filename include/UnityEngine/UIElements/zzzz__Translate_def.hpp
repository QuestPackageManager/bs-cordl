...
public:
  ...
  /// @brief Method Equals, addr 0x6b3cf88, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6b3cf08, size 0x80, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::Translate other);

  /// @brief Method GetHashCode, addr 0x6b368dc, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method None, addr 0x6b3b3e4, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::UIElements::Translate None();

  /// @brief Method ToString, addr 0x6b3d01c, size 0x13c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6b3ce2c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 v);

  /// @brief Method .ctor, addr 0x6b3ce1c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Length x, ::UnityEngine::UIElements::Length y, float_t z);

  /// @brief Method get_x, addr 0x6b3ce5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length get_x();

  /// @brief Method get_y, addr 0x6b3ce6c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Length get_y();

  /// @brief Method get_z, addr 0x6b3ce7c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6b3658c, size 0x80, virtual false, abstract: false, final false
  static inline bool op_Equality(::UnityEngine::UIElements::Translate lhs, ::UnityEngine::UIElements::Translate rhs);

  /// @brief Method op_Inequality, addr 0x6b3ce8c, size 0x7c, virtual false, abstract: false, final false
  static inline bool op_Inequality(::UnityEngine::UIElements::Translate lhs, ::UnityEngine::UIElements::Translate rhs);

  /// @brief Method set_x, addr 0x6b3ce64, size 0x8, virtual false, abstract: false, final false
  inline void set_x(::UnityEngine::UIElements::Length value);

  /// @brief Method set_y, addr 0x6b3ce74, size 0x8, virtual false, abstract: false, final false
  inline void set_y(::UnityEngine::UIElements::Length value);

  /// @brief Method set_z, addr 0x6b3ce84, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3d3e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b3d3e8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b3d2a4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3d3d8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3d3d0, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3d400, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::UIElements::Length GetValue(::ByRef<::UnityEngine::UIElements::Translate> container);

  static inline ::UnityEngine::UIElements::PropertyBag_Translate_YProperty* New_ctor();

  /// @brief Method SetValue, addr 0x6b3d408, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(::ByRef<::UnityEngine::UIElements::Translate> container, ::UnityEngine::UIElements::Length value);
  ...
  /// @brief Method .ctor, addr 0x6b3d308, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3d3f8, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3d3f0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method GetValue, addr 0x6b3d420, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x6b3d428, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b3d36c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsReadOnly, addr 0x6b3d418, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsReadOnly();

  /// @brief Method get_Name, addr 0x6b3d410, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Name();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6b3d158, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
