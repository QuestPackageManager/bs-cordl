...
public:
  ...
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "m_Z", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_isNone", ty: "bool", modifiers: "",
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertyBag_Translate_XProperty", modifiers: "&&", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertyBag_Translate_YProperty", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PropertyBag_Translate_ZProperty", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Translate_PropertyBag", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
