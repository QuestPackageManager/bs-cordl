...
/// @brief Method ATagOnPointerMove, addr 0x6ad9aac, size 0x2b4, virtual false, abstract: false, final false
inline void ATagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method ATagOnPointerOut, addr 0x6ad9d60, size 0x8, virtual false, abstract: false, final false
inline void ATagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  evt) ;

/// @brief Method ATagOnPointerOver, addr 0x6ad9aa4, size 0x8, virtual false, abstract: false, final false
inline void ATagOnPointerOver(::UnityEngine::UIElements::PointerOverEvent*  _) ;

/// @brief Method ATagOnPointerUp, addr 0x6ad98f4, size 0x1b0, virtual false, abstract: false, final false
inline void ATagOnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  pue) ;

/// @brief Method AllocateATagCallbacks, addr 0x6ad9780, size 0x174, virtual false, abstract: false, final false
inline void AllocateATagCallbacks() ;

/// @brief Method AllocateLinkCallbacks, addr 0x6ad95fc, size 0x174, virtual false, abstract: false, final false
inline void AllocateLinkCallbacks() ;

/// @brief Method HandleATag, addr 0x6ad7cb8, size 0xe8, virtual false, abstract: false, final false
inline void HandleATag() ;

/// @brief Method HandleLinkAndATagCallbacks, addr 0x6ad7e88, size 0x3fc, virtual false, abstract: false, final false
inline void HandleLinkAndATagCallbacks() ;

/// @brief Method HandleLinkTag, addr 0x6ad7da0, size 0xe8, virtual false, abstract: false, final false
inline void HandleLinkTag() ;

/// @brief Method HasAllocatedATagCallbacks, addr 0x6ad9770, size 0x10, virtual false, abstract: false, final false
inline bool HasAllocatedATagCallbacks() ;

/// @brief Method HasAllocatedLinkCallbacks, addr 0x6ad95ec, size 0x10, virtual false, abstract: false, final false
inline bool HasAllocatedLinkCallbacks() ;

/// @brief Method LinkTagOnPointerDown, addr 0x6ad9d68, size 0x2a8, virtual false, abstract: false, final false
inline void LinkTagOnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  pde) ;

/// @brief Method LinkTagOnPointerMove, addr 0x6ada2b8, size 0x540, virtual false, abstract: false, final false
inline void LinkTagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method LinkTagOnPointerOut, addr 0x6ada7f8, size 0x1b4, virtual false, abstract: false, final false
inline void LinkTagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  poe) ;

/// @brief Method LinkTagOnPointerUp, addr 0x6ada010, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ad7948, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  textElement) ;

/// @brief Method get_textInfo, addr 0x6ad95c8, size 0x24, virtual false, abstract: false, final false
