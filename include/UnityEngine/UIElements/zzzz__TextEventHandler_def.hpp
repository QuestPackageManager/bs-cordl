...
public:
  ...
  /// @brief Method ATagOnPointerMove, addr 0x6b4bcf4, size 0x2b4, virtual false, abstract: false, final false
  inline void ATagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* pme);

  /// @brief Method ATagOnPointerOut, addr 0x6b4bfa8, size 0x8, virtual false, abstract: false, final false
  inline void ATagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent* evt);

  /// @brief Method ATagOnPointerOver, addr 0x6b4bcec, size 0x8, virtual false, abstract: false, final false
  inline void ATagOnPointerOver(::UnityEngine::UIElements::PointerOverEvent* _);

  /// @brief Method ATagOnPointerUp, addr 0x6b4bb3c, size 0x1b0, virtual false, abstract: false, final false
  inline void ATagOnPointerUp(::UnityEngine::UIElements::PointerUpEvent* pue);

  /// @brief Method AllocateATagCallbacks, addr 0x6b4b9c8, size 0x174, virtual false, abstract: false, final false
  inline void AllocateATagCallbacks();

  /// @brief Method AllocateLinkCallbacks, addr 0x6b4b844, size 0x174, virtual false, abstract: false, final false
  inline void AllocateLinkCallbacks();

  /// @brief Method HandleATag, addr 0x6b49f00, size 0xe8, virtual false, abstract: false, final false
  inline void HandleATag();

  /// @brief Method HandleLinkAndATagCallbacks, addr 0x6b4a0d0, size 0x3fc, virtual false, abstract: false, final false
  inline void HandleLinkAndATagCallbacks();

  /// @brief Method HandleLinkTag, addr 0x6b49fe8, size 0xe8, virtual false, abstract: false, final false
  inline void HandleLinkTag();

  /// @brief Method HasAllocatedATagCallbacks, addr 0x6b4b9b8, size 0x10, virtual false, abstract: false, final false
  inline bool HasAllocatedATagCallbacks();

  /// @brief Method HasAllocatedLinkCallbacks, addr 0x6b4b834, size 0x10, virtual false, abstract: false, final false
  inline bool HasAllocatedLinkCallbacks();

  /// @brief Method LinkTagOnPointerDown, addr 0x6b4bfb0, size 0x2a8, virtual false, abstract: false, final false
  inline void LinkTagOnPointerDown(::UnityEngine::UIElements::PointerDownEvent* pde);

  /// @brief Method LinkTagOnPointerMove, addr 0x6b4c500, size 0x540, virtual false, abstract: false, final false
  inline void LinkTagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* pme);

  /// @brief Method LinkTagOnPointerOut, addr 0x6b4ca40, size 0x1b4, virtual false, abstract: false, final false
  inline void LinkTagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent* poe);

  /// @brief Method LinkTagOnPointerUp, addr 0x6b4c258, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b49b90, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::TextElement* textElement);

  /// @brief Method get_textInfo, addr 0x6b4b810, size 0x24, virtual false, abstract: false, final false
