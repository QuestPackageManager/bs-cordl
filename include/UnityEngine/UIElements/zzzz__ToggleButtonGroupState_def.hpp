...
public:
  ...
  /// @brief Method CompareTo, addr 0x6d77748, size 0x1c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::UnityEngine::UIElements::ToggleButtonGroupState other);

  /// @brief Method Equals, addr 0x6d77798, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x6d77774, size 0x24, virtual true, abstract: false, final true
  inline bool Equals(::UnityEngine::UIElements::ToggleButtonGroupState other);

  /// @brief Method GetActiveOptions, addr 0x6d754b0, size 0x188, virtual false, abstract: false, final false
  inline ::System::Span_1<int32_t> GetActiveOptions(::System::Span_1<int32_t> activeOptionsIndices);

  /// @brief Method GetHashCode, addr 0x6d77824, size 0x80, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ResetAllOptions, addr 0x6d75638, size 0x8, virtual false, abstract: false, final false
  inline void ResetAllOptions();

  /// @brief Method ResetOptions, addr 0x6d77698, size 0x98, virtual false, abstract: false, final false
  inline void ResetOptions(int32_t startingIndex);

  /// @brief Method ToString, addr 0x6d778a4, size 0x88, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6d75934, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(uint64_t optionsBitMask, int32_t length);

  /// @brief Method get_Item, addr 0x6d76f48, size 0xd4, virtual false, abstract: false, final false
  inline bool get_Item(int32_t index);

  /// @brief Method get_data, addr 0x6d77740, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_data();

  /// @brief Method get_length, addr 0x6d77730, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x6d77764, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x6d76f38, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Item, addr 0x6d75640, size 0xe8, virtual false, abstract: false, final false
  inline void set_Item(int32_t index, bool value);

  /// @brief Method set_length, addr 0x6d77738, size 0x8, virtual false, abstract: false, final false
