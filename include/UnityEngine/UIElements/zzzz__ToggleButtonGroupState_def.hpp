...
/// @brief Method CompareTo, addr 0x6c23890, size 0x1c, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::UIElements::ToggleButtonGroupState  other) ;

/// @brief Method Equals, addr 0x6c238e0, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x6c238bc, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::ToggleButtonGroupState  other) ;

/// @brief Method GetActiveOptions, addr 0x6c215f8, size 0x188, virtual false, abstract: false, final false
inline ::System::Span_1<int32_t> GetActiveOptions(::System::Span_1<int32_t>  activeOptionsIndices) ;

/// @brief Method GetHashCode, addr 0x6c2396c, size 0x80, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ResetAllOptions, addr 0x6c21780, size 0x8, virtual false, abstract: false, final false
inline void ResetAllOptions() ;

/// @brief Method ResetOptions, addr 0x6c237e0, size 0x98, virtual false, abstract: false, final false
inline void ResetOptions(int32_t  startingIndex) ;

/// @brief Method ToString, addr 0x6c239ec, size 0x88, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x6c21a7c, size 0x14c, virtual false, abstract: false, final false
inline void _ctor(uint64_t  optionsBitMask, int32_t  length) ;

/// @brief Method get_Item, addr 0x6c23090, size 0xd4, virtual false, abstract: false, final false
inline bool get_Item(int32_t  index) ;

/// @brief Method get_data, addr 0x6c23888, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_data() ;

/// @brief Method get_length, addr 0x6c23878, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x6c238ac, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x6c23080, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x6c21788, size 0xe8, virtual false, abstract: false, final false
inline void set_Item(int32_t  index, bool  value) ;

/// @brief Method set_length, addr 0x6c23880, size 0x8, virtual false, abstract: false, final false
