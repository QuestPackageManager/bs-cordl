...
public:
  ...
  // Ctor Parameters [CppParam { name: "m_Data", ty: "uint64_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: None, comment:
  // None }]
