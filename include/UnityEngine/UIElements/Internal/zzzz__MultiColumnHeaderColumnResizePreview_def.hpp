...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnResizePreview", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnHeaderColumnResizePreview(MultiColumnHeaderColumnResizePreview&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnResizePreview", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnHeaderColumnResizePreview(MultiColumnHeaderColumnResizePreviewconst&) = delete;
