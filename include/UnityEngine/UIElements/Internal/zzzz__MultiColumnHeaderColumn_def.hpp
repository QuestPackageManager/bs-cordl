...
public:
  ...
  /// @brief Method BindHeaderContent, addr 0x6bd22e8, size 0xdc, virtual false, abstract: false, final false
  inline void BindHeaderContent();

  /// @brief Method CreateDefaultHeaderContent, addr 0x6bd23c4, size 0x1a8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* CreateDefaultHeaderContent();

  /// @brief Method DefaultBindHeaderContent, addr 0x6bd256c, size 0x2bc, virtual false, abstract: false, final false
  inline void DefaultBindHeaderContent(::UnityEngine::UIElements::VisualElement* ve);

  /// @brief Method DestroyHeaderContent, addr 0x6bd1710, size 0x17c, virtual false, abstract: false, final false
  inline void DestroyHeaderContent();

  /// @brief Method Dispose, addr 0x6bd0788, size 0x190, virtual false, abstract: false, final false
  inline void Dispose();

  /// @brief Method InitManipulators, addr 0x6bd1d1c, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method OnColumnChanged, addr 0x6bd1f80, size 0x1b0, virtual false, abstract: false, final false
  inline void OnColumnChanged(::UnityEngine::UIElements::Column* c, ::UnityEngine::UIElements::ColumnDataType role);

  /// @brief Method OnColumnResized, addr 0x6bd2164, size 0x4, virtual false, abstract: false, final false
  inline void OnColumnResized(::UnityEngine::UIElements::Column* c);

  /// @brief Method OnMoverChanged, addr 0x6bd2168, size 0xa4, virtual false, abstract: false, final false
  inline void OnMoverChanged(::UnityEngine::UIElements::Internal::ColumnMover* mv);

  /// @brief Method UnbindHeaderContent, addr 0x6bd220c, size 0xdc, virtual false, abstract: false, final false
  inline void UnbindHeaderContent();

  /// @brief Method UpdateDataFromColumn, addr 0x6bd2130, size 0x34, virtual false, abstract: false, final false
  inline void UpdateDataFromColumn();

  /// @brief Method UpdateGeometryFromColumn, addr 0x6bd1c10, size 0x10c, virtual false, abstract: false, final false
  inline void UpdateGeometryFromColumn();

  /// @brief Method UpdateHeaderTemplate, addr 0x6bd19ec, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bcd518, size 0x6d4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_clickable, addr 0x6bd160c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Clickable* get_clickable();

  /// @brief Method get_column, addr 0x6bd162c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::Column* get_column();

  /// @brief Method get_content, addr 0x6bd163c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::VisualElement* get_content();

  /// @brief Method get_isContentBound, addr 0x6bd188c, size 0xb8, virtual false, abstract: false, final false
  inline bool get_isContentBound();

  /// @brief Method get_mover, addr 0x6bd161c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_clickable, addr 0x6bd1614, size 0x8, virtual false, abstract: false, final false
  inline void set_clickable(::UnityEngine::UIElements::Clickable* value);

  /// @brief Method set_column, addr 0x6bd1634, size 0x8, virtual false, abstract: false, final false
  inline void set_column(::UnityEngine::UIElements::Column* value);

  /// @brief Method set_content, addr 0x6bd1644, size 0xcc, virtual false, abstract: false, final false
  inline void set_content(::UnityEngine::UIElements::VisualElement* value);

  /// @brief Method set_isContentBound, addr 0x6bd1944, size 0xa8, virtual false, abstract: false, final false
  inline void set_isContentBound(bool value);

  /// @brief Method set_mover, addr 0x6bd1624, size 0x8, virtual false, abstract: false, final false
  inline void set_mover(::UnityEngine::UIElements::Internal::ColumnMover* value);

  /// @brief Method set_sortOrderLabel, addr 0x6bcfcb4, size 0x2c, virtual false, abstract: false, final false
