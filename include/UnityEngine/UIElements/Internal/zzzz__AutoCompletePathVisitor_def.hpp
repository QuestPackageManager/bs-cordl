...
public:
  ...
  /// @brief Method .ctor, addr 0x6bc7840, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_current, addr 0x6bc78cc, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_current();

  /// @brief Method get_currentDepth, addr 0x6bc78e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentDepth();

  /// @brief Method get_propertyPathInfos, addr 0x6bc78b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::PropertyPathInfo>* get_propertyPathInfos();

  /// @brief Method get_types, addr 0x6bc78c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::HashSet_1<::System::Type*>* get_types();

  /// @brief Method set_current, addr 0x6bc78dc, size 0xc, virtual false, abstract: false, final false
  inline void set_current(::Unity::Properties::PropertyPath value);

  /// @brief Method set_currentDepth, addr 0x6bc78f0, size 0x8, virtual false, abstract: false, final false
  inline void set_currentDepth(int32_t value);

  /// @brief Method set_propertyPathInfos, addr 0x6bc78bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x6bc7ae4, size 0x7c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x6bc7650, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bc78f8, size 0x1ec, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HasReachedEnd, addr 0x6bc7124, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x6bc71b4, size 0x88, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method VisitPropertyType, addr 0x6bc723c, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bc77e8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxDepth, addr 0x6bc711c, size 0x8, virtual false, abstract: false, final false
