...
// Ctor Parameters [CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "actualWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "width", ty: "::UnityEngine::UIElements::Length", modifiers: "", def_value: None }, CppParam { name: "visible", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Field m_OrderedColumnStates, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OrderedColumnStates, put=__cordl_internal_set_m_OrderedColumnStates)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Internal::ViewState_MultiColumnCollectionHeader_ColumnState>*  m_OrderedColumnStates;

/// @brief Field m_SortDescriptions, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SortDescriptions, put=__cordl_internal_set_m_SortDescriptions)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::SortColumnDescription*>*  m_SortDescriptions;

/// @brief Method Apply, addr 0x6b5db84, size 0x338, virtual false, abstract: false, final false
...
/// @brief Method Save, addr 0x6b5debc, size 0x684, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b5ec04, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <control>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__control_k__BackingField, put=__cordl_internal_set__control_k__BackingField)) ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn*  _control_k__BackingField;

/// @brief Field <resizeHandle>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__resizeHandle_k__BackingField, put=__cordl_internal_set__resizeHandle_k__BackingField)) ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizeHandle*  _resizeHandle_k__BackingField;
...
/// @brief Method .ctor, addr 0x6b5baa0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_control, addr 0x6b5ecc0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn* get_control() ;

/// @brief Method get_resizeHandle, addr 0x6b5ecd0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizeHandle* get_resizeHandle() ;

/// @brief Method set_control, addr 0x6b5ecc8, size 0x8, virtual false, abstract: false, final false
inline void set_control(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn*  value) ;

/// @brief Method set_resizeHandle, addr 0x6b5ecd8, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x6b5aaf0, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "columnDesc", ty: "::UnityEngine::UIElements::SortColumnDescription*", modifiers: "", def_value: None }, CppParam { name: "direction", ty: "::UnityEngine::UIElements::SortDirection", modifiers: "", def_value: None }]
...
/// @brief Method <OnContextualMenuManipulator>b__1, addr 0x6b5ece0, size 0x24, virtual false, abstract: false, final false
inline void _OnContextualMenuManipulator_b__1(::UnityEngine::UIElements::DropdownMenuAction*  a) ;

/// @brief Method <OnContextualMenuManipulator>b__2, addr 0x6b5ed04, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b5cfb0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <UpdateSortColumnDescriptionsOnClick>b__0, addr 0x6b5ed74, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b5d8ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <columnContainer>k__BackingField, offset 0x4f0, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnContainer_k__BackingField, put=__cordl_internal_set__columnContainer_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _columnContainer_k__BackingField;

/// @brief Field <columnDataMap>k__BackingField, offset 0x4e0, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnDataMap_k__BackingField, put=__cordl_internal_set__columnDataMap_k__BackingField)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*>*  _columnDataMap_k__BackingField;

/// @brief Field <columnLayout>k__BackingField, offset 0x4e8, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnLayout_k__BackingField, put=__cordl_internal_set__columnLayout_k__BackingField)) ::UnityEngine::UIElements::ColumnLayout*  _columnLayout_k__BackingField;
...
/// @brief Field <resizeHandleContainer>k__BackingField, offset 0x4f8, size 0x8 
 __declspec(property(get=__cordl_internal_get__resizeHandleContainer_k__BackingField, put=__cordl_internal_set__resizeHandleContainer_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _resizeHandleContainer_k__BackingField;
...
/// @brief Field columnContainerUssClassName, offset 0xffffffff, size 0x8 
 ...
 __declspec(property(get=get_columnDataMap)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*>*  columnDataMap;
...
/// @brief Field contextMenuPopulateEvent, offset 0x518, size 0x8 
 __declspec(property(get=__cordl_internal_get_contextMenuPopulateEvent, put=__cordl_internal_set_contextMenuPopulateEvent)) ::System::Action_2<::UnityEngine::UIElements::ContextualMenuPopulateEvent*,::UnityEngine::UIElements::Column*>*  contextMenuPopulateEvent;
...
/// @brief Field m_OldSortedColumnStates, offset 0x4c0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OldSortedColumnStates, put=__cordl_internal_set_m_OldSortedColumnStates)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_SortedColumnState>*  m_OldSortedColumnStates;
...
/// @brief Method ApplyColumnSorting, addr 0x6b5bd84, size 0x850, virtual false, abstract: false, final false
inline void ApplyColumnSorting() ;

/// @brief Method CleanupColumnData, addr 0x6b5bb6c, size 0x1bc, virtual false, abstract: false, final false
inline void CleanupColumnData(::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*  data) ;

/// @brief Method Dispose, addr 0x6b5e6d0, size 0x41c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DoLayout, addr 0x6b5d128, size 0x40, virtual false, abstract: false, final false
inline void DoLayout() ;

static inline ::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader* New_ctor(::UnityEngine::UIElements::Columns*  columns, ::UnityEngine::UIElements::SortColumnDescriptions*  sortDescriptions, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::SortColumnDescription*>*  sortedColumns) ;

/// @brief Method OnColumnAdded, addr 0x6b5a63c, size 0x350, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnAdded, addr 0x6b5b2cc, size 0x4, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x6b5bd28, size 0x5c, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnColumnClicked, addr 0x6b5d460, size 0x224, virtual false, abstract: false, final false
inline void OnColumnClicked(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnColumnControlGeometryChanged, addr 0x6b5d168, size 0x1f8, virtual false, abstract: false, final false
inline void OnColumnControlGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x6b5baa4, size 0xc8, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x6b5c5d4, size 0x18c, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x6b5c760, size 0x4, virtual false, abstract: false, final false
inline void OnColumnResized(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnContextualMenuManipulator, addr 0x6b5c764, size 0x84c, virtual false, abstract: false, final false
inline void OnContextualMenuManipulator(::UnityEngine::UIElements::ContextualMenuPopulateEvent*  evt) ;

/// @brief Method OnGeometryChanged, addr 0x6b5d0a8, size 0x80, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  e) ;

/// @brief Method OnMoveManipulatorActivated, addr 0x6b5cfb4, size 0xf4, virtual false, abstract: false, final false
inline void OnMoveManipulatorActivated(::UnityEngine::UIElements::Internal::ColumnMover*  mover) ;

/// @brief Method OnViewDataReady, addr 0x6b5da98, size 0xec, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method RaiseColumnResized, addr 0x6b5d360, size 0x100, virtual false, abstract: false, final false
inline void RaiseColumnResized(int32_t  columnIndex) ;

/// @brief Method RaiseColumnSortingChanged, addr 0x6b5ab30, size 0x38, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method ResizeToFit, addr 0x6b5aac4, size 0x2c, virtual false, abstract: false, final false
inline void ResizeToFit() ;

/// @brief Method SaveViewState, addr 0x6b5aafc, size 0x34, virtual false, abstract: false, final false
inline void SaveViewState() ;

/// @brief Method ScheduleDoLayout, addr 0x6b5a98c, size 0x138, virtual false, abstract: false, final false
inline void ScheduleDoLayout() ;

/// @brief Method ScrollHorizontally, addr 0x6b5d8f0, size 0x17c, virtual false, abstract: false, final false
inline void ScrollHorizontally(float_t  horizontalOffset) ;

/// @brief Method UpdateColumnControls, addr 0x6b5ab68, size 0x764, virtual false, abstract: false, final false
inline void UpdateColumnControls() ;

/// @brief Method UpdateSortColumnDescriptionsOnClick, addr 0x6b5d684, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method UpdateSortedColumns, addr 0x6b58b84, size 0x658, virtual false, abstract: false, final false
inline void UpdateSortedColumns() ;

/// @brief Method UpdateSortingStatus, addr 0x6b5921c, size 0x608, virtual false, abstract: false, final false
inline void UpdateSortingStatus() ;

/// @brief Method <OnContextualMenuManipulator>b__67_0, addr 0x6b5ec00, size 0x4, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*>* const& __cordl_internal_get__columnDataMap_k__BackingField() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*>*& __cordl_internal_get__columnDataMap_k__BackingField() ;
...
constexpr void __cordl_internal_set__columnDataMap_k__BackingField(::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader_ColumnData*>*  value) ;
...
/// @brief Method .ctor, addr 0x6b59dd4, size 0x868, virtual false, abstract: false, final false
...
/// @brief Method add_columnResized, addr 0x6b59824, size 0xc0, virtual false, abstract: false, final false
inline void add_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method add_columnSortingChanged, addr 0x6b599a4, size 0xac, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_contextMenuPopulateEvent, addr 0x6b59afc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method add_viewDataRestored, addr 0x6b59c7c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method get_columnContainer, addr 0x6b58ab8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_columnContainer() ;

/// @brief Method get_columnDataMap, addr 0x6b58aa8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_columnLayout, addr 0x6b58ab0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_columns, addr 0x6b591dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_isApplyingViewState, addr 0x6b58aa0, size 0x8, virtual false, abstract: false, final false
inline bool get_isApplyingViewState() ;

/// @brief Method get_resizeHandleContainer, addr 0x6b58ac0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_resizeHandleContainer() ;

/// @brief Method get_sortDescriptions, addr 0x6b58ad8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortDescriptions() ;

/// @brief Method get_sortedColumnReadonly, addr 0x6b58ad0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumnReadonly() ;

/// @brief Method get_sortedColumns, addr 0x6b58ac8, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumns() ;

/// @brief Method get_sortingEnabled, addr 0x6b591e4, size 0x8, virtual false, abstract: false, final false
inline bool get_sortingEnabled() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnResized, addr 0x6b598e4, size 0xc0, virtual false, abstract: false, final false
inline void remove_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method remove_columnSortingChanged, addr 0x6b59a50, size 0xac, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_contextMenuPopulateEvent, addr 0x6b59bbc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_viewDataRestored, addr 0x6b59d28, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method set_sortDescriptions, addr 0x6b58ae0, size 0xa4, virtual false, abstract: false, final false
inline void set_sortDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x6b591ec, size 0x30, virtual false, abstract: false, final false
