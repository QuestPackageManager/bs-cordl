...
public:
  ...
  /// @brief Method BeginDragResize, addr 0x6bca904, size 0x48, virtual false, abstract: false, final false
  inline void BeginDragResize(float_t pos);

  /// @brief Method DragResize, addr 0x6bcaa58, size 0x40, virtual false, abstract: false, final false
  inline void DragResize(float_t pos);

  /// @brief Method EndDragResize, addr 0x6bca69c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnKeyDown, addr 0x6bca614, size 0x88, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* e);

  /// @brief Method OnPointerDown, addr 0x6bca6f8, size 0x20c, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* e);

  /// @brief Method OnPointerMove, addr 0x6bca94c, size 0x10c, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* e);

  /// @brief Method OnPointerUp, addr 0x6bcaa98, size 0x138, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* e);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x6bca1bc, size 0x22c, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x6bca3e8, size 0x22c, virtual true, abstract: false, final false
  inline void UnregisterCallbacksFromTarget();

  /// @brief Method UpdatePreviewPosition, addr 0x6bcabd0, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bca0f4, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Column* column);

  /// @brief Method get_columnLayout, addr 0x6bca0d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout();

  /// @brief Method get_preview, addr 0x6bca0e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_preview();

  /// @brief Method set_columnLayout, addr 0x6bca0dc, size 0x8, virtual false, abstract: false, final false
  inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout* value);

  /// @brief Method set_preview, addr 0x6bca0ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::Internal::ColumnResizer, 0x58>, "Size mismatch!");
