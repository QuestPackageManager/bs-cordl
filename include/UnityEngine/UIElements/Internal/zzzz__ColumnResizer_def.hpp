...
/// @brief Method BeginDragResize, addr 0x6b586bc, size 0x48, virtual false, abstract: false, final false
inline void BeginDragResize(float_t  pos) ;

/// @brief Method DragResize, addr 0x6b58810, size 0x40, virtual false, abstract: false, final false
inline void DragResize(float_t  pos) ;

/// @brief Method EndDragResize, addr 0x6b58454, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x6b583cc, size 0x88, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerDown, addr 0x6b584b0, size 0x20c, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  e) ;

/// @brief Method OnPointerMove, addr 0x6b58704, size 0x10c, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  e) ;

/// @brief Method OnPointerUp, addr 0x6b58850, size 0x138, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  e) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x6b57f74, size 0x22c, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x6b581a0, size 0x22c, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdatePreviewPosition, addr 0x6b58988, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b57eac, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method get_columnLayout, addr 0x6b57e8c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_preview, addr 0x6b57e9c, size 0x8, virtual false, abstract: false, final false
inline bool get_preview() ;

/// @brief Method set_columnLayout, addr 0x6b57e94, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_preview, addr 0x6b57ea4, size 0x8, virtual false, abstract: false, final false
