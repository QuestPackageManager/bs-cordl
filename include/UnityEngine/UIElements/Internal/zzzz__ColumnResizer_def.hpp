...
public:
  ...
  /// @brief Method BeginDragResize, addr 0x49dfca4, size 0x48, virtual false, abstract: false, final false
  inline void BeginDragResize(float_t pos);

  /// @brief Method DragResize, addr 0x49dfde8, size 0x40, virtual false, abstract: false, final false
  inline void DragResize(float_t pos);

  /// @brief Method EndDragResize, addr 0x49dfa40, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnKeyDown, addr 0x49df9cc, size 0x74, virtual false, abstract: false, final false
  inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent* e);

  /// @brief Method OnPointerDown, addr 0x49dfa9c, size 0x208, virtual false, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent* e);

  /// @brief Method OnPointerMove, addr 0x49dfcec, size 0xfc, virtual false, abstract: false, final false
  inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent* e);

  /// @brief Method OnPointerUp, addr 0x49dfe28, size 0x130, virtual false, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent* e);

  /// @brief Method RegisterCallbacksOnTarget, addr 0x49df544, size 0x244, virtual true, abstract: false, final false
  inline void RegisterCallbacksOnTarget();

  /// @brief Method UnregisterCallbacksFromTarget, addr 0x49df788, size 0x244, virtual true, abstract: false, final false
  inline void UnregisterCallbacksFromTarget();

  /// @brief Method UpdatePreviewPosition, addr 0x49dff58, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x49df484, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::UIElements::Column* column);

  /// @brief Method get_columnLayout, addr 0x49df460, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout();

  /// @brief Method get_preview, addr 0x49df470, size 0x8, virtual false, abstract: false, final false
  inline bool get_preview();

  /// @brief Method set_columnLayout, addr 0x49df468, size 0x8, virtual false, abstract: false, final false
  inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout* value);

  /// @brief Method set_preview, addr 0x49df478, size 0xc, virtual false, abstract: false, final false
