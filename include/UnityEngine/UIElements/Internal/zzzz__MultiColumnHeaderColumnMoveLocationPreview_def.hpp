...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnMoveLocationPreview", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnHeaderColumnMoveLocationPreview(MultiColumnHeaderColumnMoveLocationPreview&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnMoveLocationPreview", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnHeaderColumnMoveLocationPreview(MultiColumnHeaderColumnMoveLocationPreviewconst&) = delete;
