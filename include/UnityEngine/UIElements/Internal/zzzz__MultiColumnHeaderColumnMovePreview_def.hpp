...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnMovePreview*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnMovePreview*, "UnityEngine.UIElements.Internal", "MultiColumnHeaderColumnMovePreview");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnMovePreview", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnHeaderColumnMovePreview(MultiColumnHeaderColumnMovePreview&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnMovePreview", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnHeaderColumnMovePreview(MultiColumnHeaderColumnMovePreviewconst&) = delete;
