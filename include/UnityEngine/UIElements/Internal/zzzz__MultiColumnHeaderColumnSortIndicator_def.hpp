...
/// @brief Method .ctor, addr 0x6b5ee1c, size 0x178, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_sortOrderLabel, addr 0x6b5edfc, size 0x20, virtual false, abstract: false, final false
