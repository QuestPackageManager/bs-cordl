...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator*, "UnityEngine.UIElements.Internal", "MultiColumnHeaderColumnSortIndicator");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnSortIndicator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnHeaderColumnSortIndicator(MultiColumnHeaderColumnSortIndicator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnSortIndicator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnHeaderColumnSortIndicator(MultiColumnHeaderColumnSortIndicatorconst&) = delete;
...
static_assert(sizeof(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnSortIndicator) == 0x4b0, "Size mismatch!");
