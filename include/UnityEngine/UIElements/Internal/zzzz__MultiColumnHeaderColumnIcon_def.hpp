...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnIcon", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiColumnHeaderColumnIcon(MultiColumnHeaderColumnIcon&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiColumnHeaderColumnIcon", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiColumnHeaderColumnIcon(MultiColumnHeaderColumnIconconst&) = delete;
