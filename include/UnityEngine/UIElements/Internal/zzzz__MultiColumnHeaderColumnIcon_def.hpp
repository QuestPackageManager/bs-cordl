...
public:
  ...
  /// @brief Method UpdateClassList, addr 0x6d26e48, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__5_0, addr 0x6d27038, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__5_0(::UnityEngine::UIElements::CustomStyleResolvedEvent* evt);

  /// @brief Method .ctor, addr 0x6d26d34, size 0x114, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_ussClassName();

  /// @brief Method get_isImageInline, addr 0x6d26d24, size 0x8, virtual false, abstract: false, final false
  inline bool get_isImageInline();

  static inline void setStaticF_ussClassName(::StringW value);

  /// @brief Method set_isImageInline, addr 0x6d26d2c, size 0x8, virtual false, abstract: false, final false
