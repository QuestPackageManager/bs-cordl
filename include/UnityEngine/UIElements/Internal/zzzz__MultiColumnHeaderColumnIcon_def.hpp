...
public:
  ...
  /// @brief Method UpdateClassList, addr 0x49f8cdc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method <.ctor>b__5_0, addr 0x49f8ed8, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__5_0(::UnityEngine::UIElements::CustomStyleResolvedEvent* evt);

  /// @brief Method .ctor, addr 0x49f8bd4, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_ussClassName();

  /// @brief Method get_isImageInline, addr 0x49f8bc0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isImageInline();

  static inline void setStaticF_ussClassName(::StringW value);

  /// @brief Method set_isImageInline, addr 0x49f8bc8, size 0xc, virtual false, abstract: false, final false
