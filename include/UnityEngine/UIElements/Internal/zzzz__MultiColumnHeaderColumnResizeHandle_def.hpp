...
public:
  ...
  /// @brief Method .ctor, addr 0x6bcdbec, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_dragArea, addr 0x6bd2bb4, size 0x8, virtual false, abstract: false, final false
