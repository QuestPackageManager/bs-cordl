...
public:
  ...
  /// @brief Method .ctor, addr 0x49e9008, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_dragArea, addr 0x49edf24, size 0x8, virtual false, abstract: false, final false
