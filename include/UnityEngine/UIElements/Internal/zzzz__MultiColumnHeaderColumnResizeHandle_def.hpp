...
/// @brief Method .ctor, addr 0x6b5b9a4, size 0xfc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_dragArea, addr 0x6b6096c, size 0x8, virtual false, abstract: false, final false
