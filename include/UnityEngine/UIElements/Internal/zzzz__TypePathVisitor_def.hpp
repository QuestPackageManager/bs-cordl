...
// Write type traits
MARK_REF_T(::UnityEngine::UIElements::Internal::TypePathVisitor*);
DEFINE_IL2CPP_CLASS(::UnityEngine::UIElements::Internal::TypePathVisitor*, "UnityEngine.UIElements.Internal", "TypePathVisitor");
...
public:
  ...
  /// @brief Method GetElementType, addr 0x6d1d64c, size 0x1c4, virtual false, abstract: false, final false
  static inline ::System::Type* GetElementType(::System::Type* type);

  /// @brief Method IsLastPartReached, addr 0x6d1d5e0, size 0x6c, virtual false, abstract: false, final false
  inline bool IsLastPartReached();

  static inline ::UnityEngine::UIElements::Internal::TypePathVisitor* New_ctor();

  /// @brief Method Reset, addr 0x6d1d5c4, size 0x1c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  template <typename TContainer, typename TValue> inline void Unity_Properties_IPropertyVisitor_Visit(::Unity::Properties::Property_2<TContainer, TValue>* property, ::by_ref<TContainer> container);
  ...
  /// @brief Method .ctor, addr 0x6d1d810, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Path, addr 0x6d1d590, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_Path();

  /// @brief Method get_ReturnCode, addr 0x6d1d5b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Path, addr 0x6d1d5a0, size 0xc, virtual false, abstract: false, final false
  inline void set_Path(::Unity::Properties::PropertyPath value);

  /// @brief Method set_ReturnCode, addr 0x6d1d5bc, size 0x8, virtual false, abstract: false, final false
  inline void set_ReturnCode(::Unity::Properties::VisitReturnCode value);

  /// @brief Method set_resolvedType, addr 0x6d1d5ac, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::UnityEngine::UIElements::Internal::TypePathVisitor) == 0xc0, "Size mismatch!");
