...
public:
  ...
  /// @brief Method GetElementType, addr 0x6bc7c1c, size 0x1c4, virtual false, abstract: false, final false
  static inline ::System::Type* GetElementType(::System::Type* type);

  /// @brief Method IsLastPartReached, addr 0x6bc7bb0, size 0x6c, virtual false, abstract: false, final false
  inline bool IsLastPartReached();

  static inline ::UnityEngine::UIElements::Internal::TypePathVisitor* New_ctor();

  /// @brief Method Reset, addr 0x6bc7b94, size 0x1c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x6bc7de0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Path, addr 0x6bc7b60, size 0x10, virtual false, abstract: false, final false
  inline ::Unity::Properties::PropertyPath get_Path();

  /// @brief Method get_ReturnCode, addr 0x6bc7b84, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Path, addr 0x6bc7b70, size 0xc, virtual false, abstract: false, final false
  inline void set_Path(::Unity::Properties::PropertyPath value);

  /// @brief Method set_ReturnCode, addr 0x6bc7b8c, size 0x8, virtual false, abstract: false, final false
  inline void set_ReturnCode(::Unity::Properties::VisitReturnCode value);

  /// @brief Method set_resolvedType, addr 0x6bc7b7c, size 0x8, virtual false, abstract: false, final false
