...
/// @brief Method GetElementType, addr 0x6b559d4, size 0x1c4, virtual false, abstract: false, final false
static inline ::System::Type* GetElementType(::System::Type*  type) ;

/// @brief Method IsLastPartReached, addr 0x6b55968, size 0x6c, virtual false, abstract: false, final false
inline bool IsLastPartReached() ;

static inline ::UnityEngine::UIElements::Internal::TypePathVisitor* New_ctor() ;

/// @brief Method Reset, addr 0x6b5594c, size 0x1c, virtual false, abstract: false, final false
inline void Reset() ;
...
template<typename TContainer>
inline void Unity_Properties_IPropertyBagVisitor_Visit(::Unity::Properties::IPropertyBag_1<TContainer>*  properties, ::ByRef<TContainer>  container) ;
...
template<typename TContainer,typename TValue>
inline void Unity_Properties_IPropertyVisitor_Visit(::Unity::Properties::Property_2<TContainer,TValue>*  property, ::ByRef<TContainer>  container) ;

/// @brief Method Unity.Properties.ITypeVisitor.Visit, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
template<typename TContainer>
inline void Unity_Properties_ITypeVisitor_Visit() ;
...
/// @brief Method .ctor, addr 0x6b55b98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Path, addr 0x6b55918, size 0x10, virtual false, abstract: false, final false
inline ::Unity::Properties::PropertyPath get_Path() ;

/// @brief Method get_ReturnCode, addr 0x6b5593c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Path, addr 0x6b55928, size 0xc, virtual false, abstract: false, final false
inline void set_Path(::Unity::Properties::PropertyPath  value) ;

/// @brief Method set_ReturnCode, addr 0x6b55944, size 0x8, virtual false, abstract: false, final false
inline void set_ReturnCode(::Unity::Properties::VisitReturnCode  value) ;

/// @brief Method set_resolvedType, addr 0x6b55934, size 0x8, virtual false, abstract: false, final false
