...
/// @brief Method BeginDragMove, addr 0x6b57284, size 0x454, virtual false, abstract: false, final false
inline void BeginDragMove(float_t  pos) ;

/// @brief Method DragMove, addr 0x6b576d8, size 0x8, virtual false, abstract: false, final false
inline void DragMove(float_t  pos) ;

/// @brief Method EndDragMove, addr 0x6b570e4, size 0x120, virtual false, abstract: false, final false
inline void EndDragMove(bool  cancelled) ;

static inline ::UnityEngine::UIElements::Internal::ColumnMover* New_ctor() ;

/// @brief Method OnKeyDown, addr 0x6b57204, size 0x80, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerCancel, addr 0x6b56f04, size 0x8c, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x6b5706c, size 0x78, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x6b56970, size 0x9c, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x6b56bcc, size 0x78, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x6b56d60, size 0xa0, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method ProcessCancelEvent, addr 0x6b56f90, size 0xdc, virtual false, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x6b56a0c, size 0x1c0, virtual false, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x6b56c44, size 0x11c, virtual false, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x6b56e00, size 0x104, virtual false, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x6b56318, size 0x32c, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x6b56644, size 0x32c, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdateMoveLocation, addr 0x6b576e0, size 0x33c, virtual false, abstract: false, final false
inline void UpdateMoveLocation() ;

/// @brief Method UpdatePreviewPosition, addr 0x6b57a1c, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6b5625c, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_activeChanged, addr 0x6b55f5c, size 0xc0, virtual false, abstract: false, final false
inline void add_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method add_movingChanged, addr 0x6b560dc, size 0xc0, virtual false, abstract: false, final false
inline void add_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method get_active, addr 0x6b55edc, size 0x8, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_columnLayout, addr 0x6b55ecc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_moving, addr 0x6b55f1c, size 0x8, virtual false, abstract: false, final false
inline bool get_moving() ;

/// @brief Method remove_activeChanged, addr 0x6b5601c, size 0xc0, virtual false, abstract: false, final false
inline void remove_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method remove_movingChanged, addr 0x6b5619c, size 0xc0, virtual false, abstract: false, final false
inline void remove_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method set_active, addr 0x6b55ee4, size 0x38, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_columnLayout, addr 0x6b55ed4, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_moving, addr 0x6b55f24, size 0x38, virtual false, abstract: false, final false
