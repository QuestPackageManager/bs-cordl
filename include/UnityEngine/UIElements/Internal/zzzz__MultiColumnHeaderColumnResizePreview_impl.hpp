...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::*)()>(
    &::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::_ctor)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0x6b575ec;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*>::get(), ".ctor",
...
inline void UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::setStaticF_ussClassName(::StringW value) {
  ::cordl_internals::setStaticField<::StringW, "ussClassName", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*>::get>(
...
inline void UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::setStaticF_visualUssClassName(::StringW value) {
  ::cordl_internals::setStaticField<::StringW, "visualUssClassName",
                                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*>::get>(
      std::forward<::StringW>(value));
}
inline ::StringW UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview::getStaticF_visualUssClassName() {
  return ::cordl_internals::getStaticField<::StringW, "visualUssClassName",
                                           ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizePreview*>::get>();
}
