...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3316a84, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33169ac, size 0xd8, virtual false, abstract: false, final false
