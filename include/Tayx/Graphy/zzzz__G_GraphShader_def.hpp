...
public:
  ...
  /// @brief Method InitializeShader, addr 0x44d5b04, size 0x17c, virtual false, abstract: false, final false
  inline void InitializeShader();

  static inline ::Tayx::Graphy::G_GraphShader* New_ctor();

  /// @brief Method UpdateArray, addr 0x44d5c80, size 0x44, virtual false, abstract: false, final false
  inline void UpdateArray();

  /// @brief Method UpdateAverage, addr 0x44d5cc4, size 0x3c, virtual false, abstract: false, final false
  inline void UpdateAverage();

  /// @brief Method UpdateColors, addr 0x44d5d68, size 0xa0, virtual false, abstract: false, final false
  inline void UpdateColors();

  /// @brief Method UpdatePoints, addr 0x44d5e08, size 0x3c, virtual false, abstract: false, final false
  inline void UpdatePoints();

  /// @brief Method UpdateThresholds, addr 0x44d5d00, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d5e44, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
