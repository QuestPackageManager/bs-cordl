...
public:
  ...
  /// @brief Method InitializeShader, addr 0x62fa61c, size 0x194, virtual false, abstract: false, final false
  inline void InitializeShader();

  static inline ::Tayx::Graphy::G_GraphShader* New_ctor();

  /// @brief Method UpdateArray, addr 0x62fa7b0, size 0x64, virtual false, abstract: false, final false
  inline void UpdateArray();

  /// @brief Method UpdateAverage, addr 0x62fa814, size 0x38, virtual false, abstract: false, final false
  inline void UpdateAverage();

  /// @brief Method UpdateColors, addr 0x62fa8ac, size 0x94, virtual false, abstract: false, final false
  inline void UpdateColors();

  /// @brief Method UpdatePoints, addr 0x62fa940, size 0x3c, virtual false, abstract: false, final false
  inline void UpdatePoints();

  /// @brief Method UpdateThresholds, addr 0x62fa84c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62fa97c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
