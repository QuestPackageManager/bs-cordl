...
/// @brief Method CreatePoints, addr 0x628c1b8, size 0x22c, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x628bb3c, size 0x140, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor() ;

/// @brief Method OnEnable, addr 0x628b8a8, size 0x54, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x628b8fc, size 0x38, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x628bc7c, size 0x4f4, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x628b998, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628c3e4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
