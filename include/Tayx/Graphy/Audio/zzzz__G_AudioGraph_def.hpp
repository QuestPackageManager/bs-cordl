...
public:
  ...
  /// @brief Method CreatePoints, addr 0x44d4d60, size 0x214, virtual true, abstract: false, final false
  inline void CreatePoints();

  /// @brief Method Init, addr 0x44d4718, size 0x134, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor();

  /// @brief Method OnEnable, addr 0x44d4488, size 0x50, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x44d44d8, size 0x38, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateGraph, addr 0x44d484c, size 0x4d0, virtual true, abstract: false, final false
  inline void UpdateGraph();

  /// @brief Method UpdateParameters, addr 0x44d4570, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d4f74, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
