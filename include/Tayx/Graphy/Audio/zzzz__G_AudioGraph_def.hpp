...
public:
  ...
  /// @brief Method CreatePoints, addr 0x643bedc, size 0x22c, virtual true, abstract: false, final false
  inline void CreatePoints();

  /// @brief Method Init, addr 0x643b860, size 0x140, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor();

  /// @brief Method OnEnable, addr 0x643b5cc, size 0x54, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x643b620, size 0x38, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateGraph, addr 0x643b9a0, size 0x4f4, virtual true, abstract: false, final false
  inline void UpdateGraph();

  /// @brief Method UpdateParameters, addr 0x643b6bc, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x643c108, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
