...
public:
  ...
  /// @brief Method CreatePoints, addr 0x62fe1c4, size 0x22c, virtual true, abstract: false, final false
  inline void CreatePoints();

  /// @brief Method Init, addr 0x62fdb48, size 0x140, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor();

  /// @brief Method OnEnable, addr 0x62fd8b4, size 0x54, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x62fd908, size 0x38, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateGraph, addr 0x62fdc88, size 0x4f4, virtual true, abstract: false, final false
  inline void UpdateGraph();

  /// @brief Method UpdateParameters, addr 0x62fd9a4, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62fe3f0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
