...
/// @brief Method Awake, addr 0x628cae8, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x628c534, size 0x11c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioText* New_ctor() ;

/// @brief Method Update, addr 0x628caec, size 0x118, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x628c518, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628cc04, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
