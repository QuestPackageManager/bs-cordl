...
public:
  ...
  /// @brief Method Awake addr 0x288d090 size 0x4 virtual false final false
  inline void Awake();

  /// @brief Method Start addr 0x288d538 size 0x4 virtual false final false
  inline void Start();

  /// @brief Method SetPosition addr 0x288561c size 0x300 virtual true final true
  inline void SetPosition(::Tayx::Graphy::__GraphyManager__ModulePosition newModulePosition);

  /// @brief Method SetState addr 0x288632c size 0x150 virtual true final true
  inline void SetState(::Tayx::Graphy::__GraphyManager__ModuleState state, bool silentUpdate);

  /// @brief Method RestorePreviousState addr 0x2887d28 size 0xc virtual false final false
  inline void RestorePreviousState();

  /// @brief Method UpdateParameters addr 0x28864a4 size 0x1c4 virtual false final false
  inline void UpdateParameters();

  /// @brief Method RefreshParameters addr 0x2888710 size 0x1bc virtual false final false
  inline void RefreshParameters();

  /// @brief Method Init addr 0x288d094 size 0x4a4 virtual false final false
  inline void Init();

  /// @brief Method SetGraphActive addr 0x288d53c size 0x44 virtual false final false
  inline void SetGraphActive(bool active);

  static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor();

  /// @brief Method .ctor addr 0x288d670 size 0xc0 virtual false final false
  inline void _ctor();
