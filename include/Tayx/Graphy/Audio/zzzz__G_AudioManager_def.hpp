...
public:
  ...
  /// @brief Method Awake, addr 0x44d03f0, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x44ca804, size 0x4e4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor();

  /// @brief Method RefreshParameters, addr 0x44cc3a8, size 0x1bc, virtual false, abstract: false, final false
  inline void RefreshParameters();

  /// @brief Method RestorePreviousState, addr 0x44c9c80, size 0xc, virtual false, abstract: false, final false
  inline void RestorePreviousState();

  /// @brief Method SetGraphActive, addr 0x44d03f8, size 0x44, virtual false, abstract: false, final false
  inline void SetGraphActive(bool active);

  /// @brief Method SetPosition, addr 0x44c73cc, size 0x300, virtual true, abstract: false, final true
  inline void SetPosition(::Tayx::Graphy::GraphyManager_ModulePosition newModulePosition);

  /// @brief Method SetState, addr 0x44c80d8, size 0x150, virtual true, abstract: false, final true
  inline void SetState(::Tayx::Graphy::GraphyManager_ModuleState state, bool silentUpdate);

  /// @brief Method Start, addr 0x44d03f4, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateParameters, addr 0x44c8250, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d063c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
