...
/// @brief Method Awake, addr 0x628c740, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FindAudioListener, addr 0x628c948, size 0xbc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioListener> FindAudioListener() ;

/// @brief Method Init, addr 0x6285d10, size 0x174, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioMonitor* New_ctor() ;

/// @brief Method OnDestroy, addr 0x628ca04, size 0xa8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnSceneLoaded, addr 0x628caac, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x628c744, size 0x204, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x628c43c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628cad0, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method dBNormalized, addr 0x628c1a4, size 0x14, virtual false, abstract: false, final false
inline float_t dBNormalized(float_t  db) ;

/// @brief Method get_MaxDB, addr 0x628c730, size 0x8, virtual false, abstract: false, final false
inline float_t get_MaxDB() ;

/// @brief Method get_Spectrum, addr 0x628c710, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_Spectrum() ;

/// @brief Method get_SpectrumDataAvailable, addr 0x628b934, size 0x64, virtual false, abstract: false, final false
inline bool get_SpectrumDataAvailable() ;

/// @brief Method get_SpectrumHighestValues, addr 0x628c720, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_SpectrumHighestValues() ;

/// @brief Method lin2dB, addr 0x628c170, size 0x34, virtual false, abstract: false, final false
inline float_t lin2dB(float_t  linear) ;

/// @brief Method set_MaxDB, addr 0x628c738, size 0x8, virtual false, abstract: false, final false
inline void set_MaxDB(float_t  value) ;

/// @brief Method set_Spectrum, addr 0x628c718, size 0x8, virtual false, abstract: false, final false
inline void set_Spectrum(::ArrayW<float_t,::Array<float_t>*>  value) ;

/// @brief Method set_SpectrumHighestValues, addr 0x628c728, size 0x8, virtual false, abstract: false, final false
