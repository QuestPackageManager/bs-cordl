...
public:
  ...
  /// @brief Method Awake, addr 0x2f3bb94, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FindAudioListener, addr 0x2f3bd84, size 0xb4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioListener> FindAudioListener();

  /// @brief Method Init, addr 0x2f34f28, size 0x12c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Audio::G_AudioMonitor* New_ctor();

  /// @brief Method OnDestroy, addr 0x2f3be38, size 0xa4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnSceneLoaded, addr 0x2f3bedc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x2f3bb98, size 0x1ec, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x2f3b8a4, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f3bf00, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method dBNormalized, addr 0x2f3b620, size 0x14, virtual false, abstract: false, final false
  inline float_t dBNormalized(float_t db);

  /// @brief Method get_MaxDB, addr 0x2f3bb84, size 0x8, virtual false, abstract: false, final false
  inline float_t get_MaxDB();

  /// @brief Method get_Spectrum, addr 0x2f3bb64, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_Spectrum();

  /// @brief Method get_SpectrumDataAvailable, addr 0x2f3add8, size 0x60, virtual false, abstract: false, final false
  inline bool get_SpectrumDataAvailable();

  /// @brief Method get_SpectrumHighestValues, addr 0x2f3bb74, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_SpectrumHighestValues();

  /// @brief Method lin2dB, addr 0x2f3b5f0, size 0x30, virtual false, abstract: false, final false
  inline float_t lin2dB(float_t linear);

  /// @brief Method set_MaxDB, addr 0x2f3bb8c, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxDB(float_t value);

  /// @brief Method set_Spectrum, addr 0x2f3bb6c, size 0x8, virtual false, abstract: false, final false
  inline void set_Spectrum(::ArrayW<float_t, ::Array<float_t>*> value);

  /// @brief Method set_SpectrumHighestValues, addr 0x2f3bb7c, size 0x8, virtual false, abstract: false, final false
