...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tayx::Graphy::UI::IModifiableState::*)(::Tayx::Graphy::__GraphyManager__ModuleState, bool)>(
...
inline void Tayx::Graphy::UI::IModifiableState::SetState(::Tayx::Graphy::__GraphyManager__ModuleState newState, bool silentUpdate) {
