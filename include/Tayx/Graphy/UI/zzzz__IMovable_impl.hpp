...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tayx::Graphy::UI::IMovable::*)(::Tayx::Graphy::GraphyManager_ModulePosition)>(&::Tayx::Graphy::UI::IMovable::SetPosition)> {
