...
public:
  ...
  /// @brief Method Dispose, addr 0x3057598, size 0x98, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method Init, addr 0x305ba80, size 0x280, virtual false, abstract: false, final false
  static inline void Init(int32_t minNegativeValue, int32_t maxPositiveValue);

  /// @brief Method ToStringNonAlloc, addr 0x305bd00, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaxValue, addr 0x305ba1c, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_MaxValue();

  /// @brief Method get_MinValue, addr 0x305b9b0, size 0x6c, virtual false, abstract: false, final false
