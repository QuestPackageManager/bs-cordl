...
public:
  ...
  /// @brief Method Dispose, addr 0x44db804, size 0x98, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method Init, addr 0x44dfacc, size 0x238, virtual false, abstract: false, final false
  static inline void Init(int32_t minNegativeValue, int32_t maxPositiveValue);

  /// @brief Method ToStringNonAlloc, addr 0x44dfd04, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaxValue, addr 0x44dfa68, size 0x64, virtual false, abstract: false, final false
  static inline int32_t get_MaxValue();

  /// @brief Method get_MinValue, addr 0x44df9fc, size 0x6c, virtual false, abstract: false, final false
