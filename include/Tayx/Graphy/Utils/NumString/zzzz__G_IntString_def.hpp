...
public:
  ...
  /// @brief Method Dispose, addr 0x62f7344, size 0xa0, virtual false, abstract: false, final false
  static inline void Dispose();

  /// @brief Method Init, addr 0x62fb570, size 0x230, virtual false, abstract: false, final false
  static inline void Init(int32_t minNegativeValue, int32_t maxPositiveValue);

  /// @brief Method ToStringNonAlloc, addr 0x62fb7a0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_MaxValue, addr 0x62fb508, size 0x68, virtual false, abstract: false, final false
  static inline int32_t get_MaxValue();

  /// @brief Method get_MinValue, addr 0x62fb498, size 0x70, virtual false, abstract: false, final false
