...
public:
  // Declarations
  /// @brief Method SetAllActive, addr 0x44d19b4, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllActive, addr 0x44d1bcc, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOneActive, addr 0x44d1b18, size 0xb4, virtual false, abstract: false, final false
