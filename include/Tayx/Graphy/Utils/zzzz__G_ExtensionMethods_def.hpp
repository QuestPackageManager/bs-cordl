...
public:
  // Declarations
  /// @brief Method SetAllActive, addr 0x44d5ec8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllActive, addr 0x44d60e0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOneActive, addr 0x44d602c, size 0xb4, virtual false, abstract: false, final false
