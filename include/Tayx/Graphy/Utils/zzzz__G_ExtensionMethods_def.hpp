...
public:
  // Declarations
  /// @brief Method SetAllActive, addr 0x628832c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAllActive, addr 0x6288504, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method SetOneActive, addr 0x6288444, size 0xc0, virtual false, abstract: false, final false
