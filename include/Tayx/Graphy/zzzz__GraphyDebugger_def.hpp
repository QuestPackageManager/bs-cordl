...
// Ctor Parameters [CppParam { name: "Variable", ty: "::Tayx::Graphy::GraphyDebugger_DebugVariable", modifiers: "", def_value: None }, CppParam { name: "Comparer", ty: "::Tayx::Graphy::GraphyDebugger_DebugComparer", modifiers: "", def_value: None }, CppParam { name: "Value", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Field DebugConditions, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_DebugConditions, put=__cordl_internal_set_DebugConditions)) ::System::Collections::Generic::List_1<::Tayx::Graphy::GraphyDebugger_DebugCondition>*  DebugConditions;
...
/// @brief Method Executed, addr 0x6282b30, size 0xc, virtual false, abstract: false, final false
inline void Executed() ;

static inline ::Tayx::Graphy::GraphyDebugger_DebugPacket* New_ctor() ;

/// @brief Method Update, addr 0x6282394, size 0x80, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x62819c0, size 0x104, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Check, addr 0x6282b3c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <CheckDebugPackets>b__24_0, addr 0x6282b9c, size 0xc, virtual false, abstract: false, final false
inline bool _CheckDebugPackets_b__24_0(::Tayx::Graphy::GraphyDebugger_DebugPacket*  packet) ;

/// @brief Method .ctor, addr 0x6282b98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetFirstDebugPacketWithId>b__0, addr 0x6282ba8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6281ea0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetAllDebugPacketsWithId>b__0, addr 0x6282bc8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6281f84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RemoveAllDebugPacketsWithId>b__0, addr 0x6282be8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6282114, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_debugPackets, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_debugPackets, put=__cordl_internal_set_m_debugPackets)) ::System::Collections::Generic::List_1<::Tayx::Graphy::GraphyDebugger_DebugPacket*>*  m_debugPackets;
...
/// @brief Method AddCallbackToAllDebugPacketWithId, addr 0x62821f0, size 0x1a4, virtual false, abstract: false, final false
inline void AddCallbackToAllDebugPacketWithId(::System::Action*  callback, int32_t  id) ;

/// @brief Method AddCallbackToFirstDebugPacketWithId, addr 0x6282118, size 0xd8, virtual false, abstract: false, final false
inline void AddCallbackToFirstDebugPacketWithId(::System::Action*  callback, int32_t  id) ;

/// @brief Method AddNewDebugPacket, addr 0x628176c, size 0xb4, virtual false, abstract: false, final false
inline void AddNewDebugPacket(::Tayx::Graphy::GraphyDebugger_DebugPacket*  newDebugPacket) ;

/// @brief Method AddNewDebugPacket, addr 0x6281820, size 0x1a0, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::Tayx::Graphy::GraphyDebugger_DebugCondition  newDebugCondition, ::Tayx::Graphy::GraphyDebugger_MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Action*  newCallback) ;

/// @brief Method AddNewDebugPacket, addr 0x6281be0, size 0x134, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::Tayx::Graphy::GraphyDebugger_DebugCondition  newDebugCondition, ::Tayx::Graphy::GraphyDebugger_MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>*  newCallbacks) ;

/// @brief Method AddNewDebugPacket, addr 0x6281ac4, size 0x11c, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::GraphyDebugger_DebugCondition>*  newDebugConditions, ::Tayx::Graphy::GraphyDebugger_MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Action*  newCallback) ;

/// @brief Method AddNewDebugPacket, addr 0x6281d14, size 0xb0, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::GraphyDebugger_DebugCondition>*  newDebugConditions, ::Tayx::Graphy::GraphyDebugger_MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>*  newCallbacks) ;

/// @brief Method CheckDebugPackets, addr 0x628139c, size 0x3d0, virtual false, abstract: false, final false
inline void CheckDebugPackets() ;

/// @brief Method CheckIfConditionIsMet, addr 0x6282414, size 0x120, virtual false, abstract: false, final false
inline bool CheckIfConditionIsMet(::Tayx::Graphy::GraphyDebugger_DebugCondition  debugCondition) ;

/// @brief Method ExecuteOperationsInDebugPacket, addr 0x6282534, size 0x3dc, virtual false, abstract: false, final false
inline void ExecuteOperationsInDebugPacket(::Tayx::Graphy::GraphyDebugger_DebugPacket*  debugPacket) ;

/// @brief Method GetAllDebugPacketsWithId, addr 0x6281ea4, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetFirstDebugPacketWithId, addr 0x6281dc4, size 0xdc, virtual false, abstract: false, final false
inline ::Tayx::Graphy::GraphyDebugger_DebugPacket* GetFirstDebugPacketWithId(int32_t  packetId) ;

/// @brief Method GetRequestedValueFromDebugVariable, addr 0x6282910, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method RemoveAllDebugPacketsWithId, addr 0x6282024, size 0xf0, virtual false, abstract: false, final false
inline void RemoveAllDebugPacketsWithId(int32_t  packetId) ;

/// @brief Method RemoveFirstDebugPacketWithId, addr 0x6281f88, size 0x9c, virtual false, abstract: false, final false
inline void RemoveFirstDebugPacketWithId(int32_t  packetId) ;

/// @brief Method Start, addr 0x62812f4, size 0xa4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x6281398, size 0x4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x6281240, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;
