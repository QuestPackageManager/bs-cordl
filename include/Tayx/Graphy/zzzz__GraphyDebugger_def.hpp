...
public:
  ...
  /// @brief Method Executed, addr 0x62f4b3c, size 0xc, virtual false, abstract: false, final false
  inline void Executed();

  static inline ::Tayx::Graphy::GraphyDebugger_DebugPacket* New_ctor();

  /// @brief Method Update, addr 0x62f43a0, size 0x80, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x62f39cc, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Check, addr 0x62f4b48, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <CheckDebugPackets>b__24_0, addr 0x62f4ba8, size 0xc, virtual false, abstract: false, final false
  inline bool _CheckDebugPackets_b__24_0(::Tayx::Graphy::GraphyDebugger_DebugPacket* packet);

  /// @brief Method .ctor, addr 0x62f4ba4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetFirstDebugPacketWithId>b__0, addr 0x62f4bb4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62f3eac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetAllDebugPacketsWithId>b__0, addr 0x62f4bd4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62f3f90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveAllDebugPacketsWithId>b__0, addr 0x62f4bf4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62f4120, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddCallbackToAllDebugPacketWithId, addr 0x62f41fc, size 0x1a4, virtual false, abstract: false, final false
  inline void AddCallbackToAllDebugPacketWithId(::System::Action* callback, int32_t id);

  /// @brief Method AddCallbackToFirstDebugPacketWithId, addr 0x62f4124, size 0xd8, virtual false, abstract: false, final false
  inline void AddCallbackToFirstDebugPacketWithId(::System::Action* callback, int32_t id);

  /// @brief Method AddNewDebugPacket, addr 0x62f3778, size 0xb4, virtual false, abstract: false, final false
  inline void AddNewDebugPacket(::Tayx::Graphy::GraphyDebugger_DebugPacket* newDebugPacket);

  /// @brief Method AddNewDebugPacket, addr 0x62f382c, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddNewDebugPacket, addr 0x62f3bec, size 0x134, virtual false, abstract: false, final false
  inline void AddNewDebugPacket(int32_t newId, ::Tayx::Graphy::GraphyDebugger_DebugCondition newDebugCondition, ::Tayx::Graphy::GraphyDebugger_MessageType newMessageType, ::StringW newMessage,
                                bool newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>* newCallbacks);

  /// @brief Method AddNewDebugPacket, addr 0x62f3ad0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddNewDebugPacket, addr 0x62f3d20, size 0xb0, virtual false, abstract: false, final false
  inline void AddNewDebugPacket(int32_t newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::GraphyDebugger_DebugCondition>* newDebugConditions,
  ...
  /// @brief Method CheckDebugPackets, addr 0x62f33a8, size 0x3d0, virtual false, abstract: false, final false
  inline void CheckDebugPackets();

  /// @brief Method CheckIfConditionIsMet, addr 0x62f4420, size 0x120, virtual false, abstract: false, final false
  inline bool CheckIfConditionIsMet(::Tayx::Graphy::GraphyDebugger_DebugCondition debugCondition);

  /// @brief Method ExecuteOperationsInDebugPacket, addr 0x62f4540, size 0x3dc, virtual false, abstract: false, final false
  inline void ExecuteOperationsInDebugPacket(::Tayx::Graphy::GraphyDebugger_DebugPacket* debugPacket);

  /// @brief Method GetAllDebugPacketsWithId, addr 0x62f3eb0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFirstDebugPacketWithId, addr 0x62f3dd0, size 0xdc, virtual false, abstract: false, final false
  inline ::Tayx::Graphy::GraphyDebugger_DebugPacket* GetFirstDebugPacketWithId(int32_t packetId);

  /// @brief Method GetRequestedValueFromDebugVariable, addr 0x62f491c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveAllDebugPacketsWithId, addr 0x62f4030, size 0xf0, virtual false, abstract: false, final false
  inline void RemoveAllDebugPacketsWithId(int32_t packetId);

  /// @brief Method RemoveFirstDebugPacketWithId, addr 0x62f3f94, size 0x9c, virtual false, abstract: false, final false
  inline void RemoveFirstDebugPacketWithId(int32_t packetId);

  /// @brief Method Start, addr 0x62f3300, size 0xa4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x62f33a4, size 0x4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x62f324c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();
