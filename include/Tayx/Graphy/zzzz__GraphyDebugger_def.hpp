...
namespace Tayx::Graphy {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15053)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(15054))}
...
public:
  ...
  /// @brief Method get_Check addr 0x2a005d8 size 0x8 virtual false final false
  inline bool get_Check();

  /// @brief Method Update addr 0x29ffed8 size 0x5c virtual false final false
  inline void Update();

  /// @brief Method Executed addr 0x2a005cc size 0xc virtual false final false
  inline void Executed();

  static inline ::Tayx::Graphy::__GraphyDebugger__DebugPacket* New_ctor();

  /// @brief Method .ctor addr 0x29ff4c0 size 0x11c virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x29ff9a8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetFirstDebugPacketWithId>b__0 addr 0x2a005e0 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x29ffa8c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetAllDebugPacketsWithId>b__0 addr 0x2a00604 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x29ffc0c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <RemoveAllDebugPacketsWithId>b__0 addr 0x2a00628 size 0x24 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2a006b0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <CheckDebugPackets>b__24_0 addr 0x2a006b8 size 0xc virtual false final false
...
namespace Tayx::Graphy {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15071), inst: 2552 }), TypeDefinitionIndex(TypeDefinitionIndex(15071))}
...
public:
  ...
  /// @brief Method .ctor addr 0x29fed00 size 0xbc virtual false final false
  inline void _ctor();

  /// @brief Method Start addr 0x29fedbc size 0xa0 virtual false final false
  inline void Start();

  /// @brief Method Update addr 0x29fee5c size 0x4 virtual false final false
  inline void Update();

  /// @brief Method AddNewDebugPacket addr 0x29ff27c size 0xa8 virtual false final false
  inline void AddNewDebugPacket(::Tayx::Graphy::__GraphyDebugger__DebugPacket* newDebugPacket);

  /// @brief Method AddNewDebugPacket addr 0x29ff324 size 0x19c virtual false final false
  ...
  /// @brief Method AddNewDebugPacket addr 0x29ff5dc size 0x118 virtual false final false
  ...
  /// @brief Method AddNewDebugPacket addr 0x29ff6f4 size 0x130 virtual false final false
  inline void AddNewDebugPacket(int32_t newId, ::Tayx::Graphy::__GraphyDebugger__DebugCondition newDebugCondition, ::Tayx::Graphy::__GraphyDebugger__MessageType newMessageType, ::StringW newMessage,
                                bool newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>* newCallbacks);

  /// @brief Method AddNewDebugPacket addr 0x29ff824 size 0xac virtual false final false
  inline void AddNewDebugPacket(int32_t newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugCondition>* newDebugConditions,
  ...
  /// @brief Method GetFirstDebugPacketWithId addr 0x29ff8d0 size 0xd8 virtual false final false
  inline ::Tayx::Graphy::__GraphyDebugger__DebugPacket* GetFirstDebugPacketWithId(int32_t packetId);

  /// @brief Method GetAllDebugPacketsWithId addr 0x29ff9b0 size 0xdc virtual false final false
  ...
  /// @brief Method RemoveFirstDebugPacketWithId addr 0x29ffa94 size 0x8c virtual false final false
  inline void RemoveFirstDebugPacketWithId(int32_t packetId);

  /// @brief Method RemoveAllDebugPacketsWithId addr 0x29ffb20 size 0xec virtual false final false
  inline void RemoveAllDebugPacketsWithId(int32_t packetId);

  /// @brief Method AddCallbackToFirstDebugPacketWithId addr 0x29ffc14 size 0xd8 virtual false final false
  inline void AddCallbackToFirstDebugPacketWithId(::System::Action* callback, int32_t id);

  /// @brief Method AddCallbackToAllDebugPacketWithId addr 0x29ffcec size 0x1ec virtual false final false
  inline void AddCallbackToAllDebugPacketWithId(::System::Action* callback, int32_t id);

  /// @brief Method CheckDebugPackets addr 0x29fee60 size 0x41c virtual false final false
  inline void CheckDebugPackets();

  /// @brief Method CheckIfConditionIsMet addr 0x29fff34 size 0x110 virtual false final false
  inline bool CheckIfConditionIsMet(::Tayx::Graphy::__GraphyDebugger__DebugCondition debugCondition);

  /// @brief Method GetRequestedValueFromDebugVariable addr 0x2a00400 size 0x1cc virtual false final false
  inline float_t GetRequestedValueFromDebugVariable(::Tayx::Graphy::__GraphyDebugger__DebugVariable debugVariable);

  /// @brief Method ExecuteOperationsInDebugPacket addr 0x2a00044 size 0x3bc virtual false final false
