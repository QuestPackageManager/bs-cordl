...
public:
  ...
  /// @brief Method CreatePoints, addr 0x2b54030, size 0x2ec, virtual true, abstract: false, final false
  inline void CreatePoints();

  /// @brief Method Init, addr 0x2b53c68, size 0x160, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Ram::G_RamGraph* New_ctor();

  /// @brief Method Update, addr 0x2b53a04, size 0xc, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateGraph, addr 0x2b53dc8, size 0x268, virtual true, abstract: false, final false
  inline void UpdateGraph();

  /// @brief Method UpdateParameters, addr 0x2b53a10, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b5431c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
