...
/// @brief Method CreatePoints, addr 0x6289f40, size 0x310, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x6289b98, size 0x164, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamGraph* New_ctor() ;

/// @brief Method Update, addr 0x6289940, size 0xc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x6289cfc, size 0x244, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x628994c, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628a250, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
