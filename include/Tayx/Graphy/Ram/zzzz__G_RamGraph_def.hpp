...
public:
  ...
  /// @brief Method CreatePoints, addr 0x306bee0, size 0x2ec, virtual true, abstract: false, final false
  inline void CreatePoints();

  /// @brief Method Init, addr 0x306bb18, size 0x160, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Ram::G_RamGraph* New_ctor();

  /// @brief Method Update, addr 0x306b8b4, size 0xc, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateGraph, addr 0x306bc78, size 0x268, virtual true, abstract: false, final false
  inline void UpdateGraph();

  /// @brief Method UpdateParameters, addr 0x306b8c0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x306c1cc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
