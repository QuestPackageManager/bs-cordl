...
public:
  ...
  /// @brief Method Awake, addr 0x6289f2c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x6289c8c, size 0x118, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Ram::G_RamText* New_ctor();

  /// @brief Method Update, addr 0x6289f30, size 0x17c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x6289bec, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x628a0ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
