...
public:
  ...
  /// @brief Method Awake, addr 0x62223a0, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x6222100, size 0x118, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Ram::G_RamText* New_ctor();

  /// @brief Method Update, addr 0x62223a4, size 0x17c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x6222060, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6222520, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
