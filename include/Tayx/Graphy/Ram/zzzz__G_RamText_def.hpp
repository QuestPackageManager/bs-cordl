...
/// @brief Field m_allocatedSystemMemorySizeText, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_allocatedSystemMemorySizeText, put=__cordl_internal_set_m_allocatedSystemMemorySizeText)) ::UnityW<::UnityEngine::UI::Text>  m_allocatedSystemMemorySizeText;
...
/// @brief Field m_reservedSystemMemorySizeText, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_reservedSystemMemorySizeText, put=__cordl_internal_set_m_reservedSystemMemorySizeText)) ::UnityW<::UnityEngine::UI::Text>  m_reservedSystemMemorySizeText;
...
/// @brief Method Awake, addr 0x62fe170, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x62fded0, size 0x118, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamText* New_ctor() ;

/// @brief Method Update, addr 0x62fe174, size 0x17c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x62fde30, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x62fe2f0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
