...
/// @brief Method Awake, addr 0x628a5ec, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x628a34c, size 0x118, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamText* New_ctor() ;

/// @brief Method Update, addr 0x628a5f0, size 0x17c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x628a2ac, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628a76c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
