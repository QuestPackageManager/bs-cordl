...
public:
  ...
  /// @brief Method Awake, addr 0x2b54680, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x2b54420, size 0x10c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Ram::G_RamText* New_ctor();

  /// @brief Method Update, addr 0x2b54684, size 0x160, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x2b54380, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b547e4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
