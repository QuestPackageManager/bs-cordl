...
/// @brief Method CreatePoints, addr 0x628ac14, size 0x154, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x628a880, size 0x120, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsGraph* New_ctor() ;

/// @brief Method Update, addr 0x628a778, size 0xc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x628a9a0, size 0x274, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x628a784, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628ad68, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
