...
public:
  ...
  /// @brief Method <Update>b__25_0, addr 0x3040290, size 0x20, virtual false, abstract: false, final false
  inline int32_t _Update_b__25_0(int16_t x, int16_t y);

  /// @brief Method .ctor, addr 0x3040288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x303fe74, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x303a77c, size 0xa4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsMonitor* New_ctor();

  /// @brief Method Update, addr 0x303fe78, size 0x390, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x303fbac, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3040208, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AverageFPS, addr 0x303fe44, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_AverageFPS();

  /// @brief Method get_CurrentFPS, addr 0x303fe34, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_CurrentFPS();

  /// @brief Method get_OnePercentFPS, addr 0x303fe54, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_OnePercentFPS();

  /// @brief Method get_Zero1PercentFps, addr 0x303fe64, size 0x8, virtual false, abstract: false, final false
  inline int16_t get_Zero1PercentFps();

  /// @brief Method set_AverageFPS, addr 0x303fe4c, size 0x8, virtual false, abstract: false, final false
  inline void set_AverageFPS(int16_t value);

  /// @brief Method set_CurrentFPS, addr 0x303fe3c, size 0x8, virtual false, abstract: false, final false
  inline void set_CurrentFPS(int16_t value);

  /// @brief Method set_OnePercentFPS, addr 0x303fe5c, size 0x8, virtual false, abstract: false, final false
  inline void set_OnePercentFPS(int16_t value);

  /// @brief Method set_Zero1PercentFps, addr 0x303fe6c, size 0x8, virtual false, abstract: false, final false
