...
public:
  ...
  /// @brief Method Awake, addr 0x62fd4d0, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x62fce28, size 0x154, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor();

  /// @brief Method SetFpsRelatedTextColor, addr 0x62fd808, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateParameters, addr 0x62fce0c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62fd8a8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
