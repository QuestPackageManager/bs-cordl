...
public:
  ...
  /// @brief Method Awake addr 0x2a09154 size 0x4 virtual false final false
  inline void Awake();

  /// @brief Method Update addr 0x2a09158 size 0x30c virtual false final false
  inline void Update();

  /// @brief Method UpdateParameters addr 0x2a08a90 size 0x20 virtual false final false
  inline void UpdateParameters();

  /// @brief Method Init addr 0x2a08ab0 size 0x144 virtual false final false
  inline void Init();

  /// @brief Method SetFpsRelatedTextColor addr 0x2a09464 size 0x7c virtual false final false
  inline void SetFpsRelatedTextColor(::UnityEngine::UI::Text* text, float_t fps);

  static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor();

  /// @brief Method .ctor addr 0x2a094e0 size 0x10 virtual false final false
  inline void _ctor();
