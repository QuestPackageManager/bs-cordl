...
public:
  ...
  /// @brief Method Awake, addr 0x628ae04, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x628a75c, size 0x154, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor();

  /// @brief Method SetFpsRelatedTextColor, addr 0x628b13c, size 0xa0, virtual false, abstract: false, final false
  inline void SetFpsRelatedTextColor(::UnityEngine::UI::Text* text, float_t fps);

  /// @brief Method Update, addr 0x628ae08, size 0x334, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x628a740, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x628b1dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
