...
public:
  ...
  /// @brief Method Awake, addr 0x44d4450, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x44d3db8, size 0x144, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor();

  /// @brief Method SetFpsRelatedTextColor, addr 0x44d4760, size 0x80, virtual false, abstract: false, final false
  inline void SetFpsRelatedTextColor(::UnityEngine::UI::Text* text, float_t fps);

  /// @brief Method Update, addr 0x44d4454, size 0x30c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateParameters, addr 0x44d3d98, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d47e0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
