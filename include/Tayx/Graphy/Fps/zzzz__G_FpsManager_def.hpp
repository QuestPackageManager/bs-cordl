...
public:
  ...
  /// @brief Method Awake, addr 0x2f3f260, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x2f3a050, size 0x4e4, virtual false, abstract: false, final false
  inline void Init();

  static inline ::Tayx::Graphy::Fps::G_FpsManager* New_ctor();

  /// @brief Method RefreshParameters, addr 0x2f3c3c8, size 0x1f4, virtual false, abstract: false, final false
  inline void RefreshParameters();

  /// @brief Method RestorePreviousState, addr 0x2f39e4c, size 0xc, virtual false, abstract: false, final false
  inline void RestorePreviousState();

  /// @brief Method SetGraphActive, addr 0x2f3f268, size 0x44, virtual false, abstract: false, final false
  inline void SetGraphActive(bool active);

  /// @brief Method SetPosition, addr 0x2f37128, size 0x2e8, virtual true, abstract: false, final true
  inline void SetPosition(::Tayx::Graphy::__GraphyManager__ModulePosition newModulePosition);

  /// @brief Method SetState, addr 0x2f37a24, size 0x1b0, virtual true, abstract: false, final true
  inline void SetState(::Tayx::Graphy::__GraphyManager__ModuleState state, bool silentUpdate);

  /// @brief Method Start, addr 0x2f3f264, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateParameters, addr 0x2f37c04, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2f3f450, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
