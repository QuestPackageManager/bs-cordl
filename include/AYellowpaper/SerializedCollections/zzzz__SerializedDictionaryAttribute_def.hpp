...
public:
  ...
  /// @brief Method .ctor, addr 0x3257814, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializedDictionaryAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializedDictionaryAttribute(SerializedDictionaryAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializedDictionaryAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializedDictionaryAttribute(SerializedDictionaryAttributeconst&) = delete;
