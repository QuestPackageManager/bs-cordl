...
DEFINE_IL2CPP_GEN_CLASS(::AYellowpaper::SerializedCollections::SerializedKeyValuePair_2, "AYellowpaper.SerializedCollections", "SerializedKeyValuePair`2");
// Dependencies
namespace AYellowpaper::SerializedCollections {
// cpp template
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23377 };
