...
public:
  ...
  /// @brief Method OpenFilePanel addr 0x21e6e44 size 0x140 virtual false final false
  ...
  /// @brief Method OpenFilePanel addr 0x21e6f84 size 0xf8 virtual false final false
  ...
  /// @brief Method OpenFilePanelAsync addr 0x21e707c size 0x148 virtual false final false
  ...
  /// @brief Method OpenFilePanelAsync addr 0x21e71c4 size 0x104 virtual false final false
  ...
  /// @brief Method OpenFolderPanel addr 0x21e72c8 size 0xec virtual false final false
  static inline ::ArrayW<::StringW, ::Array<::StringW>*> OpenFolderPanel(::StringW title, ::StringW directory, bool multiselect);

  /// @brief Method OpenFolderPanelAsync addr 0x21e73b4 size 0xfc virtual false final false
  ...
  /// @brief Method SaveFilePanel addr 0x21e74b0 size 0x140 virtual false final false
  static inline ::StringW SaveFilePanel(::StringW title, ::StringW directory, ::StringW defaultName, ::StringW extension);

  /// @brief Method SaveFilePanel addr 0x21e75f0 size 0xfc virtual false final false
  ...
  /// @brief Method SaveFilePanelAsync addr 0x21e76ec size 0x148 virtual false final false
  ...
  /// @brief Method SaveFilePanelAsync addr 0x21e7834 size 0x104 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21e7938 size 0x8 virtual false final false
  inline void _ctor();
