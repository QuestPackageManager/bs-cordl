...
public:
  ...
  /// @brief Method Finish, addr 0x3b732d8, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::LevelCompletionResults* levelCompletionResults);

  /// @brief Method Init, addr 0x3b73300, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7375c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b73178, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x3b73228, size 0xb0, virtual false, abstract: false, final false
