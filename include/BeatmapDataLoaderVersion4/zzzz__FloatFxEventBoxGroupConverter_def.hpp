...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x37609f0, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375f788, size 0xc, virtual false, abstract: false, final false
