...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270b9e4, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a91c, size 0x2c, virtual false, abstract: false, final false
