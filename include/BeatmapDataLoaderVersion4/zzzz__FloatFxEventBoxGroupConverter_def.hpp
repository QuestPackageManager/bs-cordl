...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatFxEventBoxGroupConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatFxEventBoxGroupConverter(FloatFxEventBoxGroupConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatFxEventBoxGroupConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatFxEventBoxGroupConverter(FloatFxEventBoxGroupConverterconst&) = delete;
