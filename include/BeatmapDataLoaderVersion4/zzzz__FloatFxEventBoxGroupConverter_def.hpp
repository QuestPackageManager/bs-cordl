...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x1329ecc, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1328e70, size 0x30, virtual false, abstract: false, final false
