...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14fe708, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fd6ac, size 0x30, virtual false, abstract: false, final false
