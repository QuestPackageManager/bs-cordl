...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x1405cb4, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1404c58, size 0x30, virtual false, abstract: false, final false
