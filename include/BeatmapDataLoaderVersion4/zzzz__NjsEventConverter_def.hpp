...
public:
  ...
  /// @brief Method Convert, addr 0x3638efc, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3638ef4, size 0x8, virtual false, abstract: false, final false
