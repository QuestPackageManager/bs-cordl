...
public:
  ...
  /// @brief Method Convert, addr 0x270dd38, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270dd0c, size 0x2c, virtual false, abstract: false, final false
