...
/// @brief Field _noteJumpMovementSpeedEvents, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteJumpMovementSpeedEvents, put=__cordl_internal_set__noteJumpMovementSpeedEvents)) ::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  _noteJumpMovementSpeedEvents;

/// @brief Method Convert, addr 0x36653e8, size 0xe8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteJumpSpeedEventData* Convert(::BeatmapSaveDataVersion4::BeatIndex*  index) ;

static inline ::BeatmapDataLoaderVersion4::NjsEventConverter* New_ctor(::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  noteJumpMovementSpeedEvents, ::GlobalNamespace::IBeatToTimeConverter*  bpmTimeProcessor) ;

constexpr ::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*> const& __cordl_internal_get__noteJumpMovementSpeedEvents() const;
...
constexpr void __cordl_internal_set__noteJumpMovementSpeedEvents(::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  value) ;

/// @brief Method .ctor, addr 0x36653e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  noteJumpMovementSpeedEvents, ::GlobalNamespace::IBeatToTimeConverter*  bpmTimeProcessor) ;
