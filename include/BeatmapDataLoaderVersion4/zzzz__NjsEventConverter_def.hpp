...
public:
  ...
  /// @brief Method Convert, addr 0x36a1e44, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a1e3c, size 0x8, virtual false, abstract: false, final false
