...
public:
  ...
  /// @brief Method Convert, addr 0x270dde0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270dc68, size 0x2c, virtual false, abstract: false, final false
