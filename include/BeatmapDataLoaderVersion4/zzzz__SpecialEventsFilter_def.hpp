...
public:
  ...
  /// @brief Method IsEventValid, addr 0x3665cb4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3665468, size 0x22c, virtual false, abstract: false, final false
