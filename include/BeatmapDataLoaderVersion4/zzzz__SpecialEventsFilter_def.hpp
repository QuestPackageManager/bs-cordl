...
public:
  ...
  /// @brief Method .ctor, addr 0x12bf46c, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEventValid, addr 0x12bfd28, size 0x64, virtual false, abstract: false, final false
