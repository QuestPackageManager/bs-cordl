...
public:
  ...
  /// @brief Method IsEventValid, addr 0x1404f8c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14046d0, size 0x2f0, virtual false, abstract: false, final false
