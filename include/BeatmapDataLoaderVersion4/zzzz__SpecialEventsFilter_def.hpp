...
public:
  ...
  /// @brief Method IsEventValid, addr 0x26d88dc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d7eb4, size 0x2f8, virtual false, abstract: false, final false
