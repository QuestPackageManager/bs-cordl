...
public:
  ...
  /// @brief Method IsEventValid, addr 0x14f754c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f6c90, size 0x2f0, virtual false, abstract: false, final false
