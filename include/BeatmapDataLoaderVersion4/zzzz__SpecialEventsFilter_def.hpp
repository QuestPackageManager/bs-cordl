...
public:
  ...
  /// @brief Method IsEventValid, addr 0x37642d8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763a8c, size 0x22c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpecialEventsFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpecialEventsFilter(SpecialEventsFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpecialEventsFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpecialEventsFilter(SpecialEventsFilterconst&) = delete;
