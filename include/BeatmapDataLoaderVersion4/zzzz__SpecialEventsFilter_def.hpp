...
public:
  ...
  /// @brief Method IsEventValid, addr 0x14fd9e0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fd124, size 0x2f0, virtual false, abstract: false, final false
