...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14f7f9c, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f71e8, size 0x30, virtual false, abstract: false, final false
