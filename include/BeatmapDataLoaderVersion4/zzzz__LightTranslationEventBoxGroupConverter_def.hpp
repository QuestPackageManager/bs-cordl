...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270ed98, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270df68, size 0x2c, virtual false, abstract: false, final false
