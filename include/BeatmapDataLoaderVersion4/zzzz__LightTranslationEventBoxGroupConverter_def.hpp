...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x3764ed8, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763f0c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationEventBoxGroupConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightTranslationEventBoxGroupConverter(LightTranslationEventBoxGroupConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationEventBoxGroupConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightTranslationEventBoxGroupConverter(LightTranslationEventBoxGroupConverterconst&) = delete;
