...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x1329bf4, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1328e40, size 0x30, virtual false, abstract: false, final false
