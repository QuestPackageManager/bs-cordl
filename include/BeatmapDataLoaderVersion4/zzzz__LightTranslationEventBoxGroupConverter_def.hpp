...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x27130dc, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27122ac, size 0x2c, virtual false, abstract: false, final false
