...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270d39c, size 0x228, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270c56c, size 0x2c, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter, 0x20>, "Size mismatch!");
