...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x36668ac, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36658e8, size 0xc, virtual false, abstract: false, final false
