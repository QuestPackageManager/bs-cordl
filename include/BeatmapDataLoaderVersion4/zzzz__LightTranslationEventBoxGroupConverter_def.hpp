...
public:
// Declarations
/// @brief Method ConvertEvents, addr 0x3666914, size 0x21c, virtual true, abstract: false, final false
...
static inline ::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter* New_ctor(::BeatmapSaveDataVersion4::LightshowSaveData*  lightshowSaveData, ::GlobalNamespace::IEnvironmentLightGroups*  lightGroups, ::GlobalNamespace::IBeatmapBoxConverter*  boxConverter) ;

/// @brief Method .ctor, addr 0x3665950, size 0xc, virtual false, abstract: false, final false
