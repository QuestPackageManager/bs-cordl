...
public:
  ...
  /// @brief Method Convert, addr 0x36a17cc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a1794, size 0x8, virtual false, abstract: false, final false
