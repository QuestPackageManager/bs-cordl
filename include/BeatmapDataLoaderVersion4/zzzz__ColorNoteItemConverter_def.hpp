...
public:
  ...
  /// @brief Method Convert, addr 0x3638884, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x363884c, size 0x8, virtual false, abstract: false, final false
