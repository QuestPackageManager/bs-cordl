...
public:
  ...
  /// @brief Method Convert, addr 0x13281ac, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x132809c, size 0x2c, virtual false, abstract: false, final false
