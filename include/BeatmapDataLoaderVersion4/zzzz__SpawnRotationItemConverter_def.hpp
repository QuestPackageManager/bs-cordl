...
public:
  ...
  /// @brief Method Convert, addr 0x14fd058, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fd02c, size 0x2c, virtual false, abstract: false, final false
