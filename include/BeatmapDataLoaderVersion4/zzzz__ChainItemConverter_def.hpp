...
public:
  ...
  /// @brief Method Convert, addr 0x14f679c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f64c8, size 0x30, virtual false, abstract: false, final false
