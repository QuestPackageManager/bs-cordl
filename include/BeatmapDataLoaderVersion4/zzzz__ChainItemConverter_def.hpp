...
public:
  ...
  /// @brief Method Convert, addr 0x270d530, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d20c, size 0x30, virtual false, abstract: false, final false
