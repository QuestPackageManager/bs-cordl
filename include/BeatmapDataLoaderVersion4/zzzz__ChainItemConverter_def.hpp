...
public:
  ...
  /// @brief Method Convert, addr 0x270d3e0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d0bc, size 0x30, virtual false, abstract: false, final false
