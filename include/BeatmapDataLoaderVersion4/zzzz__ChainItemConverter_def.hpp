...
public:
  ...
  /// @brief Method Convert, addr 0x270d8cc, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d5a8, size 0x30, virtual false, abstract: false, final false
