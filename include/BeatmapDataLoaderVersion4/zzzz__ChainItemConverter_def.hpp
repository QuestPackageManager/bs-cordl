...
public:
  ...
  /// @brief Method Convert, addr 0x36a1a40, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a17ac, size 0xc, virtual false, abstract: false, final false
