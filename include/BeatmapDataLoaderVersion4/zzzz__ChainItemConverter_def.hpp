...
public:
  ...
  /// @brief Method Convert, addr 0x14041e0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1403f0c, size 0x30, virtual false, abstract: false, final false
