...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x36665d8, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36658dc, size 0xc, virtual false, abstract: false, final false
