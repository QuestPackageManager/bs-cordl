...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270eaa8, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270df3c, size 0x2c, virtual false, abstract: false, final false
