...
public:
  ...
  /// @brief Method .ctor, addr 0x12bf994, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertEvents, addr 0x12c0470, size 0x258, virtual true, abstract: false, final false
