...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14fe128, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fd64c, size 0x30, virtual false, abstract: false, final false
