...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14056d8, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1404bfc, size 0x30, virtual false, abstract: false, final false
