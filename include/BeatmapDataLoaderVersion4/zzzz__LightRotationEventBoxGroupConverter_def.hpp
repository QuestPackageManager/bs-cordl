...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x26cd4b4, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cc934, size 0x30, virtual false, abstract: false, final false
