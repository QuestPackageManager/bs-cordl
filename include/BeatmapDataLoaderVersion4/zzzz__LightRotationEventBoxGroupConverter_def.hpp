...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightRotationEventBoxGroupConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightRotationEventBoxGroupConverter(LightRotationEventBoxGroupConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightRotationEventBoxGroupConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightRotationEventBoxGroupConverter(LightRotationEventBoxGroupConverterconst&) = delete;
