...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x3760474, size 0x2d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375f770, size 0xc, virtual false, abstract: false, final false
