...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::EventBoxGroupConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::EventBoxGroupConverter*, "BeatmapDataLoaderVersion4", "EventBoxGroupConverter");
...
public:
  // Declarations
  /// @brief Field _boxConverter, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__boxConverter, put = __cordl_internal_set__boxConverter)) ::GlobalNamespace::IBeatmapBoxConverter* _boxConverter;
  ...
  /// @brief Method Convert, addr 0x3763f24, size 0x320, virtual false, abstract: false, final false
  ...
  constexpr ::GlobalNamespace::IBeatmapBoxConverter* const& __cordl_internal_get__boxConverter() const;

  constexpr ::GlobalNamespace::IBeatmapBoxConverter*& __cordl_internal_get__boxConverter();
  ...
  constexpr void __cordl_internal_set__boxConverter(::GlobalNamespace::IBeatmapBoxConverter* value);
  ...
  /// @brief Method .ctor, addr 0x3764550, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroupConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventBoxGroupConverter(EventBoxGroupConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroupConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventBoxGroupConverter(EventBoxGroupConverterconst&) = delete;
  ...
  /// @brief Field _boxConverter, offset: 0x20, size: 0x8, def value: None
  ::GlobalNamespace::IBeatmapBoxConverter* ____boxConverter;
...
static_assert(offsetof(::BeatmapDataLoaderVersion4::EventBoxGroupConverter, ____boxConverter) == 0x20, "Offset mismatch!");

static_assert(sizeof(::BeatmapDataLoaderVersion4::EventBoxGroupConverter) == 0x28, "Size mismatch!");
