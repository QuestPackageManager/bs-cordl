...
public:
  ...
  /// @brief Method Convert, addr 0x270dfc0, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270e3b8, size 0x2c, virtual false, abstract: false, final false
