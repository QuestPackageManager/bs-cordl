...
public:
  ...
  /// @brief Method Convert, addr 0x270c5c4, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270c9bc, size 0x2c, virtual false, abstract: false, final false
