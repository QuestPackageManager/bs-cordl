...
public:
  ...
  /// @brief Method Convert, addr 0x270a104, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a4fc, size 0x2c, virtual false, abstract: false, final false
