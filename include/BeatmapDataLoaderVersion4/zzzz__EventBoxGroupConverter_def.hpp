...
public:
  ...
  /// @brief Method Convert, addr 0x14fd6dc, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fda44, size 0x30, virtual false, abstract: false, final false
