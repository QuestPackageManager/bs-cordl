...
public:
  ...
  /// @brief Method Convert, addr 0x270dc0c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d608, size 0x2c, virtual false, abstract: false, final false
