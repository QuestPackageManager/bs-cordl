...
/// @brief Field _waypoints, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__waypoints, put=__cordl_internal_set__waypoints)) ::ArrayW<::BeatmapSaveDataVersion4::Waypoint,::Array<::BeatmapSaveDataVersion4::Waypoint>*>  _waypoints;

/// @brief Method Convert, addr 0x36a30d8, size 0xf8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapObjectData* Convert(::BeatmapSaveDataVersion4::BeatmapBeatIndex*  index) ;

static inline ::BeatmapDataLoaderVersion4::WaypointItemConverter* New_ctor(::ArrayW<::BeatmapSaveDataVersion4::Waypoint,::Array<::BeatmapSaveDataVersion4::Waypoint>*>  waypoints, ::GlobalNamespace::BpmTimeProcessor*  bpmTimeProcessor) ;
...
/// @brief Method .ctor, addr 0x36a2b58, size 0x8, virtual false, abstract: false, final false
