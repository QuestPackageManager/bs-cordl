...
public:
  ...
  /// @brief Method Convert, addr 0x270a0a8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2709aa4, size 0x2c, virtual false, abstract: false, final false
