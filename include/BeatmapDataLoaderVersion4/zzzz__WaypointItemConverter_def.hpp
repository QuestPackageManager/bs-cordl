...
public:
  ...
  /// @brief Method Convert, addr 0x270dbe4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d5e0, size 0x2c, virtual false, abstract: false, final false
