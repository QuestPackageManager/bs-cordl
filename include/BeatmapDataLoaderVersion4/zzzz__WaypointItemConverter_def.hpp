...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WaypointItemConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WaypointItemConverter(WaypointItemConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WaypointItemConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WaypointItemConverter(WaypointItemConverterconst&) = delete;
