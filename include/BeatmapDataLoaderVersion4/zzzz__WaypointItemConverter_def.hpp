...
public:
  ...
  /// @brief Method Convert, addr 0x3638dfc, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x363887c, size 0x8, virtual false, abstract: false, final false
