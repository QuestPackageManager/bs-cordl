...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatFxBaseDataConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatFxBaseDataConverter(FloatFxBaseDataConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatFxBaseDataConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatFxBaseDataConverter(FloatFxBaseDataConverterconst&) = delete;
