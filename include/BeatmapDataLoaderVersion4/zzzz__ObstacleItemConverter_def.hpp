...
public:
  ...
  /// @brief Method Convert, addr 0x27093cc, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270919c, size 0x2c, virtual false, abstract: false, final false
