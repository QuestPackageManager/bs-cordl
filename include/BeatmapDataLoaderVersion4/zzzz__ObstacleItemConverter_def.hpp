...
public:
  ...
  /// @brief Method Convert, addr 0x12ffe40, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ffc48, size 0x2c, virtual false, abstract: false, final false
