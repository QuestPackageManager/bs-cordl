...
public:
  ...
  /// @brief Method Convert, addr 0x3763484, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763300, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObstacleItemConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObstacleItemConverter(ObstacleItemConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObstacleItemConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObstacleItemConverter(ObstacleItemConverterconst&) = delete;
