...
public:
  ...
  /// @brief Method .ctor, addr 0x12bec78, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x12bee70, size 0x108, virtual false, abstract: false, final false
