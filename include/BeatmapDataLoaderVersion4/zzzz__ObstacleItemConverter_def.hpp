...
public:
  ...
  /// @brief Method Convert, addr 0x13282ec, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13280f4, size 0x2c, virtual false, abstract: false, final false
