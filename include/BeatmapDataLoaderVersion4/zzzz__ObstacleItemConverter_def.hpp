...
public:
  ...
  /// @brief Method Convert, addr 0x270d7ac, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d57c, size 0x2c, virtual false, abstract: false, final false
