...
public:
  ...
  /// @brief Method Convert, addr 0x14fcb28, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fc930, size 0x2c, virtual false, abstract: false, final false
