...
public:
  ...
  /// @brief Method Convert, addr 0x14040d8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1403ee0, size 0x2c, virtual false, abstract: false, final false
