...
// Write type traits
MARK_REF_T(::BeatmapDataLoaderVersion4::BpmEventConverter*);
DEFINE_IL2CPP_CLASS(::BeatmapDataLoaderVersion4::BpmEventConverter*, "BeatmapDataLoaderVersion4", "BpmEventConverter");
...
public:
  ...
  /// @brief Method Convert, addr 0x376322c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763220, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BpmEventConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BpmEventConverter(BpmEventConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BpmEventConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BpmEventConverter(BpmEventConverterconst&) = delete;
...
static_assert(sizeof(::BeatmapDataLoaderVersion4::BpmEventConverter) == 0x20, "Size mismatch!");
