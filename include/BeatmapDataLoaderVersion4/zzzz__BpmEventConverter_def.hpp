...
public:
  ...
  /// @brief Method Convert, addr 0x3664c0c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3664c00, size 0xc, virtual false, abstract: false, final false
