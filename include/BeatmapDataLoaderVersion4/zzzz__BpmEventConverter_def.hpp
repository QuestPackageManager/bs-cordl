...
public:
  ...
  /// @brief Method Convert, addr 0x36a16d0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a16c4, size 0xc, virtual false, abstract: false, final false
