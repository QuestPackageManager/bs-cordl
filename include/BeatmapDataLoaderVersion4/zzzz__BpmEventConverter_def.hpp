...
public:
  ...
  /// @brief Method Convert, addr 0x270d470, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d444, size 0x2c, virtual false, abstract: false, final false
