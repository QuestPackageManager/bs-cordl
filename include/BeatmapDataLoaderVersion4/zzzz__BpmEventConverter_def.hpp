...
public:
  ...
  /// @brief Method Convert, addr 0x270d0d4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d0a8, size 0x2c, virtual false, abstract: false, final false
