...
public:
  ...
  /// @brief Method Convert, addr 0x36a18ac, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a179c, size 0x8, virtual false, abstract: false, final false
