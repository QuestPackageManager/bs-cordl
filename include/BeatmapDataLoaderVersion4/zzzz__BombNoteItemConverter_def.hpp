...
public:
  ...
  /// @brief Method .ctor, addr 0x12bec4c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x12bedfc, size 0x74, virtual false, abstract: false, final false
