...
public:
  ...
  /// @brief Method Convert, addr 0x3763408, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37632f8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BombNoteItemConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BombNoteItemConverter(BombNoteItemConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BombNoteItemConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BombNoteItemConverter(BombNoteItemConverterconst&) = delete;
