...
public:
  ...
  /// @brief Method Convert, addr 0x12ffdcc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ffc1c, size 0x2c, virtual false, abstract: false, final false
