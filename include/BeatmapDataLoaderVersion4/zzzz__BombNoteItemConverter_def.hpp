...
public:
  ...
  /// @brief Method Convert, addr 0x14f6620, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f6470, size 0x2c, virtual false, abstract: false, final false
