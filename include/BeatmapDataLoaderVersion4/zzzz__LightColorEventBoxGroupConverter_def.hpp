...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x3764920, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763ef4, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightColorEventBoxGroupConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightColorEventBoxGroupConverter(LightColorEventBoxGroupConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightColorEventBoxGroupConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightColorEventBoxGroupConverter(LightColorEventBoxGroupConverterconst&) = delete;
