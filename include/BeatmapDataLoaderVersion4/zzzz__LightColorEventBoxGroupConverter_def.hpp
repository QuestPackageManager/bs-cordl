...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270e780, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270df10, size 0x2c, virtual false, abstract: false, final false
