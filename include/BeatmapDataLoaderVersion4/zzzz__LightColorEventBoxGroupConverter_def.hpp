...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x3760190, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375f764, size 0xc, virtual false, abstract: false, final false
