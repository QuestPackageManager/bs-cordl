...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270a8c4, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a054, size 0x2c, virtual false, abstract: false, final false
