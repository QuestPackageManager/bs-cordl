...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x2712ac4, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2712254, size 0x2c, virtual false, abstract: false, final false
