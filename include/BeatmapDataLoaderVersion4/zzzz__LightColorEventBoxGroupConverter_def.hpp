...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14fddf4, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fd61c, size 0x30, virtual false, abstract: false, final false
