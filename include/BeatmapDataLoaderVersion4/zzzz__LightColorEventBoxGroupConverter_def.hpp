...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x26d8d08, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d8494, size 0x2c, virtual false, abstract: false, final false
