...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x14053a0, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1404bc8, size 0x30, virtual false, abstract: false, final false
