...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270cd84, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270c514, size 0x2c, virtual false, abstract: false, final false
