...
public:
  // Declarations
  /// @brief Method ConvertEvents, addr 0x270b108, size 0x24c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a898, size 0x2c, virtual false, abstract: false, final false
