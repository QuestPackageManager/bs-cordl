...
public:
  ...
  /// @brief Method Convert, addr 0x3763ccc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763cb8, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicEventItemConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicEventItemConverter(BasicEventItemConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicEventItemConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicEventItemConverter(BasicEventItemConverterconst&) = delete;
