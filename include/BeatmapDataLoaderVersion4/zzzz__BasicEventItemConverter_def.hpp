...
public:
  ...
  /// @brief Method Convert, addr 0x270a61c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a5b0, size 0x40, virtual false, abstract: false, final false
