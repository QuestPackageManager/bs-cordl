...
public:
  ...
  /// @brief Method Convert, addr 0x36a216c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36a2158, size 0xc, virtual false, abstract: false, final false
