...
public:
  // Declarations
  /// @brief Method Convert, addr 0x14fda74, size 0x380, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::IndexFilter* Convert(::BeatmapSaveDataVersion4::IndexFilter indexFilter, int32_t groupSize);

  /// @brief Method IsIndexFilterValid, addr 0x14fe9cc, size 0xa4, virtual false, abstract: false, final false
