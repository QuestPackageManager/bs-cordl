...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IndexFilterConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IndexFilterConverter(IndexFilterConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IndexFilterConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IndexFilterConverter(IndexFilterConverterconst&) = delete;
