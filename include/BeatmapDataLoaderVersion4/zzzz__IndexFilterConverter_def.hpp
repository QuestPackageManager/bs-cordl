...
public:
  // Declarations
  /// @brief Method Convert, addr 0x2712728, size 0x39c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::IndexFilter* Convert(::BeatmapSaveDataVersion4::IndexFilter indexFilter, int32_t groupSize);

  /// @brief Method IsIndexFilterValid, addr 0x2713658, size 0xa4, virtual false, abstract: false, final false
