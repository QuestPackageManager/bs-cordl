...
public:
  ...
  /// @brief Method Convert, addr 0x1404340, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1403f3c, size 0x30, virtual false, abstract: false, final false
