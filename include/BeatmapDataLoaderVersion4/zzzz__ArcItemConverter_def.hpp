...
public:
  ...
  /// @brief Method Convert, addr 0x270d55c, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d0ec, size 0x30, virtual false, abstract: false, final false
