...
public:
  ...
  /// @brief Method Convert, addr 0x36650d4, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3664cf4, size 0xc, virtual false, abstract: false, final false
