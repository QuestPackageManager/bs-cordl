...
public:
  ...
  /// @brief Method .ctor, addr 0x12becd4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Convert, addr 0x12bf0d8, size 0x1ac, virtual false, abstract: false, final false
