...
public:
  ...
  /// @brief Method Convert, addr 0x13000a8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ffca4, size 0x30, virtual false, abstract: false, final false
