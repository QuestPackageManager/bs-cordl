...
public:
  ...
  /// @brief Method Convert, addr 0x37636f4, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3763314, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArcItemConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArcItemConverter(ArcItemConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArcItemConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArcItemConverter(ArcItemConverterconst&) = delete;
