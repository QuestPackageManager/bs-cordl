...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::IntFxEventBaseData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::IntFxEventBaseData*, "BeatmapSaveDataVersion3", "IntFxEventBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375aa18, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, int32_t value);

  /// @brief Method get_beat, addr 0x375a9f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_usePreviousEventValue, addr 0x375aa00, size 0x10, virtual false, abstract: false, final false
  inline bool get_usePreviousEventValue();

  /// @brief Method get_value, addr 0x375aa10, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::IntFxEventBaseData) == 0x20, "Size mismatch!");
