...
/// @brief Method .ctor, addr 0x369e9c0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, int32_t  value) ;

/// @brief Method get_beat, addr 0x369e9a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_usePreviousEventValue, addr 0x369e9a8, size 0x10, virtual false, abstract: false, final false
inline bool get_usePreviousEventValue() ;

/// @brief Method get_value, addr 0x369e9b8, size 0x8, virtual false, abstract: false, final false
