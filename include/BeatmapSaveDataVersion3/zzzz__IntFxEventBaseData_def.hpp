...
public:
  ...
  /// @brief Method get_beat, addr 0x12bb924, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_usePreviousEventValue, addr 0x12bb92c, size 0x10, virtual false, abstract: false, final false
  inline bool get_usePreviousEventValue();

  /// @brief Method get_value, addr 0x12bb93c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_value();

  static inline ::BeatmapSaveDataVersion3::IntFxEventBaseData* New_ctor(float_t beat, int32_t value);

  /// @brief Method .ctor, addr 0x12bb944, size 0x38, virtual false, abstract: false, final false
