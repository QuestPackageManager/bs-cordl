...
// TypeDefinitionIndex(TypeDefinitionIndex(11208))] Self: TypeDefinitionIndex(TypeDefinitionIndex(11172)) CS Name: ::BeatmapSaveDataVersion3::LightRotationEventBox*
...
public:
  ...
  /// @brief Method get_rotationDistributionParam, addr 0x12bbe00, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rotationDistributionParam();

  /// @brief Method get_rotationDistributionParamType, addr 0x12bbe08, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::DistributionParamType get_rotationDistributionParamType();

  /// @brief Method get_axis, addr 0x12bbe10, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::Axis get_axis();

  /// @brief Method get_flipRotation, addr 0x12bbe18, size 0x10, virtual false, abstract: false, final false
  inline bool get_flipRotation();

  /// @brief Method get_rotationDistributionShouldAffectFirstBaseEvent, addr 0x12bbe28, size 0x10, virtual false, abstract: false, final false
  inline bool get_rotationDistributionShouldAffectFirstBaseEvent();

  /// @brief Method get_rotationDistributionEaseType, addr 0x12bbe38, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_rotationDistributionEaseType();

  /// @brief Method get_lightRotationBaseDataList, addr 0x12bbe40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bbe48, size 0x78, virtual false, abstract: false, final false
