...
public:
  ...
  /// @brief Method .ctor, addr 0x2708c30, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cuttableSlicesCount, addr 0x2708c1c, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_cuttableSlicesCount();

  /// @brief Method get_sliceCount, addr 0x2708c14, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_squishAmount, addr 0x2708c28, size 0x8, virtual false, abstract: false, final false
