...
public:
  ...
  /// @brief Method .ctor, addr 0x375b028, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_cuttableSlicesCount, addr 0x375b014, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_cuttableSlicesCount();

  /// @brief Method get_sliceCount, addr 0x375b00c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_squishAmount, addr 0x375b020, size 0x8, virtual false, abstract: false, final false
