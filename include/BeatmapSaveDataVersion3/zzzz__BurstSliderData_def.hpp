...
public:
  ...
  /// @brief Method .ctor, addr 0x1325870, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_sliceCount, addr 0x1325860, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_squishAmount, addr 0x1325868, size 0x8, virtual false, abstract: false, final false
