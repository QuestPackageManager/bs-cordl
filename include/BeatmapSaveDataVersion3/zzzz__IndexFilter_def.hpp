...
public:
  ...
  /// @brief Method CreateDivisionIndexFilter, addr 0x369d724, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateForExtension, addr 0x369d80c, size 0x5c, virtual false, abstract: false, final false
  static inline ::BeatmapSaveDataVersion3::IndexFilter* CreateForExtension();

  /// @brief Method CreateStepFilter, addr 0x369d798, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369d6ec, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::BeatmapSaveDataVersion3::IndexFilter* other);

  /// @brief Method .ctor, addr 0x369d6c8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method get_chunks, addr 0x369d6a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_chunks();

  /// @brief Method get_limit, addr 0x369d6a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_limit();

  /// @brief Method get_limitAlsoAffectsType, addr 0x369d6b0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType get_limitAlsoAffectsType();

  /// @brief Method get_param0, addr 0x369d680, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_param0();

  /// @brief Method get_param1, addr 0x369d688, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_param1();

  /// @brief Method get_random, addr 0x369d6b8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::IndexFilterRandomType get_random();

  /// @brief Method get_reversed, addr 0x369d690, size 0x10, virtual false, abstract: false, final false
  inline bool get_reversed();

  /// @brief Method get_seed, addr 0x369d6c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_seed();

  /// @brief Method get_type, addr 0x369d678, size 0x8, virtual false, abstract: false, final false
