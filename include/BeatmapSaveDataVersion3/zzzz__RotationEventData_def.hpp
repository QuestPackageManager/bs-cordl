...
/// @brief Method .ctor, addr 0x3661b48, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, ::BeatmapSaveDataCommon::ExecutionTime  executionTime, float_t  rotation) ;

/// @brief Method get_executionTime, addr 0x3661b38, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::ExecutionTime get_executionTime() ;

/// @brief Method get_rotation, addr 0x3661b40, size 0x8, virtual false, abstract: false, final false
