...
namespace BeatmapSaveDataVersion3 {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11155)), TypeDefinitionIndex(TypeDefinitionIndex(11210))]
...
public:
  ...
  /// @brief Method get_executionTime, addr 0x12bc14c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::ExecutionTime get_executionTime();

  /// @brief Method get_rotation, addr 0x12bc154, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bc15c, size 0x38, virtual false, abstract: false, final false
