...
public:
  ...
  /// @brief Method .ctor, addr 0x369db30, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_angleOffset, addr 0x369db18, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_angleOffset();

  /// @brief Method get_color, addr 0x369db20, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteColorType get_color();

  /// @brief Method get_cutDirection, addr 0x369db28, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection();

  /// @brief Method get_layer, addr 0x369db10, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layer();

  /// @brief Method get_line, addr 0x369db08, size 0x8, virtual false, abstract: false, final false
