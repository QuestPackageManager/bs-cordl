...
public:
  ...
  /// @brief Method .ctor, addr 0x270a3a8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_angleOffset, addr 0x270a390, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_angleOffset();

  /// @brief Method get_color, addr 0x270a398, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteColorType get_color();

  /// @brief Method get_cutDirection, addr 0x270a3a0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection();

  /// @brief Method get_layer, addr 0x270a388, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layer();

  /// @brief Method get_line, addr 0x270a380, size 0x8, virtual false, abstract: false, final false
