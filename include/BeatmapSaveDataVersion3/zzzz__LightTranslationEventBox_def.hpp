...
public:
  ...
  /// @brief Method .ctor, addr 0x270a64c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_axis, addr 0x270a614, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::Axis get_axis();

  /// @brief Method get_flipTranslation, addr 0x270a61c, size 0x10, virtual false, abstract: false, final false
  inline bool get_flipTranslation();

  /// @brief Method get_gapDistributionEaseType, addr 0x270a63c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_gapDistributionEaseType();

  /// @brief Method get_gapDistributionParam, addr 0x270a604, size 0x8, virtual false, abstract: false, final false
  inline float_t get_gapDistributionParam();

  /// @brief Method get_gapDistributionParamType, addr 0x270a60c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::DistributionParamType get_gapDistributionParamType();

  /// @brief Method get_gapDistributionShouldAffectFirstBaseEvent, addr 0x270a62c, size 0x10, virtual false, abstract: false, final false
  inline bool get_gapDistributionShouldAffectFirstBaseEvent();

  /// @brief Method get_lightTranslationBaseDataList, addr 0x270a644, size 0x8, virtual false, abstract: false, final false
