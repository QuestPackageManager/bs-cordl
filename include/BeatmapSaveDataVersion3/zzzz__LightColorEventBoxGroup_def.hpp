...
public:
// Declarations
/// @brief Method CopyWith, addr 0x369e50c, size 0x118, virtual false, abstract: false, final false
...
static inline ::BeatmapSaveDataVersion3::LightColorEventBoxGroup* New_ctor(float_t  beat, int32_t  groupId, ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::LightColorEventBox*>*  eventBoxes) ;

/// @brief Method .ctor, addr 0x369e4a4, size 0x68, virtual false, abstract: false, final false
