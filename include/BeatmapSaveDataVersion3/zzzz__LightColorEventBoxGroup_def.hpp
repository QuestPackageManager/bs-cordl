...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x270d9d4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270d964, size 0x70, virtual false, abstract: false, final false
