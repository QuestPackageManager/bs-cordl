...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::LightColorEventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::LightColorEventBoxGroup*, "BeatmapSaveDataVersion3", "LightColorEventBoxGroup");
...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x375ecf4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375ec8c, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightColorEventBoxGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightColorEventBoxGroup(LightColorEventBoxGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightColorEventBoxGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightColorEventBoxGroup(LightColorEventBoxGroupconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion3::LightColorEventBoxGroup) == 0x20, "Size mismatch!");
