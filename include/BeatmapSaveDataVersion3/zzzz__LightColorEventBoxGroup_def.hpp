...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x14f8120, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f80b0, size 0x70, virtual false, abstract: false, final false
