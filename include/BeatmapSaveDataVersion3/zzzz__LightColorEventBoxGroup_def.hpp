...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x270579c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270572c, size 0x70, virtual false, abstract: false, final false
