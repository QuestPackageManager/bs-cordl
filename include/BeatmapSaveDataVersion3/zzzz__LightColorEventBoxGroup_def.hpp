...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x13248d8, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1324868, size 0x70, virtual false, abstract: false, final false
