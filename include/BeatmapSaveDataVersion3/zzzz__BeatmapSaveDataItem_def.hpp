...
/// @brief Method .ctor, addr 0x369e0d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(float_t  beat) ;

/// @brief Method get_beat, addr 0x369e0cc, size 0x8, virtual true, abstract: false, final true
