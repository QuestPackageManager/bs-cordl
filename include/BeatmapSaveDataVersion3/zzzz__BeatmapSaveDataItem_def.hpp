...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BeatmapSaveDataItem*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BeatmapSaveDataItem*, "BeatmapSaveDataVersion3", "BeatmapSaveDataItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375a12c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t beat);

  /// @brief Method get_beat, addr 0x375a124, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BeatmapSaveDataItem) == 0x18, "Size mismatch!");
