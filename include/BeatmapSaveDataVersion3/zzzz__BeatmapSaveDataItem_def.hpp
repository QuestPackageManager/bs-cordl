...
public:
  ...
  /// @brief Method .ctor, addr 0x369cd40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t beat);

  /// @brief Method get_beat, addr 0x369cd38, size 0x8, virtual true, abstract: false, final true
