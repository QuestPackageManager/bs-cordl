...
public:
  ...
  /// @brief Method get_beat, addr 0x12bb008, size 0x8, virtual true, abstract: false, final true
  inline float_t get_beat();

  static inline ::BeatmapSaveDataVersion3::BeatmapSaveDataItem* New_ctor(float_t beat);

  /// @brief Method .ctor, addr 0x12bb010, size 0x28, virtual false, abstract: false, final false
