...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::ObstacleData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::ObstacleData*, "BeatmapSaveDataVersion3", "ObstacleData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375b070, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, int32_t line, int32_t layer, float_t duration, int32_t width, int32_t height);

  /// @brief Method get_duration, addr 0x375b058, size 0x8, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_height, addr 0x375b068, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_layer, addr 0x375b050, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layer();

  /// @brief Method get_line, addr 0x375b048, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_line();

  /// @brief Method get_width, addr 0x375b060, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::ObstacleData) == 0x28, "Size mismatch!");
