...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::FxEventType, "BeatmapSaveDataVersion3", "FxEventType");
// Dependencies
namespace BeatmapSaveDataVersion3 {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataVersion3::FxEventType) == 0x4, "Size mismatch!");
