...
public:
  ...
  /// @brief Method .ctor, addr 0x270a088, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x270a048, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_brightness, addr 0x270a060, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_colorType, addr 0x270a058, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EnvironmentColorType get_colorType();

  /// @brief Method get_strobeBeatFrequency, addr 0x270a068, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x270a070, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x270a078, size 0x10, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method get_transitionType, addr 0x270a050, size 0x8, virtual false, abstract: false, final false
