...
public:
  ...
  /// @brief Method .ctor, addr 0x270853c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x27084fc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_brightness, addr 0x2708514, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_colorType, addr 0x270850c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EnvironmentColorType get_colorType();

  /// @brief Method get_strobeBeatFrequency, addr 0x270851c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x2708524, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x270852c, size 0x10, virtual false, abstract: false, final false
  inline bool get_strobeFade();

  /// @brief Method get_transitionType, addr 0x2708504, size 0x8, virtual false, abstract: false, final false
