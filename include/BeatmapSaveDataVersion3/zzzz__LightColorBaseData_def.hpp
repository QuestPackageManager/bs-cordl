...
namespace BeatmapSaveDataVersion3 {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11163)), TypeDefinitionIndex(TypeDefinitionIndex(11209))]
...
public:
  ...
  /// @brief Method get_beat, addr 0x12bbd48, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_transitionType, addr 0x12bbd50, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataVersion3::TransitionType get_transitionType();

  /// @brief Method get_colorType, addr 0x12bbd58, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EnvironmentColorType get_colorType();

  /// @brief Method get_brightness, addr 0x12bbd60, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightness();

  /// @brief Method get_strobeBeatFrequency, addr 0x12bbd68, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_strobeBeatFrequency();

  /// @brief Method get_strobeBrightness, addr 0x12bbd70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_strobeBrightness();

  /// @brief Method get_strobeFade, addr 0x12bbd78, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bbd88, size 0x78, virtual false, abstract: false, final false
