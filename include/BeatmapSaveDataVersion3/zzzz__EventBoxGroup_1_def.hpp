...
// Write type traits
MARK_GEN_REF_T_PTR(::BeatmapSaveDataVersion3::EventBoxGroup_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::BeatmapSaveDataVersion3::EventBoxGroup_1, "BeatmapSaveDataVersion3", "EventBoxGroup`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroup_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventBoxGroup_1(EventBoxGroup_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroup_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventBoxGroup_1(EventBoxGroup_1const&) = delete;
