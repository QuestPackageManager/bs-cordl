...
public:
  ...
  /// @brief Method get_beat, addr 0x12bb97c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_usePreviousEventValue, addr 0x12bb984, size 0x10, virtual false, abstract: false, final false
  inline bool get_usePreviousEventValue();

  /// @brief Method get_value, addr 0x12bb994, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method get_easeType, addr 0x12bb99c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bb9a4, size 0x54, virtual false, abstract: false, final false
