...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x2706160, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27060f0, size 0x70, virtual false, abstract: false, final false
