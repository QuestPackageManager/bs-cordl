...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x375ee74, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375ee0c, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightRotationEventBoxGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightRotationEventBoxGroup(LightRotationEventBoxGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightRotationEventBoxGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightRotationEventBoxGroup(LightRotationEventBoxGroupconst&) = delete;
