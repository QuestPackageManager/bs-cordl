...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x2707ddc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2707d6c, size 0x70, virtual false, abstract: false, final false
