...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x14f8270, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f8200, size 0x70, virtual false, abstract: false, final false
