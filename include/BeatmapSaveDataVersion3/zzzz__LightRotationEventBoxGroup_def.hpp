...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x369d2f8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369d290, size 0x68, virtual false, abstract: false, final false
