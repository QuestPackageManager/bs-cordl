...
public:
  ...
  /// @brief Method .ctor, addr 0x1400e70, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_brightnessDistributionEaseType, addr 0x1400e60, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_brightnessDistributionEaseType();

  /// @brief Method get_brightnessDistributionParam, addr 0x1400e40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_brightnessDistributionParam();

  /// @brief Method get_brightnessDistributionParamType, addr 0x1400e48, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::DistributionParamType get_brightnessDistributionParamType();

  /// @brief Method get_brightnessDistributionShouldAffectFirstBaseEvent, addr 0x1400e50, size 0x10, virtual false, abstract: false, final false
  inline bool get_brightnessDistributionShouldAffectFirstBaseEvent();

  /// @brief Method get_lightColorBaseDataList, addr 0x1400e68, size 0x8, virtual false, abstract: false, final false
