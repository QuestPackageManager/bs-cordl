...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::LightTranslationEventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::LightTranslationEventBoxGroup*, "BeatmapSaveDataVersion3", "LightTranslationEventBoxGroup");
...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x375eff4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375ef8c, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationEventBoxGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightTranslationEventBoxGroup(LightTranslationEventBoxGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationEventBoxGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightTranslationEventBoxGroup(LightTranslationEventBoxGroupconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion3::LightTranslationEventBoxGroup) == 0x20, "Size mismatch!");
