...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x270dc64, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270dbf4, size 0x70, virtual false, abstract: false, final false
