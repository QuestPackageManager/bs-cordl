...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x2705a2c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27059bc, size 0x70, virtual false, abstract: false, final false
