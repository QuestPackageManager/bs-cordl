...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x369d478, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369d410, size 0x68, virtual false, abstract: false, final false
