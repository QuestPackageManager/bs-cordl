...
public:
  // Declarations
  /// @brief Method CopyWith, addr 0x26d40bc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d404c, size 0x70, virtual false, abstract: false, final false
