...
public:
  ...
  /// @brief Method .ctor, addr 0x27088c8, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, bool boost);

  /// @brief Method get_boost, addr 0x27088c0, size 0x8, virtual false, abstract: false, final false
