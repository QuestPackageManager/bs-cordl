...
public:
  ...
  /// @brief Method .ctor, addr 0x3661ab4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, bool boost);

  /// @brief Method get_boost, addr 0x3661aac, size 0x8, virtual false, abstract: false, final false
