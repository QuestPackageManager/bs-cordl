...
public:
  ...
  /// @brief Method .ctor, addr 0x2706c4c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, bool boost);

  /// @brief Method get_boost, addr 0x2706c44, size 0x8, virtual false, abstract: false, final false
