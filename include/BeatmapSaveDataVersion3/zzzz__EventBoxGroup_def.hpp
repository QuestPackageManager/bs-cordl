...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::EventBoxGroup*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::EventBoxGroup*, "BeatmapSaveDataVersion3", "EventBoxGroup");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375e8cc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupId, addr 0x375e8c4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroup", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventBoxGroup(EventBoxGroup&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventBoxGroup", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventBoxGroup(EventBoxGroupconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion3::EventBoxGroup) == 0x18, "Size mismatch!");
