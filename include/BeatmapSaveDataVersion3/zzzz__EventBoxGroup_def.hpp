...
public:
  ...
  /// @brief Method .ctor, addr 0x14f7cc4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupId, addr 0x14f7cbc, size 0x8, virtual false, abstract: false, final false
