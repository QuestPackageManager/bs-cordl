...
public:
  ...
  /// @brief Method .ctor, addr 0x36348b4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupId, addr 0x36348ac, size 0x8, virtual false, abstract: false, final false
