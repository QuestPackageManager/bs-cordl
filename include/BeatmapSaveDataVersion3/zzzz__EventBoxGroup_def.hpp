...
public:
  ...
  /// @brief Method .ctor, addr 0x375a13c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupId, addr 0x375a134, size 0x8, virtual false, abstract: false, final false
