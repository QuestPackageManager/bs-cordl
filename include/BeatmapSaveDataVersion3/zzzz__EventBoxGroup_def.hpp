...
public:
  ...
  /// @brief Method .ctor, addr 0x14f17ac, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupId, addr 0x14f17a4, size 0x8, virtual false, abstract: false, final false
