...
public:
  ...
  /// @brief Method AddEventAndGetIndex, addr 0x12fc27c, size 0xc0, virtual false, abstract: false, final false
  inline int32_t AddEventAndGetIndex(::BeatmapSaveDataVersion3::FloatFxEventBaseData* e);

  /// @brief Method AddEventAndGetIndex, addr 0x12fc33c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12fc0e4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x12fc1a4, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::IntFxEventBaseData*>* intFxEventBaseData,
                    ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::FloatFxEventBaseData*>* floatFxEventBaseData);

  /// @brief Method get_floatEventsList, addr 0x12fc0dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BeatmapSaveDataVersion3::FloatFxEventBaseData*>* get_floatEventsList();

  /// @brief Method get_intEventsList, addr 0x12fc0d4, size 0x8, virtual false, abstract: false, final false
