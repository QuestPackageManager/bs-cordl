...
public:
  ...
  /// @brief Method .ctor, addr 0x270d5b8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_type, addr 0x270d5b0, size 0x8, virtual false, abstract: false, final false
