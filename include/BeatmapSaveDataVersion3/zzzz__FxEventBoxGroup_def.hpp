...
public:
  ...
  /// @brief Method .ctor, addr 0x14f7d04, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_type, addr 0x14f7cfc, size 0x8, virtual false, abstract: false, final false
