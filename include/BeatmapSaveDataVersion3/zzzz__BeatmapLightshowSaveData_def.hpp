...
/// @brief Field basicBeatmapEvents, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_basicBeatmapEvents, put=__cordl_internal_set_basicBeatmapEvents)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::BasicEventData*>*  basicBeatmapEvents;

/// @brief Field colorBoostBeatmapEvents, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorBoostBeatmapEvents, put=__cordl_internal_set_colorBoostBeatmapEvents)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::ColorBoostEventData*>*  colorBoostBeatmapEvents;

 __declspec(property(get=get_isEmpty)) bool  isEmpty;

/// @brief Field lightColorEventBoxGroups, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightColorEventBoxGroups, put=__cordl_internal_set_lightColorEventBoxGroups)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::LightColorEventBoxGroup*>*  lightColorEventBoxGroups;

/// @brief Field lightRotationEventBoxGroups, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightRotationEventBoxGroups, put=__cordl_internal_set_lightRotationEventBoxGroups)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::LightRotationEventBoxGroup*>*  lightRotationEventBoxGroups;

/// @brief Field lightTranslationEventBoxGroups, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightTranslationEventBoxGroups, put=__cordl_internal_set_lightTranslationEventBoxGroups)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::LightTranslationEventBoxGroup*>*  lightTranslationEventBoxGroups;

/// @brief Field vfxEventBoxGroups, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_vfxEventBoxGroups, put=__cordl_internal_set_vfxEventBoxGroups)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion3::FxEventBoxGroup*>*  vfxEventBoxGroups;
...
/// @brief Method .ctor, addr 0x369dfd8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isEmpty, addr 0x369dec0, size 0x118, virtual false, abstract: false, final false
