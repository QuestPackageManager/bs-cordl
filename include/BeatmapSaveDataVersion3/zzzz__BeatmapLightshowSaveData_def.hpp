...
public:
  ...
  /// @brief Method .ctor, addr 0x14f7b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isEmpty, addr 0x14f7a90, size 0xe8, virtual false, abstract: false, final false
