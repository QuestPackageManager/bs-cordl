...
public:
  ...
  /// @brief Method .ctor, addr 0x369cc44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isEmpty, addr 0x369cb2c, size 0x118, virtual false, abstract: false, final false
