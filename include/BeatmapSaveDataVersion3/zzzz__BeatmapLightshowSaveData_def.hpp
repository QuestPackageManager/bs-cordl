...
public:
  ...
  /// @brief Method .ctor, addr 0x375a030, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isEmpty, addr 0x3759f18, size 0x118, virtual false, abstract: false, final false
