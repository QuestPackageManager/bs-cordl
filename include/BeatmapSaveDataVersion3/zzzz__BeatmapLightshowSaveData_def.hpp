...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BeatmapLightshowSaveData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BeatmapLightshowSaveData*, "BeatmapSaveDataVersion3", "BeatmapLightshowSaveData");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLightshowSaveData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapLightshowSaveData(BeatmapLightshowSaveData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLightshowSaveData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapLightshowSaveData(BeatmapLightshowSaveDataconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BeatmapLightshowSaveData) == 0x48, "Size mismatch!");
