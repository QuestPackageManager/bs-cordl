...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BombNoteData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BombNoteData*, "BeatmapSaveDataVersion3", "BombNoteData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375af40, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, int32_t line, int32_t layer);

  /// @brief Method get_layer, addr 0x375af38, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_layer();

  /// @brief Method get_line, addr 0x375af30, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BombNoteData) == 0x20, "Size mismatch!");
