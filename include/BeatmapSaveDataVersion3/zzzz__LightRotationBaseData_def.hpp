...
static inline ::BeatmapSaveDataVersion3::LightRotationBaseData* New_ctor(float_t  beat, bool  usePreviousEventRotationValue, ::BeatmapSaveDataCommon::EaseType  easeType, int32_t  loopsCount, float_t  rotation, ::BeatmapSaveDataCommon::RotationDirection  rotationDirection) ;
...
/// @brief Method .ctor, addr 0x369ed60, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, bool  usePreviousEventRotationValue, ::BeatmapSaveDataCommon::EaseType  easeType, int32_t  loopsCount, float_t  rotation, ::BeatmapSaveDataCommon::RotationDirection  rotationDirection) ;

/// @brief Method get_beat, addr 0x369ed28, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_easeType, addr 0x369ed40, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_easeType() ;

/// @brief Method get_loopsCount, addr 0x369ed48, size 0x8, virtual false, abstract: false, final false
inline int32_t get_loopsCount() ;

/// @brief Method get_rotation, addr 0x369ed50, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotation() ;

/// @brief Method get_rotationDirection, addr 0x369ed58, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::RotationDirection get_rotationDirection() ;

/// @brief Method get_usePreviousEventRotationValue, addr 0x369ed30, size 0x10, virtual false, abstract: false, final false
