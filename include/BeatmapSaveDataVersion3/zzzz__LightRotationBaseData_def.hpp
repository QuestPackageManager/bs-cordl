...
/// @brief Method .ctor, addr 0x3661a1c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method get_beat, addr 0x36619e4, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_easeType, addr 0x36619fc, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_easeType() ;

/// @brief Method get_loopsCount, addr 0x3661a04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_loopsCount() ;

/// @brief Method get_rotation, addr 0x3661a0c, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotation() ;

/// @brief Method get_rotationDirection, addr 0x3661a14, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::RotationDirection get_rotationDirection() ;

/// @brief Method get_usePreviousEventRotationValue, addr 0x36619ec, size 0x10, virtual false, abstract: false, final false
