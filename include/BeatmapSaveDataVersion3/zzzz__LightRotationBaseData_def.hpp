...
public:
  ...
  /// @brief Method .ctor, addr 0x14010c4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x140108c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_easeType, addr 0x14010a4, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_easeType();

  /// @brief Method get_loopsCount, addr 0x14010ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_loopsCount();

  /// @brief Method get_rotation, addr 0x14010b4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rotation();

  /// @brief Method get_rotationDirection, addr 0x14010bc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::RotationDirection get_rotationDirection();

  /// @brief Method get_usePreviousEventRotationValue, addr 0x1401094, size 0x10, virtual false, abstract: false, final false
