...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::LightRotationBaseData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::LightRotationBaseData*, "BeatmapSaveDataVersion3", "LightRotationBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375adb8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x375ad80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_easeType, addr 0x375ad98, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_easeType();

  /// @brief Method get_loopsCount, addr 0x375ada0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_loopsCount();

  /// @brief Method get_rotation, addr 0x375ada8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rotation();

  /// @brief Method get_rotationDirection, addr 0x375adb0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::RotationDirection get_rotationDirection();

  /// @brief Method get_usePreviousEventRotationValue, addr 0x375ad88, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatmapSaveDataVersion3::LightRotationBaseData) == 0x28, "Size mismatch!");
