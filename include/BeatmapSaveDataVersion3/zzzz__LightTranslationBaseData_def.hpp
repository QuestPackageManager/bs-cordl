...
public:
  ...
  /// @brief Method .ctor, addr 0x14f27f4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beat, addr 0x14f27cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beat();

  /// @brief Method get_easeType, addr 0x14f27e4, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::EaseType get_easeType();

  /// @brief Method get_translation, addr 0x14f27ec, size 0x8, virtual false, abstract: false, final false
  inline float_t get_translation();

  /// @brief Method get_usePreviousEventTranslationValue, addr 0x14f27d4, size 0x10, virtual false, abstract: false, final false
