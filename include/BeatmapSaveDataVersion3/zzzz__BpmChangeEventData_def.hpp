...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion3::BpmChangeEventData*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion3::BpmChangeEventData*, "BeatmapSaveDataVersion3", "BpmChangeEventData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375f65c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, float_t bpm);

  /// @brief Method get_bpm, addr 0x375f654, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BpmChangeEventData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BpmChangeEventData(BpmChangeEventData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BpmChangeEventData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BpmChangeEventData(BpmChangeEventDataconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion3::BpmChangeEventData) == 0x18, "Size mismatch!");
