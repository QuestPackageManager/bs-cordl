...
public:
  ...
  /// @brief Method .ctor, addr 0x14f9da8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(float_t beat, float_t bpm);

  /// @brief Method get_bpm, addr 0x14f9da0, size 0x8, virtual false, abstract: false, final false
