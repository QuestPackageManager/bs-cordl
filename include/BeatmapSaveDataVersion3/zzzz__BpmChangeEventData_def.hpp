...
public:
  ...
  /// @brief Method get_bpm, addr 0x12bc11c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_bpm();

  static inline ::BeatmapSaveDataVersion3::BpmChangeEventData* New_ctor(float_t beat, float_t bpm);

  /// @brief Method .ctor, addr 0x12bc124, size 0x28, virtual false, abstract: false, final false
