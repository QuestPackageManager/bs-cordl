...
public:
  ...
  /// @brief Method .ctor, addr 0x369dbf8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headControlPointLengthMultiplier, addr 0x369dbd8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_sliderMidAnchorMode, addr 0x369dbf0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::SliderMidAnchorMode get_sliderMidAnchorMode();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x369dbe0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x369dbe8, size 0x8, virtual false, abstract: false, final false
