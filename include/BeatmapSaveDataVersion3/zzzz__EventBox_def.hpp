...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventBox", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventBox(EventBox&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventBox", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventBox(EventBoxconst&) = delete;
