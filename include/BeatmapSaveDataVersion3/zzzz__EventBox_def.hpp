...
public:
  ...
  /// @brief Method .ctor, addr 0x3661590, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatDistributionParam, addr 0x3661580, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beatDistributionParam();

  /// @brief Method get_beatDistributionParamType, addr 0x3661588, size 0x8, virtual false, abstract: false, final false
  inline ::BeatmapSaveDataCommon::DistributionParamType get_beatDistributionParamType();

  /// @brief Method get_indexFilter, addr 0x3661578, size 0x8, virtual false, abstract: false, final false
