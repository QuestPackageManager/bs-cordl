...
public:
  // Declarations
  /// @brief Method Init, addr 0x258ce38, size 0x70, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x258cdb0, size 0x88, virtual false, abstract: false, final false
