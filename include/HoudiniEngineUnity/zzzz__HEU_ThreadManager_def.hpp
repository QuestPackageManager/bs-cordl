...
public:
  ...
  /// @brief Method AddTask, addr 0x3a7595c, size 0xe8, virtual false, abstract: false, final false
  inline void AddTask(::HoudiniEngineUnity::HEU_ThreadedTask* task);

  /// @brief Method CreateInstance, addr 0x3a75578, size 0x4, virtual false, abstract: false, final false
  static inline void CreateInstance();

  /// @brief Method Finalize, addr 0x3a7557c, size 0x8, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::HoudiniEngineUnity::HEU_ThreadManager* New_ctor();

  /// @brief Method Register, addr 0x3a75588, size 0x4, virtual false, abstract: false, final false
  inline void Register();

  /// @brief Method RemoveTask, addr 0x3a75a44, size 0xe8, virtual false, abstract: false, final false
  inline void RemoveTask(::HoudiniEngineUnity::HEU_ThreadedTask* task);

  /// @brief Method Unregister, addr 0x3a75584, size 0x4, virtual false, abstract: false, final false
  inline void Unregister();

  /// @brief Method Update, addr 0x3a7558c, size 0x3d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3a75b2c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::HoudiniEngineUnity::HEU_ThreadManager* getStaticF__instance();

  /// @brief Method get_Instance, addr 0x3a75530, size 0x48, virtual false, abstract: false, final false
