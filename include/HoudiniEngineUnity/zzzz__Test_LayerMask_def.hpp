...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9a4d4, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9a4ac, size 0x28, virtual false, abstract: false, final false
