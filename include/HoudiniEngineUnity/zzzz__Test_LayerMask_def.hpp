...
public:
  ...
  /// @brief Method .ctor, addr 0x227c238, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::LayerMask self);

  /// @brief Method IsEquivalentTo, addr 0x227c260, size 0xf8, virtual true, abstract: false, final true
