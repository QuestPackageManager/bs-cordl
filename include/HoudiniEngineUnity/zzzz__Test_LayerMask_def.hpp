...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25ca874, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25ca84c, size 0x28, virtual false, abstract: false, final false
