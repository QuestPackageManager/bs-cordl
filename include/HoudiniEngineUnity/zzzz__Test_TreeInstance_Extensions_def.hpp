...
public:
  ...
  /// @brief Method .ctor addr 0x208fd58 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToTestObject>b__1_0 addr 0x208fd60 size 0x88 virtual false final false
  inline ::HoudiniEngineUnity::Test_TreeInstance* _ToTestObject_b__1_0(::UnityEngine::TreeInstance lod);

  /// @brief Method <ToTestObject>b__2_0 addr 0x208fde8 size 0x88 virtual false final false
...
public:
  ...
  /// @brief Method ToTestObject addr 0x208fa78 size 0x88 virtual false final false
  static inline ::HoudiniEngineUnity::Test_TreeInstance* ToTestObject(::UnityEngine::TreeInstance self);

  /// @brief Method ToTestObject addr 0x208fb00 size 0xf8 virtual false final false
  ...
  /// @brief Method ToTestObject addr 0x208fbf8 size 0xfc virtual false final false
