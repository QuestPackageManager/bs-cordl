...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x3a97210, size 0x80, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TreeInstance* _ToTestObject_b__1_0(::UnityEngine::TreeInstance lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3a97290, size 0x80, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TreeInstance* _ToTestObject_b__2_0(::UnityEngine::TreeInstance lod);

  /// @brief Method .ctor, addr 0x3a97208, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x3a96fc4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3a96f44, size 0x80, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_TreeInstance* ToTestObject(::UnityEngine::TreeInstance self);

  /// @brief Method ToTestObject, addr 0x3a970b4, size 0xf8, virtual false, abstract: false, final false
