...
public:
  ...
  /// @brief Method get_Tag, addr 0x22707a4, size 0x8, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::JSONNodeType get_Tag();

  /// @brief Method get_IsBoolean, addr 0x22707ac, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsBoolean();

  /// @brief Method GetEnumerator, addr 0x22707b4, size 0x14, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value, addr 0x22707c8, size 0xc, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x22707d4, size 0x7c, virtual true, abstract: false, final false
  inline void set_Value(::StringW value);

  /// @brief Method get_AsBool, addr 0x2270850, size 0x8, virtual true, abstract: false, final false
  inline bool get_AsBool();

  /// @brief Method set_AsBool, addr 0x2270858, size 0xc, virtual true, abstract: false, final false
  inline void set_AsBool(bool value);

  static inline ::HoudiniEngineUnity::JSONBool* New_ctor(bool aData);

  /// @brief Method .ctor, addr 0x226a7a4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(bool aData);

  static inline ::HoudiniEngineUnity::JSONBool* New_ctor(::StringW aData);

  /// @brief Method .ctor, addr 0x2270864, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder, addr 0x2270898, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2270910, size 0x78, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2270988, size 0xc, virtual true, abstract: false, final false
