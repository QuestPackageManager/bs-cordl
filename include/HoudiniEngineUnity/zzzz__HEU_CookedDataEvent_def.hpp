...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10465)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10465), inst: 5237 }),
// TypeDefinitionIndex(TypeDefinitionIndex(9597))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9603)) CS Name: ::HoudiniEngineUnity::HEU_CookedDataEvent*
