...
public:
  ...
  /// @brief Method BakeGameObjectComponents, addr 0x2551c54, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearGeneratedMaterialReferences, addr 0x25512c4, size 0x18, virtual false, abstract: false, final false
  static inline void ClearGeneratedMaterialReferences(::HoudiniEngineUnity::HEU_GeneratedOutputData* generatedOutputData);

  /// @brief Method ClearMaterialsNoLongerUsed, addr 0x2551854, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyMaterialOverrides, addr 0x2551968, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllGeneratedColliders, addr 0x25512dc, size 0x238, virtual false, abstract: false, final false
  static inline void DestroyAllGeneratedColliders(::HoudiniEngineUnity::HEU_GeneratedOutputData* outputData);

  /// @brief Method DestroyGeneratedOutput, addr 0x2551514, size 0x180, virtual false, abstract: false, final false
  static inline void DestroyGeneratedOutput(::HoudiniEngineUnity::HEU_GeneratedOutput* generatedOutput);

  /// @brief Method DestroyGeneratedOutputChildren, addr 0x2551694, size 0x174, virtual false, abstract: false, final false
  static inline void DestroyGeneratedOutputChildren(::HoudiniEngineUnity::HEU_GeneratedOutput* generatedOutput);

  /// @brief Method DestroyGeneratedOutputData, addr 0x2551808, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGeneratedMaterialsForGameObject, addr 0x2550dc4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method HasLODGroup, addr 0x2550cc4, size 0x54, virtual false, abstract: false, final false
  static inline bool HasLODGroup(::HoudiniEngineUnity::HEU_GeneratedOutput* output);

  /// @brief Method IsEquivalentTo, addr 0x2551d7c, size 0x1a8, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_GeneratedOutput* other);

  /// @brief Method IsOutputDataUsingMaterial, addr 0x2551110, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOutputUsingMaterial, addr 0x2550fb0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetMaterialOverrides, addr 0x2550b68, size 0x15c, virtual false, abstract: false, final false
  static inline void ResetMaterialOverrides(::HoudiniEngineUnity::HEU_GeneratedOutput* output);

  /// @brief Method ResetMaterialOverrides, addr 0x2550d18, size 0xac, virtual false, abstract: false, final false
  static inline void ResetMaterialOverrides(::HoudiniEngineUnity::HEU_GeneratedOutputData* outputData);

  /// @brief Method WriteOutputToAssetCache, addr 0x2551bf8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x254874c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInstancer, addr 0x2550b54, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsInstancer, addr 0x2550b5c, size 0xc, virtual false, abstract: false, final false
