...
public:
  ...
  /// @brief Method get_IsInstancer addr 0x2155d18 size 0x8 virtual false final false
  inline bool get_IsInstancer();

  /// @brief Method set_IsInstancer addr 0x2155d20 size 0xc virtual false final false
  inline void set_IsInstancer(bool value);

  /// @brief Method ResetMaterialOverrides addr 0x2155d2c size 0x15c virtual false final false
  static inline void ResetMaterialOverrides(::HoudiniEngineUnity::HEU_GeneratedOutput* output);

  /// @brief Method ResetMaterialOverrides addr 0x2155edc size 0xac virtual false final false
  static inline void ResetMaterialOverrides(::HoudiniEngineUnity::HEU_GeneratedOutputData* outputData);

  /// @brief Method GetGeneratedMaterialsForGameObject addr 0x2155f88 size 0x1ec virtual false final false
  ...
  /// @brief Method HasLODGroup addr 0x2155e88 size 0x54 virtual false final false
  static inline bool HasLODGroup(::HoudiniEngineUnity::HEU_GeneratedOutput* output);

  /// @brief Method IsOutputUsingMaterial addr 0x2156174 size 0x160 virtual false final false
  ...
  /// @brief Method IsOutputDataUsingMaterial addr 0x21562d4 size 0x1b4 virtual false final false
  ...
  /// @brief Method ClearGeneratedMaterialReferences addr 0x2156488 size 0x18 virtual false final false
  static inline void ClearGeneratedMaterialReferences(::HoudiniEngineUnity::HEU_GeneratedOutputData* generatedOutputData);

  /// @brief Method DestroyAllGeneratedColliders addr 0x21564a0 size 0x238 virtual false final false
  static inline void DestroyAllGeneratedColliders(::HoudiniEngineUnity::HEU_GeneratedOutputData* outputData);

  /// @brief Method DestroyGeneratedOutput addr 0x21566d8 size 0x180 virtual false final false
  static inline void DestroyGeneratedOutput(::HoudiniEngineUnity::HEU_GeneratedOutput* generatedOutput);

  /// @brief Method DestroyGeneratedOutputChildren addr 0x2156858 size 0x174 virtual false final false
  static inline void DestroyGeneratedOutputChildren(::HoudiniEngineUnity::HEU_GeneratedOutput* generatedOutput);

  /// @brief Method DestroyGeneratedOutputData addr 0x21569cc size 0x4c virtual false final false
  ...
  /// @brief Method ClearMaterialsNoLongerUsed addr 0x2156a18 size 0x114 virtual false final false
  ...
  /// @brief Method CopyMaterialOverrides addr 0x2156b2c size 0x290 virtual false final false
  ...
  /// @brief Method WriteOutputToAssetCache addr 0x2156dbc size 0x5c virtual false final false
  inline void WriteOutputToAssetCache(::UnityEngine::GameObject* parentObject, ::StringW outputPath, bool bIsInstancer);

  /// @brief Method BakeGameObjectComponents addr 0x2156e18 size 0x128 virtual false final false
  ...
  /// @brief Method IsEquivalentTo addr 0x2156f40 size 0x1a8 virtual true final true
  ...
  /// @brief Method .ctor addr 0x214d910 size 0xa8 virtual false final false
  inline void _ctor();
