...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25f2fdc, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25f2fa8, size 0x34, virtual false, abstract: false, final false
