...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a967dc, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a967a8, size 0x34, virtual false, abstract: false, final false
