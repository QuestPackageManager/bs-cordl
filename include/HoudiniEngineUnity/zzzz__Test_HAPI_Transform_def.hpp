...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a96b78, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a96b44, size 0x34, virtual false, abstract: false, final false
