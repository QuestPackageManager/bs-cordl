...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9c080, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9c04c, size 0x34, virtual false, abstract: false, final false
