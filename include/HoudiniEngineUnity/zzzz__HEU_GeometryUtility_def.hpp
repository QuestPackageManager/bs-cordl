...
public:
  // Declarations
  /// @brief Method CalculateMeshTangents, addr 0x24aa124, size 0x4d8, virtual false, abstract: false, final false
  static inline void CalculateMeshTangents(::UnityEngine::Mesh* mesh);

  /// @brief Method GenerateCubeMeshFromPoints, addr 0x24b0924, size 0xb00, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangle, addr 0x24ab180, size 0x4c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> GeneratePerTriangle(::UnityEngine::Mesh* meshSrc);

  /// @brief Method GenerateSecondaryUVSet, addr 0x24b08e0, size 0x44, virtual false, abstract: false, final false
  static inline void GenerateSecondaryUVSet(::UnityEngine::Mesh* meshsrc);

  /// @brief Method GetInstanceOutputName, addr 0x24b1424, size 0xbc, virtual false, abstract: false, final false
