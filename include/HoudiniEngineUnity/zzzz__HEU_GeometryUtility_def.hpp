...
public:
  // Declarations
  /// @brief Method CalculateMeshTangents, addr 0x3a742b4, size 0x4dc, virtual false, abstract: false, final false
  static inline void CalculateMeshTangents(::UnityEngine::Mesh* mesh);

  /// @brief Method GenerateCubeMeshFromPoints, addr 0x3a7a450, size 0xb08, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangle, addr 0x3a7536c, size 0x4c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> GeneratePerTriangle(::UnityEngine::Mesh* meshSrc);

  /// @brief Method GenerateSecondaryUVSet, addr 0x3a7a40c, size 0x44, virtual false, abstract: false, final false
  static inline void GenerateSecondaryUVSet(::UnityEngine::Mesh* meshsrc);

  /// @brief Method GetInstanceOutputName, addr 0x3a7af58, size 0xb8, virtual false, abstract: false, final false
