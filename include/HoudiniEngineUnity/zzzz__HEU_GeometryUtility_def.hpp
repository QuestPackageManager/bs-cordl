...
public:
  // Declarations
  /// @brief Method CalculateMeshTangents, addr 0x3a73f40, size 0x4dc, virtual false, abstract: false, final false
  static inline void CalculateMeshTangents(::UnityEngine::Mesh* mesh);

  /// @brief Method GenerateCubeMeshFromPoints, addr 0x3a7a0dc, size 0xb08, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePerTriangle, addr 0x3a74ff8, size 0x4c, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> GeneratePerTriangle(::UnityEngine::Mesh* meshSrc);

  /// @brief Method GenerateSecondaryUVSet, addr 0x3a7a098, size 0x44, virtual false, abstract: false, final false
  static inline void GenerateSecondaryUVSet(::UnityEngine::Mesh* meshsrc);

  /// @brief Method GetInstanceOutputName, addr 0x3a7abe4, size 0xb8, virtual false, abstract: false, final false
