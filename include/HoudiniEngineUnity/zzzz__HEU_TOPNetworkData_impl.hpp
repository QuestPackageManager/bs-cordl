...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPNodeData*>*> const& HoudiniEngineUnity::HEU_TOPNetworkData::__get__topNodes() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____topNodes;
}
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::TOPNodeTags*> const& HoudiniEngineUnity::HEU_TOPNetworkData::__get__tags() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____tags;
}
