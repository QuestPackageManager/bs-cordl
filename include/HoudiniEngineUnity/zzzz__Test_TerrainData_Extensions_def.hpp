...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x23abde8, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TerrainData* _ToTestObject_b__1_0(::UnityEngine::TerrainData* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x23abe4c, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TerrainData* _ToTestObject_b__2_0(::UnityEngine::TerrainData* lod);

  /// @brief Method .ctor, addr 0x23abde0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x23abb88, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x23abb24, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_TerrainData* ToTestObject(::UnityEngine::TerrainData* self);

  /// @brief Method ToTestObject, addr 0x23abc80, size 0xfc, virtual false, abstract: false, final false
