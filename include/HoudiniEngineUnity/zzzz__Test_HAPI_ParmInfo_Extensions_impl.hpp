...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::HoudiniEngineUnity::Test_HAPI_ParmInfo* (*)(::HoudiniEngineUnity::HAPI_ParmInfo)>(
  ...
  constexpr static std::size_t addrs = 0x208b808;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::Test_HAPI_ParmInfo_Extensions*>::get(), "ToTestObject", std::vector<Il2CppClass*>{},
