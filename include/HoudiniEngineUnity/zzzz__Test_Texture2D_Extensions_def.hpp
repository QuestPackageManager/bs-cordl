...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x25cbff8, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Texture2D* _ToTestObject_b__1_0(::UnityEngine::Texture2D* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x25cc05c, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Texture2D* _ToTestObject_b__2_0(::UnityEngine::Texture2D* lod);

  /// @brief Method .ctor, addr 0x25cbff0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x25cbd98, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x25cb818, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_Texture2D* ToTestObject(::UnityEngine::Texture2D* self);

  /// @brief Method ToTestObject, addr 0x25cbe90, size 0xfc, virtual false, abstract: false, final false
