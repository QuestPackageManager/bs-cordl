...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x24d436c, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Texture2D* _ToTestObject_b__1_0(::UnityEngine::Texture2D* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x24d43d0, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Texture2D* _ToTestObject_b__2_0(::UnityEngine::Texture2D* lod);

  /// @brief Method .ctor, addr 0x24d4364, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x24d410c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x24d3b8c, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_Texture2D* ToTestObject(::UnityEngine::Texture2D* self);

  /// @brief Method ToTestObject, addr 0x24d4204, size 0xfc, virtual false, abstract: false, final false
