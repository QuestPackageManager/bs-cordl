...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x24d26f8, size 0x1a0, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_MeshFilter* other);

  /// @brief Method IsNull, addr 0x24d2698, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x24d2670, size 0x28, virtual false, abstract: false, final false
