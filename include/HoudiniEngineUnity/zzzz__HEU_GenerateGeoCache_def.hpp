...
public:
  ...
  /// @brief Method .ctor addr 0x21c1f4c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x21c45c4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetFinalMaterialsFromComparingNewWithPrevious>b__63_0 addr 0x21c45cc size 0x5c virtual false final false
  inline bool _GetFinalMaterialsFromComparingNewWithPrevious_b__63_0(::UnityEngine::Material* material);

  /// @brief Method <GenerateLODMeshesFromGeoGroups>b__65_0 addr 0x21c4628 size 0x1c virtual false final false
...
public:
  ...
  /// @brief Method get_GeoID addr 0x21b9128 size 0x8 virtual false final false
  inline int32_t get_GeoID();

  /// @brief Method get_PartID addr 0x21b9130 size 0x8 virtual false final false
  inline int32_t get_PartID();

  /// @brief Method get_AssetID addr 0x21b9138 size 0x8 virtual false final false
  inline int32_t get_AssetID();

  /// @brief Method set_AssetID addr 0x21b9140 size 0x8 virtual false final false
  inline void set_AssetID(int32_t value);

  /// @brief Method GetPopulatedGeoCache addr 0x21b9148 size 0x304 virtual false final false
  ...
  /// @brief Method PopulateUnityMaterialData addr 0x21b9648 size 0x614 virtual false final false
  inline void PopulateUnityMaterialData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetMaterialKeyFromAttributeIndex addr 0x21bb85c size 0x15c virtual false final false
  ...
  /// @brief Method CreateMaterialInfoEntryFromAttributeIndex addr 0x21bb740 size 0x11c virtual false final false
  ...
  /// @brief Method PopulateGeometryData addr 0x21b9c5c size 0x1ae4 virtual false final false
  inline bool PopulateGeometryData(::HoudiniEngineUnity::HEU_SessionBase* session, bool bUseLODGroups);

  /// @brief Method ParseLODTransitionAttribute addr 0x21bb9b8 size 0x1bc virtual false final false
  ...
  /// @brief Method UpdateColliders addr 0x21bbb74 size 0x150 virtual false final false
  ...
  /// @brief Method UpdateCollider addr 0x21bbcc4 size 0x644 virtual false final false
  ...
  /// @brief Method GetFinalMaterialsFromComparingNewWithPrevious addr 0x21bc308 size 0x3a4 virtual false final false
  ...
  /// @brief Method GenerateMeshFromSingleGroup addr 0x21bc6ac size 0x1bc virtual false final false
  ...
  /// @brief Method GenerateLODMeshesFromGeoGroups addr 0x21bd354 size 0xb64 virtual false final false
  ...
  /// @brief Method GenerateMeshFromGeoGroup addr 0x21bc868 size 0xaec virtual false final false
  ...
  /// @brief Method CombineQuadMeshes addr 0x21be62c size 0x5a4 virtual false final false
  ...
  /// @brief Method CombineMeshes addr 0x21bebd0 size 0x344 virtual false final false
  ...
  /// @brief Method CreateMeshFromMeshData addr 0x21be390 size 0x29c virtual false final false
  ...
  /// @brief Method TransferRegularAttributesToVertices addr 0x21bef60 size 0x2ec virtual false final false
  ...
  /// @brief Method GenerateGeoGroupUsingGeoCacheVertices addr 0x21bf24c size 0x2d00 virtual false final false
  ...
  /// @brief Method GenerateGeoGroupUsingGeoCachePoints addr 0x21c22f4 size 0x226c virtual false final false
  ...
  /// @brief Method CalculateGroupMeshTopology addr 0x21c1f54 size 0x1c8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21b944c size 0x1fc virtual false final false
  inline void _ctor();
