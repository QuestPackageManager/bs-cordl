...
public:
  ...
  /// @brief Method CopyTo, addr 0x2451f30, size 0x74, virtual false, abstract: false, final false
  inline void CopyTo(::HoudiniEngineUnity::HEU_InputObjectInfo* destObject);

  /// @brief Method IsEquivalentTo, addr 0x2454250, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method SetReferencesFromGameObject, addr 0x2452218, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2451e48, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();
