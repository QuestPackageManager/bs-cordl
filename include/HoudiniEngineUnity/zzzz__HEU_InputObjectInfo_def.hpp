...
public:
  ...
  /// @brief Method CopyTo, addr 0x2459f2c, size 0x74, virtual false, abstract: false, final false
  inline void CopyTo(::HoudiniEngineUnity::HEU_InputObjectInfo* destObject);

  /// @brief Method IsEquivalentTo, addr 0x245c24c, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method SetReferencesFromGameObject, addr 0x245a214, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2459e44, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor();
