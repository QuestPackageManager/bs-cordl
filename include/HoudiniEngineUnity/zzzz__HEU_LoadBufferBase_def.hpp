...
public:
  ...
  /// @brief Method InitializeBuffer, addr 0x2590ae0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2590afc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
