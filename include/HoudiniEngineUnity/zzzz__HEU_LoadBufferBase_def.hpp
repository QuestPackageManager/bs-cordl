...
public:
  ...
  /// @brief Method InitializeBuffer, addr 0x25a7a24, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a7a40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
