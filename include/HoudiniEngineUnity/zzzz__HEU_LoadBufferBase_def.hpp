...
public:
  ...
  /// @brief Method InitializeBuffer, addr 0x3a5d27c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a5d298, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
