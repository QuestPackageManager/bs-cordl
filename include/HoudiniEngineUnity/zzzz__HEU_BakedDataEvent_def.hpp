...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9234)), TypeDefinitionIndex(TypeDefinitionIndex(9390)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9234), inst: 5216
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(9397)) CS Name: ::HoudiniEngineUnity::HEU_BakedDataEvent*
...
public:
  ...
  /// @brief Method .ctor, addr 0x21e3e04, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
