...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10465)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10465), inst: 5236 }),
// TypeDefinitionIndex(TypeDefinitionIndex(9598))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9605)) CS Name: ::HoudiniEngineUnity::HEU_BakedDataEvent*
