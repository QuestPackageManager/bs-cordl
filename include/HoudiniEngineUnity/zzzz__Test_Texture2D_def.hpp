...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x24ca008, size 0x108, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Texture2D* other);

  /// @brief Method IsNull, addr 0x24c9fa8, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x24c9f80, size 0x28, virtual false, abstract: false, final false
