...
public:
  ...
  /// @brief Method .ctor addr 0x208f370 size 0x28 virtual false final false
  inline void _ctor(::UnityEngine::Texture2D* self);

  /// @brief Method IsNull addr 0x208f398 size 0x60 virtual true final true
  inline bool IsNull();

  /// @brief Method IsEquivalentTo addr 0x208f3f8 size 0x108 virtual true final true
