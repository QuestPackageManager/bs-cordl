...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25f82ec, size 0x21c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25f82b8, size 0x34, virtual false, abstract: false, final false
