...
public:
  ...
  /// @brief Method .ctor addr 0x208bdfc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToTestObject>b__1_0 addr 0x208be04 size 0x64 virtual false final false
  inline ::HoudiniEngineUnity::Test_LODGroup* _ToTestObject_b__1_0(::UnityEngine::LODGroup* lod);

  /// @brief Method <ToTestObject>b__2_0 addr 0x208be68 size 0x64 virtual false final false
...
public:
  ...
  /// @brief Method ToTestObject addr 0x20898c4 size 0x64 virtual false final false
  static inline ::HoudiniEngineUnity::Test_LODGroup* ToTestObject(::UnityEngine::LODGroup* self);

  /// @brief Method ToTestObject addr 0x208bba4 size 0xf8 virtual false final false
  ...
  /// @brief Method ToTestObject addr 0x208bc9c size 0xfc virtual false final false
