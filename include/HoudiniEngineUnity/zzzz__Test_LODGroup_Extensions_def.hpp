...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x24c6a14, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_LODGroup* _ToTestObject_b__1_0(::UnityEngine::LODGroup* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x24c6a78, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_LODGroup* _ToTestObject_b__2_0(::UnityEngine::LODGroup* lod);

  /// @brief Method .ctor, addr 0x24c6a0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x24c67b4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x24c44d4, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_LODGroup* ToTestObject(::UnityEngine::LODGroup* self);

  /// @brief Method ToTestObject, addr 0x24c68ac, size 0xfc, virtual false, abstract: false, final false
