...
public:
  ...
  /// @brief Method Equals, addr 0x24bcb58, size 0xec, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetEnumerator, addr 0x24bcad8, size 0x14, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method GetHashCode, addr 0x24bcc44, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  static inline ::HoudiniEngineUnity::JSONString* New_ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder, addr 0x24bcafc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24b6bcc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW aData);

  /// @brief Method get_IsString, addr 0x24bcad0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsString();

  /// @brief Method get_Tag, addr 0x24bcac8, size 0x8, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::JSONNodeType get_Tag();

  /// @brief Method get_Value, addr 0x24bcaec, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Value();

  /// @brief Method set_Value, addr 0x24bcaf4, size 0x8, virtual true, abstract: false, final false
