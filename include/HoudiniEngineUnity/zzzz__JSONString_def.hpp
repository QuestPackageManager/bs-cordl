...
public:
  ...
  /// @brief Method get_Tag addr 0x2082eb8 size 0x8 virtual true final false
  inline ::HoudiniEngineUnity::JSONNodeType get_Tag();

  /// @brief Method get_IsString addr 0x2082ec0 size 0x8 virtual true final false
  inline bool get_IsString();

  /// @brief Method GetEnumerator addr 0x2082ec8 size 0x14 virtual true final false
  inline ::HoudiniEngineUnity::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value addr 0x2082edc size 0x8 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x2082ee4 size 0x8 virtual true final false
  inline void set_Value(::StringW value);

  static inline ::HoudiniEngineUnity::JSONString* New_ctor(::StringW aData);

  /// @brief Method .ctor addr 0x207cfbc size 0x28 virtual false final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder addr 0x2082eec size 0x5c virtual true final false
  ...
  /// @brief Method Equals addr 0x2082f48 size 0xec virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2083034 size 0x20 virtual true final false
