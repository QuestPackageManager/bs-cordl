...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x24c6b64, size 0x1cc, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Transform* other);

  /// @brief Method IsNull, addr 0x24c6b04, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x24c6adc, size 0x28, virtual false, abstract: false, final false
