...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x23a7618, size 0x1cc, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Transform* other);

  /// @brief Method IsNull, addr 0x23a75b8, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x23a7590, size 0x28, virtual false, abstract: false, final false
