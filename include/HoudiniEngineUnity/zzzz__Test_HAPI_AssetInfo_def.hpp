...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9619c, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a96168, size 0x34, virtual false, abstract: false, final false
