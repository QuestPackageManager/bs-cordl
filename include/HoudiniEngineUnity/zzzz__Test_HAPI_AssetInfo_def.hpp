...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x2344444, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2344410, size 0x34, virtual false, abstract: false, final false
