...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3aa4154, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3aa4120, size 0x34, virtual false, abstract: false, final false
