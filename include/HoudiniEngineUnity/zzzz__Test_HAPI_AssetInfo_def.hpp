...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a91228, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a911f4, size 0x34, virtual false, abstract: false, final false
