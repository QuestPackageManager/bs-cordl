...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a95e00, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a95dcc, size 0x34, virtual false, abstract: false, final false
