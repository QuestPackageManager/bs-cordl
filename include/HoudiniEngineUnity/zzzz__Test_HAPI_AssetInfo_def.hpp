...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25c63f0, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25c63bc, size 0x34, virtual false, abstract: false, final false
