...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25de334, size 0x2c0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25de300, size 0x34, virtual false, abstract: false, final false
