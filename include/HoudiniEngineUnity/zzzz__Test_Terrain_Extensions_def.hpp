...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x25f96c0, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Terrain* _ToTestObject_b__1_0(::UnityEngine::Terrain* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x25f9724, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Terrain* _ToTestObject_b__2_0(::UnityEngine::Terrain* lod);

  /// @brief Method .ctor, addr 0x25f96b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x25f9460, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x25f24e4, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_Terrain* ToTestObject(::UnityEngine::Terrain* self);

  /// @brief Method ToTestObject, addr 0x25f9558, size 0xfc, virtual false, abstract: false, final false
