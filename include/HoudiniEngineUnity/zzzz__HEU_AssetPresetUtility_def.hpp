...
public:
  ...
  /// @brief Method LoadPresetFileIntoAssetAndCook, addr 0x3a0738c, size 0x66c, virtual false, abstract: false, final false
  static inline void LoadPresetFileIntoAssetAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW filePath);

  /// @brief Method SaveAssetPresetToFile, addr 0x3a0659c, size 0x640, virtual false, abstract: false, final false
