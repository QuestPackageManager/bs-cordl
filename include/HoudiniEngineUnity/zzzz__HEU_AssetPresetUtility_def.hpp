...
public:
  ...
  /// @brief Method LoadPresetFileIntoAssetAndCook, addr 0x3a07018, size 0x66c, virtual false, abstract: false, final false
  static inline void LoadPresetFileIntoAssetAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW filePath);

  /// @brief Method SaveAssetPresetToFile, addr 0x3a06228, size 0x640, virtual false, abstract: false, final false
