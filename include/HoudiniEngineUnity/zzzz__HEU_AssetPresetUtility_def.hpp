...
public:
  ...
  /// @brief Method LoadPresetFileIntoAssetAndCook, addr 0x3a0a058, size 0x66c, virtual false, abstract: false, final false
  static inline void LoadPresetFileIntoAssetAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW filePath);

  /// @brief Method SaveAssetPresetToFile, addr 0x3a09268, size 0x640, virtual false, abstract: false, final false
