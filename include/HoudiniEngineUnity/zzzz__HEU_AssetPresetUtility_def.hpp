...
public:
  ...
  /// @brief Method LoadPresetFileIntoAssetAndCook, addr 0x2431a48, size 0x668, virtual false, abstract: false, final false
  static inline void LoadPresetFileIntoAssetAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW filePath);

  /// @brief Method SaveAssetPresetToFile, addr 0x2430c1c, size 0x640, virtual false, abstract: false, final false
