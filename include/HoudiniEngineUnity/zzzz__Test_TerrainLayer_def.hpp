...
public:
  ...
  /// @brief Method .ctor, addr 0x21e7430, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TerrainLayer* self);

  /// @brief Method IsNull, addr 0x21e7458, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();

  /// @brief Method IsEquivalentTo, addr 0x21e74b8, size 0x464, virtual true, abstract: false, final true
