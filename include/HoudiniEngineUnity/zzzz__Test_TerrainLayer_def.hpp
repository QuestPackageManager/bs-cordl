...
public:
  ...
  /// @brief Method .ctor addr 0x208ea94 size 0x28 virtual false final false
  inline void _ctor(::UnityEngine::TerrainLayer* self);

  /// @brief Method IsNull addr 0x208eabc size 0x60 virtual true final true
  inline bool IsNull();

  /// @brief Method IsEquivalentTo addr 0x208eb1c size 0x464 virtual true final true
