...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9af8c, size 0x464, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_TerrainLayer* other);

  /// @brief Method IsNull, addr 0x3a9af2c, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x3a9af04, size 0x28, virtual false, abstract: false, final false
