...
public:
  ...
  /// @brief Method .ctor, addr 0x227cd18, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TerrainLayer* self);

  /// @brief Method IsNull, addr 0x227cd40, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();

  /// @brief Method IsEquivalentTo, addr 0x227cda0, size 0x464, virtual true, abstract: false, final true
