...
public:
  ...
  /// @brief Method GetMaterialAlpha, addr 0x3a5860c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSupportedFileFormat, addr 0x3a587e4, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTextureFileNameFromMaterialParam, addr 0x3a57f44, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a58908, size 0x1b8, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_MaterialData* other);

  /// @brief Method IsExistingMaterial, addr 0x3a569b8, size 0x14, virtual false, abstract: false, final false
  inline bool IsExistingMaterial();

  /// @brief Method IsTransparentMaterial, addr 0x3a578ec, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateMaterialFromHoudini, addr 0x3a569cc, size 0xf20, virtual false, abstract: false, final false
  inline void UpdateMaterialFromHoudini(::HoudiniEngineUnity::HAPI_MaterialInfo materialInfo, ::StringW assetCacheFolderPath);

  /// @brief Method UseLegacyShaders, addr 0x3a57968, size 0x5dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a58ac0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
