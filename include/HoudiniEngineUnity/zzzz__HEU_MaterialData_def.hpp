...
public:
  ...
  /// @brief Method IsExistingMaterial addr 0x219d59c size 0x14 virtual false final false
  inline bool IsExistingMaterial();

  /// @brief Method UpdateMaterialFromHoudini addr 0x219d5b0 size 0xf40 virtual false final false
  inline void UpdateMaterialFromHoudini(::HoudiniEngineUnity::HAPI_MaterialInfo materialInfo, ::StringW assetCacheFolderPath);

  /// @brief Method UseLegacyShaders addr 0x219e56c size 0x5d8 virtual false final false
  ...
  /// @brief Method GetTextureFileNameFromMaterialParam addr 0x219eb44 size 0x24c virtual false final false
  ...
  /// @brief Method IsTransparentMaterial addr 0x219e4f0 size 0x30 virtual false final false
  ...
  /// @brief Method GetMaterialAlpha addr 0x219f200 size 0x1d8 virtual false final false
  ...
  /// @brief Method GetSupportedFileFormat addr 0x219f3d8 size 0x124 virtual false final false
  ...
  /// @brief Method IsEquivalentTo addr 0x219f4fc size 0x1c8 virtual true final true
  ...
  /// @brief Method .ctor addr 0x219f6c4 size 0x10 virtual false final false
  inline void _ctor();
