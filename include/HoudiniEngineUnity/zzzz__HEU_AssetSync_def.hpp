...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3a05c24, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3a05c44, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3a05c10, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a05b10, size 0x100, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateThreadedTask, addr 0x3a05798, size 0x68, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo* CreateThreadedTask();

  /// @brief Method InitializeAsset, addr 0x3a056a0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3a05694, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x3a05690, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLoadComplete, addr 0x3a058b0, size 0x34, virtual true, abstract: false, final false
  inline void OnLoadComplete(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method Resync, addr 0x3a05968, size 0x38, virtual true, abstract: false, final false
  inline void Resync();

  /// @brief Method SetLoadCallback, addr 0x3a05804, size 0x38, virtual false, abstract: false, final false
  inline void SetLoadCallback(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadCallback* callback);

  /// @brief Method SetupLoadTask, addr 0x3a0583c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a059a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
