...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2487c24, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2487c44, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2487c10, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2487ae4, size 0x12c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateThreadedTask, addr 0x2487768, size 0x68, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo* CreateThreadedTask();

  /// @brief Method InitializeAsset, addr 0x2487670, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2487664, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x2487660, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLoadComplete, addr 0x2487880, size 0x34, virtual true, abstract: false, final false
  inline void OnLoadComplete(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method Resync, addr 0x2487938, size 0x38, virtual true, abstract: false, final false
  inline void Resync();

  /// @brief Method SetLoadCallback, addr 0x24877d4, size 0x38, virtual false, abstract: false, final false
  inline void SetLoadCallback(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadCallback* callback);

  /// @brief Method SetupLoadTask, addr 0x248780c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2487970, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
