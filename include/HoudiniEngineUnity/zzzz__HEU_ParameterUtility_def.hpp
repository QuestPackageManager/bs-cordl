...
public:
  ...
  /// @brief Method SetFloat, addr 0x222ca7c, size 0x130, virtual false, abstract: false, final false
  static inline bool SetFloat(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, float_t setValue);

  /// @brief Method SetFloats, addr 0x222cbac, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method GetString, addr 0x222cccc, size 0x13c, virtual false, abstract: false, final false
  static inline bool GetString(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, ByRef<::StringW> outValue);

  /// @brief Method SetString, addr 0x222ce08, size 0x14c, virtual false, abstract: false, final false
  static inline bool SetString(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, ::StringW setValue);

  /// @brief Method SetChoice, addr 0x222cf54, size 0x184, virtual false, abstract: false, final false
  static inline bool SetChoice(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, int32_t setValue);

  /// @brief Method GetChoice, addr 0x222d0d8, size 0x168, virtual false, abstract: false, final false
  static inline bool GetChoice(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, ByRef<int32_t> outValue);

  /// @brief Method SetInputNode, addr 0x222d240, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputNode, addr 0x222d3f0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColor, addr 0x222d594, size 0x12c, virtual false, abstract: false, final false
  static inline bool GetColor(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, ByRef<::UnityEngine::Color> getValue);

  /// @brief Method SetColor, addr 0x222d6c0, size 0x138, virtual false, abstract: false, final false
  static inline bool SetColor(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::StringW paramName, ::UnityEngine::Color setValue);

  /// @brief Method GetParameterIndexFromName, addr 0x222d7f8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameterIndexFromNameOrTag, addr 0x222d8e8, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetParameterIndexFromNameOrTag(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID,
                                                       ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo, ::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*> parameters, ::StringW parameterName);

  /// @brief Method FindTextureParamByNameOrTag, addr 0x222d958, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameterFloatValue, addr 0x222db18, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameterColor3Value, addr 0x222dc24, size 0x117c, virtual false, abstract: false, final false
