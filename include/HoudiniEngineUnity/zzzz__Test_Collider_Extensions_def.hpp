...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x25e144c, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Collider* _ToTestObject_b__1_0(::UnityEngine::Collider* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x25e14b0, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x25e11ec, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x25de168, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_Collider* ToTestObject(::UnityEngine::Collider* self);

  /// @brief Method ToTestObject, addr 0x25e12e4, size 0xfc, virtual false, abstract: false, final false
