...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9495)), TypeDefinitionIndex(TypeDefinitionIndex(9499))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x22182bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
