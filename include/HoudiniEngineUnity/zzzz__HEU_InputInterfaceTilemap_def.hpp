...
public:
  ...
  /// @brief Method .ctor addr 0x207647c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x2073be8 size 0xc virtual false final false
  inline void _ctor();

  /// @brief Method Initialize addr 0x2073bf4 size 0x70 virtual false final false
  inline void Initialize(::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings* settings);

  /// @brief Method CreateInputNodeWithDataUpload addr 0x2073c64 size 0x198 virtual true final false
  ...
  /// @brief Method IsThisInputObjectSupported addr 0x20758d0 size 0xc4 virtual true final false
  inline bool IsThisInputObjectSupported(::UnityEngine::GameObject* inputObject);

  /// @brief Method UploadData addr 0x2073ed4 size 0x19fc virtual false final false
  ...
  /// @brief Method GenerateTilemapDataFromGameObject addr 0x2073dfc size 0xd8 virtual false final false
