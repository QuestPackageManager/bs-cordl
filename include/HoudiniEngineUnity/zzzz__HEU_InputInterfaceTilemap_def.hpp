...
public:
  ...
  /// @brief Method .ctor, addr 0x25b1d10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateInputNodeWithDataUpload, addr 0x25af4f8, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateTilemapDataFromGameObject, addr 0x25af690, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x25af488, size 0x70, virtual false, abstract: false, final false
  inline void Initialize(::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings* settings);

  /// @brief Method IsThisInputObjectSupported, addr 0x25b1164, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method UploadData, addr 0x25af768, size 0x19fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25af47c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
