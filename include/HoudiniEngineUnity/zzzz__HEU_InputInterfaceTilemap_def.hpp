...
public:
  ...
  /// @brief Method .ctor, addr 0x3a83290, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateInputNodeWithDataUpload, addr 0x3a80b58, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateTilemapDataFromGameObject, addr 0x3a80cfc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x3a80af0, size 0x68, virtual false, abstract: false, final false
  inline void Initialize(::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings* settings);

  /// @brief Method IsThisInputObjectSupported, addr 0x3a827c4, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method UploadData, addr 0x3a80dd4, size 0x19f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a80ae4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
