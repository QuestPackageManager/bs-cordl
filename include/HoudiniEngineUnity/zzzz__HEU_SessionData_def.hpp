...
public:
  ...
  /// @brief Method GetOrCreateSessionSync, addr 0x3a58e8c, size 0x60, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionSyncData* GetOrCreateSessionSync();

  /// @brief Method GetSessionSync, addr 0x3a58f98, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionSyncData* GetSessionSync();

  static inline ::HoudiniEngineUnity::HEU_SessionData* New_ctor();

  /// @brief Method SetSessionSync, addr 0x3a58fa0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a591a0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline int64_t getStaticF_INVALID_SESSION_ID();

  /// @brief Method get_IsDefaultSession, addr 0x3a5916c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDefaultSession();

  /// @brief Method get_IsInitialized, addr 0x3a59020, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_IsSessionSync, addr 0x3a58254, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsSessionSync();

  /// @brief Method get_IsValidSessionID, addr 0x3a59034, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsValidSessionID();

  /// @brief Method get_PipeName, addr 0x3a5903c, size 0x40, virtual false, abstract: false, final false
  inline ::StringW get_PipeName();

  /// @brief Method get_Port, addr 0x3a59084, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Port();

  /// @brief Method get_ProcessID, addr 0x3a59000, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_ProcessID();

  /// @brief Method get_SessionClassType, addr 0x3a59094, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Type* get_SessionClassType();

  /// @brief Method get_SessionID, addr 0x3a58fa8, size 0x58, virtual false, abstract: false, final false
  inline int64_t get_SessionID();

  /// @brief Method get_SessionType, addr 0x3a59010, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HAPI_SessionType get_SessionType();

  /// @brief Method get_ThisConnectionMode, addr 0x3a59180, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionConnectionState get_ThisConnectionMode();

  /// @brief Method get_ThisSessionMode, addr 0x3a59190, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionMode get_ThisSessionMode();

  static inline void setStaticF_INVALID_SESSION_ID(int64_t value);

  /// @brief Method set_IsDefaultSession, addr 0x3a59174, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDefaultSession(bool value);

  /// @brief Method set_IsInitialized, addr 0x3a59028, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_PipeName, addr 0x3a5907c, size 0x8, virtual false, abstract: false, final false
  inline void set_PipeName(::StringW value);

  /// @brief Method set_Port, addr 0x3a5908c, size 0x8, virtual false, abstract: false, final false
  inline void set_Port(int32_t value);

  /// @brief Method set_ProcessID, addr 0x3a59008, size 0x8, virtual false, abstract: false, final false
  inline void set_ProcessID(int32_t value);

  /// @brief Method set_SessionClassType, addr 0x3a5913c, size 0x30, virtual false, abstract: false, final false
  inline void set_SessionClassType(::System::Type* value);

  /// @brief Method set_SessionID, addr 0x3a58694, size 0x8, virtual false, abstract: false, final false
  inline void set_SessionID(int64_t value);

  /// @brief Method set_SessionType, addr 0x3a59018, size 0x8, virtual false, abstract: false, final false
  inline void set_SessionType(::HoudiniEngineUnity::HAPI_SessionType value);

  /// @brief Method set_ThisConnectionMode, addr 0x3a59188, size 0x8, virtual false, abstract: false, final false
  inline void set_ThisConnectionMode(::HoudiniEngineUnity::SessionConnectionState value);

  /// @brief Method set_ThisSessionMode, addr 0x3a59198, size 0x8, virtual false, abstract: false, final false
