...
public:
  ...
  /// @brief Method AddShelf, addr 0x2333424, size 0x108, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_Shelf* AddShelf(::StringW shelfName, ::StringW shelfPath);

  /// @brief Method AreShelvesLoaded, addr 0x23326c0, size 0x58, virtual false, abstract: false, final false
  static inline bool AreShelvesLoaded();

  /// @brief Method ClearShelves, addr 0x2332770, size 0x98, virtual false, abstract: false, final false
  static inline void ClearShelves();

  /// @brief Method ExecuteTool, addr 0x2334a0c, size 0x384, virtual false, abstract: false, final false
  static inline void ExecuteTool(int32_t toolSlot);

  /// @brief Method ExecuteToolBatch, addr 0x2335c34, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteToolGenerator, addr 0x2334d90, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteToolNoInput, addr 0x2334fa0, size 0x1b8, virtual false, abstract: false, final false
  static inline void ExecuteToolNoInput(::StringW toolName, ::StringW toolPath);

  /// @brief Method ExecuteToolOperatorMultiple, addr 0x2335754, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteToolOperatorSingle, addr 0x2335158, size 0x5fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentShelfIndex, addr 0x2332878, size 0x58, virtual false, abstract: false, final false
  static inline int32_t GetCurrentShelfIndex();

  /// @brief Method GetNumShelves, addr 0x2332808, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetNumShelves();

  /// @brief Method GetShelf, addr 0x233292c, size 0xcc, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_Shelf* GetShelf(int32_t index);

  /// @brief Method GetShelf, addr 0x23329f8, size 0x1b8, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_Shelf* GetShelf(::StringW shelfName);

  /// @brief Method GetShelfStorageEntry, addr 0x2332bb0, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetShelfStorageEntry(::StringW shelfName, ::StringW shelfPath);

  /// @brief Method GetSplitShelfEntry, addr 0x2332c0c, size 0xd0, virtual false, abstract: false, final false
  static inline void GetSplitShelfEntry(::StringW shelfEntry, ByRef<::StringW> shelfName, ByRef<::StringW> shelfPath);

  /// @brief Method GetToolAssetPath, addr 0x2334618, size 0x15c, virtual false, abstract: false, final false
  static inline ::StringW GetToolAssetPath(::HoudiniEngineUnity::HEU_ShelfToolData* tool, ::StringW inPath);

  /// @brief Method GetToolIconPath, addr 0x2334774, size 0x154, virtual false, abstract: false, final false
  static inline ::StringW GetToolIconPath(::HoudiniEngineUnity::HEU_ShelfToolData* tool, ::StringW inPath);

  /// @brief Method GetToolResourcePath, addr 0x2335d9c, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW GetToolResourcePath(::HoudiniEngineUnity::HEU_ShelfToolData* tool, ::StringW inPath, ::StringW ext);

  /// @brief Method IsValidInput, addr 0x2335ca0, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsValidInput(::UnityEngine::GameObject* gameObject);

  /// @brief Method LoadShelves, addr 0x2332cdc, size 0x748, virtual false, abstract: false, final false
  static inline void LoadShelves();

  /// @brief Method LoadToolFromJsonFile, addr 0x2333a64, size 0x1cc, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_ShelfToolData* LoadToolFromJsonFile(::StringW jsonFilePath);

  /// @brief Method LoadToolFromJsonString, addr 0x2333c30, size 0x990, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_ShelfToolData* LoadToolFromJsonString(::StringW json, ::StringW jsonFilePath);

  /// @brief Method LoadToolsFromDirectory, addr 0x233352c, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveShelf, addr 0x23348c8, size 0x144, virtual false, abstract: false, final false
  static inline void RemoveShelf(int32_t shelfIndex);

  /// @brief Method SaveShelf, addr 0x23337d8, size 0x28c, virtual false, abstract: false, final false
  static inline void SaveShelf();

  /// @brief Method SetCurrentShelf, addr 0x23328d0, size 0x5c, virtual false, abstract: false, final false
  static inline void SetCurrentShelf(int32_t index);

  /// @brief Method SetReloadShelves, addr 0x2332718, size 0x58, virtual false, abstract: false, final false
  static inline void SetReloadShelves();

  /// @brief Method .ctor, addr 0x2335e7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
