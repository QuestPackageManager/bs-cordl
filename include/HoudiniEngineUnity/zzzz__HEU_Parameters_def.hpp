...
public:
  ...
  /// @brief Method <Initialize>b__0, addr 0x3a4e2c4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a4b7d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreParametersValid, addr 0x3a499a4, size 0x8, virtual false, abstract: false, final false
  inline bool AreParametersValid();

  /// @brief Method CleanUp, addr 0x3a499d4, size 0x280, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method ClearInstancesFromMultiParm, addr 0x3a4cbb8, size 0xbc, virtual false, abstract: false, final false
  inline void ClearInstancesFromMultiParm(int32_t unityParamIndex);

  /// @brief Method DownloadAsDefaultPresetData, addr 0x3a4d5d4, size 0x50, virtual false, abstract: false, final false
  inline void DownloadAsDefaultPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DownloadPresetData, addr 0x3a4d540, size 0x50, virtual false, abstract: false, final false
  inline void DownloadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetChosenIndexFromChoiceList, addr 0x3a4bdc4, size 0xac, virtual false, abstract: false, final false
  inline int32_t GetChosenIndexFromChoiceList(::HoudiniEngineUnity::HEU_ParameterData* inChoiceParameter);

  /// @brief Method GetDefaultPresetData, addr 0x3a4999c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDefaultPresetData();

  /// @brief Method GetInputNodeConnectionObjects, addr 0x3a4d53c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameter, addr 0x3a47224, size 0x84, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(int32_t listIndex);

  /// @brief Method GetParameter, addr 0x3a4bbdc, size 0x168, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(::StringW name);

  /// @brief Method GetParameterDataForUIRestore, addr 0x3a4d354, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameterWithParmID, addr 0x3a4706c, size 0x158, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameterWithParmID(int32_t parmID);

  /// @brief Method GetParameters, addr 0x3a4bbd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterData*>* GetParameters();

  /// @brief Method GetPresetData, addr 0x3a4998c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPresetData();

  /// @brief Method GetStringFromParameter, addr 0x3a4be70, size 0x48, virtual false, abstract: false, final false
  inline ::StringW GetStringFromParameter(::StringW paramName);

  /// @brief Method HasModifiersPending, addr 0x3a4cc74, size 0x50, virtual false, abstract: false, final false
  inline bool HasModifiersPending();

  /// @brief Method HaveParametersChanged, addr 0x3a4befc, size 0x410, virtual false, abstract: false, final false
  inline bool HaveParametersChanged();

  /// @brief Method Initialize, addr 0x3a49c54, size 0x1b7c, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertInstanceToMultiParm, addr 0x3a4ca18, size 0xd0, virtual false, abstract: false, final false
  inline void InsertInstanceToMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToAdd);

  /// @brief Method IsEquivalentTo, addr 0x3a4de94, size 0x300, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessModifiers, addr 0x3a4ccc4, size 0x690, virtual false, abstract: false, final false
  inline void ProcessModifiers(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method RemoveInstancesFromMultiParm, addr 0x3a4cae8, size 0xd0, virtual false, abstract: false, final false
  inline void RemoveInstancesFromMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToRemove);

  /// @brief Method RemoveParameter, addr 0x3a4bd44, size 0x80, virtual false, abstract: false, final false
  inline void RemoveParameter(int32_t listIndex);

  /// @brief Method ResetAllToDefault, addr 0x3a4dd0c, size 0x188, virtual false, abstract: false, final false
  inline void ResetAllToDefault(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SetPresetData, addr 0x3a49994, size 0x8, virtual false, abstract: false, final false
  inline void SetPresetData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method SetStringToParameter, addr 0x3a4beb8, size 0x44, virtual false, abstract: false, final false
  inline void SetStringToParameter(::StringW paramName, ::StringW value);

  /// @brief Method SetupRampParameter, addr 0x3a4b7d8, size 0x3fc, virtual false, abstract: false, final false
  inline void SetupRampParameter(::HoudiniEngineUnity::HEU_ParameterData* rampParameter);

  /// @brief Method SyncInternalParametersForUndoCompare, addr 0x3a4d92c, size 0x3e0, virtual false, abstract: false, final false
  inline void SyncInternalParametersForUndoCompare(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SyncParameterFromHoudini, addr 0x3a4d8ac, size 0x80, virtual false, abstract: false, final false
  inline void SyncParameterFromHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW parameterName);

  /// @brief Method UpdateTransformParameters, addr 0x3a4d804, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadParameterInputs, addr 0x3a4d624, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadPresetData, addr 0x3a4d590, size 0x44, virtual false, abstract: false, final false
  inline void UploadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadValuesToHoudini, addr 0x3a4c30c, size 0x70c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a4e194, size 0x130, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ParameterModifiers, addr 0x3a49968, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* get_ParameterModifiers();

  /// @brief Method get_RecacheUI, addr 0x3a499c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_RecacheUI();

  /// @brief Method get_RequiresRegeneration, addr 0x3a49978, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequiresRegeneration();

  /// @brief Method get_RootParameters, addr 0x3a49958, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int32_t>* get_RootParameters();

  /// @brief Method get_ShowParameters, addr 0x3a499ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ParameterModifiers, addr 0x3a49970, size 0x8, virtual false, abstract: false, final false
  inline void set_ParameterModifiers(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* value);

  /// @brief Method set_RecacheUI, addr 0x3a499c8, size 0xc, virtual false, abstract: false, final false
  inline void set_RecacheUI(bool value);

  /// @brief Method set_RequiresRegeneration, addr 0x3a49980, size 0xc, virtual false, abstract: false, final false
  inline void set_RequiresRegeneration(bool value);

  /// @brief Method set_RootParameters, addr 0x3a49960, size 0x8, virtual false, abstract: false, final false
  inline void set_RootParameters(::System::Collections::Generic::List_1<int32_t>* value);

  /// @brief Method set_ShowParameters, addr 0x3a499b4, size 0xc, virtual false, abstract: false, final false
