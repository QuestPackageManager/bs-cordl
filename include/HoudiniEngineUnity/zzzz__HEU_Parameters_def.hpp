...
public:
  ...
  /// @brief Method .ctor addr 0x2194ea8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Initialize>b__0 addr 0x2197a58 size 0x14 virtual false final false
...
public:
  ...
  /// @brief Method get_RootParameters addr 0x2193058 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<int32_t>* get_RootParameters();

  /// @brief Method set_RootParameters addr 0x2193060 size 0x8 virtual false final false
  inline void set_RootParameters(::System::Collections::Generic::List_1<int32_t>* value);

  /// @brief Method get_ParameterModifiers addr 0x2193068 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* get_ParameterModifiers();

  /// @brief Method set_ParameterModifiers addr 0x2193070 size 0x8 virtual false final false
  inline void set_ParameterModifiers(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* value);

  /// @brief Method get_RequiresRegeneration addr 0x2193078 size 0x8 virtual false final false
  inline bool get_RequiresRegeneration();

  /// @brief Method set_RequiresRegeneration addr 0x2193080 size 0xc virtual false final false
  inline void set_RequiresRegeneration(bool value);

  /// @brief Method GetPresetData addr 0x219308c size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPresetData();

  /// @brief Method SetPresetData addr 0x2193094 size 0x8 virtual false final false
  inline void SetPresetData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetDefaultPresetData addr 0x219309c size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDefaultPresetData();

  /// @brief Method AreParametersValid addr 0x21930a4 size 0x8 virtual false final false
  inline bool AreParametersValid();

  /// @brief Method get_ShowParameters addr 0x21930ac size 0x8 virtual false final false
  inline bool get_ShowParameters();

  /// @brief Method set_ShowParameters addr 0x21930b4 size 0xc virtual false final false
  inline void set_ShowParameters(bool value);

  /// @brief Method get_RecacheUI addr 0x21930c0 size 0x8 virtual false final false
  inline bool get_RecacheUI();

  /// @brief Method set_RecacheUI addr 0x21930c8 size 0xc virtual false final false
  inline void set_RecacheUI(bool value);

  /// @brief Method CleanUp addr 0x21930d4 size 0x29c virtual false final false
  inline void CleanUp();

  /// @brief Method Initialize addr 0x2193370 size 0x1b38 virtual false final false
  ...
  /// @brief Method SetupRampParameter addr 0x2194eb0 size 0x3f0 virtual false final false
  inline void SetupRampParameter(::HoudiniEngineUnity::HEU_ParameterData* rampParameter);

  /// @brief Method GetParameters addr 0x21952a0 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterData*>* GetParameters();

  /// @brief Method GetParameter addr 0x2190910 size 0x84 virtual false final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(int32_t listIndex);

  /// @brief Method GetParameter addr 0x21952a8 size 0x190 virtual false final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(::StringW name);

  /// @brief Method GetParameterWithParmID addr 0x219074c size 0x164 virtual false final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameterWithParmID(int32_t parmID);

  /// @brief Method RemoveParameter addr 0x2195438 size 0x80 virtual false final false
  inline void RemoveParameter(int32_t listIndex);

  /// @brief Method GetChosenIndexFromChoiceList addr 0x21954b8 size 0xac virtual false final false
  inline int32_t GetChosenIndexFromChoiceList(::HoudiniEngineUnity::HEU_ParameterData* inChoiceParameter);

  /// @brief Method GetStringFromParameter addr 0x2195564 size 0x48 virtual false final false
  inline ::StringW GetStringFromParameter(::StringW paramName);

  /// @brief Method SetStringToParameter addr 0x21955ac size 0x70 virtual false final false
  inline void SetStringToParameter(::StringW paramName, ::StringW value);

  /// @brief Method HaveParametersChanged addr 0x219561c size 0x410 virtual false final false
  inline bool HaveParametersChanged();

  /// @brief Method UploadValuesToHoudini addr 0x2195a2c size 0x71c virtual false final false
  ...
  /// @brief Method InsertInstanceToMultiParm addr 0x2196148 size 0xd4 virtual false final false
  inline void InsertInstanceToMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToAdd);

  /// @brief Method RemoveInstancesFromMultiParm addr 0x219621c size 0xd4 virtual false final false
  inline void RemoveInstancesFromMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToRemove);

  /// @brief Method ClearInstancesFromMultiParm addr 0x21962f0 size 0xc0 virtual false final false
  inline void ClearInstancesFromMultiParm(int32_t unityParamIndex);

  /// @brief Method HasModifiersPending addr 0x21963b0 size 0x50 virtual false final false
  inline bool HasModifiersPending();

  /// @brief Method ProcessModifiers addr 0x2196400 size 0x694 virtual false final false
  inline void ProcessModifiers(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetParameterDataForUIRestore addr 0x2196a94 size 0x1e8 virtual false final false
  ...
  /// @brief Method GetInputNodeConnectionObjects addr 0x2196c7c size 0x4 virtual false final false
  inline void GetInputNodeConnectionObjects(::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* inputNodeObjects);

  /// @brief Method DownloadPresetData addr 0x2196c80 size 0x50 virtual false final false
  inline void DownloadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadPresetData addr 0x2196cd0 size 0x44 virtual false final false
  inline void UploadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DownloadAsDefaultPresetData addr 0x2196d14 size 0x50 virtual false final false
  inline void DownloadAsDefaultPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadParameterInputs addr 0x2196d64 size 0x1e0 virtual false final false
  ...
  /// @brief Method UpdateTransformParameters addr 0x2196f44 size 0xa8 virtual false final false
  ...
  /// @brief Method SyncParameterFromHoudini addr 0x2196fec size 0x80 virtual false final false
  inline void SyncParameterFromHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW parameterName);

  /// @brief Method SyncInternalParametersForUndoCompare addr 0x219706c size 0x41c virtual false final false
  inline void SyncInternalParametersForUndoCompare(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method ResetAllToDefault addr 0x2197488 size 0x188 virtual false final false
  inline void ResetAllToDefault(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method IsEquivalentTo addr 0x2197610 size 0x318 virtual true final true
  ...
  /// @brief Method .ctor addr 0x2197928 size 0x130 virtual false final false
  inline void _ctor();
