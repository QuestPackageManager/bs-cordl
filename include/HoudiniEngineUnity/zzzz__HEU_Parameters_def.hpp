...
public:
  ...
  /// @brief Method <Initialize>b__0, addr 0x235a77c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2357bcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreParametersValid, addr 0x2355dc8, size 0x8, virtual false, abstract: false, final false
  inline bool AreParametersValid();

  /// @brief Method CleanUp, addr 0x2355df8, size 0x29c, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method ClearInstancesFromMultiParm, addr 0x2359014, size 0xc0, virtual false, abstract: false, final false
  inline void ClearInstancesFromMultiParm(int32_t unityParamIndex);

  /// @brief Method DownloadAsDefaultPresetData, addr 0x2359a38, size 0x50, virtual false, abstract: false, final false
  inline void DownloadAsDefaultPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DownloadPresetData, addr 0x23599a4, size 0x50, virtual false, abstract: false, final false
  inline void DownloadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetChosenIndexFromChoiceList, addr 0x23581dc, size 0xac, virtual false, abstract: false, final false
  inline int32_t GetChosenIndexFromChoiceList(::HoudiniEngineUnity::HEU_ParameterData* inChoiceParameter);

  /// @brief Method GetDefaultPresetData, addr 0x2355dc0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDefaultPresetData();

  /// @brief Method GetInputNodeConnectionObjects, addr 0x23599a0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameter, addr 0x2353634, size 0x84, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(int32_t listIndex);

  /// @brief Method GetParameter, addr 0x2357fcc, size 0x190, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(::StringW name);

  /// @brief Method GetParameterDataForUIRestore, addr 0x23597b8, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParameterWithParmID, addr 0x2353470, size 0x164, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameterWithParmID(int32_t parmID);

  /// @brief Method GetParameters, addr 0x2357fc4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterData*>* GetParameters();

  /// @brief Method GetPresetData, addr 0x2355db0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPresetData();

  /// @brief Method GetStringFromParameter, addr 0x2358288, size 0x48, virtual false, abstract: false, final false
  inline ::StringW GetStringFromParameter(::StringW paramName);

  /// @brief Method HasModifiersPending, addr 0x23590d4, size 0x50, virtual false, abstract: false, final false
  inline bool HasModifiersPending();

  /// @brief Method HaveParametersChanged, addr 0x2358340, size 0x410, virtual false, abstract: false, final false
  inline bool HaveParametersChanged();

  /// @brief Method Initialize, addr 0x2356094, size 0x1b38, virtual false, abstract: false, final false
  ...
  /// @brief Method InsertInstanceToMultiParm, addr 0x2358e6c, size 0xd4, virtual false, abstract: false, final false
  inline void InsertInstanceToMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToAdd);

  /// @brief Method IsEquivalentTo, addr 0x235a334, size 0x318, virtual true, abstract: false, final true
  ...
  /// @brief Method ProcessModifiers, addr 0x2359124, size 0x694, virtual false, abstract: false, final false
  inline void ProcessModifiers(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method RemoveInstancesFromMultiParm, addr 0x2358f40, size 0xd4, virtual false, abstract: false, final false
  inline void RemoveInstancesFromMultiParm(int32_t unityParamIndex, int32_t instanceIndex, int32_t numInstancesToRemove);

  /// @brief Method RemoveParameter, addr 0x235815c, size 0x80, virtual false, abstract: false, final false
  inline void RemoveParameter(int32_t listIndex);

  /// @brief Method ResetAllToDefault, addr 0x235a1ac, size 0x188, virtual false, abstract: false, final false
  inline void ResetAllToDefault(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SetPresetData, addr 0x2355db8, size 0x8, virtual false, abstract: false, final false
  inline void SetPresetData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method SetStringToParameter, addr 0x23582d0, size 0x70, virtual false, abstract: false, final false
  inline void SetStringToParameter(::StringW paramName, ::StringW value);

  /// @brief Method SetupRampParameter, addr 0x2357bd4, size 0x3f0, virtual false, abstract: false, final false
  inline void SetupRampParameter(::HoudiniEngineUnity::HEU_ParameterData* rampParameter);

  /// @brief Method SyncInternalParametersForUndoCompare, addr 0x2359d90, size 0x41c, virtual false, abstract: false, final false
  inline void SyncInternalParametersForUndoCompare(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SyncParameterFromHoudini, addr 0x2359d10, size 0x80, virtual false, abstract: false, final false
  inline void SyncParameterFromHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW parameterName);

  /// @brief Method UpdateTransformParameters, addr 0x2359c68, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadParameterInputs, addr 0x2359a88, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadPresetData, addr 0x23599f4, size 0x44, virtual false, abstract: false, final false
  inline void UploadPresetData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadValuesToHoudini, addr 0x2358750, size 0x71c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x235a64c, size 0x130, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ParameterModifiers, addr 0x2355d8c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* get_ParameterModifiers();

  /// @brief Method get_RecacheUI, addr 0x2355de4, size 0x8, virtual false, abstract: false, final false
  inline bool get_RecacheUI();

  /// @brief Method get_RequiresRegeneration, addr 0x2355d9c, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequiresRegeneration();

  /// @brief Method get_RootParameters, addr 0x2355d7c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<int32_t>* get_RootParameters();

  /// @brief Method get_ShowParameters, addr 0x2355dd0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ParameterModifiers, addr 0x2355d94, size 0x8, virtual false, abstract: false, final false
  inline void set_ParameterModifiers(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* value);

  /// @brief Method set_RecacheUI, addr 0x2355dec, size 0xc, virtual false, abstract: false, final false
  inline void set_RecacheUI(bool value);

  /// @brief Method set_RequiresRegeneration, addr 0x2355da4, size 0xc, virtual false, abstract: false, final false
  inline void set_RequiresRegeneration(bool value);

  /// @brief Method set_RootParameters, addr 0x2355d84, size 0x8, virtual false, abstract: false, final false
  inline void set_RootParameters(::System::Collections::Generic::List_1<int32_t>* value);

  /// @brief Method set_ShowParameters, addr 0x2355dd8, size 0xc, virtual false, abstract: false, final false
