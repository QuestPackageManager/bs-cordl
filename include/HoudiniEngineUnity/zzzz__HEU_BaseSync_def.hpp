...
public:
  ...
  /// @brief Method AddGeneratedOutputFilePath, addr 0x3a5ed44, size 0xe0, virtual false, abstract: false, final false
  inline void AddGeneratedOutputFilePath(::StringW path);

  /// @brief Method ApplyAttributeModifiersOnGameObjectOutput, addr 0x3a5ee24, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Awake, addr 0x3a5c080, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Bake, addr 0x3a5c91c, size 0x3ac, virtual true, abstract: false, final false
  inline void Bake();

  /// @brief Method ClearLog, addr 0x3a5c608, size 0xf8, virtual false, abstract: false, final false
  inline void ClearLog();

  /// @brief Method CreateNewInstanceFromObject, addr 0x3a603f8, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteSessionData, addr 0x3a5c090, size 0x78, virtual true, abstract: false, final false
  inline void DeleteSessionData();

  /// @brief Method DestroyGeneratedData, addr 0x3a5c164, size 0x4, virtual true, abstract: false, final false
  inline void DestroyGeneratedData();

  /// @brief Method DestroyOutputs, addr 0x3a5c168, size 0x24c, virtual false, abstract: false, final false
  inline void DestroyOutputs();

  /// @brief Method Error, addr 0x3a5c700, size 0x1c, virtual false, abstract: false, final false
  inline void Error(::StringW error);

  /// @brief Method GenerateAllInstancers, addr 0x3a5ebdc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateGeometry, addr 0x3a5cea4, size 0x108, virtual true, abstract: false, final false
  inline void GenerateGeometry(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadData* loadData, int32_t objIndex);

  /// @brief Method GenerateInstancer, addr 0x3a5f088, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromAssetPaths, addr 0x3a5fac4, size 0x934, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromNodeIDs, addr 0x3a5f388, size 0x73c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x3a5cfac, size 0x60c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateObjects, addr 0x3a5ce18, size 0x8c, virtual true, abstract: false, final false
  inline void GenerateObjects(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadData* loadData);

  /// @brief Method GenerateTerrain, addr 0x3a5d5b8, size 0x1624, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHoudiniSession, addr 0x3a5c3d0, size 0x160, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetHoudiniSession(bool bCreateIfNotFound);

  /// @brief Method GetOutputCacheDirectory, addr 0x3a5ece0, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetOutputCacheDirectory();

  /// @brief Method GetParentNodeID, addr 0x3a5c108, size 0x5c, virtual false, abstract: false, final false
  inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method Initialize, addr 0x3a5c3b4, size 0x1c, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method IsLoaded, addr 0x3a5c71c, size 0x24, virtual false, abstract: false, final false
  inline bool IsLoaded();

  /// @brief Method Log, addr 0x3a5c530, size 0xd8, virtual false, abstract: false, final false
  inline void Log(::StringW msg);

  static inline ::HoudiniEngineUnity::HEU_BaseSync* New_ctor();

  /// @brief Method OnDestroy, addr 0x3a5c084, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnLoadComplete, addr 0x3a5bd14, size 0x84, virtual true, abstract: false, final false
  inline void OnLoadComplete(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadData* loadData);

  /// @brief Method OnStopped, addr 0x3a5ec90, size 0x50, virtual false, abstract: false, final false
  inline void OnStopped(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadData* loadData);

  /// @brief Method Reset, addr 0x3a5cd5c, size 0xbc, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Resync, addr 0x3a5c8e0, size 0x3c, virtual true, abstract: false, final false
  inline void Resync();

  /// @brief Method SetOutputCacheDirectory, addr 0x3a605b8, size 0x8, virtual false, abstract: false, final false
  inline void SetOutputCacheDirectory(::StringW directory);

  /// @brief Method SetOutputVisiblity, addr 0x3a5ee94, size 0x1f4, virtual false, abstract: false, final false
  inline void SetOutputVisiblity(::HoudiniEngineUnity::HEU_LoadBufferBase* buffer);

  /// @brief Method SetupLoadTask, addr 0x3a5c868, size 0x4, virtual true, abstract: false, final false
  inline void SetupLoadTask(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method StartSync, addr 0x3a5c740, size 0x128, virtual true, abstract: false, final false
  inline void StartSync();

  /// @brief Method StopSync, addr 0x3a5c86c, size 0x74, virtual true, abstract: false, final false
  inline void StopSync();

  /// @brief Method SyncUpdate, addr 0x3a605c0, size 0x4, virtual true, abstract: false, final false
  inline void SyncUpdate();

  /// @brief Method Unload, addr 0x3a5ccc8, size 0x94, virtual true, abstract: false, final false
  inline void Unload();
  ...
  /// @brief Method .ctor, addr 0x3a5bdd4, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor();
