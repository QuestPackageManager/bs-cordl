...
public:
  ...
  /// @brief Method AddGeneratedOutputFilePath, addr 0x2493920, size 0xe4, virtual false, abstract: false, final false
  inline void AddGeneratedOutputFilePath(::StringW path);

  /// @brief Method ApplyAttributeModifiersOnGameObjectOutput, addr 0x2493a04, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Awake, addr 0x2490c4c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Bake, addr 0x24914e0, size 0x3a4, virtual true, abstract: false, final false
  inline void Bake();

  /// @brief Method ClearLog, addr 0x24911c0, size 0x104, virtual false, abstract: false, final false
  inline void ClearLog();

  /// @brief Method CreateNewInstanceFromObject, addr 0x2495008, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteSessionData, addr 0x2490c5c, size 0x78, virtual true, abstract: false, final false
  inline void DeleteSessionData();

  /// @brief Method DestroyGeneratedData, addr 0x2490d30, size 0x4, virtual true, abstract: false, final false
  inline void DestroyGeneratedData();

  /// @brief Method DestroyOutputs, addr 0x2490d34, size 0x23c, virtual false, abstract: false, final false
  inline void DestroyOutputs();

  /// @brief Method Error, addr 0x24912c4, size 0x1c, virtual false, abstract: false, final false
  inline void Error(::StringW error);

  /// @brief Method GenerateAllInstancers, addr 0x24937b8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateGeometry, addr 0x2491a64, size 0x108, virtual true, abstract: false, final false
  inline void GenerateGeometry(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData, int32_t objIndex);

  /// @brief Method GenerateInstancer, addr 0x2493c68, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromAssetPaths, addr 0x24946b8, size 0x950, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromNodeIDs, addr 0x2493f78, size 0x740, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x2491b6c, size 0x614, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateObjects, addr 0x24919d8, size 0x8c, virtual true, abstract: false, final false
  inline void GenerateObjects(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method GenerateTerrain, addr 0x2492180, size 0x1638, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHoudiniSession, addr 0x2490f8c, size 0x15c, virtual true, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetHoudiniSession(bool bCreateIfNotFound);

  /// @brief Method GetOutputCacheDirectory, addr 0x24938bc, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetOutputCacheDirectory();

  /// @brief Method GetParentNodeID, addr 0x2490cd4, size 0x5c, virtual false, abstract: false, final false
  inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method Initialize, addr 0x2490f70, size 0x1c, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method IsLoaded, addr 0x24912e0, size 0x24, virtual false, abstract: false, final false
  inline bool IsLoaded();

  /// @brief Method Log, addr 0x24910e8, size 0xd8, virtual false, abstract: false, final false
  inline void Log(::StringW msg);

  static inline ::HoudiniEngineUnity::HEU_BaseSync* New_ctor();

  /// @brief Method OnDestroy, addr 0x2490c50, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnLoadComplete, addr 0x24908b0, size 0x84, virtual true, abstract: false, final false
  inline void OnLoadComplete(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method OnStopped, addr 0x249386c, size 0x50, virtual false, abstract: false, final false
  inline void OnStopped(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method Reset, addr 0x2491918, size 0xc0, virtual true, abstract: false, final false
  inline void Reset();

  /// @brief Method Resync, addr 0x24914a4, size 0x3c, virtual true, abstract: false, final false
  inline void Resync();

  /// @brief Method SetOutputCacheDirectory, addr 0x24951c8, size 0x8, virtual false, abstract: false, final false
  inline void SetOutputCacheDirectory(::StringW directory);

  /// @brief Method SetOutputVisiblity, addr 0x2493a74, size 0x1f4, virtual false, abstract: false, final false
  inline void SetOutputVisiblity(::HoudiniEngineUnity::HEU_LoadBufferBase* buffer);

  /// @brief Method SetupLoadTask, addr 0x249142c, size 0x4, virtual true, abstract: false, final false
  inline void SetupLoadTask(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method StartSync, addr 0x2491304, size 0x128, virtual true, abstract: false, final false
  inline void StartSync();

  /// @brief Method StopSync, addr 0x2491430, size 0x74, virtual true, abstract: false, final false
  inline void StopSync();

  /// @brief Method SyncUpdate, addr 0x24951d0, size 0x4, virtual true, abstract: false, final false
  inline void SyncUpdate();

  /// @brief Method Unload, addr 0x2491884, size 0x94, virtual true, abstract: false, final false
  inline void Unload();
  ...
  /// @brief Method .ctor, addr 0x2490970, size 0x170, virtual false, abstract: false, final false
  inline void _ctor();
