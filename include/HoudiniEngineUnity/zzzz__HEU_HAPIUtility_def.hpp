...
public:
  // Declarations
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnity, addr 0x2469e68, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnityForInstance, addr 0x2469f7c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyMatrixToLocalTransform, addr 0x246a144, size 0x60, virtual false, abstract: false, final false
  static inline void ApplyMatrixToLocalTransform(ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Transform* transform);

  /// @brief Method ApplyWorldTransfromFromHoudiniToUnity, addr 0x2469c80, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudini, addr 0x2468dc0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudiniWithOptions, addr 0x2469130, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookAssetNode, addr 0x2468a34, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookCurveAsset, addr 0x2468e18, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookInputAsset, addr 0x2468f04, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewAsset, addr 0x2469250, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewCurveAsset, addr 0x2469600, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInputAsset, addr 0x2469624, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyChildren, addr 0x2469650, size 0x47c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGameObject, addr 0x2469acc, size 0x10, virtual false, abstract: false, final false
  static inline void DestroyGameObject(::UnityEngine::GameObject* gameObect, bool bRegisterUndo);

  /// @brief Method DoesGeoPartHaveAttribute, addr 0x246b094, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method DoesMappedPathExist, addr 0x2467d10, size 0x9c, virtual false, abstract: false, final false
  static inline bool DoesMappedPathExist(::StringW inPath);

  /// @brief Method FindHoudiniAssetFileInPathWithExt, addr 0x24681ac, size 0x284, virtual false, abstract: false, final false
  static inline ::StringW FindHoudiniAssetFileInPathWithExt(::StringW filePath);

  /// @brief Method GetAssetInScene, addr 0x2469b7c, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAssetRoot> GetAssetInScene(int32_t assetID);

  /// @brief Method GetDefaultCookOptions, addr 0x24691ac, size 0x44, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_CookOptions GetDefaultCookOptions(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetEnvironmentPath, addr 0x2467b14, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW GetEnvironmentPath();

  /// @brief Method GetHAPITransform, addr 0x246a924, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHAPITransformFromMatrix, addr 0x246a708, size 0x178, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_TransformEuler GetHAPITransformFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetHAPITransformQuatFromMatrix, addr 0x246aa48, size 0x1b4, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_Transform GetHAPITransformQuatFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetHoudiniEngineInstallationInfo, addr 0x2467ad4, size 0x40, virtual false, abstract: false, final false
  static inline ::StringW GetHoudiniEngineInstallationInfo();

  /// @brief Method GetMatrix4x4, addr 0x246aca8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrixFromHAPITransform, addr 0x246a574, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectInfos, addr 0x246b15c, size 0x4b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentNodeID, addr 0x246b0f4, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method GetPosition, addr 0x246a1a4, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetPosition(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetQuaternion, addr 0x246a1b0, size 0x360, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion GetQuaternion(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetRealPathFromHFSPath, addr 0x2467b5c, size 0x160, virtual false, abstract: false, final false
  static inline ::StringW GetRealPathFromHFSPath(::StringW inPath);

  /// @brief Method GetScale, addr 0x246a510, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetScale(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method InstantiateHDA, addr 0x24684c4, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEqualTol, addr 0x246add0, size 0x10, virtual false, abstract: false, final false
  static inline bool IsEqualTol(float_t a, float_t b, float_t t);

  /// @brief Method IsHoudiniAssetFile, addr 0x2468068, size 0x144, virtual false, abstract: false, final false
  static inline bool IsHoudiniAssetFile(::StringW filePath);

  /// @brief Method IsNodeValidInHoudini, addr 0x2469adc, size 0xa0, virtual false, abstract: false, final false
  static inline bool IsNodeValidInHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method IsSameTransform, addr 0x246ad6c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSessionSyncEqual, addr 0x246b068, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSupportedPolygonType, addr 0x246b0d8, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsSupportedPolygonType(::HoudiniEngineUnity::HAPI_PartType partType);

  /// @brief Method IsTransformEqual, addr 0x246ade0, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewportEqual, addr 0x246af80, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadGeoWithNewGeoSync, addr 0x2469648, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> LoadGeoWithNewGeoSync(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method LoadHDAFile, addr 0x2468814, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method LocateValidFilePath, addr 0x24684bc, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::StringW assetName, ::StringW inFilePath);

  /// @brief Method LocateValidFilePath, addr 0x2468450, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::UnityEngine::Object* inObject);

  /// @brief Method Log, addr 0x2468438, size 0x8, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x2468448, size 0x8, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogWarning, addr 0x2468440, size 0x8, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method ProcessHoudiniCookStatus, addr 0x2468bec, size 0x1d4, virtual false, abstract: false, final false
  static inline bool ProcessHoudiniCookStatus(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW assetName);

  /// @brief Method SetAnimationCurveTangentModes, addr 0x246b0d4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMatrixPosition, addr 0x246a6f0, size 0x18, virtual false, abstract: false, final false
