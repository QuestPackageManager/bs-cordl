...
public:
  // Declarations
  /// @brief Method GetHoudiniEngineInstallationInfo, addr 0x221a148, size 0x40, virtual false, abstract: false, final false
  static inline ::StringW GetHoudiniEngineInstallationInfo();

  /// @brief Method GetEnvironmentPath, addr 0x221a188, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW GetEnvironmentPath();

  /// @brief Method GetRealPathFromHFSPath, addr 0x221a1d0, size 0x160, virtual false, abstract: false, final false
  static inline ::StringW GetRealPathFromHFSPath(::StringW inPath);

  /// @brief Method DoesMappedPathExist, addr 0x221a384, size 0x9c, virtual false, abstract: false, final false
  static inline bool DoesMappedPathExist(::StringW inPath);

  /// @brief Method IsHoudiniAssetFile, addr 0x221a6dc, size 0x144, virtual false, abstract: false, final false
  static inline bool IsHoudiniAssetFile(::StringW filePath);

  /// @brief Method FindHoudiniAssetFileInPathWithExt, addr 0x221a820, size 0x284, virtual false, abstract: false, final false
  static inline ::StringW FindHoudiniAssetFileInPathWithExt(::StringW filePath);

  /// @brief Method Log, addr 0x221aaac, size 0x8, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogWarning, addr 0x221aab4, size 0x8, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method LogError, addr 0x221aabc, size 0x8, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LocateValidFilePath, addr 0x221aac4, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::UnityEngine::Object* inObject);

  /// @brief Method LocateValidFilePath, addr 0x221ab30, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::StringW assetName, ::StringW inFilePath);

  /// @brief Method InstantiateHDA, addr 0x221ab38, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadHDAFile, addr 0x221ae88, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookAssetNode, addr 0x221b0a8, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookCurveAsset, addr 0x221b48c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookInputAsset, addr 0x221b578, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudini, addr 0x221b434, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudiniWithOptions, addr 0x221b7a4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultCookOptions, addr 0x221b820, size 0x44, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_CookOptions GetDefaultCookOptions(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method ProcessHoudiniCookStatus, addr 0x221b260, size 0x1d4, virtual false, abstract: false, final false
  static inline bool ProcessHoudiniCookStatus(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW assetName);

  /// @brief Method CreateNewAsset, addr 0x221b8c4, size 0x3b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewCurveAsset, addr 0x221bc74, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInputAsset, addr 0x221bc98, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadGeoWithNewGeoSync, addr 0x221bcbc, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> LoadGeoWithNewGeoSync(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DestroyChildren, addr 0x221bcc4, size 0x47c, virtual false, abstract: false, final false
  static inline void DestroyChildren(::UnityEngine::Transform* inTransform);

  /// @brief Method DestroyGameObject, addr 0x221c140, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNodeValidInHoudini, addr 0x221c150, size 0xa0, virtual false, abstract: false, final false
  static inline bool IsNodeValidInHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method GetAssetInScene, addr 0x221c1f0, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAssetRoot> GetAssetInScene(int32_t assetID);

  /// @brief Method ApplyWorldTransfromFromHoudiniToUnity, addr 0x221c2f4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnity, addr 0x221c4dc, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnityForInstance, addr 0x221c5f0, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyMatrixToLocalTransform, addr 0x221c7b8, size 0x60, virtual false, abstract: false, final false
  static inline void ApplyMatrixToLocalTransform(ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Transform* transform);

  /// @brief Method GetMatrixFromHAPITransform, addr 0x221cbe8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQuaternion, addr 0x221c824, size 0x360, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion GetQuaternion(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetPosition, addr 0x221c818, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetPosition(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method SetMatrixPosition, addr 0x221cd64, size 0x18, virtual false, abstract: false, final false
  static inline void SetMatrixPosition(ByRef<::UnityEngine::Matrix4x4> m, ByRef<::UnityEngine::Vector3> position);

  /// @brief Method GetScale, addr 0x221cb84, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetScale(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetHAPITransformFromMatrix, addr 0x221cd7c, size 0x178, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_TransformEuler GetHAPITransformFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetHAPITransform, addr 0x221cf98, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHAPITransformQuatFromMatrix, addr 0x221d0bc, size 0x1b4, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_Transform GetHAPITransformQuatFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetMatrix4x4, addr 0x221d31c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSameTransform, addr 0x221d3e0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEqualTol, addr 0x221d444, size 0x10, virtual false, abstract: false, final false
  static inline bool IsEqualTol(float_t a, float_t b, float_t t);

  /// @brief Method IsTransformEqual, addr 0x221d454, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewportEqual, addr 0x221d5f4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSessionSyncEqual, addr 0x221d6dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method DoesGeoPartHaveAttribute, addr 0x221d708, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAnimationCurveTangentModes, addr 0x221d748, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSupportedPolygonType, addr 0x221d74c, size 0x1c, virtual false, abstract: false, final false
  static inline bool IsSupportedPolygonType(::HoudiniEngineUnity::HAPI_PartType partType);

  /// @brief Method GetParentNodeID, addr 0x221d768, size 0x68, virtual false, abstract: false, final false
  static inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method GetObjectInfos, addr 0x221d7d0, size 0x4b8, virtual false, abstract: false, final false
