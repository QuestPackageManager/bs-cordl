...
public:
  // Declarations
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnity, addr 0x39d46b8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyLocalTransfromFromHoudiniToUnityForInstance, addr 0x39d47cc, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyMatrixToLocalTransform, addr 0x39d4994, size 0x60, virtual false, abstract: false, final false
  static inline void ApplyMatrixToLocalTransform(ByRef<::UnityEngine::Matrix4x4> matrix, ::UnityEngine::Transform* transform);

  /// @brief Method ApplyWorldTransfromFromHoudiniToUnity, addr 0x39d44d0, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudini, addr 0x39d360c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method CookNodeInHoudiniWithOptions, addr 0x39d398c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookAssetNode, addr 0x39d328c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookCurveAsset, addr 0x39d3664, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndCookInputAsset, addr 0x39d3750, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewAsset, addr 0x39d3aac, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewCurveAsset, addr 0x39d3e58, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInputAsset, addr 0x39d3e7c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyChildren, addr 0x39d3ea8, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGameObject, addr 0x39d4328, size 0x10, virtual false, abstract: false, final false
  static inline void DestroyGameObject(::UnityEngine::GameObject* gameObect, bool bRegisterUndo);

  /// @brief Method DoesGeoPartHaveAttribute, addr 0x39d58f8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method DoesMappedPathExist, addr 0x39d2640, size 0x9c, virtual false, abstract: false, final false
  static inline bool DoesMappedPathExist(::StringW inPath);

  /// @brief Method FindHoudiniAssetFileInPathWithExt, addr 0x39d2ae4, size 0x1c4, virtual false, abstract: false, final false
  static inline ::StringW FindHoudiniAssetFileInPathWithExt(::StringW filePath);

  /// @brief Method GetAssetInScene, addr 0x39d43cc, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAssetRoot> GetAssetInScene(int32_t assetID);

  /// @brief Method GetDefaultCookOptions, addr 0x39d3a08, size 0x44, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_CookOptions GetDefaultCookOptions(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetEnvironmentPath, addr 0x39d2444, size 0x48, virtual false, abstract: false, final false
  static inline ::StringW GetEnvironmentPath();

  /// @brief Method GetHAPITransform, addr 0x39d5190, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHAPITransformFromMatrix, addr 0x39d4f74, size 0x178, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_TransformEuler GetHAPITransformFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetHAPITransformQuatFromMatrix, addr 0x39d52b4, size 0x1b4, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HAPI_Transform GetHAPITransformQuatFromMatrix(ByRef<::UnityEngine::Matrix4x4> mat);

  /// @brief Method GetHoudiniEngineInstallationInfo, addr 0x39d2404, size 0x40, virtual false, abstract: false, final false
  static inline ::StringW GetHoudiniEngineInstallationInfo();

  /// @brief Method GetMatrix4x4, addr 0x39d5514, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatrixFromHAPITransform, addr 0x39d4de0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetObjectInfos, addr 0x39d59b8, size 0x4b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetParentNodeID, addr 0x39d595c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method GetPosition, addr 0x39d49f4, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetPosition(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetQuaternion, addr 0x39d4a00, size 0x37c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion GetQuaternion(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method GetRealPathFromHFSPath, addr 0x39d248c, size 0x160, virtual false, abstract: false, final false
  static inline ::StringW GetRealPathFromHFSPath(::StringW inPath);

  /// @brief Method GetScale, addr 0x39d4d7c, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetScale(ByRef<::UnityEngine::Matrix4x4> m);

  /// @brief Method InstantiateHDA, addr 0x39d2d3c, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEqualTol, addr 0x39d5634, size 0x10, virtual false, abstract: false, final false
  static inline bool IsEqualTol(float_t a, float_t b, float_t t);

  /// @brief Method IsHoudiniAssetFile, addr 0x39d29a0, size 0x144, virtual false, abstract: false, final false
  static inline bool IsHoudiniAssetFile(::StringW filePath);

  /// @brief Method IsNodeValidInHoudini, addr 0x39d4338, size 0x94, virtual false, abstract: false, final false
  static inline bool IsNodeValidInHoudini(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t nodeID);

  /// @brief Method IsSameTransform, addr 0x39d55d8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSessionSyncEqual, addr 0x39d58cc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsSupportedPolygonType, addr 0x39d593c, size 0x20, virtual false, abstract: false, final false
  static inline bool IsSupportedPolygonType(::HoudiniEngineUnity::HAPI_PartType partType);

  /// @brief Method IsTransformEqual, addr 0x39d5644, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewportEqual, addr 0x39d57e4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadGeoWithNewGeoSync, addr 0x39d3ea0, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> LoadGeoWithNewGeoSync(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method LoadHDAFile, addr 0x39d3094, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method LocateValidFilePath, addr 0x39d2d34, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::StringW assetName, ::StringW inFilePath);

  /// @brief Method LocateValidFilePath, addr 0x39d2cc8, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW LocateValidFilePath(::UnityEngine::Object* inObject);

  /// @brief Method Log, addr 0x39d2cb0, size 0x8, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x39d2cc0, size 0x8, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogWarning, addr 0x39d2cb8, size 0x8, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method ProcessHoudiniCookStatus, addr 0x39d3444, size 0x1c8, virtual false, abstract: false, final false
  static inline bool ProcessHoudiniCookStatus(::HoudiniEngineUnity::HEU_SessionBase* session, ::StringW assetName);

  /// @brief Method SetAnimationCurveTangentModes, addr 0x39d5938, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMatrixPosition, addr 0x39d4f5c, size 0x18, virtual false, abstract: false, final false
