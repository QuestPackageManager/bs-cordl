...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a2d430, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a2d3fc, size 0x34, virtual false, abstract: false, final false
