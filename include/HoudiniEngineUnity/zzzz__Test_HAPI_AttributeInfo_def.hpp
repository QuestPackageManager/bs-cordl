...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a971e0, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a971ac, size 0x34, virtual false, abstract: false, final false
