...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x23454b0, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x234547c, size 0x34, virtual false, abstract: false, final false
