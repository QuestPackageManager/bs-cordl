...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9c6e8, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9c6b4, size 0x34, virtual false, abstract: false, final false
