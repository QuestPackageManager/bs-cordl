...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9226c, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a92238, size 0x34, virtual false, abstract: false, final false
