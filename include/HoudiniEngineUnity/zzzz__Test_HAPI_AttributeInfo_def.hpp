...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25f3654, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25f3620, size 0x34, virtual false, abstract: false, final false
