...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25df3a0, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25df36c, size 0x34, virtual false, abstract: false, final false
