...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x23a6288, size 0xec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23a6254, size 0x34, virtual false, abstract: false, final false
