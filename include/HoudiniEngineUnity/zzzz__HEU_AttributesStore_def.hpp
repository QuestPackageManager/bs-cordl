...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x246db58, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x246dc38, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x246db44, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246da6c, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAttributeValueFloat, addr 0x246cae0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAttributeValueInt, addr 0x246c4e8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method AreAttributesDirty, addr 0x246d060, size 0x174, virtual false, abstract: false, final false
  inline bool AreAttributesDirty();

  /// @brief Method CopyAttributeValuesTo, addr 0x246d1ec, size 0x1d8, virtual false, abstract: false, final false
  inline void CopyAttributeValuesTo(::HoudiniEngineUnity::HEU_AttributesStore* destAttrStore);

  /// @brief Method CreateAttribute, addr 0x246a0b4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllData, addr 0x2468bd0, size 0xcc, virtual false, abstract: false, final false
  inline void DestroyAllData(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method DisablePaintCollider, addr 0x246bd00, size 0x118, virtual false, abstract: false, final false
  inline void DisablePaintCollider();

  /// @brief Method EnablePaintCollider, addr 0x246bb5c, size 0x1a4, virtual false, abstract: false, final false
  inline void EnablePaintCollider();

  /// @brief Method FillAttribute, addr 0x246cdb4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeData, addr 0x246b8d4, size 0x84, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_AttributeData* GetAttributeData(int32_t index);

  /// @brief Method GetAttributeData, addr 0x2469f24, size 0x190, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_AttributeData* GetAttributeData(::StringW name);

  /// @brief Method GetAttributeNames, addr 0x246b958, size 0x204, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* GetAttributeNames();

  /// @brief Method GetAttributeSetValueFunction, addr 0x246ce54, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributesList, addr 0x246afc8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPaintMeshCollider, addr 0x246c084, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::MeshCollider> GetPaintMeshCollider();

  /// @brief Method GetPositionAttributeValues, addr 0x246d1d4, size 0xc, virtual false, abstract: false, final false
  inline void GetPositionAttributeValues(ByRef<::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*>> positionArray);

  /// @brief Method GetVertexIndices, addr 0x246d1e0, size 0xc, virtual false, abstract: false, final false
  inline void GetVertexIndices(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> indices);

  /// @brief Method HasColorAttribute, addr 0x2469f0c, size 0x8, virtual false, abstract: false, final false
  inline bool HasColorAttribute();

  /// @brief Method HasDirtyAttributes, addr 0x246a8c4, size 0x184, virtual false, abstract: false, final false
  inline bool HasDirtyAttributes();

  /// @brief Method HasMeshForPainting, addr 0x246c024, size 0x60, virtual false, abstract: false, final false
  inline bool HasMeshForPainting();

  /// @brief Method HidePaintMesh, addr 0x246bf3c, size 0xe8, virtual false, abstract: false, final false
  inline void HidePaintMesh();

  /// @brief Method IsEquivalentTo, addr 0x246d428, size 0x578, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_AttributesStore* other);

  /// @brief Method IsValidStore, addr 0x246d3c4, size 0x64, virtual false, abstract: false, final false
  inline bool IsValidStore(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method MultiplyAttributeValueFloat, addr 0x246cc20, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyAttributeValueInt, addr 0x246c850, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method PaintAttribute, addr 0x246c0fc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateAttributeData, addr 0x246a168, size 0x75c, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshUpstreamInputs, addr 0x246b840, size 0x78, virtual false, abstract: false, final false
  inline void RefreshUpstreamInputs(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method ReplaceAttributeValueFloat, addr 0x246ca38, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceAttributeValueInt, addr 0x246c304, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeDataDirty, addr 0x246b8b8, size 0x1c, virtual false, abstract: false, final false
  static inline void SetAttributeDataDirty(::HoudiniEngineUnity::HEU_AttributeData* attributeData);

  /// @brief Method SetAttributeDataSyncd, addr 0x246afac, size 0x1c, virtual false, abstract: false, final false
  static inline void SetAttributeDataSyncd(::HoudiniEngineUnity::HEU_AttributeData* attributeData);

  /// @brief Method SetAttributeEditValueFloat, addr 0x246c1bc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeEditValueInt, addr 0x246c150, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeEditValueString, addr 0x246c228, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttributeValueString, addr 0x246ccd8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupMeshAndMaterials, addr 0x246882c, size 0x3a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowPaintMesh, addr 0x246be18, size 0x124, virtual false, abstract: false, final false
  inline void ShowPaintMesh();

  /// @brief Method SubtractAttributeValueFloat, addr 0x246cb80, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method SubtractAttributeValueInt, addr 0x246c69c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncAllAttributesFrom, addr 0x2468194, size 0x698, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncDirtyAttributesToHoudini, addr 0x246aa48, size 0x6c, virtual false, abstract: false, final false
  inline void SyncDirtyAttributesToHoudini(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UpdateAttribute, addr 0x246b230, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateAttributeList, addr 0x246b6ec, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadAttributeViaMeshInput, addr 0x246aab4, size 0x4f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246d9a0, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeoID, addr 0x2469ef4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_GeoID();

  /// @brief Method get_GeoName, addr 0x2469f04, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GeoName();

  /// @brief Method get_OutputMesh, addr 0x2469f1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_OutputMesh();

  /// @brief Method get_OutputTransform, addr 0x2469f14, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_OutputTransform();

  /// @brief Method get_PartID, addr 0x2469efc, size 0x8, virtual false, abstract: false, final false
