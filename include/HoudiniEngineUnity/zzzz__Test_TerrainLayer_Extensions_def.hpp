...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x3a967a8, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TerrainLayer* _ToTestObject_b__1_0(::UnityEngine::TerrainLayer* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3a96804, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_TerrainLayer* _ToTestObject_b__2_0(::UnityEngine::TerrainLayer* lod);

  /// @brief Method .ctor, addr 0x3a967a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x3a9655c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3a96500, size 0x5c, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_TerrainLayer* ToTestObject(::UnityEngine::TerrainLayer* self);

  /// @brief Method ToTestObject, addr 0x3a9664c, size 0xf8, virtual false, abstract: false, final false
