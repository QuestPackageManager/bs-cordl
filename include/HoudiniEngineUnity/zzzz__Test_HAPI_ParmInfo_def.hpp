...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25c7914, size 0x78c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25c78e0, size 0x34, virtual false, abstract: false, final false
