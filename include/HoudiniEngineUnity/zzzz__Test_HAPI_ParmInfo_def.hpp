...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x23a6740, size 0x78c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23a670c, size 0x34, virtual false, abstract: false, final false
