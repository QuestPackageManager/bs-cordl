...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a92714, size 0x78c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a926e0, size 0x34, virtual false, abstract: false, final false
