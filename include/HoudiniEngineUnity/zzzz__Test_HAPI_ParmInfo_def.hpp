...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9cb90, size 0x78c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9cb5c, size 0x34, virtual false, abstract: false, final false
