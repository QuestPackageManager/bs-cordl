...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9075))]
...
public:
  ...
  /// @brief Method CalculateIndexFormat, addr 0x2265a8c, size 0x78, virtual false, abstract: false, final false
  inline void CalculateIndexFormat(int32_t numVertices);

  /// @brief Method SetFormatForMesh, addr 0x2265b04, size 0x24, virtual false, abstract: false, final false
  inline void SetFormatForMesh(::UnityEngine::Mesh* mesh);

  static inline ::HoudiniEngineUnity::HEU_MeshIndexFormat* New_ctor();

  /// @brief Method .ctor, addr 0x2265b28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
