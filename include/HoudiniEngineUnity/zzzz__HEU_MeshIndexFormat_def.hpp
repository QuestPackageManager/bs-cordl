...
public:
  ...
  /// @brief Method CalculateIndexFormat, addr 0x3a84dbc, size 0x78, virtual false, abstract: false, final false
  inline void CalculateIndexFormat(int32_t numVertices);

  static inline ::HoudiniEngineUnity::HEU_MeshIndexFormat* New_ctor();

  /// @brief Method SetFormatForMesh, addr 0x3a84e34, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a84e58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
