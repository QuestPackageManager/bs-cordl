...
public:
  ...
  /// @brief Method .ctor addr 0x21e422c size 0x28 virtual false final false
  inline void _ctor(::UnityEngine::LODGroup* self);

  /// @brief Method IsNull addr 0x21e4254 size 0x60 virtual true final true
  inline bool IsNull();

  /// @brief Method IsEquivalentTo addr 0x21e42b4 size 0x28c virtual true final true
