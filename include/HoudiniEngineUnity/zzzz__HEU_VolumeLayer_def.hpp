...
// Dependencies HoudiniEngineUnity.HFLayerType, HoudiniEngineUnity.IEquivable`1<T>, System.Object
namespace HoudiniEngineUnity {
// Is value type: false
...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9d424, size 0x370, virtual true, abstract: false, final true
  ...
  constexpr ::HoudiniEngineUnity::HEU_DetailPrototype* const& __cordl_internal_get__detailPrototype() const;
  ...
  /// @brief Method .ctor, addr 0x3a9d794, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
