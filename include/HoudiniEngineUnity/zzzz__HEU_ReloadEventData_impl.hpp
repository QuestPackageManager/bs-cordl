...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_ReloadEventData::*)(
    ::HoudiniEngineUnity::HEU_HoudiniAsset*, bool, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*)>(&::HoudiniEngineUnity::HEU_ReloadEventData::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x214e28c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_ReloadEventData*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
inline ::HoudiniEngineUnity::HEU_ReloadEventData* HoudiniEngineUnity::HEU_ReloadEventData::New_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset* asset, bool successful,
  ...
  return THROW_UNLESS(::il2cpp_utils::New<::HoudiniEngineUnity::HEU_ReloadEventData*>(asset, successful, outputObjects));
}
