...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a48b18, size 0xe0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a3fa30, size 0xac, virtual false, abstract: false, final false
