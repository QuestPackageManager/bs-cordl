...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a562b8, size 0xe0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a4d1d0, size 0xac, virtual false, abstract: false, final false
