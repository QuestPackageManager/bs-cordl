...
public:
  // Declarations
  /// @brief Method Init, addr 0x23546f4, size 0xe0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x234b6b0, size 0xac, virtual false, abstract: false, final false
