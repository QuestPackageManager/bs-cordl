...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a4338c, size 0xe0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a3a2a4, size 0xac, virtual false, abstract: false, final false
