...
public:
  // Declarations
  /// @brief Method Init, addr 0x2473c40, size 0xe0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x246abfc, size 0xac, virtual false, abstract: false, final false
