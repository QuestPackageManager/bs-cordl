...
public:
  ...
  /// @brief Method GetNewModifier, addr 0x3a492cc, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a49358, size 0x28c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a49350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
