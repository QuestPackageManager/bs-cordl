...
public:
  // Declarations
  /// @brief Method SetMeshDetailAttribute, addr 0x3a87ba4, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMeshPointAttribute, addr 0x3a87a18, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMeshPointAttribute, addr 0x3a87578, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMeshPointAttribute, addr 0x3a877e8, size 0x230, virtual false, abstract: false, final false
  static inline bool SetMeshPointAttribute(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t geoID, int32_t partID, ::StringW attrName, int32_t tupleSize,
                                           ::ArrayW<::UnityEngine::Vector3Int, ::Array<::UnityEngine::Vector3Int>*> data, ::ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetMeshPointAttribute, addr 0x3a87d9c, size 0x1e4, virtual false, abstract: false, final false
  static inline bool SetMeshPointAttribute(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t geoID, int32_t partID, ::StringW attrName, int32_t tupleSize,
                                           ::ArrayW<float_t, ::Array<float_t>*> data, ::ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetMeshVertexAttribute, addr 0x3a87f88, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMeshVertexFloatAttribute, addr 0x3a88214, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadMeshIntoHoudiniNode, addr 0x3a88424, size 0x64c, virtual false, abstract: false, final false
