...
public:
  // Declarations
  /// @brief Method SetMeshPointAttribute addr 0x2075994 size 0x28c virtual false final false
  ...
  /// @brief Method SetMeshPointAttribute addr 0x2076294 size 0x1e8 virtual false final false
  static inline bool SetMeshPointAttribute(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t geoID, int32_t partID, ::StringW attrName, int32_t tupleSize,
                                           ::ArrayW<float_t, ::Array<float_t>*> data, ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetMeshVertexAttribute addr 0x2076484 size 0x2a8 virtual false final false
  ...
  /// @brief Method SetMeshVertexFloatAttribute addr 0x207672c size 0x214 virtual false final false
  ...
  /// @brief Method UploadMeshIntoHoudiniNode addr 0x2076940 size 0x65c virtual false final false
  ...
  /// @brief Method SetMeshPointAttribute addr 0x2075c20 size 0x2dc virtual false final false
  static inline bool SetMeshPointAttribute(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t geoID, int32_t partID, ::StringW attrName, int32_t tupleSize,
                                           ::ArrayW<::UnityEngine::Vector3Int, ::Array<::UnityEngine::Vector3Int>*> data, ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetMeshPointAttribute addr 0x2075efc size 0x198 virtual false final false
  ...
  /// @brief Method SetMeshDetailAttribute addr 0x2076094 size 0x200 virtual false final false
