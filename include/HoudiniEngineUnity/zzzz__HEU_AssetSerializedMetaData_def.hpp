...
public:
  ...
  /// @brief Method .ctor, addr 0x3a08dec, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SavedCurveNodeData, addr 0x3a08d28, size 0x8, virtual false, abstract: false, final false
