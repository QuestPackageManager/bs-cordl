...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a08518, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a085d4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SavedCurveNodeData, addr 0x3a08510, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SoftDeleted, addr 0x3a084fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_SoftDeleted, addr 0x3a08504, size 0xc, virtual false, abstract: false, final false
