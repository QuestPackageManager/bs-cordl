...
public:
  ...
  /// @brief Method AddInputEntryAtEnd, addr 0x245071c, size 0x8c, virtual false, abstract: false, final false
  inline void AddInputEntryAtEnd(::UnityEngine::GameObject* newEntryGameObject);

  /// @brief Method AddInputEntryAtEndMesh, addr 0x2450918, size 0x2c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_InputObjectInfo* AddInputEntryAtEndMesh(::UnityEngine::GameObject* newEntryGameObject);

  /// @brief Method AreAnyInputHDAsConnected, addr 0x24509c8, size 0x1b4, virtual false, abstract: false, final false
  inline bool AreAnyInputHDAsConnected();

  /// @brief Method ChangeInputType, addr 0x2450160, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearConnectedInputHDAs, addr 0x2450d90, size 0x1b8, virtual false, abstract: false, final false
  inline void ClearConnectedInputHDAs();

  /// @brief Method ClearUICache, addr 0x244fcf8, size 0x8, virtual false, abstract: false, final false
  inline void ClearUICache();

  /// @brief Method ConnectToMergeObject, addr 0x2451aa0, size 0x180, virtual false, abstract: false, final false
  inline void ConnectToMergeObject(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method CopyInputValuesTo, addr 0x24529c0, size 0x444, virtual false, abstract: false, final false
  inline void CopyInputValuesTo(::HoudiniEngineUnity::HEU_SessionBase* session, ::HoudiniEngineUnity::HEU_InputNode* destInputNode);

  /// @brief Method CreateInputHDAInfo, addr 0x2450470, size 0x70, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_InputHDAInfo* CreateInputHDAInfo(::UnityEngine::GameObject* inputGameObject);

  /// @brief Method CreateInputObjectInfo, addr 0x2450408, size 0x68, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_InputObjectInfo* CreateInputObjectInfo(::UnityEngine::GameObject* inputGameObject);

  /// @brief Method CreateSetupInput, addr 0x244fc44, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllData, addr 0x244fcdc, size 0x1c, virtual false, abstract: false, final false
  inline void DestroyAllData(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DisconnectAndDestroyInputs, addr 0x244fd00, size 0x230, virtual false, abstract: false, final false
  inline void DisconnectAndDestroyInputs(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method DisconnectConnectedMergeNode, addr 0x2450b7c, size 0x214, virtual false, abstract: false, final false
  inline void DisconnectConnectedMergeNode(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method FindAddToInputHDA, addr 0x24538d8, size 0x158, virtual false, abstract: false, final false
  inline bool FindAddToInputHDA(::StringW gameObjectName);

  /// @brief Method GetConnectedInputCount, addr 0x2452314, size 0x84, virtual false, abstract: false, final false
  inline int32_t GetConnectedInputCount();

  /// @brief Method GetConnectedNodeID, addr 0x2452398, size 0xd8, virtual false, abstract: false, final false
  inline int32_t GetConnectedNodeID(int32_t index);

  /// @brief Method GetInputEntryGameObject, addr 0x24504e0, size 0x23c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> GetInputEntryGameObject(int32_t index);

  /// @brief Method GetInternalObjectType, addr 0x24503e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectedObjectsForInputHDAs, addr 0x2453bd4, size 0x11c, virtual false, abstract: false, final false
  inline void HandleSelectedObjectsForInputHDAs(::ArrayW<::UnityEngine::GameObject*, ::Array<::UnityEngine::GameObject*>*> selectedObjects);

  /// @brief Method HandleSelectedObjectsForInputObjects, addr 0x2453ab8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasInputNodeTransformChanged, addr 0x2452470, size 0x25c, virtual false, abstract: false, final false
  inline bool HasInputNodeTransformChanged();

  /// @brief Method InsertInputEntry, addr 0x2450190, size 0x258, virtual false, abstract: false, final false
  inline void InsertInputEntry(int32_t index, ::UnityEngine::GameObject* newInputGameObject);

  /// @brief Method InternalAddInputHDAAtEnd, addr 0x2450860, size 0xb8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_InputHDAInfo* InternalAddInputHDAAtEnd(::UnityEngine::GameObject* newInputHDA);

  /// @brief Method InternalAddInputObjectAtEnd, addr 0x24507a8, size 0xb8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_InputObjectInfo* InternalAddInputObjectAtEnd(::UnityEngine::GameObject* newInputGameObject);

  /// @brief Method IsAssetInput, addr 0x244fc2c, size 0x10, virtual false, abstract: false, final false
  inline bool IsAssetInput();

  /// @brief Method IsEquivalentTo, addr 0x2453cf0, size 0x414, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_InputNode* other);

  /// @brief Method LoadPreset, addr 0x24533b4, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyParentRemovedInput, addr 0x2453a30, size 0x88, virtual false, abstract: false, final false
  inline void NotifyParentRemovedInput();

  /// @brief Method NumInputEntries, addr 0x2450944, size 0x84, virtual false, abstract: false, final false
  inline int32_t NumInputEntries();

  /// @brief Method PopulateInputPreset, addr 0x2452e28, size 0x58c, virtual false, abstract: false, final false
  inline void PopulateInputPreset(::HoudiniEngineUnity::HEU_InputPreset* inputPreset);

  /// @brief Method ReconnectToUpstreamAsset, addr 0x2451fa4, size 0x274, virtual false, abstract: false, final false
  inline void ReconnectToUpstreamAsset();

  /// @brief Method RemoveAllInputEntries, addr 0x244ff30, size 0xa8, virtual false, abstract: false, final false
  inline void RemoveAllInputEntries();

  /// @brief Method ResetConnectionForForceUpdate, addr 0x2450110, size 0x50, virtual false, abstract: false, final false
  inline void ResetConnectionForForceUpdate(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method ResetInputNode, addr 0x24500c4, size 0x4c, virtual false, abstract: false, final false
  inline void ResetInputNode(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method ResetInputObjectTransforms, addr 0x244ffd8, size 0xec, virtual false, abstract: false, final false
  inline void ResetInputObjectTransforms();

  /// @brief Method SetInputNodeID, addr 0x244fcd4, size 0x8, virtual false, abstract: false, final false
  inline void SetInputNodeID(int32_t nodeID);

  /// @brief Method UpdateOnAssetRecreation, addr 0x2452854, size 0x16c, virtual false, abstract: false, final false
  inline void UpdateOnAssetRecreation(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadHDAInput, addr 0x2451344, size 0x1c0, virtual false, abstract: false, final false
  inline void UploadHDAInput(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadInput, addr 0x2450f48, size 0x3fc, virtual false, abstract: false, final false
  inline void UploadInput(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadInputObjectTransforms, addr 0x24526cc, size 0x188, virtual false, abstract: false, final false
  inline void UploadInputObjectTransforms(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadObjectMergePackGeometry, addr 0x2451d34, size 0x114, virtual false, abstract: false, final false
  inline bool UploadObjectMergePackGeometry(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadObjectMergeTransformType, addr 0x2451c20, size 0x114, virtual false, abstract: false, final false
  inline bool UploadObjectMergeTransformType(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method UploadUnityInput, addr 0x2451504, size 0x59c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2454104, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_InputName, addr 0x244fbdc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_InputName();

  /// @brief Method get_InputNodeID, addr 0x244fbac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_InputNodeID();

  /// @brief Method get_InputObjects, addr 0x244fba4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputObjectInfo*>* get_InputObjects();

  /// @brief Method get_InputType, addr 0x244fb84, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::__HEU_InputNode__InputNodeType get_InputType();

  /// @brief Method get_KeepWorldTransform, addr 0x244fbfc, size 0x8, virtual false, abstract: false, final false
  inline bool get_KeepWorldTransform();

  /// @brief Method get_LabelName, addr 0x244fbe4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LabelName();

  /// @brief Method get_PackGeometryBeforeMerging, addr 0x244fc10, size 0x8, virtual false, abstract: false, final false
  inline bool get_PackGeometryBeforeMerging();

  /// @brief Method get_ParamName, addr 0x244fbec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ParamName();

  /// @brief Method get_ParentAsset, addr 0x244fc24, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> get_ParentAsset();

  /// @brief Method get_PendingInputObjectType, addr 0x244fb94, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::__HEU_InputNode__InputObjectType get_PendingInputObjectType();

  /// @brief Method get_RequiresCook, addr 0x244fbb4, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequiresCook();

  /// @brief Method get_RequiresUpload, addr 0x244fbc8, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequiresUpload();

  /// @brief Method get_ThisInputObjectType, addr 0x244fb8c, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::__HEU_InputNode__InputObjectType get_ThisInputObjectType();

  /// @brief Method get_TilemapSettings, addr 0x244fc3c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_KeepWorldTransform, addr 0x244fc04, size 0xc, virtual false, abstract: false, final false
  inline void set_KeepWorldTransform(bool value);

  /// @brief Method set_PackGeometryBeforeMerging, addr 0x244fc18, size 0xc, virtual false, abstract: false, final false
  inline void set_PackGeometryBeforeMerging(bool value);

  /// @brief Method set_ParamName, addr 0x244fbf4, size 0x8, virtual false, abstract: false, final false
  inline void set_ParamName(::StringW value);

  /// @brief Method set_PendingInputObjectType, addr 0x244fb9c, size 0x8, virtual false, abstract: false, final false
  inline void set_PendingInputObjectType(::HoudiniEngineUnity::__HEU_InputNode__InputObjectType value);

  /// @brief Method set_RequiresCook, addr 0x244fbbc, size 0xc, virtual false, abstract: false, final false
  inline void set_RequiresCook(bool value);

  /// @brief Method set_RequiresUpload, addr 0x244fbd0, size 0xc, virtual false, abstract: false, final false
