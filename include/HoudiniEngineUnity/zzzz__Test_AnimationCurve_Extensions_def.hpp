...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x3a9b68c, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_AnimationCurve* _ToTestObject_b__1_0(::UnityEngine::AnimationCurve* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3a9b6e8, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_AnimationCurve* _ToTestObject_b__2_0(::UnityEngine::AnimationCurve* lod);

  /// @brief Method .ctor, addr 0x3a9b684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x3a9b440, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3a9b3e4, size 0x5c, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_AnimationCurve* ToTestObject(::UnityEngine::AnimationCurve* self);

  /// @brief Method ToTestObject, addr 0x3a9b530, size 0xf8, virtual false, abstract: false, final false
