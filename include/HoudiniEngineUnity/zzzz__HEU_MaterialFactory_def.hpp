...
public:
  ...
  /// @brief Method CopyMaterial, addr 0x2364668, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> CopyMaterial(::UnityEngine::Material* material);

  /// @brief Method CreateHoudiniMaterialData, addr 0x23650b4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMaterialInCache, addr 0x2364c40, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewHoudiniStandardMaterial, addr 0x236366c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateUnitySubstanceMaterialData, addr 0x23648d8, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method DeleteAssetMaterial, addr 0x236385c, size 0x8, virtual false, abstract: false, final false
  static inline void DeleteAssetMaterial(::UnityEngine::Material* material);

  /// @brief Method DestroyNonAssetMaterial, addr 0x23637bc, size 0xa0, virtual false, abstract: false, final false
  static inline void DestroyNonAssetMaterial(::UnityEngine::Material* material, bool bRegisterUndo);

  /// @brief Method DoesMaterialExistInAssetCache, addr 0x2363798, size 0x24, virtual false, abstract: false, final false
  static inline bool DoesMaterialExistInAssetCache(::UnityEngine::Material* material);

  /// @brief Method EnableGPUInstancing, addr 0x236463c, size 0x18, virtual false, abstract: false, final false
  static inline void EnableGPUInstancing(::UnityEngine::Material* material);

  /// @brief Method ExtractHoudiniImageToTextureFile, addr 0x2363c84, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractHoudiniImageToTexturePNGJPEG, addr 0x2363b50, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ExtractHoudiniImageToTextureRaw, addr 0x2363864, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method FindPluginShader, addr 0x2362244, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> FindPluginShader(::StringW shaderName);

  /// @brief Method FindShader, addr 0x23633f8, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> FindShader(::StringW shaderName);

  /// @brief Method GenerateDefaultMaterialName, addr 0x2364e94, size 0xbc, virtual false, abstract: false, final false
  static inline ::StringW GenerateDefaultMaterialName(int32_t geoID, int32_t partID);

  /// @brief Method GetDefaultStandardMaterial, addr 0x23646cc, size 0xcc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetDefaultStandardMaterial();

  /// @brief Method GetMaterialDataFromCache, addr 0x2364f50, size 0x164, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_MaterialData> GetMaterialDataFromCache(int32_t materialKey,
                                                                                          ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_MaterialData>>* materialCache);

  /// @brief Method GetMaterialDataMapFromCache, addr 0x23654b0, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNewMaterialWithShader, addr 0x2363444, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrCreateDefaultMaterialInCache, addr 0x2364da8, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_MaterialData>
  ...
  /// @brief Method GetUnitySubstanceMaterialKey, addr 0x2364508, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSubstanceMaterialWithIndex, addr 0x2364298, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSubstanceMaterialWithName, addr 0x23640bc, size 0x1dc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> LoadSubstanceMaterialWithName(::StringW materialPath, ::StringW substanceName);

  /// @brief Method LoadTexture, addr 0x2364798, size 0x138, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> LoadTexture(::StringW path);

  /// @brief Method LoadUnityMaterial, addr 0x2363e24, size 0x298, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> LoadUnityMaterial(::StringW materialPath);

  /// @brief Method MaterialHasGPUInstancingEnabled, addr 0x2364654, size 0x14, virtual false, abstract: false, final false
  static inline bool MaterialHasGPUInstancingEnabled(::UnityEngine::Material* material);

  /// @brief Method MaterialNameToKey, addr 0x2364620, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t MaterialNameToKey(::StringW materialName);

  /// @brief Method RenderAndExtractImageToTexture, addr 0x2362ab4, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method WhiteTexture, addr 0x23648d0, size 0x8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> WhiteTexture();

  /// @brief Method WriteMaterialToAssetCache, addr 0x23636a4, size 0xf4, virtual false, abstract: false, final false
