...
public:
  ...
  /// @brief Method .ctor addr 0x208dee4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToTestObject>b__1_0 addr 0x208deec size 0x64 virtual false final false
  inline ::HoudiniEngineUnity::Test_MeshFilter* _ToTestObject_b__1_0(::UnityEngine::MeshFilter* lod);

  /// @brief Method <ToTestObject>b__2_0 addr 0x208df50 size 0x64 virtual false final false
...
public:
  ...
  /// @brief Method ToTestObject addr 0x2089928 size 0x64 virtual false final false
  static inline ::HoudiniEngineUnity::Test_MeshFilter* ToTestObject(::UnityEngine::MeshFilter* self);

  /// @brief Method ToTestObject addr 0x208dc8c size 0xf8 virtual false final false
  ...
  /// @brief Method ToTestObject addr 0x208dd84 size 0xfc virtual false final false
