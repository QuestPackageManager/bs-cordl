...
public:
  ...
  /// @brief Method System.Runtime.Serialization.ISerializationSurrogate.GetObjectData, addr 0x399e4ec, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Runtime.Serialization.ISerializationSurrogate.SetObjectData, addr 0x399e5b4, size 0x198, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x399d5fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
