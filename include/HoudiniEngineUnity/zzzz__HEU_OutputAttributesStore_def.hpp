...
public:
  ...
  /// @brief Method Clear, addr 0x3a3a0d0, size 0x50, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetAttribute, addr 0x3a3a060, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttribute, addr 0x3a39f64, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a3a120, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
