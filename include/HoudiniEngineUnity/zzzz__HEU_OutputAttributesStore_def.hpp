...
public:
  ...
  /// @brief Method Clear, addr 0x22e5ae0, size 0x50, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetAttribute, addr 0x22e5a70, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAttribute, addr 0x22e5974, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22e5b30, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
