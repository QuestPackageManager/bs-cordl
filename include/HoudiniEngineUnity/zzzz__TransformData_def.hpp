...
public:
  // Declarations
  /// @brief Method CopyTo, addr 0x3a6a208, size 0x80, virtual false, abstract: false, final false
  inline void CopyTo(::UnityEngine::Transform* other, bool copyParent);

  /// @brief Method CopyToLocal, addr 0x3a6a288, size 0x80, virtual false, abstract: false, final false
  inline void CopyToLocal(::UnityEngine::Transform* other, bool copyParent);

  /// @brief Method .ctor, addr 0x3a6a170, size 0x98, virtual false, abstract: false, final false
