...
public:
  ...
  /// @brief Method ApplyPreset, addr 0x25fdb70, size 0x2d8, virtual false, abstract: false, final false
  inline bool ApplyPreset(::HoudiniEngineUnity::HEU_VolumeCachePreset* volumeCachePreset);

  /// @brief Method CopyDetailProperties, addr 0x25fe824, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyLayer, addr 0x25fba24, size 0xb8, virtual false, abstract: false, final false
  static inline void CopyLayer(::HoudiniEngineUnity::HEU_VolumeLayer* srcLayer, ::HoudiniEngineUnity::HEU_VolumeLayer* destLayer);

  /// @brief Method CopyPrototype, addr 0x25fe84c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyValuesTo, addr 0x25fe5e0, size 0x244, virtual false, abstract: false, final false
  inline void CopyValuesTo(::HoudiniEngineUnity::HEU_VolumeCache* destCache);

  /// @brief Method FinishUpdateLayers, addr 0x25fb89c, size 0xc, virtual false, abstract: false, final false
  inline void FinishUpdateLayers();

  /// @brief Method GenerateTerrainWithAlphamaps, addr 0x25fc3a4, size 0x17cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLayer, addr 0x25fbadc, size 0x190, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_VolumeLayer* GetLayer(::StringW layerName);

  /// @brief Method GetPartLayerAttributes, addr 0x25fbc6c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x25fb860, size 0x3c, virtual false, abstract: false, final false
  inline void Initialize(::HoudiniEngineUnity::HEU_GeoNode* ownerNode, int32_t tileIndex);

  /// @brief Method IsEquivalentTo, addr 0x25fe894, size 0x31c, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_VolumeCache* other);

  /// @brief Method LoadAssetTexture, addr 0x25fbec0, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> LoadAssetTexture(::StringW path);

  /// @brief Method LoadDefaultSplatTexture, addr 0x25fde48, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> LoadDefaultSplatTexture();

  /// @brief Method LoadLayerColorFromAttribute, addr 0x25fc0f4, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerFloatFromAttribute, addr 0x25fbfc0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerPropertiesFromAttributes, addr 0x25fded0, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerTextureFromAttribute, addr 0x25fbdc8, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerVector2FromAttribute, addr 0x25fc260, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateDetailPrototype, addr 0x25fe2fc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulatePreset, addr 0x25fe324, size 0x2bc, virtual false, abstract: false, final false
  inline void PopulatePreset(::HoudiniEngineUnity::HEU_VolumeCachePreset* cachePreset);

  /// @brief Method PopulateScatterTrees, addr 0x25fe2d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetParameters, addr 0x25fb8a8, size 0x17c, virtual false, abstract: false, final false
  inline void ResetParameters();

  /// @brief Method StartUpdateLayers, addr 0x25fb40c, size 0x74, virtual false, abstract: false, final false
  inline void StartUpdateLayers();

  /// @brief Method UpdateLayerFromPart, addr 0x25fb480, size 0x3e0, virtual false, abstract: false, final false
  inline void UpdateLayerFromPart(::HoudiniEngineUnity::HEU_SessionBase* session, ::HoudiniEngineUnity::HEU_PartData* part);

  /// @brief Method UpdateVolumeCachesFromParts, addr 0x25fab30, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25febb0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeoName, addr 0x25fab14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GeoName();

  /// @brief Method get_IsDirty, addr 0x25faaf0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDirty();

  /// @brief Method get_ObjectName, addr 0x25fab0c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ObjectName();

  /// @brief Method get_TileIndex, addr 0x25fab04, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_TileIndex();

  /// @brief Method get_UIExpanded, addr 0x25fab1c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDirty, addr 0x25faaf8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDirty(bool value);

  /// @brief Method set_UIExpanded, addr 0x25fab24, size 0xc, virtual false, abstract: false, final false
