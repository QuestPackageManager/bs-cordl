...
public:
  ...
  /// @brief Method ApplyPreset, addr 0x3aa1434, size 0x2d0, virtual false, abstract: false, final false
  inline bool ApplyPreset(::HoudiniEngineUnity::HEU_VolumeCachePreset* volumeCachePreset);

  /// @brief Method CopyDetailProperties, addr 0x3aa20d0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyLayer, addr 0x3a9f314, size 0xb4, virtual false, abstract: false, final false
  static inline void CopyLayer(::HoudiniEngineUnity::HEU_VolumeLayer* srcLayer, ::HoudiniEngineUnity::HEU_VolumeLayer* destLayer);

  /// @brief Method CopyPrototype, addr 0x3aa20f8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyValuesTo, addr 0x3aa1e90, size 0x240, virtual false, abstract: false, final false
  inline void CopyValuesTo(::HoudiniEngineUnity::HEU_VolumeCache* destCache);

  /// @brief Method FinishUpdateLayers, addr 0x3a9f190, size 0xc, virtual false, abstract: false, final false
  inline void FinishUpdateLayers();

  /// @brief Method GenerateTerrainWithAlphamaps, addr 0x3a9fc5c, size 0x17d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLayer, addr 0x3a9f3c8, size 0x168, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_VolumeLayer* GetLayer(::StringW layerName);

  /// @brief Method GetPartLayerAttributes, addr 0x3a9f530, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x3a9f154, size 0x3c, virtual false, abstract: false, final false
  inline void Initialize(::HoudiniEngineUnity::HEU_GeoNode* ownerNode, int32_t tileIndex);

  /// @brief Method IsEquivalentTo, addr 0x3aa2140, size 0x304, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_VolumeCache* other);

  /// @brief Method LoadAssetTexture, addr 0x3a9f780, size 0x100, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> LoadAssetTexture(::StringW path);

  /// @brief Method LoadDefaultSplatTexture, addr 0x3aa1704, size 0x88, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> LoadDefaultSplatTexture();

  /// @brief Method LoadLayerColorFromAttribute, addr 0x3a9f9b0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerFloatFromAttribute, addr 0x3a9f880, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerPropertiesFromAttributes, addr 0x3aa178c, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerTextureFromAttribute, addr 0x3a9f688, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerVector2FromAttribute, addr 0x3a9fb1c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateDetailPrototype, addr 0x3aa1bb8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulatePreset, addr 0x3aa1be0, size 0x2b0, virtual false, abstract: false, final false
  inline void PopulatePreset(::HoudiniEngineUnity::HEU_VolumeCachePreset* cachePreset);

  /// @brief Method PopulateScatterTrees, addr 0x3aa1b94, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetParameters, addr 0x3a9f19c, size 0x178, virtual false, abstract: false, final false
  inline void ResetParameters();

  /// @brief Method StartUpdateLayers, addr 0x3a9ed14, size 0x74, virtual false, abstract: false, final false
  inline void StartUpdateLayers();

  /// @brief Method UpdateLayerFromPart, addr 0x3a9ed88, size 0x3cc, virtual false, abstract: false, final false
  inline void UpdateLayerFromPart(::HoudiniEngineUnity::HEU_SessionBase* session, ::HoudiniEngineUnity::HEU_PartData* part);

  /// @brief Method UpdateVolumeCachesFromParts, addr 0x3a9e440, size 0x8d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aa2444, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeoName, addr 0x3a9e424, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GeoName();

  /// @brief Method get_IsDirty, addr 0x3a9e400, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDirty();

  /// @brief Method get_ObjectName, addr 0x3a9e41c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ObjectName();

  /// @brief Method get_TileIndex, addr 0x3a9e414, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_TileIndex();

  /// @brief Method get_UIExpanded, addr 0x3a9e42c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsDirty, addr 0x3a9e408, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDirty(bool value);

  /// @brief Method set_UIExpanded, addr 0x3a9e434, size 0xc, virtual false, abstract: false, final false
