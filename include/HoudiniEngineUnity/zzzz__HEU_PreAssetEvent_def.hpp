...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10387)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10387), inst: 5121 }),
// TypeDefinitionIndex(TypeDefinitionIndex(9526))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9533)) CS Name: ::HoudiniEngineUnity::HEU_PreAssetEvent*
...
public:
  ...
  /// @brief Method .ctor addr 0x1ff6bcc size 0x48 virtual false final false
  inline void _ctor();
