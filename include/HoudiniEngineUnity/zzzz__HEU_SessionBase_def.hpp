...
public:
  ...
  /// @brief Method get_UserNotifiedSessionInvalid addr 0x21a1a10 size 0x8 virtual false final false
  inline bool get_UserNotifiedSessionInvalid();

  /// @brief Method set_UserNotifiedSessionInvalid addr 0x21a1a18 size 0xc virtual false final false
  inline void set_UserNotifiedSessionInvalid(bool value);

  /// @brief Method get_ConnectionState addr 0x21a1a24 size 0x18 virtual false final false
  inline ::HoudiniEngineUnity::SessionConnectionState get_ConnectionState();

  /// @brief Method set_ConnectionState addr 0x21a1a3c size 0x10 virtual false final false
  inline void set_ConnectionState(::HoudiniEngineUnity::SessionConnectionState value);

  /// @brief Method get_ThisSessionMode addr 0x21a1a4c size 0x18 virtual false final false
  inline ::HoudiniEngineUnity::SessionMode get_ThisSessionMode();

  /// @brief Method set_ThisSessionMode addr 0x21a1a64 size 0x10 virtual false final false
  inline void set_ThisSessionMode(::HoudiniEngineUnity::SessionMode value);

  /// @brief Method GetSessionErrorMsg addr 0x21a1a74 size 0x8 virtual false final false
  inline ::StringW GetSessionErrorMsg();

  /// @brief Method get_LogErrorOverride addr 0x21a1a7c size 0x8 virtual false final false
  inline bool get_LogErrorOverride();

  /// @brief Method set_LogErrorOverride addr 0x21a1a84 size 0xc virtual false final false
  inline void set_LogErrorOverride(bool value);

  /// @brief Method get_ThrowErrorOverride addr 0x21a1a90 size 0x8 virtual false final false
  inline bool get_ThrowErrorOverride();

  /// @brief Method set_ThrowErrorOverride addr 0x21a1a98 size 0xc virtual false final false
  inline void set_ThrowErrorOverride(bool value);

  /// @brief Method IsSessionSync addr 0x21a1aa4 size 0x20 virtual false final false
  inline bool IsSessionSync();

  /// @brief Method get_LastCallResultCode addr 0x21a1ad4 size 0x8 virtual false final false
  inline ::HoudiniEngineUnity::HAPI_Result get_LastCallResultCode();

  /// @brief Method set_LastCallResultCode addr 0x21a1adc size 0x8 virtual false final false
  inline void set_LastCallResultCode(::HoudiniEngineUnity::HAPI_Result value);

  /// @brief Method GetRegisteredAssetFromID addr 0x21a1ae4 size 0x8 virtual true final false
  inline ::HoudiniEngineUnity::HEU_HoudiniAsset* GetRegisteredAssetFromID(int32_t id);

  /// @brief Method IsAssetRegistered addr 0x21a1aec size 0x8 virtual true final false
  inline bool IsAssetRegistered(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method RegisterAsset addr 0x21a1af4 size 0x4 virtual true final false
  inline void RegisterAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method UnregisterAsset addr 0x21a1af8 size 0x4 virtual true final false
  inline void UnregisterAsset(int32_t id);

  /// @brief Method ReregisterOnAwake addr 0x21a1afc size 0x4 virtual true final false
  ...
  /// @brief Method .ctor addr 0x21a1b00 size 0x20 virtual false final false
  inline void _ctor();

  /// @brief Method SetSessionErrorMsg addr 0x21a1b20 size 0x20 virtual true final false
  inline void SetSessionErrorMsg(::StringW msg, bool bLogError);

  /// @brief Method SetSessionConnectionErrorMsg addr 0x21a1b40 size 0x264 virtual true final false
  ...
  /// @brief Method SetLibraryErrorMsg addr 0x21a1de4 size 0xb8 virtual true final false
  inline void SetLibraryErrorMsg(bool bLogError);

  /// @brief Method CreateSessionData addr 0x21a1e9c size 0x8 virtual true final false
  inline bool CreateSessionData(bool bOverwriteExisting, bool bIsDefaultSession);

  /// @brief Method CreateInProcessSession addr 0x21a1ea4 size 0x8 virtual true final false
  inline bool CreateInProcessSession(bool bIsDefaultSession);

  /// @brief Method CreateThriftSocketSession addr 0x21a1eac size 0x8 virtual true final false
  ...
  /// @brief Method CreateThriftPipeSession addr 0x21a1eb4 size 0x8 virtual true final false
  ...
  /// @brief Method CreateCustomSession addr 0x21a1ebc size 0x8 virtual true final false
  inline bool CreateCustomSession(bool bIsDefaultSession);

  /// @brief Method ConnectThriftSocketSession addr 0x21a1ec4 size 0x8 virtual true final false
  ...
  /// @brief Method ConnectThriftPipeSession addr 0x21a1ecc size 0x8 virtual true final false
  ...
  /// @brief Method CloseSession addr 0x21a1ed4 size 0x8 virtual true final false
  inline bool CloseSession();

  /// @brief Method CheckAndCloseExistingSession addr 0x21a1edc size 0x8 virtual true final false
  inline bool CheckAndCloseExistingSession();

  /// @brief Method ClearSessionInfo addr 0x21a1ee4 size 0x20 virtual true final false
  inline void ClearSessionInfo();

  /// @brief Method SetSessionData addr 0x21a1f0c size 0x8 virtual false final false
  inline void SetSessionData(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method GetSessionData addr 0x21a1f14 size 0x8 virtual false final false
  inline ::HoudiniEngineUnity::HEU_SessionData* GetSessionData();

  /// @brief Method GetSessionInfo addr 0x21a1f1c size 0x40 virtual true final false
  inline ::StringW GetSessionInfo();

  /// @brief Method IsSessionValid addr 0x21a1f5c size 0x8 virtual true final false
  inline bool IsSessionValid();

  /// @brief Method RestartSession addr 0x21a1f64 size 0x8 virtual true final false
  inline bool RestartSession();

  /// @brief Method GetLastSessionError addr 0x21a1f6c size 0x8 virtual false final false
  inline ::StringW GetLastSessionError();

  /// @brief Method CheckVersionMatch addr 0x21a1f74 size 0x8 virtual true final false
  inline bool CheckVersionMatch();

  /// @brief Method InitializeSession addr 0x21a1f7c size 0x8 virtual true final false
  inline bool InitializeSession(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method HandleStatusResult addr 0x21a1f84 size 0x8 virtual true final false
  inline bool HandleStatusResult(::HoudiniEngineUnity::HAPI_Result result, ::StringW prependMsg, bool bThrowError, bool bLogError);

  /// @brief Method SetServerEnvString addr 0x21a1f8c size 0x4 virtual true final false
  inline void SetServerEnvString(::StringW name, ::StringW value);

  /// @brief Method GetServerEnvString addr 0x21a1f90 size 0xc virtual true final false
  inline bool GetServerEnvString(::StringW name, ByRef<::StringW> value);

  /// @brief Method GetServerEnvVarCount addr 0x21a1f9c size 0xc virtual true final false
  inline bool GetServerEnvVarCount(ByRef<int32_t> env_count);

  /// @brief Method GetCallResult addr 0x21a1fa8 size 0xc virtual true final false
  inline bool GetCallResult(ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetCookResult addr 0x21a1fb4 size 0xc virtual true final false
  inline bool GetCookResult(ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetCookState addr 0x21a1fc0 size 0xc virtual true final false
  inline bool GetCookState(ByRef<::HoudiniEngineUnity::HAPI_State> state);

  /// @brief Method GetStatusString addr 0x21a1fcc size 0x40 virtual true final false
  ...
  /// @brief Method ComposeNodeCookResult addr 0x21a200c size 0x40 virtual true final false
  inline ::StringW ComposeNodeCookResult(int32_t nodeId, ::HoudiniEngineUnity::HAPI_StatusVerbosity verbosity);

  /// @brief Method GetEnvInt addr 0x21a204c size 0x8 virtual true final false
  inline int32_t GetEnvInt(::HoudiniEngineUnity::HAPI_EnvIntType intType);

  /// @brief Method GetSessionEnvInt addr 0x21a2054 size 0x8 virtual true final false
  inline int32_t GetSessionEnvInt(::HoudiniEngineUnity::HAPI_SessionEnvIntType intType, bool bLogError);

  /// @brief Method GetString addr 0x21a205c size 0x8 virtual true final false
  inline bool GetString(int32_t stringHandle, ByRef<::StringW> resultString, int32_t bufferLength);

  /// @brief Method GetStringBufferLength addr 0x21a2064 size 0x8 virtual true final false
  inline int32_t GetStringBufferLength(int32_t stringHandle);

  /// @brief Method CheckForSpecificErrors addr 0x21a206c size 0x8 virtual true final false
  inline int32_t CheckForSpecificErrors(int32_t nodeID, int32_t errorsToCheck);

  /// @brief Method GetTime addr 0x21a2074 size 0x8 virtual true final false
  inline float_t GetTime();

  /// @brief Method SetTime addr 0x21a207c size 0x8 virtual true final false
  inline bool SetTime(float_t time);

  /// @brief Method GetUseHoudiniTime addr 0x21a2084 size 0x8 virtual true final false
  inline bool GetUseHoudiniTime();

  /// @brief Method SetUseHoudiniTime addr 0x21a208c size 0x8 virtual true final false
  inline bool SetUseHoudiniTime(bool enable);

  /// @brief Method LoadAssetLibraryFromFile addr 0x21a2094 size 0xc virtual true final false
  inline bool LoadAssetLibraryFromFile(::StringW assetPath, bool bAllowOverwrite, ByRef<int32_t> libraryID);

  /// @brief Method LoadAssetLibraryFromMemory addr 0x21a20a0 size 0xc virtual true final false
  inline bool LoadAssetLibraryFromMemory(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, bool bAllowOverwrite, ByRef<int32_t> libraryID);

  /// @brief Method CreateNode addr 0x21a20ac size 0x10 virtual true final false
  ...
  /// @brief Method GetComposedChildNodeList addr 0x21a2144 size 0x8 virtual true final false
  inline bool GetComposedChildNodeList(int32_t parentNodeID, ::ArrayW<int32_t, ::Array<int32_t>*> childNodeIDs, int32_t count);

  /// @brief Method LoadHIPFile addr 0x21a214c size 0x8 virtual true final false
  inline bool LoadHIPFile(::StringW fileName, bool bCookOnLoad);

  /// @brief Method SaveHIPFile addr 0x21a2154 size 0x8 virtual true final false
  inline bool SaveHIPFile(::StringW fileName, bool bLockNodes);

  /// @brief Method GetObjectInfo addr 0x21a215c size 0x8 virtual true final false
  inline bool GetObjectInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_ObjectInfo> objectInfo);

  /// @brief Method GetObjectTransform addr 0x21a2164 size 0x8 virtual true final false
  ...
  /// @brief Method SetObjectTransform addr 0x21a216c size 0x8 virtual true final false
  inline bool SetObjectTransform(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_TransformEuler> hapiTransform);

  /// @brief Method ComposeObjectList addr 0x21a2174 size 0xc virtual true final false
  inline bool ComposeObjectList(int32_t nodeID, ByRef<int32_t> objectCount);

  /// @brief Method GetComposedObjectList addr 0x21a2180 size 0x8 virtual true final false
  ...
  /// @brief Method GetComposedObjectTransforms addr 0x21a2188 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeNames addr 0x21a21b0 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeStringData addr 0x21a21b8 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeFloatData addr 0x21a21c0 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeFloat64Data addr 0x21a21c8 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeIntData addr 0x21a21d0 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeUInt8Data addr 0x21a21d8 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeInt8Data addr 0x21a21e0 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeInt16Data addr 0x21a21e8 size 0x8 virtual true final false
  ...
  /// @brief Method GetAttributeInt64Data addr 0x21a21f0 size 0x8 virtual true final false
  ...
  /// @brief Method GetGroupNames addr 0x21a21f8 size 0x8 virtual true final false
  ...
  /// @brief Method GetGroupMembership addr 0x21a2200 size 0x8 virtual true final false
  ...
  /// @brief Method GetGroupCountOnPackedInstancePart addr 0x21a2208 size 0x10 virtual true final false
  ...
  /// @brief Method GetGroupNamesOnPackedInstancePart addr 0x21a2218 size 0x8 virtual true final false
  ...
  /// @brief Method GetGroupMembershipOnPackedInstancePart addr 0x21a2220 size 0x8 virtual true final false
  ...
  /// @brief Method GetInstancedPartIds addr 0x21a2228 size 0x8 virtual true final false
  ...
  /// @brief Method GetInstancerPartTransforms addr 0x21a2230 size 0x8 virtual true final false
  ...
  /// @brief Method GetInstanceTransformsOnPart addr 0x21a2238 size 0x8 virtual true final false
  inline bool GetInstanceTransformsOnPart(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_RSTOrder rstOrder,
                                          ByRef<::ArrayW<::HoudiniEngineUnity::HAPI_Transform, ::Array<::HoudiniEngineUnity::HAPI_Transform>*>> transformsArray, int32_t start, int32_t length);

  /// @brief Method GetInstancedObjectIds addr 0x21a2240 size 0x8 virtual true final false
  ...
  /// @brief Method GetFaceCounts addr 0x21a2248 size 0x8 virtual true final false
  ...
  /// @brief Method GetFaceCounts addr 0x21a2250 size 0x8 virtual true final false
  ...
  /// @brief Method GetVertexList addr 0x21a2258 size 0x8 virtual true final false
  ...
  /// @brief Method GetCurveOrders addr 0x21a2280 size 0x8 virtual true final false
  ...
  /// @brief Method GetCurveKnots addr 0x21a2288 size 0x8 virtual true final false
  ...
  /// @brief Method SetPartInfo addr 0x21a2290 size 0x8 virtual true final false
  inline bool SetPartInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetFaceCount addr 0x21a2298 size 0x8 virtual true final false
  ...
  /// @brief Method SetVertexList addr 0x21a22a0 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeIntData addr 0x21a22a8 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeInt8Data addr 0x21a22b0 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeInt16Data addr 0x21a22b8 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeInt64Data addr 0x21a22c0 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeFloatData addr 0x21a22c8 size 0x8 virtual true final false
  ...
  /// @brief Method SetAttributeStringData addr 0x21a22d0 size 0x8 virtual true final false
  ...
  /// @brief Method CommitGeo addr 0x21a22f8 size 0x8 virtual true final false
  inline bool CommitGeo(int32_t nodeID);

  /// @brief Method RevertGeo addr 0x21a2300 size 0x8 virtual true final false
  inline bool RevertGeo(int32_t nodeID);

  /// @brief Method SetCurveInfo addr 0x21a2308 size 0x8 virtual true final false
  inline bool SetCurveInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_CurveInfo> curveInfo);

  /// @brief Method SetCurveCounts addr 0x21a2310 size 0x8 virtual true final false
  ...
  /// @brief Method SetCurveOrders addr 0x21a2318 size 0x8 virtual true final false
  ...
  /// @brief Method SetCurveKnots addr 0x21a2320 size 0x8 virtual true final false
  inline bool SetCurveKnots(int32_t nodeID, int32_t partID, ::ArrayW<float_t, ::Array<float_t>*> knots, int32_t start, int32_t length);

  /// @brief Method GetMaterialOnPart addr 0x21a2328 size 0x8 virtual true final false
  inline bool GetMaterialOnPart(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_MaterialInfo> materialInfo);

  /// @brief Method GetMaterialNodeIDsOnFaces addr 0x21a2330 size 0x8 virtual true final false
  ...
  /// @brief Method GetMaterialInfo addr 0x21a2338 size 0x8 virtual true final false
  ...
  /// @brief Method GetImageInfo addr 0x21a2340 size 0x8 virtual true final false
  inline bool GetImageInfo(int32_t materialNodeID, ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method SetImageInfo addr 0x21a2348 size 0x8 virtual true final false
  inline bool SetImageInfo(int32_t materialNodeID, ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method RenderTextureToImage addr 0x21a2350 size 0x8 virtual true final false
  inline bool RenderTextureToImage(int32_t materialNodeID, int32_t parmID, bool bLogError);

  /// @brief Method RenderCOPToImage addr 0x21a2358 size 0x8 virtual true final false
  inline bool RenderCOPToImage(int32_t copNodeID);

  /// @brief Method ExtractImageToMemory addr 0x21a2360 size 0x54 virtual true final false
  ...
  /// @brief Method GetImagePlanes addr 0x21a23b4 size 0x4c virtual true final false
  inline bool GetImagePlanes(int32_t nodeID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> imagePlanes, int32_t numImagePlanes);

  /// @brief Method ExtractImageToFile addr 0x21a2400 size 0xc virtual true final false
  ...
  /// @brief Method GetParams addr 0x21a240c size 0x8 virtual true final false
  ...
  /// @brief Method CreateHeightfieldInputVolumeNode addr 0x21a2534 size 0x10 virtual true final false
  ...
  /// @brief Method GetPreset addr 0x21a2544 size 0x54 virtual true final false
  inline bool GetPreset(int32_t nodeID, ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> presetData);

  /// @brief Method SetPreset addr 0x21a2598 size 0x8 virtual true final false
  inline bool SetPreset(int32_t nodeID, ::ArrayW<uint8_t, ::Array<uint8_t>*> presetData);

  /// @brief Method GetVolumeInfo addr 0x21a25a0 size 0x8 virtual true final false
  inline bool GetVolumeInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method GetHeightFieldData addr 0x21a25a8 size 0x8 virtual true final false
  ...
  /// @brief Method SetVolumeInfo addr 0x21a25b0 size 0x8 virtual true final false
  inline bool SetVolumeInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method SetVolumeTileFloatData addr 0x21a25b8 size 0x4c virtual true final false
  ...
  /// @brief Method GetVolumeBounds addr 0x21a2604 size 0x34 virtual true final false
  ...
  /// @brief Method SetHeightFieldData addr 0x21a2638 size 0x8 virtual true final false
  ...
  /// @brief Method GetActiveCacheCount addr 0x21a2640 size 0xc virtual true final false
  inline bool GetActiveCacheCount(ByRef<int32_t> activeCacheCount);

  /// @brief Method GetActiveCacheNames addr 0x21a264c size 0x8 virtual true final false
  inline bool GetActiveCacheNames(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> cacheNamesArray, int32_t activeCacheCount);

  /// @brief Method GetCacheProperty addr 0x21a2654 size 0xc virtual true final false
  ...
  /// @brief Method SetCacheProperty addr 0x21a2660 size 0x8 virtual true final false
  inline bool SetCacheProperty(::StringW cacheName, ::HoudiniEngineUnity::HAPI_CacheProperty cacheProperty, int32_t propertyValue);

  /// @brief Method SaveGeoToFile addr 0x21a2668 size 0x8 virtual true final false
  inline bool SaveGeoToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method LoadGeoFromFile addr 0x21a2670 size 0x8 virtual true final false
  inline bool LoadGeoFromFile(int32_t nodeID, ::StringW file_name);

  /// @brief Method SaveNodeToFile addr 0x21a2678 size 0x8 virtual true final false
  inline bool SaveNodeToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method LoadNodeFromFile addr 0x21a2680 size 0x10 virtual true final false
  ...
  /// @brief Method GetGeoSize addr 0x21a2690 size 0xc virtual true final false
  inline bool GetGeoSize(int32_t nodeID, ::StringW format, ByRef<int32_t> size);

  /// @brief Method GetHandleInfo addr 0x21a269c size 0x8 virtual true final false
  ...
  /// @brief Method GetHandleBindingInfo addr 0x21a26a4 size 0x8 virtual true final false
  ...
  /// @brief Method ConvertTransform addr 0x21a26ac size 0x14 virtual true final false
  ...
  /// @brief Method GetTotalCookCount addr 0x21a26c0 size 0xc virtual true final false
  ...
  /// @brief Method SetSessionSync addr 0x21a26cc size 0x8 virtual true final false
  inline bool SetSessionSync(bool enable);

  /// @brief Method GetViewport addr 0x21a26d4 size 0x8 virtual true final false
  inline bool GetViewport(ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method SetViewport addr 0x21a26dc size 0x8 virtual true final false
  inline bool SetViewport(ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method GetSessionSyncInfo addr 0x21a26e4 size 0x8 virtual true final false
  inline bool GetSessionSyncInfo(ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method SetSessionSyncInfo addr 0x21a26ec size 0x8 virtual true final false
  inline bool SetSessionSyncInfo(ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method SetNodeDisplay addr 0x21a26f4 size 0x8 virtual true final false
