...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9481))]
...
public:
  ...
  /// @brief Method get_UserNotifiedSessionInvalid, addr 0x22372f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_UserNotifiedSessionInvalid();

  /// @brief Method set_UserNotifiedSessionInvalid, addr 0x22372fc, size 0xc, virtual false, abstract: false, final false
  inline void set_UserNotifiedSessionInvalid(bool value);

  /// @brief Method get_ConnectionState, addr 0x2237308, size 0x18, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionConnectionState get_ConnectionState();

  /// @brief Method set_ConnectionState, addr 0x2237320, size 0x10, virtual false, abstract: false, final false
  inline void set_ConnectionState(::HoudiniEngineUnity::SessionConnectionState value);

  /// @brief Method get_ThisSessionMode, addr 0x2237330, size 0x18, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionMode get_ThisSessionMode();

  /// @brief Method set_ThisSessionMode, addr 0x2237348, size 0x10, virtual false, abstract: false, final false
  inline void set_ThisSessionMode(::HoudiniEngineUnity::SessionMode value);

  /// @brief Method GetSessionErrorMsg, addr 0x2237358, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetSessionErrorMsg();

  /// @brief Method get_LogErrorOverride, addr 0x2237360, size 0x8, virtual false, abstract: false, final false
  inline bool get_LogErrorOverride();

  /// @brief Method set_LogErrorOverride, addr 0x2237368, size 0xc, virtual false, abstract: false, final false
  inline void set_LogErrorOverride(bool value);

  /// @brief Method get_ThrowErrorOverride, addr 0x2237374, size 0x8, virtual false, abstract: false, final false
  inline bool get_ThrowErrorOverride();

  /// @brief Method set_ThrowErrorOverride, addr 0x223737c, size 0xc, virtual false, abstract: false, final false
  inline void set_ThrowErrorOverride(bool value);

  /// @brief Method IsSessionSync, addr 0x2237388, size 0x20, virtual false, abstract: false, final false
  inline bool IsSessionSync();

  /// @brief Method get_LastCallResultCode, addr 0x22373b8, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HAPI_Result get_LastCallResultCode();

  /// @brief Method set_LastCallResultCode, addr 0x22373c0, size 0x8, virtual false, abstract: false, final false
  inline void set_LastCallResultCode(::HoudiniEngineUnity::HAPI_Result value);

  /// @brief Method GetRegisteredAssetFromID, addr 0x22373c8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> GetRegisteredAssetFromID(int32_t id);

  /// @brief Method IsAssetRegistered, addr 0x22373d0, size 0x8, virtual true, abstract: false, final false
  inline bool IsAssetRegistered(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method RegisterAsset, addr 0x22373d8, size 0x4, virtual true, abstract: false, final false
  inline void RegisterAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method UnregisterAsset, addr 0x22373dc, size 0x4, virtual true, abstract: false, final false
  inline void UnregisterAsset(int32_t id);

  /// @brief Method ReregisterOnAwake, addr 0x22373e0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22373e4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method SetSessionErrorMsg, addr 0x2237404, size 0x20, virtual true, abstract: false, final false
  inline void SetSessionErrorMsg(::StringW msg, bool bLogError);

  /// @brief Method SetSessionConnectionErrorMsg, addr 0x2237424, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method SetLibraryErrorMsg, addr 0x22376c8, size 0xb8, virtual true, abstract: false, final false
  inline void SetLibraryErrorMsg(bool bLogError);

  /// @brief Method CreateSessionData, addr 0x2237780, size 0x8, virtual true, abstract: false, final false
  inline bool CreateSessionData(bool bOverwriteExisting, bool bIsDefaultSession);

  /// @brief Method CreateInProcessSession, addr 0x2237788, size 0x8, virtual true, abstract: false, final false
  inline bool CreateInProcessSession(bool bIsDefaultSession);

  /// @brief Method CreateThriftSocketSession, addr 0x2237790, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateThriftPipeSession, addr 0x2237798, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateCustomSession, addr 0x22377a0, size 0x8, virtual true, abstract: false, final false
  inline bool CreateCustomSession(bool bIsDefaultSession);

  /// @brief Method ConnectThriftSocketSession, addr 0x22377a8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConnectThriftPipeSession, addr 0x22377b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CloseSession, addr 0x22377b8, size 0x8, virtual true, abstract: false, final false
  inline bool CloseSession();

  /// @brief Method CheckAndCloseExistingSession, addr 0x22377c0, size 0x8, virtual true, abstract: false, final false
  inline bool CheckAndCloseExistingSession();

  /// @brief Method ClearSessionInfo, addr 0x22377c8, size 0x20, virtual true, abstract: false, final false
  inline void ClearSessionInfo();

  /// @brief Method SetSessionData, addr 0x22377f0, size 0x8, virtual false, abstract: false, final false
  inline void SetSessionData(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method GetSessionData, addr 0x22377f8, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionData* GetSessionData();

  /// @brief Method GetSessionInfo, addr 0x2237800, size 0x40, virtual true, abstract: false, final false
  inline ::StringW GetSessionInfo();

  /// @brief Method IsSessionValid, addr 0x2237840, size 0x8, virtual true, abstract: false, final false
  inline bool IsSessionValid();

  /// @brief Method RestartSession, addr 0x2237848, size 0x8, virtual true, abstract: false, final false
  inline bool RestartSession();

  /// @brief Method GetLastSessionError, addr 0x2237850, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetLastSessionError();

  /// @brief Method CheckVersionMatch, addr 0x2237858, size 0x8, virtual true, abstract: false, final false
  inline bool CheckVersionMatch();

  /// @brief Method InitializeSession, addr 0x2237860, size 0x8, virtual true, abstract: false, final false
  inline bool InitializeSession(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method HandleStatusResult, addr 0x2237868, size 0x8, virtual true, abstract: false, final false
  inline bool HandleStatusResult(::HoudiniEngineUnity::HAPI_Result result, ::StringW prependMsg, bool bThrowError, bool bLogError);

  /// @brief Method SetServerEnvString, addr 0x2237870, size 0x4, virtual true, abstract: false, final false
  inline void SetServerEnvString(::StringW name, ::StringW value);

  /// @brief Method GetServerEnvString, addr 0x2237874, size 0xc, virtual true, abstract: false, final false
  inline bool GetServerEnvString(::StringW name, ByRef<::StringW> value);

  /// @brief Method GetServerEnvVarCount, addr 0x2237880, size 0xc, virtual true, abstract: false, final false
  inline bool GetServerEnvVarCount(ByRef<int32_t> env_count);

  /// @brief Method GetCallResult, addr 0x223788c, size 0xc, virtual true, abstract: false, final false
  inline bool GetCallResult(ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetCookResult, addr 0x2237898, size 0xc, virtual true, abstract: false, final false
  inline bool GetCookResult(ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetCookState, addr 0x22378a4, size 0xc, virtual true, abstract: false, final false
  inline bool GetCookState(ByRef<::HoudiniEngineUnity::HAPI_State> state);

  /// @brief Method GetStatusString, addr 0x22378b0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method ComposeNodeCookResult, addr 0x22378f0, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ComposeNodeCookResult(int32_t nodeId, ::HoudiniEngineUnity::HAPI_StatusVerbosity verbosity);

  /// @brief Method GetEnvInt, addr 0x2237930, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetEnvInt(::HoudiniEngineUnity::HAPI_EnvIntType intType);

  /// @brief Method GetSessionEnvInt, addr 0x2237938, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetSessionEnvInt(::HoudiniEngineUnity::HAPI_SessionEnvIntType intType, bool bLogError);

  /// @brief Method GetString, addr 0x2237940, size 0x8, virtual true, abstract: false, final false
  inline bool GetString(int32_t stringHandle, ByRef<::StringW> resultString, int32_t bufferLength);

  /// @brief Method GetStringBufferLength, addr 0x2237948, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetStringBufferLength(int32_t stringHandle);

  /// @brief Method CheckForSpecificErrors, addr 0x2237950, size 0x8, virtual true, abstract: false, final false
  inline int32_t CheckForSpecificErrors(int32_t nodeID, int32_t errorsToCheck);

  /// @brief Method GetTime, addr 0x2237958, size 0x8, virtual true, abstract: false, final false
  inline float_t GetTime();

  /// @brief Method SetTime, addr 0x2237960, size 0x8, virtual true, abstract: false, final false
  inline bool SetTime(float_t time);

  /// @brief Method GetUseHoudiniTime, addr 0x2237968, size 0x8, virtual true, abstract: false, final false
  inline bool GetUseHoudiniTime();

  /// @brief Method SetUseHoudiniTime, addr 0x2237970, size 0x8, virtual true, abstract: false, final false
  inline bool SetUseHoudiniTime(bool enable);

  /// @brief Method LoadAssetLibraryFromFile, addr 0x2237978, size 0xc, virtual true, abstract: false, final false
  inline bool LoadAssetLibraryFromFile(::StringW assetPath, bool bAllowOverwrite, ByRef<int32_t> libraryID);

  /// @brief Method LoadAssetLibraryFromMemory, addr 0x2237984, size 0xc, virtual true, abstract: false, final false
  inline bool LoadAssetLibraryFromMemory(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, bool bAllowOverwrite, ByRef<int32_t> libraryID);

  /// @brief Method CreateNode, addr 0x2237990, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method DeleteNode, addr 0x22379a0, size 0x4, virtual true, abstract: false, final false
  inline void DeleteNode(int32_t nodeID);

  /// @brief Method CookNode, addr 0x22379a4, size 0x8, virtual true, abstract: false, final false
  inline bool CookNode(int32_t nodeID, bool bCookTemplatedGeos, bool bSplitGeosByGroup);

  /// @brief Method CookNodeWithOptions, addr 0x22379ac, size 0x8, virtual true, abstract: false, final false
  inline bool CookNodeWithOptions(int32_t nodeID, ::HoudiniEngineUnity::HAPI_CookOptions cookOptions);

  /// @brief Method RenameNode, addr 0x22379b4, size 0x8, virtual true, abstract: false, final false
  inline bool RenameNode(int32_t nodeID, ::StringW newName);

  /// @brief Method ConnectNodeInput, addr 0x22379bc, size 0x8, virtual true, abstract: false, final false
  inline bool ConnectNodeInput(int32_t nodeID, int32_t inputIndex, int32_t nodeIDToConnect, int32_t outputIndex);

  /// @brief Method DisconnectNodeInput, addr 0x22379c4, size 0x8, virtual true, abstract: false, final false
  inline bool DisconnectNodeInput(int32_t nodeID, int32_t inputIndex, bool bLogError);

  /// @brief Method QueryNodeInput, addr 0x22379cc, size 0x10, virtual true, abstract: false, final false
  inline bool QueryNodeInput(int32_t nodeID, int32_t inputIndex, ByRef<int32_t> connectedNodeID, bool bLogError);

  /// @brief Method GetNodeInputName, addr 0x22379dc, size 0xc, virtual true, abstract: false, final false
  inline bool GetNodeInputName(int32_t nodeID, int32_t inputIndex, ByRef<int32_t> nodeNameIndex);

  /// @brief Method GetAvailableAssetCount, addr 0x22379e8, size 0xc, virtual true, abstract: false, final false
  inline bool GetAvailableAssetCount(int32_t libraryID, ByRef<int32_t> assetCount);

  /// @brief Method GetAvailableAssets, addr 0x22379f4, size 0x8, virtual true, abstract: false, final false
  inline bool GetAvailableAssets(int32_t libraryID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> assetNames, int32_t assetCount);

  /// @brief Method GetAssetInfo, addr 0x22379fc, size 0x8, virtual true, abstract: false, final false
  inline bool GetAssetInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_AssetInfo> assetInfo);

  /// @brief Method GetNodeInfo, addr 0x2237a04, size 0x8, virtual true, abstract: false, final false
  inline bool GetNodeInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_NodeInfo> nodeInfo, bool bLogError);

  /// @brief Method GetNodePath, addr 0x2237a0c, size 0xc, virtual true, abstract: false, final false
  inline bool GetNodePath(int32_t nodeID, int32_t relativeNodeID, ByRef<::StringW> path);

  /// @brief Method IsNodeValid, addr 0x2237a18, size 0x8, virtual true, abstract: false, final false
  inline bool IsNodeValid(int32_t nodeID, int32_t uniqueNodeID);

  /// @brief Method ComposeChildNodeList, addr 0x2237a20, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetComposedChildNodeList, addr 0x2237a28, size 0x8, virtual true, abstract: false, final false
  inline bool GetComposedChildNodeList(int32_t parentNodeID, ::ArrayW<int32_t, ::Array<int32_t>*> childNodeIDs, int32_t count);

  /// @brief Method LoadHIPFile, addr 0x2237a30, size 0x8, virtual true, abstract: false, final false
  inline bool LoadHIPFile(::StringW fileName, bool bCookOnLoad);

  /// @brief Method SaveHIPFile, addr 0x2237a38, size 0x8, virtual true, abstract: false, final false
  inline bool SaveHIPFile(::StringW fileName, bool bLockNodes);

  /// @brief Method GetObjectInfo, addr 0x2237a40, size 0x8, virtual true, abstract: false, final false
  inline bool GetObjectInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_ObjectInfo> objectInfo);

  /// @brief Method GetObjectTransform, addr 0x2237a48, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetObjectTransform, addr 0x2237a50, size 0x8, virtual true, abstract: false, final false
  inline bool SetObjectTransform(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_TransformEuler> hapiTransform);

  /// @brief Method ComposeObjectList, addr 0x2237a58, size 0xc, virtual true, abstract: false, final false
  inline bool ComposeObjectList(int32_t nodeID, ByRef<int32_t> objectCount);

  /// @brief Method GetComposedObjectList, addr 0x2237a64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetComposedObjectTransforms, addr 0x2237a6c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDisplayGeoInfo, addr 0x2237a74, size 0x8, virtual true, abstract: false, final false
  inline bool GetDisplayGeoInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_GeoInfo> geoInfo, bool bLogError);

  /// @brief Method GetGeoInfo, addr 0x2237a7c, size 0x8, virtual true, abstract: false, final false
  inline bool GetGeoInfo(int32_t nodeID, ByRef<::HoudiniEngineUnity::HAPI_GeoInfo> geoInfo, bool bLogError);

  /// @brief Method GetPartInfo, addr 0x2237a84, size 0x8, virtual true, abstract: false, final false
  inline bool GetPartInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method GetAttributeInfo, addr 0x2237a8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeNames, addr 0x2237a94, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringData, addr 0x2237a9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloatData, addr 0x2237aa4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloat64Data, addr 0x2237aac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeIntData, addr 0x2237ab4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeUInt8Data, addr 0x2237abc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt8Data, addr 0x2237ac4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt16Data, addr 0x2237acc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt64Data, addr 0x2237ad4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupNames, addr 0x2237adc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupMembership, addr 0x2237ae4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupCountOnPackedInstancePart, addr 0x2237aec, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupNamesOnPackedInstancePart, addr 0x2237afc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupMembershipOnPackedInstancePart, addr 0x2237b04, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstancedPartIds, addr 0x2237b0c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstancerPartTransforms, addr 0x2237b14, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstanceTransformsOnPart, addr 0x2237b1c, size 0x8, virtual true, abstract: false, final false
  inline bool GetInstanceTransformsOnPart(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_RSTOrder rstOrder,
                                          ByRef<::ArrayW<::HoudiniEngineUnity::HAPI_Transform, ::Array<::HoudiniEngineUnity::HAPI_Transform>*>> transformsArray, int32_t start, int32_t length);

  /// @brief Method GetInstancedObjectIds, addr 0x2237b24, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFaceCounts, addr 0x2237b2c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFaceCounts, addr 0x2237b34, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetVertexList, addr 0x2237b3c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetBoxInfo, addr 0x2237b44, size 0x8, virtual true, abstract: false, final false
  inline bool GetBoxInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_BoxInfo> boxInfo);

  /// @brief Method GetSphereInfo, addr 0x2237b4c, size 0x8, virtual true, abstract: false, final false
  inline bool GetSphereInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_SphereInfo> sphereInfo);

  /// @brief Method GetCurveInfo, addr 0x2237b54, size 0x8, virtual true, abstract: false, final false
  inline bool GetCurveInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_CurveInfo> curveInfo);

  /// @brief Method GetCurveCounts, addr 0x2237b5c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCurveOrders, addr 0x2237b64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCurveKnots, addr 0x2237b6c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetPartInfo, addr 0x2237b74, size 0x8, virtual true, abstract: false, final false
  inline bool SetPartInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetFaceCount, addr 0x2237b7c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetVertexList, addr 0x2237b84, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeIntData, addr 0x2237b8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt8Data, addr 0x2237b94, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt16Data, addr 0x2237b9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt64Data, addr 0x2237ba4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeFloatData, addr 0x2237bac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeStringData, addr 0x2237bb4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method AddAttribute, addr 0x2237bbc, size 0x8, virtual true, abstract: false, final false
  inline bool AddAttribute(int32_t nodeID, int32_t partID, ::StringW name, ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo);

  /// @brief Method AddGroup, addr 0x2237bc4, size 0x8, virtual true, abstract: false, final false
  inline bool AddGroup(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_GroupType groupType, ::StringW groupName);

  /// @brief Method DeleteGroup, addr 0x2237bcc, size 0x8, virtual true, abstract: false, final false
  inline bool DeleteGroup(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_GroupType groupType, ::StringW groupName);

  /// @brief Method SetGroupMembership, addr 0x2237bd4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CommitGeo, addr 0x2237bdc, size 0x8, virtual true, abstract: false, final false
  inline bool CommitGeo(int32_t nodeID);

  /// @brief Method RevertGeo, addr 0x2237be4, size 0x8, virtual true, abstract: false, final false
  inline bool RevertGeo(int32_t nodeID);

  /// @brief Method SetCurveInfo, addr 0x2237bec, size 0x8, virtual true, abstract: false, final false
  inline bool SetCurveInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_CurveInfo> curveInfo);

  /// @brief Method SetCurveCounts, addr 0x2237bf4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCurveOrders, addr 0x2237bfc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCurveKnots, addr 0x2237c04, size 0x8, virtual true, abstract: false, final false
  inline bool SetCurveKnots(int32_t nodeID, int32_t partID, ::ArrayW<float_t, ::Array<float_t>*> knots, int32_t start, int32_t length);

  /// @brief Method GetMaterialOnPart, addr 0x2237c0c, size 0x8, virtual true, abstract: false, final false
  inline bool GetMaterialOnPart(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_MaterialInfo> materialInfo);

  /// @brief Method GetMaterialNodeIDsOnFaces, addr 0x2237c14, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMaterialInfo, addr 0x2237c1c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetImageInfo, addr 0x2237c24, size 0x8, virtual true, abstract: false, final false
  inline bool GetImageInfo(int32_t materialNodeID, ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method SetImageInfo, addr 0x2237c2c, size 0x8, virtual true, abstract: false, final false
  inline bool SetImageInfo(int32_t materialNodeID, ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method RenderTextureToImage, addr 0x2237c34, size 0x8, virtual true, abstract: false, final false
  inline bool RenderTextureToImage(int32_t materialNodeID, int32_t parmID, bool bLogError);

  /// @brief Method RenderCOPToImage, addr 0x2237c3c, size 0x8, virtual true, abstract: false, final false
  inline bool RenderCOPToImage(int32_t copNodeID);

  /// @brief Method ExtractImageToMemory, addr 0x2237c44, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method GetImagePlanes, addr 0x2237c98, size 0x4c, virtual true, abstract: false, final false
  inline bool GetImagePlanes(int32_t nodeID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> imagePlanes, int32_t numImagePlanes);

  /// @brief Method ExtractImageToFile, addr 0x2237ce4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetParams, addr 0x2237cf0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetParmTagName, addr 0x2237cf8, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmTagName(int32_t nodeID, int32_t parmID, int32_t tagIndex, ByRef<int32_t> tagName);

  /// @brief Method GetParmTagValue, addr 0x2237d04, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmTagValue(int32_t nodeID, int32_t parmID, ::StringW tagName, ByRef<int32_t> tagValue);

  /// @brief Method ParmHasTag, addr 0x2237d10, size 0x8, virtual true, abstract: false, final false
  inline bool ParmHasTag(int32_t nodeID, int32_t parmID, ::StringW tagName, ByRef<bool> hasTag);

  /// @brief Method GetParamIntValues, addr 0x2237d18, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamIntValues(int32_t nodeID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParamIntValue, addr 0x2237d20, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamIntValue(int32_t nodeID, ::StringW parmName, int32_t index, ByRef<int32_t> value);

  /// @brief Method GetParamFloatValues, addr 0x2237d2c, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamFloatValues(int32_t nodeID, ByRef<::ArrayW<float_t, ::Array<float_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParamFloatValue, addr 0x2237d34, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamFloatValue(int32_t nodeID, ::StringW parmName, int32_t index, ByRef<float_t> value);

  /// @brief Method GetParamStringValues, addr 0x2237d40, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamStringValues(int32_t nodeID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParamStringValue, addr 0x2237d48, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamStringValue(int32_t nodeID, ::StringW parmName, int32_t index, ByRef<int32_t> value);

  /// @brief Method GetParamNodeValue, addr 0x2237d54, size 0x10, virtual true, abstract: false, final false
  inline bool GetParamNodeValue(int32_t nodeID, ::StringW paramName, ByRef<int32_t> nodeValue);

  /// @brief Method GetParamChoiceValues, addr 0x2237d64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetParamIntValues, addr 0x2237d6c, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamIntValues(int32_t nodeID, ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method SetParamIntValue, addr 0x2237d74, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamIntValue(int32_t nodeID, ::StringW paramName, int32_t index, int32_t value);

  /// @brief Method SetParamFloatValues, addr 0x2237d7c, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamFloatValues(int32_t nodeID, ByRef<::ArrayW<float_t, ::Array<float_t>*>> values, int32_t start, int32_t length);

  /// @brief Method SetParamFloatValue, addr 0x2237d84, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamFloatValue(int32_t nodeID, ::StringW paramName, int32_t index, float_t value);

  /// @brief Method SetParamStringValue, addr 0x2237d8c, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamStringValue(int32_t nodeID, ::StringW strValue, int32_t parmID, int32_t index);

  /// @brief Method SetParamStringValue, addr 0x2237d94, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamStringValue(int32_t nodeID, ::StringW parmName, ::StringW parmValue, int32_t index);

  /// @brief Method SetParamNodeValue, addr 0x2237d9c, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamNodeValue(int32_t nodeID, ::StringW paramName, int32_t nodeValueID);

  /// @brief Method InsertMultiparmInstance, addr 0x2237da4, size 0x8, virtual true, abstract: false, final false
  inline bool InsertMultiparmInstance(int32_t nodeID, int32_t parmID, int32_t instancePosition);

  /// @brief Method RemoveMultiParmInstance, addr 0x2237dac, size 0x8, virtual true, abstract: false, final false
  inline bool RemoveMultiParmInstance(int32_t nodeID, int32_t parmID, int32_t instancePosition);

  /// @brief Method GetParmWithTag, addr 0x2237db4, size 0x8, virtual true, abstract: false, final false
  inline bool GetParmWithTag(int32_t nodeID, ::StringW tagName, ByRef<int32_t> parmID);

  /// @brief Method RevertParmToDefault, addr 0x2237dbc, size 0x8, virtual true, abstract: false, final false
  inline bool RevertParmToDefault(int32_t nodeID, ::StringW parm_name, int32_t index);

  /// @brief Method RevertParmToDefaults, addr 0x2237dc4, size 0x8, virtual true, abstract: false, final false
  inline bool RevertParmToDefaults(int32_t nodeID, ::StringW parm_name);

  /// @brief Method GetParmIDFromName, addr 0x2237dcc, size 0x10, virtual true, abstract: false, final false
  inline bool GetParmIDFromName(int32_t nodeID, ::StringW parmName, ByRef<int32_t> parmID);

  /// @brief Method GetParmStringValue, addr 0x2237ddc, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmStringValue(int32_t nodeID, ::StringW parmName, int32_t index, bool evaluate, ByRef<int32_t> value);

  /// @brief Method CreateInputNode, addr 0x2237de8, size 0x10, virtual true, abstract: false, final false
  inline bool CreateInputNode(ByRef<int32_t> nodeID, ::StringW name);

  /// @brief Method CreateHeightFieldInput, addr 0x2237df8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateHeightfieldInputVolumeNode, addr 0x2237e18, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPreset, addr 0x2237e28, size 0x54, virtual true, abstract: false, final false
  inline bool GetPreset(int32_t nodeID, ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> presetData);

  /// @brief Method SetPreset, addr 0x2237e7c, size 0x8, virtual true, abstract: false, final false
  inline bool SetPreset(int32_t nodeID, ::ArrayW<uint8_t, ::Array<uint8_t>*> presetData);

  /// @brief Method GetVolumeInfo, addr 0x2237e84, size 0x8, virtual true, abstract: false, final false
  inline bool GetVolumeInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method GetHeightFieldData, addr 0x2237e8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetVolumeInfo, addr 0x2237e94, size 0x8, virtual true, abstract: false, final false
  inline bool SetVolumeInfo(int32_t nodeID, int32_t partID, ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method SetVolumeTileFloatData, addr 0x2237e9c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetVolumeBounds, addr 0x2237ee8, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method SetHeightFieldData, addr 0x2237f1c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetActiveCacheCount, addr 0x2237f24, size 0xc, virtual true, abstract: false, final false
  inline bool GetActiveCacheCount(ByRef<int32_t> activeCacheCount);

  /// @brief Method GetActiveCacheNames, addr 0x2237f30, size 0x8, virtual true, abstract: false, final false
  inline bool GetActiveCacheNames(ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> cacheNamesArray, int32_t activeCacheCount);

  /// @brief Method GetCacheProperty, addr 0x2237f38, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCacheProperty, addr 0x2237f44, size 0x8, virtual true, abstract: false, final false
  inline bool SetCacheProperty(::StringW cacheName, ::HoudiniEngineUnity::HAPI_CacheProperty cacheProperty, int32_t propertyValue);

  /// @brief Method SaveGeoToFile, addr 0x2237f4c, size 0x8, virtual true, abstract: false, final false
  inline bool SaveGeoToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method LoadGeoFromFile, addr 0x2237f54, size 0x8, virtual true, abstract: false, final false
  inline bool LoadGeoFromFile(int32_t nodeID, ::StringW file_name);

  /// @brief Method SaveNodeToFile, addr 0x2237f5c, size 0x8, virtual true, abstract: false, final false
  inline bool SaveNodeToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method LoadNodeFromFile, addr 0x2237f64, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGeoSize, addr 0x2237f74, size 0xc, virtual true, abstract: false, final false
  inline bool GetGeoSize(int32_t nodeID, ::StringW format, ByRef<int32_t> size);

  /// @brief Method GetHandleInfo, addr 0x2237f80, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHandleBindingInfo, addr 0x2237f88, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertTransform, addr 0x2237f90, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GetTotalCookCount, addr 0x2237fa4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSessionSync, addr 0x2237fb0, size 0x8, virtual true, abstract: false, final false
  inline bool SetSessionSync(bool enable);

  /// @brief Method GetViewport, addr 0x2237fb8, size 0x8, virtual true, abstract: false, final false
  inline bool GetViewport(ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method SetViewport, addr 0x2237fc0, size 0x8, virtual true, abstract: false, final false
  inline bool SetViewport(ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method GetSessionSyncInfo, addr 0x2237fc8, size 0x8, virtual true, abstract: false, final false
  inline bool GetSessionSyncInfo(ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method SetSessionSyncInfo, addr 0x2237fd0, size 0x8, virtual true, abstract: false, final false
  inline bool SetSessionSyncInfo(ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method SetNodeDisplay, addr 0x2237fd8, size 0x8, virtual true, abstract: false, final false
