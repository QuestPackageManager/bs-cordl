...
public:
  ...
  /// @brief Method AddAttribute, addr 0x3a58a68, size 0x8, virtual true, abstract: false, final false
  inline bool AddAttribute(int32_t nodeID, int32_t partID, ::StringW name, ::ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo);

  /// @brief Method AddGroup, addr 0x3a58a70, size 0x8, virtual true, abstract: false, final false
  inline bool AddGroup(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_GroupType groupType, ::StringW groupName);

  /// @brief Method CheckAndCloseExistingSession, addr 0x3a5866c, size 0x8, virtual true, abstract: false, final false
  inline bool CheckAndCloseExistingSession();

  /// @brief Method CheckForSpecificErrors, addr 0x3a587fc, size 0x8, virtual true, abstract: false, final false
  inline int32_t CheckForSpecificErrors(int32_t nodeID, int32_t errorsToCheck);

  /// @brief Method CheckVersionMatch, addr 0x3a58704, size 0x8, virtual true, abstract: false, final false
  inline bool CheckVersionMatch();

  /// @brief Method ClearSessionInfo, addr 0x3a58674, size 0x20, virtual true, abstract: false, final false
  inline void ClearSessionInfo();

  /// @brief Method CloseSession, addr 0x3a58664, size 0x8, virtual true, abstract: false, final false
  inline bool CloseSession();

  /// @brief Method CommitGeo, addr 0x3a58a88, size 0x8, virtual true, abstract: false, final false
  inline bool CommitGeo(int32_t nodeID);

  /// @brief Method ComposeChildNodeList, addr 0x3a588cc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ComposeNodeCookResult, addr 0x3a5879c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ComposeNodeCookResult(int32_t nodeId, ::HoudiniEngineUnity::HAPI_StatusVerbosity verbosity);

  /// @brief Method ComposeObjectList, addr 0x3a58904, size 0xc, virtual true, abstract: false, final false
  inline bool ComposeObjectList(int32_t nodeID, ::ByRef<int32_t> objectCount);

  /// @brief Method ConnectNodeInput, addr 0x3a58868, size 0x8, virtual true, abstract: false, final false
  inline bool ConnectNodeInput(int32_t nodeID, int32_t inputIndex, int32_t nodeIDToConnect, int32_t outputIndex);

  /// @brief Method ConnectThriftPipeSession, addr 0x3a5865c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConnectThriftSocketSession, addr 0x3a58654, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ConvertTransform, addr 0x3a58e3c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CookNode, addr 0x3a58850, size 0x8, virtual true, abstract: false, final false
  inline bool CookNode(int32_t nodeID, bool bCookTemplatedGeos, bool bSplitGeosByGroup);

  /// @brief Method CookNodeWithOptions, addr 0x3a58858, size 0x8, virtual true, abstract: false, final false
  inline bool CookNodeWithOptions(int32_t nodeID, ::HoudiniEngineUnity::HAPI_CookOptions cookOptions);

  /// @brief Method CreateCustomSession, addr 0x3a5864c, size 0x8, virtual true, abstract: false, final false
  inline bool CreateCustomSession(bool bIsDefaultSession);

  /// @brief Method CreateHeightFieldInput, addr 0x3a58ca4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateHeightfieldInputVolumeNode, addr 0x3a58cc4, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateInProcessSession, addr 0x3a58634, size 0x8, virtual true, abstract: false, final false
  inline bool CreateInProcessSession(bool bIsDefaultSession);

  /// @brief Method CreateInputNode, addr 0x3a58c94, size 0x10, virtual true, abstract: false, final false
  inline bool CreateInputNode(::ByRef<int32_t> nodeID, ::StringW name);

  /// @brief Method CreateNode, addr 0x3a5883c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateSessionData, addr 0x3a5862c, size 0x8, virtual true, abstract: false, final false
  inline bool CreateSessionData(bool bOverwriteExisting, bool bIsDefaultSession);

  /// @brief Method CreateThriftPipeSession, addr 0x3a58644, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateThriftSocketSession, addr 0x3a5863c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method DeleteGroup, addr 0x3a58a78, size 0x8, virtual true, abstract: false, final false
  inline bool DeleteGroup(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_GroupType groupType, ::StringW groupName);

  /// @brief Method DeleteNode, addr 0x3a5884c, size 0x4, virtual true, abstract: false, final false
  inline void DeleteNode(int32_t nodeID);

  /// @brief Method DisconnectNodeInput, addr 0x3a58870, size 0x8, virtual true, abstract: false, final false
  inline bool DisconnectNodeInput(int32_t nodeID, int32_t inputIndex, bool bLogError);

  /// @brief Method ExtractImageToFile, addr 0x3a58b90, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method ExtractImageToMemory, addr 0x3a58af0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method GetActiveCacheCount, addr 0x3a58dd0, size 0xc, virtual true, abstract: false, final false
  inline bool GetActiveCacheCount(::ByRef<int32_t> activeCacheCount);

  /// @brief Method GetActiveCacheNames, addr 0x3a58ddc, size 0x8, virtual true, abstract: false, final false
  inline bool GetActiveCacheNames(::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> cacheNamesArray, int32_t activeCacheCount);

  /// @brief Method GetAssetInfo, addr 0x3a588a8, size 0x8, virtual true, abstract: false, final false
  inline bool GetAssetInfo(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_AssetInfo> assetInfo);

  /// @brief Method GetAttributeFloat64Data, addr 0x3a58958, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloatData, addr 0x3a58950, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInfo, addr 0x3a58938, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt16Data, addr 0x3a58978, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt64Data, addr 0x3a58980, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeInt8Data, addr 0x3a58970, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeIntData, addr 0x3a58960, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeNames, addr 0x3a58940, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringData, addr 0x3a58948, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAttributeUInt8Data, addr 0x3a58968, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAvailableAssetCount, addr 0x3a58894, size 0xc, virtual true, abstract: false, final false
  inline bool GetAvailableAssetCount(int32_t libraryID, ::ByRef<int32_t> assetCount);

  /// @brief Method GetAvailableAssets, addr 0x3a588a0, size 0x8, virtual true, abstract: false, final false
  inline bool GetAvailableAssets(int32_t libraryID, ::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> assetNames, int32_t assetCount);

  /// @brief Method GetBoxInfo, addr 0x3a589f0, size 0x8, virtual true, abstract: false, final false
  inline bool GetBoxInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_BoxInfo> boxInfo);

  /// @brief Method GetCacheProperty, addr 0x3a58de4, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCallResult, addr 0x3a58738, size 0xc, virtual true, abstract: false, final false
  inline bool GetCallResult(::ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetComposedChildNodeList, addr 0x3a588d4, size 0x8, virtual true, abstract: false, final false
  inline bool GetComposedChildNodeList(int32_t parentNodeID, ::ArrayW<int32_t, ::Array<int32_t>*> childNodeIDs, int32_t count);

  /// @brief Method GetComposedObjectList, addr 0x3a58910, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetComposedObjectTransforms, addr 0x3a58918, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCookResult, addr 0x3a58744, size 0xc, virtual true, abstract: false, final false
  inline bool GetCookResult(::ByRef<::HoudiniEngineUnity::HAPI_Result> result);

  /// @brief Method GetCookState, addr 0x3a58750, size 0xc, virtual true, abstract: false, final false
  inline bool GetCookState(::ByRef<::HoudiniEngineUnity::HAPI_State> state);

  /// @brief Method GetCurveCounts, addr 0x3a58a08, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCurveInfo, addr 0x3a58a00, size 0x8, virtual true, abstract: false, final false
  inline bool GetCurveInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_CurveInfo> curveInfo);

  /// @brief Method GetCurveKnots, addr 0x3a58a18, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCurveOrders, addr 0x3a58a10, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetDisplayGeoInfo, addr 0x3a58920, size 0x8, virtual true, abstract: false, final false
  inline bool GetDisplayGeoInfo(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_GeoInfo> geoInfo, bool bLogError);

  /// @brief Method GetEnvInt, addr 0x3a587dc, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetEnvInt(::HoudiniEngineUnity::HAPI_EnvIntType intType);

  /// @brief Method GetFaceCounts, addr 0x3a589d8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetFaceCounts, addr 0x3a589e0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGeoInfo, addr 0x3a58928, size 0x8, virtual true, abstract: false, final false
  inline bool GetGeoInfo(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_GeoInfo> geoInfo, bool bLogError);

  /// @brief Method GetGeoSize, addr 0x3a58e20, size 0xc, virtual true, abstract: false, final false
  inline bool GetGeoSize(int32_t nodeID, ::StringW format, ::ByRef<int32_t> size);

  /// @brief Method GetGroupCountOnPackedInstancePart, addr 0x3a58998, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupMembership, addr 0x3a58990, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupMembershipOnPackedInstancePart, addr 0x3a589b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupNames, addr 0x3a58988, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetGroupNamesOnPackedInstancePart, addr 0x3a589a8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHandleBindingInfo, addr 0x3a58e34, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHandleInfo, addr 0x3a58e2c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHeightFieldData, addr 0x3a58d38, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetImageInfo, addr 0x3a58ad0, size 0x8, virtual true, abstract: false, final false
  inline bool GetImageInfo(int32_t materialNodeID, ::ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method GetImagePlanes, addr 0x3a58b44, size 0x4c, virtual true, abstract: false, final false
  inline bool GetImagePlanes(int32_t nodeID, ::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> imagePlanes, int32_t numImagePlanes);

  /// @brief Method GetInstanceTransformsOnPart, addr 0x3a589c8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstancedObjectIds, addr 0x3a589d0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstancedPartIds, addr 0x3a589b8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstancerPartTransforms, addr 0x3a589c0, size 0x8, virtual true, abstract: false, final false
  inline bool GetInstancerPartTransforms(int32_t nodeID, int32_t partID, ::HoudiniEngineUnity::HAPI_RSTOrder rstOrder,
                                         ::ByRef<::ArrayW<::HoudiniEngineUnity::HAPI_Transform, ::Array<::HoudiniEngineUnity::HAPI_Transform>*>> transformsArray, int32_t start, int32_t length);

  /// @brief Method GetLastSessionError, addr 0x3a586fc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetLastSessionError();

  /// @brief Method GetMaterialInfo, addr 0x3a58ac8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMaterialNodeIDsOnFaces, addr 0x3a58ac0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetMaterialOnPart, addr 0x3a58ab8, size 0x8, virtual true, abstract: false, final false
  inline bool GetMaterialOnPart(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_MaterialInfo> materialInfo);

  /// @brief Method GetNodeInfo, addr 0x3a588b0, size 0x8, virtual true, abstract: false, final false
  inline bool GetNodeInfo(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_NodeInfo> nodeInfo, bool bLogError);

  /// @brief Method GetNodeInputName, addr 0x3a58888, size 0xc, virtual true, abstract: false, final false
  inline bool GetNodeInputName(int32_t nodeID, int32_t inputIndex, ::ByRef<int32_t> nodeNameIndex);

  /// @brief Method GetNodePath, addr 0x3a588b8, size 0xc, virtual true, abstract: false, final false
  inline bool GetNodePath(int32_t nodeID, int32_t relativeNodeID, ::ByRef<::StringW> path);

  /// @brief Method GetObjectInfo, addr 0x3a588ec, size 0x8, virtual true, abstract: false, final false
  inline bool GetObjectInfo(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_ObjectInfo> objectInfo);

  /// @brief Method GetObjectTransform, addr 0x3a588f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetParamChoiceValues, addr 0x3a58c10, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetParamFloatValue, addr 0x3a58be0, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamFloatValue(int32_t nodeID, ::StringW parmName, int32_t index, ::ByRef<float_t> value);

  /// @brief Method GetParamFloatValues, addr 0x3a58bd8, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamFloatValues(int32_t nodeID, ::ByRef<::ArrayW<float_t, ::Array<float_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParamIntValue, addr 0x3a58bcc, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamIntValue(int32_t nodeID, ::StringW parmName, int32_t index, ::ByRef<int32_t> value);

  /// @brief Method GetParamIntValues, addr 0x3a58bc4, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamIntValues(int32_t nodeID, ::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParamNodeValue, addr 0x3a58c00, size 0x10, virtual true, abstract: false, final false
  inline bool GetParamNodeValue(int32_t nodeID, ::StringW paramName, ::ByRef<int32_t> nodeValue);

  /// @brief Method GetParamStringValue, addr 0x3a58bf4, size 0xc, virtual true, abstract: false, final false
  inline bool GetParamStringValue(int32_t nodeID, ::StringW parmName, int32_t index, ::ByRef<int32_t> value);

  /// @brief Method GetParamStringValues, addr 0x3a58bec, size 0x8, virtual true, abstract: false, final false
  inline bool GetParamStringValues(int32_t nodeID, ::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method GetParams, addr 0x3a58b9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetParmIDFromName, addr 0x3a58c78, size 0x10, virtual true, abstract: false, final false
  inline bool GetParmIDFromName(int32_t nodeID, ::StringW parmName, ::ByRef<int32_t> parmID);

  /// @brief Method GetParmStringValue, addr 0x3a58c88, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmStringValue(int32_t nodeID, ::StringW parmName, int32_t index, bool evaluate, ::ByRef<int32_t> value);

  /// @brief Method GetParmTagName, addr 0x3a58ba4, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmTagName(int32_t nodeID, int32_t parmID, int32_t tagIndex, ::ByRef<int32_t> tagName);

  /// @brief Method GetParmTagValue, addr 0x3a58bb0, size 0xc, virtual true, abstract: false, final false
  inline bool GetParmTagValue(int32_t nodeID, int32_t parmID, ::StringW tagName, ::ByRef<int32_t> tagValue);

  /// @brief Method GetParmWithTag, addr 0x3a58c60, size 0x8, virtual true, abstract: false, final false
  inline bool GetParmWithTag(int32_t nodeID, ::StringW tagName, ::ByRef<int32_t> parmID);

  /// @brief Method GetPartInfo, addr 0x3a58930, size 0x8, virtual true, abstract: false, final false
  inline bool GetPartInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method GetPreset, addr 0x3a58cd4, size 0x54, virtual true, abstract: false, final false
  inline bool GetPreset(int32_t nodeID, ::ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> presetData);

  /// @brief Method GetRegisteredAssetFromID, addr 0x3a58274, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> GetRegisteredAssetFromID(int32_t id);

  /// @brief Method GetServerEnvString, addr 0x3a58720, size 0xc, virtual true, abstract: false, final false
  inline bool GetServerEnvString(::StringW name, ::ByRef<::StringW> value);

  /// @brief Method GetServerEnvVarCount, addr 0x3a5872c, size 0xc, virtual true, abstract: false, final false
  inline bool GetServerEnvVarCount(::ByRef<int32_t> env_count);

  /// @brief Method GetSessionData, addr 0x3a586a4, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionData* GetSessionData();

  /// @brief Method GetSessionEnvInt, addr 0x3a587e4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetSessionEnvInt(::HoudiniEngineUnity::HAPI_SessionEnvIntType intType, bool bLogError);

  /// @brief Method GetSessionErrorMsg, addr 0x3a58204, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetSessionErrorMsg();

  /// @brief Method GetSessionInfo, addr 0x3a586ac, size 0x40, virtual true, abstract: false, final false
  inline ::StringW GetSessionInfo();

  /// @brief Method GetSessionSyncInfo, addr 0x3a58e74, size 0x8, virtual true, abstract: false, final false
  inline bool GetSessionSyncInfo(::ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method GetSphereInfo, addr 0x3a589f8, size 0x8, virtual true, abstract: false, final false
  inline bool GetSphereInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_SphereInfo> sphereInfo);

  /// @brief Method GetStatusString, addr 0x3a5875c, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method GetString, addr 0x3a587ec, size 0x8, virtual true, abstract: false, final false
  inline bool GetString(int32_t stringHandle, ::ByRef<::StringW> resultString, int32_t bufferLength);

  /// @brief Method GetStringBufferLength, addr 0x3a587f4, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetStringBufferLength(int32_t stringHandle);

  /// @brief Method GetTime, addr 0x3a58804, size 0x8, virtual true, abstract: false, final false
  inline float_t GetTime();

  /// @brief Method GetTotalCookCount, addr 0x3a58e50, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method GetUseHoudiniTime, addr 0x3a58814, size 0x8, virtual true, abstract: false, final false
  inline bool GetUseHoudiniTime();

  /// @brief Method GetVertexList, addr 0x3a589e8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetViewport, addr 0x3a58e64, size 0x8, virtual true, abstract: false, final false
  inline bool GetViewport(::ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method GetVolumeBounds, addr 0x3a58d94, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method GetVolumeInfo, addr 0x3a58d30, size 0x8, virtual true, abstract: false, final false
  inline bool GetVolumeInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method HandleStatusResult, addr 0x3a58714, size 0x8, virtual true, abstract: false, final false
  inline bool HandleStatusResult(::HoudiniEngineUnity::HAPI_Result result, ::StringW prependMsg, bool bThrowError, bool bLogError);

  /// @brief Method InitializeSession, addr 0x3a5870c, size 0x8, virtual true, abstract: false, final false
  inline bool InitializeSession(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method InsertMultiparmInstance, addr 0x3a58c50, size 0x8, virtual true, abstract: false, final false
  inline bool InsertMultiparmInstance(int32_t nodeID, int32_t parmID, int32_t instancePosition);

  /// @brief Method IsAssetRegistered, addr 0x3a5827c, size 0x8, virtual true, abstract: false, final false
  inline bool IsAssetRegistered(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method IsNodeValid, addr 0x3a588c4, size 0x8, virtual true, abstract: false, final false
  inline bool IsNodeValid(int32_t nodeID, int32_t uniqueNodeID);

  /// @brief Method IsSessionSync, addr 0x3a58234, size 0x20, virtual false, abstract: false, final false
  inline bool IsSessionSync();

  /// @brief Method IsSessionValid, addr 0x3a586ec, size 0x8, virtual true, abstract: false, final false
  inline bool IsSessionValid();

  /// @brief Method LoadAssetLibraryFromFile, addr 0x3a58824, size 0xc, virtual true, abstract: false, final false
  inline bool LoadAssetLibraryFromFile(::StringW assetPath, bool bAllowOverwrite, ::ByRef<int32_t> libraryID);

  /// @brief Method LoadAssetLibraryFromMemory, addr 0x3a58830, size 0xc, virtual true, abstract: false, final false
  inline bool LoadAssetLibraryFromMemory(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, bool bAllowOverwrite, ::ByRef<int32_t> libraryID);

  /// @brief Method LoadGeoFromFile, addr 0x3a58e00, size 0x8, virtual true, abstract: false, final false
  inline bool LoadGeoFromFile(int32_t nodeID, ::StringW file_name);

  /// @brief Method LoadHIPFile, addr 0x3a588dc, size 0x8, virtual true, abstract: false, final false
  inline bool LoadHIPFile(::StringW fileName, bool bCookOnLoad);

  /// @brief Method LoadNodeFromFile, addr 0x3a58e10, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method ParmHasTag, addr 0x3a58bbc, size 0x8, virtual true, abstract: false, final false
  inline bool ParmHasTag(int32_t nodeID, int32_t parmID, ::StringW tagName, ::ByRef<bool> hasTag);

  /// @brief Method QueryNodeInput, addr 0x3a58878, size 0x10, virtual true, abstract: false, final false
  inline bool QueryNodeInput(int32_t nodeID, int32_t inputIndex, ::ByRef<int32_t> connectedNodeID, bool bLogError);

  /// @brief Method RegisterAsset, addr 0x3a58284, size 0x4, virtual true, abstract: false, final false
  inline void RegisterAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method RemoveMultiParmInstance, addr 0x3a58c58, size 0x8, virtual true, abstract: false, final false
  inline bool RemoveMultiParmInstance(int32_t nodeID, int32_t parmID, int32_t instancePosition);

  /// @brief Method RenameNode, addr 0x3a58860, size 0x8, virtual true, abstract: false, final false
  inline bool RenameNode(int32_t nodeID, ::StringW newName);

  /// @brief Method RenderCOPToImage, addr 0x3a58ae8, size 0x8, virtual true, abstract: false, final false
  inline bool RenderCOPToImage(int32_t copNodeID);

  /// @brief Method RenderTextureToImage, addr 0x3a58ae0, size 0x8, virtual true, abstract: false, final false
  inline bool RenderTextureToImage(int32_t materialNodeID, int32_t parmID, bool bLogError);

  /// @brief Method ReregisterOnAwake, addr 0x3a5828c, size 0x4, virtual true, abstract: false, final false
  inline void ReregisterOnAwake(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method RestartSession, addr 0x3a586f4, size 0x8, virtual true, abstract: false, final false
  inline bool RestartSession();

  /// @brief Method RevertGeo, addr 0x3a58a90, size 0x8, virtual true, abstract: false, final false
  inline bool RevertGeo(int32_t nodeID);

  /// @brief Method RevertParmToDefault, addr 0x3a58c68, size 0x8, virtual true, abstract: false, final false
  inline bool RevertParmToDefault(int32_t nodeID, ::StringW parm_name, int32_t index);

  /// @brief Method RevertParmToDefaults, addr 0x3a58c70, size 0x8, virtual true, abstract: false, final false
  inline bool RevertParmToDefaults(int32_t nodeID, ::StringW parm_name);

  /// @brief Method SaveGeoToFile, addr 0x3a58df8, size 0x8, virtual true, abstract: false, final false
  inline bool SaveGeoToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method SaveHIPFile, addr 0x3a588e4, size 0x8, virtual true, abstract: false, final false
  inline bool SaveHIPFile(::StringW fileName, bool bLockNodes);

  /// @brief Method SaveNodeToFile, addr 0x3a58e08, size 0x8, virtual true, abstract: false, final false
  inline bool SaveNodeToFile(int32_t nodeID, ::StringW fileName);

  /// @brief Method SetAttributeFloatData, addr 0x3a58a58, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt16Data, addr 0x3a58a48, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt64Data, addr 0x3a58a50, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeInt8Data, addr 0x3a58a40, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeIntData, addr 0x3a58a38, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetAttributeStringData, addr 0x3a58a60, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCacheProperty, addr 0x3a58df0, size 0x8, virtual true, abstract: false, final false
  inline bool SetCacheProperty(::StringW cacheName, ::HoudiniEngineUnity::HAPI_CacheProperty cacheProperty, int32_t propertyValue);

  /// @brief Method SetCurveCounts, addr 0x3a58aa0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCurveInfo, addr 0x3a58a98, size 0x8, virtual true, abstract: false, final false
  inline bool SetCurveInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_CurveInfo> curveInfo);

  /// @brief Method SetCurveKnots, addr 0x3a58ab0, size 0x8, virtual true, abstract: false, final false
  inline bool SetCurveKnots(int32_t nodeID, int32_t partID, ::ArrayW<float_t, ::Array<float_t>*> knots, int32_t start, int32_t length);

  /// @brief Method SetCurveOrders, addr 0x3a58aa8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetFaceCount, addr 0x3a58a28, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetGroupMembership, addr 0x3a58a80, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetHeightFieldData, addr 0x3a58dc8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetImageInfo, addr 0x3a58ad8, size 0x8, virtual true, abstract: false, final false
  inline bool SetImageInfo(int32_t materialNodeID, ::ByRef<::HoudiniEngineUnity::HAPI_ImageInfo> imageInfo);

  /// @brief Method SetLibraryErrorMsg, addr 0x3a58574, size 0xb8, virtual true, abstract: false, final false
  inline void SetLibraryErrorMsg(bool bLogError);

  /// @brief Method SetNodeDisplay, addr 0x3a58e84, size 0x8, virtual true, abstract: false, final false
  inline bool SetNodeDisplay(int32_t node_id, int32_t onOff);

  /// @brief Method SetObjectTransform, addr 0x3a588fc, size 0x8, virtual true, abstract: false, final false
  inline bool SetObjectTransform(int32_t nodeID, ::ByRef<::HoudiniEngineUnity::HAPI_TransformEuler> hapiTransform);

  /// @brief Method SetParamFloatValue, addr 0x3a58c30, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamFloatValue(int32_t nodeID, ::StringW paramName, int32_t index, float_t value);

  /// @brief Method SetParamFloatValues, addr 0x3a58c28, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamFloatValues(int32_t nodeID, ::ByRef<::ArrayW<float_t, ::Array<float_t>*>> values, int32_t start, int32_t length);

  /// @brief Method SetParamIntValue, addr 0x3a58c20, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamIntValue(int32_t nodeID, ::StringW paramName, int32_t index, int32_t value);

  /// @brief Method SetParamIntValues, addr 0x3a58c18, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamIntValues(int32_t nodeID, ::ByRef<::ArrayW<int32_t, ::Array<int32_t>*>> values, int32_t start, int32_t length);

  /// @brief Method SetParamNodeValue, addr 0x3a58c48, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamNodeValue(int32_t nodeID, ::StringW paramName, int32_t nodeValueID);

  /// @brief Method SetParamStringValue, addr 0x3a58c40, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamStringValue(int32_t nodeID, ::StringW parmName, ::StringW parmValue, int32_t index);

  /// @brief Method SetParamStringValue, addr 0x3a58c38, size 0x8, virtual true, abstract: false, final false
  inline bool SetParamStringValue(int32_t nodeID, ::StringW strValue, int32_t parmID, int32_t index);

  /// @brief Method SetPartInfo, addr 0x3a58a20, size 0x8, virtual true, abstract: false, final false
  inline bool SetPartInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_PartInfo> partInfo);

  /// @brief Method SetPreset, addr 0x3a58d28, size 0x8, virtual true, abstract: false, final false
  inline bool SetPreset(int32_t nodeID, ::ArrayW<uint8_t, ::Array<uint8_t>*> presetData);

  /// @brief Method SetServerEnvString, addr 0x3a5871c, size 0x4, virtual true, abstract: false, final false
  inline void SetServerEnvString(::StringW name, ::StringW value);

  /// @brief Method SetSessionConnectionErrorMsg, addr 0x3a582d0, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSessionData, addr 0x3a5869c, size 0x8, virtual false, abstract: false, final false
  inline void SetSessionData(::HoudiniEngineUnity::HEU_SessionData* sessionData);

  /// @brief Method SetSessionErrorMsg, addr 0x3a582b0, size 0x20, virtual true, abstract: false, final false
  inline void SetSessionErrorMsg(::StringW msg, bool bLogError);

  /// @brief Method SetSessionSync, addr 0x3a58e5c, size 0x8, virtual true, abstract: false, final false
  inline bool SetSessionSync(bool enable);

  /// @brief Method SetSessionSyncInfo, addr 0x3a58e7c, size 0x8, virtual true, abstract: false, final false
  inline bool SetSessionSyncInfo(::ByRef<::HoudiniEngineUnity::HAPI_SessionSyncInfo> syncInfo);

  /// @brief Method SetTime, addr 0x3a5880c, size 0x8, virtual true, abstract: false, final false
  inline bool SetTime(float_t time);

  /// @brief Method SetUseHoudiniTime, addr 0x3a5881c, size 0x8, virtual true, abstract: false, final false
  inline bool SetUseHoudiniTime(bool enable);

  /// @brief Method SetVertexList, addr 0x3a58a30, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method SetViewport, addr 0x3a58e6c, size 0x8, virtual true, abstract: false, final false
  inline bool SetViewport(::ByRef<::HoudiniEngineUnity::HAPI_Viewport> viewport);

  /// @brief Method SetVolumeInfo, addr 0x3a58d40, size 0x8, virtual true, abstract: false, final false
  inline bool SetVolumeInfo(int32_t nodeID, int32_t partID, ::ByRef<::HoudiniEngineUnity::HAPI_VolumeInfo> volumeInfo);

  /// @brief Method SetVolumeTileFloatData, addr 0x3a58d48, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method UnregisterAsset, addr 0x3a58288, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a58290, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConnectionState, addr 0x3a581b4, size 0x18, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionConnectionState get_ConnectionState();

  /// @brief Method get_LastCallResultCode, addr 0x3a58264, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HAPI_Result get_LastCallResultCode();

  /// @brief Method get_LogErrorOverride, addr 0x3a5820c, size 0x8, virtual false, abstract: false, final false
  inline bool get_LogErrorOverride();

  /// @brief Method get_ThisSessionMode, addr 0x3a581dc, size 0x18, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::SessionMode get_ThisSessionMode();

  /// @brief Method get_ThrowErrorOverride, addr 0x3a58220, size 0x8, virtual false, abstract: false, final false
  inline bool get_ThrowErrorOverride();

  /// @brief Method get_UserNotifiedSessionInvalid, addr 0x3a581a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_UserNotifiedSessionInvalid();

  /// @brief Method set_ConnectionState, addr 0x3a581cc, size 0x10, virtual false, abstract: false, final false
  inline void set_ConnectionState(::HoudiniEngineUnity::SessionConnectionState value);

  /// @brief Method set_LastCallResultCode, addr 0x3a5826c, size 0x8, virtual false, abstract: false, final false
  inline void set_LastCallResultCode(::HoudiniEngineUnity::HAPI_Result value);

  /// @brief Method set_LogErrorOverride, addr 0x3a58214, size 0xc, virtual false, abstract: false, final false
  inline void set_LogErrorOverride(bool value);

  /// @brief Method set_ThisSessionMode, addr 0x3a581f4, size 0x10, virtual false, abstract: false, final false
  inline void set_ThisSessionMode(::HoudiniEngineUnity::SessionMode value);

  /// @brief Method set_ThrowErrorOverride, addr 0x3a58228, size 0xc, virtual false, abstract: false, final false
  inline void set_ThrowErrorOverride(bool value);

  /// @brief Method set_UserNotifiedSessionInvalid, addr 0x3a581a8, size 0xc, virtual false, abstract: false, final false
