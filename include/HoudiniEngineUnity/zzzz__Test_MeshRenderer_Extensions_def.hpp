...
class Test_MeshRenderer_Extensions___c;
}
namespace HoudiniEngineUnity {
...
MARK_REF_PTR_T(::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c);
// Dependencies System.Object
namespace HoudiniEngineUnity {
// Is value type: false
// CS Name: HoudiniEngineUnity.Test_MeshRenderer_Extensions/<>c
class CORDL_TYPE Test_MeshRenderer_Extensions___c : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9, put = setStaticF___9)) ::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c* __9;

  /// @brief Field <>9__1_0, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9__1_0, put = setStaticF___9__1_0)) ::System::Converter_2<::UnityW<::UnityEngine::MeshRenderer>, ::HoudiniEngineUnity::Test_MeshRenderer*>* __9__1_0;

  /// @brief Field <>9__2_0, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9__2_0, put = setStaticF___9__2_0)) ::System::Converter_2<::UnityW<::UnityEngine::MeshRenderer>, ::HoudiniEngineUnity::Test_MeshRenderer*>* __9__2_0;

  static inline ::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c* New_ctor();

  /// @brief Method <ToTestObject>b__1_0, addr 0x3aa7e80, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__1_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3aa7edc, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__2_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method .ctor, addr 0x3aa7e78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c* getStaticF___9();
  ...
  static inline void setStaticF___9(::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr Test_MeshRenderer_Extensions___c();

public:
  // Ctor Parameters [CppParam { name: "", ty: "Test_MeshRenderer_Extensions___c", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Test_MeshRenderer_Extensions___c(Test_MeshRenderer_Extensions___c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Test_MeshRenderer_Extensions___c", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Test_MeshRenderer_Extensions___c(Test_MeshRenderer_Extensions___c const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c, 0x10>, "Size mismatch!");
...
public:
  // Declarations
  using __c = ::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c;

  /// @brief Method ToTestObject, addr 0x3aa7c34, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3aa4004, size 0x5c, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_MeshRenderer* ToTestObject(::UnityEngine::MeshRenderer* self);

  /// @brief Method ToTestObject, addr 0x3aa7d24, size 0xf8, virtual false, abstract: false, final false
...
NEED_NO_BOX(::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::Test_MeshRenderer_Extensions___c*, "HoudiniEngineUnity", "Test_MeshRenderer_Extensions/<>c");
