...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x24c85ac, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__1_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x24c8610, size 0x64, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__2_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method .ctor, addr 0x24c85a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x24c834c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x24c4600, size 0x64, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_MeshRenderer* ToTestObject(::UnityEngine::MeshRenderer* self);

  /// @brief Method ToTestObject, addr 0x24c8444, size 0xfc, virtual false, abstract: false, final false
