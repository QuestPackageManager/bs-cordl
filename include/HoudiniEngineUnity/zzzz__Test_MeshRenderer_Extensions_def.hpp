...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x3a9a6e0, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__1_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3a9a73c, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_MeshRenderer* _ToTestObject_b__2_0(::UnityEngine::MeshRenderer* lod);

  /// @brief Method .ctor, addr 0x3a9a6d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x3a9a494, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3a96864, size 0x5c, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_MeshRenderer* ToTestObject(::UnityEngine::MeshRenderer* self);

  /// @brief Method ToTestObject, addr 0x3a9a584, size 0xf8, virtual false, abstract: false, final false
