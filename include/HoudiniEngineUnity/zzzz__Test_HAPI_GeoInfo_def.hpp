...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a91eb8, size 0x300, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a91e84, size 0x34, virtual false, abstract: false, final false
