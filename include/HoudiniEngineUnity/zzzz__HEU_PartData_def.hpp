...
public:
  ...
  /// @brief Method <CopyGameObjectComponents>b__85_0, addr 0x3a30f98, size 0x18, virtual false, abstract: false, final false
  inline int32_t _CopyGameObjectComponents_b__85_0(::UnityEngine::LOD a, ::UnityEngine::LOD b);

  /// @brief Method .ctor, addr 0x3a30f90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CopyChildGameObjects>b__0, addr 0x3a30fb0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a2ed94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__0, addr 0x3a310b8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a2f7e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__1, addr 0x3a311c0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a2f7ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppendBakedCloneName, addr 0x3a2eedc, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW AppendBakedCloneName(::StringW name);

  /// @brief Method ApplyHAPITransform, addr 0x3a2aae4, size 0x15c, virtual false, abstract: false, final false
  inline void ApplyHAPITransform(::ByRef<::HoudiniEngineUnity::HAPI_Transform> hapiTransform);

  /// @brief Method BakePartToGameObject, addr 0x3a2f00c, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToGameObject, addr 0x3a2ef28, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToNewGameObject, addr 0x3a2ed9c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateColliderState, addr 0x3a2c858, size 0x2ec, virtual false, abstract: false, final false
  inline void CalculateColliderState();

  /// @brief Method CalculateVisibility, addr 0x3a2c80c, size 0x30, virtual false, abstract: false, final false
  inline void CalculateVisibility(bool bParentVisibility, bool bParentDisplayGeo);

  /// @brief Method ClearGeneratedData, addr 0x3a2b2c0, size 0x18, virtual false, abstract: false, final false
  inline void ClearGeneratedData();

  /// @brief Method ClearGeneratedMeshOutput, addr 0x3a2b2d8, size 0x88, virtual false, abstract: false, final false
  inline void ClearGeneratedMeshOutput();

  /// @brief Method ClearGeneratedVolumeOutput, addr 0x3a2b360, size 0x34, virtual false, abstract: false, final false
  inline void ClearGeneratedVolumeOutput();

  /// @brief Method ClearInstances, addr 0x3a294b8, size 0x110, virtual false, abstract: false, final false
  inline void ClearInstances();

  /// @brief Method ClearInvalidObjectInstanceInfos, addr 0x3a295c8, size 0x200, virtual false, abstract: false, final false
  inline void ClearInvalidObjectInstanceInfos();

  /// @brief Method ClearObjectInstanceInfos, addr 0x3a2a93c, size 0xd0, virtual false, abstract: false, final false
  inline void ClearObjectInstanceInfos();

  /// @brief Method CopyChildGameObjects, addr 0x3a2e984, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyGameObjectComponents, addr 0x3a2cb44, size 0x1e40, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInstanceFromObject, addr 0x3a2bb90, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectInstanceInfo, addr 0x3a2c364, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllData, addr 0x3a2a808, size 0x134, virtual false, abstract: false, final false
  inline void DestroyAllData();

  /// @brief Method DestroyAttributesStore, addr 0x3a2aa0c, size 0xd8, virtual false, abstract: false, final false
  inline void DestroyAttributesStore();

  /// @brief Method DestroyPart, addr 0x3a2664c, size 0x2c, virtual false, abstract: false, final false
  static inline void DestroyPart(::HoudiniEngineUnity::HEU_PartData* part);

  /// @brief Method DestroyParts, addr 0x3a308e8, size 0xd4, virtual false, abstract: false, final false
  static inline void DestroyParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* parts);

  /// @brief Method GenerateAttributesStore, addr 0x3a2c4e8, size 0xb4, virtual false, abstract: false, final false
  inline void GenerateAttributesStore(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GenerateInstancesFromObject, addr 0x3a2bf94, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectID, addr 0x3a28f68, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectIds, addr 0x3a27d0c, size 0x5f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromUnityAssetPathAttribute, addr 0x3a28304, size 0xc64, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x3a26264, size 0x3e8, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePartInstances, addr 0x3a2b394, size 0x730, virtual false, abstract: false, final false
  inline void GeneratePartInstances(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetClonableObjects, addr 0x3a2ae90, size 0xfc, virtual false, abstract: false, final false
  inline void GetClonableObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* clonableObjects);

  /// @brief Method GetClonableParts, addr 0x3a2af8c, size 0xf4, virtual false, abstract: false, final false
  inline void GetClonableParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* clonableParts);

  /// @brief Method GetCurve, addr 0x3a2c59c, size 0x98, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_Curve> GetCurve(bool bEditableOnly);

  /// @brief Method GetDebugInfo, addr 0x3a2ac40, size 0x22c, virtual false, abstract: false, final false
  inline void GetDebugInfo(::System::Text::StringBuilder* sb);

  /// @brief Method GetHDAPartWithGameObject, addr 0x3a2b230, size 0x84, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_PartData> GetHDAPartWithGameObject(::UnityEngine::GameObject* inGameObject);

  /// @brief Method GetObjectInstanceInfoWithObjectID, addr 0x3a2bac4, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectID(int32_t objNodeID);

  /// @brief Method GetObjectInstanceInfoWithObjectPath, addr 0x3a2c28c, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectPath(::StringW path);

  /// @brief Method GetObjectInstanceInfos, addr 0x3a306c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo>>* GetObjectInstanceInfos();

  /// @brief Method GetOutput, addr 0x3a2b17c, size 0xb4, virtual false, abstract: false, final false
  inline void GetOutput(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutput*>* outputs);

  /// @brief Method GetOutputGameObjects, addr 0x3a2b080, size 0xfc, virtual false, abstract: false, final false
  inline void GetOutputGameObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* outputObjects);

  /// @brief Method GetPartPointCount, addr 0x3a2a3a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPartPointCount();

  /// @brief Method GetVolumeLayerName, addr 0x3a2a800, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetVolumeLayerName();

  /// @brief Method HaveInstancesBeenGenerated, addr 0x3a2a3f0, size 0x8, virtual false, abstract: false, final false
  inline bool HaveInstancesBeenGenerated();

  /// @brief Method Initialize, addr 0x3a2a4a4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAttribInstancer, addr 0x3a2a368, size 0x8, virtual false, abstract: false, final false
  inline bool IsAttribInstancer();

  /// @brief Method IsEquivalentTo, addr 0x3a309bc, size 0x578, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_PartData* other);

  /// @brief Method IsInstancerAnyType, addr 0x3a2a370, size 0x2c, virtual false, abstract: false, final false
  inline bool IsInstancerAnyType();

  /// @brief Method IsObjectInstancer, addr 0x3a2a3ac, size 0x8, virtual false, abstract: false, final false
  inline bool IsObjectInstancer();

  /// @brief Method IsPartCurve, addr 0x3a2a3c8, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartCurve();

  /// @brief Method IsPartEditable, addr 0x3a2a3e8, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartEditable();

  /// @brief Method IsPartInstanced, addr 0x3a2a39c, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartInstanced();

  /// @brief Method IsPartInstancer, addr 0x3a2a358, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartInstancer();

  /// @brief Method IsPartMesh, addr 0x3a2a3d8, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartMesh();

  /// @brief Method IsPartVolume, addr 0x3a27cfc, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartVolume();

  /// @brief Method IsUsingMaterial, addr 0x3a2ae6c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateObjectInstanceInfos, addr 0x3a29900, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCurvePart, addr 0x3a2f7f4, size 0x130, virtual false, abstract: false, final false
  inline void ProcessCurvePart(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SetColliderState, addr 0x3a2c83c, size 0x1c, virtual false, abstract: false, final false
  inline void SetColliderState(bool bEnabled);

  /// @brief Method SetGameObject, addr 0x3a2a7d4, size 0x24, virtual false, abstract: false, final false
  inline void SetGameObject(::UnityEngine::GameObject* gameObject);

  /// @brief Method SetGameObjectName, addr 0x3a2a68c, size 0x148, virtual false, abstract: false, final false
  inline void SetGameObjectName(::StringW partName);

  /// @brief Method SetObjectInstanceInfos, addr 0x3a3055c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method SetObjectInstancer, addr 0x3a2b2b4, size 0xc, virtual false, abstract: false, final false
  inline void SetObjectInstancer(bool bObjectInstancer);

  /// @brief Method SetTerrainData, addr 0x3a306d8, size 0x1a0, virtual false, abstract: false, final false
  inline void SetTerrainData(::UnityEngine::TerrainData* terrainData, ::StringW exportPathRelative, ::StringW exportPathUser);

  /// @brief Method SetTerrainOffsetPosition, addr 0x3a306cc, size 0xc, virtual false, abstract: false, final false
  inline void SetTerrainOffsetPosition(::UnityEngine::Vector3 offsetPosition);

  /// @brief Method SetVisiblity, addr 0x3a2c634, size 0x1d8, virtual false, abstract: false, final false
  inline void SetVisiblity(bool bVisibility);

  /// @brief Method SetVolumeLayerName, addr 0x3a2a7f8, size 0x8, virtual false, abstract: false, final false
  inline void SetVolumeLayerName(::StringW name);

  /// @brief Method SetupAttributeGeometry, addr 0x3a267cc, size 0xcc, virtual false, abstract: false, final false
  inline void SetupAttributeGeometry(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SyncAttributesStore, addr 0x3a2f924, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3a30878, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a2a42c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeneratedOutput, addr 0x3a2a400, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_GeneratedOutput* get_GeneratedOutput();

  /// @brief Method get_MeshVertexCount, addr 0x3a2a3f8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MeshVertexCount();

  /// @brief Method get_ObjectInstancesBeenGenerated, addr 0x3a2a3b4, size 0x8, virtual false, abstract: false, final false
  inline bool get_ObjectInstancesBeenGenerated();

  /// @brief Method get_OutputGameObject, addr 0x3a2a408, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_OutputGameObject();

  /// @brief Method get_ParentAsset, addr 0x3a2a2d0, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> get_ParentAsset();

  /// @brief Method get_ParentGeoNode, addr 0x3a2a2c8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_GeoNode> get_ParentGeoNode();

  /// @brief Method get_PartID, addr 0x3a2a2b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PartID();

  /// @brief Method get_PartName, addr 0x3a2a2c0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ObjectInstancesBeenGenerated, addr 0x3a2a3bc, size 0xc, virtual false, abstract: false, final false
