...
public:
  ...
  /// @brief Method <CopyGameObjectComponents>b__85_0, addr 0x23411ac, size 0x18, virtual false, abstract: false, final false
  inline int32_t _CopyGameObjectComponents_b__85_0(::UnityEngine::LOD a, ::UnityEngine::LOD b);

  /// @brief Method .ctor, addr 0x23411a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CopyChildGameObjects>b__0, addr 0x23411c4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x233ef6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__0, addr 0x23412d0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x233f9dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__1, addr 0x23413dc, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x233f9e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppendBakedCloneName, addr 0x233f0b4, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW AppendBakedCloneName(::StringW name);

  /// @brief Method ApplyHAPITransform, addr 0x233acec, size 0x168, virtual false, abstract: false, final false
  inline void ApplyHAPITransform(ByRef<::HoudiniEngineUnity::HAPI_Transform> hapiTransform);

  /// @brief Method BakePartToGameObject, addr 0x233f1e4, size 0x7f8, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToGameObject, addr 0x233f100, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToNewGameObject, addr 0x233ef74, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateColliderState, addr 0x233ca98, size 0x2d8, virtual false, abstract: false, final false
  inline void CalculateColliderState();

  /// @brief Method CalculateVisibility, addr 0x233ca4c, size 0x30, virtual false, abstract: false, final false
  inline void CalculateVisibility(bool bParentVisibility, bool bParentDisplayGeo);

  /// @brief Method ClearGeneratedData, addr 0x233b4e4, size 0x18, virtual false, abstract: false, final false
  inline void ClearGeneratedData();

  /// @brief Method ClearGeneratedMeshOutput, addr 0x233b4fc, size 0x88, virtual false, abstract: false, final false
  inline void ClearGeneratedMeshOutput();

  /// @brief Method ClearGeneratedVolumeOutput, addr 0x233b584, size 0x34, virtual false, abstract: false, final false
  inline void ClearGeneratedVolumeOutput();

  /// @brief Method ClearInstances, addr 0x23396a8, size 0x110, virtual false, abstract: false, final false
  inline void ClearInstances();

  /// @brief Method ClearInvalidObjectInstanceInfos, addr 0x23397b8, size 0x200, virtual false, abstract: false, final false
  inline void ClearInvalidObjectInstanceInfos();

  /// @brief Method ClearObjectInstanceInfos, addr 0x233ab48, size 0xcc, virtual false, abstract: false, final false
  inline void ClearObjectInstanceInfos();

  /// @brief Method CopyChildGameObjects, addr 0x233eb50, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyGameObjectComponents, addr 0x233cd70, size 0x1de0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInstanceFromObject, addr 0x233bdbc, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectInstanceInfo, addr 0x233c59c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllData, addr 0x233aa14, size 0x134, virtual false, abstract: false, final false
  inline void DestroyAllData();

  /// @brief Method DestroyAttributesStore, addr 0x233ac14, size 0xd8, virtual false, abstract: false, final false
  inline void DestroyAttributesStore();

  /// @brief Method DestroyPart, addr 0x23367ac, size 0x2c, virtual false, abstract: false, final false
  static inline void DestroyPart(::HoudiniEngineUnity::HEU_PartData* part);

  /// @brief Method DestroyParts, addr 0x2340ae4, size 0xd4, virtual false, abstract: false, final false
  static inline void DestroyParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* parts);

  /// @brief Method GenerateAttributesStore, addr 0x233c728, size 0xb4, virtual false, abstract: false, final false
  inline void GenerateAttributesStore(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GenerateInstancesFromObject, addr 0x233c1c4, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectID, addr 0x2339150, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectIds, addr 0x2337ec0, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromUnityAssetPathAttribute, addr 0x23384c0, size 0xc90, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x23363c0, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePartInstances, addr 0x233b5b8, size 0x738, virtual false, abstract: false, final false
  inline void GeneratePartInstances(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetClonableObjects, addr 0x233b0a4, size 0x100, virtual false, abstract: false, final false
  inline void GetClonableObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* clonableObjects);

  /// @brief Method GetClonableParts, addr 0x233b1a4, size 0xf8, virtual false, abstract: false, final false
  inline void GetClonableParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* clonableParts);

  /// @brief Method GetCurve, addr 0x233c7dc, size 0x98, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_Curve> GetCurve(bool bEditableOnly);

  /// @brief Method GetDebugInfo, addr 0x233ae54, size 0x22c, virtual false, abstract: false, final false
  inline void GetDebugInfo(::System::Text::StringBuilder* sb);

  /// @brief Method GetHDAPartWithGameObject, addr 0x233b454, size 0x84, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_PartData> GetHDAPartWithGameObject(::UnityEngine::GameObject* inGameObject);

  /// @brief Method GetObjectInstanceInfoWithObjectID, addr 0x233bcf0, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectID(int32_t objNodeID);

  /// @brief Method GetObjectInstanceInfoWithObjectPath, addr 0x233c4c4, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectPath(::StringW path);

  /// @brief Method GetObjectInstanceInfos, addr 0x23408c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo>>* GetObjectInstanceInfos();

  /// @brief Method GetOutput, addr 0x233b39c, size 0xb8, virtual false, abstract: false, final false
  inline void GetOutput(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutput*>* outputs);

  /// @brief Method GetOutputGameObjects, addr 0x233b29c, size 0x100, virtual false, abstract: false, final false
  inline void GetOutputGameObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* outputObjects);

  /// @brief Method GetPartPointCount, addr 0x233a5ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPartPointCount();

  /// @brief Method GetVolumeLayerName, addr 0x233aa0c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetVolumeLayerName();

  /// @brief Method HaveInstancesBeenGenerated, addr 0x233a5f8, size 0x8, virtual false, abstract: false, final false
  inline bool HaveInstancesBeenGenerated();

  /// @brief Method Initialize, addr 0x233a6b4, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAttribInstancer, addr 0x233a570, size 0x8, virtual false, abstract: false, final false
  inline bool IsAttribInstancer();

  /// @brief Method IsEquivalentTo, addr 0x2340bb8, size 0x588, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_PartData* other);

  /// @brief Method IsInstancerAnyType, addr 0x233a578, size 0x2c, virtual false, abstract: false, final false
  inline bool IsInstancerAnyType();

  /// @brief Method IsObjectInstancer, addr 0x233a5b4, size 0x8, virtual false, abstract: false, final false
  inline bool IsObjectInstancer();

  /// @brief Method IsPartCurve, addr 0x233a5d0, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartCurve();

  /// @brief Method IsPartEditable, addr 0x233a5f0, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartEditable();

  /// @brief Method IsPartInstanced, addr 0x233a5a4, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartInstanced();

  /// @brief Method IsPartInstancer, addr 0x233a560, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartInstancer();

  /// @brief Method IsPartMesh, addr 0x233a5e0, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartMesh();

  /// @brief Method IsPartVolume, addr 0x2337eb0, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartVolume();

  /// @brief Method IsUsingMaterial, addr 0x233b080, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateObjectInstanceInfos, addr 0x2339af0, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCurvePart, addr 0x233f9ec, size 0x138, virtual false, abstract: false, final false
  inline void ProcessCurvePart(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SetColliderState, addr 0x233ca7c, size 0x1c, virtual false, abstract: false, final false
  inline void SetColliderState(bool bEnabled);

  /// @brief Method SetGameObject, addr 0x233a9e0, size 0x24, virtual false, abstract: false, final false
  inline void SetGameObject(::UnityEngine::GameObject* gameObject);

  /// @brief Method SetGameObjectName, addr 0x233a898, size 0x148, virtual false, abstract: false, final false
  inline void SetGameObjectName(::StringW partName);

  /// @brief Method SetObjectInstanceInfos, addr 0x2340754, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetObjectInstancer, addr 0x233b4d8, size 0xc, virtual false, abstract: false, final false
  inline void SetObjectInstancer(bool bObjectInstancer);

  /// @brief Method SetTerrainData, addr 0x23408d4, size 0x1a0, virtual false, abstract: false, final false
  inline void SetTerrainData(::UnityEngine::TerrainData* terrainData, ::StringW exportPathRelative, ::StringW exportPathUser);

  /// @brief Method SetTerrainOffsetPosition, addr 0x23408c8, size 0xc, virtual false, abstract: false, final false
  inline void SetTerrainOffsetPosition(::UnityEngine::Vector3 offsetPosition);

  /// @brief Method SetVisiblity, addr 0x233c874, size 0x1d8, virtual false, abstract: false, final false
  inline void SetVisiblity(bool bVisibility);

  /// @brief Method SetVolumeLayerName, addr 0x233aa04, size 0x8, virtual false, abstract: false, final false
  inline void SetVolumeLayerName(::StringW name);

  /// @brief Method SetupAttributeGeometry, addr 0x233692c, size 0xcc, virtual false, abstract: false, final false
  inline void SetupAttributeGeometry(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SyncAttributesStore, addr 0x233fb24, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2340a74, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x233a634, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeneratedOutput, addr 0x233a608, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_GeneratedOutput* get_GeneratedOutput();

  /// @brief Method get_MeshVertexCount, addr 0x233a600, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MeshVertexCount();

  /// @brief Method get_ObjectInstancesBeenGenerated, addr 0x233a5bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ObjectInstancesBeenGenerated();

  /// @brief Method get_OutputGameObject, addr 0x233a610, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_OutputGameObject();

  /// @brief Method get_ParentAsset, addr 0x233a4d8, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> get_ParentAsset();

  /// @brief Method get_ParentGeoNode, addr 0x233a4d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_GeoNode> get_ParentGeoNode();

  /// @brief Method get_PartID, addr 0x233a4c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PartID();

  /// @brief Method get_PartName, addr 0x233a4c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ObjectInstancesBeenGenerated, addr 0x233a5c4, size 0xc, virtual false, abstract: false, final false
