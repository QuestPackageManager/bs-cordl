...
public:
  ...
  /// @brief Method <CopyGameObjectComponents>b__85_0, addr 0x22e03d4, size 0x18, virtual false, abstract: false, final false
  inline int32_t _CopyGameObjectComponents_b__85_0(::UnityEngine::LOD a, ::UnityEngine::LOD b);

  /// @brief Method .ctor, addr 0x22e03cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <CopyChildGameObjects>b__0, addr 0x22e03ec, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22de194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__0, addr 0x22e04f8, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22dec04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <BakePartToGameObject>b__1, addr 0x22e0604, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22dec0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppendBakedCloneName, addr 0x22de2dc, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW AppendBakedCloneName(::StringW name);

  /// @brief Method ApplyHAPITransform, addr 0x22d9f14, size 0x168, virtual false, abstract: false, final false
  inline void ApplyHAPITransform(ByRef<::HoudiniEngineUnity::HAPI_Transform> hapiTransform);

  /// @brief Method BakePartToGameObject, addr 0x22de40c, size 0x7f8, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToGameObject, addr 0x22de328, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method BakePartToNewGameObject, addr 0x22de19c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateColliderState, addr 0x22dbcc0, size 0x2d8, virtual false, abstract: false, final false
  inline void CalculateColliderState();

  /// @brief Method CalculateVisibility, addr 0x22dbc74, size 0x30, virtual false, abstract: false, final false
  inline void CalculateVisibility(bool bParentVisibility, bool bParentDisplayGeo);

  /// @brief Method ClearGeneratedData, addr 0x22da70c, size 0x18, virtual false, abstract: false, final false
  inline void ClearGeneratedData();

  /// @brief Method ClearGeneratedMeshOutput, addr 0x22da724, size 0x88, virtual false, abstract: false, final false
  inline void ClearGeneratedMeshOutput();

  /// @brief Method ClearGeneratedVolumeOutput, addr 0x22da7ac, size 0x34, virtual false, abstract: false, final false
  inline void ClearGeneratedVolumeOutput();

  /// @brief Method ClearInstances, addr 0x22d88d0, size 0x110, virtual false, abstract: false, final false
  inline void ClearInstances();

  /// @brief Method ClearInvalidObjectInstanceInfos, addr 0x22d89e0, size 0x200, virtual false, abstract: false, final false
  inline void ClearInvalidObjectInstanceInfos();

  /// @brief Method ClearObjectInstanceInfos, addr 0x22d9d70, size 0xcc, virtual false, abstract: false, final false
  inline void ClearObjectInstanceInfos();

  /// @brief Method CopyChildGameObjects, addr 0x22ddd78, size 0x41c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyGameObjectComponents, addr 0x22dbf98, size 0x1de0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNewInstanceFromObject, addr 0x22dafe4, size 0x408, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectInstanceInfo, addr 0x22db7c4, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyAllData, addr 0x22d9c3c, size 0x134, virtual false, abstract: false, final false
  inline void DestroyAllData();

  /// @brief Method DestroyAttributesStore, addr 0x22d9e3c, size 0xd8, virtual false, abstract: false, final false
  inline void DestroyAttributesStore();

  /// @brief Method DestroyPart, addr 0x22d59d4, size 0x2c, virtual false, abstract: false, final false
  static inline void DestroyPart(::HoudiniEngineUnity::HEU_PartData* part);

  /// @brief Method DestroyParts, addr 0x22dfd0c, size 0xd4, virtual false, abstract: false, final false
  static inline void DestroyParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* parts);

  /// @brief Method GenerateAttributesStore, addr 0x22db950, size 0xb4, virtual false, abstract: false, final false
  inline void GenerateAttributesStore(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GenerateInstancesFromObject, addr 0x22db3ec, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectID, addr 0x22d8378, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromObjectIds, addr 0x22d70e8, size 0x600, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancesFromUnityAssetPathAttribute, addr 0x22d76e8, size 0xc90, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x22d55e8, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePartInstances, addr 0x22da7e0, size 0x738, virtual false, abstract: false, final false
  inline void GeneratePartInstances(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method GetClonableObjects, addr 0x22da2cc, size 0x100, virtual false, abstract: false, final false
  inline void GetClonableObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* clonableObjects);

  /// @brief Method GetClonableParts, addr 0x22da3cc, size 0xf8, virtual false, abstract: false, final false
  inline void GetClonableParts(::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>* clonableParts);

  /// @brief Method GetCurve, addr 0x22dba04, size 0x98, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_Curve> GetCurve(bool bEditableOnly);

  /// @brief Method GetDebugInfo, addr 0x22da07c, size 0x22c, virtual false, abstract: false, final false
  inline void GetDebugInfo(::System::Text::StringBuilder* sb);

  /// @brief Method GetHDAPartWithGameObject, addr 0x22da67c, size 0x84, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_PartData> GetHDAPartWithGameObject(::UnityEngine::GameObject* inGameObject);

  /// @brief Method GetObjectInstanceInfoWithObjectID, addr 0x22daf18, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectID(int32_t objNodeID);

  /// @brief Method GetObjectInstanceInfoWithObjectPath, addr 0x22db6ec, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfoWithObjectPath(::StringW path);

  /// @brief Method GetObjectInstanceInfos, addr 0x22dfae8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo>>* GetObjectInstanceInfos();

  /// @brief Method GetOutput, addr 0x22da5c4, size 0xb8, virtual false, abstract: false, final false
  inline void GetOutput(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutput*>* outputs);

  /// @brief Method GetOutputGameObjects, addr 0x22da4c4, size 0x100, virtual false, abstract: false, final false
  inline void GetOutputGameObjects(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* outputObjects);

  /// @brief Method GetPartPointCount, addr 0x22d97d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetPartPointCount();

  /// @brief Method GetVolumeLayerName, addr 0x22d9c34, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetVolumeLayerName();

  /// @brief Method HaveInstancesBeenGenerated, addr 0x22d9820, size 0x8, virtual false, abstract: false, final false
  inline bool HaveInstancesBeenGenerated();

  /// @brief Method Initialize, addr 0x22d98dc, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsAttribInstancer, addr 0x22d9798, size 0x8, virtual false, abstract: false, final false
  inline bool IsAttribInstancer();

  /// @brief Method IsEquivalentTo, addr 0x22dfde0, size 0x588, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_PartData* other);

  /// @brief Method IsInstancerAnyType, addr 0x22d97a0, size 0x2c, virtual false, abstract: false, final false
  inline bool IsInstancerAnyType();

  /// @brief Method IsObjectInstancer, addr 0x22d97dc, size 0x8, virtual false, abstract: false, final false
  inline bool IsObjectInstancer();

  /// @brief Method IsPartCurve, addr 0x22d97f8, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartCurve();

  /// @brief Method IsPartEditable, addr 0x22d9818, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartEditable();

  /// @brief Method IsPartInstanced, addr 0x22d97cc, size 0x8, virtual false, abstract: false, final false
  inline bool IsPartInstanced();

  /// @brief Method IsPartInstancer, addr 0x22d9788, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartInstancer();

  /// @brief Method IsPartMesh, addr 0x22d9808, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartMesh();

  /// @brief Method IsPartVolume, addr 0x22d70d8, size 0x10, virtual false, abstract: false, final false
  inline bool IsPartVolume();

  /// @brief Method IsUsingMaterial, addr 0x22da2a8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateObjectInstanceInfos, addr 0x22d8d18, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessCurvePart, addr 0x22dec14, size 0x138, virtual false, abstract: false, final false
  inline void ProcessCurvePart(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SetColliderState, addr 0x22dbca4, size 0x1c, virtual false, abstract: false, final false
  inline void SetColliderState(bool bEnabled);

  /// @brief Method SetGameObject, addr 0x22d9c08, size 0x24, virtual false, abstract: false, final false
  inline void SetGameObject(::UnityEngine::GameObject* gameObject);

  /// @brief Method SetGameObjectName, addr 0x22d9ac0, size 0x148, virtual false, abstract: false, final false
  inline void SetGameObjectName(::StringW partName);

  /// @brief Method SetObjectInstanceInfos, addr 0x22df97c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetObjectInstancer, addr 0x22da700, size 0xc, virtual false, abstract: false, final false
  inline void SetObjectInstancer(bool bObjectInstancer);

  /// @brief Method SetTerrainData, addr 0x22dfafc, size 0x1a0, virtual false, abstract: false, final false
  inline void SetTerrainData(::UnityEngine::TerrainData* terrainData, ::StringW exportPathRelative, ::StringW exportPathUser);

  /// @brief Method SetTerrainOffsetPosition, addr 0x22dfaf0, size 0xc, virtual false, abstract: false, final false
  inline void SetTerrainOffsetPosition(::UnityEngine::Vector3 offsetPosition);

  /// @brief Method SetVisiblity, addr 0x22dba9c, size 0x1d8, virtual false, abstract: false, final false
  inline void SetVisiblity(bool bVisibility);

  /// @brief Method SetVolumeLayerName, addr 0x22d9c2c, size 0x8, virtual false, abstract: false, final false
  inline void SetVolumeLayerName(::StringW name);

  /// @brief Method SetupAttributeGeometry, addr 0x22d5b54, size 0xcc, virtual false, abstract: false, final false
  inline void SetupAttributeGeometry(::HoudiniEngineUnity::HEU_SessionBase* session);

  /// @brief Method SyncAttributesStore, addr 0x22ded4c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x22dfc9c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d985c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GeneratedOutput, addr 0x22d9830, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_GeneratedOutput* get_GeneratedOutput();

  /// @brief Method get_MeshVertexCount, addr 0x22d9828, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MeshVertexCount();

  /// @brief Method get_ObjectInstancesBeenGenerated, addr 0x22d97e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_ObjectInstancesBeenGenerated();

  /// @brief Method get_OutputGameObject, addr 0x22d9838, size 0x24, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_OutputGameObject();

  /// @brief Method get_ParentAsset, addr 0x22d9700, size 0x88, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> get_ParentAsset();

  /// @brief Method get_ParentGeoNode, addr 0x22d96f8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HoudiniEngineUnity::HEU_GeoNode> get_ParentGeoNode();

  /// @brief Method get_PartID, addr 0x22d96e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PartID();

  /// @brief Method get_PartName, addr 0x22d96f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ObjectInstancesBeenGenerated, addr 0x22d97ec, size 0xc, virtual false, abstract: false, final false
