...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a48bf8, size 0xc8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a3f6b4, size 0xa4, virtual false, abstract: false, final false
