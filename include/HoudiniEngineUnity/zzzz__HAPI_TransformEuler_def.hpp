...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a48044, size 0xc8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a3eb00, size 0xa4, virtual false, abstract: false, final false
