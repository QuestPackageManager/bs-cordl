...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a4b084, size 0xc8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a41b40, size 0xa4, virtual false, abstract: false, final false
