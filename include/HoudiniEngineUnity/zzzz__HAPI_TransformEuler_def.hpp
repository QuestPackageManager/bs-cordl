...
public:
  // Declarations
  /// @brief Method Init, addr 0x3a56398, size 0xc8, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method .ctor, addr 0x3a4ce54, size 0xa4, virtual false, abstract: false, final false
