...
public:
  ...
  /// @brief Method .ctor, addr 0x3a67010, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3a67018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3a67138, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3a671d0, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3a67124, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a67020, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AppendLog, addr 0x3a62c1c, size 0x114, virtual false, abstract: false, final false
  inline void AppendLog(::HoudiniEngineUnity::HEU_LoadData_HEU_ThreadedTaskLoadGeo_LoadStatus status, ::StringW logStr);

  /// @brief Method BuildBufferIDsMap, addr 0x3a65554, size 0x4c4, virtual true, abstract: false, final false
  inline void BuildBufferIDsMap(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadData* loadData);

  /// @brief Method CleanUp, addr 0x3a6622c, size 0x8, virtual true, abstract: false, final false
  inline void CleanUp();

  /// @brief Method CookNode, addr 0x3a62d30, size 0x19c, virtual true, abstract: false, final false
  inline bool CookNode(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t cookNodeID);

  /// @brief Method CreateFileNode, addr 0x3a65c74, size 0x8c, virtual false, abstract: false, final false
  inline bool CreateFileNode(::ByRef<int32_t> fileNodeID);

  /// @brief Method CreateLogString, addr 0x3a66234, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW CreateLogString(::HoudiniEngineUnity::HEU_LoadData_HEU_ThreadedTaskLoadGeo_LoadStatus status, ::StringW logStr);

  /// @brief Method DoAssetLoad, addr 0x3a65e08, size 0x310, virtual true, abstract: false, final false
  inline bool DoAssetLoad();

  /// @brief Method DoFileLoad, addr 0x3a65a18, size 0x25c, virtual true, abstract: false, final false
  inline bool DoFileLoad();

  /// @brief Method DoWork, addr 0x3a628e4, size 0x338, virtual true, abstract: false, final false
  inline void DoWork();

  /// @brief Method GenerateInstancerBuffers, addr 0x3a65140, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMeshBuffers, addr 0x3a637d4, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePartsInstancerBuffer, addr 0x3a669c8, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePointAttributeInstancerBuffer, addr 0x3a66c78, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateTerrainBuffers, addr 0x3a63cc0, size 0x1480, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCookNodeID, addr 0x3a66418, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetCookNodeID();

  /// @brief Method GetDisplayNodeID, addr 0x3a65d00, size 0x50, virtual false, abstract: false, final false
  inline int32_t GetDisplayNodeID(int32_t objNodeID);

  /// @brief Method GetLoadBufferVolumeFromTileIndex, addr 0x3a66870, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFloatFromAttribute, addr 0x3a664b8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerColorFromAttribute, addr 0x3a665dc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerVector2FromAttribute, addr 0x3a6673c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadNodeBuffer, addr 0x3a630a0, size 0x2b0, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadObjectBuffers, addr 0x3a62ed8, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadStringFromAttribute, addr 0x3a66434, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method OnComplete, addr 0x3a66118, size 0x90, virtual true, abstract: false, final false
  inline void OnComplete();

  /// @brief Method OnStopped, addr 0x3a661a8, size 0x84, virtual true, abstract: false, final false
  inline void OnStopped();

  /// @brief Method QueryParts, addr 0x3a63350, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method SetFileParm, addr 0x3a65d50, size 0xb8, virtual false, abstract: false, final false
  inline bool SetFileParm(int32_t fileNodeID, ::StringW filePath);

  /// @brief Method SetLoadCallback, addr 0x3a628dc, size 0x8, virtual false, abstract: false, final false
  inline void SetLoadCallback(::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadCallback* loadCallback);

  /// @brief Method SetLog, addr 0x3a662d8, size 0x140, virtual false, abstract: false, final false
  inline void SetLog(::HoudiniEngineUnity::HEU_LoadData_HEU_ThreadedTaskLoadGeo_LoadStatus status, ::StringW logStr);

  /// @brief Method SetupLoad, addr 0x3a627f8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadAsset, addr 0x3a5b958, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadFile, addr 0x3a602e8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadNode, addr 0x3a6049c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method Sleep, addr 0x3a62ecc, size 0xc, virtual false, abstract: false, final false
  inline void Sleep();
  ...
  /// @brief Method .ctor, addr 0x3a5b8bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
