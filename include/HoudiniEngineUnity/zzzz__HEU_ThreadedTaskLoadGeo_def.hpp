...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9603))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2247704, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x224770c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2247714, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke, addr 0x2247844, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method BeginInvoke, addr 0x2247858, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x22478f0, size 0xc, virtual true, abstract: false, final false
...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9586)), TypeDefinitionIndex(TypeDefinitionIndex(9601)), TypeDefinitionIndex(TypeDefinitionIndex(9602))]
...
public:
  ...
  /// @brief Method SetupLoad, addr 0x2241e74, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadNode, addr 0x223fa98, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadFile, addr 0x223f8e4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupLoadAsset, addr 0x223aee0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLoadCallback, addr 0x2241f5c, size 0x8, virtual false, abstract: false, final false
  inline void SetLoadCallback(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadCallback* loadCallback);

  /// @brief Method DoWork, addr 0x2241f64, size 0x338, virtual true, abstract: false, final false
  inline void DoWork();

  /// @brief Method CookNode, addr 0x22423b4, size 0x190, virtual true, abstract: false, final false
  inline bool CookNode(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t cookNodeID);

  /// @brief Method LoadObjectBuffers, addr 0x2242550, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadNodeBuffer, addr 0x224271c, size 0x2a0, virtual true, abstract: false, final false
  ...
  /// @brief Method BuildBufferIDsMap, addr 0x2244c20, size 0x4c8, virtual true, abstract: false, final false
  inline void BuildBufferIDsMap(::HoudiniEngineUnity::__HEU_ThreadedTaskLoadGeo__HEU_LoadData* loadData);

  /// @brief Method DoFileLoad, addr 0x22450e8, size 0x20c, virtual true, abstract: false, final false
  inline bool DoFileLoad();

  /// @brief Method DoAssetLoad, addr 0x2245488, size 0x32c, virtual true, abstract: false, final false
  inline bool DoAssetLoad();

  /// @brief Method QueryParts, addr 0x22429bc, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method OnComplete, addr 0x22457b4, size 0x90, virtual true, abstract: false, final false
  inline void OnComplete();

  /// @brief Method OnStopped, addr 0x2245844, size 0x84, virtual true, abstract: false, final false
  inline void OnStopped();

  /// @brief Method CleanUp, addr 0x22458c8, size 0x8, virtual true, abstract: false, final false
  inline void CleanUp();

  /// @brief Method CreateLogString, addr 0x22458d0, size 0xa4, virtual false, abstract: false, final false
  inline ::StringW CreateLogString(::GlobalNamespace::__HEU_ThreadedTaskLoadGeo__HEU_LoadData__LoadStatus status, ::StringW logStr);

  /// @brief Method AppendLog, addr 0x224229c, size 0x118, virtual false, abstract: false, final false
  inline void AppendLog(::GlobalNamespace::__HEU_ThreadedTaskLoadGeo__HEU_LoadData__LoadStatus status, ::StringW logStr);

  /// @brief Method SetLog, addr 0x2245974, size 0x150, virtual false, abstract: false, final false
  inline void SetLog(::GlobalNamespace::__HEU_ThreadedTaskLoadGeo__HEU_LoadData__LoadStatus status, ::StringW logStr);

  /// @brief Method CreateFileNode, addr 0x22452f4, size 0x8c, virtual false, abstract: false, final false
  inline bool CreateFileNode(ByRef<int32_t> fileNodeID);

  /// @brief Method GetCookNodeID, addr 0x2245ac4, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetCookNodeID();

  /// @brief Method GetDisplayNodeID, addr 0x2245380, size 0x50, virtual false, abstract: false, final false
  inline int32_t GetDisplayNodeID(int32_t objNodeID);

  /// @brief Method SetFileParm, addr 0x22453d0, size 0xb8, virtual false, abstract: false, final false
  inline bool SetFileParm(int32_t fileNodeID, ::StringW filePath);

  /// @brief Method Sleep, addr 0x2242544, size 0xc, virtual false, abstract: false, final false
  inline void Sleep();

  /// @brief Method GenerateTerrainBuffers, addr 0x2243354, size 0x14a0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadStringFromAttribute, addr 0x2245ae0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadFloatFromAttribute, addr 0x2245b64, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerColorFromAttribute, addr 0x2245c8c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLayerVector2FromAttribute, addr 0x2245dec, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMeshBuffers, addr 0x2242e40, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateInstancerBuffers, addr 0x22447f4, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePartsInstancerBuffer, addr 0x2246088, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePointAttributeInstancerBuffer, addr 0x2246348, size 0x13bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLoadBufferVolumeFromTileIndex, addr 0x2245f24, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x223ae44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
