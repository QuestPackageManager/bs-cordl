...
public:
  // Declarations
  /// @brief Method GenerateTerrainFromVolume addr 0x20844a4 size 0x9a4 virtual false final false
  ...
  /// @brief Method SetTerrainMaterial addr 0x2084e48 size 0x1d8 virtual false final false
  ...
  /// @brief Method GetDefaultTerrainShaderName addr 0x2085724 size 0xa0 virtual false final false
  static inline ::StringW GetDefaultTerrainShaderName();

  /// @brief Method GetDefaultTerrainMaterialPath addr 0x20857c4 size 0xa0 virtual false final false
  static inline ::StringW GetDefaultTerrainMaterialPath();

  /// @brief Method GetNormalizedHeightmapFromPartWithMinMax addr 0x2085020 size 0x604 virtual false final false
  ...
  /// @brief Method GetDetailMapFromPart addr 0x2085a64 size 0x2fc virtual false final false
  ...
  /// @brief Method GetHeightmapFromPart addr 0x2085864 size 0x184 virtual false final false
  ...
  /// @brief Method ConvertHeightMapHoudiniToUnity addr 0x2085624 size 0x100 virtual false final false
  ...
  /// @brief Method ConvertHeightFieldToAlphaMap addr 0x2085d60 size 0x19c virtual false final false
  ...
  /// @brief Method AppendConvertedHeightFieldToAlphaMap addr 0x2085efc size 0x2b4 virtual false final false
  ...
  /// @brief Method GetVolumePositionOffset addr 0x20861b0 size 0xc0 virtual false final false
  ...
  /// @brief Method GetTreePrototypeInfosFromPart addr 0x2086270 size 0x2c0 virtual false final false
  ...
  /// @brief Method PopulateScatterTrees addr 0x2086530 size 0xc84 virtual false final false
  ...
  /// @brief Method ApplyScatterTrees addr 0x20871b4 size 0x4f0 virtual false final false
  ...
  /// @brief Method PopulateDetailPrototype addr 0x20876a4 size 0x3f0 virtual false final false
  ...
  /// @brief Method PopulateDetailProperties addr 0x2087a94 size 0x31c virtual false final false
  ...
  /// @brief Method ApplyDetailLayers addr 0x2087db0 size 0x4cc virtual false final false
  ...
  /// @brief Method GetTerrainLayerIndexByName addr 0x208827c size 0x164 virtual false final false
  ...
  /// @brief Method GetTerrainLayerIndex addr 0x20883e0 size 0xc0 virtual false final false
  ...
  /// @brief Method VolumeLayerHasAttributes addr 0x20884a0 size 0x350 virtual false final false
  static inline bool VolumeLayerHasAttributes(::HoudiniEngineUnity::HEU_SessionBase* session, int32_t geoID, int32_t partID);

  /// @brief Method GetHeightfieldLayerType addr 0x20887f0 size 0x148 virtual false final false
  ...
  /// @brief Method GetHeightRangeFromHeightfield addr 0x20859e8 size 0x7c virtual false final false
  ...
  /// @brief Method GetTerrainDataExportPathFromHeightfieldAttribute addr 0x2088938 size 0xd8 virtual false final false
  ...
  /// @brief Method ResampleData addr 0x2073168 size 0x350 virtual false final false
