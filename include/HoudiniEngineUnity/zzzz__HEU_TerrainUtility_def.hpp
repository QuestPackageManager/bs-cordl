...
public:
  // Declarations
  /// @brief Method AppendConvertedHeightFieldToAlphaMap, addr 0x233f7e8, size 0x2b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyDetailLayers, addr 0x234169c, size 0x4cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ApplyScatterTrees, addr 0x2340aa0, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertHeightFieldToAlphaMap, addr 0x233f64c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertHeightMapHoudiniToUnity, addr 0x233ef10, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateTerrainFromVolume, addr 0x233dd90, size 0x9a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultTerrainMaterialPath, addr 0x233f0b0, size 0xa0, virtual false, abstract: false, final false
  static inline ::StringW GetDefaultTerrainMaterialPath();

  /// @brief Method GetDefaultTerrainShaderName, addr 0x233f010, size 0xa0, virtual false, abstract: false, final false
  static inline ::StringW GetDefaultTerrainShaderName();

  /// @brief Method GetDetailMapFromPart, addr 0x233f350, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHeightRangeFromHeightfield, addr 0x233f2d4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHeightfieldLayerType, addr 0x23420dc, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHeightmapFromPart, addr 0x233f150, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNormalizedHeightmapFromPartWithMinMax, addr 0x233e90c, size 0x604, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTerrainDataExportPathFromHeightfieldAttribute, addr 0x2342224, size 0x10d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTerrainLayerIndex, addr 0x2341ccc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTerrainLayerIndexByName, addr 0x2341b68, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTreePrototypeInfosFromPart, addr 0x233fb5c, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVolumePositionOffset, addr 0x233fa9c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateDetailProperties, addr 0x2341380, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateDetailPrototype, addr 0x2340f90, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method PopulateScatterTrees, addr 0x233fe1c, size 0xc84, virtual false, abstract: false, final false
  ...
  /// @brief Method ResampleData, addr 0x232ca50, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTerrainMaterial, addr 0x233e734, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method VolumeLayerHasAttributes, addr 0x2341d8c, size 0x350, virtual false, abstract: false, final false
