...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3830)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3830), inst: 1623 }),
// TypeDefinitionIndex(TypeDefinitionIndex(9796)), TypeDefinitionIndex(TypeDefinitionIndex(2611))} Self: TypeDefinitionIndex(TypeDefinitionIndex(9797)) CS Name: ::JSONArray::<get_Children>d__22*
...
public:
  ...
  /// @brief Method .ctor addr 0x20819bc size 0x34 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x2081b58 size 0x1c virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x2081b74 size 0x194 virtual true final true
  inline bool MoveNext();

  /// @brief Method <>m__Finally1 addr 0x2081d08 size 0x50 virtual false final false
  inline void __m__Finally1();

  /// @brief Method System.Collections.Generic.IEnumerator<HoudiniEngineUnity.JSONNode>.get_Current addr 0x2081d58 size 0x8 virtual true final true
  inline ::HoudiniEngineUnity::JSONNode* System_Collections_Generic_IEnumerator_HoudiniEngineUnity_JSONNode__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2081d60 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2081da0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.Generic.IEnumerable<HoudiniEngineUnity.JSONNode>.GetEnumerator addr 0x2081da8 size 0xa4 virtual true final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2081e4c size 0x4 virtual true final true
...
public:
  ...
  /// @brief Method get_Inline addr 0x20812ec size 0x8 virtual true final false
  inline bool get_Inline();

  /// @brief Method set_Inline addr 0x20812f4 size 0xc virtual true final false
  inline void set_Inline(bool value);

  /// @brief Method get_Tag addr 0x2081300 size 0x8 virtual true final false
  inline ::HoudiniEngineUnity::JSONNodeType get_Tag();

  /// @brief Method get_IsArray addr 0x2081308 size 0x8 virtual true final false
  inline bool get_IsArray();

  /// @brief Method GetEnumerator addr 0x2081310 size 0x8c virtual true final false
  inline ::HoudiniEngineUnity::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Item addr 0x208139c size 0xb4 virtual true final false
  inline ::HoudiniEngineUnity::JSONNode* get_Item(int32_t aIndex);

  /// @brief Method set_Item addr 0x2081478 size 0x144 virtual true final false
  inline void set_Item(int32_t aIndex, ::HoudiniEngineUnity::JSONNode* value);

  /// @brief Method get_Item addr 0x20815bc size 0x64 virtual true final false
  inline ::HoudiniEngineUnity::JSONNode* get_Item(::StringW aKey);

  /// @brief Method set_Item addr 0x2081620 size 0xe4 virtual true final false
  inline void set_Item(::StringW aKey, ::HoudiniEngineUnity::JSONNode* value);

  /// @brief Method get_Count addr 0x2081704 size 0x48 virtual true final false
  inline int32_t get_Count();

  /// @brief Method Add addr 0x208174c size 0xe4 virtual true final false
  inline void Add(::StringW aKey, ::HoudiniEngineUnity::JSONNode* aItem);

  /// @brief Method Remove addr 0x2081830 size 0xb4 virtual true final false
  inline ::HoudiniEngineUnity::JSONNode* Remove(int32_t aIndex);

  /// @brief Method Remove addr 0x20818e4 size 0x60 virtual true final false
  inline ::HoudiniEngineUnity::JSONNode* Remove(::HoudiniEngineUnity::JSONNode* aNode);

  /// @brief Method get_Children addr 0x2081944 size 0x78 virtual true final false
  inline ::System::Collections::Generic::IEnumerable_1<::HoudiniEngineUnity::JSONNode*>* get_Children();

  /// @brief Method WriteToStringBuilder addr 0x20819f0 size 0x168 virtual true final false
  ...
  /// @brief Method .ctor addr 0x207e1b4 size 0x7c virtual false final false
  inline void _ctor();
