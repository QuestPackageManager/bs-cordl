...
public:
  // Declarations
  /// @brief Method UpdateDefines addr 0x20788b4 size 0xd8 virtual false final false
  static inline void UpdateDefines();

  /// @brief Method GetPipeline addr 0x207898c size 0x130 virtual false final false
  static inline ::HoudiniEngineUnity::HEU_PipelineType GetPipeline();

  /// @brief Method AddDefine addr 0x2078abc size 0x108 virtual false final false
  static inline void AddDefine(::StringW define);

  /// @brief Method RemoveDefine addr 0x2078bc4 size 0xc0 virtual false final false
  static inline void RemoveDefine(::StringW define);

  /// @brief Method GetDefines addr 0x2078c84 size 0x70 virtual false final false
  static inline ::System::Collections::Generic::List_1<::StringW>* GetDefines();

  /// @brief Method SetDefines addr 0x2078cf4 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2078cf8 size 0x8 virtual false final false
  inline void _ctor();
