...
public:
  ...
  /// @brief Method .ctor, addr 0x3a53f78, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SyncStatus, addr 0x3a56b54, size 0x14, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionSyncData_Status get_SyncStatus();

  /// @brief Method set_SyncStatus, addr 0x3a56b68, size 0xc, virtual false, abstract: false, final false
