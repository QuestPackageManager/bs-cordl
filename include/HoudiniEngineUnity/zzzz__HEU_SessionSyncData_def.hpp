...
public:
  ...
  /// @brief Method .ctor, addr 0x2366488, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SyncStatus, addr 0x23690f4, size 0x14, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::__HEU_SessionSyncData__Status get_SyncStatus();

  /// @brief Method set_SyncStatus, addr 0x2369108, size 0xc, virtual false, abstract: false, final false
