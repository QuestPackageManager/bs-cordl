...
public:
  ...
  /// @brief Method .ctor, addr 0x24849d4, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SyncStatus, addr 0x2487640, size 0x14, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::__HEU_SessionSyncData__Status get_SyncStatus();

  /// @brief Method set_SyncStatus, addr 0x2487654, size 0xc, virtual false, abstract: false, final false
