...
public:
  // Declarations
  /// @brief Method isFloat, addr 0x3a43550, size 0x14, virtual false, abstract: false, final false
  inline bool isFloat();

  /// @brief Method isInt, addr 0x3a43534, size 0x1c, virtual false, abstract: false, final false
  inline bool isInt();

  /// @brief Method isNode, addr 0x3a435b0, size 0x10, virtual false, abstract: false, final false
  inline bool isNode();

  /// @brief Method isNonValue, addr 0x3a435c0, size 0x14, virtual false, abstract: false, final false
  inline bool isNonValue();

  /// @brief Method isPath, addr 0x3a43590, size 0x20, virtual false, abstract: false, final false
  inline bool isPath();

  /// @brief Method isString, addr 0x3a43564, size 0x2c, virtual false, abstract: false, final false
