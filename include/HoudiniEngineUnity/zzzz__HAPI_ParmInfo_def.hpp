...
public:
  // Declarations
  /// @brief Method isFloat, addr 0x2473e08, size 0x14, virtual false, abstract: false, final false
  inline bool isFloat();

  /// @brief Method isInt, addr 0x2473de8, size 0x20, virtual false, abstract: false, final false
  inline bool isInt();

  /// @brief Method isNode, addr 0x2473e6c, size 0x10, virtual false, abstract: false, final false
  inline bool isNode();

  /// @brief Method isNonValue, addr 0x2473e7c, size 0x14, virtual false, abstract: false, final false
  inline bool isNonValue();

  /// @brief Method isPath, addr 0x2473e4c, size 0x20, virtual false, abstract: false, final false
  inline bool isPath();

  /// @brief Method isString, addr 0x2473e1c, size 0x30, virtual false, abstract: false, final false
