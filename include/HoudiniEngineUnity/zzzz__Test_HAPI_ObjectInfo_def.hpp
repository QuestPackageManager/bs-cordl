...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a91998, size 0x1b8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9195c, size 0x3c, virtual false, abstract: false, final false
