...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x23a599c, size 0x1b8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23a5960, size 0x3c, virtual false, abstract: false, final false
