...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9530))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2278520, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::HoudiniEngineUnity::HAPI_ObjectInfo self);

  /// @brief Method IsEquivalentTo, addr 0x227855c, size 0x1b8, virtual true, abstract: false, final true
