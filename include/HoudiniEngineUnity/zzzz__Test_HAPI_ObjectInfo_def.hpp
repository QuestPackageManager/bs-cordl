...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a2cb5c, size 0x1b8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a2cb20, size 0x3c, virtual false, abstract: false, final false
