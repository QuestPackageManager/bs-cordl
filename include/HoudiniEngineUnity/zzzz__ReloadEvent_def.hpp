...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10467)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3843), inst: 311 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(10467), inst: 5233 }), TypeDefinitionIndex(TypeDefinitionIndex(3843)), TypeDefinitionIndex(TypeDefinitionIndex(9639)), TypeDefinitionIndex(TypeDefinitionIndex(10196))}
