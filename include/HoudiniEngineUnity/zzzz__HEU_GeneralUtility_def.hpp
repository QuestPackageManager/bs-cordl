...
public:
  ...
  /// @brief Method ApplyTransformTo, addr 0x3a65534, size 0xc0, virtual false, abstract: false, final false
  static inline void ApplyTransformTo(::UnityEngine::Transform* src, ::UnityEngine::Transform* target);

  /// @brief Method AssignUnityLayer, addr 0x3a67d50, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignUnityTag, addr 0x3a67a8c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method AttachScriptWithInvokeFunction, addr 0x3a68d50, size 0x550, virtual false, abstract: false, final false
  static inline void AttachScriptWithInvokeFunction(::StringW scriptSet, ::UnityEngine::GameObject* gameObject);

  /// @brief Method BiLerpf, addr 0x3a6a0b0, size 0x48, virtual false, abstract: false, final false
  static inline float_t BiLerpf(float_t p00, float_t p10, float_t p01, float_t p11, float_t fracX, float_t fracY);

  /// @brief Method CheckAttributeExists, addr 0x3a64e84, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method ColorToString, addr 0x3a673f0, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW ColorToString(::UnityEngine::Color c);

  /// @brief Method CopyComponents, addr 0x3a69754, size 0x4, virtual false, abstract: false, final false
  static inline void CopyComponents(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* destGO);

  /// @brief Method CopyFlags, addr 0x3a678ec, size 0x68, virtual false, abstract: false, final false
  static inline void CopyFlags(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* dstGO, bool bIncludeChildren);

  /// @brief Method CopyHAPITransform, addr 0x3a69c00, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyLocalTransformValues, addr 0x3a655f4, size 0x68, virtual false, abstract: false, final false
  static inline void CopyLocalTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method CopyWorldTransformValues, addr 0x3a654cc, size 0x68, virtual false, abstract: false, final false
  static inline void CopyWorldTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method CreateOutputAttribute, addr 0x3a6516c, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOutputAttributeHelper, addr 0x3a6544c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyBakedGameObjects, addr 0x3a66568, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyBakedGameObjectsWithEndName, addr 0x3a66570, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGeneratedComponents, addr 0x3a66198, size 0x120, virtual false, abstract: false, final false
  static inline void DestroyGeneratedComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMaterial, addr 0x3a66df0, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMaterial(::UnityEngine::Material* material);

  /// @brief Method DestroyGeneratedMeshComponents, addr 0x3a662b8, size 0xb8, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMeshComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMeshMaterialsLODGroups, addr 0x3a666b0, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyImmediate, addr 0x3a66524, size 0x44, virtual false, abstract: false, final false
  static inline void DestroyImmediate(::UnityEngine::Object* obj, bool bAllowDestroyingAssets, bool bRegisterUndo);

  /// @brief Method DestroyLODGroup, addr 0x3a6691c, size 0x1ec, virtual false, abstract: false, final false
  static inline void DestroyLODGroup(::UnityEngine::GameObject* targetGO, bool bDontDeletePersistantResources);

  /// @brief Method DestroyMeshCollider, addr 0x3a66f24, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyMeshCollider(::UnityEngine::MeshCollider* meshCollider, bool bDontDeletePersistantResources);

  /// @brief Method DestroyTerrainComponents, addr 0x3a66370, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoesUnityTagExist, addr 0x3a67724, size 0x8, virtual false, abstract: false, final false
  static inline bool DoesUnityTagExist(::StringW tagName);

  /// @brief Method FindOrGenerateHandles, addr 0x3a692fc, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method Fractionalf, addr 0x3a6a0f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeColorSingle, addr 0x3a68afc, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloatSingle, addr 0x3a68864, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeInfo, addr 0x3a64ecc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeIntSingle, addr 0x3a689b0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringData, addr 0x3a64d54, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringDataHelper, addr 0x3a64b7c, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingle, addr 0x3a68254, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingleStrict, addr 0x3a684e4, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildGameObjects, addr 0x3a6565c, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildGameObjectsWithNamePattern, addr 0x3a659fc, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByName, addr 0x3a65eb4, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByNameInProjectOnly, addr 0x3a66028, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInProjectOnly(::StringW name);

  /// @brief Method GetGameObjectByNameInScene, addr 0x3a66100, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInScene(::StringW name);

  /// @brief Method GetHDAByGameObjectNameInScene, addr 0x3a6614c, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAssetRoot> GetHDAByGameObjectNameInScene(::StringW name);

  /// @brief Method GetInstanceChildObjects, addr 0x3a65e1c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLODTransforms, addr 0x3a66b08, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialAttributeValueFromPart, addr 0x3a69c94, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNonInstanceChildObjects, addr 0x3a65e68, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPrefabFromPath, addr 0x3a6a318, size 0x254, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetPrefabFromPath(::StringW path);

  /// @brief Method GetRawOperatorName, addr 0x3a6a2c0, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW GetRawOperatorName(::StringW assetOpName);

  /// @brief Method GetSystemTypeByName, addr 0x3a67a40, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Type* GetSystemTypeByName(::StringW typeName);

  /// @brief Method GetUnityScriptAttributeValue, addr 0x3a680f0, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttribute, addr 0x3a68cb8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValidInstanceAttribute, addr 0x3a64f5c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGameObjectInProject, addr 0x3a660f8, size 0x8, virtual false, abstract: false, final false
  static inline bool IsGameObjectInProject(::UnityEngine::GameObject* go);

  /// @brief Method IsInCameraView, addr 0x3a692a0, size 0x5c, virtual false, abstract: false, final false
  static inline bool IsInCameraView(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 point);

  /// @brief Method IsMouseOverRect, addr 0x3a679c8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMouseWithinSceneView, addr 0x3a67954, size 0x74, virtual false, abstract: false, final false
  static inline bool IsMouseWithinSceneView(::UnityEngine::Camera* camera, ::UnityEngine::Vector2 mousePosition);

  /// @brief Method LoadTextureFromFile, addr 0x3a69758, size 0x1f0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture> LoadTextureFromFile(::StringW filePath);

  /// @brief Method LongestCommonPrefix, addr 0x3a6a104, size 0x1bc, virtual false, abstract: false, final false
  static inline ::StringW LongestCommonPrefix(::System::Collections::Generic::List_1<::StringW>* list);

  /// @brief Method MakeStaticIfHasAttribute, addr 0x3a67f94, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeTexture, addr 0x3a69948, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshCollider, addr 0x3a69f60, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshFilter, addr 0x3a69e08, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceFirstOccurrence, addr 0x3a69a7c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGameObjectChildrenColliderState, addr 0x3a67308, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenColliderState(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectChildrenRenderVisibility, addr 0x3a6713c, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenRenderVisibility(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectColliderState, addr 0x3a67224, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectColliderState(::UnityEngine::GameObject* gameObject, bool bEnabled);

  /// @brief Method SetGameObjectRenderVisiblity, addr 0x3a67058, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectRenderVisiblity(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetLODTransformValues, addr 0x3a66cbc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLayer, addr 0x3a6772c, size 0xe0, virtual false, abstract: false, final false
  static inline void SetLayer(::UnityEngine::GameObject* rootGO, int32_t layer, bool bIncludeChildren);

  /// @brief Method SetParentWithCleanTransform, addr 0x3a69b10, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTag, addr 0x3a6780c, size 0xe0, virtual false, abstract: false, final false
  static inline void SetTag(::UnityEngine::GameObject* rootGO, ::StringW tag, bool bIncludeChildren);

  /// @brief Method StringToColor, addr 0x3a675e0, size 0x144, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color StringToColor(::StringW colorString);

  /// @brief Method UpdateGeneratedAttributeStore, addr 0x3a64f98, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a6a56c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
