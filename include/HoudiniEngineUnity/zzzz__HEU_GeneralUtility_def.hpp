...
public:
  ...
  /// @brief Method GetAttributeStringDataHelper, addr 0x2249dec, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringData, addr 0x2249fc0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAttributeExists, addr 0x224a0f4, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeInfo, addr 0x224a144, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValidInstanceAttribute, addr 0x224a1d8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateGeneratedAttributeStore, addr 0x224a214, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOutputAttributeHelper, addr 0x224a6cc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOutputAttribute, addr 0x224a3e8, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyWorldTransformValues, addr 0x224a74c, size 0x68, virtual false, abstract: false, final false
  static inline void CopyWorldTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method ApplyTransformTo, addr 0x224a7b4, size 0xd4, virtual false, abstract: false, final false
  static inline void ApplyTransformTo(::UnityEngine::Transform* src, ::UnityEngine::Transform* target);

  /// @brief Method CopyLocalTransformValues, addr 0x224a888, size 0x68, virtual false, abstract: false, final false
  static inline void CopyLocalTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method GetChildGameObjects, addr 0x224a8f0, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildGameObjectsWithNamePattern, addr 0x224ac90, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstanceChildObjects, addr 0x224b0b0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNonInstanceChildObjects, addr 0x224b0fc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByName, addr 0x224b148, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByNameInProjectOnly, addr 0x224b2d0, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInProjectOnly(::StringW name);

  /// @brief Method IsGameObjectInProject, addr 0x224b3a0, size 0x8, virtual false, abstract: false, final false
  static inline bool IsGameObjectInProject(::UnityEngine::GameObject* go);

  /// @brief Method GetGameObjectByNameInScene, addr 0x224b3a8, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInScene(::StringW name);

  /// @brief Method GetHDAByGameObjectNameInScene, addr 0x224b3f4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGeneratedComponents, addr 0x224b440, size 0x120, virtual false, abstract: false, final false
  static inline void DestroyGeneratedComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMeshComponents, addr 0x224b560, size 0xb8, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMeshComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyTerrainComponents, addr 0x224b618, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyImmediate, addr 0x224b7cc, size 0x44, virtual false, abstract: false, final false
  static inline void DestroyImmediate(::UnityEngine::Object* obj, bool bAllowDestroyingAssets, bool bRegisterUndo);

  /// @brief Method DestroyBakedGameObjects, addr 0x224b810, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyBakedGameObjectsWithEndName, addr 0x224b818, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyLODGroup, addr 0x224bbc4, size 0x1ec, virtual false, abstract: false, final false
  static inline void DestroyLODGroup(::UnityEngine::GameObject* targetGO, bool bDontDeletePersistantResources);

  /// @brief Method GetLODTransforms, addr 0x224bdb0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLODTransformValues, addr 0x224bf68, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGeneratedMeshMaterialsLODGroups, addr 0x224b958, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGeneratedMaterial, addr 0x224c0ac, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMaterial(::UnityEngine::Material* material);

  /// @brief Method DestroyMeshCollider, addr 0x224c1e0, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyMeshCollider(::UnityEngine::MeshCollider* meshCollider, bool bDontDeletePersistantResources);

  /// @brief Method SetGameObjectRenderVisiblity, addr 0x224c314, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectRenderVisiblity(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectChildrenRenderVisibility, addr 0x224c3f8, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenRenderVisibility(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectColliderState, addr 0x224c4e0, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectColliderState(::UnityEngine::GameObject* gameObject, bool bEnabled);

  /// @brief Method SetGameObjectChildrenColliderState, addr 0x224c5c4, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenColliderState(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method ColorToString, addr 0x224c6ac, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW ColorToString(::UnityEngine::Color c);

  /// @brief Method StringToColor, addr 0x224c89c, size 0x224, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color StringToColor(::StringW colorString);

  /// @brief Method DoesUnityTagExist, addr 0x224cac0, size 0x8, virtual false, abstract: false, final false
  static inline bool DoesUnityTagExist(::StringW tagName);

  /// @brief Method SetLayer, addr 0x224cac8, size 0xe0, virtual false, abstract: false, final false
  static inline void SetLayer(::UnityEngine::GameObject* rootGO, int32_t layer, bool bIncludeChildren);

  /// @brief Method SetTag, addr 0x224cba8, size 0xe0, virtual false, abstract: false, final false
  static inline void SetTag(::UnityEngine::GameObject* rootGO, ::StringW tag, bool bIncludeChildren);

  /// @brief Method CopyFlags, addr 0x224cc88, size 0x68, virtual false, abstract: false, final false
  static inline void CopyFlags(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* dstGO, bool bIncludeChildren);

  /// @brief Method IsMouseWithinSceneView, addr 0x224ccf0, size 0x70, virtual false, abstract: false, final false
  static inline bool IsMouseWithinSceneView(::UnityEngine::Camera* camera, ::UnityEngine::Vector2 mousePosition);

  /// @brief Method IsMouseOverRect, addr 0x224cd60, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSystemTypeByName, addr 0x224cda4, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Type* GetSystemTypeByName(::StringW typeName);

  /// @brief Method AssignUnityTag, addr 0x224cdf0, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignUnityLayer, addr 0x224d0c8, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeStaticIfHasAttribute, addr 0x224d320, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnityScriptAttributeValue, addr 0x224d490, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingle, addr 0x224d5f8, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingleStrict, addr 0x224d89c, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloatSingle, addr 0x224dc1c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeIntSingle, addr 0x224dd7c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeColorSingle, addr 0x224dedc, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttribute, addr 0x224e0a8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method AttachScriptWithInvokeFunction, addr 0x224e14c, size 0x550, virtual false, abstract: false, final false
  static inline void AttachScriptWithInvokeFunction(::StringW scriptSet, ::UnityEngine::GameObject* gameObject);

  /// @brief Method IsInCameraView, addr 0x224e69c, size 0x98, virtual false, abstract: false, final false
  static inline bool IsInCameraView(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 point);

  /// @brief Method FindOrGenerateHandles, addr 0x224e734, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyComponents, addr 0x224eb98, size 0x4, virtual false, abstract: false, final false
  static inline void CopyComponents(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* destGO);

  /// @brief Method LoadTextureFromFile, addr 0x224eb9c, size 0x1f4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture> LoadTextureFromFile(::StringW filePath);

  /// @brief Method MakeTexture, addr 0x224ed90, size 0x134, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> MakeTexture(int32_t width, int32_t height, ::UnityEngine::Color color);

  /// @brief Method ReplaceFirstOccurrence, addr 0x224eec4, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ReplaceFirstOccurrence(::StringW srcStr, ::StringW searchStr, ::StringW replaceStr);

  /// @brief Method SetParentWithCleanTransform, addr 0x224ef58, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyHAPITransform, addr 0x224f048, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialAttributeValueFromPart, addr 0x224f0dc, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshFilter, addr 0x224f254, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshCollider, addr 0x224f3ac, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method BiLerpf, addr 0x224f4fc, size 0x48, virtual false, abstract: false, final false
  static inline float_t BiLerpf(float_t p00, float_t p10, float_t p01, float_t p11, float_t fracX, float_t fracY);

  /// @brief Method Fractionalf, addr 0x224f544, size 0xc, virtual false, abstract: false, final false
  static inline float_t Fractionalf(float_t value);

  /// @brief Method LongestCommonPrefix, addr 0x224f550, size 0x18c, virtual false, abstract: false, final false
  static inline ::StringW LongestCommonPrefix(::System::Collections::Generic::List_1<::StringW>* list);

  /// @brief Method GetRawOperatorName, addr 0x224f6dc, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW GetRawOperatorName(::StringW assetOpName);

  /// @brief Method GetPrefabFromPath, addr 0x224f734, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224f984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
