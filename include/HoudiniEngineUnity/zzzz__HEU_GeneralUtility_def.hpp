...
public:
  ...
  /// @brief Method ApplyTransformTo, addr 0x2315e1c, size 0xd4, virtual false, abstract: false, final false
  static inline void ApplyTransformTo(::UnityEngine::Transform* src, ::UnityEngine::Transform* target);

  /// @brief Method AssignUnityLayer, addr 0x2318730, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method AssignUnityTag, addr 0x2318458, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method AttachScriptWithInvokeFunction, addr 0x23197b4, size 0x550, virtual false, abstract: false, final false
  static inline void AttachScriptWithInvokeFunction(::StringW scriptSet, ::UnityEngine::GameObject* gameObject);

  /// @brief Method BiLerpf, addr 0x231ab64, size 0x48, virtual false, abstract: false, final false
  static inline float_t BiLerpf(float_t p00, float_t p10, float_t p01, float_t p11, float_t fracX, float_t fracY);

  /// @brief Method CheckAttributeExists, addr 0x231575c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method ColorToString, addr 0x2317d14, size 0x1f0, virtual false, abstract: false, final false
  static inline ::StringW ColorToString(::UnityEngine::Color c);

  /// @brief Method CopyComponents, addr 0x231a200, size 0x4, virtual false, abstract: false, final false
  static inline void CopyComponents(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* destGO);

  /// @brief Method CopyFlags, addr 0x23182f0, size 0x68, virtual false, abstract: false, final false
  static inline void CopyFlags(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* dstGO, bool bIncludeChildren);

  /// @brief Method CopyHAPITransform, addr 0x231a6b0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyLocalTransformValues, addr 0x2315ef0, size 0x68, virtual false, abstract: false, final false
  static inline void CopyLocalTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method CopyWorldTransformValues, addr 0x2315db4, size 0x68, virtual false, abstract: false, final false
  static inline void CopyWorldTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method CreateOutputAttribute, addr 0x2315a50, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOutputAttributeHelper, addr 0x2315d34, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyBakedGameObjects, addr 0x2316e78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyBakedGameObjectsWithEndName, addr 0x2316e80, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyGeneratedComponents, addr 0x2316aa8, size 0x120, virtual false, abstract: false, final false
  static inline void DestroyGeneratedComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMaterial, addr 0x2317714, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMaterial(::UnityEngine::Material* material);

  /// @brief Method DestroyGeneratedMeshComponents, addr 0x2316bc8, size 0xb8, virtual false, abstract: false, final false
  static inline void DestroyGeneratedMeshComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMeshMaterialsLODGroups, addr 0x2316fc0, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method DestroyImmediate, addr 0x2316e34, size 0x44, virtual false, abstract: false, final false
  static inline void DestroyImmediate(::UnityEngine::Object* obj, bool bAllowDestroyingAssets, bool bRegisterUndo);

  /// @brief Method DestroyLODGroup, addr 0x231722c, size 0x1ec, virtual false, abstract: false, final false
  static inline void DestroyLODGroup(::UnityEngine::GameObject* targetGO, bool bDontDeletePersistantResources);

  /// @brief Method DestroyMeshCollider, addr 0x2317848, size 0x134, virtual false, abstract: false, final false
  static inline void DestroyMeshCollider(::UnityEngine::MeshCollider* meshCollider, bool bDontDeletePersistantResources);

  /// @brief Method DestroyTerrainComponents, addr 0x2316c80, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoesUnityTagExist, addr 0x2318128, size 0x8, virtual false, abstract: false, final false
  static inline bool DoesUnityTagExist(::StringW tagName);

  /// @brief Method FindOrGenerateHandles, addr 0x2319d9c, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method Fractionalf, addr 0x231abac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeColorSingle, addr 0x2319544, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeFloatSingle, addr 0x2319284, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeInfo, addr 0x23157ac, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeIntSingle, addr 0x23193e4, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringData, addr 0x2315628, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringDataHelper, addr 0x2315454, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingle, addr 0x2318c60, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAttributeStringValueSingleStrict, addr 0x2318f04, size 0x380, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildGameObjects, addr 0x2315f58, size 0x3a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetChildGameObjectsWithNamePattern, addr 0x23162f8, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByName, addr 0x23167b0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetGameObjectByNameInProjectOnly, addr 0x2316938, size 0xd0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInProjectOnly(::StringW name);

  /// @brief Method GetGameObjectByNameInScene, addr 0x2316a10, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetGameObjectByNameInScene(::StringW name);

  /// @brief Method GetHDAByGameObjectNameInScene, addr 0x2316a5c, size 0x4c, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAssetRoot> GetHDAByGameObjectNameInScene(::StringW name);

  /// @brief Method GetInstanceChildObjects, addr 0x2316718, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLODTransforms, addr 0x2317418, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialAttributeValueFromPart, addr 0x231a744, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNonInstanceChildObjects, addr 0x2316764, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPrefabFromPath, addr 0x231ad9c, size 0x250, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::GameObject> GetPrefabFromPath(::StringW path);

  /// @brief Method GetRawOperatorName, addr 0x231ad44, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW GetRawOperatorName(::StringW assetOpName);

  /// @brief Method GetSystemTypeByName, addr 0x231840c, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Type* GetSystemTypeByName(::StringW typeName);

  /// @brief Method GetUnityScriptAttributeValue, addr 0x2318af8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAttribute, addr 0x2319710, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method HasValidInstanceAttribute, addr 0x2315840, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method IsGameObjectInProject, addr 0x2316a08, size 0x8, virtual false, abstract: false, final false
  static inline bool IsGameObjectInProject(::UnityEngine::GameObject* go);

  /// @brief Method IsInCameraView, addr 0x2319d04, size 0x98, virtual false, abstract: false, final false
  static inline bool IsInCameraView(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 point);

  /// @brief Method IsMouseOverRect, addr 0x23183c8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMouseWithinSceneView, addr 0x2318358, size 0x70, virtual false, abstract: false, final false
  static inline bool IsMouseWithinSceneView(::UnityEngine::Camera* camera, ::UnityEngine::Vector2 mousePosition);

  /// @brief Method LoadTextureFromFile, addr 0x231a204, size 0x1f4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture> LoadTextureFromFile(::StringW filePath);

  /// @brief Method LongestCommonPrefix, addr 0x231abb8, size 0x18c, virtual false, abstract: false, final false
  static inline ::StringW LongestCommonPrefix(::System::Collections::Generic::List_1<::StringW>* list);

  /// @brief Method MakeStaticIfHasAttribute, addr 0x2318988, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method MakeTexture, addr 0x231a3f8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshCollider, addr 0x231aa14, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshFilter, addr 0x231a8bc, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceFirstOccurrence, addr 0x231a52c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGameObjectChildrenColliderState, addr 0x2317c2c, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenColliderState(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectChildrenRenderVisibility, addr 0x2317a60, size 0xe8, virtual false, abstract: false, final false
  static inline void SetGameObjectChildrenRenderVisibility(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectColliderState, addr 0x2317b48, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectColliderState(::UnityEngine::GameObject* gameObject, bool bEnabled);

  /// @brief Method SetGameObjectRenderVisiblity, addr 0x231797c, size 0xe4, virtual false, abstract: false, final false
  static inline void SetGameObjectRenderVisiblity(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetLODTransformValues, addr 0x23175d0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLayer, addr 0x2318130, size 0xe0, virtual false, abstract: false, final false
  static inline void SetLayer(::UnityEngine::GameObject* rootGO, int32_t layer, bool bIncludeChildren);

  /// @brief Method SetParentWithCleanTransform, addr 0x231a5c0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTag, addr 0x2318210, size 0xe0, virtual false, abstract: false, final false
  static inline void SetTag(::UnityEngine::GameObject* rootGO, ::StringW tag, bool bIncludeChildren);

  /// @brief Method StringToColor, addr 0x2317f04, size 0x224, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color StringToColor(::StringW colorString);

  /// @brief Method UpdateGeneratedAttributeStore, addr 0x231587c, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231afec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
