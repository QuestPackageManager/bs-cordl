...
public:
  ...
  /// @brief Method GetAttributeStringDataHelper addr 0x205cb6c size 0x1d4 virtual false final false
  ...
  /// @brief Method GetAttributeStringData addr 0x205cd40 size 0x134 virtual false final false
  ...
  /// @brief Method CheckAttributeExists addr 0x205ce74 size 0x50 virtual false final false
  ...
  /// @brief Method GetAttributeInfo addr 0x205cec4 size 0x94 virtual false final false
  ...
  /// @brief Method HasValidInstanceAttribute addr 0x205cf58 size 0x3c virtual false final false
  ...
  /// @brief Method UpdateGeneratedAttributeStore addr 0x205cf94 size 0x1d4 virtual false final false
  ...
  /// @brief Method CreateOutputAttributeHelper addr 0x205d44c size 0x80 virtual false final false
  ...
  /// @brief Method CreateOutputAttribute addr 0x205d168 size 0x2e4 virtual false final false
  ...
  /// @brief Method CopyWorldTransformValues addr 0x205d4cc size 0x68 virtual false final false
  static inline void CopyWorldTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method ApplyTransformTo addr 0x205d534 size 0xd4 virtual false final false
  static inline void ApplyTransformTo(::UnityEngine::Transform* src, ::UnityEngine::Transform* target);

  /// @brief Method CopyLocalTransformValues addr 0x205d608 size 0x68 virtual false final false
  static inline void CopyLocalTransformValues(::UnityEngine::Transform* src, ::UnityEngine::Transform* dest);

  /// @brief Method GetChildGameObjects addr 0x205d670 size 0x3a0 virtual false final false
  ...
  /// @brief Method GetChildGameObjectsWithNamePattern addr 0x205da10 size 0x420 virtual false final false
  ...
  /// @brief Method GetInstanceChildObjects addr 0x205de30 size 0x4c virtual false final false
  ...
  /// @brief Method GetNonInstanceChildObjects addr 0x205de7c size 0x4c virtual false final false
  ...
  /// @brief Method GetGameObjectByName addr 0x205dec8 size 0x188 virtual false final false
  ...
  /// @brief Method GetGameObjectByNameInProjectOnly addr 0x205e050 size 0xd0 virtual false final false
  static inline ::UnityEngine::GameObject* GetGameObjectByNameInProjectOnly(::StringW name);

  /// @brief Method IsGameObjectInProject addr 0x205e120 size 0x8 virtual false final false
  static inline bool IsGameObjectInProject(::UnityEngine::GameObject* go);

  /// @brief Method GetGameObjectByNameInScene addr 0x205e128 size 0x4c virtual false final false
  static inline ::UnityEngine::GameObject* GetGameObjectByNameInScene(::StringW name);

  /// @brief Method GetHDAByGameObjectNameInScene addr 0x205e174 size 0x4c virtual false final false
  ...
  /// @brief Method DestroyGeneratedComponents addr 0x205e1c0 size 0x120 virtual false final false
  static inline void DestroyGeneratedComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyGeneratedMeshComponents addr 0x205e2e0 size 0xb8 virtual false final false
  static inline void DestroyGeneratedMeshComponents(::UnityEngine::GameObject* gameObject);

  /// @brief Method DestroyTerrainComponents addr 0x205e398 size 0x1b4 virtual false final false
  ...
  /// @brief Method DestroyImmediate addr 0x205e54c size 0x44 virtual false final false
  static inline void DestroyImmediate(::UnityEngine::Object* obj, bool bAllowDestroyingAssets, bool bRegisterUndo);

  /// @brief Method DestroyBakedGameObjects addr 0x205e590 size 0x8 virtual false final false
  static inline void DestroyBakedGameObjects(::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* gameObjectsToDestroy);

  /// @brief Method DestroyBakedGameObjectsWithEndName addr 0x205e598 size 0x140 virtual false final false
  ...
  /// @brief Method DestroyLODGroup addr 0x205e944 size 0x1ec virtual false final false
  static inline void DestroyLODGroup(::UnityEngine::GameObject* targetGO, bool bDontDeletePersistantResources);

  /// @brief Method GetLODTransforms addr 0x205eb30 size 0x1b8 virtual false final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::Transform*>* GetLODTransforms(::UnityEngine::GameObject* targetGO);

  /// @brief Method SetLODTransformValues addr 0x205ece8 size 0x144 virtual false final false
  ...
  /// @brief Method DestroyGeneratedMeshMaterialsLODGroups addr 0x205e6d8 size 0x26c virtual false final false
  ...
  /// @brief Method DestroyGeneratedMaterial addr 0x205ee2c size 0x134 virtual false final false
  static inline void DestroyGeneratedMaterial(::UnityEngine::Material* material);

  /// @brief Method DestroyMeshCollider addr 0x205ef60 size 0x134 virtual false final false
  static inline void DestroyMeshCollider(::UnityEngine::MeshCollider* meshCollider, bool bDontDeletePersistantResources);

  /// @brief Method SetGameObjectRenderVisiblity addr 0x205f094 size 0xe4 virtual false final false
  static inline void SetGameObjectRenderVisiblity(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectChildrenRenderVisibility addr 0x205f178 size 0xe8 virtual false final false
  static inline void SetGameObjectChildrenRenderVisibility(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method SetGameObjectColliderState addr 0x205f260 size 0xe4 virtual false final false
  static inline void SetGameObjectColliderState(::UnityEngine::GameObject* gameObject, bool bEnabled);

  /// @brief Method SetGameObjectChildrenColliderState addr 0x205f344 size 0xe8 virtual false final false
  static inline void SetGameObjectChildrenColliderState(::UnityEngine::GameObject* gameObject, bool bVisible);

  /// @brief Method ColorToString addr 0x205f42c size 0x1f0 virtual false final false
  static inline ::StringW ColorToString(::UnityEngine::Color c);

  /// @brief Method StringToColor addr 0x205f61c size 0x224 virtual false final false
  static inline ::UnityEngine::Color StringToColor(::StringW colorString);

  /// @brief Method DoesUnityTagExist addr 0x205f840 size 0x8 virtual false final false
  static inline bool DoesUnityTagExist(::StringW tagName);

  /// @brief Method SetLayer addr 0x205f848 size 0xe0 virtual false final false
  static inline void SetLayer(::UnityEngine::GameObject* rootGO, int32_t layer, bool bIncludeChildren);

  /// @brief Method SetTag addr 0x205f928 size 0xe0 virtual false final false
  static inline void SetTag(::UnityEngine::GameObject* rootGO, ::StringW tag, bool bIncludeChildren);

  /// @brief Method CopyFlags addr 0x205fa08 size 0x68 virtual false final false
  static inline void CopyFlags(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* dstGO, bool bIncludeChildren);

  /// @brief Method IsMouseWithinSceneView addr 0x205fa70 size 0x70 virtual false final false
  static inline bool IsMouseWithinSceneView(::UnityEngine::Camera* camera, ::UnityEngine::Vector2 mousePosition);

  /// @brief Method IsMouseOverRect addr 0x205fae0 size 0x44 virtual false final false
  ...
  /// @brief Method GetSystemTypeByName addr 0x205fb24 size 0x4c virtual false final false
  static inline ::System::Type* GetSystemTypeByName(::StringW typeName);

  /// @brief Method AssignUnityTag addr 0x205fb70 size 0x2d8 virtual false final false
  ...
  /// @brief Method AssignUnityLayer addr 0x205fe48 size 0x258 virtual false final false
  ...
  /// @brief Method MakeStaticIfHasAttribute addr 0x20600a0 size 0x170 virtual false final false
  ...
  /// @brief Method GetUnityScriptAttributeValue addr 0x2060210 size 0x168 virtual false final false
  ...
  /// @brief Method GetAttributeStringValueSingle addr 0x2060378 size 0x2a4 virtual false final false
  ...
  /// @brief Method GetAttributeStringValueSingleStrict addr 0x206061c size 0x380 virtual false final false
  ...
  /// @brief Method GetAttributeFloatSingle addr 0x206099c size 0x160 virtual false final false
  ...
  /// @brief Method GetAttributeIntSingle addr 0x2060afc size 0x160 virtual false final false
  ...
  /// @brief Method GetAttributeColorSingle addr 0x2060c5c size 0x1cc virtual false final false
  ...
  /// @brief Method HasAttribute addr 0x2060e28 size 0xa4 virtual false final false
  ...
  /// @brief Method AttachScriptWithInvokeFunction addr 0x2060ecc size 0x550 virtual false final false
  static inline void AttachScriptWithInvokeFunction(::StringW scriptSet, ::UnityEngine::GameObject* gameObject);

  /// @brief Method IsInCameraView addr 0x206141c size 0x98 virtual false final false
  static inline bool IsInCameraView(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 point);

  /// @brief Method FindOrGenerateHandles addr 0x20614b4 size 0x464 virtual false final false
  ...
  /// @brief Method CopyComponents addr 0x2061918 size 0x4 virtual false final false
  static inline void CopyComponents(::UnityEngine::GameObject* srcGO, ::UnityEngine::GameObject* destGO);

  /// @brief Method LoadTextureFromFile addr 0x206191c size 0x1f4 virtual false final false
  static inline ::UnityEngine::Texture* LoadTextureFromFile(::StringW filePath);

  /// @brief Method MakeTexture addr 0x2061b10 size 0x134 virtual false final false
  static inline ::UnityEngine::Texture2D* MakeTexture(int32_t width, int32_t height, ::UnityEngine::Color color);

  /// @brief Method ReplaceFirstOccurrence addr 0x2061c44 size 0x94 virtual false final false
  static inline ::StringW ReplaceFirstOccurrence(::StringW srcStr, ::StringW searchStr, ::StringW replaceStr);

  /// @brief Method SetParentWithCleanTransform addr 0x2061cd8 size 0xf0 virtual false final false
  ...
  /// @brief Method CopyHAPITransform addr 0x2061dc8 size 0x94 virtual false final false
  ...
  /// @brief Method GetMaterialAttributeValueFromPart addr 0x2061e5c size 0x178 virtual false final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshFilter addr 0x2061fd4 size 0x158 virtual false final false
  ...
  /// @brief Method ReplaceColliderMeshFromMeshCollider addr 0x206212c size 0x150 virtual false final false
  ...
  /// @brief Method BiLerpf addr 0x206227c size 0x48 virtual false final false
  static inline float_t BiLerpf(float_t p00, float_t p10, float_t p01, float_t p11, float_t fracX, float_t fracY);

  /// @brief Method Fractionalf addr 0x20622c4 size 0xc virtual false final false
  static inline float_t Fractionalf(float_t value);

  /// @brief Method LongestCommonPrefix addr 0x20622d0 size 0x18c virtual false final false
  static inline ::StringW LongestCommonPrefix(::System::Collections::Generic::List_1<::StringW>* list);

  /// @brief Method GetRawOperatorName addr 0x206245c size 0x58 virtual false final false
  static inline ::StringW GetRawOperatorName(::StringW assetOpName);

  /// @brief Method GetPrefabFromPath addr 0x20624b4 size 0x250 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2062704 size 0x8 virtual false final false
  inline void _ctor();
