...
public:
  ...
  /// @brief Method CompareTo, addr 0x3a7a068, size 0x30, virtual true, abstract: false, final true
  inline int32_t CompareTo(::HoudiniEngineUnity::HEU_GeoGroup* other);

  static inline ::HoudiniEngineUnity::HEU_GeoGroup* New_ctor();

  /// @brief Method SetupNormalIndices, addr 0x3a77f14, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a77e98, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
