...
public:
  ...
  /// @brief Method get_Tag addr 0x2083054 size 0x8 virtual true final false
  inline ::HoudiniEngineUnity::JSONNodeType get_Tag();

  /// @brief Method get_IsNumber addr 0x208305c size 0x8 virtual true final false
  inline bool get_IsNumber();

  /// @brief Method GetEnumerator addr 0x2083064 size 0x14 virtual true final false
  inline ::HoudiniEngineUnity::__JSONNode__Enumerator GetEnumerator();

  /// @brief Method get_Value addr 0x2083078 size 0x68 virtual true final false
  inline ::StringW get_Value();

  /// @brief Method set_Value addr 0x20830e0 size 0x8c virtual true final false
  inline void set_Value(::StringW value);

  /// @brief Method get_AsDouble addr 0x208316c size 0x8 virtual true final false
  inline double_t get_AsDouble();

  /// @brief Method set_AsDouble addr 0x2083174 size 0x8 virtual true final false
  inline void set_AsDouble(double_t value);

  /// @brief Method get_AsLong addr 0x208317c size 0x20 virtual true final false
  inline int64_t get_AsLong();

  /// @brief Method set_AsLong addr 0x208319c size 0xc virtual true final false
  inline void set_AsLong(int64_t value);

  static inline ::HoudiniEngineUnity::JSONNumber* New_ctor(double_t aData);

  /// @brief Method .ctor addr 0x207d1d0 size 0x28 virtual false final false
  inline void _ctor(double_t aData);

  static inline ::HoudiniEngineUnity::JSONNumber* New_ctor(::StringW aData);

  /// @brief Method .ctor addr 0x20831a8 size 0x34 virtual false final false
  inline void _ctor(::StringW aData);

  /// @brief Method WriteToStringBuilder addr 0x20831dc size 0x34 virtual true final false
  ...
  /// @brief Method IsNumeric addr 0x2083210 size 0x1a0 virtual false final false
  static inline bool IsNumeric(::System::Object* value);

  /// @brief Method Equals addr 0x20833b0 size 0x100 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x20834b0 size 0x70 virtual true final false
