...
public:
  ...
  /// @brief Method ClearHoudiniEngineReferences, addr 0x3a29704, size 0x74, virtual false, abstract: false, final false
  inline void ClearHoudiniEngineReferences();

  /// @brief Method DestroyRootComponent, addr 0x3a29778, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3a29458, size 0x1d0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveHoudiniEngineAssetData, addr 0x3a29628, size 0xdc, virtual false, abstract: false, final false
  inline void RemoveHoudiniEngineAssetData();

  /// @brief Method Reset, addr 0x3a29788, size 0xe8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3a29870, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
