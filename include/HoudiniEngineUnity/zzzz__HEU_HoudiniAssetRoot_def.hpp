...
public:
  ...
  /// @brief Method ClearHoudiniEngineReferences, addr 0x3a241fc, size 0x74, virtual false, abstract: false, final false
  inline void ClearHoudiniEngineReferences();

  /// @brief Method DestroyRootComponent, addr 0x3a24270, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3a23f50, size 0x1d0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveHoudiniEngineAssetData, addr 0x3a24120, size 0xdc, virtual false, abstract: false, final false
  inline void RemoveHoudiniEngineAssetData();

  /// @brief Method Reset, addr 0x3a24280, size 0xe8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3a24368, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
