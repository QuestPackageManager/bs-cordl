...
public:
  ...
  /// @brief Method CompleteTask, addr 0x259000c, size 0x240, virtual true, abstract: false, final false
  inline void CompleteTask(::HoudiniEngineUnity::__HEU_Task__TaskResult result);

  /// @brief Method CookCompletedCallback, addr 0x259024c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CookCompletedCallback, addr 0x25902cc, size 0x10, virtual false, abstract: false, final false
  inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_CookedEventData* cookedEventData);

  /// @brief Method CookCompletedCallback, addr 0x25902dc, size 0x10, virtual false, abstract: false, final false
  inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_ReloadEventData* reloadEventData);

  /// @brief Method DoTask, addr 0x258f7f4, size 0x5b0, virtual true, abstract: false, final false
  inline void DoTask();

  /// @brief Method GetTaskSession, addr 0x258f740, size 0xb4, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetTaskSession();

  /// @brief Method KillTask, addr 0x258fdcc, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25902ec, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
