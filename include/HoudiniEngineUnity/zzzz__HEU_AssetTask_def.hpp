...
public:
  ...
  /// @brief Method CompleteTask, addr 0x3a6f70c, size 0x230, virtual true, abstract: false, final false
  inline void CompleteTask(::HoudiniEngineUnity::HEU_Task_TaskResult result);

  /// @brief Method CookCompletedCallback, addr 0x3a6f93c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CookCompletedCallback, addr 0x3a6f9bc, size 0x10, virtual false, abstract: false, final false
  inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_CookedEventData* cookedEventData);

  /// @brief Method CookCompletedCallback, addr 0x3a6f9cc, size 0x10, virtual false, abstract: false, final false
  inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_ReloadEventData* reloadEventData);

  /// @brief Method DoTask, addr 0x3a6ef18, size 0x59c, virtual true, abstract: false, final false
  inline void DoTask();

  /// @brief Method GetTaskSession, addr 0x3a6ee64, size 0xb4, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetTaskSession();

  /// @brief Method KillTask, addr 0x3a6f4dc, size 0x230, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a6f9dc, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();
