...
public:
  ...
  /// @brief Method .ctor addr 0x208c8b0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ToTestObject>b__1_0 addr 0x208c8b8 size 0x64 virtual false final false
  inline ::HoudiniEngineUnity::Test_Material* _ToTestObject_b__1_0(::UnityEngine::Material* lod);

  /// @brief Method <ToTestObject>b__2_0 addr 0x208c91c size 0x64 virtual false final false
...
public:
  ...
  /// @brief Method ToTestObject addr 0x208c5c4 size 0x64 virtual false final false
  static inline ::HoudiniEngineUnity::Test_Material* ToTestObject(::UnityEngine::Material* self);

  /// @brief Method ToTestObject addr 0x208c628 size 0x128 virtual false final false
  ...
  /// @brief Method ToTestObject addr 0x208c750 size 0xfc virtual false final false
