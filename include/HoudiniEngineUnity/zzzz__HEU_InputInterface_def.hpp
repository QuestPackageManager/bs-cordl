...
public:
  ...
  /// @brief Method RegisterInterface, addr 0x3a7b048, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a7b020, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t priority);

  /// @brief Method get_Priority, addr 0x3a7b018, size 0x8, virtual false, abstract: false, final false
