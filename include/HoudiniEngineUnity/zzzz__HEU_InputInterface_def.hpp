...
public:
  ...
  /// @brief Method RegisterInterface, addr 0x25c10e8, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c10c0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t priority);

  /// @brief Method get_Priority, addr 0x25c10b8, size 0x8, virtual false, abstract: false, final false
