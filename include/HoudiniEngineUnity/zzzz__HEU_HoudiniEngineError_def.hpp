...
public:
  ...
  /// @brief Method ToString, addr 0x3a3f988, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a3f884, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3a3f900, size 0x88, virtual false, abstract: false, final false
