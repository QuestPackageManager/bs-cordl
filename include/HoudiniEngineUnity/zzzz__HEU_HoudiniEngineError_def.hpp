...
public:
  ...
  /// @brief Method ToString, addr 0x3a4053c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a40438, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3a404b4, size 0x88, virtual false, abstract: false, final false
