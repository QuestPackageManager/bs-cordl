...
public:
  // Declarations
  /// @brief Method AddAssetForUpdate, addr 0x22b1a10, size 0x4, virtual false, abstract: false, final false
  static inline void AddAssetForUpdate(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method AddNodeSyncForUpdate, addr 0x22b1a18, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnBeforeAssemblyReload, addr 0x22b19bc, size 0x50, virtual false, abstract: false, final false
  static inline void OnBeforeAssemblyReload();

  /// @brief Method OnPrefabInstanceUpdate, addr 0x22b1a20, size 0x4, virtual false, abstract: false, final false
  static inline void OnPrefabInstanceUpdate(::UnityEngine::GameObject* instance);

  /// @brief Method RemoveAsset, addr 0x22b1a14, size 0x4, virtual false, abstract: false, final false
  static inline void RemoveAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* asset);

  /// @brief Method RemoveNodeSync, addr 0x22b1a1c, size 0x4, virtual false, abstract: false, final false
  static inline void RemoveNodeSync(::HoudiniEngineUnity::HEU_BaseSync* nodeSync);

  /// @brief Method Update, addr 0x22b1a0c, size 0x4, virtual false, abstract: false, final false
  static inline void Update();

  /// @brief Method .ctor, addr 0x22b1a24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
