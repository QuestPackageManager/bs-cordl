...
public:
  ...
  /// @brief Method <ToTestObject>b__1_0, addr 0x3a9a218, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Mesh* _ToTestObject_b__1_0(::UnityEngine::Mesh* lod);

  /// @brief Method <ToTestObject>b__2_0, addr 0x3a9a274, size 0x5c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::Test_Mesh* _ToTestObject_b__2_0(::UnityEngine::Mesh* lod);

  /// @brief Method .ctor, addr 0x3a9a210, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ToTestObject, addr 0x3a99fcc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToTestObject, addr 0x3a99f70, size 0x5c, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::Test_Mesh* ToTestObject(::UnityEngine::Mesh* self);

  /// @brief Method ToTestObject, addr 0x3a9a0bc, size 0xf8, virtual false, abstract: false, final false
