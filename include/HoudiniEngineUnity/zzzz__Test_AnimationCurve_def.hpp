...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9b304, size 0xe0, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_AnimationCurve* other);

  /// @brief Method IsNull, addr 0x3a9b2f4, size 0x10, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x3a9b2cc, size 0x28, virtual false, abstract: false, final false
