...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25caa08, size 0xf4, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Gradient* other);

  /// @brief Method IsNull, addr 0x25ca9f8, size 0x10, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x25ca9d0, size 0x28, virtual false, abstract: false, final false
