...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9a2c4, size 0xf4, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Gradient* other);

  /// @brief Method IsNull, addr 0x3a9a2b4, size 0x10, virtual true, abstract: false, final true
  inline bool IsNull();

  static inline ::HoudiniEngineUnity::Test_Gradient* New_ctor(::UnityEngine::Gradient* self);

  constexpr ::UnityEngine::Gradient* const& __cordl_internal_get_self() const;
  ...
  /// @brief Method .ctor, addr 0x3a9a28c, size 0x28, virtual false, abstract: false, final false
