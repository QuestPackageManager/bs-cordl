...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a97380, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a9734c, size 0x34, virtual false, abstract: false, final false
