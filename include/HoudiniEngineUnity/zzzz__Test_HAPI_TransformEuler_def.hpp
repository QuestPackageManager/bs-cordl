...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9240c, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a923d8, size 0x34, virtual false, abstract: false, final false
