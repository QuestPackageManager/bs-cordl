...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3aa5338, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3aa5304, size 0x34, virtual false, abstract: false, final false
