...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25c7604, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25c75d0, size 0x34, virtual false, abstract: false, final false
