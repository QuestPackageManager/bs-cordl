...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x24cf978, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24cf944, size 0x34, virtual false, abstract: false, final false
