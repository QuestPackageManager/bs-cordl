...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25df548, size 0x254, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25df514, size 0x34, virtual false, abstract: false, final false
