...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3a585bc, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x3a585dc, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3a585a8, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::HoudiniEngineUnity::HEU_PDGAssetLink_UpdateUIDelegate* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x3a58520, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3a5522c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CancelCook, addr 0x3a57718, size 0x60, virtual false, abstract: false, final false
  inline void CancelCook();

  /// @brief Method ClearAllTOPData, addr 0x3a55a08, size 0x2c4, virtual false, abstract: false, final false
  inline void ClearAllTOPData();

  /// @brief Method ClearTOPNetworkWorkItemResults, addr 0x3a56fe0, size 0x140, virtual false, abstract: false, final false
  static inline void ClearTOPNetworkWorkItemResults(::HoudiniEngineUnity::HEU_TOPNetworkData* topNetwork);

  /// @brief Method ClearTOPNodeWorkItemResults, addr 0x3a56ce4, size 0x124, virtual false, abstract: false, final false
  static inline void ClearTOPNodeWorkItemResults(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method ClearWorkItemResult, addr 0x3a57484, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearWorkItemResultByID, addr 0x3a5730c, size 0x1c, virtual false, abstract: false, final false
  static inline void ClearWorkItemResultByID(::HoudiniEngineUnity::HEU_TOPNodeData* topNode, int32_t workItemID);

  /// @brief Method CookOutput, addr 0x3a55820, size 0x60, virtual false, abstract: false, final false
  inline void CookOutput();

  /// @brief Method CookTOPNode, addr 0x3a575ac, size 0x20, virtual false, abstract: false, final false
  inline void CookTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method DestroyWorkItemResultData, addr 0x3a57120, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method DirtyAll, addr 0x3a575d4, size 0x20, virtual false, abstract: false, final false
  inline void DirtyAll();

  /// @brief Method DirtyTOPNode, addr 0x3a57584, size 0x20, virtual false, abstract: false, final false
  inline void DirtyTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method GetHAPISession, addr 0x3a56190, size 0x8c, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetHAPISession();

  /// @brief Method GetLoadRootTransform, addr 0x3a57ddc, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> GetLoadRootTransform();

  /// @brief Method GetSelectedTOPNetwork, addr 0x3a56ec4, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetSelectedTOPNetwork();

  /// @brief Method GetSelectedTOPNode, addr 0x3a56f50, size 0x90, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetSelectedTOPNode();

  /// @brief Method GetTOPNetwork, addr 0x3a56ecc, size 0x84, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetTOPNetwork(int32_t index);

  /// @brief Method GetTOPNetworkByName, addr 0x3a565cc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTOPNode, addr 0x3a57eb8, size 0x170, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetTOPNode(int32_t nodeID);

  /// @brief Method GetTOPNodeByName, addr 0x3a56b34, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTOPNodeStatus, addr 0x3a58300, size 0x100, virtual false, abstract: false, final false
  inline ::StringW GetTOPNodeStatus(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method GetWorkResultByID, addr 0x3a57328, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleInitialLoad, addr 0x3a55230, size 0x4, virtual false, abstract: false, final false
  inline void HandleInitialLoad();

  /// @brief Method LoadResults, addr 0x3a5777c, size 0x5dc, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyAssetCooked, addr 0x3a557f4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyAssetCooked, addr 0x3a559e8, size 0x10, virtual false, abstract: false, final false
  inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_CookedEventData* cookedEventData);

  /// @brief Method NotifyAssetCooked, addr 0x3a559f8, size 0x10, virtual false, abstract: false, final false
  inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_ReloadEventData* reloadEventData);

  /// @brief Method OnAfterDeserialize, addr 0x3a55238, size 0x4, virtual true, abstract: false, final true
  inline void OnAfterDeserialize();

  /// @brief Method OnBeforeSerialize, addr 0x3a55234, size 0x4, virtual true, abstract: false, final true
  inline void OnBeforeSerialize();

  /// @brief Method OnDestroy, addr 0x3a5523c, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ParseHEngineData, addr 0x3a56404, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method PauseCook, addr 0x3a576b4, size 0x60, virtual false, abstract: false, final false
  inline void PauseCook();

  /// @brief Method PopulateFromHDA, addr 0x3a55880, size 0x168, virtual false, abstract: false, final false
  inline void PopulateFromHDA();

  /// @brief Method PopulateTOPNetworks, addr 0x3a55ce8, size 0x4a8, virtual false, abstract: false, final false
  inline bool PopulateTOPNetworks();

  /// @brief Method PopulateTOPNodes, addr 0x3a5676c, size 0x3c8, virtual false, abstract: false, final false
  ...
  /// @brief Method Refresh, addr 0x3a553ec, size 0x408, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RepaintUI, addr 0x3a55ccc, size 0x1c, virtual false, abstract: false, final false
  inline void RepaintUI();

  /// @brief Method Reset, addr 0x3a553e8, size 0x4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ResetTOPNetworkWorkItemTally, addr 0x3a57608, size 0xa8, virtual false, abstract: false, final false
  inline void ResetTOPNetworkWorkItemTally(::HoudiniEngineUnity::HEU_TOPNetworkData* topNetwork);

  /// @brief Method SelectTOPNetwork, addr 0x3a56e08, size 0x5c, virtual false, abstract: false, final false
  inline void SelectTOPNetwork(int32_t newIndex);

  /// @brief Method SelectTOPNode, addr 0x3a56e64, size 0x60, virtual false, abstract: false, final false
  inline void SelectTOPNode(::HoudiniEngineUnity::HEU_TOPNetworkData* network, int32_t newIndex);

  /// @brief Method Setup, addr 0x3a552b8, size 0x130, virtual false, abstract: false, final false
  inline void Setup(::HoudiniEngineUnity::HEU_HoudiniAsset* hdaAsset);

  /// @brief Method UpdateTOPNodeResultsVisibility, addr 0x3a574f8, size 0x8c, virtual false, abstract: false, final false
  inline void UpdateTOPNodeResultsVisibility(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method UpdateWorkItemTally, addr 0x3a58028, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a5843c, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AssetLinkState, addr 0x3a58434, size 0x8, virtual false, abstract: false, final false
  inline ::HoudiniEngineUnity::HEU_PDGAssetLink_LinkState get_AssetLinkState();

  /// @brief Method get_AssetName, addr 0x3a58424, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AssetName();

  /// @brief Method get_SelectedTOPNetwork, addr 0x3a5842c, size 0x8, virtual false, abstract: false, final false
