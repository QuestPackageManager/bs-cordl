...
public:
  ...
  /// @brief Method .ctor addr 0x219c83c size 0xbc virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x219c8f8 size 0x14 virtual true final false
  inline void Invoke();

  /// @brief Method BeginInvoke addr 0x219c90c size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x219c92c size 0xc virtual true final false
...
public:
  ...
  /// @brief Method Awake addr 0x21994bc size 0x4 virtual false final false
  inline void Awake();

  /// @brief Method OnBeforeSerialize addr 0x21994c4 size 0x4 virtual true final true
  inline void OnBeforeSerialize();

  /// @brief Method OnAfterDeserialize addr 0x21994c8 size 0x4 virtual true final true
  inline void OnAfterDeserialize();

  /// @brief Method HandleInitialLoad addr 0x21994c0 size 0x4 virtual false final false
  inline void HandleInitialLoad();

  /// @brief Method OnDestroy addr 0x21994cc size 0x4 virtual false final false
  inline void OnDestroy();

  /// @brief Method Setup addr 0x2199550 size 0x12c virtual false final false
  inline void Setup(::HoudiniEngineUnity::HEU_HoudiniAsset* hdaAsset);

  /// @brief Method NotifyAssetCooked addr 0x2199aac size 0x2c virtual false final false
  ...
  /// @brief Method NotifyAssetCooked addr 0x2199ca0 size 0x10 virtual false final false
  inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_CookedEventData* cookedEventData);

  /// @brief Method NotifyAssetCooked addr 0x2199cb0 size 0x10 virtual false final false
  inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_ReloadEventData* reloadEventData);

  /// @brief Method Reset addr 0x219967c size 0x4 virtual false final false
  inline void Reset();

  /// @brief Method Refresh addr 0x2199680 size 0x42c virtual false final false
  inline void Refresh();

  /// @brief Method PopulateFromHDA addr 0x2199b38 size 0x168 virtual false final false
  inline void PopulateFromHDA();

  /// @brief Method PopulateTOPNetworks addr 0x2199fa0 size 0x4cc virtual false final false
  inline bool PopulateTOPNetworks();

  /// @brief Method PopulateTOPNodes addr 0x219aa54 size 0x3e8 virtual false final false
  ...
  /// @brief Method SelectTOPNetwork addr 0x219b10c size 0x5c virtual false final false
  inline void SelectTOPNetwork(int32_t newIndex);

  /// @brief Method SelectTOPNode addr 0x219b168 size 0x60 virtual false final false
  inline void SelectTOPNode(::HoudiniEngineUnity::HEU_TOPNetworkData* network, int32_t newIndex);

  /// @brief Method GetSelectedTOPNetwork addr 0x219b1c8 size 0x8 virtual false final false
  inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetSelectedTOPNetwork();

  /// @brief Method GetSelectedTOPNode addr 0x219b254 size 0x90 virtual false final false
  inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetSelectedTOPNode();

  /// @brief Method GetTOPNetwork addr 0x219b1d0 size 0x84 virtual false final false
  inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetTOPNetwork(int32_t index);

  /// @brief Method GetTOPNetworkByName addr 0x219a8b0 size 0xcc virtual false final false
  ...
  /// @brief Method GetTOPNodeByName addr 0x219ae3c size 0xcc virtual false final false
  ...
  /// @brief Method ClearAllTOPData addr 0x2199cc0 size 0x2c4 virtual false final false
  inline void ClearAllTOPData();

  /// @brief Method ClearTOPNetworkWorkItemResults addr 0x219b2e4 size 0x140 virtual false final false
  static inline void ClearTOPNetworkWorkItemResults(::HoudiniEngineUnity::HEU_TOPNetworkData* topNetwork);

  /// @brief Method ClearTOPNodeWorkItemResults addr 0x219afec size 0x120 virtual false final false
  static inline void ClearTOPNodeWorkItemResults(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method ClearWorkItemResultByID addr 0x219b60c size 0x1c virtual false final false
  static inline void ClearWorkItemResultByID(::HoudiniEngineUnity::HEU_TOPNodeData* topNode, int32_t workItemID);

  /// @brief Method ClearWorkItemResult addr 0x219b784 size 0x74 virtual false final false
  ...
  /// @brief Method UpdateTOPNodeResultsVisibility addr 0x219b7f8 size 0x8c virtual false final false
  inline void UpdateTOPNodeResultsVisibility(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method GetWorkResultByID addr 0x219b628 size 0x15c virtual false final false
  ...
  /// @brief Method DestroyWorkItemResultData addr 0x219b424 size 0x1e8 virtual false final false
  ...
  /// @brief Method DirtyTOPNode addr 0x219b884 size 0x20 virtual false final false
  inline void DirtyTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method CookTOPNode addr 0x219b8ac size 0x20 virtual false final false
  inline void CookTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method DirtyAll addr 0x219b8d4 size 0x20 virtual false final false
  inline void DirtyAll();

  /// @brief Method CookOutput addr 0x2199ad8 size 0x60 virtual false final false
  inline void CookOutput();

  /// @brief Method PauseCook addr 0x219b9b4 size 0x60 virtual false final false
  inline void PauseCook();

  /// @brief Method CancelCook addr 0x219ba18 size 0x60 virtual false final false
  inline void CancelCook();

  /// @brief Method GetHAPISession addr 0x219a46c size 0x8c virtual false final false
  inline ::HoudiniEngineUnity::HEU_SessionBase* GetHAPISession();

  /// @brief Method LoadResults addr 0x219ba7c size 0x5ec virtual false final false
  ...
  /// @brief Method GetLoadRootTransform addr 0x219c0ec size 0xe4 virtual false final false
  inline ::UnityEngine::Transform* GetLoadRootTransform();

  /// @brief Method GetTOPNode addr 0x219c1d0 size 0x170 virtual false final false
  inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetTOPNode(int32_t nodeID);

  /// @brief Method RepaintUI addr 0x2199f84 size 0x1c virtual false final false
  inline void RepaintUI();

  /// @brief Method UpdateWorkItemTally addr 0x219c340 size 0x2d8 virtual false final false
  inline void UpdateWorkItemTally();

  /// @brief Method ResetTOPNetworkWorkItemTally addr 0x219b908 size 0xa8 virtual false final false
  inline void ResetTOPNetworkWorkItemTally(::HoudiniEngineUnity::HEU_TOPNetworkData* topNetwork);

  /// @brief Method GetTOPNodeStatus addr 0x219c618 size 0x100 virtual false final false
  inline ::StringW GetTOPNodeStatus(::HoudiniEngineUnity::HEU_TOPNodeData* topNode);

  /// @brief Method ParseHEngineData addr 0x219a6e4 size 0x1cc virtual false final false
  ...
  /// @brief Method get_AssetName addr 0x219c73c size 0x8 virtual false final false
  inline ::StringW get_AssetName();

  /// @brief Method get_SelectedTOPNetwork addr 0x219c744 size 0x8 virtual false final false
  inline int32_t get_SelectedTOPNetwork();

  /// @brief Method get_AssetLinkState addr 0x219c74c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x219c754 size 0xe0 virtual false final false
  inline void _ctor();
