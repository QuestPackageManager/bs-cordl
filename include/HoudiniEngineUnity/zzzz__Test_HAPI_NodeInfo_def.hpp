...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25f2964, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25f2930, size 0x34, virtual false, abstract: false, final false
