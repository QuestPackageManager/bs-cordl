...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3aa44c8, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3aa4494, size 0x34, virtual false, abstract: false, final false
