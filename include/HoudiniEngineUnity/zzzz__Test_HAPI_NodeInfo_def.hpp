...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x25de6b0, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25de67c, size 0x34, virtual false, abstract: false, final false
