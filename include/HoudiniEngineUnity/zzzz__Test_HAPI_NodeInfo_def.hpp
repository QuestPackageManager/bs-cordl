...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a96174, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a96140, size 0x34, virtual false, abstract: false, final false
