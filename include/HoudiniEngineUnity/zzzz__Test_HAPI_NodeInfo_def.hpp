...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a96d28, size 0x340, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a96cf4, size 0x34, virtual false, abstract: false, final false
