...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a9bf70, size 0x568, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_TerrainData* other);

  /// @brief Method IsNull, addr 0x3a9bf10, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x3a9bee8, size 0x28, virtual false, abstract: false, final false
