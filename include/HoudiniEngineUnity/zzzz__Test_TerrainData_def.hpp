...
public:
  ...
  /// @brief Method IsEquivalentTo, addr 0x3a97398, size 0x568, virtual true, abstract: false, final true
  inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_TerrainData* other);

  /// @brief Method IsNull, addr 0x3a97338, size 0x60, virtual true, abstract: false, final true
  inline bool IsNull();
  ...
  /// @brief Method .ctor, addr 0x3a97310, size 0x28, virtual false, abstract: false, final false
