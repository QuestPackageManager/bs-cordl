...
public:
  ...
  /// @brief Method CopyTo, addr 0x2452e04, size 0x24, virtual false, abstract: false, final false
  inline void CopyTo(::HoudiniEngineUnity::HEU_InputHDAInfo* destInfo);

  /// @brief Method IsEquivalentTo, addr 0x24544dc, size 0x130, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2452304, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
