...
public:
  ...
  /// @brief Method CreateInputNodeWithMultiAssets, addr 0x3a84544, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInputNodeWithMultiObjects, addr 0x3a83c74, size 0x5bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHighestPriority, addr 0x3a83540, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t GetHighestPriority();

  /// @brief Method GetInputInterface, addr 0x3a83a7c, size 0x118, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_InputInterface* GetInputInterface(::UnityEngine::GameObject* inputObject);

  /// @brief Method GetInputInterface, addr 0x3a83b94, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInputInterfaceByType, addr 0x3a838a4, size 0x158, virtual false, abstract: false, final false
  static inline ::HoudiniEngineUnity::HEU_InputInterface* GetInputInterfaceByType(::System::Type* type);

  /// @brief Method RegisterInputInterface, addr 0x3a8360c, size 0x298, virtual false, abstract: false, final false
  static inline void RegisterInputInterface(::HoudiniEngineUnity::HEU_InputInterface* inputInterface);

  /// @brief Method UnregisterInputInterface, addr 0x3a839fc, size 0x80, virtual false, abstract: false, final false
  static inline void UnregisterInputInterface(::HoudiniEngineUnity::HEU_InputInterface* inputInterface);

  /// @brief Method UploadInputObjectTransform, addr 0x3a84230, size 0x314, virtual false, abstract: false, final false
