...
public:
  ...
  /// @brief Method GetHighestPriority addr 0x2076f9c size 0xcc virtual false final false
  static inline int32_t GetHighestPriority();

  /// @brief Method RegisterInputInterface addr 0x2077068 size 0x29c virtual false final false
  static inline void RegisterInputInterface(::HoudiniEngineUnity::HEU_InputInterface* inputInterface);

  /// @brief Method UnregisterInputInterface addr 0x207745c size 0x80 virtual false final false
  static inline void UnregisterInputInterface(::HoudiniEngineUnity::HEU_InputInterface* inputInterface);

  /// @brief Method GetInputInterfaceByType addr 0x2077304 size 0x158 virtual false final false
  static inline ::HoudiniEngineUnity::HEU_InputInterface* GetInputInterfaceByType(::System::Type* type);

  /// @brief Method GetInputInterface addr 0x20774dc size 0x118 virtual false final false
  static inline ::HoudiniEngineUnity::HEU_InputInterface* GetInputInterface(::UnityEngine::GameObject* inputObject);

  /// @brief Method GetInputInterface addr 0x20775f4 size 0xe0 virtual false final false
  ...
  /// @brief Method CreateInputNodeWithMultiObjects addr 0x20776d4 size 0x5d0 virtual false final false
  ...
  /// @brief Method CreateInputNodeWithMultiAssets addr 0x2077fcc size 0x3c4 virtual false final false
  ...
  /// @brief Method UploadInputObjectTransform addr 0x2077ca4 size 0x328 virtual false final false
