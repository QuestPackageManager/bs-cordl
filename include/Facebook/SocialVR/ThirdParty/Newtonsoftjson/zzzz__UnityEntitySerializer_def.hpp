...
public:
  // Declarations
  /// @brief Method CanConvert addr 0x2321e48 size 0xac virtual true final false
  inline bool CanConvert(::System::Type* objectType);

  /// @brief Method ReadJson addr 0x2321ef4 size 0x84 virtual true final false
  inline ::System::Object* ReadJson(::Newtonsoft::Json::JsonReader* reader, ::System::Type* objectType, ::System::Object* existingValue, ::Newtonsoft::Json::JsonSerializer* serializer);

  /// @brief Method WriteJson addr 0x2321f78 size 0xfc virtual true final false
  inline void WriteJson(::Newtonsoft::Json::JsonWriter* writer, ::System::Object* value, ::Newtonsoft::Json::JsonSerializer* serializer);

  static inline ::Facebook::SocialVR::ThirdParty::Newtonsoftjson::UnityEntitySerializer* New_ctor();

  /// @brief Method .ctor addr 0x2322074 size 0x8 virtual false final false
  inline void _ctor();
