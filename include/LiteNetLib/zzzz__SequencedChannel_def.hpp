...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SequencedChannel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SequencedChannel(SequencedChannel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SequencedChannel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SequencedChannel(SequencedChannelconst&) = delete;
