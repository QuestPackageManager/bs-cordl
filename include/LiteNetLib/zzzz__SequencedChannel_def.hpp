...
public:
  ...
  /// @brief Method ProcessPacket, addr 0x57635b4, size 0x1dc, virtual true, abstract: false, final false
  inline bool ProcessPacket(::LiteNetLib::NetPacket* packet);

  /// @brief Method SendNextPackets, addr 0x57632a0, size 0x314, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575f0b0, size 0xac, virtual false, abstract: false, final false
