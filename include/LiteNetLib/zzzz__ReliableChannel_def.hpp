...
public:
  // Declarations
  /// @brief Method Clear, addr 0x3aba7a8, size 0x40, virtual false, abstract: false, final false
  inline bool Clear(::LiteNetLib::NetPeer* peer);

  /// @brief Method Init, addr 0x3abac50, size 0xc, virtual false, abstract: false, final false
  inline void Init(::LiteNetLib::NetPacket* packet);

  /// @brief Method ToString, addr 0x3abb1b0, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method TrySend, addr 0x3abac5c, size 0x78, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ProcessAck, addr 0x3aba464, size 0x344, virtual false, abstract: false, final false
  inline void ProcessAck(::LiteNetLib::NetPacket* packet);

  /// @brief Method ProcessPacket, addr 0x3abacd4, size 0x4dc, virtual true, abstract: false, final false
  inline bool ProcessPacket(::LiteNetLib::NetPacket* packet);

  /// @brief Method SendNextPackets, addr 0x3aba7e8, size 0x468, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ab6d9c, size 0x188, virtual false, abstract: false, final false
