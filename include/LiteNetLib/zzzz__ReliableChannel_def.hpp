...
public:
// Declarations
/// @brief Method Clear, addr 0x56f4994, size 0x40, virtual false, abstract: false, final false
inline bool Clear(::LiteNetLib::NetPeer*  peer) ;

/// @brief Method Init, addr 0x56f4e18, size 0xc, virtual false, abstract: false, final false
inline void Init(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ToString, addr 0x56f533c, size 0x78, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TrySend, addr 0x56f4e24, size 0x78, virtual false, abstract: false, final false
...
/// @brief Field _pendingPackets, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__pendingPackets, put=__cordl_internal_set__pendingPackets)) ::ArrayW<::LiteNetLib::ReliableChannel_PendingPacket,::Array<::LiteNetLib::ReliableChannel_PendingPacket>*>  _pendingPackets;
...
/// @brief Method ProcessAck, addr 0x56f4670, size 0x324, virtual false, abstract: false, final false
inline void ProcessAck(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ProcessPacket, addr 0x56f4e9c, size 0x4a0, virtual true, abstract: false, final false
inline bool ProcessPacket(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method SendNextPackets, addr 0x56f49d4, size 0x444, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56f102c, size 0x198, virtual false, abstract: false, final false
