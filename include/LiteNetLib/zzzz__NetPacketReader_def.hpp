...
public:
  ...
  /// @brief Method Recycle, addr 0x3ab0564, size 0x68, virtual false, abstract: false, final false
  inline void Recycle();

  /// @brief Method RecycleInternal, addr 0x3ab02ec, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method SetSource, addr 0x3ab0224, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ab01f8, size 0x2c, virtual false, abstract: false, final false
