...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetPacketReader", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetPacketReader(NetPacketReader&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetPacketReader", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetPacketReader(NetPacketReaderconst&) = delete;
