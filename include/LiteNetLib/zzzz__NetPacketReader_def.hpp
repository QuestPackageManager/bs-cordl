...
// Write type traits
MARK_REF_T(::LiteNetLib::NetPacketReader*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetPacketReader*, "LiteNetLib", "NetPacketReader");
...
public:
  ...
  /// @brief Method Recycle, addr 0x589ff0c, size 0x68, virtual false, abstract: false, final false
  inline void Recycle();

  /// @brief Method RecycleInternal, addr 0x589fc80, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method SetSource, addr 0x589fbd8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589fbd0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::NetPacketReader) == 0x40, "Size mismatch!");
