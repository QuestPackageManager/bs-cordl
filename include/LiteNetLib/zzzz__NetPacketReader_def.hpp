...
public:
  ...
  /// @brief Method Recycle, addr 0x3aab178, size 0x68, virtual false, abstract: false, final false
  inline void Recycle();

  /// @brief Method RecycleInternal, addr 0x3aaaf00, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method SetSource, addr 0x3aaae38, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aaae0c, size 0x2c, virtual false, abstract: false, final false
