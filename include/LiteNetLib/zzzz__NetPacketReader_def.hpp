...
public:
  ...
  /// @brief Method Recycle, addr 0x3ab5254, size 0x68, virtual false, abstract: false, final false
  inline void Recycle();

  /// @brief Method RecycleInternal, addr 0x3ab4fdc, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method SetSource, addr 0x3ab4f14, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ab4ee8, size 0x2c, virtual false, abstract: false, final false
