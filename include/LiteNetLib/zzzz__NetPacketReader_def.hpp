...
public:
  ...
  /// @brief Method Recycle, addr 0x3ab00ec, size 0x68, virtual false, abstract: false, final false
  inline void Recycle();

  /// @brief Method RecycleInternal, addr 0x3aafe74, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method SetSource, addr 0x3aafdac, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aafd80, size 0x2c, virtual false, abstract: false, final false
