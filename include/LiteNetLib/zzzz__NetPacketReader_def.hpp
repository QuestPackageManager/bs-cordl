...
namespace LiteNetLib {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14207))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2291c48, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetManager* manager, ::LiteNetLib::NetEvent* evt);

  /// @brief Method SetSource, addr 0x2291c74, size 0x40, virtual false, abstract: false, final false
  inline void SetSource(::LiteNetLib::NetPacket* packet);

  /// @brief Method RecycleInternal, addr 0x2291d3c, size 0x44, virtual false, abstract: false, final false
  inline void RecycleInternal();

  /// @brief Method Recycle, addr 0x2291fdc, size 0x6c, virtual false, abstract: false, final false
  inline void Recycle();
