...
::cordl_internals::setStaticField<::ArrayW<int32_t,::Array<int32_t>*>, "PossibleMtu", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LiteNetLib::NetConstants*>::get>(std::forward<::ArrayW<int32_t,::Array<int32_t>*>>(value));
}
