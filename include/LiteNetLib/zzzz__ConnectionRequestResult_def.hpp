...
DEFINE_IL2CPP_CLASS(::LiteNetLib::ConnectionRequestResult, "LiteNetLib", "ConnectionRequestResult");
// Dependencies
namespace LiteNetLib {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::ConnectionRequestResult) == 0x4, "Size mismatch!");
