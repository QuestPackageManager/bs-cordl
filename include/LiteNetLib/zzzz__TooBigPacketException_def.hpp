...
public:
  ...
  /// @brief Method .ctor, addr 0x3ab266c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3ab2674, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3ab267c, size 0x8, virtual false, abstract: false, final false
