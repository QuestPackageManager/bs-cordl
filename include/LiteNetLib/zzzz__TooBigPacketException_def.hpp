...
public:
  ...
  /// @brief Method .ctor, addr 0x56ea1b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x56ea1b8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x56ea1dc, size 0x24, virtual false, abstract: false, final false
