...
namespace LiteNetLib {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14173))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2291c30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::LiteNetLib::TooBigPacketException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2291c38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  static inline ::LiteNetLib::TooBigPacketException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor, addr 0x2291c40, size 0x8, virtual false, abstract: false, final false
