...
public:
  ...
  /// @brief Method .ctor, addr 0x3aaadf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3aaadfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3aaae04, size 0x8, virtual false, abstract: false, final false
