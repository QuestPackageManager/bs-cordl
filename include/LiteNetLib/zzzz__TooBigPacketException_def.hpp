...
public:
  ...
  /// @brief Method .ctor, addr 0x589fb80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x589fb88, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x589fbac, size 0x24, virtual false, abstract: false, final false
