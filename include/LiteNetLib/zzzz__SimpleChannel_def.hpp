...
public:
  ...
  /// @brief Method ProcessPacket, addr 0x3abb8d0, size 0x8, virtual true, abstract: false, final false
  inline bool ProcessPacket(::LiteNetLib::NetPacket* packet);

  /// @brief Method SendNextPackets, addr 0x3abb760, size 0x170, virtual true, abstract: false, final false
  inline void SendNextPackets();

  /// @brief Method .ctor, addr 0x3abb75c, size 0x4, virtual false, abstract: false, final false
