...
public:
  ...
  /// @brief Method .ctor, addr 0x229d9a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method SendNextPackets, addr 0x229d9ac, size 0x170, virtual true, abstract: false, final false
  inline void SendNextPackets();

  /// @brief Method ProcessPacket, addr 0x229db1c, size 0x8, virtual true, abstract: false, final false
