...
public:
  ...
  /// @brief Method .ctor addr 0x20a626c size 0x4 virtual false final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method SendNextPackets addr 0x20a6270 size 0x170 virtual true final false
  inline void SendNextPackets();

  /// @brief Method ProcessPacket addr 0x20a63e0 size 0x8 virtual true final false
