...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimpleChannel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SimpleChannel(SimpleChannel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SimpleChannel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SimpleChannel(SimpleChannelconst&) = delete;
