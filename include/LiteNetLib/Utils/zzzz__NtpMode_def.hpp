...
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::NtpMode, "LiteNetLib.Utils", "NtpMode");
// Dependencies
namespace LiteNetLib::Utils {
// Is value type: true
...
public:
  ...
  /// @brief Field Client value: I32(3)
  static ::LiteNetLib::Utils::NtpMode const Client;

  /// @brief Field Server value: I32(4)
...
static_assert(sizeof(::LiteNetLib::Utils::NtpMode) == 0x4, "Size mismatch!");
