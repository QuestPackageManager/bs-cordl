...
// Write type traits
MARK_REF_T(::LiteNetLib::Utils::CRC32C*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::CRC32C*, "LiteNetLib.Utils", "CRC32C");
...
public:
  ...
  /// @brief Method Compute, addr 0x58a95e0, size 0x3bc, virtual false, abstract: false, final false
  ...
  static inline void setStaticF_Table(::ArrayW<uint32_t> value);
...
static_assert(sizeof(::LiteNetLib::Utils::CRC32C) == 0x10, "Size mismatch!");
