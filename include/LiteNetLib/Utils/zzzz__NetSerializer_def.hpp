...
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_BoolSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_ByteSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_CharSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_ClassInfo_1;
}
namespace LiteNetLib::Utils {
...
namespace LiteNetLib::Utils {
template<typename TProperty>
class NetSerializer_CustomTypeStatic_1;
}
namespace LiteNetLib::Utils {
template<typename TProperty>
...
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_DoubleSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_EnumByteSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_EnumIntSerializer_1;
}
namespace LiteNetLib::Utils {
...
namespace LiteNetLib::Utils {
template<typename TClass,typename TProperty>
class NetSerializer_FastCallSpecificAuto_2;
}
namespace LiteNetLib::Utils {
template<typename TClass,typename TProperty>
class NetSerializer_FastCallSpecific_2;
}
namespace LiteNetLib::Utils {
template<typename TClass,typename TProperty>
class NetSerializer_FastCallStatic_2;
}
namespace LiteNetLib::Utils {
template<typename TClass,typename TProperty>
...
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_FastCall_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_FloatSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_IPEndPointSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_IntSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_LongSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_SByteSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_ShortSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_StringSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_UIntSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_ULongSerializer_1;
}
namespace LiteNetLib::Utils {
template<typename T>
class NetSerializer_UShortSerializer_1;
}
...
static inline ::LiteNetLib::Utils::NetSerializer_FastCallStatic_2<TClass,TProperty>* New_ctor(::System::Action_2<::LiteNetLib::Utils::NetDataWriter*,TProperty>*  write, ::System::Func_2<::LiteNetLib::Utils::NetDataReader*,TProperty>*  read) ;
...
/// @brief Field _serializers, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__serializers, put=__cordl_internal_set__serializers)) ::ArrayW<::LiteNetLib::Utils::NetSerializer_FastCall_1<T>*,::Array<::LiteNetLib::Utils::NetSerializer_FastCall_1<T>*>*>  _serializers;
...
template<typename T>
inline ::LiteNetLib::Utils::NetSerializer_FastCall_1<T>* Get() ;

static inline ::LiteNetLib::Utils::NetSerializer_CustomType* New_ctor() ;

/// @brief Method .ctor, addr 0x56f8d88, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::LiteNetLib::Utils::NetSerializer_CustomTypeStatic_1<TProperty>* New_ctor(::System::Action_2<::LiteNetLib::Utils::NetDataWriter*,TProperty>*  writer, ::System::Func_2<::LiteNetLib::Utils::NetDataReader*,TProperty>*  reader) ;
...
// Declarations
template<typename T>
using BoolSerializer_1 = ::LiteNetLib::Utils::NetSerializer_BoolSerializer_1<T>;

template<typename T>
using ByteSerializer_1 = ::LiteNetLib::Utils::NetSerializer_ByteSerializer_1<T>;

template<typename T>
using CharSerializer_1 = ::LiteNetLib::Utils::NetSerializer_CharSerializer_1<T>;

template<typename T>
using ClassInfo_1 = ::LiteNetLib::Utils::NetSerializer_ClassInfo_1<T>;
...
template<typename TProperty>
using CustomTypeStatic_1 = ::LiteNetLib::Utils::NetSerializer_CustomTypeStatic_1<TProperty>;

template<typename TProperty>
using CustomTypeStruct_1 = ::LiteNetLib::Utils::NetSerializer_CustomTypeStruct_1<TProperty>;

template<typename T>
using DoubleSerializer_1 = ::LiteNetLib::Utils::NetSerializer_DoubleSerializer_1<T>;

template<typename T>
using EnumByteSerializer_1 = ::LiteNetLib::Utils::NetSerializer_EnumByteSerializer_1<T>;

template<typename T>
using EnumIntSerializer_1 = ::LiteNetLib::Utils::NetSerializer_EnumIntSerializer_1<T>;

template<typename TClass,typename TProperty>
using FastCallClass_2 = ::LiteNetLib::Utils::NetSerializer_FastCallClass_2<TClass, TProperty>;

template<typename TClass,typename TProperty>
using FastCallSpecificAuto_2 = ::LiteNetLib::Utils::NetSerializer_FastCallSpecificAuto_2<TClass, TProperty>;

template<typename TClass,typename TProperty>
using FastCallSpecific_2 = ::LiteNetLib::Utils::NetSerializer_FastCallSpecific_2<TClass, TProperty>;

template<typename TClass,typename TProperty>
using FastCallStatic_2 = ::LiteNetLib::Utils::NetSerializer_FastCallStatic_2<TClass, TProperty>;

template<typename TClass,typename TProperty>
using FastCallStruct_2 = ::LiteNetLib::Utils::NetSerializer_FastCallStruct_2<TClass, TProperty>;

template<typename T>
using FastCall_1 = ::LiteNetLib::Utils::NetSerializer_FastCall_1<T>;

template<typename T>
using FloatSerializer_1 = ::LiteNetLib::Utils::NetSerializer_FloatSerializer_1<T>;

template<typename T>
using IPEndPointSerializer_1 = ::LiteNetLib::Utils::NetSerializer_IPEndPointSerializer_1<T>;

template<typename T>
using IntSerializer_1 = ::LiteNetLib::Utils::NetSerializer_IntSerializer_1<T>;

template<typename T>
using LongSerializer_1 = ::LiteNetLib::Utils::NetSerializer_LongSerializer_1<T>;

template<typename T>
using SByteSerializer_1 = ::LiteNetLib::Utils::NetSerializer_SByteSerializer_1<T>;

template<typename T>
using ShortSerializer_1 = ::LiteNetLib::Utils::NetSerializer_ShortSerializer_1<T>;

template<typename T>
using StringSerializer_1 = ::LiteNetLib::Utils::NetSerializer_StringSerializer_1<T>;

template<typename T>
using UIntSerializer_1 = ::LiteNetLib::Utils::NetSerializer_UIntSerializer_1<T>;

template<typename T>
using ULongSerializer_1 = ::LiteNetLib::Utils::NetSerializer_ULongSerializer_1<T>;

template<typename T>
using UShortSerializer_1 = ::LiteNetLib::Utils::NetSerializer_UShortSerializer_1<T>;
...
/// @brief Field _registeredTypes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__registeredTypes, put=__cordl_internal_set__registeredTypes)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::LiteNetLib::Utils::NetSerializer_CustomType*>*  _registeredTypes;
...
template<typename T>
inline ::LiteNetLib::Utils::NetSerializer_ClassInfo_1<T>* RegisterInternal() ;
...
/// @brief Method RegisterNestedType, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline void RegisterNestedType(::System::Action_2<::LiteNetLib::Utils::NetDataWriter*,T>*  writer, ::System::Func_2<::LiteNetLib::Utils::NetDataReader*,T>*  reader) ;

/// @brief Method Serialize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Serialize(T  obj) ;
...
/// @brief Method .ctor, addr 0x56f87dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x56f88ec, size 0xa8, virtual false, abstract: false, final false
