...
template <typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14210), inst: 1962 }), TypeDefinitionIndex(TypeDefinitionIndex(14210))}
...
template <typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14210), inst: 1953 }), TypeDefinitionIndex(TypeDefinitionIndex(14210))}
...
template <typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14209), inst: 1973 }), TypeDefinitionIndex(TypeDefinitionIndex(14209))}
...
public:
  ...
  /// @brief Method .ctor addr 0x220bccc size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x220b7a4 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::LiteNetLib::Utils::NetSerializer* New_ctor(int32_t maxStringLength);

  /// @brief Method .ctor addr 0x220b898 size 0x90 virtual false final false
