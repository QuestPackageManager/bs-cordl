...
public:
  ...
  static inline ::LiteNetLib::Utils::NetDataReader* New_ctor(::ArrayW<uint8_t> source);

  static inline ::LiteNetLib::Utils::NetDataReader* New_ctor(::ArrayW<uint8_t> source, int32_t offset);
...
static_assert(sizeof(::LiteNetLib::Utils::NetDataReader) == 0x28, "Size mismatch!");
