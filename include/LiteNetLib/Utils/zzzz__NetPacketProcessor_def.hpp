...
namespace LiteNetLib::Utils {
template<typename T>
class NetPacketProcessor_HashCache_1;
}
namespace LiteNetLib::Utils {
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x56f8d30, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x56f8d58, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x56f8d1c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56f8bd4, size 0x148, virtual false, abstract: false, final false
...
// Declarations
template<typename T>
using HashCache_1 = ::LiteNetLib::Utils::NetPacketProcessor_HashCache_1<T>;
...
/// @brief Field _callbacks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__callbacks, put=__cordl_internal_set__callbacks)) ::System::Collections::Generic::Dictionary_2<uint64_t,::LiteNetLib::Utils::NetPacketProcessor_SubscribeDelegate*>*  _callbacks;
...
/// @brief Method GetCallbackFromData, addr 0x56f8994, size 0xd8, virtual true, abstract: false, final false
...
/// @brief Method ReadAllPackets, addr 0x56f8ad8, size 0x54, virtual false, abstract: false, final false
inline void ReadAllPackets(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method ReadAllPackets, addr 0x56f8b34, size 0x58, virtual false, abstract: false, final false
inline void ReadAllPackets(::LiteNetLib::Utils::NetDataReader*  reader, ::System::Object*  userData) ;

/// @brief Method ReadPacket, addr 0x56f8b2c, size 0x8, virtual false, abstract: false, final false
inline void ReadPacket(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method ReadPacket, addr 0x56f8b8c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56f86e0, size 0xfc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x56f87e4, size 0x108, virtual false, abstract: false, final false
