...
/// @brief Method CheckTimestamps, addr 0x56f9428, size 0x12c, virtual false, abstract: false, final false
inline void CheckTimestamps() ;

/// @brief Method FromServerResponse, addr 0x56f97d8, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetDateTime64, addr 0x56f9020, size 0x144, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> GetDateTime64(int32_t  offset) ;

/// @brief Method GetInt32BE, addr 0x56f9ba0, size 0x4, virtual false, abstract: false, final false
inline int32_t GetInt32BE(int32_t  offset) ;

/// @brief Method GetTimeSpan32, addr 0x56f8f14, size 0x7c, virtual false, abstract: false, final false
inline ::System::TimeSpan GetTimeSpan32(int32_t  offset) ;

/// @brief Method GetUInt32BE, addr 0x56f8fa0, size 0x78, virtual false, abstract: false, final false
inline uint32_t GetUInt32BE(int32_t  offset) ;

/// @brief Method GetUInt64BE, addr 0x56f9aac, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method SetDateTime64, addr 0x56f918c, size 0x164, virtual false, abstract: false, final false
inline void SetDateTime64(int32_t  offset, ::System::Nullable_1<::System::DateTime>  value) ;

/// @brief Method SetUInt64BE, addr 0x56f9b24, size 0x7c, virtual false, abstract: false, final false
inline void SetUInt64BE(int32_t  offset, uint64_t  value) ;

/// @brief Method SwapEndianness, addr 0x56f9bfc, size 0x8, virtual false, abstract: false, final false
static inline uint32_t SwapEndianness(uint32_t  x) ;

/// @brief Method SwapEndianness, addr 0x56f9ba4, size 0x58, virtual false, abstract: false, final false
static inline uint64_t SwapEndianness(uint64_t  x) ;

/// @brief Method ValidateReply, addr 0x56f995c, size 0x150, virtual false, abstract: false, final false
inline void ValidateReply() ;

/// @brief Method ValidateRequest, addr 0x56f9864, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56f9688, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x56f9750, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

static inline ::System::DateTime getStaticF_Epoch() ;

/// @brief Method get_Bytes, addr 0x56f8d8c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Bytes() ;

/// @brief Method get_CorrectionOffset, addr 0x56f9554, size 0x134, virtual false, abstract: false, final false
inline ::System::TimeSpan get_CorrectionOffset() ;

/// @brief Method get_DestinationTimestamp, addr 0x56f92f0, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_DestinationTimestamp() ;

/// @brief Method get_LeapIndicator, addr 0x56f8d9c, size 0x2c, virtual false, abstract: false, final false
inline ::LiteNetLib::Utils::NtpLeapIndicator get_LeapIndicator() ;

/// @brief Method get_Mode, addr 0x56f8e28, size 0x2c, virtual false, abstract: false, final false
inline ::LiteNetLib::Utils::NtpMode get_Mode() ;

/// @brief Method get_OriginTimestamp, addr 0x56f9164, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_OriginTimestamp() ;

/// @brief Method get_Poll, addr 0x56f8eb4, size 0x2c, virtual false, abstract: false, final false
inline int32_t get_Poll() ;

/// @brief Method get_Precision, addr 0x56f8ee0, size 0x2c, virtual false, abstract: false, final false
inline int32_t get_Precision() ;

/// @brief Method get_ReceiveTimestamp, addr 0x56f916c, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_ReceiveTimestamp() ;

/// @brief Method get_ReferenceId, addr 0x56f8f98, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_ReferenceId() ;

/// @brief Method get_ReferenceTimestamp, addr 0x56f9018, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_ReferenceTimestamp() ;

/// @brief Method get_RootDelay, addr 0x56f8f0c, size 0x8, virtual false, abstract: false, final false
inline ::System::TimeSpan get_RootDelay() ;

/// @brief Method get_RootDispersion, addr 0x56f8f90, size 0x8, virtual false, abstract: false, final false
inline ::System::TimeSpan get_RootDispersion() ;

/// @brief Method get_RoundTripTime, addr 0x56f9304, size 0x124, virtual false, abstract: false, final false
inline ::System::TimeSpan get_RoundTripTime() ;

/// @brief Method get_Stratum, addr 0x56f8e88, size 0x2c, virtual false, abstract: false, final false
inline int32_t get_Stratum() ;

/// @brief Method get_TransmitTimestamp, addr 0x56f9174, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> get_TransmitTimestamp() ;

/// @brief Method get_VersionNumber, addr 0x56f8dc8, size 0x2c, virtual false, abstract: false, final false
inline int32_t get_VersionNumber() ;

static inline void setStaticF_Epoch(::System::DateTime  value) ;

/// @brief Method set_Bytes, addr 0x56f8d94, size 0x8, virtual false, abstract: false, final false
inline void set_Bytes(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_DestinationTimestamp, addr 0x56f92fc, size 0x8, virtual false, abstract: false, final false
inline void set_DestinationTimestamp(::System::Nullable_1<::System::DateTime>  value) ;

/// @brief Method set_Mode, addr 0x56f8e54, size 0x34, virtual false, abstract: false, final false
inline void set_Mode(::LiteNetLib::Utils::NtpMode  value) ;

/// @brief Method set_TransmitTimestamp, addr 0x56f917c, size 0x10, virtual false, abstract: false, final false
inline void set_TransmitTimestamp(::System::Nullable_1<::System::DateTime>  value) ;

/// @brief Method set_VersionNumber, addr 0x56f8df4, size 0x34, virtual false, abstract: false, final false
