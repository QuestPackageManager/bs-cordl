...
public:
  ...
  /// @brief Method .ctor addr 0x20abd74 size 0xf0 virtual false final false
  inline void _ctor(::System::Net::IPEndPoint* endPoint, ::System::Action_1<::LiteNetLib::Utils::NtpPacket*>* onRequestComplete);

  /// @brief Method Create addr 0x20abe64 size 0x70 virtual false final false
  ...
  /// @brief Method Create addr 0x20abed4 size 0x78 virtual false final false
  ...
  /// @brief Method Create addr 0x20abf4c size 0x74 virtual false final false
  ...
  /// @brief Method Create addr 0x20abfc0 size 0x70 virtual false final false
  ...
  /// @brief Method Send addr 0x20ac030 size 0xc8 virtual false final false
  inline void Send();

  /// @brief Method Close addr 0x20ac0f8 size 0x20 virtual false final false
  inline void Close();

  /// @brief Method LiteNetLib.INetSocketListener.OnMessageReceived addr 0x20ac118 size 0x19c virtual true final true
