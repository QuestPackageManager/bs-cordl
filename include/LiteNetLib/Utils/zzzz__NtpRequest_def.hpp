...
// Write type traits
MARK_REF_T(::LiteNetLib::Utils::NtpRequest*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::Utils::NtpRequest*, "LiteNetLib.Utils", "NtpRequest");
...
public:
  ...
  /// @brief Method Close, addr 0x58adaa8, size 0x1c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method Create, addr 0x58ad810, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x58ad87c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x58ad968, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x58ad8f0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LiteNetLib.INetSocketListener.OnMessageReceived, addr 0x58adac4, size 0x194, virtual true, abstract: false, final true
  inline void LiteNetLib_INetSocketListener_OnMessageReceived(::ArrayW<uint8_t> data, int32_t length, ::System::Net::Sockets::SocketError errorCode, ::System::Net::IPEndPoint* remoteEndPoint);
  ...
  /// @brief Method Send, addr 0x58ad9dc, size 0xcc, virtual false, abstract: false, final false
  inline void Send();
  ...
  /// @brief Method .ctor, addr 0x58ad72c, size 0xe4, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::Utils::NtpRequest) == 0x28, "Size mismatch!");
