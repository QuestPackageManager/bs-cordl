...
template<typename T>
constexpr  LiteNetLib::Utils::INetImmutableSerializable_1<T>::operator ::LiteNetLib::Utils::INetImmutableSerializable*() noexcept {
...
template<typename T>
constexpr ::LiteNetLib::Utils::INetImmutableSerializable* LiteNetLib::Utils::INetImmutableSerializable_1<T>::i___LiteNetLib__Utils__INetImmutableSerializable() noexcept {
return static_cast<::LiteNetLib::Utils::INetImmutableSerializable*>(static_cast<void*>(this));
}
