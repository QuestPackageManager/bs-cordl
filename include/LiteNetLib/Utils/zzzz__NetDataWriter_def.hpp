...
public:
  ...
  /// @brief Method get_Capacity addr 0x20a8968 size 0x1c virtual false final false
  inline int32_t get_Capacity();

  static inline ::LiteNetLib::Utils::NetDataWriter* New_ctor();

  /// @brief Method .ctor addr 0x2098e2c size 0xc virtual false final false
  inline void _ctor();

  static inline ::LiteNetLib::Utils::NetDataWriter* New_ctor(bool autoResize);

  /// @brief Method .ctor addr 0x20a89f4 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0x20a8984 size 0x70 virtual false final false
  inline void _ctor(bool autoResize, int32_t initialSize);

  /// @brief Method FromBytes addr 0x20a8a00 size 0xa0 virtual false final false
  static inline ::LiteNetLib::Utils::NetDataWriter* FromBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, bool copy);

  /// @brief Method FromBytes addr 0x20a8b14 size 0x8c virtual false final false
  static inline ::LiteNetLib::Utils::NetDataWriter* FromBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t offset, int32_t length);

  /// @brief Method FromString addr 0x20a00d4 size 0x70 virtual false final false
  static inline ::LiteNetLib::Utils::NetDataWriter* FromString(::StringW value);

  /// @brief Method ResizeIfNeed addr 0x20a8cd8 size 0x80 virtual false final false
  inline void ResizeIfNeed(int32_t newSize);

  /// @brief Method Reset addr 0x20a8d58 size 0x18 virtual false final false
  inline void Reset(int32_t size);

  /// @brief Method Reset addr 0x20a8d70 size 0x8 virtual false final false
  inline void Reset();

  /// @brief Method CopyData addr 0x20a8d78 size 0x74 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CopyData();

  /// @brief Method get_Data addr 0x20a8dec size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Data();

  /// @brief Method get_Length addr 0x20a8df4 size 0x8 virtual false final false
  inline int32_t get_Length();

  /// @brief Method Put addr 0x20a8dfc size 0x50 virtual false final false
  inline void Put(float_t value);

  /// @brief Method Put addr 0x20a8e4c size 0x50 virtual false final false
  inline void Put(double_t value);

  /// @brief Method Put addr 0x20a8e9c size 0x50 virtual false final false
  inline void Put(int64_t value);

  /// @brief Method Put addr 0x20a8eec size 0x50 virtual false final false
  inline void Put(uint64_t value);

  /// @brief Method Put addr 0x20a8f3c size 0x50 virtual false final false
  inline void Put(int32_t value);

  /// @brief Method Put addr 0x20a8f8c size 0x50 virtual false final false
  inline void Put(uint32_t value);

  /// @brief Method Put addr 0x20a8fdc size 0x50 virtual false final false
  inline void Put(char16_t value);

  /// @brief Method Put addr 0x20a902c size 0x50 virtual false final false
  inline void Put(uint16_t value);

  /// @brief Method Put addr 0x20a907c size 0x50 virtual false final false
  inline void Put(int16_t value);

  /// @brief Method Put addr 0x20a90cc size 0x68 virtual false final false
  inline void Put(int8_t value);

  /// @brief Method Put addr 0x20a9134 size 0x68 virtual false final false
  inline void Put(uint8_t value);

  /// @brief Method Put addr 0x20a8ba0 size 0x6c virtual false final false
  inline void Put(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t length);

  /// @brief Method Put addr 0x20a8aa0 size 0x74 virtual false final false
  inline void Put(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method PutSBytesWithLength addr 0x20a919c size 0x8c virtual false final false
  inline void PutSBytesWithLength(::ArrayW<int8_t, ::Array<int8_t>*> data, int32_t offset, int32_t length);

  /// @brief Method PutSBytesWithLength addr 0x20a9228 size 0x90 virtual false final false
  inline void PutSBytesWithLength(::ArrayW<int8_t, ::Array<int8_t>*> data);

  /// @brief Method PutBytesWithLength addr 0x20a92b8 size 0x8c virtual false final false
  inline void PutBytesWithLength(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t length);

  /// @brief Method PutBytesWithLength addr 0x20a9344 size 0x90 virtual false final false
  inline void PutBytesWithLength(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Put addr 0x20a93d4 size 0x6c virtual false final false
  inline void Put(bool value);

  /// @brief Method PutArray addr 0x20a9440 size 0xac virtual false final false
  inline void PutArray(::System::Array* arr, int32_t sz);

  /// @brief Method PutArray addr 0x20a94ec size 0x8 virtual false final false
  inline void PutArray(::ArrayW<float_t, ::Array<float_t>*> value);

  /// @brief Method PutArray addr 0x20a94f4 size 0x8 virtual false final false
  inline void PutArray(::ArrayW<double_t, ::Array<double_t>*> value);

  /// @brief Method PutArray addr 0x20a94fc size 0x8 virtual false final false
  inline void PutArray(::ArrayW<int64_t, ::Array<int64_t>*> value);

  /// @brief Method PutArray addr 0x20a9504 size 0x8 virtual false final false
  inline void PutArray(::ArrayW<uint64_t, ::Array<uint64_t>*> value);

  /// @brief Method PutArray addr 0x20a950c size 0x8 virtual false final false
  inline void PutArray(::ArrayW<int32_t, ::Array<int32_t>*> value);

  /// @brief Method PutArray addr 0x20a9514 size 0x8 virtual false final false
  inline void PutArray(::ArrayW<uint32_t, ::Array<uint32_t>*> value);

  /// @brief Method PutArray addr 0x20a951c size 0x8 virtual false final false
  inline void PutArray(::ArrayW<uint16_t, ::Array<uint16_t>*> value);

  /// @brief Method PutArray addr 0x20a9524 size 0x8 virtual false final false
  inline void PutArray(::ArrayW<int16_t, ::Array<int16_t>*> value);

  /// @brief Method PutArray addr 0x20a952c size 0x8 virtual false final false
  inline void PutArray(::ArrayW<bool, ::Array<bool>*> value);

  /// @brief Method PutArray addr 0x20a9534 size 0x88 virtual false final false
  inline void PutArray(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method PutArray addr 0x20a95bc size 0x9c virtual false final false
  inline void PutArray(::ArrayW<::StringW, ::Array<::StringW>*> value, int32_t maxLength);

  /// @brief Method Put addr 0x20a9740 size 0x104c virtual false final false
  inline void Put(::System::Net::IPEndPoint* endPoint);

  /// @brief Method Put addr 0x20a8c0c size 0xcc virtual false final false
  inline void Put(::StringW value);

  /// @brief Method Put addr 0x20a9658 size 0xe8 virtual false final false
