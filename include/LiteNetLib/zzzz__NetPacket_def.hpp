...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetPacket(NetPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetPacket(NetPacketconst&) = delete;
