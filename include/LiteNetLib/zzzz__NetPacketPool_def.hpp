...
// Write type traits
MARK_REF_T(::LiteNetLib::NetPacketPool*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetPacketPool*, "LiteNetLib", "NetPacketPool");
// Dependencies LiteNetLib.NetPacket, System.Object
namespace LiteNetLib {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__pool, put = __cordl_internal_set__pool)) ::ArrayW<::LiteNetLib::NetPacket*> _pool;

  /// @brief Method GetPacket, addr 0x589efe8, size 0x174, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetPacket(int32_t size);

  /// @brief Method GetWithData, addr 0x58a2b84, size 0xc0, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetWithData(::LiteNetLib::PacketProperty property, ::ArrayW<uint8_t> data, int32_t start, int32_t length);

  /// @brief Method GetWithProperty, addr 0x58a1358, size 0x8c, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetWithProperty(::LiteNetLib::PacketProperty property);

  /// @brief Method GetWithProperty, addr 0x58a07fc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Recycle, addr 0x589db40, size 0x128, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::LiteNetLib::NetPacket*> const& __cordl_internal_get__pool() const;

  constexpr ::ArrayW<::LiteNetLib::NetPacket*>& __cordl_internal_get__pool();

  constexpr void __cordl_internal_set__count(int32_t value);

  constexpr void __cordl_internal_set__lock(::System::Threading::ReaderWriterLockSlim* value);

  constexpr void __cordl_internal_set__pool(::ArrayW<::LiteNetLib::NetPacket*> value);

  /// @brief Method .ctor, addr 0x589e894, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetPacketPool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetPacketPool(NetPacketPool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetPacketPool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetPacketPool(NetPacketPoolconst&) = delete;
  ...
  ::ArrayW<::LiteNetLib::NetPacket*> ____pool;
...
static_assert(sizeof(::LiteNetLib::NetPacketPool) == 0x28, "Size mismatch!");
