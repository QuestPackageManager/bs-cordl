...
/// @brief Method GetPacket, addr 0x575ac80, size 0x174, virtual false, abstract: false, final false
inline ::LiteNetLib::NetPacket* GetPacket(int32_t  size) ;

/// @brief Method GetWithData, addr 0x575e81c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetWithProperty, addr 0x575cff0, size 0x8c, virtual false, abstract: false, final false
inline ::LiteNetLib::NetPacket* GetWithProperty(::LiteNetLib::PacketProperty  property) ;

/// @brief Method GetWithProperty, addr 0x575c494, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Recycle, addr 0x57597d8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x575a52c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;
