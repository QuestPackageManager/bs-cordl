...
public:
  ...
  /// @brief Method GetPacket, addr 0x58a1174, size 0x174, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetPacket(int32_t size);

  /// @brief Method GetWithData, addr 0x58a4d10, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWithProperty, addr 0x58a34e4, size 0x8c, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPacket* GetWithProperty(::LiteNetLib::PacketProperty property);

  /// @brief Method GetWithProperty, addr 0x58a2988, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Recycle, addr 0x589fccc, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a0a20, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
