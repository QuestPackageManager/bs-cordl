...
public:
  ...
  /// @brief Method Equals, addr 0x575e4b0, size 0x5c, virtual true, abstract: false, final true
  inline bool Equals(::System::Net::IPEndPoint* x, ::System::Net::IPEndPoint* y);

  /// @brief Method GetHashCode, addr 0x575e50c, size 0x20, virtual true, abstract: false, final true
  inline int32_t GetHashCode(::System::Net::IPEndPoint* obj);

  static inline ::LiteNetLib::NetManager_IPEndPointComparer* New_ctor();

  /// @brief Method .ctor, addr 0x5758d54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x575e52c, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method MoveNext, addr 0x575e530, size 0x2c, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method Reset, addr 0x575e55c, size 0x38, virtual true, abstract: false, final true
  inline void Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x575e59c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method .ctor, addr 0x575e3e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* p);

  /// @brief Method get_Current, addr 0x575e594, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method AddPeer, addr 0x5758548, size 0x170, virtual false, abstract: false, final false
  inline void AddPeer(::LiteNetLib::NetPeer* peer);

  /// @brief Method Connect, addr 0x575d9c4, size 0x148, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* Connect(::StringW address, int32_t port, ::LiteNetLib::Utils::NetDataWriter* connectionData);

  /// @brief Method Connect, addr 0x575d918, size 0x38, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* Connect(::StringW address, int32_t port, ::StringW key);

  /// @brief Method Connect, addr 0x575db0c, size 0x1d8, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* Connect(::System::Net::IPEndPoint* target, ::LiteNetLib::Utils::NetDataWriter* connectionData);

  /// @brief Method Connect, addr 0x575dce4, size 0x30, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* Connect(::System::Net::IPEndPoint* target, ::StringW key);

  /// @brief Method ConnectionLatencyUpdated, addr 0x5758d58, size 0x40, virtual false, abstract: false, final false
  inline void ConnectionLatencyUpdated(::LiteNetLib::NetPeer* fromPeer, int32_t latency);

  /// @brief Method CreateEvent, addr 0x5758d98, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateReceiveEvent, addr 0x575c0c8, size 0x284, virtual false, abstract: false, final false
  inline void CreateReceiveEvent(::LiteNetLib::NetPacket* packet, ::LiteNetLib::DeliveryMethod method, ::LiteNetLib::NetPeer* fromPeer);

  /// @brief Method DataReceived, addr 0x575a664, size 0x5c8, virtual false, abstract: false, final false
  inline void DataReceived(::ArrayW<uint8_t, ::Array<uint8_t>*> reusableBuffer, int32_t count, ::System::Net::IPEndPoint* remoteEndPoint);

  /// @brief Method DisconnectAll, addr 0x575e21c, size 0x10, virtual false, abstract: false, final false
  inline void DisconnectAll();

  /// @brief Method DisconnectAll, addr 0x575e22c, size 0x90, virtual false, abstract: false, final false
  inline void DisconnectAll(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t start, int32_t count);

  /// @brief Method DisconnectPeer, addr 0x575e2f0, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectPeer(::LiteNetLib::NetPeer* peer);

  /// @brief Method DisconnectPeer, addr 0x575e358, size 0x3c, virtual false, abstract: false, final false
  inline void DisconnectPeer(::LiteNetLib::NetPeer* peer, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method DisconnectPeer, addr 0x575e324, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectPeer(::LiteNetLib::NetPeer* peer, ::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t start, int32_t count);

  /// @brief Method DisconnectPeer, addr 0x57595f8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method DisconnectPeer, addr 0x575e394, size 0x3c, virtual false, abstract: false, final false
  inline void DisconnectPeer(::LiteNetLib::NetPeer* peer, ::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method DisconnectPeerForce, addr 0x575e2bc, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectPeerForce(::LiteNetLib::NetPeer* peer);

  /// @brief Method DisconnectPeerForce, addr 0x575958c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Flush, addr 0x575d538, size 0x28, virtual false, abstract: false, final false
  inline void Flush();

  /// @brief Method GetEnumerator, addr 0x575e3d0, size 0x10, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetManager_NetPeerEnumerator GetEnumerator();

  /// @brief Method GetNextPeerId, addr 0x575acf4, size 0x134, virtual false, abstract: false, final false
  inline int32_t GetNextPeerId();

  /// @brief Method GetPeerById, addr 0x5758470, size 0x30, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* GetPeerById(int32_t id);

  /// @brief Method GetPeersCount, addr 0x575e1ac, size 0x70, virtual false, abstract: false, final false
  inline int32_t GetPeersCount(::LiteNetLib::ConnectionState peerState);

  /// @brief Method GetPeersNonAlloc, addr 0x5758344, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method LiteNetLib.INetSocketListener.OnMessageReceived, addr 0x575a3dc, size 0x288, virtual true, abstract: false, final true
  ...
  /// @brief Method MessageDelivered, addr 0x57590d0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnConnectionSolved, addr 0x5753e6c, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method PollEvents, addr 0x575d7a8, size 0x170, virtual false, abstract: false, final false
  inline void PollEvents();

  /// @brief Method ProcessConnectRequest, addr 0x575b1dc, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEvent, addr 0x5759978, size 0x538, virtual false, abstract: false, final false
  inline void ProcessEvent(::LiteNetLib::NetEvent* evt);

  /// @brief Method RecycleEvent, addr 0x5758098, size 0x118, virtual false, abstract: false, final false
  inline void RecycleEvent(::LiteNetLib::NetEvent* evt);

  /// @brief Method RemovePeer, addr 0x57586b8, size 0x48, virtual false, abstract: false, final false
  inline void RemovePeer(::LiteNetLib::NetPeer* peer);

  /// @brief Method RemovePeerInternal, addr 0x5758700, size 0x1bc, virtual false, abstract: false, final false
  inline void RemovePeerInternal(::LiteNetLib::NetPeer* peer);

  /// @brief Method SendBroadcast, addr 0x575d1f8, size 0x1c, virtual false, abstract: false, final false
  inline bool SendBroadcast(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t port);

  /// @brief Method SendBroadcast, addr 0x575d098, size 0x160, virtual false, abstract: false, final false
  inline bool SendBroadcast(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t start, int32_t length, int32_t port);

  /// @brief Method SendBroadcast, addr 0x575d074, size 0x24, virtual false, abstract: false, final false
  inline bool SendBroadcast(::LiteNetLib::Utils::NetDataWriter* writer, int32_t port);

  /// @brief Method SendRaw, addr 0x5759170, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method SendRaw, addr 0x57593f4, size 0x24, virtual false, abstract: false, final false
  inline int32_t SendRaw(::LiteNetLib::NetPacket* packet, ::System::Net::IPEndPoint* remoteEndPoint);

  /// @brief Method SendRawAndRecycle, addr 0x575911c, size 0x54, virtual false, abstract: false, final false
  inline int32_t SendRawAndRecycle(::LiteNetLib::NetPacket* packet, ::System::Net::IPEndPoint* remoteEndPoint);

  /// @brief Method SendToAll, addr 0x575c4cc, size 0x20, virtual false, abstract: false, final false
  inline void SendToAll(::ArrayW<uint8_t, ::Array<uint8_t>*> data, uint8_t channelNumber, ::LiteNetLib::DeliveryMethod options);

  /// @brief Method SendToAll, addr 0x575c694, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToAll, addr 0x575c380, size 0x20, virtual false, abstract: false, final false
  inline void SendToAll(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::LiteNetLib::DeliveryMethod options);

  /// @brief Method SendToAll, addr 0x575c634, size 0x24, virtual false, abstract: false, final false
  inline void SendToAll(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::LiteNetLib::DeliveryMethod options, ::LiteNetLib::NetPeer* excludePeer);

  /// @brief Method SendToAll, addr 0x575c3a0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToAll, addr 0x575c520, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToAll, addr 0x575c374, size 0xc, virtual false, abstract: false, final false
  inline void SendToAll(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t start, int32_t length, ::LiteNetLib::DeliveryMethod options);

  /// @brief Method SendToAll, addr 0x575c658, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToAll, addr 0x575c4a4, size 0x28, virtual false, abstract: false, final false
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, uint8_t channelNumber, ::LiteNetLib::DeliveryMethod options);

  /// @brief Method SendToAll, addr 0x575c668, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendToAll, addr 0x575c34c, size 0x28, virtual false, abstract: false, final false
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::LiteNetLib::DeliveryMethod options);

  /// @brief Method SendToAll, addr 0x575c4f4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method SendUnconnectedMessage, addr 0x575cf20, size 0x1c, virtual false, abstract: false, final false
  inline bool SendUnconnectedMessage(::ArrayW<uint8_t, ::Array<uint8_t>*> message, ::System::Net::IPEndPoint* remoteEndPoint);

  /// @brief Method SendUnconnectedMessage, addr 0x575cf3c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SendUnconnectedMessage, addr 0x575cf90, size 0x24, virtual false, abstract: false, final false
  inline bool SendUnconnectedMessage(::LiteNetLib::Utils::NetDataWriter* writer, ::System::Net::IPEndPoint* remoteEndPoint);

  /// @brief Method Start, addr 0x575c6b8, size 0x8, virtual false, abstract: false, final false
  inline bool Start();

  /// @brief Method Start, addr 0x575ccd8, size 0x94, virtual false, abstract: false, final false
  inline bool Start(::StringW addressIPv4, ::StringW addressIPv6, int32_t port);

  /// @brief Method Start, addr 0x575c738, size 0x194, virtual false, abstract: false, final false
  inline bool Start(::System::Net::IPAddress* addressIPv4, ::System::Net::IPAddress* addressIPv6, int32_t port);

  /// @brief Method Start, addr 0x575c6c0, size 0x78, virtual false, abstract: false, final false
  inline bool Start(int32_t port);

  /// @brief Method Stop, addr 0x575de1c, size 0x8, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Stop, addr 0x575de24, size 0x2d8, virtual false, abstract: false, final false
  inline void Stop(bool sendDisconnectMessages);

  /// @brief Method System.Collections.Generic.IEnumerable<LiteNetLib.NetPeer>.GetEnumerator, addr 0x575e3e8, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x575e44c, size 0x64, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method TryGetPeer, addr 0x57584ac, size 0x9c, virtual false, abstract: false, final false
  inline bool TryGetPeer(::System::Net::IPEndPoint* endPoint, ::ByRef<::LiteNetLib::NetPeer*> peer);

  /// @brief Method UpdateLogic, addr 0x5759ec0, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57588bc, size 0x400, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::INetEventListener* listener, ::LiteNetLib::Layers::PacketLayerBase* extraPacketLayer);

  /// @brief Method get_ChannelsCount, addr 0x57582b8, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_ChannelsCount();

  /// @brief Method get_ConnectedPeerList, addr 0x5758324, size 0x20, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::LiteNetLib::NetPeer*>* get_ConnectedPeerList();

  /// @brief Method get_ConnectedPeersCount, addr 0x57584a0, size 0xc, virtual false, abstract: false, final false
  inline int32_t get_ConnectedPeersCount();

  /// @brief Method get_FirstPeer, addr 0x57582ac, size 0xc, virtual false, abstract: false, final false
  inline ::LiteNetLib::NetPeer* get_FirstPeer();

  /// @brief Method get_IsRunning, addr 0x5758278, size 0x1c, virtual false, abstract: false, final false
  inline bool get_IsRunning();

  /// @brief Method get_LocalPort, addr 0x5758294, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ChannelsCount, addr 0x57582c0, size 0x64, virtual false, abstract: false, final false
