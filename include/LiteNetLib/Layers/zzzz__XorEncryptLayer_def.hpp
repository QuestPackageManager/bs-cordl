...
public:
  ...
  /// @brief Method .ctor, addr 0x22a2d50, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::LiteNetLib::Layers::XorEncryptLayer* New_ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method .ctor, addr 0x22a2d6c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  static inline ::LiteNetLib::Layers::XorEncryptLayer* New_ctor(::StringW key);

  /// @brief Method .ctor, addr 0x22a2e30, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW key);

  /// @brief Method SetKey, addr 0x22a2e60, size 0x44, virtual false, abstract: false, final false
  inline void SetKey(::StringW key);

  /// @brief Method SetKey, addr 0x22a2d9c, size 0x94, virtual false, abstract: false, final false
  inline void SetKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  /// @brief Method ProcessInboundPacket, addr 0x22a2ea4, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessOutBoundPacket, addr 0x22a2f34, size 0x8c, virtual true, abstract: false, final false
