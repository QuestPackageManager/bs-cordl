...
public:
  ...
  /// @brief Method .ctor, addr 0x220d1ec, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ProcessInboundPacket, addr 0x220d234, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessOutBoundPacket, addr 0x220d3c8, size 0xa0, virtual true, abstract: false, final false
