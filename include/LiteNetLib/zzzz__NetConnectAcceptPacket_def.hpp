...
public:
  ...
  /// @brief Method FromData, addr 0x56edd88, size 0xc8, virtual false, abstract: false, final false
  static inline ::LiteNetLib::NetConnectAcceptPacket* FromData(::LiteNetLib::NetPacket* packet);

  /// @brief Method Make, addr 0x56f0dd0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56f0dc0, size 0x10, virtual false, abstract: false, final false
