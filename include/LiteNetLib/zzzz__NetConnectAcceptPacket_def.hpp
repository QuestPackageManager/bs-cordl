...
public:
  ...
  /// @brief Method FromData, addr 0x575b9fc, size 0xc8, virtual false, abstract: false, final false
  static inline ::LiteNetLib::NetConnectAcceptPacket* FromData(::LiteNetLib::NetPacket* packet);

  /// @brief Method Make, addr 0x575ea44, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575ea34, size 0x10, virtual false, abstract: false, final false
