...
public:
  ...
  /// @brief Method FromData, addr 0x3ab6150, size 0xdc, virtual false, abstract: false, final false
  static inline ::LiteNetLib::NetConnectAcceptPacket* FromData(::LiteNetLib::NetPacket* packet);

  /// @brief Method Make, addr 0x3ab920c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ab91cc, size 0x40, virtual false, abstract: false, final false
