...
// Write type traits
MARK_REF_T(::LiteNetLib::NetConnectAcceptPacket*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetConnectAcceptPacket*, "LiteNetLib", "NetConnectAcceptPacket");
...
public:
  ...
  /// @brief Method FromData, addr 0x58a15cc, size 0xc8, virtual false, abstract: false, final false
  static inline ::LiteNetLib::NetConnectAcceptPacket* FromData(::LiteNetLib::NetPacket* packet);

  /// @brief Method Make, addr 0x58a4614, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a4604, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetConnectAcceptPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetConnectAcceptPacket(NetConnectAcceptPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetConnectAcceptPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetConnectAcceptPacket(NetConnectAcceptPacketconst&) = delete;
...
static_assert(sizeof(::LiteNetLib::NetConnectAcceptPacket) == 0x20, "Size mismatch!");
