...
public:
  ...
  /// @brief Method .ctor, addr 0x24e95a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x24e95a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x24e95b0, size 0x8, virtual false, abstract: false, final false
