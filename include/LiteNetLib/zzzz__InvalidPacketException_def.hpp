...
public:
  ...
  /// @brief Method .ctor addr 0x209a4dc size 0x8 virtual false final false
  inline void _ctor();

  static inline ::LiteNetLib::InvalidPacketException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x209a4e4 size 0x8 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::LiteNetLib::InvalidPacketException* New_ctor(::StringW message, ::System::Exception* innerException);

  /// @brief Method .ctor addr 0x209a4ec size 0x8 virtual false final false
