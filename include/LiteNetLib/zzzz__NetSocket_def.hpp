...
public:
  ...
  /// @brief Method Bind, addr 0x575c8cc, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method BindSocket, addr 0x5760da4, size 0x5dc, virtual false, abstract: false, final false
  inline bool BindSocket(::System::Net::Sockets::Socket* socket, ::System::Net::IPEndPoint* ep, bool reuseAddress);

  /// @brief Method Close, addr 0x575e0fc, size 0xb0, virtual false, abstract: false, final false
  inline void Close(bool suspend);

  /// @brief Method IsActive, addr 0x5760868, size 0xc, virtual false, abstract: false, final false
  inline bool IsActive();

  static inline ::LiteNetLib::NetSocket* New_ctor(::LiteNetLib::INetSocketListener* listener);

  /// @brief Method ReceiveLogic, addr 0x5760874, size 0x530, virtual false, abstract: false, final false
  inline void ReceiveLogic(::System::Object* state);

  /// @brief Method SendBroadcast, addr 0x575d274, size 0x2c4, virtual false, abstract: false, final false
  inline bool SendBroadcast(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t size, int32_t port);

  /// @brief Method SendTo, addr 0x5757444, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5758cbc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocalPort, addr 0x5760768, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LocalPort();

  /// @brief Method get_Ttl, addr 0x5760778, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LocalPort, addr 0x5760770, size 0x8, virtual false, abstract: false, final false
  inline void set_LocalPort(int32_t value);

  /// @brief Method set_Ttl, addr 0x575742c, size 0x18, virtual false, abstract: false, final false
