...
public:
  ...
  /// @brief Method Bind, addr 0x58a4628, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method BindSocket, addr 0x58a8b00, size 0x5dc, virtual false, abstract: false, final false
  inline bool BindSocket(::System::Net::Sockets::Socket* socket, ::System::Net::IPEndPoint* ep, bool reuseAddress);

  /// @brief Method Close, addr 0x58a5e58, size 0xb0, virtual false, abstract: false, final false
  inline void Close(bool suspend);

  /// @brief Method IsActive, addr 0x58a85c4, size 0xc, virtual false, abstract: false, final false
  inline bool IsActive();

  static inline ::LiteNetLib::NetSocket* New_ctor(::LiteNetLib::INetSocketListener* listener);

  /// @brief Method ReceiveLogic, addr 0x58a85d0, size 0x530, virtual false, abstract: false, final false
  inline void ReceiveLogic(::System::Object* state);

  /// @brief Method SendBroadcast, addr 0x58a4fd0, size 0x2c4, virtual false, abstract: false, final false
  inline bool SendBroadcast(::ArrayW<uint8_t> data, int32_t offset, int32_t size, int32_t port);

  /// @brief Method SendTo, addr 0x589f1a0, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a0a18, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocalPort, addr 0x58a84c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_LocalPort();

  /// @brief Method get_Ttl, addr 0x58a84d4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LocalPort, addr 0x58a84cc, size 0x8, virtual false, abstract: false, final false
  inline void set_LocalPort(int32_t value);

  /// @brief Method set_Ttl, addr 0x589f188, size 0x18, virtual false, abstract: false, final false
