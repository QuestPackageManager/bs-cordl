...
public:
  ...
  /// @brief Method Write, addr 0x589f96c, size 0x70, virtual false, abstract: false, final false
  static inline void Write(::LiteNetLib::NetLogLevel level, ::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method Write, addr 0x589f900, size 0x6c, virtual false, abstract: false, final false
  static inline void Write(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteError, addr 0x589bb5c, size 0x6c, virtual false, abstract: false, final false
  static inline void WriteError(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteForce, addr 0x589fa48, size 0x70, virtual false, abstract: false, final false
  static inline void WriteForce(::LiteNetLib::NetLogLevel level, ::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteForce, addr 0x589f9dc, size 0x6c, virtual false, abstract: false, final false
  static inline void WriteForce(::StringW str, ::ArrayW<::System::Object*> args);

  /// @brief Method WriteLogic, addr 0x589f6e8, size 0x218, virtual false, abstract: false, final false
