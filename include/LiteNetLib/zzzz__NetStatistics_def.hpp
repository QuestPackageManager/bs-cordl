...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetStatistics", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetStatistics(NetStatistics&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetStatistics", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetStatistics(NetStatisticsconst&) = delete;
