...
public:
  ...
  /// @brief Method AddBytesReceived, addr 0x3ac1040, size 0xc, virtual false, abstract: false, final false
  inline void AddBytesReceived(int64_t bytesReceived);

  /// @brief Method AddBytesSent, addr 0x3abf0ac, size 0xc, virtual false, abstract: false, final false
  inline void AddBytesSent(int64_t bytesSent);

  /// @brief Method AddPacketLoss, addr 0x3ac6fc8, size 0xc, virtual false, abstract: false, final false
  inline void AddPacketLoss(int64_t packetLoss);

  /// @brief Method IncrementPacketLoss, addr 0x3ac6fbc, size 0xc, virtual false, abstract: false, final false
  inline void IncrementPacketLoss();

  /// @brief Method IncrementPacketsReceived, addr 0x3ac1034, size 0xc, virtual false, abstract: false, final false
  inline void IncrementPacketsReceived();

  /// @brief Method IncrementPacketsSent, addr 0x3abf0a0, size 0xc, virtual false, abstract: false, final false
  inline void IncrementPacketsSent();

  static inline ::LiteNetLib::NetStatistics* New_ctor();

  /// @brief Method Reset, addr 0x3ac6f60, size 0x5c, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method ToString, addr 0x3ac6fd4, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3abe868, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BytesReceived, addr 0x3ac6efc, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_BytesReceived();

  /// @brief Method get_BytesSent, addr 0x3ac6ef0, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_BytesSent();

  /// @brief Method get_PacketLoss, addr 0x3ac6f08, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_PacketLoss();

  /// @brief Method get_PacketLossPercent, addr 0x3ac6f14, size 0x4c, virtual false, abstract: false, final false
  inline int64_t get_PacketLossPercent();

  /// @brief Method get_PacketsReceived, addr 0x3ac6ee4, size 0xc, virtual false, abstract: false, final false
  inline int64_t get_PacketsReceived();

  /// @brief Method get_PacketsSent, addr 0x3ac6ed8, size 0xc, virtual false, abstract: false, final false
