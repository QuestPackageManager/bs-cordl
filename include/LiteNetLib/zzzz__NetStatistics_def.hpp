...
public:
  ...
  /// @brief Method get_PacketsSent addr 0x20a3dc4 size 0xc virtual false final false
  inline int64_t get_PacketsSent();

  /// @brief Method get_PacketsReceived addr 0x20a3dd0 size 0xc virtual false final false
  inline int64_t get_PacketsReceived();

  /// @brief Method get_BytesSent addr 0x20a3ddc size 0xc virtual false final false
  inline int64_t get_BytesSent();

  /// @brief Method get_BytesReceived addr 0x20a3de8 size 0xc virtual false final false
  inline int64_t get_BytesReceived();

  /// @brief Method get_PacketLoss addr 0x20a3df4 size 0xc virtual false final false
  inline int64_t get_PacketLoss();

  /// @brief Method get_PacketLossPercent addr 0x20a3e00 size 0x4c virtual false final false
  inline int64_t get_PacketLossPercent();

  /// @brief Method Reset addr 0x20a3e4c size 0x5c virtual false final false
  inline void Reset();

  /// @brief Method IncrementPacketsSent addr 0x209bca4 size 0xc virtual false final false
  inline void IncrementPacketsSent();

  /// @brief Method IncrementPacketsReceived addr 0x209dc2c size 0xc virtual false final false
  inline void IncrementPacketsReceived();

  /// @brief Method AddBytesSent addr 0x209bcb0 size 0xc virtual false final false
  inline void AddBytesSent(int64_t bytesSent);

  /// @brief Method AddBytesReceived addr 0x209dc38 size 0xc virtual false final false
  inline void AddBytesReceived(int64_t bytesReceived);

  /// @brief Method IncrementPacketLoss addr 0x20a3ea8 size 0xc virtual false final false
  inline void IncrementPacketLoss();

  /// @brief Method AddPacketLoss addr 0x20a3eb4 size 0xc virtual false final false
  inline void AddPacketLoss(int64_t packetLoss);

  /// @brief Method ToString addr 0x20a3ec0 size 0x270 virtual true final false
  inline ::StringW ToString();

  static inline ::LiteNetLib::NetStatistics* New_ctor();

  /// @brief Method .ctor addr 0x209b44c size 0x8 virtual false final false
  inline void _ctor();
