...
public:
  ...
  /// @brief Method MakeEndPoint, addr 0x2290b5c, size 0xa8, virtual false, abstract: false, final false
  static inline ::System::Net::IPEndPoint* MakeEndPoint(::StringW hostStr, int32_t port);

  /// @brief Method ResolveAddress, addr 0x2296bc0, size 0x1b8, virtual false, abstract: false, final false
  static inline ::System::Net::IPAddress* ResolveAddress(::StringW hostStr);

  /// @brief Method ResolveAddress, addr 0x229b86c, size 0xcc, virtual false, abstract: false, final false
  static inline ::System::Net::IPAddress* ResolveAddress(::StringW hostStr, ::System::Net::Sockets::AddressFamily addressFamily);

  /// @brief Method ResolveAddresses, addr 0x229b938, size 0x20, virtual false, abstract: false, final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> ResolveAddresses(::StringW hostStr);

  /// @brief Method GetLocalIpList, addr 0x229b958, size 0xa4, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::StringW>* GetLocalIpList(::LiteNetLib::LocalAddrType addrType);

  /// @brief Method GetLocalIpList, addr 0x229b9fc, size 0x84c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLocalIp, addr 0x2290d20, size 0x21c, virtual false, abstract: false, final false
  static inline ::StringW GetLocalIp(::LiteNetLib::LocalAddrType addrType);

  /// @brief Method PrintInterfaceInfos, addr 0x229c248, size 0x41c, virtual false, abstract: false, final false
  static inline void PrintInterfaceInfos();

  /// @brief Method RelativeSequenceNumber, addr 0x229a478, size 0x2c, virtual false, abstract: false, final false
