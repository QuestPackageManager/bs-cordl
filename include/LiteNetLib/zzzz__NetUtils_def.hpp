...
public:
  ...
  /// @brief Method MakeEndPoint addr 0x2099420 size 0xa8 virtual false final false
  static inline ::System::Net::IPEndPoint* MakeEndPoint(::StringW hostStr, int32_t port);

  /// @brief Method ResolveAddress addr 0x209f484 size 0x1b8 virtual false final false
  static inline ::System::Net::IPAddress* ResolveAddress(::StringW hostStr);

  /// @brief Method ResolveAddress addr 0x20a4130 size 0xcc virtual false final false
  static inline ::System::Net::IPAddress* ResolveAddress(::StringW hostStr, ::System::Net::Sockets::AddressFamily addressFamily);

  /// @brief Method ResolveAddresses addr 0x20a41fc size 0x20 virtual false final false
  static inline ::ArrayW<::System::Net::IPAddress*, ::Array<::System::Net::IPAddress*>*> ResolveAddresses(::StringW hostStr);

  /// @brief Method GetLocalIpList addr 0x20a421c size 0xa4 virtual false final false
  static inline ::System::Collections::Generic::List_1<::StringW>* GetLocalIpList(::LiteNetLib::LocalAddrType addrType);

  /// @brief Method GetLocalIpList addr 0x20a42c0 size 0x84c virtual false final false
  ...
  /// @brief Method GetLocalIp addr 0x20995e4 size 0x21c virtual false final false
  static inline ::StringW GetLocalIp(::LiteNetLib::LocalAddrType addrType);

  /// @brief Method PrintInterfaceInfos addr 0x20a4b0c size 0x41c virtual false final false
  static inline void PrintInterfaceInfos();

  /// @brief Method RelativeSequenceNumber addr 0x20a2d3c size 0x2c virtual false final false
