...
// Write type traits
MARK_REF_T(::LiteNetLib::NetConstants*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetConstants*, "LiteNetLib", "NetConstants");
...
public:
  ...
  __declspec(property(get = getStaticF_PossibleMtu, put = setStaticF_PossibleMtu)) ::ArrayW<int32_t> PossibleMtu;

  static inline int32_t getStaticF_MaxPacketSize();

  static inline ::ArrayW<int32_t> getStaticF_PossibleMtu();

  static inline void setStaticF_MaxPacketSize(int32_t value);

  static inline void setStaticF_PossibleMtu(::ArrayW<int32_t> value);
...
static_assert(sizeof(::LiteNetLib::NetConstants) == 0x10, "Size mismatch!");
