...
/// @brief Method Accept, addr 0x56e63a0, size 0x68, virtual false, abstract: false, final false
inline ::LiteNetLib::NetPeer* Accept() ;

/// @brief Method AcceptIfKey, addr 0x56e5d10, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method Reject, addr 0x56e64f8, size 0x14, virtual false, abstract: false, final false
inline void Reject() ;

/// @brief Method Reject, addr 0x56e650c, size 0x1c, virtual false, abstract: false, final false
inline void Reject(::ArrayW<uint8_t,::Array<uint8_t>*>  rejectData) ;

/// @brief Method Reject, addr 0x56e6494, size 0x8, virtual false, abstract: false, final false
inline void Reject(::ArrayW<uint8_t,::Array<uint8_t>*>  rejectData, int32_t  start, int32_t  length) ;

/// @brief Method Reject, addr 0x56e6408, size 0x8c, virtual false, abstract: false, final false
inline void Reject(::ArrayW<uint8_t,::Array<uint8_t>*>  rejectData, int32_t  start, int32_t  length, bool  force) ;

/// @brief Method Reject, addr 0x56e6528, size 0x24, virtual false, abstract: false, final false
inline void Reject(::LiteNetLib::Utils::NetDataWriter*  rejectData) ;

/// @brief Method RejectForce, addr 0x56e64a4, size 0x14, virtual false, abstract: false, final false
inline void RejectForce() ;

/// @brief Method RejectForce, addr 0x56e64b8, size 0x1c, virtual false, abstract: false, final false
inline void RejectForce(::ArrayW<uint8_t,::Array<uint8_t>*>  rejectData) ;

/// @brief Method RejectForce, addr 0x56e649c, size 0x8, virtual false, abstract: false, final false
inline void RejectForce(::ArrayW<uint8_t,::Array<uint8_t>*>  rejectData, int32_t  start, int32_t  length) ;

/// @brief Method RejectForce, addr 0x56e64d4, size 0x24, virtual false, abstract: false, final false
inline void RejectForce(::LiteNetLib::Utils::NetDataWriter*  rejectData) ;

/// @brief Method TryActivate, addr 0x56e5ca4, size 0x28, virtual false, abstract: false, final false
inline bool TryActivate() ;

/// @brief Method UpdateRequest, addr 0x56e5ccc, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56e5cf8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_Result, addr 0x56e5c94, size 0x8, virtual false, abstract: false, final false
inline ::LiteNetLib::ConnectionRequestResult get_Result() ;

/// @brief Method set_Result, addr 0x56e5c9c, size 0x8, virtual false, abstract: false, final false
