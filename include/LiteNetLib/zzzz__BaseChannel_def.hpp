...
public:
  ...
  /// @brief Method AddToQueue, addr 0x25f4f14, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f4e38, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method get_PacketsInQueue, addr 0x25f4ecc, size 0x48, virtual false, abstract: false, final false
