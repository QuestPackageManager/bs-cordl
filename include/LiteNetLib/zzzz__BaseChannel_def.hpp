...
public:
  ...
  /// @brief Method AddToQueue, addr 0x3aae5c4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aae4f0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method get_PacketsInQueue, addr 0x3aae57c, size 0x48, virtual false, abstract: false, final false
