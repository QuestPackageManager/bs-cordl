...
public:
  ...
  /// @brief Method AddToQueue, addr 0x23bbdfc, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23bbd20, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method get_PacketsInQueue, addr 0x23bbdb4, size 0x48, virtual false, abstract: false, final false
