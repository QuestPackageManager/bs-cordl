...
public:
  ...
  /// @brief Method AddToQueue, addr 0x5753a7c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57539a4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* peer);

  /// @brief Method get_PacketsInQueue, addr 0x5753a2c, size 0x50, virtual false, abstract: false, final false
