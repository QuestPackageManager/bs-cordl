...
MARK_REF_T(::LiteNetLib::NetEvent*);
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetEvent_EType, "LiteNetLib", "NetEvent/EType");
DEFINE_IL2CPP_CLASS(::LiteNetLib::NetEvent*, "LiteNetLib", "NetEvent");
// Dependencies
namespace LiteNetLib {
// Is value type: true
...
static_assert(sizeof(::LiteNetLib::NetEvent_EType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x589ff74, size 0x60, virtual false, abstract: false, final false
...
static_assert(sizeof(::LiteNetLib::NetEvent) == 0x58, "Size mismatch!");
