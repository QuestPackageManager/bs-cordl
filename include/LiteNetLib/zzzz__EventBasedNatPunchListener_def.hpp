...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x23be4bc, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x23be4e8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x23be4a8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be378, size 0x130, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x23be638, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x23be6d0, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x23be624, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23be4f4, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method LiteNetLib.INatPunchListener.OnNatIntroductionRequest, addr 0x23be338, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INatPunchListener.OnNatIntroductionSuccess, addr 0x23be354, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23be370, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_NatIntroductionRequest, addr 0x23be0c8, size 0x9c, virtual false, abstract: false, final false
  inline void add_NatIntroductionRequest(::LiteNetLib::__EventBasedNatPunchListener__OnNatIntroductionRequest* value);

  /// @brief Method add_NatIntroductionSuccess, addr 0x23be200, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_NatIntroductionRequest, addr 0x23be164, size 0x9c, virtual false, abstract: false, final false
  inline void remove_NatIntroductionRequest(::LiteNetLib::__EventBasedNatPunchListener__OnNatIntroductionRequest* value);

  /// @brief Method remove_NatIntroductionSuccess, addr 0x23be29c, size 0x9c, virtual false, abstract: false, final false
