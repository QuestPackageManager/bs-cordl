...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x235c6e4, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x235c710, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x235c6d0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x235c5a0, size 0x130, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x235c860, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x235c8f8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x235c84c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x235c71c, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, void* method);
...
public:
  ...
  /// @brief Method LiteNetLib.INatPunchListener.OnNatIntroductionRequest, addr 0x235c560, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INatPunchListener.OnNatIntroductionSuccess, addr 0x235c57c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x235c598, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_NatIntroductionRequest, addr 0x235c2f0, size 0x9c, virtual false, abstract: false, final false
  inline void add_NatIntroductionRequest(::LiteNetLib::__EventBasedNatPunchListener__OnNatIntroductionRequest* value);

  /// @brief Method add_NatIntroductionSuccess, addr 0x235c428, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_NatIntroductionRequest, addr 0x235c38c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_NatIntroductionRequest(::LiteNetLib::__EventBasedNatPunchListener__OnNatIntroductionRequest* value);

  /// @brief Method remove_NatIntroductionSuccess, addr 0x235c4c4, size 0x9c, virtual false, abstract: false, final false
