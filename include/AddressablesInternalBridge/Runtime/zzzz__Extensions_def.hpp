...
public:
  ...
  /// @brief Method <GetUpdateableCatalogLocationDatas>b__1_0, addr 0x44d826c, size 0x14, virtual false, abstract: false, final false
  inline bool _GetUpdateableCatalogLocationDatas_b__1_0(::UnityEngine::AddressableAssets::ResourceLocatorInfo* locatorInfo);

  /// @brief Method <GetUpdateableCatalogLocationDatas>b__1_1, addr 0x44d8424, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d8264, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCatalogLocationData, addr 0x44d7cc4, size 0xb4, virtual false, abstract: false, final false
  static inline ::AddressablesInternalBridge::Runtime::CatalogLocationData* GetCatalogLocationData(::StringW locatorId);

  /// @brief Method GetUpdateableCatalogLocationDatas, addr 0x44d802c, size 0x1dc, virtual false, abstract: false, final false
