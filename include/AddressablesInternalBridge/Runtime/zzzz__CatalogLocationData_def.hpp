...
public:
  ...
  /// @brief Method .ctor, addr 0x6306448, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CatalogLocation, addr 0x6306a88, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_CatalogLocation();

  /// @brief Method get_LocalHash, addr 0x6306a80, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_LocalHash();

  /// @brief Method get_LocatorId, addr 0x6306a78, size 0x8, virtual false, abstract: false, final false
