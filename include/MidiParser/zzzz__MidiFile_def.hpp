...
public:
  // Declarations
  /// @brief Method Read16, addr 0x3c2dfe0, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Read16(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> i);

  /// @brief Method Read32, addr 0x3c2df50, size 0x90, virtual false, abstract: false, final false
  static inline int32_t Read32(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> i);

  /// @brief Method Read8, addr 0x3c2e564, size 0x38, virtual false, abstract: false, final false
  static inline uint8_t Read8(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> i);

  /// @brief Method ReadAllBytesFromStream, addr 0x3c2e59c, size 0x244, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadAllBytesFromStream(::System::IO::Stream* input);

  /// @brief Method ReadString, addr 0x3c2def8, size 0x58, virtual false, abstract: false, final false
  static inline ::StringW ReadString(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> i, int32_t length);

  /// @brief Method ReadVarInt, addr 0x3c2e464, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ParseMetaEvent, addr 0x3c2e374, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseTrack, addr 0x3c2e034, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c2dbe0, size 0x318, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x3c2dbbc, size 0x24, virtual false, abstract: false, final false
