...
public:
// Declarations
/// @brief Method Read16, addr 0x5946f8c, size 0x54, virtual false, abstract: false, final false
static inline int32_t Read16(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  i) ;

/// @brief Method Read32, addr 0x5946efc, size 0x90, virtual false, abstract: false, final false
static inline int32_t Read32(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  i) ;

/// @brief Method Read8, addr 0x59474f0, size 0x38, virtual false, abstract: false, final false
static inline uint8_t Read8(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  i) ;

/// @brief Method ReadAllBytesFromStream, addr 0x5947528, size 0x1fc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAllBytesFromStream(::System::IO::Stream*  input) ;

/// @brief Method ReadString, addr 0x5946ea4, size 0x58, virtual false, abstract: false, final false
static inline ::StringW ReadString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  i, int32_t  length) ;

/// @brief Method ReadVarInt, addr 0x59473ec, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ParseMetaEvent, addr 0x59472fc, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method ParseTrack, addr 0x5946fe0, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5946b50, size 0x354, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x5946b2c, size 0x24, virtual false, abstract: false, final false
