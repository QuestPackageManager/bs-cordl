...
/// @brief Method get_Channel, addr 0x58d3df0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Channel() ;

/// @brief Method get_MetaEventType, addr 0x58d3de8, size 0x8, virtual false, abstract: false, final false
inline ::MidiParser::MetaEventType get_MetaEventType() ;

/// @brief Method get_Note, addr 0x58d3df8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Note() ;

/// @brief Method get_Value, addr 0x58d3e08, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Value() ;

/// @brief Method get_Velocity, addr 0x58d3e00, size 0x8, virtual false, abstract: false, final false
