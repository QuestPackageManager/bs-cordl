...
/// @brief Method get_Channel, addr 0x594772c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Channel() ;

/// @brief Method get_MetaEventType, addr 0x5947724, size 0x8, virtual false, abstract: false, final false
inline ::MidiParser::MetaEventType get_MetaEventType() ;

/// @brief Method get_Note, addr 0x5947734, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Note() ;

/// @brief Method get_Value, addr 0x5947744, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Value() ;

/// @brief Method get_Velocity, addr 0x594773c, size 0x8, virtual false, abstract: false, final false
