...
public:
  // Declarations
  /// @brief Method ControllerToFfiController, addr 0x3f56534, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::Ffi_Controller ControllerToFfiController(::Oculus::Haptics::Controller controller);

  /// @brief Method Map, addr 0x3f56cd8, size 0x28, virtual false, abstract: false, final false
