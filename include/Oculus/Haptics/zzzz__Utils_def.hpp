...
public:
  // Declarations
  /// @brief Method ControllerToFfiController, addr 0x3f5ab04, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::Ffi_Controller ControllerToFfiController(::Oculus::Haptics::Controller controller);

  /// @brief Method Map, addr 0x3f5b2a8, size 0x28, virtual false, abstract: false, final false
