...
public:
  ...
  /// @brief Method CreateHapticPlayer, addr 0x5db0230, size 0x20, virtual false, abstract: false, final false
  inline int32_t CreateHapticPlayer();

  /// @brief Method Dispose, addr 0x5db29f0, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5db2a60, size 0xd8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureInitialized, addr 0x5db1658, size 0x258, virtual false, abstract: false, final false
  static inline bool EnsureInitialized();

  /// @brief Method Finalize, addr 0x5db2b9c, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetAmplitudeHapticPlayer, addr 0x5db0c1c, size 0xa4, virtual false, abstract: false, final false
  inline float_t GetAmplitudeHapticPlayer(int32_t playerId);

  /// @brief Method GetClipDuration, addr 0x5db0b64, size 0xa0, virtual false, abstract: false, final false
  inline float_t GetClipDuration(int32_t clipId);

  /// @brief Method GetFrequencyShiftHapticPlayer, addr 0x5db0e34, size 0xa0, virtual false, abstract: false, final false
  inline float_t GetFrequencyShiftHapticPlayer(int32_t playerId);

  /// @brief Method GetPriorityHapticPlayer, addr 0x5db1048, size 0xb8, virtual false, abstract: false, final false
  inline uint32_t GetPriorityHapticPlayer(int32_t playerId);

  /// @brief Method IsHapticPlayerLooping, addr 0x5db09f4, size 0xa0, virtual false, abstract: false, final false
  inline bool IsHapticPlayerLooping(int32_t playerId);

  /// @brief Method IsInitialized, addr 0x5db18b8, size 0x98, virtual false, abstract: false, final false
  static inline bool IsInitialized();

  /// @brief Method IsPcmHapticsExtensionEnabled, addr 0x5db18b0, size 0x8, virtual false, abstract: false, final false
  static inline bool IsPcmHapticsExtensionEnabled();

  /// @brief Method IsSupportedPlatform, addr 0x5db164c, size 0x8, virtual false, abstract: false, final false
  static inline bool IsSupportedPlatform();

  /// @brief Method LoadClip, addr 0x5db1274, size 0xb8, virtual false, abstract: false, final false
  inline int32_t LoadClip(::StringW clipJson);

  /// @brief Method LoopHapticPlayer, addr 0x5db0ab4, size 0x98, virtual false, abstract: false, final false
  inline void LoopHapticPlayer(int32_t playerId, bool enabled);

  /// @brief Method MapPriority, addr 0x5db25a0, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method PlayHapticPlayer, addr 0x5db0400, size 0x104, virtual false, abstract: false, final false
  inline void PlayHapticPlayer(int32_t playerId, ::Oculus::Haptics::Controller controller);

  /// @brief Method ReleaseClip, addr 0x5db13f4, size 0x1c, virtual false, abstract: false, final false
  inline bool ReleaseClip(int32_t clipId);

  /// @brief Method ReleaseHapticPlayer, addr 0x5db153c, size 0x1c, virtual false, abstract: false, final false
  inline bool ReleaseHapticPlayer(int32_t playerId);

  /// @brief Method ResumeHapticPlayer, addr 0x5db0628, size 0xf4, virtual false, abstract: false, final false
  inline void ResumeHapticPlayer(int32_t playerId);

  /// @brief Method SeekPlaybackPositionHapticPlayer, addr 0x5db0840, size 0x19c, virtual false, abstract: false, final false
  inline void SeekPlaybackPositionHapticPlayer(int32_t playerId, float_t time);

  /// @brief Method SetAmplitudeHapticPlayer, addr 0x5db0cd8, size 0x144, virtual false, abstract: false, final false
  inline void SetAmplitudeHapticPlayer(int32_t playerId, float_t amplitude);

  /// @brief Method SetFrequencyShiftHapticPlayer, addr 0x5db0eec, size 0x144, virtual false, abstract: false, final false
  inline void SetFrequencyShiftHapticPlayer(int32_t playerId, float_t amount);

  /// @brief Method SetHapticPlayerClip, addr 0x5db132c, size 0xc8, virtual false, abstract: false, final false
  inline void SetHapticPlayerClip(int32_t playerId, int32_t clipId);

  /// @brief Method SetPriorityHapticPlayer, addr 0x5db111c, size 0x158, virtual false, abstract: false, final false
  inline void SetPriorityHapticPlayer(int32_t playerId, uint32_t value);

  /// @brief Method StopHapticPlayer, addr 0x5db0734, size 0xf4, virtual false, abstract: false, final false
  inline void StopHapticPlayer(int32_t playerId);

  /// @brief Method .ctor, addr 0x5db1654, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
