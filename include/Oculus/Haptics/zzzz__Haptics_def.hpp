...
public:
  ...
  /// @brief Method CreateHapticPlayer, addr 0x5c01d74, size 0x20, virtual false, abstract: false, final false
  inline int32_t CreateHapticPlayer();

  /// @brief Method Dispose, addr 0x5c04534, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x5c045a4, size 0xd8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EnsureInitialized, addr 0x5c0319c, size 0x258, virtual false, abstract: false, final false
  static inline bool EnsureInitialized();

  /// @brief Method Finalize, addr 0x5c046e0, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GetAmplitudeHapticPlayer, addr 0x5c02760, size 0xa4, virtual false, abstract: false, final false
  inline float_t GetAmplitudeHapticPlayer(int32_t playerId);

  /// @brief Method GetClipDuration, addr 0x5c026a8, size 0xa0, virtual false, abstract: false, final false
  inline float_t GetClipDuration(int32_t clipId);

  /// @brief Method GetFrequencyShiftHapticPlayer, addr 0x5c02978, size 0xa0, virtual false, abstract: false, final false
  inline float_t GetFrequencyShiftHapticPlayer(int32_t playerId);

  /// @brief Method GetPriorityHapticPlayer, addr 0x5c02b8c, size 0xb8, virtual false, abstract: false, final false
  inline uint32_t GetPriorityHapticPlayer(int32_t playerId);

  /// @brief Method IsHapticPlayerLooping, addr 0x5c02538, size 0xa0, virtual false, abstract: false, final false
  inline bool IsHapticPlayerLooping(int32_t playerId);

  /// @brief Method IsInitialized, addr 0x5c033fc, size 0x98, virtual false, abstract: false, final false
  static inline bool IsInitialized();

  /// @brief Method IsPcmHapticsExtensionEnabled, addr 0x5c033f4, size 0x8, virtual false, abstract: false, final false
  static inline bool IsPcmHapticsExtensionEnabled();

  /// @brief Method IsSupportedPlatform, addr 0x5c03190, size 0x8, virtual false, abstract: false, final false
  static inline bool IsSupportedPlatform();

  /// @brief Method LoadClip, addr 0x5c02db8, size 0xb8, virtual false, abstract: false, final false
  inline int32_t LoadClip(::StringW clipJson);

  /// @brief Method LoopHapticPlayer, addr 0x5c025f8, size 0x98, virtual false, abstract: false, final false
  inline void LoopHapticPlayer(int32_t playerId, bool enabled);

  /// @brief Method MapPriority, addr 0x5c040e4, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method PauseHapticPlayer, addr 0x5c02060, size 0xf4, virtual false, abstract: false, final false
  inline void PauseHapticPlayer(int32_t playerId);

  /// @brief Method PlayCallback, addr 0x5c030ec, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PlayHapticPlayer, addr 0x5c01f44, size 0x104, virtual false, abstract: false, final false
  inline void PlayHapticPlayer(int32_t playerId, ::Oculus::Haptics::Controller controller);

  /// @brief Method ReleaseClip, addr 0x5c02f38, size 0x1c, virtual false, abstract: false, final false
  inline bool ReleaseClip(int32_t clipId);

  /// @brief Method ReleaseHapticPlayer, addr 0x5c03080, size 0x1c, virtual false, abstract: false, final false
  inline bool ReleaseHapticPlayer(int32_t playerId);

  /// @brief Method ResumeHapticPlayer, addr 0x5c0216c, size 0xf4, virtual false, abstract: false, final false
  inline void ResumeHapticPlayer(int32_t playerId);

  /// @brief Method SeekPlaybackPositionHapticPlayer, addr 0x5c02384, size 0x19c, virtual false, abstract: false, final false
  inline void SeekPlaybackPositionHapticPlayer(int32_t playerId, float_t time);

  /// @brief Method SetAmplitudeHapticPlayer, addr 0x5c0281c, size 0x144, virtual false, abstract: false, final false
  inline void SetAmplitudeHapticPlayer(int32_t playerId, float_t amplitude);

  /// @brief Method SetFrequencyShiftHapticPlayer, addr 0x5c02a30, size 0x144, virtual false, abstract: false, final false
  inline void SetFrequencyShiftHapticPlayer(int32_t playerId, float_t amount);

  /// @brief Method SetHapticPlayerClip, addr 0x5c02e70, size 0xc8, virtual false, abstract: false, final false
  inline void SetHapticPlayerClip(int32_t playerId, int32_t clipId);

  /// @brief Method SetPriorityHapticPlayer, addr 0x5c02c60, size 0x158, virtual false, abstract: false, final false
  inline void SetPriorityHapticPlayer(int32_t playerId, uint32_t value);

  /// @brief Method StopHapticPlayer, addr 0x5c02278, size 0xf4, virtual false, abstract: false, final false
  inline void StopHapticPlayer(int32_t playerId);

  /// @brief Method .ctor, addr 0x5c03198, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Instance, addr 0x5c01e80, size 0xa8, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::Haptics* get_Instance();

  /// @brief Method get_IsPCMHaptics, addr 0x5c030f0, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_IsPCMHaptics, addr 0x5c0313c, size 0x54, virtual false, abstract: false, final false
