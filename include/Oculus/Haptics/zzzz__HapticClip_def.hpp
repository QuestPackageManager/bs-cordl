...
// Write type traits
MARK_REF_T(::Oculus::Haptics::HapticClip*);
DEFINE_IL2CPP_CLASS(::Oculus::Haptics::HapticClip*, "Oculus.Haptics", "HapticClip");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5db01d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HapticClip", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HapticClip(HapticClip&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HapticClip", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HapticClip(HapticClipconst&) = delete;
...
static_assert(sizeof(::Oculus::Haptics::HapticClip) == 0x20, "Size mismatch!");
