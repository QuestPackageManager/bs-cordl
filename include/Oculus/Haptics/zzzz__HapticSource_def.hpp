...
/// @brief Method Awake, addr 0x5c04c3c, size 0x70, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Oculus::Haptics::HapticSource* New_ctor() ;

/// @brief Method OnAfterDeserialize, addr 0x5c04e58, size 0x10, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x5c04e54, size 0x4, virtual true, abstract: false, final true
inline void OnBeforeSerialize() ;

/// @brief Method OnDestroy, addr 0x5c04e68, size 0x14, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x5c04d3c, size 0x14, virtual false, abstract: false, final false
inline void Pause() ;

/// @brief Method Play, addr 0x5c04d04, size 0x1c, virtual false, abstract: false, final false
inline void Play() ;

/// @brief Method Play, addr 0x5c04d20, size 0x1c, virtual false, abstract: false, final false
inline void Play(::Oculus::Haptics::Controller  controller) ;

/// @brief Method Resume, addr 0x5c04d50, size 0x14, virtual false, abstract: false, final false
inline void Resume() ;

/// @brief Method Seek, addr 0x5c04d78, size 0x14, virtual false, abstract: false, final false
inline void Seek(float_t  time) ;

/// @brief Method Stop, addr 0x5c04d64, size 0x14, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method SyncSerializedFieldsToPlayer, addr 0x5c04cac, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c04e7c, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_amplitude, addr 0x5c04de8, size 0x8, virtual false, abstract: false, final false
inline float_t get_amplitude() ;

/// @brief Method get_clipDuration, addr 0x5c04da4, size 0x14, virtual false, abstract: false, final false
inline float_t get_clipDuration() ;

/// @brief Method get_frequencyShift, addr 0x5c04e0c, size 0x8, virtual false, abstract: false, final false
inline float_t get_frequencyShift() ;

/// @brief Method get_loop, addr 0x5c04dc0, size 0x8, virtual false, abstract: false, final false
inline bool get_loop() ;

/// @brief Method get_priority, addr 0x5c04e30, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_priority() ;

/// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

/// @brief Method set_amplitude, addr 0x5c04df0, size 0x1c, virtual false, abstract: false, final false
inline void set_amplitude(float_t  value) ;

/// @brief Method set_clip, addr 0x5c04d8c, size 0x18, virtual false, abstract: false, final false
inline void set_clip(::Oculus::Haptics::HapticClip*  value) ;

/// @brief Method set_controller, addr 0x5c04db8, size 0x8, virtual false, abstract: false, final false
inline void set_controller(::Oculus::Haptics::Controller  value) ;

/// @brief Method set_frequencyShift, addr 0x5c04e14, size 0x1c, virtual false, abstract: false, final false
inline void set_frequencyShift(float_t  value) ;

/// @brief Method set_loop, addr 0x5c04dc8, size 0x20, virtual false, abstract: false, final false
inline void set_loop(bool  value) ;

/// @brief Method set_priority, addr 0x5c04e38, size 0x1c, virtual false, abstract: false, final false
