...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x281de6c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x281defc, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x281de58, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x281dd94, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Failed, addr 0x281cd28, size 0x8, virtual false, abstract: false, final false
  static inline bool Failed(::Oculus::Haptics::__Ffi__Result result);

  static inline ::Oculus::Haptics::Ffi* New_ctor();

  /// @brief Method Succeeded, addr 0x281cb44, size 0xc, virtual false, abstract: false, final false
  static inline bool Succeeded(::Oculus::Haptics::__Ffi__Result result);

  /// @brief Method .ctor, addr 0x281dd8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method clip_duration, addr 0x281d084, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result clip_duration(int32_t clipId, ByRef<float_t> clip_duration);

  /// @brief Method create_player, addr 0x281cdf8, size 0x7c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result create_player(ByRef<int32_t> player_id);

  /// @brief Method error_message, addr 0x281cb50, size 0x148, virtual false, abstract: false, final false
  static inline ::StringW error_message();

  /// @brief Method get_null_backend_statistics, addr 0x281dd18, size 0x74, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__NullBackendStatistics get_null_backend_statistics();

  /// @brief Method haptics_sdk_error_message, addr 0x281db30, size 0x68, virtual false, abstract: false, final false
  static inline void* haptics_sdk_error_message();

  /// @brief Method haptics_sdk_error_message_length, addr 0x281db98, size 0x68, virtual false, abstract: false, final false
  static inline int32_t haptics_sdk_error_message_length();

  /// @brief Method initialize_with_null_backend, addr 0x281dab0, size 0x80, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result initialize_with_null_backend(::Oculus::Haptics::__Ffi__LogCallback* logCallback);

  /// @brief Method initialize_with_ovr_plugin, addr 0x281ca24, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method initialize_with_ovr_plugin_bytes, addr 0x281d9e8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method initialized, addr 0x281cc98, size 0x90, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result initialized(ByRef<bool> initialized);

  /// @brief Method load_clip, addr 0x281cd30, size 0x4c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result load_clip(::StringW data, ByRef<int32_t> clip_id_out);

  /// @brief Method load_clip_bytes, addr 0x281dc7c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method player_amplitude, addr 0x281d2b0, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_amplitude(int32_t playerId, ByRef<float_t> amplitude);

  /// @brief Method player_frequency_shift, addr 0x281d3c0, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_frequency_shift(int32_t playerId, ByRef<float_t> frequency_shift);

  /// @brief Method player_looping_enabled, addr 0x281d18c, size 0x98, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_looping_enabled(int32_t playerId, ByRef<bool> looping_enabled);

  /// @brief Method player_play, addr 0x281cf84, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_play(int32_t playerId, ::Oculus::Haptics::__Ffi__Controller controller);

  /// @brief Method player_priority, addr 0x281d750, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_priority(int32_t playerId, ByRef<uint32_t> priority);

  /// @brief Method player_set_amplitude, addr 0x281d224, size 0x8c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_set_amplitude(int32_t playerId, float_t amplitude);

  /// @brief Method player_set_clip, addr 0x281ce74, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_set_clip(int32_t playerId, int32_t clipId);

  /// @brief Method player_set_frequency_shift, addr 0x281d334, size 0x8c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_set_frequency_shift(int32_t playerId, float_t amount);

  /// @brief Method player_set_looping_enabled, addr 0x281d108, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_set_looping_enabled(int32_t playerId, bool enabled);

  /// @brief Method player_set_priority, addr 0x281d6cc, size 0x84, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_set_priority(int32_t playerId, uint32_t priority);

  /// @brief Method player_stop, addr 0x281d008, size 0x7c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result player_stop(int32_t playerId);

  /// @brief Method release_clip, addr 0x281cd7c, size 0x7c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result release_clip(int32_t clipId);

  /// @brief Method release_player, addr 0x281d7d4, size 0x7c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result release_player(int32_t playerId);

  /// @brief Method set_suspended, addr 0x281dc00, size 0x7c, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result set_suspended(bool suspended);

  /// @brief Method uninitialize, addr 0x281d914, size 0x68, virtual false, abstract: false, final false
  static inline ::Oculus::Haptics::__Ffi__Result uninitialize();

  /// @brief Method version, addr 0x281d97c, size 0x6c, virtual false, abstract: false, final false
