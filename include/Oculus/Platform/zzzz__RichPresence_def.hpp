...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RichPresence", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RichPresence(RichPresence&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RichPresence", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RichPresence(RichPresenceconst&) = delete;
