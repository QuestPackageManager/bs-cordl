...
public:
  // Declarations
  /// @brief Method ConsumePurchase, addr 0x5c3b190, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* ConsumePurchase(::StringW sku);

  /// @brief Method GetNextProductListPage, addr 0x5c3b8a0, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextPurchaseListPage, addr 0x5c3ba90, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProductsBySKU, addr 0x5c3b2e4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetViewerPurchases, addr 0x5c3b460, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PurchaseList*>* GetViewerPurchases();

  /// @brief Method GetViewerPurchasesDurableCache, addr 0x5c3b5b8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PurchaseList*>* GetViewerPurchasesDurableCache();

  /// @brief Method LaunchCheckoutFlow, addr 0x5c3b710, size 0x190, virtual false, abstract: false, final false
