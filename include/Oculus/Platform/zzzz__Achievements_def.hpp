...
public:
  // Declarations
  /// @brief Method AddCount, addr 0x284e35c, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddCount(::StringW name, uint64_t count);

  /// @brief Method AddFields, addr 0x284e4cc, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddFields(::StringW name, ::StringW fields);

  /// @brief Method GetAllDefinitions, addr 0x284e63c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementDefinitionList*>* GetAllDefinitions();

  /// @brief Method GetAllProgress, addr 0x284e794, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementProgressList*>* GetAllProgress();

  /// @brief Method GetDefinitionsByName, addr 0x284e8ec, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAchievementDefinitionListPage, addr 0x284ed34, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextAchievementProgressListPage, addr 0x284ef10, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProgressByName, addr 0x284ea60, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method Unlock, addr 0x284ebd4, size 0x160, virtual false, abstract: false, final false
