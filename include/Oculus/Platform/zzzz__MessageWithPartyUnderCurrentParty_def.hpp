...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4602 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13466))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13313)) CS Name: ::Oculus.Platform::MessageWithPartyUnderCurrentParty*
...
public:
  ...
  /// @brief Method .ctor addr 0x26ef558 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetParty addr 0x26f3170 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  /// @brief Method GetDataFromMessage addr 0x26f31ac size 0x9c virtual true final false
