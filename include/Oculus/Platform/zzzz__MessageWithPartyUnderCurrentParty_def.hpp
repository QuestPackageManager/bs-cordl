...
// 4581 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13223)) CS Name: ::Oculus.Platform::MessageWithPartyUnderCurrentParty*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718eec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetParty, addr 0x271cf5c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  /// @brief Method GetDataFromMessage, addr 0x271cf98, size 0x9c, virtual true, abstract: false, final false
