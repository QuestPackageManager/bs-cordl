...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13442)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4592 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13243)) CS Name: ::Oculus.Platform::MessageWithUserAndRoomList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2719574, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserAndRoomList, addr 0x271e04c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserAndRoomList* GetUserAndRoomList();

  /// @brief Method GetDataFromMessage, addr 0x271e088, size 0x9c, virtual true, abstract: false, final false
