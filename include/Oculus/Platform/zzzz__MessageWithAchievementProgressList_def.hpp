...
public:
  // Declarations
  /// @brief Method GetAchievementProgressList, addr 0x3f7c234, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementProgressList* GetAchievementProgressList();

  /// @brief Method GetDataFromMessage, addr 0x3f7c270, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7a2b4, size 0x58, virtual false, abstract: false, final false
