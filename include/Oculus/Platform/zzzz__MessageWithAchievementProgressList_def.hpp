...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13449)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4467 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13276)) CS Name: ::Oculus.Platform::MessageWithAchievementProgressList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25926ec size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAchievementProgressList addr 0x25945fc size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::AchievementProgressList* GetAchievementProgressList();

  /// @brief Method GetDataFromMessage addr 0x2594638 size 0x9c virtual true final false
