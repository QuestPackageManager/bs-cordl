...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StandalonePlatformSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StandalonePlatformSettings(StandalonePlatformSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StandalonePlatformSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StandalonePlatformSettings(StandalonePlatformSettingsconst&) = delete;
