...
public:
  ...
  /// @brief Method .ctor, addr 0x5cb01c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_OculusPlatformTestUserAccessToken, addr 0x5cb01b0, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserAccessToken();

  /// @brief Method get_OculusPlatformTestUserEmail, addr 0x5cb0180, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserEmail();

  /// @brief Method get_OculusPlatformTestUserPassword, addr 0x5cb0198, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW get_OculusPlatformTestUserPassword();

  /// @brief Method set_OculusPlatformTestUserAccessToken, addr 0x5cb01c4, size 0x4, virtual false, abstract: false, final false
  static inline void set_OculusPlatformTestUserAccessToken(::StringW value);

  /// @brief Method set_OculusPlatformTestUserEmail, addr 0x5cb0194, size 0x4, virtual false, abstract: false, final false
  static inline void set_OculusPlatformTestUserEmail(::StringW value);

  /// @brief Method set_OculusPlatformTestUserPassword, addr 0x5cb01ac, size 0x4, virtual false, abstract: false, final false
