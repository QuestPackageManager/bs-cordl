...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29cb1b8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingVideoStats, addr 0x29cb17c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cb124, size 0x58, virtual false, abstract: false, final false
