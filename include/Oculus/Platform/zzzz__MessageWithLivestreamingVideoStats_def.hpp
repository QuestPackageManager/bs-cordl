...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c9fc3c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingVideoStats, addr 0x5c9fbf8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9fb9c, size 0x5c, virtual false, abstract: false, final false
