...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13502)), TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4497 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13317)) CS Name: ::Oculus.Platform::MessageWithLivestreamingVideoStats*
...
public:
  ...
  /// @brief Method .ctor addr 0x2596a24 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLivestreamingVideoStats addr 0x2596a7c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetLivestreamingVideoStats();

  /// @brief Method GetDataFromMessage addr 0x2596ab8 size 0x9c virtual true final false
