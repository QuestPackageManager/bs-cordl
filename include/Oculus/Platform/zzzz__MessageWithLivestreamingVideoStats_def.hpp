...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13395)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4570 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13210)) CS Name: ::Oculus.Platform::MessageWithLivestreamingVideoStats*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271c2ac, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLivestreamingVideoStats, addr 0x271c304, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetLivestreamingVideoStats();

  /// @brief Method GetDataFromMessage, addr 0x271c340, size 0x9c, virtual true, abstract: false, final false
