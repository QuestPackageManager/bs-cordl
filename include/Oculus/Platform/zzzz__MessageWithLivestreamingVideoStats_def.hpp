...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4596 }), TypeDefinitionIndex(TypeDefinitionIndex(13456)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13304)) CS Name: ::Oculus.Platform::MessageWithLivestreamingVideoStats*
