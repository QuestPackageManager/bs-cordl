...
public:
  // Declarations
  /// @brief Method Register, addr 0x5deaa18, size 0x158, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PushNotification", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PushNotification(PushNotification&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PushNotification", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PushNotification(PushNotificationconst&) = delete;
