...
// Write type traits
MARK_REF_T(::Oculus::Platform::Media*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Media*, "Oculus.Platform", "Media");
...
public:
  // Declarations
  /// @brief Method ShareToFacebook, addr 0x5dea478, size 0x180, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Media", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Media(Media&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Media", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Media(Mediaconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Media) == 0x10, "Size mismatch!");
