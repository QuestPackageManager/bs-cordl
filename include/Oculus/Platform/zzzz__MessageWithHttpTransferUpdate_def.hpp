...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddd7ec, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::HttpTransferUpdate* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetHttpTransferUpdate, addr 0x5ddd7a8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd82a8, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithHttpTransferUpdate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithHttpTransferUpdate(MessageWithHttpTransferUpdate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithHttpTransferUpdate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithHttpTransferUpdate(MessageWithHttpTransferUpdateconst&) = delete;
