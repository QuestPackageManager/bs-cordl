...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f82cdc, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::HttpTransferUpdate* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetHttpTransferUpdate, addr 0x3f82ca0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7e750, size 0x58, virtual false, abstract: false, final false
