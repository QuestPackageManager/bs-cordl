...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3812), inst: 600 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(13269), inst: 4464 }), TypeDefinitionIndex(TypeDefinitionIndex(3812))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13300)) CS Name:
...
public:
  ...
  /// @brief Method .ctor addr 0x2592ed4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetDataStore addr 0x2595a54 size 0x3c virtual true final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetDataStore();

  /// @brief Method GetDataFromMessage addr 0x2595a90 size 0x5c virtual true final false
