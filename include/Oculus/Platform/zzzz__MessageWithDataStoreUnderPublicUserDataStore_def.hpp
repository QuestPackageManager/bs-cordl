...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3824)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3824), inst: 608 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(13262), inst: 4568 }), TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13287)) CS Name:
