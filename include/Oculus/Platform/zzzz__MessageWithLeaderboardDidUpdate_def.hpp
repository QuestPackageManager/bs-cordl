...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddb520, size 0x60, virtual true, abstract: false, final false
  inline bool GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardDidUpdate, addr 0x5ddb4dc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5784, size 0x5c, virtual false, abstract: false, final false
