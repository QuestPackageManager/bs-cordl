...
public:
  // Declarations
  /// @brief Method Create, addr 0x2acd1c8, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x2acd378, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x2acd4d8, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x2acd64c, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x2acd7ac, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x2acd934, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x2acdaac, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x2acdc48, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x2acced0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x2accbd8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x2acd04c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x2accd54, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x2acddf8, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x2acdf58, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x2ace0b8, size 0x1b0, virtual false, abstract: false, final false
