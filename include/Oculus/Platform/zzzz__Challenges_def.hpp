...
public:
  // Declarations
  /// @brief Method Create, addr 0x3f83f68, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x3f840d8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x3f84230, size 0x144, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x3f8439c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x3f844f4, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x3f84674, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x3f847e4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x3f84978, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x3f83c78, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x3f83988, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x3f83df0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x3f83b00, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x3f84ae8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x3f84c40, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x3f84d98, size 0x170, virtual false, abstract: false, final false
