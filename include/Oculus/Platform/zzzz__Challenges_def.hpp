...
public:
  // Declarations
  /// @brief Method Create, addr 0x5ca4848, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x5ca49c0, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x5ca4b28, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x5ca4c84, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x5ca4dec, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x5ca4f74, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x5ca50f4, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x5ca5290, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x5ca4528, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x5ca4208, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x5ca46b8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x5ca4398, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x5ca5408, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x5ca5570, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x5ca56d8, size 0x178, virtual false, abstract: false, final false
