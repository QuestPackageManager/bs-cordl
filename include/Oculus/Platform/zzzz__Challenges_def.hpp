...
public:
  // Declarations
  /// @brief Method Create, addr 0x5bcb874, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x5bcb9ec, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x5bcbb54, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x5bcbcb0, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x5bcbe18, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x5bcbfa0, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x5bcc120, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x5bcc2bc, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x5bcb554, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x5bcb234, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x5bcb6e4, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x5bcb3c4, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x5bcc434, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x5bcc59c, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x5bcc704, size 0x178, virtual false, abstract: false, final false
