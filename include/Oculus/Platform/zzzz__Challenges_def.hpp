...
public:
  // Declarations
  /// @brief Method Create, addr 0x3f83fe0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x3f84150, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x3f842a8, size 0x144, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x3f84414, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x3f8456c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x3f846ec, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x3f8485c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x3f849f0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x3f83cf0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x3f83a00, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x3f83e68, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x3f83b78, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x3f84b60, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x3f84cb8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x3f84e10, size 0x170, virtual false, abstract: false, final false
