...
public:
  // Declarations
  /// @brief Method Create, addr 0x284b338, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x284b4e8, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x284b648, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x284b7bc, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x284b91c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x284baa4, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x284bc1c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x284bdb8, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x284b040, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x284ad48, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x284b1bc, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x284aec4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x284bf68, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x284c0c8, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x284c228, size 0x1b0, virtual false, abstract: false, final false
