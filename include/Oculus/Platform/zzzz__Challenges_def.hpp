...
public:
  // Declarations
  /// @brief Method Create, addr 0x5de0810, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x5de0988, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x5de0af0, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x5de0c4c, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x5de0db4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x5de0f3c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x5de10bc, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x5de1258, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x5de04f0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x5de01d0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x5de0680, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x5de0360, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x5de13d0, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x5de1538, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x5de16a0, size 0x178, virtual false, abstract: false, final false
...
public:
  ...
  Challenges(Challengesconst&) = delete;
