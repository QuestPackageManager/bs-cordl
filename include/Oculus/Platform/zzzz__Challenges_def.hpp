...
public:
  // Declarations
  /// @brief Method Create, addr 0x2aed854, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x2aeda04, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x2aedb64, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x2aedcd8, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x2aede38, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x2aedfc0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x2aee138, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x2aee2d4, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x2aed55c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x2aed264, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x2aed6d8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x2aed3e0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x2aee484, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x2aee5e4, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x2aee744, size 0x1b0, virtual false, abstract: false, final false
