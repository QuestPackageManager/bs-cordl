...
public:
  // Declarations
  /// @brief Method GetNextEntries, addr 0x27259b4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x2725b30, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x2725cac, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x2725e28, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x2725fa4, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x2726154, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x27262b4, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x2726400, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x2726560, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x27266e8, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x2726860, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x27269fc, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x2726bac, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x2726d0c, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x2726e6c, size 0x1b0, virtual false, abstract: false, final false
