...
public:
  // Declarations
  /// @brief Method Create, addr 0x3f0debc, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x3f0e02c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x3f0e184, size 0x144, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x3f0e2f0, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x3f0e448, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x3f0e5c8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x3f0e738, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x3f0e8cc, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x3f0dbcc, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x3f0d8dc, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x3f0dd44, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x3f0da54, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x3f0ea3c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x3f0eb94, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x3f0ecec, size 0x170, virtual false, abstract: false, final false
