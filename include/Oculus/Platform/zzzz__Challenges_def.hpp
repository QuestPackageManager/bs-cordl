...
public:
  // Declarations
  /// @brief Method Create, addr 0x2b01268, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method DeclineInvite, addr 0x2b01418, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t challengeID);

  /// @brief Method Delete, addr 0x2b01578, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Delete(uint64_t challengeID);

  /// @brief Method Get, addr 0x2b016ec, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t challengeID);

  /// @brief Method GetEntries, addr 0x2b0184c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x2b019d4, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x2b01b4c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetList, addr 0x2b01ce8, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextChallenges, addr 0x2b00f70, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x2b00c78, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousChallenges, addr 0x2b010ec, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x2b00df4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x2b01e98, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t challengeID);

  /// @brief Method Leave, addr 0x2b01ff8, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t challengeID);

  /// @brief Method UpdateInfo, addr 0x2b02158, size 0x1b0, virtual false, abstract: false, final false
