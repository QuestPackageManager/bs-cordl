...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AbuseReportType, "Oculus.Platform", "AbuseReportType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AbuseReportType) == 0x4, "Size mismatch!");
