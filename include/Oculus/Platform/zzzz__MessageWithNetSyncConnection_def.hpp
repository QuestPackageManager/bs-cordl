...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x27e436c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncConnection, addr 0x27e4330, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27e0d58, size 0x58, virtual false, abstract: false, final false
