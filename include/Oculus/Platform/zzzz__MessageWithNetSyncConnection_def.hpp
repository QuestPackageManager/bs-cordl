...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13406)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 974 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13216)) CS Name: ::Oculus.Platform::MessageWithNetSyncConnection*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718de4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncConnection, addr 0x271c814, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetNetSyncConnection();

  /// @brief Method GetDataFromMessage, addr 0x271c850, size 0x9c, virtual true, abstract: false, final false
