...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 978 }), TypeDefinitionIndex(TypeDefinitionIndex(13262)),
// TypeDefinitionIndex(TypeDefinitionIndex(13458))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13306)) CS Name: ::Oculus.Platform::MessageWithNetSyncConnection*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ef450, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncConnection, addr 0x26f2a28, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetNetSyncConnection();

  /// @brief Method GetDataFromMessage, addr 0x26f2a64, size 0x9c, virtual true, abstract: false, final false
