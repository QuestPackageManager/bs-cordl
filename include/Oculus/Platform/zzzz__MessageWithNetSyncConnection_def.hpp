...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc6e28, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncConnection, addr 0x5bc6de4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2b80, size 0x5c, virtual false, abstract: false, final false
