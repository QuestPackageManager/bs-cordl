...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd9b9c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncConnection, addr 0x5dd9b58, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd58f4, size 0x5c, virtual false, abstract: false, final false
