...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 959 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13513))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13323)) CS Name: ::Oculus.Platform::MessageWithNetSyncConnection*
...
public:
  ...
  /// @brief Method .ctor addr 0x259355c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncConnection addr 0x2596f8c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetNetSyncConnection();

  /// @brief Method GetDataFromMessage addr 0x2596fc8 size 0x9c virtual true final false
