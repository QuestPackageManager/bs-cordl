...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afccb8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncConnection, addr 0x2afcc7c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af96a4, size 0x58, virtual false, abstract: false, final false
