...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4588 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13441))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13293)) CS Name: ::Oculus.Platform::MessageWithLaunchBlockFlowResult*
