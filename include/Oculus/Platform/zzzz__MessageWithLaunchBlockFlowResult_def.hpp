...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc6158, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchBlockFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchBlockFlowResult, addr 0x5bc6114, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc27e8, size 0x5c, virtual false, abstract: false, final false
