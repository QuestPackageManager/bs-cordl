...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::PartyUpdateAction, "Oculus.Platform", "PartyUpdateAction");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::PartyUpdateAction) == 0x4, "Size mismatch!");
