...
/// @brief Method Finalize, addr 0x5c7ad60, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::AvatarEditorOptions* New_ctor() ;

/// @brief Method SetSourceOverride, addr 0x5c7ac44, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c7ab84, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x5c7ad54, size 0xc, virtual false, abstract: false, final false
