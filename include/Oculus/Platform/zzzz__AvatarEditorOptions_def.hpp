...
public:
  ...
  /// @brief Method Finalize, addr 0x29a5a48, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AvatarEditorOptions* New_ctor();

  /// @brief Method SetSourceOverride, addr 0x29a58e8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29a581c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x29a59f0, size 0x58, virtual false, abstract: false, final false
