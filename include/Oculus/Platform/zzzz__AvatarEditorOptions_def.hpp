...
// Write type traits
MARK_REF_T(::Oculus::Platform::AvatarEditorOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AvatarEditorOptions*, "Oculus.Platform", "AvatarEditorOptions");
...
public:
  ...
  /// @brief Method Finalize, addr 0x5db2f88, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AvatarEditorOptions* New_ctor();

  /// @brief Method SetSourceOverride, addr 0x5db2e6c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5db2dac, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5db2f7c, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::AvatarEditorOptions) == 0x18, "Size mismatch!");
