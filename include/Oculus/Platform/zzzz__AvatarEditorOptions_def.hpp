...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed964, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method SetSourceOverride, addr 0x26eda30, size 0x68, virtual false, abstract: false, final false
  inline void SetSourceOverride(::StringW value);

  /// @brief Method op_Explicit, addr 0x26edb38, size 0x58, virtual false, abstract: false, final false
  static inline void* op_Explicit_void_(::Oculus::Platform::AvatarEditorOptions* options);

  /// @brief Method Finalize, addr 0x26edb90, size 0xd4, virtual true, abstract: false, final false
