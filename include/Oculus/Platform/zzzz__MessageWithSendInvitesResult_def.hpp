...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2aea1dc, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SendInvitesResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSendInvitesResult, addr 0x2aea1a0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae6058, size 0x58, virtual false, abstract: false, final false
