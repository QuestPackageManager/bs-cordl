...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4609 }), TypeDefinitionIndex(TypeDefinitionIndex(13480)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13322)) CS Name: ::Oculus.Platform::MessageWithSendInvitesResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ef818, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetSendInvitesResult, addr 0x26f3960, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SendInvitesResult* GetSendInvitesResult();

  /// @brief Method GetDataFromMessage, addr 0x26f399c, size 0x9c, virtual true, abstract: false, final false
