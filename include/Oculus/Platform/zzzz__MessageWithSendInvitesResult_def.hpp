...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f1f02c, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SendInvitesResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSendInvitesResult, addr 0x3f1eff0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f1b0d0, size 0x58, virtual false, abstract: false, final false
