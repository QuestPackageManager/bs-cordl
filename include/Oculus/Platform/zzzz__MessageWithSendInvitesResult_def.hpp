...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13480)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 4609 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13322)) CS Name: ::Oculus.Platform::MessageWithSendInvitesResult*
