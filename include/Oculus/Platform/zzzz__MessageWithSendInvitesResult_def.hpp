...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2ac9b50, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SendInvitesResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetSendInvitesResult, addr 0x2ac9b14, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ac59cc, size 0x58, virtual false, abstract: false, final false
