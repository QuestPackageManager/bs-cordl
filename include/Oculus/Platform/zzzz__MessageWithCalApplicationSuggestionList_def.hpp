...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13359)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4552 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13183)) CS Name: ::Oculus.Platform::MessageWithCalApplicationSuggestionList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271aa54, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCalApplicationSuggestionList, addr 0x271aaac, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CalApplicationSuggestionList* GetCalApplicationSuggestionList();

  /// @brief Method GetDataFromMessage, addr 0x271aae8, size 0x9c, virtual true, abstract: false, final false
