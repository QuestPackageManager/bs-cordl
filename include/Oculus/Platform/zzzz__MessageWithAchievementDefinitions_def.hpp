...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithAchievementDefinitions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithAchievementDefinitions*, "Oculus.Platform", "MessageWithAchievementDefinitions");
...
public:
  // Declarations
  /// @brief Method GetAchievementDefinitions, addr 0x5dd90bc, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementDefinitionList* GetAchievementDefinitions();

  /// @brief Method GetDataFromMessage, addr 0x5dd9100, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd6e88, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithAchievementDefinitions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithAchievementDefinitions(MessageWithAchievementDefinitions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithAchievementDefinitions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithAchievementDefinitions(MessageWithAchievementDefinitionsconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::MessageWithAchievementDefinitions) == 0x30, "Size mismatch!");
