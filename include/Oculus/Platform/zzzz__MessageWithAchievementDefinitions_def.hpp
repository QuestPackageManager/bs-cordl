...
public:
  // Declarations
  /// @brief Method GetAchievementDefinitions, addr 0x5dd6e94, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementDefinitionList* GetAchievementDefinitions();

  /// @brief Method GetDataFromMessage, addr 0x5dd6ed8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd4c60, size 0x5c, virtual false, abstract: false, final false
