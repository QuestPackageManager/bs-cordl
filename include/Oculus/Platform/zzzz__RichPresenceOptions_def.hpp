...
public:
  ...
  /// @brief Method Finalize, addr 0x29d9688, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d9624, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x29d7c80, size 0x58, virtual false, abstract: false, final false
