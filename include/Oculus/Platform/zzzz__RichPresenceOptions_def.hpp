...
public:
  ...
  /// @brief Method Finalize, addr 0x3f8bd28, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f8bcc4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x3f8a44c, size 0xc, virtual false, abstract: false, final false
