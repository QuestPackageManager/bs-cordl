...
public:
  ...
  /// @brief Method Finalize, addr 0x29d768c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29d7628, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x29d5c84, size 0x58, virtual false, abstract: false, final false
