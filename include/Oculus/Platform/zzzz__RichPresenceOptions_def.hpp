...
// Write type traits
MARK_REF_T(::Oculus::Platform::RichPresenceOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::RichPresenceOptions*, "Oculus.Platform", "RichPresenceOptions");
...
public:
  ...
  /// @brief Method Finalize, addr 0x5debe00, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5debda4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5deaf68, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RichPresenceOptions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RichPresenceOptions(RichPresenceOptions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RichPresenceOptions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RichPresenceOptions(RichPresenceOptionsconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::RichPresenceOptions) == 0x18, "Size mismatch!");
