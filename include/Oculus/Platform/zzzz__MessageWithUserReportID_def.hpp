...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4522 }), TypeDefinitionIndex(TypeDefinitionIndex(13554)),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13355)) CS Name: ::Oculus.Platform::MessageWithUserReportID*
...
public:
  ...
  /// @brief Method .ctor addr 0x2598bfc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserReportID addr 0x2598c54 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::UserReportID* GetUserReportID();

  /// @brief Method GetDataFromMessage addr 0x2598c90 size 0x9c virtual true final false
