...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13447)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4597 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13248)) CS Name: ::Oculus.Platform::MessageWithUserReportID*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271e484, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserReportID, addr 0x271e4dc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetUserReportID();

  /// @brief Method GetDataFromMessage, addr 0x271e518, size 0x9c, virtual true, abstract: false, final false
