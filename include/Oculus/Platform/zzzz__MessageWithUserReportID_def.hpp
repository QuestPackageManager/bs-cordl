...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f82b74, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserReportID, addr 0x3f82b38, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f82ae0, size 0x58, virtual false, abstract: false, final false
