...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7c384, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserReportID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserReportID, addr 0x3f7c348, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c2f0, size 0x58, virtual false, abstract: false, final false
