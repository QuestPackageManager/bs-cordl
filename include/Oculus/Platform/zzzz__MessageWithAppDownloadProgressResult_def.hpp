...
public:
  // Declarations
  /// @brief Method GetAppDownloadProgressResult, addr 0x3f7d9dc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult();

  /// @brief Method GetDataFromMessage, addr 0x3f7da18, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7b96c, size 0x58, virtual false, abstract: false, final false
