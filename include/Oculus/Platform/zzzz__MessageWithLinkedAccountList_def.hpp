...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc67d4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLinkedAccountList, addr 0x5bc6790, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2a6c, size 0x5c, virtual false, abstract: false, final false
