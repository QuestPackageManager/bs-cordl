...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7dc38, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLinkedAccountList, addr 0x3f7dbfc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7dba4, size 0x58, virtual false, abstract: false, final false
