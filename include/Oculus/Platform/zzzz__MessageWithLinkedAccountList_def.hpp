...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afc6a0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLinkedAccountList, addr 0x2afc664, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2afc60c, size 0x58, virtual false, abstract: false, final false
