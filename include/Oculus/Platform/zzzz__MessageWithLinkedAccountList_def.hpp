...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13391)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4567 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13206)) CS Name: ::Oculus.Platform::MessageWithLinkedAccountList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271be44, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLinkedAccountList, addr 0x271be9c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetLinkedAccountList();

  /// @brief Method GetDataFromMessage, addr 0x271bed8, size 0x9c, virtual true, abstract: false, final false
