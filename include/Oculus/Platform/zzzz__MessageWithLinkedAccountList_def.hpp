...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2ae8c8c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLinkedAccountList, addr 0x2ae8c50, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae8bf8, size 0x58, virtual false, abstract: false, final false
