...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2d2b4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLinkedAccountList, addr 0x5c2d270, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2954c, size 0x5c, virtual false, abstract: false, final false
