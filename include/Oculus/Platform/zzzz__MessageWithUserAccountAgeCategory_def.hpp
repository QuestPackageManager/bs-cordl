...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29cc690, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserAccountAgeCategory* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserAccountAgeCategory, addr 0x29cc654, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c82d4, size 0x58, virtual false, abstract: false, final false
