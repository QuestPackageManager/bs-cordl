...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc82f0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserAccountAgeCategory* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserAccountAgeCategory, addr 0x5bc82ac, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc319c, size 0x5c, virtual false, abstract: false, final false
