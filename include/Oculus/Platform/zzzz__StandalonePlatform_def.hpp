...
// Write type traits
MARK_REF_T(::Oculus::Platform::StandalonePlatform*);
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5dec0cc, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5dec13c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5dec0b8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dec04c, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::StandalonePlatform_UnityLogDelegate) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method AsyncInitialize, addr 0x5deb6b4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method AsyncInitializeWithAccessTokenAndOptions, addr 0x5ddeb9c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeInEditor, addr 0x5dde668, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dde664, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Oculus::Platform::StandalonePlatform) == 0x10, "Size mismatch!");
