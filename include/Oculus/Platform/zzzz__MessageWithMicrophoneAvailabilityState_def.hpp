...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13405)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4576 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13215)) CS Name: ::Oculus.Platform::MessageWithMicrophoneAvailabilityState*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718d8c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMicrophoneAvailabilityState, addr 0x271c73c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetMicrophoneAvailabilityState();

  /// @brief Method GetDataFromMessage, addr 0x271c778, size 0x9c, virtual true, abstract: false, final false
