...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f8400c, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetMicrophoneAvailabilityState, addr 0x3f83fd0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f80c18, size 0x58, virtual false, abstract: false, final false
