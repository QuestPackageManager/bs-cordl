...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4503 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13512))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13322)) CS Name: ::Oculus.Platform::MessageWithMicrophoneAvailabilityState*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593504 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMicrophoneAvailabilityState addr 0x2596eb4 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetMicrophoneAvailabilityState();

  /// @brief Method GetDataFromMessage addr 0x2596ef0 size 0x9c virtual true final false
