...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29cb290, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetDataFromMessage(void* c_message);

  /// @brief Method GetMicrophoneAvailabilityState, addr 0x29cb254, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c7cfc, size 0x58, virtual false, abstract: false, final false
