...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13457)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 4597 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13305)) CS Name: ::Oculus.Platform::MessageWithMicrophoneAvailabilityState*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ef3f8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMicrophoneAvailabilityState, addr 0x26f2950, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetMicrophoneAvailabilityState();

  /// @brief Method GetDataFromMessage, addr 0x26f298c, size 0x9c, virtual true, abstract: false, final false
