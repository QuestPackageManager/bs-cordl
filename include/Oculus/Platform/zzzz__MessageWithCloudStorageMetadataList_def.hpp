...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4484 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13474))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13297)) CS Name: ::Oculus.Platform::MessageWithCloudStorageMetadataList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592dcc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCloudStorageMetadataList addr 0x259580c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::CloudStorageMetadataList* GetCloudStorageMetadataList();

  /// @brief Method GetDataFromMessage addr 0x2595848 size 0x9c virtual true final false
