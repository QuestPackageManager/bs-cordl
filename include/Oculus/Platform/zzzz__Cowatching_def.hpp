...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Cowatching", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Cowatching(Cowatching&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Cowatching", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Cowatching(Cowatchingconst&) = delete;
