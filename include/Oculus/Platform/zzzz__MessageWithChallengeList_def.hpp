...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x3f8bd20, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x3f8bd5c, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f89698, size 0x58, virtual false, abstract: false, final false
