...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x27e2f10, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x27e2f4c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27e0780, size 0x58, virtual false, abstract: false, final false
