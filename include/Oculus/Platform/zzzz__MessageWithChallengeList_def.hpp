...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x5dd856c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x5dd85b0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5220, size 0x5c, virtual false, abstract: false, final false
