...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x5c9e7cc, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x5c9e810, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b480, size 0x5c, virtual false, abstract: false, final false
