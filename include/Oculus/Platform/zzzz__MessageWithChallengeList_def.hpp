...
public:
  // Declarations
  /// @brief Method GetChallengeList, addr 0x3f7e7d4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x3f7e810, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c14c, size 0x58, virtual false, abstract: false, final false
