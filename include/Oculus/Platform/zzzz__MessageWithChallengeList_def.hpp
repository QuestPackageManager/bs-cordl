...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13361)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4554 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13185)) CS Name: ::Oculus.Platform::MessageWithChallengeList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271849c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetChallengeList, addr 0x271ac5c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList();

  /// @brief Method GetDataFromMessage, addr 0x271ac98, size 0x9c, virtual true, abstract: false, final false
