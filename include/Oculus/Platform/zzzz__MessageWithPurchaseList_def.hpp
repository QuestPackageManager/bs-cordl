...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f84d24, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PurchaseList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPurchaseList, addr 0x3f84ce8, size 0x3c, virtual true, abstract: false, final false
