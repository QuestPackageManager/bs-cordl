...
/// @brief Method Finalize, addr 0x5cb2d3c, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::VoipOptions* New_ctor() ;

/// @brief Method SetBitrateForNewConnections, addr 0x5cb2c64, size 0x6c, virtual false, abstract: false, final false
inline void SetBitrateForNewConnections(::Oculus::Platform::VoipBitrate  value) ;

/// @brief Method SetCreateNewConnectionUseDtx, addr 0x5cb2cd0, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cb2c08, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x5ca7d60, size 0xc, virtual false, abstract: false, final false
