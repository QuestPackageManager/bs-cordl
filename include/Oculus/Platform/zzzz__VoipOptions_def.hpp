...
public:
  ...
  /// @brief Method Finalize, addr 0x2ad83c0, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::VoipOptions* New_ctor();

  /// @brief Method SetBitrateForNewConnections, addr 0x2ad82f0, size 0x68, virtual false, abstract: false, final false
  inline void SetBitrateForNewConnections(::Oculus::Platform::VoipBitrate value);

  /// @brief Method SetCreateNewConnectionUseDtx, addr 0x2ad8358, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Explicit, addr 0x2aceb54, size 0x58, virtual false, abstract: false, final false
