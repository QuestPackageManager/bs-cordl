...
public:
  ...
  /// @brief Method Finalize, addr 0x2b0c460, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::VoipOptions* New_ctor();

  /// @brief Method SetBitrateForNewConnections, addr 0x2b0c390, size 0x68, virtual false, abstract: false, final false
  inline void SetBitrateForNewConnections(::Oculus::Platform::VoipBitrate value);

  /// @brief Method SetCreateNewConnectionUseDtx, addr 0x2b0c3f8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0c32c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x2b02bf4, size 0x58, virtual false, abstract: false, final false
