...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AppAgeCategory, "Oculus.Platform", "AppAgeCategory");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AppAgeCategory) == 0x4, "Size mismatch!");
