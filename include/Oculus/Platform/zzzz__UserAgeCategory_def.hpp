...
public:
// Declarations
/// @brief Method Get, addr 0x5c3d1b4, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserAccountAgeCategory*>* Get() ;

/// @brief Method Report, addr 0x5c3d30c, size 0x154, virtual false, abstract: false, final false
