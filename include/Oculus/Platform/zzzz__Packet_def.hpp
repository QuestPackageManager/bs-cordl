...
/// @brief Method Dispose, addr 0x5c2ffb8, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x5c2ff74, size 0x44, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::Packet* New_ctor(::System::IntPtr  packetHandle) ;

/// @brief Method ReadBytes, addr 0x5c2fdd0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c2fd60, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  packetHandle) ;

/// @brief Method get_SenderID, addr 0x5c2ff10, size 0x5c, virtual false, abstract: false, final false
inline uint64_t get_SenderID() ;

/// @brief Method get_Size, addr 0x5c2ff6c, size 0x8, virtual false, abstract: false, final false
