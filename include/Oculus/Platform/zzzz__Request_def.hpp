...
public:
  ...
  /// @brief Method HandleMessage, addr 0x29d75bc, size 0x6c, virtual true, abstract: false, final false
  inline void HandleMessage(::Oculus::Platform::Message* msg);

  static inline ::Oculus::Platform::Request* New_ctor(uint64_t requestID);

  /// @brief Method OnComplete, addr 0x29a0fa4, size 0x6c, virtual false, abstract: false, final false
  inline ::Oculus::Platform::Request* OnComplete(::Oculus::Platform::__Message__Callback* callback);

  /// @brief Method RunCallbacks, addr 0x29a6564, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cdd78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(uint64_t requestID);

  /// @brief Method get_RequestID, addr 0x29d75ac, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_RequestID();

  /// @brief Method set_RequestID, addr 0x29d75b4, size 0x8, virtual false, abstract: false, final false
