...
// 1160 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13335)) CS Name: ::Oculus.Platform::MessageWithPurchase*
...
public:
  ...
  /// @brief Method .ctor addr 0x25937c4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPurchase addr 0x2597b64 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::Purchase* GetPurchase();

  /// @brief Method GetDataFromMessage addr 0x2597ba0 size 0x9c virtual true final false
