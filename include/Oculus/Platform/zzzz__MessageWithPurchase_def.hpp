...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dda7e8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Purchase* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPurchase, addr 0x5dda7a4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5b78, size 0x5c, virtual false, abstract: false, final false
