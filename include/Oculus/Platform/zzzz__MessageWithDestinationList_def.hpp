...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13478)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4486 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13301)) CS Name: ::Oculus.Platform::MessageWithDestinationList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592f2c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetDestinationList addr 0x2595aec size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::DestinationList* GetDestinationList();

  /// @brief Method GetDataFromMessage addr 0x2595b28 size 0x9c virtual true final false
