...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7d170, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetDestinationList, addr 0x3f7d134, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7a93c, size 0x58, virtual false, abstract: false, final false
