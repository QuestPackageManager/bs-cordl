...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f08a34, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetDestinationList, addr 0x3f089f8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f06200, size 0x58, virtual false, abstract: false, final false
