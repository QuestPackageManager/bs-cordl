...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afbb78, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetDestinationList, addr 0x2afbb3c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af922c, size 0x58, virtual false, abstract: false, final false
