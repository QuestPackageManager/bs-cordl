...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2c77c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetDestinationList, addr 0x5c2c738, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c29158, size 0x5c, virtual false, abstract: false, final false
