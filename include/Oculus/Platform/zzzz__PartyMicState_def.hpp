...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::PartyMicState, "Oculus.Platform", "PartyMicState");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::PartyMicState) == 0x4, "Size mismatch!");
