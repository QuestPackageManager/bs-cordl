...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dda548, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyUpdateNotification, addr 0x5dda504, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5a64, size 0x5c, virtual false, abstract: false, final false
