...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc77d4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyUpdateNotification, addr 0x5bc7790, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2cf0, size 0x5c, virtual false, abstract: false, final false
