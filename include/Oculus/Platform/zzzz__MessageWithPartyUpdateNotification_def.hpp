...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x5c2e7c0, size 0x9c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPartyUpdateNotification, addr 0x5c2e77c, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c29cdc, size 0x5c, virtual false, abstract: false, final false
