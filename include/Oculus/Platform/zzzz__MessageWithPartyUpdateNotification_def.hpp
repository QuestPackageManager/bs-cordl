...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 962 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13524))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13332)) CS Name: ::Oculus.Platform::MessageWithPartyUpdateNotification*
...
public:
  ...
  /// @brief Method .ctor addr 0x25936bc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPartyUpdateNotification addr 0x25978dc size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::PartyUpdateNotification* GetPartyUpdateNotification();

  /// @brief Method GetDataFromMessage addr 0x2597918 size 0x9c virtual true final false
