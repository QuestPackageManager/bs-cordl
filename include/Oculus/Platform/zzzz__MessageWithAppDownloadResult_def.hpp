...
public:
  // Declarations
  /// @brief Method GetAppDownloadResult, addr 0x29c74f0, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AppDownloadResult* GetAppDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x29c752c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c5360, size 0x58, virtual false, abstract: false, final false
