...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(SendPolicy)
// Forward declare root types
namespace Oculus::Platform {
struct SendPolicy;
}
// Write type traits
MARK_VAL_T(::Oculus::Platform::SendPolicy);
...
struct CORDL_TYPE SendPolicy {
public:
  // Declarations
  using __CORDL_BACKING_ENUM_TYPE = int32_t;

  /// @brief Nested struct __SendPolicy_Unwrapped
  enum struct __SendPolicy_Unwrapped : int32_t {
  ...
  constexpr operator __SendPolicy_Unwrapped() const noexcept {
    return static_cast<__SendPolicy_Unwrapped>(this->value__);
  }
...
static_assert(::cordl_internals::size_check_v<::Oculus::Platform::SendPolicy, 0x4>, "Size mismatch!");

static_assert(offsetof(::Oculus::Platform::SendPolicy, value__) == 0x0, "Offset mismatch!");
