...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13356)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4550 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13181)) CS Name: ::Oculus.Platform::MessageWithCalApplicationFinalized*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718394, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCalApplicationFinalized, addr 0x271a8a4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CalApplicationFinalized* GetCalApplicationFinalized();

  /// @brief Method GetDataFromMessage, addr 0x271a8e0, size 0x9c, virtual true, abstract: false, final false
