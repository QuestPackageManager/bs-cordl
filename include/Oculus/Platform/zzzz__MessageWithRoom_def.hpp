...
// 980 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13231)) CS Name: ::Oculus.Platform::MessageWithRoom*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2719154, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoom, addr 0x271d674, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Room* GetRoom();

  /// @brief Method GetDataFromMessage, addr 0x271d6b0, size 0x9c, virtual true, abstract: false, final false
