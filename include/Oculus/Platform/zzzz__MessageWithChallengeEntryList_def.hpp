...
public:
  // Declarations
  /// @brief Method GetChallengeEntryList, addr 0x5c2c3b8, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeEntryList* GetChallengeEntryList();

  /// @brief Method GetDataFromMessage, addr 0x5c2c3fc, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c28fe8, size 0x5c, virtual false, abstract: false, final false
