...
public:
  // Declarations
  /// @brief Method GetChallengeEntryList, addr 0x3f7e91c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ChallengeEntryList* GetChallengeEntryList();

  /// @brief Method GetDataFromMessage, addr 0x3f7e958, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c21c, size 0x58, virtual false, abstract: false, final false
