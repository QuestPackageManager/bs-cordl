...
public:
  // Declarations
  /// @brief Method GetCowatchViewerList, addr 0x5dd872c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CowatchViewerList* GetCowatchViewerList();

  /// @brief Method GetDataFromMessage, addr 0x5dd8770, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd52d8, size 0x5c, virtual false, abstract: false, final false
