...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::LogEventParameter, "Oculus.Platform", "LogEventParameter");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::LogEventParameter) == 0x4, "Size mismatch!");
