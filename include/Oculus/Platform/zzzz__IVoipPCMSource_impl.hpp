...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Oculus::Platform::IVoipPCMSource::*)(::ArrayW<float_t,::Array<float_t>*>, int32_t)>(&::Oculus::Platform::IVoipPCMSource::GetPCM)> {
