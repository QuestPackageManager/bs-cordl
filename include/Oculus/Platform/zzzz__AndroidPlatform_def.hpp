...
public:
  // Declarations
  /// @brief Method AsyncInitialize, addr 0x5b9f7a0, size 0xf0, virtual false, abstract: false, final false
  inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method Initialize, addr 0x5b9f658, size 0xac, virtual false, abstract: false, final false
  inline bool Initialize(::StringW appId);

  static inline ::Oculus::Platform::AndroidPlatform* New_ctor();

  /// @brief Method .ctor, addr 0x5b9f928, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
