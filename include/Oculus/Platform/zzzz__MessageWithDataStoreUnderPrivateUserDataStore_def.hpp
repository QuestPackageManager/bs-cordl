...
// }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst: 4537 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13192)) CS Name:
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718704, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetDataStore, addr 0x271b244, size 0x3c, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* GetDataStore();

  /// @brief Method GetDataFromMessage, addr 0x271b280, size 0x5c, virtual true, abstract: false, final false
