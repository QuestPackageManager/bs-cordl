...
public:
  ...
  /// @brief Method .ctor, addr 0x26ed1e4, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method SetDeeplinkMessage, addr 0x26ed2b0, size 0x68, virtual false, abstract: false, final false
  inline void SetDeeplinkMessage(::StringW value);

  /// @brief Method SetDestinationApiName, addr 0x26ed3b8, size 0x68, virtual false, abstract: false, final false
  inline void SetDestinationApiName(::StringW value);

  /// @brief Method SetLobbySessionId, addr 0x26ed4c0, size 0x68, virtual false, abstract: false, final false
  inline void SetLobbySessionId(::StringW value);

  /// @brief Method SetMatchSessionId, addr 0x26ed5c8, size 0x68, virtual false, abstract: false, final false
  inline void SetMatchSessionId(::StringW value);

  /// @brief Method SetRoomId, addr 0x26ed6d0, size 0x68, virtual false, abstract: false, final false
  inline void SetRoomId(uint64_t value);

  /// @brief Method op_Explicit, addr 0x26ed7bc, size 0x58, virtual false, abstract: false, final false
  static inline void* op_Explicit_void_(::Oculus::Platform::ApplicationOptions* options);

  /// @brief Method Finalize, addr 0x26ed814, size 0xd4, virtual true, abstract: false, final false
