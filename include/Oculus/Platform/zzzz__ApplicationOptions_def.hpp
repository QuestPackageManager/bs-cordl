...
/// @brief Method Finalize, addr 0x5c7aa74, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::ApplicationOptions* New_ctor() ;

/// @brief Method SetDeeplinkMessage, addr 0x5c7a538, size 0x6c, virtual false, abstract: false, final false
inline void SetDeeplinkMessage(::StringW  value) ;

/// @brief Method SetDestinationApiName, addr 0x5c7a648, size 0x6c, virtual false, abstract: false, final false
inline void SetDestinationApiName(::StringW  value) ;

/// @brief Method SetLobbySessionId, addr 0x5c7a758, size 0x6c, virtual false, abstract: false, final false
inline void SetLobbySessionId(::StringW  value) ;

/// @brief Method SetMatchSessionId, addr 0x5c7a868, size 0x6c, virtual false, abstract: false, final false
inline void SetMatchSessionId(::StringW  value) ;

/// @brief Method SetRoomId, addr 0x5c7a978, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c7a478, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x5c7aa68, size 0xc, virtual false, abstract: false, final false
