...
public:
  ...
  /// @brief Method .ctor addr 0x26ce794 size 0x64 virtual false final false
  inline void _ctor();

  /// @brief Method SetDeeplinkMessage addr 0x26ce860 size 0x68 virtual false final false
  inline void SetDeeplinkMessage(::StringW value);

  /// @brief Method SetDestinationApiName addr 0x26ce968 size 0x68 virtual false final false
  inline void SetDestinationApiName(::StringW value);

  /// @brief Method SetLobbySessionId addr 0x26cea70 size 0x68 virtual false final false
  inline void SetLobbySessionId(::StringW value);

  /// @brief Method SetMatchSessionId addr 0x26ceb78 size 0x68 virtual false final false
  inline void SetMatchSessionId(::StringW value);

  /// @brief Method SetRoomId addr 0x26cec80 size 0x68 virtual false final false
  inline void SetRoomId(uint64_t value);

  /// @brief Method op_Explicit addr 0x26ced6c size 0x58 virtual false final false
  static inline void* op_Explicit_void_(::Oculus::Platform::ApplicationOptions* options);

  /// @brief Method Finalize addr 0x26cedc4 size 0xd4 virtual true final false
