...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13357)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4551 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13182)) CS Name: ::Oculus.Platform::MessageWithCalApplicationProposed*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27183ec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCalApplicationProposed, addr 0x271a97c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CalApplicationProposed* GetCalApplicationProposed();

  /// @brief Method GetDataFromMessage, addr 0x271a9b8, size 0x9c, virtual true, abstract: false, final false
