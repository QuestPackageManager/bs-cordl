...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd97c0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x5dd977c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd9720, size 0x5c, virtual false, abstract: false, final false
