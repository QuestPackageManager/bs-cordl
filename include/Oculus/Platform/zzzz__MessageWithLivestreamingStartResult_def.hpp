...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13393)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4569 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13208)) CS Name: ::Oculus.Platform::MessageWithLivestreamingStartResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271c0a4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x271c0fc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetLivestreamingStartResult();

  /// @brief Method GetDataFromMessage, addr 0x271c138, size 0x9c, virtual true, abstract: false, final false
