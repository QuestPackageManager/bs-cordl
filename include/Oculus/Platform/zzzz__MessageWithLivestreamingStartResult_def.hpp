...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4595 }), TypeDefinitionIndex(TypeDefinitionIndex(13262)),
// TypeDefinitionIndex(TypeDefinitionIndex(13454))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13302)) CS Name: ::Oculus.Platform::MessageWithLivestreamingStartResult*
