...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c8fb4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x29c8f78, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c8f20, size 0x58, virtual false, abstract: false, final false
