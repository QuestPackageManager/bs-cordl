...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f83d44, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x3f83d08, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f83cb0, size 0x58, virtual false, abstract: false, final false
