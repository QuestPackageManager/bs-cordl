...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f0974c, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStartResult, addr 0x3f09710, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f096b8, size 0x58, virtual false, abstract: false, final false
