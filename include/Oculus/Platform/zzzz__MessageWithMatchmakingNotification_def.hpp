...
// 980 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13252)) CS Name: ::Oculus.Platform::MessageWithMatchmakingNotification*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27197dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoom, addr 0x271e888, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Room* GetRoom();

  /// @brief Method GetDataFromMessage, addr 0x271e8c4, size 0x9c, virtual true, abstract: false, final false
