...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x27e5844, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserCapabilityList, addr 0x27e5808, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27e1388, size 0x58, virtual false, abstract: false, final false
