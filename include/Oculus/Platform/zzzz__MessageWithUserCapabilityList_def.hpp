...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddb224, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserCapabilityList, addr 0x5ddb1e0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5fc8, size 0x5c, virtual false, abstract: false, final false
