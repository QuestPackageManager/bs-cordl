...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13488)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 4612 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13329)) CS Name: ::Oculus.Platform::MessageWithUserCapabilityList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26efa80, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserCapabilityList, addr 0x26f3f00, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetUserCapabilityList();

  /// @brief Method GetDataFromMessage, addr 0x26f3f3c, size 0x9c, virtual true, abstract: false, final false
