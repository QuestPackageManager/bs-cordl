...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f85504, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserCapabilityList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserCapabilityList, addr 0x3f854c8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f812a0, size 0x58, virtual false, abstract: false, final false
