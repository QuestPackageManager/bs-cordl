...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4612 }), TypeDefinitionIndex(TypeDefinitionIndex(13262)),
// TypeDefinitionIndex(TypeDefinitionIndex(13488))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13329)) CS Name: ::Oculus.Platform::MessageWithUserCapabilityList*
