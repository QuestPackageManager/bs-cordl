...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca0290, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x5ca024c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ca01f0, size 0x5c, virtual false, abstract: false, final false
