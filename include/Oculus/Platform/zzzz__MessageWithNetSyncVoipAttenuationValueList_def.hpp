...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x5c2e2a8, size 0x9c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x5c2e264, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c2e208, size 0x5c, virtual false, abstract: false, final false
