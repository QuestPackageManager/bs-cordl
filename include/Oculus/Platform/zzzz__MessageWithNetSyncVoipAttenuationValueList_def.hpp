...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4600 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13464))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13310)) CS Name: ::Oculus.Platform::MessageWithNetSyncVoipAttenuationValueList*
