...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithNetSyncVoipAttenuationValueList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithNetSyncVoipAttenuationValueList*, "Oculus.Platform", "MessageWithNetSyncVoipAttenuationValueList");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddc258, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x5ddc214, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ddc1b8, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithNetSyncVoipAttenuationValueList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithNetSyncVoipAttenuationValueList(MessageWithNetSyncVoipAttenuationValueList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithNetSyncVoipAttenuationValueList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithNetSyncVoipAttenuationValueList(MessageWithNetSyncVoipAttenuationValueListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::MessageWithNetSyncVoipAttenuationValueList) == 0x30, "Size mismatch!");
