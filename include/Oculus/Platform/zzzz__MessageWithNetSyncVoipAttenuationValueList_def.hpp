...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29cb7d0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x29cb794, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29cb73c, size 0x58, virtual false, abstract: false, final false
