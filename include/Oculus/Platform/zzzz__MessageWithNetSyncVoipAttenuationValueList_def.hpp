...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13519)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4506 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13327)) CS Name: ::Oculus.Platform::MessageWithNetSyncVoipAttenuationValueList*
...
public:
  ...
  /// @brief Method .ctor addr 0x259739c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList addr 0x25973f4 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetNetSyncVoipAttenuationValueList();

  /// @brief Method GetDataFromMessage addr 0x2597430 size 0x9c virtual true final false
