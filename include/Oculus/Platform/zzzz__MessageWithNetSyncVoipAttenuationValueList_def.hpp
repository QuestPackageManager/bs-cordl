...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2ae970c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x2ae96d0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae9678, size 0x58, virtual false, abstract: false, final false
