...
public:
  // Declarations
  /// @brief Method Get, addr 0x3f7dfa0, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LeaderboardList*>* Get(::StringW leaderboardName);

  /// @brief Method GetEntries, addr 0x3f7e0f8, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x3f7e278, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x3f7e3e8, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x3f7dcb0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextLeaderboardListPage, addr 0x3f7e8b4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x3f7de28, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntry, addr 0x3f7e57c, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntryWithSupplementaryMetric, addr 0x3f7e710, size 0x1a4, virtual false, abstract: false, final false
