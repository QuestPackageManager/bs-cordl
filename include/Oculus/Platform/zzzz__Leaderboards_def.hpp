...
public:
  // Declarations
  /// @brief Method Get, addr 0x3f82e9c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LeaderboardList*>* Get(::StringW leaderboardName);

  /// @brief Method GetEntries, addr 0x3f82ff4, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesAfterRank, addr 0x3f83174, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEntriesByIds, addr 0x3f832e4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextEntries, addr 0x3f82bac, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextLeaderboardListPage, addr 0x3f837b0, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPreviousEntries, addr 0x3f82d24, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntry, addr 0x3f83478, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEntryWithSupplementaryMetric, addr 0x3f8360c, size 0x1a4, virtual false, abstract: false, final false
