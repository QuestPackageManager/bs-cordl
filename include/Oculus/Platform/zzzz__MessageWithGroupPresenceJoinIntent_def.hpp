...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13480)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 953 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13302)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceJoinIntent*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592f84 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetGroupPresenceJoinIntent addr 0x2595bc4 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetGroupPresenceJoinIntent();

  /// @brief Method GetDataFromMessage addr 0x2595c00 size 0x9c virtual true final false
