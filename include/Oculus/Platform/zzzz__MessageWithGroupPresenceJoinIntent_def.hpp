...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x5ca08c8, size 0x9c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetGroupPresenceJoinIntent, addr 0x5ca0884, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c9d220, size 0x5c, virtual false, abstract: false, final false
