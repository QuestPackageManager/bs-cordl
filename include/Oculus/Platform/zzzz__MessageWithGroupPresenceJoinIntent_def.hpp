...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c8304, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(void* c_message);

  /// @brief Method GetGroupPresenceJoinIntent, addr 0x29c82c8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c5938, size 0x58, virtual false, abstract: false, final false
