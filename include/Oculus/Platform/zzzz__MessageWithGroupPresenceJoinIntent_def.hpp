...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x5c2cd68, size 0x9c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetGroupPresenceJoinIntent, addr 0x5c2cd24, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c296c0, size 0x5c, virtual false, abstract: false, final false
