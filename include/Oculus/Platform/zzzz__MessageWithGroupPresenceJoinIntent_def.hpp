...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 971 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13434))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13289)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceJoinIntent*
