...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f79cb4, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetGroupPresenceJoinIntent, addr 0x3f79c78, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f77408, size 0x58, virtual false, abstract: false, final false
