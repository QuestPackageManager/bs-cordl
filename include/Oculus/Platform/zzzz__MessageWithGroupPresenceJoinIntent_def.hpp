...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afbc50, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceJoinIntent* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetGroupPresenceJoinIntent, addr 0x2afbc14, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af9284, size 0x58, virtual false, abstract: false, final false
