...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c83dc, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetDataFromMessage(void* c_message);

  /// @brief Method GetGroupPresenceLeaveIntent, addr 0x29c83a0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c5990, size 0x58, virtual false, abstract: false, final false
