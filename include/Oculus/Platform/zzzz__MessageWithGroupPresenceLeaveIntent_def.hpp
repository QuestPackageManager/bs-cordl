...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 972 }), TypeDefinitionIndex(TypeDefinitionIndex(13435)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13290)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceLeaveIntent*
