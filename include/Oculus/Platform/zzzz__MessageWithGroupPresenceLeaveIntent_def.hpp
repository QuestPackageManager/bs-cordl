...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13374)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 969 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13196)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceLeaveIntent*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718864, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetGroupPresenceLeaveIntent, addr 0x271b524, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetGroupPresenceLeaveIntent();

  /// @brief Method GetDataFromMessage, addr 0x271b560, size 0x9c, virtual true, abstract: false, final false
