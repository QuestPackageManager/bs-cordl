...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 954 }), TypeDefinitionIndex(TypeDefinitionIndex(13481)),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13303)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceLeaveIntent*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592fdc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetGroupPresenceLeaveIntent addr 0x2595c9c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetGroupPresenceLeaveIntent();

  /// @brief Method GetDataFromMessage addr 0x2595cd8 size 0x9c virtual true final false
