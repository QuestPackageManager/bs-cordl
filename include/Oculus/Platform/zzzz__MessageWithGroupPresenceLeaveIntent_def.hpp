...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13435)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 972 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13290)) CS Name: ::Oculus.Platform::MessageWithGroupPresenceLeaveIntent*
