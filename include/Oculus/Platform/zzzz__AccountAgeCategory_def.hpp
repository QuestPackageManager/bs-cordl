...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::AccountAgeCategory, "Oculus.Platform", "AccountAgeCategory");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::AccountAgeCategory) == 0x4, "Size mismatch!");
