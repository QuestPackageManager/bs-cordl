...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13537)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4514 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13343)) CS Name: ::Oculus.Platform::MessageWithRoomInviteNotificationList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593a84 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoomInviteNotificationList addr 0x2598224 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::RoomInviteNotificationList* GetRoomInviteNotificationList();

  /// @brief Method GetDataFromMessage addr 0x2598260 size 0x9c virtual true final false
