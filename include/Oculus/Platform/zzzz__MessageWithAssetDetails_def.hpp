...
public:
  // Declarations
  /// @brief Method GetAssetDetails, addr 0x5c9dee8, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetails* GetAssetDetails();

  /// @brief Method GetDataFromMessage, addr 0x5c9df2c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b144, size 0x5c, virtual false, abstract: false, final false
