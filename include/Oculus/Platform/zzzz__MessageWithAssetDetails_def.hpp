...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13417)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 1169 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13275)) CS Name: ::Oculus.Platform::MessageWithAssetDetails*
