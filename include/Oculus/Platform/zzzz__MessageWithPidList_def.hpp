...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13419)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4583 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13226)) CS Name: ::Oculus.Platform::MessageWithPidList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718f9c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPidList, addr 0x271d23c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PidList* GetPidList();

  /// @brief Method GetDataFromMessage, addr 0x271d278, size 0x9c, virtual true, abstract: false, final false
