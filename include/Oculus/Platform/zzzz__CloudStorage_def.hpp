...
public:
  // Declarations
  /// @brief Method Delete, addr 0x272bda8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method Load, addr 0x272bf18, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::CloudStorageData*>* Load(::StringW bucket, ::StringW key);

  /// @brief Method LoadBucketMetadata, addr 0x272c088, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadConflictMetadata, addr 0x272c1e8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadHandle, addr 0x272c358, size 0x160, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::CloudStorageData*>* LoadHandle(::StringW handle);

  /// @brief Method LoadMetadata, addr 0x272c4b8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveKeepLocal, addr 0x272c628, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveKeepRemote, addr 0x272c7a0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x272c918, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextCloudStorageMetadataListPage, addr 0x272cabc, size 0x11dc, virtual false, abstract: false, final false
