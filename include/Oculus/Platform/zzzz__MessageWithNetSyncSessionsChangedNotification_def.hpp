...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca0018, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x5c9ffd4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9bbb0, size 0x5c, virtual false, abstract: false, final false
