...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x27e4574, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x27e4538, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27e0db0, size 0x58, virtual false, abstract: false, final false
