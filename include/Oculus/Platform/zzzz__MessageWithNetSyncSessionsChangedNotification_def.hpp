...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 979 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13461))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13308)) CS Name: ::Oculus.Platform::MessageWithNetSyncSessionsChangedNotification*
