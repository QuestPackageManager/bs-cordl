...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7e418, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionsChangedNotification* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSessionsChangedNotification, addr 0x3f7e3dc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7ae0c, size 0x58, virtual false, abstract: false, final false
