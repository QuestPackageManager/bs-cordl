...
/// @brief Method EntitlementCheckCallback, addr 0x5c455f4, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method PerformUserEntitlementCheck, addr 0x5c45118, size 0x22c, virtual false, abstract: false, final false
inline void PerformUserEntitlementCheck() ;

/// @brief Method PlatformInitializeCallback, addr 0x5c45344, size 0x2b0, virtual false, abstract: false, final false
inline void PlatformInitializeCallback(::Oculus::Platform::Message_1<::Oculus::Platform::Models::PlatformInitialize*>*  msg) ;

/// @brief Method QuitAppOnFailure, addr 0x5c456e0, size 0xa0, virtual false, abstract: false, final false
inline void QuitAppOnFailure() ;

/// @brief Method Start, addr 0x5c45054, size 0xc4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5c45780, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_UserFailedEntitlementCheck, addr 0x5c44da4, size 0xac, virtual false, abstract: false, final false
inline void add_UserFailedEntitlementCheck(::System::Action*  value) ;

/// @brief Method add_UserPassedEntitlementCheck, addr 0x5c44efc, size 0xac, virtual false, abstract: false, final false
inline void add_UserPassedEntitlementCheck(::System::Action*  value) ;

/// @brief Method remove_UserFailedEntitlementCheck, addr 0x5c44e50, size 0xac, virtual false, abstract: false, final false
inline void remove_UserFailedEntitlementCheck(::System::Action*  value) ;

/// @brief Method remove_UserPassedEntitlementCheck, addr 0x5c44fa8, size 0xac, virtual false, abstract: false, final false
