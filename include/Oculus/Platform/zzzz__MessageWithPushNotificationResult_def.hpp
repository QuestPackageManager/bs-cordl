...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc7c34, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PushNotificationResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPushNotificationResult, addr 0x5bc7bf0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2ebc, size 0x5c, virtual false, abstract: false, final false
