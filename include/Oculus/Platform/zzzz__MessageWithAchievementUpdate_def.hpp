...
public:
// Declarations
/// @brief Method GetAchievementUpdate, addr 0x5c2b6a4, size 0x44, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate() ;

/// @brief Method GetDataFromMessage, addr 0x5c2b6e8, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c28f90, size 0x5c, virtual false, abstract: false, final false
