...
public:
  // Declarations
  /// @brief Method GetAchievementUpdate, addr 0x3f8b1c0, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetDataFromMessage, addr 0x3f8b1fc, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f891c8, size 0x58, virtual false, abstract: false, final false
