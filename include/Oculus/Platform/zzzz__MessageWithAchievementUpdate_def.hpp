...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4572 }), TypeDefinitionIndex(TypeDefinitionIndex(13411)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13270)) CS Name: ::Oculus.Platform::MessageWithAchievementUpdate*
