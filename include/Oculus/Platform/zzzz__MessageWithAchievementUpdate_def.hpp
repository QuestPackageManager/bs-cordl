...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13343)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4541 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13170)) CS Name: ::Oculus.Platform::MessageWithAchievementUpdate*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2717fcc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAchievementUpdate, addr 0x2719f5c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetDataFromMessage, addr 0x2719f98, size 0x9c, virtual true, abstract: false, final false
