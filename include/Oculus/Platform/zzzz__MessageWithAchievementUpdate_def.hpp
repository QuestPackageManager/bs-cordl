...
public:
  // Declarations
  /// @brief Method GetAchievementUpdate, addr 0x3f78d78, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetDataFromMessage, addr 0x3f78db4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f76d80, size 0x58, virtual false, abstract: false, final false
