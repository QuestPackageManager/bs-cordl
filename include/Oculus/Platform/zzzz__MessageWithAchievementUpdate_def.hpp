...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4572 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13411))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13270)) CS Name: ::Oculus.Platform::MessageWithAchievementUpdate*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ee9a8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAchievementUpdate, addr 0x26f0a38, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate();

  /// @brief Method GetDataFromMessage, addr 0x26f0a74, size 0x9c, virtual true, abstract: false, final false
