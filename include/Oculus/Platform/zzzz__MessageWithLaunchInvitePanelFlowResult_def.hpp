...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13444)), TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 975 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13295)) CS Name: ::Oculus.Platform::MessageWithLaunchInvitePanelFlowResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ef1e8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x26f1f28, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetLaunchInvitePanelFlowResult();

  /// @brief Method GetDataFromMessage, addr 0x26f1f64, size 0x9c, virtual true, abstract: false, final false
