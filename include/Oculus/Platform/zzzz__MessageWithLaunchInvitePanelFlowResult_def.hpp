...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13383)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 971 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13201)) CS Name: ::Oculus.Platform::MessageWithLaunchInvitePanelFlowResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27189c4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult, addr 0x271b9b4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetLaunchInvitePanelFlowResult();

  /// @brief Method GetDataFromMessage, addr 0x271b9f0, size 0x9c, virtual true, abstract: false, final false
