...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 956 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13490))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13308)) CS Name: ::Oculus.Platform::MessageWithLaunchInvitePanelFlowResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x259313c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLaunchInvitePanelFlowResult addr 0x259612c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetLaunchInvitePanelFlowResult();

  /// @brief Method GetDataFromMessage addr 0x2596168 size 0x9c virtual true final false
