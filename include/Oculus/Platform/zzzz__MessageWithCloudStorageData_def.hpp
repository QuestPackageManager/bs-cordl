...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13365)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4556 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13188)) CS Name: ::Oculus.Platform::MessageWithCloudStorageData*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27185a4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCloudStorageData, addr 0x271aee4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CloudStorageData* GetCloudStorageData();

  /// @brief Method GetDataFromMessage, addr 0x271af20, size 0x9c, virtual true, abstract: false, final false
