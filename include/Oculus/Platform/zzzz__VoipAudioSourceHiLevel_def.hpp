...
public:
  ...
  /// @brief Method Awake, addr 0x5c3e654, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate* New_ctor();

  /// @brief Method OnAudioFilterRead, addr 0x5c3e6d8, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c3eb98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x5c3dfa0, size 0x2d4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreatePCMSource, addr 0x5c3e28c, size 0x50, virtual true, abstract: false, final false
  inline void CreatePCMSource();

  /// @brief Method MSToElements, addr 0x5c3e2e0, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t MSToElements(int32_t ms);

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor();

  /// @brief Method SampleRateToEnum, addr 0x5c3df5c, size 0x44, virtual false, abstract: false, final false
  inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t rate);

  /// @brief Method Start, addr 0x5c3e274, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x5c3df58, size 0x4, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x5c3e34c, size 0x304, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5c3e650, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_senderID, addr 0x5c3dea0, size 0xb8, virtual false, abstract: false, final false
