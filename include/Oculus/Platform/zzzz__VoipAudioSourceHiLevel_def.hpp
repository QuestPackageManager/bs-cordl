...
public:
  ...
  /// @brief Method Awake, addr 0x3f9b980, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate* New_ctor();

  /// @brief Method OnAudioFilterRead, addr 0x3f9ba04, size 0x4e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f9bee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x3f9b308, size 0x2a4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreatePCMSource, addr 0x3f9b5c8, size 0x58, virtual true, abstract: false, final false
  inline void CreatePCMSource();

  /// @brief Method MSToElements, addr 0x3f9b628, size 0x68, virtual false, abstract: false, final false
  static inline int32_t MSToElements(int32_t ms);

  static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor();

  /// @brief Method SampleRateToEnum, addr 0x3f9b2c4, size 0x44, virtual false, abstract: false, final false
  inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t rate);

  /// @brief Method Start, addr 0x3f9b5ac, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Stop, addr 0x3f9b2c0, size 0x4, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x3f9b690, size 0x2e8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3f9b978, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_senderID, addr 0x3f9b214, size 0xac, virtual false, abstract: false, final false
