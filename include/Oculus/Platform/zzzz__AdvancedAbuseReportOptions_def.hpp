...
public:
  ...
  /// @brief Method AddSuggestedUser, addr 0x5c78258, size 0x6c, virtual false, abstract: false, final false
  inline void AddSuggestedUser(uint64_t userID);

  /// @brief Method ClearDeveloperDefinedContext, addr 0x5c77f80, size 0x5c, virtual false, abstract: false, final false
  inline void ClearDeveloperDefinedContext();

  /// @brief Method ClearSuggestedUsers, addr 0x5c78348, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSuggestedUsers();

  /// @brief Method Finalize, addr 0x5c7851c, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AdvancedAbuseReportOptions* New_ctor();

  /// @brief Method SetDeveloperDefinedContext, addr 0x5c77e4c, size 0x74, virtual false, abstract: false, final false
  inline void SetDeveloperDefinedContext(::StringW key, ::StringW value);

  /// @brief Method SetObjectType, addr 0x5c78058, size 0x6c, virtual false, abstract: false, final false
  inline void SetObjectType(::StringW value);

  /// @brief Method SetReportType, addr 0x5c78168, size 0x6c, virtual false, abstract: false, final false
  inline void SetReportType(::Oculus::Platform::AbuseReportType value);

  /// @brief Method SetVideoMode, addr 0x5c78420, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c77d8c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5c78510, size 0xc, virtual false, abstract: false, final false
