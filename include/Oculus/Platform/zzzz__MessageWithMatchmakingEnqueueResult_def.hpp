...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13509)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4500 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13319)) CS Name: ::Oculus.Platform::MessageWithMatchmakingEnqueueResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x25933fc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMatchmakingEnqueueResult addr 0x2596c2c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::MatchmakingEnqueueResult* GetMatchmakingEnqueueResult();

  /// @brief Method GetDataFromMessage addr 0x2596c68 size 0x9c virtual true final false
