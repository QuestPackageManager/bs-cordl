...
// Write type traits
MARK_REF_T(::Oculus::Platform::DeviceApplicationIntegrity*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::DeviceApplicationIntegrity*, "Oculus.Platform", "DeviceApplicationIntegrity");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DeviceApplicationIntegrity", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeviceApplicationIntegrity(DeviceApplicationIntegrity&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeviceApplicationIntegrity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeviceApplicationIntegrity(DeviceApplicationIntegrityconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::DeviceApplicationIntegrity) == 0x10, "Size mismatch!");
