...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4594 }), TypeDefinitionIndex(TypeDefinitionIndex(13453)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13301)) CS Name: ::Oculus.Platform::MessageWithLivestreamingApplicationStatus*
