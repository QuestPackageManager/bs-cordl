...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithLivestreamingApplicationStatus*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithLivestreamingApplicationStatus*, "Oculus.Platform", "MessageWithLivestreamingApplicationStatus");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddb8ac, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingApplicationStatus* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingApplicationStatus, addr 0x5ddb868, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ddb80c, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithLivestreamingApplicationStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithLivestreamingApplicationStatus(MessageWithLivestreamingApplicationStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithLivestreamingApplicationStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithLivestreamingApplicationStatus(MessageWithLivestreamingApplicationStatusconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::MessageWithLivestreamingApplicationStatus) == 0x30, "Size mismatch!");
