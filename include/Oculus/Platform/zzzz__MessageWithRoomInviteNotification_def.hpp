...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 966 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13536))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13342)) CS Name: ::Oculus.Platform::MessageWithRoomInviteNotification*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593a2c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoomInviteNotification addr 0x259814c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::RoomInviteNotification* GetRoomInviteNotification();

  /// @brief Method GetDataFromMessage addr 0x2598188 size 0x9c virtual true final false
