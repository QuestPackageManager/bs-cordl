...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::NetSyncVoipMicSource, "Oculus.Platform", "NetSyncVoipMicSource");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::NetSyncVoipMicSource) == 0x4, "Size mismatch!");
