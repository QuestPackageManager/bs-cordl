...
public:
  ...
  /// @brief Method Finalize, addr 0x5bc8aa0, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::MultiplayerErrorOptions* New_ctor();

  /// @brief Method SetErrorKey, addr 0x5bc8a28, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc89cc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5bc8a94, size 0xc, virtual false, abstract: false, final false
