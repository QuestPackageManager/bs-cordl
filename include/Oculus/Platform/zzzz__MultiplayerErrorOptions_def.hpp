...
public:
  ...
  /// @brief Method Finalize, addr 0x3f8eb70, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::MultiplayerErrorOptions* New_ctor();

  /// @brief Method SetErrorKey, addr 0x3f8eafc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f8ea98, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x3f8eb64, size 0xc, virtual false, abstract: false, final false
