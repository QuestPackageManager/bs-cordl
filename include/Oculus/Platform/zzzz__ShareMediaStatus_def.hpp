...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::ShareMediaStatus, "Oculus.Platform", "ShareMediaStatus");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::ShareMediaStatus) == 0x4, "Size mismatch!");
