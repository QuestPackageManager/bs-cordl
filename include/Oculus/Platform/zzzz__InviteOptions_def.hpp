...
public:
  ...
  /// @brief Method AddSuggestedUser, addr 0x5bbff48, size 0x6c, virtual false, abstract: false, final false
  inline void AddSuggestedUser(uint64_t userID);

  /// @brief Method ClearSuggestedUsers, addr 0x5bbffb4, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSuggestedUsers();

  /// @brief Method Finalize, addr 0x5bc001c, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bbfeec, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5bc0010, size 0xc, virtual false, abstract: false, final false
