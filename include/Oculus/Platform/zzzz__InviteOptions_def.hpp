...
public:
  ...
  /// @brief Method AddSuggestedUser, addr 0x5c26a28, size 0x6c, virtual false, abstract: false, final false
  inline void AddSuggestedUser(uint64_t userID);

  /// @brief Method ClearSuggestedUsers, addr 0x5c26a94, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSuggestedUsers();

  /// @brief Method Finalize, addr 0x5c26afc, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c269cc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5c26af0, size 0xc, virtual false, abstract: false, final false
