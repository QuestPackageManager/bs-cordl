...
/// @brief Method AddSuggestedUser, addr 0x5c26f34, size 0x6c, virtual false, abstract: false, final false
inline void AddSuggestedUser(uint64_t  userID) ;

/// @brief Method ClearSuggestedUsers, addr 0x5c26fa0, size 0x5c, virtual false, abstract: false, final false
inline void ClearSuggestedUsers() ;

/// @brief Method Finalize, addr 0x5c27008, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c26ed8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x5c26ffc, size 0xc, virtual false, abstract: false, final false
