...
// Write type traits
MARK_REF_T(::Oculus::Platform::InviteOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::InviteOptions*, "Oculus.Platform", "InviteOptions");
...
public:
  ...
  /// @brief Method AddSuggestedUser, addr 0x5dd4ee4, size 0x6c, virtual false, abstract: false, final false
  inline void AddSuggestedUser(uint64_t userID);

  /// @brief Method ClearSuggestedUsers, addr 0x5dd4f50, size 0x5c, virtual false, abstract: false, final false
  inline void ClearSuggestedUsers();

  /// @brief Method Finalize, addr 0x5dd4fb8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd4e88, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5dd4fac, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InviteOptions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InviteOptions(InviteOptions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InviteOptions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InviteOptions(InviteOptionsconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::InviteOptions) == 0x18, "Size mismatch!");
