...
public:
  ...
  /// @brief Method .ctor, addr 0x26f3040, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetParty, addr 0x26f3098, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  /// @brief Method GetDataFromMessage, addr 0x26f30d4, size 0x9c, virtual true, abstract: false, final false
