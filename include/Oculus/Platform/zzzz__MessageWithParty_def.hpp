...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4508 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13522))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13329)) CS Name: ::Oculus.Platform::MessageWithParty*
...
public:
  ...
  /// @brief Method .ctor addr 0x25975a4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetParty addr 0x25975fc size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::Party* GetParty();

  /// @brief Method GetDataFromMessage addr 0x2597638 size 0x9c virtual true final false
