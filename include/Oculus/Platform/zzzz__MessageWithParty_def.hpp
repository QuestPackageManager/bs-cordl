...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dda24c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Party* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetParty, addr 0x5dda208, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dda1ac, size 0x5c, virtual false, abstract: false, final false
