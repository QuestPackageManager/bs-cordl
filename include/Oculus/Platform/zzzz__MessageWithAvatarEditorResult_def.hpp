...
public:
  // Declarations
  /// @brief Method GetAvatarEditorResult, addr 0x5c2c038, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult();

  /// @brief Method GetDataFromMessage, addr 0x5c2c07c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c28e78, size 0x5c, virtual false, abstract: false, final false
