...
public:
  // Declarations
  /// @brief Method GetAvatarEditorResult, addr 0x5c9e52c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult();

  /// @brief Method GetDataFromMessage, addr 0x5c9e570, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b36c, size 0x5c, virtual false, abstract: false, final false
