...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13423)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4581 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13281)) CS Name: ::Oculus.Platform::MessageWithAvatarEditorResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x26eed70 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAvatarEditorResult addr 0x26f1380 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult();

  /// @brief Method GetDataFromMessage addr 0x26f13bc size 0x9c virtual true final false
