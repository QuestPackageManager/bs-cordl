...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::LeaderboardFilterType, "Oculus.Platform", "LeaderboardFilterType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::LeaderboardFilterType) == 0x4, "Size mismatch!");
