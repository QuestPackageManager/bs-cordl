...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4485 }), TypeDefinitionIndex(TypeDefinitionIndex(13475)),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13298)) CS Name: ::Oculus.Platform::MessageWithCloudStorageUpdateResponse*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592e24 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCloudStorageUpdateResponse addr 0x25958e4 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::CloudStorageUpdateResponse* GetCloudStorageUpdateResponse();

  /// @brief Method GetDataFromMessage addr 0x2595920 size 0x9c virtual true final false
