...
public:
  // Declarations
  /// @brief Method Clear addr 0x26ca7bc size 0x144 virtual false final false
  static inline ::Oculus::Platform::Request* Clear();

  /// @brief Method GetInvitableUsers addr 0x26fcd08 size 0x1a0 virtual false final false
  ...
  /// @brief Method GetSentInvites addr 0x26fcea8 size 0x158 virtual false final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ApplicationInviteList*>* GetSentInvites();

  /// @brief Method LaunchInvitePanel addr 0x26caad8 size 0x1a0 virtual false final false
  ...
  /// @brief Method LaunchMultiplayerErrorDialog addr 0x26fd000 size 0x18c virtual false final false
  static inline ::Oculus::Platform::Request* LaunchMultiplayerErrorDialog(::Oculus::Platform::MultiplayerErrorOptions* options);

  /// @brief Method LaunchRejoinDialog addr 0x26fd18c size 0x178 virtual false final false
  ...
  /// @brief Method LaunchRosterPanel addr 0x26cae34 size 0x18c virtual false final false
  static inline ::Oculus::Platform::Request* LaunchRosterPanel(::Oculus::Platform::RosterOptions* options);

  /// @brief Method SendInvites addr 0x26fd35c size 0x174 virtual false final false
  ...
  /// @brief Method Set addr 0x26ca3e4 size 0x18c virtual false final false
  static inline ::Oculus::Platform::Request* Set(::Oculus::Platform::GroupPresenceOptions* groupPresenceOptions);

  /// @brief Method SetDeeplinkMessageOverride addr 0x26fd4d0 size 0x14c virtual false final false
  static inline ::Oculus::Platform::Request* SetDeeplinkMessageOverride(::StringW deeplink_message);

  /// @brief Method SetDestination addr 0x26fd61c size 0x14c virtual false final false
  static inline ::Oculus::Platform::Request* SetDestination(::StringW api_name);

  /// @brief Method SetIsJoinable addr 0x26fd768 size 0x14c virtual false final false
  static inline ::Oculus::Platform::Request* SetIsJoinable(bool is_joinable);

  /// @brief Method SetLobbySession addr 0x26fd8b4 size 0x14c virtual false final false
  static inline ::Oculus::Platform::Request* SetLobbySession(::StringW id);

  /// @brief Method SetMatchSession addr 0x26fda00 size 0x14c virtual false final false
  static inline ::Oculus::Platform::Request* SetMatchSession(::StringW id);

  /// @brief Method SetInvitationsSentNotificationCallback addr 0x26cc77c size 0x74 virtual false final false
  ...
  /// @brief Method SetJoinIntentReceivedNotificationCallback addr 0x26cc694 size 0x74 virtual false final false
  ...
  /// @brief Method SetLeaveIntentReceivedNotificationCallback addr 0x26cc708 size 0x74 virtual false final false
  ...
  /// @brief Method GetNextApplicationInviteListPage addr 0x26fdb4c size 0x1dc virtual false final false
