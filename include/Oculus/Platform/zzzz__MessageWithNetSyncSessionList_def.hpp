...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13460)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 4598 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13307)) CS Name: ::Oculus.Platform::MessageWithNetSyncSessionList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26f2b00, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncSessionList, addr 0x26f2b58, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionList* GetNetSyncSessionList();

  /// @brief Method GetDataFromMessage, addr 0x26f2b94, size 0x9c, virtual true, abstract: false, final false
