...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13408)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4577 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13217)) CS Name: ::Oculus.Platform::MessageWithNetSyncSessionList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271c8ec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncSessionList, addr 0x271c944, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionList* GetNetSyncSessionList();

  /// @brief Method GetDataFromMessage, addr 0x271c980, size 0x9c, virtual true, abstract: false, final false
