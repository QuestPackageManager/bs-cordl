...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f84204, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSessionList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSessionList, addr 0x3f841c8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f84170, size 0x58, virtual false, abstract: false, final false
