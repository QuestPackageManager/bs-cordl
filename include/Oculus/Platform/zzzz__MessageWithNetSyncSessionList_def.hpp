...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4598 }), TypeDefinitionIndex(TypeDefinitionIndex(13460)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13307)) CS Name: ::Oculus.Platform::MessageWithNetSyncSessionList*
