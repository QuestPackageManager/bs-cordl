...
public:
  // Declarations
  /// @brief Method CancelAppDownload, addr 0x3f86170, size 0x150, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadResult*>* CancelAppDownload();

  /// @brief Method CheckAppDownloadProgress, addr 0x3f862c0, size 0x150, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadProgressResult*>* CheckAppDownloadProgress();

  /// @brief Method GetVersion, addr 0x3f86410, size 0x150, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ApplicationVersion*>* GetVersion();

  /// @brief Method InstallAppUpdateAndRelaunch, addr 0x3f86560, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchOtherApp, addr 0x3f866c0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method StartAppDownload, addr 0x3f86830, size 0x150, virtual false, abstract: false, final false
