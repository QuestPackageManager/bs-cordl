...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::SdkAccountType, "Oculus.Platform", "SdkAccountType");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::SdkAccountType) == 0x4, "Size mismatch!");
