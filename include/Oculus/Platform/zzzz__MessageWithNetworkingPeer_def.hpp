...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13413)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 976 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13249)) CS Name: ::Oculus.Platform::MessageWithNetworkingPeer*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271972c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetworkingPeer, addr 0x271e5b4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetworkingPeer* GetNetworkingPeer();

  /// @brief Method GetDataFromMessage, addr 0x271e5f0, size 0xb0, virtual true, abstract: false, final false
