...
public:
  // Declarations
  /// @brief Method GetAssetDetailsList, addr 0x3f79258, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList();

  /// @brief Method GetDataFromMessage, addr 0x3f79294, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f76f90, size 0x58, virtual false, abstract: false, final false
