...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13348)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4544 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13174)) CS Name: ::Oculus.Platform::MessageWithAssetDetailsList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271812c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAssetDetailsList, addr 0x271a2bc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList();

  /// @brief Method GetDataFromMessage, addr 0x271a2f8, size 0x9c, virtual true, abstract: false, final false
