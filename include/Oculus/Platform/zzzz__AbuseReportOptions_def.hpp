...
public:
  ...
  /// @brief Method Finalize, addr 0x5c05788, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::AbuseReportOptions* New_ctor();

  /// @brief Method SetPreventPeopleChooser, addr 0x5c0559c, size 0x6c, virtual false, abstract: false, final false
  inline void SetPreventPeopleChooser(bool value);

  /// @brief Method SetReportType, addr 0x5c0568c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c054dc, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5c0577c, size 0xc, virtual false, abstract: false, final false
