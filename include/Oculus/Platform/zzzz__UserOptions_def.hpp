...
// Write type traits
MARK_REF_T(::Oculus::Platform::UserOptions*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::UserOptions*, "Oculus.Platform", "UserOptions");
...
public:
  ...
  /// @brief Method AddServiceProvider, addr 0x5de97c0, size 0x6c, virtual false, abstract: false, final false
  inline void AddServiceProvider(::Oculus::Platform::ServiceProvider value);

  /// @brief Method ClearServiceProviders, addr 0x5de9fd8, size 0x5c, virtual false, abstract: false, final false
  inline void ClearServiceProviders();

  /// @brief Method Finalize, addr 0x5dea0a0, size 0x94, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::UserOptions* New_ctor();

  /// @brief Method SetMaxUsers, addr 0x5de9f6c, size 0x6c, virtual false, abstract: false, final false
  inline void SetMaxUsers(uint32_t value);

  /// @brief Method SetTimeWindow, addr 0x5dea034, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5de9764, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x5de09bc, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::UserOptions) == 0x18, "Size mismatch!");
