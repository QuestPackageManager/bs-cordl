...
public:
  ...
  /// @brief Method AddServiceProvider, addr 0x2854cdc, size 0x68, virtual false, abstract: false, final false
  inline void AddServiceProvider(::Oculus::Platform::ServiceProvider value);

  /// @brief Method ClearServiceProviders, addr 0x2855578, size 0x58, virtual false, abstract: false, final false
  inline void ClearServiceProviders();

  /// @brief Method Finalize, addr 0x2855638, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::UserOptions* New_ctor();

  /// @brief Method SetMaxUsers, addr 0x2855510, size 0x68, virtual false, abstract: false, final false
  inline void SetMaxUsers(uint32_t value);

  /// @brief Method SetTimeWindow, addr 0x28555d0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2854c78, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x2854d44, size 0x58, virtual false, abstract: false, final false
