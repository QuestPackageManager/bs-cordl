...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca1068, size 0x58, virtual true, abstract: false, final false
  inline ::StringW GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetString, addr 0x5ca1024, size 0x44, virtual true, abstract: false, final false
  inline ::StringW GetString();

  static inline ::Oculus::Platform::MessageWithString* New_ctor(::System::IntPtr c_message);

  /// @brief Method .ctor, addr 0x5c9c05c, size 0x5c, virtual false, abstract: false, final false
