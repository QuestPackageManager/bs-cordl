...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 1184 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13484))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13326)) CS Name: ::Oculus.Platform::MessageWithUser*
...
public:
  ...
  /// @brief Method .ctor addr 0x26ef978 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUser addr 0x26f3c78 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::User* GetUser();

  /// @brief Method GetDataFromMessage addr 0x26f3cb4 size 0x9c virtual true final false
