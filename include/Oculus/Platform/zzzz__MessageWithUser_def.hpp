...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13439)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 1166 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13242)) CS Name: ::Oculus.Platform::MessageWithUser*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271951c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUser, addr 0x271df74, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetUser();

  /// @brief Method GetDataFromMessage, addr 0x271dfb0, size 0x9c, virtual true, abstract: false, final false
