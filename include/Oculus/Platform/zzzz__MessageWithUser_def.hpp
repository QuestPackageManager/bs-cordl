...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2ecf0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUser, addr 0x5c2ecac, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetUser();

  static inline ::Oculus::Platform::MessageWithUser* New_ctor(::System::IntPtr c_message);

  /// @brief Method .ctor, addr 0x5c29c20, size 0x5c, virtual false, abstract: false, final false
