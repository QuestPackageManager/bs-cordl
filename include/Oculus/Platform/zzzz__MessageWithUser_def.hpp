...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13484)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 1184 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13326)) CS Name: ::Oculus.Platform::MessageWithUser*
