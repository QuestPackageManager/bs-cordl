...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 1163 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13546))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13349)) CS Name: ::Oculus.Platform::MessageWithUser*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593c94 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUser addr 0x25986ec size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::User* GetUser();

  /// @brief Method GetDataFromMessage addr 0x2598728 size 0x9c virtual true final false
