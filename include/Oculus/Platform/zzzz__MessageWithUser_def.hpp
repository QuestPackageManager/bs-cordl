...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithUser*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithUser*, "Oculus.Platform", "MessageWithUser");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddd1ac, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUser, addr 0x5ddd168, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::User* GetUser();

  static inline ::Oculus::Platform::MessageWithUser* New_ctor(::System::IntPtr c_message);

  /// @brief Method .ctor, addr 0x5dd80dc, size 0x5c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::MessageWithUser) == 0x30, "Size mismatch!");
