...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afc498, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardList, addr 0x2afc45c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af94ec, size 0x58, virtual false, abstract: false, final false
