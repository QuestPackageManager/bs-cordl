...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c8b4c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(void* c_message);

  /// @brief Method GetLeaderboardList, addr 0x29c8b10, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c5ba0, size 0x58, virtual false, abstract: false, final false
