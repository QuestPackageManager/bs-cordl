...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f838fc, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardList, addr 0x3f838c0, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f80ab8, size 0x58, virtual false, abstract: false, final false
