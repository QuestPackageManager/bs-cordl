...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f80ca4, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardList, addr 0x3f80c68, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7de60, size 0x58, virtual false, abstract: false, final false
