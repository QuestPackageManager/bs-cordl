...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd9388, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardList, addr 0x5dd9344, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd56cc, size 0x5c, virtual false, abstract: false, final false
