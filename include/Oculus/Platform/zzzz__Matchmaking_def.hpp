...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2724094, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(
      property(get = __cordl_internal_get_criteria,
               put = __cordl_internal_set_criteria))::ArrayW<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion, ::Array<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion>*> criteria;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::System::Object*>*& __cordl_internal_get_data();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW, ::System::Object*>*> const& __cordl_internal_get_data() const;

  constexpr void __cordl_internal_set_data(::System::Collections::Generic::Dictionary_2<::StringW, ::System::Object*>* value);

  constexpr ::ArrayW<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion, ::Array<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion>*>& __cordl_internal_get_criteria();

  constexpr ::ArrayW<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion, ::Array<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion>*> const& __cordl_internal_get_criteria() const;

  constexpr void __cordl_internal_set_criteria(::ArrayW<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion, ::Array<::GlobalNamespace::__Matchmaking__CustomQuery__Criterion>*> value);

  /// @brief Method ToUnmanaged, addr 0x272275c, size 0x31c, virtual false, abstract: false, final false
  inline void* ToUnmanaged();

  static inline ::Oculus::Platform::__Matchmaking__CustomQuery* New_ctor();

  /// @brief Method .ctor, addr 0x272408c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ReportResultsInsecure, addr 0x2722124, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStats, addr 0x2722440, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Browse, addr 0x27225b8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Browse2, addr 0x2722a78, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Cancel, addr 0x2722c28, size 0x15c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Cancel(::StringW pool, ::StringW requestHash);

  /// @brief Method Cancel, addr 0x2722d84, size 0x144, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* Cancel();

  /// @brief Method CreateAndEnqueueRoom, addr 0x2722ec8, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateAndEnqueueRoom2, addr 0x2723084, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRoom, addr 0x2723234, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRoom2, addr 0x27233ac, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Enqueue, addr 0x272355c, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Enqueue2, addr 0x2723700, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method EnqueueRoom, addr 0x27238b0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method EnqueueRoom2, addr 0x2723a54, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAdminSnapshot, addr 0x2723c04, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::MatchmakingAdminSnapshot*>* GetAdminSnapshot();

  /// @brief Method JoinRoom, addr 0x2723d5c, size 0x170, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Room*>* JoinRoom(uint64_t roomID, bool subscribeToUpdates);

  /// @brief Method StartMatch, addr 0x2723ecc, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* StartMatch(uint64_t roomID);

  /// @brief Method SetMatchFoundNotificationCallback, addr 0x2724018, size 0x74, virtual false, abstract: false, final false
