...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f839cc, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardEntryList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardEntryList, addr 0x3f83990, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f80b10, size 0x58, virtual false, abstract: false, final false
