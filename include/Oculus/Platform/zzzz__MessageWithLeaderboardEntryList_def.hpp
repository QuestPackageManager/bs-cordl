...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc66f4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardEntryList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLeaderboardEntryList, addr 0x5bc66b0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc29b4, size 0x5c, virtual false, abstract: false, final false
