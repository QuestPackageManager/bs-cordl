...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13389)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 972 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13205)) CS Name: ::Oculus.Platform::MessageWithLeaderboardEntryList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718acc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLeaderboardEntryList, addr 0x271bd6c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LeaderboardEntryList* GetLeaderboardEntryList();

  /// @brief Method GetDataFromMessage, addr 0x271bda8, size 0x9c, virtual true, abstract: false, final false
