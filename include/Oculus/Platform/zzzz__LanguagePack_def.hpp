...
public:
  // Declarations
  /// @brief Method GetCurrent, addr 0x5de7f14, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AssetDetails*>* GetCurrent();

  /// @brief Method SetCurrent, addr 0x5de806c, size 0x168, virtual false, abstract: false, final false
