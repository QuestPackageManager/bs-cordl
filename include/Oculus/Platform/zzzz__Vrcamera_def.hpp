...
public:
  // Declarations
  /// @brief Method SetGetDataChannelMessageUpdateNotificationCallback, addr 0x3f8cddc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetGetSurfaceUpdateNotificationCallback, addr 0x3f8ce50, size 0x74, virtual false, abstract: false, final false
