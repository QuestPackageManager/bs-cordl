...
public:
  // Declarations
  /// @brief Method SetGetDataChannelMessageUpdateNotificationCallback addr 0x27003c4 size 0x74 virtual false final false
  ...
  /// @brief Method SetGetSurfaceUpdateNotificationCallback addr 0x2700438 size 0x74 virtual false final false
