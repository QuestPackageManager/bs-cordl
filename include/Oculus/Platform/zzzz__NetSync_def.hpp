...
public:
  // Declarations
  /// @brief Method SetConnectionStatusChangedNotificationCallback, addr 0x3f8b7bc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSessionsChangedNotificationCallback, addr 0x3f8b830, size 0x74, virtual false, abstract: false, final false
