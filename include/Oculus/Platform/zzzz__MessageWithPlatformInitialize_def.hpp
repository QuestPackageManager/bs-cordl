...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13421)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4584 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13255)) CS Name: ::Oculus.Platform::MessageWithPlatformInitialize*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271988c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPlatformInitialize, addr 0x271eb64, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetPlatformInitialize();

  /// @brief Method GetDataFromMessage, addr 0x271eba0, size 0x9c, virtual true, abstract: false, final false
