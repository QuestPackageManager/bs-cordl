...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddb6a4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPlatformInitialize, addr 0x5ddb660, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd60dc, size 0x5c, virtual false, abstract: false, final false
