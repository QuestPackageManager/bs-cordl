...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f82dac, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPlatformInitialize, addr 0x3f82d70, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7e7a8, size 0x58, virtual false, abstract: false, final false
