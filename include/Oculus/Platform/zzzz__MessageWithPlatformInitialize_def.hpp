...
public:
  ...
  /// @brief Method GetPlatformInitialize, addr 0x3f7fb0c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7b544, size 0x58, virtual false, abstract: false, final false
