...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4605 }), TypeDefinitionIndex(TypeDefinitionIndex(13472)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13335)) CS Name: ::Oculus.Platform::MessageWithPlatformInitialize*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26efbe0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPlatformInitialize, addr 0x26f4428, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PlatformInitialize* GetPlatformInitialize();

  /// @brief Method GetDataFromMessage, addr 0x26f4464, size 0x9c, virtual true, abstract: false, final false
