...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13427)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 980 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13232)) CS Name: ::Oculus.Platform::MessageWithRoomUnderCurrentRoom*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27191ac, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoom, addr 0x271d74c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Room* GetRoom();

  /// @brief Method GetDataFromMessage, addr 0x271d788, size 0x9c, virtual true, abstract: false, final false
