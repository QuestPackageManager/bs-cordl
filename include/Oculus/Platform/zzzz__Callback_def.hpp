...
public:
  ...
  /// @brief Method HandleMessage, addr 0x3f6a5d4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f6a5cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3f69e94, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRequest, addr 0x3f69ebc, size 0xdc, virtual false, abstract: false, final false
  static inline void AddRequest(::Oculus::Platform::Request* request);

  /// @brief Method FlushJoinIntentNotificationQueue, addr 0x3f6a44c, size 0xa0, virtual false, abstract: false, final false
  static inline void FlushJoinIntentNotificationQueue();

  /// @brief Method HandleMessage, addr 0x3f6a0d8, size 0x248, virtual false, abstract: false, final false
  static inline void HandleMessage(::Oculus::Platform::Message* msg);

  /// @brief Method OnApplicationQuit, addr 0x3f6a3a8, size 0xa4, virtual false, abstract: false, final false
  static inline void OnApplicationQuit();

  /// @brief Method RunCallbacks, addr 0x3f69f98, size 0x6c, virtual false, abstract: false, final false
  static inline void RunCallbacks();

  /// @brief Method RunLimitedCallbacks, addr 0x3f6a320, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNotificationCallback, addr 0x3f69d88, size 0x10c, virtual false, abstract: false, final false
