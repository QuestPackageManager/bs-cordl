...
public:
  ...
  /// @brief Method HandleMessage, addr 0x3f5818c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f58184, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3f57a4c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddRequest, addr 0x3f57a74, size 0xdc, virtual false, abstract: false, final false
  static inline void AddRequest(::Oculus::Platform::Request* request);

  /// @brief Method FlushJoinIntentNotificationQueue, addr 0x3f58004, size 0xa0, virtual false, abstract: false, final false
  static inline void FlushJoinIntentNotificationQueue();

  /// @brief Method HandleMessage, addr 0x3f57c90, size 0x248, virtual false, abstract: false, final false
  static inline void HandleMessage(::Oculus::Platform::Message* msg);

  /// @brief Method OnApplicationQuit, addr 0x3f57f60, size 0xa4, virtual false, abstract: false, final false
  static inline void OnApplicationQuit();

  /// @brief Method RunCallbacks, addr 0x3f57b50, size 0x6c, virtual false, abstract: false, final false
  static inline void RunCallbacks();

  /// @brief Method RunLimitedCallbacks, addr 0x3f57ed8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNotificationCallback, addr 0x3f57940, size 0x10c, virtual false, abstract: false, final false
