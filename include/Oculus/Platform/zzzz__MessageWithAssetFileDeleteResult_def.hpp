...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4578 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13419))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13277)) CS Name: ::Oculus.Platform::MessageWithAssetFileDeleteResult*
