...
public:
  // Declarations
  /// @brief Method GetAssetFileDeleteResult, addr 0x3f7e29c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult();

  /// @brief Method GetDataFromMessage, addr 0x3f7e2d8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7bf5c, size 0x58, virtual false, abstract: false, final false
