...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4472 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13456))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13282)) CS Name: ::Oculus.Platform::MessageWithAssetFileDeleteResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x25928fc size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAssetFileDeleteResult addr 0x2594b0c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult();

  /// @brief Method GetDataFromMessage addr 0x2594b48 size 0x9c virtual true final false
