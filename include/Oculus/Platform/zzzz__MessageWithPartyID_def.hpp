...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc76f4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x5bc76b0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc7654, size 0x5c, virtual false, abstract: false, final false
