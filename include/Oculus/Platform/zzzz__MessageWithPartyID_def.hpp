...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dda468, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x5dda424, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dda3c8, size 0x5c, virtual false, abstract: false, final false
