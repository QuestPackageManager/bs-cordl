...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afd530, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x2afd4f4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2afd49c, size 0x58, virtual false, abstract: false, final false
