...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2e1d4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x5c2e190, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2e134, size 0x5c, virtual false, abstract: false, final false
