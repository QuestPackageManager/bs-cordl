...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7ea58, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetPartyID, addr 0x3f7ea1c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7e9c4, size 0x58, virtual false, abstract: false, final false
