...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4603 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13467))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13314)) CS Name: ::Oculus.Platform::MessageWithPartyID*
