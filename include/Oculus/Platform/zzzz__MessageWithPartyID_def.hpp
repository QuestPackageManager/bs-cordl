...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4509 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13523))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13331)) CS Name: ::Oculus.Platform::MessageWithPartyID*
...
public:
  ...
  /// @brief Method .ctor addr 0x25977ac size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetPartyID addr 0x2597804 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::PartyID* GetPartyID();

  /// @brief Method GetDataFromMessage addr 0x2597840 size 0x9c virtual true final false
