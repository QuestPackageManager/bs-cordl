...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2848188, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserList* GetDataFromMessage(void* c_message);

  /// @brief Method GetUserList, addr 0x284814c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2843d4c, size 0x58, virtual false, abstract: false, final false
