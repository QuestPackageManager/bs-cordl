...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc83d0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserList, addr 0x5bc838c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc31f8, size 0x5c, virtual false, abstract: false, final false
