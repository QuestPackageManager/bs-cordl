...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca13a4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserList, addr 0x5ca1360, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9c1cc, size 0x5c, virtual false, abstract: false, final false
