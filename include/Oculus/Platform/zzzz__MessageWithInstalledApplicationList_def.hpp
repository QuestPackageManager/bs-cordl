...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13377)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4560 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13197)) CS Name: ::Oculus.Platform::MessageWithInstalledApplicationList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271b5fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetInstalledApplicationList, addr 0x271b654, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InstalledApplicationList* GetInstalledApplicationList();

  /// @brief Method GetDataFromMessage, addr 0x271b690, size 0x9c, virtual true, abstract: false, final false
