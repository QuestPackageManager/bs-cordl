...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29ca508, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InstalledApplicationList* GetDataFromMessage(void* c_message);

  /// @brief Method GetInstalledApplicationList, addr 0x29ca4cc, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29ca474, size 0x58, virtual false, abstract: false, final false
