...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc5f98, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InstalledApplicationList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetInstalledApplicationList, addr 0x5bc5f54, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc5ef8, size 0x5c, virtual false, abstract: false, final false
