...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13503)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4498 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13318)) CS Name: ::Oculus.Platform::MessageWithMatchmakingAdminSnapshot*
...
public:
  ...
  /// @brief Method .ctor addr 0x259334c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMatchmakingAdminSnapshot addr 0x2596b54 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::MatchmakingAdminSnapshot* GetMatchmakingAdminSnapshot();

  /// @brief Method GetDataFromMessage addr 0x2596b90 size 0x9c virtual true final false
