...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f8e5d4, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserDataStoreUpdateResponse* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserDataStoreUpdateResponse, addr 0x3f8e598, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f8a2f8, size 0x58, virtual false, abstract: false, final false
