...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13445)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4594 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13246)) CS Name: ::Oculus.Platform::MessageWithUserDataStoreUpdateResponse*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271967c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserDataStoreUpdateResponse, addr 0x271e2d4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserDataStoreUpdateResponse* GetUserDataStoreUpdateResponse();

  /// @brief Method GetDataFromMessage, addr 0x271e310, size 0x9c, virtual true, abstract: false, final false
