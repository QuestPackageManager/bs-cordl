...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), TypeDefinitionIndex(TypeDefinitionIndex(13535)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4515 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13341)) CS Name: ::Oculus.Platform::MessageWithRoomList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25939d4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRoomList addr 0x2598074 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::RoomList* GetRoomList();

  /// @brief Method GetDataFromMessage addr 0x25980b0 size 0x9c virtual true final false
