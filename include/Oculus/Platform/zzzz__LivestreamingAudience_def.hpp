...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::LivestreamingAudience, "Oculus.Platform", "LivestreamingAudience");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::LivestreamingAudience) == 0x4, "Size mismatch!");
