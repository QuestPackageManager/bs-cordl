...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddab68, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSdkAccountList, addr 0x5ddab24, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5ce8, size 0x5c, virtual false, abstract: false, final false
