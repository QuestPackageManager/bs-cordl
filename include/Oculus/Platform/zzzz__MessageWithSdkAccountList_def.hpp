...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ca0dc8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSdkAccountList, addr 0x5ca0d84, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9bf48, size 0x5c, virtual false, abstract: false, final false
