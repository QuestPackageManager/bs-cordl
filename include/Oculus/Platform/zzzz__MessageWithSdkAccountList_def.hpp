...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13432)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4589 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13237)) CS Name: ::Oculus.Platform::MessageWithSdkAccountList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2719364, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetSdkAccountList, addr 0x271db84, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetSdkAccountList();

  /// @brief Method GetDataFromMessage, addr 0x271dbc0, size 0x9c, virtual true, abstract: false, final false
