...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29cc1c8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(void* c_message);

  /// @brief Method GetSdkAccountList, addr 0x29cc18c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c80c4, size 0x58, virtual false, abstract: false, final false
