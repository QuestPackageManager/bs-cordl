...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc7df4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetSdkAccountList, addr 0x5bc7db0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2f74, size 0x5c, virtual false, abstract: false, final false
