...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13426)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4586 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13230)) CS Name: ::Oculus.Platform::MessageWithRejoinDialogResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27190fc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetRejoinDialogResult, addr 0x271d59c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RejoinDialogResult* GetRejoinDialogResult();

  /// @brief Method GetDataFromMessage, addr 0x271d5d8, size 0x9c, virtual true, abstract: false, final false
