...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2e7f4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RejoinDialogResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetRejoinDialogResult, addr 0x5c2e7b0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c299f8, size 0x5c, virtual false, abstract: false, final false
