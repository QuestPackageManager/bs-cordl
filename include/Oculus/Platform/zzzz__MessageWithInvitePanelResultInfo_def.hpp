...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f8076c, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetInvitePanelResultInfo, addr 0x3f80730, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7dca8, size 0x58, virtual false, abstract: false, final false
