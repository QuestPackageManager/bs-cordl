...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4587 }), TypeDefinitionIndex(TypeDefinitionIndex(13262)),
// TypeDefinitionIndex(TypeDefinitionIndex(13439))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13292)) CS Name: ::Oculus.Platform::MessageWithInvitePanelResultInfo*
