...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2cb58, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetInvitePanelResultInfo, addr 0x5c2cb14, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2926c, size 0x5c, virtual false, abstract: false, final false
