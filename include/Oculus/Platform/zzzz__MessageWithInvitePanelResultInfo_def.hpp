...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7eef0, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetInvitePanelResultInfo, addr 0x3f7eeb4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c42c, size 0x58, virtual false, abstract: false, final false
