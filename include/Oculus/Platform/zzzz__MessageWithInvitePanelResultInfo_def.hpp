...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithInvitePanelResultInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithInvitePanelResultInfo(MessageWithInvitePanelResultInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithInvitePanelResultInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithInvitePanelResultInfo(MessageWithInvitePanelResultInfoconst&) = delete;
