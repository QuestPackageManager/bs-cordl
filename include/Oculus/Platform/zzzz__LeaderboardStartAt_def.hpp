...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::LeaderboardStartAt, "Oculus.Platform", "LeaderboardStartAt");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::LeaderboardStartAt) == 0x4, "Size mismatch!");
