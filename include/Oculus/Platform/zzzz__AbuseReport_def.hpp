...
public:
  // Declarations
  /// @brief Method ReportRequestHandled, addr 0x28213c4, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* ReportRequestHandled(::Oculus::Platform::ReportRequestResponse response);

  /// @brief Method SetReportButtonPressedNotificationCallback, addr 0x2821600, size 0x74, virtual false, abstract: false, final false
