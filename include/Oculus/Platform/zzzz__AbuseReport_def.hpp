...
public:
  // Declarations
  /// @brief Method ReportRequestHandled, addr 0x5c3595c, size 0x154, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* ReportRequestHandled(::Oculus::Platform::ReportRequestResponse response);

  /// @brief Method SetReportButtonPressedNotificationCallback, addr 0x5c35ab0, size 0x7c, virtual false, abstract: false, final false
