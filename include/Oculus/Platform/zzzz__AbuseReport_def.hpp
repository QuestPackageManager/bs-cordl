...
public:
  // Declarations
  /// @brief Method ReportRequestHandled, addr 0x27be9a8, size 0x14c, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request* ReportRequestHandled(::Oculus::Platform::ReportRequestResponse response);

  /// @brief Method SetReportButtonPressedNotificationCallback, addr 0x27bebe4, size 0x74, virtual false, abstract: false, final false
