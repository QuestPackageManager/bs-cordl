...
public:
  // Declarations
  /// @brief Method GetCowatchingState, addr 0x5c9eb4c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CowatchingState* GetCowatchingState();

  /// @brief Method GetDataFromMessage, addr 0x5c9eb90, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b5f0, size 0x5c, virtual false, abstract: false, final false
