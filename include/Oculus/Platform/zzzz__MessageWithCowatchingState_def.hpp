...
public:
  // Declarations
  /// @brief Method GetCowatchingState, addr 0x5bc5b78, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::CowatchingState* GetCowatchingState();

  /// @brief Method GetDataFromMessage, addr 0x5bc5bbc, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc261c, size 0x5c, virtual false, abstract: false, final false
