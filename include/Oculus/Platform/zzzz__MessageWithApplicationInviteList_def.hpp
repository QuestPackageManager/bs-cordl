...
public:
  // Declarations
  /// @brief Method GetApplicationInviteList, addr 0x5dd7838, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList();

  /// @brief Method GetDataFromMessage, addr 0x5dd787c, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd4e2c, size 0x5c, virtual false, abstract: false, final false
