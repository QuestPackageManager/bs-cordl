...
public:
// Declarations
/// @brief Method GetApplicationInviteList, addr 0x5c2bab0, size 0x44, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList() ;

/// @brief Method GetDataFromMessage, addr 0x5c2baf4, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c290a4, size 0x5c, virtual false, abstract: false, final false
