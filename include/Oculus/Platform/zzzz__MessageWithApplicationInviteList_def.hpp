...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4575 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13415))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13273)) CS Name: ::Oculus.Platform::MessageWithApplicationInviteList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26eeab0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetApplicationInviteList, addr 0x26f0cc0, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList();

  /// @brief Method GetDataFromMessage, addr 0x26f0cfc, size 0x9c, virtual true, abstract: false, final false
