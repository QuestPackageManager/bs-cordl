...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithApplicationInviteList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithApplicationInviteList*, "Oculus.Platform", "MessageWithApplicationInviteList");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithApplicationInviteList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithApplicationInviteList(MessageWithApplicationInviteList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithApplicationInviteList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithApplicationInviteList(MessageWithApplicationInviteListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::MessageWithApplicationInviteList) == 0x30, "Size mismatch!");
