...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13410)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4578 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13219)) CS Name: ::Oculus.Platform::MessageWithNetSyncSetSessionPropertyResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271caf4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x271cb4c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetNetSyncSetSessionPropertyResult();

  /// @brief Method GetDataFromMessage, addr 0x271cb88, size 0x9c, virtual true, abstract: false, final false
