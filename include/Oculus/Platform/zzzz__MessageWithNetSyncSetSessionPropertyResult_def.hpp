...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4599 }), TypeDefinitionIndex(TypeDefinitionIndex(13462)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13309)) CS Name: ::Oculus.Platform::MessageWithNetSyncSetSessionPropertyResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x26f2d08, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x26f2d60, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetNetSyncSetSessionPropertyResult();

  /// @brief Method GetDataFromMessage, addr 0x26f2d9c, size 0x9c, virtual true, abstract: false, final false
