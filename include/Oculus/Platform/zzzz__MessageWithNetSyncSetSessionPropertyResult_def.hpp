...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13517)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4505 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13326)) CS Name: ::Oculus.Platform::MessageWithNetSyncSetSessionPropertyResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x259726c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult addr 0x25972c4 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetNetSyncSetSessionPropertyResult();

  /// @brief Method GetDataFromMessage addr 0x2597300 size 0x9c virtual true final false
