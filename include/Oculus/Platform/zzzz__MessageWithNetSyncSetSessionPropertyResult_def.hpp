...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult*, "Oculus.Platform", "MessageWithNetSyncSetSessionPropertyResult");
...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddc11c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x5ddc0d8, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ddc07c, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithNetSyncSetSessionPropertyResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageWithNetSyncSetSessionPropertyResult(MessageWithNetSyncSetSessionPropertyResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageWithNetSyncSetSessionPropertyResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageWithNetSyncSetSessionPropertyResult(MessageWithNetSyncSetSessionPropertyResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::MessageWithNetSyncSetSessionPropertyResult) == 0x30, "Size mismatch!");
