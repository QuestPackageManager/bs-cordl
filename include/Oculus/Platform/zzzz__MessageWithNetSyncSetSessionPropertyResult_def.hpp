...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd9ef4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x5dd9eb0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd9e54, size 0x5c, virtual false, abstract: false, final false
