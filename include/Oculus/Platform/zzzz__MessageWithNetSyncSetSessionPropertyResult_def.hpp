...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c96a4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x29c9668, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c9610, size 0x58, virtual false, abstract: false, final false
