...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2dc60, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x5c2dc1c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2dbc0, size 0x5c, virtual false, abstract: false, final false
