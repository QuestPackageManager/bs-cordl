...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4518 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13541))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13346)) CS Name: ::Oculus.Platform::MessageWithShareMediaResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593b8c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetShareMediaResult addr 0x25984ac size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetShareMediaResult();

  /// @brief Method GetDataFromMessage addr 0x25984e8 size 0x9c virtual true final false
