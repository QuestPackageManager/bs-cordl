...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13434)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4591 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13239)) CS Name: ::Oculus.Platform::MessageWithShareMediaResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2719414, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetShareMediaResult, addr 0x271dd34, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetShareMediaResult();

  /// @brief Method GetDataFromMessage, addr 0x271dd70, size 0x9c, virtual true, abstract: false, final false
