...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2ea94, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetShareMediaResult, addr 0x5c2ea50, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c29b0c, size 0x5c, virtual false, abstract: false, final false
