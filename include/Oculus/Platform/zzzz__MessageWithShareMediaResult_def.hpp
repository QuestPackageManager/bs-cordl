...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f8e064, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetShareMediaResult, addr 0x3f8e028, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f8a090, size 0x58, virtual false, abstract: false, final false
