...
public:
  ...
  /// @brief Method .ctor, addr 0x26ef870, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetShareMediaResult, addr 0x26f3a38, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ShareMediaResult* GetShareMediaResult();

  /// @brief Method GetDataFromMessage, addr 0x26f3a74, size 0x9c, virtual true, abstract: false, final false
