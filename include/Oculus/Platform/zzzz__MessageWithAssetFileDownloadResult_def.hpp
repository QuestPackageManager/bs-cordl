...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadResult, addr 0x3f794c8, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x3f79504, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f77098, size 0x58, virtual false, abstract: false, final false
