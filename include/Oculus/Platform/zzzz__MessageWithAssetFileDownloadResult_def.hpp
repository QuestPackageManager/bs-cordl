...
// Write type traits
MARK_REF_T(::Oculus::Platform::MessageWithAssetFileDownloadResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::MessageWithAssetFileDownloadResult*, "Oculus.Platform", "MessageWithAssetFileDownloadResult");
...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadResult, addr 0x5dda334, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x5dda378, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd727c, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageWithAssetFileDownloadResult", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Oculus::Platform::MessageWithAssetFileDownloadResult) == 0x30, "Size mismatch!");
