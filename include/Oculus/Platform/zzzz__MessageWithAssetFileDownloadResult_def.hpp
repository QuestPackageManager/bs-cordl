...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadResult, addr 0x29c9ad4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x29c9b10, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c75c4, size 0x58, virtual false, abstract: false, final false
