...
public:
// Declarations
/// @brief Method GetAssetFileDownloadResult, addr 0x5c9fee4, size 0x44, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult() ;

/// @brief Method GetDataFromMessage, addr 0x5c9ff28, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c9ce2c, size 0x5c, virtual false, abstract: false, final false
