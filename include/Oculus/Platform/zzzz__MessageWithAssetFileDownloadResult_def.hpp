...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadResult, addr 0x5bc5398, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadResult* GetAssetFileDownloadResult();

  /// @brief Method GetDataFromMessage, addr 0x5bc53dc, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc22e0, size 0x5c, virtual false, abstract: false, final false
