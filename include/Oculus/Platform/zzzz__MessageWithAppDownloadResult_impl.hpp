...
inline ::Oculus::Platform::Models::AppDownloadResult* Oculus::Platform::MessageWithAppDownloadResult::GetAppDownloadResult() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithAppDownloadResult*>::get(),
                                                                             "GetAppDownloadResult", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
...
inline ::Oculus::Platform::Models::AppDownloadResult* Oculus::Platform::MessageWithAppDownloadResult::GetDataFromMessage(void* c_message) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithAppDownloadResult*>::get(), "GetDataFromMessage",
