...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13471)), TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4482 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13294)) CS Name: ::Oculus.Platform::MessageWithCloudStorageConflictMetadata*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592cc4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetCloudStorageConflictMetadata addr 0x2595584 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::CloudStorageConflictMetadata* GetCloudStorageConflictMetadata();

  /// @brief Method GetDataFromMessage addr 0x25955c0 size 0x9c virtual true final false
