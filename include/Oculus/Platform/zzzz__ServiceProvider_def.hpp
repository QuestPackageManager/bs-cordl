...
DEFINE_IL2CPP_CLASS(::Oculus::Platform::ServiceProvider, "Oculus.Platform", "ServiceProvider");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
static_assert(sizeof(::Oculus::Platform::ServiceProvider) == 0x4, "Size mismatch!");
