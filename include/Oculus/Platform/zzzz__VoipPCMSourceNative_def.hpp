...
public:
  ...
  /// @brief Method GetPCM, addr 0x29dabe4, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method PeekSizeElements, addr 0x29dac9c, size 0x90, virtual true, abstract: false, final true
  inline int32_t PeekSizeElements();

  /// @brief Method SetSenderID, addr 0x29dac94, size 0x8, virtual true, abstract: false, final true
  inline void SetSenderID(uint64_t senderID);

  /// @brief Method Update, addr 0x29dad2c, size 0x4, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x29da0f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
