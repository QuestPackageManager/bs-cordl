...
/// @brief Method GetPCM, addr 0x5cb2dd0, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method PeekSizeElements, addr 0x5cb2e50, size 0x60, virtual true, abstract: false, final true
inline int32_t PeekSizeElements() ;

/// @brief Method SetSenderID, addr 0x5cb2e48, size 0x8, virtual true, abstract: false, final true
inline void SetSenderID(uint64_t  senderID) ;

/// @brief Method Update, addr 0x5cb2eb0, size 0x4, virtual true, abstract: false, final true
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5cb2348, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
