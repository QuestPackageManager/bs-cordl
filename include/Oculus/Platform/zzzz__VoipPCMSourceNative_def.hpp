...
public:
  ...
  /// @brief Method GetPCM, addr 0x5deaff8, size 0x78, virtual true, abstract: false, final true
  inline int32_t GetPCM(::ArrayW<float_t> dest, int32_t length);

  static inline ::Oculus::Platform::VoipPCMSourceNative* New_ctor();

  /// @brief Method PeekSizeElements, addr 0x5deb078, size 0x60, virtual true, abstract: false, final true
  inline int32_t PeekSizeElements();

  /// @brief Method SetSenderID, addr 0x5deb070, size 0x8, virtual true, abstract: false, final true
  inline void SetSenderID(uint64_t senderID);

  /// @brief Method Update, addr 0x5deb0d8, size 0x4, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dea570, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
