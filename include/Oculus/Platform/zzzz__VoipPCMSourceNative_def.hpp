...
// Write type traits
MARK_REF_T(::Oculus::Platform::VoipPCMSourceNative*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::VoipPCMSourceNative*, "Oculus.Platform", "VoipPCMSourceNative");
...
public:
  ...
  /// @brief Method GetPCM, addr 0x5ded220, size 0x78, virtual true, abstract: false, final true
  inline int32_t GetPCM(::ArrayW<float_t> dest, int32_t length);

  static inline ::Oculus::Platform::VoipPCMSourceNative* New_ctor();

  /// @brief Method PeekSizeElements, addr 0x5ded2a0, size 0x60, virtual true, abstract: false, final true
  inline int32_t PeekSizeElements();

  /// @brief Method SetSenderID, addr 0x5ded298, size 0x8, virtual true, abstract: false, final true
  inline void SetSenderID(uint64_t senderID);

  /// @brief Method Update, addr 0x5ded300, size 0x4, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dec798, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VoipPCMSourceNative", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VoipPCMSourceNative(VoipPCMSourceNative&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VoipPCMSourceNative", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VoipPCMSourceNative(VoipPCMSourceNativeconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::VoipPCMSourceNative) == 0x18, "Size mismatch!");
