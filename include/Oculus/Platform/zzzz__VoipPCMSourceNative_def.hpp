...
public:
  ...
  /// @brief Method GetPCM, addr 0x5c3ed64, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method PeekSizeElements, addr 0x5c3ede4, size 0x60, virtual true, abstract: false, final true
  inline int32_t PeekSizeElements();

  /// @brief Method SetSenderID, addr 0x5c3eddc, size 0x8, virtual true, abstract: false, final true
  inline void SetSenderID(uint64_t senderID);

  /// @brief Method Update, addr 0x5c3ee44, size 0x4, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5c3e2dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
