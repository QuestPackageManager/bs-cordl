...
public:
  ...
  /// @brief Method GetPCM addr 0x27022e0 size 0xb0 virtual true final true
  inline int32_t GetPCM(::ArrayW<float_t, ::Array<float_t>*> dest, int32_t length);

  /// @brief Method SetSenderID addr 0x2702390 size 0x8 virtual true final true
  inline void SetSenderID(uint64_t senderID);

  /// @brief Method PeekSizeElements addr 0x2702398 size 0x90 virtual true final true
  inline int32_t PeekSizeElements();

  /// @brief Method Update addr 0x2702428 size 0x4 virtual true final true
  inline void Update();

  static inline ::Oculus::Platform::VoipPCMSourceNative* New_ctor();

  /// @brief Method .ctor addr 0x27017f0 size 0x8 virtual false final false
  inline void _ctor();
