...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::AssetFileDownloadUpdate::*)(::System::IntPtr)>(&::Oculus::Platform::Models::AssetFileDownloadUpdate::_ctor)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x5deb9fc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::AssetFileDownloadUpdate*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* Oculus::Platform::Models::AssetFileDownloadUpdate::New_ctor(::System::IntPtr o) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::AssetFileDownloadUpdate*>(o));
}
// Ctor Parameters []
