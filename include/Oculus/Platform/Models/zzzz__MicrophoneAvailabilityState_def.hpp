...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::MicrophoneAvailabilityState*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::MicrophoneAvailabilityState*, "Oculus.Platform.Models", "MicrophoneAvailabilityState");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0de4, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MicrophoneAvailabilityState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MicrophoneAvailabilityState(MicrophoneAvailabilityState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MicrophoneAvailabilityState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MicrophoneAvailabilityState(MicrophoneAvailabilityStateconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::MicrophoneAvailabilityState) == 0x18, "Size mismatch!");
