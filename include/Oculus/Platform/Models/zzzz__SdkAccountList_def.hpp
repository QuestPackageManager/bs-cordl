...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2494, size 0x1dc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SdkAccountList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SdkAccountList(SdkAccountList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SdkAccountList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SdkAccountList(SdkAccountListconst&) = delete;
