...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::LeaderboardEntry::*)(::System::IntPtr)>(&::Oculus::Platform::Models::LeaderboardEntry::_ctor)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::LeaderboardEntry*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
constexpr void Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_set_DisplayScore(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___DisplayScore = value;
}
constexpr ::ArrayW<uint8_t>& Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_get_ExtraData() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ExtraData;
}
constexpr ::ArrayW<uint8_t> const& Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_get_ExtraData() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___ExtraData;
}
constexpr void Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_set_ExtraData(::ArrayW<uint8_t> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr void Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_set_SupplementaryMetricOptional(::Oculus::Platform::Models::SupplementaryMetric* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___SupplementaryMetricOptional = value;
}
...
constexpr void Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_set_SupplementaryMetric(::Oculus::Platform::Models::SupplementaryMetric* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___SupplementaryMetric = value;
}
...
inline ::Oculus::Platform::Models::LeaderboardEntry* Oculus::Platform::Models::LeaderboardEntry::New_ctor(::System::IntPtr o) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::LeaderboardEntry*>(o));
}
// Ctor Parameters []
