...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13369)), TypeDefinitionIndex(TypeDefinitionIndex(13441)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1167 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13442)) CS Name: ::Oculus.Platform.Models::UserAndRoomList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x273d808, size 0x25c, virtual false, abstract: false, final false
