...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2788, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SystemVoipState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SystemVoipState(SystemVoipState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SystemVoipState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SystemVoipState(SystemVoipStateconst&) = delete;
