...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13354)), TypeDefinitionIndex(TypeDefinitionIndex(13369)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1147 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13355)) CS Name: ::Oculus.Platform.Models::BlockedUserList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27372e8, size 0x25c, virtual false, abstract: false, final false
