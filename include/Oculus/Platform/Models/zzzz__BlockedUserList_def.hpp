...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1170 }), TypeDefinitionIndex(TypeDefinitionIndex(13424)),
// TypeDefinitionIndex(TypeDefinitionIndex(13430))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13425)) CS Name: ::Oculus.Platform.Models::BlockedUserList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2704d54 size 0x25c virtual false final false
