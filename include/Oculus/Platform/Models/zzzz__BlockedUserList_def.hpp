...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::BlockedUserList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::BlockedUserList*, "Oculus.Platform.Models", "BlockedUserList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dee318, size 0x1fc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BlockedUserList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BlockedUserList(BlockedUserList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BlockedUserList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BlockedUserList(BlockedUserListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::BlockedUserList) == 0x28, "Size mismatch!");
