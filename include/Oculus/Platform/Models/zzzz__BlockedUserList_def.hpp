...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13476)), TypeDefinitionIndex(TypeDefinitionIndex(13461)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13476), inst:
// 1144 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13462)) CS Name: ::Oculus.Platform.Models::BlockedUserList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b1a60 size 0x25c virtual false final false
