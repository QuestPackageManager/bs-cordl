...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13424)), TypeDefinitionIndex(TypeDefinitionIndex(13430)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst:
// 1170 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13425)) CS Name: ::Oculus.Platform.Models::BlockedUserList*
