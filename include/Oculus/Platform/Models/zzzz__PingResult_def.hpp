...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PingResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PingResult*, "Oculus.Platform.Models", "PingResult");
...
static_assert(sizeof(::Oculus::Platform::Models::PingResult) == 0x28, "Size mismatch!");
