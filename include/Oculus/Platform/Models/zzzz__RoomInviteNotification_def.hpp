...
public:
  ...
  __declspec(property(get = __get_SentTime, put = __set_SentTime))::System::DateTime SentTime;
  ...
  constexpr ::System::DateTime& __get_SentTime();

  constexpr ::System::DateTime const& __get_SentTime() const;
  ...
  /// @brief Method .ctor addr 0x25b75dc size 0xa8 virtual false final false
