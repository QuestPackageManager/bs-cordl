...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Purchase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Purchase(Purchase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Purchase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Purchase(Purchaseconst&) = delete;
