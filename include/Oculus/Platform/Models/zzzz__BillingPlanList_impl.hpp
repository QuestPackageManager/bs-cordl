...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::BillingPlanList::*)(::System::IntPtr)>(
    &::Oculus::Platform::Models::BillingPlanList::_ctor)> {
  constexpr static std::size_t size = 0x1dc;
  constexpr static std::size_t addrs = 0x5c3fc10;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::BillingPlanList*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
inline ::Oculus::Platform::Models::BillingPlanList* Oculus::Platform::Models::BillingPlanList::New_ctor(::System::IntPtr a) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Oculus::Platform::Models::BillingPlanList*>(a));
}
// Ctor Parameters []
