...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::HttpTransferUpdate*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::HttpTransferUpdate*, "Oculus.Platform.Models", "HttpTransferUpdate");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5def9b4, size 0x128, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HttpTransferUpdate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HttpTransferUpdate(HttpTransferUpdate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HttpTransferUpdate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HttpTransferUpdate(HttpTransferUpdateconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::HttpTransferUpdate) == 0x28, "Size mismatch!");
