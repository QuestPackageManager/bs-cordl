...
public:
  ...
  __declspec(property(get = __get_AdminSnapshotOptional, put = __set_AdminSnapshotOptional))::Oculus::Platform::Models::MatchmakingAdminSnapshot* AdminSnapshotOptional;

  /// @brief Field AdminSnapshot, offset 0x18, size 0x8
  __declspec(property(get = __get_AdminSnapshot, put = __set_AdminSnapshot))::Oculus::Platform::Models::MatchmakingAdminSnapshot* AdminSnapshot;

  /// @brief Field AverageWait, offset 0x20, size 0x4
  __declspec(property(get = __get_AverageWait, put = __set_AverageWait)) uint32_t AverageWait;

  /// @brief Field MatchesInLastHourCount, offset 0x24, size 0x4
  __declspec(property(get = __get_MatchesInLastHourCount, put = __set_MatchesInLastHourCount)) uint32_t MatchesInLastHourCount;

  /// @brief Field MaxExpectedWait, offset 0x28, size 0x4
  __declspec(property(get = __get_MaxExpectedWait, put = __set_MaxExpectedWait)) uint32_t MaxExpectedWait;

  /// @brief Field Pool, offset 0x30, size 0x8
  __declspec(property(get = __get_Pool, put = __set_Pool))::StringW Pool;

  /// @brief Field RecentMatchPercentage, offset 0x38, size 0x4
  __declspec(property(get = __get_RecentMatchPercentage, put = __set_RecentMatchPercentage)) uint32_t RecentMatchPercentage;

  /// @brief Field RequestHash, offset 0x40, size 0x8
  __declspec(property(get = __get_RequestHash, put = __set_RequestHash))::StringW RequestHash;

  constexpr ::Oculus::Platform::Models::MatchmakingAdminSnapshot*& __get_AdminSnapshotOptional();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingAdminSnapshot*> const& __get_AdminSnapshotOptional() const;

  constexpr void __set_AdminSnapshotOptional(::Oculus::Platform::Models::MatchmakingAdminSnapshot* value);

  constexpr ::Oculus::Platform::Models::MatchmakingAdminSnapshot*& __get_AdminSnapshot();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingAdminSnapshot*> const& __get_AdminSnapshot() const;

  constexpr void __set_AdminSnapshot(::Oculus::Platform::Models::MatchmakingAdminSnapshot* value);

  constexpr uint32_t& __get_AverageWait();

  constexpr uint32_t const& __get_AverageWait() const;

  constexpr void __set_AverageWait(uint32_t value);

  constexpr uint32_t& __get_MatchesInLastHourCount();

  constexpr uint32_t const& __get_MatchesInLastHourCount() const;

  constexpr void __set_MatchesInLastHourCount(uint32_t value);

  constexpr uint32_t& __get_MaxExpectedWait();

  constexpr uint32_t const& __get_MaxExpectedWait() const;

  constexpr void __set_MaxExpectedWait(uint32_t value);

  constexpr ::StringW& __get_Pool();

  constexpr ::StringW const& __get_Pool() const;

  constexpr void __set_Pool(::StringW value);

  constexpr uint32_t& __get_RecentMatchPercentage();

  constexpr uint32_t const& __get_RecentMatchPercentage() const;

  constexpr void __set_RecentMatchPercentage(uint32_t value);

  constexpr ::StringW& __get_RequestHash();

  constexpr ::StringW const& __get_RequestHash() const;
  ...
  /// @brief Method .ctor addr 0x25b4f74 size 0x168 virtual false final false
