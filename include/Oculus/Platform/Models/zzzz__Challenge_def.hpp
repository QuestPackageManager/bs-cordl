...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13243)), TypeDefinitionIndex(TypeDefinitionIndex(2368)), TypeDefinitionIndex(TypeDefinitionIndex(2611)),
// TypeDefinitionIndex(TypeDefinitionIndex(13246))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13467)) CS Name: ::Oculus.Platform.Models::Challenge*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b2090 size 0x228 virtual false final false
