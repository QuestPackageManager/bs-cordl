...
template <typename T> inline void Oculus::Platform::Models::DeserializableList_1<T>::set_Item(int32_t index, T value) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::DeserializableList_1<T>*>::get(), "set_Item", std::vector<Il2CppClass*>{},
...
template <typename T> inline void Oculus::Platform::Models::DeserializableList_1<T>::Add(T item) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::DeserializableList_1<T>*>::get(), "Add", std::vector<Il2CppClass*>{},
...
template <typename T> inline void Oculus::Platform::Models::DeserializableList_1<T>::CopyTo(::ArrayW<T, ::Array<T>*> array, int32_t arrayIndex) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::DeserializableList_1<T>*>::get(), "CopyTo", std::vector<Il2CppClass*>{},
...
template <typename T> inline void Oculus::Platform::Models::DeserializableList_1<T>::Insert(int32_t index, T item) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::DeserializableList_1<T>*>::get(), "Insert", std::vector<Il2CppClass*>{},
      ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T>::get() })));
...
template <typename T> inline ::System::Collections::IEnumerator* Oculus::Platform::Models::DeserializableList_1<T>::GetEnumerator1() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::DeserializableList_1<T>*>::get(),
                                                                             "GetEnumerator1", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
...
template <typename T> inline ::Oculus::Platform::Models::DeserializableList_1<T>* Oculus::Platform::Models::DeserializableList_1<T>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::DeserializableList_1<T>*>());
}
