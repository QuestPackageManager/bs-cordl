...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::RejoinDialogResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::RejoinDialogResult*, "Oculus.Platform.Models", "RejoinDialogResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df23a0, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RejoinDialogResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RejoinDialogResult(RejoinDialogResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RejoinDialogResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RejoinDialogResult(RejoinDialogResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::RejoinDialogResult) == 0x18, "Size mismatch!");
