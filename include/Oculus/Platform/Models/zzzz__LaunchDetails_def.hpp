...
public:
  ...
  /// @brief Method .ctor, addr 0x5c41a38, size 0x11c, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Oculus::Platform::Models::LaunchDetails, 0x58>, "Size mismatch!");
