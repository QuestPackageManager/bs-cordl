...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LaunchDetails", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LaunchDetails(LaunchDetails&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LaunchDetails", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LaunchDetails(LaunchDetailsconst&) = delete;
