...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::*)(void*)>(
  ...
  constexpr static std::size_t addrs = 0x25b567c;
...
constexpr ::Oculus::Platform::Models::MatchmakingEnqueueResult*& Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::__get_MatchmakingEnqueueResult() {
...
Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::__get_MatchmakingEnqueueResult() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MatchmakingEnqueueResult;
}
...
constexpr ::Oculus::Platform::Models::Room*& Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::__get_Room() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Room;
}
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::Room*> const& Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::__get_Room() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Room;
}
...
inline ::Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom* Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom::New_ctor(void* o) {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom*>(o));
}
