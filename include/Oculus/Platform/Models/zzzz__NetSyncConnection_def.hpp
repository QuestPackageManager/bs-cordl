...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0e58, size 0xb0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetSyncConnection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetSyncConnection(NetSyncConnection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetSyncConnection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetSyncConnection(NetSyncConnectionconst&) = delete;
