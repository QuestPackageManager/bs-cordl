...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13140))]
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Counter, put = __cordl_internal_set_Counter)) int64_t Counter;
  ...
  __declspec(property(get = __cordl_internal_get_SaveTime, put = __cordl_internal_set_SaveTime)) uint64_t SaveTime;

  /// @brief Field Status, offset 0x40, size 0x4
  __declspec(property(get = __cordl_internal_get_Status, put = __cordl_internal_set_Status))::Oculus::Platform::CloudStorageDataStatus Status;
  ...
  constexpr int64_t& __cordl_internal_get_Counter();

  constexpr int64_t const& __cordl_internal_get_Counter() const;

  constexpr void __cordl_internal_set_Counter(int64_t value);
  ...
  constexpr uint64_t& __cordl_internal_get_SaveTime();

  constexpr uint64_t const& __cordl_internal_get_SaveTime() const;

  constexpr void __cordl_internal_set_SaveTime(uint64_t value);

  constexpr ::Oculus::Platform::CloudStorageDataStatus& __cordl_internal_get_Status();

  constexpr ::Oculus::Platform::CloudStorageDataStatus const& __cordl_internal_get_Status() const;

  constexpr void __cordl_internal_set_Status(::Oculus::Platform::CloudStorageDataStatus value);
  ...
  /// @brief Method .ctor, addr 0x27385ac, size 0xe8, virtual false, abstract: false, final false
