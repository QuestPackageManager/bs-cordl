...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::Team::*)(void*)>(&::Oculus::Platform::Models::Team::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25b7d54;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::Team*>::get(), ".ctor", std::vector<Il2CppClass*>{},
                                                 ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<void*>::get() })));
    return ___internal_method;
  }
};
constexpr ::Oculus::Platform::Models::UserList*& Oculus::Platform::Models::Team::__get_AssignedUsers() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___AssignedUsers;
}
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::UserList*> const& Oculus::Platform::Models::Team::__get_AssignedUsers() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___AssignedUsers;
}
...
constexpr int32_t& Oculus::Platform::Models::Team::__get_MaxUsers() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MaxUsers;
}
constexpr int32_t const& Oculus::Platform::Models::Team::__get_MaxUsers() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MaxUsers;
}
...
constexpr int32_t& Oculus::Platform::Models::Team::__get_MinUsers() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MinUsers;
}
constexpr int32_t const& Oculus::Platform::Models::Team::__get_MinUsers() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MinUsers;
}
...
constexpr ::StringW& Oculus::Platform::Models::Team::__get_Name() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Name;
}
constexpr ::StringW const& Oculus::Platform::Models::Team::__get_Name() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Name;
}
...
inline ::Oculus::Platform::Models::Team* Oculus::Platform::Models::Team::New_ctor(void* o) {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::Team*>(o));
}
