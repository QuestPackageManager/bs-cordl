...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AchievementProgress*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AchievementProgress*, "Oculus.Platform.Models", "AchievementProgress");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AchievementProgress", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AchievementProgress(AchievementProgress&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AchievementProgress", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AchievementProgress(AchievementProgressconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AchievementProgress) == 0x38, "Size mismatch!");
