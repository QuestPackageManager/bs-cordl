...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0ce4, size 0x100, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ManagedInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ManagedInfo(ManagedInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ManagedInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ManagedInfo(ManagedInfoconst&) = delete;
