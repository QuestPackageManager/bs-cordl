...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserAccountAgeCategory*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserAccountAgeCategory*, "Oculus.Platform.Models", "UserAccountAgeCategory");
// Dependencies Oculus.Platform.AccountAgeCategory, System.Object
namespace Oculus::Platform::Models {
// Is value type: false
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df28dc, size 0x70, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::UserAccountAgeCategory) == 0x18, "Size mismatch!");
