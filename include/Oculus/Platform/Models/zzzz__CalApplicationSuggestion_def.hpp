...
public:
  ...
  __declspec(property(get = __cordl_internal_get_SocialContext, put = __cordl_internal_set_SocialContext))::StringW SocialContext;
  ...
  constexpr ::StringW& __cordl_internal_get_SocialContext();

  constexpr ::StringW const& __cordl_internal_get_SocialContext() const;

  constexpr void __cordl_internal_set_SocialContext(::StringW value);

  static inline ::Oculus::Platform::Models::CalApplicationSuggestion* New_ctor(void* o);

  /// @brief Method .ctor, addr 0x2737654, size 0x88, virtual false, abstract: false, final false
