...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::MatchmakingBrowseResult::*)(void*)>(
  ...
  constexpr static std::size_t addrs = 0x25b4e80;
...
constexpr ::Oculus::Platform::Models::MatchmakingEnqueueResult*& Oculus::Platform::Models::MatchmakingBrowseResult::__get_EnqueueResult() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___EnqueueResult;
}
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingEnqueueResult*> const& Oculus::Platform::Models::MatchmakingBrowseResult::__get_EnqueueResult() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___EnqueueResult;
}
...
constexpr ::Oculus::Platform::Models::RoomList*& Oculus::Platform::Models::MatchmakingBrowseResult::__get_Rooms() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Rooms;
}
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::RoomList*> const& Oculus::Platform::Models::MatchmakingBrowseResult::__get_Rooms() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___Rooms;
}
...
inline ::Oculus::Platform::Models::MatchmakingBrowseResult* Oculus::Platform::Models::MatchmakingBrowseResult::New_ctor(void* o) {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::MatchmakingBrowseResult*>(o));
}
