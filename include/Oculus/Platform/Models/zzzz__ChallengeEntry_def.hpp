...
public:
  ...
  /// @brief Method .ctor, addr 0x5deebd0, size 0x104, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChallengeEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChallengeEntry(ChallengeEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChallengeEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChallengeEntry(ChallengeEntryconst&) = delete;
