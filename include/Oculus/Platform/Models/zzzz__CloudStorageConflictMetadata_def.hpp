...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Local, put = __cordl_internal_set_Local))::Oculus::Platform::Models::CloudStorageMetadata* Local;

  /// @brief Field Remote, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_Remote, put = __cordl_internal_set_Remote))::Oculus::Platform::Models::CloudStorageMetadata* Remote;

  constexpr ::Oculus::Platform::Models::CloudStorageMetadata*& __cordl_internal_get_Local();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::CloudStorageMetadata*> const& __cordl_internal_get_Local() const;

  constexpr void __cordl_internal_set_Local(::Oculus::Platform::Models::CloudStorageMetadata* value);

  constexpr ::Oculus::Platform::Models::CloudStorageMetadata*& __cordl_internal_get_Remote();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::CloudStorageMetadata*> const& __cordl_internal_get_Remote() const;

  constexpr void __cordl_internal_set_Remote(::Oculus::Platform::Models::CloudStorageMetadata* value);

  static inline ::Oculus::Platform::Models::CloudStorageConflictMetadata* New_ctor(void* o);

  /// @brief Method .ctor, addr 0x27384cc, size 0xe0, virtual false, abstract: false, final false
