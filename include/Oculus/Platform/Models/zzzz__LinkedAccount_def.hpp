...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LinkedAccount*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LinkedAccount*, "Oculus.Platform.Models", "LinkedAccount");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0844, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinkedAccount", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinkedAccount(LinkedAccount&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinkedAccount", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinkedAccount(LinkedAccountconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::LinkedAccount) == 0x28, "Size mismatch!");
