...
public:
  ...
  /// @brief Method .ctor, addr 0x5defd68, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvitePanelResultInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvitePanelResultInfo(InvitePanelResultInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvitePanelResultInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvitePanelResultInfo(InvitePanelResultInfoconst&) = delete;
