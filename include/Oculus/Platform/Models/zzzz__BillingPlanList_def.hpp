...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BillingPlanList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BillingPlanList(BillingPlanList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BillingPlanList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BillingPlanList(BillingPlanListconst&) = delete;
