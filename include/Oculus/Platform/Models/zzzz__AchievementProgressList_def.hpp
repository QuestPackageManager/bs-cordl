...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1167 }), TypeDefinitionIndex(TypeDefinitionIndex(13409)),
// TypeDefinitionIndex(TypeDefinitionIndex(13430))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13410)) CS Name: ::Oculus.Platform.Models::AchievementProgressList*
