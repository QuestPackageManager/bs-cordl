...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9464, size 0x1f0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AchievementProgressList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AchievementProgressList(AchievementProgressList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AchievementProgressList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AchievementProgressList(AchievementProgressListconst&) = delete;
