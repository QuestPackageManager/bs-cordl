...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13448)), TypeDefinitionIndex(TypeDefinitionIndex(13476)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13476), inst:
// 1141 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13449)) CS Name: ::Oculus.Platform.Models::AchievementProgressList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b092c size 0x25c virtual false final false
