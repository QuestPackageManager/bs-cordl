...
public:
  ...
  /// @brief Method .ctor, addr 0x5def060, size 0x1d8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContentRating", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContentRating(ContentRating&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContentRating", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContentRating(ContentRatingconst&) = delete;
