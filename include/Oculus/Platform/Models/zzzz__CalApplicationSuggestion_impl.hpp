...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::CalApplicationSuggestion::*)(void*)>(
  ...
  constexpr static std::size_t addrs = 0x2737654;
...
constexpr uint64_t& Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_get__cordl_ID() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____cordl_ID;
}
constexpr uint64_t const& Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_get__cordl_ID() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____cordl_ID;
}
constexpr void Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_set__cordl_ID(uint64_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____cordl_ID = value;
}
constexpr ::StringW& Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_get_SocialContext() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___SocialContext;
}
constexpr ::StringW const& Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_get_SocialContext() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___SocialContext;
}
constexpr void Oculus::Platform::Models::CalApplicationSuggestion::__cordl_internal_set_SocialContext(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::Oculus::Platform::Models::CalApplicationSuggestion* Oculus::Platform::Models::CalApplicationSuggestion::New_ctor(void* o) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Oculus::Platform::Models::CalApplicationSuggestion*>(o));
}
