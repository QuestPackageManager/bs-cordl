...
#include <cstdint>
CORDL_MODULE_EXPORT(CalApplicationProposed)
// Forward declare root types
namespace Oculus::Platform::Models {
class CalApplicationProposed;
}
// Write type traits
MARK_REF_PTR_T(::Oculus::Platform::Models::CalApplicationProposed);
...
class CORDL_TYPE CalApplicationProposed : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Oculus::Platform::Models::CalApplicationProposed* New_ctor(void* o);

  /// @brief Method .ctor, addr 0x27375dc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(void* o);

  // Ctor Parameters [CppParam { name: "", ty: "CalApplicationProposed", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CalApplicationProposed(CalApplicationProposed&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CalApplicationProposed", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CalApplicationProposed(CalApplicationProposed const&) = delete;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr CalApplicationProposed();
...
static_assert(::cordl_internals::size_check_v<::Oculus::Platform::Models::CalApplicationProposed, 0x18>, "Size mismatch!");

static_assert(offsetof(::Oculus::Platform::Models::CalApplicationProposed, ____cordl_ID) == 0x10, "Offset mismatch!");
