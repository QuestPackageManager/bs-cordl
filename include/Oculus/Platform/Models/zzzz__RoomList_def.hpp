...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13369)), TypeDefinitionIndex(TypeDefinitionIndex(13427)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 980 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13428)) CS Name: ::Oculus.Platform.Models::RoomList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x273a964, size 0x25c, virtual false, abstract: false, final false
