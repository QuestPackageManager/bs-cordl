...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LivestreamingVideoStats*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LivestreamingVideoStats*, "Oculus.Platform.Models", "LivestreamingVideoStats");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0c54, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingVideoStats", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LivestreamingVideoStats(LivestreamingVideoStats&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingVideoStats", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LivestreamingVideoStats(LivestreamingVideoStatsconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::LivestreamingVideoStats) == 0x20, "Size mismatch!");
