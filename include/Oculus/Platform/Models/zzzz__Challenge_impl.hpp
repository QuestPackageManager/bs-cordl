...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::Challenge::*)(::System::IntPtr)>(&::Oculus::Platform::Models::Challenge::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5dec2ec;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::Challenge*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
constexpr void Oculus::Platform::Models::Challenge::__cordl_internal_set_ParticipantsOptional(::Oculus::Platform::Models::UserList* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___ParticipantsOptional = value;
}
...
inline ::Oculus::Platform::Models::Challenge* Oculus::Platform::Models::Challenge::New_ctor(::System::IntPtr o) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::Challenge*>(o));
}
// Ctor Parameters []
