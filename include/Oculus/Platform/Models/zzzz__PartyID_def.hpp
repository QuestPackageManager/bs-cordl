...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PartyID*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PartyID*, "Oculus.Platform.Models", "PartyID");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df17b8, size 0x70, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PartyID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PartyID(PartyID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PartyID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PartyID(PartyIDconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::PartyID) == 0x18, "Size mismatch!");
