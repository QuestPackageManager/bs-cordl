...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ApplicationInvite*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ApplicationInvite*, "Oculus.Platform.Models", "ApplicationInvite");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5ded73c, size 0x140, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::ApplicationInvite) == 0x50, "Size mismatch!");
