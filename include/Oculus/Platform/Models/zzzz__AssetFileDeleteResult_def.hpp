...
public:
  ...
  /// @brief Method .ctor, addr 0x5deda5c, size 0xa4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDeleteResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetFileDeleteResult(AssetFileDeleteResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDeleteResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetFileDeleteResult(AssetFileDeleteResultconst&) = delete;
