...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::ManagedInfo::*)(::System::IntPtr)>(
    &::Oculus::Platform::Models::ManagedInfo::_ctor)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0x5c42828;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::ManagedInfo*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
constexpr void Oculus::Platform::Models::ManagedInfo::__cordl_internal_set_Department(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___Department)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr void Oculus::Platform::Models::ManagedInfo::__cordl_internal_set_EmployeeNumber(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___EmployeeNumber)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr void Oculus::Platform::Models::ManagedInfo::__cordl_internal_set_OrganizationId(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___OrganizationId)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
inline ::Oculus::Platform::Models::ManagedInfo* Oculus::Platform::Models::ManagedInfo::New_ctor(::System::IntPtr o) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Oculus::Platform::Models::ManagedInfo*>(o));
}
// Ctor Parameters []
