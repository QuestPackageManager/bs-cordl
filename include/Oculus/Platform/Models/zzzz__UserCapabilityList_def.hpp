...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserCapabilityList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserCapabilityList*, "Oculus.Platform.Models", "UserCapabilityList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df29f0, size 0x1fc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserCapabilityList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserCapabilityList(UserCapabilityList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserCapabilityList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserCapabilityList(UserCapabilityListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::UserCapabilityList) == 0x28, "Size mismatch!");
