...
public:
  ...
  /// @brief Method .ctor, addr 0x5df1828, size 0xd0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PartyUpdateNotification", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PartyUpdateNotification(PartyUpdateNotification&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PartyUpdateNotification", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PartyUpdateNotification(PartyUpdateNotificationconst&) = delete;
