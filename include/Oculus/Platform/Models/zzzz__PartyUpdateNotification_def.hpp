...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13265))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x273c084, size 0xd8, virtual false, abstract: false, final false
