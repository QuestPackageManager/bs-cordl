...
public:
  ...
  /// @brief Method .ctor, addr 0x5defe6c, size 0x88, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LaunchBlockFlowResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LaunchBlockFlowResult(LaunchBlockFlowResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LaunchBlockFlowResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LaunchBlockFlowResult(LaunchBlockFlowResultconst&) = delete;
