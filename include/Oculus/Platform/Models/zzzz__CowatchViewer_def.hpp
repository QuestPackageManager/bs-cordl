...
public:
  ...
  /// @brief Method .ctor, addr 0x5def2ac, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CowatchViewer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CowatchViewer(CowatchViewer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CowatchViewer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CowatchViewer(CowatchViewerconst&) = delete;
