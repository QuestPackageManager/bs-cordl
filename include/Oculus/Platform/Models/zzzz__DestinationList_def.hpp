...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1173 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
...
public:
  ...
  /// @brief Method .ctor, addr 0x2705b64, size 0x25c, virtual false, abstract: false, final false
