...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13430)), TypeDefinitionIndex(TypeDefinitionIndex(13459)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst:
// 1178 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13460)) CS Name: ::Oculus.Platform.Models::NetSyncSessionList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2707654, size 0x23c, virtual false, abstract: false, final false
