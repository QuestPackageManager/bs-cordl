...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LivestreamingStartResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LivestreamingStartResult*, "Oculus.Platform.Models", "LivestreamingStartResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0b24, size 0x70, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingStartResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LivestreamingStartResult(LivestreamingStartResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingStartResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LivestreamingStartResult(LivestreamingStartResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::LivestreamingStartResult) == 0x18, "Size mismatch!");
