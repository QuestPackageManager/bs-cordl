...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AvatarEditorResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AvatarEditorResult*, "Oculus.Platform.Models", "AvatarEditorResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedcd8, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarEditorResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarEditorResult(AvatarEditorResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarEditorResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarEditorResult(AvatarEditorResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AvatarEditorResult) == 0x18, "Size mismatch!");
