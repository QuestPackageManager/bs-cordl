...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LeaderboardEntry*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LeaderboardEntry*, "Oculus.Platform.Models", "LeaderboardEntry");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_ExtraData, put = __cordl_internal_set_ExtraData)) ::ArrayW<uint8_t> ExtraData;
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_ExtraData() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_ExtraData();
  ...
  constexpr void __cordl_internal_set_ExtraData(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_Rank(int32_t value);

  constexpr void __cordl_internal_set_Score(int64_t value);

  constexpr void __cordl_internal_set_SupplementaryMetric(::Oculus::Platform::Models::SupplementaryMetric* value);

  constexpr void __cordl_internal_set_SupplementaryMetricOptional(::Oculus::Platform::Models::SupplementaryMetric* value);
  ...
  /// @brief Method .ctor, addr 0x5df0444, size 0x164, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LeaderboardEntry) == 0x58, "Size mismatch!");
