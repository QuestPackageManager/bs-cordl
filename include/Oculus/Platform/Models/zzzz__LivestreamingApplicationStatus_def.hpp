...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingApplicationStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LivestreamingApplicationStatus(LivestreamingApplicationStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LivestreamingApplicationStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LivestreamingApplicationStatus(LivestreamingApplicationStatusconst&) = delete;
