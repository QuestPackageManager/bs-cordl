...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2bec, size 0x74, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserDataStoreUpdateResponse", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserDataStoreUpdateResponse(UserDataStoreUpdateResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserDataStoreUpdateResponse", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserDataStoreUpdateResponse(UserDataStoreUpdateResponseconst&) = delete;
