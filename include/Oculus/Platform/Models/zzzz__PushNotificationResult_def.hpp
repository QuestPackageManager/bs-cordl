...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::PushNotificationResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::PushNotificationResult*, "Oculus.Platform.Models", "PushNotificationResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2330, size 0x70, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PushNotificationResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PushNotificationResult(PushNotificationResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PushNotificationResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PushNotificationResult(PushNotificationResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::PushNotificationResult) == 0x18, "Size mismatch!");
