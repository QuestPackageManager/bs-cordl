...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::Purchase::*)(void*)>(&::Oculus::Platform::Models::Purchase::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25b7000;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::Purchase*>::get(), ".ctor", std::vector<Il2CppClass*>{},
