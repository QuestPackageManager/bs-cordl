...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::NetworkingPeer::*)(uint64_t, ::Oculus::Platform::PeerConnectionState)>(
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::NetworkingPeer*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint64_t (::Oculus::Platform::Models::NetworkingPeer::*)()>(&::Oculus::Platform::Models::NetworkingPeer::get_ID)> {
  ...
  constexpr static std::size_t addrs = 0x25b6478;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::NetworkingPeer::*)(uint64_t)>(
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::NetworkingPeer*>::get(), "set_ID", std::vector<Il2CppClass*>{},
                                                 ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<uint64_t>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::PeerConnectionState (::Oculus::Platform::Models::NetworkingPeer::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x25b6488;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::NetworkingPeer::*)(::Oculus::Platform::PeerConnectionState)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x25b6490;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::NetworkingPeer*>::get(), "set_State", std::vector<Il2CppClass*>{},
                                                 ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Oculus::Platform::PeerConnectionState>::get() })));
    return ___internal_method;
  }
};
constexpr uint64_t& Oculus::Platform::Models::NetworkingPeer::__get__ID_k__BackingField() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____ID_k__BackingField;
}
constexpr uint64_t const& Oculus::Platform::Models::NetworkingPeer::__get__ID_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____ID_k__BackingField;
}
...
constexpr ::Oculus::Platform::PeerConnectionState& Oculus::Platform::Models::NetworkingPeer::__get__State_k__BackingField() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____State_k__BackingField;
}
constexpr ::Oculus::Platform::PeerConnectionState const& Oculus::Platform::Models::NetworkingPeer::__get__State_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____State_k__BackingField;
}
...
inline ::Oculus::Platform::Models::NetworkingPeer* Oculus::Platform::Models::NetworkingPeer::New_ctor(uint64_t id, ::Oculus::Platform::PeerConnectionState state) {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::NetworkingPeer*>(id, state));
}
