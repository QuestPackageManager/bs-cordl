...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::BillingPlan*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::BillingPlan*, "Oculus.Platform.Models", "BillingPlan");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedd4c, size 0xf0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::BillingPlan) == 0x28, "Size mismatch!");
