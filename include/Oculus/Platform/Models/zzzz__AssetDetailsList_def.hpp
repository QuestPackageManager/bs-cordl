...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1169 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
// TypeDefinitionIndex(TypeDefinitionIndex(13417))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13418)) CS Name: ::Oculus.Platform.Models::AssetDetailsList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2704788 size 0x23c virtual false final false
