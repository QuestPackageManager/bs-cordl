...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13430)), TypeDefinitionIndex(TypeDefinitionIndex(13469)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst:
...
public:
  ...
  /// @brief Method .ctor, addr 0x27080f8, size 0x23c, virtual false, abstract: false, final false
