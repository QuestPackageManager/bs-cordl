...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LaunchReportFlowResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LaunchReportFlowResult*, "Oculus.Platform.Models", "LaunchReportFlowResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedf14, size 0x84, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::LaunchReportFlowResult) == 0x20, "Size mismatch!");
