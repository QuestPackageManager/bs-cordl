...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Party*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Party*, "Oculus.Platform.Models", "Party");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df164c, size 0x16c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Party) == 0x48, "Size mismatch!");
