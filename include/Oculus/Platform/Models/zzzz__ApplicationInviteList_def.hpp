...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13414)), TypeDefinitionIndex(TypeDefinitionIndex(13430)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst:
// 1168 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13415)) CS Name: ::Oculus.Platform.Models::ApplicationInviteList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2704264, size 0x25c, virtual false, abstract: false, final false
