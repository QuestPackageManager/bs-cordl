...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13344)), TypeDefinitionIndex(TypeDefinitionIndex(13369)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1145 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13345)) CS Name: ::Oculus.Platform.Models::ApplicationInviteList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2736818, size 0x25c, virtual false, abstract: false, final false
