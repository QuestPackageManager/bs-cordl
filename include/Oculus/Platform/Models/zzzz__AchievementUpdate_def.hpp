...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9730, size 0x7c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AchievementUpdate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AchievementUpdate(AchievementUpdate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AchievementUpdate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AchievementUpdate(AchievementUpdateconst&) = delete;
