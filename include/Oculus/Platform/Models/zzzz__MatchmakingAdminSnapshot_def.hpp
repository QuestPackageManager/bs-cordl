...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Candidates, put = __cordl_internal_set_Candidates))::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidateList* Candidates;

  /// @brief Field MyCurrentThreshold, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_MyCurrentThreshold, put = __cordl_internal_set_MyCurrentThreshold)) double_t MyCurrentThreshold;

  constexpr ::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidateList*& __cordl_internal_get_Candidates();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidateList*> const& __cordl_internal_get_Candidates() const;

  constexpr void __cordl_internal_set_Candidates(::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidateList* value);

  constexpr double_t& __cordl_internal_get_MyCurrentThreshold();

  constexpr double_t const& __cordl_internal_get_MyCurrentThreshold() const;

  constexpr void __cordl_internal_set_MyCurrentThreshold(double_t value);

  static inline ::Oculus::Platform::Models::MatchmakingAdminSnapshot* New_ctor(void* o);

  /// @brief Method .ctor, addr 0x273a350, size 0xc0, virtual false, abstract: false, final false
