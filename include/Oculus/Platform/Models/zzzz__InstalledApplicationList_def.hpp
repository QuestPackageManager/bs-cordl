...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1174 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
// TypeDefinitionIndex(TypeDefinitionIndex(13437))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13438)) CS Name: ::Oculus.Platform.Models::InstalledApplicationList*
