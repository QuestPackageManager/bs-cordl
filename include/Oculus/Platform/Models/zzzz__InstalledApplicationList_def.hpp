...
public:
  ...
  /// @brief Method .ctor, addr 0x5defb8c, size 0x1dc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InstalledApplicationList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InstalledApplicationList(InstalledApplicationList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InstalledApplicationList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InstalledApplicationList(InstalledApplicationListconst&) = delete;
