...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadUpdate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetFileDownloadUpdate(AssetFileDownloadUpdate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadUpdate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetFileDownloadUpdate(AssetFileDownloadUpdateconst&) = delete;
