...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AchievementDefinitionList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AchievementDefinitionList*, "Oculus.Platform.Models", "AchievementDefinitionList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9198, size 0x1f0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AchievementDefinitionList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AchievementDefinitionList(AchievementDefinitionList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AchievementDefinitionList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AchievementDefinitionList(AchievementDefinitionListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AchievementDefinitionList) == 0x28, "Size mismatch!");
