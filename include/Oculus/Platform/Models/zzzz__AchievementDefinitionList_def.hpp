...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13446)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13476), inst: 1140 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13476))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13447)) CS Name: ::Oculus.Platform.Models::AchievementDefinitionList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b0614 size 0x25c virtual false final false
