...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13360)), TypeDefinitionIndex(TypeDefinitionIndex(13369)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1149 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13361)) CS Name: ::Oculus.Platform.Models::ChallengeList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2737ec4, size 0x27c, virtual false, abstract: false, final false
