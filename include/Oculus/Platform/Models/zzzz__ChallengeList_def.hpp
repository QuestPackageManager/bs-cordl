...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13426)), TypeDefinitionIndex(TypeDefinitionIndex(13430)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst:
// 1171 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13427)) CS Name: ::Oculus.Platform.Models::ChallengeList*
