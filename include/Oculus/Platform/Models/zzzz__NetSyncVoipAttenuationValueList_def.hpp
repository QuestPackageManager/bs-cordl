...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13369)), TypeDefinitionIndex(TypeDefinitionIndex(13411)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1160 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13412)) CS Name: ::Oculus.Platform.Models::NetSyncVoipAttenuationValueList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x273ba94, size 0x23c, virtual false, abstract: false, final false
