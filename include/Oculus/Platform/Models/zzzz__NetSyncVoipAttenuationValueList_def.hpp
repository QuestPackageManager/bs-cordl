...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1179 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
...
public:
  ...
  /// @brief Method .ctor, addr 0x2707a88, size 0x23c, virtual false, abstract: false, final false
