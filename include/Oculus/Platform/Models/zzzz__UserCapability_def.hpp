...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::UserCapability*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::UserCapability*, "Oculus.Platform.Models", "UserCapability");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df294c, size 0xa4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserCapability", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserCapability(UserCapability&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserCapability", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserCapability(UserCapabilityconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::UserCapability) == 0x30, "Size mismatch!");
