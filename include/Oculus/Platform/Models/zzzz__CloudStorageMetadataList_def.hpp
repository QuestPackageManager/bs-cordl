...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13476)), TypeDefinitionIndex(TypeDefinitionIndex(13473)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13476), inst:
// 1148 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13474)) CS Name: ::Oculus.Platform.Models::CloudStorageMetadataList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b2eb4 size 0x25c virtual false final false
