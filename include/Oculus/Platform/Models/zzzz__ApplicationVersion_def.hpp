...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ApplicationVersion*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ApplicationVersion*, "Oculus.Platform.Models", "ApplicationVersion");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9e08, size 0xa8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ApplicationVersion", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ApplicationVersion(ApplicationVersion&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ApplicationVersion", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ApplicationVersion(ApplicationVersionconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::ApplicationVersion) == 0x40, "Size mismatch!");
