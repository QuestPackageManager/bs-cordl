...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::ShareMediaResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::ShareMediaResult*, "Oculus.Platform.Models", "ShareMediaResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2718, size 0x70, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ShareMediaResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ShareMediaResult(ShareMediaResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ShareMediaResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ShareMediaResult(ShareMediaResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::ShareMediaResult) == 0x18, "Size mismatch!");
