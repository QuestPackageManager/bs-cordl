...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13319))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x273d4dc, size 0x78, virtual false, abstract: false, final false
