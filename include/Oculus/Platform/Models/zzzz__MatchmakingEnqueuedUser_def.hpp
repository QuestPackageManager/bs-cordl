...
public:
  ...
  __declspec(property(get = __get_CustomData, put = __set_CustomData))::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* CustomData;

  /// @brief Field UserOptional, offset 0x18, size 0x8
  __declspec(property(get = __get_UserOptional, put = __set_UserOptional))::Oculus::Platform::Models::User* UserOptional;

  /// @brief Field User, offset 0x20, size 0x8
  __declspec(property(get = __get_User, put = __set_User))::Oculus::Platform::Models::User* User;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*& __get_CustomData();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*> const& __get_CustomData() const;

  constexpr void __set_CustomData(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* value);

  constexpr ::Oculus::Platform::Models::User*& __get_UserOptional();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::User*> const& __get_UserOptional() const;
  ...
  /// @brief Method .ctor addr 0x25b5338 size 0x108 virtual false final false
