...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AssetFileDownloadCancelResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AssetFileDownloadCancelResult*, "Oculus.Platform.Models", "AssetFileDownloadCancelResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedb00, size 0xa4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadCancelResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetFileDownloadCancelResult(AssetFileDownloadCancelResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadCancelResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetFileDownloadCancelResult(AssetFileDownloadCancelResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AssetFileDownloadCancelResult) == 0x30, "Size mismatch!");
