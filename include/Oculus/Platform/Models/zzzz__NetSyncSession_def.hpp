...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::NetSyncSession*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::NetSyncSession*, "Oculus.Platform.Models", "NetSyncSession");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0f08, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetSyncSession", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetSyncSession(NetSyncSession&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetSyncSession", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetSyncSession(NetSyncSessionconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::NetSyncSession) == 0x38, "Size mismatch!");
