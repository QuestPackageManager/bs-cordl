...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13369)), TypeDefinitionIndex(TypeDefinitionIndex(13439)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13369), inst:
// 1166 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13440)) CS Name: ::Oculus.Platform.Models::UserList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2737b40, size 0x25c, virtual false, abstract: false, final false
