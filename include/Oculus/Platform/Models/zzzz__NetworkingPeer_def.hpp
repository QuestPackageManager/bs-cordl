...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13373)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  __declspec(property(get = __get__State_k__BackingField, put = __set__State_k__BackingField))::Oculus::Platform::PeerConnectionState _State_k__BackingField;
  ...
  constexpr ::Oculus::Platform::PeerConnectionState& __get__State_k__BackingField();

  constexpr ::Oculus::Platform::PeerConnectionState const& __get__State_k__BackingField() const;
  ...
  /// @brief Method .ctor addr 0x25b6448 size 0x30 virtual false final false
  inline void _ctor(uint64_t id, ::Oculus::Platform::PeerConnectionState state);

  /// @brief Method get_ID addr 0x25b6478 size 0x8 virtual false final false
  inline uint64_t get_ID();

  /// @brief Method set_ID addr 0x25b6480 size 0x8 virtual false final false
  inline void set_ID(uint64_t value);

  /// @brief Method get_State addr 0x25b6488 size 0x8 virtual false final false
  inline ::Oculus::Platform::PeerConnectionState get_State();

  /// @brief Method set_State addr 0x25b6490 size 0x8 virtual false final false
