...
public:
  ...
  /// @brief Method .ctor, addr 0x5df12f0, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NetSyncVoipAttenuationValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NetSyncVoipAttenuationValue(NetSyncVoipAttenuationValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NetSyncVoipAttenuationValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NetSyncVoipAttenuationValue(NetSyncVoipAttenuationValueconst&) = delete;
