...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1176 }), TypeDefinitionIndex(TypeDefinitionIndex(13449)),
// TypeDefinitionIndex(TypeDefinitionIndex(13430))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13450)) CS Name: ::Oculus.Platform.Models::LeaderboardEntryList*
