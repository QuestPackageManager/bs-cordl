...
public:
  ...
  /// @brief Method .ctor, addr 0x5df0628, size 0x21c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardEntryList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaderboardEntryList(LeaderboardEntryList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardEntryList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaderboardEntryList(LeaderboardEntryListconst&) = delete;
