...
public:
  ...
  __declspec(property(get = __cordl_internal_get_MatchmakingEnqueueResult,
                      put = __cordl_internal_set_MatchmakingEnqueueResult))::Oculus::Platform::Models::MatchmakingEnqueueResult* MatchmakingEnqueueResult;
  ...
  constexpr ::Oculus::Platform::Models::MatchmakingEnqueueResult*& __cordl_internal_get_MatchmakingEnqueueResult();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingEnqueueResult*> const& __cordl_internal_get_MatchmakingEnqueueResult() const;

  constexpr void __cordl_internal_set_MatchmakingEnqueueResult(::Oculus::Platform::Models::MatchmakingEnqueueResult* value);
  ...
  /// @brief Method .ctor, addr 0x273af04, size 0xf4, virtual false, abstract: false, final false
