...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1175 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
// TypeDefinitionIndex(TypeDefinitionIndex(13447))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13448)) CS Name: ::Oculus.Platform.Models::LeaderboardList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2706830 size 0x25c virtual false final false
