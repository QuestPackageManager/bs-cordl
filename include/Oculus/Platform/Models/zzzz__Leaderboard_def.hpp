...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::Leaderboard*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::Leaderboard*, "Oculus.Platform.Models", "Leaderboard");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dec6ac, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Oculus::Platform::Models::Leaderboard) == 0x30, "Size mismatch!");
