...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::LanguagePackInfo*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::LanguagePackInfo*, "Oculus.Platform.Models", "LanguagePackInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5defddc, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LanguagePackInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LanguagePackInfo(LanguagePackInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LanguagePackInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LanguagePackInfo(LanguagePackInfoconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::LanguagePackInfo) == 0x28, "Size mismatch!");
