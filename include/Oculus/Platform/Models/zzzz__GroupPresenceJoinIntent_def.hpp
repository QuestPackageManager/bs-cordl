...
public:
  ...
  /// @brief Method .ctor, addr 0x5def884, size 0xa0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GroupPresenceJoinIntent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GroupPresenceJoinIntent(GroupPresenceJoinIntent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GroupPresenceJoinIntent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GroupPresenceJoinIntent(GroupPresenceJoinIntentconst&) = delete;
