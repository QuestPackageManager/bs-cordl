...
public:
  ...
  __declspec(property(get = __cordl_internal_get_CountdownMS, put = __cordl_internal_set_CountdownMS)) int32_t CountdownMS;
  ...
  __declspec(property(get = __cordl_internal_get_LaunchDetails, put = __cordl_internal_set_LaunchDetails))::StringW LaunchDetails;

  constexpr int32_t& __cordl_internal_get_CountdownMS();

  constexpr int32_t const& __cordl_internal_get_CountdownMS() const;

  constexpr void __cordl_internal_set_CountdownMS(int32_t value);
  ...
  constexpr ::StringW& __cordl_internal_get_LaunchDetails();

  constexpr ::StringW const& __cordl_internal_get_LaunchDetails() const;

  constexpr void __cordl_internal_set_LaunchDetails(::StringW value);

  static inline ::Oculus::Platform::Models::CalApplicationFinalized* New_ctor(void* o);

  /// @brief Method .ctor, addr 0x2737544, size 0x98, virtual false, abstract: false, final false
