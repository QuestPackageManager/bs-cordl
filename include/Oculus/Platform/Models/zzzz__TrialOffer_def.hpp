...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::TrialOffer*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::TrialOffer*, "Oculus.Platform.Models", "TrialOffer");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2808, size 0xd4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrialOffer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrialOffer(TrialOffer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrialOffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrialOffer(TrialOfferconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::TrialOffer) == 0x28, "Size mismatch!");
