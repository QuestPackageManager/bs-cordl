...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13248)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  __declspec(property(get = __get_Status, put = __set_Status))::Oculus::Platform::CloudStorageUpdateStatus Status;
  ...
  constexpr ::Oculus::Platform::CloudStorageUpdateStatus& __get_Status();

  constexpr ::Oculus::Platform::CloudStorageUpdateStatus const& __get_Status() const;
  ...
  /// @brief Method .ctor addr 0x25b3110 size 0xa8 virtual false final false
