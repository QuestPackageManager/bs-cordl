...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::BlockedUserList::*)(::System::IntPtr)>(&::Oculus::Platform::Models::BlockedUserList::_ctor)> {
  constexpr static std::size_t size = 0x1fc;
  constexpr static std::size_t addrs = 0x5dee318;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::BlockedUserList*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
inline ::Oculus::Platform::Models::BlockedUserList* Oculus::Platform::Models::BlockedUserList::New_ctor(::System::IntPtr a) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::BlockedUserList*>(a));
}
// Ctor Parameters []
