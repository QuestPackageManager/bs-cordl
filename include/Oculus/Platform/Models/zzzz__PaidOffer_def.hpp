...
public:
  ...
  /// @brief Method .ctor, addr 0x5dede3c, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PaidOffer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PaidOffer(PaidOffer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PaidOffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PaidOffer(PaidOfferconst&) = delete;
