...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13476)), TypeDefinitionIndex(TypeDefinitionIndex(13544)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13476), inst:
// 1162 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13545)) CS Name: ::Oculus.Platform.Models::TeamList*
...
public:
  ...
  /// @brief Method .ctor addr 0x25b73a0 size 0x23c virtual false final false
