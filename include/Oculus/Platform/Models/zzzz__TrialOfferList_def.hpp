...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::TrialOfferList*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::TrialOfferList*, "Oculus.Platform.Models", "TrialOfferList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedef0, size 0x1dc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrialOfferList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrialOfferList(TrialOfferList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrialOfferList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrialOfferList(TrialOfferListconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::TrialOfferList) == 0x28, "Size mismatch!");
