...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::GroupPresenceLeaveIntent*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::GroupPresenceLeaveIntent*, "Oculus.Platform.Models", "GroupPresenceLeaveIntent");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5def924, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GroupPresenceLeaveIntent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GroupPresenceLeaveIntent(GroupPresenceLeaveIntent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GroupPresenceLeaveIntent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GroupPresenceLeaveIntent(GroupPresenceLeaveIntentconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::GroupPresenceLeaveIntent) == 0x28, "Size mismatch!");
