...
public:
  ...
  __declspec(property(get = __get_AssignedUsers, put = __set_AssignedUsers))::Oculus::Platform::Models::UserList* AssignedUsers;

  /// @brief Field MaxUsers, offset 0x18, size 0x4
  __declspec(property(get = __get_MaxUsers, put = __set_MaxUsers)) int32_t MaxUsers;

  /// @brief Field MinUsers, offset 0x1c, size 0x4
  __declspec(property(get = __get_MinUsers, put = __set_MinUsers)) int32_t MinUsers;

  /// @brief Field Name, offset 0x20, size 0x8
  __declspec(property(get = __get_Name, put = __set_Name))::StringW Name;

  constexpr ::Oculus::Platform::Models::UserList*& __get_AssignedUsers();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::UserList*> const& __get_AssignedUsers() const;

  constexpr void __set_AssignedUsers(::Oculus::Platform::Models::UserList* value);

  constexpr int32_t& __get_MaxUsers();

  constexpr int32_t const& __get_MaxUsers() const;

  constexpr void __set_MaxUsers(int32_t value);

  constexpr int32_t& __get_MinUsers();

  constexpr int32_t const& __get_MinUsers() const;
  ...
  /// @brief Method .ctor addr 0x25b7d54 size 0xe0 virtual false final false
