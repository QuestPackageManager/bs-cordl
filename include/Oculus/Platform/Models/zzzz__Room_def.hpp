...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13310)), TypeDefinitionIndex(TypeDefinitionIndex(13311)),
// TypeDefinitionIndex(TypeDefinitionIndex(13314))] Self: TypeDefinitionIndex(TypeDefinitionIndex(13427)) CS Name: ::Oculus.Platform.Models::Room*
class CORDL_TYPE Room : public ::System::Object {
public:
  // Declarations
  /// @brief Field ApplicationID, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get_ApplicationID, put = __cordl_internal_set_ApplicationID)) uint64_t ApplicationID;

  /// @brief Field DataStore, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_DataStore, put = __cordl_internal_set_DataStore))::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* DataStore;
  ...
  __declspec(property(get = __cordl_internal_get_IsMembershipLocked, put = __cordl_internal_set_IsMembershipLocked)) bool IsMembershipLocked;

  /// @brief Field JoinPolicy, offset 0x44, size 0x4
  __declspec(property(get = __cordl_internal_get_JoinPolicy, put = __cordl_internal_set_JoinPolicy))::Oculus::Platform::RoomJoinPolicy JoinPolicy;

  /// @brief Field Joinability, offset 0x48, size 0x4
  __declspec(property(get = __cordl_internal_get_Joinability, put = __cordl_internal_set_Joinability))::Oculus::Platform::RoomJoinability Joinability;

  /// @brief Field MatchedUsersOptional, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get_MatchedUsersOptional, put = __cordl_internal_set_MatchedUsersOptional))::Oculus::Platform::Models::MatchmakingEnqueuedUserList* MatchedUsersOptional;

  /// @brief Field MatchedUsers, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get_MatchedUsers, put = __cordl_internal_set_MatchedUsers))::Oculus::Platform::Models::MatchmakingEnqueuedUserList* MatchedUsers;

  /// @brief Field MaxUsers, offset 0x60, size 0x4
  __declspec(property(get = __cordl_internal_get_MaxUsers, put = __cordl_internal_set_MaxUsers)) uint32_t MaxUsers;

  /// @brief Field Name, offset 0x68, size 0x8
  __declspec(property(get = __cordl_internal_get_Name, put = __cordl_internal_set_Name))::StringW Name;

  /// @brief Field OwnerOptional, offset 0x70, size 0x8
  __declspec(property(get = __cordl_internal_get_OwnerOptional, put = __cordl_internal_set_OwnerOptional))::Oculus::Platform::Models::User* OwnerOptional;

  /// @brief Field Owner, offset 0x78, size 0x8
  __declspec(property(get = __cordl_internal_get_Owner, put = __cordl_internal_set_Owner))::Oculus::Platform::Models::User* Owner;

  /// @brief Field TeamsOptional, offset 0x80, size 0x8
  __declspec(property(get = __cordl_internal_get_TeamsOptional, put = __cordl_internal_set_TeamsOptional))::Oculus::Platform::Models::TeamList* TeamsOptional;

  /// @brief Field Teams, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get_Teams, put = __cordl_internal_set_Teams))::Oculus::Platform::Models::TeamList* Teams;

  /// @brief Field Type, offset 0x90, size 0x4
  __declspec(property(get = __cordl_internal_get_Type, put = __cordl_internal_set_Type))::Oculus::Platform::RoomType Type;
  ...
  constexpr uint64_t& __cordl_internal_get_ApplicationID();

  constexpr uint64_t const& __cordl_internal_get_ApplicationID() const;

  constexpr void __cordl_internal_set_ApplicationID(uint64_t value);

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*& __cordl_internal_get_DataStore();

  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*> const& __cordl_internal_get_DataStore() const;

  constexpr void __cordl_internal_set_DataStore(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* value);
  ...
  constexpr bool& __cordl_internal_get_IsMembershipLocked();

  constexpr bool const& __cordl_internal_get_IsMembershipLocked() const;

  constexpr void __cordl_internal_set_IsMembershipLocked(bool value);

  constexpr ::Oculus::Platform::RoomJoinPolicy& __cordl_internal_get_JoinPolicy();

  constexpr ::Oculus::Platform::RoomJoinPolicy const& __cordl_internal_get_JoinPolicy() const;

  constexpr void __cordl_internal_set_JoinPolicy(::Oculus::Platform::RoomJoinPolicy value);

  constexpr ::Oculus::Platform::RoomJoinability& __cordl_internal_get_Joinability();

  constexpr ::Oculus::Platform::RoomJoinability const& __cordl_internal_get_Joinability() const;

  constexpr void __cordl_internal_set_Joinability(::Oculus::Platform::RoomJoinability value);

  constexpr ::Oculus::Platform::Models::MatchmakingEnqueuedUserList*& __cordl_internal_get_MatchedUsersOptional();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingEnqueuedUserList*> const& __cordl_internal_get_MatchedUsersOptional() const;

  constexpr void __cordl_internal_set_MatchedUsersOptional(::Oculus::Platform::Models::MatchmakingEnqueuedUserList* value);

  constexpr ::Oculus::Platform::Models::MatchmakingEnqueuedUserList*& __cordl_internal_get_MatchedUsers();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::MatchmakingEnqueuedUserList*> const& __cordl_internal_get_MatchedUsers() const;

  constexpr void __cordl_internal_set_MatchedUsers(::Oculus::Platform::Models::MatchmakingEnqueuedUserList* value);

  constexpr uint32_t& __cordl_internal_get_MaxUsers();

  constexpr uint32_t const& __cordl_internal_get_MaxUsers() const;

  constexpr void __cordl_internal_set_MaxUsers(uint32_t value);
  ...
  constexpr ::Oculus::Platform::Models::User*& __cordl_internal_get_OwnerOptional();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::User*> const& __cordl_internal_get_OwnerOptional() const;

  constexpr void __cordl_internal_set_OwnerOptional(::Oculus::Platform::Models::User* value);

  constexpr ::Oculus::Platform::Models::User*& __cordl_internal_get_Owner();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::User*> const& __cordl_internal_get_Owner() const;

  constexpr void __cordl_internal_set_Owner(::Oculus::Platform::Models::User* value);

  constexpr ::Oculus::Platform::Models::TeamList*& __cordl_internal_get_TeamsOptional();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::TeamList*> const& __cordl_internal_get_TeamsOptional() const;

  constexpr void __cordl_internal_set_TeamsOptional(::Oculus::Platform::Models::TeamList* value);

  constexpr ::Oculus::Platform::Models::TeamList*& __cordl_internal_get_Teams();

  constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::TeamList*> const& __cordl_internal_get_Teams() const;

  constexpr void __cordl_internal_set_Teams(::Oculus::Platform::Models::TeamList* value);

  constexpr ::Oculus::Platform::RoomType& __cordl_internal_get_Type();

  constexpr ::Oculus::Platform::RoomType const& __cordl_internal_get_Type() const;

  constexpr void __cordl_internal_set_Type(::Oculus::Platform::RoomType value);
  ...
  /// @brief Method .ctor, addr 0x273aff8, size 0x3b0, virtual false, abstract: false, final false
