...
public:
  ...
  /// @brief Method .ctor, addr 0x5df2670, size 0xa8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SendInvitesResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SendInvitesResult(SendInvitesResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SendInvitesResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SendInvitesResult(SendInvitesResultconst&) = delete;
