...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AbuseReportRecording*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AbuseReportRecording*, "Oculus.Platform.Models", "AbuseReportRecording");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dd9050, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AbuseReportRecording", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AbuseReportRecording(AbuseReportRecording&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AbuseReportRecording", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AbuseReportRecording(AbuseReportRecordingconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AbuseReportRecording) == 0x18, "Size mismatch!");
