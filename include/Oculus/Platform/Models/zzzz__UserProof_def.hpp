...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserProof", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserProof(UserProof&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserProof", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserProof(UserProofconst&) = delete;
