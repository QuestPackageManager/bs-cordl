...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppDownloadProgressResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppDownloadProgressResult(AppDownloadProgressResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppDownloadProgressResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppDownloadProgressResult(AppDownloadProgressResultconst&) = delete;
