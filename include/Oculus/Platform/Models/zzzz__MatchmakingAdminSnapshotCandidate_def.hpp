...
public:
  ...
  __declspec(property(get = __cordl_internal_get_CanMatch, put = __cordl_internal_set_CanMatch)) bool CanMatch;

  /// @brief Field MyTotalScore, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_MyTotalScore, put = __cordl_internal_set_MyTotalScore)) double_t MyTotalScore;

  /// @brief Field TheirCurrentThreshold, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_TheirCurrentThreshold, put = __cordl_internal_set_TheirCurrentThreshold)) double_t TheirCurrentThreshold;

  /// @brief Field TheirTotalScore, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get_TheirTotalScore, put = __cordl_internal_set_TheirTotalScore)) double_t TheirTotalScore;
  ...
  constexpr bool& __cordl_internal_get_CanMatch();

  constexpr bool const& __cordl_internal_get_CanMatch() const;

  constexpr void __cordl_internal_set_CanMatch(bool value);

  constexpr double_t& __cordl_internal_get_MyTotalScore();

  constexpr double_t const& __cordl_internal_get_MyTotalScore() const;

  constexpr void __cordl_internal_set_MyTotalScore(double_t value);

  constexpr double_t& __cordl_internal_get_TheirCurrentThreshold();

  constexpr double_t const& __cordl_internal_get_TheirCurrentThreshold() const;

  constexpr void __cordl_internal_set_TheirCurrentThreshold(double_t value);

  constexpr double_t& __cordl_internal_get_TheirTotalScore();

  constexpr double_t const& __cordl_internal_get_TheirTotalScore() const;

  constexpr void __cordl_internal_set_TheirTotalScore(double_t value);
  ...
  /// @brief Method .ctor, addr 0x273a64c, size 0xbc, virtual false, abstract: false, final false
