...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Oculus::Platform::Models::AchievementDefinitionList::*)(::System::IntPtr)>(
  ...
  constexpr static std::size_t addrs = 0x5dd6f70;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Oculus::Platform::Models::AchievementDefinitionList*>(), { ".ctor", {}, { ::i2c::type_of<::System::IntPtr>() } })));
...
inline ::Oculus::Platform::Models::AchievementDefinitionList* Oculus::Platform::Models::AchievementDefinitionList::New_ctor(::System::IntPtr a) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Oculus::Platform::Models::AchievementDefinitionList*>(a));
}
// Ctor Parameters []
