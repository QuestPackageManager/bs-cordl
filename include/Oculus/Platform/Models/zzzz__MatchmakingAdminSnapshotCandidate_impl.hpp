...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::*)(void*)>(
  ...
  constexpr static std::size_t addrs = 0x25b4dc4;
...
constexpr bool& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_CanMatch() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___CanMatch;
}
constexpr bool const& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_CanMatch() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___CanMatch;
}
...
constexpr double_t& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_MyTotalScore() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MyTotalScore;
}
constexpr double_t const& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_MyTotalScore() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___MyTotalScore;
}
...
constexpr double_t& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TheirCurrentThreshold() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TheirCurrentThreshold;
}
constexpr double_t const& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TheirCurrentThreshold() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TheirCurrentThreshold;
}
...
constexpr double_t& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TheirTotalScore() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TheirTotalScore;
}
constexpr double_t const& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TheirTotalScore() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TheirTotalScore;
}
...
constexpr ::StringW& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TraceId() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TraceId;
}
constexpr ::StringW const& Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::__get_TraceId() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___TraceId;
}
...
inline ::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate* Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate::New_ctor(void* o) {
  return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::MatchmakingAdminSnapshotCandidate*>(o));
}
