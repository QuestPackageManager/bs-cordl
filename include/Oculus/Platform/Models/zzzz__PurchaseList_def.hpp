...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1182 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)),
...
public:
  ...
  /// @brief Method .ctor addr 0x2708874 size 0x25c virtual false final false
