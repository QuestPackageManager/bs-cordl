...
// Write type traits
MARK_REF_T(::Oculus::Platform::Models::AssetFileDownloadResult*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::Models::AssetFileDownloadResult*, "Oculus.Platform.Models", "AssetFileDownloadResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dedba4, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetFileDownloadResult(AssetFileDownloadResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetFileDownloadResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetFileDownloadResult(AssetFileDownloadResultconst&) = delete;
...
static_assert(sizeof(::Oculus::Platform::Models::AssetFileDownloadResult) == 0x20, "Size mismatch!");
