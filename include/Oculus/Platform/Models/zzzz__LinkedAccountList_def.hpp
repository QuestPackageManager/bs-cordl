...
public:
  ...
  /// @brief Method .ctor, addr 0x5df08d4, size 0x1dc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinkedAccountList", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinkedAccountList(LinkedAccountList&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinkedAccountList", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinkedAccountList(LinkedAccountListconst&) = delete;
