...
public:
  // Declarations
  /// @brief Method GetAbuseReportRecording, addr 0x5c2aab8, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording();

  /// @brief Method GetDataFromMessage, addr 0x5c2aafc, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2aa5c, size 0x5c, virtual false, abstract: false, final false
