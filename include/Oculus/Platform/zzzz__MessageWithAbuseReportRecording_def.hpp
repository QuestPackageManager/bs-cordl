...
public:
  // Declarations
  /// @brief Method GetAbuseReportRecording, addr 0x3f78b08, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording();

  /// @brief Method GetDataFromMessage, addr 0x3f78b44, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f78ab0, size 0x58, virtual false, abstract: false, final false
