...
public:
// Declarations
/// @brief Method GetAbuseReportRecording, addr 0x5c9eb24, size 0x44, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording() ;

/// @brief Method GetDataFromMessage, addr 0x5c9eb68, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c9eac8, size 0x5c, virtual false, abstract: false, final false
