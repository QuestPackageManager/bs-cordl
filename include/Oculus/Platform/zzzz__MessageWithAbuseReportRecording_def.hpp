...
public:
  // Declarations
  /// @brief Method GetAbuseReportRecording, addr 0x3f7da04, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7d9ac, size 0x58, virtual false, abstract: false, final false
