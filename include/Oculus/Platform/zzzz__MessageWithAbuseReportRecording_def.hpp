...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13338)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4538 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13167)) CS Name: ::Oculus.Platform::MessageWithAbuseReportRecording*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2719c7c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAbuseReportRecording, addr 0x2719cd4, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording();

  /// @brief Method GetDataFromMessage, addr 0x2719d10, size 0x9c, virtual true, abstract: false, final false
