...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13543)), TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 967 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13348)) CS Name: ::Oculus.Platform::MessageWithSystemVoipState*
...
public:
  ...
  /// @brief Method .ctor addr 0x2593c3c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetSystemVoipState addr 0x2598614 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::SystemVoipState* GetSystemVoipState();

  /// @brief Method GetDataFromMessage addr 0x2598650 size 0x9c virtual true final false
