...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 983 }), TypeDefinitionIndex(TypeDefinitionIndex(13483)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13325)) CS Name: ::Oculus.Platform::MessageWithSystemVoipState*
