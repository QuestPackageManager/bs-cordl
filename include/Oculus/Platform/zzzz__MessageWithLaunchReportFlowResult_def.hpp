...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4590 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13445))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13296)) CS Name: ::Oculus.Platform::MessageWithLaunchReportFlowResult*
