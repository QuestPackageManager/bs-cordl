...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5c2cf34, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchReportFlowResult, addr 0x5c2cef0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c2ce94, size 0x5c, virtual false, abstract: false, final false
