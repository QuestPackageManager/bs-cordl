...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd91c8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchReportFlowResult, addr 0x5dd9184, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd9128, size 0x5c, virtual false, abstract: false, final false
