...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13491)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4491 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13309)) CS Name: ::Oculus.Platform::MessageWithLaunchReportFlowResult*
...
public:
  ...
  /// @brief Method .ctor addr 0x2596204 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLaunchReportFlowResult addr 0x259625c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetLaunchReportFlowResult();

  /// @brief Method GetDataFromMessage addr 0x2596298 size 0x9c virtual true final false
