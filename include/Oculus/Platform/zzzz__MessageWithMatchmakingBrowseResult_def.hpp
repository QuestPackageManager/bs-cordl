...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13399)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4572 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13253)) CS Name: ::Oculus.Platform::MessageWithMatchmakingBrowseResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718c2c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetMatchmakingEnqueueResult, addr 0x271e960, size 0x48, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::MatchmakingEnqueueResult* GetMatchmakingEnqueueResult();

  /// @brief Method GetRoomList, addr 0x271e9a8, size 0x48, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::RoomList* GetRoomList();

  /// @brief Method GetDataFromMessage, addr 0x271e9f0, size 0x9c, virtual true, abstract: false, final false
