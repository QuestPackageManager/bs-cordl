...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 970 }), TypeDefinitionIndex(TypeDefinitionIndex(13422)),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13280)) CS Name: ::Oculus.Platform::MessageWithAssetFileDownloadUpdate*
