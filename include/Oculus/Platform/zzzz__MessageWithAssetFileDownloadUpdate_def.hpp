...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13352)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 967 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13178)) CS Name: ::Oculus.Platform::MessageWithAssetFileDownloadUpdate*
...
public:
  ...
  /// @brief Method .ctor, addr 0x271828c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAssetFileDownloadUpdate, addr 0x271a61c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetDataFromMessage, addr 0x271a658, size 0x9c, virtual true, abstract: false, final false
