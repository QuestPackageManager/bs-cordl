...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadUpdate, addr 0x3f79598, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetDataFromMessage, addr 0x3f795d4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f770f0, size 0x58, virtual false, abstract: false, final false
