...
public:
  // Declarations
  /// @brief Method GetAssetFileDownloadUpdate, addr 0x2afb4fc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetDataFromMessage, addr 0x2afb538, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af8f6c, size 0x58, virtual false, abstract: false, final false
