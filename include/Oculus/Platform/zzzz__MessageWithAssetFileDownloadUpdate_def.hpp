...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13459)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 952 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13285)) CS Name: ::Oculus.Platform::MessageWithAssetFileDownloadUpdate*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592a04 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAssetFileDownloadUpdate addr 0x2594d94 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetAssetFileDownloadUpdate();

  /// @brief Method GetDataFromMessage addr 0x2594dd0 size 0x9c virtual true final false
