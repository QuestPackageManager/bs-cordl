...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x28461b0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* GetDataFromMessage(void* c_message);

  /// @brief Method GetLaunchFriendRequestFlowResult, addr 0x2846174, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28434b4, size 0x58, virtual false, abstract: false, final false
