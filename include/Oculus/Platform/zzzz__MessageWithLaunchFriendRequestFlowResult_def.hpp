...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13443)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4589 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13294)) CS Name: ::Oculus.Platform::MessageWithLaunchFriendRequestFlowResult*
