...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc6238, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchFriendRequestFlowResult, addr 0x5bc61f4, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2844, size 0x5c, virtual false, abstract: false, final false
