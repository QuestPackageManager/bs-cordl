...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7f090, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLaunchFriendRequestFlowResult, addr 0x3f7f054, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c4dc, size 0x58, virtual false, abstract: false, final false
