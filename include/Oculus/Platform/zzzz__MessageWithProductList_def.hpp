...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f8db84, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetProductList, addr 0x3f8db48, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f89e80, size 0x58, virtual false, abstract: false, final false
