...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc7994, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetProductList, addr 0x5bc7950, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2da8, size 0x5c, virtual false, abstract: false, final false
