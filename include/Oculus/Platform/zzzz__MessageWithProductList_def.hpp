...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2afd7b8, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetProductList, addr 0x2afd77c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2af98b4, size 0x58, virtual false, abstract: false, final false
