...
#include <cstddef>
#include <cstdint>
CORDL_MODULE_EXPORT(VoipDtxState)
// Forward declare root types
namespace Oculus::Platform {
struct VoipDtxState;
}
// Write type traits
MARK_VAL_T(::Oculus::Platform::VoipDtxState);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::VoipDtxState, "Oculus.Platform", "VoipDtxState");
// Dependencies
namespace Oculus::Platform {
// Is value type: true
...
public:
  ...
  /// @brief Nested struct __VoipDtxState_Unwrapped
  enum struct __VoipDtxState_Unwrapped : int32_t {
  ...
  constexpr operator __VoipDtxState_Unwrapped() const noexcept {
    return static_cast<__VoipDtxState_Unwrapped>(this->value__);
  }
...
static_assert(offsetof(::Oculus::Platform::VoipDtxState, value__) == 0x0, "Offset mismatch!");

static_assert(sizeof(::Oculus::Platform::VoipDtxState) == 0x4, "Size mismatch!");
