...
public:
// Declarations
/// @brief Method GetCurrent, addr 0x5c3c894, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Party*>* GetCurrent() ;

/// @brief Method SetPartyUpdateNotificationCallback, addr 0x5c3c9ec, size 0x7c, virtual false, abstract: false, final false
