...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x27f3f2c, size 0x98, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(void* tag, void* msg, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x27f3fc4, size 0x100c, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x27f3f18, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27f3e54, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsyncInitialize, addr 0x27e6a24, size 0x140, virtual false, abstract: false, final false
  inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method CPPLogCallback, addr 0x27f3d34, size 0xd8, virtual false, abstract: false, final false
  inline void CPPLogCallback(void* tag, void* message);

  /// @brief Method Initialize, addr 0x27e7220, size 0xf0, virtual false, abstract: false, final false
  inline bool Initialize(::StringW appId);

  static inline ::Oculus::Platform::WindowsPlatform* New_ctor();

  /// @brief Method .ctor, addr 0x27e6a1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method getCallbackPointer, addr 0x27f3e0c, size 0x48, virtual false, abstract: false, final false
