...
public:
  ...
  /// @brief Method .ctor addr 0x270254c size 0xc4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x2702610 size 0x14 virtual true final false
  inline void Invoke(void* tag, void* msg);

  /// @brief Method BeginInvoke addr 0x2702624 size 0x98 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(void* tag, void* msg, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x27026bc size 0x100c virtual true final false
...
public:
  ...
  /// @brief Method CPPLogCallback addr 0x270242c size 0xd8 virtual false final false
  inline void CPPLogCallback(void* tag, void* message);

  /// @brief Method getCallbackPointer addr 0x2702504 size 0x48 virtual false final false
  inline void* getCallbackPointer();

  /// @brief Method Initialize addr 0x26f5918 size 0xf0 virtual false final false
  inline bool Initialize(::StringW appId);

  /// @brief Method AsyncInitialize addr 0x26f511c size 0x140 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26f5114 size 0x8 virtual false final false
  inline void _ctor();
