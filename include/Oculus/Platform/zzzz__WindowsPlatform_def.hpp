...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2ad87d8, size 0x98, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(void* tag, void* msg, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x2ad8870, size 0x100c, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2ad87c4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ad8700, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AsyncInitialize, addr 0x2acb2d0, size 0x140, virtual false, abstract: false, final false
  inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW appId);

  /// @brief Method CPPLogCallback, addr 0x2ad85e0, size 0xd8, virtual false, abstract: false, final false
  inline void CPPLogCallback(void* tag, void* message);

  /// @brief Method Initialize, addr 0x2acbacc, size 0xf0, virtual false, abstract: false, final false
  inline bool Initialize(::StringW appId);

  static inline ::Oculus::Platform::WindowsPlatform* New_ctor();

  /// @brief Method .ctor, addr 0x2acb2c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method getCallbackPointer, addr 0x2ad86b8, size 0x48, virtual false, abstract: false, final false
