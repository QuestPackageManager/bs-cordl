...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7f940, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStatus, addr 0x3f7f904, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c6ec, size 0x58, virtual false, abstract: false, final false
