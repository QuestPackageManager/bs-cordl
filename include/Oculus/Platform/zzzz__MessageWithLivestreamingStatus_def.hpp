...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x29c908c, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(void* c_message);

  /// @brief Method GetLivestreamingStatus, addr 0x29c9050, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x29c5ca8, size 0x58, virtual false, abstract: false, final false
