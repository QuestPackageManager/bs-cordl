...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dd98a0, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetLivestreamingStatus, addr 0x5dd985c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd583c, size 0x5c, virtual false, abstract: false, final false
