...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13501)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 958 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13269))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13316)) CS Name: ::Oculus.Platform::MessageWithLivestreamingStatus*
...
public:
  ...
  /// @brief Method .ctor addr 0x25932f4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLivestreamingStatus addr 0x259694c size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::LivestreamingStatus* GetLivestreamingStatus();

  /// @brief Method GetDataFromMessage addr 0x2596988 size 0x9c virtual true final false
