...
public:
  // Declarations
  /// @brief Method Get, addr 0x5de265c, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* Get(uint64_t userID);

  /// @brief Method GetAccessToken, addr 0x5de27c4, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::StringW>* GetAccessToken();

  /// @brief Method GetBlockedUsers, addr 0x5de291c, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::BlockedUserList*>* GetBlockedUsers();

  /// @brief Method GetLinkedAccounts, addr 0x5de2a74, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLoggedInUser, addr 0x5de2bf0, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* GetLoggedInUser();

  /// @brief Method GetLoggedInUserFriends, addr 0x5de2d48, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserList*>* GetLoggedInUserFriends();

  /// @brief Method GetLoggedInUserLocale, addr 0x5de2574, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW GetLoggedInUserLocale();

  /// @brief Method GetLoggedInUserManagedInfo, addr 0x5de2ea0, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::User*>* GetLoggedInUserManagedInfo();

  /// @brief Method GetNextBlockedUserListPage, addr 0x5de3848, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextUserCapabilityListPage, addr 0x5de3c28, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNextUserListPage, addr 0x5de3a38, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrgScopedID, addr 0x5de2ff8, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::OrgScopedID*>* GetOrgScopedID(uint64_t userID);

  /// @brief Method GetSdkAccounts, addr 0x5de3160, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::SdkAccountList*>* GetSdkAccounts();

  /// @brief Method GetUserProof, addr 0x5de32b8, size 0x158, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserProof*>* GetUserProof();

  /// @brief Method LaunchBlockFlow, addr 0x5de3410, size 0x168, virtual false, abstract: false, final false
  static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LaunchBlockFlowResult*>* LaunchBlockFlow(uint64_t userID);

  /// @brief Method LaunchFriendRequestFlow, addr 0x5de3578, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method LaunchUnblockFlow, addr 0x5de36e0, size 0x168, virtual false, abstract: false, final false
