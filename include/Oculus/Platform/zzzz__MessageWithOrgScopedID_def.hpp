...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13465)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4601 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13262))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13311)) CS Name: ::Oculus.Platform::MessageWithOrgScopedID*
...
public:
  ...
  /// @brief Method .ctor addr 0x26ef500 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetOrgScopedID addr 0x26f2f68 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetOrgScopedID();

  /// @brief Method GetDataFromMessage addr 0x26f2fa4 size 0x9c virtual true final false
