...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5dda110, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetOrgScopedID, addr 0x5dda0cc, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd59ac, size 0x5c, virtual false, abstract: false, final false
