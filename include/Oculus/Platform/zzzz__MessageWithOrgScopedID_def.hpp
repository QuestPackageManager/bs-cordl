...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13414)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4580 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13221)) CS Name: ::Oculus.Platform::MessageWithOrgScopedID*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718e94, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetOrgScopedID, addr 0x271cd54, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetOrgScopedID();

  /// @brief Method GetDataFromMessage, addr 0x271cd90, size 0x9c, virtual true, abstract: false, final false
