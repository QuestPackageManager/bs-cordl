...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x3f7b1ac, size 0x94, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetOrgScopedID, addr 0x3f7b170, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f778d8, size 0x58, virtual false, abstract: false, final false
