...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x2ae97e4, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetOrgScopedID, addr 0x2ae97a8, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ae5d40, size 0x58, virtual false, abstract: false, final false
