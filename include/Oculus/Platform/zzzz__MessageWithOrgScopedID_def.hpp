...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4507 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13521))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13328)) CS Name: ::Oculus.Platform::MessageWithOrgScopedID*
...
public:
  ...
  /// @brief Method .ctor addr 0x259360c size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetOrgScopedID addr 0x25974cc size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::OrgScopedID* GetOrgScopedID();

  /// @brief Method GetDataFromMessage addr 0x2597508 size 0x9c virtual true final false
