...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13465)), TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst:
// 4601 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13311)) CS Name: ::Oculus.Platform::MessageWithOrgScopedID*
