...
public:
  // Declarations
  /// @brief Method GetChallenge, addr 0x3f79808, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x3f79844, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f771f8, size 0x58, virtual false, abstract: false, final false
