...
public:
  // Declarations
  /// @brief Method GetChallenge, addr 0x5bc5718, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x5bc575c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc2450, size 0x5c, virtual false, abstract: false, final false
