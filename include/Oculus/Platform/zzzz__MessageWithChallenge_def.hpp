...
public:
  // Declarations
  /// @brief Method GetChallenge, addr 0x3f7e77c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x3f7e7b8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f7c16c, size 0x58, virtual false, abstract: false, final false
