...
public:
  // Declarations
  /// @brief Method GetChallenge, addr 0x5dd848c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x5dd84d0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd51c4, size 0x5c, virtual false, abstract: false, final false
