...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13360)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 1149 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13184)) CS Name: ::Oculus.Platform::MessageWithChallenge*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718444, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetChallenge, addr 0x271ab84, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::Challenge* GetChallenge();

  /// @brief Method GetDataFromMessage, addr 0x271abc0, size 0x9c, virtual true, abstract: false, final false
