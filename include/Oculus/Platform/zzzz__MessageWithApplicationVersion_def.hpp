...
public:
  // Declarations
  /// @brief Method GetApplicationVersion, addr 0x5c9dd64, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetDataFromMessage, addr 0x5c9dda8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b0e8, size 0x5c, virtual false, abstract: false, final false
