...
public:
  // Declarations
  /// @brief Method GetApplicationVersion, addr 0x5dd7b04, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetDataFromMessage, addr 0x5dd7b48, size 0x98, virtual true, abstract: false, final false
