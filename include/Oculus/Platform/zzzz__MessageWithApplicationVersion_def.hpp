...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst: 4470 }), TypeDefinitionIndex(TypeDefinitionIndex(13269)),
// TypeDefinitionIndex(TypeDefinitionIndex(13453))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13279)) CS Name: ::Oculus.Platform::MessageWithApplicationVersion*
...
public:
  ...
  /// @brief Method .ctor addr 0x25927f4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetApplicationVersion addr 0x2594884 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion();

  /// @brief Method GetDataFromMessage addr 0x25948c0 size 0x9c virtual true final false
