...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4579 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13420))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13278)) CS Name: ::Oculus.Platform::MessageWithAssetFileDownloadCancelResult*
