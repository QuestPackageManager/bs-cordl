...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13350)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4546 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13176)) CS Name: ::Oculus.Platform::MessageWithAssetFileDownloadCancelResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27181dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetAssetFileDownloadCancelResult, addr 0x271a46c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult();

  /// @brief Method GetDataFromMessage, addr 0x271a4a8, size 0x9c, virtual true, abstract: false, final false
