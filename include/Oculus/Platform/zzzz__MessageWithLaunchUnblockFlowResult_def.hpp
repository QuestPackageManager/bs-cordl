...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13385)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4565 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13203)) CS Name: ::Oculus.Platform::MessageWithLaunchUnblockFlowResult*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2718a1c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetLaunchUnblockFlowResult, addr 0x271bbbc, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::LaunchUnblockFlowResult* GetLaunchUnblockFlowResult();

  /// @brief Method GetDataFromMessage, addr 0x271bbf8, size 0x9c, virtual true, abstract: false, final false
