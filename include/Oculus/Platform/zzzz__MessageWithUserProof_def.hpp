...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13162)), TypeDefinitionIndex(TypeDefinitionIndex(13446)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13162), inst:
// 4596 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(13247)) CS Name: ::Oculus.Platform::MessageWithUserProof*
...
public:
  ...
  /// @brief Method .ctor, addr 0x27196d4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(void* c_message);

  /// @brief Method GetUserProof, addr 0x271e3ac, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserProof* GetUserProof();

  /// @brief Method GetDataFromMessage, addr 0x271e3e8, size 0x9c, virtual true, abstract: false, final false
