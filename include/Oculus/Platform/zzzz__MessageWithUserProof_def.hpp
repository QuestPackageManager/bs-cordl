...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5bc8590, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserProof* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserProof, addr 0x5bc854c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5bc32b0, size 0x5c, virtual false, abstract: false, final false
