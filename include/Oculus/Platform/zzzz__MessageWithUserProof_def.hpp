...
public:
  // Declarations
  /// @brief Method GetDataFromMessage, addr 0x5ddb304, size 0x9c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::UserProof* GetDataFromMessage(::System::IntPtr c_message);

  /// @brief Method GetUserProof, addr 0x5ddb2c0, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd6024, size 0x5c, virtual false, abstract: false, final false
