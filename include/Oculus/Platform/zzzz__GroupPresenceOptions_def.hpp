...
public:
  ...
  /// @brief Method Finalize, addr 0x2ac2a80, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::GroupPresenceOptions* New_ctor();

  /// @brief Method SetDeeplinkMessageOverride, addr 0x2ac29c0, size 0x68, virtual false, abstract: false, final false
  inline void SetDeeplinkMessageOverride(::StringW value);

  /// @brief Method SetDestinationApiName, addr 0x2aa03f8, size 0x68, virtual false, abstract: false, final false
  inline void SetDestinationApiName(::StringW value);

  /// @brief Method SetIsJoinable, addr 0x2aa0530, size 0x68, virtual false, abstract: false, final false
  inline void SetIsJoinable(bool value);

  /// @brief Method SetLobbySessionId, addr 0x2aa04c8, size 0x68, virtual false, abstract: false, final false
  inline void SetLobbySessionId(::StringW value);

  /// @brief Method SetMatchSessionId, addr 0x2aa0460, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2aa0394, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x2ac2a28, size 0x58, virtual false, abstract: false, final false
