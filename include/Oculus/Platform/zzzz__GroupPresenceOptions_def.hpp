...
public:
  ...
  /// @brief Method Finalize, addr 0x3f79d54, size 0xd4, virtual true, abstract: false, final false
  inline void Finalize();

  static inline ::Oculus::Platform::GroupPresenceOptions* New_ctor();

  /// @brief Method SetDeeplinkMessageOverride, addr 0x3f79ce0, size 0x68, virtual false, abstract: false, final false
  inline void SetDeeplinkMessageOverride(::StringW value);

  /// @brief Method SetDestinationApiName, addr 0x3f57bc4, size 0x68, virtual false, abstract: false, final false
  inline void SetDestinationApiName(::StringW value);

  /// @brief Method SetIsJoinable, addr 0x3f57cfc, size 0x68, virtual false, abstract: false, final false
  inline void SetIsJoinable(bool value);

  /// @brief Method SetLobbySessionId, addr 0x3f57c94, size 0x68, virtual false, abstract: false, final false
  inline void SetLobbySessionId(::StringW value);

  /// @brief Method SetMatchSessionId, addr 0x3f57c2c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f57b60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Explicit, addr 0x3f79d48, size 0xc, virtual false, abstract: false, final false
