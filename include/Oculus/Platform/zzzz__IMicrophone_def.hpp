...
// Write type traits
MARK_REF_T(::Oculus::Platform::IMicrophone*);
DEFINE_IL2CPP_CLASS(::Oculus::Platform::IMicrophone*, "Oculus.Platform", "IMicrophone");
// Dependencies
namespace Oculus::Platform {
// Is value type: false
...
public:
  ...
  inline ::ArrayW<float_t> Update();

  // Ctor Parameters [CppParam { name: "", ty: "IMicrophone", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMicrophone(IMicrophoneconst&) = delete;
