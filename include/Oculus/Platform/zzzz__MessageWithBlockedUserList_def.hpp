...
public:
  // Declarations
  /// @brief Method GetBlockedUserList, addr 0x5c9e60c, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage, addr 0x5c9e650, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5c9b3c8, size 0x5c, virtual false, abstract: false, final false
