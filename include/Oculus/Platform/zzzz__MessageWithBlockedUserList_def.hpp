...
public:
  // Declarations
  /// @brief Method GetBlockedUserList, addr 0x284577c, size 0x3c, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage, addr 0x28457b8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28430ec, size 0x58, virtual false, abstract: false, final false
