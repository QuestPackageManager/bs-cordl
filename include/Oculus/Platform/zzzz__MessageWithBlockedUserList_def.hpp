...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13462)), TypeDefinitionIndex(TypeDefinitionIndex(13269)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13269), inst:
// 4476 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13287)) CS Name: ::Oculus.Platform::MessageWithBlockedUserList*
...
public:
  ...
  /// @brief Method .ctor addr 0x2592ab4 size 0x58 virtual false final false
  inline void _ctor(void* c_message);

  /// @brief Method GetBlockedUserList addr 0x2594f44 size 0x3c virtual true final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage addr 0x2594f80 size 0x9c virtual true final false
