...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4582 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13425))} Self: TypeDefinitionIndex(TypeDefinitionIndex(13282)) CS Name: ::Oculus.Platform::MessageWithBlockedUserList*
