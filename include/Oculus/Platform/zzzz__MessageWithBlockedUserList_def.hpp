...
public:
  // Declarations
  /// @brief Method GetBlockedUserList, addr 0x5dd83ac, size 0x44, virtual true, abstract: false, final false
  inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList();

  /// @brief Method GetDataFromMessage, addr 0x5dd83f0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dd5168, size 0x5c, virtual false, abstract: false, final false
