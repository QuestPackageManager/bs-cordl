...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightTranslationEvent, "BeatmapSaveDataVersion4", "LightTranslationEvent");
...
public:
  ...
  // None, comment: None }, CppParam { name: "t", ty: "float_t", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightTranslationEvent) == 0xc, "Size mismatch!");
