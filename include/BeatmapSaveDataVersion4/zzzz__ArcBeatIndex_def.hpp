...
public:
  ...
  /// @brief Method .ctor, addr 0x375d924, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x375d91c, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArcBeatIndex", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArcBeatIndex(ArcBeatIndex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArcBeatIndex", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArcBeatIndex(ArcBeatIndexconst&) = delete;
