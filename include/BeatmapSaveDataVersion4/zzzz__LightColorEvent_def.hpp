...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightColorEvent, "BeatmapSaveDataVersion4", "LightColorEvent");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightColorEvent) == 0x1c, "Size mismatch!");
