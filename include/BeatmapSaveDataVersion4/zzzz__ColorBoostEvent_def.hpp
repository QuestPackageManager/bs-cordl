...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::ColorBoostEvent, "BeatmapSaveDataVersion4", "ColorBoostEvent");
// Dependencies
namespace BeatmapSaveDataVersion4 {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 15323 };
...
static_assert(sizeof(::BeatmapSaveDataVersion4::ColorBoostEvent) == 0x4, "Size mismatch!");
