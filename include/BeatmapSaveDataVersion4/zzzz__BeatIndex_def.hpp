...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatIndex", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatIndex(BeatIndex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatIndex", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatIndex(BeatIndexconst&) = delete;
