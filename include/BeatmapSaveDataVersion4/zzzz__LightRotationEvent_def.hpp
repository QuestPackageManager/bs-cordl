...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightRotationEvent, "BeatmapSaveDataVersion4", "LightRotationEvent");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightRotationEvent) == 0x14, "Size mismatch!");
