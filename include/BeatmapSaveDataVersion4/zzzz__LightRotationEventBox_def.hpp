...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightRotationEventBox, "BeatmapSaveDataVersion4", "LightRotationEventBox");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightRotationEventBox) == 0x20, "Size mismatch!");
