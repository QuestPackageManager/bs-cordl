...
/// @brief Field njsEventData, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_njsEventData, put=__cordl_internal_set_njsEventData)) ::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  njsEventData;

/// @brief Field njsEvents, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_njsEvents, put=__cordl_internal_set_njsEvents)) ::ArrayW<::BeatmapSaveDataVersion4::BeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatIndex*>*>  njsEvents;
...
/// @brief Method .ctor, addr 0x365fdfc, size 0x58c, virtual false, abstract: false, final false
inline void _ctor() ;
