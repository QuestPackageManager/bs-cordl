...
// Ctor Parameters [CppParam { name: "d", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "p", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "e", ty: "::BeatmapSaveDataCommon::EaseType", modifiers: "", def_value: Some("{}") }]
