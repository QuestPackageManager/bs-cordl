...
// Ctor Parameters [CppParam { name: "tx", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ty", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "c", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "s", ty: "float_t", modifiers: "", def_value: Some("{}") }]
