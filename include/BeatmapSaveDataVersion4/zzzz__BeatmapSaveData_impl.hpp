...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapSaveDataVersion4::BeatmapSaveData::*)()>(&::BeatmapSaveDataVersion4::BeatmapSaveData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x365fdfc;
...
constexpr ::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>& BeatmapSaveDataVersion4::BeatmapSaveData::__cordl_internal_get_njsEventData()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___njsEventData;
}
constexpr ::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*> const& BeatmapSaveDataVersion4::BeatmapSaveData::__cordl_internal_get_njsEventData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___njsEventData;
}
constexpr void BeatmapSaveDataVersion4::BeatmapSaveData::__cordl_internal_set_njsEventData(::ArrayW<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent,::Array<::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
