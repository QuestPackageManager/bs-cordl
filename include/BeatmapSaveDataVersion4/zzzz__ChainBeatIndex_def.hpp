...
public:
  ...
  /// @brief Method .ctor, addr 0x375d918, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x375d910, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChainBeatIndex", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChainBeatIndex(ChainBeatIndex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChainBeatIndex", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChainBeatIndex(ChainBeatIndexconst&) = delete;
