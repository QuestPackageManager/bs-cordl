...
public:
  ...
  /// @brief Method get_beat, addr 0x12bad3c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_beat();

  static inline ::BeatmapSaveDataVersion4::ChainBeatIndex* New_ctor();

  /// @brief Method .ctor, addr 0x12bad44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
