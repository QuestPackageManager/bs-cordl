...
// Ctor Parameters [CppParam { name: "m", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "tm", ty: "float_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "a", ty: "::BeatmapSaveDataCommon::SliderMidAnchorMode", modifiers: "", def_value: Some("{}"), comment: None }]
