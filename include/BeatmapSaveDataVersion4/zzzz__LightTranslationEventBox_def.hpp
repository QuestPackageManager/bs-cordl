...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::LightTranslationEventBox, "BeatmapSaveDataVersion4", "LightTranslationEventBox");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::LightTranslationEventBox) == 0x20, "Size mismatch!");
