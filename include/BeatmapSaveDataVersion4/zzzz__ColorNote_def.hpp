...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::ColorNote, "BeatmapSaveDataVersion4", "ColorNote");
...
static_assert(sizeof(::BeatmapSaveDataVersion4::ColorNote) == 0x14, "Size mismatch!");
