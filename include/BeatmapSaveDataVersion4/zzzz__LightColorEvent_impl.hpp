...
// Some("{}"), comment: None }, CppParam { name: "c", ty: "::BeatmapSaveDataCommon::EnvironmentColorType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "b", ty: "float_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "f", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sb", ty: "float_t", modifiers:
// "", def_value: Some("{}"), comment: None }, CppParam { name: "sf", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
