...
public:
  ...
  /// @brief Method .ctor, addr 0x14f744c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x14f7444, size 0x8, virtual true, abstract: false, final true
