...
public:
  ...
  /// @brief Method .ctor, addr 0x27088b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x27088a8, size 0x8, virtual true, abstract: false, final true
