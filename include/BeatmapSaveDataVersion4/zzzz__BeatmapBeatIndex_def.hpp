...
public:
  ...
  /// @brief Method .ctor, addr 0x2708834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x270882c, size 0x8, virtual true, abstract: false, final true
