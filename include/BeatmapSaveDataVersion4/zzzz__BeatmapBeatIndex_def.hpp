...
// Write type traits
MARK_REF_T(::BeatmapSaveDataVersion4::BeatmapBeatIndex*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::BeatmapBeatIndex*, "BeatmapSaveDataVersion4", "BeatmapBeatIndex");
...
public:
  ...
  /// @brief Method .ctor, addr 0x375d90c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x375d904, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBeatIndex", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapBeatIndex(BeatmapBeatIndex&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBeatIndex", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapBeatIndex(BeatmapBeatIndexconst&) = delete;
...
static_assert(sizeof(::BeatmapSaveDataVersion4::BeatmapBeatIndex) == 0x20, "Size mismatch!");
