...
public:
  ...
  /// @brief Method .ctor, addr 0x36338f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x36338ec, size 0x8, virtual true, abstract: false, final true
