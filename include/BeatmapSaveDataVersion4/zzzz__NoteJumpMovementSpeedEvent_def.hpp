...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent, "BeatmapSaveDataVersion4", "NoteJumpMovementSpeedEvent");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "d", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "p", ty: "int32_t", modifiers: "", def_value: None, comment: None },
  // CppParam { name: "e", ty: "::BeatmapSaveDataCommon::EaseType", modifiers: "", def_value: None, comment: None }]
...
static_assert(sizeof(::BeatmapSaveDataVersion4::NoteJumpMovementSpeedEvent) == 0xc, "Size mismatch!");
