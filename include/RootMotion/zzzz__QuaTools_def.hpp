...
public:
  // Declarations
  /// @brief Method Lerp, addr 0x123e63c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Slerp, addr 0x123e688, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method LinearBlend, addr 0x123e6d4, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion LinearBlend(::UnityEngine::Quaternion q, float_t weight);

  /// @brief Method SphericalBlend, addr 0x123e7d8, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion SphericalBlend(::UnityEngine::Quaternion q, float_t weight);

  /// @brief Method FromToAroundAxis, addr 0x123e8dc, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method RotationToLocalSpace, addr 0x123e9f0, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion RotationToLocalSpace(::UnityEngine::Quaternion space, ::UnityEngine::Quaternion rotation);

  /// @brief Method FromToRotation, addr 0x123ea98, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion FromToRotation(::UnityEngine::Quaternion from, ::UnityEngine::Quaternion to);

  /// @brief Method GetAxis, addr 0x123eba4, size 0x168, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetAxis(::UnityEngine::Vector3 v);

  /// @brief Method ClampRotation, addr 0x123ed0c, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ClampAngle, addr 0x123eef0, size 0xd0, virtual false, abstract: false, final false
  static inline float_t ClampAngle(float_t angle, float_t clampWeight, int32_t clampSmoothing);

  /// @brief Method MatchRotation, addr 0x123efc0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBiPolar, addr 0x123f144, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 ToBiPolar(::UnityEngine::Vector3 euler);

  /// @brief Method ToBiPolar, addr 0x123f250, size 0x58, virtual false, abstract: false, final false
