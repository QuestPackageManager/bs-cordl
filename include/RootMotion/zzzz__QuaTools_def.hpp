...
public:
  // Declarations
  /// @brief Method Lerp, addr 0x12d96ec, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Slerp, addr 0x12d9738, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method LinearBlend, addr 0x12d9784, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion LinearBlend(::UnityEngine::Quaternion q, float_t weight);

  /// @brief Method SphericalBlend, addr 0x12d9888, size 0x104, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion SphericalBlend(::UnityEngine::Quaternion q, float_t weight);

  /// @brief Method FromToAroundAxis, addr 0x12d998c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method RotationToLocalSpace, addr 0x12d9aa0, size 0xa8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion RotationToLocalSpace(::UnityEngine::Quaternion space, ::UnityEngine::Quaternion rotation);

  /// @brief Method FromToRotation, addr 0x12d9b48, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion FromToRotation(::UnityEngine::Quaternion from, ::UnityEngine::Quaternion to);

  /// @brief Method GetAxis, addr 0x12d9c54, size 0x168, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetAxis(::UnityEngine::Vector3 v);

  /// @brief Method ClampRotation, addr 0x12d9dbc, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ClampAngle, addr 0x12d9fa0, size 0xd0, virtual false, abstract: false, final false
  static inline float_t ClampAngle(float_t angle, float_t clampWeight, int32_t clampSmoothing);

  /// @brief Method MatchRotation, addr 0x12da070, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBiPolar, addr 0x12da1f4, size 0x10c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 ToBiPolar(::UnityEngine::Vector3 euler);

  /// @brief Method ToBiPolar, addr 0x12da300, size 0x58, virtual false, abstract: false, final false
