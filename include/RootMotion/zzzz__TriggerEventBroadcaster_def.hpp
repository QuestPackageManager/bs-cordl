...
public:
  ...
  /// @brief Method OnTriggerEnter, addr 0x12da8ac, size 0xb4, virtual false, abstract: false, final false
  inline void OnTriggerEnter(::UnityEngine::Collider* collider);

  /// @brief Method OnTriggerStay, addr 0x12da960, size 0xb4, virtual false, abstract: false, final false
  inline void OnTriggerStay(::UnityEngine::Collider* collider);

  /// @brief Method OnTriggerExit, addr 0x12daa14, size 0xb4, virtual false, abstract: false, final false
  inline void OnTriggerExit(::UnityEngine::Collider* collider);

  static inline ::RootMotion::TriggerEventBroadcaster* New_ctor();

  /// @brief Method .ctor, addr 0x12daac8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
