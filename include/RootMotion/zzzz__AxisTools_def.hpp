...
public:
  // Declarations
  /// @brief Method ToVector3 addr 0x11c5200 size 0xe0 virtual false final false
  static inline ::UnityEngine::Vector3 ToVector3(::RootMotion::Axis axis);

  /// @brief Method ToAxis addr 0x11c52e0 size 0x38 virtual false final false
  static inline ::RootMotion::Axis ToAxis(::UnityEngine::Vector3 v);

  /// @brief Method GetAxisToPoint addr 0x11c5318 size 0xfc virtual false final false
  static inline ::RootMotion::Axis GetAxisToPoint(::UnityEngine::Transform* t, ::UnityEngine::Vector3 worldPosition);

  /// @brief Method GetAxisToDirection addr 0x11c5460 size 0xfc virtual false final false
  static inline ::RootMotion::Axis GetAxisToDirection(::UnityEngine::Transform* t, ::UnityEngine::Vector3 direction);

  /// @brief Method GetAxisVectorToPoint addr 0x11c5414 size 0x4c virtual false final false
  static inline ::UnityEngine::Vector3 GetAxisVectorToPoint(::UnityEngine::Transform* t, ::UnityEngine::Vector3 worldPosition);

  /// @brief Method GetAxisVectorToDirection addr 0x11c555c size 0x44 virtual false final false
  static inline ::UnityEngine::Vector3 GetAxisVectorToDirection(::UnityEngine::Transform* t, ::UnityEngine::Vector3 direction);

  /// @brief Method GetAxisVectorToDirection addr 0x11c55a0 size 0x48c virtual false final false
  ...
  /// @brief Method .ctor addr 0x11c5a2c size 0x8 virtual false final false
  inline void _ctor();
