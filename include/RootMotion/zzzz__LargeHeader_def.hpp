...
public:
  ...
  /// @brief Method .ctor, addr 0x12d908c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  static inline ::RootMotion::LargeHeader* New_ctor(::StringW name, ::StringW color);

  /// @brief Method .ctor, addr 0x12d90f4, size 0x68, virtual false, abstract: false, final false
