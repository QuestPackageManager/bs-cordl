...
public:
  ...
  /// @brief Method MoveNext, addr 0x136ce80, size 0xe4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::RootMotion::FinalIK::__AimController___TurnToTarget_d__33* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x136cf64, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x136cf6c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x136cfac, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x136ce7c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x136cd70, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyMinDistance, addr 0x136c8e0, size 0x184, virtual false, abstract: false, final false
  inline void ApplyMinDistance();

  /// @brief Method LateUpdate, addr 0x136c3b4, size 0x52c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::RootMotion::FinalIK::AimController* New_ctor();

  /// @brief Method RootRotation, addr 0x136ca64, size 0x2a4, virtual false, abstract: false, final false
  inline void RootRotation();

  /// @brief Method Start, addr 0x136c2b4, size 0x7c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TurnToTarget, addr 0x136cd08, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x136cd98, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pivot, addr 0x136c330, size 0x84, virtual false, abstract: false, final false
