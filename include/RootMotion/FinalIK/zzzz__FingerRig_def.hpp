...
public:
  ...
  /// @brief Method AddChildrenRecursive, addr 0x13482d8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddFinger, addr 0x13483c0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoDetect, addr 0x13480b4, size 0x224, virtual false, abstract: false, final false
  inline void AutoDetect();

  /// @brief Method FixFingerTransforms, addr 0x1348798, size 0x68, virtual false, abstract: false, final false
  inline void FixFingerTransforms();

  /// @brief Method FixTransforms, addr 0x1348860, size 0x14, virtual true, abstract: false, final false
  inline void FixTransforms();

  /// @brief Method InitiateSolver, addr 0x134868c, size 0xa8, virtual true, abstract: false, final false
  inline void InitiateSolver();

  /// @brief Method IsValid, addr 0x1348040, size 0x74, virtual false, abstract: false, final false
  inline bool IsValid(ByRef<::StringW> errorMessage);

  static inline ::RootMotion::FinalIK::FingerRig* New_ctor();

  /// @brief Method RemoveFinger, addr 0x134852c, size 0x160, virtual false, abstract: false, final false
  inline void RemoveFinger(int32_t index);

  /// @brief Method StoreDefaultLocalState, addr 0x1348800, size 0x5c, virtual false, abstract: false, final false
  inline void StoreDefaultLocalState();

  /// @brief Method UpdateFingerSolvers, addr 0x1348734, size 0x64, virtual false, abstract: false, final false
  inline void UpdateFingerSolvers();

  /// @brief Method UpdateSolver, addr 0x134885c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1348874, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_initiated, addr 0x134802c, size 0x8, virtual false, abstract: false, final false
  inline bool get_initiated();

  /// @brief Method set_initiated, addr 0x1348034, size 0xc, virtual false, abstract: false, final false
