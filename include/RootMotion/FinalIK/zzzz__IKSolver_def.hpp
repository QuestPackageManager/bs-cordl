...
public:
  ...
  /// @brief Method StoreDefaultLocalState addr 0x125ec54 size 0x44 virtual false final false
  inline void StoreDefaultLocalState();

  /// @brief Method FixTransform addr 0x125ec98 size 0xe0 virtual false final false
  inline void FixTransform();

  /// @brief Method UpdateSolverPosition addr 0x125ed78 size 0x2c virtual false final false
  inline void UpdateSolverPosition();

  /// @brief Method UpdateSolverLocalPosition addr 0x125eda4 size 0x2c virtual false final false
  inline void UpdateSolverLocalPosition();

  /// @brief Method UpdateSolverState addr 0x125edd0 size 0x44 virtual false final false
  inline void UpdateSolverState();

  /// @brief Method UpdateSolverLocalState addr 0x125ee14 size 0x44 virtual false final false
  inline void UpdateSolverLocalState();

  static inline ::RootMotion::FinalIK::__IKSolver__Point* New_ctor();

  /// @brief Method .ctor addr 0x125ee58 size 0x60 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_rotationLimit addr 0x125eeb8 size 0xe0 virtual false final false
  inline ::RootMotion::FinalIK::RotationLimit* get_rotationLimit();

  /// @brief Method set_rotationLimit addr 0x125ef98 size 0x78 virtual false final false
  inline void set_rotationLimit(::RootMotion::FinalIK::RotationLimit* value);

  /// @brief Method Swing addr 0x125f010 size 0x26c virtual false final false
  inline void Swing(::UnityEngine::Vector3 swingTarget, float_t weight);

  /// @brief Method SolverSwing addr 0x125f27c size 0x2bc virtual false final false
  ...
  /// @brief Method Swing2D addr 0x125f538 size 0x1f4 virtual false final false
  inline void Swing2D(::UnityEngine::Vector3 swingTarget, float_t weight);

  /// @brief Method SetToSolverPosition addr 0x125f72c size 0x28 virtual false final false
  inline void SetToSolverPosition();

  static inline ::RootMotion::FinalIK::__IKSolver__Bone* New_ctor();

  /// @brief Method .ctor addr 0x125f754 size 0x6c virtual false final false
  inline void _ctor();

  static inline ::RootMotion::FinalIK::__IKSolver__Bone* New_ctor(::UnityEngine::Transform* transform);

  /// @brief Method .ctor addr 0x125f7c0 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x125f838 size 0x88 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x125f8c0 size 0x4 virtual false final false
  inline void _ctor();

  static inline ::RootMotion::FinalIK::__IKSolver__Node* New_ctor(::UnityEngine::Transform* transform);

  /// @brief Method .ctor addr 0x125f8c4 size 0x24 virtual false final false
  inline void _ctor(::UnityEngine::Transform* transform);

  static inline ::RootMotion::FinalIK::__IKSolver__Node* New_ctor(::UnityEngine::Transform* transform, float_t weight);

  /// @brief Method .ctor addr 0x125f8e8 size 0x34 virtual false final false
  inline void _ctor(::UnityEngine::Transform* transform, float_t weight);
...
public:
  ...
  /// @brief Method .ctor addr 0x125f91c size 0xbc virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x125f9d8 size 0x14 virtual true final false
  inline void Invoke();

  /// @brief Method BeginInvoke addr 0x125f9ec size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x125fa0c size 0xc virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0x125fa18 size 0xc4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x125fadc size 0x14 virtual true final false
  inline void Invoke(int32_t i);

  /// @brief Method BeginInvoke addr 0x125faf0 size 0x84 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(int32_t i, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x125fb74 size 0xc virtual true final false
  inline void EndInvoke(::System::IAsyncResult* result);
...
public:
  ...
  /// @brief Method IsValid addr 0x125e5c8 size 0x74 virtual false final false
  inline bool IsValid();

  /// @brief Method IsValid addr 0x0 size 0xffffffffffffffff virtual true final false
  inline bool IsValid(ByRef<::StringW> message);

  /// @brief Method Initiate addr 0x125e63c size 0x170 virtual false final false
  inline void Initiate(::UnityEngine::Transform* root);

  /// @brief Method Update addr 0x125e7ac size 0x70 virtual false final false
  inline void Update();

  /// @brief Method GetIKPosition addr 0x125e81c size 0xc virtual true final false
  inline ::UnityEngine::Vector3 GetIKPosition();

  /// @brief Method SetIKPosition addr 0x125e828 size 0xc virtual false final false
  inline void SetIKPosition(::UnityEngine::Vector3 position);

  /// @brief Method GetIKPositionWeight addr 0x125e834 size 0x8 virtual false final false
  inline float_t GetIKPositionWeight();

  /// @brief Method SetIKPositionWeight addr 0x125e83c size 0x1c virtual false final false
  inline void SetIKPositionWeight(float_t weight);

  /// @brief Method GetRoot addr 0x125e858 size 0x8 virtual false final false
  inline ::UnityEngine::Transform* GetRoot();

  /// @brief Method get_initiated addr 0x125e860 size 0x8 virtual false final false
  inline bool get_initiated();

  /// @brief Method set_initiated addr 0x125e868 size 0xc virtual false final false
  ...
  /// @brief Method LogWarning addr 0x125e874 size 0x18 virtual false final false
  inline void LogWarning(::StringW message);

  /// @brief Method ContainsDuplicateBone addr 0x125e88c size 0x124 virtual false final false
  ...
  /// @brief Method HierarchyIsValid addr 0x125e9b0 size 0x98 virtual false final false
  ...
  /// @brief Method PreSolveBones addr 0x125ea48 size 0x1f4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x125ec3c size 0x18 virtual false final false
  inline void _ctor();
