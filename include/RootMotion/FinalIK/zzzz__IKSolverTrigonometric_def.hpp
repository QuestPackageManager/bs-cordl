...
public:
  ...
  /// @brief Method GetRotation, addr 0x1270d68, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetRotation(::UnityEngine::Vector3 direction, ::UnityEngine::Vector3 bendNormal);

  /// @brief Method GetBendNormalFromCurrentRotation, addr 0x126ba9c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1270e04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetBendPlaneToCurrent, addr 0x126f3b8, size 0x180, virtual false, abstract: false, final false
  inline void SetBendPlaneToCurrent();

  /// @brief Method SetIKRotation, addr 0x126f538, size 0xc, virtual false, abstract: false, final false
  inline void SetIKRotation(::UnityEngine::Quaternion rotation);

  /// @brief Method SetIKRotationWeight, addr 0x126f544, size 0x1c, virtual false, abstract: false, final false
  inline void SetIKRotationWeight(float_t weight);

  /// @brief Method GetIKRotation, addr 0x126f560, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetIKRotation();

  /// @brief Method GetIKRotationWeight, addr 0x126f56c, size 0x8, virtual false, abstract: false, final false
  inline float_t GetIKRotationWeight();

  /// @brief Method GetPoints, addr 0x126f574, size 0xec, virtual true, abstract: false, final false
  inline ::ArrayW<::RootMotion::FinalIK::__IKSolver__Point*, ::Array<::RootMotion::FinalIK::__IKSolver__Point*>*> GetPoints();

  /// @brief Method GetPoint, addr 0x126f660, size 0xf8, virtual true, abstract: false, final false
  inline ::RootMotion::FinalIK::__IKSolver__Point* GetPoint(::UnityEngine::Transform* transform);

  /// @brief Method StoreDefaultLocalState, addr 0x126f758, size 0x40, virtual true, abstract: false, final false
  inline void StoreDefaultLocalState();

  /// @brief Method FixTransforms, addr 0x126f798, size 0x50, virtual true, abstract: false, final false
  inline void FixTransforms();

  /// @brief Method IsValid, addr 0x126f7e8, size 0x3a4, virtual true, abstract: false, final false
  inline bool IsValid(ByRef<::StringW> message);

  /// @brief Method SetChain, addr 0x126fb8c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Solve, addr 0x126fbd8, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDirectionToBendPoint, addr 0x12700cc, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInitiate, addr 0x1270224, size 0x12c, virtual true, abstract: false, final false
  inline void OnInitiate();

  /// @brief Method IsDirectHierarchy, addr 0x12703d0, size 0xf0, virtual false, abstract: false, final false
  inline bool IsDirectHierarchy();

  /// @brief Method InitiateBones, addr 0x1270350, size 0x80, virtual false, abstract: false, final false
  inline void InitiateBones();

  /// @brief Method OnUpdate, addr 0x12705b0, size 0x5f8, virtual true, abstract: false, final false
  inline void OnUpdate();

  /// @brief Method OnInitiateVirtual, addr 0x1270df8, size 0x4, virtual true, abstract: false, final false
  inline void OnInitiateVirtual();

  /// @brief Method OnUpdateVirtual, addr 0x1270dfc, size 0x4, virtual true, abstract: false, final false
  inline void OnUpdateVirtual();

  /// @brief Method OnPostSolveVirtual, addr 0x1270e00, size 0x4, virtual true, abstract: false, final false
  inline void OnPostSolveVirtual();

  /// @brief Method GetBendDirection, addr 0x1270ba8, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x126cc44, size 0x128, virtual false, abstract: false, final false
  inline void _ctor();
