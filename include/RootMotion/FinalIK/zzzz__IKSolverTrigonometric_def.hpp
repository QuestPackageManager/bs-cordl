...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(8996)), TypeDefinitionIndex(TypeDefinitionIndex(12458))]
...
public:
  ...
  /// @brief Method Initiate, addr 0x1309570, size 0xf0, virtual false, abstract: false, final false
  inline void Initiate(::UnityEngine::Vector3 childPosition, ::UnityEngine::Vector3 bendNormal);

  /// @brief Method GetRotation, addr 0x1309e18, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetRotation(::UnityEngine::Vector3 direction, ::UnityEngine::Vector3 bendNormal);

  /// @brief Method GetBendNormalFromCurrentRotation, addr 0x1304b4c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1309eb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(8996)), TypeDefinitionIndex(TypeDefinitionIndex(12462))]
...
public:
  ...
  /// @brief Method SetBendGoalPosition, addr 0x13082d4, size 0x194, virtual false, abstract: false, final false
  inline void SetBendGoalPosition(::UnityEngine::Vector3 goalPosition, float_t weight);

  /// @brief Method SetBendPlaneToCurrent, addr 0x1308468, size 0x180, virtual false, abstract: false, final false
  inline void SetBendPlaneToCurrent();

  /// @brief Method SetIKRotation, addr 0x13085e8, size 0xc, virtual false, abstract: false, final false
  inline void SetIKRotation(::UnityEngine::Quaternion rotation);

  /// @brief Method SetIKRotationWeight, addr 0x13085f4, size 0x1c, virtual false, abstract: false, final false
  inline void SetIKRotationWeight(float_t weight);

  /// @brief Method GetIKRotation, addr 0x1308610, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetIKRotation();

  /// @brief Method GetIKRotationWeight, addr 0x130861c, size 0x8, virtual false, abstract: false, final false
  inline float_t GetIKRotationWeight();

  /// @brief Method GetPoints, addr 0x1308624, size 0xec, virtual true, abstract: false, final false
  inline ::ArrayW<::RootMotion::FinalIK::__IKSolver__Point*, ::Array<::RootMotion::FinalIK::__IKSolver__Point*>*> GetPoints();

  /// @brief Method GetPoint, addr 0x1308710, size 0xf8, virtual true, abstract: false, final false
  inline ::RootMotion::FinalIK::__IKSolver__Point* GetPoint(::UnityEngine::Transform* transform);

  /// @brief Method StoreDefaultLocalState, addr 0x1308808, size 0x40, virtual true, abstract: false, final false
  inline void StoreDefaultLocalState();

  /// @brief Method FixTransforms, addr 0x1308848, size 0x50, virtual true, abstract: false, final false
  inline void FixTransforms();

  /// @brief Method IsValid, addr 0x1308898, size 0x3a4, virtual true, abstract: false, final false
  inline bool IsValid(ByRef<::StringW> message);

  /// @brief Method SetChain, addr 0x1308c3c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method Solve, addr 0x1308c88, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDirectionToBendPoint, addr 0x130917c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method OnInitiate, addr 0x13092d4, size 0x12c, virtual true, abstract: false, final false
  inline void OnInitiate();

  /// @brief Method IsDirectHierarchy, addr 0x1309480, size 0xf0, virtual false, abstract: false, final false
  inline bool IsDirectHierarchy();

  /// @brief Method InitiateBones, addr 0x1309400, size 0x80, virtual false, abstract: false, final false
  inline void InitiateBones();

  /// @brief Method OnUpdate, addr 0x1309660, size 0x5f8, virtual true, abstract: false, final false
  inline void OnUpdate();

  /// @brief Method OnInitiateVirtual, addr 0x1309ea8, size 0x4, virtual true, abstract: false, final false
  inline void OnInitiateVirtual();

  /// @brief Method OnUpdateVirtual, addr 0x1309eac, size 0x4, virtual true, abstract: false, final false
  inline void OnUpdateVirtual();

  /// @brief Method OnPostSolveVirtual, addr 0x1309eb0, size 0x4, virtual true, abstract: false, final false
  inline void OnPostSolveVirtual();

  /// @brief Method GetBendDirection, addr 0x1309c58, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1305cf4, size 0x128, virtual false, abstract: false, final false
  inline void _ctor();
