...
public:
  ...
  /// @brief Method .ctor, addr 0x1332424, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Start, addr 0x1331274, size 0xd4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Apply, addr 0x1331dd0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1332410, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(8996)), TypeDefinitionIndex(TypeDefinitionIndex(12554)),
// TypeDefinitionIndex(TypeDefinitionIndex(12564))] Self: TypeDefinitionIndex(TypeDefinitionIndex(12565)) CS Name: ::RootMotion.FinalIK::Recoil*
...
public:
  ...
  /// @brief Method get_isFinished, addr 0x13310d8, size 0x24, virtual false, abstract: false, final false
  inline bool get_isFinished();

  /// @brief Method SetHandRotations, addr 0x13310fc, size 0x2c, virtual false, abstract: false, final false
  inline void SetHandRotations(::UnityEngine::Quaternion leftHandRotation, ::UnityEngine::Quaternion rightHandRotation);

  /// @brief Method Fire, addr 0x1331128, size 0x14c, virtual false, abstract: false, final false
  inline void Fire(float_t magnitude);

  /// @brief Method OnModifyOffset, addr 0x1331348, size 0xa88, virtual true, abstract: false, final false
  inline void OnModifyOffset();

  /// @brief Method AfterFBBIK, addr 0x133204c, size 0x118, virtual false, abstract: false, final false
  inline void AfterFBBIK();

  /// @brief Method AfterAimIK, addr 0x1332164, size 0x50, virtual false, abstract: false, final false
  inline void AfterAimIK();

  /// @brief Method get_primaryHandEffector, addr 0x1331fd4, size 0x3c, virtual false, abstract: false, final false
  inline ::RootMotion::FinalIK::IKEffector* get_primaryHandEffector();

  /// @brief Method get_secondaryHandEffector, addr 0x1332010, size 0x3c, virtual false, abstract: false, final false
  inline ::RootMotion::FinalIK::IKEffector* get_secondaryHandEffector();

  /// @brief Method get_primaryHand, addr 0x1331f9c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_primaryHand();

  /// @brief Method get_secondaryHand, addr 0x1331fb8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_secondaryHand();

  /// @brief Method OnDestroy, addr 0x13321b4, size 0x1d0, virtual true, abstract: false, final false
  inline void OnDestroy();

  static inline ::RootMotion::FinalIK::Recoil* New_ctor();

  /// @brief Method .ctor, addr 0x1332384, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
