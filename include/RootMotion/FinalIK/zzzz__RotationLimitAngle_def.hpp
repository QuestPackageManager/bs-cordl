...
public:
  ...
  /// @brief Method OpenUserManual addr 0x121e300 size 0x44 virtual false final false
  inline void OpenUserManual();

  /// @brief Method OpenScriptReference addr 0x121e344 size 0x44 virtual false final false
  inline void OpenScriptReference();

  /// @brief Method SupportGroup addr 0x121e388 size 0x44 virtual false final false
  inline void SupportGroup();

  /// @brief Method ASThread addr 0x121e3cc size 0x44 virtual false final false
  inline void ASThread();

  /// @brief Method LimitRotation addr 0x121e410 size 0x38 virtual true final false
  inline ::UnityEngine::Quaternion LimitRotation(::UnityEngine::Quaternion rotation);

  /// @brief Method LimitSwing addr 0x121e448 size 0x324 virtual false final false
  ...
  /// @brief Method .ctor addr 0x121e76c size 0x10 virtual false final false
  inline void _ctor();
