...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::BipedIKSolvers::*)(::RootMotion::BipedReferences*)>(
  ...
  constexpr static std::size_t addrs = 0x11d1980;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::BipedIKSolvers*>::get(), "AssignReferences", std::vector<Il2CppClass*>{},
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLimb*> const& RootMotion::FinalIK::BipedIKSolvers::__get_leftFoot() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___leftFoot;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLimb*> const& RootMotion::FinalIK::BipedIKSolvers::__get_rightFoot() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___rightFoot;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLimb*> const& RootMotion::FinalIK::BipedIKSolvers::__get_leftHand() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___leftHand;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLimb*> const& RootMotion::FinalIK::BipedIKSolvers::__get_rightHand() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___rightHand;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverFABRIK*> const& RootMotion::FinalIK::BipedIKSolvers::__get_spine() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___spine;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLookAt*> const& RootMotion::FinalIK::BipedIKSolvers::__get_lookAt() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___lookAt;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverAim*> const& RootMotion::FinalIK::BipedIKSolvers::__get_aim() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___aim;
}
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::Constraints*> const& RootMotion::FinalIK::BipedIKSolvers::__get_pelvis() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___pelvis;
}
