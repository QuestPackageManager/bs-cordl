...
public:
  ...
  /// @brief Method OpenScriptReference, addr 0x1292cd4, size 0x44, virtual false, abstract: false, final false
  inline void OpenScriptReference();

  /// @brief Method SupportGroup, addr 0x1292d18, size 0x44, virtual false, abstract: false, final false
  inline void SupportGroup();

  /// @brief Method ASThread, addr 0x1292d5c, size 0x44, virtual false, abstract: false, final false
  inline void ASThread();

  /// @brief Method SetSpline, addr 0x1292da0, size 0x1c, virtual false, abstract: false, final false
  inline void SetSpline(::ArrayW<::UnityEngine::Keyframe, ::Array<::UnityEngine::Keyframe>*> keyframes);

  /// @brief Method LimitRotation, addr 0x1292dbc, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::Quaternion LimitRotation(::UnityEngine::Quaternion rotation);

  /// @brief Method LimitSwing, addr 0x1292e50, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1293208, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
