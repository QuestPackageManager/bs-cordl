...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(12554))]
...
public:
  ...
  /// @brief Method Start, addr 0x132cadc, size 0x48, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method OnModifyOffset, addr 0x132cb44, size 0x1ec, virtual true, abstract: false, final false
  inline void OnModifyOffset();

  static inline ::RootMotion::FinalIK::BodyTilt* New_ctor();

  /// @brief Method .ctor, addr 0x132cde4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
