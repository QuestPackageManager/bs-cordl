...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::Constraint::*)()>(&::RootMotion::FinalIK::Constraint::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x11d23c0;
...
inline void RootMotion::FinalIK::Constraint::UpdateConstraint() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::Constraint*>::get(), "UpdateConstraint",
                                                                             std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
