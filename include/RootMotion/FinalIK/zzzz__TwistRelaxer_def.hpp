...
public:
  ...
  /// @brief Method Relax, addr 0x131af00, size 0x444, virtual false, abstract: false, final false
  inline void Relax();

  /// @brief Method Start, addr 0x131b344, size 0x3a0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnPostUpdate, addr 0x131b6e4, size 0x78, virtual false, abstract: false, final false
  inline void OnPostUpdate();

  /// @brief Method LateUpdate, addr 0x131b75c, size 0x78, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method OnDestroy, addr 0x131b7d4, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  static inline ::RootMotion::FinalIK::TwistRelaxer* New_ctor();

  /// @brief Method .ctor, addr 0x131b8ec, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
