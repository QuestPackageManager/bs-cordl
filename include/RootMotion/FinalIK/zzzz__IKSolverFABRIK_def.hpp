...
public:
  ...
  /// @brief Method SolveForward addr 0x11f2d4c size 0xd8 virtual false final false
  inline void SolveForward(::UnityEngine::Vector3 position);

  /// @brief Method SolveBackward addr 0x11f332c size 0xd8 virtual false final false
  inline void SolveBackward(::UnityEngine::Vector3 position);

  /// @brief Method GetIKPosition addr 0x11f345c size 0x88 virtual true final false
  inline ::UnityEngine::Vector3 GetIKPosition();

  /// @brief Method OnInitiate addr 0x11f34e4 size 0x270 virtual true final false
  inline void OnInitiate();

  /// @brief Method OnUpdate addr 0x11f39dc size 0x2f0 virtual true final false
  inline void OnUpdate();

  /// @brief Method get_boneLengthCanBeZero addr 0x11f3d14 size 0x8 virtual true final false
  inline bool get_boneLengthCanBeZero();

  /// @brief Method SolveJoint addr 0x11f3d1c size 0x11c virtual false final false
  inline ::UnityEngine::Vector3 SolveJoint(::UnityEngine::Vector3 pos1, ::UnityEngine::Vector3 pos2, float_t length);

  /// @brief Method OnPreSolve addr 0x11f2e24 size 0x39c virtual false final false
  inline void OnPreSolve();

  /// @brief Method OnPostSolve addr 0x11f3414 size 0x48 virtual false final false
  inline void OnPostSolve();

  /// @brief Method Solve addr 0x11f3ccc size 0x48 virtual false final false
  inline void Solve(::UnityEngine::Vector3 targetPosition);

  /// @brief Method ForwardReach addr 0x11f31c0 size 0x16c virtual false final false
  inline void ForwardReach(::UnityEngine::Vector3 position);

  /// @brief Method SolverMove addr 0x11f43c8 size 0x68 virtual false final false
  inline void SolverMove(int32_t index, ::UnityEngine::Vector3 offset);

  /// @brief Method SolverRotate addr 0x11f4430 size 0xd0 virtual false final false
  inline void SolverRotate(int32_t index, ::UnityEngine::Quaternion rotation, bool recursive);

  /// @brief Method SolverRotateChildren addr 0x11f4500 size 0xc8 virtual false final false
  inline void SolverRotateChildren(int32_t index, ::UnityEngine::Quaternion rotation);

  /// @brief Method SolverMoveChildrenAroundPoint addr 0x11f45c8 size 0xf0 virtual false final false
  inline void SolverMoveChildrenAroundPoint(int32_t index, ::UnityEngine::Quaternion rotation);

  /// @brief Method GetParentSolverRotation addr 0x11f3754 size 0x144 virtual false final false
  inline ::UnityEngine::Quaternion GetParentSolverRotation(int32_t index);

  /// @brief Method GetParentSolverPosition addr 0x11f3898 size 0x144 virtual false final false
  inline ::UnityEngine::Vector3 GetParentSolverPosition(int32_t index);

  /// @brief Method GetLimitedRotation addr 0x11f46b8 size 0x1c0 virtual false final false
  inline ::UnityEngine::Quaternion GetLimitedRotation(int32_t index, ::UnityEngine::Quaternion q, ByRef<bool> changed);

  /// @brief Method LimitForward addr 0x11f3fb8 size 0x410 virtual false final false
  inline void LimitForward(int32_t rotateBone, int32_t limitBone);

  /// @brief Method BackwardReach addr 0x11f3404 size 0x10 virtual false final false
  inline void BackwardReach(::UnityEngine::Vector3 position);

  /// @brief Method BackwardReachUnlimited addr 0x11f4d28 size 0xb8 virtual false final false
  inline void BackwardReachUnlimited(::UnityEngine::Vector3 position);

  /// @brief Method BackwardReachLimited addr 0x11f4878 size 0x4b0 virtual false final false
  inline void BackwardReachLimited(::UnityEngine::Vector3 position);

  /// @brief Method MapToSolverPositions addr 0x11f3e38 size 0xd0 virtual false final false
  inline void MapToSolverPositions();

  /// @brief Method MapToSolverPositionsLimited addr 0x11f3f08 size 0xb0 virtual false final false
  inline void MapToSolverPositionsLimited();

  static inline ::RootMotion::FinalIK::IKSolverFABRIK* New_ctor();

  /// @brief Method .ctor addr 0x11f4de0 size 0x80 virtual false final false
  inline void _ctor();
