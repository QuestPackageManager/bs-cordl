...
public:
  ...
  /// @brief Method OpenUserManual, addr 0x12dc51c, size 0x44, virtual false, abstract: false, final false
  inline void OpenUserManual();

  /// @brief Method OpenScriptReference, addr 0x12dc560, size 0x44, virtual false, abstract: false, final false
  inline void OpenScriptReference();

  /// @brief Method SupportGroup, addr 0x12dc5a4, size 0x44, virtual false, abstract: false, final false
  inline void SupportGroup();

  /// @brief Method ASThread, addr 0x12dc5e8, size 0x44, virtual false, abstract: false, final false
  inline void ASThread();

  /// @brief Method GetIKPositionWeight, addr 0x12dc62c, size 0x1c, virtual false, abstract: false, final false
  inline float_t GetIKPositionWeight(::UnityEngine::AvatarIKGoal goal);

  /// @brief Method GetIKRotationWeight, addr 0x12dc6c4, size 0x1c, virtual false, abstract: false, final false
  inline float_t GetIKRotationWeight(::UnityEngine::AvatarIKGoal goal);

  /// @brief Method SetIKPositionWeight, addr 0x12dc6e0, size 0x2c, virtual false, abstract: false, final false
  inline void SetIKPositionWeight(::UnityEngine::AvatarIKGoal goal, float_t weight);

  /// @brief Method SetIKRotationWeight, addr 0x12dc70c, size 0x2c, virtual false, abstract: false, final false
  inline void SetIKRotationWeight(::UnityEngine::AvatarIKGoal goal, float_t weight);

  /// @brief Method SetIKPosition, addr 0x12dc738, size 0x3c, virtual false, abstract: false, final false
  inline void SetIKPosition(::UnityEngine::AvatarIKGoal goal, ::UnityEngine::Vector3 IKPosition);

  /// @brief Method SetIKRotation, addr 0x12dc774, size 0x40, virtual false, abstract: false, final false
  inline void SetIKRotation(::UnityEngine::AvatarIKGoal goal, ::UnityEngine::Quaternion IKRotation);

  /// @brief Method GetIKPosition, addr 0x12dc7b4, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetIKPosition(::UnityEngine::AvatarIKGoal goal);

  /// @brief Method GetIKRotation, addr 0x12dc7d4, size 0x20, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion GetIKRotation(::UnityEngine::AvatarIKGoal goal);

  /// @brief Method SetLookAtWeight, addr 0x12dc7f4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLookAtPosition, addr 0x12dc818, size 0x28, virtual false, abstract: false, final false
  inline void SetLookAtPosition(::UnityEngine::Vector3 lookAtPosition);

  /// @brief Method SetSpinePosition, addr 0x12dc840, size 0x28, virtual false, abstract: false, final false
  inline void SetSpinePosition(::UnityEngine::Vector3 spinePosition);

  /// @brief Method SetSpineWeight, addr 0x12dc868, size 0x24, virtual false, abstract: false, final false
  inline void SetSpineWeight(float_t weight);

  /// @brief Method GetGoalIK, addr 0x12dc648, size 0x7c, virtual false, abstract: false, final false
  inline ::RootMotion::FinalIK::IKSolverLimb* GetGoalIK(::UnityEngine::AvatarIKGoal goal);

  /// @brief Method InitiateBipedIK, addr 0x12dc88c, size 0xc, virtual false, abstract: false, final false
  inline void InitiateBipedIK();

  /// @brief Method UpdateBipedIK, addr 0x12dc898, size 0xc, virtual false, abstract: false, final false
  inline void UpdateBipedIK();

  /// @brief Method SetToDefaults, addr 0x12dc8a4, size 0x13c, virtual false, abstract: false, final false
  inline void SetToDefaults();

  /// @brief Method FixTransforms, addr 0x12dcb10, size 0x9c, virtual true, abstract: false, final false
  inline void FixTransforms();

  /// @brief Method InitiateSolver, addr 0x12dcbac, size 0x1b0, virtual true, abstract: false, final false
  inline void InitiateSolver();

  /// @brief Method UpdateSolver, addr 0x12dcecc, size 0x174, virtual true, abstract: false, final false
  inline void UpdateSolver();

  /// @brief Method LogWarning, addr 0x12dd338, size 0x24, virtual false, abstract: false, final false
  inline void LogWarning(::StringW message);

  static inline ::RootMotion::FinalIK::BipedIK* New_ctor();

  /// @brief Method .ctor, addr 0x12dd35c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
