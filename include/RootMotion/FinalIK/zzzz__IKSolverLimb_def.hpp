...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(10249)), TypeDefinitionIndex(TypeDefinitionIndex(10252)), TypeDefinitionIndex(TypeDefinitionIndex(12576)),
// TypeDefinitionIndex(TypeDefinitionIndex(12582)), TypeDefinitionIndex(TypeDefinitionIndex(14871))] Self: TypeDefinitionIndex(TypeDefinitionIndex(12578)) CS Name: ::RootMotion.FinalIK::IKSolverLimb*
