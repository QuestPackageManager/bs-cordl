...
public:
  ...
  /// @brief Method .ctor addr 0x121c78c size 0x154 virtual false final false
  inline void _ctor(::UnityEngine::Rigidbody* r);

  /// @brief Method RecordVelocity addr 0x121d2d4 size 0xd4 virtual false final false
  inline void RecordVelocity();

  /// @brief Method WakeUp addr 0x121d094 size 0x240 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x121c8e0 size 0x5c virtual false final false
  inline void _ctor(::UnityEngine::Transform* transform);

  /// @brief Method FixTransform addr 0x121d3ec size 0x110 virtual false final false
  inline void FixTransform(float_t weight);

  /// @brief Method StoreLocalState addr 0x121d3a8 size 0x44 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x121c93c size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x121d70c size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x121d710 size 0x1e0 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x121d8f0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x121d8f8 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x121d938 size 0x8 virtual true final true
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15104)), TypeDefinitionIndex(TypeDefinitionIndex(10152))}
...
public:
  ...
  /// @brief Method EnableRagdoll addr 0x121c1e4 size 0x2c virtual false final false
  inline void EnableRagdoll();

  /// @brief Method DisableRagdoll addr 0x121c274 size 0x48 virtual false final false
  inline void DisableRagdoll();

  /// @brief Method Start addr 0x121c380 size 0x40c virtual false final false
  inline void Start();

  /// @brief Method DisableRagdollSmooth addr 0x121c318 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* DisableRagdollSmooth();

  /// @brief Method Update addr 0x121c964 size 0x228 virtual false final false
  inline void Update();

  /// @brief Method FixedUpdate addr 0x121cb8c size 0x34 virtual false final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate addr 0x121cc2c size 0x70 virtual false final false
  inline void LateUpdate();

  /// @brief Method AfterLastIK addr 0x121ce1c size 0x24 virtual false final false
  inline void AfterLastIK();

  /// @brief Method AfterAnimation addr 0x121cc9c size 0x2c virtual false final false
  inline void AfterAnimation();

  /// @brief Method OnFinalPose addr 0x121cde8 size 0x34 virtual false final false
  inline void OnFinalPose();

  /// @brief Method RagdollEnabler addr 0x121ce9c size 0x1f8 virtual false final false
  inline void RagdollEnabler();

  /// @brief Method get_isRagdoll addr 0x121c210 size 0x64 virtual false final false
  inline bool get_isRagdoll();

  /// @brief Method RecordVelocities addr 0x121ce40 size 0x5c virtual false final false
  inline void RecordVelocities();

  /// @brief Method get_ikUsed addr 0x121ccc8 size 0x120 virtual false final false
  inline bool get_ikUsed();

  /// @brief Method StoreLocalState addr 0x121c2bc size 0x5c virtual false final false
  inline void StoreLocalState();

  /// @brief Method FixTransforms addr 0x121cbc0 size 0x6c virtual false final false
  inline void FixTransforms(float_t weight);

  /// @brief Method OnDestroy addr 0x121d4fc size 0x118 virtual false final false
  inline void OnDestroy();

  static inline ::RootMotion::FinalIK::RagdollUtility* New_ctor();

  /// @brief Method .ctor addr 0x121d614 size 0xf8 virtual false final false
  inline void _ctor();
