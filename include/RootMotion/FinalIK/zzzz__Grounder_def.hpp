...
public:
  ...
  /// @brief Method .ctor addr 0x11d4488 size 0xbc virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x11d4544 size 0x14 virtual true final false
  inline void Invoke();

  /// @brief Method BeginInvoke addr 0x11d4558 size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x11d4578 size 0xc virtual true final false
...
public:
  ...
  /// @brief Method get_initiated addr 0x11d3fbc size 0x8 virtual false final false
  inline bool get_initiated();

  /// @brief Method set_initiated addr 0x11d3fc4 size 0xc virtual false final false
  inline void set_initiated(bool value);

  /// @brief Method GetSpineOffsetTarget addr 0x11d3fd0 size 0xc4 virtual false final false
  inline ::UnityEngine::Vector3 GetSpineOffsetTarget();

  /// @brief Method LogWarning addr 0x11d4280 size 0x24 virtual false final false
  inline void LogWarning(::StringW message);

  /// @brief Method GetLegSpineBendVector addr 0x11d4094 size 0x1ec virtual false final false
  inline ::UnityEngine::Vector3 GetLegSpineBendVector(::RootMotion::FinalIK::__Grounding__Leg* leg);

  /// @brief Method GetLegSpineTangent addr 0x11d42a4 size 0x174 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11d4418 size 0x70 virtual false final false
  inline void _ctor();
