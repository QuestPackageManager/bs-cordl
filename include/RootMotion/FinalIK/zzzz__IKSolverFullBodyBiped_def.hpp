...
public:
  ...
  /// @brief Method get_bodyEffector addr 0x1267430 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_bodyEffector();

  /// @brief Method get_leftShoulderEffector addr 0x1267570 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_leftShoulderEffector();

  /// @brief Method get_rightShoulderEffector addr 0x1267578 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_rightShoulderEffector();

  /// @brief Method get_leftThighEffector addr 0x1267580 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_leftThighEffector();

  /// @brief Method get_rightThighEffector addr 0x1267588 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_rightThighEffector();

  /// @brief Method get_leftHandEffector addr 0x1267590 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_leftHandEffector();

  /// @brief Method get_rightHandEffector addr 0x1267598 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_rightHandEffector();

  /// @brief Method get_leftFootEffector addr 0x12675a0 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_leftFootEffector();

  /// @brief Method get_rightFootEffector addr 0x12675a8 size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* get_rightFootEffector();

  /// @brief Method get_leftArmChain addr 0x12675b0 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* get_leftArmChain();

  /// @brief Method get_rightArmChain addr 0x12675dc size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* get_rightArmChain();

  /// @brief Method get_leftLegChain addr 0x1267608 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* get_leftLegChain();

  /// @brief Method get_rightLegChain addr 0x1267634 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* get_rightLegChain();

  /// @brief Method get_leftArmMapping addr 0x1267660 size 0x28 virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* get_leftArmMapping();

  /// @brief Method get_rightArmMapping addr 0x1267688 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* get_rightArmMapping();

  /// @brief Method get_leftLegMapping addr 0x12676b4 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* get_leftLegMapping();

  /// @brief Method get_rightLegMapping addr 0x12676e0 size 0x2c virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* get_rightLegMapping();

  /// @brief Method get_headMapping addr 0x126770c size 0x28 virtual false final false
  inline ::RootMotion::FinalIK::IKMappingBone* get_headMapping();

  /// @brief Method SetChainWeights addr 0x1267734 size 0x50 virtual false final false
  inline void SetChainWeights(::RootMotion::FinalIK::FullBodyBipedChain c, float_t pull, float_t reach);

  /// @brief Method SetEffectorWeights addr 0x1267834 size 0x78 virtual false final false
  ...
  /// @brief Method GetChain addr 0x1267784 size 0xb0 virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* GetChain(::RootMotion::FinalIK::FullBodyBipedChain c);

  /// @brief Method GetChain addr 0x12678ac size 0xc8 virtual false final false
  inline ::RootMotion::FinalIK::FBIKChain* GetChain(::RootMotion::FinalIK::FullBodyBipedEffector effector);

  /// @brief Method GetEffector addr 0x1267438 size 0x138 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* GetEffector(::RootMotion::FinalIK::FullBodyBipedEffector effector);

  /// @brief Method GetEndEffector addr 0x1267974 size 0xb0 virtual false final false
  inline ::RootMotion::FinalIK::IKEffector* GetEndEffector(::RootMotion::FinalIK::FullBodyBipedChain c);

  /// @brief Method GetLimbMapping addr 0x1267a24 size 0xac virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* GetLimbMapping(::RootMotion::FinalIK::FullBodyBipedChain chain);

  /// @brief Method GetLimbMapping addr 0x1267ad0 size 0xac virtual false final false
  inline ::RootMotion::FinalIK::IKMappingLimb* GetLimbMapping(::RootMotion::FinalIK::FullBodyBipedEffector effector);

  /// @brief Method GetSpineMapping addr 0x1267b7c size 0x8 virtual false final false
  inline ::RootMotion::FinalIK::IKMappingSpine* GetSpineMapping();

  /// @brief Method GetHeadMapping addr 0x1267b84 size 0x28 virtual false final false
  inline ::RootMotion::FinalIK::IKMappingBone* GetHeadMapping();

  /// @brief Method GetBendConstraint addr 0x1267bac size 0xc0 virtual false final false
  inline ::RootMotion::FinalIK::IKConstraintBend* GetBendConstraint(::RootMotion::FinalIK::FullBodyBipedChain limb);

  /// @brief Method IsValid addr 0x1267c6c size 0x190 virtual true final false
  inline bool IsValid(ByRef<::StringW> message);

  /// @brief Method SetToReferences addr 0x1267dfc size 0xf80 virtual false final false
  inline void SetToReferences(::RootMotion::BipedReferences* references, ::UnityEngine::Transform* rootNode);

  /// @brief Method DetectRootNodeBone addr 0x1268d7c size 0x450 virtual false final false
  static inline ::UnityEngine::Transform* DetectRootNodeBone(::RootMotion::BipedReferences* references);

  /// @brief Method SetLimbOrientations addr 0x126932c size 0x5c virtual false final false
  inline void SetLimbOrientations(::RootMotion::BipedLimbOrientations* o);

  /// @brief Method get_pullBodyOffset addr 0x1269480 size 0xc virtual false final false
  inline ::UnityEngine::Vector3 get_pullBodyOffset();

  /// @brief Method set_pullBodyOffset addr 0x126948c size 0xc virtual false final false
  inline void set_pullBodyOffset(::UnityEngine::Vector3 value);

  /// @brief Method SetLimbOrientation addr 0x1269388 size 0xf8 virtual false final false
  ...
  /// @brief Method GetLeftClavicle addr 0x12691cc size 0xb0 virtual false final false
  static inline ::UnityEngine::Transform* GetLeftClavicle(::RootMotion::BipedReferences* references);

  /// @brief Method GetRightClavicle addr 0x126927c size 0xb0 virtual false final false
  static inline ::UnityEngine::Transform* GetRightClavicle(::RootMotion::BipedReferences* references);

  /// @brief Method Contains addr 0x1269498 size 0xc4 virtual false final false
  ...
  /// @brief Method ReadPose addr 0x126955c size 0xcc virtual true final false
  inline void ReadPose();

  /// @brief Method PullBody addr 0x1269628 size 0x11c virtual false final false
  inline void PullBody();

  /// @brief Method GetBodyOffset addr 0x1269744 size 0x190 virtual false final false
  inline ::UnityEngine::Vector3 GetBodyOffset();

  /// @brief Method GetHandBodyPull addr 0x12698d4 size 0x178 virtual false final false
  ...
  /// @brief Method ApplyBendConstraints addr 0x1269a4c size 0x25c virtual true final false
  inline void ApplyBendConstraints();

  /// @brief Method WritePose addr 0x1269ca8 size 0x78 virtual true final false
  inline void WritePose();

  static inline ::RootMotion::FinalIK::IKSolverFullBodyBiped* New_ctor();

  /// @brief Method .ctor addr 0x1269d20 size 0xc virtual false final false
  inline void _ctor();
