...
public:
  ...
  /// @brief Method Start, addr 0x132f268, size 0x68, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method LateUpdate, addr 0x132f354, size 0x4e8, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method get_pivot, addr 0x132f2d0, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_pivot();

  /// @brief Method ApplyMinDistance, addr 0x132f83c, size 0x184, virtual false, abstract: false, final false
  inline void ApplyMinDistance();

  /// @brief Method RootRotation, addr 0x132f9c0, size 0x24c, virtual false, abstract: false, final false
  inline void RootRotation();

  static inline ::RootMotion::FinalIK::LookAtController* New_ctor();

  /// @brief Method .ctor, addr 0x132fc0c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
