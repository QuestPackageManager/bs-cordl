...
public:
  ...
  /// @brief Method GetBonesOfType, addr 0x12d142c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBonesOfSide, addr 0x12d16f0, size 0x1ac, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Transform>, ::Array<::UnityW<::UnityEngine::Transform>>*>
  ...
  /// @brief Method GetBonesOfTypeAndSide, addr 0x12d1924, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityW<::UnityEngine::Transform>, ::Array<::UnityW<::UnityEngine::Transform>>*>
  ...
  /// @brief Method GetFirstBoneOfTypeAndSide, addr 0x12d1998, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNamingMatch, addr 0x12d1a2c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBoneType, addr 0x12d15d8, size 0x118, virtual false, abstract: false, final false
  static inline ::RootMotion::__BipedNaming__BoneType GetBoneType(::StringW boneName);

  /// @brief Method GetBoneSide, addr 0x12d189c, size 0x88, virtual false, abstract: false, final false
  static inline ::RootMotion::__BipedNaming__BoneSide GetBoneSide(::StringW boneName);

  /// @brief Method GetBone, addr 0x12d2164, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method isLeft, addr 0x12d1fbc, size 0xd4, virtual false, abstract: false, final false
  static inline bool isLeft(::StringW boneName);

  /// @brief Method isRight, addr 0x12d2090, size 0xd4, virtual false, abstract: false, final false
  static inline bool isRight(::StringW boneName);

  /// @brief Method isSpine, addr 0x12d1c14, size 0x9c, virtual false, abstract: false, final false
  static inline bool isSpine(::StringW boneName);

  /// @brief Method isHead, addr 0x12d1cb0, size 0x9c, virtual false, abstract: false, final false
  static inline bool isHead(::StringW boneName);

  /// @brief Method isArm, addr 0x12d1d4c, size 0x9c, virtual false, abstract: false, final false
  static inline bool isArm(::StringW boneName);

  /// @brief Method isLeg, addr 0x12d1de8, size 0x9c, virtual false, abstract: false, final false
  static inline bool isLeg(::StringW boneName);

  /// @brief Method isTail, addr 0x12d1e84, size 0x9c, virtual false, abstract: false, final false
  static inline bool isTail(::StringW boneName);

  /// @brief Method isEye, addr 0x12d1f20, size 0x9c, virtual false, abstract: false, final false
  static inline bool isEye(::StringW boneName);

  /// @brief Method isTypeExclude, addr 0x12d234c, size 0x60, virtual false, abstract: false, final false
  static inline bool isTypeExclude(::StringW boneName);

  /// @brief Method matchesNaming, addr 0x12d1b40, size 0xd4, virtual false, abstract: false, final false
  static inline bool matchesNaming(::StringW boneName, ::ArrayW<::StringW, ::Array<::StringW>*> namingConvention);

  /// @brief Method excludesNaming, addr 0x12d22c8, size 0x84, virtual false, abstract: false, final false
  static inline bool excludesNaming(::StringW boneName, ::ArrayW<::StringW, ::Array<::StringW>*> namingConvention);

  /// @brief Method matchesLastLetter, addr 0x12d23ac, size 0xc0, virtual false, abstract: false, final false
  static inline bool matchesLastLetter(::StringW boneName, ::ArrayW<::StringW, ::Array<::StringW>*> namingConvention);

  /// @brief Method LastLetterIs, addr 0x12d246c, size 0x34, virtual false, abstract: false, final false
  static inline bool LastLetterIs(::StringW boneName, ::StringW letter);

  /// @brief Method firstLetter, addr 0x12d2254, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW firstLetter(::StringW boneName);

  /// @brief Method lastLetter, addr 0x12d21e4, size 0x70, virtual false, abstract: false, final false
