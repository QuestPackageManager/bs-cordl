...
namespace RootMotion {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12399))}
...
public:
  ...
  /// @brief Method Awake addr 0x11c0af4 size 0x218 virtual false final false
  inline void Awake();

  /// @brief Method GetCharacterRoot addr 0x11c0f10 size 0x8 virtual true final false
  inline ::UnityEngine::Transform* GetCharacterRoot();

  /// @brief Method OnStartBaking addr 0x11c0f18 size 0xd0 virtual true final false
  inline void OnStartBaking();

  /// @brief Method OnSetLoopFrame addr 0x11c1104 size 0x6c virtual true final false
  inline void OnSetLoopFrame(float_t time);

  /// @brief Method OnSetCurves addr 0x11c1368 size 0x64 virtual true final false
  inline void OnSetCurves(ByRef<::UnityEngine::AnimationClip*> clip);

  /// @brief Method OnSetKeyframes addr 0x11c1680 size 0x6c virtual true final false
  inline void OnSetKeyframes(float_t time, bool lastFrame);

  /// @brief Method IsIgnored addr 0x11c0d0c size 0xb8 virtual false final false
  inline bool IsIgnored(::UnityEngine::Transform* t);

  /// @brief Method BakePosition addr 0x11c0dc4 size 0xb8 virtual false final false
  inline bool BakePosition(::UnityEngine::Transform* t);

  static inline ::RootMotion::GenericBaker* New_ctor();

  /// @brief Method .ctor addr 0x11c18e0 size 0x5c virtual false final false
  inline void _ctor();
