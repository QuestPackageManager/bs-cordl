...
public:
  ...
  /// @brief Method .ctor addr 0x11d0674 size 0xd4 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x11d0748 size 0x14 virtual true final false
  inline void Invoke(::StringW message);

  /// @brief Method BeginInvoke addr 0x11d075c size 0x20 virtual true final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW message, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke addr 0x11d077c size 0xc virtual true final false
...
public:
  ...
  /// @brief Method Log addr 0x11d05dc size 0x98 virtual false final false
  static inline void Log(::StringW message, ::RootMotion::__Warning__Logger* logger, bool logInEditMode);

  /// @brief Method Log addr 0x11ca87c size 0xb4 virtual false final false
