...
template <typename T> inline ::IgnoranceThirdparty::RingBuffer_1<T>* IgnoranceThirdparty::RingBuffer_1<T>::New_ctor(int32_t capacity) {
  return THROW_UNLESS(::il2cpp_utils::New<::IgnoranceThirdparty::RingBuffer_1<T>*>(capacity));
}
template <typename T> inline void IgnoranceThirdparty::RingBuffer_1<T>::_ctor(int32_t capacity) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
template <typename T> inline T IgnoranceThirdparty::RingBuffer_1<T>::get_Item(int64_t index) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), "get_Item", std::vector<Il2CppClass*>{},
...
template <typename T> inline void IgnoranceThirdparty::RingBuffer_1<T>::set_Item(int64_t index, T value) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), "set_Item", std::vector<Il2CppClass*>{},
      ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int64_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T>::get() })));
...
template <typename T> inline bool IgnoranceThirdparty::RingBuffer_1<T>::TryDequeue(ByRef<T> obj) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), "TryDequeue", std::vector<Il2CppClass*>{},
...
template <typename T> inline void IgnoranceThirdparty::RingBuffer_1<T>::Enqueue(T item) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), "Enqueue", std::vector<Il2CppClass*>{},
...
template <typename T> inline int32_t IgnoranceThirdparty::RingBuffer_1<T>::NextPowerOfTwo(int32_t x) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::IgnoranceThirdparty::RingBuffer_1<T>*>::get(), "NextPowerOfTwo", std::vector<Il2CppClass*>{},
                                               ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
