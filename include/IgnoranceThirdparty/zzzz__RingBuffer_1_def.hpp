...
// Write type traits
MARK_GEN_REF_T_PTR(::IgnoranceThirdparty::RingBuffer_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::IgnoranceThirdparty::RingBuffer_1, "IgnoranceThirdparty", "RingBuffer`1");
// [DefaultMember("Item")]
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__entries, put = __cordl_internal_set__entries)) ::ArrayW<T> _entries;
  ...
  inline bool TryDequeue(::by_ref<T> obj);
  ...
  constexpr ::ArrayW<T> const& __cordl_internal_get__entries() const;

  constexpr ::ArrayW<T>& __cordl_internal_get__entries();
  ...
  constexpr void __cordl_internal_set__entries(::ArrayW<T> value);
...
public:
  ...
  RingBuffer_1(RingBuffer_1const&) = delete;
