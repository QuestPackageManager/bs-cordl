...
public:
  ...
  /// @brief Method UpdateBodyPosition, addr 0x105e8ec, size 0x1b0, virtual false, abstract: false, final false
  inline void UpdateBodyPosition();

  /// @brief Method UpdateTransforms, addr 0x105e810, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x105ea9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bodyWorldPosition, addr 0x105e7f4, size 0x1c, virtual false, abstract: false, final false
