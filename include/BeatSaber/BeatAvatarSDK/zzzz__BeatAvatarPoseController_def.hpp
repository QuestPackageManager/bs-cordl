...
public:
  ...
  /// @brief Method UpdateBodyPosition, addr 0xe6d2f4, size 0x1b0, virtual false, abstract: false, final false
  inline void UpdateBodyPosition();

  /// @brief Method UpdateTransforms, addr 0xe6d218, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6d4a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bodyWorldPosition, addr 0xe6d1fc, size 0x1c, virtual false, abstract: false, final false
