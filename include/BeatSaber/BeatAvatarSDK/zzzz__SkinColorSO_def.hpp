...
public:
  ...
  /// @brief Method get_Color, addr 0xe1c568, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_Color();

  static inline ::BeatSaber::BeatAvatarSDK::SkinColorSO* New_ctor();

  /// @brief Method .ctor, addr 0xe1c574, size 0x1008, virtual false, abstract: false, final false
  inline void _ctor();
