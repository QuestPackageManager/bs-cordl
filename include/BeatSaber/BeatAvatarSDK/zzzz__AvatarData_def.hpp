...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarData(AvatarData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarData(AvatarDataconst&) = delete;
