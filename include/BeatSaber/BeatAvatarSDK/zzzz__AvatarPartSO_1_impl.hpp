...
template<typename T>
constexpr ::StringW& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__id()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____id;
}
template<typename T>
constexpr ::StringW const& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__id() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____id;
}
template<typename T>
constexpr void BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_set__id(::StringW  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____id, value);
}
template<typename T>
constexpr ::StringW& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__localizationKey()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____localizationKey;
}
template<typename T>
constexpr ::StringW const& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__localizationKey() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____localizationKey;
}
template<typename T>
constexpr void BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_set__localizationKey(::StringW  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____localizationKey, value);
}
template<typename T>
constexpr T& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__partAsset()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____partAsset;
}
template<typename T>
constexpr T const& BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_get__partAsset() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____partAsset;
}
template<typename T>
constexpr void BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::__cordl_internal_set__partAsset(T  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::BeatSaber::BeatAvatarSDK::IAvatarPart* BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::i___BeatSaber__BeatAvatarSDK__IAvatarPart() noexcept {
return static_cast<::BeatSaber::BeatAvatarSDK::IAvatarPart*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename T>
constexpr ::BeatSaber::BeatAvatarSDK::AvatarPartSO_1<T>::AvatarPartSO_1()   {
}
