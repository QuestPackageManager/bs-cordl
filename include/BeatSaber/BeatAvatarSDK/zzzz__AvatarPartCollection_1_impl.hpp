...
template<typename T>
constexpr ::ArrayW<T,::Array<T>*>& BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>::__cordl_internal_get__parts()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____parts;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*> const& BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>::__cordl_internal_get__parts() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____parts;
}
template<typename T>
constexpr void BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>::__cordl_internal_set__parts(::ArrayW<T,::Array<T>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
