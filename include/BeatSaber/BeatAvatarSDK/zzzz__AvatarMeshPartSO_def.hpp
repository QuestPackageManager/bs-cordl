...
public:
  ...
  /// @brief Method .ctor, addr 0x31e2f20, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x31e2edc, size 0x44, virtual false, abstract: false, final false
