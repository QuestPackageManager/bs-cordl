...
/// @brief Method .ctor, addr 0x31ac418, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mesh, addr 0x31ac3d4, size 0x44, virtual false, abstract: false, final false
