...
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10070)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15687), inst: 913 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15687))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15682)) CS Name: ::BeatSaber.BeatAvatarSDK::AvatarMeshPartSO*
