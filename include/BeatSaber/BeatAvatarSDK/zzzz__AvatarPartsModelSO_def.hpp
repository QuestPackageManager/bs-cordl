...
/// @brief Field _clothes, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__clothes, put=__cordl_internal_set__clothes)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>*>  _clothes;

/// @brief Field _eyes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__eyes, put=__cordl_internal_set__eyes)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>>*>  _eyes;

/// @brief Field _facialHair, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__facialHair, put=__cordl_internal_set__facialHair)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>*>  _facialHair;

/// @brief Field _glasses, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__glasses, put=__cordl_internal_set__glasses)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>*>  _glasses;

/// @brief Field _hands, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__hands, put=__cordl_internal_set__hands)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>*>  _hands;

/// @brief Field _headTops, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__headTops, put=__cordl_internal_set__headTops)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarMeshPartSO>>*>  _headTops;

/// @brief Field _mouths, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__mouths, put=__cordl_internal_set__mouths)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO>>*>  _mouths;
...
/// @brief Method .ctor, addr 0x31ac80c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Clothes, addr 0x31ac804, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Eyes, addr 0x31ac7dc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_FacialHair, addr 0x31ac7f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Glasses, addr 0x31ac7ec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Hands, addr 0x31ac7fc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Mouths, addr 0x31ac7e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_headTops, addr 0x31ac7d4, size 0x8, virtual false, abstract: false, final false
