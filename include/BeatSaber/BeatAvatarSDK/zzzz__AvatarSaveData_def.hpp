...
public:
  ...
  /// @brief Method .ctor, addr 0x327be48, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarSaveData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarSaveData(AvatarSaveData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarSaveData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarSaveData(AvatarSaveDataconst&) = delete;
