...
/// @brief Method .ctor, addr 0x31aebc4, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_darkerColorMultiplier, addr 0x31aebb4, size 0x8, virtual false, abstract: false, final false
inline float_t get_darkerColorMultiplier() ;

/// @brief Method get_defaultColor, addr 0x31aeba8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_defaultColor() ;

/// @brief Method get_whiteBoost, addr 0x31aebbc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <>9__10_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__10_0, put=setStaticF___9__10_0)) ::System::Func_2<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*,::UnityEngine::Color>*  __9__10_0;

static inline ::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter___c* New_ctor() ;

/// @brief Method <OnValidate>b__10_0, addr 0x31aec34, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Color _OnValidate_b__10_0(::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*  x) ;

/// @brief Method .ctor, addr 0x31aec30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colorDataList, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorDataList, put=__cordl_internal_set__colorDataList)) ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*,::Array<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>*>  _colorDataList;
...
/// @brief Method OnValidate, addr 0x31ae7c0, size 0x1d8, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetColors, addr 0x31ae3c0, size 0x208, virtual false, abstract: false, final false
inline void SetColors(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors) ;

/// @brief Method SetHighlight, addr 0x31ae6e8, size 0xc, virtual false, abstract: false, final false
inline void SetHighlight(bool  highlighted, int32_t  uvSegment) ;

/// @brief Method UpdateRenderer, addr 0x31ae998, size 0x1a0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*,::Array<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>*> const& __cordl_internal_get__colorDataList() const;

constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*,::Array<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>*>& __cordl_internal_get__colorDataList() ;
...
constexpr void __cordl_internal_set__colorDataList(::ArrayW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*,::Array<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter_ColorData*>*>  value) ;
...
/// @brief Method .ctor, addr 0x31aeb38, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
