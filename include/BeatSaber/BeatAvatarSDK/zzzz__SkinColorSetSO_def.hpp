...
public:
  ...
  /// @brief Method .ctor, addr 0x31e575c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colors, addr 0x31e5754, size 0x8, virtual false, abstract: false, final false
