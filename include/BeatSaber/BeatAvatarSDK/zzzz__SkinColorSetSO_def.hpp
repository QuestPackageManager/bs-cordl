...
public:
  ...
  /// @brief Method .ctor, addr 0x2261c38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colors, addr 0x2261c30, size 0x8, virtual false, abstract: false, final false
