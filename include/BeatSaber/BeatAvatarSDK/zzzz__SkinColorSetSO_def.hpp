...
public:
  ...
  /// @brief Method .ctor, addr 0x1050b20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colors, addr 0x1050b18, size 0x8, virtual false, abstract: false, final false
