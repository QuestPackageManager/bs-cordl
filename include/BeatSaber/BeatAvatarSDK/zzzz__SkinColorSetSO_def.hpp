...
/// @brief Field _colors, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__colors, put=__cordl_internal_set__colors)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>,::Array<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>>*>  _colors;
...
/// @brief Method .ctor, addr 0x31aec54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colors, addr 0x31aec4c, size 0x8, virtual false, abstract: false, final false
