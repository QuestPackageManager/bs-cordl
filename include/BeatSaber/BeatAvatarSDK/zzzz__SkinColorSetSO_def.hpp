...
public:
  ...
  /// @brief Method get_colors, addr 0xe28b9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe28ba4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
