...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::SkinColorSetSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::SkinColorSetSO*, "BeatSaber.BeatAvatarSDK", "SkinColorSetSO");
// Dependencies BeatSaber.BeatAvatarSDK.SkinColorSO, PersistentScriptableObject
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colors, put = __cordl_internal_set__colors)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>> _colors;

  __declspec(property(get = get_colors)) ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>> colors;

  static inline ::BeatSaber::BeatAvatarSDK::SkinColorSetSO* New_ctor();

  constexpr ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>> const& __cordl_internal_get__colors() const;

  constexpr ::ArrayW<::UnityW<::BeatSaber::BeatAvatarSDK::SkinColorSO>>& __cordl_internal_get__colors();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SkinColorSetSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SkinColorSetSO(SkinColorSetSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SkinColorSetSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SkinColorSetSO(SkinColorSetSOconst&) = delete;
...
static_assert(sizeof(::BeatSaber::BeatAvatarSDK::SkinColorSetSO) == 0x20, "Size mismatch!");
