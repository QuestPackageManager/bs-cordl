...
// Write type traits
MARK_REF_T(::BeatSaber::BeatAvatarSDK::IAvatarPart*);
DEFINE_IL2CPP_CLASS(::BeatSaber::BeatAvatarSDK::IAvatarPart*, "BeatSaber.BeatAvatarSDK", "IAvatarPart");
// Dependencies
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAvatarPart", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAvatarPart(IAvatarPartconst&) = delete;
