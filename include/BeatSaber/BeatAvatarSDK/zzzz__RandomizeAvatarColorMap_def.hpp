...
public:
  ...
  /// @brief Method .ctor, addr 0x317d324, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorIndices, addr 0x317d918, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_colorIndices();

  /// @brief Method get_totalIndices, addr 0x317d910, size 0x8, virtual false, abstract: false, final false
