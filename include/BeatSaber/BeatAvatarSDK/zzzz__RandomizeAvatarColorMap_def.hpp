...
public:
  ...
  /// @brief Method .ctor, addr 0x225aa6c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorIndices, addr 0x225aff4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_colorIndices();

  /// @brief Method get_totalIndices, addr 0x225afec, size 0x8, virtual false, abstract: false, final false
