...
/// @brief Method Awake, addr 0x31ac814, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x31ac824, size 0xe4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetColor, addr 0x31ac908, size 0x28, virtual false, abstract: false, final false
inline void SetColor(::UnityEngine::Color  color) ;

/// @brief Method SetColors, addr 0x31ac930, size 0x14, virtual false, abstract: false, final false
inline void SetColors(::UnityEngine::Color  mainColor, ::UnityEngine::Color  rimLightColor) ;

/// @brief Method SetHighlight, addr 0x31acb08, size 0x8, virtual false, abstract: false, final false
inline void SetHighlight(bool  highlighted, int32_t  uvSegment) ;

/// @brief Method UpdateRenderer, addr 0x31ac944, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31acb10, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
