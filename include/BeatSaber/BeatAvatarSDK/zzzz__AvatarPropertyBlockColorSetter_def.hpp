...
public:
  ...
  /// @brief Method Awake, addr 0x105dae0, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x105daf0, size 0xa0, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetColor, addr 0x105db90, size 0x38, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetColors, addr 0x105dbc8, size 0x14, virtual false, abstract: false, final false
  inline void SetColors(::UnityEngine::Color mainColor, ::UnityEngine::Color rimLightColor);

  /// @brief Method SetHighlight, addr 0x105dd7c, size 0xc, virtual false, abstract: false, final false
  inline void SetHighlight(bool highlighted, int32_t uvSegment);

  /// @brief Method UpdateRenderer, addr 0x105dbdc, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x105dd88, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
