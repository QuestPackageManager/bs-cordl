...
public:
  ...
  /// @brief Method RandomizeAll, addr 0x31ab98c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RandomizeColors, addr 0x31ad324, size 0x2e0, virtual false, abstract: false, final false
  static inline void RandomizeColors(::BeatSaber::BeatAvatarSDK::AvatarData* avatarData);

  /// @brief Method RandomizeModels, addr 0x31ad190, size 0x194, virtual false, abstract: false, final false
