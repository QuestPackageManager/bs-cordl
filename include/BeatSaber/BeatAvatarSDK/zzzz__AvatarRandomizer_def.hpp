...
public:
  ...
  /// @brief Method RandomizeAll, addr 0x31e23e4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RandomizeColors, addr 0x31e3d7c, size 0x2e0, virtual false, abstract: false, final false
  static inline void RandomizeColors(::BeatSaber::BeatAvatarSDK::AvatarData* avatarData);

  /// @brief Method RandomizeModels, addr 0x31e3be8, size 0x194, virtual false, abstract: false, final false
