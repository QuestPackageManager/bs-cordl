...
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9037)), TypeDefinitionIndex(TypeDefinitionIndex(15788)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15788), inst:
// 779 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15793)) CS Name: ::BeatSaber.BeatAvatarSDK::AvatarSpritePartSO*
...
public:
  ...
  /// @brief Method get_sprite, addr 0xe27614, size 0x3c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_sprite();

  static inline ::BeatSaber::BeatAvatarSDK::AvatarSpritePartSO* New_ctor();

  /// @brief Method .ctor, addr 0xe27650, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
