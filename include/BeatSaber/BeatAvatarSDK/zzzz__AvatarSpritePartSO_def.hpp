...
public:
  ...
  /// @brief Method .ctor, addr 0x327c050, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sprite, addr 0x327c00c, size 0x44, virtual false, abstract: false, final false
