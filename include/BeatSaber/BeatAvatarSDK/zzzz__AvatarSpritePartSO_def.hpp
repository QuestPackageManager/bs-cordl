...
public:
  ...
  /// @brief Method .ctor, addr 0x31ad658, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sprite, addr 0x31ad614, size 0x44, virtual false, abstract: false, final false
