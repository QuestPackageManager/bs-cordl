...
namespace BeatSaber::BeatAvatarSDK {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15687), inst: 777 }), TypeDefinitionIndex(TypeDefinitionIndex(10291)),
// TypeDefinitionIndex(TypeDefinitionIndex(15687))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15692)) CS Name: ::BeatSaber.BeatAvatarSDK::AvatarSpritePartSO*
