...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarPartSO_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarPartSO_1(AvatarPartSO_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarPartSO_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarPartSO_1(AvatarPartSO_1const&) = delete;
