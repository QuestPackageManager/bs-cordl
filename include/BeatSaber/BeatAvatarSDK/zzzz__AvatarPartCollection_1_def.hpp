...
public:
  ...
  __declspec(property(get = __cordl_internal_get__parts, put = __cordl_internal_set__parts)) ::ArrayW<T> _parts;

  __declspec(property(get = get_count)) int32_t count;

  __declspec(property(get = get_parts)) ::ArrayW<T> parts;
  ...
  static inline ::BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>* New_ctor(::ArrayW<T> parts);
  ...
  constexpr ::ArrayW<T> const& __cordl_internal_get__parts() const;

  constexpr ::ArrayW<T>& __cordl_internal_get__parts();
