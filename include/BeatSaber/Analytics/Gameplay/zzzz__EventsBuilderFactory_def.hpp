...
public:
  ...
  /// @brief Method Create, addr 0x31cddf0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31cde50, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
