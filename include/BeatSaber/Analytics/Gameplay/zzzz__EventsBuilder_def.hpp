...
/// @brief Field _events, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__events, put=__cordl_internal_set__events)) ::System::Collections::Generic::List_1<::BeatSaber::Analytics::Gameplay::Events::SpaceshipUserEventBase*>*  _events;
...
/// @brief Field _segmentSettings, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__segmentSettings, put=__cordl_internal_set__segmentSettings)) ::BeatSaber::Analytics::Gameplay::Events::SpaceshipSegmentEventSettingsField*  _segmentSettings;
...
inline void SetupSegmentFields(::StringW  segmentName, ::StringW  segmentId, ::BeatSaber::Analytics::Gameplay::Events::SpaceshipSegmentType*  currentSegmentType, ::BeatSaber::Analytics::Gameplay::Events::SpaceshipSegmentEventSettingsField*  currentSegmentSettings) ;

/// @brief Method StartSegment, addr 0x31cd954, size 0x300, virtual false, abstract: false, final false
inline ::BeatSaber::Analytics::Gameplay::EventsBuilder* StartSegment(::StringW  segmentName, ::BeatSaber::Analytics::Gameplay::Events::SpaceshipSegmentType*  type, ::BeatSaber::Analytics::Gameplay::Events::SpaceshipSegmentEventSettingsField*  settings) ;
