...
public:
  ...
  /// @brief Method GetIDType, addr 0x3265bd8, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatSaber::Analytics::Gameplay::Events::SpaceshipUserEventBase* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x3265be0, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32650f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::Events::SpaceshipUserEventBase) == 0x68, "Size mismatch!");
