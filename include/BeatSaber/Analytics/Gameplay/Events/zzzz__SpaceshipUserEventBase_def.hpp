...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x31d0370, size 0x128, virtual true, abstract: false, final false
  inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager* manager);

  /// @brief Method GetIDType, addr 0x31d0a80, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::BeatSaber::Analytics::Gameplay::Events::SpaceshipUserEventBase* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x31d0a88, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d0020, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
