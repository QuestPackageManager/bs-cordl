...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x3264e54, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32623b0, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::Events::SpaceshipMetricEvent) == 0x88, "Size mismatch!");
