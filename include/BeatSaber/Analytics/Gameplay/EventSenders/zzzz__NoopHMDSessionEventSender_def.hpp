...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoopHMDSessionEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoopHMDSessionEventSender(NoopHMDSessionEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoopHMDSessionEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoopHMDSessionEventSender(NoopHMDSessionEventSenderconst&) = delete;
