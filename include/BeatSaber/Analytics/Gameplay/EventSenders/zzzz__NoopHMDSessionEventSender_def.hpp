...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::NoopHMDSessionEventSender*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::NoopHMDSessionEventSender*, "BeatSaber.Analytics.Gameplay.EventSenders", "NoopHMDSessionEventSender");
...
public:
  ...
  /// @brief Method SendHMDSessionEnd, addr 0x3264b1c, size 0x4, virtual true, abstract: false, final true
  inline void SendHMDSessionEnd();

  /// @brief Method SendHMDSessionStart, addr 0x3264b18, size 0x4, virtual true, abstract: false, final true
  inline void SendHMDSessionStart();

  /// @brief Method .ctor, addr 0x3262cd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::NoopHMDSessionEventSender) == 0x10, "Size mismatch!");
