...
/// @brief Method SendHMDSessionEnd, addr 0x31d0d3c, size 0x4, virtual true, abstract: false, final true
inline void SendHMDSessionEnd() ;

/// @brief Method SendHMDSessionStart, addr 0x31d0d38, size 0x4, virtual true, abstract: false, final true
inline void SendHMDSessionStart() ;

/// @brief Method .ctor, addr 0x31ceef0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
