...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::IHMDSessionEventSender*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::IHMDSessionEventSender*, "BeatSaber.Analytics.Gameplay.EventSenders", "IHMDSessionEventSender");
// Dependencies
namespace BeatSaber::Analytics::Gameplay::EventSenders {
// Is value type: false
