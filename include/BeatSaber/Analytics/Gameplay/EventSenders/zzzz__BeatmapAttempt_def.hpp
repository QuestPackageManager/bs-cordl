...
public:
  ...
  /// @brief Method GetBuilderForBeatmapAttempt, addr 0x31cf24c, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method NewEventsBuilder, addr 0x31cec58, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SendAbortedLevel, addr 0x31cf680, size 0x178, virtual true, abstract: false, final true
  inline void SendAbortedLevel(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData* levelData);

  /// @brief Method SendFinishedLevel, addr 0x31cf0f0, size 0x15c, virtual true, abstract: false, final true
  inline void SendFinishedLevel(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData* eventData);

  /// @brief Method SendStartedLevel, addr 0x31cec74, size 0x308, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31ce9e4, size 0x8, virtual false, abstract: false, final false
