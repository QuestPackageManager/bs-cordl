...
public:
  ...
  /// @brief Method .ctor, addr 0x3264350, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData) == 0x48, "Size mismatch!");
