...
public:
  ...
  /// @brief Method GetSegmentName, addr 0x3264040, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendEventsBatch, addr 0x3264118, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3263d2c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventSenderBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventSenderBase(EventSenderBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventSenderBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventSenderBase(EventSenderBaseconst&) = delete;
