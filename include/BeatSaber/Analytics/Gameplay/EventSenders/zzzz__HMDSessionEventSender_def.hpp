...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender*, "BeatSaber.Analytics.Gameplay.EventSenders", "HMDSessionEventSender");
// [NullableContext(1)]
// [Nullable(0)]
...
public:
  ...
  /// @brief Method NewEventsBuilder, addr 0x3264cc4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SegmentNameFor, addr 0x3264c6c, size 0x50, virtual false, abstract: false, final false
  static inline ::StringW SegmentNameFor(::StringW platform);

  /// @brief Method SendHMDSessionEnd, addr 0x3264ec4, size 0x218, virtual true, abstract: false, final true
  inline void SendHMDSessionEnd();

  /// @brief Method SendHMDSessionStart, addr 0x3264cd8, size 0x1ec, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3263b54, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentSegment, addr 0x3264cbc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HMDSessionEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HMDSessionEventSender(HMDSessionEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HMDSessionEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HMDSessionEventSender(HMDSessionEventSenderconst&) = delete;
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender) == 0x38, "Size mismatch!");
