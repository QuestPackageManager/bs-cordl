...
static inline ::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender* New_ctor(::OSCE::Analytics::AnalyticsManager*  analyticsManager, ::BeatSaber::Analytics::Gameplay::EventsBuilderFactory*  eventsBuilderFactory, ::StringW  platform) ;
