...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoopBeatmapAttemptEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoopBeatmapAttemptEventSender(NoopBeatmapAttemptEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoopBeatmapAttemptEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoopBeatmapAttemptEventSender(NoopBeatmapAttemptEventSenderconst&) = delete;
