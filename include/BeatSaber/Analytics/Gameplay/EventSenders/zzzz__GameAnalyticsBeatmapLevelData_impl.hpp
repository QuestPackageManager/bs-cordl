...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::*)(::StringW, ::StringW, ::StringW, ::StringW, ::StringW, ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*, ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*)>(&::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::_ctor)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x31d0570;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 7>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*>::get()}
                    )));
...
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_get_practiceSettings()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___practiceSettings;
}
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings* const& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_get_practiceSettings() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___practiceSettings;
}
constexpr void BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_set_practiceSettings(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_get_gameplayModifiers()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___gameplayModifiers;
}
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers* const& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_get_gameplayModifiers() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___gameplayModifiers;
}
constexpr void BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::__cordl_internal_set_gameplayModifiers(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData::_ctor(::StringW  gameMode, ::StringW  levelID, ::StringW  difficulty, ::StringW  characteristic, ::StringW  missionID, ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*  practiceSettings, ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsGameplayModifiers*  gameplayModifiers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*>(gameMode, levelID, difficulty, characteristic, missionID, practiceSettings, gameplayModifiers));
}
// Ctor Parameters []
