...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::*)(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*, bool, bool, bool, int32_t, int32_t, int32_t, bool, int32_t, uint32_t, int32_t, int32_t, int32_t, int32_t)>(&::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x31d0518;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 14>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<uint32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
...
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::__cordl_internal_get_levelData()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___levelData;
}
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData* const& BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::__cordl_internal_get_levelData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___levelData;
}
constexpr void BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::__cordl_internal_set_levelData(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, levelData, isEndStateQuit, isEndStateRestart, isClear, rank, modifiedScore, score, isFullCombo, maxCombo, duration, goodCuts, badCuts, misses, bombsHit);
}
inline ::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData* BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData::New_ctor(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapLevelData*  levelData, bool  isEndStateQuit, bool  isEndStateRestart, bool  isClear, int32_t  rank, int32_t  modifiedScore, int32_t  score, bool  isFullCombo, int32_t  maxCombo, uint32_t  duration, int32_t  goodCuts, int32_t  badCuts, int32_t  misses, int32_t  bombsHit)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapAttemptEventData*>(levelData, isEndStateQuit, isEndStateRestart, isClear, rank, modifiedScore, score, isFullCombo, maxCombo, duration, goodCuts, badCuts, misses, bombsHit));
}
// Ctor Parameters []
