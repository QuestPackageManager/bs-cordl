...
public:
  ...
  /// @brief Method SendBlockLevelGameplayEvent, addr 0x3264b14, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3262ccc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
