...
// Write type traits
MARK_REF_T(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings*, "BeatSaber.Analytics.Gameplay.EventSenders", "GameAnalyticsBeatmapPracticeSettings");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3264934, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameAnalyticsBeatmapPracticeSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameAnalyticsBeatmapPracticeSettings(GameAnalyticsBeatmapPracticeSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameAnalyticsBeatmapPracticeSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameAnalyticsBeatmapPracticeSettings(GameAnalyticsBeatmapPracticeSettingsconst&) = delete;
...
static_assert(sizeof(::BeatSaber::Analytics::Gameplay::EventSenders::GameAnalyticsBeatmapPracticeSettings) == 0x20, "Size mismatch!");
