...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::*)()>(&::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::get_CurrentSegment)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x31d08c0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender*>::get(),
                        "get_CurrentSegment",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Analytics::Gameplay::EventsBuilder* (::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::*)()>(&::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::NewEventsBuilder)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x31d0910;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::*)(::OSCE::Analytics::AnalyticsManager*, ::BeatSaber::Analytics::Gameplay::EventsBuilderFactory*, ::StringW)>(&::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x31cf7b4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::OSCE::Analytics::AnalyticsManager*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::Analytics::Gameplay::EventsBuilderFactory*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::*)()>(&::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::SendHMDSessionStart)> {
  constexpr static std::size_t size = 0x1ec;
  constexpr static std::size_t addrs = 0x31d0924;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::*)()>(&::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::SendHMDSessionEnd)> {
  constexpr static std::size_t size = 0x218;
  constexpr static std::size_t addrs = 0x31d0b10;
...
inline void BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::_ctor(::OSCE::Analytics::AnalyticsManager*  analyticsManager, ::BeatSaber::Analytics::Gameplay::EventsBuilderFactory*  eventsBuilderFactory, ::StringW  platform)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender* BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::New_ctor(::OSCE::Analytics::AnalyticsManager*  analyticsManager, ::BeatSaber::Analytics::Gameplay::EventsBuilderFactory*  eventsBuilderFactory, ::StringW  platform)  {
...
constexpr ::BeatSaber::Analytics::Gameplay::EventSenders::IHMDSessionEventSender* BeatSaber::Analytics::Gameplay::EventSenders::HMDSessionEventSender::i___BeatSaber__Analytics__Gameplay__EventSenders__IHMDSessionEventSender() noexcept {
return static_cast<::BeatSaber::Analytics::Gameplay::EventSenders::IHMDSessionEventSender*>(static_cast<void*>(this));
}
// Ctor Parameters []
