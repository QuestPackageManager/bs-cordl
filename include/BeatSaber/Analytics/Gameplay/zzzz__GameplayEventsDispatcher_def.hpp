...
public:
  ...
  /// @brief Method MoveNext, addr 0x31ce35c, size 0x1ec, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31ce548, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31ce5b4, size 0x430, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31ceaa0, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Initialize, addr 0x31ce1d4, size 0x24, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method InitializeAsync, addr 0x31ce1f8, size 0xb0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* InitializeAsync();

  /// @brief Method InitializeInternalAsync, addr 0x31ce2a8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31ce0d0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapAttempt, addr 0x31ce0a0, size 0x8, virtual true, abstract: false, final true
  inline ::BeatSaber::Analytics::Gameplay::EventSenders::IBeatmapAttemptEventSender* get_beatmapAttempt();

  /// @brief Method get_blockLevel, addr 0x31ce0b0, size 0x8, virtual true, abstract: false, final true
  inline ::BeatSaber::Analytics::Gameplay::EventSenders::IBlockLevelGameplayEventSender* get_blockLevel();

  /// @brief Method get_hmdSession, addr 0x31ce0c0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_beatmapAttempt, addr 0x31ce0a8, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapAttempt(::BeatSaber::Analytics::Gameplay::EventSenders::IBeatmapAttemptEventSender* value);

  /// @brief Method set_blockLevel, addr 0x31ce0b8, size 0x8, virtual false, abstract: false, final false
  inline void set_blockLevel(::BeatSaber::Analytics::Gameplay::EventSenders::IBlockLevelGameplayEventSender* value);

  /// @brief Method set_hmdSession, addr 0x31ce0c8, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Analytics::Gameplay::GameplayEventsDispatcher__InitializeInternalAsync_d__18, "BeatSaber.Analytics.Gameplay",
