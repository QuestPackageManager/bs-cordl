...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Analytics::Gameplay::EventSenders::IBeatmapAttemptEventSender* (::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::*)()>(&::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::get_beatmapAttempt)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher*>::get(),
                                  0
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Analytics::Gameplay::EventSenders::IBlockLevelGameplayEventSender* (::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::*)()>(&::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::get_blockLevel)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Analytics::Gameplay::EventSenders::IHMDSessionEventSender* (::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::*)()>(&::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::get_hmdSession)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::*)()>(&::BeatSaber::Analytics::Gameplay::IGameplayEventsDispatcher::InitializeAsync)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
