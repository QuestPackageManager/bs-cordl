...
public:
  ...
  __declspec(property(get = __cordl_internal_get__segmentIdToState,
                      put = __cordl_internal_set__segmentIdToState)) ::System::Collections::Generic::Dictionary_2<::StringW, ::BeatSaber::Analytics::Gameplay::SegmentState*>* _segmentIdToState;
  ...
  /// @brief Method AddSegment, addr 0x31cd004, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Clear, addr 0x31cdffc, size 0xa4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetSegmentState, addr 0x31cd2c0, size 0x74, virtual false, abstract: false, final false
  inline ::BeatSaber::Analytics::Gameplay::SegmentState* GetSegmentState(::StringW segmentId);

  /// @brief Method IsSegmentFinished, addr 0x31ccfa0, size 0x64, virtual false, abstract: false, final false
  inline bool IsSegmentFinished(::StringW segmentId);

  /// @brief Method MarkSegmentAsFinished, addr 0x31cdd6c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveSegment, addr 0x31cdcac, size 0xc0, virtual false, abstract: false, final false
  inline bool RemoveSegment(::StringW segmentName);

  /// @brief Method TryGetSegmentId, addr 0x31ccf34, size 0x6c, virtual false, abstract: false, final false
  inline bool TryGetSegmentId(::StringW segmentName, ::ByRef<::StringW> segmentId);

  /// @brief Method UpdateSeqNum, addr 0x31cdc38, size 0x74, virtual false, abstract: false, final false
  inline void UpdateSeqNum(::StringW segmentId, int32_t seqNum);

  /// @brief Method UpdateSettings, addr 0x31ccb84, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31cdea8, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor();
