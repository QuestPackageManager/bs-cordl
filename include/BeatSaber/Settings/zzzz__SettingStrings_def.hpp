...
public:
  ...
  /// @brief Method Decode, addr 0x2240384, size 0x4, virtual false, abstract: false, final false
  static inline bool Decode(ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ByRef<::StringW> log);

  /// @brief Method Encode, addr 0x223f71c, size 0x4, virtual false, abstract: false, final false
  static inline void Encode(ByRef<::BeatSaber::Settings::Settings> settings, ::System::Text::StringBuilder* stream);

  /// @brief Method IsPureWhiteSpace, addr 0x2242588, size 0xc0, virtual false, abstract: false, final false
  static inline bool IsPureWhiteSpace(::System::ReadOnlySpan_1<char16_t> property);

  /// @brief Method ReadBool, addr 0x2241f5c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFloat, addr 0x2241d84, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x22421b4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadProperties, addr 0x2240388, size 0x2d0, virtual false, abstract: false, final false
  static inline bool ReadProperties(ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ByRef<::StringW> log);

  /// @brief Method ReadProperty, addr 0x2240658, size 0x16b0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPropertyLine, addr 0x224238c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadString, addr 0x2242124, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteProperties, addr 0x223f720, size 0xc64, virtual false, abstract: false, final false
