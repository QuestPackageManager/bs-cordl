...
public:
  ...
  /// @brief Method Decode, addr 0x322f204, size 0x4, virtual false, abstract: false, final false
  static inline bool Decode(::ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ::ByRef<::StringW> log);

  /// @brief Method Encode, addr 0x322e410, size 0x4, virtual false, abstract: false, final false
  static inline void Encode(::ByRef<::BeatSaber::Settings::Settings> settings, ::System::Text::StringBuilder* stream);

  /// @brief Method IsPureWhiteSpace, addr 0x32313f0, size 0xb0, virtual false, abstract: false, final false
  static inline bool IsPureWhiteSpace(::System::ReadOnlySpan_1<char16_t> property);

  /// @brief Method ReadBool, addr 0x3230dc4, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFloat, addr 0x3230be4, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x3230f80, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadProperties, addr 0x322f208, size 0x2e0, virtual false, abstract: false, final false
  static inline bool ReadProperties(::ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ::ByRef<::StringW> log);

  /// @brief Method ReadProperty, addr 0x322f4e8, size 0x16bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPropertyLine, addr 0x32311e4, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadString, addr 0x3231160, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteProperties, addr 0x322e414, size 0xdf0, virtual false, abstract: false, final false
