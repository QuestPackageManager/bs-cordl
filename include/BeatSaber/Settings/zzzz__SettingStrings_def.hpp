...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SettingStrings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SettingStrings(SettingStrings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SettingStrings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SettingStrings(SettingStringsconst&) = delete;
