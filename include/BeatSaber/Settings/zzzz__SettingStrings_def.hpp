...
public:
  ...
  /// @brief Method Decode, addr 0x227fed4, size 0x4, virtual false, abstract: false, final false
  static inline bool Decode(::ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ::ByRef<::StringW> log);

  /// @brief Method Encode, addr 0x227f21c, size 0x4, virtual false, abstract: false, final false
  static inline void Encode(::ByRef<::BeatSaber::Settings::Settings> settings, ::System::Text::StringBuilder* stream);

  /// @brief Method IsPureWhiteSpace, addr 0x2282178, size 0xc0, virtual false, abstract: false, final false
  static inline bool IsPureWhiteSpace(::System::ReadOnlySpan_1<char16_t> property);

  /// @brief Method ReadBool, addr 0x2281b4c, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFloat, addr 0x2281974, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadInt, addr 0x2281d14, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadProperties, addr 0x227fed8, size 0x2d0, virtual false, abstract: false, final false
  static inline bool ReadProperties(::ByRef<::BeatSaber::Settings::Settings> settings, ::StringW text, ::ByRef<::StringW> log);

  /// @brief Method ReadProperty, addr 0x22801a8, size 0x1750, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPropertyLine, addr 0x2281f7c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadString, addr 0x2281eec, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteProperties, addr 0x227f220, size 0xcb4, virtual false, abstract: false, final false
