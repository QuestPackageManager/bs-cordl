...
// Ctor Parameters [CppParam { name: "volume", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "ambientVolumeScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "latency", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "overrideLatency", ty: "bool", modifiers: "", def_value: Some("{}") }]
