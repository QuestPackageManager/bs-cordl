...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::SelectedProfile, "BeatSaber.Settings", "SelectedProfile");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::SelectedProfile) == 0x8, "Size mismatch!");
