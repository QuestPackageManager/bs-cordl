...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SettingPresets", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SettingPresets(SettingPresets&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SettingPresets", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SettingPresets(SettingPresetsconst&) = delete;
