...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::PerformanceToolSettings, "BeatSaber.Settings", "PerformanceToolSettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::PerformanceToolSettings) == 0x4, "Size mismatch!");
