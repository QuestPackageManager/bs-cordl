...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::WindowSettings, "BeatSaber.Settings", "WindowSettings");
...
static_assert(sizeof(::BeatSaber::Settings::WindowSettings) == 0xc, "Size mismatch!");
