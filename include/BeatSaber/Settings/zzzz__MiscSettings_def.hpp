...
// Ctor Parameters [CppParam { name: "region", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "language", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "pauseButtonResponse", ty: "::BeatSaber::Settings::MiscSettings_ResponseLevel", modifiers: "", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::BeatSaber::Settings::MiscSettings, 0x18>, "Size mismatch!");
