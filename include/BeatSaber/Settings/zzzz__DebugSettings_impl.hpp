...
// Ctor Parameters [CppParam { name: "showBeatmapLevelVersion", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "disableVRTrackingInAutoplayPS4", ty: "bool",
