...
// Ctor Parameters [CppParam { name: "showBeatmapLevelVersion", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "disableVRTrackingInAutoplayPS4", ty: "bool", modifiers: "", def_value: Some("{}") }]
