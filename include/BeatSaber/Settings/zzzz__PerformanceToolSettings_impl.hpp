...
// Ctor Parameters [CppParam { name: "recordFps", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "showFps", ty: "bool", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "showMemory", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "saveScreenshot", ty: "bool", modifiers: "", def_value:
// Some("{}"), comment: None }]
