...
// Ctor Parameters [CppParam { name: "recordFps", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "showFps", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "showMemory", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "saveScreenshot", ty: "bool", modifiers: "", def_value: Some("{}") }]
