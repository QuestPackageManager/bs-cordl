...
// Ctor Parameters [CppParam { name: "showBeatmapLevelVersion", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "disableVRTrackingInAutoplayPS4", ty: "bool", modifiers: "", def_value: None }]
