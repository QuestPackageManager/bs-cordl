...
// Ctor Parameters [CppParam { name: "cpuLevel", ty: "::BeatSaber::Settings::QuestSettings_SuggestedPerformanceLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "gpuLevel", ty: "::BeatSaber::Settings::QuestSettings_SuggestedPerformanceLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "foveatedRenderingMenu", ty: "::BeatSaber::Settings::QuestSettings_FoveatedRenderingLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "foveatedRenderingGameplay", ty: "::BeatSaber::Settings::QuestSettings_FoveatedRenderingLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "eyeTrackedFoveatedRendering", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "dynamicFoveatedRendering", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatSaber::Settings::QuestSettings::QuestSettings(::BeatSaber::Settings::QuestSettings_SuggestedPerformanceLevel  cpuLevel, ::BeatSaber::Settings::QuestSettings_SuggestedPerformanceLevel  gpuLevel, ::BeatSaber::Settings::QuestSettings_FoveatedRenderingLevel  foveatedRenderingMenu, ::BeatSaber::Settings::QuestSettings_FoveatedRenderingLevel  foveatedRenderingGameplay, bool  eyeTrackedFoveatedRendering, bool  dynamicFoveatedRendering) noexcept  {
