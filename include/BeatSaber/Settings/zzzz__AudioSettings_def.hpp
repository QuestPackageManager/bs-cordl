...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::AudioSettings, "BeatSaber.Settings", "AudioSettings");
// Dependencies
namespace BeatSaber::Settings {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Settings::AudioSettings) == 0x10, "Size mismatch!");
