...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::SmoothCameraSettings, "BeatSaber.Settings", "SmoothCameraSettings");
...
static_assert(sizeof(::BeatSaber::Settings::SmoothCameraSettings) == 0x2c, "Size mismatch!");
