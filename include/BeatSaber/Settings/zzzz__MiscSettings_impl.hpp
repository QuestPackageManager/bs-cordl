...
// Ctor Parameters [CppParam { name: "region", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "language", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "pauseButtonResponse", ty: "::BeatSaber::Settings::MiscSettings_ResponseLevel", modifiers: "", def_value: Some("{}") }]
