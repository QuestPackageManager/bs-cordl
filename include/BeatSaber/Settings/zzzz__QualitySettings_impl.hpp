...
// Ctor Parameters [CppParam { name: "renderViewportScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "vrResolutionScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "menuVRResolutionScaleMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "antiAliasingLevel", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "targetFramerate", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "vSyncCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxQueuedFrames", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "mainEffect", ty: "::BeatSaber::Settings::QualitySettings_MainEffectOption", modifiers: "", def_value: Some("{}") }, CppParam { name: "bloom", ty: "::BeatSaber::Settings::QualitySettings_BloomQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "mirror", ty: "::BeatSaber::Settings::QualitySettings_MirrorQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "obstacles", ty: "::BeatSaber::Settings::QualitySettings_ObstacleQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "screenDisplacementEffects", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "smokeGraphics", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "burnMarkTrails", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxShockwaveParticles", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxNumberOfCutSoundEffects", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatSaber::Settings::QualitySettings::QualitySettings(float_t  renderViewportScale, float_t  vrResolutionScale, float_t  menuVRResolutionScaleMultiplier, int32_t  antiAliasingLevel, int32_t  targetFramerate, int32_t  vSyncCount, int32_t  maxQueuedFrames, ::BeatSaber::Settings::QualitySettings_MainEffectOption  mainEffect, ::BeatSaber::Settings::QualitySettings_BloomQuality  bloom, ::BeatSaber::Settings::QualitySettings_MirrorQuality  mirror, ::BeatSaber::Settings::QualitySettings_ObstacleQuality  obstacles, bool  screenDisplacementEffects, bool  smokeGraphics, bool  burnMarkTrails, int32_t  maxShockwaveParticles, int32_t  maxNumberOfCutSoundEffects) noexcept  {
