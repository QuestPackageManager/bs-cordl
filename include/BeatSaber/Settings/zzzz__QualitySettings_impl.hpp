...
// Ctor Parameters [CppParam { name: "renderViewportScale", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "vrResolutionScale", ty: "float_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "menuVRResolutionScaleMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "antiAliasingLevel", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "targetFramerate", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None },
// CppParam { name: "vSyncCount", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "maxQueuedFrames", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "mainEffect", ty: "::BeatSaber::Settings::QualitySettings_MainEffectOption", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bloom", ty:
// "::BeatSaber::Settings::QualitySettings_BloomQuality", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "mirror", ty: "::BeatSaber::Settings::QualitySettings_MirrorQuality",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "obstacles", ty: "::BeatSaber::Settings::QualitySettings_ObstacleQuality", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "screenDisplacementEffects", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "smokeGraphics", ty: "bool", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "burnMarkTrails", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "maxShockwaveParticles", ty: "int32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "maxNumberOfCutSoundEffects", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
