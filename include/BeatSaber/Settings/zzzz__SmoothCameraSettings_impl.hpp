...
// Ctor Parameters [CppParam { name: "enabled", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "fov", ty: "float_t", modifiers: "", def_value: Some("{}"), comment:
// None }, CppParam { name: "smoothPosition", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "smoothRotation", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "thirdPersonEnabled", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "thirdPersonPosition", ty:
// "::Unity::Mathematics::float3", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "thirdPersonRotation", ty: "::Unity::Mathematics::float3", modifiers: "", def_value:
// Some("{}"), comment: None }]
