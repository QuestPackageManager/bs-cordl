...
// Ctor Parameters [CppParam { name: "position", ty: "::Unity::Mathematics::float3", modifiers: "", def_value: None }, CppParam { name: "rotation", ty: "::Unity::Mathematics::float3", modifiers: "", def_value: None }, CppParam { name: "hapticFeedback", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "selectedProfile", ty: "::BeatSaber::Settings::SelectedProfile", modifiers: "", def_value: None }]
