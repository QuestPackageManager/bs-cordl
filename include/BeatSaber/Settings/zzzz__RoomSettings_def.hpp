...
DEFINE_IL2CPP_CLASS(::BeatSaber::Settings::RoomSettings, "BeatSaber.Settings", "RoomSettings");
...
static_assert(sizeof(::BeatSaber::Settings::RoomSettings) == 0x10, "Size mismatch!");
