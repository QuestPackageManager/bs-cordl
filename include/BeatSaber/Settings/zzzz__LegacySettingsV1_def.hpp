...
public:
  ...
  /// @brief Method ApplyTo, addr 0x31f134c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f1498, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
