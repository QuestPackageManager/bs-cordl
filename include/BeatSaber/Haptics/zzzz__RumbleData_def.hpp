...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RumbleData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RumbleData(RumbleData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RumbleData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RumbleData(RumbleDataconst&) = delete;
