...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnsupportedAdvancedHapticsPlayer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnsupportedAdvancedHapticsPlayer(UnsupportedAdvancedHapticsPlayer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnsupportedAdvancedHapticsPlayer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnsupportedAdvancedHapticsPlayer(UnsupportedAdvancedHapticsPlayerconst&) = delete;
