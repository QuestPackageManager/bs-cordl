...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IHapticFeedbackPlayer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IHapticFeedbackPlayer(IHapticFeedbackPlayerconst&) = delete;
