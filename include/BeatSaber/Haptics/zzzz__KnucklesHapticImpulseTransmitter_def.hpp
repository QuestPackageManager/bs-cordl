...
public:
  ...
  /// @brief Method MoveNext, addr 0x3298384, size 0x134, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::Haptics::KnucklesHapticImpulseTransmitter__HapticsCoroutine_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x32984b8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32984c0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32984f8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3298380, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32982f0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x32982f8, size 0x88, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HapticsCoroutine, addr 0x3298260, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method StopHaptics, addr 0x32982d8, size 0x18, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x32982b4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3298218, size 0x48, virtual false, abstract: false, final false
