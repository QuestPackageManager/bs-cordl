...
public:
  ...
  /// @brief Method BeatSaber.GraphQL.IGraphQLClientProvider.InitializeAsync, addr 0x320079c, size 0x170, virtual true, abstract: false, final true
  ...
  /// @brief Method System.IDisposable.Dispose, addr 0x3200910, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method Zenject.IInitializable.Initialize, addr 0x320090c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3200914, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_globalRequestFailureEvent, addr 0x320061c, size 0xc0, virtual true, abstract: false, final true
  inline void add_globalRequestFailureEvent(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method add_globalRequestSucceededEvent, addr 0x320049c, size 0xc0, virtual true, abstract: false, final true
  inline void add_globalRequestSucceededEvent(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method add_initializationDidFinishEvent, addr 0x3200344, size 0xac, virtual true, abstract: false, final true
  inline void add_initializationDidFinishEvent(::System::Action* value);

  /// @brief Method get_graphQLClient, addr 0x320033c, size 0x8, virtual true, abstract: false, final true
  inline ::OculusStudios::GraphQL::ClientInterface::IGraphQLClient* get_graphQLClient();

  /// @brief Method get_initializationState, addr 0x3200334, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_globalRequestFailureEvent, addr 0x32006dc, size 0xc0, virtual true, abstract: false, final true
  inline void remove_globalRequestFailureEvent(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method remove_globalRequestSucceededEvent, addr 0x320055c, size 0xc0, virtual true, abstract: false, final true
  inline void remove_globalRequestSucceededEvent(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method remove_initializationDidFinishEvent, addr 0x32003f0, size 0xac, virtual true, abstract: false, final true
