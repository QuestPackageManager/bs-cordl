...
public:
  ...
  /// @brief Method LogError, addr 0x31fe84c, size 0xac, virtual true, abstract: false, final true
  inline void LogError(::System::Exception* exception);

  /// @brief Method LogError, addr 0x31fe7c0, size 0x8c, virtual true, abstract: false, final true
  inline void LogError(::StringW message);

  /// @brief Method LogInfo, addr 0x31fe984, size 0xac, virtual true, abstract: false, final true
  inline void LogInfo(::System::Exception* exception);

  /// @brief Method LogInfo, addr 0x31fe8f8, size 0x8c, virtual true, abstract: false, final true
  inline void LogInfo(::StringW message);

  /// @brief Method LogVerbose, addr 0x31fea30, size 0x4, virtual true, abstract: false, final true
  inline void LogVerbose(::StringW message);

  /// @brief Method LogWarning, addr 0x31fea34, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method OnRequestFailed, addr 0x31feadc, size 0x1c, virtual true, abstract: false, final true
  inline void OnRequestFailed(::OculusStudios::GraphQL::ClientInterface::Request* request);

  /// @brief Method OnRequestSucceeded, addr 0x31feac0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31fe7b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* onRequestSucceeded,
                    ::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* onRequestFailed);

  /// @brief Method add_onRequestFailed, addr 0x31fe638, size 0xc0, virtual false, abstract: false, final false
  inline void add_onRequestFailed(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method add_onRequestSucceeded, addr 0x31fe4b8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onRequestFailed, addr 0x31fe6f8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_onRequestFailed(::System::Action_1<::OculusStudios::GraphQL::ClientInterface::Request*>* value);

  /// @brief Method remove_onRequestSucceeded, addr 0x31fe578, size 0xc0, virtual false, abstract: false, final false
