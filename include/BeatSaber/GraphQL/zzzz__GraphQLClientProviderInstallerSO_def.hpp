...
public:
  ...
  /// @brief Method InstallBindings, addr 0x320005c, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320011c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_devServerPath, addr 0x3200054, size 0x8, virtual false, abstract: false, final false
