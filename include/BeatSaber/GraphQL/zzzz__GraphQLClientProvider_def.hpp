...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::BeatSaber::GraphQL::GraphQLClientProvider*", modifiers: "", def_value: None }, CppParam { name: "ctx", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_appVersion_5__2", ty: "::System::Version*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::StringW>", modifiers: "", def_value: None }]
constexpr GraphQLClientProvider__InitializationTask_d__24(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::BeatSaber::GraphQL::GraphQLClientProvider*  __4__this, ::System::Threading::CancellationToken  ctx, ::System::Version*  _appVersion_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::StringW>  __u__1) noexcept;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::BeatSaber::GraphQL::GraphQLClientProvider*", modifiers: "", def_value: None }, CppParam { name: "ctx", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr GraphQLClientProvider__InitializeAsync_d__23(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::BeatSaber::GraphQL::GraphQLClientProvider*  __4__this, ::System::Threading::CancellationToken  ctx, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Field _initializationCancellationToken, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__initializationCancellationToken, put=__cordl_internal_set__initializationCancellationToken)) ::System::Threading::CancellationTokenSource*  _initializationCancellationToken;

/// @brief Field <initializationState>k__BackingField, offset 0x48, size 0x4 
 __declspec(property(get=__cordl_internal_get__initializationState_k__BackingField, put=__cordl_internal_set__initializationState_k__BackingField)) ::BeatSaber::GraphQL::BSClientProviderInitializationState  _initializationState_k__BackingField;
