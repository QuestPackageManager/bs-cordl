...
DEFINE_IL2CPP_CLASS(::BeatSaber::GraphQL::DummyGraphQLClient*, "BeatSaber.GraphQL", "DummyGraphQLClient");
DEFINE_IL2CPP_GEN_CLASS(::BeatSaber::GraphQL::DummyGraphQLClient__OculusStudios_GraphQL_ClientInterface_IGraphQLClient_Mutate_d__10_2, "BeatSaber.GraphQL",
                        "DummyGraphQLClient/<OculusStudios-GraphQL-ClientInterface-IGraphQLClient-Mutate>d__10`2");
DEFINE_IL2CPP_GEN_CLASS(::BeatSaber::GraphQL::DummyGraphQLClient__OculusStudios_GraphQL_ClientInterface_IGraphQLClient_Mutate_d__9_1, "BeatSaber.GraphQL",
                        "DummyGraphQLClient/<OculusStudios-GraphQL-ClientInterface-IGraphQLClient-Mutate>d__9`1");
DEFINE_IL2CPP_GEN_CLASS(::BeatSaber::GraphQL::DummyGraphQLClient__OculusStudios_GraphQL_ClientInterface_IGraphQLClient_Query_d__11_1, "BeatSaber.GraphQL",
...
// Non member Declarations
static_assert(sizeof(::BeatSaber::GraphQL::DummyGraphQLClient) == 0x10, "Size mismatch!");
