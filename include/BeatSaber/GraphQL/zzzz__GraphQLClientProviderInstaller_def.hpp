...
public:
  ...
  /// @brief Method InstallBindings, addr 0x3296e8c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3296e3c, size 0x50, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientProviderInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GraphQLClientProviderInstaller(GraphQLClientProviderInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GraphQLClientProviderInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GraphQLClientProviderInstaller(GraphQLClientProviderInstallerconst&) = delete;
