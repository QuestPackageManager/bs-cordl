...
public:
  ...
  /// @brief Method InstallBindings, addr 0x32001e4, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3200194, size 0x50, virtual false, abstract: false, final false
