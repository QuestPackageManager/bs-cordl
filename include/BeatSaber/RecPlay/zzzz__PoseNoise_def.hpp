...
public:
  // Declarations
  /// @brief Method Sample, addr 0x31f0c58, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose Sample(float_t time);

  /// @brief Method SampleLemniscateOfBernoulli, addr 0x31f0d20, size 0x40, virtual false, abstract: false, final false
