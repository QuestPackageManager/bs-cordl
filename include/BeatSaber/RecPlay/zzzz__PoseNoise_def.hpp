...
public:
// Declarations
/// @brief Method Sample, addr 0x31f0ba8, size 0xc8, virtual false, abstract: false, final false
inline ::UnityEngine::Pose Sample(float_t  time) ;

/// @brief Method SampleLemniscateOfBernoulli, addr 0x31f0c70, size 0x40, virtual false, abstract: false, final false
