...
public:
  // Declarations
  /// @brief Method Sample, addr 0x227b1f4, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose Sample(float_t time);

  /// @brief Method SampleLemniscateOfBernoulli, addr 0x227b2b0, size 0x40, virtual false, abstract: false, final false
