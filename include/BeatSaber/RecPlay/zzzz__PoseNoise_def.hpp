...
public:
  // Declarations
  /// @brief Method Sample, addr 0x227a418, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose Sample(float_t time);

  /// @brief Method SampleLemniscateOfBernoulli, addr 0x227a4d4, size 0x40, virtual false, abstract: false, final false
