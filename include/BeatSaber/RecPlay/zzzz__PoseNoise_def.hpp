...
public:
  // Declarations
  /// @brief Method Sample, addr 0x32c59f8, size 0xc8, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose Sample(float_t time);

  /// @brief Method SampleLemniscateOfBernoulli, addr 0x32c5ac0, size 0x440, virtual false, abstract: false, final false
