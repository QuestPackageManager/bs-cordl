...
public:
  // Declarations
  /// @brief Method Sample, addr 0xe9e9e8, size 0xbc, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose Sample(float_t time);

  /// @brief Method SampleLemniscateOfBernoulli, addr 0xe9eaa4, size 0x40, virtual false, abstract: false, final false
