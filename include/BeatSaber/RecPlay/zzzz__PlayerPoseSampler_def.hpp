...
public:
  ...
  /// @brief Method Sample, addr 0xe9e2a0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe9e560, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
