...
public:
  ...
  /// @brief Method Sample, addr 0x31bfbd0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31bfee8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
