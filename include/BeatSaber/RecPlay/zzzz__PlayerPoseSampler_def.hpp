...
public:
  ...
  /// @brief Method Sample, addr 0x227aae4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227ae58, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
