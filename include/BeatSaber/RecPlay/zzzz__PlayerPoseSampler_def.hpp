...
public:
  ...
  /// @brief Method Sample, addr 0x106ee98, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x106f158, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
