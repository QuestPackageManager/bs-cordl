...
public:
  ...
  /// @brief Method Sample, addr 0x32c3c4c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32c3f64, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
