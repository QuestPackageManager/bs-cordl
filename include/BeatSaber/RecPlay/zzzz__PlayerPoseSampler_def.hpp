...
// Write type traits
MARK_REF_T(::BeatSaber::RecPlay::PlayerPoseSampler*);
DEFINE_IL2CPP_CLASS(::BeatSaber::RecPlay::PlayerPoseSampler*, "BeatSaber.RecPlay", "PlayerPoseSampler");
...
public:
  ...
  /// @brief Method Sample, addr 0x32c53d4, size 0x110, virtual false, abstract: false, final false
  inline void Sample(float_t time, ::by_ref<::BeatSaber::RecPlay::PlayerPose> player);
  ...
  /// @brief Method .ctor, addr 0x32c56ec, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseSampler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerPoseSampler(PlayerPoseSampler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseSampler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerPoseSampler(PlayerPoseSamplerconst&) = delete;
...
static_assert(sizeof(::BeatSaber::RecPlay::PlayerPoseSampler) == 0x90, "Size mismatch!");
