...
public:
  ...
  /// @brief Method Sample, addr 0x227bd58, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227c0cc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
