...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Pose (::BeatSaber::RecPlay::PoseNoise::*)(float_t)>(&::BeatSaber::RecPlay::PoseNoise::Sample)> {
  ...
  constexpr static std::size_t addrs = 0x31f0ba8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::RecPlay::PoseNoise>::get(),
                        "Sample",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(float_t)>(&::BeatSaber::RecPlay::PoseNoise::SampleLemniscateOfBernoulli)> {
  ...
  constexpr static std::size_t addrs = 0x31f0c70;
...
// Ctor Parameters [CppParam { name: "frequency", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "move", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "rotate", ty: "float_t", modifiers: "", def_value: Some("{}") }]
