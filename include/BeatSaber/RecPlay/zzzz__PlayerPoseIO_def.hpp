...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseIO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerPoseIO(PlayerPoseIO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseIO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerPoseIO(PlayerPoseIOconst&) = delete;
