...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::RecPlay::PoseOffsets::*)(::ByRef<::BeatSaber::RecPlay::PlayerPose>)>(&::BeatSaber::RecPlay::PoseOffsets::Adjust)> {
  constexpr static std::size_t size = 0x198;
  constexpr static std::size_t addrs = 0x31f0698;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::RecPlay::PoseOffsets>::get(),
                        "Adjust",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::BeatSaber::RecPlay::PlayerPose>>::get()}
                    )));
    return ___internal_method;
  }
};
inline void BeatSaber::RecPlay::PoseOffsets::setStaticF_kDefault(::BeatSaber::RecPlay::PoseOffsets  value)  {
::cordl_internals::setStaticField<::BeatSaber::RecPlay::PoseOffsets, "kDefault", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::RecPlay::PoseOffsets>::get>(std::forward<::BeatSaber::RecPlay::PoseOffsets>(value));
}
...
// Ctor Parameters [CppParam { name: "room", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }, CppParam { name: "leftController", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }, CppParam { name: "rightController", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }]
