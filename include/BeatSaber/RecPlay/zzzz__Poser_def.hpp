...
public:
  // Declarations
  /// @brief Method InterpolatePose, addr 0x227c944, size 0x8c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InterpolatePose(::ByRef<::UnityEngine::Pose> a, ::ByRef<::UnityEngine::Pose> b, float_t t);

  /// @brief Method InvertPose, addr 0x227cb9c, size 0x68, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose InvertPose(::UnityEngine::Pose pose);

  /// @brief Method MirrorPoseYZ, addr 0x227cc04, size 0x6c4, virtual false, abstract: false, final false
