...
public:
// Declarations
/// @brief Method InterpolatePose, addr 0x31f0a58, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose InterpolatePose(::ByRef<::UnityEngine::Pose>  a, ::ByRef<::UnityEngine::Pose>  b, float_t  t) ;

/// @brief Method InvertPose, addr 0x31f0cb0, size 0x68, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose InvertPose(::UnityEngine::Pose  pose) ;

/// @brief Method MirrorPoseYZ, addr 0x31f0d18, size 0x434, virtual false, abstract: false, final false
