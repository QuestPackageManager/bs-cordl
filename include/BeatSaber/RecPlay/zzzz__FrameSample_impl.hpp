...
// Ctor Parameters [CppParam { name: "previous", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "next", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "alpha", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }]
