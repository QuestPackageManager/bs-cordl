...
public:
  ...
  /// @brief Method AdjustHead, addr 0xe9e504, size 0x5c, virtual false, abstract: false, final false
  inline void AdjustHead(ByRef<::UnityEngine::Pose> pose);

  /// @brief Method AdjustLeftHand, addr 0xe9e42c, size 0x6c, virtual false, abstract: false, final false
  inline void AdjustLeftHand(ByRef<::UnityEngine::Pose> pose);

  /// @brief Method AdjustPose, addr 0xe9e820, size 0xc0, virtual false, abstract: false, final false
  static inline void AdjustPose(ByRef<::UnityEngine::Pose> pose, ByRef<::UnityEngine::Pose> room, ByRef<::UnityEngine::Pose> controller);

  /// @brief Method AdjustRightHand, addr 0xe9e498, size 0x6c, virtual false, abstract: false, final false
