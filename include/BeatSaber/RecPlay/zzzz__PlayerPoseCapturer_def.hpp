...
public:
  ...
  /// @brief Method Capture, addr 0x2279664, size 0x120, virtual false, abstract: false, final false
  inline void Capture(float_t time, ::BeatSaber::RecPlay::PlayerPose pose);

  /// @brief Method CreatePlayerPoseFrames, addr 0x2279784, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22795dc, size 0x88, virtual false, abstract: false, final false
