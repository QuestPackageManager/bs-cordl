...
public:
  ...
  /// @brief Method Capture, addr 0x32c3e08, size 0x104, virtual false, abstract: false, final false
  inline void Capture(float_t time, ::BeatSaber::RecPlay::PlayerPose pose);

  /// @brief Method CreatePlayerPoseFrames, addr 0x32c3f0c, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32c3d84, size 0x84, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseCapturer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerPoseCapturer(PlayerPoseCapturer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerPoseCapturer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerPoseCapturer(PlayerPoseCapturerconst&) = delete;
