...
public:
  // Declarations
  /// @brief Method FindPoseSample, addr 0x322c508, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method InterpolatePoseSample, addr 0x322c650, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SamplePose, addr 0x322c290, size 0x70, virtual false, abstract: false, final false
