...
public:
  // Declarations
  /// @brief Method FindPoseSample, addr 0x2278640, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method InterpolatePoseSample, addr 0x227879c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SamplePose, addr 0x227835c, size 0x70, virtual false, abstract: false, final false
