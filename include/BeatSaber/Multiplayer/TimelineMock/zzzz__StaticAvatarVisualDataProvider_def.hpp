...
public:
  ...
  /// @brief Method .ctor, addr 0x104cc68, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MultiplayerAvatarsData avatarsData);

  /// @brief Method get_avatarsData, addr 0x104cc54, size 0x14, virtual true, abstract: false, final true
