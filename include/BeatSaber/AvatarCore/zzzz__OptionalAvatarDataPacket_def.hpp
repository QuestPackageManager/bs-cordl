...
public:
  ...
  /// @brief Method get_pool addr 0xe10ccc size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::BeatSaber::AvatarCore::OptionalAvatarDataPacket*>* get_pool();

  /// @brief Method Serialize addr 0xe10d0c size 0x44 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xe10d50 size 0x48 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xe10d98 size 0x64 virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xe10dfc size 0x8 virtual false final false
  inline ::BeatSaber::AvatarCore::OptionalAvatarDataPacket* Init(::BeatSaber::AvatarCore::OptionalAvatarData optionalAvatarData);

  /// @brief Method Init addr 0xe10e04 size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe10e38 size 0x8c virtual false final false
  inline void _ctor();
