...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OptionalAvatarDataPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OptionalAvatarDataPacket(OptionalAvatarDataPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OptionalAvatarDataPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OptionalAvatarDataPacket(OptionalAvatarDataPacketconst&) = delete;
