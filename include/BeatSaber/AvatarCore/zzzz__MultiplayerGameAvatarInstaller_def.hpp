...
public:
  ...
  /// @brief Method InstallBindings, addr 0x1042978, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1042bb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
