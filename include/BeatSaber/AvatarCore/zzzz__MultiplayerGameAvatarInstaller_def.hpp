...
/// @brief Method InstallBindings, addr 0x31a06a0, size 0x2d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31a0974, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
