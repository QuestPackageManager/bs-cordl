...
public:
  ...
  /// @brief Method InstallBindings, addr 0xf53e04, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf54040, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
