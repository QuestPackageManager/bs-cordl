...
public:
  ...
  /// @brief Method InstallBindings, addr 0x225498c, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2254bc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
