...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::AvatarHeadOffset*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::AvatarHeadOffset*, "BeatSaber.AvatarCore", "AvatarHeadOffset");
...
public:
  ...
  /// @brief Method HandleMultiplayerAvatarPoseControllerDidUpdatePose, addr 0x326b57c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x326b3ac, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x326b260, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x326b5d0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AvatarHeadOffset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AvatarHeadOffset(AvatarHeadOffset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AvatarHeadOffset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AvatarHeadOffset(AvatarHeadOffsetconst&) = delete;
...
static_assert(sizeof(::BeatSaber::AvatarCore::AvatarHeadOffset) == 0x38, "Size mismatch!");
