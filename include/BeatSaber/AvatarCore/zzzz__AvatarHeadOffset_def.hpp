...
public:
  ...
  /// @brief Method HandleMultiplayerAvatarPoseControllerDidUpdatePose, addr 0x319bdd0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x319bc00, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x319bab4, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x319be24, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
