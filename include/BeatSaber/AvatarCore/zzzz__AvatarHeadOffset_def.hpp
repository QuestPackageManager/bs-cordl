...
/// @brief Field _avatarPoseController, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__avatarPoseController, put=__cordl_internal_set__avatarPoseController)) ::UnityW<::BeatSaber::AvatarCore::MultiplayerAvatarPoseController>  _avatarPoseController;
...
/// @brief Method HandleMultiplayerAvatarPoseControllerDidUpdatePose, addr 0x31d3548, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x31d3378, size 0x110, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x31d322c, size 0x8c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x31d359c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
