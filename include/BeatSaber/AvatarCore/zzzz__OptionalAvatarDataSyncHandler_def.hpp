...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::OptionalAvatarDataSyncHandler*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::OptionalAvatarDataSyncHandler*, "BeatSaber.AvatarCore", "OptionalAvatarDataSyncHandler");
...
public:
  ...
  /// @brief Method Dispose, addr 0x3270af4, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataChanged, addr 0x3270bb4, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOptionalAvatarDataPacket, addr 0x3270e98, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SendOptionalAvatarData, addr 0x327068c, size 0x25c, virtual false, abstract: false, final false
  inline void SendOptionalAvatarData(::BeatSaber::AvatarCore::OptionalAvatarData data);

  /// @brief Method TryGetAllLatestOptionalAvatarData, addr 0x326f618, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32708e8, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method add_didChangeOptionalAvatarDataEvent, addr 0x326f9e0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeOptionalAvatarDataEvent, addr 0x326fb34, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::OptionalAvatarDataSyncHandler) == 0x28, "Size mismatch!");
