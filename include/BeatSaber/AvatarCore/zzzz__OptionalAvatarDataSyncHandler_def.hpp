...
public:
  ...
  /// @brief Method Dispose, addr 0x2251c20, size 0xbc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataChanged, addr 0x2251cdc, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOptionalAvatarDataPacket, addr 0x2251f38, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SendOptionalAvatarData, addr 0x225181c, size 0x250, virtual false, abstract: false, final false
  inline void SendOptionalAvatarData(::BeatSaber::AvatarCore::OptionalAvatarData data);

  /// @brief Method TryGetAllLatestOptionalAvatarData, addr 0x2250834, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2251a6c, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method add_didChangeOptionalAvatarDataEvent, addr 0x2250bd8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeOptionalAvatarDataEvent, addr 0x2250d14, size 0xb0, virtual false, abstract: false, final false
