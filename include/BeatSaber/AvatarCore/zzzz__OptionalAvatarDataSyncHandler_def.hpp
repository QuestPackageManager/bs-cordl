...
public:
  ...
  /// @brief Method add_didChangeOptionalAvatarDataEvent addr 0xe108ac size 0xb0 virtual false final false
  ...
  /// @brief Method remove_didChangeOptionalAvatarDataEvent addr 0xe109f0 size 0xb0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe1172c size 0x1bc virtual false final false
  inline void _ctor(::GlobalNamespace::IMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method Dispose addr 0xe118e8 size 0xc8 virtual true final true
  inline void Dispose();

  /// @brief Method SendOptionalAvatarData addr 0xe114e4 size 0x248 virtual false final false
  inline void SendOptionalAvatarData(::BeatSaber::AvatarCore::OptionalAvatarData data);

  /// @brief Method TryGetAllLatestOptionalAvatarData addr 0xe10504 size 0x68 virtual false final false
  ...
  /// @brief Method HandleOptionalAvatarDataPacket addr 0xe11c10 size 0x80 virtual false final false
  ...
  /// @brief Method HandleOptionalAvatarDataChanged addr 0xe119b0 size 0x260 virtual false final false
