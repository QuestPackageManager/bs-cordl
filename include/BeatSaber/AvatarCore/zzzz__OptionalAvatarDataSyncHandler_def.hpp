...
public:
  ...
  /// @brief Method Dispose, addr 0x2256020, size 0xbc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataChanged, addr 0x22560dc, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOptionalAvatarDataPacket, addr 0x2256338, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method SendOptionalAvatarData, addr 0x2255c1c, size 0x250, virtual false, abstract: false, final false
  inline void SendOptionalAvatarData(::BeatSaber::AvatarCore::OptionalAvatarData data);

  /// @brief Method TryGetAllLatestOptionalAvatarData, addr 0x2254c34, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2255e6c, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method add_didChangeOptionalAvatarDataEvent, addr 0x2254fd8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeOptionalAvatarDataEvent, addr 0x2255114, size 0xb0, virtual false, abstract: false, final false
