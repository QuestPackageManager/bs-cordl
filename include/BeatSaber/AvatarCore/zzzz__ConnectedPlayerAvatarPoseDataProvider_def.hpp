...
public:
  ...
  /// @brief Method Tick, addr 0xe60278, size 0x564, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0xe6023c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_poseDidChangeEvent, addr 0xe600dc, size 0xb0, virtual true, abstract: false, final true
  inline void add_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>* value);

  /// @brief Method get_currentPose, addr 0xe600cc, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_poseDidChangeEvent, addr 0xe6018c, size 0xb0, virtual true, abstract: false, final true
