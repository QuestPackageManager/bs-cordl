...
public:
  ...
  /// @brief Method Tick, addr 0x224f844, size 0x558, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x224f808, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_poseDidChangeEvent, addr 0x224f6a8, size 0xb0, virtual true, abstract: false, final true
  inline void add_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>* value);

  /// @brief Method get_currentPose, addr 0x224f698, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_poseDidChangeEvent, addr 0x224f758, size 0xb0, virtual true, abstract: false, final true
