...
public:
  ...
  /// @brief Method Tick, addr 0x31d5e90, size 0x4f8, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x31d5e84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method add_poseDidChangeEvent, addr 0x31d5d04, size 0xc0, virtual true, abstract: false, final true
  inline void add_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>* value);

  /// @brief Method get_currentPose, addr 0x31d5cf4, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_poseDidChangeEvent, addr 0x31d5dc4, size 0xc0, virtual true, abstract: false, final true
