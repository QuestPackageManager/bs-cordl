...
public:
  ...
  /// @brief Method MoveNext, addr 0x2249a98, size 0x5c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x224a1d8, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadAndDisplayAvatar, addr 0x2249a00, size 0x90, virtual false, abstract: false, final false
  inline void LoadAndDisplayAvatar();

  static inline ::BeatSaber::AvatarCore::AvatarController* New_ctor();

  /// @brief Method Start, addr 0x22499fc, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2249a90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_avatar, addr 0x22499f4, size 0x8, virtual false, abstract: false, final false
