...
public:
  ...
  /// @brief Method MoveNext, addr 0x2214c94, size 0x5c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22153d4, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadAndDisplayAvatar, addr 0x2214bfc, size 0x90, virtual false, abstract: false, final false
  inline void LoadAndDisplayAvatar();

  static inline ::BeatSaber::AvatarCore::AvatarController* New_ctor();

  /// @brief Method Start, addr 0x2214bf8, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2214c8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_avatar, addr 0x2214bf0, size 0x8, virtual false, abstract: false, final false
