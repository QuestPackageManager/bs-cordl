...
public:
  ...
  /// @brief Method MoveNext, addr 0x103d22c, size 0x5d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x103d97c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadAndDisplayAvatar, addr 0x103d190, size 0x94, virtual false, abstract: false, final false
  inline void LoadAndDisplayAvatar();

  static inline ::BeatSaber::AvatarCore::AvatarController* New_ctor();

  /// @brief Method Start, addr 0x103d18c, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x103d224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_avatar, addr 0x103d184, size 0x8, virtual false, abstract: false, final false
