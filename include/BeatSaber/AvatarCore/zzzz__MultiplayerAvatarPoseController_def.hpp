...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::MultiplayerAvatarPoseController*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::MultiplayerAvatarPoseController*, "BeatSaber.AvatarCore", "MultiplayerAvatarPoseController");
...
static_assert(sizeof(::BeatSaber::AvatarCore::MultiplayerAvatarPoseController) == 0x58, "Size mismatch!");
