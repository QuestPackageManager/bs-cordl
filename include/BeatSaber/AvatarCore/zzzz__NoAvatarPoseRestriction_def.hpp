...
/// @brief Method RestrictPose, addr 0x31d81a0, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x31d81d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
