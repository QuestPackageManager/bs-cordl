...
public:
  ...
  /// @brief Method RestrictPose, addr 0x2254bc8, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2254bf4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
