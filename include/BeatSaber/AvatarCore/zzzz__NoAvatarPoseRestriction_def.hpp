...
public:
  ...
  /// @brief Method RestrictPose, addr 0x2250d90, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2250dbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
