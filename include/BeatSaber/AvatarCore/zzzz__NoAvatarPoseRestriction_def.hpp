...
public:
  ...
  /// @brief Method RestrictPose, addr 0x2250808, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2250834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
