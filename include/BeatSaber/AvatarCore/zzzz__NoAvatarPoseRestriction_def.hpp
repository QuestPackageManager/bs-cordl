...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoAvatarPoseRestriction", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoAvatarPoseRestriction(NoAvatarPoseRestriction&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoAvatarPoseRestriction", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoAvatarPoseRestriction(NoAvatarPoseRestrictionconst&) = delete;
