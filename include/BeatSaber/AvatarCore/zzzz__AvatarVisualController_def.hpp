...
public:
  ...
  /// @brief Method __SetAvatarController, addr 0x326eba8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326ebb0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
