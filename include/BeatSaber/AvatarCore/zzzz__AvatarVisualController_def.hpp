...
public:
  ...
  /// @brief Method MoveNext, addr 0x1041260, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x1041328, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1041330, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1041370, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x104125c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1041224, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SetLightColor, addr 0x1041058, size 0x13c, virtual false, abstract: false, final false
  inline void SetLightColor(::UnityEngine::Color color);

  /// @brief Method WaitForAvatarLoadAndSetLightColor, addr 0x1041194, size 0x90, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* WaitForAvatarLoadAndSetLightColor(::UnityEngine::Color color);

  /// @brief Method __SetAvatarController, addr 0x104124c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1041254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
