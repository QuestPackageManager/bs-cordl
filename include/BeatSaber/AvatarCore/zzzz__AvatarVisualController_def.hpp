...
public:
  ...
  /// @brief Method MoveNext, addr 0x224dbc4, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x224dc8c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x224dc94, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x224dccc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x224dbc0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x224db88, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SetLightColor, addr 0x224d9c4, size 0x13c, virtual false, abstract: false, final false
  inline void SetLightColor(::UnityEngine::Color color);

  /// @brief Method WaitForAvatarLoadAndSetLightColor, addr 0x224db00, size 0x88, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* WaitForAvatarLoadAndSetLightColor(::UnityEngine::Color color);

  /// @brief Method __SetAvatarController, addr 0x224dbb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224dbb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
