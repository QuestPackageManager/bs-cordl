...
public:
  ...
  /// @brief Method MoveNext, addr 0x31d5ac8, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x31d5b94, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x31d5b9c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x31d5bd4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x31d5ac4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31d5ab0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SetLightColor, addr 0x31d58f4, size 0x140, virtual false, abstract: false, final false
  inline void SetLightColor(::UnityEngine::Color color);

  /// @brief Method WaitForAvatarLoadAndSetLightColor, addr 0x31d5a34, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* WaitForAvatarLoadAndSetLightColor(::UnityEngine::Color color);

  /// @brief Method __SetAvatarController, addr 0x31d5ab8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d5ac0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
