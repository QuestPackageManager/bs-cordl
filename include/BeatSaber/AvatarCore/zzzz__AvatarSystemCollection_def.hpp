...
public:
  ...
  /// @brief Method .ctor, addr 0x224dbf8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_anyAvatarCreated>b__14_0, addr 0x224dc00, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x224dca0, size 0x46c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x224e10c, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x224e174, size 0x910, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x224ea84, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AvatarSystemBySelectionSortOrder, addr 0x224d5f0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDefaultAvatarsForAvatarSystemsWithoutUserCreatedAvatarAsync, addr 0x224da20, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* CreateDefaultAvatarsForAvatarSystemsWithoutUserCreatedAvatarAsync();

  /// @brief Method GetAvatarSystem, addr 0x224db8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAvatarSystem, addr 0x224dae4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAvatarSystem, addr 0x224d9f0, size 0x30, virtual false, abstract: false, final false
  inline ::BeatSaber::AvatarCore::IAvatarSystem* GetAvatarSystem(::StringW avatarTypeIdentifier);

  /// @brief Method GetAvatarSystem, addr 0x224b398, size 0x124, virtual false, abstract: false, final false
  inline ::BeatSaber::AvatarCore::IAvatarSystem* GetAvatarSystem(uint32_t avatarTypeIdentifierHash);

  /// @brief Method GetMultiplayerAvatarOptionalDataProvider, addr 0x224d934, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMultiplayerAvatarsData, addr 0x224d838, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAvatarSystem, addr 0x224b340, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224cb54, size 0xa9c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::BeatSaber::AvatarCore::IAvatarSystem*>* boundAvatarSystems);

  /// @brief Method get_anyAvatarCreated, addr 0x224d718, size 0x120, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* get_anyAvatarCreated();

  /// @brief Method get_availableAvatarSystems, addr 0x224cb44, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* get_availableAvatarSystems();

  /// @brief Method get_selectableAvatarSystems, addr 0x224cb3c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* get_selectableAvatarSystems();

  /// @brief Method get_supportedOptionalAvatarDataType, addr 0x224cb4c, size 0x8, virtual false, abstract: false, final false
