...
public:
  // Declarations
  /// @brief Method ReadColor, addr 0x224dd5c, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Color ReadColor(::System::IO::BinaryReader* binaryReader);

  /// @brief Method Write, addr 0x224dcd4, size 0x88, virtual false, abstract: false, final false
