...
public:
  ...
  /// @brief Method FollowPosition, addr 0xe78898, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0xe787d4, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0xe787f0, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0xe78980, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
