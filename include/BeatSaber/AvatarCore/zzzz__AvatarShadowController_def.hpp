...
public:
  ...
  /// @brief Method FollowPosition, addr 0x104763c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x1047578, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x1047594, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x1047724, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
