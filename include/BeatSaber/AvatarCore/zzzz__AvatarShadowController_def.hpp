...
public:
  ...
  /// @brief Method FollowPosition, addr 0x224cf84, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x224cec0, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x224cedc, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x224d06c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
