...
public:
  ...
  /// @brief Method Finish, addr 0x2249868, size 0x2c, virtual false, abstract: false, final false
  inline void Finish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction finishAction);

  /// @brief Method HandleBeatAvatarEditorRandomizeAllButtonWasPressed, addr 0x2249894, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAvatarSystem, addr 0x2249860, size 0x8, virtual false, abstract: false, final false
  inline void SetAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method Setup, addr 0x2249800, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22498b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method add_randomizeAllButtonWasPressedEvent, addr 0x22496c8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_randomizeAllButtonWasPressedEvent, addr 0x2249764, size 0x9c, virtual false, abstract: false, final false
