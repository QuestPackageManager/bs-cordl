...
public:
  ...
  /// @brief Method Finish, addr 0x31d24bc, size 0x2c, virtual false, abstract: false, final false
  inline void Finish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction finishAction);

  /// @brief Method HandleBeatAvatarEditorRandomizeAllButtonWasPressed, addr 0x31d24e8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAvatarSystem, addr 0x31d24b4, size 0x8, virtual false, abstract: false, final false
  inline void SetAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method Setup, addr 0x31d2454, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d2504, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x31d1ffc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didSetupEvent, addr 0x31d217c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>* value);

  /// @brief Method add_randomizeAllButtonWasPressedEvent, addr 0x31d22fc, size 0xac, virtual false, abstract: false, final false
  inline void add_randomizeAllButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_didFinishEvent, addr 0x31d20bc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSetupEvent, addr 0x31d223c, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>* value);

  /// @brief Method remove_randomizeAllButtonWasPressedEvent, addr 0x31d23a8, size 0xac, virtual false, abstract: false, final false
