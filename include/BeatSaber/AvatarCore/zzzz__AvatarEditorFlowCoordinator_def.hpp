...
public:
  ...
  /// @brief Method Finish, addr 0x224fd28, size 0x2c, virtual false, abstract: false, final false
  inline void Finish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction finishAction);

  /// @brief Method HandleBeatAvatarEditorRandomizeAllButtonWasPressed, addr 0x224fd54, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAvatarSystem, addr 0x224fd20, size 0x8, virtual false, abstract: false, final false
  inline void SetAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method Setup, addr 0x224fcc0, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224fd70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x224f8c8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didSetupEvent, addr 0x224fa28, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>* value);

  /// @brief Method add_randomizeAllButtonWasPressedEvent, addr 0x224fb88, size 0x9c, virtual false, abstract: false, final false
  inline void add_randomizeAllButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_didFinishEvent, addr 0x224f978, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSetupEvent, addr 0x224fad8, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>* value);

  /// @brief Method remove_randomizeAllButtonWasPressedEvent, addr 0x224fc24, size 0x9c, virtual false, abstract: false, final false
