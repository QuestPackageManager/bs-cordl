...
/// @brief Field didFinishEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*  didFinishEvent;

/// @brief Field didSetupEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSetupEvent, put=__cordl_internal_set_didSetupEvent)) ::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>*  didSetupEvent;
...
/// @brief Method Finish, addr 0x319b9b4, size 0x2c, virtual false, abstract: false, final false
inline void Finish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction  finishAction) ;

/// @brief Method HandleBeatAvatarEditorRandomizeAllButtonWasPressed, addr 0x319b9e0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetAvatarSystem, addr 0x319b9ac, size 0x8, virtual false, abstract: false, final false
inline void SetAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem) ;

/// @brief Method Setup, addr 0x319b94c, size 0x60, virtual true, abstract: false, final false
...
constexpr ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>* const& __cordl_internal_get_didFinishEvent() const;

constexpr ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*& __cordl_internal_get_didFinishEvent() ;
...
constexpr void __cordl_internal_set_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*  value) ;
...
/// @brief Method .ctor, addr 0x319b9fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x319b4f4, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*  value) ;

/// @brief Method add_didSetupEvent, addr 0x319b674, size 0xc0, virtual false, abstract: false, final false
inline void add_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>*  value) ;

/// @brief Method add_randomizeAllButtonWasPressedEvent, addr 0x319b7f4, size 0xac, virtual false, abstract: false, final false
inline void add_randomizeAllButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x319b5b4, size 0xc0, virtual false, abstract: false, final false
inline void remove_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*  value) ;

/// @brief Method remove_didSetupEvent, addr 0x319b734, size 0xc0, virtual false, abstract: false, final false
inline void remove_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode>*  value) ;

/// @brief Method remove_randomizeAllButtonWasPressedEvent, addr 0x319b8a0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Field didFinishEvent, offset: 0xb0, size: 0x8, def value: None
 ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction>*  ___didFinishEvent;
