...
public:
  ...
  /// @brief Method .ctor, addr 0x224be2c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method get_avatarsData, addr 0x224bd64, size 0xc8, virtual true, abstract: false, final true
