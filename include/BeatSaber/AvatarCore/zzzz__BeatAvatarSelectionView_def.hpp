...
public:
  ...
  /// @brief Method Activate, addr 0x31daee0, size 0x3c, virtual true, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x31daf1c, size 0x14, virtual true, abstract: false, final false
  inline void Deactivate();

  /// @brief Method HandleAvatarDataModelDidChangeAvatarData, addr 0x31daf30, size 0x4, virtual false, abstract: false, final false
  inline void HandleAvatarDataModelDidChangeAvatarData(::BeatSaber::BeatAvatarSDK::AvatarData* data);

  /// @brief Method Init, addr 0x31dad50, size 0x98, virtual false, abstract: false, final false
  inline void Init();

  static inline ::BeatSaber::AvatarCore::BeatAvatarSelectionView* New_ctor();

  /// @brief Method OnDestroy, addr 0x31dae10, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetCreated, addr 0x31daea8, size 0x38, virtual true, abstract: false, final false
  inline void SetCreated(bool isCreated);

  /// @brief Method UpdateAvatarVisuals, addr 0x31dade8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31daf34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
