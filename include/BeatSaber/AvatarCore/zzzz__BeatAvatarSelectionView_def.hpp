...
/// @brief Field _beatAvatarVisualController, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatAvatarVisualController, put=__cordl_internal_set__beatAvatarVisualController)) ::UnityW<::BeatSaber::BeatAvatarSDK::BeatAvatarVisualController>  _beatAvatarVisualController;

/// @brief Method Activate, addr 0x31a43d8, size 0x3c, virtual true, abstract: false, final false
inline void Activate() ;

/// @brief Method Deactivate, addr 0x31a4414, size 0x14, virtual true, abstract: false, final false
inline void Deactivate() ;

/// @brief Method HandleAvatarDataModelDidChangeAvatarData, addr 0x31a4428, size 0x4, virtual false, abstract: false, final false
inline void HandleAvatarDataModelDidChangeAvatarData(::BeatSaber::BeatAvatarSDK::AvatarData*  data) ;

/// @brief Method Init, addr 0x31a4248, size 0x98, virtual false, abstract: false, final false
inline void Init() ;

static inline ::BeatSaber::AvatarCore::BeatAvatarSelectionView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x31a4308, size 0x98, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetCreated, addr 0x31a43a0, size 0x38, virtual true, abstract: false, final false
inline void SetCreated(bool  isCreated) ;

/// @brief Method UpdateAvatarVisuals, addr 0x31a42e0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31a442c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
