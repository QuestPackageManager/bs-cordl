...
public:
  ...
  /// @brief Method Dispose, addr 0x31d8420, size 0x13c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataProviderDataDidChange, addr 0x31d8338, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentLocalAvatarDisplayContext, addr 0x31d834c, size 0xd4, virtual false, abstract: false, final false
  inline void SetCurrentLocalAvatarDisplayContext(::BeatSaber::AvatarCore::AvatarDisplayContext avatarDisplayContext);

  /// @brief Method SetSelectedAvatarTypeId, addr 0x31d7f00, size 0x438, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d7ef8, size 0x8, virtual false, abstract: false, final false
