...
public:
  ...
  /// @brief Method Dispose, addr 0xf54f8c, size 0x108, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataProviderDataDidChange, addr 0xf54eb0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentLocalAvatarDisplayContext, addr 0xf54ec8, size 0xc4, virtual false, abstract: false, final false
  inline void SetCurrentLocalAvatarDisplayContext(::BeatSaber::AvatarCore::AvatarDisplayContext avatarDisplayContext);

  /// @brief Method SetSelectedAvatarTypeId, addr 0xf54aa0, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf54a74, size 0x2c, virtual false, abstract: false, final false
