...
public:
  ...
  /// @brief Method Dispose, addr 0x104c2ac, size 0x108, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleOptionalAvatarDataProviderDataDidChange, addr 0x104c1d0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCurrentLocalAvatarDisplayContext, addr 0x104c1e8, size 0xc4, virtual false, abstract: false, final false
  inline void SetCurrentLocalAvatarDisplayContext(::BeatSaber::AvatarCore::AvatarDisplayContext avatarDisplayContext);

  /// @brief Method SetSelectedAvatarTypeId, addr 0x104bdc0, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x104bd94, size 0x2c, virtual false, abstract: false, final false
