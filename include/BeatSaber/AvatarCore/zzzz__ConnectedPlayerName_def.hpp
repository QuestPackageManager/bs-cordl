...
public:
  ...
  /// @brief Method Start, addr 0x316fd10, size 0xc8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x316fdd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
