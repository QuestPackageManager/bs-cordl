...
public:
  ...
  /// @brief Method Start, addr 0x104a43c, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x104a500, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
