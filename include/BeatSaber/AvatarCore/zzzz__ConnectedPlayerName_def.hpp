...
public:
  ...
  /// @brief Method Start, addr 0xe7b698, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0xe7b75c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
