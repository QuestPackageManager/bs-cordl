...
public:
  ...
  /// @brief Method Start, addr 0x224e5e0, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x224e6a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
