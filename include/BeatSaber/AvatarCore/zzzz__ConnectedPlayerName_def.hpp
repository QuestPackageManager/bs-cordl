...
public:
  ...
  /// @brief Method Start, addr 0x224d804, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x224d8c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
