...
public:
  ...
  /// @brief Method SetOptionalDataProvider, addr 0x224ae8c, size 0x1e8, virtual false, abstract: false, final false
  inline void SetOptionalDataProvider(::BeatSaber::AvatarCore::IOptionalAvatarDataProvider* optionalDataProvider);

  /// @brief Method SetPoseDataProvider, addr 0x224ab90, size 0x218, virtual false, abstract: false, final false
  inline void SetPoseDataProvider(::BeatSaber::AvatarCore::IAvatarPoseDataProvider* poseDataProvider);

  /// @brief Method SetVisualDataProvider, addr 0x224ada8, size 0xe4, virtual false, abstract: false, final false
  inline void SetVisualDataProvider(::BeatSaber::AvatarCore::IAvatarVisualDataProvider* visualDataProvider);

  /// @brief Method UpdateAvatarFromOptionalData, addr 0x224b1cc, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateAvatarFromOptionalDataList, addr 0x224b074, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224b298, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
