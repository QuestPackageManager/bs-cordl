...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAvatarVisualDataProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAvatarVisualDataProvider(IAvatarVisualDataProviderconst&) = delete;
