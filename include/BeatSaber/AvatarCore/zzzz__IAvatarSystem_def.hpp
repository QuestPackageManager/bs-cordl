...
public:
  ...
  /// @brief Method get_selectableByUser addr 0x0 size 0xffffffffffffffff virtual true final false
  inline bool get_selectableByUser();

  /// @brief Method get_isFallbackSystem addr 0x0 size 0xffffffffffffffff virtual true final false
  inline bool get_isFallbackSystem();

  /// @brief Method get_selectionSortOrder addr 0x0 size 0xffffffffffffffff virtual true final false
  inline int32_t get_selectionSortOrder();

  /// @brief Method get_supportedOptionalAvatarDataTypes addr 0x0 size 0xffffffffffffffff virtual true final false
