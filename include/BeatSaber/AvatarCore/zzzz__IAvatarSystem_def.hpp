...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::IAvatarSystem*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::IAvatarSystem*, "BeatSaber.AvatarCore", "IAvatarSystem");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAvatarSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAvatarSystem(IAvatarSystemconst&) = delete;
