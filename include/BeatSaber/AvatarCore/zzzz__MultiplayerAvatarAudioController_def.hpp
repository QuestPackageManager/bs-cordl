...
public:
  ...
  /// @brief Method MoveNext, addr 0xe60f8c, size 0xd4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::AvatarCore::__MultiplayerAvatarAudioController___Start_d__4* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0xe61060, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0xe61068, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0xe610a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0xe60f88, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xe60f58, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0xe60ef0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe60f80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_connectedPlayer, addr 0xe60ee8, size 0x8, virtual false, abstract: false, final false
