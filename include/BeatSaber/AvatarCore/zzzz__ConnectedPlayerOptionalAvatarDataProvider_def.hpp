...
/// @brief Method Dispose, addr 0x31a0e68, size 0x94, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleOptionalAvatarDataSyncHandlerDidChangeOptionalAvatarDataSync, addr 0x31a0fc0, size 0x16c, virtual false, abstract: false, final false
inline void HandleOptionalAvatarDataSyncHandlerDidChangeOptionalAvatarDataSync(::GlobalNamespace::IBeatSaberConnectedPlayer*  connectedPlayer, ::BeatSaber::AvatarCore::OptionalAvatarData  optionalAvatarData) ;

static inline ::BeatSaber::AvatarCore::ConnectedPlayerOptionalAvatarDataProvider* New_ctor(::GlobalNamespace::IBeatSaberConnectedPlayer*  connectedPlayer, ::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::BeatSaber::AvatarCore::OptionalAvatarDataSyncHandler*  optionalAvatarDataSyncHandler) ;

/// @brief Method SetDisplayContext, addr 0x31a0fbc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x31a0cfc, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IBeatSaberConnectedPlayer*  connectedPlayer, ::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::BeatSaber::AvatarCore::OptionalAvatarDataSyncHandler*  optionalAvatarDataSyncHandler) ;

/// @brief Method add_dataDidChangeEvent, addr 0x31a0b7c, size 0xc0, virtual true, abstract: false, final true
inline void add_dataDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::OptionalAvatarData>*  value) ;

/// @brief Method get_currentData, addr 0x31a09ac, size 0x34, virtual true, abstract: false, final true
inline ::System::Collections::Generic::Dictionary_2<uint32_t,::BeatSaber::AvatarCore::OptionalAvatarData>* get_currentData() ;

/// @brief Method get_playbackDelayMs, addr 0x31a0a4c, size 0x130, virtual true, abstract: false, final true
...
/// @brief Method remove_dataDidChangeEvent, addr 0x31a0c3c, size 0xc0, virtual true, abstract: false, final true
