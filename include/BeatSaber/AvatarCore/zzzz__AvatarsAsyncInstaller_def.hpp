...
public:
  ...
  /// @brief Method InstallBindings, addr 0xe5ce34, size 0xbc, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0xe5cef0, size 0x3ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe5d2dc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabel, addr 0xe5ce2c, size 0x8, virtual true, abstract: false, final false
