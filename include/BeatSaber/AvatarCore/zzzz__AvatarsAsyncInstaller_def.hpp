...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31d292c, size 0xfc, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x31d2a28, size 0x3d8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d2e00, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x31d28e8, size 0x44, virtual true, abstract: false, final false
