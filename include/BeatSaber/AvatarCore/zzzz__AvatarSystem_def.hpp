...
/// @brief Field _supportedOptionalAvatarDataTypes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__supportedOptionalAvatarDataTypes, put=__cordl_internal_set__supportedOptionalAvatarDataTypes)) ::System::Collections::Generic::IReadOnlyCollection_1<uint32_t>*  _supportedOptionalAvatarDataTypes;
...
static inline ::BeatSaber::AvatarCore::AvatarSystem* New_ctor(::BeatSaber::AvatarCore::AvatarSystemIdentifier  identifier, bool  isFallbackSystem, bool  selectableByUser, int32_t  selectionSortOrder, ::System::Collections::Generic::IReadOnlyCollection_1<uint32_t>*  supportedOptionalAvatarDataTypes) ;
...
/// @brief Method .ctor, addr 0x319cc88, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::BeatSaber::AvatarCore::AvatarSystemIdentifier  identifier, bool  isFallbackSystem, bool  selectableByUser, int32_t  selectionSortOrder, ::System::Collections::Generic::IReadOnlyCollection_1<uint32_t>*  supportedOptionalAvatarDataTypes) ;
...
/// @brief Method get_isFallbackSystem, addr 0x319ccb4, size 0x8, virtual true, abstract: false, final true
inline bool get_isFallbackSystem() ;

/// @brief Method get_selectableByUser, addr 0x319ccac, size 0x8, virtual true, abstract: false, final true
inline bool get_selectableByUser() ;

/// @brief Method get_selectionSortOrder, addr 0x319ccbc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_selectionSortOrder() ;

/// @brief Method get_supportedOptionalAvatarDataTypes, addr 0x319ccc4, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IReadOnlyCollection_1<uint32_t>* get_supportedOptionalAvatarDataTypes() ;

/// @brief Method get_typeIdentifier, addr 0x319cca0, size 0xc, virtual true, abstract: false, final true
