...
public:
  ...
  /// @brief Method .ctor, addr 0x326ab14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x326ab0c, size 0x8, virtual false, abstract: false, final false
