...
public:
  ...
  /// @brief Method .ctor, addr 0x103e1b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x103e1a8, size 0x8, virtual false, abstract: false, final false
