...
public:
  ...
  /// @brief Method .ctor, addr 0x31d28e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x31d28dc, size 0x8, virtual false, abstract: false, final false
