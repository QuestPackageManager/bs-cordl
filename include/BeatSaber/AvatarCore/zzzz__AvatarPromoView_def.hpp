...
public:
  ...
  /// @brief Method .ctor, addr 0x221e6bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x221e6b4, size 0x8, virtual false, abstract: false, final false
