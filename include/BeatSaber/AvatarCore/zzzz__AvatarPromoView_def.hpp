...
public:
  ...
  /// @brief Method .ctor, addr 0x224bd80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_rectTransform, addr 0x224bd78, size 0x8, virtual false, abstract: false, final false
