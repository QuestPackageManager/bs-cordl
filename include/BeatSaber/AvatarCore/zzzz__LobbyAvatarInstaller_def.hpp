...
/// @brief Method InstallBindings, addr 0x319fcfc, size 0x300, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x319fffc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
