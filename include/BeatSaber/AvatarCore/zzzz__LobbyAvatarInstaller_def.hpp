...
public:
  ...
  /// @brief Method InstallBindings, addr 0x1052280, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10524e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
