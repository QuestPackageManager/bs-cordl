...
public:
  ...
  /// @brief Method InstallBindings, addr 0xf534cc, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf53730, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
