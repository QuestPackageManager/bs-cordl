...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31d6804, size 0x300, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31d6b04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
