...
public:
  ...
  /// @brief Method InstallBindings, addr 0x326ea30, size 0x300, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326ed30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
