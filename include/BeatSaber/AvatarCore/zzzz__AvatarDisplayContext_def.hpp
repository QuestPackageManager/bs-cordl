...
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::AvatarDisplayContext, "BeatSaber.AvatarCore", "AvatarDisplayContext");
// Dependencies
namespace BeatSaber::AvatarCore {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::AvatarCore::AvatarDisplayContext) == 0x4, "Size mismatch!");
