...
inline ::BeatSaber::AvatarCore::__LimitAvatarPoseRestriction__Parameters* BeatSaber::AvatarCore::__LimitAvatarPoseRestriction__Parameters::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::BeatSaber::AvatarCore::__LimitAvatarPoseRestriction__Parameters*>());
}
...
inline ::BeatSaber::AvatarCore::LimitAvatarPoseRestriction* BeatSaber::AvatarCore::LimitAvatarPoseRestriction::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::BeatSaber::AvatarCore::LimitAvatarPoseRestriction*>());
}
