...
public:
  ...
  /// @brief Method .ctor, addr 0x2251fcc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MultiplayerAvatarsData avatarsData);

  /// @brief Method get_avatarsData, addr 0x2251fb8, size 0x14, virtual true, abstract: false, final true
