...
public:
  ...
  /// @brief Method .ctor, addr 0x224e55c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MultiplayerAvatarsData avatarsData);

  /// @brief Method get_avatarsData, addr 0x224e548, size 0x14, virtual true, abstract: false, final true
