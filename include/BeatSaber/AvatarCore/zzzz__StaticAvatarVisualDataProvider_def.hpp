...
public:
  ...
  /// @brief Method .ctor, addr 0x31d8dfc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MultiplayerAvatarsData avatarsData);

  /// @brief Method get_avatarsData, addr 0x31d8de8, size 0x14, virtual true, abstract: false, final true
