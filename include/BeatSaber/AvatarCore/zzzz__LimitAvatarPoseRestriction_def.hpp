...
// Write type traits
MARK_REF_T(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction*);
MARK_REF_T(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction_Parameters*);
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction*, "BeatSaber.AvatarCore", "LimitAvatarPoseRestriction");
DEFINE_IL2CPP_CLASS(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction_Parameters*, "BeatSaber.AvatarCore", "LimitAvatarPoseRestriction/Parameters");
...
public:
  ...
  /// @brief Method .ctor, addr 0x326f8c0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction_Parameters) == 0x40, "Size mismatch!");
...
public:
  ...
  /// @brief Method LimitHandPositionRelativeToHead, addr 0x326f820, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method RestrictPose, addr 0x326f620, size 0x200, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326f8bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BeatSaber::AvatarCore::LimitAvatarPoseRestriction) == 0x18, "Size mismatch!");
