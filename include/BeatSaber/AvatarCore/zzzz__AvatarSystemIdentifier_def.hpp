...
public:
  ...
  /// @brief Method Equals, addr 0x326d9a0, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x326d990, size 0x10, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::AvatarCore::AvatarSystemIdentifier other);

  /// @brief Method GetHashCode, addr 0x326da1c, size 0x8, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method HashAvatarSystemTypeMultiplier, addr 0x326ca4c, size 0x8, virtual false, abstract: false, final false
  static inline uint32_t HashAvatarSystemTypeMultiplier(::StringW avatarSystemTypeIdentifier);

  /// @brief Method .ctor, addr 0x326d96c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x326da24, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x326daa0, size 0x80, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::AvatarCore::AvatarSystemIdentifier) == 0x10, "Size mismatch!");
