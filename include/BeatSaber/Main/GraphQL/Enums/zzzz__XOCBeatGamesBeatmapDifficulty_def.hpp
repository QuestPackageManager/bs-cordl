...
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty, "BeatSaber.Main.GraphQL.Enums", "XOCBeatGamesBeatmapDifficulty");
// Dependencies
namespace BeatSaber::Main::GraphQL::Enums {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty) == 0x4, "Size mismatch!");
