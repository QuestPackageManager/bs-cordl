...
public:
  ...
  /// @brief Method GetParams, addr 0x3208834, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3208840, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_AccuracyScore, addr 0x3207f64, size 0xb8, virtual true, abstract: false, final true
  inline void set_AccuracyScore(::System::Nullable_1<int64_t> value);

  /// @brief Method set_BadCutsCount, addr 0x320801c, size 0x98, virtual true, abstract: false, final true
  inline void set_BadCutsCount(int64_t value);

  /// @brief Method set_Characteristic, addr 0x32080b4, size 0xac, virtual true, abstract: false, final true
  inline void set_Characteristic(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic value);

  /// @brief Method set_ClientMutationId, addr 0x3208160, size 0x80, virtual true, abstract: false, final true
  inline void set_ClientMutationId(::StringW value);

  /// @brief Method set_ClientSongId, addr 0x32081e0, size 0x80, virtual true, abstract: false, final true
  inline void set_ClientSongId(::StringW value);

  /// @brief Method set_CutAngle, addr 0x3208260, size 0xb8, virtual true, abstract: false, final true
  inline void set_CutAngle(::System::Nullable_1<int64_t> value);

  /// @brief Method set_Difficulty, addr 0x3208318, size 0xac, virtual true, abstract: false, final true
  inline void set_Difficulty(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty value);

  /// @brief Method set_MaxPerfectCombo, addr 0x32083c4, size 0xb8, virtual true, abstract: false, final true
  inline void set_MaxPerfectCombo(::System::Nullable_1<int64_t> value);

  /// @brief Method set_MissedCutsCount, addr 0x320847c, size 0x98, virtual true, abstract: false, final true
  inline void set_MissedCutsCount(int64_t value);

  /// @brief Method set_ModifierMask, addr 0x3208514, size 0x98, virtual true, abstract: false, final true
  inline void set_ModifierMask(int64_t value);

  /// @brief Method set_PausesCount, addr 0x32085ac, size 0xb8, virtual true, abstract: false, final true
  inline void set_PausesCount(::System::Nullable_1<int64_t> value);

  /// @brief Method set_Score, addr 0x3208664, size 0x98, virtual true, abstract: false, final true
  inline void set_Score(int64_t value);

  /// @brief Method set_SwingScore, addr 0x32086fc, size 0xb8, virtual true, abstract: false, final true
  inline void set_SwingScore(::System::Nullable_1<int64_t> value);

  /// @brief Method set_User, addr 0x32087b4, size 0x80, virtual true, abstract: false, final true
