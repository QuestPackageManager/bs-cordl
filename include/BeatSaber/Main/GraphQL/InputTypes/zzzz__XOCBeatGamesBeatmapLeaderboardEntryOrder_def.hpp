...
/// @brief Method GetParams, addr 0x31cbd18, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x31cbd24, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_By, addr 0x31cbbc0, size 0xac, virtual true, abstract: false, final true
inline void set_By(::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapLeaderboardEntryOrderBySubject  value) ;

/// @brief Method set_Desc, addr 0x31cbc6c, size 0xac, virtual true, abstract: false, final true
