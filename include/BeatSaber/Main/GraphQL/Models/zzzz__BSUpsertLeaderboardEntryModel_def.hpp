...
/// @brief Method .ctor, addr 0x31cbad4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ClientMutationId, addr 0x31cbacc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ClientMutationId() ;

/// @brief Method set_ClientMutationId, addr 0x31cbac4, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel, ____ClientMutationId_k__BackingField) == 0x10, "Offset mismatch!");
...
using XocBeatGamesBeatmapLeaderboardEntryUpsertModel = ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel;
 ...
 __declspec(property(get=get_XocBeatGamesBeatmapLeaderboardEntryUpsert, put=set_XocBeatGamesBeatmapLeaderboardEntryUpsert)) ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel*  XocBeatGamesBeatmapLeaderboardEntryUpsert;

/// @brief Field <XocBeatGamesBeatmapLeaderboardEntryUpsert>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField, put=__cordl_internal_set__XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel*  _XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField;

static inline ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel* New_ctor() ;

constexpr ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel* const& __cordl_internal_get__XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField() const;

constexpr ::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel*& __cordl_internal_get__XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField() ;

constexpr void __cordl_internal_set__XocBeatGamesBeatmapLeaderboardEntryUpsert_k__BackingField(::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel*  value) ;

/// @brief Method .ctor, addr 0x31cbac0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_XocBeatGamesBeatmapLeaderboardEntryUpsert, addr 0x31cbab8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_XocBeatGamesBeatmapLeaderboardEntryUpsert, addr 0x31cbab0, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::BSUpsertLeaderboardEntryModel_XocBeatGamesBeatmapLeaderboardEntryUpsertModel*, "BeatSaber.Main.GraphQL.Models", "BSUpsertLeaderboardEntryModel/XocBeatGamesBeatmapLeaderboardEntryUpsertModel");
