...
public:
  ...
  /// @brief Method .ctor, addr 0x3207c90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ClientMutationId, addr 0x3207c88, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ClientMutationId();

  /// @brief Method set_ClientMutationId, addr 0x3207c80, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207c7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XocBeatGamesBeatmapLeaderboardEntryUpsert, addr 0x3207c74, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_XocBeatGamesBeatmapLeaderboardEntryUpsert, addr 0x3207c6c, size 0x8, virtual false, abstract: false, final false
