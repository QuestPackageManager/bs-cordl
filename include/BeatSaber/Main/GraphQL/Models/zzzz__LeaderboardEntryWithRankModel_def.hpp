...
/// @brief Method .ctor, addr 0x31cbbbc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Alias, addr 0x31cbbb4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Alias() ;

/// @brief Method get_Id, addr 0x31cbba4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method set_Alias, addr 0x31cbbac, size 0x8, virtual false, abstract: false, final false
inline void set_Alias(::StringW  value) ;

/// @brief Method set_Id, addr 0x31cbb9c, size 0x8, virtual false, abstract: false, final false
...
OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel(OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel const& ) = delete;
...
static_assert(offsetof(::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel, ____Id_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel, ____Alias_k__BackingField) == 0x18, "Offset mismatch!");
...
using NodesModel = ::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel;
 ...
 __declspec(property(get=get_Nodes, put=set_Nodes)) ::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>*  Nodes;

/// @brief Field <Nodes>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Nodes_k__BackingField, put=__cordl_internal_set__Nodes_k__BackingField)) ::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>*  _Nodes_k__BackingField;
...
constexpr ::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>* const& __cordl_internal_get__Nodes_k__BackingField() const;

constexpr ::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>*& __cordl_internal_get__Nodes_k__BackingField() ;

constexpr void __cordl_internal_set__Nodes_k__BackingField(::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>*  value) ;

/// @brief Method .ctor, addr 0x31cbb98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Nodes, addr 0x31cbb90, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Nodes, addr 0x31cbb88, size 0x8, virtual false, abstract: false, final false
inline void set_Nodes(::System::Collections::Generic::List_1<::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*>*  value) ;
...
/// @brief Field <Owners>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Owners_k__BackingField, put=__cordl_internal_set__Owners_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_OwnersModel*  _Owners_k__BackingField;
...
/// @brief Method get_Owners, addr 0x31cbb7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Owners, addr 0x31cbb74, size 0x8, virtual false, abstract: false, final false
...
using FirstPartyXplatformUserModel = ::BeatSaber::Main::GraphQL::Models::UserModel_LeaderboardEntryWithRankModel_FirstPartyXplatformUserModel;
 ...
 __declspec(property(get=get_FirstPartyXplatformUser, put=set_FirstPartyXplatformUser)) ::BeatSaber::Main::GraphQL::Models::UserModel_LeaderboardEntryWithRankModel_FirstPartyXplatformUserModel*  FirstPartyXplatformUser;

 __declspec(property(get=get_Id, put=set_Id)) ::StringW  Id;

/// @brief Field <FirstPartyXplatformUser>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__FirstPartyXplatformUser_k__BackingField, put=__cordl_internal_set__FirstPartyXplatformUser_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::UserModel_LeaderboardEntryWithRankModel_FirstPartyXplatformUserModel*  _FirstPartyXplatformUser_k__BackingField;
...
/// @brief Method get_FirstPartyXplatformUser, addr 0x31cbb68, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Id, addr 0x31cbb58, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method set_FirstPartyXplatformUser, addr 0x31cbb60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Id, addr 0x31cbb50, size 0x8, virtual false, abstract: false, final false
inline void set_Id(::StringW  value) ;
...
/// @brief Field <User>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__User_k__BackingField, put=__cordl_internal_set__User_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::LeaderboardEntryWithRankModel_UserModel*  _User_k__BackingField;
...
/// @brief Method .ctor, addr 0x31cbb4c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Rank, addr 0x31cbb40, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<int64_t> get_Rank() ;

/// @brief Method get_Score, addr 0x31cbb2c, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<int64_t> get_Score() ;

/// @brief Method get_User, addr 0x31cbb1c, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::Main::GraphQL::Models::LeaderboardEntryWithRankModel_UserModel* get_User() ;

/// @brief Method set_Rank, addr 0x31cbb38, size 0x8, virtual false, abstract: false, final false
inline void set_Rank(::System::Nullable_1<int64_t>  value) ;

/// @brief Method set_Score, addr 0x31cbb24, size 0x8, virtual false, abstract: false, final false
inline void set_Score(::System::Nullable_1<int64_t>  value) ;

/// @brief Method set_User, addr 0x31cbb14, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_OwnersModel*, "BeatSaber.Main.GraphQL.Models", "LeaderboardEntryWithRankModel/UserModel/FirstPartyXplatformUserModel/OwnersModel");
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::OwnersModel_FirstPartyXplatformUserModel_UserModel_LeaderboardEntryWithRankModel_NodesModel*, "BeatSaber.Main.GraphQL.Models", "LeaderboardEntryWithRankModel/UserModel/FirstPartyXplatformUserModel/OwnersModel/NodesModel");
NEED_NO_BOX(::BeatSaber::Main::GraphQL::Models::UserModel_LeaderboardEntryWithRankModel_FirstPartyXplatformUserModel);
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::UserModel_LeaderboardEntryWithRankModel_FirstPartyXplatformUserModel*, "BeatSaber.Main.GraphQL.Models", "LeaderboardEntryWithRankModel/UserModel/FirstPartyXplatformUserModel");
