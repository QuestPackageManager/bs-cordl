...
public:
  ...
  /// @brief Method .ctor, addr 0x3207d78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Alias, addr 0x3207d70, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Alias();

  /// @brief Method get_Id, addr 0x3207d60, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method set_Alias, addr 0x3207d68, size 0x8, virtual false, abstract: false, final false
  inline void set_Alias(::StringW value);

  /// @brief Method set_Id, addr 0x3207d58, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207d54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Nodes, addr 0x3207d4c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Nodes, addr 0x3207d44, size 0x8, virtual false, abstract: false, final false
  inline void
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207d40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Owners, addr 0x3207d38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Owners, addr 0x3207d30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207d2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_FirstPartyXplatformUser, addr 0x3207d24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Id, addr 0x3207d14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method set_FirstPartyXplatformUser, addr 0x3207d1c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Id, addr 0x3207d0c, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::StringW value);
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207d08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Rank, addr 0x3207cfc, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_Rank();

  /// @brief Method get_Score, addr 0x3207ce8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<int64_t> get_Score();

  /// @brief Method get_User, addr 0x3207cd8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::Models::LeaderboardEntryWithRankModel_UserModel* get_User();

  /// @brief Method set_Rank, addr 0x3207cf4, size 0x8, virtual false, abstract: false, final false
  inline void set_Rank(::System::Nullable_1<int64_t> value);

  /// @brief Method set_Score, addr 0x3207ce0, size 0x8, virtual false, abstract: false, final false
  inline void set_Score(::System::Nullable_1<int64_t> value);

  /// @brief Method set_User, addr 0x3207cd0, size 0x8, virtual false, abstract: false, final false
