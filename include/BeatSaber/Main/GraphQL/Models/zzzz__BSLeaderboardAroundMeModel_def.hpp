...
public:
  // Declarations
  __declspec(property(get = System_Collections_Generic_IEnumerator_OculusStudios_GraphQL_Client_GraphQLModel__get_Current)) ::OculusStudios::GraphQL::Client::GraphQLModel*
      System_Collections_Generic_IEnumerator_OculusStudios_GraphQL_Client_GraphQLModel__Current;
  ...
  __declspec(property(get = __cordl_internal_get___2__current, put = __cordl_internal_set___2__current)) ::OculusStudios::GraphQL::Client::GraphQLModel* __2__current;
  ...
  constexpr operator ::System::Collections::Generic::IEnumerable_1<::OculusStudios::GraphQL::Client::GraphQLModel*>*() noexcept;

  /// @brief Convert operator to "::System::Collections::Generic::IEnumerator_1<::OculusStudios::GraphQL::Client::GraphQLModel*>"
  constexpr operator ::System::Collections::Generic::IEnumerator_1<::OculusStudios::GraphQL::Client::GraphQLModel*>*() noexcept;
  ...
  constexpr ::OculusStudios::GraphQL::Client::GraphQLModel* const& __cordl_internal_get___2__current() const;
  ...
  constexpr ::System::Collections::Generic::IEnumerable_1<::OculusStudios::GraphQL::Client::GraphQLModel*>*
  ...
  constexpr ::System::Collections::Generic::IEnumerator_1<::OculusStudios::GraphQL::Client::GraphQLModel*>*
...
public:
  ...
  ::OculusStudios::GraphQL::Client::GraphQLModel* _____2__current;
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty:
  // "LeaderboardEntriesAroundPlayerPageModel_BeatmapModel_DataEnvironmentModel_FetchXOCBeatGamesEnvironmentPlayerRootModel_BSLeaderboardAroundMeModel_NodesModel", modifiers: "const&", def_value:
  // None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaderboardEntriesAroundPlayerPageModel_BeatmapModel_DataEnvironmentModel_FetchXOCBeatGamesEnvironmentPlayerRootModel_BSLeaderboardAroundMeModel_NodesModel(
...
public:
  ...
  /// [Preserve]
  /// @brief [JsonProperty("leaderboard_entries_around_player_page", NullValueHandling = (Newtonsoft.Json.NullValueHandling)1)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DataEnvironmentModel_FetchXOCBeatGamesEnvironmentPlayerRootModel_BSLeaderboardAroundMeModel_BeatmapModel", modifiers: "&&", def_value: None, comment:
  // None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FetchXOCBeatGamesEnvironmentPlayerRootModel_BSLeaderboardAroundMeModel_DataEnvironmentModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BSLeaderboardAroundMeModel_FetchXOCBeatGamesEnvironmentPlayerRootModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BSLeaderboardAroundMeModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
