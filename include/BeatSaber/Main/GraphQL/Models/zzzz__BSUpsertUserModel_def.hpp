...
public:
  ...
  /// @brief Method .ctor, addr 0x3207ccc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Id, addr 0x3207cc4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Id();

  /// @brief Method set_Id, addr 0x3207cbc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207cb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BeatGamesUser, addr 0x3207cb0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::Models::XocBeatGamesUserUpsertModel_BSUpsertUserModel_BeatGamesUserModel* get_BeatGamesUser();

  /// @brief Method set_BeatGamesUser, addr 0x3207ca8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3207ca4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_XocBeatGamesUserUpsert, addr 0x3207c9c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::Models::BSUpsertUserModel_XocBeatGamesUserUpsertModel* get_XocBeatGamesUserUpsert();

  /// @brief Method set_XocBeatGamesUserUpsert, addr 0x3207c94, size 0x8, virtual false, abstract: false, final false
