...
/// @brief Method .ctor, addr 0x31cbb10, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Id, addr 0x31cbb08, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method set_Id, addr 0x31cbb00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <BeatGamesUser>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__BeatGamesUser_k__BackingField, put=__cordl_internal_set__BeatGamesUser_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::XocBeatGamesUserUpsertModel_BSUpsertUserModel_BeatGamesUserModel*  _BeatGamesUser_k__BackingField;
...
/// @brief Method .ctor, addr 0x31cbafc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BeatGamesUser, addr 0x31cbaf4, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::Main::GraphQL::Models::XocBeatGamesUserUpsertModel_BSUpsertUserModel_BeatGamesUserModel* get_BeatGamesUser() ;

/// @brief Method set_BeatGamesUser, addr 0x31cbaec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <XocBeatGamesUserUpsert>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__XocBeatGamesUserUpsert_k__BackingField, put=__cordl_internal_set__XocBeatGamesUserUpsert_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::BSUpsertUserModel_XocBeatGamesUserUpsertModel*  _XocBeatGamesUserUpsert_k__BackingField;
...
/// @brief Method .ctor, addr 0x31cbae8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_XocBeatGamesUserUpsert, addr 0x31cbae0, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::Main::GraphQL::Models::BSUpsertUserModel_XocBeatGamesUserUpsertModel* get_XocBeatGamesUserUpsert() ;

/// @brief Method set_XocBeatGamesUserUpsert, addr 0x31cbad8, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::XocBeatGamesUserUpsertModel_BSUpsertUserModel_BeatGamesUserModel*, "BeatSaber.Main.GraphQL.Models", "BSUpsertUserModel/XocBeatGamesUserUpsertModel/BeatGamesUserModel");
