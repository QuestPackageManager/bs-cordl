...
/// @brief Field <Status>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Status_k__BackingField, put=__cordl_internal_set__Status_k__BackingField)) ::System::Nullable_1<::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesHealthCheckStatusValue>  _Status_k__BackingField;
...
/// @brief Method .ctor, addr 0x31cb95c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Status, addr 0x31cb954, size 0x8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesHealthCheckStatusValue> get_Status() ;

/// @brief Method set_Status, addr 0x31cb94c, size 0x8, virtual false, abstract: false, final false
...
using XocBeatGamesLeaderboardHealthModel = ::BeatSaber::Main::GraphQL::Models::BSLeaderboardHealthModel_XocBeatGamesLeaderboardHealthModel;
 ...
 __declspec(property(get=get_XocBeatGamesLeaderboardHealth, put=set_XocBeatGamesLeaderboardHealth)) ::BeatSaber::Main::GraphQL::Models::BSLeaderboardHealthModel_XocBeatGamesLeaderboardHealthModel*  XocBeatGamesLeaderboardHealth;

/// @brief Field <XocBeatGamesLeaderboardHealth>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__XocBeatGamesLeaderboardHealth_k__BackingField, put=__cordl_internal_set__XocBeatGamesLeaderboardHealth_k__BackingField)) ::BeatSaber::Main::GraphQL::Models::BSLeaderboardHealthModel_XocBeatGamesLeaderboardHealthModel*  _XocBeatGamesLeaderboardHealth_k__BackingField;
...
/// @brief Method .ctor, addr 0x31cb948, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_XocBeatGamesLeaderboardHealth, addr 0x31cb940, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_XocBeatGamesLeaderboardHealth, addr 0x31cb938, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BeatSaber::Main::GraphQL::Models::BSLeaderboardHealthModel_XocBeatGamesLeaderboardHealthModel*, "BeatSaber.Main.GraphQL.Models", "BSLeaderboardHealthModel/XocBeatGamesLeaderboardHealthModel");
