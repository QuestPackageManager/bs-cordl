...
public:
  ...
  /// @brief Method GetPersistedQueryID, addr 0x320783c, size 0x14, virtual true, abstract: false, final false
  inline uint64_t GetPersistedQueryID();

  /// @brief Method GetVariableNames, addr 0x3207610, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3207850, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Data, addr 0x320778c, size 0xb0, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData* get_Data();

  /// @brief Method set_Data, addr 0x320770c, size 0x80, virtual false, abstract: false, final false
