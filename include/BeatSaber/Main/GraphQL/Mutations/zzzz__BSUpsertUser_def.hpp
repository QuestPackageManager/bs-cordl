...
public:
  ...
  /// @brief Method GetPersistedQueryID, addr 0x329ef10, size 0x14, virtual true, abstract: false, final false
  inline uint64_t GetPersistedQueryID();

  /// @brief Method GetVariableNames, addr 0x329ece4, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x329ef24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Data, addr 0x329ee60, size 0xb0, virtual false, abstract: false, final false
  inline ::BeatSaber::Main::GraphQL::InputTypes::IXOCBeatGamesUserUpsertData* get_Data();

  /// @brief Method set_Data, addr 0x329ede0, size 0x80, virtual false, abstract: false, final false
