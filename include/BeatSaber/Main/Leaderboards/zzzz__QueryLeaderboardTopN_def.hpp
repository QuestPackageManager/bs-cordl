...
/// @brief Method CreateQuery, addr 0x31d11ec, size 0x17c, virtual false, abstract: false, final false
static inline ::BeatSaber::Main::GraphQL::Queries::BSLeaderboardTopN* CreateQuery(::GlobalNamespace::BeatmapKey  key, ::GlobalNamespace::GameplayModifierMask  modifiers, int64_t  amountEntries, ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*  order) ;

static inline ::BeatSaber::Main::Leaderboards::QueryLeaderboardTopN* New_ctor(::GlobalNamespace::BeatmapKey  key, ::GlobalNamespace::GameplayModifierMask  modifiers, int64_t  amountEntries, ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*  order) ;

/// @brief Method .ctor, addr 0x31ce844, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapKey  key, ::GlobalNamespace::GameplayModifierMask  modifiers, int64_t  amountEntries, ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*  order) ;
