...
public:
  ...
  /// @brief Method CreateQuery, addr 0x320ce04, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320a6b0, size 0xa8, virtual false, abstract: false, final false
