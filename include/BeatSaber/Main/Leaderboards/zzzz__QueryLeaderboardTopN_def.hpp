...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::QueryLeaderboardTopN*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::QueryLeaderboardTopN*, "BeatSaber.Main.Leaderboards", "QueryLeaderboardTopN");
...
public:
  ...
  /// @brief Method CreateQuery, addr 0x32a62a8, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a3a10, size 0xb0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardTopN", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryLeaderboardTopN(QueryLeaderboardTopN&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardTopN", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryLeaderboardTopN(QueryLeaderboardTopNconst&) = delete;
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::QueryLeaderboardTopN) == 0x68, "Size mismatch!");
