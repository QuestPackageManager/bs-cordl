...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UpsertLeaderboardEntryMutation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpsertLeaderboardEntryMutation(UpsertLeaderboardEntryMutation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpsertLeaderboardEntryMutation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpsertLeaderboardEntryMutation(UpsertLeaderboardEntryMutationconst&) = delete;
