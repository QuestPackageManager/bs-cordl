...
public:
  // Declarations
  /// @brief Method ConvertInputData, addr 0x320c8b4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320c3c8, size 0xbc, virtual false, abstract: false, final false
