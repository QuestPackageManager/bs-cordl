...
public:
  ...
  /// @brief Method .ctor, addr 0x32a4f5c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardHealth", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryLeaderboardHealth(QueryLeaderboardHealth&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardHealth", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryLeaderboardHealth(QueryLeaderboardHealthconst&) = delete;
