...
public:
  // Declarations
  /// @brief Method IsBeatGamesErrorCode, addr 0x320c4f0, size 0x70, virtual false, abstract: false, final false
  static inline bool IsBeatGamesErrorCode(::StringW code);

  /// @brief Method IsBeatGamesErrorCode, addr 0x320aeac, size 0x14, virtual false, abstract: false, final false
