...
// Write type traits
MARK_REF_T(::BeatSaber::Main::Leaderboards::GraphQLErrorCode*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Main::Leaderboards::GraphQLErrorCode*, "BeatSaber.Main.Leaderboards", "GraphQLErrorCode");
...
public:
  // Declarations
  /// @brief Method IsBeatGamesErrorCode, addr 0x32a4188, size 0x70, virtual false, abstract: false, final false
  static inline bool IsBeatGamesErrorCode(::StringW code);

  /// @brief Method IsBeatGamesErrorCode, addr 0x32a2b50, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::Main::Leaderboards::GraphQLErrorCode) == 0x10, "Size mismatch!");
