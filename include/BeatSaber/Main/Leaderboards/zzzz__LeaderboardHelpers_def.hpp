...
public:
  // Declarations
  /// @brief Method ConvertCharacteristic, addr 0x32a5938, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertDifficulty, addr 0x32a5c80, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LeaderboardHelpers(LeaderboardHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LeaderboardHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LeaderboardHelpers(LeaderboardHelpersconst&) = delete;
