...
public:
  // Declarations
  /// @brief Method ConvertCharacteristic, addr 0x32a41f8, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ConvertDifficulty, addr 0x32a4540, size 0xc, virtual false, abstract: false, final false
