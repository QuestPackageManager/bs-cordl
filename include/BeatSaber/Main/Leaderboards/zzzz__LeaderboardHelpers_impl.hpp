...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapCharacteristic (*)(::StringW)>(&::BeatSaber::Main::Leaderboards::LeaderboardHelpers::ConvertCharacteristic)> {
  constexpr static std::size_t size = 0x308;
  constexpr static std::size_t addrs = 0x31d0948;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Main::Leaderboards::LeaderboardHelpers*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::Main::GraphQL::Enums::XOCBeatGamesBeatmapDifficulty (*)(::GlobalNamespace::BeatmapDifficulty)>(&::BeatSaber::Main::Leaderboards::LeaderboardHelpers::ConvertDifficulty)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x31d0c90;
