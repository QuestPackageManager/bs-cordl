...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Main::Leaderboards::UpsertUserMutation::*)(::BeatSaber::Settings::Settings)>(&::BeatSaber::Main::Leaderboards::UpsertUserMutation::_ctor)> {
  constexpr static std::size_t size = 0xdc;
  constexpr static std::size_t addrs = 0x31cffe0;
