...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Main::Leaderboards::UpsertUserMutation::*)(::BGLib::Polyglot::LocalizationLanguage)>(
    &::BeatSaber::Main::Leaderboards::UpsertUserMutation::_ctor)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x320bc00;
