...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardAroundMe", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryLeaderboardAroundMe(QueryLeaderboardAroundMe&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardAroundMe", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryLeaderboardAroundMe(QueryLeaderboardAroundMeconst&) = delete;
