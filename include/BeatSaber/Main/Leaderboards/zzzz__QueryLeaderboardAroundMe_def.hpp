...
/// @brief Method CreateQuery, addr 0x31d0d84, size 0x18c, virtual false, abstract: false, final false
static inline ::BeatSaber::Main::GraphQL::Queries::BSLeaderboardAroundMe* CreateQuery(::StringW  userId, ::GlobalNamespace::BeatmapKey  key, ::GlobalNamespace::GameplayModifierMask  modifiers, int64_t  amountEntries, ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*  order) ;

static inline ::BeatSaber::Main::Leaderboards::QueryLeaderboardAroundMe* New_ctor(::StringW  userId, ::GlobalNamespace::BeatmapKey  key, ::GlobalNamespace::GameplayModifierMask  modifiers, int64_t  amountEntries, ::BeatSaber::Main::GraphQL::InputTypes::XOCBeatGamesBeatmapLeaderboardEntryOrder*  order) ;

/// @brief Method .ctor, addr 0x31cd898, size 0xb8, virtual false, abstract: false, final false
