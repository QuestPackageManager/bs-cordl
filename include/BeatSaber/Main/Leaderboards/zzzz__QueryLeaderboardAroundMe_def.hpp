...
public:
  ...
  /// @brief Method CreateQuery, addr 0x320c99c, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3209704, size 0xb8, virtual false, abstract: false, final false
