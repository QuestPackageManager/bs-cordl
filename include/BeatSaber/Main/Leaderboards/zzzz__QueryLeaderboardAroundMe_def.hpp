...
public:
  ...
  /// @brief Method CreateQuery, addr 0x31a0fb4, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x319dacc, size 0xb8, virtual false, abstract: false, final false
