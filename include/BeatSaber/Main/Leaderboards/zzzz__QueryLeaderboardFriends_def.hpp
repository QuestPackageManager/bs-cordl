...
public:
  ...
  /// @brief Method CreateQuery, addr 0x32a6030, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a3224, size 0xc0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardFriends", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QueryLeaderboardFriends(QueryLeaderboardFriends&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QueryLeaderboardFriends", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QueryLeaderboardFriends(QueryLeaderboardFriendsconst&) = delete;
