...
public:
  ...
  /// @brief Method CreateQuery, addr 0x32a48d0, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a1b9c, size 0xb0, virtual false, abstract: false, final false
