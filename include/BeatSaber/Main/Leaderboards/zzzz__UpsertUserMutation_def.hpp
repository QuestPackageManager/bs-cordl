...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UpsertUserMutation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UpsertUserMutation(UpsertUserMutation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UpsertUserMutation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UpsertUserMutation(UpsertUserMutationconst&) = delete;
