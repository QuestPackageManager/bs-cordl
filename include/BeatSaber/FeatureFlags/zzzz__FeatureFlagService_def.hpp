...
public:
  ...
  /// @brief Method <QueryRemoteFlagsAsync>b__12_0, addr 0x31f5b5c, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31f5b70, size 0x74c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31f62bc, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31f633c, size 0x31c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31f6658, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31f66d8, size 0x898, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31f6f98, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x31f7004, size 0x1cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31f71d0, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__remoteFlagsResponse,
                      put = __cordl_internal_set__remoteFlagsResponse)) ::System::Collections::Generic::Dictionary_2<::StringW, bool>* _remoteFlagsResponse;
  ...
  /// @brief Method GetRemoteFlag, addr 0x31f578c, size 0x128, virtual false, abstract: false, final false
  inline ::System::Nullable_1<bool> GetRemoteFlag(::GlobalNamespace::FeatureConfiguration_Remote* remoteFlag);

  /// @brief Method GetRemoteFlagWithDependency, addr 0x31f56cc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x31f51a4, size 0xc4, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method InitializeAsync, addr 0x31f5268, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::BeatSaber::FeatureFlags::FeatureFlagService_State>* InitializeAsync();

  /// @brief Method IsFeatureEnabled, addr 0x31f53f4, size 0x2d8, virtual true, abstract: false, final true
  inline ::System::Nullable_1<bool> IsFeatureEnabled(::BeatSaber::FeatureFlags::Feature feature);

  /// @brief Method IsFeatureEnabledAsync, addr 0x31f58b4, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method QueryRemoteFlagsAsync, addr 0x31f5344, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* QueryRemoteFlagsAsync();

  /// @brief Method WaitForInitialization, addr 0x31f59a4, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WaitForInitialization();

  /// @brief Method <Initialize>b__10_0, addr 0x31f5a54, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f5094, size 0x110, virtual false, abstract: false, final false
