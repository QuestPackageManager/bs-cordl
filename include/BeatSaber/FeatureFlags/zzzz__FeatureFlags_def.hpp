...
public:
  ...
  /// @brief Method GetConfiguration, addr 0x31f4ef4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31f4efc, size 0x198, virtual false, abstract: false, final false
  inline void _ctor();
