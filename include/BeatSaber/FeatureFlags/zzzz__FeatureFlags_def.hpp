...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FeatureFlags", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FeatureFlags(FeatureFlags&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FeatureFlags", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FeatureFlags(FeatureFlagsconst&) = delete;
