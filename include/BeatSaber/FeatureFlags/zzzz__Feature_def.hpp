...
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::Feature, "BeatSaber.FeatureFlags", "Feature");
// Dependencies
namespace BeatSaber::FeatureFlags {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::FeatureFlags::Feature) == 0x4, "Size mismatch!");
