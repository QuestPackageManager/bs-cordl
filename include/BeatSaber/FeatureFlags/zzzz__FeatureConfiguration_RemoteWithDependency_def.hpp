...
public:
  ...
  /// @brief Method .ctor, addr 0x328b78c, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FeatureConfiguration_RemoteWithDependency", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FeatureConfiguration_RemoteWithDependency(FeatureConfiguration_RemoteWithDependency&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FeatureConfiguration_RemoteWithDependency", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FeatureConfiguration_RemoteWithDependency(FeatureConfiguration_RemoteWithDependencyconst&) = delete;
