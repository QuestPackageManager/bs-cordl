...
/// @brief Field _enabledFeatures, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__enabledFeatures, put=__cordl_internal_set__enabledFeatures)) ::System::Collections::Generic::Dictionary_2<::BeatSaber::FeatureFlags::Feature,bool>*  _enabledFeatures;
