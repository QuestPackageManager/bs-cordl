...
public:
  ...
  /// @brief Method Initialize, addr 0x328db3c, size 0x38, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method IsFeatureEnabled, addr 0x328dbf0, size 0x98, virtual true, abstract: false, final true
  inline ::System::Nullable_1<bool> IsFeatureEnabled(::BeatSaber::FeatureFlags::Feature feature);

  /// @brief Method IsFeatureEnabledAsync, addr 0x328dc88, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method SetFeatureEnabled, addr 0x328db74, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328dd3c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
