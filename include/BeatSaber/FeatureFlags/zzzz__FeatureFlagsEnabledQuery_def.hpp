...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FeatureFlagsEnabledQuery", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FeatureFlagsEnabledQuery(FeatureFlagsEnabledQuery&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FeatureFlagsEnabledQuery", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FeatureFlagsEnabledQuery(FeatureFlagsEnabledQueryconst&) = delete;
