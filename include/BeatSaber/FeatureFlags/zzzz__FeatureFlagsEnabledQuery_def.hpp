...
public:
  // Declarations
  /// @brief Method CreateQuery, addr 0x328ccec, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328c798, size 0x28, virtual false, abstract: false, final false
