...
public:
  ...
  /// @brief Method .ctor, addr 0x328b774, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FeatureConfiguration", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FeatureConfiguration(FeatureConfiguration&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FeatureConfiguration", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FeatureConfiguration(FeatureConfigurationconst&) = delete;
