...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FeatureConfiguration_RemoteWithDependency::*)(::StringW, bool, ::BeatSaber::FeatureFlags::Feature)>(&::GlobalNamespace::FeatureConfiguration_RemoteWithDependency::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x31f5c04;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::FeatureConfiguration_RemoteWithDependency*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::FeatureFlags::Feature>::get()}
                    )));
...
inline ::GlobalNamespace::FeatureConfiguration_RemoteWithDependency* GlobalNamespace::FeatureConfiguration_RemoteWithDependency::New_ctor(::StringW  feature, bool  defaultValue, ::BeatSaber::FeatureFlags::Feature  dependency)  {
