...
// Write type traits
MARK_REF_T(::BeatSaber::FeatureFlags::IFeatureFlagService*);
DEFINE_IL2CPP_CLASS(::BeatSaber::FeatureFlags::IFeatureFlagService*, "BeatSaber.FeatureFlags", "IFeatureFlagService");
// Dependencies
namespace BeatSaber::FeatureFlags {
// Is value type: false
