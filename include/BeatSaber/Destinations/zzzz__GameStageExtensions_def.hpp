...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameStageExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameStageExtensions(GameStageExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameStageExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameStageExtensions(GameStageExtensionsconst&) = delete;
