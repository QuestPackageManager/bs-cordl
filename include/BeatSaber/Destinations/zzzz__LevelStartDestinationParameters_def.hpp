...
/// @brief Field customPlayerSpecificSettings, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_customPlayerSpecificSettings, put=__cordl_internal_set_customPlayerSpecificSettings)) ::GlobalNamespace::PlayerSpecificSettings*  customPlayerSpecificSettings;
...
static inline ::BeatSaber::Destinations::LevelStartDestinationParameters* New_ctor(::BeatSaber::Destinations::GameMode  gameMode, ::BeatSaber::Destinations::SimpleBeatmapKey*  beatmapKey, ::BeatSaber::Destinations::GameplayEnvironmentOverride*  environmentOverride, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, ::GlobalNamespace::PlayerSpecificSettings*  customPlayerSpecificSettings, ::GlobalNamespace::PracticeSettings*  practiceSettings, ::GlobalNamespace::GameplayAdditionalInformation*  additionalInformation) ;
...
/// @brief Method .ctor, addr 0x31b15e8, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x31b1718, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::BeatSaber::Destinations::GameMode  gameMode, ::BeatSaber::Destinations::SimpleBeatmapKey*  beatmapKey, ::BeatSaber::Destinations::GameplayEnvironmentOverride*  environmentOverride, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, ::GlobalNamespace::PlayerSpecificSettings*  customPlayerSpecificSettings, ::GlobalNamespace::PracticeSettings*  practiceSettings, ::GlobalNamespace::GameplayAdditionalInformation*  additionalInformation) ;
