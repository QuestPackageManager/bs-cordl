...
public:
// Declarations
/// @brief Method FromSerializedName, addr 0x31e8b9c, size 0x198, virtual false, abstract: false, final false
static inline ::BeatSaber::Destinations::BeatmapCharacteristic FromSerializedName(::StringW  serializedName) ;

/// @brief Method ToSerializedName, addr 0x31e8a6c, size 0x130, virtual false, abstract: false, final false
