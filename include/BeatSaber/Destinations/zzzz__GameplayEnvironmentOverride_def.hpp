...
public:
  ...
  /// @brief Method .ctor, addr 0x31e80c8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x31e80e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW environment, ::StringW colorScheme, bool overrideLightshowColors);

  /// @brief Method get_overrideColorScheme, addr 0x31e80a8, size 0x20, virtual false, abstract: false, final false
  inline bool get_overrideColorScheme();

  /// @brief Method get_overrideEnvironment, addr 0x31e8088, size 0x20, virtual false, abstract: false, final false
