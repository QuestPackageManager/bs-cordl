...
/// @brief Field kScenesThatShouldDisableRootObjects, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kScenesThatShouldDisableRootObjects, put=setStaticF_kScenesThatShouldDisableRootObjects)) ::System::Collections::Generic::HashSet_1<::StringW>*  kScenesThatShouldDisableRootObjects;

/// @brief Method ShouldDisableRootObjects, addr 0x31b20c8, size 0xc8, virtual false, abstract: false, final false
