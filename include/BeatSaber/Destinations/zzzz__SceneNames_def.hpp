...
// Write type traits
MARK_REF_T(::BeatSaber::Destinations::SceneNames*);
DEFINE_IL2CPP_CLASS(::BeatSaber::Destinations::SceneNames*, "BeatSaber.Destinations", "SceneNames");
// [NullableContext(1)]
// [Nullable(0)]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SceneNames", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SceneNames(SceneNames&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SceneNames", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SceneNames(SceneNamesconst&) = delete;
...
static_assert(sizeof(::BeatSaber::Destinations::SceneNames) == 0x10, "Size mismatch!");
