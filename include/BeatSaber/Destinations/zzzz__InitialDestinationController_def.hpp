...
public:
  ...
  /// @brief Method MoveNext, addr 0x31e8838, size 0x2cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x31e8b04, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetDestinationSourcePriority, addr 0x31e83e4, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetDestinationSourcePriority(::BeatSaber::Destinations::DestinationSource destinationSource);

  /// @brief Method InitializeInternalAsync, addr 0x31e8690, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InitializeInternalAsync();

  /// @brief Method InitializeScenesAsync, addr 0x31e8628, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method OverrideDestination, addr 0x31e83e8, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x31e879c, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetDestinationResolver, addr 0x31e8740, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31e87ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::BeatSaber::Destinations::Destination* getStaticF_kDefaultInitialDestination();

  /// @brief Method get_initialDestination, addr 0x31e837c, size 0x68, virtual false, abstract: false, final false
