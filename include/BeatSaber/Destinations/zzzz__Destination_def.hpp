...
/// @brief Field levelStartParameters, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_levelStartParameters, put=__cordl_internal_set_levelStartParameters)) ::BeatSaber::Destinations::LevelStartDestinationParameters*  levelStartParameters;
...
static inline ::BeatSaber::Destinations::Destination* New_ctor(::BeatSaber::Destinations::DestinationTarget  stage, ::BeatSaber::Destinations::LevelStartDestinationParameters*  levelStartDestination, ::ArrayW<::StringW,::Array<::StringW>*>  arguments, bool  requiresHealthWarning, bool  loadMenu) ;
...
/// @brief Method .ctor, addr 0x31b172c, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::BeatSaber::Destinations::DestinationTarget  stage, ::BeatSaber::Destinations::LevelStartDestinationParameters*  levelStartDestination, ::ArrayW<::StringW,::Array<::StringW>*>  arguments, bool  requiresHealthWarning, bool  loadMenu) ;
