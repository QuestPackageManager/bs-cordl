...
public:
  ...
  /// @brief Method ToMissionObjective, addr 0x328000c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3280000, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_referenceValue, addr 0x327fff8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_referenceValue();

  /// @brief Method get_referenceValueComparisonType, addr 0x327fff0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjective_ReferenceValueComparisonType get_referenceValueComparisonType();

  /// @brief Method get_type, addr 0x327ffe8, size 0x8, virtual false, abstract: false, final false
