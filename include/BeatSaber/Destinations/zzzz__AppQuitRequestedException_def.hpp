...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppQuitRequestedException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppQuitRequestedException(AppQuitRequestedException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppQuitRequestedException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppQuitRequestedException(AppQuitRequestedExceptionconst&) = delete;
