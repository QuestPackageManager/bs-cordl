...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DestinationMissionObjectiveTypeExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DestinationMissionObjectiveTypeExtensions(DestinationMissionObjectiveTypeExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DestinationMissionObjectiveTypeExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DestinationMissionObjectiveTypeExtensions(DestinationMissionObjectiveTypeExtensionsconst&) = delete;
