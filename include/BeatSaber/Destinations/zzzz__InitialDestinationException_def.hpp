...
public:
  ...
  /// @brief Method .ctor, addr 0x3281ac0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitialDestinationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitialDestinationException(InitialDestinationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitialDestinationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitialDestinationException(InitialDestinationExceptionconst&) = delete;
