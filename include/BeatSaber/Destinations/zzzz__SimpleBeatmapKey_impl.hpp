...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Destinations::SimpleBeatmapKey::*)(::BeatSaber::Destinations::BeatmapCharacteristic, ::GlobalNamespace::BeatmapDifficulty, ::StringW)>(&::BeatSaber::Destinations::SimpleBeatmapKey::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x31b150c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Destinations::SimpleBeatmapKey*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::Destinations::BeatmapCharacteristic>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapDifficulty>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapKey (::BeatSaber::Destinations::SimpleBeatmapKey::*)(::GlobalNamespace::BeatmapCharacteristicCollection*)>(&::BeatSaber::Destinations::SimpleBeatmapKey::ToStruct)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x31b1518;
...
inline ::BeatSaber::Destinations::SimpleBeatmapKey* BeatSaber::Destinations::SimpleBeatmapKey::New_ctor(::BeatSaber::Destinations::BeatmapCharacteristic  characteristic, ::GlobalNamespace::BeatmapDifficulty  difficulty, ::StringW  levelId)  {
