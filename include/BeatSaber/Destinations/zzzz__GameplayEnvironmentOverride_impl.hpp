...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::BeatSaber::Destinations::GameplayEnvironmentOverride::*)()>(&::BeatSaber::Destinations::GameplayEnvironmentOverride::get_overrideEnvironment)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x31b1580;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Destinations::GameplayEnvironmentOverride*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::BeatSaber::Destinations::GameplayEnvironmentOverride::*)()>(&::BeatSaber::Destinations::GameplayEnvironmentOverride::get_overrideColorScheme)> {
  constexpr static std::size_t size = 0x20;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Destinations::GameplayEnvironmentOverride::*)()>(&::BeatSaber::Destinations::GameplayEnvironmentOverride::_ctor)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::Destinations::GameplayEnvironmentOverride::*)(::StringW, ::StringW, bool)>(&::BeatSaber::Destinations::GameplayEnvironmentOverride::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x31b15dc;
...
inline ::BeatSaber::Destinations::GameplayEnvironmentOverride* BeatSaber::Destinations::GameplayEnvironmentOverride::New_ctor(::StringW  environment, ::StringW  colorScheme, bool  overrideLightshowColors)  {
