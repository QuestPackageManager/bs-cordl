...
public:
  ...
  /// @brief Method <GetControllerProfilesSaveData>b__23_0, addr 0x226f240, size 0x18, virtual false, abstract: false, final false
  inline bool _GetControllerProfilesSaveData_b__23_0(::BeatSaber::GameSettings::ControllerProfile* profile);

  /// @brief Method <GetControllerProfilesSaveData>b__23_1, addr 0x226f258, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226f238, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226f318, size 0x84, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BeatSaber::GameSettings::ControllerProfilesModel__GetBuiltInProfiles_d__21* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<BeatSaber.GameSettings.ControllerProfile>.GetEnumerator, addr 0x226f3e4, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<BeatSaber.GameSettings.ControllerProfile>.get_Current, addr 0x226f39c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x226f474, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x226f3a4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x226f3dc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x226f314, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x226ee5c, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226f478, size 0x228, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226f6a0, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226f6ac, size 0x4d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226fcb8, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method GetBuiltInProfiles, addr 0x226e6e8, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::BeatSaber::GameSettings::ControllerProfile*>* GetBuiltInProfiles();

  /// @brief Method GetControllerProfilesSaveData, addr 0x226eb88, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultController, addr 0x226f180, size 0x5c, virtual false, abstract: false, final false
  static inline ::BeatSaber::GameSettings::Controller GetDefaultController();

  /// @brief Method GetDefaultControllersProfile, addr 0x226f0a4, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDefaultCustomControllerProfile, addr 0x226ee90, size 0x198, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::ControllerProfile* GetDefaultCustomControllerProfile(int32_t profileIndex);

  /// @brief Method GetSelectedProfileIndexFromSettings, addr 0x226ee08, size 0x54, virtual false, abstract: false, final false
  inline int32_t GetSelectedProfileIndexFromSettings(int32_t builtInProfilesCount);

  /// @brief Method Initialize, addr 0x226e750, size 0x90, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method LoadAsync, addr 0x226e7e0, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* LoadAsync();

  static inline ::BeatSaber::GameSettings::ControllerProfilesModel* New_ctor();

  /// @brief Method RefreshControllersReference, addr 0x226ea6c, size 0xa4, virtual false, abstract: false, final false
  inline void RefreshControllersReference();

  /// @brief Method SaveAsync, addr 0x226eb10, size 0x78, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveAsync();

  /// @brief Method UpdateSelectedProfile, addr 0x226e8a0, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226e608, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_profiles, addr 0x226e59c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::GameSettings::ControllerProfile*>* get_profiles();

  /// @brief Method get_selectedProfile, addr 0x226e5b4, size 0x54, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::ControllerProfile* get_selectedProfile();

  /// @brief Method get_selectedProfileIndex, addr 0x226e5a4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_selectedProfileIndex();

  /// @brief Convert to "::Zenject::IInitializable"
  constexpr ::Zenject::IInitializable* i___Zenject__IInitializable() noexcept;

  /// @brief Method set_selectedProfileIndex, addr 0x226e5ac, size 0x8, virtual false, abstract: false, final false
