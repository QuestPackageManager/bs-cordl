...
public:
  ...
  /// @brief Method .ctor, addr 0x10608ec, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enabled, addr 0x106137c, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method get_fov, addr 0x1061384, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fov();

  /// @brief Method get_isDirty, addr 0x1061368, size 0x8, virtual true, abstract: false, final true
  inline bool get_isDirty();

  /// @brief Method get_positionSmooth, addr 0x1061394, size 0x8, virtual false, abstract: false, final false
  inline float_t get_positionSmooth();

  /// @brief Method get_rotationSmooth, addr 0x106138c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_rotationSmooth();

  /// @brief Method get_thirdPersonEnabled, addr 0x106139c, size 0x8, virtual false, abstract: false, final false
  inline bool get_thirdPersonEnabled();

  /// @brief Method get_thirdPersonEulerAngles, addr 0x10613b0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_thirdPersonEulerAngles();

  /// @brief Method get_thirdPersonPosition, addr 0x10613a4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_enabled, addr 0x106032c, size 0x14, virtual false, abstract: false, final false
  inline void set_enabled(bool value);

  /// @brief Method set_fov, addr 0x1060340, size 0x10, virtual false, abstract: false, final false
  inline void set_fov(float_t value);

  /// @brief Method set_isDirty, addr 0x1061370, size 0xc, virtual true, abstract: false, final true
  inline void set_isDirty(bool value);

  /// @brief Method set_positionSmooth, addr 0x1060360, size 0x10, virtual false, abstract: false, final false
  inline void set_positionSmooth(float_t value);

  /// @brief Method set_rotationSmooth, addr 0x1060350, size 0x10, virtual false, abstract: false, final false
  inline void set_rotationSmooth(float_t value);

  /// @brief Method set_thirdPersonEnabled, addr 0x1060370, size 0x14, virtual false, abstract: false, final false
  inline void set_thirdPersonEnabled(bool value);

  /// @brief Method set_thirdPersonEulerAngles, addr 0x1060398, size 0x14, virtual false, abstract: false, final false
  inline void set_thirdPersonEulerAngles(::UnityEngine::Vector3 value);

  /// @brief Method set_thirdPersonPosition, addr 0x1060384, size 0x14, virtual false, abstract: false, final false
