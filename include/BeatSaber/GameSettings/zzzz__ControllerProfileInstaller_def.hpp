...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x31c1e74, size 0xbc, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::BeatSaber::GameSettings::ControllerProfileInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x31c1f30, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
