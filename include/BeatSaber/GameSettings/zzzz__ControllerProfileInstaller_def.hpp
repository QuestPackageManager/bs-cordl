...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x226aa0c, size 0x98, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::BeatSaber::GameSettings::ControllerProfileInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x226aaa4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
