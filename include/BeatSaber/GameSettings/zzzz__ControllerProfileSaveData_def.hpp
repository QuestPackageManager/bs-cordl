...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ControllerProfileSaveData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ControllerProfileSaveData(ControllerProfileSaveData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ControllerProfileSaveData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ControllerProfileSaveData(ControllerProfileSaveDataconst&) = delete;
