...
public:
  ...
  /// @brief Method Deactivate, addr 0x226ea70, size 0x8, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method HandlePositionSliderValueDidChange, addr 0x226f0e4, size 0x90, virtual false, abstract: false, final false
  inline void HandlePositionSliderValueDidChange(::HMUI::RangeValuesTextSlider* slider, float_t value);

  /// @brief Method HandleRotationSliderValueDidChange, addr 0x226f174, size 0x90, virtual false, abstract: false, final false
  inline void HandleRotationSliderValueDidChange(::HMUI::RangeValuesTextSlider* slider, float_t value);

  /// @brief Method Initialize, addr 0x226e4d0, size 0x43c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::BeatSaber::GameSettings::ControllersTransformSettings* New_ctor();

  /// @brief Method RefreshView, addr 0x226ee5c, size 0x12c, virtual false, abstract: false, final false
  inline void RefreshView(::BeatSaber::GameSettings::ControllerProfile* controllerProfile);

  /// @brief Method SetInteractable, addr 0x226f044, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226f204, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_selectedControllerProfile, addr 0x226efe8, size 0x5c, virtual false, abstract: false, final false
