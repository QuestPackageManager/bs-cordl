...
public:
  ...
  /// @brief Method .ctor, addr 0x105df88, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customPreset, addr 0x105df40, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::CustomPerformancePreset* get_customPreset();

  /// @brief Method get_isDirty, addr 0x105ded0, size 0x34, virtual true, abstract: false, final false
  inline bool get_isDirty();

  /// @brief Method get_performancePresetKey, addr 0x105df28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_performancePresetKey();

  /// @brief Method get_windowMode, addr 0x105df58, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::WindowMode get_windowMode();

  /// @brief Method get_windowResolution, addr 0x105df70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2Int get_windowResolution();

  /// @brief Method set_customPreset, addr 0x105df48, size 0x10, virtual false, abstract: false, final false
  inline void set_customPreset(::BeatSaber::PerformancePresets::CustomPerformancePreset* value);

  /// @brief Method set_isDirty, addr 0x105df04, size 0x24, virtual true, abstract: false, final false
  inline void set_isDirty(bool value);

  /// @brief Method set_performancePresetKey, addr 0x105df30, size 0x10, virtual false, abstract: false, final false
  inline void set_performancePresetKey(::StringW value);

  /// @brief Method set_windowMode, addr 0x105df60, size 0x10, virtual false, abstract: false, final false
  inline void set_windowMode(::BeatSaber::GameSettings::WindowMode value);

  /// @brief Method set_windowResolution, addr 0x105df78, size 0x10, virtual false, abstract: false, final false
