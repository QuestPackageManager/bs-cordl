...
public:
  ...
  /// @brief Method LoadAsync, addr 0x226c2dc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x226c34c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226c3b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fileStorage, addr 0x226c280, size 0x5c, virtual false, abstract: false, final false
