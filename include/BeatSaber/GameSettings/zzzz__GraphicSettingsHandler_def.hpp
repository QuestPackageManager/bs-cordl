...
public:
  ...
  /// @brief Method MoveNext, addr 0x105e798, size 0x380, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x105eb18, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x105eb70, size 0x4c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x105f038, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x105f090, size 0x2ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x105f33c, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method InternalLoadAsync, addr 0x105e5d4, size 0xf0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::BGLib::SaveDataCore::SaveDataResult>* InternalLoadAsync();

  /// @brief Method Load, addr 0x105e6c4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method PerformPostLoadAsync, addr 0x105e4e0, size 0xf4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::BGLib::SaveDataCore::SaveDataResult>* PerformPostLoadAsync();

  /// @brief Method TryGetCurrentPerformancePreset, addr 0x105e210, size 0x9c, virtual false, abstract: false, final false
  inline bool TryGetCurrentPerformancePreset(ByRef<::BeatSaber::PerformancePresets::PerformancePreset*> currentPreset);

  /// @brief Method TryGetCurrentPerformancePreset, addr 0x105e2ac, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method TryUpdateCurrentPerformancePresetAsync, addr 0x105e3f0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x105e750, size 0x48, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::BGLib::SaveDataCore::SaveDataResult>* __n__0();

  /// @brief Method .ctor, addr 0x105e158, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IFileStorage* fileStorage);

  /// @brief Method .ctor, addr 0x105e1b0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IFileStorage* fileStorage, ::BeatSaber::GameSettings::GraphicSettings* instance);

  /// @brief Method get_fileNameWithExtension, addr 0x105e110, size 0x40, virtual true, abstract: false, final false
  inline ::StringW get_fileNameWithExtension();

  /// @brief Method get_firstVersion, addr 0x105e09c, size 0x74, virtual true, abstract: false, final false
  inline ::System::Version* get_firstVersion();

  /// @brief Method get_preferredStorageLocation, addr 0x105e150, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::StoragePreference get_preferredStorageLocation();

  /// @brief Method get_version, addr 0x105e028, size 0x74, virtual true, abstract: false, final false
