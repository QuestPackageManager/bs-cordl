...
/// @brief Field <leftController>k__BackingField, offset 0x20, size 0x18 
 __declspec(property(get=__cordl_internal_get__leftController_k__BackingField, put=__cordl_internal_set__leftController_k__BackingField)) ::BeatSaber::GameSettings::Controller  _leftController_k__BackingField;

/// @brief Field <rightController>k__BackingField, offset 0x38, size 0x18 
 __declspec(property(get=__cordl_internal_get__rightController_k__BackingField, put=__cordl_internal_set__rightController_k__BackingField)) ::BeatSaber::GameSettings::Controller  _rightController_k__BackingField;
...
/// @brief Method Activate, addr 0x31c3670, size 0x8, virtual false, abstract: false, final false
inline void Activate(::GlobalNamespace::IVRPlatformHelper*  vrPlatformHelper) ;

/// @brief Method CopyFromLeftToRight, addr 0x31c3678, size 0x14, virtual false, abstract: false, final false
inline void CopyFromLeftToRight() ;

/// @brief Method CopyFromOtherControllerProfile, addr 0x31c3750, size 0x38, virtual false, abstract: false, final false
inline void CopyFromOtherControllerProfile(::BeatSaber::GameSettings::ControllerProfile*  other) ;

/// @brief Method CopyFromRightToLeft, addr 0x31c373c, size 0x14, virtual false, abstract: false, final false
inline void CopyFromRightToLeft() ;

/// @brief Method Deactivate, addr 0x31c23a0, size 0x8, virtual false, abstract: false, final false
inline void Deactivate() ;

/// @brief Method FromSaveData, addr 0x31c3470, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method HasDefaultValues, addr 0x31c354c, size 0x58, virtual false, abstract: false, final false
inline bool HasDefaultValues() ;

static inline ::BeatSaber::GameSettings::ControllerProfile* New_ctor(::StringW  localizationKey, int32_t  index, bool  modifiable, bool  alternativeHandling, ::BeatSaber::GameSettings::Controller  leftController, ::BeatSaber::GameSettings::Controller  rightController) ;

/// @brief Method RefreshControllers, addr 0x31c368c, size 0xb0, virtual false, abstract: false, final false
inline void RefreshControllers() ;

/// @brief Method SetRotateThanMove, addr 0x31c3788, size 0x8, virtual false, abstract: false, final false
inline void SetRotateThanMove(bool  value) ;

/// @brief Method ToSaveData, addr 0x31c2b20, size 0x9c, virtual false, abstract: false, final false
inline ::BeatSaber::GameSettings::ControllerProfileSaveData* ToSaveData() ;

/// @brief Method UpdateControllerPosition, addr 0x31c3880, size 0x74, virtual false, abstract: false, final false
inline void UpdateControllerPosition(bool  isLeft, ::UnityEngine::Vector3  value) ;

/// @brief Method UpdateControllerRotation, addr 0x31c38f4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c2910, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  localizationKey, int32_t  index, bool  modifiable, bool  alternativeHandling, ::BeatSaber::GameSettings::Controller  leftController, ::BeatSaber::GameSettings::Controller  rightController) ;

/// @brief Method get_alternativeHandling, addr 0x31c3610, size 0x8, virtual false, abstract: false, final false
inline bool get_alternativeHandling() ;

/// @brief Method get_leftController, addr 0x31c3620, size 0x14, virtual false, abstract: false, final false
inline ::BeatSaber::GameSettings::Controller get_leftController() ;

/// @brief Method get_rightController, addr 0x31c3648, size 0x14, virtual false, abstract: false, final false
inline ::BeatSaber::GameSettings::Controller get_rightController() ;

/// @brief Method set_alternativeHandling, addr 0x31c3618, size 0x8, virtual false, abstract: false, final false
inline void set_alternativeHandling(bool  value) ;

/// @brief Method set_leftController, addr 0x31c3634, size 0x14, virtual false, abstract: false, final false
inline void set_leftController(::BeatSaber::GameSettings::Controller  value) ;

/// @brief Method set_rightController, addr 0x31c365c, size 0x14, virtual false, abstract: false, final false
