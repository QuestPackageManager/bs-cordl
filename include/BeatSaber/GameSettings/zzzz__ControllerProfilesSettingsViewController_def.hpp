...
public:
  ...
  /// @brief Method CopyFormLeftToRight, addr 0x226f8c4, size 0x3c, virtual false, abstract: false, final false
  inline void CopyFormLeftToRight();

  /// @brief Method CopyFromRightToLeft, addr 0x226f900, size 0x3c, virtual false, abstract: false, final false
  inline void CopyFromRightToLeft();

  /// @brief Method CopyProfileResponse, addr 0x226eeb0, size 0x10, virtual false, abstract: false, final false
  inline void CopyProfileResponse(bool wasCanceled, int32_t selectedDropdownIndex);

  /// @brief Method CopyValuesFromOtherProfile, addr 0x226eec0, size 0xd8, virtual false, abstract: false, final false
  inline void CopyValuesFromOtherProfile(int32_t otherProfileIndex);

  /// @brief Method DidActivate, addr 0x226ef98, size 0x314, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x226f7fc, size 0x50, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method GetControllerProfileDisplayName, addr 0x226fbb0, size 0x88, virtual false, abstract: false, final false
  static inline ::StringW GetControllerProfileDisplayName(::BeatSaber::GameSettings::ControllerProfile* profile);

  /// @brief Method GetSelectedProfile, addr 0x226f854, size 0x18, virtual false, abstract: false, final false
  inline ::BeatSaber::GameSettings::ControllerProfile* GetSelectedProfile();

  /// @brief Method HandlingToggleChanged, addr 0x226f86c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProfileSelected, addr 0x226f898, size 0x2c, virtual false, abstract: false, final false
  inline void ProfileSelected(::HMUI::DropdownWithTableView* view, int32_t index);

  /// @brief Method RefreshView, addr 0x226f6e8, size 0x114, virtual false, abstract: false, final false
  inline void RefreshView();

  /// @brief Method ShowCopyFromProfile, addr 0x226f93c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226fd64, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_onRequestSelectProfileToCopyFrom, addr 0x226ed50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onRequestSelectProfileToCopyFrom, addr 0x226ee00, size 0xb0, virtual false, abstract: false, final false
