...
/// @brief Field _interactableCanvasGroups, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__interactableCanvasGroups, put=__cordl_internal_set__interactableCanvasGroups)) ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>,::Array<::UnityW<::UnityEngine::CanvasGroup>>*>  _interactableCanvasGroups;
...
/// @brief Field _transformSettingsViewControllers, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__transformSettingsViewControllers, put=__cordl_internal_set__transformSettingsViewControllers)) ::ArrayW<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>,::Array<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>>*>  _transformSettingsViewControllers;

/// @brief Field onRequestSelectProfileToCopyFrom, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get_onRequestSelectProfileToCopyFrom, put=__cordl_internal_set_onRequestSelectProfileToCopyFrom)) ::System::Action_1<::ArrayW<::System::ValueTuple_2<::StringW,int32_t>,::Array<::System::ValueTuple_2<::StringW,int32_t>>*>>*  onRequestSelectProfileToCopyFrom;

/// @brief Method CopyFormLeftToRight, addr 0x31c458c, size 0x3c, virtual false, abstract: false, final false
inline void CopyFormLeftToRight() ;

/// @brief Method CopyFromRightToLeft, addr 0x31c45c8, size 0x3c, virtual false, abstract: false, final false
inline void CopyFromRightToLeft() ;

/// @brief Method CopyProfileResponse, addr 0x31c3a94, size 0x10, virtual false, abstract: false, final false
inline void CopyProfileResponse(bool  wasCanceled, int32_t  selectedDropdownIndex) ;

/// @brief Method CopyValuesFromOtherProfile, addr 0x31c3aa4, size 0xdc, virtual false, abstract: false, final false
inline void CopyValuesFromOtherProfile(int32_t  otherProfileIndex) ;

/// @brief Method DidActivate, addr 0x31c3b80, size 0x3fc, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x31c44d0, size 0x48, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method GetControllerProfileDisplayName, addr 0x31c4874, size 0x84, virtual false, abstract: false, final false
static inline ::StringW GetControllerProfileDisplayName(::BeatSaber::GameSettings::ControllerProfile*  profile) ;

/// @brief Method GetSelectedProfile, addr 0x31c4520, size 0x14, virtual false, abstract: false, final false
inline ::BeatSaber::GameSettings::ControllerProfile* GetSelectedProfile() ;

/// @brief Method HandlingToggleChanged, addr 0x31c4534, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ProfileSelected, addr 0x31c4560, size 0x2c, virtual false, abstract: false, final false
inline void ProfileSelected(::HMUI::DropdownWithTableView*  view, int32_t  index) ;

/// @brief Method RefreshView, addr 0x31c43d0, size 0x100, virtual false, abstract: false, final false
inline void RefreshView() ;

/// @brief Method ShowCopyFromProfile, addr 0x31c4604, size 0x270, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>,::Array<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>>*> const& __cordl_internal_get__transformSettingsViewControllers() const;

constexpr ::ArrayW<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>,::Array<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>>*>& __cordl_internal_get__transformSettingsViewControllers() ;

constexpr ::System::Action_1<::ArrayW<::System::ValueTuple_2<::StringW,int32_t>,::Array<::System::ValueTuple_2<::StringW,int32_t>>*>>* const& __cordl_internal_get_onRequestSelectProfileToCopyFrom() const;
...
constexpr void __cordl_internal_set__transformSettingsViewControllers(::ArrayW<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>,::Array<::UnityW<::BeatSaber::GameSettings::ControllersTransformSettings>>*>  value) ;

constexpr void __cordl_internal_set_onRequestSelectProfileToCopyFrom(::System::Action_1<::ArrayW<::System::ValueTuple_2<::StringW,int32_t>,::Array<::System::ValueTuple_2<::StringW,int32_t>>*>>*  value) ;

/// @brief Method .ctor, addr 0x31c4a94, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onRequestSelectProfileToCopyFrom, addr 0x31c3914, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_onRequestSelectProfileToCopyFrom, addr 0x31c39d4, size 0xc0, virtual false, abstract: false, final false
