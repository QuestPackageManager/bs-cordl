...
public:
  ...
  /// @brief Method MoveNext, addr 0x3175c70, size 0x338, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3175fa8, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist, addr 0x31759fc, size 0xe0, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist();

  /// @brief Method DeleteUserCreatedAvatar, addr 0x3175b74, size 0x84, virtual true, abstract: false, final false
  inline void DeleteUserCreatedAvatar();

  /// @brief Method GetMultiplayerAvatarOptionalDataProvider, addr 0x31759f4, size 0x8, virtual true, abstract: false, final false
  inline ::BeatSaber::AvatarCore::IOptionalAvatarDataProvider* GetMultiplayerAvatarOptionalDataProvider();

  /// @brief Method GetMultiplayerAvatarsData, addr 0x3175960, size 0x94, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::MultiplayerAvatarData>* GetMultiplayerAvatarsData();

  /// @brief Method InstantiateAvatar, addr 0x31757d8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarEditorUI, addr 0x3175880, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarSelectionView, addr 0x31758f0, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method __GetRandomizedMultiplayerAvatarsData, addr 0x3175adc, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31756e0, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_avatarCreated, addr 0x31757c0, size 0x18, virtual true, abstract: false, final false
