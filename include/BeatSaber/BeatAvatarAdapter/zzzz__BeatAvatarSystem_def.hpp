...
public:
  ...
  /// @brief Method MoveNext, addr 0x10472fc, size 0x2c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x10475c4, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist, addr 0x1047070, size 0xfc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist();

  /// @brief Method DeleteUserCreatedAvatar, addr 0x10471fc, size 0x84, virtual true, abstract: false, final false
  inline void DeleteUserCreatedAvatar();

  /// @brief Method GetMultiplayerAvatarOptionalDataProvider, addr 0x1047068, size 0x8, virtual true, abstract: false, final false
  inline ::BeatSaber::AvatarCore::IOptionalAvatarDataProvider* GetMultiplayerAvatarOptionalDataProvider();

  /// @brief Method GetMultiplayerAvatarsData, addr 0x1046fdc, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::MultiplayerAvatarData>* GetMultiplayerAvatarsData();

  /// @brief Method InstantiateAvatar, addr 0x1046e68, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarEditorUI, addr 0x1046f14, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarSelectionView, addr 0x1046f78, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method __GetRandomizedMultiplayerAvatarsData, addr 0x104716c, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1046d64, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_avatarCreated, addr 0x1046e4c, size 0x1c, virtual true, abstract: false, final false
