...
public:
  ...
  /// @brief Method MoveNext, addr 0x2255124, size 0x324, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2255448, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist, addr 0x2254ea0, size 0xf4, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* CreateDefaultAvatarIfUserCreatedAvatarDoesNotExist();

  /// @brief Method DeleteUserCreatedAvatar, addr 0x2255024, size 0x84, virtual true, abstract: false, final false
  inline void DeleteUserCreatedAvatar();

  /// @brief Method GetMultiplayerAvatarOptionalDataProvider, addr 0x2254e98, size 0x8, virtual true, abstract: false, final false
  inline ::BeatSaber::AvatarCore::IOptionalAvatarDataProvider* GetMultiplayerAvatarOptionalDataProvider();

  /// @brief Method GetMultiplayerAvatarsData, addr 0x2254e0c, size 0x8c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::MultiplayerAvatarData>* GetMultiplayerAvatarsData();

  /// @brief Method InstantiateAvatar, addr 0x2254c98, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarEditorUI, addr 0x2254d44, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method InstantiateAvatarSelectionView, addr 0x2254da8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method __GetRandomizedMultiplayerAvatarsData, addr 0x2254f94, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2254b94, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_avatarCreated, addr 0x2254c7c, size 0x1c, virtual true, abstract: false, final false
