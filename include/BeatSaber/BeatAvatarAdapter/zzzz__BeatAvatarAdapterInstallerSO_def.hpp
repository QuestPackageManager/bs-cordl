...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31dbb90, size 0x10, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallBindings, addr 0x31dbba0, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31dbe24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
