...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31a5138, size 0x10, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallBindings, addr 0x31a5148, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31a53cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
