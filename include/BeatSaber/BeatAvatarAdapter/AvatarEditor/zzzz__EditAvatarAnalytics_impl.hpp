...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)()>(
  ...
  constexpr static std::size_t addrs = 0x104a8a8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)()>(
  ...
  constexpr static std::size_t addrs = 0x104a9fc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)(
  ...
  constexpr static std::size_t addrs = 0x104ab9c;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode>::get() })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)(
  ...
  constexpr static std::size_t addrs = 0x104aeec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)()>(
  ...
  constexpr static std::size_t addrs = 0x104afe4;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics*>::get(),
                                    "HandleAvatarEditorFlowCoordinatorRandomizeAllButtonWasPressed", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* (
  ...
  constexpr static std::size_t addrs = 0x104ac74;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics*>::get(),
                                                 "CreateEditAvatarEventData", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::*)()>(
  ...
  constexpr static std::size_t addrs = 0x104b0b4;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IAnalyticsModel*> const&
BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::__cordl_internal_get__analyticsModel() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____analyticsModel;
}
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::AvatarDataModel*> const&
BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::__cordl_internal_get__avatarDataModel() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____avatarDataModel;
}
...
constexpr ::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode& BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::__cordl_internal_get__lastEditMode() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lastEditMode;
}
constexpr ::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode const& BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::__cordl_internal_get__lastEditMode() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____lastEditMode;
}
constexpr void BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::__cordl_internal_set__lastEditMode(::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics* BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarAnalytics*>());
}
