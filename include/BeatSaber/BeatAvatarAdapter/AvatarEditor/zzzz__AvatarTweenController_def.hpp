...
public:
  ...
  /// @brief Method .ctor addr 0xe153fc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <CreatePopTween>b__0 addr 0xe16090 size 0x38 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xe15404 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0xe160c8 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0xe160cc size 0x20c virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0xe162d8 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0xe162e0 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0xe16320 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method .ctor addr 0xe15efc size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0xe16328 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0xe1632c size 0x27c virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0xe165a8 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0xe165b0 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0xe165f0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();
...
public:
  ...
  /// @brief Method Awake addr 0xe14f78 size 0x4c virtual false final false
  inline void Awake();

  /// @brief Method OnDisable addr 0xe14fc4 size 0x4 virtual false final false
  inline void OnDisable();

  /// @brief Method OnDestroy addr 0xe1505c size 0x4 virtual false final false
  inline void OnDestroy();

  /// @brief Method PresentAvatar addr 0xe12a5c size 0x48 virtual false final false
  inline void PresentAvatar();

  /// @brief Method HideAvatar addr 0xe131e8 size 0xb8 virtual false final false
  inline void HideAvatar();

  /// @brief Method PopAll addr 0xe15130 size 0x2c virtual false final false
  inline void PopAll();

  /// @brief Method PopHead addr 0xe152bc size 0x8 virtual false final false
  inline void PopHead();

  /// @brief Method PopHands addr 0xe152c4 size 0x8 virtual false final false
  inline void PopHands();

  /// @brief Method PopClothes addr 0xe152cc size 0x8 virtual false final false
  inline void PopClothes();

  /// @brief Method PopHead addr 0xe1515c size 0x60 virtual false final false
  inline void PopHead(float_t popAmount);

  /// @brief Method PopHands addr 0xe1521c size 0xa0 virtual false final false
  inline void PopHands(float_t popAmount);

  /// @brief Method PopClothes addr 0xe151bc size 0x60 virtual false final false
  inline void PopClothes(float_t popAmount);

  /// @brief Method CreatePopTween addr 0xe152d4 size 0x128 virtual false final false
  inline ::Tweening::Tween_1<float_t>* CreatePopTween(::UnityEngine::Transform* partTransform, float_t popAmount);

  /// @brief Method AppearAnimation addr 0xe15060 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* AppearAnimation();

  /// @brief Method AppearBody addr 0xe1542c size 0x2b0 virtual false final false
  inline void AppearBody();

  /// @brief Method AppearHead addr 0xe156dc size 0x2b0 virtual false final false
  inline void AppearHead();

  /// @brief Method AppearLeftHand addr 0xe1598c size 0x2b8 virtual false final false
  inline void AppearLeftHand();

  /// @brief Method AppearRightHand addr 0xe15c44 size 0x2b8 virtual false final false
  inline void AppearRightHand();

  /// @brief Method DisappearAnimation addr 0xe150c8 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* DisappearAnimation();

  /// @brief Method StopAll addr 0xe14fc8 size 0x94 virtual false final false
  inline void StopAll();

  static inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarTweenController* New_ctor();

  /// @brief Method .ctor addr 0xe15f24 size 0x54 virtual false final false
  inline void _ctor();

  /// @brief Method <AppearBody>b__56_0 addr 0xe15f78 size 0x1c virtual false final false
  inline void _AppearBody_b__56_0(::UnityEngine::Vector3 val);

  /// @brief Method <AppearBody>b__56_1 addr 0xe15f94 size 0x1c virtual false final false
  inline void _AppearBody_b__56_1(::UnityEngine::Vector3 val);

  /// @brief Method <AppearHead>b__57_0 addr 0xe15fb0 size 0x1c virtual false final false
  inline void _AppearHead_b__57_0(::UnityEngine::Vector3 val);

  /// @brief Method <AppearHead>b__57_1 addr 0xe15fcc size 0x1c virtual false final false
  inline void _AppearHead_b__57_1(::UnityEngine::Vector3 val);

  /// @brief Method <AppearLeftHand>b__58_0 addr 0xe15fe8 size 0x1c virtual false final false
  inline void _AppearLeftHand_b__58_0(::UnityEngine::Vector3 val);

  /// @brief Method <AppearLeftHand>b__58_1 addr 0xe16004 size 0x1c virtual false final false
  inline void _AppearLeftHand_b__58_1(::UnityEngine::Vector3 val);

  /// @brief Method <AppearRightHand>b__59_0 addr 0xe16020 size 0x1c virtual false final false
  inline void _AppearRightHand_b__59_0(::UnityEngine::Vector3 val);

  /// @brief Method <AppearRightHand>b__59_1 addr 0xe1603c size 0x1c virtual false final false
  inline void _AppearRightHand_b__59_1(::UnityEngine::Vector3 val);

  /// @brief Method <DisappearAnimation>b__60_0 addr 0xe16058 size 0x1c virtual false final false
  inline void _DisappearAnimation_b__60_0(::UnityEngine::Vector3 val);

  /// @brief Method <DisappearAnimation>b__60_1 addr 0xe16074 size 0x1c virtual false final false
