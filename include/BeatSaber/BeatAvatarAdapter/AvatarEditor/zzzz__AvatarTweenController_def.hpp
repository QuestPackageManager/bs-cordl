...
public:
  ...
  /// @brief Method <CreatePopTween>b__0, addr 0x3276f24, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32760b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AppearBody, addr 0x32760bc, size 0x344, virtual false, abstract: false, final false
  inline void AppearBody();

  /// @brief Method AppearHead, addr 0x3276400, size 0x344, virtual false, abstract: false, final false
  inline void AppearHead();

  /// @brief Method AppearLeftHand, addr 0x3276744, size 0x34c, virtual false, abstract: false, final false
  inline void AppearLeftHand();

  /// @brief Method AppearRightHand, addr 0x3276a90, size 0x34c, virtual false, abstract: false, final false
  inline void AppearRightHand();

  /// @brief Method Awake, addr 0x3275bdc, size 0x4c, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method HideAvatar, addr 0x327386c, size 0xbc, virtual false, abstract: false, final false
  inline void HideAvatar();

  static inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarTweenController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3275cc4, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x3275c28, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method PopAll, addr 0x3275d70, size 0x2c, virtual false, abstract: false, final false
  inline void PopAll();

  /// @brief Method PopClothes, addr 0x3275f10, size 0x8, virtual false, abstract: false, final false
  inline void PopClothes();

  /// @brief Method PopClothes, addr 0x3275dfc, size 0x60, virtual false, abstract: false, final false
  inline void PopClothes(float_t popAmount);

  /// @brief Method PopHands, addr 0x3275f08, size 0x8, virtual false, abstract: false, final false
  inline void PopHands();

  /// @brief Method PopHands, addr 0x3275e5c, size 0xa4, virtual false, abstract: false, final false
  inline void PopHands(float_t popAmount);

  /// @brief Method PopHead, addr 0x3275f00, size 0x8, virtual false, abstract: false, final false
  inline void PopHead();

  /// @brief Method PopHead, addr 0x3275d9c, size 0x60, virtual false, abstract: false, final false
  inline void PopHead(float_t popAmount);

  /// @brief Method PresentAvatar, addr 0x3272f3c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3276de4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
