...
public:
  ...
  /// @brief Method Clear, addr 0x31dc884, size 0x74, virtual false, abstract: false, final false
  inline void Clear();

  static inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarEditHistory* New_ctor();

  /// @brief Method Redo, addr 0x31dc914, size 0x70, virtual false, abstract: false, final false
  inline void Redo();

  /// @brief Method Undo, addr 0x31dc8f8, size 0x1c, virtual false, abstract: false, final false
  inline void Undo();

  /// @brief Method UpdateEditHistory, addr 0x31dc984, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31dcb64, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentSnapShot, addr 0x31dc81c, size 0x58, virtual false, abstract: false, final false
  inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarHistorySnapshot get_currentSnapShot();

  /// @brief Method get_lastEditedPart, addr 0x31dc874, size 0x10, virtual false, abstract: false, final false
  inline ::BeatSaber::BeatAvatarSDK::AvatarPart get_lastEditedPart();

  /// @brief Method get_redoAvailable, addr 0x31dc7bc, size 0x60, virtual false, abstract: false, final false
  inline bool get_redoAvailable();

  /// @brief Method get_undoAvailable, addr 0x31dc7ac, size 0x10, virtual false, abstract: false, final false
