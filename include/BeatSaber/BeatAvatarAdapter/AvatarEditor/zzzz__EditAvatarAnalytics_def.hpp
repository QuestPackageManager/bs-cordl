...
/// @brief Method Awake, addr 0x31a96b4, size 0x18c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateEditAvatarEventData, addr 0x31a9b38, size 0x34c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* CreateEditAvatarEventData() ;

/// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish, addr 0x31a9e84, size 0x104, virtual false, abstract: false, final false
inline void HandleAvatarEditorFlowCoordinatorDidFinish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator*  flowCoordinator, ::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystemMetadata, ::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction  finishAction) ;

/// @brief Method HandleAvatarEditorFlowCoordinatorDidSetup, addr 0x31a9a50, size 0xe8, virtual false, abstract: false, final false
inline void HandleAvatarEditorFlowCoordinatorDidSetup(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode  editMode) ;

/// @brief Method HandleAvatarEditorFlowCoordinatorRandomizeAllButtonWasPressed, addr 0x31a9f88, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x31a9840, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31aa060, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
