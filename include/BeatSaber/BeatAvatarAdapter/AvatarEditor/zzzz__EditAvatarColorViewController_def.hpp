...
public:
  ...
  /// @brief Method add_didChangeColorEvent addr 0xe125d0 size 0xb0 virtual false final false
  inline void add_didChangeColorEvent(::System::Action_1<::UnityEngine::Color>* value);

  /// @brief Method remove_didChangeColorEvent addr 0xe13088 size 0xb0 virtual false final false
  inline void remove_didChangeColorEvent(::System::Action_1<::UnityEngine::Color>* value);

  /// @brief Method add_didFinishEvent addr 0xe12680 size 0xb0 virtual false final false
  inline void add_didFinishEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_didFinishEvent addr 0xe13138 size 0xb0 virtual false final false
  inline void remove_didFinishEvent(::System::Action_1<bool>* value);

  /// @brief Method SetColorCallback addr 0xe1824c size 0x8 virtual false final false
  inline void SetColorCallback(::System::Action_1<::UnityEngine::Color>* colorCallback);

  /// @brief Method SetColor addr 0xe13314 size 0x68 virtual false final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method Start addr 0xe18254 size 0x1b8 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0xe1840c size 0x168 virtual true final false
  inline void OnDestroy();

  /// @brief Method HandleHSVPanelControllerColorDidChange addr 0xe18574 size 0x70 virtual false final false
  ...
  /// @brief Method HandlePreviousColorPanelControllerColorWasSelected addr 0xe18678 size 0x78 virtual false final false
  inline void HandlePreviousColorPanelControllerColorWasSelected(::UnityEngine::Color color);

  /// @brief Method HandleCancelButtonWasPressed addr 0xe186f0 size 0x5c virtual false final false
  inline void HandleCancelButtonWasPressed();

  /// @brief Method HandleApplyButtonWasPressed addr 0xe1874c size 0x20 virtual false final false
  inline void HandleApplyButtonWasPressed();

  /// @brief Method ChangeColor addr 0xe185e4 size 0x94 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe1876c size 0x68 virtual false final false
  inline void _ctor();
