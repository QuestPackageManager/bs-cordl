...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::*)()>(&::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::InstallBindings)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x31a5088;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::*)(::Zenject::DiContainer*)>(&::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::InstallBindings)> {
  constexpr static std::size_t size = 0x284;
  constexpr static std::size_t addrs = 0x31a5098;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::*)()>(&::BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x31a531c;
...
constexpr ::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::BeatAvatarEditorViewController>& BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_get__beatAvatarEditorViewController()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatAvatarEditorViewController;
}
constexpr ::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::BeatAvatarEditorViewController> const& BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_get__beatAvatarEditorViewController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatAvatarEditorViewController;
}
constexpr void BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_set__beatAvatarEditorViewController(::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::BeatAvatarEditorViewController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController>& BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_get__editAvatarColorView()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____editAvatarColorView;
}
constexpr ::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController> const& BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_get__editAvatarColorView() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____editAvatarColorView;
}
constexpr void BeatSaber::BeatAvatarAdapter::BeatAvatarAdapterInstallerSO::__cordl_internal_set__editAvatarColorView(::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
