...
public:
  ...
  /// @brief Method .ctor, addr 0x31dc7a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_avatarEditorPrefab, addr 0x31dc78c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReferenceGameObject* get_avatarEditorPrefab();

  /// @brief Method get_avatarForUnityEditorPrefab, addr 0x31dc79c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReferenceGameObject* get_avatarForUnityEditorPrefab();

  /// @brief Method get_avatarGameplayPrefab, addr 0x31dc774, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReferenceGameObject* get_avatarGameplayPrefab();

  /// @brief Method get_avatarHologramPrefab, addr 0x31dc784, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReferenceGameObject* get_avatarHologramPrefab();

  /// @brief Method get_avatarResultsPrefab, addr 0x31dc77c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReferenceGameObject* get_avatarResultsPrefab();

  /// @brief Method get_avatarSelectionViewPrefab, addr 0x31dc794, size 0x8, virtual false, abstract: false, final false
