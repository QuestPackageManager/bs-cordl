...
public:
// Declarations
/// @brief Method CreateAvatarData, addr 0x31a48d0, size 0x584, virtual false, abstract: false, final false
...
/// @brief Method CreateMultiplayerAvatarsData, addr 0x31a4434, size 0x49c, virtual false, abstract: false, final false
