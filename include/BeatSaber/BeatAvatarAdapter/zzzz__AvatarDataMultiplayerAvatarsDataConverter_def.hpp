...
public:
  // Declarations
  /// @brief Method CreateAvatarData, addr 0x2254670, size 0x5d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateMultiplayerAvatarsData, addr 0x2254154, size 0x51c, virtual false, abstract: false, final false
