...
public:
  ...
  /// @brief Method SetLightColor, addr 0x22533b0, size 0x1c, virtual true, abstract: false, final false
  inline void SetLightColor(::UnityEngine::Color lightColor);

  /// @brief Method UpdateAvatarFromOptionalData, addr 0x22535f0, size 0x4, virtual true, abstract: false, final false
  inline void UpdateAvatarFromOptionalData(::BeatSaber::AvatarCore::OptionalAvatarData data, float_t playbackDelaySeconds);

  /// @brief Method UpdateAvatarFromPose, addr 0x22533cc, size 0x78, virtual true, abstract: false, final false
  inline void UpdateAvatarFromPose(::BeatSaber::AvatarCore::AvatarPoseData currentPose);

  /// @brief Method UpdateAvatarFromVisualData, addr 0x2253444, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22535f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bodyCenterWorldPosition, addr 0x2253394, size 0x1c, virtual true, abstract: false, final false
