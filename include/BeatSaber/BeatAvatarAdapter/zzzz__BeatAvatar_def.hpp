...
/// @brief Method SetLightColor, addr 0x31a4e78, size 0x1c, virtual true, abstract: false, final false
inline void SetLightColor(::UnityEngine::Color  lightColor) ;

/// @brief Method UpdateAvatarFromOptionalData, addr 0x31a5080, size 0x4, virtual true, abstract: false, final false
inline void UpdateAvatarFromOptionalData(::BeatSaber::AvatarCore::OptionalAvatarData  data, int64_t  playbackDelayMs) ;

/// @brief Method UpdateAvatarFromPose, addr 0x31a4e94, size 0x78, virtual true, abstract: false, final false
inline void UpdateAvatarFromPose(::BeatSaber::AvatarCore::AvatarPoseData  currentPose) ;

/// @brief Method UpdateAvatarFromVisualData, addr 0x31a4f0c, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31a5084, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bodyCenterWorldPosition, addr 0x31a4e54, size 0x24, virtual true, abstract: false, final false
