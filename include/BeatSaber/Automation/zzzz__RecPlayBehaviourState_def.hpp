...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecPlayBehaviourState", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecPlayBehaviourState(RecPlayBehaviourState&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecPlayBehaviourState", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecPlayBehaviourState(RecPlayBehaviourStateconst&) = delete;
