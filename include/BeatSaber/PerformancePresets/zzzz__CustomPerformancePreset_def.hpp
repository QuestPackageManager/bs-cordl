...
public:
  ...
  /// @brief Method .ctor, addr 0x1066d84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_antiAliasingLevel, addr 0x1066c0c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_antiAliasingLevel();

  /// @brief Method get_bloomPrePassTextureEffect, addr 0x1066c9c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::BloomPrepassTextureEffectPreset get_bloomPrePassTextureEffect();

  /// @brief Method get_burnMarkTrails, addr 0x1066cec, size 0x8, virtual false, abstract: false, final false
  inline bool get_burnMarkTrails();

  /// @brief Method get_defaultAudioLatency, addr 0x1066d54, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultAudioLatency();

  /// @brief Method get_depthTexture, addr 0x1066cd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_depthTexture();

  /// @brief Method get_isDirty, addr 0x1066b98, size 0x8, virtual true, abstract: false, final true
  inline bool get_isDirty();

  /// @brief Method get_mainEffectGraphics, addr 0x1066c84, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::MainEffectPreset get_mainEffectGraphics();

  /// @brief Method get_maxNumberOfCutSoundEffects, addr 0x1066d3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxNumberOfCutSoundEffects();

  /// @brief Method get_maxQueuedFrames, addr 0x1066c54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxQueuedFrames();

  /// @brief Method get_maxShockwaveParticles, addr 0x1066d24, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxShockwaveParticles();

  /// @brief Method get_menuVRResolutionScaleMultiplier, addr 0x1066bf4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_menuVRResolutionScaleMultiplier();

  /// @brief Method get_mirrorGraphics, addr 0x1066c6c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::MirrorQualityPreset get_mirrorGraphics();

  /// @brief Method get_obstaclesQuality, addr 0x1066d6c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::ObstaclesQuality get_obstaclesQuality();

  /// @brief Method get_presetName, addr 0x1066bac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_presetName();

  /// @brief Method get_renderViewportScale, addr 0x1066bc4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_renderViewportScale();

  /// @brief Method get_screenDisplacementEffects, addr 0x1066d08, size 0x8, virtual false, abstract: false, final false
  inline bool get_screenDisplacementEffects();

  /// @brief Method get_smokeGraphics, addr 0x1066cb4, size 0x8, virtual false, abstract: false, final false
  inline bool get_smokeGraphics();

  /// @brief Method get_targetFramerate, addr 0x1066c24, size 0x8, virtual false, abstract: false, final false
  inline float_t get_targetFramerate();

  /// @brief Method get_vSyncCount, addr 0x1066c3c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_vSyncCount();

  /// @brief Method get_vrResolutionScale, addr 0x1066bdc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_antiAliasingLevel, addr 0x1066c14, size 0x10, virtual false, abstract: false, final false
  inline void set_antiAliasingLevel(int32_t value);

  /// @brief Method set_bloomPrePassTextureEffect, addr 0x1066ca4, size 0x10, virtual false, abstract: false, final false
  inline void set_bloomPrePassTextureEffect(::BeatSaber::PerformancePresets::BloomPrepassTextureEffectPreset value);

  /// @brief Method set_burnMarkTrails, addr 0x1066cf4, size 0x14, virtual false, abstract: false, final false
  inline void set_burnMarkTrails(bool value);

  /// @brief Method set_defaultAudioLatency, addr 0x1066d5c, size 0x10, virtual false, abstract: false, final false
  inline void set_defaultAudioLatency(float_t value);

  /// @brief Method set_depthTexture, addr 0x1066cd8, size 0x14, virtual false, abstract: false, final false
  inline void set_depthTexture(bool value);

  /// @brief Method set_isDirty, addr 0x1066ba0, size 0xc, virtual true, abstract: false, final true
  inline void set_isDirty(bool value);

  /// @brief Method set_mainEffectGraphics, addr 0x1066c8c, size 0x10, virtual false, abstract: false, final false
  inline void set_mainEffectGraphics(::BeatSaber::PerformancePresets::MainEffectPreset value);

  /// @brief Method set_maxNumberOfCutSoundEffects, addr 0x1066d44, size 0x10, virtual false, abstract: false, final false
  inline void set_maxNumberOfCutSoundEffects(int32_t value);

  /// @brief Method set_maxQueuedFrames, addr 0x1066c5c, size 0x10, virtual false, abstract: false, final false
  inline void set_maxQueuedFrames(int32_t value);

  /// @brief Method set_maxShockwaveParticles, addr 0x1066d2c, size 0x10, virtual false, abstract: false, final false
  inline void set_maxShockwaveParticles(int32_t value);

  /// @brief Method set_menuVRResolutionScaleMultiplier, addr 0x1066bfc, size 0x10, virtual false, abstract: false, final false
  inline void set_menuVRResolutionScaleMultiplier(float_t value);

  /// @brief Method set_mirrorGraphics, addr 0x1066c74, size 0x10, virtual false, abstract: false, final false
  inline void set_mirrorGraphics(::BeatSaber::PerformancePresets::MirrorQualityPreset value);

  /// @brief Method set_obstaclesQuality, addr 0x1066d74, size 0x10, virtual false, abstract: false, final false
  inline void set_obstaclesQuality(::BeatSaber::PerformancePresets::ObstaclesQuality value);

  /// @brief Method set_presetName, addr 0x1066bb4, size 0x10, virtual false, abstract: false, final false
  inline void set_presetName(::StringW value);

  /// @brief Method set_renderViewportScale, addr 0x1066bcc, size 0x10, virtual false, abstract: false, final false
  inline void set_renderViewportScale(float_t value);

  /// @brief Method set_screenDisplacementEffects, addr 0x1066d10, size 0x14, virtual false, abstract: false, final false
  inline void set_screenDisplacementEffects(bool value);

  /// @brief Method set_smokeGraphics, addr 0x1066cbc, size 0x14, virtual false, abstract: false, final false
  inline void set_smokeGraphics(bool value);

  /// @brief Method set_targetFramerate, addr 0x1066c2c, size 0x10, virtual false, abstract: false, final false
  inline void set_targetFramerate(float_t value);

  /// @brief Method set_vSyncCount, addr 0x1066c44, size 0x10, virtual false, abstract: false, final false
  inline void set_vSyncCount(int32_t value);

  /// @brief Method set_vrResolutionScale, addr 0x1066be4, size 0x10, virtual false, abstract: false, final false
