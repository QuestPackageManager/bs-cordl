...
public:
  ...
  /// @brief Method .ctor, addr 0x1066d88, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_antiAliasingLevel, addr 0x1066e88, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_antiAliasingLevel();

  /// @brief Method get_bloomPrePassTextureEffect, addr 0x1066eb8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::BloomPrepassTextureEffectPreset get_bloomPrePassTextureEffect();

  /// @brief Method get_burnMarkTrails, addr 0x1066ed0, size 0x8, virtual false, abstract: false, final false
  inline bool get_burnMarkTrails();

  /// @brief Method get_dataVersion, addr 0x1066e58, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_dataVersion();

  /// @brief Method get_defaultAudioLatency, addr 0x1066ef0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_defaultAudioLatency();

  /// @brief Method get_depthTexture, addr 0x1066ec8, size 0x8, virtual false, abstract: false, final false
  inline bool get_depthTexture();

  /// @brief Method get_environmentOverrides, addr 0x1066f08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_mainEffectGraphics, addr 0x1066eb0, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::MainEffectPreset get_mainEffectGraphics();

  /// @brief Method get_maxNumberOfCutSoundEffects, addr 0x1066ee8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxNumberOfCutSoundEffects();

  /// @brief Method get_maxQueuedFrames, addr 0x1066ea0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxQueuedFrames();

  /// @brief Method get_maxShockwaveParticles, addr 0x1066ee0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxShockwaveParticles();

  /// @brief Method get_menuVRResolutionScaleMultiplier, addr 0x1066e80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_menuVRResolutionScaleMultiplier();

  /// @brief Method get_mirrorGraphics, addr 0x1066ea8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::MirrorQualityPreset get_mirrorGraphics();

  /// @brief Method get_obstaclesQuality, addr 0x1066ef8, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::ObstaclesQuality get_obstaclesQuality();

  /// @brief Method get_presetName, addr 0x1066e60, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_presetName();

  /// @brief Method get_presetNameLocalizationTag, addr 0x1066e68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_presetNameLocalizationTag();

  /// @brief Method get_questSettings, addr 0x1066f00, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::PerformancePresets::QuestPerformanceSettings* get_questSettings();

  /// @brief Method get_renderViewportScale, addr 0x1066e70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_renderViewportScale();

  /// @brief Method get_screenDisplacementEffects, addr 0x1066ed8, size 0x8, virtual false, abstract: false, final false
  inline bool get_screenDisplacementEffects();

  /// @brief Method get_smokeGraphics, addr 0x1066ec0, size 0x8, virtual false, abstract: false, final false
  inline bool get_smokeGraphics();

  /// @brief Method get_targetFramerate, addr 0x1066e90, size 0x8, virtual false, abstract: false, final false
  inline float_t get_targetFramerate();

  /// @brief Method get_vSyncCount, addr 0x1066e98, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_vSyncCount();

  /// @brief Method get_vrResolutionScale, addr 0x1066e78, size 0x8, virtual false, abstract: false, final false
