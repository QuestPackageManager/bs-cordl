...
public:
  ...
  /// @brief Method .ctor, addr 0xf75f3c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_basicBeatmapEventType, addr 0xf75f1c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventType get_basicBeatmapEventType();

  /// @brief Method get_basicEventTrackPage, addr 0xf75f34, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackPage get_basicEventTrackPage();

  /// @brief Method get_trackDefinition, addr 0xf75f2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::BeatSaber::TrackDefinitions::EventTrackDefinitionSO> get_trackDefinition();

  /// @brief Method get_trackName, addr 0xf75f14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_trackName();

  /// @brief Method get_trackToolbarType, addr 0xf75f24, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xf75fa4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_eventBoxGroupPageName, addr 0xf75f94, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_eventBoxGroupPageName();

  /// @brief Method get_eventBoxGroupTrackInfos, addr 0xf75f9c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xf76194, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enableDuplicate, addr 0xf76108, size 0x8, virtual false, abstract: false, final false
  inline bool get_enableDuplicate();

  /// @brief Method get_groupName, addr 0xf76048, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_groupName();

  /// @brief Method get_lightGroup, addr 0xf76058, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LightGroupSO> get_lightGroup();

  /// @brief Method get_overrideDefaultRotationAxis, addr 0xf760d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_overrideDefaultTranslationAxis, addr 0xf760f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_showColorTrack, addr 0xf76068, size 0x8, virtual false, abstract: false, final false
  inline bool get_showColorTrack();

  /// @brief Method get_showFloatFxTrack, addr 0xf76100, size 0x8, virtual false, abstract: false, final false
  inline bool get_showFloatFxTrack();

  /// @brief Method get_showRotationTrack, addr 0xf76070, size 0x28, virtual false, abstract: false, final false
  inline bool get_showRotationTrack();

  /// @brief Method get_showRotationXTrack, addr 0xf760c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_showRotationXTrack();

  /// @brief Method get_showRotationYTrack, addr 0xf760c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_showRotationYTrack();

  /// @brief Method get_showRotationZTrack, addr 0xf760d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_showRotationZTrack();

  /// @brief Method get_showTranslationTrack, addr 0xf76098, size 0x28, virtual false, abstract: false, final false
  inline bool get_showTranslationTrack();

  /// @brief Method get_showTranslationXTrack, addr 0xf760e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_showTranslationXTrack();

  /// @brief Method get_showTranslationYTrack, addr 0xf760e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_showTranslationYTrack();

  /// @brief Method get_showTranslationZTrack, addr 0xf760f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_showTranslationZTrack();

  /// @brief Method get_targetLightGroups, addr 0xf76110, size 0x84, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::LightGroupSO>, ::Array<::UnityW<::GlobalNamespace::LightGroupSO>>*> get_targetLightGroups();

  /// @brief Method set_groupName, addr 0xf76050, size 0x8, virtual false, abstract: false, final false
  inline void set_groupName(::StringW value);

  /// @brief Method set_lightGroup, addr 0xf76060, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xf75f0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_basicEventTrackInfos, addr 0xf75efc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_environmentInfo, addr 0xf75ef4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo();

  /// @brief Method get_eventBoxGroupPageInfos, addr 0xf75f04, size 0x8, virtual false, abstract: false, final false
