...
} // namespace end def BeatSaber::TrackDefinitions
// Dependencies 
namespace BeatSaber::TrackDefinitions {
// Is value type: true
...
/// @brief Field _dataTransformationType, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__dataTransformationType, put=__cordl_internal_set__dataTransformationType)) ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType  _dataTransformationType;
...
/// @brief Method .ctor, addr 0x31f69bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_dataTransformation, addr 0x31f69a4, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType get_dataTransformation() ;

/// @brief Method get_markerType, addr 0x31f69ac, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType get_markerType() ;

/// @brief Method get_needsFiltering, addr 0x31f69b4, size 0x8, virtual false, abstract: false, final false
inline bool get_needsFiltering() ;

/// @brief Method get_visible, addr 0x31f699c, size 0x8, virtual false, abstract: false, final false
