...
MARK_REF_T(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO*);
DEFINE_IL2CPP_CLASS(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType, "BeatSaber.TrackDefinitions", "EventTrackDefinitionSO/DataTransformationType");
DEFINE_IL2CPP_CLASS(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType, "BeatSaber.TrackDefinitions", "EventTrackDefinitionSO/MarkerType");
DEFINE_IL2CPP_CLASS(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO*, "BeatSaber.TrackDefinitions", "EventTrackDefinitionSO");
// Dependencies
namespace BeatSaber::TrackDefinitions {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32ec95c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dataTransformation, addr 0x32ec944, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType get_dataTransformation();

  /// @brief Method get_markerType, addr 0x32ec94c, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType get_markerType();

  /// @brief Method get_needsFiltering, addr 0x32ec954, size 0x8, virtual false, abstract: false, final false
  inline bool get_needsFiltering();

  /// @brief Method get_visible, addr 0x32ec93c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::EventTrackDefinitionSO) == 0x28, "Size mismatch!");
