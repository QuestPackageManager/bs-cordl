...
public:
  ...
  /// @brief Method .ctor, addr 0x22835d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dataTransformation, addr 0x22835bc, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType get_dataTransformation();

  /// @brief Method get_markerType, addr 0x22835c4, size 0x8, virtual false, abstract: false, final false
  inline ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType get_markerType();

  /// @brief Method get_needsFiltering, addr 0x22835cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_needsFiltering();

  /// @brief Method get_visible, addr 0x22835b4, size 0x8, virtual false, abstract: false, final false
