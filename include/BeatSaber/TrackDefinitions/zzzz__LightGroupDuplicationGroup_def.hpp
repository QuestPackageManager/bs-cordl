...
public:
  ...
  /// @brief Method .ctor, addr 0x3232704, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_duplicationGroupName, addr 0x32326f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_duplicationGroupName();

  /// @brief Method get_lightGroups, addr 0x32326fc, size 0x8, virtual false, abstract: false, final false
