...
public:
  ...
  /// @brief Method .ctor, addr 0x227f4b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_duplicationGroupName, addr 0x227f4a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_duplicationGroupName();

  /// @brief Method get_lightGroups, addr 0x227f4ac, size 0x8, virtual false, abstract: false, final false
