...
public:
  ...
  __declspec(property(get = __cordl_internal_get__lightGroups, put = __cordl_internal_set__lightGroups)) ::ArrayW<::UnityW<::GlobalNamespace::LightGroupSO>> _lightGroups;

  __declspec(property(get = get_duplicationGroupName)) ::StringW duplicationGroupName;

  __declspec(property(get = get_lightGroups)) ::ArrayW<::UnityW<::GlobalNamespace::LightGroupSO>> lightGroups;
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightGroupSO>> const& __cordl_internal_get__lightGroups() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightGroupSO>>& __cordl_internal_get__lightGroups();
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::LightGroupDuplicationGroup) == 0x28, "Size mismatch!");
