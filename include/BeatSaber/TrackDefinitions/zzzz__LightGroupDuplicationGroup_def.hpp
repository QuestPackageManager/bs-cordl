...
public:
  ...
  /// @brief Method get_duplicationGroupName, addr 0x22835dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_duplicationGroupName();

  /// @brief Method get_lightGroups, addr 0x22835e4, size 0x8, virtual false, abstract: false, final false
