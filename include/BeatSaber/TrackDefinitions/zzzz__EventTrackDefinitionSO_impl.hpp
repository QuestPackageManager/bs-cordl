...
constexpr ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType  BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType::NoTransformation{static_cast<int32_t>(0x0)};
...
constexpr ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType  BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType::DeltaRotation{static_cast<int32_t>(0x2)};
...
constexpr ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType  BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType::TurnOffValueDuration{static_cast<int32_t>(0x4)};
constexpr ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType  BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType::ValueDuration{static_cast<int32_t>(0x5)};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_dataTransformation)> {
  constexpr static std::size_t size = 0x8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_MarkerType (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_markerType)> {
  constexpr static std::size_t size = 0x8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x31f69bc;
...
constexpr ::BeatSaber::TrackDefinitions::EventTrackDefinitionSO_DataTransformationType const& BeatSaber::TrackDefinitions::EventTrackDefinitionSO::__cordl_internal_get__dataTransformationType() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dataTransformationType;
}
