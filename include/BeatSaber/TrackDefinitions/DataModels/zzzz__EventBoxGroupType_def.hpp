...
DEFINE_IL2CPP_CLASS(::BeatSaber::TrackDefinitions::DataModels::EventBoxGroupType, "BeatSaber.TrackDefinitions.DataModels", "EventBoxGroupType");
// Dependencies
namespace BeatSaber::TrackDefinitions::DataModels {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::DataModels::EventBoxGroupType) == 0x4, "Size mismatch!");
