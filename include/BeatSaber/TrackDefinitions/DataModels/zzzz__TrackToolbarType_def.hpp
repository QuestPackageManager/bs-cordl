...
DEFINE_IL2CPP_CLASS(::BeatSaber::TrackDefinitions::DataModels::TrackToolbarType, "BeatSaber.TrackDefinitions.DataModels", "TrackToolbarType");
// Dependencies
namespace BeatSaber::TrackDefinitions::DataModels {
// Is value type: true
...
static_assert(sizeof(::BeatSaber::TrackDefinitions::DataModels::TrackToolbarType) == 0x4, "Size mismatch!");
