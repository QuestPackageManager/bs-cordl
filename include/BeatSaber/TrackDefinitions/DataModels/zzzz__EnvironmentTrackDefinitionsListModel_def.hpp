...
/// @brief Field <>9__1_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__1_0, put=setStaticF___9__1_0)) ::System::Func_2<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>,::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  __9__1_0;

/// @brief Field <>9__1_1, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__1_1, put=setStaticF___9__1_1)) ::System::Func_2<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  __9__1_1;

static inline ::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel___c* New_ctor() ;

/// @brief Method <.ctor>b__1_0, addr 0x3234cdc, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__1_1, addr 0x3234cf0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3234cd8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::System::Func_2<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>* getStaticF___9__1_1() ;
...
static inline void setStaticF___9__1_1(::System::Func_2<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  value) ;
...
} // namespace end def BeatSaber::TrackDefinitions::DataModels
// Dependencies System.Object
namespace BeatSaber::TrackDefinitions::DataModels {
// Is value type: false
...
/// @brief Field _environmentTracksTypeMap, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentTracksTypeMap, put=__cordl_internal_set__environmentTracksTypeMap)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  _environmentTracksTypeMap;

static inline ::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel* New_ctor(::System::Collections::Generic::IEnumerable_1<::UnityW<::BeatSaber::TrackDefinitions::EnvironmentTracksDefinitionSO>>*  environmentTrackDefinitions) ;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>* const& __cordl_internal_get__environmentTracksTypeMap() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*& __cordl_internal_get__environmentTracksTypeMap() ;

constexpr void __cordl_internal_set__environmentTracksTypeMap(::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  value) ;

/// @brief Method .ctor, addr 0x3232fcc, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x3234c10, size 0x74, virtual false, abstract: false, final false
...
/// @brief Field _environmentTracksTypeMap, offset: 0x10, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::BeatSaber::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  ____environmentTracksTypeMap;
