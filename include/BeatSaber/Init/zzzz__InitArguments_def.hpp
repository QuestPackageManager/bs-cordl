...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InitArguments", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InitArguments(InitArguments&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InitArguments", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InitArguments(InitArgumentsconst&) = delete;
