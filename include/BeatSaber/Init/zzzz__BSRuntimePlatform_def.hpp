...
public:
  // Declarations
  /// @brief Method GetPlatformType, addr 0x22762f0, size 0x8, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::RuntimePlatformType GetPlatformType();

  /// @brief Method get_IsSteam, addr 0x22762f8, size 0x8, virtual false, abstract: false, final false
