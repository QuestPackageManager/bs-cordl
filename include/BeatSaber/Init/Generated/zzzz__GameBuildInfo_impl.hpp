...
::cordl_internals::setStaticField<::BeatSaber::Init::GameVersion_PreReleaseLabel, "kBuildLabel", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Init::Generated::GameBuildInfo*>::get>(std::forward<::BeatSaber::Init::GameVersion_PreReleaseLabel>(value));
}
inline ::BeatSaber::Init::GameVersion_PreReleaseLabel BeatSaber::Init::Generated::GameBuildInfo::getStaticF_kBuildLabel()  {
return ::cordl_internals::getStaticField<::BeatSaber::Init::GameVersion_PreReleaseLabel, "kBuildLabel", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::Init::Generated::GameBuildInfo*>::get>();
}
// Ctor Parameters []
