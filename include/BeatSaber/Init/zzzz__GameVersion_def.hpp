...
/// @brief Method CompareTo, addr 0x31c54cc, size 0x40, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Content  other) ;

/// @brief Method Equals, addr 0x31c6244, size 0x94, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::GameVersion_Content  other) ;

/// @brief Method Parse, addr 0x31c514c, size 0x7c, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW  versionCode) ;

/// @brief Method Parse, addr 0x31c5e10, size 0x324, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW  versionCore, ::StringW  pattern) ;

/// @brief Method ParseOnStartOf, addr 0x31c6134, size 0x7c, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_Content ParseOnStartOf(::StringW  versionCode) ;

/// @brief Method ReadFromApplicationVersion, addr 0x31c61b0, size 0x94, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_Content ReadFromApplicationVersion() ;

/// @brief Method ToString, addr 0x31c5770, size 0xd8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31c5e04, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "major", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "minor", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "patch", ty: "uint32_t", modifiers: "", def_value: None }]
...
/// @brief Method <.cctor>b__16_0, addr 0x31c6ea4, size 0x8, virtual false, abstract: false, final false
inline ::StringW __cctor_b__16_0(::System::ValueTuple_2<::BeatSaber::Init::GameVersion_PreReleasePrefix,::StringW>  el) ;

/// @brief Method .ctor, addr 0x31c6ea0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <Parse>b__0, addr 0x31c6eac, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c67bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetPrefixText>b__0, addr 0x31c6ed8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c6904, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field kPreReleasePrefixLabelMap, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_kPreReleasePrefixLabelMap, put=setStaticF_kPreReleasePrefixLabelMap)) ::System::Collections::Generic::IReadOnlyList_1<::System::ValueTuple_2<::BeatSaber::Init::GameVersion_PreReleasePrefix,::StringW>>*  kPreReleasePrefixLabelMap;
...
/// @brief Method CompareTo, addr 0x31c697c, size 0x2c, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion_PreReleaseLabel  other) ;

/// @brief Method Equals, addr 0x31c69a8, size 0x94, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::GameVersion_PreReleaseLabel  other) ;

/// @brief Method FirstLetterToUpper, addr 0x31c639c, size 0x118, virtual false, abstract: false, final false
static inline ::StringW FirstLetterToUpper(::ByRef<::StringW>  value) ;

/// @brief Method GetPrefixText, addr 0x31c67c0, size 0x144, virtual false, abstract: false, final false
inline ::StringW GetPrefixText() ;

/// @brief Method Parse, addr 0x31c64b4, size 0x308, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_PreReleaseLabel Parse(::StringW  releaseLabel) ;

/// @brief Method ToString, addr 0x31c6908, size 0x74, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31c6328, size 0x74, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "prefix", ty: "::BeatSaber::Init::GameVersion_PreReleasePrefix", modifiers: "", def_value: None }, CppParam { name: "label", ty: "::StringW", modifiers: "", def_value: None }]
...
/// @brief Method CompareTo, addr 0x31c7550, size 0xc0, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion_BuildInfo  other) ;

/// @brief Method Equals, addr 0x31c7704, size 0x84, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::GameVersion_BuildInfo  other) ;

/// @brief Method ExtractNumberFromPlatformId, addr 0x31c76a8, size 0x5c, virtual false, abstract: false, final false
static inline ::StringW ExtractNumberFromPlatformId(::StringW  inputPlatformId) ;

/// @brief Method Parse, addr 0x31c72d8, size 0x278, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_BuildInfo Parse(::StringW  buildMetadataValue) ;

/// @brief Method ToString, addr 0x31c709c, size 0x168, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31c5bd0, size 0xc4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "buildId", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "platform", ty: "::BeatSaber::Init::RuntimePlatformType", modifiers: "", def_value: None }, CppParam { name: "platformId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "platformIdIntValue", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method BuildInfoText, addr 0x31c6fb4, size 0xe8, virtual false, abstract: false, final false
inline ::StringW BuildInfoText() ;

/// @brief Method CompareTo, addr 0x31c550c, size 0x130, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Metadata  other) ;

/// @brief Method Equals, addr 0x31c7610, size 0x94, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::GameVersion_Metadata  other) ;

/// @brief Method ExtractSubStrings, addr 0x31c7204, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x31c51c8, size 0x1a4, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion_Metadata Parse(::StringW  versionMetadata) ;

/// @brief Method ToString, addr 0x31c5848, size 0xf0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31c6ee8, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::System::Nullable_1<::BeatSaber::Init::GameVersion_BuildInfo>  buildInfo) ;

/// @brief Method .ctor, addr 0x31c5c94, size 0x18, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "preReleaseLabel", ty: "::BeatSaber::Init::GameVersion_PreReleaseLabel", modifiers: "", def_value: None }, CppParam { name: "buildInfo", ty: "::System::Nullable_1<::BeatSaber::Init::GameVersion_BuildInfo>", modifiers: "", def_value: None }]
...
/// @brief Method CompareTo, addr 0x31c536c, size 0x160, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion*  other) ;

/// @brief Method Equals, addr 0x31c563c, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method Parse, addr 0x31c4f04, size 0x248, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion* Parse(::StringW  version) ;

/// @brief Method ToString, addr 0x31c5654, size 0x11c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UpdatePlatformId, addr 0x31c59e0, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c4ee8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method get_IsReleasable, addr 0x31c5938, size 0xa8, virtual false, abstract: false, final false
