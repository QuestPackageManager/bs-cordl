...
public:
  ...
  /// @brief Method CompareTo, addr 0x22768e8, size 0x3c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Equals, addr 0x227755c, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Parse, addr 0x227657c, size 0x74, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCode);

  /// @brief Method Parse, addr 0x2277148, size 0x314, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCore, ::StringW pattern);

  /// @brief Method ParseOnStartOf, addr 0x227745c, size 0x74, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ParseOnStartOf(::StringW versionCode);

  /// @brief Method ReadFromApplicationVersion, addr 0x22774d0, size 0x8c, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ReadFromApplicationVersion();

  /// @brief Method ToString, addr 0x2275c28, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x227713c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__16_0, addr 0x227814c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__16_0(::System::ValueTuple_2<::BeatSaber::Init::GameVersion_PreReleasePrefix, ::StringW> el);

  /// @brief Method .ctor, addr 0x2278144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Parse>b__0, addr 0x2278154, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2277a94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPrefixText>b__0, addr 0x2278184, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x2277c1c, size 0x2c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method Equals, addr 0x2277c48, size 0x78, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method FirstLetterToUpper, addr 0x2277690, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW FirstLetterToUpper(::ByRef<::StringW> value);

  /// @brief Method GetPrefixText, addr 0x2277a9c, size 0x108, virtual false, abstract: false, final false
  inline ::StringW GetPrefixText();

  /// @brief Method Parse, addr 0x22777b8, size 0x2dc, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_PreReleaseLabel Parse(::StringW releaseLabel);

  /// @brief Method ToString, addr 0x2277bac, size 0x70, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2277620, size 0x70, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x22787cc, size 0xc8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method Equals, addr 0x22789f4, size 0x88, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method ExtractNumberFromPlatformId, addr 0x2278940, size 0xb4, virtual false, abstract: false, final false
  static inline ::StringW ExtractNumberFromPlatformId(::BeatSaber::Init::RuntimePlatformType platform, ::StringW inputPlatformId);

  /// @brief Method FormatPlatformId, addr 0x2278a7c, size 0xdc, virtual false, abstract: false, final false
  static inline ::StringW FormatPlatformId(::BeatSaber::Init::RuntimePlatformType platform, ::StringW inputPlatformId);

  /// @brief Method Parse, addr 0x227855c, size 0x270, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_BuildInfo Parse(::StringW buildMetadataValue);

  /// @brief Method ToString, addr 0x2278338, size 0x158, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2276f00, size 0xd4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildInfoText, addr 0x227824c, size 0xec, virtual false, abstract: false, final false
  inline ::StringW BuildInfoText();

  /// @brief Method CompareTo, addr 0x2276924, size 0x12c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method Equals, addr 0x2278894, size 0xa8, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method ExtractSubStrings, addr 0x2278490, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x22765f0, size 0x170, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Metadata Parse(::StringW versionMetadata);

  /// @brief Method ToString, addr 0x2276b78, size 0xe0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2278194, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::System::Nullable_1<::BeatSaber::Init::GameVersion_BuildInfo> buildInfo);

  /// @brief Method .ctor, addr 0x2276fd4, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x2276760, size 0x188, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion* other);

  /// @brief Method Equals, addr 0x2276a50, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method Parse, addr 0x227634c, size 0x230, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion* Parse(::StringW version);

  /// @brief Method ToString, addr 0x2276a68, size 0x110, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdatePlatformId, addr 0x2276cf0, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2276300, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReleasable, addr 0x2276c58, size 0x98, virtual false, abstract: false, final false
