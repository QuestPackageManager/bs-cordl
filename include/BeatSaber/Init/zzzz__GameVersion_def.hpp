...
public:
  ...
  /// @brief Method CompareTo, addr 0x3201688, size 0x40, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Equals, addr 0x3202400, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Content other);

  /// @brief Method Parse, addr 0x3201308, size 0x7c, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCode);

  /// @brief Method Parse, addr 0x3201fcc, size 0x324, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content Parse(::StringW versionCore, ::StringW pattern);

  /// @brief Method ParseOnStartOf, addr 0x32022f0, size 0x7c, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ParseOnStartOf(::StringW versionCode);

  /// @brief Method ReadFromApplicationVersion, addr 0x320236c, size 0x94, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Content ReadFromApplicationVersion();

  /// @brief Method ToString, addr 0x320192c, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3201fc0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.cctor>b__16_0, addr 0x3203060, size 0x8, virtual false, abstract: false, final false
  inline ::StringW __cctor_b__16_0(::System::ValueTuple_2<::BeatSaber::Init::GameVersion_PreReleasePrefix, ::StringW> el);

  /// @brief Method .ctor, addr 0x320305c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Parse>b__0, addr 0x3203068, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3202978, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPrefixText>b__0, addr 0x3203094, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3202ac0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3202b38, size 0x2c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method Equals, addr 0x3202b64, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_PreReleaseLabel other);

  /// @brief Method FirstLetterToUpper, addr 0x3202558, size 0x118, virtual false, abstract: false, final false
  static inline ::StringW FirstLetterToUpper(::ByRef<::StringW> value);

  /// @brief Method GetPrefixText, addr 0x320297c, size 0x144, virtual false, abstract: false, final false
  inline ::StringW GetPrefixText();

  /// @brief Method Parse, addr 0x3202670, size 0x308, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_PreReleaseLabel Parse(::StringW releaseLabel);

  /// @brief Method ToString, addr 0x3202ac4, size 0x74, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x32024e4, size 0x74, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x320370c, size 0xc0, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method Equals, addr 0x32038c0, size 0x84, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_BuildInfo other);

  /// @brief Method ExtractNumberFromPlatformId, addr 0x3203864, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW ExtractNumberFromPlatformId(::StringW inputPlatformId);

  /// @brief Method Parse, addr 0x3203494, size 0x278, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_BuildInfo Parse(::StringW buildMetadataValue);

  /// @brief Method ToString, addr 0x3203258, size 0x168, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3201d8c, size 0xc4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BuildInfoText, addr 0x3203170, size 0xe8, virtual false, abstract: false, final false
  inline ::StringW BuildInfoText();

  /// @brief Method CompareTo, addr 0x32016c8, size 0x130, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method Equals, addr 0x32037cc, size 0x94, virtual true, abstract: false, final true
  inline bool Equals(::BeatSaber::Init::GameVersion_Metadata other);

  /// @brief Method ExtractSubStrings, addr 0x32033c0, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3201384, size 0x1a4, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion_Metadata Parse(::StringW versionMetadata);

  /// @brief Method ToString, addr 0x3201a04, size 0xf0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x32030a4, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::System::Nullable_1<::BeatSaber::Init::GameVersion_BuildInfo> buildInfo);

  /// @brief Method .ctor, addr 0x3201e50, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3201528, size 0x160, virtual true, abstract: false, final true
  inline int32_t CompareTo(::BeatSaber::Init::GameVersion* other);

  /// @brief Method Equals, addr 0x32017f8, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method Parse, addr 0x32010c0, size 0x248, virtual false, abstract: false, final false
  static inline ::BeatSaber::Init::GameVersion* Parse(::StringW version);

  /// @brief Method ToString, addr 0x3201810, size 0x11c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method UpdatePlatformId, addr 0x3201b9c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32010a4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReleasable, addr 0x3201af4, size 0xa8, virtual false, abstract: false, final false
