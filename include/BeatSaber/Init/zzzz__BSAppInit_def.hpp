...
public:
  ...
  /// @brief Method InstallBindings, addr 0xe98480, size 0xac, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::BeatSaber::Init::BSAppInit* New_ctor();

  /// @brief Method PreloadAsync, addr 0xe983d8, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe9852c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_commandLineArguments, addr 0xe983b0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_commandLineArguments, addr 0xe983c4, size 0x14, virtual false, abstract: false, final false
