...
public:
  ...
  /// @brief Method InstallBindings, addr 0x22715f8, size 0x1c4, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::BeatSaber::Init::BSAppInit* New_ctor();

  /// @brief Method PreloadAsync, addr 0x2271550, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227197c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_commandLineArguments, addr 0x2271528, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_commandLineArguments, addr 0x227153c, size 0x14, virtual false, abstract: false, final false
