...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InspectorLabelAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InspectorLabelAttribute(InspectorLabelAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InspectorLabelAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InspectorLabelAttribute(InspectorLabelAttributeconst&) = delete;
