...
public:
  // Declarations
  /// @brief Method CRC64, addr 0x568066c, size 0x4, virtual false, abstract: false, final false
  static inline uint64_t CRC64(::System::IntPtr buffers, int32_t bufferCount);

  /// @brief Method Deinitialize, addr 0x5680604, size 0x4, virtual false, abstract: false, final false
  static inline void Deinitialize();

  /// @brief Method InitOpenSSL, addr 0x56801cc, size 0x24, virtual false, abstract: false, final false
  static inline void InitOpenSSL();

  /// @brief Method Initialize, addr 0x56802f4, size 0x8c, virtual false, abstract: false, final false
  static inline bool Initialize();

  /// @brief Method Initialize, addr 0x5680448, size 0xf8, virtual false, abstract: false, final false
  static inline bool Initialize(::ENet::Callbacks* callbacks);

  /// @brief Method get_Time, addr 0x5680164, size 0x4, virtual false, abstract: false, final false
