...
// Write type traits
MARK_REF_T(::ENet::InterceptCallback*);
DEFINE_IL2CPP_CLASS(::ENet::InterceptCallback*, "ENet", "InterceptCallback");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x589192c, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5891a24, size 0x30, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::by_ref<::ENet::Event> event, ::by_ref<::ENet::Address> address, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5891918, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5891898, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InterceptCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InterceptCallback(InterceptCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InterceptCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InterceptCallback(InterceptCallbackconst&) = delete;
...
static_assert(sizeof(::ENet::InterceptCallback) == 0x80, "Size mismatch!");
