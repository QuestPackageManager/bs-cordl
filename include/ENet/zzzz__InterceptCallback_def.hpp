...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x567c034, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x567c12c, size 0x30, virtual true, abstract: false, final false
  inline int32_t EndInvoke(::ByRef<::ENet::Event> event, ::ByRef<::ENet::Address> address, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x567c020, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x567bfa0, size 0x80, virtual false, abstract: false, final false
