...
public:
  ...
  /// @brief Method .ctor addr 0x21ef208 size 0xd8 virtual false final false
  inline void _ctor(::System::Object* object, void* method);

  /// @brief Method Invoke addr 0x21ef2e0 size 0x14 virtual true final false
  inline int32_t Invoke(ByRef<::ENet::Event> event, ByRef<::ENet::Address> address, void* receivedData, int32_t receivedDataLength);

  /// @brief Method BeginInvoke addr 0x21ef2f4 size 0x11c virtual true final false
  ...
  /// @brief Method EndInvoke addr 0x21ef410 size 0x34 virtual true final false
