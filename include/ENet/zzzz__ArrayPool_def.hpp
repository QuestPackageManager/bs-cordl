...
/// @brief Method GetByteBuffer, addr 0x56dcca8, size 0x108, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetByteBuffer() ;

/// @brief Method GetPointerBuffer, addr 0x56dcdb0, size 0x108, virtual false, abstract: false, final false
