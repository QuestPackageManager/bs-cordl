...
public:
  ...
  /// @brief Method GetByteBuffer, addr 0x23b3320, size 0x94, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetByteBuffer();

  /// @brief Method GetPointerBuffer, addr 0x23b33b4, size 0x94, virtual false, abstract: false, final false
