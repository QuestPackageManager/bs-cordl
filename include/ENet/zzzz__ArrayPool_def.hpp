...
// Write type traits
MARK_REF_T(::ENet::ArrayPool*);
DEFINE_IL2CPP_CLASS(::ENet::ArrayPool*, "ENet", "ArrayPool");
...
public:
  ...
  __declspec(property(get = getStaticF_byteBuffer, put = setStaticF_byteBuffer)) ::ArrayW<uint8_t> byteBuffer;
  ...
  static inline ::ArrayW<::System::IntPtr> getStaticF_pointerBuffer();

  static inline void setStaticF_byteBuffer(::ArrayW<uint8_t> value);

  static inline void setStaticF_pointerBuffer(::ArrayW<::System::IntPtr> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ArrayPool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ArrayPool(ArrayPool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ArrayPool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ArrayPool(ArrayPoolconst&) = delete;
...
static_assert(sizeof(::ENet::ArrayPool) == 0x10, "Size mismatch!");
