...
public:
  ...
  /// @brief Method .ctor, addr 0x3aa32e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ENet::ENetEvent event);

  /// @brief Method get_ChannelID, addr 0x3aa336c, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_ChannelID();

  /// @brief Method get_Data, addr 0x3aa3374, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Data();

  /// @brief Method get_NativeData, addr 0x3aa32cc, size 0xc, virtual false, abstract: false, final false
  inline ::ENet::ENetEvent get_NativeData();

  /// @brief Method get_Packet, addr 0x3aa337c, size 0x8, virtual false, abstract: false, final false
  inline ::ENet::Packet get_Packet();

  /// @brief Method get_Peer, addr 0x3aa32f8, size 0x38, virtual false, abstract: false, final false
  inline ::ENet::Peer get_Peer();

  /// @brief Method get_Type, addr 0x3aa32f0, size 0x8, virtual false, abstract: false, final false
  inline ::ENet::EventType get_Type();

  /// @brief Method set_NativeData, addr 0x3aa32d8, size 0xc, virtual false, abstract: false, final false
