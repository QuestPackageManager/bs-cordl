...
public:
  ...
  /// @brief Method get_NativeData, addr 0x21efd60, size 0xc, virtual false, abstract: false, final false
  inline ::ENet::ENetEvent get_NativeData();

  /// @brief Method set_NativeData, addr 0x21efd6c, size 0xc, virtual false, abstract: false, final false
  inline void set_NativeData(::ENet::ENetEvent value);

  /// @brief Method .ctor, addr 0x21efd78, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ENet::ENetEvent event);

  /// @brief Method get_Type, addr 0x21efd84, size 0x8, virtual false, abstract: false, final false
  inline ::ENet::EventType get_Type();

  /// @brief Method get_Peer, addr 0x21efd8c, size 0x28, virtual false, abstract: false, final false
  inline ::ENet::Peer get_Peer();

  /// @brief Method get_ChannelID, addr 0x21efe34, size 0x8, virtual false, abstract: false, final false
  inline uint8_t get_ChannelID();

  /// @brief Method get_Data, addr 0x21efe3c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_Data();

  /// @brief Method get_Packet, addr 0x21efe44, size 0x8, virtual false, abstract: false, final false
