...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x56dc938, size 0x54, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::IntPtr size, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x56dc98c, size 0x24, virtual true, abstract: false, final false
  inline ::System::IntPtr EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x56dc924, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56dc8b8, size 0x6c, virtual false, abstract: false, final false
