...
public:
  ...
  /// @brief Method ConfigureThrottle, addr 0x56e06cc, size 0x48, virtual false, abstract: false, final false
  inline void ConfigureThrottle(uint32_t interval, uint32_t acceleration, uint32_t deceleration, uint32_t threshold);

  /// @brief Method Disconnect, addr 0x56e0b74, size 0x28, virtual false, abstract: false, final false
  inline void Disconnect(uint32_t data);

  /// @brief Method DisconnectLater, addr 0x56e0ccc, size 0x28, virtual false, abstract: false, final false
  inline void DisconnectLater(uint32_t data);

  /// @brief Method DisconnectNow, addr 0x56e0c20, size 0x28, virtual false, abstract: false, final false
  inline void DisconnectNow(uint32_t data);

  /// @brief Method Ping, addr 0x56e0958, size 0x18, virtual false, abstract: false, final false
  inline void Ping();

  /// @brief Method PingInterval, addr 0x56e09ec, size 0x28, virtual false, abstract: false, final false
  inline void PingInterval(uint32_t interval);

  /// @brief Method Receive, addr 0x56e088c, size 0x48, virtual false, abstract: false, final false
  inline bool Receive(::ByRef<uint8_t> channelID, ::ByRef<::ENet::Packet> packet);

  /// @brief Method Reset, addr 0x56e0d78, size 0x18, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Send, addr 0x56e07c0, size 0x38, virtual false, abstract: false, final false
  inline int32_t Send(uint8_t channelID, ::ByRef<::ENet::Packet> packet);

  /// @brief Method ThrowIfNotCreated, addr 0x56dfd18, size 0x58, virtual false, abstract: false, final false
  inline void ThrowIfNotCreated();

  /// @brief Method Timeout, addr 0x56e0a98, size 0x40, virtual false, abstract: false, final false
  inline void Timeout(uint32_t timeoutLimit, uint32_t timeoutMinimum, uint32_t timeoutMaximum);

  /// @brief Method .ctor, addr 0x56dd7a0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr peer);

  /// @brief Method get_BytesReceived, addr 0x56e04f8, size 0x18, virtual false, abstract: false, final false
  inline uint64_t get_BytesReceived();

  /// @brief Method get_BytesSent, addr 0x56e0464, size 0x18, virtual false, abstract: false, final false
  inline uint64_t get_BytesSent();

  /// @brief Method get_Data, addr 0x56e058c, size 0x18, virtual false, abstract: false, final false
  inline ::System::IntPtr get_Data();

  /// @brief Method get_ID, addr 0x56dfc58, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_ID();

  /// @brief Method get_IP, addr 0x56dfc60, size 0xb8, virtual false, abstract: false, final false
  inline ::StringW get_IP();

  /// @brief Method get_IsSet, addr 0x56dfc48, size 0x10, virtual false, abstract: false, final false
  inline bool get_IsSet();

  /// @brief Method get_LastReceiveTime, addr 0x56e0214, size 0x18, virtual false, abstract: false, final false
  inline uint32_t get_LastReceiveTime();

  /// @brief Method get_LastRoundTripTime, addr 0x56e00ec, size 0x18, virtual false, abstract: false, final false
  inline uint32_t get_LastRoundTripTime();

  /// @brief Method get_LastSendTime, addr 0x56e0180, size 0x18, virtual false, abstract: false, final false
  inline uint32_t get_LastSendTime();

  /// @brief Method get_MTU, addr 0x56dff34, size 0x18, virtual false, abstract: false, final false
  inline uint32_t get_MTU();

  /// @brief Method get_NativeData, addr 0x56dfbbc, size 0x8, virtual false, abstract: false, final false
  inline ::System::IntPtr get_NativeData();

  /// @brief Method get_PacketsLost, addr 0x56e033c, size 0x18, virtual false, abstract: false, final false
  inline uint64_t get_PacketsLost();

  /// @brief Method get_PacketsSent, addr 0x56e02a8, size 0x18, virtual false, abstract: false, final false
  inline uint64_t get_PacketsSent();

  /// @brief Method get_PacketsThrottle, addr 0x56e03d0, size 0x18, virtual false, abstract: false, final false
  inline float_t get_PacketsThrottle();

  /// @brief Method get_Port, addr 0x56dfea0, size 0x18, virtual false, abstract: false, final false
  inline uint16_t get_Port();

  /// @brief Method get_RoundTripTime, addr 0x56e0058, size 0x18, virtual false, abstract: false, final false
  inline uint32_t get_RoundTripTime();

  /// @brief Method get_State, addr 0x56dffc8, size 0x14, virtual false, abstract: false, final false
  inline ::ENet::PeerState get_State();

  /// @brief Method set_Data, addr 0x56e0620, size 0x28, virtual false, abstract: false, final false
  inline void set_Data(::System::IntPtr value);

  /// @brief Method set_NativeData, addr 0x56dfbc4, size 0x8, virtual false, abstract: false, final false
