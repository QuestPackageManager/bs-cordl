...
// Ctor Parameters [CppParam { name: "malloc", ty: "::ENet::AllocCallback*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "free", ty: "::ENet::FreeCallback*", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "noMemory", ty: "::ENet::NoMemoryCallback*", modifiers: "", def_value: Some("{}"), comment: None }]
