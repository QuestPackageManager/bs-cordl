...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x56dcc0c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x56dcc84, size 0x24, virtual true, abstract: false, final false
inline uint64_t EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x56dcbf8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56dcb8c, size 0x6c, virtual false, abstract: false, final false
