...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (*)()>(&::ENet::ArrayPool::GetByteBuffer)> {
  ...
  constexpr static std::size_t addrs = 0x56dcca8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*> (*)()>(&::ENet::ArrayPool::GetPointerBuffer)> {
  constexpr static std::size_t size = 0x108;
  constexpr static std::size_t addrs = 0x56dcdb0;
...
::cordl_internals::setStaticField<::ArrayW<uint8_t,::Array<uint8_t>*>, "byteBuffer", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::ENet::ArrayPool*>::get>(std::forward<::ArrayW<uint8_t,::Array<uint8_t>*>>(value));
}
...
::cordl_internals::setStaticField<::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>, "pointerBuffer", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::ENet::ArrayPool*>::get>(std::forward<::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>>(value));
}
