...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x567be64, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x567be80, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x567be50, size 0x14, virtual true, abstract: false, final false
  inline void Invoke();

  static inline ::ENet::NoMemoryCallback* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x567bde8, size 0x68, virtual false, abstract: false, final false
