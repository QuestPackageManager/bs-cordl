...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x24d2188, size 0x84, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(void* memory, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x24d220c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x24d2174, size 0x14, virtual true, abstract: false, final false
  inline void Invoke(void* memory);

  static inline ::ENet::FreeCallback* New_ctor(::System::Object* object, void* method);

  /// @brief Method .ctor, addr 0x24d20b0, size 0xc4, virtual false, abstract: false, final false
