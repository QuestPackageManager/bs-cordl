...
public:
  ...
  /// @brief Method .ctor, addr 0x6a5b938, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GenericStack", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GenericStack(GenericStack&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GenericStack", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GenericStack(GenericStackconst&) = delete;
