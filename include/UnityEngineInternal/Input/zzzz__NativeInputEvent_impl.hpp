...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngineInternal::Input::NativeInputEventType", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "sizeInBytes", ty:
// "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "deviceId", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "time", ty:
// "double_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "eventId", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }]
