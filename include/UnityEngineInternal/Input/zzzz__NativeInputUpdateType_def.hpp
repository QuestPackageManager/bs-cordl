...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::Input::NativeInputUpdateType, "UnityEngineInternal.Input", "NativeInputUpdateType");
// Dependencies
namespace UnityEngineInternal::Input {
// Is value type: true
...
static_assert(sizeof(::UnityEngineInternal::Input::NativeInputUpdateType) == 0x4, "Size mismatch!");
