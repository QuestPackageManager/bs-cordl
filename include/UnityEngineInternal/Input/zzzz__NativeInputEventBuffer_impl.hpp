...
constexpr void* const& UnityEngineInternal::Input::NativeInputEventBuffer::__cordl_internal_get_eventBuffer() const {
return this->___eventBuffer;
}
constexpr void UnityEngineInternal::Input::NativeInputEventBuffer::__cordl_internal_set_eventBuffer(void*  value)  {
...
// Ctor Parameters [CppParam { name: "eventBuffer", ty: "void*", modifiers: "", def_value: Some("{}") }, CppParam { name: "eventCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "sizeInBytes", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "capacityInBytes", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
