...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6b604b8, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6b6044c, size 0x6c, virtual false, abstract: false, final false
