...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x6a0ae64, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6a0adf8, size 0x6c, virtual false, abstract: false, final false
