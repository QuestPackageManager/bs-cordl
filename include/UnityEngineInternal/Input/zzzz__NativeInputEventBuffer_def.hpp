...
DEFINE_IL2CPP_CLASS(::UnityEngineInternal::Input::NativeInputEventBuffer, "UnityEngineInternal.Input", "NativeInputEventBuffer");
// Dependencies
namespace UnityEngineInternal::Input {
// Is value type: true
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23283 };
...
static_assert(sizeof(::UnityEngineInternal::Input::NativeInputEventBuffer) == 0x14, "Size mismatch!");
