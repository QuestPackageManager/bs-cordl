...
/// @brief Method ToString, addr 0x688f5a4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x688f59c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  rule) ;

/// @brief Method .ctor, addr 0x688f524, size 0x78, virtual false, abstract: false, final false
