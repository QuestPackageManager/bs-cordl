...
public:
  // Ctor Parameters [CppParam { name: "", ty: "WebSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  WebSettings(WebSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "WebSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  WebSettings(WebSettingsconst&) = delete;
