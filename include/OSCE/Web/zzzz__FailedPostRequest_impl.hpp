...
// Ctor Parameters [CppParam { name: "Path", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "Json", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "ErrorMessage", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "AttemptsMade", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Batch", ty: "::OSCE::Analytics::LoggerAnalyticsBatch*", modifiers: "", def_value: Some("{}") }]
