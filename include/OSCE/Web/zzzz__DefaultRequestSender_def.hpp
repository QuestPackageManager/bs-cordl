...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultRequestSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultRequestSender(DefaultRequestSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultRequestSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultRequestSender(DefaultRequestSenderconst&) = delete;
