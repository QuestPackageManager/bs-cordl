...
public:
  ...
  /// @brief Method SendBatchRequest, addr 0x5dfb084, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method SendIdRequest, addr 0x5dfb294, size 0x118, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5dfb07c, size 0x8, virtual false, abstract: false, final false
