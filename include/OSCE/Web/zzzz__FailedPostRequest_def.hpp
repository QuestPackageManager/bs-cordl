...
// Ctor Parameters [CppParam { name: "Path", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "Json", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ErrorMessage", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "AttemptsMade", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Batch", ty: "::OSCE::Analytics::LoggerAnalyticsBatch*", modifiers: "", def_value: None }]
