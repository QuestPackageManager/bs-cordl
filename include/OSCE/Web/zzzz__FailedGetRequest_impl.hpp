...
// Ctor Parameters [CppParam { name: "Path", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "Query", ty: "::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "AttemptsMade", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
