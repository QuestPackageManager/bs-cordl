...
public:
  ...
  /// @brief Method MoveNext, addr 0x5dfbab8, size 0x760, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5dfc218, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method <PostAsync>b__0, addr 0x5dfb9f0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfb9ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5dfc284, size 0x314, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5dfc598, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5dfc618, size 0x418, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5dfca74, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5dfcaf4, size 0x474, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5dfcf68, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5dfcfe8, size 0x2a4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5dfd28c, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method BuildQueryString, addr 0x5dfb89c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildUri, addr 0x5dfb7a8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateClient, addr 0x5dfb460, size 0x74, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpClient* CreateClient();

  /// @brief Method GetHandler, addr 0x5dfb4d4, size 0x194, virtual false, abstract: false, final false
  inline ::System::Net::Http::HttpClientHandler* GetHandler();

  static inline ::OSCE::Web::REST* New_ctor();

  /// @brief Method PostAsync, addr 0x5dfb668, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method PostRequest, addr 0x5dfb1a0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfb3ac, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();
