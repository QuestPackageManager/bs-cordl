...
/// @brief Method ApplyBasicFields, addr 0x5d8b5b4, size 0x6c, virtual true, abstract: false, final false
inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method ApplyTime, addr 0x5d8b7f8, size 0x4c, virtual true, abstract: false, final false
inline void ApplyTime(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method EventRequiresAnalyticsID, addr 0x5d8b780, size 0x8, virtual true, abstract: false, final false
inline bool EventRequiresAnalyticsID() ;

/// @brief Method GetIDForEvent, addr 0x5d8b86c, size 0x15c, virtual false, abstract: false, final false
inline ::StringW GetIDForEvent(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method GetIDType, addr 0x5d8b778, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IDType GetIDType() ;

static inline ::OSCE::Analytics::UserSessionAnalyticsEvent* New_ctor() ;

/// @brief Method ReturnEventToPool, addr 0x5d8b788, size 0x70, virtual true, abstract: false, final false
inline void ReturnEventToPool() ;

/// @brief Method ReturnedToPool, addr 0x5d8b6ec, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d8b774, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
