...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserSessionAnalyticsEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserSessionAnalyticsEvent(UserSessionAnalyticsEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserSessionAnalyticsEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserSessionAnalyticsEvent(UserSessionAnalyticsEventconst&) = delete;
