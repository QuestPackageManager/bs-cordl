...
public:
  ...
  /// @brief Method AddEvent, addr 0x5dfeb54, size 0xb4, virtual false, abstract: false, final false
  inline void AddEvent(::OSCE::Analytics::BaseAnalyticsEvent* eventToSend);

  /// @brief Method ApplyOtherBatch, addr 0x5dffe7c, size 0x140, virtual false, abstract: false, final false
  inline void ApplyOtherBatch(::OSCE::Analytics::LoggerAnalyticsBatch* otherBatch);

  /// @brief Method ConvertEvents, addr 0x5dff03c, size 0x160, virtual false, abstract: false, final false
  inline void ConvertEvents();

  static inline ::OSCE::Analytics::LoggerAnalyticsBatch* New_ctor();

  /// @brief Method OnBatchFailed, addr 0x5dffa58, size 0x10, virtual false, abstract: false, final false
  inline void OnBatchFailed();

  /// @brief Method ReturnedToPool, addr 0x5e011dc, size 0x118, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e012f4, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Count, addr 0x5dffd74, size 0x50, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_CreatedByPool, addr 0x5e011cc, size 0x8, virtual true, abstract: false, final true
  inline bool get_CreatedByPool();

  /// @brief Method get_FailedAttempts, addr 0x5e011c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CreatedByPool, addr 0x5e011d4, size 0x8, virtual true, abstract: false, final true
