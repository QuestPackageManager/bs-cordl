...
/// @brief Field ACCEPTED_STRING_ARRAY_SCRIBE_TYPES, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ACCEPTED_STRING_ARRAY_SCRIBE_TYPES, put=setStaticF_ACCEPTED_STRING_ARRAY_SCRIBE_TYPES)) ::ArrayW<::System::Type*,::Array<::System::Type*>*>  ACCEPTED_STRING_ARRAY_SCRIBE_TYPES;
