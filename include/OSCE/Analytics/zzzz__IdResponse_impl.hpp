...
// Ctor Parameters [CppParam { name: "rid", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "platform_rid", ty: "::StringW", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "platform_account_id", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "game_specific_id", ty: "::StringW",
