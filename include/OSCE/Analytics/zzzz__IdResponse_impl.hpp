...
// Ctor Parameters [CppParam { name: "rid", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "platform_rid", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "platform_account_id", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "game_specific_id", ty: "::StringW", modifiers: "", def_value: Some("{}") }]
