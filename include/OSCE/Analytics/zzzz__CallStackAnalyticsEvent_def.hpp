...
/// @brief Method ApplyBasicFields, addr 0x5d8b580, size 0x34, virtual true, abstract: false, final false
inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method GetIDType, addr 0x5d8b578, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IDType GetIDType() ;

static inline ::OSCE::Analytics::CallStackAnalyticsEvent* New_ctor() ;

/// @brief Method ReturnEventToPool, addr 0x5d8b620, size 0x74, virtual true, abstract: false, final false
inline void ReturnEventToPool() ;

/// @brief Method ReturnedToPool, addr 0x5d8b694, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d8b770, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
