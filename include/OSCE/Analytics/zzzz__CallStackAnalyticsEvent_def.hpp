...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CallStackAnalyticsEvent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CallStackAnalyticsEvent(CallStackAnalyticsEvent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CallStackAnalyticsEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CallStackAnalyticsEvent(CallStackAnalyticsEventconst&) = delete;
