...
public:
  ...
  /// @brief Method ApplyBasicFields, addr 0x5dfd58c, size 0x34, virtual true, abstract: false, final false
  inline void ApplyBasicFields(::OSCE::Analytics::AnalyticsManager* manager);

  /// @brief Method GetIDType, addr 0x5dfd584, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IDType GetIDType();

  static inline ::OSCE::Analytics::CallStackAnalyticsEvent* New_ctor();

  /// @brief Method ReturnEventToPool, addr 0x5dfd62c, size 0x74, virtual true, abstract: false, final false
  inline void ReturnEventToPool();

  /// @brief Method ReturnedToPool, addr 0x5dfd6a0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dfd77c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
