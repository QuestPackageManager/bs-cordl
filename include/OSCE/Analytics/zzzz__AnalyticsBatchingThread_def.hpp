...
/// @brief Method MoveNext, addr 0x5d8e41c, size 0x388, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d8e7a4, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::OSCE::Analytics::AnalyticsBatchingThread*", modifiers: "", def_value: None }]
constexpr AnalyticsBatchingThread__ThreadedBatchSender_d__23(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::OSCE::Analytics::AnalyticsBatchingThread*  __4__this) noexcept;
...
/// @brief Field _failedBatchesToRetry, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__failedBatchesToRetry, put=__cordl_internal_set__failedBatchesToRetry)) ::System::Collections::Generic::Queue_1<::OSCE::Analytics::LoggerAnalyticsBatch*>*  _failedBatchesToRetry;
...
/// @brief Field _newBatchesToSend, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__newBatchesToSend, put=__cordl_internal_set__newBatchesToSend)) ::System::Collections::Generic::Queue_1<::OSCE::Analytics::LoggerAnalyticsBatch*>*  _newBatchesToSend;
...
/// @brief Field _unsentThreadedEvents, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__unsentThreadedEvents, put=__cordl_internal_set__unsentThreadedEvents)) ::System::Collections::Concurrent::ConcurrentQueue_1<::OSCE::Analytics::BaseAnalyticsEvent*>*  _unsentThreadedEvents;

/// @brief Method BatchSent, addr 0x5d8ddb8, size 0xb8, virtual false, abstract: false, final false
inline void BatchSent() ;

/// @brief Method CollectThreadedMessagesIntoBatch, addr 0x5d8e0ac, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method FlushToSingleBatch, addr 0x5d8dc24, size 0x144, virtual false, abstract: false, final false
inline ::OSCE::Analytics::LoggerAnalyticsBatch* FlushToSingleBatch(::OSCE::Analytics::LoggerAnalyticsBatch*  batch) ;

/// @brief Method GetActiveSends, addr 0x5d8cbfc, size 0xb8, virtual false, abstract: false, final false
inline int32_t GetActiveSends() ;

/// @brief Method IsBatchQueueEmpty, addr 0x5d8ccb4, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method OnBatchAttempted, addr 0x5d8d994, size 0xb8, virtual false, abstract: false, final false
inline void OnBatchAttempted() ;

/// @brief Method QueueBatch, addr 0x5d8c908, size 0x140, virtual false, abstract: false, final false
inline void QueueBatch(::OSCE::Analytics::LoggerAnalyticsBatch*  batch) ;

/// @brief Method QueueThreadedMessage, addr 0x5d8dfb0, size 0x64, virtual false, abstract: false, final false
inline void QueueThreadedMessage(::OSCE::Analytics::BaseAnalyticsEvent*  newEvent) ;

/// @brief Method SendBatchFromThread, addr 0x5d8e2f8, size 0x124, virtual false, abstract: false, final false
inline void SendBatchFromThread(::OSCE::Analytics::LoggerAnalyticsBatch*  batchToSend, bool  shouldFlush) ;

/// @brief Method Shutdown, addr 0x5d8cfbc, size 0x44, virtual false, abstract: false, final false
inline void Shutdown() ;

/// @brief Method ThreadedBatchSender, addr 0x5d8e014, size 0x98, virtual false, abstract: false, final false
inline void ThreadedBatchSender() ;

/// @brief Method TriggerAsyncSend, addr 0x5d8ce28, size 0x70, virtual false, abstract: false, final false
inline void TriggerAsyncSend() ;

/// @brief Method TriggerImmediateSend, addr 0x5d8da64, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d8be34, size 0x1dc, virtual false, abstract: false, final false
inline void _ctor(::OSCE::Analytics::AnalyticsManager*  manager) ;

/// @brief Method get_TimeOfLastSend, addr 0x5d8da5c, size 0x8, virtual false, abstract: false, final false
