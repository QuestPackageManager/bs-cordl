...
DEFINE_IL2CPP_CLASS(::OSCE::Analytics::LoggerAnalyticsEvent, "OSCE.Analytics", "LoggerAnalyticsEvent");
// Dependencies
namespace OSCE::Analytics {
// Is value type: true
...
static_assert(sizeof(::OSCE::Analytics::LoggerAnalyticsEvent) == 0x10, "Size mismatch!");
