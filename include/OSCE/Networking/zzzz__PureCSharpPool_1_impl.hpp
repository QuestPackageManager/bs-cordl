...
#include "OSCE/Networking/zzzz__IPureCSharpPoolElement_impl.hpp"
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::OSCE::Networking::IPureCSharpPoolElement*> && ::cordl_internals::default_constructor_constraint<T>)
inline void OSCE::Networking::PureCSharpPool_1<T>::setStaticF__pooledObjects(::ArrayW<T> value) {
  ::cordl_internals::setStaticField<::ArrayW<T>, "_pooledObjects", ::OSCE::Networking::PureCSharpPool_1<T>*>(std::forward<::ArrayW<T>>(value));
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::OSCE::Networking::IPureCSharpPoolElement*> && ::cordl_internals::default_constructor_constraint<T>)
inline ::ArrayW<T> OSCE::Networking::PureCSharpPool_1<T>::getStaticF__pooledObjects() {
