...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::AOT::MonoPInvokeCallbackAttribute::*)(::System::Type*)>(&::AOT::MonoPInvokeCallbackAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2b387d4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::AOT::MonoPInvokeCallbackAttribute*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
inline ::AOT::MonoPInvokeCallbackAttribute* AOT::MonoPInvokeCallbackAttribute::New_ctor(::System::Type* type) {
  return THROW_UNLESS(::il2cpp_utils::New<::AOT::MonoPInvokeCallbackAttribute*>(type));
}
