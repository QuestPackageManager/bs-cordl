...
// Ctor Parameters [CppParam { name: "si", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ei", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "l", ty: "float_t", modifiers: "", def_value: None }]
