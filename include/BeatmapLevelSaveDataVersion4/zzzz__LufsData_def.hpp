...
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::LufsData, "BeatmapLevelSaveDataVersion4", "LufsData");
// Dependencies
namespace BeatmapLevelSaveDataVersion4 {
// Is value type: true
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::LufsData) == 0xc, "Size mismatch!");
