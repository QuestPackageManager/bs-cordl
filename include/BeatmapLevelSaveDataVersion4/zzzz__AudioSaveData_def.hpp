...
public:
  ...
  /// @brief Method .ctor, addr 0x3760104, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AudioSaveData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AudioSaveData(AudioSaveData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AudioSaveData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AudioSaveData(AudioSaveDataconst&) = delete;
