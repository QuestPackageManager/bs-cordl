...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::AudioSaveData::*)()>(&::BeatmapLevelSaveDataVersion4::AudioSaveData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x369f91c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::AudioSaveData*>::get(),
                        ".ctor",
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BpmData*,::Array<::BeatmapLevelSaveDataVersion4::BpmData*>*> const& BeatmapLevelSaveDataVersion4::AudioSaveData::__cordl_internal_get_bpmData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___bpmData;
}
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData,::Array<::BeatmapLevelSaveDataVersion4::LufsData>*> const& BeatmapLevelSaveDataVersion4::AudioSaveData::__cordl_internal_get_lufsData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___lufsData;
}
constexpr void BeatmapLevelSaveDataVersion4::AudioSaveData::__cordl_internal_set_lufsData(::ArrayW<::BeatmapLevelSaveDataVersion4::LufsData,::Array<::BeatmapLevelSaveDataVersion4::LufsData>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
