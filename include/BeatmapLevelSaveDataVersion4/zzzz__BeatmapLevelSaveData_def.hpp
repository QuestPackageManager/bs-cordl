...
// Write type traits
MARK_REF_T(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData*);
MARK_REF_T(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*);
MARK_REF_T(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*);
...
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData*, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData");
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData/ColorScheme");
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData/DifficultyBeatmap");
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_AudioData, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData/AudioData");
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_BeatmapAuthors, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData/BeatmapAuthors");
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_SongData, "BeatmapLevelSaveDataVersion4", "BeatmapLevelSaveData/SongData");
// Dependencies
namespace BeatmapLevelSaveDataVersion4 {
// Is value type: true
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_SongData) == 0x18, "Size mismatch!");
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_AudioData) == 0x28, "Size mismatch!");
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme) == 0x60, "Size mismatch!");
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_BeatmapAuthors) == 0x10, "Size mismatch!");
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap) == 0x50, "Size mismatch!");

} // namespace BeatmapLevelSaveDataVersion4
// Dependencies BeatmapLevelSaveDataVersion4.BeatmapLevelSaveData::AudioData, BeatmapLevelSaveDataVersion4.BeatmapLevelSaveData::ColorScheme,
// BeatmapLevelSaveDataVersion4.BeatmapLevelSaveData::DifficultyBeatmap, BeatmapLevelSaveDataVersion4.BeatmapLevelSaveData::SongData, System.Object
namespace BeatmapLevelSaveDataVersion4 {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_colorSchemes, put = __cordl_internal_set_colorSchemes)) ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*> colorSchemes;
  ...
  __declspec(property(get = __cordl_internal_get_difficultyBeatmaps, put = __cordl_internal_set_difficultyBeatmaps)) ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>
      difficultyBeatmaps;

  /// @brief Field environmentNames, offset 0x68, size 0x8
  __declspec(property(get = __cordl_internal_get_environmentNames, put = __cordl_internal_set_environmentNames)) ::ArrayW<::StringW> environmentNames;
  ...
  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*> const& __cordl_internal_get_colorSchemes() const;

  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>& __cordl_internal_get_colorSchemes();
  ...
  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*> const& __cordl_internal_get_difficultyBeatmaps() const;

  constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>& __cordl_internal_get_difficultyBeatmaps();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_environmentNames() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_environmentNames();
  ...
  constexpr void __cordl_internal_set_colorSchemes(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*> value);

  constexpr void __cordl_internal_set_coverImageFilename(::StringW value);

  constexpr void __cordl_internal_set_difficultyBeatmaps(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*> value);

  constexpr void __cordl_internal_set_environmentNames(::ArrayW<::StringW> value);
...
public:
  ...
  ::ArrayW<::StringW> ___environmentNames;

  /// @brief Field colorSchemes, offset: 0x70, size: 0x8, def value: None
  ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*> ___colorSchemes;

  /// @brief Field difficultyBeatmaps, offset: 0x78, size: 0x8, def value: None
  ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*> ___difficultyBeatmaps;
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData) == 0x80, "Size mismatch!");
