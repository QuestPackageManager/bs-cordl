...
// Ctor Parameters [CppParam { name: "title", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "subTitle", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "author", ty: "::StringW", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "songFilename", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "songDuration", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "audioDataFilename", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "bpm", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "lufs", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "previewStartTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "previewDuration", ty: "float_t", modifiers: "", def_value: None }]
constexpr BeatmapLevelSaveData_AudioData(::StringW  songFilename, float_t  songDuration, ::StringW  audioDataFilename, float_t  bpm, float_t  lufs, float_t  previewStartTime, float_t  previewDuration) noexcept;
...
/// @brief Method .ctor, addr 0x36625d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "mappers", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "lighters", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }]
...
/// @brief Method .ctor, addr 0x36625d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field colorSchemes, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorSchemes, put=__cordl_internal_set_colorSchemes)) ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*>  colorSchemes;
...
/// @brief Field difficultyBeatmaps, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_difficultyBeatmaps, put=__cordl_internal_set_difficultyBeatmaps)) ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*>  difficultyBeatmaps;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*> const& __cordl_internal_get_colorSchemes() const;

constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*>& __cordl_internal_get_colorSchemes() ;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*> const& __cordl_internal_get_difficultyBeatmaps() const;

constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*>& __cordl_internal_get_difficultyBeatmaps() ;
...
constexpr void __cordl_internal_set_colorSchemes(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*>  value) ;

constexpr void __cordl_internal_set_coverImageFilename(::StringW  value) ;

constexpr void __cordl_internal_set_difficultyBeatmaps(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*>  value) ;
...
/// @brief Method .ctor, addr 0x36624f0, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
