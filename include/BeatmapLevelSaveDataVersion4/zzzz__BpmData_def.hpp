...
public:
  ...
  /// @brief Method .ctor, addr 0x36625c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x36625bc, size 0x8, virtual true, abstract: false, final true
