...
// Write type traits
MARK_REF_T(::BeatmapLevelSaveDataVersion4::BpmData*);
DEFINE_IL2CPP_CLASS(::BeatmapLevelSaveDataVersion4::BpmData*, "BeatmapLevelSaveDataVersion4", "BpmData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3760158, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beat, addr 0x3760150, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::BeatmapLevelSaveDataVersion4::BpmData) == 0x20, "Size mismatch!");
