...
// Ctor Parameters [CppParam { name: "title", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "subTitle", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "author", ty: "::StringW", modifiers: "", def_value: Some("{}") }]
...
// Ctor Parameters [CppParam { name: "songFilename", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "songDuration", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "audioDataFilename", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "bpm", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "lufs", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "previewStartTime", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "previewDuration", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_AudioData::BeatmapLevelSaveData_AudioData(::StringW  songFilename, float_t  songDuration, ::StringW  audioDataFilename, float_t  bpm, float_t  lufs, float_t  previewStartTime, float_t  previewDuration) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme::*)()>(&::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x36625d0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>::get(),
                        ".ctor",
...
// Ctor Parameters [CppParam { name: "mappers", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "lighters", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_BeatmapAuthors::BeatmapLevelSaveData_BeatmapAuthors(::ArrayW<::StringW,::Array<::StringW>*>  mappers, ::ArrayW<::StringW,::Array<::StringW>*>  lighters) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap::*)()>(&::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x36625d4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::*)()>(&::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x36624f0;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*>& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_colorSchemes()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___colorSchemes;
}
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*> const& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_colorSchemes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___colorSchemes;
}
constexpr void BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_set_colorSchemes(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_ColorScheme*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*>& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_difficultyBeatmaps()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___difficultyBeatmaps;
}
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*> const& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_difficultyBeatmaps() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___difficultyBeatmaps;
}
constexpr void BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_set_difficultyBeatmaps(::ArrayW<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData_DifficultyBeatmap*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
::cordl_internals::setStaticField<::System::Version*, "kCustomColorOverridesVersion", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData*>::get>(std::forward<::System::Version*>(value));
}
inline ::System::Version* BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::getStaticF_kCustomColorOverridesVersion()  {
return ::cordl_internals::getStaticField<::System::Version*, "kCustomColorOverridesVersion", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData*>::get>();
}
