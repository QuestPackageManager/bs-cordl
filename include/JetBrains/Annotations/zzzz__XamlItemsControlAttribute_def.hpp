...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XamlItemsControlAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XamlItemsControlAttribute(XamlItemsControlAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XamlItemsControlAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XamlItemsControlAttribute(XamlItemsControlAttributeconst&) = delete;
