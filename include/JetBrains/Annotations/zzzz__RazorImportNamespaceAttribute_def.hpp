...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3acdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x6e3ace4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x6e3acec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::RazorImportNamespaceAttribute) == 0x18, "Size mismatch!");
