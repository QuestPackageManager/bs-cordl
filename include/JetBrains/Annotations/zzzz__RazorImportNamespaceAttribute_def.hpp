...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4e60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x6ce4e68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x6ce4e70, size 0x8, virtual false, abstract: false, final false
