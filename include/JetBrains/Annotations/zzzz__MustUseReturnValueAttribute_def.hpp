...
public:
  ...
  /// @brief Method .ctor addr 0x2eba32c size 0x8 virtual false final false
  inline void _ctor();

  static inline ::JetBrains::Annotations::MustUseReturnValueAttribute* New_ctor(::StringW justification);

  /// @brief Method .ctor addr 0x2eba334 size 0x28 virtual false final false
  inline void _ctor(::StringW justification);

  /// @brief Method get_Justification addr 0x2eba35c size 0x8 virtual false final false
  inline ::StringW get_Justification();

  /// @brief Method set_Justification addr 0x2eba364 size 0x8 virtual false final false
