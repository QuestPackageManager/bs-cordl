...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ItemCanBeNullAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ItemCanBeNullAttribute(ItemCanBeNullAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ItemCanBeNullAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ItemCanBeNullAttribute(ItemCanBeNullAttributeconst&) = delete;
