...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvokerParameterNameAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvokerParameterNameAttribute(InvokerParameterNameAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvokerParameterNameAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvokerParameterNameAttribute(InvokerParameterNameAttributeconst&) = delete;
