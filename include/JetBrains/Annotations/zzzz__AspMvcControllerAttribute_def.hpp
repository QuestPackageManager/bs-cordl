...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcControllerAttribute* New_ctor(/* [NotNull] */ ::StringW anonymousProperty);
  ...
  /// @brief Method .ctor, addr 0x6e3e130, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6e3e134, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(/* [NotNull] */ ::StringW anonymousProperty);

  /// [CompilerGenerated]
  /// @brief Method get_AnonymousProperty, addr 0x6e3e13c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_AnonymousProperty();

  /// [CompilerGenerated]
  /// @brief Method set_AnonymousProperty, addr 0x6e3e144, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcControllerAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcControllerAttribute(AspMvcControllerAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcControllerAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcControllerAttribute(AspMvcControllerAttributeconst&) = delete;
