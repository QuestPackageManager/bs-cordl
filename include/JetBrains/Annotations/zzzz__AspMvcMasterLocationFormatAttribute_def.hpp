...
public:
  ...
  /// @brief Method .ctor, addr 0x4af37f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x4af3820, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x4af3828, size 0x8, virtual false, abstract: false, final false
