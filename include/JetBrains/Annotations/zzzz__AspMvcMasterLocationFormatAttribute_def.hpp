...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4cac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6ce4cb4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6ce4cbc, size 0x8, virtual false, abstract: false, final false
