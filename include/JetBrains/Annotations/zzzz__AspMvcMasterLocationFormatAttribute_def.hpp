...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute* New_ctor(/* [NotNull] */ ::StringW format);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcMasterLocationFormatAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcMasterLocationFormatAttribute(AspMvcMasterLocationFormatAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcMasterLocationFormatAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcMasterLocationFormatAttribute(AspMvcMasterLocationFormatAttributeconst&) = delete;
