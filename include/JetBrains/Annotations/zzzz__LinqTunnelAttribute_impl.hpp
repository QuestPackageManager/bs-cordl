...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::LinqTunnelAttribute::*)()>(&::JetBrains::Annotations::LinqTunnelAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6e3ac60;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::LinqTunnelAttribute*>(), { ".ctor", {}, {} })));
...
inline ::JetBrains::Annotations::LinqTunnelAttribute* JetBrains::Annotations::LinqTunnelAttribute::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::JetBrains::Annotations::LinqTunnelAttribute*>());
}
// Ctor Parameters []
