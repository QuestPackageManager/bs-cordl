...
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AssertionConditionType, "JetBrains.Annotations", "AssertionConditionType");
// Dependencies
namespace JetBrains::Annotations {
// Is value type: true
...
static_assert(sizeof(::JetBrains::Annotations::AssertionConditionType) == 0x4, "Size mismatch!");
