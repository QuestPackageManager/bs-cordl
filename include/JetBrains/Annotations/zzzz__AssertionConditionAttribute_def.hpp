...
/// @brief Field <ConditionType>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__ConditionType_k__BackingField, put=__cordl_internal_set__ConditionType_k__BackingField)) ::JetBrains::Annotations::AssertionConditionType  _ConditionType_k__BackingField;
...
/// @brief Method .ctor, addr 0x6c72b84, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::AssertionConditionType  conditionType) ;

/// @brief Method get_ConditionType, addr 0x6c72b8c, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::AssertionConditionType get_ConditionType() ;

/// @brief Method set_ConditionType, addr 0x6c72b94, size 0x8, virtual false, abstract: false, final false
