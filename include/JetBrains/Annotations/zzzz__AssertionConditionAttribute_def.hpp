...
public:
  ...
  /// @brief Method .ctor, addr 0x4af3710, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::AssertionConditionType conditionType);

  /// @brief Method get_ConditionType, addr 0x4af3738, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::AssertionConditionType get_ConditionType();

  /// @brief Method set_ConditionType, addr 0x4af3740, size 0x8, virtual false, abstract: false, final false
