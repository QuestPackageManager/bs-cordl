...
/// @brief Method .ctor, addr 0x6ce6940, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::AssertionConditionType  conditionType) ;

/// @brief Method get_ConditionType, addr 0x6ce6948, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::AssertionConditionType get_ConditionType() ;

/// @brief Method set_ConditionType, addr 0x6ce6950, size 0x8, virtual false, abstract: false, final false
