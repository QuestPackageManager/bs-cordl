...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3ac44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::AssertionConditionType conditionType);

  /// @brief Method get_ConditionType, addr 0x6e3ac4c, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::AssertionConditionType get_ConditionType();

  /// @brief Method set_ConditionType, addr 0x6e3ac54, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AssertionConditionAttribute) == 0x18, "Size mismatch!");
