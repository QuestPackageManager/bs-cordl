...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4e78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW type, ::StringW fieldName);

  /// @brief Method get_FieldName, addr 0x6ce4e90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FieldName();

  /// @brief Method get_Type, addr 0x6ce4e80, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Type();

  /// @brief Method set_FieldName, addr 0x6ce4e98, size 0x8, virtual false, abstract: false, final false
  inline void set_FieldName(::StringW value);

  /// @brief Method set_Type, addr 0x6ce4e88, size 0x8, virtual false, abstract: false, final false
