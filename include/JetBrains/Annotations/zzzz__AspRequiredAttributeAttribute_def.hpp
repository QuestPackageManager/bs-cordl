...
public:
  ...
  /// @brief Method .ctor, addr 0x4a8c774, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW attribute);

  /// @brief Method get_Attribute, addr 0x4a8c79c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Attribute();

  /// @brief Method set_Attribute, addr 0x4a8c7a4, size 0x8, virtual false, abstract: false, final false
