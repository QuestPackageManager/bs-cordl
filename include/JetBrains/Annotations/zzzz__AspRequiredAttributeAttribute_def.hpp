...
public:
  ...
  /// @brief Method .ctor, addr 0x6c7252c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW attribute);

  /// @brief Method get_Attribute, addr 0x6c72534, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Attribute();

  /// @brief Method set_Attribute, addr 0x6c7253c, size 0x8, virtual false, abstract: false, final false
