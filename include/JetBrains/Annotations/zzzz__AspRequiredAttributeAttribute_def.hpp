...
public:
  ...
  /// @brief Method get_Attribute, addr 0x4af3bec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Attribute();

  /// @brief Method set_Attribute, addr 0x4af3bf4, size 0x8, virtual false, abstract: false, final false
