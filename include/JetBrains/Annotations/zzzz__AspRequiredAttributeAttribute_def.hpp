...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4e30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW attribute);

  /// @brief Method get_Attribute, addr 0x6ce4e38, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Attribute();

  /// @brief Method set_Attribute, addr 0x6ce4e40, size 0x8, virtual false, abstract: false, final false
