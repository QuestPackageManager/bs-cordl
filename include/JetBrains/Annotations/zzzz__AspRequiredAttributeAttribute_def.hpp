...
public:
  ...
  /// @brief Method .ctor, addr 0x4a7805c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW attribute);

  /// @brief Method get_Attribute, addr 0x4a78084, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Attribute();

  /// @brief Method set_Attribute, addr 0x4a7808c, size 0x8, virtual false, abstract: false, final false
