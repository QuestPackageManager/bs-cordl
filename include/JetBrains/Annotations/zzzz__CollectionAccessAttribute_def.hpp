...
public:
  ...
  /// @brief Method .ctor, addr 0x4af0f70, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::CollectionAccessType collectionAccessType);

  /// @brief Method get_CollectionAccessType, addr 0x4af0f98, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::CollectionAccessType get_CollectionAccessType();

  /// @brief Method set_CollectionAccessType, addr 0x4af0fa0, size 0x8, virtual false, abstract: false, final false
