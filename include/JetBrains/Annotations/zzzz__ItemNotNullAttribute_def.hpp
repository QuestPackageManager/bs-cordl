...
// [AttributeUsage((System.AttributeTargets)6592)]
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3de60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ItemNotNullAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ItemNotNullAttribute(ItemNotNullAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ItemNotNullAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ItemNotNullAttribute(ItemNotNullAttributeconst&) = delete;
