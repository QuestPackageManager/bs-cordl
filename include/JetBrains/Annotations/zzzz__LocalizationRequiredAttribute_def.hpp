...
public:
  ...
  /// @brief Method .ctor, addr 0x4af3ba4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4af3bc4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(bool required);

  /// @brief Method get_Required, addr 0x4af3bf0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Required();

  /// @brief Method set_Required, addr 0x4af3bf8, size 0xc, virtual false, abstract: false, final false
