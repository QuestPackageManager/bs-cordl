...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4aec, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ce4af8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool required);

  /// @brief Method get_Required, addr 0x6ce4b00, size 0x8, virtual false, abstract: false, final false
  inline bool get_Required();

  /// @brief Method set_Required, addr 0x6ce4b08, size 0x8, virtual false, abstract: false, final false
