...
public:
  ...
  /// @brief Method .ctor, addr 0x4affa5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4affa64, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW comment);

  /// @brief Method get_Comment, addr 0x4affa8c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Comment();

  /// @brief Method set_Comment, addr 0x4affa94, size 0x8, virtual false, abstract: false, final false
