...
public:
  ...
  /// @brief Method get_Format, addr 0x4af38d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x4af38d8, size 0x8, virtual false, abstract: false, final false
