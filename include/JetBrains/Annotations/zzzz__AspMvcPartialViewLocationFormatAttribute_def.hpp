...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute* New_ctor(/* [NotNull] */ ::StringW format);
  ...
  /// @brief Method .ctor, addr 0x6e3e0c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(/* [NotNull] */ ::StringW format);

  /// [CompilerGenerated]
  /// @brief Method get_Format, addr 0x6e3e0d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// [CompilerGenerated]
  /// @brief Method set_Format, addr 0x6e3e0d8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcPartialViewLocationFormatAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcPartialViewLocationFormatAttribute(AspMvcPartialViewLocationFormatAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcPartialViewLocationFormatAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcPartialViewLocationFormatAttribute(AspMvcPartialViewLocationFormatAttributeconst&) = delete;
