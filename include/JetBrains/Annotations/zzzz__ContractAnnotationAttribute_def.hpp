...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4ab4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW contract);

  /// @brief Method .ctor, addr 0x6ce4ac0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW contract, bool forceFullStates);

  /// @brief Method get_Contract, addr 0x6ce4acc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Contract();

  /// @brief Method get_ForceFullStates, addr 0x6ce4adc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceFullStates();

  /// @brief Method set_Contract, addr 0x6ce4ad4, size 0x8, virtual false, abstract: false, final false
  inline void set_Contract(::StringW value);

  /// @brief Method set_ForceFullStates, addr 0x6ce4ae4, size 0x8, virtual false, abstract: false, final false
