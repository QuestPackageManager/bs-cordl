...
public:
  ...
  /// @brief Method .ctor, addr 0x6c721b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW contract);

  /// @brief Method .ctor, addr 0x6c721bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW contract, bool forceFullStates);

  /// @brief Method get_Contract, addr 0x6c721c8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Contract();

  /// @brief Method get_ForceFullStates, addr 0x6c721d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_ForceFullStates();

  /// @brief Method set_Contract, addr 0x6c721d0, size 0x8, virtual false, abstract: false, final false
  inline void set_Contract(::StringW value);

  /// @brief Method set_ForceFullStates, addr 0x6c721e0, size 0x8, virtual false, abstract: false, final false
