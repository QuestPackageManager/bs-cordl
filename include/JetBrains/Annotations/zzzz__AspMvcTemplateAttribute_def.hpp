...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3e164, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcTemplateAttribute) == 0x10, "Size mismatch!");
