...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::PublicAPIAttribute::*)()>(&::JetBrains::Annotations::PublicAPIAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6c72988;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::PublicAPIAttribute::*)(::StringW)>(&::JetBrains::Annotations::PublicAPIAttribute::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6c7298c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::JetBrains::Annotations::PublicAPIAttribute::*)()>(&::JetBrains::Annotations::PublicAPIAttribute::get_Comment)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6c72994;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::PublicAPIAttribute::*)(::StringW)>(&::JetBrains::Annotations::PublicAPIAttribute::set_Comment)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6c7299c;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::PublicAPIAttribute*>());
}
inline ::JetBrains::Annotations::PublicAPIAttribute* JetBrains::Annotations::PublicAPIAttribute::New_ctor(::StringW  comment)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::PublicAPIAttribute*>(comment));
}
// Ctor Parameters []
