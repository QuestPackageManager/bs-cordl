...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3a8e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatParameterName);

  /// @brief Method get_FormatParameterName, addr 0x6e3a8e8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FormatParameterName();

  /// @brief Method set_FormatParameterName, addr 0x6e3a8f0, size 0x8, virtual false, abstract: false, final false
