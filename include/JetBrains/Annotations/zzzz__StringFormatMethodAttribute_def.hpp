...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4a64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW formatParameterName);

  /// @brief Method get_FormatParameterName, addr 0x6ce4a6c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_FormatParameterName();

  /// @brief Method set_FormatParameterName, addr 0x6ce4a74, size 0x8, virtual false, abstract: false, final false
