...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute::*)(::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x6e3e0c8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e3e0d0;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute::*)(::StringW)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e3e0d8;
...
inline void JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute::_ctor(/* [NotNull] */ ::StringW format) {
  static auto* ___internal_method =
...
inline ::JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute* JetBrains::Annotations::AspMvcPartialViewLocationFormatAttribute::New_ctor(/* [NotNull] */ ::StringW format) {
