...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3df14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CannotApplyEqualityOperatorAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CannotApplyEqualityOperatorAttribute(CannotApplyEqualityOperatorAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CannotApplyEqualityOperatorAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CannotApplyEqualityOperatorAttribute(CannotApplyEqualityOperatorAttributeconst&) = delete;
