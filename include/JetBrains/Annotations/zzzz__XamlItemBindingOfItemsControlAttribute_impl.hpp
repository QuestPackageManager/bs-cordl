...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::XamlItemBindingOfItemsControlAttribute::*)()>(&::JetBrains::Annotations::XamlItemBindingOfItemsControlAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6c72bb4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::JetBrains::Annotations::XamlItemBindingOfItemsControlAttribute*>::get(),
                        ".ctor",
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::XamlItemBindingOfItemsControlAttribute*>());
}
// Ctor Parameters []
