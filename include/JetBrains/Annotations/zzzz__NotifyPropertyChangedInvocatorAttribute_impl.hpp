...
inline void JetBrains::Annotations::NotifyPropertyChangedInvocatorAttribute::_ctor(/* [NotNull] */ ::StringW parameterName) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::NotifyPropertyChangedInvocatorAttribute*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
...
inline ::JetBrains::Annotations::NotifyPropertyChangedInvocatorAttribute* JetBrains::Annotations::NotifyPropertyChangedInvocatorAttribute::New_ctor(/* [NotNull] */ ::StringW parameterName) {
