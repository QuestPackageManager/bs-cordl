...
public:
  ...
  /// @brief Method .ctor, addr 0x4862314, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4862338, size 0x2c, virtual false, abstract: false, final false
