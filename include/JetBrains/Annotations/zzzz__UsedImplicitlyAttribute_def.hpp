...
public:
  ...
  /// @brief Method .ctor, addr 0x6a60c68, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6a60c78, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UsedImplicitlyAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UsedImplicitlyAttribute(UsedImplicitlyAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UsedImplicitlyAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UsedImplicitlyAttribute(UsedImplicitlyAttributeconst&) = delete;
