...
public:
  ...
  /// @brief Method .ctor, addr 0x486eab4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x486ead8, size 0x2c, virtual false, abstract: false, final false
