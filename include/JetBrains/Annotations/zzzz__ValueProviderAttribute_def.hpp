...
public:
  ...
  /// @brief Method .ctor, addr 0x4aed31c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x4aed344, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x4aed34c, size 0x8, virtual false, abstract: false, final false
