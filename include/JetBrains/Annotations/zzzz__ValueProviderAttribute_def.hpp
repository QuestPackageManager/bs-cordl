...
// [AttributeUsage((System.AttributeTargets)2432, AllowMultiple = true)]
...
public:
  ...
  static inline ::JetBrains::Annotations::ValueProviderAttribute* New_ctor(/* [NotNull] */ ::StringW name);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValueProviderAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValueProviderAttribute(ValueProviderAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValueProviderAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValueProviderAttribute(ValueProviderAttributeconst&) = delete;
