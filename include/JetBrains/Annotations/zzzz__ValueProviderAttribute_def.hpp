...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3a8f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_Name, addr 0x6e3a900, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x6e3a908, size 0x8, virtual false, abstract: false, final false
