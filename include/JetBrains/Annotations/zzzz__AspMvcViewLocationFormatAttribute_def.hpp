...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcViewLocationFormatAttribute* New_ctor(/* [NotNull] */ ::StringW format);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcViewLocationFormatAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcViewLocationFormatAttribute(AspMvcViewLocationFormatAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcViewLocationFormatAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcViewLocationFormatAttribute(AspMvcViewLocationFormatAttributeconst&) = delete;
