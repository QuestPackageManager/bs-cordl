...
public:
  ...
  static inline ::JetBrains::Annotations::HtmlAttributeValueAttribute* New_ctor(/* [NotNull] */ ::StringW name);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HtmlAttributeValueAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HtmlAttributeValueAttribute(HtmlAttributeValueAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HtmlAttributeValueAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HtmlAttributeValueAttribute(HtmlAttributeValueAttributeconst&) = delete;
