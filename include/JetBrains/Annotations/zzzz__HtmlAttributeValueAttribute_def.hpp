...
public:
  ...
  /// @brief Method get_Name, addr 0x4af36b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method set_Name, addr 0x4af36c0, size 0x8, virtual false, abstract: false, final false
