...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RazorWriteMethodParameterAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RazorWriteMethodParameterAttribute(RazorWriteMethodParameterAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RazorWriteMethodParameterAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RazorWriteMethodParameterAttribute(RazorWriteMethodParameterAttributeconst&) = delete;
