...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3e2f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RazorWriteLiteralMethodAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RazorWriteLiteralMethodAttribute(RazorWriteLiteralMethodAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RazorWriteLiteralMethodAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RazorWriteLiteralMethodAttribute(RazorWriteLiteralMethodAttributeconst&) = delete;
