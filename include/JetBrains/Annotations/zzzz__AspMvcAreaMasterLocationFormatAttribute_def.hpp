...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute* New_ctor(/* [NotNull] */ ::StringW format);
  ...
  /// @brief Method .ctor, addr 0x6e3e068, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(/* [NotNull] */ ::StringW format);

  /// [CompilerGenerated]
  /// @brief Method get_Format, addr 0x6e3e070, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// [CompilerGenerated]
  /// @brief Method set_Format, addr 0x6e3e078, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcAreaMasterLocationFormatAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcAreaMasterLocationFormatAttribute(AspMvcAreaMasterLocationFormatAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcAreaMasterLocationFormatAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcAreaMasterLocationFormatAttribute(AspMvcAreaMasterLocationFormatAttributeconst&) = delete;
