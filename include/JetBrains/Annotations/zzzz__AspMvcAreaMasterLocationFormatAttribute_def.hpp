...
public:
  ...
  /// @brief Method .ctor, addr 0x6c094dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6c094e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6c094ec, size 0x8, virtual false, abstract: false, final false
