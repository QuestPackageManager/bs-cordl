...
public:
  ...
  /// @brief Method .ctor, addr 0x6c09718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW directive);

  /// @brief Method get_Directive, addr 0x6c09720, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Directive();

  /// @brief Method set_Directive, addr 0x6c09728, size 0x8, virtual false, abstract: false, final false
