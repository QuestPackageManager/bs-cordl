...
public:
  ...
  /// @brief Method .ctor, addr 0x4b0006c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW directive);

  /// @brief Method get_Directive, addr 0x4b00094, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Directive();

  /// @brief Method set_Directive, addr 0x4b0009c, size 0x8, virtual false, abstract: false, final false
