...
public:
  ...
  /// @brief Method .ctor, addr 0x485c6e4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x485c708, size 0x2c, virtual false, abstract: false, final false
