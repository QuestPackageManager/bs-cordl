...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4b7c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ce4ba0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::ImplicitUseTargetFlags targetFlags);

  /// @brief Method .ctor, addr 0x6ce4b94, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::ImplicitUseKindFlags useKindFlags);

  /// @brief Method .ctor, addr 0x6ce4b8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TargetFlags, addr 0x6ce4bbc, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::ImplicitUseTargetFlags get_TargetFlags();

  /// @brief Method get_UseKindFlags, addr 0x6ce4bac, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::ImplicitUseKindFlags get_UseKindFlags();

  /// @brief Method set_TargetFlags, addr 0x6ce4bc4, size 0x8, virtual false, abstract: false, final false
  inline void set_TargetFlags(::JetBrains::Annotations::ImplicitUseTargetFlags value);

  /// @brief Method set_UseKindFlags, addr 0x6ce4bb4, size 0x8, virtual false, abstract: false, final false
