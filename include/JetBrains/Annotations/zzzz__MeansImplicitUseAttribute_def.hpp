...
public:
  ...
  /// @brief Method .ctor, addr 0x4865ad4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4865af8, size 0x2c, virtual false, abstract: false, final false
