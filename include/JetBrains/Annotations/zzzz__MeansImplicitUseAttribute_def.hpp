...
public:
  ...
  /// @brief Method .ctor, addr 0x33d6050, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33d6074, size 0x2c, virtual false, abstract: false, final false
