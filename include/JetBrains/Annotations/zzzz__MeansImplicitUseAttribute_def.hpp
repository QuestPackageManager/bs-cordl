...
public:
  ...
  /// @brief Method .ctor, addr 0x3651200, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x365127c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::ImplicitUseTargetFlags targetFlags);

  /// @brief Method .ctor, addr 0x3651250, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::JetBrains::Annotations::ImplicitUseKindFlags useKindFlags);

  /// @brief Method .ctor, addr 0x3651224, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TargetFlags, addr 0x36512b8, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::ImplicitUseTargetFlags get_TargetFlags();

  /// @brief Method get_UseKindFlags, addr 0x36512a8, size 0x8, virtual false, abstract: false, final false
  inline ::JetBrains::Annotations::ImplicitUseKindFlags get_UseKindFlags();

  /// @brief Method set_TargetFlags, addr 0x36512c0, size 0x8, virtual false, abstract: false, final false
  inline void set_TargetFlags(::JetBrains::Annotations::ImplicitUseTargetFlags value);

  /// @brief Method set_UseKindFlags, addr 0x36512b0, size 0x8, virtual false, abstract: false, final false
