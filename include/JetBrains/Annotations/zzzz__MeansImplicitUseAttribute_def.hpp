...
public:
  ...
  /// @brief Method .ctor, addr 0x6893e7c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6893e8c, size 0x8, virtual false, abstract: false, final false
