...
public:
  ...
  /// @brief Method .ctor, addr 0x6a60c80, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6a60c90, size 0x8, virtual false, abstract: false, final false
