...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute::*)(::StringW)>(
  ...
  constexpr static std::size_t addrs = 0x6e3e068;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::StringW (::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e3e070;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute::*)(::StringW)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e3e078;
...
inline void JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute::_ctor(/* [NotNull] */ ::StringW format) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
...
inline ::JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute* JetBrains::Annotations::AspMvcAreaMasterLocationFormatAttribute::New_ctor(/* [NotNull] */ ::StringW format) {
