...
public:
  ...
  /// @brief Method .ctor, addr 0x4aff768, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4aff770, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW parameterName);

  /// @brief Method get_ParameterName, addr 0x4aff798, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ParameterName();

  /// @brief Method set_ParameterName, addr 0x4aff7a0, size 0x8, virtual false, abstract: false, final false
