...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4c10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6ce4c14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW basePath);

  /// @brief Method get_BasePath, addr 0x6ce4c1c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BasePath();

  /// @brief Method set_BasePath, addr 0x6ce4c24, size 0x8, virtual false, abstract: false, final false
