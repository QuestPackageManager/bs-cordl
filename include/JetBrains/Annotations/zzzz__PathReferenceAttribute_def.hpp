...
public:
  ...
  /// @brief Method .ctor addr 0x2eba374 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::JetBrains::Annotations::PathReferenceAttribute* New_ctor(::StringW basePath);

  /// @brief Method .ctor addr 0x2eba37c size 0x28 virtual false final false
  inline void _ctor(::StringW basePath);

  /// @brief Method get_BasePath addr 0x2eba3a4 size 0x8 virtual false final false
  inline ::StringW get_BasePath();

  /// @brief Method set_BasePath addr 0x2eba3ac size 0x8 virtual false final false
