...
public:
  ...
  /// @brief Method .ctor, addr 0x4af3e6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4af3e74, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW basePath);

  /// @brief Method get_BasePath, addr 0x4af3e9c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_BasePath();

  /// @brief Method set_BasePath, addr 0x4af3ea4, size 0x8, virtual false, abstract: false, final false
