...
public:
  ...
  /// @brief Method .ctor, addr 0x6ce4c94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6ce4c9c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6ce4ca4, size 0x8, virtual false, abstract: false, final false
