...
public:
  ...
  /// @brief Method .ctor, addr 0x6c0950c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW format);

  /// @brief Method get_Format, addr 0x6c09514, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// @brief Method set_Format, addr 0x6c0951c, size 0x8, virtual false, abstract: false, final false
