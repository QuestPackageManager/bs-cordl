...
// Write type traits
MARK_REF_T(::JetBrains::Annotations::AspMvcAreaViewLocationFormatAttribute*);
DEFINE_IL2CPP_CLASS(::JetBrains::Annotations::AspMvcAreaViewLocationFormatAttribute*, "JetBrains.Annotations", "AspMvcAreaViewLocationFormatAttribute");
...
public:
  ...
  static inline ::JetBrains::Annotations::AspMvcAreaViewLocationFormatAttribute* New_ctor(/* [NotNull] */ ::StringW format);
  ...
  /// @brief Method .ctor, addr 0x6e3e098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(/* [NotNull] */ ::StringW format);

  /// [CompilerGenerated]
  /// @brief Method get_Format, addr 0x6e3e0a0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Format();

  /// [CompilerGenerated]
  /// @brief Method set_Format, addr 0x6e3e0a8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AspMvcAreaViewLocationFormatAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AspMvcAreaViewLocationFormatAttribute(AspMvcAreaViewLocationFormatAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AspMvcAreaViewLocationFormatAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AspMvcAreaViewLocationFormatAttribute(AspMvcAreaViewLocationFormatAttributeconst&) = delete;
...
static_assert(sizeof(::JetBrains::Annotations::AspMvcAreaViewLocationFormatAttribute) == 0x18, "Size mismatch!");
