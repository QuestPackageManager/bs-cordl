...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::NoEnumerationAttribute::*)()>(&::JetBrains::Annotations::NoEnumerationAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6894564;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::NoEnumerationAttribute*>());
}
// Ctor Parameters []
