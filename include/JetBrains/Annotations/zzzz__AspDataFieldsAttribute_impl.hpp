...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AspDataFieldsAttribute::*)()>(&::JetBrains::Annotations::AspDataFieldsAttribute::_ctor)> {
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::AspDataFieldsAttribute*>());
}
// Ctor Parameters []
