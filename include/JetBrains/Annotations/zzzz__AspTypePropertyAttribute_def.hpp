...
public:
  ...
  /// @brief Method .ctor, addr 0x6c72554, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool createConstructorReferences);

  /// @brief Method get_CreateConstructorReferences, addr 0x6c72544, size 0x8, virtual false, abstract: false, final false
  inline bool get_CreateConstructorReferences();

  /// @brief Method set_CreateConstructorReferences, addr 0x6c7254c, size 0x8, virtual false, abstract: false, final false
