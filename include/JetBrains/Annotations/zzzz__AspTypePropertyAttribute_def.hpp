...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3acd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool createConstructorReferences);

  /// @brief Method get_CreateConstructorReferences, addr 0x6e3acc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_CreateConstructorReferences();

  /// @brief Method set_CreateConstructorReferences, addr 0x6e3accc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::JetBrains::Annotations::AspTypePropertyAttribute) == 0x18, "Size mismatch!");
