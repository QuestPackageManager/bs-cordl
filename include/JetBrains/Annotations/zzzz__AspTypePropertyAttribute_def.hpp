...
/// @brief Field <CreateConstructorReferences>k__BackingField, offset 0x10, size 0x1 
 __declspec(property(get=__cordl_internal_get__CreateConstructorReferences_k__BackingField, put=__cordl_internal_set__CreateConstructorReferences_k__BackingField)) bool  _CreateConstructorReferences_k__BackingField;
...
/// @brief Method .ctor, addr 0x6c72c14, size 0x8, virtual false, abstract: false, final false
inline void _ctor(bool  createConstructorReferences) ;

/// @brief Method get_CreateConstructorReferences, addr 0x6c72c04, size 0x8, virtual false, abstract: false, final false
inline bool get_CreateConstructorReferences() ;

/// @brief Method set_CreateConstructorReferences, addr 0x6c72c0c, size 0x8, virtual false, abstract: false, final false
