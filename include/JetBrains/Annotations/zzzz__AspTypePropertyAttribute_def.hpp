...
public:
  ...
  /// @brief Method .ctor, addr 0x6c096d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(bool createConstructorReferences);

  /// @brief Method get_CreateConstructorReferences, addr 0x6c096c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_CreateConstructorReferences();

  /// @brief Method set_CreateConstructorReferences, addr 0x6c096c8, size 0x8, virtual false, abstract: false, final false
