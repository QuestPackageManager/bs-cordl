...
public:
  ...
  /// @brief Method .ctor, addr 0x30221bc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* baseType);

  /// @brief Method get_BaseType, addr 0x30221e4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_BaseType();

  /// @brief Method set_BaseType, addr 0x30221ec, size 0x8, virtual false, abstract: false, final false
