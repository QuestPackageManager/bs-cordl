...
public:
  ...
  /// @brief Method .ctor, addr 0x4af34e8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* baseType);

  /// @brief Method get_BaseType, addr 0x4af3510, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_BaseType();

  /// @brief Method set_BaseType, addr 0x4af3518, size 0x8, virtual false, abstract: false, final false
