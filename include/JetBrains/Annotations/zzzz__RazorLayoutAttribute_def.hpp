...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3e2f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::JetBrains::Annotations::RazorLayoutAttribute) == 0x10, "Size mismatch!");
