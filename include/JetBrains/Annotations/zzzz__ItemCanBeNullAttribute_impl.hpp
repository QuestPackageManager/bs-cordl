...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::ItemCanBeNullAttribute::*)()>(&::JetBrains::Annotations::ItemCanBeNullAttribute::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x6ce65d8;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::ItemCanBeNullAttribute*>());
}
// Ctor Parameters []
