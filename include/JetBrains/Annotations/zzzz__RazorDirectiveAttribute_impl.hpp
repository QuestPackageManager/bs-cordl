...
inline void JetBrains::Annotations::RazorDirectiveAttribute::_ctor(/* [NotNull] */ ::StringW directive) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::JetBrains::Annotations::RazorDirectiveAttribute*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
...
inline ::JetBrains::Annotations::RazorDirectiveAttribute* JetBrains::Annotations::RazorDirectiveAttribute::New_ctor(/* [NotNull] */ ::StringW directive) {
