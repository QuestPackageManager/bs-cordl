...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DateStringAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DateStringAttribute(DateStringAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DateStringAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DateStringAttribute(DateStringAttributeconst&) = delete;
