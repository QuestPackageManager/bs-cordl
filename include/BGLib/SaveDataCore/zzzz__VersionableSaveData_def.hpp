...
public:
  ...
  /// @brief Method .ctor, addr 0x1082c70, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isDirty, addr 0x1082c58, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method set_isDirty, addr 0x1082c64, size 0xc, virtual true, abstract: false, final false
