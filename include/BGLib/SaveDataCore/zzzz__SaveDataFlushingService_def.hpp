...
public:
  ...
  /// @brief Method MoveNext, addr 0x1081fcc, size 0x640, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1082618, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x1082670, size 0x590, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1082c00, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method FlushSaveFilesAsync, addr 0x1081c5c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Register, addr 0x1081bb4, size 0xa8, virtual false, abstract: false, final false
  inline void Register(::BGLib::SaveDataCore::ISaveDataHandler* handler);

  /// @brief Method ReleaseSaveBlocker, addr 0x1081eb4, size 0x58, virtual false, abstract: false, final false
  inline bool ReleaseSaveBlocker(::UnityEngine::Object* o);

  /// @brief Method ResetChangesAsync, addr 0x1081d5c, size 0x100, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* ResetChangesAsync();

  /// @brief Method TrackSaveBlocker, addr 0x1081e5c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1081f0c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
