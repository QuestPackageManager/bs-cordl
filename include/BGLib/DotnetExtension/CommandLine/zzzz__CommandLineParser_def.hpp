...
public:
  ...
  /// @brief Method <ParseArgs>b__7_1, addr 0x3311558, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _ParseArgs_b__7_1(::BGLib::DotnetExtension::CommandLine::ArgumentOption option);

  /// @brief Method .ctor, addr 0x3311554, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ParseArgs>b__0, addr 0x3311560, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33113e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddParsedOption, addr 0x33113e8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateHint, addr 0x3310e9c, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateOptionsMap, addr 0x330f9c8, size 0x828, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCommandLineArgs, addr 0x330f5e8, size 0x78, virtual false, abstract: false, final false
  static inline ::ArrayW<::StringW> GetCommandLineArgs();

  /// @brief Method ParseArgs, addr 0x331055c, size 0x934, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseCommandLine, addr 0x330f6a0, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseEnvironmentCommandLine, addr 0x330f660, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectRequiredOptions, addr 0x33101f0, size 0x36c, virtual false, abstract: false, final false
