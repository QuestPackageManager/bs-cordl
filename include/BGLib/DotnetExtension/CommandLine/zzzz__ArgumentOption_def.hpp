...
public:
  ...
  /// @brief Method ValidateArgumentValue, addr 0x22a04b4, size 0x240, virtual false, abstract: false, final false
  inline void ValidateArgumentValue(::StringW value);

  /// @brief Method .ctor, addr 0x22a0468, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_expectsValue, addr 0x22a048c, size 0x28, virtual false, abstract: false, final false
  inline bool get_expectsValue();

  /// @brief Method get_required, addr 0x22a0478, size 0x14, virtual false, abstract: false, final false
