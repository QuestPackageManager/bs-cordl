...
public:
  ...
  /// @brief Method ValidateArgumentValue, addr 0x107ca60, size 0x2ac, virtual false, abstract: false, final false
  inline void ValidateArgumentValue(::StringW value);

  /// @brief Method .ctor, addr 0x107ca14, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_expectsValue, addr 0x107ca38, size 0x28, virtual false, abstract: false, final false
  inline bool get_expectsValue();

  /// @brief Method get_required, addr 0x107ca24, size 0x14, virtual false, abstract: false, final false
