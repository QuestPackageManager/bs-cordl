...
public:
  ...
  /// @brief Method ToDestinationArguments, addr 0x3255da0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateArgumentValue, addr 0x3255b8c, size 0x214, virtual false, abstract: false, final false
  inline void ValidateArgumentValue(::StringW value);

  /// @brief Method .ctor, addr 0x3255b54, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_expectsValue, addr 0x3255b78, size 0x14, virtual false, abstract: false, final false
  inline bool get_expectsValue();

  /// @brief Method get_required, addr 0x3255b64, size 0x14, virtual false, abstract: false, final false
