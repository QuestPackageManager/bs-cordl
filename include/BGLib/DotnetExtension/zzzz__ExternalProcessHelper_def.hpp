...
public:
  // Declarations
  /// @brief Method GetProcessOutputLines, addr 0x3254200, size 0x458, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::StringW>* GetProcessOutputLines(::StringW path, ::StringW arguments);

  /// @brief Method StartBackgroundProcess, addr 0x325418c, size 0x74, virtual false, abstract: false, final false
