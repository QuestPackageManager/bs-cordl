...
public:
// Declarations
/// @brief Method GetProcessOutputLines, addr 0x3217db4, size 0x458, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetProcessOutputLines(::StringW  path, ::StringW  arguments) ;

/// @brief Method StartBackgroundProcess, addr 0x3217d40, size 0x74, virtual false, abstract: false, final false
