...
public:
  ...
  /// @brief Method Add, addr 0x3254efc, size 0x198, virtual true, abstract: false, final true
  inline void Add(::System::IDisposable* item);

  /// @brief Method Clear, addr 0x32551f4, size 0x10c, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method Contains, addr 0x3255300, size 0x114, virtual true, abstract: false, final true
  inline bool Contains(::System::IDisposable* item);

  /// @brief Method CopyTo, addr 0x3255414, size 0x1b8, virtual true, abstract: false, final true
  inline void CopyTo(::ArrayW<::System::IDisposable*, ::Array<::System::IDisposable*>*> array, int32_t arrayIndex);

  /// @brief Method Dispose, addr 0x32556fc, size 0x258, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetEnumerator, addr 0x32555cc, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method Remove, addr 0x3255094, size 0x160, virtual true, abstract: false, final true
  inline bool Remove(::System::IDisposable* item);

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x32556f8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3254b84, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3254c20, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x3254d14, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::System::IDisposable*, ::Array<::System::IDisposable*>*> checkers);

  /// @brief Method .ctor, addr 0x3254e08, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IEnumerable_1<::System::IDisposable*>* checkers);

  /// @brief Method get_Count, addr 0x3254a88, size 0xf4, virtual true, abstract: false, final true
  inline int32_t get_Count();

  /// @brief Method get_IsReadOnly, addr 0x3254b7c, size 0x8, virtual true, abstract: false, final true
