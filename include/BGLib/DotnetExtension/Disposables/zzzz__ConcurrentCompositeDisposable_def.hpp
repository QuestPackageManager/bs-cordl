...
/// @brief Method Add, addr 0x3218ab0, size 0x198, virtual true, abstract: false, final true
inline void Add(::System::IDisposable*  item) ;

/// @brief Method Clear, addr 0x3218da8, size 0x10c, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x3218eb4, size 0x114, virtual true, abstract: false, final true
inline bool Contains(::System::IDisposable*  item) ;

/// @brief Method CopyTo, addr 0x3218fc8, size 0x1b8, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::System::IDisposable*,::Array<::System::IDisposable*>*>  array, int32_t  arrayIndex) ;

/// @brief Method Dispose, addr 0x32192b0, size 0x258, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetEnumerator, addr 0x3219180, size 0x12c, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x3218c48, size 0x160, virtual true, abstract: false, final true
inline bool Remove(::System::IDisposable*  item) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x32192ac, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3218738, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x32187d4, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method .ctor, addr 0x32188c8, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::IDisposable*,::Array<::System::IDisposable*>*>  checkers) ;

/// @brief Method .ctor, addr 0x32189bc, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::System::IDisposable*>*  checkers) ;

/// @brief Method get_Count, addr 0x321863c, size 0xf4, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x3218730, size 0x8, virtual true, abstract: false, final true
