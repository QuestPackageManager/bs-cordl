...
public:
  ...
  /// @brief Method Dispose, addr 0x3310d58, size 0xac, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x3310e04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disposable, addr 0x3310c9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::IDisposable* get_disposable();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_disposable, addr 0x3310ca4, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::DotnetExtension::Disposables::SingleDisposable) == 0x18, "Size mismatch!");
