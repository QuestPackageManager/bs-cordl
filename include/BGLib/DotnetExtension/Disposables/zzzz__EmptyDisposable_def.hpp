...
/// @brief Method Dispose, addr 0x3219544, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::BGLib::DotnetExtension::Disposables::EmptyDisposable* New_ctor() ;

/// @brief Method .ctor, addr 0x3219540, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
