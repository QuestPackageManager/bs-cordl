...
// Write type traits
MARK_REF_T(::BGLib::DotnetExtension::Disposables::EmptyDisposable*);
DEFINE_IL2CPP_CLASS(::BGLib::DotnetExtension::Disposables::EmptyDisposable*, "BGLib.DotnetExtension.Disposables", "EmptyDisposable");
...
public:
  ...
  /// @brief Method Dispose, addr 0x3310c44, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::BGLib::DotnetExtension::Disposables::EmptyDisposable* New_ctor();

  /// @brief Method .ctor, addr 0x3310c40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EmptyDisposable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EmptyDisposable(EmptyDisposable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EmptyDisposable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EmptyDisposable(EmptyDisposableconst&) = delete;
...
static_assert(sizeof(::BGLib::DotnetExtension::Disposables::EmptyDisposable) == 0x10, "Size mismatch!");
