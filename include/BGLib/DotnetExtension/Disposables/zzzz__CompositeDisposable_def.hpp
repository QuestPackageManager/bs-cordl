...
public:
  ...
  /// @brief Method Add, addr 0x325483c, size 0xe4, virtual false, abstract: false, final false
  inline void Add(::ArrayW<::System::IDisposable*, ::Array<::System::IDisposable*>*> disposables);

  /// @brief Method Add, addr 0x325473c, size 0x100, virtual false, abstract: false, final false
  inline void Add(::System::IDisposable* item);

  /// @brief Method Dispose, addr 0x3254920, size 0x168, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x3254658, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(int32_t capacity);

  /// @brief Method .ctor, addr 0x32546dc, size 0x60, virtual false, abstract: false, final false
