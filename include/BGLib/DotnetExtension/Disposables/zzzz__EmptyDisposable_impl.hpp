...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::DotnetExtension::Disposables::EmptyDisposable::*)()>(&::BGLib::DotnetExtension::Disposables::EmptyDisposable::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3256728;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::DotnetExtension::Disposables::EmptyDisposable::*)()>(&::BGLib::DotnetExtension::Disposables::EmptyDisposable::Dispose)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x325672c;
...
::cordl_internals::setStaticField<::BGLib::DotnetExtension::Disposables::EmptyDisposable*, "disposable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::DotnetExtension::Disposables::EmptyDisposable*>::get>(std::forward<::BGLib::DotnetExtension::Disposables::EmptyDisposable*>(value));
}
...
return ::cordl_internals::getStaticField<::BGLib::DotnetExtension::Disposables::EmptyDisposable*, "disposable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::DotnetExtension::Disposables::EmptyDisposable*>::get>();
}
