...
public:
  // Declarations
  /// @brief Method GetDirectoryPath, addr 0xf8357c, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW GetDirectoryPath(::StringW variableName);

  /// @brief Method SetDirectoryPath, addr 0xf8362c, size 0x12c, virtual false, abstract: false, final false
