...
public:
  // Declarations
  /// @brief Method GetDirectoryPath, addr 0x22a1b4c, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW GetDirectoryPath(::StringW variableName);

  /// @brief Method SetDirectoryPath, addr 0x22a1bf4, size 0x120, virtual false, abstract: false, final false
