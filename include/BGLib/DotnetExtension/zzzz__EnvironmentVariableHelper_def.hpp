...
public:
  // Declarations
  /// @brief Method GetDirectoryPath, addr 0x3217c2c, size 0xa4, virtual false, abstract: false, final false
  static inline ::StringW GetDirectoryPath(::StringW variableName);

  /// @brief Method SetDirectoryPath, addr 0x3217cd0, size 0x120, virtual false, abstract: false, final false
