...
public:
// Declarations
/// @brief Method GetTargetName, addr 0x322efdc, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x322efd8, size 0x4, virtual false, abstract: false, final false
