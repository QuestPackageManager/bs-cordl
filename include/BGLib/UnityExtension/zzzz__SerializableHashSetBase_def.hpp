...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::SerializableHashSetBase*);
MARK_GEN_REF_T_PTR(::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1);
MARK_REF_T(::BGLib::UnityExtension::SerializableHashSetBase_Storage*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::SerializableHashSetBase*, "BGLib.UnityExtension", "SerializableHashSetBase");
DEFINE_IL2CPP_GEN_CLASS_PTR(::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1, "BGLib.UnityExtension", "SerializableHashSetBase/HashSet`1");
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::SerializableHashSetBase_Storage*, "BGLib.UnityExtension", "SerializableHashSetBase/Storage");
...
public:
  ...
  /// @brief Method .ctor, addr 0x332aa10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::BGLib::UnityExtension::SerializableHashSetBase_Storage) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x332aa0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::BGLib::UnityExtension::SerializableHashSetBase) == 0x10, "Size mismatch!");
