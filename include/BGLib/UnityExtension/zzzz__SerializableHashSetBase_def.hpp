...
class SerializableHashSetBase_HashSet_1;
}
namespace BGLib::UnityExtension {
...
/// @brief Method .ctor, addr 0x322ef5c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1<TValue>* New_ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;
...
// Declarations
template<typename TValue>
using HashSet_1 = ::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1<TValue>;
...
/// @brief Method .ctor, addr 0x322ef58, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
