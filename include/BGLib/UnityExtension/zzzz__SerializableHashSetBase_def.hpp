...
public:
  ...
  /// @brief Method .ctor, addr 0x326b434, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x326b430, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
