...
public:
  ...
  /// @brief Method GetTargetName, addr 0x22b7600, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b75d0, size 0x30, virtual false, abstract: false, final false
