...
public:
  ...
  /// @brief Method GetTargetName, addr 0x22b75c0, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b7590, size 0x30, virtual false, abstract: false, final false
