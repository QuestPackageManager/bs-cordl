...
/// @brief Method GetTargetName, addr 0x322f084, size 0xe0, virtual true, abstract: false, final false
inline ::StringW GetTargetName() ;

static inline ::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute* New_ctor(::StringW  propertyName, ::StringW  nestedPropertyName, ::StringW  nameFilter, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType  filterPropType) ;
...
/// @brief Method .ctor, addr 0x322f054, size 0x30, virtual false, abstract: false, final false
