...
public:
  ...
  /// @brief Method GetTargetName, addr 0x326b55c, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326b52c, size 0x30, virtual false, abstract: false, final false
