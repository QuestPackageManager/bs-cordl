...
public:
  ...
  /// @brief Method GetTargetName, addr 0x33287b0, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3328780, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyIDFromPropertyAttribute) == 0x30, "Size mismatch!");
