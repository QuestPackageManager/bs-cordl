...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::UnityExtension::InfoBoxAttribute::*)(::StringW, ::BGLib::UnityExtension::InfoBoxAttribute_Type)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::InfoBoxAttribute*>(),
                                                             { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::BGLib::UnityExtension::InfoBoxAttribute_Type>() } })));
...
inline void BGLib::UnityExtension::InfoBoxAttribute::_ctor(::StringW info, ::BGLib::UnityExtension::InfoBoxAttribute_Type messageType) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::InfoBoxAttribute*>(),
                                                           { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::BGLib::UnityExtension::InfoBoxAttribute_Type>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, info, messageType);
}
inline ::BGLib::UnityExtension::InfoBoxAttribute* BGLib::UnityExtension::InfoBoxAttribute::New_ctor(::StringW info, ::BGLib::UnityExtension::InfoBoxAttribute_Type messageType) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::InfoBoxAttribute*>(info, messageType));
}
// Ctor Parameters []
