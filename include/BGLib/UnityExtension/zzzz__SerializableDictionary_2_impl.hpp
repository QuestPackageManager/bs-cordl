...
constexpr ::System::Collections::Generic::List_1<TKey>* const& BGLib::UnityExtension::SerializableDictionary_2<TKey, TValue>::__cordl_internal_get_keys() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___keys;
}
...
template <typename TKey, typename TValue>
constexpr ::System::Collections::Generic::List_1<TValue>* const& BGLib::UnityExtension::SerializableDictionary_2<TKey, TValue>::__cordl_internal_get_values() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___values;
}
template <typename TKey, typename TValue>
