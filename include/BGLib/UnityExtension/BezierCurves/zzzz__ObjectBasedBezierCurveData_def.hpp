...
/// @brief Method .ctor, addr 0x3230c34, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_endPoint, addr 0x3230c1c, size 0x18, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 get_endPoint() ;

/// @brief Method get_hasReferences, addr 0x32309a0, size 0x9c, virtual false, abstract: false, final false
inline bool get_hasReferences() ;

/// @brief Method get_startPoint, addr 0x3230c04, size 0x18, virtual true, abstract: false, final false
