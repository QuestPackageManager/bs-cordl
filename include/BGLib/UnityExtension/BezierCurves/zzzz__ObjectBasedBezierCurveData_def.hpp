...
public:
  ...
  /// @brief Method .ctor, addr 0x22b7f44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endPoint, addr 0x22b7f28, size 0x1c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_endPoint();

  /// @brief Method get_hasReferences, addr 0x22b7ca8, size 0x98, virtual false, abstract: false, final false
  inline bool get_hasReferences();

  /// @brief Method get_startPoint, addr 0x22b7f0c, size 0x1c, virtual true, abstract: false, final false
