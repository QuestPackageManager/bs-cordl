...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData*, "BGLib.UnityExtension.BezierCurves", "ObjectBasedBezierCurveData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x332a360, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endPoint, addr 0x332a348, size 0x18, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_endPoint();

  /// @brief Method get_hasReferences, addr 0x332a0cc, size 0x9c, virtual false, abstract: false, final false
  inline bool get_hasReferences();

  /// @brief Method get_startPoint, addr 0x332a330, size 0x18, virtual true, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::ObjectBasedBezierCurveData) == 0x38, "Size mismatch!");
