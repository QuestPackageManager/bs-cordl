...
public:
  ...
  /// @brief Method Evaluate, addr 0x22b6de4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b6efc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
