...
public:
  ...
  /// @brief Method Evaluate, addr 0x22bc518, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22bc630, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
