...
public:
  ...
  /// @brief Method Evaluate, addr 0x2277a8c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2277ba4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
