...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::BaseBezierCurve*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::BaseBezierCurve*, "BGLib.UnityExtension.BezierCurves", "BaseBezierCurve");
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::BaseBezierCurve) == 0x20, "Size mismatch!");
