...
public:
  ...
  /// @brief Method Evaluate, addr 0x22b81a8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b82c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
