...
public:
  ...
  /// @brief Method Evaluate, addr 0x326bee8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326bff4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
