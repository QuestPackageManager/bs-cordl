...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectBasedBezierCurve", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectBasedBezierCurve(ObjectBasedBezierCurve&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectBasedBezierCurve", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectBasedBezierCurve(ObjectBasedBezierCurveconst&) = delete;
