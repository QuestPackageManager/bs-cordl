...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::GenericBezierCurve*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::GenericBezierCurve*, "BGLib.UnityExtension.BezierCurves", "GenericBezierCurve");
...
public:
  ...
  /// @brief Method GetBezierCurveData, addr 0x332bd00, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBezierCurveData, addr 0x332bec4, size 0x1b0, virtual true, abstract: false, final false
  inline void SetBezierCurveData(::BGLib::UnityExtension::BezierCurves::CurveData newValue);

  /// @brief Method .ctor, addr 0x332c074, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x332bcf8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GenericBezierCurve", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GenericBezierCurve(GenericBezierCurve&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GenericBezierCurve", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GenericBezierCurve(GenericBezierCurveconst&) = delete;
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::GenericBezierCurve) == 0x28, "Size mismatch!");
