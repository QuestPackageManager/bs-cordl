...
public:
  ...
  /// @brief Method GetBezierCurveData, addr 0x22b8964, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBezierCurveData, addr 0x22b8b28, size 0x1bc, virtual true, abstract: false, final false
  inline void SetBezierCurveData(::BGLib::UnityExtension::BezierCurves::CurveData newValue);

  /// @brief Method .ctor, addr 0x22b8ce4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x22b895c, size 0x8, virtual true, abstract: false, final false
