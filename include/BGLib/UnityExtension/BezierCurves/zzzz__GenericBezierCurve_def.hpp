...
public:
  ...
  /// @brief Method GetBezierCurveData, addr 0x31ff8d0, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBezierCurveData, addr 0x31ffa94, size 0x1b0, virtual true, abstract: false, final false
  inline void SetBezierCurveData(::BGLib::UnityExtension::BezierCurves::CurveData newValue);

  /// @brief Method .ctor, addr 0x31ffc44, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x31ff8c8, size 0x8, virtual true, abstract: false, final false
