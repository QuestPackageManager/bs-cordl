...
public:
  ...
  /// @brief Method GetBezierCurveData, addr 0x32302fc, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetBezierCurveData, addr 0x32304c0, size 0x1b0, virtual true, abstract: false, final false
  inline void SetBezierCurveData(::BGLib::UnityExtension::BezierCurves::CurveData newValue);

  /// @brief Method .ctor, addr 0x3230670, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x32302f4, size 0x8, virtual true, abstract: false, final false
