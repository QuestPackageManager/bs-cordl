...
public:
  // Declarations
  /// @brief Method Evaluate, addr 0x22b81f4, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 Evaluate(float_t t);

  /// @brief Method RotatePointAroundPivot, addr 0x22b8950, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method RotatePointsAroundPivot, addr 0x22b8814, size 0x13c, virtual false, abstract: false, final false
