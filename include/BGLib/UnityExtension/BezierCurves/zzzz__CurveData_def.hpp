...
public:
  // Declarations
  /// @brief Method Evaluate, addr 0x3329178, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 Evaluate(float_t t);

  /// @brief Method RotatePointAroundPivot, addr 0x3329920, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method RotatePointsAroundPivot, addr 0x332979c, size 0x184, virtual false, abstract: false, final false
