...
public:
// Declarations
/// @brief Method Evaluate, addr 0x322fa4c, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 Evaluate(float_t  t) ;

/// @brief Method RotatePointAroundPivot, addr 0x32301f4, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method RotatePointsAroundPivot, addr 0x3230070, size 0x184, virtual false, abstract: false, final false
