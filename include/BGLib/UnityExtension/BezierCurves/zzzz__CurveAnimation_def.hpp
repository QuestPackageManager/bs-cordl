...
namespace BGLib::UnityExtension::BezierCurves {
template <typename T> class __CurveAnimation__CurveEvent_1;
}
namespace BGLib::UnityExtension::BezierCurves {
...
public:
  ...
  /// @brief Method .ctor, addr 0x2277f40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2277f4c, size 0x164, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BGLib::UnityExtension::BezierCurves::__CurveAnimation___Animate_d__17* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x22780b0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x22780b8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x22780f0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2277f48, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2277e28, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  template <typename T> using CurveEvent_1 = ::BGLib::UnityExtension::BezierCurves::__CurveAnimation__CurveEvent_1<T>;
  ...
  __declspec(property(get = __cordl_internal_get_onIterate,
                      put = __cordl_internal_set_onIterate)) ::BGLib::UnityExtension::BezierCurves::__CurveAnimation__CurveEvent_1<::UnityEngine::Vector3>* onIterate;
  ...
  /// @brief Method Animate, addr 0x2277db4, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Animate(bool withDelay);

  /// @brief Method Animate, addr 0x2277e50, size 0xb4, virtual false, abstract: false, final false
  inline void Animate(float_t t);

  /// @brief Method Awake, addr 0x2277d6c, size 0x14, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::BGLib::UnityExtension::BezierCurves::CurveAnimation* New_ctor();

  /// @brief Method StartAnimation, addr 0x2277d80, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2277f04, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isPlaying, addr 0x2277d58, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPlaying();

  /// @brief Method set_isPlaying, addr 0x2277d60, size 0xc, virtual false, abstract: false, final false
