...
public:
  ...
  /// @brief Method .ctor, addr 0x326c374, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x326c380, size 0x180, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::BGLib::UnityExtension::BezierCurves::CurveAnimation__Animate_d__20* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x326c500, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x326c508, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x326c540, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x326c37c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326c334, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Animate, addr 0x326c2cc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Animate(bool withDelay);

  /// @brief Method Animate, addr 0x326c1e0, size 0xa8, virtual false, abstract: false, final false
  inline void Animate(float_t t);

  /// @brief Method Awake, addr 0x326c288, size 0x14, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LateUpdate, addr 0x326c1c8, size 0x18, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::BGLib::UnityExtension::BezierCurves::CurveAnimation* New_ctor();

  /// @brief Method StartAnimation, addr 0x326c29c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326c33c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isPlaying, addr 0x326c1b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isPlaying();

  /// @brief Method set_isPlaying, addr 0x326c1c0, size 0x8, virtual false, abstract: false, final false
