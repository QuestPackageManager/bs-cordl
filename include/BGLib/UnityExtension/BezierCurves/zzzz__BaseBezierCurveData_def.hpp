...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::BezierCurves::BaseBezierCurveData*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::BezierCurves::BaseBezierCurveData*, "BGLib.UnityExtension.BezierCurves", "BaseBezierCurveData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3329344, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endControlPoint, addr 0x33292c8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_startControlPoint, addr 0x332924c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method set_endControlPoint, addr 0x33292f8, size 0x4c, virtual false, abstract: false, final false
  inline void set_endControlPoint(::UnityEngine::Vector3 value);

  /// @brief Method set_startControlPoint, addr 0x332927c, size 0x4c, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::BezierCurves::BaseBezierCurveData) == 0x28, "Size mismatch!");
