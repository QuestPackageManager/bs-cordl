...
public:
  ...
  /// @brief Method .ctor, addr 0x22b8370, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endControlPoint, addr 0x22b82f4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_startControlPoint, addr 0x22b8278, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method set_endControlPoint, addr 0x22b8324, size 0x4c, virtual false, abstract: false, final false
  inline void set_endControlPoint(::UnityEngine::Vector3 value);

  /// @brief Method set_startControlPoint, addr 0x22b82a8, size 0x4c, virtual false, abstract: false, final false
