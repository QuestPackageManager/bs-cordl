...
public:
  ...
  /// @brief Method .ctor, addr 0x326c0f0, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_endControlPoint, addr 0x326c074, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_startControlPoint, addr 0x326bff8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method set_endControlPoint, addr 0x326c0a4, size 0x4c, virtual false, abstract: false, final false
  inline void set_endControlPoint(::UnityEngine::Vector3 value);

  /// @brief Method set_startControlPoint, addr 0x326c028, size 0x4c, virtual false, abstract: false, final false
