...
public:
  ...
  /// @brief Method GetTargetName, addr 0x22b5238, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b520c, size 0x2c, virtual false, abstract: false, final false
