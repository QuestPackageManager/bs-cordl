...
public:
  ...
  /// @brief Method GetTargetName, addr 0x326b524, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326b4f8, size 0x2c, virtual false, abstract: false, final false
