...
public:
  ...
  /// @brief Method GetTargetName, addr 0x322f0fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322f0d0, size 0x2c, virtual false, abstract: false, final false
