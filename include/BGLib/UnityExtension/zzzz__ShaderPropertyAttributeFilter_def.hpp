...
MARK_REF_T(::BGLib::UnityExtension::ShaderPropertyAttributeFilter*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType, "BGLib.UnityExtension", "ShaderPropertyAttributeFilter/PropType");
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::ShaderPropertyAttributeFilter*, "BGLib.UnityExtension", "ShaderPropertyAttributeFilter");
// Dependencies
namespace BGLib::UnityExtension {
// Is value type: true
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x332868c, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::ShaderPropertyAttributeFilter) == 0x20, "Size mismatch!");
