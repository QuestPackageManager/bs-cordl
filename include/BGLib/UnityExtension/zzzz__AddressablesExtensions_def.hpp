...
template<typename T>
class AddressablesExtensions___c__DisplayClass3_0_1;
}
...
// Declarations
template<typename T>
using __c__DisplayClass3_0_1 = ::BGLib::UnityExtension::AddressablesExtensions___c__DisplayClass3_0_1<T>;
...
template<typename T>
static inline ::System::Threading::Tasks::Task_1<::System::Collections::Generic::IList_1<T>*>* LoadContentAsync(::UnityEngine::AddressableAssets::IKeyEvaluator*  label) ;
