...
template<typename T>
class AddressablesExtensions___c__DisplayClass4_0_1;
}
...
MARK_GEN_REF_PTR_T(::BGLib::UnityExtension::AddressablesExtensions___c__DisplayClass4_0_1);
// Dependencies System.Object, UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1<TObject>
namespace BGLib::UnityExtension {
// cpp template
template<typename T>
// Is value type: false
// CS Name: BGLib.UnityExtension.AddressablesExtensions/<>c__DisplayClass4_0`1<T>
class CORDL_TYPE AddressablesExtensions___c__DisplayClass4_0_1 : public ::System::Object {
public:
// Declarations
/// @brief Field asyncOperationHandle, offset 0x10, size 0x18 
 __declspec(property(get=__cordl_internal_get_asyncOperationHandle, put=__cordl_internal_set_asyncOperationHandle)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>  asyncOperationHandle;
...
static inline ::BGLib::UnityExtension::AddressablesExtensions___c__DisplayClass4_0_1<T>* New_ctor() ;

/// @brief Method <GetAwaiter>g__OnCompleted|0, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _GetAwaiter_g__OnCompleted_0(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>  handle) ;
...
// Declarations
template<typename T>
using __c__DisplayClass4_0_1 = ::BGLib::UnityExtension::AddressablesExtensions___c__DisplayClass4_0_1<T>;

/// @brief Method CompleteTaskSource, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void CompleteTaskSource(::System::Threading::Tasks::TaskCompletionSource_1<T>*  taskSource, ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>  handle) ;

/// @brief Method GetAssetLoadingAsyncOperationHandleOrNull, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Nullable_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<T>*>> GetAssetLoadingAsyncOperationHandleOrNull(::StringW  runtimeKey) ;
...
template<typename T>
static inline ::System::Collections::Generic::IList_1<T>* LoadContent(::System::Object*  label) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::BGLib::UnityExtension::AddressablesExtensions___c__DisplayClass4_0_1, "BGLib.UnityExtension", "AddressablesExtensions/<>c__DisplayClass4_0`1");
