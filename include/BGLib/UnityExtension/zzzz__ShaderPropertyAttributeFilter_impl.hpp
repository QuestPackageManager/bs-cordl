...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::BGLib::UnityExtension::ShaderPropertyAttributeFilter::*)(::StringW, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType)>(
  ...
  constexpr static std::size_t addrs = 0x332868c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyAttributeFilter*>(),
...
inline void BGLib::UnityExtension::ShaderPropertyAttributeFilter::_ctor(::StringW nameFilter, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType propType) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::BGLib::UnityExtension::ShaderPropertyAttributeFilter*>(),
                                                           { ".ctor", {}, { ::i2c::type_of<::StringW>(), ::i2c::type_of<::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, nameFilter, propType);
}
...
BGLib::UnityExtension::ShaderPropertyAttributeFilter::New_ctor(::StringW nameFilter, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType propType) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::BGLib::UnityExtension::ShaderPropertyAttributeFilter*>(nameFilter, propType));
}
// Ctor Parameters []
