...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::UnityExtension::ShaderPropertyAttributeFilter::*)(::StringW, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType)>(&::BGLib::UnityExtension::ShaderPropertyAttributeFilter::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x322ef60;
...
inline ::BGLib::UnityExtension::ShaderPropertyAttributeFilter* BGLib::UnityExtension::ShaderPropertyAttributeFilter::New_ctor(::StringW  nameFilter, ::BGLib::UnityExtension::ShaderPropertyAttributeFilter_PropType  propType)  {
