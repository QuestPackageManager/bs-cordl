...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_keys, put = __cordl_internal_set_m_keys)) ::ArrayW<TKey> m_keys;

  /// @brief Field m_values, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_m_values, put = __cordl_internal_set_m_values)) ::ArrayW<TValueStorage> m_values;
  ...
  constexpr ::ArrayW<TKey> const& __cordl_internal_get_m_keys() const;

  constexpr ::ArrayW<TKey>& __cordl_internal_get_m_keys();

  constexpr ::ArrayW<TValueStorage> const& __cordl_internal_get_m_values() const;

  constexpr ::ArrayW<TValueStorage>& __cordl_internal_get_m_values();
  ...
  constexpr void __cordl_internal_set_m_keys(::ArrayW<TKey> value);

  constexpr void __cordl_internal_set_m_values(::ArrayW<TValueStorage> value);
