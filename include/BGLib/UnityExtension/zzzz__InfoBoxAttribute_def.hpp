...
MARK_REF_T(::BGLib::UnityExtension::InfoBoxAttribute*);
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::InfoBoxAttribute_Type, "BGLib.UnityExtension", "InfoBoxAttribute/Type");
DEFINE_IL2CPP_CLASS(::BGLib::UnityExtension::InfoBoxAttribute*, "BGLib.UnityExtension", "InfoBoxAttribute");
// Dependencies
namespace BGLib::UnityExtension {
// Is value type: true
...
public:
  ...
  /// @brief Method .ctor, addr 0x3328f08, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::BGLib::UnityExtension::InfoBoxAttribute) == 0x28, "Size mismatch!");
