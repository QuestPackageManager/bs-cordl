...
public:
  ...
  /// @brief Method MoveNext, addr 0x22b7128, size 0x714, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22b79c8, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ExistsAsync, addr 0x22b7034, size 0xf4, virtual false, abstract: false, final false
