...
public:
  ...
  /// @brief Method .ctor, addr 0x326b42c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x326b428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
