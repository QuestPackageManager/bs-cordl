...
/// @brief Method .ctor, addr 0x322ef54, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey,TValue>* New_ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;
...
// Declarations
template<typename TKey,typename TValue>
using Dictionary_2 = ::BGLib::UnityExtension::SerializableDictionaryBase_Dictionary_2<TKey, TValue>;
...
/// @brief Method .ctor, addr 0x322ef50, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
