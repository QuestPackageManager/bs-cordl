...
// Write type traits
MARK_REF_T(::BGLib::UnityExtension::UnityWebRequestExtensions*);
MARK_REF_T(::BGLib::UnityExtension::UnityWebRequestExtensions___c__DisplayClass1_0*);
...
public:
  ...
  /// @brief Method <GetAwaiter>g__SetResult|0, addr 0x3328988, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3328984, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3328a60, size 0x65c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x33290bc, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetAwaiter, addr 0x3326960, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SendWebRequestAsync, addr 0x3328890, size 0xf4, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::BGLib::UnityExtension::UnityWebRequestExtensions) == 0x10, "Size mismatch!");
