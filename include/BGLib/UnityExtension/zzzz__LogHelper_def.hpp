...
public:
  // Declarations
  /// @brief Method LogBuildOnly, addr 0x22b393c, size 0x58, virtual false, abstract: false, final false
  static inline void LogBuildOnly(::StringW message);

  /// @brief Method LogBuildOnly, addr 0x22b3994, size 0x68, virtual false, abstract: false, final false
