...
public:
  // Declarations
  /// @brief Method LogBuildOnly, addr 0x326b360, size 0x5c, virtual false, abstract: false, final false
  static inline void LogBuildOnly(::StringW message);

  /// @brief Method LogBuildOnly, addr 0x326b3bc, size 0x6c, virtual false, abstract: false, final false
