...
public:
  // Declarations
  /// @brief Method LogBuildOnly, addr 0x22bb7ac, size 0x58, virtual false, abstract: false, final false
  static inline void LogBuildOnly(::StringW message);

  /// @brief Method LogBuildOnly, addr 0x22bb804, size 0x68, virtual false, abstract: false, final false
