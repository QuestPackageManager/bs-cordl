...
// Write type traits
MARK_GEN_REF_T_PTR(::BGLib::UnityExtension::SerializableHashSet_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::BGLib::UnityExtension::SerializableHashSet_1, "BGLib.UnityExtension", "SerializableHashSet`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_keys, put = __cordl_internal_set_m_keys)) ::ArrayW<T> m_keys;
  ...
  constexpr ::ArrayW<T> const& __cordl_internal_get_m_keys() const;

  constexpr ::ArrayW<T>& __cordl_internal_get_m_keys();

  constexpr void __cordl_internal_set_m_hashSet(::BGLib::UnityExtension::SerializableHashSetBase_HashSet_1<T>* value);

  constexpr void __cordl_internal_set_m_keys(::ArrayW<T> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SerializableHashSet_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SerializableHashSet_1(SerializableHashSet_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SerializableHashSet_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SerializableHashSet_1(SerializableHashSet_1const&) = delete;
