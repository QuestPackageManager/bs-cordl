...
namespace BGLib::MetaRemoteAssets {
struct __MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9;
}
namespace BGLib::MetaRemoteAssets {
...
MARK_VAL_T(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9);
// Type: ::<>c
...
public:
  ...
  static __declspec(property(get = getStaticF___9__8_0, put = setStaticF___9__8_0))::System::Func_2<::UnityW<::GlobalNamespace::SceneInfo>, bool>* __9__8_0;

  static inline ::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater____c* New_ctor();

  /// @brief Method <HandleGameSceneChanged>b__8_0, addr 0x1089480, size 0x54, virtual false, abstract: false, final false
  inline bool _HandleGameSceneChanged_b__8_0(::GlobalNamespace::SceneInfo* info);

  /// @brief Method .ctor, addr 0x1089478, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater____c* getStaticF___9();

  static inline ::System::Func_2<::UnityW<::GlobalNamespace::SceneInfo>, bool>* getStaticF___9__8_0();

  static inline void setStaticF___9(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater____c* value);

  static inline void setStaticF___9__8_0(::System::Func_2<::UnityW<::GlobalNamespace::SceneInfo>, bool>* value);
...
// Type: ::<CheckForCatalogUpdateWithInterval>d__9
// SizeInfo { instance_size: 64, native_size: -1, calculated_instance_size: 64, calculated_native_size: 80, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace BGLib::MetaRemoteAssets {
// Is value type: true
// CS Name: ::MetaRemoteAssetsCatalogUpdater::<CheckForCatalogUpdateWithInterval>d__9
struct CORDL_TYPE __MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext, addr 0x10894d4, size 0x478, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x1089b20, size 0xc, virtual true, abstract: false, final true
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9();
  ...
  // def_value: None }]
  constexpr __MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder,
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, 0x40>, "Size mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, cancellationToken) == 0x28, "Offset mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, __u__1) == 0x30, "Offset mismatch!");

static_assert(offsetof(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, __u__2) == 0x38, "Offset mismatch!");
...
public:
  // Declarations
  using _CheckForCatalogUpdateWithInterval_d__9 = ::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9;
  ...
  /// @brief Method CheckForCatalogUpdateWithInterval, addr 0x1089184, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleGameSceneChanged, addr 0x108925c, size 0x1b8, virtual false, abstract: false, final false
  inline void HandleGameSceneChanged(::GlobalNamespace::ScenesTransitionSetupDataSO* transitionSetupDataSo, ::Zenject::DiContainer* container);

  /// @brief Method Initialize, addr 0x1089094, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1089014, size 0x80, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__9, "BGLib.MetaRemoteAssets",
                       "MetaRemoteAssetsCatalogUpdater/<CheckForCatalogUpdateWithInterval>d__9");
