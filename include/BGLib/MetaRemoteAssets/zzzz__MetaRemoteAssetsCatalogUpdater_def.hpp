...
/// @brief Method <HandleGameSceneChanged>b__9_0, addr 0x321f9a0, size 0x4c, virtual false, abstract: false, final false
inline bool _HandleGameSceneChanged_b__9_0(::StringW  sceneName) ;

/// @brief Method .ctor, addr 0x321f99c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x321f9ec, size 0x540, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x32200cc, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr MetaRemoteAssetsCatalogUpdater__CheckForCatalogUpdateWithInterval_d__10(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater*  __4__this, ::System::Threading::CancellationToken  cancellationToken, ::System::Runtime::CompilerServices::TaskAwaiter_1<bool>  __u__1, ::System::Runtime::CompilerServices::TaskAwaiter  __u__2) noexcept;
...
/// @brief Field _checkForCatalogUpdateOngoingTask, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__checkForCatalogUpdateOngoingTask, put=__cordl_internal_set__checkForCatalogUpdateOngoingTask)) ::System::Threading::Tasks::Task*  _checkForCatalogUpdateOngoingTask;
...
/// @brief Method CheckForCatalogUpdateWithInterval, addr 0x321f684, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x321f744, size 0x28, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleGameSceneChanged, addr 0x321f76c, size 0x1dc, virtual false, abstract: false, final false
inline void HandleGameSceneChanged(::GlobalNamespace::GameScenesManager_SceneTransitionType  sceneTransitionType, ::GlobalNamespace::ScenesTransitionSetupDataSO*  transitionSetupDataSo, ::Zenject::DiContainer*  container) ;

/// @brief Method Initialize, addr 0x321f558, size 0x12c, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater* New_ctor(::BGLib::MetaRemoteAssets::MetaRemoteAssetsManager*  remoteAssetsManager, ::GlobalNamespace::GameScenesManager*  scenesManager) ;
...
/// @brief Method .ctor, addr 0x321f4dc, size 0x7c, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BGLib::MetaRemoteAssets::MetaRemoteAssetsCatalogUpdater__CheckForCatalogUpdateWithInterval_d__10, "BGLib.MetaRemoteAssets", "MetaRemoteAssetsCatalogUpdater/<CheckForCatalogUpdateWithInterval>d__10");
