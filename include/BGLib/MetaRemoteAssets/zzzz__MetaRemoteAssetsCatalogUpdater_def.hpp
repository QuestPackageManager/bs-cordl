...
public:
  ...
  /// @brief Method <HandleGameSceneChanged>b__9_0, addr 0x22a5284, size 0x54, virtual false, abstract: false, final false
  inline bool _HandleGameSceneChanged_b__9_0(::GlobalNamespace::SceneInfo* info);

  /// @brief Method .ctor, addr 0x22a527c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22a52d8, size 0x510, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22a59ac, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CheckForCatalogUpdateWithInterval, addr 0x22a4f80, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x22a5050, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleGameSceneChanged, addr 0x22a506c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x22a4e98, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22a4e20, size 0x78, virtual false, abstract: false, final false
