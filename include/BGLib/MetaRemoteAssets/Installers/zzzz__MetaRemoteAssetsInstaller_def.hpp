...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetaRemoteAssetsInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetaRemoteAssetsInstaller(MetaRemoteAssetsInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetaRemoteAssetsInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetaRemoteAssetsInstaller(MetaRemoteAssetsInstallerconst&) = delete;
