...
public:
  ...
  /// @brief Method InstallBindings, addr 0x22aa410, size 0x168, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallRemoteCatalogLoader, addr 0x22aa578, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22aa600, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
