...
public:
  ...
  /// @brief Method GetPlatform, addr 0x325f9a0, size 0x44, virtual false, abstract: false, final false
  static inline ::StringW GetPlatform();

  /// @brief Method InstallBindings, addr 0x325f7e4, size 0x1bc, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallRemoteCatalogLoader, addr 0x325f9e4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325fa90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
