...
public:
  ...
  /// @brief Method InstallBindings, addr 0x22ab684, size 0x168, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method InstallRemoteCatalogLoader, addr 0x22ab7ec, size 0x88, virtual false, abstract: false, final false
