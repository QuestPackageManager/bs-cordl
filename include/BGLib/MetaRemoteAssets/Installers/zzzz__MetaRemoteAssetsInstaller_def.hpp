...
/// @brief Method GetPlatform, addr 0x326073c, size 0x44, virtual false, abstract: false, final false
static inline ::StringW GetPlatform() ;

/// @brief Method InstallBindings, addr 0x3260580, size 0x1bc, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method InstallRemoteCatalogLoader, addr 0x3260780, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x326082c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
