...
public:
  ...
  /// @brief Method <PreloadAsync>b__0_0, addr 0x22aec84, size 0xd8, virtual false, abstract: false, final false
  inline bool _PreloadAsync_b__0_0(::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* locator);

  /// @brief Method .ctor, addr 0x22aec7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22aed5c, size 0x458, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22af1b4, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method PreloadAsync, addr 0x22aeb5c, size 0xbc, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* PreloadAsync();

  /// @brief Method .ctor, addr 0x22aec18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
