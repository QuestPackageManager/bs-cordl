...
public:
  ...
  /// @brief Method <LoadRemoteCatalogAsync>b__0_0, addr 0x22a74fc, size 0xd8, virtual false, abstract: false, final false
  inline bool _LoadRemoteCatalogAsync_b__0_0(::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* locator);

  /// @brief Method .ctor, addr 0x22a74f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22a75d4, size 0x4c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22a7a98, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadRemoteCatalogAsync, addr 0x22a73ac, size 0xe4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22a7490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
