...
/// @brief Method LoadRemoteCatalogAsync, addr 0x32232c0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3223330, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
