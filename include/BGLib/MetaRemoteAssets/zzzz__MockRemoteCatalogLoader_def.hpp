...
public:
  ...
  /// @brief Method LoadRemoteCatalogAsync, addr 0x325f770, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x325f7e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
