...
public:
  ...
  /// @brief Method LoadRemoteCatalogAsync, addr 0x22aa3a0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22aa408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
