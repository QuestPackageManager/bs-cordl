...
public:
  ...
  /// @brief Method CreateDropdown, addr 0xf8a668, size 0x234, virtual false, abstract: false, final false
  inline void CreateDropdown();

  static inline ::BGLib::Polyglot::LanguageDropdown* New_ctor();

  /// @brief Method OnLocalize, addr 0xf8ab80, size 0x138, virtual true, abstract: false, final true
  inline void OnLocalize(::BGLib::Polyglot::LocalizationModel* localization);

  /// @brief Method Reset, addr 0xf8a5f4, size 0x50, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Start, addr 0xf8a644, size 0x24, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0xf8acb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
