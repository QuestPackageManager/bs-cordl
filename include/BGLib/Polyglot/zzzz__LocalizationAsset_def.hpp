...
public:
  ...
  /// @brief Method .ctor, addr 0x331a904, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TextAsset* textAsset);

  /// @brief Method get_TextAsset, addr 0x331a8fc, size 0x8, virtual false, abstract: false, final false
