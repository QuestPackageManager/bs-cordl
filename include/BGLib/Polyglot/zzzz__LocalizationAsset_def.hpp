...
/// @brief Method .ctor, addr 0x3224834, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextAsset*  textAsset) ;

/// @brief Method get_TextAsset, addr 0x322482c, size 0x8, virtual false, abstract: false, final false
