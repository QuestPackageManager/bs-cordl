...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::LocalizationModel::*)(::UnityEngine::TextAsset*)>(&::BGLib::Polyglot::LocalizationModel::ApplyLocalizationContent)> {
  constexpr static std::size_t size = 0x28;
