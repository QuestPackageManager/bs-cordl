...
public:
  // Declarations
  /// @brief Method IsAlignmentLeft, addr 0x22b06e4, size 0x20, virtual false, abstract: false, final false
  static inline bool IsAlignmentLeft(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsAlignmentRight, addr 0x22b06c0, size 0x24, virtual false, abstract: false, final false
  static inline bool IsAlignmentRight(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsOppositeDirection, addr 0x22b067c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetText, addr 0x22b049c, size 0x11c, virtual true, abstract: false, final false
  inline void SetText(::UnityEngine::UI::Text* text, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x22b05b8, size 0xc4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::UnityEngine::UI::Text* text, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x22b0704, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
