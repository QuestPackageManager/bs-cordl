...
public:
  // Declarations
  /// @brief Method IsAlignmentLeft, addr 0x22b1a18, size 0x20, virtual false, abstract: false, final false
  static inline bool IsAlignmentLeft(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsAlignmentRight, addr 0x22b19f4, size 0x24, virtual false, abstract: false, final false
  static inline bool IsAlignmentRight(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsOppositeDirection, addr 0x22b19b0, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SetText, addr 0x22b17d0, size 0x11c, virtual true, abstract: false, final false
  inline void SetText(::UnityEngine::UI::Text* text, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x22b18ec, size 0xc4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::UnityEngine::UI::Text* text, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x22b1a38, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
