...
public:
  // Declarations
  /// @brief Method GetLanguageDirection, addr 0x3263b34, size 0x10, virtual false, abstract: false, final false
  static inline ::BGLib::Polyglot::LanguageDirection GetLanguageDirection(::BGLib::Polyglot::LocalizationLanguage language);

  /// @brief Method ToCultureInfoName, addr 0x3262510, size 0xe8, virtual false, abstract: false, final false
  static inline ::StringW ToCultureInfoName(::BGLib::Polyglot::LocalizationLanguage language);

  /// @brief Method ToLocalizationLanguage, addr 0x32625f8, size 0x1458, virtual false, abstract: false, final false
  static inline ::BGLib::Polyglot::LocalizationLanguage ToLocalizationLanguage(::StringW serializedName);

  /// @brief Method ToLocalizationLanguage, addr 0x3263a90, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToSerializedName, addr 0x3262250, size 0x2c0, virtual false, abstract: false, final false
