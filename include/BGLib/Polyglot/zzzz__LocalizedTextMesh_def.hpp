...
/// @brief Method IsAlignmentLeft, addr 0x322418c, size 0xc, virtual false, abstract: false, final false
inline bool IsAlignmentLeft(::UnityEngine::TextAlignment  alignment) ;

/// @brief Method IsAlignmentRight, addr 0x3224180, size 0xc, virtual false, abstract: false, final false
inline bool IsAlignmentRight(::UnityEngine::TextAlignment  alignment) ;

/// @brief Method IsOppositeDirection, addr 0x3224158, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnLocalize, addr 0x3223f50, size 0x100, virtual true, abstract: false, final true
inline void OnLocalize(::BGLib::Polyglot::LocalizationModel*  localization) ;

/// @brief Method Reset, addr 0x3223ee4, size 0x54, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Start, addr 0x3223f38, size 0x18, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3224198, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Key, addr 0x3223edc, size 0x8, virtual false, abstract: false, final false
