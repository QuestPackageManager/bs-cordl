...
MARK_REF_T(::BGLib::Polyglot::CsvReader*);
DEFINE_IL2CPP_CLASS(::BGLib::Polyglot::CsvReader_ParsingMode, "BGLib.Polyglot", "CsvReader/ParsingMode");
DEFINE_IL2CPP_CLASS(::BGLib::Polyglot::CsvReader*, "BGLib.Polyglot", "CsvReader");
// Dependencies
namespace BGLib::Polyglot {
// Is value type: true
...
static_assert(sizeof(::BGLib::Polyglot::CsvReader_ParsingMode) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Parse, addr 0x331b654, size 0x820, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::StringW>*>* Parse(::StringW src);

  /// @brief Method .ctor, addr 0x331ed14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::BGLib::Polyglot::CsvReader) == 0x10, "Size mismatch!");
