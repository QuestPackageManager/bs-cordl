...
public:
  ...
  /// @brief Method Parse, addr 0x3225630, size 0x820, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::StringW>*>* Parse(::StringW src);

  /// @brief Method .ctor, addr 0x3228fa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
