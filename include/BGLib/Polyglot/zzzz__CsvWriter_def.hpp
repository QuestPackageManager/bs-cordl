...
public:
  // Declarations
  /// @brief Method AppendCSVLine, addr 0x22ab70c, size 0x24, virtual false, abstract: false, final false
  static inline void AppendCSVLine(::System::Text::StringBuilder* buffer, ::ArrayW<::StringW, ::Array<::StringW>*> values);

  /// @brief Method AppendCSVLine, addr 0x22ab6e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendElement, addr 0x22ab664, size 0x84, virtual false, abstract: false, final false
  static inline void AppendElement(::System::Text::StringBuilder* buffer, ::StringW element);

  /// @brief Method AppendRow, addr 0x22ab024, size 0x1f4, virtual false, abstract: false, final false
  static inline void AppendRow(::StringW filePath, ::System::Collections::Generic::List_1<::StringW>* row);

  /// @brief Method AppendRowInternal, addr 0x22ab218, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method HasEscapeChars, addr 0x22ab5b0, size 0xb4, virtual false, abstract: false, final false
