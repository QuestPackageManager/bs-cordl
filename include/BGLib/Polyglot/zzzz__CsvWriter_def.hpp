...
public:
// Declarations
/// @brief Method AppendCSVLine, addr 0x32295c4, size 0x2c, virtual false, abstract: false, final false
static inline void AppendCSVLine(::System::Text::StringBuilder*  buffer, ::ArrayW<::StringW,::Array<::StringW>*>  values) ;

/// @brief Method AppendCSVLine, addr 0x3229598, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method AppendElement, addr 0x3229504, size 0x94, virtual false, abstract: false, final false
static inline void AppendElement(::System::Text::StringBuilder*  buffer, ::StringW  element) ;

/// @brief Method AppendRow, addr 0x3228efc, size 0x1d0, virtual false, abstract: false, final false
static inline void AppendRow(::StringW  filePath, ::System::Collections::Generic::List_1<::StringW>*  row) ;

/// @brief Method AppendRowInternal, addr 0x32290cc, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method HasEscapeChars, addr 0x3229428, size 0xdc, virtual false, abstract: false, final false
