...
public:
  // Declarations
  /// @brief Method AppendCSVLine, addr 0x3229674, size 0x2c, virtual false, abstract: false, final false
  static inline void AppendCSVLine(::System::Text::StringBuilder* buffer, ::ArrayW<::StringW, ::Array<::StringW>*> values);

  /// @brief Method AppendCSVLine, addr 0x3229648, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendElement, addr 0x32295b4, size 0x94, virtual false, abstract: false, final false
  static inline void AppendElement(::System::Text::StringBuilder* buffer, ::StringW element);

  /// @brief Method AppendRow, addr 0x3228fac, size 0x1d0, virtual false, abstract: false, final false
  static inline void AppendRow(::StringW filePath, ::System::Collections::Generic::List_1<::StringW>* row);

  /// @brief Method AppendRowInternal, addr 0x322917c, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasEscapeChars, addr 0x32294d8, size 0xdc, virtual false, abstract: false, final false
