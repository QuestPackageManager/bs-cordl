...
public:
  // Declarations
  /// @brief Method IsAlignmentLeft, addr 0x2272028, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentLeft(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsAlignmentRight, addr 0x2272000, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentRight(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsOppositeDirection, addr 0x2271fac, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetText, addr 0x2271eac, size 0x2c, virtual true, abstract: false, final false
  inline void SetText(::TMPro::TextMeshPro* text, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x2271ed8, size 0xd4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::TMPro::TextMeshPro* text, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x2272050, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
