...
public:
  // Declarations
  /// @brief Method IsAlignmentLeft, addr 0x331a31c, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentLeft(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsAlignmentRight, addr 0x331a2f4, size 0x28, virtual false, abstract: false, final false
  static inline bool IsAlignmentRight(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsOppositeDirection, addr 0x331a2a0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method SetText, addr 0x331a188, size 0x28, virtual true, abstract: false, final false
  inline void SetText(::TMPro::TextMeshPro* text, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x331a1b0, size 0xf0, virtual true, abstract: false, final false
  inline void UpdateAlignment(::TMPro::TextMeshPro* text, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x331a344, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
