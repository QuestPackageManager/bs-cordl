...
public:
  ...
  /// @brief Method .ctor, addr 0xe4ea54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <InputFilesContains>b__0, addr 0xe4eec0, size 0xa8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_InputFiles, addr 0xe4e2c4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* get_InputFiles();

  /// @brief Method get_SelectedCultureInfo, addr 0xe4e2cc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_SelectedCultureInfo();

  /// @brief Method set_SelectedCultureInfo, addr 0xe4e2d4, size 0x8c, virtual false, abstract: false, final false
  inline void set_SelectedCultureInfo(::System::Globalization::CultureInfo* value);

  /// @brief Method get_SelectedLanguage, addr 0xe4e360, size 0x1c, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::Language get_SelectedLanguage();

  /// @brief Method set_SelectedLanguage, addr 0xe4e37c, size 0x130, virtual false, abstract: false, final false
  inline void set_SelectedLanguage(::BGLib::Polyglot::Language value);

  /// @brief Method get_fallbackLanguage, addr 0xe4e558, size 0x1c, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::Language get_fallbackLanguage();

  /// @brief Method get_SelectedLanguageDirection, addr 0xe4e574, size 0x28, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LanguageDirection get_SelectedLanguageDirection();

  /// @brief Method get_SupportedLanguages, addr 0xe4e59c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::Language>* get_SupportedLanguages();

  /// @brief Method get_EnglishLanguageNames, addr 0xe4be28, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_EnglishLanguageNames();

  /// @brief Method get_LocalizedLanguageNames, addr 0xe4e5b8, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_LocalizedLanguageNames();

  /// @brief Method get_SelectedLanguageIndex, addr 0xe4bea4, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_SelectedLanguageIndex();

  /// @brief Method add__onChangeLanguage, addr 0xe4e634, size 0xb0, virtual false, abstract: false, final false
  inline void add__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>* value);

  /// @brief Method remove__onChangeLanguage, addr 0xe4e6e4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe4e794, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectLanguage, addr 0xe4e8a4, size 0xd8, virtual false, abstract: false, final false
  inline void SelectLanguage(int32_t selected);

  /// @brief Method AddOnLocalizeEvent, addr 0xe4bc70, size 0x1b8, virtual false, abstract: false, final false
  inline void AddOnLocalizeEvent(::BGLib::Polyglot::ILocalize* localize);

  /// @brief Method InputFilesContains, addr 0xe4e97c, size 0xd8, virtual false, abstract: false, final false
  inline bool InputFilesContains(::BGLib::Polyglot::LocalizationDocument* doc);

  /// @brief Method GetCultureInfo, addr 0xe4e4ac, size 0xac, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* GetCultureInfo(::BGLib::Polyglot::Language language);

  /// @brief Method Get, addr 0xe4c3ac, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW Get(::StringW key);

  /// @brief Method GetOrKey, addr 0xe4ed04, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetOrKey(::StringW key);

  /// @brief Method TryGet, addr 0xe4ea5c, size 0x2a8, virtual false, abstract: false, final false
  inline bool TryGet(::StringW key, ::BGLib::Polyglot::Language language, ByRef<::StringW> value);

  /// @brief Method GetFormatOrKey, addr 0xe4eda8, size 0x58, virtual false, abstract: false, final false
  inline ::StringW GetFormatOrKey(::StringW key, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> arguments);

  /// @brief Method IsValueValid, addr 0xe4ed30, size 0x78, virtual false, abstract: false, final false
  static inline bool IsValueValid(::StringW value);

  /// @brief Method KeyExist, addr 0xe4ee00, size 0x20, virtual false, abstract: false, final false
  inline bool KeyExist(::StringW key);

  /// @brief Method KeyExist, addr 0xe4ee20, size 0xa0, virtual false, abstract: false, final false
