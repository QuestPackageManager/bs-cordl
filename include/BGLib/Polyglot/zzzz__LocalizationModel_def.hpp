...
public:
  ...
  /// @brief Method <InputFilesContains>b__0, addr 0xf8da90, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf8d624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddOnLocalizeEvent, addr 0xf8a934, size 0x1b8, virtual false, abstract: false, final false
  inline void AddOnLocalizeEvent(::BGLib::Polyglot::ILocalize* localize);

  /// @brief Method Get, addr 0xf8b070, size 0xd8, virtual false, abstract: false, final false
  inline ::StringW Get(::StringW key);

  /// @brief Method GetCultureInfo, addr 0xf8d07c, size 0xac, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* GetCultureInfo(::BGLib::Polyglot::Language language);

  /// @brief Method GetFormatOrKey, addr 0xf8d978, size 0x58, virtual false, abstract: false, final false
  inline ::StringW GetFormatOrKey(::StringW key, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> arguments);

  /// @brief Method GetOrKey, addr 0xf8d8d4, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW GetOrKey(::StringW key);

  /// @brief Method InputFilesContains, addr 0xf8d54c, size 0xd8, virtual false, abstract: false, final false
  inline bool InputFilesContains(::BGLib::Polyglot::LocalizationDocument* doc);

  /// @brief Method IsValueValid, addr 0xf8d900, size 0x78, virtual false, abstract: false, final false
  static inline bool IsValueValid(::StringW value);

  /// @brief Method KeyExist, addr 0xf8d9d0, size 0x20, virtual false, abstract: false, final false
  inline bool KeyExist(::StringW key);

  /// @brief Method KeyExist, addr 0xf8d9f0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectLanguage, addr 0xf8d474, size 0xd8, virtual false, abstract: false, final false
  inline void SelectLanguage(int32_t selected);

  /// @brief Method TryGet, addr 0xf8d62c, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf8d364, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method add__onChangeLanguage, addr 0xf8d204, size 0xb0, virtual false, abstract: false, final false
  inline void add__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>* value);

  /// @brief Method get_EnglishLanguageNames, addr 0xf8aaec, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_EnglishLanguageNames();

  /// @brief Method get_InputFiles, addr 0xf8ce94, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* get_InputFiles();

  /// @brief Method get_LocalizedLanguageNames, addr 0xf8d188, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_LocalizedLanguageNames();

  /// @brief Method get_SelectedCultureInfo, addr 0xf8ce9c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Globalization::CultureInfo* get_SelectedCultureInfo();

  /// @brief Method get_SelectedLanguage, addr 0xf8cf30, size 0x1c, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::Language get_SelectedLanguage();

  /// @brief Method get_SelectedLanguageDirection, addr 0xf8d144, size 0x28, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LanguageDirection get_SelectedLanguageDirection();

  /// @brief Method get_SelectedLanguageIndex, addr 0xf8ab68, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_SelectedLanguageIndex();

  /// @brief Method get_SupportedLanguages, addr 0xf8d16c, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::Language>* get_SupportedLanguages();

  /// @brief Method get_fallbackLanguage, addr 0xf8d128, size 0x1c, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::Language get_fallbackLanguage();

  /// @brief Method remove__onChangeLanguage, addr 0xf8d2b4, size 0xb0, virtual false, abstract: false, final false
  inline void remove__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>* value);

  /// @brief Method set_SelectedCultureInfo, addr 0xf8cea4, size 0x8c, virtual false, abstract: false, final false
  inline void set_SelectedCultureInfo(::System::Globalization::CultureInfo* value);

  /// @brief Method set_SelectedLanguage, addr 0xf8cf4c, size 0x130, virtual false, abstract: false, final false
