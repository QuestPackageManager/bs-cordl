...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::TextAsset> (::BGLib::Polyglot::LocalizationAsset::*)()>(&::BGLib::Polyglot::LocalizationAsset::get_TextAsset)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x322482c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::LocalizationAsset*>::get(),
                        "get_TextAsset",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::LocalizationAsset::*)(::UnityEngine::TextAsset*)>(&::BGLib::Polyglot::LocalizationAsset::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3224834;
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, textAsset);
}
inline ::BGLib::Polyglot::LocalizationAsset* BGLib::Polyglot::LocalizationAsset::New_ctor(::UnityEngine::TextAsset*  textAsset)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::BGLib::Polyglot::LocalizationAsset*>(textAsset));
}
// Ctor Parameters []
