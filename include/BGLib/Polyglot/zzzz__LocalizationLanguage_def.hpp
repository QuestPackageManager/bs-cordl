...
DEFINE_IL2CPP_CLASS(::BGLib::Polyglot::LocalizationLanguage, "BGLib.Polyglot", "LocalizationLanguage");
// Dependencies
namespace BGLib::Polyglot {
// Is value type: true
...
static_assert(sizeof(::BGLib::Polyglot::LocalizationLanguage) == 0x4, "Size mismatch!");
