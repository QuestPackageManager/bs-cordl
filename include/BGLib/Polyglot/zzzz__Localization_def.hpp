...
/// @brief Method Get, addr 0x32245f8, size 0x18, virtual false, abstract: false, final false
static inline ::StringW Get(::StringW  key) ;

/// @brief Method HasNoSupportedLanguage, addr 0x3224748, size 0x58, virtual false, abstract: false, final false
inline bool HasNoSupportedLanguage() ;

/// @brief Method IsLanguageSupported, addr 0x32247a0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method NoDomainReloadInit, addr 0x32245ac, size 0x4c, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method SetSingletonInstance, addr 0x3224610, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3224824, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::BGLib::Polyglot::LocalizationModel* getStaticF__instance() ;

/// @brief Method get_FallbackLanguage, addr 0x32246b4, size 0x8, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::LocalizationLanguage get_FallbackLanguage() ;

/// @brief Method get_Instance, addr 0x3223a9c, size 0x98, virtual false, abstract: false, final false
static inline ::BGLib::Polyglot::LocalizationModel* get_Instance() ;

/// @brief Method get_SupportedLanguages, addr 0x32246ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::LocalizationLanguage>* get_SupportedLanguages() ;

/// @brief Method get_selectedLanguageIndex, addr 0x32246bc, size 0x8c, virtual false, abstract: false, final false
