...
public:
  // Declarations
  /// @brief Method ToCultureInfoName, addr 0x22aba8c, size 0xb8, virtual false, abstract: false, final false
  static inline ::StringW ToCultureInfoName(::BGLib::Polyglot::Language lang);

  /// @brief Method ToLanguage, addr 0x22abb44, size 0x1398, virtual false, abstract: false, final false
  static inline ::BGLib::Polyglot::Language ToLanguage(::StringW serializedName);

  /// @brief Method ToLanguage, addr 0x22acf58, size 0xe8, virtual false, abstract: false, final false
  static inline ::BGLib::Polyglot::Language ToLanguage(::UnityEngine::SystemLanguage systemLanguage, bool useFallbackLanguage);

  /// @brief Method ToSerializedName, addr 0x22ab8dc, size 0x1b0, virtual false, abstract: false, final false
