...
public:
  ...
  /// @brief Method OnLocalize, addr 0xeb58f4, size 0x28, virtual true, abstract: false, final true
  inline void OnLocalize(::BGLib::Polyglot::LocalizationModel* localization);

  /// @brief Method Start, addr 0xeb58a4, size 0x50, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0xeb591c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
