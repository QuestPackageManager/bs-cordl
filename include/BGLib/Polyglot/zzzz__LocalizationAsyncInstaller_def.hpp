...
public:
  ...
  /// @brief Method <LocalizationContentToAsset>b__6_0, addr 0x31f42bc, size 0x50, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LocalizationAsset* _LocalizationContentToAsset_b__6_0(::UnityEngine::TextAsset* localizationTextAsset);

  /// @brief Method .ctor, addr 0x31f42b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x31f4040, size 0x17c, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadLocalizationAssetsSync, addr 0x31f41bc, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* LoadLocalizationAssetsSync();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x31f3f04, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method LocalizationContentToAsset, addr 0x31f3f20, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f4220, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x31f3ec0, size 0x44, virtual true, abstract: false, final false
