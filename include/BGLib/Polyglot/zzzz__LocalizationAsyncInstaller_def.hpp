...
// Write type traits
MARK_REF_T(::BGLib::Polyglot::LocalizationAsyncInstaller*);
...
public:
  ...
  /// @brief Method <LocalizationContentToAsset>b__6_0, addr 0x331ad08, size 0x50, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LocalizationAsset* _LocalizationContentToAsset_b__6_0(::UnityEngine::TextAsset* localizationTextAsset);

  /// @brief Method .ctor, addr 0x331ad04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _inputFiles, offset 0x58, size 0x8
  ...
  /// @brief Field _mainPolyglotAsset, offset 0x50, size 0x8
  ...
  /// @brief Method InstallBindings, addr 0x331aa8c, size 0x17c, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadLocalizationAssetsSync, addr 0x331ac08, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* LoadLocalizationAssetsSync();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x331a950, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method LocalizationContentToAsset, addr 0x331a96c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331ac6c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x331a90c, size 0x44, virtual true, abstract: false, final false
...
// Non member Declarations
static_assert(offsetof(::BGLib::Polyglot::LocalizationAsyncInstaller, ____mainPolyglotAsset) == 0x50, "Offset mismatch!");

static_assert(offsetof(::BGLib::Polyglot::LocalizationAsyncInstaller, ____inputFiles) == 0x58, "Offset mismatch!");

static_assert(sizeof(::BGLib::Polyglot::LocalizationAsyncInstaller) == 0x60, "Size mismatch!");
