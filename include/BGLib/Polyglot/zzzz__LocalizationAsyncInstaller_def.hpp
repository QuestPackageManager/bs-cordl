...
public:
  ...
  /// @brief Method <LocalizationContentToAsset>b__6_0, addr 0x32610e8, size 0x50, virtual false, abstract: false, final false
  inline ::BGLib::Polyglot::LocalizationAsset* _LocalizationContentToAsset_b__6_0(::UnityEngine::TextAsset* localizationTextAsset);

  /// @brief Method .ctor, addr 0x32610e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x3260e6c, size 0x17c, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadLocalizationAssetsSync, addr 0x3260fe8, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* LoadLocalizationAssetsSync();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x3260d30, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method LocalizationContentToAsset, addr 0x3260d4c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326104c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x3260cec, size 0x44, virtual true, abstract: false, final false
