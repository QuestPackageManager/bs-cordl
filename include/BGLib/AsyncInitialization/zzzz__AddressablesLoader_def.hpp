...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::BGLib::AsyncInitialization::AddressablesLoader__InstantiateFromAddressableToContainer_d__0_2, "BGLib.AsyncInitialization", "AddressablesLoader/<InstantiateFromAddressableToContainer>d__0`2");
