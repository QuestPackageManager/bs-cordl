...
public:
  ...
  /// @brief Method ReadJson, addr 0x33144d8, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x3314594, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x331468c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
