...
/// @brief Method ReadJson, addr 0x325bc14, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method WriteJson, addr 0x325bcd0, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x325bdc8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
