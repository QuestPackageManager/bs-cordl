...
public:
  ...
  /// @brief Method ReadJson, addr 0x31ee2f0, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x31ee3ac, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31ee4f8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
