...
public:
  ...
  /// @brief Method ReadJson, addr 0x325b068, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x325b124, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325b270, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
