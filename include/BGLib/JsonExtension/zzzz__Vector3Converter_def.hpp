...
public:
  ...
  /// @brief Method ReadJson, addr 0x22aaa9c, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x22aab3c, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22aac84, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
