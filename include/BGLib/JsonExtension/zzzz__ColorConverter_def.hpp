...
/// @brief Method ReadJson, addr 0x325b794, size 0xbc, virtual true, abstract: false, final false
inline ::UnityEngine::Color ReadJson(::Newtonsoft::Json::JsonReader*  reader, ::System::Type*  objectType, ::UnityEngine::Color  existingValue, bool  hasExistingValue, ::Newtonsoft::Json::JsonSerializer*  serializer) ;

/// @brief Method WriteJson, addr 0x325b850, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x325b9e8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
