...
public:
  ...
  /// @brief Method ReadJson, addr 0x3314058, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x3314114, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33142ac, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23335 };
