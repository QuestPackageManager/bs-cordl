...
public:
  ...
  /// @brief Method ReadJson, addr 0x325a9f8, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x325aab4, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325ac4c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
