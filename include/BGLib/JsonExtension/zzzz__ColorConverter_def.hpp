...
public:
  ...
  /// @brief Method ReadJson, addr 0x321e65c, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x321e718, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321e8b0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
