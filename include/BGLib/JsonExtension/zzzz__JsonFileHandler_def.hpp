...
template <typename T> class __JsonFileHandler____c__DisplayClass0_0_1;
}
...
public:
  // Declarations
  template <typename T> using __c__DisplayClass0_0_1 = ::BGLib::JsonExtension::__JsonFileHandler____c__DisplayClass0_0_1<T>;
