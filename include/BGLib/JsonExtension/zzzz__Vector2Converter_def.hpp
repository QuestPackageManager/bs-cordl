...
public:
  ...
  /// @brief Method ReadJson, addr 0x22aa6ec, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x22aa78c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22aa87c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
