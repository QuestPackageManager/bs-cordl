...
public:
  ...
  /// @brief Method ReadJson, addr 0x31edf10, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x31edfcc, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31ee0c4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
