...
public:
  ...
  /// @brief Method ReadJson, addr 0x321e8ec, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x321e9a8, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321eaa0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
