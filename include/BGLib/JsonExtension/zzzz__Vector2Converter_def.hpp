...
public:
  ...
  /// @brief Method ReadJson, addr 0x325ac88, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteJson, addr 0x325ad44, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325ae3c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
