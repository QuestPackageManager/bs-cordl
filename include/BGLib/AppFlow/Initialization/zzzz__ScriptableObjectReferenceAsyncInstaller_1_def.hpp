...
namespace BGLib::AppFlow::Initialization {
template<typename T>
struct ScriptableObjectReferenceAsyncInstaller_1__LoadResourcesBeforeInstallAsync_d__4;
}
...
constexpr ScriptableObjectReferenceAsyncInstaller_1__LoadResourcesBeforeInstallAsync_d__4(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<T>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<T>  __u__1) noexcept;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::BGLib::AppFlow::Initialization::ScriptableObjectReferenceAsyncInstaller_1__LoadResourcesBeforeInstallAsync_d__4, "BGLib.AppFlow.Initialization", "ScriptableObjectReferenceAsyncInstaller`1/<LoadResourcesBeforeInstallAsync>d__4");
