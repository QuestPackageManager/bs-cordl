...
/// @brief Field <>9__17_0, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__17_0, put=setStaticF___9__17_0)) ::System::Func_2<::UnityW<::BGLib::AppFlow::Initialization::AsyncPreloader>,::System::Threading::Tasks::Task*>*  __9__17_0;

static inline ::BGLib::AppFlow::Initialization::AsyncSceneContext___c* New_ctor() ;

/// @brief Method <LoadInstallersAsync>b__17_0, addr 0x324f974, size 0x20, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* _LoadInstallersAsync_b__17_0(::BGLib::AppFlow::Initialization::AsyncPreloader*  r) ;

/// @brief Method .ctor, addr 0x324f970, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <LoadInstallersAsync>b__1, addr 0x324f998, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x324f994, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x324f9bc, size 0x5d4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x324ff90, size 0x80, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "::BGLib::AppFlow::Initialization::AsyncSceneContext___c__DisplayClass17_0*", modifiers: "", def_value: None }, CppParam { name: "_loadersStopwatch_5__2", ty: "::System::Diagnostics::Stopwatch*", modifiers: "", def_value: None }, CppParam { name: "_installersStopwatch_5__3", ty: "::System::Diagnostics::Stopwatch*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr AsyncSceneContext__LoadInstallersAsync_d__17(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  __t__builder, ::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>  __4__this, ::BGLib::AppFlow::Initialization::AsyncSceneContext___c__DisplayClass17_0*  __8__1, ::System::Diagnostics::Stopwatch*  _loadersStopwatch_5__2, ::System::Diagnostics::Stopwatch*  _installersStopwatch_5__3, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x3250010, size 0x184, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3250194, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr AsyncSceneContext__Run_d__13(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x325019c, size 0x3d8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3250574, size 0x6c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>", modifiers: "", def_value: None }]
constexpr AsyncSceneContext__RunAsync_d__14(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::BGLib::AppFlow::Initialization::AsyncSceneContext>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  __u__1) noexcept;
...
/// @brief Field _asyncInstallers, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__asyncInstallers, put=__cordl_internal_set__asyncInstallers)) ::System::Collections::Generic::List_1<::UnityW<::BGLib::AppFlow::Initialization::AsyncInstaller>>*  _asyncInstallers;

/// @brief Field _asyncPreloaders, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__asyncPreloaders, put=__cordl_internal_set__asyncPreloaders)) ::System::Collections::Generic::List_1<::UnityW<::BGLib::AppFlow::Initialization::AsyncPreloader>>*  _asyncPreloaders;
...
/// @brief Field <telemetryInstallersDurationMS>k__BackingField, offset 0xe4, size 0x4 
 __declspec(property(get=__cordl_internal_get__telemetryInstallersDurationMS_k__BackingField, put=__cordl_internal_set__telemetryInstallersDurationMS_k__BackingField)) int32_t  _telemetryInstallersDurationMS_k__BackingField;

/// @brief Field <telemetryLoadersDurationMS>k__BackingField, offset 0xe0, size 0x4 
 __declspec(property(get=__cordl_internal_get__telemetryLoadersDurationMS_k__BackingField, put=__cordl_internal_set__telemetryLoadersDurationMS_k__BackingField)) int32_t  _telemetryLoadersDurationMS_k__BackingField;
...
/// @brief Method CreateContainerForLoading, addr 0x324f4a0, size 0x98, virtual false, abstract: false, final false
inline ::Zenject::DiContainer* CreateContainerForLoading() ;

/// @brief Method CreateRegistry, addr 0x324f538, size 0x9c, virtual false, abstract: false, final false
inline ::BGLib::AppFlow::Initialization::AsyncInstallerRegistry* CreateRegistry() ;

/// @brief Method InstallInstallers, addr 0x324f6b4, size 0x258, virtual true, abstract: false, final false
inline void InstallInstallers() ;

/// @brief Method LoadInstallersAsync, addr 0x324f5d4, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x324f3fc, size 0xa4, virtual true, abstract: false, final false
inline void Run() ;

/// @brief Method RunAsync, addr 0x3247650, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method <>n__0, addr 0x324f914, size 0x8, virtual false, abstract: false, final false
inline void __n__0() ;

/// @brief Method .ctor, addr 0x324f90c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_telemetryInstallersDurationMS, addr 0x324f3ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_telemetryInstallersDurationMS() ;

/// @brief Method get_telemetryLoadersDurationMS, addr 0x324f3dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_telemetryLoadersDurationMS() ;

/// @brief Method set_telemetryInstallersDurationMS, addr 0x324f3f4, size 0x8, virtual false, abstract: false, final false
inline void set_telemetryInstallersDurationMS(int32_t  value) ;

/// @brief Method set_telemetryLoadersDurationMS, addr 0x324f3e4, size 0x8, virtual false, abstract: false, final false
