...
public:
  ...
  /// @brief Method .ctor, addr 0x330839c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_loadersQueue, addr 0x3308394, size 0x8, virtual false, abstract: false, final false
