...
public:
  ...
  /// @brief Method .ctor, addr 0x107ee34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::BGLib::AppFlow::Initialization::AsyncPreloader, 0x20>, "Size mismatch!");
