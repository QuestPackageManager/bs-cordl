...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FeatureAsyncInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FeatureAsyncInstaller(FeatureAsyncInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FeatureAsyncInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FeatureAsyncInstaller(FeatureAsyncInstallerconst&) = delete;
