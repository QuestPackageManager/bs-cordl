...
public:
  ...
  /// @brief Method InstallBindings, addr 0x330871c, size 0x4, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x33083f8, size 0x324, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3308720, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x33083b4, size 0x44, virtual true, abstract: false, final false
