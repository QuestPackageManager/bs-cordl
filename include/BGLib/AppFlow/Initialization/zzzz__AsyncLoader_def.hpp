...
public:
  ...
  /// @brief Method LoadAsync, addr 0x3306f00, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x3306efc, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3306ea8, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method TryCancelTaskIfItRunning, addr 0x3306eac, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3306aa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
