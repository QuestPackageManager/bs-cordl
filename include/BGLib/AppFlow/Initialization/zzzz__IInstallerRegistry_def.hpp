...
public:
  // Declarations
  /// @brief Method AddInstaller, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline void AddInstaller(::Zenject::IInstaller* newInstaller);

  // Ctor Parameters [CppParam { name: "", ty: "IInstallerRegistry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IInstallerRegistry(IInstallerRegistryconst&) = delete;
