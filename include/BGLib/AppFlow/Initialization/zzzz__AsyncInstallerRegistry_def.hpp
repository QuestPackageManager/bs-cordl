...
public:
  ...
  /// @brief Method AddMonoInstaller, addr 0x229c87c, size 0xa4, virtual true, abstract: false, final true
  inline void AddMonoInstaller(::Zenject::MonoInstaller* newMonoInstaller);

  /// @brief Method AddScriptableObjectInstaller, addr 0x229c920, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x229c9c4, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();
