...
public:
  ...
  /// @brief Method AddMonoInstaller, addr 0x1077f88, size 0xa8, virtual true, abstract: false, final true
  inline void AddMonoInstaller(::Zenject::MonoInstaller* newMonoInstaller);

  /// @brief Method AddScriptableObjectInstaller, addr 0x1078030, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x10780d8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
