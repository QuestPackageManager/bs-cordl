...
public:
  // Declarations
  /// @brief Method AddMonoInstaller addr 0x0 size 0xffffffffffffffff virtual true final false
  inline void AddMonoInstaller(::Zenject::MonoInstaller* newMonoInstaller);

  /// @brief Method AddScriptableObjectInstaller addr 0x0 size 0xffffffffffffffff virtual true final false
...
public:
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync addr 0x0 size 0xffffffffffffffff virtual true final false
  ...
  /// @brief Method .ctor addr 0xe23c2c size 0x8 virtual false final false
  inline void _ctor();
