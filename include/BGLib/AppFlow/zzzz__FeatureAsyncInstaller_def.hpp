...
public:
  ...
  /// @brief Method InstallBindings, addr 0x229c828, size 0x4, virtual true, abstract: false, final false
  inline void InstallBindings();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x229c4d4, size 0x354, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229c82c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_assetLabelRuntimeKey, addr 0x229c494, size 0x40, virtual true, abstract: false, final false
