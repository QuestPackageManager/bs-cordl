...
CORDL_MODULE_INIT
CORDL_MODULE_EXPORT(IHandshakeServerToClientMessage)
...
// Write type traits
MARK_REF_PTR_T(::BGNet::Core::Messages::IHandshakeServerToClientMessage);
...
class CORDL_TYPE IHandshakeServerToClientMessage {
public:
  // Declarations
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IHandshakeServerToClientMessage", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IHandshakeServerToClientMessage(IHandshakeServerToClientMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IHandshakeServerToClientMessage", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IHandshakeServerToClientMessage(IHandshakeServerToClientMessage const&) = delete;
