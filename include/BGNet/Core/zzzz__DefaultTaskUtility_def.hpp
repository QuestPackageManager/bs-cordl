...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0xeef4b8, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0xeef450, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0xeef538, size 0x68, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0xeef5a0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0xeef520, size 0x18, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0xeef608, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
