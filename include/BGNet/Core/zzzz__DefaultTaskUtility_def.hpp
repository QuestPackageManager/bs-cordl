...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0x3247888, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0x324781c, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x3247914, size 0x6c, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0x3247980, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0x32478f8, size 0x1c, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x32479ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
