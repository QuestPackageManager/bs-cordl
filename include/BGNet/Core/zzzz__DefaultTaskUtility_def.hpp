...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0xecfdb0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0xecfd48, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0xecfe30, size 0x68, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0xecfe98, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0xecfe18, size 0x18, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0xecff00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
