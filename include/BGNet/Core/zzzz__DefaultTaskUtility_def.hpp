...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0x10bb760, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0x10bb6f8, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x10bb7e0, size 0x68, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0x10bb848, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0x10bb7c8, size 0x18, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x10bb8b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
