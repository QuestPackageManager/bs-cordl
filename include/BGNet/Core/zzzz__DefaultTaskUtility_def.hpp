...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0xfc903c, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0xfc8fd4, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0xfc90bc, size 0x68, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0xfc9124, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0xfc90a4, size 0x18, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0xfc918c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
