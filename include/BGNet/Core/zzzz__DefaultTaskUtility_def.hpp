...
public:
  ...
  /// @brief Method CancellationTokenWithDelay, addr 0x10c2fd0, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Delay, addr 0x10c2f68, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Run, addr 0x10c3050, size 0x68, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* Run(::System::Action* action, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Run, addr 0x10c30b8, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method Wait, addr 0x10c3038, size 0x18, virtual true, abstract: false, final true
  inline void Wait(::System::Threading::Tasks::Task* task);

  /// @brief Method .ctor, addr 0x10c3120, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
