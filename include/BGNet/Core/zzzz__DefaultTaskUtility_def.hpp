...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DefaultTaskUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DefaultTaskUtility(DefaultTaskUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DefaultTaskUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DefaultTaskUtility(DefaultTaskUtilityconst&) = delete;
