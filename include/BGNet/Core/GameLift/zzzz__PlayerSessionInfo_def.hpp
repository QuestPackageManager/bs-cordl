...
public:
  ...
  /// @brief Method .ctor, addr 0x31ee5e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::BGNet::Core::GameLift::PlayerSessionInfo, 0x88>, "Size mismatch!");
