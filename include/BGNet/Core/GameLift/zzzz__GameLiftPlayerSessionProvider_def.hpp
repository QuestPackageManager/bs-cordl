...
public:
  ...
  /// @brief Method <GetAverageLatencies>b__25_0, addr 0x3226af0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method <GetAverageLatencies>b__25_1, addr 0x3226b44, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method <GetAverageLatencies>b__25_2, addr 0x3226b88, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3226aec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3226bec, size 0x1b10, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32286fc, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x322877c, size 0x3c0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3228b3c, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3228ba8, size 0x38c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3228f34, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3228f3c, size 0x3b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32292f0, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32292f8, size 0x344, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x322963c, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32296bc, size 0x9dc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x322a098, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Dispose, addr 0x32266a0, size 0x144, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetAverageLatencies, addr 0x3226034, size 0x260, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::StringW, int64_t>* GetAverageLatencies();

  /// @brief Method GetAwsGameLiftRegionEndpoint, addr 0x3226370, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW GetAwsGameLiftRegionEndpoint(::StringW awsRegion);

  /// @brief Method GetGameLiftPlayerSessionInfo, addr 0x3225ee8, size 0x14c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetGameLiftUdpPingBeaconEndpoint, addr 0x32264d0, size 0x6c, virtual false, abstract: false, final false
  static inline ::StringW GetGameLiftUdpPingBeaconEndpoint(::StringW awsRegion);

  /// @brief Method GetMultiplayerStatusData, addr 0x3225c04, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* GetMultiplayerStatusData();

  /// @brief Method GetXPlatformAccessToken, addr 0x322653c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method PingAllAwsGameLiftRegions, addr 0x3225e44, size 0xa4, virtual false, abstract: false, final false
  inline void PingAllAwsGameLiftRegions();

  /// @brief Method PingAllAwsGameLiftRegionsUsingGameLiftUdpPingBeacons, addr 0x3225da0, size 0xa4, virtual false, abstract: false, final false
  inline void PingAllAwsGameLiftRegionsUsingGameLiftUdpPingBeacons();

  /// @brief Method PingRegionAsync, addr 0x3226294, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::ValueTuple_2<::StringW, int64_t>>* PingRegionAsync(::StringW awsRegion);

  /// @brief Method PingRegionUsingGameLiftUdpPingBeaconAsync, addr 0x32263dc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method PollUpdate, addr 0x3225cb4, size 0xec, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method <PingAllAwsGameLiftRegionsUsingGameLiftUdpPingBeacons>b__28_0, addr 0x3226a94, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method <PingAllAwsGameLiftRegions>b__24_0, addr 0x3226a90, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3225860, size 0x3a4, virtual false, abstract: false, final false
