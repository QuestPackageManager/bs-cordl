...
// Ctor Parameters [CppParam { name: "errorCode", ty: "::GlobalNamespace::MultiplayerPlacementErrorCode", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "playerSessionInfo",
// ty: "::BGNet::Core::GameLift::PlayerSessionInfo*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "pollIntervalMs", ty: "int32_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "ticketId", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "ticketStatus", ty: "::StringW", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "placementId", ty: "::StringW", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "placementStatus", ty: "::StringW", modifiers:
