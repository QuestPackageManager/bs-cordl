...
public:
  ...
  /// @brief Method .ctor, addr 0x3284c48, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddLogger, addr 0x3284a80, size 0x15c, virtual false, abstract: false, final false
  static inline void AddLogger(::BGNet::Logging::Debug_ILogger* logger);

  /// @brief Method ClearAllLoggers, addr 0x328534c, size 0x98, virtual false, abstract: false, final false
  static inline void ClearAllLoggers();

  /// @brief Method Log, addr 0x3284f48, size 0xfc, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x3285044, size 0x100, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogException, addr 0x3285144, size 0x108, virtual false, abstract: false, final false
  static inline void LogException(::System::Exception* exception, ::StringW message);

  /// @brief Method LogWarning, addr 0x328524c, size 0x100, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method NoDomainReloadInit, addr 0x32849fc, size 0x80, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method RemoveAndDisposeLogger, addr 0x3284c50, size 0x240, virtual false, abstract: false, final false
  static inline void RemoveAndDisposeLogger(::BGNet::Logging::Debug_ILogger* logger);

  /// @brief Method <RemoveAndDisposeLogger>g__DisposeLogger|7_0, addr 0x3284e90, size 0xb8, virtual false, abstract: false, final false
