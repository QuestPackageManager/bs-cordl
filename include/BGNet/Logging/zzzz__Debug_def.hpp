...
public:
  ...
  /// @brief Method .ctor, addr 0x10c6684, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddLogger, addr 0x10c6494, size 0x178, virtual false, abstract: false, final false
  static inline void AddLogger(::BGNet::Logging::__Debug__ILogger* logger);

  /// @brief Method Log, addr 0x10c68f8, size 0xf4, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x10c69ec, size 0xf8, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogException, addr 0x10c6ae4, size 0x100, virtual false, abstract: false, final false
  static inline void LogException(::System::Exception* exception, ::StringW message);

  /// @brief Method LogWarning, addr 0x10c6be4, size 0xf8, virtual false, abstract: false, final false
  static inline void LogWarning(::StringW message);

  /// @brief Method NoDomainReloadInit, addr 0x10c63fc, size 0x90, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method RemoveLogger, addr 0x10c66ac, size 0x24c, virtual false, abstract: false, final false
