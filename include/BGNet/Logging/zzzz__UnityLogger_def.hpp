...
public:
  ...
  /// @brief Method LogError, addr 0x334263c, size 0x5c, virtual true, abstract: false, final true
  inline void LogError(::StringW message);

  /// @brief Method LogException, addr 0x3342698, size 0x90, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception, ::StringW message);

  /// @brief Method LogInfo, addr 0x3342638, size 0x4, virtual true, abstract: false, final true
  inline void LogInfo(::StringW message);

  /// @brief Method LogWarning, addr 0x3342728, size 0x5c, virtual true, abstract: false, final true
  inline void LogWarning(::StringW message);

  static inline ::BGNet::Logging::UnityLogger* New_ctor();

  /// @brief Method .ctor, addr 0x3341cd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
