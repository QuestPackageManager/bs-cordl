...
public:
  ...
  /// @brief Method .ctor, addr 0x5e49c48, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RangedRecord", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RangedRecord(RangedRecord&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RangedRecord", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RangedRecord(RangedRecordconst&) = delete;
