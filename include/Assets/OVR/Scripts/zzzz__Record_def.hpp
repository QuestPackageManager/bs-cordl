...
// Write type traits
MARK_REF_T(::Assets::OVR::Scripts::Record*);
DEFINE_IL2CPP_CLASS(::Assets::OVR::Scripts::Record*, "Assets.OVR.Scripts", "Record");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5e49c3c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Record", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Record(Record&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Record", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Record(Recordconst&) = delete;
...
static_assert(sizeof(::Assets::OVR::Scripts::Record) == 0x28, "Size mismatch!");
