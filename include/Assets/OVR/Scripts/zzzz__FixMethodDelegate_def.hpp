...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4073ff8, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x40740bc, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4073fe0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4073edc, size 0x104, virtual false, abstract: false, final false
