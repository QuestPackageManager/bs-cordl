...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5d0ddf0, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x5d0de6c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5d0dddc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d0dc94, size 0x148, virtual false, abstract: false, final false
