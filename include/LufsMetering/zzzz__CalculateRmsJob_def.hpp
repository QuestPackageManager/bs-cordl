...
public:
  ...
  /// @brief Method Execute, addr 0x3267e08, size 0x294, virtual true, abstract: false, final true
  inline void Execute(int32_t i);

  /// @brief Method .ctor, addr 0x3267df4, size 0x14, virtual false, abstract: false, final false
