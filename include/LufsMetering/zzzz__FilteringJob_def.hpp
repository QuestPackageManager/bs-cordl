...
public:
  ...
  /// @brief Method Execute, addr 0x3b78dd8, size 0xa4, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method .ctor, addr 0x3b78dbc, size 0x1c, virtual false, abstract: false, final false
