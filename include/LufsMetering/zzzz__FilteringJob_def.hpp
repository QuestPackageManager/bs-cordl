...
public:
  ...
  /// @brief Method Execute, addr 0x3b12898, size 0xa4, virtual true, abstract: false, final true
  inline void Execute();

  /// @brief Method .ctor, addr 0x3b1287c, size 0x1c, virtual false, abstract: false, final false
