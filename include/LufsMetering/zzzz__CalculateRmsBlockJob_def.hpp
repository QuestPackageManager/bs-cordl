...
public:
  ...
  /// @brief Method Create, addr 0x5836348, size 0xc, virtual false, abstract: false, final false
  static inline ::LufsMetering::CalculateRmsBlockJob Create(::Unity::Collections::NativeArray_1<float_t> inputData);

  /// @brief Method Execute, addr 0x5836354, size 0xc8, virtual true, abstract: false, final true
  inline void Execute();
