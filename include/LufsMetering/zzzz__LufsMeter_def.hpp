...
public:
  ...
  /// @brief Method <IntegratedLoudness>b__5_0, addr 0x5837ce4, size 0x8, virtual false, abstract: false, final false
  inline float_t _IntegratedLoudness_b__5_0(float_t g, float_t z);

  /// @brief Method .ctor, addr 0x5837ce0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AnalyzeClipLoudness, addr 0x583650c, size 0xc4, virtual false, abstract: false, final false
  inline ::LufsMetering::LoudnessData AnalyzeClipLoudness(::UnityEngine::AudioClip* clip);

  /// @brief Method IntegratedLoudness, addr 0x58365d0, size 0xe10, virtual false, abstract: false, final false
  ...
  /// @brief Method MomentaryLoudness, addr 0x58373f0, size 0x800, virtual false, abstract: false, final false
  ...
  /// @brief Method SwapData, addr 0x58373e0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5837bf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
