...
/// @brief Method <IntegratedLoudness>b__5_0, addr 0x57c7af4, size 0x8, virtual false, abstract: false, final false
inline float_t _IntegratedLoudness_b__5_0(float_t  g, float_t  z) ;

/// @brief Method .ctor, addr 0x57c7af0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _inputDataNative, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputDataNative, put=__cordl_internal_set__inputDataNative)) ::ArrayW<::Unity::Collections::NativeArray_1<float_t>,::Array<::Unity::Collections::NativeArray_1<float_t>>*>  _inputDataNative;

/// @brief Field _outputDataNative, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__outputDataNative, put=__cordl_internal_set__outputDataNative)) ::ArrayW<::Unity::Collections::NativeArray_1<float_t>,::Array<::Unity::Collections::NativeArray_1<float_t>>*>  _outputDataNative;

/// @brief Method AnalyzeClipLoudness, addr 0x57c631c, size 0xc4, virtual false, abstract: false, final false
inline ::LufsMetering::LoudnessData AnalyzeClipLoudness(::UnityEngine::AudioClip*  clip) ;

/// @brief Method IntegratedLoudness, addr 0x57c63e0, size 0xe10, virtual false, abstract: false, final false
...
/// @brief Method MomentaryLoudness, addr 0x57c7200, size 0x800, virtual false, abstract: false, final false
...
/// @brief Method SwapData, addr 0x57c71f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57c7a00, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
