...
// Write type traits
MARK_REF_T(::LufsMetering::LufsMeter*);
MARK_REF_T(::LufsMetering::LufsMeter___c*);
DEFINE_IL2CPP_CLASS(::LufsMetering::LufsMeter*, "LufsMetering", "LufsMeter");
DEFINE_IL2CPP_CLASS(::LufsMetering::LufsMeter___c*, "LufsMetering", "LufsMeter/<>c");
// [CompilerGenerated]
...
public:
  ...
  /// @brief Method <IntegratedLoudness>b__5_0, addr 0x3269240, size 0x8, virtual false, abstract: false, final false
  inline float_t _IntegratedLoudness_b__5_0(float_t g, float_t z);

  /// @brief Method .ctor, addr 0x326923c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LufsMeter___c", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LufsMeter___c(LufsMeter___c&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LufsMeter___c", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LufsMeter___c(LufsMeter___cconst&) = delete;
...
static_assert(sizeof(::LufsMetering::LufsMeter___c) == 0x10, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF__channelGains, put = setStaticF__channelGains)) ::ArrayW<float_t> _channelGains;

  /// @brief Field _inputDataNative, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get__inputDataNative, put = __cordl_internal_set__inputDataNative)) ::ArrayW<::Unity::Collections::NativeArray_1<float_t>> _inputDataNative;
  ...
  /// @brief Method AnalyzeClipLoudness, addr 0x326826c, size 0xc4, virtual false, abstract: false, final false
  inline ::LufsMetering::LoudnessData AnalyzeClipLoudness(::UnityEngine::AudioClip* clip);

  /// @brief Method IntegratedLoudness, addr 0x3268330, size 0xe10, virtual false, abstract: false, final false
  inline ::LufsMetering::LoudnessData IntegratedLoudness(::ArrayW<float_t> interleavedData, int32_t numChannels, int32_t rate);

  /// @brief Method MomentaryLoudness, addr 0x3265f50, size 0x780, virtual false, abstract: false, final false
  ...
  /// @brief Method SwapData, addr 0x3269140, size 0x10, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::Unity::Collections::NativeArray_1<float_t>>& __cordl_internal_get__inputDataNative();

  constexpr ::ArrayW<::Unity::Collections::NativeArray_1<float_t>> const& __cordl_internal_get__outputDataNative() const;

  constexpr ::ArrayW<::Unity::Collections::NativeArray_1<float_t>>& __cordl_internal_get__outputDataNative();

  constexpr void __cordl_internal_set__inputDataNative(::ArrayW<::Unity::Collections::NativeArray_1<float_t>> value);

  constexpr void __cordl_internal_set__outputDataNative(::ArrayW<::Unity::Collections::NativeArray_1<float_t>> value);

  /// @brief Method .ctor, addr 0x3266890, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<float_t> getStaticF__channelGains();

  static inline void setStaticF__channelGains(::ArrayW<float_t> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LufsMeter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LufsMeter(LufsMeter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LufsMeter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LufsMeter(LufsMeterconst&) = delete;
  ...
  ::ArrayW<::Unity::Collections::NativeArray_1<float_t>> ____inputDataNative;

  /// @brief Field _outputDataNative, offset: 0x18, size: 0x8, def value: None
  ::ArrayW<::Unity::Collections::NativeArray_1<float_t>> ____outputDataNative;
...
static_assert(sizeof(::LufsMetering::LufsMeter) == 0x20, "Size mismatch!");
