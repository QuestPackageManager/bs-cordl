...
public:
  // Declarations
  /// @brief Method GetHighPassDeManCoefficients, addr 0x57c5504, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHighShelfDeManCoefficients, addr 0x57c543c, size 0xc8, virtual false, abstract: false, final false
