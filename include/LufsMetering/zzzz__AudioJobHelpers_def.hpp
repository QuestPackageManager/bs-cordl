...
public:
  // Declarations
  /// @brief Method GetHighPassDeManCoefficients, addr 0x5836024, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHighShelfDeManCoefficients, addr 0x5835f5c, size 0xc8, virtual false, abstract: false, final false
