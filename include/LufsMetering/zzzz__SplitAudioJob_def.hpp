...
public:
  ...
  /// @brief Method Create, addr 0x583641c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x583642c, size 0x1c, virtual true, abstract: false, final true
