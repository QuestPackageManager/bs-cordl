...
public:
  ...
  /// @brief Method Create, addr 0x57c58fc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method Execute, addr 0x57c590c, size 0x1c, virtual true, abstract: false, final true
