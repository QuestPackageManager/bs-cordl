...
public:
// Declarations
/// @brief Method ToString, addr 0x57725cc, size 0x278, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x576c274, size 0x64, virtual false, abstract: false, final false
