...
public:
  // Declarations
  /// @brief Method ToString, addr 0x56a2448, size 0x278, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x569c0f0, size 0x64, virtual false, abstract: false, final false
