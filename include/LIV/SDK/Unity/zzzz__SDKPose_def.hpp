...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3ace020, size 0x278, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac7e24, size 0x70, virtual false, abstract: false, final false
