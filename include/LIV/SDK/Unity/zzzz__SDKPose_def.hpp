...
public:
  // Declarations
  /// @brief Method ToString, addr 0x57030f0, size 0x278, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x56fcd98, size 0x64, virtual false, abstract: false, final false
