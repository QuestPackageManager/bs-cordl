...
public:
  // Declarations
  /// @brief Method ToString, addr 0x24fb5ac, size 0x278, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x24f5228, size 0x70, virtual false, abstract: false, final false
