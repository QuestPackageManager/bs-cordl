...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3acb144, size 0xe8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3aca6ec, size 0x14, virtual false, abstract: false, final false
