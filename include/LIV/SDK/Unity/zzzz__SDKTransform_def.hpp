...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5702a58, size 0x114, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x5701fc0, size 0x14, virtual false, abstract: false, final false
