...
public:
// Declarations
/// @brief Method ToString, addr 0x57027e0, size 0x114, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x5701d48, size 0x14, virtual false, abstract: false, final false
