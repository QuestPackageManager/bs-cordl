...
public:
  // Declarations
  /// @brief Method ToString, addr 0x57706cc, size 0x114, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x576fc34, size 0x14, virtual false, abstract: false, final false
