...
public:
// Declarations
/// @brief Method ObtainControl, addr 0x5700340, size 0x14, virtual false, abstract: false, final false
inline void ObtainControl() ;

/// @brief Method ReleaseControl, addr 0x5700330, size 0x10, virtual false, abstract: false, final false
inline void ReleaseControl() ;

/// @brief Method ToString, addr 0x5701d5c, size 0x33c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x56fc01c, size 0x10c, virtual false, abstract: false, final false
