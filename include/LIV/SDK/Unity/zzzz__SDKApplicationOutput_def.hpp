...
public:
// Declarations
/// @brief Method ToString, addr 0x577121c, size 0x24c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x576ac44, size 0x6c, virtual false, abstract: false, final false
