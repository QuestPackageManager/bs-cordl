...
public:
  ...
  /// @brief Method StartBackgroundRendering, addr 0x260ebb8, size 0x44, virtual false, abstract: false, final false
  static inline void StartBackgroundRendering();

  /// @brief Method StartForegroundRendering, addr 0x260efe0, size 0x44, virtual false, abstract: false, final false
  static inline void StartForegroundRendering();

  /// @brief Method StartRendering, addr 0x260eb74, size 0x44, virtual false, abstract: false, final false
  static inline void StartRendering();

  /// @brief Method StopBackgroundRendering, addr 0x260ed88, size 0x44, virtual false, abstract: false, final false
  static inline void StopBackgroundRendering();

  /// @brief Method StopForegroundRendering, addr 0x260f094, size 0x44, virtual false, abstract: false, final false
  static inline void StopForegroundRendering();

  /// @brief Method StopRendering, addr 0x260edcc, size 0x44, virtual false, abstract: false, final false
