...
/// @brief Method StartBackgroundRendering, addr 0x576df70, size 0x48, virtual false, abstract: false, final false
static inline void StartBackgroundRendering() ;

/// @brief Method StartForegroundRendering, addr 0x576e37c, size 0x48, virtual false, abstract: false, final false
static inline void StartForegroundRendering() ;

/// @brief Method StartRendering, addr 0x576df28, size 0x48, virtual false, abstract: false, final false
static inline void StartRendering() ;

/// @brief Method StopBackgroundRendering, addr 0x576e110, size 0x48, virtual false, abstract: false, final false
static inline void StopBackgroundRendering() ;

/// @brief Method StopForegroundRendering, addr 0x576e424, size 0x48, virtual false, abstract: false, final false
static inline void StopForegroundRendering() ;

/// @brief Method StopRendering, addr 0x576e158, size 0x48, virtual false, abstract: false, final false
