...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LIV::SDK::Unity::SDKPose (*)()>(&::LIV::SDK::Unity::SDKPose::get_empty)> {
  ...
  constexpr static std::size_t addrs = 0x576c274;
...
constexpr ::LIV::SDK::Unity::SDKPose::SDKPose(::LIV::SDK::Unity::SDKMatrix4x4  projectionMatrix, ::LIV::SDK::Unity::SDKVector3  localPosition, ::LIV::SDK::Unity::SDKQuaternion  localRotation, float_t  verticalFieldOfView, float_t  nearClipPlane, float_t  farClipPlane, int32_t  unused0, int32_t  unused1) noexcept  {
