...
public:
  ...
  /// @brief Method MoveNext, addr 0x576978c, size 0x108, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x576995c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5769964, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x576999c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5769788, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5768e28, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Activate, addr 0x5768e30, size 0x18, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method CreateAssets, addr 0x5769188, size 0x6c, virtual false, abstract: false, final false
  inline void CreateAssets();

  /// @brief Method DestroyAssets, addr 0x576925c, size 0x20, virtual false, abstract: false, final false
  inline void DestroyAssets();

  /// @brief Method Invalidate, addr 0x5768d54, size 0x78, virtual false, abstract: false, final false
  inline void Invalidate();

  static inline ::LIV::SDK::Unity::LIV* New_ctor();

  /// @brief Method OnDisable, addr 0x5768dcc, size 0x8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5768cec, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnSDKActivate, addr 0x5768e54, size 0xb4, virtual false, abstract: false, final false
  inline void OnSDKActivate();

  /// @brief Method OnSDKDeactivate, addr 0x5768f08, size 0xbc, virtual false, abstract: false, final false
  inline void OnSDKDeactivate();

  /// @brief Method OnSDKReadyChanged, addr 0x5768e48, size 0xc, virtual false, abstract: false, final false
  inline void OnSDKReadyChanged(bool value);

  /// @brief Method StartRenderCoroutine, addr 0x57691f4, size 0x44, virtual false, abstract: false, final false
  inline void StartRenderCoroutine();

  /// @brief Method StopRenderCoroutine, addr 0x5769238, size 0x24, virtual false, abstract: false, final false
  inline void StopRenderCoroutine();

  /// @brief Method SubmitSDKOutput, addr 0x5768fc4, size 0x1c4, virtual false, abstract: false, final false
  inline void SubmitSDKOutput();

  /// @brief Method Update, addr 0x5768d3c, size 0x18, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateSDKReady, addr 0x5768cf8, size 0x44, virtual false, abstract: false, final false
  inline void UpdateSDKReady();

  /// @brief Method WaitForUnityEndOfFrame, addr 0x5768dd4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5769650, size 0x138, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HMDCamera, addr 0x57688e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_HMDCamera();

  /// @brief Method get_MRCameraPrefab, addr 0x57689e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_MRCameraPrefab();

  /// @brief Method get__isReady, addr 0x5768bcc, size 0x78, virtual false, abstract: false, final false
  inline bool get__isReady();

  /// @brief Method get_disableStandardAssets, addr 0x5768a74, size 0x8, virtual false, abstract: false, final false
  inline bool get_disableStandardAssets();

  /// @brief Method get_excludeBehaviours, addr 0x5768a94, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_excludeBehaviours();

  /// @brief Method get_fixPostEffectsAlpha, addr 0x5768abc, size 0x8, virtual false, abstract: false, final false
  inline bool get_fixPostEffectsAlpha();

  /// @brief Method get_isActive, addr 0x5768bc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActive();

  /// @brief Method get_isValid, addr 0x5768acc, size 0xf8, virtual false, abstract: false, final false
  inline bool get_isValid();

  /// @brief Method get_render, addr 0x5768ce4, size 0x8, virtual false, abstract: false, final false
  inline ::LIV::SDK::Unity::SDKRender* get_render();

  /// @brief Method get_spectatorLayerMask, addr 0x5768a84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_spectatorLayerMask();

  /// @brief Method get_stage, addr 0x5768594, size 0x90, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_stage();

  /// @brief Method get_stageLocalToWorldMatrix, addr 0x57686d4, size 0x100, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix();

  /// @brief Method get_stageTransform, addr 0x57688d4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_stageTransform();

  /// @brief Method get_stageWorldToLocalMatrix, addr 0x57687d4, size 0x100, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 get_stageWorldToLocalMatrix();

  /// @brief Method get_trackedSpaceOrigin, addr 0x57686cc, size 0x4, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_trackedSpaceOrigin();

  /// @brief Method set_HMDCamera, addr 0x57688ec, size 0xf8, virtual false, abstract: false, final false
  inline void set_HMDCamera(::UnityEngine::Camera* value);

  /// @brief Method set_MRCameraPrefab, addr 0x57689ec, size 0x88, virtual false, abstract: false, final false
  inline void set_MRCameraPrefab(::UnityEngine::Camera* value);

  /// @brief Method set_disableStandardAssets, addr 0x5768a7c, size 0x8, virtual false, abstract: false, final false
  inline void set_disableStandardAssets(bool value);

  /// @brief Method set_excludeBehaviours, addr 0x5768a9c, size 0x20, virtual false, abstract: false, final false
  inline void set_excludeBehaviours(::ArrayW<::StringW, ::Array<::StringW>*> value);

  /// @brief Method set_fixPostEffectsAlpha, addr 0x5768ac4, size 0x8, virtual false, abstract: false, final false
  inline void set_fixPostEffectsAlpha(bool value);

  /// @brief Method set_spectatorLayerMask, addr 0x5768a8c, size 0x8, virtual false, abstract: false, final false
  inline void set_spectatorLayerMask(::UnityEngine::LayerMask value);

  /// @brief Method set_stage, addr 0x5768624, size 0x94, virtual false, abstract: false, final false
  inline void set_stage(::UnityEngine::Transform* value);

  /// @brief Method set_stageTransform, addr 0x57688dc, size 0x8, virtual false, abstract: false, final false
  inline void set_stageTransform(::UnityEngine::Transform* value);

  /// @brief Method set_trackedSpaceOrigin, addr 0x57686d0, size 0x4, virtual false, abstract: false, final false
