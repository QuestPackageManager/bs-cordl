...
public:
  // Declarations
  /// @brief Method Perspective, addr 0x3ac6f40, size 0xac, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Perspective(float_t vFov, float_t aspect, float_t zNear, float_t zFar);

  /// @brief Method Rotate, addr 0x3ac7184, size 0x94, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Rotate(::LIV::SDK::Unity::SDKQuaternion value);

  /// @brief Method Scale, addr 0x3ac7218, size 0x2c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Scale(::LIV::SDK::Unity::SDKVector3 value);

  /// @brief Method TRS, addr 0x3ac7244, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x3ac7334, size 0x4ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Translate, addr 0x3ac713c, size 0x48, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 Translate(::LIV::SDK::Unity::SDKVector3 value);

  /// @brief Method get_identity, addr 0x3ac6f14, size 0x2c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 get_identity();

  /// @brief Method op_Implicit, addr 0x3ac6064, size 0x44, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 op_Implicit___LIV__SDK__Unity__SDKMatrix4x4(::UnityEngine::Matrix4x4 v);

  /// @brief Method op_Implicit, addr 0x3ac4d78, size 0x44, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 op_Implicit___UnityEngine__Matrix4x4(::LIV::SDK::Unity::SDKMatrix4x4 v);

  /// @brief Method op_Multiply, addr 0x3ac6fec, size 0xf8, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKMatrix4x4 op_Multiply(::LIV::SDK::Unity::SDKMatrix4x4 lhs, ::LIV::SDK::Unity::SDKMatrix4x4 rhs);

  /// @brief Method op_Multiply, addr 0x3ac70e4, size 0x58, virtual false, abstract: false, final false
