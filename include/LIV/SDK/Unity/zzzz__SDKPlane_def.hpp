...
public:
  // Declarations
  /// @brief Method op_Implicit, addr 0x2214c44, size 0x5c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKPlane op_Implicit___LIV__SDK__Unity__SDKPlane(::UnityEngine::Plane v);

  /// @brief Method get_empty, addr 0x2214ca0, size 0x14, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKPlane get_empty();

  /// @brief Method ToString, addr 0x2214cb4, size 0xc4, virtual true, abstract: false, final false
