...
namespace LIV::SDK::Unity {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14982))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(14985))
// CS Name: ::LIV.SDK.Unity::SDKPlane
struct CORDL_TYPE SDKPlane {
public:
  // Declarations
  /// @brief Method op_Implicit, addr 0x22aa52c, size 0x5c, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKPlane op_Implicit___LIV__SDK__Unity__SDKPlane(::UnityEngine::Plane v);

  /// @brief Method get_empty, addr 0x22aa588, size 0x14, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKPlane get_empty();

  /// @brief Method ToString, addr 0x22aa59c, size 0xc4, virtual true, abstract: false, final false
