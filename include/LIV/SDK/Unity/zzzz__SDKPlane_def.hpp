...
public:
  // Declarations
  /// @brief Method ToString, addr 0x23d89dc, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x23d89c8, size 0x14, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKPlane get_empty();

  /// @brief Method op_Implicit, addr 0x23d896c, size 0x5c, virtual false, abstract: false, final false
