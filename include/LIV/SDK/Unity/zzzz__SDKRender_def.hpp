...
/// @brief Method CreateAssets, addr 0x56fcb84, size 0x798, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method CreateBackgroundTexture, addr 0x5700354, size 0x9c, virtual false, abstract: false, final false
inline void CreateBackgroundTexture() ;

/// @brief Method CreateComplexClipPlaneTexture, addr 0x57006a4, size 0x9c, virtual false, abstract: false, final false
inline void CreateComplexClipPlaneTexture() ;

/// @brief Method CreateForegroundTexture, addr 0x570056c, size 0x9c, virtual false, abstract: false, final false
inline void CreateForegroundTexture() ;

/// @brief Method CreateOptimizedTexture, addr 0x5700608, size 0x9c, virtual false, abstract: false, final false
inline void CreateOptimizedTexture() ;

/// @brief Method DestroyAssets, addr 0x56ff654, size 0x194, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Dispose, addr 0x56fb4b8, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetClipPlaneMaterial, addr 0x56fc708, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetGroundClipPlaneMaterial, addr 0x56fc810, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method InvokePostRenderBackground, addr 0x56fe98c, size 0x30, virtual false, abstract: false, final false
inline void InvokePostRenderBackground() ;

/// @brief Method InvokePostRenderForeground, addr 0x56feca0, size 0x30, virtual false, abstract: false, final false
inline void InvokePostRenderForeground() ;

/// @brief Method InvokePreRender, addr 0x56fdc30, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRender() ;

/// @brief Method InvokePreRenderBackground, addr 0x56fe864, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRenderBackground() ;

/// @brief Method InvokePreRenderForeground, addr 0x56fec70, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRenderForeground() ;

/// @brief Method IvokePostRender, addr 0x56fe644, size 0x30, virtual false, abstract: false, final false
inline void IvokePostRender() ;

static inline ::LIV::SDK::Unity::SDKRender* New_ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method ReleaseBridgePoseControl, addr 0x56ff7e8, size 0x64, virtual false, abstract: false, final false
inline void ReleaseBridgePoseControl() ;

/// @brief Method Render, addr 0x56fb9a8, size 0xc8, virtual false, abstract: false, final false
inline void Render() ;

/// @brief Method RenderBackground, addr 0x56fdc60, size 0x11c, virtual false, abstract: false, final false
inline void RenderBackground() ;

/// @brief Method RenderForeground, addr 0x56fdd7c, size 0x474, virtual false, abstract: false, final false
inline void RenderForeground() ;

/// @brief Method RenderOptimized, addr 0x56fe1f0, size 0x454, virtual false, abstract: false, final false
inline void RenderOptimized() ;

/// @brief Method SendTextureToBridge, addr 0x56fe894, size 0xf8, virtual false, abstract: false, final false
inline void SendTextureToBridge(::UnityEngine::RenderTexture*  texture, ::LIV::SDK::Unity::TEXTURE_ID  id) ;

/// @brief Method SetGroundPlane, addr 0x56fffa8, size 0x1bc, virtual false, abstract: false, final false
inline void SetGroundPlane(float_t  distance, ::UnityEngine::Vector3  normal, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x5700164, size 0x18, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Plane  plane, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x570017c, size 0x1b4, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Transform*  transform, bool  useLocalSpace) ;

/// @brief Method SetPose, addr 0x56ffa88, size 0x358, virtual false, abstract: false, final false
...
/// @brief Method UpdateBridgeInputFrame, addr 0x56fd3a0, size 0x1a8, virtual false, abstract: false, final false
inline void UpdateBridgeInputFrame() ;

/// @brief Method UpdateBridgeResolution, addr 0x56fd874, size 0x58, virtual false, abstract: false, final false
inline void UpdateBridgeResolution() ;

/// @brief Method UpdateCameraSettings, addr 0x56fd31c, size 0x84, virtual false, abstract: false, final false
inline void UpdateCameraSettings() ;

/// @brief Method UpdateTextures, addr 0x56fd9c0, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56fb390, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method get_cameraInstance, addr 0x56ff914, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraInstance() ;

/// @brief Method get_cameraReference, addr 0x56feda0, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraReference() ;

/// @brief Method get_canRenderBackground, addr 0x56fc8ec, size 0xa8, virtual false, abstract: false, final false
inline bool get_canRenderBackground() ;

/// @brief Method get_canRenderForeground, addr 0x56fc994, size 0xb0, virtual false, abstract: false, final false
inline bool get_canRenderForeground() ;

/// @brief Method get_canRenderOptimized, addr 0x56fca44, size 0x7c, virtual false, abstract: false, final false
inline bool get_canRenderOptimized() ;

/// @brief Method get_canSetPose, addr 0x56ffa68, size 0x20, virtual false, abstract: false, final false
inline bool get_canSetPose() ;

/// @brief Method get_disableStandardAssets, addr 0x56fea4c, size 0x18, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_hmdCamera, addr 0x56ff91c, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_hmdCamera() ;

/// @brief Method get_inputFrame, addr 0x56ff8fc, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKInputFrame get_inputFrame() ;

/// @brief Method get_interlacedRendering, addr 0x56fc8d4, size 0xc, virtual false, abstract: false, final false
inline bool get_interlacedRendering() ;

/// @brief Method get_liv, addr 0x56ff8e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::LIV::SDK::Unity::LIV> get_liv() ;

/// @brief Method get_localToWorldMatrix, addr 0x56fd548, size 0xc8, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_outputFrame, addr 0x56ff8ec, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKOutputFrame get_outputFrame() ;

/// @brief Method get_resolution, addr 0x56ff90c, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKResolution get_resolution() ;

/// @brief Method get_spectatorLayerMask, addr 0x56fd610, size 0x18, virtual false, abstract: false, final false
inline int32_t get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x56ff934, size 0x14, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x56ff960, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x56ff948, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_useDeferredRendering, addr 0x56fc8ac, size 0x28, virtual false, abstract: false, final false
