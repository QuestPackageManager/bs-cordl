...
// Dependencies LIV.SDK.Unity.SDKInputFrame, LIV.SDK.Unity.SDKOutputFrame, LIV.SDK.Unity.SDKPose, LIV.SDK.Unity.SDKResolution, System.Object, UnityEngine.Rendering.CameraEvent
namespace LIV::SDK::Unity {
// Is value type: false
...
/// @brief Field _captureTextureCommandBuffer, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__captureTextureCommandBuffer, put=__cordl_internal_set__captureTextureCommandBuffer)) ::UnityEngine::Rendering::CommandBuffer*  _captureTextureCommandBuffer;
...
/// @brief Field _clipPlaneComplexDebugMaterial, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__clipPlaneComplexDebugMaterial, put=__cordl_internal_set__clipPlaneComplexDebugMaterial)) ::UnityW<::UnityEngine::Material>  _clipPlaneComplexDebugMaterial;
...
/// @brief Field _clipPlaneSimpleDebugMaterial, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__clipPlaneSimpleDebugMaterial, put=__cordl_internal_set__clipPlaneSimpleDebugMaterial)) ::UnityW<::UnityEngine::Material>  _clipPlaneSimpleDebugMaterial;
...
/// @brief Field _complexClipPlaneRenderTexture, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__complexClipPlaneRenderTexture, put=__cordl_internal_set__complexClipPlaneRenderTexture)) ::UnityW<::UnityEngine::RenderTexture>  _complexClipPlaneRenderTexture;

/// @brief Field _forceForwardRenderingMaterial, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__forceForwardRenderingMaterial, put=__cordl_internal_set__forceForwardRenderingMaterial)) ::UnityW<::UnityEngine::Material>  _forceForwardRenderingMaterial;
...
/// @brief Field _optimizedRenderingCameraEvent, offset 0x3c, size 0x4 
 __declspec(property(get=__cordl_internal_get__optimizedRenderingCameraEvent, put=__cordl_internal_set__optimizedRenderingCameraEvent)) ::UnityEngine::Rendering::CameraEvent  _optimizedRenderingCameraEvent;

/// @brief Field _optimizedRenderingCommandBuffer, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__optimizedRenderingCommandBuffer, put=__cordl_internal_set__optimizedRenderingCommandBuffer)) ::UnityEngine::Rendering::CommandBuffer*  _optimizedRenderingCommandBuffer;
...
/// @brief Method CreateAssets, addr 0x576c2d8, size 0x798, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method CreateBackgroundTexture, addr 0x576faa8, size 0x9c, virtual false, abstract: false, final false
inline void CreateBackgroundTexture() ;

/// @brief Method CreateComplexClipPlaneTexture, addr 0x576fdf8, size 0x9c, virtual false, abstract: false, final false
inline void CreateComplexClipPlaneTexture() ;

/// @brief Method CreateForegroundTexture, addr 0x576fcc0, size 0x9c, virtual false, abstract: false, final false
inline void CreateForegroundTexture() ;

/// @brief Method CreateOptimizedTexture, addr 0x576fd5c, size 0x9c, virtual false, abstract: false, final false
inline void CreateOptimizedTexture() ;

/// @brief Method DestroyAssets, addr 0x576eda8, size 0x194, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Dispose, addr 0x576ac0c, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetClipPlaneMaterial, addr 0x576be5c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetGroundClipPlaneMaterial, addr 0x576bf64, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method InvokePostRenderBackground, addr 0x576e0e0, size 0x30, virtual false, abstract: false, final false
inline void InvokePostRenderBackground() ;

/// @brief Method InvokePostRenderForeground, addr 0x576e3f4, size 0x30, virtual false, abstract: false, final false
inline void InvokePostRenderForeground() ;

/// @brief Method InvokePreRender, addr 0x576d384, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRender() ;

/// @brief Method InvokePreRenderBackground, addr 0x576dfb8, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRenderBackground() ;

/// @brief Method InvokePreRenderForeground, addr 0x576e3c4, size 0x30, virtual false, abstract: false, final false
inline void InvokePreRenderForeground() ;

/// @brief Method IvokePostRender, addr 0x576dd98, size 0x30, virtual false, abstract: false, final false
inline void IvokePostRender() ;

static inline ::LIV::SDK::Unity::SDKRender* New_ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method ReleaseBridgePoseControl, addr 0x576ef3c, size 0x64, virtual false, abstract: false, final false
inline void ReleaseBridgePoseControl() ;

/// @brief Method Render, addr 0x576b0fc, size 0xc8, virtual false, abstract: false, final false
inline void Render() ;

/// @brief Method RenderBackground, addr 0x576d3b4, size 0x11c, virtual false, abstract: false, final false
inline void RenderBackground() ;

/// @brief Method RenderForeground, addr 0x576d4d0, size 0x474, virtual false, abstract: false, final false
inline void RenderForeground() ;

/// @brief Method RenderOptimized, addr 0x576d944, size 0x454, virtual false, abstract: false, final false
inline void RenderOptimized() ;

/// @brief Method SendTextureToBridge, addr 0x576dfe8, size 0xf8, virtual false, abstract: false, final false
inline void SendTextureToBridge(::UnityEngine::RenderTexture*  texture, ::LIV::SDK::Unity::TEXTURE_ID  id) ;

/// @brief Method SetGroundPlane, addr 0x576f6fc, size 0x1bc, virtual false, abstract: false, final false
inline void SetGroundPlane(float_t  distance, ::UnityEngine::Vector3  normal, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x576f8b8, size 0x18, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Plane  plane, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x576f8d0, size 0x1b4, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Transform*  transform, bool  useLocalSpace) ;

/// @brief Method SetPose, addr 0x576f1dc, size 0x358, virtual false, abstract: false, final false
...
/// @brief Method UpdateBridgeInputFrame, addr 0x576caf4, size 0x1a8, virtual false, abstract: false, final false
inline void UpdateBridgeInputFrame() ;

/// @brief Method UpdateBridgeResolution, addr 0x576cfc8, size 0x58, virtual false, abstract: false, final false
inline void UpdateBridgeResolution() ;

/// @brief Method UpdateCameraSettings, addr 0x576ca70, size 0x84, virtual false, abstract: false, final false
inline void UpdateCameraSettings() ;

/// @brief Method UpdateTextures, addr 0x576d114, size 0x270, virtual false, abstract: false, final false
inline void UpdateTextures() ;

constexpr ::UnityEngine::Rendering::CommandBuffer* const& __cordl_internal_get__applyTextureCommandBuffer() const;
...
constexpr ::UnityEngine::Rendering::CommandBuffer* const& __cordl_internal_get__captureTextureCommandBuffer() const;
...
constexpr ::UnityEngine::Rendering::CommandBuffer* const& __cordl_internal_get__clipPlaneCommandBuffer() const;
...
constexpr ::UnityEngine::Rendering::CommandBuffer* const& __cordl_internal_get__combineAlphaCommandBuffer() const;
...
constexpr ::UnityEngine::Rendering::CommandBuffer* const& __cordl_internal_get__optimizedRenderingCommandBuffer() const;
...
/// @brief Method .ctor, addr 0x576aae4, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method get_cameraInstance, addr 0x576f068, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraInstance() ;

/// @brief Method get_cameraReference, addr 0x576e4f4, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraReference() ;

/// @brief Method get_canRenderBackground, addr 0x576c040, size 0xa8, virtual false, abstract: false, final false
inline bool get_canRenderBackground() ;

/// @brief Method get_canRenderForeground, addr 0x576c0e8, size 0xb0, virtual false, abstract: false, final false
inline bool get_canRenderForeground() ;

/// @brief Method get_canRenderOptimized, addr 0x576c198, size 0x7c, virtual false, abstract: false, final false
inline bool get_canRenderOptimized() ;

/// @brief Method get_canSetPose, addr 0x576f1bc, size 0x20, virtual false, abstract: false, final false
inline bool get_canSetPose() ;

/// @brief Method get_disableStandardAssets, addr 0x576e1a0, size 0x18, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_hmdCamera, addr 0x576f070, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_hmdCamera() ;

/// @brief Method get_inputFrame, addr 0x576f050, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKInputFrame get_inputFrame() ;

/// @brief Method get_interlacedRendering, addr 0x576c028, size 0xc, virtual false, abstract: false, final false
inline bool get_interlacedRendering() ;

/// @brief Method get_liv, addr 0x576f038, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::LIV::SDK::Unity::LIV> get_liv() ;

/// @brief Method get_localToWorldMatrix, addr 0x576cc9c, size 0xc8, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_outputFrame, addr 0x576f040, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKOutputFrame get_outputFrame() ;

/// @brief Method get_resolution, addr 0x576f060, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKResolution get_resolution() ;

/// @brief Method get_spectatorLayerMask, addr 0x576cd64, size 0x18, virtual false, abstract: false, final false
inline int32_t get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x576f088, size 0x14, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x576f0b4, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x576f09c, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_useDeferredRendering, addr 0x576c000, size 0x28, virtual false, abstract: false, final false
