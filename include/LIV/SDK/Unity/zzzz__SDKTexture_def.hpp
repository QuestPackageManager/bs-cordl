...
public:
  // Declarations
  /// @brief Method ToString, addr 0x2503b8c, size 0x3a4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x24fd8b4, size 0x5c, virtual false, abstract: false, final false
