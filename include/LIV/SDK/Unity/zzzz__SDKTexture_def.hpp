...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3ac849c, size 0x3a4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac23c0, size 0x14, virtual false, abstract: false, final false
