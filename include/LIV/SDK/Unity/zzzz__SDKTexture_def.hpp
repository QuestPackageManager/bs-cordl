...
public:
  // Declarations
  /// @brief Method ToString, addr 0x56a1a14, size 0x39c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x569b7b8, size 0x14, virtual false, abstract: false, final false
