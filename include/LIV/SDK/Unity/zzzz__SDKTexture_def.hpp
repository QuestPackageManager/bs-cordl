...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3acd604, size 0x3a4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac7528, size 0x14, virtual false, abstract: false, final false
