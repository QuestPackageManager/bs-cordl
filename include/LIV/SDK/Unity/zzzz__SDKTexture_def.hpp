...
namespace LIV::SDK::Unity {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15106)), TypeDefinitionIndex(TypeDefinitionIndex(15104)), TypeDefinitionIndex(TypeDefinitionIndex(2603)),
// TypeDefinitionIndex(TypeDefinitionIndex(15105)), TypeDefinitionIndex(TypeDefinitionIndex(15102)), TypeDefinitionIndex(TypeDefinitionIndex(15103))} Self:
