...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5770330, size 0x39c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x576a0d4, size 0x14, virtual false, abstract: false, final false
