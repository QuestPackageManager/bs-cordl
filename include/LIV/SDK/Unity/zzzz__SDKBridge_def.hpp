...
namespace LIV::SDK::Unity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(14968)), TypeDefinitionIndex(TypeDefinitionIndex(14981)),
// TypeDefinitionIndex(TypeDefinitionIndex(14988)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14968), inst: 77 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(14968), inst: 4917 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14968), inst: 4918 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(14969)) CS Name:
...
public:
  ...
  /// @brief Method AddStringToChannel, addr 0x22a4404, size 0x8, virtual false, abstract: false, final false
  static inline int32_t AddStringToChannel(int32_t slot, void* str, int32_t length, uint64_t tag);

  /// @brief Method addtexture, addr 0x22a440c, size 0x8, virtual false, abstract: false, final false
  static inline int32_t addtexture(void* sourcetexture, uint64_t tag);

  /// @brief Method GetObjectTimeStamp, addr 0x22a4414, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t GetObjectTimeStamp(void* obj);

  /// @brief Method GetCurrentTimeTicks, addr 0x22a441c, size 0x8, virtual false, abstract: false, final false
  static inline uint64_t GetCurrentTimeTicks();

  /// @brief Method GetIsCaptureActive, addr 0x22a4424, size 0x8, virtual false, abstract: false, final false
  static inline bool GetIsCaptureActive();

  /// @brief Method GetRenderEventFunc, addr 0x22a442c, size 0x48, virtual false, abstract: false, final false
  static inline void* GetRenderEventFunc();

  /// @brief Method GetCompositorChannelObject, addr 0x22a4474, size 0x48, virtual false, abstract: false, final false
  static inline void* GetCompositorChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp);

  /// @brief Method AddObjectToCompositorChannel, addr 0x22a44bc, size 0x8, virtual false, abstract: false, final false
  static inline int32_t AddObjectToCompositorChannel(int32_t slot, void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method AddObjectToFrame, addr 0x22a44c4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t AddObjectToFrame(void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method updatinputframe, addr 0x22a44cc, size 0x48, virtual false, abstract: false, final false
  static inline void* updatinputframe(void* InputFrame);

  /// @brief Method GetViewportTexture, addr 0x22a4514, size 0x48, virtual false, abstract: false, final false
  static inline void* GetViewportTexture();

  /// @brief Method GetChannelObject, addr 0x22a455c, size 0x48, virtual false, abstract: false, final false
  static inline void* GetChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp);

  /// @brief Method AddObjectToChannel, addr 0x22a45a4, size 0x8, virtual false, abstract: false, final false
  static inline int32_t AddObjectToChannel(int32_t slot, void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method Tag, addr 0x22a45ac, size 0x84, virtual false, abstract: false, final false
  static inline uint64_t Tag(::StringW str);

  /// @brief Method AddString, addr 0x22a4630, size 0xfc, virtual false, abstract: false, final false
  static inline void AddString(::StringW tag, ::StringW value, int32_t slot);

  /// @brief Method AddTexture, addr 0x22a472c, size 0xc0, virtual false, abstract: false, final false
  static inline void AddTexture(::LIV::SDK::Unity::SDKTexture texture, uint64_t tag);

  /// @brief Method GetObjectTime, addr 0x22a47ec, size 0x5c, virtual false, abstract: false, final false
  static inline uint64_t GetObjectTime(void* objectptr);

  /// @brief Method GetCurrentTime, addr 0x22a4848, size 0x5c, virtual false, abstract: false, final false
  static inline uint64_t GetCurrentTime();

  /// @brief Method get_IsActive, addr 0x22a364c, size 0x98, virtual false, abstract: false, final false
  static inline bool get_IsActive();

  /// @brief Method IssuePluginEvent, addr 0x22a48a4, size 0xb0, virtual false, abstract: false, final false
  static inline void IssuePluginEvent();

  /// @brief Method SubmitApplicationOutput, addr 0x22a3e60, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateInputFrame, addr 0x22a4954, size 0x2c0, virtual false, abstract: false, final false
  static inline bool UpdateInputFrame(ByRef<::LIV::SDK::Unity::SDKInputFrame> setframe);

  /// @brief Method GetViewfinderTexture, addr 0x22a4d58, size 0x1d4, virtual false, abstract: false, final false
  static inline ::LIV::SDK::Unity::SDKTexture GetViewfinderTexture();

  /// @brief Method AddTexture, addr 0x22a4f88, size 0x130, virtual false, abstract: false, final false
  static inline void AddTexture(::LIV::SDK::Unity::SDKTexture texture);

  /// @brief Method CreateFrame, addr 0x22a50b8, size 0x168, virtual false, abstract: false, final false
  static inline void CreateFrame(::LIV::SDK::Unity::SDKOutputFrame frame);

  /// @brief Method SetGroundPlane, addr 0x22a5220, size 0xa0, virtual false, abstract: false, final false
  static inline void SetGroundPlane(::LIV::SDK::Unity::SDKPlane groundPlane);

  /// @brief Method GetResolution, addr 0x22a52c0, size 0x130, virtual false, abstract: false, final false
