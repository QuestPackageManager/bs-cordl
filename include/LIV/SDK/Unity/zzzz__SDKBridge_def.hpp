...
namespace LIV::SDK::Unity {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15199), inst: 4840 }), TypeDefinitionIndex(TypeDefinitionIndex(15199)), GenericInstantiation(GenericInstantiation
// { tdi: TypeDefinitionIndex(15199), inst: 112 }), TypeDefinitionIndex(TypeDefinitionIndex(15212)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15199), inst: 4839 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15219)), TypeDefinitionIndex(TypeDefinitionIndex(2611))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15200)) CS Name: ::LIV.SDK.Unity::SDKBridge*
...
public:
  ...
  /// @brief Method AddStringToChannel addr 0x20adbe4 size 0x8 virtual false final false
  static inline int32_t AddStringToChannel(int32_t slot, void* str, int32_t length, uint64_t tag);

  /// @brief Method addtexture addr 0x20adbec size 0x8 virtual false final false
  static inline int32_t addtexture(void* sourcetexture, uint64_t tag);

  /// @brief Method GetObjectTimeStamp addr 0x20adbf4 size 0x8 virtual false final false
  static inline uint64_t GetObjectTimeStamp(void* obj);

  /// @brief Method GetCurrentTimeTicks addr 0x20adbfc size 0x8 virtual false final false
  static inline uint64_t GetCurrentTimeTicks();

  /// @brief Method GetIsCaptureActive addr 0x20adc04 size 0x8 virtual false final false
  static inline bool GetIsCaptureActive();

  /// @brief Method GetRenderEventFunc addr 0x20adc0c size 0x48 virtual false final false
  static inline void* GetRenderEventFunc();

  /// @brief Method GetCompositorChannelObject addr 0x20adc54 size 0x48 virtual false final false
  static inline void* GetCompositorChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp);

  /// @brief Method AddObjectToCompositorChannel addr 0x20adc9c size 0x8 virtual false final false
  static inline int32_t AddObjectToCompositorChannel(int32_t slot, void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method AddObjectToFrame addr 0x20adca4 size 0x8 virtual false final false
  static inline int32_t AddObjectToFrame(void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method updatinputframe addr 0x20adcac size 0x48 virtual false final false
  static inline void* updatinputframe(void* InputFrame);

  /// @brief Method GetViewportTexture addr 0x20adcf4 size 0x48 virtual false final false
  static inline void* GetViewportTexture();

  /// @brief Method GetChannelObject addr 0x20add3c size 0x48 virtual false final false
  static inline void* GetChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp);

  /// @brief Method AddObjectToChannel addr 0x20add84 size 0x8 virtual false final false
  static inline int32_t AddObjectToChannel(int32_t slot, void* obj, int32_t objectsize, uint64_t tag);

  /// @brief Method Tag addr 0x20add8c size 0x84 virtual false final false
  static inline uint64_t Tag(::StringW str);

  /// @brief Method AddString addr 0x20ade10 size 0xfc virtual false final false
  static inline void AddString(::StringW tag, ::StringW value, int32_t slot);

  /// @brief Method AddTexture addr 0x20adf0c size 0xc0 virtual false final false
  static inline void AddTexture(::LIV::SDK::Unity::SDKTexture texture, uint64_t tag);

  /// @brief Method GetObjectTime addr 0x20adfcc size 0x5c virtual false final false
  static inline uint64_t GetObjectTime(void* objectptr);

  /// @brief Method GetCurrentTime addr 0x20ae028 size 0x5c virtual false final false
  static inline uint64_t GetCurrentTime();

  /// @brief Method get_IsActive addr 0x20ace2c size 0x98 virtual false final false
  static inline bool get_IsActive();

  /// @brief Method IssuePluginEvent addr 0x20ae084 size 0xb0 virtual false final false
  static inline void IssuePluginEvent();

  /// @brief Method SubmitApplicationOutput addr 0x20ad640 size 0x1f0 virtual false final false
  ...
  /// @brief Method UpdateInputFrame addr 0x20ae134 size 0x2c0 virtual false final false
  static inline bool UpdateInputFrame(ByRef<::LIV::SDK::Unity::SDKInputFrame> setframe);

  /// @brief Method GetViewfinderTexture addr 0x20ae538 size 0x1d4 virtual false final false
  static inline ::LIV::SDK::Unity::SDKTexture GetViewfinderTexture();

  /// @brief Method AddTexture addr 0x20ae768 size 0x130 virtual false final false
  static inline void AddTexture(::LIV::SDK::Unity::SDKTexture texture);

  /// @brief Method CreateFrame addr 0x20ae898 size 0x168 virtual false final false
  static inline void CreateFrame(::LIV::SDK::Unity::SDKOutputFrame frame);

  /// @brief Method SetGroundPlane addr 0x20aea00 size 0xa0 virtual false final false
  static inline void SetGroundPlane(::LIV::SDK::Unity::SDKPlane groundPlane);

  /// @brief Method GetResolution addr 0x20aeaa0 size 0x130 virtual false final false
