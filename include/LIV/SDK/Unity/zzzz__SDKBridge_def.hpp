...
namespace LIV::SDK::Unity {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15095), inst: 4947 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15095), inst: 4946
// }), TypeDefinitionIndex(TypeDefinitionIndex(15095)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15095), inst: 105 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15108)), TypeDefinitionIndex(TypeDefinitionIndex(15115))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15096)) CS Name: ::LIV.SDK.Unity::SDKBridge*
