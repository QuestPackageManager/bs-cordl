...
namespace LIV::SDK::Unity {
template<typename T>
struct SDKBridge_SDKInjection_1;
}
namespace LIV::SDK::Unity {
...
// Declarations
template<typename T>
using SDKInjection_1 = ::LIV::SDK::Unity::SDKBridge_SDKInjection_1<T>;
...
/// @brief Field _injection_SDKInputFrame, offset 0xffffffff, size 0x168 
 __declspec(property(get=getStaticF__injection_SDKInputFrame, put=setStaticF__injection_SDKInputFrame)) ::LIV::SDK::Unity::SDKBridge_SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame>  _injection_SDKInputFrame;

/// @brief Field _injection_SDKResolution, offset 0xffffffff, size 0x18 
 __declspec(property(get=getStaticF__injection_SDKResolution, put=setStaticF__injection_SDKResolution)) ::LIV::SDK::Unity::SDKBridge_SDKInjection_1<::LIV::SDK::Unity::SDKResolution>  _injection_SDKResolution;

/// @brief Method AddObjectToChannel, addr 0x56fbb18, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToCompositorChannel, addr 0x56fbaf0, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToCompositorChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToFrame, addr 0x56fbaf8, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToFrame(::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddString, addr 0x56fbb84, size 0x104, virtual false, abstract: false, final false
static inline void AddString(::StringW  tag, ::StringW  value, int32_t  slot) ;

/// @brief Method AddStringToChannel, addr 0x56fbab8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddTexture, addr 0x56fc1fc, size 0x13c, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture) ;

/// @brief Method AddTexture, addr 0x56fbc88, size 0xc0, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture, uint64_t  tag) ;

/// @brief Method CreateFrame, addr 0x56fc338, size 0x15c, virtual false, abstract: false, final false
static inline void CreateFrame(::LIV::SDK::Unity::SDKOutputFrame  frame) ;

/// @brief Method GetChannelObject, addr 0x56fbb10, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCompositorChannelObject, addr 0x56fbae8, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetCompositorChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCurrentTime, addr 0x56fbda8, size 0x60, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTime() ;

/// @brief Method GetCurrentTimeTicks, addr 0x56fbad0, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTimeTicks() ;

/// @brief Method GetIsCaptureActive, addr 0x56fbad8, size 0x8, virtual false, abstract: false, final false
static inline bool GetIsCaptureActive() ;

/// @brief Method GetObjectTime, addr 0x56fbd48, size 0x60, virtual false, abstract: false, final false
static inline uint64_t GetObjectTime(::System::IntPtr  objectptr) ;

/// @brief Method GetObjectTimeStamp, addr 0x56fbac8, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetObjectTimeStamp(::System::IntPtr  obj) ;

/// @brief Method GetRenderEventFunc, addr 0x56fbae0, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetRenderEventFunc() ;

/// @brief Method GetResolution, addr 0x56fc540, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method GetViewfinderTexture, addr 0x56fc128, size 0xc0, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKTexture GetViewfinderTexture() ;

/// @brief Method GetViewportTexture, addr 0x56fbb08, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetViewportTexture() ;

/// @brief Method IssuePluginEvent, addr 0x56fbe08, size 0x84, virtual false, abstract: false, final false
static inline void IssuePluginEvent() ;

/// @brief Method SetGroundPlane, addr 0x56fc494, size 0xac, virtual false, abstract: false, final false
static inline void SetGroundPlane(::LIV::SDK::Unity::SDKPlane  groundPlane) ;

/// @brief Method SubmitApplicationOutput, addr 0x56fb55c, size 0x1fc, virtual false, abstract: false, final false
static inline void SubmitApplicationOutput(::LIV::SDK::Unity::SDKApplicationOutput  applicationOutput) ;

/// @brief Method Tag, addr 0x56fbb20, size 0x64, virtual false, abstract: false, final false
static inline uint64_t Tag(::StringW  str) ;

/// @brief Method UpdateInputFrame, addr 0x56fbe8c, size 0x190, virtual false, abstract: false, final false
static inline bool UpdateInputFrame(::ByRef<::LIV::SDK::Unity::SDKInputFrame>  setframe) ;

/// @brief Method addtexture, addr 0x56fbac0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_IsActive, addr 0x56fad58, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method updatinputframe, addr 0x56fbb00, size 0x8, virtual false, abstract: false, final false
