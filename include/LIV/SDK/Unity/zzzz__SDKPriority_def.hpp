...
public:
// Declarations
/// @brief Method ToString, addr 0x5701868, size 0x260, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x570185c, size 0xc, virtual false, abstract: false, final false
