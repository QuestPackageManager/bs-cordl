...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3ac78dc, size 0x26c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac78d0, size 0xc, virtual false, abstract: false, final false
