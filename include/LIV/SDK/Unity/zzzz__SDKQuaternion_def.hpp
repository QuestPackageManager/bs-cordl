...
public:
// Declarations
/// @brief Method Euler, addr 0x57702cc, size 0xb0, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion Euler(float_t  pitch, float_t  yaw, float_t  roll) ;

/// @brief Method ToString, addr 0x5770494, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_identity, addr 0x57702b4, size 0x14, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion get_identity() ;

/// @brief Method op_Implicit, addr 0x576f6b4, size 0x4, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion op_Implicit___LIV__SDK__Unity__SDKQuaternion(::UnityEngine::Quaternion  v) ;

/// @brief Method op_Implicit, addr 0x57702c8, size 0x4, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion op_Implicit___UnityEngine__Quaternion(::LIV::SDK::Unity::SDKQuaternion  v) ;

/// @brief Method op_Multiply, addr 0x577037c, size 0x74, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion op_Multiply(::LIV::SDK::Unity::SDKQuaternion  lhs, ::LIV::SDK::Unity::SDKQuaternion  rhs) ;

/// @brief Method op_Multiply, addr 0x57703f0, size 0xa4, virtual false, abstract: false, final false
