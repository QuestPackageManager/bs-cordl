...
public:
// Declarations
/// @brief Method ToString, addr 0x5702b04, size 0x374, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x5702ab8, size 0x4c, virtual false, abstract: false, final false
