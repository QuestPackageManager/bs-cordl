...
public:
  // Declarations
  /// @brief Method ToString, addr 0x57709f0, size 0x374, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x57709a4, size 0x4c, virtual false, abstract: false, final false
