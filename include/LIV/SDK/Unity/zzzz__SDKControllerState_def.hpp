...
public:
// Declarations
/// @brief Method ToString, addr 0x5772258, size 0x374, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x577220c, size 0x4c, virtual false, abstract: false, final false
