...
public:
  // Declarations
  /// @brief Method ToString, addr 0x23d9cf8, size 0x368, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x23d9cac, size 0x4c, virtual false, abstract: false, final false
