...
// SizeInfo { instance_size: 168, native_size: 168, calculated_instance_size: 168, calculated_native_size: 184, minimum_alignment: 4, packing: None, specified_packing: None }
namespace LIV::SDK::Unity {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3a71a60, size 0x244, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3a71938, size 0x64, virtual false, abstract: false, final false
