...
public:
// Declarations
/// @brief Method ToString, addr 0x5771944, size 0x254, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x57717ec, size 0x64, virtual false, abstract: false, final false
