...
public:
// Declarations
/// @brief Method ToString, addr 0x57021f0, size 0x254, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x5702098, size 0x64, virtual false, abstract: false, final false
