...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LIV::SDK::Unity::SDKPriority (*)()>(&::LIV::SDK::Unity::SDKPriority::get_empty)> {
  ...
  constexpr static std::size_t addrs = 0x570185c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::LIV::SDK::Unity::SDKPriority::*)()>(&::LIV::SDK::Unity::SDKPriority::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x5701868;
...
constexpr ::LIV::SDK::Unity::SDKPriority::SDKPriority(int8_t  pose, int8_t  clipPlane, int8_t  stage, int8_t  resolution, int8_t  feature, int8_t  nearFarAdjustment, int8_t  groundPlane, int8_t  reserved2) noexcept  {
this->pose = pose;
