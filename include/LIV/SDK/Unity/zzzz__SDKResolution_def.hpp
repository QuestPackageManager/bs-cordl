...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3a701bc, size 0xa0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_zero, addr 0x3a6c0d8, size 0x8, virtual false, abstract: false, final false
