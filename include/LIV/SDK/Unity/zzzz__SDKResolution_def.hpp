...
public:
  // Declarations
  /// @brief Method ToString, addr 0x569ff10, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_zero, addr 0x569bcd0, size 0x8, virtual false, abstract: false, final false
