...
public:
  // Declarations
  /// @brief Method ToString, addr 0x5700bb8, size 0xb4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_zero, addr 0x56fc978, size 0x8, virtual false, abstract: false, final false
