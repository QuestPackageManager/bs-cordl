...
public:
  // Declarations
  /// @brief Method ToString, addr 0x576ffe8, size 0xf4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x576a9ac, size 0x60, virtual false, abstract: false, final false
