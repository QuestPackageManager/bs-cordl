...
public:
// Declarations
/// @brief Method ToString, addr 0x5771850, size 0xf4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x576c214, size 0x60, virtual false, abstract: false, final false
