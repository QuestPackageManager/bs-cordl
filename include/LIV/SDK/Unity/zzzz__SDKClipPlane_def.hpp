...
public:
// Declarations
/// @brief Method ToString, addr 0x5772048, size 0x1c4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x5771468, size 0x34, virtual false, abstract: false, final false
