...
public:
  // Declarations
  /// @brief Method ToString, addr 0x2377cf8, size 0x1dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x2377184, size 0x34, virtual false, abstract: false, final false
