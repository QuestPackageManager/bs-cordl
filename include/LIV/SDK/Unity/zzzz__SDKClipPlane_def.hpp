...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3ac8928, size 0x1dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac7db4, size 0x34, virtual false, abstract: false, final false
