...
public:
  // Declarations
  /// @brief Method ToString, addr 0x3ac8da0, size 0x1dc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x3ac822c, size 0x34, virtual false, abstract: false, final false
