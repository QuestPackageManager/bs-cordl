...
public:
  // Declarations
  /// @brief Method ToString, addr 0x57707e0, size 0x1c4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method get_empty, addr 0x576fc00, size 0x34, virtual false, abstract: false, final false
