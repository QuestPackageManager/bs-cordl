...
public:
  ...
  /// @brief Method Start, addr 0x2266a54, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2266c5c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
