...
public:
  ...
  /// @brief Method Start, addr 0x22650a4, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x22652ac, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
