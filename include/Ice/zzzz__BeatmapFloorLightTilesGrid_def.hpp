...
public:
  ...
  /// @brief Method Start, addr 0x2268b54, size 0x78, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2268d5c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
