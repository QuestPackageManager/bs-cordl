...
// Write type traits
MARK_REF_T(::Ice::BeatmapFloorLightTilesGrid*);
DEFINE_IL2CPP_CLASS(::Ice::BeatmapFloorLightTilesGrid*, "Ice", "BeatmapFloorLightTilesGrid");
...
public:
  ...
  /// @brief Method Start, addr 0x328826c, size 0x70, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3288480, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Ice::BeatmapFloorLightTilesGrid) == 0x40, "Size mismatch!");
