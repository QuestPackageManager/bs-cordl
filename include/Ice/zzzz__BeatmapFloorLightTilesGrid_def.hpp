...
public:
  ...
  /// @brief Method Start, addr 0x31bbfe8, size 0x70, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x31bc1fc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
