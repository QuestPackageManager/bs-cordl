...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)(::UnityEngine::Color)>(
  ...
  constexpr static std::size_t addrs = 0x129fea4;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Ice::NoteCutFloorLightStreakTileEffectSpawner*>::get(), "set_spawnColor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)()>(
  ...
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x129feb0;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Ice::NoteCutFloorLightStreakTileEffectSpawner*>::get(),
                                                                               "get_spawnColor", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)()>(
  ...
  constexpr static std::size_t addrs = 0x129febc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)()>(
  ...
  constexpr static std::size_t addrs = 0x129ff48;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)(
  ...
  constexpr static std::size_t addrs = 0x129ffe0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Ice::NoteCutFloorLightStreakTileEffectSpawner*>::get(), "HandleNoteWasCut", std::vector<Il2CppClass*>{},
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Ice::NoteCutFloorLightStreakTileEffectSpawner::*)()>(
  ...
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x12a0044;
...
constexpr ::Ice::FloorLightStreakTileEffect*& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__floorLightStreakTileEffect() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____floorLightStreakTileEffect;
}
constexpr ::cordl_internals::to_const_pointer<::Ice::FloorLightStreakTileEffect*> const& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__floorLightStreakTileEffect() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____floorLightStreakTileEffect;
}
...
constexpr ::GlobalNamespace::BeatmapObjectManager*& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__beatmapObjectManager() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____beatmapObjectManager;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectManager*> const& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__beatmapObjectManager() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____beatmapObjectManager;
}
...
constexpr ::GlobalNamespace::ColorManager*& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__colorManager() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____colorManager;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorManager*> const& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__colorManager() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____colorManager;
}
...
constexpr ::UnityEngine::Color& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__spawnColor() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____spawnColor;
}
constexpr ::UnityEngine::Color const& Ice::NoteCutFloorLightStreakTileEffectSpawner::__get__spawnColor() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____spawnColor;
}
...
inline ::Ice::NoteCutFloorLightStreakTileEffectSpawner* Ice::NoteCutFloorLightStreakTileEffectSpawner::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::Ice::NoteCutFloorLightStreakTileEffectSpawner*>());
}
