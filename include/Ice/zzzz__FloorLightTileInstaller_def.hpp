...
public:
  ...
  /// @brief Method InstallBindings, addr 0x318d074, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x318d0fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
