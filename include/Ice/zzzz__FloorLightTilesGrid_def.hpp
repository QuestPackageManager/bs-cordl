...
// Write type traits
MARK_REF_T(::Ice::FloorLightTilesGrid*);
DEFINE_IL2CPP_CLASS(::Ice::FloorLightTilesGrid*, "Ice", "FloorLightTilesGrid");
// Dependencies AbstractPoolContainer, Ice.FloorLightTile, UnityEngine.Vector3
namespace Ice {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__grid, put = __cordl_internal_set__grid)) ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>>> _grid;
  ...
  constexpr ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>>> const& __cordl_internal_get__grid() const;

  constexpr ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>>>& __cordl_internal_get__grid();
  ...
  constexpr void __cordl_internal_set__grid(::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>>> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloorLightTilesGrid", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloorLightTilesGrid(FloorLightTilesGrid&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloorLightTilesGrid", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloorLightTilesGrid(FloorLightTilesGridconst&) = delete;
  ...
  ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>>> ____grid;
...
static_assert(sizeof(::Ice::FloorLightTilesGrid) == 0x50, "Size mismatch!");
