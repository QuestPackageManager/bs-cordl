...
/// @brief Field _floorLightTileMemoryPoolContainer, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__floorLightTileMemoryPoolContainer, put=__cordl_internal_set__floorLightTileMemoryPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::Ice::FloorLightTile>>*  _floorLightTileMemoryPoolContainer;

/// @brief Field _grid, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__grid, put=__cordl_internal_set__grid)) ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>,::Array<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>>*>  _grid;
...
/// @brief Method DespawnAll, addr 0x31bced8, size 0xd4, virtual true, abstract: false, final false
inline void DespawnAll() ;

/// @brief Method DespawnTile, addr 0x31bcfac, size 0x6c, virtual false, abstract: false, final false
inline void DespawnTile(::Ice::FloorLightTile*  floorLightTile) ;

/// @brief Method HandleFloorLightTileDidFinish, addr 0x31bd018, size 0x4, virtual false, abstract: false, final false
inline void HandleFloorLightTileDidFinish(::Ice::FloorLightTile*  floorLightTile) ;

/// @brief Method HighlightTile, addr 0x31bc528, size 0x1c4, virtual false, abstract: false, final false
inline void HighlightTile(int32_t  x, int32_t  y, float_t  fadeInDuration, float_t  fadeOutDuration, ::UnityEngine::Color  color) ;

/// @brief Method Init, addr 0x31bbfa8, size 0x1a4, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>,::Array<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>>*> const& __cordl_internal_get__grid() const;

constexpr ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>,::Array<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>>*>& __cordl_internal_get__grid() ;
...
constexpr void __cordl_internal_set__grid(::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>,::Array<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>>*>  value) ;
...
/// @brief Method .ctor, addr 0x31bd01c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ySize, addr 0x31bced0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _grid, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>,::Array<::ArrayW<::UnityW<::Ice::FloorLightTile>,::Array<::UnityW<::Ice::FloorLightTile>>*>>*>  ____grid;
