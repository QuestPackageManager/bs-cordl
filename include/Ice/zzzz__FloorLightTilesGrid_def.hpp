...
public:
  ...
  /// @brief Method DespawnAll, addr 0x31f39e0, size 0xd4, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method DespawnTile, addr 0x31f3ab4, size 0x6c, virtual false, abstract: false, final false
  inline void DespawnTile(::Ice::FloorLightTile* floorLightTile);

  /// @brief Method HandleFloorLightTileDidFinish, addr 0x31f3b20, size 0x4, virtual false, abstract: false, final false
  inline void HandleFloorLightTileDidFinish(::Ice::FloorLightTile* floorLightTile);

  /// @brief Method HighlightTile, addr 0x31f3030, size 0x1c4, virtual false, abstract: false, final false
  inline void HighlightTile(int32_t x, int32_t y, float_t fadeInDuration, float_t fadeOutDuration, ::UnityEngine::Color color);

  /// @brief Method Init, addr 0x31f2ab0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f3b24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ySize, addr 0x31f39d8, size 0x8, virtual false, abstract: false, final false
