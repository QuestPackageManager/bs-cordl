...
public:
  ...
  /// @brief Method DespawnAll, addr 0x10633b4, size 0xc0, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method DespawnTile, addr 0x1063474, size 0x60, virtual false, abstract: false, final false
  inline void DespawnTile(::Ice::FloorLightTile* floorLightTile);

  /// @brief Method HandleFloorLightTileDidFinish, addr 0x10634d4, size 0x4, virtual false, abstract: false, final false
  inline void HandleFloorLightTileDidFinish(::Ice::FloorLightTile* floorLightTile);

  /// @brief Method HighlightTile, addr 0x1062a58, size 0x1b8, virtual false, abstract: false, final false
  inline void HighlightTile(int32_t x, int32_t y, float_t fadeInDuration, float_t fadeOutDuration, ::UnityEngine::Color color);

  /// @brief Method Init, addr 0x10624bc, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10634d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ySize, addr 0x10633ac, size 0x8, virtual false, abstract: false, final false
