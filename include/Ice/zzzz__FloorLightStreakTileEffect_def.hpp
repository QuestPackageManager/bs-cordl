...
/// @brief Method ManualUpdate, addr 0x31bc3dc, size 0x68, virtual false, abstract: false, final false
inline void ManualUpdate(float_t  deltaTime) ;

static inline ::Ice::FloorLightStreakTileEffect_Element* New_ctor() ;

/// @brief Method Setup, addr 0x31bc514, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31bc8ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x31bc9bc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_currentTileY, addr 0x31bc9b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_currentTileY() ;

/// @brief Method get_lineIndex, addr 0x31bc9ac, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _elementsPool, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__elementsPool, put=__cordl_internal_set__elementsPool)) ::GlobalNamespace::SimpleMemoryPool_1<::Ice::FloorLightStreakTileEffect_Element*>*  _elementsPool;
...
/// @brief Method CreateNewElement, addr 0x31bc7e8, size 0x104, virtual false, abstract: false, final false
inline ::Ice::FloorLightStreakTileEffect_Element* CreateNewElement() ;

/// @brief Method DespawnAll, addr 0x31bc6ec, size 0xfc, virtual true, abstract: false, final false
inline void DespawnAll() ;

/// @brief Method HandleElementDidMoveToNextTile, addr 0x31bc8f0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method SpawnEffect, addr 0x31bc444, size 0xd0, virtual false, abstract: false, final false
inline void SpawnEffect(int32_t  x, ::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x31bc160, size 0xc8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x31bc228, size 0x1b4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x31bc99c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
