...
public:
  ...
  /// @brief Method ManualUpdate, addr 0x3288710, size 0x68, virtual false, abstract: false, final false
  inline void ManualUpdate(float_t deltaTime);

  static inline ::Ice::FloorLightStreakTileEffect_Element* New_ctor();

  /// @brief Method Setup, addr 0x3288848, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3288c20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x3288cf0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_currentTileY, addr 0x3288ce8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentTileY();

  /// @brief Method get_lineIndex, addr 0x3288ce0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateNewElement, addr 0x3288b1c, size 0x104, virtual false, abstract: false, final false
  inline ::Ice::FloorLightStreakTileEffect_Element* CreateNewElement();

  /// @brief Method DespawnAll, addr 0x3288a20, size 0xfc, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method HandleElementDidMoveToNextTile, addr 0x3288c24, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnEffect, addr 0x3288778, size 0xd0, virtual false, abstract: false, final false
  inline void SpawnEffect(int32_t x, ::UnityEngine::Color color);

  /// @brief Method Start, addr 0x3288494, size 0xc8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x328855c, size 0x1b4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3288cd0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
