...
public:
  ...
  /// @brief Method ManualUpdate, addr 0x106291c, size 0x68, virtual false, abstract: false, final false
  inline void ManualUpdate(float_t deltaTime);

  static inline ::Ice::__FloorLightStreakTileEffect__Element* New_ctor();

  /// @brief Method Setup, addr 0x1062a44, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1062df8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x1062ec0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_currentTileY, addr 0x1062eb8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentTileY();

  /// @brief Method get_lineIndex, addr 0x1062eb0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateNewElement, addr 0x1062cf4, size 0x104, virtual false, abstract: false, final false
  inline ::Ice::__FloorLightStreakTileEffect__Element* CreateNewElement();

  /// @brief Method DespawnAll, addr 0x1062c10, size 0xe4, virtual true, abstract: false, final false
  inline void DespawnAll();

  /// @brief Method HandleElementDidMoveToNextTile, addr 0x1062e00, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnEffect, addr 0x1062984, size 0xc0, virtual false, abstract: false, final false
  inline void SpawnEffect(int32_t x, ::UnityEngine::Color color);

  /// @brief Method Start, addr 0x1062668, size 0xc4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x106272c, size 0x1f0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x1062e9c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
