...
public:
  ...
  /// @brief Method .ctor, addr 0x31f390c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x31f34d0, size 0x224, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleFadeInTweenOnCompleted, addr 0x31f3864, size 0x24, virtual false, abstract: false, final false
  inline void HandleFadeInTweenOnCompleted();

  /// @brief Method HandleFadeOutTweenOnCompleted, addr 0x31f3888, size 0x20, virtual false, abstract: false, final false
  inline void HandleFadeOutTweenOnCompleted();

  /// @brief Method HighlightWithColor, addr 0x31f3798, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x31f36f4, size 0xa4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColor, addr 0x31f38a8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f3908, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
