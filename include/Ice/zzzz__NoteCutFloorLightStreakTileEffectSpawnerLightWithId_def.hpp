...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x32894f8, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3289514, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Ice::NoteCutFloorLightStreakTileEffectSpawnerLightWithId) == 0x40, "Size mismatch!");
