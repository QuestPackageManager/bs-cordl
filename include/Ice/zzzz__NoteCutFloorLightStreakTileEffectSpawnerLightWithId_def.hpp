...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x31f3cd4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f3cf0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
