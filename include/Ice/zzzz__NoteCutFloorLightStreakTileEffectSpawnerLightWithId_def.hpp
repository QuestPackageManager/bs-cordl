...
/// @brief Field _noteCutFloorLightStreakTileEffectSpawner, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteCutFloorLightStreakTileEffectSpawner, put=__cordl_internal_set__noteCutFloorLightStreakTileEffectSpawner)) ::UnityW<::Ice::NoteCutFloorLightStreakTileEffectSpawner>  _noteCutFloorLightStreakTileEffectSpawner;

/// @brief Method ColorWasSet, addr 0x31bd1cc, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31bd1e8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
