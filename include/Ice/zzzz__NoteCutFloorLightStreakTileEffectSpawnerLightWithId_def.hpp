...
public:
  ...
  /// @brief Method ColorWasSet, addr 0xe9641c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe9643c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
