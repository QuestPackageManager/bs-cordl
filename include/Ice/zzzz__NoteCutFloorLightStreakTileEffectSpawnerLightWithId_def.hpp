...
// Write type traits
MARK_REF_T(::Ice::NoteCutFloorLightStreakTileEffectSpawnerLightWithId*);
DEFINE_IL2CPP_CLASS(::Ice::NoteCutFloorLightStreakTileEffectSpawnerLightWithId*, "Ice", "NoteCutFloorLightStreakTileEffectSpawnerLightWithId");
...
public:
  // Declarations
  /// @brief Field _noteCutFloorLightStreakTileEffectSpawner, offset 0x40, size 0x8
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteCutFloorLightStreakTileEffectSpawnerLightWithId", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "NoteCutFloorLightStreakTileEffectSpawnerLightWithId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoteCutFloorLightStreakTileEffectSpawnerLightWithId(NoteCutFloorLightStreakTileEffectSpawnerLightWithIdconst&) = delete;
...
static_assert(offsetof(::Ice::NoteCutFloorLightStreakTileEffectSpawnerLightWithId, ____noteCutFloorLightStreakTileEffectSpawner) == 0x40, "Offset mismatch!");

static_assert(sizeof(::Ice::NoteCutFloorLightStreakTileEffectSpawnerLightWithId) == 0x48, "Size mismatch!");
