...
/// @brief Method ColorWasSet, addr 0x31f49f4, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31f4a10, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
