...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x3c6eff0, size 0x7c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x3c6efb0, size 0x30, virtual false, abstract: false, final false
