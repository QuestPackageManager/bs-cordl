...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x598acbc, size 0x7c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x598ac80, size 0x2c, virtual false, abstract: false, final false
