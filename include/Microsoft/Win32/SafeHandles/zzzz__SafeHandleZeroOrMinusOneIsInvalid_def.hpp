...
public:
  ...
  /// @brief Method .ctor, addr 0x598acac, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool ownsHandle);

  /// @brief Method get_IsInvalid, addr 0x598ad88, size 0x14, virtual true, abstract: false, final false
