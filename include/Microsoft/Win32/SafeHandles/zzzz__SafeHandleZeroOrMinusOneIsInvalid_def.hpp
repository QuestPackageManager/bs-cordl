...
// Write type traits
MARK_REF_T(::Microsoft::Win32::SafeHandles::SafeHandleZeroOrMinusOneIsInvalid*);
DEFINE_IL2CPP_CLASS(::Microsoft::Win32::SafeHandles::SafeHandleZeroOrMinusOneIsInvalid*, "Microsoft.Win32.SafeHandles", "SafeHandleZeroOrMinusOneIsInvalid");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SafeHandleZeroOrMinusOneIsInvalid", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SafeHandleZeroOrMinusOneIsInvalid(SafeHandleZeroOrMinusOneIsInvalid&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SafeHandleZeroOrMinusOneIsInvalid", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SafeHandleZeroOrMinusOneIsInvalid(SafeHandleZeroOrMinusOneIsInvalidconst&) = delete;
...
static_assert(sizeof(::Microsoft::Win32::SafeHandles::SafeHandleZeroOrMinusOneIsInvalid) == 0x20, "Size mismatch!");
