...
public:
  ...
  /// @brief Method .ctor, addr 0x5918924, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool ownsHandle);

  /// @brief Method get_IsInvalid, addr 0x5918934, size 0x10, virtual true, abstract: false, final false
