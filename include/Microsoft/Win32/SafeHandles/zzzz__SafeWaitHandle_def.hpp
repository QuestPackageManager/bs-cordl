...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x3c6f09c, size 0x1c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x3c6f06c, size 0x30, virtual false, abstract: false, final false
