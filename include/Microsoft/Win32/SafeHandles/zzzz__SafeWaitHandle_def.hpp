...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x3bf90c8, size 0x1c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x3bf9098, size 0x30, virtual false, abstract: false, final false
