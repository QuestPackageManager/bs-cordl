...
public:
  ...
  /// @brief Method .ctor, addr 0x242c224, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(void* existingHandle, bool ownsHandle);

  /// @brief Method ReleaseHandle, addr 0x242c24c, size 0x1c, virtual true, abstract: false, final false
