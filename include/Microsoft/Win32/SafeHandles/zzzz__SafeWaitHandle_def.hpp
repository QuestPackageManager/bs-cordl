...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x26ad08c, size 0x1c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x26ad064, size 0x28, virtual false, abstract: false, final false
