...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x3c70ad0, size 0x1c, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x3c70aa0, size 0x30, virtual false, abstract: false, final false
