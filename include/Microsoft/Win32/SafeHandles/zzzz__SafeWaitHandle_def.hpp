...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x58b1fa0, size 0x24, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x58b1f74, size 0x2c, virtual false, abstract: false, final false
