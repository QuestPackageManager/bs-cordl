...
public:
  ...
  /// @brief Method ReleaseHandle, addr 0x40a6430, size 0x8, virtual true, abstract: false, final false
  inline bool ReleaseHandle();

  /// @brief Method .ctor, addr 0x40a61b4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr existingHandle, bool ownsHandle);

  /// @brief Method .ctor, addr 0x40a6404, size 0x2c, virtual false, abstract: false, final false
