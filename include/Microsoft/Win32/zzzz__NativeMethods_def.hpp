...
public:
  // Declarations
  /// @brief Method CloseProcess, addr 0x5ea212c, size 0x60, virtual false, abstract: false, final false
  static inline bool CloseProcess(::System::IntPtr handle);

  /// @brief Method DuplicateHandle, addr 0x5ea1dd4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcess, addr 0x5ea1f68, size 0x14, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetCurrentProcess();

  /// @brief Method GetCurrentProcessId, addr 0x5ea2128, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetCurrentProcessId();

  /// @brief Method GetExitCodeProcess, addr 0x5ea1f7c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProcessTimes, addr 0x5ea2030, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProcessTimes, addr 0x5ea2028, size 0x8, virtual false, abstract: false, final false
