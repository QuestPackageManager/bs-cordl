...
public:
  // Declarations
  /// @brief Method CloseProcess, addr 0x411f090, size 0x4, virtual false, abstract: false, final false
  static inline bool CloseProcess(::System::IntPtr handle);

  /// @brief Method DuplicateHandle, addr 0x411ed08, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentProcess, addr 0x411ee70, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetCurrentProcess();

  /// @brief Method GetCurrentProcessId, addr 0x411f08c, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetCurrentProcessId();

  /// @brief Method GetExitCodeProcess, addr 0x411ee78, size 0xf8, virtual false, abstract: false, final false
  static inline bool GetExitCodeProcess(::Microsoft::Win32::SafeHandles::SafeProcessHandle* processHandle, ::ByRef<int32_t> exitCode);

  /// @brief Method GetExitCodeProcess, addr 0x411ee74, size 0x4, virtual false, abstract: false, final false
  static inline bool GetExitCodeProcess(::System::IntPtr processHandle, ::ByRef<int32_t> exitCode);

  /// @brief Method GetProcessTimes, addr 0x411ef74, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GetProcessTimes, addr 0x411ef70, size 0x4, virtual false, abstract: false, final false
