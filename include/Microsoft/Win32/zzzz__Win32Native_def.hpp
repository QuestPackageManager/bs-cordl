...
public:
  // Declarations
  /// @brief Method GetMessage, addr 0x27ab054, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetMessage(int32_t hr);

  /// @brief Method MakeHRFromErrorCode, addr 0x27ab0b0, size 0xc, virtual false, abstract: false, final false
