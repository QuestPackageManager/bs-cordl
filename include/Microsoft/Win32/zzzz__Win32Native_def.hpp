...
public:
  // Declarations
  /// @brief Method GetMessage, addr 0x3c733ac, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetMessage(int32_t hr);

  /// @brief Method MakeHRFromErrorCode, addr 0x3c73408, size 0xc, virtual false, abstract: false, final false
