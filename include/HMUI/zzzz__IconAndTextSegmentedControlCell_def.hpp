...
public:
  ...
  /// @brief Method SetTextActive, addr 0x4088700, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4088984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_sprite, addr 0x4088944, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_sprite();

  /// @brief Method get_text, addr 0x4088960, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_sprite, addr 0x4088398, size 0x1c, virtual false, abstract: false, final false
  inline void set_sprite(::UnityEngine::Sprite* value);

  /// @brief Method set_text, addr 0x40883b4, size 0x24, virtual false, abstract: false, final false
