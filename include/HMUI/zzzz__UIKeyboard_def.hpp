...
static_assert(sizeof(::HMUI::UIKeyboard___c__DisplayClass24_0) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::HMUI::UIKeyboard) == 0x68, "Size mismatch!");
