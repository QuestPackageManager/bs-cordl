...
public:
  ...
  /// @brief Method <Awake>b__3, addr 0x5735350, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5734cec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x57348e0, size 0x40c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleCapsLockPressed, addr 0x57350a0, size 0x1a4, virtual false, abstract: false, final false
  inline void HandleCapsLockPressed();

  /// @brief Method HandleKeyPress, addr 0x5734e34, size 0x120, virtual false, abstract: false, final false
  inline void HandleKeyPress(::UnityEngine::KeyCode keyCode);

  /// @brief Method HasFontStyle, addr 0x5735244, size 0x1c, virtual false, abstract: false, final false
  inline bool HasFontStyle(::TMPro::TextMeshProUGUI* text, ::TMPro::FontStyles style);

  static inline ::HMUI::UIKeyboard* New_ctor();

  /// @brief Method OnEnable, addr 0x5735260, size 0x40, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetCapsLockState, addr 0x5734f54, size 0x20, virtual false, abstract: false, final false
  inline void SetCapsLockState(::HMUI::CapsLockState newState);

  /// @brief Method SetKeyboardCapitalization, addr 0x5734f74, size 0x12c, virtual false, abstract: false, final false
  inline void SetKeyboardCapitalization(bool capitalize);

  /// @brief Method Update, addr 0x5734cf0, size 0x144, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <Awake>b__24_0, addr 0x57352fc, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__24_0();

  /// @brief Method <Awake>b__24_1, addr 0x5735318, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__24_1();

  /// @brief Method <Awake>b__24_2, addr 0x5735334, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57352a0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_capsLockStateChangedEvent, addr 0x5734748, size 0xc0, virtual false, abstract: false, final false
  inline void add_capsLockStateChangedEvent(::System::Action_1<::HMUI::CapsLockState>* value);

  /// @brief Method add_deleteButtonWasPressedEvent, addr 0x57345f0, size 0xac, virtual false, abstract: false, final false
  inline void add_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_keyWasPressedEvent, addr 0x5734470, size 0xc0, virtual false, abstract: false, final false
  inline void add_keyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method add_okButtonWasPressedEvent, addr 0x5734318, size 0xac, virtual false, abstract: false, final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method get_capsLockState, addr 0x57348d8, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::CapsLockState get_capsLockState();

  /// @brief Method get_shouldCapitalize, addr 0x57348c8, size 0x10, virtual false, abstract: false, final false
  inline bool get_shouldCapitalize();

  /// @brief Method remove_capsLockStateChangedEvent, addr 0x5734808, size 0xc0, virtual false, abstract: false, final false
  inline void remove_capsLockStateChangedEvent(::System::Action_1<::HMUI::CapsLockState>* value);

  /// @brief Method remove_deleteButtonWasPressedEvent, addr 0x573469c, size 0xac, virtual false, abstract: false, final false
  inline void remove_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_keyWasPressedEvent, addr 0x5734530, size 0xc0, virtual false, abstract: false, final false
  inline void remove_keyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method remove_okButtonWasPressedEvent, addr 0x57343c4, size 0xac, virtual false, abstract: false, final false
