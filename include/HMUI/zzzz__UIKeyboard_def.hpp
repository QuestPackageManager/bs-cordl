...
/// @brief Method <Awake>b__3, addr 0x56c7464, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56c6e00, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _letterBtnTexts, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__letterBtnTexts, put=__cordl_internal_set__letterBtnTexts)) ::System::Collections::Generic::List_1<::UnityW<::TMPro::TextMeshProUGUI>>*  _letterBtnTexts;
...
/// @brief Method Awake, addr 0x56c69f4, size 0x40c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleCapsLockPressed, addr 0x56c71b4, size 0x1a4, virtual false, abstract: false, final false
inline void HandleCapsLockPressed() ;

/// @brief Method HandleKeyPress, addr 0x56c6f48, size 0x120, virtual false, abstract: false, final false
inline void HandleKeyPress(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method HasFontStyle, addr 0x56c7358, size 0x1c, virtual false, abstract: false, final false
inline bool HasFontStyle(::TMPro::TextMeshProUGUI*  text, ::TMPro::FontStyles  style) ;

static inline ::HMUI::UIKeyboard* New_ctor() ;

/// @brief Method OnEnable, addr 0x56c7374, size 0x40, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetCapsLockState, addr 0x56c7068, size 0x20, virtual false, abstract: false, final false
inline void SetCapsLockState(::HMUI::CapsLockState  newState) ;

/// @brief Method SetKeyboardCapitalization, addr 0x56c7088, size 0x12c, virtual false, abstract: false, final false
inline void SetKeyboardCapitalization(bool  capitalize) ;

/// @brief Method Update, addr 0x56c6e04, size 0x144, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method <Awake>b__24_0, addr 0x56c7410, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__24_0() ;

/// @brief Method <Awake>b__24_1, addr 0x56c742c, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__24_1() ;

/// @brief Method <Awake>b__24_2, addr 0x56c7448, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56c73b4, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_capsLockStateChangedEvent, addr 0x56c685c, size 0xc0, virtual false, abstract: false, final false
inline void add_capsLockStateChangedEvent(::System::Action_1<::HMUI::CapsLockState>*  value) ;

/// @brief Method add_deleteButtonWasPressedEvent, addr 0x56c6704, size 0xac, virtual false, abstract: false, final false
inline void add_deleteButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method add_keyWasPressedEvent, addr 0x56c6584, size 0xc0, virtual false, abstract: false, final false
inline void add_keyWasPressedEvent(::System::Action_1<char16_t>*  value) ;

/// @brief Method add_okButtonWasPressedEvent, addr 0x56c642c, size 0xac, virtual false, abstract: false, final false
inline void add_okButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method get_capsLockState, addr 0x56c69ec, size 0x8, virtual false, abstract: false, final false
inline ::HMUI::CapsLockState get_capsLockState() ;

/// @brief Method get_shouldCapitalize, addr 0x56c69dc, size 0x10, virtual false, abstract: false, final false
inline bool get_shouldCapitalize() ;

/// @brief Method remove_capsLockStateChangedEvent, addr 0x56c691c, size 0xc0, virtual false, abstract: false, final false
inline void remove_capsLockStateChangedEvent(::System::Action_1<::HMUI::CapsLockState>*  value) ;

/// @brief Method remove_deleteButtonWasPressedEvent, addr 0x56c67b0, size 0xac, virtual false, abstract: false, final false
inline void remove_deleteButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_keyWasPressedEvent, addr 0x56c6644, size 0xc0, virtual false, abstract: false, final false
inline void remove_keyWasPressedEvent(::System::Action_1<char16_t>*  value) ;

/// @brief Method remove_okButtonWasPressedEvent, addr 0x56c64d8, size 0xac, virtual false, abstract: false, final false
