...
public:
  ...
  /// @brief Method Awake, addr 0x21da704, size 0xec, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Start, addr 0x21da7f0, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x21da858, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleSelectionDidChange, addr 0x21da944, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleHighlightDidChange, addr 0x21da948, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshVisuals, addr 0x21da7f4, size 0x64, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  static inline ::HMUI::SelectableCellStaticAnimations* New_ctor();

  /// @brief Method .ctor, addr 0x21da94c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
