...
public:
  ...
  /// @brief Method Awake, addr 0x56d6c84, size 0xec, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleHighlightDidChange, addr 0x56d6edc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectionDidChange, addr 0x56d6ed8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x56d6dec, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x56d6d74, size 0x78, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method Start, addr 0x56d6d70, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x56d6ee0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
