...
public:
  ...
  /// @brief Method Awake, addr 0x242f08c, size 0xec, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleHighlightDidChange, addr 0x242f2d0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectionDidChange, addr 0x242f2cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x242f1e0, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x242f17c, size 0x64, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method Start, addr 0x242f178, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x242f2d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
