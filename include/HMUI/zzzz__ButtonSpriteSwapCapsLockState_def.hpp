...
// Write type traits
MARK_REF_T(::HMUI::ButtonSpriteSwapCapsLockState*);
DEFINE_IL2CPP_CLASS(::HMUI::ButtonSpriteSwapCapsLockState*, "HMUI", "ButtonSpriteSwapCapsLockState");
// Dependencies UnityEngine.Color, UnityEngine.MonoBehaviour, UnityEngine.UI.Image
namespace HMUI {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__images, put = __cordl_internal_set__images)) ::ArrayW<::UnityW<::UnityEngine::UI::Image>> _images;
  ...
  /// @brief Method OnCapsLockStateChanged, addr 0x5883ed0, size 0x4, virtual false, abstract: false, final false
  inline void OnCapsLockStateChanged(::HMUI::CapsLockState capsLockState);

  /// @brief Method OnDisable, addr 0x5883e44, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5883c14, size 0xd8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method UpdateSprites, addr 0x5883cec, size 0x158, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>>& __cordl_internal_get__images();
  ...
  constexpr void __cordl_internal_set__images(::ArrayW<::UnityW<::UnityEngine::UI::Image>> value);
  ...
  /// @brief Method .ctor, addr 0x5883ed4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::ButtonSpriteSwapCapsLockState) == 0x78, "Size mismatch!");
