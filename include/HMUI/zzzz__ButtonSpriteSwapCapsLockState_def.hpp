...
/// @brief Method OnCapsLockStateChanged, addr 0x56cd560, size 0x4, virtual false, abstract: false, final false
inline void OnCapsLockStateChanged(::HMUI::CapsLockState  capsLockState) ;

/// @brief Method OnDisable, addr 0x56cd4d4, size 0x8c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56cd2a4, size 0xd8, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method UpdateSprites, addr 0x56cd37c, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56cd564, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
