...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValueChangedBinder_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValueChangedBinder_1(ValueChangedBinder_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValueChangedBinder_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValueChangedBinder_1(ValueChangedBinder_1const&) = delete;
