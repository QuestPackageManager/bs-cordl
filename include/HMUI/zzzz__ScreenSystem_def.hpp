...
public:
  ...
  /// @brief Method Awake, addr 0x228b564, size 0xc0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::HMUI::ScreenSystem* New_ctor();

  /// @brief Method OnDestroy, addr 0x228b624, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetBackButton, addr 0x2287240, size 0x30, virtual false, abstract: false, final false
  inline void SetBackButton(bool visible, bool animated);

  /// @brief Method <Awake>b__24_0, addr 0x228b648, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x228b640, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_backButtonWasPressedEvent, addr 0x22887fc, size 0x9c, virtual false, abstract: false, final false
  inline void add_backButtonWasPressedEvent(::System::Action* value);

  /// @brief Method get_bottomScreen, addr 0x228b554, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_bottomScreen();

  /// @brief Method get_leftScreen, addr 0x228b544, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_leftScreen();

  /// @brief Method get_mainScreen, addr 0x228b53c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_mainScreen();

  /// @brief Method get_rightScreen, addr 0x228b54c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_rightScreen();

  /// @brief Method get_titleViewController, addr 0x228b534, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::TitleViewController> get_titleViewController();

  /// @brief Method get_topScreen, addr 0x228b55c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_topScreen();

  /// @brief Method remove_backButtonWasPressedEvent, addr 0x2288898, size 0x9c, virtual false, abstract: false, final false
