...
public:
  ...
  /// @brief Method AddButtonBinding, addr 0x22dced0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddButtonBindings, addr 0x22dcd5c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method AddScrollBinding, addr 0x22dcc5c, size 0xa8, virtual false, abstract: false, final false
  inline void AddScrollBinding(::UnityEngine::Events::UnityAction_1<float_t>* action);

  /// @brief Method AddScrollBindings, addr 0x22dcb20, size 0x13c, virtual false, abstract: false, final false
  inline void AddScrollBindings(::System::Collections::Generic::List_1<::UnityEngine::Events::UnityAction_1<float_t>*>* bindingData);

  /// @brief Method ClearBindings, addr 0x22dd078, size 0xa4, virtual false, abstract: false, final false
  inline void ClearBindings();

  /// @brief Method Init, addr 0x22dca60, size 0xc0, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method ManualUpdate, addr 0x22dd11c, size 0x384, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::HMUI::MouseBinder* New_ctor();

  /// @brief Method RemoveButtonBinding, addr 0x22dcfc8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveScrollBinding, addr 0x22dcd04, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22dca44, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enabled, addr 0x22dca30, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method set_enabled, addr 0x22dca38, size 0xc, virtual false, abstract: false, final false
