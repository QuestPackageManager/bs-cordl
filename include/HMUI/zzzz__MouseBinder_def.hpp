...
public:
  ...
  /// @brief Method AddButtonBinding, addr 0x56c396c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddButtonBindings, addr 0x56c3818, size 0x154, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method AddScrollBinding, addr 0x56c3700, size 0xb4, virtual false, abstract: false, final false
  inline void AddScrollBinding(::UnityEngine::Events::UnityAction_1<float_t>* action);

  /// @brief Method AddScrollBindings, addr 0x56c35fc, size 0x104, virtual false, abstract: false, final false
  inline void AddScrollBindings(::System::Collections::Generic::List_1<::UnityEngine::Events::UnityAction_1<float_t>*>* bindingData);

  /// @brief Method ClearBindings, addr 0x56c3ae0, size 0xb4, virtual false, abstract: false, final false
  inline void ClearBindings();

  /// @brief Method Init, addr 0x56c3538, size 0xc4, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method ManualUpdate, addr 0x56c3b94, size 0x388, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::HMUI::MouseBinder* New_ctor();

  /// @brief Method RemoveButtonBinding, addr 0x56c3a50, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveScrollBinding, addr 0x56c37b4, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56c3534, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_enabled, addr 0x56c3524, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabled();

  /// @brief Method set_enabled, addr 0x56c352c, size 0x8, virtual false, abstract: false, final false
