...
public:
  ...
  /// @brief Method .ctor, addr 0x3a0765c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3a07730, size 0x8c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::InputFieldView__BlinkingCaretCoroutine_d__43* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3a077bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3a077c4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3a077fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3a0772c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3a07500, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActivateKeyboard, addr 0x3a06e98, size 0x1b8, virtual false, abstract: false, final false
  inline void ActivateKeyboard(::HMUI::UIKeyboard* keyboard);

  /// @brief Method Awake, addr 0x3a06d3c, size 0xe8, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method BlinkingCaretCoroutine, addr 0x3a07050, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* BlinkingCaretCoroutine();

  /// @brief Method ClearInput, addr 0x3a07294, size 0x50, virtual false, abstract: false, final false
  inline void ClearInput();

  /// @brief Method DeactivateKeyboard, addr 0x3a070b0, size 0x198, virtual false, abstract: false, final false
  inline void DeactivateKeyboard(::HMUI::UIKeyboard* keyboard);

  /// @brief Method DoStateTransition, addr 0x3a06e38, size 0x60, virtual true, abstract: false, final false
  inline void DoStateTransition(::UnityEngine::UI::Selectable_SelectionState state, bool instant);

  /// @brief Method KeyboardDeletePressed, addr 0x3a07424, size 0xdc, virtual false, abstract: false, final false
  inline void KeyboardDeletePressed();

  /// @brief Method KeyboardKeyPressed, addr 0x3a072e4, size 0x140, virtual false, abstract: false, final false
  inline void KeyboardKeyPressed(char16_t letter);

  static inline ::HMUI::InputFieldView* New_ctor();

  /// @brief Method OnDestroy, addr 0x3a06e24, size 0x14, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetText, addr 0x3a0727c, size 0x18, virtual false, abstract: false, final false
  inline void SetText(::StringW value);

  /// @brief Method UpdateCaretPosition, addr 0x3a06c20, size 0xec, virtual false, abstract: false, final false
  inline void UpdateCaretPosition();

  /// @brief Method UpdateClearButton, addr 0x3a07248, size 0x34, virtual false, abstract: false, final false
  inline void UpdateClearButton();

  /// @brief Method UpdatePlaceholder, addr 0x3a06d0c, size 0x30, virtual false, abstract: false, final false
  inline void UpdatePlaceholder();

  /// @brief Method <Awake>b__34_0, addr 0x3a076a4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a07528, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x3a06a38, size 0xb4, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::InputFieldView_SelectionState>* value);

  /// @brief Method get_keyboardPositionOffset, addr 0x3a06bb0, size 0x10, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_keyboardPositionOffset();

  /// @brief Method get_onValueChanged, addr 0x3a06a28, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::InputFieldView_InputFieldChanged* get_onValueChanged();

  /// @brief Method get_selectionState, addr 0x3a06ba0, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::InputFieldView_SelectionState get_selectionState();

  /// @brief Method get_text, addr 0x3a06bc0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_useGlobalKeyboard, addr 0x3a06ba8, size 0x8, virtual false, abstract: false, final false
  inline bool get_useGlobalKeyboard();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x3a06aec, size 0xb4, virtual false, abstract: false, final false
  inline void remove_selectionStateDidChangeEvent(::System::Action_1<::HMUI::InputFieldView_SelectionState>* value);

  /// @brief Method set_onValueChanged, addr 0x3a06a30, size 0x8, virtual false, abstract: false, final false
  inline void set_onValueChanged(::HMUI::InputFieldView_InputFieldChanged* value);

  /// @brief Method set_text, addr 0x3a06bc8, size 0x58, virtual false, abstract: false, final false
