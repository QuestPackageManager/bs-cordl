...
public:
  // Declarations
  /// @brief Method GetWorldCorners, addr 0x5743454, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57434c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
