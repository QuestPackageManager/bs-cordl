...
public:
  // Declarations
  /// @brief Method GetWorldCorners, addr 0x3a09db0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a09e18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
