...
public:
  // Declarations
  /// @brief Method GetWorldCorners, addr 0x253fc70, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253fcd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
