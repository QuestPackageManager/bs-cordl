...
public:
  // Declarations
  /// @brief Method GetWorldCorners, addr 0x3992048, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39920b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
