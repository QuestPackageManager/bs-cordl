...
public:
  ...
  /// @brief Method TextForValue, addr 0x573788c, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57378e8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
