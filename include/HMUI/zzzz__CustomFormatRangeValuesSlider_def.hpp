...
public:
  ...
  /// @brief Method TextForValue, addr 0x56c9c18, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56c9c74, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
