...
public:
  ...
  /// @brief Method TextForValue, addr 0x5880310, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588036c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
