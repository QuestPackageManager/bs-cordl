...
/// @brief Method TextForValue, addr 0x57390f4, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5739150, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
