...
// Write type traits
MARK_REF_T(::HMUI::CustomFormatRangeValuesSlider*);
DEFINE_IL2CPP_CLASS(::HMUI::CustomFormatRangeValuesSlider*, "HMUI", "CustomFormatRangeValuesSlider");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CustomFormatRangeValuesSlider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CustomFormatRangeValuesSlider(CustomFormatRangeValuesSlider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CustomFormatRangeValuesSlider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CustomFormatRangeValuesSlider(CustomFormatRangeValuesSliderconst&) = delete;
...
static_assert(sizeof(::HMUI::CustomFormatRangeValuesSlider) == 0x178, "Size mismatch!");
