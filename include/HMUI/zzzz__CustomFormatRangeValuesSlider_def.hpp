...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13511))]
...
public:
  ...
  /// @brief Method TextForValue, addr 0x21b6cb4, size 0x70, virtual true, abstract: false, final false
  inline ::StringW TextForValue(float_t value);

  static inline ::HMUI::CustomFormatRangeValuesSlider* New_ctor();

  /// @brief Method .ctor, addr 0x21b6d24, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
