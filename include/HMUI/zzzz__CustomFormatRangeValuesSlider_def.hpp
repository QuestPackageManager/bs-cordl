...
/// @brief Method TextForValue, addr 0x56c99a0, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56c99fc, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
