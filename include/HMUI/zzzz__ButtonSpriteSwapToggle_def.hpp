...
public:
  ...
  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x39ef90c, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x39ef8dc, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39efa58, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isToggled, addr 0x39ef894, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x39ef89c, size 0x40, virtual false, abstract: false, final false
