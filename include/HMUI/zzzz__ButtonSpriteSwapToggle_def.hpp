...
public:
  ...
  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x2411910, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x24118e0, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2411a5c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isToggled, addr 0x2411898, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x24118a0, size 0x40, virtual false, abstract: false, final false
