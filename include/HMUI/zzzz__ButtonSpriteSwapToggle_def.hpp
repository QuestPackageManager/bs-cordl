...
public:
  ...
  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x56cd85c, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x56cd830, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56cd9ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isToggled, addr 0x56cd7f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x56cd7f8, size 0x38, virtual false, abstract: false, final false
