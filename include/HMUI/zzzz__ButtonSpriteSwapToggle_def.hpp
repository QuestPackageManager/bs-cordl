...
public:
  ...
  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x566cbb4, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x566cb88, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x566cd04, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isToggled, addr 0x566cb48, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x566cb50, size 0x38, virtual false, abstract: false, final false
