...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13572))]
...
public:
  ...
  /// @brief Method get_isToggled, addr 0x21c4f58, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x21c4f60, size 0x40, virtual false, abstract: false, final false
  inline void set_isToggled(bool value);

  /// @brief Method OnEnable, addr 0x21c4fa0, size 0x30, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x21c4fd0, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c511c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
