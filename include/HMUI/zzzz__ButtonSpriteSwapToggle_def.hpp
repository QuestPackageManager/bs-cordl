...
public:
  ...
  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x39f4880, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x39f4850, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f49cc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isToggled, addr 0x39f4808, size 0x8, virtual false, abstract: false, final false
  inline bool get_isToggled();

  /// @brief Method set_isToggled, addr 0x39f4810, size 0x40, virtual false, abstract: false, final false
