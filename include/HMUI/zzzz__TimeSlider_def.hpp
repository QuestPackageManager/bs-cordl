...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13511)), TypeDefinitionIndex(TypeDefinitionIndex(13514))]
...
public:
  ...
  /// @brief Method TextForValue, addr 0x21b8a5c, size 0x254, virtual true, abstract: false, final false
  inline ::StringW TextForValue(float_t value);

  static inline ::HMUI::TimeSlider* New_ctor();

  /// @brief Method .ctor, addr 0x21b8cb0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
