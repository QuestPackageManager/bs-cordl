...
public:
  ...
  /// @brief Method TextForValue, addr 0x22860c4, size 0x254, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2286318, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
