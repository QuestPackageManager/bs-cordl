...
public:
  ...
  /// @brief Method FormatTimeSpan, addr 0x57398bc, size 0x25c, virtual false, abstract: false, final false
  static inline ::StringW FormatTimeSpan(::System::TimeSpan ts);

  static inline ::HMUI::TimeSlider* New_ctor();

  /// @brief Method SetBounds, addr 0x5739650, size 0x10, virtual false, abstract: false, final false
  inline void SetBounds(bool valuesValid, float_t lowerValue, float_t upperValue);

  /// @brief Method TextForValue, addr 0x5739660, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5739b18, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
