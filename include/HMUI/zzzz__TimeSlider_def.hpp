...
public:
  ...
  /// @brief Method FormatTimeSpan, addr 0x56cbc48, size 0x25c, virtual false, abstract: false, final false
  static inline ::StringW FormatTimeSpan(::System::TimeSpan ts);

  static inline ::HMUI::TimeSlider* New_ctor();

  /// @brief Method SetBounds, addr 0x56cb9dc, size 0x10, virtual false, abstract: false, final false
  inline void SetBounds(bool valuesValid, float_t lowerValue, float_t upperValue);

  /// @brief Method TextForValue, addr 0x56cb9ec, size 0x25c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56cbea4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
