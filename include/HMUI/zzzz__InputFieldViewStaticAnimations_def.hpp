...
public:
  ...
  /// @brief Method Awake, addr 0x5740844, size 0x8c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleInputFieldViewSelectionStateDidChange, addr 0x57408f0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5740a2c, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5740a14, size 0x18, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x57408d0, size 0x20, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5740b3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
