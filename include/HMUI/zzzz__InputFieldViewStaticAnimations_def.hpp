...
public:
  ...
  /// @brief Method Awake, addr 0x39f4864, size 0x8c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleInputFieldViewSelectionStateDidChange, addr 0x39f4914, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x39f4a34, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x39f4a18, size 0x1c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x39f48f0, size 0x24, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39f4b00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
