...
public:
  ...
  /// @brief Method Awake, addr 0x5671f28, size 0x8c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleInputFieldViewSelectionStateDidChange, addr 0x5671fd4, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5672110, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x56720f8, size 0x18, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x5671fb4, size 0x20, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5672220, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
