...
// Write type traits
MARK_REF_T(::HMUI::ScreenModeData*);
DEFINE_IL2CPP_CLASS(::HMUI::ScreenModeData*, "HMUI", "ScreenModeData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32f6050, size 0x24, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::ScreenModeData) == 0x40, "Size mismatch!");
