...
public:
  ...
  /// @brief Method set_reuseIdentifier, addr 0x21487e8, size 0x8, virtual false, abstract: false, final false
  inline void set_reuseIdentifier(::StringW value);

  /// @brief Method get_idx, addr 0x21487f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_idx();

  /// @brief Method set_idx, addr 0x21487f8, size 0x8, virtual false, abstract: false, final false
  inline void set_idx(int32_t value);

  /// @brief Method get_tableCellOwner, addr 0x2148800, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::ITableCellOwner* get_tableCellOwner();

  /// @brief Method TableViewSetup, addr 0x2148808, size 0xc, virtual true, abstract: false, final false
  inline void TableViewSetup(::HMUI::ITableCellOwner* tableCellOwner, int32_t idx);

  /// @brief Method MoveIdx, addr 0x2148814, size 0x10, virtual false, abstract: false, final false
  inline void MoveIdx(int32_t offset);

  /// @brief Method InternalToggle, addr 0x2148824, size 0x1f4, virtual true, abstract: false, final false
  inline void InternalToggle();

  /// @brief Method __WasPreparedForReuse, addr 0x2148a18, size 0x10, virtual false, abstract: false, final false
  inline void __WasPreparedForReuse();

  /// @brief Method WasPreparedForReuse, addr 0x2148a28, size 0x4, virtual true, abstract: false, final false
  inline void WasPreparedForReuse();

  static inline ::HMUI::TableCell* New_ctor();

  /// @brief Method .ctor, addr 0x2148a2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
