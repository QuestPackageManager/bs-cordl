...
public:
  ...
  /// @brief Method Awake, addr 0x56658bc, size 0xac, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculatePanelPosition, addr 0x5665968, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Hide, addr 0x5664ff8, size 0x28, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::HMUI::HoverHintPanel* New_ctor();

  /// @brief Method Show, addr 0x5665400, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56659e0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isShown, addr 0x56658ac, size 0x8, virtual false, abstract: false, final false
  inline bool get_isShown();

  /// @brief Method set_isShown, addr 0x56658b4, size 0x8, virtual false, abstract: false, final false
