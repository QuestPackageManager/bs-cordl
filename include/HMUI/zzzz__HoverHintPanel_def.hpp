...
public:
  ...
  /// @brief Method Awake, addr 0x56c6564, size 0xac, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculatePanelPosition, addr 0x56c6610, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Hide, addr 0x56c5ca0, size 0x28, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::HMUI::HoverHintPanel* New_ctor();

  /// @brief Method Show, addr 0x56c60a8, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56c6688, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isShown, addr 0x56c6554, size 0x8, virtual false, abstract: false, final false
  inline bool get_isShown();

  /// @brief Method set_isShown, addr 0x56c655c, size 0x8, virtual false, abstract: false, final false
