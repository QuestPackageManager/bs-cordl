...
public:
  ...
  /// @brief Method Awake, addr 0x39ee0f0, size 0xa8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculatePanelPosition, addr 0x39ee198, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Hide, addr 0x39ed7e4, size 0x28, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::HMUI::HoverHintPanel* New_ctor();

  /// @brief Method Show, addr 0x39edc34, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ee218, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isShown, addr 0x39ee0dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_isShown();

  /// @brief Method set_isShown, addr 0x39ee0e4, size 0xc, virtual false, abstract: false, final false
