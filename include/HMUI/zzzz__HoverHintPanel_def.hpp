...
public:
  ...
  /// @brief Method get_isShown addr 0x1fc7558 size 0x8 virtual false final false
  inline bool get_isShown();

  /// @brief Method set_isShown addr 0x1fc7560 size 0xc virtual false final false
  inline void set_isShown(bool value);

  /// @brief Method Awake addr 0x1fc756c size 0xb4 virtual false final false
  inline void Awake();

  /// @brief Method Show addr 0x1fc707c size 0x274 virtual false final false
  inline void Show(::StringW text, ::UnityEngine::Transform* parent, ::UnityEngine::Vector2 containerSize, ::UnityEngine::Rect spawnRect);

  /// @brief Method Hide addr 0x1fc6c40 size 0x28 virtual false final false
  inline void Hide();

  /// @brief Method CalculatePanelPosition addr 0x1fc7620 size 0x10c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1fc772c size 0x20 virtual false final false
  inline void _ctor();
