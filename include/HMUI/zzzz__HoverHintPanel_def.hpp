...
public:
  ...
  /// @brief Method Awake, addr 0x39edd54, size 0xa8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculatePanelPosition, addr 0x39eddfc, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Hide, addr 0x39ed448, size 0x28, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::HMUI::HoverHintPanel* New_ctor();

  /// @brief Method Show, addr 0x39ed898, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ede7c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isShown, addr 0x39edd40, size 0x8, virtual false, abstract: false, final false
  inline bool get_isShown();

  /// @brief Method set_isShown, addr 0x39edd48, size 0xc, virtual false, abstract: false, final false
