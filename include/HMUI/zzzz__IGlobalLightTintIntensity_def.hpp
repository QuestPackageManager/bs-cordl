...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGlobalLightTintIntensity", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGlobalLightTintIntensity(IGlobalLightTintIntensityconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23634 };
