...
public:
  ...
  /// @brief Method Awake, addr 0x5669418, size 0x250, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ConvertFromNormalizedValue, addr 0x5669244, size 0x18, virtual false, abstract: false, final false
  inline float_t ConvertFromNormalizedValue(float_t normalizedValue);

  /// @brief Method HandleNormalizedValueDidChange, addr 0x5669700, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method NormalizeValue, addr 0x5669278, size 0x18, virtual false, abstract: false, final false
  inline float_t NormalizeValue(float_t rangeValue);

  /// @brief Method OnDestroy, addr 0x5669668, size 0x98, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method TextForNormalizedValue, addr 0x5669734, size 0x24, virtual true, abstract: false, final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method TextForValue, addr 0x5669758, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW TextForValue(float_t value);

  /// @brief Method <Awake>b__19_0, addr 0x56697c4, size 0x44, virtual false, abstract: false, final false
  inline void _Awake_b__19_0();

  /// @brief Method <Awake>b__19_1, addr 0x5669810, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5668fd8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x5669298, size 0xc0, virtual false, abstract: false, final false
  inline void add_valueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::RangeValuesTextSlider>, float_t>* value);

  /// @brief Method get_maxValue, addr 0x5669190, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxValue();

  /// @brief Method get_minValue, addr 0x5669104, size 0x8, virtual false, abstract: false, final false
  inline float_t get_minValue();

  /// @brief Method get_value, addr 0x566921c, size 0x28, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method remove_valueDidChangeEvent, addr 0x5669358, size 0xc0, virtual false, abstract: false, final false
  inline void remove_valueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::RangeValuesTextSlider>, float_t>* value);

  /// @brief Method set_interactable, addr 0x5669098, size 0x6c, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  /// @brief Method set_maxValue, addr 0x5669198, size 0x84, virtual false, abstract: false, final false
  inline void set_maxValue(float_t value);

  /// @brief Method set_minValue, addr 0x566910c, size 0x84, virtual false, abstract: false, final false
  inline void set_minValue(float_t value);

  /// @brief Method set_value, addr 0x566925c, size 0x1c, virtual false, abstract: false, final false
