...
public:
  ...
  /// @brief Method get_minValue addr 0x21224f8 size 0x8 virtual false final false
  inline float_t get_minValue();

  /// @brief Method set_minValue addr 0x2122500 size 0x80 virtual false final false
  inline void set_minValue(float_t value);

  /// @brief Method get_maxValue addr 0x2122580 size 0x8 virtual false final false
  inline float_t get_maxValue();

  /// @brief Method set_maxValue addr 0x2122588 size 0x80 virtual false final false
  inline void set_maxValue(float_t value);

  /// @brief Method set_value addr 0x2122608 size 0x1c virtual false final false
  inline void set_value(float_t value);

  /// @brief Method get_value addr 0x2122644 size 0x28 virtual false final false
  inline float_t get_value();

  /// @brief Method add_valueDidChangeEvent addr 0x2122684 size 0xb4 virtual false final false
  inline void add_valueDidChangeEvent(::System::Action_2<::HMUI::RangeValuesTextSlider*, float_t>* value);

  /// @brief Method remove_valueDidChangeEvent addr 0x2122738 size 0xb4 virtual false final false
  inline void remove_valueDidChangeEvent(::System::Action_2<::HMUI::RangeValuesTextSlider*, float_t>* value);

  /// @brief Method Awake addr 0x21227ec size 0x1ec virtual true final false
  inline void Awake();

  /// @brief Method OnDestroy addr 0x21229d8 size 0x98 virtual true final false
  inline void OnDestroy();

  /// @brief Method HandleNormalizedValueDidChange addr 0x2122a70 size 0x34 virtual false final false
  inline void HandleNormalizedValueDidChange(::HMUI::TextSlider* slider, float_t normalizedValue);

  /// @brief Method ConvertFromNormalizedValue addr 0x212266c size 0x18 virtual false final false
  inline float_t ConvertFromNormalizedValue(float_t normalizedValue);

  /// @brief Method NormalizeValue addr 0x2122624 size 0x18 virtual false final false
  inline float_t NormalizeValue(float_t rangeValue);

  /// @brief Method TextForNormalizedValue addr 0x2122aa4 size 0x24 virtual true final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method TextForValue addr 0x2122ac8 size 0x68 virtual true final false
  inline ::StringW TextForValue(float_t value);

  static inline ::HMUI::RangeValuesTextSlider* New_ctor();

  /// @brief Method .ctor addr 0x2122454 size 0xc virtual false final false
  inline void _ctor();

  /// @brief Method <Awake>b__17_0 addr 0x2122b30 size 0x44 virtual false final false
  inline void _Awake_b__17_0();

  /// @brief Method <Awake>b__17_1 addr 0x2122b7c size 0x44 virtual false final false
