  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::Interactable*>::get(), "add_interactableChangeEvent", std::span<Il2CppClass const* const, 0>(),
                                    ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_2<::HMUI::Interactable*, bool>*>::get() })));
...
constexpr ::System::Action_2<::HMUI::Interactable*, bool>*& HMUI::Interactable::__cordl_internal_get_interactableChangeEvent() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___interactableChangeEvent;
}
constexpr ::System::Action_2<::HMUI::Interactable*, bool>* const& HMUI::Interactable::__cordl_internal_get_interactableChangeEvent() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___interactableChangeEvent;
}
constexpr void HMUI::Interactable::__cordl_internal_set_interactableChangeEvent(::System::Action_2<::HMUI::Interactable*, bool>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
