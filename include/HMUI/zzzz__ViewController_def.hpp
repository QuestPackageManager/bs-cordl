...
MARK_REF_T(::HMUI::ViewController*);
MARK_REF_T(::HMUI::ViewController__DismissViewControllerCoroutine_d__54*);
MARK_REF_T(::HMUI::ViewController__PresentViewControllerCoroutine_d__50*);
MARK_REF_T(::HMUI::ViewController__ReplaceViewControllerCoroutine_d__52*);
DEFINE_IL2CPP_CLASS(::HMUI::ViewController_AnimationDirection, "HMUI", "ViewController/AnimationDirection");
DEFINE_IL2CPP_CLASS(::HMUI::ViewController_AnimationType, "HMUI", "ViewController/AnimationType");
DEFINE_IL2CPP_CLASS(::HMUI::ViewController*, "HMUI", "ViewController");
DEFINE_IL2CPP_CLASS(::HMUI::ViewController__DismissViewControllerCoroutine_d__54*, "HMUI", "ViewController/<DismissViewControllerCoroutine>d__54");
DEFINE_IL2CPP_CLASS(::HMUI::ViewController__PresentViewControllerCoroutine_d__50*, "HMUI", "ViewController/<PresentViewControllerCoroutine>d__50");
DEFINE_IL2CPP_CLASS(::HMUI::ViewController__ReplaceViewControllerCoroutine_d__52*, "HMUI", "ViewController/<ReplaceViewControllerCoroutine>d__52");
// Dependencies
namespace HMUI {
// Is value type: true
...
static_assert(sizeof(::HMUI::ViewController_AnimationType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32f54a8, size 0x1b4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::ViewController__DismissViewControllerCoroutine_d__54* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x32f57dc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32f57e4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32f581c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x32f54a4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32f52ac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32f5828, size 0x224, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::ViewController__PresentViewControllerCoroutine_d__50* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x32f5ac4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32f5acc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32f5b04, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x32f5824, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x32f51a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32f5b10, size 0x26c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::ViewController__ReplaceViewControllerCoroutine_d__52* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x32f5d7c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32f5d84, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32f5dbc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x32f5b0c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x32f5224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method DeactivateGameObject, addr 0x32ee0b4, size 0x4c, virtual true, abstract: false, final false
  inline void DeactivateGameObject();

  /// @brief Method DidActivate, addr 0x32f504c, size 0x4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x32f5050, size 0x4, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method DismissViewControllerCoroutine, addr 0x32f522c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method IsViewControllerInHierarchy, addr 0x32f52b4, size 0x194, virtual false, abstract: false, final false
  inline bool IsViewControllerInHierarchy(::HMUI::ViewController* viewController);

  /// @brief Method Log, addr 0x32f5448, size 0x5c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  static inline ::HMUI::ViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x32f5004, size 0x48, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PresentViewControllerCoroutine, addr 0x32f511c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceViewControllerCoroutine, addr 0x32f51a8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method __Activate, addr 0x32edd70, size 0xc8, virtual true, abstract: false, final false
  inline void __Activate(bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method __Deactivate, addr 0x32edf14, size 0xb0, virtual true, abstract: false, final false
  inline void __Deactivate(bool removedFromHierarchy, bool deactivateGameObject, bool screenSystemDisabling);

  /// @brief Method __DismissViewController, addr 0x32f07f8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method __Init, addr 0x32edb14, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method __PresentViewController, addr 0x32f0dac, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method __ReplaceViewController, addr 0x32f113c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method __ResetViewController, addr 0x32f5054, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32eeab0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_buttonBinder, addr 0x32f4ff4, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::ButtonBinder* get_buttonBinder();

  /// @brief Method get_canvasGroup, addr 0x32f4368, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::CanvasGroup> get_canvasGroup();

  /// @brief Method get_childViewController, addr 0x32f4eb0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_childViewController();

  /// @brief Method get_containerViewController, addr 0x32f4e98, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::ContainerViewController> get_containerViewController();

  /// @brief Method get_enableUserInteractions, addr 0x32f4f3c, size 0x1c, virtual false, abstract: false, final false
  inline bool get_enableUserInteractions();

  /// @brief Method get_graphicRaycaster, addr 0x32f4f58, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> get_graphicRaycaster();

  /// @brief Method get_isActivated, addr 0x32f4f1c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isActivated();

  /// @brief Method get_isInTransition, addr 0x32f4f2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInTransition();

  /// @brief Method get_isInViewControllerHierarchy, addr 0x32f4eb8, size 0x64, virtual false, abstract: false, final false
  inline bool get_isInViewControllerHierarchy();

  /// @brief Method get_parentViewController, addr 0x32f4ea8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_parentViewController();

  /// @brief Method get_rectTransform, addr 0x32f3738, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform();

  /// @brief Method get_screen, addr 0x32f4ea0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::Screen> get_screen();

  /// @brief Method get_wasActivatedBefore, addr 0x32f4f24, size 0x8, virtual false, abstract: false, final false
  inline bool get_wasActivatedBefore();

  /// @brief Method set_buttonBinder, addr 0x32f4ffc, size 0x8, virtual false, abstract: false, final false
  inline void set_buttonBinder(::HMUI::ButtonBinder* value);

  /// @brief Method set_enableUserInteractions, addr 0x32f4ab8, size 0x24, virtual false, abstract: false, final false
  inline void set_enableUserInteractions(bool value);

  /// @brief Method set_isInTransition, addr 0x32f4f34, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::ViewController) == 0x78, "Size mismatch!");
