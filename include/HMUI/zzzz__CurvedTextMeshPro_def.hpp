...
public:
  ...
  /// @brief Method get_useScriptableObjectColors addr 0x211b864 size 0x8 virtual false final false
  inline bool get_useScriptableObjectColors();

  /// @brief Method set_useScriptableObjectColors addr 0x211b86c size 0xc virtual false final false
  inline void set_useScriptableObjectColors(bool value);

  /// @brief Method get_color addr 0x211b878 size 0x90 virtual true final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color addr 0x211b908 size 0x8 virtual true final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method OnEnable addr 0x211b910 size 0x34 virtual true final false
  inline void OnEnable();

  /// @brief Method GenerateTextMesh addr 0x211b944 size 0x7b4 virtual true final false
  inline void GenerateTextMesh();

  /// @brief Method __Refresh addr 0x211c1a8 size 0x10 virtual true final true
  inline void __Refresh();

  /// @brief Method UpdateMesh addr 0x211c0f8 size 0xb0 virtual false final false
  inline void UpdateMesh(::UnityEngine::Mesh* mesh, int32_t meshIndex, ::UnityEngine::Vector2 curveUV, ::UnityEngine::Color32 color32);

  /// @brief Method FillUV3s addr 0x211c1b8 size 0xd8 virtual false final false
  ...
  /// @brief Method FillColors addr 0x211c290 size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0x211c304 size 0x8c virtual false final false
  inline void _ctor();
