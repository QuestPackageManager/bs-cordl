...
// Write type traits
MARK_REF_T(::HMUI::CurvedTextMeshPro*);
MARK_VAL_T(::HMUI::CurvedTextMeshPro_CurvedMeshInfo);
DEFINE_IL2CPP_CLASS(::HMUI::CurvedTextMeshPro*, "HMUI", "CurvedTextMeshPro");
DEFINE_IL2CPP_CLASS(::HMUI::CurvedTextMeshPro_CurvedMeshInfo, "HMUI", "CurvedTextMeshPro/CurvedMeshInfo");
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector2> uvs3;
...
public:
  ...
  /// @brief Method FillColors, addr 0x32f7f8c, size 0x74, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color32> FillColors(int32_t meshIndex, ::UnityEngine::Color32 color32);

  /// @brief Method FillUV3s, addr 0x32f7eb4, size 0xd8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2> FillUV3s(int32_t meshIndex, int32_t vertexCount, ::UnityEngine::Vector2 curve);

  /// @brief Method GenerateTextMesh, addr 0x32f7b0c, size 0x2e8, virtual true, abstract: false, final false
  inline void GenerateTextMesh();

  static inline ::HMUI::CurvedTextMeshPro* New_ctor();

  /// @brief Method OnEnable, addr 0x32f7ad8, size 0x34, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method UpdateMesh, addr 0x32f7df4, size 0xb0, virtual false, abstract: false, final false
  inline void UpdateMesh(::UnityEngine::Mesh* mesh, int32_t meshIndex, ::UnityEngine::Vector2 curveUV, ::UnityEngine::Color32 color32);

  /// @brief Method __Refresh, addr 0x32f7ea4, size 0x10, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<::HMUI::CurvedTextMeshPro_CurvedMeshInfo> const& __cordl_internal_get__curvedMeshInfos() const;

  constexpr ::ArrayW<::HMUI::CurvedTextMeshPro_CurvedMeshInfo>& __cordl_internal_get__curvedMeshInfos();
  ...
  constexpr void __cordl_internal_set__curvedMeshInfos(::ArrayW<::HMUI::CurvedTextMeshPro_CurvedMeshInfo> value);

  constexpr void __cordl_internal_set__useScriptableObjectColors(bool value);

  /// @brief Method .ctor, addr 0x32f8000, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x32f7a38, size 0x98, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_useScriptableObjectColors, addr 0x32f7a28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x32f7ad0, size 0x8, virtual true, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_useScriptableObjectColors, addr 0x32f7a30, size 0x8, virtual false, abstract: false, final false
