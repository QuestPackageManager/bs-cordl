...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13124)), TypeDefinitionIndex(TypeDefinitionIndex(10205)), TypeDefinitionIndex(TypeDefinitionIndex(10170))}
...
public:
  ...
  /// @brief Method get_handleRect addr 0x1fcc964 size 0x8 virtual false final false
  inline ::UnityEngine::RectTransform* get_handleRect();

  /// @brief Method set_handleRect addr 0x1fcc96c size 0x88 virtual false final false
  inline void set_handleRect(::UnityEngine::RectTransform* value);

  /// @brief Method set_handleColor addr 0x1fccb2c size 0xc4 virtual false final false
  inline void set_handleColor(::UnityEngine::Color value);

  /// @brief Method get_normalizedValue addr 0x1fccbf0 size 0xc virtual false final false
  inline ::UnityEngine::Vector2 get_normalizedValue();

  /// @brief Method set_normalizedValue addr 0x1fccbfc size 0x8 virtual false final false
  inline void set_normalizedValue(::UnityEngine::Vector2 value);

  /// @brief Method add_normalizedValueDidChangeEvent addr 0x1fcccb4 size 0xb4 virtual false final false
  inline void add_normalizedValueDidChangeEvent(::System::Action_2<::HMUI::Slider2D*, ::UnityEngine::Vector2>* value);

  /// @brief Method remove_normalizedValueDidChangeEvent addr 0x1fccd68 size 0xb4 virtual false final false
  inline void remove_normalizedValueDidChangeEvent(::System::Action_2<::HMUI::Slider2D*, ::UnityEngine::Vector2>* value);

  /// @brief Method Rebuild addr 0x1fcce1c size 0x4 virtual true final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method LayoutComplete addr 0x1fcce20 size 0x4 virtual true final false
  inline void LayoutComplete();

  /// @brief Method GraphicUpdateComplete addr 0x1fcce24 size 0x4 virtual true final false
  inline void GraphicUpdateComplete();

  /// @brief Method OnEnable addr 0x1fcce28 size 0x44 virtual true final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x1fcce6c size 0x24 virtual true final false
  inline void OnDisable();

  /// @brief Method UpdateCachedReferences addr 0x1fcc9f4 size 0x138 virtual false final false
  inline void UpdateCachedReferences();

  /// @brief Method SetNormalizedValue addr 0x1fcce90 size 0x8 virtual false final false
  inline void SetNormalizedValue(::UnityEngine::Vector2 input);

  /// @brief Method SetNormalizedValue addr 0x1fccc04 size 0xb0 virtual false final false
  inline void SetNormalizedValue(::UnityEngine::Vector2 input, bool sendCallback);

  /// @brief Method OnRectTransformDimensionsChange addr 0x1fcce98 size 0x44 virtual true final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method UpdateVisuals addr 0x1fccedc size 0x188 virtual true final false
  inline void UpdateVisuals();

  /// @brief Method UpdateDrag addr 0x1fcd064 size 0x230 virtual false final false
  inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method MayDrag addr 0x1fcd294 size 0x64 virtual false final false
  inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnBeginDrag addr 0x1fcd2f8 size 0x80 virtual true final false
  inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDrag addr 0x1fcd378 size 0x90 virtual true final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerDown addr 0x1fcd408 size 0xa0 virtual true final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter addr 0x1fcd4a8 size 0x8 virtual true final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method DoStateTransition addr 0x1fcd4b0 size 0xc virtual true final false
  inline void DoStateTransition(::UnityEngine::UI::__Selectable__SelectionState state, bool instant);

  /// @brief Method OnInitializePotentialDrag addr 0x1fcd4bc size 0x18 virtual true final false
  ...
  /// @brief Method .ctor addr 0x1fcd4d4 size 0x58 virtual false final false
  inline void _ctor();

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x1fcd52c size 0x8 virtual true final true
