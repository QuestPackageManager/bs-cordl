...
public:
  ...
  /// @brief Method Awake, addr 0x39fe430, size 0x98, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNormalizedValueDidChange, addr 0x39ff038, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x39fe60c, size 0x8c, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPointerUp, addr 0x39ff08c, size 0x98, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method SetColors, addr 0x39fe74c, size 0x30, virtual false, abstract: false, final false
  inline void SetColors(::UnityEngine::Color color0, ::UnityEngine::Color color1);

  /// @brief Method TextForNormalizedValue, addr 0x39feea0, size 0x198, virtual true, abstract: false, final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method UpdateVisuals, addr 0x39fe77c, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ff124, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorDidChangeEvent, addr 0x39fe2c8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_colorDidChangeEvent, addr 0x39fe37c, size 0xb4, virtual false, abstract: false, final false
