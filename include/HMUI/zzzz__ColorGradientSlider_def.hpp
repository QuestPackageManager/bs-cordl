...
public:
  ...
  /// @brief Method Awake, addr 0x5736b78, size 0x98, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNormalizedValueDidChange, addr 0x57376b4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5736d64, size 0x80, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPointerUp, addr 0x5737710, size 0x84, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method SetColors, addr 0x5736ea4, size 0x30, virtual false, abstract: false, final false
  inline void SetColors(::UnityEngine::Color color0, ::UnityEngine::Color color1);

  /// @brief Method TextForNormalizedValue, addr 0x5737514, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method UpdateVisuals, addr 0x5736ed4, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5737794, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorDidChangeEvent, addr 0x57369f8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_colorDidChangeEvent, addr 0x5736ab8, size 0xc0, virtual false, abstract: false, final false
