...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x2304a70, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x23049c4, size 0xac, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__6_0, addr 0x2304acc, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2304ac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x230485c, size 0xb4, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::UISelectionState>* value);

  /// @brief Method get_selectionState, addr 0x2304854, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::UISelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x2304910, size 0xb4, virtual false, abstract: false, final false
