...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x5740d80, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method SetSelectionState, addr 0x5740de4, size 0x20, virtual false, abstract: false, final false
  inline void SetSelectionState(::HMUI::UISelectionState state);

  /// @brief Method Start, addr 0x5740ccc, size 0xb4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__6_0, addr 0x5740e0c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5740e04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x5740b4c, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::UISelectionState>* value);

  /// @brief Method get_selectionState, addr 0x5740b44, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::UISelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x5740c0c, size 0xc0, virtual false, abstract: false, final false
