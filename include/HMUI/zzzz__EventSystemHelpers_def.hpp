...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventSystemHelpers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventSystemHelpers(EventSystemHelpers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventSystemHelpers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventSystemHelpers(EventSystemHelpersconst&) = delete;
