...
// Write type traits
MARK_REF_T(::HMUI::HoverTextSetter*);
DEFINE_IL2CPP_CLASS(::HMUI::HoverTextSetter*, "HMUI", "HoverTextSetter");
...
public:
  ...
  /// @brief Method OnDisable, addr 0x587e5a8, size 0x14, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerEnter, addr 0x587e578, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x587e594, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587e5bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x587e568, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x587e570, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::HoverTextSetter) == 0x30, "Size mismatch!");
