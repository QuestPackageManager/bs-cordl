...
public:
  ...
  /// @brief Method OnDisable, addr 0x5735b24, size 0x14, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerEnter, addr 0x5735af4, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x5735b10, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5735b38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x5735ae4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x5735aec, size 0x8, virtual false, abstract: false, final false
