...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HoverTextSetter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HoverTextSetter(HoverTextSetter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HoverTextSetter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HoverTextSetter(HoverTextSetterconst&) = delete;
