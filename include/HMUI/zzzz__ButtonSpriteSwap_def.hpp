...
public:
  ...
  /// @brief Method Awake, addr 0x58815a4, size 0xb4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x5881940, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5881780, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5881760, size 0x20, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshVisualState, addr 0x5881740, size 0x20, virtual false, abstract: false, final false
  inline void RefreshVisualState();

  /// @brief Method Start, addr 0x5881718, size 0x28, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5881a04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
