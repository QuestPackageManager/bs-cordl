...
public:
  ...
  /// @brief Method Awake, addr 0x573ad2c, size 0xb4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleButtonSelectionStateDidChange, addr 0x573b0c8, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x573af08, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x573aee8, size 0x20, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshVisualState, addr 0x573aec8, size 0x20, virtual false, abstract: false, final false
  inline void RefreshVisualState();

  /// @brief Method Start, addr 0x573aea0, size 0x28, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x573b18c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
