...
public:
  ...
  /// @brief Method Awake, addr 0x39f4258, size 0xa8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::HMUI::UIKeyboardKey* New_ctor();

  /// @brief Method OnValidate, addr 0x39f4300, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f43e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeUppercase, addr 0x39f4250, size 0x8, virtual false, abstract: false, final false
  inline bool get_canBeUppercase();

  /// @brief Method get_keyCode, addr 0x39f4248, size 0x8, virtual false, abstract: false, final false
