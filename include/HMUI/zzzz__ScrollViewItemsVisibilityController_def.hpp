...
public:
  ...
  /// @brief Method .ctor addr 0x21457f0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Start>b__11_0 addr 0x21457f8 size 0x44 virtual false final false
  inline float_t _Start_b__11_0(::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*, float_t>* item);

  /// @brief Method <Start>b__11_1 addr 0x214583c size 0x44 virtual false final false
...
public:
  ...
  /// @brief Method Start addr 0x2144eb4 size 0x4a0 virtual false final false
  inline void Start();

  /// @brief Method Update addr 0x21454fc size 0x9c virtual false final false
  inline void Update();

  /// @brief Method UpdateVisibilityUpDirection addr 0x2145354 size 0x1a8 virtual false final false
  inline void UpdateVisibilityUpDirection(float_t newContentAnchoredPositionY);

  /// @brief Method UpdateVisibilityDownDirection addr 0x2145598 size 0x19c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2145734 size 0x58 virtual false final false
  inline void _ctor();
