...
public:
  ...
  /// @brief Method <Start>b__11_0, addr 0x3a01cbc, size 0x44, virtual false, abstract: false, final false
  inline float_t _Start_b__11_0(::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>* item);

  /// @brief Method <Start>b__11_1, addr 0x3a01d00, size 0x44, virtual false, abstract: false, final false
  inline float_t _Start_b__11_1(::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>* item);

  /// @brief Method .ctor, addr 0x3a01cb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Start, addr 0x3a01370, size 0x4a0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3a019b8, size 0x9c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateVisibilityDownDirection, addr 0x3a01a54, size 0x1ac, virtual false, abstract: false, final false
  inline void UpdateVisibilityDownDirection(float_t newContentAnchoredPositionY);

  /// @brief Method UpdateVisibilityUpDirection, addr 0x3a01810, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a01c00, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
