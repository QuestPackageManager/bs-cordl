...
// Write type traits
MARK_REF_T(::HMUI::ScrollViewItemsVisibilityController*);
...
public:
  ...
  /// @brief Method <Start>b__11_0, addr 0x588c9b4, size 0x4c, virtual false, abstract: false, final false
  inline float_t _Start_b__11_0(::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>* item);

  /// @brief Method <Start>b__11_1, addr 0x588ca00, size 0x4c, virtual false, abstract: false, final false
  inline float_t _Start_b__11_1(::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>* item);

  /// @brief Method .ctor, addr 0x588c9b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::ScrollViewItemsVisibilityController___c) == 0x10, "Size mismatch!");

} // namespace HMUI
// Dependencies HMUI.ScrollViewItemForVisibilityController, System.Tuple`2<T1, T2>, UnityEngine.MonoBehaviour, UnityEngine.Vector3
namespace HMUI {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__items, put = __cordl_internal_set__items)) ::ArrayW<::UnityW<::HMUI::ScrollViewItemForVisibilityController>> _items;
  ...
  __declspec(property(get = __cordl_internal_get__viewportWorldCorners, put = __cordl_internal_set__viewportWorldCorners)) ::ArrayW<::UnityEngine::Vector3> _viewportWorldCorners;

  static inline ::HMUI::ScrollViewItemsVisibilityController* New_ctor();

  /// @brief Method Start, addr 0x588c050, size 0x4d0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x588c6cc, size 0xac, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateVisibilityDownDirection, addr 0x588c778, size 0x188, virtual false, abstract: false, final false
  inline void UpdateVisibilityDownDirection(float_t newContentAnchoredPositionY);

  /// @brief Method UpdateVisibilityUpDirection, addr 0x588c520, size 0x1ac, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::HMUI::ScrollViewItemForVisibilityController>> const& __cordl_internal_get__items() const;

  constexpr ::ArrayW<::UnityW<::HMUI::ScrollViewItemForVisibilityController>>& __cordl_internal_get__items();
  ...
  constexpr ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> const& __cordl_internal_get__lowerItemsCornes() const;

  constexpr ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*>& __cordl_internal_get__lowerItemsCornes();
  ...
  constexpr ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> const& __cordl_internal_get__upperItemsCornes() const;

  constexpr ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*>& __cordl_internal_get__upperItemsCornes();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__viewportWorldCorners() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__viewportWorldCorners();
  ...
  constexpr void __cordl_internal_set__items(::ArrayW<::UnityW<::HMUI::ScrollViewItemForVisibilityController>> value);

  constexpr void __cordl_internal_set__lastContentAnchoredPositionY(float_t value);

  constexpr void __cordl_internal_set__lowerItemsCornes(::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> value);

  constexpr void __cordl_internal_set__lowerLastVisibleIndex(int32_t value);

  constexpr void __cordl_internal_set__upperItemsCornes(::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> value);
  ...
  /// @brief Method .ctor, addr 0x588c900, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityW<::HMUI::ScrollViewItemForVisibilityController>> ____items;
  ...
  ::ArrayW<::UnityEngine::Vector3> ____viewportWorldCorners;

  /// @brief Field _upperItemsCornes, offset: 0x48, size: 0x8, def value: None
  ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> ____upperItemsCornes;

  /// @brief Field _lowerItemsCornes, offset: 0x50, size: 0x8, def value: None
  ::ArrayW<::System::Tuple_2<::UnityW<::HMUI::ScrollViewItemForVisibilityController>, float_t>*> ____lowerItemsCornes;
...
static_assert(sizeof(::HMUI::ScrollViewItemsVisibilityController) == 0x68, "Size mismatch!");
