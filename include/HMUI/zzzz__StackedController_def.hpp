...
public:
  ...
  /// @brief Method <PopViewControllers>g__AnimationLayouter|0, addr 0x22eeafc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22eea54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method LayoutViewControllers, addr 0x22ee6ac, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method PopViewController, addr 0x22ee88c, size 0x14, virtual false, abstract: false, final false
  inline void PopViewController(::System::Action* finishedCallback, bool immediately);

  /// @brief Method PopViewControllers, addr 0x22ee8a0, size 0x1b4, virtual false, abstract: false, final false
  inline void PopViewControllers(int32_t numberOfViewControllersToPop, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method PushViewController, addr 0x22ee7e0, size 0xac, virtual false, abstract: false, final false
  inline void PushViewController(::HMUI::ViewController* viewController, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method SetupViewControllerRect, addr 0x22ee794, size 0x28, virtual false, abstract: false, final false
  static inline void SetupViewControllerRect(::HMUI::ViewController* viewController, int32_t index);

  /// @brief Method <PushViewController>g__AnimationLayouter|3_0, addr 0x22eea64, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22eea5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_topStackedViewController, addr 0x22ee634, size 0x78, virtual false, abstract: false, final false
