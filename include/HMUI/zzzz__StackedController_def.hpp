...
// Write type traits
MARK_REF_T(::HMUI::StackedController*);
...
public:
  ...
  /// @brief Method <PopViewControllers>g__AnimationLayouter|0, addr 0x32f4e24, size 0x70, virtual false, abstract: false, final false
  inline void _PopViewControllers_g__AnimationLayouter_0(float_t t, ::ArrayW<::HMUI::ViewController*> viewControllers,
  ...
  /// @brief Method .ctor, addr 0x32f4d8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::StackedController___c__DisplayClass5_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method LayoutViewControllers, addr 0x32f499c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method PopViewController, addr 0x32f4b84, size 0x10, virtual false, abstract: false, final false
  inline void PopViewController(::System::Action* finishedCallback, bool immediately);

  /// @brief Method PopViewControllers, addr 0x32f4b94, size 0x1f8, virtual false, abstract: false, final false
  inline void PopViewControllers(int32_t numberOfViewControllersToPop, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method PushViewController, addr 0x32f4adc, size 0xa8, virtual false, abstract: false, final false
  inline void PushViewController(::HMUI::ViewController* viewController, ::System::Action* finishedCallback, bool immediately);

  /// @brief Method SetupViewControllerRect, addr 0x32f4a90, size 0x28, virtual false, abstract: false, final false
  static inline void SetupViewControllerRect(::HMUI::ViewController* viewController, int32_t index);

  /// @brief Method <PushViewController>g__AnimationLayouter|3_0, addr 0x32f4d94, size 0x90, virtual false, abstract: false, final false
  static inline void _PushViewController_g__AnimationLayouter_3_0(float_t t, ::ArrayW<::HMUI::ViewController*> viewControllers);

  /// @brief Method .ctor, addr 0x32f4d90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_topStackedViewController, addr 0x32f4918, size 0x84, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::HMUI::StackedController) == 0x88, "Size mismatch!");
