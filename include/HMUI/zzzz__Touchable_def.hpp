...
// Write type traits
MARK_REF_T(::HMUI::Touchable*);
DEFINE_IL2CPP_CLASS(::HMUI::Touchable*, "HMUI", "Touchable");
...
public:
  ...
  /// @brief Method OnPopulateMesh, addr 0x588106c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5880bd4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_skew, addr 0x5881064, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Touchable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Touchable(Touchable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Touchable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Touchable(Touchableconst&) = delete;
...
static_assert(sizeof(::HMUI::Touchable) == 0xa8, "Size mismatch!");
