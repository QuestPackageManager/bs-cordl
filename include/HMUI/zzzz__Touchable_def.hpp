...
public:
  ...
  /// @brief Method OnPopulateMesh, addr 0x56ccb80, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56cc6e8, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_skew, addr 0x56ccb78, size 0x8, virtual false, abstract: false, final false
