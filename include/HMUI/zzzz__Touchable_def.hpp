...
/// @brief Method OnPopulateMesh, addr 0x573c05c, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x573bbc4, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_skew, addr 0x573c054, size 0x8, virtual false, abstract: false, final false
