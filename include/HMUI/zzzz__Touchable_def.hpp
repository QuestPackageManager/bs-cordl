...
public:
  ...
  /// @brief Method OnPopulateMesh, addr 0x398a130, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3989cb8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_skew, addr 0x398a128, size 0x8, virtual false, abstract: false, final false
