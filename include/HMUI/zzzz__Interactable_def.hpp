...
public:
  ...
  /// @brief Method add_interactableChangeEvent, addr 0x21b2284, size 0xb0, virtual false, abstract: false, final false
  inline void add_interactableChangeEvent(::System::Action_2<::UnityW<::HMUI::Interactable>, bool>* value);

  /// @brief Method remove_interactableChangeEvent, addr 0x21b2334, size 0xb0, virtual false, abstract: false, final false
  inline void remove_interactableChangeEvent(::System::Action_2<::UnityW<::HMUI::Interactable>, bool>* value);

  /// @brief Method get_interactable, addr 0x21b23e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method set_interactable, addr 0x21b23ec, size 0x3c, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  static inline ::HMUI::Interactable* New_ctor();

  /// @brief Method .ctor, addr 0x21ac41c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
