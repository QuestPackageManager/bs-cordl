...
public:
  ...
  /// @brief Method <Awake>b__49_1, addr 0x588bf98, size 0x4, virtual false, abstract: false, final false
  inline float_t _Awake_b__49_1(float_t i);

  /// @brief Method <Awake>b__49_3, addr 0x588bf9c, size 0x4, virtual false, abstract: false, final false
  inline float_t _Awake_b__49_3(float_t i);

  /// @brief Method .ctor, addr 0x588bf94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PageUpButtonPressed>b__0, addr 0x588bfa0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588bad4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PageDownButtonPressed>b__0, addr 0x588bfb0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588be2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleJoystickWasCenteredThisFrame>b__0, addr 0x588bfc0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588be9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleJoystickWasCenteredThisFrame>b__1, addr 0x588bfd0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588bea0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x5889dd0, size 0x63c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CheckScrollInput, addr 0x588a908, size 0x178, virtual false, abstract: false, final false
  inline void CheckScrollInput();

  /// @brief Method HandleJoystickWasCenteredThisFrame, addr 0x588abbc, size 0x4dc, virtual false, abstract: false, final false
  inline void HandleJoystickWasCenteredThisFrame();

  /// @brief Method HandleJoystickWasNotCenteredThisFrame, addr 0x588aa80, size 0x13c, virtual false, abstract: false, final false
  inline void HandleJoystickWasNotCenteredThisFrame(::UnityEngine::Vector2 deltaPos);

  /// @brief Method HandlePointerDidEnter, addr 0x588be30, size 0x14, virtual false, abstract: false, final false
  inline void HandlePointerDidEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method HandlePointerDidExit, addr 0x588be44, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x588a644, size 0x204, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PageDownButtonPressed, addr 0x588bad8, size 0x354, virtual false, abstract: false, final false
  inline void PageDownButtonPressed();

  /// @brief Method PageUpButtonPressed, addr 0x588b7b4, size 0x320, virtual false, abstract: false, final false
  inline void PageUpButtonPressed();

  /// @brief Method RefreshButtons, addr 0x588a530, size 0x114, virtual false, abstract: false, final false
  inline void RefreshButtons();

  /// @brief Method ResolveScrollDirection, addr 0x588be4c, size 0x50, virtual false, abstract: false, final false
  inline ::HMUI::ScrollView_ScrollDirection ResolveScrollDirection(::UnityEngine::Vector2 deltaPos);

  /// @brief Method ScrollTo, addr 0x58899b8, size 0xb8, virtual false, abstract: false, final false
  inline void ScrollTo(float_t destinationPos, bool animated);

  /// @brief Method ScrollToByPercentage, addr 0x588b6fc, size 0x3c, virtual false, abstract: false, final false
  inline void ScrollToByPercentage(float_t value);

  /// @brief Method ScrollToEnd, addr 0x588b4f8, size 0x40, virtual false, abstract: false, final false
  inline void ScrollToEnd(bool animated);

  /// @brief Method ScrollToWorldPosition, addr 0x588b538, size 0x50, virtual false, abstract: false, final false
  inline void ScrollToWorldPosition(::UnityEngine::Vector3 worldPosition, float_t pageRelativePosition, bool animated);

  /// @brief Method ScrollToWorldPositionIfOutsideArea, addr 0x588b648, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetContentSize, addr 0x588b2bc, size 0x20c, virtual false, abstract: false, final false
  inline void SetContentSize(float_t contentSize);

  /// @brief Method SetDestinationPos, addr 0x588b738, size 0x4c, virtual false, abstract: false, final false
  inline void SetDestinationPos(float_t value);

  /// @brief Method Update, addr 0x588b098, size 0x148, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateContentSize, addr 0x588a4cc, size 0x64, virtual false, abstract: false, final false
  inline void UpdateContentSize();

  /// @brief Method UpdateVerticalScrollIndicator, addr 0x588b1e0, size 0xdc, virtual false, abstract: false, final false
  inline void UpdateVerticalScrollIndicator(float_t posY);

  /// @brief Method WorldPositionToScrollViewPosition, addr 0x588b588, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 WorldPositionToScrollViewPosition(::UnityEngine::Vector3 worldPosition);

  /// @brief Method <Awake>b__49_0, addr 0x588bed0, size 0x3c, virtual false, abstract: false, final false
  inline float_t _Awake_b__49_0(::HMUI::ItemForFocussedScrolling* item);

  /// @brief Method <Awake>b__49_2, addr 0x588bf0c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588bea4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_scrollPositionChangedEvent, addr 0x5889b50, size 0xc0, virtual false, abstract: false, final false
  inline void add_scrollPositionChangedEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_contentSize, addr 0x5889d50, size 0x40, virtual false, abstract: false, final false
  inline float_t get_contentSize();

  /// @brief Method get_contentTransform, addr 0x5889cd8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_contentTransform();

  /// @brief Method get_needsScrolling, addr 0x5889a74, size 0x8, virtual false, abstract: false, final false
  inline bool get_needsScrolling();

  /// @brief Method get_needsVerticalScrollController, addr 0x5889a7c, size 0xd4, virtual false, abstract: false, final false
  inline bool get_needsVerticalScrollController();

  /// @brief Method get_position, addr 0x5889ce0, size 0x3c, virtual false, abstract: false, final false
  inline float_t get_position();

  /// @brief Method get_scrollPageSize, addr 0x5889d90, size 0x40, virtual false, abstract: false, final false
  inline float_t get_scrollPageSize();

  /// @brief Method get_scrollableSize, addr 0x5889d1c, size 0x34, virtual false, abstract: false, final false
  inline float_t get_scrollableSize();

  /// @brief Method get_viewportTransform, addr 0x5889cd0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_viewportTransform();

  /// @brief Method remove_scrollPositionChangedEvent, addr 0x5889c10, size 0xc0, virtual false, abstract: false, final false
