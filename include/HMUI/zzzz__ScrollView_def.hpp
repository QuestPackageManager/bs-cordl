...
/// @brief Method <Awake>b__46_1, addr 0x56d5520, size 0x4, virtual false, abstract: false, final false
inline float_t _Awake_b__46_1(float_t  i) ;

/// @brief Method <Awake>b__46_3, addr 0x56d5524, size 0x4, virtual false, abstract: false, final false
inline float_t _Awake_b__46_3(float_t  i) ;

/// @brief Method .ctor, addr 0x56d551c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <PageUpButtonPressed>b__0, addr 0x56d5528, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d505c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <PageDownButtonPressed>b__0, addr 0x56d5538, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d53b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleJoystickWasCenteredThisFrame>b__0, addr 0x56d5548, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d5424, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleJoystickWasCenteredThisFrame>b__1, addr 0x56d5558, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d5428, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _lastJoystickScrollDirection, offset 0xa8, size 0x4 
 __declspec(property(get=__cordl_internal_get__lastJoystickScrollDirection, put=__cordl_internal_set__lastJoystickScrollDirection)) ::HMUI::ScrollView_ScrollDirection  _lastJoystickScrollDirection;
...
/// @brief Method Awake, addr 0x56d338c, size 0x63c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckScrollInput, addr 0x56d3ec4, size 0x160, virtual false, abstract: false, final false
inline void CheckScrollInput() ;

/// @brief Method HandleJoystickWasCenteredThisFrame, addr 0x56d4160, size 0x4dc, virtual false, abstract: false, final false
inline void HandleJoystickWasCenteredThisFrame() ;

/// @brief Method HandleJoystickWasNotCenteredThisFrame, addr 0x56d4024, size 0x13c, virtual false, abstract: false, final false
inline void HandleJoystickWasNotCenteredThisFrame(::UnityEngine::Vector2  deltaPos) ;

/// @brief Method HandlePointerDidEnter, addr 0x56d53b8, size 0x14, virtual false, abstract: false, final false
inline void HandlePointerDidEnter(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method HandlePointerDidExit, addr 0x56d53cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x56d3c00, size 0x204, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PageDownButtonPressed, addr 0x56d5060, size 0x354, virtual false, abstract: false, final false
inline void PageDownButtonPressed() ;

/// @brief Method PageUpButtonPressed, addr 0x56d4d3c, size 0x320, virtual false, abstract: false, final false
inline void PageUpButtonPressed() ;

/// @brief Method RefreshButtons, addr 0x56d3aec, size 0x114, virtual false, abstract: false, final false
inline void RefreshButtons() ;

/// @brief Method ResolveScrollDirection, addr 0x56d53d4, size 0x50, virtual false, abstract: false, final false
inline ::HMUI::ScrollView_ScrollDirection ResolveScrollDirection(::UnityEngine::Vector2  deltaPos) ;

/// @brief Method ScrollTo, addr 0x56d3048, size 0xb8, virtual false, abstract: false, final false
inline void ScrollTo(float_t  destinationPos, bool  animated) ;

/// @brief Method ScrollToByPercentage, addr 0x56d4c84, size 0x3c, virtual false, abstract: false, final false
inline void ScrollToByPercentage(float_t  value) ;

/// @brief Method ScrollToEnd, addr 0x56d4aa0, size 0x40, virtual false, abstract: false, final false
inline void ScrollToEnd(bool  animated) ;

/// @brief Method ScrollToWorldPosition, addr 0x56d4ae0, size 0x48, virtual false, abstract: false, final false
inline void ScrollToWorldPosition(::UnityEngine::Vector3  worldPosition, float_t  pageRelativePosition, bool  animated) ;

/// @brief Method ScrollToWorldPositionIfOutsideArea, addr 0x56d4bd8, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method SetContentSize, addr 0x56d4864, size 0x20c, virtual false, abstract: false, final false
inline void SetContentSize(float_t  contentSize) ;

/// @brief Method SetDestinationPos, addr 0x56d4cc0, size 0x4c, virtual false, abstract: false, final false
inline void SetDestinationPos(float_t  value) ;

/// @brief Method Update, addr 0x56d463c, size 0x14c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateContentSize, addr 0x56d3a88, size 0x64, virtual false, abstract: false, final false
inline void UpdateContentSize() ;

/// @brief Method UpdateVerticalScrollIndicator, addr 0x56d4788, size 0xdc, virtual false, abstract: false, final false
inline void UpdateVerticalScrollIndicator(float_t  posY) ;

/// @brief Method WorldPositionToScrollViewPosition, addr 0x56d4b28, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 WorldPositionToScrollViewPosition(::UnityEngine::Vector3  worldPosition) ;

/// @brief Method <Awake>b__46_0, addr 0x56d5458, size 0x3c, virtual false, abstract: false, final false
inline float_t _Awake_b__46_0(::HMUI::ItemForFocussedScrolling*  item) ;

/// @brief Method <Awake>b__46_2, addr 0x56d5494, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d542c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_scrollPositionChangedEvent, addr 0x56d310c, size 0xc0, virtual false, abstract: false, final false
inline void add_scrollPositionChangedEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_contentSize, addr 0x56d330c, size 0x40, virtual false, abstract: false, final false
inline float_t get_contentSize() ;

/// @brief Method get_contentTransform, addr 0x56d3294, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_contentTransform() ;

/// @brief Method get_needsScrolling, addr 0x56d3104, size 0x8, virtual false, abstract: false, final false
inline bool get_needsScrolling() ;

/// @brief Method get_position, addr 0x56d329c, size 0x3c, virtual false, abstract: false, final false
inline float_t get_position() ;

/// @brief Method get_scrollPageSize, addr 0x56d334c, size 0x40, virtual false, abstract: false, final false
inline float_t get_scrollPageSize() ;

/// @brief Method get_scrollableSize, addr 0x56d32d8, size 0x34, virtual false, abstract: false, final false
inline float_t get_scrollableSize() ;

/// @brief Method get_viewportTransform, addr 0x56d328c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_viewportTransform() ;

/// @brief Method remove_scrollPositionChangedEvent, addr 0x56d31cc, size 0xc0, virtual false, abstract: false, final false
