...
public:
  ...
  /// @brief Method OnDisable, addr 0x2518bb4, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerEnter, addr 0x25189d0, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x2518a80, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2518c34, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_size, addr 0x2518844, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_size();

  /// @brief Method get_text, addr 0x2518834, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_worldCenter, addr 0x25188d4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x251883c, size 0x8, virtual false, abstract: false, final false
