...
public:
  ...
  /// @brief Method OnDisable, addr 0x24ffc70, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerEnter, addr 0x24ffa8c, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x24ffb3c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24ffcf0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_size, addr 0x24ff900, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_size();

  /// @brief Method get_text, addr 0x24ff8f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_worldCenter, addr 0x24ff990, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x24ff8f8, size 0x8, virtual false, abstract: false, final false
