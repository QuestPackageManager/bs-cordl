...
public:
  ...
  /// @brief Method OnDisable, addr 0x23fefe8, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerEnter, addr 0x23fee04, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x23feeb4, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23ff068, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_size, addr 0x23fec78, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_size();

  /// @brief Method get_text, addr 0x23fec68, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method get_worldCenter, addr 0x23fed08, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_text, addr 0x23fec70, size 0x8, virtual false, abstract: false, final false
