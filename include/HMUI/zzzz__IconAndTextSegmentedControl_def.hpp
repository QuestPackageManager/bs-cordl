...
public:
  ...
  /// @brief Method .ctor, addr 0x408bb68, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* icon, ::StringW text, bool interactable);

  /// @brief Method get_icon, addr 0x408bb34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_icon();

  /// @brief Method get_interactable, addr 0x408bb54, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method get_text, addr 0x408bb44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_icon, addr 0x408bb3c, size 0x8, virtual false, abstract: false, final false
  inline void set_icon(::UnityEngine::Sprite* value);

  /// @brief Method set_interactable, addr 0x408bb5c, size 0xc, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  /// @brief Method set_text, addr 0x408bb4c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CellForCellNumber, addr 0x408b4ac, size 0x150, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::SegmentedControlCell> CellForCellNumber(int32_t cellNumber);

  /// @brief Method Init, addr 0x408af4c, size 0x1c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::HMUI::IconAndTextSegmentedControl* New_ctor();

  /// @brief Method NumberOfCells, addr 0x408b494, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x408af70, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTextsActive, addr 0x408b63c, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408b994, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
