...
// Write type traits
MARK_REF_T(::HMUI::DropdownWithTitleView*);
DEFINE_IL2CPP_CLASS(::HMUI::DropdownWithTitleView*, "HMUI", "DropdownWithTitleView");
...
public:
  ...
  /// @brief Method RefreshSize, addr 0x5884ee8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5884f48, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::DropdownWithTitleView) == 0x90, "Size mismatch!");
