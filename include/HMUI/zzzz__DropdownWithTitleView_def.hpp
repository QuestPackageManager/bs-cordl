...
public:
  ...
  /// @brief Method RefreshSize, addr 0x3a036ec, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a0374c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
