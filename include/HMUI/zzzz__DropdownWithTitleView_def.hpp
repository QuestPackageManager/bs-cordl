...
public:
  ...
  /// @brief Method RefreshSize, addr 0x39f074c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f07ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
