...
public:
  ...
  /// @brief Method RefreshSize, addr 0x39f83d8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f8438, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
