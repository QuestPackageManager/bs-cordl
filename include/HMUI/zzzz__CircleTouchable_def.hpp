...
public:
  ...
  /// @brief Method DrawGizmoCircle, addr 0x566b950, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDrawGizmosSelected, addr 0x566b818, size 0x138, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method OnEnable, addr 0x566b6c0, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Raycast, addr 0x566b74c, size 0xcc, virtual true, abstract: false, final false
  inline bool Raycast(::UnityEngine::Vector2 sp, ::UnityEngine::Camera* eventCamera);

  /// @brief Method UpdateCachedReferences, addr 0x566b6dc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x566ba30, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
