...
/// @brief Method .ctor, addr 0x323cdd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_data, addr 0x323cdd0, size 0x8, virtual false, abstract: false, final false
