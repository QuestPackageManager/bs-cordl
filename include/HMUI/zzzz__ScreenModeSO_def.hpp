...
public:
  ...
  /// @brief Method .ctor, addr 0x252746c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x2527464, size 0x8, virtual false, abstract: false, final false
