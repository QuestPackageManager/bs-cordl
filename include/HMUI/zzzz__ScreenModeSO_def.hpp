...
public:
  ...
  /// @brief Method .ctor, addr 0x323c03c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x323c034, size 0x8, virtual false, abstract: false, final false
