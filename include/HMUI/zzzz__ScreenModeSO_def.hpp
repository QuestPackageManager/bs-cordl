...
// Write type traits
MARK_REF_T(::HMUI::ScreenModeSO*);
DEFINE_IL2CPP_CLASS(::HMUI::ScreenModeSO*, "HMUI", "ScreenModeSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32f47e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x32f47d8, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::HMUI::ScreenModeSO) == 0x20, "Size mismatch!");
