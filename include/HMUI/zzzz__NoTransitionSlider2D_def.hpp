...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionSlider2D", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoTransitionSlider2D(NoTransitionSlider2D&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionSlider2D", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoTransitionSlider2D(NoTransitionSlider2Dconst&) = delete;
