...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x588e4f0, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588e530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x588e370, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::NoTransitionSlider2D_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x588e368, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::NoTransitionSlider2D_SelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x588e430, size 0xc0, virtual false, abstract: false, final false
