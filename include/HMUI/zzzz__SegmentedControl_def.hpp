...
public:
  ...
  /// @brief Method CreateCells, addr 0x5e1435c, size 0x644, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCellSelectionDidChange, addr 0x5e149ac, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNonInteractableCellWasPressed, addr 0x5e14b20, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadData, addr 0x5e1307c, size 0x474, virtual false, abstract: false, final false
  inline void ReloadData();

  /// @brief Method SelectCellWithNumber, addr 0x5e14c54, size 0xac, virtual false, abstract: false, final false
  inline void SelectCellWithNumber(int32_t selectCellNumber);

  /// @brief Method SetCallbackForCell, addr 0x5e14bd8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e139e0, size 0x20c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressNonInteractableCellEvent, addr 0x5e141c4, size 0xc0, virtual false, abstract: false, final false
  inline void add_didPressNonInteractableCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>, int32_t>* value);

  /// @brief Method add_didSelectCellEvent, addr 0x5e14044, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>, int32_t>* value);

  /// @brief Method get_cells, addr 0x5e14354, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::HMUI::SegmentedControlCell>>* get_cells();

  /// @brief Method get_dataSource, addr 0x5e14344, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::SegmentedControl_IDataSource* get_dataSource();

  /// @brief Method get_selectedCellNumber, addr 0x5e1434c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_selectedCellNumber();

  /// @brief Method remove_didPressNonInteractableCellEvent, addr 0x5e14284, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didPressNonInteractableCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>, int32_t>* value);

  /// @brief Method remove_didSelectCellEvent, addr 0x5e14104, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didSelectCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>, int32_t>* value);

  /// @brief Method set_dataSource, addr 0x5e13034, size 0x8, virtual false, abstract: false, final false
