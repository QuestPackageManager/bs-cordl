...
inline bool HMUI::SetPropertyUtility::SetStruct(::by_ref<T> currentValue, T newValue) {
...
inline bool HMUI::SetPropertyUtility::SetClass(::by_ref<T> currentValue, T newValue) {
  static auto* ___internal_method_base = THROW_UNLESS(
