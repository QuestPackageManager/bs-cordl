...
public:
  ...
  /// @brief Method MoveNext, addr 0x252d69c, size 0xec, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::__HoverHintController___ShowHintAfterDelay_d__10* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x252d788, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x252d790, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x252d7d0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x252d698, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x252d27c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x252d7dc, size 0xcc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::__HoverHintController___HideHintAfterDelay_d__11* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x252d8a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x252d8b0, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x252d8f0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x252d7d8, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x252d2a4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method Awake, addr 0x252cf40, size 0xa0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetScreenTransformForHoverHint, addr 0x252d2cc, size 0x150, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> GetScreenTransformForHoverHint(::HMUI::HoverHint* hoverHint);

  /// @brief Method HideHint, addr 0x252ce24, size 0x44, virtual false, abstract: false, final false
  inline void HideHint();

  /// @brief Method HideHintAfterDelay, addr 0x252d204, size 0x78, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* HideHintAfterDelay(float_t delay);

  /// @brief Method HideHintInstant, addr 0x252cdf0, size 0x34, virtual false, abstract: false, final false
  inline void HideHintInstant();

  static inline ::HMUI::HoverHintController* New_ctor();

  /// @brief Method OnApplicationFocus, addr 0x252d008, size 0x2c, virtual false, abstract: false, final false
  inline void OnApplicationFocus(bool hasFocus);

  /// @brief Method SetupAndShowHintPanel, addr 0x252d034, size 0x14c, virtual false, abstract: false, final false
  inline void SetupAndShowHintPanel(::HMUI::HoverHint* hoverHint);

  /// @brief Method ShowHint, addr 0x252cca0, size 0x94, virtual false, abstract: false, final false
  inline void ShowHint(::HMUI::HoverHint* hoverHint);

  /// @brief Method ShowHintAfterDelay, addr 0x252d180, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252d690, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
