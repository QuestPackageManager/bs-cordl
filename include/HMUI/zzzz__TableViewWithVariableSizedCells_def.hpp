...
public:
  ...
  /// @brief Method GetCellPosition, addr 0x5892fc0, size 0x50, virtual true, abstract: false, final false
  inline float_t GetCellPosition(int32_t idx);

  /// @brief Method GetCellSize, addr 0x5892f90, size 0x30, virtual true, abstract: false, final false
  inline float_t GetCellSize(int32_t idx);

  /// @brief Method GetMaxVisibleIdx, addr 0x5892ea0, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetMaxVisibleIdx();

  /// @brief Method GetMinVisibleIdx, addr 0x5892dd0, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetMinVisibleIdx();

  static inline ::HMUI::TableViewWithVariableSizedCells* New_ctor();

  /// @brief Method UpdateCachedData, addr 0x5893010, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5893204, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_contentSize, addr 0x5892dc8, size 0x8, virtual true, abstract: false, final false
