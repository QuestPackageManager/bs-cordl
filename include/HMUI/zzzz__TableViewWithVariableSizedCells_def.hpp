...
public:
  ...
  __declspec(property(get = __cordl_internal_get__cachedCellSizes, put = __cordl_internal_set__cachedCellSizes)) ::ArrayW<float_t> _cachedCellSizes;

  /// @brief Field _cachedCumulativeCellSizes, offset 0xd0, size 0x8
  __declspec(property(get = __cordl_internal_get__cachedCumulativeCellSizes, put = __cordl_internal_set__cachedCumulativeCellSizes)) ::ArrayW<float_t> _cachedCumulativeCellSizes;
  ...
  /// @brief Method GetCellPosition, addr 0x5890e34, size 0x50, virtual true, abstract: false, final false
  inline float_t GetCellPosition(int32_t idx);

  /// @brief Method GetCellSize, addr 0x5890e04, size 0x30, virtual true, abstract: false, final false
  inline float_t GetCellSize(int32_t idx);

  /// @brief Method GetMaxVisibleIdx, addr 0x5890d14, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetMaxVisibleIdx();

  /// @brief Method GetMinVisibleIdx, addr 0x5890c44, size 0xd0, virtual true, abstract: false, final false
  inline int32_t GetMinVisibleIdx();

  static inline ::HMUI::TableViewWithVariableSizedCells* New_ctor();

  /// @brief Method UpdateCachedData, addr 0x5890e84, size 0x1f4, virtual true, abstract: false, final false
  inline void UpdateCachedData();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get__cachedCellSizes() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__cachedCellSizes();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get__cachedCumulativeCellSizes() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__cachedCumulativeCellSizes();

  constexpr float_t const& __cordl_internal_get__totalHeight() const;

  constexpr float_t& __cordl_internal_get__totalHeight();

  constexpr void __cordl_internal_set__cachedCellSizes(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__cachedCumulativeCellSizes(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__totalHeight(float_t value);

  /// @brief Method .ctor, addr 0x5891078, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_contentSize, addr 0x5890c3c, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  ::ArrayW<float_t> ____cachedCellSizes;

  /// @brief Field _cachedCumulativeCellSizes, offset: 0xd0, size: 0x8, def value: None
  ::ArrayW<float_t> ____cachedCumulativeCellSizes;
...
static_assert(sizeof(::HMUI::TableViewWithVariableSizedCells) == 0xd8, "Size mismatch!");
