...
/// @brief Method GetCellPosition, addr 0x56dbf6c, size 0x50, virtual true, abstract: false, final false
inline float_t GetCellPosition(int32_t  idx) ;

/// @brief Method GetCellSize, addr 0x56dbf3c, size 0x30, virtual true, abstract: false, final false
inline float_t GetCellSize(int32_t  idx) ;

/// @brief Method GetMaxVisibleIdx, addr 0x56dbe4c, size 0xf0, virtual true, abstract: false, final false
inline int32_t GetMaxVisibleIdx() ;

/// @brief Method GetMinVisibleIdx, addr 0x56dbd7c, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetMinVisibleIdx() ;

static inline ::HMUI::TableViewWithVariableSizedCells* New_ctor() ;

/// @brief Method UpdateCachedData, addr 0x56dbfbc, size 0x1f4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56dc1b0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_contentSize, addr 0x56dbd74, size 0x8, virtual true, abstract: false, final false
