...
public:
  ...
  /// @brief Method .ctor, addr 0x4097c10, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* icon, ::StringW hintText, bool interactable);

  /// @brief Method get_hintText, addr 0x4097bec, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_hintText();

  /// @brief Method get_icon, addr 0x4097bdc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_icon();

  /// @brief Method get_interactable, addr 0x4097bfc, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method set_hintText, addr 0x4097bf4, size 0x8, virtual false, abstract: false, final false
  inline void set_hintText(::StringW value);

  /// @brief Method set_icon, addr 0x4097be4, size 0x8, virtual false, abstract: false, final false
  inline void set_icon(::UnityEngine::Sprite* value);

  /// @brief Method set_interactable, addr 0x4097c04, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CellForCellNumber, addr 0x40978f4, size 0x1c8, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::SegmentedControlCell> CellForCellNumber(int32_t cellNumber);

  /// @brief Method Init, addr 0x4097880, size 0x1c, virtual false, abstract: false, final false
  inline void Init();

  static inline ::HMUI::IconSegmentedControl* New_ctor();

  /// @brief Method NumberOfCells, addr 0x40978dc, size 0x18, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x409789c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4097bcc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
