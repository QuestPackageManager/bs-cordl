...
/// @brief Field _curvedCanvasCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__curvedCanvasCache, put=setStaticF__curvedCanvasCache)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityW<::HMUI::CurvedCanvasSettings>>*  _curvedCanvasCache;
...
/// @brief Method GetCurvedCanvasSettings, addr 0x56c4aa8, size 0x1fc, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas*  canvas) ;

/// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x56c4ca4, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x56c4a94, size 0x14, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x56c4e24, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
