...
public:
  ...
  /// @brief Method GetCurvedCanvasSettings, addr 0x39ec954, size 0x1ec, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas* canvas);

  /// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x39ecb40, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x39ec940, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x39ecc7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
