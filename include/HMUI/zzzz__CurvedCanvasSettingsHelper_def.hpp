...
public:
  ...
  /// @brief Method GetCurvedCanvasSettings, addr 0x5878d74, size 0x1fc, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas* canvas);

  /// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x5878f70, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5878d60, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CurvedCanvasSettingsHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CurvedCanvasSettingsHelper(CurvedCanvasSettingsHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CurvedCanvasSettingsHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CurvedCanvasSettingsHelper(CurvedCanvasSettingsHelperconst&) = delete;
