...
public:
  ...
  /// @brief Method GetCurvedCanvasSettings, addr 0x5732994, size 0x1fc, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas* canvas);

  /// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x5732b90, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5732980, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5732d10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
