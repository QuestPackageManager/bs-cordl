...
public:
  ...
  /// @brief Method GetCurvedCanvasSettings, addr 0x25172f0, size 0x1ec, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas* canvas);

  /// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x25174dc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x25172dc, size 0x14, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x25175ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
