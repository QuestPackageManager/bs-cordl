...
public:
  ...
  /// @brief Method .ctor, addr 0x3a10014, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cells, addr 0x3a1000c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::HMUI::TableCell>>* get_cells();

  /// @brief Method get_reuseIdentifier, addr 0x3a10004, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddCellToReusableCells, addr 0x3a0f3ac, size 0x160, virtual false, abstract: false, final false
  inline void AddCellToReusableCells(::HMUI::TableCell* cell);

  /// @brief Method Awake, addr 0x3a0e3d0, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ChangeRectSize, addr 0x3a0ff54, size 0xb0, virtual false, abstract: false, final false
  inline void ChangeRectSize(::UnityEngine::RectTransform_Axis axis, float_t size);

  /// @brief Method ClearHighlights, addr 0x3a0edb4, size 0x154, virtual false, abstract: false, final false
  inline void ClearHighlights();

  /// @brief Method ClearSelection, addr 0x3a0fd5c, size 0x1ac, virtual false, abstract: false, final false
  inline void ClearSelection();

  /// @brief Method DeleteCells, addr 0x3a0d274, size 0x318, virtual false, abstract: false, final false
  inline void DeleteCells(int32_t idx, int32_t count);

  /// @brief Method DequeueReusableCellForIdentifier, addr 0x3a0b8e8, size 0xec, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::TableCell> DequeueReusableCellForIdentifier(::StringW identifier);

  /// @brief Method DidSelectCellWithIdx, addr 0x3a0fa3c, size 0x28, virtual true, abstract: false, final false
  inline void DidSelectCellWithIdx(int32_t idx);

  /// @brief Method GetCellAtIndex, addr 0x3a0efc0, size 0xb0, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::TableCell> GetCellAtIndex(int32_t index);

  /// @brief Method GetCellPosition, addr 0x3a0f364, size 0x48, virtual true, abstract: false, final false
  inline float_t GetCellPosition(int32_t idx);

  /// @brief Method GetCellSize, addr 0x3a0f35c, size 0x8, virtual true, abstract: false, final false
  inline float_t GetCellSize(int32_t idx);

  /// @brief Method GetMaxVisibleIdx, addr 0x3a0f234, size 0x128, virtual true, abstract: false, final false
  inline int32_t GetMaxVisibleIdx();

  /// @brief Method GetMinVisibleIdx, addr 0x3a0f148, size 0xec, virtual true, abstract: false, final false
  inline int32_t GetMinVisibleIdx();

  /// @brief Method GetVisibleCellsIdRange, addr 0x3a0f070, size 0xd8, virtual false, abstract: false, final false
  inline ::System::Tuple_2<int32_t, int32_t>* GetVisibleCellsIdRange();

  /// @brief Method HandleCellSelectionDidChange, addr 0x3a0f758, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScrollRectValueChanged, addr 0x3a0f74c, size 0xc, virtual false, abstract: false, final false
  inline void HandleScrollRectValueChanged(float_t f);

  /// @brief Method Hide, addr 0x3a0ef08, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  /// @brief Method InsertCells, addr 0x3a0ce70, size 0x35c, virtual false, abstract: false, final false
  inline void InsertCells(int32_t idx, int32_t count);

  /// @brief Method LayoutCellForIdx, addr 0x3a0f50c, size 0x240, virtual false, abstract: false, final false
  inline void LayoutCellForIdx(::HMUI::TableCell* cell, int32_t idx, float_t offset);

  /// @brief Method LazyInit, addr 0x3a0e3e0, size 0x348, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::HMUI::TableView* New_ctor();

  /// @brief Method OnDestroy, addr 0x3a0e728, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x3a0e7b4, size 0x54, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshCells, addr 0x3a0e808, size 0x5ac, virtual false, abstract: false, final false
  inline void RefreshCells(bool forcedVisualsRefresh, bool forcedContentRefresh);

  /// @brief Method RefreshCellsContent, addr 0x3a0efb4, size 0xc, virtual false, abstract: false, final false
  inline void RefreshCellsContent();

  /// @brief Method RefreshContentSize, addr 0x3a0ef50, size 0x64, virtual false, abstract: false, final false
  inline void RefreshContentSize();

  /// @brief Method ReloadData, addr 0x3a0c904, size 0x2d8, virtual true, abstract: false, final false
  inline void ReloadData();

  /// @brief Method ReloadDataKeepingPosition, addr 0x3a0fb10, size 0x4c, virtual false, abstract: false, final false
  inline void ReloadDataKeepingPosition();

  /// @brief Method ScrollToCellWithIdx, addr 0x3a0d5d0, size 0xe4, virtual false, abstract: false, final false
  inline void ScrollToCellWithIdx(int32_t idx, ::HMUI::TableView_ScrollPositionType scrollPositionType, bool animated);

  /// @brief Method ScrollToPosition, addr 0x3a0ff08, size 0x4c, virtual false, abstract: false, final false
  inline void ScrollToPosition(float_t position, bool animated);

  /// @brief Method SelectCellWithIdx, addr 0x3a0fb78, size 0x1e4, virtual false, abstract: false, final false
  inline void SelectCellWithIdx(int32_t idx, bool callbackTable);

  /// @brief Method SetDataSource, addr 0x3a0fb5c, size 0x1c, virtual true, abstract: false, final false
  inline void SetDataSource(::HMUI::TableView_IDataSource* newDataSource, bool reloadData);

  /// @brief Method Show, addr 0x3a0ef2c, size 0x24, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method UpdateCachedData, addr 0x3a0fa64, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a0d6b8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeRectSizeEvent, addr 0x3a0e144, size 0xb0, virtual false, abstract: false, final false
  inline void add_didChangeRectSizeEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method add_didDeleteCellsEvent, addr 0x3a0dfe4, size 0xb0, virtual false, abstract: false, final false
  inline void add_didDeleteCellsEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method add_didDeselectCellWithIdxEvent, addr 0x3a0dbc4, size 0xb0, virtual false, abstract: false, final false
  inline void add_didDeselectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::TableView>, int32_t>* value);

  /// @brief Method add_didInsertCellsEvent, addr 0x3a0de84, size 0xb0, virtual false, abstract: false, final false
  inline void add_didInsertCellsEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method add_didReloadDataEvent, addr 0x3a0dd24, size 0xb0, virtual false, abstract: false, final false
  inline void add_didReloadDataEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method add_didSelectCellWithIdxEvent, addr 0x3a0da64, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::TableView>, int32_t>* value);

  /// @brief Method get_canSelectSelectedCell, addr 0x3a0da5c, size 0x8, virtual true, abstract: false, final true
  inline bool get_canSelectSelectedCell();

  /// @brief Method get_cellSize, addr 0x3a0e2cc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cellSize();

  /// @brief Method get_contentSize, addr 0x3a0e390, size 0x40, virtual true, abstract: false, final false
  inline float_t get_contentSize();

  /// @brief Method get_contentTransform, addr 0x3a0e2bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_contentTransform();

  /// @brief Method get_dataSource, addr 0x3a0e2a4, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::TableView_IDataSource* get_dataSource();

  /// @brief Method get_numberOfCells, addr 0x3a0e2c4, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_numberOfCells();

  /// @brief Method get_paddingEnd, addr 0x3a0e360, size 0x30, virtual false, abstract: false, final false
  inline float_t get_paddingEnd();

  /// @brief Method get_paddingStart, addr 0x3a0e330, size 0x30, virtual false, abstract: false, final false
  inline float_t get_paddingStart();

  /// @brief Method get_scrollView, addr 0x3a0e2e4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::HMUI::ScrollView> get_scrollView();

  /// @brief Method get_selectionType, addr 0x3a0da4c, size 0x8, virtual true, abstract: false, final true
  inline ::HMUI::TableViewSelectionType get_selectionType();

  /// @brief Method get_spacing, addr 0x3a0e2d4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spacing();

  /// @brief Method get_tableType, addr 0x3a0e2dc, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::TableView_TableType get_tableType();

  /// @brief Method get_totalPadding, addr 0x3a0e2ec, size 0x44, virtual false, abstract: false, final false
  inline float_t get_totalPadding();

  /// @brief Method get_viewportTransform, addr 0x3a0e2b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_viewportTransform();

  /// @brief Method get_visibleCells, addr 0x3a0e2ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeRectSizeEvent, addr 0x3a0e1f4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didChangeRectSizeEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method remove_didDeleteCellsEvent, addr 0x3a0e094, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didDeleteCellsEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method remove_didDeselectCellWithIdxEvent, addr 0x3a0dc74, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didDeselectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::TableView>, int32_t>* value);

  /// @brief Method remove_didInsertCellsEvent, addr 0x3a0df34, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didInsertCellsEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method remove_didReloadDataEvent, addr 0x3a0ddd4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didReloadDataEvent(::System::Action_1<::UnityW<::HMUI::TableView>>* value);

  /// @brief Method remove_didSelectCellWithIdxEvent, addr 0x3a0db14, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::TableView>, int32_t>* value);

  /// @brief Method set_selectionType, addr 0x3a0da54, size 0x8, virtual false, abstract: false, final false
