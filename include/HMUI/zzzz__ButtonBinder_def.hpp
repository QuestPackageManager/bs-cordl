...
public:
  ...
  /// @brief Method AddBinding, addr 0x39e98c4, size 0x148, virtual false, abstract: false, final false
  inline void AddBinding(::UnityEngine::UI::Button* button, ::System::Action* action);

  /// @brief Method AddBindings, addr 0x39e9a40, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearBindings, addr 0x39e9ba4, size 0x220, virtual false, abstract: false, final false
  inline void ClearBindings();

  /// @brief Method Init, addr 0x39e9814, size 0x74, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x39e97f8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x39e9a0c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e9888, size 0x3c, virtual false, abstract: false, final false
