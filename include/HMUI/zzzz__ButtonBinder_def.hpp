...
public:
  ...
  /// @brief Method AddBinding, addr 0x39ec5dc, size 0x148, virtual false, abstract: false, final false
  inline void AddBinding(::UnityEngine::UI::Button* button, ::System::Action* action);

  /// @brief Method AddBindings, addr 0x39ec758, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearBindings, addr 0x39ec8bc, size 0x220, virtual false, abstract: false, final false
  inline void ClearBindings();

  /// @brief Method Init, addr 0x39ec52c, size 0x74, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x39ec510, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x39ec724, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ec5a0, size 0x3c, virtual false, abstract: false, final false
