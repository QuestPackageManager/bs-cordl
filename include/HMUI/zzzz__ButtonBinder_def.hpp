...
public:
  ...
  /// @brief Method AddBinding, addr 0x572faf8, size 0x160, virtual false, abstract: false, final false
  inline void AddBinding(::UnityEngine::UI::Button* button, ::System::Action* action);

  /// @brief Method AddBindings, addr 0x572fc80, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearBindings, addr 0x572fdbc, size 0x1f0, virtual false, abstract: false, final false
  inline void ClearBindings();

  /// @brief Method Init, addr 0x572fa54, size 0x74, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x572fa50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x572fc58, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572fac8, size 0x30, virtual false, abstract: false, final false
