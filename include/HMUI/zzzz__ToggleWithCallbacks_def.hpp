...
/// @brief Field stateDidChangeEvent, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateDidChangeEvent, put=__cordl_internal_set_stateDidChangeEvent)) ::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>*  stateDidChangeEvent;

/// @brief Method DoStateTransition, addr 0x56dc2c4, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56dc30c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_stateDidChangeEvent, addr 0x56d7890, size 0xc0, virtual false, abstract: false, final false
inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>*  value) ;

/// @brief Method get_selectionState, addr 0x56d7ccc, size 0x78, virtual false, abstract: false, final false
inline ::HMUI::ToggleWithCallbacks_SelectionState get_selectionState() ;

/// @brief Method remove_stateDidChangeEvent, addr 0x56d7c04, size 0xc0, virtual false, abstract: false, final false
