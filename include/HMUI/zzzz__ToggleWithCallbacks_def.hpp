...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x3a02e00, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a02e4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateDidChangeEvent, addr 0x39fe4ec, size 0xb4, virtual false, abstract: false, final false
  inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x39fe884, size 0x54, virtual false, abstract: false, final false
  inline ::HMUI::ToggleWithCallbacks_SelectionState get_selectionState();

  /// @brief Method remove_stateDidChangeEvent, addr 0x39fe7c8, size 0xb4, virtual false, abstract: false, final false
