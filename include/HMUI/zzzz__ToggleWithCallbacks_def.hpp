...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x5893318, size 0x48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5893360, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateDidChangeEvent, addr 0x588e8e4, size 0xc0, virtual false, abstract: false, final false
  inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x588ed20, size 0x78, virtual false, abstract: false, final false
  inline ::HMUI::ToggleWithCallbacks_SelectionState get_selectionState();

  /// @brief Method remove_stateDidChangeEvent, addr 0x588ec58, size 0xc0, virtual false, abstract: false, final false
