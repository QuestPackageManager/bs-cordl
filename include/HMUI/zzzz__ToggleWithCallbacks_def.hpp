...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x3a105a0, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a105ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateDidChangeEvent, addr 0x3a0bc8c, size 0xb4, virtual false, abstract: false, final false
  inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::ToggleWithCallbacks_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x3a0c024, size 0x54, virtual false, abstract: false, final false
  inline ::HMUI::ToggleWithCallbacks_SelectionState get_selectionState();

  /// @brief Method remove_stateDidChangeEvent, addr 0x3a0bf68, size 0xb4, virtual false, abstract: false, final false
