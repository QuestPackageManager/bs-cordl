...
MARK_REF_T(::HMUI::ImageView*);
DEFINE_IL2CPP_CLASS(::HMUI::ImageView_GradientDirection, "HMUI", "ImageView/GradientDirection");
DEFINE_IL2CPP_CLASS(::HMUI::ImageView*, "HMUI", "ImageView");
// Dependencies
namespace HMUI {
// Is value type: true
...
public:
  ...
  __declspec(property(get = getStaticF_s_ColorScratch, put = setStaticF_s_ColorScratch)) ::ArrayW<::UnityEngine::Color> s_ColorScratch;

  /// @brief Field s_UV1Scratch, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_s_UV1Scratch, put = setStaticF_s_UV1Scratch)) ::ArrayW<::UnityEngine::Vector2> s_UV1Scratch;
  ...
  /// @brief Method AddQuad, addr 0x32fb940, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x32fbc44, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x32fbee4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithHorizontalGradient, addr 0x32fb20c, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithVerticalGradient, addr 0x32fb638, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFilledSprite, addr 0x32fa314, size 0x9b8, virtual false, abstract: false, final false
  inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper* toFill, bool preserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSimpleSprite, addr 0x32f8470, size 0x6f0, virtual false, abstract: false, final false
  inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper* vh, bool lPreserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSlicedSprite, addr 0x32f8b60, size 0xe8c, virtual false, abstract: false, final false
  inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GenerateTiledSprite, addr 0x32f99ec, size 0x928, virtual false, abstract: false, final false
  inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GetAdjustedBorders, addr 0x32fb18c, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4 border, ::UnityEngine::Rect rect);

  /// @brief Method GetDrawingDimensions, addr 0x32facdc, size 0x414, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect);

  /// @brief Method GetNumberOfElements, addr 0x32fb0f0, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t GetNumberOfElements(float_t curvedUIRadius, float_t width);

  static inline ::HMUI::ImageView* New_ctor();

  /// @brief Method OnEnable, addr 0x32f82c0, size 0x3c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPopulateMesh, addr 0x32f82fc, size 0x174, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method RadialCut, addr 0x32fbff4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method RadialCut, addr 0x32fc128, size 0x3f0, virtual false, abstract: false, final false
  static inline void RadialCut(::ArrayW<::UnityEngine::Vector3> xy, float_t cos, float_t sin, bool invert, int32_t corner);

  /// @brief Method __Refresh, addr 0x32faccc, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32fc518, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  static inline ::ArrayW<::UnityEngine::Color> getStaticF_s_ColorScratch();

  static inline ::ArrayW<::UnityEngine::Vector2> getStaticF_s_UV1Scratch();
  ...
  /// @brief Method get_color, addr 0x32f8094, size 0x90, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_color0, addr 0x32f8158, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color0();

  /// @brief Method get_color1, addr 0x32f820c, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color1();

  /// @brief Method get_gradient, addr 0x32f8134, size 0x8, virtual true, abstract: false, final false
  inline bool get_gradient();

  /// @brief Method get_skew, addr 0x32f812c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_skew();

  /// @brief Method get_useScriptableObjectColors, addr 0x32f8084, size 0x8, virtual false, abstract: false, final false
  ...
  static inline void setStaticF_s_ColorScratch(::ArrayW<::UnityEngine::Color> value);

  static inline void setStaticF_s_UV1Scratch(::ArrayW<::UnityEngine::Vector2> value);
  ...
  /// @brief Method set_color, addr 0x32f8124, size 0x8, virtual true, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_color0, addr 0x32f81ec, size 0x20, virtual true, abstract: false, final false
  inline void set_color0(::UnityEngine::Color value);

  /// @brief Method set_color1, addr 0x32f82a0, size 0x20, virtual true, abstract: false, final false
  inline void set_color1(::UnityEngine::Color value);

  /// @brief Method set_gradient, addr 0x32f813c, size 0x1c, virtual true, abstract: false, final false
  inline void set_gradient(bool value);

  /// @brief Method set_useScriptableObjectColors, addr 0x32f808c, size 0x8, virtual false, abstract: false, final false
