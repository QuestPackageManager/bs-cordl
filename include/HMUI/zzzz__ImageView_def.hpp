...
public:
  ...
  /// @brief Method AddQuad, addr 0x2420e4c, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x2421130, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x24213a4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithHorizontalGradient, addr 0x2420294, size 0x8c4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithVerticalGradient, addr 0x2420b58, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFilledSprite, addr 0x241e6ac, size 0x14e4, virtual false, abstract: false, final false
  inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper* toFill, bool preserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSimpleSprite, addr 0x241928c, size 0x14c0, virtual false, abstract: false, final false
  inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper* vh, bool lPreserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSlicedSprite, addr 0x241a74c, size 0x1bcc, virtual false, abstract: false, final false
  inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GenerateTiledSprite, addr 0x241c318, size 0x2394, virtual false, abstract: false, final false
  inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GetAdjustedBorders, addr 0x24201bc, size 0xd8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4 border, ::UnityEngine::Rect rect);

  /// @brief Method GetDrawingDimensions, addr 0x241fba0, size 0x588, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect);

  /// @brief Method GetNumberOfElements, addr 0x2420128, size 0x94, virtual false, abstract: false, final false
  static inline int32_t GetNumberOfElements(float_t curvedUIRadius, float_t width);

  static inline ::HMUI::ImageView* New_ctor();

  /// @brief Method OnEnable, addr 0x24190f0, size 0x28, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPopulateMesh, addr 0x2419118, size 0x174, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method RadialCut, addr 0x2421488, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RadialCut, addr 0x24215a8, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method __Refresh, addr 0x241fb90, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2421994, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color, addr 0x2418f18, size 0x88, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_color0, addr 0x2418fd0, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color0();

  /// @brief Method get_color1, addr 0x2419060, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color1();

  /// @brief Method get_gradient, addr 0x2418fb0, size 0x8, virtual false, abstract: false, final false
  inline bool get_gradient();

  /// @brief Method get_skew, addr 0x2418fa8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_skew();

  /// @brief Method get_useScriptableObjectColors, addr 0x2418f04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x2418fa0, size 0x8, virtual true, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_color0, addr 0x241123c, size 0x20, virtual false, abstract: false, final false
  inline void set_color0(::UnityEngine::Color value);

  /// @brief Method set_color1, addr 0x241125c, size 0x20, virtual false, abstract: false, final false
  inline void set_color1(::UnityEngine::Color value);

  /// @brief Method set_gradient, addr 0x2418fb8, size 0x18, virtual false, abstract: false, final false
  inline void set_gradient(bool value);

  /// @brief Method set_useScriptableObjectColors, addr 0x2418f0c, size 0xc, virtual false, abstract: false, final false
