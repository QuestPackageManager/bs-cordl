...
/// @brief Method AddQuad, addr 0x3243f38, size 0x304, virtual false, abstract: false, final false
...
/// @brief Method AddQuad, addr 0x324423c, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method AddQuad, addr 0x32444dc, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method AddQuadWithHorizontalGradient, addr 0x3243804, size 0x42c, virtual false, abstract: false, final false
...
/// @brief Method AddQuadWithVerticalGradient, addr 0x3243c30, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method GenerateFilledSprite, addr 0x324290c, size 0x9b8, virtual false, abstract: false, final false
inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper*  toFill, bool  preserveAspect, float_t  curvedUIRadius) ;

/// @brief Method GenerateSimpleSprite, addr 0x3240a68, size 0x6f0, virtual false, abstract: false, final false
inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper*  vh, bool  lPreserveAspect, float_t  curvedUIRadius) ;

/// @brief Method GenerateSlicedSprite, addr 0x3241158, size 0xe8c, virtual false, abstract: false, final false
inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper*  toFill, float_t  curvedUIRadius) ;

/// @brief Method GenerateTiledSprite, addr 0x3241fe4, size 0x928, virtual false, abstract: false, final false
inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper*  toFill, float_t  curvedUIRadius) ;

/// @brief Method GetAdjustedBorders, addr 0x3243784, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4  border, ::UnityEngine::Rect  rect) ;

/// @brief Method GetDrawingDimensions, addr 0x32432d4, size 0x414, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetDrawingDimensions(bool  shouldPreserveAspect) ;

/// @brief Method GetNumberOfElements, addr 0x32436e8, size 0x9c, virtual false, abstract: false, final false
static inline int32_t GetNumberOfElements(float_t  curvedUIRadius, float_t  width) ;

static inline ::HMUI::ImageView* New_ctor() ;

/// @brief Method OnEnable, addr 0x32408b8, size 0x3c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPopulateMesh, addr 0x32408f4, size 0x174, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method RadialCut, addr 0x32445ec, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method RadialCut, addr 0x3244720, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method __Refresh, addr 0x32432c4, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3244b10, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_color, addr 0x324068c, size 0x90, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_color0, addr 0x3240750, size 0x94, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color0() ;

/// @brief Method get_color1, addr 0x3240804, size 0x94, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color1() ;

/// @brief Method get_gradient, addr 0x324072c, size 0x8, virtual true, abstract: false, final false
inline bool get_gradient() ;

/// @brief Method get_skew, addr 0x3240724, size 0x8, virtual false, abstract: false, final false
inline float_t get_skew() ;

/// @brief Method get_useScriptableObjectColors, addr 0x324067c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x324071c, size 0x8, virtual true, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_color0, addr 0x32407e4, size 0x20, virtual true, abstract: false, final false
inline void set_color0(::UnityEngine::Color  value) ;

/// @brief Method set_color1, addr 0x3240898, size 0x20, virtual true, abstract: false, final false
inline void set_color1(::UnityEngine::Color  value) ;

/// @brief Method set_gradient, addr 0x3240734, size 0x1c, virtual true, abstract: false, final false
inline void set_gradient(bool  value) ;

/// @brief Method set_useScriptableObjectColors, addr 0x3240684, size 0x8, virtual false, abstract: false, final false
