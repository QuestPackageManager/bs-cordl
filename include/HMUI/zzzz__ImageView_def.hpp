...
public:
  ...
  /// @brief Method AddQuad, addr 0x324319c, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x32434a0, size 0x2a0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x3243740, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithHorizontalGradient, addr 0x3242a68, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuadWithVerticalGradient, addr 0x3242e94, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFilledSprite, addr 0x3241b70, size 0x9b8, virtual false, abstract: false, final false
  inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper* toFill, bool preserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSimpleSprite, addr 0x323fccc, size 0x6f0, virtual false, abstract: false, final false
  inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper* vh, bool lPreserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSlicedSprite, addr 0x32403bc, size 0xe8c, virtual false, abstract: false, final false
  inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GenerateTiledSprite, addr 0x3241248, size 0x928, virtual false, abstract: false, final false
  inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper* toFill, float_t curvedUIRadius);

  /// @brief Method GetAdjustedBorders, addr 0x32429e8, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4 border, ::UnityEngine::Rect rect);

  /// @brief Method GetDrawingDimensions, addr 0x3242538, size 0x414, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect);

  /// @brief Method GetNumberOfElements, addr 0x324294c, size 0x9c, virtual false, abstract: false, final false
  static inline int32_t GetNumberOfElements(float_t curvedUIRadius, float_t width);

  static inline ::HMUI::ImageView* New_ctor();

  /// @brief Method OnEnable, addr 0x323fb1c, size 0x3c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPopulateMesh, addr 0x323fb58, size 0x174, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method RadialCut, addr 0x3243850, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method RadialCut, addr 0x3243984, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method __Refresh, addr 0x3242528, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3243d74, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color, addr 0x323f8f0, size 0x90, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_color0, addr 0x323f9b4, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color0();

  /// @brief Method get_color1, addr 0x323fa68, size 0x94, virtual true, abstract: false, final false
  inline ::UnityEngine::Color get_color1();

  /// @brief Method get_gradient, addr 0x323f990, size 0x8, virtual true, abstract: false, final false
  inline bool get_gradient();

  /// @brief Method get_skew, addr 0x323f988, size 0x8, virtual false, abstract: false, final false
  inline float_t get_skew();

  /// @brief Method get_useScriptableObjectColors, addr 0x323f8e0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x323f980, size 0x8, virtual true, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_color0, addr 0x323fa48, size 0x20, virtual true, abstract: false, final false
  inline void set_color0(::UnityEngine::Color value);

  /// @brief Method set_color1, addr 0x323fafc, size 0x20, virtual true, abstract: false, final false
  inline void set_color1(::UnityEngine::Color value);

  /// @brief Method set_gradient, addr 0x323f998, size 0x1c, virtual true, abstract: false, final false
  inline void set_gradient(bool value);

  /// @brief Method set_useScriptableObjectColors, addr 0x323f8e8, size 0x8, virtual false, abstract: false, final false
