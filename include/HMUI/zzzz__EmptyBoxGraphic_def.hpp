...
public:
  ...
  /// @brief Method OnDrawGizmosSelected, addr 0x2287114, size 0x18c, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method OnPopulateMesh, addr 0x2286b5c, size 0x5b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22872a0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
