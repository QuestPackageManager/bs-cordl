...
public:
  ...
  /// @brief Method OnPopulateMesh, addr 0x21b94f4, size 0x5b8, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* vh);

  /// @brief Method OnDrawGizmosSelected, addr 0x21b9aac, size 0x18c, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  static inline ::HMUI::EmptyBoxGraphic* New_ctor();

  /// @brief Method .ctor, addr 0x21b9c38, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
