...
public:
  ...
  /// @brief Method Awake, addr 0x5667220, size 0x78, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x56674b4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isOnTop, addr 0x5667298, size 0x21c, virtual false, abstract: false, final false
