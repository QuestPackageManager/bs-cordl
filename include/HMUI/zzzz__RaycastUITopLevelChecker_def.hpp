...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RaycastUITopLevelChecker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RaycastUITopLevelChecker(RaycastUITopLevelChecker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RaycastUITopLevelChecker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RaycastUITopLevelChecker(RaycastUITopLevelCheckerconst&) = delete;
