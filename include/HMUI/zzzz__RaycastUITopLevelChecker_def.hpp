...
/// @brief Method Awake, addr 0x56c7c50, size 0x78, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x56c7ee4, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isOnTop, addr 0x56c7cc8, size 0x21c, virtual false, abstract: false, final false
