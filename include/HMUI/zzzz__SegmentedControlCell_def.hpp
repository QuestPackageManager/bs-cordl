...
public:
  // Declarations
  /// @brief Field <cellNumber>k__BackingField, offset 0x54, size 0x4
  ...
  /// @brief Field _segmentedControl, offset 0x58, size 0x8
  ...
  /// @brief Method InternalToggle, addr 0x408f794, size 0x24, virtual true, abstract: false, final false
  inline void InternalToggle();

  static inline ::HMUI::SegmentedControlCell* New_ctor();

  /// @brief Method SegmentedControlSetup, addr 0x408f470, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408e848, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellNumber, addr 0x408f784, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cellNumber();

  /// @brief Method set_cellNumber, addr 0x408f78c, size 0x8, virtual false, abstract: false, final false
