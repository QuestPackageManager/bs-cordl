...
public:
  ...
  /// @brief Method InternalToggle, addr 0x22e3100, size 0x24, virtual true, abstract: false, final false
  inline void InternalToggle();

  static inline ::HMUI::SegmentedControlCell* New_ctor();

  /// @brief Method SegmentedControlSetup, addr 0x22e2e84, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22e2838, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellNumber, addr 0x22e30f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cellNumber();

  /// @brief Method set_cellNumber, addr 0x22e30f8, size 0x8, virtual false, abstract: false, final false
