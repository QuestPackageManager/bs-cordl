...
public:
  ...
  /// @brief Method OnEnable, addr 0x5740f18, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5740fec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
