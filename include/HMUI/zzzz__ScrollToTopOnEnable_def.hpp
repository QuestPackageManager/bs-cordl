...
public:
  ...
  /// @brief Method OnEnable, addr 0x39f9a64, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f9b48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
