...
public:
  ...
  /// @brief Method OnEnable, addr 0x21d76d4, size 0x20, virtual false, abstract: false, final false
  inline void OnEnable();

  static inline ::HMUI::ScrollToTopOnEnable* New_ctor();

  /// @brief Method .ctor, addr 0x21d77b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
