...
public:
  ...
  /// @brief Method OnEnable, addr 0x56d32a4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56d3378, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
