...
public:
  ...
  /// @brief Method OnEnable, addr 0x22a3d3c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22a3e20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
