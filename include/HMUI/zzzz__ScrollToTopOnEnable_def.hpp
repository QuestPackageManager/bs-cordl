...
public:
  ...
  /// @brief Method OnEnable, addr 0x56725fc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56726d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
