...
// Write type traits
MARK_REF_T(::HMUI::ScrollToTopOnEnable*);
DEFINE_IL2CPP_CLASS(::HMUI::ScrollToTopOnEnable*, "HMUI", "ScrollToTopOnEnable");
...
static_assert(sizeof(::HMUI::ScrollToTopOnEnable) == 0x28, "Size mismatch!");
