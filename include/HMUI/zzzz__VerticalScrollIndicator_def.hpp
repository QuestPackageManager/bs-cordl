...
public:
  ...
  /// @brief Method OnEnable, addr 0x5893458, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshHandle, addr 0x5893368, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589345c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_handle, addr 0x5893450, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_handle();

  /// @brief Method get_normalizedPageHeight, addr 0x5893448, size 0x8, virtual false, abstract: false, final false
  inline float_t get_normalizedPageHeight();

  /// @brief Method get_progress, addr 0x5893440, size 0x8, virtual false, abstract: false, final false
  inline float_t get_progress();

  /// @brief Method set_normalizedPageHeight, addr 0x588b4c8, size 0x30, virtual false, abstract: false, final false
  inline void set_normalizedPageHeight(float_t value);

  /// @brief Method set_progress, addr 0x588b784, size 0x30, virtual false, abstract: false, final false
