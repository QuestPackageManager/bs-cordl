...
public:
  ...
  /// @brief Method OnEnable, addr 0x3a053c0, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshHandle, addr 0x3a052e0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a053c4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_normalizedPageHeight, addr 0x3a053b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_normalizedPageHeight();

  /// @brief Method get_progress, addr 0x3a053b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_progress();

  /// @brief Method set_normalizedPageHeight, addr 0x39fe054, size 0x2c, virtual false, abstract: false, final false
  inline void set_normalizedPageHeight(float_t value);

  /// @brief Method set_progress, addr 0x39fe2b8, size 0x2c, virtual false, abstract: false, final false
