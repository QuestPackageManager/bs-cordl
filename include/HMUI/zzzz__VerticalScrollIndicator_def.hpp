...
public:
  ...
  /// @brief Method OnEnable, addr 0x39fd7a8, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshHandle, addr 0x39fd6c8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39fd7ac, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_normalizedPageHeight, addr 0x39fd7a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_normalizedPageHeight();

  /// @brief Method get_progress, addr 0x39fd798, size 0x8, virtual false, abstract: false, final false
  inline float_t get_progress();

  /// @brief Method set_normalizedPageHeight, addr 0x39f63c8, size 0x2c, virtual false, abstract: false, final false
  inline void set_normalizedPageHeight(float_t value);

  /// @brief Method set_progress, addr 0x39f662c, size 0x2c, virtual false, abstract: false, final false
