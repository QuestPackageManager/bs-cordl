...
public:
  ...
  /// @brief Method GraphicUpdateComplete, addr 0x57390e4, size 0x4, virtual true, abstract: false, final false
  inline void GraphicUpdateComplete();

  /// @brief Method LayoutComplete, addr 0x57390e0, size 0x4, virtual true, abstract: false, final false
  inline void LayoutComplete();

  /// @brief Method MayDrag, addr 0x57393c4, size 0x64, virtual false, abstract: false, final false
  inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  static inline ::HMUI::TextSlider* New_ctor();

  /// @brief Method OnBeginDrag, addr 0x5739428, size 0x98, virtual true, abstract: false, final false
  inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnDisable, addr 0x5739138, size 0x8, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrag, addr 0x57394c0, size 0xa8, virtual true, abstract: false, final false
  inline void OnDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnEnable, addr 0x57390f8, size 0x40, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnInitializePotentialDrag, addr 0x5739618, size 0x14, virtual true, abstract: false, final false
  inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerDown, addr 0x5739568, size 0xb0, virtual true, abstract: false, final false
  inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnRectTransformDimensionsChange, addr 0x5739140, size 0x38, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method Rebuild, addr 0x57390dc, size 0x4, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate executing);

  /// @brief Method Refresh, addr 0x57390e8, size 0x10, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method SetNormalizedValue, addr 0x5738124, size 0x8, virtual false, abstract: false, final false
  inline void SetNormalizedValue(float_t input);

  /// @brief Method SetNormalizedValue, addr 0x5739044, size 0x98, virtual false, abstract: false, final false
  inline void SetNormalizedValue(float_t input, bool sendCallback);

  /// @brief Method TextForNormalizedValue, addr 0x573962c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW TextForNormalizedValue(float_t normalizedValue);

  /// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x5739648, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform();

  /// @brief Method UpdateCachedReferences, addr 0x5738d50, size 0x148, virtual false, abstract: false, final false
  inline void UpdateCachedReferences();

  /// @brief Method UpdateDrag, addr 0x5739178, size 0x24c, virtual false, abstract: false, final false
  inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method UpdateVisuals, addr 0x5737070, size 0x314, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5737798, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_normalizedValueDidChangeEvent, addr 0x5736ca4, size 0xc0, virtual false, abstract: false, final false
  inline void add_normalizedValueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::TextSlider>, float_t>* value);

  /// @brief Method get_handleRect, addr 0x5738cac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_handleRect();

  /// @brief Method get_handleSize, addr 0x5738e98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_handleSize();

  /// @brief Method get_normalizedValue, addr 0x5737384, size 0xa8, virtual false, abstract: false, final false
  inline float_t get_normalizedValue();

  /// @brief Method get_numberOfSteps, addr 0x573903c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_numberOfSteps();

  /// @brief Method get_separatorSize, addr 0x5738fb0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_separatorSize();

  /// @brief Method get_valueSize, addr 0x5738f24, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_normalizedValueDidChangeEvent, addr 0x5736de4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_normalizedValueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::TextSlider>, float_t>* value);

  /// @brief Method set_handleColor, addr 0x573742c, size 0xc8, virtual false, abstract: false, final false
  inline void set_handleColor(::UnityEngine::Color value);

  /// @brief Method set_handleRect, addr 0x5738cb4, size 0x9c, virtual false, abstract: false, final false
  inline void set_handleRect(::UnityEngine::RectTransform* value);

  /// @brief Method set_handleSize, addr 0x5738ea0, size 0x84, virtual false, abstract: false, final false
  inline void set_handleSize(float_t value);

  /// @brief Method set_normalizedValue, addr 0x5737bac, size 0x8, virtual false, abstract: false, final false
  inline void set_normalizedValue(float_t value);

  /// @brief Method set_numberOfSteps, addr 0x5736c10, size 0x94, virtual false, abstract: false, final false
  inline void set_numberOfSteps(int32_t value);

  /// @brief Method set_separatorSize, addr 0x5738fb8, size 0x84, virtual false, abstract: false, final false
  inline void set_separatorSize(float_t value);

  /// @brief Method set_valueSize, addr 0x5738f2c, size 0x84, virtual false, abstract: false, final false
  inline void set_valueSize(float_t value);

  /// @brief Method set_valueTextColor, addr 0x57374f4, size 0x20, virtual false, abstract: false, final false
