...
public:
  ...
  /// @brief Method .ctor, addr 0x228e3ec, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x228e418, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x228e438, size 0x2c, virtual true, abstract: false, final false
  inline ::UnityEngine::Color EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x228e404, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x228e0ac, size 0x100, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <LerpColors>b__31_0, addr 0x228e4c8, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_0(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method <LerpColors>b__31_1, addr 0x228e4e4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_1(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method <LerpColors>b__31_2, addr 0x228e500, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_2(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method <LerpColors>b__31_3, addr 0x228e51c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_3(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method <LerpColors>b__31_4, addr 0x228e538, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_4(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method <LerpColors>b__31_5, addr 0x228e554, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color _LerpColors_b__31_5(::HMUI::AnimatedSwitchView_ColorBlock* colorBlock);

  /// @brief Method .ctor, addr 0x228e4c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x228d50c, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleOnValueChanged, addr 0x228e354, size 0x28, virtual false, abstract: false, final false
  inline void HandleOnValueChanged(bool value);

  /// @brief Method HandleStateDidChange, addr 0x228e37c, size 0x50, virtual false, abstract: false, final false
  inline void HandleStateDidChange(::HMUI::ToggleWithCallbacks_SelectionState selectionState);

  /// @brief Method LerpColor, addr 0x228e1ac, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method LerpColors, addr 0x228d6fc, size 0x4e4, virtual false, abstract: false, final false
  inline void LerpColors(float_t switchAmount, float_t highlightAmount, float_t disabledAmount);

  /// @brief Method LerpPosition, addr 0x228dbe0, size 0x64, virtual false, abstract: false, final false
  inline void LerpPosition(float_t switchAmount);

  /// @brief Method LerpStretch, addr 0x228e02c, size 0x80, virtual false, abstract: false, final false
  inline void LerpStretch(float_t switchAmount);

  static inline ::HMUI::AnimatedSwitchView* New_ctor();

  /// @brief Method OnDestroy, addr 0x228dc44, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x228d55c, size 0x1a0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x228dd8c, size 0x2a0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x228e3cc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
