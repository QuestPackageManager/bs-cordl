...
public:
  ...
  /// @brief Method HandleBeforeDismissingScenes, addr 0x2286378, size 0xac, virtual false, abstract: false, final false
  inline void HandleBeforeDismissingScenes(::System::Collections::Generic::List_1<::StringW>* _);

  /// @brief Method HandleSceneTransitionDidFinish, addr 0x22861a0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x228624c, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2286088, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartWithFlowCoordinator, addr 0x2286424, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2286448, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
