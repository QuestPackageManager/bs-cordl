...
public:
  ...
  /// @brief Method HandleBeforeDismissingScenes, addr 0x323a8bc, size 0xac, virtual false, abstract: false, final false
  inline void HandleBeforeDismissingScenes(::System::Collections::Generic::IReadOnlyList_1<::StringW>* _);

  /// @brief Method HandleSceneTransitionDidFinish, addr 0x323a698, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x323a744, size 0x178, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x323a580, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartWithFlowCoordinator, addr 0x323a968, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x323a988, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
