...
public:
  ...
  /// @brief Method HandleBeforeDismissingScenes, addr 0x2289e28, size 0xac, virtual false, abstract: false, final false
  inline void HandleBeforeDismissingScenes(::System::Collections::Generic::List_1<::StringW>* _);

  /// @brief Method HandleSceneTransitionDidFinish, addr 0x2289c50, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2289cfc, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2289b38, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartWithFlowCoordinator, addr 0x2289ed4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2289ef8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
