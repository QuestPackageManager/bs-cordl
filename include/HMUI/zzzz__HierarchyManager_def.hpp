...
public:
  ...
  /// @brief Method Start, addr 0x21bf0e4, size 0x11c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x21bf2b4, size 0x140, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleSceneTransitionDidFinish, addr 0x21bf200, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleBeforeDismissingScenes, addr 0x21bf3f4, size 0xb4, virtual false, abstract: false, final false
  inline void HandleBeforeDismissingScenes();

  /// @brief Method StartWithFlowCoordinator, addr 0x21bf4a8, size 0x28, virtual false, abstract: false, final false
  inline void StartWithFlowCoordinator(::HMUI::FlowCoordinator* flowCoordinator);

  static inline ::HMUI::HierarchyManager* New_ctor();

  /// @brief Method .ctor, addr 0x21bf4d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
