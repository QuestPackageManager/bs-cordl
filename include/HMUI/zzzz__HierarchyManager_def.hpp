...
/// @brief Method HandleBeforeDismissingScenes, addr 0x31feb8c, size 0xac, virtual false, abstract: false, final false
inline void HandleBeforeDismissingScenes(::System::Collections::Generic::IReadOnlyList_1<::StringW>*  _) ;

/// @brief Method HandleSceneTransitionDidFinish, addr 0x31fe968, size 0xac, virtual false, abstract: false, final false
inline void HandleSceneTransitionDidFinish(::GlobalNamespace::GameScenesManager_SceneTransitionType  sceneTransitionType, ::GlobalNamespace::ScenesTransitionSetupDataSO*  scenesTransitionSetupData, ::Zenject::DiContainer*  container) ;

static inline ::HMUI::HierarchyManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x31fea14, size 0x178, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x31fe850, size 0x118, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartWithFlowCoordinator, addr 0x31fec38, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31fec58, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
