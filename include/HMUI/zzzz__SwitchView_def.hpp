...
MARK_REF_T(::HMUI::SwitchView*);
DEFINE_IL2CPP_CLASS(::HMUI::SwitchView_AnimationType, "HMUI", "SwitchView/AnimationType");
DEFINE_IL2CPP_CLASS(::HMUI::SwitchView*, "HMUI", "SwitchView");
// Dependencies
namespace HMUI {
// Is value type: true
...
public:
  ...
  /// @brief Method Awake, addr 0x588e708, size 0x54, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleOnValueChanged, addr 0x588ed18, size 0x4, virtual false, abstract: false, final false
  inline void HandleOnValueChanged(bool value);

  /// @brief Method HandleStateDidChange, addr 0x588ed1c, size 0x4, virtual false, abstract: false, final false
  inline void HandleStateDidChange(::HMUI::ToggleWithCallbacks_SelectionState value);

  static inline ::HMUI::SwitchView* New_ctor();

  /// @brief Method OnDestroy, addr 0x588ead8, size 0x180, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshVisuals, addr 0x588e9a4, size 0x134, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method Start, addr 0x588e75c, size 0x188, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x588ed98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::SwitchView) == 0x70, "Size mismatch!");
