...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InteractableTiltEffect::*)(float_t)>(&::HMUI::InteractableTiltEffect::set_effectStrengthMultiplier)> {
  ...
  constexpr static std::size_t addrs = 0x573d180;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::InteractableTiltEffect*>::get(),
                        "set_effectStrengthMultiplier",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::HMUI::InteractableTiltEffect::*)()>(&::HMUI::InteractableTiltEffect::get_effectStrengthMultiplier)> {
  ...
  constexpr static std::size_t addrs = 0x573d23c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::InteractableTiltEffect*>::get(),
                        "get_effectStrengthMultiplier",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InteractableTiltEffect::*)(::UnityEngine::EventSystems::PointerEventData*)>(&::HMUI::InteractableTiltEffect::OnPointerEnter)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x573d244;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InteractableTiltEffect::*)(::UnityEngine::EventSystems::PointerEventData*)>(&::HMUI::InteractableTiltEffect::OnPointerMove)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x573d294;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Quaternion (::HMUI::InteractableTiltEffect::*)(::UnityEngine::Vector2)>(&::HMUI::InteractableTiltEffect::ComputeNewTargetRotation)> {
  constexpr static std::size_t size = 0x8c;
  constexpr static std::size_t addrs = 0x573d1b0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::InteractableTiltEffect*>::get(),
                        "ComputeNewTargetRotation",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InteractableTiltEffect::*)()>(&::HMUI::InteractableTiltEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x573d2e4;
