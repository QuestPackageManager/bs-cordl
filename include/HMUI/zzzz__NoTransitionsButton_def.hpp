...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(12917)), TypeDefinitionIndex(TypeDefinitionIndex(13575))]
...
public:
  ...
  /// @brief Method get_selectionState, addr 0x21c53c4, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::__NoTransitionsButton__SelectionState get_selectionState();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x21c4be8, size 0xb4, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::__NoTransitionsButton__SelectionState>* value);

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x21c4dd0, size 0xb4, virtual false, abstract: false, final false
  inline void remove_selectionStateDidChangeEvent(::System::Action_1<::HMUI::__NoTransitionsButton__SelectionState>* value);

  /// @brief Method DoStateTransition, addr 0x21c53cc, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21c540c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
