...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x39f4e00, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f4e40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x39f449c, size 0xb4, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::NoTransitionsButton_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x39f4df8, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::NoTransitionsButton_SelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x39f4680, size 0xb4, virtual false, abstract: false, final false
