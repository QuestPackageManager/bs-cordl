...
public:
  ...
  /// @brief Method DoStateTransition, addr 0x56cde24, size 0x40, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56cde64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_selectionStateDidChangeEvent, addr 0x56cd16c, size 0xc0, virtual false, abstract: false, final false
  inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::NoTransitionsButton_SelectionState>* value);

  /// @brief Method get_selectionState, addr 0x56cde1c, size 0x8, virtual false, abstract: false, final false
  inline ::HMUI::NoTransitionsButton_SelectionState get_selectionState();

  /// @brief Method remove_selectionStateDidChangeEvent, addr 0x56cd394, size 0xc0, virtual false, abstract: false, final false
