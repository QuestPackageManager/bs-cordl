...
public:
  ...
  /// @brief Method OnPointerEnter, addr 0x22df7e0, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x22df7fc, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22df818, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_pointerDidEnterEvent, addr 0x22df520, size 0xb0, virtual false, abstract: false, final false
  inline void add_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method add_pointerDidExitEvent, addr 0x22df680, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_pointerDidEnterEvent, addr 0x22df5d0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method remove_pointerDidExitEvent, addr 0x22df730, size 0xb0, virtual false, abstract: false, final false
