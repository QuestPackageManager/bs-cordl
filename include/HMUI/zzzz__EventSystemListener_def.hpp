...
public:
  ...
  /// @brief Method OnPointerEnter, addr 0x39e8398, size 0x1c, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x39e83b4, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39e83d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_pointerDidEnterEvent, addr 0x39e80d8, size 0xb0, virtual false, abstract: false, final false
  inline void add_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method add_pointerDidExitEvent, addr 0x39e8238, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_pointerDidEnterEvent, addr 0x39e8188, size 0xb0, virtual false, abstract: false, final false
  inline void remove_pointerDidEnterEvent(::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* value);

  /// @brief Method remove_pointerDidExitEvent, addr 0x39e82e8, size 0xb0, virtual false, abstract: false, final false
