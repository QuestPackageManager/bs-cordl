...
public:
  ...
  /// @brief Method ClearHighlight, addr 0x23079b4, size 0x10, virtual false, abstract: false, final false
  inline void ClearHighlight(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method HighlightDidChange, addr 0x23079c8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x23078ac, size 0x10, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnPointerClick, addr 0x23079cc, size 0xb0, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x2307b1c, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x2307b2c, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x2307a7c, size 0xa0, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method SelectionDidChange, addr 0x23079c4, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method SetHighlight, addr 0x23078bc, size 0x78, virtual false, abstract: false, final false
  inline void SetHighlight(bool value, ::HMUI::__SelectableCell__TransitionType transitionType, bool ignoreCurrentValue);

  /// @brief Method SetSelected, addr 0x2307934, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x230787c, size 0x30, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2307b3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_highlightDidChangeEvent, addr 0x23076f4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_selectionDidChangeEvent, addr 0x2307594, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_highlighted, addr 0x2307854, size 0x8, virtual false, abstract: false, final false
  inline bool get_highlighted();

  /// @brief Method get_selected, addr 0x2307868, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_highlightDidChangeEvent, addr 0x23077a4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_selectionDidChangeEvent, addr 0x2307644, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_highlighted, addr 0x230785c, size 0xc, virtual false, abstract: false, final false
  inline void set_highlighted(bool value);

  /// @brief Method set_selected, addr 0x2307870, size 0xc, virtual false, abstract: false, final false
