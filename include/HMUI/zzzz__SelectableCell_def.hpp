...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(13490))]
...
public:
  ...
  /// @brief Method add_selectionDidChangeEvent, addr 0x21da164, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_selectionDidChangeEvent, addr 0x21da214, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_highlightDidChangeEvent, addr 0x21da2c4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_highlightDidChangeEvent, addr 0x21da374, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_highlighted, addr 0x21da424, size 0x8, virtual false, abstract: false, final false
  inline bool get_highlighted();

  /// @brief Method set_highlighted, addr 0x21da42c, size 0xc, virtual false, abstract: false, final false
  inline void set_highlighted(bool value);

  /// @brief Method get_selected, addr 0x21da438, size 0x8, virtual false, abstract: false, final false
  inline bool get_selected();

  /// @brief Method set_selected, addr 0x21da440, size 0xc, virtual false, abstract: false, final false
  inline void set_selected(bool value);

  /// @brief Method Start, addr 0x21da44c, size 0x30, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method SetSelected, addr 0x21da47c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearHighlight, addr 0x21da4fc, size 0x10, virtual false, abstract: false, final false
  inline void ClearHighlight(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method SetHighlight, addr 0x21da50c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectionDidChange, addr 0x21da584, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method HighlightDidChange, addr 0x21da588, size 0x4, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method OnPointerClick, addr 0x21da58c, size 0xb0, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x21da63c, size 0xa0, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x21da6dc, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x21da6ec, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  static inline ::HMUI::SelectableCell* New_ctor();

  /// @brief Method .ctor, addr 0x21da6fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
