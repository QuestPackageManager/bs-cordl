...
public:
  ...
  /// @brief Method ClearHighlight, addr 0x22a6b64, size 0x10, virtual false, abstract: false, final false
  inline void ClearHighlight(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method HighlightDidChange, addr 0x22a6bf0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method OnPointerClick, addr 0x22a6bf4, size 0xb0, virtual true, abstract: false, final false
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerEnter, addr 0x22a6d44, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnPointerExit, addr 0x22a6d54, size 0x10, virtual true, abstract: false, final false
  inline void OnPointerExit(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSubmit, addr 0x22a6ca4, size 0xa0, virtual true, abstract: false, final false
  inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method SelectionDidChange, addr 0x22a6bec, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method SetHighlight, addr 0x22a6b74, size 0x78, virtual false, abstract: false, final false
  inline void SetHighlight(bool value, ::HMUI::__SelectableCell__TransitionType transitionType, bool ignoreCurrentValue);

  /// @brief Method SetSelected, addr 0x22a6ae4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x22a6ab4, size 0x30, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x22a6d64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_highlightDidChangeEvent, addr 0x22a692c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_selectionDidChangeEvent, addr 0x22a67cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_highlighted, addr 0x22a6a8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_highlighted();

  /// @brief Method get_selected, addr 0x22a6aa0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_highlightDidChangeEvent, addr 0x22a69dc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_selectionDidChangeEvent, addr 0x22a687c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_highlighted, addr 0x22a6a94, size 0xc, virtual false, abstract: false, final false
  inline void set_highlighted(bool value);

  /// @brief Method set_selected, addr 0x22a6aa8, size 0xc, virtual false, abstract: false, final false
