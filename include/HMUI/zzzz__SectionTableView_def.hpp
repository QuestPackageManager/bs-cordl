...
public:
  ...
  /// @brief Method CellForIdx, addr 0x2309108, size 0x184, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t baseRow);

  /// @brief Method CellSize, addr 0x2309020, size 0xa0, virtual true, abstract: false, final true
  inline float_t CellSize();

  /// @brief Method DidSelectCellWithIdx, addr 0x23098b8, size 0x7c, virtual true, abstract: false, final false
  inline void DidSelectCellWithIdx(int32_t baseRow);

  /// @brief Method FoldAll, addr 0x230998c, size 0x54, virtual false, abstract: false, final false
  inline void FoldAll();

  /// @brief Method FoldSection, addr 0x2309efc, size 0xa8, virtual false, abstract: false, final false
  inline void FoldSection(int32_t section);

  /// @brief Method IsSectionUnfolded, addr 0x2308fec, size 0x34, virtual false, abstract: false, final false
  inline bool IsSectionUnfolded(int32_t section);

  static inline ::HMUI::SectionTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x23090c0, size 0x48, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method ReloadData, addr 0x230936c, size 0x8, virtual true, abstract: false, final false
  inline void ReloadData();

  /// @brief Method ReloadData, addr 0x2309374, size 0x210, virtual false, abstract: false, final false
  inline void ReloadData(bool resetFoldState);

  /// @brief Method ScrollToRow, addr 0x230a310, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method SectionAndRowForBaseRow, addr 0x230928c, size 0xe0, virtual false, abstract: false, final false
  inline void SectionAndRowForBaseRow(int32_t baseRow, ByRef<int32_t> section, ByRef<int32_t> row, ByRef<bool> isSectionHeader);

  /// @brief Method UnfoldAllSections, addr 0x2309934, size 0x58, virtual false, abstract: false, final false
  inline void UnfoldAllSections();

  /// @brief Method UnfoldSection, addr 0x23099e0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230a430, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHeaderEvent, addr 0x2308e60, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectHeaderEvent(::System::Action_2<::UnityW<::HMUI::SectionTableView>, int32_t>* value);

  /// @brief Method add_didSelectRowInSectionEvent, addr 0x2308d00, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectRowInSectionEvent(::System::Action_3<::UnityW<::HMUI::SectionTableView>, int32_t, int32_t>* value);

  /// @brief Method get_dataSource, addr 0x2308fc0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectHeaderEvent, addr 0x2308f10, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectHeaderEvent(::System::Action_2<::UnityW<::HMUI::SectionTableView>, int32_t>* value);

  /// @brief Method remove_didSelectRowInSectionEvent, addr 0x2308db0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectRowInSectionEvent(::System::Action_3<::UnityW<::HMUI::SectionTableView>, int32_t, int32_t>* value);

  /// @brief Method set_dataSource, addr 0x2308fc8, size 0x24, virtual false, abstract: false, final false
