...
public:
  ...
  /// @brief Method Awake addr 0x212c274 size 0x144 virtual false final false
  inline void Awake();

  /// @brief Method SetMode addr 0x212c450 size 0x214 virtual false final false
  inline void SetMode(::HMUI::ScreenModeData* screenModeData);

  /// @brief Method SetDefaultMode addr 0x212c664 size 0x8 virtual false final false
  inline void SetDefaultMode();

  static inline ::HMUI::ScreenModeController* New_ctor();

  /// @brief Method .ctor addr 0x212c66c size 0x8 virtual false final false
  inline void _ctor();
