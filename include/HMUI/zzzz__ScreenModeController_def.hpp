...
/// @brief Field _curvedCanvases, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__curvedCanvases, put=__cordl_internal_set__curvedCanvases)) ::ArrayW<::UnityW<::HMUI::CurvedCanvasSettings>,::Array<::UnityW<::HMUI::CurvedCanvasSettings>>*>  _curvedCanvases;
...
/// @brief Method Awake, addr 0x31fff78, size 0x138, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::HMUI::ScreenModeController* New_ctor() ;

/// @brief Method SetDefaultMode, addr 0x32002f8, size 0x8, virtual false, abstract: false, final false
inline void SetDefaultMode() ;

/// @brief Method SetMode, addr 0x32000d4, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3200300, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
