...
public:
  ...
  /// @brief Method Awake, addr 0x323bca8, size 0x138, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::HMUI::ScreenModeController* New_ctor();

  /// @brief Method SetDefaultMode, addr 0x323c028, size 0x8, virtual false, abstract: false, final false
  inline void SetDefaultMode();

  /// @brief Method SetMode, addr 0x323be04, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x323c030, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
