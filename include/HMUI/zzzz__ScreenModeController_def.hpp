...
// Write type traits
MARK_REF_T(::HMUI::ScreenModeController*);
DEFINE_IL2CPP_CLASS(::HMUI::ScreenModeController*, "HMUI", "ScreenModeController");
// Dependencies HMUI.CurvedCanvasSettings, UnityEngine.MonoBehaviour
namespace HMUI {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__curvedCanvases, put = __cordl_internal_set__curvedCanvases)) ::ArrayW<::UnityW<::HMUI::CurvedCanvasSettings>> _curvedCanvases;
  ...
  constexpr ::ArrayW<::UnityW<::HMUI::CurvedCanvasSettings>>& __cordl_internal_get__curvedCanvases();
  ...
  constexpr void __cordl_internal_set__curvedCanvases(::ArrayW<::UnityW<::HMUI::CurvedCanvasSettings>> value);
...
static_assert(sizeof(::HMUI::ScreenModeController) == 0x40, "Size mismatch!");
