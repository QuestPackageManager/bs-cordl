...
public:
  ...
  /// @brief Method Awake, addr 0x22edf88, size 0x144, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::HMUI::ScreenModeController* New_ctor();

  /// @brief Method SetDefaultMode, addr 0x22ee378, size 0x8, virtual false, abstract: false, final false
  inline void SetDefaultMode();

  /// @brief Method SetMode, addr 0x22ee164, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22ee380, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
