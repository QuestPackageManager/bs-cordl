...
public:
  ...
  /// @brief Method Awake, addr 0x22876bc, size 0x13c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::HMUI::ScreenModeController* New_ctor();

  /// @brief Method SetDefaultMode, addr 0x2287aa4, size 0x8, virtual false, abstract: false, final false
  inline void SetDefaultMode();

  /// @brief Method SetMode, addr 0x2287890, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2287aac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
