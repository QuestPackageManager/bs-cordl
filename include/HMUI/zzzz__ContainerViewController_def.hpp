...
public:
  ...
  /// @brief Method MoveNext, addr 0x24083d0, size 0x210, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::__ContainerViewController___AddViewControllerCoroutine_d__15* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x24085e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x24085e8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2408628, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x24083cc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2407ff4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2408634, size 0x2fc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::__ContainerViewController___RemoveViewControllersCoroutine_d__17* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2408930, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2408938, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2408978, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2408630, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x24080f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method AddViewController, addr 0x2407de8, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method AddViewControllerCoroutine, addr 0x2407f60, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearChildViewControllers, addr 0x2407ac8, size 0x124, virtual false, abstract: false, final false
  inline void ClearChildViewControllers();

  /// @brief Method DeactivateGameObject, addr 0x24079e0, size 0xe8, virtual true, abstract: false, final false
  inline void DeactivateGameObject();

  /// @brief Method GetNewXPositionsForViewControllers, addr 0x240811c, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveViewControllers, addr 0x240801c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveViewControllersCoroutine, addr 0x2408060, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method SetChildViewController, addr 0x2407bec, size 0xa0, virtual false, abstract: false, final false
  inline void SetChildViewController(::HMUI::ViewController* viewController);

  /// @brief Method SetChildViewControllers, addr 0x2407c8c, size 0x15c, virtual false, abstract: false, final false
  inline void SetChildViewControllers(::ArrayW<::HMUI::ViewController*, ::Array<::HMUI::ViewController*>*> viewControllers);

  /// @brief Method __Activate, addr 0x2407780, size 0x190, virtual true, abstract: false, final false
  inline void __Activate(bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method __Deactivate, addr 0x2407910, size 0xd0, virtual true, abstract: false, final false
  inline void __Deactivate(bool removedFromHierarchy, bool deactivateGameObject, bool screenSystemDisabling);

  /// @brief Method __Init, addr 0x24076a8, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2408350, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_controllersContainer, addr 0x24075f8, size 0xa8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_controllersContainer();

  /// @brief Method get_viewControllers, addr 0x24076a0, size 0x8, virtual false, abstract: false, final false
