...
public:
  ...
  /// @brief Method CellForIdx, addr 0x3a02c7c, size 0x1bc, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x3a02bc8, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method HandleDidSelectCellWithIdx, addr 0x3a02f24, size 0x14c, virtual false, abstract: false, final false
  inline void HandleDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropdownWithTableView, int32_t idx);

  /// @brief Method LazyInit, addr 0x3a02708, size 0xa8, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::HMUI::SimpleTextDropdown* New_ctor();

  /// @brief Method NumberOfCells, addr 0x3a02bd0, size 0xac, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method OnDestroy, addr 0x3a027b0, size 0x90, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithIdx, addr 0x3a029dc, size 0x1ec, virtual true, abstract: false, final false
  inline void SelectCellWithIdx(int32_t idx);

  /// @brief Method SetTexts, addr 0x3a02840, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a03070, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
