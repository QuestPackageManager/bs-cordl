...
public:
  ...
  /// @brief Method ExecuteAnimation, addr 0x39e46f8, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go);

  /// @brief Method ExecuteAnimation, addr 0x39e47d4, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go, ::System::Action* finishedCallback);

  /// @brief Method ExecuteAnimation, addr 0x39e47e4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAnimation, addr 0x39e4708, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e47f0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
