...
public:
  ...
  /// @brief Method ExecuteAnimation, addr 0x23fa4c4, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go);

  /// @brief Method ExecuteAnimation, addr 0x23fa5a0, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go, ::System::Action* finishedCallback);

  /// @brief Method ExecuteAnimation, addr 0x23fa5b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAnimation, addr 0x23fa4d4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23fa5bc, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
