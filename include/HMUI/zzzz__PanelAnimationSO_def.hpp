...
public:
  ...
  /// @brief Method ExecuteAnimation, addr 0x5660fa4, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go);

  /// @brief Method ExecuteAnimation, addr 0x5661080, size 0x10, virtual false, abstract: false, final false
  inline void ExecuteAnimation(::UnityEngine::GameObject* go, ::System::Action* finishedCallback);

  /// @brief Method ExecuteAnimation, addr 0x5661090, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAnimation, addr 0x5660fb4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x566109c, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
