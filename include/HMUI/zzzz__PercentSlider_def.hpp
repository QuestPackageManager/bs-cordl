...
public:
  ...
  /// @brief Method TextForValue, addr 0x39f1270, size 0x8c, virtual true, abstract: false, final false
  inline ::StringW TextForValue(float_t value);

  /// @brief Method .ctor, addr 0x39f12fc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
