...
public:
  ...
  /// @brief Method SetText, addr 0x21c1740, size 0x24, virtual false, abstract: false, final false
  inline void SetText(::StringW text);

  static inline ::HMUI::TitleViewController* New_ctor();

  /// @brief Method .ctor, addr 0x21c1764, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
