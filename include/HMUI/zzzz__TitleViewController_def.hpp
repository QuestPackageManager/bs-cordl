...
public:
  ...
  /// @brief Method SetText, addr 0x3239170, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x323c6f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
