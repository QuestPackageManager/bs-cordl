...
public:
  ...
  /// @brief Method SetText, addr 0x241607c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24160a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
