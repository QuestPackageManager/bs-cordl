...
public:
  ...
  /// @brief Method SetText, addr 0x2288744, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x228bb88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
