...
template<typename T>
inline void HMUI::UIItemsList_1_DataCallback<T>::_ctor(::System::Object*  object, ::System::IntPtr  method)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::UIItemsList_1_DataCallback<T>*>::get(),
                        ".ctor",
...
template<typename T>
inline void HMUI::UIItemsList_1_DataCallback<T>::Invoke(int32_t  idx, T  item)  {
...
template<typename T>
inline ::System::IAsyncResult* HMUI::UIItemsList_1_DataCallback<T>::BeginInvoke(int32_t  idx, T  item, ::System::AsyncCallback*  callback, ::System::Object*  object)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::UIItemsList_1_DataCallback<T>*>::get(),
                            14
...
template<typename T>
inline void HMUI::UIItemsList_1_DataCallback<T>::EndInvoke(::System::IAsyncResult*  result)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                            il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::UIItemsList_1_DataCallback<T>*>::get(),
                            15
...
template<typename T>
inline ::HMUI::UIItemsList_1_DataCallback<T>* HMUI::UIItemsList_1_DataCallback<T>::New_ctor(::System::Object*  object, ::System::IntPtr  method)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::HMUI::UIItemsList_1_DataCallback<T>*>(object, method));
}
// Ctor Parameters []
template<typename T>
constexpr ::HMUI::UIItemsList_1_DataCallback<T>::UIItemsList_1_DataCallback()   {
}
template<typename T>
...
template<typename T>
constexpr ::System::Collections::Generic::List_1<T>* const& HMUI::UIItemsList_1<T>::__cordl_internal_get__items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
...
template<typename T>
constexpr ::Zenject::DiContainer* const& HMUI::UIItemsList_1<T>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename T>
...
template<typename T>
inline void HMUI::UIItemsList_1<T>::SetData(int32_t  numberOfElements, ::HMUI::UIItemsList_1_DataCallback<T>*  dataCallback)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::UIItemsList_1<T>*>::get(),
                        "SetData",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HMUI::UIItemsList_1_DataCallback<T>*>::get()}
                    )));
