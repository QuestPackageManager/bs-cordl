...
template <typename T> inline ::HMUI::__UIItemsList_1__DataCallback<T>* HMUI::__UIItemsList_1__DataCallback<T>::New_ctor(::System::Object* object, ::System::IntPtr method) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::HMUI::__UIItemsList_1__DataCallback<T>*>(object, method));
}
template <typename T> inline void HMUI::__UIItemsList_1__DataCallback<T>::_ctor(::System::Object* object, ::System::IntPtr method) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::__UIItemsList_1__DataCallback<T>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline void HMUI::__UIItemsList_1__DataCallback<T>::Invoke(int32_t idx, T item) {
  auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::__UIItemsList_1__DataCallback<T>*>::get(), 13)));
...
template <typename T> inline ::System::IAsyncResult* HMUI::__UIItemsList_1__DataCallback<T>::BeginInvoke(int32_t idx, T item, ::System::AsyncCallback* callback, ::System::Object* object) {
  auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::__UIItemsList_1__DataCallback<T>*>::get(), 14)));
...
template <typename T> inline void HMUI::__UIItemsList_1__DataCallback<T>::EndInvoke(::System::IAsyncResult* result) {
  auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::__UIItemsList_1__DataCallback<T>*>::get(), 15)));
...
template <typename T> constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<T>*> const& HMUI::UIItemsList_1<T>::__cordl_internal_get__items() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____items;
}
...
template <typename T> constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& HMUI::UIItemsList_1<T>::__cordl_internal_get__container() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____container;
}
