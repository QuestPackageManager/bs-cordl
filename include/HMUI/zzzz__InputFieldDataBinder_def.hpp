...
MARK_GEN_REF_T_PTR(::HMUI::InputFieldDataBinder___c__3_1);
MARK_GEN_REF_T_PTR(::HMUI::InputFieldDataBinder___c__DisplayClass2_0_2);
...
public:
  ...
  /// @brief Method ClearBindings, addr 0x5878614, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58785a0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::InputFieldDataBinder) == 0x18, "Size mismatch!");
