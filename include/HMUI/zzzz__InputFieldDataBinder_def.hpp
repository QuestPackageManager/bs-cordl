...
public:
  ...
  /// @brief Method ClearBindings, addr 0x5730020, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572ffac, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
