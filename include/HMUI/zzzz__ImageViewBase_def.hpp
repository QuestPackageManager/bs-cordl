...
// Write type traits
MARK_REF_T(::HMUI::ImageViewBase*);
DEFINE_IL2CPP_CLASS(::HMUI::ImageViewBase*, "HMUI", "ImageViewBase");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5888298, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::HMUI::ImageViewBase) == 0x110, "Size mismatch!");
