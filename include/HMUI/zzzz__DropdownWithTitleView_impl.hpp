...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::DropdownWithTitleView::*)(::HMUI::TableView_IDataSource*)>(&::HMUI::DropdownWithTitleView::RefreshSize)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x56ce578;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::DropdownWithTitleView::*)()>(&::HMUI::DropdownWithTitleView::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56ce5d8;
