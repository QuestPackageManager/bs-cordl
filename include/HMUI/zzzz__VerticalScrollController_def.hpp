...
/// @brief Method Awake, addr 0x56d5fd4, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::HMUI::VerticalScrollController* New_ctor() ;

/// @brief Method OnDrag, addr 0x56d61a8, size 0x64, virtual true, abstract: false, final true
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnInitializePotentialDrag, addr 0x56d620c, size 0x14, virtual true, abstract: false, final true
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x56d60d4, size 0xd4, virtual true, abstract: false, final true
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnValidate, addr 0x56d5ff0, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56d6220, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_updateScrollPositionEvent, addr 0x56d39c8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_updateScrollPositionEvent, addr 0x56d3e04, size 0xc0, virtual false, abstract: false, final false
