...
public:
  ...
  /// @brief Method <Hide>b__0, addr 0x229443c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2293a1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleParentViewControllerDidDeactivate>b__0, addr 0x22944b8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2294424, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateBlocker, addr 0x2293ed8, size 0x458, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> CreateBlocker();

  /// @brief Method GetModalRootTransform, addr 0x2293dd8, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleBlockerButtonClicked, addr 0x2294330, size 0x1c, virtual false, abstract: false, final false
  inline void HandleBlockerButtonClicked();

  /// @brief Method HandleParentViewControllerDidDeactivate, addr 0x229434c, size 0xd8, virtual false, abstract: false, final false
  inline void HandleParentViewControllerDidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Hide, addr 0x2293810, size 0x20c, virtual true, abstract: false, final false
  inline void Hide(bool animated, ::System::Action* finishedCallback);

  static inline ::HMUI::ModalView* New_ctor();

  /// @brief Method OnDestroy, addr 0x2293504, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x22934f0, size 0x14, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method SetupView, addr 0x2293590, size 0x280, virtual false, abstract: false, final false
  inline void SetupView(::UnityEngine::Transform* screenTransform);

  /// @brief Method Show, addr 0x2293a24, size 0x3b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229442c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_blockerClickedEvent, addr 0x22933b0, size 0x9c, virtual true, abstract: false, final false
  inline void add_blockerClickedEvent(::System::Action* value);

  /// @brief Method get_isShown, addr 0x22934e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isShown();

  /// @brief Method remove_blockerClickedEvent, addr 0x229344c, size 0x9c, virtual true, abstract: false, final false
