...
public:
  ...
  /// @brief Method .ctor, addr 0x587bd88, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatRectOffset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatRectOffset(FloatRectOffset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatRectOffset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatRectOffset(FloatRectOffsetconst&) = delete;
