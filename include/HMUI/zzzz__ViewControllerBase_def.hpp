...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3a02228, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3a022ec, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3a02208, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a0217c, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3a023a0, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3a02448, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3a02384, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a022f8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CallDidActivate, addr 0x3a02128, size 0x28, virtual false, abstract: false, final false
  inline void CallDidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method CallDidDeactivate, addr 0x3a02150, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a02174, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didActivateEvent, addr 0x3a01eb8, size 0x9c, virtual false, abstract: false, final false
  inline void add_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method add_didDeactivateEvent, addr 0x3a01ff0, size 0x9c, virtual false, abstract: false, final false
  inline void add_didDeactivateEvent(::HMUI::ViewControllerBase_DidDeactivateDelegate* value);

  /// @brief Method remove_didActivateEvent, addr 0x3a01f54, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method remove_didDeactivateEvent, addr 0x3a0208c, size 0x9c, virtual false, abstract: false, final false
