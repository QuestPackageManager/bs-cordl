...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x39f9778, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x39f983c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x39f9758, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f96cc, size 0x8c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x39f98f0, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x39f9998, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x39f98d4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f9848, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CallDidActivate, addr 0x39f9678, size 0x28, virtual false, abstract: false, final false
  inline void CallDidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method CallDidDeactivate, addr 0x39f96a0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f96c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didActivateEvent, addr 0x39f9408, size 0x9c, virtual false, abstract: false, final false
  inline void add_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method add_didDeactivateEvent, addr 0x39f9540, size 0x9c, virtual false, abstract: false, final false
  inline void add_didDeactivateEvent(::HMUI::ViewControllerBase_DidDeactivateDelegate* value);

  /// @brief Method remove_didActivateEvent, addr 0x39f94a4, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method remove_didDeactivateEvent, addr 0x39f95dc, size 0x9c, virtual false, abstract: false, final false
