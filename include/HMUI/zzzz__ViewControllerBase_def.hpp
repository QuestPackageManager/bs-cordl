...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x573ab90, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x573ac20, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x573ab7c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x573ab10, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x573acac, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x573ad20, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x573ac98, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x573ac2c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CallDidActivate, addr 0x573aac0, size 0x28, virtual false, abstract: false, final false
  inline void CallDidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method CallDidDeactivate, addr 0x573aae8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x573ab0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didActivateEvent, addr 0x573a810, size 0xac, virtual false, abstract: false, final false
  inline void add_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method add_didDeactivateEvent, addr 0x573a968, size 0xac, virtual false, abstract: false, final false
  inline void add_didDeactivateEvent(::HMUI::ViewControllerBase_DidDeactivateDelegate* value);

  /// @brief Method remove_didActivateEvent, addr 0x573a8bc, size 0xac, virtual false, abstract: false, final false
  inline void remove_didActivateEvent(::HMUI::ViewControllerBase_DidActivateDelegate* value);

  /// @brief Method remove_didDeactivateEvent, addr 0x573aa14, size 0xac, virtual false, abstract: false, final false
