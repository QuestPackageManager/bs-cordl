...
public:
  ...
  /// @brief Method CellForCellNumber, addr 0x408b368, size 0x308, virtual true, abstract: false, final true
  ...
  /// @brief Method NumberOfCells, addr 0x408b2bc, size 0xac, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetTexts, addr 0x408b2a4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408b6f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
