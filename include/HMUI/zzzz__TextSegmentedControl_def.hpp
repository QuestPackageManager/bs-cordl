...
public:
  ...
  /// @brief Method CellForCellNumber, addr 0x25304b0, size 0x2ac, virtual true, abstract: false, final true
  ...
  /// @brief Method NumberOfCells, addr 0x2530404, size 0xac, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetTexts, addr 0x25303ec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25307e4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
