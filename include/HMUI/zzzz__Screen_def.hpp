...
public:
  ...
  /// @brief Method MoveNext, addr 0x228993c, size 0x530, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::Screen__TransitionCoroutine_d__5* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2289f00, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2289f08, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2289f40, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2289938, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22898fc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x2289924, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetRootViewController, addr 0x2286ab0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionCoroutine, addr 0x2289888, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2289930, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isBeingDestroyed, addr 0x2289880, size 0x8, virtual false, abstract: false, final false
