...
public:
  ...
  /// @brief Method MoveNext, addr 0x2526a7c, size 0x504, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::HMUI::__Screen___TransitionCoroutine_d__5* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2527014, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x252701c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x252705c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2526a78, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2526a3c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x2526a64, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetRootViewController, addr 0x25268f0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionCoroutine, addr 0x25269c0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2526a70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isBeingDestroyed, addr 0x25268e8, size 0x8, virtual false, abstract: false, final false
