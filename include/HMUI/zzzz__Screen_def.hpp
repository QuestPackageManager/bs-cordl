...
namespace HMUI {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13553))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x21c0530, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose, addr 0x21c056c, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext, addr 0x21c0570, size 0x504, virtual true, abstract: false, final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x21c0b08, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x21c0b10, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x21c0b50, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method get_isBeingDestroyed, addr 0x21c03dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_isBeingDestroyed();

  /// @brief Method SetRootViewController, addr 0x21c03e4, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionCoroutine, addr 0x21c04b4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x21c0558, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  static inline ::HMUI::Screen* New_ctor();

  /// @brief Method .ctor, addr 0x21c0564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
