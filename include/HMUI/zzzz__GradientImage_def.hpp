...
public:
  ...
  /// @brief Method AddQuad, addr 0x39fd54c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x39fd1bc, size 0x390, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x39fd6a0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateFilledSprite, addr 0x39fc474, size 0x8f0, virtual false, abstract: false, final false
  inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper* toFill, bool preserveAspect);

  /// @brief Method GenerateSimpleSprite, addr 0x39faeac, size 0x564, virtual false, abstract: false, final false
  inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper* vh, bool lPreserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSlicedSprite, addr 0x39fb410, size 0x7b8, virtual false, abstract: false, final false
  inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper* vh, float_t curvedUIRadius);

  /// @brief Method GenerateTiledSprite, addr 0x39fbbc8, size 0x8ac, virtual false, abstract: false, final false
  inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method GetAdjustedBorders, addr 0x39fd178, size 0x44, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4 border, ::UnityEngine::Rect rect);

  /// @brief Method GetDrawingDimensions, addr 0x39fcd64, size 0x414, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect);

  static inline ::HMUI::GradientImage* New_ctor();

  /// @brief Method OnPopulateMesh, addr 0x39fad3c, size 0x170, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method RadialCut, addr 0x39fd784, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RadialCut, addr 0x39fd8a4, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39fdcd0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color0, addr 0x39faca4, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color0();

  /// @brief Method get_color1, addr 0x39facf0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color0, addr 0x39facb8, size 0x38, virtual false, abstract: false, final false
  inline void set_color0(::UnityEngine::Color value);

  /// @brief Method set_color1, addr 0x39fad04, size 0x38, virtual false, abstract: false, final false
