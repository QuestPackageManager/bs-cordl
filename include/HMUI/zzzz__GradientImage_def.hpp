...
// TypeDefinitionIndex(TypeDefinitionIndex(8995)), TypeDefinitionIndex(TypeDefinitionIndex(12953))] Self: TypeDefinitionIndex(TypeDefinitionIndex(13578)) CS Name: ::HMUI::GradientImage*
...
public:
  ...
  /// @brief Method get_color0, addr 0x21c5c30, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color0();

  /// @brief Method set_color0, addr 0x21c5c44, size 0x38, virtual false, abstract: false, final false
  inline void set_color0(::UnityEngine::Color value);

  /// @brief Method get_color1, addr 0x21c5c7c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color1();

  /// @brief Method set_color1, addr 0x21c5c90, size 0x38, virtual false, abstract: false, final false
  inline void set_color1(::UnityEngine::Color value);

  /// @brief Method OnPopulateMesh, addr 0x21c5cc8, size 0x174, virtual true, abstract: false, final false
  inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method GenerateSimpleSprite, addr 0x21c5e3c, size 0xab8, virtual false, abstract: false, final false
  inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper* vh, bool lPreserveAspect, float_t curvedUIRadius);

  /// @brief Method GenerateSlicedSprite, addr 0x21c68f4, size 0xd80, virtual false, abstract: false, final false
  inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper* vh, float_t curvedUIRadius);

  /// @brief Method GenerateTiledSprite, addr 0x21c7674, size 0x22ec, virtual false, abstract: false, final false
  inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper* toFill);

  /// @brief Method AddQuad, addr 0x21cbdec, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x21cbc98, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method AddQuad, addr 0x21cb3f0, size 0x8a8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAdjustedBorders, addr 0x21cb318, size 0xd8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4 border, ::UnityEngine::Rect rect);

  /// @brief Method GenerateFilledSprite, addr 0x21c9960, size 0x1430, virtual false, abstract: false, final false
  inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper* toFill, bool preserveAspect);

  /// @brief Method RadialCut, addr 0x21cbed0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method RadialCut, addr 0x21cbff0, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDrawingDimensions, addr 0x21cad90, size 0x588, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect);

  static inline ::HMUI::GradientImage* New_ctor();

  /// @brief Method .ctor, addr 0x21cc3dc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
