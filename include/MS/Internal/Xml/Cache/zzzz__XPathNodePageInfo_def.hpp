...
// Write type traits
MARK_REF_T(::MS::Internal::Xml::Cache::XPathNodePageInfo*);
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::Cache::XPathNodePageInfo*, "MS.Internal.Xml.Cache", "XPathNodePageInfo");
// Dependencies MS.Internal.Xml.Cache.XPathNode, System.Object
namespace MS::Internal::Xml::Cache {
// Is value type: false
...
public:
  // Declarations
  __declspec(property(get = get_NextPage)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> NextPage;
  ...
  __declspec(property(get = __cordl_internal_get__pageNext, put = __cordl_internal_set__pageNext)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> _pageNext;
  ...
  constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> const& __cordl_internal_get__pageNext() const;

  constexpr ::ArrayW<::MS::Internal::Xml::Cache::XPathNode>& __cordl_internal_get__pageNext();
  ...
  constexpr void __cordl_internal_set__pageNext(::ArrayW<::MS::Internal::Xml::Cache::XPathNode> value);

  constexpr void __cordl_internal_set__pageNum(int32_t value);

  /// @brief Method get_NextPage, addr 0x627b5d0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> get_NextPage();

  /// @brief Method get_NodeCount, addr 0x627b5c8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_NodeCount();

  /// @brief Method get_PageNumber, addr 0x627b5c0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XPathNodePageInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XPathNodePageInfo(XPathNodePageInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XPathNodePageInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XPathNodePageInfo(XPathNodePageInfoconst&) = delete;
  ...
  ::ArrayW<::MS::Internal::Xml::Cache::XPathNode> ____pageNext;
...
static_assert(sizeof(::MS::Internal::Xml::Cache::XPathNodePageInfo) == 0x20, "Size mismatch!");
