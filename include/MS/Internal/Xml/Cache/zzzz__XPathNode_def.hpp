...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::Cache::XPathNode, "MS.Internal.Xml.Cache", "XPathNode");
// Dependencies
namespace MS::Internal::Xml::Cache {
// Is value type: true
...
static_assert(sizeof(::MS::Internal::Xml::Cache::XPathNode) == 0x20, "Size mismatch!");
