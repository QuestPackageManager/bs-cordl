...
public:
  ...
  /// @brief Method get_NodeType, addr 0x28ed6b8, size 0xc, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathNodeType get_NodeType();

  /// @brief Method get_Prefix, addr 0x28ed7b0, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_LocalName, addr 0x28ed700, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_LocalName();

  /// @brief Method get_NamespaceUri, addr 0x28ed758, size 0x1c, virtual false, abstract: false, final false
  inline ::StringW get_NamespaceUri();

  /// @brief Method get_Document, addr 0x28ed810, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Xml::XPath::XPathDocument* get_Document();

  /// @brief Method get_PageInfo, addr 0x28edd60, size 0x1c, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo();

  /// @brief Method GetParent, addr 0x28edbf0, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetParent(ByRef<::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*>> pageNode);

  /// @brief Method GetSibling, addr 0x28edac4, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetSibling(ByRef<::ArrayW<::MS::Internal::Xml::Cache::XPathNode, ::Array<::MS::Internal::Xml::Cache::XPathNode>*>> pageNode);

  /// @brief Method get_IsXmlNamespaceNode, addr 0x28eda3c, size 0x88, virtual false, abstract: false, final false
  inline bool get_IsXmlNamespaceNode();

  /// @brief Method get_HasSibling, addr 0x28edd7c, size 0x10, virtual false, abstract: false, final false
  inline bool get_HasSibling();

  /// @brief Method get_HasCollapsedText, addr 0x28edd8c, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasCollapsedText();

  /// @brief Method get_IsText, addr 0x28edd98, size 0x60, virtual false, abstract: false, final false
  inline bool get_IsText();

  /// @brief Method get_HasNamespaceDecls, addr 0x28eddf8, size 0xc, virtual false, abstract: false, final false
  inline bool get_HasNamespaceDecls();

  /// @brief Method get_Value, addr 0x28ede04, size 0x8, virtual false, abstract: false, final false
