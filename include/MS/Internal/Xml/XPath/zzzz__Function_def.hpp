...
public:
  ...
  /// @brief Method .ctor, addr 0x43051b0, size 0x110, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::Function_FunctionType ftype, ::MS::Internal::Xml::XPath::AstNode* arg);

  /// @brief Method .ctor, addr 0x4305074, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x430510c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x43052c8, size 0x80, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x43052c0, size 0x8, virtual true, abstract: false, final false
