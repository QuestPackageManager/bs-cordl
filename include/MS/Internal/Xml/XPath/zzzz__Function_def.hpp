...
public:
  ...
  /// @brief Method .ctor, addr 0x6134738, size 0x104, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::Function_FunctionType ftype, ::MS::Internal::Xml::XPath::AstNode* arg);

  /// @brief Method .ctor, addr 0x613460c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6134698, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x6134844, size 0x84, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x613483c, size 0x8, virtual true, abstract: false, final false
