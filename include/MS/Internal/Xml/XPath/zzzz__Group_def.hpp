...
// Write type traits
MARK_REF_T(::MS::Internal::Xml::XPath::Group*);
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Group*, "MS.Internal.Xml.XPath", "Group");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6276dec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::AstNode* groupNode);

  /// @brief Method get_ReturnType, addr 0x6276dfc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x6276df4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Group", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Group(Group&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Group", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Group(Groupconst&) = delete;
...
static_assert(sizeof(::MS::Internal::Xml::XPath::Group) == 0x18, "Size mismatch!");
