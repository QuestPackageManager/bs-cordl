...
public:
  ...
  /// @brief Method NextChar, addr 0x6137ef4, size 0x64, virtual false, abstract: false, final false
  inline bool NextChar();

  /// @brief Method NextLex, addr 0x613690c, size 0x400, virtual false, abstract: false, final false
  inline bool NextLex();

  /// @brief Method ScanFraction, addr 0x6137fc8, size 0xb4, virtual false, abstract: false, final false
  inline double_t ScanFraction();

  /// @brief Method ScanName, addr 0x613820c, size 0x6c, virtual false, abstract: false, final false
  inline ::StringW ScanName();

  /// @brief Method ScanNumber, addr 0x613812c, size 0xe0, virtual false, abstract: false, final false
  inline double_t ScanNumber();

  /// @brief Method ScanString, addr 0x613807c, size 0xb0, virtual false, abstract: false, final false
  inline ::StringW ScanString();

  /// @brief Method SkipSpace, addr 0x6137f98, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6134b9c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::StringW xpathExpr);

  /// @brief Method get_CanBeFunction, addr 0x6137f90, size 0x8, virtual false, abstract: false, final false
  inline bool get_CanBeFunction();

  /// @brief Method get_CurrentChar, addr 0x6137f60, size 0x8, virtual false, abstract: false, final false
  inline char16_t get_CurrentChar();

  /// @brief Method get_Kind, addr 0x6137f68, size 0x8, virtual false, abstract: false, final false
  inline ::MS::Internal::Xml::XPath::XPathScanner_LexKind get_Kind();

  /// @brief Method get_Name, addr 0x6137f70, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_NumberValue, addr 0x6137f88, size 0x8, virtual false, abstract: false, final false
  inline double_t get_NumberValue();

  /// @brief Method get_Prefix, addr 0x6137f78, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Prefix();

  /// @brief Method get_SourceText, addr 0x6137f58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_SourceText();

  /// @brief Method get_StringValue, addr 0x6137f80, size 0x8, virtual false, abstract: false, final false
