...
/// @brief Method NextChar, addr 0x60c5ee8, size 0x64, virtual false, abstract: false, final false
inline bool NextChar() ;

/// @brief Method NextLex, addr 0x60c4900, size 0x400, virtual false, abstract: false, final false
inline bool NextLex() ;

/// @brief Method ScanFraction, addr 0x60c5fbc, size 0xb4, virtual false, abstract: false, final false
inline double_t ScanFraction() ;

/// @brief Method ScanName, addr 0x60c6200, size 0x6c, virtual false, abstract: false, final false
inline ::StringW ScanName() ;

/// @brief Method ScanNumber, addr 0x60c6120, size 0xe0, virtual false, abstract: false, final false
inline double_t ScanNumber() ;

/// @brief Method ScanString, addr 0x60c6070, size 0xb0, virtual false, abstract: false, final false
inline ::StringW ScanString() ;

/// @brief Method SkipSpace, addr 0x60c5f8c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x60c2b90, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::StringW  xpathExpr) ;

/// @brief Method get_CanBeFunction, addr 0x60c5f84, size 0x8, virtual false, abstract: false, final false
inline bool get_CanBeFunction() ;

/// @brief Method get_CurrentChar, addr 0x60c5f54, size 0x8, virtual false, abstract: false, final false
inline char16_t get_CurrentChar() ;

/// @brief Method get_Kind, addr 0x60c5f5c, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::XPathScanner_LexKind get_Kind() ;

/// @brief Method get_Name, addr 0x60c5f64, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NumberValue, addr 0x60c5f7c, size 0x8, virtual false, abstract: false, final false
inline double_t get_NumberValue() ;

/// @brief Method get_Prefix, addr 0x60c5f6c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SourceText, addr 0x60c5f4c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SourceText() ;

/// @brief Method get_StringValue, addr 0x60c5f74, size 0x8, virtual false, abstract: false, final false
