...
public:
  ...
  /// @brief Method .ctor, addr 0x61345f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::MS::Internal::Xml::XPath::AstNode* input, ::MS::Internal::Xml::XPath::AstNode* condition);

  /// @brief Method get_ReturnType, addr 0x6134604, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x61345fc, size 0x8, virtual true, abstract: false, final false
