...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Root", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Root(Root&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Root", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Root(Rootconst&) = delete;
