...
public:
  ...
  /// @brief Method .ctor, addr 0x2d5eec0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW prefix);

  /// @brief Method get_ReturnType, addr 0x2d5eef4, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x2d5eeec, size 0x8, virtual true, abstract: false, final false
