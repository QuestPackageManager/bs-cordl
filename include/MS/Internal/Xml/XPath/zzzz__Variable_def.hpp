...
public:
  ...
  /// @brief Method .ctor, addr 0x430883c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW prefix);

  /// @brief Method get_ReturnType, addr 0x4308870, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x4308868, size 0x8, virtual true, abstract: false, final false
