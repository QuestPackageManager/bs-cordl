...
public:
  ...
  /// @brief Method .ctor, addr 0x605a854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW name, ::StringW prefix);

  /// @brief Method get_ReturnType, addr 0x605a864, size 0x8, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x605a85c, size 0x8, virtual true, abstract: false, final false
