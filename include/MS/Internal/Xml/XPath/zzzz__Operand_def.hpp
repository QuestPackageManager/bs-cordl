...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Operand", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Operand(Operand&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Operand", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Operand(Operandconst&) = delete;
