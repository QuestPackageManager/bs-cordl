...
public:
  ...
  /// @brief Method .ctor, addr 0x60c2300, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x60c2314, size 0x20, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x60c230c, size 0x8, virtual true, abstract: false, final false
