...
public:
  ...
  /// @brief Method .ctor, addr 0x4308728, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ReturnType, addr 0x430876c, size 0x24, virtual true, abstract: false, final false
  inline ::System::Xml::XPath::XPathResultType get_ReturnType();

  /// @brief Method get_Type, addr 0x4308764, size 0x8, virtual true, abstract: false, final false
