...
DEFINE_IL2CPP_CLASS(::MS::Internal::Xml::XPath::Axis_AxisType, "MS.Internal.Xml.XPath", "Axis/AxisType");
...
static_assert(sizeof(::MS::Internal::Xml::XPath::Axis_AxisType) == 0x4, "Size mismatch!");
