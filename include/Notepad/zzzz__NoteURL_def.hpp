...
DEFINE_IL2CPP_CLASS(::Notepad::NoteURL, "Notepad", "NoteURL");
// Dependencies
namespace Notepad {
// Is value type: true
...
public:
  ...
  // Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None, comment: None }, CppParam { name: "url", ty: "::StringW", modifiers: "", def_value: None, comment: None
  // }]
...
static_assert(sizeof(::Notepad::NoteURL) == 0x10, "Size mismatch!");
