...
public:
  ...
  /// @brief Method OpusDecode, addr 0x24dc1a0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecodeFloat, addr 0x24db608, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecoderCreate, addr 0x24db4a8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecoderDestroy, addr 0x24db7fc, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusDecoderDestroy(void* decoder);

  /// @brief Method OpusEncode, addr 0x24dc0e4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncodeFloat, addr 0x24dbe1c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncoderCreate, addr 0x24dbcd0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncoderDestroy, addr 0x24dbf5c, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusEncoderDestroy(void* encoder);

  /// @brief Method OpusEncoderSetBitrate, addr 0x24db9b4, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetBitrate(void* encoder, int32_t bitrate);

  /// @brief Method OpusEncoderSetComplexity, addr 0x24dba68, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetComplexity(void* encoder, int32_t complexity);

  /// @brief Method OpusEncoderSetSignal, addr 0x24dbb1c, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetSignal(void* encoder, ::UnityOpus::OpusSignal signal);

  /// @brief Method OpusPcmSoftClip, addr 0x24db6cc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24dc264, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
