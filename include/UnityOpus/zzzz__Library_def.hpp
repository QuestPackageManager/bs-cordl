...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16388))
// CS Name: ::UnityOpus::Library*
class CORDL_TYPE Library : public ::System::Object {
public:
  // Declarations
  /// @brief Method OpusEncoderCreate, addr 0x228d344, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncode, addr 0x228d758, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncodeFloat, addr 0x228d490, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncoderDestroy, addr 0x228d5d0, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusEncoderDestroy(void* encoder);

  /// @brief Method OpusEncoderSetBitrate, addr 0x228d028, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetBitrate(void* encoder, int32_t bitrate);

  /// @brief Method OpusEncoderSetComplexity, addr 0x228d0dc, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetComplexity(void* encoder, int32_t complexity);

  /// @brief Method OpusEncoderSetSignal, addr 0x228d190, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetSignal(void* encoder, ::UnityOpus::OpusSignal signal);

  /// @brief Method OpusDecoderCreate, addr 0x228cb1c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecode, addr 0x228d814, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecodeFloat, addr 0x228cc7c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecoderDestroy, addr 0x228ce70, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusDecoderDestroy(void* decoder);

  /// @brief Method OpusPcmSoftClip, addr 0x228cd40, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x228d8d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
