...
public:
  // Declarations
  /// @brief Method OpusEncoderCreate addr 0x21e82bc size 0x9c virtual false final false
  ...
  /// @brief Method OpusEncode addr 0x21e86d0 size 0xbc virtual false final false
  ...
  /// @brief Method OpusEncodeFloat addr 0x21e8408 size 0xbc virtual false final false
  ...
  /// @brief Method OpusEncoderDestroy addr 0x21e8548 size 0x7c virtual false final false
  static inline void OpusEncoderDestroy(void* encoder);

  /// @brief Method OpusEncoderSetBitrate addr 0x21e7fa0 size 0x84 virtual false final false
  static inline int32_t OpusEncoderSetBitrate(void* encoder, int32_t bitrate);

  /// @brief Method OpusEncoderSetComplexity addr 0x21e8054 size 0x84 virtual false final false
  static inline int32_t OpusEncoderSetComplexity(void* encoder, int32_t complexity);

  /// @brief Method OpusEncoderSetSignal addr 0x21e8108 size 0x84 virtual false final false
  static inline int32_t OpusEncoderSetSignal(void* encoder, ::UnityOpus::OpusSignal signal);

  /// @brief Method OpusDecoderCreate addr 0x21e7a94 size 0x94 virtual false final false
  ...
  /// @brief Method OpusDecode addr 0x21e878c size 0xc4 virtual false final false
  ...
  /// @brief Method OpusDecodeFloat addr 0x21e7bf4 size 0xc4 virtual false final false
  ...
  /// @brief Method OpusDecoderDestroy addr 0x21e7de8 size 0x7c virtual false final false
  static inline void OpusDecoderDestroy(void* decoder);

  /// @brief Method OpusPcmSoftClip addr 0x21e7cb8 size 0xac virtual false final false
  ...
  /// @brief Method .ctor addr 0x21e8850 size 0x8 virtual false final false
  inline void _ctor();
