...
public:
  ...
  /// @brief Method OpusDecode, addr 0x5753818, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecodeFloat, addr 0x5752e54, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecoderCreate, addr 0x5752d58, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusDecoderDestroy, addr 0x5752ff8, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusDecoderDestroy(::System::IntPtr decoder);

  /// @brief Method OpusEncode, addr 0x575375c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncodeFloat, addr 0x5753530, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncoderCreate, addr 0x5753468, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method OpusEncoderDestroy, addr 0x5753620, size 0x7c, virtual false, abstract: false, final false
  static inline void OpusEncoderDestroy(::System::IntPtr encoder);

  /// @brief Method OpusEncoderSetBitrate, addr 0x5753164, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetBitrate(::System::IntPtr encoder, int32_t bitrate);

  /// @brief Method OpusEncoderSetComplexity, addr 0x5753218, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetComplexity(::System::IntPtr encoder, int32_t complexity);

  /// @brief Method OpusEncoderSetSignal, addr 0x57532cc, size 0x84, virtual false, abstract: false, final false
  static inline int32_t OpusEncoderSetSignal(::System::IntPtr encoder, ::UnityOpus::OpusSignal signal);

  /// @brief Method OpusPcmSoftClip, addr 0x5752f18, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57538dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
