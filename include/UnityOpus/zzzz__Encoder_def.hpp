...
namespace UnityOpus {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6157)), TypeDefinitionIndex(TypeDefinitionIndex(2601)), TypeDefinitionIndex(TypeDefinitionIndex(2611)),
// TypeDefinitionIndex(TypeDefinitionIndex(6159))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6155)) CS Name: ::UnityOpus::Encoder*
...
public:
  ...
  /// @brief Method get_Bitrate addr 0x21e7f70 size 0x8 virtual false final false
  inline int32_t get_Bitrate();

  /// @brief Method set_Bitrate addr 0x21e7f78 size 0x28 virtual false final false
  inline void set_Bitrate(int32_t value);

  /// @brief Method get_Complexity addr 0x21e8024 size 0x8 virtual false final false
  inline int32_t get_Complexity();

  /// @brief Method set_Complexity addr 0x21e802c size 0x28 virtual false final false
  inline void set_Complexity(int32_t value);

  /// @brief Method get_Signal addr 0x21e80d8 size 0x8 virtual false final false
  inline ::UnityOpus::OpusSignal get_Signal();

  /// @brief Method set_Signal addr 0x21e80e0 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21e818c size 0x130 virtual false final false
  ...
  /// @brief Method Encode addr 0x21e8358 size 0xb0 virtual false final false
  inline int32_t Encode(::ArrayW<float_t, ::Array<float_t>*> pcm, int32_t count, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Dispose addr 0x21e84c4 size 0x84 virtual true final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize addr 0x21e85c4 size 0xa0 virtual true final false
  inline void Finalize();

  /// @brief Method Dispose addr 0x21e8664 size 0x6c virtual true final true
  inline void Dispose();
