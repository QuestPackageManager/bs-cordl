...
public:
  ...
  /// @brief Method Dispose, addr 0x57536ec, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x57535ec, size 0x34, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Encode, addr 0x5753504, size 0x2c, virtual false, abstract: false, final false
  inline int32_t Encode(::ArrayW<float_t, ::Array<float_t>*> pcm, int32_t count, ::ArrayW<uint8_t, ::Array<uint8_t>*> output);

  /// @brief Method Finalize, addr 0x575369c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5753350, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Bitrate, addr 0x5753134, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Bitrate();

  /// @brief Method get_Complexity, addr 0x57531e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Complexity();

  /// @brief Method get_Signal, addr 0x575329c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityOpus::OpusSignal get_Signal();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_Bitrate, addr 0x575313c, size 0x28, virtual false, abstract: false, final false
  inline void set_Bitrate(int32_t value);

  /// @brief Method set_Complexity, addr 0x57531f0, size 0x28, virtual false, abstract: false, final false
  inline void set_Complexity(int32_t value);

  /// @brief Method set_Signal, addr 0x57532a4, size 0x28, virtual false, abstract: false, final false
