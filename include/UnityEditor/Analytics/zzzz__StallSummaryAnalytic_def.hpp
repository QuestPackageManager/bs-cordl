...
public:
  ...
  /// @brief Method CreateStallSummaryAnalytic, addr 0x6e22878, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e22800, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
