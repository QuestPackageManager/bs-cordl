...
public:
  // Declarations
  /// @brief Method CreatePackageManagerEmbedPackageAnalytic, addr 0x6bf10d0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6bf103c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
