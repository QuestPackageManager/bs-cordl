...
public:
  // Declarations
  /// @brief Method CreatePackageManagerEmbedPackageAnalytic, addr 0x6e2228c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e221f8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
