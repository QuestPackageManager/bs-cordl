...
public:
  ...
  /// @brief Method CreateAssetImportStatusAnalytic, addr 0x6cccbe4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cccb68, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
