...
public:
  ...
  __declspec(property(get = __cordl_internal_get_selected_asset_extensions, put = __cordl_internal_set_selected_asset_extensions)) ::ArrayW<::StringW> selected_asset_extensions;
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_selected_asset_extensions() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_selected_asset_extensions();
  ...
  constexpr void __cordl_internal_set_selected_asset_extensions(::ArrayW<::StringW> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AssetImportStatusAnalytic", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AssetImportStatusAnalytic(AssetImportStatusAnalytic&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AssetImportStatusAnalytic", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AssetImportStatusAnalytic(AssetImportStatusAnalyticconst&) = delete;
  ...
  ::ArrayW<::StringW> ___selected_asset_extensions;
...
static_assert(sizeof(::UnityEditor::Analytics::AssetImportStatusAnalytic) == 0x68, "Size mismatch!");
