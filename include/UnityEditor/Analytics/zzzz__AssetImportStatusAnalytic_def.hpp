...
/// @brief Method CreateAssetImportStatusAnalytic, addr 0x6cce75c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cce6e0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
