...
public:
  // Declarations
  /// @brief Method CreatePackageManagerAddPackageAnalytic, addr 0x6e21eec, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21e58, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
