...
public:
  // Declarations
  /// @brief Method CreatePackageManagerTestAnalytic, addr 0x6ccc5a4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccc510, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
