...
public:
// Declarations
/// @brief Method CreatePackageManagerTestAnalytic, addr 0x6c5a35c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c5a2c8, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
