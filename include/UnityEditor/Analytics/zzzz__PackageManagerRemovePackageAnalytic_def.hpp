...
public:
// Declarations
/// @brief Method CreatePackageManagerRemovePackageAnalytic, addr 0x6cce204, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cce170, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
