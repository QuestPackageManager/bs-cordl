...
public:
  ...
  /// @brief Method CreateTestAnalytic, addr 0x6e25f98, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e25f20, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TestAnalytic", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TestAnalytic(TestAnalytic&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TestAnalytic", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TestAnalytic(TestAnalyticconst&) = delete;
