...
public:
  ...
  /// @brief Method CreateTestAnalytic, addr 0x6cccfe0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cccf68, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
