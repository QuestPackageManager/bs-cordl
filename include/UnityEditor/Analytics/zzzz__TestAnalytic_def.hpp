...
public:
  ...
  /// @brief Method CreateTestAnalytic, addr 0x6e22a10, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e22998, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
