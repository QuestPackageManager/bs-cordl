...
public:
  ...
  /// @brief Method CreateLicensingErrorAnalytic, addr 0x6e219a0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21928, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
