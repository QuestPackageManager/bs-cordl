...
public:
  ...
  /// @brief Method CreateLicensingErrorAnalytic, addr 0x6ccbf70, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbef8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
