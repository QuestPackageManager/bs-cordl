...
/// @brief Method CreateSendGameBuildAnalytic, addr 0x6ccdee4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6ccde6c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
