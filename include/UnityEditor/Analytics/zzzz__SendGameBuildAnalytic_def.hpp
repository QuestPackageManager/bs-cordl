...
public:
  ...
  /// @brief Method CreateSendGameBuildAnalytic, addr 0x6ccc36c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccc2f4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
