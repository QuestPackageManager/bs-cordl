...
public:
  ...
  /// @brief Method CreateSendGameBuildAnalytic, addr 0x6e21d9c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21d24, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEditor::Analytics::SendGameBuildAnalytic) == 0x30, "Size mismatch!");
