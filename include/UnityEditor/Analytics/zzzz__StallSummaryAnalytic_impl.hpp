...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEditor::Analytics::StallSummaryAnalytic::*)()>(&::UnityEditor::Analytics::StallSummaryAnalytic::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6cce948;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEditor::Analytics::StallSummaryAnalytic*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEditor::Analytics::StallSummaryAnalytic* (*)()>(&::UnityEditor::Analytics::StallSummaryAnalytic::CreateStallSummaryAnalytic)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6cce9c0;
