...
public:
  ...
  /// @brief Method CreateAssetImportAnalytic, addr 0x6ccccb0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cccc38, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
