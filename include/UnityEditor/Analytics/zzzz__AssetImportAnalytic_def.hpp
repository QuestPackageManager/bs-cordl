...
/// @brief Method CreateAssetImportAnalytic, addr 0x6c5aa68, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c5a9f0, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
