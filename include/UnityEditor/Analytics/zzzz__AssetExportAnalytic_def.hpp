...
public:
  ...
  /// @brief Method CreateAssetExportAnalytic, addr 0x6e227ac, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e22734, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
