...
public:
  ...
  /// @brief Method CreateAssetExportAnalytic, addr 0x6cccd7c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cccd04, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
