...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MetalPatchShaderComputeBufferAnalytic", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MetalPatchShaderComputeBufferAnalytic(MetalPatchShaderComputeBufferAnalytic&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MetalPatchShaderComputeBufferAnalytic", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MetalPatchShaderComputeBufferAnalytic(MetalPatchShaderComputeBufferAnalyticconst&) = delete;
