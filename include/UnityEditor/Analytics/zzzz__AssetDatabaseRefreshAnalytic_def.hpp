...
public:
  ...
  /// @brief Method CreateAssetDatabaseRefreshAnalytic, addr 0x6ccbd0c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbc94, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
