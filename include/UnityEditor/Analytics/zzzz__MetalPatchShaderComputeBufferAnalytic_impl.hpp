...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic::*)()>(&::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic::_ctor)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x6ccdc08;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic* (*)()>(&::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic::CreateMetalPatchShaderComputeBufferAnalytic)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x6ccdc80;
...
return ::cordl_internals::RunMethodRethrow<::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic*, false>(nullptr, ___internal_method);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEditor::Analytics::MetalPatchShaderComputeBufferAnalytic*>());
}
// Ctor Parameters []
