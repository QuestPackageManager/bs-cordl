...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::UnityEditor::Analytics::AssetExportAnalytic::*)()>(&::UnityEditor::Analytics::AssetExportAnalytic::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6e22734;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityEditor::Analytics::AssetExportAnalytic* (*)()>(&::UnityEditor::Analytics::AssetExportAnalytic::CreateAssetExportAnalytic)> {
  ...
  constexpr static std::size_t addrs = 0x6e227ac;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEditor::Analytics::AssetExportAnalytic*>(), { "CreateAssetExportAnalytic", {}, {} })));
    return ___internal_method;
  }
};
...
inline ::UnityEditor::Analytics::AssetExportAnalytic* UnityEditor::Analytics::AssetExportAnalytic::CreateAssetExportAnalytic() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::UnityEditor::Analytics::AssetExportAnalytic*>(), { "CreateAssetExportAnalytic", {}, {} })));
