...
public:
  ...
  /// @brief Method CreateCollabOperationAnalytic, addr 0x6e24e5c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e24de4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CollabOperationAnalytic", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CollabOperationAnalytic(CollabOperationAnalytic&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CollabOperationAnalytic", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CollabOperationAnalytic(CollabOperationAnalyticconst&) = delete;
