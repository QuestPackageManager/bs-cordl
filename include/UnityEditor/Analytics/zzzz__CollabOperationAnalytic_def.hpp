...
public:
  ...
  /// @brief Method CreateCollabOperationAnalytic, addr 0x6ccbea4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbe2c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
