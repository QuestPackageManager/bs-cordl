...
public:
  ...
  /// @brief Method CreateProjectSettingsInformationAnalytic, addr 0x6ccc2a0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccc228, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
