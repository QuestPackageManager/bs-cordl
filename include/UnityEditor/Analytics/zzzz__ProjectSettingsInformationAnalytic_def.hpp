...
public:
  ...
  /// @brief Method CreateProjectSettingsInformationAnalytic, addr 0x6e21cd0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21c58, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEditor::Analytics::ProjectSettingsInformationAnalytic) == 0x38, "Size mismatch!");
