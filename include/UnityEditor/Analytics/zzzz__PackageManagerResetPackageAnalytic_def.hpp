...
public:
// Declarations
/// @brief Method CreatePackageManagerResetPackageAnalytic, addr 0x6cce4bc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cce428, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
