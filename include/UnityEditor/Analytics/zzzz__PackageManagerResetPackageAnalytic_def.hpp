...
public:
  // Declarations
  /// @brief Method CreatePackageManagerResetPackageAnalytic, addr 0x6c5a03c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c59fa8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
