...
public:
// Declarations
/// @brief Method CreatePackageManagerStartServerPackageAnalytic, addr 0x6c5a8cc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c5a838, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
