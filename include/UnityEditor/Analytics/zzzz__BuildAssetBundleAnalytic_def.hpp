...
public:
  ...
  /// @brief Method CreateBuildAssetBundleAnalytic, addr 0x6ccbdd8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccbd60, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
