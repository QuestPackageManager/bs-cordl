...
public:
  ...
  /// @brief Method CreateBuildAssetBundleAnalytic, addr 0x6e21808, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21790, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::UnityEditor::Analytics::BuildAssetBundleAnalytic) == 0x38, "Size mismatch!");
