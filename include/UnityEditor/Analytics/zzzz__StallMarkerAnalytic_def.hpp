...
public:
  ...
  /// @brief Method CreateStallMarkerAnalytic, addr 0x6cccf14, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccce9c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
