...
public:
  ...
  /// @brief Method CreateNavmeshBakingAnalytic, addr 0x6ccc1d4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccc15c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
