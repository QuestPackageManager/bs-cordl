...
public:
  ...
  /// @brief Method CreateNavmeshBakingAnalytic, addr 0x6e21c04, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e21b8c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
