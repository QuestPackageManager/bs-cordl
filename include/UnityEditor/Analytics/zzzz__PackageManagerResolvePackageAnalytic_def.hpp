...
public:
  ...
  /// @brief Method CreatePackageManagerResolvePackageAnalytic, addr 0x6ccc774, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6ccc6e0, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
