...
constexpr T1& ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_get_First()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___First;
}
template<typename T1,typename T2>
constexpr T1 const& ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_get_First() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___First;
}
template<typename T1,typename T2>
constexpr void ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_set_First(T1  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->___First, value);
}
template<typename T1,typename T2>
constexpr T2& ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_get_Second()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Second;
}
template<typename T1,typename T2>
constexpr T2 const& ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_get_Second() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Second;
}
template<typename T1,typename T2>
constexpr void ModestTree::Util::ValuePair_2<T1,T2>::__cordl_internal_set_Second(T2  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Equals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ModestTree::Util::ValuePair_2<T1,T2>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename T1,typename T2>
constexpr ::ModestTree::Util::ValuePair_2<T1,T2>::ValuePair_2()   {
}
