...
// Write type traits
MARK_REF_T(::ModestTree::Util::PreserveAttribute*);
DEFINE_IL2CPP_CLASS(::ModestTree::Util::PreserveAttribute*, "ModestTree.Util", "PreserveAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e42b30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  PreserveAttribute(PreserveAttributeconst&) = delete;
...
static_assert(sizeof(::ModestTree::Util::PreserveAttribute) == 0x10, "Size mismatch!");
