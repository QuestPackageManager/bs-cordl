...
// Write type traits
MARK_GEN_REF_T_PTR(::ModestTree::Util::ValuePair_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::ModestTree::Util::ValuePair_2, "ModestTree.Util", "ValuePair`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValuePair_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValuePair_2(ValuePair_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValuePair_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValuePair_2(ValuePair_2const&) = delete;
