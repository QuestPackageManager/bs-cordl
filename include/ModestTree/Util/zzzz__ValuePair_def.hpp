...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValuePair", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValuePair(ValuePair&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValuePair", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValuePair(ValuePairconst&) = delete;
