...
// Write type traits
MARK_GEN_REF_T_PTR(::ModestTree::Util::ValuePair_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::ModestTree::Util::ValuePair_3, "ModestTree.Util", "ValuePair`3");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ValuePair_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ValuePair_3(ValuePair_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ValuePair_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ValuePair_3(ValuePair_3const&) = delete;
