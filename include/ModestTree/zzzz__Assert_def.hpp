...
public:
  // Declarations
  /// @brief Method That addr 0x2eba9d0 size 0x38 virtual false final false
  static inline void That(bool condition);

  /// @brief Method IsNotEmpty addr 0x2ebaa6c size 0x44 virtual false final false
  ...
  /// @brief Method DerivesFrom addr 0x2ebaab0 size 0x138 virtual false final false
  static inline void DerivesFrom(::System::Type* childType, ::System::Type* parentType);

  /// @brief Method DerivesFromOrEqual addr 0x2ebad1c size 0x138 virtual false final false
  static inline void DerivesFromOrEqual(::System::Type* childType, ::System::Type* parentType);

  /// @brief Method IsEqual addr 0x2ebaef4 size 0x58 virtual false final false
  static inline void IsEqual(::System::Object* left, ::System::Object* right);

  /// @brief Method IsEqual addr 0x2ebb058 size 0x12c virtual false final false
  static inline void IsEqual(::System::Object* left, ::System::Object* right, ::System::Func_1<::StringW>* messageGenerator);

  /// @brief Method IsApproximately addr 0x2ebb184 size 0x13c virtual false final false
  static inline void IsApproximately(float_t left, float_t right, float_t epsilon);

  /// @brief Method IsEqual addr 0x2ebaf4c size 0x10c virtual false final false
  static inline void IsEqual(::System::Object* left, ::System::Object* right, ::StringW message);

  /// @brief Method IsNotEqual addr 0x2ebb2c0 size 0x58 virtual false final false
  static inline void IsNotEqual(::System::Object* left, ::System::Object* right);

  /// @brief Method IsNotEqual addr 0x2ebb3f4 size 0x12c virtual false final false
  static inline void IsNotEqual(::System::Object* left, ::System::Object* right, ::System::Func_1<::StringW>* messageGenerator);

  /// @brief Method IsNull addr 0x2ebb520 size 0x80 virtual false final false
  static inline void IsNull(::System::Object* val);

  /// @brief Method IsNull addr 0x2ebb5a0 size 0x7c virtual false final false
  static inline void IsNull(::System::Object* val, ::StringW message);

  /// @brief Method IsNull addr 0x2ebb61c size 0xd0 virtual false final false
  static inline void IsNull(::System::Object* val, ::StringW message, ::System::Object* p1);

  /// @brief Method IsNotNull addr 0x2ebb8a0 size 0x38 virtual false final false
  static inline void IsNotNull(::System::Object* val);

  /// @brief Method IsNotNull addr 0x2ebb8d8 size 0x7c virtual false final false
  static inline void IsNotNull(::System::Object* val, ::StringW message);

  /// @brief Method IsNotNull addr 0x2ebb954 size 0xd0 virtual false final false
  static inline void IsNotNull(::System::Object* val, ::StringW message, ::System::Object* p1);

  /// @brief Method IsNotNull addr 0x2ebba24 size 0xf8 virtual false final false
  ...
  /// @brief Method IsNotEqual addr 0x2ebb318 size 0xdc virtual false final false
  static inline void IsNotEqual(::System::Object* left, ::System::Object* right, ::StringW message);

  /// @brief Method Warn addr 0x2ebbb1c size 0xac virtual false final false
  static inline void Warn(bool condition);

  /// @brief Method Warn addr 0x2ebbc40 size 0xe8 virtual false final false
  static inline void Warn(bool condition, ::System::Func_1<::StringW>* messageGenerator);

  /// @brief Method That addr 0x2ebbd28 size 0x48 virtual false final false
  static inline void That(bool condition, ::StringW message);

  /// @brief Method That addr 0x2ebbd70 size 0x98 virtual false final false
  static inline void That(bool condition, ::StringW message, ::System::Object* p1);

  /// @brief Method That addr 0x2ebbe08 size 0xc4 virtual false final false
  static inline void That(bool condition, ::StringW message, ::System::Object* p1, ::System::Object* p2);

  /// @brief Method That addr 0x2ebbecc size 0xec virtual false final false
  static inline void That(bool condition, ::StringW message, ::System::Object* p1, ::System::Object* p2, ::System::Object* p3);

  /// @brief Method Warn addr 0x2ebbfb8 size 0xd0 virtual false final false
  static inline void Warn(bool condition, ::StringW message);

  /// @brief Method Throws addr 0x2ebc088 size 0x48 virtual false final false
  ...
  /// @brief Method CreateException addr 0x2ebc0d0 size 0x74 virtual false final false
  static inline ::Zenject::ZenjectException* CreateException();

  /// @brief Method CreateException addr 0x2ebaa08 size 0x64 virtual false final false
  static inline ::Zenject::ZenjectException* CreateException(::StringW message);

  /// @brief Method CreateException addr 0x2ebac98 size 0x84 virtual false final false
  ...
  /// @brief Method CreateException addr 0x2ebc144 size 0x8c virtual false final false
