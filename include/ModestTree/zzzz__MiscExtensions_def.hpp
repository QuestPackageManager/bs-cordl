...
public:
  ...
  /// @brief Method Fmt, addr 0x6ce5cc4, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x6ce6b30, size 0x68, virtual false, abstract: false, final false
