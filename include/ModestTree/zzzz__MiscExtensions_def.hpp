...
public:
  ...
  /// @brief Method Fmt, addr 0x4af7ef8, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x4af8d00, size 0x64, virtual false, abstract: false, final false
