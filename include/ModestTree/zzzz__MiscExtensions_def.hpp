...
public:
  ...
  /// @brief Method Fmt, addr 0x4aeeb1c, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x4aef924, size 0x64, virtual false, abstract: false, final false
