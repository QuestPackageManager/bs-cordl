...
public:
  ...
  /// @brief Method Fmt, addr 0x6e3bb40, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Join, addr 0x6e3c9ac, size 0x68, virtual false, abstract: false, final false
