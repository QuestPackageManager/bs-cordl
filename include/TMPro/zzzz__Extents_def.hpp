...
public:
  ...
  /// @brief Method ToString, addr 0x47d30ac, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x47d30a0, size 0xc, virtual false, abstract: false, final false
