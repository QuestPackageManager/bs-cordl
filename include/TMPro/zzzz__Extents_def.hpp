...
public:
  ...
  /// @brief Method ToString, addr 0x47ca07c, size 0x1a0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x47ca070, size 0xc, virtual false, abstract: false, final false
