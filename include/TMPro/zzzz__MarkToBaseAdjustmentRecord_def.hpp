...
public:
  ...
  /// @brief Method get_baseGlyphAnchorPoint, addr 0x67f1a6c, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::GlyphAnchorPoint get_baseGlyphAnchorPoint();

  /// @brief Method get_baseGlyphID, addr 0x67f1a5c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_baseGlyphID();

  /// @brief Method get_markGlyphID, addr 0x67f1a7c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_markGlyphID();

  /// @brief Method get_markPositionAdjustment, addr 0x67f1a8c, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::MarkPositionAdjustment get_markPositionAdjustment();

  /// @brief Method set_baseGlyphAnchorPoint, addr 0x67f1a74, size 0x8, virtual false, abstract: false, final false
  inline void set_baseGlyphAnchorPoint(::TMPro::GlyphAnchorPoint value);

  /// @brief Method set_baseGlyphID, addr 0x67f1a64, size 0x8, virtual false, abstract: false, final false
  inline void set_baseGlyphID(uint32_t value);

  /// @brief Method set_markGlyphID, addr 0x67f1a84, size 0x8, virtual false, abstract: false, final false
  inline void set_markGlyphID(uint32_t value);

  /// @brief Method set_markPositionAdjustment, addr 0x67f1a94, size 0x8, virtual false, abstract: false, final false
