...
public:
// Declarations
/// @brief Method .ctor, addr 0x67e33a8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method AddFontAsset, addr 0x67e2dc8, size 0x5e0, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method ClearFontAssetGlyphCache, addr 0x67e36a0, size 0x50, virtual false, abstract: false, final false
static inline void ClearFontAssetGlyphCache() ;

/// @brief Method GetTextSettings, addr 0x67e2cb0, size 0x118, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> GetTextSettings() ;

static inline ::TMPro::TMP_ResourceManager* New_ctor() ;

/// @brief Method RebuildFontAssetCache, addr 0x67e36f0, size 0x4ec, virtual false, abstract: false, final false
static inline void RebuildFontAssetCache() ;

/// @brief Method RemoveFontAsset, addr 0x67e33c8, size 0x17c, virtual false, abstract: false, final false
static inline void RemoveFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method TryGetFontAssetByFamilyName, addr 0x67e35e0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method TryGetFontAssetByName, addr 0x67e3544, size 0x9c, virtual false, abstract: false, final false
static inline bool TryGetFontAssetByName(int32_t  nameHashcode, ::ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method .ctor, addr 0x67e3bdc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
