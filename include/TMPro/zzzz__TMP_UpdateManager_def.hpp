...
public:
  ...
  /// @brief Method get_instance addr 0x2ac90cc size 0xa8 virtual false final false
  static inline ::TMPro::TMP_UpdateManager* get_instance();

  static inline ::TMPro::TMP_UpdateManager* New_ctor();

  /// @brief Method .ctor addr 0x2ac9174 size 0x1cc virtual false final false
  inline void _ctor();

  /// @brief Method RegisterTextObjectForUpdate addr 0x2ac9340 size 0x60 virtual false final false
  static inline void RegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method InternalRegisterTextObjectForUpdate addr 0x2ac93a0 size 0x114 virtual false final false
  inline void InternalRegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method RegisterTextElementForLayoutRebuild addr 0x2ac94b4 size 0x60 virtual false final false
  static inline void RegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForLayoutRebuild addr 0x2ac9514 size 0x114 virtual false final false
  inline void InternalRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForGraphicRebuild addr 0x2ac9628 size 0x60 virtual false final false
  static inline void RegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForGraphicRebuild addr 0x2ac9688 size 0x114 virtual false final false
  inline void InternalRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForCullingUpdate addr 0x2ac979c size 0x60 virtual false final false
  static inline void RegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForCullingUpdate addr 0x2ac97fc size 0x114 virtual false final false
  inline void InternalRegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method OnCameraPreCull addr 0x2ac9910 size 0x4 virtual false final false
  inline void OnCameraPreCull();

  /// @brief Method DoRebuilds addr 0x2ac9914 size 0x254 virtual false final false
  inline void DoRebuilds();

  /// @brief Method UnRegisterTextObjectForUpdate addr 0x2ac9b68 size 0x60 virtual false final false
  static inline void UnRegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method UnRegisterTextElementForRebuild addr 0x2ac9c60 size 0x80 virtual false final false
  static inline void UnRegisterTextElementForRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextElementForGraphicRebuild addr 0x2ac9ce0 size 0x98 virtual false final false
  inline void InternalUnRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextElementForLayoutRebuild addr 0x2ac9d78 size 0x98 virtual false final false
  inline void InternalUnRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextObjectForUpdate addr 0x2ac9bc8 size 0x98 virtual false final false
