...
public:
  ...
  /// @brief Method DoRebuilds, addr 0x3177f90, size 0x254, virtual false, abstract: false, final false
  inline void DoRebuilds();

  /// @brief Method InternalRegisterTextElementForCullingUpdate, addr 0x3177e78, size 0x114, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForGraphicRebuild, addr 0x3177d04, size 0x114, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextElementForLayoutRebuild, addr 0x3177b90, size 0x114, virtual false, abstract: false, final false
  inline void InternalRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalRegisterTextObjectForUpdate, addr 0x3177a1c, size 0x114, virtual false, abstract: false, final false
  inline void InternalRegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method InternalUnRegisterTextElementForGraphicRebuild, addr 0x317835c, size 0x98, virtual false, abstract: false, final false
  inline void InternalUnRegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextElementForLayoutRebuild, addr 0x31783f4, size 0x98, virtual false, abstract: false, final false
  inline void InternalUnRegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method InternalUnRegisterTextObjectForUpdate, addr 0x3178244, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method OnCameraPreCull, addr 0x3177f8c, size 0x4, virtual false, abstract: false, final false
  inline void OnCameraPreCull();

  /// @brief Method RegisterTextElementForCullingUpdate, addr 0x3177e18, size 0x60, virtual false, abstract: false, final false
  static inline void RegisterTextElementForCullingUpdate(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForGraphicRebuild, addr 0x3177ca4, size 0x60, virtual false, abstract: false, final false
  static inline void RegisterTextElementForGraphicRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextElementForLayoutRebuild, addr 0x3177b30, size 0x60, virtual false, abstract: false, final false
  static inline void RegisterTextElementForLayoutRebuild(::TMPro::TMP_Text* element);

  /// @brief Method RegisterTextObjectForUpdate, addr 0x31779bc, size 0x60, virtual false, abstract: false, final false
  static inline void RegisterTextObjectForUpdate(::TMPro::TMP_Text* textObject);

  /// @brief Method UnRegisterTextElementForRebuild, addr 0x31782dc, size 0x80, virtual false, abstract: false, final false
  static inline void UnRegisterTextElementForRebuild(::TMPro::TMP_Text* element);

  /// @brief Method UnRegisterTextObjectForUpdate, addr 0x31781e4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31777f0, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_instance, addr 0x3177748, size 0xa8, virtual false, abstract: false, final false
