...
/// @brief Method Approximately, addr 0x67916d4, size 0x28, virtual false, abstract: false, final false
static inline bool Approximately(float_t  a, float_t  b) ;

/// @brief Method Mod, addr 0x67916fc, size 0x14, virtual false, abstract: false, final false
