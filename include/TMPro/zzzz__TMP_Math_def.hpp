...
public:
  ...
  /// @brief Method Approximately, addr 0x68036e0, size 0x28, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method Mod, addr 0x6803708, size 0x14, virtual false, abstract: false, final false
