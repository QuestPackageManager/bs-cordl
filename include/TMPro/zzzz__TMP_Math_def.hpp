...
public:
  ...
  /// @brief Method Approximately, addr 0x6943d3c, size 0x28, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method Mod, addr 0x6943d64, size 0x14, virtual false, abstract: false, final false
