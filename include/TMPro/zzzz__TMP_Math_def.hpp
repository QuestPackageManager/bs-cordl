...
public:
  ...
  /// @brief Method Approximately, addr 0x6949554, size 0x28, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b);

  /// @brief Method Mod, addr 0x694957c, size 0x14, virtual false, abstract: false, final false
