...
public:
  ...
  /// @brief Method .ctor, addr 0x6857b50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetCharacters, addr 0x6857b54, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::HashSet_1<uint32_t>* GetCharacters(::UnityEngine::TextAsset* file);

  /// @brief Method GetFontAsset, addr 0x6857910, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_FontAsset> GetFontAsset();

  /// @brief Method GetSettings, addr 0x6857858, size 0xb8, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_Settings> GetSettings();

  /// @brief Method GetSpriteAsset, addr 0x68579d0, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_SpriteAsset> GetSpriteAsset();

  /// @brief Method GetStyleSheet, addr 0x6857a90, size 0xc0, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_StyleSheet> GetStyleSheet();

  /// @brief Method LoadDefaultSettings, addr 0x685771c, size 0x13c, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_Settings> LoadDefaultSettings();

  /// @brief Method LoadLinebreakingRules, addr 0x6857454, size 0x16c, virtual false, abstract: false, final false
  static inline void LoadLinebreakingRules();

  static inline ::TMPro::TMP_Settings* New_ctor();

  /// @brief Method SetAssetVersion, addr 0x6856098, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6857c48, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_autoSizeTextContainer, addr 0x6856b5c, size 0x60, virtual false, abstract: false, final false
  static inline bool get_autoSizeTextContainer();

  /// @brief Method get_clearDynamicDataOnBuild, addr 0x6856798, size 0x60, virtual false, abstract: false, final false
  static inline bool get_clearDynamicDataOnBuild();

  /// @brief Method get_defaultColorGradientPresetsPath, addr 0x685717c, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW get_defaultColorGradientPresetsPath();

  /// @brief Method get_defaultFontAsset, addr 0x6856858, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_FontAsset> get_defaultFontAsset();

  /// @brief Method get_defaultFontAssetPath, addr 0x685691c, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW get_defaultFontAssetPath();

  /// @brief Method get_defaultFontSize, addr 0x685697c, size 0x60, virtual false, abstract: false, final false
  static inline float_t get_defaultFontSize();

  /// @brief Method get_defaultSpriteAsset, addr 0x6856e08, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_SpriteAsset> get_defaultSpriteAsset();

  /// @brief Method get_defaultSpriteAssetPath, addr 0x6856ecc, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW get_defaultSpriteAssetPath();

  /// @brief Method get_defaultStyleSheet, addr 0x68571dc, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_StyleSheet> get_defaultStyleSheet();

  /// @brief Method get_defaultTextAutoSizingMaxRatio, addr 0x6856a3c, size 0x60, virtual false, abstract: false, final false
  static inline float_t get_defaultTextAutoSizingMaxRatio();

  /// @brief Method get_defaultTextAutoSizingMinRatio, addr 0x68569dc, size 0x60, virtual false, abstract: false, final false
  static inline float_t get_defaultTextAutoSizingMinRatio();

  /// @brief Method get_defaultTextMeshProTextContainerSize, addr 0x6856a9c, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 get_defaultTextMeshProTextContainerSize();

  /// @brief Method get_defaultTextMeshProUITextContainerSize, addr 0x6856afc, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 get_defaultTextMeshProUITextContainerSize();

  /// @brief Method get_emojiFallbackTextAssets, addr 0x68570b8, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_Asset>>* get_emojiFallbackTextAssets();

  /// @brief Method get_enableEmojiSupport, addr 0x6856f2c, size 0x60, virtual false, abstract: false, final false
  static inline bool get_enableEmojiSupport();

  /// @brief Method get_enableExtraPadding, addr 0x68564f4, size 0x60, virtual false, abstract: false, final false
  static inline bool get_enableExtraPadding();

  /// @brief Method get_enableKerning, addr 0x68563c8, size 0xcc, virtual false, abstract: false, final false
  static inline bool get_enableKerning();

  /// @brief Method get_enableParseEscapeCharacters, addr 0x68565b4, size 0x60, virtual false, abstract: false, final false
  static inline bool get_enableParseEscapeCharacters();

  /// @brief Method get_enableRaycastTarget, addr 0x6856614, size 0x60, virtual false, abstract: false, final false
  static inline bool get_enableRaycastTarget();

  /// @brief Method get_enableTintAllSprites, addr 0x6856554, size 0x60, virtual false, abstract: false, final false
  static inline bool get_enableTintAllSprites();

  /// @brief Method get_fallbackFontAssets, addr 0x6856c84, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>* get_fallbackFontAssets();

  /// @brief Method get_followingCharacters, addr 0x6857360, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextAsset> get_followingCharacters();

  /// @brief Method get_fontFeatures, addr 0x6856494, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::OTL_FeatureTag>* get_fontFeatures();

  /// @brief Method get_getFontFeaturesAtRuntime, addr 0x6856674, size 0x60, virtual false, abstract: false, final false
  static inline bool get_getFontFeaturesAtRuntime();

  /// @brief Method get_hideSubTextObjects, addr 0x6856da8, size 0x60, virtual false, abstract: false, final false
  static inline bool get_hideSubTextObjects();

  /// @brief Method get_instance, addr 0x685615c, size 0x26c, virtual false, abstract: false, final false
  static inline ::UnityW<::TMPro::TMP_Settings> get_instance();

  /// @brief Method get_isTMPSettingsNull, addr 0x6857688, size 0x94, virtual false, abstract: false, final false
  static inline bool get_isTMPSettingsNull();

  /// @brief Method get_isTextObjectScaleStatic, addr 0x6856bbc, size 0x60, virtual false, abstract: false, final false
  static inline bool get_isTextObjectScaleStatic();

  /// @brief Method get_leadingCharacters, addr 0x6857300, size 0x60, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::TextAsset> get_leadingCharacters();

  /// @brief Method get_linebreakingRules, addr 0x68573c0, size 0x94, virtual false, abstract: false, final false
  static inline ::TMPro::TMP_Settings_LineBreakingTable* get_linebreakingRules();

  /// @brief Method get_matchMaterialPreset, addr 0x6856d48, size 0x60, virtual false, abstract: false, final false
  static inline bool get_matchMaterialPreset();

  /// @brief Method get_missingCharacterSpriteUnicode, addr 0x6856ff4, size 0x60, virtual false, abstract: false, final false
  static inline uint32_t get_missingCharacterSpriteUnicode();

  /// @brief Method get_missingGlyphCharacter, addr 0x68566d4, size 0x60, virtual false, abstract: false, final false
  static inline int32_t get_missingGlyphCharacter();

  /// @brief Method get_styleSheetsResourcePath, addr 0x68572a0, size 0x60, virtual false, abstract: false, final false
  static inline ::StringW get_styleSheetsResourcePath();

  /// @brief Method get_textWrappingMode, addr 0x68560fc, size 0x60, virtual false, abstract: false, final false
  static inline ::TMPro::TextWrappingModes get_textWrappingMode();

  /// @brief Method get_useModernHangulLineBreakingRules, addr 0x68575c0, size 0x60, virtual false, abstract: false, final false
  static inline bool get_useModernHangulLineBreakingRules();

  /// @brief Method get_version, addr 0x6856054, size 0x44, virtual false, abstract: false, final false
  static inline ::StringW get_version();

  /// @brief Method get_warningsDisabled, addr 0x68567f8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method set_defaultFontAsset, addr 0x68568b8, size 0x64, virtual false, abstract: false, final false
  static inline void set_defaultFontAsset(::TMPro::TMP_FontAsset* value);

  /// @brief Method set_defaultSpriteAsset, addr 0x6856e68, size 0x64, virtual false, abstract: false, final false
  static inline void set_defaultSpriteAsset(::TMPro::TMP_SpriteAsset* value);

  /// @brief Method set_defaultStyleSheet, addr 0x685723c, size 0x64, virtual false, abstract: false, final false
  static inline void set_defaultStyleSheet(::TMPro::TMP_StyleSheet* value);

  /// @brief Method set_emojiFallbackTextAssets, addr 0x6857118, size 0x64, virtual false, abstract: false, final false
  static inline void set_emojiFallbackTextAssets(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_Asset>>* value);

  /// @brief Method set_enableEmojiSupport, addr 0x6856f8c, size 0x68, virtual false, abstract: false, final false
  static inline void set_enableEmojiSupport(bool value);

  /// @brief Method set_fallbackFontAssets, addr 0x6856ce4, size 0x64, virtual false, abstract: false, final false
  static inline void set_fallbackFontAssets(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>* value);

  /// @brief Method set_isTextObjectScaleStatic, addr 0x6856c1c, size 0x68, virtual false, abstract: false, final false
  static inline void set_isTextObjectScaleStatic(bool value);

  /// @brief Method set_missingCharacterSpriteUnicode, addr 0x6857054, size 0x64, virtual false, abstract: false, final false
  static inline void set_missingCharacterSpriteUnicode(uint32_t value);

  /// @brief Method set_missingGlyphCharacter, addr 0x6856734, size 0x64, virtual false, abstract: false, final false
  static inline void set_missingGlyphCharacter(int32_t value);

  /// @brief Method set_useModernHangulLineBreakingRules, addr 0x6857620, size 0x68, virtual false, abstract: false, final false
