...
public:
  // Declarations
  /// @brief Method Clone, addr 0x695721c, size 0x70, virtual false, abstract: false, final false
  static inline ::TMPro::TMP_Glyph* Clone(::TMPro::TMP_Glyph* source);

  static inline ::TMPro::TMP_Glyph* New_ctor();

  /// @brief Method .ctor, addr 0x695728c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
