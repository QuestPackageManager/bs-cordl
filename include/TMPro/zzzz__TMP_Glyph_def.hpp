...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TMP_Glyph", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TMP_Glyph(TMP_Glyph&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TMP_Glyph", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TMP_Glyph(TMP_Glyphconst&) = delete;
