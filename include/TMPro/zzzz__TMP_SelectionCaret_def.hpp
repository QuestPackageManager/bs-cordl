...
public:
  // Declarations
  /// @brief Method Cull, addr 0x2c3faf4, size 0xd0, virtual true, abstract: false, final false
  inline void Cull(::UnityEngine::Rect clipRect, bool validRect);

  /// @brief Method UpdateGeometry, addr 0x2c3fbc4, size 0x4, virtual true, abstract: false, final false
  inline void UpdateGeometry();

  static inline ::TMPro::TMP_SelectionCaret* New_ctor();

  /// @brief Method .ctor, addr 0x2c3fbc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
