...
/// @brief Method get_componentGlyphIDs, addr 0x677faf0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t,::Array<uint32_t>*> get_componentGlyphIDs() ;

/// @brief Method get_ligatureGlyphID, addr 0x677fb00, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_ligatureGlyphID() ;

/// @brief Method op_Equality, addr 0x677fb10, size 0x78, virtual false, abstract: false, final false
static inline bool op_Equality(::TMPro::LigatureSubstitutionRecord  lhs, ::TMPro::LigatureSubstitutionRecord  rhs) ;

/// @brief Method op_Inequality, addr 0x677fb88, size 0x18, virtual false, abstract: false, final false
static inline bool op_Inequality(::TMPro::LigatureSubstitutionRecord  lhs, ::TMPro::LigatureSubstitutionRecord  rhs) ;

/// @brief Method set_componentGlyphIDs, addr 0x677faf8, size 0x8, virtual false, abstract: false, final false
inline void set_componentGlyphIDs(::ArrayW<uint32_t,::Array<uint32_t>*>  value) ;

/// @brief Method set_ligatureGlyphID, addr 0x677fb08, size 0x8, virtual false, abstract: false, final false
