...
// Write type traits
MARK_GEN_REF_T_PTR(::TMPro::FastAction_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::TMPro::FastAction_2, "TMPro", "FastAction`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FastAction_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FastAction_2(FastAction_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FastAction_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FastAction_2(FastAction_2const&) = delete;
