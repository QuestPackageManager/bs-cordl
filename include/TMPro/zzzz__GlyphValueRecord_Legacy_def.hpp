...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6816c94, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphValueRecord valueRecord);

  /// @brief Method op_Addition, addr 0x6816ca0, size 0x14, virtual false, abstract: false, final false
