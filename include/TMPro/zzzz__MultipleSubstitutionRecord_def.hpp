...
public:
  ...
  /// @brief Method get_substituteGlyphIDs, addr 0x6932148, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t> get_substituteGlyphIDs();

  /// @brief Method get_targetGlyphID, addr 0x6932138, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_targetGlyphID();

  /// @brief Method set_substituteGlyphIDs, addr 0x6932150, size 0x8, virtual false, abstract: false, final false
  inline void set_substituteGlyphIDs(::ArrayW<uint32_t> value);

  /// @brief Method set_targetGlyphID, addr 0x6932140, size 0x8, virtual false, abstract: false, final false
