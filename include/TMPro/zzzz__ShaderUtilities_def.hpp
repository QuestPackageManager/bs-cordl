...
public:
  ...
  /// @brief Method ComputePaddingForProperties, addr 0x6858ef8, size 0x2f4, virtual false, abstract: false, final false
  static inline float_t ComputePaddingForProperties(::UnityEngine::Material* mat);

  /// @brief Method GetFontExtent, addr 0x6858570, size 0x50, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 GetFontExtent(::UnityEngine::Material* material);

  /// @brief Method GetPadding, addr 0x685875c, size 0x79c, virtual false, abstract: false, final false
  static inline float_t GetPadding(::UnityEngine::Material* material, bool enableExtraPadding, bool isBold);

  /// @brief Method GetPadding, addr 0x68591ec, size 0x838, virtual false, abstract: false, final false
  ...
  /// @brief Method GetShaderPropertyIDs, addr 0x684f258, size 0xdc4, virtual false, abstract: false, final false
  static inline void GetShaderPropertyIDs();

  /// @brief Method IsMaskingEnabled, addr 0x68585c0, size 0x19c, virtual false, abstract: false, final false
  static inline bool IsMaskingEnabled(::UnityEngine::Material* material);

  /// @brief Method UpdateShaderRatios, addr 0x6858144, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShaderRef_MobileBitmap, addr 0x6857ebc, size 0x108, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap();

  /// @brief Method get_ShaderRef_MobileSDF, addr 0x6857db4, size 0x108, virtual false, abstract: false, final false
