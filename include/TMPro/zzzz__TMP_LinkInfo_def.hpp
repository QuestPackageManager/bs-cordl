...
public:
  // Declarations
  /// @brief Method GetLink, addr 0x680399c, size 0x4, virtual false, abstract: false, final false
  inline ::StringW GetLink();

  /// @brief Method GetLinkID, addr 0x68039a0, size 0x94, virtual false, abstract: false, final false
  inline ::StringW GetLinkID();

  /// @brief Method GetLinkText, addr 0x68038c0, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW GetLinkText();

  /// @brief Method SetLinkID, addr 0x68037d4, size 0xec, virtual false, abstract: false, final false
