...
public:
  // Declarations
  /// @brief Method GetLink, addr 0x6949810, size 0x4, virtual false, abstract: false, final false
  inline ::StringW GetLink();

  /// @brief Method GetLinkID, addr 0x6949814, size 0x94, virtual false, abstract: false, final false
  inline ::StringW GetLinkID();

  /// @brief Method GetLinkText, addr 0x6949734, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW GetLinkText();

  /// @brief Method SetLinkID, addr 0x6949648, size 0xec, virtual false, abstract: false, final false
