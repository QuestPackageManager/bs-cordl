...
public:
// Declarations
/// @brief Method GetLink, addr 0x6791990, size 0x4, virtual false, abstract: false, final false
inline ::StringW GetLink() ;

/// @brief Method GetLinkID, addr 0x6791994, size 0x94, virtual false, abstract: false, final false
inline ::StringW GetLinkID() ;

/// @brief Method GetLinkText, addr 0x67918b4, size 0xdc, virtual false, abstract: false, final false
inline ::StringW GetLinkText() ;

/// @brief Method SetLinkID, addr 0x67917c8, size 0xec, virtual false, abstract: false, final false
