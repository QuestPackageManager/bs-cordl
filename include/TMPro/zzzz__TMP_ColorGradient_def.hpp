...
public:
  ...
  /// @brief Method .ctor, addr 0x47d3c84, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x47d3d20, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x47d3d8c, size 0xa4, virtual false, abstract: false, final false
