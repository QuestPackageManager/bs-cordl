...
public:
  ...
  /// @brief Method .ctor, addr 0x312c7e0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x312c87c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x312c8e8, size 0xa4, virtual false, abstract: false, final false
