...
public:
  ...
  /// @brief Method <SortGlyphPairAdjustmentRecords>b__6_0, addr 0x47e3ca0, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_0(::TMPro::TMP_GlyphPairAdjustmentRecord* s);

  /// @brief Method <SortGlyphPairAdjustmentRecords>b__6_1, addr 0x47e3cb8, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_1(::TMPro::TMP_GlyphPairAdjustmentRecord* s);

  /// @brief Method .ctor, addr 0x47e3c98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SortGlyphPairAdjustmentRecords, addr 0x47dbe14, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47e0940, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_glyphPairAdjustmentRecords, addr 0x47e3c2c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::TMPro::TMP_GlyphPairAdjustmentRecord*>* get_glyphPairAdjustmentRecords();

  /// @brief Method set_glyphPairAdjustmentRecords, addr 0x47e3c34, size 0x8, virtual false, abstract: false, final false
