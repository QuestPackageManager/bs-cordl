...
public:
  ...
  /// @brief Method .ctor, addr 0x69921a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6990678, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMaskingMaterial>b__0, addr 0x6992b0c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6990d4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveStencilMaterial>b__0, addr 0x6992b88, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6990ebc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ReleaseBaseMaterial>b__0, addr 0x6992c04, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69913a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBaseMaterial>b__0, addr 0x6992c80, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6990a18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddFallbackMaterialReference, addr 0x69925c8, size 0x154, virtual false, abstract: false, final false
  static inline void AddFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method AddMaskingMaterial, addr 0x6990ad4, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupFallbackMaterials, addr 0x698f2ac, size 0x254, virtual false, abstract: false, final false
  static inline void CleanupFallbackMaterials();

  /// @brief Method ClearMaterials, addr 0x69913a4, size 0x1fc, virtual false, abstract: false, final false
  static inline void ClearMaterials();

  /// @brief Method CopyMaterialPresetProperties, addr 0x6991f4c, size 0x254, virtual false, abstract: false, final false
  static inline void CopyMaterialPresetProperties(::UnityEngine::Material* source, ::UnityEngine::Material* destination);

  /// @brief Method FindRootSortOverrideCanvas, addr 0x6991888, size 0x1c0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetBaseMaterial, addr 0x69908a8, size 0x170, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBaseMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method GetFallbackMaterial, addr 0x6991c68, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x69921a4, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialForRendering, addr 0x6991a48, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilID, addr 0x69915a0, size 0x2e8, virtual false, abstract: false, final false
  static inline int32_t GetStencilID(::UnityEngine::GameObject* obj);

  /// @brief Method GetStencilMaterial, addr 0x698f500, size 0x3b4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetStencilMaterial(::UnityEngine::Material* baseMaterial, int32_t stencilID);

  /// @brief Method OnPreRender, addr 0x698f230, size 0x7c, virtual false, abstract: false, final false
  static inline void OnPreRender();

  /// @brief Method ReleaseBaseMaterial, addr 0x6990ec0, size 0x4e0, virtual false, abstract: false, final false
  static inline void ReleaseBaseMaterial(::UnityEngine::Material* baseMaterial);

  /// @brief Method ReleaseFallbackMaterial, addr 0x6992908, size 0x204, virtual false, abstract: false, final false
  static inline void ReleaseFallbackMaterial(::UnityEngine::Material* fallbackMaterial);

  /// @brief Method ReleaseStencilMaterial, addr 0x699067c, size 0x22c, virtual false, abstract: false, final false
  static inline void ReleaseStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method RemoveFallbackMaterialReference, addr 0x699271c, size 0x1ec, virtual false, abstract: false, final false
  static inline void RemoveFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method RemoveStencilMaterial, addr 0x6990d50, size 0x16c, virtual false, abstract: false, final false
  static inline void RemoveStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method SetStencil, addr 0x6990a1c, size 0xb8, virtual false, abstract: false, final false
