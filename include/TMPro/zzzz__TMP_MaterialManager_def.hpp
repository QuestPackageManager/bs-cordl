...
public:
  ...
  /// @brief Method .ctor, addr 0x316bd84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x316a2e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBaseMaterial>b__0, addr 0x316c6b8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316a648, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMaskingMaterial>b__0, addr 0x316c728, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316a980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveStencilMaterial>b__0, addr 0x316c798, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316aae8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ReleaseBaseMaterial>b__0, addr 0x316c808, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316b01c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddFallbackMaterialReference, addr 0x316c1ac, size 0x144, virtual false, abstract: false, final false
  static inline void AddFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method AddMaskingMaterial, addr 0x316a70c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupFallbackMaterials, addr 0x316922c, size 0x214, virtual false, abstract: false, final false
  static inline void CleanupFallbackMaterials();

  /// @brief Method ClearMaterials, addr 0x316b024, size 0x1bc, virtual false, abstract: false, final false
  static inline void ClearMaterials();

  /// @brief Method CopyMaterialPresetProperties, addr 0x316bb18, size 0x26c, virtual false, abstract: false, final false
  static inline void CopyMaterialPresetProperties(::UnityEngine::Material* source, ::UnityEngine::Material* destination);

  /// @brief Method FindRootSortOverrideCanvas, addr 0x316b4ac, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetBaseMaterial, addr 0x316a4e4, size 0x164, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBaseMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method GetFallbackMaterial, addr 0x316b848, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x316bd8c, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialForRendering, addr 0x316b64c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilID, addr 0x316b1e0, size 0x2cc, virtual false, abstract: false, final false
  static inline int32_t GetStencilID(::UnityEngine::GameObject* obj);

  /// @brief Method GetStencilMaterial, addr 0x3169440, size 0x3b4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetStencilMaterial(::UnityEngine::Material* baseMaterial, int32_t stencilID);

  /// @brief Method OnPreRender, addr 0x31691b4, size 0x78, virtual false, abstract: false, final false
  static inline void OnPreRender();

  /// @brief Method ReleaseBaseMaterial, addr 0x316aaf0, size 0x52c, virtual false, abstract: false, final false
  static inline void ReleaseBaseMaterial(::UnityEngine::Material* baseMaterial);

  /// @brief Method ReleaseFallbackMaterial, addr 0x316c4c4, size 0x1f4, virtual false, abstract: false, final false
  static inline void ReleaseFallbackMaterial(::UnityEngine::Material* fallbackMaterial);

  /// @brief Method ReleaseStencilMaterial, addr 0x316a2e8, size 0x1fc, virtual false, abstract: false, final false
  static inline void ReleaseStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method RemoveFallbackMaterialReference, addr 0x316c2f0, size 0x1d4, virtual false, abstract: false, final false
  static inline void RemoveFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method RemoveStencilMaterial, addr 0x316a988, size 0x160, virtual false, abstract: false, final false
  static inline void RemoveStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method SetStencil, addr 0x316a650, size 0xbc, virtual false, abstract: false, final false
