...
public:
  ...
  /// @brief Method .ctor, addr 0x47f9164, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x47f7774, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMaskingMaterial>b__0, addr 0x47f9a94, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47f7dfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveStencilMaterial>b__0, addr 0x47f9b04, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47f7f60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ReleaseBaseMaterial>b__0, addr 0x47f9b74, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47f83fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBaseMaterial>b__0, addr 0x47f9be4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47f7acc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddFallbackMaterialReference, addr 0x47f9590, size 0x144, virtual false, abstract: false, final false
  static inline void AddFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method AddMaskingMaterial, addr 0x47f7b90, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupFallbackMaterials, addr 0x47f66f4, size 0x214, virtual false, abstract: false, final false
  static inline void CleanupFallbackMaterials();

  /// @brief Method ClearMaterials, addr 0x47f8404, size 0x1bc, virtual false, abstract: false, final false
  static inline void ClearMaterials();

  /// @brief Method CopyMaterialPresetProperties, addr 0x47f8ef8, size 0x26c, virtual false, abstract: false, final false
  static inline void CopyMaterialPresetProperties(::UnityEngine::Material* source, ::UnityEngine::Material* destination);

  /// @brief Method FindRootSortOverrideCanvas, addr 0x47f888c, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetBaseMaterial, addr 0x47f796c, size 0x160, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBaseMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method GetFallbackMaterial, addr 0x47f8c28, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x47f916c, size 0x424, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialForRendering, addr 0x47f8a2c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilID, addr 0x47f85c0, size 0x2cc, virtual false, abstract: false, final false
  static inline int32_t GetStencilID(::UnityEngine::GameObject* obj);

  /// @brief Method GetStencilMaterial, addr 0x47f6908, size 0x3a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetStencilMaterial(::UnityEngine::Material* baseMaterial, int32_t stencilID);

  /// @brief Method OnPreRender, addr 0x47f667c, size 0x78, virtual false, abstract: false, final false
  static inline void OnPreRender();

  /// @brief Method ReleaseBaseMaterial, addr 0x47f7f68, size 0x494, virtual false, abstract: false, final false
  static inline void ReleaseBaseMaterial(::UnityEngine::Material* baseMaterial);

  /// @brief Method ReleaseFallbackMaterial, addr 0x47f98a4, size 0x1f0, virtual false, abstract: false, final false
  static inline void ReleaseFallbackMaterial(::UnityEngine::Material* fallbackMaterial);

  /// @brief Method ReleaseStencilMaterial, addr 0x47f777c, size 0x1f0, virtual false, abstract: false, final false
  static inline void ReleaseStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method RemoveFallbackMaterialReference, addr 0x47f96d4, size 0x1d0, virtual false, abstract: false, final false
  static inline void RemoveFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method RemoveStencilMaterial, addr 0x47f7e04, size 0x15c, virtual false, abstract: false, final false
  static inline void RemoveStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method SetStencil, addr 0x47f7ad4, size 0xbc, virtual false, abstract: false, final false
