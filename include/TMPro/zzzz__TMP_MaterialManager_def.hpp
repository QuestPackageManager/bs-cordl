...
public:
  ...
  /// @brief Method .ctor, addr 0x3167d88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x31662e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetBaseMaterial>b__0, addr 0x31686bc, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316664c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddMaskingMaterial>b__0, addr 0x316872c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3166984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveStencilMaterial>b__0, addr 0x316879c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3166aec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ReleaseBaseMaterial>b__0, addr 0x316880c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3167020, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddFallbackMaterialReference, addr 0x31681b0, size 0x144, virtual false, abstract: false, final false
  static inline void AddFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method AddMaskingMaterial, addr 0x3166710, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method CleanupFallbackMaterials, addr 0x3165230, size 0x214, virtual false, abstract: false, final false
  static inline void CleanupFallbackMaterials();

  /// @brief Method ClearMaterials, addr 0x3167028, size 0x1bc, virtual false, abstract: false, final false
  static inline void ClearMaterials();

  /// @brief Method CopyMaterialPresetProperties, addr 0x3167b1c, size 0x26c, virtual false, abstract: false, final false
  static inline void CopyMaterialPresetProperties(::UnityEngine::Material* source, ::UnityEngine::Material* destination);

  /// @brief Method FindRootSortOverrideCanvas, addr 0x31674b0, size 0x1a0, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform* start);

  /// @brief Method GetBaseMaterial, addr 0x31664e8, size 0x164, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetBaseMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method GetFallbackMaterial, addr 0x316784c, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFallbackMaterial, addr 0x3167d90, size 0x420, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaterialForRendering, addr 0x3167650, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetStencilID, addr 0x31671e4, size 0x2cc, virtual false, abstract: false, final false
  static inline int32_t GetStencilID(::UnityEngine::GameObject* obj);

  /// @brief Method GetStencilMaterial, addr 0x3165444, size 0x3b4, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Material> GetStencilMaterial(::UnityEngine::Material* baseMaterial, int32_t stencilID);

  /// @brief Method OnPreRender, addr 0x31651b8, size 0x78, virtual false, abstract: false, final false
  static inline void OnPreRender();

  /// @brief Method ReleaseBaseMaterial, addr 0x3166af4, size 0x52c, virtual false, abstract: false, final false
  static inline void ReleaseBaseMaterial(::UnityEngine::Material* baseMaterial);

  /// @brief Method ReleaseFallbackMaterial, addr 0x31684c8, size 0x1f4, virtual false, abstract: false, final false
  static inline void ReleaseFallbackMaterial(::UnityEngine::Material* fallbackMaterial);

  /// @brief Method ReleaseStencilMaterial, addr 0x31662ec, size 0x1fc, virtual false, abstract: false, final false
  static inline void ReleaseStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method RemoveFallbackMaterialReference, addr 0x31682f4, size 0x1d4, virtual false, abstract: false, final false
  static inline void RemoveFallbackMaterialReference(::UnityEngine::Material* targetMaterial);

  /// @brief Method RemoveStencilMaterial, addr 0x316698c, size 0x160, virtual false, abstract: false, final false
  static inline void RemoveStencilMaterial(::UnityEngine::Material* stencilMaterial);

  /// @brief Method SetStencil, addr 0x3166654, size 0xbc, virtual false, abstract: false, final false
