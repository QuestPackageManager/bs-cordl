...
public:
  ...
  /// @brief Method GetStyle, addr 0x685cacc, size 0x8c, virtual false, abstract: false, final false
  inline ::TMPro::TMP_Style* GetStyle(int32_t hashCode);

  /// @brief Method GetStyle, addr 0x685cb58, size 0xc0, virtual false, abstract: false, final false
  inline ::TMPro::TMP_Style* GetStyle(::StringW name);

  /// @brief Method LoadStyleDictionaryInternal, addr 0x685c760, size 0x36c, virtual false, abstract: false, final false
  inline void LoadStyleDictionaryInternal();

  static inline ::TMPro::TMP_StyleSheet* New_ctor();

  /// @brief Method RefreshStyles, addr 0x685cc18, size 0x4, virtual false, abstract: false, final false
  inline void RefreshStyles();

  /// @brief Method Reset, addr 0x685c75c, size 0x4, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x685cc1c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_styles, addr 0x685c754, size 0x8, virtual false, abstract: false, final false
