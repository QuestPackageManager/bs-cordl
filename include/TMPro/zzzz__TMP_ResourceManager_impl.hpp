...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::TMPro::TMP_ResourceManager_FontAssetRef::*)(int32_t, int32_t, int32_t, ::TMPro::TMP_FontAsset*)>(
  ...
  constexpr static std::size_t addrs = 0x6995a10;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::TMP_ResourceManager_FontAssetRef>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::UnityW<::TMPro::TMP_Settings> (*)()>(&::TMPro::TMP_ResourceManager::GetTextSettings)> {
  ...
  constexpr static std::size_t addrs = 0x6995318;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::TMPro::TMP_FontAsset*)>(&::TMPro::TMP_ResourceManager::AddFontAsset)> {
  ...
  constexpr static std::size_t addrs = 0x6995430;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::TMP_ResourceManager*>(), { "AddFontAsset", {}, { ::i2c::type_of<::TMPro::TMP_FontAsset*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)(::TMPro::TMP_FontAsset*)>(&::TMPro::TMP_ResourceManager::RemoveFontAsset)> {
  ...
  constexpr static std::size_t addrs = 0x6995a30;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::TMP_ResourceManager*>(), { "RemoveFontAsset", {}, { ::i2c::type_of<::TMPro::TMP_FontAsset*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(int32_t, ::by_ref<::TMPro::TMP_FontAsset*>)>(&::TMPro::TMP_ResourceManager::TryGetFontAssetByName)> {
  ...
  constexpr static std::size_t addrs = 0x6995bac;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::TMPro::TMP_ResourceManager*>(), { "TryGetFontAssetByName", {}, { ::i2c::type_of<int32_t>(), ::i2c::type_of<::by_ref<::TMPro::TMP_FontAsset*>>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (*)(int32_t, int32_t, ::by_ref<::TMPro::TMP_FontAsset*>)>(&::TMPro::TMP_ResourceManager::TryGetFontAssetByFamilyName)> {
  ...
  constexpr static std::size_t addrs = 0x6995c48;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::TMP_ResourceManager*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (*)()>(&::TMPro::TMP_ResourceManager::RebuildFontAssetCache)> {
  ...
  constexpr static std::size_t addrs = 0x6995d58;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::TMPro::TMP_ResourceManager::*)()>(&::TMPro::TMP_ResourceManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6996244;
...
inline void TMPro::TMP_ResourceManager::setStaticF_s_FontAssetReferences(::System::Collections::Generic::Dictionary_2<int32_t, ::TMPro::TMP_ResourceManager_FontAssetRef>* value) {
  ::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<int32_t, ::TMPro::TMP_ResourceManager_FontAssetRef>*, "s_FontAssetReferences", ::TMPro::TMP_ResourceManager*>(
...
inline void TMPro::TMP_ResourceManager::setStaticF_s_FontAssetNameReferenceLookup(::System::Collections::Generic::Dictionary_2<int32_t, ::UnityW<::TMPro::TMP_FontAsset>>* value) {
  ::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<int32_t, ::UnityW<::TMPro::TMP_FontAsset>>*, "s_FontAssetNameReferenceLookup", ::TMPro::TMP_ResourceManager*>(
...
inline void TMPro::TMP_ResourceManager::setStaticF_s_FontAssetFamilyNameAndStyleReferenceLookup(::System::Collections::Generic::Dictionary_2<int64_t, ::UnityW<::TMPro::TMP_FontAsset>>* value) {
  ::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<int64_t, ::UnityW<::TMPro::TMP_FontAsset>>*, "s_FontAssetFamilyNameAndStyleReferenceLookup",
                                    ::TMPro::TMP_ResourceManager*>(std::forward<::System::Collections::Generic::Dictionary_2<int64_t, ::UnityW<::TMPro::TMP_FontAsset>>*>(value));
}
...
inline void TMPro::TMP_ResourceManager::setStaticF_s_FontAssetRemovalList(::System::Collections::Generic::List_1<int32_t>* value) {
  ::cordl_internals::setStaticField<::System::Collections::Generic::List_1<int32_t>*, "s_FontAssetRemovalList", ::TMPro::TMP_ResourceManager*>(
