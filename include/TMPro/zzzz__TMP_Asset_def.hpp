...
public:
  ...
  /// @brief Method get_instanceID, addr 0x2bfe220, size 0x28, virtual false, abstract: false, final false
  inline int32_t get_instanceID();

  static inline ::TMPro::TMP_Asset* New_ctor();

  /// @brief Method .ctor, addr 0x2bfe248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
