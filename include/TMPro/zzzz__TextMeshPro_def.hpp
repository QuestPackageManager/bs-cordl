...
public:
  ...
  /// @brief Method Awake, addr 0x67f50d0, size 0x2cc, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateLayoutInputHorizontal, addr 0x67f50c8, size 0x4, virtual true, abstract: false, final true
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x67f50cc, size 0x4, virtual true, abstract: false, final true
  inline void CalculateLayoutInputVertical();

  /// @brief Method ClearMesh, addr 0x67f4ad8, size 0xcc, virtual true, abstract: false, final false
  inline void ClearMesh(bool updateMesh);

  /// @brief Method ComputeMarginSize, addr 0x67f93f0, size 0xe4, virtual true, abstract: false, final false
  inline void ComputeMarginSize();

  /// @brief Method CreateMaterialInstance, addr 0x67f6190, size 0xbc, virtual false, abstract: false, final false
  inline void CreateMaterialInstance();

  /// @brief Method DestroySubMeshObjects, addr 0x67f9d88, size 0xe0, virtual true, abstract: false, final false
  inline void DestroySubMeshObjects();

  /// @brief Method DisableMasking, addr 0x67f6098, size 0xf8, virtual false, abstract: false, final false
  inline void DisableMasking();

  /// @brief Method EnableMasking, addr 0x67f5f18, size 0xfc, virtual false, abstract: false, final false
  inline void EnableMasking();

  /// @brief Method ForceMeshUpdate, addr 0x67f4a5c, size 0x10, virtual true, abstract: false, final false
  inline void ForceMeshUpdate(bool ignoreActiveState, bool forceTextReparsing);

  /// @brief Method GenerateTextMesh, addr 0x67e2cd8, size 0x73b0, virtual true, abstract: false, final false
  inline void GenerateTextMesh();

  /// @brief Method GetCompoundBounds, addr 0x67f9e68, size 0x194, virtual true, abstract: false, final false
  inline ::UnityEngine::Bounds GetCompoundBounds();

  /// @brief Method GetMaterial, addr 0x67f624c, size 0x114, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Material* mat);

  /// @brief Method GetMaterials, addr 0x67f6360, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method GetSharedMaterials, addr 0x67f654c, size 0x18c, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Material>, ::Array<::UnityW<::UnityEngine::Material>>*> GetSharedMaterials();

  /// @brief Method GetTextContainerLocalCorners, addr 0x67f99d4, size 0x9c, virtual true, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetTextContainerLocalCorners();

  /// @brief Method GetTextInfo, addr 0x67f4a6c, size 0x6c, virtual true, abstract: false, final false
  inline ::TMPro::TMP_TextInfo* GetTextInfo(::StringW text);

  /// @brief Method InternalUpdate, addr 0x67f9678, size 0xa8, virtual true, abstract: false, final false
  inline void InternalUpdate();

  /// @brief Method LoadFontAsset, addr 0x67f5618, size 0x5ac, virtual true, abstract: false, final false
  inline void LoadFontAsset();

  static inline ::TMPro::TextMeshPro* New_ctor();

  /// @brief Method OnDestroy, addr 0x67f554c, size 0xcc, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDidApplyAnimationProperties, addr 0x67f94d4, size 0x1c, virtual true, abstract: false, final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnDisable, addr 0x67f549c, size 0xb0, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x67f539c, size 0x100, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPreRenderObject, addr 0x67f45d8, size 0x254, virtual false, abstract: false, final false
  inline void OnPreRenderObject();

  /// @brief Method OnRectTransformDimensionsChange, addr 0x67f9520, size 0x158, virtual true, abstract: false, final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method OnTransformParentChanged, addr 0x67f94f0, size 0x30, virtual true, abstract: false, final false
  inline void OnTransformParentChanged();

  /// @brief Method Rebuild, addr 0x67f44ec, size 0xec, virtual true, abstract: false, final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate update);

  /// @brief Method SetActiveSubMeshes, addr 0x67f9c68, size 0x120, virtual true, abstract: false, final false
  inline void SetActiveSubMeshes(bool state);

  /// @brief Method SetActiveSubTextObjectRenderers, addr 0x67f9894, size 0x140, virtual false, abstract: false, final false
  inline void SetActiveSubTextObjectRenderers(bool state);

  /// @brief Method SetAllDirty, addr 0x67f44a8, size 0x44, virtual true, abstract: false, final false
  inline void SetAllDirty();

  /// @brief Method SetArraySizes, addr 0x67f7174, size 0x227c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCulling, addr 0x67f6df8, size 0x2f0, virtual true, abstract: false, final false
  inline void SetCulling();

  /// @brief Method SetFaceColor, addr 0x67f6b88, size 0x124, virtual true, abstract: false, final false
  inline void SetFaceColor(::UnityEngine::Color32 color);

  /// @brief Method SetLayoutDirty, addr 0x67f43c0, size 0xd8, virtual true, abstract: false, final false
  inline void SetLayoutDirty();

  /// @brief Method SetMask, addr 0x67f3f74, size 0x164, virtual false, abstract: false, final false
  inline void SetMask(::TMPro::MaskingTypes maskType);

  /// @brief Method SetMask, addr 0x67f40d8, size 0x48, virtual false, abstract: false, final false
  inline void SetMask(::TMPro::MaskingTypes type, ::UnityEngine::Vector4 maskCoords);

  /// @brief Method SetMask, addr 0x67f41c0, size 0x60, virtual false, abstract: false, final false
  inline void SetMask(::TMPro::MaskingTypes type, ::UnityEngine::Vector4 maskCoords, float_t softnessX, float_t softnessY);

  /// @brief Method SetMaskCoordinates, addr 0x67f4120, size 0xa0, virtual false, abstract: false, final false
  inline void SetMaskCoordinates(::UnityEngine::Vector4 coords);

  /// @brief Method SetMaskCoordinates, addr 0x67f4220, size 0xe8, virtual false, abstract: false, final false
  inline void SetMaskCoordinates(::UnityEngine::Vector4 coords, float_t softX, float_t softY);

  /// @brief Method SetMaterialDirty, addr 0x67f4498, size 0x10, virtual true, abstract: false, final false
  inline void SetMaterialDirty();

  /// @brief Method SetMeshFilters, addr 0x67f9a70, size 0x1f8, virtual false, abstract: false, final false
  inline void SetMeshFilters(bool state);

  /// @brief Method SetOutlineColor, addr 0x67f6cac, size 0x124, virtual true, abstract: false, final false
  inline void SetOutlineColor(::UnityEngine::Color32 color);

  /// @brief Method SetOutlineThickness, addr 0x67f6a60, size 0x128, virtual true, abstract: false, final false
  inline void SetOutlineThickness(float_t thickness);

  /// @brief Method SetPerspectiveCorrection, addr 0x67f70e8, size 0x8c, virtual false, abstract: false, final false
  inline void SetPerspectiveCorrection();

  /// @brief Method SetShaderDepth, addr 0x67f6dd0, size 0x28, virtual true, abstract: false, final false
  inline void SetShaderDepth();

  /// @brief Method SetSharedMaterial, addr 0x67f6510, size 0x3c, virtual true, abstract: false, final false
  inline void SetSharedMaterial(::UnityEngine::Material* mat);

  /// @brief Method SetSharedMaterials, addr 0x67f66d8, size 0x388, virtual true, abstract: false, final false
  inline void SetSharedMaterials(::ArrayW<::UnityEngine::Material*, ::Array<::UnityEngine::Material*>*> materials);

  /// @brief Method SetVerticesDirty, addr 0x67f4308, size 0xb8, virtual true, abstract: false, final false
  inline void SetVerticesDirty();

  /// @brief Method UpdateEnvMapMatrix, addr 0x67f5cf4, size 0x224, virtual false, abstract: false, final false
  inline void UpdateEnvMapMatrix();

  /// @brief Method UpdateFontAsset, addr 0x67f50b8, size 0x10, virtual false, abstract: false, final false
  inline void UpdateFontAsset();

  /// @brief Method UpdateGeometry, addr 0x67f4d24, size 0x18, virtual true, abstract: false, final false
  inline void UpdateGeometry(::UnityEngine::Mesh* mesh, int32_t index);

  /// @brief Method UpdateMask, addr 0x67f6014, size 0x84, virtual false, abstract: false, final false
  inline void UpdateMask();

  /// @brief Method UpdateMaterial, addr 0x67f482c, size 0x12c, virtual true, abstract: false, final false
  inline void UpdateMaterial();

  /// @brief Method UpdateMeshPadding, addr 0x67f4958, size 0x104, virtual true, abstract: false, final false
  inline void UpdateMeshPadding();

  /// @brief Method UpdateSDFScale, addr 0x67f9720, size 0x174, virtual false, abstract: false, final false
  inline void UpdateSDFScale(float_t scaleDelta);

  /// @brief Method UpdateSubMeshSortingLayerID, addr 0x67f38e0, size 0x110, virtual false, abstract: false, final false
  inline void UpdateSubMeshSortingLayerID(int32_t id);

  /// @brief Method UpdateSubMeshSortingOrder, addr 0x67f3b40, size 0x110, virtual false, abstract: false, final false
  inline void UpdateSubMeshSortingOrder(int32_t order);

  /// @brief Method UpdateVertexData, addr 0x67f4ee0, size 0x1d8, virtual true, abstract: false, final false
  inline void UpdateVertexData();

  /// @brief Method UpdateVertexData, addr 0x67f4d3c, size 0x1a4, virtual true, abstract: false, final false
  inline void UpdateVertexData(::TMPro::TMP_VertexDataUpdateFlags flags);

  /// @brief Method ValidateEnvMapProperty, addr 0x67f5bc4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f9ffc, size 0x138, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnPreRenderText, addr 0x67f4ba4, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method get_autoSizeTextContainer, addr 0x67f3c50, size 0x8, virtual true, abstract: false, final false
  inline bool get_autoSizeTextContainer();

  /// @brief Method get_maskType, addr 0x67f3f64, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::MaskingTypes get_maskType();

  /// @brief Method get_mesh, addr 0x67f3da0, size 0xb8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_meshFilter, addr 0x67f3e58, size 0x10c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter();

  /// @brief Method get_renderer, addr 0x67f378c, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Renderer> get_renderer();

  /// @brief Method get_sortingLayerID, addr 0x67f36f4, size 0x98, virtual false, abstract: false, final false
  inline int32_t get_sortingLayerID();

  /// @brief Method get_sortingOrder, addr 0x67f39f0, size 0x98, virtual false, abstract: false, final false
  inline int32_t get_sortingOrder();

  /// @brief Method get_textContainer, addr 0x67f3cfc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::TMPro::TextContainer> get_textContainer();

  /// @brief Method get_transform, addr 0x67f3d04, size 0x9c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_transform();

  /// @brief Convert to "::UnityEngine::UI::ILayoutElement"
  constexpr ::UnityEngine::UI::ILayoutElement* i___UnityEngine__UI__ILayoutElement() noexcept;

  /// @brief Method remove_OnPreRenderText, addr 0x67f4c64, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method set_autoSizeTextContainer, addr 0x67f3c58, size 0xa4, virtual true, abstract: false, final false
  inline void set_autoSizeTextContainer(bool value);

  /// @brief Method set_maskType, addr 0x67f3f6c, size 0x8, virtual false, abstract: false, final false
  inline void set_maskType(::TMPro::MaskingTypes value);

  /// @brief Method set_sortingLayerID, addr 0x67f3828, size 0xb8, virtual false, abstract: false, final false
  inline void set_sortingLayerID(int32_t value);

  /// @brief Method set_sortingOrder, addr 0x67f3a88, size 0xb8, virtual false, abstract: false, final false
