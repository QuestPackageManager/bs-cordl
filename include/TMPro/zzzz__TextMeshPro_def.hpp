...
public:
  ...
  /// @brief Method get_sortingLayerID addr 0x2bf0ec4 size 0x94 virtual false final false
  inline int32_t get_sortingLayerID();

  /// @brief Method set_sortingLayerID addr 0x2bf0fec size 0xb4 virtual false final false
  inline void set_sortingLayerID(int32_t value);

  /// @brief Method get_sortingOrder addr 0x2bf11ac size 0x94 virtual false final false
  inline int32_t get_sortingOrder();

  /// @brief Method set_sortingOrder addr 0x2bf1240 size 0xb4 virtual false final false
  inline void set_sortingOrder(int32_t value);

  /// @brief Method get_autoSizeTextContainer addr 0x2bf1400 size 0x8 virtual true final false
  inline bool get_autoSizeTextContainer();

  /// @brief Method set_autoSizeTextContainer addr 0x2bf1408 size 0xa0 virtual true final false
  inline void set_autoSizeTextContainer(bool value);

  /// @brief Method get_textContainer addr 0x2bf14a8 size 0x8 virtual false final false
  inline ::TMPro::TextContainer* get_textContainer();

  /// @brief Method get_transform addr 0x2bf14b0 size 0x94 virtual false final false
  inline ::UnityEngine::Transform* get_transform();

  /// @brief Method get_renderer addr 0x2bf0f58 size 0x94 virtual false final false
  inline ::UnityEngine::Renderer* get_renderer();

  /// @brief Method get_mesh addr 0x2bf1544 size 0xb0 virtual true final false
  inline ::UnityEngine::Mesh* get_mesh();

  /// @brief Method get_meshFilter addr 0x2bf15f4 size 0xfc virtual false final false
  inline ::UnityEngine::MeshFilter* get_meshFilter();

  /// @brief Method get_maskType addr 0x2bf16f0 size 0x8 virtual false final false
  inline ::TMPro::MaskingTypes get_maskType();

  /// @brief Method set_maskType addr 0x2bf16f8 size 0x8 virtual false final false
  inline void set_maskType(::TMPro::MaskingTypes value);

  /// @brief Method SetMask addr 0x2bf1848 size 0x48 virtual false final false
  inline void SetMask(::TMPro::MaskingTypes type, ::UnityEngine::Vector4 maskCoords);

  /// @brief Method SetMask addr 0x2bf1930 size 0x60 virtual false final false
  inline void SetMask(::TMPro::MaskingTypes type, ::UnityEngine::Vector4 maskCoords, float_t softnessX, float_t softnessY);

  /// @brief Method SetVerticesDirty addr 0x2bf1a80 size 0xb0 virtual true final false
  inline void SetVerticesDirty();

  /// @brief Method SetLayoutDirty addr 0x2bf1b30 size 0xd0 virtual true final false
  inline void SetLayoutDirty();

  /// @brief Method SetMaterialDirty addr 0x2bf1c00 size 0x10 virtual true final false
  inline void SetMaterialDirty();

  /// @brief Method SetAllDirty addr 0x2bf1c10 size 0x44 virtual true final false
  inline void SetAllDirty();

  /// @brief Method Rebuild addr 0x2bf1c54 size 0xe8 virtual true final false
  inline void Rebuild(::UnityEngine::UI::CanvasUpdate update);

  /// @brief Method UpdateMaterial addr 0x2bf1f98 size 0x134 virtual true final false
  inline void UpdateMaterial();

  /// @brief Method UpdateMeshPadding addr 0x2bf20cc size 0x100 virtual true final false
  inline void UpdateMeshPadding();

  /// @brief Method ForceMeshUpdate addr 0x2bf21cc size 0x14 virtual true final false
  inline void ForceMeshUpdate(bool ignoreActiveState, bool forceTextReparsing);

  /// @brief Method GetTextInfo addr 0x2bf21e0 size 0x6c virtual true final false
  inline ::TMPro::TMP_TextInfo* GetTextInfo(::StringW text);

  /// @brief Method ClearMesh addr 0x2bf224c size 0xc0 virtual true final false
  inline void ClearMesh(bool updateMesh);

  /// @brief Method add_OnPreRenderText addr 0x2bf230c size 0xb4 virtual true final false
  inline void add_OnPreRenderText(::System::Action_1<::TMPro::TMP_TextInfo*>* value);

  /// @brief Method remove_OnPreRenderText addr 0x2bf23c0 size 0xb4 virtual true final false
  inline void remove_OnPreRenderText(::System::Action_1<::TMPro::TMP_TextInfo*>* value);

  /// @brief Method UpdateGeometry addr 0x2bf2474 size 0x18 virtual true final false
  inline void UpdateGeometry(::UnityEngine::Mesh* mesh, int32_t index);

  /// @brief Method UpdateVertexData addr 0x2bf248c size 0x198 virtual true final false
  inline void UpdateVertexData(::TMPro::TMP_VertexDataUpdateFlags flags);

  /// @brief Method UpdateVertexData addr 0x2bf2624 size 0x198 virtual true final false
  inline void UpdateVertexData();

  /// @brief Method UpdateFontAsset addr 0x2bf27bc size 0x10 virtual false final false
  inline void UpdateFontAsset();

  /// @brief Method CalculateLayoutInputHorizontal addr 0x2bf27cc size 0x4 virtual true final true
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical addr 0x2bf27d0 size 0x4 virtual true final true
  inline void CalculateLayoutInputVertical();

  /// @brief Method Awake addr 0x2bf27d4 size 0x3a8 virtual true final false
  inline void Awake();

  /// @brief Method OnEnable addr 0x2bf2b7c size 0xfc virtual true final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x2bf2c78 size 0xac virtual true final false
  inline void OnDisable();

  /// @brief Method OnDestroy addr 0x2bf2d24 size 0xcc virtual true final false
  inline void OnDestroy();

  /// @brief Method LoadFontAsset addr 0x2bf2df0 size 0x670 virtual true final false
  inline void LoadFontAsset();

  /// @brief Method UpdateEnvMapMatrix addr 0x2bf3460 size 0x27c virtual false final false
  inline void UpdateEnvMapMatrix();

  /// @brief Method SetMask addr 0x2bf1700 size 0x148 virtual false final false
  inline void SetMask(::TMPro::MaskingTypes maskType);

  /// @brief Method SetMaskCoordinates addr 0x2bf1890 size 0xa0 virtual false final false
  inline void SetMaskCoordinates(::UnityEngine::Vector4 coords);

  /// @brief Method SetMaskCoordinates addr 0x2bf1990 size 0xf0 virtual false final false
  inline void SetMaskCoordinates(::UnityEngine::Vector4 coords, float_t softX, float_t softY);

  /// @brief Method EnableMasking addr 0x2bf36dc size 0xf8 virtual false final false
  inline void EnableMasking();

  /// @brief Method DisableMasking addr 0x2bf3854 size 0xf4 virtual false final false
  inline void DisableMasking();

  /// @brief Method UpdateMask addr 0x2bf37d4 size 0x80 virtual false final false
  inline void UpdateMask();

  /// @brief Method GetMaterial addr 0x2bf3a0c size 0x110 virtual true final false
  inline ::UnityEngine::Material* GetMaterial(::UnityEngine::Material* mat);

  /// @brief Method GetMaterials addr 0x2bf3b1c size 0x1a8 virtual true final false
  ...
  /// @brief Method SetSharedMaterial addr 0x2bf3cc4 size 0x38 virtual true final false
  inline void SetSharedMaterial(::UnityEngine::Material* mat);

  /// @brief Method GetSharedMaterials addr 0x2bf3cfc size 0x190 virtual true final false
  inline ::ArrayW<::UnityEngine::Material*, ::Array<::UnityEngine::Material*>*> GetSharedMaterials();

  /// @brief Method SetSharedMaterials addr 0x2bf3e8c size 0x368 virtual true final false
  inline void SetSharedMaterials(::ArrayW<::UnityEngine::Material*, ::Array<::UnityEngine::Material*>*> materials);

  /// @brief Method SetOutlineThickness addr 0x2bf41f4 size 0x12c virtual true final false
  inline void SetOutlineThickness(float_t thickness);

  /// @brief Method SetFaceColor addr 0x2bf4320 size 0x128 virtual true final false
  inline void SetFaceColor(::UnityEngine::Color32 color);

  /// @brief Method SetOutlineColor addr 0x2bf4448 size 0x128 virtual true final false
  inline void SetOutlineColor(::UnityEngine::Color32 color);

  /// @brief Method CreateMaterialInstance addr 0x2bf3948 size 0xc4 virtual false final false
  inline void CreateMaterialInstance();

  /// @brief Method SetShaderDepth addr 0x2bf4570 size 0xe8 virtual true final false
  inline void SetShaderDepth();

  /// @brief Method SetCulling addr 0x2bf4658 size 0x2a8 virtual true final false
  inline void SetCulling();

  /// @brief Method SetPerspectiveCorrection addr 0x2bf4900 size 0x84 virtual false final false
  inline void SetPerspectiveCorrection();

  /// @brief Method SetArraySizes addr 0x2bf4984 size 0x1ad0 virtual true final false
  inline int32_t SetArraySizes(::ArrayW<::TMPro::__TMP_Text__UnicodeChar, ::Array<::TMPro::__TMP_Text__UnicodeChar>*> unicodeChars);

  /// @brief Method ComputeMarginSize addr 0x2bf6454 size 0x124 virtual true final false
  inline void ComputeMarginSize();

  /// @brief Method OnDidApplyAnimationProperties addr 0x2bf6578 size 0x1c virtual true final false
  inline void OnDidApplyAnimationProperties();

  /// @brief Method OnTransformParentChanged addr 0x2bf6594 size 0x30 virtual true final false
  inline void OnTransformParentChanged();

  /// @brief Method OnRectTransformDimensionsChange addr 0x2bf65c4 size 0x17c virtual true final false
  inline void OnRectTransformDimensionsChange();

  /// @brief Method InternalUpdate addr 0x2bf6740 size 0x9c virtual true final false
  inline void InternalUpdate();

  /// @brief Method OnPreRenderObject addr 0x2bf1d3c size 0x25c virtual false final false
  inline void OnPreRenderObject();

  /// @brief Method GenerateTextMesh addr 0x2bdfd98 size 0x7878 virtual true final false
  inline void GenerateTextMesh();

  /// @brief Method GetTextContainerLocalCorners addr 0x2bf6a8c size 0x9c virtual true final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> GetTextContainerLocalCorners();

  /// @brief Method SetMeshFilters addr 0x2bf6b28 size 0x1c0 virtual false final false
  inline void SetMeshFilters(bool state);

  /// @brief Method SetActiveSubMeshes addr 0x2bf6ce8 size 0x108 virtual true final false
  inline void SetActiveSubMeshes(bool state);

  /// @brief Method SetActiveSubTextObjectRenderers addr 0x2bf6960 size 0x12c virtual false final false
  inline void SetActiveSubTextObjectRenderers(bool state);

  /// @brief Method DestroySubMeshObjects addr 0x2bf6df0 size 0xdc virtual true final false
  inline void DestroySubMeshObjects();

  /// @brief Method UpdateSubMeshSortingLayerID addr 0x2bf10a0 size 0x10c virtual false final false
  inline void UpdateSubMeshSortingLayerID(int32_t id);

  /// @brief Method UpdateSubMeshSortingOrder addr 0x2bf12f4 size 0x10c virtual false final false
  inline void UpdateSubMeshSortingOrder(int32_t order);

  /// @brief Method GetCompoundBounds addr 0x2bf6ecc size 0x248 virtual true final false
  inline ::UnityEngine::Bounds GetCompoundBounds();

  /// @brief Method UpdateSDFScale addr 0x2bf67dc size 0x184 virtual false final false
  inline void UpdateSDFScale(float_t scaleDelta);

  static inline ::TMPro::TextMeshPro* New_ctor();

  /// @brief Method .ctor addr 0x2bf7114 size 0xc0 virtual false final false
  inline void _ctor();
