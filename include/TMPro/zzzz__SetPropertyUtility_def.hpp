...
/// @brief Method SetColor, addr 0x68504dc, size 0x4c, virtual false, abstract: false, final false
...
template<typename T>
static inline bool SetEquatableStruct(::ByRef<T>  currentValue, T  newValue) ;
