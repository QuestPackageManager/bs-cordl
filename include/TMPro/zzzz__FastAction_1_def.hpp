...
// Write type traits
MARK_GEN_REF_T_PTR(::TMPro::FastAction_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::TMPro::FastAction_1, "TMPro", "FastAction`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FastAction_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FastAction_1(FastAction_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FastAction_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FastAction_1(FastAction_1const&) = delete;
