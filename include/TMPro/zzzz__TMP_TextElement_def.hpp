...
namespace TMPro {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12345))]
...
public:
  ...
  /// @brief Method get_elementType, addr 0x2c4595c, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::TextElementType get_elementType();

  /// @brief Method get_unicode, addr 0x2c45964, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_unicode();

  /// @brief Method set_unicode, addr 0x2c4596c, size 0x8, virtual false, abstract: false, final false
  inline void set_unicode(uint32_t value);

  /// @brief Method get_textAsset, addr 0x2c45974, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::TMPro::TMP_Asset> get_textAsset();

  /// @brief Method set_textAsset, addr 0x2c4597c, size 0x8, virtual false, abstract: false, final false
  inline void set_textAsset(::TMPro::TMP_Asset* value);

  /// @brief Method get_glyph, addr 0x2c45984, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::TextCore::Glyph* get_glyph();

  /// @brief Method set_glyph, addr 0x2c4598c, size 0x8, virtual false, abstract: false, final false
  inline void set_glyph(::UnityEngine::TextCore::Glyph* value);

  /// @brief Method get_glyphIndex, addr 0x2c45994, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method set_glyphIndex, addr 0x2c4599c, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphIndex(uint32_t value);

  /// @brief Method get_scale, addr 0x2c459a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_scale();

  /// @brief Method set_scale, addr 0x2c459ac, size 0x8, virtual false, abstract: false, final false
  inline void set_scale(float_t value);

  static inline ::TMPro::TMP_TextElement* New_ctor();

  /// @brief Method .ctor, addr 0x2c42420, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
