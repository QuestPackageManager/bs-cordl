...
public:
  ...
  /// @brief Method OnPointerClick addr 0x2abbc44 size 0x68 virtual true final true
  inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method OnSelect addr 0x2abbcac size 0x78 virtual true final true
  inline void OnSelect(::UnityEngine::EventSystems::BaseEventData* eventData);

  /// @brief Method OnDeselect addr 0x2abbd24 size 0x74 virtual true final true
  ...
  /// @brief Method .ctor addr 0x2abbd98 size 0x8 virtual false final false
  inline void _ctor();
