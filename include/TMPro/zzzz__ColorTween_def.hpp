...
namespace TMPro {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10178)), TypeDefinitionIndex(TypeDefinitionIndex(10387)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10387), inst:
// 294 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(12267)) CS Name: ::ColorTween::ColorTweenCallback*
...
public:
  ...
  /// @brief Method .ctor addr 0x2a7d558 size 0x48 virtual false final false
  inline void _ctor();
...
namespace TMPro {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10178)), TypeDefinitionIndex(TypeDefinitionIndex(12266))}
...
public:
  ...
  /// @brief Method get_startColor addr 0x2a7d380 size 0xc virtual false final false
  inline ::UnityEngine::Color get_startColor();

  /// @brief Method set_startColor addr 0x2a7d38c size 0xc virtual false final false
  inline void set_startColor(::UnityEngine::Color value);

  /// @brief Method get_targetColor addr 0x2a7d398 size 0xc virtual false final false
  inline ::UnityEngine::Color get_targetColor();

  /// @brief Method set_targetColor addr 0x2a7d3a4 size 0xc virtual false final false
  inline void set_targetColor(::UnityEngine::Color value);

  /// @brief Method get_tweenMode addr 0x2a7d3b0 size 0x8 virtual false final false
  inline ::TMPro::__ColorTween__ColorTweenMode get_tweenMode();

  /// @brief Method set_tweenMode addr 0x2a7d3b8 size 0x8 virtual false final false
  inline void set_tweenMode(::TMPro::__ColorTween__ColorTweenMode value);

  /// @brief Method get_duration addr 0x2a7d3c0 size 0x8 virtual true final true
  inline float_t get_duration();

  /// @brief Method set_duration addr 0x2a7d3c8 size 0x8 virtual false final false
  inline void set_duration(float_t value);

  /// @brief Method get_ignoreTimeScale addr 0x2a7d3d0 size 0x8 virtual true final true
  inline bool get_ignoreTimeScale();

  /// @brief Method set_ignoreTimeScale addr 0x2a7d3d8 size 0xc virtual false final false
  inline void set_ignoreTimeScale(bool value);

  /// @brief Method TweenValue addr 0x2a7d3e4 size 0xdc virtual true final true
  inline void TweenValue(float_t floatPercentage);

  /// @brief Method AddOnChangedCallback addr 0x2a7d4d0 size 0x88 virtual false final false
  inline void AddOnChangedCallback(::UnityEngine::Events::UnityAction_1<::UnityEngine::Color>* callback);

  /// @brief Method GetIgnoreTimescale addr 0x2a7d5a0 size 0x8 virtual false final false
  inline bool GetIgnoreTimescale();

  /// @brief Method GetDuration addr 0x2a7d5a8 size 0x8 virtual false final false
  inline float_t GetDuration();

  /// @brief Method ValidTarget addr 0x2a7d4c0 size 0x10 virtual true final true
