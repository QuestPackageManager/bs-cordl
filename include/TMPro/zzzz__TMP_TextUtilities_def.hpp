...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6864614, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DistanceToLine, addr 0x6862370, size 0xc8, virtual false, abstract: false, final false
  static inline float_t DistanceToLine(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ::UnityEngine::Vector3 point);

  /// @brief Method FindIntersectingCharacter, addr 0x6862558, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method FindIntersectingLine, addr 0x686330c, size 0x17c, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingLine(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindIntersectingLink, addr 0x6863488, size 0x378, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingLink(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindIntersectingWord, addr 0x6862780, size 0x470, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingWord(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestCharacter, addr 0x6861494, size 0x348, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNearestCharacterOnLine, addr 0x6861ed8, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNearestLine, addr 0x6861d34, size 0x1a4, virtual false, abstract: false, final false
  static inline int32_t FindNearestLine(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestLink, addr 0x6863800, size 0x6fc, virtual false, abstract: false, final false
  static inline int32_t FindNearestLink(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestWord, addr 0x6862bf0, size 0x71c, virtual false, abstract: false, final false
  static inline int32_t FindNearestWord(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method GetCursorIndexFromPosition, addr 0x686132c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorIndexFromPosition, addr 0x6861b20, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x68641f0, size 0xb4, virtual false, abstract: false, final false
  static inline int32_t GetHashCode(::StringW s);

  /// @brief Method GetHashCodeCaseInSensitive, addr 0x68643a4, size 0xb8, virtual false, abstract: false, final false
  static inline uint32_t GetHashCodeCaseInSensitive(::StringW s);

  /// @brief Method GetSimpleHashCode, addr 0x68642a4, size 0x48, virtual false, abstract: false, final false
  static inline int32_t GetSimpleHashCode(::StringW s);

  /// @brief Method GetSimpleHashCodeLowercase, addr 0x68642ec, size 0xb8, virtual false, abstract: false, final false
  static inline uint32_t GetSimpleHashCodeLowercase(::StringW s);

  /// @brief Method HexToInt, addr 0x686445c, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t hex);

  /// @brief Method IntersectLinePlane, addr 0x6863efc, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method IsIntersectingRectTransform, addr 0x6862438, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method PointIntersectRectangle, addr 0x68622b0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenPointToWorldPointInRectangle, addr 0x68617dc, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method StringHexToInt, addr 0x6864488, size 0x11c, virtual false, abstract: false, final false
  static inline int32_t StringHexToInt(::StringW s);

  /// @brief Method ToLowerFast, addr 0x6864070, size 0x80, virtual false, abstract: false, final false
  static inline char16_t ToLowerFast(char16_t c);

  /// @brief Method ToUpperASCIIFast, addr 0x6864170, size 0x80, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x68640f0, size 0x80, virtual false, abstract: false, final false
