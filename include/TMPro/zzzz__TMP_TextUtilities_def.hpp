...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x480a740, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DistanceToLine, addr 0x48087f8, size 0xc8, virtual false, abstract: false, final false
  static inline float_t DistanceToLine(::UnityEngine::Vector3 a, ::UnityEngine::Vector3 b, ::UnityEngine::Vector3 point);

  /// @brief Method FindIntersectingCharacter, addr 0x48089dc, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method FindIntersectingLine, addr 0x48095b8, size 0x158, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingLine(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindIntersectingLink, addr 0x4809710, size 0x340, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingLink(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindIntersectingWord, addr 0x4808be4, size 0x410, virtual false, abstract: false, final false
  static inline int32_t FindIntersectingWord(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestCharacter, addr 0x4807a20, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNearestCharacterOnLine, addr 0x48083cc, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindNearestLine, addr 0x480824c, size 0x180, virtual false, abstract: false, final false
  static inline int32_t FindNearestLine(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestLink, addr 0x4809a50, size 0x714, virtual false, abstract: false, final false
  static inline int32_t FindNearestLink(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method FindNearestWord, addr 0x4808ff4, size 0x5c4, virtual false, abstract: false, final false
  static inline int32_t FindNearestWord(::TMPro::TMP_Text* text, ::UnityEngine::Vector3 position, ::UnityEngine::Camera* camera);

  /// @brief Method GetCursorIndexFromPosition, addr 0x48078bc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCursorIndexFromPosition, addr 0x480806c, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x480a430, size 0xbc, virtual false, abstract: false, final false
  static inline int32_t GetHashCode(::StringW s);

  /// @brief Method GetSimpleHashCode, addr 0x480209c, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t GetSimpleHashCode(::StringW s);

  /// @brief Method GetSimpleHashCodeLowercase, addr 0x480a4ec, size 0xbc, virtual false, abstract: false, final false
  static inline uint32_t GetSimpleHashCodeLowercase(::StringW s);

  /// @brief Method HexToInt, addr 0x480a5a8, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t HexToInt(char16_t hex);

  /// @brief Method IntersectLinePlane, addr 0x480a164, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method IsIntersectingRectTransform, addr 0x48088c0, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method PointIntersectRectangle, addr 0x4808738, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method ScreenPointToWorldPointInRectangle, addr 0x4807d48, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method StringHexToInt, addr 0x480a5d4, size 0x104, virtual false, abstract: false, final false
  static inline int32_t StringHexToInt(::StringW s);

  /// @brief Method ToLowerFast, addr 0x480a2d4, size 0x74, virtual false, abstract: false, final false
  static inline char16_t ToLowerFast(char16_t c);

  /// @brief Method ToUpperASCIIFast, addr 0x480a3bc, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t ToUpperASCIIFast(uint32_t c);

  /// @brief Method ToUpperFast, addr 0x480a348, size 0x74, virtual false, abstract: false, final false
