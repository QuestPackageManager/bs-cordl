...
/// @brief Method SearchForCharacter, addr 0x68193b4, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method SearchForCharacter, addr 0x68197c0, size 0x4, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_FontAsset> SearchForCharacter(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>*  fonts, uint32_t  unicode, ::ByRef<::TMPro::TMP_Character*>  character) ;

/// @brief Method SearchForCharacterInternal, addr 0x68194a8, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method SearchForCharacterInternal, addr 0x68197c4, size 0x100, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_FontAsset> SearchForCharacterInternal(::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>*  fonts, uint32_t  unicode, ::ByRef<::TMPro::TMP_Character*>  character) ;
