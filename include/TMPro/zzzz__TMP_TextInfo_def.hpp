...
public:
  ...
  /// @brief Method Clear, addr 0x69a58f8, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ClearAllData, addr 0x69a594c, size 0x13c, virtual false, abstract: false, final false
  inline void ClearAllData();

  /// @brief Method ClearAllMeshInfo, addr 0x69a5b44, size 0xb8, virtual false, abstract: false, final false
  inline void ClearAllMeshInfo();

  /// @brief Method ClearLineInfo, addr 0x69a5d74, size 0x188, virtual false, abstract: false, final false
  inline void ClearLineInfo();

  /// @brief Method ClearMeshInfo, addr 0x69a5a88, size 0xbc, virtual false, abstract: false, final false
  inline void ClearMeshInfo(bool updateMesh);

  /// @brief Method ClearPageInfo, addr 0x69a5efc, size 0x9c, virtual false, abstract: false, final false
  inline void ClearPageInfo();

  /// @brief Method ClearUnusedVertices, addr 0x69a5cbc, size 0xb8, virtual false, abstract: false, final false
  inline void ClearUnusedVertices(::ArrayW<::TMPro::MaterialReference> materials);

  /// @brief Method CopyMeshInfoVertexData, addr 0x69a5f98, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetVertexLayout, addr 0x69a5bfc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69a5510, size 0x130, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x69a5640, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(int32_t characterCount);

  /// @brief Method .ctor, addr 0x69a577c, size 0x17c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TMP_TextInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TMP_TextInfo(TMP_TextInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TMP_TextInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TMP_TextInfo(TMP_TextInfoconst&) = delete;
