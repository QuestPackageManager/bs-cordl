...
/// @brief Method Clear, addr 0x67eda78, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearAllData, addr 0x67edacc, size 0x13c, virtual false, abstract: false, final false
inline void ClearAllData() ;

/// @brief Method ClearAllMeshInfo, addr 0x67edcc4, size 0xb8, virtual false, abstract: false, final false
inline void ClearAllMeshInfo() ;

/// @brief Method ClearLineInfo, addr 0x67edef4, size 0x188, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x67edc08, size 0xbc, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x67ee07c, size 0x9c, virtual false, abstract: false, final false
inline void ClearPageInfo() ;

/// @brief Method ClearUnusedVertices, addr 0x67ede3c, size 0xb8, virtual false, abstract: false, final false
inline void ClearUnusedVertices(::ArrayW<::TMPro::MaterialReference,::Array<::TMPro::MaterialReference>*>  materials) ;

/// @brief Method CopyMeshInfoVertexData, addr 0x67ee118, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method ResetVertexLayout, addr 0x67edd7c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x67ed690, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x67ed7c0, size 0x13c, virtual false, abstract: false, final false
inline void _ctor(int32_t  characterCount) ;

/// @brief Method .ctor, addr 0x67ed8fc, size 0x17c, virtual false, abstract: false, final false
