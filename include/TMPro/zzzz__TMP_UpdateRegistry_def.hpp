...
// Write type traits
MARK_REF_T(::TMPro::TMP_UpdateRegistry*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_UpdateRegistry*, "TMPro", "TMP_UpdateRegistry");
...
public:
  ...
  /// @brief Method InternalRegisterCanvasElementForGraphicRebuild, addr 0x69ab798, size 0x17c, virtual false, abstract: false, final false
  inline bool InternalRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalRegisterCanvasElementForLayoutRebuild, addr 0x69ab5fc, size 0x17c, virtual false, abstract: false, final false
  inline bool InternalRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild, addr 0x69abd18, size 0xf0, virtual false, abstract: false, final false
  inline void InternalUnRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild, addr 0x69abc28, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method PerformUpdateForCanvasRendererObjects, addr 0x69ab914, size 0x274, virtual false, abstract: false, final false
  inline void PerformUpdateForCanvasRendererObjects();

  /// @brief Method PerformUpdateForMeshRendererObjects, addr 0x69abb88, size 0x70, virtual false, abstract: false, final false
  inline void PerformUpdateForMeshRendererObjects();

  /// @brief Method RegisterCanvasElementForGraphicRebuild, addr 0x69ab778, size 0x20, virtual false, abstract: false, final false
  static inline void RegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method RegisterCanvasElementForLayoutRebuild, addr 0x69ab5dc, size 0x20, virtual false, abstract: false, final false
  static inline void RegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement* element);

  /// @brief Method UnRegisterCanvasElementForRebuild, addr 0x69abbf8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69ab48c, size 0x150, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::TMPro::TMP_UpdateRegistry* getStaticF_s_Instance();

  /// @brief Method get_instance, addr 0x69ab414, size 0x78, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TMP_UpdateRegistry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TMP_UpdateRegistry(TMP_UpdateRegistry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TMP_UpdateRegistry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TMP_UpdateRegistry(TMP_UpdateRegistryconst&) = delete;
...
static_assert(sizeof(::TMPro::TMP_UpdateRegistry) == 0x30, "Size mismatch!");
