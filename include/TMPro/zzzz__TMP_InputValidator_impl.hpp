...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<char16_t (::TMPro::TMP_InputValidator::*)(::ByRef<::StringW>, ::ByRef<int32_t>, char16_t)>(&::TMPro::TMP_InputValidator::Validate)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_InputValidator::*)()>(&::TMPro::TMP_InputValidator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x67dc9a4;
