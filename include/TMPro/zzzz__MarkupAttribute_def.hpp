...
/// @brief Method get_NameHashCode, addr 0x67eec1c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_NameHashCode() ;

/// @brief Method get_ValueHashCode, addr 0x67eec2c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ValueHashCode() ;

/// @brief Method get_ValueLength, addr 0x67eec4c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ValueLength() ;

/// @brief Method get_ValueStartIndex, addr 0x67eec3c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ValueStartIndex() ;

/// @brief Method set_NameHashCode, addr 0x67eec24, size 0x8, virtual false, abstract: false, final false
inline void set_NameHashCode(int32_t  value) ;

/// @brief Method set_ValueHashCode, addr 0x67eec34, size 0x8, virtual false, abstract: false, final false
inline void set_ValueHashCode(int32_t  value) ;

/// @brief Method set_ValueLength, addr 0x67eec54, size 0x8, virtual false, abstract: false, final false
inline void set_ValueLength(int32_t  value) ;

/// @brief Method set_ValueStartIndex, addr 0x67eec44, size 0x8, virtual false, abstract: false, final false
