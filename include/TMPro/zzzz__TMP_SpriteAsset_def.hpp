...
public:
  ...
  /// @brief Method .ctor addr 0x2c44800 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <SortGlyphTable>b__40_0 addr 0x2c44808 size 0x18 virtual false final false
  inline uint32_t _SortGlyphTable_b__40_0(::TMPro::TMP_SpriteGlyph* item);

  /// @brief Method <SortCharacterTable>b__41_0 addr 0x2c44820 size 0x18 virtual false final false
...
public:
  ...
  /// @brief Method get_version addr 0x2c42b80 size 0x8 virtual false final false
  inline ::StringW get_version();

  /// @brief Method set_version addr 0x2c42b88 size 0x8 virtual false final false
  inline void set_version(::StringW value);

  /// @brief Method get_faceInfo addr 0x2c42b90 size 0x10 virtual false final false
  inline ::UnityEngine::TextCore::FaceInfo get_faceInfo();

  /// @brief Method set_faceInfo addr 0x2c42ba0 size 0x18 virtual false final false
  inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo value);

  /// @brief Method get_spriteCharacterTable addr 0x2c42b0c size 0x24 virtual false final false
  inline ::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterTable();

  /// @brief Method set_spriteCharacterTable addr 0x2c430dc size 0x8 virtual false final false
  inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>* value);

  /// @brief Method get_spriteCharacterLookupTable addr 0x2c430e4 size 0x24 virtual false final false
  inline ::System::Collections::Generic::Dictionary_2<uint32_t, ::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterLookupTable();

  /// @brief Method set_spriteCharacterLookupTable addr 0x2c43108 size 0x8 virtual false final false
  ...
  /// @brief Method get_spriteGlyphTable addr 0x2c43110 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::TMPro::TMP_SpriteGlyph*>* get_spriteGlyphTable();

  /// @brief Method set_spriteGlyphTable addr 0x2c43118 size 0x8 virtual false final false
  inline void set_spriteGlyphTable(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteGlyph*>* value);

  /// @brief Method Awake addr 0x2c43120 size 0x88 virtual false final false
  inline void Awake();

  /// @brief Method GetDefaultSpriteMaterial addr 0x2c436e4 size 0xe8 virtual false final false
  inline ::UnityEngine::Material* GetDefaultSpriteMaterial();

  /// @brief Method UpdateLookupTables addr 0x2c42bb8 size 0x524 virtual false final false
  inline void UpdateLookupTables();

  /// @brief Method GetSpriteIndexFromHashcode addr 0x2c437cc size 0x88 virtual false final false
  inline int32_t GetSpriteIndexFromHashcode(int32_t hashCode);

  /// @brief Method GetSpriteIndexFromUnicode addr 0x2c43854 size 0x94 virtual false final false
  inline int32_t GetSpriteIndexFromUnicode(uint32_t unicode);

  /// @brief Method GetSpriteIndexFromName addr 0x2c438e8 size 0x74 virtual false final false
  inline int32_t GetSpriteIndexFromName(::StringW name);

  /// @brief Method SearchForSpriteByUnicode addr 0x2c439c8 size 0x228 virtual false final false
  ...
  /// @brief Method SearchForSpriteByUnicodeInternal addr 0x2c43bf0 size 0x1a0 virtual false final false
  ...
  /// @brief Method SearchForSpriteByUnicodeInternal addr 0x2c43d90 size 0xb0 virtual false final false
  ...
  /// @brief Method SearchForSpriteByHashCode addr 0x2c43e40 size 0x320 virtual false final false
  ...
  /// @brief Method SearchForSpriteByHashCodeInternal addr 0x2c44160 size 0x1a0 virtual false final false
  ...
  /// @brief Method SearchForSpriteByHashCodeInternal addr 0x2c44300 size 0xb0 virtual false final false
  ...
  /// @brief Method SortGlyphTable addr 0x2c443b0 size 0x138 virtual false final false
  inline void SortGlyphTable();

  /// @brief Method SortCharacterTable addr 0x2c444e8 size 0x13c virtual false final false
  inline void SortCharacterTable();

  /// @brief Method SortGlyphAndCharacterTables addr 0x2c44624 size 0x18 virtual false final false
  inline void SortGlyphAndCharacterTables();

  /// @brief Method UpgradeSpriteAsset addr 0x2c431a8 size 0x53c virtual false final false
  inline void UpgradeSpriteAsset();

  static inline ::TMPro::TMP_SpriteAsset* New_ctor();

  /// @brief Method .ctor addr 0x2c446dc size 0xc0 virtual false final false
  inline void _ctor();
