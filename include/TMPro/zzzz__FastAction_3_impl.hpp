...
template <typename A, typename B, typename C> inline void TMPro::FastAction_3<A, B, C>::Add(::System::Action_3<A, B, C>* rhs) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_3<A, B, C>*>(), { "Add", {}, { ::i2c::type_of<::System::Action_3<A, B, C>*>() } })));
...
template <typename A, typename B, typename C> inline void TMPro::FastAction_3<A, B, C>::Remove(::System::Action_3<A, B, C>* rhs) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_3<A, B, C>*>(), { "Remove", {}, { ::i2c::type_of<::System::Action_3<A, B, C>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, rhs);
}
template <typename A, typename B, typename C> inline void TMPro::FastAction_3<A, B, C>::Call(A a, B b, C c) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_3<A, B, C>*>(), { "Call", {}, { ::i2c::type_of<A>(), ::i2c::type_of<B>(), ::i2c::type_of<C>() } })));
...
template <typename A, typename B, typename C> inline void TMPro::FastAction_3<A, B, C>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_3<A, B, C>*>(), { ".ctor", {}, {} })));
