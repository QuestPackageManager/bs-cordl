...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x67f28b4, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x67f2acc, size 0x1e8, virtual false, abstract: false, final false
  static inline int32_t AddMaterialReference(::UnityEngine::Material* material, ::TMPro::TMP_SpriteAsset* spriteAsset,
                                             ::ByRef<::ArrayW<::TMPro::MaterialReference, ::Array<::TMPro::MaterialReference>*>> materialReferences,
                                             ::System::Collections::Generic::Dictionary_2<int32_t, int32_t>* materialReferenceIndexLookup);

  /// @brief Method Contains, addr 0x67f27b4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x67f2738, size 0x7c, virtual false, abstract: false, final false
