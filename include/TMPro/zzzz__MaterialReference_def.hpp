...
public:
  ...
  // Ctor Parameters [CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "fontAsset", ty: "::UnityW<::TMPro::TMP_FontAsset>", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "spriteAsset", ty: "::UnityW<::TMPro::TMP_SpriteAsset>", modifiers: "", def_value: None, comment: None }, CppParam { name: "material", ty:
  // "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None, comment: None }, CppParam { name: "isDefaultMaterial", ty: "bool", modifiers: "", def_value: None, comment: None }, CppParam {
  // name: "isFallbackMaterial", ty: "bool", modifiers: "", def_value: None, comment: None }, CppParam { name: "fallbackMaterial", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "padding", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "referenceCount", ty: "int32_t", modifiers: "", def_value:
  // None, comment: None }]
