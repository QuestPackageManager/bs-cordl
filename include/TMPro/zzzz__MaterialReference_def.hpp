...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x47b5cc4, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x47b5ed0, size 0x1d8, virtual false, abstract: false, final false
  static inline int32_t AddMaterialReference(::UnityEngine::Material* material, ::TMPro::TMP_SpriteAsset* spriteAsset,
                                             ::ByRef<::ArrayW<::TMPro::MaterialReference, ::Array<::TMPro::MaterialReference>*>> materialReferences,
                                             ::System::Collections::Generic::Dictionary_2<int32_t, int32_t>* materialReferenceIndexLookup);

  /// @brief Method Contains, addr 0x47b5bc8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47b5b4c, size 0x7c, virtual false, abstract: false, final false
