...
public:
  // Declarations
  /// @brief Method AddMaterialReference, addr 0x6932f10, size 0x218, virtual false, abstract: false, final false
  ...
  /// @brief Method AddMaterialReference, addr 0x6933128, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x6932e10, size 0x100, virtual false, abstract: false, final false
  static inline bool Contains(::ArrayW<::TMPro::MaterialReference> materialReferences, ::TMPro::TMP_FontAsset* fontAsset);

  /// @brief Method .ctor, addr 0x6932d94, size 0x7c, virtual false, abstract: false, final false
