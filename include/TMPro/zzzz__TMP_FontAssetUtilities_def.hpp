...
public:
  ...
  /// @brief Method get_instance addr 0x2a8c6e4 size 0x58 virtual false final false
  static inline ::TMPro::TMP_FontAssetUtilities* get_instance();

  /// @brief Method GetCharacterFromFontAsset addr 0x2a8c73c size 0x158 virtual false final false
  ...
  /// @brief Method GetCharacterFromFontAsset_Internal addr 0x2a8c894 size 0x3dc virtual false final false
  ...
  /// @brief Method GetCharacterFromFontAssets addr 0x2a8cc70 size 0x258 virtual false final false
  ...
  /// @brief Method GetSpriteCharacterFromSpriteAsset addr 0x2a8cec8 size 0x30c virtual false final false
  ...
  /// @brief Method GetSpriteCharacterFromSpriteAsset_Internal addr 0x2a8d1d4 size 0x1dc virtual false final false
  ...
  /// @brief Method .ctor addr 0x2a8c6dc size 0x8 virtual false final false
  inline void _ctor();
