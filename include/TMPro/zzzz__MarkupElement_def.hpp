...
/// @brief Method .ctor, addr 0x67eee04, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(int32_t  nameHashCode, int32_t  startIndex, int32_t  length) ;

/// @brief Method get_Attributes, addr 0x67eedf4, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::TMPro::MarkupAttribute,::Array<::TMPro::MarkupAttribute>*> get_Attributes() ;

/// @brief Method get_NameHashCode, addr 0x67eec5c, size 0x28, virtual false, abstract: false, final false
inline int32_t get_NameHashCode() ;

/// @brief Method get_ValueHashCode, addr 0x67eed04, size 0x28, virtual false, abstract: false, final false
inline int32_t get_ValueHashCode() ;

/// @brief Method get_ValueLength, addr 0x67eeda4, size 0x28, virtual false, abstract: false, final false
inline int32_t get_ValueLength() ;

/// @brief Method get_ValueStartIndex, addr 0x67eed54, size 0x28, virtual false, abstract: false, final false
inline int32_t get_ValueStartIndex() ;

/// @brief Method set_Attributes, addr 0x67eedfc, size 0x8, virtual false, abstract: false, final false
inline void set_Attributes(::ArrayW<::TMPro::MarkupAttribute,::Array<::TMPro::MarkupAttribute>*>  value) ;

/// @brief Method set_NameHashCode, addr 0x67eec84, size 0x80, virtual false, abstract: false, final false
inline void set_NameHashCode(int32_t  value) ;

/// @brief Method set_ValueHashCode, addr 0x67eed2c, size 0x28, virtual false, abstract: false, final false
inline void set_ValueHashCode(int32_t  value) ;

/// @brief Method set_ValueLength, addr 0x67eedcc, size 0x28, virtual false, abstract: false, final false
inline void set_ValueLength(int32_t  value) ;

/// @brief Method set_ValueStartIndex, addr 0x67eed7c, size 0x28, virtual false, abstract: false, final false
