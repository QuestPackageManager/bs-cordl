...
public:
  ...
  /// @brief Method get_left addr 0x2a7cb18 size 0x8 virtual false final false
  inline float_t get_left();

  /// @brief Method set_left addr 0x2a7cb20 size 0x8 virtual false final false
  inline void set_left(float_t value);

  /// @brief Method get_right addr 0x2a7cb28 size 0x8 virtual false final false
  inline float_t get_right();

  /// @brief Method set_right addr 0x2a7cb30 size 0x8 virtual false final false
  inline void set_right(float_t value);

  /// @brief Method get_top addr 0x2a7cb38 size 0x8 virtual false final false
  inline float_t get_top();

  /// @brief Method set_top addr 0x2a7cb40 size 0x8 virtual false final false
  inline void set_top(float_t value);

  /// @brief Method get_bottom addr 0x2a7cb48 size 0x8 virtual false final false
  inline float_t get_bottom();

  /// @brief Method set_bottom addr 0x2a7cb50 size 0x8 virtual false final false
  inline void set_bottom(float_t value);

  /// @brief Method get_horizontal addr 0x2a7cb58 size 0x8 virtual false final false
  inline float_t get_horizontal();

  /// @brief Method set_horizontal addr 0x2a7cb60 size 0x8 virtual false final false
  inline void set_horizontal(float_t value);

  /// @brief Method get_vertical addr 0x2a7cb68 size 0x8 virtual false final false
  inline float_t get_vertical();

  /// @brief Method set_vertical addr 0x2a7cb70 size 0x8 virtual false final false
  inline void set_vertical(float_t value);

  /// @brief Method get_zero addr 0x2a7cb78 size 0x5c virtual false final false
  static inline ::TMPro::TMP_Offset get_zero();

  /// @brief Method .ctor addr 0x2a7cbd4 size 0xc virtual false final false
  inline void _ctor(float_t left, float_t right, float_t top, float_t bottom);

  /// @brief Method .ctor addr 0x2a7cbe0 size 0xc virtual false final false
  inline void _ctor(float_t horizontal, float_t vertical);

  /// @brief Method op_Equality addr 0x2a7cbec size 0x30 virtual false final false
  static inline bool op_Equality(::TMPro::TMP_Offset lhs, ::TMPro::TMP_Offset rhs);

  /// @brief Method op_Inequality addr 0x2a7cc1c size 0xb8 virtual false final false
  static inline bool op_Inequality(::TMPro::TMP_Offset lhs, ::TMPro::TMP_Offset rhs);

  /// @brief Method op_Multiply addr 0x2a7ccd4 size 0x14 virtual false final false
  static inline ::TMPro::TMP_Offset op_Multiply(::TMPro::TMP_Offset a, float_t b);

  /// @brief Method GetHashCode addr 0x2a7cce8 size 0x64 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method Equals addr 0x2a7cd4c size 0x78 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0x2a7cdc4 size 0xa8 virtual false final false
