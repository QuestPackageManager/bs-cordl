...
public:
  ...
  /// @brief Method MoveNext, addr 0x316db54, size 0x8e0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::TMPro::__TMP_SpriteAnimator___DoSpriteAnimationInternal_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x316e458, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x316e460, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x316e4a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x316db50, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x316daa8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x316d86c, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DoSpriteAnimation, addr 0x316d920, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method DoSpriteAnimationInternal, addr 0x316da08, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x316d8c0, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x316d8bc, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method StopAllAnimations, addr 0x316d8c4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x316dad0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
