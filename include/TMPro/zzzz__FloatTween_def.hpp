...
public:
  ...
  /// @brief Method .ctor, addr 0x694ac74, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddOnChangedCallback, addr 0x694abdc, size 0x98, virtual false, abstract: false, final false
  inline void AddOnChangedCallback(::UnityEngine::Events::UnityAction_1<float_t>* callback);

  /// @brief Method GetDuration, addr 0x694acc8, size 0x8, virtual false, abstract: false, final false
  inline float_t GetDuration();

  /// @brief Method GetIgnoreTimescale, addr 0x694acc0, size 0x8, virtual false, abstract: false, final false
  inline bool GetIgnoreTimescale();

  /// @brief Method TweenValue, addr 0x694ab38, size 0x94, virtual true, abstract: false, final true
  inline void TweenValue(float_t floatPercentage);

  /// @brief Method ValidTarget, addr 0x694abcc, size 0x10, virtual true, abstract: false, final true
  inline bool ValidTarget();

  /// @brief Method get_duration, addr 0x694ab18, size 0x8, virtual true, abstract: false, final true
  inline float_t get_duration();

  /// @brief Method get_ignoreTimeScale, addr 0x694ab28, size 0x8, virtual true, abstract: false, final true
  inline bool get_ignoreTimeScale();

  /// @brief Method get_startValue, addr 0x694aaf8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startValue();

  /// @brief Method get_targetValue, addr 0x694ab08, size 0x8, virtual false, abstract: false, final false
  inline float_t get_targetValue();

  /// @brief Convert to "::TMPro::ITweenValue"
  constexpr ::TMPro::ITweenValue* i___TMPro__ITweenValue();

  /// @brief Method set_duration, addr 0x694ab20, size 0x8, virtual false, abstract: false, final false
  inline void set_duration(float_t value);

  /// @brief Method set_ignoreTimeScale, addr 0x694ab30, size 0x8, virtual false, abstract: false, final false
  inline void set_ignoreTimeScale(bool value);

  /// @brief Method set_startValue, addr 0x694ab00, size 0x8, virtual false, abstract: false, final false
  inline void set_startValue(float_t value);

  /// @brief Method set_targetValue, addr 0x694ab10, size 0x8, virtual false, abstract: false, final false
  ...
  // Ctor Parameters [CppParam { name: "m_Target", ty: "::TMPro::FloatTween_FloatTweenCallback*", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_StartValue", ty: "float_t",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "m_TargetValue", ty: "float_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "m_Duration", ty: "float_t",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "m_IgnoreTimeScale", ty: "bool", modifiers: "", def_value: None, comment: None }]
