...
namespace TMPro {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8994)), TypeDefinitionIndex(TypeDefinitionIndex(12228))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(12229))
// CS Name: ::TMPro::HighlightState
struct CORDL_TYPE HighlightState {
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2bfe774, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color32 color, ::TMPro::TMP_Offset padding);

  /// @brief Method op_Equality, addr 0x2bfe784, size 0xc8, virtual false, abstract: false, final false
  static inline bool op_Equality(::TMPro::HighlightState lhs, ::TMPro::HighlightState rhs);

  /// @brief Method op_Inequality, addr 0x2bfe84c, size 0x48, virtual false, abstract: false, final false
  static inline bool op_Inequality(::TMPro::HighlightState lhs, ::TMPro::HighlightState rhs);

  /// @brief Method GetHashCode, addr 0x2bfe894, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Equals, addr 0x2bfe900, size 0x80, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2bfe980, size 0xa4, virtual false, abstract: false, final false
