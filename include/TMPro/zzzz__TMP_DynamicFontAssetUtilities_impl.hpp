...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_DynamicFontAssetUtilities_FontReference::*)(::StringW, ::StringW, int32_t)>(&::TMPro::TMP_DynamicFontAssetUtilities_FontReference::_ctor)> {
  constexpr static std::size_t size = 0x23c;
  constexpr static std::size_t addrs = 0x6799714;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_DynamicFontAssetUtilities::*)()>(&::TMPro::TMP_DynamicFontAssetUtilities::InitializeSystemFontReferenceCache)> {
  constexpr static std::size_t size = 0x600;
  constexpr static std::size_t addrs = 0x6799114;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ::ByRef<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>)>(&::TMPro::TMP_DynamicFontAssetUtilities::TryGetSystemFontReference)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x6799950;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ::StringW, ::ByRef<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>)>(&::TMPro::TMP_DynamicFontAssetUtilities::TryGetSystemFontReference)> {
  constexpr static std::size_t size = 0x84;
  constexpr static std::size_t addrs = 0x6799c58;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "TryGetSystemFontReference",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::TMPro::TMP_DynamicFontAssetUtilities::*)(::StringW, ::StringW, ::ByRef<::TMPro::TMP_DynamicFontAssetUtilities_FontReference>)>(&::TMPro::TMP_DynamicFontAssetUtilities::TryGetSystemFontReferenceInternal)> {
  constexpr static std::size_t size = 0x288;
  constexpr static std::size_t addrs = 0x67999d0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_DynamicFontAssetUtilities::*)()>(&::TMPro::TMP_DynamicFontAssetUtilities::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x6799cdc;
...
::cordl_internals::setStaticField<::TMPro::TMP_DynamicFontAssetUtilities*, "s_Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::TMP_DynamicFontAssetUtilities*>::get>(std::forward<::TMPro::TMP_DynamicFontAssetUtilities*>(value));
}
inline ::TMPro::TMP_DynamicFontAssetUtilities* TMPro::TMP_DynamicFontAssetUtilities::getStaticF_s_Instance()  {
return ::cordl_internals::getStaticField<::TMPro::TMP_DynamicFontAssetUtilities*, "s_Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::TMP_DynamicFontAssetUtilities*>::get>();
}
