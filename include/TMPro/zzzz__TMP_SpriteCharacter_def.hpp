...
public:
  ...
  /// @brief Method .ctor, addr 0x47fddf8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x47fe06c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(uint32_t unicode, ::TMPro::TMP_SpriteGlyph* glyph);

  /// @brief Method .ctor, addr 0x47fe120, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(uint32_t unicode, uint32_t glyphIndex);

  /// @brief Method .ctor, addr 0x47fe0c0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(uint32_t unicode, ::TMPro::TMP_SpriteAsset* spriteAsset, ::TMPro::TMP_SpriteGlyph* glyph);

  /// @brief Method get_hashCode, addr 0x47fe05c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_name, addr 0x47fdfe8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method set_name, addr 0x47fde18, size 0x78, virtual false, abstract: false, final false
