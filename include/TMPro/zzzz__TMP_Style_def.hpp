...
// Write type traits
MARK_REF_T(::TMPro::TMP_Style*);
DEFINE_IL2CPP_CLASS(::TMPro::TMP_Style*, "TMPro", "TMP_Style");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_m_ClosingTagArray, put = __cordl_internal_set_m_ClosingTagArray)) ::ArrayW<uint32_t> m_ClosingTagArray;
  ...
  __declspec(property(get = __cordl_internal_get_m_OpeningTagArray, put = __cordl_internal_set_m_OpeningTagArray)) ::ArrayW<uint32_t> m_OpeningTagArray;
  ...
  /// @brief Method RefreshStyle, addr 0x699cc54, size 0x15c, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_m_ClosingTagArray() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_m_ClosingTagArray();
  ...
  constexpr ::ArrayW<uint32_t> const& __cordl_internal_get_m_OpeningTagArray() const;

  constexpr ::ArrayW<uint32_t>& __cordl_internal_get_m_OpeningTagArray();

  constexpr void __cordl_internal_set_m_ClosingDefinition(::StringW value);

  constexpr void __cordl_internal_set_m_ClosingTagArray(::ArrayW<uint32_t> value);
  ...
  constexpr void __cordl_internal_set_m_OpeningTagArray(::ArrayW<uint32_t> value);

  /// @brief Method .ctor, addr 0x699ca9c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NormalStyle, addr 0x699c9f0, size 0xac, virtual false, abstract: false, final false
  static inline ::TMPro::TMP_Style* get_NormalStyle();

  /// @brief Method get_hashCode, addr 0x699cb60, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_name, addr 0x699cb24, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_styleClosingDefinition, addr 0x699cb84, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_styleClosingDefinition();

  /// @brief Method get_styleClosingTagArray, addr 0x699cb94, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t> get_styleClosingTagArray();

  /// @brief Method get_styleOpeningDefinition, addr 0x699cb7c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_styleOpeningDefinition();

  /// @brief Method get_styleOpeningTagArray, addr 0x699cb8c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint32_t> get_styleOpeningTagArray();

  static inline void setStaticF_k_NormalStyle(::TMPro::TMP_Style* value);

  /// @brief Method set_hashCode, addr 0x699cb68, size 0x14, virtual false, abstract: false, final false
  inline void set_hashCode(int32_t value);

  /// @brief Method set_name, addr 0x699cb2c, size 0x34, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::TMP_Style) == 0x40, "Size mismatch!");
