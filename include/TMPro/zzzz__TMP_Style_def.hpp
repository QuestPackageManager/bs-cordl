...
public:
  ...
  /// @brief Method RefreshStyle, addr 0x480794c, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4807784, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NormalStyle, addr 0x48076d0, size 0xb4, virtual false, abstract: false, final false
  static inline ::TMPro::TMP_Style* get_NormalStyle();

  /// @brief Method get_hashCode, addr 0x4807854, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_hashCode();

  /// @brief Method get_name, addr 0x4807814, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_styleClosingDefinition, addr 0x4807878, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_styleClosingDefinition();

  /// @brief Method get_styleClosingTagArray, addr 0x4807888, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_styleClosingTagArray();

  /// @brief Method get_styleOpeningDefinition, addr 0x4807870, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_styleOpeningDefinition();

  /// @brief Method get_styleOpeningTagArray, addr 0x4807880, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_hashCode, addr 0x480785c, size 0x14, virtual false, abstract: false, final false
  inline void set_hashCode(int32_t value);

  /// @brief Method set_name, addr 0x480781c, size 0x38, virtual false, abstract: false, final false
