...
namespace TMPro {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(12270))]
...
public:
  ...
  /// @brief Method get_glyphIndex, addr 0x2c0ed30, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_glyphIndex();

  /// @brief Method set_glyphIndex, addr 0x2c0ed38, size 0x8, virtual false, abstract: false, final false
  inline void set_glyphIndex(uint32_t value);

  /// @brief Method get_glyphValueRecord, addr 0x2c0ed40, size 0xc, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphValueRecord get_glyphValueRecord();

  /// @brief Method set_glyphValueRecord, addr 0x2c0ed4c, size 0xc, virtual false, abstract: false, final false
  inline void set_glyphValueRecord(::TMPro::TMP_GlyphValueRecord value);

  /// @brief Method .ctor, addr 0x2c0c58c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint32_t glyphIndex, ::TMPro::TMP_GlyphValueRecord glyphValueRecord);

  /// @brief Method .ctor, addr 0x2c0ed58, size 0x54, virtual false, abstract: false, final false
