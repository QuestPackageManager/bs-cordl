...
public:
  ...
  /// @brief Method .ctor, addr 0x67f1a54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(float_t x, float_t y);

  /// @brief Method get_xPositionAdjustment, addr 0x67f1a34, size 0x8, virtual false, abstract: false, final false
  inline float_t get_xPositionAdjustment();

  /// @brief Method get_yPositionAdjustment, addr 0x67f1a44, size 0x8, virtual false, abstract: false, final false
  inline float_t get_yPositionAdjustment();

  /// @brief Method set_xPositionAdjustment, addr 0x67f1a3c, size 0x8, virtual false, abstract: false, final false
  inline void set_xPositionAdjustment(float_t value);

  /// @brief Method set_yPositionAdjustment, addr 0x67f1a4c, size 0x8, virtual false, abstract: false, final false
