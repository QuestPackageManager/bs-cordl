...
namespace TMPro {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10170)), TypeDefinitionIndex(TypeDefinitionIndex(12377))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2abe1e0 size 0x8 virtual false final false
  inline void _ctor();
