...
public:
  ...
  /// @brief Method ConvertLegacyKerningData, addr 0x695738c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6957350, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6957370, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6957360, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint32_t left, uint32_t right, float_t offset);

  static inline ::TMPro::KerningPair* getStaticF_empty();

  /// @brief Method get_firstGlyph, addr 0x6957310, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_firstGlyph();

  /// @brief Method get_firstGlyphAdjustments, addr 0x6957320, size 0xc, virtual false, abstract: false, final false
  inline ::TMPro::GlyphValueRecord_Legacy get_firstGlyphAdjustments();

  /// @brief Method get_ignoreSpacingAdjustments, addr 0x6957348, size 0x8, virtual false, abstract: false, final false
  inline bool get_ignoreSpacingAdjustments();

  /// @brief Method get_secondGlyph, addr 0x695732c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_secondGlyph();

  /// @brief Method get_secondGlyphAdjustments, addr 0x695733c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_firstGlyph, addr 0x6957318, size 0x8, virtual false, abstract: false, final false
  inline void set_firstGlyph(uint32_t value);

  /// @brief Method set_secondGlyph, addr 0x6957334, size 0x8, virtual false, abstract: false, final false
