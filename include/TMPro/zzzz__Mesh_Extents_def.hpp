...
public:
  // Declarations
  /// @brief Method ToString, addr 0x312bd30, size 0x2ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x312bd24, size 0xc, virtual false, abstract: false, final false
