...
public:
  // Declarations
  /// @brief Method ToString, addr 0x6803d78, size 0x1b8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x6803d6c, size 0xc, virtual false, abstract: false, final false
