...
public:
  // Declarations
  /// @brief Method ToString, addr 0x2d46880, size 0x2ac, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x2d46874, size 0xc, virtual false, abstract: false, final false
