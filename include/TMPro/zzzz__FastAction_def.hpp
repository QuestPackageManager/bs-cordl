...
public:
  ...
  /// @brief Method Add, addr 0x311ea04, size 0xc0, virtual false, abstract: false, final false
  inline void Add(::System::Action* rhs);

  /// @brief Method Call, addr 0x311eb84, size 0x98, virtual false, abstract: false, final false
  inline void Call();

  static inline ::TMPro::FastAction* New_ctor();

  /// @brief Method Remove, addr 0x311eac4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x311ec1c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
