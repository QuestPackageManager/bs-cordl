...
/// @brief Method CreateButton, addr 0x679359c, size 0x328, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateButton(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateDropdown, addr 0x6794140, size 0xe84, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateDropdown(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateInputField, addr 0x6793968, size 0x7d8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateInputField(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateScrollbar, addr 0x67932ac, size 0x2f0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateScrollbar(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateText, addr 0x67938c4, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateText(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateUIElementRoot, addr 0x6792e50, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateUIElementRoot(::StringW  name, ::UnityEngine::Vector2  size) ;

/// @brief Method CreateUIObject, addr 0x6792f00, size 0xcc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateUIObject(::StringW  name, ::UnityEngine::GameObject*  parent) ;

/// @brief Method SetDefaultColorTransitionValues, addr 0x6793160, size 0x64, virtual false, abstract: false, final false
static inline void SetDefaultColorTransitionValues(::UnityEngine::UI::Selectable*  slider) ;

/// @brief Method SetDefaultTextValues, addr 0x67930d4, size 0x8c, virtual false, abstract: false, final false
static inline void SetDefaultTextValues(::TMPro::TMP_Text*  lbl) ;

/// @brief Method SetLayerRecursively, addr 0x67931c4, size 0xe8, virtual false, abstract: false, final false
static inline void SetLayerRecursively(::UnityEngine::GameObject*  go, int32_t  layer) ;

/// @brief Method SetParentAndAlign, addr 0x6792fcc, size 0x108, virtual false, abstract: false, final false
