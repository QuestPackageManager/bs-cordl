...
public:
  ...
  /// @brief Method .ctor addr 0x2c016e4 size 0x28 virtual false final false
  inline void _ctor();

  static inline ::TMPro::TMP_Character* New_ctor(uint32_t unicode, ::UnityEngine::TextCore::Glyph* glyph);

  /// @brief Method .ctor addr 0x2c0170c size 0x54 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c01760 size 0x60 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2c017c0 size 0x40 virtual false final false
