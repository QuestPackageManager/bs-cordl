...
public:
  ...
  /// @brief Method .ctor, addr 0x2bfe250, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::TMPro::TMP_Character* New_ctor(uint32_t unicode, ::UnityEngine::TextCore::Glyph* glyph);

  /// @brief Method .ctor, addr 0x2bfe278, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfe2cc, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfe32c, size 0x40, virtual false, abstract: false, final false
