...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6729548, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x672956c, size 0x24, virtual false, abstract: false, final false
