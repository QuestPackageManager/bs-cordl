...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x47c9ca4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x47c9cc8, size 0x1c, virtual false, abstract: false, final false
