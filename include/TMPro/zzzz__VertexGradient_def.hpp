...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x680378c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Color color);

  /// @brief Method .ctor, addr 0x68037b0, size 0x24, virtual false, abstract: false, final false
