...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x680b720, size 0x23c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InitializeSystemFontReferenceCache, addr 0x680b120, size 0x600, virtual false, abstract: false, final false
  inline void InitializeSystemFontReferenceCache();

  static inline ::TMPro::TMP_DynamicFontAssetUtilities* New_ctor();

  /// @brief Method TryGetSystemFontReference, addr 0x680b95c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReference, addr 0x680bc64, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSystemFontReferenceInternal, addr 0x680b9dc, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x680bce8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
