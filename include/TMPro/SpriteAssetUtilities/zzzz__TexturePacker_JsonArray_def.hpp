...
public:
  // Declarations
  /// @brief Method ToString, addr 0x6865f98, size 0x1a4, virtual true, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x686613c, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW ToString();
...
public:
  ...
  /// @brief Method .ctor, addr 0x68661ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x6865f94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
