...
public:
  // Declarations
  /// @brief Method ToString, addr 0x4806fb0, size 0x188, virtual true, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x4807138, size 0xac, virtual true, abstract: false, final false
  inline ::StringW ToString();
...
public:
  ...
  /// @brief Method .ctor, addr 0x48071e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x4806fa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
