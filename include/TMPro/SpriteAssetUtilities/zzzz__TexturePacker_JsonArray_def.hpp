...
public:
  // Declarations
  /// @brief Method ToString, addr 0x480d748, size 0x188, virtual true, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x480d8d0, size 0xac, virtual true, abstract: false, final false
  inline ::StringW ToString();
...
public:
  ...
  /// @brief Method .ctor, addr 0x480d97c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x480d740, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
