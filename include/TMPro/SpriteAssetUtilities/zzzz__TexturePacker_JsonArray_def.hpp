...
public:
// Declarations
/// @brief Method ToString, addr 0x67f3f8c, size 0x1a4, virtual true, abstract: false, final false
...
public:
// Declarations
/// @brief Method ToString, addr 0x67f4130, size 0xb0, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
/// @brief Method .ctor, addr 0x67f41e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x67f3f88, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
