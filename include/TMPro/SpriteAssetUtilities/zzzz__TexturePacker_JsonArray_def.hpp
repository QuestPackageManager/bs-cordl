...
public:
  // Declarations
  /// @brief Method ToString, addr 0x67f38cc, size 0x1a4, virtual true, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method ToString, addr 0x67f3a70, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW ToString();
...
public:
  ...
  /// @brief Method .ctor, addr 0x67f3b20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x67f38c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
