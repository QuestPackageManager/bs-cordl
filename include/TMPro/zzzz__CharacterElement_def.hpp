...
/// @brief Method .ctor, addr 0x67eec00, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::TMPro::TMP_TextElement*  textElement) ;

/// @brief Method get_Unicode, addr 0x67eebf0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_Unicode() ;

/// @brief Method set_Unicode, addr 0x67eebf8, size 0x8, virtual false, abstract: false, final false
