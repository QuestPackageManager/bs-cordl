...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x68191a4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint32_t firstGlyphIndex, uint32_t secondGlyphIndex);

  /// @brief Method .ctor, addr 0x68191b4, size 0x24, virtual false, abstract: false, final false
