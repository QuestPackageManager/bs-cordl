...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x6959800, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(uint32_t firstGlyphIndex, uint32_t secondGlyphIndex);

  /// @brief Method .ctor, addr 0x6959810, size 0x24, virtual false, abstract: false, final false
