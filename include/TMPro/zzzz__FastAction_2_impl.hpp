...
template <typename A, typename B> inline void TMPro::FastAction_2<A, B>::Add(::System::Action_2<A, B>* rhs) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_2<A, B>*>(), { "Add", {}, { ::i2c::type_of<::System::Action_2<A, B>*>() } })));
...
template <typename A, typename B> inline void TMPro::FastAction_2<A, B>::Remove(::System::Action_2<A, B>* rhs) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_2<A, B>*>(), { "Remove", {}, { ::i2c::type_of<::System::Action_2<A, B>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, rhs);
}
template <typename A, typename B> inline void TMPro::FastAction_2<A, B>::Call(A a, B b) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_2<A, B>*>(), { "Call", {}, { ::i2c::type_of<A>(), ::i2c::type_of<B>() } })));
...
template <typename A, typename B> inline void TMPro::FastAction_2<A, B>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::TMPro::FastAction_2<A, B>*>(), { ".ctor", {}, {} })));
