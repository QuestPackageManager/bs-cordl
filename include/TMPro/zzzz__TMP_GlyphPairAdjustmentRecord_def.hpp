...
namespace TMPro {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12269)), TypeDefinitionIndex(TypeDefinitionIndex(12271))]
...
public:
  ...
  /// @brief Method get_firstAdjustmentRecord, addr 0x2c0edac, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_firstAdjustmentRecord();

  /// @brief Method set_firstAdjustmentRecord, addr 0x2c0edc0, size 0x14, virtual false, abstract: false, final false
  inline void set_firstAdjustmentRecord(::TMPro::TMP_GlyphAdjustmentRecord value);

  /// @brief Method get_secondAdjustmentRecord, addr 0x2c0edd4, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_secondAdjustmentRecord();

  /// @brief Method set_secondAdjustmentRecord, addr 0x2c0ede8, size 0x14, virtual false, abstract: false, final false
  inline void set_secondAdjustmentRecord(::TMPro::TMP_GlyphAdjustmentRecord value);

  /// @brief Method get_featureLookupFlags, addr 0x2c0edfc, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::FontFeatureLookupFlags get_featureLookupFlags();

  /// @brief Method set_featureLookupFlags, addr 0x2c0ee04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c0c59c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c0ba8c, size 0xb4, virtual false, abstract: false, final false
