...
public:
  ...
  /// @brief Method .ctor, addr 0x69597b4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x69597d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord glyphPairAdjustmentRecord);

  /// @brief Method get_featureLookupFlags, addr 0x69597a4, size 0x8, virtual false, abstract: false, final false
  inline ::TMPro::FontFeatureLookupFlags get_featureLookupFlags();

  /// @brief Method get_firstAdjustmentRecord, addr 0x6959754, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_firstAdjustmentRecord();

  /// @brief Method get_secondAdjustmentRecord, addr 0x695977c, size 0x14, virtual false, abstract: false, final false
  inline ::TMPro::TMP_GlyphAdjustmentRecord get_secondAdjustmentRecord();

  /// @brief Method set_featureLookupFlags, addr 0x69597ac, size 0x8, virtual false, abstract: false, final false
  inline void set_featureLookupFlags(::TMPro::FontFeatureLookupFlags value);

  /// @brief Method set_firstAdjustmentRecord, addr 0x6959768, size 0x14, virtual false, abstract: false, final false
  inline void set_firstAdjustmentRecord(::TMPro::TMP_GlyphAdjustmentRecord value);

  /// @brief Method set_secondAdjustmentRecord, addr 0x6959790, size 0x14, virtual false, abstract: false, final false
