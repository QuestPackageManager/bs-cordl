...
DEFINE_IL2CPP_CLASS(::TMPro::KerningPairKey, "TMPro", "KerningPairKey");
// Dependencies
namespace TMPro {
// Is value type: true
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x695caf8, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::TMPro::KerningPairKey) == 0xc, "Size mismatch!");
