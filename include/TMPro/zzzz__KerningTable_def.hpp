...
public:
  ...
  /// @brief Method <AddKerningPair>b__0, addr 0x2d5628c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d55d18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddGlyphPairAdjustmentRecord>b__0, addr 0x2d562c8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d55f18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveKerningPair>b__0, addr 0x2d56304, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d56040, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SortKerningPairs>b__7_0, addr 0x2d563ac, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortKerningPairs_b__7_0(::TMPro::KerningPair* s);

  /// @brief Method <SortKerningPairs>b__7_1, addr 0x2d563c4, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortKerningPairs_b__7_1(::TMPro::KerningPair* s);

  /// @brief Method .ctor, addr 0x2d563a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddGlyphPairAdjustmentRecord, addr 0x2d55d20, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKerningPair, addr 0x2d55b60, size 0x1b8, virtual false, abstract: false, final false
  inline int32_t AddKerningPair(uint32_t first, uint32_t second, float_t offset);

  /// @brief Method AddKerningPair, addr 0x2d5598c, size 0x1d4, virtual false, abstract: false, final false
  inline void AddKerningPair();

  static inline ::TMPro::KerningTable* New_ctor();

  /// @brief Method RemoveKerningPair, addr 0x2d56048, size 0x58, virtual false, abstract: false, final false
  inline void RemoveKerningPair(int32_t index);

  /// @brief Method RemoveKerningPair, addr 0x2d55f20, size 0x120, virtual false, abstract: false, final false
  inline void RemoveKerningPair(int32_t left, int32_t right);

  /// @brief Method SortKerningPairs, addr 0x2d560a0, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2d55204, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
