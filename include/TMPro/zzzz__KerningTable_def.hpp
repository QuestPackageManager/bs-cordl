...
public:
  ...
  /// @brief Method <SortKerningPairs>b__7_0, addr 0x47e2828, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortKerningPairs_b__7_0(::TMPro::KerningPair* s);

  /// @brief Method <SortKerningPairs>b__7_1, addr 0x47e2840, size 0x18, virtual false, abstract: false, final false
  inline uint32_t _SortKerningPairs_b__7_1(::TMPro::KerningPair* s);

  /// @brief Method .ctor, addr 0x47e2820, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddKerningPair>b__0, addr 0x47e2858, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47e2260, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddGlyphPairAdjustmentRecord>b__0, addr 0x47e2894, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47e2454, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveKerningPair>b__0, addr 0x47e28d0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47e2578, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddGlyphPairAdjustmentRecord, addr 0x47e2268, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method AddKerningPair, addr 0x47e20b4, size 0x1ac, virtual false, abstract: false, final false
  inline int32_t AddKerningPair(uint32_t first, uint32_t second, float_t offset);

  /// @brief Method AddKerningPair, addr 0x47e1ee0, size 0x1d4, virtual false, abstract: false, final false
  inline void AddKerningPair();

  static inline ::TMPro::KerningTable* New_ctor();

  /// @brief Method RemoveKerningPair, addr 0x47e2580, size 0x58, virtual false, abstract: false, final false
  inline void RemoveKerningPair(int32_t index);

  /// @brief Method RemoveKerningPair, addr 0x47e245c, size 0x11c, virtual false, abstract: false, final false
  inline void RemoveKerningPair(int32_t left, int32_t right);

  /// @brief Method SortKerningPairs, addr 0x47e25d8, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47e1778, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
