...
static_assert(::cordl_internals::size_check_v<::TMPro::TextProcessingElementType, 0x4>, "Size mismatch!");

} // namespace TMPro
DEFINE_IL2CPP_ARG_TYPE(::TMPro::TextProcessingElementType, "TMPro", "TextProcessingElementType");
