...
/// @brief Method get_baseMarkGlyphAnchorPoint, addr 0x677faa0, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::GlyphAnchorPoint get_baseMarkGlyphAnchorPoint() ;

/// @brief Method get_baseMarkGlyphID, addr 0x677fa90, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_baseMarkGlyphID() ;

/// @brief Method get_combiningMarkGlyphID, addr 0x677fab0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_combiningMarkGlyphID() ;

/// @brief Method get_combiningMarkPositionAdjustment, addr 0x677fac0, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::MarkPositionAdjustment get_combiningMarkPositionAdjustment() ;

/// @brief Method set_baseMarkGlyphAnchorPoint, addr 0x677faa8, size 0x8, virtual false, abstract: false, final false
inline void set_baseMarkGlyphAnchorPoint(::TMPro::GlyphAnchorPoint  value) ;

/// @brief Method set_baseMarkGlyphID, addr 0x677fa98, size 0x8, virtual false, abstract: false, final false
inline void set_baseMarkGlyphID(uint32_t  value) ;

/// @brief Method set_combiningMarkGlyphID, addr 0x677fab8, size 0x8, virtual false, abstract: false, final false
inline void set_combiningMarkGlyphID(uint32_t  value) ;

/// @brief Method set_combiningMarkPositionAdjustment, addr 0x677fac8, size 0x8, virtual false, abstract: false, final false
