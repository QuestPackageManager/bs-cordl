...
public:
  ...
  /// @brief Method .ctor, addr 0x6802d98, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6802d8c, size 0xc, virtual false, abstract: false, final false
