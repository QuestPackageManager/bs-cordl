...
public:
  ...
  /// @brief Method .ctor, addr 0x335eb28, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335eaf0, size 0x38, virtual false, abstract: false, final false
