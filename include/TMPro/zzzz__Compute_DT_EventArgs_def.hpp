...
public:
  ...
  /// @brief Method .ctor, addr 0x69433f4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::TMPro::Compute_DistanceTransform_EventTypes type, ::ArrayW<::UnityEngine::Color> colors);

  /// @brief Method .ctor, addr 0x69433e8, size 0xc, virtual false, abstract: false, final false
