...
public:
  ...
  /// @brief Method .ctor, addr 0x47c937c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x47c9344, size 0x38, virtual false, abstract: false, final false
