...
public:
  ...
  /// @brief Method .ctor, addr 0x2bfbf5c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bfbf94, size 0x30, virtual false, abstract: false, final false
