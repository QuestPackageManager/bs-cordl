...
public:
// Declarations
/// @brief Method Add, addr 0x67ef0c8, size 0x104, virtual false, abstract: false, final false
inline uint8_t Add(::TMPro::FontStyles  style) ;

/// @brief Method Clear, addr 0x67ef0bc, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x67ef1cc, size 0x14c, virtual false, abstract: false, final false
