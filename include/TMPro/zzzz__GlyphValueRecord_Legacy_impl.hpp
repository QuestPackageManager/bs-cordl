...
// Ctor Parameters [CppParam { name: "xPlacement", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "yPlacement", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "xAdvance", ty: "float_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "yAdvance", ty: "float_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
