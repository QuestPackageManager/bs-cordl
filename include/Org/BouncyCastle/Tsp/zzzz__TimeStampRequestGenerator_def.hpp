...
public:
  ...
  /// @brief Method AddExtension, addr 0x3560ee8, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method AddExtension, addr 0x3560e9c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method AddExtension, addr 0x3560cc4, size 0x1d8, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method AddExtension, addr 0x3560c80, size 0x44, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method Generate, addr 0x356135c, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x3561374, size 0x14, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Tsp::TimeStampRequest* Generate(::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestAlgorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest,
                                                              ::Org::BouncyCastle::Math::BigInteger* nonce);

  /// @brief Method Generate, addr 0x3561090, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Tsp::TimeStampRequest* Generate(::StringW digestAlgorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest);

  /// @brief Method Generate, addr 0x3561098, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCertReq, addr 0x3560c10, size 0x70, virtual false, abstract: false, final false
  inline void SetCertReq(bool certReq);

  /// @brief Method SetReqPolicy, addr 0x3560ba4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3561388, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
