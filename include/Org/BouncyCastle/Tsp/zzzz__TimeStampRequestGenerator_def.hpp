...
public:
  ...
  /// @brief Method SetReqPolicy, addr 0x117dd78, size 0x70, virtual false, abstract: false, final false
  inline void SetReqPolicy(::StringW reqPolicy);

  /// @brief Method SetCertReq, addr 0x117dde8, size 0x6c, virtual false, abstract: false, final false
  inline void SetCertReq(bool certReq);

  /// @brief Method AddExtension, addr 0x117de54, size 0x44, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method AddExtension, addr 0x117de98, size 0x1d8, virtual false, abstract: false, final false
  inline void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method AddExtension, addr 0x117e070, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method AddExtension, addr 0x117e0bc, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x117e264, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Tsp::TimeStampRequest* Generate(::StringW digestAlgorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest);

  /// @brief Method Generate, addr 0x117e26c, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x117e53c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x117e558, size 0x18, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Tsp::TimeStampRequest* Generate(::Org::BouncyCastle::Asn1::DerObjectIdentifier* digestAlgorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest,
                                                              ::Org::BouncyCastle::Math::BigInteger* nonce);

  static inline ::Org::BouncyCastle::Tsp::TimeStampRequestGenerator* New_ctor();

  /// @brief Method .ctor, addr 0x117e570, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
