...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TspValidationException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TspValidationException(TspValidationException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TspValidationException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TspValidationException(TspValidationExceptionconst&) = delete;
