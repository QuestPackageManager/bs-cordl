...
public:
  ...
  /// @brief Method .ctor, addr 0x34faea0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34f9a54, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, int32_t failureCode);

  /// @brief Method get_FailureCode, addr 0x3500a38, size 0x8, virtual false, abstract: false, final false
