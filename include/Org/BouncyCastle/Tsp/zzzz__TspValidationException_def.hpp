...
public:
  ...
  /// @brief Method .ctor, addr 0x13b27e8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13b136c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message, int32_t failureCode);

  /// @brief Method get_FailureCode, addr 0x13b865c, size 0x8, virtual false, abstract: false, final false
