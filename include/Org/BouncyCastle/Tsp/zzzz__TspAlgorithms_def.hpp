...
public:
  ...
  /// @brief Method .ctor, addr 0x3624564, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TspAlgorithms", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TspAlgorithms(TspAlgorithms&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TspAlgorithms", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TspAlgorithms(TspAlgorithmsconst&) = delete;
