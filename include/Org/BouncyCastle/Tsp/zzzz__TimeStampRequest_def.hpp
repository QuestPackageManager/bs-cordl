...
public:
  ...
  /// @brief Method GetEncoded, addr 0x25c6be0, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetExtension, addr 0x25c6c0c, size 0x14, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extension* GetExtension(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetExtensionOids, addr 0x25c6c20, size 0x58, virtual true, abstract: false, final false
  inline ::System::Collections::IList* GetExtensionOids();

  /// @brief Method GetMessageImprintDigest, addr 0x25c6308, size 0x24, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetMessageImprintDigest();

  /// @brief Method GetX509Extensions, addr 0x25c6d28, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Validate, addr 0x25c63b0, size 0x610, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c623c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* input);

  /// @brief Method .ctor, addr 0x25c60a4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> req);

  /// @brief Method .ctor, addr 0x25c606c, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Tsp::TimeStampReq* req);

  /// @brief Method .ctor, addr 0x25c6110, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1InputStream* str);

  /// @brief Method get_CertReq, addr 0x25c6384, size 0x2c, virtual false, abstract: false, final false
  inline bool get_CertReq();

  /// @brief Method get_Extensions, addr 0x25c69e4, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_Extensions();

  /// @brief Method get_HasExtensions, addr 0x25c6bfc, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasExtensions();

  /// @brief Method get_MessageImprintAlgOid, addr 0x25c62cc, size 0x3c, virtual false, abstract: false, final false
  inline ::StringW get_MessageImprintAlgOid();

  /// @brief Method get_Nonce, addr 0x25c6358, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Nonce();

  /// @brief Method get_ReqPolicy, addr 0x25c632c, size 0x2c, virtual false, abstract: false, final false
  inline ::StringW get_ReqPolicy();

  /// @brief Method get_Version, addr 0x25c62a8, size 0x24, virtual false, abstract: false, final false
