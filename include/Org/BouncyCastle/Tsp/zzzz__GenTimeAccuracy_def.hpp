...
public:
  ...
  /// @brief Method GetTimeComponent, addr 0x11e5514, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x11e5584, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e54c0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Tsp::Accuracy* accuracy);

  /// @brief Method get_Micros, addr 0x11e5558, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_Micros();

  /// @brief Method get_Millis, addr 0x11e552c, size 0x2c, virtual false, abstract: false, final false
  inline int32_t get_Millis();

  /// @brief Method get_Seconds, addr 0x11e54e8, size 0x2c, virtual false, abstract: false, final false
