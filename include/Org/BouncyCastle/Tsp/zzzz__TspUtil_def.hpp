...
public:
  ...
  /// @brief Method CreateDigestInstance, addr 0x25cd3c8, size 0x8c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigestInstance(::StringW digestAlgOID);

  /// @brief Method GetCriticalExtensionOids, addr 0x25cd454, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigestAlgName, addr 0x25cd2c0, size 0x108, virtual false, abstract: false, final false
  static inline ::StringW GetDigestAlgName(::StringW digestAlgOID);

  /// @brief Method GetDigestLength, addr 0x25c6a00, size 0x1e0, virtual false, abstract: false, final false
  static inline int32_t GetDigestLength(::StringW digestAlgOID);

  /// @brief Method GetExtensionOids, addr 0x25c6c78, size 0xb0, virtual false, abstract: false, final false
  static inline ::System::Collections::IList* GetExtensionOids(::Org::BouncyCastle::Asn1::X509::X509Extensions* extensions);

  /// @brief Method GetNonCriticalExtensionOids, addr 0x25cd824, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSignatureTimestamps, addr 0x25cc92c, size 0x994, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateCertificate, addr 0x25ca0b8, size 0x35c, virtual false, abstract: false, final false
  static inline void ValidateCertificate(::Org::BouncyCastle::X509::X509Certificate* cert);

  /// @brief Method .ctor, addr 0x25cd8d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
