...
public:
  ...
  /// @brief Method Generate, addr 0x25cc824, size 0x664, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAccuracyMicros, addr 0x25ceaa8, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMicros(int32_t accuracyMicros);

  /// @brief Method SetAccuracyMillis, addr 0x25ceaa0, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMillis(int32_t accuracyMillis);

  /// @brief Method SetAccuracySeconds, addr 0x25cea98, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracySeconds(int32_t accuracySeconds);

  /// @brief Method SetCertificates, addr 0x25cea88, size 0x8, virtual false, abstract: false, final false
  inline void SetCertificates(::Org::BouncyCastle::X509::Store::IX509Store* certificates);

  /// @brief Method SetCrls, addr 0x25cea90, size 0x8, virtual false, abstract: false, final false
  inline void SetCrls(::Org::BouncyCastle::X509::Store::IX509Store* crls);

  /// @brief Method SetOrdering, addr 0x25ceab0, size 0xc, virtual false, abstract: false, final false
  inline void SetOrdering(bool ordering);

  /// @brief Method SetTsa, addr 0x25ceabc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ce66c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ce678, size 0x410, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID, ::StringW tsaPolicyOID,
