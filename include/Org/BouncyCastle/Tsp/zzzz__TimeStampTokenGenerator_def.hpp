...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Tsp::TimeStampTokenGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Tsp::TimeStampTokenGenerator*, "Org.BouncyCastle.Tsp", "TimeStampTokenGenerator");
...
public:
  ...
  /// @brief Method Generate, addr 0x3621b88, size 0x6a0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetAccuracyMicros, addr 0x3623e9c, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMicros(int32_t accuracyMicros);

  /// @brief Method SetAccuracyMillis, addr 0x3623e94, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracyMillis(int32_t accuracyMillis);

  /// @brief Method SetAccuracySeconds, addr 0x3623e8c, size 0x8, virtual false, abstract: false, final false
  inline void SetAccuracySeconds(int32_t accuracySeconds);

  /// @brief Method SetCertificates, addr 0x3623e7c, size 0x8, virtual false, abstract: false, final false
  inline void SetCertificates(::Org::BouncyCastle::X509::Store::IX509Store* certificates);

  /// @brief Method SetCrls, addr 0x3623e84, size 0x8, virtual false, abstract: false, final false
  inline void SetCrls(::Org::BouncyCastle::X509::Store::IX509Store* crls);

  /// @brief Method SetOrdering, addr 0x3623ea4, size 0x8, virtual false, abstract: false, final false
  inline void SetOrdering(bool ordering);

  /// @brief Method SetTsa, addr 0x3623eac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3623a44, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3623a50, size 0x42c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* key, ::Org::BouncyCastle::X509::X509Certificate* cert, ::StringW digestOID, ::StringW tsaPolicyOID,
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TimeStampTokenGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TimeStampTokenGenerator(TimeStampTokenGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TimeStampTokenGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TimeStampTokenGenerator(TimeStampTokenGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Tsp::TimeStampTokenGenerator) == 0x68, "Size mismatch!");
