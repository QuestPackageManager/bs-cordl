...
public:
  ...
  /// @brief Method .ctor, addr 0x13c68b8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13c60a8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13c2dcc, size 0x70, virtual false, abstract: false, final false
