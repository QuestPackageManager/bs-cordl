...
public:
  ...
  /// @brief Method .ctor, addr 0x25d2e94, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25d27fc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25cf6d4, size 0x70, virtual false, abstract: false, final false
