...
public:
  ...
  /// @brief Method .ctor addr 0x10e32fc size 0x58 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Tsp::TspException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x10e2aec size 0x68 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Org::BouncyCastle::Tsp::TspException* New_ctor(::StringW message, ::System::Exception* e);

  /// @brief Method .ctor addr 0x10df810 size 0x70 virtual false final false
