...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TspException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TspException(TspException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TspException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TspException(TspExceptionconst&) = delete;
