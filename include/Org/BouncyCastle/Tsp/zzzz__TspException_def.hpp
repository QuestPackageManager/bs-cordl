...
public:
  ...
  /// @brief Method .ctor, addr 0x25cea94, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ce3fc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25cb2d4, size 0x70, virtual false, abstract: false, final false
