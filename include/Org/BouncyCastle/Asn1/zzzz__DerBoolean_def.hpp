...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x26381f8, size 0x98, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x2638290, size 0x74, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x2638174, size 0x84, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x262e4f4, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBoolean* FromOctetString(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method GetInstance, addr 0x2637f6c, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBoolean* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x2637e1c, size 0xe8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBoolean* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0x2637f04, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2638304, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2638094, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> val);

  /// @brief Method .ctor, addr 0x2638130, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsTrue, addr 0x2638164, size 0x10, virtual false, abstract: false, final false
