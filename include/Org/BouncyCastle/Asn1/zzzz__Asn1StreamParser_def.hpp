...
/// @brief Method ReadImplicit, addr 0x35c8f14, size 0x2ac, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadImplicit(bool  constructed, int32_t  tag) ;

/// @brief Method ReadIndef, addr 0x35c8da4, size 0x170, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadIndef(int32_t  tagValue) ;

/// @brief Method ReadObject, addr 0x35c9390, size 0x560, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject() ;

/// @brief Method ReadTaggedObject, addr 0x35c3bd4, size 0x288, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadTaggedObject(bool  constructed, int32_t  tag) ;

/// @brief Method ReadVector, addr 0x35c91d8, size 0x128, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* ReadVector() ;

/// @brief Method Set00Check, addr 0x35c98f0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35c8d24, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method .ctor, addr 0x35c3ba4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream) ;

/// @brief Method .ctor, addr 0x35c5314, size 0xe4, virtual false, abstract: false, final false
