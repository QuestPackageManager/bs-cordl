...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1StreamParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1StreamParser*, "Org.BouncyCastle.Asn1", "Asn1StreamParser");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_tmpBuffers, put = __cordl_internal_set_tmpBuffers)) ::ArrayW<::ArrayW<uint8_t>> tmpBuffers;

  static inline ::Org::BouncyCastle::Asn1::Asn1StreamParser* New_ctor(::ArrayW<uint8_t> encoding);
  ...
  /// @brief Method ReadImplicit, addr 0x36853cc, size 0x2ac, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadImplicit(bool constructed, int32_t tag);

  /// @brief Method ReadIndef, addr 0x368525c, size 0x170, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadIndef(int32_t tagValue);

  /// @brief Method ReadObject, addr 0x3685848, size 0x560, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ReadTaggedObject, addr 0x368008c, size 0x288, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadTaggedObject(bool constructed, int32_t tag);

  /// @brief Method ReadVector, addr 0x3685690, size 0x128, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* ReadVector();

  /// @brief Method Set00Check, addr 0x3685da8, size 0xa0, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::ArrayW<uint8_t>> const& __cordl_internal_get_tmpBuffers() const;

  constexpr ::ArrayW<::ArrayW<uint8_t>>& __cordl_internal_get_tmpBuffers();

  constexpr void __cordl_internal_set__in(::System::IO::Stream* value);

  constexpr void __cordl_internal_set__limit(int32_t value);

  constexpr void __cordl_internal_set_tmpBuffers(::ArrayW<::ArrayW<uint8_t>> value);

  /// @brief Method .ctor, addr 0x36851dc, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encoding);

  /// @brief Method .ctor, addr 0x368005c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream);

  /// @brief Method .ctor, addr 0x36817cc, size 0xe4, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::ArrayW<uint8_t>> ___tmpBuffers;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1StreamParser) == 0x28, "Size mismatch!");
