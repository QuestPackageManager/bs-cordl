...
public:
  ...
  /// @brief Method ReadObject, addr 0x26362c4, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x262dc20, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x262dbf8, size 0x28, virtual false, abstract: false, final false
