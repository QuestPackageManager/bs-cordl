...
public:
  ...
  /// @brief Method ReadObject, addr 0x2632814, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x262a170, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x262a148, size 0x28, virtual false, abstract: false, final false
