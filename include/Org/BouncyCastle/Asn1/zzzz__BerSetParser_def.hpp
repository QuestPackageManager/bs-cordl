...
public:
  ...
  /// @brief Method ReadObject, addr 0x14280cc, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x141f8d4, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x141f8ac, size 0x28, virtual false, abstract: false, final false
