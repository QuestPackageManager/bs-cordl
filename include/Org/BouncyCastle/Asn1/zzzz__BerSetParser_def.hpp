...
public:
  ...
  /// @brief Method ReadObject, addr 0x359088c, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x3588440, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3588438, size 0x8, virtual false, abstract: false, final false
