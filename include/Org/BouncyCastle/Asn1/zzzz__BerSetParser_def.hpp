...
public:
  ...
  /// @brief Method ReadObject, addr 0x132e138, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x1325940, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1325918, size 0x28, virtual false, abstract: false, final false
