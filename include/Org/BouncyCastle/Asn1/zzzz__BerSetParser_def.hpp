...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerSetParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerSetParser*, "Org.BouncyCastle.Asn1", "BerSetParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x368c3fc, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x3683fb0, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3683fa8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerSetParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerSetParser(BerSetParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerSetParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerSetParser(BerSetParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerSetParser) == 0x18, "Size mismatch!");
