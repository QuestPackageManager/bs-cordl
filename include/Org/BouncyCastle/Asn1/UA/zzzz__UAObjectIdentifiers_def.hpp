...
public:
  ...
  /// @brief Method .ctor, addr 0x3552a04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UAObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UAObjectIdentifiers(UAObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UAObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UAObjectIdentifiers(UAObjectIdentifiersconst&) = delete;
