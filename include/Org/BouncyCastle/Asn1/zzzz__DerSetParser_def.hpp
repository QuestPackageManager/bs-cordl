...
/// @brief Method ReadObject, addr 0x35d2b74, size 0x1c, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject() ;

/// @brief Method ToAsn1Object, addr 0x35d2b90, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x35c91c0, size 0x8, virtual false, abstract: false, final false
