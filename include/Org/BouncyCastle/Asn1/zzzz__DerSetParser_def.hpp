...
public:
  ...
  /// @brief Method ReadObject, addr 0x12596d8, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x12596f8, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x124f90c, size 0x28, virtual false, abstract: false, final false
