...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerSetParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerSetParser*, "Org.BouncyCastle.Asn1", "DerSetParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x36913b4, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x36913d0, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3687a00, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerSetParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerSetParser(DerSetParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerSetParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerSetParser(DerSetParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerSetParser) == 0x18, "Size mismatch!");
