...
public:
  ...
  /// @brief Method ReadObject, addr 0x35d1dd8, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x35d1df4, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35c8424, size 0x8, virtual false, abstract: false, final false
