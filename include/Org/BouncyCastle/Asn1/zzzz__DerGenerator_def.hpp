...
public:
  ...
  /// @brief Method WriteDerEncoded, addr 0x263a578, size 0x34, virtual false, abstract: false, final false
  static inline void WriteDerEncoded(::System::IO::Stream* outStr, int32_t tag, ::System::IO::Stream* inStr);

  /// @brief Method WriteDerEncoded, addr 0x263a438, size 0x60, virtual false, abstract: false, final false
  static inline void WriteDerEncoded(::System::IO::Stream* outStream, int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteDerEncoded, addr 0x263a498, size 0xe0, virtual false, abstract: false, final false
  inline void WriteDerEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteLength, addr 0x263a384, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263a30c, size 0x2c, virtual false, abstract: false, final false
