...
public:
  ...
  /// @brief Method WriteDerEncoded, addr 0x3569c88, size 0x34, virtual false, abstract: false, final false
  static inline void WriteDerEncoded(::System::IO::Stream* outStr, int32_t tag, ::System::IO::Stream* inStr);

  /// @brief Method WriteDerEncoded, addr 0x3569b48, size 0x60, virtual false, abstract: false, final false
  static inline void WriteDerEncoded(::System::IO::Stream* outStream, int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteDerEncoded, addr 0x3569ba8, size 0xe0, virtual false, abstract: false, final false
  inline void WriteDerEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteLength, addr 0x3569a8c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3569a68, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x3569a74, size 0x18, virtual false, abstract: false, final false
