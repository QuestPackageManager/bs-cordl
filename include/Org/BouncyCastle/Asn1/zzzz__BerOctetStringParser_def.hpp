...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x2634a58, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x262d9cc, size 0x154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x262d9a4, size 0x28, virtual false, abstract: false, final false
