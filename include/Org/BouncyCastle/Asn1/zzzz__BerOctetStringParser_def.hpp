...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x368ac78, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x3683dd0, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3683dc8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerOctetStringParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerOctetStringParser(BerOctetStringParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerOctetStringParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerOctetStringParser(BerOctetStringParserconst&) = delete;
