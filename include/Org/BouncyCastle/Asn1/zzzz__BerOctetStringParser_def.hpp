...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x2630fe8, size 0x64, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x2629f5c, size 0x154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2629f34, size 0x28, virtual false, abstract: false, final false
