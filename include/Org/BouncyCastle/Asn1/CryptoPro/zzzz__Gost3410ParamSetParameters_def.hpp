...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters*, "Org.BouncyCastle.Asn1.CryptoPro", "Gost3410ParamSetParameters");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x336e7e0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x336e7f4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336eabc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336e1d0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336e964, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_A, addr 0x336eaa8, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_A();

  /// @brief Method get_KeySize, addr 0x336ea78, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_P, addr 0x336ea80, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_Q, addr 0x336ea94, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Gost3410ParamSetParameters", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters) == 0x30, "Size mismatch!");
