...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Gost28147Parameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Gost28147Parameters(Gost28147Parameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Gost28147Parameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Gost28147Parameters(Gost28147Parametersconst&) = delete;
