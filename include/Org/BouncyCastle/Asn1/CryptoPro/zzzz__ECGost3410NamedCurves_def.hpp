...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0xf1afe8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureCurve, addr 0xf1b080, size 0x4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method GetByName, addr 0xf1d388, size 0x1ec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* GetByName(::StringW name);

  /// @brief Method GetByNameX9, addr 0xf1d574, size 0x144, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByNameX9(::StringW name);

  /// @brief Method GetByOid, addr 0xf1cf94, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetByOidX9, addr 0xf1d0b0, size 0x1cc, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOidX9(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetName, addr 0xf1d6b8, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0xf1d7b8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf1b084, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Names, addr 0xf1d27c, size 0x10c, virtual false, abstract: false, final false
