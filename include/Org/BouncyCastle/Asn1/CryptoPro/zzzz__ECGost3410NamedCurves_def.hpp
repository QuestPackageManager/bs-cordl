...
public:
  ...
  /// @brief Method ConfigureBasepoint addr 0xe148b0 size 0x98 virtual false final false
  ...
  /// @brief Method ConfigureCurve addr 0xe14948 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe1494c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method GetByOid addr 0xe1685c size 0x11c virtual false final false
  ...
  /// @brief Method GetByOidX9 addr 0xe16978 size 0x1cc virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOidX9(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method get_Names addr 0xe16b44 size 0x10c virtual false final false
  static inline ::System::Collections::IEnumerable* get_Names();

  /// @brief Method GetByName addr 0xe16c50 size 0x1ec virtual false final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* GetByName(::StringW name);

  /// @brief Method GetByNameX9 addr 0xe16e3c size 0x144 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByNameX9(::StringW name);

  /// @brief Method GetName addr 0xe16f80 size 0x100 virtual false final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid addr 0xe17080 size 0x11c virtual false final false
