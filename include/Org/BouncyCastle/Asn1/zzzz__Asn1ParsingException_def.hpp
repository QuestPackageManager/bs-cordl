...
public:
  ...
  /// @brief Method .ctor, addr 0x262f490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262f498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262f4a0, size 0x8, virtual false, abstract: false, final false
