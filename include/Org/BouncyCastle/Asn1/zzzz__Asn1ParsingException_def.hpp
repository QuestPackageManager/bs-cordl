...
public:
  ...
  /// @brief Method .ctor, addr 0x2633890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2633898, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x26338a0, size 0x8, virtual false, abstract: false, final false
