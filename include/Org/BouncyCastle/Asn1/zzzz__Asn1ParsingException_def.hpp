...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1ParsingException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1ParsingException*, "Org.BouncyCastle.Asn1", "Asn1ParsingException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36857e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36857e8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x368580c, size 0x24, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1ParsingException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asn1ParsingException(Asn1ParsingException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asn1ParsingException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1ParsingException(Asn1ParsingExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1ParsingException) == 0x90, "Size mismatch!");
