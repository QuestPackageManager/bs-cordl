...
public:
  ...
  /// @brief Method .ctor, addr 0x262fb58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262fb60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262fb68, size 0x8, virtual false, abstract: false, final false
