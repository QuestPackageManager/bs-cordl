...
public:
  ...
  /// @brief Method .ctor, addr 0x3683458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3683460, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3683484, size 0x24, virtual false, abstract: false, final false
