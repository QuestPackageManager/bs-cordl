...
public:
  ...
  /// @brief Method .ctor, addr 0x262e15c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262e164, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262e16c, size 0x8, virtual false, abstract: false, final false
