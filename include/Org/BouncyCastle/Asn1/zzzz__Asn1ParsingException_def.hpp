...
public:
  ...
  /// @brief Method .ctor, addr 0x25eedac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25eedb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25eedbc, size 0x8, virtual false, abstract: false, final false
