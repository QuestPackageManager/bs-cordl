...
public:
  ...
  /// @brief Method .ctor, addr 0x262ba20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262ba28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262ba30, size 0x8, virtual false, abstract: false, final false
