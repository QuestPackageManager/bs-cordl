...
public:
  ...
  /// @brief Method .ctor, addr 0x355f42c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x355f434, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x355f458, size 0x24, virtual false, abstract: false, final false
