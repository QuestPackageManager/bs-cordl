...
public:
  ...
  /// @brief Method .ctor, addr 0x124d6b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x124d6b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x124d6c0, size 0x8, virtual false, abstract: false, final false
