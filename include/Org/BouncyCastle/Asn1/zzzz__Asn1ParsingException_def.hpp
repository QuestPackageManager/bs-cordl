...
public:
  ...
  /// @brief Method .ctor, addr 0x262f520, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262f528, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262f530, size 0x8, virtual false, abstract: false, final false
