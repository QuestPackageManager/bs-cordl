...
public:
  ...
  /// @brief Method GetObjectParser, addr 0x1254e38, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x124ba6c, size 0xfc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x1254d84, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(int32_t baseTag, int32_t tagNumber, ::System::IO::Stream* contentStream);

  /// @brief Method .ctor, addr 0x124ba2c, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(bool constructed, int32_t tagNumber, ::Org::BouncyCastle::Asn1::Asn1StreamParser* parser);

  /// @brief Method get_IsConstructed, addr 0x1254e28, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsConstructed();

  /// @brief Method get_TagNo, addr 0x1254e30, size 0x8, virtual true, abstract: false, final true
