...
public:
  ...
  /// @brief Method GetObjectParser, addr 0x35910e0, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x3588160, size 0xf8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x359103c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(int32_t baseTag, int32_t tagNumber, ::System::IO::Stream* contentStream);

  /// @brief Method .ctor, addr 0x3588150, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool constructed, int32_t tagNumber, ::Org::BouncyCastle::Asn1::Asn1StreamParser* parser);

  /// @brief Method get_IsConstructed, addr 0x35910d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsConstructed();

  /// @brief Method get_TagNo, addr 0x35910d8, size 0x8, virtual true, abstract: false, final true
