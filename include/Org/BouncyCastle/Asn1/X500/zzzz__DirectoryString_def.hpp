...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f1a74, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10f17bc, size 0x290, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x10f1b5c, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x10f1b7c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f1a4c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerStringBase* str);

  /// @brief Method .ctor, addr 0x10f1ae0, size 0x7c, virtual false, abstract: false, final false
