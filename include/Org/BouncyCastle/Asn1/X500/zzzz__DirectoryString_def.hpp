...
public:
  ...
  /// @brief Method GetInstance, addr 0x3497f08, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3497c6c, size 0x294, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x3497fe8, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x3498004, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3497f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerStringBase* str);

  /// @brief Method .ctor, addr 0x3497f7c, size 0x6c, virtual false, abstract: false, final false
