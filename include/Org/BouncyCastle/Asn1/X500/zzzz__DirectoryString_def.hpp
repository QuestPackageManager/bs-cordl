...
// Dependencies Org.BouncyCastle.Asn1.Asn1Encodable, Org.BouncyCastle.Asn1.IAsn1Choice, Org.BouncyCastle.Asn1.IAsn1String
namespace Org::BouncyCastle::Asn1::X500 {
// Is value type: false
...
public:
  ...
  /// @brief Method GetInstance, addr 0x25019c4, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2501718, size 0x284, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x2501aa0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x2501ac0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250199c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerStringBase* str);

  /// @brief Method .ctor, addr 0x2501a2c, size 0x74, virtual false, abstract: false, final false
