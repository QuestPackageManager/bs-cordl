...
public:
  ...
  /// @brief Method GetFirst, addr 0x2501e08, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* GetFirst();

  /// @brief Method GetInstance, addr 0x2501b08, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::Rdn* GetInstance(::System::Object* obj);

  /// @brief Method GetTypesAndValues, addr 0x2501e58, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2501f4c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2501d48, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2501cd4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* attrTAndV);

  /// @brief Method .ctor, addr 0x2501ba8, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method .ctor, addr 0x2501ae0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* values);

  /// @brief Method get_Count, addr 0x2501de8, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsMultiValued, addr 0x2501dbc, size 0x2c, virtual true, abstract: false, final false
