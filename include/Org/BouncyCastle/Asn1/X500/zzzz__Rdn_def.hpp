...
public:
  ...
  /// @brief Method GetFirst, addr 0x12e0890, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* GetFirst();

  /// @brief Method GetInstance, addr 0x12e0570, size 0xa8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X500::Rdn* GetInstance(::System::Object* obj);

  /// @brief Method GetTypesAndValues, addr 0x12e08e0, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12e09d4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12e07c8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12e074c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* attrTAndV);

  /// @brief Method .ctor, addr 0x12e0618, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method .ctor, addr 0x12e0548, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* values);

  /// @brief Method get_Count, addr 0x12e0870, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_IsMultiValued, addr 0x12e0844, size 0x2c, virtual true, abstract: false, final false
