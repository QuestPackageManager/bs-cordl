...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Rdn", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Rdn(Rdn&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Rdn", modifiers: "const&", def_value: None, comment: None }]
