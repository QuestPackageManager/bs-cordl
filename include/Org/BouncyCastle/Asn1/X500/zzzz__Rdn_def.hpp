...
/// @brief Method GetFirst, addr 0x345bcc4, size 0x50, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue* GetFirst() ;

/// @brief Method GetInstance, addr 0x345b9e4, size 0x9c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X500::Rdn* GetInstance(::System::Object*  obj) ;

/// @brief Method GetTypesAndValues, addr 0x345bd14, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x345be0c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x345bc0c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x345bba4, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue*  attrTAndV) ;

/// @brief Method .ctor, addr 0x345ba80, size 0x124, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid, ::Org::BouncyCastle::Asn1::Asn1Encodable*  value) ;

/// @brief Method .ctor, addr 0x345b9dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set*  values) ;

/// @brief Method get_Count, addr 0x345bca8, size 0x1c, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsMultiValued, addr 0x345bc7c, size 0x2c, virtual true, abstract: false, final false
