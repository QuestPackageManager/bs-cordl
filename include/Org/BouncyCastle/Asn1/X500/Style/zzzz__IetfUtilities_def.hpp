...
public:
  // Declarations
  /// @brief Method ValueToString addr 0x100d828 size 0x4fc virtual false final false
  static inline ::StringW ValueToString(::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method Canonicalize addr 0x100dd24 size 0x2a4 virtual false final false
  static inline ::StringW Canonicalize(::StringW s);

  /// @brief Method CanonicalString addr 0x100e244 size 0x10 virtual false final false
  static inline ::StringW CanonicalString(::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method DecodeObject addr 0x100dfc8 size 0x150 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* DecodeObject(::StringW oValue);

  /// @brief Method StripInternalSpaces addr 0x100e118 size 0x12c virtual false final false
  static inline ::StringW StripInternalSpaces(::StringW str);

  /// @brief Method RdnAreEqual addr 0x100e254 size 0xe8 virtual false final false
  static inline bool RdnAreEqual(::Org::BouncyCastle::Asn1::X500::Rdn* rdn1, ::Org::BouncyCastle::Asn1::X500::Rdn* rdn2);

  /// @brief Method AtvAreEqual addr 0x100e33c size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0x100e408 size 0x8 virtual false final false
  inline void _ctor();
