...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EdECObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EdECObjectIdentifiers(EdECObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EdECObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EdECObjectIdentifiers(EdECObjectIdentifiersconst&) = delete;
