...
public:
  ...
  /// @brief Method GetInstance, addr 0x345deb0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x345dec4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345e190, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345e120, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method .ctor, addr 0x345e128, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* issuer, ::Org::BouncyCastle::Asn1::Asn1Object* locator);

  /// @brief Method .ctor, addr 0x345e048, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x345e180, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer();

  /// @brief Method get_Locator, addr 0x345e188, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServiceLocator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServiceLocator(ServiceLocator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServiceLocator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServiceLocator(ServiceLocatorconst&) = delete;
