...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcspRequest(OcspRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcspRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcspRequest(OcspRequestconst&) = delete;
