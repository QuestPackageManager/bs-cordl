...
public:
  ...
  /// @brief Method GetInstance, addr 0x11f4da4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x11f1160, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11f519c, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f50f0, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* requestorName, ::Org::BouncyCastle::Asn1::Asn1Sequence* requestList,
                    ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method .ctor, addr 0x11f4e1c, size 0x2d4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  static inline ::Org::BouncyCastle::Asn1::DerInteger* getStaticF_V1();

  /// @brief Method get_RequestExtensions, addr 0x11f5194, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_RequestList, addr 0x11f518c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_RequestList();

  /// @brief Method get_RequestorName, addr 0x11f5184, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_RequestorName();

  /// @brief Method get_Version, addr 0x11f517c, size 0x8, virtual false, abstract: false, final false
