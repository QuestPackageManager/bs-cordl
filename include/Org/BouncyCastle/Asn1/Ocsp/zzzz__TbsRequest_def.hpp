...
public:
  ...
  /// @brief Method GetInstance, addr 0x240927c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x240576c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2409670, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24095c4, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* requestorName, ::Org::BouncyCastle::Asn1::Asn1Sequence* requestList,
                    ::Org::BouncyCastle::Asn1::X509::X509Extensions* requestExtensions);

  /// @brief Method .ctor, addr 0x24092f4, size 0x2d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  static inline ::Org::BouncyCastle::Asn1::DerInteger* getStaticF_V1();

  /// @brief Method get_RequestExtensions, addr 0x2409668, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions();

  /// @brief Method get_RequestList, addr 0x2409660, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_RequestList();

  /// @brief Method get_RequestorName, addr 0x2409658, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_RequestorName();

  /// @brief Method get_Version, addr 0x2409650, size 0x8, virtual false, abstract: false, final false
