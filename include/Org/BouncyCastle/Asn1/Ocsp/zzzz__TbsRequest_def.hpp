...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TbsRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TbsRequest(TbsRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TbsRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TbsRequest(TbsRequestconst&) = delete;
