...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::OcspObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::OcspObjectIdentifiers*, "Org.BouncyCastle.Asn1.Ocsp", "OcspObjectIdentifiers");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::OcspObjectIdentifiers) == 0x10, "Size mismatch!");
