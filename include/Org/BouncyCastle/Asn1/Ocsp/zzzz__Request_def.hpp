...
public:
  ...
  /// @brief Method GetInstance, addr 0x24059a8, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::Request* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x24059c0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2405ce8, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2405c60, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2405b3c, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ReqCert, addr 0x2405cd8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* get_ReqCert();

  /// @brief Method get_SingleRequestExtensions, addr 0x2405ce0, size 0x8, virtual false, abstract: false, final false
