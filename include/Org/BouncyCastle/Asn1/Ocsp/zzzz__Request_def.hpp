...
public:
  ...
  /// @brief Method GetInstance, addr 0x345c574, size 0x14, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::Request* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x345c588, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345c89c, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345c834, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345c70c, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ReqCert, addr 0x345c88c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* get_ReqCert();

  /// @brief Method get_SingleRequestExtensions, addr 0x345c894, size 0x8, virtual false, abstract: false, final false
