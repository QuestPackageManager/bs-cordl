...
public:
  ...
  /// @brief Method .ctor, addr 0x335fe4c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* value);

  /// @brief Method .ctor, addr 0x336099c, size 0x68, virtual false, abstract: false, final false
