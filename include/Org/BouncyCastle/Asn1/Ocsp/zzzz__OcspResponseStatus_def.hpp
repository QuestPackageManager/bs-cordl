...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::OcspResponseStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::OcspResponseStatus*, "Org.BouncyCastle.Asn1.Ocsp", "OcspResponseStatus");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3459634, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* value);

  /// @brief Method .ctor, addr 0x345a184, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::OcspResponseStatus) == 0x20, "Size mismatch!");
