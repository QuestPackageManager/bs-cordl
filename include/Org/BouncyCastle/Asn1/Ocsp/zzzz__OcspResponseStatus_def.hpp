...
public:
  ...
  /// @brief Method .ctor, addr 0x1012a78, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* value);

  /// @brief Method .ctor, addr 0x10135cc, size 0x64, virtual false, abstract: false, final false
