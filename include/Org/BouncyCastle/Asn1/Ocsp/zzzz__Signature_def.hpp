...
public:
  ...
  /// @brief Method GetInstance, addr 0xff1dd4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xff4d14, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::Signature* GetInstance(::System::Object* obj);

  /// @brief Method GetSignatureOctets, addr 0xff50d4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xff50fc, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff4e9c, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0xff5008, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff5010, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Certs, addr 0xff50f4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_Certs();

  /// @brief Method get_SignatureAlgorithm, addr 0xff50c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm();

  /// @brief Method get_SignatureValue, addr 0xff50cc, size 0x8, virtual false, abstract: false, final false
