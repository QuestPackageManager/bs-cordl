...
public:
  ...
  /// @brief Method GetInstance, addr 0x2403458, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x2403470, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x240376c, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240370c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24035ec, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x240374c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_IssuerKeyHash, addr 0x240375c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_IssuerKeyHash();

  /// @brief Method get_IssuerNameHash, addr 0x2403754, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_IssuerNameHash();

  /// @brief Method get_SerialNumber, addr 0x2403764, size 0x8, virtual false, abstract: false, final false
