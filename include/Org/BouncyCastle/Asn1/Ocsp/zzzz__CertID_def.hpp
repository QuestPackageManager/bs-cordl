...
public:
  ...
  /// @brief Method GetInstance, addr 0x24057e8, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x2405800, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2405afc, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2405a9c, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240597c, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x2405adc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_IssuerKeyHash, addr 0x2405aec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_IssuerKeyHash();

  /// @brief Method get_IssuerNameHash, addr 0x2405ae4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_IssuerNameHash();

  /// @brief Method get_SerialNumber, addr 0x2405af4, size 0x8, virtual false, abstract: false, final false
