...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::CertStatus*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::CertStatus*, "Org.BouncyCastle.Asn1.Ocsp", "CertStatus");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x345a670, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345a804, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345a4c0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x345a544, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* choice);

  /// @brief Method .ctor, addr 0x345a528, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo* info);

  /// @brief Method .ctor, addr 0x345a538, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_Status, addr 0x345a7fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Status();

  /// @brief Method get_TagNo, addr 0x345a7f4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertStatus", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertStatus(CertStatus&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertStatus", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertStatus(CertStatusconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::CertStatus) == 0x20, "Size mismatch!");
