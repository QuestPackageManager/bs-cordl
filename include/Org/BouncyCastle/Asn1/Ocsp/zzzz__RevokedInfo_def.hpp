...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo*, "Org.BouncyCastle.Asn1.Ocsp", "RevokedInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x345a65c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x345d9d8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345dd98, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345dd28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerGeneralizedTime* revocationTime);

  /// @brief Method .ctor, addr 0x345dd30, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345db5c, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_RevocationReason, addr 0x345dd90, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::CrlReason* get_RevocationReason();

  /// @brief Method get_RevocationTime, addr 0x345dd88, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevokedInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevokedInfo(RevokedInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevokedInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevokedInfo(RevokedInfoconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo) == 0x20, "Size mismatch!");
