...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ocsp::ResponseBytes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ocsp::ResponseBytes*, "Org.BouncyCastle.Asn1.Ocsp", "ResponseBytes");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x345ba34, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x345cebc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345d1fc, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345d16c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* responseType, ::Org::BouncyCastle::Asn1::Asn1OctetString* response);

  /// @brief Method .ctor, addr 0x345d040, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Response, addr 0x345d1f4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Response();

  /// @brief Method get_ResponseType, addr 0x345d1ec, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResponseBytes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResponseBytes(ResponseBytes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResponseBytes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResponseBytes(ResponseBytesconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ocsp::ResponseBytes) == 0x20, "Size mismatch!");
