...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x11def14, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11deb3c, size 0x3c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlNum, addr 0x11def04, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CrlNum();

  /// @brief Method get_CrlTime, addr 0x11def0c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_CrlTime();

  /// @brief Method get_CrlUrl, addr 0x11deefc, size 0x8, virtual false, abstract: false, final false
