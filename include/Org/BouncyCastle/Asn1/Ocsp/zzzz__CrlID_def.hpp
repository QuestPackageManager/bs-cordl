...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x24063dc, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2406010, size 0x3b4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlNum, addr 0x24063cc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CrlNum();

  /// @brief Method get_CrlTime, addr 0x24063d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_CrlTime();

  /// @brief Method get_CrlUrl, addr 0x24063c4, size 0x8, virtual false, abstract: false, final false
