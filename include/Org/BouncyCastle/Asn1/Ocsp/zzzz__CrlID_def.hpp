...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x3334864, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33344bc, size 0x390, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlNum, addr 0x3334854, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CrlNum();

  /// @brief Method get_CrlTime, addr 0x333485c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_CrlTime();

  /// @brief Method get_CrlUrl, addr 0x333484c, size 0x8, virtual false, abstract: false, final false
