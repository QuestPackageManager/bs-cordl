...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspResponse", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcspResponse(OcspResponse&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcspResponse", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcspResponse(OcspResponseconst&) = delete;
