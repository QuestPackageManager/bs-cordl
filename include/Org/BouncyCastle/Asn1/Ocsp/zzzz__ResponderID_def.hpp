...
public:
  ...
  /// @brief Method GetInstance, addr 0x2408410, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2408140, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x240842c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2408564, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2408328, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x240839c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x24084b4, size 0xb0, virtual true, abstract: false, final false
