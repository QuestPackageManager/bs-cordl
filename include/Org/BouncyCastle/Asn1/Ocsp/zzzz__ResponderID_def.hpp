...
public:
  ...
  /// @brief Method GetInstance, addr 0x10ed8f4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10ed618, size 0x1ec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x10ed910, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10eda48, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10ed804, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x10ed87c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x10ed998, size 0xb0, virtual true, abstract: false, final false
