...
public:
  ...
  /// @brief Method GetInstance, addr 0x24049a0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x24046d0, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x24049bc, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2404af4, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24048b8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x240492c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x2404a44, size 0xb0, virtual true, abstract: false, final false
