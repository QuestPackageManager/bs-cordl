...
public:
  ...
  /// @brief Method GetInstance, addr 0x345cc4c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x345c9b4, size 0x1e8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyHash, addr 0x345cc74, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345cdb8, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345cb9c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x345cbf4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* id);

  /// @brief Method get_Name, addr 0x345cd00, size 0xb8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ResponderID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ResponderID(ResponderID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ResponderID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ResponderID(ResponderIDconst&) = delete;
