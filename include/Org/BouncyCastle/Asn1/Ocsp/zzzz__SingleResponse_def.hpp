...
public:
  ...
  /// @brief Method .ctor, addr 0xfaf26c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfaf2bc, size 0x2b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0xfaf574, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xfaf58c, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ocsp::SingleResponse* GetInstance(::System::Object* obj);

  /// @brief Method get_CertId, addr 0xfaf714, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::CertID* get_CertId();

  /// @brief Method get_CertStatus, addr 0xfaf71c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::CertStatus* get_CertStatus();

  /// @brief Method get_ThisUpdate, addr 0xfaf724, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_ThisUpdate();

  /// @brief Method get_NextUpdate, addr 0xfaf72c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NextUpdate();

  /// @brief Method get_SingleExtensions, addr 0xfaf734, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_SingleExtensions();

  /// @brief Method ToAsn1Object, addr 0xfaf73c, size 0x184, virtual true, abstract: false, final false
