...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x263613c, size 0x98, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x263610c, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x2635f68, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2635e80, size 0xe8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerGeneralString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x2636100, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetString, addr 0x26360f8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262ab50, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str);

  /// @brief Method .ctor, addr 0x2636084, size 0x74, virtual false, abstract: false, final false
