...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x1257fdc, size 0xa0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x1257fac, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x1257de0, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1257cf0, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerGeneralString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x1257fa0, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetString, addr 0x1257f98, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x124c7dc, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str);

  /// @brief Method .ctor, addr 0x1257f20, size 0x78, virtual false, abstract: false, final false
