...
/// @brief Method Asn1Equals, addr 0x35cffb4, size 0x148, virtual true, abstract: false, final false
inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object*  asn1Object) ;

/// @brief Method Asn1GetHashCode, addr 0x35cff40, size 0x74, virtual true, abstract: false, final false
inline int32_t Asn1GetHashCode() ;

/// @brief Method Encode, addr 0x35cfdf4, size 0xfc, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream*  derOut) ;

/// @brief Method GetObjFromVector, addr 0x35cfc30, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method WriteEncodable, addr 0x35cfef0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35cfdac, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35cfd4c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35c3ed0, size 0x2f4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector*  vector) ;

/// @brief Method get_DataValueDescriptor, addr 0x35d00fc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_DataValueDescriptor() ;

/// @brief Method get_DirectReference, addr 0x35d010c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DirectReference() ;

/// @brief Method get_Encoding, addr 0x35d011c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Encoding() ;

/// @brief Method get_ExternalContent, addr 0x35d0124, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_ExternalContent() ;

/// @brief Method get_IndirectReference, addr 0x35d0134, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerInteger* get_IndirectReference() ;

/// @brief Method set_DataValueDescriptor, addr 0x35d0104, size 0x8, virtual false, abstract: false, final false
inline void set_DataValueDescriptor(::Org::BouncyCastle::Asn1::Asn1Object*  value) ;

/// @brief Method set_DirectReference, addr 0x35d0114, size 0x8, virtual false, abstract: false, final false
inline void set_DirectReference(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  value) ;

/// @brief Method set_Encoding, addr 0x35cfcc4, size 0x88, virtual false, abstract: false, final false
inline void set_Encoding(int32_t  value) ;

/// @brief Method set_ExternalContent, addr 0x35d012c, size 0x8, virtual false, abstract: false, final false
inline void set_ExternalContent(::Org::BouncyCastle::Asn1::Asn1Object*  value) ;

/// @brief Method set_IndirectReference, addr 0x35d013c, size 0x8, virtual false, abstract: false, final false
