...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerExternal", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerExternal(DerExternal&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerExternal", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerExternal(DerExternalconst&) = delete;
