...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerExternal*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerExternal*, "Org.BouncyCastle.Asn1", "DerExternal");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368c46c, size 0x148, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x368c3f8, size 0x74, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x368c2ac, size 0xfc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetObjFromVector, addr 0x368c0e8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEncodable, addr 0x368c3a8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368c264, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368c204, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* directReference, ::Org::BouncyCastle::Asn1::DerInteger* indirectReference,
                    ::Org::BouncyCastle::Asn1::Asn1Object* dataValueDescriptor, ::Org::BouncyCastle::Asn1::DerTaggedObject* externalData);

  /// @brief Method .ctor, addr 0x3680388, size 0x2f4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* vector);

  /// @brief Method get_DataValueDescriptor, addr 0x368c5b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_DataValueDescriptor();

  /// @brief Method get_DirectReference, addr 0x368c5c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DirectReference();

  /// @brief Method get_Encoding, addr 0x368c5d4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Encoding();

  /// @brief Method get_ExternalContent, addr 0x368c5dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_ExternalContent();

  /// @brief Method get_IndirectReference, addr 0x368c5ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_IndirectReference();

  /// @brief Method set_DataValueDescriptor, addr 0x368c5bc, size 0x8, virtual false, abstract: false, final false
  inline void set_DataValueDescriptor(::Org::BouncyCastle::Asn1::Asn1Object* value);

  /// @brief Method set_DirectReference, addr 0x368c5cc, size 0x8, virtual false, abstract: false, final false
  inline void set_DirectReference(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_Encoding, addr 0x368c17c, size 0x88, virtual false, abstract: false, final false
  inline void set_Encoding(int32_t value);

  /// @brief Method set_ExternalContent, addr 0x368c5e4, size 0x8, virtual false, abstract: false, final false
  inline void set_ExternalContent(::Org::BouncyCastle::Asn1::Asn1Object* value);

  /// @brief Method set_IndirectReference, addr 0x368c5f4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerExternal) == 0x38, "Size mismatch!");
