...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x26387c8, size 0xe4, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x2638754, size 0x74, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x2638600, size 0x104, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetObjFromVector, addr 0x2638404, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteEncodable, addr 0x2638704, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263858c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263852c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* directReference, ::Org::BouncyCastle::Asn1::DerInteger* indirectReference,
                    ::Org::BouncyCastle::Asn1::Asn1Object* dataValueDescriptor, ::Org::BouncyCastle::Asn1::DerTaggedObject* externalData);

  /// @brief Method .ctor, addr 0x262c368, size 0x2e8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* vector);

  /// @brief Method get_DataValueDescriptor, addr 0x26388ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_DataValueDescriptor();

  /// @brief Method get_DirectReference, addr 0x26388bc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_DirectReference();

  /// @brief Method get_Encoding, addr 0x26388cc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Encoding();

  /// @brief Method get_ExternalContent, addr 0x26388d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_ExternalContent();

  /// @brief Method get_IndirectReference, addr 0x26388e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_IndirectReference();

  /// @brief Method set_DataValueDescriptor, addr 0x26388b4, size 0x8, virtual false, abstract: false, final false
  inline void set_DataValueDescriptor(::Org::BouncyCastle::Asn1::Asn1Object* value);

  /// @brief Method set_DirectReference, addr 0x26388c4, size 0x8, virtual false, abstract: false, final false
  inline void set_DirectReference(::Org::BouncyCastle::Asn1::DerObjectIdentifier* value);

  /// @brief Method set_Encoding, addr 0x2638498, size 0x94, virtual false, abstract: false, final false
  inline void set_Encoding(int32_t value);

  /// @brief Method set_ExternalContent, addr 0x26388dc, size 0x8, virtual false, abstract: false, final false
  inline void set_ExternalContent(::Org::BouncyCastle::Asn1::Asn1Object* value);

  /// @brief Method set_IndirectReference, addr 0x26388ec, size 0x8, virtual false, abstract: false, final false
