...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x111e2a0, size 0xa0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x111e284, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Branch, addr 0x111d910, size 0x70, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Branch(::StringW branchID);

  /// @brief Method DoOutput, addr 0x111df90, size 0x1b4, virtual false, abstract: false, final false
  inline void DoOutput(::System::IO::MemoryStream* bOut);

  /// @brief Method Encode, addr 0x111e258, size 0x2c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x111d308, size 0x238, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* FromOctetString(::ArrayW<uint8_t, ::Array<uint8_t>*> enc);

  /// @brief Method GetBody, addr 0x111e144, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBody();

  /// @brief Method GetInstance, addr 0x111d540, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1109844, size 0x1d8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method IsValidBranchID, addr 0x111d818, size 0xf0, virtual false, abstract: false, final false
  static inline bool IsValidBranchID(::StringW branchID, int32_t start);

  /// @brief Method IsValidIdentifier, addr 0x111d628, size 0xb8, virtual false, abstract: false, final false
  static inline bool IsValidIdentifier(::StringW identifier);

  /// @brief Method MakeOidStringFromBytes, addr 0x111dadc, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method On, addr 0x111d980, size 0xb0, virtual true, abstract: false, final false
  inline bool On(::Org::BouncyCastle::Asn1::DerObjectIdentifier* stem);

  /// @brief Method ToString, addr 0x111e340, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WriteField, addr 0x111de14, size 0x17c, virtual false, abstract: false, final false
  inline void WriteField(::System::IO::Stream* outputStream, ::Org::BouncyCastle::Math::BigInteger* fieldValue);

  /// @brief Method WriteField, addr 0x111dd34, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x111da30, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x10fffe0, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::StringW identifier);

  /// @brief Method .ctor, addr 0x111d6e0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Id, addr 0x111d908, size 0x8, virtual false, abstract: false, final false
