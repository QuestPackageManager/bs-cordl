...
public:
  ...
  static __declspec(property(get = getStaticF_cache, put = setStaticF_cache)) ::ArrayW<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, ::Array<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>*>
      cache;
  ...
  /// @brief Method Asn1Equals, addr 0x24d4c14, size 0x98, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x24d4bf8, size 0x1c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Branch, addr 0x24d425c, size 0x68, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Branch(::StringW branchID);

  /// @brief Method DoOutput, addr 0x24d48f4, size 0x1c4, virtual false, abstract: false, final false
  inline void DoOutput(::System::IO::MemoryStream* bOut);

  /// @brief Method Encode, addr 0x24d4bcc, size 0x2c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x24d3c4c, size 0x23c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* FromOctetString(::ArrayW<uint8_t, ::Array<uint8_t>*> enc);

  /// @brief Method GetBody, addr 0x24d4ab8, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBody();

  /// @brief Method GetInstance, addr 0x24d3e88, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x24c05c8, size 0x1d4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method IsValidBranchID, addr 0x24d4164, size 0xf0, virtual false, abstract: false, final false
  static inline bool IsValidBranchID(::StringW branchID, int32_t start);

  /// @brief Method IsValidIdentifier, addr 0x24d3f78, size 0xb8, virtual false, abstract: false, final false
  static inline bool IsValidIdentifier(::StringW identifier);

  /// @brief Method MakeOidStringFromBytes, addr 0x24d4420, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method On, addr 0x24d42c4, size 0xb0, virtual true, abstract: false, final false
  inline bool On(::Org::BouncyCastle::Asn1::DerObjectIdentifier* stem);

  /// @brief Method ToString, addr 0x24d4cac, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WriteField, addr 0x24d4778, size 0x17c, virtual false, abstract: false, final false
  inline void WriteField(::System::IO::Stream* outputStream, ::Org::BouncyCastle::Math::BigInteger* fieldValue);

  /// @brief Method WriteField, addr 0x24d4694, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d4374, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x24b7110, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::StringW identifier);

  /// @brief Method .ctor, addr 0x24d4030, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Id, addr 0x24d4254, size 0x8, virtual false, abstract: false, final false
