...
/// @brief Method Asn1Equals, addr 0x34645d0, size 0xa8, virtual true, abstract: false, final false
inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object*  asn1Object) ;

/// @brief Method Asn1GetHashCode, addr 0x34645bc, size 0x14, virtual true, abstract: false, final false
inline int32_t Asn1GetHashCode() ;

/// @brief Method Branch, addr 0x3463c10, size 0x6c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Branch(::StringW  branchID) ;

/// @brief Method DoOutput, addr 0x34642d4, size 0x1a4, virtual false, abstract: false, final false
inline void DoOutput(::System::IO::MemoryStream*  bOut) ;

/// @brief Method Encode, addr 0x3464590, size 0x2c, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream*  derOut) ;

/// @brief Method FromOctetString, addr 0x3463628, size 0x248, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* FromOctetString(::ArrayW<uint8_t,::Array<uint8_t>*>  enc) ;

/// @brief Method GetBody, addr 0x3464478, size 0x118, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBody() ;

/// @brief Method GetInstance, addr 0x3463870, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x344ff9c, size 0x1e8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetInstance(::System::Object*  obj) ;

/// @brief Method IsValidBranchID, addr 0x3463b4c, size 0xbc, virtual false, abstract: false, final false
static inline bool IsValidBranchID(::StringW  branchID, int32_t  start) ;

/// @brief Method IsValidIdentifier, addr 0x3463980, size 0x9c, virtual false, abstract: false, final false
static inline bool IsValidIdentifier(::StringW  identifier) ;

/// @brief Method MakeOidStringFromBytes, addr 0x3463df0, size 0x28c, virtual false, abstract: false, final false
...
/// @brief Method On, addr 0x3463c7c, size 0xc8, virtual true, abstract: false, final false
inline bool On(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  stem) ;

/// @brief Method ToString, addr 0x3464678, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method WriteField, addr 0x3464158, size 0x17c, virtual false, abstract: false, final false
inline void WriteField(::System::IO::Stream*  outputStream, ::Org::BouncyCastle::Math::BigInteger*  fieldValue) ;

/// @brief Method WriteField, addr 0x346407c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3463d44, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method .ctor, addr 0x344669c, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(::StringW  identifier) ;

/// @brief Method .ctor, addr 0x3463a1c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method get_Id, addr 0x3463c08, size 0x8, virtual false, abstract: false, final false
