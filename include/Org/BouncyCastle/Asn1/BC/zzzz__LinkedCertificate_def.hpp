...
public:
  ...
  /// @brief Method GetInstance, addr 0x3346564, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3346624, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334638c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo* digest, ::Org::BouncyCastle::Asn1::X509::GeneralName* certLocation);

  /// @brief Method .ctor, addr 0x3346398, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33463a4, size 0x1c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CACerts, addr 0x334661c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CACerts();

  /// @brief Method get_CertIssuer, addr 0x3346614, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CertIssuer();

  /// @brief Method get_CertLocation, addr 0x334660c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_CertLocation();

  /// @brief Method get_Digest, addr 0x3346604, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LinkedCertificate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LinkedCertificate(LinkedCertificate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LinkedCertificate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LinkedCertificate(LinkedCertificateconst&) = delete;
