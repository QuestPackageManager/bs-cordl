...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f7224, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f72e8, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f6ff0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo* digest, ::Org::BouncyCastle::Asn1::X509::GeneralName* certLocation);

  /// @brief Method .ctor, addr 0x22f7020, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f7060, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CACerts, addr 0x22f72e0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CACerts();

  /// @brief Method get_CertIssuer, addr 0x22f72d8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CertIssuer();

  /// @brief Method get_CertLocation, addr 0x22f72d0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_CertLocation();

  /// @brief Method get_Digest, addr 0x22f72c8, size 0x8, virtual true, abstract: false, final false
