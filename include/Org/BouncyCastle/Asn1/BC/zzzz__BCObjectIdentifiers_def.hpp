...
public:
  ...
  /// @brief Method .ctor, addr 0x3345fa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BCObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BCObjectIdentifiers(BCObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BCObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BCObjectIdentifiers(BCObjectIdentifiersconst&) = delete;
