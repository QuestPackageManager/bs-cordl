...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EacObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EacObjectIdentifiers(EacObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EacObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EacObjectIdentifiers(EacObjectIdentifiersconst&) = delete;
