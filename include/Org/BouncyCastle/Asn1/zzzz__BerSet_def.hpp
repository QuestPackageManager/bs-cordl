...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerSet", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerSet(BerSet&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerSet", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerSet(BerSetconst&) = delete;
