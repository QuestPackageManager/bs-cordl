...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerUtf8String*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerUtf8String*, "Org.BouncyCastle.Asn1", "DerUtf8String");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x36929a4, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x3692a4c, size 0x50, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x3692850, size 0xf4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerUtf8String* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x3692764, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerUtf8String* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x369299c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  static inline ::Org::BouncyCastle::Asn1::DerUtf8String* New_ctor(::ArrayW<uint8_t> str);
  ...
  /// @brief Method .ctor, addr 0x3684aa0, size 0x54, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x3692944, size 0x58, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerUtf8String", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerUtf8String(DerUtf8String&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerUtf8String", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerUtf8String(DerUtf8Stringconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerUtf8String) == 0x18, "Size mismatch!");
