...
public:
  ...
  /// @brief Method .ctor addr 0x11434d0 size 0xc8 virtual false final false
  inline void _ctor(::System::IO::Stream* inStream, int32_t length, int32_t limit);

  /// @brief Method get_Remaining addr 0x114ef30 size 0x8 virtual false final false
  inline int32_t get_Remaining();

  /// @brief Method ReadByte addr 0x114ef38 size 0x1e4 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Read addr 0x114f11c size 0x254 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadAllIntoByteArray addr 0x1145798 size 0x3a4 virtual false final false
  inline void ReadAllIntoByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method ToArray addr 0x1143598 size 0x3a8 virtual false final false
