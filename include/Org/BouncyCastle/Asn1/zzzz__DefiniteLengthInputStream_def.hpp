...
public:
  ...
  /// @brief Method Read, addr 0x14293e8, size 0x254, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadAllIntoByteArray, addr 0x141fa64, size 0x3a4, virtual false, abstract: false, final false
  inline void ReadAllIntoByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method ReadByte, addr 0x1429204, size 0x1e4, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ToArray, addr 0x141d864, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141d79c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Remaining, addr 0x14291fc, size 0x8, virtual false, abstract: false, final false
