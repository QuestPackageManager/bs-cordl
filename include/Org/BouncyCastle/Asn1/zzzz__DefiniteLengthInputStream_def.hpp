...
public:
  ...
  /// @brief Method Read, addr 0x35ce0f4, size 0x21c, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t off, int32_t len);

  /// @brief Method ReadAllIntoByteArray, addr 0x35c4b24, size 0x34c, virtual false, abstract: false, final false
  inline void ReadAllIntoByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method ReadByte, addr 0x35cdf3c, size 0x1b8, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method ToArray, addr 0x35c2aa0, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c29dc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Remaining, addr 0x35cdf34, size 0x8, virtual false, abstract: false, final false
