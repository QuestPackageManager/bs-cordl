...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x11e6f58, size 0xc8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x11e7020, size 0x5c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x11e6f30, size 0x28, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x11e6878, size 0x1ac, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* FromOctetString(::ArrayW<uint8_t, ::Array<uint8_t>*> enc);

  /// @brief Method GetInstance, addr 0x11e6738, size 0x140, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x11e64a0, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::System::Object* obj);

  /// @brief Method HasValue, addr 0x11e6e34, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e6c9c, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x11e6bf4, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* val);

  /// @brief Method .ctor, addr 0x11e6a24, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(int32_t val);

  /// @brief Method .ctor, addr 0x11e6b0c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IntValueExact, addr 0x11e6eac, size 0x84, virtual false, abstract: false, final false
  inline int32_t get_IntValueExact();

  /// @brief Method get_Value, addr 0x11e6dcc, size 0x68, virtual false, abstract: false, final false
