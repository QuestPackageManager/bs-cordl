...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x3459fe4, size 0xd0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x345a0b4, size 0x60, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x3459fc4, size 0x20, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x345992c, size 0x1b4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* FromOctetString(::ArrayW<uint8_t> enc);

  /// @brief Method GetInstance, addr 0x34597e8, size 0x144, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x3459548, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::System::Object* obj);

  /// @brief Method HasValue, addr 0x3459ecc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3459d40, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> bytes);

  /// @brief Method .ctor, addr 0x3459ca8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* val);

  /// @brief Method .ctor, addr 0x3459ae0, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t val);

  /// @brief Method .ctor, addr 0x3459bc4, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int64_t val);

  static inline ::ArrayW<::Org::BouncyCastle::Asn1::DerEnumerated*> getStaticF_cache();

  /// @brief Method get_IntValueExact, addr 0x3459f44, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_IntValueExact();

  /// @brief Method get_Value, addr 0x3459e68, size 0x64, virtual false, abstract: false, final false
