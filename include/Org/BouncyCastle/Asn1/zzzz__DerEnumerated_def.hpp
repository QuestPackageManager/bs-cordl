...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerEnumerated*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerEnumerated*, "Org.BouncyCastle.Asn1", "DerEnumerated");
...
public:
  ...
  __declspec(property(get = getStaticF_cache, put = setStaticF_cache)) ::ArrayW<::Org::BouncyCastle::Asn1::DerEnumerated*> cache;
  ...
  /// @brief Method Asn1Equals, addr 0x345c36c, size 0xd0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x345c43c, size 0x60, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x345c34c, size 0x20, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromOctetString, addr 0x345bcb4, size 0x1b4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* FromOctetString(::ArrayW<uint8_t> enc);

  /// @brief Method GetInstance, addr 0x345bb70, size 0x144, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x345b8d0, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* GetInstance(::System::Object* obj);

  /// @brief Method HasValue, addr 0x345c254, size 0x78, virtual false, abstract: false, final false
  inline bool HasValue(::Org::BouncyCastle::Math::BigInteger* x);

  static inline ::Org::BouncyCastle::Asn1::DerEnumerated* New_ctor(::ArrayW<uint8_t> bytes);
  ...
  /// @brief Method .ctor, addr 0x345c0c8, size 0x128, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> bytes);

  /// @brief Method .ctor, addr 0x345c030, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* val);

  /// @brief Method .ctor, addr 0x345be68, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t val);

  /// @brief Method .ctor, addr 0x345bf4c, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int64_t val);

  static inline ::ArrayW<::Org::BouncyCastle::Asn1::DerEnumerated*> getStaticF_cache();

  /// @brief Method get_IntValueExact, addr 0x345c2cc, size 0x80, virtual false, abstract: false, final false
  inline int32_t get_IntValueExact();

  /// @brief Method get_Value, addr 0x345c1f0, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Value();

  static inline void setStaticF_cache(::ArrayW<::Org::BouncyCastle::Asn1::DerEnumerated*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerEnumerated", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerEnumerated(DerEnumerated&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerEnumerated", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerEnumerated(DerEnumeratedconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerEnumerated) == 0x20, "Size mismatch!");
