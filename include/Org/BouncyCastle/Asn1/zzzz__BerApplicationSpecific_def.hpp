...
public:
  ...
  /// @brief Method .ctor, addr 0x36890b8, size 0x4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerApplicationSpecific", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerApplicationSpecific(BerApplicationSpecific&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerApplicationSpecific", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerApplicationSpecific(BerApplicationSpecificconst&) = delete;
