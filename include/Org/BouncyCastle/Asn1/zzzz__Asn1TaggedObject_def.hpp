...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1TaggedObject*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1TaggedObject*, "Org.BouncyCastle.Asn1", "Asn1TaggedObject");
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x3688554, size 0x11c, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x3688670, size 0x2c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method GetInstance, addr 0x3688340, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x36883b4, size 0x100, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1TaggedObject* GetInstance(::System::Object* obj);

  /// @brief Method GetObject, addr 0x3678428, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* GetObject();

  /// @brief Method GetObjectParser, addr 0x36886b4, size 0x124, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* GetObjectParser(int32_t tag, bool isExplicit);

  /// @brief Method IsConstructed, addr 0x36881e0, size 0x160, virtual false, abstract: false, final false
  static inline bool IsConstructed(bool isExplicit, ::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method IsEmpty, addr 0x36886ac, size 0x8, virtual false, abstract: false, final false
  inline bool IsEmpty();

  /// @brief Method IsExplicit, addr 0x36886a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x36887d8, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36884c8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool explicitly, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method .ctor, addr 0x36884b4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method get_TagNo, addr 0x368869c, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1TaggedObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Asn1TaggedObject(Asn1TaggedObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Asn1TaggedObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1TaggedObject(Asn1TaggedObjectconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1TaggedObject) == 0x20, "Size mismatch!");
