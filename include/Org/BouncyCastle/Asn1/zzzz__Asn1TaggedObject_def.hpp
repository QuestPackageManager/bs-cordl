...
public:
  ...
  /// @brief Method IsConstructed addr 0x11bac5c size 0x130 virtual false final false
  static inline bool IsConstructed(bool isExplicit, ::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method GetInstance addr 0x11bad8c size 0x78 virtual false final false
  ...
  /// @brief Method GetInstance addr 0x11bae04 size 0x100 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11baf04 size 0x44 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11baf48 size 0x8c virtual false final false
  inline void _ctor(bool explicitly, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Asn1Equals addr 0x11bafd4 size 0xf8 virtual true final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode addr 0x11bb0cc size 0x3c virtual true final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method get_TagNo addr 0x11bb108 size 0x8 virtual true final true
  inline int32_t get_TagNo();

  /// @brief Method IsExplicit addr 0x11bb110 size 0x8 virtual false final false
  inline bool IsExplicit();

  /// @brief Method IsEmpty addr 0x11bb118 size 0x8 virtual false final false
  inline bool IsEmpty();

  /// @brief Method GetObject addr 0x11aabb0 size 0x18 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* GetObject();

  /// @brief Method GetObjectParser addr 0x11bb120 size 0x130 virtual true final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* GetObjectParser(int32_t tag, bool isExplicit);

  /// @brief Method ToString addr 0x11bb250 size 0x178 virtual true final false
