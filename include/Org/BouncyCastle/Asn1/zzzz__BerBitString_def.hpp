...
public:
  ...
  /// @brief Method .ctor, addr 0x11e8a48, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e8ab8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Asn1::BerBitString* New_ctor(int32_t namedBits);

  /// @brief Method .ctor, addr 0x11e8b20, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e8b88, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Encode, addr 0x11e8bf0, size 0xd4, virtual true, abstract: false, final false
