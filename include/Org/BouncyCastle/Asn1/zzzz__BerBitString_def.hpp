...
public:
  // Declarations
  /// @brief Method Encode, addr 0x2632ffc, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2632ec4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x2632e54, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t padBits);

  /// @brief Method .ctor, addr 0x2632f2c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t namedBits);

  /// @brief Method .ctor, addr 0x2632f94, size 0x68, virtual false, abstract: false, final false
