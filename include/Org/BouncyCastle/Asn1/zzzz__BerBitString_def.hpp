...
public:
  ...
  /// @brief Method .ctor, addr 0x11bbbb8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bbc28, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Asn1::BerBitString* New_ctor(int32_t namedBits);

  /// @brief Method .ctor, addr 0x11bbc90, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bbcf8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Encode, addr 0x11bbd60, size 0xd4, virtual true, abstract: false, final false
