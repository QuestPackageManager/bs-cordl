...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerBitString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerBitString(BerBitString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerBitString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerBitString(BerBitStringconst&) = delete;
