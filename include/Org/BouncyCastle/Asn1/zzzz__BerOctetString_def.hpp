...
public:
  ...
  /// @brief Method MoveNext, addr 0x368a450, size 0x12c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Org::BouncyCastle::Asn1::BerOctetString_ChunkEnumerator* New_ctor(::ArrayW<uint8_t> octets, int32_t chunkSize);

  /// @brief Method Reset, addr 0x368a57c, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3689fd8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> octets, int32_t chunkSize);

  /// @brief Method get_Current, addr 0x368a40c, size 0x44, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x3689ff0, size 0x3cc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromSequence, addr 0x3684cbc, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBytes, addr 0x3689ac0, size 0xe0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ToBytes(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs);

  /// @brief Method ToOctetStringArray, addr 0x3689ba0, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368269c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs);

  /// @brief Method .ctor, addr 0x3689eb0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*> octs, int32_t chunkSize);

  /// @brief Method .ctor, addr 0x3689e08, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x3689e88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str, int32_t chunkSize);

  /// @brief Method .ctor, addr 0x3689f30, size 0x2c, virtual false, abstract: false, final false
