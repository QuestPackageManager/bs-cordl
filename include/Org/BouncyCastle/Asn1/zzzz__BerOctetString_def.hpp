...
public:
  ...
  /// @brief Method MoveNext, addr 0x35cae74, size 0x12c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x35cafa0, size 0xc, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x35ca9fc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> octets, int32_t chunkSize);

  /// @brief Method get_Current, addr 0x35cae30, size 0x44, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Encode, addr 0x35caa14, size 0x3cc, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromSequence, addr 0x35c56e0, size 0x124, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::BerOctetString* FromSequence(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetEnumerator, addr 0x35ca980, size 0x7c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetObjects, addr 0x35caa10, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBytes, addr 0x35ca4e4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToOctetStringArray, addr 0x35ca5c4, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ca7bc, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* e);

  /// @brief Method .ctor, addr 0x35c30c0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1OctetString*, ::Array<::Org::BouncyCastle::Asn1::Asn1OctetString*>*> octs);

  /// @brief Method .ctor, addr 0x35ca8d4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ca82c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str);

  /// @brief Method .ctor, addr 0x35ca8ac, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str, int32_t chunkSize);

  /// @brief Method .ctor, addr 0x35ca954, size 0x2c, virtual false, abstract: false, final false
