...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1OctetStringParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1OctetStringParser*, "Org.BouncyCastle.Asn1", "Asn1OctetStringParser");
// Dependencies
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "Asn1OctetStringParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Asn1OctetStringParser(Asn1OctetStringParserconst&) = delete;
