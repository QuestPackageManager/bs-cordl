...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IAsn1ApplicationSpecificParser*, "Org.BouncyCastle.Asn1", "IAsn1ApplicationSpecificParser");
// Dependencies
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAsn1ApplicationSpecificParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAsn1ApplicationSpecificParser(IAsn1ApplicationSpecificParserconst&) = delete;
