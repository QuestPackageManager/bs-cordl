...
public:
  ...
  /// @brief Method GetAuthAttrs, addr 0xfdeb2c, size 0x1b8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetAuthAttrs();

  /// @brief Method GetDigestAlgorithm, addr 0xfde690, size 0x19c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetDigestAlgorithm();

  /// @brief Method GetEnapsulatedContentInfo, addr 0xfde82c, size 0x120, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser* GetEnapsulatedContentInfo();

  /// @brief Method GetMac, addr 0xfdece4, size 0x130, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetMac();

  /// @brief Method GetMacAlgorithm, addr 0xfde528, size 0x168, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetMacAlgorithm();

  /// @brief Method GetOriginatorInfo, addr 0xfddfd0, size 0x2e0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* GetOriginatorInfo();

  /// @brief Method GetRecipientInfos, addr 0xfde428, size 0x100, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetRecipientInfos();

  /// @brief Method GetUnauthAttrs, addr 0xfdee14, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfddea4, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_Version, addr 0xfddfc8, size 0x8, virtual false, abstract: false, final false
