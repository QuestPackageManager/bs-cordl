...
/// @brief Method GetAuthAttrs, addr 0x325a600, size 0x1c4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetAuthAttrs() ;

/// @brief Method GetDigestAlgorithm, addr 0x325a154, size 0x1b0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetDigestAlgorithm() ;

/// @brief Method GetEnapsulatedContentInfo, addr 0x325a304, size 0x124, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser* GetEnapsulatedContentInfo() ;

/// @brief Method GetMac, addr 0x325a7c4, size 0x138, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetMac() ;

/// @brief Method GetMacAlgorithm, addr 0x3259fe4, size 0x170, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetMacAlgorithm() ;

/// @brief Method GetOriginatorInfo, addr 0x3259a88, size 0x2e4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* GetOriginatorInfo() ;

/// @brief Method GetRecipientInfos, addr 0x3259edc, size 0x108, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetRecipientInfos() ;

/// @brief Method GetUnauthAttrs, addr 0x325a8fc, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3259954, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  seq) ;

/// @brief Method get_Version, addr 0x3259a80, size 0x8, virtual false, abstract: false, final false
