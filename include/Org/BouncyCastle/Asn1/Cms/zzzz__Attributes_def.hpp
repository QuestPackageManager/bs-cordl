...
public:
  ...
  /// @brief Method GetAttributes, addr 0xf01604, size 0xf0, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cms::Attribute*, ::Array<::Org::BouncyCastle::Asn1::Cms::Attribute*>*> GetAttributes();

  /// @brief Method GetInstance, addr 0xf0155c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf016f4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf014b8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* attributes);

  /// @brief Method .ctor, addr 0xf014e0, size 0x7c, virtual false, abstract: false, final false
