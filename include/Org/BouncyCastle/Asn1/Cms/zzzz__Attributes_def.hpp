...
public:
  ...
  /// @brief Method GetAttributes, addr 0x22ff974, size 0xf0, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cms::Attribute*, ::Array<::Org::BouncyCastle::Asn1::Cms::Attribute*>*> GetAttributes();

  /// @brief Method GetInstance, addr 0x22ff8d4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22ffa64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22ff838, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* attributes);

  /// @brief Method .ctor, addr 0x22ff860, size 0x74, virtual false, abstract: false, final false
