...
public:
  ...
  /// @brief Method .ctor addr 0xe7cac8 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe7caf0 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe7cb74 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe7cbf8 size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe7cc7c size 0x84 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe7cd00 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* info);

  /// @brief Method GetInstance addr 0xe77620 size 0x1b4 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Cms::RecipientInfo* GetInstance(::System::Object* o);

  /// @brief Method get_Version addr 0xe777d4 size 0x16c virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Version();

  /// @brief Method get_IsTagged addr 0xe7cd4c size 0x7c virtual false final false
  inline bool get_IsTagged();

  /// @brief Method get_Info addr 0xe7cdc8 size 0x140 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Info();

  /// @brief Method GetKekInfo addr 0xe7cd28 size 0x24 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo* GetKekInfo(::Org::BouncyCastle::Asn1::Asn1TaggedObject* o);

  /// @brief Method ToAsn1Object addr 0xe7cf08 size 0x20 virtual true final false
