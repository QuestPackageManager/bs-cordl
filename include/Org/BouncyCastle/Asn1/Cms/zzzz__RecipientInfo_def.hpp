...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecipientInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecipientInfo(RecipientInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecipientInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecipientInfo(RecipientInfoconst&) = delete;
