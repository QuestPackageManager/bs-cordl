...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber*, "Org.BouncyCastle.Asn1.Cms", "IssuerAndSerialNumber");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3358818, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3358a64, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3358a4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name, ::Org::BouncyCastle::Asn1::DerInteger* serialNumber);

  /// @brief Method .ctor, addr 0x33589d8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509Name* name, ::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method .ctor, addr 0x33588b8, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Name, addr 0x3358a54, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Name();

  /// @brief Method get_SerialNumber, addr 0x3358a5c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber) == 0x20, "Size mismatch!");
