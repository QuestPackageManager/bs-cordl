...
public:
  ...
  /// @brief Method GetInstance, addr 0x3355020, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x335598c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335da58, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335d7d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* certs, ::Org::BouncyCastle::Asn1::Asn1Set* crls);

  /// @brief Method .ctor, addr 0x335d7dc, size 0x26c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Certificates, addr 0x335da48, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_Crls, addr 0x335da50, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OriginatorInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OriginatorInfo(OriginatorInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OriginatorInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OriginatorInfo(OriginatorInfoconst&) = delete;
