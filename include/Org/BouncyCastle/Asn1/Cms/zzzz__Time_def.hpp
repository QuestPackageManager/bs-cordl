...
public:
  ...
  /// @brief Method GetInstance, addr 0x2313bb0, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::Time* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x2313bcc, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23142c4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2313eb8, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime date);

  /// @brief Method .ctor, addr 0x2313d80, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* time);

  /// @brief Method get_Date, addr 0x2314114, size 0x1b0, virtual false, abstract: false, final false
  inline ::System::DateTime get_Date();

  /// @brief Method get_TimeString, addr 0x231404c, size 0xc8, virtual false, abstract: false, final false
