...
public:
  ...
  /// @brief Method GetInstance, addr 0x3360808, size 0x28, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::Time* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x3360830, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3360f64, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3360b3c, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime date);

  /// @brief Method .ctor, addr 0x3360a00, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* time);

  /// @brief Method get_Date, addr 0x3360da8, size 0x1bc, virtual false, abstract: false, final false
  inline ::System::DateTime get_Date();

  /// @brief Method get_TimeString, addr 0x3360cd8, size 0xd0, virtual false, abstract: false, final false
