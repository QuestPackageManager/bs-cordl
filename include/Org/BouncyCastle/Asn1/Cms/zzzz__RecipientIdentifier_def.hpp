...
public:
  ...
  /// @brief Method GetInstance, addr 0x335c81c, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335ef94, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335ee80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0x335ee10, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x335ee08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method get_ID, addr 0x335ef08, size 0x8c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IsTagged, addr 0x335ee88, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecipientIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecipientIdentifier(RecipientIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecipientIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecipientIdentifier(RecipientIdentifierconst&) = delete;
