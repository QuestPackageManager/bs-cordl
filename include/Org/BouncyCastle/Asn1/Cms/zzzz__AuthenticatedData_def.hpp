...
public:
  ...
  /// @brief Method .ctor addr 0xdfccec size 0x134 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdfd388 size 0x304 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance addr 0xdfd81c size 0x18 virtual false final false
  ...
  /// @brief Method GetInstance addr 0xdfd834 size 0x178 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Cms::AuthenticatedData* GetInstance(::System::Object* obj);

  /// @brief Method get_Version addr 0xdfd9ac size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Version();

  /// @brief Method get_OriginatorInfo addr 0xdfd9b4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* get_OriginatorInfo();

  /// @brief Method get_RecipientInfos addr 0xdfd9bc size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_RecipientInfos();

  /// @brief Method get_MacAlgorithm addr 0xdfd9c4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MacAlgorithm();

  /// @brief Method get_DigestAlgorithm addr 0xdfd9cc size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_EncapsulatedContentInfo addr 0xdfd9d4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapsulatedContentInfo();

  /// @brief Method get_AuthAttrs addr 0xdfd9dc size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthAttrs();

  /// @brief Method get_Mac addr 0xdfd9e4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Mac();

  /// @brief Method get_UnauthAttrs addr 0xdfd9ec size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthAttrs();

  /// @brief Method ToAsn1Object addr 0xdfd9f4 size 0x1f4 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method CalculateVersion addr 0xdfce20 size 0x568 virtual false final false
