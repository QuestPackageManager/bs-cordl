...
public:
  ...
  /// @brief Method CalculateVersion, addr 0x3352498, size 0x504, virtual false, abstract: false, final false
  static inline int32_t CalculateVersion(::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* origInfo);

  /// @brief Method GetInstance, addr 0x3352e1c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3352e30, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3352fe8, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3352378, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335299c, size 0x2fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AuthAttrs, addr 0x3352fd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthAttrs();

  /// @brief Method get_DigestAlgorithm, addr 0x3352fc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_EncapsulatedContentInfo, addr 0x3352fc8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapsulatedContentInfo();

  /// @brief Method get_Mac, addr 0x3352fd8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Mac();

  /// @brief Method get_MacAlgorithm, addr 0x3352fb8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MacAlgorithm();

  /// @brief Method get_OriginatorInfo, addr 0x3352fa8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* get_OriginatorInfo();

  /// @brief Method get_RecipientInfos, addr 0x3352fb0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_RecipientInfos();

  /// @brief Method get_UnauthAttrs, addr 0x3352fe0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthAttrs();

  /// @brief Method get_Version, addr 0x3352fa0, size 0x8, virtual false, abstract: false, final false
