...
public:
  ...
  /// @brief Method CalculateVersion, addr 0x3258cb0, size 0x504, virtual false, abstract: false, final false
  static inline int32_t CalculateVersion(::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* origInfo);

  /// @brief Method GetInstance, addr 0x3259634, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3259648, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3259800, size 0x204, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3258b90, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32591b4, size 0x2fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AuthAttrs, addr 0x32597e8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthAttrs();

  /// @brief Method get_DigestAlgorithm, addr 0x32597d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_EncapsulatedContentInfo, addr 0x32597e0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapsulatedContentInfo();

  /// @brief Method get_Mac, addr 0x32597f0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Mac();

  /// @brief Method get_MacAlgorithm, addr 0x32597d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MacAlgorithm();

  /// @brief Method get_OriginatorInfo, addr 0x32597c0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* get_OriginatorInfo();

  /// @brief Method get_RecipientInfos, addr 0x32597c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_RecipientInfos();

  /// @brief Method get_UnauthAttrs, addr 0x32597f8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthAttrs();

  /// @brief Method get_Version, addr 0x32597b8, size 0x8, virtual false, abstract: false, final false
