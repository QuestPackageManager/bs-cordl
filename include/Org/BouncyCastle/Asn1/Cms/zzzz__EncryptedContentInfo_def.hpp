...
public:
  ...
  /// @brief Method GetInstance, addr 0x325aee0, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x325d160, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325cfc4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325cfd0, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0x325d150, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0x325d148, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptedContent, addr 0x325d158, size 0x8, virtual false, abstract: false, final false
