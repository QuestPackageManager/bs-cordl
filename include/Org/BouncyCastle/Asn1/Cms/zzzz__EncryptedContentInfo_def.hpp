...
public:
  ...
  /// @brief Method .ctor, addr 0xea11c4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xea1200, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0xe9f0fc, size 0x178, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo* GetInstance(::System::Object* obj);

  /// @brief Method get_ContentType, addr 0xea1370, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0xea1378, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_EncryptedContent, addr 0xea1380, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedContent();

  /// @brief Method ToAsn1Object, addr 0xea1388, size 0x170, virtual true, abstract: false, final false
