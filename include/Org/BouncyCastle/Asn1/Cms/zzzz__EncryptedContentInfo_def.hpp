...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo*, "Org.BouncyCastle.Asn1.Cms", "EncryptedContentInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3356a50, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3358cd0, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3358b34, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3358b40, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0x3358cc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0x3358cb8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptedContent, addr 0x3358cc8, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptedContentInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptedContentInfo(EncryptedContentInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptedContentInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptedContentInfo(EncryptedContentInfoconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo) == 0x28, "Size mismatch!");
