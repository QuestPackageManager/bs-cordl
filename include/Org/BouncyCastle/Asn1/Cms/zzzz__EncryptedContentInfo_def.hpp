...
public:
  ...
  /// @brief Method GetInstance, addr 0x10e55e0, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10e786c, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e76a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e76e4, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0x10e785c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0x10e7854, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptedContent, addr 0x10e7864, size 0x8, virtual false, abstract: false, final false
