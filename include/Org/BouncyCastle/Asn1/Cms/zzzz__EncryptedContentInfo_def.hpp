...
public:
  ...
  /// @brief Method GetInstance, addr 0xfdf354, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfe15e0, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe141c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe1458, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0xfe15d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0xfe15c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptedContent, addr 0xfe15d8, size 0x8, virtual false, abstract: false, final false
