...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::ScvpReqRes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::ScvpReqRes*, "Org.BouncyCastle.Asn1.Cms", "ScvpReqRes");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x335d5e0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335d798, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335d780, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* request, ::Org::BouncyCastle::Asn1::Cms::ContentInfo* response);

  /// @brief Method .ctor, addr 0x335d778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* response);

  /// @brief Method .ctor, addr 0x335d680, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Request, addr 0x335d788, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_Request();

  /// @brief Method get_Response, addr 0x335d790, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::ScvpReqRes) == 0x20, "Size mismatch!");
