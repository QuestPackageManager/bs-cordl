...
public:
  ...
  /// @brief Method GetInstance, addr 0x335b41c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x334fcdc, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335b8c4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335b790, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algorithm, ::ArrayW<uint8_t> publicKey);

  /// @brief Method .ctor, addr 0x335b804, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Algorithm, addr 0x335b8b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Algorithm();

  /// @brief Method get_PublicKey, addr 0x335b8bc, size 0x8, virtual false, abstract: false, final false
