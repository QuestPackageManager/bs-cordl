...
public:
  ...
  /// @brief Method .ctor, addr 0x3357f38, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsObjectIdentifiers(CmsObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsObjectIdentifiers(CmsObjectIdentifiersconst&) = delete;
