...
public:
  ...
  /// @brief Method GetInstance, addr 0xfe5968, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfe5a0c, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe5714, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfe5754, size 0x214, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_FileName, addr 0xfe5bc8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_FileName();

  /// @brief Method get_IsHashProtected, addr 0xfe5bac, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsHashProtected();

  /// @brief Method get_MediaType, addr 0xfe5bd0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerIA5String* get_MediaType();

  /// @brief Method get_OtherMetaData, addr 0xfe5bd8, size 0x8, virtual true, abstract: false, final false
