...
public:
  ...
  /// @brief Method GetInstance, addr 0x2305e24, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2305ec8, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2305bd0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2305c10, size 0x214, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_FileName, addr 0x2306080, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_FileName();

  /// @brief Method get_IsHashProtected, addr 0x2306064, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsHashProtected();

  /// @brief Method get_MediaType, addr 0x2306088, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerIA5String* get_MediaType();

  /// @brief Method get_OtherMetaData, addr 0x2306090, size 0x8, virtual true, abstract: false, final false
