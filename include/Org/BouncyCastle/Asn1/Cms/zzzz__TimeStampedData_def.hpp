...
/// @brief Method GetInstance, addr 0x32a511c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x32a51dc, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32a4d40, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x32a4dc4, size 0x26c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Content, addr 0x32a51cc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Content() ;

/// @brief Method get_DataUri, addr 0x32a51bc, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerIA5String* get_DataUri() ;

/// @brief Method get_MetaData, addr 0x32a51c4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::MetaData* get_MetaData() ;

/// @brief Method get_TemporalEvidence, addr 0x32a51d4, size 0x8, virtual false, abstract: false, final false
