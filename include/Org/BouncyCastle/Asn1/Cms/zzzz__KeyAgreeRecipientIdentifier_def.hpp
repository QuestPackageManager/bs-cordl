...
public:
  ...
  /// @brief Method GetInstance, addr 0x3260030, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3260044, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3260248, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3260214, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issuerSerial);

  /// @brief Method .ctor, addr 0x3260230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method get_IssuerAndSerialNumber, addr 0x3260238, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_RKeyID, addr 0x3260240, size 0x8, virtual false, abstract: false, final false
