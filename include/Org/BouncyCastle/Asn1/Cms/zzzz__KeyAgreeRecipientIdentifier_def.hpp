...
public:
  ...
  /// @brief Method GetInstance, addr 0x2306198, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x23061b0, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23063fc, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2306384, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issuerSerial);

  /// @brief Method .ctor, addr 0x23063c4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method get_IssuerAndSerialNumber, addr 0x23063ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_RKeyID, addr 0x23063f4, size 0x8, virtual false, abstract: false, final false
