...
public:
  ...
  /// @brief Method GetInstance, addr 0x2308528, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2308540, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230878c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2308754, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method get_IssuerAndSerialNumber, addr 0x230877c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_RKeyID, addr 0x2308784, size 0x8, virtual false, abstract: false, final false
