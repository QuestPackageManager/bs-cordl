...
public:
  ...
  /// @brief Method GetInstance, addr 0x23071b4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x23071cc, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2307418, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23073a0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issuerSerial);

  /// @brief Method .ctor, addr 0x23073e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method get_IssuerAndSerialNumber, addr 0x2307408, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_RKeyID, addr 0x2307410, size 0x8, virtual false, abstract: false, final false
