...
public:
  ...
  /// @brief Method GetInstance, addr 0x335dfdc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x335dff0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_OriType, addr 0x335e090, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OriType();

  /// @brief Method get_OriValue, addr 0x335e098, size 0x8, virtual true, abstract: false, final false
