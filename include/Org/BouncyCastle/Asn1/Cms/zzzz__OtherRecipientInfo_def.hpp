...
public:
  ...
  /// @brief Method GetInstance, addr 0x23096d0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x23096e8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230979c, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23095f8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oriType, ::Org::BouncyCastle::Asn1::Asn1Encodable* oriValue);

  /// @brief Method .ctor, addr 0x2309624, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OriType, addr 0x230978c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OriType();

  /// @brief Method get_OriValue, addr 0x2309794, size 0x8, virtual true, abstract: false, final false
