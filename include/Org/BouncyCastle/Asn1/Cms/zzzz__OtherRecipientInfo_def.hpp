...
public:
  ...
  /// @brief Method GetInstance, addr 0xf0cfa0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xf0cfb8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf0d06c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0cec8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oriType, ::Org::BouncyCastle::Asn1::Asn1Encodable* oriValue);

  /// @brief Method .ctor, addr 0xf0cef4, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OriType, addr 0xf0d05c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OriType();

  /// @brief Method get_OriValue, addr 0xf0d064, size 0x8, virtual true, abstract: false, final false
