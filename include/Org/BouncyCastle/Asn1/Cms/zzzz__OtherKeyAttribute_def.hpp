...
public:
  ...
  /// @brief Method GetInstance, addr 0x2307bb0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230a880, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230a844, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* keyAttrId, ::Org::BouncyCastle::Asn1::Asn1Encodable* keyAttr);

  /// @brief Method .ctor, addr 0x230a764, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyAttr, addr 0x230a878, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_KeyAttr();

  /// @brief Method get_KeyAttrId, addr 0x230a870, size 0x8, virtual false, abstract: false, final false
