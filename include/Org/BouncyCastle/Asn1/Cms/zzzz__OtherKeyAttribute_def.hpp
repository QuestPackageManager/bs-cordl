...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d72c8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10da080, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10da044, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* keyAttrId, ::Org::BouncyCastle::Asn1::Asn1Encodable* keyAttr);

  /// @brief Method .ctor, addr 0x10d9f64, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyAttr, addr 0x10da078, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_KeyAttr();

  /// @brief Method get_KeyAttrId, addr 0x10da070, size 0x8, virtual false, abstract: false, final false
