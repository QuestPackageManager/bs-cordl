...
public:
  ...
  /// @brief Method GetInstance, addr 0x2304100, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2306dd0, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2306d94, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* keyAttrId, ::Org::BouncyCastle::Asn1::Asn1Encodable* keyAttr);

  /// @brief Method .ctor, addr 0x2306cb4, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyAttr, addr 0x2306dc8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_KeyAttr();

  /// @brief Method get_KeyAttrId, addr 0x2306dc0, size 0x8, virtual false, abstract: false, final false
