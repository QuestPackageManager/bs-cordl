...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo*, "Org.BouncyCastle.Asn1.Cms", "KeyAgreeRecipientInfo");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3359e38, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3359e4c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3359fe4, size 0x224, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3359ab4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3359b3c, size 0x288, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyEncryptionAlgorithm, addr 0x3359fd4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithm();

  /// @brief Method get_Originator, addr 0x3359fc4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorIdentifierOrKey* get_Originator();

  /// @brief Method get_RecipientEncryptedKeys, addr 0x3359fdc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_RecipientEncryptedKeys();

  /// @brief Method get_UserKeyingMaterial, addr 0x3359fcc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_UserKeyingMaterial();

  /// @brief Method get_Version, addr 0x3359fbc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo) == 0x38, "Size mismatch!");
