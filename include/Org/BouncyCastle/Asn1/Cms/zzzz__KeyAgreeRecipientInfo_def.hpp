...
public:
  ...
  /// @brief Method GetInstance, addr 0x10eae70, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10eae88, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10eb028, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10eaae4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10eab7c, size 0x288, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyEncryptionAlgorithm, addr 0x10eb018, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithm();

  /// @brief Method get_Originator, addr 0x10eb008, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorIdentifierOrKey* get_Originator();

  /// @brief Method get_RecipientEncryptedKeys, addr 0x10eb020, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_RecipientEncryptedKeys();

  /// @brief Method get_UserKeyingMaterial, addr 0x10eb010, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_UserKeyingMaterial();

  /// @brief Method get_Version, addr 0x10eb000, size 0x8, virtual false, abstract: false, final false
