...
public:
  ...
  /// @brief Method GetInstance, addr 0x335eb68, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x335eb7c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335ed18, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335ed00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335ea80, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptedKey, addr 0x335ed10, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedKey();

  /// @brief Method get_Identifier, addr 0x335ed08, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecipientEncryptedKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecipientEncryptedKey(RecipientEncryptedKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecipientEncryptedKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecipientEncryptedKey(RecipientEncryptedKeyconst&) = delete;
