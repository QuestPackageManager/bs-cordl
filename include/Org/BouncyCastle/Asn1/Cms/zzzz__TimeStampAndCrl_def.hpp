...
public:
  ...
  /// @brief Method GetInstance, addr 0x230c50c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230c5c0, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230c484, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x230c45c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo* timeStamp);

  /// @brief Method get_Crl, addr 0x230c5b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::CertificateList* get_Crl();

  /// @brief Method get_TimeStampToken, addr 0x230c5b0, size 0x8, virtual true, abstract: false, final false
