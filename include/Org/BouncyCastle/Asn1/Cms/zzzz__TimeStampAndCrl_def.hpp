...
public:
  ...
  /// @brief Method GetInstance, addr 0xfed1d4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfed288, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfed14c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Crl, addr 0xfed280, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::CertificateList* get_Crl();

  /// @brief Method get_TimeStampToken, addr 0xfed278, size 0x8, virtual true, abstract: false, final false
