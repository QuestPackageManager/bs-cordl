...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d4f34, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d53e0, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d52e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo* encInfo);

  /// @brief Method .ctor, addr 0x10d52e8, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo* encInfo, ::Org::BouncyCastle::Asn1::Asn1Set* unprotectedAttrs);

  /// @brief Method .ctor, addr 0x10d50ac, size 0x234, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptedContentInfo, addr 0x10d53d0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfo* get_EncryptedContentInfo();

  /// @brief Method get_UnprotectedAttrs, addr 0x10d53d8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnprotectedAttrs();

  /// @brief Method get_Version, addr 0x10d53c8, size 0x8, virtual true, abstract: false, final false
