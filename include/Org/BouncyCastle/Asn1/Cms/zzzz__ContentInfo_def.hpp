...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d48e8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10d1084, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d493c, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d4900, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* contentType, ::Org::BouncyCastle::Asn1::Asn1Encodable* content);

  /// @brief Method .ctor, addr 0x10d4648, size 0x2a0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Content, addr 0x10d4934, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Content();

  /// @brief Method get_ContentType, addr 0x10d492c, size 0x8, virtual false, abstract: false, final false
