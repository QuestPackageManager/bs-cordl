...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptedContentInfoParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptedContentInfoParser(EncryptedContentInfoParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptedContentInfoParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptedContentInfoParser(EncryptedContentInfoParserconst&) = delete;
