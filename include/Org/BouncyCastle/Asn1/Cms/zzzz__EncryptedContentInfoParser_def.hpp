...
/// @brief Method GetEncryptedContent, addr 0x329a61c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3298d5c, size 0x2b4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  seq) ;

/// @brief Method get_ContentEncryptionAlgorithm, addr 0x329a614, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm() ;

/// @brief Method get_ContentType, addr 0x329a60c, size 0x8, virtual false, abstract: false, final false
