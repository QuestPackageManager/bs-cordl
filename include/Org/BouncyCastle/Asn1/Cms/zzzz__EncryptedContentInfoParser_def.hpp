...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser*, "Org.BouncyCastle.Asn1.Cms", "EncryptedContentInfoParser");
...
public:
  ...
  /// @brief Method GetEncryptedContent, addr 0x3356ad4, size 0xbc, virtual false, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* const& __cordl_internal_get__contentEncryptionAlgorithm() const;

  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*& __cordl_internal_get__contentEncryptionAlgorithm();

  constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier* const& __cordl_internal_get__contentType() const;

  constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier*& __cordl_internal_get__contentType();

  constexpr ::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser* const& __cordl_internal_get__encryptedContent() const;
  ...
  /// @brief Method .ctor, addr 0x3355214, size 0x2b4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0x3356acc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0x3356ac4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser) == 0x28, "Size mismatch!");
