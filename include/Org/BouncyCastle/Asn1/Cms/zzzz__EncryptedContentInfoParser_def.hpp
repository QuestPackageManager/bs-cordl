...
public:
  ...
  /// @brief Method GetEncryptedContent, addr 0xee84d8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xee6c04, size 0x2b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentEncryptionAlgorithm, addr 0xee84d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ContentEncryptionAlgorithm();

  /// @brief Method get_ContentType, addr 0xee84c8, size 0x8, virtual false, abstract: false, final false
