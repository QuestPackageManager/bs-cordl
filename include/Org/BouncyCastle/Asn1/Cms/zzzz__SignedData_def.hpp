...
public:
  ...
  /// @brief Method CalculateVersion, addr 0x230cf58, size 0x6a0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForVersion3, addr 0x230d5f8, size 0x2bc, virtual false, abstract: false, final false
  inline bool CheckForVersion3(::Org::BouncyCastle::Asn1::Asn1Set* signerInfs);

  /// @brief Method GetInstance, addr 0x230c740, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230d8e4, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230ce48, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230c7e4, size 0x664, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CRLs, addr 0x230d8d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_CRLs();

  /// @brief Method get_Certificates, addr 0x230d8cc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_DigestAlgorithms, addr 0x230d8bc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_EncapContentInfo, addr 0x230d8c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapContentInfo();

  /// @brief Method get_SignerInfos, addr 0x230d8dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x230d8b4, size 0x8, virtual false, abstract: false, final false
