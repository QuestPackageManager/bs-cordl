...
public:
  ...
  /// @brief Method CalculateVersion, addr 0x10dc824, size 0x694, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForVersion3, addr 0x10dceb8, size 0x2d4, virtual false, abstract: false, final false
  inline bool CheckForVersion3(::Org::BouncyCastle::Asn1::Asn1Set* signerInfs);

  /// @brief Method GetInstance, addr 0x10dc000, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10dd1bc, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10dc714, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10dc0a4, size 0x670, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CRLs, addr 0x10dd1ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_CRLs();

  /// @brief Method get_Certificates, addr 0x10dd1a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_DigestAlgorithms, addr 0x10dd194, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_EncapContentInfo, addr 0x10dd19c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapContentInfo();

  /// @brief Method get_SignerInfos, addr 0x10dd1b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x10dd18c, size 0x8, virtual false, abstract: false, final false
