...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::SignedData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::SignedData*, "Org.BouncyCastle.Asn1.Cms", "SignedData");
...
public:
  ...
  /// @brief Method CalculateVersion, addr 0x33603e0, size 0x63c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckForVersion3, addr 0x3360a1c, size 0x294, virtual false, abstract: false, final false
  inline bool CheckForVersion3(::Org::BouncyCastle::Asn1::Asn1Set* signerInfs);

  /// @brief Method GetInstance, addr 0x335fbd8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3360ce0, size 0x240, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33602d4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335fc78, size 0x65c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CRLs, addr 0x3360cd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_CRLs();

  /// @brief Method get_Certificates, addr 0x3360cc8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_DigestAlgorithms, addr 0x3360cb8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_EncapContentInfo, addr 0x3360cc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapContentInfo();

  /// @brief Method get_SignerInfos, addr 0x3360cd8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x3360cb0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignedData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignedData(SignedData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignedData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignedData(SignedDataconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::SignedData) == 0x48, "Size mismatch!");
