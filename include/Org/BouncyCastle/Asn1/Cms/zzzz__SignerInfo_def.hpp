...
public:
  ...
  /// @brief Method GetInstance, addr 0x10df448, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10dfeec, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10df5d0, size 0x6ac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x10dfc7c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10dfdd0, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* sid, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digAlgorithm,
  ...
  /// @brief Method get_AuthenticatedAttributes, addr 0x10dfec4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes();

  /// @brief Method get_DigestAlgorithm, addr 0x10dfecc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_DigestEncryptionAlgorithm, addr 0x10dfedc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm();

  /// @brief Method get_EncryptedDigest, addr 0x10dfed4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest();

  /// @brief Method get_SignerID, addr 0x10dfebc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* get_SignerID();

  /// @brief Method get_UnauthenticatedAttributes, addr 0x10dfee4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes();

  /// @brief Method get_Version, addr 0x10dfeb4, size 0x8, virtual false, abstract: false, final false
