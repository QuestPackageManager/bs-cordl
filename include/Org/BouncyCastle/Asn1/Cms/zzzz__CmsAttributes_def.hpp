...
public:
  ...
  /// @brief Method .ctor, addr 0x3357da4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsAttributes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsAttributes(CmsAttributes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsAttributes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsAttributes(CmsAttributesconst&) = delete;
