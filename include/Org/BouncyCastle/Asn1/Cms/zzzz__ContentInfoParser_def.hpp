...
public:
  ...
  /// @brief Method GetContent, addr 0x10db2f4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d88e0, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentType, addr 0x10db2ec, size 0x8, virtual false, abstract: false, final false
