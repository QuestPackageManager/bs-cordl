...
public:
  ...
  /// @brief Method GetContent, addr 0x3358a68, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3356048, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentType, addr 0x3358a60, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContentInfoParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContentInfoParser(ContentInfoParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContentInfoParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContentInfoParser(ContentInfoParserconst&) = delete;
