...
/// @brief Method GetContent, addr 0x325ce48, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x325a428, size 0x1d8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  seq) ;

/// @brief Method get_ContentType, addr 0x325ce40, size 0x8, virtual false, abstract: false, final false
