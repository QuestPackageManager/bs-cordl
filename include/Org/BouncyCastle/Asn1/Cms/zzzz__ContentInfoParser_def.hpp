...
public:
  ...
  /// @brief Method GetContent, addr 0xf077dc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf04dc8, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_ContentType, addr 0xf077d4, size 0x8, virtual false, abstract: false, final false
