...
public:
  ...
  /// @brief Method GetInstance, addr 0x10df0f4, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10df428, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10df0cc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0x10df048, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x10df020, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method get_ID, addr 0x10df3a0, size 0x88, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IsTagged, addr 0x10df324, size 0x7c, virtual false, abstract: false, final false
