...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a25d8, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a2914, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a25d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0x32a2560, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x32a2558, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method get_ID, addr 0x32a2888, size 0x8c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IsTagged, addr 0x32a2808, size 0x80, virtual false, abstract: false, final false
