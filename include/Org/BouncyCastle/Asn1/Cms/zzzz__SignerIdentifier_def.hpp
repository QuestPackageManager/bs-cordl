...
public:
  ...
  /// @brief Method GetInstance, addr 0xf11e4c, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf12180, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf11e24, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0xf11da0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0xf11d78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method get_ID, addr 0xf120f8, size 0x88, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IsTagged, addr 0xf1207c, size 0x7c, virtual false, abstract: false, final false
