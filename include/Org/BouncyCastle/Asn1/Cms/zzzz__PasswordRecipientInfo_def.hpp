...
/// @brief Field keyDerivationAlgorithm, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_keyDerivationAlgorithm, put=__cordl_internal_set_keyDerivationAlgorithm)) ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm;
...
/// @brief Method GetInstance, addr 0x329ff04, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x329ff18, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x32a00a8, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x329fc2c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x329fbb8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x329fcac, size 0x258, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_EncryptedKey, addr 0x32a00a0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedKey() ;

/// @brief Method get_KeyDerivationAlgorithm, addr 0x32a0090, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyDerivationAlgorithm() ;

/// @brief Method get_KeyEncryptionAlgorithm, addr 0x32a0098, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyEncryptionAlgorithm() ;

/// @brief Method get_Version, addr 0x32a0088, size 0x8, virtual false, abstract: false, final false
