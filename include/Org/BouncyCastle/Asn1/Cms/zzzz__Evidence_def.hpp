...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::Evidence*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::Evidence*, "Org.BouncyCastle.Asn1.Cms", "Evidence");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x335875c, size 0x28, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::Evidence* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x33585fc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335878c, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3358540, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x3358538, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::TimeStampTokenEvidence* tstEvidence);

  /// @brief Method get_TstEvidence, addr 0x3358784, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::Evidence) == 0x20, "Size mismatch!");
