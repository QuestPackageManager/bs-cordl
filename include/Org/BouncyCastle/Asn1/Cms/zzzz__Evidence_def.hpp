...
public:
  ...
  /// @brief Method GetInstance, addr 0x23039d0, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::Evidence* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x230386c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23039f4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23037a8, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x2303780, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::TimeStampTokenEvidence* tstEvidence);

  /// @brief Method get_TstEvidence, addr 0x23039ec, size 0x8, virtual true, abstract: false, final false
