...
public:
  ...
  /// @brief Method GetInstance, addr 0x23063ac, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2309e48, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2309fc8, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2309c10, size 0x238, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x2309b7c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyIdentifier);

  /// @brief Method .ctor, addr 0x2309b88, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2309b40, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Date, addr 0x2309fb8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_Date();

  /// @brief Method get_OtherKeyAttribute, addr 0x2309fc0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute* get_OtherKeyAttribute();

  /// @brief Method get_SubjectKeyIdentifier, addr 0x2309fb0, size 0x8, virtual false, abstract: false, final false
