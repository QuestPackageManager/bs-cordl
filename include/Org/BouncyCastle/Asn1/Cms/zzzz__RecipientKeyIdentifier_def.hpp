...
public:
  ...
  /// @brief Method GetInstance, addr 0xf0abf8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xf0e798, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf0e928, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0e564, size 0x234, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0xf0e4c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyIdentifier);

  /// @brief Method .ctor, addr 0xf0e4d4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0e48c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Date, addr 0xf0e918, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_Date();

  /// @brief Method get_OtherKeyAttribute, addr 0xf0e920, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute* get_OtherKeyAttribute();

  /// @brief Method get_SubjectKeyIdentifier, addr 0xf0e910, size 0x8, virtual false, abstract: false, final false
