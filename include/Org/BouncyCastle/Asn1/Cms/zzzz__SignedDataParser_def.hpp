...
public:
  ...
  /// @brief Method GetCertificates, addr 0x230e0cc, size 0x258, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetCertificates();

  /// @brief Method GetCrls, addr 0x230e324, size 0x2b4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetCrls();

  /// @brief Method GetDigestAlgorithms, addr 0x230deec, size 0xdc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetDigestAlgorithms();

  /// @brief Method GetEncapContentInfo, addr 0x230dfc8, size 0x104, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser* GetEncapContentInfo();

  /// @brief Method GetInstance, addr 0x230dc38, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::SignedDataParser* GetInstance(::System::Object* o);

  /// @brief Method GetSignerInfos, addr 0x230e5d8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230ddc0, size 0x124, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser* seq);

  /// @brief Method get_Version, addr 0x230dee4, size 0x8, virtual false, abstract: false, final false
