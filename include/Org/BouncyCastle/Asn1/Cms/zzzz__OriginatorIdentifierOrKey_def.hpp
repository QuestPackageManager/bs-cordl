...
public:
  ...
  /// @brief Method GetInstance, addr 0x22d34ac, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x22d46a8, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22d4b0c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d4658, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* id);

  /// @brief Method .ctor, addr 0x22d44f4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* id);

  /// @brief Method .ctor, addr 0x22d4680, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* id);

  /// @brief Method .ctor, addr 0x22d44cc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* id);

  /// @brief Method .ctor, addr 0x22d45dc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* id);

  /// @brief Method .ctor, addr 0x22d4560, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier* id);

  /// @brief Method get_ID, addr 0x22d493c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID();

  /// @brief Method get_IssuerAndSerialNumber, addr 0x22d4944, size 0x7c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* get_IssuerAndSerialNumber();

  /// @brief Method get_OriginatorKey, addr 0x22d4a54, size 0x4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* get_OriginatorKey();

  /// @brief Method get_OriginatorPublicKey, addr 0x22d4a58, size 0x9c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::OriginatorPublicKey* get_OriginatorPublicKey();

  /// @brief Method get_SubjectKeyIdentifier, addr 0x22d49c0, size 0x94, virtual false, abstract: false, final false
