...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cms::KekIdentifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cms::KekIdentifier*, "Org.BouncyCastle.Asn1.Cms", "KekIdentifier");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x335b384, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x335b398, size 0x170, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cms::KekIdentifier* GetInstance(::System::Object* obj);

  static inline ::Org::BouncyCastle::Asn1::Cms::KekIdentifier* New_ctor(::ArrayW<uint8_t> keyIdentifier, ::Org::BouncyCastle::Asn1::DerGeneralizedTime* date,
  ...
  /// @brief Method ToAsn1Object, addr 0x335b520, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x335aedc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> keyIdentifier, ::Org::BouncyCastle::Asn1::DerGeneralizedTime* date, ::Org::BouncyCastle::Asn1::Cms::OtherKeyAttribute* other);

  /// @brief Method .ctor, addr 0x335af58, size 0x2a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Date, addr 0x335b510, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_Date();

  /// @brief Method get_KeyIdentifier, addr 0x335b508, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_KeyIdentifier();

  /// @brief Method get_Other, addr 0x335b518, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KekIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KekIdentifier(KekIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KekIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KekIdentifier(KekIdentifierconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cms::KekIdentifier) == 0x28, "Size mismatch!");
