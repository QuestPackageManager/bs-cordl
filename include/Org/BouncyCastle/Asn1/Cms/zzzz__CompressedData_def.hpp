...
public:
  ...
  /// @brief Method GetInstance, addr 0x325c548, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x325c55c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x325c6e4, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325c3cc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325c440, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CompressionAlgorithmIdentifier, addr 0x325c6d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_CompressionAlgorithmIdentifier();

  /// @brief Method get_EncapContentInfo, addr 0x325c6dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_EncapContentInfo();

  /// @brief Method get_Version, addr 0x325c6cc, size 0x8, virtual false, abstract: false, final false
