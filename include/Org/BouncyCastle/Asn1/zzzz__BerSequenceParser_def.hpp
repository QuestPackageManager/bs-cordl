...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerSequenceParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerSequenceParser*, "Org.BouncyCastle.Asn1", "BerSequenceParser");
...
public:
  ...
  /// @brief Method ReadObject, addr 0x368b7f0, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x3683f34, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3683f2c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerSequenceParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerSequenceParser(BerSequenceParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerSequenceParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerSequenceParser(BerSequenceParserconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerSequenceParser) == 0x18, "Size mismatch!");
