...
public:
  ...
  /// @brief Method ReadObject, addr 0x35cc214, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x35c4958, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x35c4950, size 0x8, virtual false, abstract: false, final false
