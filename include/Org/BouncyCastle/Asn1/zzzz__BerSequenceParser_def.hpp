...
public:
  ...
  /// @brief Method ReadObject, addr 0x2639a24, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x2631f48, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2631f20, size 0x28, virtual false, abstract: false, final false
