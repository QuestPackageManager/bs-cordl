...
public:
  ...
  /// @brief Method .ctor, addr 0x35423e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RosstandartObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RosstandartObjectIdentifiers(RosstandartObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RosstandartObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RosstandartObjectIdentifiers(RosstandartObjectIdentifiersconst&) = delete;
