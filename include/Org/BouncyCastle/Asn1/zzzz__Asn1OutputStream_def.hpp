...
public:
  ...
  /// @brief Method WriteObject, addr 0x36832ec, size 0x16c, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x36832e8, size 0x4, virtual false, abstract: false, final false
