...
public:
  ...
  /// @brief Method WriteObject, addr 0x262e004, size 0x158, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x262e000, size 0x4, virtual false, abstract: false, final false
