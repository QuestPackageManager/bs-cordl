...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::Challenge*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::Challenge*, "Org.BouncyCastle.Asn1.Cmp", "Challenge");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3346ae8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3346c74, size 0x184, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3346a3c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Owf, addr 0x3346c6c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::Challenge) == 0x28, "Size mismatch!");
