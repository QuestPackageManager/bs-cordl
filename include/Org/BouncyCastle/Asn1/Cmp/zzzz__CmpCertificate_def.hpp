...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*, "Org.BouncyCastle.Asn1.Cmp", "CmpCertificate");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3346cc8, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3349240, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3349180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* x509v2AttrCert);

  /// @brief Method .ctor, addr 0x3349188, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* x509v3PKCert);

  /// @brief Method get_IsX509v3PKCert, addr 0x3349220, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsX509v3PKCert();

  /// @brief Method get_X509v2AttrCert, addr 0x3349238, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* get_X509v2AttrCert();

  /// @brief Method get_X509v3PKCert, addr 0x3349230, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmpCertificate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmpCertificate(CmpCertificate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmpCertificate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmpCertificate(CmpCertificateconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::CmpCertificate) == 0x20, "Size mismatch!");
