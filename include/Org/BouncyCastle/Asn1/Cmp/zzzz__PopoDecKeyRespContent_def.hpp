...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyRespContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyRespContent*, "Org.BouncyCastle.Asn1.Cmp", "PopoDecKeyRespContent");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x334c104, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3350b38, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToDerIntegerArray, addr 0x3350a3c, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::DerInteger*> ToDerIntegerArray();
  ...
  /// @brief Method .ctor, addr 0x3350a34, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PopoDecKeyRespContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PopoDecKeyRespContent(PopoDecKeyRespContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PopoDecKeyRespContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PopoDecKeyRespContent(PopoDecKeyRespContentconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::PopoDecKeyRespContent) == 0x18, "Size mismatch!");
