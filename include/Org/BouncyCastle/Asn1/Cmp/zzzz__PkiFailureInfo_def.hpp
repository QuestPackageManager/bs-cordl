...
public:
  ...
  /// @brief Method .ctor, addr 0xe96110, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe96174, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* info);

  /// @brief Method ToString, addr 0xe96204, size 0x98, virtual true, abstract: false, final false
