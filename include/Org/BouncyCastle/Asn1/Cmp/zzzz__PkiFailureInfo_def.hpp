...
public:
  ...
  /// @brief Method ToString, addr 0xedd1d4, size 0x98, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0xedd144, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* info);

  /// @brief Method .ctor, addr 0xedd0e0, size 0x64, virtual false, abstract: false, final false
