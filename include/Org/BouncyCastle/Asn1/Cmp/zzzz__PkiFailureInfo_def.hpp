...
public:
  ...
  /// @brief Method .ctor addr 0xdf60ac size 0x64 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdf6110 size 0x90 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* info);

  /// @brief Method ToString addr 0xdf61a0 size 0x98 virtual true final false
