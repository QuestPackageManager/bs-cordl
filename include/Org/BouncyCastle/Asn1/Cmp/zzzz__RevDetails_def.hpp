...
public:
  ...
  /// @brief Method GetInstance, addr 0x22fdc00, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fdde0, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fdd7c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertTemplate* certDetails);

  /// @brief Method .ctor, addr 0x22fdda4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fdb2c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertDetails, addr 0x22fddd0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* get_CertDetails();

  /// @brief Method get_CrlEntryDetails, addr 0x22fddd8, size 0x8, virtual true, abstract: false, final false
