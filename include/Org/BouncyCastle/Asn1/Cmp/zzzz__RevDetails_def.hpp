...
public:
  ...
  /// @brief Method GetInstance, addr 0xeffe84, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf00070, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf0000c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertTemplate* certDetails);

  /// @brief Method .ctor, addr 0xf00034, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeffdb0, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertDetails, addr 0xf00060, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* get_CertDetails();

  /// @brief Method get_CrlEntryDetails, addr 0xf00068, size 0x8, virtual true, abstract: false, final false
