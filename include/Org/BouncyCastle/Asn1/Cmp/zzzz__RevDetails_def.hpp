...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d399c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d3b88, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d3b24, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::CertTemplate* certDetails);

  /// @brief Method .ctor, addr 0x10d3b4c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d38c8, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertDetails, addr 0x10d3b78, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* get_CertDetails();

  /// @brief Method get_CrlEntryDetails, addr 0x10d3b80, size 0x8, virtual true, abstract: false, final false
