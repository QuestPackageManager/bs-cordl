...
public:
  ...
  /// @brief Method GetInstance, addr 0x3226498, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3229938, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToPkiMessageArray, addr 0x3229840, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32297d8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::PkiMessage*, ::Array<::Org::BouncyCastle::Asn1::Cmp::PkiMessage*>*> msgs);

  /// @brief Method .ctor, addr 0x32297d0, size 0x8, virtual false, abstract: false, final false
