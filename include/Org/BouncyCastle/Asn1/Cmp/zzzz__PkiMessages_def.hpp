...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f7e10, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fb1e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToPkiMessageArray, addr 0x22fb0f4, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fb080, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::PkiMessage*, ::Array<::Org::BouncyCastle::Asn1::Cmp::PkiMessage*>*> msgs);

  /// @brief Method .ctor, addr 0x22fb058, size 0x28, virtual false, abstract: false, final false
