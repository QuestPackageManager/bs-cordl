...
public:
  ...
  /// @brief Method GetInstance, addr 0x10ce7a8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d46a8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToRevDetailsArray, addr 0x10d45b4, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d4538, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*, ::Array<::Org::BouncyCastle::Asn1::Cmp::RevDetails*>*> revDetails);

  /// @brief Method .ctor, addr 0x10d4510, size 0x28, virtual false, abstract: false, final false
