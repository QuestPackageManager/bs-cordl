...
public:
  ...
  static inline ::Org::BouncyCastle::Asn1::Cmp::RevReqContent* New_ctor(/* [ParamArray] */ ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*> revDetails);
  ...
  inline void _ctor(/* [ParamArray] */ ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*> revDetails);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevReqContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevReqContent(RevReqContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevReqContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevReqContent(RevReqContentconst&) = delete;
