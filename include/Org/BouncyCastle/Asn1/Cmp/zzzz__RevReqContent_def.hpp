...
public:
  ...
  /// @brief Method GetInstance, addr 0x3225ecc, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x322bbb8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToRevDetailsArray, addr 0x322bac0, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322ba58, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*, ::Array<::Org::BouncyCastle::Asn1::Cmp::RevDetails*>*> revDetails);

  /// @brief Method .ctor, addr 0x322ba50, size 0x8, virtual false, abstract: false, final false
