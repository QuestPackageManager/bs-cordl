...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f8c18, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fe90c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToRevDetailsArray, addr 0x22fe818, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fe7a4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::RevDetails*, ::Array<::Org::BouncyCastle::Asn1::Cmp::RevDetails*>*> revDetails);

  /// @brief Method .ctor, addr 0x22fe77c, size 0x28, virtual false, abstract: false, final false
