...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::CmpObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::CmpObjectIdentifiers*, "Org.BouncyCastle.Asn1.Cmp", "CmpObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3349970, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmpObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmpObjectIdentifiers(CmpObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmpObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmpObjectIdentifiers(CmpObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::CmpObjectIdentifiers) == 0x10, "Size mismatch!");
