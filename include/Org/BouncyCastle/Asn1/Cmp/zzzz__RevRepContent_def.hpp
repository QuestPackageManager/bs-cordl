...
public:
  ...
  /// @brief Method GetCrls, addr 0x322b4c4, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*, ::Array<::Org::BouncyCastle::Asn1::X509::CertificateList*>*> GetCrls();

  /// @brief Method GetInstance, addr 0x3226048, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetRevCerts, addr 0x322b3c0, size 0x104, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Crmf::CertId*, ::Array<::Org::BouncyCastle::Asn1::Crmf::CertId*>*> GetRevCerts();

  /// @brief Method GetStatus, addr 0x322b2c8, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x322b5c8, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322b1f0, size 0xd8, virtual false, abstract: false, final false
