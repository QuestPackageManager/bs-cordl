...
public:
  ...
  /// @brief Method GetCrls, addr 0x22fbe68, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*, ::Array<::Org::BouncyCastle::Asn1::X509::CertificateList*>*> GetCrls();

  /// @brief Method GetInstance, addr 0x22f69b8, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetRevCerts, addr 0x22fbd68, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Crmf::CertId*, ::Array<::Org::BouncyCastle::Asn1::Crmf::CertId*>*> GetRevCerts();

  /// @brief Method GetStatus, addr 0x22fbc74, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fbf68, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fbb94, size 0xe0, virtual false, abstract: false, final false
