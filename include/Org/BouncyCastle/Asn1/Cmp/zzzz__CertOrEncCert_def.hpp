...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertOrEncCert", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertOrEncCert(CertOrEncCert&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertOrEncCert", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertOrEncCert(CertOrEncCertconst&) = delete;
