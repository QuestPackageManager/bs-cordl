...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d2614, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10ca9a4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d295c, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d262c, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x10d27a4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t status);

  /// @brief Method .ctor, addr 0x10d2820, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* statusString);

  /// @brief Method .ctor, addr 0x10d28a0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FailInfo, addr 0x10d2954, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_FailInfo();

  /// @brief Method get_Status, addr 0x10d2930, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Status();

  /// @brief Method get_StatusString, addr 0x10d294c, size 0x8, virtual false, abstract: false, final false
