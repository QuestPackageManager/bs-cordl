...
public:
  ...
  /// @brief Method GetInstance, addr 0x3350010, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x334866c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335031c, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3350024, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3350198, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t status);

  /// @brief Method .ctor, addr 0x3350204, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* statusString);

  /// @brief Method .ctor, addr 0x3350274, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FailInfo, addr 0x3350314, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_FailInfo();

  /// @brief Method get_Status, addr 0x33502f4, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Status();

  /// @brief Method get_StatusString, addr 0x335030c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkiStatusInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkiStatusInfo(PkiStatusInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkiStatusInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkiStatusInfo(PkiStatusInfoconst&) = delete;
