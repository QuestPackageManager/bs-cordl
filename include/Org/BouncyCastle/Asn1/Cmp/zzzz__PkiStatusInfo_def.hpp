...
public:
  ...
  /// @brief Method GetInstance, addr 0x32544a0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x324cafc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32547ac, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32544b4, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3254628, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t status);

  /// @brief Method .ctor, addr 0x3254694, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(int32_t status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* statusString);

  /// @brief Method .ctor, addr 0x3254704, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FailInfo, addr 0x32547a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_FailInfo();

  /// @brief Method get_Status, addr 0x3254784, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Status();

  /// @brief Method get_StatusString, addr 0x325479c, size 0x8, virtual false, abstract: false, final false
