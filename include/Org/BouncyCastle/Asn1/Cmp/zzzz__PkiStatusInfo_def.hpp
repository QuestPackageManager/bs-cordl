...
public:
  ...
  /// @brief Method GetInstance, addr 0x22fc86c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x22f4ee0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fcb9c, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fc884, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x22fc9fc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(int32_t status);

  /// @brief Method .ctor, addr 0x22fca70, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* statusString);

  /// @brief Method .ctor, addr 0x22fcae8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FailInfo, addr 0x22fcb94, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_FailInfo();

  /// @brief Method get_Status, addr 0x22fcb70, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Status();

  /// @brief Method get_StatusString, addr 0x22fcb8c, size 0x8, virtual false, abstract: false, final false
