...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f9484, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fce74, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fcdf0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* certReqId, ::Org::BouncyCastle::Asn1::DerInteger* checkAfter);

  /// @brief Method .ctor, addr 0x22fce20, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fcd4c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertReqID, addr 0x22fce5c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_CheckAfter, addr 0x22fce64, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CheckAfter();

  /// @brief Method get_Reason, addr 0x22fce6c, size 0x8, virtual true, abstract: false, final false
