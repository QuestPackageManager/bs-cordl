...
public:
  ...
  /// @brief Method GetGeneralInfo, addr 0x22fb1cc, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*, ::Array<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*>*> GetGeneralInfo();

  /// @brief Method GetInstance, addr 0x22faf34, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fb2cc, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fb138, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fb0b0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fac7c, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FreeText, addr 0x22fb1c4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_FreeText();

  /// @brief Method get_MessageTime, addr 0x22fb18c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_MessageTime();

  /// @brief Method get_ProtectionAlg, addr 0x22fb194, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ProtectionAlg();

  /// @brief Method get_Pvno, addr 0x22fb174, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Pvno();

  /// @brief Method get_RecipKID, addr 0x22fb1a4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipKID();

  /// @brief Method get_RecipNonce, addr 0x22fb1bc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipNonce();

  /// @brief Method get_Recipient, addr 0x22fb184, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Recipient();

  /// @brief Method get_Sender, addr 0x22fb17c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Sender();

  /// @brief Method get_SenderKID, addr 0x22fb19c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderKID();

  /// @brief Method get_SenderNonce, addr 0x22fb1b4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderNonce();

  /// @brief Method get_TransactionID, addr 0x22fb1ac, size 0x8, virtual true, abstract: false, final false
