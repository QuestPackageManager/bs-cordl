...
public:
  ...
  /// @brief Method GetGeneralInfo, addr 0x22f771c, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*, ::Array<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*>*> GetGeneralInfo();

  /// @brief Method GetInstance, addr 0x22f7484, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f781c, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f7688, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f7600, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f71cc, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_FreeText, addr 0x22f7714, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_FreeText();

  /// @brief Method get_MessageTime, addr 0x22f76dc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_MessageTime();

  /// @brief Method get_ProtectionAlg, addr 0x22f76e4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_ProtectionAlg();

  /// @brief Method get_Pvno, addr 0x22f76c4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Pvno();

  /// @brief Method get_RecipKID, addr 0x22f76f4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipKID();

  /// @brief Method get_RecipNonce, addr 0x22f770c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_RecipNonce();

  /// @brief Method get_Recipient, addr 0x22f76d4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Recipient();

  /// @brief Method get_Sender, addr 0x22f76cc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Sender();

  /// @brief Method get_SenderKID, addr 0x22f76ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderKID();

  /// @brief Method get_SenderNonce, addr 0x22f7704, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_SenderNonce();

  /// @brief Method get_TransactionID, addr 0x22f76fc, size 0x8, virtual true, abstract: false, final false
