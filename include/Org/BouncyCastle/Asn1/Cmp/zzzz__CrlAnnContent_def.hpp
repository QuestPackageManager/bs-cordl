...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::CrlAnnContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::CrlAnnContent*, "Org.BouncyCastle.Asn1.Cmp", "CrlAnnContent");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x334997c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3349bf4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToCertificateListArray, addr 0x3349af8, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> ToCertificateListArray();
  ...
  /// @brief Method .ctor, addr 0x3349974, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrlAnnContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrlAnnContent(CrlAnnContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrlAnnContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrlAnnContent(CrlAnnContentconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::CrlAnnContent) == 0x18, "Size mismatch!");
