...
/// @brief Method GetInstance, addr 0x328dd40, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x32927c0, size 0x1d8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3292638, size 0x160, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_BadSinceDate, addr 0x32927b0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_BadSinceDate() ;

/// @brief Method get_CertID, addr 0x32927a0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::CertId* get_CertID() ;

/// @brief Method get_CrlDetails, addr 0x32927b8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_CrlDetails() ;

/// @brief Method get_Status, addr 0x3292798, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::PkiStatusEncodable* get_Status() ;

/// @brief Method get_WillBeRevokedAt, addr 0x32927a8, size 0x8, virtual true, abstract: false, final false
