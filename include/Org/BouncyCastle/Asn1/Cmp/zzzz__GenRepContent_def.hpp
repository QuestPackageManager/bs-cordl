...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f4bf0, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f4ed8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToInfoTypeAndValueArray, addr 0x22f4de4, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f4d70, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*, ::Array<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*>*> itv);

  /// @brief Method .ctor, addr 0x22f4bc8, size 0x28, virtual false, abstract: false, final false
