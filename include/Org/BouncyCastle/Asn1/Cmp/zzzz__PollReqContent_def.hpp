...
public:
  ...
  /// @brief Method GetCertReqIDs, addr 0x334e368, size 0x13c, virtual true, abstract: false, final false
  inline ::ArrayW<::ArrayW<::Org::BouncyCastle::Asn1::DerInteger*>> GetCertReqIDs();

  /// @brief Method GetInstance, addr 0x334a640, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceToDerIntegerArray, addr 0x334e4a4, size 0xf8, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Asn1::DerInteger*> SequenceToDerIntegerArray(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x334e59c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334e360, size 0x8, virtual false, abstract: false, final false
