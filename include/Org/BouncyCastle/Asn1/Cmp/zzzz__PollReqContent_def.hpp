...
public:
  ...
  /// @brief Method GetCertReqIDs, addr 0xedfb78, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xedbd04, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceToDerIntegerArray, addr 0xedfcb4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xedfda8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedfb50, size 0x28, virtual false, abstract: false, final false
