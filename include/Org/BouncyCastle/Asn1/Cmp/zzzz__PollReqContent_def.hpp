...
public:
  ...
  /// @brief Method GetCertReqIDs, addr 0xeff27c, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xefb408, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceToDerIntegerArray, addr 0xeff3b8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xeff4ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeff254, size 0x28, virtual false, abstract: false, final false
