...
public:
  ...
  /// @brief Method GetCertReqIDs, addr 0x22fbc98, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x22f7f90, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method SequenceToDerIntegerArray, addr 0x22fbdd4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fbec8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fbc70, size 0x28, virtual false, abstract: false, final false
