...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyRecRepContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyRecRepContent(KeyRecRepContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyRecRepContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyRecRepContent(KeyRecRepContentconst&) = delete;
