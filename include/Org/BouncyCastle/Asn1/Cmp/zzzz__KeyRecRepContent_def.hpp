...
public:
  ...
  /// @brief Method GetCACerts, addr 0x22c2188, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*, ::Array<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*>*> GetCACerts();

  /// @brief Method GetInstance, addr 0x22c1ffc, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyPairHist, addr 0x22c2284, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22c2380, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22c1e64, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NewSigCert, addr 0x22c2180, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewSigCert();

  /// @brief Method get_Status, addr 0x22c2178, size 0x8, virtual true, abstract: false, final false
