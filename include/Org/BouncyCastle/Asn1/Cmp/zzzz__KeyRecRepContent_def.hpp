...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent*, "Org.BouncyCastle.Asn1.Cmp", "KeyRecRepContent");
...
public:
  ...
  /// @brief Method GetCACerts, addr 0x3348b60, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*> GetCACerts();

  /// @brief Method GetInstance, addr 0x33489cc, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyPairHist, addr 0x3348c60, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3348d60, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3348828, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NewSigCert, addr 0x3348b58, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewSigCert();

  /// @brief Method get_Status, addr 0x3348b50, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent) == 0x30, "Size mismatch!");
