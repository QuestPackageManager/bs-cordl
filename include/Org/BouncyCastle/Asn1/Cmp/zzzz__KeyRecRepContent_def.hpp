...
public:
  ...
  /// @brief Method GetCACerts, addr 0xfd33f8, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*, ::Array<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*>*> GetCACerts();

  /// @brief Method GetInstance, addr 0xfd3260, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyPairHist, addr 0xfd34f4, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfd35f0, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd30c4, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NewSigCert, addr 0xfd33f0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewSigCert();

  /// @brief Method get_Status, addr 0xfd33e8, size 0x8, virtual true, abstract: false, final false
