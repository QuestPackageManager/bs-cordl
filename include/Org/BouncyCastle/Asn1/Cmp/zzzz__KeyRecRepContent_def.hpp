...
/// @brief Method GetCACerts, addr 0x328c6a8, size 0x100, virtual true, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*,::Array<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*>*> GetCACerts() ;

/// @brief Method GetInstance, addr 0x328c514, size 0x184, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent* GetInstance(::System::Object*  obj) ;

/// @brief Method GetKeyPairHist, addr 0x328c7a8, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x328c8a8, size 0x148, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x328c370, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_NewSigCert, addr 0x328c6a0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewSigCert() ;

/// @brief Method get_Status, addr 0x328c698, size 0x8, virtual true, abstract: false, final false
