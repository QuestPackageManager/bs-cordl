...
public:
  ...
  /// @brief Method GetInstance, addr 0x324bc80, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x324be84, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324be04, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertOrEncCert* certOrEncCert);

  /// @brief Method .ctor, addr 0x324be10, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324b9f0, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertOrEncCert, addr 0x324be6c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CertOrEncCert* get_CertOrEncCert();

  /// @brief Method get_PrivateKey, addr 0x324be74, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* get_PrivateKey();

  /// @brief Method get_PublicationInfo, addr 0x324be7c, size 0x8, virtual true, abstract: false, final false
