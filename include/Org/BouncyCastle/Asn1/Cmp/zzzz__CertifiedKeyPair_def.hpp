...
public:
  ...
  /// @brief Method GetInstance, addr 0xed68b0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xed6ae8, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed6a38, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CertOrEncCert* certOrEncCert);

  /// @brief Method .ctor, addr 0xed6a44, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xed6630, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertOrEncCert, addr 0xed6ad0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CertOrEncCert* get_CertOrEncCert();

  /// @brief Method get_PrivateKey, addr 0xed6ad8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* get_PrivateKey();

  /// @brief Method get_PublicationInfo, addr 0xed6ae0, size 0x8, virtual true, abstract: false, final false
