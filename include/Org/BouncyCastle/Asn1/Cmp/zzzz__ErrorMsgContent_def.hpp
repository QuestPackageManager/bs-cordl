...
public:
  ...
  /// @brief Method GetInstance, addr 0x328a8b8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x328aabc, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328aa3c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* pkiStatusInfo);

  /// @brief Method .ctor, addr 0x328aa48, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328a620, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ErrorCode, addr 0x328aaac, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_ErrorCode();

  /// @brief Method get_ErrorDetails, addr 0x328aab4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_ErrorDetails();

  /// @brief Method get_PkiStatusInfo, addr 0x328aaa4, size 0x8, virtual true, abstract: false, final false
