...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent*, "Org.BouncyCastle.Asn1.Cmp", "ErrorMsgContent");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3349e94, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334a098, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334a018, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* pkiStatusInfo);

  /// @brief Method .ctor, addr 0x334a024, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3349bfc, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ErrorCode, addr 0x334a088, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_ErrorCode();

  /// @brief Method get_ErrorDetails, addr 0x334a090, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* get_ErrorDetails();

  /// @brief Method get_PkiStatusInfo, addr 0x334a080, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ErrorMsgContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ErrorMsgContent(ErrorMsgContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ErrorMsgContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ErrorMsgContent(ErrorMsgContentconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::ErrorMsgContent) == 0x28, "Size mismatch!");
