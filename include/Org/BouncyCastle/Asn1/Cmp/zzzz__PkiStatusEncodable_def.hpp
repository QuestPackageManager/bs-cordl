...
public:
  ...
  /// @brief Method GetInstance, addr 0xfd83a8, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfd8550, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfd8304, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatus status);

  /// @brief Method .ctor, addr 0xfd8380, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0xfd8534, size 0x1c, virtual true, abstract: false, final false
