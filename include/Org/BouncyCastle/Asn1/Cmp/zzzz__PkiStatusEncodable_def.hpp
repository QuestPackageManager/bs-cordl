...
public:
  ...
  /// @brief Method GetInstance, addr 0x329078c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3290920, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3290718, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatus status);

  /// @brief Method .ctor, addr 0x3290784, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x3290908, size 0x18, virtual true, abstract: false, final false
