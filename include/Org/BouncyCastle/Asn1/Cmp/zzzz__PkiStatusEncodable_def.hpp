...
public:
  ...
  /// @brief Method .ctor, addr 0xe6d21c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6d298, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* status);

  /// @brief Method GetInstance, addr 0xe6d2c0, size 0x18c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiStatusEncodable* GetInstance(::System::Object* obj);

  /// @brief Method get_Value, addr 0xe6d44c, size 0x1c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Value();

  /// @brief Method ToAsn1Object, addr 0xe6d468, size 0x8, virtual true, abstract: false, final false
