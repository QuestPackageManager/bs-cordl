...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f8b50, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f8cec, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f8ab4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatus status);

  /// @brief Method .ctor, addr 0x22f8b28, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x22f8cd0, size 0x1c, virtual true, abstract: false, final false
