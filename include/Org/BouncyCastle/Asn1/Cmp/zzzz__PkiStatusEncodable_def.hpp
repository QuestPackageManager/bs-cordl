...
public:
  ...
  /// @brief Method GetInstance, addr 0x10cbacc, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10cbc74, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cba28, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiStatus status);

  /// @brief Method .ctor, addr 0x10cbaa4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Value, addr 0x10cbc58, size 0x1c, virtual true, abstract: false, final false
