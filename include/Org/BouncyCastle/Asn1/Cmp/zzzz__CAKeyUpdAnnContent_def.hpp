...
public:
  ...
  /// @brief Method GetInstance, addr 0xfcf1c4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xfcf364, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfcef68, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NewWithNew, addr 0xfcf35c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewWithNew();

  /// @brief Method get_NewWithOld, addr 0xfcf354, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_NewWithOld();

  /// @brief Method get_OldWithNew, addr 0xfcf34c, size 0x8, virtual true, abstract: false, final false
