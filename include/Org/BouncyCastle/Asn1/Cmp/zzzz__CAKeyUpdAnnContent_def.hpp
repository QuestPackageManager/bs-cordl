...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CAKeyUpdAnnContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CAKeyUpdAnnContent(CAKeyUpdAnnContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CAKeyUpdAnnContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CAKeyUpdAnnContent(CAKeyUpdAnnContentconst&) = delete;
