...
public:
  ...
  /// @brief Method GetInstance, addr 0x10d8924, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10d8da8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToInfoTypeAndValueArray, addr 0x10d8b2c, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d8ab0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*, ::Array<::Org::BouncyCastle::Asn1::Cmp::InfoTypeAndValue*>*> itv);

  /// @brief Method .ctor, addr 0x10d88fc, size 0x28, virtual false, abstract: false, final false
