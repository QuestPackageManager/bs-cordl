...
public:
  ...
  /// @brief Method Add, addr 0x322b6f8, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* Add(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method Add, addr 0x322b720, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method AddCrl, addr 0x322b7c8, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* AddCrl(::Org::BouncyCastle::Asn1::X509::CertificateList* crl);

  /// @brief Method Build, addr 0x322b7f0, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x322b9c4, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
