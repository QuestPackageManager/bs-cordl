...
public:
  ...
  /// @brief Method Add, addr 0x22fe468, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* Add(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method Add, addr 0x22fe490, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method AddCrl, addr 0x22fe538, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* AddCrl(::Org::BouncyCastle::Asn1::X509::CertificateList* crl);

  /// @brief Method Build, addr 0x22fe560, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fe6ec, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
