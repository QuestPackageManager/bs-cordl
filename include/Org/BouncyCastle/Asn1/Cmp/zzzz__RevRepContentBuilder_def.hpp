...
public:
  ...
  /// @brief Method Add, addr 0x10d41d0, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* Add(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method Add, addr 0x10d41f8, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method AddCrl, addr 0x10d42a4, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* AddCrl(::Org::BouncyCastle::Asn1::X509::CertificateList* crl);

  /// @brief Method Build, addr 0x10d42cc, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10d4470, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
