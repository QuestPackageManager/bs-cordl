...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevRepContentBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevRepContentBuilder(RevRepContentBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevRepContentBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevRepContentBuilder(RevRepContentBuilderconst&) = delete;
