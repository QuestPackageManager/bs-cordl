...
public:
  ...
  /// @brief Method Add, addr 0x10cd960, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* Add(::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* status);

  /// @brief Method Add, addr 0x10cd988, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method AddCrl, addr 0x10cda34, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder* AddCrl(::Org::BouncyCastle::Asn1::X509::CertificateList* crl);

  /// @brief Method Build, addr 0x10cda5c, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cdc00, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
