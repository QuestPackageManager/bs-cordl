...
public:
  ...
  /// @brief Method GetInstance, addr 0x22fb194, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fb75c, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fb6f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* infoType);

  /// @brief Method .ctor, addr 0x22fb720, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* infoType, ::Org::BouncyCastle::Asn1::Asn1Encodable* optionalValue);

  /// @brief Method .ctor, addr 0x22fb630, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_InfoType, addr 0x22fb74c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_InfoType();

  /// @brief Method get_InfoValue, addr 0x22fb754, size 0x8, virtual true, abstract: false, final false
