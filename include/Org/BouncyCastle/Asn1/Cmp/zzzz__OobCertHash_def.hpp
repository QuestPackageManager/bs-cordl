...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Cmp::OobCertHash*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Cmp::OobCertHash*, "Org.BouncyCastle.Asn1.Cmp", "OobCertHash");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x334b584, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334b718, size 0xd0, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* const& __cordl_internal_get_hashAlg() const;

  constexpr ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*& __cordl_internal_get_hashAlg();

  constexpr ::Org::BouncyCastle::Asn1::DerBitString* const& __cordl_internal_get_hashVal() const;
  ...
  /// @brief Method .ctor, addr 0x334b230, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertID, addr 0x334b710, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertId* get_CertID();

  /// @brief Method get_HashAlg, addr 0x334b708, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OobCertHash", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OobCertHash(OobCertHash&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OobCertHash", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OobCertHash(OobCertHashconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Cmp::OobCertHash) == 0x28, "Size mismatch!");
