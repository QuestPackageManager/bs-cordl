...
public:
  ...
  /// @brief Method GetInstance, addr 0xe9629c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xe91ee4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe962b4, size 0x334, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* New_ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0xe965e8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method get_Size, addr 0xe96664, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Size();

  /// @brief Method get_Count, addr 0xe96688, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0xe966ac, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method GetStringAt, addr 0xe96740, size 0x4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* GetStringAt(int32_t index);

  /// @brief Method ToAsn1Object, addr 0xe96744, size 0x8, virtual true, abstract: false, final false
