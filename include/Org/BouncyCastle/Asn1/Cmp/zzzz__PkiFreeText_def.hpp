...
public:
  ...
  /// @brief Method GetInstance, addr 0x22fae68, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x22f6c38, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* GetInstance(::System::Object* obj);

  /// @brief Method GetStringAt, addr 0x22fb2f8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22fb2fc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fb1a8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0x22fae80, size 0x328, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Count, addr 0x22fb240, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x22fb264, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0x22fb21c, size 0x24, virtual false, abstract: false, final false
