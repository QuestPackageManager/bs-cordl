...
public:
  ...
  /// @brief Method GetInstance, addr 0xedd26c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xed8eb4, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* GetInstance(::System::Object* obj);

  /// @brief Method GetStringAt, addr 0xedd710, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xedd714, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xedd5b8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0xedd284, size 0x334, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Count, addr 0xedd658, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0xedd67c, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0xedd634, size 0x24, virtual false, abstract: false, final false
