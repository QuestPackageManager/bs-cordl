...
public:
  ...
  /// @brief Method GetInstance, addr 0xefc970, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xef85b8, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* GetInstance(::System::Object* obj);

  /// @brief Method GetStringAt, addr 0xefce14, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xefce18, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xefccbc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0xefc988, size 0x334, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Count, addr 0xefcd5c, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0xefcd80, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0xefcd38, size 0x24, virtual false, abstract: false, final false
