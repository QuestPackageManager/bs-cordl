...
public:
  ...
  /// @brief Method GetInstance, addr 0x328e9a4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x328a734, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText* GetInstance(::System::Object* obj);

  /// @brief Method GetStringAt, addr 0x328ee10, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x328ee14, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x328ecc8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String* p);

  /// @brief Method .ctor, addr 0x328e9b8, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Count, addr 0x328ed50, size 0x20, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x328ed70, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_Item(int32_t index);

  /// @brief Method get_Size, addr 0x328ed30, size 0x20, virtual false, abstract: false, final false
