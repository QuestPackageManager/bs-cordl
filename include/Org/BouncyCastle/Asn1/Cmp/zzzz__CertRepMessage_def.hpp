...
public:
  ...
  /// @brief Method GetCAPubs, addr 0x3345d68, size 0x100, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*> GetCAPubs();

  /// @brief Method GetInstance, addr 0x3345b10, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::CertRepMessage* GetInstance(::System::Object* obj);

  /// @brief Method GetResponse, addr 0x3345e68, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33460e4, size 0xb8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3345c94, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3345a18, size 0xf8, virtual false, abstract: false, final false
