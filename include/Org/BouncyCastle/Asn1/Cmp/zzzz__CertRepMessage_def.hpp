...
public:
  ...
  /// @brief Method GetCAPubs, addr 0x22f8d78, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*, ::Array<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*>*> GetCAPubs();

  /// @brief Method GetInstance, addr 0x22f8b18, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Cmp::CertRepMessage* GetInstance(::System::Object* obj);

  /// @brief Method GetResponse, addr 0x22f8e74, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f90e4, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f8c94, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*, ::Array<::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*>*> caPubs,
                    ::ArrayW<::Org::BouncyCastle::Asn1::Cmp::CertResponse*, ::Array<::Org::BouncyCastle::Asn1::Cmp::CertResponse*>*> response);

  /// @brief Method .ctor, addr 0x22f8a20, size 0xf8, virtual false, abstract: false, final false
