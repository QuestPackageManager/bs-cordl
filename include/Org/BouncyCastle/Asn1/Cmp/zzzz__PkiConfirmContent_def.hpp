...
public:
  // Declarations
  /// @brief Method GetInstance addr 0xdf49f8 size 0x150 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdf506c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method ToAsn1Object addr 0xdf5074 size 0x58 virtual true final false
