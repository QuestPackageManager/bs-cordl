...
public:
  // Declarations
  /// @brief Method GetInstance, addr 0x22f5590, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f5bd4, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method .ctor, addr 0x22f5bcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
