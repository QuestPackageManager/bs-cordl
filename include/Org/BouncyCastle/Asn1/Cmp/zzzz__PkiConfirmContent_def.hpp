...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PkiConfirmContent", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PkiConfirmContent(PkiConfirmContent&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PkiConfirmContent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PkiConfirmContent(PkiConfirmContentconst&) = delete;
