...
public:
  // Declarations
  /// @brief Method GetInstance, addr 0xe94a58, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe950cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ToAsn1Object, addr 0xe950d4, size 0x58, virtual true, abstract: false, final false
