...
public:
  // Declarations
  /// @brief Method GetInstance, addr 0xe69bc8, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6a23c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method ToAsn1Object, addr 0xe6a244, size 0x58, virtual true, abstract: false, final false
