...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f0200, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f1a7c, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f1900, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);

  /// @brief Method .ctor, addr 0x22f19b0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f185c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertHash, addr 0x22f1a64, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_CertHash();

  /// @brief Method get_CertReqID, addr 0x22f1a6c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_StatusInfo, addr 0x22f1a74, size 0x8, virtual true, abstract: false, final false
