...
public:
  ...
  /// @brief Method GetInstance, addr 0x10c2e4c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10c4768, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10c45dc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);

  /// @brief Method .ctor, addr 0x10c4690, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10c4538, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertHash, addr 0x10c4750, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_CertHash();

  /// @brief Method get_CertReqID, addr 0x10c4758, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_StatusInfo, addr 0x10c4760, size 0x8, virtual true, abstract: false, final false
