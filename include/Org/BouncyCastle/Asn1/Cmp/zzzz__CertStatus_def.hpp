...
public:
  ...
  /// @brief Method GetInstance, addr 0x22f1920, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f319c, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f3020, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);

  /// @brief Method .ctor, addr 0x22f30d0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f2f7c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertHash, addr 0x22f3184, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_CertHash();

  /// @brief Method get_CertReqID, addr 0x22f318c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_StatusInfo, addr 0x22f3194, size 0x8, virtual true, abstract: false, final false
