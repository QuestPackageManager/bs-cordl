...
public:
  ...
  /// @brief Method GetInstance, addr 0x324b864, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x324d0d4, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324cf70, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> certHash, ::Org::BouncyCastle::Math::BigInteger* certReqId);

  /// @brief Method .ctor, addr 0x324d010, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324ced4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertHash, addr 0x324d0bc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_CertHash();

  /// @brief Method get_CertReqID, addr 0x324d0c4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_StatusInfo, addr 0x324d0cc, size 0x8, virtual true, abstract: false, final false
