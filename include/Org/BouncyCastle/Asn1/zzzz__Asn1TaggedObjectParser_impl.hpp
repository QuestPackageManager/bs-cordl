...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::*)()>(&::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::get_TagNo)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), { ::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), 0 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Asn1::IAsn1Convertible* (::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::*)(int32_t, bool)>(
    &::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::GetObjectParser)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), { ::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), 1 }));
    return ___internal_method;
  }
};
inline int32_t Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::get_TagNo() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), 0 })));
...
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* Org::BouncyCastle::Asn1::Asn1TaggedObjectParser::GetObjectParser(int32_t tag, bool isExplicit) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Asn1::Asn1TaggedObjectParser*>(), 1 })));
