...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BerTaggedObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BerTaggedObject(BerTaggedObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BerTaggedObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BerTaggedObject(BerTaggedObjectconst&) = delete;
