...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute*, "Org.BouncyCastle.Asn1.Smime", "SmimeCapabilitiesAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x354becc, size 0xd4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmimeCapabilitiesAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmimeCapabilitiesAttribute(SmimeCapabilitiesAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmimeCapabilitiesAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmimeCapabilitiesAttribute(SmimeCapabilitiesAttributeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute) == 0x20, "Size mismatch!");
