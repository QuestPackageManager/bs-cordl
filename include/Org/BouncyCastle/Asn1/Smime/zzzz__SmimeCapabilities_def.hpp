...
public:
  ...
  /// @brief Method DoGetCapabilitiesForOid, addr 0x1108b9c, size 0x640, virtual false, abstract: false, final false
  inline void DoGetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability, ::System::Collections::IList* list);

  /// @brief Method GetCapabilities, addr 0x1108b20, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetCapabilities(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetCapabilitiesForOid, addr 0x11091dc, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetInstance, addr 0x11088b8, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11093a0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1108af8, size 0x28, virtual false, abstract: false, final false
