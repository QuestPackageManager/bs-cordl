...
public:
  ...
  /// @brief Method DoGetCapabilitiesForOid, addr 0x24b48a0, size 0x640, virtual false, abstract: false, final false
  inline void DoGetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability, ::System::Collections::IList* list);

  /// @brief Method GetCapabilities, addr 0x24b482c, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetCapabilities(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetCapabilitiesForOid, addr 0x24b4ee0, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetInstance, addr 0x24b45d0, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24b5098, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24b4804, size 0x28, virtual false, abstract: false, final false
