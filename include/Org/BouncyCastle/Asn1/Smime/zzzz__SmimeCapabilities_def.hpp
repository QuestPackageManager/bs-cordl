...
public:
  ...
  /// @brief Method DoGetCapabilitiesForOid, addr 0x24f4f84, size 0x640, virtual false, abstract: false, final false
  inline void DoGetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability, ::System::Collections::IList* list);

  /// @brief Method GetCapabilities, addr 0x24f4f10, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetCapabilities(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetCapabilitiesForOid, addr 0x24f55c4, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetCapabilitiesForOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method GetInstance, addr 0x24f4cb4, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24f577c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f4ee8, size 0x28, virtual false, abstract: false, final false
