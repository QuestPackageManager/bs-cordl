...
public:
  ...
  /// @brief Method GetInstance, addr 0x24f1bd0, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24f274c, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f26ac, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capabilityID, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x24f2590, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CapabilityID, addr 0x24f273c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CapabilityID();

  /// @brief Method get_Parameters, addr 0x24f2744, size 0x8, virtual false, abstract: false, final false
