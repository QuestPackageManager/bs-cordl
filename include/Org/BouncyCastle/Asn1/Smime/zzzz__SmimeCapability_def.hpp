...
public:
  ...
  /// @brief Method GetInstance, addr 0x10e5b54, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10e670c, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e6668, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capabilityID, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x10e654c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CapabilityID, addr 0x10e66fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CapabilityID();

  /// @brief Method get_Parameters, addr 0x10e6704, size 0x8, virtual false, abstract: false, final false
