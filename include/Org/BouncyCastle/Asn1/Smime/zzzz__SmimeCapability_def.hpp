...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Smime::SmimeCapability*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Smime::SmimeCapability*, "Org.BouncyCastle.Asn1.Smime", "SmimeCapability");
...
public:
  ...
  __declspec(property(get = getStaticF_SmimeCapabilitiesVersions, put = setStaticF_SmimeCapabilitiesVersions)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* SmimeCapabilitiesVersions;
  ...
  /// @brief Method GetInstance, addr 0x354b5e0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x354c148, size 0x154, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier* const& __cordl_internal_get_capabilityID() const;
  ...
  /// @brief Method .ctor, addr 0x354c0c0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capabilityID, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x354bfa0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CapabilityID, addr 0x354c138, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CapabilityID();

  /// @brief Method get_Parameters, addr 0x354c140, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmimeCapability", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmimeCapability(SmimeCapability&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmimeCapability", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmimeCapability(SmimeCapabilityconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Smime::SmimeCapability) == 0x20, "Size mismatch!");
