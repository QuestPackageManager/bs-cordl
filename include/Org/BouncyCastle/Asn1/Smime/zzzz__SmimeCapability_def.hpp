...
public:
  ...
  /// @brief Method GetInstance, addr 0x344fa70, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34505d8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3450550, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capabilityID, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x3450430, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CapabilityID, addr 0x34505c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CapabilityID();

  /// @brief Method get_Parameters, addr 0x34505d0, size 0x8, virtual false, abstract: false, final false
