...
public:
  ...
  /// @brief Method AddCapability, addr 0x354a010, size 0x7c, virtual false, abstract: false, final false
  inline void AddCapability(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method AddCapability, addr 0x354a1c4, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCapability, addr 0x354a08c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1EncodableVector, addr 0x354a2cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x354a2d4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
