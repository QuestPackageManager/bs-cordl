...
public:
  ...
  /// @brief Method AddCapability, addr 0x10e6948, size 0x80, virtual false, abstract: false, final false
  inline void AddCapability(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method AddCapability, addr 0x10e6afc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCapability, addr 0x10e69c8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1EncodableVector, addr 0x10e6c04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e6c0c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
