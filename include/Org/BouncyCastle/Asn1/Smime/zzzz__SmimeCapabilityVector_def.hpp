...
public:
  ...
  /// @brief Method AddCapability, addr 0x348cdbc, size 0x7c, virtual false, abstract: false, final false
  inline void AddCapability(::Org::BouncyCastle::Asn1::DerObjectIdentifier* capability);

  /// @brief Method AddCapability, addr 0x348cf70, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCapability, addr 0x348ce38, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1EncodableVector, addr 0x348d078, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x348d080, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
