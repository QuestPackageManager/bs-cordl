...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Smime::SmimeEncryptionKeyPreferenceAttribute*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Smime::SmimeEncryptionKeyPreferenceAttribute*, "Org.BouncyCastle.Asn1.Smime", "SmimeEncryptionKeyPreferenceAttribute");
...
public:
  ...
  /// @brief Method .ctor, addr 0x354c6b8, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issAndSer);

  /// @brief Method .ctor, addr 0x354c788, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method .ctor, addr 0x354c858, size 0xd0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmimeEncryptionKeyPreferenceAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmimeEncryptionKeyPreferenceAttribute(SmimeEncryptionKeyPreferenceAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmimeEncryptionKeyPreferenceAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmimeEncryptionKeyPreferenceAttribute(SmimeEncryptionKeyPreferenceAttributeconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Smime::SmimeEncryptionKeyPreferenceAttribute) == 0x20, "Size mismatch!");
