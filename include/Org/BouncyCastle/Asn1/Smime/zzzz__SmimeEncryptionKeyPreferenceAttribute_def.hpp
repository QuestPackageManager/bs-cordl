...
public:
  ...
  /// @brief Method .ctor, addr 0x24f674c, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber* issAndSer);

  /// @brief Method .ctor, addr 0x24f682c, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier* rKeyID);

  /// @brief Method .ctor, addr 0x24f690c, size 0xe0, virtual false, abstract: false, final false
