...
public:
  ...
  /// @brief Method WriteObject, addr 0x26337b4, size 0x158, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x2631e94, size 0x4, virtual false, abstract: false, final false
