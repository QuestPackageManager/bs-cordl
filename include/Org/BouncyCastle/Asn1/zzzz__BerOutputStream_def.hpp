...
public:
  ...
  /// @brief Method WriteObject, addr 0x358f19c, size 0x16c, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x358d8b0, size 0x4, virtual false, abstract: false, final false
