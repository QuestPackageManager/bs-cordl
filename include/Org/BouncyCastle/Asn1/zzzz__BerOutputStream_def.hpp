...
public:
  ...
  /// @brief Method WriteObject, addr 0x2631078, size 0x158, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method .ctor, addr 0x262f758, size 0x4, virtual false, abstract: false, final false
