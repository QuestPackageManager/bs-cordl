...
public:
  ...
  /// @brief Method CallAsn1Equals, addr 0x3286da0, size 0xc, virtual false, abstract: false, final false
  inline bool CallAsn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method CallAsn1GetHashCode, addr 0x3286c7c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method FromByteArray, addr 0x328d7f8, size 0x228, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* FromByteArray(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method FromStream, addr 0x328da20, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x328db58, size 0x4, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method .ctor, addr 0x328db5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
