...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerSetGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerSetGenerator*, "Org.BouncyCastle.Asn1", "DerSetGenerator");
...
public:
  ...
  /// @brief Method AddObject, addr 0x36912f0, size 0x84, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x369137c, size 0x38, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x3691374, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36911f0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x3691260, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerSetGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerSetGenerator(DerSetGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerSetGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerSetGenerator(DerSetGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerSetGenerator) == 0x28, "Size mismatch!");
