...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x35ca060, size 0x7c, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x35ca0dc, size 0x8, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x35ca044, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c9f9c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35c9ff0, size 0x54, virtual false, abstract: false, final false
