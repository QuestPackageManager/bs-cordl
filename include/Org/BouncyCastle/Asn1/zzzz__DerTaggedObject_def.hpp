...
public:
  ...
  /// @brief Method .ctor, addr 0x11d7c98, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e06cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ebf00, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo);

  /// @brief Method Encode, addr 0x11ebf74, size 0xc8, virtual true, abstract: false, final false
