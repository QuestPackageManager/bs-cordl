...
public:
  // Declarations
  /// @brief Method Encode, addr 0x35cceb4, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c1b08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(bool explicitly, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method .ctor, addr 0x35cce3c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(int32_t tagNo);

  /// @brief Method .ctor, addr 0x35b90a4, size 0x14, virtual false, abstract: false, final false
