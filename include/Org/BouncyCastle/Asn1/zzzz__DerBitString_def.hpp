...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x3251f64, size 0xe0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x3251ef8, size 0x6c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Encode, addr 0x3251de4, size 0x114, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromAsn1Octets, addr 0x3251740, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBitString* FromAsn1Octets(::ArrayW<uint8_t, ::Array<uint8_t>*> octets);

  /// @brief Method GetBytes, addr 0x3251c34, size 0xa0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes();

  /// @brief Method GetInstance, addr 0x32515fc, size 0x144, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBitString* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x324f804, size 0x210, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBitString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x3251b84, size 0xb0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetString, addr 0x3252044, size 0x194, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3251a18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x32518c4, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t padBits);

  /// @brief Method .ctor, addr 0x3251a20, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(int32_t namedBits);

  /// @brief Method .ctor, addr 0x3251b58, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  static inline ::ArrayW<char16_t, ::Array<char16_t>*> getStaticF_table();

  /// @brief Method get_IntValue, addr 0x3251cdc, size 0x108, virtual true, abstract: false, final false
  inline int32_t get_IntValue();

  /// @brief Method get_PadBits, addr 0x3251cd4, size 0x8, virtual true, abstract: false, final false
