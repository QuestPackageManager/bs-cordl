...
public:
  ...
  /// @brief Method GetInstance, addr 0xe68790, size 0x20c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBitString* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0xe6a61c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6a8e4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6aa4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::Org::BouncyCastle::Asn1::DerBitString* New_ctor(int32_t namedBits);

  /// @brief Method .ctor, addr 0xe6aa54, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6ab7c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method GetOctets, addr 0xe6aba8, size 0xb0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetBytes, addr 0xe6ac58, size 0xa0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBytes();

  /// @brief Method get_PadBits, addr 0xe6acf8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_PadBits();

  /// @brief Method get_IntValue, addr 0xe6ad00, size 0x10c, virtual true, abstract: false, final false
  inline int32_t get_IntValue();

  /// @brief Method Encode, addr 0xe6ae0c, size 0x118, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Asn1GetHashCode, addr 0xe6af24, size 0x88, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Asn1Equals, addr 0xe6afac, size 0xd8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method GetString, addr 0xe6b084, size 0x168, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method FromAsn1Octets, addr 0xe6a75c, size 0x188, virtual false, abstract: false, final false
