...
public:
  ...
  /// @brief Method Encode, addr 0x369158c, size 0xb8, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetEnumerator, addr 0x3691544, size 0x24, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Asn1::LazyDerSequence* New_ctor(::ArrayW<uint8_t> encoded);

  /// @brief Method Parse, addr 0x36913b0, size 0x16c, virtual false, abstract: false, final false
  inline void Parse();
  ...
  /// @brief Method .ctor, addr 0x3691264, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> encoded);

  /// @brief Method get_Count, addr 0x3691568, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x369151c, size 0x28, virtual true, abstract: false, final false
