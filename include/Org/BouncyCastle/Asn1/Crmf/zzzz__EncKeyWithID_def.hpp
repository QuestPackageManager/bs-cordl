...
public:
  ...
  /// @brief Method GetInstance, addr 0x22d3218, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22d34e4, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d33c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo);

  /// @brief Method .ctor, addr 0x22d341c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d33f0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::DerUtf8String* str);

  /// @brief Method .ctor, addr 0x22d32bc, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HasIdentifier, addr 0x22d3450, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasIdentifier();

  /// @brief Method get_Identifier, addr 0x22d34dc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Identifier();

  /// @brief Method get_IsIdentifierUtf8String, addr 0x22d3460, size 0x7c, virtual true, abstract: false, final false
  inline bool get_IsIdentifierUtf8String();

  /// @brief Method get_PrivateKey, addr 0x22d3448, size 0x8, virtual true, abstract: false, final false
