...
public:
  ...
  /// @brief Method GetInstance, addr 0x326b14c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x326b3b8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326b300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo);

  /// @brief Method .ctor, addr 0x326b310, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326b308, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::DerUtf8String* str);

  /// @brief Method .ctor, addr 0x326b1ec, size 0x114, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HasIdentifier, addr 0x326b320, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasIdentifier();

  /// @brief Method get_Identifier, addr 0x326b3b0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Identifier();

  /// @brief Method get_IsIdentifierUtf8String, addr 0x326b330, size 0x80, virtual true, abstract: false, final false
  inline bool get_IsIdentifierUtf8String();

  /// @brief Method get_PrivateKey, addr 0x326b318, size 0x8, virtual true, abstract: false, final false
