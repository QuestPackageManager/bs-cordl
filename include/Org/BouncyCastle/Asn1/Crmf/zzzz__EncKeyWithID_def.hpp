...
public:
  ...
  /// @brief Method GetInstance, addr 0xeaf9c8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeafa6c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeafb78, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeafba0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeafbcc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PrivateKey, addr 0xeafbf8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* get_PrivateKey();

  /// @brief Method get_HasIdentifier, addr 0xeafc00, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasIdentifier();

  /// @brief Method get_IsIdentifierUtf8String, addr 0xeafc10, size 0x7c, virtual true, abstract: false, final false
  inline bool get_IsIdentifierUtf8String();

  /// @brief Method get_Identifier, addr 0xeafc8c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Identifier();

  /// @brief Method ToAsn1Object, addr 0xeafc94, size 0x148, virtual true, abstract: false, final false
