...
public:
  ...
  /// @brief Method GetInstance, addr 0xf1709c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf17368, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf1724c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo);

  /// @brief Method .ctor, addr 0xf172a0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf17274, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* privKeyInfo, ::Org::BouncyCastle::Asn1::DerUtf8String* str);

  /// @brief Method .ctor, addr 0xf17140, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HasIdentifier, addr 0xf172d4, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasIdentifier();

  /// @brief Method get_Identifier, addr 0xf17360, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Identifier();

  /// @brief Method get_IsIdentifierUtf8String, addr 0xf172e4, size 0x7c, virtual true, abstract: false, final false
  inline bool get_IsIdentifierUtf8String();

  /// @brief Method get_PrivateKey, addr 0xf172cc, size 0x8, virtual true, abstract: false, final false
