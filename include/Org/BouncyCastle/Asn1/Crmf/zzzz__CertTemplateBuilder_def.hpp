...
public:
  ...
  /// @brief Method AddOptional, addr 0x230fa34, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x230f8e0, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230fad0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
