...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::CertTemplateBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::CertTemplateBuilder*, "Org.BouncyCastle.Asn1.Crmf", "CertTemplateBuilder");
...
public:
  ...
  /// @brief Method AddOptional, addr 0x33644e0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x3364390, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3364588, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::CertTemplateBuilder) == 0x60, "Size mismatch!");
