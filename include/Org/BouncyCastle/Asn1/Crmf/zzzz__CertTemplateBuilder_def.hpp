...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertTemplateBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertTemplateBuilder(CertTemplateBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertTemplateBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertTemplateBuilder(CertTemplateBuilderconst&) = delete;
