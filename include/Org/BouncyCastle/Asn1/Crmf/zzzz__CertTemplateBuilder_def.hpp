...
public:
  ...
  /// @brief Method AddOptional, addr 0x22d2dc0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x22d2c6c, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d2e5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
