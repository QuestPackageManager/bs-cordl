...
public:
  ...
  /// @brief Method AddOptional, addr 0x32a728c, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Build, addr 0x32a713c, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a7334, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
