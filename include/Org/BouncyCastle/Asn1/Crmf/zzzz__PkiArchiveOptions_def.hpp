...
public:
  ...
  /// @brief Method GetInstance, addr 0x2318c20, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2319080, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2318f40, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(bool archiveRemGenPrivKey);

  /// @brief Method .ctor, addr 0x2318ef0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedKey* encKey);

  /// @brief Method .ctor, addr 0x2318f18, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyGenParameters);

  /// @brief Method .ctor, addr 0x2318d9c, size 0x154, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method get_Type, addr 0x2318fb8, size 0xc0, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x2319078, size 0x8, virtual true, abstract: false, final false
