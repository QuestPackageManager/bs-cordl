...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a7aa0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a7d00, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a7c2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* encryptedValue);

  /// @brief Method .ctor, addr 0x32a7c24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EnvelopedData* envelopedData);

  /// @brief Method get_IsEncryptedValue, addr 0x32a7cd4, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsEncryptedValue();

  /// @brief Method get_Value, addr 0x32a7ce4, size 0x1c, virtual true, abstract: false, final false
