...
public:
  ...
  /// @brief Method GetInstance, addr 0x10e4758, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10e4a18, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e4920, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* encryptedValue);

  /// @brief Method .ctor, addr 0x10e48f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EnvelopedData* envelopedData);

  /// @brief Method get_IsEncryptedValue, addr 0x10e49ec, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsEncryptedValue();

  /// @brief Method get_Value, addr 0x10e49fc, size 0x1c, virtual true, abstract: false, final false
