...
public:
  ...
  /// @brief Method GetInstance, addr 0xff1034, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xff12f4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff11fc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* encryptedValue);

  /// @brief Method .ctor, addr 0xff11d4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EnvelopedData* envelopedData);

  /// @brief Method get_IsEncryptedValue, addr 0xff12c8, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsEncryptedValue();

  /// @brief Method get_Value, addr 0xff12d8, size 0x1c, virtual true, abstract: false, final false
