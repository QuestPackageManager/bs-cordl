...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptedKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptedKey(EncryptedKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptedKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptedKey(EncryptedKeyconst&) = delete;
