...
public:
  ...
  /// @brief Method GetInstance, addr 0x2313d0c, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2313fbc, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2313ec4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* encryptedValue);

  /// @brief Method .ctor, addr 0x2313e9c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cms::EnvelopedData* envelopedData);

  /// @brief Method get_IsEncryptedValue, addr 0x2313f90, size 0x10, virtual true, abstract: false, final false
  inline bool get_IsEncryptedValue();

  /// @brief Method get_Value, addr 0x2313fa0, size 0x1c, virtual true, abstract: false, final false
