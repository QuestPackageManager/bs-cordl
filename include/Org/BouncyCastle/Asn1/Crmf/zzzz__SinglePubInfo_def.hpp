...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SinglePubInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SinglePubInfo(SinglePubInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SinglePubInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SinglePubInfo(SinglePubInfoconst&) = delete;
