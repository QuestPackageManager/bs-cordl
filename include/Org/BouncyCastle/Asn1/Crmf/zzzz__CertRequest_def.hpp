...
public:
  ...
  /// @brief Method GetInstance, addr 0x230e5a0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x230eebc, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230ee68, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230ede4, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230eb24, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertReqID, addr 0x230eea4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID();

  /// @brief Method get_CertTemplate, addr 0x230eeac, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* get_CertTemplate();

  /// @brief Method get_Controls, addr 0x230eeb4, size 0x8, virtual true, abstract: false, final false
