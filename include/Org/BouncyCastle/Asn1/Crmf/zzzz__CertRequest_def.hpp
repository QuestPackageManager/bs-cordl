...
/// @brief Method GetInstance, addr 0x3269788, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Crmf::CertRequest* GetInstance(::System::Object*  obj) ;

static inline ::Org::BouncyCastle::Asn1::Crmf::CertRequest* New_ctor(::Org::BouncyCastle::Asn1::DerInteger*  certReqId, ::Org::BouncyCastle::Asn1::Crmf::CertTemplate*  certTemplate, ::Org::BouncyCastle::Asn1::Crmf::Controls*  controls) ;

static inline ::Org::BouncyCastle::Asn1::Crmf::CertRequest* New_ctor(int32_t  certReqId, ::Org::BouncyCastle::Asn1::Crmf::CertTemplate*  certTemplate, ::Org::BouncyCastle::Asn1::Crmf::Controls*  controls) ;

static inline ::Org::BouncyCastle::Asn1::Crmf::CertRequest* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x326a06c, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x326a048, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3269fcc, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3269d1c, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_CertReqID, addr 0x326a054, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerInteger* get_CertReqID() ;

/// @brief Method get_CertTemplate, addr 0x326a05c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::CertTemplate* get_CertTemplate() ;

/// @brief Method get_Controls, addr 0x326a064, size 0x8, virtual true, abstract: false, final false
