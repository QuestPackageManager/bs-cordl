...
public:
  ...
  /// @brief Method .ctor, addr 0xeb050c, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0xeaf1c8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeb0818, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Time* notBefore, ::Org::BouncyCastle::Asn1::X509::Time* notAfter);

  /// @brief Method get_NotBefore, addr 0xeb0844, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_NotBefore();

  /// @brief Method get_NotAfter, addr 0xeb084c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_NotAfter();

  /// @brief Method ToAsn1Object, addr 0xeb0854, size 0xc0, virtual true, abstract: false, final false
