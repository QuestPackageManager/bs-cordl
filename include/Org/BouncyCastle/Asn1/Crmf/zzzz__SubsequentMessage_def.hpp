...
public:
  ...
  /// @brief Method ValueOf, addr 0x32a9568, size 0x118, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* ValueOf(int32_t value);

  /// @brief Method .ctor, addr 0x32aad84, size 0x4, virtual false, abstract: false, final false
