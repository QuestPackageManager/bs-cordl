...
public:
  ...
  /// @brief Method .ctor, addr 0xeb32e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(int32_t value);

  /// @brief Method ValueOf, addr 0xeb19c8, size 0x110, virtual false, abstract: false, final false
