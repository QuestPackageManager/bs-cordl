...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage*, "Org.BouncyCastle.Asn1.Crmf", "SubsequentMessage");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubsequentMessage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubsequentMessage(SubsequentMessage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubsequentMessage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubsequentMessage(SubsequentMessageconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage) == 0x20, "Size mismatch!");
