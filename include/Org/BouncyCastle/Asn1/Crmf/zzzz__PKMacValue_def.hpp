...
public:
  ...
  /// @brief Method GetInstance, addr 0x2315be0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2315a64, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2315ce0, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2315ca4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::Org::BouncyCastle::Asn1::DerBitString* macValue);

  /// @brief Method .ctor, addr 0x2315bf8, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PbmParameter* pbmParams, ::Org::BouncyCastle::Asn1::DerBitString* macValue);

  /// @brief Method .ctor, addr 0x23159b0, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgID, addr 0x2315cd0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgID();

  /// @brief Method get_MacValue, addr 0x2315cd8, size 0x8, virtual true, abstract: false, final false
