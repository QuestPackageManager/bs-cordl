...
public:
  ...
  /// @brief Method GetInstance, addr 0x23120b4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23165f0, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2316510, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2316580, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey* Poposk);

  /// @brief Method .ctor, addr 0x23163c4, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x23165b0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey* privkey);

  /// @brief Method get_Object, addr 0x23165e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Object();

  /// @brief Method get_Type, addr 0x23165e0, size 0x8, virtual true, abstract: false, final false
