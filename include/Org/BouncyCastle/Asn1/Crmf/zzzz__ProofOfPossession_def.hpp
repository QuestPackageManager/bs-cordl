...
public:
  ...
  /// @brief Method GetInstance, addr 0x3365448, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33697f8, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3369764, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x33697cc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::PopoSigningKey* Poposk);

  /// @brief Method .ctor, addr 0x3369624, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x33697dc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t type, ::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey* privkey);

  /// @brief Method get_Object, addr 0x33697f0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Object();

  /// @brief Method get_Type, addr 0x33697e8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ProofOfPossession", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ProofOfPossession(ProofOfPossession&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ProofOfPossession", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ProofOfPossession(ProofOfPossessionconst&) = delete;
