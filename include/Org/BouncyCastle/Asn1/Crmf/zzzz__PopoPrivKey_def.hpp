...
public:
  ...
  /// @brief Method GetInstance, addr 0xff2d30, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xff2df0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff2db0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0xff2aa4, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0xff2de0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0xff2de8, size 0x8, virtual true, abstract: false, final false
