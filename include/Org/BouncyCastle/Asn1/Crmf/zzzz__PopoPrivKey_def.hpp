...
public:
  ...
  /// @brief Method GetInstance, addr 0x2311f20, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2311fdc, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2311f9c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0x2311c94, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0x2311fcc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x2311fd4, size 0x8, virtual true, abstract: false, final false
