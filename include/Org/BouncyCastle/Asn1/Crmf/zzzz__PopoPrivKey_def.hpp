...
public:
  ...
  /// @brief Method GetInstance, addr 0x33668d4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3366984, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3366964, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0x3366630, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0x3366974, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x336697c, size 0x8, virtual true, abstract: false, final false
