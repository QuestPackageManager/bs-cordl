...
public:
  ...
  /// @brief Method GetInstance, addr 0x3368c5c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3368d0c, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3368cec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0x33689b8, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0x3368cfc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x3368d04, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PopoPrivKey", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PopoPrivKey(PopoPrivKey&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PopoPrivKey", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PopoPrivKey(PopoPrivKeyconst&) = delete;
