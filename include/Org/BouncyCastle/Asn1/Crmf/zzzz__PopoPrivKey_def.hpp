...
public:
  ...
  /// @brief Method GetInstance, addr 0x2316058, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2316114, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23160d4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0x2315dcc, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0x2316104, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0x231610c, size 0x8, virtual true, abstract: false, final false
