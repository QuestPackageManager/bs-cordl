...
public:
  ...
  /// @brief Method GetInstance, addr 0xf191ac, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf1926c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf1922c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* msg);

  /// @brief Method .ctor, addr 0xf18f20, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj);

  /// @brief Method get_Type, addr 0xf1925c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Type();

  /// @brief Method get_Value, addr 0xf19264, size 0x8, virtual true, abstract: false, final false
