...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PopoSigningKeyInput", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PopoSigningKeyInput(PopoSigningKeyInput&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PopoSigningKeyInput", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PopoSigningKeyInput(PopoSigningKeyInputconst&) = delete;
