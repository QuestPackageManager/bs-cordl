...
public:
  ...
  /// @brief Method GetInstance, addr 0x23106bc, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::CertId* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x2310540, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23106e4, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23104d8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x23106d4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Issuer();

  /// @brief Method get_SerialNumber, addr 0x23106dc, size 0x8, virtual true, abstract: false, final false
