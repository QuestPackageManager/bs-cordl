...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::CertId*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::CertId*, "Org.BouncyCastle.Asn1.Crmf", "CertId");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3362a34, size 0x14, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::CertId* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x33628b0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3362a58, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3362850, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x3362a48, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Issuer();

  /// @brief Method get_SerialNumber, addr 0x3362a50, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::CertId) == 0x20, "Size mismatch!");
