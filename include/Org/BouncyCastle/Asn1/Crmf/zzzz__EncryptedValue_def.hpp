...
public:
  ...
  /// @brief Method .ctor, addr 0xeb0128, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0xeaffcc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeb0320, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IntendedAlg, addr 0xeb03c4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_IntendedAlg();

  /// @brief Method get_SymmAlg, addr 0xeb03cc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SymmAlg();

  /// @brief Method get_EncSymmKey, addr 0xeb03d4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncSymmKey();

  /// @brief Method get_KeyAlg, addr 0xeb03dc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyAlg();

  /// @brief Method get_ValueHint, addr 0xeb03e4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_ValueHint();

  /// @brief Method get_EncValue, addr 0xeb03ec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncValue();

  /// @brief Method ToAsn1Object, addr 0xeb03f4, size 0x118, virtual true, abstract: false, final false
