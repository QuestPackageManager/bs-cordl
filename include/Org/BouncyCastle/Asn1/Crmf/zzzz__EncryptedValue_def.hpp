...
public:
  ...
  /// @brief Method GetInstance, addr 0x3367210, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3367618, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3367588, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3367360, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncSymmKey, addr 0x33675f8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncSymmKey();

  /// @brief Method get_EncValue, addr 0x3367610, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncValue();

  /// @brief Method get_IntendedAlg, addr 0x33675e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_IntendedAlg();

  /// @brief Method get_KeyAlg, addr 0x3367600, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyAlg();

  /// @brief Method get_SymmAlg, addr 0x33675f0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SymmAlg();

  /// @brief Method get_ValueHint, addr 0x3367608, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptedValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptedValue(EncryptedValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptedValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptedValue(EncryptedValueconst&) = delete;
