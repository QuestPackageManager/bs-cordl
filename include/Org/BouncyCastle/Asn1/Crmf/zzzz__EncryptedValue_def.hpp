...
public:
  ...
  /// @brief Method GetInstance, addr 0x10eb1b8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10eb5e0, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10eb50c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10eb314, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncSymmKey, addr 0x10eb5c0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncSymmKey();

  /// @brief Method get_EncValue, addr 0x10eb5d8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncValue();

  /// @brief Method get_IntendedAlg, addr 0x10eb5b0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_IntendedAlg();

  /// @brief Method get_KeyAlg, addr 0x10eb5c8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyAlg();

  /// @brief Method get_SymmAlg, addr 0x10eb5b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SymmAlg();

  /// @brief Method get_ValueHint, addr 0x10eb5d0, size 0x8, virtual true, abstract: false, final false
