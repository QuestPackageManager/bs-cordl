...
public:
  ...
  /// @brief Method .ctor addr 0xe110c4 size 0x1f8 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance addr 0xe10f68 size 0xa4 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe112bc size 0xa4 virtual false final false
  ...
  /// @brief Method get_IntendedAlg addr 0xe11360 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_IntendedAlg();

  /// @brief Method get_SymmAlg addr 0xe11368 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SymmAlg();

  /// @brief Method get_EncSymmKey addr 0xe11370 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncSymmKey();

  /// @brief Method get_KeyAlg addr 0xe11378 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_KeyAlg();

  /// @brief Method get_ValueHint addr 0xe11380 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_ValueHint();

  /// @brief Method get_EncValue addr 0xe11388 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_EncValue();

  /// @brief Method ToAsn1Object addr 0xe11390 size 0x118 virtual true final false
