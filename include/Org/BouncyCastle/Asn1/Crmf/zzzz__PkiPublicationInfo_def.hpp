...
public:
  ...
  /// @brief Method GetInstance, addr 0x32a8af0, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Crmf::PkiPublicationInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetPubInfos, addr 0x32a8c7c, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32a8f00, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a8a90, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Action, addr 0x32a8c74, size 0x8, virtual true, abstract: false, final false
