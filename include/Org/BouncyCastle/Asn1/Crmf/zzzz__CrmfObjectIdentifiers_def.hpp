...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Crmf::CrmfObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Crmf::CrmfObjectIdentifiers*, "Org.BouncyCastle.Asn1.Crmf", "CrmfObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3366cb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrmfObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrmfObjectIdentifiers(CrmfObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrmfObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrmfObjectIdentifiers(CrmfObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Crmf::CrmfObjectIdentifiers) == 0x10, "Size mismatch!");
