...
public:
  ...
  /// @brief Method GetInstance, addr 0x3366f00, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3366d7c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3366f38, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3366f14, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33669f0, size 0x208, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmIdentifier, addr 0x3366f28, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmIdentifier();

  /// @brief Method get_PoposkInput, addr 0x3366f20, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput* get_PoposkInput();

  /// @brief Method get_Signature, addr 0x3366f30, size 0x8, virtual true, abstract: false, final false
