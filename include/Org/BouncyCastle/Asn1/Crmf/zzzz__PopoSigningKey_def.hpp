...
public:
  ...
  /// @brief Method GetInstance, addr 0x3242ed4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3242d50, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3242f0c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3242ee8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32429c4, size 0x208, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmIdentifier, addr 0x3242efc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmIdentifier();

  /// @brief Method get_PoposkInput, addr 0x3242ef4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Crmf::PopoSigningKeyInput* get_PoposkInput();

  /// @brief Method get_Signature, addr 0x3242f04, size 0x8, virtual true, abstract: false, final false
