...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0xff6038, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xff5e78, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* g);

  /// @brief Method .ctor, addr 0xff5f18, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0xff601c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_P, addr 0xff6000, size 0x1c, virtual false, abstract: false, final false
