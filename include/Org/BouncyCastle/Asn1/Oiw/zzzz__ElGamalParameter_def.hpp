...
public:
  ...
  /// @brief Method .ctor, addr 0xfafea8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfaff48, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_P, addr 0xfb0030, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_G, addr 0xfb004c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method ToAsn1Object, addr 0xfb0068, size 0xf0, virtual true, abstract: false, final false
