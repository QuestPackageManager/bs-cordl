...
public:
  ...
  /// @brief Method GetInstance, addr 0xfb91dc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xfb91f4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb961c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb9298, size 0x384, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Modulus, addr 0xfb9684, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus();

  /// @brief Method get_PublicExponent, addr 0xfb968c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PublicExponent();

  /// @brief Method get_PrivateExponent, addr 0xfb9694, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrivateExponent();

  /// @brief Method get_Prime1, addr 0xfb969c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime1();

  /// @brief Method get_Prime2, addr 0xfb96a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime2();

  /// @brief Method get_Exponent1, addr 0xfb96ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent1();

  /// @brief Method get_Exponent2, addr 0xfb96b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent2();

  /// @brief Method get_Coefficient, addr 0xfb96bc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Coefficient();

  /// @brief Method ToAsn1Object, addr 0xfb96c4, size 0x318, virtual true, abstract: false, final false
