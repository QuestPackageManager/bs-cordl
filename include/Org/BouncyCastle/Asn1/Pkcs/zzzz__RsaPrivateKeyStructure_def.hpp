...
public:
  ...
  /// @brief Method GetInstance, addr 0x33a8e4c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x33a8e60, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33a92d8, size 0x31c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a9280, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a8f00, size 0x380, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Coefficient, addr 0x33a92d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Coefficient();

  /// @brief Method get_Exponent1, addr 0x33a92c0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent1();

  /// @brief Method get_Exponent2, addr 0x33a92c8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent2();

  /// @brief Method get_Modulus, addr 0x33a9298, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus();

  /// @brief Method get_Prime1, addr 0x33a92b0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime1();

  /// @brief Method get_Prime2, addr 0x33a92b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime2();

  /// @brief Method get_PrivateExponent, addr 0x33a92a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PrivateExponent();

  /// @brief Method get_PublicExponent, addr 0x33a92a0, size 0x8, virtual false, abstract: false, final false
