...
public:
  ...
  /// @brief Method GetInstance, addr 0x240eb24, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x240eb3c, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetVersionValue, addr 0x240eef8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ParsePrivateKey, addr 0x240f1a0, size 0x28, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePrivateKey();

  /// @brief Method ParsePublicKey, addr 0x240f1c8, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePublicKey();

  /// @brief Method ToAsn1Object, addr 0x240f1fc, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240f018, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240f168, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240f024, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable* privateKey, ::Org::BouncyCastle::Asn1::Asn1Set* attributes,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> publicKey);

  /// @brief Method .ctor, addr 0x240ebe0, size 0x318, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Attributes, addr 0x240f178, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Attributes();

  /// @brief Method get_HasPublicKey, addr 0x240f180, size 0x10, virtual true, abstract: false, final false
  inline bool get_HasPublicKey();

  /// @brief Method get_PrivateKeyAlgorithm, addr 0x240f190, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_PrivateKeyAlgorithm();

  /// @brief Method get_PrivateKeyData, addr 0x240f198, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_PrivateKeyData();

  /// @brief Method get_PublicKeyData, addr 0x240f1f4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_PublicKeyData();

  /// @brief Method get_Version, addr 0x240f170, size 0x8, virtual true, abstract: false, final false
