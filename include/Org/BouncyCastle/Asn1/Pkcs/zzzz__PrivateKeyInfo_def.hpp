...
public:
  ...
  /// @brief Method GetInstance addr 0xf16b0c size 0x18 virtual false final false
  ...
  /// @brief Method GetInstance addr 0xf16b24 size 0xa4 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetVersionValue addr 0xf16eec size 0x124 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf17010 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0xf1716c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf1701c size 0x150 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable* privateKey, ::Org::BouncyCastle::Asn1::Asn1Set* attributes,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> publicKey);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor addr 0xf16bc8 size 0x324 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Version addr 0xf17174 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Version();

  /// @brief Method get_Attributes addr 0xf1717c size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Attributes();

  /// @brief Method get_HasPublicKey addr 0xf17184 size 0x10 virtual true final false
  inline bool get_HasPublicKey();

  /// @brief Method get_PrivateKeyAlgorithm addr 0xf17194 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_PrivateKeyAlgorithm();

  /// @brief Method get_PrivateKeyData addr 0xf1719c size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_PrivateKeyData();

  /// @brief Method ParsePrivateKey addr 0xf171a4 size 0x28 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePrivateKey();

  /// @brief Method ParsePublicKey addr 0xf171cc size 0x2c virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePublicKey();

  /// @brief Method get_PublicKeyData addr 0xf171f8 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_PublicKeyData();

  /// @brief Method ToAsn1Object addr 0xf17200 size 0x184 virtual true final false
