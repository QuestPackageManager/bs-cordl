...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f4aa4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f4f98, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4dd4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4b48, size 0x28c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptionScheme, addr 0x10f4f90, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptionScheme* get_EncryptionScheme();

  /// @brief Method get_KeyDerivationFunc, addr 0x10f4f88, size 0x8, virtual false, abstract: false, final false
