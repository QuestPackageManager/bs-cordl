...
public:
  ...
  /// @brief Method GetInstance, addr 0x240b964, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x240be40, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240bc88, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240ba08, size 0x280, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptionScheme, addr 0x240be38, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::EncryptionScheme* get_EncryptionScheme();

  /// @brief Method get_KeyDerivationFunc, addr 0x240be30, size 0x8, virtual false, abstract: false, final false
