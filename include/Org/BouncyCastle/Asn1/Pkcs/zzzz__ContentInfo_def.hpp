...
public:
  ...
  /// @brief Method GetInstance, addr 0xfb0aa8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb1c68, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb1db4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* contentType, ::Org::BouncyCastle::Asn1::Asn1Encodable* content);

  /// @brief Method get_ContentType, addr 0xfb1de0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_Content, addr 0xfb1de8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Content();

  /// @brief Method ToAsn1Object, addr 0xfb1df0, size 0x140, virtual true, abstract: false, final false
