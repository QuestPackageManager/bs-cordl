...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::CertBag*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::CertBag*, "Org.BouncyCastle.Asn1.Pkcs", "CertBag");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x345dd98, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345df94, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345df7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* certID, ::Org::BouncyCastle::Asn1::Asn1Object* certValue);

  /// @brief Method .ctor, addr 0x345de38, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CertID, addr 0x345df84, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CertID();

  /// @brief Method get_CertValue, addr 0x345df8c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::CertBag) == 0x20, "Size mismatch!");
