...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertBag", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertBag(CertBag&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertBag", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertBag(CertBagconst&) = delete;
