...
public:
  ...
  /// @brief Method .ctor, addr 0xfb3d40, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfb3d44, size 0x2c, virtual false, abstract: false, final false
