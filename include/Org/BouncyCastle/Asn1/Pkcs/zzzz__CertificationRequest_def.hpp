...
public:
  ...
  /// @brief Method GetCertificationRequestInfo, addr 0x240848c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::CertificationRequestInfo* GetCertificationRequestInfo();

  /// @brief Method GetInstance, addr 0x2408190, size 0xd0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::CertificationRequest* GetInstance(::System::Object* obj);

  /// @brief Method GetSignatureOctets, addr 0x24084a4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24084c4, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24083a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x24083ac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2408260, size 0x144, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Signature, addr 0x240849c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_Signature();

  /// @brief Method get_SignatureAlgorithm, addr 0x2408494, size 0x8, virtual false, abstract: false, final false
