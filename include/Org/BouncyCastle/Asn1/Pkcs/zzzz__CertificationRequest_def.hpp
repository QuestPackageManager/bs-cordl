...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificationRequest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificationRequest(CertificationRequest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificationRequest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificationRequest(CertificationRequestconst&) = delete;
