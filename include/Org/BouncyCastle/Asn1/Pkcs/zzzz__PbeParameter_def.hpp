...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::PbeParameter*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::PbeParameter*, "Org.BouncyCastle.Asn1.Pkcs", "PbeParameter");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3461364, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::PbeParameter* GetInstance(::System::Object* obj);

  /// @brief Method GetSalt, addr 0x3461664, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3461698, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34615c4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x34614e8, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_IterationCount, addr 0x3461680, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::PbeParameter) == 0x20, "Size mismatch!");
