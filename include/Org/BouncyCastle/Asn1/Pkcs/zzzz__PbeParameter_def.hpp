...
public:
  ...
  /// @brief Method GetInstance, addr 0x23ce8a0, size 0x194, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::PbeParameter* GetInstance(::System::Object* obj);

  /// @brief Method GetSalt, addr 0x23cebc8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23cec04, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ceb18, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x23cea34, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_IterationCount, addr 0x23cebe8, size 0x1c, virtual false, abstract: false, final false
