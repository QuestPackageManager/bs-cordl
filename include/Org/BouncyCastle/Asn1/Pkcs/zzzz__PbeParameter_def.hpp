...
public:
  ...
  /// @brief Method GetInstance, addr 0x333d338, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::PbeParameter* GetInstance(::System::Object* obj);

  /// @brief Method GetSalt, addr 0x333d638, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x333d66c, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x333d598, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x333d4bc, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_IterationCount, addr 0x333d654, size 0x18, virtual false, abstract: false, final false
