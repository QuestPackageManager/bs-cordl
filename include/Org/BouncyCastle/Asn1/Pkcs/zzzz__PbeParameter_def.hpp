...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PbeParameter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PbeParameter(PbeParameter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PbeParameter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PbeParameter(PbeParameterconst&) = delete;
