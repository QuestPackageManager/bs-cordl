...
public:
  ...
  /// @brief Method GetInstance, addr 0x336c0ac, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336c46c, size 0x288, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336c3dc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x336c448, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336c230, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x336c454, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x336c45c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_PSourceAlgorithm, addr 0x336c464, size 0x8, virtual false, abstract: false, final false
