...
public:
  ...
  /// @brief Method GetInstance, addr 0xffe9b4, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xffedb8, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffecf0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xffed64, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffeb3c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0xffeda0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0xffeda8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_PSourceAlgorithm, addr 0xffedb0, size 0x8, virtual false, abstract: false, final false
