...
public:
  ...
  /// @brief Method GetInstance, addr 0x101f0b8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x101f4bc, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x101f3f4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x101f468, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x101f240, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x101f4a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x101f4ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_PSourceAlgorithm, addr 0x101f4b4, size 0x8, virtual false, abstract: false, final false
