...
public:
  ...
  /// @brief Method GetInstance, addr 0x11ec360, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11ec764, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ec69c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11ec710, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ec4e8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x11ec74c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x11ec754, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_PSourceAlgorithm, addr 0x11ec75c, size 0x8, virtual false, abstract: false, final false
