...
public:
  ...
  /// @brief Method GetEncryptedData, addr 0x3462424, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncryptedData();

  /// @brief Method GetInstance, addr 0x3462298, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3462440, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3462228, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t> encoding);

  /// @brief Method .ctor, addr 0x3462150, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptionAlgorithm, addr 0x346241c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EncryptedPrivateKeyInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EncryptedPrivateKeyInfo(EncryptedPrivateKeyInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EncryptedPrivateKeyInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EncryptedPrivateKeyInfo(EncryptedPrivateKeyInfoconst&) = delete;
