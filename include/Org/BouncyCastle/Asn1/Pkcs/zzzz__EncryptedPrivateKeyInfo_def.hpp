...
public:
  ...
  /// @brief Method GetEncryptedData, addr 0x346009c, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetEncryptedData();

  /// @brief Method GetInstance, addr 0x345ff10, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34600b8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345fea0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t> encoding);

  /// @brief Method .ctor, addr 0x345fdc8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_EncryptionAlgorithm, addr 0x3460094, size 0x8, virtual false, abstract: false, final false
