...
public:
  ...
  /// @brief Method GetInstance, addr 0x11e3e00, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11e40c0, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e4084, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* attrType, ::Org::BouncyCastle::Asn1::Asn1Set* attrValues);

  /// @brief Method .ctor, addr 0x11e3f54, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AttrType, addr 0x11e40b0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AttrType();

  /// @brief Method get_AttrValues, addr 0x11e40b8, size 0x8, virtual false, abstract: false, final false
