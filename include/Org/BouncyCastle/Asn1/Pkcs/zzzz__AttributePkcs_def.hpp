...
public:
  ...
  /// @brief Method GetInstance addr 0xf0f3d0 size 0x154 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf0f524 size 0x130 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf0f654 size 0x2c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* attrType, ::Org::BouncyCastle::Asn1::Asn1Set* attrValues);

  /// @brief Method get_AttrType addr 0xf0f680 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AttrType();

  /// @brief Method get_AttrValues addr 0xf0f688 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AttrValues();

  /// @brief Method ToAsn1Object addr 0xf0f690 size 0xf0 virtual true final false
