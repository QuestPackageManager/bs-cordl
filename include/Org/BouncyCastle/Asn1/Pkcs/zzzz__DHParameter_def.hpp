...
public:
  ...
  /// @brief Method .ctor addr 0xf870a0 size 0xd0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf87170 size 0x3c0 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_P addr 0xf87530 size 0x1c virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_P();

  /// @brief Method get_G addr 0xf8754c size 0x1c virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_L addr 0xf87568 size 0x14 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_L();

  /// @brief Method ToAsn1Object addr 0xf8757c size 0x174 virtual true final false
