...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x240d718, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240d24c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Math::BigInteger* g, int32_t l);

  /// @brief Method .ctor, addr 0x240d30c, size 0x3c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0x240d6e8, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G();

  /// @brief Method get_L, addr 0x240d704, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_L();

  /// @brief Method get_P, addr 0x240d6cc, size 0x1c, virtual false, abstract: false, final false
