...
/// @brief Method GetIV, addr 0x33a6738, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetIV() ;

/// @brief Method GetInstance, addr 0x33a659c, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x33a6754, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33a6420, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterations) ;

/// @brief Method .ctor, addr 0x33a64c0, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Iterations, addr 0x33a6720, size 0x18, virtual false, abstract: false, final false
