...
public:
  ...
  /// @brief Method GetIV, addr 0x2410880, size 0x20, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x24106e8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24108a0, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2410554, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterations);

  /// @brief Method .ctor, addr 0x2410604, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Iterations, addr 0x2410864, size 0x1c, virtual false, abstract: false, final false
