...
public:
  ...
  /// @brief Method GetIV, addr 0xffbd20, size 0x20, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0xffbb7c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xffbd40, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffb9e0, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterations);

  /// @brief Method .ctor, addr 0xffba94, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Iterations, addr 0xffbd04, size 0x1c, virtual false, abstract: false, final false
