...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params*, "Org.BouncyCastle.Asn1.Pkcs", "Pbkdf2Params");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3461aa4, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* GetInstance(::System::Object* obj);

  /// @brief Method GetSalt, addr 0x34621d4, size 0x1c, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* New_ctor(::ArrayW<uint8_t> salt, int32_t iterationCount, int32_t keyLength);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* New_ctor(::ArrayW<uint8_t> salt, int32_t iterationCount, int32_t keyLength, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* prf);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* New_ctor(::ArrayW<uint8_t> salt, int32_t iterationCount, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* prf);

  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ToAsn1Object, addr 0x3462304, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3462060, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x3462100, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> salt, int32_t iterationCount, int32_t keyLength);

  /// @brief Method .ctor, addr 0x346218c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34621b0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> salt, int32_t iterationCount, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* prf);

  /// @brief Method .ctor, addr 0x3461d28, size 0x338, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  static inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* getStaticF_algid_hmacWithSHA1();

  /// @brief Method get_IsDefaultPrf, addr 0x346221c, size 0x80, virtual false, abstract: false, final false
  inline bool get_IsDefaultPrf();

  /// @brief Method get_IterationCount, addr 0x34621f0, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_IterationCount();

  /// @brief Method get_KeyLength, addr 0x3462208, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_KeyLength();

  /// @brief Method get_Prf, addr 0x346229c, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params) == 0x30, "Size mismatch!");
