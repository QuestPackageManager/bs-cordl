...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Pbkdf2Params", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Pbkdf2Params(Pbkdf2Params&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Pbkdf2Params", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Pbkdf2Params(Pbkdf2Paramsconst&) = delete;
