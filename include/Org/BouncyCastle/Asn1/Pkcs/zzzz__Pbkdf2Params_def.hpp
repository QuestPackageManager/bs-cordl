...
public:
  ...
  /// @brief Method GetInstance addr 0xf89d18 size 0x188 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf89fa0 size 0x330 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8a2d0 size 0xb4 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8a384 size 0x90 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8a414 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8a438 size 0x24 virtual false final false
  ...
  /// @brief Method GetSalt addr 0xf8a45c size 0x20 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSalt();

  /// @brief Method get_IterationCount addr 0xf8a47c size 0x1c virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_IterationCount();

  /// @brief Method get_KeyLength addr 0xf8a498 size 0x14 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_KeyLength();

  /// @brief Method get_IsDefaultPrf addr 0xf8a4ac size 0x7c virtual false final false
  inline bool get_IsDefaultPrf();

  /// @brief Method get_Prf addr 0xf8a528 size 0x64 virtual false final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Prf();

  /// @brief Method ToAsn1Object addr 0xf8a58c size 0x190 virtual true final false
