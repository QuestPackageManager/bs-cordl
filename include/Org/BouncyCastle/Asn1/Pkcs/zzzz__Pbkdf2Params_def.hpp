...
public:
  ...
  /// @brief Method GetInstance, addr 0x240fdec, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* GetInstance(::System::Object* obj);

  /// @brief Method GetSalt, addr 0x241050c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x241063c, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241038c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount);

  /// @brief Method .ctor, addr 0x241043c, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> salt, int32_t iterationCount, int32_t keyLength);

  /// @brief Method .ctor, addr 0x24104c4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24104e8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2410064, size 0x328, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  static inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* getStaticF_algid_hmacWithSHA1();

  /// @brief Method get_IsDefaultPrf, addr 0x241055c, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsDefaultPrf();

  /// @brief Method get_IterationCount, addr 0x241052c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_IterationCount();

  /// @brief Method get_KeyLength, addr 0x2410548, size 0x14, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_KeyLength();

  /// @brief Method get_Prf, addr 0x24105d8, size 0x64, virtual false, abstract: false, final false
