...
/// @brief Field Pkcs9AtExtendedCertificateAttributes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_Pkcs9AtExtendedCertificateAttributes, put=setStaticF_Pkcs9AtExtendedCertificateAttributes)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  Pkcs9AtExtendedCertificateAttributes;
...
/// @brief Method .ctor, addr 0x336b200, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
