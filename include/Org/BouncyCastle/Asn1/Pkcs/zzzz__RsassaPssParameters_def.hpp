...
public:
  ...
  /// @brief Method GetInstance, addr 0x2414378, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24147a8, size 0x280, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24146d4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2414748, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24144f4, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x2414788, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x2414790, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_SaltLength, addr 0x2414798, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_SaltLength();

  /// @brief Method get_TrailerField, addr 0x24147a0, size 0x8, virtual false, abstract: false, final false
