...
public:
  ...
  /// @brief Method GetInstance, addr 0x10200b0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10204f0, size 0x278, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x102041c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1020490, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1020238, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x10204d0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x10204d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_SaltLength, addr 0x10204e0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_SaltLength();

  /// @brief Method get_TrailerField, addr 0x10204e8, size 0x8, virtual false, abstract: false, final false
