...
public:
  ...
  /// @brief Method GetInstance, addr 0x336d060, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336d45c, size 0x320, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336d3c4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x336d430, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336d1e4, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_HashAlgorithm, addr 0x336d43c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_MaskGenAlgorithm, addr 0x336d444, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm();

  /// @brief Method get_SaltLength, addr 0x336d44c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_SaltLength();

  /// @brief Method get_TrailerField, addr 0x336d454, size 0x8, virtual false, abstract: false, final false
