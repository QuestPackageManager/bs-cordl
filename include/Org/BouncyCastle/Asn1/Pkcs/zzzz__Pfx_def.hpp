...
public:
  ...
  /// @brief Method GetInstance, addr 0x24101e0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24103b8, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241037c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* contentInfo, ::Org::BouncyCastle::Asn1::Pkcs::MacData* macData);

  /// @brief Method .ctor, addr 0x2410284, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AuthSafe, addr 0x24103a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_AuthSafe();

  /// @brief Method get_MacData, addr 0x24103b0, size 0x8, virtual false, abstract: false, final false
