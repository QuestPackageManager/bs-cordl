...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f27d8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f2e44, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f2b40, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f2960, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Content, addr 0x10f2d7c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Content();

  /// @brief Method get_ContentType, addr 0x10f2cc4, size 0x90, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptionAlgorithm, addr 0x10f2d54, size 0x28, virtual false, abstract: false, final false
