...
public:
  ...
  /// @brief Method GetInstance, addr 0x24115c0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2411c14, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2411914, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x241173c, size 0x1d8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Content, addr 0x2411b4c, size 0xc8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Content();

  /// @brief Method get_ContentType, addr 0x2411a94, size 0x90, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptionAlgorithm, addr 0x2411b24, size 0x28, virtual false, abstract: false, final false
