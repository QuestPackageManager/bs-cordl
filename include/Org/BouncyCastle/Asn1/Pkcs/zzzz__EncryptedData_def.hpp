...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Pkcs::EncryptedData*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Pkcs::EncryptedData*, "Org.BouncyCastle.Asn1.Pkcs", "EncryptedData");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x34619c4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x346202c, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3461d28, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3461b48, size 0x1e0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Content, addr 0x3461f60, size 0xcc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Content();

  /// @brief Method get_ContentType, addr 0x3461ea4, size 0x94, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType();

  /// @brief Method get_EncryptionAlgorithm, addr 0x3461f38, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Pkcs::EncryptedData) == 0x18, "Size mismatch!");
