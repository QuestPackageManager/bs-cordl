...
public:
  ...
  /// @brief Method GetIV, addr 0x33416d0, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x33412d8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x334174c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33415b4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x334161c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(int32_t parameterVersion, ::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x3341438, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_RC2ParameterVersion, addr 0x33416bc, size 0x14, virtual false, abstract: false, final false
