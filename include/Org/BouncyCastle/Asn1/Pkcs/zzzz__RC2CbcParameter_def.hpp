...
public:
  ...
  /// @brief Method GetIV, addr 0x24175e0, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x24171e4, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2417658, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24174a8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x241751c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(int32_t parameterVersion, ::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x241733c, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_RC2ParameterVersion, addr 0x24175cc, size 0x14, virtual false, abstract: false, final false
