...
public:
  ...
  /// @brief Method GetInstance, addr 0x11edbc8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11edebc, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ede38, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method .ctor, addr 0x11ede68, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11edc6c, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_BagAttributes, addr 0x11edeb4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_BagAttributes();

  /// @brief Method get_BagID, addr 0x11edea4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_BagID();

  /// @brief Method get_BagValue, addr 0x11edeac, size 0x8, virtual false, abstract: false, final false
