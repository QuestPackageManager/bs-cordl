...
public:
  ...
  /// @brief Method GetInstance, addr 0x33a9eb4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33aa16c, size 0x1ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33aa13c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method .ctor, addr 0x33aa148, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33a9f54, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_BagAttributes, addr 0x33aa164, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_BagAttributes();

  /// @brief Method get_BagID, addr 0x33aa154, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_BagID();

  /// @brief Method get_BagValue, addr 0x33aa15c, size 0x8, virtual false, abstract: false, final false
