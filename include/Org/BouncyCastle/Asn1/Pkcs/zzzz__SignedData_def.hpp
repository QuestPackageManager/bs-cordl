...
public:
  ...
  /// @brief Method GetInstance, addr 0x346756c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3467c30, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3467bf0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346760c, size 0x5e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Certificates, addr 0x3467c18, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_ContentInfo, addr 0x3467c10, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_ContentInfo();

  /// @brief Method get_Crls, addr 0x3467c20, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Crls();

  /// @brief Method get_DigestAlgorithms, addr 0x3467c08, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_SignerInfos, addr 0x3467c28, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method get_Version, addr 0x3467c00, size 0x8, virtual false, abstract: false, final false
