...
public:
  ...
  /// @brief Method GetInstance, addr 0xfba6e4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfbad74, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfba788, size 0x5ec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Version, addr 0xfbadc8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Version();

  /// @brief Method get_DigestAlgorithms, addr 0xfbadd0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_DigestAlgorithms();

  /// @brief Method get_ContentInfo, addr 0xfbadd8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Pkcs::ContentInfo* get_ContentInfo();

  /// @brief Method get_Certificates, addr 0xfbade0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Certificates();

  /// @brief Method get_Crls, addr 0xfbade8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Crls();

  /// @brief Method get_SignerInfos, addr 0xfbadf0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Set* get_SignerInfos();

  /// @brief Method ToAsn1Object, addr 0xfbadf8, size 0x194, virtual true, abstract: false, final false
