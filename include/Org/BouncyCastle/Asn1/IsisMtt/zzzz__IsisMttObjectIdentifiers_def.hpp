...
/// @brief Field IdIsisMttATAdditionalInformation, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_IdIsisMttATAdditionalInformation, put=setStaticF_IdIsisMttATAdditionalInformation)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATAdditionalInformation;
...
/// @brief Field IdIsisMttATDeclarationOfMajority, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_IdIsisMttATDeclarationOfMajority, put=setStaticF_IdIsisMttATDeclarationOfMajority)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATDeclarationOfMajority;
...
/// @brief Field IdIsisMttATLiabilityLimitationFlag, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_IdIsisMttATLiabilityLimitationFlag, put=setStaticF_IdIsisMttATLiabilityLimitationFlag)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATLiabilityLimitationFlag;
...
/// @brief Field IdIsisMttATRequestedCertificate, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_IdIsisMttATRequestedCertificate, put=setStaticF_IdIsisMttATRequestedCertificate)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATRequestedCertificate;
...
/// @brief Method .ctor, addr 0x335a350, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
