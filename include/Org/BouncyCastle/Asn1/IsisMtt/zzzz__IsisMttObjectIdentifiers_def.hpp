...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IsisMttObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IsisMttObjectIdentifiers(IsisMttObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IsisMttObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IsisMttObjectIdentifiers(IsisMttObjectIdentifiersconst&) = delete;
