...
public:
  ...
  /// @brief Method GetCertificateBytes, addr 0x344e950, size 0x100, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetCertificateBytes();

  /// @brief Method GetInstance, addr 0x344e81c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x344e524, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x344ea50, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344e70c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* certificate);

  /// @brief Method .ctor, addr 0x344e714, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x344e890, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IsisMtt::Ocsp::RequestedCertificate_Choice type, ::ArrayW<uint8_t> certificateOctets);

  /// @brief Method get_Type, addr 0x344e930, size 0x20, virtual false, abstract: false, final false
