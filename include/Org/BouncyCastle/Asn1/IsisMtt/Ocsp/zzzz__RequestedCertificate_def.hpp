...
public:
  ...
  /// @brief Method GetCertificateBytes, addr 0x33916fc, size 0x100, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertificateBytes();

  /// @brief Method GetInstance, addr 0x33915c8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x33912d0, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33917fc, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33914b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* certificate);

  /// @brief Method .ctor, addr 0x33914c0, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x339163c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x33916dc, size 0x20, virtual false, abstract: false, final false
