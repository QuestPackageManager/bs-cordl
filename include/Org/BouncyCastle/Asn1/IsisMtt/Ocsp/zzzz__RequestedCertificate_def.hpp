...
public:
  ...
  /// @brief Method GetCertificateBytes, addr 0x11d4db8, size 0x104, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertificateBytes();

  /// @brief Method GetInstance, addr 0x11d4c80, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x11d4938, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11d4ebc, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d4b2c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* certificate);

  /// @brief Method .ctor, addr 0x11d4b54, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagged);

  /// @brief Method .ctor, addr 0x11d4cec, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Type, addr 0x11d4d98, size 0x20, virtual false, abstract: false, final false
