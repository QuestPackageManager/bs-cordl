...
public:
  ...
  /// @brief Method GetInstance, addr 0x23fc78c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23fc97c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23fc8d8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x23fc900, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x23fc974, size 0x8, virtual true, abstract: false, final false
