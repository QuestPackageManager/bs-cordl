...
public:
  ...
  /// @brief Method GetInstance, addr 0x3450ec4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345108c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3451010, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x3451018, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x3451084, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AdditionalInformationSyntax", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AdditionalInformationSyntax(AdditionalInformationSyntax&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AdditionalInformationSyntax", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AdditionalInformationSyntax(AdditionalInformationSyntaxconst&) = delete;
