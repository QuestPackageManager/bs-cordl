...
public:
  ...
  /// @brief Method GetInstance, addr 0x3355354, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x335551c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33554a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x33554a8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x3355514, size 0x8, virtual true, abstract: false, final false
