...
public:
  ...
  /// @brief Method GetInstance, addr 0x10e189c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10e1aa0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10e19f4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x10e1a1c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x10e1a98, size 0x8, virtual true, abstract: false, final false
