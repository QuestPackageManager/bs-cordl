...
public:
  ...
  /// @brief Method GetInstance, addr 0xfa1644, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa179c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa17c4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0xfa1840, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Information();

  /// @brief Method ToAsn1Object, addr 0xfa1848, size 0x20, virtual true, abstract: false, final false
