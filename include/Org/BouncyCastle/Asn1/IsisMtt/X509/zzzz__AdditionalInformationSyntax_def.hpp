...
public:
  ...
  /// @brief Method GetInstance, addr 0x23c7110, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23c7300, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c725c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* information);

  /// @brief Method .ctor, addr 0x23c7284, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW information);

  /// @brief Method get_Information, addr 0x23c72f8, size 0x8, virtual true, abstract: false, final false
