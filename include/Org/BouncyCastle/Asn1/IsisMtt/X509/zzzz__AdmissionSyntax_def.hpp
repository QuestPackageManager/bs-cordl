...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax*, "Org.BouncyCastle.Asn1.IsisMtt.X509", "AdmissionSyntax");
...
public:
  ...
  /// @brief Method GetContentsOfAdmissions, addr 0x34523dc, size 0x114, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::IsisMtt::X509::Admissions*> GetContentsOfAdmissions();

  /// @brief Method GetInstance, addr 0x3451ff8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34522b8, size 0x11c, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::Asn1Sequence* const& __cordl_internal_get_contentsOfAdmissions() const;
  ...
  /// @brief Method .ctor, addr 0x34522b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345217c, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AdmissionAuthority, addr 0x34523d4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AdmissionSyntax", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AdmissionSyntax(AdmissionSyntax&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AdmissionSyntax", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AdmissionSyntax(AdmissionSyntaxconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::X509::AdmissionSyntax) == 0x20, "Size mismatch!");
