...
public:
  ...
  /// @brief Method GetInstance, addr 0x332f350, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x332f518, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x332f49c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* restriction);

  /// @brief Method .ctor, addr 0x332f4a4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW restriction);

  /// @brief Method get_RestrictionString, addr 0x332f510, size 0x8, virtual true, abstract: false, final false
