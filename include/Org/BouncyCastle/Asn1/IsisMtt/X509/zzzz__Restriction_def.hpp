...
public:
  ...
  /// @brief Method GetInstance, addr 0x23ffcf4, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23ffee4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ffe40, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* restriction);

  /// @brief Method .ctor, addr 0x23ffe68, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW restriction);

  /// @brief Method get_RestrictionString, addr 0x23ffedc, size 0x8, virtual true, abstract: false, final false
