...
public:
  ...
  /// @brief Method GetInstance, addr 0x23fd5b8, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23fd7a8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23fd704, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* restriction);

  /// @brief Method .ctor, addr 0x23fd72c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::StringW restriction);

  /// @brief Method get_RestrictionString, addr 0x23fd7a0, size 0x8, virtual true, abstract: false, final false
