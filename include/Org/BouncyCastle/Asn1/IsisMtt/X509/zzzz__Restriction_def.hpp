...
public:
  ...
  /// @brief Method GetInstance, addr 0x11e0200, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11e0404, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e0358, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* restriction);

  /// @brief Method .ctor, addr 0x11e0380, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW restriction);

  /// @brief Method get_RestrictionString, addr 0x11e03fc, size 0x8, virtual true, abstract: false, final false
