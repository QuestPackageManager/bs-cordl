...
public:
  ...
  /// @brief Method GetInstance, addr 0xfa4454, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa45dc, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa48d8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfa4914, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Country, addr 0xfa4950, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_Country();

  /// @brief Method get_TypeOfSubstitution, addr 0xfa4958, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_TypeOfSubstitution();

  /// @brief Method get_ThirdPerson, addr 0xfa4960, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_ThirdPerson();

  /// @brief Method get_CertRef, addr 0xfa4968, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::IssuerSerial* get_CertRef();

  /// @brief Method ToAsn1Object, addr 0xfa4970, size 0x174, virtual true, abstract: false, final false
