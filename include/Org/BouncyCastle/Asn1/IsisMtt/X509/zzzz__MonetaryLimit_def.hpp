...
public:
  ...
  /// @brief Method GetInstance, addr 0x3452aec, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3452e8c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3452d70, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor(::StringW currency, int32_t amount, int32_t exponent);

  /// @brief Method .ctor, addr 0x3452c50, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Amount, addr 0x3452e5c, size 0x18, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Amount();

  /// @brief Method get_Currency, addr 0x3452e40, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW get_Currency();

  /// @brief Method get_Exponent, addr 0x3452e74, size 0x18, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonetaryLimit", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonetaryLimit(MonetaryLimit&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonetaryLimit", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonetaryLimit(MonetaryLimitconst&) = delete;
