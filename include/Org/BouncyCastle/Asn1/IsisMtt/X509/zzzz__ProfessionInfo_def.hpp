...
public:
  ...
  /// @brief Method GetInstance, addr 0x23fb314, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::IsisMtt::X509::ProfessionInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetProfessionItems, addr 0x23fe338, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method GetProfessionOids, addr 0x23fe44c, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23fe168, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23fe0ac, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority* namingAuthority,
                    ::ArrayW<::Org::BouncyCastle::Asn1::X500::DirectoryString*, ::Array<::Org::BouncyCastle::Asn1::X500::DirectoryString*>*> professionItems,
                    ::ArrayW<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, ::Array<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>*> professionOids, ::StringW registrationNumber,
                    ::Org::BouncyCastle::Asn1::Asn1OctetString* addProfessionInfo);

  /// @brief Method .ctor, addr 0x23fd7fc, size 0x8b0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AddProfessionInfo, addr 0x23fe328, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_AddProfessionInfo();

  /// @brief Method get_NamingAuthority, addr 0x23fe330, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority* get_NamingAuthority();

  /// @brief Method get_RegistrationNumber, addr 0x23fe5b4, size 0x8, virtual true, abstract: false, final false
