...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority*, "Org.BouncyCastle.Asn1.IsisMtt.X509", "NamingAuthority");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x34518fc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3452fa8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3453804, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34537f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345312c, size 0x5c8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_NamingAuthorityID, addr 0x34537e0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_NamingAuthorityID();

  /// @brief Method get_NamingAuthorityText, addr 0x34537e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_NamingAuthorityText();

  /// @brief Method get_NamingAuthorityUrl, addr 0x34537f0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NamingAuthority", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NamingAuthority(NamingAuthority&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NamingAuthority", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NamingAuthority(NamingAuthorityconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IsisMtt::X509::NamingAuthority) == 0x28, "Size mismatch!");
