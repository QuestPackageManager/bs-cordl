...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::OidTokenizer*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::OidTokenizer*, "Org.BouncyCastle.Asn1", "OidTokenizer");
...
public:
  ...
  /// @brief Method NextToken, addr 0x36918f0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36918d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method get_HasMoreTokens, addr 0x36918e0, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::OidTokenizer) == 0x20, "Size mismatch!");
