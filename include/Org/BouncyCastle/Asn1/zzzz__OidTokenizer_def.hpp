...
/// @brief Method NextToken, addr 0x35d5438, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35d5420, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method get_HasMoreTokens, addr 0x35d5428, size 0x10, virtual false, abstract: false, final false
