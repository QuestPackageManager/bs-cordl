...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OidTokenizer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OidTokenizer(OidTokenizer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OidTokenizer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OidTokenizer(OidTokenizerconst&) = delete;
