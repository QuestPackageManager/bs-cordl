...
public:
  ...
  /// @brief Method NextToken, addr 0x2641ea4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2641e6c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method get_HasMoreTokens, addr 0x2641e94, size 0x10, virtual false, abstract: false, final false
