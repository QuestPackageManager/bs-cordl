...
public:
  ...
  /// @brief Method NextToken, addr 0x125c064, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x125c02c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method get_HasMoreTokens, addr 0x125c054, size 0x10, virtual false, abstract: false, final false
