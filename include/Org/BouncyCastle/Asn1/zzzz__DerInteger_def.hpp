...
public:
  ...
  /// @brief Method AllowUnsafe addr 0xe13958 size 0xb0 virtual false final false
  static inline bool AllowUnsafe();

  /// @brief Method GetInstance addr 0xe0d410 size 0xf0 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerInteger* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance addr 0xe10040 size 0x124 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe0c364 size 0x8c virtual false final false
  inline void _ctor(int32_t value);

  static inline ::Org::BouncyCastle::Asn1::DerInteger* New_ctor(int64_t value);

  /// @brief Method .ctor addr 0xe13a10 size 0x8c virtual false final false
  inline void _ctor(int64_t value);

  static inline ::Org::BouncyCastle::Asn1::DerInteger* New_ctor(::Org::BouncyCastle::Math::BigInteger* value);

  /// @brief Method .ctor addr 0xe13a9c size 0x88 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe13a08 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe13b24 size 0x104 virtual false final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, bool clone);

  /// @brief Method get_PositiveValue addr 0xe13d08 size 0x6c virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_PositiveValue();

  /// @brief Method get_Value addr 0xe13d74 size 0x68 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Value();

  /// @brief Method HasValue addr 0xe13ddc size 0x74 virtual false final false
  inline bool HasValue(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method get_IntPositiveValueExact addr 0xe13f24 size 0x9c virtual false final false
  inline int32_t get_IntPositiveValueExact();

  /// @brief Method get_IntValueExact addr 0xe10220 size 0x80 virtual false final false
  inline int32_t get_IntValueExact();

  /// @brief Method get_LongValueExact addr 0xe13fc0 size 0x80 virtual false final false
  inline int64_t get_LongValueExact();

  /// @brief Method Encode addr 0xe14118 size 0x28 virtual true final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Asn1GetHashCode addr 0xe14140 size 0x5c virtual true final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Asn1Equals addr 0xe1419c size 0xc8 virtual true final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method ToString addr 0xe14264 size 0x20 virtual true final false
  inline ::StringW ToString();

  /// @brief Method IntValue addr 0xe13e50 size 0xd4 virtual false final false
  static inline int32_t IntValue(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t start, int32_t signExt);

  /// @brief Method LongValue addr 0xe14040 size 0xd8 virtual false final false
  static inline int64_t LongValue(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t start, int32_t signExt);

  /// @brief Method IsMalformed addr 0xe13c28 size 0x7c virtual false final false
  static inline bool IsMalformed(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method SignBytesToSkip addr 0xe13ca4 size 0x64 virtual false final false
