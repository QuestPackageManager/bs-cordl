...
public:
  ...
  /// @brief Method Add, addr 0x26225c4, size 0xf0, virtual false, abstract: false, final false
  inline void Add(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method Add, addr 0x2629864, size 0x6c, virtual false, abstract: false, final false
  inline void Add(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> objs);

  /// @brief Method AddAll, addr 0x262acf0, size 0x16c, virtual false, abstract: false, final false
  inline void AddAll(::Org::BouncyCastle::Asn1::Asn1EncodableVector* other);

  /// @brief Method AddOptional, addr 0x262ac7c, size 0x6c, virtual false, abstract: false, final false
  inline void AddOptional(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> objs);

  /// @brief Method AddOptionalTagged, addr 0x26224f4, size 0x8c, virtual false, abstract: false, final false
  inline void AddOptionalTagged(bool isExplicit, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method CloneElements, addr 0x262b0e4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyElements, addr 0x262af68, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> CopyElements();

  /// @brief Method FromEnumerable, addr 0x262a744, size 0x364, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* FromEnumerable(::System::Collections::IEnumerable* e);

  /// @brief Method GetEnumerator, addr 0x262af4c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method Reallocate, addr 0x262abb0, size 0xcc, virtual false, abstract: false, final false
  inline void Reallocate(int32_t minCapacity);

  /// @brief Method TakeElements, addr 0x262b014, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26281cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262aaa8, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method .ctor, addr 0x26224c8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Count, addr 0x262af44, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x262ae5c, size 0xe8, virtual false, abstract: false, final false
