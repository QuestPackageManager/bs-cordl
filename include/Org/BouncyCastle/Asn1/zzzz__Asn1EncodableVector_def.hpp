...
public:
  ...
  /// @brief Method FromEnumerable, addr 0x11e012c, size 0x35c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ddb64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* New_ctor(int32_t initialCapacity);

  /// @brief Method .ctor, addr 0x11e0488, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d7bd8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> v);

  /// @brief Method Add, addr 0x11d7cdc, size 0xf4, virtual false, abstract: false, final false
  inline void Add(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method Add, addr 0x11df248, size 0x6c, virtual false, abstract: false, final false
  inline void Add(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> objs);

  /// @brief Method AddOptional, addr 0x11e0660, size 0x6c, virtual false, abstract: false, final false
  inline void AddOptional(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> objs);

  /// @brief Method AddOptionalTagged, addr 0x11d7c04, size 0x94, virtual false, abstract: false, final false
  inline void AddOptionalTagged(bool isExplicit, int32_t tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method AddAll, addr 0x11e06d4, size 0x16c, virtual false, abstract: false, final false
  inline void AddAll(::Org::BouncyCastle::Asn1::Asn1EncodableVector* other);

  /// @brief Method get_Item, addr 0x11e0840, size 0xf0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Item(int32_t index);

  /// @brief Method get_Count, addr 0x11e0930, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method GetEnumerator, addr 0x11e0938, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method CopyElements, addr 0x11e0954, size 0xac, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> CopyElements();

  /// @brief Method TakeElements, addr 0x11e0a00, size 0xd0, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> TakeElements();

  /// @brief Method Reallocate, addr 0x11e0594, size 0xcc, virtual false, abstract: false, final false
  inline void Reallocate(int32_t minCapacity);

  /// @brief Method CloneElements, addr 0x11e0ad0, size 0xb4, virtual false, abstract: false, final false
