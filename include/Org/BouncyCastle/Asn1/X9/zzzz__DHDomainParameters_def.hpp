...
public:
  ...
  /// @brief Method GetInstance, addr 0x141a078, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x141a090, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::DHDomainParameters* GetInstance(::System::Object* obj);

  /// @brief Method GetNext, addr 0x141a4f4, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x141a7f4, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141a404, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141a218, size 0x1ec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0x141a7d4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_G();

  /// @brief Method get_J, addr 0x141a7e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_J();

  /// @brief Method get_P, addr 0x141a7cc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_P();

  /// @brief Method get_Q, addr 0x141a7dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Q();

  /// @brief Method get_ValidationParms, addr 0x141a7ec, size 0x8, virtual false, abstract: false, final false
