...
public:
  ...
  /// @brief Method GetInstance, addr 0x25eae5c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x25eae74, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::DHDomainParameters* GetInstance(::System::Object* obj);

  /// @brief Method GetNext, addr 0x25eb2bc, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x25eb5b0, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25eb1d8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25eaff0, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_G, addr 0x25eb590, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_G();

  /// @brief Method get_J, addr 0x25eb5a0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_J();

  /// @brief Method get_P, addr 0x25eb588, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_P();

  /// @brief Method get_Q, addr 0x25eb598, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Q();

  /// @brief Method get_ValidationParms, addr 0x25eb5a8, size 0x8, virtual false, abstract: false, final false
