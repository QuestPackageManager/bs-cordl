...
public:
  ...
  /// @brief Method GetInstance, addr 0x357b358, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x357b36c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x357b548, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x357b4e8, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* y);

  /// @brief Method get_Y, addr 0x357b540, size 0x8, virtual false, abstract: false, final false
