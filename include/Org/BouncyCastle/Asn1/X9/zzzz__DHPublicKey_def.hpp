...
public:
  ...
  /// @brief Method GetInstance, addr 0x261ea64, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x261ea7c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x261ec74, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x261ebf8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* y);

  /// @brief Method get_Y, addr 0x261ec6c, size 0x8, virtual false, abstract: false, final false
