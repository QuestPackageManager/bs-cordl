...
public:
  ...
  /// @brief Method GetInstance, addr 0x141a9c0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x141a9d8, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x141abe0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141ab60, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* y);

  /// @brief Method get_Y, addr 0x141abd8, size 0x8, virtual false, abstract: false, final false
