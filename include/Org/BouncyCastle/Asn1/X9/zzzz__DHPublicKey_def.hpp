...
public:
  ...
  /// @brief Method GetInstance, addr 0x262147c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2621494, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x262168c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2621610, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerInteger* y);

  /// @brief Method get_Y, addr 0x2621684, size 0x8, virtual false, abstract: false, final false
