...
public:
  ...
  /// @brief Method GetInstance, addr 0x35bdd40, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35be114, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bdfcc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9ECParameters* ecParameters);

  /// @brief Method .ctor, addr 0x35bdffc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* namedCurve);

  /// @brief Method .ctor, addr 0x35be004, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Null* obj);

  /// @brief Method .ctor, addr 0x35bdfc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method get_IsImplicitlyCA, addr 0x35be08c, size 0x80, virtual false, abstract: false, final false
  inline bool get_IsImplicitlyCA();

  /// @brief Method get_IsNamedCurve, addr 0x35be00c, size 0x80, virtual false, abstract: false, final false
  inline bool get_IsNamedCurve();

  /// @brief Method get_Parameters, addr 0x35be10c, size 0x8, virtual false, abstract: false, final false
