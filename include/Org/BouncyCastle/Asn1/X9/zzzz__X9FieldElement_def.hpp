...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X9::X9FieldElement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X9::X9FieldElement*, "Org.BouncyCastle.Asn1.X9", "X9FieldElement");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x367d6ac, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x367c194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECFieldElement* f);

  /// @brief Method .ctor, addr 0x367d5b4, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3, ::Org::BouncyCastle::Asn1::Asn1OctetString* s);

  /// @brief Method .ctor, addr 0x367d4e0, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Asn1::Asn1OctetString* s);

  /// @brief Method get_Value, addr 0x367d6a4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X9::X9FieldElement) == 0x18, "Size mismatch!");
