...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x35c0458, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bef40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECFieldElement* f);

  /// @brief Method .ctor, addr 0x35c0360, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3, ::Org::BouncyCastle::Asn1::Asn1OctetString* s);

  /// @brief Method .ctor, addr 0x35c028c, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* p, ::Org::BouncyCastle::Asn1::Asn1OctetString* s);

  /// @brief Method get_Value, addr 0x35c0450, size 0x8, virtual false, abstract: false, final false
