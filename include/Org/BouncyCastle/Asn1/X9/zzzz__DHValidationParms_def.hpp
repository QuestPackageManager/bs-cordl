...
public:
  ...
  /// @brief Method GetInstance, addr 0x3674d38, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x36747bc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3674f40, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3674eb0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* seed, ::Org::BouncyCastle::Asn1::DerInteger* pgenCounter);

  /// @brief Method .ctor, addr 0x3674d4c, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PgenCounter, addr 0x3674f38, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_PgenCounter();

  /// @brief Method get_Seed, addr 0x3674f30, size 0x8, virtual false, abstract: false, final false
