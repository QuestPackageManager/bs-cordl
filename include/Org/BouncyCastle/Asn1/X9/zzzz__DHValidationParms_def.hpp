...
public:
  ...
  /// @brief Method GetInstance, addr 0x35b7ae4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35b7568, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35b7cec, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b7c5c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* seed, ::Org::BouncyCastle::Asn1::DerInteger* pgenCounter);

  /// @brief Method .ctor, addr 0x35b7af8, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PgenCounter, addr 0x35b7ce4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_PgenCounter();

  /// @brief Method get_Seed, addr 0x35b7cdc, size 0x8, virtual false, abstract: false, final false
