...
public:
  ...
  /// @brief Method .ctor, addr 0xef3d90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0xef3abc, size 0xb8, virtual false, abstract: false, final false
