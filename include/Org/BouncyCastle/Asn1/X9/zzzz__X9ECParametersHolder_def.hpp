...
public:
  ...
  /// @brief Method .ctor, addr 0x22f1f38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0x22f1c68, size 0xb8, virtual false, abstract: false, final false
