...
public:
  ...
  /// @brief Method .ctor, addr 0x22f62a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0x22f5fd8, size 0xb8, virtual false, abstract: false, final false
