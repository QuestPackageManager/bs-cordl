...
/// @brief Method .ctor, addr 0x3286d9c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Parameters, addr 0x3286ad4, size 0xb4, virtual false, abstract: false, final false
