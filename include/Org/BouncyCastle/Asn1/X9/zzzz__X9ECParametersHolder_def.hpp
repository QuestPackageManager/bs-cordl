...
public:
  ...
  /// @brief Method .ctor, addr 0x3249a6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0x32497a4, size 0xb4, virtual false, abstract: false, final false
