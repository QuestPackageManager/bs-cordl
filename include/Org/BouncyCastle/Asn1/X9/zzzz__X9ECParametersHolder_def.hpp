...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X9::X9ECParametersHolder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X9::X9ECParametersHolder*, "Org.BouncyCastle.Asn1.X9", "X9ECParametersHolder");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3343254, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0x3342f8c, size 0xb4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X9::X9ECParametersHolder) == 0x18, "Size mismatch!");
