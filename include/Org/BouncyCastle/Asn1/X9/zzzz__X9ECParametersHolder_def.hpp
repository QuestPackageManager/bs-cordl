...
public:
  ...
  /// @brief Method .ctor, addr 0x321f228, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Parameters, addr 0x321ef60, size 0xb4, virtual false, abstract: false, final false
