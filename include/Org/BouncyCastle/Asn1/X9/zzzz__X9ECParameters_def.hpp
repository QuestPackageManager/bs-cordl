...
public:
  ...
  /// @brief Method GetInstance, addr 0x262474c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetInstance(::System::Object* obj);

  /// @brief Method GetSeed, addr 0x26255a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2625620, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26217bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26200f8, size 0x350, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Asn1::X9::X9ECPoint* g, ::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* h,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x262502c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26250d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2625038, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECPoint* g, ::Org::BouncyCastle::Math::BigInteger* n, ::Org::BouncyCastle::Math::BigInteger* h,
                    ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x2624b78, size 0x3d4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_BaseEntry, addr 0x2625618, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::X9ECPoint* get_BaseEntry();

  /// @brief Method get_Curve, addr 0x2625574, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve();

  /// @brief Method get_CurveEntry, addr 0x26255ac, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::X9Curve* get_CurveEntry();

  /// @brief Method get_FieldIDEntry, addr 0x2625610, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::X9FieldID* get_FieldIDEntry();

  /// @brief Method get_G, addr 0x262557c, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_G();

  /// @brief Method get_H, addr 0x262559c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_H();

  /// @brief Method get_N, addr 0x2625594, size 0x8, virtual false, abstract: false, final false
