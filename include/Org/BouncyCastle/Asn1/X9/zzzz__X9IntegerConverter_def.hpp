...
public:
  // Declarations
  /// @brief Method GetByteLength, addr 0x35c0850, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetByteLength, addr 0x35c0508, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method IntegerToBytes, addr 0x35c053c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c0884, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
