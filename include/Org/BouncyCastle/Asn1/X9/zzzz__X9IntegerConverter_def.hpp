...
public:
  // Declarations
  /// @brief Method GetByteLength, addr 0x141b658, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetByteLength, addr 0x141b324, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method IntegerToBytes, addr 0x141b358, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141b68c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
