...
public:
  // Declarations
  /// @brief Method GetByteLength, addr 0x1424950, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetByteLength, addr 0x142461c, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method IntegerToBytes, addr 0x1424650, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1424984, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
