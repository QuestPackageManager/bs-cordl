...
public:
  // Declarations
  /// @brief Method GetByteLength, addr 0x122243c, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetByteLength, addr 0x1222108, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method IntegerToBytes, addr 0x122213c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1222470, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
