...
public:
  // Declarations
  /// @brief Method GetByteLength, addr 0x1247b40, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetByteLength, addr 0x124780c, size 0x34, virtual false, abstract: false, final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method IntegerToBytes, addr 0x1247840, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1247b74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
