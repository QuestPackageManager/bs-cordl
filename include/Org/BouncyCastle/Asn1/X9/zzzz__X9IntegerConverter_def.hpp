...
public:
  // Declarations
  /// @brief Method GetByteLength addr 0x1141060 size 0x34 virtual false final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement* fe);

  /// @brief Method GetByteLength addr 0x1141394 size 0x34 virtual false final false
  static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IntegerToBytes addr 0x1141094 size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x11413c8 size 0x8 virtual false final false
  inline void _ctor();
