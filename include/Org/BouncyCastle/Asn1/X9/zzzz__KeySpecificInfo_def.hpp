...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x26224ec, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26221f8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithm, ::Org::BouncyCastle::Asn1::Asn1OctetString* counter);

  /// @brief Method .ctor, addr 0x2622224, size 0x2b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Algorithm, addr 0x26224dc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm();

  /// @brief Method get_Counter, addr 0x26224e4, size 0x8, virtual false, abstract: false, final false
