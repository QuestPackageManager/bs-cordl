...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x3551bb4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35518d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithm, ::Org::BouncyCastle::Asn1::Asn1OctetString* counter);

  /// @brief Method .ctor, addr 0x35518dc, size 0x2c8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Algorithm, addr 0x3551ba4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm();

  /// @brief Method get_Counter, addr 0x3551bac, size 0x8, virtual false, abstract: false, final false
