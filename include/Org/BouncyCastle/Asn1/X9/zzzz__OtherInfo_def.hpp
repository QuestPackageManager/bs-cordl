...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x141cf54, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141cb40, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141cb7c, size 0x3a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyInfo, addr 0x141cf3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::KeySpecificInfo* get_KeyInfo();

  /// @brief Method get_PartyAInfo, addr 0x141cf44, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_PartyAInfo();

  /// @brief Method get_SuppPubInfo, addr 0x141cf4c, size 0x8, virtual false, abstract: false, final false
