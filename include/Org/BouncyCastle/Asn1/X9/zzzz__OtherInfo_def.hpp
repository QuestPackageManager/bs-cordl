...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x35b8e7c, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b8a80, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b8a8c, size 0x3c0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyInfo, addr 0x35b8e64, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::KeySpecificInfo* get_KeyInfo();

  /// @brief Method get_PartyAInfo, addr 0x35b8e6c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_PartyAInfo();

  /// @brief Method get_SuppPubInfo, addr 0x35b8e74, size 0x8, virtual false, abstract: false, final false
