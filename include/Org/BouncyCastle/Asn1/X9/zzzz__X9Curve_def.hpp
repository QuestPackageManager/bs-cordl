...
public:
  ...
  /// @brief Method GetSeed, addr 0x262c324, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x262c380, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262b7c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method .ctor, addr 0x262b7d0, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x262b95c, size 0x710, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262b94c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9FieldID* fieldID, ::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Curve, addr 0x262c31c, size 0x8, virtual false, abstract: false, final false
