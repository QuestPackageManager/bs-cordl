...
public:
  ...
  /// @brief Method GetSeed, addr 0x3582744, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35827a4, size 0x200, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3581b88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method .ctor, addr 0x3581b90, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x3581d30, size 0x714, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3581d20, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9FieldID* fieldID, ::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Curve, addr 0x358273c, size 0x8, virtual false, abstract: false, final false
