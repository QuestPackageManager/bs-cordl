...
public:
  ...
  /// @brief Method GetSeed, addr 0x26285ec, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2628648, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2627a90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method .ctor, addr 0x2627a98, size 0x17c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::ArrayW<uint8_t, ::Array<uint8_t>*> seed);

  /// @brief Method .ctor, addr 0x2627c24, size 0x710, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2627c14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9FieldID* fieldID, ::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Curve, addr 0x26285e4, size 0x8, virtual false, abstract: false, final false
