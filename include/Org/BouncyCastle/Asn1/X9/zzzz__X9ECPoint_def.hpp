...
public:
  ...
  /// @brief Method GetPointEncoding, addr 0x141afd0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x141b094, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14140b0, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* c, ::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method .ctor, addr 0x141a634, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* c, ::Org::BouncyCastle::Asn1::Asn1OctetString* s);

  /// @brief Method .ctor, addr 0x141a72c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x141af14, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint* p, bool compressed);

  /// @brief Method get_IsPointCompressed, addr 0x141b048, size 0x4c, virtual false, abstract: false, final false
  inline bool get_IsPointCompressed();

  /// @brief Method get_Point, addr 0x1414168, size 0x70, virtual false, abstract: false, final false
