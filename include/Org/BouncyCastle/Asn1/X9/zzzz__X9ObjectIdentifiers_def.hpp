...
/// @brief Field DHSinglePassCofactorDHSha1KdfScheme, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_DHSinglePassCofactorDHSha1KdfScheme, put=setStaticF_DHSinglePassCofactorDHSha1KdfScheme)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  DHSinglePassCofactorDHSha1KdfScheme;
...
/// @brief Method .ctor, addr 0x3584f38, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
