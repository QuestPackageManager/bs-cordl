...
public:
  ...
  static __declspec(property(get = getStaticF_DHSinglePassCofactorDHSha1KdfScheme,
  ...
  static __declspec(property(get = getStaticF_DHSinglePassStdDHSha1KdfScheme,
                             put = setStaticF_DHSinglePassStdDHSha1KdfScheme))::Org::BouncyCastle::Asn1::DerObjectIdentifier* DHSinglePassStdDHSha1KdfScheme;
  ...
  /// @brief Method .ctor, addr 0x132237c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
