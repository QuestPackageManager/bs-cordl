...
public:
  ...
  /// @brief Method GetInstance, addr 0x25f3380, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x25f4320, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f35c0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1);

  /// @brief Method .ctor, addr 0x25f35cc, size 0x3dc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3);

  /// @brief Method .ctor, addr 0x25f3518, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* primeP);

  /// @brief Method .ctor, addr 0x25f4254, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Identifier, addr 0x25f4310, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Identifier();

  /// @brief Method get_Parameters, addr 0x25f4318, size 0x8, virtual false, abstract: false, final false
