...
public:
  ...
  /// @brief Method GetInstance, addr 0x262666c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x262760c, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26268ac, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1);

  /// @brief Method .ctor, addr 0x26268b8, size 0x3dc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3);

  /// @brief Method .ctor, addr 0x2626804, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* primeP);

  /// @brief Method .ctor, addr 0x2627540, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Identifier, addr 0x26275fc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Identifier();

  /// @brief Method get_Parameters, addr 0x2627604, size 0x8, virtual false, abstract: false, final false
