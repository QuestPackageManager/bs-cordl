...
public:
  ...
  /// @brief Method GetInstance, addr 0x141a594, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x141b56c, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141a7e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1);

  /// @brief Method .ctor, addr 0x141a7f0, size 0x3e4, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3);

  /// @brief Method .ctor, addr 0x141a734, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* primeP);

  /// @brief Method .ctor, addr 0x141b4a0, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Identifier, addr 0x141b55c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Identifier();

  /// @brief Method get_Parameters, addr 0x141b564, size 0x8, virtual false, abstract: false, final false
