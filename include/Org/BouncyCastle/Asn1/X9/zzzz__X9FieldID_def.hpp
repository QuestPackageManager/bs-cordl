...
public:
  ...
  /// @brief Method GetInstance, addr 0x35bf78c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35c0760, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35bf9c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1);

  /// @brief Method .ctor, addr 0x35bf9d4, size 0x3e8, virtual false, abstract: false, final false
  inline void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3);

  /// @brief Method .ctor, addr 0x35bf924, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* primeP);

  /// @brief Method .ctor, addr 0x35c0694, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Identifier, addr 0x35c0750, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Identifier();

  /// @brief Method get_Parameters, addr 0x35c0758, size 0x8, virtual false, abstract: false, final false
