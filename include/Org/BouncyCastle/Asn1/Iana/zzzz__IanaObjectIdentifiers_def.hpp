...
public:
  ...
  /// @brief Method .ctor, addr 0x337f624, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IanaObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IanaObjectIdentifiers(IanaObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IanaObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IanaObjectIdentifiers(IanaObjectIdentifiersconst&) = delete;
