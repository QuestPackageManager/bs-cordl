...
public:
  ...
  /// @brief Method .ctor, addr 0x2629e8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2629e94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2629e9c, size 0x8, virtual false, abstract: false, final false
