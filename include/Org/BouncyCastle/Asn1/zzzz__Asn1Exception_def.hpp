...
public:
  ...
  /// @brief Method .ctor, addr 0x25eaadc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25eaae4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25eaaec, size 0x8, virtual false, abstract: false, final false
