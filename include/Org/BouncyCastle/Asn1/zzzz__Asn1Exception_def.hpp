...
public:
  ...
  /// @brief Method .ctor, addr 0x3585a94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3585a9c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3585ac0, size 0x24, virtual false, abstract: false, final false
