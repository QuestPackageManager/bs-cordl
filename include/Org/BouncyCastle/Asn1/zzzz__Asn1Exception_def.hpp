...
public:
  ...
  /// @brief Method .ctor, addr 0x35c2028, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35c2030, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35c2054, size 0x24, virtual false, abstract: false, final false
