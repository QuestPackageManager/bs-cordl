...
public:
  ...
  /// @brief Method .ctor, addr 0x262b888, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262b890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262b898, size 0x8, virtual false, abstract: false, final false
