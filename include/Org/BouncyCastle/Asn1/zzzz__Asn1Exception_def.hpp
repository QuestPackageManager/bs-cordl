...
public:
  ...
  /// @brief Method .ctor, addr 0x262b250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262b258, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262b260, size 0x8, virtual false, abstract: false, final false
