...
public:
  ...
  /// @brief Method .ctor, addr 0x367f27c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x367f284, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x367f2a8, size 0x24, virtual false, abstract: false, final false
