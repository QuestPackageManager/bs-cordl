...
public:
  ...
  /// @brief Method .ctor, addr 0x262f5c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x262f5d0, size 0x8, virtual false, abstract: false, final false
