...
public:
  ...
  /// @brief Method .ctor, addr 0x141cdd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x141cde0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x141cde8, size 0x8, virtual false, abstract: false, final false
