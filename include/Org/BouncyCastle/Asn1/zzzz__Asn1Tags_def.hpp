...
public:
  ...
  /// @brief Method .ctor, addr 0x3688948, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Asn1Tags", modifiers: "&&", def_value: None, comment: None }]
