...
public:
  ...
  /// @brief Method GetCertHash, addr 0x110b38c, size 0x11c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertHash();

  /// @brief Method GetInstance, addr 0x110adec, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x110b4b0, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x110b174, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algId, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest);

  /// @brief Method .ctor, addr 0x110b1f8, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x110af7c, size 0x1f8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmHash, addr 0x110b288, size 0x104, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmHash();

  /// @brief Method get_IssuerSerial, addr 0x110b4a8, size 0x8, virtual false, abstract: false, final false
