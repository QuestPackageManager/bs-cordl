...
public:
  ...
  /// @brief Method GetCertHash, addr 0x23265d4, size 0x20, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetCertHash();

  /// @brief Method GetInstance, addr 0x232621c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23265fc, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23264e8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> hash);

  /// @brief Method .ctor, addr 0x232655c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> hash, ::Org::BouncyCastle::Asn1::X509::IssuerSerial* issuerSerial);

  /// @brief Method .ctor, addr 0x232639c, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_IssuerSerial, addr 0x23265f4, size 0x8, virtual false, abstract: false, final false
