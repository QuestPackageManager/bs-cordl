...
public:
  ...
  /// @brief Method GetInstance, addr 0x2324b50, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2324ebc, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2324e58, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* contentType);

  /// @brief Method .ctor, addr 0x2324e80, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2324cd0, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ContentDescription, addr 0x2324eb4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_ContentDescription();

  /// @brief Method get_ContentType, addr 0x2324eac, size 0x8, virtual false, abstract: false, final false
