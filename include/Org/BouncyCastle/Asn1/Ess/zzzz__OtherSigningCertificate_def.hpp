...
public:
  ...
  /// @brief Method GetCerts, addr 0x33798b8, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Ess::OtherCertID*> GetCerts();

  /// @brief Method GetInstance, addr 0x337958c, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate* GetInstance(::System::Object* o);

  /// @brief Method GetPolicies, addr 0x33799cc, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3379ae8, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3379850, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ess::OtherCertID* otherCertID);

  /// @brief Method .ctor, addr 0x3379714, size 0x13c, virtual false, abstract: false, final false
