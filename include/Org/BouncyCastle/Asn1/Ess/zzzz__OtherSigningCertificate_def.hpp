...
public:
  ...
  /// @brief Method GetCerts, addr 0x22f359c, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Ess::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Ess::OtherCertID*>*> GetCerts();

  /// @brief Method GetInstance, addr 0x22f325c, size 0x180, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate* GetInstance(::System::Object* o);

  /// @brief Method GetPolicies, addr 0x22f36ac, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x22f37c4, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f3528, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ess::OtherCertID* otherCertID);

  /// @brief Method .ctor, addr 0x22f33dc, size 0x14c, virtual false, abstract: false, final false
