...
public:
  ...
  /// @brief Method GetCerts, addr 0x32800d0, size 0x114, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Ess::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Ess::OtherCertID*>*> GetCerts();

  /// @brief Method GetInstance, addr 0x327fda4, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ess::OtherSigningCertificate* GetInstance(::System::Object* o);

  /// @brief Method GetPolicies, addr 0x32801e4, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3280300, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3280068, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ess::OtherCertID* otherCertID);

  /// @brief Method .ctor, addr 0x327ff2c, size 0x13c, virtual false, abstract: false, final false
