...
public:
  ...
  /// @brief Method GetCerts, addr 0x2327f50, size 0x110, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Ess::EssCertID*, ::Array<::Org::BouncyCastle::Asn1::Ess::EssCertID*>*> GetCerts();

  /// @brief Method GetInstance, addr 0x2327c10, size 0x180, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Ess::SigningCertificate* GetInstance(::System::Object* o);

  /// @brief Method GetPolicies, addr 0x2328060, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2328178, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2327edc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ess::EssCertID* essCertID);

  /// @brief Method .ctor, addr 0x2327d90, size 0x14c, virtual false, abstract: false, final false
