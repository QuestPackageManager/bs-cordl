...
public:
  ...
  /// @brief Method GetInstance, addr 0x23238b0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2323ad8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2323a5c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method .ctor, addr 0x2323a34, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method get_Value, addr 0x2323ad0, size 0x8, virtual false, abstract: false, final false
