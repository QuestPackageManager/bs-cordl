...
public:
  ...
  /// @brief Method GetInstance, addr 0x327e884, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x327ea7c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327ea0c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method .ctor, addr 0x327ea04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method get_Value, addr 0x327ea74, size 0x8, virtual false, abstract: false, final false
