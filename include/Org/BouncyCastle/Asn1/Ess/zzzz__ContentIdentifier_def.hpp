...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f8464, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f86a4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f8620, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method .ctor, addr 0x10f85f8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method get_Value, addr 0x10f869c, size 0x8, virtual false, abstract: false, final false
