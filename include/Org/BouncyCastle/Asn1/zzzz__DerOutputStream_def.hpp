...
public:
  ...
  /// @brief Method .ctor addr 0x11467ec size 0x4 virtual false final false
  inline void _ctor(::System::IO::Stream* os);

  /// @brief Method WriteLength addr 0x11467f0 size 0xa0 virtual false final false
  inline void WriteLength(int32_t length);

  /// @brief Method WriteEncoded addr 0x1146890 size 0x5c virtual false final false
  inline void WriteEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteEncoded addr 0x11468ec size 0x7c virtual false final false
  inline void WriteEncoded(int32_t tag, uint8_t first, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteEncoded addr 0x1146968 size 0x64 virtual false final false
  inline void WriteEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t offset, int32_t length);

  /// @brief Method WriteTag addr 0x11469cc size 0x124 virtual false final false
  inline void WriteTag(int32_t flags, int32_t tagNo);

  /// @brief Method WriteEncoded addr 0x1146af0 size 0x50 virtual false final false
  inline void WriteEncoded(int32_t flags, int32_t tagNo, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteNull addr 0x1146b40 size 0x38 virtual false final false
  inline void WriteNull();

  /// @brief Method WriteObject addr 0x1146b78 size 0x15c virtual true final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteObject addr 0x1146cd4 size 0x70 virtual true final false
  inline void WriteObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method WriteObject addr 0x1146d44 size 0x58 virtual true final false
