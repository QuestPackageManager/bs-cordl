...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerOutputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerOutputStream*, "Org.BouncyCastle.Asn1", "DerOutputStream");
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerOutputStream) == 0x30, "Size mismatch!");
