...
public:
  ...
  /// @brief Method WriteEncoded, addr 0x355f000, size 0x50, virtual false, abstract: false, final false
  inline void WriteEncoded(int32_t flags, int32_t tagNo, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteEncoded, addr 0x355eda0, size 0x5c, virtual false, abstract: false, final false
  inline void WriteEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteEncoded, addr 0x355ee78, size 0x64, virtual false, abstract: false, final false
  inline void WriteEncoded(int32_t tag, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes, int32_t offset, int32_t length);

  /// @brief Method WriteEncoded, addr 0x355edfc, size 0x7c, virtual false, abstract: false, final false
  inline void WriteEncoded(int32_t tag, uint8_t first, ::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method WriteLength, addr 0x355ecf0, size 0xb0, virtual false, abstract: false, final false
  inline void WriteLength(int32_t length);

  /// @brief Method WriteNull, addr 0x355f050, size 0x38, virtual false, abstract: false, final false
  inline void WriteNull();

  /// @brief Method WriteObject, addr 0x355f1f4, size 0x70, virtual true, abstract: false, final false
  inline void WriteObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method WriteObject, addr 0x355f264, size 0x58, virtual true, abstract: false, final false
  inline void WriteObject(::Org::BouncyCastle::Asn1::Asn1Object* obj);

  /// @brief Method WriteObject, addr 0x355f088, size 0x16c, virtual true, abstract: false, final false
  inline void WriteObject(::System::Object* obj);

  /// @brief Method WriteTag, addr 0x355eedc, size 0x124, virtual false, abstract: false, final false
  inline void WriteTag(int32_t flags, int32_t tagNo);

  /// @brief Method .ctor, addr 0x355ecec, size 0x4, virtual false, abstract: false, final false
