...
public:
  ...
  /// @brief Method ReadObject, addr 0x142a704, size 0x20, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x142a724, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x141f94c, size 0x28, virtual false, abstract: false, final false
