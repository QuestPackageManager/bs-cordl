...
public:
  ...
  /// @brief Method ReadObject, addr 0x368c5fc, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x368c618, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3681ca0, size 0x8, virtual false, abstract: false, final false
