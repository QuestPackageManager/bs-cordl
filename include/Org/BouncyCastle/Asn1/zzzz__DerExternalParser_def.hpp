...
public:
  ...
  /// @brief Method ReadObject, addr 0x368e984, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x368e9a0, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3684028, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerExternalParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerExternalParser(DerExternalParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerExternalParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerExternalParser(DerExternalParserconst&) = delete;
