...
public:
  ...
  /// @brief Method ReadObject, addr 0x14339fc, size 0x20, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x1433a1c, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1428c44, size 0x28, virtual false, abstract: false, final false
