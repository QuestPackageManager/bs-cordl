...
public:
  ...
  /// @brief Method ReadObject, addr 0x35685d0, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x35685ec, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355dc74, size 0x8, virtual false, abstract: false, final false
