...
public:
  ...
  /// @brief Method ReadObject, addr 0x2638f2c, size 0x20, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x2638f4c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262e31c, size 0x28, virtual false, abstract: false, final false
