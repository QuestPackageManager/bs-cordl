...
public:
  ...
  /// @brief Method ReadObject, addr 0x3691160, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x369117c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3687a08, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerSequenceParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerSequenceParser(DerSequenceParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerSequenceParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerSequenceParser(DerSequenceParserconst&) = delete;
