...
public:
  ...
  /// @brief Method Encode, addr 0x263530c, size 0x398, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FromVector, addr 0x262d7c0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2635308, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262fe30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor, addr 0x2622d3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method .ctor, addr 0x26225d4, size 0x4, virtual false, abstract: false, final false
