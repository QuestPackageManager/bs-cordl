...
public:
  ...
  /// @brief Method GetHashedMessage, addr 0x355093c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHashedMessage();

  /// @brief Method GetInstance, addr 0x35507a0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3550944, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355092c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm, ::ArrayW<uint8_t> hashedMessage);

  /// @brief Method .ctor, addr 0x3550840, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x3550934, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MessageImprint", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MessageImprint(MessageImprint&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MessageImprint", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MessageImprint(MessageImprintconst&) = delete;
