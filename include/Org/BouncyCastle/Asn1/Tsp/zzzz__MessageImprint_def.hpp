...
public:
  ...
  /// @brief Method GetHashedMessage, addr 0x24f94cc, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetHashedMessage();

  /// @brief Method GetInstance, addr 0x24f9300, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24f94d4, size 0x118, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f9498, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f93a4, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x24f94c4, size 0x8, virtual false, abstract: false, final false
