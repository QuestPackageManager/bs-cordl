...
public:
  ...
  /// @brief Method .ctor, addr 0x10a5794, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10a5878, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0x10a5b88, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Tsp::Accuracy* GetInstance(::System::Object* obj);

  /// @brief Method get_Seconds, addr 0x10a5c2c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Seconds();

  /// @brief Method get_Millis, addr 0x10a5c34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Millis();

  /// @brief Method get_Micros, addr 0x10a5c3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Micros();

  /// @brief Method ToAsn1Object, addr 0x10a5c44, size 0x138, virtual true, abstract: false, final false
