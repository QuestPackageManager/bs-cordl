...
public:
  ...
  /// @brief Method GetInstance, addr 0x110f08c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x110fa54, size 0x298, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x110f130, size 0x814, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x110f944, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Accuracy, addr 0x110fa24, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Tsp::Accuracy* get_Accuracy();

  /// @brief Method get_Extensions, addr 0x110fa4c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_Extensions();

  /// @brief Method get_GenTime, addr 0x110fa2c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_GenTime();

  /// @brief Method get_MessageImprint, addr 0x110fa0c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Tsp::MessageImprint* get_MessageImprint();

  /// @brief Method get_Nonce, addr 0x110fa3c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Nonce();

  /// @brief Method get_Ordering, addr 0x110fa34, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBoolean* get_Ordering();

  /// @brief Method get_Policy, addr 0x110fa14, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Policy();

  /// @brief Method get_SerialNumber, addr 0x110fa1c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_SerialNumber();

  /// @brief Method get_Tsa, addr 0x110fa44, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Tsa();

  /// @brief Method get_Version, addr 0x110fa04, size 0x8, virtual false, abstract: false, final false
