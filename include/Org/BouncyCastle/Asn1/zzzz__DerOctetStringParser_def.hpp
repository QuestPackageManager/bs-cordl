...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x2636dac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x2636db4, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x262dc04, size 0x28, virtual false, abstract: false, final false
