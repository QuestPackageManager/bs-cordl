...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerOctetStringParser*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerOctetStringParser*, "Org.BouncyCastle.Asn1", "DerOctetStringParser");
...
public:
  ...
  /// @brief Method GetOctetStream, addr 0x368e624, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method ToAsn1Object, addr 0x368e62c, size 0x160, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3685688, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerOctetStringParser) == 0x18, "Size mismatch!");
