...
public:
  ...
  /// @brief Method AddObject, addr 0x3687014, size 0x84, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x36870a4, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x368709c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBerBody, addr 0x36871dc, size 0x14, virtual false, abstract: false, final false
  inline void WriteBerBody(::System::IO::Stream* contentStream);

  /// @brief Method WriteBerEnd, addr 0x36870a8, size 0x98, virtual false, abstract: false, final false
  inline void WriteBerEnd();

  /// @brief Method WriteBerHeader, addr 0x3687184, size 0x58, virtual false, abstract: false, final false
  inline void WriteBerHeader(int32_t tag);

  /// @brief Method WriteHdr, addr 0x3687140, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3686ff0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x3686ffc, size 0x18, virtual false, abstract: false, final false
