...
public:
  ...
  /// @brief Method .ctor addr 0x114abe4 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x114ac10 size 0x4c virtual false final false
  inline void _ctor(::System::IO::Stream* outStream, int32_t tagNo, bool isExplicit);

  /// @brief Method AddObject addr 0x114ac5c size 0x80 virtual true final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method GetRawOutputStream addr 0x114ace0 size 0x8 virtual true final false
  inline ::System::IO::Stream* GetRawOutputStream();

  /// @brief Method Close addr 0x114ace8 size 0x4 virtual true final false
  inline void Close();

  /// @brief Method WriteHdr addr 0x114ad84 size 0x44 virtual false final false
  inline void WriteHdr(int32_t tag);

  /// @brief Method WriteBerHeader addr 0x114adc8 size 0x58 virtual false final false
  inline void WriteBerHeader(int32_t tag);

  /// @brief Method WriteBerBody addr 0x114ae20 size 0x14 virtual false final false
  inline void WriteBerBody(::System::IO::Stream* contentStream);

  /// @brief Method WriteBerEnd addr 0x114acec size 0x98 virtual false final false
