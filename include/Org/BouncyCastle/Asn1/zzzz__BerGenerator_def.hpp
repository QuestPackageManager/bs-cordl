...
public:
  ...
  /// @brief Method AddObject, addr 0x35c9dc0, size 0x84, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x35c9e50, size 0x4, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x35c9e48, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method WriteBerBody, addr 0x35c9f88, size 0x14, virtual false, abstract: false, final false
  inline void WriteBerBody(::System::IO::Stream* contentStream);

  /// @brief Method WriteBerEnd, addr 0x35c9e54, size 0x98, virtual false, abstract: false, final false
  inline void WriteBerEnd();

  /// @brief Method WriteBerHeader, addr 0x35c9f30, size 0x58, virtual false, abstract: false, final false
  inline void WriteBerHeader(int32_t tag);

  /// @brief Method WriteHdr, addr 0x35c9eec, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c9d9c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x35c9da8, size 0x18, virtual false, abstract: false, final false
