...
public:
  ...
  /// @brief Method GetInstance, addr 0x11ee5ac, size 0x100, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0x11ee6ac, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ee7ec, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::StringW time);

  static inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* New_ctor(::System::DateTime time);

  /// @brief Method .ctor, addr 0x11eeb84, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e40d4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method get_TimeString, addr 0x11eebf0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TimeString();

  /// @brief Method GetTime, addr 0x11eebf8, size 0x31c, virtual false, abstract: false, final false
  inline ::StringW GetTime();

  /// @brief Method CalculateGmtOffset, addr 0x11eef14, size 0x280, virtual false, abstract: false, final false
  inline ::StringW CalculateGmtOffset();

  /// @brief Method Convert, addr 0x11ef194, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW Convert(int32_t time);

  /// @brief Method ToDateTime, addr 0x11ee904, size 0x280, virtual false, abstract: false, final false
  inline ::System::DateTime ToDateTime();

  /// @brief Method FString, addr 0x11ef254, size 0x84, virtual false, abstract: false, final false
  inline ::StringW FString(int32_t count);

  /// @brief Method ParseDateString, addr 0x11ef2d8, size 0x24c, virtual false, abstract: false, final false
  inline ::System::DateTime ParseDateString(::StringW s, ::StringW format, bool makeUniversal);

  /// @brief Method get_HasFractionalSeconds, addr 0x11ef228, size 0x2c, virtual false, abstract: false, final false
  inline bool get_HasFractionalSeconds();

  /// @brief Method GetOctets, addr 0x11ef524, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method Encode, addr 0x11ef530, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Asn1Equals, addr 0x11ef560, size 0xa0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x11ef600, size 0x1c, virtual true, abstract: false, final false
