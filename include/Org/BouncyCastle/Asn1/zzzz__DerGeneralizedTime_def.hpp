...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x3593e88, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x3593f30, size 0x14, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method CalculateGmtOffset, addr 0x35937a0, size 0x2ec, virtual false, abstract: false, final false
  inline ::StringW CalculateGmtOffset();

  /// @brief Method Convert, addr 0x3593a8c, size 0x98, virtual false, abstract: false, final false
  static inline ::StringW Convert(int32_t time);

  /// @brief Method Encode, addr 0x3593e58, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method FString, addr 0x3593b58, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW FString(int32_t count);

  /// @brief Method GetInstance, addr 0x3592fa4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3592ea4, size 0x100, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x3593e4c, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetTime, addr 0x359352c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseDateString, addr 0x3593be4, size 0x268, virtual false, abstract: false, final false
  inline ::System::DateTime ParseDateString(::StringW s, ::StringW format, bool makeUniversal);

  /// @brief Method ToDateTime, addr 0x35931d4, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3588d90, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> bytes);

  /// @brief Method .ctor, addr 0x35930d4, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(::StringW time);

  /// @brief Method .ctor, addr 0x3593498, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime time);

  /// @brief Method get_HasFractionalSeconds, addr 0x3593b24, size 0x34, virtual false, abstract: false, final false
  inline bool get_HasFractionalSeconds();

  /// @brief Method get_TimeString, addr 0x3593524, size 0x8, virtual false, abstract: false, final false
