...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Bsi::BsiObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Bsi::BsiObjectIdentifiers*, "Org.BouncyCastle.Asn1.Bsi", "BsiObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3346c4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BsiObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BsiObjectIdentifiers(BsiObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BsiObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BsiObjectIdentifiers(BsiObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Bsi::BsiObjectIdentifiers) == 0x10, "Size mismatch!");
