...
public:
  ...
  /// @brief Method .ctor addr 0xe280d8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CreateParameters addr 0xe280e0 size 0x1d4 virtual true final false
...
public:
  ...
  /// @brief Method .ctor addr 0xe28318 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CreateParameters addr 0xe28320 size 0x1d4 virtual true final false
  inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* CreateParameters();
...
public:
  ...
  /// @brief Method .ctor addr 0xe276a0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method ConfigureBasepoint addr 0xe276a8 size 0xf0 virtual false final false
  ...
  /// @brief Method ConfigureCurve addr 0xe27798 size 0x4 virtual false final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method FromHex addr 0xe2779c size 0xa0 virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method DefineCurve addr 0xe2783c size 0x210 virtual false final false
  ...
  /// @brief Method GetByName addr 0xe27bcc size 0x80 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid addr 0xe27da0 size 0x12c virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid addr 0xe27c4c size 0x154 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetOid(::StringW name);

  /// @brief Method GetName addr 0xe27ecc size 0x100 virtual false final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method get_Names addr 0xe27fcc size 0x10c virtual false final false
