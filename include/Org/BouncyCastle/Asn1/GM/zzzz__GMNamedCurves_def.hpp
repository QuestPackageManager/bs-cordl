...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::GM::GMNamedCurves*);
MARK_REF_T(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_SM2P256V1Holder*);
MARK_REF_T(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_WapiP192V1Holder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::GM::GMNamedCurves*, "Org.BouncyCastle.Asn1.GM", "GMNamedCurves");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_SM2P256V1Holder*, "Org.BouncyCastle.Asn1.GM", "GMNamedCurves/SM2P256V1Holder");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_WapiP192V1Holder*, "Org.BouncyCastle.Asn1.GM", "GMNamedCurves/WapiP192V1Holder");
...
public:
  ...
  /// @brief Method CreateParameters, addr 0x337b578, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337b574, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_SM2P256V1Holder) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateParameters, addr 0x337b7b4, size 0x1e4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* CreateParameters();

  static inline ::Org::BouncyCastle::Asn1::GM::GMNamedCurves_WapiP192V1Holder* New_ctor();

  /// @brief Method .ctor, addr 0x337b7b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Asn1::GM::GMNamedCurves_WapiP192V1Holder) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0x337aaf8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureCurve, addr 0x337abf4, size 0x4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method DefineCurve, addr 0x337ac98, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method FromHex, addr 0x337abf8, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method GetByName, addr 0x337b048, size 0x84, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid, addr 0x337b230, size 0x138, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetName, addr 0x337b368, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0x337b0cc, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337aaf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Names, addr 0x337b460, size 0x114, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Asn1::GM::GMNamedCurves) == 0x10, "Size mismatch!");
