...
public:
  ...
  /// @brief Method CreateParameters, addr 0x32be324, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32be320, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateParameters, addr 0x32be560, size 0x1e4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* CreateParameters();

  static inline ::Org::BouncyCastle::Asn1::GM::GMNamedCurves_WapiP192V1Holder* New_ctor();

  /// @brief Method .ctor, addr 0x32be55c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0x32bd8a4, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureCurve, addr 0x32bd9a0, size 0x4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method DefineCurve, addr 0x32bda44, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method FromHex, addr 0x32bd9a4, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method GetByName, addr 0x32bddf4, size 0x84, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid, addr 0x32bdfdc, size 0x138, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetName, addr 0x32be114, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0x32bde78, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32bd8a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Names, addr 0x32be20c, size 0x114, virtual false, abstract: false, final false
