...
/// @brief Field sm2encrypt_recommendedParameters, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_sm2encrypt_recommendedParameters, put=setStaticF_sm2encrypt_recommendedParameters)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  sm2encrypt_recommendedParameters;
...
/// @brief Method .ctor, addr 0x32831d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
