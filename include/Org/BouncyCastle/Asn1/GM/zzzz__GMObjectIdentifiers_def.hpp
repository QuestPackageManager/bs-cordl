...
public:
  ...
  /// @brief Method .ctor, addr 0x337edf0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GMObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GMObjectIdentifiers(GMObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GMObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GMObjectIdentifiers(GMObjectIdentifiersconst&) = delete;
