...
public:
  ...
  /// @brief Method .ctor addr 0xf7d744 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method DefineCurveAlias addr 0xf7d74c size 0x198 virtual false final false
  static inline void DefineCurveAlias(::StringW name, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetByName addr 0xf7dc04 size 0x80 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid addr 0xf7ddd8 size 0x58 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid addr 0xf7dc84 size 0x154 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetOid(::StringW name);

  /// @brief Method GetName addr 0xf7de30 size 0x100 virtual false final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method get_Names addr 0xf7df30 size 0x10c virtual false final false
