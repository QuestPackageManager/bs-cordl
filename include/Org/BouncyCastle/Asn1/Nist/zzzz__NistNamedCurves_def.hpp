...
public:
  ...
  /// @brief Method DefineCurveAlias, addr 0x2407920, size 0x198, virtual false, abstract: false, final false
  static inline void DefineCurveAlias(::StringW name, ::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetByName, addr 0x2407dd8, size 0x80, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid, addr 0x2407fac, size 0x58, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetName, addr 0x2408004, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0x2407e58, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2407918, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Names, addr 0x2408104, size 0x108, virtual false, abstract: false, final false
