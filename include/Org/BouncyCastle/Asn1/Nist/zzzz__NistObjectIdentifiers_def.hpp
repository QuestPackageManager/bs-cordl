...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Nist::NistObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Nist::NistObjectIdentifiers*, "Org.BouncyCastle.Asn1.Nist", "NistObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3458648, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NistObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NistObjectIdentifiers(NistObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NistObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NistObjectIdentifiers(NistObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Nist::NistObjectIdentifiers) == 0x10, "Size mismatch!");
