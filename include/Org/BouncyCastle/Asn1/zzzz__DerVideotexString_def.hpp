...
public:
  ...
  /// @brief Method GetInstance, addr 0x11c58d4, size 0x220, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerVideotexString* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0x11c5af4, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11b7488, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encoding);

  /// @brief Method GetString, addr 0x11c5c24, size 0xc, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method GetOctets, addr 0x11c5c30, size 0x5c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method Encode, addr 0x11c5c8c, size 0x24, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Asn1GetHashCode, addr 0x11c5cb0, size 0x5c, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Asn1Equals, addr 0x11c5d0c, size 0xc8, virtual true, abstract: false, final false
