...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::OtherRevRefs*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::OtherRevRefs*, "Org.BouncyCastle.Asn1.Esf", "OtherRevRefs");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x337133c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3373cf8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373c50, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373a54, size 0x1fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevRefType, addr 0x3373ce8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OtherRevRefType();

  /// @brief Method get_OtherRevRefsObject, addr 0x3373cf0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::OtherRevRefs) == 0x20, "Size mismatch!");
