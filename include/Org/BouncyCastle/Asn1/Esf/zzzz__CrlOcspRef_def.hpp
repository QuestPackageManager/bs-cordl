...
public:
  ...
  /// @brief Method GetInstance, addr 0x324b760, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x324d4b8, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324d494, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324cdbc, size 0x3d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlIDs, addr 0x324d4a0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::CrlListID* get_CrlIDs();

  /// @brief Method get_OcspIDs, addr 0x324d4a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* get_OcspIDs();

  /// @brief Method get_OtherRev, addr 0x324d4b0, size 0x8, virtual false, abstract: false, final false
