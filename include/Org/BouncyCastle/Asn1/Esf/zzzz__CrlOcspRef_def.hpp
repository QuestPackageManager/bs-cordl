...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*, "Org.BouncyCastle.Asn1.Esf", "CrlOcspRef");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3371b14, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x337386c, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373848, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373170, size 0x3d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlIDs, addr 0x3373854, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::CrlListID* get_CrlIDs();

  /// @brief Method get_OcspIDs, addr 0x337385c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* get_OcspIDs();

  /// @brief Method get_OtherRev, addr 0x3373864, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrlOcspRef", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrlOcspRef(CrlOcspRef&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrlOcspRef", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrlOcspRef(CrlOcspRefconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::CrlOcspRef) == 0x28, "Size mismatch!");
