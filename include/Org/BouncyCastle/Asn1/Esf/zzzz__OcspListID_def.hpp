...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b3f64, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspResponses, addr 0x32b577c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b58a0, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b5540, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b55f4, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* ocspResponses);

  /// @brief Method .ctor, addr 0x32b4f74, size 0x448, virtual false, abstract: false, final false
