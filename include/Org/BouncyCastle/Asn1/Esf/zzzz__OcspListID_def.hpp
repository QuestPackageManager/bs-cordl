...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f1170, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspResponses, addr 0x10f2a24, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f2b44, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f27bc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f2880, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* ocspResponses);

  /// @brief Method .ctor, addr 0x10f21b4, size 0x480, virtual false, abstract: false, final false
