...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f79e0, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspResponses, addr 0x10f9294, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f93b4, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f902c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f90f0, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* ocspResponses);

  /// @brief Method .ctor, addr 0x10f8a24, size 0x480, virtual false, abstract: false, final false
