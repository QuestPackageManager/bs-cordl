...
public:
  ...
  /// @brief Method GetInstance, addr 0x32779d0, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OcspListID* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspResponses, addr 0x32791e8, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x327930c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3278fac, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3279060, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* ocspResponses);

  /// @brief Method .ctor, addr 0x32789e0, size 0x448, virtual false, abstract: false, final false
