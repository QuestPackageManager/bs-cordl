...
public:
  ...
  /// @brief Method GetInstance, addr 0x3252914, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3252b3c, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3252b2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3252ad4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId* signaturePolicyId);

  /// @brief Method get_SignaturePolicyId, addr 0x3252b34, size 0x8, virtual false, abstract: false, final false
