...
public:
  ...
  /// @brief Method GetInstance, addr 0x2325c20, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2325e84, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2325e60, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2325dec, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId* signaturePolicyId);

  /// @brief Method get_SignaturePolicyId, addr 0x2325e7c, size 0x8, virtual false, abstract: false, final false
