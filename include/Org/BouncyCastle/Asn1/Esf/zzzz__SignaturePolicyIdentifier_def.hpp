...
public:
  ...
  /// @brief Method GetInstance, addr 0x2325bd0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2325e34, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2325e10, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2325d9c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId* signaturePolicyId);

  /// @brief Method get_SignaturePolicyId, addr 0x2325e2c, size 0x8, virtual false, abstract: false, final false
