...
public:
  ...
  /// @brief Method GetCrlVals, addr 0x3377df4, size 0x128, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::CertificateList*> GetCrlVals();

  /// @brief Method GetInstance, addr 0x337709c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::RevocationValues* GetInstance(::System::Object* obj);

  /// @brief Method GetOcspVals, addr 0x3377f1c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x337804c, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3377b2c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3377bc8, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337713c, size 0x9f0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevVals, addr 0x3378044, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RevocationValues", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RevocationValues(RevocationValues&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RevocationValues", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RevocationValues(RevocationValuesconst&) = delete;
