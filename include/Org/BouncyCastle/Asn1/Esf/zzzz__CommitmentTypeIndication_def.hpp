...
public:
  ...
  /// @brief Method GetInstance, addr 0x32b0b78, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32b1020, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b0fa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* commitmentTypeId);

  /// @brief Method .ctor, addr 0x32b0fb0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32b0cfc, size 0x2ac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CommitmentTypeID, addr 0x32b1010, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CommitmentTypeID();

  /// @brief Method get_CommitmentTypeQualifier, addr 0x32b1018, size 0x8, virtual false, abstract: false, final false
