...
public:
  ...
  /// @brief Method GetInstance, addr 0x3373de8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3374210, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3374168, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3373f6c, size 0x1fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevValType, addr 0x3374200, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OtherRevValType();

  /// @brief Method get_OtherRevValsObject, addr 0x3374208, size 0x8, virtual false, abstract: false, final false
