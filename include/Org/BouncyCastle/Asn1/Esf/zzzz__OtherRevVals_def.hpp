...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f3f90, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f43e8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4320, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4118, size 0x208, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OtherRevValType, addr 0x10f43d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OtherRevValType();

  /// @brief Method get_OtherRevValsObject, addr 0x10f43e0, size 0x8, virtual false, abstract: false, final false
