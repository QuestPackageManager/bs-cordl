...
public:
  ...
  /// @brief Method GetCertificates, addr 0xffa2ec, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0xff9bac, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xffa400, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffa084, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xffa148, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certificates);

  /// @brief Method .ctor, addr 0xff9d34, size 0x350, virtual false, abstract: false, final false
