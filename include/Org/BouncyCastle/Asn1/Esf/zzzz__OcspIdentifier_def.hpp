...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OcspIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OcspIdentifier(OcspIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OcspIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OcspIdentifier(OcspIdentifierconst&) = delete;
