...
public:
  ...
  /// @brief Method GetInstance, addr 0x231ea38, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x231ee94, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231edbc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* ocspResponderID, ::System::DateTime producedAt);

  /// @brief Method .ctor, addr 0x231ebb4, size 0x208, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OcspResponderID, addr 0x231ee70, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* get_OcspResponderID();

  /// @brief Method get_ProducedAt, addr 0x231ee78, size 0x1c, virtual false, abstract: false, final false
