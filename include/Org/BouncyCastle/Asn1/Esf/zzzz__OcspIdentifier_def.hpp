...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::OcspIdentifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::OcspIdentifier*, "Org.BouncyCastle.Asn1.Esf", "OcspIdentifier");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3371c84, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33720d8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337200c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::ResponderID* ocspResponderID, ::System::DateTime producedAt);

  /// @brief Method .ctor, addr 0x3371e08, size 0x204, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OcspResponderID, addr 0x33720b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Ocsp::ResponderID* get_OcspResponderID();

  /// @brief Method get_ProducedAt, addr 0x33720c0, size 0x18, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::OcspIdentifier) == 0x20, "Size mismatch!");
