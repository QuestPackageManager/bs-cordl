...
public:
  ...
  /// @brief Method .ctor, addr 0xeb987c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeb9884, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeb9918, size 0x24c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method GetInstance, addr 0xeb9b64, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::CommitmentTypeQualifier* GetInstance(::System::Object* obj);

  /// @brief Method get_CommitmentTypeIdentifier, addr 0xeb9cec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CommitmentTypeIdentifier();

  /// @brief Method get_Qualifier, addr 0xeb9cf4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* get_Qualifier();

  /// @brief Method ToAsn1Object, addr 0xeb9cfc, size 0x148, virtual true, abstract: false, final false
