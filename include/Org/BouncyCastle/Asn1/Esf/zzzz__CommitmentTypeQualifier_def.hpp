...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f4d50, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f4ee8, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4a68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* commitmentTypeIdentifier);

  /// @brief Method .ctor, addr 0x10f4a70, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4b04, size 0x24c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CommitmentTypeIdentifier, addr 0x10f4ed8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CommitmentTypeIdentifier();

  /// @brief Method get_Qualifier, addr 0x10f4ee0, size 0x8, virtual false, abstract: false, final false
