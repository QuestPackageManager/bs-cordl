...
public:
  ...
  /// @brief Method GetHashValue, addr 0x3375944, size 0x1c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHashValue();

  /// @brief Method GetInstance, addr 0x33755f0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3375cec, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375b84, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm, ::ArrayW<uint8_t> hashValue);

  /// @brief Method .ctor, addr 0x3375c64, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3375980, size 0x204, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_HashAlgorithm, addr 0x3375ce4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OtherHashAlgAndValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OtherHashAlgAndValue(OtherHashAlgAndValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OtherHashAlgAndValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OtherHashAlgAndValue(OtherHashAlgAndValueconst&) = delete;
