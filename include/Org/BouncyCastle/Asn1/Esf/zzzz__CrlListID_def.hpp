...
public:
  ...
  /// @brief Method GetCrls, addr 0x324cc38, size 0x124, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*>*> GetCrls();

  /// @brief Method GetInstance, addr 0x324c2ac, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x324cd5c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x324c9fc, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*>*> crls);

  /// @brief Method .ctor, addr 0x324cab0, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* crls);

  /// @brief Method .ctor, addr 0x324c430, size 0x448, virtual false, abstract: false, final false
