...
public:
  ...
  /// @brief Method GetCrls, addr 0x231ea70, size 0x120, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*>*> GetCrls();

  /// @brief Method GetInstance, addr 0x231e0b4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x231eb90, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231e824, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlValidatedID*>*> crls);

  /// @brief Method .ctor, addr 0x231e8dc, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* crls);

  /// @brief Method .ctor, addr 0x231e230, size 0x478, virtual false, abstract: false, final false
