...
public:
  ...
  /// @brief Method GetHashValue, addr 0x3279da4, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetHashValue();

  /// @brief Method GetInstance, addr 0x32780b8, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3279df0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3279c04, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* otherHash);

  /// @brief Method .ctor, addr 0x3279c5c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> sha1Hash);

  /// @brief Method .ctor, addr 0x3279a28, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* sha1Hash);

  /// @brief Method get_HashAlgorithm, addr 0x3279d10, size 0x94, virtual false, abstract: false, final false
