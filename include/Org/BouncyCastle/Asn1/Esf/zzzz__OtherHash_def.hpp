...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::OtherHash*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::OtherHash*, "Org.BouncyCastle.Asn1.Esf", "OtherHash");
...
public:
  ...
  /// @brief Method GetHashValue, addr 0x337358c, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHashValue();

  /// @brief Method GetInstance, addr 0x33718a0, size 0x11c, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Asn1::Esf::OtherHash* New_ctor(::ArrayW<uint8_t> sha1Hash);

  static inline ::Org::BouncyCastle::Asn1::Esf::OtherHash* New_ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* sha1Hash);

  /// @brief Method ToAsn1Object, addr 0x33735d8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33733ec, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* otherHash);

  /// @brief Method .ctor, addr 0x3373444, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> sha1Hash);

  /// @brief Method .ctor, addr 0x3373210, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* sha1Hash);

  /// @brief Method get_HashAlgorithm, addr 0x33734f8, size 0x94, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::OtherHash) == 0x20, "Size mismatch!");
