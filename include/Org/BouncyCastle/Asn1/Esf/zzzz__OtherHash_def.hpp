...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OtherHash", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OtherHash(OtherHash&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OtherHash", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OtherHash(OtherHashconst&) = delete;
