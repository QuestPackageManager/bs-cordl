...
public:
  ...
  /// @brief Method GetHashValue, addr 0xf26410, size 0x30, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetHashValue();

  /// @brief Method GetInstance, addr 0xf24590, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf26460, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf26230, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* otherHash);

  /// @brief Method .ctor, addr 0xf262a8, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> sha1Hash);

  /// @brief Method .ctor, addr 0xf26030, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* sha1Hash);

  /// @brief Method get_HashAlgorithm, addr 0xf2636c, size 0xa4, virtual false, abstract: false, final false
