...
public:
  ...
  /// @brief Method GetCerts, addr 0x2320120, size 0x120, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> GetCerts();

  /// @brief Method GetInstance, addr 0x231fa8c, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate* GetInstance(::System::Object* obj);

  /// @brief Method GetPolicies, addr 0x2320240, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2320368, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231fdc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> certs);

  /// @brief Method .ctor, addr 0x231fdd0, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> certs,
                    ::ArrayW<::Org::BouncyCastle::Asn1::X509::PolicyInformation*, ::Array<::Org::BouncyCastle::Asn1::X509::PolicyInformation*>*> policies);
  ...
  /// @brief Method .ctor, addr 0x231febc, size 0x264, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs, ::System::Collections::IEnumerable* policies);

  /// @brief Method .ctor, addr 0x231fc08, size 0x1c0, virtual false, abstract: false, final false
