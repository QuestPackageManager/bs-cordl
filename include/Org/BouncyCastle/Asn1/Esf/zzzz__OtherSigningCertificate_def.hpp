...
public:
  ...
  /// @brief Method GetInstance, addr 0xebfb5c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xebfce4, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xebfeb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xebfebc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> certs,
                    ::ArrayW<::Org::BouncyCastle::Asn1::X509::PolicyInformation*, ::Array<::Org::BouncyCastle::Asn1::X509::PolicyInformation*>*> policies);

  static inline ::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate* New_ctor(::System::Collections::IEnumerable* certs);

  /// @brief Method .ctor, addr 0xebffb0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xebffb8, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs, ::System::Collections::IEnumerable* policies);

  /// @brief Method GetCerts, addr 0xec0234, size 0x120, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> GetCerts();

  /// @brief Method GetPolicies, addr 0xec0354, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xec047c, size 0x148, virtual true, abstract: false, final false
