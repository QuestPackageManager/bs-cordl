...
public:
  ...
  /// @brief Method GetCerts, addr 0x10f4bb0, size 0x120, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> GetCerts();

  /// @brief Method GetInstance, addr 0x10f44d8, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::OtherSigningCertificate* GetInstance(::System::Object* obj);

  /// @brief Method GetPolicies, addr 0x10f4cd0, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f4df8, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f4830, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> certs);

  /// @brief Method .ctor, addr 0x10f4838, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> certs,
                    ::ArrayW<::Org::BouncyCastle::Asn1::X509::PolicyInformation*, ::Array<::Org::BouncyCastle::Asn1::X509::PolicyInformation*>*> policies);

  /// @brief Method .ctor, addr 0x10f492c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs);

  /// @brief Method .ctor, addr 0x10f4934, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* certs, ::System::Collections::IEnumerable* policies);

  /// @brief Method .ctor, addr 0x10f4660, size 0x1d0, virtual false, abstract: false, final false
