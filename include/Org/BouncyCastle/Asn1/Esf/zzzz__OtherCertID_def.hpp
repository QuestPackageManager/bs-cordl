...
public:
  ...
  /// @brief Method GetInstance, addr 0x327561c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x32798ec, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327987c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* otherCertHash);

  /// @brief Method .ctor, addr 0x3279884, size 0x58, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* otherCertHash, ::Org::BouncyCastle::Asn1::X509::IssuerSerial* issuerSerial);

  /// @brief Method .ctor, addr 0x32796c8, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_IssuerSerial, addr 0x32798e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::IssuerSerial* get_IssuerSerial();

  /// @brief Method get_OtherCertHash, addr 0x32798dc, size 0x8, virtual false, abstract: false, final false
