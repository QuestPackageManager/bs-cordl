...
public:
  ...
  /// @brief Method .ctor, addr 0x3370150, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CommitmentTypeIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CommitmentTypeIdentifier(CommitmentTypeIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CommitmentTypeIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CommitmentTypeIdentifier(CommitmentTypeIdentifierconst&) = delete;
