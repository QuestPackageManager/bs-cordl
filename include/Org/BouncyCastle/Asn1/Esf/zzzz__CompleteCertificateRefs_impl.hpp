...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs* (*)(::System::Object*)>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::GetInstance)> {
  constexpr static std::size_t size = 0x184;
  constexpr static std::size_t addrs = 0x32b24b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::*)(::Org::BouncyCastle::Asn1::Asn1Sequence*)>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::_ctor)> {
  constexpr static std::size_t size = 0x318;
  constexpr static std::size_t addrs = 0x32b2634;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::*)(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*>)>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::_ctor)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x32b2ad0;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::*)(::System::Collections::IEnumerable*)>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::_ctor)> {
  constexpr static std::size_t size = 0x188;
  constexpr static std::size_t addrs = 0x32b2b84;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> (::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::*)()>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::GetOtherCertIDs)> {
  constexpr static std::size_t size = 0x124;
  constexpr static std::size_t addrs = 0x32b2d0c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1Object* (::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::*)()>(&::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::ToAsn1Object)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x32b2e30;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___otherCertIDs)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::GetOtherCertIDs()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs*>::get(),
                        "GetOtherCertIDs",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*>, false>(this, ___internal_method);
}
...
inline ::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs* Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs::New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*,::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*>  otherCertIDs)  {
