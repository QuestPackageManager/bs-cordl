...
public:
  ...
  /// @brief Method GetInstance, addr 0x231bf6c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x231d0d4, size 0x12c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231d044, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* crlHash);

  /// @brief Method .ctor, addr 0x231d04c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* crlHash, ::Org::BouncyCastle::Asn1::Esf::CrlIdentifier* crlIdentifier);

  /// @brief Method .ctor, addr 0x231cd6c, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlHash, addr 0x231d0c4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OtherHash* get_CrlHash();

  /// @brief Method get_CrlIdentifier, addr 0x231d0cc, size 0x8, virtual false, abstract: false, final false
