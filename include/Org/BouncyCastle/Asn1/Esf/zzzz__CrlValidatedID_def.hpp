...
public:
  ...
  /// @brief Method GetInstance, addr 0x110237c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x110355c, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11034c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* crlHash);

  /// @brief Method .ctor, addr 0x11034d0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OtherHash* crlHash, ::Org::BouncyCastle::Asn1::Esf::CrlIdentifier* crlIdentifier);

  /// @brief Method .ctor, addr 0x11031d8, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_CrlHash, addr 0x110354c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OtherHash* get_CrlHash();

  /// @brief Method get_CrlIdentifier, addr 0x1103554, size 0x8, virtual false, abstract: false, final false
