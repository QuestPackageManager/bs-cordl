...
public:
  ...
  /// @brief Method GetCrlOcspRefs, addr 0x336fb4c, size 0x124, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*> GetCrlOcspRefs();

  /// @brief Method GetInstance, addr 0x336f2f0, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x336fc70, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x336f910, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*> crlOcspRefs);

  /// @brief Method .ctor, addr 0x336f9c4, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* crlOcspRefs);

  /// @brief Method .ctor, addr 0x336f474, size 0x318, virtual false, abstract: false, final false
