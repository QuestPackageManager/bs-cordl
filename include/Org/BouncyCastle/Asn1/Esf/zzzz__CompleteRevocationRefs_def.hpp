...
public:
  ...
  /// @brief Method GetCrlOcspRefs, addr 0x231b1f8, size 0x120, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*>*> GetCrlOcspRefs();

  /// @brief Method GetInstance, addr 0x231a96c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x231b318, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231afac, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*, ::Array<::Org::BouncyCastle::Asn1::Esf::CrlOcspRef*>*> crlOcspRefs);

  /// @brief Method .ctor, addr 0x231b064, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* crlOcspRefs);

  /// @brief Method .ctor, addr 0x231aae8, size 0x348, virtual false, abstract: false, final false
