...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f2634, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f2e08, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f2d74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Esf::OcspIdentifier* ocspIdentifier);

  /// @brief Method .ctor, addr 0x10f2d7c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f2bac, size 0x1c8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_OcspIdentifier, addr 0x10f2df8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OcspIdentifier* get_OcspIdentifier();

  /// @brief Method get_OcspRepHash, addr 0x10f2e00, size 0x8, virtual false, abstract: false, final false
