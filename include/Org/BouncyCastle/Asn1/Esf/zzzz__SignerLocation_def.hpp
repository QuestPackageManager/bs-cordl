...
public:
  ...
  /// @brief Method GetInstance, addr 0xf2a63c, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::SignerLocation* GetInstance(::System::Object* obj);

  /// @brief Method GetPostal, addr 0xf2a6f0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf2a900, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf2a5e8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf2a55c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf2a4b4, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* countryName, ::Org::BouncyCastle::Asn1::X500::DirectoryString* localityName,
                    ::Org::BouncyCastle::Asn1::Asn1Sequence* postalAddress);

  /// @brief Method .ctor, addr 0xf2a0b8, size 0x3fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Country, addr 0xf2a6e0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Country();

  /// @brief Method get_CountryName, addr 0xf2a7f0, size 0x84, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_CountryName();

  /// @brief Method get_Locality, addr 0xf2a6e8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Locality();

  /// @brief Method get_LocalityName, addr 0xf2a874, size 0x84, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_LocalityName();

  /// @brief Method get_PostalAddress, addr 0xf2a8f8, size 0x8, virtual false, abstract: false, final false
