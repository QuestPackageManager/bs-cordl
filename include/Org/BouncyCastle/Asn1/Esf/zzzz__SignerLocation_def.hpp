...
public:
  ...
  /// @brief Method GetInstance, addr 0x10f78e4, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::SignerLocation* GetInstance(::System::Object* obj);

  /// @brief Method GetPostal, addr 0x10f7998, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f7ba8, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f7890, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f7804, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f775c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* countryName, ::Org::BouncyCastle::Asn1::X500::DirectoryString* localityName,
                    ::Org::BouncyCastle::Asn1::Asn1Sequence* postalAddress);

  /// @brief Method .ctor, addr 0x10f7360, size 0x3fc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Country, addr 0x10f7988, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Country();

  /// @brief Method get_CountryName, addr 0x10f7a98, size 0x84, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_CountryName();

  /// @brief Method get_Locality, addr 0x10f7990, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Locality();

  /// @brief Method get_LocalityName, addr 0x10f7b1c, size 0x84, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_LocalityName();

  /// @brief Method get_PostalAddress, addr 0x10f7ba0, size 0x8, virtual false, abstract: false, final false
