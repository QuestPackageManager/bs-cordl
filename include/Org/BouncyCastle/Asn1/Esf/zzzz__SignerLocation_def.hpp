...
public:
  ...
  /// @brief Method GetInstance, addr 0x23254b0, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::SignerLocation* GetInstance(::System::Object* obj);

  /// @brief Method GetPostal, addr 0x2325564, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2325754, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x232545c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23253d8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2325334, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X500::DirectoryString* countryName, ::Org::BouncyCastle::Asn1::X500::DirectoryString* localityName,
                    ::Org::BouncyCastle::Asn1::Asn1Sequence* postalAddress);

  /// @brief Method .ctor, addr 0x2324f48, size 0x3ec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Country, addr 0x2325554, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Country();

  /// @brief Method get_CountryName, addr 0x2325664, size 0x74, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_CountryName();

  /// @brief Method get_Locality, addr 0x232555c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_Locality();

  /// @brief Method get_LocalityName, addr 0x23256d8, size 0x74, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerUtf8String* get_LocalityName();

  /// @brief Method get_PostalAddress, addr 0x232574c, size 0x8, virtual false, abstract: false, final false
