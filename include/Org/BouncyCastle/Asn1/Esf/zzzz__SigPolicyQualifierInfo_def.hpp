...
public:
  ...
  /// @brief Method GetInstance, addr 0x2329cc0, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x232b1b4, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x232af5c, size 0x200, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x232b15c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SigPolicyQualifierId, addr 0x232b1a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_SigPolicyQualifierId();

  /// @brief Method get_SigQualifier, addr 0x232b1ac, size 0x8, virtual false, abstract: false, final false
