...
public:
  ...
  /// @brief Method GetInstance, addr 0x23250c0, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId* GetInstance(::System::Object* obj);

  /// @brief Method GetSigPolicyQualifiers, addr 0x23257ec, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2325a7c, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x232523c, size 0x2d4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x2325510, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2325518, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* sigPolicyIdentifier, ::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* sigPolicyHash,
                    ::ArrayW<::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo*, ::Array<::Org::BouncyCastle::Asn1::Esf::SigPolicyQualifierInfo*>*> sigPolicyQualifiers);

  /// @brief Method .ctor, addr 0x232560c, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* sigPolicyIdentifier, ::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* sigPolicyHash,
                    ::System::Collections::IEnumerable* sigPolicyQualifiers);

  /// @brief Method get_SigPolicyHash, addr 0x23257e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Esf::OtherHashAlgAndValue* get_SigPolicyHash();

  /// @brief Method get_SigPolicyIdentifier, addr 0x23257dc, size 0x8, virtual false, abstract: false, final false
