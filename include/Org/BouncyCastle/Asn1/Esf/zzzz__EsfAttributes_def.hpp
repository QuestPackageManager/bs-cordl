...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Esf::EsfAttributes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Esf::EsfAttributes*, "Org.BouncyCastle.Asn1.Esf", "EsfAttributes");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3374008, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EsfAttributes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EsfAttributes(EsfAttributes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EsfAttributes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EsfAttributes(EsfAttributesconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Esf::EsfAttributes) == 0x10, "Size mismatch!");
