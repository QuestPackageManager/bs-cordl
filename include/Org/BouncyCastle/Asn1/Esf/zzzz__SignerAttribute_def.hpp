...
public:
  ...
  /// @brief Method GetInstance, addr 0xf29c90, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0xf29fb8, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf29f80, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* certifiedAttributes);

  /// @brief Method .ctor, addr 0xf29f58, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* claimedAttributes);

  /// @brief Method .ctor, addr 0xf29de4, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj);

  /// @brief Method get_CertifiedAttributes, addr 0xf29fb0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* get_CertifiedAttributes();

  /// @brief Method get_ClaimedAttributes, addr 0xf29fa8, size 0x8, virtual true, abstract: false, final false
