...
public:
  ...
  /// @brief Method GetInstance, addr 0x3376be4, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3376ec8, size 0x100, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3376eb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* certifiedAttributes);

  /// @brief Method .ctor, addr 0x3376ea8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* claimedAttributes);

  /// @brief Method .ctor, addr 0x3376d34, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj);

  /// @brief Method get_CertifiedAttributes, addr 0x3376ec0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* get_CertifiedAttributes();

  /// @brief Method get_ClaimedAttributes, addr 0x3376eb8, size 0x8, virtual true, abstract: false, final false
