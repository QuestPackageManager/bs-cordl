...
public:
  ...
  /// @brief Method GetInstance, addr 0x2325eac, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23261c8, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2326190, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificate* certifiedAttributes);

  /// @brief Method .ctor, addr 0x2326168, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* claimedAttributes);

  /// @brief Method .ctor, addr 0x2325ff8, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* obj);

  /// @brief Method get_CertifiedAttributes, addr 0x23261c0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* get_CertifiedAttributes();

  /// @brief Method get_ClaimedAttributes, addr 0x23261b8, size 0x8, virtual true, abstract: false, final false
