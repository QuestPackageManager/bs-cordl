...
public:
  ...
  /// @brief Method GetInstance, addr 0x231c6f4, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Esf::CompleteCertificateRefs* GetInstance(::System::Object* obj);

  /// @brief Method GetOtherCertIDs, addr 0x231cf80, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x231d0a0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231cd34, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Esf::OtherCertID*, ::Array<::Org::BouncyCastle::Asn1::Esf::OtherCertID*>*> otherCertIDs);

  /// @brief Method .ctor, addr 0x231cdec, size 0x194, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* otherCertIDs);

  /// @brief Method .ctor, addr 0x231c870, size 0x348, virtual false, abstract: false, final false
