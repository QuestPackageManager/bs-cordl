...
public:
  ...
  /// @brief Method BuildObject, addr 0x3585fc8, size 0x480, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* BuildObject(int32_t tag, int32_t tagNo, int32_t length);

  /// @brief Method CreateDerSequence, addr 0x3587988, size 0x84, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreateDerSet, addr 0x3587a9c, size 0x88, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSet* CreateDerSet(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreatePrimitiveDerObject, addr 0x3586e94, size 0x5f4, virtual false, abstract: false, final false
  ...
  /// @brief Method FindLimit, addr 0x3585d64, size 0x140, virtual false, abstract: false, final false
  static inline int32_t FindLimit(::System::IO::Stream* input);

  /// @brief Method GetBmpCharBuffer, addr 0x35888dc, size 0x338, virtual false, abstract: false, final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> GetBmpCharBuffer(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* defIn);

  /// @brief Method GetBuffer, addr 0x35884c8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLength, addr 0x3587cec, size 0x2b0, virtual false, abstract: false, final false
  static inline int32_t ReadLength(::System::IO::Stream* s, int32_t limit, bool isParsing);

  /// @brief Method ReadObject, addr 0x3587580, size 0x408, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadObject();

  /// @brief Method ReadTagNumber, addr 0x3587bcc, size 0x120, virtual false, abstract: false, final false
  static inline int32_t ReadTagNumber(::System::IO::Stream* s, int32_t tag);

  /// @brief Method ReadVector, addr 0x3587488, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3585f48, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0x3585ea4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method .ctor, addr 0x3585ed4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream, int32_t limit);

  /// @brief Method get_Limit, addr 0x35884c0, size 0x8, virtual true, abstract: false, final false
