...
public:
  ...
  /// @brief Method FindLimit, addr 0x11e0ecc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e1000, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e1030, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e10a0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method BuildObject, addr 0x11e1120, size 0x490, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* BuildObject(int32_t tag, int32_t tagNo, int32_t length);

  /// @brief Method ReadVector, addr 0x11e25f4, size 0xf0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* ReadVector(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreateDerSequence, addr 0x11e2b5c, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreateDerSet, addr 0x11e2c68, size 0x84, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSet* CreateDerSet(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method ReadObject, addr 0x11e26e4, size 0x478, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadObject();

  /// @brief Method get_Limit, addr 0x11e3788, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Limit();

  /// @brief Method ReadTagNumber, addr 0x11e2d88, size 0x100, virtual false, abstract: false, final false
  static inline int32_t ReadTagNumber(::System::IO::Stream* s, int32_t tag);

  /// @brief Method ReadLength, addr 0x11e2e88, size 0x2f0, virtual false, abstract: false, final false
  static inline int32_t ReadLength(::System::IO::Stream* s, int32_t limit, bool isParsing);

  /// @brief Method GetBuffer, addr 0x11e3790, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBmpCharBuffer, addr 0x11e3c1c, size 0x310, virtual false, abstract: false, final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> GetBmpCharBuffer(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* defIn);

  /// @brief Method CreatePrimitiveDerObject, addr 0x11e2030, size 0x5c4, virtual false, abstract: false, final false
