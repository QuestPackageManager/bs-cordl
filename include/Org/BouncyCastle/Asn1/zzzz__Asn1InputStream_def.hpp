...
public:
  ...
  /// @brief Method BuildObject, addr 0x1426604, size 0x490, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* BuildObject(int32_t tag, int32_t tagNo, int32_t length);

  /// @brief Method CreateDerSequence, addr 0x1428040, size 0x80, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreateDerSet, addr 0x142814c, size 0x84, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSet* CreateDerSet(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreatePrimitiveDerObject, addr 0x1427514, size 0x5c4, virtual false, abstract: false, final false
  ...
  /// @brief Method FindLimit, addr 0x14263b0, size 0x134, virtual false, abstract: false, final false
  static inline int32_t FindLimit(::System::IO::Stream* input);

  /// @brief Method GetBmpCharBuffer, addr 0x1429100, size 0x310, virtual false, abstract: false, final false
  static inline ::ArrayW<char16_t, ::Array<char16_t>*> GetBmpCharBuffer(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* defIn);

  /// @brief Method GetBuffer, addr 0x1428c74, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLength, addr 0x142836c, size 0x2f0, virtual false, abstract: false, final false
  static inline int32_t ReadLength(::System::IO::Stream* s, int32_t limit, bool isParsing);

  /// @brief Method ReadObject, addr 0x1427bc8, size 0x478, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadObject();

  /// @brief Method ReadTagNumber, addr 0x142826c, size 0x100, virtual false, abstract: false, final false
  static inline int32_t ReadTagNumber(::System::IO::Stream* s, int32_t tag);

  /// @brief Method ReadVector, addr 0x1427ad8, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1426584, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method .ctor, addr 0x14264e4, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method .ctor, addr 0x1426514, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream, int32_t limit);

  /// @brief Method get_Limit, addr 0x1428c6c, size 0x8, virtual true, abstract: false, final false
