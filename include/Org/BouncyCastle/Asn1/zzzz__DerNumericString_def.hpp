...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x12334d4, size 0xa0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x12334a4, size 0x30, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x1233200, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1233110, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerNumericString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctets, addr 0x1233498, size 0xc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetOctets();

  /// @brief Method GetString, addr 0x1233490, size 0x8, virtual true, abstract: false, final false
  inline ::StringW GetString();

  /// @brief Method IsNumericString, addr 0x12333cc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1227174, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str);

  /// @brief Method .ctor, addr 0x12333c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method .ctor, addr 0x12332ec, size 0xd8, virtual false, abstract: false, final false
