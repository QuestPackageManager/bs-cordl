...
public:
  ...
  /// @brief Method .ctor, addr 0xe62824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CreateParameters, addr 0xe62834, size 0x1d4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0xe61d9c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureCurve, addr 0xe61e8c, size 0x4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method FromHex, addr 0xe61e90, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method DefineCurve, addr 0xe61f30, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method GetByName, addr 0xe6225c, size 0x80, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid, addr 0xe62430, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0xe622dc, size 0x154, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetOid(::StringW name);

  /// @brief Method GetName, addr 0xe62610, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method get_Names, addr 0xe62710, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6281c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
