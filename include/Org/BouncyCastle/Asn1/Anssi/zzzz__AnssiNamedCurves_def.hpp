...
public:
  ...
  /// @brief Method CreateParameters, addr 0x10c78b0, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10c78a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0x10c6e18, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ConfigureCurve, addr 0x10c6f08, size 0x4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* curve);

  /// @brief Method DefineCurve, addr 0x10c6fac, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method FromHex, addr 0x10c6f0c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW hex);

  /// @brief Method GetByName, addr 0x10c72d8, size 0x80, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW name);

  /// @brief Method GetByOid, addr 0x10c74ac, size 0x128, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetName, addr 0x10c768c, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetOid, addr 0x10c7358, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10c7898, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Names, addr 0x10c778c, size 0x10c, virtual false, abstract: false, final false
