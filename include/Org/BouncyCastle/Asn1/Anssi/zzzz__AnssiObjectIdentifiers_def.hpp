...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Anssi::AnssiObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Anssi::AnssiObjectIdentifiers*, "Org.BouncyCastle.Asn1.Anssi", "AnssiObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3345818, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AnssiObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AnssiObjectIdentifiers(AnssiObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AnssiObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AnssiObjectIdentifiers(AnssiObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Anssi::AnssiObjectIdentifiers) == 0x10, "Size mismatch!");
