...
public:
  ...
  /// @brief Method .ctor, addr 0x11e5608, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* outer);

  /// @brief Method ReadObject, addr 0x11e5908, size 0xf8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x11e5a60, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetInstance, addr 0x11ddc34, size 0x398, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Sequence* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0x11e4ff4, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e52c0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::Asn1Sequence* New_ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor, addr 0x11e532c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e5418, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11e550c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method GetEnumerator, addr 0x11e558c, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method get_Parser, addr 0x11e55a8, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1SequenceParser* get_Parser();

  /// @brief Method get_Item, addr 0x11e5650, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Item(int32_t index);

  /// @brief Method get_Count, addr 0x11e5680, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method ToArray, addr 0x11e569c, size 0x58, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> ToArray();

  /// @brief Method Asn1GetHashCode, addr 0x11e56f4, size 0x94, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Asn1Equals, addr 0x11e5788, size 0x174, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method ToString, addr 0x11e58fc, size 0xc, virtual true, abstract: false, final false
