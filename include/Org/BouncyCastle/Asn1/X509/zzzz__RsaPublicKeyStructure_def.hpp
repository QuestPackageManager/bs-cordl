...
public:
  ...
  /// @brief Method GetInstance, addr 0x260ecb0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x260ecc8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260f08c, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260ef50, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* modulus, ::Org::BouncyCastle::Math::BigInteger* publicExponent);

  /// @brief Method .ctor, addr 0x260ee30, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Modulus, addr 0x260f07c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus();

  /// @brief Method get_PublicExponent, addr 0x260f084, size 0x8, virtual false, abstract: false, final false
