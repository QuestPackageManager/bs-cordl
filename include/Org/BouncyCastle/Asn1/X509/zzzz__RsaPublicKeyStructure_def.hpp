...
public:
  ...
  /// @brief Method GetInstance, addr 0x260ec70, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x260ec88, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260f04c, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260ef10, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* modulus, ::Org::BouncyCastle::Math::BigInteger* publicExponent);

  /// @brief Method .ctor, addr 0x260edf0, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Modulus, addr 0x260f03c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus();

  /// @brief Method get_PublicExponent, addr 0x260f044, size 0x8, virtual false, abstract: false, final false
