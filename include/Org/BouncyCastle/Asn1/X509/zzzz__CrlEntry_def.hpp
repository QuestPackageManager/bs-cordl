...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x26160b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2615ec0, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Extensions, addr 0x2616000, size 0xb0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_Extensions();

  /// @brief Method get_RevocationDate, addr 0x2615ff8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_RevocationDate();

  /// @brief Method get_UserCertificate, addr 0x2615ff0, size 0x8, virtual false, abstract: false, final false
