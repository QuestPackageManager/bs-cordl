...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CrlEntry", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CrlEntry(CrlEntry&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CrlEntry", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CrlEntry(CrlEntryconst&) = delete;
