...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter*, "Org.BouncyCastle.Asn1.X509", "X509NameEntryConverter");
...
public:
  // Declarations
  /// @brief Method CanBePrintable, addr 0x3669eb4, size 0xc, virtual false, abstract: false, final false
  inline bool CanBePrintable(::StringW str);

  /// @brief Method ConvertHexEncoded, addr 0x3669e30, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3669ec0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter) == 0x10, "Size mismatch!");
