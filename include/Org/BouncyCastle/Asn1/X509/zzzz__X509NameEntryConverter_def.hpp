...
public:
  // Declarations
  /// @brief Method CanBePrintable, addr 0x2614e4c, size 0xc, virtual false, abstract: false, final false
  inline bool CanBePrintable(::StringW str);

  /// @brief Method ConvertHexEncoded, addr 0x2614dd4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2614e58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
