...
public:
  // Declarations
  /// @brief Method CanBePrintable, addr 0x2616848, size 0xc, virtual false, abstract: false, final false
  inline bool CanBePrintable(::StringW str);

  /// @brief Method ConvertHexEncoded, addr 0x26167d0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2616854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
