...
public:
// Declarations
/// @brief Method CanBePrintable, addr 0x35ad9fc, size 0xc, virtual false, abstract: false, final false
inline bool CanBePrintable(::StringW  str) ;

/// @brief Method ConvertHexEncoded, addr 0x35ad978, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35ada08, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
