...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator*, "Org.BouncyCastle.Asn1.X509", "X509ExtensionsGenerator");
...
public:
  ...
  /// @brief Method AddExtension, addr 0x366faa8, size 0x280, virtual false, abstract: false, final false
  inline void AddExtension(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, bool critical, ::ArrayW<uint8_t> extValue);

  /// @brief Method AddExtension, addr 0x366f998, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Generate, addr 0x366fddc, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x366f92c, size 0x6c, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x366fe40, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsEmpty, addr 0x366fd28, size 0xb4, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509ExtensionsGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509ExtensionsGenerator(X509ExtensionsGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509ExtensionsGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509ExtensionsGenerator(X509ExtensionsGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator) == 0x20, "Size mismatch!");
