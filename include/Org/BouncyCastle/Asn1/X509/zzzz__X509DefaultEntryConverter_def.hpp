...
public:
  // Declarations
  /// @brief Method GetConvertedValue, addr 0x1407938, size 0x398, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1407cd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
