...
public:
  // Declarations
  /// @brief Method GetConvertedValue, addr 0x3669ec4, size 0x384, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366a248, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
