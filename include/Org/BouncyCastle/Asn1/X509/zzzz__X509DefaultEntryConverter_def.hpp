...
public:
  // Declarations
  /// @brief Method GetConvertedValue, addr 0x2614e60, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26151e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
