...
public:
  // Declarations
  /// @brief Method GetConvertedValue, addr 0x2616194, size 0x380, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2616514, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
