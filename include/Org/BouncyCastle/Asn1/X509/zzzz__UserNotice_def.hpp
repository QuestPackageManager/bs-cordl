...
/// @brief Method GetInstance, addr 0x35aaa30, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x35aaae0, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35aa7d4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35aa7dc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::NoticeReference*  noticeRef, ::StringW  str) ;

/// @brief Method .ctor, addr 0x35aa848, size 0x1e8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_ExplicitText, addr 0x35aaad8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::DisplayText* get_ExplicitText() ;

/// @brief Method get_NoticeRef, addr 0x35aaad0, size 0x8, virtual true, abstract: false, final false
