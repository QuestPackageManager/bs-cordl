...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::UserNotice*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::UserNotice*, "Org.BouncyCastle.Asn1.X509", "UserNotice");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3666ee8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3666f98, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3666c8c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3666c94, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::NoticeReference* noticeRef, ::StringW str);

  /// @brief Method .ctor, addr 0x3666d00, size 0x1e8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ExplicitText, addr 0x3666f90, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DisplayText* get_ExplicitText();

  /// @brief Method get_NoticeRef, addr 0x3666f88, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::UserNotice) == 0x20, "Size mismatch!");
