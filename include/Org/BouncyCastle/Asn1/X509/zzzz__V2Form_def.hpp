...
public:
  ...
  /// @brief Method GetInstance, addr 0x2614288, size 0x18, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::V2Form* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x26142a0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x261464c, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x261456c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuerName);

  /// @brief Method .ctor, addr 0x26145d4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2614598, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuerName, ::Org::BouncyCastle::Asn1::X509::IssuerSerial* baseCertificateID,
                    ::Org::BouncyCastle::Asn1::X509::ObjectDigestInfo* objectDigestInfo);

  /// @brief Method .ctor, addr 0x2614604, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2614344, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_BaseCertificateID, addr 0x261463c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::IssuerSerial* get_BaseCertificateID();

  /// @brief Method get_IssuerName, addr 0x2614634, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_IssuerName();

  /// @brief Method get_ObjectDigestInfo, addr 0x2614644, size 0x8, virtual false, abstract: false, final false
