...
public:
  ...
  /// @brief Method ToString, addr 0x359ade0, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x359ad60, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* reason);

  /// @brief Method .ctor, addr 0x359acf4, size 0x6c, virtual false, abstract: false, final false
