...
public:
  ...
  /// @brief Method ToString, addr 0x13ed954, size 0xcc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x13ed8e0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* reason);

  /// @brief Method .ctor, addr 0x13ed878, size 0x68, virtual false, abstract: false, final false
