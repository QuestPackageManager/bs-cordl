...
public:
  ...
  /// @brief Method .ctor, addr 0x11b8efc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11b8f64, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated* reason);

  /// @brief Method ToString, addr 0x11b8fd8, size 0xcc, virtual true, abstract: false, final false
