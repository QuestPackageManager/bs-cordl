...
public:
  ...
  /// @brief Method CreateSequence, addr 0x260bde8, size 0x2ac, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateSequence(::System::Collections::IList* subtrees);

  /// @brief Method GetInstance, addr 0x260b8e4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260c0a4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260bd9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* permitted, ::System::Collections::ArrayList* excluded);

  /// @brief Method .ctor, addr 0x260bda0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* permitted, ::System::Collections::IList* excluded);

  /// @brief Method .ctor, addr 0x260ba60, size 0x33c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ExcludedSubtrees, addr 0x260c09c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_ExcludedSubtrees();

  /// @brief Method get_PermittedSubtrees, addr 0x260c094, size 0x8, virtual false, abstract: false, final false
