...
public:
  ...
  /// @brief Method FromExtensions, addr 0x2602664, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllUsages, addr 0x2602e30, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetAllUsages();

  /// @brief Method GetInstance, addr 0x2602078, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2602090, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::ExtendedKeyUsage* GetInstance(::System::Object* obj);

  /// @brief Method GetUsages, addr 0x2602d50, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* GetUsages();

  /// @brief Method HasKeyPurposeId, addr 0x2602ca4, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2602fb0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2602280, size 0x3e4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x26026d8, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::KeyPurposeID*, ::Array<::Org::BouncyCastle::Asn1::X509::KeyPurposeID*>*> usages);

  /// @brief Method .ctor, addr 0x2602844, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* usages);

  /// @brief Method .ctor, addr 0x2602848, size 0x45c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerable* usages);

  /// @brief Method get_Count, addr 0x2602f0c, size 0xa4, virtual false, abstract: false, final false
