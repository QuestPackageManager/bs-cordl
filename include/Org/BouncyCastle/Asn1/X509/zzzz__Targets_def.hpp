...
public:
  ...
  /// @brief Method GetInstance, addr 0x122e6b4, size 0x18c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::Targets* GetInstance(::System::Object* obj);

  /// @brief Method GetTargets, addr 0x122e9d8, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x122eae8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122e92c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*, ::Array<::Org::BouncyCastle::Asn1::X509::Target*>*> targets);

  /// @brief Method .ctor, addr 0x122e9b0, size 0x28, virtual false, abstract: false, final false
