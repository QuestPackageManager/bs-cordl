...
public:
  ...
  /// @brief Method Equivalent, addr 0x2618be8, size 0x5cc, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Extensions* other);

  /// @brief Method GetCriticalExtensionOids, addr 0x2619864, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtension, addr 0x2616d70, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtension, addr 0x2615d84, size 0xf4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extension* GetExtension(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetExtensionOids, addr 0x26191b4, size 0x58, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, ::Array<::Org::BouncyCastle::Asn1::DerObjectIdentifier*>*> GetExtensionOids();

  /// @brief Method GetExtensionOids, addr 0x2619344, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtensionParsedValue, addr 0x26040ac, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExtensionParsedValue, addr 0x2616d7c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetExtensionParsedValue(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetInstance, addr 0x2616d98, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2611f24, size 0x1e0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetInstance(::System::Object* obj);

  /// @brief Method GetNonCriticalExtensionOids, addr 0x261933c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Oids, addr 0x26184f8, size 0xa8, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Oids();

  /// @brief Method ToAsn1Object, addr 0x2618600, size 0x5e8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToOidArray, addr 0x261920c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2617b60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* extensions);

  /// @brief Method .ctor, addr 0x26175e8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* extensions);

  /// @brief Method .ctor, addr 0x2618044, size 0x4b4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* oids, ::System::Collections::ArrayList* values);

  /// @brief Method .ctor, addr 0x261501c, size 0x50c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* oids, ::System::Collections::IList* values);

  /// @brief Method .ctor, addr 0x2617b6c, size 0x4d8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* ordering, ::System::Collections::Hashtable* extensions);

  /// @brief Method .ctor, addr 0x26175f4, size 0x56c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* ordering, ::System::Collections::IDictionary* extensions);

  /// @brief Method .ctor, addr 0x2616e10, size 0x7d8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ExtensionOids, addr 0x26185a0, size 0x60, virtual false, abstract: false, final false
