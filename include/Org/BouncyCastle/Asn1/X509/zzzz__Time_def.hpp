...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a94a0, size 0x28, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::Time* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x35a826c, size 0x1d0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::Time* GetInstance(::System::Object* obj);

  /// @brief Method GetTime, addr 0x35a97a0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a9a2c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToDateTime, addr 0x35a9870, size 0x1bc, virtual false, abstract: false, final false
  inline ::System::DateTime ToDateTime();

  /// @brief Method ToString, addr 0x35a9a34, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a9604, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::System::DateTime date);

  /// @brief Method .ctor, addr 0x35a94c8, size 0x13c, virtual false, abstract: false, final false
