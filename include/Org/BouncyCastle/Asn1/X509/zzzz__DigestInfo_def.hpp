...
public:
  ...
  /// @brief Method GetDigest, addr 0x355edf0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDigest();

  /// @brief Method GetInstance, addr 0x355eb5c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x355eb70, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x355edf8, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355ede0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<uint8_t, ::Array<uint8_t>*> digest);

  /// @brief Method .ctor, addr 0x355ecf4, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmID, addr 0x355ede8, size 0x8, virtual false, abstract: false, final false
