...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a5da8, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a62c4, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a6250, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* attributes);

  /// @brief Method .ctor, addr 0x35a6254, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* attributes);

  /// @brief Method .ctor, addr 0x35a5f2c, size 0x324, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Attributes, addr 0x35a6590, size 0x64, virtual false, abstract: false, final false
