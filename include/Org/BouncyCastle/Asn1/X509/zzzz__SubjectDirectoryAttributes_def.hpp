...
public:
  ...
  /// @brief Method GetInstance, addr 0x3569814, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3569d30, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3569cbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* attributes);

  /// @brief Method .ctor, addr 0x3569cc0, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* attributes);

  /// @brief Method .ctor, addr 0x3569998, size 0x324, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Attributes, addr 0x3569ffc, size 0x64, virtual false, abstract: false, final false
