...
public:
  ...
  /// @brief Method GetInstance, addr 0x260f218, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260f770, size 0x2c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260f6f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* attributes);

  /// @brief Method .ctor, addr 0x260f6f8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* attributes);

  /// @brief Method .ctor, addr 0x260f394, size 0x360, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Attributes, addr 0x260fa34, size 0x60, virtual false, abstract: false, final false
