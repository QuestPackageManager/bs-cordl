...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes*, "Org.BouncyCastle.Asn1.X509", "SubjectDirectoryAttributes");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3665384, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x36658a0, size 0x2cc, virtual true, abstract: false, final false
  ...
  /// [Obsolete]
  /// @brief Method .ctor, addr 0x366582c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::ArrayList* attributes);

  /// @brief Method .ctor, addr 0x3665830, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* attributes);

  /// @brief Method .ctor, addr 0x3665508, size 0x324, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Attributes, addr 0x3665b6c, size 0x64, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubjectDirectoryAttributes", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubjectDirectoryAttributes(SubjectDirectoryAttributes&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubjectDirectoryAttributes", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubjectDirectoryAttributes(SubjectDirectoryAttributesconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes) == 0x18, "Size mismatch!");
