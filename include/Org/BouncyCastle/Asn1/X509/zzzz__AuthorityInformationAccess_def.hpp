...
public:
  ...
  __declspec(
      property(get = __cordl_internal_get_descriptions,
               put = __cordl_internal_set_descriptions))::ArrayW<::Org::BouncyCastle::Asn1::X509::AccessDescription*, ::Array<::Org::BouncyCastle::Asn1::X509::AccessDescription*>*> descriptions;

  /// @brief Method Copy, addr 0x10f72a4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method FromExtensions, addr 0x10f7588, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAccessDescriptions, addr 0x10f7740, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x10f731c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x10f7748, size 0x68, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x10f77b0, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f75f0, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AccessDescription* description);

  /// @brief Method .ctor, addr 0x10f7698, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f76c8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::X509::GeneralName* location);

  /// @brief Method .ctor, addr 0x10f73c0, size 0x1c8, virtual false, abstract: false, final false
