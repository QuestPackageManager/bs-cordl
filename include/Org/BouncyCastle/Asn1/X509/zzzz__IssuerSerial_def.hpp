...
public:
  ...
  /// @brief Method GetInstance, addr 0x11bedcc, size 0x188, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::IssuerSerial* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance, addr 0x11be090, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bef54, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bf114, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuer, ::Org::BouncyCastle::Asn1::DerInteger* serial);

  /// @brief Method get_Issuer, addr 0x11bf140, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_Issuer();

  /// @brief Method get_Serial, addr 0x11bf148, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerInteger* get_Serial();

  /// @brief Method get_IssuerUid, addr 0x11bf150, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUid();

  /// @brief Method ToAsn1Object, addr 0x11bf158, size 0x174, virtual true, abstract: false, final false
