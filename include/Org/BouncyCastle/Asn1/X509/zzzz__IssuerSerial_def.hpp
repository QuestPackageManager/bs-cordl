...
public:
  ...
  /// @brief Method GetInstance, addr 0x25c8720, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x25c9438, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x25c97b0, size 0x170, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c976c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* issuer, ::Org::BouncyCastle::Asn1::DerInteger* serial);

  /// @brief Method .ctor, addr 0x25c95b4, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Issuer, addr 0x25c9798, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_Issuer();

  /// @brief Method get_IssuerUid, addr 0x25c97a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUid();

  /// @brief Method get_Serial, addr 0x25c97a0, size 0x8, virtual false, abstract: false, final false
