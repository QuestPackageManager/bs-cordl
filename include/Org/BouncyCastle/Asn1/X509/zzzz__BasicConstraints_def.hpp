...
public:
  ...
  /// @brief Method FromExtensions, addr 0x2507d9c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2507adc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2507af4, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::BasicConstraints* GetInstance(::System::Object* obj);

  /// @brief Method IsCA, addr 0x2507f20, size 0x14, virtual false, abstract: false, final false
  inline bool IsCA();
  ...
  /// @brief Method ToAsn1Object, addr 0x2507f48, size 0x134, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x250807c, size 0x1fc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2507e04, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(bool cA);

  /// @brief Method .ctor, addr 0x2507e78, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(int32_t pathLenConstraint);

  /// @brief Method .ctor, addr 0x2507be4, size 0x1b8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PathLenConstraint, addr 0x2507f34, size 0x14, virtual false, abstract: false, final false
