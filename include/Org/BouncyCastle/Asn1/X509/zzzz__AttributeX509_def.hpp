...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::AttributeX509*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::AttributeX509*, "Org.BouncyCastle.Asn1.X509", "AttributeX509");
...
public:
  ...
  /// @brief Method GetAttributeValues, addr 0x354bdb4, size 0x20, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*> GetAttributeValues();

  /// @brief Method GetInstance, addr 0x354b8ec, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x354bddc, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x354bda4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* attrType, ::Org::BouncyCastle::Asn1::Asn1Set* attrValues);

  /// @brief Method .ctor, addr 0x354ba70, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AttrType, addr 0x354bdac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AttrType();

  /// @brief Method get_AttrValues, addr 0x354bdd4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttributeX509", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttributeX509(AttributeX509&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttributeX509", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttributeX509(AttributeX509const&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::AttributeX509) == 0x20, "Size mismatch!");
