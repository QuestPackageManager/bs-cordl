#pragma once
// IWYU pragma private; include "Org/BouncyCastle/Asn1/X509/X509ObjectIdentifiers.hpp"
...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::X509ObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::X509ObjectIdentifiers*, "Org.BouncyCastle.Asn1.X509", "X509ObjectIdentifiers");
...
public:
  ...
  __declspec(property(get = getStaticF_CommonName, put = setStaticF_CommonName)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* CommonName;

  /// @brief Field CountryName, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_CountryName, put = setStaticF_CountryName)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* CountryName;

  /// @brief Field CrlAccessMethod, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_CrlAccessMethod, put = setStaticF_CrlAccessMethod)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* CrlAccessMethod;

  /// @brief Field IdAD, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_IdAD, put = setStaticF_IdAD)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* IdAD;
  ...
  __declspec(property(get = getStaticF_IdEARsa, put = setStaticF_IdEARsa)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* IdEARsa;

  /// @brief Field IdPE, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_IdPE, put = setStaticF_IdPE)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* IdPE;

  /// @brief Field IdPkix, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_IdPkix, put = setStaticF_IdPkix)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* IdPkix;
  ...
  __declspec(property(get = getStaticF_LocalityName, put = setStaticF_LocalityName)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* LocalityName;

  /// @brief Field OcspAccessMethod, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_OcspAccessMethod, put = setStaticF_OcspAccessMethod)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* OcspAccessMethod;

  /// @brief Field Organization, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_Organization, put = setStaticF_Organization)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* Organization;

  /// @brief Field OrganizationalUnitName, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_OrganizationalUnitName, put = setStaticF_OrganizationalUnitName)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* OrganizationalUnitName;

  /// @brief Field RipeMD160, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_RipeMD160, put = setStaticF_RipeMD160)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* RipeMD160;

  /// @brief Field RipeMD160WithRsaEncryption, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_RipeMD160WithRsaEncryption, put = setStaticF_RipeMD160WithRsaEncryption)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* RipeMD160WithRsaEncryption;

  /// @brief Field StateOrProvinceName, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_StateOrProvinceName, put = setStaticF_StateOrProvinceName)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* StateOrProvinceName;

  /// @brief Field id_at_name, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF_id_at_name, put = setStaticF_id_at_name)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* id_at_name;
  ...
  __declspec(property(get = getStaticF_id_at_telephoneNumber, put = setStaticF_id_at_telephoneNumber)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier* id_at_telephoneNumber;

  static inline ::Org::BouncyCastle::Asn1::X509::X509ObjectIdentifiers* New_ctor();

  /// @brief Method .ctor, addr 0x36765cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509ObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509ObjectIdentifiers(X509ObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509ObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509ObjectIdentifiers(X509ObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::X509ObjectIdentifiers) == 0x10, "Size mismatch!");
