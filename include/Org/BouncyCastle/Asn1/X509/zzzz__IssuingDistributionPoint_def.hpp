...
public:
  ...
  /// @brief Method GetInstance, addr 0x260a004, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x260a01c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260a780, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x260a788, size 0x2e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a43c, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260a198, size 0x2a4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method appendObject, addr 0x260aa68, size 0xf8, virtual false, abstract: false, final false
  inline void appendObject(::System::Text::StringBuilder* buf, ::StringW sep, ::StringW name, ::StringW val);

  /// @brief Method get_DistributionPoint, addr 0x260a770, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DistributionPointName* get_DistributionPoint();

  /// @brief Method get_IsIndirectCrl, addr 0x260a760, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsIndirectCrl();

  /// @brief Method get_OnlyContainsAttributeCerts, addr 0x260a768, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsAttributeCerts();

  /// @brief Method get_OnlyContainsCACerts, addr 0x260a758, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsCACerts();

  /// @brief Method get_OnlyContainsUserCerts, addr 0x260a750, size 0x8, virtual false, abstract: false, final false
  inline bool get_OnlyContainsUserCerts();

  /// @brief Method get_OnlySomeReasons, addr 0x260a778, size 0x8, virtual false, abstract: false, final false
