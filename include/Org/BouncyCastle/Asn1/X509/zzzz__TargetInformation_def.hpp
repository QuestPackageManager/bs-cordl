...
public:
  ...
  /// @brief Method GetInstance, addr 0x26109a4, size 0x180, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetTargetsObjects, addr 0x2610b4c, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2610f2c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610e50, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*, ::Array<::Org::BouncyCastle::Asn1::X509::Target*>*> targets);

  /// @brief Method .ctor, addr 0x2610b24, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method .ctor, addr 0x2610ddc, size 0x74, virtual false, abstract: false, final false
