...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::TargetInformation*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::TargetInformation*, "Org.BouncyCastle.Asn1.X509", "TargetInformation");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3666b28, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetTargetsObjects, addr 0x3666cac, size 0x114, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::Targets*> GetTargetsObjects();

  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*> targets);
  ...
  /// @brief Method ToAsn1Object, addr 0x3667078, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3666fa4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*> targets);

  /// @brief Method .ctor, addr 0x3666ca4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method .ctor, addr 0x3666f3c, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TargetInformation", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TargetInformation(TargetInformation&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TargetInformation", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TargetInformation(TargetInformationconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::TargetInformation) == 0x18, "Size mismatch!");
