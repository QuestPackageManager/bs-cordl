...
public:
  ...
  /// @brief Method GetInstance, addr 0x1207cec, size 0x18c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetTargetsObjects, addr 0x1207ea0, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12082a4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12081b8, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*, ::Array<::Org::BouncyCastle::Asn1::X509::Target*>*> targets);

  /// @brief Method .ctor, addr 0x1207e78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method .ctor, addr 0x120813c, size 0x7c, virtual false, abstract: false, final false
