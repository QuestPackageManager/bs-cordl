...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a754c, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetTargetsObjects, addr 0x35a76d0, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a7a9c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a79c8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*, ::Array<::Org::BouncyCastle::Asn1::X509::Target*>*> targets);

  /// @brief Method .ctor, addr 0x35a76c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method .ctor, addr 0x35a7960, size 0x68, virtual false, abstract: false, final false
