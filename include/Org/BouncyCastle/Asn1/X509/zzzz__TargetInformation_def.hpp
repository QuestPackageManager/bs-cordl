...
public:
  ...
  /// @brief Method GetInstance, addr 0x3540774, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TargetInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetTargetsObjects, addr 0x35408f8, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3540cc4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3540bf0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::Target*, ::Array<::Org::BouncyCastle::Asn1::X509::Target*>*> targets);

  /// @brief Method .ctor, addr 0x35408f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* targets);

  /// @brief Method .ctor, addr 0x3540b88, size 0x68, virtual false, abstract: false, final false
