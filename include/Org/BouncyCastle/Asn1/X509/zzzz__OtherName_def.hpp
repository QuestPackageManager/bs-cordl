...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::OtherName*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::OtherName*, "Org.BouncyCastle.Asn1.X509", "OtherName");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3662cb0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3662e34, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3662d50, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x3662e1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* typeID, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_TypeID, addr 0x3662e24, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_TypeID();

  /// @brief Method get_Value, addr 0x3662e2c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OtherName", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OtherName(OtherName&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OtherName", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OtherName(OtherNameconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::OtherName) == 0x20, "Size mismatch!");
