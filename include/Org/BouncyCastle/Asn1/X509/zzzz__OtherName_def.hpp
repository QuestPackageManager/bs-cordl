...
public:
  ...
  /// @brief Method GetInstance, addr 0x2610e68, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2611008, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610f0c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x2610fcc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* typeID, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_TypeID, addr 0x2610ff8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_TypeID();

  /// @brief Method get_Value, addr 0x2611000, size 0x8, virtual false, abstract: false, final false
