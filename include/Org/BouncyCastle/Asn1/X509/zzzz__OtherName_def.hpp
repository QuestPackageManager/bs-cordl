...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a36d4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a3858, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a3774, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x35a3840, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* typeID, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method get_TypeID, addr 0x35a3848, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_TypeID();

  /// @brief Method get_Value, addr 0x35a3850, size 0x8, virtual false, abstract: false, final false
