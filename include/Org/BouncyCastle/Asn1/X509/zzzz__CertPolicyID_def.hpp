...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertPolicyID", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertPolicyID(CertPolicyID&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertPolicyID", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertPolicyID(CertPolicyIDconst&) = delete;
