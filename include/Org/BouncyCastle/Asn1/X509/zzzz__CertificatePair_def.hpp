...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificatePair", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificatePair(CertificatePair&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificatePair", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificatePair(CertificatePairconst&) = delete;
