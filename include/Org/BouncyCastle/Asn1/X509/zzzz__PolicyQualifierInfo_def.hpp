...
public:
  ...
  /// @brief Method GetInstance, addr 0x13fef6c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x13ff020, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13fed54, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::StringW cps);

  /// @brief Method .ctor, addr 0x13fed28, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13fee04, size 0x168, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyQualifierId, addr 0x13ff010, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyQualifierId();

  /// @brief Method get_Qualifier, addr 0x13ff018, size 0x8, virtual true, abstract: false, final false
