...
public:
  ...
  /// @brief Method GetInstance, addr 0x260c738, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260c7ec, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260c52c, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::StringW cps);

  /// @brief Method .ctor, addr 0x260c500, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260c5d4, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyQualifierId, addr 0x260c7dc, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyQualifierId();

  /// @brief Method get_Qualifier, addr 0x260c7e4, size 0x8, virtual true, abstract: false, final false
