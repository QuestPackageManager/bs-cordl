...
public:
  ...
  /// @brief Method GetInstance, addr 0x35a4634, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a46e4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a4434, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW cps);

  /// @brief Method .ctor, addr 0x35a442c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a44d8, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyQualifierId, addr 0x35a46d4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyQualifierId();

  /// @brief Method get_Qualifier, addr 0x35a46dc, size 0x8, virtual true, abstract: false, final false
