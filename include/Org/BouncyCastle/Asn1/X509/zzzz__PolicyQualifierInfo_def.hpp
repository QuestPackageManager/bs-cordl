...
public:
  ...
  /// @brief Method GetInstance, addr 0x3663c10, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3663cc0, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3663a10, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW cps);

  /// @brief Method .ctor, addr 0x3663a08, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3663ab4, size 0x15c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyQualifierId, addr 0x3663cb0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyQualifierId();

  /// @brief Method get_Qualifier, addr 0x3663cb8, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PolicyQualifierInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PolicyQualifierInfo(PolicyQualifierInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PolicyQualifierInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PolicyQualifierInfo(PolicyQualifierInfoconst&) = delete;
