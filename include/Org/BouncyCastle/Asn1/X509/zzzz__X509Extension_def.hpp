...
public:
  ...
  /// @brief Method ConvertValueToObject, addr 0x2605c2c, size 0x104, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* ConvertValueToObject(::Org::BouncyCastle::Asn1::X509::X509Extension* ext);

  /// @brief Method Equals, addr 0x261662c, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x26165fc, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetParsedValue, addr 0x26165f8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x261655c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBoolean* critical, ::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method .ctor, addr 0x2614964, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool critical, ::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method get_IsCritical, addr 0x26165e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCritical();

  /// @brief Method get_Value, addr 0x26165f0, size 0x8, virtual false, abstract: false, final false
