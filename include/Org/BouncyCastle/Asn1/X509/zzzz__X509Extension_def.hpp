...
public:
  ...
  /// @brief Method ConvertValueToObject, addr 0x359c9bc, size 0x108, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* ConvertValueToObject(::Org::BouncyCastle::Asn1::X509::X509Extension* ext);

  /// @brief Method Equals, addr 0x35ad0a4, size 0xc0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x35ad074, size 0x30, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetParsedValue, addr 0x35ad070, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35acff8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBoolean* critical, ::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method .ctor, addr 0x35ab44c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(bool critical, ::Org::BouncyCastle::Asn1::Asn1OctetString* value);

  /// @brief Method get_IsCritical, addr 0x35ad060, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCritical();

  /// @brief Method get_Value, addr 0x35ad068, size 0x8, virtual false, abstract: false, final false
