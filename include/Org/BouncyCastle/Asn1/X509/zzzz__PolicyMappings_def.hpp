...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x260c3e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260be04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* mappings);

  /// @brief Method .ctor, addr 0x260be08, size 0x5dc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* mappings);

  /// @brief Method .ctor, addr 0x260bddc, size 0x28, virtual false, abstract: false, final false
