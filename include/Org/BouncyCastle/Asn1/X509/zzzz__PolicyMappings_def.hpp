...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x2609ca8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26096c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* mappings);

  /// @brief Method .ctor, addr 0x26096cc, size 0x5dc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* mappings);

  /// @brief Method .ctor, addr 0x26096a0, size 0x28, virtual false, abstract: false, final false
