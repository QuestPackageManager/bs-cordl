...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x260d7a8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260d1c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* mappings);

  /// @brief Method .ctor, addr 0x260d1cc, size 0x5dc, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* mappings);

  /// @brief Method .ctor, addr 0x260d1a0, size 0x28, virtual false, abstract: false, final false
