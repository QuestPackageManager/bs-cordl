...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::PolicyMappings*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::PolicyMappings*, "Org.BouncyCastle.Asn1.X509", "PolicyMappings");
...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x36638e4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x366332c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* mappings);

  /// @brief Method .ctor, addr 0x3663330, size 0x5b4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* mappings);

  /// @brief Method .ctor, addr 0x3663324, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PolicyMappings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PolicyMappings(PolicyMappings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PolicyMappings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PolicyMappings(PolicyMappingsconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::PolicyMappings) == 0x18, "Size mismatch!");
