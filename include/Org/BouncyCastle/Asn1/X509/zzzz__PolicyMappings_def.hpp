...
public:
  ...
  /// @brief Method ToAsn1Object, addr 0x366155c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3660fa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* mappings);

  /// @brief Method .ctor, addr 0x3660fa8, size 0x5b4, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* mappings);

  /// @brief Method .ctor, addr 0x3660f9c, size 0x8, virtual false, abstract: false, final false
