...
public:
  ...
  /// @brief Method .ctor, addr 0x36638ec, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PolicyQualifierID", modifiers: "&&", def_value: None, comment: None }]
