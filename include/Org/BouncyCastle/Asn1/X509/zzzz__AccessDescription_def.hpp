...
public:
  ...
  /// @brief Method GetInstance, addr 0x10b055c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b06e4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b07fc, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid, ::Org::BouncyCastle::Asn1::X509::GeneralName* location);

  /// @brief Method get_AccessMethod, addr 0x10b0828, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AccessMethod();

  /// @brief Method get_AccessLocation, addr 0x10b0830, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_AccessLocation();

  /// @brief Method ToAsn1Object, addr 0x10b0838, size 0xf0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x10b0928, size 0x70, virtual true, abstract: false, final false
