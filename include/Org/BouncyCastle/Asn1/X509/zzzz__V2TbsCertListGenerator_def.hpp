...
public:
  ...
  /// @brief Method AddCrlEntry, addr 0x35aad1c, size 0xf4, virtual false, abstract: false, final false
  inline void AddCrlEntry(::Org::BouncyCastle::Asn1::Asn1Sequence* crlEntry);

  /// @brief Method AddCrlEntry, addr 0x35aae10, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCrlEntry, addr 0x35ab92c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCrlEntry, addr 0x35aae98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCrlEntry, addr 0x35aaea0, size 0x5ac, virtual false, abstract: false, final false
  inline void AddCrlEntry(::Org::BouncyCastle::Asn1::DerInteger* userCertificate, ::Org::BouncyCastle::Asn1::X509::Time* revocationDate, int32_t reason,
                          ::Org::BouncyCastle::Asn1::DerGeneralizedTime* invalidityDate);

  /// @brief Method GenerateTbsCertList, addr 0x35aba8c, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExtensions, addr 0x35aba84, size 0x8, virtual false, abstract: false, final false
  inline void SetExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* extensions);

  /// @brief Method SetIssuer, addr 0x35aac20, size 0x8, virtual false, abstract: false, final false
  inline void SetIssuer(::Org::BouncyCastle::Asn1::X509::X509Name* issuer);

  /// @brief Method SetNextUpdate, addr 0x35aac90, size 0x7c, virtual false, abstract: false, final false
  inline void SetNextUpdate(::Org::BouncyCastle::Asn1::DerUtcTime* nextUpdate);

  /// @brief Method SetNextUpdate, addr 0x35aad14, size 0x8, virtual false, abstract: false, final false
  inline void SetNextUpdate(::Org::BouncyCastle::Asn1::X509::Time* nextUpdate);

  /// @brief Method SetSignature, addr 0x35aac18, size 0x8, virtual false, abstract: false, final false
  inline void SetSignature(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* signature);

  /// @brief Method SetThisUpdate, addr 0x35aac28, size 0x68, virtual false, abstract: false, final false
  inline void SetThisUpdate(::Org::BouncyCastle::Asn1::DerUtcTime* thisUpdate);

  /// @brief Method SetThisUpdate, addr 0x35aad0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35aabb8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
