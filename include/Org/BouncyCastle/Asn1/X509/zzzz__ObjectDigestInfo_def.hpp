...
public:
  ...
  /// @brief Method GetInstance, addr 0x365f0e4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x366260c, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3662ae4, size 0x1cc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36629d0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3662790, size 0x240, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DigestAlgorithm, addr 0x3662ad4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm();

  /// @brief Method get_DigestedObjectType, addr 0x3662ac4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerEnumerated* get_DigestedObjectType();

  /// @brief Method get_ObjectDigest, addr 0x3662adc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerBitString* get_ObjectDigest();

  /// @brief Method get_OtherObjectTypeID, addr 0x3662acc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObjectDigestInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObjectDigestInfo(ObjectDigestInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObjectDigestInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObjectDigestInfo(ObjectDigestInfoconst&) = delete;
