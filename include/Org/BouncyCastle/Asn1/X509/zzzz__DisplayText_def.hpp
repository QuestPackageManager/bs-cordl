...
public:
  ...
  /// @brief Method GetInstance, addr 0x365ac8c, size 0x164, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::DisplayText* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x365ae6c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x365adf0, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365ac84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IAsn1String* contents);

  /// @brief Method .ctor, addr 0x365abe4, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x365aa84, size 0x160, virtual false, abstract: false, final false
