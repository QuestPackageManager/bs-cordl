...
public:
  ...
  /// @brief Method GetInstance, addr 0x12fbc64, size 0x180, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::DisplayText* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x12fbe5c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12fbde4, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12fbc3c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IAsn1String* contents);

  /// @brief Method .ctor, addr 0x12fbb98, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x12fba2c, size 0x16c, virtual false, abstract: false, final false
