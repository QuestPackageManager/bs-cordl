...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::DisplayText*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::DisplayText*, "Org.BouncyCastle.Asn1.X509", "DisplayText");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3658904, size 0x164, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::DisplayText* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x3658ae4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3658a68, size 0x7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36588fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IAsn1String* contents);

  /// @brief Method .ctor, addr 0x365885c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::StringW text);

  /// @brief Method .ctor, addr 0x36586fc, size 0x160, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::DisplayText) == 0x20, "Size mismatch!");
