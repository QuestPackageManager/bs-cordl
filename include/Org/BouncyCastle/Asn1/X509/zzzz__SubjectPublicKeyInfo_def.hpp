...
public:
  ...
  /// @brief Method GetInstance, addr 0x366630c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3666320, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPublicKey, addr 0x3666634, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ParsePublicKey, addr 0x366660c, size 0x28, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePublicKey();

  /// @brief Method ToAsn1Object, addr 0x3666664, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3666594, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<uint8_t> publicKey);

  /// @brief Method .ctor, addr 0x3666524, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::Org::BouncyCastle::Asn1::Asn1Encodable* publicKey);

  /// @brief Method .ctor, addr 0x36663c0, size 0x164, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmID, addr 0x3666604, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmID();

  /// @brief Method get_PublicKeyData, addr 0x366665c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubjectPublicKeyInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubjectPublicKeyInfo(SubjectPublicKeyInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubjectPublicKeyInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubjectPublicKeyInfo(SubjectPublicKeyInfoconst&) = delete;
