...
public:
  ...
  /// @brief Method GetInstance, addr 0x122dbb8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x122dbd0, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetPublicKey, addr 0x122df14, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ParsePublicKey, addr 0x122deec, size 0x28, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePublicKey();

  /// @brief Method ToAsn1Object, addr 0x122df44, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122de64, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<uint8_t, ::Array<uint8_t>*> publicKey);

  /// @brief Method .ctor, addr 0x122dde4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::Org::BouncyCastle::Asn1::Asn1Encodable* publicKey);

  /// @brief Method .ctor, addr 0x122dc74, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_AlgorithmID, addr 0x122dee4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_AlgorithmID();

  /// @brief Method get_PublicKeyData, addr 0x122df3c, size 0x8, virtual false, abstract: false, final false
