...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthorityKeyIdentifier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthorityKeyIdentifier(AuthorityKeyIdentifier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthorityKeyIdentifier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthorityKeyIdentifier(AuthorityKeyIdentifierconst&) = delete;
