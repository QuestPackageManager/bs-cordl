...
public:
  ...
  /// @brief Method FromExtensions, addr 0x12f92d0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x12f8e20, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x12f8e38, size 0xf0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyIdentifier, addr 0x12f96c0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12f96f4, size 0xd8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x12f97cc, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12f96b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> keyIdentifier);

  /// @brief Method .ctor, addr 0x12f95dc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12f95cc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* name, ::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method .ctor, addr 0x12f8f28, size 0x3a8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x12f9338, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* spki);

  /// @brief Method .ctor, addr 0x12f9344, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AuthorityCertIssuer, addr 0x12f96d8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_AuthorityCertIssuer();

  /// @brief Method get_AuthorityCertSerialNumber, addr 0x12f96e0, size 0x14, virtual false, abstract: false, final false
