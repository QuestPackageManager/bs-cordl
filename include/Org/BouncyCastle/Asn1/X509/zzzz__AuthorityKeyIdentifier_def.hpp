...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier*, "Org.BouncyCastle.Asn1.X509", "AuthorityKeyIdentifier");
...
public:
  ...
  /// @brief Method FromExtensions, addr 0x355b0a8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x355ac10, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x355ac24, size 0x108, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyIdentifier, addr 0x355b4a8, size 0x18, virtual false, abstract: false, final false
  ...
  static inline ::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier* New_ctor(::ArrayW<uint8_t> keyIdentifier, ::Org::BouncyCastle::Asn1::X509::GeneralNames* name,
  ...
  /// @brief Method ToAsn1Object, addr 0x355b4dc, size 0xd8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x355b5b4, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355b49c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> keyIdentifier);

  /// @brief Method .ctor, addr 0x355b3c8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355b3b8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* name, ::Org::BouncyCastle::Math::BigInteger* serialNumber);

  /// @brief Method .ctor, addr 0x355ad2c, size 0x37c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x355b120, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* spki);

  /// @brief Method .ctor, addr 0x355b12c, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AuthorityCertIssuer, addr 0x355b4c0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_AuthorityCertIssuer();

  /// @brief Method get_AuthorityCertSerialNumber, addr 0x355b4c8, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::AuthorityKeyIdentifier) == 0x28, "Size mismatch!");
