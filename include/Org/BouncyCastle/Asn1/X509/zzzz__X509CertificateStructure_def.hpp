...
/// @brief Method GetInstance, addr 0x3570100, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x3570114, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetInstance(::System::Object*  obj) ;

/// @brief Method GetSignatureOctets, addr 0x3570460, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x357047c, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35701b4, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x35702fc, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method get_EndDate, addr 0x3570408, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::Time* get_EndDate() ;

/// @brief Method get_Issuer, addr 0x35703d8, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer() ;

/// @brief Method get_SerialNumber, addr 0x35703c0, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerInteger* get_SerialNumber() ;

/// @brief Method get_Signature, addr 0x3570458, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_Signature() ;

/// @brief Method get_SignatureAlgorithm, addr 0x3570450, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm() ;

/// @brief Method get_StartDate, addr 0x35703f0, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::Time* get_StartDate() ;

/// @brief Method get_Subject, addr 0x3570420, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Subject() ;

/// @brief Method get_SubjectPublicKeyInfo, addr 0x3570438, size 0x18, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* get_SubjectPublicKeyInfo() ;

/// @brief Method get_TbsCertificate, addr 0x35703a4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure* get_TbsCertificate() ;

/// @brief Method get_Version, addr 0x35703ac, size 0x14, virtual false, abstract: false, final false
