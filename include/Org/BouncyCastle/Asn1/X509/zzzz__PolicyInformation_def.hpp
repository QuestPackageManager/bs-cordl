...
public:
  ...
  /// @brief Method GetInstance, addr 0x260cf58, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260d00c, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260cf04, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* policyIdentifier);

  /// @brief Method .ctor, addr 0x260cf2c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260cd68, size 0x19c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_PolicyIdentifier, addr 0x260cffc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyIdentifier();

  /// @brief Method get_PolicyQualifiers, addr 0x260d004, size 0x8, virtual false, abstract: false, final false
