...
public:
  ...
  /// @brief Method .ctor, addr 0x1194180, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1194324, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x119434c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1194378, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::PolicyInformation* GetInstance(::System::Object* obj);

  /// @brief Method get_PolicyIdentifier, addr 0x119441c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PolicyIdentifier();

  /// @brief Method get_PolicyQualifiers, addr 0x1194424, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_PolicyQualifiers();

  /// @brief Method ToAsn1Object, addr 0x119442c, size 0x148, virtual true, abstract: false, final false
