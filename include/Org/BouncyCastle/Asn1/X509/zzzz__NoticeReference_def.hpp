...
public:
  ...
  /// @brief Method ConvertVector, addr 0x260c160, size 0x45c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* ConvertVector(::System::Collections::IList* numbers);

  /// @brief Method GetInstance, addr 0x260c7f0, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::NoticeReference* GetInstance(::System::Object* obj);

  /// @brief Method GetNoticeNumbers, addr 0x260c89c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260c9b0, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260c65c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260c5ec, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::StringW organization, ::Org::BouncyCastle::Asn1::Asn1EncodableVector* noticeNumbers);

  /// @brief Method .ctor, addr 0x260c5bc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::StringW organization, ::System::Collections::IList* numbers);

  /// @brief Method .ctor, addr 0x260c6d8, size 0x118, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Organization, addr 0x260c894, size 0x8, virtual true, abstract: false, final false
