...
public:
  ...
  /// @brief Method GetInstance, addr 0x355b89c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* GetInstance(::System::Object* obj);

  /// @brief Method GetSignatureOctets, addr 0x355bc50, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x355bc6c, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355baa8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355b93c, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_ACInfo, addr 0x355bc38, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo* get_ACInfo();

  /// @brief Method get_SignatureAlgorithm, addr 0x355bc40, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm();

  /// @brief Method get_SignatureValue, addr 0x355bc48, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AttributeCertificate", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AttributeCertificate(AttributeCertificate&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AttributeCertificate", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AttributeCertificate(AttributeCertificateconst&) = delete;
