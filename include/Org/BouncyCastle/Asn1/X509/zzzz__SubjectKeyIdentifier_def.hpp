...
public:
  ...
  /// @brief Method CreateSha1KeyIdentifier, addr 0x140158c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTruncatedSha1KeyIdentifier, addr 0x14015f8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method FromExtensions, addr 0x1401198, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigest, addr 0x14012cc, size 0x1f0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDigest(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* spki);

  /// @brief Method GetInstance, addr 0x1400f98, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1400fb0, size 0x184, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyIdentifier, addr 0x14014bc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x1401518, size 0x74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x140120c, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> keyID);

  /// @brief Method .ctor, addr 0x1401164, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyID);

  /// @brief Method .ctor, addr 0x1401134, size 0x30, virtual false, abstract: false, final false
