...
public:
  ...
  /// @brief Method CreateSha1KeyIdentifier, addr 0x35a6bf0, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTruncatedSha1KeyIdentifier, addr 0x35a6c54, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method FromExtensions, addr 0x35a67f4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigest, addr 0x35a6928, size 0x1fc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDigest(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* spki);

  /// @brief Method GetInstance, addr 0x35a65f4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x35a6608, size 0x19c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyIdentifier, addr 0x35a6b24, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35a6b84, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35a686c, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> keyID);

  /// @brief Method .ctor, addr 0x35a67c0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyID);

  /// @brief Method .ctor, addr 0x35a67a4, size 0x1c, virtual false, abstract: false, final false
