...
public:
  ...
  /// @brief Method CreateSha1KeyIdentifier, addr 0x26106ac, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTruncatedSha1KeyIdentifier, addr 0x2610710, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method FromExtensions, addr 0x26102c4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDigest, addr 0x26103f4, size 0x1f0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetDigest(::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* spki);

  /// @brief Method GetInstance, addr 0x26100cc, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x26100e4, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::SubjectKeyIdentifier* GetInstance(::System::Object* obj);

  /// @brief Method GetKeyIdentifier, addr 0x26105e4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2610640, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610338, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> keyID);

  /// @brief Method .ctor, addr 0x2610290, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString* keyID);

  /// @brief Method .ctor, addr 0x2610260, size 0x30, virtual false, abstract: false, final false
