...
public:
  ...
  /// @brief Method Copy, addr 0x12ff1fc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method FromExtensions, addr 0x12ff43c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x12fc130, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x12ff274, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* GetInstance(::System::Object* obj);

  /// @brief Method GetNames, addr 0x12ff58c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12ff594, size 0x68, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x12ff5fc, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ff4b4, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method .ctor, addr 0x12ff55c, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*, ::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*> names);

  /// @brief Method .ctor, addr 0x12ff318, size 0x124, virtual false, abstract: false, final false
