...
public:
  ...
  /// @brief Method Copy, addr 0x365e080, size 0x78, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*> Copy(::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*> names);

  /// @brief Method FromExtensions, addr 0x365e2b4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x365b14c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x365e0f8, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* GetInstance(::System::Object* obj);

  /// @brief Method GetNames, addr 0x365e3ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x365e3f4, size 0x60, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x365e454, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365e330, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method .ctor, addr 0x365e3d0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*> names);

  /// @brief Method .ctor, addr 0x365e198, size 0x11c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GeneralNames", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GeneralNames(GeneralNames&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GeneralNames", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GeneralNames(GeneralNamesconst&) = delete;
