...
/// @brief Field policyInformation, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_policyInformation, put=__cordl_internal_set_policyInformation)) ::ArrayW<::Org::BouncyCastle::Asn1::X509::PolicyInformation*,::Array<::Org::BouncyCastle::Asn1::X509::PolicyInformation*>*>  policyInformation;

/// @brief Method Copy, addr 0x34a03f4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method FromExtensions, addr 0x34a0644, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x34a0630, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x34a046c, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::CertificatePolicies* GetInstance(::System::Object*  obj) ;

/// @brief Method GetPolicyInformation, addr 0x34a0778, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method GetPolicyInformation, addr 0x34a0780, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x34a0824, size 0x60, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object() ;

/// @brief Method ToString, addr 0x34a0884, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34a06bc, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::PolicyInformation*  name) ;

/// @brief Method .ctor, addr 0x34a075c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34a050c, size 0x124, virtual false, abstract: false, final false
