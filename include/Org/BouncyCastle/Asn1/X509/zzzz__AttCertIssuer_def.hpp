...
public:
  ...
  /// @brief Method GetInstance, addr 0x11194a0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x1119130, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11194c4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x111945c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* names);

  /// @brief Method .ctor, addr 0x11193d4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::V2Form* v2Form);

  /// @brief Method get_Issuer, addr 0x11194bc, size 0x8, virtual false, abstract: false, final false
