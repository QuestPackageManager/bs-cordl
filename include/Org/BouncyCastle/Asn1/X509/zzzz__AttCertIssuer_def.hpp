...
public:
  ...
  /// @brief Method GetInstance, addr 0x2503174, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2502e1c, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2503198, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2503130, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* names);

  /// @brief Method .ctor, addr 0x25030b0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::V2Form* v2Form);

  /// @brief Method get_Issuer, addr 0x2503190, size 0x8, virtual false, abstract: false, final false
