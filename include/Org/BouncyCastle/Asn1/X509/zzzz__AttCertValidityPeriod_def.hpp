...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod*, "Org.BouncyCastle.Asn1.X509", "AttCertValidityPeriod");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x35593f8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3559174, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3559424, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355940c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35592f8, size 0x100, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotAfterTime, addr 0x355941c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotAfterTime();

  /// @brief Method get_NotBeforeTime, addr 0x3559414, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::AttCertValidityPeriod) == 0x20, "Size mismatch!");
