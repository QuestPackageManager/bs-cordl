...
/// @brief Method GetInstance, addr 0x349ba70, size 0x184, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::SigI::PersonalData* GetInstance(::System::Object*  obj) ;

static inline ::Org::BouncyCastle::Asn1::X509::SigI::PersonalData* New_ctor(::Org::BouncyCastle::Asn1::X509::SigI::NameOrPseudonym*  nameOrPseudonym, ::Org::BouncyCastle::Math::BigInteger*  nameDistinguisher, ::Org::BouncyCastle::Asn1::DerGeneralizedTime*  dateOfBirth, ::Org::BouncyCastle::Asn1::X500::DirectoryString*  placeOfBirth, ::StringW  gender, ::Org::BouncyCastle::Asn1::X500::DirectoryString*  postalAddress) ;

static inline ::Org::BouncyCastle::Asn1::X509::SigI::PersonalData* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x349bfac, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x349bf6c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x349bbf4, size 0x378, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_DateOfBirth, addr 0x349bf8c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_DateOfBirth() ;

/// @brief Method get_Gender, addr 0x349bf9c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Gender() ;

/// @brief Method get_NameDistinguisher, addr 0x349bf84, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_NameDistinguisher() ;

/// @brief Method get_NameOrPseudonym, addr 0x349bf7c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::SigI::NameOrPseudonym* get_NameOrPseudonym() ;

/// @brief Method get_PlaceOfBirth, addr 0x349bf94, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_PlaceOfBirth() ;

/// @brief Method get_PostalAddress, addr 0x349bfa4, size 0x8, virtual false, abstract: false, final false
