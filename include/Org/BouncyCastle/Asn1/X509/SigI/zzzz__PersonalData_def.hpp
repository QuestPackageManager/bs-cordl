...
public:
  ...
  /// @brief Method GetInstance, addr 0x345e740, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x345ec7c, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345ec3c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345e8c4, size 0x378, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DateOfBirth, addr 0x345ec5c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_DateOfBirth();

  /// @brief Method get_Gender, addr 0x345ec6c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Gender();

  /// @brief Method get_NameDistinguisher, addr 0x345ec54, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_NameDistinguisher();

  /// @brief Method get_NameOrPseudonym, addr 0x345ec4c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::SigI::NameOrPseudonym* get_NameOrPseudonym();

  /// @brief Method get_PlaceOfBirth, addr 0x345ec64, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X500::DirectoryString* get_PlaceOfBirth();

  /// @brief Method get_PostalAddress, addr 0x345ec74, size 0x8, virtual false, abstract: false, final false
