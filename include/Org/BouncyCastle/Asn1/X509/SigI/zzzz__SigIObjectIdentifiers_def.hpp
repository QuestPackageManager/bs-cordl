...
public:
  ...
  /// @brief Method .ctor, addr 0x355aa34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SigIObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SigIObjectIdentifiers(SigIObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SigIObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SigIObjectIdentifiers(SigIObjectIdentifiersconst&) = delete;
