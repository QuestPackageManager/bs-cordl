...
public:
  ...
  /// @brief Method GetInstance, addr 0x260c8d8, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260cdc4, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260caa0, size 0x314, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotAfter, addr 0x260cdbc, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x260cdb4, size 0x8, virtual false, abstract: false, final false
