...
public:
  ...
  /// @brief Method GetInstance, addr 0x11c2f24, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c30f8, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotBefore, addr 0x11c3408, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotBefore();

  /// @brief Method get_NotAfter, addr 0x11c3410, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotAfter();

  /// @brief Method ToAsn1Object, addr 0x11c3418, size 0xc0, virtual true, abstract: false, final false
