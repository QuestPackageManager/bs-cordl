...
public:
  ...
  /// @brief Method GetInstance, addr 0x122b5f8, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x122baec, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x122b7cc, size 0x310, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_NotAfter, addr 0x122bae4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_NotAfter();

  /// @brief Method get_NotBefore, addr 0x122badc, size 0x8, virtual false, abstract: false, final false
