...
public:
  ...
  /// @brief Method GetInstance, addr 0x261261c, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::RoleSyntax* GetInstance(::System::Object* obj);

  /// @brief Method GetRoleAuthorityAsString, addr 0x2612bec, size 0x1d4, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> GetRoleAuthorityAsString();

  /// @brief Method GetRoleNameAsString, addr 0x2612b00, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2612dc0, size 0xf4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x2612eb4, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26128c4, size 0x190, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* roleAuthority, ::Org::BouncyCastle::Asn1::X509::GeneralName* roleName);

  /// @brief Method .ctor, addr 0x2612a54, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* roleName);

  /// @brief Method .ctor, addr 0x2612a60, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::StringW roleName);

  /// @brief Method .ctor, addr 0x26126c0, size 0x204, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_RoleAuthority, addr 0x2612af0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_RoleAuthority();

  /// @brief Method get_RoleName, addr 0x2612af8, size 0x8, virtual false, abstract: false, final false
