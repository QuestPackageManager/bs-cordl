...
public:
  ...
  /// @brief Method GetInstance, addr 0x366203c, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::RoleSyntax* GetInstance(::System::Object* obj);

  /// @brief Method GetRoleAuthorityAsString, addr 0x366260c, size 0x1e0, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW> GetRoleAuthorityAsString();

  /// @brief Method GetRoleNameAsString, addr 0x366251c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x36627ec, size 0x120, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x366290c, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36622dc, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralNames* roleAuthority, ::Org::BouncyCastle::Asn1::X509::GeneralName* roleName);

  /// @brief Method .ctor, addr 0x3662468, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::GeneralName* roleName);

  /// @brief Method .ctor, addr 0x3662474, size 0x98, virtual false, abstract: false, final false
  inline void _ctor(::StringW roleName);

  /// @brief Method .ctor, addr 0x36620dc, size 0x200, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_RoleAuthority, addr 0x366250c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_RoleAuthority();

  /// @brief Method get_RoleName, addr 0x3662514, size 0x8, virtual false, abstract: false, final false
