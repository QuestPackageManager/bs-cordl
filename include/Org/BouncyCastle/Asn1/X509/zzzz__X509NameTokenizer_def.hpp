...
public:
  ...
  /// @brief Method HasMoreTokens, addr 0x261def4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method NextToken, addr 0x261dca4, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x261dc9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method .ctor, addr 0x261de70, size 0x84, virtual false, abstract: false, final false
