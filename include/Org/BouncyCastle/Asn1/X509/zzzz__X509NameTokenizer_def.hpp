...
public:
  ...
  /// @brief Method HasMoreTokens, addr 0x354dc74, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method NextToken, addr 0x354da44, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x354da3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method .ctor, addr 0x354dbf8, size 0x7c, virtual false, abstract: false, final false
