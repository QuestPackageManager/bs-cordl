...
public:
  ...
  /// @brief Method HasMoreTokens, addr 0x35784b8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method NextToken, addr 0x3578288, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3578280, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW oid);

  /// @brief Method .ctor, addr 0x357843c, size 0x7c, virtual false, abstract: false, final false
