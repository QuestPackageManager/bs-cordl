...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509NameTokenizer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509NameTokenizer(X509NameTokenizer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509NameTokenizer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509NameTokenizer(X509NameTokenizerconst&) = delete;
