...
public:
  ...
  /// @brief Method AppendValue, addr 0x35b6214, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeOid, addr 0x35b45ac, size 0x268, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* DecodeOid(::StringW name, ::System::Collections::IDictionary* lookUp);

  /// @brief Method Equivalent, addr 0x35b56e4, size 0x5fc, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other);

  /// @brief Method Equivalent, addr 0x35b5284, size 0x460, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other, bool inOrder);

  /// @brief Method GetInstance, addr 0x359e09c, size 0x7c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x359e274, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetInstance(::System::Object* obj);

  /// @brief Method GetOidList, addr 0x35b4a70, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetOidList();

  /// @brief Method GetValueList, addr 0x35b4ad0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetValueList();

  /// @brief Method GetValueList, addr 0x35b4ad8, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x35b4dd0, size 0x4b4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x35b6a9c, size 0x6c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method ToString, addr 0x35b64d8, size 0x5c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b2d70, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x359da1c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::StringW dirName);

  /// @brief Method .ctor, addr 0x35b39d0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::StringW dirName, ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x35b3478, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* oids, ::System::Collections::IList* values);

  /// @brief Method .ctor, addr 0x35b34e4, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b2de8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* ordering, ::System::Collections::IDictionary* attributes);

  /// @brief Method .ctor, addr 0x35b2e54, size 0x624, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b44a4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool reverse, ::StringW dirName);

  /// @brief Method .ctor, addr 0x35b4520, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool reverse, ::StringW dirName, ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x35b3954, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(bool reverse, ::System::Collections::IDictionary* lookUp, ::StringW dirName);

  /// @brief Method .ctor, addr 0x35b3a54, size 0xa50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35b2478, size 0x8f8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method canonicalize, addr 0x35b5dbc, size 0x1dc, virtual false, abstract: false, final false
  static inline ::StringW canonicalize(::StringW s);

  /// @brief Method decodeObject, addr 0x35b60a4, size 0x170, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* decodeObject(::StringW v);

  /// @brief Method equivalentStrings, addr 0x35b5ce0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DefaultReverse, addr 0x35b08d0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DefaultReverse, addr 0x35b0944, size 0x7c, virtual false, abstract: false, final false
  static inline void set_DefaultReverse(bool value);

  /// @brief Method stripInternalSpaces, addr 0x35b5f98, size 0x10c, virtual false, abstract: false, final false
