...
public:
  ...
  /// @brief Method get_DefaultReverse, addr 0x11cf4c8, size 0x70, virtual false, abstract: false, final false
  static inline bool get_DefaultReverse();

  /// @brief Method set_DefaultReverse, addr 0x11cf538, size 0x78, virtual false, abstract: false, final false
  static inline void set_DefaultReverse(bool value);

  /// @brief Method GetInstance, addr 0x11bc5c0, size 0x78, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x11bc78c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d187c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x11d0f50, size 0x92c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d18f8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d1974, size 0x654, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d1fc8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* oids, ::System::Collections::IList* values);

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(::System::Collections::IList* oids, ::System::Collections::IList* values,
                                                                    ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x11d2044, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bbf0c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d2554, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d3020, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d3098, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d24c8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool reverse, ::System::Collections::IDictionary* lookUp, ::StringW dirName);

  /// @brief Method DecodeOid, addr 0x11d3120, size 0x268, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* DecodeOid(::StringW name, ::System::Collections::IDictionary* lookUp);

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(bool reverse, ::System::Collections::IDictionary* lookUp, ::StringW dirName,
                                                                    ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x11d25d4, size 0xa4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOidList, addr 0x11d3610, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetOidList();

  /// @brief Method GetValueList, addr 0x11d366c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetValueList();

  /// @brief Method GetValueList, addr 0x11d3674, size 0x2f4, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetValueList(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method ToAsn1Object, addr 0x11d3968, size 0x4d8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method Equivalent, addr 0x11d3e40, size 0x460, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other, bool inOrder);

  /// @brief Method Equivalent, addr 0x11d42a0, size 0x5dc, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other);

  /// @brief Method equivalentStrings, addr 0x11d487c, size 0xd8, virtual false, abstract: false, final false
  static inline bool equivalentStrings(::StringW s1, ::StringW s2);

  /// @brief Method canonicalize, addr 0x11d4954, size 0x1cc, virtual false, abstract: false, final false
  static inline ::StringW canonicalize(::StringW s);

  /// @brief Method decodeObject, addr 0x11d4c18, size 0x170, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* decodeObject(::StringW v);

  /// @brief Method stripInternalSpaces, addr 0x11d4b20, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW stripInternalSpaces(::StringW str);

  /// @brief Method AppendValue, addr 0x11d4d88, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x11d505c, size 0x5d8, virtual false, abstract: false, final false
  inline ::StringW ToString(bool reverse, ::System::Collections::IDictionary* oidSymbols);

  /// @brief Method ToString, addr 0x11d5634, size 0x68, virtual true, abstract: false, final false
