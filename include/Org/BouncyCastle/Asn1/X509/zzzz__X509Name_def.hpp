...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509Name", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509Name(X509Name&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509Name", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509Name(X509Nameconst&) = delete;
