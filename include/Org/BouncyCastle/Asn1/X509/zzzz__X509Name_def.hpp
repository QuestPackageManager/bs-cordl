...
public:
  ...
  /// @brief Method get_DefaultReverse, addr 0x11a1638, size 0x70, virtual false, abstract: false, final false
  static inline bool get_DefaultReverse();

  /// @brief Method set_DefaultReverse, addr 0x11a16a8, size 0x78, virtual false, abstract: false, final false
  static inline void set_DefaultReverse(bool value);

  /// @brief Method GetInstance, addr 0x118e730, size 0x78, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x118e8fc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a39ec, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x11a30c0, size 0x92c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a3a68, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a3ae4, size 0x654, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a4138, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IList* oids, ::System::Collections::IList* values);

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(::System::Collections::IList* oids, ::System::Collections::IList* values,
                                                                    ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x11a41b4, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x118e07c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a46c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a5190, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a5208, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a4638, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(bool reverse, ::System::Collections::IDictionary* lookUp, ::StringW dirName);

  /// @brief Method DecodeOid, addr 0x11a5290, size 0x268, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* DecodeOid(::StringW name, ::System::Collections::IDictionary* lookUp);

  static inline ::Org::BouncyCastle::Asn1::X509::X509Name* New_ctor(bool reverse, ::System::Collections::IDictionary* lookUp, ::StringW dirName,
                                                                    ::Org::BouncyCastle::Asn1::X509::X509NameEntryConverter* converter);

  /// @brief Method .ctor, addr 0x11a4744, size 0xa4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOidList, addr 0x11a5780, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetOidList();

  /// @brief Method GetValueList, addr 0x11a57dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetValueList();

  /// @brief Method GetValueList, addr 0x11a57e4, size 0x2f4, virtual false, abstract: false, final false
  inline ::System::Collections::IList* GetValueList(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method ToAsn1Object, addr 0x11a5ad8, size 0x4d8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method Equivalent, addr 0x11a5fb0, size 0x460, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other, bool inOrder);

  /// @brief Method Equivalent, addr 0x11a6410, size 0x5dc, virtual false, abstract: false, final false
  inline bool Equivalent(::Org::BouncyCastle::Asn1::X509::X509Name* other);

  /// @brief Method equivalentStrings, addr 0x11a69ec, size 0xd8, virtual false, abstract: false, final false
  static inline bool equivalentStrings(::StringW s1, ::StringW s2);

  /// @brief Method canonicalize, addr 0x11a6ac4, size 0x1cc, virtual false, abstract: false, final false
  static inline ::StringW canonicalize(::StringW s);

  /// @brief Method decodeObject, addr 0x11a6d88, size 0x170, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Object* decodeObject(::StringW v);

  /// @brief Method stripInternalSpaces, addr 0x11a6c90, size 0xf8, virtual false, abstract: false, final false
  static inline ::StringW stripInternalSpaces(::StringW str);

  /// @brief Method AppendValue, addr 0x11a6ef8, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x11a71cc, size 0x5d8, virtual false, abstract: false, final false
  inline ::StringW ToString(bool reverse, ::System::Collections::IDictionary* oidSymbols);

  /// @brief Method ToString, addr 0x11a77a4, size 0x68, virtual true, abstract: false, final false
