...
public:
  ...
  /// @brief Method GetInstance, addr 0x2501db0, size 0x164, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation* GetInstance(::System::Object* obj);

  /// @brief Method GetNameRegistrationAuthorities, addr 0x250233c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2502344, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250230c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25022e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* semanticsIdentifier);

  /// @brief Method .ctor, addr 0x25022b8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* semanticsIdentifier,
                    ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*, ::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*> generalNames);

  /// @brief Method .ctor, addr 0x2501f14, size 0x3a4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_SemanticsIdentifier, addr 0x2502334, size 0x8, virtual false, abstract: false, final false
