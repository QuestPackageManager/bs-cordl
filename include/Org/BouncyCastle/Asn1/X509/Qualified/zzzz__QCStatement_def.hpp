...
public:
  ...
  /// @brief Method GetInstance, addr 0x25032a0, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x250352c, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25034c8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* qcStatementId);

  /// @brief Method .ctor, addr 0x25034f0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2503404, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_StatementId, addr 0x250351c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_StatementId();

  /// @brief Method get_StatementInfo, addr 0x2503524, size 0x8, virtual false, abstract: false, final false
