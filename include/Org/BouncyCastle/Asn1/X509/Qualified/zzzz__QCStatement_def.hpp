...
public:
  ...
  /// @brief Method GetInstance, addr 0x10ae424, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10ae58c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10ae650, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10ae678, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_StatementId, addr 0x10ae6a4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_StatementId();

  /// @brief Method get_StatementInfo, addr 0x10ae6ac, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_StatementInfo();

  /// @brief Method ToAsn1Object, addr 0x10ae6b4, size 0x148, virtual true, abstract: false, final false
