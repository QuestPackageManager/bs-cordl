...
public:
  // Ctor Parameters [CppParam { name: "", ty: "QCStatement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  QCStatement(QCStatement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "QCStatement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  QCStatement(QCStatementconst&) = delete;
