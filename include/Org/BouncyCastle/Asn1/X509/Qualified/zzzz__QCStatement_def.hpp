...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement*, "Org.BouncyCastle.Asn1.X509.Qualified", "QCStatement");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x3556948, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3556b90, size 0x154, virtual true, abstract: false, final false
  ...
  constexpr ::Org::BouncyCastle::Asn1::Asn1Encodable* const& __cordl_internal_get_qcStatementInfo() const;
  ...
  /// @brief Method .ctor, addr 0x3556b70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* qcStatementId);

  /// @brief Method .ctor, addr 0x3556b78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3556aac, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_StatementId, addr 0x3556b80, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_StatementId();

  /// @brief Method get_StatementInfo, addr 0x3556b88, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement) == 0x20, "Size mismatch!");
