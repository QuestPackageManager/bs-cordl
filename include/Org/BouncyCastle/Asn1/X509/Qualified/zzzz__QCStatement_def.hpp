...
public:
  ...
  /// @brief Method GetInstance addr 0x1010344 size 0x168 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10104ac size 0xc4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1010570 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1010598 size 0x2c virtual false final false
  ...
  /// @brief Method get_StatementId addr 0x10105c4 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_StatementId();

  /// @brief Method get_StatementInfo addr 0x10105cc size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_StatementInfo();

  /// @brief Method ToAsn1Object addr 0x10105d4 size 0x148 virtual true final false
