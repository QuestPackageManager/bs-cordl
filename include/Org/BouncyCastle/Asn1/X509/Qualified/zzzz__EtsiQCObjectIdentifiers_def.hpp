...
public:
  ...
  /// @brief Method .ctor, addr 0x35581f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EtsiQCObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EtsiQCObjectIdentifiers(EtsiQCObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EtsiQCObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EtsiQCObjectIdentifiers(EtsiQCObjectIdentifiersconst&) = delete;
