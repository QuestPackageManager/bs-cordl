...
public:
  ...
  /// @brief Method GetInstance, addr 0x2502770, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2502de8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2502b70, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::StringW alphabetic);

  /// @brief Method .ctor, addr 0x2502958, size 0x218, virtual false, abstract: false, final false
  inline void _ctor(int32_t numeric);

  /// @brief Method get_Alphabetic, addr 0x2502ce8, size 0x80, virtual false, abstract: false, final false
  inline ::StringW get_Alphabetic();

  /// @brief Method get_IsAlphabetic, addr 0x2502c6c, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsAlphabetic();

  /// @brief Method get_Numeric, addr 0x2502d68, size 0x80, virtual false, abstract: false, final false
