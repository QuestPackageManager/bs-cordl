...
public:
  ...
  /// @brief Method GetInstance, addr 0x12e1210, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x12e18d0, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12e1624, size 0x108, virtual false, abstract: false, final false
  inline void _ctor(::StringW alphabetic);

  /// @brief Method .ctor, addr 0x12e13fc, size 0x228, virtual false, abstract: false, final false
  inline void _ctor(int32_t numeric);

  /// @brief Method get_Alphabetic, addr 0x12e17a8, size 0xa8, virtual false, abstract: false, final false
  inline ::StringW get_Alphabetic();

  /// @brief Method get_IsAlphabetic, addr 0x12e172c, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsAlphabetic();

  /// @brief Method get_Numeric, addr 0x12e1850, size 0x80, virtual false, abstract: false, final false
