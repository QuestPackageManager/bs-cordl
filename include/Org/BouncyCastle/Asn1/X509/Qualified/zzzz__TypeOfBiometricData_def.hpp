...
public:
  ...
  /// @brief Method GetInstance, addr 0x24fe044, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24fffc4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24ffe28, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* biometricDataOid);

  /// @brief Method .ctor, addr 0x24ffd3c, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(int32_t predefinedBiometricType);

  /// @brief Method get_BiometricDataOid, addr 0x24fff4c, size 0x78, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_BiometricDataOid();

  /// @brief Method get_IsPredefined, addr 0x24ffe50, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsPredefined();

  /// @brief Method get_PredefinedBiometricType, addr 0x24ffecc, size 0x80, virtual false, abstract: false, final false
