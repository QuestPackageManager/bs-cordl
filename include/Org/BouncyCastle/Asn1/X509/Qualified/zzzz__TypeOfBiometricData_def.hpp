...
public:
  ...
  /// @brief Method GetInstance, addr 0x2500780, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2502700, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2502564, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* biometricDataOid);

  /// @brief Method .ctor, addr 0x2502478, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(int32_t predefinedBiometricType);

  /// @brief Method get_BiometricDataOid, addr 0x2502688, size 0x78, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_BiometricDataOid();

  /// @brief Method get_IsPredefined, addr 0x250258c, size 0x7c, virtual false, abstract: false, final false
  inline bool get_IsPredefined();

  /// @brief Method get_PredefinedBiometricType, addr 0x2502608, size 0x80, virtual false, abstract: false, final false
