...
public:
  ...
  /// @brief Method GetInstance, addr 0x24fde1c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x24fe2c0, size 0x19c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24fdf80, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method .ctor, addr 0x24fe264, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24fe224, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Qualified::TypeOfBiometricData* typeOfBiometricData, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgorithm,
                    ::Org::BouncyCastle::Asn1::Asn1OctetString* biometricDataHash, ::Org::BouncyCastle::Asn1::DerIA5String* sourceDataUri);

  /// @brief Method get_BiometricDataHash, addr 0x24fe2b0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_BiometricDataHash();

  /// @brief Method get_HashAlgorithm, addr 0x24fe2a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm();

  /// @brief Method get_SourceDataUri, addr 0x24fe2b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerIA5String* get_SourceDataUri();

  /// @brief Method get_TypeOfBiometricData, addr 0x24fe2a0, size 0x8, virtual false, abstract: false, final false
