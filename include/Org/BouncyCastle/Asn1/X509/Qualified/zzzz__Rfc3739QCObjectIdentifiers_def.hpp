...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Qualified::Rfc3739QCObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Qualified::Rfc3739QCObjectIdentifiers*, "Org.BouncyCastle.Asn1.X509.Qualified", "Rfc3739QCObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3556ce4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Qualified::Rfc3739QCObjectIdentifiers) == 0x10, "Size mismatch!");
