...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::X509::Qualified::MonetaryValue*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::X509::Qualified::MonetaryValue*, "Org.BouncyCastle.Asn1.X509.Qualified", "MonetaryValue");
...
public:
  ...
  /// @brief Method GetInstance, addr 0x355884c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3558bb4, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3558ae0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Qualified::Iso4217CurrencyCode* currency, int32_t amount, int32_t exponent);

  /// @brief Method .ctor, addr 0x35589b0, size 0x130, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Amount, addr 0x3558b84, size 0x18, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Amount();

  /// @brief Method get_Currency, addr 0x3558b7c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Qualified::Iso4217CurrencyCode* get_Currency();

  /// @brief Method get_Exponent, addr 0x3558b9c, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonetaryValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonetaryValue(MonetaryValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonetaryValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonetaryValue(MonetaryValueconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::X509::Qualified::MonetaryValue) == 0x28, "Size mismatch!");
