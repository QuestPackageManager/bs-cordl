...
public:
  ...
  /// @brief Method Get, addr 0x25067f0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDictionary, addr 0x2506944, size 0x5c, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* ToDictionary();

  /// @brief Method ToHashtable, addr 0x25068e4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25064b8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* attrs);

  /// @brief Method .ctor, addr 0x2506440, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* attrs);

  /// @brief Method .ctor, addr 0x2506678, size 0x178, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* s);

  /// @brief Method .ctor, addr 0x2506530, size 0x148, virtual false, abstract: false, final false
