...
public:
  ...
  /// @brief Method Get, addr 0x349d19c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method ToDictionary, addr 0x349d308, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IDictionary* ToDictionary();

  /// @brief Method ToHashtable, addr 0x349d2a0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x349ce74, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Hashtable* attrs);

  /// @brief Method .ctor, addr 0x349ce04, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IDictionary* attrs);

  /// @brief Method .ctor, addr 0x349d028, size 0x174, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* s);

  /// @brief Method .ctor, addr 0x349cee4, size 0x144, virtual false, abstract: false, final false
