...
public:
  ...
  /// @brief Method MoveNext, addr 0x261136c, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x261140c, size 0xa4, virtual true, abstract: false, final true
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2611344, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::IEnumerator* e);

  /// @brief Method get_Current, addr 0x26114b0, size 0xe4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x2611268, size 0xdc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2611230, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetInstance, addr 0x2610984, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x261099c, size 0x17c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::TbsCertificateList* GetInstance(::System::Object* obj);

  /// @brief Method GetRevokedCertificateEnumeration, addr 0x2611198, size 0x98, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerable* GetRevokedCertificateEnumeration();

  /// @brief Method GetRevokedCertificates, addr 0x261104c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2611260, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2610b18, size 0x4e8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_Extensions, addr 0x2611258, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_Extensions();

  /// @brief Method get_Issuer, addr 0x2611034, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer();

  /// @brief Method get_NextUpdate, addr 0x2611044, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_NextUpdate();

  /// @brief Method get_Signature, addr 0x261102c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Signature();

  /// @brief Method get_ThisUpdate, addr 0x261103c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::Time* get_ThisUpdate();

  /// @brief Method get_Version, addr 0x2611000, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_Version();

  /// @brief Method get_VersionNumber, addr 0x2611024, size 0x8, virtual false, abstract: false, final false
