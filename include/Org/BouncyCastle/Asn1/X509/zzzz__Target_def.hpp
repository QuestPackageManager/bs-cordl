...
public:
  ...
  /// @brief Method GetInstance, addr 0x260e230, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x260e53c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260e3ac, size 0x10c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject* tagObj);

  /// @brief Method .ctor, addr 0x260e4b8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::Target_Choice type, ::Org::BouncyCastle::Asn1::X509::GeneralName* name);

  /// @brief Method get_TargetGroup, addr 0x260e52c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_TargetGroup();

  /// @brief Method get_TargetName, addr 0x260e534, size 0x8, virtual true, abstract: false, final false
