...
public:
  ...
  /// @brief Method AddAttribute, addr 0x35aa44c, size 0x18, virtual false, abstract: false, final false
  inline void AddAttribute(::Org::BouncyCastle::Asn1::X509::AttributeX509* attribute);

  /// @brief Method AddAttribute, addr 0x35aa378, size 0xd4, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method GenerateAttributeCertificateInfo, addr 0x35aa49c, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEndDate, addr 0x35aa484, size 0x8, virtual false, abstract: false, final false
  inline void SetEndDate(::Org::BouncyCastle::Asn1::DerGeneralizedTime* endDate);

  /// @brief Method SetExtensions, addr 0x35aa494, size 0x8, virtual false, abstract: false, final false
  inline void SetExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* extensions);

  /// @brief Method SetHolder, addr 0x35aa370, size 0x8, virtual false, abstract: false, final false
  inline void SetHolder(::Org::BouncyCastle::Asn1::X509::Holder* holder);

  /// @brief Method SetIssuer, addr 0x35aa474, size 0x8, virtual false, abstract: false, final false
  inline void SetIssuer(::Org::BouncyCastle::Asn1::X509::AttCertIssuer* issuer);

  /// @brief Method SetIssuerUniqueID, addr 0x35aa48c, size 0x8, virtual false, abstract: false, final false
  inline void SetIssuerUniqueID(::Org::BouncyCastle::Asn1::DerBitString* issuerUniqueID);

  /// @brief Method SetSerialNumber, addr 0x35aa464, size 0x8, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Asn1::DerInteger* serialNumber);

  /// @brief Method SetSignature, addr 0x35aa46c, size 0x8, virtual false, abstract: false, final false
  inline void SetSignature(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* signature);

  /// @brief Method SetStartDate, addr 0x35aa47c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35aa2e0, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
