...
public:
  ...
  /// @brief Method AddAttribute, addr 0x3669a28, size 0x18, virtual false, abstract: false, final false
  inline void AddAttribute(::Org::BouncyCastle::Asn1::X509::AttributeX509* attribute);

  /// @brief Method AddAttribute, addr 0x3669954, size 0xd4, virtual false, abstract: false, final false
  inline void AddAttribute(::StringW oid, ::Org::BouncyCastle::Asn1::Asn1Encodable* value);

  /// @brief Method GenerateAttributeCertificateInfo, addr 0x3669a78, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEndDate, addr 0x3669a60, size 0x8, virtual false, abstract: false, final false
  inline void SetEndDate(::Org::BouncyCastle::Asn1::DerGeneralizedTime* endDate);

  /// @brief Method SetExtensions, addr 0x3669a70, size 0x8, virtual false, abstract: false, final false
  inline void SetExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* extensions);

  /// @brief Method SetHolder, addr 0x366994c, size 0x8, virtual false, abstract: false, final false
  inline void SetHolder(::Org::BouncyCastle::Asn1::X509::Holder* holder);

  /// @brief Method SetIssuer, addr 0x3669a50, size 0x8, virtual false, abstract: false, final false
  inline void SetIssuer(::Org::BouncyCastle::Asn1::X509::AttCertIssuer* issuer);

  /// @brief Method SetIssuerUniqueID, addr 0x3669a68, size 0x8, virtual false, abstract: false, final false
  inline void SetIssuerUniqueID(::Org::BouncyCastle::Asn1::DerBitString* issuerUniqueID);

  /// @brief Method SetSerialNumber, addr 0x3669a40, size 0x8, virtual false, abstract: false, final false
  inline void SetSerialNumber(::Org::BouncyCastle::Asn1::DerInteger* serialNumber);

  /// @brief Method SetSignature, addr 0x3669a48, size 0x8, virtual false, abstract: false, final false
  inline void SetSignature(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* signature);

  /// @brief Method SetStartDate, addr 0x3669a58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36698bc, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "V2AttributeCertificateInfoGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  V2AttributeCertificateInfoGenerator(V2AttributeCertificateInfoGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "V2AttributeCertificateInfoGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  V2AttributeCertificateInfoGenerator(V2AttributeCertificateInfoGeneratorconst&) = delete;
