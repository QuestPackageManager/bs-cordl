...
public:
  // Declarations
  /// @brief Method GetInstance addr 0x11922bc size 0x114 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::X509::KeyUsage* GetInstance(::System::Object* obj);

  /// @brief Method FromExtensions addr 0x1192464 size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11924d8 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11923d0 size 0x94 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* usage);

  /// @brief Method ToString addr 0x1192540 size 0xc0 virtual true final false
