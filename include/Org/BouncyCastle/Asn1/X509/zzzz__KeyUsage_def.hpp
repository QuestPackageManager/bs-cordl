...
public:
// Declarations
/// @brief Method FromExtensions, addr 0x35a2ad0, size 0x78, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::KeyUsage* FromExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

/// @brief Method GetInstance, addr 0x35a28f8, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x35a2bb4, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x35a2a30, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString*  usage) ;

/// @brief Method .ctor, addr 0x35a2b48, size 0x6c, virtual false, abstract: false, final false
