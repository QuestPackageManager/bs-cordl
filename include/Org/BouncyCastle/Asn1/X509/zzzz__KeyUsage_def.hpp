...
public:
  // Declarations
  /// @brief Method FromExtensions, addr 0x365ef88, size 0x78, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::X509::KeyUsage* FromExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions* extensions);

  /// @brief Method GetInstance, addr 0x365edb0, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x365f06c, size 0xc4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x365eee8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* usage);

  /// @brief Method .ctor, addr 0x365f000, size 0x6c, virtual false, abstract: false, final false
