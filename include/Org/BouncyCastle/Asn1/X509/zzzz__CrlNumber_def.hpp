...
public:
  ...
  /// @brief Method .ctor addr 0x111adb8 size 0x8 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* number);

  /// @brief Method get_Number addr 0x111adc0 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Number();

  /// @brief Method ToString addr 0x111adc8 size 0x5c virtual true final false
