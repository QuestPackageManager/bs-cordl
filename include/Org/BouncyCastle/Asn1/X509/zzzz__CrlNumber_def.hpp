...
public:
  ...
  /// @brief Method ToString, addr 0x26003d8, size 0x5c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x26003c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* number);

  /// @brief Method get_Number, addr 0x26003d0, size 0x8, virtual false, abstract: false, final false
