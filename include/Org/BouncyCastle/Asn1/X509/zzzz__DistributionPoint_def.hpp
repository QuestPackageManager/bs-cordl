...
public:
  ...
  /// @brief Method GetInstance, addr 0x13ee620, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x13ed538, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x13ee8c0, size 0xd8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x13ee998, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13ee86c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13ee638, size 0x170, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method appendObject, addr 0x13eeb50, size 0xf8, virtual false, abstract: false, final false
  inline void appendObject(::System::Text::StringBuilder* buf, ::StringW sep, ::StringW name, ::StringW val);

  /// @brief Method get_CrlIssuer, addr 0x13ee8b8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CrlIssuer();

  /// @brief Method get_DistributionPointName, addr 0x13ee8a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DistributionPointName* get_DistributionPointName();

  /// @brief Method get_Reasons, addr 0x13ee8b0, size 0x8, virtual false, abstract: false, final false
