...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DistributionPoint", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DistributionPoint(DistributionPoint&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DistributionPoint", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DistributionPoint(DistributionPointconst&) = delete;
