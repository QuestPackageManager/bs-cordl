...
public:
  ...
  /// @brief Method GetInstance, addr 0x2604ad8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x2603b74, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2604d74, size 0xd4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object();

  /// @brief Method ToString, addr 0x2604e48, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2604d20, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2604af0, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method appendObject, addr 0x2605000, size 0xf8, virtual false, abstract: false, final false
  inline void appendObject(::System::Text::StringBuilder* buf, ::StringW sep, ::StringW name, ::StringW val);

  /// @brief Method get_CrlIssuer, addr 0x2604d6c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CrlIssuer();

  /// @brief Method get_DistributionPointName, addr 0x2604d5c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::DistributionPointName* get_DistributionPointName();

  /// @brief Method get_Reasons, addr 0x2604d64, size 0x8, virtual false, abstract: false, final false
