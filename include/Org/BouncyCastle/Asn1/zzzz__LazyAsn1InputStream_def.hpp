...
public:
  ...
  /// @brief Method .ctor, addr 0x11f3224, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11f3228, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inputStream);

  /// @brief Method CreateDerSequence, addr 0x11f3258, size 0x74, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream* dIn);

  /// @brief Method CreateDerSet, addr 0x11f3334, size 0x74, virtual true, abstract: false, final false
