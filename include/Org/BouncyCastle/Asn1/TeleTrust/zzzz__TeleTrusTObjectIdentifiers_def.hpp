...
public:
  ...
  /// @brief Method .ctor, addr 0x354f950, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TeleTrusTObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TeleTrusTObjectIdentifiers(TeleTrusTObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TeleTrusTObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TeleTrusTObjectIdentifiers(TeleTrusTObjectIdentifiersconst&) = delete;
