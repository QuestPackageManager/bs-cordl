...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Misc::MiscObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Misc::MiscObjectIdentifiers*, "Org.BouncyCastle.Asn1.Misc", "MiscObjectIdentifiers");
...
public:
  ...
  __declspec(property(get = getStaticF_cryptlib_algorithm_blowfish_CBC,
  ...
  __declspec(property(get = getStaticF_cryptlib_algorithm_blowfish_CFB,
  ...
  __declspec(property(get = getStaticF_cryptlib_algorithm_blowfish_ECB,
  ...
  __declspec(property(get = getStaticF_cryptlib_algorithm_blowfish_OFB,
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MiscObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MiscObjectIdentifiers(MiscObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MiscObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MiscObjectIdentifiers(MiscObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Misc::MiscObjectIdentifiers) == 0x10, "Size mismatch!");
