...
public:
  ...
  /// @brief Method GetIV, addr 0x3397458, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x33971c4, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3397470, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33973f0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x3397308, size 0xe8, virtual false, abstract: false, final false
