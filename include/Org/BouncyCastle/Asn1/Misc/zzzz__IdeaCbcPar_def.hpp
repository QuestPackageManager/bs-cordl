...
public:
  ...
  /// @brief Method GetIV, addr 0x11dad14, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x11daa6c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11dad2c, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11dac98, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv);

  /// @brief Method .ctor, addr 0x11dabb4, size 0xe4, virtual false, abstract: false, final false
