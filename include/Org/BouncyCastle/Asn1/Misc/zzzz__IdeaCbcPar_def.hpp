...
public:
  ...
  /// @brief Method GetIV, addr 0x34546ac, size 0x18, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetIV();

  /// @brief Method GetInstance, addr 0x3454418, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x34546c4, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3454644, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> iv);

  /// @brief Method .ctor, addr 0x345455c, size 0xe8, virtual false, abstract: false, final false
