...
public:
  ...
  /// @brief Method ToString, addr 0x11e24b4, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x11e247c, size 0x38, virtual false, abstract: false, final false
