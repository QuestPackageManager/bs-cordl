...
public:
  ...
  /// @brief Method ToString, addr 0x335bacc, size 0xb0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x335ba2c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString* usage);

  /// @brief Method .ctor, addr 0x335b9c0, size 0x6c, virtual false, abstract: false, final false
