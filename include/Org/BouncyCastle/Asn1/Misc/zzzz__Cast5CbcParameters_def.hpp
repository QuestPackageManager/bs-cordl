...
public:
  ...
  /// @brief Method GetIV, addr 0x24025dc, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x240222c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x2402670, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240252c, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv, int32_t keyLength);

  /// @brief Method .ctor, addr 0x2402368, size 0x1c4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyLength, addr 0x2402654, size 0x1c, virtual false, abstract: false, final false
