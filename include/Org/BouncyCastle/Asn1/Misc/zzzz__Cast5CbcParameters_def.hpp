...
public:
  ...
  /// @brief Method GetIV, addr 0x3330268, size 0x7c, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetIV();

  /// @brief Method GetInstance, addr 0x332feb4, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x33302fc, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33301c8, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> iv, int32_t keyLength);

  /// @brief Method .ctor, addr 0x332fff8, size 0x1d0, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_KeyLength, addr 0x33302e4, size 0x18, virtual false, abstract: false, final false
