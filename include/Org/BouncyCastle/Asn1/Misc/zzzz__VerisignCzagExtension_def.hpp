...
/// @brief Method ToString, addr 0x335be7c, size 0x64, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x335be44, size 0x38, virtual false, abstract: false, final false
