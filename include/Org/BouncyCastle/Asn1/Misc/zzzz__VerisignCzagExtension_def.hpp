...
public:
  ...
  /// @brief Method ToString, addr 0xfee330, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0xfee2f8, size 0x38, virtual false, abstract: false, final false
