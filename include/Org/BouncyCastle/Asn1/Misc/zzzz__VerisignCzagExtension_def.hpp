...
public:
  ...
  /// @brief Method ToString, addr 0x23c2bd0, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x23c2b98, size 0x38, virtual false, abstract: false, final false
