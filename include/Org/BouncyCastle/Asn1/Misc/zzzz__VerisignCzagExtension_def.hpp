...
public:
  ...
  /// @brief Method ToString, addr 0x2403344, size 0x60, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x240330c, size 0x38, virtual false, abstract: false, final false
