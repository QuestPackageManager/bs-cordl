...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VerisignCzagExtension", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VerisignCzagExtension(VerisignCzagExtension&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VerisignCzagExtension", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VerisignCzagExtension(VerisignCzagExtensionconst&) = delete;
