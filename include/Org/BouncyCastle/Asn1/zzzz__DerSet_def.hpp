...
public:
  ...
  /// @brief Method FromVector addr 0x114d1b4 size 0x94 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerSet* FromVector(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method FromVector addr 0x1144c0c size 0x9c virtual false final false
  ...
  /// @brief Method .ctor addr 0x114d260 size 0x4 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::DerSet* New_ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor addr 0x1148278 size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x114d264 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x114d248 size 0x18 virtual false final false
  ...
  /// @brief Method .ctor addr 0x114827c size 0x34 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector, bool needsSorting);

  /// @brief Method Encode addr 0x114d27c size 0x390 virtual true final false
