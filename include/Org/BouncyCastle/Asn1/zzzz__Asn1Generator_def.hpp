...
public:
  ...
  /// @brief Method .ctor, addr 0x355b2a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method get_Out, addr 0x355b2a8, size 0x8, virtual false, abstract: false, final false
