...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Asn1Generator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Asn1Generator*, "Org.BouncyCastle.Asn1", "Asn1Generator");
...
public:
  ...
  /// @brief Method .ctor, addr 0x367f2cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method get_Out, addr 0x367f2d4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Asn1Generator) == 0x18, "Size mismatch!");
