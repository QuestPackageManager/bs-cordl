...
/// @brief Method .ctor, addr 0x3585a34, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method get_Out, addr 0x3585a3c, size 0x8, virtual false, abstract: false, final false
