...
public:
  ...
  /// @brief Method .ctor, addr 0x263559c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x26355d0, size 0x54, virtual false, abstract: false, final false
