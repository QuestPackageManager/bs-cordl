...
public:
  ...
  /// @brief Method .ctor, addr 0x2631b2c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x2631b60, size 0x54, virtual false, abstract: false, final false
