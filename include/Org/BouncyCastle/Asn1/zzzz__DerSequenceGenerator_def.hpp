...
public:
  ...
  /// @brief Method AddObject, addr 0x1332f24, size 0x80, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x1332fac, size 0x38, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x1332fa4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1332e00, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x1332e80, size 0xa4, virtual false, abstract: false, final false
