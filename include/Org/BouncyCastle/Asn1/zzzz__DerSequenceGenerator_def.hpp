...
/// @brief Method AddObject, addr 0x35d285c, size 0x84, virtual true, abstract: false, final false
inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method Close, addr 0x35d28e8, size 0x38, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetRawOutputStream, addr 0x35d28e0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35d275c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x35d27cc, size 0x90, virtual false, abstract: false, final false
