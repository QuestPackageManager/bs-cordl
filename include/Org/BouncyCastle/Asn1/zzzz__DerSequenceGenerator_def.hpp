...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::DerSequenceGenerator*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::DerSequenceGenerator*, "Org.BouncyCastle.Asn1", "DerSequenceGenerator");
// Dependencies Org.BouncyCastle.Asn1.DerGenerator
namespace Org::BouncyCastle::Asn1 {
// Is value type: false
...
public:
  ...
  /// @brief Method AddObject, addr 0x369109c, size 0x84, virtual true, abstract: false, final false
  inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method Close, addr 0x3691128, size 0x38, virtual true, abstract: false, final false
  inline void Close();

  /// @brief Method GetRawOutputStream, addr 0x3691120, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3690f9c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x369100c, size 0x90, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerSequenceGenerator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerSequenceGenerator(DerSequenceGenerator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerSequenceGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerSequenceGenerator(DerSequenceGeneratorconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::DerSequenceGenerator) == 0x28, "Size mismatch!");
