...
public:
  ...
  /// @brief Method SetParentEofDetect, addr 0x2637378, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2637344, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream, int32_t limit);

  /// @brief Method get_Limit, addr 0x2637370, size 0x8, virtual true, abstract: false, final false
