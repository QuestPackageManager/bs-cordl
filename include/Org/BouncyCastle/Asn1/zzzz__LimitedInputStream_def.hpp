...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::LimitedInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::LimitedInputStream*, "Org.BouncyCastle.Asn1", "LimitedInputStream");
...
public:
  ...
  /// @brief Method SetParentEofDetect, addr 0x368b0e8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368b0b4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream, int32_t limit);

  /// @brief Method get_Limit, addr 0x368b0e0, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::LimitedInputStream) == 0x40, "Size mismatch!");
