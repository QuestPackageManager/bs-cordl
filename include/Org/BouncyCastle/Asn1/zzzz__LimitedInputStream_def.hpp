...
/// @brief Method SetParentEofDetect, addr 0x3591850, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x359181c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream, int32_t  limit) ;

/// @brief Method get_Limit, addr 0x3591848, size 0x8, virtual true, abstract: false, final false
