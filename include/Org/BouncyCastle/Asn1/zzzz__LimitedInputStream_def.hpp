...
public:
  ...
  /// @brief Method .ctor, addr 0x11ecf4c, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* inStream, int32_t limit);

  /// @brief Method get_Limit, addr 0x11ecf78, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Limit();

  /// @brief Method SetParentEofDetect, addr 0x11ecf80, size 0x90, virtual true, abstract: false, final false
