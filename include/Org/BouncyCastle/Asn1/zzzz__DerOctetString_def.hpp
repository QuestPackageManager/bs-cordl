...
public:
  // Declarations
  /// @brief Method Encode, addr 0x36876ac, size 0x1c, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method Encode, addr 0x36876c8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368763c, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* obj);

  /// @brief Method .ctor, addr 0x3687584, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::IAsn1Convertible* obj);

  /// @brief Method .ctor, addr 0x367d40c, size 0x4, virtual false, abstract: false, final false
