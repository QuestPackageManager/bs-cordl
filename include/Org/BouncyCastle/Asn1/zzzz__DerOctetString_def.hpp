...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DerOctetString", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DerOctetString(DerOctetString&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DerOctetString", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DerOctetString(DerOctetStringconst&) = delete;
