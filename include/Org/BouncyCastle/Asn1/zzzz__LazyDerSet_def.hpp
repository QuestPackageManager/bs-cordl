...
public:
  ...
  /// @brief Method Encode, addr 0x3598038, size 0xb8, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetEnumerator, addr 0x3597ff0, size 0x24, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  static inline ::Org::BouncyCastle::Asn1::LazyDerSet* New_ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encoded);

  /// @brief Method Parse, addr 0x3597e5c, size 0x16c, virtual false, abstract: false, final false
  inline void Parse();
  ...
  /// @brief Method .ctor, addr 0x3597b5c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> encoded);

  /// @brief Method get_Count, addr 0x3598014, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x3597fc8, size 0x28, virtual true, abstract: false, final false
