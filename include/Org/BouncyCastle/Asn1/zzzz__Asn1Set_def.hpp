...
public:
  ...
  /// @brief Method ReadObject, addr 0x142bfc8, size 0xf8, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x142c0c0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x142bc00, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Compare, addr 0x142c0c8, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x142bfb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x142bcd8, size 0x16c, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x142bc44, size 0x94, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method GetEnumerator, addr 0x142bb40, size 0x1c, virtual true, abstract: false, final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method GetInstance, addr 0x142b2e4, size 0x558, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Set* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool explicitly);

  /// @brief Method GetInstance, addr 0x142af4c, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method Sort, addr 0x142be44, size 0x170, virtual false, abstract: false, final false
  inline void Sort();

  /// @brief Method ToArray, addr 0x142bba8, size 0x58, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> ToArray();

  /// @brief Method ToString, addr 0x142bfbc, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x142b874, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x142b8e0, size 0xec, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor, addr 0x142bac0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method .ctor, addr 0x142b9cc, size 0xf4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> elements);

  /// @brief Method get_Count, addr 0x142bb8c, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_Count();

  /// @brief Method get_Item, addr 0x142bb5c, size 0x30, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Item(int32_t index);

  /// @brief Method get_Parser, addr 0x142aee4, size 0x60, virtual false, abstract: false, final false
