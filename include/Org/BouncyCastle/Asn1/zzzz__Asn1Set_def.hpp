...
public:
  ...
  /// @brief Method .ctor addr 0x114863c size 0x44 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Set* outer);

  /// @brief Method ReadObject addr 0x1148a04 size 0xf8 virtual true final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object addr 0x1148afc size 0x8 virtual true final false
...
public:
  ...
  /// @brief Method Compare addr 0x1148b04 size 0x180 virtual true final true
  ...
  /// @brief Method .ctor addr 0x11489f0 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetInstance addr 0x1147988 size 0x398 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Set* GetInstance(::System::Object* obj);

  /// @brief Method GetInstance addr 0x1147d20 size 0x558 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11482b0 size 0x6c virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Asn1::Asn1Set* New_ctor(::Org::BouncyCastle::Asn1::Asn1Encodable* element);

  /// @brief Method .ctor addr 0x114831c size 0xec virtual false final false
  ...
  /// @brief Method .ctor addr 0x1148408 size 0xf4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x11484fc size 0x80 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1EncodableVector* elementVector);

  /// @brief Method GetEnumerator addr 0x114857c size 0x1c virtual true final false
  inline ::System::Collections::IEnumerator* GetEnumerator();

  /// @brief Method get_Item addr 0x1148598 size 0x30 virtual true final false
  inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Item(int32_t index);

  /// @brief Method get_Count addr 0x11485c8 size 0x1c virtual true final false
  inline int32_t get_Count();

  /// @brief Method ToArray addr 0x11485e4 size 0x58 virtual true final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Asn1Encodable*, ::Array<::Org::BouncyCastle::Asn1::Asn1Encodable*>*> ToArray();

  /// @brief Method get_Parser addr 0x1147920 size 0x60 virtual false final false
  inline ::Org::BouncyCastle::Asn1::Asn1SetParser* get_Parser();

  /// @brief Method Asn1GetHashCode addr 0x1148680 size 0x94 virtual true final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method Asn1Equals addr 0x1148714 size 0x16c virtual true final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Sort addr 0x1148880 size 0x170 virtual false final false
  inline void Sort();

  /// @brief Method ToString addr 0x11489f8 size 0xc virtual true final false
