...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::IAsn1Convertible* (::Org::BouncyCastle::Asn1::Asn1SetParser::*)()>(&::Org::BouncyCastle::Asn1::Asn1SetParser::ReadObject)> {
