...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Dump", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Dump(Dump&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Dump", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Dump(Dumpconst&) = delete;
