...
public:
  ...
  /// @brief Method .ctor addr 0x100d594 size 0x6c virtual false final false
  inline void _ctor(::System::IO::Stream* s);

  /// @brief Method get_CanRead addr 0x100d600 size 0x20 virtual true final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek addr 0x100d620 size 0x20 virtual true final false
  inline bool get_CanSeek();

  /// @brief Method get_CanWrite addr 0x100d640 size 0x20 virtual true final false
  inline bool get_CanWrite();

  /// @brief Method get_Length addr 0x100d660 size 0x20 virtual true final false
  inline int64_t get_Length();

  /// @brief Method get_Position addr 0x100d680 size 0x20 virtual true final false
  inline int64_t get_Position();

  /// @brief Method set_Position addr 0x100d6a0 size 0x24 virtual true final false
  inline void set_Position(int64_t value);

  /// @brief Method Close addr 0x100d6c4 size 0x68 virtual true final false
  inline void Close();

  /// @brief Method Flush addr 0x100d72c size 0x24 virtual true final false
  inline void Flush();

  /// @brief Method Seek addr 0x100d750 size 0x24 virtual true final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetLength addr 0x100d774 size 0x24 virtual true final false
  inline void SetLength(int64_t value);

  /// @brief Method Read addr 0x100d798 size 0x24 virtual true final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte addr 0x100d7bc size 0x24 virtual true final false
  inline int32_t ReadByte();

  /// @brief Method Write addr 0x100d7e0 size 0x24 virtual true final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteByte addr 0x100d804 size 0x24 virtual true final false
