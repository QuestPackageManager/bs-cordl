...
public:
  ...
  /// @brief Method .ctor, addr 0xe95474, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method GetString, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::StringW GetString();

  /// @brief Method ToString, addr 0xe9547c, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Asn1GetHashCode, addr 0xe95488, size 0x24, virtual true, abstract: false, final false
