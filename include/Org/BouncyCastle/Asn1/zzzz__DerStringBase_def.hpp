...
public:
  ...
  /// @brief Method ToString, addr 0x334d140, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x334d13c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
