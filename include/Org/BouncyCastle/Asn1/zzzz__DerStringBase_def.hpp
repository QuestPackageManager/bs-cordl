...
public:
  ...
  /// @brief Method Asn1GetHashCode, addr 0x22fa0ac, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x22fa0a0, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x22fa098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
