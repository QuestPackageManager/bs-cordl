...
public:
  ...
  /// @brief Method Asn1GetHashCode, addr 0x32515dc, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x32515d0, size 0xc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x32515cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
