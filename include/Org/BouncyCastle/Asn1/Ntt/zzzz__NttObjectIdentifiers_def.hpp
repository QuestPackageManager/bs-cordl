...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::Ntt::NttObjectIdentifiers*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::Ntt::NttObjectIdentifiers*, "Org.BouncyCastle.Asn1.Ntt", "NttObjectIdentifiers");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34599e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NttObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NttObjectIdentifiers(NttObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NttObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NttObjectIdentifiers(NttObjectIdentifiersconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::Ntt::NttObjectIdentifiers) == 0x10, "Size mismatch!");
