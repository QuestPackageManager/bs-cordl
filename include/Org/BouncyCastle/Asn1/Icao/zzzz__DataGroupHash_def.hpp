...
public:
  ...
  /// @brief Method GetInstance, addr 0x11d989c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11d9acc, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11d9a28, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(int32_t dataGroupNumber, ::Org::BouncyCastle::Asn1::Asn1OctetString* dataGroupHashValue);

  /// @brief Method .ctor, addr 0x11d9940, size 0xe8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DataGroupHashValue, addr 0x11d9ac4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_DataGroupHashValue();

  /// @brief Method get_DataGroupNumber, addr 0x11d9aa8, size 0x1c, virtual false, abstract: false, final false
