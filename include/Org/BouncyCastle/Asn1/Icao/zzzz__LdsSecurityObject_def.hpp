...
public:
  ...
  /// @brief Method CheckDatagroupHashSeqSize, addr 0x11da57c, size 0xac, virtual false, abstract: false, final false
  inline void CheckDatagroupHashSeqSize(int32_t size);

  /// @brief Method GetDatagroupHash, addr 0x11da7b0, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*, ::Array<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*>*> GetDatagroupHash();

  /// @brief Method GetInstance, addr 0x11d9e20, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x11da7c0, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11da628, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digestAlgorithmIdentifier,
                    ::ArrayW<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*, ::Array<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*>*> datagroupHash);

  /// @brief Method .ctor, addr 0x11da6d4, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* digestAlgorithmIdentifier,
                    ::ArrayW<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*, ::Array<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*>*> datagroupHash,
                    ::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo* versionInfo);

  /// @brief Method .ctor, addr 0x11d9ec4, size 0x570, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method get_DigestAlgorithmIdentifier, addr 0x11da7a8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmIdentifier();

  /// @brief Method get_Version, addr 0x11da78c, size 0x1c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Version();

  /// @brief Method get_VersionInfo, addr 0x11da7b8, size 0x8, virtual false, abstract: false, final false
