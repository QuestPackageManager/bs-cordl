...
public:
  ...
  /// @brief Method GetInstance, addr 0x23fb50c, size 0xa4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetLdsVersion, addr 0x23fbb10, size 0x20, virtual true, abstract: false, final false
  inline ::StringW GetLdsVersion();

  /// @brief Method GetUnicodeVersion, addr 0x23fbb30, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x23fbb50, size 0xec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23fb998, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW ldsVersion, ::StringW unicodeVersion);

  /// @brief Method .ctor, addr 0x23fba2c, size 0xe4, virtual false, abstract: false, final false
