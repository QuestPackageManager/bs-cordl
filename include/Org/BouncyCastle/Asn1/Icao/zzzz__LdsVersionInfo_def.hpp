...
public:
  ...
  /// @brief Method GetInstance, addr 0x3390688, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo* GetInstance(::System::Object* obj);

  /// @brief Method GetLdsVersion, addr 0x3390c6c, size 0x1c, virtual true, abstract: false, final false
  inline ::StringW GetLdsVersion();

  /// @brief Method GetUnicodeVersion, addr 0x3390c88, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3390ca4, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3390b04, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW ldsVersion, ::StringW unicodeVersion);

  /// @brief Method .ctor, addr 0x3390b90, size 0xdc, virtual false, abstract: false, final false
