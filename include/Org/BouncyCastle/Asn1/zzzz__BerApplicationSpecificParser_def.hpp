...
public:
  ...
  /// @brief Method ReadObject, addr 0x3686d34, size 0x1c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x36818bc, size 0x7c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x36818b0, size 0xc, virtual false, abstract: false, final false
