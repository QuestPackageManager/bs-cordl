...
public:
  ...
  /// @brief Method ReadObject, addr 0x262f3c4, size 0x20, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject();

  /// @brief Method ToAsn1Object, addr 0x2629d88, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2629d58, size 0x30, virtual false, abstract: false, final false
