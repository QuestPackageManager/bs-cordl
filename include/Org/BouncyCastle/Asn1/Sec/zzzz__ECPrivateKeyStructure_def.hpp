...
public:
  ...
  /// @brief Method GetInstance, addr 0x3482e10, size 0xa0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Sec::ECPrivateKeyStructure* GetInstance(::System::Object* obj);

  /// @brief Method GetKey, addr 0x34836f4, size 0xdc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* GetKey();

  /// @brief Method GetObjectInTag, addr 0x3483854, size 0x334, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* GetObjectInTag(int32_t tagNo);

  /// @brief Method GetParameters, addr 0x3483b88, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Asn1::Asn1Object* GetParameters();

  /// @brief Method GetPublicKey, addr 0x34837d0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method ToAsn1Object, addr 0x3483b90, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3482f08, size 0x1b4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* key);

  /// @brief Method .ctor, addr 0x34830d4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* key, ::Org::BouncyCastle::Asn1::Asn1Encodable* parameters);

  /// @brief Method .ctor, addr 0x34830e0, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34830bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t orderBitLength, ::Org::BouncyCastle::Math::BigInteger* key);

  /// @brief Method .ctor, addr 0x34830c8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34833b0, size 0x344, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3482eb0, size 0x58, virtual false, abstract: false, final false
