...
/// @brief Method GetInstance, addr 0x34467cc, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Sec::ECPrivateKeyStructure* GetInstance(::System::Object*  obj) ;

/// @brief Method GetKey, addr 0x34470b0, size 0xdc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* GetKey() ;

/// @brief Method GetObjectInTag, addr 0x3447210, size 0x334, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* GetObjectInTag(int32_t  tagNo) ;

/// @brief Method GetParameters, addr 0x3447544, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* GetParameters() ;

/// @brief Method GetPublicKey, addr 0x344718c, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x344754c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34468c4, size 0x1b4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  key) ;

/// @brief Method .ctor, addr 0x3446a90, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  key, ::Org::BouncyCastle::Asn1::Asn1Encodable*  parameters) ;

/// @brief Method .ctor, addr 0x3446a9c, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3446a78, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  orderBitLength, ::Org::BouncyCastle::Math::BigInteger*  key) ;

/// @brief Method .ctor, addr 0x3446a84, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3446d6c, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x344686c, size 0x58, virtual false, abstract: false, final false
