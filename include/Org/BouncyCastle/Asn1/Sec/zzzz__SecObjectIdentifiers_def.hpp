...
public:
  ...
  /// @brief Method .ctor, addr 0x354ac84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecObjectIdentifiers", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecObjectIdentifiers(SecObjectIdentifiers&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecObjectIdentifiers", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecObjectIdentifiers(SecObjectIdentifiersconst&) = delete;
