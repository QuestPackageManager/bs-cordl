...
public:
  ...
  /// @brief Method GetNextParser, addr 0x35cdbf4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x35cda34, size 0x1c0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x35cdcf8, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35cb704, size 0x2c, virtual false, abstract: false, final false
