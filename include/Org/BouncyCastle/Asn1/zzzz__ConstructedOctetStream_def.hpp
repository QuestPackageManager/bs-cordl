...
public:
  ...
  /// @brief Method GetNextParser, addr 0x2637080, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x2636ebc, size 0x1c4, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x2637180, size 0x134, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2634abc, size 0x2c, virtual false, abstract: false, final false
