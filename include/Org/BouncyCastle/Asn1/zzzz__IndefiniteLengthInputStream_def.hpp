...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::IndefiniteLengthInputStream*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::IndefiniteLengthInputStream*, "Org.BouncyCastle.Asn1", "IndefiniteLengthInputStream");
...
public:
  ...
  /// @brief Method CheckForEof, addr 0x3693364, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x36933fc, size 0x100, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x36934fc, size 0x48, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method RequireByte, addr 0x3693304, size 0x60, virtual false, abstract: false, final false
  inline int32_t RequireByte();

  /// @brief Method SetEofOn00, addr 0x36881d0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3683b0c, size 0x48, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IndefiniteLengthInputStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IndefiniteLengthInputStream(IndefiniteLengthInputStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IndefiniteLengthInputStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IndefiniteLengthInputStream(IndefiniteLengthInputStreamconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::IndefiniteLengthInputStream) == 0x48, "Size mismatch!");
