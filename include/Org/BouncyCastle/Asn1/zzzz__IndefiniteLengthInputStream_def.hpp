...
public:
  ...
  /// @brief Method CheckForEof, addr 0x14289b0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x1428a54, size 0x104, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x1428b58, size 0x48, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method RequireByte, addr 0x1428948, size 0x68, virtual false, abstract: false, final false
  inline int32_t RequireByte();

  /// @brief Method SetEofOn00, addr 0x141d454, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1418af4, size 0x44, virtual false, abstract: false, final false
