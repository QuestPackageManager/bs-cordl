...
public:
  ...
  /// @brief Method CheckForEof, addr 0x35d3d88, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Read, addr 0x35d3e20, size 0x100, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadByte, addr 0x35d3f20, size 0x48, virtual true, abstract: false, final false
  inline int32_t ReadByte();

  /// @brief Method RequireByte, addr 0x35d3d28, size 0x60, virtual false, abstract: false, final false
  inline int32_t RequireByte();

  /// @brief Method SetEofOn00, addr 0x35c8bf4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35c4530, size 0x48, virtual false, abstract: false, final false
