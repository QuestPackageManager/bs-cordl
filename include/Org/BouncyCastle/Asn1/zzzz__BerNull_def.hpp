...
public:
  ...
  /// @brief Method Encode, addr 0x35ca1f0, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ca140, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ca198, size 0x58, virtual false, abstract: false, final false
