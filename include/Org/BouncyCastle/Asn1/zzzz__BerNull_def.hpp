...
public:
  ...
  /// @brief Method Encode, addr 0x142535c, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14252b4, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1425308, size 0x54, virtual false, abstract: false, final false
