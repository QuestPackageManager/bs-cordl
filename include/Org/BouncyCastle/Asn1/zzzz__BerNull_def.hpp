...
/// @brief Method Encode, addr 0x35caf8c, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x35caedc, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x35caf34, size 0x58, virtual false, abstract: false, final false
