...
public:
  ...
  /// @brief Method Encode, addr 0x2633c3c, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2633b94, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2633be8, size 0x54, virtual false, abstract: false, final false
