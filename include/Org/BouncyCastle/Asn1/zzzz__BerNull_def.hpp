...
public:
  ...
  /// @brief Method Encode, addr 0x2637974, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26378cc, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2637920, size 0x54, virtual false, abstract: false, final false
