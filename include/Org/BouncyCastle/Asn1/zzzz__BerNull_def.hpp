...
public:
  ...
  /// @brief Method Encode, addr 0x262fb04, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262fa5c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x262fab0, size 0x54, virtual false, abstract: false, final false
