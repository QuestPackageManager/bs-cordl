...
public:
  ...
  /// @brief Method Encode, addr 0x26335b4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263350c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2633560, size 0x54, virtual false, abstract: false, final false
