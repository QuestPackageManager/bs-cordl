...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Asn1::BerNull*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Asn1::BerNull*, "Org.BouncyCastle.Asn1", "BerNull");
...
public:
  ...
  /// @brief Method Encode, addr 0x3687444, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3687394, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x36873ec, size 0x58, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Asn1::BerNull) == 0x18, "Size mismatch!");
