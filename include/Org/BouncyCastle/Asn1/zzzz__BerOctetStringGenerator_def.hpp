...
public:
  ...
  /// @brief Method Close, addr 0x36885f0, size 0x48, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x36884bc, size 0x134, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t> buf, int32_t offset, int32_t len);

  /// @brief Method WriteByte, addr 0x3688454, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3688374, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetOctetOutputStream, addr 0x3688230, size 0x58, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetOctetOutputStream();

  /// @brief Method GetOctetOutputStream, addr 0x3688288, size 0x6c, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetOctetOutputStream(::ArrayW<uint8_t> buf);

  /// @brief Method GetOctetOutputStream, addr 0x36882f4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3688200, size 0x14, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x3688214, size 0x1c, virtual false, abstract: false, final false
