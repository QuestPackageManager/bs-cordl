...
public:
  ...
  /// @brief Method Close, addr 0x26347e8, size 0x48, virtual true, abstract: false, final false
  inline void Close();
  ...
  /// @brief Method Write, addr 0x26346c8, size 0x120, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buf, int32_t offset, int32_t len);

  /// @brief Method WriteByte, addr 0x2634660, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2634580, size 0x88, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetOctetOutputStream, addr 0x2634454, size 0x54, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetOctetOutputStream();

  /// @brief Method GetOctetOutputStream, addr 0x26344a8, size 0x68, virtual false, abstract: false, final false
  inline ::System::IO::Stream* GetOctetOutputStream(::ArrayW<uint8_t, ::Array<uint8_t>*> buf);

  /// @brief Method GetOctetOutputStream, addr 0x2634510, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26343cc, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::System::IO::Stream* outStream);

  /// @brief Method .ctor, addr 0x2634400, size 0x54, virtual false, abstract: false, final false
