...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x368b980, size 0xa8, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Encode, addr 0x368ba28, size 0x104, virtual true, abstract: false, final false
  inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream* derOut);

  /// @brief Method GetInstance, addr 0x368b6c0, size 0xf4, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBmpString* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject* obj, bool isExplicit);

  /// @brief Method GetInstance, addr 0x368b5d4, size 0xec, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerBmpString* GetInstance(::System::Object* obj);

  /// @brief Method GetString, addr 0x368b978, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36823fc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<char16_t> str);

  /// @brief Method .ctor, addr 0x368b7b4, size 0x16c, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> str);

  /// @brief Method .ctor, addr 0x368b920, size 0x58, virtual false, abstract: false, final false
