...
public:
  ...
  /// @brief Method ToString, addr 0x35c55b0, size 0x44, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x35c55ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
