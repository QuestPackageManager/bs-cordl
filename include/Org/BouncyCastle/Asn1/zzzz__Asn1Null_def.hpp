...
public:
  ...
  /// @brief Method ToString, addr 0x262ef38, size 0x40, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x262ef30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
