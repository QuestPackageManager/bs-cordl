...
public:
  ...
  /// @brief Method ToString, addr 0x358901c, size 0x44, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3589018, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
