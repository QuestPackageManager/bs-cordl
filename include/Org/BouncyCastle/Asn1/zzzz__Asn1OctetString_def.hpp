...
public:
  ...
  /// @brief Method Asn1Equals, addr 0x263301c, size 0xe0, virtual true, abstract: false, final false
  inline bool Asn1Equals(::Org::BouncyCastle::Asn1::Asn1Object* asn1Object);

  /// @brief Method Asn1GetHashCode, addr 0x2632fac, size 0x70, virtual true, abstract: false, final false
  inline int32_t Asn1GetHashCode();

  /// @brief Method GetInstance, addr 0x2632cb0, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x262c06c, size 0x2b0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetInstance(::System::Object* obj);

  /// @brief Method GetOctetStream, addr 0x2632f3c, size 0x64, virtual true, abstract: false, final true
  inline ::System::IO::Stream* GetOctetStream();

  /// @brief Method GetOctets, addr 0x2632fa4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x26330fc, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2632ec8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> str);

  /// @brief Method get_Parser, addr 0x2632fa0, size 0x4, virtual false, abstract: false, final false
