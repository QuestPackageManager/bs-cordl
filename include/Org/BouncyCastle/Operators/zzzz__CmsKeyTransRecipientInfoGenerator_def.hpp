...
public:
  ...
  /// @brief Method GenerateWrappedKey, addr 0x334bb38, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x334b894, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* recipCert, ::Org::BouncyCastle::Crypto::IKeyWrapper* keyWrapper);

  /// @brief Method .ctor, addr 0x334b9cc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::Org::BouncyCastle::Crypto::IKeyWrapper* keyWrapper);

  /// @brief Method get_AlgorithmDetails, addr 0x334ba44, size 0xf4, virtual true, abstract: false, final false
