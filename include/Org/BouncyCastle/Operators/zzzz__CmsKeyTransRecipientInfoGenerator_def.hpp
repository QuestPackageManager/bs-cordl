...
public:
  ...
  /// @brief Method GenerateWrappedKey, addr 0x23b2fc0, size 0x130, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b2d14, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::X509::X509Certificate* recipCert, ::Org::BouncyCastle::Crypto::IKeyWrapper* keyWrapper);

  /// @brief Method .ctor, addr 0x23b2e60, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> subjectKeyID, ::Org::BouncyCastle::Crypto::IKeyWrapper* keyWrapper);

  /// @brief Method get_AlgorithmDetails, addr 0x23b2ed4, size 0xec, virtual true, abstract: false, final false
