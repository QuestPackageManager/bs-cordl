...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder*, "Org.BouncyCastle.Operators", "CmsContentEncryptorBuilder");
...
public:
  ...
  /// @brief Method Build, addr 0x340ae0c, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherBuilderWithKey* Build();

  /// @brief Method GetKeySize, addr 0x340ab98, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x340ad30, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* encryptionOID);

  /// @brief Method .ctor, addr 0x340ada4, size 0x68, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CmsContentEncryptorBuilder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CmsContentEncryptorBuilder(CmsContentEncryptorBuilder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CmsContentEncryptorBuilder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CmsContentEncryptorBuilder(CmsContentEncryptorBuilderconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Operators::CmsContentEncryptorBuilder) == 0x28, "Size mismatch!");
