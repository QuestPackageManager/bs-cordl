...
public:
  ...
  /// @brief Method Build, addr 0x32e4a58, size 0x64, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherBuilderWithKey* Build();

  /// @brief Method GetKeySize, addr 0x32e47e4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32e497c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* encryptionOID);

  /// @brief Method .ctor, addr 0x32e49f0, size 0x68, virtual false, abstract: false, final false
