...
public:
  ...
  /// @brief Method Build, addr 0x23b53f0, size 0x60, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Crypto::ICipherBuilderWithKey* Build();

  /// @brief Method GetKeySize, addr 0x23b5160, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23b5304, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier* encryptionOID);

  /// @brief Method .ctor, addr 0x23b5374, size 0x7c, virtual false, abstract: false, final false
