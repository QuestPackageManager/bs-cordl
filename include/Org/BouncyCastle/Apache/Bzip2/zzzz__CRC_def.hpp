...
public:
  ...
  /// @brief Method GetFinalCRC, addr 0x2600944, size 0xc, virtual false, abstract: false, final false
  inline int32_t GetFinalCRC();

  /// @brief Method GetGlobalCRC, addr 0x2601434, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetGlobalCRC();

  /// @brief Method InitialiseCRC, addr 0x260090c, size 0xc, virtual false, abstract: false, final false
  inline void InitialiseCRC();

  static inline ::Org::BouncyCastle::Apache::Bzip2::CRC* New_ctor();

  /// @brief Method SetGlobalCRC, addr 0x260143c, size 0x8, virtual false, abstract: false, final false
  inline void SetGlobalCRC(int32_t newCrc);

  /// @brief Method UpdateCRC, addr 0x26012a8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ff464, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
