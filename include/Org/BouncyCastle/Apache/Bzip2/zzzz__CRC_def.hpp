...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CRC", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CRC(CRC&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CRC", modifiers: "const&", def_value: None, comment: None }]
