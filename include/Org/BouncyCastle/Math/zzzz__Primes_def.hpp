...
/// @brief Method ProbablyPrime, addr 0x3475c38, size 0x50, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::Primes_MROutput* ProbablyPrime() ;

/// @brief Method ProvablyCompositeNotPrimePower, addr 0x3475cec, size 0x54, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::Primes_MROutput* ProvablyCompositeNotPrimePower() ;

/// @brief Method ProvablyCompositeWithFactor, addr 0x3475c94, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3475c88, size 0xc, virtual false, abstract: false, final false
inline void _ctor(bool  provablyComposite, ::Org::BouncyCastle::Math::BigInteger*  factor) ;

/// @brief Method get_Factor, addr 0x3475d40, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Factor() ;

/// @brief Method get_IsNotPrimePower, addr 0x3475d50, size 0x20, virtual false, abstract: false, final false
inline bool get_IsNotPrimePower() ;

/// @brief Method get_IsProvablyComposite, addr 0x3475d48, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3475d70, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  prime, ::ArrayW<uint8_t,::Array<uint8_t>*>  primeSeed, int32_t  primeGenCounter) ;

/// @brief Method get_Prime, addr 0x3475d7c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Prime() ;

/// @brief Method get_PrimeGenCounter, addr 0x3475d8c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PrimeGenCounter() ;

/// @brief Method get_PrimeSeed, addr 0x3475d84, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CheckCandidate, addr 0x34746e4, size 0x80, virtual false, abstract: false, final false
static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger*  n, ::StringW  name) ;

/// @brief Method EnhancedMRProbablePrimeTest, addr 0x347424c, size 0x498, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::Primes_MROutput* EnhancedMRProbablePrimeTest(::Org::BouncyCastle::Math::BigInteger*  candidate, ::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  iterations) ;

/// @brief Method Extract32, addr 0x34757f8, size 0xc0, virtual false, abstract: false, final false
static inline uint32_t Extract32(::ArrayW<uint8_t,::Array<uint8_t>*>  bs) ;

/// @brief Method GenerateSTRandomPrime, addr 0x3473a70, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method HasAnySmallFactors, addr 0x3474764, size 0x7c, virtual false, abstract: false, final false
static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger*  candidate) ;

/// @brief Method Hash, addr 0x347566c, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method HashGen, addr 0x3475a1c, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method ImplHasAnySmallFactors, addr 0x34747e0, size 0x920, virtual false, abstract: false, final false
static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method ImplMRProbablePrimeToBase, addr 0x3475338, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method ImplSTRandomPrime, addr 0x3473c14, size 0x638, virtual false, abstract: false, final false
...
/// @brief Method Inc, addr 0x34757a4, size 0x54, virtual false, abstract: false, final false
static inline void Inc(::ArrayW<uint8_t,::Array<uint8_t>*>  seed, int32_t  c) ;

/// @brief Method IsMRProbablePrime, addr 0x3475100, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method IsMRProbablePrimeToBase, addr 0x34754a8, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method IsPrime32, addr 0x34758b8, size 0x164, virtual false, abstract: false, final false
static inline bool IsPrime32(uint32_t  x) ;

static inline ::Org::BouncyCastle::Math::Primes* New_ctor() ;

/// @brief Method .ctor, addr 0x3475c34, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
