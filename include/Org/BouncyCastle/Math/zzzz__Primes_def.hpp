...
public:
  ...
  /// @brief Method ProbablyPrime, addr 0x10c8498, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProbablyPrime();

  /// @brief Method ProvablyCompositeWithFactor, addr 0x10c852c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProvablyCompositeNotPrimePower, addr 0x10c8598, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10c84fc, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger* factor);

  /// @brief Method get_Factor, addr 0x10c8600, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Factor();

  /// @brief Method get_IsProvablyComposite, addr 0x10c8608, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsProvablyComposite();

  /// @brief Method get_IsNotPrimePower, addr 0x10c8610, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x10c8630, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t, ::Array<uint8_t>*> primeSeed, int32_t primeGenCounter);

  /// @brief Method get_Prime, addr 0x10c866c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime();

  /// @brief Method get_PrimeSeed, addr 0x10c8674, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PrimeSeed();

  /// @brief Method get_PrimeGenCounter, addr 0x10c867c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GenerateSTRandomPrime, addr 0x10c6338, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method EnhancedMRProbablePrimeTest, addr 0x10c6b18, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAnySmallFactors, addr 0x10c7028, size 0x74, virtual false, abstract: false, final false
  static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* candidate);

  /// @brief Method IsMRProbablePrime, addr 0x10c7980, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRProbablePrimeToBase, addr 0x10c7d20, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckCandidate, addr 0x10c6fa4, size 0x84, virtual false, abstract: false, final false
  static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger* n, ::StringW name);

  /// @brief Method ImplHasAnySmallFactors, addr 0x10c709c, size 0x8e4, virtual false, abstract: false, final false
  static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImplMRProbablePrimeToBase, addr 0x10c7bb4, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSTRandomPrime, addr 0x10c64e4, size 0x634, virtual false, abstract: false, final false
  ...
  /// @brief Method Extract32, addr 0x10c8068, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t Extract32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method Hash, addr 0x10c7edc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method HashGen, addr 0x10c8280, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method Inc, addr 0x10c8010, size 0x58, virtual false, abstract: false, final false
  static inline void Inc(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t c);

  /// @brief Method IsPrime32, addr 0x10c8128, size 0x158, virtual false, abstract: false, final false
  static inline bool IsPrime32(uint32_t x);

  static inline ::Org::BouncyCastle::Math::Primes* New_ctor();

  /// @brief Method .ctor, addr 0x10c8490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
