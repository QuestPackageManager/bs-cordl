...
public:
  ...
  /// @brief Method ProbablyPrime, addr 0x130e97c, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProbablyPrime();

  /// @brief Method ProvablyCompositeNotPrimePower, addr 0x130ea7c, size 0x68, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProvablyCompositeNotPrimePower();

  /// @brief Method ProvablyCompositeWithFactor, addr 0x130ea10, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x130e9e0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger* factor);

  /// @brief Method get_Factor, addr 0x130eae4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Factor();

  /// @brief Method get_IsNotPrimePower, addr 0x130eaf4, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsNotPrimePower();

  /// @brief Method get_IsProvablyComposite, addr 0x130eaec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x130eb14, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t, ::Array<uint8_t>*> primeSeed, int32_t primeGenCounter);

  /// @brief Method get_Prime, addr 0x130eb50, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime();

  /// @brief Method get_PrimeGenCounter, addr 0x130eb60, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PrimeGenCounter();

  /// @brief Method get_PrimeSeed, addr 0x130eb58, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckCandidate, addr 0x130d488, size 0x84, virtual false, abstract: false, final false
  static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger* n, ::StringW name);

  /// @brief Method EnhancedMRProbablePrimeTest, addr 0x130cffc, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method Extract32, addr 0x130e54c, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t Extract32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method GenerateSTRandomPrime, addr 0x130c81c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAnySmallFactors, addr 0x130d50c, size 0x74, virtual false, abstract: false, final false
  static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* candidate);

  /// @brief Method Hash, addr 0x130e3c0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method HashGen, addr 0x130e764, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplHasAnySmallFactors, addr 0x130d580, size 0x8e4, virtual false, abstract: false, final false
  static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImplMRProbablePrimeToBase, addr 0x130e098, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSTRandomPrime, addr 0x130c9c8, size 0x634, virtual false, abstract: false, final false
  ...
  /// @brief Method Inc, addr 0x130e4f4, size 0x58, virtual false, abstract: false, final false
  static inline void Inc(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t c);

  /// @brief Method IsMRProbablePrime, addr 0x130de64, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRProbablePrimeToBase, addr 0x130e204, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPrime32, addr 0x130e60c, size 0x158, virtual false, abstract: false, final false
  static inline bool IsPrime32(uint32_t x);

  static inline ::Org::BouncyCastle::Math::Primes* New_ctor();

  /// @brief Method .ctor, addr 0x130e974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
