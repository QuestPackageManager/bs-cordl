...
public:
  ...
  /// @brief Method ProbablyPrime, addr 0x1305684, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProbablyPrime();

  /// @brief Method ProvablyCompositeNotPrimePower, addr 0x1305784, size 0x68, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProvablyCompositeNotPrimePower();

  /// @brief Method ProvablyCompositeWithFactor, addr 0x1305718, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13056e8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger* factor);

  /// @brief Method get_Factor, addr 0x13057ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Factor();

  /// @brief Method get_IsNotPrimePower, addr 0x13057fc, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsNotPrimePower();

  /// @brief Method get_IsProvablyComposite, addr 0x13057f4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x130581c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t, ::Array<uint8_t>*> primeSeed, int32_t primeGenCounter);

  /// @brief Method get_Prime, addr 0x1305858, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime();

  /// @brief Method get_PrimeGenCounter, addr 0x1305868, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_PrimeGenCounter();

  /// @brief Method get_PrimeSeed, addr 0x1305860, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckCandidate, addr 0x1304190, size 0x84, virtual false, abstract: false, final false
  static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger* n, ::StringW name);

  /// @brief Method EnhancedMRProbablePrimeTest, addr 0x1303d04, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method Extract32, addr 0x1305254, size 0xc0, virtual false, abstract: false, final false
  static inline uint32_t Extract32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method GenerateSTRandomPrime, addr 0x1303524, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method HasAnySmallFactors, addr 0x1304214, size 0x74, virtual false, abstract: false, final false
  static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* candidate);

  /// @brief Method Hash, addr 0x13050c8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method HashGen, addr 0x130546c, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplHasAnySmallFactors, addr 0x1304288, size 0x8e4, virtual false, abstract: false, final false
  static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImplMRProbablePrimeToBase, addr 0x1304da0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSTRandomPrime, addr 0x13036d0, size 0x634, virtual false, abstract: false, final false
  ...
  /// @brief Method Inc, addr 0x13051fc, size 0x58, virtual false, abstract: false, final false
  static inline void Inc(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t c);

  /// @brief Method IsMRProbablePrime, addr 0x1304b6c, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMRProbablePrimeToBase, addr 0x1304f0c, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPrime32, addr 0x1305314, size 0x158, virtual false, abstract: false, final false
  static inline bool IsPrime32(uint32_t x);

  static inline ::Org::BouncyCastle::Math::Primes* New_ctor();

  /// @brief Method .ctor, addr 0x130567c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
