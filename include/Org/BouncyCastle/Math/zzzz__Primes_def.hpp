...
public:
  ...
  /// @brief Method ProbablyPrime addr 0x102a3b8 size 0x64 virtual false final false
  static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProbablyPrime();

  /// @brief Method ProvablyCompositeWithFactor addr 0x102a44c size 0x6c virtual false final false
  ...
  /// @brief Method ProvablyCompositeNotPrimePower addr 0x102a4b8 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x102a41c size 0x30 virtual false final false
  inline void _ctor(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger* factor);

  /// @brief Method get_Factor addr 0x102a520 size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Factor();

  /// @brief Method get_IsProvablyComposite addr 0x102a528 size 0x8 virtual false final false
  inline bool get_IsProvablyComposite();

  /// @brief Method get_IsNotPrimePower addr 0x102a530 size 0x20 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x102a550 size 0x3c virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* prime, ::ArrayW<uint8_t, ::Array<uint8_t>*> primeSeed, int32_t primeGenCounter);

  /// @brief Method get_Prime addr 0x102a58c size 0x8 virtual false final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Prime();

  /// @brief Method get_PrimeSeed addr 0x102a594 size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PrimeSeed();

  /// @brief Method get_PrimeGenCounter addr 0x102a59c size 0x8 virtual false final false
...
public:
  ...
  /// @brief Method GenerateSTRandomPrime addr 0x1028258 size 0x1ac virtual false final false
  ...
  /// @brief Method EnhancedMRProbablePrimeTest addr 0x1028a38 size 0x48c virtual false final false
  ...
  /// @brief Method HasAnySmallFactors addr 0x1028f48 size 0x74 virtual false final false
  static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* candidate);

  /// @brief Method IsMRProbablePrime addr 0x10298a0 size 0x234 virtual false final false
  ...
  /// @brief Method IsMRProbablePrimeToBase addr 0x1029c40 size 0x1bc virtual false final false
  ...
  /// @brief Method CheckCandidate addr 0x1028ec4 size 0x84 virtual false final false
  static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger* n, ::StringW name);

  /// @brief Method ImplHasAnySmallFactors addr 0x1028fbc size 0x8e4 virtual false final false
  static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImplMRProbablePrimeToBase addr 0x1029ad4 size 0x16c virtual false final false
  ...
  /// @brief Method ImplSTRandomPrime addr 0x1028404 size 0x634 virtual false final false
  ...
  /// @brief Method Extract32 addr 0x1029f88 size 0xc0 virtual false final false
  static inline uint32_t Extract32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs);

  /// @brief Method Hash addr 0x1029dfc size 0x134 virtual false final false
  ...
  /// @brief Method HashGen addr 0x102a1a0 size 0x180 virtual false final false
  ...
  /// @brief Method Inc addr 0x1029f30 size 0x58 virtual false final false
  static inline void Inc(::ArrayW<uint8_t, ::Array<uint8_t>*> seed, int32_t c);

  /// @brief Method IsPrime32 addr 0x102a048 size 0x158 virtual false final false
  static inline bool IsPrime32(uint32_t x);

  static inline ::Org::BouncyCastle::Math::Primes* New_ctor();

  /// @brief Method .ctor addr 0x102a3b0 size 0x8 virtual false final false
  inline void _ctor();
