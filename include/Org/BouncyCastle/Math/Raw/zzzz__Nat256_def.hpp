...
public:
  // Declarations
  /// @brief Method Add addr 0x1018bfc size 0x19c virtual false final false
  ...
  /// @brief Method Add addr 0x1018d98 size 0x25c virtual false final false
  ...
  /// @brief Method AddBothTo addr 0x1018ff4 size 0x1dc virtual false final false
  ...
  /// @brief Method AddBothTo addr 0x10191d0 size 0x29c virtual false final false
  ...
  /// @brief Method AddTo addr 0x101946c size 0x158 virtual false final false
  static inline uint32_t AddTo(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddTo addr 0x10195c4 size 0x1e0 virtual false final false
  ...
  /// @brief Method AddToEachOther addr 0x10197a4 size 0x210 virtual false final false
  ...
  /// @brief Method Copy addr 0x10199b4 size 0xdc virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Copy addr 0x1019a90 size 0x15c virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t xOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t zOff);

  /// @brief Method Copy64 addr 0x1019bec size 0x88 virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Copy64 addr 0x1019c74 size 0xd4 virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, int32_t xOff, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method Create addr 0x1019d48 size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Create();

  /// @brief Method Create64 addr 0x1019d8c size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> Create64();

  /// @brief Method CreateExt addr 0x1019dd0 size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> CreateExt();

  /// @brief Method CreateExt64 addr 0x1019e14 size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> CreateExt64();

  /// @brief Method Diff addr 0x1019e58 size 0x7c virtual false final false
  ...
  /// @brief Method Mul addr 0x101ab84 size 0x36c virtual false final false
  ...
  /// @brief Method MulAddTo addr 0x101aef0 size 0x1b8 virtual false final false
  ...
  /// @brief Method MulAddTo addr 0x101b0a8 size 0x27c virtual false final false
  ...
  /// @brief Method Mul33Add addr 0x101b324 size 0x27c virtual false final false
  ...
  /// @brief Method MulByWord addr 0x101b5a0 size 0xdc virtual false final false
  static inline uint32_t MulByWord(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulByWordAddTo addr 0x101b67c size 0x15c virtual false final false
  static inline uint32_t MulByWordAddTo(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulWordAddTo addr 0x101b7d8 size 0x1dc virtual false final false
  ...
  /// @brief Method Sub addr 0x1019f54 size 0x25c virtual false final false
  ...
  /// @brief Method SubBothFrom addr 0x101c67c size 0x1dc virtual false final false
  ...
  /// @brief Method SubFrom addr 0x101c858 size 0x158 virtual false final false
  static inline int32_t SubFrom(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubFrom addr 0x101c9b0 size 0x1ec virtual false final false
