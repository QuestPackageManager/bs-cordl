...
public:
  // Declarations
  /// @brief Method Add, addr 0x10b6cdc, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x10b6e78, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBothTo, addr 0x10b70d4, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBothTo, addr 0x10b72b0, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTo, addr 0x10b754c, size 0x158, virtual false, abstract: false, final false
  static inline uint32_t AddTo(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddTo, addr 0x10b76a4, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddToEachOther, addr 0x10b7884, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method Copy, addr 0x10b7a94, size 0xdc, virtual false, abstract: false, final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Copy, addr 0x10b7b70, size 0x15c, virtual false, abstract: false, final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t xOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t zOff);

  /// @brief Method Copy64, addr 0x10b7ccc, size 0x88, virtual false, abstract: false, final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Copy64, addr 0x10b7d54, size 0xd4, virtual false, abstract: false, final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, int32_t xOff, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method Create, addr 0x10b7e28, size 0x44, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Create();

  /// @brief Method Create64, addr 0x10b7e6c, size 0x44, virtual false, abstract: false, final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> Create64();

  /// @brief Method CreateExt, addr 0x10b7eb0, size 0x44, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> CreateExt();

  /// @brief Method CreateExt64, addr 0x10b7ef4, size 0x44, virtual false, abstract: false, final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> CreateExt64();

  /// @brief Method Diff, addr 0x10b7f38, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Eq, addr 0x10b8290, size 0x68, virtual false, abstract: false, final false
  static inline bool Eq(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Eq64, addr 0x10b82f8, size 0x68, virtual false, abstract: false, final false
  static inline bool Eq64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> y);

  /// @brief Method FromBigInteger, addr 0x10b8360, size 0xd4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method FromBigInteger64, addr 0x10b86f4, size 0xd4, virtual false, abstract: false, final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> FromBigInteger64(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method GetBit, addr 0x10b8834, size 0x64, virtual false, abstract: false, final false
  static inline uint32_t GetBit(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t bit);

  /// @brief Method Gte, addr 0x10b8898, size 0x70, virtual false, abstract: false, final false
  static inline bool Gte(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Gte, addr 0x10b7fb4, size 0x80, virtual false, abstract: false, final false
  static inline bool Gte(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t xOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> y, int32_t yOff);

  /// @brief Method IsOne, addr 0x10b8908, size 0x60, virtual false, abstract: false, final false
  static inline bool IsOne(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method IsOne64, addr 0x10b8968, size 0x60, virtual false, abstract: false, final false
  static inline bool IsOne64(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method IsZero, addr 0x10b89c8, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsZero(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method IsZero64, addr 0x10b8a14, size 0x4c, virtual false, abstract: false, final false
  static inline bool IsZero64(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method Mul, addr 0x10b8a60, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method Mul, addr 0x10b8c64, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method MulAddTo, addr 0x10b8fd0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method MulAddTo, addr 0x10b9188, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method Mul33Add, addr 0x10b9404, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method MulByWord, addr 0x10b9680, size 0xdc, virtual false, abstract: false, final false
  static inline uint32_t MulByWord(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulByWordAddTo, addr 0x10b975c, size 0x15c, virtual false, abstract: false, final false
  static inline uint32_t MulByWordAddTo(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulWordAddTo, addr 0x10b98b8, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Sub, addr 0x10b8034, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method SubBothFrom, addr 0x10ba75c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SubFrom, addr 0x10ba938, size 0x158, virtual false, abstract: false, final false
  static inline int32_t SubFrom(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubFrom, addr 0x10baa90, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method ToBigInteger, addr 0x10bac7c, size 0xe0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method ToBigInteger64, addr 0x10bad78, size 0xe0, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger64(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method Zero, addr 0x10bae58, size 0x78, virtual false, abstract: false, final false
  static inline void Zero(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  static inline ::Org::BouncyCastle::Math::Raw::Nat256* New_ctor();

  /// @brief Method .ctor, addr 0x10baed0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
