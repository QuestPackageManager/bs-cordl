...
public:
  // Declarations
  /// @brief Method Add addr 0xff331c size 0x13c virtual false final false
  ...
  /// @brief Method AddBothTo addr 0xff3458 size 0x16c virtual false final false
  ...
  /// @brief Method AddTo addr 0xff35c4 size 0x108 virtual false final false
  static inline uint32_t AddTo(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddTo addr 0xff36cc size 0x170 virtual false final false
  ...
  /// @brief Method AddToEachOther addr 0xff383c size 0x190 virtual false final false
  ...
  /// @brief Method Copy addr 0xff39cc size 0xac virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Copy addr 0xff3a78 size 0x10c virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t xOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t zOff);

  /// @brief Method Copy64 addr 0xff3b84 size 0x6c virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Copy64 addr 0xff3bf0 size 0xa4 virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, int32_t xOff, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method Create addr 0xff3c94 size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Create();

  /// @brief Method Create64 addr 0xff3cd8 size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> Create64();

  /// @brief Method CreateExt addr 0xff3d1c size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> CreateExt();

  /// @brief Method CreateExt64 addr 0xff3d60 size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> CreateExt64();

  /// @brief Method Diff addr 0xff3da4 size 0x7c virtual false final false
  ...
  /// @brief Method Mul addr 0xff46c4 size 0x29c virtual false final false
  ...
  /// @brief Method MulAddTo addr 0xff4960 size 0x164 virtual false final false
  ...
  /// @brief Method MulAddTo addr 0xff4ac4 size 0x1f8 virtual false final false
  ...
  /// @brief Method Mul33Add addr 0xff4cbc size 0x1e4 virtual false final false
  ...
  /// @brief Method MulWordAddExt addr 0xff4ea0 size 0x16c virtual false final false
  ...
  /// @brief Method Sub addr 0xff3ea0 size 0x1cc virtual false final false
  ...
  /// @brief Method SubBothFrom addr 0xff59b8 size 0x16c virtual false final false
  ...
  /// @brief Method SubFrom addr 0xff5b24 size 0x108 virtual false final false
  static inline int32_t SubFrom(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubFrom addr 0xff5c2c size 0x174 virtual false final false
