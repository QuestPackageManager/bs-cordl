...
public:
  // Declarations
  /// @brief Method Mul, addr 0x3562e58, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Square, addr 0x3562f9c, size 0xf8, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> zz);

  /// @brief Method .ctor, addr 0x3563094, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
