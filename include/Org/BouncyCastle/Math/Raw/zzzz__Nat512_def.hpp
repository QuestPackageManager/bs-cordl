...
public:
  // Declarations
  /// @brief Method Mul, addr 0x343ee2c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Square, addr 0x343ef70, size 0xf8, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> zz);

  /// @brief Method .ctor, addr 0x343f068, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
