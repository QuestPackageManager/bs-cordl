...
public:
  // Declarations
  /// @brief Method Copy64 addr 0x101d580 size 0xdc virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Copy64 addr 0x101d65c size 0x164 virtual false final false
  static inline void Copy64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, int32_t xOff, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method Create64 addr 0x101d7c0 size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> Create64();

  /// @brief Method CreateExt64 addr 0x101d804 size 0x44 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> CreateExt64();

  /// @brief Method Eq64 addr 0x101d848 size 0x68 virtual false final false
  static inline bool Eq64(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> y);

  /// @brief Method FromBigInteger64 addr 0x101d8b0 size 0xd4 virtual false final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> FromBigInteger64(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method IsOne64 addr 0x101d984 size 0x60 virtual false final false
  static inline bool IsOne64(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method IsZero64 addr 0x101d9e4 size 0x4c virtual false final false
  static inline bool IsZero64(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method ToBigInteger64 addr 0x101da30 size 0xe0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x101db10 size 0x8 virtual false final false
  inline void _ctor();
