...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Nat320", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Nat320(Nat320&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Nat320", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Nat320(Nat320const&) = delete;
