...
public:
  // Declarations
  /// @brief Method Mul addr 0x101d2f8 size 0x16c virtual false final false
  ...
  /// @brief Method Square addr 0x101d464 size 0x114 virtual false final false
  ...
  /// @brief Method .ctor addr 0x101d578 size 0x8 virtual false final false
  inline void _ctor();
