...
public:
  // Declarations
  /// @brief Method Mul, addr 0x10bb3d8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method Square, addr 0x10bb544, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10bb658, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
