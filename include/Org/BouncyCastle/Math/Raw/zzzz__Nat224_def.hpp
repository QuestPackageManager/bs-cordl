...
public:
  // Declarations
  /// @brief Method Add addr 0xff5fd0 size 0x16c virtual false final false
  ...
  /// @brief Method Add addr 0xff613c size 0x214 virtual false final false
  ...
  /// @brief Method AddBothTo addr 0xff6350 size 0x1a4 virtual false final false
  ...
  /// @brief Method AddBothTo addr 0xff64f4 size 0x24c virtual false final false
  ...
  /// @brief Method AddTo addr 0xff6740 size 0x130 virtual false final false
  static inline uint32_t AddTo(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddTo addr 0xff6870 size 0x1a8 virtual false final false
  ...
  /// @brief Method AddToEachOther addr 0xff6a18 size 0x1d0 virtual false final false
  ...
  /// @brief Method Copy addr 0xff6be8 size 0xc4 virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Copy addr 0xff6cac size 0x134 virtual false final false
  static inline void Copy(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t xOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t zOff);

  /// @brief Method Create addr 0xff6de0 size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Create();

  /// @brief Method CreateExt addr 0xff6e24 size 0x44 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> CreateExt();

  /// @brief Method Diff addr 0xff6e68 size 0x7c virtual false final false
  ...
  /// @brief Method Mul addr 0xff7614 size 0x2ec virtual false final false
  ...
  /// @brief Method MulAddTo addr 0xff7900 size 0x190 virtual false final false
  ...
  /// @brief Method MulAddTo addr 0xff7a90 size 0x240 virtual false final false
  ...
  /// @brief Method Mul33Add addr 0xff7cd0 size 0x230 virtual false final false
  ...
  /// @brief Method MulByWord addr 0xff7f00 size 0xc4 virtual false final false
  static inline uint32_t MulByWord(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulByWordAddTo addr 0xff7fc4 size 0x134 virtual false final false
  static inline uint32_t MulByWordAddTo(uint32_t x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method MulWordAddTo addr 0xff80f8 size 0x1a4 virtual false final false
  ...
  /// @brief Method Sub addr 0xff6f64 size 0x214 virtual false final false
  ...
  /// @brief Method SubBothFrom addr 0xff8dc0 size 0x1a4 virtual false final false
  ...
  /// @brief Method SubFrom addr 0xff8f64 size 0x130 virtual false final false
  static inline int32_t SubFrom(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubFrom addr 0xff9094 size 0x1b0 virtual false final false
  ...
  /// @brief Method ToBigInteger addr 0xff9244 size 0xe4 virtual false final false
  static inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method Zero addr 0xff9328 size 0x6c virtual false final false
  static inline void Zero(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  static inline ::Org::BouncyCastle::Math::Raw::Nat224* New_ctor();

  /// @brief Method .ctor addr 0xff9394 size 0x8 virtual false final false
  inline void _ctor();
