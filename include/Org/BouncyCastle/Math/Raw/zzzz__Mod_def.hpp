...
public:
  ...
  /// @brief Method Add, addr 0x24de524, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionResult, addr 0x24de29c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionStep, addr 0x24de170, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Invert, addr 0x24ddc14, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x24de3cc, size 0x158, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Random(::ArrayW<uint32_t, ::Array<uint32_t>*> p);

  /// @brief Method Subtract, addr 0x24de604, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24de8e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
