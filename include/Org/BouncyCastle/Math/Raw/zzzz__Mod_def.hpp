...
public:
  ...
  /// @brief Method Add, addr 0x12c692c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionResult, addr 0x12c66a4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionStep, addr 0x12c6594, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Invert, addr 0x12c6048, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x12c67d4, size 0x158, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Random(::ArrayW<uint32_t, ::Array<uint32_t>*> p);

  /// @brief Method Subtract, addr 0x12c6a0c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c6d00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
