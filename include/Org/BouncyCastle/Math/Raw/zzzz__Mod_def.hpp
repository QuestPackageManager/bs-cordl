...
public:
  ...
  /// @brief Method Add, addr 0x12bd0bc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionResult, addr 0x12bce34, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionStep, addr 0x12bcd24, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Invert, addr 0x12bc7d8, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x12bcf64, size 0x158, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Random(::ArrayW<uint32_t, ::Array<uint32_t>*> p);

  /// @brief Method Subtract, addr 0x12bd19c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bd490, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
