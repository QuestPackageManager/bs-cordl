...
public:
  ...
  /// @brief Method Invert addr 0xfead80 size 0x3c4 virtual false final false
  ...
  /// @brief Method Random addr 0xfeb50c size 0x158 virtual false final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Random(::ArrayW<uint32_t, ::Array<uint32_t>*> p);

  /// @brief Method Add addr 0xfeb664 size 0x4c virtual false final false
  ...
  /// @brief Method Subtract addr 0xfeb744 size 0x4c virtual false final false
  ...
  /// @brief Method InversionResult addr 0xfeb3dc size 0x48 virtual false final false
  ...
  /// @brief Method InversionStep addr 0xfeb2cc size 0x110 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfeba38 size 0x8 virtual false final false
  inline void _ctor();
