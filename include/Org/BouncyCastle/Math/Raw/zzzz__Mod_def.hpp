...
public:
  ...
  /// @brief Method Add, addr 0x24de4e4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionResult, addr 0x24de25c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method InversionStep, addr 0x24de130, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method Invert, addr 0x24ddbd4, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x24de38c, size 0x158, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> Random(::ArrayW<uint32_t, ::Array<uint32_t>*> p);

  /// @brief Method Subtract, addr 0x24de5c4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24de8a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
