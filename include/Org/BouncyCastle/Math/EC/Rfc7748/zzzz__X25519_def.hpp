...
public:
  // Declarations
  /// @brief Method CalculateAgreement, addr 0x11aa110, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Decode32, addr 0x11aa4e8, size 0x68, virtual false, abstract: false, final false
  static inline uint32_t Decode32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method DecodeScalar, addr 0x11aa550, size 0x90, virtual false, abstract: false, final false
  static inline void DecodeScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> k, int32_t kOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> n);

  /// @brief Method GeneratePrivateKey, addr 0x11aa5e0, size 0x58, virtual false, abstract: false, final false
  static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom* random, ::ArrayW<uint8_t, ::Array<uint8_t>*> k);

  /// @brief Method GeneratePublicKey, addr 0x11aa638, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PointDouble, addr 0x11aa738, size 0xe8, virtual false, abstract: false, final false
  static inline void PointDouble(::ArrayW<int32_t, ::Array<int32_t>*> x, ::ArrayW<int32_t, ::Array<int32_t>*> z);

  /// @brief Method Precompute, addr 0x11ab3f8, size 0x4c, virtual false, abstract: false, final false
  static inline void Precompute();

  /// @brief Method ScalarMult, addr 0x11aa1c4, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method ScalarMultBase, addr 0x11aa63c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11ac0ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
