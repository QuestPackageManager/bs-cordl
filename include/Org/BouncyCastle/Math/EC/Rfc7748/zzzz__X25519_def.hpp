...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Rfc7748::X25519*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Rfc7748::X25519*, "Org.BouncyCastle.Math.EC.Rfc7748", "X25519");
...
public:
  // Declarations
  /// @brief Method CalculateAgreement, addr 0x351253c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Decode32, addr 0x3512918, size 0x68, virtual false, abstract: false, final false
  static inline uint32_t Decode32(::ArrayW<uint8_t> bs, int32_t off);

  /// @brief Method DecodeScalar, addr 0x3512980, size 0x90, virtual false, abstract: false, final false
  static inline void DecodeScalar(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint32_t> n);

  /// @brief Method GeneratePrivateKey, addr 0x3512a10, size 0x58, virtual false, abstract: false, final false
  static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom* random, ::ArrayW<uint8_t> k);

  /// @brief Method GeneratePublicKey, addr 0x3512a68, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PointDouble, addr 0x3512b70, size 0xec, virtual false, abstract: false, final false
  static inline void PointDouble(::ArrayW<int32_t> x, ::ArrayW<int32_t> z);

  /// @brief Method Precompute, addr 0x35137a0, size 0x50, virtual false, abstract: false, final false
  static inline void Precompute();

  /// @brief Method ScalarMult, addr 0x35125f4, size 0x324, virtual false, abstract: false, final false
  static inline void ScalarMult(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> u, int32_t uOff, ::ArrayW<uint8_t> r, int32_t rOff);

  /// @brief Method ScalarMultBase, addr 0x3512a6c, size 0x104, virtual false, abstract: false, final false
  static inline void ScalarMultBase(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> r, int32_t rOff);

  /// @brief Method .ctor, addr 0x3514490, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X25519", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X25519(X25519&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X25519", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X25519(X25519const&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Rfc7748::X25519) == 0x10, "Size mismatch!");
