...
public:
  // Declarations
  /// @brief Method CalculateAgreement addr 0xfc8ddc size 0xb4 virtual false final false
  ...
  /// @brief Method Decode32 addr 0xfc91b4 size 0x68 virtual false final false
  static inline uint32_t Decode32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method DecodeScalar addr 0xfc921c size 0x90 virtual false final false
  static inline void DecodeScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> k, int32_t kOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> n);

  /// @brief Method GeneratePrivateKey addr 0xfc92ac size 0x58 virtual false final false
  static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom* random, ::ArrayW<uint8_t, ::Array<uint8_t>*> k);

  /// @brief Method GeneratePublicKey addr 0xfc9304 size 0x4 virtual false final false
  ...
  /// @brief Method PointDouble addr 0xfc9404 size 0xe8 virtual false final false
  static inline void PointDouble(::ArrayW<int32_t, ::Array<int32_t>*> x, ::ArrayW<int32_t, ::Array<int32_t>*> z);

  /// @brief Method Precompute addr 0xfca0c4 size 0x4c virtual false final false
  static inline void Precompute();

  /// @brief Method ScalarMult addr 0xfc8e90 size 0x324 virtual false final false
  ...
  /// @brief Method ScalarMultBase addr 0xfc9308 size 0xfc virtual false final false
  ...
  /// @brief Method .ctor addr 0xfcadb8 size 0x8 virtual false final false
  inline void _ctor();
