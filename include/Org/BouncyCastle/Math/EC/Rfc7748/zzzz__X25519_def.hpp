...
public:
  // Declarations
  /// @brief Method CalculateAgreement, addr 0x12a40a4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Decode32, addr 0x12a447c, size 0x68, virtual false, abstract: false, final false
  static inline uint32_t Decode32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method DecodeScalar, addr 0x12a44e4, size 0x90, virtual false, abstract: false, final false
  static inline void DecodeScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> k, int32_t kOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> n);

  /// @brief Method GeneratePrivateKey, addr 0x12a4574, size 0x58, virtual false, abstract: false, final false
  static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom* random, ::ArrayW<uint8_t, ::Array<uint8_t>*> k);

  /// @brief Method GeneratePublicKey, addr 0x12a45cc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method PointDouble, addr 0x12a46cc, size 0xe8, virtual false, abstract: false, final false
  static inline void PointDouble(::ArrayW<int32_t, ::Array<int32_t>*> x, ::ArrayW<int32_t, ::Array<int32_t>*> z);

  /// @brief Method Precompute, addr 0x12a538c, size 0x4c, virtual false, abstract: false, final false
  static inline void Precompute();

  /// @brief Method ScalarMult, addr 0x12a4158, size 0x324, virtual false, abstract: false, final false
  ...
  /// @brief Method ScalarMultBase, addr 0x12a45d0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a6080, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
