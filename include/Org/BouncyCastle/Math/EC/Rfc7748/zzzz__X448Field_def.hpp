...
public:
  ...
  /// @brief Method .ctor addr 0xfcd968 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method Add addr 0xfcc1cc size 0x70 virtual false final false
  ...
  /// @brief Method AddOne addr 0xfcd970 size 0x2c virtual false final false
  static inline void AddOne(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddOne addr 0xfcd99c size 0x38 virtual false final false
  static inline void AddOne(::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t zOff);

  /// @brief Method Carry addr 0xfcd9d4 size 0x180 virtual false final false
  static inline void Carry(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method CMov addr 0xfcdb54 size 0x80 virtual false final false
  ...
  /// @brief Method Negate addr 0xfce140 size 0x28 virtual false final false
  static inline void Negate(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Normalize addr 0xfcd888 size 0x20 virtual false final false
  static inline void Normalize(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method One addr 0xfce21c size 0x54 virtual false final false
  static inline void One(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method PowPm3d4 addr 0xfcde9c size 0x1f0 virtual false final false
  static inline void PowPm3d4(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Reduce addr 0xfce168 size 0xb4 virtual false final false
  static inline void Reduce(::ArrayW<uint32_t, ::Array<uint32_t>*> z, int32_t x);

  /// @brief Method Sqr addr 0xfcc5b0 size 0x5ac virtual false final false
  static inline void Sqr(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Sqr addr 0xfce08c size 0x48 virtual false final false
  static inline void Sqr(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t n, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SqrtRatioVar addr 0xfce270 size 0x12c virtual false final false
  ...
  /// @brief Method Sub addr 0xfcc23c size 0x374 virtual false final false
  ...
  /// @brief Method SubOne addr 0xfce39c size 0x3c virtual false final false
  static inline void SubOne(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Zero addr 0xfce3d8 size 0x3c virtual false final false
