...
public:
  ...
  /// @brief Method Copy, addr 0x24db7e8, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method Lookup, addr 0x24db938, size 0x4c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x24db984, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24db8d4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x24db91c, size 0x1c, virtual true, abstract: false, final false
