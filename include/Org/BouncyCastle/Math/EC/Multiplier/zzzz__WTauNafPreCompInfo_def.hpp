...
public:
  ...
  /// @brief Method .ctor, addr 0x24bcecc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PreComp, addr 0x24bced4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PreComp, addr 0x24bcedc, size 0x8, virtual true, abstract: false, final false
