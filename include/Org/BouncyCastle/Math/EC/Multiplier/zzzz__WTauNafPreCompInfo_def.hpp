...
public:
  ...
  /// @brief Method .ctor, addr 0x24bce8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PreComp, addr 0x24bce94, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PreComp, addr 0x24bce9c, size 0x8, virtual true, abstract: false, final false
