...
public:
  ...
  /// @brief Method .ctor, addr 0x24b941c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PreComp, addr 0x24b9424, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PreComp, addr 0x24b942c, size 0x8, virtual true, abstract: false, final false
