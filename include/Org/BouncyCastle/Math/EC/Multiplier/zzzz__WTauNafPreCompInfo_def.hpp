...
public:
  ...
  /// @brief Method .ctor, addr 0x24bd554, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PreComp, addr 0x24bd55c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_PreComp, addr 0x24bd564, size 0x8, virtual true, abstract: false, final false
