...
public:
  ...
  /// @brief Method DecrementPromotionCountdown, addr 0x24b9fe4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24ba0c4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ConfWidth, addr 0x24ba074, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_ConfWidth();

  /// @brief Method get_IsPromoted, addr 0x24ba058, size 0x1c, virtual true, abstract: false, final false
  inline bool get_IsPromoted();

  /// @brief Method get_PreComp, addr 0x24ba084, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> get_PreComp();

  /// @brief Method get_PreCompNeg, addr 0x24ba094, size 0x8, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> get_PreCompNeg();

  /// @brief Method get_PromotionCountdown, addr 0x24ba01c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_PromotionCountdown();

  /// @brief Method get_Twice, addr 0x24ba0a4, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Twice();

  /// @brief Method get_Width, addr 0x24ba0b4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_ConfWidth, addr 0x24ba07c, size 0x8, virtual true, abstract: false, final false
  inline void set_ConfWidth(int32_t value);

  /// @brief Method set_PreComp, addr 0x24ba08c, size 0x8, virtual true, abstract: false, final false
  inline void set_PreComp(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> value);

  /// @brief Method set_PreCompNeg, addr 0x24ba09c, size 0x8, virtual true, abstract: false, final false
  inline void set_PreCompNeg(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> value);

  /// @brief Method set_PromotionCountdown, addr 0x24ba034, size 0x24, virtual false, abstract: false, final false
  inline void set_PromotionCountdown(int32_t value);

  /// @brief Method set_Twice, addr 0x24ba0ac, size 0x8, virtual true, abstract: false, final false
  inline void set_Twice(::Org::BouncyCastle::Math::EC::ECPoint* value);

  /// @brief Method set_Width, addr 0x24ba0bc, size 0x8, virtual true, abstract: false, final false
