...
/// @brief Method DecrementPromotionCountdown, addr 0x3413958, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34139f8, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConfWidth, addr 0x34139a8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConfWidth() ;

/// @brief Method get_IsPromoted, addr 0x3413994, size 0x14, virtual true, abstract: false, final false
inline bool get_IsPromoted() ;

/// @brief Method get_PreComp, addr 0x34139b8, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> get_PreComp() ;

/// @brief Method get_PreCompNeg, addr 0x34139c8, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> get_PreCompNeg() ;

/// @brief Method get_PromotionCountdown, addr 0x341397c, size 0xc, virtual false, abstract: false, final false
inline int32_t get_PromotionCountdown() ;

/// @brief Method get_Twice, addr 0x34139d8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Twice() ;

/// @brief Method get_Width, addr 0x34139e8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_ConfWidth, addr 0x34139b0, size 0x8, virtual true, abstract: false, final false
inline void set_ConfWidth(int32_t  value) ;

/// @brief Method set_PreComp, addr 0x34139c0, size 0x8, virtual true, abstract: false, final false
inline void set_PreComp(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*>  value) ;

/// @brief Method set_PreCompNeg, addr 0x34139d0, size 0x8, virtual true, abstract: false, final false
inline void set_PreCompNeg(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*>  value) ;

/// @brief Method set_PromotionCountdown, addr 0x3413988, size 0xc, virtual false, abstract: false, final false
inline void set_PromotionCountdown(int32_t  value) ;

/// @brief Method set_Twice, addr 0x34139e0, size 0x8, virtual true, abstract: false, final false
inline void set_Twice(::Org::BouncyCastle::Math::EC::ECPoint*  value) ;

/// @brief Method set_Width, addr 0x34139f0, size 0x8, virtual true, abstract: false, final false
