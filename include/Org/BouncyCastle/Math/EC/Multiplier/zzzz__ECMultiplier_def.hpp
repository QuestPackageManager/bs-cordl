...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "ECMultiplier");
// Dependencies
namespace Org::BouncyCastle::Math::EC::Multiplier {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ECMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECMultiplier(ECMultiplierconst&) = delete;
