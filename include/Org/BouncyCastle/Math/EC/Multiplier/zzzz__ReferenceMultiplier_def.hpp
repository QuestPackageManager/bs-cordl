...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ReferenceMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ReferenceMultiplier(ReferenceMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ReferenceMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ReferenceMultiplier(ReferenceMultiplierconst&) = delete;
