...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x350c984, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350c994, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
