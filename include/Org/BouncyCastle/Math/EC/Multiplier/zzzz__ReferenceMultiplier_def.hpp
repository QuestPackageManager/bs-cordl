...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x34130ec, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34130fc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
