...
public:
  ...
  /// @brief Method CheckExisting, addr 0x350dedc, size 0x38, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* existingFP, int32_t n);

  /// @brief Method CheckTable, addr 0x350df14, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x350daa4, size 0x438, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x350da30, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FixedPointUtilities_FixedPointCallback", modifiers: "&&", def_value: None, comment: None }]
...
public:
  ...
  /// @brief Method GetCombSize, addr 0x350d810, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t GetCombSize(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetFixedPointPreCompInfo, addr 0x350d9b4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x350d85c, size 0x114, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x350daa0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FixedPointUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
