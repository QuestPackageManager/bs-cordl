...
public:
  ...
  /// @brief Method .ctor addr 0xfc40e0 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method Precompute addr 0xfc4170 size 0x434 virtual true final true
  ...
  /// @brief Method CheckExisting addr 0xfc45a4 size 0x38 virtual false final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* existingFP, int32_t n);

  /// @brief Method CheckTable addr 0xfc45dc size 0xb0 virtual false final false
...
public:
  ...
  /// @brief Method GetCombSize addr 0xfc3eb0 size 0x4c virtual false final false
  static inline int32_t GetCombSize(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetFixedPointPreCompInfo addr 0xfc4068 size 0x78 virtual false final false
  ...
  /// @brief Method Precompute addr 0xfc3efc size 0x120 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfc4168 size 0x8 virtual false final false
  inline void _ctor();
