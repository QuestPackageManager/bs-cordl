...
public:
  ...
  /// @brief Method CheckExisting, addr 0x24bcd18, size 0x38, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* existingFP, int32_t n);

  /// @brief Method CheckTable, addr 0x24bcd50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x24bc8e0, size 0x438, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24bc850, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetCombSize, addr 0x24bc624, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t GetCombSize(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetFixedPointPreCompInfo, addr 0x24bc7d8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x24bc670, size 0x11c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x24bc8d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
