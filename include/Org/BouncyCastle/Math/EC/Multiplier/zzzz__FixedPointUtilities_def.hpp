...
public:
  ...
  /// @brief Method CheckExisting, addr 0x341236c, size 0x38, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* existingFP, int32_t n);

  /// @brief Method CheckTable, addr 0x34123a4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x3411f34, size 0x438, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3411ec0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetCombSize, addr 0x3411ca0, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t GetCombSize(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method GetFixedPointPreCompInfo, addr 0x3411e44, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x3411cec, size 0x114, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x3411f30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
