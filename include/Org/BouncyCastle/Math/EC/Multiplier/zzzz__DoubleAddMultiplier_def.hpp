...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x350d39c, size 0x1c4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350d560, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DoubleAddMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DoubleAddMultiplier(DoubleAddMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DoubleAddMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DoubleAddMultiplier(DoubleAddMultiplierconst&) = delete;
