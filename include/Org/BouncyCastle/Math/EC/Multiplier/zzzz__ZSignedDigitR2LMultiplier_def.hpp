...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x35123f8, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3512538, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ZSignedDigitR2LMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ZSignedDigitR2LMultiplier(ZSignedDigitR2LMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ZSignedDigitR2LMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ZSignedDigitR2LMultiplier(ZSignedDigitR2LMultiplierconst&) = delete;
