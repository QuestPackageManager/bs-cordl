...
public:
  ...
  /// @brief Method .ctor, addr 0x344e3c8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LookupTable, addr 0x344e398, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECLookupTable* get_LookupTable();

  /// @brief Method get_Offset, addr 0x344e3a8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Offset();

  /// @brief Method get_Width, addr 0x344e3b8, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method set_LookupTable, addr 0x344e3a0, size 0x8, virtual true, abstract: false, final false
  inline void set_LookupTable(::Org::BouncyCastle::Math::EC::ECLookupTable* value);

  /// @brief Method set_Offset, addr 0x344e3b0, size 0x8, virtual true, abstract: false, final false
  inline void set_Offset(::Org::BouncyCastle::Math::EC::ECPoint* value);

  /// @brief Method set_Width, addr 0x344e3c0, size 0x8, virtual true, abstract: false, final false
