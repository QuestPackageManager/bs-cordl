...
public:
  ...
  /// @brief Method ConfigureCurve, addr 0x350e758, size 0x120, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* c, int32_t coord);

  /// @brief Method MultiplyPositive, addr 0x350e2f4, size 0x1ec, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350e2dc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x350e2ec, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::MixedNafR2LMultiplier) == 0x18, "Size mismatch!");
