...
public:
  ...
  /// @brief Method ConfigureCurve, addr 0x10cc5fc, size 0x134, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve* c, int32_t coord);

  /// @brief Method MultiplyPositive, addr 0x10cc1a0, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cc150, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x10cc174, size 0x2c, virtual false, abstract: false, final false
