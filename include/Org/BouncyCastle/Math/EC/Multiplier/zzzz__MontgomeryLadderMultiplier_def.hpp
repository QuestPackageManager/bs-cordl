...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "MontgomeryLadderMultiplier");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MontgomeryLadderMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MontgomeryLadderMultiplier(MontgomeryLadderMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MontgomeryLadderMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MontgomeryLadderMultiplier(MontgomeryLadderMultiplierconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::MontgomeryLadderMultiplier) == 0x10, "Size mismatch!");
