...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x350ea80, size 0x138, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350ebb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NafL2RMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NafL2RMultiplier(NafL2RMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NafL2RMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NafL2RMultiplier(NafL2RMultiplierconst&) = delete;
