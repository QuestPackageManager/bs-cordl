...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FixedPointCombMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FixedPointCombMultiplier(FixedPointCombMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FixedPointCombMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FixedPointCombMultiplier(FixedPointCombMultiplierconst&) = delete;
