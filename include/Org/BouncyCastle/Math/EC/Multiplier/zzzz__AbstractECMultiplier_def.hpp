...
public:
  ...
  /// @brief Method CheckResult, addr 0x341181c, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method Multiply, addr 0x3411750, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3411828, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
