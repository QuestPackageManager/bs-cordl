...
public:
  ...
  /// @brief Method CheckResult, addr 0x350b004, size 0xc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method Multiply, addr 0x350af38, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350b010, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
