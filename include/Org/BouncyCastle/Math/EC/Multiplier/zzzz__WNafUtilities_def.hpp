...
public:
  ...
  /// @brief Method Precompute, addr 0x12a2250, size 0x1b8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12a1204, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Precompute, addr 0x12a2408, size 0x378, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x12a1ecc, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x12a2f64, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckTable, addr 0x12a306c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x12a2780, size 0x7e4, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x12a1f0c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x12a3490, size 0x9c, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* existingWNaf, int32_t width, int32_t reqPreCompLen, bool includeNegated);

  /// @brief Method CheckTable, addr 0x12a352c, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> table, int32_t reqLen);
  ...
  /// @brief Method Precompute, addr 0x12a3088, size 0x408, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x12a208c, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0x12a1084, size 0x180, virtual false, abstract: false, final false
  static inline void ConfigureBasepoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GenerateCompactNaf, addr 0x129fea0, size 0x274, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateCompactNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateCompactWindowNaf, addr 0x12a0c58, size 0x30c, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateCompactWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateJsf, addr 0x12a12b8, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateNaf, addr 0x12a15d4, size 0x188, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateWindowNaf, addr 0x12a175c, size 0x2d8, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetNafWeight, addr 0x12a1a34, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetNafWeight(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetWNafPreCompInfo, addr 0x12a1a98, size 0x98, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* GetWNafPreCompInfo(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GetWNafPreCompInfo, addr 0x12a1b30, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowSize, addr 0x12a0ab8, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits);

  /// @brief Method GetWindowSize, addr 0x12a1c60, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, int32_t maxWidth);

  /// @brief Method GetWindowSize, addr 0x12a1cd0, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t, ::Array<int32_t>*> windowSizeCutoffs);

  /// @brief Method GetWindowSize, addr 0x12a1ba8, size 0xb8, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t, ::Array<int32_t>*> windowSizeCutoffs, int32_t maxWidth);

  /// @brief Method MapPointWithPrecomp, addr 0x12a1d40, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x12a0b1c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method PrecomputeWithPointMap, addr 0x12a1f4c, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizeTable, addr 0x12a20d0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Trim, addr 0x12a1234, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> Trim(::ArrayW<int32_t, ::Array<int32_t>*> a, int32_t length);

  /// @brief Method Trim, addr 0x12a1550, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Trim(::ArrayW<uint8_t, ::Array<uint8_t>*> a, int32_t length);

  /// @brief Method .ctor, addr 0x12a2248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
