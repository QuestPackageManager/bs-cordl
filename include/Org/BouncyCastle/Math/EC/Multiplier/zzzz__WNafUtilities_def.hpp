...
public:
  ...
  /// @brief Method Precompute, addr 0x24b8f70, size 0x1b0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24b7f28, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Precompute, addr 0x24b9120, size 0x374, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x24b8bf0, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x24b9c58, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckTable, addr 0x24b9d60, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x24b9494, size 0x7c4, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x24b8c30, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x24ba188, size 0x9c, virtual false, abstract: false, final false
  inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* existingWNaf, int32_t width, int32_t reqPreCompLen, bool includeNegated);

  /// @brief Method CheckTable, addr 0x24ba224, size 0x1c, virtual false, abstract: false, final false
  inline bool CheckTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> table, int32_t reqLen);
  ...
  /// @brief Method Precompute, addr 0x24b9d7c, size 0x40c, virtual true, abstract: false, final true
  inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* existing);
  ...
  /// @brief Method .ctor, addr 0x24b8dac, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ConfigureBasepoint, addr 0x24b7dac, size 0x17c, virtual false, abstract: false, final false
  static inline void ConfigureBasepoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GenerateCompactNaf, addr 0x24b6bf0, size 0x270, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateCompactNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateCompactWindowNaf, addr 0x24b7984, size 0x308, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GenerateCompactWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateJsf, addr 0x24b7fdc, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateNaf, addr 0x24b82f8, size 0x188, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateNaf(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GenerateWindowNaf, addr 0x24b8480, size 0x2cc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GenerateWindowNaf(int32_t width, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetNafWeight, addr 0x24b874c, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetNafWeight(::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method GetWNafPreCompInfo, addr 0x24b87b0, size 0x98, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* GetWNafPreCompInfo(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method GetWNafPreCompInfo, addr 0x24b8848, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWindowSize, addr 0x24b77e8, size 0x64, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits);

  /// @brief Method GetWindowSize, addr 0x24b8988, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, int32_t maxWidth);

  /// @brief Method GetWindowSize, addr 0x24b89f8, size 0x70, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t, ::Array<int32_t>*> windowSizeCutoffs);

  /// @brief Method GetWindowSize, addr 0x24b88c0, size 0xc8, virtual false, abstract: false, final false
  static inline int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t, ::Array<int32_t>*> windowSizeCutoffs, int32_t maxWidth);

  /// @brief Method MapPointWithPrecomp, addr 0x24b8a68, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x24b784c, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method PrecomputeWithPointMap, addr 0x24b8c70, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizeTable, addr 0x24b8df0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method Trim, addr 0x24b7f58, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> Trim(::ArrayW<int32_t, ::Array<int32_t>*> a, int32_t length);

  /// @brief Method Trim, addr 0x24b8274, size 0x84, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Trim(::ArrayW<uint8_t, ::Array<uint8_t>*> a, int32_t length);

  /// @brief Method .ctor, addr 0x24b8f68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
