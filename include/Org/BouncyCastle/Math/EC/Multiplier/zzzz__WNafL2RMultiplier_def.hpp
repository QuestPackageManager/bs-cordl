...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafL2RMultiplier");
...
public:
  // Declarations
  /// @brief Method MultiplyPositive, addr 0x350edd0, size 0x300, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350f574, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier) == 0x10, "Size mismatch!");
