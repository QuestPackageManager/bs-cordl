...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "IPreCompCallback");
// Dependencies
namespace Org::BouncyCastle::Math::EC::Multiplier {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPreCompCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPreCompCallback(IPreCompCallbackconst&) = delete;
