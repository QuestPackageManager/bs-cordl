...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x10cbee4, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cbe3c, size 0xa8, virtual false, abstract: false, final false
