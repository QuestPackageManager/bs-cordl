...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x129f9fc, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x129f954, size 0xa8, virtual false, abstract: false, final false
