...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x350e06c, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350dfd0, size 0x9c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GlvMultiplier", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlvMultiplier(GlvMultiplier&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlvMultiplier", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlvMultiplier(GlvMultiplierconst&) = delete;
