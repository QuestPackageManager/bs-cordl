...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x129718c, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12970e4, size 0xa8, virtual false, abstract: false, final false
