...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x11a5a68, size 0x26c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a59c0, size 0xa8, virtual false, abstract: false, final false
