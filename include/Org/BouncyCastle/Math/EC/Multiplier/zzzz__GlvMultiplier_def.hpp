...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x34124fc, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3412460, size 0x9c, virtual false, abstract: false, final false
