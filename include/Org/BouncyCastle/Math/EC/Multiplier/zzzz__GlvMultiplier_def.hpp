...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x24b916c, size 0x264, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24b90c8, size 0xa4, virtual false, abstract: false, final false
