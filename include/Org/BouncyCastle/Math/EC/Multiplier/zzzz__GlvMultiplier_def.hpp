...
public:
  ...
  /// @brief Method MultiplyPositive, addr 0x344ea90, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x344e9f4, size 0x9c, virtual false, abstract: false, final false
