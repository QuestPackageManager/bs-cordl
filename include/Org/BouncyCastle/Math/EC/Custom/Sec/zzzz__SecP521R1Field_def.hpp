...
public:
  ...
  /// @brief Method Add addr 0xf8a680 size 0x110 virtual false final false
  ...
  /// @brief Method Twice addr 0xf8b2ac size 0x68 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method ImplMultiply addr 0xf8ae64 size 0x9c virtual false final false
  ...
  /// @brief Method ImplSquare addr 0xf8b194 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8b3a8 size 0x8 virtual false final false
  inline void _ctor();
