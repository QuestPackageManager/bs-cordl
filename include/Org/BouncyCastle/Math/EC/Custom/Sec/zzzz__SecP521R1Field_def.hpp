...
public:
  ...
  /// @brief Method Add, addr 0xffe8cc, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOne, addr 0xffe9dc, size 0xe8, virtual false, abstract: false, final false
  static inline void AddOne(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method FromBigInteger, addr 0xffeac4, size 0x9c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t, ::Array<uint32_t>*> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Half, addr 0xffeb60, size 0x68, virtual false, abstract: false, final false
  static inline void Half(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Inv, addr 0xffebc8, size 0x2b8, virtual false, abstract: false, final false
  static inline void Inv(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method IsZero, addr 0xffee80, size 0x54, virtual false, abstract: false, final false
  static inline int32_t IsZero(::ArrayW<uint32_t, ::Array<uint32_t>*> x);

  /// @brief Method Multiply, addr 0xffef58, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Negate, addr 0xfff260, size 0x9c, virtual false, abstract: false, final false
  static inline void Negate(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Random, addr 0xffe29c, size 0xf8, virtual false, abstract: false, final false
  static inline void Random(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method RandomMult, addr 0xffe464, size 0x6c, virtual false, abstract: false, final false
  static inline void RandomMult(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Reduce, addr 0xfff14c, size 0x114, virtual false, abstract: false, final false
  static inline void Reduce(::ArrayW<uint32_t, ::Array<uint32_t>*> xx, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Reduce23, addr 0xfff2fc, size 0xe4, virtual false, abstract: false, final false
  static inline void Reduce23(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Square, addr 0xffeed4, size 0x84, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SquareN, addr 0xffefe4, size 0xcc, virtual false, abstract: false, final false
  static inline void SquareN(::ArrayW<uint32_t, ::Array<uint32_t>*> x, int32_t n, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method Subtract, addr 0xfff458, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Twice, addr 0xfff4f8, size 0x68, virtual false, abstract: false, final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method ImplMultiply, addr 0xfff0b0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSquare, addr 0xfff3e0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xfff5f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
