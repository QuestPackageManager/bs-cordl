...
public:
  ...
  /// @brief Method CreatePoint, addr 0x24446a0, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Lookup, addr 0x2444588, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x2444780, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x244416c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x2444580, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  static __declspec(property(get = getStaticF_SECP256R1_AFFINE_ZS,
  ...
  /// @brief Method CloneCurve, addr 0x2443ba0, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x2443fcc, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x2443e2c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x2443f34, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x2443cc0, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x24441a8, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x2444344, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x2443bf0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x244397c, size 0x21c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x2443c5c, size 0x64, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x2443c54, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x2443bfc, size 0x58, virtual true, abstract: false, final false
