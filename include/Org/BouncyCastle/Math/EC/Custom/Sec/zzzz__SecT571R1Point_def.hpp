...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecT571R1Point", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecT571R1Point(SecT571R1Point&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecT571R1Point", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecT571R1Point(SecT571R1Pointconst&) = delete;
