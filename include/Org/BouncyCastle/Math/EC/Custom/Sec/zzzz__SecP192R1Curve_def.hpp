...
public:
  ...
  /// @brief Method CreatePoint, addr 0x246aff8, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Lookup, addr 0x246aef0, size 0x108, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x246b0d8, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246aad4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x246aee8, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x246a504, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x246a930, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x246a790, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x246a898, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x246a624, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x246ab10, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x246acac, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x246a554, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246a2e0, size 0x21c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x246a5c0, size 0x64, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x246a5b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x246a560, size 0x58, virtual true, abstract: false, final false
