...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve_SecP192R1LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP192R1Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve_SecP192R1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP192R1Curve/SecP192R1LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x34c0178, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y);

  /// @brief Method Lookup, addr 0x34c0048, size 0x130, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x34c024c, size 0xe8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve_SecP192R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve* outer, ::ArrayW<uint32_t> table,
                                                                                                          int32_t size);
  ...
  /// @brief Method .ctor, addr 0x34bfc68, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve* outer, ::ArrayW<uint32_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x34c0040, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecP192R1Curve_SecP192R1LookupTable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecP192R1Curve_SecP192R1LookupTable(SecP192R1Curve_SecP192R1LookupTable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecP192R1Curve_SecP192R1LookupTable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecP192R1Curve_SecP192R1LookupTable(SecP192R1Curve_SecP192R1LookupTableconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve_SecP192R1LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECP192R1_AFFINE_ZS, put = setStaticF_SECP192R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECP192R1_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x34bf67c, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x34bfab0, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34bf91c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34bfa20, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x34bf7a8, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x34bfc74, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x34bfdf0, size 0x94, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x34bf6d0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34bf448, size 0x22c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECP192R1_AFFINE_ZS();

  static inline ::Org::BouncyCastle::Math::BigInteger* getStaticF_q();

  /// @brief Method get_FieldSize, addr 0x34bf740, size 0x68, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x34bf738, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x34bf6dc, size 0x5c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  static inline void setStaticF_SECP192R1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecP192R1Curve", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecP192R1Curve(SecP192R1Curve&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecP192R1Curve", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecP192R1Curve(SecP192R1Curveconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve) == 0x58, "Size mismatch!");
