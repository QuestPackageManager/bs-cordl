...
/// @brief Method CreatePoint, addr 0x3401938, size 0xd4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  y) ;

/// @brief Method Lookup, addr 0x3401808, size 0x130, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x3401a0c, size 0xe8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve_SecP192R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve*  outer, ::ArrayW<uint32_t,::Array<uint32_t>*>  table, int32_t  size) ;
...
/// @brief Method .ctor, addr 0x3401428, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x3401800, size 0x8, virtual true, abstract: false, final false
...
/// @brief Field SECP192R1_AFFINE_ZS, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SECP192R1_AFFINE_ZS, put=setStaticF_SECP192R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECP192R1_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x3400e3c, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x3401270, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x34010dc, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x34011e0, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x3400f68, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method RandomFieldElement, addr 0x3401434, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult, addr 0x34015b0, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method SupportsCoordinateSystem, addr 0x3400e90, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3400c08, size 0x22c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x3400f00, size 0x68, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x3400ef8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_Q, addr 0x3400e9c, size 0x5c, virtual true, abstract: false, final false
