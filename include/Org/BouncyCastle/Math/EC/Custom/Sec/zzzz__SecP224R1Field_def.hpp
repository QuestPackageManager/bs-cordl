...
public:
  ...
  /// @brief Method Add addr 0xf7a254 size 0xdc virtual false final false
  ...
  /// @brief Method AddExt addr 0xf7a3d0 size 0x134 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xf7add4 size 0x130 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xf7b20c size 0xe4 virtual false final false
  ...
  /// @brief Method Twice addr 0xf7b2f0 size 0xd0 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPInvTo addr 0xf7a330 size 0xa0 virtual false final false
  static inline void AddPInvTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPInvFrom addr 0xf7b16c size 0xa0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf7b4d4 size 0x8 virtual false final false
  inline void _ctor();
