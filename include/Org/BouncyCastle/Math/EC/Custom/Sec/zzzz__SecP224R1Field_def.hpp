...
public:
  ...
  /// @brief Method Add addr 0xfee4a0 size 0xdc virtual false final false
  ...
  /// @brief Method AddExt addr 0xfee61c size 0x134 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xfef020 size 0x130 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xfef458 size 0xe4 virtual false final false
  ...
  /// @brief Method Twice addr 0xfef53c size 0xd0 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPInvTo addr 0xfee57c size 0xa0 virtual false final false
  static inline void AddPInvTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPInvFrom addr 0xfef3b8 size 0xa0 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfef720 size 0x8 virtual false final false
  inline void _ctor();
