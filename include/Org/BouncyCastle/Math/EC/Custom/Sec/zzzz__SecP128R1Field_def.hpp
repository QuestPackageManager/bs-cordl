...
public:
  ...
  /// @brief Method Add addr 0xf61cb0 size 0xdc virtual false final false
  ...
  /// @brief Method AddExt addr 0xf61e0c size 0xf4 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xf626e8 size 0xf4 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xf62aac size 0xac virtual false final false
  ...
  /// @brief Method Twice addr 0xf62b58 size 0xd0 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPInvTo addr 0xf61d8c size 0x80 virtual false final false
  static inline void AddPInvTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPInvFrom addr 0xf62a2c size 0x80 virtual false final false
  ...
  /// @brief Method .ctor addr 0xf62d3c size 0x8 virtual false final false
  inline void _ctor();
