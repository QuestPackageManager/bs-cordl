...
/// @brief Method Add, addr 0x33c4714, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method AddExt, addr 0x33c4880, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method AddOne, addr 0x33c49bc, size 0xe0, virtual false, abstract: false, final false
static inline void AddOne(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method AddPInvTo, addr 0x33c47f8, size 0x88, virtual false, abstract: false, final false
static inline void AddPInvTo(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method FromBigInteger, addr 0x33c4a9c, size 0xd0, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t,::Array<uint32_t>*> FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method Half, addr 0x33c4b6c, size 0xcc, virtual false, abstract: false, final false
static inline void Half(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Inv, addr 0x33c4c38, size 0x294, virtual false, abstract: false, final false
static inline void Inv(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method IsZero, addr 0x33c4ecc, size 0x54, virtual false, abstract: false, final false
static inline int32_t IsZero(::ArrayW<uint32_t,::Array<uint32_t>*>  x) ;

/// @brief Method Multiply, addr 0x33c4fa4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method MultiplyAddToExt, addr 0x33c52e4, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method Negate, addr 0x33c541c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Random, addr 0x33c40e8, size 0xe0, virtual false, abstract: false, final false
static inline void Random(::Org::BouncyCastle::Security::SecureRandom*  r, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method RandomMult, addr 0x33c4264, size 0x78, virtual false, abstract: false, final false
static inline void RandomMult(::Org::BouncyCastle::Security::SecureRandom*  r, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Reduce, addr 0x33c5100, size 0x1e4, virtual false, abstract: false, final false
static inline void Reduce(::ArrayW<uint32_t,::Array<uint32_t>*>  xx, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Reduce32, addr 0x33c54d0, size 0x144, virtual false, abstract: false, final false
static inline void Reduce32(uint32_t  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Square, addr 0x33c4f20, size 0x84, virtual false, abstract: false, final false
static inline void Square(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SquareN, addr 0x33c5030, size 0xd0, virtual false, abstract: false, final false
static inline void SquareN(::ArrayW<uint32_t,::Array<uint32_t>*>  x, int32_t  n, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SubPInvFrom, addr 0x33c56a4, size 0x88, virtual false, abstract: false, final false
static inline void SubPInvFrom(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Subtract, addr 0x33c5614, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SubtractExt, addr 0x33c572c, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Twice, addr 0x33c5814, size 0xe4, virtual false, abstract: false, final false
static inline void Twice(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method .ctor, addr 0x33c5a10, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
