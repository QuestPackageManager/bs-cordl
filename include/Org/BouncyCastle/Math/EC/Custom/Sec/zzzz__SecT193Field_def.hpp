...
public:
  // Declarations
  /// @brief Method Add addr 0xfa1f6c size 0xd8 virtual false final false
  ...
  /// @brief Method AddExt addr 0xfa2044 size 0x168 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xfa2b08 size 0x50 virtual false final false
  ...
  /// @brief Method ImplMulwAcc addr 0xfa2e80 size 0x1f8 virtual false final false
  static inline void ImplMulwAcc(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0xfa237c size 0xa8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa3078 size 0x8 virtual false final false
  inline void _ctor();
