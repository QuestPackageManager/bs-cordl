...
public:
  ...
  /// @brief Method Add, addr 0x24b14c8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x24b1458, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBothTo, addr 0x24b155c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddExt, addr 0x24b15f8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOne, addr 0x24b1668, size 0x74, virtual false, abstract: false, final false
  static inline void AddOne(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method AddTo, addr 0x24b16dc, size 0x5c, virtual false, abstract: false, final false
  static inline void AddTo(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method FromBigInteger, addr 0x24b1738, size 0x10, virtual false, abstract: false, final false
  static inline ::ArrayW<uint64_t, ::Array<uint64_t>*> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method HalfTrace, addr 0x24b1748, size 0xc4, virtual false, abstract: false, final false
  static inline void HalfTrace(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method ImplMultiply, addr 0x24b1ea8, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplMulwAcc, addr 0x24b2480, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSquare, addr 0x24b180c, size 0x13c, virtual false, abstract: false, final false
  static inline void ImplSquare(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> zz);

  /// @brief Method Invert, addr 0x24b1a90, size 0x248, virtual false, abstract: false, final false
  static inline void Invert(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Multiply, addr 0x24b1d58, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyAddToExt, addr 0x24b2130, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x24b1948, size 0x148, virtual false, abstract: false, final false
  static inline void Reduce(::ArrayW<uint64_t, ::Array<uint64_t>*> xx, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Reduce5, addr 0x24b21bc, size 0x6c, virtual false, abstract: false, final false
  static inline void Reduce5(::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method Sqrt, addr 0x24b2228, size 0x190, virtual false, abstract: false, final false
  static inline void Sqrt(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Square, addr 0x24b1cd8, size 0x80, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method SquareAddToExt, addr 0x24b23b8, size 0x84, virtual false, abstract: false, final false
  static inline void SquareAddToExt(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> zz);

  /// @brief Method SquareN, addr 0x24b1de0, size 0xc8, virtual false, abstract: false, final false
  static inline void SquareN(::ArrayW<uint64_t, ::Array<uint64_t>*> x, int32_t n, ::ArrayW<uint64_t, ::Array<uint64_t>*> z);

  /// @brief Method Trace, addr 0x24b243c, size 0x44, virtual false, abstract: false, final false
  static inline uint32_t Trace(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method .ctor, addr 0x24b26f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
