...
public:
  // Declarations
  /// @brief Method Add, addr 0x34f03a8, size 0xd8, virtual false, abstract: false, final false
  static inline void Add(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> z);

  /// @brief Method AddExt, addr 0x34f0480, size 0x198, virtual false, abstract: false, final false
  static inline void AddExt(::ArrayW<uint64_t> xx, ::ArrayW<uint64_t> yy, ::ArrayW<uint64_t> zz);

  /// @brief Method AddOne, addr 0x34f0618, size 0x8c, virtual false, abstract: false, final false
  static inline void AddOne(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method AddTo, addr 0x34f06a4, size 0xa8, virtual false, abstract: false, final false
  static inline void AddTo(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method FromBigInteger, addr 0x34f074c, size 0x10, virtual false, abstract: false, final false
  static inline ::ArrayW<uint64_t> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method HalfTrace, addr 0x34f075c, size 0x8c, virtual false, abstract: false, final false
  static inline void HalfTrace(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method ImplCompactExt, addr 0x34f1334, size 0xb4, virtual false, abstract: false, final false
  static inline void ImplCompactExt(::ArrayW<uint64_t> zz);

  /// @brief Method ImplExpand, addr 0x34f13e8, size 0x8c, virtual false, abstract: false, final false
  static inline void ImplExpand(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method ImplMultiply, addr 0x34f0c3c, size 0x35c, virtual false, abstract: false, final false
  static inline void ImplMultiply(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> zz);

  /// @brief Method ImplMulwAcc, addr 0x34f1474, size 0x190, virtual false, abstract: false, final false
  static inline void ImplMulwAcc(uint64_t x, uint64_t y, ::ArrayW<uint64_t> z, int32_t zOff);

  /// @brief Method ImplSquare, addr 0x34f07e8, size 0x9c, virtual false, abstract: false, final false
  static inline void ImplSquare(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> zz);

  /// @brief Method Invert, addr 0x34f0984, size 0x1b4, virtual false, abstract: false, final false
  static inline void Invert(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method Multiply, addr 0x34f0b74, size 0x4c, virtual false, abstract: false, final false
  static inline void Multiply(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> z);

  /// @brief Method MultiplyAddToExt, addr 0x34f0f98, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x34f0884, size 0x100, virtual false, abstract: false, final false
  static inline void Reduce(::ArrayW<uint64_t> xx, ::ArrayW<uint64_t> z);

  /// @brief Method Reduce23, addr 0x34f0fe8, size 0x80, virtual false, abstract: false, final false
  static inline void Reduce23(::ArrayW<uint64_t> z, int32_t zOff);

  /// @brief Method Sqrt, addr 0x34f1068, size 0x254, virtual false, abstract: false, final false
  static inline void Sqrt(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method Square, addr 0x34f0b38, size 0x3c, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z);

  /// @brief Method SquareAddToExt, addr 0x34f12bc, size 0x40, virtual false, abstract: false, final false
  static inline void SquareAddToExt(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> zz);

  /// @brief Method SquareN, addr 0x34f0bc0, size 0x7c, virtual false, abstract: false, final false
  static inline void SquareN(::ArrayW<uint64_t> x, int32_t n, ::ArrayW<uint64_t> z);

  /// @brief Method Trace, addr 0x34f12fc, size 0x38, virtual false, abstract: false, final false
  static inline uint32_t Trace(::ArrayW<uint64_t> x);

  /// @brief Method .ctor, addr 0x34f1604, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
