...
public:
  // Declarations
  /// @brief Method Add addr 0xfa7724 size 0xd8 virtual false final false
  ...
  /// @brief Method AddExt addr 0xfa77fc size 0x198 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xfa8330 size 0x50 virtual false final false
  ...
  /// @brief Method ImplMulwAcc addr 0xfa8810 size 0x1b0 virtual false final false
  static inline void ImplMulwAcc(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0xfa7b64 size 0x9c virtual false final false
  ...
  /// @brief Method .ctor addr 0xfa89c0 size 0x8 virtual false final false
  inline void _ctor();
