...
public:
  ...
  /// @brief Method Add, addr 0x34c3e28, size 0xdc, virtual false, abstract: false, final false
  static inline void Add(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method AddExt, addr 0x34c3f04, size 0x13c, virtual false, abstract: false, final false
  static inline void AddExt(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> yy, ::ArrayW<uint32_t> zz);

  /// @brief Method AddOne, addr 0x34c4040, size 0xd8, virtual false, abstract: false, final false
  static inline void AddOne(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method FromBigInteger, addr 0x34c4118, size 0xd0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Half, addr 0x34c41e8, size 0xcc, virtual false, abstract: false, final false
  static inline void Half(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method Inv, addr 0x34c42b4, size 0x32c, virtual false, abstract: false, final false
  static inline void Inv(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method IsZero, addr 0x34c45e0, size 0x54, virtual false, abstract: false, final false
  static inline int32_t IsZero(::ArrayW<uint32_t> x);

  /// @brief Method Multiply, addr 0x34c46b8, size 0x8c, virtual false, abstract: false, final false
  static inline void Multiply(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method MultiplyAddToExt, addr 0x34c4914, size 0x138, virtual false, abstract: false, final false
  static inline void MultiplyAddToExt(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> zz);

  /// @brief Method Negate, addr 0x34c4a4c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x34c3800, size 0xe0, virtual false, abstract: false, final false
  static inline void Random(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t> z);

  /// @brief Method RandomMult, addr 0x34c397c, size 0x78, virtual false, abstract: false, final false
  static inline void RandomMult(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t> z);

  /// @brief Method Reduce, addr 0x34c4814, size 0x100, virtual false, abstract: false, final false
  static inline void Reduce(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> z);

  /// @brief Method Reduce32, addr 0x34c4b00, size 0xe0, virtual false, abstract: false, final false
  static inline void Reduce32(uint32_t x, ::ArrayW<uint32_t> z);

  /// @brief Method Square, addr 0x34c4634, size 0x84, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method SquareN, addr 0x34c4744, size 0xd0, virtual false, abstract: false, final false
  static inline void SquareN(::ArrayW<uint32_t> x, int32_t n, ::ArrayW<uint32_t> z);

  /// @brief Method Subtract, addr 0x34c4be0, size 0x34, virtual false, abstract: false, final false
  static inline void Subtract(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method SubtractExt, addr 0x34c4c14, size 0xe8, virtual false, abstract: false, final false
  static inline void SubtractExt(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> yy, ::ArrayW<uint32_t> zz);

  /// @brief Method Twice, addr 0x34c4cfc, size 0xdc, virtual false, abstract: false, final false
  static inline void Twice(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method .ctor, addr 0x34c4ef0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecP224K1Field", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecP224K1Field(SecP224K1Field&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecP224K1Field", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecP224K1Field(SecP224K1Fieldconst&) = delete;
