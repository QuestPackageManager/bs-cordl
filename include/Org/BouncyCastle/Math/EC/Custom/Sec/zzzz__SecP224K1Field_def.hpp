...
public:
  ...
  /// @brief Method Add, addr 0x34c1aa0, size 0xdc, virtual false, abstract: false, final false
  static inline void Add(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method AddExt, addr 0x34c1b7c, size 0x13c, virtual false, abstract: false, final false
  static inline void AddExt(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> yy, ::ArrayW<uint32_t> zz);

  /// @brief Method AddOne, addr 0x34c1cb8, size 0xd8, virtual false, abstract: false, final false
  static inline void AddOne(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method FromBigInteger, addr 0x34c1d90, size 0xd0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint32_t> FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method Half, addr 0x34c1e60, size 0xcc, virtual false, abstract: false, final false
  static inline void Half(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method Inv, addr 0x34c1f2c, size 0x32c, virtual false, abstract: false, final false
  static inline void Inv(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method IsZero, addr 0x34c2258, size 0x54, virtual false, abstract: false, final false
  static inline int32_t IsZero(::ArrayW<uint32_t> x);

  /// @brief Method Multiply, addr 0x34c2330, size 0x8c, virtual false, abstract: false, final false
  static inline void Multiply(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method MultiplyAddToExt, addr 0x34c258c, size 0x138, virtual false, abstract: false, final false
  static inline void MultiplyAddToExt(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> zz);

  /// @brief Method Negate, addr 0x34c26c4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method Random, addr 0x34c1478, size 0xe0, virtual false, abstract: false, final false
  static inline void Random(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t> z);

  /// @brief Method RandomMult, addr 0x34c15f4, size 0x78, virtual false, abstract: false, final false
  static inline void RandomMult(::Org::BouncyCastle::Security::SecureRandom* r, ::ArrayW<uint32_t> z);

  /// @brief Method Reduce, addr 0x34c248c, size 0x100, virtual false, abstract: false, final false
  static inline void Reduce(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> z);

  /// @brief Method Reduce32, addr 0x34c2778, size 0xe0, virtual false, abstract: false, final false
  static inline void Reduce32(uint32_t x, ::ArrayW<uint32_t> z);

  /// @brief Method Square, addr 0x34c22ac, size 0x84, virtual false, abstract: false, final false
  static inline void Square(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method SquareN, addr 0x34c23bc, size 0xd0, virtual false, abstract: false, final false
  static inline void SquareN(::ArrayW<uint32_t> x, int32_t n, ::ArrayW<uint32_t> z);

  /// @brief Method Subtract, addr 0x34c2858, size 0x34, virtual false, abstract: false, final false
  static inline void Subtract(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> z);

  /// @brief Method SubtractExt, addr 0x34c288c, size 0xe8, virtual false, abstract: false, final false
  static inline void SubtractExt(::ArrayW<uint32_t> xx, ::ArrayW<uint32_t> yy, ::ArrayW<uint32_t> zz);

  /// @brief Method Twice, addr 0x34c2974, size 0xdc, virtual false, abstract: false, final false
  static inline void Twice(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z);

  /// @brief Method .ctor, addr 0x34c2b68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
