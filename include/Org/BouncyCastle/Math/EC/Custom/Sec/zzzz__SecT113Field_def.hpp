...
public:
  // Declarations
  /// @brief Method Add addr 0xf8cd60 size 0x78 virtual false final false
  ...
  /// @brief Method AddExt addr 0xf8cdd8 size 0xd8 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xf8d504 size 0x50 virtual false final false
  ...
  /// @brief Method ImplMulw addr 0xf8d6b4 size 0x1c0 virtual false final false
  static inline void ImplMulw(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0xf8d000 size 0x5c virtual false final false
  ...
  /// @brief Method .ctor addr 0xf8d874 size 0x8 virtual false final false
  inline void _ctor();
