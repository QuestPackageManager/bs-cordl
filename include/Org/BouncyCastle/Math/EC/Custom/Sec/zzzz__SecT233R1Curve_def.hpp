...
public:
  ...
  /// @brief Method CreatePoint, addr 0x34f4550, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y);

  /// @brief Method Lookup, addr 0x34f4438, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x34f4624, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f430c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve* outer, ::ArrayW<uint64_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x34f4430, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x34f3ebc, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x34f415c, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34f3f8c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34f4094, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x34f3f2c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x34f3f10, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f3ce0, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECT233R1_AFFINE_ZS();

  /// @brief Method get_FieldSize, addr 0x34f3f24, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x34f3f1c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x34f412c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x34f413c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x34f4144, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x34f414c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x34f4154, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x34f4134, size 0x8, virtual true, abstract: false, final false
