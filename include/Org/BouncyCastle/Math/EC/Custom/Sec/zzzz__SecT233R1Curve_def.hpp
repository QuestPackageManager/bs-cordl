...
public:
  ...
  /// @brief Method .ctor addr 0xfac7f8 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0xfac944 size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0xfac94c size 0x118 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0xfacb44 size 0xc8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0xfaca64 size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xfac1d0 size 0x1c0 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0xfac398 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0xfac3f0 size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Infinity addr 0xfac3fc size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize addr 0xfac404 size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0xfac40c size 0x64 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0xfac470 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0xfac584 size 0x94 virtual true final false
  ...
  /// @brief Method get_IsKoblitz addr 0xfac624 size 0x8 virtual true final false
  inline bool get_IsKoblitz();

  /// @brief Method get_M addr 0xfac62c size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_IsTrinomial addr 0xfac634 size 0x8 virtual true final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1 addr 0xfac63c size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0xfac644 size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0xfac64c size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method CreateCacheSafeLookupTable addr 0xfac654 size 0x1a4 virtual true final false
