...
public:
  // Declarations
  /// @brief Method Add addr 0x1029b60 size 0x168 virtual false final false
  ...
  /// @brief Method AddExt addr 0x1029cc8 size 0x70 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0x102a5ec size 0x50 virtual false final false
  ...
  /// @brief Method ImplMulwAcc addr 0x102ab0c size 0x1e0 virtual false final false
  ...
  /// @brief Method ImplSquare addr 0x1029fcc size 0x10c virtual false final false
  ...
  /// @brief Method .ctor addr 0x102acec size 0x8 virtual false final false
  inline void _ctor();
