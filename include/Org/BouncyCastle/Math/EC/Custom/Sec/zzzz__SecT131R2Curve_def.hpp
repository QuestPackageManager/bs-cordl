...
public:
  ...
  /// @brief Method .ctor addr 0xf991d8 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0xf99320 size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0xf99328 size 0x108 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0xf99510 size 0xcc virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0xf99430 size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xf98b70 size 0x200 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0xf98d78 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0xf98dd0 size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_FieldSize addr 0xf98ddc size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0xf98de4 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0xf98e44 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0xf98f58 size 0x94 virtual true final false
  ...
  /// @brief Method get_Infinity addr 0xf98ff8 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz addr 0xf99000 size 0x8 virtual true final false
  inline bool get_IsKoblitz();

  /// @brief Method get_M addr 0xf99008 size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_IsTrinomial addr 0xf99010 size 0x8 virtual true final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1 addr 0xf99018 size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0xf99020 size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0xf99028 size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method CreateCacheSafeLookupTable addr 0xf99030 size 0x1a8 virtual true final false
