...
public:
  ...
  /// @brief Method CreatePoint, addr 0x1051854, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Lookup, addr 0x105174c, size 0x108, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x1051934, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1051320, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x1051744, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x1050d24, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x1051178, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x1050fc4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x10510d8, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x1050e4c, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x105135c, size 0xa4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x1051500, size 0xa4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x1050d7c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1050afc, size 0x220, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x1050de8, size 0x64, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x1050de0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x1050d88, size 0x58, virtual true, abstract: false, final false
