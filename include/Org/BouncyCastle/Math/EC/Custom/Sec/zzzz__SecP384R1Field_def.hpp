...
public:
  ...
  /// @brief Method Add addr 0xf86888 size 0xe4 virtual false final false
  ...
  /// @brief Method AddExt addr 0xf86a28 size 0x134 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xf878cc size 0xe4 virtual false final false
  ...
  /// @brief Method Twice addr 0xf879b0 size 0xd4 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPInvTo addr 0xf8696c size 0xbc virtual false final false
  static inline void AddPInvTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPInvFrom addr 0xf87810 size 0xbc virtual false final false
  ...
  /// @brief Method .ctor addr 0xf87b98 size 0x8 virtual false final false
  inline void _ctor();
