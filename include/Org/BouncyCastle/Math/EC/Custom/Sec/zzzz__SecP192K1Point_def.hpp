...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecP192K1Point", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecP192K1Point(SecP192K1Point&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecP192K1Point", modifiers: "const&", def_value: None, comment: None }]
