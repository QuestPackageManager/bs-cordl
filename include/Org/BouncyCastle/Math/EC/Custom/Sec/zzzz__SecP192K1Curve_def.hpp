...
public:
  ...
  /// @brief Method CreatePoint, addr 0x1242c00, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Lookup, addr 0x1242af8, size 0x108, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x1242ce0, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12426cc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x1242af0, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x12420d0, size 0x58, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x1242524, size 0x1a8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x1242370, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x1242484, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x12421f8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x1242708, size 0xa4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x12428ac, size 0xa4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x1242128, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1241f24, size 0x1a4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x1242194, size 0x64, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x124218c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x1242134, size 0x58, virtual true, abstract: false, final false
