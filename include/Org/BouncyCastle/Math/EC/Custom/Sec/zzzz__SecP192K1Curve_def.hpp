...
public:
  ...
  /// @brief Method .ctor addr 0xf6ec74 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0xf6f098 size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0xf6f0a0 size 0x108 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0xf6f288 size 0xc8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0xf6f1a8 size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xf6e4cc size 0x1a4 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0xf6e678 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0xf6e6d0 size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Q addr 0xf6e6dc size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_Infinity addr 0xf6e734 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize addr 0xf6e73c size 0x64 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0xf6e7a0 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0xf6e918 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0xf6ea2c size 0x94 virtual true final false
  ...
  /// @brief Method CreateCacheSafeLookupTable addr 0xf6eacc size 0x1a8 virtual true final false
  ...
  /// @brief Method RandomFieldElement addr 0xf6ecb0 size 0xa4 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult addr 0xf6ee54 size 0xa4 virtual true final false
