...
public:
  ...
  /// @brief Method .ctor addr 0xf9bae4 size 0xf4 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* x);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163FieldElement* New_ctor();

  /// @brief Method .ctor addr 0xf9bbd8 size 0x24 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163FieldElement* New_ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method .ctor addr 0xf9bbfc size 0x28 virtual false final false
  inline void _ctor(::ArrayW<uint64_t, ::Array<uint64_t>*> x);

  /// @brief Method get_IsOne addr 0xf9bc24 size 0xc virtual true final false
  inline bool get_IsOne();

  /// @brief Method get_IsZero addr 0xf9bc30 size 0xc virtual true final false
  inline bool get_IsZero();

  /// @brief Method TestBitZero addr 0xf9bc3c size 0x2c virtual true final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger addr 0xf9bc68 size 0xc virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger();

  /// @brief Method get_FieldName addr 0xf9bc74 size 0x40 virtual true final false
  inline ::StringW get_FieldName();

  /// @brief Method get_FieldSize addr 0xf9bcb4 size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method Add addr 0xf9bcbc size 0xf0 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Add(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method AddOne addr 0xf9bdac size 0xa8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* AddOne();

  /// @brief Method Subtract addr 0xf9be54 size 0xc virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Subtract(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method Multiply addr 0xf9be60 size 0xf0 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Multiply(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method MultiplyMinusProduct addr 0xf9bf50 size 0x10 virtual true final false
  ...
  /// @brief Method MultiplyPlusProduct addr 0xf9bf60 size 0x18c virtual true final false
  ...
  /// @brief Method Divide addr 0xf9c0ec size 0x40 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Divide(::Org::BouncyCastle::Math::EC::ECFieldElement* b);

  /// @brief Method Negate addr 0xf9c12c size 0x4 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Negate();

  /// @brief Method Square addr 0xf9c130 size 0xa8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Square();

  /// @brief Method SquareMinusProduct addr 0xf9c1d8 size 0x10 virtual true final false
  ...
  /// @brief Method SquarePlusProduct addr 0xf9c1e8 size 0x14c virtual true final false
  ...
  /// @brief Method SquarePow addr 0xf9c334 size 0xc0 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* SquarePow(int32_t pow);

  /// @brief Method HalfTrace addr 0xf9c3f4 size 0xa8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* HalfTrace();

  /// @brief Method get_HasFastTrace addr 0xf9c49c size 0x8 virtual true final false
  inline bool get_HasFastTrace();

  /// @brief Method Trace addr 0xf9c4a4 size 0x58 virtual true final false
  inline int32_t Trace();

  /// @brief Method Invert addr 0xf9c4fc size 0xa8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Invert();

  /// @brief Method Sqrt addr 0xf9c5a4 size 0xa8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Sqrt();

  /// @brief Method get_Representation addr 0xf9c64c size 0x8 virtual true final false
  inline int32_t get_Representation();

  /// @brief Method get_M addr 0xf9c654 size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_K1 addr 0xf9c65c size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0xf9c664 size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0xf9c66c size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method Equals addr 0xf9c674 size 0x8c virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0xf9c700 size 0x8c virtual true final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::ECFieldElement* other);

  /// @brief Method Equals addr 0xf9c78c size 0x2c virtual true final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163FieldElement* other);

  /// @brief Method GetHashCode addr 0xf9c7b8 size 0x74 virtual true final false
