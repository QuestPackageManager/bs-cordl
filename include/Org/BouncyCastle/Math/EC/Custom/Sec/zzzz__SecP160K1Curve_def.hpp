...
public:
  ...
  /// @brief Method CreatePoint, addr 0x2462cac, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method Lookup, addr 0x2462ba4, size 0x108, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x2462d8c, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24628e8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x2462b9c, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x2462434, size 0x50, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x2462744, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x24625b0, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x24626b4, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x2462554, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method RandomFieldElement, addr 0x2462924, size 0xa0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method RandomFieldElementMult, addr 0x24629c4, size 0xa0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom* r);

  /// @brief Method SupportsCoordinateSystem, addr 0x2462484, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246229c, size 0x190, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x24624f0, size 0x64, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x24624e8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x2462490, size 0x58, virtual true, abstract: false, final false
