...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160K1Curve*> const& __get_m_outer() const;
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160K1Point*> const& __get_m_infinity() const;
