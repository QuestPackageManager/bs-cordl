...
/// @brief Method CreatePoint, addr 0x33f5034, size 0xd4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  y) ;

/// @brief Method Lookup, addr 0x33f4f08, size 0x12c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x33f5108, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33f4c7c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x33f4f00, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method CloneCurve, addr 0x33f47a4, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x33f4ac4, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x33f4930, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x33f4a34, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x33f48d0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method RandomFieldElement, addr 0x33f4c88, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult, addr 0x33f4d20, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method SupportsCoordinateSystem, addr 0x33f47f8, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33f45f8, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x33f4868, size 0x68, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x33f4860, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_Q, addr 0x33f4804, size 0x5c, virtual true, abstract: false, final false
