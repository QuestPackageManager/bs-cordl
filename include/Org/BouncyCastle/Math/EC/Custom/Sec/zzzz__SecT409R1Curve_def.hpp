...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT409R1Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT409R1Curve/SecT409R1LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x3503268, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y);

  /// @brief Method Lookup, addr 0x350313c, size 0x12c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x350333c, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3503014, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve* outer, ::ArrayW<uint64_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x3503134, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECT409R1_AFFINE_ZS, put = setStaticF_SECT409R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECT409R1_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x3502bc0, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x3502e5c, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x3502c8c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x3502d94, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x3502c30, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x3502c14, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35029e4, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECT409R1_AFFINE_ZS();

  /// @brief Method get_FieldSize, addr 0x3502c28, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x3502c20, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x3502e2c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x3502e3c, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x3502e44, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x3502e4c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x3502e54, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x3502e34, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve) == 0x60, "Size mismatch!");
