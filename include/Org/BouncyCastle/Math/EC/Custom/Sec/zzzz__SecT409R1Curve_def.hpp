#pragma once
// IWYU pragma private; include "Org/BouncyCastle/Math/EC/Custom/Sec/SecT409R1Curve.hpp"
...
class SecT409R1Curve_SecT409R1LookupTable;
}
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
...
MARK_REF_PTR_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable);
...
class CORDL_TYPE SecT409R1Curve_SecT409R1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
...
/// @brief Method CreatePoint, addr 0x3446db0, size 0xd4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  y) ;

/// @brief Method Lookup, addr 0x3446c84, size 0x12c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x3446e84, size 0xe8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve*  outer, ::ArrayW<uint64_t,::Array<uint64_t>*>  table, int32_t  size) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve* const& __cordl_internal_get_m_outer() const;
...
/// @brief Method .ctor, addr 0x3446b5c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x3446c7c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Size() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr SecT409R1Curve_SecT409R1LookupTable() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "SecT409R1Curve_SecT409R1LookupTable", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
SecT409R1Curve_SecT409R1LookupTable(SecT409R1Curve_SecT409R1LookupTable && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "SecT409R1Curve_SecT409R1LookupTable", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
SecT409R1Curve_SecT409R1LookupTable(SecT409R1Curve_SecT409R1LookupTable const& ) = delete;
...
static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable, ___m_outer) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable, ___m_table) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable, ___m_size) == 0x20, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable, 0x28>, "Size mismatch!");
...
public:
// Declarations
using SecT409R1LookupTable = ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable;
...
/// @brief Field SECT409R1_AFFINE_ZS, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SECT409R1_AFFINE_ZS, put=setStaticF_SECT409R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECT409R1_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x3446708, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x34469a4, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x34467d4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x34468dc, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x3446778, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x344675c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x344652c, size 0x1d4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x3446770, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x3446768, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_IsKoblitz, addr 0x3446974, size 0x8, virtual true, abstract: false, final false
inline bool get_IsKoblitz() ;

/// @brief Method get_IsTrinomial, addr 0x3446984, size 0x8, virtual true, abstract: false, final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1, addr 0x344698c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x3446994, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x344699c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x344697c, size 0x8, virtual true, abstract: false, final false
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve_SecT409R1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT409R1Curve/SecT409R1LookupTable");
