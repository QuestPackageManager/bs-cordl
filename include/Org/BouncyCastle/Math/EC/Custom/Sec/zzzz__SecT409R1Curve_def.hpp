...
public:
  ...
  /// @brief Method .ctor addr 0xfbb8d4 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0xfbba1c size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0xfbba24 size 0x108 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0xfbbc0c size 0xcc virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0xfbbb2c size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xfbb2ac size 0x1c0 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0xfbb474 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0xfbb4cc size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Infinity addr 0xfbb4d8 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize addr 0xfbb4e0 size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0xfbb4e8 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0xfbb548 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0xfbb65c size 0x94 virtual true final false
  ...
  /// @brief Method get_IsKoblitz addr 0xfbb6fc size 0x8 virtual true final false
  inline bool get_IsKoblitz();

  /// @brief Method get_M addr 0xfbb704 size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_IsTrinomial addr 0xfbb70c size 0x8 virtual true final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1 addr 0xfbb714 size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0xfbb71c size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0xfbb724 size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method CreateCacheSafeLookupTable addr 0xfbb72c size 0x1a8 virtual true final false
