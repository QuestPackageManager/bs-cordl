...
public:
  ...
  /// @brief Method .ctor addr 0x102db20 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0x102dc68 size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0x102dc70 size 0x108 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0x102de58 size 0xcc virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0x102dd78 size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x102d4f8 size 0x1c0 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0x102d6c0 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0x102d718 size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Infinity addr 0x102d724 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize addr 0x102d72c size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0x102d734 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0x102d794 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0x102d8a8 size 0x94 virtual true final false
  ...
  /// @brief Method get_IsKoblitz addr 0x102d948 size 0x8 virtual true final false
  inline bool get_IsKoblitz();

  /// @brief Method get_M addr 0x102d950 size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_IsTrinomial addr 0x102d958 size 0x8 virtual true final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1 addr 0x102d960 size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0x102d968 size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0x102d970 size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method CreateCacheSafeLookupTable addr 0x102d978 size 0x1a8 virtual true final false
