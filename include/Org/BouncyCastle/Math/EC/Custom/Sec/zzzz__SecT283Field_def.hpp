...
public:
  ...
  /// @brief Method Add addr 0xfb19e0 size 0x108 virtual false final false
  ...
  /// @brief Method AddExt addr 0xfb1ae8 size 0x1c8 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xfb2ab8 size 0x8c virtual false final false
  ...
  /// @brief Method ImplMulw addr 0xfb2fac size 0x1c0 virtual false final false
  static inline void ImplMulw(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0xfb1efc size 0xcc virtual false final false
  ...
  /// @brief Method .ctor addr 0xfb3200 size 0x8 virtual false final false
  inline void _ctor();
