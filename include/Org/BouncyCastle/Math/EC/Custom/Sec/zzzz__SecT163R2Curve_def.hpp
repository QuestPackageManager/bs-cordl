...
public:
  ...
  /// @brief Method .ctor addr 0xfa08b0 size 0x3c virtual false final false
  ...
  /// @brief Method get_Size addr 0xfa09f8 size 0x8 virtual true final false
  inline int32_t get_Size();

  /// @brief Method Lookup addr 0xfa0a00 size 0x108 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar addr 0xfa0be8 size 0xcc virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  /// @brief Method CreatePoint addr 0xfa0b08 size 0xe0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xfa0288 size 0x1c0 virtual false final false
  inline void _ctor();

  /// @brief Method CloneCurve addr 0xfa0450 size 0x58 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem addr 0xfa04a8 size 0xc virtual true final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Infinity addr 0xfa04b4 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize addr 0xfa04bc size 0x8 virtual true final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger addr 0xfa04c4 size 0x60 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint addr 0xfa0524 size 0x88 virtual true final false
  ...
  /// @brief Method CreateRawPoint addr 0xfa0638 size 0x94 virtual true final false
  ...
  /// @brief Method get_IsKoblitz addr 0xfa06d8 size 0x8 virtual true final false
  inline bool get_IsKoblitz();

  /// @brief Method get_M addr 0xfa06e0 size 0x8 virtual true final false
  inline int32_t get_M();

  /// @brief Method get_IsTrinomial addr 0xfa06e8 size 0x8 virtual true final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1 addr 0xfa06f0 size 0x8 virtual true final false
  inline int32_t get_K1();

  /// @brief Method get_K2 addr 0xfa06f8 size 0x8 virtual true final false
  inline int32_t get_K2();

  /// @brief Method get_K3 addr 0xfa0700 size 0x8 virtual true final false
  inline int32_t get_K3();

  /// @brief Method CreateCacheSafeLookupTable addr 0xfa0708 size 0x1a8 virtual true final false
