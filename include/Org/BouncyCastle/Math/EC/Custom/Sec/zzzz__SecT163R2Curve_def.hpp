...
public:
  ...
  /// @brief Method CreatePoint, addr 0x33c599c, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t, ::Array<uint64_t>*> x, ::ArrayW<uint64_t, ::Array<uint64_t>*> y);

  /// @brief Method Lookup, addr 0x33c5870, size 0x12c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x33c5a70, size 0xe8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c5748, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Size, addr 0x33c5868, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x33c52f4, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x33c5590, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x33c53c0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x33c54c8, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x33c5364, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x33c5348, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33c5118, size 0x1d4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_FieldSize, addr 0x33c535c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x33c5354, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x33c5560, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x33c5570, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x33c5578, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x33c5580, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x33c5588, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x33c5568, size 0x8, virtual true, abstract: false, final false
