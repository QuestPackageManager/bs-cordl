...
public:
  ...
  /// @brief Method Add addr 0x100db74 size 0xa8 virtual false final false
  ...
  /// @brief Method AddExt addr 0x100dc1c size 0x138 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0x100e770 size 0x8c virtual false final false
  ...
  /// @brief Method ImplMulw addr 0x100eaf4 size 0x1a0 virtual false final false
  static inline void ImplMulw(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0x100df1c size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0x100ed28 size 0x8 virtual false final false
  inline void _ctor();
