...
public:
  ...
  /// @brief Method Add addr 0xf9a928 size 0xa8 virtual false final false
  ...
  /// @brief Method AddExt addr 0xf9a9d0 size 0x138 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xf9b524 size 0x8c virtual false final false
  ...
  /// @brief Method ImplMulw addr 0xf9b8a8 size 0x1a0 virtual false final false
  static inline void ImplMulw(uint64_t x, uint64_t y, ::ArrayW<uint64_t, ::Array<uint64_t>*> z, int32_t zOff);

  /// @brief Method ImplSquare addr 0xf9acd0 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0xf9badc size 0x8 virtual false final false
  inline void _ctor();
