...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecP256K1Point", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecP256K1Point(SecP256K1Point&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecP256K1Point", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecP256K1Point(SecP256K1Pointconst&) = delete;
