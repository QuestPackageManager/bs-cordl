...
/// @brief Method CreatePoint, addr 0x3436390, size 0xd4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  y) ;

/// @brief Method Lookup, addr 0x3436278, size 0x118, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x3436464, size 0xcc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve_SecT233K1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve*  outer, ::ArrayW<uint64_t,::Array<uint64_t>*>  table, int32_t  size) ;
...
/// @brief Method .ctor, addr 0x3436264, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x3436270, size 0x8, virtual true, abstract: false, final false
...
/// @brief Field SECT233K1_AFFINE_ZS, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SECT233K1_AFFINE_ZS, put=setStaticF_SECT233K1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECT233K1_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x3435d48, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x3435fa0, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method CreateDefaultMultiplier, addr 0x3435da8, size 0x44, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier() ;

/// @brief Method CreateRawPoint, addr 0x3435e50, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x3435ed8, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x3435df4, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x3435d9c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3435bbc, size 0x18c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x3435dec, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x3435f68, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_IsKoblitz, addr 0x3435f70, size 0x8, virtual true, abstract: false, final false
inline bool get_IsKoblitz() ;

/// @brief Method get_IsTrinomial, addr 0x3435f80, size 0x8, virtual true, abstract: false, final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1, addr 0x3435f88, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x3435f90, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x3435f98, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x3435f78, size 0x8, virtual true, abstract: false, final false
