...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve_SecT233K1LookupTable*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT233K1Curve");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve_SecT233K1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT233K1Curve/SecT233K1LookupTable");
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x34f4bd0, size 0xd4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y);

  /// @brief Method Lookup, addr 0x34f4ab8, size 0x118, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x34f4ca4, size 0xcc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t index);

  static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve_SecT233K1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve* outer, ::ArrayW<uint64_t> table,
                                                                                                          int32_t size);
  ...
  /// @brief Method .ctor, addr 0x34f4aa4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve* outer, ::ArrayW<uint64_t> table, int32_t size);

  /// @brief Method get_Size, addr 0x34f4ab0, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecT233K1Curve_SecT233K1LookupTable", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecT233K1Curve_SecT233K1LookupTable(SecT233K1Curve_SecT233K1LookupTable&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecT233K1Curve_SecT233K1LookupTable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecT233K1Curve_SecT233K1LookupTable(SecT233K1Curve_SecT233K1LookupTableconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve_SecT233K1LookupTable) == 0x28, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF_SECT233K1_AFFINE_ZS, put = setStaticF_SECT233K1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> SECT233K1_AFFINE_ZS;
  ...
  /// @brief Method CloneCurve, addr 0x34f4588, size 0x54, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x34f47e0, size 0x1b0, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDefaultMultiplier, addr 0x34f45e8, size 0x44, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier();

  /// @brief Method CreateRawPoint, addr 0x34f4690, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x34f4718, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x34f4634, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x34f45dc, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34f43fc, size 0x18c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> getStaticF_SECT233K1_AFFINE_ZS();

  /// @brief Method get_FieldSize, addr 0x34f462c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x34f47a8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_IsKoblitz, addr 0x34f47b0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsKoblitz();

  /// @brief Method get_IsTrinomial, addr 0x34f47c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsTrinomial();

  /// @brief Method get_K1, addr 0x34f47c8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K1();

  /// @brief Method get_K2, addr 0x34f47d0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K2();

  /// @brief Method get_K3, addr 0x34f47d8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_K3();

  /// @brief Method get_M, addr 0x34f47b8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_M();

  static inline void setStaticF_SECT233K1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SecT233K1Curve", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SecT233K1Curve(SecT233K1Curve&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SecT233K1Curve", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SecT233K1Curve(SecT233K1Curveconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve) == 0x60, "Size mismatch!");
