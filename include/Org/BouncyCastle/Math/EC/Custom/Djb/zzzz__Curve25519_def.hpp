...
MARK_REF_PTR_T(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519_Curve25519LookupTable);
...
/// @brief Method CreatePoint, addr 0x33e7da4, size 0xd4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  y) ;

/// @brief Method Lookup, addr 0x33e7c8c, size 0x118, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x33e7e78, size 0xcc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519_Curve25519LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519*  outer, ::ArrayW<uint32_t,::Array<uint32_t>*>  table, int32_t  size) ;
...
/// @brief Method .ctor, addr 0x33e7774, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519*  outer, ::ArrayW<uint32_t,::Array<uint32_t>*>  table, int32_t  size) ;

/// @brief Method get_Size, addr 0x33e7c84, size 0x8, virtual true, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519_Curve25519LookupTable, 0x28>, "Size mismatch!");
...
/// @brief Field CURVE25519_AFFINE_ZS, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_CURVE25519_AFFINE_ZS, put=setStaticF_CURVE25519_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  CURVE25519_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x33e7190, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x33e75c4, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x33e7430, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x33e7534, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x33e72bc, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method RandomFieldElement, addr 0x33e7780, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult, addr 0x33e791c, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method SupportsCoordinateSystem, addr 0x33e71e4, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x33e6fe4, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x33e7254, size 0x68, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x33e724c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_Q, addr 0x33e71f0, size 0x5c, virtual true, abstract: false, final false
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519_Curve25519LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519_Curve25519LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Djb", "Curve25519/Curve25519LookupTable");
