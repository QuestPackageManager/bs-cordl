...
public:
  ...
  /// @brief Method Add addr 0xfcd260 size 0xb4 virtual false final false
  ...
  /// @brief Method AddExt addr 0xfcd388 size 0xbc virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xfcddb0 size 0xb8 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xfce0f0 size 0x90 virtual false final false
  ...
  /// @brief Method Twice addr 0xfce2e4 size 0xb4 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPTo addr 0xfce078 size 0x78 virtual false final false
  static inline uint32_t AddPTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPExtTo addr 0xfce180 size 0x164 virtual false final false
  static inline uint32_t AddPExtTo(::ArrayW<uint32_t, ::Array<uint32_t>*> zz);

  /// @brief Method SubPFrom addr 0xfcd314 size 0x74 virtual false final false
  static inline int32_t SubPFrom(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPExtFrom addr 0xfcd444 size 0x168 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfce468 size 0x8 virtual false final false
  inline void _ctor();
