...
public:
  ...
  /// @brief Method Add addr 0xf5e018 size 0xdc virtual false final false
  ...
  /// @brief Method AddExt addr 0xf5e1e0 size 0xf8 virtual false final false
  ...
  /// @brief Method MultiplyAddToExt addr 0xf5ec14 size 0xf4 virtual false final false
  ...
  /// @brief Method SubtractExt addr 0xf5f0a8 size 0xa4 virtual false final false
  ...
  /// @brief Method Twice addr 0xf5f14c size 0xd0 virtual false final false
  static inline void Twice(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method AddPInvTo addr 0xf5e0f4 size 0xec virtual false final false
  static inline void AddPInvTo(::ArrayW<uint32_t, ::Array<uint32_t>*> z);

  /// @brief Method SubPInvFrom addr 0xf5efbc size 0xec virtual false final false
  ...
  /// @brief Method .ctor addr 0xf5f2ec size 0x8 virtual false final false
  inline void _ctor();
