...
public:
  ...
  /// @brief Method Create, addr 0x337e984, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCoordinateSystem, addr 0x337e96c, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* SetCoordinateSystem(int32_t coord);

  /// @brief Method SetEndomorphism, addr 0x337e974, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* SetEndomorphism(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* endomorphism);

  /// @brief Method SetMultiplier, addr 0x337e97c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337d094, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x337ec08, size 0xfc, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint8_t, ::Array<uint8_t>*> x, ::ArrayW<uint8_t, ::Array<uint8_t>*> y);

  /// @brief Method Lookup, addr 0x337ea64, size 0x1a4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x337ed04, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337dec0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* outer, ::ArrayW<uint8_t, ::Array<uint8_t>*> table, int32_t size);

  /// @brief Method get_Size, addr 0x337ea5c, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckPoint, addr 0x337decc, size 0x94, virtual true, abstract: false, final false
  inline void CheckPoint(::Org::BouncyCastle::Math::EC::ECPoint* point);

  /// @brief Method CheckPoints, addr 0x337df60, size 0x24, virtual true, abstract: false, final false
  inline void CheckPoints(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method CheckPoints, addr 0x337df84, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method Configure, addr 0x337d024, size 0x70, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* Configure();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x337dca4, size 0x21c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDefaultMultiplier, addr 0x337d230, size 0xb8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier();

  /// @brief Method CreatePoint, addr 0x337d1b4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePoint, addr 0x337d1c8, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodePoint, addr 0x337e430, size 0x400, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x337e224, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x337e0d4, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAllCoordinateSystems, addr 0x337cf9c, size 0x78, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GetAllCoordinateSystems();

  /// @brief Method GetEndomorphism, addr 0x337e370, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* GetEndomorphism();

  /// @brief Method GetHashCode, addr 0x337e2bc, size 0xb4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMultiplier, addr 0x337e378, size 0xb8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* GetMultiplier();

  /// @brief Method GetPreCompInfo, addr 0x337d2f4, size 0x1f4, virtual true, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x337d848, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeAll, addr 0x337d958, size 0x28, virtual true, abstract: false, final false
  inline void NormalizeAll(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method NormalizeAll, addr 0x337d980, size 0x2f4, virtual true, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x337d4e8, size 0x360, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x337d2e8, size 0xc, virtual true, abstract: false, final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method ValidatePoint, addr 0x337d0a4, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x337d130, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x337d014, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method get_A, addr 0x337dc7c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_A();

  /// @brief Method get_B, addr 0x337dc84, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_B();

  /// @brief Method get_Cofactor, addr 0x337dc94, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Cofactor();

  /// @brief Method get_CoordinateSystem, addr 0x337dc9c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CoordinateSystem();

  /// @brief Method get_Field, addr 0x337dc74, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Order, addr 0x337dc8c, size 0x8, virtual true, abstract: false, final false
