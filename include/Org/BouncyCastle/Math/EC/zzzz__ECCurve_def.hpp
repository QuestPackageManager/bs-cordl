...
public:
  ...
  /// @brief Method Create, addr 0x2454300, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCoordinateSystem, addr 0x24542e8, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* SetCoordinateSystem(int32_t coord);

  /// @brief Method SetEndomorphism, addr 0x24542f0, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* SetEndomorphism(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* endomorphism);

  /// @brief Method SetMultiplier, addr 0x24542f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x245296c, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x2454568, size 0xf8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint8_t, ::Array<uint8_t>*> x, ::ArrayW<uint8_t, ::Array<uint8_t>*> y);

  /// @brief Method Lookup, addr 0x24543e4, size 0x184, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x2454660, size 0x148, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24537ec, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* outer, ::ArrayW<uint8_t, ::Array<uint8_t>*> table, int32_t size);

  /// @brief Method get_Size, addr 0x24543dc, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckPoint, addr 0x2453828, size 0x94, virtual true, abstract: false, final false
  inline void CheckPoint(::Org::BouncyCastle::Math::EC::ECPoint* point);

  /// @brief Method CheckPoints, addr 0x24538bc, size 0x28, virtual true, abstract: false, final false
  inline void CheckPoints(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method CheckPoints, addr 0x24538e4, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method Configure, addr 0x24528f0, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve_Config* Configure();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x24535e0, size 0x20c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDefaultMultiplier, addr 0x2452b40, size 0xb4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier();

  /// @brief Method CreatePoint, addr 0x2452ac4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePoint, addr 0x2452ad8, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodePoint, addr 0x2453db0, size 0x3fc, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2453b94, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2453a44, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAllCoordinateSystems, addr 0x2452850, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GetAllCoordinateSystems();

  /// @brief Method GetEndomorphism, addr 0x2453cec, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* GetEndomorphism();

  /// @brief Method GetHashCode, addr 0x2453c20, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMultiplier, addr 0x2453cf4, size 0xbc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* GetMultiplier();

  /// @brief Method GetPreCompInfo, addr 0x2452c00, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x2453188, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeAll, addr 0x2453298, size 0x2c, virtual true, abstract: false, final false
  inline void NormalizeAll(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method NormalizeAll, addr 0x24532c4, size 0x2ec, virtual true, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x2452e18, size 0x370, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x2452bf4, size 0xc, virtual true, abstract: false, final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method ValidatePoint, addr 0x24529b0, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x2452a3c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24528c0, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method get_A, addr 0x24535b8, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_A();

  /// @brief Method get_B, addr 0x24535c0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_B();

  /// @brief Method get_Cofactor, addr 0x24535d0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Cofactor();

  /// @brief Method get_CoordinateSystem, addr 0x24535d8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CoordinateSystem();

  /// @brief Method get_Field, addr 0x24535b0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Order, addr 0x24535c8, size 0x8, virtual true, abstract: false, final false
