...
public:
  ...
  /// @brief Method Create, addr 0x11378cc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCoordinateSystem, addr 0x11378b4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::__ECCurve__Config* SetCoordinateSystem(int32_t coord);

  /// @brief Method SetEndomorphism, addr 0x11378bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMultiplier, addr 0x11378c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1135ee0, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreatePoint, addr 0x1137b38, size 0x100, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint8_t, ::Array<uint8_t>*> x, ::ArrayW<uint8_t, ::Array<uint8_t>*> y);

  /// @brief Method Lookup, addr 0x11379b8, size 0x180, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t index);

  /// @brief Method LookupVar, addr 0x1137c38, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1136d80, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* outer, ::ArrayW<uint8_t, ::Array<uint8_t>*> table, int32_t size);

  /// @brief Method get_Size, addr 0x11379b0, size 0x8, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckPoint, addr 0x1136dbc, size 0x98, virtual true, abstract: false, final false
  inline void CheckPoint(::Org::BouncyCastle::Math::EC::ECPoint* point);

  /// @brief Method CheckPoints, addr 0x1136e54, size 0x28, virtual true, abstract: false, final false
  inline void CheckPoints(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method CheckPoints, addr 0x1136e7c, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method Configure, addr 0x1135e64, size 0x7c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::__ECCurve__Config* Configure();

  /// @brief Method CreateCacheSafeLookupTable, addr 0x1136b6c, size 0x214, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateDefaultMultiplier, addr 0x11360bc, size 0xc0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier();

  /// @brief Method CreatePoint, addr 0x1136040, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method CreatePoint, addr 0x1136054, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method DecodePoint, addr 0x1137354, size 0x420, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x1137138, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1136fe8, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method GetAllCoordinateSystems, addr 0x1135dc4, size 0x70, virtual false, abstract: false, final false
  static inline ::ArrayW<int32_t, ::Array<int32_t>*> GetAllCoordinateSystems();

  /// @brief Method GetEndomorphism, addr 0x1137290, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* GetEndomorphism();

  /// @brief Method GetHashCode, addr 0x11371c4, size 0xcc, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetMultiplier, addr 0x1137298, size 0xbc, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* GetMultiplier();

  /// @brief Method GetPreCompInfo, addr 0x1136188, size 0x218, virtual true, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x1136710, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeAll, addr 0x1136820, size 0x2c, virtual true, abstract: false, final false
  inline void NormalizeAll(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*, ::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> points);

  /// @brief Method NormalizeAll, addr 0x113684c, size 0x2f0, virtual true, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x11363a0, size 0x370, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x113617c, size 0xc, virtual true, abstract: false, final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method ValidatePoint, addr 0x1135f24, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x1135fb4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1135e34, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method get_A, addr 0x1136b44, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_A();

  /// @brief Method get_B, addr 0x1136b4c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_B();

  /// @brief Method get_Cofactor, addr 0x1136b5c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Cofactor();

  /// @brief Method get_CoordinateSystem, addr 0x1136b64, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_CoordinateSystem();

  /// @brief Method get_Field, addr 0x1136b3c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Order, addr 0x1136b54, size 0x8, virtual true, abstract: false, final false
