...
public:
  ...
  /// @brief Method Add, addr 0x352d608, size 0x84, virtual false, abstract: false, final false
  static inline void Add(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> y, int32_t yOff, int32_t count);

  /// @brief Method Add, addr 0x352d7d8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBoth, addr 0x352d880, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOne, addr 0x3526538, size 0x108, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* AddOne();

  /// @brief Method AddShiftedByBitsSafe, addr 0x352d4e4, size 0x124, virtual false, abstract: false, final false
  inline void AddShiftedByBitsSafe(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t otherDegree, int32_t bits);

  /// @brief Method AddShiftedByWords, addr 0x35263e0, size 0xcc, virtual false, abstract: false, final false
  inline void AddShiftedByWords(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t words);

  /// @brief Method AddShiftedDown, addr 0x352d73c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method AddShiftedUp, addr 0x352d68c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method BitLength, addr 0x352d0f4, size 0x158, virtual false, abstract: false, final false
  static inline int32_t BitLength(int64_t w);

  /// @brief Method Copy, addr 0x3526350, size 0x90, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Copy();

  /// @brief Method CopyTo, addr 0x3523634, size 0x28, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<int64_t> z, int32_t zOff);

  /// @brief Method Degree, addr 0x3525c64, size 0x9c, virtual false, abstract: false, final false
  inline int32_t Degree();

  /// @brief Method DegreeFrom, addr 0x352d24c, size 0xb8, virtual false, abstract: false, final false
  inline int32_t DegreeFrom(int32_t limit);

  /// @brief Method Distribute, addr 0x352d930, size 0xa8, virtual false, abstract: false, final false
  static inline void Distribute(::ArrayW<int64_t> x, int32_t src, int32_t dst1, int32_t dst2, int32_t count);

  /// @brief Method Equals, addr 0x352fc88, size 0x94, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x352fd1c, size 0xb8, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::LongArray* other);

  /// @brief Method FlipBit, addr 0x352dab4, size 0x40, virtual false, abstract: false, final false
  static inline void FlipBit(::ArrayW<int64_t> buf, int32_t off, int32_t n);

  /// @brief Method FlipVector, addr 0x352f0b0, size 0x10c, virtual false, abstract: false, final false
  static inline void FlipVector(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> y, int32_t yOff, int32_t yLen, int32_t bits);

  /// @brief Method FlipWord, addr 0x352d9f0, size 0x8c, virtual false, abstract: false, final false
  static inline void FlipWord(::ArrayW<int64_t> buf, int32_t off, int32_t bit, int64_t word);

  /// @brief Method GetHashCode, addr 0x352fdd4, size 0x74, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUsedLength, addr 0x352cff8, size 0x18, virtual false, abstract: false, final false
  inline int32_t GetUsedLength();

  /// @brief Method GetUsedLengthFrom, addr 0x352d010, size 0xe4, virtual false, abstract: false, final false
  inline int32_t GetUsedLengthFrom(int32_t from);

  /// @brief Method Interleave, addr 0x352e6ac, size 0x178, virtual false, abstract: false, final false
  static inline void Interleave(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> z, int32_t zOff, int32_t count, int32_t width);

  /// @brief Method Interleave2_32to64, addr 0x352f1bc, size 0xc4, virtual false, abstract: false, final false
  static inline int64_t Interleave2_32to64(int32_t x);

  /// @brief Method Interleave2_n, addr 0x352fafc, size 0xf4, virtual false, abstract: false, final false
  static inline int64_t Interleave2_n(int64_t x, int32_t rounds);

  /// @brief Method Interleave2_n, addr 0x352f658, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave3, addr 0x352f75c, size 0x8c, virtual false, abstract: false, final false
  static inline int64_t Interleave3(int64_t x);

  /// @brief Method Interleave3, addr 0x352f364, size 0xfc, virtual false, abstract: false, final false
  static inline void Interleave3(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> z, int32_t zOff, int32_t count);

  /// @brief Method Interleave3_13to65, addr 0x352f94c, size 0x98, virtual false, abstract: false, final false
  static inline int64_t Interleave3_13to65(int32_t x);

  /// @brief Method Interleave3_21to63, addr 0x352f7e8, size 0xb0, virtual false, abstract: false, final false
  static inline int64_t Interleave3_21to63(int32_t x);

  /// @brief Method Interleave4_16to64, addr 0x352fbf0, size 0x98, virtual false, abstract: false, final false
  static inline int64_t Interleave4_16to64(int32_t x);

  /// @brief Method Interleave5, addr 0x352f898, size 0xb4, virtual false, abstract: false, final false
  static inline int64_t Interleave5(int64_t x);

  /// @brief Method Interleave5, addr 0x352f460, size 0xfc, virtual false, abstract: false, final false
  static inline void Interleave5(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> z, int32_t zOff, int32_t count);

  /// @brief Method Interleave7, addr 0x352f9e4, size 0x118, virtual false, abstract: false, final false
  static inline int64_t Interleave7(int64_t x);

  /// @brief Method Interleave7, addr 0x352f55c, size 0xfc, virtual false, abstract: false, final false
  static inline void Interleave7(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> z, int32_t zOff, int32_t count);

  /// @brief Method IsOne, addr 0x3525d14, size 0x70, virtual false, abstract: false, final false
  inline bool IsOne();

  /// @brief Method IsZero, addr 0x3525d98, size 0x68, virtual false, abstract: false, final false
  inline bool IsZero();

  /// @brief Method ModInverse, addr 0x3527a38, size 0x444, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModInverse(int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ModMultiply, addr 0x3526728, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyAlt, addr 0x352e1d0, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyLD, addr 0x352dc0c, size 0x510, virtual false, abstract: false, final false
  ...
  /// @brief Method ModReduce, addr 0x352e824, size 0xe8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModReduce(int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ModSquare, addr 0x352736c, size 0x190, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquare(int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ModSquareN, addr 0x3527870, size 0x134, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquareN(int32_t n, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method Multiply, addr 0x3526d6c, size 0x440, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Multiply(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method MultiplyWord, addr 0x352daf4, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x35271ac, size 0xe8, virtual false, abstract: false, final false
  inline void Reduce(int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceBit, addr 0x352eebc, size 0x104, virtual false, abstract: false, final false
  static inline void ReduceBit(::ArrayW<int64_t> buf, int32_t off, int32_t bit, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceBitWise, addr 0x352edf4, size 0xc8, virtual false, abstract: false, final false
  static inline void ReduceBitWise(::ArrayW<int64_t> buf, int32_t off, int32_t BitLength, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceInPlace, addr 0x352e90c, size 0x260, virtual false, abstract: false, final false
  static inline int32_t ReduceInPlace(::ArrayW<int64_t> buf, int32_t off, int32_t len, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceResult, addr 0x352e11c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceVectorWise, addr 0x352eb6c, size 0x110, virtual false, abstract: false, final false
  static inline void ReduceVectorWise(::ArrayW<int64_t> buf, int32_t off, int32_t len, int32_t words, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceWord, addr 0x352efc0, size 0xf0, virtual false, abstract: false, final false
  static inline void ReduceWord(::ArrayW<int64_t> buf, int32_t off, int32_t bit, int64_t word, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ReduceWordWise, addr 0x352ec7c, size 0x178, virtual false, abstract: false, final false
  static inline void ReduceWordWise(::ArrayW<int64_t> buf, int32_t off, int32_t len, int32_t toBit, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method ResizedInts, addr 0x352d304, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t> ResizedInts(int32_t newLen);

  /// @brief Method ShiftUp, addr 0x352d3c0, size 0x80, virtual false, abstract: false, final false
  static inline int64_t ShiftUp(::ArrayW<int64_t> x, int32_t xOff, int32_t count, int32_t shift);

  /// @brief Method ShiftUp, addr 0x352d440, size 0xa4, virtual false, abstract: false, final false
  static inline int64_t ShiftUp(::ArrayW<int64_t> x, int32_t xOff, ::ArrayW<int64_t> z, int32_t zOff, int32_t count, int32_t shift);

  /// @brief Method Square, addr 0x352766c, size 0x150, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Square(int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method SquareInPlace, addr 0x352f280, size 0xe4, virtual false, abstract: false, final false
  static inline void SquareInPlace(::ArrayW<int64_t> x, int32_t xLen, int32_t m, ::ArrayW<int32_t> ks);

  /// @brief Method TestBit, addr 0x352da7c, size 0x38, virtual false, abstract: false, final false
  static inline bool TestBit(::ArrayW<int64_t> buf, int32_t off, int32_t n);

  /// @brief Method TestBitZero, addr 0x3525e3c, size 0x30, virtual false, abstract: false, final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger, addr 0x3525e80, size 0x210, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger();

  /// @brief Method ToString, addr 0x352fe48, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35259f8, size 0x248, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* bigInt);

  /// @brief Method .ctor, addr 0x352cee0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(int32_t intLen);

  /// @brief Method .ctor, addr 0x3523b04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int64_t> ints);

  /// @brief Method .ctor, addr 0x352cf40, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Length, addr 0x352d9d8, size 0x18, virtual false, abstract: false, final false
