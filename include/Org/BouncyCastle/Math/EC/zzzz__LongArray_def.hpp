...
public:
  ...
  /// @brief Method Add, addr 0x12c12f8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x12c14a4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBoth, addr 0x12c1534, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOne, addr 0x12ba0f4, size 0x11c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* AddOne();

  /// @brief Method AddShiftedByBitsSafe, addr 0x12c11f8, size 0x100, virtual false, abstract: false, final false
  inline void AddShiftedByBitsSafe(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t otherDegree, int32_t bits);

  /// @brief Method AddShiftedByWords, addr 0x12b9f94, size 0xd4, virtual false, abstract: false, final false
  inline void AddShiftedByWords(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t words);

  /// @brief Method AddShiftedDown, addr 0x12c1414, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method AddShiftedUp, addr 0x12c1370, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method BitLength, addr 0x12c0e58, size 0x120, virtual false, abstract: false, final false
  static inline int32_t BitLength(int64_t w);

  /// @brief Method Copy, addr 0x12b9ef4, size 0xa0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Copy();

  /// @brief Method CopyTo, addr 0x12b71d0, size 0x2c, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<int64_t, ::Array<int64_t>*> z, int32_t zOff);

  /// @brief Method Degree, addr 0x12b97f0, size 0xa4, virtual false, abstract: false, final false
  inline int32_t Degree();

  /// @brief Method DegreeFrom, addr 0x12c0f78, size 0xac, virtual false, abstract: false, final false
  inline int32_t DegreeFrom(int32_t limit);

  /// @brief Method Distribute, addr 0x12c15cc, size 0xa8, virtual false, abstract: false, final false
  static inline void Distribute(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t src, int32_t dst1, int32_t dst2, int32_t count);

  /// @brief Method Equals, addr 0x12c389c, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x12c3924, size 0xb0, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::LongArray* other);

  /// @brief Method FlipBit, addr 0x12c174c, size 0x44, virtual false, abstract: false, final false
  static inline void FlipBit(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t n);

  /// @brief Method FlipVector, addr 0x12c2d60, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipWord, addr 0x12c1690, size 0x7c, virtual false, abstract: false, final false
  static inline void FlipWord(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t bit, int64_t word);

  /// @brief Method GetHashCode, addr 0x12c39d4, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUsedLength, addr 0x12c0d5c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetUsedLength();

  /// @brief Method GetUsedLengthFrom, addr 0x12c0d78, size 0xe0, virtual false, abstract: false, final false
  inline int32_t GetUsedLengthFrom(int32_t from);

  /// @brief Method Interleave, addr 0x12c2334, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave2_32to64, addr 0x12c2e60, size 0xc0, virtual false, abstract: false, final false
  static inline int64_t Interleave2_32to64(int32_t x);

  /// @brief Method Interleave2_n, addr 0x12c371c, size 0xec, virtual false, abstract: false, final false
  static inline int64_t Interleave2_n(int64_t x, int32_t rounds);

  /// @brief Method Interleave2_n, addr 0x12c32ac, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave3, addr 0x12c33a0, size 0x88, virtual false, abstract: false, final false
  static inline int64_t Interleave3(int64_t x);

  /// @brief Method Interleave3, addr 0x12c3000, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave3_13to65, addr 0x12c3574, size 0x94, virtual false, abstract: false, final false
  static inline int64_t Interleave3_13to65(int32_t x);

  /// @brief Method Interleave3_21to63, addr 0x12c3428, size 0xac, virtual false, abstract: false, final false
  static inline int64_t Interleave3_21to63(int32_t x);

  /// @brief Method Interleave4_16to64, addr 0x12c3808, size 0x94, virtual false, abstract: false, final false
  static inline int64_t Interleave4_16to64(int32_t x);

  /// @brief Method Interleave5, addr 0x12c34d4, size 0xa0, virtual false, abstract: false, final false
  static inline int64_t Interleave5(int64_t x);

  /// @brief Method Interleave5, addr 0x12c30e4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave7, addr 0x12c3608, size 0x114, virtual false, abstract: false, final false
  static inline int64_t Interleave7(int64_t x);

  /// @brief Method Interleave7, addr 0x12c31c8, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOne, addr 0x12b98ac, size 0x60, virtual false, abstract: false, final false
  inline bool IsOne();

  /// @brief Method IsZero, addr 0x12b9960, size 0x4c, virtual false, abstract: false, final false
  inline bool IsZero();

  /// @brief Method ModInverse, addr 0x12bb580, size 0x480, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModInverse(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModMultiply, addr 0x12ba2f0, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyAlt, addr 0x12c1e78, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyLD, addr 0x12c18a8, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method ModReduce, addr 0x12c24ac, size 0xe4, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModReduce(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModSquare, addr 0x12baed0, size 0x190, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquare(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModSquareN, addr 0x12bb3b8, size 0x134, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquareN(int32_t n, int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method Multiply, addr 0x12ba8e8, size 0x430, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyWord, addr 0x12c1790, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x12bad18, size 0xe0, virtual false, abstract: false, final false
  inline void Reduce(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ReduceBit, addr 0x12c2b44, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceBitWise, addr 0x12c2a80, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceInPlace, addr 0x12c2590, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceResult, addr 0x12c1dc0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceVectorWise, addr 0x12c27d8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceWord, addr 0x12c2c58, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceWordWise, addr 0x12c2910, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizedInts, addr 0x12c1024, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t, ::Array<int64_t>*> ResizedInts(int32_t newLen);

  /// @brief Method ShiftUp, addr 0x12c10e0, size 0x80, virtual false, abstract: false, final false
  static inline int64_t ShiftUp(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t xOff, int32_t count, int32_t shift);

  /// @brief Method ShiftUp, addr 0x12c1160, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Square, addr 0x12bb1c4, size 0x150, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Square(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method SquareInPlace, addr 0x12c2f20, size 0xe0, virtual false, abstract: false, final false
  static inline void SquareInPlace(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t xLen, int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method TestBit, addr 0x12c170c, size 0x40, virtual false, abstract: false, final false
  static inline bool TestBit(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t n);

  /// @brief Method TestBitZero, addr 0x12b99e8, size 0x34, virtual false, abstract: false, final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger, addr 0x12b9a34, size 0x214, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger();

  /// @brief Method ToString, addr 0x12c3a50, size 0x1bc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12b95a4, size 0x224, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* bigInt);

  /// @brief Method .ctor, addr 0x12c0c40, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t intLen);

  /// @brief Method .ctor, addr 0x12b76a8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int64_t, ::Array<int64_t>*> ints);

  /// @brief Method .ctor, addr 0x12c0ca8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Length, addr 0x12c1674, size 0x1c, virtual false, abstract: false, final false
