...
public:
  ...
  /// @brief Method Add, addr 0x24d9ef8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Add, addr 0x24da0a4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method AddBoth, addr 0x24da134, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method AddOne, addr 0x24d2eb0, size 0x118, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* AddOne();

  /// @brief Method AddShiftedByBitsSafe, addr 0x24d9df8, size 0x100, virtual false, abstract: false, final false
  inline void AddShiftedByBitsSafe(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t otherDegree, int32_t bits);

  /// @brief Method AddShiftedByWords, addr 0x24d2d54, size 0xd4, virtual false, abstract: false, final false
  inline void AddShiftedByWords(::Org::BouncyCastle::Math::EC::LongArray* other, int32_t words);

  /// @brief Method AddShiftedDown, addr 0x24da014, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method AddShiftedUp, addr 0x24d9f70, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method BitLength, addr 0x24d9a58, size 0x120, virtual false, abstract: false, final false
  static inline int32_t BitLength(int64_t w);

  /// @brief Method Copy, addr 0x24d2cbc, size 0x98, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Copy();

  /// @brief Method CopyTo, addr 0x24cffb4, size 0x2c, virtual false, abstract: false, final false
  inline void CopyTo(::ArrayW<int64_t, ::Array<int64_t>*> z, int32_t zOff);

  /// @brief Method Degree, addr 0x24d25f8, size 0xa0, virtual false, abstract: false, final false
  inline int32_t Degree();

  /// @brief Method DegreeFrom, addr 0x24d9b78, size 0xac, virtual false, abstract: false, final false
  inline int32_t DegreeFrom(int32_t limit);

  /// @brief Method Distribute, addr 0x24da1cc, size 0xa8, virtual false, abstract: false, final false
  static inline void Distribute(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t src, int32_t dst1, int32_t dst2, int32_t count);

  /// @brief Method Equals, addr 0x24dc4c0, size 0x88, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x24dc548, size 0xbc, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::LongArray* other);

  /// @brief Method FlipBit, addr 0x24da344, size 0x40, virtual false, abstract: false, final false
  static inline void FlipBit(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t n);

  /// @brief Method FlipVector, addr 0x24db98c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method FlipWord, addr 0x24da290, size 0x7c, virtual false, abstract: false, final false
  static inline void FlipWord(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t bit, int64_t word);

  /// @brief Method GetHashCode, addr 0x24dc604, size 0x7c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetUsedLength, addr 0x24d9958, size 0x1c, virtual false, abstract: false, final false
  inline int32_t GetUsedLength();

  /// @brief Method GetUsedLengthFrom, addr 0x24d9974, size 0xe4, virtual false, abstract: false, final false
  inline int32_t GetUsedLengthFrom(int32_t from);

  /// @brief Method Interleave, addr 0x24daf70, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave2_32to64, addr 0x24dba8c, size 0xc0, virtual false, abstract: false, final false
  static inline int64_t Interleave2_32to64(int32_t x);

  /// @brief Method Interleave2_n, addr 0x24dc344, size 0xe8, virtual false, abstract: false, final false
  static inline int64_t Interleave2_n(int64_t x, int32_t rounds);

  /// @brief Method Interleave2_n, addr 0x24dbed4, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave3, addr 0x24dbfc8, size 0x88, virtual false, abstract: false, final false
  static inline int64_t Interleave3(int64_t x);

  /// @brief Method Interleave3, addr 0x24dbc28, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave3_13to65, addr 0x24dc19c, size 0x94, virtual false, abstract: false, final false
  static inline int64_t Interleave3_13to65(int32_t x);

  /// @brief Method Interleave3_21to63, addr 0x24dc050, size 0xac, virtual false, abstract: false, final false
  static inline int64_t Interleave3_21to63(int32_t x);

  /// @brief Method Interleave4_16to64, addr 0x24dc42c, size 0x94, virtual false, abstract: false, final false
  static inline int64_t Interleave4_16to64(int32_t x);

  /// @brief Method Interleave5, addr 0x24dc0fc, size 0xa0, virtual false, abstract: false, final false
  static inline int64_t Interleave5(int64_t x);

  /// @brief Method Interleave5, addr 0x24dbd0c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Interleave7, addr 0x24dc230, size 0x114, virtual false, abstract: false, final false
  static inline int64_t Interleave7(int64_t x);

  /// @brief Method Interleave7, addr 0x24dbdf0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsOne, addr 0x24d26b0, size 0x70, virtual false, abstract: false, final false
  inline bool IsOne();

  /// @brief Method IsZero, addr 0x24d2738, size 0x5c, virtual false, abstract: false, final false
  inline bool IsZero();

  /// @brief Method ModInverse, addr 0x24d4350, size 0x470, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModInverse(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModMultiply, addr 0x24d30a4, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyAlt, addr 0x24daa80, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ModMultiplyLD, addr 0x24da49c, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method ModReduce, addr 0x24db100, size 0xe0, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModReduce(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModSquare, addr 0x24d3ca8, size 0x194, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquare(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ModSquareN, addr 0x24d4188, size 0x138, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* ModSquareN(int32_t n, int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method Multiply, addr 0x24d36a4, size 0x450, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyWord, addr 0x24da384, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Reduce, addr 0x24d3af4, size 0xe0, virtual false, abstract: false, final false
  inline void Reduce(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method ReduceBit, addr 0x24db7a0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceBitWise, addr 0x24db6dc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceInPlace, addr 0x24db1e0, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceResult, addr 0x24da9d0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceVectorWise, addr 0x24db458, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceWord, addr 0x24db89c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReduceWordWise, addr 0x24db56c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method ResizedInts, addr 0x24d9c24, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<int64_t, ::Array<int64_t>*> ResizedInts(int32_t newLen);

  /// @brief Method ShiftUp, addr 0x24d9ce0, size 0x80, virtual false, abstract: false, final false
  static inline int64_t ShiftUp(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t xOff, int32_t count, int32_t shift);

  /// @brief Method ShiftUp, addr 0x24d9d60, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method Square, addr 0x24d3f9c, size 0x14c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::LongArray* Square(int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method SquareInPlace, addr 0x24dbb4c, size 0xdc, virtual false, abstract: false, final false
  static inline void SquareInPlace(::ArrayW<int64_t, ::Array<int64_t>*> x, int32_t xLen, int32_t m, ::ArrayW<int32_t, ::Array<int32_t>*> ks);

  /// @brief Method TestBit, addr 0x24da30c, size 0x38, virtual false, abstract: false, final false
  static inline bool TestBit(::ArrayW<int64_t, ::Array<int64_t>*> buf, int32_t off, int32_t n);

  /// @brief Method TestBitZero, addr 0x24d27d0, size 0x34, virtual false, abstract: false, final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger, addr 0x24d281c, size 0x204, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger();

  /// @brief Method ToString, addr 0x24dc680, size 0x1c8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d2384, size 0x24c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* bigInt);

  /// @brief Method .ctor, addr 0x24d983c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t intLen);

  /// @brief Method .ctor, addr 0x24d04a8, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int64_t, ::Array<int64_t>*> ints);

  /// @brief Method .ctor, addr 0x24d98a4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Length, addr 0x24da274, size 0x1c, virtual false, abstract: false, final false
