...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ECPointBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ECPointBase(ECPointBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ECPointBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECPointBase(ECPointBaseconst&) = delete;
