...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x106414c, size 0x1b8, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded(bool compressed);

  /// @brief Method Multiply, addr 0x1064304, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x106402c, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECFieldElement* x, ::Org::BouncyCastle::Math::EC::ECFieldElement* y, bool withCompression);

  /// @brief Method .ctor, addr 0x10640b0, size 0x9c, virtual false, abstract: false, final false
