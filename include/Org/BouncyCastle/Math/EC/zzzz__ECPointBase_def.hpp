...
public:
  // Declarations
  /// @brief Method GetEncoded, addr 0x33eab20, size 0x1cc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded(bool compressed);

  /// @brief Method Multiply, addr 0x33eacec, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x33eaa04, size 0x88, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECFieldElement* x, ::Org::BouncyCastle::Math::EC::ECFieldElement* y, bool withCompression);

  /// @brief Method .ctor, addr 0x33eaa8c, size 0x94, virtual false, abstract: false, final false
