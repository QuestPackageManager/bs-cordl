...
public:
  // Declarations
  /// @brief Method CleanPoint, addr 0x12bed6c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplCheckResult, addr 0x12bdd90, size 0x74, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ImplCheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method ImplShamirsTrickFixedPoint, addr 0x12bee4c, size 0x490, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickJsf, addr 0x12be444, size 0x4c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x12be088, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x12bf598, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x12bf2dc, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x12bfbcc, size 0x4d4, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x12bf8c4, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x12bde04, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultipliesGlv, addr 0x12bd9c4, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x12bd910, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsF2mCurve, addr 0x12bd17c, size 0x24, virtual false, abstract: false, final false
  static inline bool IsF2mCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsF2mField, addr 0x12bd1a0, size 0x184, virtual false, abstract: false, final false
  static inline bool IsF2mField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method IsFpCurve, addr 0x12bd324, size 0x24, virtual false, abstract: false, final false
  static inline bool IsFpCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsFpField, addr 0x12bd348, size 0xac, virtual false, abstract: false, final false
  static inline bool IsFpField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method MontgomeryTrick, addr 0x12be908, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method MontgomeryTrick, addr 0x12be910, size 0x2a8, virtual false, abstract: false, final false
  static inline void MontgomeryTrick(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> zs, int32_t off, int32_t len,
                                     ::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  static inline ::Org::BouncyCastle::Math::EC::ECAlgorithms* New_ctor();

  /// @brief Method ReferenceMultiply, addr 0x12bebb8, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ShamirsTrick, addr 0x12be3e8, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfMultiplies, addr 0x12bd3f4, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfTwoMultiplies, addr 0x12bd69c, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x12becf8, size 0x74, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ValidatePoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x12c00a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
