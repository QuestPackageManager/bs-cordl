...
public:
  // Declarations
  /// @brief Method IsF2mCurve addr 0x1049e08 size 0x24 virtual false final false
  static inline bool IsF2mCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsF2mField addr 0x1049e2c size 0x184 virtual false final false
  static inline bool IsF2mField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method IsFpCurve addr 0x1049fb0 size 0x24 virtual false final false
  static inline bool IsFpCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsFpField addr 0x1049fd4 size 0xac virtual false final false
  static inline bool IsFpField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method SumOfMultiplies addr 0x104a080 size 0x2a8 virtual false final false
  ...
  /// @brief Method SumOfTwoMultiplies addr 0x104a328 size 0x274 virtual false final false
  ...
  /// @brief Method ShamirsTrick addr 0x104b074 size 0x5c virtual false final false
  ...
  /// @brief Method ImportPoint addr 0x104a59c size 0xb4 virtual false final false
  ...
  /// @brief Method MontgomeryTrick addr 0x104b594 size 0x8 virtual false final false
  ...
  /// @brief Method MontgomeryTrick addr 0x104b59c size 0x2a8 virtual false final false
  static inline void MontgomeryTrick(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> zs, int32_t off, int32_t len,
                                     ::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  /// @brief Method ReferenceMultiply addr 0x104b844 size 0x140 virtual false final false
  ...
  /// @brief Method ValidatePoint addr 0x104b984 size 0x74 virtual false final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ValidatePoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method CleanPoint addr 0x104b9f8 size 0xe0 virtual false final false
  ...
  /// @brief Method ImplCheckResult addr 0x104aa1c size 0x74 virtual false final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ImplCheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method ImplShamirsTrickJsf addr 0x104b0d0 size 0x4c4 virtual false final false
  ...
  /// @brief Method ImplShamirsTrickWNaf addr 0x104ad14 size 0x360 virtual false final false
  ...
  /// @brief Method ImplShamirsTrickWNaf addr 0x104c224 size 0x32c virtual false final false
  ...
  /// @brief Method ImplShamirsTrickWNaf addr 0x104bf68 size 0x2bc virtual false final false
  ...
  /// @brief Method ImplSumOfMultiplies addr 0x104aa90 size 0x284 virtual false final false
  ...
  /// @brief Method ImplSumOfMultipliesGlv addr 0x104a650 size 0x3cc virtual false final false
  ...
  /// @brief Method ImplSumOfMultiplies addr 0x104c858 size 0x4d4 virtual false final false
  ...
  /// @brief Method ImplSumOfMultiplies addr 0x104c550 size 0x308 virtual false final false
  ...
  /// @brief Method ImplShamirsTrickFixedPoint addr 0x104bad8 size 0x490 virtual false final false
  ...
  /// @brief Method .ctor addr 0x104cd2c size 0x8 virtual false final false
  inline void _ctor();
