...
public:
  // Declarations
  /// @brief Method CleanPoint, addr 0x24cd954, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplCheckResult, addr 0x24cc988, size 0x70, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ImplCheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method ImplShamirsTrickFixedPoint, addr 0x24cda30, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickJsf, addr 0x24cd01c, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24ccc60, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24ce158, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24cdebc, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24ce78c, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24ce484, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24cc9f8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultipliesGlv, addr 0x24cc5bc, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x24cc50c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsF2mCurve, addr 0x24cbd94, size 0x24, virtual false, abstract: false, final false
  static inline bool IsF2mCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsF2mField, addr 0x24cbdb8, size 0x184, virtual false, abstract: false, final false
  static inline bool IsF2mField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method IsFpCurve, addr 0x24cbf3c, size 0x24, virtual false, abstract: false, final false
  static inline bool IsFpCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsFpField, addr 0x24cbf60, size 0xac, virtual false, abstract: false, final false
  static inline bool IsFpField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method MontgomeryTrick, addr 0x24cd4d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method MontgomeryTrick, addr 0x24cd4e0, size 0x2c4, virtual false, abstract: false, final false
  static inline void MontgomeryTrick(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> zs, int32_t off, int32_t len,
                                     ::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  static inline ::Org::BouncyCastle::Math::EC::ECAlgorithms* New_ctor();

  /// @brief Method ReferenceMultiply, addr 0x24cd7a4, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ShamirsTrick, addr 0x24ccfc0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfMultiplies, addr 0x24cc00c, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfTwoMultiplies, addr 0x24cc298, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x24cd8e4, size 0x70, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ValidatePoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x24cec24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
