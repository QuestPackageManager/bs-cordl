...
public:
  // Declarations
  /// @brief Method CleanPoint, addr 0x24cd904, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplCheckResult, addr 0x24cc938, size 0x70, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ImplCheckResult(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method ImplShamirsTrickFixedPoint, addr 0x24cd9e0, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickJsf, addr 0x24ccfcc, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24ccc10, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24ce108, size 0x32c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplShamirsTrickWNaf, addr 0x24cde6c, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24ce73c, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24ce434, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultiplies, addr 0x24cc9a8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSumOfMultipliesGlv, addr 0x24cc56c, size 0x3cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x24cc4bc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsF2mCurve, addr 0x24cbd44, size 0x24, virtual false, abstract: false, final false
  static inline bool IsF2mCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsF2mField, addr 0x24cbd68, size 0x184, virtual false, abstract: false, final false
  static inline bool IsF2mField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method IsFpCurve, addr 0x24cbeec, size 0x24, virtual false, abstract: false, final false
  static inline bool IsFpCurve(::Org::BouncyCastle::Math::EC::ECCurve* c);

  /// @brief Method IsFpField, addr 0x24cbf10, size 0xac, virtual false, abstract: false, final false
  static inline bool IsFpField(::Org::BouncyCastle::Math::Field::IFiniteField* field);

  /// @brief Method MontgomeryTrick, addr 0x24cd488, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method MontgomeryTrick, addr 0x24cd490, size 0x2c4, virtual false, abstract: false, final false
  static inline void MontgomeryTrick(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> zs, int32_t off, int32_t len,
                                     ::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  static inline ::Org::BouncyCastle::Math::EC::ECAlgorithms* New_ctor();

  /// @brief Method ReferenceMultiply, addr 0x24cd754, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ShamirsTrick, addr 0x24ccf70, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfMultiplies, addr 0x24cbfbc, size 0x28c, virtual false, abstract: false, final false
  ...
  /// @brief Method SumOfTwoMultiplies, addr 0x24cc248, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidatePoint, addr 0x24cd894, size 0x70, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::ECPoint* ValidatePoint(::Org::BouncyCastle::Math::EC::ECPoint* p);

  /// @brief Method .ctor, addr 0x24cebd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
