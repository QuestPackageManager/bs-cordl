...
CORDL_MODULE_EXPORT(ScaleXNegateYPointMap)
...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap*, "Org.BouncyCastle.Math.EC", "ScaleXNegateYPointMap");
// Dependencies System.Object
namespace Org::BouncyCastle::Math::EC {
// Is value type: false
// CS Name: Org.BouncyCastle.Math.EC.ScaleXNegateYPointMap
class CORDL_TYPE ScaleXNegateYPointMap : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method Map, addr 0x3532608, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3532600, size 0x8, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr ScaleXNegateYPointMap();

public:
  // Ctor Parameters [CppParam { name: "", ty: "ScaleXNegateYPointMap", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScaleXNegateYPointMap(ScaleXNegateYPointMap&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScaleXNegateYPointMap", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScaleXNegateYPointMap(ScaleXNegateYPointMap const&) = delete;
...
static_assert(offsetof(::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap, ___scale) == 0x10, "Offset mismatch!");

static_assert(sizeof(::Org::BouncyCastle::Math::EC::ScaleXNegateYPointMap) == 0x18, "Size mismatch!");
