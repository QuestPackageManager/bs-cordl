...
public:
  ...
  /// @brief Method Equals, addr 0x113a7ac, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x113a838, size 0x74, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::ECFieldElement* other);

  /// @brief Method GetEncoded, addr 0x113a8fc, size 0x58, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetEncoded();

  /// @brief Method GetHashCode, addr 0x113a8ac, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method MultiplyMinusProduct, addr 0x113a5cc, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method MultiplyPlusProduct, addr 0x113a628, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method SquareMinusProduct, addr 0x113a684, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method SquarePlusProduct, addr 0x113a6e8, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method SquarePow, addr 0x113a74c, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method TestBitZero, addr 0x113a784, size 0x28, virtual true, abstract: false, final false
  inline bool TestBitZero();

  /// @brief Method ToBigInteger, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger();

  /// @brief Method ToString, addr 0x113a8d4, size 0x28, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x113a954, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BitLength, addr 0x113a558, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method get_IsOne, addr 0x113a57c, size 0x24, virtual true, abstract: false, final false
  inline bool get_IsOne();

  /// @brief Method get_IsZero, addr 0x113a5a0, size 0x2c, virtual true, abstract: false, final false
