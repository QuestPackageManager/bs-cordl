...
public:
  ...
  /// @brief Method Map, addr 0x12ce23c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ce214, size 0x28, virtual false, abstract: false, final false
