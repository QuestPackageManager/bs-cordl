...
public:
  ...
  /// @brief Method Map, addr 0x12c4f44, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c4f1c, size 0x28, virtual false, abstract: false, final false
