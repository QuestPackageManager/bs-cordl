...
public:
  ...
  /// @brief Method CheckVector, addr 0x11a4bd0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11a4848, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Bits, addr 0x11a4c88, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_Bits();

  /// @brief Method get_G1, addr 0x11a4c78, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G1();

  /// @brief Method get_G2, addr 0x11a4c80, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_G2();

  /// @brief Method get_V1A, addr 0x11a4c58, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_V1A();

  /// @brief Method get_V1B, addr 0x11a4c60, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_V1B();

  /// @brief Method get_V2A, addr 0x11a4c68, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_V2A();

  /// @brief Method get_V2B, addr 0x11a4c70, size 0x8, virtual true, abstract: false, final false
