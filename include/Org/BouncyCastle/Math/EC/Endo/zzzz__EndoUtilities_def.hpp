...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities*);
MARK_REF_T(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities_MapPointCallback*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities*, "Org.BouncyCastle.Math.EC.Endo", "EndoUtilities");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities_MapPointCallback*, "Org.BouncyCastle.Math.EC.Endo", "EndoUtilities/MapPointCallback");
...
public:
  ...
  /// @brief Method CheckExisting, addr 0x350cb1c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Precompute, addr 0x350c928, size 0x1f4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x350c8b4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EndoUtilities_MapPointCallback", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities_MapPointCallback) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method CalculateB, addr 0x350c688, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method DecomposeScalar, addr 0x350c44c, size 0x23c, virtual false, abstract: false, final false
  static inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*> DecomposeScalar(::Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters* p, ::Org::BouncyCastle::Math::BigInteger* k);

  /// @brief Method MapPoint, addr 0x350c790, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x350c924, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EndoUtilities", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Endo::EndoUtilities) == 0x10, "Size mismatch!");
