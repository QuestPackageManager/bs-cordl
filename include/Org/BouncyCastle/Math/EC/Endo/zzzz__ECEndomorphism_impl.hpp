...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECPointMap* (::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism::*)()>(&::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism::get_PointMap)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism::*)()>(&::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism::get_HasEfficientPointMap)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;
