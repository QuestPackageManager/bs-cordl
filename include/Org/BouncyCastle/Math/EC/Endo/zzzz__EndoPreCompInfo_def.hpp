...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EndoPreCompInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EndoPreCompInfo(EndoPreCompInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EndoPreCompInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EndoPreCompInfo(EndoPreCompInfoconst&) = delete;
