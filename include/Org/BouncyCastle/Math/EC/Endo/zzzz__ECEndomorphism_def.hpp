...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism*, "Org.BouncyCastle.Math.EC.Endo", "ECEndomorphism");
// Dependencies
namespace Org::BouncyCastle::Math::EC::Endo {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ECEndomorphism", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ECEndomorphism(ECEndomorphismconst&) = delete;
