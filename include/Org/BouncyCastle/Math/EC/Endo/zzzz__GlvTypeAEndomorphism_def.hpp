...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GlvTypeAEndomorphism", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlvTypeAEndomorphism(GlvTypeAEndomorphism&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlvTypeAEndomorphism", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlvTypeAEndomorphism(GlvTypeAEndomorphismconst&) = delete;
