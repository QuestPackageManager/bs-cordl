...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GlvTypeAParameters", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GlvTypeAParameters(GlvTypeAParameters&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GlvTypeAParameters", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GlvTypeAParameters(GlvTypeAParametersconst&) = delete;
