...
public:
  ...
  /// @brief Method .ctor, addr 0x350a92c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_I, addr 0x350a938, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_I();

  /// @brief Method get_Lambda, addr 0x350a940, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Lambda();

  /// @brief Method get_SplitParams, addr 0x350a948, size 0x8, virtual true, abstract: false, final false
