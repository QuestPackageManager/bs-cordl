...
public:
  ...
  /// @brief Method .ctor, addr 0x11a45f4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_I, addr 0x11a4630, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_I();

  /// @brief Method get_Lambda, addr 0x11a4638, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Lambda();

  /// @brief Method get_SplitParams, addr 0x11a4640, size 0x8, virtual true, abstract: false, final false
