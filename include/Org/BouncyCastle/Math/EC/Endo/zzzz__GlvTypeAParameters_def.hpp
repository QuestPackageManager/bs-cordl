...
/// @brief Method .ctor, addr 0x3411094, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_I, addr 0x34110a0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_I() ;

/// @brief Method get_Lambda, addr 0x34110a8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Lambda() ;

/// @brief Method get_SplitParams, addr 0x34110b0, size 0x8, virtual true, abstract: false, final false
