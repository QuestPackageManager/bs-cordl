...
public:
  ...
  /// @brief Method .ctor, addr 0x24b3bd8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_I, addr 0x24b3c14, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_I();

  /// @brief Method get_Lambda, addr 0x24b3c1c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Lambda();

  /// @brief Method get_SplitParams, addr 0x24b3c24, size 0x8, virtual true, abstract: false, final false
