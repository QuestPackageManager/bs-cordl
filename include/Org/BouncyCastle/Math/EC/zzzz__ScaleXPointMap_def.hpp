...
public:
  ...
  /// @brief Method Map, addr 0x3532638, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3532630, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScaleXPointMap", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScaleXPointMap(ScaleXPointMap&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScaleXPointMap", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScaleXPointMap(ScaleXPointMapconst&) = delete;
