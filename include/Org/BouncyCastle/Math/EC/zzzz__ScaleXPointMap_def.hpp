...
public:
  ...
  /// @brief Method .ctor, addr 0x1087c88, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  /// @brief Method Map, addr 0x1087cb0, size 0x2c, virtual true, abstract: false, final false
