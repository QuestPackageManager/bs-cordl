...
public:
  ...
  /// @brief Method Map, addr 0x10f0384, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f035c, size 0x28, virtual false, abstract: false, final false
