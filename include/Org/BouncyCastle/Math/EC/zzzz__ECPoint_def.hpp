...
public:
  ...
  /// @brief Method Precompute, addr 0x24515c8, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2450c00, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckNormalized, addr 0x24507fc, size 0x68, virtual true, abstract: false, final false
  inline void CheckNormalized();

  /// @brief Method CreateScaledPoint, addr 0x2450b50, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2450ee0, size 0x8c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2450f6c, size 0x2ac, virtual true, abstract: false, final false
  inline bool Equals(::Org::BouncyCastle::Math::EC::ECPoint* other);

  /// @brief Method GetDetachedPoint, addr 0x2450664, size 0x2c, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* GetDetachedPoint();

  /// @brief Method GetEncoded, addr 0x2451424, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x2451218, size 0xc4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetInitialZCoords, addr 0x24501ac, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetZCoord, addr 0x245071c, size 0x40, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* GetZCoord(int32_t index);

  /// @brief Method GetZCoords, addr 0x245075c, size 0x88, virtual true, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> GetZCoords();

  /// @brief Method ImplIsValid, addr 0x244c33c, size 0x13c, virtual false, abstract: false, final false
  inline bool ImplIsValid(bool decompressed, bool checkOrder);

  /// @brief Method IsNormalized, addr 0x2450864, size 0x70, virtual true, abstract: false, final false
  inline bool IsNormalized();

  /// @brief Method IsValid, addr 0x244abc0, size 0xc, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method IsValidPartial, addr 0x2450bf4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Normalize, addr 0x24508d4, size 0x18c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Normalize();

  /// @brief Method Normalize, addr 0x2450a60, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method SatisfiesOrder, addr 0x2450564, size 0x100, virtual true, abstract: false, final false
  inline bool SatisfiesOrder();

  /// @brief Method ScaleX, addr 0x2450c40, size 0x90, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleX(::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  /// @brief Method ScaleXNegateY, addr 0x2450cd0, size 0xb0, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleXNegateY(::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  /// @brief Method ScaleY, addr 0x2450d80, size 0xa4, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleY(::Org::BouncyCastle::Math::EC::ECFieldElement* scale);

  /// @brief Method ScaleYNegateX, addr 0x2450e24, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method ThreeTimes, addr 0x2451510, size 0x14, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* ThreeTimes();

  /// @brief Method TimesPow2, addr 0x2451438, size 0x9c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* TimesPow2(int32_t e);

  /// @brief Method ToString, addr 0x24512dc, size 0x148, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Twice, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* Twice();

  /// @brief Method TwicePlus, addr 0x24514d4, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2450474, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECFieldElement* x, ::Org::BouncyCastle::Math::EC::ECFieldElement* y, bool withCompression);

  /// @brief Method .ctor, addr 0x2450510, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AffineXCoord, addr 0x24506b4, size 0x2c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_AffineXCoord();

  /// @brief Method get_AffineYCoord, addr 0x24506e0, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method get_Curve, addr 0x2450690, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve();

  /// @brief Method get_CurveCoordinateSystem, addr 0x2450698, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_CurveCoordinateSystem();

  /// @brief Method get_IsCompressed, addr 0x2450bec, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsCompressed();

  /// @brief Method get_IsInfinity, addr 0x244b408, size 0x20, virtual false, abstract: false, final false
  inline bool get_IsInfinity();

  /// @brief Method get_RawXCoord, addr 0x24507e4, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_RawXCoord();

  /// @brief Method get_RawYCoord, addr 0x24507ec, size 0x8, virtual false, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_RawYCoord();

  /// @brief Method get_RawZCoords, addr 0x24507f4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> get_RawZCoords();

  /// @brief Method get_XCoord, addr 0x245070c, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_XCoord();

  /// @brief Method get_YCoord, addr 0x2450714, size 0x8, virtual true, abstract: false, final false
