...
public:
  ...
  /// @brief Method Map, addr 0x10f03d8, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10f03b0, size 0x28, virtual false, abstract: false, final false
