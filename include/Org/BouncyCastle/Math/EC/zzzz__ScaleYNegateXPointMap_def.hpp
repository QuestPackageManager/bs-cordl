...
public:
  ...
  /// @brief Method Map, addr 0x3436af8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3436af0, size 0x8, virtual false, abstract: false, final false
