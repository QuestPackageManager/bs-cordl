...
/// @brief Method SatisfiesCurveEquation, addr 0x33ebb98, size 0x2b8, virtual true, abstract: false, final false
inline bool SatisfiesCurveEquation() ;

/// @brief Method Subtract, addr 0x33ebe50, size 0x60, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Subtract(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method .ctor, addr 0x33ebb64, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::Org::BouncyCastle::Math::EC::ECFieldElement*  y, bool  withCompression) ;

/// @brief Method .ctor, addr 0x33ebb68, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_CompressionYTilde, addr 0x33ebb6c, size 0x2c, virtual true, abstract: false, final false
