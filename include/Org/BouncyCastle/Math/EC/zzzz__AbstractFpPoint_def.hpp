...
public:
  ...
  /// @brief Method .ctor addr 0xfd0e70 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xfd0e78 size 0x8 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve* curve, ::Org::BouncyCastle::Math::EC::ECFieldElement* x, ::Org::BouncyCastle::Math::EC::ECFieldElement* y,
                    ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*, ::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> zs, bool withCompression);

  /// @brief Method get_CompressionYTilde addr 0xfd0e80 size 0x2c virtual true final false
  inline bool get_CompressionYTilde();

  /// @brief Method SatisfiesCurveEquation addr 0xfd0eac size 0x2d8 virtual true final false
  inline bool SatisfiesCurveEquation();

  /// @brief Method Subtract addr 0xfd1184 size 0x60 virtual true final false
