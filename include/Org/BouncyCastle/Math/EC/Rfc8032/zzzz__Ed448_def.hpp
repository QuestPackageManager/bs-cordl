...
public:
  ...
  /// @brief Method .ctor, addr 0x345ffa4, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x34612b0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateS, addr 0x345d2c8, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckContextVar, addr 0x345de7c, size 0x14, virtual false, abstract: false, final false
  static inline bool CheckContextVar(::ArrayW<uint8_t, ::Array<uint8_t>*> ctx);

  /// @brief Method CheckPoint, addr 0x345de90, size 0xe4, virtual false, abstract: false, final false
  static inline int32_t CheckPoint(::ArrayW<uint32_t, ::Array<uint32_t>*> x, ::ArrayW<uint32_t, ::Array<uint32_t>*> y);

  /// @brief Method CheckPoint, addr 0x345df74, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckPointVar, addr 0x345e0ac, size 0xe8, virtual false, abstract: false, final false
  static inline bool CheckPointVar(::ArrayW<uint8_t, ::Array<uint8_t>*> p);

  /// @brief Method CheckScalarVar, addr 0x345e268, size 0xdc, virtual false, abstract: false, final false
  static inline bool CheckScalarVar(::ArrayW<uint8_t, ::Array<uint8_t>*> s);

  /// @brief Method CreatePrehash, addr 0x345e344, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IXof* CreatePrehash();

  /// @brief Method CreateXof, addr 0x345e394, size 0x5c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IXof* CreateXof();

  /// @brief Method Decode16, addr 0x345e3f0, size 0x40, virtual false, abstract: false, final false
  static inline uint32_t Decode16(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method Decode24, addr 0x345e430, size 0x54, virtual false, abstract: false, final false
  static inline uint32_t Decode24(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method Decode32, addr 0x345e484, size 0x68, virtual false, abstract: false, final false
  static inline uint32_t Decode32(::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method Decode32, addr 0x345e194, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodePointVar, addr 0x345e4ec, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method DecodeScalar, addr 0x345d46c, size 0x78, virtual false, abstract: false, final false
  static inline void DecodeScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> k, int32_t kOff, ::ArrayW<uint32_t, ::Array<uint32_t>*> n);

  /// @brief Method Dom4, addr 0x345e720, size 0x238, virtual false, abstract: false, final false
  static inline void Dom4(::Org::BouncyCastle::Crypto::IXof* d, uint8_t x, ::ArrayW<uint8_t, ::Array<uint8_t>*> y);

  /// @brief Method Encode24, addr 0x345e958, size 0x64, virtual false, abstract: false, final false
  static inline void Encode24(uint32_t n, ::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method Encode32, addr 0x345d4e4, size 0x80, virtual false, abstract: false, final false
  static inline void Encode32(uint32_t n, ::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method Encode56, addr 0x345e9bc, size 0x80, virtual false, abstract: false, final false
  static inline void Encode56(uint64_t n, ::ArrayW<uint8_t, ::Array<uint8_t>*> bs, int32_t off);

  /// @brief Method EncodePoint, addr 0x345ea3c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method GeneratePrivateKey, addr 0x345eb84, size 0x18, virtual false, abstract: false, final false
  static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom* random, ::ArrayW<uint8_t, ::Array<uint8_t>*> k);

  /// @brief Method GeneratePublicKey, addr 0x345eb9c, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWnafVar, addr 0x345eecc, size 0x1bc, virtual false, abstract: false, final false
  static inline ::ArrayW<int8_t, ::Array<int8_t>*> GetWnafVar(::ArrayW<uint32_t, ::Array<uint32_t>*> n, int32_t width);

  /// @brief Method ImplSign, addr 0x345f088, size 0x488, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSign, addr 0x345f510, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplSign, addr 0x345f7d4, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ImplVerify, addr 0x345fa90, size 0x514, virtual false, abstract: false, final false
  ...
  /// @brief Method PointAddPrecomp, addr 0x34603f4, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method PointAddVar, addr 0x3460184, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method PointCopy, addr 0x34605ec, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method PointDouble, addr 0x3460698, size 0x17c, virtual false, abstract: false, final false
  static inline void PointDouble(::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_PointExt* r);

  /// @brief Method PointExtendXY, addr 0x345e708, size 0x18, virtual false, abstract: false, final false
  static inline void PointExtendXY(::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_PointExt* p);

  /// @brief Method PointLookup, addr 0x3460814, size 0xe0, virtual false, abstract: false, final false
  static inline void PointLookup(int32_t block, int32_t index, ::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_PointPrecomp* p);

  /// @brief Method PointPrecompVar, addr 0x34608f4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method PointSetNeutral, addr 0x3460a5c, size 0x38, virtual false, abstract: false, final false
  static inline void PointSetNeutral(::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_PointExt* p);

  /// @brief Method Precompute, addr 0x3460a94, size 0x5e8, virtual false, abstract: false, final false
  static inline void Precompute();

  /// @brief Method PruneScalar, addr 0x345ed8c, size 0x60, virtual false, abstract: false, final false
  static inline void PruneScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> n, int32_t nOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> r);

  /// @brief Method ReduceScalar, addr 0x345d564, size 0x918, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReduceScalar(::ArrayW<uint8_t, ::Array<uint8_t>*> n);

  /// @brief Method ScalarMultBase, addr 0x346107c, size 0x234, virtual false, abstract: false, final false
  static inline void ScalarMultBase(::ArrayW<uint8_t, ::Array<uint8_t>*> k, ::Org::BouncyCastle::Math::EC::Rfc8032::Ed448_PointExt* r);

  /// @brief Method ScalarMultBaseEncoded, addr 0x345edec, size 0xe0, virtual false, abstract: false, final false
  static inline void ScalarMultBaseEncoded(::ArrayW<uint8_t, ::Array<uint8_t>*> k, ::ArrayW<uint8_t, ::Array<uint8_t>*> r, int32_t rOff);

  /// @brief Method ScalarMultBaseXY, addr 0x34612d8, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ScalarMultStrausVar, addr 0x345ffd8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x3461430, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Sign, addr 0x34614f0, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method SignPrehash, addr 0x34615c0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method SignPrehash, addr 0x3461754, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method SignPrehash, addr 0x346167c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SignPrehash, addr 0x3461928, size 0x1f0, virtual false, abstract: false, final false
  static inline void SignPrehash(::ArrayW<uint8_t, ::Array<uint8_t>*> sk, int32_t skOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> pk, int32_t pkOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> ctx,
                                 ::Org::BouncyCastle::Crypto::IXof* ph, ::ArrayW<uint8_t, ::Array<uint8_t>*> sig, int32_t sigOff);

  /// @brief Method Verify, addr 0x3461b18, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyPrehash, addr 0x3461bdc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyPrehash, addr 0x3461ca0, size 0x1dc, virtual false, abstract: false, final false
  static inline bool VerifyPrehash(::ArrayW<uint8_t, ::Array<uint8_t>*> sig, int32_t sigOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> pk, int32_t pkOff, ::ArrayW<uint8_t, ::Array<uint8_t>*> ctx,
                                   ::Org::BouncyCastle::Crypto::IXof* ph);

  /// @brief Method .ctor, addr 0x3462074, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
