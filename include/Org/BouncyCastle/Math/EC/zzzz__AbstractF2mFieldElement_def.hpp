...
public:
  ...
  /// @brief Method HalfTrace addr 0xf8d87c size 0x140 virtual true final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* HalfTrace();

  /// @brief Method get_HasFastTrace addr 0xf8d9bc size 0x8 virtual true final false
  inline bool get_HasFastTrace();

  /// @brief Method Trace addr 0xf8d9c4 size 0x14c virtual true final false
  inline int32_t Trace();

  static inline ::Org::BouncyCastle::Math::EC::AbstractF2mFieldElement* New_ctor();

  /// @brief Method .ctor addr 0xf8db10 size 0x8 virtual false final false
  inline void _ctor();
