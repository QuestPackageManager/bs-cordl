...
public:
  ...
  /// @brief Method HalfTrace, addr 0x33de308, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x33de44c, size 0x164, virtual true, abstract: false, final false
  inline int32_t Trace();

  /// @brief Method .ctor, addr 0x33de5b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasFastTrace, addr 0x33de444, size 0x8, virtual true, abstract: false, final false
