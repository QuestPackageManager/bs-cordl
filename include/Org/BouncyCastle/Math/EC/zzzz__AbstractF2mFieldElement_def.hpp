...
public:
  ...
  /// @brief Method HalfTrace, addr 0x2484894, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method Trace, addr 0x24849d8, size 0x144, virtual true, abstract: false, final false
  inline int32_t Trace();

  /// @brief Method .ctor, addr 0x2484b1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_HasFastTrace, addr 0x24849d0, size 0x8, virtual true, abstract: false, final false
