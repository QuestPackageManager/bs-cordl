...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::FpCurve*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::FpCurve*, "Org.BouncyCastle.Math.EC", "FpCurve");
...
public:
  ...
  /// @brief Method CloneCurve, addr 0x3522614, size 0x8c, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method CreateRawPoint, addr 0x3522800, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x3522884, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method FromBigInteger, addr 0x35226e0, size 0x74, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method ImportPoint, addr 0x3522914, size 0x220, virtual true, abstract: false, final false
  ...
  /// @brief Method SupportsCoordinateSystem, addr 0x35226a0, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35222a0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35222ac, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x352254c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3522558, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* q, ::Org::BouncyCastle::Math::BigInteger* r, ::Org::BouncyCastle::Math::EC::ECFieldElement* a,
  ...
  /// @brief Method get_FieldSize, addr 0x35226c8, size 0x18, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method get_Infinity, addr 0x35226c0, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_Q, addr 0x35226b8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::FpCurve) == 0x68, "Size mismatch!");
