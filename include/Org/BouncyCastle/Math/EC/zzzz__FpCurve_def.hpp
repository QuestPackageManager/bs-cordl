...
public:
  ...
  /// @brief Method .ctor, addr 0x104cd34, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x104cd40, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x104cfe8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x104cff4, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* q, ::Org::BouncyCastle::Math::BigInteger* r, ::Org::BouncyCastle::Math::EC::ECFieldElement* a,
  ...
  /// @brief Method CloneCurve, addr 0x104d0b8, size 0x90, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve();

  /// @brief Method SupportsCoordinateSystem, addr 0x104d148, size 0x20, virtual true, abstract: false, final false
  inline bool SupportsCoordinateSystem(int32_t coord);

  /// @brief Method get_Q, addr 0x104d168, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Q();

  /// @brief Method get_Infinity, addr 0x104d170, size 0x8, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity();

  /// @brief Method get_FieldSize, addr 0x104d178, size 0x1c, virtual true, abstract: false, final false
  inline int32_t get_FieldSize();

  /// @brief Method FromBigInteger, addr 0x104d194, size 0x78, virtual true, abstract: false, final false
  inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger* x);

  /// @brief Method CreateRawPoint, addr 0x104d2c8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateRawPoint, addr 0x104d350, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method ImportPoint, addr 0x104d3f0, size 0x224, virtual true, abstract: false, final false
