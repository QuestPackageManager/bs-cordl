...
/// @brief Method CloneCurve, addr 0x346615c, size 0x8c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateRawPoint, addr 0x3466348, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x34663cc, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x3466228, size 0x74, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method ImportPoint, addr 0x346645c, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x34661e8, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3465de8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3465df4, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3466094, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x34660a0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method get_FieldSize, addr 0x3466210, size 0x18, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x3466208, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_Q, addr 0x3466200, size 0x8, virtual true, abstract: false, final false
