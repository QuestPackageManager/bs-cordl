...
public:
  ...
  /// @brief Method ApproximateDivisionByN, addr 0x122ea3c, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLucas, addr 0x122f0bc, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMu, addr 0x122ef78, size 0x104, virtual false, abstract: false, final false
  static inline int8_t GetMu(::Org::BouncyCastle::Math::EC::AbstractF2mCurve* curve);

  /// @brief Method GetMu, addr 0x122f07c, size 0x30, virtual false, abstract: false, final false
  static inline int8_t GetMu(::Org::BouncyCastle::Math::EC::ECFieldElement* curveA);

  /// @brief Method GetMu, addr 0x122f0ac, size 0x10, virtual false, abstract: false, final false
  static inline int8_t GetMu(int32_t curveA);

  /// @brief Method GetPreComp, addr 0x12304a0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetShiftsForCofactor, addr 0x122f718, size 0x98, virtual false, abstract: false, final false
  static inline int32_t GetShiftsForCofactor(::Org::BouncyCastle::Math::BigInteger* h);

  /// @brief Method GetSi, addr 0x122f40c, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSi, addr 0x122f7b0, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTw, addr 0x122f2a0, size 0x16c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* GetTw(int8_t mu, int32_t w);

  /// @brief Method MultiplyFromTnaf, addr 0x122fed4, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyRTnaf, addr 0x122fc88, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method MultiplyTnaf, addr 0x122fdd8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Norm, addr 0x122e440, size 0x11c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::BigInteger* Norm(int8_t mu, ::Org::BouncyCastle::Math::EC::Abc::ZTauElement* lambda);

  /// @brief Method Norm, addr 0x122e55c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method PartModReduction, addr 0x122fa00, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method Round, addr 0x122e658, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method Tau, addr 0x122ef58, size 0x20, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::EC::AbstractF2mPoint* Tau(::Org::BouncyCastle::Math::EC::AbstractF2mPoint* p);

  /// @brief Method TauAdicNaf, addr 0x122ebb4, size 0x3a4, virtual false, abstract: false, final false
  static inline ::ArrayW<int8_t, ::Array<int8_t>*> TauAdicNaf(int8_t mu, ::Org::BouncyCastle::Math::EC::Abc::ZTauElement* lambda);

  /// @brief Method TauAdicWNaf, addr 0x12300e0, size 0x3c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1230d50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
