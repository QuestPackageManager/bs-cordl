...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::EC::Abc::ZTauElement*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::EC::Abc::ZTauElement*, "Org.BouncyCastle.Math.EC.Abc", "ZTauElement");
...
public:
  ...
  /// @brief Method .ctor, addr 0x34a10a4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ZTauElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ZTauElement(ZTauElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ZTauElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ZTauElement(ZTauElementconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::EC::Abc::ZTauElement) == 0x20, "Size mismatch!");
