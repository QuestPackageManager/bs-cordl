...
/// @brief Method Equals, addr 0x343762c, size 0xbc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x34376e8, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3436fc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  characteristic) ;

/// @brief Method get_Characteristic, addr 0x343761c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Characteristic() ;

/// @brief Method get_Dimension, addr 0x3437624, size 0x8, virtual true, abstract: false, final false
