...
public:
  ...
  /// @brief Method .ctor addr 0xfea230 size 0x28 virtual false final false
  inline void _ctor(::Org::BouncyCastle::Math::BigInteger* characteristic);

  /// @brief Method get_Characteristic addr 0xfea8b4 size 0x8 virtual true final false
  inline ::Org::BouncyCastle::Math::BigInteger* get_Characteristic();

  /// @brief Method get_Dimension addr 0xfea8bc size 0x8 virtual true final false
  inline int32_t get_Dimension();

  /// @brief Method Equals addr 0xfea8c4 size 0xb4 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0xfea978 size 0x20 virtual true final false
