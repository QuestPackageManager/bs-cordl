...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrimeField", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrimeField(PrimeField&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrimeField", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrimeField(PrimeFieldconst&) = delete;
