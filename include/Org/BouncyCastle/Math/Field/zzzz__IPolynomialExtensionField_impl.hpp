...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Org::BouncyCastle::Math::Field::IPolynomial* (::Org::BouncyCastle::Math::Field::IPolynomialExtensionField::*)()>(
    &::Org::BouncyCastle::Math::Field::IPolynomialExtensionField::get_MinimalPolynomial)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Math::Field::IPolynomialExtensionField*>(),
                                                                                          { ::i2c::class_of<::Org::BouncyCastle::Math::Field::IPolynomialExtensionField*>(), 0 }));
...
inline ::Org::BouncyCastle::Math::Field::IPolynomial* Org::BouncyCastle::Math::Field::IPolynomialExtensionField::get_MinimalPolynomial() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Org::BouncyCastle::Math::Field::IPolynomialExtensionField*>(), 0 })));
