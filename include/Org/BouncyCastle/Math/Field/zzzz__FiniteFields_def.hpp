...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Math::Field::FiniteFields*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Math::Field::FiniteFields*, "Org.BouncyCastle.Math.Field", "FiniteFields");
...
public:
  ...
  /// @brief Method GetBinaryExtensionField, addr 0x353287c, size 0x178, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Math::Field::IPolynomialExtensionField* GetBinaryExtensionField(::ArrayW<int32_t> exponents);

  /// @brief Method GetPrimeField, addr 0x3532a6c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3532cc0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FiniteFields", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FiniteFields(FiniteFields&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FiniteFields", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FiniteFields(FiniteFieldsconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Math::Field::FiniteFields) == 0x10, "Size mismatch!");
