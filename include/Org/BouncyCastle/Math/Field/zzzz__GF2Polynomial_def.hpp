...
public:
  ...
  /// @brief Method Equals, addr 0x10cd82c, size 0xd8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExponentsPresent, addr 0x10cd7d0, size 0x5c, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetExponentsPresent();

  /// @brief Method GetHashCode, addr 0x10cd904, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10cd0b8, size 0x78, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int32_t, ::Array<int32_t>*> exponents);

  /// @brief Method get_Degree, addr 0x10cd79c, size 0x34, virtual true, abstract: false, final false
