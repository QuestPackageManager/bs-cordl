...
public:
  ...
  /// @brief Method Equals, addr 0x3473b20, size 0xe0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetExponentsPresent, addr 0x3473ac0, size 0x60, virtual true, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> GetExponentsPresent();

  /// @brief Method GetHashCode, addr 0x3473c00, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3473418, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<int32_t, ::Array<int32_t>*> exponents);

  /// @brief Method get_Degree, addr 0x3473a8c, size 0x34, virtual true, abstract: false, final false
