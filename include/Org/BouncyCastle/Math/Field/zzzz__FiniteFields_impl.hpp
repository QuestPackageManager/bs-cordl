...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::Field::IPolynomialExtensionField* (*)(::ArrayW<int32_t,::Array<int32_t>*>)>(&::Org::BouncyCastle::Math::Field::FiniteFields::GetBinaryExtensionField)> {
  constexpr static std::size_t size = 0x178;
  constexpr static std::size_t addrs = 0x347403c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::Field::IFiniteField* (*)(::Org::BouncyCastle::Math::BigInteger*)>(&::Org::BouncyCastle::Math::Field::FiniteFields::GetPrimeField)> {
  constexpr static std::size_t size = 0x174;
  constexpr static std::size_t addrs = 0x347422c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Math::Field::FiniteFields::*)()>(&::Org::BouncyCastle::Math::Field::FiniteFields::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3474480;
...
::cordl_internals::setStaticField<::Org::BouncyCastle::Math::Field::IFiniteField*, "GF_2", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::Field::FiniteFields*>::get>(std::forward<::Org::BouncyCastle::Math::Field::IFiniteField*>(value));
}
inline ::Org::BouncyCastle::Math::Field::IFiniteField* Org::BouncyCastle::Math::Field::FiniteFields::getStaticF_GF_2()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Math::Field::IFiniteField*, "GF_2", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::Field::FiniteFields*>::get>();
}
inline void Org::BouncyCastle::Math::Field::FiniteFields::setStaticF_GF_3(::Org::BouncyCastle::Math::Field::IFiniteField*  value)  {
::cordl_internals::setStaticField<::Org::BouncyCastle::Math::Field::IFiniteField*, "GF_3", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::Field::FiniteFields*>::get>(std::forward<::Org::BouncyCastle::Math::Field::IFiniteField*>(value));
}
inline ::Org::BouncyCastle::Math::Field::IFiniteField* Org::BouncyCastle::Math::Field::FiniteFields::getStaticF_GF_3()  {
return ::cordl_internals::getStaticField<::Org::BouncyCastle::Math::Field::IFiniteField*, "GF_3", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::Field::FiniteFields*>::get>();
}
