...
public:
  // Declarations
  /// @brief Method CreateKey, addr 0x13b2ef8, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey, addr 0x13b1974, size 0x1584, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKey, addr 0x13b1958, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyInfoData);

  /// @brief Method GetRawKey, addr 0x13b318c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPkcsDHParam, addr 0x13b2f14, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPkcsDHParam, addr 0x13b3054, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b1950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
