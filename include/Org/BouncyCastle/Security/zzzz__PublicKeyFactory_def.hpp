...
public:
  // Declarations
  /// @brief Method CreateKey, addr 0x35514b0, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey, addr 0x3550040, size 0x1470, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKey, addr 0x3550024, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyInfoData);

  /// @brief Method GetRawKey, addr 0x355177c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPkcsDHParam, addr 0x35514cc, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPkcsDHParam, addr 0x3551610, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3550020, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
