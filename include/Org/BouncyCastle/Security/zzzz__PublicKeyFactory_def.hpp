...
public:
  ...
  /// @brief Method .ctor addr 0x10ce394 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CreateKey addr 0x10ce39c size 0x1c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyInfoData);

  /// @brief Method CreateKey addr 0x10cf93c size 0x1c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey addr 0x10ce3b8 size 0x1584 virtual false final false
  ...
  /// @brief Method GetRawKey addr 0x10cfbd0 size 0x84 virtual false final false
  ...
  /// @brief Method IsPkcsDHParam addr 0x10cf958 size 0x140 virtual false final false
  static inline bool IsPkcsDHParam(::Org::BouncyCastle::Asn1::Asn1Sequence* seq);

  /// @brief Method ReadPkcsDHParam addr 0x10cfa98 size 0x138 virtual false final false
