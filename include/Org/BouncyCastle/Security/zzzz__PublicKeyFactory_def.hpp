...
public:
  // Declarations
  /// @brief Method CreateKey, addr 0x25bb50c, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey, addr 0x25b9fbc, size 0x1550, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKey, addr 0x25b9fa0, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> keyInfoData);

  /// @brief Method GetRawKey, addr 0x25bb798, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPkcsDHParam, addr 0x25bb528, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPkcsDHParam, addr 0x25bb668, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b9f98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
