...
public:
  ...
  /// @brief Method AddAlgorithm, addr 0x3601f68, size 0x1cc, virtual false, abstract: false, final false
  static inline void AddAlgorithm(::StringW canonicalName, ::ArrayW<::System::Object*> aliases);

  /// @brief Method AddBasicIVSizeEntries, addr 0x3602134, size 0x15c, virtual false, abstract: false, final false
  static inline void AddBasicIVSizeEntries(int32_t size, ::ArrayW<::StringW> algorithms);

  /// @brief Method CreateIV, addr 0x3603278, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> CreateIV(::Org::BouncyCastle::Security::SecureRandom* random, int32_t ivLength);

  /// @brief Method CreateIVOctetString, addr 0x36031d4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x36023c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3602794, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x360271c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3602444, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBasicIVSize, addr 0x3602cd0, size 0x198, virtual false, abstract: false, final false
  static inline int32_t FindBasicIVSize(::StringW canonicalName);

  /// @brief Method GenerateParameters, addr 0x3602e68, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x3602edc, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCanonicalAlgorithmName, addr 0x3602290, size 0x134, virtual false, abstract: false, final false
  static inline ::StringW GetCanonicalAlgorithmName(::StringW algorithm);

  /// @brief Method GetCipherParameters, addr 0x3602820, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x360289c, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method WithRandom, addr 0x36032e4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360081c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
