...
public:
  ...
  /// @brief Method .ctor, addr 0x1131b4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method AddAlgorithm, addr 0x11333fc, size 0x1c4, virtual false, abstract: false, final false
  static inline void AddAlgorithm(::StringW canonicalName, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> aliases);

  /// @brief Method AddBasicIVSizeEntries, addr 0x11335c0, size 0x164, virtual false, abstract: false, final false
  static inline void AddBasicIVSizeEntries(int32_t size, ::ArrayW<::StringW, ::Array<::StringW>*> algorithms);

  /// @brief Method GetCanonicalAlgorithmName, addr 0x1133724, size 0x138, virtual false, abstract: false, final false
  static inline ::StringW GetCanonicalAlgorithmName(::StringW algorithm);

  /// @brief Method CreateKeyParameter, addr 0x113385c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x1133b98, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x1133c04, size 0x80, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* CreateKeyParameter(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algOid, ::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes,
                                                                                          int32_t offset, int32_t length);

  /// @brief Method CreateKeyParameter, addr 0x11338d0, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x1133c84, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x1133cfc, size 0x45c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x11342fc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x1134364, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method WithRandom, addr 0x1134778, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateIVOctetString, addr 0x1134668, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateIV, addr 0x1134710, size 0x68, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateIV(::Org::BouncyCastle::Security::SecureRandom* random, int32_t ivLength);

  /// @brief Method FindBasicIVSize, addr 0x1134158, size 0x1a4, virtual false, abstract: false, final false
