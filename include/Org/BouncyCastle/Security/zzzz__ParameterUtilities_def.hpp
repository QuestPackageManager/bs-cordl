...
public:
  ...
  /// @brief Method AddAlgorithm, addr 0x3544d14, size 0x1cc, virtual false, abstract: false, final false
  static inline void AddAlgorithm(::StringW canonicalName, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> aliases);

  /// @brief Method AddBasicIVSizeEntries, addr 0x3544ee0, size 0x15c, virtual false, abstract: false, final false
  static inline void AddBasicIVSizeEntries(int32_t size, ::ArrayW<::StringW, ::Array<::StringW>*> algorithms);

  /// @brief Method CreateIV, addr 0x3546024, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CreateIV(::Org::BouncyCastle::Security::SecureRandom* random, int32_t ivLength);

  /// @brief Method CreateIVOctetString, addr 0x3545f80, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3545170, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x3545540, size 0x8c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* CreateKeyParameter(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algOid, ::ArrayW<uint8_t, ::Array<uint8_t>*> keyBytes,
                                                                                          int32_t offset, int32_t length);

  /// @brief Method CreateKeyParameter, addr 0x35454c8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateKeyParameter, addr 0x35451f0, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBasicIVSize, addr 0x3545a7c, size 0x198, virtual false, abstract: false, final false
  static inline int32_t FindBasicIVSize(::StringW canonicalName);

  /// @brief Method GenerateParameters, addr 0x3545c14, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateParameters, addr 0x3545c88, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCanonicalAlgorithmName, addr 0x354503c, size 0x134, virtual false, abstract: false, final false
  static inline ::StringW GetCanonicalAlgorithmName(::StringW algorithm);

  /// @brief Method GetCipherParameters, addr 0x35455cc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCipherParameters, addr 0x3545648, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method WithRandom, addr 0x3546090, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35435c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
