...
public:
  ...
  /// @brief Method .ctor, addr 0x13a1210, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13a1218, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13a1220, size 0x8, virtual false, abstract: false, final false
