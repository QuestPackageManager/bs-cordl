...
public:
  ...
  /// @brief Method .ctor, addr 0x25ab224, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ab22c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ab234, size 0x8, virtual false, abstract: false, final false
