...
public:
  ...
  /// @brief Method .ctor, addr 0x3540844, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x354084c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3540854, size 0x8, virtual false, abstract: false, final false
