...
public:
  ...
  /// @brief Method .ctor, addr 0x35ffe20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ffe28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ffe30, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InvalidParameterException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InvalidParameterException(InvalidParameterException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InvalidParameterException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InvalidParameterException(InvalidParameterExceptionconst&) = delete;
