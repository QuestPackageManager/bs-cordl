...
public:
  ...
  /// @brief Method .ctor, addr 0x25aef5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aef64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25aef6c, size 0x8, virtual false, abstract: false, final false
