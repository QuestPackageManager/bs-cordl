...
public:
  ...
  /// @brief Method .ctor, addr 0x25aab5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aab64, size 0x8, virtual false, abstract: false, final false
