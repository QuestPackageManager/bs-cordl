...
public:
  ...
  /// @brief Method CreateEngine, addr 0x35122b4, size 0x118, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID);

  /// @brief Method CreateEngine, addr 0x3511d5c, size 0x558, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::StringW algorithm);

  /// @brief Method CreateEngine, addr 0x3511cf8, size 0x64, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid);

  /// @brief Method FixDesParity, addr 0x3511acc, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x35101f4, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x3510178, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x3510328, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x3511904, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x35119ac, size 0xac, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero);

  /// @brief Method GenerateCipherParameters, addr 0x3511a58, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x351072c, size 0x114c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x35106ac, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x3511878, size 0x8c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero, ::Org::BouncyCastle::Asn1::Asn1Encodable* pbeParameters);

  /// @brief Method GetEncodingName, addr 0x35123cc, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetObjectIdentifier, addr 0x350f4e4, size 0x208, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method IsOpenSsl, addr 0x350fdb4, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsOpenSsl(::StringW algorithm);

  /// @brief Method IsPbeAlgorithm, addr 0x350ffb0, size 0x1c8, virtual false, abstract: false, final false
  static inline bool IsPbeAlgorithm(::StringW algorithm);

  /// @brief Method IsPkcs12, addr 0x350f7c0, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs12(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme1, addr 0x350f9bc, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs5Scheme1(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme2, addr 0x350fbb8, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs5Scheme2(::StringW algorithm);

  /// @brief Method MakePbeGenerator, addr 0x350f294, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3509b74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Algorithms, addr 0x350f6ec, size 0xd4, virtual false, abstract: false, final false
