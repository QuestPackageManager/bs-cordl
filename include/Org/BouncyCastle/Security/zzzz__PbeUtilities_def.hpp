...
public:
  ...
  /// @brief Method .ctor addr 0x10c35a4 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method MakePbeGenerator addr 0x10c8bb0 size 0x248 virtual false final false
  ...
  /// @brief Method GetObjectIdentifier addr 0x10c8df8 size 0x208 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method get_Algorithms addr 0x10c9000 size 0xcc virtual false final false
  static inline ::System::Collections::ICollection* get_Algorithms();

  /// @brief Method IsPkcs12 addr 0x10c90cc size 0x1fc virtual false final false
  static inline bool IsPkcs12(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme1 addr 0x10c92c8 size 0x1fc virtual false final false
  static inline bool IsPkcs5Scheme1(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme2 addr 0x10c94c4 size 0x1fc virtual false final false
  static inline bool IsPkcs5Scheme2(::StringW algorithm);

  /// @brief Method IsOpenSsl addr 0x10c96c0 size 0x1fc virtual false final false
  static inline bool IsOpenSsl(::StringW algorithm);

  /// @brief Method IsPbeAlgorithm addr 0x10c98bc size 0x1cc virtual false final false
  static inline bool IsPbeAlgorithm(::StringW algorithm);

  /// @brief Method GenerateAlgorithmParameters addr 0x10c9a88 size 0x78 virtual false final false
  ...
  /// @brief Method GenerateAlgorithmParameters addr 0x10c9b00 size 0x134 virtual false final false
  ...
  /// @brief Method GenerateAlgorithmParameters addr 0x10c9c34 size 0x3c4 virtual false final false
  ...
  /// @brief Method GenerateCipherParameters addr 0x10c9ff8 size 0x7c virtual false final false
  ...
  /// @brief Method GenerateCipherParameters addr 0x10cb1a8 size 0x80 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero, ::Org::BouncyCastle::Asn1::Asn1Encodable* pbeParameters);

  /// @brief Method GenerateCipherParameters addr 0x10cb228 size 0xa4 virtual false final false
  ...
  /// @brief Method GenerateCipherParameters addr 0x10cb2cc size 0xa8 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero);

  /// @brief Method GenerateCipherParameters addr 0x10cb374 size 0x70 virtual false final false
  ...
  /// @brief Method GenerateCipherParameters addr 0x10ca074 size 0x1134 virtual false final false
  ...
  /// @brief Method CreateEngine addr 0x10cb5fc size 0x60 virtual false final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid);

  /// @brief Method CreateEngine addr 0x10cbb54 size 0x110 virtual false final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID);

  /// @brief Method CreateEngine addr 0x10cb65c size 0x4f8 virtual false final false
  static inline ::System::Object* CreateEngine(::StringW algorithm);

  /// @brief Method GetEncodingName addr 0x10cbc64 size 0x108 virtual false final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method FixDesParity addr 0x10cb3e4 size 0x218 virtual false final false
