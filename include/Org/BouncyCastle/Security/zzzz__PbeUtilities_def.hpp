...
public:
  ...
  /// @brief Method CreateEngine, addr 0x25b87a0, size 0x110, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID);

  /// @brief Method CreateEngine, addr 0x25b828c, size 0x514, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::StringW algorithm);

  /// @brief Method CreateEngine, addr 0x25b822c, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Object* CreateEngine(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid);

  /// @brief Method FixDesParity, addr 0x25b8018, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x25b677c, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x25b6704, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateAlgorithmParameters, addr 0x25b68a0, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x25b7e5c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x25b7f00, size 0xa8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero);

  /// @brief Method GenerateCipherParameters, addr 0x25b7fa8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x25b6cc8, size 0x1114, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x25b6c4c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateCipherParameters, addr 0x25b7ddc, size 0x80, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateCipherParameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* algorithmOid, ::ArrayW<char16_t, ::Array<char16_t>*> password,
                                                                                         bool wrongPkcs12Zero, ::Org::BouncyCastle::Asn1::Asn1Encodable* pbeParameters);

  /// @brief Method GetEncodingName, addr 0x25b88b0, size 0x108, virtual false, abstract: false, final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetObjectIdentifier, addr 0x25b5a74, size 0x208, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method IsOpenSsl, addr 0x25b633c, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsOpenSsl(::StringW algorithm);

  /// @brief Method IsPbeAlgorithm, addr 0x25b6538, size 0x1cc, virtual false, abstract: false, final false
  static inline bool IsPbeAlgorithm(::StringW algorithm);

  /// @brief Method IsPkcs12, addr 0x25b5d48, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs12(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme1, addr 0x25b5f44, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs5Scheme1(::StringW algorithm);

  /// @brief Method IsPkcs5Scheme2, addr 0x25b6140, size 0x1fc, virtual false, abstract: false, final false
  static inline bool IsPkcs5Scheme2(::StringW algorithm);

  /// @brief Method MakePbeGenerator, addr 0x25b583c, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b0230, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Algorithms, addr 0x25b5c7c, size 0xcc, virtual false, abstract: false, final false
