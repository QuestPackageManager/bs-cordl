...
public:
  ...
  /// @brief Method .ctor, addr 0x25ba54c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ba4e4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ba5a4, size 0x70, virtual false, abstract: false, final false
