...
public:
  ...
  /// @brief Method .ctor, addr 0x360eabc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x360ea50, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x360eb14, size 0x74, virtual false, abstract: false, final false
