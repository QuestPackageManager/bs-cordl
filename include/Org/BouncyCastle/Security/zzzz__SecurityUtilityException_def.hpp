...
public:
  ...
  /// @brief Method .ctor, addr 0x3551868, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35517fc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35518c0, size 0x74, virtual false, abstract: false, final false
