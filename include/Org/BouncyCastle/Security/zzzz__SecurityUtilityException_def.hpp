...
public:
  ...
  /// @brief Method .ctor, addr 0x13b3278, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x13b3210, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13b32d0, size 0x70, virtual false, abstract: false, final false
