...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::InvalidKeyException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::InvalidKeyException*, "Org.BouncyCastle.Security", "InvalidKeyException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35fda80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35fda88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35fda90, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::InvalidKeyException) == 0x90, "Size mismatch!");
