...
public:
  ...
  /// @brief Method .ctor, addr 0x25aab84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aab8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25aab94, size 0x8, virtual false, abstract: false, final false
