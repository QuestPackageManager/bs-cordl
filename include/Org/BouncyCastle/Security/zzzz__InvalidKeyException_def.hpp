...
public:
  ...
  /// @brief Method .ctor, addr 0x1397f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1397f08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1397f10, size 0x8, virtual false, abstract: false, final false
