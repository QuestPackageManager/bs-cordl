...
public:
  ...
  /// @brief Method .ctor, addr 0x3504298, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35042a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35042a8, size 0x8, virtual false, abstract: false, final false
