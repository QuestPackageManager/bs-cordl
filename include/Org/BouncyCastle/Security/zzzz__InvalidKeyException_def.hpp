...
public:
  ...
  /// @brief Method .ctor, addr 0x25aab44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aab4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25aab54, size 0x8, virtual false, abstract: false, final false
