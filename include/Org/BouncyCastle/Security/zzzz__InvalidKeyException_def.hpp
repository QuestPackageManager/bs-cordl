...
public:
  ...
  /// @brief Method .ctor, addr 0x25aabd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aabdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25aabe4, size 0x8, virtual false, abstract: false, final false
