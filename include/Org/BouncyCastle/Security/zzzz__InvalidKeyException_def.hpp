...
public:
  ...
  /// @brief Method .ctor, addr 0x34d9a54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34d9a5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34d9a64, size 0x8, virtual false, abstract: false, final false
