...
public:
  ...
  /// @brief Method .ctor, addr 0x1390690, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1390698, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x13906a0, size 0x8, virtual false, abstract: false, final false
