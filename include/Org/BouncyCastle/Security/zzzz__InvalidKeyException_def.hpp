...
public:
  ...
  /// @brief Method .ctor, addr 0x354082c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3540834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x354083c, size 0x8, virtual false, abstract: false, final false
