...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Security::GeneralSecurityException::*)()>(&::Org::BouncyCastle::Security::GeneralSecurityException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x35c566c;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Security::GeneralSecurityException::*)(::StringW)>(&::Org::BouncyCastle::Security::GeneralSecurityException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x35c56c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Org::BouncyCastle::Security::GeneralSecurityException*>(), { ".ctor", {}, { ::i2c::type_of<::StringW>() } })));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::Org::BouncyCastle::Security::GeneralSecurityException._ctor
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Org::BouncyCastle::Security::GeneralSecurityException::*)(::StringW, ::System::Exception*)>(
  ...
  constexpr static std::size_t addrs = 0x35c5730;
...
inline ::Org::BouncyCastle::Security::GeneralSecurityException* Org::BouncyCastle::Security::GeneralSecurityException::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Security::GeneralSecurityException*>());
}
inline ::Org::BouncyCastle::Security::GeneralSecurityException* Org::BouncyCastle::Security::GeneralSecurityException::New_ctor(::StringW message) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Security::GeneralSecurityException*>(message));
}
inline ::Org::BouncyCastle::Security::GeneralSecurityException* Org::BouncyCastle::Security::GeneralSecurityException::New_ctor(::StringW message, ::System::Exception* exception) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Org::BouncyCastle::Security::GeneralSecurityException*>(message, exception));
}
// Ctor Parameters []
