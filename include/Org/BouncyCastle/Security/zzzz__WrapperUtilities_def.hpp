...
MARK_REF_T(::Org::BouncyCastle::Security::WrapperUtilities*);
MARK_REF_T(::Org::BouncyCastle::Security::WrapperUtilities_BufferedCipherWrapper*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::WrapperUtilities_WrapAlgorithm, "Org.BouncyCastle.Security", "WrapperUtilities/WrapAlgorithm");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::WrapperUtilities*, "Org.BouncyCastle.Security", "WrapperUtilities");
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::WrapperUtilities_BufferedCipherWrapper*, "Org.BouncyCastle.Security", "WrapperUtilities/BufferedCipherWrapper");
// Dependencies
namespace Org::BouncyCastle::Security {
// Is value type: true
...
static_assert(sizeof(::Org::BouncyCastle::Security::WrapperUtilities_WrapAlgorithm) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x361ef8c, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method Unwrap, addr 0x361f174, size 0x120, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x361f054, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x361ede0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x361eee8, size 0xa4, virtual true, abstract: false, final true
...
static_assert(sizeof(::Org::BouncyCastle::Security::WrapperUtilities_BufferedCipherWrapper) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetAlgorithmName, addr 0x361ede8, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetWrapper, addr 0x361e874, size 0x56c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IWrapper* GetWrapper(::StringW algorithm);

  /// @brief Method GetWrapper, addr 0x361e810, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361e028, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::Org::BouncyCastle::Security::WrapperUtilities) == 0x10, "Size mismatch!");
