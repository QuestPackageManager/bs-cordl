...
public:
  ...
  /// @brief Method Init, addr 0x355f9b0, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method Unwrap, addr 0x355fb98, size 0x120, virtual true, abstract: false, final true
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t inOff, int32_t length);

  /// @brief Method Wrap, addr 0x355fa78, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x355f804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher* cipher);

  /// @brief Method get_AlgorithmName, addr 0x355f90c, size 0xa4, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetAlgorithmName, addr 0x355f80c, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetWrapper, addr 0x355f298, size 0x56c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IWrapper* GetWrapper(::StringW algorithm);

  /// @brief Method GetWrapper, addr 0x355f234, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x355ea4c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
