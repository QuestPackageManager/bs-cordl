...
public:
  ...
  /// @brief Method CalculateMac, addr 0x11c7d20, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x11c7e78, size 0x134, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IMac* mac);

  /// @brief Method DoFinal, addr 0x11c7fac, size 0xec, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IMac* mac, ::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method GetAlgorithmName, addr 0x11c7c18, size 0x108, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetMac, addr 0x11c7090, size 0xb88, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IMac* GetMac(::StringW algorithm);

  /// @brief Method GetMac, addr 0x11c7030, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11c5418, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
