...
public:
  ...
  /// @brief Method .ctor addr 0x1121578 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method GetObjectIdentifier addr 0x1121580 size 0x25c virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method get_Algorithms addr 0x11217dc size 0xcc virtual false final false
  static inline ::System::Collections::ICollection* get_Algorithms();

  /// @brief Method GetCipher addr 0x11218a8 size 0x60 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetCipher(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetCipher addr 0x1121908 size 0x21cc virtual false final false
  static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetCipher(::StringW algorithm);

  /// @brief Method GetAlgorithmName addr 0x1124120 size 0x108 virtual false final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetDigitIndex addr 0x1123ad4 size 0xb0 virtual false final false
  static inline int32_t GetDigitIndex(::StringW s);

  /// @brief Method CreateBlockCipher addr 0x1123b84 size 0x59c virtual false final false
