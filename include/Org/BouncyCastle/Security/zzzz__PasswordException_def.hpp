...
public:
  ...
  /// @brief Method .ctor, addr 0x2554f80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2554f88, size 0x8, virtual false, abstract: false, final false
