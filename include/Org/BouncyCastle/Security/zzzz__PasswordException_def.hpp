...
public:
  ...
  /// @brief Method .ctor, addr 0x2551248, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2551250, size 0x8, virtual false, abstract: false, final false
