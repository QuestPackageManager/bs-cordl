...
public:
  ...
  /// @brief Method .ctor, addr 0x35a4ae0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35a4b04, size 0x24, virtual false, abstract: false, final false
