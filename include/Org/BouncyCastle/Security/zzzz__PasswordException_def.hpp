...
public:
  ...
  /// @brief Method .ctor, addr 0x3480ab4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3480ad8, size 0x24, virtual false, abstract: false, final false
