...
public:
  ...
  /// @brief Method .ctor, addr 0x2550c10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2550c18, size 0x8, virtual false, abstract: false, final false
