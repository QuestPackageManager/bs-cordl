...
public:
  ...
  /// @brief Method .ctor, addr 0x35a6e68, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35a6e8c, size 0x24, virtual false, abstract: false, final false
