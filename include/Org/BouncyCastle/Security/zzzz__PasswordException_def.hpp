...
public:
  ...
  /// @brief Method .ctor, addr 0x1167ae8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1167af0, size 0x8, virtual false, abstract: false, final false
