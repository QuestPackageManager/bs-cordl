...
public:
  ...
  /// @brief Method .ctor, addr 0x34ab2f8, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34ab31c, size 0x24, virtual false, abstract: false, final false
