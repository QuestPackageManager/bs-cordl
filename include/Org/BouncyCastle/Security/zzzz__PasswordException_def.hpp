...
public:
  ...
  /// @brief Method .ctor, addr 0x124166c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1241674, size 0x8, virtual false, abstract: false, final false
