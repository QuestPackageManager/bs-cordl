...
public:
  ...
  /// @brief Method GetDefaultX509Parameters, addr 0x13b54f4, size 0x2a8, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::StringW algorithm);

  /// @brief Method GetDefaultX509Parameters, addr 0x13b5494, size 0x60, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetEncodingName, addr 0x13b6a7c, size 0x108, virtual false, abstract: false, final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetObjectIdentifier, addr 0x13b516c, size 0x25c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method GetPssX509Parameters, addr 0x13b579c, size 0x244, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetPssX509Parameters(::StringW digestName);

  /// @brief Method GetSigner, addr 0x13b5a40, size 0x103c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::StringW algorithm);

  /// @brief Method GetSigner, addr 0x13b59e0, size 0x60, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method InitSigner, addr 0x13b6c04, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method InitSigner, addr 0x13b6b84, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13aa060, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Algorithms, addr 0x13b53c8, size 0xcc, virtual false, abstract: false, final false
