...
public:
  ...
  /// @brief Method .ctor addr 0x10cfd9c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method GetObjectIdentifier addr 0x10daea8 size 0x25c virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method get_Algorithms addr 0x10db104 size 0xcc virtual false final false
  static inline ::System::Collections::ICollection* get_Algorithms();

  /// @brief Method GetDefaultX509Parameters addr 0x10db1d0 size 0x60 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetDefaultX509Parameters addr 0x10db230 size 0x2a8 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetDefaultX509Parameters(::StringW algorithm);

  /// @brief Method GetPssX509Parameters addr 0x10db4d8 size 0x244 virtual false final false
  static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetPssX509Parameters(::StringW digestName);

  /// @brief Method GetSigner addr 0x10db71c size 0x60 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetSigner addr 0x10db77c size 0x103c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::ISigner* GetSigner(::StringW algorithm);

  /// @brief Method GetEncodingName addr 0x10dc7b8 size 0x108 virtual false final false
  static inline ::StringW GetEncodingName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method InitSigner addr 0x10dc8c0 size 0x80 virtual false final false
  ...
  /// @brief Method InitSigner addr 0x10dc940 size 0x138 virtual false final false
