...
public:
  ...
  /// @brief Method .ctor, addr 0x1386a70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1386a78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1386a80, size 0x8, virtual false, abstract: false, final false
