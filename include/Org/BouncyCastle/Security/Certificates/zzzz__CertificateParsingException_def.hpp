...
public:
  ...
  /// @brief Method .ctor, addr 0x2598238, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2598240, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2598248, size 0x8, virtual false, abstract: false, final false
