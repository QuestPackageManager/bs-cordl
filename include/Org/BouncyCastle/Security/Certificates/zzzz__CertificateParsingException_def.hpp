...
public:
  ...
  /// @brief Method .ctor, addr 0x35ed344, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ed34c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ed354, size 0x8, virtual false, abstract: false, final false
