...
public:
  ...
  /// @brief Method .ctor, addr 0x2596b18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2596b20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2596b28, size 0x8, virtual false, abstract: false, final false
