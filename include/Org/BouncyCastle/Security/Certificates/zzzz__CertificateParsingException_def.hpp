...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::Certificates::CertificateParsingException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::Certificates::CertificateParsingException*, "Org.BouncyCastle.Security.Certificates", "CertificateParsingException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35ef6cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ef6d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ef6dc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateParsingException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateParsingException(CertificateParsingException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateParsingException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateParsingException(CertificateParsingExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Security::Certificates::CertificateParsingException) == 0x90, "Size mismatch!");
