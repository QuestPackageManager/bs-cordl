...
public:
  ...
  /// @brief Method .ctor, addr 0x11b3f58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11b3f60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11b3f68, size 0x8, virtual false, abstract: false, final false
