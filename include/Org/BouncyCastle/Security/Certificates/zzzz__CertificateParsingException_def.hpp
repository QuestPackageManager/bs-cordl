...
public:
  ...
  /// @brief Method .ctor, addr 0x2564f4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2564f54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2564f5c, size 0x8, virtual false, abstract: false, final false
