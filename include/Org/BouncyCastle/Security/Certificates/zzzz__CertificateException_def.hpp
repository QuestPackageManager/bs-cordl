...
public:
  ...
  /// @brief Method .ctor addr 0x10ac740 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CertificateException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x10ac748 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10ac750 size 0x8 virtual false final false
