...
public:
  ...
  /// @brief Method .ctor, addr 0x35ed2e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ed2ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ed2f4, size 0x8, virtual false, abstract: false, final false
