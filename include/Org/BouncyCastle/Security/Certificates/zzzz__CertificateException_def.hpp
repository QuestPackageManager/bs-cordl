...
public:
  ...
  /// @brief Method .ctor addr 0x111d994 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CertificateException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x111d99c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x111d9a4 size 0x8 virtual false final false
