...
public:
  ...
  /// @brief Method .ctor, addr 0x259a570, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x259a578, size 0x8, virtual false, abstract: false, final false
