...
public:
  ...
  /// @brief Method .ctor, addr 0x138fd08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x138fd10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x138fd18, size 0x8, virtual false, abstract: false, final false
