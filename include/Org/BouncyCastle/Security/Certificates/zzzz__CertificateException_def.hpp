...
public:
  ...
  /// @brief Method .ctor, addr 0x1386a10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1386a18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x1386a20, size 0x8, virtual false, abstract: false, final false
