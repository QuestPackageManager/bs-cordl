...
public:
  ...
  /// @brief Method .ctor, addr 0x34c92b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34c92c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34c92c8, size 0x8, virtual false, abstract: false, final false
