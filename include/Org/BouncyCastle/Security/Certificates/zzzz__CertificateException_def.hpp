...
public:
  ...
  /// @brief Method .ctor, addr 0x2559e44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2559e4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2559e54, size 0x8, virtual false, abstract: false, final false
