...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::Certificates::CertificateException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::Certificates::CertificateException*, "Org.BouncyCastle.Security.Certificates", "CertificateException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35ef66c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ef674, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ef67c, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateException(CertificateException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateException(CertificateExceptionconst&) = delete;
...
static_assert(sizeof(::Org::BouncyCastle::Security::Certificates::CertificateException) == 0x90, "Size mismatch!");
