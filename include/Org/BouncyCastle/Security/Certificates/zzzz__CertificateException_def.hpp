...
public:
  ...
  /// @brief Method .ctor, addr 0x34f3afc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34f3b04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34f3b0c, size 0x8, virtual false, abstract: false, final false
