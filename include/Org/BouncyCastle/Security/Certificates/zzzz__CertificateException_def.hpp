...
public:
  ...
  /// @brief Method .ctor, addr 0x259a528, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x259a530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x259a538, size 0x8, virtual false, abstract: false, final false
