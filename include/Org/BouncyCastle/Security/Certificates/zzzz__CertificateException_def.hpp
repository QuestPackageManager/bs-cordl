...
public:
  ...
  /// @brief Method .ctor, addr 0x3530090, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3530098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35300a0, size 0x8, virtual false, abstract: false, final false
