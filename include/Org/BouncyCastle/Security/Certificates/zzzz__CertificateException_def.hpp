...
public:
  ...
  /// @brief Method .ctor, addr 0x2596ab8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2596ac0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2596ac8, size 0x8, virtual false, abstract: false, final false
