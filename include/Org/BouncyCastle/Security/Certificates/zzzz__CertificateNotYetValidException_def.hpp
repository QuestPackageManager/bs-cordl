...
public:
  ...
  /// @brief Method .ctor, addr 0x2596b00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2596b08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2596b10, size 0x8, virtual false, abstract: false, final false
