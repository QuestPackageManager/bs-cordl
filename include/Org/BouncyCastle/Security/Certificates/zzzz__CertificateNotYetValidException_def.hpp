...
public:
  ...
  /// @brief Method .ctor, addr 0x11b3f40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11b3f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11b3f50, size 0x8, virtual false, abstract: false, final false
