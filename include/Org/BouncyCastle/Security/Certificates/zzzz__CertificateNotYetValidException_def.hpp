...
public:
  ...
  /// @brief Method .ctor, addr 0x118d83c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x118d844, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x118d84c, size 0x8, virtual false, abstract: false, final false
