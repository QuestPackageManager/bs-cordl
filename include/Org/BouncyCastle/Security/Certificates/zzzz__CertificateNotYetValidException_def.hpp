...
public:
  ...
  /// @brief Method .ctor, addr 0x128dac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x128dacc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x128dad4, size 0x8, virtual false, abstract: false, final false
