...
public:
  ...
  /// @brief Method .ctor, addr 0x35300d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35300e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35300e8, size 0x8, virtual false, abstract: false, final false
