...
public:
  ...
  /// @brief Method .ctor, addr 0x111d9dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CertificateNotYetValidException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x111d9e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x111d9ec, size 0x8, virtual false, abstract: false, final false
