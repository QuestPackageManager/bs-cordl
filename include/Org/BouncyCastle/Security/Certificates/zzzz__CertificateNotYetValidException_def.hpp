...
public:
  ...
  /// @brief Method .ctor, addr 0x114b86c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CertificateNotYetValidException* New_ctor(::StringW message);

  /// @brief Method .ctor, addr 0x114b874, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x114b87c, size 0x8, virtual false, abstract: false, final false
