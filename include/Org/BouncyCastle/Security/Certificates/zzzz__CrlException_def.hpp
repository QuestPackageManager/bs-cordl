...
public:
  ...
  /// @brief Method .ctor, addr 0x111da0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CrlException* New_ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x111da14, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x111da1c, size 0x8, virtual false, abstract: false, final false
