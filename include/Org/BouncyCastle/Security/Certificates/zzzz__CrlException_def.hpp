...
public:
  ...
  /// @brief Method .ctor, addr 0x1386a88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1386a90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x1386a98, size 0x8, virtual false, abstract: false, final false
