...
public:
  ...
  /// @brief Method .ctor addr 0x10ac7b8 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::Certificates::CrlException* New_ctor(::StringW msg);

  /// @brief Method .ctor addr 0x10ac7c0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x10ac7c8 size 0x8 virtual false final false
