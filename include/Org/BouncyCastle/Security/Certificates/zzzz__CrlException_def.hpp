...
public:
  ...
  /// @brief Method .ctor, addr 0x3530108, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3530110, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x3530118, size 0x8, virtual false, abstract: false, final false
