...
public:
  ...
  /// @brief Method .ctor, addr 0x128daac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x128dab4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x128dabc, size 0x8, virtual false, abstract: false, final false
