...
public:
  ...
  /// @brief Method .ctor, addr 0x2596ae8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2596af0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x2596af8, size 0x8, virtual false, abstract: false, final false
