...
public:
  ...
  /// @brief Method .ctor, addr 0x35ed314, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ed31c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ed324, size 0x8, virtual false, abstract: false, final false
