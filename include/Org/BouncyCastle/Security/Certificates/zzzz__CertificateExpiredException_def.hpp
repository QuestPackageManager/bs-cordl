...
public:
  ...
  /// @brief Method .ctor, addr 0x34f3b2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34f3b34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34f3b3c, size 0x8, virtual false, abstract: false, final false
