...
public:
  ...
  /// @brief Method .ctor, addr 0x137f1d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x137f1d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x137f1e0, size 0x8, virtual false, abstract: false, final false
