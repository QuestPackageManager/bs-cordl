...
public:
  ...
  /// @brief Method .ctor, addr 0x11b3f28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x11b3f30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x11b3f38, size 0x8, virtual false, abstract: false, final false
