...
public:
  ...
  /// @brief Method .ctor, addr 0x118d824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x118d82c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x118d834, size 0x8, virtual false, abstract: false, final false
