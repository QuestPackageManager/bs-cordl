...
public:
  ...
  /// @brief Method .ctor, addr 0x35ef69c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35ef6a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35ef6ac, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateExpiredException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateExpiredException(CertificateExpiredException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateExpiredException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateExpiredException(CertificateExpiredExceptionconst&) = delete;
