...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertificateEncodingException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertificateEncodingException(CertificateEncodingException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertificateEncodingException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertificateEncodingException(CertificateEncodingExceptionconst&) = delete;
