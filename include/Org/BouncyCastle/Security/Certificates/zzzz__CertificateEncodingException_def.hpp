...
public:
  ...
  /// @brief Method .ctor, addr 0x259920c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2599214, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x259921c, size 0x8, virtual false, abstract: false, final false
