...
public:
  ...
  /// @brief Method .ctor, addr 0x259a540, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x259a548, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x259a550, size 0x8, virtual false, abstract: false, final false
