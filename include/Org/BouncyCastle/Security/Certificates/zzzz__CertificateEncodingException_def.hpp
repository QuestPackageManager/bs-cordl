...
public:
  ...
  /// @brief Method .ctor, addr 0x1386a28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x1386a30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW msg);

  /// @brief Method .ctor, addr 0x1386a38, size 0x8, virtual false, abstract: false, final false
