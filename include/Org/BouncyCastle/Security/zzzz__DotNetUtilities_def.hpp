...
public:
  // Declarations
  /// @brief Method ConvertRSAParametersField, addr 0x11c0610, size 0x104, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertRSAParametersField(::Org::BouncyCastle::Math::BigInteger* n, int32_t size);

  /// @brief Method CreateRSAProvider, addr 0x11c0178, size 0x134, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* CreateRSAProvider(::System::Security::Cryptography::RSAParameters rp);

  /// @brief Method CreateRSAProvider, addr 0x11c02d8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromX509Certificate, addr 0x11bf6f0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x11bf7bc, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x11bf76c, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetDsaKeyPair(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method GetDsaPublicKey, addr 0x11bfa40, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaPublicKey, addr 0x11bf9f0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyPair, addr 0x11bff9c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x11bfc38, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x11bfbe8, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetRsaKeyPair(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method GetRsaPublicKey, addr 0x11bfecc, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaPublicKey, addr 0x11bfe7c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x11c04cc, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Asn1::Pkcs::RsaPrivateKeyStructure* privKey);

  /// @brief Method ToRSA, addr 0x11c05e4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x11c0388, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x11c04a0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x11c00b8, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters* rsaKey);

  /// @brief Method ToRSA, addr 0x11c02ac, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x11c04f0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x11c03ac, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x11c00dc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x11bf66c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x11bf5f0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x11bf5e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
