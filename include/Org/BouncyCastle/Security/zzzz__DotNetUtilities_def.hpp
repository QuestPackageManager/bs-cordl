...
public:
  // Declarations
  /// @brief Method ConvertRSAParametersField, addr 0x1199f0c, size 0x104, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertRSAParametersField(::Org::BouncyCastle::Math::BigInteger* n, int32_t size);

  /// @brief Method CreateRSAProvider, addr 0x1199a74, size 0x134, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* CreateRSAProvider(::System::Security::Cryptography::RSAParameters rp);

  /// @brief Method CreateRSAProvider, addr 0x1199bd4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromX509Certificate, addr 0x1198fec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x11990b8, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x1199068, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetDsaKeyPair(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method GetDsaPublicKey, addr 0x119933c, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaPublicKey, addr 0x11992ec, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyPair, addr 0x1199898, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x1199534, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x11994e4, size 0x50, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetRsaKeyPair(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method GetRsaPublicKey, addr 0x11997c8, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaPublicKey, addr 0x1199778, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x1199dc8, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Asn1::Pkcs::RsaPrivateKeyStructure* privKey);

  /// @brief Method ToRSA, addr 0x1199ee0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x1199c84, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x1199d9c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x11999b4, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters* rsaKey);

  /// @brief Method ToRSA, addr 0x1199ba8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x1199dec, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x1199ca8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x11999d8, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x1198f68, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x1198eec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1198ee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
