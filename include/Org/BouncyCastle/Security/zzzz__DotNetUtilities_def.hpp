...
public:
  // Declarations
  /// @brief Method ConvertRSAParametersField, addr 0x25a2bc8, size 0x100, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertRSAParametersField(::Org::BouncyCastle::Math::BigInteger* n, int32_t size);

  /// @brief Method CreateRSAProvider, addr 0x25a2730, size 0x134, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* CreateRSAProvider(::System::Security::Cryptography::RSAParameters rp);

  /// @brief Method CreateRSAProvider, addr 0x25a2890, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method FromX509Certificate, addr 0x25a1d50, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x25a1e14, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaKeyPair, addr 0x25a1dcc, size 0x48, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetDsaKeyPair(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method GetDsaPublicKey, addr 0x25a206c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method GetDsaPublicKey, addr 0x25a2024, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method GetKeyPair, addr 0x25a2558, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x25a223c, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaKeyPair, addr 0x25a21f4, size 0x48, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GetRsaKeyPair(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method GetRsaPublicKey, addr 0x25a2498, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRsaPublicKey, addr 0x25a2450, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x25a2a84, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Asn1::Pkcs::RsaPrivateKeyStructure* privKey);

  /// @brief Method ToRSA, addr 0x25a2b9c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x25a2940, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x25a2a58, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSA, addr 0x25a2670, size 0x24, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* ToRSA(::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters* rsaKey);

  /// @brief Method ToRSA, addr 0x25a2864, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x25a2aa8, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x25a2964, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToRSAParameters, addr 0x25a2694, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x25a1cd0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method ToX509Certificate, addr 0x25a1c58, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25a1c50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
