...
public:
  ...
  /// @brief Method .ctor, addr 0x113cfb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method CreateKey, addr 0x113cfbc, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfoData);

  /// @brief Method CreateKey, addr 0x113e460, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey, addr 0x113cfd8, size 0x1488, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* keyInfo);

  /// @brief Method GetRawKey, addr 0x113e47c, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x113e514, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x113e528, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x113e578, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x113e54c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptKey, addr 0x113e59c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptKey, addr 0x113e5bc, size 0x1020, virtual false, abstract: false, final false
