...
public:
  ...
  /// @brief Method .ctor addr 0x10cbd6c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method CreateKey addr 0x10cbd74 size 0x1c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfoData);

  /// @brief Method CreateKey addr 0x10cd218 size 0x1c virtual false final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey addr 0x10cbd90 size 0x1488 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* keyInfo);

  /// @brief Method GetRawKey addr 0x10cd234 size 0x98 virtual false final false
  ...
  /// @brief Method DecryptKey addr 0x10cd2cc size 0x14 virtual false final false
  ...
  /// @brief Method DecryptKey addr 0x10cd2e0 size 0x24 virtual false final false
  ...
  /// @brief Method DecryptKey addr 0x10cd330 size 0x24 virtual false final false
  ...
  /// @brief Method DecryptKey addr 0x10cd304 size 0x2c virtual false final false
  ...
  /// @brief Method EncryptKey addr 0x10cd354 size 0x20 virtual false final false
  ...
  /// @brief Method EncryptKey addr 0x10cd374 size 0x1020 virtual false final false
