...
public:
  // Declarations
  /// @brief Method CreateKey, addr 0x25be220, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream* inStr);

  /// @brief Method CreateKey, addr 0x25bcd9c, size 0x1484, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* keyInfo);

  /// @brief Method CreateKey, addr 0x25bcd80, size 0x1c, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t, ::Array<uint8_t>*> privateKeyInfoData);

  /// @brief Method DecryptKey, addr 0x25be308, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x25be2d0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x25be2e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method DecryptKey, addr 0x25be334, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptKey, addr 0x25be358, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptKey, addr 0x25be378, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRawKey, addr 0x25be23c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bcd78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
