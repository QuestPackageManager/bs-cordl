...
public:
  ...
  /// @brief Method .ctor, addr 0x25ab1f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25ab1fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25ab204, size 0x8, virtual false, abstract: false, final false
