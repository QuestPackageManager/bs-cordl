...
public:
  ...
  /// @brief Method .ctor, addr 0x3540814, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x354081c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3540824, size 0x8, virtual false, abstract: false, final false
