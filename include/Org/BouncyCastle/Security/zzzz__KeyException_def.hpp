...
public:
  ...
  /// @brief Method .ctor, addr 0x25aef2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25aef34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25aef3c, size 0x8, virtual false, abstract: false, final false
