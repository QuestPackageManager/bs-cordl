...
public:
  ...
  /// @brief Method .ctor, addr 0x25a97f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25a9800, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25a9808, size 0x8, virtual false, abstract: false, final false
