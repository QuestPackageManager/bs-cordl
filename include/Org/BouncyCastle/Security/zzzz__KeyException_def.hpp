...
public:
  ...
  /// @brief Method .ctor, addr 0x3504280, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3504288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x3504290, size 0x8, virtual false, abstract: false, final false
