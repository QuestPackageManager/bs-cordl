...
public:
  ...
  /// @brief Method .ctor, addr 0x25a70bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x25a70c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x25a70cc, size 0x8, virtual false, abstract: false, final false
