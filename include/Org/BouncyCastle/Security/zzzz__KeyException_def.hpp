...
// Write type traits
MARK_REF_T(::Org::BouncyCastle::Security::KeyException*);
DEFINE_IL2CPP_CLASS(::Org::BouncyCastle::Security::KeyException*, "Org.BouncyCastle.Security", "KeyException");
...
public:
  ...
  /// @brief Method .ctor, addr 0x35fda68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x35fda70, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x35fda78, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Org::BouncyCastle::Security::KeyException) == 0x90, "Size mismatch!");
