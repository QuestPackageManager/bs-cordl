...
public:
  ...
  /// @brief Method .ctor addr 0x10bdc24 size 0x8 virtual false final false
  inline void _ctor();

  static inline ::Org::BouncyCastle::Security::KeyException* New_ctor(::StringW message);

  /// @brief Method .ctor addr 0x10bdc2c size 0x8 virtual false final false
  inline void _ctor(::StringW message);

  static inline ::Org::BouncyCastle::Security::KeyException* New_ctor(::StringW message, ::System::Exception* exception);

  /// @brief Method .ctor addr 0x10bdc34 size 0x8 virtual false final false
