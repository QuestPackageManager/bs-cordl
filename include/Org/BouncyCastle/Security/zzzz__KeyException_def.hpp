...
public:
  ...
  /// @brief Method .ctor, addr 0x34d9a3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x34d9a44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34d9a4c, size 0x8, virtual false, abstract: false, final false
