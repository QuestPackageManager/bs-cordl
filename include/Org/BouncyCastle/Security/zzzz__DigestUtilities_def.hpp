...
public:
  ...
  /// @brief Method GetObjectIdentifier addr 0x1127c70 size 0x25c virtual false final false
  static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetObjectIdentifier(::StringW mechanism);

  /// @brief Method get_Algorithms addr 0x1127ecc size 0xcc virtual false final false
  static inline ::System::Collections::ICollection* get_Algorithms();

  /// @brief Method GetDigest addr 0x1127f98 size 0x60 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetDigest addr 0x1127ff8 size 0xc04 virtual false final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::StringW algorithm);

  /// @brief Method GetAlgorithmName addr 0x1128bfc size 0x108 virtual false final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method CalculateDigest addr 0x1128d04 size 0x68 virtual false final false
  ...
  /// @brief Method CalculateDigest addr 0x1128d6c size 0xf8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateDigest(::StringW algorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method DoFinal addr 0x1128e64 size 0x134 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method DoFinal addr 0x1128f98 size 0xec virtual false final false
