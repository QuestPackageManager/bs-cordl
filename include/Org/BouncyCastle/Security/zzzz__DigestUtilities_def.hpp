...
public:
  ...
  /// @brief Method CalculateDigest, addr 0x34d4140, size 0x100, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> CalculateDigest(::StringW algorithm, ::ArrayW<uint8_t, ::Array<uint8_t>*> input);

  /// @brief Method CalculateDigest, addr 0x34d40cc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method DoFinal, addr 0x34d4240, size 0x13c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IDigest* digest);

  /// @brief Method DoFinal, addr 0x34d437c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAlgorithmName, addr 0x34d3fcc, size 0x100, virtual false, abstract: false, final false
  static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier* oid);

  /// @brief Method GetDigest, addr 0x34d353c, size 0xa90, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::StringW algorithm);

  /// @brief Method GetDigest, addr 0x34d34d8, size 0x64, virtual false, abstract: false, final false
  static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::Org::BouncyCastle::Asn1::DerObjectIdentifier* id);

  /// @brief Method GetObjectIdentifier, addr 0x34d31b4, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34cf754, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Algorithms, addr 0x34d3404, size 0xd4, virtual false, abstract: false, final false
