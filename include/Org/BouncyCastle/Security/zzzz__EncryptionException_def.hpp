...
public:
  ...
  /// @brief Method .ctor, addr 0x254f4f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x254f4fc, size 0x8, virtual false, abstract: false, final false
