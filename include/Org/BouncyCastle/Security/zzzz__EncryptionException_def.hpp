...
public:
  ...
  /// @brief Method .ctor, addr 0x34a9ab4, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x34a9ad8, size 0x24, virtual false, abstract: false, final false
